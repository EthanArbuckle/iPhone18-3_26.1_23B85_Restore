uint64_t sub_100E22708(uint64_t a1, uint64_t a2, uint64_t a3)
{
  ...
  STACK[0x2A0] = v4 << 32;
  return (*(v6 + 8 * (((v7 - (v4 << 32) + 104563846 >= (v3 - 19871) - 7684) * (v3 - 27563)) | v3)))();
}
...
uint64_t sub_100E22AC0(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, uint64_t a16, uint64_t a17, uint64_t a18, uint64_t a19, uint64_t a20, uint64_t a21, uint64_t a22, uint64_t a23, uint64_t a24, uint64_t a25, uint64_t a26, uint64_t a27, uint64_t a28, uint64_t a29, uint64_t a30, uint64_t a31, uint64_t a32, uint64_t a33, uint64_t a34, uint64_t a35, uint64_t a36, uint64_t a37, uint64_t a38, uint64_t a39, uint64_t a40, uint64_t a41, uint64_t a42, uint64_t a43, uint64_t a44, uint64_t a45, uint64_t a46, uint64_t a47, uint64_t a48, int a49, int a50, int a51, int a52, int a53, int a54, int a55, int a56, int a57, unsigned int a58, unsigned int a59, int a60, unsigned int a61)
{
  LODWORD(STACK[0x234]) = a49 ^ 0x77C1AAF1;
  LODWORD(STACK[0x230]) = a55 ^ 0x2940D260;
  LODWORD(STACK[0x238]) = (37 * ((a57 | 0x100) ^ 0x2E1A) - 698241546) ^ a54;
  ...
  return (*(*(v61 - 184) + 8 * (a57 | 0x100)))(a1, LODWORD(STACK[0x2B4]), LODWORD(STACK[0x2DC]), LODWORD(STACK[0x2D8]), a5, a6, v65);
}
...
uint64_t sub_100E22F40(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, unsigned int a6)
{
  ...
  v20 = (*(v10 + 8 * (a6 + 2120268338)))(v13 ^ (2 * ((((v19 ^ 0x302401A5) << 8) & 0x38AD0000 ^ 0x28AD0000 ^ (((v19 ^ 0x302401A5) << 8) ^ 0xADBF0000) & (v19 ^ 0x302401A5)) & (((v19 ^ 0x889BE00) & (v18 << 8) ^ v18) << 16) ^ (v19 ^ 0x889BE00) & (v18 << 8) ^ v18)) ^ 0xEA693B7ALL);
  STACK[0x4A0] = v20;
  *(v8 + 3896) = v20;
...
uint64_t sub_100E23C38(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, uint64_t a16, uint64_t a17, uint64_t a18, uint64_t a19, uint64_t a20, char a21, uint64_t a22, uint64_t a23, uint64_t a24, uint64_t a25, uint64_t a26, uint64_t a27, uint64_t a28, uint64_t a29, uint64_t a30, uint64_t a31, uint64_t a32, uint64_t a33, unsigned int a34)
{
  ...
  v47 = *(&a21 + (((v38 ^ (2 * ((v46 << 16) & 0x1CA40000 ^ v46 ^ ((v46 << 16) ^ 0x289E0000) & (((v45 ^ 0x14A4201E) << 8) & 0x1CA40000 ^ 0x18840000 ^ (((v45 ^ 0x14A4201E) << 8) ^ 0x24280000) & (v45 ^ 0x14A4201E))))) >> 2) ^ 0x27F0E993) + 18);
...
uint64_t sub_100E23E74(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, int a8)
{
  ...
  v14 = v9 == a8 && v12 < 0xBFF;
  return (*(v10 + 8 * ((8330 * v14) ^ (v8 - 503363455))))();
}
...
uint64_t sub_100E267DC(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, uint64_t a16, uint64_t a17, uint64_t a18, uint64_t a19, uint64_t a20, uint64_t a21, uint64_t a22, uint64_t a23, uint64_t a24, uint64_t a25, uint64_t a26, uint64_t a27, uint64_t a28, uint64_t a29, uint64_t a30, uint64_t a31, uint64_t a32, unint64_t *a33, unint64_t *a34)
{
  ...
  return (*(v35 + 8 * ((((v34 + 197679153) & 0xF4379ED7) + 19025) ^ v34)))();
}
...
uint64_t sub_100E26F00(uint64_t a1, unsigned int a2)
{
  ...
  STACK[0x1D30] = v4;
  return (*(v3 + 8 * ((980 * (v4 > STACK[0x1ED0])) ^ 0x5DF4)))();
}
...
uint64_t sub_100E28200(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, void *a5)
{
  *a5 = *(v7 + 1280);
  ...
  return (*(v8 + 8 * (((LODWORD(STACK[0xD9C]) == -143113071) * (v5 ^ v6 ^ 0x819FAA9F)) ^ v5)))();
}
...
{
  *(v75 - 240) = STACK[0x1730] ^ a72;
  *(v75 - 216) = a72;
  *(v75 - 224) = a72;
  *(v75 - 220) = (v73 - 329067976) ^ a72;
  *(v75 - 232) = v73 + 1211071600 - a72 - 1540143702;
  *(v75 - 228) = a72 + v73 - 1632379223;
  *(v75 - 208) = ((v73 + 1211071600) ^ a66) + a72;
  v76 = (*(v74 + 8 * (v73 + v72)))(v75 - 240);
  return (*(v74 + 8 * *(v75 - 204)))(v76);
}
...
uint64_t sub_100E2B0A8(uint64_t a1, uint64_t a2, int a3)
{
  ...
  STACK[0xF48] = v5;
  STACK[0x840] = 0;
  return (*(v4 + 8 * (((v5 == 0) * ((a3 + ((v3 - 1577097574) & 0xDF9FFEFF) + 2357) ^ (v3 + 6593))) ^ v3)))();
}
...
uint64_t sub_100E2BB98(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, int a8)
{
  ...
  return (*(v10 + 8 * ((v11 * ((v9 + 22507) ^ (a8 - 2152) ^ ((v9 - 2145421083) | 0x180420C))) ^ v9)))();
}
...
void *sub_100E2BE3C(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, int a8)
{
  ...
  return (*(v9 + 8 * (v10 ^ 0x66BA ^ (a8 - 1683710477) & 0xE2BBEAFB)))(&STACK[0xEE4]);
}
...
uint64_t sub_100E2F598(uint64_t a1, uint64_t a2, uint64_t a3)
{
  v6 = *(*(a3 + 808) + 24);
  STACK[0x730] = v6;
  return (*(v5 + 8 * (((v6 == 0) * (v4 + v3 + 25 - 43557)) ^ v3)))();
}
...
uint64_t sub_100E2FFB8(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, int a8)
{
  *(v10 + 224) = STACK[0x3B0];
  *(v10 + 3808) = STACK[0x3A0];
  ...
  {
    v15 = v9 + v11 - 3667;
    v16 = (*(v13 + 8 * (v11 + 2120268448)))(31, 0, 0, 0);
...
uint64_t sub_100E3019C(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4)
{
  ...
  STACK[0x1708] = 0;
  STACK[0x598] = 0;
  return (*(v6 + 8 * (((v7 != a4) * ((14 * (v5 ^ 0x4372)) ^ 0x9A7)) ^ v5)))();
}
...
uint64_t sub_100E30580(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, int a7, int a8)
{
  v17 = *(a2 + 8 * (a8 ^ (8 * (v11 + a7)) ^ v15)) ^ v10;
  *(v9 + 8 * ((v13 + 61) ^ v8)) = *(a2 + 8 * (a8 ^ v12 ^ v15)) ^ v10;
  *(v9 + 8 * ((v11 + a7) ^ v8)) = v17;
  return (*(v14 + 8 * ((4 * (v13 == 0)) | (16 * (v13 == 0)) | v16)))();
}
...
void *sub_100E3294C(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, int a8)
{
  v11 = v9 + a8 + 1048;
  *(v8 + 3728) = *(v10 + 8 * v11);
  return (*(v10 + 8 * ((v9 + a8 + 475) ^ v11 ^ 0x52AC)))(&STACK[0x17B4]);
}
...
uint64_t sub_100E34D04(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4)
{
  ...
  STACK[0x7A8] = 0;
  *(a3 + 840) = 0;
  return (*(STACK[0x540] + 8 * (((v5 == a4) * ((v4 - 7041) ^ 0x819FCBA3 ^ v4 ^ 0x819FE721)) ^ v4)))();
}
...
uint64_t sub_100E35F50(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, int a5, unsigned int a6, int a7, int a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, uint64_t a16, uint64_t a17, uint64_t a18, uint64_t a19, uint64_t a20, uint64_t a21, uint64_t a22, uint64_t a23, uint64_t a24, uint64_t a25, uint64_t a26, uint64_t a27, uint64_t a28, uint64_t a29, uint64_t a30, uint64_t a31, uint64_t a32, uint64_t a33, uint64_t a34, uint64_t a35, uint64_t a36, uint64_t a37, uint64_t a38, uint64_t a39, uint64_t a40, uint64_t a41, uint64_t a42, uint64_t a43, uint64_t a44, uint64_t a45, uint64_t a46, uint64_t a47, uint64_t a48, uint64_t a49, uint64_t a50, uint64_t a51, uint64_t a52, uint64_t a53, uint64_t a54)
{
  ...
  *(v54 + 1200) = *(STACK[0x540] + 5624);
  return (*(v55 + 8 * ((a7 + 15520) ^ 0x2BF ^ ((a5 + 1 > a6) * a8))))(a54);
}
...
uint64_t sub_100E382E4(double a1, int8x16_t a2, int64x2_t a3, int8x16_t a4, int8x16_t a5, int8x16_t a6, int8x16_t a7, int8x16_t a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, uint64_t a16)
{
  ...
  *(v20 + a14) = veor_s8(vrev64_s8(*&vqtbl4q_s8(v141, *&STACK[0x4D0])), STACK[0x530]);
  return (*(v36 + 8 * ((13922 * (v18 == v19)) ^ v17)))();
}
...
uint64_t sub_100E395DC(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, uint64_t a16, uint64_t a17, uint64_t a18, uint64_t a19, uint64_t a20, uint64_t a21, uint64_t a22, uint64_t a23, uint64_t a24, uint64_t a25, uint64_t a26, uint64_t a27, uint64_t a28, uint64_t a29, uint64_t a30, uint64_t a31, uint64_t a32, uint64_t a33, uint64_t a34, uint64_t a35, uint64_t a36, uint64_t a37, uint64_t a38, uint64_t a39, uint64_t a40, uint64_t a41, uint64_t a42, uint64_t a43, uint64_t a44, uint64_t a45, uint64_t a46, uint64_t a47, uint64_t a48, uint64_t a49, uint64_t a50, uint64_t a51, uint64_t a52, uint64_t a53, uint64_t a54, unint64_t *a55)
{
  ...
  v60 = (*(v56 + 8 * (v55 + 26732)))(&STACK[0x2280] + v58, 0, 32);
...
uint64_t sub_100E3989C@<X0>(uint64_t a1@<X0>, int a2@<W8>)
{
  ...
  v5 = !v4;
  return (*(v3 + 8 * (((((71 * (a2 ^ 0x3593)) ^ 0x3744) + (a2 ^ 0xB86)) * v5) ^ a2)))();
}
...
void *sub_100E39C58(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, int a8)
{
  v10 = v8 + a8 + 2302;
  STACK[0x1B90] = *(v9 + 8 * v10);
  return (*(v9 + 8 * (a8 + 2120255727 + v10 - 12142)))(&STACK[0x1500]);
}
...
uint64_t sub_100E3A1F0(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, int a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, uint64_t a16, uint64_t a17, uint64_t a18, uint64_t a19, uint64_t a20, uint64_t a21, uint64_t a22, uint64_t a23, uint64_t a24, uint64_t a25, uint64_t a26, uint64_t a27, uint64_t a28, uint64_t a29, uint64_t a30, uint64_t a31, _DWORD *a32)
{
  v32 = a8 + 2120241019;
  v33 = STACK[0x540];
  v34 = (*(STACK[0x540] + 8 * (a8 ^ (a8 - 971))))(STACK[0xDA0]);
  v35 = STACK[0x1C54];
  STACK[0x1310] -= 16;
  *a32 = v35;
...
uint64_t sub_100E3AAE4(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, int a8)
{
  ...
  return (*(v8 + 8 * ((203 * (v9 != 0)) ^ (a8 + 2120252513))))();
}
...
uint64_t sub_100E3AD40(unint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, int a8)
{
  ...
  *(v11 + 1064) = v16 - v17;
  v19 = (*(v12 + 8 * (v9 + 2120268347)))(v13 - 240);
  v20 = *(v12 + 8 * *(v13 - 220));
...
uint64_t sub_100E3BA70(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, uint64_t a16, uint64_t a17, uint64_t a18, uint64_t a19, uint64_t a20, uint64_t a21, uint64_t a22, uint64_t a23, uint64_t a24, uint64_t a25, uint64_t a26, void *a27)
{
  ...
  *(v28 + 95) = v61;
  ...
  while (v68 != 32);
  *a27 = STACK[0x2218];
  return (*(v29 + 8 * v33))(v69, v70, v71, v72);
}
...
uint64_t sub_100E3BEE4(uint64_t a1, unsigned int a2)
{
  ...
  STACK[0x1D10] = v4;
  return (*(v3 + 8 * ((46 * (v4 > STACK[0x2040])) ^ 0x688C)))();
}
...
uint64_t sub_100E3D120(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4)
{
  ...
  *(v6 + 827) = 1;
  *(*(a4 + 320) + 4) = 369950720;
  return (*(v7 + 8 * (v4 ^ 0x4BEB ^ (11 * (v4 ^ 0x9C3)))))();
}
...
uint64_t sub_100E3EC48(uint64_t a1, unsigned int a2)
{
  ...
  STACK[0x1C20] = v4;
  return (*(v3 + 8 * ((17 * (v4 > STACK[0x2160])) | 0x678A)))();
}
...
uint64_t sub_100E40054(uint64_t a1, uint64_t a2, uint64_t a3, int a4)
{
  v9 = v6 - 1;
  *(v4 + v9) = *(v5 + v9) ^ 0xF;
  return (*(v8 + 8 * ((a4 + v7 - 1927) ^ 0x2F8E ^ (21 * ((v7 ^ 0xDB ^ (((v9 - (a4 + v7 - 1927)) | ((a4 + v7 - 1927) - v9)) < 0)) & 1)))))();
}
...
uint64_t sub_100E4126C(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, uint64_t a16, uint64_t a17, uint64_t a18, uint64_t a19, uint64_t a20, uint64_t a21, uint64_t a22, uint64_t a23, uint64_t a24, uint64_t a25, uint64_t a26, uint64_t a27, uint64_t a28, uint64_t a29, uint64_t a30, uint64_t a31, uint64_t a32, uint64_t a33, uint64_t a34, uint64_t a35, uint64_t a36, uint64_t a37, uint64_t a38, uint64_t a39, uint64_t a40, uint64_t a41, uint64_t a42, uint64_t a43, uint64_t a44, uint64_t a45, uint64_t a46, uint64_t a47, uint64_t a48, uint64_t a49, uint64_t a50, uint64_t a51, uint64_t a52, uint64_t a53, uint64_t a54, uint64_t a55, uint64_t a56, uint64_t a57, uint64_t a58, uint64_t a59, uint64_t a60, uint64_t a61, uint64_t a62, uint64_t a63)
{
  ...
  return (*(v64 + 8 * ((((v65 - 2185) | 0x220E) ^ 0x33AF) + v65)))(a1, a2, a63);
}
...
uint64_t sub_100E44968(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4)
{
  ...
  STACK[0xEB8] = 0;
  STACK[0x970] = 0;
  return (*(v5 + 8 * ((57 * (((v6 == a4) ^ (v4 - 98)) & 1)) ^ v4)))();
}
...
uint64_t sub_100E45CFC(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4)
{
  ...
  STACK[0x1048] = 0;
  STACK[0xDD0] = 0;
  return (*(v6 + 8 * (((4 * (((v5 + v4 - 92) ^ (v7 == a4)) & 1)) & 0xEF | (16 * (((v5 + v4 + 2468) ^ (v7 == a4)) & 1))) ^ (v4 + 2120255734))))();
}
...
uint64_t sub_100E45E88(__n128 a1, __n128 a2, __n128 a3, uint64_t a4, uint64_t a5, int a6, uint64_t a7, unint64_t a8)
{
  ...
  *&STACK[0x4C0] = vdupq_n_s64(0x9967FA0BA4337986);
  return v12(a1, a2, a3, vdupq_n_s64(v8));
}
...
uint64_t sub_100E47494(uint64_t a1, uint64_t a2, int a3)
{
  v6 = STACK[0x13E8];
  *v6 = 0;
  return (*(v5 + 8 * (((STACK[0x1208] + 20 <= (v6 + 2)) * (a3 + v4 - 27043)) ^ (v3 + v4 - 89))))();
}
...
void *sub_100E49790(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, int a8)
{
  ...
  return (*(v9 + 8 * ((v8 + a8 + 21650) ^ v10)))(&STACK[0xABC]);
}
...
uint64_t sub_100E4D29C(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, __int128 a10)
{
  ...
  v13 = (*(v11 + 8 * ((v12 + 17735) ^ 0x8C7)))(v10, &a10, 1536);
...
uint64_t sub_100E533AC(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, uint64_t a16, uint64_t a17, uint64_t a18, uint64_t a19, uint64_t a20, uint64_t a21, uint64_t a22, uint64_t a23, uint64_t a24, uint64_t a25, uint64_t a26, uint64_t a27, uint64_t a28, uint64_t a29, uint64_t a30, uint64_t a31, uint64_t a32, uint64_t a33, uint64_t a34, uint64_t a35, uint64_t a36, uint64_t a37, uint64_t a38, uint64_t a39)
{
  ...
  v41 = STACK[0x410] == a13;
  STACK[0x4F0] = v40;
  return (*(STACK[0x540] + 8 * (((v40 + 2120262831) * v41) ^ v39)))(STACK[0x530], 0x25A862CADD572E28, 0x1F7B92942DEF21EFLL, a39);
}
...
uint64_t sub_100E54054(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4)
{
  ...
  STACK[0xD38] = 0;
  v10 = v8 != a4 && v4 != 0;
  return (*(v7 + 8 * ((v10 * ((((v6 - 2121349269) | 0x108004) ^ 0x7E6001EB) + ((v6 + 609682642) & 0xDBA8BCFF))) ^ v6)))();
}
...
uint64_t sub_100E586B0(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, uint64_t a16, uint64_t a17, uint64_t a18, uint64_t a19, uint64_t a20, uint64_t a21, uint64_t a22, uint64_t a23, uint64_t a24, uint64_t a25, uint64_t a26, uint64_t a27, uint64_t a28, uint64_t a29, uint64_t a30, uint64_t a31, uint64_t a32, uint64_t a33, uint64_t a34, uint64_t a35, uint64_t a36, uint64_t a37, uint64_t a38, uint64_t a39, uint64_t a40, uint64_t a41, uint64_t a42, uint64_t a43, uint64_t a44, uint64_t a45, uint64_t a46, uint64_t a47, uint64_t a48, int a49, int a50, int a51, int a52, int a53, int a54, uint64_t a55, uint64_t a56, uint64_t a57, uint64_t a58, uint64_t a59, uint64_t a60, uint64_t a61, uint64_t a62, uint64_t a63)
{
  ...
  LODWORD(STACK[0x364]) ^= a66 ^ 0xBF99D6F1 ^ *(v67 - 248) ^ LODWORD(STACK[0x394]) ^ LODWORD(STACK[0x398]) ^ *(v67 - 236) ^ a51 ^ a49 ^ a54;
  return (*(*(v67 - 184) + 8 * v66))();
}
...
uint64_t sub_100E59650(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, uint64_t a16, uint64_t a17, uint64_t a18, uint64_t a19, uint64_t a20, uint64_t a21, uint64_t a22, uint64_t a23, uint64_t a24, uint64_t a25, uint64_t a26, uint64_t a27, uint64_t a28, uint64_t a29, uint64_t a30, uint64_t a31, uint64_t a32, uint64_t a33, uint64_t a34, uint64_t a35, uint64_t a36, uint64_t a37, uint64_t a38, uint64_t a39, uint64_t a40, uint64_t a41, uint64_t a42, uint64_t a43, uint64_t a44, uint64_t a45, uint64_t a46, uint64_t a47, uint64_t a48, uint64_t a49, uint64_t a50, uint64_t a51, uint64_t a52, uint64_t a53, uint64_t a54, uint64_t a55, uint64_t a56, uint64_t a57, uint64_t a58, uint64_t a59, uint64_t a60)
{
  ...
  return v62(a1, a2, a3, a4, 0xA4C13E7A672B61F6, 0x2EAD2D51E70187D4, 0xEE93EFF9FB91609BLL, 0x9D63C3648794ABC0, a9, a10, a11, a12, a13, a14, a15, a16, a17, a18, a19, a20, a21, a22, a23, a24, a25, a26, a27, a28, a29, a30, a31, a32, a33, a34, a35, a36, a37, a38, a39, a40, a41, a42, a43, a44, a45, a46, a47, a48, a49, a50, a51, a52, a53, a54, a55, a56, a57, a58, a59, a60, a3 - 104563847, a3 - 104585320);
}
...
uint64_t sub_100E59C1C(uint64_t a1, unint64_t a2, unint64_t a3, unint64_t a4, unint64_t a5, unint64_t a6, unint64_t a7, unint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, uint64_t a16, uint64_t a17, uint64_t a18, uint64_t a19, uint64_t a20, uint64_t a21, uint64_t a22, uint64_t a23, uint64_t a24, uint64_t a25, uint64_t a26, uint64_t a27, uint64_t a28, uint64_t a29, uint64_t a30, uint64_t a31, uint64_t a32, uint64_t a33, uint64_t a34, uint64_t a35, uint64_t a36, uint64_t a37, uint64_t a38, uint64_t a39, uint64_t a40, uint64_t a41, uint64_t a42, uint64_t a43, uint64_t a44, uint64_t a45, uint64_t a46, uint64_t a47, uint64_t a48, uint64_t a49, uint64_t a50, uint64_t a51, uint64_t a52, uint64_t a53, uint64_t a54, uint64_t a55, uint64_t a56, uint64_t a57, uint64_t a58, uint64_t a59, uint64_t a60, uint64_t a61, uint64_t a62, uint64_t a63)
{
  ...
  *v452 = veorq_s8(vextq_s8(v530, v530, 8uLL), *&STACK[0x300]);
  return (*(STACK[0x540] + 8 * ((18843 * (STACK[0x250] == v79)) ^ LODWORD(STACK[0x260]))))();
}
...
uint64_t sub_100E5B994(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, int a8)
{
  ...
  return (*(v9 + 8 * ((26527 * v12) ^ (v8 + a8 + 682))))();
}
...
uint64_t sub_100E5BFE0(uint64_t a1, int a2)
{
  ...
  STACK[0x18B8] = 0;
  return (*(v3 + 8 * (((v4 == 0x308E083E0C524CBELL) * ((v2 + 2120238994) ^ 0x994)) | (v2 + 2120256340))))();
}
...
uint64_t sub_100E5C65C(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, uint64_t a16, uint64_t a17, uint64_t a18, uint64_t a19, uint64_t a20, uint64_t a21, uint64_t a22, uint64_t a23, uint64_t a24, uint64_t a25, uint64_t a26, uint64_t a27, uint64_t a28, uint64_t a29, uint64_t a30, uint64_t a31, uint64_t a32, uint64_t a33, uint64_t a34, uint64_t a35, uint64_t a36, uint64_t a37, uint64_t a38, uint64_t a39, uint64_t a40, uint64_t a41, uint64_t a42, uint64_t a43, uint64_t a44, uint64_t a45, uint64_t a46, uint64_t a47, uint64_t a48, uint64_t a49, uint64_t a50, uint64_t a51, uint64_t a52, uint64_t a53, uint64_t a54, uint64_t a55, uint64_t a56, uint64_t a57, uint64_t a58, uint64_t a59, uint64_t a60, uint64_t a61, uint64_t a62, uint64_t a63)
{
  ...
  v69 = STACK[0x1800];
  v70 = STACK[0x17C0] ^ STACK[0x1800] ^ LODWORD(STACK[0x1D14]);
  v71 = STACK[0x17B0] ^ STACK[0x17E8];
  v72 = STACK[0x17E8] ^ LODWORD(STACK[0x1D18]);
  v73 = STACK[0x1820];
  v74 = STACK[0x1820] ^ LODWORD(STACK[0x1E7C]) ^ *(a68 + (LOBYTE(STACK[0x17A8]) ^ STACK[0x17C0]));
  v75 = LODWORD(STACK[0x17A8]) ^ STACK[0x17C0] ^ STACK[0x1EB8] ^ v70;
  v76 = STACK[0x1808];
  v77 = STACK[0x1810] ^ STACK[0x1808];
  v78 = STACK[0x1838];
  v79 = LODWORD(STACK[0x1838]) ^ LODWORD(STACK[0x21D4]) ^ *(a68 + (STACK[0x1810] ^ STACK[0x1808]));
  LODWORD(STACK[0x3D10]) = v79;
  v80 = v77 ^ STACK[0x1EE0];
  v81 = STACK[0x1828] ^ LODWORD(STACK[0x1D88]);
  v82 = STACK[0x1818];
  v83 = STACK[0x1818] ^ LODWORD(STACK[0x1E30]) ^ *(a68 + (STACK[0x17F0] ^ STACK[0x1828]));
  v84 = STACK[0x17F0] ^ STACK[0x1828] ^ STACK[0x1EC0];
  v85 = v71 ^ STACK[0x1EB0];
  v86 = STACK[0x17E0];
  v87 = v72 ^ STACK[0x17E0];
  STACK[0x3D78] = v85 ^ v87;
  v88 = *(a68 + (v85 ^ v72 ^ v86));
  v89 = *(a68 + v71);
  v90 = LOBYTE(STACK[0x5135]);
  LODWORD(STACK[0x3E18]) = v90;
  v91 = STACK[0x1FC4];
  v92 = STACK[0x17AC];
  v93 = LODWORD(STACK[0x17AC]) ^ LODWORD(STACK[0x1FC4]) ^ v90 ^ v89;
  LODWORD(STACK[0x3D68]) = v88 ^ LODWORD(STACK[0x1F08]) ^ v93;
  LODWORD(v69) = v78 ^ LODWORD(STACK[0x1E80]) ^ v69;
  v94 = STACK[0x17C8];
  LODWORD(STACK[0x3D30]) = v81 ^ STACK[0x17C8];
  v95 = v94 ^ v73 ^ LODWORD(STACK[0x1CE4]);
  LODWORD(v73) = v86 ^ LODWORD(STACK[0x1F6C]) ^ v82;
  v96 = STACK[0x1CE0];
  LODWORD(v86) = STACK[0x17BC];
  v97 = v92 ^ LODWORD(STACK[0x1CE0]) ^ LODWORD(STACK[0x17BC]);
  LODWORD(STACK[0x3D50]) = v97 ^ LODWORD(STACK[0x1EA4]) ^ v93;
  LODWORD(v82) = STACK[0x1F70];
  LODWORD(STACK[0x3CB8]) = v73 ^ LODWORD(STACK[0x1F70]) ^ v87;
  v98 = STACK[0x1E78];
  STACK[0x3C08] = v73 ^ LODWORD(STACK[0x1E78]) ^ v83;
  LODWORD(v73) = v83 ^ LODWORD(STACK[0x1EEC]);
  v99 = LODWORD(STACK[0x1EEC]) ^ v82;
  v100 = STACK[0x1D40];
  LODWORD(v82) = v86 ^ LODWORD(STACK[0x1D40]) ^ v76;
  v101 = v80 ^ v82;
  v102 = v101 ^ STACK[0x21D8];
  LODWORD(v86) = *(a68 + v101);
  v103 = STACK[0x1FC8];
  STACK[0x1FC8] = STACK[0x1FC8];
  v104 = v98 ^ v103 ^ v99;
  v105 = STACK[0x1E74];
  LODWORD(v94) = STACK[0x1D3C];
  v106 = STACK[0x1F1C];
  LODWORD(STACK[0x3D48]) = v86 ^ LODWORD(STACK[0x1F1C]) ^ v79;
  STACK[0x25C0] = v94 ^ v105 ^ v106 ^ v70 ^ v86 ^ *(a68 + v102);
  v107 = STACK[0x1E98];
  STACK[0x3BE8] = v95 ^ LODWORD(STACK[0x1E98]) ^ v74;
  v108 = v74 ^ LODWORD(STACK[0x1D58]);
  LODWORD(v86) = v95 ^ LODWORD(STACK[0x1D38]);
  LOBYTE(v95) = LODWORD(STACK[0x1D38]) ^ LODWORD(STACK[0x1D58]);
  v109 = v75 ^ STACK[0x1EF8];
  v110 = *(a68 + v75);
  v111 = STACK[0x1D20];
  v112 = *(a68 + v109) ^ v110;
  LODWORD(STACK[0x3CC0]) = v108 ^ v110;
  STACK[0x2918] = v108 ^ v112;
  LOBYTE(v112) = v111 ^ v107 ^ v95 ^ v84 ^ v112;
  STACK[0x3D60] = v69 ^ v105;
  v113 = v70 ^ v94 ^ v69;
  v114 = LODWORD(STACK[0x1D30]) ^ v91 ^ v100 ^ v96 ^ v76;
  v115 = v97 ^ LODWORD(STACK[0x1D30]) ^ v82;
  v116 = v104 ^ v85;
  v117 = v114 ^ v97 ^ v82 ^ v89 ^ *(a68 + v85);
  v118 = STACK[0x3D30];
  v119 = *(a68 + (v84 ^ LODWORD(STACK[0x3D30])));
  v120 = STACK[0x3D78] ^ v103;
  v121 = *(a68 + (v84 ^ LODWORD(STACK[0x3D30]) ^ v111)) ^ v119;
  v122 = STACK[0x3D68];
  LODWORD(v94) = LODWORD(STACK[0x3D68]) ^ *(a68 + (STACK[0x3D78] ^ v103));
  LODWORD(STACK[0x3D40]) = v94;
  STACK[0x2020] = v117 ^ v94 ^ LODWORD(STACK[0x3E18]) ^ *(a68 + (v116 ^ v121));
  v123 = STACK[0x3CB8];
  v124 = LODWORD(STACK[0x3CB8]) ^ *(a68 + v111) ^ v116 ^ *(a68 + v111);
  LODWORD(STACK[0x3CE0]) = v121 ^ v73;
  STACK[0x3050] = v124 ^ v73 ^ *(a68 + v112);
  LODWORD(v82) = v73 ^ v119 ^ LODWORD(STACK[0x1D1C]);
  LODWORD(STACK[0x3CB0]) = v73 ^ v119 ^ LODWORD(STACK[0x1F7C]);
  LODWORD(STACK[0x3CD8]) = v118 ^ 0x16 ^ v86;
  v125 = STACK[0x1CA0];
  LODWORD(STACK[0x3C88]) = v118 ^ 0x16 ^ STACK[0x1CA0] ^ v84 ^ v111;
  v126 = *(a68 + (v84 ^ v111 ^ v86));
  v127 = *(a68 + v125);
  LODWORD(STACK[0x3CA0]) = v127 ^ v126 ^ *(a68 + (v84 ^ v111 ^ v86 ^ v125));
  LODWORD(v125) = LOBYTE(STACK[0x50AF]);
  LODWORD(STACK[0x3D78]) = v125;
  LODWORD(v73) = v122 ^ v125;
  v128 = *(a68 + (v120 ^ v123));
  LODWORD(v86) = *(a68 + (v109 ^ v113));
  v129 = v115;
  LOBYTE(v112) = v102 ^ v115;
  v130 = *(a68 + (v102 ^ v115));
  LODWORD(STACK[0x3CD0]) = v130;
  LODWORD(v76) = STACK[0x1CCC];
  LODWORD(STACK[0x3C80]) = v122 ^ v125 ^ LODWORD(STACK[0x1CCC]) ^ v128;
  v131 = STACK[0x1CB8];
  v132 = *(a68 + STACK[0x1CB8]);
  LODWORD(STACK[0x3C70]) = v132 ^ v128 ^ *(a68 + (v120 ^ v123 ^ STACK[0x1CB8]));
  v133 = STACK[0x1FC0];
  v134 = STACK[0x3CC0];
  LODWORD(STACK[0x3CE8]) = LODWORD(STACK[0x3CC0]) ^ LODWORD(STACK[0x1FC0]) ^ v86;
  LODWORD(v125) = v109 ^ STACK[0x1E68];
  v135 = *(a68 + STACK[0x1E68]);
  LODWORD(v86) = v135 ^ v86 ^ *(a68 + (v109 ^ v113 ^ STACK[0x1E68]));
  LODWORD(STACK[0x3C00]) = v86;
  v136 = v102 ^ STACK[0x1DC8];
  LODWORD(v103) = *(a68 + (v112 ^ STACK[0x1DC8]));
  v137 = *(a68 + STACK[0x1DC8]);
  LODWORD(STACK[0x3D30]) = v137;
  v138 = v103 ^ v130 ^ v137;
  LODWORD(STACK[0x3CC8]) = v138;
  LODWORD(v103) = v135 ^ v133;
  v139 = v126 ^ v82;
  v140 = v127 ^ v82;
  LODWORD(v111) = v129 ^ LODWORD(STACK[0x1F5C]) ^ LODWORD(STACK[0x3D50]);
  v141 = LOBYTE(STACK[0x5138]);
  v142 = v141 ^ v132;
  v143 = LODWORD(STACK[0x3D50]) ^ LODWORD(STACK[0x1D2C]);
  v144 = v76 ^ LODWORD(STACK[0x1D2C]) ^ v141 ^ v132;
  v145 = v144 ^ LODWORD(STACK[0x3D50]);
  LODWORD(v82) = v136 ^ v129;
  STACK[0x2EF0] = v136 ^ LODWORD(STACK[0x1F5C]) ^ v144;
  v146 = LODWORD(STACK[0x3D10]) ^ STACK[0x3D60];
  v147 = STACK[0x1E64];
  LODWORD(STACK[0x3C90]) = v113 ^ LODWORD(STACK[0x1E64]) ^ v146;
  v148 = STACK[0x1F38];
  v149 = v146 ^ LODWORD(STACK[0x1F38]) ^ LODWORD(STACK[0x3D48]);
  v150 = STACK[0x1DEC];
  LODWORD(STACK[0x3D48]) ^= LODWORD(STACK[0x1DEC]);
  v151 = v150 ^ v147 ^ v148 ^ v137;
  LODWORD(STACK[0x3C98]) = v125 ^ v113;
  LODWORD(STACK[0x3CF0]) = v151 ^ v113;
  LOBYTE(v125) = v125 ^ v151;
  LODWORD(v69) = v120 ^ v131 ^ v123;
  v152 = v123 ^ LODWORD(STACK[0x1E5C]);
  LOBYTE(v148) = v131 ^ LODWORD(STACK[0x1E5C]) ^ v120;
  v153 = STACK[0x3C88];
  LOBYTE(v120) = LODWORD(STACK[0x3C88]) ^ LODWORD(STACK[0x3D58]) ^ 0xC8;
  v154 = STACK[0x3BE8];
  LODWORD(v131) = STACK[0x3BE8] ^ LODWORD(STACK[0x1EAC]) ^ v134;
  v155 = v103 ^ LODWORD(STACK[0x1EAC]);
  LODWORD(STACK[0x3CA8]) = v155;
  LODWORD(STACK[0x3D10]) = v103 ^ v134 ^ *(a68 + (v138 ^ v125));
  v156 = STACK[0x3CB0];
  LOBYTE(v103) = v148 ^ v140 ^ LODWORD(STACK[0x3CB0]) ^ LODWORD(STACK[0x3CA0]);
  v157 = LODWORD(STACK[0x3CA0]) ^ v140 ^ LODWORD(STACK[0x3CB0]);
  LOBYTE(v125) = v140 ^ v152 ^ v140 ^ LODWORD(STACK[0x3CB0]);
  v158 = STACK[0x1FB8];
  v159 = v155 ^ LODWORD(STACK[0x1FB8]);
  STACK[0x2018] = v159;
  LODWORD(v159) = v86 ^ v159;
  v160 = *(a68 + (v159 ^ v120));
  v161 = STACK[0x3C08];
  LOBYTE(v120) = v157 ^ STACK[0x3C08];
  LODWORD(STACK[0x3CA0]) = v157 ^ STACK[0x3C08];
  STACK[0x27B0] = LODWORD(STACK[0x3CE0]) ^ v160;
  LOBYTE(v125) = v125 ^ v120 ^ v103 ^ v160;
  LODWORD(STACK[0x3C78]) = v143 ^ v73;
  v162 = v82 ^ v76 ^ v142 ^ v73;
  LODWORD(STACK[0x3D68]) = v141;
  LODWORD(v76) = LODWORD(STACK[0x3C70]) ^ v141;
  LODWORD(STACK[0x3CB8]) = v76;
  v163 = v145 ^ v76;
  LODWORD(v103) = LODWORD(STACK[0x3D78]) ^ *(a68 + v103);
  STACK[0x2488] = v103 ^ LODWORD(STACK[0x3D40]);
  STACK[0x3CC0] = v162 ^ v76 ^ v145 ^ v76 ^ v103;
  LODWORD(v103) = STACK[0x3CD8];
  v164 = LODWORD(STACK[0x3CD8]) ^ v158;
  LODWORD(STACK[0x3C68]) = v153 ^ LODWORD(STACK[0x3CD8]);
  LODWORD(v125) = *(a68 + v125);
  LODWORD(STACK[0x3C88]) = v159 ^ v103;
  STACK[0x3CE0] = v125 ^ v163 ^ LODWORD(STACK[0x3E18]);
  LODWORD(v125) = LODWORD(STACK[0x3C80]) ^ v141;
  LODWORD(v76) = v125 ^ LODWORD(STACK[0x1E84]);
  LODWORD(STACK[0x3C60]) = v125 ^ LODWORD(STACK[0x1CB4]);
  LODWORD(v159) = v161 ^ v152;
  LODWORD(v103) = v161 ^ v152 ^ v69;
  v165 = *(a68 + (v161 ^ v152 ^ v69));
  LODWORD(v125) = v82 ^ v111;
  LODWORD(STACK[0x3C18]) = v111 ^ LODWORD(STACK[0x1D34]);
  v166 = STACK[0x1CC0];
  v167 = v69 ^ STACK[0x1CC0];
  v168 = v103 ^ STACK[0x1CC0];
  STACK[0x3BA0] = v168;
  LODWORD(v103) = *(a68 + v166);
  LODWORD(v166) = LOBYTE(STACK[0x5092]);
  LODWORD(STACK[0x3D50]) = v166;
  LODWORD(v166) = v76 ^ v103 ^ v166;
  LODWORD(v103) = v103 ^ v165 ^ *(a68 + v168);
  LODWORD(v69) = LOBYTE(STACK[0x672F]);
  LODWORD(STACK[0x3C10]) = v76 ^ v165 ^ v69;
  LODWORD(STACK[0x3BF8]) = v103 ^ v69;
  v169 = v156 ^ v161;
  LODWORD(v69) = STACK[0x1F58];
  LODWORD(STACK[0x3D40]) = v156 ^ v161 ^ LODWORD(STACK[0x1F58]) ^ v139;
  LODWORD(v76) = v139 ^ LODWORD(STACK[0x1EF0]);
  LODWORD(v73) = LODWORD(STACK[0x1EF0]) ^ v69;
  LODWORD(v168) = STACK[0x1FB4];
  v170 = STACK[0x3CE8];
  LODWORD(STACK[0x3CD8]) = v131 ^ LODWORD(STACK[0x1FB4]) ^ LODWORD(STACK[0x3CE8]);
  LODWORD(v161) = v170 ^ LODWORD(STACK[0x1E2C]);
  LODWORD(v69) = LODWORD(STACK[0x1E2C]) ^ v168;
  LODWORD(v103) = STACK[0x1F78];
  v171 = STACK[0x3C90];
  LODWORD(STACK[0x3CB0]) = LODWORD(STACK[0x3C90]) ^ LODWORD(STACK[0x1F78]) ^ v149;
  v172 = v149 ^ LODWORD(STACK[0x1CEC]);
  v173 = LODWORD(STACK[0x1CEC]) ^ v103;
  LODWORD(v86) = LODWORD(STACK[0x3D48]) ^ LODWORD(STACK[0x3CD0]);
  v174 = STACK[0x1E90];
  LODWORD(v82) = *(a68 + STACK[0x1E90]);
  LODWORD(v103) = STACK[0x1F8C];
  v175 = v86 ^ LODWORD(STACK[0x1F8C]);
  LODWORD(STACK[0x3CE8]) = v86 ^ v172;
  v176 = v82 ^ v103 ^ v172;
  v177 = v173 ^ v82 ^ v103;
  v178 = v164 ^ v154;
  LODWORD(v111) = STACK[0x1C9C];
  LODWORD(STACK[0x3BE0]) = v164 ^ v154 ^ LODWORD(STACK[0x1C9C]) ^ v131;
  v179 = STACK[0x1E00];
  v180 = *(a68 + STACK[0x1E00]);
  LODWORD(v69) = v69 ^ v180;
  LODWORD(v86) = v69 ^ v131;
  LODWORD(v103) = STACK[0x3C98];
  STACK[0x3B98] = v171 ^ LODWORD(STACK[0x3C98]);
  LODWORD(v131) = *(a68 + (v171 ^ v103));
  v181 = v103 ^ v179;
  v182 = *(a68 + (v171 ^ v103 ^ v179)) ^ v131;
  LODWORD(STACK[0x3C80]) = v131 ^ v161;
  STACK[0x2550] = v180 ^ v161;
  v183 = v182 ^ v161;
  STACK[0x2490] = v183;
  LODWORD(v161) = v86 ^ v182 ^ v180;
  LODWORD(v69) = v182 ^ v180 ^ v69 ^ v111;
  LODWORD(v174) = v125 ^ v174;
  LODWORD(v125) = *(a68 + v125);
  v184 = *(a68 + v174) ^ v125;
  LODWORD(STACK[0x3C70]) = v125 ^ v175;
  v185 = v184 ^ v82;
  v186 = v184 ^ v175;
  LODWORD(STACK[0x3BD0]) = v184 ^ v175;
  LODWORD(v125) = v184 ^ v82 ^ v177;
  LODWORD(STACK[0x3C20]) = v171 ^ v181;
  LOBYTE(v177) = v125 ^ v181;
  v187 = v125 ^ v171;
  LODWORD(v179) = LODWORD(STACK[0x1FB0]) ^ 0xC;
  v188 = v159 ^ v179 ^ v169;
  LODWORD(STACK[0x3BD8]) = v188;
  v189 = STACK[0x1DD8];
  v190 = *(a68 + STACK[0x1DD8]);
  LODWORD(v73) = v73 ^ v190;
  LODWORD(v86) = v73 ^ v169;
  LODWORD(v82) = v159 ^ v167;
  LOBYTE(v167) = v167 ^ v179 ^ v73;
  LODWORD(v125) = STACK[0x3C68];
  v191 = LODWORD(STACK[0x3C68]) ^ STACK[0x1DD8];
  LODWORD(v179) = *(a68 + (LODWORD(STACK[0x3C68]) ^ 0x16u ^ v178));
  LODWORD(v73) = *(a68 + (LODWORD(STACK[0x3C68]) ^ 0x16u ^ v178 ^ STACK[0x1DD8])) ^ v179;
  LODWORD(STACK[0x3CD0]) = v179 ^ v76;
  LODWORD(v111) = v73 ^ v190;
  LOBYTE(v179) = v167 ^ 0xC;
  v192 = *(a68 + (v167 ^ 0xCu ^ (v73 ^ v190)));
  v193 = v69 ^ v125 ^ v189;
  STACK[0x3C90] = v193;
  LODWORD(v131) = v73 ^ v76 ^ *(a68 + v193);
  LODWORD(STACK[0x3C98]) = v131;
  LODWORD(v76) = LODWORD(STACK[0x3D68]) ^ v166 ^ v192;
  LODWORD(v166) = v166 ^ LODWORD(STACK[0x3C60]);
  LODWORD(v159) = STACK[0x3C78];
  LODWORD(STACK[0x3BF0]) = LODWORD(STACK[0x3C60]) ^ LODWORD(STACK[0x3C78]);
  v194 = LODWORD(STACK[0x3C18]) ^ v159;
  v195 = v166 ^ LODWORD(STACK[0x3C18]);
  LODWORD(v73) = v166 ^ v159;
  LODWORD(v166) = v178 ^ v191;
  LODWORD(v159) = v69 ^ v178 ^ 0x16;
  LODWORD(STACK[0x39E8]) = v159;
  LOBYTE(v189) = v159 ^ v193 ^ v183 ^ v161 ^ *(a68 + v177);
  v196 = LODWORD(STACK[0x3CA8]) ^ v154;
  STACK[0x3C18] = v196;
  LODWORD(v69) = LODWORD(STACK[0x3D10]) ^ v196;
  STACK[0x2880] = LODWORD(STACK[0x3C88]) ^ 0x16 ^ v69;
  v197 = v161 ^ v69;
  LODWORD(v69) = *(a68 + (v174 ^ 0x5Bu ^ (v195 ^ LODWORD(STACK[0x3BF8])))) ^ v186;
  STACK[0x2F40] = v176;
  STACK[0x27E0] = v187;
  LODWORD(STACK[0x3CA8]) = v69 ^ v187;
  v198 = v69 ^ v187 ^ v176 ^ v185;
  STACK[0x2838] = v197 ^ *(a68 + (v198 ^ v177));
  v199 = v73 ^ v76;
  LODWORD(v196) = v76 ^ v195;
  LOBYTE(v193) = v179 ^ v86;
  LODWORD(v76) = STACK[0x3CF0];
  LODWORD(v179) = LODWORD(STACK[0x3CF0]) ^ LODWORD(STACK[0x3CC8]);
  LODWORD(v111) = v111 ^ v86 ^ v131;
  STACK[0x3498] = v111 ^ LODWORD(STACK[0x3CA0]);
  STACK[0x3C78] = v179 ^ v198;
  LODWORD(v179) = LODWORD(STACK[0x3D78]) ^ *(a68 + (v111 ^ v82));
  LODWORD(v159) = *(a68 + (v199 ^ v174));
  LODWORD(STACK[0x3CA0]) = v159;
  LODWORD(v159) = v159 ^ v69;
  LODWORD(STACK[0x3C88]) = v159;
  LODWORD(STACK[0x3C68]) = *(a68 + (v196 ^ v199 ^ v174 ^ v179)) ^ v198 ^ v159;
  LODWORD(STACK[0x3BF8]) = LODWORD(STACK[0x3D48]) ^ LODWORD(STACK[0x3D30]) ^ v76 ^ *(a68 + (LODWORD(STACK[0x3CB8]) ^ STACK[0x2EF0])) ^ *(a68 + STACK[0x3CC0]);
  LODWORD(v159) = *(a68 + v189);
  LODWORD(STACK[0x3C60]) = v159;
  LODWORD(v193) = *(a68 + (v193 ^ v159));
  v200 = *(a68 + ((v188 ^ v82) ^ 0xCLL));
  LODWORD(STACK[0x3CF0]) = v200;
  LODWORD(v196) = v196 ^ v199 ^ v179 ^ LODWORD(STACK[0x3E18]);
  v201 = STACK[0x1CA8];
  LODWORD(v179) = *(a68 + ((STACK[0x1CA8] ^ v188 ^ v82) ^ 0xCu));
  STACK[0x2480] = v196 ^ v193;
  LODWORD(v159) = LOBYTE(STACK[0x5082]);
  LODWORD(STACK[0x3D48]) = v159;
  LODWORD(v196) = v179 ^ v200 ^ v159;
  LODWORD(v193) = LODWORD(STACK[0x3C10]) ^ LODWORD(STACK[0x1D44]) ^ v159;
  LODWORD(v189) = STACK[0x3BF0];
  v202 = LODWORD(STACK[0x3BF0]) ^ LODWORD(STACK[0x1D10]) ^ LODWORD(STACK[0x3C10]);
  LODWORD(STACK[0x3D30]) = v202;
  v203 = v194 ^ v174;
  LODWORD(v111) = v194 ^ LODWORD(STACK[0x1E28]) ^ v189;
  LODWORD(STACK[0x3CB8]) = v111;
  v204 = STACK[0x1CD0];
  v205 = *(a68 + STACK[0x1CD0]);
  LODWORD(v86) = STACK[0x1ECC];
  LODWORD(v187) = LODWORD(STACK[0x1ECC]) ^ LODWORD(STACK[0x1ED8]) ^ v205;
  LODWORD(v154) = v187 ^ LODWORD(STACK[0x1FD4]);
  v206 = STACK[0x1CD8];
  LODWORD(STACK[0x3BC0]) = v166 ^ STACK[0x1CD8] ^ v154;
  LODWORD(v131) = STACK[0x3BE0];
  LODWORD(v166) = LODWORD(STACK[0x3BE0]) ^ v166;
  LODWORD(v179) = *(a68 + v206);
  v207 = v166 ^ v206;
  STACK[0x3BC8] = v207;
  LODWORD(v159) = *(a68 + v166);
  LODWORD(STACK[0x3BA8]) = v159;
  LODWORD(v207) = *(a68 + v207) ^ v159;
  LODWORD(STACK[0x3B80]) = v207;
  LODWORD(v166) = LODWORD(STACK[0x1FE8]) ^ LODWORD(STACK[0x1F14]) ^ v179;
  LODWORD(v179) = v207 ^ v179;
  LODWORD(v189) = v166 ^ LODWORD(STACK[0x3D40]);
  LODWORD(v166) = v166 ^ LODWORD(STACK[0x1ED0]);
  LODWORD(STACK[0x3C10]) = v189 ^ v179;
  LODWORD(v159) = v179 ^ v166;
  LODWORD(STACK[0x3B68]) = v179 ^ v166;
  LODWORD(STACK[0x3BB0]) = v82 ^ v201;
  LODWORD(v166) = *(a68 + v201);
  LODWORD(v179) = v196 ^ v166;
  LODWORD(STACK[0x3B48]) = v196 ^ v166;
  LODWORD(v166) = v202 ^ v166;
  STACK[0x3B78] = v159 ^ v82 ^ v201;
  v208 = *(a68 + (v159 ^ v82 ^ v201));
  v209 = v166 ^ v193;
  LODWORD(STACK[0x3B60]) = v166 ^ v193;
  LODWORD(v193) = v193 ^ 0x5B;
  LODWORD(STACK[0x3A68]) = v193;
  LODWORD(STACK[0x3CC8]) = v193 ^ v196 ^ v208;
  LODWORD(v73) = STACK[0x3CB0];
  LODWORD(v166) = STACK[0x3C20];
  STACK[0x3B90] = (LODWORD(STACK[0x3CB0]) ^ LODWORD(STACK[0x3C20]));
  v210 = *(a68 + (v73 ^ v166));
  LODWORD(v159) = v203;
  STACK[0x3948] = v203;
  v211 = *(a68 + v203);
  LODWORD(STACK[0x3A60]) = v211;
  LODWORD(v201) = *(a68 + STACK[0x1E88]);
  LODWORD(v203) = v166 ^ v204;
  v212 = v159 ^ STACK[0x1E88];
  STACK[0x3CC0] = v212;
  v213 = *(a68 + v212);
  LODWORD(v193) = *(a68 + (v73 ^ v166 ^ v204));
  STACK[0x2F80] = v213;
  LODWORD(v213) = v201 ^ v211 ^ v213;
  LODWORD(v166) = v193 ^ v210;
  LODWORD(v193) = v193 ^ v210 ^ v205;
  LODWORD(v176) = STACK[0x1D54];
  v214 = STACK[0x1EDC];
  v215 = LODWORD(STACK[0x1EDC]) ^ LODWORD(STACK[0x1D54]) ^ v201;
  LODWORD(v82) = STACK[0x3C80];
  v216 = v82 ^ v86;
  LODWORD(v204) = STACK[0x1CE8];
  LODWORD(v196) = v213 ^ v215 ^ LODWORD(STACK[0x1CE8]);
  STACK[0x3B70] = v196 ^ v203;
  v217 = v166 ^ v82 ^ v86 ^ *(a68 + (v196 ^ v203));
  LODWORD(STACK[0x3BF0]) = v217;
  LODWORD(v189) = STACK[0x3C70];
  LODWORD(v69) = LODWORD(STACK[0x3C70]) ^ v176;
  v218 = v201 ^ v69;
  v219 = STACK[0x3CE8];
  LODWORD(v86) = v215 ^ LODWORD(STACK[0x3CE8]) ^ v213;
  v220 = v209 ^ v111 ^ v179;
  v221 = v220 ^ v212;
  LODWORD(v176) = *(a68 + (v220 ^ v212));
  STACK[0x2510] = v218;
  STACK[0x39A0] = v176 ^ LODWORD(STACK[0x3BD0]);
  LODWORD(v201) = v213 ^ v218 ^ v176;
  LODWORD(v212) = STACK[0x3CD8];
  LODWORD(v176) = v187 ^ LODWORD(STACK[0x3CD8]);
  LOBYTE(v187) = LODWORD(STACK[0x3BC0]) ^ 0x16 ^ v193;
  LOBYTE(v218) = v193 ^ v176;
  LODWORD(v193) = v154 ^ v131 ^ v193 ^ v176 ^ v217;
  LODWORD(v111) = v193 ^ LODWORD(STACK[0x3BC0]);
  LODWORD(v154) = LODWORD(STACK[0x1FD4]) ^ v131;
  LODWORD(STACK[0x3BC0]) = v176 ^ v193 ^ 0x16;
  LODWORD(v193) = v154 ^ v212;
  LODWORD(v154) = v212;
  LOBYTE(v176) = v193 ^ 0x16;
  LODWORD(STACK[0x3988]) = v193 ^ 0x16;
  LODWORD(STACK[0x3D30]) ^= 0x5Bu;
  v222 = v196 ^ v73;
  LODWORD(v131) = v73 ^ v203;
  LODWORD(STACK[0x3CF0]) ^= LODWORD(STACK[0x3A68]);
  LODWORD(v196) = v219;
  v223 = v73 ^ v204 ^ v219;
  LODWORD(STACK[0x38C8]) = v223;
  LODWORD(v73) = v196 ^ v214 ^ v189;
  LODWORD(STACK[0x3938]) = v73;
  LODWORD(STACK[0x3CE8]) = v210 ^ v216;
  LODWORD(v193) = LODWORD(STACK[0x3B68]) ^ LODWORD(STACK[0x3BD8]);
  LODWORD(v196) = LODWORD(STACK[0x3BD8]) ^ LODWORD(STACK[0x1ED0]);
  LODWORD(STACK[0x3BB0]) ^= LODWORD(STACK[0x3BD8]);
  LODWORD(v212) = STACK[0x3D40];
  LODWORD(STACK[0x3CB0]) = v196 ^ LODWORD(STACK[0x3D40]);
  LODWORD(v179) = LODWORD(STACK[0x3CD0]) ^ LODWORD(STACK[0x1F14]);
  v224 = v212 ^ LODWORD(STACK[0x1FE8]) ^ LODWORD(STACK[0x3CD0]);
  LODWORD(STACK[0x3C70]) = v224;
  LODWORD(STACK[0x3C20]) = LODWORD(STACK[0x3A60]) ^ v69;
  LODWORD(STACK[0x3CD8]) = v154 ^ LODWORD(STACK[0x1ED8]) ^ v82;
  LODWORD(v212) = v179 ^ LODWORD(STACK[0x3B80]);
  LODWORD(STACK[0x3CD0]) = v212;
  v225 = v179 ^ LODWORD(STACK[0x3BA8]);
  LODWORD(STACK[0x3BD8]) = v225;
  LOBYTE(v213) = v187 ^ v218;
  v226 = *(a68 + v187) ^ v212;
  LODWORD(v193) = v193 ^ v226;
  STACK[0x3068] = v111 ^ STACK[0x3C90];
  LODWORD(v187) = STACK[0x3C10];
  LODWORD(v196) = LODWORD(STACK[0x3C10]) ^ STACK[0x3B78];
  STACK[0x3BA8] = v196 ^ v193 ^ 0xC;
  LODWORD(v212) = LODWORD(STACK[0x3D68]) ^ *(a68 + ((v196 ^ v193) ^ 0xCu));
  LODWORD(v218) = *(a68 + v111);
  LODWORD(v196) = v196 ^ v218;
  LODWORD(v179) = *(a68 + v196);
  LODWORD(v82) = LODWORD(STACK[0x3CC8]) ^ LODWORD(STACK[0x3D50]);
  LODWORD(STACK[0x3B68]) = v82;
  LODWORD(v69) = v212 ^ v82 ^ LODWORD(STACK[0x3D78]) ^ v179;
  LODWORD(STACK[0x3C80]) = v69;
  STACK[0x2F18] = v222;
  v227 = v222 ^ v86 ^ v201;
  LODWORD(v203) = STACK[0x3CB8];
  v228 = v221 ^ LODWORD(STACK[0x3CB8]) ^ v82;
  LODWORD(v179) = *(a68 + v228);
  LODWORD(v86) = v179 ^ v86;
  LODWORD(STACK[0x3B78]) = v86;
  LODWORD(v189) = v220 ^ v82 ^ v212;
  LODWORD(STACK[0x3C90]) = v189;
  STACK[0x3B80] = v228;
  LODWORD(v179) = v179 ^ v201 ^ *(a68 + (v189 ^ v228));
  LODWORD(v212) = v212 ^ LODWORD(STACK[0x3B48]) ^ LODWORD(STACK[0x3B60]);
  v229 = v227 ^ STACK[0x3B70];
  STACK[0x3B70] = v229;
  STACK[0x3120] = v227;
  LODWORD(v201) = *(a68 + v229);
  LODWORD(STACK[0x3A68]) = v201;
  LODWORD(v229) = LODWORD(STACK[0x3C60]) ^ LODWORD(STACK[0x3C98]);
  LODWORD(v213) = *(a68 + (v213 ^ v201));
  STACK[0x2568] = v226;
  LODWORD(v213) = v213 ^ v226;
  STACK[0x3BD0] = v229 ^ v218 ^ v213;
  LODWORD(STACK[0x3C60]) = v213 ^ v187;
  LODWORD(STACK[0x3C10]) = v193 ^ v218 ^ v196;
  LODWORD(STACK[0x3950]) = LODWORD(STACK[0x3CA8]) ^ LODWORD(STACK[0x3CA0]);
  LODWORD(v213) = STACK[0x3C68];
  STACK[0x3B48] = (LODWORD(STACK[0x3BF8]) ^ LODWORD(STACK[0x3C68]));
  STACK[0x2738] = v179 ^ LODWORD(STACK[0x3C88]);
  v230 = v212 ^ v69;
  v231 = v179 ^ v227;
  STACK[0x26C8] = v231;
  STACK[0x3848] = v230;
  v232 = v230 ^ v228;
  STACK[0x3B60] = v232;
  STACK[0x2CE8] = v86 ^ v213 ^ v231 ^ *(a68 + v232);
  v233 = STACK[0x3BC8];
  LODWORD(v231) = *(a68 + (v176 ^ STACK[0x3BC8]));
  LODWORD(STACK[0x3C98]) = v231;
  LODWORD(v229) = v233 ^ STACK[0x1D68];
  LODWORD(v213) = *(a68 + STACK[0x1D68]);
  LODWORD(v218) = *(a68 + (v176 ^ v233 ^ STACK[0x1D68])) ^ v231;
  LODWORD(v69) = STACK[0x1F48];
  LODWORD(v232) = LODWORD(STACK[0x1F48]) ^ LODWORD(STACK[0x1F4C]) ^ v213;
  LODWORD(v213) = v218 ^ v213;
  LODWORD(v154) = v213 ^ v232 ^ LODWORD(STACK[0x1F30]);
  LODWORD(STACK[0x3930]) = v232 ^ v224 ^ v213;
  v234 = STACK[0x3CC0];
  LODWORD(v232) = v203 ^ STACK[0x3CC0];
  LODWORD(v82) = v203;
  LODWORD(v233) = *(a68 + (v203 ^ STACK[0x3CC0]));
  LODWORD(STACK[0x3C68]) = v233;
  LODWORD(v222) = *(a68 + (v223 ^ v131));
  v235 = STACK[0x1DA0];
  LODWORD(v227) = *(a68 + STACK[0x1DA0]);
  v236 = STACK[0x1FA8];
  LODWORD(v203) = *(a68 + STACK[0x1FA8]);
  v237 = v232 ^ STACK[0x1FA8];
  STACK[0x1FA8] = STACK[0x1FA8];
  STACK[0x3A60] = v237;
  LOBYTE(v232) = v223 ^ v131 ^ v235;
  v238 = *(a68 + v237) ^ v233;
  LODWORD(STACK[0x3CA8]) = v238;
  LODWORD(v213) = LODWORD(STACK[0x1FE4]) ^ LODWORD(STACK[0x1F2C]) ^ v203;
  LODWORD(v233) = v213 ^ v73;
  v239 = v213 ^ LODWORD(STACK[0x1FEC]);
  LODWORD(STACK[0x3CA0]) = v131 ^ v235;
  v240 = v239 ^ v235;
  STACK[0x2360] = v240;
  LODWORD(v176) = v240 ^ v131 ^ v238 ^ v203;
  LODWORD(STACK[0x38F8]) = v238 ^ v203 ^ v233;
  v241 = *(a68 + v232) ^ v222;
  LODWORD(v233) = STACK[0x1D74];
  LODWORD(v73) = LODWORD(STACK[0x1EF4]) ^ LODWORD(STACK[0x1D74]) ^ v227;
  v242 = v241 ^ v227;
  LODWORD(v240) = v225 ^ v69;
  LODWORD(STACK[0x3BC8]) = v225 ^ v69;
  LODWORD(v235) = STACK[0x1F20];
  v243 = v73 ^ LODWORD(STACK[0x1F20]) ^ v229;
  LODWORD(v69) = v229;
  STACK[0x38D8] = v241 ^ v227 ^ v243;
  LODWORD(v226) = v218 ^ v240 ^ *(a68 + (v241 ^ v227 ^ v243));
  LODWORD(v229) = STACK[0x3CB0];
  v244 = STACK[0x3BB0];
  LODWORD(v237) = *(a68 + (LODWORD(STACK[0x3CB0]) ^ LODWORD(STACK[0x3BB0])));
  LODWORD(STACK[0x3BE0]) = v237;
  v245 = STACK[0x1D98];
  LODWORD(v131) = v244 ^ STACK[0x1D98];
  LODWORD(STACK[0x3940]) = v131;
  LODWORD(v218) = *(a68 + v245);
  LODWORD(v232) = *(a68 + (v229 ^ v244 ^ v245)) ^ v237;
  v246 = LOBYTE(STACK[0x6730]);
  LODWORD(v245) = LODWORD(STACK[0x1FA0]) ^ STACK[0x1F00] ^ v246 ^ v218;
  LODWORD(v86) = v232 ^ v218;
  LODWORD(v237) = LODWORD(STACK[0x3CF0]) ^ LODWORD(STACK[0x1FA0]);
  LODWORD(STACK[0x3BB0]) = v237;
  LOBYTE(v227) = v131 ^ 0xC;
  LODWORD(v218) = v154 ^ v131 ^ 0xC;
  LODWORD(v237) = LODWORD(STACK[0x3D48]) ^ v237 ^ v232 ^ *(a68 + (v154 ^ v131 ^ 0xC));
  LODWORD(v131) = LODWORD(STACK[0x3D30]) ^ v245 ^ v246 ^ v86;
  LODWORD(v232) = LOBYTE(STACK[0x50A5]);
  LODWORD(STACK[0x3D40]) = v232;
  LODWORD(v232) = v232 ^ v86;
  v247 = STACK[0x1FA4];
  LODWORD(v86) = v82 ^ LODWORD(STACK[0x1FA4]);
  LODWORD(STACK[0x3920]) = v86;
  LOBYTE(v247) = v247 ^ v236 ^ v245 ^ v234 ^ v232;
  LODWORD(v232) = v232 ^ v245 ^ v86;
  LODWORD(v245) = LODWORD(STACK[0x3CE8]) ^ v233;
  LODWORD(STACK[0x3C88]) = v222 ^ v245;
  v248 = v241 ^ v245 ^ *(a68 + v176);
  LODWORD(v233) = STACK[0x3988];
  LODWORD(STACK[0x38D0]) = LODWORD(STACK[0x3988]) ^ v235;
  LODWORD(STACK[0x3BF8]) = v233 ^ v69;
  LODWORD(v245) = v73 ^ v235 ^ v233;
  LODWORD(v73) = v73 ^ LODWORD(STACK[0x3CD8]);
  LODWORD(v82) = v242 ^ v73;
  LODWORD(v245) = v245 ^ v248;
  v249 = v245 ^ v73;
  LOBYTE(v245) = v242 ^ v73 ^ v243 ^ v245;
  LODWORD(v234) = STACK[0x38C8];
  v250 = LODWORD(STACK[0x38C8]) ^ v203 ^ v239;
  STACK[0x23E0] = v226 ^ LODWORD(STACK[0x3CD0]);
  LODWORD(v203) = STACK[0x3930];
  LODWORD(v86) = v229 ^ 0xC;
  STACK[0x3CD0] = v226 ^ LODWORD(STACK[0x3930]);
  v251 = v237 ^ v131;
  LODWORD(v237) = v237 ^ LODWORD(STACK[0x3B68]) ^ *(a68 + (v154 ^ v229 ^ 0xC ^ v218 ^ v226 ^ v203)) ^ LODWORD(STACK[0x3CC8]);
  LODWORD(v73) = *(a68 + v245) ^ v203;
  LODWORD(v235) = v232 ^ v251;
  LODWORD(v232) = *(a68 + (v73 ^ v218));
  v252 = v237 ^ v251;
  STACK[0x2498] = v252;
  LODWORD(v131) = v237 ^ LODWORD(STACK[0x3D68]) ^ v232;
  LODWORD(STACK[0x3908]) = v131;
  LODWORD(v237) = STACK[0x3C20];
  v253 = LODWORD(STACK[0x3C20]) ^ LODWORD(STACK[0x1FE4]);
  LODWORD(v232) = *(a68 + (v247 ^ 0x9DLL)) ^ v253;
  v254 = LODWORD(STACK[0x38F8]) ^ v250 ^ v232;
  LODWORD(v245) = *(a68 + (v254 ^ v176));
  LODWORD(v233) = v245 ^ v82;
  LODWORD(v245) = v248 ^ v245;
  LODWORD(v203) = *(a68 + (v235 ^ v247));
  v255 = v203 ^ LODWORD(STACK[0x38F8]);
  LODWORD(v226) = STACK[0x38F8];
  LODWORD(v187) = v245 ^ *(a68 + (v255 ^ v176));
  LODWORD(STACK[0x3930]) = v187;
  LODWORD(v82) = v232 ^ LODWORD(STACK[0x3CA8]) ^ *(a68 + ((v252 ^ v247) ^ 0x9DLL));
  LOBYTE(v69) = v233 ^ STACK[0x38D8];
  LOBYTE(v245) = v229 ^ 0xC ^ v227 ^ *(a68 + v69);
  LODWORD(v227) = v226 ^ LODWORD(STACK[0x3B78]);
  LODWORD(v226) = v254 ^ v203 ^ v82;
  LODWORD(STACK[0x38F8]) = v226;
  STACK[0x3988] = v226 ^ v255 ^ v176;
  LODWORD(v229) = *(a68 + (v226 ^ v255 ^ v176));
  STACK[0x2F78] = v227 ^ v82;
  STACK[0x22E0] = v229 ^ v233;
  LODWORD(v229) = STACK[0x3C60];
  LODWORD(v233) = LODWORD(STACK[0x3C10]) ^ LODWORD(STACK[0x3C60]) ^ 0xC;
  STACK[0x2388] = v249;
  LODWORD(STACK[0x3CA8]) = v187 ^ v249;
  LODWORD(v227) = *(a68 + (v187 ^ v249 ^ v69));
  STACK[0x3138] = v73 ^ v229 ^ v227;
  STACK[0x3B78] = v218 ^ v233 ^ v227;
  STACK[0x2CB8] = *(a68 + v233) ^ (LODWORD(STACK[0x3C90]) ^ LODWORD(STACK[0x3C80])) ^ LODWORD(STACK[0x3E18]);
  STACK[0x2F88] = v255 ^ STACK[0x3120] ^ v254;
  LODWORD(STACK[0x3C90]) = v131 ^ v235;
  LODWORD(v232) = *(a68 + (v131 ^ v235 ^ v252 ^ v247));
  STACK[0x2D08] = v255 ^ STACK[0x26C8] ^ v226 ^ v232;
  LODWORD(v245) = LODWORD(STACK[0x3D78]) ^ *(a68 + v245);
  LODWORD(STACK[0x38D8]) = v245;
  STACK[0x3768] = v232 ^ v254 ^ *(a68 + (v247 ^ 0x9Du ^ v245));
  v256 = v234 ^ 0xFFFFFF84;
  LODWORD(v226) = v234;
  LODWORD(v249) = v234 ^ 0xFFFFFF84 ^ LODWORD(STACK[0x1FEC]) ^ LODWORD(STACK[0x3938]);
  LODWORD(v73) = LODWORD(STACK[0x3938]) ^ LODWORD(STACK[0x1F2C]) ^ v237;
  LODWORD(v187) = LODWORD(STACK[0x38D0]) ^ LODWORD(STACK[0x3CD8]);
  LODWORD(v131) = LODWORD(STACK[0x3CD8]) ^ LODWORD(STACK[0x1EF4]) ^ LODWORD(STACK[0x3CE8]);
  LODWORD(v233) = LODWORD(STACK[0x3CB0]) ^ LODWORD(STACK[0x3940]);
  v257 = STACK[0x1E38];
  LODWORD(v245) = *(a68 + STACK[0x1E38]);
  v258 = STACK[0x3C70];
  v259 = v86 ^ LODWORD(STACK[0x1F30]) ^ LODWORD(STACK[0x3C70]);
  LODWORD(v234) = *(a68 + (v259 ^ v233));
  LODWORD(STACK[0x3CD8]) = *(a68 + (v259 ^ v233 ^ STACK[0x1E38])) ^ v245 ^ v234;
  LODWORD(v229) = STACK[0x3CC0] ^ STACK[0x1FA8] ^ LODWORD(STACK[0x3CB8]);
  LODWORD(v235) = v258 ^ LODWORD(STACK[0x1F4C]) ^ LODWORD(STACK[0x3BD8]);
  LODWORD(STACK[0x3BD8]) = v235;
  v260 = LODWORD(STACK[0x3D30]) ^ LODWORD(STACK[0x3920]);
  LODWORD(v252) = LODWORD(STACK[0x3D30]) ^ STACK[0x1F00] ^ LODWORD(STACK[0x3CF0]);
  LODWORD(v154) = LODWORD(STACK[0x3C68]) ^ v253;
  LODWORD(v86) = LODWORD(STACK[0x3C98]) ^ LODWORD(STACK[0x3BC8]);
  v261 = STACK[0x1CF0];
  LODWORD(v227) = *(a68 + STACK[0x1CF0]);
  LODWORD(STACK[0x3C60]) = v229 ^ STACK[0x1CF0];
  LOBYTE(v237) = v260 ^ v229;
  LODWORD(STACK[0x3C10]) = v260;
  LOBYTE(v229) = v260 ^ v229 ^ v261;
  LODWORD(v261) = *(a68 + v237);
  LODWORD(STACK[0x3CF0]) = v261;
  LODWORD(v237) = *(a68 + v229);
  LODWORD(STACK[0x38D0]) = v227;
  LODWORD(STACK[0x3CE8]) = v261 ^ v227 ^ v237;
  v262 = STACK[0x3D40];
  LODWORD(v82) = LODWORD(STACK[0x3BB0]) ^ LODWORD(STACK[0x3BE0]) ^ LODWORD(STACK[0x3D40]);
  LODWORD(STACK[0x3940]) = v233 ^ v257;
  LODWORD(v257) = LODWORD(STACK[0x1F40]) ^ LODWORD(STACK[0x1DB0]);
  LODWORD(v261) = v86 ^ LODWORD(STACK[0x1DB0]);
  LODWORD(STACK[0x3BC8]) = v235 ^ LODWORD(STACK[0x1F40]) ^ v86;
  v263 = LOBYTE(STACK[0x5097]) ^ v245;
  LODWORD(v235) = LOBYTE(STACK[0x5097]);
  LODWORD(v237) = STACK[0x1FBC];
  LODWORD(v229) = STACK[0x1ED4];
  LODWORD(v245) = LODWORD(STACK[0x1ED4]) ^ LODWORD(STACK[0x1FBC]) ^ v263;
  LODWORD(v233) = STACK[0x1DD4];
  LODWORD(STACK[0x3B68]) = v245 ^ LODWORD(STACK[0x1DD4]);
  LODWORD(STACK[0x3C20]) = v245 ^ v252;
  LODWORD(STACK[0x3CC8]) = v260 ^ v233 ^ v252;
  LODWORD(STACK[0x3938]) = v252 ^ v237;
  v264 = STACK[0x1D0C];
  LODWORD(v245) = LODWORD(STACK[0x1D0C]) ^ LODWORD(STACK[0x1F74]);
  LODWORD(STACK[0x3CB8]) = v73 ^ LODWORD(STACK[0x1F74]) ^ v154;
  LODWORD(v176) = v154 ^ v264;
  LODWORD(v203) = v235;
  LODWORD(STACK[0x3D30]) = v235;
  LODWORD(STACK[0x3BE0]) = v82 ^ v229 ^ v235 ^ v234;
  LODWORD(v237) = STACK[0x1E48];
  LODWORD(STACK[0x3C98]) = LODWORD(STACK[0x1E48]) ^ v249 ^ 0xFFFFFF84 ^ v73;
  LODWORD(v245) = v245 ^ v227;
  LODWORD(STACK[0x3C80]) = v245 ^ v73;
  LODWORD(v73) = v245 ^ v237;
  LODWORD(v237) = STACK[0x3CA0];
  v265 = v256 ^ LODWORD(STACK[0x3CA0]) ^ v249;
  LODWORD(v154) = *(a68 + (v187 ^ LODWORD(STACK[0x3BF8])));
  LODWORD(v233) = LODWORD(STACK[0x3BF8]) ^ STACK[0x1D78];
  LODWORD(v252) = *(a68 + STACK[0x1D78]);
  LODWORD(v245) = *(a68 + (v187 ^ LODWORD(STACK[0x3BF8]) ^ STACK[0x1D78]));
  STACK[0x2608] = v249 ^ v73 ^ 0xFFFFFF84;
  LODWORD(v234) = v257 ^ v252;
  v266 = v245 ^ v154 ^ v252;
  LODWORD(STACK[0x3CB0]) = v154 ^ v261;
  LODWORD(v86) = v245 ^ v154 ^ v261;
  LODWORD(STACK[0x3BB0]) = v86;
  LODWORD(v154) = *(a68 + STACK[0x1CF8]);
  LODWORD(v227) = v237 ^ STACK[0x1CF8];
  v267 = v265 ^ STACK[0x1CF8];
  STACK[0x3C68] = v267;
  v268 = *(a68 + v267);
  LODWORD(v249) = *(a68 + v265);
  LODWORD(STACK[0x3CA0]) = v227 ^ v226 ^ v73;
  v269 = STACK[0x1E60];
  LODWORD(v237) = STACK[0x3C88];
  LODWORD(STACK[0x3C70]) = LODWORD(STACK[0x3C88]) ^ LODWORD(STACK[0x1E60]) ^ v249;
  LODWORD(v267) = STACK[0x1F9C];
  v270 = v269 ^ LODWORD(STACK[0x1F9C]) ^ v154;
  LODWORD(v69) = v270 ^ LODWORD(STACK[0x1E14]);
  LODWORD(v73) = v187 ^ LODWORD(STACK[0x1E14]);
  STACK[0x26F8] = v268;
  LODWORD(v257) = v268 ^ v154 ^ v249;
  LODWORD(STACK[0x3CC0]) = v187 ^ v233;
  LODWORD(v227) = v257 ^ v69 ^ v187;
  LODWORD(STACK[0x38B8]) = v227;
  LODWORD(v187) = v257 ^ v69 ^ v233;
  LODWORD(STACK[0x38C0]) = v73 ^ v131;
  LODWORD(v226) = v131 ^ v267;
  LODWORD(v131) = v270 ^ v131;
  LODWORD(v268) = v259 ^ LODWORD(STACK[0x1E34]);
  LODWORD(v249) = v266 ^ v234 ^ LODWORD(STACK[0x1E34]);
  LODWORD(v73) = v259 ^ LODWORD(STACK[0x3940]);
  v271 = v249 ^ v259;
  LOBYTE(v249) = v249 ^ LODWORD(STACK[0x3940]);
  LODWORD(v229) = v263 ^ v229;
  v272 = LODWORD(STACK[0x3CD8]) ^ v203;
  LODWORD(STACK[0x3920]) = LODWORD(STACK[0x3938]) ^ v82;
  v273 = v229 ^ v272 ^ v82 ^ v262 ^ *(a68 + v249);
  LODWORD(STACK[0x3CD8]) = v176 ^ LODWORD(STACK[0x3CF0]);
  LODWORD(v233) = v176 ^ LODWORD(STACK[0x38D0]);
  LODWORD(v203) = STACK[0x3C60];
  LODWORD(v176) = STACK[0x3B68];
  v274 = (LODWORD(STACK[0x3B68]) ^ LODWORD(STACK[0x3C60]));
  STACK[0x25F0] = v274;
  v275 = v274 ^ v272;
  v276 = STACK[0x3CE8];
  v277 = v233 ^ LODWORD(STACK[0x3CE8]) ^ *(a68 + (v176 ^ v203 ^ v272));
  LODWORD(v233) = STACK[0x3BD8];
  LODWORD(STACK[0x3CF0]) = v268 ^ LODWORD(STACK[0x3BD8]);
  LODWORD(v274) = v233 ^ v234;
  LODWORD(STACK[0x38A0]) = v226 ^ v237;
  v278 = v154 ^ v237;
  STACK[0x3BD8] = v154 ^ v269;
  LODWORD(v229) = v131 ^ v257;
  STACK[0x2010] = v278;
  LOBYTE(v131) = LODWORD(STACK[0x3CA0]) ^ v276;
  LODWORD(v82) = v276;
  LODWORD(v237) = v278 ^ v269 ^ v257 ^ *(a68 + v131);
  LODWORD(v278) = STACK[0x3C10];
  LODWORD(STACK[0x3828]) = LODWORD(STACK[0x3C10]) ^ v203;
  LODWORD(v261) = LODWORD(STACK[0x3C20]) ^ v272;
  LODWORD(v257) = v272 ^ v278 ^ v176;
  LODWORD(v278) = *(a68 + v187) ^ v86;
  STACK[0x2CD0] = v266;
  LODWORD(v226) = v278 ^ v274 ^ v266;
  v279 = v227 ^ v229;
  LODWORD(v274) = v237 ^ v227 ^ v229;
  LODWORD(STACK[0x3CA0]) = v274;
  LODWORD(v266) = v278 ^ *(a68 + (v274 ^ v187));
  v280 = LODWORD(STACK[0x3D48]) ^ *(a68 + (v226 ^ v73));
  v281 = v271 ^ v266;
  LODWORD(v234) = v266;
  LODWORD(STACK[0x38D0]) = v266;
  LODWORD(v266) = v280 ^ v273 ^ LODWORD(STACK[0x3D50]) ^ *(a68 + (v271 ^ v266 ^ v226 ^ v73));
  STACK[0x2300] = v273;
  v282 = v273 ^ v261;
  STACK[0x3460] = v282;
  LODWORD(v227) = v257 ^ v282;
  LODWORD(v278) = STACK[0x2608] ^ LODWORD(STACK[0x3C80]) ^ v277;
  v283 = *(a68 + (v278 ^ v131));
  LODWORD(v257) = *(a68 + (v257 ^ v273 ^ v261 ^ v275));
  LODWORD(v282) = v82 ^ LODWORD(STACK[0x3C80]);
  STACK[0x3938] = v280;
  LODWORD(v82) = v280 ^ v261;
  LODWORD(STACK[0x3C80]) = v283 ^ v229;
  LODWORD(v280) = v282 ^ v257;
  LOBYTE(v282) = v283 ^ v229 ^ v187;
  LODWORD(v261) = *(a68 + v282);
  LOBYTE(v176) = v82 ^ v275;
  LODWORD(v273) = v82;
  LODWORD(STACK[0x3888]) = v82;
  LODWORD(v229) = *(a68 + (v82 ^ v275));
  STACK[0x2470] = v277;
  LODWORD(v277) = v257 ^ v277;
  LODWORD(STACK[0x38B0]) = v277;
  LOBYTE(v82) = v280 ^ v131;
  LODWORD(v154) = v280;
  LODWORD(STACK[0x3878]) = v280;
  LODWORD(v257) = *(a68 + (v280 ^ v131));
  STACK[0x2E70] = v283;
  LODWORD(v280) = v257 ^ v283;
  LODWORD(v257) = v257 ^ v283 ^ v279;
  LODWORD(v229) = v277 ^ v278 ^ v229;
  v284 = v261 ^ v234 ^ *(a68 + (v257 ^ v282));
  LODWORD(v282) = LODWORD(STACK[0x3C90]) ^ 0xFFFFFFCE;
  LODWORD(v268) = *(a68 + (v229 ^ v82));
  LODWORD(v234) = v268 ^ v257;
  LODWORD(STACK[0x3C60]) = v268 ^ v257;
  LODWORD(v257) = v237 ^ v280;
  LODWORD(v237) = v266 ^ v227;
  LODWORD(v227) = *(a68 + (v266 ^ v227 ^ v176));
  LODWORD(v257) = v234 ^ v257 ^ *(a68 + (v227 ^ v131));
  LODWORD(v277) = STACK[0x22E0] ^ LODWORD(STACK[0x3CA8]);
  LOBYTE(v234) = v284 ^ v281;
  LODWORD(STACK[0x3778]) = v284 ^ v281;
  STACK[0x22C8] = v277 ^ v257;
  v285 = v257 ^ v268 ^ v187;
  STACK[0x38C8] = v285;
  LODWORD(STACK[0x3C90]) = *(a68 + v285) ^ v284;
  LODWORD(STACK[0x3C88]) = v261 ^ v226;
  LOBYTE(v285) = v261 ^ v73;
  LODWORD(v261) = *(a68 + (v261 ^ v73));
  v286 = LOBYTE(STACK[0x6731]);
  LODWORD(STACK[0x3838]) = v286;
  LODWORD(v261) = v286 ^ v261;
  LODWORD(STACK[0x3C20]) = v261 ^ v273;
  v287 = v261 ^ v273 ^ v237;
  STACK[0x2798] = v282 ^ v287;
  LODWORD(v282) = *(a68 + (v268 ^ v187));
  LODWORD(STACK[0x37A8]) = v282;
  v288 = v282 ^ v226 ^ v73;
  STACK[0x3940] = v288;
  LODWORD(STACK[0x3BF8]) = *(a68 + v288) ^ v287;
  LODWORD(STACK[0x3858]) = v227 ^ v154 ^ v229;
  v289 = v261 ^ v266;
  LODWORD(STACK[0x3708]) = v261 ^ v266;
  STACK[0x37C0] = v275;
  v290 = v261 ^ v275;
  STACK[0x3B68] = v290;
  LODWORD(v288) = v227 ^ v278 ^ v227 ^ v154 ^ *(a68 + (v290 ^ 0x53));
  LODWORD(v278) = v289 ^ *(a68 + (v234 ^ v285));
  LODWORD(STACK[0x3738]) = v278;
  LOBYTE(v285) = v290 ^ v237;
  LODWORD(v237) = v278 ^ LODWORD(STACK[0x3D78]);
  LODWORD(STACK[0x36E0]) = v237;
  STACK[0x2158] = v288 ^ *(a68 + (v285 ^ v237));
  LOBYTE(v288) = LODWORD(STACK[0x3CF0]) ^ v73;
  LODWORD(v285) = *(a68 + v288);
  LODWORD(v278) = LODWORD(STACK[0x3CD8]) ^ LODWORD(STACK[0x1DB4]);
  LODWORD(v290) = LODWORD(STACK[0x3CD8]) ^ LODWORD(STACK[0x1D28]);
  v291 = STACK[0x1E24];
  LODWORD(v266) = STACK[0x3BE0];
  LODWORD(STACK[0x3718]) = LODWORD(STACK[0x3BE0]) ^ LODWORD(STACK[0x1E24]) ^ v285;
  v292 = STACK[0x1E50];
  LODWORD(STACK[0x3810]) = v73 ^ STACK[0x1E50];
  LODWORD(v288) = *(a68 + (v288 ^ v292));
  LODWORD(v292) = *(a68 + v292);
  LODWORD(v176) = v288 ^ v285 ^ v292;
  v293 = v292 ^ v291;
  LODWORD(v288) = STACK[0x1D60];
  LODWORD(v268) = STACK[0x3BC8];
  LODWORD(v292) = STACK[0x3CB0];
  LODWORD(STACK[0x3CD8]) = LODWORD(STACK[0x3BC8]) ^ LODWORD(STACK[0x1D60]) ^ LODWORD(STACK[0x3CB0]);
  LODWORD(v292) = v292 ^ LODWORD(STACK[0x1E58]);
  LODWORD(v187) = LODWORD(STACK[0x1E58]) ^ v288;
  LODWORD(v229) = STACK[0x1DE4];
  LODWORD(v226) = STACK[0x38A0];
  LODWORD(v227) = STACK[0x3C70];
  LODWORD(STACK[0x3C10]) = LODWORD(STACK[0x38A0]) ^ LODWORD(STACK[0x1DE4]) ^ LODWORD(STACK[0x3C70]);
  LODWORD(v82) = v227 ^ LODWORD(STACK[0x1DFC]);
  LODWORD(v227) = LODWORD(STACK[0x1DFC]) ^ v229;
  LODWORD(v285) = STACK[0x1F3C];
  LODWORD(v277) = STACK[0x38C0];
  LODWORD(STACK[0x3CB0]) = LODWORD(STACK[0x38C0]) ^ LODWORD(STACK[0x1F3C]) ^ v226;
  v294 = STACK[0x1D00];
  LODWORD(v275) = *(a68 + STACK[0x1D00]);
  LODWORD(v227) = v227 ^ v275;
  LODWORD(STACK[0x3CA8]) = v227 ^ v226;
  v295 = v227 ^ v285;
  v296 = STACK[0x1F60];
  v297 = STACK[0x3C98];
  LODWORD(v229) = STACK[0x3CB8];
  LODWORD(STACK[0x3C70]) = LODWORD(STACK[0x3C98]) ^ STACK[0x1F60] ^ LODWORD(STACK[0x3CB8]);
  v298 = STACK[0x1D48];
  LODWORD(v227) = *(a68 + STACK[0x1D48]);
  LODWORD(STACK[0x3800]) = v290 ^ v229;
  LODWORD(v290) = v290 ^ v278 ^ v227;
  LODWORD(STACK[0x3CB8]) = v290 ^ v229;
  LODWORD(v290) = v290 ^ v296;
  LODWORD(v234) = STACK[0x3CC8];
  LODWORD(v131) = STACK[0x3828];
  v299 = *(a68 + (LODWORD(STACK[0x3CC8]) ^ LODWORD(STACK[0x3828])));
  v300 = STACK[0x3C68];
  LOBYTE(v284) = v297 ^ STACK[0x3C68];
  LODWORD(v296) = v297;
  LODWORD(v273) = *(a68 + (LODWORD(STACK[0x3CC8]) ^ LODWORD(STACK[0x3828]) ^ v298)) ^ v299;
  v301 = v273 ^ v227;
  LODWORD(v290) = v301 ^ v290;
  LODWORD(STACK[0x38A0]) = v296 ^ STACK[0x3C68] ^ v294;
  LODWORD(STACK[0x37F8]) = v290 ^ v296;
  LODWORD(v154) = v290 ^ v300 ^ v294;
  LODWORD(STACK[0x3818]) = v131 ^ v298 ^ v234;
  LODWORD(v280) = v234 ^ LODWORD(STACK[0x1F18]);
  LODWORD(v227) = v298 ^ LODWORD(STACK[0x1F18]) ^ v131;
  LODWORD(v298) = LOBYTE(STACK[0x512C]);
  LODWORD(STACK[0x3C68]) = v298;
  LODWORD(v296) = STACK[0x1F28];
  LODWORD(v226) = v293 ^ LODWORD(STACK[0x1F28]) ^ v298;
  LODWORD(v131) = v227 ^ v226 ^ v298 ^ v176;
  LODWORD(v226) = v226 ^ v298 ^ v176;
  LODWORD(STACK[0x36C8]) = v299 ^ v278;
  LODWORD(STACK[0x3C98]) = v273 ^ v278;
  LODWORD(v300) = STACK[0x3920];
  LODWORD(STACK[0x36A0]) = LODWORD(STACK[0x3920]) ^ v296 ^ v266;
  LODWORD(v278) = v293 ^ v266 ^ v176;
  v302 = v277;
  LODWORD(v273) = *(a68 + (v277 ^ LODWORD(STACK[0x3CC0])));
  v303 = LODWORD(STACK[0x3CC0]) ^ STACK[0x1D80];
  LODWORD(v176) = *(a68 + STACK[0x1D80]);
  LODWORD(v296) = *(a68 + (v277 ^ LODWORD(STACK[0x3CC0]) ^ STACK[0x1D80])) ^ v273;
  LODWORD(v290) = v187 ^ v176;
  LODWORD(v277) = v296 ^ v176;
  LODWORD(v298) = STACK[0x1F24];
  v304 = v187 ^ v176 ^ LODWORD(STACK[0x1F24]);
  LODWORD(v187) = STACK[0x3810];
  v305 = v278 ^ LODWORD(STACK[0x3D30]) ^ *(a68 + (v304 ^ LODWORD(STACK[0x3810]) ^ v296 ^ v176));
  LODWORD(STACK[0x3CC8]) = v273 ^ v292;
  STACK[0x2000] = v176 ^ v292;
  LODWORD(v292) = v296 ^ v292;
  LODWORD(v273) = *(a68 + v284);
  LODWORD(v296) = *(a68 + (v284 ^ v294));
  v306 = v275 ^ v273;
  STACK[0x2F30] = v306;
  LODWORD(v266) = v296 ^ v306;
  LODWORD(v296) = v295 ^ v303;
  LODWORD(v306) = v266 ^ v295 ^ v303;
  LODWORD(v176) = v292 ^ *(a68 + (v266 ^ v295 ^ v303));
  STACK[0x3418] = v280 ^ v300;
  v307 = v280 ^ v226;
  v308 = v226 ^ v300;
  LODWORD(v226) = STACK[0x3CF0];
  LODWORD(STACK[0x3638]) = LODWORD(STACK[0x3CF0]) ^ v298 ^ v268;
  LODWORD(v298) = v268 ^ v290;
  LODWORD(STACK[0x3828]) = v82 ^ v273;
  LODWORD(v300) = v82 ^ v275 ^ *(a68 + v154);
  v309 = v226 ^ v187;
  LODWORD(v82) = v226;
  LODWORD(v298) = LODWORD(STACK[0x3BB0]) ^ v298;
  v310 = v176 ^ LODWORD(STACK[0x3BB0]);
  LODWORD(STACK[0x3BE0]) = v176;
  STACK[0x2408] = v310;
  LODWORD(v298) = v298 ^ v277 ^ v310;
  LOBYTE(v273) = v298 ^ v226 ^ v187;
  STACK[0x26C0] = v309;
  v311 = *(a68 + v273) ^ v305 ^ LODWORD(STACK[0x3D40]);
  LODWORD(STACK[0x3640]) = v302 ^ v303;
  STACK[0x2678] = v301;
  v312 = LODWORD(STACK[0x3CB8]) ^ v301;
  STACK[0x2570] = v312;
  v313 = *(a68 + v131);
  STACK[0x33F8] = v313;
  v314 = v313 ^ LODWORD(STACK[0x3C98]);
  STACK[0x27F0] = v295;
  LODWORD(v301) = STACK[0x3CA8];
  LODWORD(v313) = LODWORD(STACK[0x3CA8]) ^ v302 ^ v295 ^ v300;
  v315 = v313 ^ v296;
  STACK[0x38C0] = v315;
  v316 = v313 ^ v266;
  LODWORD(v295) = STACK[0x37F8];
  LODWORD(v296) = v314 ^ v312 ^ LODWORD(STACK[0x37F8]);
  v317 = v314 ^ v312;
  LODWORD(STACK[0x37D8]) = v314 ^ v312;
  LODWORD(STACK[0x3810]) = v296;
  LODWORD(v313) = v296 ^ v154;
  LODWORD(v296) = *(a68 + (v296 ^ v154)) ^ v266;
  v318 = v296 ^ v300;
  LODWORD(v312) = v296 ^ v301;
  STACK[0x2478] = v304;
  v319 = v304 ^ v82;
  STACK[0x2008] = v305;
  LODWORD(v300) = v308 ^ v305;
  LODWORD(STACK[0x3C98]) = v308 ^ v305;
  LOBYTE(v305) = v307 ^ v131;
  LODWORD(v296) = *(a68 + v315);
  LODWORD(v301) = v300 ^ v307 ^ v131;
  LODWORD(v315) = *(a68 + (v300 ^ v307 ^ v131));
  LODWORD(STACK[0x3CA8]) = v315;
  STACK[0x28D0] = v319;
  v320 = v296 ^ v176;
  LODWORD(v315) = v314 ^ v315;
  LODWORD(v82) = v315 ^ v295;
  LODWORD(STACK[0x3788]) = v315 ^ v295;
  STACK[0x3920] = v315 ^ v295 ^ v313;
  LODWORD(v296) = *(a68 + (v315 ^ v295 ^ v313));
  LODWORD(v300) = v312 ^ v306;
  LODWORD(v176) = v312;
  LODWORD(STACK[0x3750]) = v312;
  LODWORD(v312) = *(a68 + (v312 ^ v306));
  v321 = v277 ^ v319 ^ v320;
  STACK[0x2350] = v312 ^ LODWORD(STACK[0x38D0]);
  LODWORD(v319) = v312 ^ v298;
  STACK[0x3110] = v318;
  LODWORD(v298) = v296 ^ v318;
  STACK[0x2468] = v320;
  LODWORD(v277) = v312 ^ v320;
  LODWORD(STACK[0x3BB0]) = v312 ^ v320;
  LODWORD(v312) = v312 ^ v309;
  LODWORD(v320) = v296 ^ v318 ^ v316;
  LODWORD(v131) = v316;
  STACK[0x3CC0] = v316;
  STACK[0x38D0] = v320 ^ v300;
  LODWORD(v300) = *(a68 + (v320 ^ v300)) ^ v277;
  LODWORD(STACK[0x37F8]) = v300 ^ v321;
  v322 = v300 ^ v321 ^ v312;
  STACK[0x3CF0] = v322;
  LODWORD(v154) = LODWORD(STACK[0x3838]) ^ *(a68 + (v300 ^ v321 ^ v312));
  LOBYTE(v316) = v273 ^ v321;
  STACK[0x2E88] = v307;
  STACK[0x2588] = v311;
  LOBYTE(v296) = v311 ^ v307 ^ v301;
  LODWORD(v307) = v311 ^ v307;
  LODWORD(STACK[0x3758]) = v307;
  LODWORD(v296) = *(a68 + v296);
  v323 = v296 ^ v315;
  STACK[0x2F98] = v323;
  v324 = v296 ^ v317;
  STACK[0x2120] = v324;
  LOBYTE(v318) = v324 ^ v313;
  LODWORD(v324) = *(a68 + (v324 ^ v313));
  v325 = v319 ^ v321;
  v326 = v324 ^ v306;
  v327 = *(a68 + (v324 ^ v306));
  LODWORD(v306) = v300 ^ v319;
  LODWORD(v315) = v300 ^ v327;
  STACK[0x3CB8] = v327 ^ v319;
  LODWORD(v300) = STACK[0x3C80];
  STACK[0x2680] = (LODWORD(STACK[0x3CA0]) ^ LODWORD(STACK[0x3C80]));
  LODWORD(STACK[0x37C8]) = LODWORD(STACK[0x3C60]) ^ v300 ^ v320;
  LODWORD(v300) = LODWORD(STACK[0x3D48]) ^ *(a68 + v316);
  v328 = *(a68 + v312);
  STACK[0x3BC8] = v328;
  LOBYTE(v316) = v300;
  LODWORD(STACK[0x3658]) = v300;
  LODWORD(v328) = v300 ^ v311 ^ LODWORD(STACK[0x3D50]) ^ v328;
  LODWORD(v300) = v325 ^ v315;
  LODWORD(STACK[0x3760]) = v325 ^ v315;
  v329 = *(a68 + (v325 ^ v315 ^ v322));
  LODWORD(v319) = LODWORD(STACK[0x3738]) ^ v328;
  LODWORD(v320) = v328;
  LODWORD(STACK[0x3C60]) = v328;
  LODWORD(STACK[0x3568]) = v154;
  LODWORD(STACK[0x36C0]) = v319 ^ v154 ^ v329;
  LOBYTE(v329) = v316 ^ v305;
  LODWORD(v319) = *(a68 + (v316 ^ v305)) ^ v323;
  LODWORD(v305) = v319 ^ v82;
  LODWORD(v322) = v319;
  LODWORD(STACK[0x36B8]) = v319;
  LODWORD(STACK[0x3720]) = v319 ^ v82;
  LODWORD(v319) = *(a68 + (v319 ^ v82 ^ v318)) ^ v324;
  v330 = v319 ^ v298;
  STACK[0x2788] = v330;
  v331 = v319 ^ v131;
  STACK[0x3838] = v326;
  STACK[0x3CA0] = v331 ^ v326;
  LODWORD(v298) = *(a68 + (v331 ^ v326));
  STACK[0x3480] = v298 ^ v315;
  LODWORD(STACK[0x3588]) = v306 ^ v298;
  LODWORD(v298) = LODWORD(STACK[0x37A8]) ^ LODWORD(STACK[0x3778]);
  LODWORD(STACK[0x36D8]) = v320 ^ v307;
  LODWORD(v320) = *(a68 + (v320 ^ v307 ^ v329));
  LODWORD(STACK[0x3738]) = v320;
  LODWORD(v324) = v324 ^ v176;
  STACK[0x36D0] = v154 ^ v301;
  v332 = v320 ^ v313;
  STACK[0x36E8] = v332;
  LODWORD(v313) = *(a68 + (v320 ^ v313));
  LODWORD(v306) = *(a68 + ((v154 ^ v301) ^ 0x53)) ^ v322;
  LODWORD(STACK[0x37A8]) = v306;
  LODWORD(v306) = v306 ^ v320;
  LODWORD(STACK[0x36F0]) = v306;
  v333 = v306 ^ v305;
  STACK[0x2180] = v333;
  v334 = v333 ^ v332;
  STACK[0x3778] = v334;
  LODWORD(v334) = *(a68 + v334);
  STACK[0x3C80] = v326 ^ v324 ^ v313;
  LODWORD(v334) = v334 ^ v330;
  STACK[0x2560] = v334 ^ v324;
  STACK[0x27E8] = v331;
  STACK[0x2740] = v313 ^ v331 ^ v334;
  LODWORD(v313) = STACK[0x3C90];
  LODWORD(v334) = STACK[0x3C88];
  STACK[0x3090] = (LODWORD(STACK[0x3C90]) ^ LODWORD(STACK[0x3C88]));
  LODWORD(STACK[0x3548]) = v300 ^ v298 ^ v334;
  LODWORD(STACK[0x3558]) = v300 ^ v298 ^ v313;
  LODWORD(v323) = STACK[0x3C68];
  LODWORD(v324) = LODWORD(STACK[0x3718]) ^ LODWORD(STACK[0x3C68]);
  LODWORD(v176) = STACK[0x3638];
  v335 = STACK[0x26C0];
  LODWORD(v298) = *(a68 + (LODWORD(STACK[0x3638]) ^ STACK[0x26C0]));
  v336 = STACK[0x1E08];
  LODWORD(v334) = *(a68 + STACK[0x1E08]);
  LODWORD(v313) = *(a68 + (LODWORD(STACK[0x3638]) ^ STACK[0x26C0] ^ STACK[0x1E08]));
  LODWORD(v322) = LOBYTE(STACK[0x5060]);
  LODWORD(v332) = v322 ^ LODWORD(STACK[0x2168]);
  LODWORD(STACK[0x3628]) = v322;
  LODWORD(STACK[0x3650]) = v298 ^ v324 ^ v332;
  LODWORD(v318) = v334 ^ v298 ^ v313;
  LODWORD(v298) = v334 ^ v332;
  LODWORD(v334) = STACK[0x1DE8];
  v337 = STACK[0x36A0];
  STACK[0x26D8] = LODWORD(STACK[0x36A0]) ^ LODWORD(STACK[0x1DE8]) ^ v324;
  LODWORD(STACK[0x3630]) = v298 ^ v324;
  LODWORD(v324) = v298 ^ v334;
  LODWORD(v313) = STACK[0x1DBC];
  v338 = STACK[0x3800];
  LODWORD(v334) = STACK[0x36C8];
  LODWORD(STACK[0x36B0]) = LODWORD(STACK[0x3800]) ^ LODWORD(STACK[0x1DBC]) ^ LODWORD(STACK[0x36C8]);
  LODWORD(v82) = v334 ^ LODWORD(STACK[0x1F34]);
  LODWORD(v331) = LODWORD(STACK[0x1F34]) ^ v313;
  LODWORD(v313) = STACK[0x21D0];
  v339 = STACK[0x3418];
  STACK[0x2818] = STACK[0x3418] ^ LODWORD(STACK[0x21D0]) ^ v337;
  LODWORD(STACK[0x3C90]) = v324 ^ v337;
  v340 = v324 ^ v313;
  LODWORD(STACK[0x3718]) = v324 ^ v313;
  LODWORD(v298) = STACK[0x1F10];
  LODWORD(v131) = STACK[0x3CB0];
  LODWORD(v313) = STACK[0x3C10];
  LODWORD(STACK[0x36C8]) = LODWORD(STACK[0x3CB0]) ^ LODWORD(STACK[0x1F10]) ^ LODWORD(STACK[0x3C10]);
  v341 = STACK[0x1D90];
  LODWORD(v330) = *(a68 + STACK[0x1D90]);
  LODWORD(v324) = STACK[0x1E20];
  LODWORD(STACK[0x36A0]) = v313 ^ LODWORD(STACK[0x1E20]);
  LODWORD(v326) = STACK[0x1EA8];
  LODWORD(v324) = v324 ^ LODWORD(STACK[0x1EA8]) ^ v330;
  LODWORD(STACK[0x3C88]) = v324 ^ v313;
  LODWORD(STACK[0x3C10]) = v324 ^ v298;
  LODWORD(v313) = *(a68 + (v339 ^ LODWORD(STACK[0x3818])));
  LODWORD(v334) = LODWORD(STACK[0x3818]) ^ STACK[0x1E40];
  LOBYTE(v324) = v339 ^ LODWORD(STACK[0x3818]) ^ STACK[0x1E40];
  LODWORD(v298) = *(a68 + STACK[0x1E40]);
  LODWORD(v320) = STACK[0x3C70];
  LOBYTE(v307) = LODWORD(STACK[0x3C70]) ^ LODWORD(STACK[0x38A0]);
  LODWORD(v316) = LODWORD(STACK[0x38A0]) ^ v341;
  v342 = v331 ^ v298;
  LODWORD(v339) = STACK[0x1E4C];
  LODWORD(v331) = LODWORD(STACK[0x3C70]) ^ LODWORD(STACK[0x1E4C]);
  STACK[0x24A0] = LODWORD(STACK[0x3C70]) ^ v316;
  v343 = v342 ^ v339 ^ v320;
  LODWORD(STACK[0x3608]) = v331 ^ v338;
  LODWORD(v324) = *(a68 + v324) ^ v313;
  STACK[0x2DD8] = v342;
  v344 = v324 ^ v298 ^ v342 ^ v338;
  v345 = v342 ^ v339 ^ v316 ^ v324 ^ v298;
  LODWORD(v316) = STACK[0x3640];
  LOBYTE(v331) = v131 ^ LODWORD(STACK[0x3640]);
  LODWORD(v131) = *(a68 + v331);
  LODWORD(STACK[0x3530]) = v131;
  LODWORD(v154) = v335 ^ v336;
  LODWORD(v316) = v316 ^ STACK[0x1DF0];
  v346 = *(a68 + STACK[0x1DF0]);
  LODWORD(v342) = *(a68 + (v331 ^ STACK[0x1DF0])) ^ v131;
  LODWORD(v331) = STACK[0x1F54];
  v347 = LODWORD(STACK[0x1F44]) ^ LODWORD(STACK[0x1F54]) ^ v346;
  LODWORD(v339) = STACK[0x1D64];
  LODWORD(v131) = v176;
  LODWORD(STACK[0x3528]) = v176 ^ LODWORD(STACK[0x1D64]);
  LODWORD(v176) = v347 ^ v339;
  STACK[0x1FF0] = v346;
  v348 = v342 ^ v346;
  LODWORD(v176) = v348 ^ v176;
  LODWORD(STACK[0x3640]) = v131 ^ v154;
  v349 = v176 ^ v131;
  LODWORD(v318) = v318 ^ v322;
  v350 = LODWORD(STACK[0x3630]) ^ v318;
  v351 = (v176 ^ v154);
  v352 = v176 ^ v154;
  LODWORD(v351) = *(a68 + v351);
  STACK[0x3458] = v350;
  LODWORD(v176) = v323 ^ v350 ^ v351;
  STACK[0x24A8] = v82 ^ v313;
  LODWORD(v323) = v334;
  STACK[0x38A0] = v340 ^ v334 ^ v318;
  LODWORD(v334) = v82 ^ *(a68 + (v340 ^ v334 ^ v318));
  LODWORD(v351) = STACK[0x3828];
  LODWORD(STACK[0x35F0]) = LODWORD(STACK[0x36A0]) ^ LODWORD(STACK[0x3828]);
  LODWORD(STACK[0x35E0]) = v351 ^ v326;
  v353 = v345;
  LODWORD(v351) = v351 ^ v326 ^ v330 ^ *(a68 + v345);
  v354 = v334 ^ v324;
  STACK[0x23D8] = v343;
  LODWORD(v343) = v344 ^ v298 ^ v343 ^ v334;
  v355 = *(a68 + v307);
  STACK[0x2A28] = v355;
  v356 = *(a68 + (v307 ^ v341));
  STACK[0x28C0] = v356;
  LODWORD(v82) = v330 ^ v355 ^ v356;
  LODWORD(v324) = LODWORD(STACK[0x3CC8]) ^ v331;
  LODWORD(STACK[0x34F8]) = v324;
  LODWORD(v355) = v342 ^ v324;
  LODWORD(STACK[0x36A0]) = v342 ^ v324;
  STACK[0x2460] = v347;
  LODWORD(v324) = v347 ^ LODWORD(STACK[0x3CD8]);
  STACK[0x22F8] = v348;
  LODWORD(v324) = v324 ^ v348;
  v357 = v82 ^ LODWORD(STACK[0x3C10]);
  LODWORD(v342) = v357 ^ v316;
  LODWORD(v334) = *(a68 + (v357 ^ v316)) ^ v355;
  v358 = v334 ^ v324;
  STACK[0x34A8] = v358;
  STACK[0x3038] = v349;
  LOBYTE(v341) = v334 ^ v324 ^ v349 ^ v352;
  LOBYTE(v307) = v352;
  STACK[0x3510] = v352;
  LODWORD(v349) = v358 ^ v349;
  LODWORD(STACK[0x3550]) = v349;
  LODWORD(v341) = *(a68 + v341);
  LODWORD(v358) = STACK[0x3D30];
  LODWORD(v355) = v176;
  LODWORD(STACK[0x3638]) = v176;
  LODWORD(v345) = v341 ^ v176 ^ v358;
  LODWORD(v356) = STACK[0x3CB0];
  v359 = v357 ^ LODWORD(STACK[0x3CB0]);
  LOBYTE(v347) = v353;
  STACK[0x3818] = v353;
  LODWORD(v331) = v343;
  LODWORD(STACK[0x3538]) = v343;
  LODWORD(v341) = *(a68 + (v343 ^ v353));
  LODWORD(STACK[0x3590]) = v356 ^ v316;
  LODWORD(STACK[0x35D0]) = v334 ^ LODWORD(STACK[0x3BE0]);
  LODWORD(v358) = STACK[0x3C88];
  LODWORD(v326) = v82 ^ LODWORD(STACK[0x3C88]);
  v360 = v341 ^ v326;
  STACK[0x2FA0] = v360;
  v361 = v360 ^ v342;
  STACK[0x35A0] = v361;
  LODWORD(v334) = *(a68 + v361) ^ v334;
  LODWORD(v353) = v351 ^ v358;
  LODWORD(STACK[0x3610]) = v351 ^ v358;
  v362 = STACK[0x3418];
  LODWORD(v323) = STACK[0x3418] ^ v323;
  LODWORD(v358) = LODWORD(STACK[0x3C90]) ^ v318;
  LODWORD(STACK[0x3630]) = v358;
  v363 = v355 ^ v358;
  LODWORD(STACK[0x3508]) = v323;
  STACK[0x2930] = v363;
  STACK[0x3C10] = v363 ^ v323;
  LODWORD(v330) = *(a68 + (v355 ^ v358 ^ v323));
  STACK[0x2348] = v344;
  LOBYTE(v343) = v330 ^ v344 ^ v347;
  v364 = v330 ^ v344;
  LODWORD(v351) = v351 ^ v82 ^ *(a68 + v343);
  v365 = v351 ^ v341;
  STACK[0x34B8] = v351 ^ v326;
  v366 = LODWORD(STACK[0x3718]) ^ v362;
  STACK[0x3060] = v366;
  LODWORD(v366) = v318 ^ v366;
  LODWORD(v355) = v359 ^ v353;
  LODWORD(STACK[0x3570]) = v359 ^ v353;
  v367 = *(a68 + (v359 ^ v353 ^ v342));
  STACK[0x3130] = v367;
  STACK[0x3718] = v354;
  LODWORD(v330) = v330 ^ v354;
  LODWORD(STACK[0x35E8]) = v330;
  LODWORD(STACK[0x3520]) = v345;
  v368 = v366 ^ v345;
  STACK[0x2658] = v368;
  v369 = *(a68 + (v366 ^ v345 ^ v363 ^ v323));
  v370 = v367 ^ v324;
  LODWORD(STACK[0x3618]) = v334 ^ v324;
  v371 = v334 ^ v367;
  LODWORD(v334) = v369 ^ v330;
  v372 = v369 ^ v330 ^ v331;
  LOBYTE(v369) = v369 ^ v330 ^ v331 ^ v343;
  LODWORD(v362) = v372;
  STACK[0x27C0] = v372;
  LODWORD(STACK[0x34E8]) = v365 ^ v355;
  STACK[0x2188] = v365;
  LODWORD(v330) = *(a68 + (v365 ^ v355 ^ v361));
  LOBYTE(v341) = v370 ^ v307;
  STACK[0x2DC8] = v370;
  LODWORD(STACK[0x3C70]) = v371 ^ v349;
  LODWORD(v326) = *(a68 + v369);
  LODWORD(v361) = *(a68 + (v371 ^ v349 ^ v370 ^ v307)) ^ v345 ^ LODWORD(STACK[0x3D48]);
  LODWORD(STACK[0x33F0]) = v361;
  v373 = v326 ^ v342;
  v374 = *(a68 + (v326 ^ v342));
  STACK[0x3C88] = v371;
  STACK[0x1FF8] = v371 ^ v330 ^ LODWORD(STACK[0x3BB0]);
  LODWORD(v82) = v374 ^ v371 ^ v330;
  LODWORD(v349) = STACK[0x3D78];
  STACK[0x2800] = LODWORD(STACK[0x3D78]) ^ *(a68 + STACK[0x1FC8]);
  v375 = LODWORD(STACK[0x3CA8]) ^ STACK[0x2570];
  LODWORD(v372) = LODWORD(STACK[0x3658]) ^ LODWORD(STACK[0x3C98]);
  LODWORD(STACK[0x3468]) = v372;
  LODWORD(v366) = LODWORD(STACK[0x3568]) ^ v372;
  LODWORD(v345) = STACK[0x36E0];
  LODWORD(v355) = STACK[0x36C0];
  STACK[0x24B0] = v366 ^ LODWORD(STACK[0x36E0]) ^ LODWORD(STACK[0x36C0]);
  LODWORD(v331) = STACK[0x3588];
  STACK[0x3CB0] = (LODWORD(STACK[0x3548]) ^ LODWORD(STACK[0x3588]));
  v376 = *(a68 + STACK[0x3C80]) ^ STACK[0x3480];
  STACK[0x3CA8] = LODWORD(STACK[0x3558]) ^ v376;
  LODWORD(STACK[0x34F0]) = v376 ^ v331;
  LOBYTE(v376) = v331 ^ STACK[0x3CF0];
  v377 = v345 ^ 0x53;
  STACK[0x2748] = v377;
  v378 = v355 ^ v377;
  v379 = *(a68 + v376);
  LODWORD(v377) = LODWORD(STACK[0x3D40]) ^ *(a68 + v341);
  STACK[0x1AF0] = v375;
  STACK[0x3BE0] = v364;
  STACK[0x26E0] = v364 ^ v375 ^ v334;
  LODWORD(v375) = v377 ^ v323;
  STACK[0x3800] = v377 ^ v323;
  LODWORD(v341) = *(a68 + (v377 ^ v323));
  LODWORD(v372) = v341 ^ v334;
  LODWORD(STACK[0x3490]) = v341 ^ v334;
  LOBYTE(v371) = v330 ^ STACK[0x3510];
  LODWORD(v331) = v330 ^ v370;
  v380 = v341 ^ STACK[0x3818];
  LODWORD(v370) = *(a68 + (v341 ^ STACK[0x3818]));
  LODWORD(v363) = v377 ^ v363;
  LODWORD(STACK[0x3358]) = v363;
  LODWORD(v377) = v361 ^ v377;
  LODWORD(v334) = LODWORD(STACK[0x3D50]) ^ *(a68 + v371);
  v381 = v377 ^ v368;
  STACK[0x1C48] = v381;
  LODWORD(v368) = v377;
  LODWORD(STACK[0x33E8]) = v377;
  STACK[0x3818] = v381 ^ v375;
  LODWORD(v377) = *(a68 + (v381 ^ v375));
  STACK[0x3478] = v377 ^ LODWORD(STACK[0x36B8]);
  LODWORD(v370) = v370 ^ v365;
  LODWORD(STACK[0x3340]) = v370;
  v382 = v377 ^ v372;
  STACK[0x2580] = v382;
  LODWORD(v381) = STACK[0x3C70];
  STACK[0x3470] = v82 ^ LODWORD(STACK[0x3C70]);
  LOBYTE(v377) = v82 ^ v381 ^ v371;
  v383 = *(a68 + v377);
  STACK[0x2600] = v382 ^ v362;
  LODWORD(v323) = v380;
  STACK[0x3308] = v380;
  LODWORD(v371) = *(a68 + (v382 ^ v362 ^ v380));
  v384 = v326 ^ STACK[0x2FA0];
  LODWORD(v370) = v370 ^ v326;
  LODWORD(v362) = STACK[0x34E8];
  LODWORD(STACK[0x3370]) = v370 ^ LODWORD(STACK[0x34E8]);
  LODWORD(v372) = v373;
  STACK[0x3C90] = v373;
  STACK[0x36B8] = v370 ^ v362 ^ v373;
  LODWORD(v380) = *(a68 + (v370 ^ v362 ^ v373));
  LODWORD(STACK[0x33C8]) = v380;
  LODWORD(STACK[0x3368]) = v331;
  v385 = v82 ^ v331;
  v386 = v82 ^ v380;
  LODWORD(v381) = v381 ^ v331;
  LODWORD(STACK[0x3390]) = v381;
  LODWORD(v381) = v386 ^ v381;
  STACK[0x2F68] = v386;
  LODWORD(STACK[0x3398]) = v381;
  LODWORD(v381) = *(a68 + (v381 ^ v377));
  LODWORD(STACK[0x36C0]) = v381;
  LODWORD(v326) = v349 ^ v381;
  LODWORD(v375) = v368 ^ LODWORD(STACK[0x3D68]);
  STACK[0x3828] = v383;
  LODWORD(STACK[0x3348]) = v383 ^ v375;
  STACK[0x3058] = v384;
  LODWORD(STACK[0x3328]) = v371 ^ v384;
  v387 = v371 ^ v384 ^ v372;
  LODWORD(v331) = v387;
  STACK[0x32C8] = v387;
  LODWORD(v82) = *(a68 + v387);
  STACK[0x3BB0] = v385;
  LODWORD(STACK[0x3330]) = v82 ^ v385;
  LODWORD(v377) = *(a68 + (v82 ^ v385 ^ v377));
  LODWORD(STACK[0x33D0]) = v334 ^ v363;
  LODWORD(v387) = v349 ^ v381 ^ v334 ^ v363;
  LODWORD(STACK[0x3300]) = v387;
  v388 = v383 ^ v375 ^ v334;
  STACK[0x1AF8] = v388;
  v389 = v388 ^ v326;
  STACK[0x2858] = v389;
  STACK[0x2FB0] = v378;
  LODWORD(STACK[0x32E8]) = v378 ^ v379;
  LODWORD(STACK[0x32E0]) = v378 ^ v379 ^ v387 ^ v389 ^ v377;
  v390 = v341 ^ v364;
  STACK[0x3500] = v390;
  STACK[0x23D0] = v334 ^ LODWORD(STACK[0x3C60]);
  v391 = v334 ^ STACK[0x3C10];
  STACK[0x32D0] = v391;
  LODWORD(v391) = *(a68 + v391);
  LODWORD(STACK[0x32D8]) = v391;
  LODWORD(v390) = v391 ^ v390;
  LODWORD(STACK[0x3320]) = v390;
  v392 = v390 ^ v323;
  STACK[0x3D78] = v392;
  LODWORD(v334) = *(a68 + v392) ^ v371;
  LODWORD(STACK[0x3510]) = v334 ^ v370;
  v393 = v334 ^ v362;
  LODWORD(STACK[0x3C60]) = v334 ^ v362;
  LODWORD(v375) = LODWORD(STACK[0x3528]) ^ LODWORD(STACK[0x3CD8]);
  v394 = (LODWORD(STACK[0x3CD8]) ^ LODWORD(STACK[0x1F44])) ^ LODWORD(STACK[0x3CC8]);
  STACK[0x2640] = v394;
  LODWORD(v392) = LODWORD(STACK[0x3530]) ^ LODWORD(STACK[0x34F8]);
  LODWORD(v389) = STACK[0x1D08];
  LODWORD(v334) = LODWORD(STACK[0x1D08]) ^ LODWORD(STACK[0x1E9C]);
  LODWORD(STACK[0x3658]) = v394 ^ LODWORD(STACK[0x1E9C]) ^ v392;
  LODWORD(v341) = v392 ^ v389;
  LODWORD(STACK[0x34E8]) = LODWORD(STACK[0x3BF8]) ^ v345;
  LODWORD(v394) = STACK[0x3C20];
  STACK[0x1C80] = v345 ^ LODWORD(STACK[0x3C20]);
  STACK[0x2CF0] = LODWORD(STACK[0x3708]) ^ 0x53u;
  LODWORD(v392) = v366 ^ LODWORD(STACK[0x36D8]);
  STACK[0x2458] = v366 ^ v394;
  STACK[0x22A0] = v394 ^ 0x53;
  v395 = STACK[0x36D0];
  STACK[0x1C90] = STACK[0x36D0] ^ STACK[0x3B68];
  LODWORD(v392) = v392 ^ STACK[0x24B0];
  STACK[0x3CD8] = v392 ^ v395;
  LODWORD(STACK[0x32B8]) = v392 ^ 0x53;
  STACK[0x21E0] = v393 ^ v331;
  LODWORD(STACK[0x32C0]) = *(a68 + (v393 ^ v331)) ^ v82;
  STACK[0x2DA8] = v386 ^ STACK[0x3480] ^ v82;
  v396 = STACK[0x24A0];
  LODWORD(v345) = STACK[0x3608];
  LOBYTE(v323) = LODWORD(STACK[0x3608]) ^ STACK[0x24A0];
  LODWORD(v392) = *(a68 + v323);
  v397 = LODWORD(STACK[0x35E0]) ^ STACK[0x2A28];
  LODWORD(v394) = STACK[0x2278];
  LODWORD(v377) = STACK[0x35F0];
  LODWORD(v331) = STACK[0x2278];
  LODWORD(STACK[0x2278]) = STACK[0x2278];
  LODWORD(STACK[0x17A4]) = v377 ^ v394 ^ v397;
  LODWORD(v389) = STACK[0x1DAC];
  LODWORD(v366) = v397 ^ LODWORD(STACK[0x1DAC]);
  LODWORD(v385) = STACK[0x1D5C];
  LODWORD(v395) = STACK[0x36C8];
  STACK[0x2638] = LODWORD(STACK[0x36C8]) ^ LODWORD(STACK[0x1D5C]) ^ v377;
  v398 = STACK[0x1F90];
  LODWORD(v371) = *(a68 + STACK[0x1F90]);
  v399 = v389 ^ v331 ^ v371;
  LODWORD(STACK[0x3CC8]) = v399 ^ v377;
  LODWORD(v386) = v399 ^ v385;
  STACK[0x3440] = v392 ^ v366;
  LODWORD(STACK[0x3C20]) = v371 ^ v392;
  LODWORD(STACK[0x3BF8]) = v371 ^ v366;
  LODWORD(v378) = STACK[0x3590];
  LODWORD(v377) = v395;
  LODWORD(v371) = *(a68 + (v395 ^ LODWORD(STACK[0x3590])));
  v400 = STACK[0x1F80];
  STACK[0x3528] = v395 ^ LODWORD(STACK[0x3590]) ^ STACK[0x1F80];
  LODWORD(v370) = *(a68 + (v395 ^ v378 ^ v400)) ^ v371;
  LODWORD(STACK[0x36D8]) = v341 ^ v371;
  LODWORD(v389) = STACK[0x3640];
  LODWORD(v366) = v375;
  LODWORD(v371) = *(a68 + (v375 ^ LODWORD(STACK[0x3640])));
  LODWORD(v395) = v400;
  STACK[0x1F80] = v400;
  LODWORD(v368) = *(a68 + v400);
  LODWORD(v334) = v334 ^ v368;
  LODWORD(v392) = v370 ^ v368;
  STACK[0x33B8] = v368 ^ v341;
  LODWORD(v362) = v370 ^ v341;
  LODWORD(STACK[0x1F54]) = v370 ^ v341;
  v401 = STACK[0x1DC0];
  LODWORD(v341) = v389 ^ STACK[0x1DC0];
  STACK[0x36D0] = v375 ^ v341;
  LODWORD(v82) = LOBYTE(STACK[0x5056]);
  LODWORD(v370) = *(a68 + (v375 ^ v389 ^ v401)) ^ v371 ^ v82;
  v402 = STACK[0x3650];
  LODWORD(v82) = LODWORD(STACK[0x3650]) ^ LODWORD(STACK[0x2178]) ^ v82;
  LODWORD(STACK[0x17A0]) = v82 ^ v371;
  LODWORD(v371) = *(a68 + v401);
  LODWORD(v384) = v370 ^ v371;
  v403 = v82 ^ v371;
  LODWORD(v400) = v82 ^ v370;
  LODWORD(STACK[0x17F8]) = v82 ^ v370;
  LODWORD(v331) = STACK[0x3508];
  v404 = STACK[0x2818] ^ LODWORD(STACK[0x3508]);
  STACK[0x3548] = v404;
  LODWORD(v371) = *(a68 + v404);
  v405 = v386 ^ v377;
  LODWORD(v401) = v378 ^ v395 ^ v386;
  v406 = STACK[0x24A8];
  LODWORD(v386) = STACK[0x24A8] ^ LODWORD(STACK[0x1EA0]);
  v407 = STACK[0x1E18];
  v408 = v404 ^ STACK[0x1E18];
  STACK[0x36C8] = v408;
  LODWORD(v370) = *(a68 + v408) ^ v371;
  LODWORD(STACK[0x1EA0]) = v371 ^ v386;
  LODWORD(v377) = LODWORD(STACK[0x36B0]) ^ LODWORD(STACK[0x1D8C]) ^ v406;
  LODWORD(v371) = LODWORD(STACK[0x36B0]) ^ LODWORD(STACK[0x1F50]);
  v409 = *(a68 + v407);
  LODWORD(v406) = v370 ^ v409;
  LODWORD(v408) = v370 ^ v386;
  LODWORD(STACK[0x1F34]) = v370 ^ v386;
  STACK[0x2A68] = v409;
  LODWORD(STACK[0x1D8C]) = v377;
  v410 = v377 ^ v386 ^ v409;
  LODWORD(v370) = v345;
  STACK[0x3640] = v371 ^ v345;
  LODWORD(v386) = v406 ^ v410 ^ v371;
  LOBYTE(v345) = v398;
  STACK[0x1F90] = v398;
  LODWORD(STACK[0x3B68]) = v370 ^ v396 ^ v398;
  LODWORD(v370) = v386 ^ v370;
  v411 = v386 ^ v396 ^ v398;
  LODWORD(v386) = v334 ^ STACK[0x2640];
  LODWORD(v371) = STACK[0x1DB8];
  v412 = v334 ^ LODWORD(STACK[0x1DB8]);
  LODWORD(v377) = v386 ^ v392;
  STACK[0x22A8] = v412;
  LODWORD(v392) = v392 ^ v412;
  LODWORD(v409) = v392 ^ v366;
  LODWORD(STACK[0x32B0]) = v366 ^ v371;
  v413 = v392 ^ v341;
  LODWORD(v341) = v400 ^ LODWORD(STACK[0x3628]) ^ *(a68 + (v392 ^ v341));
  LODWORD(v392) = v402 ^ LODWORD(STACK[0x2170]);
  LODWORD(STACK[0x32A0]) = v392;
  STACK[0x2CF8] = v403;
  v414 = v403 ^ v392;
  LODWORD(v392) = v414 ^ LODWORD(STACK[0x1F0C]);
  LODWORD(v403) = v414;
  STACK[0x2750] = v414;
  v415 = v392 ^ v407;
  v416 = *(a68 + (v323 ^ v345));
  STACK[0x25F8] = v416;
  v417 = LODWORD(STACK[0x3C20]) ^ v416;
  LODWORD(v366) = LODWORD(STACK[0x3BF8]) ^ v417;
  STACK[0x2730] = v415;
  v418 = v384 ^ v331 ^ v415;
  STACK[0x22E8] = v410;
  v419 = v406 ^ v410;
  LODWORD(v414) = *(a68 + v418);
  v420 = v411;
  LODWORD(v416) = *(a68 + v411);
  v421 = v401 ^ v417;
  LODWORD(v331) = LODWORD(STACK[0x3CC8]) ^ v417;
  v422 = *(a68 + (v401 ^ v417)) ^ v362;
  LODWORD(STACK[0x1EA8]) = v366;
  LODWORD(v366) = v416 ^ v366;
  LODWORD(v371) = v414 ^ v408;
  STACK[0x3708] = v417;
  STACK[0x3CC8] = v405;
  LODWORD(STACK[0x1F10]) = v417 ^ v405;
  LODWORD(STACK[0x1DE4]) = v366 ^ v331;
  LODWORD(v405) = v366 ^ v331 ^ v417 ^ v405;
  LODWORD(STACK[0x1F3C]) = v405;
  STACK[0x33B0] = v405 ^ v421;
  LODWORD(v408) = *(a68 + (v405 ^ v401 ^ v417));
  STACK[0x2FF8] = v419;
  LODWORD(STACK[0x1E4C]) = v370;
  LODWORD(STACK[0x1D28]) = v371 ^ v419;
  v423 = v371 ^ v419 ^ v370;
  STACK[0x36B0] = v423 ^ v420;
  STACK[0x1F60] = v423;
  v424 = v420;
  LODWORD(v423) = *(a68 + (v371 ^ v419 ^ v370 ^ v420));
  LODWORD(v417) = v422;
  STACK[0x23F0] = v422;
  LODWORD(v422) = v408 ^ v422;
  v425 = v413;
  v426 = v408 ^ v377 ^ v413;
  LODWORD(v420) = v408 ^ v377;
  LODWORD(STACK[0x1F40]) = v408 ^ v377;
  STACK[0x3650] = v426;
  LODWORD(v408) = *(a68 + (v408 ^ v377 ^ v413));
  LODWORD(STACK[0x1E20]) = v331;
  LODWORD(STACK[0x1F9C]) = v423 ^ v331;
  v427 = v423 ^ v331 ^ v421;
  STACK[0x34F8] = v421;
  LODWORD(v413) = v427;
  STACK[0x3568] = v427;
  LODWORD(v416) = *(a68 + v427);
  LODWORD(STACK[0x1DB0]) = v422;
  LODWORD(v422) = v416 ^ v422;
  LODWORD(STACK[0x1F44]) = v377;
  LODWORD(STACK[0x1D64]) = v409;
  LODWORD(STACK[0x1D60]) = v417 ^ v377;
  LODWORD(v416) = v417 ^ v377 ^ v409;
  v428 = v422 ^ v416;
  LODWORD(v417) = v416;
  LODWORD(STACK[0x1F24]) = v416;
  LODWORD(v377) = v422;
  LODWORD(STACK[0x1F48]) = v422;
  v429 = v428 ^ v426;
  LODWORD(v426) = v428;
  STACK[0x26B8] = v428;
  STACK[0x35F0] = v429;
  v430 = LODWORD(STACK[0x3D30]) ^ v408;
  LODWORD(v409) = LODWORD(STACK[0x3D40]) ^ *(a68 + v429);
  LODWORD(v429) = v384 ^ STACK[0x26D8] ^ v403;
  LODWORD(v392) = STACK[0x2818] ^ v392;
  LODWORD(STACK[0x33E4]) = v384;
  STACK[0x3530] = v425;
  STACK[0x3628] = v417 ^ v425;
  v431 = *(a68 + (v417 ^ v425));
  LODWORD(STACK[0x1F28]) = v341 ^ v429;
  LODWORD(STACK[0x21D0]) = v384 ^ v392;
  LODWORD(v392) = v341 ^ v429 ^ v384 ^ v392;
  STACK[0x3608] = v392 ^ v418;
  LODWORD(v428) = v392;
  LODWORD(STACK[0x1F18]) = v392;
  v432 = *(a68 + (v392 ^ v418));
  STACK[0x2590] = v431;
  LODWORD(v392) = LODWORD(STACK[0x3C68]) ^ v431;
  LODWORD(STACK[0x1E24]) = v341;
  LODWORD(v403) = v392 ^ v341;
  LODWORD(STACK[0x1ED4]) = v392 ^ v341;
  LODWORD(STACK[0x1DE8]) = v429;
  LODWORD(v392) = v392 ^ v429;
  LODWORD(STACK[0x1FBC]) = v392;
  LODWORD(STACK[0x1DFC]) = v366;
  LODWORD(v429) = v423 ^ v366;
  STACK[0x34D8] = v418;
  LODWORD(v431) = v392 ^ v418;
  STACK[0x3590] = v392 ^ v418;
  LODWORD(v423) = *(a68 + (v392 ^ v418));
  LODWORD(STACK[0x1F74]) = v432 ^ v419;
  STACK[0x34E0] = v424;
  LODWORD(v401) = v432 ^ v419 ^ v424;
  STACK[0x35E0] = v401;
  LODWORD(v392) = *(a68 + (v432 ^ v419 ^ v424));
  LODWORD(STACK[0x1E60]) = v429;
  v433 = v392 ^ v429;
  LODWORD(v392) = v433 ^ v405;
  v434 = v433;
  v435 = v433 ^ v405 ^ v413;
  STACK[0x3D40] = v435;
  LODWORD(v366) = v392;
  LODWORD(STACK[0x1F20]) = v392;
  LODWORD(v392) = *(a68 + v435);
  STACK[0x2E80] = v432;
  LODWORD(STACK[0x1DB4]) = v371;
  LODWORD(v432) = v432 ^ v371;
  LODWORD(STACK[0x1D0C]) = v432;
  LODWORD(v432) = v423 ^ v432;
  LODWORD(v423) = v432 ^ v371 ^ v419 ^ v370;
  LODWORD(v419) = v432;
  LODWORD(STACK[0x1FE4]) = v432;
  v436 = v423 ^ v401;
  STACK[0x3558] = v436;
  LODWORD(v401) = v423;
  LODWORD(STACK[0x1FEC]) = v423;
  LODWORD(v423) = *(a68 + v436);
  STACK[0x2210] = v430;
  LODWORD(v436) = v430 ^ v403 ^ v428;
  LODWORD(STACK[0x1FA0]) = v430 ^ v403;
  LODWORD(STACK[0x1FA4]) = v436;
  v437 = v436 ^ v431;
  STACK[0x3508] = v437;
  LODWORD(v370) = *(a68 + v437);
  v438 = v392 ^ v425;
  LODWORD(v437) = *(a68 + (v392 ^ v425));
  LODWORD(STACK[0x3298]) = v409;
  v439 = v409 ^ v430 ^ v403;
  STACK[0x3588] = v439;
  LODWORD(v362) = v437 ^ v439 ^ LODWORD(STACK[0x3D48]);
  STACK[0x2358] = v434;
  LODWORD(v431) = v423 ^ v434;
  LODWORD(STACK[0x1ECC]) = v423 ^ v434;
  LODWORD(v403) = STACK[0x1F9C];
  LODWORD(v439) = v423 ^ LODWORD(STACK[0x1F9C]);
  STACK[0x3BF8] = v409 ^ v418;
  v440 = *(a68 + (v409 ^ v418));
  LODWORD(v371) = v423 ^ v421;
  STACK[0x3428] = v423 ^ v421;
  LODWORD(v423) = *(a68 + (v423 ^ v421));
  LODWORD(v437) = v377 ^ v392;
  LODWORD(v421) = v392 ^ v420;
  LODWORD(STACK[0x1FE8]) = v392 ^ v420;
  LODWORD(v420) = v370;
  LODWORD(STACK[0x3290]) = v370;
  v441 = v370 ^ v424;
  STACK[0x3280] = v441;
  LODWORD(v392) = *(a68 + (v370 ^ v424));
  LODWORD(STACK[0x1F14]) = v437;
  LODWORD(v370) = v423 ^ v437;
  LODWORD(v437) = v392 ^ v431;
  LODWORD(STACK[0x1EF4]) = v434 ^ v403;
  LODWORD(v434) = v392 ^ v434 ^ v403;
  LODWORD(STACK[0x1FB4]) = v434;
  LODWORD(v403) = v370;
  LODWORD(STACK[0x1EF0]) = v370;
  STACK[0x3288] = v438;
  v442 = v370 ^ v426 ^ v438;
  STACK[0x3438] = v442;
  LODWORD(v370) = v370 ^ v426;
  LODWORD(STACK[0x1FB0]) = v370;
  LODWORD(v392) = *(a68 + v442);
  LODWORD(STACK[0x1D54]) = v420 ^ v419;
  STACK[0x2F38] = v440;
  LODWORD(v442) = v420 ^ v419 ^ v440;
  LODWORD(STACK[0x1F8C]) = v442;
  LODWORD(v442) = v442 ^ v401;
  LODWORD(STACK[0x1F78]) = v442;
  v443 = v442 ^ v441;
  STACK[0x3420] = v443;
  v444 = *(a68 + v443);
  LODWORD(v431) = STACK[0x3D50];
  LODWORD(v401) = LODWORD(STACK[0x3D50]) ^ v392;
  LODWORD(STACK[0x3D48]) = v401;
  LODWORD(STACK[0x1ED8]) = v439;
  v445 = v434 ^ v439 ^ v366;
  LODWORD(v439) = v439 ^ v366;
  LODWORD(STACK[0x1FD4]) = v439;
  STACK[0x2840] = v445;
  LODWORD(v366) = v445 ^ v371;
  STACK[0x3278] = v445 ^ v371;
  LODWORD(v445) = *(a68 + (v445 ^ v371));
  LODWORD(v440) = v445 ^ v403;
  LODWORD(v434) = v445 ^ v421;
  LODWORD(STACK[0x1F7C]) = v445 ^ v421;
  STACK[0x2610] = v444;
  LODWORD(STACK[0x1E2C]) = v437;
  LODWORD(STACK[0x1FC0]) = v444 ^ v437;
  LODWORD(v445) = v444 ^ v437 ^ v439;
  LODWORD(STACK[0x1FB8]) = v445;
  STACK[0x3378] = v445 ^ v366;
  LODWORD(v445) = *(a68 + (v445 ^ v366));
  LODWORD(v438) = v434 ^ v438;
  STACK[0x3310] = v438;
  v446 = *(a68 + v438);
  LODWORD(STACK[0x1CCC]) = v401 ^ v362;
  LODWORD(v444) = v401 ^ v362 ^ LODWORD(STACK[0x3D68]);
  LODWORD(STACK[0x1D1C]) = v440;
  LODWORD(v445) = v445 ^ v440;
  LODWORD(STACK[0x1EEC]) = v445;
  LODWORD(v445) = v445 ^ v370;
  LODWORD(STACK[0x1F70]) = v445;
  v447 = v445 ^ v438;
  STACK[0x32A8] = v447;
  LODWORD(v447) = *(a68 + v447);
  STACK[0x3C20] = v446;
  LODWORD(v440) = v446 ^ v444;
  LODWORD(STACK[0x1F08]) = v446 ^ v444;
  LODWORD(v444) = LODWORD(STACK[0x36C0]) ^ STACK[0x2858];
  v448 = STACK[0x1AF8];
  v449 = v440 ^ STACK[0x1AF8];
  STACK[0x3D30] = v449;
  LODWORD(STACK[0x1FC4]) = v449 ^ v444 ^ v447;
  LODWORD(v444) = STACK[0x3C00];
  STACK[0x2548] = (LODWORD(STACK[0x3D10]) ^ LODWORD(STACK[0x3C00]));
  STACK[0x2558] = v444 ^ STACK[0x3C18];
  LODWORD(v444) = STACK[0x3A68];
  STACK[0x2438] = (LODWORD(STACK[0x3BC0]) ^ LODWORD(STACK[0x3A68]));
  v450 = v444 ^ LODWORD(STACK[0x3BF0]);
  STACK[0x1C78] = LODWORD(STACK[0x3BF0]) ^ STACK[0x2490];
  STACK[0x2448] = LODWORD(STACK[0x3950]) ^ STACK[0x26C8];
  STACK[0x2398] = v450;
  STACK[0x3C68] = LODWORD(STACK[0x3930]) ^ v450;
  v451 = STACK[0x2498];
  STACK[0x21B8] = LODWORD(STACK[0x3908]) ^ STACK[0x2498];
  STACK[0x36E0] = LODWORD(STACK[0x38D8]) ^ v451;
  STACK[0x3048] = LODWORD(STACK[0x3CE8]) ^ STACK[0x2608];
  LODWORD(v449) = STACK[0x3858];
  STACK[0x36C0] = (LODWORD(STACK[0x3858]) ^ LODWORD(STACK[0x38F8]));
  LODWORD(v438) = STACK[0x3E18];
  STACK[0x3BF0] = (LODWORD(STACK[0x34E8]) ^ LODWORD(STACK[0x3E18]));
  v452 = STACK[0x3CC0];
  STACK[0x2900] = STACK[0x3CC0] ^ LODWORD(STACK[0x38B8]);
  STACK[0x2D00] = v452 ^ LODWORD(STACK[0x3750]);
  LODWORD(v440) = STACK[0x3468];
  STACK[0x2910] = (LODWORD(STACK[0x3468]) ^ LODWORD(STACK[0x3888]));
  STACK[0x3030] = STACK[0x2F98] ^ LODWORD(STACK[0x38B0]);
  LODWORD(v434) = v440;
  STACK[0x2990] = v440 ^ LODWORD(STACK[0x3758]);
  v453 = STACK[0x2120];
  STACK[0x2368] = STACK[0x2120] ^ LODWORD(STACK[0x3878]);
  STACK[0x2D10] = v431 ^ STACK[0x3BC8];
  LODWORD(v450) = LODWORD(STACK[0x3738]) ^ v453;
  STACK[0x2830] = LODWORD(STACK[0x37C8]) ^ STACK[0x2788];
  v454 = v450 ^ LODWORD(STACK[0x3720]);
  LODWORD(v452) = *(a68 + STACK[0x3CD8]);
  STACK[0x2340] = v454 ^ v449;
  LODWORD(v449) = v452 ^ v450;
  LODWORD(v431) = v452 ^ v450 ^ STACK[0x36E8];
  LODWORD(v441) = STACK[0x36F0];
  LODWORD(v425) = v452 ^ LODWORD(STACK[0x36F0]);
  STACK[0x3CD8] = LODWORD(STACK[0x35D0]) ^ STACK[0x3130];
  LODWORD(v452) = STACK[0x3C98];
  STACK[0x2118] = STACK[0x2588] ^ LODWORD(STACK[0x3C98]);
  v455 = STACK[0x2930];
  LODWORD(v370) = STACK[0x3520];
  v456 = LODWORD(STACK[0x3520]) ^ STACK[0x2930];
  STACK[0x34E8] = v456;
  STACK[0x26A0] = v456 ^ v452;
  v457 = STACK[0x3BE0];
  STACK[0x22C0] = STACK[0x3BE0] ^ LODWORD(STACK[0x37D8]);
  LODWORD(v403) = v457 ^ LODWORD(STACK[0x3538]);
  STACK[0x34A0] = v403 ^ LODWORD(STACK[0x3810]);
  STACK[0x2E58] = STACK[0x27C0] ^ LODWORD(STACK[0x3788]);
  LODWORD(v418) = LODWORD(STACK[0x33F0]) ^ v455;
  STACK[0x2390] = v418 ^ v434;
  STACK[0x2870] = STACK[0x3470] ^ LODWORD(STACK[0x37F8]);
  STACK[0x2268] = LODWORD(STACK[0x3340]) ^ STACK[0x2FA0];
  LODWORD(v434) = LODWORD(STACK[0x32E8]) ^ v438;
  LODWORD(v438) = STACK[0x32E0];
  v458 = v434 ^ LODWORD(STACK[0x32E0]);
  STACK[0x26A8] = v458;
  v459 = STACK[0x1C48];
  v460 = v448 ^ STACK[0x1C48];
  STACK[0x3148] = v460;
  LODWORD(v455) = STACK[0x3300];
  STACK[0x2308] = LODWORD(STACK[0x32B8]) ^ v460 ^ LODWORD(STACK[0x3300]);
  LODWORD(STACK[0x3930]) = v458 ^ v460 ^ v455;
  LOBYTE(v420) = v455 ^ STACK[0x32D0];
  LODWORD(v456) = *(a68 + (v448 ^ v459 ^ STACK[0x32D0])) ^ STACK[0x2580];
  v461 = v456 ^ LODWORD(STACK[0x32D8]);
  v462 = STACK[0x2600];
  v463 = v461 ^ STACK[0x2600];
  STACK[0x2F08] = v461;
  STACK[0x2578] = v463;
  v464 = STACK[0x3D78];
  v465 = v463 ^ STACK[0x3D78];
  STACK[0x3D10] = v465;
  v466 = *(a68 + (v461 ^ v462 ^ v464));
  LODWORD(v426) = STACK[0x3370];
  LODWORD(v463) = STACK[0x3328];
  STACK[0x33F0] = (LODWORD(STACK[0x3328]) ^ LODWORD(STACK[0x3370]));
  LODWORD(v413) = LODWORD(STACK[0x3C60]) ^ v463;
  STACK[0x2F70] = v466;
  STACK[0x2790] = v413 ^ v466;
  LODWORD(v464) = STACK[0x2DC8] ^ LODWORD(STACK[0x3550]);
  LODWORD(v401) = STACK[0x3368];
  LODWORD(v413) = LODWORD(STACK[0x33C8]) ^ LODWORD(STACK[0x3368]);
  v467 = STACK[0x26D8];
  LODWORD(STACK[0x17FC]) = LODWORD(STACK[0x32A0]) ^ STACK[0x26D8];
  LODWORD(v421) = STACK[0x2740] ^ STACK[0x3C80];
  v468 = v466 ^ STACK[0x3C90];
  STACK[0x3D50] = v468;
  STACK[0x3A68] = v421 ^ v468;
  v469 = *(a68 + v420);
  LODWORD(v424) = STACK[0x3330];
  v470 = LODWORD(STACK[0x3330]) ^ STACK[0x2F68] ^ LODWORD(STACK[0x32C0]);
  LODWORD(v384) = STACK[0x3390];
  STACK[0x3720] = (LODWORD(STACK[0x32C0]) ^ LODWORD(STACK[0x3390]));
  v471 = v469 ^ STACK[0x3308];
  STACK[0x1C40] = v471;
  STACK[0x3468] = v431 ^ v471;
  STACK[0x23E8] = v449 ^ STACK[0x2180];
  LODWORD(v471) = STACK[0x3320];
  v472 = v469 ^ LODWORD(STACK[0x3320]);
  STACK[0x25C8] = v472;
  STACK[0x2378] = v472 ^ v449;
  LODWORD(v472) = STACK[0x34F0];
  STACK[0x2CE0] = LODWORD(STACK[0x34F0]) ^ STACK[0x3090];
  STACK[0x3C00] = v470;
  STACK[0x2520] = v470 ^ v472;
  LODWORD(v470) = v456 ^ STACK[0x3500];
  STACK[0x2DB0] = v425 ^ v469;
  STACK[0x2E60] = v438 ^ STACK[0x24B0];
  STACK[0x30B8] = v465 ^ STACK[0x3778];
  STACK[0x1AE8] = LODWORD(STACK[0x37A8]) ^ v453;
  STACK[0x24F8] = v461 ^ v441;
  LODWORD(v465) = STACK[0x3358];
  STACK[0x3810] = (LODWORD(STACK[0x3348]) ^ LODWORD(STACK[0x3358]));
  STACK[0x32B8] = STACK[0x32C8] ^ STACK[0x3CA0];
  LODWORD(v472) = STACK[0x3398];
  STACK[0x27B8] = (LODWORD(STACK[0x3398]) ^ LODWORD(STACK[0x3760]));
  LODWORD(STACK[0x3D68]) = STACK[0x2818] ^ LODWORD(STACK[0x1F0C]) ^ v467;
  ...
  LODWORD(v467) = STACK[0x1F9C];
  STACK[0x23C8] = (LODWORD(STACK[0x1F9C]) ^ LODWORD(STACK[0x3610]));
  LODWORD(v456) = v467 ^ LODWORD(STACK[0x1F3C]);
  LODWORD(STACK[0x1E14]) = v456;
  STACK[0x2D18] = v456 ^ LODWORD(STACK[0x3570]);
  STACK[0x2950] = LODWORD(STACK[0x1FA0]) ^ v370;
  STACK[0x2A40] = (LODWORD(STACK[0x1FE4]) ^ LODWORD(STACK[0x35E8]));
  v473 = STACK[0x26B8];
  STACK[0x2860] = v464 ^ STACK[0x26B8];
  STACK[0x2768] = LODWORD(STACK[0x1FEC]) ^ v403;
  STACK[0x3010] = STACK[0x3D40] ^ STACK[0x35A0];
  v474 = (LODWORD(STACK[0x3298]) ^ LODWORD(STACK[0x1FBC]));
  STACK[0x2888] = v465 ^ STACK[0x2658];
  v475 = v474 ^ v465;
  v476 = v474;
  STACK[0x23C0] = v475;
  LODWORD(v449) = STACK[0x1FE8];
  STACK[0x2CD8] = (LODWORD(STACK[0x3618]) ^ LODWORD(STACK[0x1FE8]));
  LODWORD(v441) = LODWORD(STACK[0x3290]) ^ LODWORD(STACK[0x1F74]);
  LODWORD(STACK[0x1EDC]) = v441;
  LODWORD(STACK[0x1ED0]) = v449 ^ v473;
  STACK[0x3520] = v449 ^ v473 ^ LODWORD(STACK[0x3C70]);
  STACK[0x1C38] = v362 ^ LODWORD(STACK[0x33E8]);
  LODWORD(v473) = STACK[0x3490];
  STACK[0x2868] = STACK[0x3478] ^ LODWORD(STACK[0x3490]);
  LODWORD(v474) = STACK[0x1F8C];
  STACK[0x2F58] = LODWORD(STACK[0x1F8C]) ^ v473;
  LODWORD(v473) = v476;
  STACK[0x2D98] = v476;
  LODWORD(STACK[0x1CB4]) = v362 ^ v476;
  STACK[0x2500] = v362 ^ v476 ^ v418;
  LODWORD(v475) = LODWORD(STACK[0x1EF0]) ^ v449;
  LODWORD(STACK[0x1F58]) = v475;
  STACK[0x25D8] = v475 ^ v401;
  STACK[0x2198] = LODWORD(STACK[0x1FB0]) ^ v384;
  LODWORD(STACK[0x1E84]) = v362;
  LODWORD(v403) = v362 ^ LODWORD(STACK[0x1FA4]);
  v477 = STACK[0x3BF8];
  STACK[0x3CE8] = v403 ^ STACK[0x3BF8];
  LODWORD(v475) = *(a68 + (v403 ^ v477));
  LODWORD(v438) = v475 ^ v441;
  v478 = LODWORD(STACK[0x3D48]) ^ v473;
  LODWORD(v473) = STACK[0x33D0];
  STACK[0x3C80] = v478 ^ LODWORD(STACK[0x33D0]);
  LODWORD(STACK[0x1F5C]) = v478 ^ v403;
  STACK[0x2F20] = v473 ^ v459 ^ v478 ^ v403;
  v479 = STACK[0x3280];
  v480 = v475 ^ v441 ^ STACK[0x3280];
  LODWORD(v473) = *(a68 + (v475 ^ v441 ^ STACK[0x3280]));
  v481 = v478 ^ v477;
  LODWORD(v418) = v478;
  STACK[0x2410] = v478;
  LODWORD(v478) = *(a68 + v481);
  LODWORD(v453) = STACK[0x1FB8];
  STACK[0x2F90] = LODWORD(STACK[0x1FB8]) ^ v426;
  LODWORD(STACK[0x1DEC]) = v475 ^ v474;
  LODWORD(v441) = v478 ^ v475 ^ v474;
  LODWORD(v426) = v473 ^ LODWORD(STACK[0x1FC0]);
  LODWORD(v401) = v473 ^ LODWORD(STACK[0x1FB4]);
  STACK[0x2940] = v413 ^ STACK[0x3CB8];
  LODWORD(v362) = STACK[0x1F7C];
  LODWORD(v461) = STACK[0x1EEC];
  STACK[0x3D48] = LODWORD(STACK[0x1EEC]) ^ LODWORD(STACK[0x1F7C]) ^ v413;
  LODWORD(v473) = v471 ^ v462;
  LODWORD(STACK[0x1F38]) = v438;
  LODWORD(STACK[0x1E74]) = v441 ^ v438;
  STACK[0x3950] = v441 ^ v438 ^ v471;
  LODWORD(v370) = v424;
  STACK[0x22B8] = v424 ^ v472;
  STACK[0x2F10] = LODWORD(STACK[0x1F70]) ^ v472;
  STACK[0x2690] = v454;
  STACK[0x2380] = v471 ^ v462 ^ v454;
  LODWORD(v471) = v441 ^ LODWORD(STACK[0x1F78]);
  LODWORD(v454) = v441;
  LODWORD(STACK[0x1F1C]) = v441;
  STACK[0x28F8] = v471 ^ v473;
  v482 = v471 ^ v480;
  STACK[0x1EF8] = v482;
  STACK[0x21E8] = v482 ^ STACK[0x3D78];
  v483 = STACK[0x3278];
  v484 = v401 ^ STACK[0x3278];
  LODWORD(v473) = *(a68 + (v401 ^ STACK[0x3278]));
  LODWORD(STACK[0x1D34]) = v403;
  LODWORD(v462) = STACK[0x1F08];
  LODWORD(v425) = LODWORD(STACK[0x1F08]) ^ v403;
  STACK[0x21D8] = v425 ^ v481;
  v485 = *(a68 + (v462 ^ v403 ^ v481));
  LODWORD(v474) = *(a68 + (v471 ^ v438 ^ v479));
  LODWORD(STACK[0x1E78]) = v461 ^ v362;
  LODWORD(v413) = v485 ^ v438;
  STACK[0x2450] = v470 ^ v485 ^ v438;
  LODWORD(v403) = v473 ^ v461;
  STACK[0x35A0] = v461 ^ v362 ^ v370 ^ v473 ^ v461;
  LODWORD(STACK[0x1D58]) = v426;
  LODWORD(v478) = v474 ^ v426;
  LODWORD(v474) = v474 ^ v426 ^ v453;
  STACK[0x3BC0] = v474 ^ LODWORD(STACK[0x3C60]);
  LODWORD(STACK[0x1F6C]) = v473 ^ v362;
  v486 = STACK[0x3288];
  v487 = v473 ^ STACK[0x3288];
  STACK[0x1EB0] = v487;
  v488 = *(a68 + v487);
  LODWORD(STACK[0x1D88]) = v474;
  STACK[0x1EC0] = v474 ^ v484;
  LODWORD(v487) = *(a68 + (v474 ^ v401 ^ v483));
  STACK[0x1EB8] = v485 ^ v479;
  LODWORD(v474) = *(a68 + (v485 ^ v479));
  STACK[0x2108] = v488;
  v489 = LODWORD(STACK[0x3E18]) ^ v488;
  STACK[0x3C98] = v489;
  LODWORD(v453) = LODWORD(STACK[0x1FC4]) ^ v462 ^ v418;
  STACK[0x1EE0] = v453 ^ v481;
  LODWORD(v488) = *(a68 + (v453 ^ v481));
  STACK[0x25B8] = v485;
  LODWORD(v485) = v485 ^ v454;
  LODWORD(STACK[0x21D4]) = v485;
  LODWORD(v485) = v488 ^ v485;
  STACK[0x28F0] = v469;
  STACK[0x2DB8] = v469 ^ STACK[0x2F08] ^ v485;
  LODWORD(STACK[0x1E30]) = v403;
  STACK[0x1818] = v487 ^ v403;
  LODWORD(v487) = LODWORD(STACK[0x3510]) ^ STACK[0x2F70];
  v490 = v474 ^ v478;
  STACK[0x1820] = v490;
  STACK[0x3788] = v487 ^ v490;
  LODWORD(STACK[0x1CE0]) = v453;
  LODWORD(STACK[0x1EA4]) = v462 ^ v418;
  LODWORD(v469) = v489 ^ v462 ^ v418;
  LODWORD(STACK[0x1D40]) = v453 ^ v425;
  v491 = v469 ^ v453 ^ v425;
  STACK[0x1808] = v491;
  STACK[0x31B8] = LODWORD(STACK[0x3930]) ^ v491;
  STACK[0x17C8] = v474 ^ v401;
  STACK[0x3E18] = *(v68 + 8 * SLODWORD(STACK[0x3D28]));
  ...
  v500 = STACK[0x3C90];
  LODWORD(STACK[0x21CC]) = v483 ^ STACK[0x3C90];
  STACK[0x1DD8] = v483;
  STACK[0x2220] = v483;
  ...
  STACK[0x2528] = STACK[0x2580] ^ v502;
  STACK[0x2540] = STACK[0x25C8] ^ STACK[0x2578];
  LODWORD(v481) = STACK[0x1FBC];
  STACK[0x3590] = LODWORD(STACK[0x1FBC]) ^ STACK[0x2930];
  LODWORD(v490) = STACK[0x1F40];
  v503 = LODWORD(STACK[0x1F40]) ^ STACK[0x34A8];
  v504 = LODWORD(STACK[0x1F18]);
  LODWORD(STACK[0x1DD4]) = v481 ^ v504;
  LODWORD(STACK[0x1E34]) = v490 ^ LODWORD(STACK[0x1F24]);
  v505 = STACK[0x1F60];
  v506 = LODWORD(STACK[0x1F74]) ^ STACK[0x1F60];
  v507 = LODWORD(STACK[0x1FA0]) ^ v481;
  LODWORD(STACK[0x1F2C]) = LODWORD(STACK[0x1FE4]) ^ LODWORD(STACK[0x1F74]);
  LODWORD(STACK[0x1F4C]) = LODWORD(STACK[0x1F48]) ^ v490;
  STACK[0x2508] = LODWORD(STACK[0x1ECC]) ^ STACK[0x2188];
  v508 = LODWORD(STACK[0x1FA4]);
  v509 = STACK[0x2D98];
  v510 = STACK[0x2D98] ^ v508;
  LODWORD(v486) = STACK[0x1EDC];
  LODWORD(STACK[0x1CE8]) = LODWORD(STACK[0x1EDC]) ^ LODWORD(STACK[0x1FEC]);
  LODWORD(v501) = LODWORD(STACK[0x1F8C]) ^ v486;
  LODWORD(STACK[0x1CEC]) = v501;
  STACK[0x26E8] = v501 ^ v502;
  LODWORD(STACK[0x1EAC]) = LODWORD(STACK[0x1FC0]) ^ LODWORD(STACK[0x1FB4]);
  v511 = LODWORD(STACK[0x1F7C]);
  LODWORD(STACK[0x1E5C]) = v511 ^ LODWORD(STACK[0x1FB0]);
  v512 = (LODWORD(STACK[0x1F38]) ^ LODWORD(STACK[0x1F78]));
  v513 = v512 ^ STACK[0x2600];
  LODWORD(STACK[0x1D30]) = v425;
  v514 = STACK[0x3148];
  STACK[0x3128] = v425 ^ STACK[0x3148];
  v515 = LODWORD(STACK[0x1FB8]);
  v516 = v401 ^ v515;
  LODWORD(STACK[0x1E98]) = v401;
  LODWORD(STACK[0x1E7C]) = v478;
  LODWORD(STACK[0x1CE4]) = v478 ^ v401;
  LODWORD(v478) = STACK[0x1F70];
  LODWORD(v490) = STACK[0x1F6C];
  LODWORD(STACK[0x1D18]) = LODWORD(STACK[0x1F6C]) ^ LODWORD(STACK[0x1F70]);
  LODWORD(STACK[0x1D14]) = v413 ^ v471;
  v517 = STACK[0x1EC0];
  STACK[0x2538] = STACK[0x1EC0] ^ STACK[0x21E0];
  LODWORD(STACK[0x17AC]) = STACK[0x3C98] ^ LODWORD(STACK[0x1FC4]);
  LODWORD(STACK[0x17BC]) = v469;
  v518 = STACK[0x26A8];
  STACK[0x33D0] = v469 ^ STACK[0x26A8];
  v519 = STACK[0x1818];
  v520 = STACK[0x1818] ^ v490;
  LODWORD(STACK[0x1E80]) = v413;
  STACK[0x1800] = v485 ^ v413;
  v521 = v519 ^ v478;
  STACK[0x1BB0] = v521 ^ STACK[0x3720];
  LODWORD(STACK[0x1838]) = v485;
  LODWORD(STACK[0x1D3C]) = v471;
  v522 = v485 ^ v471;
  v523 = STACK[0x1EE0];
  v524 = STACK[0x1808] ^ STACK[0x1EE0];
  v525 = STACK[0x1EB0];
  v526 = v521 ^ STACK[0x1EB0];
  v527 = STACK[0x1820] ^ v516;
  STACK[0x17C0] = v522;
  LODWORD(v522) = v522 ^ STACK[0x1EB8];
  LODWORD(STACK[0x17A8]) = v522;
  STACK[0x2288] = v522 ^ STACK[0x1C40];
  STACK[0x3000] = LODWORD(STACK[0x1F5C]);
  STACK[0x2280] = v505;
  STACK[0x28E0] = LODWORD(STACK[0x1FD4]);
  LODWORD(STACK[0x1F50]) = STACK[0x3640];
  STACK[0x17F0] = v527 ^ v517;
  STACK[0x3B98] = v527 ^ v517;
  STACK[0x3BF8] = v512;
  LODWORD(STACK[0x1E64]) = v512;
  ...
  LODWORD(STACK[0x1D38]) = v516;
  STACK[0x2028] = v516;
  STACK[0x28A8] = v510;
  LODWORD(STACK[0x1E28]) = v510;
  LODWORD(STACK[0x1F30]) = STACK[0x26B8];
  STACK[0x2998] = STACK[0x2118];
  STACK[0x26D0] = v506;
  LODWORD(STACK[0x1E48]) = v506;
