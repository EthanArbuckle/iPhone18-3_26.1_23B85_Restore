...
- (NSXPCInterface)driverInterface
{
  if (qword_10002B710 != -1)
  {
    dispatch_once(&qword_10002B710, &stru_1000245D8);
  }
...
- (NSXPCInterface)managerInterface
{
  if (qword_10002B700 != -1)
  {
    dispatch_once(&qword_10002B700, &stru_1000245B8);
  }
...
- (void)handleDisposeWithCompletionHandler:(id)a3
{
  ...
  block[0] = _NSConcreteStackBlock;
  block[1] = 3221225472;
  block[2] = sub_100006B54;
  block[3] = &unk_100024598;
  v9 = v4;
  v7 = v4;
  dispatch_async(&self->super, block);
}
