...
- (TransparencyGPBInt64Array)initWithCapacity:(unint64_t)capacity;
- (TransparencyGPBInt64Array)initWithValues:(const int64_t *)values count:(unint64_t)count;
...
- (TransparencyGPBInt64Array)initWithCapacity:(unint64_t)capacity
{
  ...
  if (capacity && v4)
  {
    [(TransparencyGPBInt64Array *)v4 internalResizeToCapacity:capacity];
  }
...
- (id)copyWithZone:(_NSZone *)zone
{
  v4 = [TransparencyGPBInt64Array allocWithZone:zone];
  values = self->_values;
  count = self->_count;
