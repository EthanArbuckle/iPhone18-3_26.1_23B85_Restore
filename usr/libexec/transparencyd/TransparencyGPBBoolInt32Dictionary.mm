...
- (TransparencyGPBBoolInt32Dictionary)initWithDictionary:(id)dictionary;
- (TransparencyGPBBoolInt32Dictionary)initWithInt32s:(const int *)int32s forKeys:(const BOOL *)keys count:(unint64_t)count;
...
- (id)copyWithZone:(_NSZone *)zone
{
  v4 = [TransparencyGPBBoolInt32Dictionary allocWithZone:zone];
