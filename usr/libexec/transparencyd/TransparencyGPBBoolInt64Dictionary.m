...
- (void)enumerateForTextFormat:(id)a3
{
  if (self->_valueSet[0])
  {
    (*(a3 + 2))(a3, @"false", [NSString stringWithFormat:@"%lld", self->_values[0]]);
  }
...
- (unint64_t)computeSerializedSizeAsField:(id)a3
{
  ...
  do
  {
    ...
    if (valueSet[v3])
    {
      ++v4;
      v12 = sub_1001717D8(1);
      v13 = sub_100176A08(values[v3], 2, v7) + v12;
...
- (void)writeToCodedOutputStream:(id)a3 asField:(id)a4
{
  ...
  do
  {
    ...
    if (valueSet[v10])
    {
      ...
      v15 = sub_1001717D8(1);
      [a3 writeInt32NoTag:{sub_100176A08(values[v10], 2, v7) + v15}];
      [a3 writeBool:1 value:v9 & 1];
      sub_100176BA8(a3, values[v10], 2, v7);
    }
