...
- (TransparencyPublicKeyBag)initWithPublicKeysResponse:(id)a3 application:(id)a4 settings:(id)a5 allowOldKeys:(BOOL)a6 error:(id *)a7
{
  ...
  else
  {
    ...
    v21 = qword_10039C910;
    a7 = v15;
    if (os_log_type_enabled(qword_10039C910, OS_LOG_TYPE_ERROR))
    {
      v22 = v21;
...
LABEL_38:
            ...
            v48 = qword_10039C910;
            if (os_log_type_enabled(qword_10039C910, OS_LOG_TYPE_INFO))
            {
              *buf = 0;
...
- (BOOL)verifyCertificates:(id)a3 intermediates:(id)a4 application:(id)a5 error:(id *)a6
{
  ...
  if ([v13 allowsInternalSecurityPolicies])
  {
    ...
    if (v15)
    {
      ...
      v16 = qword_10039C910;
      if (os_log_type_enabled(qword_10039C910, OS_LOG_TYPE_DEFAULT))
      {
        *buf = 0;
