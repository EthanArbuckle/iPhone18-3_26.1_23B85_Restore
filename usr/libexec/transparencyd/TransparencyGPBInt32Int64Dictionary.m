...
- (void)enumerateKeysAndInt64sUsingBlock:(id)a3
{
  ...
  do
  {
    ...
    (*(a3 + 2))(a3, [v6 intValue], objc_msgSend(-[NSMutableDictionary objectForKeyedSubscript:](dictionary, "objectForKeyedSubscript:", v6), "longLongValue"), &v7);
  }
...
- (void)writeToCodedOutputStream:(id)a3 asField:(id)a4
{
  ...
  if (v12)
  {
    ...
    do
    {
      ...
      v17 = sub_100175800(v15, 1, v8);
      [a3 writeInt32NoTag:{sub_100176A08(v16, 2, v7) + v17}];
      sub_1001759A0(a3, v15, 1, v8);
      sub_100176BA8(a3, v16, 2, v7);
      v13 = [v11 nextObject];
    }
