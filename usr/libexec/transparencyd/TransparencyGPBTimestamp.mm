...
+ (id)descriptor
{
  result = qword_10039C650;
  if (!qword_10039C650)
  {
    LODWORD(v3) = 28;
    result = [TransparencyGPBDescriptor allocDescriptorForClass:TransparencyGPBTimestamp messageName:@"Timestamp" fileDescription:off_100389070 fields:&off_100389030 fieldCount:2 storageSize:16 flags:v3];
    qword_10039C650 = result;
  }
