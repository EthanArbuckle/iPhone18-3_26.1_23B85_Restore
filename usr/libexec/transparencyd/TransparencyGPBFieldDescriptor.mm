...
- (TransparencyGPBFieldDescriptor)initWithFieldDescription:(void *)description descriptorFlags:(unsigned int)flags
{
  ...
  v7->getSel_ = v11;
  v12 = sub_100172EC8("set", v9->var0, 0, 1);
  if (v12)
  {
    v13 = v12;
  }
  ...
  else
  {
    ...
    v23 = sub_100172EC8("has", v9->var0, 0, 0);
    if (v23)
    {
      v24 = v23;
    }
  ...
  v21 = sub_100172EC8(v19, var0, v18, v20);
  if (v21)
  {
    v22 = v21;
  }
...
- (id)textFormatName
{
  ...
  AssociatedObject = objc_getAssociatedObject(self, &unk_1002DEF05);
  if (!AssociatedObject)
  {
    return 0;
  }
  ...
  return sub_1001A05F8(pointerValue, var2, name2);
}
