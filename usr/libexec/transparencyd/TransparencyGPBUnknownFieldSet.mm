...
- (id)copyWithZone:(_NSZone *)zone
{
  ...
  if (fields)
  {
    CFDictionaryApplyFunction(fields, sub_10019D020, v4);
  }
...
- (id)sortedFields
{
  ...
  if (fields)
  {
    ...
    if (Count)
    {
      ...
      while (Count != v7);
      qsort_b(&v15 - 2 * Count, Count, 0x10uLL, &stru_1003259E0);
      v10 = v6 + 1;
    ...
    {
      qsort_b(v6, 0, 0x10uLL, &stru_1003259E0);
    }
...
- (void)writeToCodedOutputStream:(id)stream
{
  ...
  if (fields)
  {
    ...
    else
    {
      ...
      while (Count != v9);
      qsort_b(&v14 - 2 * Count, Count, 0x10uLL, &stru_100325A00);
      v12 = (v8 + 1);
      do
      {
        v13 = *v12;
...
- (id)description
{
  ...
  [(NSMutableString *)v3 appendString:sub_10019FF9C(self, @"  ")];
...
- (unint64_t)serializedSize
{
  ...
  if (result)
  {
    CFDictionaryApplyFunction(result, sub_10019D5A4, &context);
    return context;
  }
...
- (void)writeAsMessageSetTo:(id)to
{
  ...
  if (fields)
  {
    CFDictionaryApplyFunction(fields, sub_10019D5F8, to);
  }
}
...
- (unint64_t)serializedSizeAsMessageSet
{
  ...
  if (result)
  {
    CFDictionaryApplyFunction(result, sub_10019D644, &context);
    return context;
  }
...
- (void)mergeUnknownFields:(id)fields
{
  if (fields)
  {
    ...
    if (v4)
    {
      CFDictionaryApplyFunction(v4, sub_10019D85C, self);
    }
  }
}
...
{
  fromCopy = from;
  v7 = sub_1001A18C4(from);
  v8 = sub_1001A18BC(fromCopy);
  v9 = 0;
  if (v8 <= 1)
  {
    if (v8)
    {
      ...
      {
        v9 = 1;
        [-[TransparencyGPBUnknownFieldSet mutableFieldForNumber:create:](self mutableFieldForNumber:v7 create:{1), "addFixed64:", sub_10016D254(input + 1)}];
      }
    }
    ...
    {
      v9 = 1;
      [-[TransparencyGPBUnknownFieldSet mutableFieldForNumber:create:](self mutableFieldForNumber:v7 create:{1), "addVarint:", sub_10016D1B0(input + 8)}];
    }
  }
  ...
  else
  {
    switch(v8)
    {
      ...
      case 5:
        v9 = 1;
        [-[TransparencyGPBUnknownFieldSet mutableFieldForNumber:create:](self mutableFieldForNumber:v7 create:{1), "addFixed32:", sub_10016D290(input + 1)}];
        break;
    }
  }
