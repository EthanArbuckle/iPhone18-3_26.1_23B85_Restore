...
- (void)writeAsMessageSetTo:(id)a3
{
  ...
  if (fields)
  {
    CFDictionaryApplyFunction(fields, sub_10019D5F8, a3);
  }
}
...
- (BOOL)mergeFieldFrom:(int)a3 input:(id)a4
{
  ...
  if (v8 <= 1)
  {
    if (v8)
    {
      ...
      {
        v9 = 1;
        [-[TransparencyGPBUnknownFieldSet mutableFieldForNumber:create:](self mutableFieldForNumber:v7 create:{1), "addFixed64:", sub_10016D254(a4 + 1)}];
      }
    }
    ...
    {
      v9 = 1;
      [-[TransparencyGPBUnknownFieldSet mutableFieldForNumber:create:](self mutableFieldForNumber:v7 create:{1), "addVarint:", sub_10016D1B0(a4 + 8)}];
    }
  }
  ...
  else
  {
    switch(v8)
    {
      ...
      case 5:
        v9 = 1;
        [-[TransparencyGPBUnknownFieldSet mutableFieldForNumber:create:](self mutableFieldForNumber:v7 create:{1), "addFixed32:", sub_10016D290(a4 + 1)}];
        break;
    }
  }
