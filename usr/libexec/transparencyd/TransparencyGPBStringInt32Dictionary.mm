  ...
  if (result)
  {
    ...
    if (nextObject)
    {
      ...
      do
      {
        ...
        v13 = sub_100171828(1, nextObject2);
        v14 = &v13[sub_100175800([v12 intValue], 2, v7)];
...
- (void)writeToCodedOutputStream:(id)stream asField:(id)field
{
  ...
  if (nextObject)
  {
    ...
    do
    {
      ...
      v15 = sub_100171828(1, nextObject2);
      [stream writeInt32NoTag:{sub_100175800(intValue, 2, v7) + v15}];
