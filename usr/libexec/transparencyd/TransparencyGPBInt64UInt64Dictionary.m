...
{
  v14.receiver = self;
  v14.super_class = TransparencyGPBInt64UInt64Dictionary;
...
{
  v3.receiver = self;
  v3.super_class = TransparencyGPBInt64UInt64Dictionary;
...
- (void)enumerateKeysAndUInt64sUsingBlock:(id)a3
{
  ...
  do
  {
    ...
    (*(a3 + 2))(a3, [v6 longLongValue], objc_msgSend(-[NSMutableDictionary objectForKeyedSubscript:](dictionary, "objectForKeyedSubscript:", v6), "unsignedLongLongValue"), &v7);
  }
  ...
  if (result)
  {
    ...
    if (v10)
    {
      ...
      do
      {
        ...
        v14 = sub_100176A08([v11 longLongValue], 1, v8);
...
- (void)writeToCodedOutputStream:(id)a3 asField:(id)a4
{
  ...
  if (v12)
  {
    ...
    do
    {
      ...
      LODWORD(v14) = sub_100176A08(v15, 1, v8);
      [a3 writeInt32NoTag:{sub_100176118(v16, 2, v7) + v14}];
      sub_100176BA8(a3, v15, 1, v8);
      if (v7 == 4)
      {
...
- (void)setUInt64:(unint64_t)a3 forKey:(int64_t)a4
{
  [(NSMutableDictionary *)self->_dictionary setObject:[NSNumber forKey:"numberWithUnsignedLongLong:" numberWithUnsignedLongLong:a3], [NSNumber numberWithLongLong:a4]];
  autocreator = self->_autocreator;
  if (autocreator)
  {
