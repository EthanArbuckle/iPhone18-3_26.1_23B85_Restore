...
+ (id)descriptor
{
  ...
  {
    LODWORD(v4) = 28;
    v2 = [TransparencyGPBDescriptor allocDescriptorForClass:TransparencyGPBAny messageName:@"Any" fileDescription:off_100389558 fields:&off_100389518 fieldCount:2 storageSize:24 flags:v4];
    [v2 setupExtraTextInfo:&unk_1002DF158];
    qword_10039C6F0 = v2;
  }
