    ...
    if (v6)
    {
      ...
      do
      {
        ...
        do
        {
          ...
          if ((*(v10[1] + 28) & 0x40) != 0)
          {
            objc_setAssociatedObject(v10, &unk_1002DEF05, v4, 1);
          }
...
- (TransparencyGPBFileDescriptor)file
{
  ...
  AssociatedObject = objc_getAssociatedObject(self, &unk_1002DEF04);
  if (!AssociatedObject)
  {
    ...
    AssociatedObject = v6;
    objc_setAssociatedObject(v6, &unk_1002DEF04, v6, 1);
  }
...
- (TransparencyGPBDescriptor)containingType
{
  AssociatedObject = objc_getAssociatedObject(self, &unk_1002DEF06);
...
- (NSString)fullName
{
  ...
  if (v4)
  {
    ...
    AssociatedObject = objc_getAssociatedObject(v4, &unk_1002DEF07);
    if (AssociatedObject)
    {
