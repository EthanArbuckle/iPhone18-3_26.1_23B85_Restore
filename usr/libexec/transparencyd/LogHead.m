...
+ (id)descriptor
{
  ...
  {
    LODWORD(v4) = 28;
    v2 = [TransparencyGPBDescriptor allocDescriptorForClass:LogHead messageName:@"LogHead" fileDescription:&unk_10038A4D8 fields:&off_10038A5D0 fieldCount:8 storageSize:64 flags:v4];
    [v2 setupExtraTextInfo:&unk_1002DF594];
    qword_10039C868 = v2;
  }
