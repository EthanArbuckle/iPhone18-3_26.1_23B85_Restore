...
- (void)enumerateKeysAndDoublesUsingBlock:(id)a3
{
  ...
  do
  {
    ...
    v7 = v6;
    [-[NSMutableDictionary objectForKeyedSubscript:](dictionary objectForKeyedSubscript:{v6), "doubleValue"}];
    (*(a3 + 2))(a3, v7, &v8);
  }
  ...
  if (result)
  {
    ...
    if (v8)
    {
      ...
      do
      {
        ...
        v12 = sub_100171828(1, v9);
        [v11 doubleValue];
        v13 = &v12[sub_1001715E0(2)];
    ...
    return v10 + sub_100171D34(*(*(a3 + 1) + 16), 15) * v6;
  }
...
- (void)writeToCodedOutputStream:(id)a3 asField:(id)a4
{
  ...
  if (v10)
  {
    ...
    do
    {
      ...
      [v12 doubleValue];
      v14 = v13;
      LODWORD(v12) = sub_100171828(1, v11);
      [a3 writeInt32NoTag:sub_1001715E0(2) + v12];
...
- (void)setDouble:(double)a3 forKey:(id)a4
{
  ...
  [(NSMutableDictionary *)self->_dictionary setObject:[NSNumber forKey:"numberWithDouble:" numberWithDouble:a3], a4];
  autocreator = self->_autocreator;
  if (autocreator)
  {
