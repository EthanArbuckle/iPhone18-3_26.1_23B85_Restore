...
- (TransparencyPatInclusionProofVerifier)initWithKeyStore:(id)store application:(id)application;
...
- (TransparencyPatInclusionProofVerifier)initWithKeyStore:(id)store application:(id)application
{
  applicationCopy = application;
  keyBag = [store keyBag];
  v8 = [(TransparencyPatInclusionProofVerifier *)self initWithKeyBag:keyBag application:applicationCopy];
