...
- (void)enumerateKeysAndUInt32sUsingBlock:(id)a3
{
  ...
  do
  {
    ...
    (*(a3 + 2))(a3, v6, [-[NSMutableDictionary objectForKeyedSubscript:](dictionary objectForKeyedSubscript:{v6), "unsignedIntValue"}], &v7);
  }
  ...
  if (result)
  {
    ...
    if (v9)
    {
      ...
      do
      {
        ...
        v13 = sub_100171828(1, v10);
        v14 = &v13[sub_100174F08([v12 unsignedIntValue], 2, v7)];
...
- (void)writeToCodedOutputStream:(id)a3 asField:(id)a4
{
  ...
  if (v11)
  {
    ...
    do
    {
      ...
      v15 = sub_100171828(1, v12);
      [a3 writeInt32NoTag:{sub_100174F08(v14, 2, v7) + v15}];
