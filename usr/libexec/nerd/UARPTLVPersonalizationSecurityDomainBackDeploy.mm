...
{
  v3.receiver = self;
  v3.super_class = UARPTLVPersonalizationSecurityDomainBackDeploy;
...
- (id)description
{
  v3 = +[UARPTLVPersonalizationSecurityDomainBackDeploy metaDataTableEntry];
...
- (id)generateTLV
{
  v3 = +[UARPTLVPersonalizationSecurityDomainBackDeploy tlvType];
  v4 = *(&self->super.super._tlvLength + 1);
  v7.receiver = self;
  v7.super_class = UARPTLVPersonalizationSecurityDomainBackDeploy;
...
- (id)tlvValue
{
  ...
  v5.receiver = self;
  v5.super_class = UARPTLVPersonalizationSecurityDomainBackDeploy;
...
+ (id)metaDataTableEntry
{
  ...
  v5[0] = @"Name";
  v5[1] = @"Value";
  v2 = +[NSNumber numberWithUnsignedInt:](NSNumber, "numberWithUnsignedInt:", +[UARPTLVPersonalizationSecurityDomainBackDeploy tlvType]);
  v6[1] = v2;
...
+ (id)tlvWithLength:(unint64_t)length value:(void *)value
{
  ...
  {
    v5 = objc_opt_new();
    [v5 setSecurityDomain:uarpNtohl(*value)];
  }
