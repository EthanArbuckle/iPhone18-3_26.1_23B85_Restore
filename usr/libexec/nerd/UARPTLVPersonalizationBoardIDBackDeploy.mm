...
{
  v3.receiver = self;
  v3.super_class = UARPTLVPersonalizationBoardIDBackDeploy;
...
- (id)description
{
  v3 = +[UARPTLVPersonalizationBoardIDBackDeploy metaDataTableEntry];
...
- (id)generateTLV
{
  v3 = +[UARPTLVPersonalizationBoardIDBackDeploy tlvType];
  v4 = *(&self->super.super._tlvLength + 1);
  v7.receiver = self;
  v7.super_class = UARPTLVPersonalizationBoardIDBackDeploy;
...
- (id)tlvValue
{
  ...
  v5.receiver = self;
  v5.super_class = UARPTLVPersonalizationBoardIDBackDeploy;
...
+ (id)metaDataTableEntry
{
  ...
  v5[0] = @"Name";
  v5[1] = @"Value";
  v2 = +[NSNumber numberWithUnsignedInt:](NSNumber, "numberWithUnsignedInt:", +[UARPTLVPersonalizationBoardIDBackDeploy tlvType]);
  v6[1] = v2;
