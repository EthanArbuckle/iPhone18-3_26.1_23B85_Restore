...
{
  v3.receiver = self;
  v3.super_class = UARPTLVPersonalizationChipIDBackDeploy;
...
- (id)description
{
  v3 = +[UARPTLVPersonalizationChipIDBackDeploy metaDataTableEntry];
...
- (id)generateTLV
{
  v3 = +[UARPTLVPersonalizationChipIDBackDeploy tlvType];
  v4 = *(&self->super.super._tlvLength + 1);
  v7.receiver = self;
  v7.super_class = UARPTLVPersonalizationChipIDBackDeploy;
...
- (id)tlvValue
{
  ...
  v5.receiver = self;
  v5.super_class = UARPTLVPersonalizationChipIDBackDeploy;
...
+ (id)metaDataTableEntry
{
  ...
  v5[0] = @"Name";
  v5[1] = @"Value";
  v2 = +[NSNumber numberWithUnsignedInt:](NSNumber, "numberWithUnsignedInt:", +[UARPTLVPersonalizationChipIDBackDeploy tlvType]);
  v6[1] = v2;
