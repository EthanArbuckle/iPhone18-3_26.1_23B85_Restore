...
+ (void)initialize
{
  ...
  {
    qword_100071AC0 = os_log_create("com.apple.SensorKit", "RDLaunchEvents");
  }
}
    ...
    do
    {
      for (i = 0; i != v4; i = i + 1)
      {
        ...
        if (v9)
        {
          ...
          handler[2] = sub_100026288;
          handler[3] = &unk_100061330;
        ...
        else if (os_log_type_enabled(qword_100071AC0, OS_LOG_TYPE_FAULT))
        {
          *buf = v12;
          v22 = v8;
