...
- (SRAuthorizationStore)initWithSensors:(id)a3 withAuthorizationTimes:(BOOL)a4
{
  ...
  if (self)
  {
    ...
    if (v8)
    {
        ...
        do
        {
          for (i = 0; i != v18; i = i + 1)
          {
            ...
            if (v24)
            {
              ...
              v29 = [v25 writerAuthorizationService];
              if (v29)
              {
                [v33 setObject:objc_msgSend(v25 forKeyedSubscript:{"name"), v29}];
              }
            }
      ...
      v30 = [(SRAuthorizationStore *)v32 updateQueue];
  ...
  if (v6)
  {
    ...
    while (2)
    {
      ...
      do
      {
        ...
        if ([(SRAuthorizationStore *)self sensorHasReaderAuthorization:a3 forBundleId:*(*(&v11 + 1) + 8 * v9)])
        {
          LOBYTE(v6) = 1;
          return v6;
        }
    ...
    do
    {
      ...
      do
      {
        ...
        if (v4)
        {
          ...
          if (v12)
          {
            v15 = [(SRAuthorizationStore *)v4 readerAuthorizationBundleIdValues];
            v16 = [p_info + 141 sensorDescriptionsForAuthorizationService:v14];
            v45 = 0u;
            v46 = 0u;
            v47 = 0u;
            v48 = 0u;
            v17 = [v15 countByEnumeratingWithState:&v45 objects:buf count:16];
            if (!v17)
            {
              goto LABEL_5;
            }
                  ...
                  if (v22)
                  {
                    ...
                    do
                    {
                      for (i = 0; i != v23; i = i + 1)
                      {
                        ...
                        if ([objc_msgSend(objc_msgSend(v15 objectForKeyedSubscript:{v21), "objectForKeyedSubscript:", objc_msgSend(*(*(&v41 + 1) + 8 * i), "name")), "BOOLValue"}])
                        {
                          v34 = 1;
                          goto LABEL_18;
                        }
...
LABEL_18:
              ...
              while (v20 != v19);
              v19 = [v15 countByEnumeratingWithState:&v45 objects:buf count:16];
            }
...
- (void)resetAuthorizationForService:(id)a3 bundleId:(id)a4
{
  ...
  sub_1000175E4(self, a3, 0, a4);
}

- (id)readerAuthorizationBundleIdValues
{
  v2 = [(SRAuthorizationStore *)self readerAuthorizationValues];
  v3 = [NSMutableDictionary dictionaryWithCapacity:[(NSDictionary *)v2 count]];
  v10 = 0u;
  v11 = 0u;
  v12 = 0u;
  v13 = 0u;
  ...
  if (v4)
  {
    ...
    do
    {
      ...
      v5 = [(NSDictionary *)v2 countByEnumeratingWithState:&v10 objects:v14 count:16];
    }
