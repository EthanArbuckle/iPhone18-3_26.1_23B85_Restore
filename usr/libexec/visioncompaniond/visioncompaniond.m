int main(int argc, const char **argv, const char **envp)
{
  ...
  v5 = __chkstk_darwin();
  v7 = &v13[-v6];
  sub_100001198(v5, qword_100008028);
  v8 = sub_1000011FC(v3, qword_100008028);
  ...
  swift_beginAccess();
  sub_100001E1C(v8, v7, &qword_100008010, &qword_1000024B8);
  v11 = [objc_opt_self() mainRunLoop];
  [v11 run];

  sub_100001E84(v7, &qword_100008010, &qword_1000024B8);
  return 0;
}
...
{
  v0 = (*(*(sub_100001150(&qword_100008018, &qword_1000024C0) - 8) + 64) + 15) & 0xFFFFFFFFFFFFFFF0;
  __chkstk_darwin();
  v2 = &v16 - v1;
  ...
  v8 = (*(*(sub_100001150(&qword_100008010, &qword_1000024B8) - 8) + 64) + 15) & 0xFFFFFFFFFFFFFFF0;
  v9 = __chkstk_darwin();
  v11 = &v16 - v10;
  v12 = sub_1000011FC(v9, &unk_100008028);
  Daemon.init()();
  (*(v4 + 56))(v11, 0, 1, v3);
  swift_beginAccess();
  sub_1000014D4(v11, v12);
  swift_endAccess();
  if (!(*(v4 + 48))(v12, 1, v3))
  {
    (*(v4 + 16))(v7, v12, v3);
  ...
  *(v14 + 16) = 0;
  *(v14 + 24) = 0;
  sub_100001B08(0, 0, v2, &unk_1000024D0, v14);
}
...
uint64_t sub_100001544(uint64_t a1)
{
  ...
  v5 = sub_100001150(&qword_100008010, &qword_1000024B8);
  v1[9] = sub_1000011FC(v5, qword_100008028);
...
{
  v9 = (*(*(sub_100001150(&qword_100008018, &qword_1000024C0) - 8) + 64) + 15) & 0xFFFFFFFFFFFFFFF0;
  __chkstk_darwin();
  v11 = v26 - v10;
  sub_100001E1C(a3, v26 - v10, &qword_100008018, &qword_1000024C0);
  ...
  if (v14 == 1)
  {
    sub_100001E84(v11, &qword_100008018, &qword_1000024C0);
  }
