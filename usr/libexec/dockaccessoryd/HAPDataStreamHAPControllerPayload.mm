...
LABEL_11:
  ...
  v24 = 0;
  v15 = [sessionIdentifier2 serializeWithError:&v24];
  v8 = v24;
...
LABEL_15:
    ...
    v23 = 0;
    v15 = [forceClose2 serializeWithError:&v23];
    v8 = v23;
...
- (NSString)description
{
  ...
  sessionIdentifier = [(HAPDataStreamHAPControllerPayload *)self sessionIdentifier];
  forceClose = [(HAPDataStreamHAPControllerPayload *)self forceClose];
  v6 = [NSString stringWithFormat:@"<HAPDataStreamHAPControllerPayload payload=%@, sessionIdentifier=%@, forceClose=%@>", payload, sessionIdentifier, forceClose];
