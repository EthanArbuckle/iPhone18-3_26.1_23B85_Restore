...
- (HAPDiagnosticsSnapshotTypeWrapper)initWithValue:(unint64_t)value;
...
+ (id)parsedFromData:(id)data error:(id *)error
{
  ...
  {
    v11 = 0;
    [(HAPDiagnosticsSnapshotTypeWrapper *)v6 parseFromData:dataCopy error:&v11];
    v8 = v11;
    if (v8)
    {
...
- (id)serializeWithError:(id *)error
{
  value = [(HAPDiagnosticsSnapshotTypeWrapper *)self value];
...
- (id)copyWithZone:(_NSZone *)zone
{
  v4 = [HAPDiagnosticsSnapshotTypeWrapper allocWithZone:zone];
  value = [(HAPDiagnosticsSnapshotTypeWrapper *)self value];

  return [(HAPDiagnosticsSnapshotTypeWrapper *)v4 initWithValue:value];
}
...
- (BOOL)isEqual:(id)equal
{
  ...
  else
  {
    ...
    if (objc_opt_isKindOfClass())
    {
      v5 = equalCopy;
      value = [(HAPDiagnosticsSnapshotTypeWrapper *)self value];
      value2 = [(HAPDiagnosticsSnapshotTypeWrapper *)v5 value];
