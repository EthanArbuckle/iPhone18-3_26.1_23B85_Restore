...
- (HAPFirmwareUpdateStateWrapper)initWithValue:(int64_t)value;
...
+ (id)parsedFromData:(id)data error:(id *)error
{
  ...
  {
    v11 = 0;
    [(HAPFirmwareUpdateStateWrapper *)v6 parseFromData:dataCopy error:&v11];
    v8 = v11;
    if (v8)
    {
...
- (id)serializeWithError:(id *)error
{
  value = [(HAPFirmwareUpdateStateWrapper *)self value];
...
- (id)copyWithZone:(_NSZone *)zone
{
  v4 = [HAPFirmwareUpdateStateWrapper allocWithZone:zone];
  value = [(HAPFirmwareUpdateStateWrapper *)self value];

  return [(HAPFirmwareUpdateStateWrapper *)v4 initWithValue:value];
}
...
- (BOOL)isEqual:(id)equal
{
  ...
  else
  {
    ...
    if (objc_opt_isKindOfClass())
    {
      v5 = equalCopy;
      value = [(HAPFirmwareUpdateStateWrapper *)self value];
      value2 = [(HAPFirmwareUpdateStateWrapper *)v5 value];
