...
+ (id)descriptor
{
  result = qword_10015D000;
  if (!qword_10015D000)
  {
    LODWORD(v3) = 28;
    result = [TransparencyGPBDescriptor allocDescriptorForClass:TransparencyGPBDuration messageName:@"Duration" fileDescription:off_100155458 fields:&off_100155418 fieldCount:2 storageSize:16 flags:v3];
    qword_10015D000 = result;
  }
