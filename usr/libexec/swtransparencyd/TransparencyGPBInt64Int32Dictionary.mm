...
- (TransparencyGPBInt64Int32Dictionary)initWithDictionary:(id)dictionary;
- (TransparencyGPBInt64Int32Dictionary)initWithInt32s:(const int *)int32s forKeys:(const int64_t *)keys count:(unint64_t)count;
...
{
  v14.receiver = self;
  v14.super_class = TransparencyGPBInt64Int32Dictionary;
...
{
  v3.receiver = self;
  v3.super_class = TransparencyGPBInt64Int32Dictionary;
  [(TransparencyGPBInt64Int32Dictionary *)&v3 dealloc];
}

- (id)copyWithZone:(_NSZone *)zone
{
  v4 = [TransparencyGPBInt64Int32Dictionary allocWithZone:zone];
  ...
  if (result)
  {
    ...
    if (nextObject)
    {
      ...
      do
      {
        ...
        v14 = sub_1000C6768([nextObject2 longLongValue], 1, mapKeyDataType);
...
- (void)writeToCodedOutputStream:(id)stream asField:(id)field
{
  ...
  if (nextObject)
  {
    ...
    do
    {
      ...
      v17 = sub_1000C6768(longLongValue, 1, mapKeyDataType);
      [stream writeInt32NoTag:{sub_1000C5560(intValue, 2, v7) + v17}];
