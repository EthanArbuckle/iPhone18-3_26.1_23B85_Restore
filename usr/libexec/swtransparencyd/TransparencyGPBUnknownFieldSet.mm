...
- (void)writeAsMessageSetTo:(id)a3
{
  ...
  if (fields)
  {
    CFDictionaryApplyFunction(fields, sub_1000ED988, a3);
  }
}
...
- (BOOL)mergeFieldFrom:(int)a3 input:(id)a4
{
  ...
  if (v8 <= 1)
  {
    if (v8)
    {
      ...
      {
        v9 = 1;
        [-[TransparencyGPBUnknownFieldSet mutableFieldForNumber:create:](self mutableFieldForNumber:v7 create:{1), "addFixed64:", sub_1000BCF34(a4 + 1)}];
      }
    }
    ...
    {
      v9 = 1;
      [-[TransparencyGPBUnknownFieldSet mutableFieldForNumber:create:](self mutableFieldForNumber:v7 create:{1), "addVarint:", sub_1000BCE90(a4 + 8)}];
    }
  }
  ...
  else
  {
    switch(v8)
    {
      ...
      case 5:
        v9 = 1;
        [-[TransparencyGPBUnknownFieldSet mutableFieldForNumber:create:](self mutableFieldForNumber:v7 create:{1), "addFixed32:", sub_1000BCF70(a4 + 1)}];
        break;
    }
  }
