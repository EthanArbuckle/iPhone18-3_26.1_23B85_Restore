...
- (unint64_t)getConfigBagEnvironment
{
  ...
  if (result == 2)
  {
    ...
    {
      return qword_1001030C8[atEnvironment];
    }
  }
...
LABEL_11:
  ...
  [v5 setValue:transparencyVersionStr forHTTPHeaderField:off_1001523B8];
  ...
  {
    [v5 setValue:automatedDeviceGroup forHTTPHeaderField:off_1001523B0];
  }
