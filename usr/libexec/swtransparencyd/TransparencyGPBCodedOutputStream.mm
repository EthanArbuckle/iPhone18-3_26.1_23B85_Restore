...
- (void)writeDouble:(int)a3 value:(double)a4
{
  v6 = sub_1000F1CD4(a3, 1);
  sub_1000BE618(&self->state_, v6);

  sub_1000BDE70(&self->state_, *&a4);
}

- (void)writeFloat:(int)a3 value:(float)a4
{
  v6 = sub_1000F1CD4(a3, 5);
  sub_1000BE618(&self->state_, v6);

  sub_1000BE058(&self->state_, SLODWORD(a4));
}

- (void)writeUInt64:(int)a3 value:(unint64_t)a4
{
  v6 = sub_1000F1CD4(a3, 0);
  sub_1000BE618(&self->state_, v6);

  sub_1000BE190(&self->state_, a4);
}
...
- (void)writeMessageNoTag:(id)a3
{
  sub_1000BE618(&self->state_, [a3 serializedSize]);
...
- (void)writeBytesNoTag:(id)a3
{
  sub_1000BE618(&self->state_, [a3 length]);
...
- (void)writeSInt32:(int)a3 value:(int)a4
{
  ...
  sub_1000BE618(&self->state_, (2 * a4) ^ (a4 >> 31));
}
...
- (void)writeSInt64:(int)a3 value:(int64_t)a4
{
  ...
  sub_1000BE190(&self->state_, (2 * a4) ^ (a4 >> 63));
}
...
- (void)writeMessageSetExtension:(int)a3 value:(id)a4
{
  ...
  sub_1000BE9E0(&self->state_, 2, a3);
