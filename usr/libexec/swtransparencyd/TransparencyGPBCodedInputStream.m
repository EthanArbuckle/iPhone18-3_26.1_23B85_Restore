...
- (void)checkLastTagWas:(int)a3
{
  ...
  {
    sub_1000BD0CC(-103, @"Unexpected tag read");
  }
}
...
- (BOOL)skipField:(int)a3
{
  ...
  if (v5 <= 1)
  {
    ...
    sub_1000BD258(&self->state_.bytes, 8);
  ...
  else
  {
    ...
    {
      case 2:
        v8 = sub_1000BCE94(&self->state_);
        sub_1000BD258(&self->state_.bytes, v8);
        v7 = self->state_.bufferPos + v8;
        break;
      case 3:
        [(TransparencyGPBCodedInputStream *)self skipMessage];
        v9 = sub_1000F1CE4(a3);
        if (self->state_.lastTag != sub_1000F1CD4(v9, 4))
        {
          sub_1000BD0CC(-103, @"Unexpected tag read");
        }
        ...
        return 1;
      case 5:
        sub_1000BD258(&self->state_.bytes, 4);
...
- (void)readGroup:(int)a3 message:(id)a4 extensionRegistry:(id)a5
{
  ...
  if (self->state_.lastTag != sub_1000F1CD4(a3, 4))
  {
    sub_1000BD0CC(-103, @"Unexpected tag read");
  }
...
- (void)readMapEntry:(id)a3 extensionRegistry:(id)a4 field:(id)a5 parentMessage:(id)a6
{
  ...
  ++self->state_.recursionDepth;
  sub_1000C4328(a3, self, a4, a5, a6);
  if (self->state_.lastTag)
  {
    sub_1000BD0CC(-103, @"Unexpected tag read");
  }
