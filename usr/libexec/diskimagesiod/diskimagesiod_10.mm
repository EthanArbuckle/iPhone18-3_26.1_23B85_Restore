void sub_1000F3F14(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, ...)
{
  va_start(va, a8);
  sub_1000F47E0(va);
  __cxa_end_catch();
...
void sub_1000F3F44(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, ...)
{
  va_start(va, a8);
  sub_1000F494C(va);
  JUMPOUT(0x1000F3F6CLL);
...
void sub_1000F3F54(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, ...)
{
  va_start(va, a8);
  sub_1000F4B90(va);
  JUMPOUT(0x1000F3F6CLL);
...
void *sub_1000F4388@<X0>(uint64_t a1@<X0>, uint64_t a2@<X1>, uint64_t a3@<X2>, int a4@<W3>, char a5@<W4>, unint64_t *a6@<X8>)
{
  result = sub_1000FCB08((*(a1 + 136) + 8 * a3), a3, a6);
  if (!*a6 || (*(*a6 + 520) & 1) != 0)
  {
    sub_1000FC5FC(a1, a2, a3, *(*(a1 + 160) + 8 * a3) * *(a1 + 28), a4, a5, &v14);
...
void sub_1000F4A54(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, ...)
{
  va_start(va, a4);
  sub_1000D2E48(va);
  _Unwind_Resume(a1);
...
void sub_1000F50A8(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, ...)
{
  va_start(va, a4);
  sub_1000FCE38(va);
  v6 = *(v4 - 152);
...
void sub_1000F5484(_Unwind_Exception *a1, uint64_t a2, ...)
{
  va_start(va1, a2);
  va_start(va, a2);
  v3 = va_arg(va1, void);
...
void sub_1000F580C(uint64_t *a1, uint64_t a2, uint64_t a3)
{
...
void sub_1000F5C10(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, atomic_ullong a11, void **a12, uint64_t a13, uint64_t a14, uint64_t a15, char a16)
{
  sub_1000F0B1C(&a11);
  sub_1001926F4(&a12);
  a12 = &a16;
...
void *sub_1000F5C70(void *a1, void *a2)
{
  ...
  sub_100001FE8(v7, " = offset = ", 12);
  v8 = *(*(*a2 + 56) + 16 * a2[1] + 8) & 0x7FFFFFFFFFFFFFLL;
  v9 = *(*(*a2 + 8) + 28);
  v10 = std::ostream::operator<<();
  v11 = sub_100001FE8(v10, ", flags = ", 10);
  v12 = atomic_load((*(*a2 + 56) + 16 * a2[1] + 8));
  v14 = v12 >> 62;
  return sub_10010091C(v11, &v14);
}
...
LABEL_41:
      ...
      else if ((v30 & 0x4000000000000000) != 0)
      {
        ...
        *v72 = sub_1000F6C54(a1, v10 * v47, v11 * v47);
        sub_1000F2D8C(a1, a2, &v76, v72, 2u, v31 | &_mh_execute_header);
        sub_10019254C(v74);
      }
      ...
      else if ((v69 & 1) == 0)
      {
        ...
        *v72 = sub_1000F6C54(a1, v10 * v44, v11 * v44);
        sub_1000F2D8C(a1, a2, &v76, v72, 2u, &_mh_execute_header & 0xFFFFFFFFFFFFFFFCLL | (v43 >> 62));
LABEL_32:
        sub_1001926F4(v74);
      }
    }
...
atomic_ullong *sub_1000F6664(atomic_ullong *result, uint64_t a2, int a3, int a4, void *a5)
{
  v5 = *(result[1] + 16);
  if (*(v5 + 160) == 1)
  {
...
void sub_1000F6850(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, ...)
{
  va_start(va, a6);
  sub_1000F0B1C(va);
  _Unwind_Resume(a1);
...
uint64_t sub_1000F6CD4(uint64_t *a1, uint64_t a2, void *a3, char a4)
{
...
uint64_t sub_1000F7064(uint64_t a1, uint64_t a2)
{
  ...
  *(a1 + 264) = v6;
  ...
  v55 = &v54;
  v52 = v12;
  sub_100015FBC(v53, &v54);
  sub_10001590C(&v54);
  v13 = v52;
  std::mutex::lock((a1 + 168));
  sub_1000F1CD0(a1, v14, v44);
  v15 = 0;
  *&v39 = a2;
  *(&v39 + 1) = &v43;
  *&v40 = v13;
  *(&v40 + 1) = v41;
  ...
  {
    v42 = sub_1000F6CD4(a1, a2, &v45, 0);
    sub_1000FB5C8(*(v45 + 56) + 16 * v46, 0, v32);
    v17 = sub_1000F6CD4(a1, a2, &v45, 1);
    v42 |= v17;
    ++v15;
    if (v29)
    {
      ...
      {
        sub_1000F79C4(&v39, v13);
        v16 = v13;
      }

      sub_1000F54C0(a1, &v45, v30);
...
void sub_1000F7C7C(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, ...)
{
  va_start(va, a4);
  sub_10010BCD4(va);
  _Unwind_Resume(a1);
...
uint64_t *sub_1000F7C90(uint64_t a1, char *a2, uint64_t a3, char **a4, char *a5, char *a6, char *a7)
{
  if (a7 == a5)
  {
    v7 = 0;
...
uint64_t sub_1000F7CC4(atomic_ullong *a1, unint64_t **a2, unint64_t *a3, char *a4, unint64_t *a5, uint64_t a6)
{
  v12 = (*(*a1 + 16))(a1);
  v15[0] = off_100211DA8;
  v15[1] = a6;
...
void sub_1000F7DDC(_Unwind_Exception *a1, uint64_t a2, ...)
{
  va_start(va, a2);
  sub_100121384(va);
  _Unwind_Resume(a1);
...
unint64_t sub_1000F7DF0(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4)
{
  ...
  *v84 = 0;
  v86 = 0;
  sub_1000302E0(&v80, a3);
  v55 = 0;
  while (!sub_10002DE0C(&v80, a4))
  {
    v78 = sub_1000F1428(a1, v82);
    v79 = v7;
    v8 = v78[1];
    v9 = *(v8 + 56);
    v10 = *(v8 + 28);
    ...
    v69[1] = v69[0] + v10;
    v70 = 2;
    sub_10002EA5C(&v80, v69, a4, v72);
    if (!sub_10002DE0C(v72, &v75))
    {
      *&v65 = &v84[1];
      *(&v65 + 1) = &v78;
      v66 = v84;
      ...
      if ((v14 & 1) == 0)
      {
        ...
        *(&v60 + 1) = 30;
        LODWORD(v61) = 16;
        sub_1000F8A00(v69, &v60);
        sub_100001FE8(v71, "Couldn't lock entry ", 20);
        sub_1000F5C70(v71, &v78);
        sub_1000F8B28(v69);
        exception = __cxa_allocate_exception(0x40uLL);
        *exception = &off_1002260F0;
      ...
      if (!v17)
      {
        LODWORD(v12) = sub_1000F2BE4(a1, a2, v78, v79);
        if (!v12)
        {
          v15 = v79;
          v16 = v78[7];
        ...
        *(&v60 + 1) = 30;
        LODWORD(v61) = 16;
        sub_1000F8B6C(v69, &v60);
        sub_100001FE8(v71, "couldn't allocate space for entry ", 34);
        sub_1000F5C70(v71, &v78);
        sub_100001FE8(v71, " ret: ", 6);
        std::ostream::operator<<();
        std::ostream::~ostream();
        sub_10010D794(v69);
        std::ios::~ios();
...
LABEL_7:
      ...
      v19 = sub_1000F8CD8(&v78, a2, v72, &v75);
      v12 = v19;
      v21 = v20;
...
LABEL_42:
              ...
              *(&v60 + 1) = 30;
              LODWORD(v61) = 16;
              sub_1000F95C0(v69, &v60);
              sub_100001FE8(v71, "Failed during data entry write in table write, error ", 53);
              std::ostream::operator<<();
              std::ostream::~ostream();
              sub_10010DF2C(v69);
              std::ios::~ios();
...
LABEL_15:
      ...
      else
      {
        ...
        {
          sub_100192588(v63, 0, v58);
          if ((v59 & 1) == 0)
          {
            *&v56 = "di_asif::details::table::write(ContextASIF &, const sg_vec::iterator &, const sg_vec::iterator &)";
            *(&v56 + 1) = 30;
            v57 = 16;
            sub_1000F972C(v69, &v56);
            sub_100001FE8(v71, "Couldn't upgrade lock entry ", 28);
            sub_1000F5C70(v71, &v78);
            sub_1000F9854(v69);
          ...
          if (v26 == 2 || (v29 & 0xC000000000000000) != 0x8000000000000000)
          {
            ...
            v36 = v31 >> 62;
            sub_1000F6664(a1, a2, v31 >> 62, 1, &v78);
            v84[0] |= v36 == 3;
            atomic_store(1u, (a1 + 96));
          }
        ...
        else
        {
          if (v26 == 3)
          {
            v69[0] = sub_1000F6C54(a1, v20, v19);
            sub_1000F2D8C(a1, a2, &v78, v69, 1u, 0x100000003);
          }
          ...
          else
          {
            ...
            v69[0] = sub_1000F6C54(a1, v21, v12);
            sub_1000F2D8C(a1, a2, &v78, v69, 1u, v35 | &_mh_execute_header);
            sub_1001926F4(v58);
          }
    ...
    *(&v65 + 1) = 30;
    LODWORD(v66) = 16;
    sub_1000F8894(v69, &v65);
    sub_100001FE8(v71, "Couldn't trim entry in write ", 29);
    sub_100192838(v71, &v80);
    std::ostream::~ostream();
    sub_10010C864(v69);
    std::ios::~ios();
    v11 = 1;
...
LABEL_45:
  ...
  if (v86 == 1)
  {
    ...
    if (v43)
    {
      ...
      v45 = *(a1 + 8);
      v46 = *(v45 + 56);
      sub_1000F580C(a1, a2, v46 + (v46 + 1) * (((*(*&v84[1] + 352) + (*(v44 + 56) + *(v44 + 56) * v85) / (*(v44 + 56) + 1) * *(v44 + 28)) / *(v44 + 26) - *(a1 + 352) / *(v45 + 26)) / (v46 * (*(v45 + 28) / *(v45 + 26)))));
    }
  }
...
void sub_1000FA788(void *a1@<X0>, uint64_t a2@<X1>, void *a3@<X2>, uint64_t a4@<X3>, uint64_t *a5@<X4>, unint64_t *a6@<X8>)
{
  v10 = *(*a1 + 8);
  v11 = *(v10 + 56);
  v12 = *(v10 + 28);
...
void sub_1000FAF80(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, ...)
{
  va_start(va, a5);
  sub_100076574(va);
  _Unwind_Resume(a1);
...
uint64_t sub_1000FC27C(uint64_t a1, uint64_t a2, uint64_t a3, unint64_t a4, uint64_t a5, char a6)
{
  *a1 = a4;
  v9 = *(a3 + 8);
  v10 = *(v9 + 56);
  ...
  *(a1 + 24) = 0;
  v12 = a6 ^ 1;
  sub_1000910A0((a1 + 32), 2 * v10 * (v11 / *(v9 + 26)), a6 ^ 1);
  *(a1 + 120) = 850045863;
  *(a1 + 112) = 0;
  *(a1 + 128) = 0u;
  *(a1 + 144) = 0u;
  ...
  *(a1 + 176) = 0;
  ...
  else
  {
    *(a1 + 112) = 257;
    ...
    if (*(v14 + 160) == 1)
    {
      sub_1000BABD4(v14, (*(a1 + 8) / *(v13 + 26) - *(a3 + 352) / *(v13 + 26)) / (*(v13 + 56) * (*(v13 + 28) / *(v13 + 26))) + *(v13 + 72) * (*(a3 + 352) / *(v13 + 88)), 1);
    }
  }
...
uint64_t sub_1000FC424(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4)
{
  if ((*(*(a2 + 8) + 8) & 1) == 0)
  {
    std::mutex::lock((a1 + 120));
...
atomic_ullong *sub_1000FC5FC@<X0>(atomic_ullong *result@<X0>, uint64_t a2@<X1>, std::unique_lock<std::mutex>::mutex_type *a3@<X2>, unint64_t a4@<X3>, int a5@<W4>, char a6@<W5>, atomic_ullong *a7@<X8>)
{
  v10 = result;
  v19 = a4;
  *a7 = 0;
  if (a4 || a5)
  {
    sub_1000FC784((result + 36), a3, a6, &v18);
...
atomic_ullong *sub_1000FC784@<X0>(uint64_t a1@<X0>, std::unique_lock<std::mutex>::mutex_type *a2@<X1>, char a3@<W2>, unint64_t *a4@<X8>)
{
  v20 = 0;
  v21 = a2;
  sub_100125530(a1, a2, a3, &v18);
...
LABEL_23:
        ...
        v13 = sub_10012105C((a1 + 928), v19, &v21);
        if ((v14 & 1) == 0)
        {
          *(v13 + 40) = v20;
        }
...
void sub_1000FD038(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, ...)
{
  va_start(va, a4);
  sub_1000FD430(va);
  _Unwind_Resume(a1);
...
void sub_1000FDA70(_Unwind_Exception *a1, int a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, std::__shared_weak_count *a14, uint64_t a15, uint64_t a16, uint64_t a17, uint64_t a18, uint64_t a19, uint64_t a20, uint64_t a21, uint64_t a22, uint64_t a23, uint64_t a24, uint64_t a25, uint64_t a26, uint64_t a27, uint64_t a28, uint64_t a29, uint64_t a30, unint64_t a31, uint64_t a32, char a33)
{
  ...
  if (a2 == 1)
  {
    ...
    *(v33 + 3616) = v37;
    ...
    sub_1000F7C90(v34, v44, v45, v46, v47, v48, v49);
    v50 = v41[2];
  ...
  sub_100015888((v38 - 168), 0);
  sub_10001590C(v36 + 8);
  sub_100015888((v38 - 128), 0);
  sub_10001590C(v35 + 8);
  sub_100072AB4(&a27);
  _Unwind_Resume(a1);
}
...
uint64_t sub_1000FE034(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, int a5)
{
  ...
  {
    v16 = v12 / *(a1 + 88);
    sub_1000F4388(a1, a2, v16, a5 ^ 1, 1, &v39);
    if (v39 && (*(v39 + 520) & 1) != 0)
    {
      if ((a5 & 1) == 0)
      {
    ...
    sub_10002ED8C(&v40, *(a1 + 88) + *(a1 + 88) * v16, a4, 0, &v31);
    if (v39 && (*(v39 + 520) & 1) == 0)
    {
      if (a5)
      {
      ...
      else
      {
        ...
        v21 = sub_1000F7DF0(v20, a2, &v31, &v35);
      }
      ...
      if ((v21 & 0x8000000000000000) != 0 && v21)
      {
        ...
        *(&v27 + 1) = 28;
        v28 = 16;
        sub_1000FE384(v29, &v27);
        sub_100001FE8(v30, "Failed during table ", 20);
        sub_100001FE8(v30, v26, v25);
        sub_100001FE8(v30, " in dir I/O, error ", 19);
        std::ostream::operator<<();
        std::ostream::~ostream();
        sub_10011593C(v29);
        std::ios::~ios();
    ...
    {
      sub_10002FBF0(&v31, &v35);
      v18 = (v38 - v34) & ~((v38 - v34) >> 63);
      sub_10002E60C(&v31, v18);
    }

    sub_10002E60C(&v40, v18);
    v12 += v18;
    v13 += v18;
    v17 = 1;
LABEL_16:
...
void sub_1000FE328(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, ...)
{
  va_start(va, a8);
  sub_1000FE4AC(va);
...
void sub_1000FE878(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, ...)
{
  va_start(va, a8);
  sub_1000EFD00(va);
  _Unwind_Resume(a1);
...
unint64_t sub_1000FE89C(uint64_t *a1, uint64_t a2, uint64_t a3, uint64_t a4)
{
  v5 = *a3;
  v6 = *(a3 + 8);
  v7 = *(a3 + 16);
...
void sub_1000FEE0C(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, ...)
{
  va_start(va, a13);
  sub_1000F0B1C(va);
  _Unwind_Resume(a1);
...
uint64_t sub_1000FF158(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4)
{
  ...
  while (1)
  {
    ...
    v11 = v36 * *(a1 + 26);
    sub_1000F4388(a1, a2, v11 / *(a1 + 88), v9 ^ 1, 1, &v32);
    if (v32 && (*(v32 + 520) & 1) == 0)
    {
      if (*(v32 + 400))
      {
...
void sub_1000FF7B0(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, ...)
{
  va_start(va, a4);
  sub_1000FFAB8(va);
  __cxa_end_catch();
...
void sub_1000FFC68(uint64_t a1, uint64_t a2, uint64_t a3, unsigned int a4, unsigned int a5, unsigned int a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10)
{
  ...
  *v15 = off_100211AF0;
  ...
  sub_1001184AC((a1 + 160), (*(a1 + 88) + a3 - 1) / *(a1 + 88));
  *(a1 + 184) = a4;
...
void sub_10010055C(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, ...)
{
  va_start(va, a15);
  sub_100015888(va, 0);
  sub_10001590C(v15 + 8);
...
void sub_100100A5C(_Unwind_Exception *a1, uint64_t a2, ...)
{
  va_start(va, a2);
  sub_100121384(va);
  _Unwind_Resume(a1);
...
void sub_100100A70(uint64_t a1, uint64_t a2)
{
  if (*(a1 + 88))
  {
    v4 = 0;
...
void sub_100100BEC(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, ...)
{
  va_start(va, a4);
  sub_1001186D0(va);
  _Unwind_Resume(a1);
...
uint64_t sub_1001010D0(uint64_t a1, uint64_t a2)
{
  ...
  sub_1000A56E0("header_signature", v4, v18, 1);
  *a1 = 2003069043;
  *(a1 + 4) = bswap32(*(a2 + 4));
  *(a1 + 8) = bswap32(*(a2 + 8));
  v5 = bswap32(*(a2 + 12));
  LODWORD(v18[0]) = 1;
  sub_100100880("header_flags", v5, v18, 1);
  *(a1 + 12) = v5;
  *(a1 + 16) = bswap64(*(a2 + 16));
  *(a1 + 24) = bswap64(*(a2 + 24));
  *(a1 + 32) = *(a2 + 32);
...
LABEL_15:
    ...
    sub_100001DC0(v18);
    sub_100001FE8(v18, "Unsupported ASIF version ", 25);
    v16 = *(a1 + 4);
    std::ostream::operator<<();
    sub_10000EBDC(v15, v18, 0xA1u);
  }
...
LABEL_23:
    v14 = 22;
LABEL_24:
    v17 = sub_100001940(exception, v13, v14);
  }
...
void sub_1001013EC(_Unwind_Exception *a1, uint64_t a2, ...)
{
  va_start(va, a2);
  sub_10000C8C8(va);
  _Unwind_Resume(a1);
...
void sub_1001013FC(_Unwind_Exception *a1, uint64_t a2, ...)
{
  va_start(va, a2);
  sub_10000C8C8(va);
...
void sub_100101968(uint64_t a1)
{
  if (*(a1 + 8) >= *(a1 + 68))
  {
    v1 = *(a1 + 8);
...
void sub_100102AE0(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, ...)
{
  va_start(va, a4);
  sub_100102DC4(va);
  __cxa_end_catch();
...
void sub_100102B00(uint64_t a1, uint64_t a2, uint64_t a3, ...)
{
  va_start(va, a3);
  sub_100102F30(va);
  __cxa_end_catch();
...
uint64_t sub_100102B28@<X0>(void *a1@<X0>, uint64_t a2@<X1>, uint64_t *a3@<X8>)
{
  *a3 = 0;
  a3[1] = 0;
  a3[2] = 0;
...
void sub_100102F74(void *a1@<X0>, uint64_t a2@<X1>, CFMutableDictionaryRef *a3@<X8>)
{
  if (*(*a1 + 72))
  {
...
LABEL_21:
  ...
  else
  {
    ...
    values = v20;
    v26 = v23;
    sub_100144D78(&keys, &values, 2, a3);
    sub_100028D2C(&v23);
    sub_100028D2C(&v20);
  }
}
...
const void **sub_1001034E4@<X0>(CFMutableDictionaryRef *a1@<X8>)
{
  ...
  values[0] = v4;
  values[1] = v3;
  sub_100144D78(keys, values, 2, a1);
  sub_100028D2C(&v3);
  return sub_100028D2C(&v4);
}

void sub_100103588(_Unwind_Exception *a1, uint64_t a2, ...)
{
  va_start(va1, a2);
  va_start(va, a2);
...
void sub_10010380C(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, ...)
{
  va_start(va, a6);
  sub_10011A89C(va);
  _Unwind_Resume(a1);
...
const void **sub_100103B54(const void **result, uint64_t a2, CFPropertyListRef propertyList)
{
  if (propertyList)
  {
    ...
    {
      exception = __cxa_allocate_exception(0x40uLL);
      v43 = sub_100001940(exception, "Not enough space for metadata", 0x1Cu);
    }

    sub_100144E60(propertyList, v64);
    v10 = v64[1];
    cf = v64[0];
    v64[0] = 0;
    sub_1000929D8(v64);
    ...
    if (v15 <= v16)
    {
      ...
      do
      {
        ...
        v24 = v22 - 1;
        sub_100101CAC(v62, (v22 - 1 + *(v20 + 26)) / *(v20 + 26) * *(v20 + 26), v19);
        sub_100101D98(v62, a2, v4[1], v21);
        if (v50 - v22 >= v17 * v15)
        {
          v25 = v17 * v15;
        }
        ...
        *(&v54 + 1) = v34;
        ...
        v35 = v4[1];
        sub_10002E310(v65, &v54);
        a2 = v48;
        sub_10002DF68(v65, v51);
        v36 = sub_1000FE034(v35, v48, &v54, v51, 0);
        if (v53)
        {
          sub_10000E984(v53);
        }
...
void sub_100104354(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, char a12, void *a13)
{
  if (v13)
  {
    (*(*v13 + 40))(v13);
...
atomic_ullong *sub_10010448C(atomic_ullong *a1, uint64_t a2, std::unique_lock<std::mutex>::mutex_type *a3, unint64_t a4, void *a5, void *a6)
{
...
void sub_10010451C(_Unwind_Exception *a1, uint64_t a2, ...)
{
  va_start(va, a2);
  sub_1000EFD00(va);
  _Unwind_Resume(a1);
...
uint64_t sub_100104538(uint64_t result, void *a2, unint64_t a3, unsigned int a4)
{
  ...
  if (v15 != v13)
  {
    do
    {
      ...
      v20[1] = v17;
      v20[2] = a4;
      result = sub_10010468C(v7 + 504, &v21, v20);
      v18 = v14[1];
      if (v18)
      {
        do
...
uint64_t sub_10010468C(uint64_t a1, __int128 *a2, uint64_t a3)
{
  v5 = (*(*a1 + 16))(a1);
  v9 = *a2;
  v10 = *(a2 + 2);
...
void sub_100104744(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, ...)
{
  va_start(va, a8);
  sub_100121384(va);
  _Unwind_Resume(a1);
...
void sub_100104758(uint64_t a1, uint64_t *a2, uint64_t a3, uint64_t a4, unsigned int a5, uint64_t *a6)
{
  *(a1 + 8) = 0;
  *a1 = off_100211B70;
  LODWORD(v22[0]) = *(a3 + 96);
...
void sub_100104C9C(uint64_t a1, unsigned int a2, unsigned int a3, unint64_t a4, unint64_t a5, void *a6, uint64_t *a7, _OWORD *a8)
{
  *(a1 + 8) = 0;
  *a1 = off_100211B70;
  *(a1 + 16) = *a6;
  ...
  *(a1 + 24) = v15;
  ...
  LODWORD(v18) = v16;
  LODWORD(v19[0]) = 1;
  sub_100100880("header_flags", v16, v19, 1);
  sub_1001017A0(a1 + 32, &v18, a8, a4, a5, a3, a2);
  *(a1 + 144) = 850045863;
  *(a1 + 152) = 0u;
  *(a1 + 168) = 0u;
  *(a1 + 184) = 0u;
  ...
  *(a1 + 496) = 0;
  ...
  v19[1] = a1;
  v19[3] = v19;
  sub_1000FFC68(a1 + 504, a1, a2 * a5, a3, a2, a2 + 511 - (a2 + 511) % a2, 2, 0, v19, a1 + 232);
}
...
uint64_t sub_100105574(uint64_t *a1, uint64_t a2)
{
  ...
  v10[21] = 0x40000000;
  v10[22] = sub_10011C214;
  v10[23] = &unk_100216C78;
  v10[24] = a2;
  ...
  *(&v7 + 1) = 27;
  v8 = 0;
  sub_10011C2F4(v9, &v7);
  sub_100001FE8(v10, "sendEvent of type ", 18);
  sub_100001FE8(v10, *a1, a1[1]);
  sub_100001FE8(v10, " with ", 6);
  v5 = *(a2 + 16);
  std::ostream::operator<<();
  sub_100001FE8(v10, " elements returned ", 19);
  std::ostream::operator<<();
  std::ostream::~ostream();
  sub_10011C528(v9);
  return std::ios::~ios();
...
void sub_1001056B0(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, ...)
{
  va_start(va, a5);
  sub_10011C41C(va);
  _Unwind_Resume(a1);
...
uint64_t sub_10010583C(uint64_t a1, uint64_t a2)
{
  ...
  {
    v10 = v9;
    v11 = *sub_1000EFC34(a2, v4);
    if (v11)
    {
      v12 = sub_100100590(a1, v11);
      if ((v5 & (v6 >= v12)) != 0)
      {
        v5 = 1;
      }
...
uint64_t sub_100105988(uint64_t a1, uint64_t a2, int a3)
{
  ...
  if ((v13 & 0x80000000) != 0)
  {
    ...
    *(&v21 + 1) = 24;
    v22 = 16;
    sub_100105E24(v23, &v21);
    sub_100001FE8(v24, "Root dir flush failed, error ", 29);
    std::ostream::operator<<();
    std::ostream::~ostream();
    sub_10011CF58(v23);
LABEL_22:
  ...
  if (!v6)
  {
    ...
    *(&v21 + 1) = 24;
    v22 = 16;
    sub_100105F90(v23, &v21);
    sub_100001FE8(v24, "Backend barrier failed after dir offset changed, error ", 55);
    std::ostream::operator<<();
    std::ostream::~ostream();
    sub_10011D6F0(v23);
    goto LABEL_22;
  ...
  if ((v14 & 0x80000000) != 0)
  {
    ...
    *(&v21 + 1) = 24;
    v22 = 16;
    sub_100106268(v23, &v21);
    sub_100001FE8(v24, "Final asif ", 11);
    if (a3 == 2)
    {
      v17 = "flush";
    }
    ...
    sub_100001FE8(v24, v17, v18);
    sub_100001FE8(v24, " failed, error ", 15);
    std::ostream::operator<<();
    std::ostream::~ostream();
    sub_10011E620(v23);
    goto LABEL_22;
...
void sub_100105D04(_Unwind_Exception *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, __int128 a9, int a10, int a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, uint64_t a16, uint64_t a17, uint64_t a18, uint64_t a19, uint64_t a20, uint64_t a21, uint64_t a22, uint64_t a23, uint64_t a24, uint64_t a25, uint64_t a26, uint64_t a27, uint64_t a28, uint64_t a29, uint64_t a30, uint64_t a31, uint64_t a32, uint64_t a33, uint64_t a34, uint64_t a35, uint64_t a36, uint64_t a37, uint64_t a38, uint64_t a39, uint64_t a40, uint64_t a41, uint64_t a42, uint64_t a43, uint64_t a44, uint64_t a45, uint64_t a46, uint64_t a47, uint64_t a48, uint64_t a49, uint64_t a50, uint64_t a51, uint64_t a52, uint64_t a53, uint64_t a54, uint64_t a55, uint64_t a56, uint64_t a57)
{
  if (a2 == 1)
  {
    ...
    *(&a9 + 1) = 24;
    a10 = 16;
    sub_1001063D4(&a12, &a9);
    sub_100001FE8(&a57, "Error during ASIF flush: ", 25);
    sub_100195A20(&a57, v59);
    sub_1001064FC(&a12);
    LODWORD(v59) = v59[2];
    __cxa_end_catch();
    JUMPOUT(0x100105CD8);
...
void sub_100106E50(uint64_t a1, _OWORD *a2)
{
  *(a1 + 112) = *a2;
  v2 = *(a1 + 16);
  sub_100101968(a1 + 32);
...
uint64_t sub_100106EC8(uint64_t a1)
{
  if (*(a1 + 112) == 0)
  {
    sub_100106B94(a1);
...
uint64_t sub_10010719C(void *a1, uint64_t a2)
{
  ...
  if (!v4)
  {
    ...
    {
      v7 = (*(*a1 + 144))(a1);
      sub_1001006D8(v11, a1, v7);
      v8 = a1[11];
      if (v8 - v6 >= sub_100102904(a1 + 546, v11))
      {
        a1[10] = v6;
        v9 = a1[2];
        sub_100101968((a1 + 4));
...
void sub_100107330(_Unwind_Exception *exception_object, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12)
{
  if (v12)
  {
    (*(*v12 + 40))(v12);
...
void *sub_1001078B0(void *result, unint64_t a2)
{
  *result = 0;
  result[1] = 0;
  result[2] = 0;
...
void sub_100107A78(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, ...)
{
  va_start(va, a4);
  sub_100045340(va);
  _Unwind_Resume(a1);
...
void *sub_100107FD8(uint64_t a1, unint64_t *a2)
{
  v2 = *(a1 + 8);
  if (!v2)
  {
