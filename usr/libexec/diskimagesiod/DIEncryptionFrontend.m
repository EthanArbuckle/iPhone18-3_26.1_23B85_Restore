...
- (expected<crypto::crypto_serializer_t,)getSerializerWithAuthTable:(DIEncryptionFrontend *)self
{
  ...
  if (v21)
  {
    ...
    sub_100180CF0(v14, &v20, a4, retstr);
    if (v15)
    {
      sub_10000E984(v15);
    }
    ...
    if (v21)
    {
      ...
      {
        sub_10000E984(v20.var0.var0.__cntrl_);
      }
    }
  }
...
- (BOOL)unlockWithPassphrase:(const char *)a3 error:(id *)a4
{
  ...
  if (v10)
  {
    ...
    v30[0] = 0;
    v31 = 0;
    v13 = &OBJC_IVAR___DIBaseParams__inputURL;
    if (v12 == v10[1])
    {
LABEL_20:
      sleep(2u);
      v4 = [v13 + 478 failWithPOSIXCode:80 description:@"Incorrect passphrase" error:a4];
    }
    ...
    else
    {
      while (1)
      {
        v14 = sub_10003AA38(&v28);
        if (!*(v14 + 632))
        {
          v15 = sub_100178AF0(v14, a3, &v21);
          if (v23 == 1)
          {
            [v9 cryptoHeader];
            sub_100040704();
...
- (BOOL)setPassphrase:(const char *)a3 error:(id *)a4
{
  ...
  {
    LODWORD(v22) = 8;
    sub_100178394(v8, a3, &v22, v17, &v26);
    if (v28)
    {
...
- (BOOL)unlockUsingSaksWithError:(id *)a3
{
  ...
  if (v6)
  {
    ...
    else
    {
      while (1)
      {
        v9 = sub_10003AA38(&v23);
        if (*(v9 + 632) == 3 && *(v9 + 12) == 9)
        {
          __p = 0;
          v19 = 0;
          v20 = 0;
          sub_1000403D4(&__p, *(v9 + 16), *(v9 + 24), *(v9 + 24) - *(v9 + 16));
    ...
    *a4 = 0;
    ...
    if (v9 != v7[1])
    {
      do
      {
        ...
        v13 = v12;
        (off_1001FA468[v10])(&v13);
        sub_10003AAD8(&v16, v14);
        if (v15[640] == 1)
        {
          sub_10003F650(v15);
        }
...
- (BOOL)unlockUsingPublicKeyWithError:(id *)a3
{
  ...
  if (v9)
  {
    ...
    else
    {
      while (1)
      {
        v12 = sub_10003AA38(&v25);
        if (*(v12 + 632) == 1)
        {
          v13 = sub_100179E70(v12, &v18);
          if (v20 == 1)
          {
            [v8 cryptoHeader];
            sub_100040704();
