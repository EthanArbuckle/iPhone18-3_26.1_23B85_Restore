...
LABEL_20:
      sleep(2u);
      v4 = [v12 + 478 failWithPOSIXCode:80 description:@"Incorrect passphrase" error:a4];
    }
...
- (BOOL)replacePassphrase:(const char *)a3 error:(id *)a4
{
  ...
  {
    v33.i32[0] = 8;
    sub_100178394(v8, a3, v33.i32, v28, &v54);
    if (v56)
    {
      v9 = *v8;
      v50 = v8;
