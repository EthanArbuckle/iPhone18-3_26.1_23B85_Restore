...
- (void)fetchPreviousSessionConnectionDataWithReply:(id)a3;
- (void)recordConnectionEvent:(id)a3 completion:(id)a4;
- (void)sessionDidDisconnect:(id)a3;
- (void)setSessionUUIDString:(id)a3;
- (void)trimConnectionDataBefore:(id)a3;
- (void)trimHistoricalConnectionDataBefore:(id)a3 completion:(id)a4;
@end
...
- (BOOL)listener:(id)a3 shouldAcceptNewConnection:(id)a4
{
  ...
  if (v7)
  {
    ...
    v12 = [objc_opt_class() _CARConnectionServiceInterface];
...
- (id)sortedConnectionEvents
{
  v2 = [(CARConnectionTimeServiceAgent *)self userDefaults];
  v3 = [v2 arrayForKey:@"CARConnectionTimeEventStoreKey"];
...
- (void)trimConnectionDataBefore:(id)a3
{
  ...
  v11 = [(CARConnectionTimeServiceAgent *)self userDefaults];
  [v11 setObject:v10 forKey:@"CARConnectionTimeEventStoreKey"];
...
- (void)_addConnectionData:(id)a3 toReconnectArray:(id)a4
{
  ...
  v14 = [(CARConnectionTimeServiceAgent *)self sessionUUIDString];
  ...
  {
    v18 = [v17 mutableCopy];
    [v18 removeObjectsInRange:{25, objc_msgSend(v18, "count") - 25}];
