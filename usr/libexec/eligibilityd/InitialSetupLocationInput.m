...
{
  v4 = a3;
  v5 = [(InitialSetupLocationInput *)self countryCodes];
  if (v5)
  {
    objc_opt_class();
    v6 = v4;
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (objc_opt_isKindOfClass())
  {
    ...
    v7 = [(InitialSetupLocationInput *)v5 countryCodes];
...
LABEL_14:
  ...
  v14 = [(EligibilityInput *)&v19 initWithInputType:14 status:a4 process:v9];
  v15 = v14;
  if (v14)
  {
