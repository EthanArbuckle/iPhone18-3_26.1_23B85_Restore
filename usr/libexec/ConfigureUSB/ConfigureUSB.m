...
LABEL_31:
  ...
  *buf = 0;
  if (os_parse_boot_arg_int() && *buf)
  {
    ...
    {
      *v33 = 0;
      _os_log_impl(&_mh_execute_header, &_os_log_default, OS_LOG_TYPE_DEFAULT, "Not disabling display due to boot-arg no_darwinos_disable_display=1", v33, 2u);
    }
  }
      ...
      if (CFArrayGetCount(DisplayList) >= 1)
      {
        for (j = 0; j < CFArrayGetCount(v23); ++j)
        {
          ...
          if (!*(ValueAtIndex + 2))
          {
            ...
            v27 = *v26;
            v28 = IOMobileFramebufferOpenByName();
            if (!v28)
            {
              break;
            }
  ...
  if ((os_variant_allows_internal_security_policies() & 1) != 0 || !access("/var/db/darwinos-enable-usb", 0))
  {
    ...
    if (v29 == -6)
    {
      ...
      *buf = 0;
      v31 = "ACM not implemented on this platform";
      goto LABEL_70;
    }
...
void sub_100001AF4(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, unint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, uint64_t a16, uint64_t a17, uint64_t a18, uint64_t a19, uint64_t a20, uint64_t a21, uint64_t a22)
{
  a9 = *v22 - v25;
  v29 = *(v27 + 8 * v26);
        ...
        if (v3)
        {
          if (v0)
          {
            ...
            if (v1 != -32)
            {
              ...
              sub_100002330();
              v15 = ccgcm_init();
              if (!sub_100002278(v15, "ccgcm_init") && !sub_100002450(v3, 16))
              {
                sub_100002308();
                v16 = ccgcm_set_iv();
                if (!sub_100002278(v16, "ccgcm_set_iv"))
                {
                  sub_100002330();
                  v17 = ccgcm_update();
                  if (!sub_100002278(v17, "ccgcm_update"))
                  {
                    sub_100002308();
                    v18 = ccgcm_finalize();
                    if (!sub_100002278(v18, "ccgcm_finalize"))
                    {
LABEL_13:
                      *v0 = v14;
                    }
        ...
        if (v3)
        {
          if (v0)
          {
            ...
            if (v1 != -33)
            {
              ...
              sub_100002330();
              v15 = ccgcm_init();
              if (!sub_100002278(v15, "ccgcm_init"))
              {
                *v3 = 2;
                v16 = (v3 + 1);
                sub_100002414();
                if (!v17 && !sub_100002450(v16, 16))
                {
                  sub_100002308();
                  v18 = ccgcm_set_iv();
                  if (!sub_100002278(v18, "ccgcm_set_iv"))
                  {
                    v19 = v16 + 16;
                    sub_100002414();
                    if (!v20)
                    {
                      sub_100002330();
                      v21 = ccgcm_update();
                      if (!sub_100002278(v21, "ccgcm_update") && !__CFADD__(v19, v1))
                      {
                        sub_100002308();
                        v22 = ccgcm_finalize();
                        if (!sub_100002278(v22, "ccgcm_finalize"))
                        {
LABEL_16:
                          *v0 = v14;
                        }
        ...
        if (v3)
        {
          if (v1)
          {
            ...
            if (v19)
            {
              ...
              sub_100002330();
              v21 = ccgcm_init();
              if (!sub_100002278(v21, "ccgcm_init"))
              {
                sub_100002308();
                v22 = ccgcm_set_iv();
                if (!sub_100002278(v22, "ccgcm_set_iv"))
                {
                  sub_100002330();
                  v23 = ccgcm_update();
                  if (!sub_100002278(v23, "ccgcm_update"))
                  {
                    sub_100002308();
                    ccgcm_finalize();
                    v24 = cc_cmp_safe();
                    if (!sub_100002278(v24, "cc_cmp_safe"))
                    {
LABEL_13:
                      *v1 = v20;
                    }
                ...
                if (!sub_100002278(v21, "ccgcm_init"))
                {
                  ...
                  if (!sub_100002278(v22, "ccgcm_set_iv"))
                  {
                    ...
                    if (!v23)
                    {
                      sub_100002330();
                      v24 = ccgcm_update();
                      if (!sub_100002278(v24, "ccgcm_update") && !__CFADD__(v7 + 17, v19))
                      {
                        sub_100002308();
                        ccgcm_finalize();
                        v25 = cc_cmp_safe();
                        if (!sub_100002278(v25, "cc_cmp_safe"))
                        {
LABEL_16:
                          *v1 = v19;
                        }
...
rsize_t sub_10000335C(rsize_t result, int a2, unsigned __int8 a3, uint64_t a4, uint64_t a5, uint64_t a6, const void *a7, uint64_t a8, char a9, uint64_t a10, int a11, unsigned int a12, uint64_t a13)
{
  v20 = result;
  if (gACMLoggingLevel <= 0xAu)
  {
...
uint64_t ACMContextDelete(_DWORD *a1, int a2)
{
  ...
  v10 = a1;
  v7 = LibCall_ACMContextDelete(sub_100006E98, &v10, a1, a2);
  if (v7)
  {
    v8 = 70;
  }
...
uint64_t ACMSetEnvironmentVariable(int a1)
{
  ...
  if (v4 >= byte_10001C001 && os_log_type_enabled(&_os_log_default, OS_LOG_TYPE_INFO))
  {
    *buf = 136315906;
    v7 = "ACMLib";
    v8 = 2080;
...
void ACMGlobalContextCredentialGetProperty(int a1, int a2, uint64_t a3)
{
  ...
  v6 = 0;
  LibCall_ACMGlobalContextCredentialGetProperty_Block(sub_100006E98, &v6, a1, a2, a3);
  if (byte_10001C001 <= 0xAu && os_log_type_enabled(&_os_log_default, OS_LOG_TYPE_INFO))
  {
    *buf = 136315394;
    v8 = "ACMLib";
...
void ACMContextCredentialGetProperty(__n128 *a1, unsigned __int32 a2, unsigned __int32 a3, uint64_t a4)
{
  ...
  {
    v9 = a1;
    v8 = LibCall_ACMContextCredentialGetProperty(sub_100006E98, &v9, a1, a2, a3, buf, &v10);
    (*(a4 + 16))(a4, v8, buf, v10);
  }
...
uint64_t ACMContextCopyData(__int128 *a1, uint64_t a2, __int128 *a3, uint64_t a4)
{
  ...
  v11 = 0;
  v8 = LibCall_ACMContextCopyData(sub_100006E98, &v11, a1, a2, a3, a4);
  if (v8)
  {
    v9 = 70;
  }
...
uint64_t ACMContextGetInfo(__int128 *a1, int a2, void *a3)
{
  ...
  v9 = a1;
  v6 = LibCall_ACMContextGetInfo(sub_100006E98, &v9, a1, a2, a3);
  if (v6)
  {
    v7 = 70;
  }
...
uint64_t sub_100006D80(uint64_t a1, char a2, uint64_t a3, uint64_t a4, size_t a5)
{
...
uint64_t sub_100006E98(uint64_t *a1, char a2, char a3, const void *a4, size_t a5, void *a6, size_t *a7)
{
  if (byte_10001C001 <= 0xAu && os_log_type_enabled(&_os_log_default, OS_LOG_TYPE_INFO))
  {
    sub_100006D74();
...
uint64_t sub_100007210(uint64_t a1, char a2, char a3, const void *a4, size_t a5, void *a6, size_t *a7)
{
  if (byte_10001C001 <= 0xAu && os_log_type_enabled(&_os_log_default, OS_LOG_TYPE_INFO))
  {
    sub_100006CE8();
  ...
  if (v19)
  {
    ...
    else
    {
      ...
      v44 = v21;
      v22 = IOConnectCallStructMethod(dword_10001C034, 0, v19, inputStructCnt, a6, &v44);
      v23 = v22;
      if (a1)
      {
        v24 = *(a1 + 16);
  ...
  if (v37 >= byte_10001C001 && os_log_type_enabled(&_os_log_default, OS_LOG_TYPE_INFO))
  {
    v46 = 136315650;
    v47 = "ACMLib";
    sub_100006D5C();
...
uint64_t sub_100007B84(uint64_t a1, uint64_t a2, unsigned int *a3)
{
  result = 0;
  v4 = *a3;
  return result;
...
uint64_t sub_100007BF8(uint64_t (*a1)(uint64_t, void, void, void *, size_t, _DWORD *, unint64_t *), uint64_t a2, int a3, _OWORD *a4, unsigned __int8 *a5, uint64_t a6, unsigned __int8 *a7, uint64_t a8, const void *a9, unsigned int a10, unsigned int a11, _DWORD *a12, BOOL *a13, void *a14, unint64_t *a15)
{
      ...
      if ((v7 & 0x30) != 0)
      {
        *a3 = 20;
        while (*(a2 + 16))
        {
          ...
          sub_100001B78(SerializedRequirementSize, v10, v11, v12, v13, v14, v15, v16, v25, v26);
        }
      }
  ...
  if (v27 && (v34 & 1) == 0)
  {
    ...
    else
    {
      ...
      if (v39)
      {
        ...
        {
          sub_100006D80(v26, 6, v41, v42, size);
        }
  ...
  if (v27 && (v34 & 1) == 0)
  {
    ...
    else
    {
      ...
      if (v39)
      {
        ...
        {
          sub_100006D80(v26, 15, v41, v42, size);
        }
  ...
  if (!a4)
  {
    switch(a2)
    {
      ...
      case 304:
        ...
        if (v26)
        {
          *(v5 + 185) = sub_100007AE0(v22, v23, v24);
        }
...
LABEL_158:
    ...
    case 0x1F5:
      ...
      {
LABEL_50:
        *(v5 + 36) = sub_100007AE0(v11, v12, v13);
      }
    ...
    case 0x1F6:
      ...
      {
LABEL_143:
        *(v5 + 52) = sub_100007AE0(v65, v66, v67);
      }
    ...
    case 0x1F7:
      ...
      if (v46)
      {
        *(v5 + 68) = sub_100007AE0(v42, v43, v44);
      }
...
LABEL_146:
  ...
  if (a2 != 701)
  {
    if (a2 == 801)
    {
      ...
      if (v38)
      {
        *(v5 + 32) = sub_100007AE0(v34, v35, v36);
      }
