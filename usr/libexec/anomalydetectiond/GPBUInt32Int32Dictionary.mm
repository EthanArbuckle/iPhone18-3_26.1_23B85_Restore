...
- (GPBUInt32Int32Dictionary)initWithDictionary:(id)dictionary;
- (GPBUInt32Int32Dictionary)initWithInt32s:(const int *)int32s forKeys:(const unsigned int *)keys count:(unint64_t)count;
...
{
  v14.receiver = self;
  v14.super_class = GPBUInt32Int32Dictionary;
...
- (void)dealloc
{
  ...
  v3.receiver = self;
  v3.super_class = GPBUInt32Int32Dictionary;
  [(GPBUInt32Int32Dictionary *)&v3 dealloc];
}

- (id)copyWithZone:(_NSZone *)zone
{
  v4 = [GPBUInt32Int32Dictionary allocWithZone:zone];
