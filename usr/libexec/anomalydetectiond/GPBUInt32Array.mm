...
+ (GPBUInt32Array)arrayWithCapacity:(unint64_t)capacity;
+ (GPBUInt32Array)arrayWithValueArray:(id)array;
+ (id)array;
- (BOOL)isEqual:(id)equal;
- (GPBUInt32Array)init;
- (GPBUInt32Array)initWithCapacity:(unint64_t)capacity;
- (GPBUInt32Array)initWithValues:(const unsigned int *)values count:(unint64_t)count;
...
- (GPBUInt32Array)initWithCapacity:(unint64_t)capacity
{
  v4 = [(GPBUInt32Array *)self initWithValues:0 count:0];
  v5 = v4;
  if (capacity && v4)
  {
    [(GPBUInt32Array *)v4 internalResizeToCapacity:capacity];
  }
...
- (id)copyWithZone:(_NSZone *)zone
{
  v4 = [GPBUInt32Array allocWithZone:zone];
  values = self->_values;
  count = self->_count;
