...
- (GPBDoubleArray)init;
- (GPBDoubleArray)initWithCapacity:(unint64_t)capacity;
- (GPBDoubleArray)initWithValues:(const double *)values count:(unint64_t)count;
...
- (GPBDoubleArray)initWithCapacity:(unint64_t)capacity
{
  ...
  if (capacity && v4)
  {
    [(GPBDoubleArray *)v4 internalResizeToCapacity:capacity];
  }
...
- (id)copyWithZone:(_NSZone *)zone
{
  v4 = [GPBDoubleArray allocWithZone:zone];
  values = self->_values;
  count = self->_count;
