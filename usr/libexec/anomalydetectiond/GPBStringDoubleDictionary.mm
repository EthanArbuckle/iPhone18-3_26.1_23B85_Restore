...
- (GPBStringDoubleDictionary)initWithDictionary:(id)dictionary;
- (GPBStringDoubleDictionary)initWithDoubles:(const double *)doubles forKeys:(id *)keys count:(unint64_t)count;
...
{
  v14.receiver = self;
  v14.super_class = GPBStringDoubleDictionary;
...
- (void)dealloc
{
  ...
  v3.receiver = self;
  v3.super_class = GPBStringDoubleDictionary;
  [(GPBStringDoubleDictionary *)&v3 dealloc];
}

- (id)copyWithZone:(_NSZone *)zone
{
  v4 = [GPBStringDoubleDictionary allocWithZone:zone];
