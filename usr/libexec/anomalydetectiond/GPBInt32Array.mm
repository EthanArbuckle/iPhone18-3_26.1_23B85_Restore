...
- (GPBInt32Array)init;
- (GPBInt32Array)initWithCapacity:(unint64_t)capacity;
- (GPBInt32Array)initWithValues:(const int *)values count:(unint64_t)count;
...
- (GPBInt32Array)initWithCapacity:(unint64_t)capacity
{
  v4 = [(GPBInt32Array *)self initWithValues:0 count:0];
  v5 = v4;
  if (capacity && v4)
  {
    [(GPBInt32Array *)v4 internalResizeToCapacity:capacity];
  }
...
- (id)copyWithZone:(_NSZone *)zone
{
  v4 = [GPBInt32Array allocWithZone:zone];
  values = self->_values;
  count = self->_count;
