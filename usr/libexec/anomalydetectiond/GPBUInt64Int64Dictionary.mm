...
- (GPBUInt64Int64Dictionary)initWithDictionary:(id)dictionary;
- (GPBUInt64Int64Dictionary)initWithInt64s:(const int64_t *)int64s forKeys:(const unint64_t *)keys count:(unint64_t)count;
...
- (id)copyWithZone:(_NSZone *)zone
{
  v4 = [GPBUInt64Int64Dictionary allocWithZone:zone];
