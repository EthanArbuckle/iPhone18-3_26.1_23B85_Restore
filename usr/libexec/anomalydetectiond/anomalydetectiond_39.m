...
LABEL_12:
  PB::TextFormatter::format(a2, "maxNormTimestamp", *(this + 3));
  v5 = *(this + 44);
  if ((v5 & 0x10) == 0)
  {
LABEL_5:
...
uint64_t CMMsl::KappaPeakDetectorMapResult::formatText(CMMsl::KappaPeakDetectorMapResult *this, PB::TextFormatter *a2, const char *a3)
{
  ...
  if (v11)
  {
    PB::TextFormatter::format(a2, "epochFirstTimestamp", *(this + 7));
    v11 = *(this + 38);
    if ((v11 & 2) == 0)
    {
LABEL_9:
  ...
  PB::TextFormatter::format(a2, "epochLastTimestamp", *(this + 8));
  v11 = *(this + 38);
  if ((v11 & 0x10000) == 0)
  {
LABEL_10:
...
LABEL_30:
  PB::TextFormatter::format(a2, "isMAPDetected", *(this + 148));
  v11 = *(this + 38);
  if ((v11 & 0x100) == 0)
  {
LABEL_11:
...
LABEL_34:
  PB::TextFormatter::format(a2, "minNumPeaks", *(this + 32));
  v11 = *(this + 38);
  if ((v11 & 0x1000) == 0)
  {
LABEL_15:
...
LABEL_35:
  PB::TextFormatter::format(a2, "numPeaks", *(this + 33));
  v11 = *(this + 38);
  if ((v11 & 0x2000) == 0)
  {
LABEL_16:
...
LABEL_37:
  PB::TextFormatter::format(a2, "peakSeparation", *(this + 149));
  v11 = *(this + 38);
  if ((v11 & 4) == 0)
  {
LABEL_18:
...
LABEL_38:
  PB::TextFormatter::format(a2, "peakTimeDeltaPercentileDiff", *(this + 9));
  v11 = *(this + 38);
  if ((v11 & 8) == 0)
  {
LABEL_19:
...
LABEL_39:
  PB::TextFormatter::format(a2, "peakToPeakMinimumSeparation", *(this + 10));
  v11 = *(this + 38);
  if ((v11 & 0x10) == 0)
  {
LABEL_20:
...
LABEL_40:
  PB::TextFormatter::format(a2, "peakToPeakSeparationThreshold", *(this + 11));
  v11 = *(this + 38);
  if ((v11 & 0x20) == 0)
  {
LABEL_21:
...
LABEL_41:
  PB::TextFormatter::format(a2, "timePercentileDiffThreshold", *(this + 12));
  v11 = *(this + 38);
  if ((v11 & 0x4000) == 0)
  {
LABEL_22:
...
uint64_t CMMsl::KappaPeakDetectorMapResult::writeTo(uint64_t this, PB::Writer *a2)
{
  ...
  if ((v4 & 0x80) != 0)
  {
    this = PB::Writer::write(a2, *(this + 112), 1u);
    v4 = *(v3 + 152);
    if ((v4 & 8) == 0)
    {
LABEL_3:
  ...
  this = PB::Writer::writeVarInt(a2, *(v3 + 80), 2u);
  v4 = *(v3 + 152);
  if ((v4 & 0x800) == 0)
  {
LABEL_4:
...
LABEL_31:
  this = PB::Writer::write(a2, *(v3 + 140), 5u);
  v4 = *(v3 + 152);
  if ((v4 & 0x8000) == 0)
  {
LABEL_7:
...
LABEL_32:
  this = PB::Writer::write(a2, *(v3 + 144), 6u);
  v4 = *(v3 + 152);
  if ((v4 & 0x200) == 0)
  {
LABEL_8:
...
LABEL_35:
  this = PB::Writer::writeVarInt(a2, *(v3 + 96), 9u);
  v4 = *(v3 + 152);
  if ((v4 & 0x100) == 0)
  {
LABEL_11:
...
LABEL_37:
  this = PB::Writer::write(a2, *(v3 + 148), 0x65u);
  v4 = *(v3 + 152);
  if ((v4 & 0x40) == 0)
  {
LABEL_13:
...
LABEL_38:
  this = PB::Writer::writeVarInt(a2, *(v3 + 104), 0x66u);
  v4 = *(v3 + 152);
  if ((v4 & 0x1000) == 0)
  {
LABEL_14:
...
LABEL_40:
    this = PB::Writer::writeVarInt(a2, *(v3 + 72), 0xCAu);
    if ((*(v3 + 152) & 0x2000) == 0)
    {
      goto LABEL_17;
    }
...
LABEL_39:
  this = PB::Writer::writeVarInt(a2, *(v3 + 132), 0xC9u);
  v4 = *(v3 + 152);
  if ((v4 & 4) != 0)
  {
    goto LABEL_40;
...
LABEL_15:
  ...
  {
LABEL_16:
    this = PB::Writer::write(a2, *(v3 + 136), 0xCBu);
  }
...
LABEL_43:
    this = PB::Writer::writeVarInt(a2, *(v3 + 64), 0xCFu);
    if ((*(v3 + 152) & 0x20000) == 0)
    {
      return this;
    }
  ...
  this = PB::Writer::writeVarInt(a2, *(v3 + 56), 0xCEu);
  v11 = *(v3 + 152);
  if ((v11 & 2) != 0)
  {
    goto LABEL_43;
...
LABEL_26:
  PB::TextFormatter::format(a2, "dimensions", *(this + 1));
  v5 = *(this + 28);
  if ((v5 & 2) == 0)
  {
LABEL_5:
...
LABEL_27:
  PB::TextFormatter::format(a2, "epochCounter", *(this + 2));
  v5 = *(this + 28);
  if ((v5 & 4) == 0)
  {
LABEL_6:
...
LABEL_28:
  PB::TextFormatter::format(a2, "jHG", *(this + 3));
  v5 = *(this + 28);
  if ((v5 & 8) == 0)
  {
LABEL_7:
...
LABEL_29:
  PB::TextFormatter::format(a2, "jImpactStart", *(this + 4));
  v5 = *(this + 28);
  if ((v5 & 0x10) == 0)
  {
LABEL_8:
...
LABEL_30:
  PB::TextFormatter::format(a2, "jLG", *(this + 5));
  v5 = *(this + 28);
  if ((v5 & 0x20) == 0)
  {
LABEL_9:
...
LABEL_31:
  PB::TextFormatter::format(a2, "nextTimestamp", *(this + 6));
  v5 = *(this + 28);
  if ((v5 & 0x40000) == 0)
  {
LABEL_10:
...
LABEL_32:
  PB::TextFormatter::format(a2, "partOfHgPath", *(this + 108));
  v5 = *(this + 28);
  if ((v5 & 0x200) == 0)
  {
LABEL_11:
...
LABEL_33:
  PB::TextFormatter::format(a2, "pointType", *(this + 18));
  v5 = *(this + 28);
  if ((v5 & 0x400) == 0)
  {
LABEL_12:
...
LABEL_3:
  ...
  this = PB::Writer::writeSInt(a2, *(v3 + 32), 2u);
  v4 = *(v3 + 112);
  if ((v4 & 1) == 0)
  {
LABEL_4:
...
LABEL_25:
  this = PB::Writer::write(a2, *(v3 + 84), 5u);
  v4 = *(v3 + 112);
  if ((v4 & 0x4000) == 0)
  {
LABEL_7:
...
LABEL_27:
  this = PB::Writer::write(a2, *(v3 + 100), 7u);
  v4 = *(v3 + 112);
  if ((v4 & 0x400) == 0)
  {
LABEL_9:
...
LABEL_28:
  this = PB::Writer::write(a2, *(v3 + 76), 8u);
  v4 = *(v3 + 112);
  if ((v4 & 0x2000) == 0)
  {
LABEL_10:
...
LABEL_31:
  this = PB::Writer::write(a2, *(v3 + 104), 0xBu);
  v4 = *(v3 + 112);
  if ((v4 & 0x800) == 0)
  {
LABEL_13:
...
LABEL_34:
  this = PB::Writer::write(a2, *(v3 + 108), 0xEu);
  v4 = *(v3 + 112);
  if ((v4 & 0x200) == 0)
  {
LABEL_16:
...
LABEL_35:
  this = PB::Writer::writeVarInt(a2, *(v3 + 72), 0xFu);
  v4 = *(v3 + 112);
  if ((v4 & 2) == 0)
  {
LABEL_17:
...
LABEL_36:
  this = PB::Writer::writeVarInt(a2, *(v3 + 16), 0x10u);
  v4 = *(v3 + 112);
  if ((v4 & 0x20) == 0)
  {
LABEL_18:
...
LABEL_38:
    this = PB::Writer::writeVarInt(a2, *(v3 + 40), 0x12u);
    if ((*(v3 + 112) & 4) == 0)
    {
      return this;
    }
...
uint64_t CMMsl::KappaPulseInertialAccel::formatText(CMMsl::KappaPulseInertialAccel *this, PB::TextFormatter *a2, const char *a3)
{
  ...
  if (v5)
  {
    PB::TextFormatter::format(a2, "epochCounter", *(this + 1));
    v5 = *(this + 40);
    if ((v5 & 2) == 0)
    {
LABEL_3:
...
uint64_t CMMsl::KappaPulseInertialAccel::writeTo(uint64_t this, PB::Writer *a2)
{
  ...
  if ((v4 & 0x100) != 0)
  {
    this = PB::Writer::writeVarInt(a2, *(this + 72), 1u);
    v4 = *(v3 + 80);
    if ((v4 & 2) == 0)
    {
LABEL_3:
...
LABEL_15:
  this = PB::Writer::writeVarInt(a2, *(v3 + 8), 5u);
  v4 = *(v3 + 80);
  if ((v4 & 0x20) == 0)
  {
LABEL_7:
...
LABEL_20:
  PB::TextFormatter::format(a2, "epochCounter", *(this + 4));
  v5 = *(this + 52);
  if ((v5 & 0x10) == 0)
  {
LABEL_6:
...
LABEL_21:
  this = PB::Writer::write(a2, *(v3 + 88), 8u);
  v4 = *(v3 + 104);
  if ((v4 & 0x80) == 0)
  {
LABEL_10:
...
LABEL_83:
  PB::TextFormatter::format(a2, "deltaTriggerTime", *(this + 1));
  v6 = *v5;
  if ((*v5 & 0x10000) == 0)
  {
LABEL_10:
...
LABEL_96:
  PB::TextFormatter::format(a2, "epochFirstTimestamp", *(this + 2));
  v6 = *v5;
  if ((*v5 & 4) == 0)
  {
LABEL_23:
...
LABEL_97:
  PB::TextFormatter::format(a2, "epochLastTimestamp", *(this + 3));
  v6 = *v5;
  if ((*v5 & 8) == 0)
  {
LABEL_24:
...
LABEL_98:
  PB::TextFormatter::format(a2, "faultCounter", *(this + 4));
  v6 = *v5;
  if ((*v5 & 0x10) == 0)
  {
LABEL_25:
...
LABEL_99:
  PB::TextFormatter::format(a2, "hgAccelBufferSize", *(this + 5));
  v6 = *v5;
  if ((*v5 & 0x10000000) == 0)
  {
LABEL_26:
...
LABEL_45:
  if ((*(this + 324) & 8) != 0)
  {
    PB::TextFormatter::format(a2, "isPulseDetected", *(this + 312));
  }
...
LABEL_68:
  ...
  if ((*v5 & 0x20) != 0)
  {
    PB::TextFormatter::format(a2, "maxPulseStartTime", *(this + 6));
    v9 = *v5;
    if ((*v5 & 0x40) == 0)
    {
LABEL_70:
  ...
  PB::TextFormatter::format(a2, "maxPulseTime", *(this + 7));
  v9 = *v5;
  if ((*v5 & 0x80) == 0)
  {
LABEL_71:
...
LABEL_141:
  ...
  {
LABEL_72:
    PB::TextFormatter::format(a2, "triggerTimestamp", *(this + 9));
  }
