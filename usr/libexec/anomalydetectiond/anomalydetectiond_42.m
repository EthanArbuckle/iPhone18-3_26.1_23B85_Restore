...
uint64_t CMMsl::KappaSevereCrashResult::formatText(CMMsl::KappaSevereCrashResult *this, PB::TextFormatter *a2, const char *a3)
{
  ...
  if ((*(this + 368) & 0x40) != 0)
  {
    PB::TextFormatter::format(a2, "anyLowSense", *(this + 320));
  }
  ...
  if ((*(this + 368) & 0x80) != 0)
  {
    PB::TextFormatter::format(a2, "crashDetectorDecision", *(this + 321));
  }

  v6 = *(this + 45);
  if (v6)
  {
    PB::TextFormatter::format(a2, "crashTimestamp", *(this + 1));
    v6 = *(this + 45);
    if ((v6 & 0x400) == 0)
    {
LABEL_11:
...
LABEL_134:
  PB::TextFormatter::format(a2, "deltaSteps", *(this + 24));
  v6 = *(this + 45);
  if ((v6 & 0x8000) == 0)
  {
LABEL_16:
...
LABEL_18:
  ...
  if ((v7 & 0x100) != 0)
  {
    PB::TextFormatter::format(a2, "earlyCrashDetectorDecision", *(this + 322));
    v7 = *(this + 46);
    if ((v7 & 0x200) == 0)
    {
LABEL_20:
  ...
  PB::TextFormatter::format(a2, "escalationCandidate", *(this + 323));
  if ((*(this + 46) & 0x400) != 0)
  {
LABEL_21:
    PB::TextFormatter::format(a2, "escalationCandidateSuppressed", *(this + 324));
  }
...
LABEL_22:
  ...
  if ((v8 & 0x20000) != 0)
  {
    PB::TextFormatter::format(a2, "faultCounter", *(this + 27));
    v8 = *(this + 45);
  }

  if ((v8 & 2) != 0)
  {
    PB::TextFormatter::format(a2, "firstTimestampMAPDecision", *(this + 2));
  }

  if ((*(this + 369) & 8) != 0)
  {
    PB::TextFormatter::format(a2, "hasSteps", *(this + 325));
  }

  if ((*(this + 362) & 4) != 0)
  {
    PB::TextFormatter::format(a2, "highSensitivityBitmap", *(this + 28));
  }

  v9 = *(this + 46);
  if ((v9 & 0x1000) != 0)
  {
    PB::TextFormatter::format(a2, "isAirbagDetectedOverWindow", *(this + 326));
    v9 = *(this + 46);
    if ((v9 & 0x2000) == 0)
    {
LABEL_32:
  ...
  PB::TextFormatter::format(a2, "isAutocorrelationDecided", *(this + 327));
  v9 = *(this + 46);
  if ((v9 & 0x4000) == 0)
  {
LABEL_33:
...
LABEL_142:
  PB::TextFormatter::format(a2, "isCrashDetected", *(this + 328));
  v9 = *(this + 46);
  if ((v9 & 0x8000) == 0)
  {
LABEL_34:
...
LABEL_143:
  PB::TextFormatter::format(a2, "isDecisionMadeAtBoundary", *(this + 329));
  v9 = *(this + 46);
  if ((v9 & 0x10000) == 0)
  {
LABEL_35:
...
LABEL_144:
  PB::TextFormatter::format(a2, "isDescalationDecided", *(this + 330));
  v9 = *(this + 46);
  if ((v9 & 0x20000) == 0)
  {
LABEL_36:
...
LABEL_145:
  PB::TextFormatter::format(a2, "isDescalationRequired", *(this + 331));
  v9 = *(this + 46);
  if ((v9 & 0x40000) == 0)
  {
LABEL_37:
...
LABEL_146:
  PB::TextFormatter::format(a2, "isEvaluatingMovingGps", *(this + 332));
  v9 = *(this + 46);
  if ((v9 & 0x80000) == 0)
  {
LABEL_38:
...
LABEL_147:
  PB::TextFormatter::format(a2, "isFreeFallDetectedEpoch", *(this + 333));
  v9 = *(this + 46);
  if ((v9 & 0x100000) == 0)
  {
LABEL_39:
...
LABEL_148:
  PB::TextFormatter::format(a2, "isHighSpeedCrashDetected", *(this + 334));
  v9 = *(this + 46);
  if ((v9 & 0x200000) == 0)
  {
LABEL_40:
...
LABEL_149:
  PB::TextFormatter::format(a2, "isHighSpeedCrashDetectedOverWindow", *(this + 335));
  v9 = *(this + 46);
  if ((v9 & 0x400000) == 0)
  {
LABEL_41:
...
LABEL_150:
  PB::TextFormatter::format(a2, "isHighSpeedDetectedOverWindow", *(this + 336));
  v9 = *(this + 46);
  if ((v9 & 0x800000) == 0)
  {
LABEL_42:
...
LABEL_151:
  PB::TextFormatter::format(a2, "isLowSensCrashDetected", *(this + 337));
  v9 = *(this + 46);
  if ((v9 & 0x1000000) == 0)
  {
LABEL_43:
...
LABEL_152:
  PB::TextFormatter::format(a2, "isLowSensRolloverCrashDetected", *(this + 338));
  v9 = *(this + 46);
  if ((v9 & 0x2000000) == 0)
  {
LABEL_44:
...
LABEL_153:
  PB::TextFormatter::format(a2, "isMAPFPDecided", *(this + 339));
  v9 = *(this + 46);
  if ((v9 & 0x4000000) == 0)
  {
LABEL_45:
...
LABEL_154:
  PB::TextFormatter::format(a2, "isQuiescenceDecided", *(this + 340));
  v9 = *(this + 46);
  if ((v9 & 0x8000000) == 0)
  {
LABEL_46:
...
LABEL_155:
  PB::TextFormatter::format(a2, "isRolloverCrashDetected", *(this + 341));
  v9 = *(this + 46);
  if ((v9 & 0x10000000) == 0)
  {
LABEL_47:
...
LABEL_156:
  PB::TextFormatter::format(a2, "isStepsDecided", *(this + 342));
  v9 = *(this + 46);
  if ((v9 & 0x20000000) == 0)
  {
LABEL_48:
...
LABEL_157:
  PB::TextFormatter::format(a2, "isTriggerClustersDecided", *(this + 343));
  if ((*(this + 46) & 0x40000000) != 0)
  {
LABEL_49:
    PB::TextFormatter::format(a2, "isUshaFPDecided", *(this + 344));
  }
...
LABEL_50:
  ...
  if ((v10 & 4) != 0)
  {
    PB::TextFormatter::format(a2, "lastLocalRealTriggerTimestamp", *(this + 3));
    v10 = *(this + 45);
    if ((v10 & 8) == 0)
    {
LABEL_52:
  ...
  PB::TextFormatter::format(a2, "lastRemoteRealTriggerTimestamp", *(this + 4));
  v10 = *(this + 45);
  if ((v10 & 0x10) == 0)
  {
LABEL_53:
...
LABEL_161:
  PB::TextFormatter::format(a2, "lastRemoteSampleTimestamp", *(this + 5));
  v10 = *(this + 45);
  if ((v10 & 0x20) == 0)
  {
LABEL_54:
...
LABEL_162:
  PB::TextFormatter::format(a2, "lastTimestampMAPDecision", *(this + 6));
  v10 = *(this + 45);
  if ((v10 & 0x80000) == 0)
  {
LABEL_55:
...
LABEL_163:
  PB::TextFormatter::format(a2, "lowSpeedOrFakeCountAtBoundaryThreshold", *(this + 29));
  v10 = *(this + 45);
  if ((v10 & 0x100000) == 0)
  {
LABEL_56:
...
LABEL_168:
  PB::TextFormatter::format(a2, "movingCountThreshold", *(this + 34));
  v10 = *(this + 45);
  if ((v10 & 0x2000000) == 0)
  {
LABEL_61:
...
LABEL_169:
  PB::TextFormatter::format(a2, "movingCountThresholdFromSydneyB", *(this + 35));
  v10 = *(this + 45);
  if ((v10 & 0x4000000) == 0)
  {
LABEL_62:
...
LABEL_171:
  PB::TextFormatter::format(a2, "movingGpsCount", *(this + 37));
  v10 = *(this + 45);
  if ((v10 & 0x10000000) == 0)
  {
LABEL_64:
...
LABEL_172:
  PB::TextFormatter::format(a2, "movingGpsCountTotal", *(this + 38));
  v10 = *(this + 45);
  if ((v10 & 0x20000000) == 0)
  {
LABEL_65:
...
LABEL_173:
  PB::TextFormatter::format(a2, "numAudioSkiing", *(this + 39));
  v10 = *(this + 45);
  if ((v10 & 0x40000000) == 0)
  {
LABEL_66:
...
LABEL_174:
  PB::TextFormatter::format(a2, "numAudioSkiingThreshold", *(this + 40));
  v10 = *(this + 45);
  if ((v10 & 0x80000000) == 0)
  {
LABEL_67:
...
LABEL_175:
  PB::TextFormatter::format(a2, "numBaroIncreasesSkiing", *(this + 41));
  v10 = *(this + 45);
  if ((v10 & 0x100000000) == 0)
  {
LABEL_68:
...
LABEL_176:
  PB::TextFormatter::format(a2, "numBaroIncreasesSkiingThreshold", *(this + 42));
  v10 = *(this + 45);
  if ((v10 & 0x200000000) == 0)
  {
LABEL_69:
...
LABEL_177:
  PB::TextFormatter::format(a2, "numDeescalationAOI", *(this + 43));
  v10 = *(this + 45);
  if ((v10 & 0x400000000) == 0)
  {
LABEL_70:
...
LABEL_178:
  PB::TextFormatter::format(a2, "numDeescalationMAP", *(this + 44));
  v10 = *(this + 45);
  if ((v10 & 0x800000000) == 0)
  {
LABEL_71:
...
LABEL_179:
  PB::TextFormatter::format(a2, "numDeescalationTwoLevel", *(this + 45));
  v10 = *(this + 45);
  if ((v10 & 0x1000000000) == 0)
  {
LABEL_72:
...
LABEL_180:
  PB::TextFormatter::format(a2, "numDeescalationUsha", *(this + 46));
  v10 = *(this + 45);
  if ((v10 & 0x2000000000) == 0)
  {
LABEL_73:
...
LABEL_181:
  PB::TextFormatter::format(a2, "numGpsSamplesInHistory", *(this + 47));
  v10 = *(this + 45);
  if ((v10 & 0x4000000000) == 0)
  {
LABEL_74:
...
LABEL_182:
  PB::TextFormatter::format(a2, "numLowOrFakeGpsSamplesInHistory", *(this + 48));
  v10 = *(this + 45);
  if ((v10 & 0x8000000000) == 0)
  {
LABEL_75:
...
LABEL_183:
  PB::TextFormatter::format(a2, "numTriggersWithRecentSkiLiftDetected", *(this + 49));
  v10 = *(this + 45);
  if ((v10 & 0x10000000000) == 0)
  {
LABEL_76:
...
LABEL_184:
  PB::TextFormatter::format(a2, "numTriggersWithTrueBtHint", *(this + 50));
  v10 = *(this + 45);
  if ((v10 & 0x20000000000) == 0)
  {
LABEL_77:
...
LABEL_185:
  PB::TextFormatter::format(a2, "numUshaCPEpoch", *(this + 51));
  v10 = *(this + 45);
  if ((v10 & 0x40000000000) == 0)
  {
LABEL_78:
...
LABEL_186:
  PB::TextFormatter::format(a2, "numUshaCPEpochThreshold", *(this + 52));
  v10 = *(this + 45);
  if ((v10 & 0x80000000000) == 0)
  {
LABEL_79:
...
LABEL_187:
  PB::TextFormatter::format(a2, "numUshaFPEpoch", *(this + 53));
  v10 = *(this + 45);
  if ((v10 & 0x100000000000) == 0)
  {
LABEL_80:
...
LABEL_188:
  PB::TextFormatter::format(a2, "numUshaFPEpochThreshold", *(this + 54));
  v10 = *(this + 45);
  if ((v10 & 0x200000000000) == 0)
  {
LABEL_81:
...
LABEL_189:
  PB::TextFormatter::format(a2, "pedometerArmConstrainedState", *(this + 55));
  v10 = *(this + 45);
  if ((v10 & 0x400000000000) == 0)
  {
LABEL_82:
...
LABEL_192:
  PB::TextFormatter::format(a2, "quiescencePulseEpochCount", *(this + 58));
  v10 = *(this + 45);
  if ((v10 & 0x2000000000000) == 0)
  {
LABEL_85:
...
LABEL_193:
  PB::TextFormatter::format(a2, "quiescenceSpinEpochCount", *(this + 59));
  v10 = *(this + 45);
  if ((v10 & 0x4000000000000) == 0)
  {
LABEL_86:
...
LABEL_194:
  PB::TextFormatter::format(a2, "sameEventState", *(this + 60));
...
LABEL_88:
  ...
  if ((v11 & 0x80000000) != 0)
  {
    PB::TextFormatter::format(a2, "shouldDeescalateBecauseOfAutocorrelationCondition", *(this + 345));
    v11 = *(this + 46);
...
LABEL_90:
  ...
  PB::TextFormatter::format(a2, "shouldDeescalateBecauseOfCrashClassifierCondition", *(this + 346));
  v11 = *(this + 46);
  if ((v11 & 0x200000000) == 0)
  {
LABEL_91:
...
LABEL_198:
  PB::TextFormatter::format(a2, "shouldDeescalateBecauseOfJointDetectionCondition", *(this + 347));
  v11 = *(this + 46);
  if ((v11 & 0x400000000) == 0)
  {
LABEL_92:
...
LABEL_199:
  PB::TextFormatter::format(a2, "shouldDeescalateBecauseOfMAPFPCondition", *(this + 348));
  v11 = *(this + 46);
  if ((v11 & 0x800000000) == 0)
  {
LABEL_93:
...
LABEL_200:
  PB::TextFormatter::format(a2, "shouldDeescalateBecauseOfMovingCondition", *(this + 349));
  v11 = *(this + 46);
  if ((v11 & 0x1000000000) == 0)
  {
LABEL_94:
...
LABEL_201:
  PB::TextFormatter::format(a2, "shouldDeescalateBecauseOfQuiescenceCondition", *(this + 350));
  v11 = *(this + 46);
  if ((v11 & 0x2000000000) == 0)
  {
LABEL_95:
...
LABEL_202:
  PB::TextFormatter::format(a2, "shouldDeescalateBecauseOfSkiLiftCondition", *(this + 351));
  v11 = *(this + 46);
  if ((v11 & 0x4000000000) == 0)
  {
LABEL_96:
...
LABEL_203:
  PB::TextFormatter::format(a2, "shouldDeescalateBecauseOfSkiingCondition", *(this + 352));
  v11 = *(this + 46);
  if ((v11 & 0x8000000000) == 0)
  {
LABEL_97:
...
LABEL_204:
  PB::TextFormatter::format(a2, "shouldDeescalateBecauseOfStaticCondition", *(this + 353));
  v11 = *(this + 46);
  if ((v11 & 0x10000000000) == 0)
  {
LABEL_98:
...
LABEL_205:
  PB::TextFormatter::format(a2, "shouldDeescalateBecauseOfStepsCondition", *(this + 354));
  v11 = *(this + 46);
  if ((v11 & 0x20000000000) == 0)
  {
LABEL_99:
...
LABEL_206:
  PB::TextFormatter::format(a2, "shouldDeescalateBecauseOfTriggerClustersCondition", *(this + 355));
  v11 = *(this + 46);
  if ((v11 & 0x40000000000) == 0)
  {
LABEL_100:
...
LABEL_207:
  PB::TextFormatter::format(a2, "shouldDeescalateBecauseOfTwoLevelSensitivityCondition", *(this + 356));
  v11 = *(this + 46);
  if ((v11 & 0x80000000000) == 0)
  {
LABEL_101:
...
LABEL_208:
  PB::TextFormatter::format(a2, "shouldDeescalateBecauseOfUshaFPCondition", *(this + 357));
  if ((*(this + 46) & 0x100000000000) != 0)
  {
LABEL_102:
    PB::TextFormatter::format(a2, "shouldEnableHighSensBecauseOfDistanceToRoadCondition", *(this + 358));
  }
...
LABEL_105:
  ...
  PB::TextFormatter::format(a2, "staticCountThreshold", *(this + 63));
  v12 = *(this + 45);
  if ((v12 & 0x40000000000000) == 0)
  {
LABEL_106:
...
LABEL_212:
  PB::TextFormatter::format(a2, "staticGpsCount", *(this + 64));
  v12 = *(this + 45);
  if ((v12 & 0x80000000000000) == 0)
  {
LABEL_107:
...
LABEL_213:
  PB::TextFormatter::format(a2, "staticGpsCountTotal", *(this + 65));
  v12 = *(this + 45);
  if ((v12 & 0x100000000000000) == 0)
  {
LABEL_108:
...
LABEL_214:
  PB::TextFormatter::format(a2, "stationaryCountMissingAsNoOpThreshold", *(this + 66));
  v12 = *(this + 45);
  if ((v12 & 0x200000000000000) == 0)
  {
LABEL_109:
...
LABEL_215:
  PB::TextFormatter::format(a2, "stepCountEventTimestamp", *(this + 67));
  v12 = *(this + 45);
  if ((v12 & 0x40) == 0)
  {
LABEL_110:
...
LABEL_216:
  PB::TextFormatter::format(a2, "stepCountEventTimestamp64", *(this + 7));
  v12 = *(this + 45);
  if ((v12 & 0x400000000000000) == 0)
  {
LABEL_111:
...
LABEL_219:
  PB::TextFormatter::format(a2, "stepsCount", *(this + 70));
  v12 = *(this + 45);
  if ((v12 & 0x2000000000000000) == 0)
  {
LABEL_114:
...
LABEL_221:
    PB::TextFormatter::format(a2, "stepsDeescalatedAtOpp", *(this + 72));
...
LABEL_220:
  PB::TextFormatter::format(a2, "stepsCountThreshold", *(this + 71));
  v12 = *(this + 45);
  if ((v12 & 0x4000000000000000) != 0)
  {
    goto LABEL_221;
...
LABEL_118:
  ...
  {
LABEL_119:
    PB::TextFormatter::format(a2, "stepsSecondOpportunityLookbackLength", *(this + 76));
  }
...
LABEL_120:
  ...
  if ((v14 & 8) != 0)
  {
    PB::TextFormatter::format(a2, "triggerClusterDeescalationWindowBoundary", *(this + 77));
    v14 = *(this + 46);
    if ((v14 & 0x10) == 0)
    {
LABEL_124:
...
uint64_t CMMsl::KappaSevereCrashResult::writeTo(uint64_t this, PB::Writer *a2)
{
  ...
  if ((v4 & 0x800000) != 0)
  {
    this = PB::Writer::write(a2, *(this + 132), 1u);
    v4 = *(v3 + 360);
    if ((v4 & 0x400000) == 0)
    {
LABEL_3:
  ...
  this = PB::Writer::write(a2, *(v3 + 128), 2u);
  v4 = *(v3 + 360);
  if ((v4 & 0x1000000) == 0)
  {
LABEL_4:
...
LABEL_141:
  this = PB::Writer::writeVarInt(a2, *(v3 + 136), 3u);
  if ((*(v3 + 360) & 0x20000000000000) != 0)
  {
LABEL_5:
    this = PB::Writer::writeVarInt(a2, *(v3 + 252), 4u);
  }

LABEL_6:
  if ((*(v3 + 368) & 2) != 0)
  {
    this = PB::Writer::write(a2, *(v3 + 300), 5u);
  }

  v5 = *(v3 + 360);
  if ((v5 & 0x800000000000000) != 0)
  {
    this = PB::Writer::write(a2, *(v3 + 276), 6u);
    v5 = *(v3 + 360);
...
LABEL_10:
  ...
  this = PB::Writer::write(a2, *(v3 + 228), 7u);
  v5 = *(v3 + 360);
  if ((v5 & 0x400000000000) == 0)
  {
LABEL_11:
...
LABEL_145:
  this = PB::Writer::write(a2, *(v3 + 224), 8u);
  v5 = *(v3 + 360);
  if ((v5 & 0x200) == 0)
  {
LABEL_12:
...
LABEL_146:
  this = PB::Writer::write(a2, *(v3 + 76), 9u);
  v5 = *(v3 + 360);
  if ((v5 & 0x100000000000000) == 0)
  {
LABEL_13:
...
LABEL_147:
  this = PB::Writer::writeVarInt(a2, *(v3 + 264), 0xAu);
  v5 = *(v3 + 360);
  if ((v5 & 0x2000000) == 0)
  {
LABEL_14:
...
LABEL_148:
  this = PB::Writer::writeVarInt(a2, *(v3 + 140), 0xBu);
  if ((*(v3 + 360) & 0x10000) != 0)
  {
LABEL_15:
...
LABEL_16:
  ...
  if ((v6 & 0x10) != 0)
  {
    this = PB::Writer::write(a2, *(v3 + 312), 0xDu);
    v6 = *(v3 + 368);
  }

  if ((v6 & 0x20) != 0)
  {
    this = PB::Writer::write(a2, *(v3 + 316), 0xEu);
  }

  v7 = *(v3 + 360);
  if ((v7 & 0x100000000000) != 0)
  {
    this = PB::Writer::writeVarInt(a2, *(v3 + 216), 0xFu);
    v7 = *(v3 + 360);
...
LABEL_22:
  ...
  this = PB::Writer::writeVarInt(a2, *(v3 + 208), 0x10u);
  v7 = *(v3 + 360);
  if ((v7 & 0x8000000000000) == 0)
  {
LABEL_23:
...
LABEL_152:
  this = PB::Writer::write(a2, *(v3 + 244), 0x11u);
  if ((*(v3 + 360) & 0x2000000000000000) != 0)
  {
LABEL_24:
    this = PB::Writer::writeVarInt(a2, *(v3 + 284), 0x12u);
  }

LABEL_25:
  if ((*(v3 + 368) & 4) != 0)
  {
    this = PB::Writer::writeVarInt(a2, *(v3 + 304), 0x13u);
  }
...
LABEL_29:
  ...
  this = PB::Writer::writeVarInt(a2, *(v3 + 64), 0x65u);
  if (*(v3 + 360))
  {
LABEL_30:
    this = PB::Writer::writeVarInt(a2, *(v3 + 8), 0x66u);
  }
...
LABEL_31:
  ...
  if ((v9 & 0x80) != 0)
  {
    this = PB::Writer::write(a2, *(v3 + 321), 0x67u);
    v9 = *(v3 + 368);
    if ((v9 & 0x100) == 0)
    {
LABEL_33:
  ...
  this = PB::Writer::write(a2, *(v3 + 322), 0x68u);
  v9 = *(v3 + 368);
  if ((v9 & 0x10000) == 0)
  {
LABEL_34:
...
LABEL_159:
  this = PB::Writer::write(a2, *(v3 + 330), 0x69u);
  v9 = *(v3 + 368);
  if ((v9 & 0x20000) == 0)
  {
LABEL_35:
...
LABEL_160:
  this = PB::Writer::write(a2, *(v3 + 331), 0x6Au);
  v9 = *(v3 + 368);
  if ((v9 & 0x10000000) == 0)
  {
LABEL_36:
...
LABEL_161:
  this = PB::Writer::write(a2, *(v3 + 342), 0x6Bu);
  v9 = *(v3 + 368);
  if ((v9 & 0x4000000) == 0)
  {
LABEL_37:
...
LABEL_162:
  this = PB::Writer::write(a2, *(v3 + 340), 0x6Cu);
  v9 = *(v3 + 368);
  if ((v9 & 0x2000) == 0)
  {
LABEL_38:
...
LABEL_163:
  this = PB::Writer::write(a2, *(v3 + 327), 0x6Du);
  v9 = *(v3 + 368);
  if ((v9 & 0x20000000) == 0)
  {
LABEL_39:
...
LABEL_164:
  this = PB::Writer::write(a2, *(v3 + 343), 0x6Eu);
  v9 = *(v3 + 368);
  if ((v9 & 0x40000000) == 0)
  {
LABEL_40:
...
LABEL_165:
  this = PB::Writer::write(a2, *(v3 + 344), 0x6Fu);
  v9 = *(v3 + 368);
  if ((v9 & 0x400) == 0)
  {
LABEL_41:
...
LABEL_166:
  this = PB::Writer::write(a2, *(v3 + 324), 0x70u);
  v9 = *(v3 + 368);
  if ((v9 & 0x2000000) == 0)
  {
LABEL_42:
...
LABEL_167:
  this = PB::Writer::write(a2, *(v3 + 339), 0x71u);
  v9 = *(v3 + 368);
  if ((v9 & 0x4000) == 0)
  {
LABEL_43:
...
LABEL_168:
  this = PB::Writer::write(a2, *(v3 + 328), 0x12Du);
  v9 = *(v3 + 368);
  if ((v9 & 0x8000000) == 0)
  {
LABEL_44:
...
LABEL_169:
  this = PB::Writer::write(a2, *(v3 + 341), 0x12Eu);
  v9 = *(v3 + 368);
  if ((v9 & 0x100000) == 0)
  {
LABEL_45:
...
LABEL_170:
  this = PB::Writer::write(a2, *(v3 + 334), 0x12Fu);
  v9 = *(v3 + 368);
  if ((v9 & 0x8000000000) == 0)
  {
LABEL_46:
...
LABEL_171:
  this = PB::Writer::write(a2, *(v3 + 353), 0x130u);
  v9 = *(v3 + 368);
  if ((v9 & 0x800000000) == 0)
  {
LABEL_47:
...
LABEL_172:
  this = PB::Writer::write(a2, *(v3 + 349), 0x131u);
  v9 = *(v3 + 368);
  if ((v9 & 0x10000000000) == 0)
  {
LABEL_48:
...
LABEL_173:
  this = PB::Writer::write(a2, *(v3 + 354), 0x132u);
  v9 = *(v3 + 368);
  if ((v9 & 0x1000000000) == 0)
  {
LABEL_49:
...
LABEL_174:
  this = PB::Writer::write(a2, *(v3 + 350), 0x133u);
  v9 = *(v3 + 368);
  if ((v9 & 0x80000000) == 0)
  {
LABEL_50:
...
LABEL_175:
  this = PB::Writer::write(a2, *(v3 + 345), 0x134u);
  v9 = *(v3 + 368);
  if ((v9 & 0x1000) == 0)
  {
LABEL_51:
...
LABEL_176:
  this = PB::Writer::write(a2, *(v3 + 326), 0x135u);
  v9 = *(v3 + 368);
  if ((v9 & 0x200000) == 0)
  {
LABEL_52:
...
LABEL_177:
  this = PB::Writer::write(a2, *(v3 + 335), 0x136u);
  v9 = *(v3 + 368);
  if ((v9 & 0x20000000000) == 0)
  {
LABEL_53:
...
LABEL_178:
  this = PB::Writer::write(a2, *(v3 + 355), 0x137u);
  if ((*(v3 + 368) & 0x2000000000) != 0)
  {
LABEL_54:
    this = PB::Writer::write(a2, *(v3 + 351), 0x138u);
  }

LABEL_55:
  if ((*(v3 + 362) & 2) != 0)
  {
    this = PB::Writer::writeVarInt(a2, *(v3 + 108), 0x139u);
  }

  v10 = *(v3 + 368);
  if ((v10 & 0x800000) != 0)
  {
    this = PB::Writer::write(a2, *(v3 + 337), 0x13Au);
    v10 = *(v3 + 368);
    if ((v10 & 0x1000000) == 0)
    {
LABEL_59:
  ...
  this = PB::Writer::write(a2, *(v3 + 338), 0x13Bu);
  if ((*(v3 + 368) & 0x40) != 0)
  {
LABEL_60:
    this = PB::Writer::write(a2, *(v3 + 320), 0x13Cu);
  }

LABEL_61:
  if ((*(v3 + 362) & 4) != 0)
  {
    this = PB::Writer::writeVarInt(a2, *(v3 + 112), 0x13Du);
  }

  v11 = *(v3 + 368);
  if ((v11 & 0x100000000000) != 0)
  {
    this = PB::Writer::write(a2, *(v3 + 358), 0x13Eu);
    v11 = *(v3 + 368);
    if ((v11 & 0x40000000000) == 0)
    {
LABEL_65:
  ...
  this = PB::Writer::write(a2, *(v3 + 356), 0x13Fu);
  v11 = *(v3 + 368);
  if ((v11 & 0x80000000000) == 0)
  {
LABEL_66:
...
LABEL_185:
  this = PB::Writer::write(a2, *(v3 + 357), 0x140u);
  v11 = *(v3 + 368);
  if ((v11 & 0x400000000) == 0)
  {
LABEL_67:
...
LABEL_186:
  this = PB::Writer::write(a2, *(v3 + 348), 0x141u);
  v11 = *(v3 + 368);
  if ((v11 & 0x200000000) == 0)
  {
LABEL_68:
...
LABEL_187:
  this = PB::Writer::write(a2, *(v3 + 347), 0x142u);
  if ((*(v3 + 368) & 0x100000000) != 0)
  {
LABEL_69:
    this = PB::Writer::write(a2, *(v3 + 346), 0x143u);
  }
...
LABEL_70:
  ...
  if ((v12 & 0x40000000000000) != 0)
  {
    this = PB::Writer::writeVarInt(a2, *(v3 + 256), 0x191u);
    v12 = *(v3 + 360);
    if ((v12 & 0x80000000000000) == 0)
    {
LABEL_72:
  ...
  this = PB::Writer::writeVarInt(a2, *(v3 + 260), 0x192u);
  v12 = *(v3 + 360);
  if ((v12 & 0x8000000) == 0)
  {
LABEL_73:
...
LABEL_191:
  this = PB::Writer::writeVarInt(a2, *(v3 + 148), 0x193u);
  if ((*(v3 + 360) & 0x10000000) != 0)
  {
LABEL_74:
    this = PB::Writer::writeVarInt(a2, *(v3 + 152), 0x194u);
  }
...
LABEL_75:
  ...
  if ((v13 & 0x40000) != 0)
  {
    this = PB::Writer::write(a2, *(v3 + 332), 0x195u);
    v13 = *(v3 + 368);
  }

  if ((v13 & 0x8000) != 0)
  {
    this = PB::Writer::write(a2, *(v3 + 329), 0x196u);
  }

  v14 = *(v3 + 360);
  if ((v14 & 0x4000000000) != 0)
  {
    this = PB::Writer::writeVarInt(a2, *(v3 + 192), 0x197u);
    v14 = *(v3 + 360);
    if ((v14 & 0x80000) == 0)
    {
LABEL_81:
...
LABEL_195:
      this = PB::Writer::writeVarInt(a2, *(v3 + 188), 0x199u);
  ...
  this = PB::Writer::writeVarInt(a2, *(v3 + 116), 0x198u);
  v14 = *(v3 + 360);
  if ((v14 & 0x2000000000) != 0)
  {
    goto LABEL_195;
...
LABEL_196:
  this = PB::Writer::write(a2, *(v3 + 292), 0x1F5u);
LABEL_83:
  if (*(v3 + 368))
  {
    this = PB::Writer::write(a2, *(v3 + 296), 0x1F6u);
  }

  v15 = *(v3 + 360);
  if ((v15 & 0x400000000000000) != 0)
  {
    this = PB::Writer::write(a2, *(v3 + 272), 0x1F7u);
    v15 = *(v3 + 360);
...
LABEL_87:
  ...
  this = PB::Writer::writeVarInt(a2, *(v3 + 280), 0x1F8u);
  if ((*(v3 + 360) & 0x4000000000000000) != 0)
  {
LABEL_88:
    this = PB::Writer::writeVarInt(a2, *(v3 + 288), 0x1F9u);
  }

LABEL_89:
  if ((*(v3 + 369) & 8) != 0)
  {
    this = PB::Writer::write(a2, *(v3 + 325), 0x259u);
  }

  v16 = *(v3 + 360);
  if ((v16 & 0x4000) != 0)
  {
    this = PB::Writer::writeVarInt(a2, *(v3 + 96), 0x25Au);
    v16 = *(v3 + 360);
    if ((v16 & 0x1000) == 0)
    {
LABEL_93:
  ...
  this = PB::Writer::write(a2, *(v3 + 88), 0x25Bu);
  v16 = *(v3 + 360);
  if ((v16 & 0x200000000000) == 0)
  {
LABEL_94:
...
LABEL_202:
  this = PB::Writer::writeVarInt(a2, *(v3 + 220), 0x25Cu);
  v16 = *(v3 + 360);
  if ((v16 & 0x200000000000000) == 0)
  {
LABEL_95:
...
LABEL_203:
  this = PB::Writer::writeVarInt(a2, *(v3 + 268), 0x25Du);
  v16 = *(v3 + 360);
  if ((v16 & 0x40) == 0)
  {
LABEL_96:
...
LABEL_204:
  this = PB::Writer::writeVarInt(a2, *(v3 + 56), 0x25Eu);
  v16 = *(v3 + 360);
  if ((v16 & 0x1000000000000) == 0)
  {
LABEL_97:
...
LABEL_205:
  this = PB::Writer::writeVarInt(a2, *(v3 + 232), 0x2BDu);
  v16 = *(v3 + 360);
  if ((v16 & 0x2000000000000) == 0)
  {
LABEL_98:
...
LABEL_206:
  this = PB::Writer::writeVarInt(a2, *(v3 + 236), 0x2BEu);
  v16 = *(v3 + 360);
  if ((v16 & 0x100000) == 0)
  {
LABEL_99:
...
LABEL_207:
  this = PB::Writer::write(a2, *(v3 + 120), 0x321u);
  v16 = *(v3 + 360);
  if ((v16 & 0x400) == 0)
  {
LABEL_100:
...
LABEL_208:
  this = PB::Writer::write(a2, *(v3 + 80), 0x322u);
  v16 = *(v3 + 360);
  if ((v16 & 0x200000) == 0)
  {
LABEL_101:
...
LABEL_209:
  this = PB::Writer::write(a2, *(v3 + 124), 0x323u);
  v16 = *(v3 + 360);
  if ((v16 & 0x800) == 0)
  {
LABEL_102:
...
LABEL_210:
  this = PB::Writer::write(a2, *(v3 + 84), 0x324u);
  if ((*(v3 + 360) & 0x100) != 0)
  {
LABEL_103:
    this = PB::Writer::write(a2, *(v3 + 72), 0x385u);
  }
...
LABEL_104:
  ...
  if ((v17 & 0x400000) != 0)
  {
    this = PB::Writer::write(a2, *(v3 + 336), 0x386u);
    v17 = *(v3 + 368);
  }

  if ((v17 & 8) != 0)
  {
    this = PB::Writer::writeVarInt(a2, *(v3 + 308), 0x3E9u);
  }

  v18 = *(v3 + 360);
  if ((v18 & 0x20000000) != 0)
  {
    this = PB::Writer::writeVarInt(a2, *(v3 + 156), 0x44Du);
    v18 = *(v3 + 360);
  }

  if ((v18 & 0x80000000) != 0)
  {
    this = PB::Writer::writeVarInt(a2, *(v3 + 164), 0x44Eu);
  }

  if ((*(v3 + 372) & 0x40) != 0)
  {
    this = PB::Writer::write(a2, *(v3 + 352), 0x44Fu);
  }

  v19 = *(v3 + 360);
  if ((v19 & 0x100000000) != 0)
  {
    this = PB::Writer::writeVarInt(a2, *(v3 + 168), 0x450u);
    v19 = *(v3 + 360);
    if ((v19 & 0x40000000) == 0)
    {
LABEL_116:
  ...
  this = PB::Writer::writeVarInt(a2, *(v3 + 160), 0x451u);
  v19 = *(v3 + 360);
  if ((v19 & 0x10000000000000) == 0)
  {
LABEL_117:
...
LABEL_214:
  this = PB::Writer::write(a2, *(v3 + 248), 0x452u);
  v19 = *(v3 + 360);
  if ((v19 & 0x8000000000) == 0)
  {
LABEL_118:
...
LABEL_215:
  this = PB::Writer::writeVarInt(a2, *(v3 + 196), 0x4B1u);
  v19 = *(v3 + 360);
  if ((v19 & 0x10000000000) == 0)
  {
LABEL_119:
...
LABEL_216:
  this = PB::Writer::writeVarInt(a2, *(v3 + 200), 0x4B2u);
  v19 = *(v3 + 360);
  if ((v19 & 0x8000) == 0)
  {
LABEL_120:
...
LABEL_217:
  this = PB::Writer::write(a2, *(v3 + 100), 0x515u);
  v19 = *(v3 + 360);
  if ((v19 & 0x80000000000) == 0)
  {
LABEL_121:
...
LABEL_218:
  this = PB::Writer::writeVarInt(a2, *(v3 + 212), 0x516u);
  v19 = *(v3 + 360);
  if ((v19 & 0x20000000000) == 0)
  {
LABEL_122:
...
LABEL_219:
  this = PB::Writer::writeVarInt(a2, *(v3 + 204), 0x517u);
  v19 = *(v3 + 360);
  if ((v19 & 0x1000000000) == 0)
  {
LABEL_123:
...
LABEL_220:
  this = PB::Writer::writeVarInt(a2, *(v3 + 184), 0x518u);
  v19 = *(v3 + 360);
  if ((v19 & 0x200000000) == 0)
  {
LABEL_124:
...
LABEL_221:
  this = PB::Writer::writeVarInt(a2, *(v3 + 172), 0x519u);
  if ((*(v3 + 360) & 0x800000000) != 0)
  {
LABEL_125:
    this = PB::Writer::writeVarInt(a2, *(v3 + 180), 0x51Au);
  }
...
LABEL_126:
  ...
  if ((v20 & 0x200) != 0)
  {
    this = PB::Writer::write(a2, *(v3 + 323), 0x51Bu);
    v20 = *(v3 + 368);
  }

  if ((v20 & 0x80000) != 0)
  {
    this = PB::Writer::write(a2, *(v3 + 333), 0x51Cu);
  }

  v21 = *(v3 + 360);
  if ((v21 & 0x400000000) != 0)
  {
    this = PB::Writer::writeVarInt(a2, *(v3 + 176), 0x51Du);
    v21 = *(v3 + 360);
    if ((v21 & 2) == 0)
    {
LABEL_132:
  ...
  this = PB::Writer::writeVarInt(a2, *(v3 + 16), 0x51Eu);
  v21 = *(v3 + 360);
  if ((v21 & 0x20) == 0)
  {
LABEL_133:
...
LABEL_225:
  this = PB::Writer::writeVarInt(a2, *(v3 + 48), 0x51Fu);
  v21 = *(v3 + 360);
  if ((v21 & 4) == 0)
  {
LABEL_134:
...
LABEL_226:
  this = PB::Writer::writeVarInt(a2, *(v3 + 24), 0x520u);
  v21 = *(v3 + 360);
  if ((v21 & 8) == 0)
  {
LABEL_135:
...
LABEL_227:
  this = PB::Writer::writeVarInt(a2, *(v3 + 32), 0x521u);
  v21 = *(v3 + 360);
  if ((v21 & 0x10) == 0)
  {
LABEL_136:
...
LABEL_229:
    this = PB::Writer::writeVarInt(a2, *(v3 + 240), 0x523u);
    if ((*(v3 + 360) & 0x2000) == 0)
    {
      return this;
    }
...
LABEL_228:
  this = PB::Writer::writeVarInt(a2, *(v3 + 40), 0x522u);
  v21 = *(v3 + 360);
  if ((v21 & 0x4000000000000) != 0)
  {
    goto LABEL_229;
...
LABEL_230:
  ...
  return PB::Writer::write(a2, v22, 0x524u);
}
