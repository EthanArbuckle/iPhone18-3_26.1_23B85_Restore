...
{
  v13.receiver = self;
  v13.super_class = GPBUInt32UInt64Dictionary;
...
- (void)dealloc
{
  ...
  v3.receiver = self;
  v3.super_class = GPBUInt32UInt64Dictionary;
...
- (void)enumerateKeysAndUInt64sUsingBlock:(id)a3
{
  ...
  do
  {
    ...
    (*(a3 + 2))(a3, [v6 unsignedIntValue], objc_msgSend(-[NSMutableDictionary objectForKeyedSubscript:](dictionary, "objectForKeyedSubscript:", v6), "unsignedLongLongValue"), &v7);
  }
...
- (void)writeToCodedOutputStream:(id)a3 asField:(id)a4
{
  ...
  if (v12)
  {
    ...
    do
    {
      ...
      v17 = sub_10031D598(v15, 1, v8);
      [a3 writeInt32NoTag:{sub_10031EA6C(v16, 2, v7) + v17}];
      sub_10031D7A8(a3, v15, 1, v8);
      sub_10031EC7C(a3, v16, 2, v7);
      v13 = [v11 nextObject];
    }
