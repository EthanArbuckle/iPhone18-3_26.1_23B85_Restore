...
- (GPBFloatArray)init;
- (GPBFloatArray)initWithCapacity:(unint64_t)capacity;
- (GPBFloatArray)initWithValues:(const float *)values count:(unint64_t)count;
...
- (GPBFloatArray)initWithCapacity:(unint64_t)capacity
{
  ...
  if (capacity && v4)
  {
    [(GPBFloatArray *)v4 internalResizeToCapacity:capacity];
  }
...
- (id)copyWithZone:(_NSZone *)zone
{
  v4 = [GPBFloatArray allocWithZone:zone];
  values = self->_values;
  count = self->_count;
