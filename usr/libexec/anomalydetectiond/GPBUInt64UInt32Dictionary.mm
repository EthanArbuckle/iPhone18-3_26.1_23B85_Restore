...
- (GPBUInt64UInt32Dictionary)initWithDictionary:(id)dictionary;
- (GPBUInt64UInt32Dictionary)initWithUInt32s:(const unsigned int *)int32s forKeys:(const unint64_t *)keys count:(unint64_t)count;
...
{
  v14.receiver = self;
  v14.super_class = GPBUInt64UInt32Dictionary;
...
- (void)dealloc
{
  ...
  v3.receiver = self;
  v3.super_class = GPBUInt64UInt32Dictionary;
  [(GPBUInt64UInt32Dictionary *)&v3 dealloc];
}

- (id)copyWithZone:(_NSZone *)zone
{
  v4 = [GPBUInt64UInt32Dictionary allocWithZone:zone];
...
- (void)writeToCodedOutputStream:(id)stream asField:(id)field
{
  ...
  if (nextObject)
  {
    ...
    do
    {
      ...
      [stream writeInt32NoTag:{sub_10031D598(unsignedIntValue, 2, v7) + v17}];
