...
uint64_t CMMsl::GaitEventsModelOutput::writeTo(uint64_t this, PB::Writer *a2)
{
  ...
  if ((v4 & 0x800) != 0)
  {
    this = PB::Writer::write(a2, *(this + 84), 1u);
    v4 = *(v3 + 88);
    if ((v4 & 1) == 0)
    {
LABEL_3:
...
LABEL_25:
  this = PB::Writer::write(a2, *(v3 + 85), 0xAu);
  v4 = *(v3 + 88);
  if ((v4 & 0x2000) == 0)
  {
LABEL_12:
...
LABEL_26:
  this = PB::Writer::write(a2, *(v3 + 86), 0xBu);
  v4 = *(v3 + 88);
  if ((v4 & 0x400) == 0)
  {
LABEL_13:
...
LABEL_13:
  PB::TextFormatter::format(a2, "isSuccessful", *(this + 44));
  v5 = *(this + 48);
  if ((v5 & 0x10) == 0)
  {
LABEL_5:
...
LABEL_14:
  PB::TextFormatter::format(a2, "stepSide", *(this + 10));
  v5 = *(this + 48);
  if ((v5 & 4) == 0)
  {
LABEL_6:
...
uint64_t CMMsl::GaitEventsStrideAggregation::writeTo(uint64_t this, PB::Writer *a2)
{
  ...
  if ((v4 & 0x20) != 0)
  {
    this = PB::Writer::write(a2, *(this + 44), 1u);
    v4 = *(v3 + 48);
    if ((v4 & 1) == 0)
    {
LABEL_3:
...
LABEL_16:
  this = PB::Writer::write(a2, *(v3 + 12), 4u);
  v4 = *(v3 + 52);
  if ((v4 & 0x100) == 0)
  {
LABEL_6:
...
LABEL_20:
  this = PB::Writer::write(a2, *(v3 + 36), 8u);
  v4 = *(v3 + 52);
  if ((v4 & 8) == 0)
  {
LABEL_10:
...
LABEL_21:
  this = PB::Writer::write(a2, *(v3 + 20), 9u);
  v4 = *(v3 + 52);
  if ((v4 & 4) != 0)
  {
    goto LABEL_22;
...
uint64_t CMMsl::GestureLogSource::formatText(CMMsl::GestureLogSource *this, PB::TextFormatter *a2, const char *a3)
{
  ...
  if (*(this + 12))
  {
    PB::TextFormatter::format(a2, "logSource", *(this + 2));
  }
...
uint64_t CMMsl::GnssAvailabilityPredictorData::formatText(CMMsl::GnssAvailabilityPredictorData *this, PB::TextFormatter *a2, const char *a3)
{
  ...
  if ((v5 & 4) != 0)
  {
    PB::TextFormatter::format(a2, "measSource", *(this + 6));
    v5 = *(this + 32);
    if ((v5 & 8) == 0)
    {
LABEL_3:
...
uint64_t CMMsl::GnssLeechLocationData::writeTo(uint64_t this, PB::Writer *a2)
{
  ...
  if ((*(this + 152) & 4) != 0)
  {
    this = PB::Writer::write(a2, *(this + 144), 1u);
  }
...
BOOL CMMsl::GnssLeechLocationData::operator==(uint64_t a1, uint64_t a2)
{
  ...
  result = sub_1001060E4((a1 + 96), a2 + 96);
  if (result)
  {
    result = sub_1001060E4((a1 + 72), a2 + 72);
    if (result)
    {
      result = sub_1001060E4((a1 + 120), a2 + 120);
      if (result)
      {
        result = sub_1001060E4((a1 + 48), a2 + 48);
        if (result)
        {
          result = sub_1001060E4((a1 + 24), a2 + 24);
          if (result)
          {
            if ((*(a1 + 152) & 2) != 0)
            {
              if ((*(a2 + 152) & 2) == 0 || *(a1 + 16) != *(a2 + 16))
              {
                return 0;
              }
            }
...
BOOL sub_1001060E4(uint64_t *a1, uint64_t a2)
{
  v2 = *a1;
  v3 = a1[1];
  v4 = *a2;
  ...
  {
    v6 = *v4++;
    result = CMMsl::SatelliteInfo::operator==(*(v5 - 8), v6);
    v8 = !result || v5 == v3;
    v5 += 8;
  }
...
uint64_t CMMsl::GravityCorrection::formatText(CMMsl::GravityCorrection *this, PB::TextFormatter *a2, const char *a3)
{
  ...
  if (*(this + 20))
  {
    PB::TextFormatter::format(a2, "isAvgGrav", *(this + 16));
  }
...
LABEL_3:
  ...
  PB::TextFormatter::format(a2, "sampleNumMod3", *(this + 5));
  v5 = *(this + 22);
  if ((v5 & 8) == 0)
  {
LABEL_4:
...
LABEL_16:
  PB::TextFormatter::format(a2, "subType", *(this + 6));
  v5 = *(this + 22);
  if ((v5 & 1) == 0)
  {
LABEL_5:
...
LABEL_18:
  PB::TextFormatter::format(a2, "triggerEnabled", *(this + 40));
  v5 = *(this + 22);
  if ((v5 & 0x100) == 0)
  {
LABEL_7:
...
LABEL_19:
  PB::TextFormatter::format(a2, "triggerOn", *(this + 41));
  v5 = *(this + 22);
  if ((v5 & 0x10) == 0)
  {
LABEL_8:
...
LABEL_16:
  this = PB::Writer::writeVarInt(a2, *(v3 + 20), 6u);
  v4 = *(v3 + 44);
  if ((v4 & 0x80) == 0)
  {
LABEL_8:
...
LABEL_18:
    this = PB::Writer::write(a2, *(v3 + 41), 8u);
    if ((*(v3 + 44) & 2) == 0)
    {
      return this;
    }
...
LABEL_15:
  PB::TextFormatter::format(a2, "doingBiasEstimation", *(this + 5));
  v5 = *(this + 36);
  if ((v5 & 0x10) == 0)
  {
LABEL_6:
...
uint64_t CMMsl::GyroBiasConstraints::formatText(CMMsl::GyroBiasConstraints *this, PB::TextFormatter *a2, const char *a3)
{
  ...
  if ((*(this + 120) & 4) != 0)
  {
    PB::TextFormatter::format(a2, "allowRelaxedGyroMean", *(this + 116));
  }
  ...
  if ((*(this + 120) & 8) != 0)
  {
    PB::TextFormatter::format(a2, "stillOnAll", *(this + 117));
  }
