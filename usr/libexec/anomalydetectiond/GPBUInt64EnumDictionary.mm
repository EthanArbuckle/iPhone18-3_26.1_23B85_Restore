...
- (GPBUInt64EnumDictionary)initWithDictionary:(id)dictionary
{
  v4 = -[GPBUInt64EnumDictionary initWithValidationFunction:rawValues:forKeys:count:](self, "initWithValidationFunction:rawValues:forKeys:count:", [dictionary validationFunc], 0, 0, 0);
  v5 = v4;
  if (dictionary && v4)
  {
...
- (id)copyWithZone:(_NSZone *)zone
{
  v4 = [GPBUInt64EnumDictionary allocWithZone:zone];
