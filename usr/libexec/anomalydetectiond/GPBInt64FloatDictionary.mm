...
- (GPBInt64FloatDictionary)initWithDictionary:(id)dictionary;
- (GPBInt64FloatDictionary)initWithFloats:(const float *)floats forKeys:(const int64_t *)keys count:(unint64_t)count;
...
- (id)copyWithZone:(_NSZone *)zone
{
  v4 = [GPBInt64FloatDictionary allocWithZone:zone];
