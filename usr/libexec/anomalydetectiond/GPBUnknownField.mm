...
{
  v3.receiver = self;
  v3.super_class = GPBUnknownField;
...
- (unint64_t)hash
{
  v3 = [(GPBUInt64Array *)self->mutableVarintList_ hash];
  v4 = [(GPBUInt32Array *)self->mutableFixed32List_ hash]+ 32 * v3 - v3;
  v5 = [(GPBUInt64Array *)self->mutableFixed64List_ hash]- v4 + 32 * v4;
  ...
  if (v8)
  {
    ...
    do
    {
      for (i = 0; i != v8; i = i + 1)
      {
        ...
        v11 = GPBComputeBytesSize(number, *(*(&v23 + 1) + 8 * i));
        v34[3] += v11;
      }
  ...
  if (v13)
  {
    ...
    do
    {
      for (j = 0; j != v13; j = j + 1)
      {
        ...
        v16 = GPBComputeUnknownGroupSize(number, *(*(&v19 + 1) + 8 * j));
        v34[3] += v16;
      }
...
- (unint64_t)serializedSizeAsMessageSetExtension
{
  ...
  do
  {
    for (i = 0; i != v5; i = i + 1)
    {
      ...
      v6 += GPBComputeRawMessageSetExtensionSize(self->number_, *(*(&v10 + 1) + 8 * i));
    }
...
- (void)addVarint:(unint64_t)varint
{
  ...
  if (mutableVarintList)
  {
    ...
    [(GPBUInt64Array *)mutableVarintList addValue:?];
  }
...
- (void)addFixed32:(unsigned int)fixed32
{
  ...
  if (mutableFixed32List)
  {
    ...
    [(GPBUInt32Array *)mutableFixed32List addValue:?];
  }
...
- (void)addFixed64:(unint64_t)fixed64
{
  ...
  if (mutableFixed64List)
  {
    ...
    [(GPBUInt64Array *)mutableFixed64List addValue:?];
  }
