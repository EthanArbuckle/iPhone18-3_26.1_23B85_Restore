...
- (GPBStringInt64Dictionary)initWithDictionary:(id)dictionary;
- (GPBStringInt64Dictionary)initWithInt64s:(const int64_t *)int64s forKeys:(id *)keys count:(unint64_t)count;
...
{
  v14.receiver = self;
  v14.super_class = GPBStringInt64Dictionary;
...
- (void)dealloc
{
  ...
  v3.receiver = self;
  v3.super_class = GPBStringInt64Dictionary;
  [(GPBStringInt64Dictionary *)&v3 dealloc];
}

- (id)copyWithZone:(_NSZone *)zone
{
  v4 = [GPBStringInt64Dictionary allocWithZone:zone];
  ...
  if (result)
  {
    ...
    if (nextObject)
    {
      ...
      do
      {
        ...
        v15 = &v14[sub_10031F4A4([v13 longLongValue], 2, v7)];
...
- (void)writeToCodedOutputStream:(id)stream asField:(id)field
{
  ...
  if (nextObject)
  {
    ...
    do
    {
      ...
      [stream writeInt32NoTag:{sub_10031F4A4(longLongValue, 2, v7) + v16}];
