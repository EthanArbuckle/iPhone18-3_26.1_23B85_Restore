...
+ (GPBUInt64Array)arrayWithCapacity:(unint64_t)capacity;
+ (GPBUInt64Array)arrayWithValueArray:(id)array;
+ (id)array;
- (BOOL)isEqual:(id)equal;
- (GPBUInt64Array)init;
- (GPBUInt64Array)initWithCapacity:(unint64_t)capacity;
- (GPBUInt64Array)initWithValues:(const unint64_t *)values count:(unint64_t)count;
...
- (GPBUInt64Array)initWithCapacity:(unint64_t)capacity
{
  v4 = [(GPBUInt64Array *)self initWithValues:0 count:0];
  v5 = v4;
  if (capacity && v4)
  {
    [(GPBUInt64Array *)v4 internalResizeToCapacity:capacity];
  }
...
- (id)copyWithZone:(_NSZone *)zone
{
  v4 = [GPBUInt64Array allocWithZone:zone];
  values = self->_values;
  count = self->_count;
