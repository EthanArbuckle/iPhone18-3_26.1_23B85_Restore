...
- (GPBInt64UInt32Dictionary)initWithDictionary:(id)dictionary;
- (GPBInt64UInt32Dictionary)initWithUInt32s:(const unsigned int *)int32s forKeys:(const int64_t *)keys count:(unint64_t)count;
...
- (id)copyWithZone:(_NSZone *)zone
{
  v4 = [GPBInt64UInt32Dictionary allocWithZone:zone];
