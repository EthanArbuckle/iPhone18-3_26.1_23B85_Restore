...
- (void)writeDouble:(int)a3 value:(double)a4
{
  v6 = sub_100025184(a3, 1);
  sub_10001837C(&self->state_, v6);

  sub_100017BD4(&self->state_, *&a4);
}

- (void)writeFloat:(int)a3 value:(float)a4
{
  v6 = sub_100025184(a3, 5);
  sub_10001837C(&self->state_, v6);

  sub_100017DBC(&self->state_, SLODWORD(a4));
}

- (void)writeUInt64:(int)a3 value:(unint64_t)a4
{
  v6 = sub_100025184(a3, 0);
  sub_10001837C(&self->state_, v6);

  sub_100017EF4(&self->state_, a4);
}
...
- (void)writeMessageNoTag:(id)a3
{
  sub_10001837C(&self->state_, [a3 serializedSize]);
...
- (void)writeBytesNoTag:(id)a3
{
  sub_10001837C(&self->state_, [a3 length]);
...
- (void)writeSInt32:(int)a3 value:(int)a4
{
  ...
  sub_10001837C(&self->state_, (2 * a4) ^ (a4 >> 31));
}
...
- (void)writeSInt64:(int)a3 value:(int64_t)a4
{
  ...
  sub_100017EF4(&self->state_, (2 * a4) ^ (a4 >> 63));
}
...
- (void)writeMessageSetExtension:(int)a3 value:(id)a4
{
  ...
  sub_100018744(&self->state_, 2, a3);
