...
- (BOOL)skipField:(int)a3
{
  ...
  if (v5 <= 1)
  {
    ...
    sub_10003905C(&self->state_.bytes, 8);
  ...
  else
  {
    ...
    {
      case 2:
        v8 = sub_100038C98(&self->state_);
        sub_10003905C(&self->state_.bytes, v8);
      ...
      case 3:
        ...
        return 1;
      case 5:
        sub_10003905C(&self->state_.bytes, 4);
