...
- (BOOL)getUInt64:(unint64_t *)int64 forKey:(unint64_t)key;
- (BOOL)isEqual:(id)equal;
- (TransparencyGPBUInt64UInt64Dictionary)initWithDictionary:(id)dictionary;
- (TransparencyGPBUInt64UInt64Dictionary)initWithUInt64s:(const unint64_t *)int64s forKeys:(const unint64_t *)keys count:(unint64_t)count;
...
- (void)removeUInt64ForKey:(unint64_t)key;
- (void)setTransparencyGPBGenericValue:(id *)value forTransparencyGPBGenericValueKey:(id *)key;
- (void)setUInt64:(unint64_t)int64 forKey:(unint64_t)key;
...
- (id)copyWithZone:(_NSZone *)zone
{
  v4 = [TransparencyGPBUInt64UInt64Dictionary allocWithZone:zone];
...
- (void)enumerateKeysAndUInt64sUsingBlock:(id)block
{
  ...
  do
  {
    ...
    (*(block + 2))(block, [nextObject unsignedLongLongValue], objc_msgSend(-[NSMutableDictionary objectForKeyedSubscript:](dictionary, "objectForKeyedSubscript:", nextObject), "unsignedLongLongValue"), &v7);
  }
  ...
  if (result)
  {
    ...
    if (nextObject)
    {
      ...
      do
      {
        ...
        v14 = sub_10003B8D4([nextObject2 unsignedLongLongValue], 1, mapKeyDataType);
...
- (void)writeToCodedOutputStream:(id)stream asField:(id)field
{
  ...
  if (nextObject)
  {
    ...
    do
    {
      ...
      LODWORD(v14) = sub_10003B8D4(unsignedLongLongValue, 1, mapKeyDataType);
      [stream writeInt32NoTag:{sub_10003B8D4(unsignedLongLongValue2, 2, v7) + v14}];
      if (mapKeyDataType == 4)
      {
      ...
      if (v7 == 4)
      {
        [stream writeFixed64:2 value:unsignedLongLongValue2];
      }

      else if (v7 == 12)
      {
        [stream writeUInt64:2 value:unsignedLongLongValue2];
      }
...
- (void)setUInt64:(unint64_t)int64 forKey:(unint64_t)key
{
  [(NSMutableDictionary *)self->_dictionary setObject:[NSNumber forKey:"numberWithUnsignedLongLong:" numberWithUnsignedLongLong:int64], [NSNumber numberWithUnsignedLongLong:key]];
  autocreator = self->_autocreator;
  if (autocreator)
  {
