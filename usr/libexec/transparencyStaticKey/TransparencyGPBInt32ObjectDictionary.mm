...
- (void)enumerateKeysAndObjectsUsingBlock:(id)a3
{
  ...
  do
  {
    ...
    (*(a3 + 2))(a3, [v6 intValue], -[NSMutableDictionary objectForKeyedSubscript:](dictionary, "objectForKeyedSubscript:", v6), &v7);
  }
  ...
  if (result)
  {
    ...
    if (v10)
    {
      ...
      do
      {
        ...
        v14 = sub_10003AFBC([v11 intValue], 1, v8);
...
- (void)writeToCodedOutputStream:(id)a3 asField:(id)a4
{
  ...
  if (v12)
  {
    ...
    do
    {
      ...
      v15 = [v13 intValue];
      v16 = sub_10003AFBC(v15, 1, v8);
      [a3 writeInt32NoTag:{sub_100039BC8(v14, v7) + v16}];
      sub_10003B15C(a3, v15, 1, v8);
      sub_100039CFC(a3, v14, v7);
      v13 = [v11 nextObject];
    }
...
- (void)setTransparencyGPBGenericValue:(id *)a3 forTransparencyGPBGenericValueKey:(id *)a4
{
  dictionary = self->_dictionary;
  var2 = a3->var2;
  v6 = [NSNumber numberWithInt:a4->var3];
