...
- (void)enumerateKeysAndBoolsUsingBlock:(id)a3
{
  ...
  do
  {
    ...
    (*(a3 + 2))(a3, [v6 intValue], objc_msgSend(-[NSMutableDictionary objectForKeyedSubscript:](dictionary, "objectForKeyedSubscript:", v6), "BOOLValue"), &v7);
  }
  ...
  if (result)
  {
    ...
    if (v9)
    {
      ...
      do
      {
        ...
        v13 = sub_10003AFBC([v10 intValue], 1, v7);
        [v12 BOOLValue];
...
- (void)writeToCodedOutputStream:(id)a3 asField:(id)a4
{
  ...
  if (v11)
  {
    ...
    do
    {
      ...
      v14 = [v12 intValue];
      v15 = [v13 BOOLValue];
      v16 = sub_10003AFBC(v14, 1, v7);
      [a3 writeInt32NoTag:sub_10001B224(2) + v16];
      sub_10003B15C(a3, v14, 1, v7);
