...
- (TransparencyGPBInt32Array)initWithCapacity:(unint64_t)capacity;
- (TransparencyGPBInt32Array)initWithValues:(const int *)values count:(unint64_t)count;
...
- (TransparencyGPBInt32Array)initWithCapacity:(unint64_t)capacity
{
  ...
  if (capacity && v4)
  {
    [(TransparencyGPBInt32Array *)v4 internalResizeToCapacity:capacity];
  }
...
- (id)copyWithZone:(_NSZone *)zone
{
  v4 = [TransparencyGPBInt32Array allocWithZone:zone];
  values = self->_values;
  count = self->_count;
