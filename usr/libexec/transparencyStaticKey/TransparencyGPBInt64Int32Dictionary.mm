  ...
  if (result)
  {
    ...
    if (nextObject)
    {
      ...
      do
      {
        ...
        v14 = sub_10003C1C4([nextObject2 longLongValue], 1, mapKeyDataType);
...
- (void)writeToCodedOutputStream:(id)stream asField:(id)field
{
  ...
  if (nextObject)
  {
    ...
    do
    {
      ...
      v17 = sub_10003C1C4(longLongValue, 1, mapKeyDataType);
      [stream writeInt32NoTag:{sub_10003AFBC(intValue, 2, v7) + v17}];
