...
- (TransparencyGPBInt64UInt64Dictionary)initWithDictionary:(id)dictionary;
- (TransparencyGPBInt64UInt64Dictionary)initWithUInt64s:(const unint64_t *)int64s forKeys:(const int64_t *)keys count:(unint64_t)count;
...
- (id)copyWithZone:(_NSZone *)zone
{
  v4 = [TransparencyGPBInt64UInt64Dictionary allocWithZone:zone];
...
- (void)writeToCodedOutputStream:(id)stream asField:(id)field
{
  ...
  if (nextObject)
  {
    ...
    do
    {
      ...
      LODWORD(v14) = sub_10003C1C4(longLongValue, 1, mapKeyDataType);
