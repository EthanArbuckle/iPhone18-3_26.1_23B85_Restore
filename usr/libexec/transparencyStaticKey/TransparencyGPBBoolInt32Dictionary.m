...
{
  v13.receiver = self;
  v13.super_class = TransparencyGPBBoolInt32Dictionary;
...
- (unint64_t)computeSerializedSizeAsField:(id)a3
{
  ...
  do
  {
    ...
    if (valueSet[v3])
    {
      ++v4;
      v12 = sub_10001B224(1);
      v13 = sub_10003AFBC(values[v3], 2, v7) + v12;
...
- (void)writeToCodedOutputStream:(id)a3 asField:(id)a4
{
  ...
  do
  {
    ...
    if (valueSet[v10])
    {
      ...
      v15 = sub_10001B224(1);
      [a3 writeInt32NoTag:{sub_10003AFBC(values[v10], 2, v7) + v15}];
      [a3 writeBool:1 value:v9 & 1];
      sub_10003B15C(a3, values[v10], 2, v7);
    }
