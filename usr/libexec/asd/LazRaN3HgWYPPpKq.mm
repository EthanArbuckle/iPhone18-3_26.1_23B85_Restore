...
- (void)compute:(_KUwyEjpVZR65eUyl *)compute UtPlzRffoEpw7Ue1:(_eipjLVDiD7LNwlPc *)ue1 SFkZRA5Ek9YzhDRs:(unsigned int)rs jAVr67FQ6j4EzsgV:(id)v i4KDOQicW9Xd5WBz:(id)bz TWWnmIjkBlMfHmma:(id)hmma withCompletion:(id)completion
{
  ...
  if (var1 == 5)
  {
    if (compute->var4.var1.var0.var1 - 4097 >= 0xFFFFF000 && compute->var4.var5.var2 < 6)
    {
      goto LABEL_13;
    }
  ...
  if (compute->var4.var1.var0.var1 - 4097 < 0xFFFFF000 || compute->var4.var5.var2 > 5 || compute->var4.var5.var3 >= 300001)
  {
LABEL_9:
    v18 = [kjAS9HuCdR1m5txL alloc];
    v19 = 155;
...
LABEL_13:
  ...
  v22 = [v21 ciiN3o1L7RiefeS5:compute];
  ...
  if (v22)
  {
    ...
    v28 = completionCopy;
    [v22 UupMWO2j2nYek7xf:compute TYPlhTGwKuAdWgfx:vCopy TWWnmIjkBlMfHmma:hmmaCopy withCompletion:v27];
  }
...
- (void)computeHash:(_KUwyEjpVZR65eUyl *)hash jAVr67FQ6j4EzsgV:(id)v i4KDOQicW9Xd5WBz:(id)bz TWWnmIjkBlMfHmma:(id)hmma withCompletion:(id)completion
{
  ...
  if (var1 == 5)
  {
    v10 = [eTBtehykeBvfpeTP rsNB9HkZVEH0l6fT:hash->var4.var0.var0 gsx0MJUoOpcxcozG:hash->var4.var1.var0.var1];
    [v11 encodeObject:v10];
    [v11 encodeInt32:hash->var4.var5.var2 forKey:@"0xb18e"];
  }
  ...
  else
  {
    ...
    v10 = [eTBtehykeBvfpeTP rsNB9HkZVEH0l6fT:hash->var4.var0.var0 gsx0MJUoOpcxcozG:hash->var4.var1.var0.var1];
    [v11 encodeObject:v10];
    [v11 encodeInt64:hash->var4.var5.var3 forKey:@"0x9efa"];
    [v11 encodeInt32:hash->var4.var5.var2 forKey:@"0xb18e"];
    [v11 encodeInt64:hash->var4.var5.var4 forKey:@"0xf16f"];
  }

LABEL_6:
  completionCopy[2](completionCopy, [Yp00msaYdVlZesvU cv2QAcQ2CDdiHuN6:v11]);
}
...
- (void)endSignpost:(_eipjLVDiD7LNwlPc *)signpost signpostId:(unint64_t)id
{
  ...
  if (id - 1 <= 0xFFFFFFFFFFFFFFFDLL && os_signpost_enabled(v6))
  {
    ...
    v11 = 1026;
    v12 = dataframeIndex;
    _os_signpost_emit_with_name_impl(&_mh_execute_header, v7, OS_SIGNPOST_INTERVAL_END, id, "lo", "p=%{public,signpost.telemetry:number1}d,i=%{public,signpost.telemetry:number2}d", v10, 0xEu);
  }
}
