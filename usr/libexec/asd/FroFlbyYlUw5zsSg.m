...
- (FroFlbyYlUw5zsSg)initWithQueue:(id)a3;
...
- (void)compute:(_KUwyEjpVZR65eUyl *)a3 UtPlzRffoEpw7Ue1:(_eipjLVDiD7LNwlPc *)a4 SFkZRA5Ek9YzhDRs:(unsigned int)a5 jAVr67FQ6j4EzsgV:(id)a6 i4KDOQicW9Xd5WBz:(id)a7 TWWnmIjkBlMfHmma:(id)a8 withCompletion:(id)a9
{
  ...
  v15 = a8;
  v16 = a7;
  v17 = [(FroFlbyYlUw5zsSg *)self queue];
  ...
  v20 = v14;
  v18 = v14;
  [Yp00msaYdVlZesvU evaluateStringTypes3:&a3->var4 string2:&a3->var4.var28 + 17 string3:&a3->var4.var28 + 34 i4KDOQicW9Xd5WBz:v16 TWWnmIjkBlMfHmma:v15 completionQueue:v17 withCompletion:v19];
}
...
- (void)computeHash:(_KUwyEjpVZR65eUyl *)a3 jAVr67FQ6j4EzsgV:(id)a4 i4KDOQicW9Xd5WBz:(id)a5 TWWnmIjkBlMfHmma:(id)a6 withCompletion:(id)a7
{
  ...
  v15 = [(FroFlbyYlUw5zsSg *)self queue];
  ...
  v16 = v11;
  v17 = v14;
  [Yp00msaYdVlZesvU evaluateStringTypes3:&a3->var4 string2:&a3->var4.var28 + 17 string3:&a3->var4.var28 + 34 i4KDOQicW9Xd5WBz:v13 TWWnmIjkBlMfHmma:v12 completionQueue:v15 withCompletion:v18];
}
...
- (void)endSignpost:(_eipjLVDiD7LNwlPc *)a3 signpostId:(unint64_t)a4
{
  ...
  if (a4 - 1 <= 0xFFFFFFFFFFFFFFFDLL && os_signpost_enabled(v6))
  {
    ...
    v11 = 1026;
    v12 = dataframeIndex;
    _os_signpost_emit_with_name_impl(&_mh_execute_header, v7, OS_SIGNPOST_INTERVAL_END, a4, "sud", "p=%{public,signpost.telemetry:number1}d,i=%{public,signpost.telemetry:number2}d", v10, 0xEu);
  }
}
