...
- (AHhsu4ZRdIKDtY02)initWithQueue:(id)a3;
...
- (void)compute:(_KUwyEjpVZR65eUyl *)a3 UtPlzRffoEpw7Ue1:(_eipjLVDiD7LNwlPc *)a4 SFkZRA5Ek9YzhDRs:(unsigned int)a5 jAVr67FQ6j4EzsgV:(id)a6 i4KDOQicW9Xd5WBz:(id)a7 TWWnmIjkBlMfHmma:(id)a8 withCompletion:(id)a9
{
  ...
  v15 = a8;
  v16 = a7;
  v17 = [(AHhsu4ZRdIKDtY02 *)self queue];
  ...
  v22 = *a4;
  v18 = v14;
  [Yp00msaYdVlZesvU evaluateStringTypes2:&a3->var4 string2:&a3->var4.var28 + 17 i4KDOQicW9Xd5WBz:v16 TWWnmIjkBlMfHmma:v15 completionQueue:v17 withCompletion:v19];
}
...
- (void)computeHash:(_KUwyEjpVZR65eUyl *)a3 jAVr67FQ6j4EzsgV:(id)a4 i4KDOQicW9Xd5WBz:(id)a5 TWWnmIjkBlMfHmma:(id)a6 withCompletion:(id)a7
{
  ...
  v15 = [(AHhsu4ZRdIKDtY02 *)self queue];
  ...
  v16 = v11;
  v17 = v14;
  [Yp00msaYdVlZesvU evaluateStringTypes2:&a3->var4 string2:&a3->var4.var28 + 17 i4KDOQicW9Xd5WBz:v13 TWWnmIjkBlMfHmma:v12 completionQueue:v15 withCompletion:v18];
}
...
- (void)endSignpost:(_eipjLVDiD7LNwlPc *)a3 signpostId:(unint64_t)a4
{
  ...
  if (a4 - 1 <= 0xFFFFFFFFFFFFFFFDLL && os_signpost_enabled(v7))
  {
    ...
    v15 = 1026;
    v16 = computeError;
    _os_signpost_emit_with_name_impl(&_mh_execute_header, v8, OS_SIGNPOST_INTERVAL_END, a4, "sl", "p=%{public,signpost.telemetry:number1}d,i=%{public,signpost.telemetry:number2}d,e=%{public,signpost.telemetry:number2}d", v12, 0x14u);
  }
}
