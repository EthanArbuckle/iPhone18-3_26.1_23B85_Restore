...
+ (void)initializeNFHardwareManagerStateWithCompletion:(id)completion;
- (id)createSeidFuture;
- (void)ILEFYKTi2wz6Hf5l:(id)hf5l;
- (void)traHoYtdjqKLUZYc:(id)yc;
@end
