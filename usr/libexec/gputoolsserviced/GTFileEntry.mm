...
- (id)description
{
  ...
  v5 = [(GTFileEntry *)self path];
  v6 = [(GTFileEntry *)self destination];
  v7 = [NSString stringWithFormat:@"<%@: %p, Path: %@, Destination: %@, Size: %lu>", v4, self, v5, v6, [(GTFileEntry *)self fileSize]];
