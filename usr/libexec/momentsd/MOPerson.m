...
- (MOPerson)initWithPersonMO:(id)a3
{
  ...
  if (v4)
  {
    ...
    v15 = [v4 isPHPersonTypeImportant];
    v16 = [v4 isMePerson];
    v17 = [v4 mePersonIdentified];
    v18 = [v5 copy];
    [v4 priorityScore];
    v20 = v19;
    [v4 significanceScore];
    LOBYTE(v28) = v17;
    self = [(MOPerson *)self initWithLocalIdentifier:v12 name:v13 contactIdentifier:v14 family:&stru_1003416B0 isPHPersonTypeImportant:v15 isMePerson:v16 mePersonIdentified:v20 personRelationships:v21 priorityScore:v28 significanceScore:v18];
    ...
    {
      v25 = [v4 givenName];
      [(MOPerson *)self setGivenName:v25];
    }
