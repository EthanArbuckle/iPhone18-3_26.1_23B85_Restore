...
- (MOFSMStore)initWithPersistenceManager:(id)manager andConfigurationManager:(id)configurationManager;
- (MOFSMStore)initWithUniverse:(id)universe;
- (void)fetchFSMWithName:(id)name CompletionHandler:(id)handler;
- (void)removeAllFSMsWithCompletionHandler:(id)handler;
- (void)updateFSM:(id)m completionHandler:(id)handler;
@end
...
- (void)fetchFSMWithName:(id)name CompletionHandler:(id)handler
{
  ...
  v21 = 0;
  persistenceManager = [(MOFSMStore *)self persistenceManager];
