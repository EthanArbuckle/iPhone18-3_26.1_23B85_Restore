...
{
  v6.receiver = self;
  v6.super_class = MOEventPatternDetectorPredicateFilterByPhoneActivityType;
...
- (id)filterEvents:(id)events
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    *buf = 134217984;
    v30 = [v6 count];
    _os_log_impl(&_mh_execute_header, v7, OS_LOG_TYPE_INFO, "Found %lu phone activity events", buf, 0xCu);
  }
