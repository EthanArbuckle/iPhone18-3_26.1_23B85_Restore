...
- (MOPlace)initWithPlaceMO:(id)a3
{
  ...
  if (v4)
  {
    ...
    v28 = [v5 startDate];
    v29 = [v5 endDate];
    self = [(MOPlace *)self initWithIdentifier:v34 placeName:v14 enclosingArea:v15 placeType:v33 placeUserType:v16 location:v35 locationMode:v21 poiCategory:v23 categoryMuid:v25 distanceToHomeInMiles:v27 placeNameConfidence:v17 familiarityIndexLOI:v18 priorityScore:v19 startDate:v28 endDate:v29];
...
- (MOPlace)initWithIdentifier:(id)a3
{
  ...
  v8 = [(MOPlace *)self initWithIdentifier:v5 placeName:&stru_1003416B0 enclosingArea:&stru_1003416B0 placeType:0 placeUserType:0 location:0 locationMode:-1.0 poiCategory:-1.0 categoryMuid:0.0 distanceToHomeInMiles:-1.0 placeNameConfidence:0 familiarityIndexLOI:&stru_1003416B0 priorityScore:0 startDate:0 endDate:0];
...
- (MOPlace)initWithPlaceName:(id)a3 placeType:(unint64_t)a4 placeUserType:(unint64_t)a5 location:(id)a6 locationMode:(unint64_t)a7 poiCategory:(id)a8 categoryMuid:(id)a9 distanceToHomeInMiles:(double)a10 placeNameConfidence:(double)a11 familiarityIndexLOI:(double)a12
{
  ...
  v25 = a3;
  v26 = +[NSUUID UUID];
  v27 = [(MOPlace *)self initWithIdentifier:v26 placeName:v25 enclosingArea:&stru_1003416B0 placeType:a4 placeUserType:a5 location:v24 locationMode:a10 poiCategory:a11 categoryMuid:a12 distanceToHomeInMiles:-1.0 placeNameConfidence:a7 familiarityIndexLOI:v23 priorityScore:v22 startDate:0 endDate:0];
