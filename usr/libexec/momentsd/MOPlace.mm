...
- (MOPlace)initWithPlaceMO:(id)o
{
  ...
  if (oCopy)
  {
    ...
    if (v6 >= 0.0)
    {
      ...
      v12 = v11;
      [v5 range];
      v35 = [v8 initWithLatitude:0 longitude:v10 horizontalUncertainty:v12 date:v13];
    }
    ...
    name = [v5 name];
    cityName = [v5 cityName];
    placeType = [v5 placeType];
    userSpecificPlaceType = [v5 userSpecificPlaceType];
    locationMode = [v5 locationMode];
    poiCategory = [v5 poiCategory];
    categoryMuid = [v5 categoryMuid];
    ...
    endDate = [v5 endDate];
    self = [(MOPlace *)self initWithIdentifier:identifier placeName:name enclosingArea:cityName placeType:placeType placeUserType:userSpecificPlaceType location:v35 locationMode:v21 poiCategory:v23 categoryMuid:v25 distanceToHomeInMiles:v27 placeNameConfidence:locationMode familiarityIndexLOI:poiCategory priorityScore:categoryMuid startDate:startDate endDate:endDate];
    ...
    if (sourceEventIdentifier)
    {
      ...
      [(MOPlace *)self setSourceEventIdentifier:sourceEventIdentifier2];
    }
...
- (MOPlace)initWithIdentifier:(id)identifier
{
  ...
  v8 = [(MOPlace *)self initWithIdentifier:identifierCopy placeName:&stru_1003416B0 enclosingArea:&stru_1003416B0 placeType:0 placeUserType:0 location:0 locationMode:-1.0 poiCategory:-1.0 categoryMuid:0.0 distanceToHomeInMiles:-1.0 placeNameConfidence:0 familiarityIndexLOI:&stru_1003416B0 priorityScore:0 startDate:0 endDate:0];
...
- (MOPlace)initWithPlaceName:(id)name placeType:(unint64_t)type placeUserType:(unint64_t)userType location:(id)location locationMode:(unint64_t)mode poiCategory:(id)category categoryMuid:(id)muid distanceToHomeInMiles:(double)self0 placeNameConfidence:(double)self1 familiarityIndexLOI:(double)self2
{
  ...
  nameCopy = name;
  v26 = +[NSUUID UUID];
  v27 = [(MOPlace *)self initWithIdentifier:v26 placeName:nameCopy enclosingArea:&stru_1003416B0 placeType:type placeUserType:userType location:locationCopy locationMode:miles poiCategory:confidence categoryMuid:i distanceToHomeInMiles:-1.0 placeNameConfidence:mode familiarityIndexLOI:categoryCopy priorityScore:muidCopy startDate:0 endDate:0];
