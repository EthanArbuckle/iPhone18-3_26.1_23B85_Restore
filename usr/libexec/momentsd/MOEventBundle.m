...
- (MOEventBundle)initWithEventBundleMO:(id)a3
{
  ...
  if (v4)
  {
    ...
    {
      v13 = [v5 endDate];
      v15 = [v13 dateByAddingTimeInterval:2419200.0];
    ...
    v18 = [v5 promptLanguage];
    [(MOEventBundle *)self setPromptLanguage:v18];

    v19 = [v5 metaDataForRank];
    ...
    v21 = [v5 summarizationGranularity];
    ...
    v23 = [v5 subSuggestionIDs];
    [(MOEventBundle *)self setSubSuggestionIDs:v23];

    v24 = [v5 timeAtHomeSubType];
    ...
    v128 = 0u;
    v29 = [v5 events];
    v30 = [v29 countByEnumeratingWithState:&v125 objects:v134 count:16];
    if (v30)
    {
      v31 = v30;
      v32 = *v126;
      do
      {
        ...
        v31 = [v29 countByEnumeratingWithState:&v125 objects:v134 count:16];
      }
    ...
    if (objc_opt_respondsToSelector())
    {
      ...
      if (v36)
      {
        v37 = [MOAction alloc];
        v38 = [v5 action];
        v39 = [(MOAction *)v37 initWithActionMO:v38];
    ...
    if (objc_opt_respondsToSelector())
    {
      v40 = [v5 concurrentMediaAction];

      if (v40)
      {
        v41 = [MOAction alloc];
        v42 = [v5 concurrentMediaAction];
        v43 = [(MOAction *)v41 initWithActionMO:v42];
    ...
    if (objc_opt_respondsToSelector())
    {
      ...
      v124 = 0u;
      v45 = [v5 actions];
      v46 = [v45 countByEnumeratingWithState:&v121 objects:v133 count:16];
      if (v46)
      {
        v47 = v46;
        v48 = *v122;
        do
        {
          ...
          v47 = [v45 countByEnumeratingWithState:&v121 objects:v133 count:16];
        }
    ...
    if (objc_opt_respondsToSelector())
    {
      ...
      v120 = 0u;
      v53 = [v5 persons];
      v54 = [v53 countByEnumeratingWithState:&v117 objects:v132 count:16];
      if (v54)
      {
        v55 = v54;
        v56 = *v118;
        do
        {
          ...
          v55 = [v53 countByEnumeratingWithState:&v117 objects:v132 count:16];
        }
    ...
    if (objc_opt_respondsToSelector())
    {
      ...
      if (v60)
      {
        v61 = [MOPlace alloc];
        v62 = [v5 place];
        v63 = [(MOPlace *)v61 initWithPlaceMO:v62];
    ...
    if (objc_opt_respondsToSelector())
    {
      ...
      v116 = 0u;
      v65 = [v5 places];
      v66 = [v65 countByEnumeratingWithState:&v113 objects:v131 count:16];
      if (v66)
      {
        v67 = v66;
        v68 = *v114;
        do
        {
          ...
          v67 = [v65 countByEnumeratingWithState:&v113 objects:v131 count:16];
        }
    ...
    if (objc_opt_respondsToSelector())
    {
      ...
      if (v72)
      {
        v73 = [MOTime alloc];
        v74 = [v5 time];
        v75 = [(MOTime *)v73 initWithTimeMO:v74];
    ...
    if (objc_opt_respondsToSelector())
    {
      v76 = [v5 predominantWeather];

      if (v76)
      {
        v77 = [MOWeather alloc];
        v78 = [v5 predominantWeather];
        v79 = [(MOWeather *)v77 initWithWeatherMO:v78];
    ...
    if (objc_opt_respondsToSelector())
    {
      ...
      v112 = 0u;
      v81 = [v5 resources];
      v82 = [v81 countByEnumeratingWithState:&v109 objects:v130 count:16];
      if (v82)
      {
        v83 = v82;
        v84 = *v110;
        do
        {
          ...
          v83 = [v81 countByEnumeratingWithState:&v109 objects:v130 count:16];
        }
    ...
    if (objc_opt_respondsToSelector())
    {
      v88 = [v5 clusterMetadata];

      if (v88)
      {
        v89 = [MOClusterMetadata alloc];
        v90 = [v5 clusterMetadata];
        v91 = [(MOClusterMetadata *)v89 initWithClusterMetadataMO:v90];
    ...
    if (objc_opt_respondsToSelector())
    {
      ...
      v108 = 0u;
      v93 = [v5 photoTraits];
      v94 = [v93 countByEnumeratingWithState:&v105 objects:v129 count:16];
      if (v94)
      {
        v95 = v94;
        v96 = *v106;
        do
        {
          ...
          v95 = [v93 countByEnumeratingWithState:&v105 objects:v129 count:16];
        }
    ...
    if (objc_opt_respondsToSelector())
    {
      v100 = [v5 outlierMetadata];

      if (v100)
      {
        v101 = [MOOutlierMetadata alloc];
        v102 = [v5 outlierMetadata];
        v103 = [(MOOutlierMetadata *)v101 initWithOutlierMetadataMO:v102];
...
- (id)primarySourceTypes
{
  ...
  switch([(MOEventBundle *)self interfaceType])
  {
    ...
    case 7uLL:
      ...
      goto LABEL_13;
    case 9uLL:
      v8 = [(MOEventBundle *)self bundleSubType];
      switch(v8)
      {
        case 0x268uLL:
    ...
    case 0xBuLL:
      ...
      goto LABEL_30;
    case 0xCuLL:
      v5 = [(MOEventBundle *)self bundleSubType];
      if (v5 <= 204)
      {
        if ((v5 - 101) >= 5)
        {
...
LABEL_13:
      v7 = 2;
LABEL_31:
      v3 = [NSArray arrayWithObjects:v4 count:v7];
LABEL_32:
