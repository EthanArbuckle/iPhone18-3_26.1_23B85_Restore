...
+ (BOOL)_containsCompleteEmbeddingDistanceWeightKeys:(id)a3;
+ (id)setEmbeddingWeightsWithConfigurationManager:(id)a3 configurationManager:(id)a4;
...
- (id)_phenotypeDimensionFor:(id)a3 withphenotypeDimensionDict:(id)a4;
- (id)generateClusterBundleFrom:(id)a3 withEmbeddings:(id)a4 andCreationDate:(id)a5 excludeResourceTypes:(id)a6;
...
- (void)initializeHDBSCANWithParams:(id)a3;
...
- (MOBundleClusteringManager)initWithUniverse:(id)a3
{
  ...
  if (v9)
  {
    ...
    *(v9 + 3) = v11;
    ...
    v13 = [v9 getDefaultClusteringParams];
    v14 = *(v9 + 7);
    *(v9 + 7) = v13;
...
- (void)runHDBSCANClusteringOn:(id)a3
{
  ...
  if (v5 <= [(MOClusteringParams *)self->_clusteringParams minClusterSize])
  {
    ...
    {
      [(MOBundleClusteringManager *)v4 runHDBSCANClusteringOn:?];
    }
  }
...
- (BOOL)isClusteringResultValid
{
  ...
  v3 = [NSCountedSet setWithArray:v2];
  v4 = [v3 count] > 1;
    ...
    do
    {
      ...
      do
      {
        ...
        if (([v19 isEqualToNumber:&off_100369FB8] & 1) == 0)
        {
          ...
          v60[3] = &unk_100337600;
          v60[4] = v19;
          v57 = [v11 indexesOfObjectsPassingTest:v60];
          ...
          v25 = [v8 filteredArrayUsingPredicate:v24];
          v26 = [(MOBundleClusteringManager *)v55 generateClusterBundleFrom:v25 withEmbeddings:v20 andCreationDate:v54 excludeResourceTypes:0];
          ...
          if (v26)
          {
            if (v28)
            {
              v49 = [v26 subBundleIDs];
              v46 = [v49 count];
              v48 = [v26 clusterMetadata];
              v45 = [v48 isFiltered];
              v47 = [v26 clusterMetadata];
              v44 = [v47 phenotype];
              v29 = [v26 startDate];
              v30 = [v26 endDate];
              *buf = 138413571;
...
- (void)annotateAnomalyBundles:(id)a3 withEmbeddings:(id)a4 handler:(id)a5
{
  ...
  v10 = a4;
  v11 = a3;
  v12 = [(MOHDBSCANClustering *)hdbscanClustering getClusterLabels];
  v13 = [(MOHDBSCANClustering *)self->_hdbscanClustering getOutlierScoreDict];
  v14 = objc_opt_new();
  v30 = v12;
  v15 = [v12 indexesOfObjectsPassingTest:&__block_literal_global_24];
  v16 = [v10 objectsAtIndexes:v15];
  ...
  v18 = [v17 allObjects];
  v19 = [NSPredicate predicateWithFormat:@"bundleIdentifier in %@", v18];
...
- (id)generateClusterBundleFrom:(id)a3 withEmbeddings:(id)a4 andCreationDate:(id)a5 excludeResourceTypes:(id)a6
{
  ...
  v10 = +[NSUUID UUID];
  v11 = [(MOEventBundle *)v9 initWithBundleIdentifier:v10 creationDate:v510];

  v518 = v11;
  v12 = [(MOEventBundle *)v11 bundleIdentifier];
  [(MOEventBundle *)v518 setSuggestionID:v12];

  v13 = [(MOEventBundle *)v518 creationDate];
  v14 = [v13 dateByAddingTimeInterval:2419200.0];
  ...
  v520 = objc_opt_new();
  v704 = v520;
  [v509 enumerateObjectsUsingBlock:v703];
          ...
          if (v33)
          {
            ...
            do
            {
              for (k = 0; k != v33; k = k + 1)
              {
                ...
                {
                  v39 = [v36 name];
                  v40 = [v585 objectForKeyedSubscript:v39];
                  v41 = [v40 count] == 0;
                  ...
                  {
                    v42 = [v36 name];
                    v43 = [v585 objectForKeyedSubscript:v42];
                    v44 = [v43 mutableCopy];
                  ...
                  v45 = [v36 name];
                  [v585 setObject:v44 forKeyedSubscript:v45];
        ...
        if (v124)
        {
          ...
          do
          {
            for (n = 0; n != v124; n = n + 1)
            {
              ...
              v127 = *(*(&v673 + 1) + 8 * n);
              v128 = [&off_100369FD0 stringValue];
...
LABEL_164:
  ...
  v542 = v553;
  v672 = v542;
  v162 = [v506 sortedArrayUsingComparator:v671];
  ...
  v505 = [NSPredicate predicateWithFormat:@"SELF IN %@", v519];
  v504 = [NSPredicate predicateWithFormat:@"NOT(SELF IN %@)", v519];
  v503 = [v162 filteredArrayUsingPredicate:v505];
  v502 = [v162 filteredArrayUsingPredicate:v504];
...
LABEL_211:
                ...
                *&v732[12] = 2113;
                *&v732[14] = v191;
                _os_log_debug_impl(&_mh_execute_header, v182, OS_LOG_TYPE_DEBUG, "Phenotype selected. count=%lu phenotypeSubBundleIDs= %{private}@", v732, 0x16u);
              }
...
LABEL_186:
              ...
              v185 = [v184 stringByReplacingOccurrencesOfString:v182 withString:&stru_1003416B0];
              [v562 setObject:v185 forKeyedSubscript:@"persons"];

              v186 = [NSPredicate predicateWithFormat:@"name != %@", v182];
              [v548 filterUsingPredicate:v186];
...
LABEL_208:
  ...
  v205 = [v576 allObjects];
  v501 = [NSPredicate predicateWithFormat:@"bundleIdentifier in %@", v205];

  v507 = [v512 filteredArrayUsingPredicate:v501];
  v206 = _mo_log_facility_get_os_log(&MOLogFacilityBundleClusteringManager);
  if (os_log_type_enabled(v206, OS_LOG_TYPE_DEBUG))
  {
    [MOBundleClusteringManager generateClusterBundleFrom:v512 withEmbeddings:v507 andCreationDate:? excludeResourceTypes:?];
  }
  ...
  if (v222)
  {
    ...
    do
    {
      for (ii = 0; ii != v222; ii = ii + 1)
      {
        ...
        v225 = [*(*(&v663 + 1) + 8 * ii) resources];
        v226 = +[NSNumber numberWithUnsignedInteger:](NSNumber, "numberWithUnsignedInteger:", [v225 count]);
        [v544 addObject:v226];
      }
  ...
  if (v526)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        v527 = v230;
        v564 = *(*(&v659 + 1) + 8 * v230);
        v232 = [v564 bundleIdentifier];

        if (v232)
        {
          v233 = [v564 bundleIdentifier];
          v234 = [v233 UUIDString];
          [v524 addObject:v234];
        }

        v235 = [v564 suggestionID];

        if (v235)
        {
          v236 = [v564 suggestionID];
          v237 = [v236 UUIDString];
          [v523 addObject:v237];
        }
        ...
        if ([v584 count])
        {
          ...
          if (!v239)
          {
            ...
            v656 = 0u;
            v655 = 0u;
            v241 = [v564 photoTraits];
            v242 = [v241 countByEnumeratingWithState:&v655 objects:v725 count:16];
            if (v242)
            {
              v243 = *v656;
              do
              {
                for (jj = 0; jj != v242; jj = jj + 1)
                {
                  ...
                  v245 = *(*(&v655 + 1) + 8 * jj);
                  v246 = [v245 name];
                  v247 = [v246 lowercaseString];
                  v248 = [v584 containsObject:v247];
              ...
              if (v251)
              {
                ...
                do
                {
                  for (kk = 0; kk != v251; kk = kk + 1)
                  {
                    ...
                    v254 = [*(*(&v651 + 1) + 8 * kk) relevantAssetUUIDs];
                    [v572 addObjectsFromArray:v254];
                  }
        ...
        if (!v257)
        {
          ...
          v647 = 0u;
          v538 = [v564 resources];
          v554 = [v538 countByEnumeratingWithState:&v647 objects:v723 count:16];
          if (!v554)
          {
            goto LABEL_355;
          }
...
LABEL_333:
                if ([v536 count])
                {
                  ...
                  if (!v282)
                  {
                    ...
                    v284 = [(MOBundleClusteringManager *)self photoManager];
                    v285 = [v258 assets];
                    ...
                    v287 = v283;
                    v640 = v287;
                    [v284 fetchAssetUsingID:v285 handler:v634];
...
LABEL_355:
  ...
  v307 = [v558 allObjects];
  [(MOEventBundle *)v518 setEvents:v307];

  v308 = [v555 allObjects];
  [(MOEventBundle *)v518 setPersons:v308];
    ...
    do
    {
      for (i3 = 0; i3 != v354; i3 = i3 + 1)
      {
        ...
        if (!v358)
        {
          ...
          v606 = 0u;
          v359 = [v356 actions];
          v360 = [v359 countByEnumeratingWithState:&v606 objects:v709 count:16];
          if (v360)
          {
            v361 = *v607;
            do
            {
              for (i4 = 0; i4 != v360; i4 = i4 + 1)
              {
                ...
                v363 = *(*(&v606 + 1) + 8 * i4);
                v364 = [v363 actionName];
                v365 = [v353 containsObject:v364];

                if ((v365 & 1) == 0)
                {
                  [v581 addObject:v363];
                  v366 = [v363 actionName];
                  [v353 addObject:v366];
                }
              }
...
LABEL_475:
    ...
    if (v373)
    {
      ...
      v379 = [v374 timeZone];
      v380 = [v379 name];
      v381 = [(MOTime *)v375 initWithTimestamp:v373 timeString:v380 timeZone:v372 timeTag:v378];
...
LABEL_483:
  ...
  if (v412)
  {
    v413 = [v562 objectForKeyedSubscript:@"combinedPlaceType"];
    if ([v413 isEqualToString:@"Home"])
    {
      goto LABEL_555;
    }
  ...
  while (2)
  {
    ...
    while (2)
    {
      ...
      if (v421)
      {
        ...
        {
          v422 = [v420 place];
          v423 = [v422 placeUserType] == 1;

          if (v423)
          {
            v424 = _mo_log_facility_get_os_log(&MOLogFacilityBundleClusteringManager);
        ...
        v428 = [v420 place];
        v429 = [v428 placeUserType] == 1;

        v430 = [v420 place];
        v431 = [v430 placeUserType] == 2;
      ...
      if (!v433)
      {
        ...
        v599 = 0u;
        v424 = [v420 places];
        v434 = [v424 countByEnumeratingWithState:&v598 objects:v707 count:16];
        if (v434)
        {
          v435 = *v599;
          do
...
LABEL_553:
  ...
  if ([v412 count])
  {
    v413 = [v412 allObjects];
    [(MOEventBundle *)v518 setPlaces:v413];
LABEL_555:
  }
...
LABEL_557:
  ...
  v459 = objc_opt_new();
  v588 = v459;
  [v512 enumerateObjectsUsingBlock:v587];
  ...
  if ([v440 count])
  {
    v461 = [v440 allObjects];
    [(MOClusterMetadata *)v458 setPhenotypePersonUUIDs:v461];
  }
...
{
  v4 = a3;
  [(MOBundleClusteringManager *)self _setClusteringParams:v4];
  v5 = [[MOHDBSCANClustering alloc] initWithParameters:v4];
  hdbscanClustering = self->_hdbscanClustering;
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_DEBUG))
  {
    [MOBundleClusteringManager initializeHDBSCANWithParams:v4];
  }
}
...
- (id)_convertContextvalueToString:(id)a3 forKey:(id)a4
{
  ...
  v10 = +[MOTime timeStringFromTimeTag:](MOTime, "timeStringFromTimeTag:", [v5 intValue]);
  if (!v10)
  {
LABEL_3:
    v9 = @"unavailable";
...
- (void)submitClusterBundleInternalAnalytics:(id)a3 withOnboardingStatus:(id)a4 andSubmissionDate:(id)a5
{
  ...
  v9 = [v159 components:764 fromDate:v170];
  v167 = [v9 year];
  v166 = [v9 month];
  v165 = [v9 day];
  v164 = [v9 hour];
  ...
  if (v171)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        v12 = [MOEngagementAndSuggestionAnalyticsManager generateDefaultAnalyticsPayloadWithOnboardingStatus:v169];
        v13 = [NSNumber numberWithInteger:v167];
        [v12 setObject:v13 forKeyedSubscript:@"submissionTimeYear"];

        v14 = [NSNumber numberWithInteger:v166];
        ...
        v16 = [NSNumber numberWithInteger:v164];
        [v12 setObject:v16 forKeyedSubscript:@"submissionTimeHour"];

        v17 = [NSNumber numberWithInteger:v163];
        [v12 setObject:v17 forKeyedSubscript:@"submissionTimeMinute"];

        v18 = [v11 bundleIdentifier];
        v19 = +[NSNumber numberWithUnsignedInteger:](NSNumber, "numberWithUnsignedInteger:", [v18 hash]);
        [v12 setObject:v19 forKeyedSubscript:@"bundleId"];

        v20 = [v11 suggestionID];
        v21 = +[NSNumber numberWithUnsignedInteger:](NSNumber, "numberWithUnsignedInteger:", [v20 hash]);
        ...
        v23 = [v11 subSuggestionIDs];
        v24 = +[NSNumber numberWithUnsignedInteger:](NSNumber, "numberWithUnsignedInteger:", [v23 count]);
        [v12 setObject:v24 forKeyedSubscript:@"subBundleCount"];

        v25 = [v11 startDate];
        [v170 timeIntervalSinceDate:v25];
        ...
        if (v31)
        {
          ...
          v35 = [v11 clusterMetadata];
          v36 = [v35 phenotype];

          v37 = +[NSNumber numberWithUnsignedInteger:](NSNumber, "numberWithUnsignedInteger:", [v36 count]);
          [v12 setObject:v37 forKeyedSubscript:@"phenotypeFieldCount"];

          v38 = [v36 objectForKeyedSubscript:@"topLevelActivityType"];

          if (v38)
          {
            v39 = [v36 objectForKeyedSubscript:@"topLevelActivityType"];
          ...
          v41 = [v36 objectForKeyedSubscript:@"secondLevelActivityType"];
          if (v41)
          {
          ...
          v47 = [v36 objectForKeyedSubscript:@"timeTag"];
          if (v47)
          {
          ...
          v49 = [v36 objectForKeyedSubscript:@"combinedPlaceType"];

          if (v49)
          {
            v50 = [v36 objectForKeyedSubscript:@"combinedPlaceType"];
            [v12 setObject:v50 forKeyedSubscript:@"combinedPlaceType"];
          }

          v51 = [v36 objectForKeyedSubscript:@"placeName"];
          if (v51)
          {
          ...
          v53 = [v36 objectForKeyedSubscript:@"enclosingAreaName"];
          if (v53)
          {
          ...
          v57 = [v36 objectForKeyedSubscript:@"withFamily"];
          ...
          v59 = [v36 objectForKeyedSubscript:@"withFriend"];
          ...
          v60 = [v36 objectForKeyedSubscript:@"withChild"];
          ...
          v61 = [v36 objectForKeyedSubscript:@"withMyPet"];
          ...
          v62 = [v36 objectForKeyedSubscript:@"activityTypeFromPhotoTraits"];

          if (v62)
          {
            v63 = [v36 objectForKeyedSubscript:@"activityTypeFromPhotoTraits"];
            [v12 setObject:v63 forKeyedSubscript:@"activityTypeFromPhotoTraits"];
          }

          v64 = [v36 objectForKeyedSubscript:@"holiday"];

          if (v64)
          {
            v65 = [v36 objectForKeyedSubscript:@"holiday"];
            [v12 setObject:v65 forKeyedSubscript:@"holiday"];
          }

          v66 = [v36 objectForKeyedSubscript:@"celebration"];

          if (v66)
          {
            v67 = [v36 objectForKeyedSubscript:@"celebration"];
            [v12 setObject:v67 forKeyedSubscript:@"celebration"];
          }

          v68 = [v36 objectForKeyedSubscript:@"placeTypeFromPhotoTraits"];

          if (v68)
          {
            v69 = [v36 objectForKeyedSubscript:@"placeTypeFromPhotoTraits"];
            [v12 setObject:v69 forKeyedSubscript:@"placeTypeFromPhotoTraits"];
          }

          v70 = [v36 objectForKeyedSubscript:@"socialEventFromPhotoTraits"];

          if (v70)
          {
            v71 = [v36 objectForKeyedSubscript:@"socialEventFromPhotoTraits"];
            [v12 setObject:v71 forKeyedSubscript:@"socialEventFromPhotoTraits"];
          }

          v72 = [v36 objectForKeyedSubscript:@"otherSubjectFromPhotoTraits"];

          if (v72)
          {
            v73 = [v36 objectForKeyedSubscript:@"otherSubjectFromPhotoTraits"];
            [v12 setObject:v73 forKeyedSubscript:@"otherSubjectFromPhotoTraits"];
          }

          v74 = [v11 clusterMetadata];
          v75 = [v74 topLevelActivityHistogram];
          [v75 count];

          v76 = [v11 clusterMetadata];
          v77 = [v76 topLevelActivityHistogram];
          v78 = [(MOBundleClusteringManager *)self _countValidKeysInHistogram:v77];
          [v12 setObject:v78 forKeyedSubscript:@"uniqueTopLevelActivityCount"];

          v79 = [v11 clusterMetadata];
          v80 = [v79 secondLevelActivityHistogram];
          [v80 count];

          v81 = [v11 clusterMetadata];
          v82 = [v81 secondLevelActivityHistogram];
          v83 = [(MOBundleClusteringManager *)self _countValidKeysInHistogram:v82];
          [v12 setObject:v83 forKeyedSubscript:@"uniqueSecondLevelActivityCount"];

          v84 = [v11 clusterMetadata];
          v85 = [v84 activityTypeFromPhotoTraitsHistogram];
          [v85 count];

          v86 = [v11 clusterMetadata];
          v87 = [v86 activityTypeFromPhotoTraitsHistogram];
          v88 = [(MOBundleClusteringManager *)self _countValidKeysInHistogram:v87];
          [v12 setObject:v88 forKeyedSubscript:@"activityTypeFromPhotoTraitsCount"];

          v89 = [v11 clusterMetadata];
          v90 = [v89 timeTagHistogram];
          [v90 count];

          v91 = [v11 clusterMetadata];
          v92 = [v91 timeTagHistogram];
          v93 = [(MOBundleClusteringManager *)self _countValidKeysInHistogram:v92];
          ...
          v96 = [v11 clusterMetadata];
          v97 = [v96 dayOfWeekHistogram];
          v98 = [(MOBundleClusteringManager *)self _countValidKeysInHistogram:v97];
          [v12 setObject:v98 forKeyedSubscript:@"dayOfWeekCount"];

          v99 = [v11 clusterMetadata];
          v100 = [v99 weekOfYearHistogram];
          [v100 count];

          v101 = [v11 clusterMetadata];
          v102 = [v101 weekOfYearHistogram];
          v103 = [(MOBundleClusteringManager *)self _countValidKeysInHistogram:v102];
          [v12 setObject:v103 forKeyedSubscript:@"weekOfYearCount"];

          v104 = [v11 clusterMetadata];
          v105 = [v104 holidayHistogram];
          [v105 count];

          v106 = [v11 clusterMetadata];
          v107 = [v106 holidayHistogram];
          v108 = [(MOBundleClusteringManager *)self _countValidKeysInHistogram:v107];
          [v12 setObject:v108 forKeyedSubscript:@"holidayCount"];

          v109 = [v11 clusterMetadata];
          v110 = [v109 celebrationHistogram];
          [v110 count];

          v111 = [v11 clusterMetadata];
          v112 = [v111 celebrationHistogram];
          v113 = [(MOBundleClusteringManager *)self _countValidKeysInHistogram:v112];
          [v12 setObject:v113 forKeyedSubscript:@"celebrationCount"];

          v114 = [v11 clusterMetadata];
          v115 = [v114 placeNameHistogram];
          [v115 count];

          v116 = [v11 clusterMetadata];
          v117 = [v116 placeNameHistogram];
          v118 = [(MOBundleClusteringManager *)self _countValidKeysInHistogram:v117];
          [v12 setObject:v118 forKeyedSubscript:@"placeNameCount"];

          v119 = [v11 clusterMetadata];
          v120 = [v119 combinedPlaceTypeHistogram];
          [v120 count];

          v121 = [v11 clusterMetadata];
          v122 = [v121 combinedPlaceTypeHistogram];
          v123 = [(MOBundleClusteringManager *)self _countValidKeysInHistogram:v122];
          [v12 setObject:v123 forKeyedSubscript:@"combinedPlaceTypeCount"];

          v124 = [v11 clusterMetadata];
          v125 = [v124 enclosingPlaceNameHistogram];
          [v125 count];

          v126 = [v11 clusterMetadata];
          v127 = [v126 enclosingPlaceNameHistogram];
          v128 = [(MOBundleClusteringManager *)self _countValidKeysInHistogram:v127];
          [v12 setObject:v128 forKeyedSubscript:@"enclosingPlaceNameCount"];

          v129 = [v11 clusterMetadata];
          v130 = [v129 placeTypeFromPhotoTraitsHistogram];
          [v130 count];

          v131 = [v11 clusterMetadata];
          v132 = [v131 placeTypeFromPhotoTraitsHistogram];
          v133 = [(MOBundleClusteringManager *)self _countValidKeysInHistogram:v132];
          [v12 setObject:v133 forKeyedSubscript:@"placeTypeFromPhotoTraitsCount"];

          v134 = [v11 clusterMetadata];
          v135 = [v134 contactNamesHistogram];
          [v135 count];

          v136 = [v11 clusterMetadata];
          v137 = [v136 contactNamesHistogram];
          v138 = [(MOBundleClusteringManager *)self _countValidKeysInHistogram:v137];
          [v12 setObject:v138 forKeyedSubscript:@"contactNamesCount"];

          v139 = [v11 clusterMetadata];
          v140 = [v139 personRelationshipHistogram];
          [v140 count];

          v141 = [v11 clusterMetadata];
          v142 = [v141 personRelationshipHistogram];
          v143 = [(MOBundleClusteringManager *)self _countValidKeysInHistogram:v142];
          [v12 setObject:v143 forKeyedSubscript:@"personRelationshipCount"];

          v144 = [v11 clusterMetadata];
          v145 = [v144 socialEventFromPhotoTraitsHistogram];
          [v145 count];

          v146 = [v11 clusterMetadata];
          v147 = [v146 socialEventFromPhotoTraitsHistogram];
          v148 = [(MOBundleClusteringManager *)self _countValidKeysInHistogram:v147];
          [v12 setObject:v148 forKeyedSubscript:@"socialEventFromPhotoTraitsCount"];

          v149 = [v11 clusterMetadata];
          v150 = [v149 otherSubjectFromPhotoTraitsHistogram];
          [v150 count];

          v151 = [v11 clusterMetadata];
          v152 = [v151 otherSubjectFromPhotoTraitsHistogram];
          v153 = [(MOBundleClusteringManager *)self _countValidKeysInHistogram:v152];
...
- (void)submitAnomalyBundleInternalAnalytics:(id)a3 withOnboardingStatus:(id)a4 andSubmissionDate:(id)a5
{
  ...
  v9 = [v45 components:764 fromDate:v55];
  v52 = [v9 year];
  v51 = [v9 month];
  v50 = [v9 day];
  v49 = [v9 hour];
  ...
  if (v56)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        v11 = *(*(&v60 + 1) + 8 * v10);
        context = objc_autoreleasePoolPush();
        v12 = [MOEngagementAndSuggestionAnalyticsManager generateDefaultAnalyticsPayloadWithOnboardingStatus:v54];
        v13 = [NSNumber numberWithInteger:v52];
        [v12 setObject:v13 forKeyedSubscript:@"submissionTimeYear"];

        v14 = [NSNumber numberWithInteger:v51];
        [v12 setObject:v14 forKeyedSubscript:@"submissionTimeMonth"];

        v15 = [NSNumber numberWithInteger:v50];
        [v12 setObject:v15 forKeyedSubscript:@"submissionTimeDay"];

        v16 = [NSNumber numberWithInteger:v49];
        [v12 setObject:v16 forKeyedSubscript:@"submissionTimeHour"];

        v17 = [NSNumber numberWithInteger:v48];
        [v12 setObject:v17 forKeyedSubscript:@"submissionTimeMinute"];
        ...
        v22 = [v11 suggestionID];
        v23 = +[NSNumber numberWithUnsignedInteger:](NSNumber, "numberWithUnsignedInteger:", [v22 hash]);
...
- (id)getDefaultClusteringParams
{
  v3 = [(MOBundleClusteringManager *)self getDefaultDistanceWeight];
  ...
  v7 = [[MOClusteringParams alloc] initWithembeddingDistanceWeights:v3 minPoints:v5 minClusterSize:v6];
...
+ (id)setEmbeddingWeightsWithConfigurationManager:(id)a3 configurationManager:(id)a4
{
  ...
  if (v8)
  {
    ...
    if (![MOBundleClusteringManager _containsCompleteEmbeddingDistanceWeightKeys:v11])
    {
      ...
      v14 = [v11 allKeys];
      [v13 handleFailureInMethod:a2 object:a1 file:@"MOBundleClusteringManager.m" lineNumber:1698 description:{@"Default embeddingDistanceWeightDict is missing some keys. Current keys:%@ (in %s:%d)", v14, "+[MOBundleClusteringManager setEmbeddingWeightsWithConfigurationManager:configurationManager:]", 1698}];
    }
