...
- (void)_performAnnotationWithEvents:(id)a3 withPatternEvents:(id)a4 withBundleWindowStart:(id)a5 withBundleWindowEnd:(id)a6 handler:(id)a7
{
  ...
  v138 = [v142 filteredArrayUsingPredicate:v139];
  ...
  if ([v149 count])
  {
    ...
    v127 = [v142 filteredArrayUsingPredicate:v128];
    ...
    v146 = [v142 filteredArrayUsingPredicate:v125];
    ...
    else
    {
      ...
      *&buf[16] = 0x3032000000;
      ...
      {
        v22 = [(MOPhotosAtHomeManager *)self parameters];
        [v22 photosDurationAtHomeSecThreshold];
        v24 = v23;
      ...
      if ([v201[5] count])
      {
        ...
        {
          v30 = [v201[5] count];
          v31 = [*(*&buf[8] + 40) firstObject];
          v32 = [v207[5] lastObject];
          *v215 = 134218498;
          *&v215[4] = v30;
          *&v215[12] = 2112;
          *&v215[14] = v31;
        ...
        v33 = [(MOPhotosAtHomeManager *)self fUniverse];
        v34 = objc_opt_class();
        v35 = NSStringFromClass(v34);
        v144 = [v33 getService:v35];
        ...
        for (i = 0; [v201[5] count] > i; i = v147 + 1)
        {
          ...
          v42 = [(MOEventBundle *)v41 startDate];
          v43 = [MOTime timeForDate:v42 timeZoneManager:v144];
          ...
          v45 = [v157 firstObject];
          v46 = [v45 eventIdentifier];
          v47 = [(MOEventBundle *)v41 action];
          [v47 setSourceEventIdentifier:v46];

          v48 = [MOPlace alloc];
          v49 = [v157 firstObject];
          v50 = [v49 location];
          v51 = [(MOPlace *)v48 initWithPlaceName:@"Home" placeType:1 placeUserType:1 location:v50 locationMode:1 poiCategory:0 categoryMuid:-1.0 distanceToHomeInMiles:-1.0 placeNameConfidence:0.0 familiarityIndexLOI:0];
          [(MOEventBundle *)v41 setPlace:v51];

          v52 = [v157 firstObject];
          v53 = [v52 eventIdentifier];
          v54 = [(MOEventBundle *)v41 place];
          ...
          v55 = [(MOEventBundle *)v41 startDate];
          v56 = [(MOEventBundle *)v41 endDate];
          v151 = [MOContextAnnotationUtilities predicateOfEmotionLogsWithStartDate:v55 endDate:v56];

          v150 = [v145 filteredArrayUsingPredicate:v151];
          v57 = [(MOPhotosAtHomeManager *)self parameters];
          [v57 emotionAttachmentBundleDurationThreshold];
          *&v58 = v58;
          ...
          *&v215[16] = 0x3032000000;
          ...
          v64 = *(*&v215[8] + 40);
          v65 = [(MOPhotosAtHomeManager *)self parameters];
          [v65 photosCurationScoreThreshold];
          v67 = v66;
          v68 = [(MOPhotosAtHomeManager *)self parameters];
          v69 = [v68 photosFaceCountThreshold];
          v70 = [(MOPhotosAtHomeManager *)self parameters];
          v71 = [v70 photosCountThreshold];
          *&v72 = v67;
          v73 = [MOPhotosAtHomeManager chooseResourcesWithGoodPhotos:v64 withPhotoCurationScore:v69 andFaceCount:v71 numPhotosThreshold:v72];
          ...
          v159 = 0u;
          v160 = 0u;
          v74 = [(MOEventBundle *)v41 resources];
          v75 = [v74 countByEnumeratingWithState:&v159 objects:v212 count:16];
          if (v75)
          {
            v76 = *v160;
            v77 = 0.0;
            do
            {
              for (j = 0; j != v75; j = j + 1)
              {
                ...
                v79 = [*(*(&v159 + 1) + 8 * j) photoCurationScore];
                [v79 floatValue];
                v81 = v80;
          ...
          v82 = [(MOEventBundle *)v41 resources];
          v83 = [v82 count] == 0;

          if (!v83)
          {
            v85 = [(MOEventBundle *)v41 resources];
            v86 = [v85 count];
          ...
          *&v84 = v77;
          ...
          v90 = [(MOEventBundle *)v41 startDate];
          v91 = [(MOEventBundle *)v41 endDate];
          v92 = [MOContextAnnotationUtilities predicateOfInviteEventsWithStartDate:v90 endDate:v91];

          v93 = [v146 filteredArrayUsingPredicate:v92];
          v94 = [(MOPhotosAtHomeManager *)self parameters];
          [v94 timeAtHomeInviteEventTimeOverlapWithVisitsThreshold];
          v96 = v95;
          v97 = [(MOPhotosAtHomeManager *)self parameters];
          [v97 timeAtHomeInviteEventDistanceFromVisitEventsThreshold];
          v99 = v98;
          v100 = [(MOPhotosAtHomeManager *)self parameters];
          [v100 timeAtHomeInviteEventPhotoTimeThreshold];
          LODWORD(v101) = v99;
          ...
          if (v103)
          {
            ...
            v105 = [(MOPhotosAtHomeManager *)self parameters];
            v106 = [v105 timeAtHomeInviteEventStandardTimeThresholdForPhotoCheck];
            v107 = [(MOPhotosAtHomeManager *)self parameters];
            +[MOContextAnnotationUtilities removePhotoResourcesFarFromInvite:inviteEvent:withStandardTimeThreshold:missingEndDateTimeThreshold:](MOContextAnnotationUtilities, "removePhotoResourcesFarFromInvite:inviteEvent:withStandardTimeThreshold:missingEndDateTimeThreshold:", v41, v103, v106, [v107 timeAtHomeInviteEventMissingEndDateTimeThresholdForPhotoCheck]);
          }

          v108 = [NSPredicate predicateWithFormat:@"%K = %lu", @"type", 2];
          v109 = [(MOEventBundle *)v41 resources];
          v110 = [v109 filteredArrayUsingPredicate:v108];

          v111 = [NSPredicate predicateWithFormat:@"%K = %lu", @"type", 16];
          v112 = [(MOEventBundle *)v41 resources];
          v113 = [v112 filteredArrayUsingPredicate:v111];
          ...
          v116 = [(MOEventBundle *)v41 resources];
          v117 = [v116 count] == 0;
  ...
  if (v11)
  {
    ...
    do
    {
      for (i = 0; i != v12; i = i + 1)
      {
        ...
        v15 = *(*(&v24 + 1) + 8 * i);
        v16 = [v15 photoCurationScore];
        [v16 floatValue];
        v18 = v17;

        if (v18 >= a4 || [v15 photoFaceCount] >= a5)
        {
          [v9 addObject:v15];
        }
