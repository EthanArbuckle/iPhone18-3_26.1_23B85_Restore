...
- (void)processIDSServiceMessage:(id)a3 completion:(id)a4
{
  ...
  v12 = *(*(*sub_1000035D0((&v8->super.isa + OBJC_IVAR____TtC12searchpartyd25SecureLocationsTrampoline_implementation), *&v8->implementation[OBJC_IVAR____TtC12searchpartyd25SecureLocationsTrampoline_implementation + 16]) + 72) + 24);
  _Block_copy(v6);
