...
- (void)updateProperties
{
  ...
  v4 = [(TSDgPTPFDPtPPort *)self _localPDelayLogMeanInterval];
  v5 = [(TSDgPTPFDPtPPort *)self _remotePDelayLogMeanInterval];
  v6 = [(TSDgPTPFDPtPPort *)self _multipleRemotes];
  v7 = [(TSDgPTPFDPtPPort *)self _measuringPDelay];
