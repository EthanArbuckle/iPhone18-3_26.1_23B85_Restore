...
- (SDAirDropHandlerPodcastsLinks)initWithTransfer:(id)transfer;
...
- (SDAirDropHandlerPodcastsLinks)initWithTransfer:(id)transfer
{
  ...
  return [(SDAirDropHandler *)&v4 initWithTransfer:transfer bundleIdentifier:@"com.apple.podcasts"];
}
...
- (BOOL)canHandleTransfer
{
  ...
  candidateIdentifiers = [(SDAirDropHandlerPodcastsLinks *)self candidateIdentifiers];
  v13 = 0u;
  v14 = 0u;
  v15 = 0u;
  v16 = 0u;
