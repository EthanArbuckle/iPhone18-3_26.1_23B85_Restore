...
{
  v7.receiver = self;
  v7.super_class = SDUnlockSetupCreateSecret;
  v3 = [(SDUnlockSetupCreateSecret *)&v7 description];
  dictionaryRepresentation = [(SDUnlockSetupCreateSecret *)self dictionaryRepresentation];
...
LABEL_5:
    v7 = 0;
    return v7 ^ v6 ^ [(NSData *)self->_token hash:v3];
  }
...
- (void)mergeFrom:(id)from
{
  ...
  {
    v6 = fromCopy;
    [(SDUnlockSetupCreateSecret *)self setToken:?];
    fromCopy = v6;
  }
}
