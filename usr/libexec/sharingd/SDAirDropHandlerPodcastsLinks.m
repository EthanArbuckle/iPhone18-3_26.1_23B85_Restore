...
{
  v4.receiver = self;
  v4.super_class = SDAirDropHandlerPodcastsLinks;
...
{
  v3.receiver = self;
  v3.super_class = SDAirDropHandlerPodcastsLinks;
...
- (id)suitableContentsDescription
{
  ...
  v4 = [(SDAirDropHandler *)self alertMessageLocalizedKeyForTypeDicts:&off_10090FFB0];
