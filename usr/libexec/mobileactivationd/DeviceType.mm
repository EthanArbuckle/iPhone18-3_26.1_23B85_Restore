...
void __28__DeviceType_sharedInstance__block_invoke(id a1)
{
  ...
  v2 = sharedInstance_device_type;
  sharedInstance_device_type = v1;
}

- (DeviceType)init
{
  v58.receiver = self;
  v58.super_class = DeviceType;
  v2 = [(DeviceType *)&v58 init];
  if (v2)
  {
    ...
    if ([v19 isEqualToNumber:&off_1003FBC78] & 1) != 0 || (objc_msgSend(v19, "isEqualToNumber:", &off_1003FBC90) & 1) != 0 || (objc_msgSend(v19, "isEqualToNumber:", &off_1003FBCA8))
    {
      LOBYTE(v20) = 0;
    }
    ...
    {
      v20 = [v19 isEqualToNumber:&off_1003FBCC0] ^ 1;
    }

    v2->_device_supports_mfi_certificates = v20;
    if ([v19 isEqualToNumber:&off_1003FBCC0] & 1) != 0 || (objc_msgSend(v19, "isEqualToNumber:", &off_1003FBC90))
    {
      LOBYTE(v21) = 0;
    }
    ...
    {
      v21 = [v19 isEqualToNumber:&off_1003FBCA8] ^ 1;
    }
    ...
    v23 = [(DeviceType *)v2 copyDeviceTreeInt:v22 key:@"allow-hactivation" defaultValue:0];
    ...
    if (v25 && v27 && v31 && v29)
    {
      if ([v25 isEqualToNumber:&off_1003FBCD8] && objc_msgSend(v27, "isEqualToNumber:", &off_1003FBCF0) && objc_msgSend(v29, "isEqualToNumber:", &off_1003FBCD8) && objc_msgSend(v31, "isEqualToNumber:", &off_1003FBCD8))
      {
        v2->_should_hactivate = 1;
        v2->_is_prodfused_demoted = 1;
      }

      if ([v25 isEqualToNumber:&off_1003FBCF0] && objc_msgSend(v27, "isEqualToNumber:", &off_1003FBCF0) && objc_msgSend(v29, "isEqualToNumber:", &off_1003FBCD8) && objc_msgSend(v31, "isEqualToNumber:", &off_1003FBCD8))
      {
        v2->_should_hactivate = 1;
    ...
    if (v2->_is_internal_build)
    {
      ...
      v39 = [(NSFileManager *)v38 fileExistsAtPath:@"/AppleInternal/Lockdown/.hactivateoff"];
      ...
      if (is_virtual_machine())
      {
        ...
        v48 = [(DeviceType *)v2 copyDeviceTreeInt:v47 key:@"enable-avp-fairplay" defaultValue:0];
...
- (id)copyDeviceTreeString:(id)a3 key:(id)a4 defaultValue:(id)a5
{
  ...
  if (a4)
  {
    ...
    if (v12)
    {
      ...
      if (v14)
      {
        v11 = [[NSString alloc] initWithUTF8String:{objc_msgSend(v10, "bytes")}];
