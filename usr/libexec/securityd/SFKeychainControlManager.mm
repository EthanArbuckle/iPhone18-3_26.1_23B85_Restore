  ...
  if (v9)
  {
    ...
    do
    {
      for (i = 0; i != v10; i = i + 1)
      {
        ...
        {
          v20 = 0;
          sub_1000103CC(v13, &v20, @"failed to delete corrupted item");
          v14 = v20;
          [v7 addObject:v20];
...
- (id)findCorruptedItemsWithError:(id *)error
{
  ...
  if (v3 != -25300)
  {
    sub_1000103CC(v3, &v34, @"generic password query failed");
    v4 = v34;
    if (v34)
    {
      [v25 addObject:v34];
  ...
  if (v5 != -25300)
  {
    sub_1000103CC(v5, &v32, @"internet password query failed");
    v6 = v32;
    if (v32)
    {
      [v25 addObject:v32];
  ...
  if (v8 != -25300)
  {
    sub_1000103CC(v8, &v29, @"certificate query failed");
    v10 = v29;
    if (v29)
    {
      [v25 addObject:v29];
...
+ (id)sharedManager
{
  if (qword_10039DE28 != -1)
  {
    dispatch_once(&qword_10039DE28, &stru_1003369F8);
  }
