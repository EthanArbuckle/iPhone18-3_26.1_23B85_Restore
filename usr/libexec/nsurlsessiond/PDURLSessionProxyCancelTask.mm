...
- (void)mergeFrom:(id)from
{
  ...
  else
  {
    ...
    v7 = fromCopy;
    [(PDURLSessionProxyCancelTask *)self setTask:?];
  }
...
{
  v7.receiver = self;
  v7.super_class = PDURLSessionProxyCancelTask;
  v3 = [(PDURLSessionProxyCancelTask *)&v7 description];
  dictionaryRepresentation = [(PDURLSessionProxyCancelTask *)self dictionaryRepresentation];
