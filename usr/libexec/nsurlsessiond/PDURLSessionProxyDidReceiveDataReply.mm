...
- (void)mergeFrom:(id)from
{
  ...
  else
  {
    ...
    v7 = fromCopy;
    [(PDURLSessionProxyDidReceiveDataReply *)self setTask:?];
  }
...
{
  v7.receiver = self;
  v7.super_class = PDURLSessionProxyDidReceiveDataReply;
  v3 = [(PDURLSessionProxyDidReceiveDataReply *)&v7 description];
  dictionaryRepresentation = [(PDURLSessionProxyDidReceiveDataReply *)self dictionaryRepresentation];
