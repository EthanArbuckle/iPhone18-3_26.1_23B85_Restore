...
- (id)_actualResponse;
- (id)_initWithActualResponse:(id)response;
...
{
  v3 = objc_opt_class();
  archiveList = [(PDURLSessionProxyResponse *)self archiveList];
...
- (id)_initWithActualResponse:(id)response
{
  ...
  if (v5)
  {
    v6 = [NSKeyedArchiver _nsurlsessionproxy_secureArchivedDataWithRootObject:responseCopy];
...
- (id)description
{
  ...
  dictionaryRepresentation = [(PDURLSessionProxyResponse *)self dictionaryRepresentation];
