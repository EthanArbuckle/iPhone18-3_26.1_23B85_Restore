...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v8 = [(NSString *)self->_taskDescription copyWithZone:a3];
  v9 = v5[2];
  v5[2] = v8;
...
LABEL_15:
      ...
      if ((v13 >> 3) == 1)
      {
        ...
        v18[0] = 0;
        v18[1] = 0;
        if (!PBReaderPlaceMark() || !sub_10006CE20(taskDescription, a3))
        {
...
- (id)description
{
  ...
  v4 = [(PDURLSessionProxySetTaskDescription *)self dictionaryRepresentation];
