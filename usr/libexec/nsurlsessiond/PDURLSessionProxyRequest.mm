...
- (id)_actualRequest;
- (id)_initWithActualRequest:(id)request;
...
{
  v3 = objc_opt_class();
  archiveList = [(PDURLSessionProxyRequest *)self archiveList];
...
- (id)_initWithActualRequest:(id)request
{
  ...
  if (v5)
  {
    v6 = [NSKeyedArchiver _nsurlsessionproxy_secureArchivedDataWithRootObject:requestCopy];
...
- (void)mergeFrom:(id)from
{
  ...
  {
    v5 = fromCopy;
    [(PDURLSessionProxyRequest *)self setArchiveList:?];
    fromCopy = v5;
  }
}
...
{
  v7.receiver = self;
  v7.super_class = PDURLSessionProxyRequest;
  v3 = [(PDURLSessionProxyRequest *)&v7 description];
  dictionaryRepresentation = [(PDURLSessionProxyRequest *)self dictionaryRepresentation];
