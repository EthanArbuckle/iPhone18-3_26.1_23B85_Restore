...
- (void)mergeFrom:(id)from
{
  ...
  else
  {
    ...
    [(PDURLSessionProxyTaskWillBeRetried *)self setTask:?];
  }
...
LABEL_7:
  ...
  else
  {
    ...
    [(PDURLSessionProxyTaskWillBeRetried *)self setError:?];
  }
...
{
  v7.receiver = self;
  v7.super_class = PDURLSessionProxyTaskWillBeRetried;
  v3 = [(PDURLSessionProxyTaskWillBeRetried *)&v7 description];
  dictionaryRepresentation = [(PDURLSessionProxyTaskWillBeRetried *)self dictionaryRepresentation];
