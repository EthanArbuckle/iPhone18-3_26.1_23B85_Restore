...
- (void)mergeFrom:(id)from
{
  ...
  else
  {
    ...
    v7 = fromCopy;
    [(PDURLSessionProxyOpenBodyStream *)self setTask:?];
  }
...
{
  v7.receiver = self;
  v7.super_class = PDURLSessionProxyOpenBodyStream;
  v3 = [(PDURLSessionProxyOpenBodyStream *)&v7 description];
  dictionaryRepresentation = [(PDURLSessionProxyOpenBodyStream *)self dictionaryRepresentation];
