...
- (id)copyWithZone:(_NSZone *)zone
{
  ...
  v8 = [(NSData *)self->_bodyData copyWithZone:zone];
  v9 = v5[1];
  v5[1] = v8;
...
LABEL_15:
      ...
      if ((v13 >> 3) == 1)
      {
        ...
        v18[0] = 0;
        v18[1] = 0;
        if (!PBReaderPlaceMark() || !sub_10006CE20(bodyData, from))
        {
...
- (id)description
{
  ...
  dictionaryRepresentation = [(PDURLSessionProxyUploadBodyData *)self dictionaryRepresentation];
