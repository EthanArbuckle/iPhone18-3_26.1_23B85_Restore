...
- (void)mergeFrom:(id)from
{
  ...
  else
  {
    ...
    [(PDURLSessionProxyWillPerformRedirectionReply *)self setTask:?];
  }
...
LABEL_7:
  ...
  else
  {
    ...
    [(PDURLSessionProxyWillPerformRedirectionReply *)self setRequest:?];
  }
...
- (BOOL)isEqual:(id)equal
{
  ...
  if ([equalCopy isMemberOfClass:objc_opt_class()] && ((task = self->_task, !(task | equalCopy[2])) || -[PDURLSessionProxyTaskMessage isEqual:](task, "isEqual:")))
  {
    ...
    {
      v7 = [(PDURLSessionProxyRequest *)request isEqual:?];
    }
...
LABEL_26:
    ...
    v17 = 0;
    v18 = 0;
    if (!PBReaderPlaceMark() || !sub_10005DE74(v14, from))
    {
LABEL_28:
...
{
  v7.receiver = self;
  v7.super_class = PDURLSessionProxyWillPerformRedirectionReply;
  v3 = [(PDURLSessionProxyWillPerformRedirectionReply *)&v7 description];
  dictionaryRepresentation = [(PDURLSessionProxyWillPerformRedirectionReply *)self dictionaryRepresentation];
