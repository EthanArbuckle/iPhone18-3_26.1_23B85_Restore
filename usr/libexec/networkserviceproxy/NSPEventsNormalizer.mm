...
- (id)predictionFromFeatures:(id)a3 error:(id *)a4
{
  ...
  v8 = [(NSPEventsNormalizer *)self predictionFromFeatures:v6 options:v7 error:a4];
...
- (id)predictionFromFeatures:(id)a3 options:(id)a4 error:(id *)a5
{
  v8 = a4;
  v9 = a3;
  v10 = [(NSPEventsNormalizer *)self model];
...
{
  v6 = a3;
  v7 = [[NSPEventsNormalizerInput alloc] initWithNormalizer_input:v6];

  v8 = [(NSPEventsNormalizer *)self predictionFromFeatures:v7 error:a4];
