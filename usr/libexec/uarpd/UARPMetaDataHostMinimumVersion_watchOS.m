...
- (UARPMetaDataHostMinimumVersion_watchOS)initWithLength:(unint64_t)a3 value:(void *)a4;
- (UARPMetaDataHostMinimumVersion_watchOS)initWithPropertyListValue:(id)a3 relativeURL:(id)a4;
- (id)description;
- (id)tlvValue;
@end
...
- (id)tlvValue
{
  v3 = [(UARPMetaDataHostMinimumVersion_watchOS *)self osVersion];
  v6.receiver = self;
  v6.super_class = UARPMetaDataHostMinimumVersion_watchOS;
...
- (id)description
{
  ...
  v4 = [(UARPMetaDataHostMinimumVersion_watchOS *)self osVersion];
