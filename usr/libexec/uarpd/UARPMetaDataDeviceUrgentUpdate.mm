...
- (UARPMetaDataDeviceUrgentUpdate)initWithLength:(unint64_t)length value:(void *)value;
- (UARPMetaDataDeviceUrgentUpdate)initWithPropertyListValue:(id)value relativeURL:(id)l;
- (id)description;
- (id)tlvValue;
@end
...
- (id)description
{
  ...
  v4 = [NSString stringWithFormat:@"<%@: %u>", tlvName, [(UARPMetaDataDeviceUrgentUpdate *)self urgentUpdate]];
