...
- (UARPMetaDataPersonalizationTicketNeedsLogicalUnitNumber)initWithLength:(unint64_t)length value:(void *)value;
- (UARPMetaDataPersonalizationTicketNeedsLogicalUnitNumber)initWithPropertyListValue:(id)value relativeURL:(id)l;
- (id)description;
- (id)tlvValue;
@end
...
- (id)description
{
  ...
  ticketNeedsLogicalUnitNumber = [(UARPMetaDataPersonalizationTicketNeedsLogicalUnitNumber *)self ticketNeedsLogicalUnitNumber];
  v5 = @"YES";
  if (!ticketNeedsLogicalUnitNumber)
  {
    v5 = @"NO";
  }
