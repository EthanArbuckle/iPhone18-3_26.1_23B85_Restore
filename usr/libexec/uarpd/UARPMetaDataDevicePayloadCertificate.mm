...
@implementation UARPMetaDataDevicePayloadCertificate

- (UARPMetaDataDevicePayloadCertificate)init
{
  v6.receiver = self;
  v6.super_class = UARPMetaDataDevicePayloadCertificate;
  v2 = [(UARPMetaData *)&v6 init];
  v3 = v2;
  if (v2)
  {
    v2->super._tlvType = -858619643;
    tlvName = v2->super._tlvName;
    v2->super._tlvName = @"Payload Certificate";
  }
  ...
  if (v8)
  {
    ...
    else
    {
      ...
      if (v14)
      {
        ...
        v20 = v9->_payloadCertificate;
        v9->_payloadCertificate = v19;

        v9->super._tlvLength = [(NSData *)v9->_payloadCertificate length];
        v13 = v9;
      }
...
- (UARPMetaDataDevicePayloadCertificate)initWithLength:(unint64_t)a3 value:(void *)a4
{
  ...
  if (v6)
  {
    ...
    v6->super._tlvLength = [(NSData *)v6->_payloadCertificate length];
  }
