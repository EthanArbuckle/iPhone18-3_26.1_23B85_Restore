...
- (UARPMetaDataHeySiriModelLocale)initWithLength:(unint64_t)a3 value:(void *)a4;
- (UARPMetaDataHeySiriModelLocale)initWithPropertyListValue:(id)a3 relativeURL:(id)a4;
- (id)description;
- (id)tlvValue;
@end
...
- (id)tlvValue
{
  v3 = [(UARPMetaDataHeySiriModelLocale *)self modelLocale];
  v6.receiver = self;
  v6.super_class = UARPMetaDataHeySiriModelLocale;
...
- (id)description
{
  ...
  v4 = [(UARPMetaDataHeySiriModelLocale *)self modelLocale];
