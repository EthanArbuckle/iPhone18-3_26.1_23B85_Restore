...
- (UARPMetaDataPersonalizationBoardID)initWithLength:(unint64_t)a3 value:(void *)a4;
- (UARPMetaDataPersonalizationBoardID)initWithPropertyListValue:(id)a3 relativeURL:(id)a4;
- (id)description;
- (id)tlvValue;
@end
...
- (id)description
{
  ...
  v4 = [NSString stringWithFormat:@"<%@: %u>", v3, [(UARPMetaDataPersonalizationBoardID *)self boardID]];
