...
@implementation UARPMetaDataPersonalizationSecurityDomain

- (UARPMetaDataPersonalizationSecurityDomain)init
{
  v6.receiver = self;
  v6.super_class = UARPMetaDataPersonalizationSecurityDomain;
  v2 = [(UARPMetaData *)&v6 init];
  v3 = v2;
  if (v2)
  {
    v2->super._tlvType = -2001563383;
    v2->super._tlvLength = 4;
    tlvName = v2->super._tlvName;
    v2->super._tlvName = @"Personalization Security Domain";
  }
...
- (UARPMetaDataPersonalizationSecurityDomain)initWithPropertyListValue:(id)value relativeURL:(id)l
{
  ...
  if (v8)
  {
    v7->_securityDomain = [(UARPMetaDataPersonalizationSecurityDomain *)v8 unsignedLongValue];
...
{
  v4.receiver = self;
  v4.super_class = UARPMetaDataPersonalizationSecurityDomain;
  v2 = [(UARPMetaData *)&v4 tlvValueWithUInt32:[(UARPMetaDataPersonalizationSecurityDomain *)self securityDomain]];
