...
- (UARPMetaDataPersonalizationUIDMode)initWithLength:(unint64_t)length value:(void *)value;
- (UARPMetaDataPersonalizationUIDMode)initWithPropertyListValue:(id)value relativeURL:(id)l;
- (id)description;
- (id)tlvValue;
@end
...
- (id)description
{
  ...
  uidMode = [(UARPMetaDataPersonalizationUIDMode *)self uidMode];
  v5 = @"YES";
  if (!uidMode)
  {
    v5 = @"NO";
