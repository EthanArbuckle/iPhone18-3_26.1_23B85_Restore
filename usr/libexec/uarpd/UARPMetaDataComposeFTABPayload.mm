...
- (UARPMetaDataComposeFTABPayload)initWithLength:(unint64_t)length value:(void *)value;
- (UARPMetaDataComposeFTABPayload)initWithPropertyListValue:(id)value relativeURL:(id)l;
- (id)description;
- (id)tlvValue;
@end
...
- (id)description
{
  ...
  isFTABPayload = [(UARPMetaDataComposeFTABPayload *)self isFTABPayload];
  v5 = @"YES";
  if (!isFTABPayload)
  {
    v5 = @"NO";
