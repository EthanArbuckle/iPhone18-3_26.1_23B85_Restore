...
- (UARPMetaDataComposeBVERStringFile)initWithLength:(unint64_t)length value:(void *)value;
- (UARPMetaDataComposeBVERStringFile)initWithPropertyListValue:(id)value relativeURL:(id)l;
- (id)description;
- (id)tlvValue;
@end
...
- (UARPMetaDataComposeBVERStringFile)initWithLength:(unint64_t)length value:(void *)value
{
  ...
  v7 = v6;
  if (v6 && (v12.receiver = v6, v12.super_class = UARPMetaDataComposeBVERStringFile, [(UARPMetaData *)&v12 componentVersionWithLength:length value:value], v8 = objc_claimAutoreleasedReturnValue(), version = v7->_version, v7->_version = v8, version, v7->_version))
  {
    v10 = v7;
  }
...
- (id)tlvValue
{
  version = [(UARPMetaDataComposeBVERStringFile *)self version];
  v6.receiver = self;
  v6.super_class = UARPMetaDataComposeBVERStringFile;
