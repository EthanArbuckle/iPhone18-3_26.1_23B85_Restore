...
- (UARPMetaDataPersonalizationProvisioning)initWithLength:(unint64_t)a3 value:(void *)a4;
- (UARPMetaDataPersonalizationProvisioning)initWithPropertyListValue:(id)a3 relativeURL:(id)a4;
- (id)description;
- (id)tlvValue;
@end
...
- (id)description
{
  ...
  v4 = [(UARPMetaDataPersonalizationProvisioning *)self provisioning];
  v5 = @"YES";
  if (!v4)
  {
    v5 = @"NO";
