...
- (UARPMetaDataPersonalizationLogicalUnitNumber)initWithLength:(unint64_t)length value:(void *)value;
- (UARPMetaDataPersonalizationLogicalUnitNumber)initWithPropertyListValue:(id)value relativeURL:(id)l;
- (id)description;
- (id)tlvValue;
@end
...
- (id)description
{
  ...
  v4 = [NSString stringWithFormat:@"<%@: %u>", tlvName, [(UARPMetaDataPersonalizationLogicalUnitNumber *)self logicalUnitNumber]];
