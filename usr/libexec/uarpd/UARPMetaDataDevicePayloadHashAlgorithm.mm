...
@implementation UARPMetaDataDevicePayloadHashAlgorithm

- (UARPMetaDataDevicePayloadHashAlgorithm)init
{
  v6.receiver = self;
  v6.super_class = UARPMetaDataDevicePayloadHashAlgorithm;
  v2 = [(UARPMetaData *)&v6 init];
  v3 = v2;
  if (v2)
  {
    v2->super._tlvType = -858619630;
    v2->super._tlvLength = 2;
    tlvName = v2->super._tlvName;
    v2->super._tlvName = @"Payload Hash Algorithm";
  }
...
- (UARPMetaDataDevicePayloadHashAlgorithm)initWithPropertyListValue:(id)value relativeURL:(id)l
{
  ...
  if (v8)
  {
    v7->_hashAlgorithm = [(UARPMetaDataDevicePayloadHashAlgorithm *)v8 unsignedShortValue];
...
{
  v4.receiver = self;
  v4.super_class = UARPMetaDataDevicePayloadHashAlgorithm;
  v2 = [(UARPMetaData *)&v4 tlvValueWithUInt16:[(UARPMetaDataDevicePayloadHashAlgorithm *)self hashAlgorithm]];
