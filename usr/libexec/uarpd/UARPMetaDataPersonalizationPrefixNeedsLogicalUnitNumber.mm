...
- (UARPMetaDataPersonalizationPrefixNeedsLogicalUnitNumber)initWithLength:(unint64_t)a3 value:(void *)a4;
- (UARPMetaDataPersonalizationPrefixNeedsLogicalUnitNumber)initWithPropertyListValue:(id)a3 relativeURL:(id)a4;
- (id)description;
- (id)tlvValue;
@end
...
- (id)description
{
  ...
  v4 = [(UARPMetaDataPersonalizationPrefixNeedsLogicalUnitNumber *)self prefixNeedsLogicalUnitNumber];
  v5 = @"YES";
  if (!v4)
  {
    v5 = @"NO";
