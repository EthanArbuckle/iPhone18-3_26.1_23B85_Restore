...
- (UARPMetaDataHostMinimumVersion_visionOS)initWithLength:(unint64_t)length value:(void *)value;
- (UARPMetaDataHostMinimumVersion_visionOS)initWithPropertyListValue:(id)value relativeURL:(id)l;
- (id)description;
- (id)tlvValue;
@end
...
- (id)tlvValue
{
  osVersion = [(UARPMetaDataHostMinimumVersion_visionOS *)self osVersion];
  v6.receiver = self;
  v6.super_class = UARPMetaDataHostMinimumVersion_visionOS;
