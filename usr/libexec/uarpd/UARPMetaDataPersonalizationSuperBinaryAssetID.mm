...
- (UARPMetaDataPersonalizationSuperBinaryAssetID)initWithLength:(unint64_t)length value:(void *)value;
- (UARPMetaDataPersonalizationSuperBinaryAssetID)initWithPropertyListValue:(id)value relativeURL:(id)l;
- (id)description;
- (id)tlvValue;
@end
...
- (id)description
{
  ...
  v4 = [NSString stringWithFormat:@"<%@: %u>", tlvName, [(UARPMetaDataPersonalizationSuperBinaryAssetID *)self assetID]];
