...
- (BOOL)isEqual:(id)a3
{
  ...
  if (objc_opt_isKindOfClass())
  {
    ...
    else
    {
      ...
      {
        v23 = majorRelocalization == v20 && (v22 & 1) == minorRelocalization;
      }
    }
  }
...
- (unint64_t)hash
{
  v15 = [NSData dataWithBytes:&self[1] length:64];
  v14 = [v15 hash];
  v3 = [NSNumber numberWithDouble:self->_timestamp];
  v4 = [v3 hash];
  v5 = [NSNumber numberWithInteger:self->_trackingState];
  v6 = [v5 hash];
  v7 = [NSNumber numberWithDouble:self->_lightEstimate];
  v8 = [v7 hash];
  v9 = [NSNumber numberWithBool:self->_majorRelocalization];
  v10 = [v9 hash];
  v11 = [NSNumber numberWithBool:self->_minorRelocalization];
  v12 = v10 ^ [v11 hash];
