...
- (NIFindingConfiguration)initWithCoder:(id)a3
{
  ...
  v5 = [(NIConfiguration *)&v26 initWithCoder:v4];
  if (v5)
  {
    ...
    if (!v9 || (objc_opt_class(), (objc_opt_isKindOfClass())) && (v10 = [v4 decodeIntegerForKey:@"preferredUpdateRate"], +[NIInternalUtils isIntValidNearbyObjectUpdateRate:](NIInternalUtils, "isIntValidNearbyObjectUpdateRate:", v10)) && (v24 = objc_msgSend(v4, "decodeIntegerForKey:", @"preferredDiscoveryPriority"), +[NIInternalUtils isIntValidNearbyObjectDiscoveryPriority:](NIInternalUtils, "isIntValidNearbyObjectDiscoveryPriority:", v24)))
    {
      v23 = [v4 decodeBoolForKey:@"cameraAssistanceEnabled"];
      v22 = [v4 decodeBoolForKey:@"cameraAssistanceInClientProcess"];
      v28 = objc_opt_class();
      ...
      v14 = [v4 decodeDictionaryWithKeysOfClasses:v25 objectsOfClasses:v13 forKey:@"debugParameters"];
      v15 = [v4 decodeIntegerForKey:@"discoveryTokenVariant"];
      v5->_isFinder = v6;
      v5->_isObserver = v7;
      if (v8 == 1)
      {
        v16 = v15;
        v5->_configType = 1;
        v17 = [v4 decodeIntegerForKey:@"requestedMeasurementQuality"];
        v18 = [v4 decodeObjectForKey:@"monitoredRegions"];
...
- (id)descriptionInternal
{
  ...
  v6 = [(NIDiscoveryToken *)self->_specifiedToken descriptionInternal];
  ...
  discoveryTokenVariant = self->_discoveryTokenVariant;
  v10 = [NSString stringWithFormat:@"<finder: %d [observer %d], cfg-type: %d, ses-token: %@, rate: %s, disc-prio: %s, camera: %d [client %d], debug-params: %@, disc-token-var: %d>, requested-meas-qual: %d", isFinder, isObserver, configType_low, v6, v7, v8, self->_cameraAssistanceEnabled, self->_cameraAssistanceInClientProcess, self->_debugParameters, discoveryTokenVariant, self->_requestedMeasurementQuality];
