...
+ (id)memoryMapModelAtPath:(id)path isPrecompiled:(BOOL)precompiled modelAttributes:(id *)attributes
{
  ...
  block[1] = 3221225472;
  v43 = v59;
  block[2] = sub_10000A398;
  block[3] = &unk_1000308E8;
  block[4] = &v45;
  v44 = a2;
  dispatch_async(qword_1000364F0, block);
...
LABEL_22:
  ...
  if (v14)
  {
    ...
    *attributes = ANECCreateModelDictionary();
    ...
    v40[3] = &unk_100030930;
    v40[4] = &v45;
    dispatch_async(qword_1000364F0, v40);
    v19 = v15;
  }
...
LABEL_17:
  ...
  if (v10)
  {
    ...
    v32[3] = &unk_100030930;
    v32[4] = &v37;
    dispatch_async(qword_1000364F0, v32);
    v11 = v10;
  }
...
LABEL_12:
  ...
  else if (os_log_type_enabled(qword_1000364F8, OS_LOG_TYPE_ERROR))
  {
    v8 = v7;
    v9 = NSStringFromSelector(a2);
    v12 = *__error();
  ...
  if (v10)
  {
    ...
    if (level)
    {
      ...
      if (v17)
      {
          ...
          do
          {
            for (i = 0; i != v22; i = i + 1)
            {
              ...
              if (unsignedIntegerValue)
              {
                ...
                v33 = [v27 objectForKeyedSubscript:off_100036340];
                if (v33)
                {
        ...
        v34 = [v50 copy];
        v8 = aSelectora;
        [aSelectora setObject:v34 forKeyedSubscript:p_cache[104]];
...
+ (id)mergeModelCacheStorageInformation:(id)information with:(id)with
{
  ...
  v30 = [v19 copy];
  [v34 setObject:v30 forKeyedSubscript:off_100036340];
