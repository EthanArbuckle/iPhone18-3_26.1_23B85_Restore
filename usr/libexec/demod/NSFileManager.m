  ...
  if (v19)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        v24 = 0u;
        v25 = 0u;
        v8 = [&off_10017BBE0 countByEnumeratingWithState:&v22 objects:v32 count:16];
        if (v8)
        {
          v9 = v8;
          v10 = *v23;
          do
          {
            ...
            while (v9 != v11);
            v9 = [&off_10017BBE0 countByEnumeratingWithState:&v22 objects:v32 count:16];
          }
