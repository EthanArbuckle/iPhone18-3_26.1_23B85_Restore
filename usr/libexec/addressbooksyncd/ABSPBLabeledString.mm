...
- (id)description
{
  ...
  dictionaryRepresentation = [(ABSPBLabeledString *)self dictionaryRepresentation];
...
{
  equalCopy = equal;
  if ([equalCopy isMemberOfClass:objc_opt_class()] && ((label = self->_label, !(label | equalCopy[1])) || -[NSString isEqual:](label, "isEqual:")))
  {
    value = self->_value;
