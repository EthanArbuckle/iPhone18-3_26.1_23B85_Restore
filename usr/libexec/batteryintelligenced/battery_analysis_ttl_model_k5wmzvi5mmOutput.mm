...
- (battery_analysis_ttl_model_k5wmzvi5mmOutput)initWithTtl_prediction:(id)ttl_prediction;
...
- (id)featureValueForName:(id)name
{
  ...
  {
    ttl_prediction = [(battery_analysis_ttl_model_k5wmzvi5mmOutput *)self ttl_prediction];
