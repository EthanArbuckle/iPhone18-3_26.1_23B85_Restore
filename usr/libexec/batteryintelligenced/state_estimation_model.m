...
- (id)predictionFromFeatures:(id)a3 error:(id *)a4
{
  ...
  v8 = [(state_estimation_model *)self predictionFromFeatures:v6 options:v7 error:a4];
...
- (id)predictionFromFeatures:(id)a3 options:(id)a4 error:(id *)a5
{
  v8 = a4;
  v9 = a3;
  v10 = [(state_estimation_model *)self model];
...
- (void)predictionFromFeatures:(id)a3 completionHandler:(id)a4
{
  v6 = a4;
  v7 = a3;
  v8 = [(state_estimation_model *)self model];
...
- (void)predictionFromFeatures:(id)a3 options:(id)a4 completionHandler:(id)a5
{
  ...
  v9 = a4;
  v10 = a3;
  v11 = [(state_estimation_model *)self model];
...
- (id)predictionFromDaily_history_input:(id)a3 usage_history_input:(id)a4 error:(id *)a5
{
  v8 = a4;
  v9 = a3;
  v10 = [[state_estimation_modelInput alloc] initWithDaily_history_input:v9 usage_history_input:v8];

  v11 = [(state_estimation_model *)self predictionFromFeatures:v10 error:a5];
