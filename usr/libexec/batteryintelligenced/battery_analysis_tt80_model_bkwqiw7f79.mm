...
- (battery_analysis_tt80_model_bkwqiw7f79)initWithConfiguration:(id)configuration error:(id *)error;
- (battery_analysis_tt80_model_bkwqiw7f79)initWithContentsOfURL:(id)l configuration:(id)configuration error:(id *)error;
- (battery_analysis_tt80_model_bkwqiw7f79)initWithContentsOfURL:(id)l error:(id *)error;
- (battery_analysis_tt80_model_bkwqiw7f79)initWithMLModel:(id)model;
...
- (battery_analysis_tt80_model_bkwqiw7f79)init
{
  ...
  v4 = [(battery_analysis_tt80_model_bkwqiw7f79 *)self initWithContentsOfURL:uRLOfModelInThisBundle error:0];
...
- (battery_analysis_tt80_model_bkwqiw7f79)initWithConfiguration:(id)configuration error:(id *)error
{
  ...
  uRLOfModelInThisBundle = [objc_opt_class() URLOfModelInThisBundle];
  v8 = [(battery_analysis_tt80_model_bkwqiw7f79 *)self initWithContentsOfURL:uRLOfModelInThisBundle configuration:configurationCopy error:error];
...
- (id)predictionFromFeatures:(id)features error:(id *)error
{
  ...
  v8 = [(battery_analysis_tt80_model_bkwqiw7f79 *)self predictionFromFeatures:featuresCopy options:v7 error:error];
...
- (id)predictionFromFeatures:(id)features options:(id)options error:(id *)error
{
  optionsCopy = options;
  featuresCopy = features;
  model = [(battery_analysis_tt80_model_bkwqiw7f79 *)self model];
  ...
  if (v11)
  {
    ...
    v15 = [(battery_analysis_tt80_model_bkwqiw7f79Output *)v12 initWithTt80_prediction:multiArrayValue];
  }
...
{
  input_1Copy = input_1;
  v7 = [[battery_analysis_tt80_model_bkwqiw7f79Input alloc] initWithInput_1:input_1Copy];

  v8 = [(battery_analysis_tt80_model_bkwqiw7f79 *)self predictionFromFeatures:v7 error:error];
  ...
  if (v12)
  {
    ...
    if ([v12 count] >= 1)
    {
      ...
      do
      {
        ...
        v19 = [(battery_analysis_tt80_model_bkwqiw7f79Output *)v16 initWithTt80_prediction:multiArrayValue];
