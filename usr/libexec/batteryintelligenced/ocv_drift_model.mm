...
- (id)predictionFromFeatures:(id)a3 error:(id *)a4
{
  ...
  v8 = [(ocv_drift_model *)self predictionFromFeatures:v6 options:v7 error:a4];
...
- (id)predictionFromFeatures:(id)a3 options:(id)a4 error:(id *)a5
{
  v8 = a4;
  v9 = a3;
  v10 = [(ocv_drift_model *)self model];
...
- (void)predictionFromFeatures:(id)a3 options:(id)a4 completionHandler:(id)a5
{
  ...
  v9 = a4;
  v10 = a3;
  v11 = [(ocv_drift_model *)self model];
...
{
  v6 = a3;
  v7 = [[ocv_drift_modelInput alloc] initWithInput:v6];

  v8 = [(ocv_drift_model *)self predictionFromFeatures:v7 error:a4];
