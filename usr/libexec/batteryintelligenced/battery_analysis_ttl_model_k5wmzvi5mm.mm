...
- (battery_analysis_ttl_model_k5wmzvi5mm)initWithConfiguration:(id)a3 error:(id *)a4;
- (battery_analysis_ttl_model_k5wmzvi5mm)initWithContentsOfURL:(id)a3 configuration:(id)a4 error:(id *)a5;
- (battery_analysis_ttl_model_k5wmzvi5mm)initWithContentsOfURL:(id)a3 error:(id *)a4;
- (battery_analysis_ttl_model_k5wmzvi5mm)initWithMLModel:(id)a3;
...
- (battery_analysis_ttl_model_k5wmzvi5mm)init
{
  ...
  v4 = [(battery_analysis_ttl_model_k5wmzvi5mm *)self initWithContentsOfURL:v3 error:0];
...
- (battery_analysis_ttl_model_k5wmzvi5mm)initWithConfiguration:(id)a3 error:(id *)a4
{
  ...
  v8 = [(battery_analysis_ttl_model_k5wmzvi5mm *)self initWithContentsOfURL:v7 configuration:v6 error:a4];
...
- (id)predictionFromFeatures:(id)a3 error:(id *)a4
{
  ...
  v8 = [(battery_analysis_ttl_model_k5wmzvi5mm *)self predictionFromFeatures:v6 options:v7 error:a4];
...
- (id)predictionFromFeatures:(id)a3 options:(id)a4 error:(id *)a5
{
  v8 = a4;
  v9 = a3;
  v10 = [(battery_analysis_ttl_model_k5wmzvi5mm *)self model];
  ...
  if (v11)
  {
    ...
    v15 = [(battery_analysis_ttl_model_k5wmzvi5mmOutput *)v12 initWithTtl_prediction:v14];
  }
...
- (void)predictionFromFeatures:(id)a3 completionHandler:(id)a4
{
  v6 = a4;
  v7 = a3;
  v8 = [(battery_analysis_ttl_model_k5wmzvi5mm *)self model];
...
- (void)predictionFromFeatures:(id)a3 options:(id)a4 completionHandler:(id)a5
{
  ...
  v9 = a4;
  v10 = a3;
  v11 = [(battery_analysis_ttl_model_k5wmzvi5mm *)self model];
...
{
  v6 = a3;
  v7 = [[battery_analysis_ttl_model_k5wmzvi5mmInput alloc] initWithInput_1:v6];

  v8 = [(battery_analysis_ttl_model_k5wmzvi5mm *)self predictionFromFeatures:v7 error:a4];
  ...
  if (v12)
  {
    ...
    if ([v12 count] >= 1)
    {
      ...
      do
      {
        ...
        v19 = [(battery_analysis_ttl_model_k5wmzvi5mmOutput *)v16 initWithTtl_prediction:v18];
