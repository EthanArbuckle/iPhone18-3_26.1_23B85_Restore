...
- (void)cancelProvisionWithReply:(id)reply;
- (void)checkStatusWithReply:(id)reply;
- (void)provisionCardWithParameters:(id)parameters delegate:(id)delegate reply:(id)reply;
@end
...
- (void)provisionCardWithParameters:(id)parameters delegate:(id)delegate reply:(id)reply
{
  ...
  *(v9 + 16) = v8;
  ...
  selfCopy = self;
  v12(parametersCopy, delegate, sub_10018A9C0, v9, v10, v11);
