...
{
  v2 = self;
  v3 = [(REMCDSavedReminder *)v2 template];
  if (v3)
  {
    v4 = v3;
...
- (BOOL)isConnectedToAccountObject:(id)a3
{
  v4 = a3;
  v5 = self;
  LOBYTE(self) = REMCDSavedReminder.isConnected(toAccountObject:)(v4);
...
+ (id)existingCloudObjectForRecordID:(id)a3 accountID:(id)a4 context:(id)a5
{
  ...
  v10 = a3;
  v11 = a5;
  v12 = static REMCDSavedReminder.existingCloudObject(for:accountID:managedObjectContext:)(v10, v7, v9, v11);
...
+ (id)newCloudObjectForRecord:(id)a3 account:(id)a4 context:(id)a5
{
  ...
  v9 = a4;
  v10 = a5;
  v11 = static REMCDSavedReminder.newCloudObject(for:account:managedObjectContext:)(v8, v9, v10);
...
- (void)mergeDataFromRecord:(id)a3 accountID:(id)a4
{
  ...
  v11._object = v8;
  REMCDSavedReminder.mergeData(from:accountID:)(v9, v11);
}
...
{
  v2 = self;
  v3 = [(REMCDSavedReminder *)v2 attachments];
  if (v3)
  {
    v4 = v3;
