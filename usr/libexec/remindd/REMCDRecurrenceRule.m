...
- (int64_t)parentEffectiveMinimumSupportedVersion
{
  ...
  if (v3)
  {
    v4 = [(REMCDRecurrenceRule *)self reminder];
...
+ (id)existingCloudObjectForRecordID:(id)a3 accountID:(id)a4 context:(id)a5
{
  ...
  v10 = a3;
  v11 = a5;
  v12 = static REMCDRecurrenceRule.existingCloudObject(for:accountID:managedObjectContext:)(v10, v7, v9, v11);
...
+ (id)newCloudObjectForRecord:(id)a3 account:(id)a4 context:(id)a5
{
  ...
  v9 = a4;
  v10 = a5;
  v11 = static REMCDRecurrenceRule.newCloudObject(for:account:managedObjectContext:)(v8, v9, v10);
...
- (void)mergeDataFromRecord:(id)a3 accountID:(id)a4
{
  ...
  v11._object = v8;
  REMCDRecurrenceRule.mergeData(from:accountID:)(v9, v11);
}
...
- (id)parentCloudObject
{
  v2 = [(REMCDRecurrenceRule *)self reminder];
