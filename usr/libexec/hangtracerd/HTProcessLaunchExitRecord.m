...
+ (id)getProcessExitsAndLaunchesDuringHang:(unint64_t)a3 endTime:(unint64_t)a4
{
  ...
  {
    *buf = 134218240;
    v61 = sub_1000024F8(a3);
    v62 = 2048;
    v63 = sub_1000024F8(a4);
  ...
  if ([qword_100067898 count])
  {
    ...
    do
    {
      ...
      v13 = [v9 + 32 sharedPrefs];
      v14 = sub_100029534([v13 runloopHangTimeoutDurationMSec] + 30000);
      ...
      if (v14 >= v12)
      {
        ...
        v23 = [p_vtable[275] dateFormatter];
        v53 = sub_10001AF68([v11 spawnTimestamp], v47, v46);
        v54 = v23;
        v52 = [v23 stringFromDate:?];
        v75[2] = v52;
        v74[3] = @"exitTimestamp";
        v24 = [p_vtable[275] dateFormatter];
        v50 = sub_10001AF68([v11 exitTimestamp], v47, v46);
        v51 = v24;
        ...
        if (v25 <= a3)
        {
          [v26 stringWithFormat:@"-%.3lfs", sub_1000294E0(a3 - v27)];
        }

        else
        {
          [v26 stringWithFormat:@"%.3lfs", sub_1000294E0(v27 - a3)];
        }
        v28 = ;
        v75[4] = v28;
        ...
        if (v29 <= a3)
        {
          [v30 stringWithFormat:@"-%.3lfs", sub_1000294E0(a3 - v31)];
        }

        else
        {
          [v30 stringWithFormat:@"%.3lfs", sub_1000294E0(v31 - a3)];
        }
        v32 = ;
        v33 = a3;
        v75[5] = v32;
        v74[6] = @"processUptime";
        v34 = [v10[270] stringWithFormat:@"%.3lfs", sub_1000294E0(objc_msgSend(v11, "exitTimestamp") - objc_msgSend(v11, "spawnTimestamp"))];
        v75[6] = v34;
        v74[7] = @"exitReasonCode";
        v35 = sub_1000291B0([v11 exitReasonNamespace], objc_msgSend(v11, "exitReasonCode"));
        v75[7] = v35;
        v74[8] = @"exitReasonNamespace";
        v36 = sub_100027C44([v11 exitReasonNamespace]);
        v75[8] = v36;
      ...
      else
      {
        ...
        {
          v56 = [v9 + 32 sharedPrefs];
          v16 = sub_100029534([v56 runloopHangTimeoutDurationMSec] + 30000);
          v17 = [v11 processName];
          v18 = [v11 pid];
          v19 = a3;
