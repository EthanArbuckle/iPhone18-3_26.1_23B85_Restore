...
- (CLTrackingAvoidanceAISFetchRecord)initWithUUID:(id)d deviceType:(unint64_t)type;
- (void)dealloc;
@end
...
- (CLTrackingAvoidanceAISFetchRecord)initWithUUID:(id)d deviceType:(unint64_t)type
{
  ...
  if (v6)
  {
    [(CLTrackingAvoidanceAISFetchRecord *)v6 setIdentifier:d];
    ...
    if (v8)
    {
      v10 = [v9 initWithDeviceUUID:d deviceType:type productData:0 manufacturerName:0 modelName:0 firmwareVersion:0 accessoryCategory:0 accessoryCapabilities:0 serialNumber:0 protocolImplementation:0 networkID:0 batteryType:0 batteryLevel:0];
    }

    else
    {
      v10 = [v9 initWithDeviceUUID:d deviceType:type productData:0 manufacturerName:0 modelName:0 firmwareVersion:0 accessoryCategory:0 accessoryCapabilities:0];
    }
