...
- (void)copyTo:(id)a3
{
  *(a3 + 4) = self->_activityType;
  has = self->_has;
  if ((*&has & 0x100) != 0)
  {
    *(a3 + 12) = self->_nCatherine;
    *(a3 + 26) |= 0x100u;
    has = self->_has;
    if ((*&has & 0x10000) == 0)
    {
...
LABEL_28:
  *(a3 + 19) = self->_nVeryHighCatherine;
  *(a3 + 26) |= 0x8000u;
  has = self->_has;
  if ((*&has & 0x400) == 0)
  {
...
LABEL_30:
  *(a3 + 16) = self->_nInterpolatedCatherine;
  *(a3 + 26) |= 0x1000u;
  has = self->_has;
  if ((*&has & 0x4000) == 0)
  {
...
LABEL_31:
  *(a3 + 18) = self->_nSampleAndHoldCatherine;
  *(a3 + 26) |= 0x4000u;
  has = self->_has;
  if ((*&has & 0x80) == 0)
  {
...
LABEL_32:
  *(a3 + 11) = LODWORD(self->_minGoodCatherine);
  *(a3 + 26) |= 0x80u;
  has = self->_has;
  if ((*&has & 0x10) == 0)
  {
...
LABEL_33:
  *(a3 + 8) = LODWORD(self->_maxGoodCatherine);
  *(a3 + 26) |= 0x10u;
  has = self->_has;
  if ((*&has & 0x20) == 0)
  {
...
LABEL_34:
  *(a3 + 9) = LODWORD(self->_meanCatherine);
  *(a3 + 26) |= 0x20u;
  has = self->_has;
  if ((*&has & 0x40) == 0)
  {
...
LABEL_35:
  *(a3 + 10) = LODWORD(self->_meanGoodCatherine);
  *(a3 + 26) |= 0x40u;
  has = self->_has;
  if ((*&has & 2) == 0)
  {
...
LABEL_36:
  *(a3 + 5) = LODWORD(self->_firstCatherine);
  *(a3 + 26) |= 2u;
  has = self->_has;
  if ((*&has & 4) == 0)
  {
...
LABEL_37:
  *(a3 + 6) = LODWORD(self->_firstCatherineStartTime);
  *(a3 + 26) |= 4u;
  has = self->_has;
  if ((*&has & 8) == 0)
  {
...
LABEL_38:
  *(a3 + 7) = LODWORD(self->_longestDropout);
  *(a3 + 26) |= 8u;
  has = self->_has;
  if ((*&has & 0x100000) == 0)
  {
...
LABEL_39:
  *(a3 + 24) = LODWORD(self->_totalDropoutTime);
  *(a3 + 26) |= 0x100000u;
  has = self->_has;
  if ((*&has & 0x200) == 0)
  {
...
LABEL_43:
  *(a3 + 21) = LODWORD(self->_onsetCatherine);
  *(a3 + 26) |= 0x20000u;
  has = self->_has;
  if ((*&has & 0x200000) == 0)
  {
...
LABEL_45:
    *(a3 + 23) = LODWORD(self->_persistedMinHR);
    *(a3 + 26) |= 0x80000u;
    return;
  }

LABEL_44:
  *(a3 + 25) = LODWORD(self->_userMaxCatherine);
  *(a3 + 26) |= 0x200000u;
  if ((*&self->_has & 0x80000) != 0)
  {
    goto LABEL_45;
...
LABEL_112:
    ...
    if ((*&has & 0x100) != 0)
    {
      if ((v7 & 0x100) == 0 || self->_nCatherine != *(a3 + 12))
      {
        goto LABEL_112;
      }
    }
    ...
    if ((*&has & 0x10000) != 0)
    {
      if ((v7 & 0x10000) == 0 || self->_nVeryLowCatherine != *(a3 + 20))
      {
        goto LABEL_112;
      }
    }
    ...
    if ((*&has & 0x2000) != 0)
    {
      if ((v7 & 0x2000) == 0 || self->_nLowCatherine != *(a3 + 17))
      {
        goto LABEL_112;
      }
    }
    ...
    if ((*&has & 0x800) != 0)
    {
      if ((v7 & 0x800) == 0 || self->_nHighCatherine != *(a3 + 15))
      {
        goto LABEL_112;
      }
    }
    ...
    if ((*&has & 0x8000) != 0)
    {
      if ((v7 & 0x8000) == 0 || self->_nVeryHighCatherine != *(a3 + 19))
      {
        goto LABEL_112;
      }
    }
    ...
    if ((*&has & 0x400) != 0)
    {
      if ((v7 & 0x400) == 0 || self->_nGoodCatherine != *(a3 + 14))
      {
        goto LABEL_112;
      }
    }
    ...
    if ((*&has & 0x1000) != 0)
    {
      if ((v7 & 0x1000) == 0 || self->_nInterpolatedCatherine != *(a3 + 16))
      {
        goto LABEL_112;
      }
    }
    ...
    if ((*&has & 0x4000) != 0)
    {
      if ((v7 & 0x4000) == 0 || self->_nSampleAndHoldCatherine != *(a3 + 18))
      {
        goto LABEL_112;
      }
    }
    ...
    if ((*&has & 0x80) != 0)
    {
      if ((v7 & 0x80) == 0 || self->_minGoodCatherine != *(a3 + 11))
      {
        goto LABEL_112;
      }
    }
    ...
    if ((*&has & 0x10) != 0)
    {
      if ((v7 & 0x10) == 0 || self->_maxGoodCatherine != *(a3 + 8))
      {
        goto LABEL_112;
      }
    }
    ...
    if ((*&has & 0x20) != 0)
    {
      if ((v7 & 0x20) == 0 || self->_meanCatherine != *(a3 + 9))
      {
        goto LABEL_112;
      }
    }
    ...
    if ((*&has & 0x40) != 0)
    {
      if ((v7 & 0x40) == 0 || self->_meanGoodCatherine != *(a3 + 10))
      {
        goto LABEL_112;
      }
    }
    ...
    if ((*&has & 2) != 0)
    {
      if ((v7 & 2) == 0 || self->_firstCatherine != *(a3 + 5))
      {
        goto LABEL_112;
      }
    }
    ...
    if ((*&has & 4) != 0)
    {
      if ((v7 & 4) == 0 || self->_firstCatherineStartTime != *(a3 + 6))
      {
        goto LABEL_112;
      }
    }
    ...
    if ((*&has & 8) != 0)
    {
      if ((v7 & 8) == 0 || self->_longestDropout != *(a3 + 7))
      {
        goto LABEL_112;
      }
    }
    ...
    if ((*&has & 0x100000) != 0)
    {
      if ((v7 & 0x100000) == 0 || self->_totalDropoutTime != *(a3 + 24))
      {
        goto LABEL_112;
      }
    }
    ...
    if ((*&has & 0x200) != 0)
    {
      if ((v7 & 0x200) == 0 || self->_nDropout != *(a3 + 13))
      {
        goto LABEL_112;
      }
    }
    ...
    if (*&has)
    {
      if ((v7 & 1) == 0 || self->_startTime != *(a3 + 1))
      {
        goto LABEL_112;
      }
    }
    ...
    if ((*&has & 0x40000) != 0)
    {
      if ((v7 & 0x40000) == 0 || self->_onsetReason != *(a3 + 22))
      {
        goto LABEL_112;
      }
    }
    ...
    if ((*&has & 0x20000) != 0)
    {
      if ((v7 & 0x20000) == 0 || self->_onsetCatherine != *(a3 + 21))
      {
        goto LABEL_112;
      }
    }
    ...
    if ((*&has & 0x200000) != 0)
    {
      if ((v7 & 0x200000) == 0 || self->_userMaxCatherine != *(a3 + 25))
      {
        goto LABEL_112;
      }
    }
    ...
    if ((*&has & 0x80000) != 0)
    {
      if ((v7 & 0x80000) == 0 || self->_persistedMinHR != *(a3 + 23))
      {
        goto LABEL_112;
      }
...
- (void)mergeFrom:(id)a3
{
  self->_activityType = *(a3 + 4);
  v3 = *(a3 + 26);
  if ((v3 & 0x100) != 0)
  {
    self->_nCatherine = *(a3 + 12);
    *&self->_has |= 0x100u;
    v3 = *(a3 + 26);
    if ((v3 & 0x10000) == 0)
    {
...
LABEL_28:
  self->_nVeryHighCatherine = *(a3 + 19);
  *&self->_has |= 0x8000u;
  v3 = *(a3 + 26);
  if ((v3 & 0x400) == 0)
  {
...
LABEL_30:
  self->_nInterpolatedCatherine = *(a3 + 16);
  *&self->_has |= 0x1000u;
  v3 = *(a3 + 26);
  if ((v3 & 0x4000) == 0)
  {
...
LABEL_31:
  self->_nSampleAndHoldCatherine = *(a3 + 18);
  *&self->_has |= 0x4000u;
  v3 = *(a3 + 26);
  if ((v3 & 0x80) == 0)
  {
...
LABEL_37:
  self->_firstCatherineStartTime = *(a3 + 6);
  *&self->_has |= 4u;
  v3 = *(a3 + 26);
  if ((v3 & 8) == 0)
  {
...
LABEL_45:
    self->_persistedMinHR = *(a3 + 23);
    *&self->_has |= 0x80000u;
    return;
  }

LABEL_44:
  self->_userMaxCatherine = *(a3 + 25);
  *&self->_has |= 0x200000u;
  if ((*(a3 + 26) & 0x80000) != 0)
  {
    goto LABEL_45;
