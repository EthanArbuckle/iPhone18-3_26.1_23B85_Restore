...
- (id)xpcSafeArrayFromArray
{
  if (self)
  {
    ...
    v4 = v3;
    v5 = &archive_entry_free_ptr;
    v6 = *v39;
    v7 = &archive_entry_free_ptr;
          ...
          if (v15)
          {
            ...
            do
            {
              ...
              do
              {
                ...
                objc_opt_class();
                if (objc_opt_isKindOfClass() & 1) != 0 || (v21 = v7[334], objc_opt_class(), (objc_opt_isKindOfClass()) || (v22 = v8[370], objc_opt_class(), (objc_opt_isKindOfClass()) || (objc_opt_class(), (objc_opt_isKindOfClass()) || (objc_opt_class(), (objc_opt_isKindOfClass()))
                {
