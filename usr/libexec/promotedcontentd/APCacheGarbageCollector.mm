...
- (APCacheGarbageCollector)initWithCacheStore:(id)a3 expirationDate:(id)a4 timeSincePrevLaunch:(double)a5
{
  ...
  if (v11)
  {
    objc_storeStrong(&v11->_cacheStore, a3);
...
- (void)stop
{
  v2 = [(APCacheGarbageCollector *)self activeCleanupOperation];
  [v2 cancel];
}
...
- (void)_handleAncientItem:(id)a3
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_DEBUG))
  {
    ...
    v7 = v4;
    v8 = 2050;
    v9 = [(APCacheGarbageCollector *)self maxObjectLifeTimeDays];
...
- (void)_removeItemInBlockForKey:(id)a3
{
  v4 = a3;
  v5 = [(APCacheGarbageCollector *)self cacheStore];
  v6 = [v5 isObjectAliveForKey:v4];

  if (!v6)
  {
    v8 = [(APCacheGarbageCollector *)self cacheStore];
    v7 = [v8 objectForKey:v4];

    v9 = [v7 garbageCollect];
...
LABEL_15:
    v16 = [(APCacheGarbageCollector *)self cacheStore];
...
- (void)_reportStatisticsForDuration:(double)a3 storageInfo:(id)a4 cancelled:(BOOL)a5
{
  ...
  if (v8 && v9)
  {
    ...
    v25[2] = v14;
    v24[3] = @"TotalFiles";
    v15 = +[NSNumber numberWithUnsignedInteger:](NSNumber, "numberWithUnsignedInteger:", [v8 filesCount]);
    v25[3] = v15;
    v24[4] = @"TotalSize";
    v16 = +[NSNumber numberWithUnsignedInteger:](NSNumber, "numberWithUnsignedInteger:", [v8 totalSize]);
    v25[4] = v16;
    v24[5] = @"Fragmentation";
    *&v17 = v11;
