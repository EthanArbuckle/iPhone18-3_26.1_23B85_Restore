...
+ (id)sharedInstance;
- (void)_storeIntegrityEvent:(id)event;
- (void)start;
@end
...
- (void)start
{
  ...
  notificationRegistrar = [v3 notificationRegistrar];
  v8 = _NSConcreteStackBlock;
  v9 = 3221225472;
  v10 = sub_1003784D8;
  v11 = &unk_100480618;
  objc_copyWeak(&v12, &location);
  v5 = [notificationRegistrar registerHandlerForExternalPurposesAndAllMetricsWithClosure:&v8];
...
{
  eventCopy = event;
  environment = [eventCopy environment];

  if (!environment)
  {
    v5 = +[NSNumber numberWithInteger:](NSNumber, "numberWithInteger:", [eventCopy metric]);
    ...
    v12 = +[NSNumber numberWithInteger:](NSNumber, "numberWithInteger:", [eventCopy purpose]);
    branch = [eventCopy branch];
    v14 = [v10 addCountForDayOfYear:v11 purpose:v12 event:v5 value:0 environment:@"PROD" branch:branch];
