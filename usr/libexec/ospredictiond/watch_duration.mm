...
- (watch_duration)init;
- (watch_duration)initWithConfiguration:(id)a3 error:(id *)a4;
- (watch_duration)initWithContentsOfURL:(id)a3 configuration:(id)a4 error:(id *)a5;
- (watch_duration)initWithContentsOfURL:(id)a3 error:(id *)a4;
- (watch_duration)initWithMLModel:(id)a3;
@end
...
- (watch_duration)init
{
  ...
  v4 = [(watch_duration *)self initWithContentsOfURL:v3 error:0];
...
- (watch_duration)initWithConfiguration:(id)a3 error:(id *)a4
{
  ...
  v8 = [(watch_duration *)self initWithContentsOfURL:v7 configuration:v6 error:a4];
...
- (id)predictionFromFeatures:(id)a3 error:(id *)a4
{
  ...
  v8 = [(watch_duration *)self predictionFromFeatures:v6 options:v7 error:a4];
...
- (id)predictionFromHour:(double)a3 plugin_battery_level:(double)a4 time_from_plugin:(double)a5 med_dur_1:(double)a6 med_dur_2:(double)a7 med_dur_4:(double)a8 med_dur_8:(double)a9 med_dur_16:(double)a10 med_dur_24:(double)a11 cnt_dur_1:(double)a12 cnt_dur_2:(double)a13 cnt_dur_4:(double)a14 cnt_dur_8:(double)a15 cnt_dur_16:(double)a16 cnt_dur_24:(double)a17 std_dur_1:(double)a18 std_dur_2:(double)a19 std_dur_4:(double)a20 std_dur_8:(double)a21 std_dur_16:(double)a22 std_dur_24:(double)a23 error:(id *)a24
{
  ...
  v27 = [(watch_duration *)self predictionFromFeatures:v26 error:a24];
