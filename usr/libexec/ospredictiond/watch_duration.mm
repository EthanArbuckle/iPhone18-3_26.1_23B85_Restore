...
- (watch_duration)init;
- (watch_duration)initWithConfiguration:(id)configuration error:(id *)error;
- (watch_duration)initWithContentsOfURL:(id)l configuration:(id)configuration error:(id *)error;
- (watch_duration)initWithContentsOfURL:(id)l error:(id *)error;
- (watch_duration)initWithMLModel:(id)model;
@end

@implementation watch_duration

+ (id)URLOfModelInThisBundle
{
  v2 = [NSBundle bundleForClass:objc_opt_class()];
  v3 = [v2 pathForResource:@"watch_duration" ofType:@"mlmodelc"];
...
- (watch_duration)initWithMLModel:(id)model
{
  ...
  {
    v10.receiver = self;
    v10.super_class = watch_duration;
    v6 = [(watch_duration *)&v10 init];
    v7 = v6;
    if (v6)
    {
...
- (watch_duration)init
{
  ...
  v4 = [(watch_duration *)self initWithContentsOfURL:uRLOfModelInThisBundle error:0];
...
- (watch_duration)initWithConfiguration:(id)configuration error:(id *)error
{
  ...
  uRLOfModelInThisBundle = [objc_opt_class() URLOfModelInThisBundle];
  v8 = [(watch_duration *)self initWithContentsOfURL:uRLOfModelInThisBundle configuration:configurationCopy error:error];
...
- (watch_duration)initWithContentsOfURL:(id)l error:(id *)error
{
  ...
  if (v5)
  {
    self = [(watch_duration *)self initWithMLModel:v5];
    selfCopy = self;
  }
...
- (watch_duration)initWithContentsOfURL:(id)l configuration:(id)configuration error:(id *)error
{
  ...
  if (v6)
  {
    self = [(watch_duration *)self initWithMLModel:v6];
    selfCopy = self;
  }
...
- (id)predictionFromFeatures:(id)features error:(id *)error
{
  ...
  v8 = [(watch_duration *)self predictionFromFeatures:featuresCopy options:v7 error:error];
...
- (id)predictionFromFeatures:(id)features options:(id)options error:(id *)error
{
  optionsCopy = options;
  featuresCopy = features;
  model = [(watch_duration *)self model];
  v11 = [model predictionFromFeatures:featuresCopy options:optionsCopy error:error];

  if (v11)
  {
    v12 = [watch_durationOutput alloc];
    v13 = [v11 featureValueForName:@"duration_pred"];
    [v13 doubleValue];
    v14 = [(watch_durationOutput *)v12 initWithDuration_pred:?];
  }
  ...
  if (v12)
  {
    ...
    if ([v12 count] >= 1)
    {
      ...
      do
      {
        ...
        v16 = [watch_durationOutput alloc];
        v17 = [v15 featureValueForName:@"duration_pred"];
        [v17 doubleValue];
        v18 = [(watch_durationOutput *)v16 initWithDuration_pred:?];
