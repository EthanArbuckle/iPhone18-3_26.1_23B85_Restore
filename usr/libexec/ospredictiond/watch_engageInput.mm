@interface watch_engageInput
- (id)featureValueForName:(id)name;
- (watch_engageInput)initWithHour:(double)hour plugin_battery_level:(double)plugin_battery_level time_from_plugin:(double)time_from_plugin med_dur_1:(double)med_dur_1 med_dur_2:(double)med_dur_2 med_dur_4:(double)med_dur_4 med_dur_8:(double)med_dur_8 med_dur_16:(double)self0 med_dur_24:(double)self1 cnt_dur_1:(double)self2 cnt_dur_2:(double)self3 cnt_dur_4:(double)self4 cnt_dur_8:(double)self5 cnt_dur_16:(double)self6 cnt_dur_24:(double)self7 std_dur_1:(double)self8 std_dur_2:(double)self9 std_dur_4:(double)std_dur_4 std_dur_8:(double)std_dur_8 std_dur_16:(double)std_dur_16 std_dur_24:(double)std_dur_24;
@end

@implementation watch_engageInput

- (watch_engageInput)initWithHour:(double)hour plugin_battery_level:(double)plugin_battery_level time_from_plugin:(double)time_from_plugin med_dur_1:(double)med_dur_1 med_dur_2:(double)med_dur_2 med_dur_4:(double)med_dur_4 med_dur_8:(double)med_dur_8 med_dur_16:(double)self0 med_dur_24:(double)self1 cnt_dur_1:(double)self2 cnt_dur_2:(double)self3 cnt_dur_4:(double)self4 cnt_dur_8:(double)self5 cnt_dur_16:(double)self6 cnt_dur_24:(double)self7 std_dur_1:(double)self8 std_dur_2:(double)self9 std_dur_4:(double)std_dur_4 std_dur_8:(double)std_dur_8 std_dur_16:(double)std_dur_16 std_dur_24:(double)std_dur_24
{
  v32.receiver = self;
  v32.super_class = watch_engageInput;
  result = [(watch_engageInput *)&v32 init];
  if (result)
  {
    result->_hour = hour;
...
LABEL_34:
  ...
  {
    [(watch_engageInput *)self plugin_battery_level];
    goto LABEL_34;
  }

  if ([nameCopy isEqualToString:@"time_from_plugin"])
  {
    [(watch_engageInput *)self time_from_plugin];
    goto LABEL_34;
  }
  ...
  {
    [(watch_engageInput *)self med_dur];
    goto LABEL_34;
  }
  ...
  {
    [(watch_engageInput *)self cnt_dur];
    goto LABEL_34;
  }
  ...
  {
    [(watch_engageInput *)self std_dur];
    goto LABEL_34;
  }
