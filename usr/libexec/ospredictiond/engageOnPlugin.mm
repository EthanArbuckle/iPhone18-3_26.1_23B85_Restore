...
- (engageOnPlugin)init;
- (engageOnPlugin)initWithConfiguration:(id)configuration error:(id *)error;
- (engageOnPlugin)initWithContentsOfURL:(id)l configuration:(id)configuration error:(id *)error;
- (engageOnPlugin)initWithContentsOfURL:(id)l error:(id *)error;
- (engageOnPlugin)initWithMLModel:(id)model;
...
- (engageOnPlugin)initWithMLModel:(id)model
{
  ...
  {
    v10.receiver = self;
    v10.super_class = engageOnPlugin;
...
- (engageOnPlugin)init
{
  ...
  v4 = [(engageOnPlugin *)self initWithContentsOfURL:uRLOfModelInThisBundle error:0];
...
- (engageOnPlugin)initWithConfiguration:(id)configuration error:(id *)error
{
  ...
  uRLOfModelInThisBundle = [objc_opt_class() URLOfModelInThisBundle];
  v8 = [(engageOnPlugin *)self initWithContentsOfURL:uRLOfModelInThisBundle configuration:configurationCopy error:error];
...
- (id)predictionFromFeatures:(id)features error:(id *)error
{
  ...
  v8 = [(engageOnPlugin *)self predictionFromFeatures:featuresCopy options:v7 error:error];
...
- (id)predictionFromFeatures:(id)features options:(id)options error:(id *)error
{
  optionsCopy = options;
  featuresCopy = features;
  model = [(engageOnPlugin *)self model];
  ...
  if (v11)
  {
    ...
    v17 = [(engageOnPluginOutput *)v12 initWithEngage:int64Value classProbability:dictionaryValue];
  }
  ...
  if (v12)
  {
    ...
    if ([v12 count] >= 1)
    {
      ...
      do
      {
        ...
        v21 = [(engageOnPluginOutput *)v16 initWithEngage:int64Value classProbability:dictionaryValue];
