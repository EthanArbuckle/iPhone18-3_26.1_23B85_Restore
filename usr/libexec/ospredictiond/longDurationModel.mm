...
- (longDurationModel)initWithConfiguration:(id)configuration error:(id *)error;
- (longDurationModel)initWithContentsOfURL:(id)l configuration:(id)configuration error:(id *)error;
- (longDurationModel)initWithContentsOfURL:(id)l error:(id *)error;
- (longDurationModel)initWithMLModel:(id)model;
...
- (longDurationModel)initWithMLModel:(id)model
{
  ...
  {
    v10.receiver = self;
    v10.super_class = longDurationModel;
...
- (longDurationModel)init
{
  ...
  v4 = [(longDurationModel *)self initWithContentsOfURL:uRLOfModelInThisBundle error:0];
...
- (longDurationModel)initWithConfiguration:(id)configuration error:(id *)error
{
  ...
  uRLOfModelInThisBundle = [objc_opt_class() URLOfModelInThisBundle];
  v8 = [(longDurationModel *)self initWithContentsOfURL:uRLOfModelInThisBundle configuration:configurationCopy error:error];
...
- (id)predictionFromFeatures:(id)features error:(id *)error
{
  ...
  v8 = [(longDurationModel *)self predictionFromFeatures:featuresCopy options:v7 error:error];
...
- (id)predictionFromFeatures:(id)features options:(id)options error:(id *)error
{
  optionsCopy = options;
  featuresCopy = features;
  model = [(longDurationModel *)self model];
  ...
  if (v11)
  {
    ...
    [v13 doubleValue];
    v14 = [(longDurationModelOutput *)v12 initWithDuration_pred:?];
  }
  ...
  if (v12)
  {
    ...
    if ([v12 count] >= 1)
    {
      ...
      do
      {
        ...
        [v17 doubleValue];
        v18 = [(longDurationModelOutput *)v16 initWithDuration_pred:?];
