...
{
  v7.receiver = self;
  v7.super_class = NEKPBDuplicateCalendar;
  v3 = [(NEKPBDuplicateCalendar *)&v7 description];
  dictionaryRepresentation = [(NEKPBDuplicateCalendar *)self dictionaryRepresentation];
...
- (void)mergeFrom:(id)from
{
  ...
  if (fromCopy[2])
  {
    [(NEKPBDuplicateCalendar *)self setName:?];
    fromCopy = v5;
  }

  if (fromCopy[1])
  {
    [(NEKPBDuplicateCalendar *)self setExternalId:?];
    fromCopy = v5;
  }
}
