...
- (void)download:(id)a3
{
  ...
  if ([(MIBUSUController *)v6 cancelled])
  {
    ...
    [(MIBUSUController *)v6 _softwareUpdateCompleteWithError:v20[5]];
  }

  else
  {
    [v5 setDownloadOnly:1];
    v11 = [[SUDownloadOptions alloc] initWithMetadata:v5 andDescriptor:v4];
...
- (void)terminate
{
  ...
  if (![(MIBUSUController *)v2 cancelled])
  {
    ...
    if (v2->_phase < 0x103)
    {
      v4 = [(MIBUSUController *)v2 manager];
    ...
    v8 = [(MIBUSUController *)v2 wifiHelper];
    [v8 stopMonitor];
...
- (void)client:(id)a3 downloadDidFinish:(id)a4
{
  ...
  self->_phase = 1024;
  v9 = [(MIBUSUController *)self delegate];
  v10 = [v7 descriptor];
...
- (void)client:(id)a3 downloadDidFail:(id)a4 withError:(id)a5
{
  ...
  v17 = 0;
  sub_100016130(&v17, 67108867, v10, @"Failed SU download", v11, v12, v13, v14, v16);
  v15 = v17;
...
- (void)client:(id)a3 downloadProgressDidChange:(id)a4
{
  ...
  v18 = [(MIBUSUController *)self phaseTranslationTable];
  v19 = [v18 objectForKey:v7];
...
- (void)client:(id)a3 installDidStart:(id)a4
{
  ...
  v11 = [(MIBUSUController *)self delegate];
...
- (void)client:(id)a3 installDidFail:(id)a4 withError:(id)a5
{
  ...
  v17 = 0;
  sub_100016130(&v17, 67108868, v10, @"Failed SU install", v11, v12, v13, v14, v16);
  v15 = v17;
  [(MIBUSUController *)self _softwareUpdateCompleteWithError:v15];
}
...
- (void)_proccessScanResults:(id)a3 andError:(id)a4
{
  ...
  if (v6)
  {
    v18 = [(MIBUSUController *)self delegate];
    [v18 scanDidFinishWithResults:v6];

    goto LABEL_15;
  }

  sub_100016130(&v27, 67108866, v7, @"No updates found", v10, v11, v12, v13, 0);
  v14 = v27;
  if (qword_1000B84A8[0] != -1)
  {
    sub_10005B4F8();
...
LABEL_4:
  ...
  else
  {
    ...
    {
      v16 = v15;
      v17 = [(MIBUSUController *)self retryCount];
      *buf = 134218240;
      v30 = v17;
      v31 = 1024;
      v32 = 3;
...
- (void)_initSUClient
{
  ...
  if (!v3)
  {
    ...
    v6 = [(MIBUSUController *)self suDelegateQueue];
    v7 = [v5 initWithDelegate:self queue:v6 clientType:0];
...
- (void)_purgeSoftwareUpdate
{
  ...
  v6 = [(MIBUSUController *)self manager];
  ...
  v8 = v4;
  v15 = v8;
  [v6 cancelDownloadWithOptions:v7 withResult:v12];
