...
- (id)dmf_installRequestWithContext:(id)context error:(id *)error
{
  ...
  v7 = [(CEMSystemBasicWebContentFilterDeclaration *)self dmf_installSynthesizedProfileRequestWithAssetProviders:assetProvidersByPayloadIdentifier error:error];
