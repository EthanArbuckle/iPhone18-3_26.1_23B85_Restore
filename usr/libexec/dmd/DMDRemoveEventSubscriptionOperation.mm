...
{
  v2.receiver = self;
  v2.super_class = DMDRemoveEventSubscriptionOperation;
  [(DMDRemoveEventSubscriptionOperation *)&v2 waitUntilFinished];
}
...
+ (BOOL)validateRequest:(id)request error:(id *)error
{
  requestCopy = request;
  v13.receiver = self;
  v13.super_class = &OBJC_METACLASS___DMDRemoveEventSubscriptionOperation;
...
- (void)runWithRequest:(id)request
{
  ...
  v6[3] = &unk_1000CEE68;
  v6[4] = self;
  [configurationEngine handleRemoveSubscriptionRequest:requestCopy completionHandler:v6];
}
