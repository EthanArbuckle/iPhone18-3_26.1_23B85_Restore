...
- (void)encodeWithCoder:(id)a3
{
  ...
  [v4 encodeBool:-[MIUninstallRecord isLastReference](self forKey:{"isLastReference", v5.receiver, v5.super_class), @"isLastReference"}];
  [v4 encodeBool:-[MIUninstallRecord isLinked](self forKey:{"isLinked"), @"isLinked"}];
}
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v4 = [(MIUninstallRecord *)&v6 copyWithZone:a3];
...
- (id)legacyDictionary
{
  ...
  v4 = [(MIUninstallRecord *)&v9 legacyDictionary];
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ([(MIUninstallRecord *)&v10 isEqual:v4])
  {
    ...
    {
      v5 = v4;
      v6 = [(MIUninstallRecord *)self isLinked];
      if (v6 == [v5 isLinked])
      {
        v8 = [(MIUninstallRecord *)self isLastReference];
...
- (unint64_t)hash
{
  v3 = [(MIUninstallRecord *)self isLinked];
  v4 = [(MIUninstallRecord *)self isLastReference];
  v5 = 2;
  if (!v4)
  {
    v5 = 0;
...
{
  v3 = objc_opt_new();
  v4 = [(MIUninstallRecord *)self bundleIdentifier];
    ...
    if (v6)
    {
      ...
      do
      {
        for (i = 0; i != v7; i = i + 1)
        {
          ...
          v10 = [*(*(&v13 + 1) + 8 * i) ICLUninstallRecord];
          [v4 addObject:v10];
        }
