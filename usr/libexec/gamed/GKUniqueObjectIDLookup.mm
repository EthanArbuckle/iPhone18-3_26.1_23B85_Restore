...
- (GKUniqueObjectIDLookup)initWithObjectClass:(Class)class context:(id)context;
- (GKUniqueObjectIDLookup)initWithObjectClass:(Class)class context:(id)context predicate:(id)predicate;
- (id)insertObjectsForServerRepresentations:(id)representations context:(id)context newObject:(id)object;
- (id)uniqueObjectsForKeys:(id)keys context:(id)context newObject:(id)object;
- (void)_populateWithContext:(id)context;
- (void)dealloc;
@end
...
- (GKUniqueObjectIDLookup)initWithObjectClass:(Class)class context:(id)context
{
  ...
  v8 = [(GKUniqueObjectIDLookup *)self initWithObjectClass:class context:contextCopy predicate:v7];
...
- (GKUniqueObjectIDLookup)initWithObjectClass:(Class)class context:(id)context predicate:(id)predicate
{
  ...
  uniqueAttributeName = [(objc_class *)class uniqueAttributeName];
  ...
  {
    v14 = [NSString stringWithFormat:@"Class %@ must define a attribute for uniquing.", class];
    ...
    v17 = +[NSString stringWithFormat:](NSString, "stringWithFormat:", @"%@ (uniqueKey != nil)\n[%s (%s:%d)]", v14, "-[GKUniqueObjectIDLookup initWithObjectClass:context:predicate:]", [lastPathComponent UTF8String], 58);
...
LABEL_3:
  ...
  if (v9)
  {
    v10 = [NSString stringWithFormat:@"%s.%@", class_getName(class), uniqueAttributeName];
    v11 = [[GKThreadsafeDictionary alloc] initWithName:v10];
    lookup = v9->_lookup;
    v9->_lookup = v11;

    objc_storeStrong(&v9->_predicate, predicateCopy);
...
- (void)_populateWithContext:(id)context
{
  ...
  if (dispatch_queue_get_specific(v5, @"com.apple.gamed.cachequeue") != @"com.apple.gamed.cachequeue")
  {
    ...
    v10 = +[NSString stringWithFormat:](NSString, "stringWithFormat:", @"%@ (_queueContext == (__bridge const void * _Nonnull)GKCacheQueueID)\n[%s (%s:%d)]", v7, "-[GKUniqueObjectIDLookup _populateWithContext:]", [lastPathComponent UTF8String], 80);

    [NSException raise:@"GameKit Exception" format:@"%@", v10];
  }

  uniqueAttributeName = [(objc_class *)self->_objectClass uniqueAttributeName];
  v12 = [(objc_class *)self->_objectClass fetchRequestForContext:contextCopy];
  ...
  if (!lookup)
  {
    ...
    v20 = +[NSString stringWithFormat:](NSString, "stringWithFormat:", @"%@ (self->_lookup != nil)\n[%s (%s:%d)]", v17, "-[GKUniqueObjectIDLookup _populateWithContext:]", [lastPathComponent2 UTF8String], 95);
  ...
  v25 = contextCopy;
  v26 = v12;
  v27 = uniqueAttributeName;
  selfCopy = self;
  v21 = uniqueAttributeName;
  v22 = v12;
  v23 = contextCopy;
...
- (id)uniqueObjectsForKeys:(id)keys context:(id)context newObject:(id)object
{
  ...
  {
    [(GKUniqueObjectIDLookup *)self _populateWithContext:contextCopy];
  }
  ...
  v26 = [NSMutableSet setWithArray:allValues];
  ...
  if ([v29 count])
  {
    ...
    entityName = [(objc_class *)self->_objectClass entityName];
    v33 = [v31 initWithEntityName:entityName];

    v34 = [NSPredicate predicateWithFormat:@"self IN %@", v29];
    [v33 setPredicate:v34];

    relationshipKeyPathsForPrefetch = [(objc_class *)self->_objectClass relationshipKeyPathsForPrefetch];
    [v33 setRelationshipKeyPathsForPrefetching:relationshipKeyPathsForPrefetch];
  ...
  if ([v39 count])
  {
    ...
    {
      v41 = [v39 _gkMapDictionaryWithKeyPath:uniqueAttributeName valueKeyPath:@"objectID"];
      if (v41)
      {
        v42 = self->_lookup;
...
- (id)insertObjectsForServerRepresentations:(id)representations context:(id)context newObject:(id)object
{
  ...
  if (dispatch_queue_get_specific(v11, @"com.apple.gamed.cachequeue") != @"com.apple.gamed.cachequeue")
  {
    ...
    v14 = [NSString stringWithUTF8String:"/Library/Caches/com.apple.xbs/Sources/GameCenter_Daemons/Frameworks/GameCenterFoundation/gamed/GKCacheObject.m"];
    lastPathComponent = [v14 lastPathComponent];
    v16 = +[NSString stringWithFormat:](NSString, "stringWithFormat:", @"%@ (_queueContext == (__bridge const void * _Nonnull)GKCacheQueueID)\n[%s (%s:%d)]", v13, "-[GKUniqueObjectIDLookup insertObjectsForServerRepresentations:context:newObject:]", [lastPathComponent UTF8String], 226);
  ...
  v17 = objectCopy;
  v29 = v17;
  v18 = [representationsCopy _gkMapWithBlock:v28];
  if ([v18 count])
  {
    uniqueAttributeName = [(objc_class *)self->_objectClass uniqueAttributeName];
    if ([contextCopy obtainPermanentIDsForObjects:v18 error:0])
    {
      v20 = [v18 _gkMapDictionaryWithKeyPath:uniqueAttributeName valueKeyPath:@"objectID"];
      if (v20)
      {
        v21 = v20;
        if (!os_log_GKGeneral)
