@interface NSSet
+ (id)_gkSetOfResourcesWithIDs:(id)ds;
- (BOOL)_gkContainsObjectPassingPredicate:(id)predicate;
- (id)_gkResourceWithID:(id)d;
- (id)_gkResourcesWithIDs:(id)ds;
@end
...
+ (id)_gkSetOfResourcesWithIDs:(id)ds
{
  v3 = [ds _gkMapWithBlock:&stru_100367488];
