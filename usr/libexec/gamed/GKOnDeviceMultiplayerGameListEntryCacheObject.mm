...
- (id)internalRepresentation
{
  ...
  if (dispatch_queue_get_specific(v3, @"com.apple.gamed.cachequeue") != @"com.apple.gamed.cachequeue")
  {
    ...
    v8 = +[NSString stringWithFormat:](NSString, "stringWithFormat:", @"%@ (_queueContext == (__bridge const void * _Nonnull)GKCacheQueueID)\n[%s (%s:%d)]", v5, "-[GKOnDeviceMultiplayerGameListEntryCacheObject internalRepresentation]", [lastPathComponent UTF8String], 3594);
...
- (void)updateWithServerRepresentation:(id)representation
{
  ...
  if (dispatch_queue_get_specific(v5, @"com.apple.gamed.cachequeue") != @"com.apple.gamed.cachequeue")
  {
    ...
    v10 = +[NSString stringWithFormat:](NSString, "stringWithFormat:", @"%@ (_queueContext == (__bridge const void * _Nonnull)GKCacheQueueID)\n[%s (%s:%d)]", v7, "-[GKOnDeviceMultiplayerGameListEntryCacheObject updateWithServerRepresentation:]", [lastPathComponent UTF8String], 3605);
  ...
  {
    v11 = [representationCopy objectForKeyedSubscript:@"bundle-id"];
    [(GKOnDeviceMultiplayerGameListEntryCacheObject *)self setBundleID:v11];

    v12 = [representationCopy objectForKeyedSubscript:@"supports-multi-player"];
    -[GKOnDeviceMultiplayerGameListEntryCacheObject setSupportsMultiplayer:](self, "setSupportsMultiplayer:", [v12 BOOLValue]);

    v13 = [representationCopy objectForKeyedSubscript:@"supports-turn-based-multi-player"];
