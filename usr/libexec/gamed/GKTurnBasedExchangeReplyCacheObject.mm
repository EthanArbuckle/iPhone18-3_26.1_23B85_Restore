...
- (void)updateWithServerRepresentation:(id)representation
{
  ...
  if (dispatch_queue_get_specific(v5, @"com.apple.gamed.cachequeue") != @"com.apple.gamed.cachequeue")
  {
    ...
    v10 = +[NSString stringWithFormat:](NSString, "stringWithFormat:", @"%@ (_queueContext == (__bridge const void * _Nonnull)GKCacheQueueID)\n[%s (%s:%d)]", v7, "-[GKTurnBasedExchangeReplyCacheObject updateWithServerRepresentation:]", [lastPathComponent UTF8String], 4089);
  ...
  [(GKCacheObject *)&v18 updateWithServerRepresentation:representationCopy];
  v11 = [representationCopy objectForKeyedSubscript:@"slot"];
  v12 = v11;
  if (v11)
  {
  ...
  v13 = [representationCopy objectForKeyedSubscript:@"message"];
  if (v13)
  {
  ...
  v15 = [representationCopy objectForKeyedSubscript:@"data"];
  [(GKTurnBasedExchangeReplyCacheObject *)self setData:v15];

  v16 = [representationCopy objectForKeyedSubscript:@"sent-at"];
  if (v16)
  {
