...
- (BTXpcService)initWithName:(const char *)a3 sessionClass:(Class)a4
{
  ...
  if (v10)
  {
    ...
    CFNotificationCenterAddObserver(DarwinNotifyCenter, 0, sub_100001618, @"com.apple.language.changed", 0, CFNotificationSuspensionBehaviorDeliverImmediately);
    p_isa = &v16->super.isa;
  }
  ...
  {
    v13 = qword_10001EFD0;
    if (os_log_type_enabled(qword_10001EFD0, OS_LOG_TYPE_FAULT))
    {
      sub_10000E3C8(v13);
    }
...
- (void)_handleEvent:(id)a3
{
  ...
  else
  {
    v6 = type;
    v7 = qword_10001EFD0;
    v8 = os_log_type_enabled(qword_10001EFD0, OS_LOG_TYPE_ERROR);
