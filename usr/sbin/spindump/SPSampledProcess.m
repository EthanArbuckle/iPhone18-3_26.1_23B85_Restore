...
- (void)removeSelfFromPidCache
{
  if (self->super.super._isSelfInPidCache)
  {
    ...
    v6 = targetProcessId;
    v5[4] = self;
    dispatch_async(qword_100117E08, v5);
  }
}
...
- (void)createHIDExitSource
{
  ...
  if ((*p_targetProcessId & 0x80000000) == 0)
  {
    ...
    v12 = *__error();
    v13 = sub_100035B20(*p_targetProcessId);
  ...
  if (self->super.super._timeoutTime <= a3)
  {
    ...
    else
    {
      if (byte_100117E80)
      {
        ...
        {
          v60 = sub_100035B20(*p_targetProcessId);
...
LABEL_107:
      ...
      {
        sub_1000B808C(&self->super.super._targetProcessId);
      }
    }
...
- (void)setSamplingCompletionHandlerQueue:(id)a3 andBlock:(id)a4
{
  ...
  if (!v6 || !v7)
  {
    ...
    if (targetProcessId < 0)
    {
      ...
      sub_100035A54("[SPSampledProcess setSamplingCompletionHandlerQueue:andBlock:]", "SPProcessEvent.m", 1065, "%s: Must provide both queue and block", v8, v9, v10, v11, "queue && block");
    }
    ...
    else
    {
      ...
      {
        v20 = *__error();
        v21 = sub_100035B20(*p_targetProcessId);
      ...
      v41 = sub_100035B20(*p_targetProcessId);
      v47 = *p_targetProcessId;
      sub_100035A54("[SPSampledProcess setSamplingCompletionHandlerQueue:andBlock:]", "SPProcessEvent.m", 1065, "%s [%d]: %s: Must provide both queue and block", v42, v43, v44, v45, v41);
    }
...
LABEL_216:
    ...
    else
    {
      ...
      v23 = *__error();
      v24 = sub_100035B20(*p_targetProcessId);
...
LABEL_185:
        ...
        v134[1] = 3221225472;
        v134[2] = sub_100083A4C;
        v134[3] = &unk_100109AE8;
        v134[4] = self;
        sub_10007C31C(v134);
LABEL_212:
        LOBYTE(v4) = 8;
...
- (void)_saveReportToStream:(__sFILE *)a3
{
  if (!a3 || self->super.super._isSampling || !self->super.super._hasSampled)
  {
    if (self->super.super._targetProcessId < 0)
    {
      ...
      sub_100035A54("[SPSampledProcess _saveReportToStream:]", "SPProcessEvent.m", 1338, "%s: save report fail %d %d %d", v3, v4, v5, v6, "stream && !_isSampling && _hasSampled");
    }
    ...
    else
    {
      if (byte_100117E80)
      {
        ...
        {
          v39 = sub_100035B20(self->super.super._targetProcessId);
          targetProcessId = self->super.super._targetProcessId;
      ...
      if (byte_100117E81 == 1 && dword_100117510 < 4)
      {
        ...
        else
        {
          ...
          {
            v52 = sub_100035B20(self->super.super._targetProcessId);
      ...
      v73 = sub_100035B20(self->super.super._targetProcessId);
      v82 = self->super.super._isSampling;
      v83 = self->super.super._hasSampled;
      v79 = self->super.super._targetProcessId;
      sub_100035A54("[SPSampledProcess _saveReportToStream:]", "SPProcessEvent.m", 1338, "%s [%d]: %s: save report fail %d %d %d", v74, v75, v76, v77, v73);
    }
  ...
  if (!self->super.super._isUrgent)
  {
    ...
    else
    {
      if (byte_100117E80)
      {
        ...
        {
          v12 = sub_100035B20(*p_targetProcessId);
...
- (void)_performSamplePrinterWork:(id)a3
{
  ...
  if (!v8 || self->super.super._isSampling || !self->super.super._hasSampled)
  {
    if (self->super.super._targetProcessId < 0)
    {
      ...
      sub_100035A54("[SPSampledProcess _performSamplePrinterWork:]", "SPProcessEvent.m", 1354, "%s: save report fail %d %d %d", v4, v5, v6, v7, "callback && !_isSampling && _hasSampled");
    }
    ...
    else
    {
      if (byte_100117E80)
      {
        ...
        {
          v40 = sub_100035B20(self->super.super._targetProcessId);
          targetProcessId = self->super.super._targetProcessId;
      ...
      if (byte_100117E81 == 1 && dword_100117510 < 4)
      {
        ...
        else
        {
          ...
          {
            v53 = sub_100035B20(self->super.super._targetProcessId);
      ...
      v74 = sub_100035B20(self->super.super._targetProcessId);
      v83 = self->super.super._isSampling;
      v84 = self->super.super._hasSampled;
      v80 = self->super.super._targetProcessId;
      sub_100035A54("[SPSampledProcess _performSamplePrinterWork:]", "SPProcessEvent.m", 1354, "%s [%d]: %s: save report fail %d %d %d", v75, v76, v77, v78, v74);
    }
