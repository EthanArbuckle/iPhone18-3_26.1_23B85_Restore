...
- (void)takeTransaction
{
  ...
  {
    v4 = sub_1000359B8("Process Event [%d]", self->_targetProcessId);
...
- (void)_setupSampleStore:(id)a3
{
  ...
  if (!v4)
  {
    ...
    else
    {
      ...
      {
        v91 = *__error();
        v92 = sub_100035B20(*p_targetProcessId);
      ...
      v112 = sub_100035B20(*p_targetProcessId);
      v119 = *p_targetProcessId;
      sub_100035A54("[SPProcessEvent _setupSampleStore:]", "SPProcessEvent.m", 205, "%s [%d]: %s: nil sampleStore", v113, v114, v115, v116, v112);
    }
  ...
  if ((targetProcessId & 0x80000000) == 0)
  {
    if (byte_100117E80)
    {
      ...
      {
        v14 = sub_100035B20(*p_targetProcessId);
    ...
    v17 = *__error();
    v18 = sub_100035B20(*p_targetProcessId);
...
LABEL_40:
      ...
      else
      {
        ...
        {
          v14 = *__error();
          v15 = sub_100035B20(*p_targetProcessId);
