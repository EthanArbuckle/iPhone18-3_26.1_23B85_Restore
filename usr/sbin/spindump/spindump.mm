int *sub_100029530()
{
  ...
  {
    v4 = *__error();
    v5 = CFStringCreateWithFormat(kCFAllocatorDefault, 0, @"ignore_thermal_pressure:%d due to cookie file", (word_100117EC0 >> 1) & 1);
    if (v5)
    {
      v6 = v5;
  ...
  word_100117EC0 = word_100117EC0 & 0xFFFB | v13;
  if (byte_100117E80 == 1)
  {
    v14 = *__error();
    v15 = sub_100035B80();
  ...
  {
    v16 = *__error();
    v17 = CFStringCreateWithFormat(kCFAllocatorDefault, 0, @"ignore_debugger:%d due to cookie file", (word_100117EC0 >> 2) & 1);
    if (v17)
    {
      v18 = v17;
  ...
  word_100117EC0 = word_100117EC0 & 0xFFF7 | v25;
  ...
  word_100117EC0 = word_100117EC0 & 0xFFEF | v27;
  if ((v26 & 8) != 0)
  {
    if (byte_100117E80 == 1)
    {
  ...
  if (word_100117EC0)
  {
    ...
    {
      v52 = *__error();
      v53 = CFStringCreateWithFormat(kCFAllocatorDefault, 0, @"Apple Internal: reporting full spins %.1f%% of the time", qword_100117E98);
      if (v53)
      {
        v54 = v53;
  ...
  sub_100054640(@"io_exception_sampling_percentage", &qword_100117EB0, v61);
  v62 = 5.0;
  if (word_100117EC0)
  {
    v62 = 100.0;
  ...
  sub_100054640(@"cpu_resource_1st_party_sampling_percentage", &qword_100117EB8, v62);
  ...
  {
    v65 = *__error();
    v66 = CFStringCreateWithFormat(kCFAllocatorDefault, 0, @"Submit spins:%d hangs:%d unavilable on this platform", (word_100117EC0 >> 6) & 1, (word_100117EC0 >> 7) & 1);
    if (v66)
    {
      v67 = v66;
  ...
  if (byte_100117E80 == 1)
  {
    ...
    {
      *buf = 67109632;
      *v167 = HIBYTE(word_100117EC0) & 1;
      *&v167[4] = 1024;
      *&v167[6] = (word_100117EC0 >> 9) & 1;
      v168 = 1024;
      v169 = (word_100117EC0 >> 3) & 1;
  ...
  {
    v76 = *__error();
    v77 = CFStringCreateWithFormat(kCFAllocatorDefault, 0, @"Submit resource reports cpu:%d io:%d due to suppression:%d", HIBYTE(word_100117EC0) & 1, (word_100117EC0 >> 9) & 1, (word_100117EC0 >> 3) & 1);
    if (v77)
    {
      v78 = v77;
  ...
  if (byte_100117E80 == 1)
  {
    ...
    {
      *buf = 67109888;
      *v167 = (word_100117EC0 >> 10) & 1;
      *&v167[4] = 1024;
      *&v167[6] = (word_100117EC0 >> 11) & 1;
      v168 = 1024;
      v169 = (word_100117EC0 >> 12) & 1;
      v170 = 1024;
      v171 = (word_100117EC0 >> 3) & 1;
  ...
  {
    v87 = *__error();
    v88 = CFStringCreateWithFormat(kCFAllocatorDefault, 0, @"Submit systemstats:%d sleep/wake failure:%d watchdog:%d due to suppression:%d", (word_100117EC0 >> 10) & 1, (word_100117EC0 >> 11) & 1, (word_100117EC0 >> 12) & 1, (word_100117EC0 >> 3) & 1);
    if (v88)
    {
      v89 = v88;
  ...
  {
    v98 = *__error();
    v99 = CFStringCreateWithFormat(kCFAllocatorDefault, 0, @"Submit service watchdog:%d unavilable on this platform", (word_100117EC0 >> 13) & 1);
    if (v99)
    {
      v100 = v99;
  ...
  byte_100117E94 = v107 | byte_100117E94 & 0xFC;
  if (byte_100117E80 == 1)
  {
    v108 = *__error();
    v109 = sub_100035B80();
    ...
    {
      *buf = 67109376;
      *v167 = (byte_100117E94 >> 1) & 1;
      *&v167[4] = 1024;
      *&v167[6] = word_100117EC0 & 1;
  ...
  {
    v110 = *__error();
    v111 = CFStringCreateWithFormat(kCFAllocatorDefault, 0, @"Avoid affecting audio:%d due to internal:%d", (byte_100117E94 >> 1) & 1, word_100117EC0 & 1);
    if (v111)
    {
      v112 = v111;
  ...
  byte_100117E94 = byte_100117E94 & 0xF7 | v119;
  if (byte_100117E80 == 1)
  {
    v120 = *__error();
    v121 = sub_100035B80();
  ...
  {
    v122 = *__error();
    v123 = CFStringCreateWithFormat(kCFAllocatorDefault, 0, @"Symbolicate:%d due to enable symbolication file existing:%d", (byte_100117E94 >> 3) & 1, (byte_100117E94 >> 3) & 1);
    if (v123)
    {
      v124 = v123;
  ...
  {
    v133 = *__error();
    v134 = CFStringCreateWithFormat(kCFAllocatorDefault, 0, @"NoBulkSymbolication:%d", (byte_100117E94 >> 4) & 1);
    if (v134)
    {
      v135 = v134;
  ...
  {
    v144 = *__error();
    v145 = CFStringCreateWithFormat(kCFAllocatorDefault, 0, @"UseDsymForUUID:%d", (byte_100117E94 >> 2) & 1);
    if (v145)
    {
      v146 = v145;
  ...
  byte_100117E94 = byte_100117E94 & 0xDF | v154;
  if (byte_100117E80 == 1)
  {
    v155 = *__error();
    v156 = sub_100035B80();
  ...
  {
    v157 = *__error();
    v158 = CFStringCreateWithFormat(kCFAllocatorDefault, 0, @"NoExclaves:%d", (byte_100117E94 >> 5) & 1);
    if (v158)
    {
      v159 = v158;
...
void sub_10002B968(uint64_t a1, void *a2, uint64_t a3, uint64_t a4, void *a5, double a6, double a7, double a8, double a9, double a10)
{
  v19 = a2;
  v20 = a5;
  v137 = a4;
...
LABEL_52:
  ...
  v45 = sub_10004AFBC(v44, a1, "cpu resource", 160, &v154);
...
LABEL_200:
            ...
            v130 = v45;
LABEL_201:
            sub_100035F94(v127, v128, v129, v130, v124, v126, v125, a8, a6);
            goto LABEL_202;
          }
        }
...
LABEL_223:
          *__error() = v76;
LABEL_224:
          sub_1000635B4(a1, v19, a3, a4, v68, a6, a7, a8, a9, a10);
          v125 = a8 - a7;
...
LABEL_103:
  v70 = sub_1000359B8("CPU resource for [%d] thread %#llx", a1, a3);
...
LABEL_683:
    v337 = 194;
LABEL_597:
    sub_100035A54("DoMicrostackshotsOnly", "microstackshot.m", v337, v333, v54, v55, v56, v57, v380);
    abort();
  }
...
LABEL_224:
            ...
            else
            {
              ...
              {
                v155 = v59;
                v156 = sub_100059C44([v65 UTF8String], a6);
                v153 = 0;
                v154 = v155 & (v156 ^ 1);
              }
            }
            ...
            v159 = sub_100030E14(a1, a2, v157, v158, v153, a6, 1, 0, a9, a10, a24, a29, a30, a31, a32, v60);
            v160 = v159;
            if (!v159)
            {
              goto LABEL_379;
...
LABEL_425:
                ...
                v261 = v50;
                v262 = [NSString stringWithUTF8String:sub_10002B924(v48, 0)];
                [v160 setEvent:v262];
...
LABEL_450:
                ...
                if (a28)
                {
                  ...
                  v76 = sub_10005A7D8(v160, v261, v273, v48, v394, v268, v274, a18, a9, a10, a11, a12, a13, a15, v270 & 1, a25);
                }

                else
                {
                  v76 = sub_10005A7D8(v160, v261, v273, v48, v394, v268, 0, a18, a9, a10, a11, a12, a13, a15, v270 & 1, a25);
                }
...
LABEL_438:
            ...
            v401[1] = 3221225472;
            v401[2] = sub_10005A6E8;
            v401[3] = &unk_100108EC8;
            v164 = v400;
            v402 = v164;
            v165 = v163;
            v403 = v165;
...
LABEL_192:
        ...
        sub_100077DF8(v112, (byte_100117E94 >> 3) & 1, (byte_100117E94 >> 2) & 1, (byte_100117E94 & 0x10) == 0);
        *buf = 0;
        v183 = buf;
        v184 = 0x2020000000;
        v185 = 0;
...
LABEL_50:
            ...
            sub_1000326A8(v30, v28, 0, 0, a11, a3, value_4, a5, a9, a10, v157);
            gzclose(v28);
            [v30 postprocess];
            goto LABEL_261;
          }
...
CFAbsoluteTime sub_1000330D8(const char *a1)
{
  __endptr = 0;
  ...
  if (v7 || (v7 = strptime(a1, "%Y-%m-%dT%T", &v110), (__endptr = v7) != 0))
  {
    ...
    if (*v7 == 46)
    {
      ...
      *v49.i64 = strtod(v7 - 2, v112);
      ...
      if (*&v112[0] <= v8)
      {
        sub_1000B159C(v112, v8, v43, v44, v45, v46, v47, v48);
      }
...
LABEL_78:
      ...
      while (1)
      {
        ...
        v56 = CFDateFormatterCreate(0, v51, qword_1000C5578[v53], qword_1000C5578[v55]);
        if (!v56)
        {
          break;
        }
...
uint64_t sub_1000341E8(const char *a1, int a2, int a3, char a4, uint64_t *a5)
{
  v195 = getpid();
  __endptr = 0;
  if (!a1 || !*a1)
...
LABEL_329:
  ...
  v10 = dword_100117678;
  v190 = malloc_type_calloc(dword_100117678, 4uLL, 0x100004052888210uLL);
  ...
  if (v12 < 1)
  {
    if (a3)
    {
      sub_100035AD8(&buffer, 0x100uLL, "Multiple matches for %s: ", v14, v15, v16, v17, v18, a1);
      v53 = 0;
LABEL_133:
      v34 = 4294967294;
LABEL_134:
...
LABEL_236:
  ...
  v29 = sub_100035AD8(&buffer, 0x100uLL, "Multiple matches for %s: ", v24, v25, v26, v27, v28, a1);
  v30 = v19;
  v31 = 0;
  v32 = 0;
  v191 = 0;
  ...
  do
  {
    ...
    if ((a4 & 1) != 0 || v195 != v42)
    {
      if (v195 != v42)
      {
        ...
        v33 += sub_100035AD8(v33, &v203 - v33, "%s%s [%d]", v37, v38, v39, v40, v41, v43);
        ++v31;
        ++v32;
      }
...
uint64_t sub_100035A54(const char *a1, const char *a2, int a3, const char *a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, char a9)
{
  result = snprintf(byte_100117688, 0x400uLL, "Assertion Failed %s %s:%d ", a1, a2, a3);
  if ((result - 1) <= 0x3FE)
  {
    result = vsnprintf(&byte_100117688[result], 1024 - result, a4, &a9);
  }
...
uint64_t sub_100035AD8(char *a1, size_t a2, const char *a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, char a9)
{
...
void sub_10003645C(uint64_t a1, void *a2, uint64_t a3, void *a4, uint64_t a5, uint64_t a6)
{
  v10 = a2;
  v11 = a4;
        ...
        if (v9 | v11 | v8 || (v16 == 0.0 ? (v19 = *(a1 + 96) == 0) : (v19 = 0), !v19 || *(a1 + 112) != 0.0))
        {
          ...
          if (!v22)
          {
            if (v27 < 0)
            {
              ...
              v156 = *(a1 + 96);
              v151 = *(a1 + 72);
              sub_100035A54("_SPEventRateReportEvent_block_invoke", "SPEventRate.m", 330, "%s: No matching timestamps provided: %llu-%llu, %llu-%llu, %.2f-%.2f", v23, v24, v25, v26, "startTimeMachCont == 0 && endTimeMachCont == 0 && startTimeMachAbs == 0 && endTimeMachAbs == 0 && startTimeCF == 0 && endTimeCF == 0");
            }
            ...
            else
            {
              ...
              v153 = *(a1 + 72);
              v149 = *(a1 + 128);
              sub_100035A54("_SPEventRateReportEvent_block_invoke", "SPEventRate.m", 330, "%s [%d]: %s: No matching timestamps provided: %llu-%llu, %llu-%llu, %.2f-%.2f", v135, v136, v137, v138, v134);
            }
          ...
          sub_100035A54("_SPEventRateReportEvent_block_invoke", "SPEventRate.m", 330, v146, v142, v143, v144, v145, v141);
