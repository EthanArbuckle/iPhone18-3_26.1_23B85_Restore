...
void sub_100078040(void *a1, int a2, int a3, const char *a4, int a5, int a6, int a7, int a8, uint64_t a9, uint64_t a10, uint8_t buf)
{

  _os_log_fault_impl(a1, v11, OS_LOG_TYPE_FAULT, a4, &buf, 0x16u);
}

void sub_100078060(void *a1, int a2, int a3, const char *a4, int a5, int a6, int a7, int a8, uint64_t a9, uint64_t a10, uint8_t buf)
{
    ...
    while (1)
    {
      ...
      else
      {
        if (byte_100117E80)
        {
          ...
          {
            v18 = sub_100035B20([v15 targetProcessId]);
        ...
        v22 = *__error();
        v23 = sub_100035B20([v15 targetProcessId]);
...
LABEL_41:
        ...
        if (os_log_type_enabled(v25, OS_LOG_TYPE_FAULT))
        {
          v26 = sub_100035B20([v15 targetProcessId]);
...
LABEL_256:
            ...
            else
            {
              ...
              {
                v135 = *__error();
                v136 = sub_100035B20([*v4 targetProcessId]);
              ...
              v175 = sub_100035B20([*v4 targetProcessId]);
              [*v4 targetProcessId];
              LOBYTE(v182) = v175;
...
LABEL_226:
        ...
        else
        {
          ...
          {
            v125 = *__error();
            v126 = sub_100035B20([*v4 targetProcessId]);
          ...
          v180 = sub_100035B20([*v4 targetProcessId]);
          [*v4 targetProcessId];
          LOBYTE(v182) = v180;
        ...
        v178 = 908;
LABEL_368:
        sub_100035A54("[SPSampledProcess requireHIDEvent:]_block_invoke", "SPProcessEvent.m", v178, v176, v119, v120, v121, v122, v182);
        abort();
      }
    }
...
_DWORD *sub_100080B88(uint64_t a1)
{
  v1 = (a1 + 32);
  v2 = *(*(a1 + 32) + 48);
  ...
  *(*v6 + 10) = v13;
  ...
  if (v25 != v26)
  {
    ...
    else
    {
      ...
      v85 = sub_100035B20(*(*v6 + 18));
      v91 = *(*v6 + 18);
      sub_100035A54("[SPSampledProcess _samplingHasCompletedWithEndSnapshot:withReason:]_block_invoke", "SPProcessEvent.m", 1269, "%s [%d]: %s: Mismatched sample providers", v86, v87, v88, v89, v85);
    }
...
void sub_10008476C(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, uint64_t a16, uint64_t a17, ...)
{
  va_start(va, a17);
...
LABEL_425:
      ...
      v201[1] = 3221225472;
      v201[2] = sub_100088028;
      v201[3] = &unk_100109C78;
      v202 = v198;
...
void sub_1000884D8(uint64_t a1@<X1>, uint64_t a2@<X8>)
{
  *(v2 - 8) = a2;
  v3 = *(a1 + 297);
  v4 = *(a1 + 298);
...
id sub_10008866C(uint64_t a1, void *a2)
{
  ...
  if (!v2)
  {
    ...
    dispatch_once(&qword_100117E30, v40);
LABEL_52:
    v6 = 0;
    goto LABEL_53;
  }
...
LABEL_54:
    ...
    v23 = ((dword_100117E5C * 1.2) + 0x3FFFF) & 0xFFFC0000;
    stackshot_config_set_size_hint();
LABEL_55:
    v98 = mach_absolute_time();
    v24 = sub_10008866C(v22, v95);
    if (v24)
    {
      ...
      if ([v24 length] >= 0xFFFFFFFF)
      {
        ...
        [v24 length];
        sub_100035A54("_SamplingThread", "SPSampleProvider.m", 263, "%s: bad stackshot data length %lu", v87, v88, v89, v90, "stackshotData.length < 4294967295U");
        abort();
      }
      ...
      if ((v12 & 1) == 0)
      {
        if (v23 && v23 < v27)
        {
          ...
          {
            v31 = *__error();
            v32 = CFStringCreateWithFormat(kCFAllocatorDefault, 0, @"Hint too small (previous %d, hint %d, actual %d)", dword_100117E5C, v23, v28);
            v33 = v32;
            if (v32)
            {
      ...
      if (qword_100117E60)
      {
        ...
        v43 = [v24 bytes];
        v44 = [v24 length];
        if (fwrite(v43, v44, 1uLL, qword_100117E60) != 1)
        {
          if (byte_100117E80 == 1)
          {
            v45 = *__error();
      ...
      v100[1] = 3221225472;
      v100[2] = sub_10008E554;
      v100[3] = &unk_100109E40;
      v101 = v40;
      v102 = v24;
      v104 = &v116;
      v106 = v22;
...
void sub_10008B7F8(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, ...)
{
  va_start(va, a9);
  _Block_object_dispose(va, 8);
  _Unwind_Resume(a1);
...
void sub_100098044(FILE *a1, void *a2, void *a3, char a4, char a5, void *a6)
{
  v11 = a2;
  v12 = a3;
  v13 = a6;
...
id sub_100098334(FILE *a1, int a2, void *a3, char a4)
{
  v7 = a3;
  v8 = objc_autoreleasePoolPush();
...
void sub_10009847C(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, ...)
{
  va_start(va, a9);
  _Block_object_dispose(va, 8);
  _Unwind_Resume(a1);
        ...
        if (v55)
        {
          if (v17)
          {
            if (objc_getProperty(v17, v48, 48, 1))
            {
              ...
              v94 = byte_100117E81 == 1 && dword_100117510 <= 2;
              v11 = v216;
              v13 = v212;
              if (!v94)
              {
            ...
            else
            {
              ...
              v143 = byte_100117E81 == 1 && dword_100117510 <= 2;
              v12 = v214;
              v11 = v216;
              if (!v143)
              {
...
LABEL_264:
        ...
        {
          sub_1000BDCFC(v11, v218);
        }

        v192 = [v11 substringWithRange:{v190, v191}];
        v24 = sub_10009A270(v192);
    ...
    do
    {
      ...
      if (v71)
      {
        ...
        if (objc_getProperty(v17, v64, 48, 1))
        {
          ...
          v111 = byte_100117E81 == 1 && dword_100117510 <= 2;
          v11 = v217;
          v13 = v213;
          if (!v111)
          {
        ...
        else
        {
          ...
          v157 = byte_100117E81 == 1 && dword_100117510 <= 2;
          v12 = v215;
          v11 = v217;
          if (!v157)
          {
...
LABEL_276:
  ...
  {
    sub_1000BDF14(v11, v218);
  }

  v196 = [v11 substringWithRange:{v194, v195}];
  v24 = sub_10009A270(v196);
...
LABEL_3:
  ...
  if (fseeko(a1, v7, 0))
  {
    ...
    v32 = __error();
    strerror(*v32);
    sub_100035A54("LookaheadLines", "SPTextualReportParser.m", 978, "%s: Unable to seek back to %lld after searching for load infos: %d (%s)", v33, v34, v35, v36, "ret == 0");
    abort();
  }
...
void sub_10009AADC(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, ...)
{
  va_start(va1, a11);
  va_start(va, a11);
  v12 = va_arg(va1, void);
  ...
  if (*(*(*(a1 + 48) + 8) + 24))
  {
    ...
    if (v9)
    {
      ...
      if (*(a1 + 56) != 1 || v104 == [*(a1 + 40) count])
      {
        ...
        v86 = v102;
        v85 = v103;
        v87 = sub_1000BC6FC([SPLoadInfo alloc], v83, v97 != 0x7FFFFFFFFFFFFFFFLL, v99, v98, v103, v102, v105, v60);
        [*(a1 + 40) addObject:v87];
      }
