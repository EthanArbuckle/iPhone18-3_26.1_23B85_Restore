...
LABEL_538:
              ...
              while (v352 < [v924 count])
              {
                ...
                v359 = v916;
                sub_10009A310(a4, v356 + v355 * (v353 + v352), v900 != 0x7FFFFFFFFFFFFFFFLL, v910, v895, v358, v892, [v916 UTF8String], v886, v275);
...
LABEL_724:
                  ...
                  v492 = v491;
                  v493 = v492;
                  sub_10009A430(a4, v481, v485 & 1, v486, v918 + 2, v490, [v492 UTF8String], 0, 0);
...
LABEL_1248:
              ...
              while (1)
              {
                ...
                v466 = v464;
                v467 = v466;
                sub_10009A310(a4, v460 + v459 * (v912 + v449), v457 & 1, v458, v918 + 2, v463, v465, [v466 UTF8String], 0, 0);
...
LABEL_527:
        ...
        v348 = v911;
        sub_10009A430(a4, v345 + (v328 + v289) * v344, v907 != 0x7FFFFFFFFFFFFFFFLL, v902, v329, v347, [v911 UTF8String], v301, v302);
        goto LABEL_672;
      }
