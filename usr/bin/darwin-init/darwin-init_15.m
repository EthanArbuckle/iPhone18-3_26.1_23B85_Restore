...
uint64_t sub_10012F4D4(uint64_t a1, unsigned int a2, int a3, unint64_t *a4, char **a5, __n128 a6, int32x4_t a7, double a8, double a9, double a10, int32x4_t a11)
{
  v11 = *(a1 + 2248);
  v12 = *(a1 + 2344);
  v13 = v11 - v12;
...
LABEL_193:
          ...
          else
          {
            if (v83 != 10)
            {
              ...
              v88 = (a1 + 2352);
              sub_10014F8D0(v265, v264, v20, v21, a6.n128_f64[0], a7, a8, a9, a10, a11, v94, a1, v259, (a1 + 2352), (a1 + 2328), v85, v81, (a1 + 2320));
              goto LABEL_226;
            }
...
void sub_100131C40(uint64_t a1, uint64_t a2, size_t a3, unint64_t a4, unint64_t a5, unsigned int a6, unsigned int a7, uint64_t a8, unsigned __int8 a9, unsigned __int8 a10, unint64_t a11, unint64_t a12, unsigned int *a13, _OWORD *a14, _OWORD *a15, unint64_t *a16, char *a17)
{
  if (a4 >> 30 < 3)
  {
    v22 = a4;
  ...
  if (sub_100131024(a2, a3, a4, a5, a11, a12))
  {
    ...
    {
      v28 = a6;
      sub_1001701F0(a1, a2, v22, a5, a3, a6, a8, a13, a12, a16, a17);
      goto LABEL_14;
    }
    ...
    {
      v28 = a6;
      sub_10016F880(a1, a2, v22, a5, a3, a6, a8, a13, a12, a16, a17);
LABEL_14:
      if (*(a1 + 24))
      {
        return;
    ...
    if (v30 > 9)
    {
      sub_10014BF54(a1, a2, v22, a3, v50, a9, a10, a13, a12, a7, v42);
    }
    ...
    else
    {
      ...
      sub_10014C854(a1, a2, v34, a3, a9, a10, &byte_1003E3330[v32], v33, v31, a13, a12, v42);
    }
    ...
    if (!*(a1 + 24))
    {
      ...
      sub_10016DE1C(a1, a2, v22, a5, a3, a9, a10, a6, v50, a7, a13, a12, v42, a16, a17);
      if (!*(a1 + 24))
      {
        sub_1001473A0(a1, v42);
        sub_1001473A0(a1, v43);
        sub_1001473A0(a1, v44);
        sub_100166DB4(a1, v45);
        *&v45 = 0;
        sub_100166DB4(a1, v46);
        *&v46 = 0;
        sub_100166DB4(a1, v47);
        *&v47 = 0;
        sub_100166DB4(a1, v48);
        *&v48 = 0;
        sub_100166DB4(a1, v49);
        v28 = a6;
LABEL_15:
        if (a5 + 4 < *a16 >> 3)
        {
        ...
        do
        {
          if (v17 + 2 < v16)
          {
            ...
            for (i = 2; i != 64; ++i)
            {
              v21 = v18;
              v18 = *(a1 + ((v17 + i) & a4));
              v22 = byte_10037CD60[4 * (*(&unk_1003E3330 + v19 + 1280) | *(&unk_1003E3330 + v21 + 1024))];
              v23 = (v18 >> 1) & 0x7C;
              ++*(&v113 + v23);
              v24 = &v111[8 * v22];
              v19 = v21;
...
uint64_t sub_100133C94(uint64_t a1, int a2, int a3)
{
  if (a3)
  {
    v4 = *(a1 + 32);
...
uint64_t sub_1001343F8(uint64_t a1, char a2)
{
  v3 = *(a1 + 32);
  v4 = *(v3 + 24) | a2 & 1;
  *(v3 + 24) = v4;
  ...
  if (*v3)
  {
    v6 = sub_100161CC4(v5, (a1 + 24), (a1 + 16), (a1 + 8), a1, 0) - 1;
    if (v6 <= 2)
    {
      return dword_10037D3C0[v6];
    }

    return 0xFFFFFFFFLL;
  }

  if (!sub_10012E5F8(v5, 2 * (v4 != 0), (a1 + 24), (a1 + 16), (a1 + 8), a1, 0))
  {
    return 0xFFFFFFFFLL;
  }

  return *(v3 + 24) && sub_10012F378(*(v3 + 16));
}
...
uint64_t sub_1001345F8(uint64_t a1, int a2, int a3)
{
  if (!a3)
  {
    *(a1 + 32) = 0;
  ...
  v5 = sub_100136794(a2);
  v6 = sub_100170C68(*(a1 + 32), 0, a2, v5 + 524544, v5 + 524344);
  *(a1 + 32) = v6;
  if (!v6)
  {
    return 0xFFFFFFFFLL;
...
uint64_t sub_100134EB4(uint64_t a1, int a2, int a3, int a4)
{
  if (a2 == 1)
  {
...
uint64_t sub_10013545C(uint64_t a1, uint64_t a2, uint64_t a3, unsigned int a4, uint64_t a5, __n128 a6, int8x16_t a7)
{
  if (a4 < 4)
  {
    return 0;
...
unint64_t sub_100135D78(unint64_t result, int8x16_t a2)
{
  v2 = *(result + 24);
  if (v2 < *(result + 32))
  {
...
char *sub_1001367A8(char *a1, unint64_t a2, const float *a3, unint64_t a4, int8x16_t *a5, int a6)
{
  v8 = 0;
...
uint64_t sub_100136BB4(_WORD *a1, unint64_t a2, _BYTE *a3, unint64_t a4, void *a5)
{
  bzero(a5, 0x8000uLL);
  v10 = 0;
  if (!a4)
...
unint64_t sub_100136F30(unint64_t a1, uint8x16_t *a2, int a3)
{
  v5 = WORD1(a1);
  a1 = a1;
  if (a3 == 1)
  ...
  else if (a2)
  {
    if (a3 >= 16)
    {
      ...
      return adler32_vec(a1, v5, a2, a3);
    }
...
char *sub_100138008(char *a1, unint64_t a2, unsigned __int8 *a3, unint64_t a4)
{
  v9 = a1;
  v10 = a3;
