...
uint64_t sub_100163524(int a1, unsigned int a2, int *__src, _DWORD *a4, uint64_t a5)
{
  v9 = a5 + 760;
  v10 = *(a5 + 752);
  v11 = a5 + 2506;
...
LABEL_46:
      ...
      {
LABEL_112:
        v100 = sub_10017194C(__src, 8, (a5 + 920), v29);
        if (a4)
        {
          *a4 = v100;
        }
...
LABEL_64:
  if (v36 == 1 || !v37)
  {
    ...
    *(&v70 + 1) = -1;
    ...
    {
      v71 = vdupq_n_s64(v68);
      v72 = vorrq_s8(v71, xmmword_1003E9370);
      v73 = vorrq_s8(v71, xmmword_1003E9380);
      v74 = vorrq_s8(v71, xmmword_1003E9390);
      v75 = vorrq_s8(v71, xmmword_1003E93A0);
...
LABEL_157:
        v125 = sub_100171708(__srca, 8, *(a5 + 912), v11);
        if (v128)
        {
          *v128 = v125;
        }
...
uint64_t sub_10016400C(unsigned int a1, unsigned int *a2, unsigned __int8 **a3, uint64_t a4)
{
  v8 = *(a4 + 748);
  result = 4294967265;
  if (v8 <= 1)
  ...
  if (v8 == 2)
  {
    v17 = *(a4 + 2556);
LABEL_21:
    result = sub_100163524(v17 + *a2, v17 + *a2, (a4 + 2564), 0, a4);
    if (result != 1)
    {
      return result;
    }
...
LABEL_40:
      ...
      else
      {
        ...
        if (!sub_100165B40((a4 + 2564), a4 + 8, &v51))
        {
          v10 = 0xFFFF;
          goto LABEL_65;
        }
...
uint64_t sub_10016655C(uint64_t result)
{
  ...
  if (v1 >= 2)
  {
    ...
    *(result + 144) = &unk_1003E3330 + 512 * (*(*(result + 688) + v28) & 3);
  }
...
uint64_t sub_100166CE8(unint64_t *a1)
{
  v2 = (a1 + 7);
...
uint64_t sub_100166DB4(uint64_t result, unint64_t a2)
{
  if (a2)
  {
    v3 = result;
...
void sub_100169648(void *a1, unsigned int a2, int a3, int a4, int a5, unsigned int a6, _BYTE *a7, int a8)
{
...
uint64_t sub_100169BAC(uint64_t a1, uint8x16_t *a2, int a3)
{
  if (!a1)
  {
    return 4294967294;
...
uint64_t sub_10016A970(uint64_t a1, unint64_t a2)
{
