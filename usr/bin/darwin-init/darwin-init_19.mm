unint64_t sub_1001581EC(unint64_t result, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, int *a7, unint64_t *a8, uint64_t a9, void *a10, void *a11)
{
  v11 = a2;
  v12 = *a8;
  v13 = a2 + result;
...
unint64_t sub_100158F54(unint64_t result, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, int *a7, unint64_t *a8, uint64_t a9, void *a10, void *a11)
{
  v11 = a2;
  v12 = *a8;
  v13 = a2 + result;
...
unint64_t sub_100159D78(unint64_t result, unint64_t a2, uint64_t a3, unint64_t a4, uint64_t a5, uint64_t a6, int *a7, unint64_t *a8, _DWORD *a9, void *a10, void *a11)
{
  v11 = a5;
  v12 = a2;
  v267 = *(a5 + 16);
...
uint64_t sub_10015BDE4(uint64_t a1, int a2, int a3, int a4)
{
  if (a2 == 1)
  {
...
uint64_t sub_10015C760(uint64_t a1, uint64_t a2, unint64_t a3, unint64_t a4, uint64_t a5, uint64_t *a6, unsigned int *a7)
{
  v10 = a1;
  if (a3)
  {
...
uint64_t sub_10015D35C(uint64_t a1, uint64_t a2, unint64_t a3, unint64_t a4, uint64_t a5, uint64_t *a6, unsigned int *a7)
{
  v10 = a1;
  if (a3)
  {
...
uint64_t sub_10015DF58(uint64_t a1, uint64_t a2, unint64_t a3, unint64_t a4, uint64_t a5, uint64_t *a6, unsigned int *a7)
{
  v10 = a1;
  if (a3)
  {
...
void sub_10015EDD0(int *a1, char *a2, uint64_t a3, int a4)
{
  if (a1[45] < 1)
  {
    v11 = a3 + 5;
...
LABEL_14:
    ...
    sub_10015F320(a1, (a1 + 722));
    sub_10015F320(a1, (a1 + 728));
    sub_10015FD68(a1, (a1 + 49), a1[724]);
    sub_10015FD68(a1, (a1 + 622), a1[730]);
    sub_10015F320(a1, (a1 + 734));
    v14 = &dword_100000010 + 2;
    while (!HIWORD(a1[byte_1003E8468[v14] + 683]))
    {
      if (v14-- <= 3)
      {
        v14 = 2;
...
LABEL_24:
  ...
  else
  {
    ...
    sub_10015FE6C(a1, (a1 + 49), v36);
    sub_10015FE6C(a1, (a1 + 622), v37);
    v34 = a1 + 49;
    v35 = a1 + 622;
  }
...
uint64_t sub_10015FC84(uint64_t result, uint64_t a2, int a3)
{
  v3 = result + 2992;
  v4 = *(result + 2992 + 4 * a3);
  v5 = 2 * a3;
...
uint64_t sub_1001604A0(uint64_t a1)
{
  v1 = *(a1 + 24);
  if (v1 < *(a1 + 32))
  {
...
uint64_t sub_1001607F8(uint64_t a1)
{
  if (*(a1 + 96))
  {
    if (sub_100160798(a1, (a1 + 80)))
  ...
  v2 = *(a1 + 8);
  if (v2 <= *(a1 + 16) || (v6[0] = *(a1 + 8), v6[1] = v2 - 1, v6[2] = 0, !sub_100160798(a1, v6)))
  {
    sub_100160B94(a1);
    if (!v3)
    {
...
_WORD *sub_1001619D0(_WORD *result, signed int a2, int a3)
{
  if (a2)
  {
    for (i = 3; ; --i)
...
uint64_t sub_100161BA4(uint64_t a1)
{
  ...
  v10 = v4;
  v8 = v5;
  result = sub_100144738(v13, 0, 0, 0);
  if (result)
  {
    v7 = sub_100161CC4(v13, &v11, &v10, &v9, &v8, &v12);
    *v3 = v12;
    sub_1001448E8(v13);
    return v7 == 1;
  }
...
uint64_t sub_100161CC4(uint64_t a1, void *a2, _BYTE **a3, size_t *a4, void **a5, size_t *a6)
{
  v6 = a6;
  v7 = a4;
  if (a6)
...
LABEL_81:
          ...
          *a1 = 18;
LABEL_82:
          v13 = sub_100163374(a1, (a1 + 8), &v166[v52]);
          if (v13 == 1)
          {
            ++v166[*(a1 + 4)];
            v23 = *(a1 + 4);
            ...
            *a1 = 19;
LABEL_119:
            v13 = sub_100163524(v166[v24] + 2, v166[v24] + 2, (*(a1 + 240) + 2528 * v23), 0, a1);
            if (v13 == 1)
            {
              *a1 = 20;
LABEL_121:
              v13 = sub_100163524(26, 0x1Au, (*(a1 + 248) + 1584 * *(a1 + 4)), 0, a1);
              if (v13 == 1)
              {
                *a1 = 21;
LABEL_123:
...
LABEL_140:
                ...
                else
                {
                  ...
                  if (sub_100165B40(v96, a1 + 8, &v168))
                  {
                    v95 = v168;
                    goto LABEL_134;
                  }
...
LABEL_179:
          ...
          *a1 = 22;
LABEL_96:
          v13 = sub_10016400C(v22 << 6, (a1 + 676), v165, a1);
          if (v13 == 1)
          {
            *v164 = 0u;
            v164[1] = 0u;
...
LABEL_106:
            ...
            v13 = sub_10016400C(4 * *(a1 + 292), (a1 + 328), (a1 + 336), a1);
            if (v13 == 1)
            {
              v157 = v6;
              v158 = v14;
              v54 = v7;
              v55 = v162;
              v89 = sub_10014492C(a1, v162, 256, 256, *(a1 + 676));
              v90 = v89 & sub_10014492C(a1, v163, 704, 704, *(a1 + 288));
              if ((v90 & sub_10014492C(a1, v161, v82, v83, *(a1 + 328)) & 1) == 0)
              {
                v156 = a1;
                v13 = -22;
                return sub_100162CE4(v156, v13);
              }
...
LABEL_156:
                  ...
                  *(a1 + 144) = &byte_1003E3330[512 * (*(*(a1 + 688) + v123) & 3)];
                  *(a1 + 160) = *(a1 + 336);
                  *(a1 + 136) = **(a1 + 192);
                  v126 = sub_100164430(a1);
                  v13 = -27;
                  if (v126)
                  {
                    v127 = *(a1 + 324);
                    ...
                    *a1 = 7;
LABEL_169:
                    v13 = sub_1001644E8(a1);
                    if (v13 == 2)
                    {
                      v13 = sub_100164E84(a1);
                    }
                  }
                }
              }
              ...
              else
              {
                ...
                {
                  v169 = 0;
                  v120 = sub_100163524(*(v55 + 16), *(v55 + 18), v119, &v169, a1);
                  if (v120 != 1)
                  {
                    break;
                  }
        ...
        case 0xA:
          goto LABEL_169;
        case 0xB:
          v13 = sub_100163E60(v7, v167, v6, a1);
          if (v13 == 1)
          {
            *a1 = 14;
          }
...
LABEL_184:
        ...
        case 0xF:
        case 0x10:
          v13 = sub_100162CF8(a1, v7, v167, v6, 0);
          if (v13 != 1)
          {
            continue;
          }
...
LABEL_198:
          if (*(a1 + 120))
          {
            v13 = sub_100162CF8(a1, v7, v167, v6, 1);
            if (v13 != 1)
            {
              continue;
            }
    ...
    if (v13 == 2)
    {
      if (*(a1 + 120) && (v17 = sub_100162CF8(a1, v7, v167, v6, 1), (v17 & 0x80000000) != 0))
      {
        v13 = v17;
      }
