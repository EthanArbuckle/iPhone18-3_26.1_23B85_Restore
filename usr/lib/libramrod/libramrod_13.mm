...
uint64_t sub_B5BE4(int a1, unsigned int a2, int *__src, _DWORD *a4, uint64_t a5)
{
  v9 = a5 + 760;
  v10 = *(a5 + 752);
  v11 = a5 + 2506;
...
LABEL_46:
      ...
      {
LABEL_112:
        v100 = sub_C400C(__src, 8, (a5 + 920), v29);
        if (a4)
        {
          *a4 = v100;
        }
...
LABEL_64:
  if (v36 == 1 || !v37)
  {
    ...
    *(&v70 + 1) = -1;
    ...
    {
      v71 = vdupq_n_s64(v68);
      v72 = vorrq_s8(v71, xmmword_178430);
      v73 = vorrq_s8(v71, xmmword_178440);
      v74 = vorrq_s8(v71, xmmword_178450);
      v75 = vorrq_s8(v71, xmmword_178460);
...
LABEL_157:
        v125 = sub_C3DC8(__srca, 8, *(a5 + 912), v11);
        if (v128)
        {
          *v128 = v125;
        }
...
uint64_t sub_B66CC(unsigned int a1, unsigned int *a2, unsigned __int8 **a3, uint64_t a4)
{
  v8 = *(a4 + 748);
  result = 4294967265;
  if (v8 <= 1)
  ...
  if (v8 == 2)
  {
    v17 = *(a4 + 2556);
LABEL_21:
    result = sub_B5BE4(v17 + *a2, v17 + *a2, (a4 + 2564), 0, a4);
    if (result != 1)
    {
      return result;
    }
...
uint64_t sub_B8C1C(uint64_t result)
{
  ...
  if (v1 >= 2)
  {
    ...
    *(result + 144) = &unk_1723F0 + 512 * (*(*(result + 688) + v28) & 3);
  }
...
uint64_t sub_B93A8(unint64_t *a1)
{
  v2 = (a1 + 7);
...
uint64_t sub_B9474(uint64_t result, unint64_t a2)
{
  if (a2)
  {
    v3 = result;
...
uint64_t sub_B967C(uint64_t a1)
{
  v2 = &__dst[16] + 2;
  v3 = a1 + 3208;
  v4 = a1 + 136;
...
void sub_BBD08(void *a1, unsigned int a2, int a3, int a4, int a5, unsigned int a6, _BYTE *a7, int a8)
{
...
uint64_t sub_BC26C(uint64_t a1, uint8x16_t *a2, int a3)
{
  if (!a1)
  {
    return 4294967294;
...
uint64_t sub_BD030(uint64_t a1, unint64_t a2)
{
