...
uint64_t sub_A15A0(uint64_t a1, int a2, uint64_t a3, uint64_t *a4)
{
  v8 = *a4 << 6;
  a4[19] = v8;
  if (v8)
...
unint64_t sub_A1640(uint64_t a1, unint64_t a2, uint64_t a3, unint64_t a4)
{
  v4 = 15;
  if (a2 > 0xF)
  {
...
uint64_t sub_A181C(uint64_t a1, unint64_t a2, uint64_t a3, unint64_t a4, void *a5)
{
  if (a4 <= 7)
  {
    v10 = 7;
...
LABEL_5:
    ...
    v21 = v20 - v16;
    v22 = v12 >> (v13 - v15);
    v23 = v12 & qword_A1CD0[v20];
    v24 = v21 - v17;
    v7 = v22 + HIWORD(v15);
    v25 = v23 >> (v20 - v16);
    v26 = v23 & qword_A1CD0[v21];
    v13 = v24 - v18;
    v8 = v25 + HIWORD(v16);
    v27 = v26 >> (v21 - v17);
    v28 = v26 & qword_A1CD0[v24];
    v9 = v27 + HIWORD(v17);
    v29 = v28 >> (v24 - v18);
    v12 = v28 & qword_A1CD0[v13];
    v10 = v29 + HIWORD(v18);
    v30 = a3 <= 4;
    a3 -= 4;
    if (v30)
  ...
  {
    v13 += v19;
    v12 = (v12 << v19) | *v14 & qword_A1CD0[v19];
    goto LABEL_5;
  }
...
uint64_t sub_A1EEC(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, void *a5, int a6)
{
  if (a6 == 2193)
  {
    v11 = 22376;
...
unint64_t sub_A2DC0(unint64_t result, unint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, int *a7, unint64_t *a8, uint64_t a9, void *a10, void *a11)
{
  v12 = *a8;
  v13 = a2 + result;
  v14 = a2 + result - 7;
...
LABEL_25:
    ...
    v174 = vandq_s8(vaddq_s64(v34, xmmword_172360), v18);
    v175 = vandq_s8(vaddq_s64(v34, xmmword_172370), v18);
...
LABEL_82:
      ...
      v174 = vandq_s8(vaddq_s64(v75, xmmword_172360), v76);
      v175 = vandq_s8(vaddq_s64(v75, xmmword_172370), v76);
          ...
          if (v176)
          {
            ...
            *a7 = v103;
            ...
            if (v178 >= 5)
            {
              ...
              *(a7 + 1) = vaddq_s32(v179, xmmword_172380);
              *(a7 + 4) = vadd_s32(*v179.i8, 0x3FFFFFFFDLL);
              if (v178 >= 0xB)
              {
                v180 = vdupq_lane_s32(v177, 0);
                *(a7 + 10) = vaddq_s32(v180, xmmword_172380);
...
unint64_t sub_A57DC(unint64_t result, unint64_t a2, uint64_t a3, unint64_t a4, uint64_t a5, uint64_t a6, int *a7, unint64_t *a8, _DWORD *a9, void *a10, void *a11)
{
  ...
  if (v17 >= 5)
  {
    ...
    *(a7 + 1) = vaddq_s32(v18, xmmword_172380);
    *(a7 + 4) = vadd_s32(*v18.i8, 0x3FFFFFFFDLL);
    if (v17 >= 0xB)
    {
      v19 = (a7 + 1);
      v20 = vld1q_dup_f32(v19);
      *(a7 + 10) = vaddq_s32(v20, xmmword_172380);
          ...
          if (v183)
          {
            ...
            *a7 = v106;
            ...
            if (v185 >= 5)
            {
              ...
              *(a7 + 1) = vaddq_s32(v186, xmmword_172380);
              *(a7 + 4) = vadd_s32(*v186.i8, 0x3FFFFFFFDLL);
              if (v185 >= 0xB)
              {
                v187 = vdupq_lane_s32(v184, 0);
                *(a7 + 10) = vaddq_s32(v187, xmmword_172380);
...
unint64_t sub_A69B8(unint64_t result, unint64_t a2, uint64_t a3, unint64_t a4, uint64_t a5, uint64_t a6, int *a7, unint64_t *a8, uint64_t a9, void *a10, void *a11)
{
  v12 = a9;
  v13 = *a8;
  v14 = a2 + result;
...
unint64_t sub_A7AF4(unint64_t result, unint64_t a2, uint64_t a3, unint64_t a4, uint64_t a5, uint64_t a6, int *a7, unint64_t *a8, uint64_t a9, void *a10, void *a11)
{
  v12 = a9;
  v228 = *(a5 + 16);
  v13 = *a8;
...
LABEL_228:
        if (v99 <= v231 && v180)
        {
          ...
          *(a7 + 1) = vaddq_s32(v181, xmmword_172380);
...
unint64_t sub_A8C20(unint64_t result, unint64_t a2, uint64_t a3, unint64_t a4, uint64_t a5, uint64_t a6, int *a7, unint64_t *a8, double a9, int32x4_t a10, double a11, double a12, double a13, int32x4_t a14, uint64_t a15, void *a16, void *a17)
{
  v18 = a15;
  v250 = *(a5 + 16);
  v19 = *a8;
  ...
  a10.i64[0] = *a7;
  v24 = vaddq_s32(vzip1q_s32(a10, a10), xmmword_172390);
  *(a7 + 1) = vaddq_s32(vdupq_lane_s32(*a7, 0), xmmword_172380);
  *(a7 + 2) = v24;
  *(a7 + 3) = vaddq_s32(vdupq_lane_s32(*a10.i8, 1), xmmword_1723A0);
  if (a2 + 4 < v20)
  {
    v240 = v23;
    v262 = (1 << v22) - 16;
...
LABEL_236:
        if (v108 <= v253 && v193)
        {
          ...
          *a7 = v108;
          a14.i32[0] = v108;
          *(a7 + 1) = vaddq_s32(vdupq_n_s32(v108), xmmword_172380);
          a7[8] = v108 - 3;
          v194 = vzip1q_s32(a14, v24);
          a14 = vdupq_lane_s32(*v194.i8, 1);
          v195 = vaddq_s32(vzip1q_s32(v194, a14), xmmword_1723B0);
...
LABEL_22:
      ...
      v126 = vandq_s8(vaddq_s64(v32, xmmword_172360), v17);
      v127 = vandq_s8(vaddq_s64(v32, xmmword_172370), v17);
      do
      {
...
LABEL_70:
        ...
        v126 = vandq_s8(vaddq_s64(v65, xmmword_172360), v66);
        v127 = vandq_s8(vaddq_s64(v65, xmmword_172370), v66);
        do
        {
