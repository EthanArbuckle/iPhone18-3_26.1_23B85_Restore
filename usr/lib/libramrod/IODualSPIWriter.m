...
- (id)_loadRegionLayout:(unsigned int)a3
{
  v4 = [(IODualSPIWriter *)self _findFirmwareInfoEntry];
  if (v4)
  {
    v5 = v4;
    v6 = IORegistryEntryCreateCFProperty(v4, @"fw-regions", 0, 0);
    IOObjectRelease(v5);
  }
  ...
  if (![v6 length])
  {
    v6 = IORegistryEntrySearchCFProperty(a3, "IOService", @"reg", 0, 3u);
    if (![v6 length])
    {
...
- (int)openService
{
  ...
  v12 = [(IOServiceWriter *)self service];
  v13 = IOServiceOpen(v12, mach_task_self_, 0, &self->_usesAFUH);
...
- (BOOL)_headerMatchesBootSFRManifestHash:(id)a3
{
  ...
  v6 = [(IODualSPIWriter *)self _getSFRManifestHashForPayload:a3];
...
- (int)writeNewerGenerationFirmware:(id)a3 withError:(id *)a4
{
  ...
  do
  {
    ...
    v6 = [(IODualSPIWriter *)self findHeaders];
    if ([v6 count] <= 1)
    {
      if (a4)
      {
        v111 = [v6 count];
        *a4 = MSUBootFirmwareError(-536870167, 0, @"writeNewerGenerationFirmware: couldn't find enough headers (only found %d of %d)", v112, v113, v114, v115, v116, v111);
      }
    ...
    {
      iBU_LOG_real(@"Both headers are valid. Checking to see which one we're booted from.", "[IODualSPIWriter writeNewerGenerationFirmware:withError:]", v27, v28, v29, v30, v31, v32, v118);
...
LABEL_20:
    ...
    iBU_LOG_real(@"Neither header is valid. Setting header0 to gen0.", "[IODualSPIWriter writeNewerGenerationFirmware:withError:]", v40, v41, v42, v43, v44, v45, v118);
    v18 = v9;
LABEL_27:
    ...
    {
      v64 = [v8 headerGeneration];
      v65 = [v18 headerGeneration];
      if (v64 != -1)
      {
        v66 = [v8 headerGeneration];
        if (v65 == -1)
        {
          v65 = v66;
        }
    ...
    if ([(IODualSPIWriter *)self _usesExtendediBootRegion]&& [(IODualSPIWriter *)self _crossingRegionChangeBoundary])
    {
      ...
      *(&self->_regBuffer + 4) = &unk_10A090;
      [v8 setImageAddress:0x20000];
      [v8 setSecondaryPayloadOffset:0x400000];
    }

    iBU_LOG_real(@"Writing updated header and images.", "[IODualSPIWriter writeNewerGenerationFirmware:withError:]", v68, v69, v70, v71, v72, v73, v119);
    v74 = [(IODualSPIWriter *)self _writeFirmware:a3 toHeader:v8 withError:&v121];
    v75 = [v8 headerGeneration];
    [v8 startLocation];
    if (v74)
    {
      iBU_LOG_real(@"Failed to write newer-generation firmware images to update header with generation 0x%x at offset 0x%x. Invalidating this header, then trying again with a different header.", "[IODualSPIWriter writeNewerGenerationFirmware:withError:]", v76, v77, v78, v79, v80, v81, v75);
    }

    else
    {
      iBU_LOG_real(@"Successfully wrote newer-generation firmware images to update header with generation 0x%x at offset 0x%x.", "[IODualSPIWriter writeNewerGenerationFirmware:withError:]", v76, v77, v78, v79, v80, v81, v75);
      if (![(IOServiceWriter *)self shouldCommit])
      {
        goto LABEL_54;
      }

      v88 = [v8 headerGeneration];
      iBU_LOG_real(@"Committing updated header with newer-generation 0x%x", "[IODualSPIWriter writeNewerGenerationFirmware:withError:]", v89, v90, v91, v92, v93, v94, v88);
      v95 = [(IODualSPIWriter *)self _commitHeader:v8 withError:&v121];
      v96 = [v8 headerGeneration];
      [v8 startLocation];
      if (!v95)
      {
        iBU_LOG_real(@"Successfully committed header with newer-generation 0x%x at offset 0x%x.", "[IODualSPIWriter writeNewerGenerationFirmware:withError:]", v97, v98, v99, v100, v101, v102, v96);
LABEL_54:
        iBU_LOG_real(@"Successfully wrote newer-generation firmware after %d retries.", "[IODualSPIWriter writeNewerGenerationFirmware:withError:]", v82, v83, v84, v85, v86, v87, v7);
        v110 = 0;
        if (!v6)
        {
          return v110;
...
LABEL_55:
      ...
      iBU_LOG_real(@"Failed to commit header with newer-generation 0x%x at offset 0x%x. Invalidating this header, then trying again with a different header.", "[IODualSPIWriter writeNewerGenerationFirmware:withError:]", v97, v98, v99, v100, v101, v102, v96);
    }
  ...
  if (a4)
  {
    *a4 = MSUBootFirmwareError(-536870167, 0, @"writeNewerGenerationFirmware: couldn't find enough headers after %d retries.", v103, v104, v105, v106, v107, (v108 - 1));
  }
  ...
  while (1)
  {
    ...
    if ([v6 count] <= 1)
    {
      ...
      if (a4)
      {
        v77 = (v10 - 1);
        v78 = [v6 count];
        *a4 = MSUBootFirmwareError(-536870167, 0, @"writeFirstGenerationFirmware: couldn't find enough headers (only found %d of %d)", v79, v80, v81, v82, v83, v78);
LABEL_18:
        v84 = -536870167;
        *v76 = MSUBootFirmwareError(-536870167, 0, @"writeFirstGenerationFirmware: couldn't find enough headers after %d retries.", v69, v70, v71, v72, v73, v77);
        if (!v6)
        {
          return v84;
        }
...
LABEL_20:
    ...
    if (![(IODualSPIWriter *)self _writeFirmware:v4 toHeader:v11 withError:&v91])
    {
      break;
    }

    v37 = [v11 startLocation];
    iBU_LOG_real(@"Failed to write firmware images to header0 at offset 0x%x. Invalidating this header, then trying again with a different header.", "[IODualSPIWriter writeFirstGenerationFirmware:withError:]", v38, v39, v40, v41, v42, v43, v37);
LABEL_13:
  ...
  v48 = [v12 startLocation];
  if (v47)
  {
    iBU_LOG_real(@"Failed to erase header1 at offset 0x%x. Invalidating this header, then trying again with a different header.", "[IODualSPIWriter writeFirstGenerationFirmware:withError:]", v49, v50, v51, v52, v53, v54, v48);
LABEL_12:
    v7 = v46;
    v8 = v45;
    v9 = v44;
  ...
  iBU_LOG_real(@"Successfully wrote header1 at offset 0x%x.", "[IODualSPIWriter writeFirstGenerationFirmware:withError:]", v49, v50, v51, v52, v53, v54, v48);
  if (![(IOServiceWriter *)self shouldCommit])
  {
    goto LABEL_24;
  }
  ...
  v62 = [v11 startLocation];
  if (v61)
  {
    iBU_LOG_real(@"Failed to commit header0 at offset 0x%x to the first partition. Invalidating this header, then trying again with a different header.", "[IODualSPIWriter writeFirstGenerationFirmware:withError:]", v63, v64, v65, v66, v67, v68, v62);
    v12 = v11;
    goto LABEL_12;
  }

  iBU_LOG_real(@"Successfully committed header0 at offset 0x%x.", "[IODualSPIWriter writeFirstGenerationFirmware:withError:]", v63, v64, v65, v66, v67, v68, v62);
LABEL_24:
...
- (void)markHeaderAsInvalid:(id)a3
{
  iBU_LOG_real(@"Marking header as invalid: %@", "[IODualSPIWriter markHeaderAsInvalid:]", a3, v3, v4, v5, v6, v7, a3);
  v10 = [(IODualSPIWriter *)self invalidHeaders];
...
- (BOOL)headerIsInvalid:(id)a3
{
  ...
  v14 = 0u;
  v15 = 0u;
  v4 = [(IODualSPIWriter *)self invalidHeaders];
...
- (int)commitHeaderAtIndex:(unint64_t)a3 withError:(id *)a4
{
  v7 = [(IODualSPIWriter *)self findHeaders];
  if ([v7 count] >= a3 + 1)
  {
    v8 = -[IODualSPIWriter _commitHeader:withError:](self, "_commitHeader:withError:", [v7 objectAtIndex:a3], a4);
  }
  ...
  else
  {
    ...
    {
      v9 = [v7 count];
      *a4 = MSUBootFirmwareError(-536870212, 0, @"commitHeaderAtIndex: couldn't find enough headers (only found %d of %d)", v10, v11, v12, v13, v14, v9);
    }
  }
...
- (int)commitPreparedHeaderWithError:(id *)a3
{
  v5 = [(IODualSPIWriter *)self findPreparedHeader];
...
- (unint64_t)findPreparedHeader
{
  v2 = [(IODualSPIWriter *)self findHeaders];
  if ([v2 count] > 1)
  {
...
- (id)findHeaders
{
  if ([(IODualSPIWriter *)self usesAFUH])
  {
    ...
    v76 = [(IODualSPIWriter *)self _usesExtendediBootRegion];
    if (v76)
    {
...
- (id)readDataAtOffset:(unsigned int)a3 ofLength:(unsigned int)a4
{
  ...
  {
    v10 = [NSData dataWithBytes:&v9[v5 & 0xFFF] length:a4];
  }
...
- (BOOL)verifyHeadersAtIndex:(unint64_t)a3
{
  v4 = [(IODualSPIWriter *)self findHeaders];
  if ([v4 count] <= 1)
  {
    v23 = [v4 count];
...
LABEL_3:
  ...
  v14 = [v4 objectAtIndexedSubscript:a3];
  if (v14 == v12)
  {
    v12 = v13;
  }
  ...
  if ([v12 isValid])
  {
    v15 = [v14 headerGeneration];
    if (v15 > [v12 headerGeneration])
    {
      v11 = 1;
      goto LABEL_9;
    }
    ...
    iBU_LOG_real(@"Header at partition %lu does not have a larger generation count than existing valid header (%d !> %d)", "[IODualSPIWriter verifyHeadersAtIndex:]", v17, v18, v19, v20, v21, v22, a3);
    goto LABEL_3;
  }
...
- (BOOL)verifyFirmwareAtIndex:(unint64_t)a3 againstData:(id)a4
{
  ...
  if ([v7 count] >= a3 + 1)
  {
    v16 = [v7 objectAtIndexedSubscript:a3];
    v17 = objc_autoreleasePoolPush();
    v15 = [-[IODualSPIWriter readDataAtOffset:ofLength:](self readDataAtOffset:objc_msgSend(v16 ofLength:{"imageAddress"), objc_msgSend(a4, "length")), "isEqual:", a4}];
    if ((v15 & 1) == 0)
    {
...
- (int)readDataAtOffset:(unsigned int)a3 ofLength:(unsigned int)a4 intoBuffer:(void *)a5
{
  ...
  input[1] = a4;
  outputStructCnt = a4;
  iBU_LOG_real(@"inputs[0] = 0x%llx; inputs[1] = 0x%llx; buf = %p; outSize = 0x%lx; &outSize = %p\n", "[IODualSPIWriter readDataAtOffset:ofLength:intoBuffer:]", *&a3, *&a4, a5, v5, v6, v7, a3);
  v10 = IOConnectCallMethod([(IODualSPIWriter *)self spiDriverConnect], 2u, input, 2u, 0, 0, 0, 0, a5, &outputStructCnt);
...
- (int)eraseBytes:(unsigned int)a3 ofLength:(unsigned int)a4 withError:(id *)a5
{
  ...
  input[0] = a3;
  input[1] = a4;
  iBU_LOG_real(@"inputs[0] = 0x%llx; inputs[1] = 0x%llx", "[IODualSPIWriter eraseBytes:ofLength:withError:]", *&a3, *&a4, a5, v5, v6, v7, a3);
...
{
  v9 = [a4 packStructure];
  v10 = [[NSMutableData alloc] initWithData:a3];
  v111 = [v9 bytes];
  v112 = 0;
  v11 = [(IODualSPIWriter *)self _usesExtendediBootRegion];
  v12 = [(IODualSPIWriter *)self _maxImageSize];
  v13 = [(IODualSPIWriter *)self _maxExtendedRegionSize]+ v12;
  v14 = [(IODualSPIWriter *)self _maxImageSize];
...
LABEL_8:
    ...
    v55 = [(IODualSPIWriter *)self _writeBytes:v51 atOffset:v52 ofLength:v54 withError:&v112];
    if (v55)
    {
      v29 = v55;
      v56 = [a4 imageAddress];
      iBU_LOG_real(@"Failed to write firmware images to offset 0x%x with error %d", "[IODualSPIWriter _writeFirmware:toHeader:withError:]", v57, v58, v59, v60, v61, v62, v56);
      if (!a5)
      {
        return v29;
      }
    ...
    else
    {
      ...
      if (v72 == 1)
      {
        ...
        v81 = -[IODualSPIWriter _writeBytes:atOffset:ofLength:withError:](self, "_writeBytes:atOffset:ofLength:withError:", [v10 bytes] + v71, objc_msgSend(a4, "secondaryPayloadOffset"), v80, &v112);
        if (v81)
        {
          v29 = v81;
      ...
      iBU_LOG_real(@"Writing header structure: %@.", "[IODualSPIWriter _writeFirmware:toHeader:withError:]", v74, v75, v76, v77, v78, v79, a4);
      v29 = -[IODualSPIWriter _writeBytes:atOffset:ofLength:withError:](self, "_writeBytes:atOffset:ofLength:withError:", v111, [a4 startLocation], objc_msgSend(v9, "length"), &v112);
      if (!v29)
      {
      ...
      v88 = [a4 startLocation];
      iBU_LOG_real(@"Failed to write header structure to offset 0x%x with error %d", "[IODualSPIWriter _writeFirmware:toHeader:withError:]", v89, v90, v91, v92, v93, v94, v88);
      if (!a5)
      {
        return v29;
      }
      ...
      v63 = v112;
      v109 = [a4 startLocation];
      v69 = @"Failed to write header structure to offset 0x%x with error %d";
    }

LABEL_15:
    v35 = MSUBootFirmwareError(3, v63, v69, v64, v65, v66, v67, v68, v109);
    goto LABEL_16;
  }
  ...
  if (v21 <= v13)
  {
    ...
    [v10 increaseLengthBy:{v13 - objc_msgSend(a3, "length")}];
    goto LABEL_8;
  }
...
- (int)_commitHeader:(id)a3 withError:(id *)a4
{
  if ([a3 isValid])
  {
    if (a4)
    {
      *a4 = MSUBootFirmwareError(4, 0, @"Header wasn't prepared / invalid at time of commit: %@", v7, v8, v9, v10, v11, a3);
    }
  ...
  {
    [a3 makeValid];
    v13 = [a3 packStructure];
    v14 = [v13 bytes];
    iBU_LOG_real(@"Committing valid header via flash as: %@", "[IODualSPIWriter _commitHeader:withError:]", v15, v16, v17, v18, v19, v20, a3);
    v21 = [a3 startLocation];
    v22 = [v13 length];
...
- (int)_writeBytes:(char *)a3 atOffset:(unsigned int)a4 ofLength:(unsigned int)a5 withError:(id *)a6
{
  ...
  input[0] = a4;
  input[1] = a5;
  iBU_LOG_real(@"inputs[0] = 0x%llx; inputs[1] = 0x%llx", "[IODualSPIWriter _writeBytes:atOffset:ofLength:withError:]", a3, *&a4, *&a5, a6, v6, v7, a4);
  v13 = IOConnectCallMethod([(IODualSPIWriter *)self spiDriverConnect], 1u, input, 2u, a3, v12, 0, 0, 0, 0);
  v19 = v13;
  if (a6 && v13)
  {
