...
- (int)writeNewerGenerationFirmware:(id)firmware withError:(id *)error
{
  ...
  do
  {
    ...
    if ([findHeaders count] <= 1)
    {
      if (error)
      {
        v111 = [findHeaders count];
        *error = MSUBootFirmwareError(-536870167, 0, @"writeNewerGenerationFirmware: couldn't find enough headers (only found %d of %d)", v112, v113, v114, v115, v116, v111);
      }
...
LABEL_27:
    ...
    else
    {
      ...
      if (headerGeneration2 != -1)
      {
        ...
        {
          if (headerGeneration4 <= [v18 headerGeneration])
          {
            v67 = v18;
          }
          ...
          headerGeneration3 = [v67 headerGeneration];
        }
      }
    }
    ...
    v74 = [(IODualSPIWriter *)self _writeFirmware:firmware toHeader:v8 withError:&v121];
    headerGeneration5 = [v8 headerGeneration];
    [v8 startLocation];
    if (v74)
    {
      iBU_LOG_real(@"Failed to write newer-generation firmware images to update header with generation 0x%x at offset 0x%x. Invalidating this header, then trying again with a different header.", "[IODualSPIWriter writeNewerGenerationFirmware:withError:]", v76, v77, v78, v79, v80, v81, headerGeneration5);
    }

    else
    {
      iBU_LOG_real(@"Successfully wrote newer-generation firmware images to update header with generation 0x%x at offset 0x%x.", "[IODualSPIWriter writeNewerGenerationFirmware:withError:]", v76, v77, v78, v79, v80, v81, headerGeneration5);
      ...
      iBU_LOG_real(@"Committing updated header with newer-generation 0x%x", "[IODualSPIWriter writeNewerGenerationFirmware:withError:]", v89, v90, v91, v92, v93, v94, headerGeneration6);
      v95 = [(IODualSPIWriter *)self _commitHeader:v8 withError:&v121];
      headerGeneration7 = [v8 headerGeneration];
      [v8 startLocation];
      if (!v95)
      {
        iBU_LOG_real(@"Successfully committed header with newer-generation 0x%x at offset 0x%x.", "[IODualSPIWriter writeNewerGenerationFirmware:withError:]", v97, v98, v99, v100, v101, v102, headerGeneration7);
LABEL_54:
...
LABEL_55:
      ...
      iBU_LOG_real(@"Failed to commit header with newer-generation 0x%x at offset 0x%x. Invalidating this header, then trying again with a different header.", "[IODualSPIWriter writeNewerGenerationFirmware:withError:]", v97, v98, v99, v100, v101, v102, headerGeneration7);
    }
  ...
  if (error)
  {
    *error = MSUBootFirmwareError(-536870167, 0, @"writeNewerGenerationFirmware: couldn't find enough headers after %d retries.", v103, v104, v105, v106, v107, (v108 - 1));
  }
