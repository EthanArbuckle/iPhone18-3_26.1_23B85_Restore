...
+ (id)updaterWithIOService:(unsigned int)a3
{
  ...
  if (objc_opt_class() == a1)
  {
    ...
    v11 = 0u;
    v12 = 0u;
    v7 = [a1 _updaterClasses];
    result = [v7 countByEnumeratingWithState:&v11 objects:v15 count:16];
    if (result)
    {
      v8 = result;
      v9 = *v12;
LABEL_7:
  ...
  {
    v5 = [[a1 alloc] initWithIOService:v3];
...
- (id)_restoreInfoDictionary
{
  ...
  else
  {
    ...
    if (!v5)
    {
      v5 = sub_4F81C("IODeviceTree:/chosen", @"boot-nonce");
      if (!v5)
      {
