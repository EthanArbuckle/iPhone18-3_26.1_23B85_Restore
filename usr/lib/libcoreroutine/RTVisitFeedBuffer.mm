...
- (id)maturedLocations
{
  if ([(NSMutableArray *)self->_locations count])
  {
    ...
    else
    {
      ...
      v6 = [(NSMutableArray *)self->_locations lastObject];
      [v6 latitude];
      v8 = v7;
      v9 = [(NSMutableArray *)self->_locations lastObject];
      [v9 longitude];
      v11 = v10;
...
- (void)addLocations:(id)a3
{
  ...
  if (os_log_type_enabled(MEMORY[0x277D86220], OS_LOG_TYPE_DEBUG))
  {
    ...
    if (os_log_type_enabled(v5, OS_LOG_TYPE_DEBUG))
    {
      ...
      v22 = [(NSDate *)self->_lastMaturedLocationDate stringFromDate];
      ...
      do
      {
        ...
        if (self->_lastMaturedLocationDate && ([*(*(&v25 + 1) + 8 * v12) date], v14 = objc_claimAutoreleasedReturnValue(), v15 = objc_msgSend(v14, "isOnOrBefore:", self->_lastMaturedLocationDate), v14, v15))
        {
          if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
          {
            ...
            {
              v17 = [(NSDate *)self->_lastMaturedLocationDate stringFromDate];
              v18 = [v13 date];
              [v18 timeIntervalSinceDate:self->_lastMaturedLocationDate];
              *buf = v24;
              v31 = v13;
              v32 = 2112;
              v33 = v17;
