...
+ (id)createWithVisitMO:()RTCoreDataTransformable
{
  ...
  v16 = [v4 initWithLatitude:v14 longitude:objc_msgSend(v15 horizontalUncertainty:"unsignedIntValue") date:v7 referenceFrame:{v10, v13}];
  ...
  if (v17)
  {
    ...
    v59 = [v23 initWithMapItem:v57 finerGranularityMapItem:v55 userType:v60 userTypeSource:v25 placeType:v27 referenceLocation:v61 confidence:v30 finerGranularityMapItemConfidence:v33 loiIdentifier:v34];
  }
  ...
  v43 = v42;
  v44 = [v3 source];
  v45 = [v35 initWithDate:v58 type:v56 location:v61 entry:v37 exit:v38 dataPointCount:v40 confidence:v43 placeInference:v59 source:{objc_msgSend(v44, "unsignedIntValue")}];
...
- (id)managedObjectWithContext:()RTCoreDataTransformable
{
  if (a3)
  {
    v3 = [RTVisitMO managedObjectWithVisit:a1 inManagedObjectContext:a3];
  }
