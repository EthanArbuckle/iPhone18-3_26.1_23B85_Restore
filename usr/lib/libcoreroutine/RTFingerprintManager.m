...
- (void)_setup
{
  v3 = [(RTFingerprintManager *)self defaultsManager];
  v6 = [v3 objectForKey:@"RTDefaultsFingerprintManagerAccessPointsFetchLimit"];
  ...
  v4 = [(RTFingerprintManager *)self fingerprintStore];
...
- (void)_shutdownWithHandler:(id)a3
{
  ...
  v5 = [(RTFingerprintManager *)self scanRequestTimer];
  [v5 invalidate];

  [(RTFingerprintManager *)self setScanRequestTimer:0];
  v6 = [(RTFingerprintManager *)self scanResultTimer];
  [v6 invalidate];
...
LABEL_6:
    ...
    if (v13 && v14 && v15 && v16)
    {
      ...
      if (v19)
      {
        ...
        objc_storeStrong(&v20->_fingerprintStore, a4);
        objc_storeStrong(&v20->_scenarioTriggerManager, a5);
        objc_storeStrong(&v20->_timerManager, obj);
        objc_storeStrong(&v20->_wifiManager, v30);
...
LABEL_15:
    ...
    v13 = [(RTFingerprintManager *)self scenarioTriggerManager];
    v14 = +[(RTNotification *)RTScenarioTriggerManagerNotificationSettled];
    [v13 addObserver:self selector:sel_onSettledNotification_ name:v14];

    v15 = [(RTFingerprintManager *)self scenarioTriggerManager];
    v16 = +[(RTNotification *)RTScenarioTriggerManagerNotificationUnsettled];
    [v15 addObserver:self selector:sel_onUnsettledNotification_ name:v16];
...
LABEL_9:
  v8 = [(RTFingerprintManager *)self scenarioTriggerManager];
  ...
  v11 = [(RTFingerprintManager *)self scanRequestTimer];
  [v11 invalidate];

  [(RTFingerprintManager *)self setScanRequestTimer:0];
  v12 = [(RTFingerprintManager *)self scanResultTimer];
  [v12 invalidate];
...
- (void)setSettledState:(unint64_t)a3
{
  ...
  if (settledState != a3)
  {
    ...
    else if (a3 != 2 || settledState)
    {
      ...
      v23 = [(RTFingerprintManager *)self timerManager];
      ...
      if (v33)
      {
        v34 = [(RTFingerprintManager *)self defaultsManager];
        v35 = [v34 objectForKey:@"RTDefaultsFingerprintManagerScanRequestTimerDuration"];
        [v35 doubleValue];
        v37 = v36;
      }
      ...
      v19 = [(RTFingerprintManager *)self scanRequestTimer];
      [v19 resume];
      goto LABEL_32;
    }
    ...
    v12 = [(RTFingerprintManager *)self scanRequestTimer];
    [v12 invalidate];

    [(RTFingerprintManager *)self setScanRequestTimer:0];
    v13 = [(RTFingerprintManager *)self scanResultTimer];

    if (v13)
    {
      v14 = [(RTFingerprintManager *)self wifiManager];
      [v14 removeObserver:self];

      v15 = [(RTFingerprintManager *)self scanResultTimer];
      [v15 invalidate];
    ...
    if ([(RTFingerprintManager *)self fingerprintMonitoringEnabled])
    {
      ...
      v19 = [v16 initWithIdentifier:v17 settledState:2 start:v18 accessPoints:0];

      v20 = [(RTFingerprintManager *)self fingerprintStore];
      v41 = v19;
...
- (void)_startScanRequestForUnsettledState
{
  ...
  if ([(RTFingerprintManager *)self fingerprintMonitoringEnabled])
  {
    ...
    v7 = [v4 initWithIdentifier:v5 settledState:1 start:v6 accessPoints:0];

    v8 = [(RTFingerprintManager *)self fingerprintStore];
    v11[0] = v7;
