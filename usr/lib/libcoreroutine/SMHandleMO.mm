...
+ (id)managedObjectWithSMHandle:(id)handle managedObject:(id)object inManagedObjectContext:(id)context;
@end
...
void __77__SMHandleMO_managedObjectWithSMHandle_managedObject_inManagedObjectContext___block_invoke(uint64_t a1)
{
  ...
  if (!v2)
  {
    v3 = [[SMHandleMO alloc] initWithContext:*(a1 + 40)];
  }
  ...
  v4 = [*(a1 + 48) primaryHandle];
  [*(*(*(a1 + 56) + 8) + 40) setPrimaryHandle:v4];

  v5 = MEMORY[0x277CBEB70];
  v7 = [*(a1 + 48) secondaryHandles];
  v6 = [v5 orderedSetWithArray:v7];
  [*(*(*(a1 + 56) + 8) + 40) setSecondaryHandles:v6];
}
