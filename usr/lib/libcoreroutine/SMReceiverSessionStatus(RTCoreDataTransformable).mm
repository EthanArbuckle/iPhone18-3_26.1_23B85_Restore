...
LABEL_12:
  ...
  {
    v4 = [objc_opt_class() createWithReceiverSessionStatusMO:v3];
    goto LABEL_8;
  }
...
+ (id)createWithReceiverSessionStatusMO:()RTCoreDataTransformable
{
  ...
  else
  {
    ...
    {
      *buf = 0;
      _os_log_error_impl(&dword_2304B3000, v7, OS_LOG_TYPE_ERROR, "Invalid parameter not satisfying: sessionStatusMO", buf, 2u);
    }
