...
void __103__SMSessionManagerStatusMO_managedObjectWithSessionManagerStatus_managedObject_inManagedObjectContext___block_invoke(uint64_t a1)
{
  ...
  if (!v2)
  {
    v3 = [[SMSessionManagerStatusMO alloc] initWithContext:*(a1 + 40)];
  }
  ...
  v5 = [*(a1 + 48) stateQueryDate];
  [*(*(*(a1 + 56) + 8) + 40) setStateQueryDate:v5];

  v6 = [*(a1 + 48) lastSessionIDDuringMagnetBreak];
  [*(*(*(a1 + 56) + 8) + 40) setLastSessionIDDuringMagnetBreak:v6];

  v8 = [*(a1 + 48) state];
  v7 = [SMSessionManagerStateMO initWithSessionManagerState:v8 inManagedObjectContext:*(a1 + 40)];
  [*(*(*(a1 + 56) + 8) + 40) setState:v7];
}
