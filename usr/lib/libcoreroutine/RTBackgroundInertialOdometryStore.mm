...
- (RTBackgroundInertialOdometryStore)initWithPersistenceManager:(id)manager;
...
- (void)_fetchStoredBackgroundInertialOdometrySamplesWithContext:(id)context handler:(id)handler;
- (void)_fetchStoredBackgroundInertialOdometrySamplesWithOptions:(id)options handler:(id)handler;
- (void)_purgeBackgroundInertialOdometrySamplesPredating:(id)predating handler:(id)handler;
- (void)fetchStoredBackgroundInertialOdometrySamplesWithContext:(id)context handler:(id)handler;
- (void)fetchStoredBackgroundInertialOdometrySamplesWithOptions:(id)options handler:(id)handler;
- (void)purgeBackgroundInertialOdometrySamplesPredating:(id)predating handler:(id)handler;
- (void)storeBackgroundInertialOdometrySamples:(id)samples handler:(id)handler;
@end
...
- (void)_fetchStoredBackgroundInertialOdometrySamplesWithOptions:(id)options handler:(id)handler
{
  ...
  v9 = [objc_alloc(MEMORY[0x277D01098]) initWithEnumerationOptions:optionsCopy];
  [(RTBackgroundInertialOdometryStore *)self _fetchStoredBackgroundInertialOdometrySamplesWithContext:v9 handler:handlerCopy];
}
...
- (void)_purgeBackgroundInertialOdometrySamplesPredating:(id)predating handler:(id)handler
{
  ...
  if (predatingCopy)
  {
    ...
    [(RTStore *)self purgePredating:predatingCopy predicateMappings:v9 purgeLimit:7200 handler:handlerCopy];
  }
