...
+ (id)createWithManagedObject:()RTCoreDataTransformable
{
  ...
  if (v3)
  {
    ...
    {
      v4 = [objc_opt_class() createWithHintMO:v3];
      goto LABEL_8;
    }
...
+ (id)createWithHintMO:()RTCoreDataTransformable
{
  ...
  if (v3)
  {
    *buf = 0;
    v13 = buf;
    v14 = 0x3032000000;
    v15 = __Block_byref_object_copy__147;
    v16 = __Block_byref_object_dispose__147;
    v17 = 0;
  ...
  else
  {
    ...
    {
      *buf = 0;
      _os_log_error_impl(&dword_2304B3000, v7, OS_LOG_TYPE_ERROR, "Invalid parameter not satisfying: hintMO", buf, 2u);
    }
...
- (id)managedObjectWithContext:()RTCoreDataTransformable
{
  if (a3)
  {
    v3 = [RTHintMO managedObjectWithHint:self inManagedObjectContext:a3];
  }
