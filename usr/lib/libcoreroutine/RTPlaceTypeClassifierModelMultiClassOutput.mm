...
- (RTPlaceTypeClassifierModelMultiClassOutput)initWithTarget:(int64_t)target classProbability:(id)probability;
...
- (RTPlaceTypeClassifierModelMultiClassOutput)initWithTarget:(int64_t)target classProbability:(id)probability
{
  ...
  v11.receiver = self;
  v11.super_class = RTPlaceTypeClassifierModelMultiClassOutput;
...
- (id)featureValueForName:(id)name
{
  ...
  {
    v5 = [MEMORY[0x277CBFEF8] featureValueWithInt64:{-[RTPlaceTypeClassifierModelMultiClassOutput target](self, "target")}];
  }

  else if ([nameCopy isEqualToString:@"classProbability"])
  {
    v6 = MEMORY[0x277CBFEF8];
    classProbability = [(RTPlaceTypeClassifierModelMultiClassOutput *)self classProbability];
