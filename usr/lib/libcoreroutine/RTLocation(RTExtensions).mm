...
- (uint64_t)initWithRTPLocation:()RTExtensions
{
  ...
  v16 = [self initWithLatitude:v12 longitude:v13 horizontalUncertainty:v6 altitude:v8 verticalUncertainty:v10 date:-1.0 referenceFrame:-1.0 speed:v15];
  return v16;
}
...
- (id)initWithCLLocation:()RTExtensions
{
  if (a3)
  {
    ...
    self = [self initWithLatitude:timestamp longitude:referenceFrame horizontalUncertainty:v5 altitude:v7 verticalUncertainty:v9 date:v11 referenceFrame:v13 speed:v15 sourceAccuracy:v19];
    selfCopy = self;
  }
...
- (id)initWithRTPair:()RTExtensions
{
  ...
  if (v4)
  {
    ...
    if (isKindOfClass)
    {
      ...
      v10 = v9;
      secondObject2 = [v5 secondObject];
      [secondObject2 doubleValue];
      v13 = v12;
      date = [MEMORY[0x277CBEAA8] date];
      self = [self initWithLatitude:date longitude:v10 horizontalUncertainty:v13 date:0.0];
...
- (id)initWithCLLocationCoordinate2D:()RTExtensions
{
  if (a3)
  {
    ...
    v5 = a3[1];
    date = [MEMORY[0x277CBEAA8] date];
    self = [self initWithLatitude:date longitude:v4 horizontalUncertainty:v5 date:0.0];
...
- (id)initWithCLCircularRegion:()RTExtensions
{
  ...
  if (v4)
  {
    ...
    v9 = v8;
    [v5 geoRadius];
    self = [self initWithLatitude:0 longitude:objc_msgSend(v5 horizontalUncertainty:"geoReferenceFrame") date:v7 referenceFrame:{v9, v10}];
    selfCopy = self;
  }
  ...
  if (os_log_type_enabled(MEMORY[0x277D86220], OS_LOG_TYPE_DEBUG))
  {
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_DEBUG))
    {
      ...
      *buf = 138412802;
      ...
      v48 = 1024;
      referenceFrame2 = [v9 referenceFrame];
...
LABEL_18:
  ...
  {
    v39 = 0;
    v27 = [v10 shiftedLocation:selfCopy allowNetwork:0 error:&v39];
    v21 = selfCopy;
    v22 = v39;
    selfCopy = v27;
  }
    ...
    if (v9)
    {
      ...
      else
      {
        ...
        if (v10)
        {
          ...
          [selfCopy3 _distanceBetweenShiftedLocation:selfCopy2 unshiftedLocation:selfCopy4 locationShifter:v10 handler:v11];
        }
...
- (id)locationAtDistance:()RTExtensions course:
{
  ...
  v13 = [v7 initWithCoordinate:date altitude:v11.latitude horizontalAccuracy:v11.longitude verticalAccuracy:0.0 course:v12 speed:-1.0 timestamp:{a3, a2}];
  ...
  v21 = v20;
  date2 = [self date];
  v23 = [v15 initWithLatitude:date2 longitude:objc_msgSend(self horizontalUncertainty:"referenceFrame") date:v17 referenceFrame:{v19, v21}];
