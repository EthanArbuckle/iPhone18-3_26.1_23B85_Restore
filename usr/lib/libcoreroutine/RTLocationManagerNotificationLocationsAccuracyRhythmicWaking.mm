...
- (RTLocationManagerNotificationLocationsAccuracyRhythmicWaking)initWithLocations:(id)locations;
@end
...
- (RTLocationManagerNotificationLocationsAccuracyRhythmicWaking)initWithLocations:(id)locations
{
  ...
  v9.receiver = self;
  v9.super_class = RTLocationManagerNotificationLocationsAccuracyRhythmicWaking;
