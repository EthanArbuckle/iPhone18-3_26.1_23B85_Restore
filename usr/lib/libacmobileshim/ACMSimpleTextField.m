...
- (ACMSimpleTextField)initWithFrame:(CGRect)a3
{
  ...
  v3 = [(ACMSimpleTextField *)&v8 initWithFrame:a3.origin.x, a3.origin.y, a3.size.width, a3.size.height];
  if (v3)
  {
...
- (CGRect)textRectForBounds:(CGRect)a3
{
  ...
  [(ACMSimpleTextField *)self clearButtonRectForBounds:a3.origin.x, a3.origin.y, a3.size.width];
  v5 = v4 + -7.0 + -6.0;
  v6 = height + -4.0;
  v7 = 7.0;
  v8 = 2.0;
