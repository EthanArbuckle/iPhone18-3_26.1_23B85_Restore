        ...
        else if (*a3)
        {
          ...
          *(v7 + 192) = v14;
          ...
          if (os_log_type_enabled(v17, OS_LOG_TYPE_DEFAULT))
          {
            ...
            *buf = 136315138;
            v22 = v18;
            _os_log_impl(&dword_296FF7000, v17, OS_LOG_TYPE_DEFAULT, "#I Baseband field test config:\n%s", buf, 0xCu);
            if (v20 < 0)
            {
...
void sub_2970F1384(_Unwind_Exception *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, xpc_object_t object, char a14, uint64_t a15, void *__p, uint64_t a17, int a18, __int16 a19, char a20, char a21)
{
  if (a21 < 0)
  {
    operator delete(__p);
...
void sub_2970F2098(_Unwind_Exception *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, uint64_t a10, char a11)
{
  xpc_release(v11);
...
void sub_2970F2CB4(_Unwind_Exception *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, uint64_t a10, char a11)
{
  xpc_release(v11);
  std::shared_ptr<Registry>::~shared_ptr[abi:ne200100](&a11);
  _Unwind_Resume(a1);
...
void sub_2970F38D0(_Unwind_Exception *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, uint64_t a10, char a11)
{
  xpc_release(v11);
  std::shared_ptr<Registry>::~shared_ptr[abi:ne200100](&a11);
  _Unwind_Resume(a1);
...
void sub_2970F43D4(_Unwind_Exception *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, uint64_t a10, char a11)
{
  xpc_release(v11);
  std::shared_ptr<Registry>::~shared_ptr[abi:ne200100](&a11);
  _Unwind_Resume(a1);
...
void sub_2970F4ED4(_Unwind_Exception *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, uint64_t a10, char a11)
{
  xpc_release(v11);
  std::shared_ptr<Registry>::~shared_ptr[abi:ne200100](&a11);
  _Unwind_Resume(a1);
...
void sub_2970F5A50(_Unwind_Exception *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, xpc_object_t object, char a11)
{
  xpc_release(object);
  std::shared_ptr<Registry>::~shared_ptr[abi:ne200100](&a11);
  _Unwind_Resume(a1);
...
LABEL_102:
                  ...
                  *&__dst = xpc_null_create();
                  ...
                  if (v58)
                  {
                    ...
                    {
                      if (MEMORY[0x29C26CE60](v59) == MEMORY[0x29EDCAA00])
                      {
                        xpc_retain(v59);
                        v60 = v59;
                      }
...
LABEL_67:
  ...
  {
    LOWORD(object[0]) = 0;
    _os_log_error_impl(&dword_296FF7000, v62, OS_LOG_TYPE_ERROR, "Ticket was not provided", object, 2u);
  }
...
LABEL_58:
    ...
    {
      LOWORD(object[0]) = 0;
      _os_log_error_impl(&dword_296FF7000, v37, OS_LOG_TYPE_ERROR, "No radio driver", object, 2u);
    }
...
LABEL_29:
  ...
  {
    LOWORD(object[0]) = 0;
    _os_log_error_impl(&dword_296FF7000, v42, OS_LOG_TYPE_ERROR, "Ticket was not provided", object, 2u);
  }
        ...
        else
        {
          ...
          if (*a3)
          {
            ...
            if (os_log_type_enabled(v16, OS_LOG_TYPE_DEFAULT))
            {
              *object = 138412290;
              *&object[4] = v15;
              _os_log_impl(&dword_296FF7000, v16, OS_LOG_TYPE_DEFAULT, "#I Get Antenna Port Info: %@", object, 0xCu);
            }
          }
        }
...
LABEL_53:
  ...
  *&aBlock[16] = ___ZZZN11RadioModule28registerCommandHandlers_syncEvEUb13_ENK4__16clEv_block_invoke;
  v61 = &__block_descriptor_tmp_263_0;
  shared_weak_owners = v1->__shared_weak_owners_;
  v15 = v1[1].__vftable;
  v63 = v15;
  if (v15)
...
void sub_2970FBF94(_Unwind_Exception *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, xpc_object_t object, char a11)
{
  xpc_release(object);
  std::shared_ptr<Registry>::~shared_ptr[abi:ne200100](&a11);
  _Unwind_Resume(a1);
