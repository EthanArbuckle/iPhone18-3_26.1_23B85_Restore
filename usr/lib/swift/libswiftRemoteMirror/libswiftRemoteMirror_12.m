...
LABEL_57:
        ...
        while (1)
        {
          ...
          result = swift::Demangle::__runtime::CharVector::append(v6 + 1591, &unk_D3717, 0, *(v6 + 1593));
          ++v32;
          --v31;
          if (v32 > v11)
          {
...
_DWORD *anonymous namespace::Remangler::mangleDependentGenericParamIndex(_DWORD *this, swift::Demangle::__runtime::Node *a2, const char *__s, char a4)
{
  ...
  if (*(a2 + 8) != 87)
  {
    ...
    if (v15)
    {
      ...
      this = swift::Demangle::__runtime::CharVector::append(v4 + 1591, __s, v19, *(v4 + 1593));
      v5 = v4 + 12736;
      v23 = *(v4 + 3184);
      v24 = *(v4 + 3185);
      v25 = *(v4 + 1591);
...
LABEL_72:
            *v5 = v44 + 1;
            ...
            if (v16)
            {
              this = swift::Demangle::__runtime::CharVector::append(v4 + 3182, v16 - 1, *(v4 + 1593));
            }
...
LABEL_53:
    ...
    if (v16)
    {
      ...
      this = swift::Demangle::__runtime::CharVector::append(v4 + 1591, __s, v22, *(v4 + 1593));
      if (v16 != 1)
      {
        this = swift::Demangle::__runtime::CharVector::append(v4 + 3182, v16 - 2, *(v4 + 1593));
      }
...
uint64_t swift::Demangle::__runtime::Demangler::dump(swift::Demangle::__runtime::Demangler *this)
{
  if (*(this + 28))
  {
    ...
    do
    {
      ...
      {
        p_p = v10.__r_.__value_.__r.__words[0];
      }
...
void reportError(const char *a1, const char *a2)
{
  ...
  for (i = qword_E4078[0]; ; i = v7)
  {
    ...
    v7 = 0;
    v8 = v6;
    atomic_compare_exchange_strong_explicit(qword_E4078, &v7, v6, memory_order_release, memory_order_relaxed);
    if (!v7)
    {
      return;
    }
...
LABEL_3:
  ...
  v7 = i;
  atomic_compare_exchange_strong_explicit(qword_E4078, &v7, v8, memory_order_release, memory_order_relaxed);
  if (v7 != i)
  {
    goto LABEL_3;
  }
