...
- (id)parseHCIEvent:(id)a3 withApplet:(id)a4 withPackage:(id)a5 withModule:(id)a6 withTransceiver:(id)a7 withError:(id *)a8
{
  ...
  if ([v14 length] <= 1)
  {
    ...
    v20 = [objc_alloc(MEMORY[0x277CCACA8]) initWithFormat:@"Invalid eventData length %u", objc_msgSend(v14, "length")];
    v21 = v20;
    if (a8)
    {
      v22 = *a8;
      ...
      v35 = ;
      *a8 = [v23 errorWithDomain:@"ATL" code:6 userInfo:v35];
    }
...
LABEL_29:
  ...
  if (v26 != 7)
  {
    ...
    if (a8)
    {
      ...
      v36 = ;
      *a8 = [v32 errorWithDomain:@"ATL" code:2 userInfo:v36];
    }
  ...
  if (v25 <= 16)
  {
    if (v25 == 1)
    {
      v28 = [(AtlasDecoder *)v27 parseStartEvent:v14 withApplet:v15 error:a8];
      goto LABEL_33;
    }

    if (v25 == 2)
    {
      v28 = [(AtlasDecoder *)v27 parseEndEvent:v14 withApplet:v15 error:a8];
      goto LABEL_33;
    }
...
LABEL_37:
    ...
    if (a8)
    {
      ...
      v48 = v47;
      *a8 = [v44 errorWithDomain:@"ATL" code:3 userInfo:v47];
    }
  ...
  if (v25 == 17)
  {
    v28 = [(AtlasDecoder *)v27 parseTransactionEvent:v14 withApplet:v15 error:a8];
    goto LABEL_33;
  }

  if (v25 == 18)
  {
    v28 = [(AtlasDecoder *)v27 parseDeselectEvent:v14 withApplet:v15 error:a8];
    goto LABEL_33;
  }
  ...
  v28 = [(AtlasDecoder *)v27 parseCommandEvent:v14 withApplet:v15 error:a8];
LABEL_33:
  v37 = v28;
  objc_sync_exit(v27);
...
LABEL_33:
      ...
      if (!*(v10 + 2))
      {
        if (v13 == 142)
        {
          a5 = [(AtlasDecoder *)self generateContactEndEvent:v9 withDidError:v12 != 144];
          goto LABEL_29;
        }
...
LABEL_19:
        v74[0] = v21 + 3;
        v74[1] = [v8 length] - 3;
        v37 = [AtlasDecoder DecodeTransactionE1TLV:v74 error:a5];
        v38 = v37;
        if (a5)
        {
          v39 = 0;
...
LABEL_58:
        ...
        if ([v47 sfi] == 8 || objc_msgSend(v47, "sfi") == 29)
        {
          ...
          {
            v50 = [v47 content];
            v51 = [AtlasDecoder decodeEventEntry:v50];
            ...
            if (v51)
            {
              ...
              if (v58)
              {
                ...
                v61 = [(NSNumber *)self->_errorCode longLongValue];
                if ((v61 - 32) >= 2 && (v61 - 131) >= 2)
                {
...
LABEL_61:
  ...
  {
    *buf = 67109120;
    LODWORD(v78) = [v8 length];
    _os_log_impl(&dword_22EEF5000, v10, OS_LOG_TYPE_ERROR, "Invalid eventData length %u", buf, 8u);
  }

  v11 = [objc_alloc(MEMORY[0x277CCACA8]) initWithFormat:@"Invalid eventData length %u", objc_msgSend(v8, "length")];
  v12 = v11;
  if (!a5)
  {
    goto LABEL_63;
  ...
  v36 = 6;
LABEL_62:
  *a5 = [v35 errorWithDomain:@"ATL" code:v36 userInfo:v34];
...
LABEL_32:
    ...
    *a5 = [v17 errorWithDomain:@"ATL" code:3 userInfo:v39];
...
LABEL_18:
    ...
    a5 = [MEMORY[0x277CBEB38] dictionaryWithDictionary:v15];
    v31 = ATLLogObject();
...
- (id)parseDeselectEvent:(id)a3 withApplet:(id)a4 error:(id *)a5
{
  ...
  if ([v8 length] != 3)
  {
    ...
    {
      *buf = 67109120;
      LODWORD(v43) = [v8 length];
      _os_log_impl(&dword_22EEF5000, v16, OS_LOG_TYPE_ERROR, "Invalid eventData length %u", buf, 8u);
    }

    v17 = [objc_alloc(MEMORY[0x277CCACA8]) initWithFormat:@"Invalid eventData length %u", objc_msgSend(v8, "length")];
    v18 = v17;
    if (!a5)
    {
      goto LABEL_24;
...
LABEL_32:
      ...
      *a4 = [v24 errorWithDomain:@"ATL" code:3 userInfo:v40];
...
LABEL_31:
  ...
  if (v6)
  {
    ...
    if (a4)
    {
      ...
      *a4 = [v12 errorWithDomain:@"ATL" code:3 userInfo:v39];
  ...
  else
  {
    ...
    v46 = @"recordData";
    v47 = v10;
    a4 = [MEMORY[0x277CBEAC0] dictionaryWithObjects:&v47 forKeys:&v46 count:1];
  }
  ...
  if (!v23)
  {
    ...
    if (!v22)
    {
      ...
      if (a9)
      {
        ...
        *a9 = [v69 errorWithDomain:@"ATL" code:5 userInfo:v76];
    ...
    v28 = [v83 asHexString];
    [v18 setObject:v28 forKeyedSubscript:@"cardId"];

    v82 = [(AtlasDecoder *)self SelectRemoteTicketingCmd];
    ...
    v80 = v52;
    v99 = v53;
    v55 = [(AtlasDecoder *)self readPartnerRecords:v17 sfi:25 count:1 error:&v99, a9];
    v56 = v99;
    ...
    if (v14)
    {
      v97 = v24;
      v61 = v14;
      v13 = [_TtC24AppletTranslationLibrary17OpaqueDataService serializedHPKEWithData:v60 publicKey:v14 scheme:v15 error:&v97];
      v62 = v97;
...
- (id)getAppletStateAndHistory:(id)a3 withApplet:(id)a4 withPackage:(id)a5 withModule:(id)a6 withError:(id *)a7
{
  ...
  v100 = 0;
  v13 = [v10 transceiveAndCheckSW:v12 error:&v100];
  v14 = v100;
  v15 = v14;
  if (v13)
  {
    ...
    v99 = v15;
    v18 = [(AtlasDecoder *)self readAndDecodeContracts:v10 sfi:9 count:4 error:&v99];
    v19 = v99;
    ...
    else
    {
      ...
      v98 = 0;
      [(AtlasDecoder *)self readAndDecodeHistory:v10 sfi:8 count:10 error:&v98];
      v25 = v24 = self;
      v26 = v98;
      if (v26)
      {
      ...
      else
      {
        ...
        v97 = 0;
        v28 = [(AtlasDecoder *)v24 readAndDecodeBestContractList:v10 sfi:30 error:&v97];
        v29 = v97;
        v81 = v28;
        if (v29)
        {
        ...
        else
        {
          ...
          if (v34)
          {
            ...
            do
            {
              ...
              do
              {
                ...
                if (v51 == 1 && ([MEMORY[0x277CCABB0] numberWithUnsignedShort:v36], v52 = objc_claimAutoreleasedReturnValue(), objc_msgSend(v31, "objectForKeyedSubscript:", v52), v53 = objc_claimAutoreleasedReturnValue(), v53, v52, !v53))
                {
          ...
          v88 = 0;
          v67 = [(AtlasDecoder *)v75 readAndDecodeEnvironment:v10 sfi:7 error:&v88];
          v68 = v88;
          v19 = v68;
          if (v68)
          {
...
- (id)parseHistory:(id)a3 withContractList:(id)a4
{
  ...
  if (v6)
  {
    ...
    do
    {
      ...
      if (v39 && v36)
      {
        v40 = [MEMORY[0x277CBEA90] dataWithIntBE:v36];
      ...
      v44 = [MEMORY[0x277CBEA90] dataWithIntBE:v36];
...
+ (id)decodeBestContractList:(id)a3
{
  ...
  if ([v3 length] == 29)
  {
    ...
    if (v4)
    {
      ...
      do
      {
        v8 = [v3 readBinaryValueAtBit:v7 numberOfBits:{3, v25}];
        v9 = [v3 readBinaryValueAtBit:v7 + 3 numberOfBits:4];
        v10 = [v3 readBinaryValueAtBit:v7 + 7 numberOfBits:8];
        v11 = [v3 readBinaryValueAtBit:v7 + 15 numberOfBits:4];
        v12 = [v3 readBinaryValueAtBit:v7 + 19 numberOfBits:5];
...
+ (id)getAbsoluteDateComponentsWithDefaultMinutes:(id)a3 withTime:(id)a4 withDefaultMinutes:(id)a5
{
  ...
  v5 = [AtlasDecoder getAbsoluteDateComponents:a3 withTime:a4, a5];
