...
- (id)parseHCIEvent:(id)a3 withApplet:(id)a4 withPackage:(id)a5 withModule:(id)a6 withTransceiver:(id)a7 withError:(id *)a8
{
  ...
  {
    case 0x10:
      v15 = [MercuryDecoder parseActivityTimeout:v11 withApplet:v12 error:a8];
      goto LABEL_13;
    case 2:
      v15 = [MercuryDecoder parseEndEvent:v11 withApplet:v12 moduleAID:v13 error:a8];
      goto LABEL_13;
    case 1:
      v15 = [MercuryDecoder parseStartEvent:v11 withApplet:v12 error:a8];
LABEL_13:
      v26 = v15;
      goto LABEL_25;
  }
...
- (id)getAppletStateAndHistory:(id)a3 withApplet:(id)a4 withPackage:(id)a5 withModule:(id)a6 withError:(id *)a7
{
  ...
  v10 = a3;
  v11 = a6;
  v12 = [MEMORY[0x277CBEA90] dataWithHexString:a4];
  v13 = SelectByNameCmd(v12);

  v14 = [v10 transceiveAndCheckSW:v13 error:a7];
  if (v14)
  {
    ...
    if (v16)
    {
      v48[0] = [v16 bytes];
      v48[1] = [v17 length];
      v18 = [MercuryDecoder DecodeE1TLV:v48 transactionInfo:0 error:a7];
      if (v18)
      {
        v40 = v14;
        v41 = v17;
        ...
        do
        {
          ...
          if ([v21 length])
          {
            ...
            *(&v53 + 1) = [v22 length];
            ...
            v24 = [MercuryDecoder DecodeE456TLV:&v53 currencyExponent:v23 error:a7];
            ...
            else
            {
              v25 = [v22 bytes];
              v26 = [v22 length];
              LogBinary(OS_LOG_TYPE_ERROR, "[MercuryDecoder getAppletStateAndHistory:withApplet:withPackage:withModule:withError:]", 127, v25, v26, @"Skipping invalid transaction info:", v27, v28, v39);
              if (a7 && *a7)
              {
                v29 = ATLLogObject();
...
+ (id)parseStartEvent:(id)a3 withApplet:(id)a4 error:(id *)a5
{
  ...
  if ([v7 length] != 9)
  {
    ...
    v15 = [objc_alloc(MEMORY[0x277CCACA8]) initWithFormat:@"Start event length %zu (exp) %zu", objc_msgSend(v7, "length"), 9];
    v10 = v15;
    if (a5)
    {
      v16 = *a5;
...
LABEL_15:
  ...
  if (*(v9 + 1) != 2)
  {
    ...
    v25 = [objc_alloc(MEMORY[0x277CCACA8]) initWithFormat:@"Start event version %u", *(v9 + 1)];
    v10 = v25;
    if (a5)
    {
      v26 = *a5;
...
+ (id)parseEndEvent:(id)a3 withApplet:(id)a4 moduleAID:(id)a5 error:(id *)a6
{
  ...
  if ([v10 length] <= 0x2C)
  {
    ...
    v14 = [objc_alloc(MEMORY[0x277CCACA8]) initWithFormat:@"End event length %zu", objc_msgSend(v10, "length")];
    v15 = v14;
    if (!a6)
    {
      goto LABEL_35;
...
LABEL_33:
  ...
  *(&buf + 1) = [v10 length] - 44;
  v67 = 0;
  v25 = [MercuryDecoder DecodeE1TLV:&buf transactionInfo:&v67 error:a6];
  v26 = v67;
  if (v25)
  {
    v65 = v12;
    ...
    v58 = v34;
    v35 = [a1 isSpecialBusErrorFor45299868:v65 state:v64 transaction:v26];
    ...
    v69[6] = v38;
    v68[7] = @"result";
    v39 = [MEMORY[0x277CCABB0] numberWithUnsignedShort:v58 & 0xFFFC];
    v69[7] = v39;
    v68[8] = @"informative";
...
+ (id)parseActivityTimeout:(id)a3 withApplet:(id)a4 error:(id *)a5
{
  ...
  if ([v7 length] != 11)
  {
    ...
    v24 = [objc_alloc(MEMORY[0x277CCACA8]) initWithFormat:@"Activity param length %zu (exp %zu)", objc_msgSend(v7, "length"), 11];
    v25 = v24;
    if (!a5)
    {
      goto LABEL_23;
...
LABEL_22:
      ...
      *a5 = [v27 errorWithDomain:@"ATL" code:3 userInfo:v40];
...
+ (id)DecodeE1TLV:(id *)a3 transactionInfo:(id *)a4 error:(id *)a5
{
  ...
  v92 = 0;
  v93 = 0;
  v8 = DERDecodeItemCtx(a3, &v92);
  if (!v8)
  {
    if (v92 != 0xE000000000000001)
    {
      LogBinary(OS_LOG_TYPE_ERROR, "+[MercuryDecoder DecodeE1TLV:transactionInfo:error:]", 333, a3->var0, a3->var1, @"Unexpected tag 0x%llx, skipping to contents...", v9, v10, v92);
      v93 = *a3;
    }
...
LABEL_30:
        ...
        {
          v53 = *(&v115 + 1) / 3uLL;
          v54 = [MEMORY[0x277CBEB18] arrayWithCapacity:*(&v115 + 1) / 3uLL];
          if (v52 >= 3)
          {
            v55 = 0;
            do
          ...
          v57 = [MEMORY[0x277CBEA60] arrayWithArray:v54];
        ...
        if (a4 && *(&v118 + 1))
        {
          ...
          *a4 = [MercuryDecoder DecodeE456TLV:&v118 currencyExponent:v63 error:a5];
        }
      ...
      if (a5)
      {
        ...
        *a5 = [v83 errorWithDomain:@"ATL" code:3 userInfo:v90];
      }
    }
    ...
    else
    {
      ...
      if (a5)
      {
        ...
        *a5 = [v69 errorWithDomain:@"ATL" code:3 userInfo:v76];
      }
    }
...
LABEL_60:
  ...
  if (a5)
  {
    ...
    *a5 = [v16 errorWithDomain:@"ATL" code:3 userInfo:v36];
  }
...
+ (id)DecodeE456TLV:(id *)a3 currencyExponent:(id)a4 error:(id *)a5
{
  ...
  if (v8 || v55 + 0x1FFFFFFFFFFFFFF9 <= 0xFFFFFFFFFFFFFFFCLL)
  {
    ...
    if (a5)
    {
      ...
      *a5 = [v14 errorWithDomain:@"ATL" code:3 userInfo:v21];
    }
  ...
  if (v24)
  {
    ...
    if (a5)
    {
      ...
      *a5 = [v30 errorWithDomain:@"ATL" code:3 userInfo:v51];
  ...
  a5 = [MEMORY[0x277CBEB38] dictionaryWithCapacity:11];
  if (*&buf[8])
  {
    ...
    [a5 setObject:v37 forKeyedSubscript:@"TransactionTime"];
  }
  ...
  if (v7 && *(&v64 + 1))
  {
    ...
    v40 = [MEMORY[0x277CCA980] decimalNumberWithMantissa:v39 exponent:-objc_msgSend(v7 isNegative:{"shortValue"), S32BE >> 31}];
    [a5 setObject:v40 forKeyedSubscript:@"FinalBalance"];
  }
  ...
  if (v7 && *(&v65 + 1))
  {
    ...
    v43 = [MEMORY[0x277CCA980] decimalNumberWithMantissa:v42 exponent:-objc_msgSend(v7 isNegative:{"shortValue"), v41 >> 31}];
    [a5 setObject:v43 forKeyedSubscript:@"Amount"];
  }

  if (*(&v66 + 1))
  {
    v44 = DecodeTransactionDetail(v66);
    [a5 setObject:v44 forKeyedSubscript:@"TypeDetail"];

    v45 = [MEMORY[0x277CBEA90] dataWithDERItem:&v66];
    [a5 setObject:v45 forKeyedSubscript:@"TypeDetailRaw"];
  }
  ...
  if (*(&v67 + 1))
  {
    ...
    if (([v46 isAlLFF] & 1) == 0)
    {
      [a5 setObject:v46 forKeyedSubscript:@"StartStation"];
    }
  }
  ...
  if (*(&v68 + 1))
  {
    ...
    if (([v47 isAlLFF] & 1) == 0)
    {
      [a5 setObject:v47 forKeyedSubscript:@"EndStation"];
    }
  }

  if (*(&v69 + 1))
  {
    v48 = [a5 objectForKeyedSubscript:@"TypeDetailRaw"];
    v49 = v48;
    if (v48)
    {
      v50 = *[v48 bytes] << 24;
    ...
    [a5 setObject:v52 forKeyedSubscript:@"SerialNumber"];
  }

  if (*(&v70 + 1))
  {
    v53 = [MEMORY[0x277CCABB0] numberWithInt:ReadS32BE(&v70)];
    [a5 setObject:v53 forKeyedSubscript:@"PointsBalance"];
  }

  if (*(&v71 + 1))
  {
    v54 = [MEMORY[0x277CCABB0] numberWithInt:ReadS32BE(&v71)];
    [a5 setObject:v54 forKeyedSubscript:@"PointsAmount"];
  }

  if (*(&v72 + 1))
  {
    v28 = [MEMORY[0x277CBEA90] dataWithDERItem:&v72];
    [a5 setObject:v28 forKeyedSubscript:@"TerminalIdentifier"];
LABEL_59:
  }
          ...
          if (v10)
          {
            ...
            if (!v15)
            {
              ...
              else
              {
                ...
                [v5 setObject:v30 atIndexedSubscript:v6];
...
+ (void)ApplyHackFor50863616:(id)a3 historyRecords:(id)a4 transceiver:(id)a5
{
  ...
  *(v61 + 3) = 17826304;
  ...
  v59 = 10137600;
  v58 = 0;
  v10 = [v9 transceiveBytesAndCheckSW:v61 length:7 error:&v58];
  v11 = v58;
  v12 = v11;
  if (!v10 || v11)
  {
  ...
  v57 = 0;
  v13 = [v9 transceiveBytesAndCheckSW:&v59 length:5 error:&v57];
  v12 = v57;
  ...
  if (*(v14 + 15) == 1)
  {
    v17 = [v7 objectForKeyedSubscript:@"TransactionInProgress"];
    v12 = [v17 mutableCopy];
...
LABEL_19:
  ...
  v23 = DecodeBCD((v14 + 16), 0, 1);
  v24 = DecodeBCD((v14 + 16), 1, 1);
  v52 = DecodeBCD((v14 + 16), 2, 1);
  v50 = DecodeBCD((v14 + 16), 3, 1);
  v48 = DecodeBCD((v14 + 16), 4, 1);
  if (![v8 count])
  {
    goto LABEL_21;
  }
  ...
  while (1)
  {
    v12 = [v8 objectAtIndexedSubscript:{v25, v46, v47}];
  ...
  v49 = v9;
  v30 = [v12 mutableCopy];
  v31 = [MEMORY[0x277CBEA90] dataWithBytes:v14 + 5 length:2];
  [v30 setObject:v31 forKeyedSubscript:@"StartStation"];

  v32 = [MEMORY[0x277CBEA90] dataWithBytes:v14 + 21 length:2];
...
+ (BOOL)isSpecialBusErrorFor45299868:(id)a3 state:(id)a4 transaction:(id)a5
{
  ...
  {
    v8 = [v7 objectForKeyedSubscript:@"TransactionInProgress"];
