  ...
  if (v3)
  {
    ...
    if (uTF8String)
    {
      if (([v3 length] & 1) == 0)
      {
        ...
        {
          v13 = 0;
          v7 = malloc_type_malloc([v3 length] >> 1, 0x6AF5ECADuLL);
...
LABEL_12:
          v10 = [MEMORY[0x1E695DEF0] dataWithBytesNoCopy:v7 length:objc_msgSend(v3 freeWhenDone:{"length") >> 1, 1}];
        }

        else
        {
          v10 = [MEMORY[0x1E695DEF0] dataWithBytes:0 length:0];
        }
