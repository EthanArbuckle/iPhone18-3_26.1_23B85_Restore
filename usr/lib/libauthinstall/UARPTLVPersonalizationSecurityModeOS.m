...
{
  v3.receiver = self;
  v3.super_class = UARPTLVPersonalizationSecurityModeOS;
...
- (id)description
{
  v3 = +[UARPTLVPersonalizationSecurityModeOS metaDataTableEntry];
...
- (id)generateTLV
{
  v3 = +[UARPTLVPersonalizationSecurityModeOS tlvType];
  v4 = *(&self->super.super._tlvLength + 1);
  v7.receiver = self;
  v7.super_class = UARPTLVPersonalizationSecurityModeOS;
...
- (id)tlvValue
{
  ...
  v5.receiver = self;
  v5.super_class = UARPTLVPersonalizationSecurityModeOS;
...
+ (id)metaDataTableEntry
{
  ...
  v6[0] = @"Name";
  v6[1] = @"Value";
  v2 = [MEMORY[0x29EDBA070] numberWithUnsignedInt:{+[UARPTLVPersonalizationSecurityModeOS tlvType](UARPTLVPersonalizationSecurityModeOS, "tlvType")}];
  v7[1] = v2;
...
+ (id)tlvWithLength:(unint64_t)a3 value:(void *)a4
{
  ...
  {
    v5 = objc_opt_new();
    [v5 setSecurityMode:uarpHtonl(*a4)];
  }
