...
{
  v3.receiver = self;
  v3.super_class = UARPTLVPersonalizationBoardIDOS;
...
- (id)description
{
  v3 = +[UARPTLVPersonalizationBoardIDOS metaDataTableEntry];
...
- (id)generateTLV
{
  v3 = +[UARPTLVPersonalizationBoardIDOS tlvType];
  v4 = *(&self->super.super._tlvLength + 1);
  v7.receiver = self;
  v7.super_class = UARPTLVPersonalizationBoardIDOS;
...
- (id)tlvValue
{
  ...
  v5.receiver = self;
  v5.super_class = UARPTLVPersonalizationBoardIDOS;
...
+ (id)metaDataTableEntry
{
  ...
  v6[0] = @"Name";
  v6[1] = @"Value";
  v2 = [MEMORY[0x29EDBA070] numberWithUnsignedInt:{+[UARPTLVPersonalizationBoardIDOS tlvType](UARPTLVPersonalizationBoardIDOS, "tlvType")}];
  v7[1] = v2;
