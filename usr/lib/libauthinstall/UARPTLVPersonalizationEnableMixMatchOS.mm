...
{
  v3.receiver = self;
  v3.super_class = UARPTLVPersonalizationEnableMixMatchOS;
...
- (void)setEnableMixMatch:(unsigned __int8)match
{
  ...
  *(&selfCopy->super.super._tlvLength + 4) = match;
  objc_sync_exit(selfCopy);
}

- (id)description
{
  v3 = +[UARPTLVPersonalizationEnableMixMatchOS metaDataTableEntry];
...
- (id)generateTLV
{
  v3 = +[UARPTLVPersonalizationEnableMixMatchOS tlvType];
  v4 = *(&self->super.super._tlvLength + 4);
  v7.receiver = self;
  v7.super_class = UARPTLVPersonalizationEnableMixMatchOS;
...
- (id)tlvValue
{
  ...
  v5.receiver = self;
  v5.super_class = UARPTLVPersonalizationEnableMixMatchOS;
...
+ (id)metaDataTableEntry
{
  ...
  v6[0] = @"Name";
  v6[1] = @"Value";
  v2 = [MEMORY[0x29EDBA070] numberWithUnsignedInt:{+[UARPTLVPersonalizationEnableMixMatchOS tlvType](UARPTLVPersonalizationEnableMixMatchOS, "tlvType")}];
  v7[1] = v2;
