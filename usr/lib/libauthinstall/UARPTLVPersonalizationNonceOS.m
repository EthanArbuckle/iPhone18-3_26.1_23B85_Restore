...
{
  v3.receiver = self;
  v3.super_class = UARPTLVPersonalizationNonceOS;
...
- (id)description
{
  v3 = +[UARPTLVPersonalizationNonceOS metaDataTableEntry];
...
- (id)generateTLV
{
  v3 = +[UARPTLVPersonalizationNonceOS tlvType];
  nonce = self->_nonce;
  v7.receiver = self;
  v7.super_class = UARPTLVPersonalizationNonceOS;
  v5 = [(UARPMetaDataTLVDataOS *)&v7 generateTLV:v3 tlvValue:nonce];
