...
- (UARPSuperBinaryOS)initWithFilePath:(id)a3 delegate:(id)a4 delegateQueue:(id)a5
{
  ...
  v13 = [(UARPSuperBinaryOS *)self initWithData:v12 delegate:v10 delegateQueue:v9];
...
- (UARPSuperBinaryOS)initWithURL:(id)a3 delegate:(id)a4 delegateQueue:(id)a5
{
  ...
  v12 = [(UARPSuperBinaryOS *)self initWithData:v11 delegate:v10 delegateQueue:v9];
...
- (BOOL)preparePayload:(UARPPayloadHeader2 *)a3
{
  v5 = [[UARPAssetTagOS alloc] initWithChar1:a3->var1.var0 char2:a3->var1.var1 char3:a3->var1.var2 char4:a3->var1.var3];
  v6 = [[UARPAssetVersionOS alloc] initWithMajorVersion:a3->var2.var0 minorVersion:a3->var2.var1 releaseVersion:a3->var2.var2 buildVersion:a3->var2.var3];
  v7 = a3->var4 + a3->var3;
...
- (id)personalizedMetaData
{
  ...
  if (manifest)
  {
    v10 = [UARPMetaDataTLVOS tlvFromType:2293403952 length:[(NSData *)manifest length] value:[(NSData *)v21->_manifest bytes]];
    if (v10)
    {
...
- (BOOL)expandTLVs
{
  ...
  if ([(NSData *)self->_metaData length])
  {
    ...
    do
    {
      ...
      v8 = [UARPMetaDataTLVOS tlvFromType:v5 length:v7 value:&v3[v6]];
      if (!v8)
      {
        break;
      }
...
- (BOOL)queryTatsuSigningServer:(id)a3 ssoOnly:(BOOL)a4 error:(id *)a5
{
  ...
  if (!v7)
  {
    v7 = [MEMORY[0x29EDB8E70] URLWithString:@"https://gs.apple.com:443"];
  }
...
- (id)generatePersonalizedSuperBinaryWithoutRRKO
{
  ...
  v14 = [(UARPSuperBinaryOS *)v17 generatePersonalizedSuperBinaryInternal:v18];
  v15 = *MEMORY[0x29EDCA608];
...
- (id)generatePersonalizedSuperBinaryInternal:(id)a3
{
  ...
  v34[1] = 44;
  v36 = [(UARPAssetVersionOS *)self->_version majorVersion];
  v37 = [(UARPAssetVersionOS *)self->_version minorVersion];
  v38 = [(UARPAssetVersionOS *)self->_version releaseVersion];
  v39 = [(UARPAssetVersionOS *)self->_version buildVersion];
  v42 = 44;
  v43 = 40 * [v4 count];
  v7 = [(UARPSuperBinaryOS *)self personalizedMetaData];
  v40 = v43 + 44;
  v8 = [v7 length];
  v9 = v43 + 44 + v8;
  v41 = v8;
...
- (id)tatsuMeasurements:(unint64_t)a3
{
  ...
  if (v5)
  {
    v5 = [(UARPSuperBinaryOS *)self composeTSSRequest:a3 asMeasurement:1];
  }
...
- (id)composeTSSRequest:(unint64_t)a3 asMeasurement:(BOOL)a4
{
  ...
  v9 = [(UARPSuperBinaryOS *)self requiredTSSOptions];
  v10 = objc_opt_new();
      ...
      do
      {
        ...
        if (v18 <= 9)
        {
          if (v18 <= 6)
          {
            if (v18 == 4)
            {
              v19 = [(UARPSuperBinaryOS *)self tssKeyName:@"BoardID" unitNumber:a3];
              v24 = MEMORY[0x29EDBA070];
              v25 = [(UARPSuperBinaryOS *)self boardID];
            }
            ...
            else
            {
              ...
              v19 = [(UARPSuperBinaryOS *)self tssKeyName:@"ChipID" unitNumber:a3];
              v24 = MEMORY[0x29EDBA070];
              v25 = [(UARPSuperBinaryOS *)self chipID];
            }
          ...
          if (v18 == 7)
          {
            v19 = [(UARPSuperBinaryOS *)self tssKeyName:@"ECID" unitNumber:a3];
            v26 = [MEMORY[0x29EDBA070] numberWithUnsignedLongLong:{-[UARPSuperBinaryOS ecID](self, "ecID")}];
            goto LABEL_32;
          }

          if (v18 != 8)
          {
            v19 = [(UARPSuperBinaryOS *)self tssKeyName:@"SecurityMode" unitNumber:a3];
            v22 = [(UARPSuperBinaryOS *)self securityMode];
            goto LABEL_34;
          }

          v19 = [(UARPSuperBinaryOS *)self tssKeyName:@"SecurityDomain" unitNumber:a3];
          v20 = MEMORY[0x29EDBA070];
          v21 = [(UARPSuperBinaryOS *)self securityDomain];
          goto LABEL_30;
        }
        ...
        if (v18 > 25)
        {
          if (v18 == 26)
          {
            v19 = [(UARPSuperBinaryOS *)self tssKeyName:@"Provisioning" unitNumber:a3];
...
LABEL_38:
          ...
          v19 = [(UARPSuperBinaryOS *)self tssKeyName:@"ManifestEpoch" unitNumber:a3];
          v20 = MEMORY[0x29EDBA070];
          v21 = [(UARPSuperBinaryOS *)self manifestEpoch];
          goto LABEL_30;
        }

        if (v18 == 10)
        {
          v19 = [(UARPSuperBinaryOS *)self tssKeyName:@"ProductionMode" unitNumber:a3];
          v22 = [(UARPSuperBinaryOS *)self productionMode];
LABEL_34:
          if (v22)
          {
            ecidData = MEMORY[0x29EDB8EB0];
        ...
        if (v18 != 24)
        {
          ...
          v19 = [(UARPSuperBinaryOS *)self tssKeyName:@"Life" unitNumber:a3];
          v20 = MEMORY[0x29EDBA070];
          v21 = [(UARPSuperBinaryOS *)self life];
LABEL_30:
          v26 = [v20 numberWithUnsignedChar:v21];
          goto LABEL_32;
        }

        v19 = [(UARPSuperBinaryOS *)self tssKeyName:@"Nonce" unitNumber:a3];
        v26 = [(UARPSuperBinaryOS *)self nonce];
LABEL_32:
        v27 = v26;
...
LABEL_40:
  ...
  [(UARPSuperBinaryOS *)self processMeasurementsForTSSOptions:self->_tssRequest unitNumber:a3 asMeasurement:v33];
                  ...
                  for (j = 0; j != v14; ++j)
                  {
                    ...
                    else
                    {
                      ...
                      else
                      {
                        ...
                        {
                          if ([(UARPSuperBinaryOS *)v35 productionMode])
                          {
