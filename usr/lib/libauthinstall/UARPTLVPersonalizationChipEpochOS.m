...
{
  v3.receiver = self;
  v3.super_class = UARPTLVPersonalizationChipEpochOS;
...
- (id)description
{
  v3 = +[UARPTLVPersonalizationChipEpochOS metaDataTableEntry];
...
- (id)generateTLV
{
  v3 = +[UARPTLVPersonalizationChipEpochOS tlvType];
  v4 = *(&self->super.super._tlvLength + 1);
  v7.receiver = self;
  v7.super_class = UARPTLVPersonalizationChipEpochOS;
...
- (id)tlvValue
{
  ...
  v5.receiver = self;
  v5.super_class = UARPTLVPersonalizationChipEpochOS;
...
+ (id)metaDataTableEntry
{
  ...
  v7[0] = @"Personalization Chip Epoch";
  v6[0] = @"Name";
  v6[1] = @"Value";
  v2 = [MEMORY[0x29EDBA070] numberWithUnsignedInt:{+[UARPTLVPersonalizationChipEpochOS tlvType](UARPTLVPersonalizationChipEpochOS, "tlvType")}];
  v7[1] = v2;
