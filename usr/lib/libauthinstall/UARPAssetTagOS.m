...
{
  v4 = a3;
  v5 = [(UARPAssetTagOS *)self decodeCharForKey:v4 key:@"char1"];
  if (v5)
  {
    v6 = [(UARPAssetTagOS *)self decodeCharForKey:v4 key:@"char2"];
    if (v6 && (v7 = v6, (v8 = [(UARPAssetTagOS *)self decodeCharForKey:v4 key:@"char3"]) != 0) && (v9 = v8, (v10 = [(UARPAssetTagOS *)self decodeCharForKey:v4 key:@"char4"]) != 0))
    {
