...
LABEL_21:
              ...
              {
                sub_2994D4550(&v38, &__buf, v10, v6, v9, &v33);
...
uint64_t sub_2994D4440(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, char a9)
{
  v9 = vsnprintf(__str, 0x400uLL, "encountered multiple dyld __all_image_info", &a9);
  v17 = sub_2994D44A8(v9, v10, v11, v12, v13, v14, v15, v16, "!dyld_all_image_infos_addr.has_value()");
  return sub_2994D44A8(v17, v18, v19, v20, v21, v22, v23, v24, a9);
}

uint64_t sub_2994D44A8(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, char a9)
{
                ...
                do
                {
                  ...
                  if (!result)
                  {
                    ...
                    if (!result)
                    {
                      if (v174)
                      {
                        v82 = sub_2994D4440(result, 528, v53, v54, v55, v56, v57, v58, v116);
LABEL_207:
                        v114 = sub_2994D4440(v82, 518, v83, v84, v85, v86, v87, v88, v116);
                        return sub_2994D51E4(v114, v115);
                      }
