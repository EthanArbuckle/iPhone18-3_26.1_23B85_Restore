...
- (void)setHasPercentage:(BOOL)percentage;
- (void)writeTo:(id)to;
@end
...
- (BOOL)isEqual:(id)equal
{
  ...
  if (v5)
  {
    if (*&self->_has)
    {
      if ((*(equal + 16) & 1) == 0 || self->_locationType != *(equal + 2))
      {
        goto LABEL_11;
      }
    }
...
LABEL_11:
    ...
    if ((*&self->_has & 2) != 0)
    {
      if ((*(equal + 16) & 2) == 0 || self->_percentage != *(equal + 3))
      {
        goto LABEL_11;
      }
