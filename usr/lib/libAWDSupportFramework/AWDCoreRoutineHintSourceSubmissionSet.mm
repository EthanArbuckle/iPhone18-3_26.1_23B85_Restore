...
- (void)dealloc
{
  ...
  v3.receiver = self;
  v3.super_class = AWDCoreRoutineHintSourceSubmissionSet;
...
- (id)description
{
  v3.receiver = self;
  v3.super_class = AWDCoreRoutineHintSourceSubmissionSet;
  return [MEMORY[0x29EDBA0F8] stringWithFormat:@"%@ %@", -[AWDCoreRoutineHintSourceSubmissionSet description](&v3, sel_description), -[AWDCoreRoutineHintSourceSubmissionSet dictionaryRepresentation](self, "dictionaryRepresentation")];
}
...
- (void)copyTo:(id)to
{
  ...
  {
    [to clearInstances];
    instancesCount = [(AWDCoreRoutineHintSourceSubmissionSet *)self instancesCount];
    if (instancesCount)
    {
      v6 = instancesCount;
      for (i = 0; i != v6; ++i)
      {
        [to addInstance:{-[AWDCoreRoutineHintSourceSubmissionSet instanceAtIndex:](self, "instanceAtIndex:", i)}];
      }
    }
  }
}
  ...
  if (v5)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        [(AWDCoreRoutineHintSourceSubmissionSet *)self addInstance:*(*(&v10 + 1) + 8 * v8++)];
      }
