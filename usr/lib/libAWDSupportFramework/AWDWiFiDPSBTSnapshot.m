...
{
  v3.receiver = self;
  v3.super_class = AWDWiFiDPSBTSnapshot;
  return [MEMORY[0x29EDBA0F8] stringWithFormat:@"%@ %@", -[AWDWiFiDPSBTSnapshot description](&v3, sel_description), -[AWDWiFiDPSBTSnapshot dictionaryRepresentation](self, "dictionaryRepresentation")];
}
...
LABEL_16:
    ...
    if ((*&self->_has & 2) != 0)
    {
      if ((*(a3 + 24) & 2) == 0 || self->_duration != *(a3 + 4))
      {
        goto LABEL_16;
      }
    }
