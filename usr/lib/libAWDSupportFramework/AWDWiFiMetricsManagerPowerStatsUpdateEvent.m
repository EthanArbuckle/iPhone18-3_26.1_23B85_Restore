...
LABEL_11:
  [v3 setObject:objc_msgSend(MEMORY[0x29EDBA070] forKey:{"numberWithUnsignedInt:", self->_unassociatedSleepDur), @"unassociated_sleep_dur"}];
  has = self->_has;
  if ((has & 2) == 0)
  {
LABEL_5:
...
LABEL_13:
    [v3 setObject:objc_msgSend(MEMORY[0x29EDBA070] forKey:{"numberWithUnsignedInt:", self->_roamDur), @"roam_dur"}];
    if ((*&self->_has & 8) == 0)
    {
      return v3;
    }
...
LABEL_12:
  [v3 setObject:objc_msgSend(MEMORY[0x29EDBA070] forKey:{"numberWithUnsignedInt:", self->_associatedSleepDur), @"associated_sleep_dur"}];
  has = self->_has;
  if ((has & 4) != 0)
  {
    goto LABEL_13;
...
LABEL_6:
  ...
  {
LABEL_7:
    [v3 setObject:objc_msgSend(MEMORY[0x29EDBA070] forKey:{"numberWithUnsignedInt:", self->_totalDur), @"total_dur"}];
  }
...
LABEL_10:
  *(a3 + 8) = self->_unassociatedSleepDur;
  *(a3 + 36) |= 0x20u;
  has = self->_has;
  if ((has & 2) == 0)
  {
...
LABEL_31:
    ...
    if ((*&self->_has & 0x10) != 0)
    {
      if ((*(a3 + 36) & 0x10) == 0 || self->_type != *(a3 + 7))
      {
        goto LABEL_31;
      }
    }
    ...
    if ((*&self->_has & 0x20) != 0)
    {
      if ((*(a3 + 36) & 0x20) == 0 || self->_unassociatedSleepDur != *(a3 + 8))
      {
        goto LABEL_31;
      }
    }
    ...
    if ((*&self->_has & 2) != 0)
    {
      if ((*(a3 + 36) & 2) == 0 || self->_associatedSleepDur != *(a3 + 4))
      {
        goto LABEL_31;
      }
    }
    ...
    if ((*&self->_has & 4) != 0)
    {
      if ((*(a3 + 36) & 4) == 0 || self->_roamDur != *(a3 + 5))
      {
        goto LABEL_31;
      }
    }
    ...
    if ((*&self->_has & 8) != 0)
    {
      if ((*(a3 + 36) & 8) == 0 || self->_totalDur != *(a3 + 6))
      {
        goto LABEL_31;
      }
...
LABEL_10:
  self->_unassociatedSleepDur = *(a3 + 8);
  *&self->_has |= 0x20u;
  v3 = *(a3 + 36);
  if ((v3 & 2) == 0)
  {
