...
- (void)dealloc
{
  ...
  v3.receiver = self;
  v3.super_class = AWDFaceTimeCallDeclineSent;
...
- (id)description
{
  v3.receiver = self;
  v3.super_class = AWDFaceTimeCallDeclineSent;
  return [MEMORY[0x29EDBA0F8] stringWithFormat:@"%@ %@", -[AWDFaceTimeCallDeclineSent description](&v3, sel_description), -[AWDFaceTimeCallDeclineSent dictionaryRepresentation](self, "dictionaryRepresentation")];
}
...
LABEL_13:
  [v4 setObject:objc_msgSend(MEMORY[0x29EDBA070] forKey:{"numberWithUnsignedInt:", self->_declineCode), @"declineCode"}];
  has = self->_has;
  if ((has & 0x20) == 0)
  {
LABEL_7:
...
LABEL_33:
      ...
      if ((*&self->_has & 4) != 0)
      {
        if ((*(a3 + 44) & 4) == 0 || self->_errorCode != *(a3 + 5))
        {
          goto LABEL_33;
        }
      }
      ...
      if ((*&self->_has & 2) != 0)
      {
        if ((*(a3 + 44) & 2) == 0 || self->_declineCode != *(a3 + 4))
        {
          goto LABEL_33;
        }
      }
      ...
      if ((*&self->_has & 0x20) != 0)
      {
        if ((*(a3 + 44) & 0x20) == 0 || self->_sendDuration != *(a3 + 10))
        {
          goto LABEL_33;
        }
      }
      ...
      if ((*&self->_has & 8) != 0)
      {
        if ((*(a3 + 44) & 8) == 0 || self->_isVideo != *(a3 + 8))
        {
          goto LABEL_33;
        }
      }
      ...
      if ((*&self->_has & 0x10) != 0)
      {
        if ((*(a3 + 44) & 0x10) == 0 || self->_onLockScreen != *(a3 + 9))
        {
          goto LABEL_33;
        }
...
- (void)mergeFrom:(id)a3
{
  if (*(a3 + 3))
  {
    [(AWDFaceTimeCallDeclineSent *)self setGuid:?];
  }
