...
- (void)dealloc
{
  ...
  v3.receiver = self;
  v3.super_class = AWDBltDelayToSecondaryDevice;
...
- (id)description
{
  v3.receiver = self;
  v3.super_class = AWDBltDelayToSecondaryDevice;
  return [MEMORY[0x29EDBA0F8] stringWithFormat:@"%@ %@", -[AWDBltDelayToSecondaryDevice description](&v3, sel_description), -[AWDBltDelayToSecondaryDevice dictionaryRepresentation](self, "dictionaryRepresentation")];
}
...
- (void)mergeFrom:(id)from
{
  ...
  if (*(from + 3))
  {
    [(AWDBltDelayToSecondaryDevice *)self setUniqueid:?];
  }
