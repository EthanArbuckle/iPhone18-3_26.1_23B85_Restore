...
- (BOOL)isEqual:(id)a3
{
  ...
  if (v5)
  {
    ...
    if ((has & 0x40) != 0)
    {
      if ((*(a3 + 52) & 0x40) == 0 || self->_success != *(a3 + 11))
      {
        goto LABEL_43;
      }
    }
    ...
    if ((has & 2) != 0)
    {
      if ((*(a3 + 52) & 2) == 0 || self->_connectionType != *(a3 + 4))
      {
        goto LABEL_43;
      }
    }
    ...
    if ((has & 0x20) != 0)
    {
      if ((*(a3 + 52) & 0x20) == 0 || self->_resultCode != *(a3 + 10))
      {
        goto LABEL_43;
      }
    }
    ...
    if ((has & 0x10) != 0)
    {
      if ((*(a3 + 52) & 0x10) == 0 || self->_registrationError != *(a3 + 9))
      {
        goto LABEL_43;
      }
    }
    ...
    if ((has & 4) != 0)
    {
      if ((*(a3 + 52) & 4) == 0 || self->_genericError != *(a3 + 5))
      {
        goto LABEL_43;
      }
    }
    ...
    if (has < 0)
    {
      if ((*(a3 + 52) & 0x80) == 0 || self->_uRLError != *(a3 + 12))
      {
        goto LABEL_43;
      }
    }
...
LABEL_43:
    ...
    if ((has & 8) != 0)
    {
      if ((*(a3 + 52) & 8) == 0 || self->_pOSIXError != *(a3 + 8))
      {
        goto LABEL_43;
      }
