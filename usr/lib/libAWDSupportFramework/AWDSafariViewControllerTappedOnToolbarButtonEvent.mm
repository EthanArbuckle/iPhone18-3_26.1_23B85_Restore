...
{
  v3.receiver = self;
  v3.super_class = AWDSafariViewControllerTappedOnToolbarButtonEvent;
  return [MEMORY[0x29EDBA0F8] stringWithFormat:@"%@ %@", -[AWDSafariViewControllerTappedOnToolbarButtonEvent description](&v3, sel_description), -[AWDSafariViewControllerTappedOnToolbarButtonEvent dictionaryRepresentation](self, "dictionaryRepresentation")];
}
