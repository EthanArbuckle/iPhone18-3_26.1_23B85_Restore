...
{
  v3.receiver = self;
  v3.super_class = AWDEventKitSyncSyncedAttendeeResponseFromWatch;
  return [MEMORY[0x29EDBA0F8] stringWithFormat:@"%@ %@", -[AWDEventKitSyncSyncedAttendeeResponseFromWatch description](&v3, sel_description), -[AWDEventKitSyncSyncedAttendeeResponseFromWatch dictionaryRepresentation](self, "dictionaryRepresentation")];
}
