...
- (void)dealloc
{
  ...
  v3.receiver = self;
  v3.super_class = AWDCoreRoutineModelClusterMovementNoiseSet;
...
- (id)description
{
  v3.receiver = self;
  v3.super_class = AWDCoreRoutineModelClusterMovementNoiseSet;
  return [MEMORY[0x29EDBA0F8] stringWithFormat:@"%@ %@", -[AWDCoreRoutineModelClusterMovementNoiseSet description](&v3, sel_description), -[AWDCoreRoutineModelClusterMovementNoiseSet dictionaryRepresentation](self, "dictionaryRepresentation")];
}
...
- (void)copyTo:(id)to
{
  ...
  {
    [to clearInstances];
    instancesCount = [(AWDCoreRoutineModelClusterMovementNoiseSet *)self instancesCount];
    if (instancesCount)
    {
      v6 = instancesCount;
      for (i = 0; i != v6; ++i)
      {
        [to addInstance:{-[AWDCoreRoutineModelClusterMovementNoiseSet instanceAtIndex:](self, "instanceAtIndex:", i)}];
      }
    }
  }
}
  ...
  if (v5)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        [(AWDCoreRoutineModelClusterMovementNoiseSet *)self addInstance:*(*(&v10 + 1) + 8 * v8++)];
      }
