...
- (id)dictionaryRepresentation
{
  ...
  if ((has & 2) != 0)
  {
    [v3 setObject:objc_msgSend(MEMORY[0x29EDBA070] forKey:{"numberWithInt:", self->_contentVersion), @"contentVersion"}];
  }
...
LABEL_11:
    ...
    if ((*&self->_has & 2) != 0)
    {
      if ((*(a3 + 20) & 2) == 0 || self->_contentVersion != *(a3 + 4))
      {
        goto LABEL_11;
      }
