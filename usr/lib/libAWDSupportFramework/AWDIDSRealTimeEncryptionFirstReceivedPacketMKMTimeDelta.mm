...
- (void)dealloc
{
  ...
  v3.receiver = self;
  v3.super_class = AWDIDSRealTimeEncryptionFirstReceivedPacketMKMTimeDelta;
...
- (id)description
{
  v3.receiver = self;
  v3.super_class = AWDIDSRealTimeEncryptionFirstReceivedPacketMKMTimeDelta;
  return [MEMORY[0x29EDBA0F8] stringWithFormat:@"%@ %@", -[AWDIDSRealTimeEncryptionFirstReceivedPacketMKMTimeDelta description](&v3, sel_description), -[AWDIDSRealTimeEncryptionFirstReceivedPacketMKMTimeDelta dictionaryRepresentation](self, "dictionaryRepresentation")];
}
...
- (void)mergeFrom:(id)from
{
  ...
  if (*(from + 4))
  {
    [(AWDIDSRealTimeEncryptionFirstReceivedPacketMKMTimeDelta *)self setServiceName:?];
  }
