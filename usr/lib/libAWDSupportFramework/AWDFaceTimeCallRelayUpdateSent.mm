...
- (void)dealloc
{
  ...
  v3.receiver = self;
  v3.super_class = AWDFaceTimeCallRelayUpdateSent;
...
- (id)description
{
  v3.receiver = self;
  v3.super_class = AWDFaceTimeCallRelayUpdateSent;
  return [MEMORY[0x29EDBA0F8] stringWithFormat:@"%@ %@", -[AWDFaceTimeCallRelayUpdateSent description](&v3, sel_description), -[AWDFaceTimeCallRelayUpdateSent dictionaryRepresentation](self, "dictionaryRepresentation")];
}
...
- (void)mergeFrom:(id)from
{
  if (*(from + 3))
  {
    [(AWDFaceTimeCallRelayUpdateSent *)self setGuid:?];
  }
