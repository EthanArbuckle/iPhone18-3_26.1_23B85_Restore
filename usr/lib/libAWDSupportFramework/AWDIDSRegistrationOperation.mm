...
LABEL_23:
    [v3 setObject:objc_msgSend(MEMORY[0x29EDBA070] forKey:{"numberWithUnsignedInt:", self->_heartbeatRegister), @"heartbeatRegister"}];
    if ((*&self->_has & 8) == 0)
    {
      return v3;
    }
...
LABEL_13:
  ...
  {
LABEL_14:
    [v3 setObject:objc_msgSend(MEMORY[0x29EDBA070] forKey:{"numberWithUnsignedInt:", self->_heartbeatDelay), @"heartbeatDelay"}];
  }
...
LABEL_54:
    ...
    if ((has & 0x10) != 0)
    {
      if ((v9 & 0x10) == 0 || self->_heartbeatRegister != *(a3 + 9))
      {
        goto LABEL_54;
      }
    }
    ...
    if ((has & 8) != 0)
    {
      if ((v9 & 8) == 0 || self->_heartbeatDelay != *(a3 + 8))
      {
        goto LABEL_54;
      }
