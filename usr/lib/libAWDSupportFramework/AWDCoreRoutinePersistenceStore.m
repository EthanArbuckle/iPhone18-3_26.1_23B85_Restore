...
LABEL_7:
    [v3 setObject:objc_msgSend(MEMORY[0x29EDBA070] forKey:{"numberWithBool:", self->_migratorFailed), @"migratorFailed"}];
    if ((*&self->_has & 2) == 0)
    {
      return v3;
    }
...
LABEL_3:
  ...
  {
LABEL_4:
    [v3 setObject:objc_msgSend(MEMORY[0x29EDBA070] forKey:{"numberWithInt:", self->_migratorDestroyedStoreReason), @"migratorDestroyedStoreReason"}];
  }
...
LABEL_7:
      *(a3 + 4) = self->_migratorDestroyedStoreReason;
      *(a3 + 24) |= 2u;
      return;
    }
  }
...
LABEL_9:
  ...
  if ((*&self->_has & 2) != 0)
  {
    if ((*(a3 + 24) & 2) == 0 || self->_migratorDestroyedStoreReason != *(a3 + 4))
    {
      goto LABEL_14;
    }
...
LABEL_7:
      self->_migratorDestroyedStoreReason = *(a3 + 4);
      *&self->_has |= 2u;
      return;
    }
  }
