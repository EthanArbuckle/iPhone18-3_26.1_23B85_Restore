...
- (void)dealloc
{
  ...
  v3.receiver = self;
  v3.super_class = AWDCoreRoutineModelTransitionSet;
...
- (id)description
{
  v3.receiver = self;
  v3.super_class = AWDCoreRoutineModelTransitionSet;
  return [MEMORY[0x29EDBA0F8] stringWithFormat:@"%@ %@", -[AWDCoreRoutineModelTransitionSet description](&v3, sel_description), -[AWDCoreRoutineModelTransitionSet dictionaryRepresentation](self, "dictionaryRepresentation")];
}
...
- (void)copyTo:(id)to
{
  ...
  {
    [to clearInstances];
    instancesCount = [(AWDCoreRoutineModelTransitionSet *)self instancesCount];
    if (instancesCount)
    {
      v6 = instancesCount;
      for (i = 0; i != v6; ++i)
      {
        [to addInstance:{-[AWDCoreRoutineModelTransitionSet instanceAtIndex:](self, "instanceAtIndex:", i)}];
      }
    }
  }
}
  ...
  if (v5)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        [(AWDCoreRoutineModelTransitionSet *)self addInstance:*(*(&v10 + 1) + 8 * v8++)];
      }
