...
- (void)dealloc
{
  ...
  v3.receiver = self;
  v3.super_class = AWDBltRequestToResponseDelay;
...
- (id)description
{
  v3.receiver = self;
  v3.super_class = AWDBltRequestToResponseDelay;
  return [MEMORY[0x29EDBA0F8] stringWithFormat:@"%@ %@", -[AWDBltRequestToResponseDelay description](&v3, sel_description), -[AWDBltRequestToResponseDelay dictionaryRepresentation](self, "dictionaryRepresentation")];
}
...
- (void)mergeFrom:(id)from
{
  ...
  if (*(from + 3))
  {
    [(AWDBltRequestToResponseDelay *)self setUniqueid:?];
  }
