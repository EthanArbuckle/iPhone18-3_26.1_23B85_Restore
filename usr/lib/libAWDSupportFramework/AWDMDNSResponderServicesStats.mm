...
- (void)setHasMaxServicesCount:(BOOL)count;
- (void)writeTo:(id)to;
@end
...
- (id)dictionaryRepresentation
{
  ...
  if ((has & 2) != 0)
  {
    [dictionary setObject:objc_msgSend(MEMORY[0x29EDBA070] forKey:{"numberWithUnsignedInt:", self->_maxServicesCount), @"maxServicesCount"}];
  }
...
LABEL_11:
    ...
    if ((*&self->_has & 2) != 0)
    {
      if ((*(equal + 20) & 2) == 0 || self->_maxServicesCount != *(equal + 4))
      {
        goto LABEL_11;
      }
