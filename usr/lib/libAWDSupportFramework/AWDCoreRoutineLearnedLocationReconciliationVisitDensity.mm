...
LABEL_7:
    [v3 setObject:objc_msgSend(MEMORY[0x29EDBA070] forKey:{"numberWithInt:", self->_totalBranchCount), @"totalBranchCount"}];
    if ((*&self->_has & 2) == 0)
    {
      return v3;
    }
...
LABEL_3:
  ...
  {
LABEL_4:
    [v3 setObject:objc_msgSend(MEMORY[0x29EDBA070] forKey:{"numberWithInt:", self->_countDeviceLost), @"countDeviceLost"}];
  }
...
LABEL_16:
    ...
    if ((*&self->_has & 4) != 0)
    {
      if ((*(a3 + 24) & 4) == 0 || self->_totalBranchCount != *(a3 + 5))
      {
        goto LABEL_16;
      }
    }
    ...
    if ((*&self->_has & 2) != 0)
    {
      if ((*(a3 + 24) & 2) == 0 || self->_countDeviceLost != *(a3 + 4))
      {
        goto LABEL_16;
      }
