...
LABEL_14:
  [v3 setObject:objc_msgSend(MEMORY[0x29EDBA070] forKey:{"numberWithInt:", self->_parkingEvents), @"parkingEvents"}];
  has = self->_has;
  if ((has & 0x10) == 0)
  {
LABEL_5:
...
LABEL_15:
  [v3 setObject:objc_msgSend(MEMORY[0x29EDBA070] forKey:{"numberWithInt:", self->_engagedParkingEvents), @"engagedParkingEvents"}];
  has = self->_has;
  if ((has & 4) == 0)
  {
LABEL_6:
...
LABEL_16:
  [v3 setObject:objc_msgSend(MEMORY[0x29EDBA070] forKey:{"numberWithInt:", self->_assistedParkingEvents), @"assistedParkingEvents"}];
  has = self->_has;
  if ((has & 0x20) == 0)
  {
LABEL_7:
...
LABEL_17:
  [v3 setObject:objc_msgSend(MEMORY[0x29EDBA070] forKey:{"numberWithInt:", self->_engagements), @"engagements"}];
  has = self->_has;
  if ((has & 2) == 0)
  {
LABEL_8:
...
LABEL_19:
    [v3 setObject:objc_msgSend(MEMORY[0x29EDBA070] forKey:{"numberWithInt:", self->_suppressedParkingEvents), @"suppressedParkingEvents"}];
    if ((*&self->_has & 0x40) == 0)
    {
      return v3;
    }
...
LABEL_18:
  [v3 setObject:objc_msgSend(MEMORY[0x29EDBA070] forKey:{"numberWithInt:", self->_assistances), @"assistances"}];
  has = self->_has;
  if ((has & 0x100) != 0)
  {
    goto LABEL_19;
...
LABEL_14:
  *(a3 + 7) = self->_engagedParkingEvents;
  *(a3 + 24) |= 0x10u;
  has = self->_has;
  if ((has & 4) == 0)
  {
...
LABEL_15:
  *(a3 + 5) = self->_assistedParkingEvents;
  *(a3 + 24) |= 4u;
  has = self->_has;
  if ((has & 0x20) == 0)
  {
...
LABEL_19:
    *(a3 + 9) = self->_locationType;
    *(a3 + 24) |= 0x40u;
    return;
  }

LABEL_18:
  *(a3 + 11) = self->_suppressedParkingEvents;
  *(a3 + 24) |= 0x100u;
  if ((*&self->_has & 0x40) != 0)
  {
    goto LABEL_19;
...
LABEL_46:
    ...
    if ((has & 0x80) != 0)
    {
      if ((v7 & 0x80) == 0 || self->_parkingEvents != *(a3 + 10))
      {
        goto LABEL_46;
      }
    }
    ...
    if ((has & 0x10) != 0)
    {
      if ((v7 & 0x10) == 0 || self->_engagedParkingEvents != *(a3 + 7))
      {
        goto LABEL_46;
      }
    }
    ...
    if ((has & 4) != 0)
    {
      if ((v7 & 4) == 0 || self->_assistedParkingEvents != *(a3 + 5))
      {
        goto LABEL_46;
      }
    }
    ...
    if ((has & 0x20) != 0)
    {
      if ((v7 & 0x20) == 0 || self->_engagements != *(a3 + 8))
      {
        goto LABEL_46;
      }
    }
    ...
    if ((has & 2) != 0)
    {
      if ((v7 & 2) == 0 || self->_assistances != *(a3 + 4))
      {
        goto LABEL_46;
      }
    }
    ...
    {
      if ((*(a3 + 24) & 0x100) == 0 || self->_suppressedParkingEvents != *(a3 + 11))
      {
        goto LABEL_46;
      }
    }
    ...
    if ((has & 0x40) != 0)
    {
      if ((v7 & 0x40) == 0 || self->_locationType != *(a3 + 9))
      {
        goto LABEL_46;
      }
...
LABEL_14:
  self->_engagedParkingEvents = *(a3 + 7);
  *&self->_has |= 0x10u;
  v3 = *(a3 + 24);
  if ((v3 & 4) == 0)
  {
...
LABEL_15:
  self->_assistedParkingEvents = *(a3 + 5);
  *&self->_has |= 4u;
  v3 = *(a3 + 24);
  if ((v3 & 0x20) == 0)
  {
...
LABEL_19:
    self->_locationType = *(a3 + 9);
    *&self->_has |= 0x40u;
    return;
  }

LABEL_18:
  self->_suppressedParkingEvents = *(a3 + 11);
  *&self->_has |= 0x100u;
  if ((*(a3 + 24) & 0x40) != 0)
  {
    goto LABEL_19;
