...
- (id)dictionaryRepresentation
{
  ...
  if ([(NSMutableArray *)self->_appPowers count])
  {
    ...
    v15 = 0u;
    appPowers = self->_appPowers;
    v6 = [(NSMutableArray *)appPowers countByEnumeratingWithState:&v12 objects:v16 count:16];
    if (v6)
    {
      v7 = v6;
      v8 = *v13;
      do
      {
        ...
        while (v7 != v9);
        v7 = [(NSMutableArray *)appPowers countByEnumeratingWithState:&v12 objects:v16 count:16];
      }
...
- (void)copyTo:(id)a3
{
  ...
  {
    [a3 clearAppPowers];
    v5 = [(AWDPowerAppBBMetrics *)self appPowersCount];
    if (v5)
    {
      v6 = v5;
      for (i = 0; i != v6; ++i)
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v16 = 0u;
  appPowers = self->_appPowers;
  v8 = [(NSMutableArray *)appPowers countByEnumeratingWithState:&v15 objects:v19 count:16];
  if (v8)
  {
    v9 = v8;
    v10 = *v16;
    do
    {
      ...
      while (v9 != v11);
      v9 = [(NSMutableArray *)appPowers countByEnumeratingWithState:&v15 objects:v19 count:16];
    }
  ...
  if (v5)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        [(AWDPowerAppBBMetrics *)self addAppPower:*(*(&v10 + 1) + 8 * v8++)];
      }
