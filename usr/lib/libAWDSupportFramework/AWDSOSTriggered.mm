...
- (id)dictionaryRepresentation
{
  ...
  if ((has & 2) != 0)
  {
    [v3 setObject:objc_msgSend(MEMORY[0x29EDBA070] forKey:{"numberWithUnsignedInt:", self->_triggerMechanism), @"triggerMechanism"}];
  }
...
- (void)writeTo:(id)a3
{
  ...
  if ((has & 2) != 0)
  {
    triggerMechanism = self->_triggerMechanism;
...
LABEL_11:
    ...
    if ((*&self->_has & 2) != 0)
    {
      if ((*(a3 + 20) & 2) == 0 || self->_triggerMechanism != *(a3 + 4))
      {
        goto LABEL_11;
      }
