...
LABEL_7:
    [v3 setObject:objc_msgSend(MEMORY[0x29EDBA070] forKey:{"numberWithUnsignedLongLong:", self->_dedupeCount), @"dedupeCount"}];
    if ((*&self->_has & 2) == 0)
    {
      return v3;
    }
...
LABEL_3:
  ...
  {
LABEL_4:
    [v3 setObject:objc_msgSend(MEMORY[0x29EDBA070] forKey:{"numberWithUnsignedLongLong:", self->_foldersWithDupesCount), @"foldersWithDupesCount"}];
  }
...
LABEL_7:
      *(a3 + 2) = self->_foldersWithDupesCount;
      *(a3 + 32) |= 2u;
      return;
    }
  }
...
LABEL_16:
    ...
    if (*&self->_has)
    {
      if ((*(a3 + 32) & 1) == 0 || self->_dedupeCount != *(a3 + 1))
      {
        goto LABEL_16;
      }
    }
    ...
    if ((*&self->_has & 2) != 0)
    {
      if ((*(a3 + 32) & 2) == 0 || self->_foldersWithDupesCount != *(a3 + 2))
      {
        goto LABEL_16;
      }
...
LABEL_7:
      self->_foldersWithDupesCount = *(a3 + 2);
      *&self->_has |= 2u;
      return;
    }
  }
