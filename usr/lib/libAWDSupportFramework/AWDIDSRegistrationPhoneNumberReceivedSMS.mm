...
- (id)dictionaryRepresentation
{
  ...
  if ((*&self->_has & 2) != 0)
  {
    [v3 setObject:objc_msgSend(MEMORY[0x29EDBA070] forKey:{"numberWithUnsignedInt:", self->_smsRoundTripDuration), @"smsRoundTripDuration"}];
  }
...
- (void)copyTo:(id)a3
{
  ...
  if ((*&self->_has & 2) != 0)
  {
    *(a3 + 6) = self->_smsRoundTripDuration;
    *(a3 + 28) |= 2u;
  }
}
...
LABEL_14:
    ...
    if ((has & 2) != 0)
    {
      if ((*(a3 + 28) & 2) == 0 || self->_smsRoundTripDuration != *(a3 + 6))
      {
        goto LABEL_14;
      }
...
- (void)mergeFrom:(id)a3
{
  ...
  if ((*(a3 + 28) & 2) != 0)
  {
    self->_smsRoundTripDuration = *(a3 + 6);
    *&self->_has |= 2u;
  }
}
