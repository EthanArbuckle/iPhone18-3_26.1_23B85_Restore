...
- (void)dealloc
{
  ...
  v3.receiver = self;
  v3.super_class = AWDCoreRoutineModelAlgorithmSet;
...
- (id)description
{
  v3.receiver = self;
  v3.super_class = AWDCoreRoutineModelAlgorithmSet;
  return [MEMORY[0x29EDBA0F8] stringWithFormat:@"%@ %@", -[AWDCoreRoutineModelAlgorithmSet description](&v3, sel_description), -[AWDCoreRoutineModelAlgorithmSet dictionaryRepresentation](self, "dictionaryRepresentation")];
}
...
- (void)copyTo:(id)to
{
  ...
  {
    [to clearInstances];
    instancesCount = [(AWDCoreRoutineModelAlgorithmSet *)self instancesCount];
    if (instancesCount)
    {
      v6 = instancesCount;
      for (i = 0; i != v6; ++i)
      {
        [to addInstance:{-[AWDCoreRoutineModelAlgorithmSet instanceAtIndex:](self, "instanceAtIndex:", i)}];
      }
    }
  }
}
  ...
  if (v5)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        [(AWDCoreRoutineModelAlgorithmSet *)self addInstance:*(*(&v10 + 1) + 8 * v8++)];
      }
