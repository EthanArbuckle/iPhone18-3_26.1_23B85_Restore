...
- (void)dealloc
{
  ...
  v3.receiver = self;
  v3.super_class = AWDFaceTimeCallInvitationReceived;
...
- (id)description
{
  v3.receiver = self;
  v3.super_class = AWDFaceTimeCallInvitationReceived;
  return [MEMORY[0x29EDBA0F8] stringWithFormat:@"%@ %@", -[AWDFaceTimeCallInvitationReceived description](&v3, sel_description), -[AWDFaceTimeCallInvitationReceived dictionaryRepresentation](self, "dictionaryRepresentation")];
}
