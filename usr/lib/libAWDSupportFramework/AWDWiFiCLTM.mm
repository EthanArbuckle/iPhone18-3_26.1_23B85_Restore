...
- (id)description
{
  v3.receiver = self;
  v3.super_class = AWDWiFiCLTM;
  return [MEMORY[0x29EDBA0F8] stringWithFormat:@"%@ %@", -[AWDWiFiCLTM description](&v3, sel_description), -[AWDWiFiCLTM dictionaryRepresentation](self, "dictionaryRepresentation")];
}
...
- (void)copyTo:(id)to
{
  ...
  {
    [to clearSliceStats];
    sliceStatsCount = [(AWDWiFiCLTM *)self sliceStatsCount];
    if (sliceStatsCount)
    {
      v6 = sliceStatsCount;
      for (i = 0; i != v6; ++i)
      {
        [to addSliceStats:{-[AWDWiFiCLTM sliceStatsAtIndex:](self, "sliceStatsAtIndex:", i)}];
      }
    }
  }
}
  ...
  if (v5)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        [(AWDWiFiCLTM *)self addSliceStats:*(*(&v10 + 1) + 8 * v8++)];
      }
