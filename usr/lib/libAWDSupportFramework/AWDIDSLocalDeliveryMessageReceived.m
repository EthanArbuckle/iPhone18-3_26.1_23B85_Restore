...
- (id)dictionaryRepresentation
{
  ...
  if (has)
  {
    [v3 setObject:objc_msgSend(MEMORY[0x29EDBA070] forKey:{"numberWithUnsignedLongLong:", self->_isFromDefaultPairedDevice), @"isFromDefaultPairedDevice"}];
    has = self->_has;
    if ((has & 4) == 0)
    {
LABEL_7:
...
- (void)writeTo:(id)a3
{
  ...
  if (has)
  {
    isFromDefaultPairedDevice = self->_isFromDefaultPairedDevice;
    PBDataWriterWriteUint64Field();
    has = self->_has;
    if ((has & 4) == 0)
    {
...
- (void)copyTo:(id)a3
{
  ...
  if (has)
  {
    *(a3 + 1) = self->_isFromDefaultPairedDevice;
    *(a3 + 56) |= 1u;
    has = self->_has;
    if ((has & 4) == 0)
    {
...
LABEL_29:
    ...
    if (has)
    {
      if ((*(a3 + 56) & 1) == 0 || self->_isFromDefaultPairedDevice != *(a3 + 1))
      {
        goto LABEL_29;
      }
    }
...
- (void)mergeFrom:(id)a3
{
  ...
  if (v5)
  {
    self->_isFromDefaultPairedDevice = *(a3 + 1);
    *&self->_has |= 1u;
    v5 = *(a3 + 56);
    if ((v5 & 4) == 0)
    {
