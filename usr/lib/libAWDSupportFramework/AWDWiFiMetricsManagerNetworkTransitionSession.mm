...
- (id)dictionaryRepresentation
{
  ...
  if ([(NSMutableArray *)self->_records count])
  {
    ...
    v15 = 0u;
    records = self->_records;
    v6 = [(NSMutableArray *)records countByEnumeratingWithState:&v12 objects:v16 count:16];
    if (v6)
    {
      v7 = v6;
      v8 = *v13;
...
- (void)copyTo:(id)a3
{
  ...
  {
    [a3 clearRecords];
    v5 = [(AWDWiFiMetricsManagerNetworkTransitionSession *)self recordsCount];
    if (v5)
    {
      v6 = v5;
      for (i = 0; i != v6; ++i)
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v16 = 0u;
  records = self->_records;
  v8 = [(NSMutableArray *)records countByEnumeratingWithState:&v15 objects:v19 count:16];
  if (v8)
  {
    v9 = v8;
    v10 = *v16;
  ...
  if (v5)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        [(AWDWiFiMetricsManagerNetworkTransitionSession *)self addRecords:*(*(&v10 + 1) + 8 * v8++)];
      }
