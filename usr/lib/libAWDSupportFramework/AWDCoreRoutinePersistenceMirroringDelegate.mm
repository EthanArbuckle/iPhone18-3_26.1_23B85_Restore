...
LABEL_7:
    [v3 setObject:objc_msgSend(MEMORY[0x29EDBA070] forKey:{"numberWithBool:", self->_mirroringDelegatePresent), @"mirroringDelegatePresent"}];
    if ((*&self->_has & 2) == 0)
    {
      return v3;
    }
...
LABEL_3:
  ...
  {
LABEL_4:
    [v3 setObject:objc_msgSend(MEMORY[0x29EDBA070] forKey:{"numberWithInt:", self->_creationFailureReason), @"creationFailureReason"}];
  }
...
LABEL_6:
    mirroringDelegatePresent = self->_mirroringDelegatePresent;
...
LABEL_7:
  creationFailureReason = self->_creationFailureReason;
...
LABEL_7:
      *(a3 + 4) = self->_creationFailureReason;
      *(a3 + 24) |= 2u;
      return;
    }
  }
  ...
  *(a3 + 20) = self->_mirroringDelegatePresent;
  *(a3 + 24) |= 4u;
  if ((*&self->_has & 2) != 0)
  {
    goto LABEL_7;
...
LABEL_9:
  ...
  if ((*&self->_has & 2) != 0)
  {
    if ((*(a3 + 24) & 2) == 0 || self->_creationFailureReason != *(a3 + 4))
    {
      goto LABEL_14;
    }
...
LABEL_7:
      self->_creationFailureReason = *(a3 + 4);
      *&self->_has |= 2u;
      return;
    }
  }
  ...
  self->_mirroringDelegatePresent = *(a3 + 20);
  *&self->_has |= 4u;
  if ((*(a3 + 24) & 2) != 0)
  {
    goto LABEL_7;
