...
- (id)dictionaryRepresentation
{
  ...
  if (has)
  {
    [v3 setObject:objc_msgSend(MEMORY[0x29EDBA070] forKey:{"numberWithUnsignedLongLong:", self->_numberOfVoiceLoops), @"numberOfVoiceLoops"}];
  }
...
- (void)writeTo:(id)a3
{
  ...
  if (has)
  {
    numberOfVoiceLoops = self->_numberOfVoiceLoops;
...
LABEL_11:
    ...
    if (*&self->_has)
    {
      if ((*(a3 + 24) & 1) == 0 || self->_numberOfVoiceLoops != *(a3 + 1))
      {
        goto LABEL_11;
      }
