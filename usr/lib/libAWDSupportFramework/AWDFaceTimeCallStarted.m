...
LABEL_33:
      ...
      if ((*&self->_has & 8) != 0)
      {
        if ((*(a3 + 44) & 8) == 0 || self->_isToPhoneNumber != *(a3 + 8))
        {
          goto LABEL_33;
        }
      }
      ...
      if ((*&self->_has & 4) != 0)
      {
        if ((*(a3 + 44) & 4) == 0 || self->_isToEmail != *(a3 + 7))
        {
          goto LABEL_33;
        }
      }
      ...
      if ((*&self->_has & 2) != 0)
      {
        if ((*(a3 + 44) & 2) == 0 || self->_isCallUpgrade != *(a3 + 6))
        {
          goto LABEL_33;
        }
      }
      ...
      if ((*&self->_has & 0x10) != 0)
      {
        if ((*(a3 + 44) & 0x10) == 0 || self->_isVideo != *(a3 + 9))
        {
          goto LABEL_33;
        }
      }
