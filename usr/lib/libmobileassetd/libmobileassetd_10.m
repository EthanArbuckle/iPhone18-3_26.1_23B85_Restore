...
LABEL_13:
  *(a5 + 208) = 0;
  ...
  while (v33 != 830);
  v40 = vbicq_s8(xmmword_3A6DA0, vmovl_s16(vcgt_u16(0x400040004000400, *(a5 + 92))));
...
unint64_t StoreCommands(uint64_t a1)
{
  ...
  result = BrotliBuildAndStoreHuffmanTreeFast(v14, v56, v11, 8, v58, v57, v5, v3);
  if (!*(v14 + 24))
  {
    if (v7)
    {
    ...
    *v60 = *(&v53[0] + 1);
    ...
    BrotliStoreHuffmanTree(v60, 0x2C0uLL, v65, v5, v3);
    result = BrotliStoreHuffmanTree(v55, 0x40uLL, v65, v5, v3);
    if (v7)
    {
      v29 = 0;
      v30 = *v5;
