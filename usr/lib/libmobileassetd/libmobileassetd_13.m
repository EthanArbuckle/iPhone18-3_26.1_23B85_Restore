...
LABEL_22:
    ...
    v176 = vandq_s8(vaddq_s64(v34, xmmword_3A7870), v18);
    v177 = vandq_s8(vaddq_s64(v34, xmmword_3A7880), v18);
    do
    {
...
LABEL_105:
      ...
      v176 = vandq_s8(vaddq_s64(v90, xmmword_3A7870), v91);
      v177 = vandq_s8(vaddq_s64(v90, xmmword_3A7880), v91);
      do
      {
...
unint64_t CreateBackwardReferencesNH65(unint64_t result, unint64_t a2, uint64_t a3, unint64_t a4, uint64_t a5, uint64_t a6, int *a7, unint64_t *a8, _DWORD *a9, void *a10, void *a11)
{
  v11 = a5;
  v12 = a2;
  v267 = *(a5 + 16);
  ...
  if (v18 >= 5)
  {
    ...
    *(a7 + 1) = vaddq_s32(v19, xmmword_3A7890);
    *(a7 + 4) = vadd_s32(*v19.i8, 0x3FFFFFFFDLL);
    if (v18 >= 0xB)
    {
      v20 = (a7 + 1);
      v21 = vld1q_dup_f32(v20);
      *(a7 + 10) = vaddq_s32(v21, xmmword_3A7890);
          ...
          if (v202)
          {
            ...
            *a7 = v104;
            ...
            if (v204 >= 5)
            {
              ...
              *(a7 + 1) = vaddq_s32(v205, xmmword_3A7890);
              *(a7 + 4) = vadd_s32(*v205.i8, 0x3FFFFFFFDLL);
              if (v204 >= 0xB)
              {
                v206 = vdupq_lane_s32(v203, 0);
                *(a7 + 10) = vaddq_s32(v206, xmmword_3A7890);
...
uint64_t BrotliClusterHistogramsLiteral(uint64_t a1, uint64_t a2, unint64_t a3, unint64_t a4, uint64_t a5, uint64_t *a6, unsigned int *a7)
{
  ...
  if (a3)
  {
    ...
    v40 = (v10 + 24);
    v39 = v10;
    memset_pattern16(v11, &unk_3A78F0, 4 * a3);
    v15 = 0;
    v16 = a5;
    v17 = a2;
    do
...
uLong crc32(uLong crc, const Bytef *buf, uInt len)
{
  ...
  if (len >= 0x20)
  {
    v7 = &crc_table + &stru_17F8.dylib;
    do
    {
      v8 = *buf ^ v3;
      v9 = qword_3A8900[BYTE1(v8) + 256] ^ *&v7[8 * (*buf ^ v3)];
      v10 = *(buf + 1) ^ v9 ^ qword_3A8900[BYTE2(v8)] ^ *(&crc_table + HIBYTE(v8));
      v11 = *(buf + 2) ^ qword_3A8900[BYTE1(v10) + 256] ^ *&v7[8 * (buf[4] ^ v9 ^ qword_3A8900[BYTE2(v8)] ^ *(&crc_table + HIBYTE(v8)))] ^ qword_3A8900[BYTE2(v10)] ^ *(&crc_table + HIBYTE(v10));
      v12 = *(buf + 3) ^ qword_3A8900[BYTE1(v11) + 256] ^ *&v7[8 * v11] ^ qword_3A8900[BYTE2(v11)] ^ *(&crc_table + HIBYTE(v11));
      v13 = *(buf + 4) ^ qword_3A8900[BYTE1(v12) + 256] ^ *&v7[8 * v12] ^ qword_3A8900[BYTE2(v12)] ^ *(&crc_table + HIBYTE(v12));
      v14 = *(buf + 5) ^ qword_3A8900[BYTE1(v13) + 256] ^ *&v7[8 * v13] ^ qword_3A8900[BYTE2(v13)] ^ *(&crc_table + HIBYTE(v13));
      v15 = *(buf + 6) ^ qword_3A8900[BYTE1(v14) + 256] ^ *&v7[8 * v14] ^ qword_3A8900[BYTE2(v14)] ^ *(&crc_table + HIBYTE(v14));
      v16 = qword_3A8900[BYTE1(v15) + 256] ^ *&v7[8 * v15] ^ qword_3A8900[BYTE2(v15)] ^ *(&crc_table + HIBYTE(v15));
      v17 = buf + 32;
      v18 = *(buf + 7) ^ v16;
      v3 = qword_3A8900[BYTE1(v18) + 256] ^ *&v7[8 * v18] ^ qword_3A8900[BYTE2(v18)] ^ *(&crc_table + HIBYTE(v18));
      len -= 32;
      buf += 32;
    }
...
LABEL_38:
        ...
        if (v1 - v10 >= 946)
        {
          ...
          v38 = 0;
          v37 = vaddq_s64(vdupq_n_s64(v10), xmmword_3ACB50);
...
double lzfseEncodeMatches(uint64_t a1)
{
  ...
  if (v7)
  {
    ...
    do
    {
      v15 = *v13++;
      v12 += v15;
      ++v246[getLSymbolFromValue_sym[v15]];
      --v14;
    }
    ...
    do
    {
      v19 = *v17++;
      v16 += v19;
      ++*&v245[4 * getMSymbolFromValue_sym[v19]];
      --v18;
    }
    ...
    do
    {
      ...
      v31 = getDSymbolFromValue_sym[(v27 | v28 | v30)];
      ++*&v244[4 * v31];
      --v21;
    }
  ...
  do
  {
    ...
    {
      v90 = dword_3AD8E0[v235[v85]];
      v91 = dword_3AD900[v235[v85]];
    }
  ...
  *v5 = v96;
  ...
  if (v115)
  {
    ...
    while ((v96 + 2) <= *(v3 + 56))
    {
      ...
      v130 = v126 - v129;
      v131 = *v128;
      v132 = (v117 & FSE_mask_lsb64_mtable_0[v130]) << v121;
      v133 = v130 + v121;
      v117 = v131 + (v117 >> v130);
      ...
      v140 = v136 - v139;
      v141 = (v118 & FSE_mask_lsb64_mtable_0[v140]) << v133;
      v142 = v140 + v133;
      v118 = *v138 + (v118 >> v140);
      ...
      v149 = v145 - v148;
      v150 = (v119 & FSE_mask_lsb64_mtable_0[v149]) << v142;
      v151 = v149 + v142;
      v119 = *v147 + (v119 >> v149);
      ...
      v158 = v154 - v157;
      v159 = v132 | v116 | v141 | v150 | ((v120 & FSE_mask_lsb64_mtable_0[v158]) << v151);
      v160 = v158 + v151;
      v120 = *v156 + (v120 >> v158);
      *v96 = v159;
      v96 = (v96 + (v160 >> 3));
  ...
  *v161 = 0;
  if (v169)
  {
    ...
    while ((v163 + 2) <= *(v3 + 56))
    {
      ...
      v182 = getDSymbolFromValue_sym[(v179 | v180 | v181)];
      v183 = (v176 - kDSymbolVBase[v182]) << v173;
      v184 = v173 + kDSymbolVBits[v182];
      ...
      v191 = v187 - v190;
      v192 = (v170 & FSE_mask_lsb64_mtable_0[v191]) << v184;
      v193 = v191 + v184;
      v170 = *v189 + (v170 >> v191);
      v194 = *(*(v3 + 128) + v175);
      v195 = getMSymbolFromValue_sym[v194];
      v196 = (v194 - kMSymbolVBase[v195]) << v193;
      v197 = v193 + kMSymbolVBits[v195];
      ...
      v204 = v200 - v203;
      v205 = (v171 & FSE_mask_lsb64_mtable_0[v204]) << v197;
      v206 = v204 + v197;
      v171 = *v201 + (v171 >> v204);
      v207 = *(*(v3 + 120) + v175);
      v208 = getLSymbolFromValue_sym[v207];
      v209 = (v207 - kLSymbolVBase[v208]) << v206;
      v210 = v206 + kLSymbolVBits[v208];
      ...
      v216 = v212 - v215;
      v217 = v183 | v174 | v196 | v205 | v209 | ((v172 & FSE_mask_lsb64_mtable_0[v216]) << v210) | v192;
      v172 = *v214 + (v172 >> v216);
      *v163 = v217;
