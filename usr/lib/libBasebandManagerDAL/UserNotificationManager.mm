...
LABEL_237:
    ...
    *(&buf + 4) = v10;
    _os_log_error_impl(&dword_297288000, v117, OS_LOG_TYPE_ERROR, "Unsupported header: %s", &buf, 0xCu);
    v107 = 0;
    goto LABEL_214;
  }
...
LABEL_101:
              ...
              *v60 = 136315138;
              v61 = v43;
              _os_log_impl(&dword_297288000, v42, OS_LOG_TYPE_INFO, "Removed callback for id: %s", v60, 0xCu);
            }
          }
