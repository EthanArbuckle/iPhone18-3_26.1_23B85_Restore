...
LABEL_19:
  ...
  if (!v17)
  {
    if ((atomic_load_explicit(&qword_2A1399D38, memory_order_acquire) & 1) == 0 && __cxa_guard_acquire(&qword_2A1399D38))
    {
      qword_2A1399D40 = 0;
      qword_2A1399D48 = 0;
      __cxa_guard_release(&qword_2A1399D38);
    }

    if (_MergedGlobals_1 == -1)
    {
      v20 = qword_2A1399D48;
      if (!os_log_type_enabled(qword_2A1399D48, OS_LOG_TYPE_ERROR))
      {
LABEL_28:
        v19 = 0;
        goto LABEL_29;
    ...
    *buf = 0;
    _os_log_error_impl(&dword_297288000, v20, OS_LOG_TYPE_ERROR, "Failed to create Call Observer from CallKit", buf, 2u);
    goto LABEL_28;
  }
  ...
  if (_MergedGlobals_1 != -1)
  {
    dispatch_once(&_MergedGlobals_1, &__block_literal_global_1);
    v18 = qword_2A1399D48;
    if (!os_log_type_enabled(qword_2A1399D48, OS_LOG_TYPE_INFO))
    {
      goto LABEL_24;
    }
...
LABEL_23:
    *buf = 0;
    _os_log_impl(&dword_297288000, v18, OS_LOG_TYPE_INFO, "Call Observer created", buf, 2u);
  }
...
- (void)callObserver:(id)a3 callChanged:(id)a4
{
  ...
  if (_MergedGlobals_1 != -1)
  {
    dispatch_once(&_MergedGlobals_1, &__block_literal_global_1);
    v8 = qword_2A1399D48;
    if (!os_log_type_enabled(qword_2A1399D48, OS_LOG_TYPE_DEBUG))
    {
      goto LABEL_4;
    }
...
LABEL_30:
    ...
    *&buf[10] = v20;
    ...
    v32 = 1024;
    v33 = fVoIPCallActive;
    _os_log_debug_impl(&dword_297288000, v9, OS_LOG_TYPE_DEBUG, "(1) call connected: %{BOOL}d, call ended: %{BOOL}d, fVoIPCallStarting: %{BOOL}d, fVoIPCallActive: %{BOOL}d", buf, 0x1Au);
    goto LABEL_7;
  }
...
LABEL_22:
  ...
  *&buf[10] = v24;
  ...
  v32 = 1024;
  v33 = v26;
  _os_log_debug_impl(&dword_297288000, v11, OS_LOG_TYPE_DEBUG, "(2) call connected: %{BOOL}d, call ended: %{BOOL}d, fVoIPCallStarting: %{BOOL}d, fVoIPCallActive: %{BOOL}d", buf, 0x1Au);
  if (!v10)
  {
    goto LABEL_25;
  }
