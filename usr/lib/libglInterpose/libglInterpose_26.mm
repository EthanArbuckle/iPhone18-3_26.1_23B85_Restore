uint64_t *vertex_attrib2f(__GLIContextRec *a1, uint64_t a2, float a3, float a4)
{
...
LABEL_29:
  ...
  *(v13 + 4838) = 1;
  ...
  result = wrapper_cache_vertex_attrib(v13, a2, 5126, a3, a4, 0.0, 1.0);
...
LABEL_9:
  ...
  return v22(a1, a2, v20, v21);
}

uint64_t *vertex_attrib3f(__GLIContextRec *a1, uint64_t a2, float a3, float a4, float a5)
{
...
LABEL_29:
  ...
  *(v15 + 4838) = 1;
  ...
  result = wrapper_cache_vertex_attrib(v15, a2, 5126, a3, a4, a5, 1.0);
...
LABEL_9:
  ...
  return v25(a1, a2, v22, v23, v24);
}

uint64_t *vertex_attrib4f(__GLIContextRec *a1, uint64_t a2, float a3, float a4, float a5, float a6)
{
...
LABEL_29:
      ...
      return v27(a1, a2, v23, v24, v25, v26);
    }
  }
  ...
  *(v17 + 4838) = 1;
  ...
  result = wrapper_cache_vertex_attrib(v17, a2, 5126, a3, a4, a5, a6);
...
LABEL_29:
      ...
      return v30(a1, a2, v26, v27, v28, v29);
    }
  }
...
uint64_t *vertex_attrib1fv(__GLIContextRec *a1, uint64_t a2, const float *a3)
{
...
LABEL_29:
  ...
  *(v11 + 4838) = 1;
  ...
  result = wrapper_cache_vertex_attrib(v11, a2, 5126, *a3, 0.0, 0.0, 1.0);
...
LABEL_9:
  ...
  return wrapper_cache_vertex_attrib(v10, v4, 5126, v11, 0.0, 0.0, 1.0);
}

uint64_t *vertex_attrib2fv(__GLIContextRec *a1, uint64_t a2, const float *a3)
{
  v6 = *(ContextInfo::activeCtxInfoMap + 8);
  if (!v6)
  {
...
LABEL_29:
  ...
  *(v11 + 4838) = 1;
  ...
  result = wrapper_cache_vertex_attrib(v11, a2, 5126, *a3, a3[1], 0.0, 1.0);
  add = atomic_fetch_add((v11 + 4640), 0xFFFFFFFF);
  if (gCheckGLErrors == 1 && (add - 1) >= 1)
  {
...
LABEL_9:
  ...
  return wrapper_cache_vertex_attrib(v10, v4, 5126, v11, v12, 0.0, 1.0);
}

uint64_t *vertex_attrib3fv(__GLIContextRec *a1, uint64_t a2, const float *a3)
{
  v6 = *(ContextInfo::activeCtxInfoMap + 8);
  if (!v6)
  {
...
LABEL_29:
  ...
  *(v11 + 4838) = 1;
  ...
  result = wrapper_cache_vertex_attrib(v11, a2, 5126, *a3, a3[1], a3[2], 1.0);
  add = atomic_fetch_add((v11 + 4640), 0xFFFFFFFF);
  if (gCheckGLErrors == 1 && (add - 1) >= 1)
  {
...
LABEL_9:
  ...
  return wrapper_cache_vertex_attrib(v10, v4, 5126, v11, v12, v13, 1.0);
}

uint64_t *vertex_attrib4fv(__GLIContextRec *a1, uint64_t a2, const float *a3)
{
  v6 = *(ContextInfo::activeCtxInfoMap + 8);
  if (!v6)
  {
...
LABEL_29:
  ...
  *(v11 + 4838) = 1;
  ...
  result = wrapper_cache_vertex_attrib(v11, a2, 5126, *a3, a3[1], a3[2], a3[3]);
  add = atomic_fetch_add((v11 + 4640), 0xFFFFFFFF);
  if (gCheckGLErrors == 1 && (add - 1) >= 1)
  {
...
LABEL_9:
  ...
  return wrapper_cache_vertex_attrib(v10, v4, 5126, v11, v12, v13, v14);
}
...
LABEL_9:
  ...
  if (gCheckGLErrors != 1 || v10 <= 1)
  {
    if ([DYGetGLGuestAppClient() waitOnGraphicsSemaphoreAssertions] >= 1)
    {
      return compile_shader_ARB((v9 + 4640));
    }
  }
  ...
  *(v9 + 4838) = 1;
  ...
  else
  {
    ...
    result = wrapper_cache_shader_post_compile(v9, a2);
...
LABEL_29:
  ...
  *(v11 + 4838) = 1;
  ...
  result = wrapper_cache_buffer_binding_delete(v11, a2, a3);
  add = atomic_fetch_add((v11 + 4640), 0xFFFFFFFF);
  if (gCheckGLErrors == 1 && (add - 1) >= 1)
  {
...
uint64_t *vertex_attribI4i(__GLIContextRec *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6)
{
  v12 = *(ContextInfo::activeCtxInfoMap + 8);
  if (!v12)
  {
...
LABEL_29:
  ...
  *(v17 + 4838) = 1;
  ...
  result = wrapper_cache_vertex_attrib(v17, a2, 5124, a3, a4, a5, a6);
  add = atomic_fetch_add((v17 + 4640), 0xFFFFFFFF);
  if (gCheckGLErrors == 1 && (add - 1) >= 1)
  {
...
LABEL_9:
  ...
  v16 = *(v12 + 40);
  (*(v16[4] + 5712))(a1, a2, a3, a4, a5, a6);

  return wrapper_cache_vertex_attrib(v16, v10, 5124, v9, v8, v7, v6);
}

uint64_t *vertex_attribI4ui(__GLIContextRec *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6)
{
  v12 = *(ContextInfo::activeCtxInfoMap + 8);
  if (!v12)
  {
...
LABEL_29:
  ...
  *(v17 + 4838) = 1;
  ...
  result = wrapper_cache_vertex_attrib(v17, a2, 5125, a3, a4, a5, a6);
  add = atomic_fetch_add((v17 + 4640), 0xFFFFFFFF);
  if (gCheckGLErrors == 1 && (add - 1) >= 1)
  {
...
LABEL_9:
  ...
  v16 = *(v12 + 40);
  (*(v16[4] + 5744))(a1, a2, a3, a4, a5, a6);

  return wrapper_cache_vertex_attrib(v16, v10, 5125, v9, v8, v7, v6);
}

uint64_t *vertex_attribI4iv(__GLIContextRec *a1, uint64_t a2, const int *a3)
{
  v6 = *(ContextInfo::activeCtxInfoMap + 8);
  if (!v6)
  {
...
LABEL_29:
  ...
  *(v11 + 4838) = 1;
  ...
  result = wrapper_cache_vertex_attrib(v11, a2, 5124, *a3, a3[1], a3[2], a3[3]);
  add = atomic_fetch_add((v11 + 4640), 0xFFFFFFFF);
  if (gCheckGLErrors == 1 && (add - 1) >= 1)
  {
...
LABEL_9:
  ...
  return wrapper_cache_vertex_attrib(v10, v4, 5124, v11, v12, v13, v14);
}

uint64_t *vertex_attribI4uiv(__GLIContextRec *a1, uint64_t a2, const unsigned int *a3)
{
  v6 = *(ContextInfo::activeCtxInfoMap + 8);
  if (!v6)
  {
...
LABEL_29:
  ...
  *(v11 + 4838) = 1;
  ...
  LODWORD(v16) = a3[2];
  LODWORD(v17) = a3[3];
  result = wrapper_cache_vertex_attrib(v11, a2, 5125, v14, v15, v16, v17);
  add = atomic_fetch_add((v11 + 4640), 0xFFFFFFFF);
  if (gCheckGLErrors == 1 && (add - 1) >= 1)
  {
...
LABEL_29:
  ...
  *(v11 + 3696) = v19;
  ...
  LODWORD(v16) = a3[2];
  LODWORD(v17) = a3[3];
  result = wrapper_cache_vertex_attrib(v11, a2, 5125, v19.u64[0], v18.u64[0], v16, v17);
  add = atomic_fetch_add((v11 + 4640), 0xFFFFFFFF);
  if (gCheckGLErrors == 1 && (add - 1) >= 1)
  {
  ...
  else
  {
    *(v11 + 4838) = 1;
    if ([DYGetGLGuestAppClient() state] != &dword_0 + 1 || !objc_msgSend(DYGetGLGuestAppClient(), "triggerCaptureOnNextGLCommand"))
    {
      ...
      LODWORD(v17) = a3[3];
      result = wrapper_cache_vertex_attrib(v11, a2, 5125, v14, v15, v16, v17);
      v19 = atomic_fetch_add((v11 + 4640), 0xFFFFFFFF) - 1;
      if (gCheckGLErrors == 1 && v19 >= 1)
      {
...
void blit_framebuffer(__GLIContextRec *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, unsigned int a6, unsigned int a7, unsigned int a8, uint64_t a9, unsigned int a10)
{
...
LABEL_34:
      ...
      v28(a1, a2, a3, a4, a5, a6, a7, a8, a9);
      return;
    }
  }
  ...
  *(v20 + 4838) = 257;
  ...
  if ([DYGetGLGuestAppClient() overrideFlags])
  {
    ...
    {
      v26 = [DYGetGLGuestAppClient() overrideFlags];
      apply_draw_overrides(v20, v26);
      (*(*(v20 + 32) + 6040))(a1, a2, a3, a4, a5, a6, a7, a8, a9, a10);
      ++*(v20 + 3704);
      if (gCheckGLErrors == 1)
      {
        alpha_func(v20);
      ...
      unapply_draw_overrides(v20, v27);
    }
  }
