...
LABEL_48:
  ...
  *(v13 + 4838) = 1;
  ...
  if ([DYGetGLGuestAppClient() state] != &dword_0 + 1 || !objc_msgSend(DYGetGLGuestAppClient(), "triggerCaptureOnNextGLCommand"))
  {
    ...
    GPUTools::FB::Encode(&v47, 283, 256, v13 + 4709, v18, v19, v20, v21, *v13);
    v22 = byte_21AF73;
    if (byte_21AF73)
    {
      breakpoint_break(&v47, &stru_108.segname[3], 1, *(v13 + 3404), v13);
    }

    if (!([DYGetGLGuestAppClient() overrideFlags] & 0x10 | v22 & 4))
    {
      v27 = mach_absolute_time();
      (*(*(v13 + 32) + 944))(a1, a2, a3, a4);
...
LABEL_25:
    ...
    GPUTools::FB::Encode(&v47, 283, 256, v13 + 4709, v23, v24, v25, v26, *v13);
    *(v47 + 1) = v45;
...
LABEL_48:
  ...
  *(v13 + 4838) = 1;
  ...
  if ([DYGetGLGuestAppClient() state] != &dword_0 + 1 || !objc_msgSend(DYGetGLGuestAppClient(), "triggerCaptureOnNextGLCommand"))
  {
    ...
    snprintf((v13 + 4709), 0x40uLL, "Cee@%u%c", *&v46[1], v17);
    GPUTools::FB::Encode(&v47, 284, 256, v13 + 4709, v18, v19, v20, v21, *v13);
    v22 = byte_21AF74;
    if (byte_21AF74)
    {
      breakpoint_break(&v47, &stru_108.segname[4], 1, *(v13 + 3404), v13);
    }

    if (!([DYGetGLGuestAppClient() overrideFlags] & 0x10 | v22 & 4))
    {
      v27 = mach_absolute_time();
      (*(*(v13 + 32) + 952))(a1, a2, a3, a4);
      v28 = mach_absolute_time() - v27;
      if (g_DYTimebaseInfo == *(&g_DYTimebaseInfo + 1))
      {
        v29 = v47;
...
LABEL_25:
    ...
    GPUTools::FB::Encode(&v47, 284, 256, v13 + 4709, v23, v24, v25, v26, *v13);
    *(v47 + 1) = v45;
    if ([objc_msgSend(DYGetGLGuestAppClient() "activeCaptureDescriptor")])
    {
      GPUTools::FB::EncodeCurrentBacktrace();
...
LABEL_48:
  ...
  *(v13 + 4838) = 1;
  ...
  if ([DYGetGLGuestAppClient() state] != &dword_0 + 1 || !objc_msgSend(DYGetGLGuestAppClient(), "triggerCaptureOnNextGLCommand"))
  {
    ...
    snprintf((v13 + 4709), 0x40uLL, "Cee@%u%c", *&v46[1], v17);
    GPUTools::FB::Encode(&v47, 294, 256, v13 + 4709, v18, v19, v20, v21, *v13);
    v22 = byte_21AF7E;
    if (byte_21AF7E)
    {
      breakpoint_break(&v47, &stru_108.segname[14], 1, *(v13 + 3404), v13);
    }

    if (!([DYGetGLGuestAppClient() overrideFlags] & 0x10 | v22 & 4))
    {
      v27 = mach_absolute_time();
      (*(*(v13 + 32) + 1008))(a1, a2, a3, a4);
      v28 = mach_absolute_time() - v27;
      if (g_DYTimebaseInfo == *(&g_DYTimebaseInfo + 1))
      {
        v29 = v47;
...
LABEL_25:
    ...
    GPUTools::FB::Encode(&v47, 294, 256, v13 + 4709, v23, v24, v25, v26, *v13);
    *(v47 + 1) = v45;
    if ([objc_msgSend(DYGetGLGuestAppClient() "activeCaptureDescriptor")])
    {
      GPUTools::FB::EncodeCurrentBacktrace();
...
LABEL_48:
  ...
  *(v13 + 4838) = 1;
  ...
  if ([DYGetGLGuestAppClient() state] != &dword_0 + 1 || !objc_msgSend(DYGetGLGuestAppClient(), "triggerCaptureOnNextGLCommand"))
  {
    ...
    snprintf((v13 + 4709), 0x40uLL, "Cee@%u%c", *&v46[1], v17);
    GPUTools::FB::Encode(&v47, 295, 256, v13 + 4709, v18, v19, v20, v21, *v13);
    v22 = byte_21AF7F;
    if (byte_21AF7F)
    {
      breakpoint_break(&v47, &stru_108.segname[15], 1, *(v13 + 3404), v13);
    }

    if (!([DYGetGLGuestAppClient() overrideFlags] & 0x10 | v22 & 4))
    {
      v27 = mach_absolute_time();
      (*(*(v13 + 32) + 1016))(a1, a2, a3, a4);
      v28 = mach_absolute_time() - v27;
      if (g_DYTimebaseInfo == *(&g_DYTimebaseInfo + 1))
      {
        v29 = v47;
...
LABEL_25:
    ...
    GPUTools::FB::Encode(&v47, 295, 256, v13 + 4709, v23, v24, v25, v26, *v13);
    *(v47 + 1) = v45;
    if ([objc_msgSend(DYGetGLGuestAppClient() "activeCaptureDescriptor")])
    {
      GPUTools::FB::EncodeCurrentBacktrace();
...
LABEL_47:
  ...
  *(v12 + 4838) = 1;
  ...
  if ([DYGetGLGuestAppClient() state] != &dword_0 + 1 || !objc_msgSend(DYGetGLGuestAppClient(), "triggerCaptureOnNextGLCommand"))
  {
    GPUTools::FB::Encode(v38, 339, 0, v6, v15, v16, v17, v18, *v12);
    v19 = byte_21AFAB;
    if (byte_21AFAB)
    {
      breakpoint_break(v38, (&stru_108.reserved2 + 3), 1, *(v12 + 3404), v12);
    }

    if (!([DYGetGLGuestAppClient() overrideFlags] & 0x10 | v19 & 4))
    {
      v20 = mach_absolute_time();
      (*(*(v12 + 32) + 1168))(a1, a2, a3);
...
LABEL_26:
    ...
    GPUTools::FB::EncodeThreadQueueInfo((v12 + 3480), (v12 + 3520), v38);
    v23 = *(v12 + 3404);
...
LABEL_35:
    ...
    breakpoint_break(v38, v34, v33, v23, v12);
    goto LABEL_35;
  }

  atomic_fetch_add((v12 + 4640), 0xFFFFFFFF);
  [DYGetGLGuestAppClient() triggerArmedCapture];
  (*(*(v12 + 24) + 1168))(a1, a2, a3);
LABEL_43:
  if (v38[0])
  {
    free(v38[0]);
...
LABEL_47:
  ...
  *(v11 + 4838) = 1;
  ...
  if ([DYGetGLGuestAppClient() state] != &dword_0 + 1 || !objc_msgSend(DYGetGLGuestAppClient(), "triggerCaptureOnNextGLCommand"))
  {
    ...
    GPUTools::FB::Encode(v39, 340, 0, v11 + 4709, v17, v18, v19, v20, *v11);
    v21 = byte_21AFAC;
    if (byte_21AFAC)
    {
      breakpoint_break(v39, &stru_108.reserved3, 1, *(v11 + 3404), v11);
    }

    if (!([DYGetGLGuestAppClient() overrideFlags] & 0x10 | v21 & 4))
    {
      v22 = mach_absolute_time();
      (*(*(v11 + 32) + 1176))(a1, a2, a3);
...
LABEL_37:
      ...
      breakpoint_break(&__ptr, v44, v43, v33, v13);
      goto LABEL_37;
    }
...
LABEL_44:
  ...
  *(v13 + 4838) = 1;
  ...
  if ([DYGetGLGuestAppClient() state] != &dword_0 + 1 || !objc_msgSend(DYGetGLGuestAppClient(), "triggerCaptureOnNextGLCommand"))
  {
    ...
    GPUTools::FB::Encode(v40, 344, 0, v13 + 4709, v18, v19, v20, v21, *v13);
    v22 = byte_21AFB0;
    if (byte_21AFB0)
    {
      breakpoint_break(v40, &stru_158, 1, *(v13 + 3404), v13);
    }

    if (!([DYGetGLGuestAppClient() overrideFlags] & 0x10 | v22 & 4))
    {
      v23 = mach_absolute_time();
      (*(*(v13 + 32) + 1208))(a1, a2, a3, a4);
