  ...
  *(v17 + 4838) = 1;
  ...
  if ([DYGetGLGuestAppClient() state] != &dword_0 + 1 || !objc_msgSend(DYGetGLGuestAppClient(), "triggerCaptureOnNextGLCommand"))
  {
    ...
    *v20 = 0;
    ...
    GPUTools::FB::Encode(&v54, 934, 256, v17 + 4709, v23, v24, v25, v26, *v17);
    v27 = a6;
    v52 = byte_21B1FE;
    if (byte_21B1FE)
    {
      breakpoint_break(&v54, &stru_388.segname[14], 1, *(v17 + 3404), v17);
    }

    if (!([DYGetGLGuestAppClient() overrideFlags] & 0x10 | v52 & 4))
    {
      v28 = mach_absolute_time();
      (*(*(v17 + 32) + 7096))(a1, a2, a3, v20, a5, v27);
...
LABEL_32:
    if (*v20 >= 1)
    {
      ...
      *(strlen((v17 + 4709)) + v17 + 4709 - 1) = 85;
      ...
      v50 = *v20;
      GPUTools::FB::Encode(&v54, 934, 256, v17 + 4709, v31, v32, v33, v34, *v17);
      *(v54 + 1) = v51;
    }
...
LABEL_44:
  ...
  *(v17 + 4838) = 1;
  ...
  if ([DYGetGLGuestAppClient() state] != &dword_0 + 1 || !objc_msgSend(DYGetGLGuestAppClient(), "triggerCaptureOnNextGLCommand"))
  {
    GPUTools::FB::Encode(v42, 934, 2, "Cuiippp", v20, v21, v22, v23, *v17);
    v24 = byte_21B1FE;
    if (byte_21B1FE)
    {
      breakpoint_break(v42, &stru_388.segname[14], 1, *(v17 + 3404), v17);
    }
...
LABEL_55:
  ...
  *(v15 + 4838) = 1;
  ...
  if ([DYGetGLGuestAppClient() state] != &dword_0 + 1 || !objc_msgSend(DYGetGLGuestAppClient(), "triggerCaptureOnNextGLCommand"))
  {
    ...
    GPUTools::FB::Encode(v42, 937, 0, v15 + 4709, v18, v19, v20, v21, *v15);
    v24 = byte_21B201;
    if (byte_21B201)
    {
      breakpoint_break(v42, (&stru_388.addr + 1), 1, *(v15 + 3404), v15);
    }
...
LABEL_46:
  ...
  *(v11 + 4838) = 1;
  ...
  if ([DYGetGLGuestAppClient() state] != &dword_0 + 1 || !objc_msgSend(DYGetGLGuestAppClient(), "triggerCaptureOnNextGLCommand"))
  {
    ...
    GPUTools::FB::Encode(&v43, 987, v11 + 4709, v14, v15, v16, v17, v18, *v11);
    v19 = byte_21B233;
    if (byte_21B233)
    {
      breakpoint_break(&v43, &stru_3D8.sectname[3], 1, *(v11 + 3404), v11);
    }
...
LABEL_23:
    ...
    GPUTools::FB::Encode(&v43, 987, 0, v11 + 4709, v20, v21, v22, v23, *v11);
    *(v43 + 1) = v42;
    if ([objc_msgSend(DYGetGLGuestAppClient() "activeCaptureDescriptor")])
    {
      GPUTools::FB::EncodeCurrentBacktrace();
...
LABEL_44:
  ...
  *(v11 + 4838) = 1;
  ...
  {
    snprintf((v11 + 4709), 0x40uLL, "Ci@%dui", a2);
    GPUTools::FB::Encode(v36, 981, 0, v11 + 4709, v14, v15, v16, v17, *v11);
    v18 = byte_21B22D;
    if (byte_21B22D)
    {
      breakpoint_break(v36, (&stru_388.reserved3 + 1), 1, *(v11 + 3404), v11);
    }
