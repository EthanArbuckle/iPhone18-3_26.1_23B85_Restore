...
LABEL_3:
  ...
  dispatch_once(&qword_2A18CB1E0, block);
  v3 = qword_2A18CB1D8;
  if ((SHIBYTE(__p.__r_.__value_.__r.__words[2]) & 0x80000000) == 0)
  {
LABEL_4:
...
- (void)setUpNotificationCenter:(id)center
{
  ...
  if (!self->fUserNotificationCenter)
  {
    ...
    {
      v8 = qword_2A18CB228;
      if (!os_log_type_enabled(qword_2A18CB228, OS_LOG_TYPE_INFO))
      {
LABEL_6:
    ...
    *buf = 138412290;
    v11 = centerCopy;
    _os_log_impl(&dword_297476000, v8, OS_LOG_TYPE_INFO, "UserNotificationCenter created with bundleID %@", buf, 0xCu);
    goto LABEL_6;
  }
...
- (BOOL)setActionForHeader:(UserNotificationManager *)self notificationContent:(SEL)content callbackData:(NotificationInfo *)data
{
  ...
  v7 = v3;
  v8 = v7;
  if ((atomic_load_explicit(&qword_2A18CB1E8, memory_order_acquire) & 1) == 0)
  {
    v7 = __cxa_guard_acquire(&qword_2A18CB1E8);
    if (v7)
    {
      _MergedGlobals_4 = TelephonyUtilIsInternalBuild();
      __cxa_guard_release(&qword_2A18CB1E8);
    }
  }

  if ((atomic_load_explicit(&qword_2A18CB1F8, memory_order_acquire) & 1) == 0)
  {
    v7 = __cxa_guard_acquire(&qword_2A18CB1F8);
    if (v7)
    {
      if (_MergedGlobals_4)
      {
      ...
      qword_2A18CB1F0 = v120;
      __cxa_guard_release(&qword_2A18CB1F8);
    }
  }

  if ((atomic_load_explicit(&qword_2A18CB208, memory_order_acquire) & 1) == 0)
  {
    v7 = __cxa_guard_acquire(&qword_2A18CB208);
    if (v7)
    {
      if (_MergedGlobals_4)
      {
      ...
      qword_2A18CB200 = v121;
      __cxa_guard_release(&qword_2A18CB208);
    }
  }
...
LABEL_237:
    ...
    *(&buf + 4) = v10;
    _os_log_error_impl(&dword_297476000, v117, OS_LOG_TYPE_ERROR, "Unsupported header: %s", &buf, 0xCu);
    v107 = 0;
    goto LABEL_214;
  }
...
LABEL_53:
  ...
  if ((v35 != 22 || v38) && ((v11 & 0x80) != 0 ? (v40 = data[1].var0.var0.var1.var0, v39 = data[1].var0.var0.var1.var1) : (v39 = v11, v40 = data + 1), v39 >= 0x14 ? (v41 = 20) : (v41 = v39), (v42 = memcmp(v40, "Telephony_Dump_Ready", v41), v39 != 20) || v42))
  {
    ...
    {
      v43 = [MEMORY[0x29EDB8E70] URLWithString:qword_2A18CB200];
      [v8 setDefaultActionURL:v43];
    }
  }
  ...
  {
    v43 = [MEMORY[0x29EDB8E70] URLWithString:qword_2A18CB1F0];
    [v8 setDefaultActionURL:v43];
  }
...
LABEL_207:
  ...
  if (os_log_type_enabled(qword_2A18CB228, OS_LOG_TYPE_INFO))
  {
    ...
    LODWORD(buf) = 136315138;
    *(&buf + 4) = data;
    _os_log_impl(&dword_297476000, v106, OS_LOG_TYPE_INFO, "Added callback for id: %s", &buf, 0xCu);
  }
...
LABEL_27:
    ...
    v14 = [v11 localizedStringForKey:v13 value:&stru_2A1E50838 table:@"Localizable"];
    [v3 setHeader:v14];
      ...
      if (v25 != 22 || v28)
      {
        ...
        if (v38 != 23 || v41)
        {
          ...
          if (v15 != 23 || v43)
          {
            ...
            v23 = [v21 localizedStringForKey:v22 value:&stru_2A1E50838 table:@"Localizable"];
            [v3 setBody:v23];
            goto LABEL_50;
          }

          v21 = [MEMORY[0x29EDB9F48] bundleWithPath:@"/System/Library/UserNotifications/Bundles/com.apple.telephony.BasebandServicesNotification.bundle"];
          v22 = [v21 localizedStringForKey:@"Baseband_Config_Updated_Details" value:&stru_2A1E50838 table:@"Localizable"];
          [v3 setBody:v22];
        }
        ...
        {
          v21 = [MEMORY[0x29EDB9F48] bundleWithPath:@"/System/Library/UserNotifications/Bundles/com.apple.telephony.BasebandServicesNotification.bundle"];
          v22 = [v21 localizedStringForKey:@"Check_Settings_Cellular_Diagnostics" value:&stru_2A1E50838 table:@"Localizable"];
          [v3 setBody:v22];
        }
...
LABEL_56:
            ...
            *buf = 136315138;
            v51 = v36;
            _os_log_impl(&dword_297476000, v35, OS_LOG_TYPE_INFO, "Added notification request with id: %s", buf, 0xCu);
          }
        }
    ...
    else
    {
      ...
      v21 = [MEMORY[0x29EDB9F48] bundleWithPath:@"/System/Library/UserNotifications/Bundles/com.apple.telephony.BasebandServicesNotification.bundle"];
      v22 = [v21 localizedStringForKey:@"Telephony_Dump_Insufficient_Details_%@" value:&stru_2A1E50838 table:@"Localizable"];
      if (*(a1 + 111) < 0)
      {
        v7 = *v7;
      }
...
LABEL_33:
  ...
  *buf = 136315394;
  ...
  v38 = 2080;
  v39 = v27;
  _os_log_impl(&dword_297476000, v26, OS_LOG_TYPE_INFO, "Submitting CoreAnalytics event[%s] - %s", buf, 0x16u);
  if (v33 < 0)
  {
...
LABEL_10:
  ...
  *buf = 136315138;
  *&buf[4] = v11;
  _os_log_impl(&dword_297476000, v10, OS_LOG_TYPE_INFO, "Received notification response with id: %s", buf, 0xCu);
LABEL_16:
  v12 = *(a1 + 48);
  if (v12)
  {
...
LABEL_101:
              ...
              *v60 = 136315138;
              v61 = v43;
              _os_log_impl(&dword_297476000, v42, OS_LOG_TYPE_INFO, "Removed callback for id: %s", v60, 0xCu);
            }
          }
