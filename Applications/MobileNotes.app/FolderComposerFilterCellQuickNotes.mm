...
- (_TtC11MobileNotes34FolderComposerFilterCellQuickNotes)initWithCoder:(id)coder;
- (_TtC11MobileNotes34FolderComposerFilterCellQuickNotes)initWithFrame:(CGRect)frame;
@end
