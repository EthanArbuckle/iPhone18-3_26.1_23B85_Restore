...
- (_TtC11MobileNotes26FolderComposerFilterFooter)initWithCoder:(id)coder;
- (_TtC11MobileNotes26FolderComposerFilterFooter)initWithFrame:(CGRect)frame;
...
- (_TtC11MobileNotes26FolderComposerFilterFooter)initWithCoder:(id)coder
{
  ...
  *v6 = 0;
  ...
  coderCopy = coder;
  v8 = [(FolderComposerFilterFooter *)&v10 initWithCoder:coderCopy];
