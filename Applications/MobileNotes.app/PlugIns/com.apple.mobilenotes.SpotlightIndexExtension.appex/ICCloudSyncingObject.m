...
+ (void)undoablyPersistActivityEventsForMoveAction:(id)a3 oldObject:(id)a4 newObject:(id)a5
{
  ...
  v8 = a4;
  v9 = a5;
  _sSo20ICCloudSyncingObjectC45com_apple_mobilenotes_SpotlightIndexExtensionE29undoablyPersistActivityEvents3for03oldC003newC0yAbCE10MoveActionC_ABSgAJtFZ_0(v7, a4, a5);
}
