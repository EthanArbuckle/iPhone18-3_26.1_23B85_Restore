...
- (void)undoablySetOrder:(unint64_t)a3 ofChild:(id)a4
{
  ...
  v15 = [v14 localizedStringForKey:@"Set Folder Order" value:&stru_1000F6F48 table:0];
...
- (void)undoablyRemoveFromOrder:(id)a3
{
  ...
  v11 = [v10 localizedStringForKey:@"Remove Folder Order" value:&stru_1000F6F48 table:0];
