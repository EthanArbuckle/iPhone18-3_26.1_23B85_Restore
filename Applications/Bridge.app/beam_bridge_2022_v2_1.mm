...
- (id)predictionFromFeatures:(id)a3 error:(id *)a4
{
  ...
  v8 = [(beam_bridge_2022_v2_1 *)self predictionFromFeatures:v6 options:v7 error:a4];
...
- (id)predictionFromFeatures:(id)a3 options:(id)a4 error:(id *)a5
{
  v8 = a4;
  v9 = a3;
  v10 = [(beam_bridge_2022_v2_1 *)self model];
...
- (void)predictionFromFeatures:(id)a3 completionHandler:(id)a4
{
  v6 = a4;
  v7 = a3;
  v8 = [(beam_bridge_2022_v2_1 *)self model];
...
- (void)predictionFromFeatures:(id)a3 options:(id)a4 completionHandler:(id)a5
{
  ...
  v9 = a4;
  v10 = a3;
  v11 = [(beam_bridge_2022_v2_1 *)self model];
...
- (id)predictionFromImage_Placeholder:(__CVBuffer *)a3 error:(id *)a4
{
  v6 = [[beam_bridge_2022_v2_1Input alloc] initWithImage_Placeholder:a3];
  v7 = [(beam_bridge_2022_v2_1 *)self predictionFromFeatures:v6 error:a4];
