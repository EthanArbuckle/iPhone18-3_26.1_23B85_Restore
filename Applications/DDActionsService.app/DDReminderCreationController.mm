...
- (DDReminderCreationController)initWithAction:(id)action delegate:(id)delegate;
...
LABEL_4:
    associatedResults = [actionCopy associatedResults];
    [actionCopy associatedResults];
    context = [actionCopy context];
    _hostApplicationBundleIdentifier = [delegateCopy _hostApplicationBundleIdentifier];
    v13 = DDUIAugmentedContextForEvent();

    v14 = sub_10000B334(associatedResults, v13, &v9->_isAllDay);
...
LABEL_22:
    ...
    v16 = sub_10000AF48(associatedResults, v13);
    if (v16)
    {
    ...
    _hostApplicationBundleIdentifier2 = [delegateCopy _hostApplicationBundleIdentifier];
    v18 = CFPreferencesCopyAppValue(@"AppCanShowSiriSuggestionsBlacklist", @"com.apple.suggestions");
    v19 = [v18 containsObject:_hostApplicationBundleIdentifier2];
...
LABEL_21:
      ...
      _hostApplicationBundleIdentifier2 = sub_10000ADA0(associatedResults, v13);
      if ([_hostApplicationBundleIdentifier2 length])
      {
        ...
        if (v21)
        {
          ...
          v23 = v22;
          v37 = v23;
          [v21 reminderTitleForContent:_hostApplicationBundleIdentifier2 withCompletion:v36];
      ...
      v28 = sub_10000AF5C(associatedResults, v13);
      if (v28)
      {
      ...
      v31 = sub_10000B174(associatedResults, v13);
...
- (void)reminderCreationViewController:(id)controller didCreateReminder:(BOOL)reminder error:(id)error
{
  ...
  _remoteViewControllerProxy = [v9 _remoteViewControllerProxy];
...
- (void)setTitle:(id)title
{
  ...
  {
    titleCopy = title;
    v5 = [[NSAttributedString alloc] initWithString:titleCopy attributes:&off_100019418];
