...
- (void)dealloc
{
  ...
  v4 = *(&v2->super.super.super.super.isa + OBJC_IVAR____TtC20JournalWidgetsSecure14VideoAssetView_playerView);
  *(&v2->super.super.super.super.isa + OBJC_IVAR____TtC20JournalWidgetsSecure14VideoAssetView_playerView) = 0;
