...
- (CGSize)intrinsicContentSize
{
  [*(&self->super.super.super.isa + OBJC_IVAR____TtCC7Journal36AudioRecordingLiveActivityStopButtonP33_9B17AF2B67F796200586389DA24B04BC11PackageView_rootLayer) bounds];
  v3 = v2;
  v5 = v4;
  result.height = v5;
  result.width = v3;
