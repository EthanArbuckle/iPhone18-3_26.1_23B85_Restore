...
- (CARSetupAppClipsView)initWithAppClipIdentifiers:(id)identifiers;
@end
...
- (CARSetupAppClipsView)initWithAppClipIdentifiers:(id)identifiers
{
  ...
  if (v6)
  {
    objc_storeStrong(&v6->_appClipIDs, identifiers);
    v8 = [[ASCLockupViewGroup alloc] initWithName:@"CarPlaySetup"];
    lockupGroup = v7->_lockupGroup;
    v7->_lockupGroup = v8;

    safeAreaLayoutGuide = [(CARSetupAppClipsView *)v7 safeAreaLayoutGuide];
    ...
    [v11 setText:v13];
    v55 = identifiersCopy;
    traitCollection = [(CARSetupAppClipsView *)v7 traitCollection];
    v15 = [UIFontDescriptor preferredFontDescriptorWithTextStyle:UIFontTextStyleTitle2 compatibleWithTraitCollection:traitCollection];
    ...
    v19 = [obja constraintEqualToAnchor:leadingAnchor];
    v74[0] = v19;
    ...
    leadingAnchor2 = [v54 leadingAnchor];
    v28 = [objb constraintEqualToAnchor:leadingAnchor2];
    v73[0] = v28;
    ...
    v33 = [topAnchor3 constraintEqualToSystemSpacingBelowAnchor:bottomAnchor multiplier:1.5];
    v73[2] = v33;
    ...
    if (v36)
    {
      ...
      do
      {
        for (i = 0; i != v37; i = i + 1)
        {
          ...
          lockupGroup = [(CARSetupAppClipsView *)v7 lockupGroup];
          ...
          v62 = v7;
          v63 = v35;
          [lockupGroup _lockupRequestForBundleID:v41 withContext:v39 completionBlock:v61];
        }
