...
{
  v5 = self;
  v2 = [(FMItemEmailViewController *)v5 parentViewController];
  if (v2)
  {
    v3 = v2;
    objc_opt_self();
...
LABEL_5:
    v14 = 0;
    v16 = 0;
    return sub_100374C54(v9, v11, a4, v13, v14, v16, a6);
  }
...
- (_TtC6FindMy25FMItemEmailViewController)initWithTitle:(id)a3 detailText:(id)a4 icon:(id)a5 contentLayout:(int64_t)a6
{
  ...
  v14 = a5;
  return sub_100374E54(v9, v11, a4, v13, a5, a6);
}
