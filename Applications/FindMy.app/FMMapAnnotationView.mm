...
- (_TtC6FindMy19FMMapAnnotationView)initWithAnnotation:(id)annotation reuseIdentifier:(id)identifier;
...
{
  selfCopy = self;
  sub_1002DE0D8(selected, animated);
}
...
- (BOOL)shouldShowCallout
{
  ...
  {
    v3 = *(&selfCopy->super.super.super.super.isa + OBJC_IVAR____TtC6FindMy19FMMapAnnotationView_shouldHideCallout);
