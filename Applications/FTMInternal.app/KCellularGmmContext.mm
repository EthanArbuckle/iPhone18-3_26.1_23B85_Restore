...
- (id)description
{
  ...
  v4 = [(KCellularGmmContext *)self dictionaryRepresentation];
...
LABEL_92:
  ...
  if (regProc >= 0xB)
  {
    v23 = [NSString stringWithFormat:@"(unknown: %i)", self->_regProc];
  }

  else
  {
    v23 = *(&off_100317DE0 + regProc);
  }

  [v3 setObject:v23 forKey:@"reg_proc"];
...
LABEL_3:
  ...
  *(v4 + 9) = self->_regStatus;
  *(v4 + 28) |= 0x10u;
  if ((*&self->_has & 0x100) != 0)
  {
LABEL_4:
    *(v4 + 13) = self->_updateStatus;
    *(v4 + 28) |= 0x100u;
  }
...
LABEL_5:
  v8 = [(RoutingAreaId *)self->_rai copyWithZone:a3];
  v9 = v6[3];
  v6[3] = v8;
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ((has & 0x10) != 0)
  {
    if ((v6 & 0x10) == 0 || self->_regStatus != *(v4 + 9))
    {
      goto LABEL_50;
    }
  }
  ...
  if ((*&self->_has & 0x100) != 0)
  {
    if ((*(v4 + 28) & 0x100) == 0 || self->_updateStatus != *(v4 + 13))
    {
      goto LABEL_50;
    }
  }
...
LABEL_50:
  ...
  if ((has & 0x80) != 0)
  {
    if ((v8 & 0x80) == 0 || self->_t3312DurS != *(v4 + 12))
    {
      goto LABEL_50;
    }
  }
  ...
  if ((has & 4) != 0)
  {
    if ((v8 & 4) == 0 || self->_procFailureCause != *(v4 + 5))
    {
      goto LABEL_50;
    }
  }
  ...
  if ((has & 0x20) != 0)
  {
    if ((v8 & 0x20) == 0 || self->_rejectCause != *(v4 + 10))
    {
      goto LABEL_50;
    }
  }
  ...
  if ((has & 0x40) != 0)
  {
    if ((v8 & 0x40) == 0 || self->_subsId != *(v4 + 11))
    {
      goto LABEL_50;
    }
...
LABEL_3:
  ...
  self->_regStatus = *(v4 + 9);
  *&self->_has |= 0x10u;
  if ((*(v4 + 28) & 0x100) != 0)
  {
LABEL_4:
    self->_updateStatus = *(v4 + 13);
    *&self->_has |= 0x100u;
  }
