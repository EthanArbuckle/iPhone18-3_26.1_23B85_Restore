...
- (id)description
{
  ...
  v4 = [(RrcConnReqRel *)self dictionaryRepresentation];
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ((*&self->_has & 4) != 0)
  {
    if ((*(v4 + 24) & 4) == 0 || self->_establishCause != *(v4 + 4))
    {
      goto LABEL_21;
    }
  }
...
LABEL_21:
  ...
  if (*&self->_has)
  {
    if ((*(v4 + 24) & 1) == 0 || self->_connStage != *(v4 + 2))
    {
      goto LABEL_21;
    }
  }
  ...
  if ((*&self->_has & 2) != 0)
  {
    if ((*(v4 + 24) & 2) == 0 || self->_counter != *(v4 + 3))
    {
      goto LABEL_21;
    }
  }
  ...
  if ((*&self->_has & 8) != 0)
  {
    if ((*(v4 + 24) & 8) == 0 || self->_releaseCause != *(v4 + 5))
    {
      goto LABEL_21;
    }
