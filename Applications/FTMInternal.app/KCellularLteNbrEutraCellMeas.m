...
{
  v7.receiver = self;
  v7.super_class = KCellularLteNbrEutraCellMeas;
  v3 = [(KCellularLteNbrEutraCellMeas *)&v7 description];
  v4 = [(KCellularLteNbrEutraCellMeas *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  {
    v5 = [[NSMutableArray alloc] initWithCapacity:{-[NSMutableArray count](self->_measNbrEutras, "count")}];
    v14 = 0u;
    v15 = 0u;
    v16 = 0u;
    v17 = 0u;
...
- (void)copyTo:(id)a3
{
  ...
  if ([(KCellularLteNbrEutraCellMeas *)self measNbrEutrasCount])
  {
    ...
    v5 = [(KCellularLteNbrEutraCellMeas *)self measNbrEutrasCount];
    if (v5)
    {
      v6 = v5;
      for (i = 0; i != v6; ++i)
      {
        v8 = [(KCellularLteNbrEutraCellMeas *)self measNbrEutraAtIndex:i];
...
- (BOOL)isEqual:(id)a3
{
  ...
  measNbrEutras = self->_measNbrEutras;
  if (measNbrEutras | *(v4 + 2))
  {
    if (![(NSMutableArray *)measNbrEutras isEqual:?])
    {
LABEL_14:
      v8 = 0;
      goto LABEL_15;
...
- (unint64_t)hash
{
  ...
  v4 = [(NSMutableArray *)self->_measNbrEutras hash];
  if ((*&self->_has & 2) != 0)
  {
  ...
  if (v7)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        [(KCellularLteNbrEutraCellMeas *)self addMeasNbrEutra:*(*(&v11 + 1) + 8 * v10), v11];
        v10 = v10 + 1;
      }
