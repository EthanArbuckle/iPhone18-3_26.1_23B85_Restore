...
- (BOOL)isEqual:(id)a3
{
  ...
  if ((has & 0x10) != 0)
  {
    if ((v6 & 0x10) == 0 || self->_msgLengthMs != *(v4 + 7))
    {
      goto LABEL_55;
    }
  }
  ...
  if ((has & 0x20) != 0)
  {
    if ((v6 & 0x20) == 0 || self->_numPreambles != *(v4 + 8))
    {
      goto LABEL_55;
    }
  }
  ...
  if ((has & 4) != 0)
  {
    if ((v6 & 4) == 0 || self->_aichStatus != *(v4 + 5))
    {
      goto LABEL_55;
    }
  }
  ...
  {
    if ((*(v4 + 30) & 0x200) == 0 || self->_txPwrDbm != *(v4 + 14))
    {
      goto LABEL_55;
    }
  }
...
LABEL_55:
  ...
  if ((has & 0x100) != 0)
  {
    if ((*(v4 + 30) & 0x100) == 0 || self->_subsId != *(v4 + 13))
    {
      goto LABEL_55;
    }
  }
  ...
  if ((has & 0x80) != 0)
  {
    if ((v8 & 0x80) == 0 || self->_psPref != *(v4 + 12))
    {
      goto LABEL_55;
    }
