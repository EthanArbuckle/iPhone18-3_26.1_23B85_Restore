...
- (BOOL)isEqual:(id)a3
{
  ...
  if (*&self->_has)
  {
    if ((*(v4 + 28) & 1) == 0 || self->_phyCellId != *(v4 + 2))
    {
      goto LABEL_26;
    }
  }
...
LABEL_26:
  ...
  if ((*&self->_has & 0x10) != 0)
  {
    if ((*(v4 + 28) & 0x10) == 0 || self->_sinr1 != *(v4 + 6))
    {
      goto LABEL_26;
    }
