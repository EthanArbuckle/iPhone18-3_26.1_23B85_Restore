...
{
  v7.receiver = self;
  v7.super_class = RsrpRsrqSinr;
  v3 = [(RsrpRsrqSinr *)&v7 description];
  dictionaryRepresentation = [(RsrpRsrqSinr *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  if (has)
  {
    v7 = [NSNumber numberWithUnsignedInt:self->_phyCellId];
...
LABEL_13:
  toCopy[5] = self->_sinr0;
  *(toCopy + 28) |= 8u;
  if ((*&self->_has & 0x10) != 0)
  {
LABEL_6:
    toCopy[6] = self->_sinr1;
    *(toCopy + 28) |= 0x10u;
  }
...
- (BOOL)isEqual:(id)equal
{
  ...
  if (*&self->_has)
  {
    if ((*(equalCopy + 28) & 1) == 0 || self->_phyCellId != *(equalCopy + 2))
    {
      goto LABEL_26;
    }
  }
...
LABEL_26:
  ...
  if ((*&self->_has & 2) != 0)
  {
    if ((*(equalCopy + 28) & 2) == 0 || self->_rsrp != *(equalCopy + 3))
    {
      goto LABEL_26;
    }
  }
  ...
  if ((*&self->_has & 4) != 0)
  {
    if ((*(equalCopy + 28) & 4) == 0 || self->_rsrq != *(equalCopy + 4))
    {
      goto LABEL_26;
    }
  }
  ...
  if ((*&self->_has & 8) != 0)
  {
    if ((*(equalCopy + 28) & 8) == 0 || self->_sinr0 != *(equalCopy + 5))
    {
      goto LABEL_26;
    }
  }
  ...
  if ((*&self->_has & 0x10) != 0)
  {
    if ((*(equalCopy + 28) & 0x10) == 0 || self->_sinr1 != *(equalCopy + 6))
    {
      goto LABEL_26;
    }
...
LABEL_13:
  self->_sinr0 = *(fromCopy + 5);
  *&self->_has |= 8u;
  if ((*(fromCopy + 28) & 0x10) != 0)
  {
LABEL_6:
    self->_sinr1 = *(fromCopy + 6);
    *&self->_has |= 0x10u;
  }
