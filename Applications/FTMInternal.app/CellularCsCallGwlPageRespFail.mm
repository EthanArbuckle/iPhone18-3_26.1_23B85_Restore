...
- (id)description
{
  ...
  v4 = [(CellularCsCallGwlPageRespFail *)self dictionaryRepresentation];
...
LABEL_21:
  ...
  {
    [v9 clearRedirArfcns];
    v6 = [(CellularCsCallGwlPageRespFail *)self redirArfcnsCount];
    if (v6)
    {
      v7 = v6;
      for (i = 0; i != v7; ++i)
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ((*&has & 0x8000) != 0)
  {
    if ((v6 & 0x8000) == 0 || self->_version != *(v4 + 24))
    {
      goto LABEL_102;
    }
  }
  ...
  if ((*&has & 0x2000) != 0)
  {
    if ((v6 & 0x2000) == 0 || self->_pageRat != *(v4 + 22))
    {
      goto LABEL_102;
    }
  }
  ...
  if ((*&has & 0x10) != 0)
  {
    if ((v6 & 0x10) == 0 || self->_cause != *(v4 + 13))
    {
      goto LABEL_102;
    }
  }
  ...
  if ((*&has & 0x200) != 0)
  {
    if ((v6 & 0x200) == 0 || self->_isImsiPage != *(v4 + 18))
    {
      goto LABEL_102;
    }
  }
  ...
  if ((*&has & 0x100) != 0)
  {
    if ((v6 & 0x100) == 0 || self->_csfbFailureType != *(v4 + 17))
    {
      goto LABEL_102;
    }
  }
  ...
  if ((*&has & 0x40) != 0)
  {
    if ((v6 & 0x40) == 0 || self->_csfbFailureEmmCause != *(v4 + 15))
    {
      goto LABEL_102;
    }
  }
  ...
  if ((*&has & 0x80) != 0)
  {
    if ((v6 & 0x80) == 0 || self->_csfbFailureLocalCause != *(v4 + 16))
    {
      goto LABEL_102;
    }
  }
  ...
  if ((*&has & 0x20) != 0)
  {
    if ((v6 & 0x20) == 0 || self->_csfbAbnormalCause != *(v4 + 14))
    {
      goto LABEL_102;
    }
  }
  ...
  if ((*&has & 0x800) != 0)
  {
    if ((v6 & 0x800) == 0 || self->_lteRegLac != *(v4 + 20))
    {
      goto LABEL_102;
    }
  }
  ...
  if ((*&has & 0x4000) != 0)
  {
    if ((v6 & 0x4000) == 0 || self->_tac != *(v4 + 23))
    {
      goto LABEL_102;
    }
  }
  ...
  if ((*&has & 0x400) != 0)
  {
    if ((v6 & 0x400) == 0 || self->_lteCellId != *(v4 + 19))
    {
      goto LABEL_102;
    }
  }
  ...
  if ((*&has & 2) != 0)
  {
    if ((v6 & 2) == 0 || self->_attemptArfcn != *(v4 + 10))
    {
      goto LABEL_102;
    }
  }
  ...
  if ((*&has & 8) != 0)
  {
    if ((v6 & 8) == 0 || self->_attemptLac != *(v4 + 12))
    {
      goto LABEL_102;
    }
  }
  ...
  if ((*&has & 4) != 0)
  {
    if ((v6 & 4) == 0 || self->_attemptCellId != *(v4 + 11))
    {
      goto LABEL_102;
    }
  }
  ...
  if ((*&has & 0x1000) != 0)
  {
    if ((v6 & 0x1000) == 0 || self->_numRedirFreq != *(v4 + 21))
    {
      goto LABEL_102;
    }
  }
...
LABEL_33:
  self->_csfbFailureEmmCause = *(v4 + 15);
  *&self->_has |= 0x40u;
  v5 = *(v4 + 26);
  if ((v5 & 0x80) == 0)
  {
...
LABEL_34:
  self->_csfbFailureLocalCause = *(v4 + 16);
  *&self->_has |= 0x80u;
  v5 = *(v4 + 26);
  if ((v5 & 0x10000) == 0)
  {
...
LABEL_35:
  self->_csfbIsLacMismatch = *(v4 + 100);
  *&self->_has |= 0x10000u;
  v5 = *(v4 + 26);
  if ((v5 & 0x20) == 0)
  {
...
LABEL_44:
  self->_numRedirFreq = *(v4 + 21);
  *&self->_has |= 0x1000u;
  if ((*(v4 + 26) & 0x40000) != 0)
  {
LABEL_20:
    self->_isRedirHighBandPcs = *(v4 + 102);
    *&self->_has |= 0x40000u;
  }

LABEL_21:
  v9 = v4;
  v6 = [v4 redirArfcnsCount];
  if (v6)
  {
    v7 = v6;
    for (i = 0; i != v7; ++i)
