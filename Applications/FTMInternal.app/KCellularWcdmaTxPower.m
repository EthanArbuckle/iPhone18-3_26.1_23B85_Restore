...
- (id)description
{
  ...
  v4 = [(KCellularWcdmaTxPower *)self dictionaryRepresentation];
...
- (void)copyTo:(id)a3
{
  ...
  if ([(KCellularWcdmaTxPower *)self txPowerInfosCount])
  {
    ...
    v5 = [(KCellularWcdmaTxPower *)self txPowerInfosCount];
    if (v5)
    {
      v6 = v5;
      for (i = 0; i != v6; ++i)
...
LABEL_14:
  ...
  if ((has & 2) != 0)
  {
    if ((*(v4 + 32) & 2) == 0 || self->_subsId != *(v4 + 4))
    {
      goto LABEL_14;
    }
