...
- (id)description
{
  ...
  v4 = [(CellularWcdmaTxRxHistV2 *)self dictionaryRepresentation];
...
- (void)copyTo:(id)a3
{
  ...
  if ([(CellularWcdmaTxRxHistV2 *)self histPerBandsCount])
  {
    ...
    v6 = [(CellularWcdmaTxRxHistV2 *)self histPerBandsCount];
    if (v6)
    {
      v7 = v6;
      for (i = 0; i != v7; ++i)
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ((*&self->_has & 2) != 0)
  {
    if ((*(v4 + 56) & 2) == 0 || self->_duration != *(v4 + 4))
    {
      goto LABEL_32;
    }
  }
  ...
  if ((has & 4) != 0)
  {
    if ((*(v4 + 56) & 4) == 0 || self->_numSubs != *(v4 + 8))
    {
      goto LABEL_32;
    }
  }
  ...
  if ((has & 8) != 0)
  {
    if ((*(v4 + 56) & 8) == 0 || self->_psPref != *(v4 + 12))
    {
      goto LABEL_32;
    }
  }
...
LABEL_28:
  ...
  if ((has & 0x10) != 0)
  {
    if ((*(v4 + 56) & 0x10) == 0 || self->_subsId != *(v4 + 13))
    {
      goto LABEL_32;
    }
