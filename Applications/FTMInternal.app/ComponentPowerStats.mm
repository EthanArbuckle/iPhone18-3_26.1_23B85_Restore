...
- (id)description
{
  ...
  v4 = [(ComponentPowerStats *)self dictionaryRepresentation];
...
LABEL_11:
  v4[4] = self->_cumulatedEnergyMj;
  *(v4 + 24) |= 4u;
  if ((*&self->_has & 2) != 0)
  {
LABEL_5:
    v4[3] = self->_avgPowerMw;
    *(v4 + 24) |= 2u;
  }
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ((*&self->_has & 8) != 0)
  {
    if ((*(v4 + 24) & 8) == 0 || self->_peakPowerMw != *(v4 + 5))
    {
      goto LABEL_21;
    }
  }
...
LABEL_21:
  ...
  if (*&self->_has)
  {
    if ((*(v4 + 24) & 1) == 0 || self->_avgActivePowerMw != *(v4 + 2))
    {
      goto LABEL_21;
    }
  }
  ...
  if ((*&self->_has & 4) != 0)
  {
    if ((*(v4 + 24) & 4) == 0 || self->_cumulatedEnergyMj != *(v4 + 4))
    {
      goto LABEL_21;
    }
  }
  ...
  if ((*&self->_has & 2) != 0)
  {
    if ((*(v4 + 24) & 2) == 0 || self->_avgPowerMw != *(v4 + 3))
    {
      goto LABEL_21;
    }
...
LABEL_11:
  self->_cumulatedEnergyMj = *(v4 + 4);
  *&self->_has |= 4u;
  if ((*(v4 + 24) & 2) != 0)
  {
LABEL_5:
    self->_avgPowerMw = *(v4 + 3);
    *&self->_has |= 2u;
  }
