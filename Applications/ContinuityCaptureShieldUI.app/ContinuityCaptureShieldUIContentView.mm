...
- (ContinuityCaptureShieldUIContentView)initWithFrame:(CGRect)frame
{
  ...
  if (v3)
  {
    ...
    v167[1] = 3221225472;
    v167[2] = sub_1000084BC;
    v167[3] = &unk_100018780;
    ...
    v165[1] = 3221225472;
    v165[2] = sub_100008574;
    v165[3] = &unk_100018780;
    ...
    v163[1] = 3221225472;
    v163[2] = sub_1000087D8;
    v163[3] = &unk_100018780;
    ...
    v161[1] = 3221225472;
    v161[2] = sub_1000088C0;
    v161[3] = &unk_100018780;
    ...
    v159[1] = 3221225472;
    v159[2] = sub_100008978;
    v159[3] = &unk_100018780;
...
- (void)setPauseButtonState:(unint64_t)state
{
  switch(state)
  {
    case 2uLL:
      ...
      v8 = [v7 localizedStringForKey:@"BUTTON_TITLE_RESUME" value:&stru_100018968 table:0];
    ...
    case 1uLL:
      ...
      v6 = [NSAttributedString alloc];
      v7 = +[NSBundle mainBundle];
      v8 = [v7 localizedStringForKey:@"BUTTON_TITLE_PAUSE" value:&stru_100018968 table:0];
...
- (id)_pauseButtonConfiguration
{
  ...
  v6 = [v5 localizedStringForKey:@"BUTTON_TITLE_PAUSE" value:&stru_100018968 table:0];
...
- (id)_facetimeButtonConfiguration
{
  ...
  v9 = [v8 localizedStringForKey:@"BUTTON_TITLE_SWITCH_%@" value:&stru_100018968 table:0];
  v10 = @"iPhone";
  if (userInterfaceIdiom == 1)
  {
    v10 = @"iPad";
...
- (id)_favoritesButtonConfiguration
{
  ...
  v7 = [v6 localizedStringForKey:@"BUTTON_TITLE_FAVORITES" value:&stru_100018968 table:0];
...
- (id)_disconnectButtonConfiguration
{
  ...
  if (self->_inPlacementStep)
  {
    ...
    v5 = +[NSBundle mainBundle];
    v6 = [v5 localizedStringForKey:@"BUTTON_TITLE_DISCONNECT" value:&stru_100018968 table:0];
  ...
  else
  {
    ...
    v6 = [v10 localizedStringForKey:v12 value:&stru_100018968 table:0];
...
- (id)_skipButtonConfiguration
{
  ...
  v5 = [v4 localizedStringForKey:@"BUTTON_TITLE_SKIP_THIS_STEP" value:&stru_100018968 table:0];
  [v2 setTitle:v5];
