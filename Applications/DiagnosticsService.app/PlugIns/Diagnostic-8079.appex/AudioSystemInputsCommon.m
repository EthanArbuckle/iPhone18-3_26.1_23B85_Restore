...
- (BOOL)validateAndInitializeParameters:(id)a3
{
  ...
  if ([v10 count])
  {
    ...
    do
    {
      ...
      v16 = v5;
      v17 = [v5[116] setWithObject:objc_opt_class()];
  ...
  {
    v30 = [v29 dk_numberFromRequiredKey:@"threshold" lowerBound:&off_100015488 upperBound:&off_100015498 failed:&v54];
  ...
  {
    v34 = [v5[116] setWithObject:objc_opt_class()];
    v35 = [v33 dk_arrayFromRequiredKey:@"modelNumbers" types:v34 maxLength:50 failed:&v54 validator:&stru_100014410];
  ...
  {
    v38 = [v37 dk_numberFromRequiredKey:@"xThreshold" lowerBound:&off_1000154A8 upperBound:&off_1000154B8 failed:&v54];
    orientationDetectorXThreshold = self->_orientationDetectorXThreshold;
    self->_orientationDetectorXThreshold = v38;

    v40 = [v37 dk_numberFromRequiredKey:@"zThreshold" lowerBound:&off_1000154A8 upperBound:&off_1000154B8 failed:&v54];
  ...
  v42 = [v48 dk_numberFromRequiredKey:@"fileDownloadTimeout" lowerBound:&off_100015350 upperBound:&off_100015368 failed:&v54];
  fileDownloadTimeout = self->_fileDownloadTimeout;
  self->_fileDownloadTimeout = v42;

  v44 = [v48 dk_numberFromRequiredKey:@"sequenceTimeout" lowerBound:&off_100015350 upperBound:&off_100015368 failed:&v54];
