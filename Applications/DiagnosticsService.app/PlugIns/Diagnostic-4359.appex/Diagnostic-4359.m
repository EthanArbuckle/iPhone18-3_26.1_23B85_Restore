...
void sub_100001128(uint64_t a1, void *a2, void *a3)
{
  v5 = a2;
  v6 = a3;
  if (([*(a1 + 32) isCancelled] & 1) == 0)
  {
    if (v6)
    {
      ...
      if (os_log_type_enabled(v7, OS_LOG_TYPE_DEFAULT))
      {
        *buf = 138412290;
        v31 = v6;
        _os_log_impl(&_mh_execute_header, v7, OS_LOG_TYPE_DEFAULT, "WIS result: %@", buf, 0xCu);
      }
...
LABEL_24:
      ...
      v10 = archiveFiles(v8, @"com.apple.Diagnostics.4359.XXXXXXXX", 0);
      v11 = v10;
      if (!v10)
      {
        goto LABEL_24;
...
void sub_1000018B0(uint64_t a1, NSObject *a2)
{
  v2 = 138412290;
  v3 = a1;
...
void sub_100001928(uint64_t a1, NSObject *a2)
{
  v2 = 138412290;
  v3 = a1;
