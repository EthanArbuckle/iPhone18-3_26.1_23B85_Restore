...
- (void)setupWithInputs:(id)a3 responder:(id)a4
{
  ...
  {
    v6 = [(EnhancedCellularCallPerformanceController *)self copyForSyncing];
    *buf = 67109376;
    v9 = v6;
    v10 = 1024;
...
- (id)_extractFilePaths:(id)a3
{
  ...
  {
    v17 = [(EnhancedCellularCallPerformanceController *)self result];
  ...
  if (![v5 count])
  {
    v18 = [(EnhancedCellularCallPerformanceController *)self result];
