...
- (void)finishRun:(id)a3 reducedLog:(id)a4 result:(int)a5 prcl:(const Prcl *)a6 angles:
{
  ...
  NSLog(@"<%@: %@:%d> %@", @"Diagnostic_FW_Status_iOS", v12, 166, v13);
  ...
  if (!v9)
  {
    ...
    v69 = 0u;
    v68 = 102;
    if ([(PeCoNetViewController *)self convertPrcl:a6 toJlex:&v68])
    {
      ...
      NSLog(@"<%@: %@:%d> %@", @"Diagnostic_FW_Status_iOS", v21, 179, v22);
      ...
      v52 = +[NSString stringWithCString:encoding:](NSString, "stringWithCString:encoding:", a6->jasperSN, +[NSString defaultCStringEncoding]);
      ...
      else
      {
        ...
        NSLog(@"<%@: %@:%d> %@", @"Diagnostic_FW_Status_iOS", v39, 193, v41);
    ...
    else
    {
      ...
      NSLog(@"<%@: %@:%d> %@", @"Diagnostic_FW_Status_iOS", v33, 174, v35);
  ...
  v44 = [v56 componentsJoinedByString:{@", "}];
  ...
  NSLog(@"<%@: %@:%d> %@", @"Diagnostic_FW_Status_iOS", v46, 205, v47);

  v48 = [(PeCoNetViewController *)self result];
  [v48 setData:v14];

  v49 = [NSNumber numberWithInt:v9];
  v50 = [(PeCoNetViewController *)self result];
  [v50 setStatusCode:v49];
...
- (void)setupWithInputs:(id)a3 responder:(id)a4
{
  ...
  NSLog(@"<%@: %@:%d> %@", @"Diagnostic_FW_Status_iOS", v7, 214, v8);
...
- (void)start
{
  ...
  NSLog(@"<%@: %@:%d> %@", @"Diagnostic_FW_Status_iOS", v4, 222, v5);

  v6 = objc_alloc_init(ViewController);
  mainAppViewController = self->_mainAppViewController;
  self->_mainAppViewController = v6;

  v8 = [(PeCoNetViewController *)self view];
  [self->_mainAppViewController setStoryBoardView:v8];
...
- (void)cancel
{
  ...
  v4 = [(PeCoNetViewController *)self result];
  [v4 setStatusCode:v3];
