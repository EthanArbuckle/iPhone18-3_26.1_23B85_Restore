...
- (BOOL)validateAndInitializeParameters:(id)parameters
{
  ...
  v9 = [parametersCopy dk_arrayFromKey:@"endpointURLs" types:v8 maxLength:0xFFFFFFFFLL defaultValue:v7 failed:&v16 validator:&stru_100008268];
  ...
  if (!v16)
  {
    v13 = [parametersCopy dk_numberFromKey:@"timeout" lowerBound:&off_100008650 upperBound:&off_100008668 defaultValue:&off_100008680 failed:&v16];
