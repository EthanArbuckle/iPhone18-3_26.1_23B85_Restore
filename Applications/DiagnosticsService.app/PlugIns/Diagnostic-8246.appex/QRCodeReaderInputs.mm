...
- (BOOL)validateAndInitializeParameters:(id)a3
{
  ...
  {
    v4 = a3;
    v5 = [v4 dk_stringFromRequiredKey:@"viewfinderInstruction" maxLength:1000 failed:&v14];
    [(QRCodeReaderInputs *)self setViewfinderInstruction:v5];

    v6 = [v4 dk_numberFromKey:@"timeout" lowerBound:&off_10000CA08 upperBound:&off_10000CA20 defaultValue:&off_10000CA08 failed:&v14];
    ...
    v9 = [v4 dk_arrayFromRequiredKey:@"codeTypes" inSet:v8 maxLength:13 failed:&v14];
