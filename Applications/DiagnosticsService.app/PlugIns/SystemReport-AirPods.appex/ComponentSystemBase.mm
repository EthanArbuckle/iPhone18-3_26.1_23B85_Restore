...
- (BOOL)isBetaBuild
{
  ...
  {
    dispatch_once(&qword_100015108, &stru_1000103D8);
  }

  return byte_100015100;
}

- (BOOL)isInternalInstall
{
  if (qword_100015110 != -1)
  {
    dispatch_once(&qword_100015110, &stru_1000103F8);
  }

  return byte_100015101;
}
