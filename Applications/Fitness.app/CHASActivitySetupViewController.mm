...
- (void)viewDidLoad
{
  ...
  if (self->_presentationContext == 6)
  {
    ...
    {
      v6 = FIUIBundle();
      v7 = [v6 localizedStringForKey:@"CANCEL_BUTTON" value:&stru_1008680E8 table:@"Localizable"];
...
- (void)_storeGoals
{
  ...
  if (self->_activityMoveMode == 2)
  {
    v32 = [v4[379] currentCalendar];
    v33 = +[NSDate date];
    v34 = [v32 startOfDayForDate:v33];

    v35 = [v4[379] currentCalendar];
...
- (void)_displayExerciseGoalViewAnimated:(BOOL)a3
{
  v3 = a3;
  scrollView = self->_scrollView;
  v6 = [(CHASActivitySetupViewController *)self contentView];
  LOBYTE(scrollView) = [(UIScrollView *)scrollView isDescendantOfView:v6];

  if ((scrollView & 1) == 0)
  {
    v7 = [(CHASActivitySetupViewController *)self contentView];
    [v7 addSubview:self->_scrollView];

    v8 = [(CHASActivitySetupViewController *)self contentView];
    v9 = [v8 topAnchor];
    v10 = [(UIScrollView *)self->_scrollView topAnchor];
    v11 = [v9 constraintEqualToAnchor:v10];
    [v11 setActive:1];

    v12 = [(CHASActivitySetupViewController *)self contentView];
  ...
  v16 = [(CHASActivitySetupViewController *)self view];
  [v16 bounds];
  v18 = v17;
  ...
  if (self->_isRTL)
  {
    [(UIScrollView *)v19 setContentOffset:v3 animated:-v18, 0.0];
...
- (void)_displayStandGoalViewAnimated:(BOOL)a3
{
  ...
  if (self->_isRTL)
  {
    [(UIScrollView *)v19 setContentOffset:v3 animated:v18 * -2.0, 0.0];
    [(UIScrollView *)self->_scrollView setContentInset:0.0, v18 + v18, 0.0, v18];
  }

  else
  {
    [(UIScrollView *)v19 setContentOffset:v3 animated:v18 + v18, 0.0];
  }
...
- (void)_saveGoalsAndDismiss
{
  ...
  if (self->_isTinkerPaired)
  {
    ...
    [v3 performEndToEndCloudSyncWithNRDeviceUUID:v6 syncParticipantFirst:1 completion:&stru_10083AC80];
  }
...
- (BOOL)_currentPageHasGoalSchedule
{
  ...
  {
    v4 = self->OBTableWelcomeController_opaque[*off_10083AEE0[v3]];
  }
...
LABEL_9:
  ...
  v9 = [[_TtC10FitnessApp13GoalDaysModel alloc] initWithGoalSchedule:v39];
...
- (void)_setGoalQuantityForGoalView:(id)a3
{
  ...
  if (self->_moveGoalView == v4)
  {
    if (self->_hasMoveGoalSchedule)
    {
      if (!self->_editTodayOnly)
      {
        v5 = [(CHASActivitySetupViewController *)self _moveQuantityForToday];
        goto LABEL_12;
      }
    }
  ...
  else if (self->_exerciseGoalView == v4)
  {
    if (self->_hasExerciseGoalSchedule)
    {
      if (!self->_editTodayOnly)
      {
        v5 = [(CHASActivitySetupViewController *)self _exerciseQuantityForToday];
        goto LABEL_12;
      }
    }
  ...
  else
  {
    if (self->_hasStandGoalSchedule)
    {
      if (!self->_editTodayOnly)
      {
        v5 = [(CHASActivitySetupViewController *)self _standQuantityForToday];
LABEL_12:
        v6 = v5;
...
LABEL_22:
  [(CHASActivitySetupViewController *)self _setGoalQuantity:*&self->OBTableWelcomeController_opaque[v7] goalView:v4];
LABEL_23:
}
...
LABEL_5:
  ...
  if (v8 <= 3)
  {
    self->OBTableWelcomeController_opaque[*off_10083AEE0[v8]] = 1;
  }
