...
- (_TtC10FitnessApp42ActivitySetupThreeRingsOnboardingVideoView)initWithCoder:(id)coder;
- (_TtC10FitnessApp42ActivitySetupThreeRingsOnboardingVideoView)initWithFrame:(CGRect)frame;
- (void)layoutSubviews;
@end
