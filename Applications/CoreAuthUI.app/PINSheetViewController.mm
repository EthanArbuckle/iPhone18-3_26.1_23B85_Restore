...
- (_TtC10CoreAuthUI22PINSheetViewController)initWithRequestID:(id)a3 endpoint:(id)a4;
- (_TtC10CoreAuthUI22PINSheetViewController)initWithRequestID:(id)a3 endpoint:(id)a4 remoteAlertPresentationMode:(int64_t)a5;
