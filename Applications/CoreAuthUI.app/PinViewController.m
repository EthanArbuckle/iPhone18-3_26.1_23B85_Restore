...
- (void)didReceiveAuthenticationData
{
  ...
  if (!v4)
  {
    ...
    v6 = [v5 objectForKey:&off_10009ABF0];
...
- (void)pinEntered:(id)a3
{
  ...
  else
  {
    ...
    v14 = [v13 objectForKey:&off_10009AC80];
    [v14 doubleValue];
    v16 = v15;
