...
- (void)_setupSecureUIController
{
  if ([(PresentationViewController *)self isSecureElement])
  {
    v3 = self->_recordedFlipbookName != 0;
    v4 = +[SecureUIManager sharedInstance];
    [v4 setIsRecording:v3];
...
- (void)presentableWillAppearAsBanner:(id)banner
{
  ...
  if (isActive)
  {
    ...
    objc_storeWeak(&qword_1000B0378, self);
  }
}
