...
LABEL_15:
      ...
      v21 = [v22 localizedStringForKey:@"CANCEL" value:&stru_1000992A0 table:@"MobileUI"];

LABEL_21:
      [v7 setObject:v21 forKeyedSubscript:&off_10009ABC0];

      goto LABEL_22;
    }

    [v7 setObject:v16 forKeyedSubscript:&off_10009AB90];
  }
...
- (id)fallbackActionFromOptions:(id)options
{
  ...
  {
    v7 = [NSBundle bundleForClass:objc_opt_class()];
    v6 = [v7 localizedStringForKey:@"ENTER_PASSWORD" value:&stru_1000992A0 table:@"MobileUI"];
  }
