...
- (PHCarPlayPhoneCallViewCell)initWithFrame:(CGRect)frame
{
  ...
  if (v3)
  {
    ...
    [(UILabel *)v4->_mainLabel setText:&stru_100361FD0];
    ...
    [(UILabel *)v4->_subtitleLabel setText:&stru_100361FD0];
    ...
    [(UILabel *)v4->_sourceLabel setText:&stru_100361FD0];
...
- (void)setTitle:(id)title subtitle:(id)subtitle source:(id)source subtitleColor:(id)color localizedSenderIdentityTitle:(id)identityTitle animated:(BOOL)animated
{
  ...
  if (!animatedCopy)
  {
    ...
    v26 = [v25 localizedStringForKey:@"ALERT_ERROR_LABEL" value:&stru_100361FD0 table:@"Localizable-Stewie"];
    if ([subtitleCopy isEqualToString:v26])
    {
      ...
      v25 = +[NSBundle mainBundle];
      v26 = [v25 localizedStringForKey:@"ALERT_ERROR_LABEL_NO_LINE_BREAK" value:&stru_100361FD0 table:@"Localizable-Stewie"];
