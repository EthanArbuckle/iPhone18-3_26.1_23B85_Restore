...
- (void)commonInit
{
  ...
  if (([(TUFeatureFlags *)self->_featureFlags smartVoicemailActionsEnabled]& 1) != 0)
  {
    ...
    v15 = [v14 localizedStringForKey:@"VOICEMAILUI_MESSAGE_TRANSCRIPT_VIEW_FOLLOW_UP_SUGGESTIONS" value:&stru_1000B4840 table:@"VoicemailUI"];
  ...
  v19 = [v18 localizedStringForKey:@"VOICEMAILUI_MESSAGE_TRANSCRIPT_VIEW_TITLE" value:&stru_1000B4840 table:@"VoicemailUI"];
...
- (void)openFeedbackURL:(id)l
{
  ...
  v22 = [v21 localizedStringForKey:@"VOICEMAILUI_MESSAGE_TRANSCRIPT_VIEW_FEEDBACK_REPORTED" value:&stru_1000B4840 table:@"VoicemailUI"];
