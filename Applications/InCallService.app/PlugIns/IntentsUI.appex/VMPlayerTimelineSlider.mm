...
- (void)loadView
{
  ...
  v8 = [v7 localizedStringForKey:@"UNKNOWN_DURATION" value:&stru_1000B4840 table:@"Voicemail"];
  ...
  v12 = [v11 localizedStringForKey:@"UNKNOWN_DURATION" value:&stru_1000B4840 table:@"Voicemail"];
