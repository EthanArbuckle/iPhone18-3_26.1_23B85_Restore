...
LABEL_56:
      buttonLabel5 = [v25 localizedStringForKey:v27 value:&stru_100361FD0 table:@"PHCarPlay"];
...
LABEL_40:
      specialRingView4 = [v32 localizedStringForKey:v33 value:&stru_100361FD0 table:@"PHCarPlay"];
...
- (void)pressesCancelled:(id)cancelled withEvent:(id)event
{
  ...
  eventCopy = event;
  if (sub_100067D5C(cancelledCopy))
  {
    [(PHCarPlayInCallButton *)self setHighlighted:0];
  }
