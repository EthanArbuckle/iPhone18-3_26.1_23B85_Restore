...
- (FTHeaderEngagementDescriptor)init
{
  if (os_log_type_enabled(&_os_log_default, OS_LOG_TYPE_ERROR))
  {
    ...
    *buf = 136315906;
    v7 = "[FTHeaderEngagementDescriptor init]";
    v8 = 2080;
    v9 = "FTHeaderEngagementDescriptor.m";
    v10 = 1024;
    v11 = 19;
    v12 = 2114;
    v13 = v2;
  ...
  v3 = [NSString stringWithFormat:@"%@: %s", @"Do not call method", "[FTHeaderEngagementDescriptor init]"];
