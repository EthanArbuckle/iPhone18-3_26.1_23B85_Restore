...
- (FTNewsAnalyticsWidgetEventTracker)initWithUserIDProvider:(id)provider
{
  ...
  if (v5)
  {
    ...
    v12 = [[FTConditionalWidgetEventTracker alloc] initWithWidgetEventTracker:v11 predicate:&stru_1000D7108];
...
- (void)widgetDidDisappearAtDate:(id)date withTrackableWidgetState:(id)state
{
  ...
  v14 = [eventAccumulators fc_arrayByTransformingWithBlock:&stru_1000D7148];
