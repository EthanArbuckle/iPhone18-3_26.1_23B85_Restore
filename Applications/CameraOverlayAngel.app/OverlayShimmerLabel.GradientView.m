...
- (_TtCC18CameraOverlayAngel19OverlayShimmerLabelP33_22DD55180974D52509049D872E07492F12GradientView)initWithCoder:(id)a3;
- (void)layoutSubviews;
@end
...
{
  v5 = self;
  [(OverlayShimmerLabel.GradientView *)v5 bounds];
  v2 = CGRectGetWidth(v7) * 0.5;
  [(OverlayShimmerLabel.GradientView *)v5 bounds];
  Height = CGRectGetHeight(v8);
  [*(&v5->super.super.super.isa + OBJC_IVAR____TtCC18CameraOverlayAngel19OverlayShimmerLabelP33_22DD55180974D52509049D872E07492F12GradientView_left) setFrame:{0.0, 0.0, v2, Height}];
  v4 = *(&v5->super.super.super.isa + OBJC_IVAR____TtCC18CameraOverlayAngel19OverlayShimmerLabelP33_22DD55180974D52509049D872E07492F12GradientView_right);
  v9.origin.x = 0.0;
  v9.origin.y = 0.0;
  v9.size.width = v2;
