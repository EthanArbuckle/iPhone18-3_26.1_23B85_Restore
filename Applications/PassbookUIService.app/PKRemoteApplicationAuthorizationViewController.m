...
- (void)loadView
{
  ...
  sub_1000024F8(self, v15);
  sub_100007DC0(self, v15, 0, 0);
...
- (void)observedView:(id)a3 didMoveToWindow:(id)a4
{
  ...
  {
    v4 = [(PKRemoteApplicationAuthorizationViewController *)self view:a3];
    [v4 setNeedsLayout];
  }
}
...
- (void)viewWillTransitionToSize:(CGSize)a3 withTransitionCoordinator:(id)a4
{
  ...
  v7 = a4;
  [(PKRemoteApplicationAuthorizationViewController *)&v9 viewWillTransitionToSize:v7 withTransitionCoordinator:width, height];
...
- (void)viewWillLayoutSubviews
{
  ...
  v3 = [(PKRemoteApplicationAuthorizationViewController *)self view];
  [v3 bounds];
  v5 = v4;
  v7 = v6;
  v9 = v8;
...
LABEL_64:
  ...
  v60 = [Tracker beginTrackingAnimation];
  v135 = location;
  [(UIView *)content pkui_setTransform:&v135 withAdditiveAnimationFactory:v52 completion:v60];
  ...
  v74 = v73;
  v75 = self->_content;
  v76 = [v63 beginTrackingAnimation];
  [(UIView *)v75 pkui_setBounds:v62 withAdditiveAnimationFactory:v76 completion:v68, v70, v72, v74];
...
LABEL_63:
    ...
    v108 = v84 + v107 * v82;
    v109 = self->_content;
    v110 = [v63 beginTrackingAnimation];
    [(UIView *)v109 pkui_setPosition:v62 withAdditiveAnimationFactory:v110 completion:v106, v108];
...
- (void)configureWithContext:(id)a3 completion:(id)a4
{
  ...
  {
    v9 = [(PKRemoteApplicationAuthorizationViewController *)self _remoteViewControllerProxy];
...
- (void)prepareForActivationWithContext:(id)a3 completion:(id)a4
{
  ...
  if (!self->_invalidated)
  {
    ...
    v10 = v9;
    if (v9 && [v9 shouldDismissOnUILock] && (objc_msgSend(v10, "shouldDismissInSwitcher") & 1) != 0)
    {
      if (!PKDeviceLocked())
      {
...
- (BOOL)gestureRecognizer:(id)a3 shouldReceiveTouch:(id)a4
{
  ...
  {
    v8 = [(PKRemoteApplicationAuthorizationViewController *)self viewIfLoaded];
    if (v8 && ([v7 locationInView:v8], v10 = v9, v12 = v11, objc_msgSend(v8, "pointInside:withEvent:", 0)) && ((physicalButton = self->_physicalButton) == 0 || (-[LAUIPhysicalButtonView convertPoint:fromView:](self->_physicalButton, "convertPoint:fromView:", v8, v10, v12), (-[LAUIPhysicalButtonView pointInside:withEvent:](physicalButton, "pointInside:withEvent:", 0) & 1) == 0)))
    {
      content = self->_content;
      if (content)
      {
        [(UIView *)self->_content convertPoint:v8 fromView:v10, v12];
...
- (void)authenticator:(id)a3 didTransitionToCoachingState:(int64_t)a4
{
  ...
  {
    self->_authenticationCoachingState = a4;
...
- (void)presentPasscodeViewController:(id)a3 completionHandler:(id)a4 reply:(id)a5
{
  ...
  {
    objc_storeStrong(&self->_passcodeVC, a3);
    ...
    v11[3] = &unk_100010568;
    v12 = v10;
    [(PKRemoteApplicationAuthorizationViewController *)self presentViewController:v8 animated:1 completion:v11];
  }
}
...
- (void)dismissPasscodeViewController
{
  if (!self->_invalidated)
  {
    ...
    v7 = [(UIViewController *)v4 presentingViewController];
    v5 = [(UIViewController *)v4 isBeingDismissed];
