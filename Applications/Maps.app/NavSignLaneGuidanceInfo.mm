...
- (id)description
{
  ...
  {
    v9 = [NSString stringWithFormat:@"laneInfoID: [%@] %d lanes (forManeuver:%d) %@", laneInfoId, v5, isForManeuver, &stru_1016631F0];
  }
...
- (NavSignLaneGuidanceInfo)initWithGuidanceLaneInfo:(id)info
{
  ...
  if (infoCopy)
  {
    ...
    if (v10)
    {
      ...
      v12 = sub_100021DB0(secondaryStrings2, &stru_10165CB90);
    }
    ...
    else
    {
      ...
      v25[3] = &unk_10165CBB8;
      v26 = v8;
      v12 = sub_100021DB0(instructions, v25);
    }
    ...
    if (v16)
    {
      ...
      v18 = sub_100021DB0(primaryStrings2, &stru_10165CBD8);
    }
