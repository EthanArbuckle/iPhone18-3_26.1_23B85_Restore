...
+ (void)performAfterDelay:(double)delay action:(id)action;
- (void)prepareContent;
@end
...
- (void)prepareContent
{
  0x4014000000000000 = [NSString stringWithFormat:@"Notifications (%.0fs delay)", 0x4014000000000000];
  v15[0] = _NSConcreteStackBlock;
  v15[1] = 3221225472;
  v15[2] = sub_100AF5D98;
  v15[3] = &unk_101637CE8;
  v15[4] = 0x4014000000000000;
  v4 = [(MapsDebugValuesViewController *)self addSectionWithTitle:0x4014000000000000 content:v15];
  ...
  v14 = v9;
  v11 = v9;
  v12 = [(MapsDebugValuesViewController *)self addSectionWithTitle:path content:v13];
}
