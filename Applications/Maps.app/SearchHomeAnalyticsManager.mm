...
- (void)logRecentEvent
{
  ...
  if (suggestions)
  {
    [GEOAPPortal captureClientACSuggestionWithQuery:&stru_1016631F0 queryTokens:0 entries:suggestions selectedIndex:self->_recentEvent.selectedIndex selectedSectionIndex:0 withinSectionSelectedIndex:0 isRetainedQuery:0 isRerankerTriggered:0 shouldDifferentiateClientAndServerResults:0];
  }
}
...
LABEL_1994:
      v6 = [NSString stringWithFormat:@"(unknown: %i)", self->_curatedCollectionEvent.target];
      goto LABEL_1995;
    }
...
- (void)curatedCollectionsTappedWithMuid:(unint64_t)muid horizontalIndex:(unint64_t)index isCurrentlySaved:(BOOL)saved
{
  ...
  value = self->_curatedCollectionEvent.value;
  self->_curatedCollectionEvent.value = @"Featured";
