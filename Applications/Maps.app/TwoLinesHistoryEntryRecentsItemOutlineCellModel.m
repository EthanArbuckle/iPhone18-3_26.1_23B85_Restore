...
- (BOOL)isEqual:(id)a3
{
  ...
  else if (v4 && (objc_opt_class(), (objc_opt_isKindOfClass() & 1) != 0))
  {
    ...
    if ([(TwoLinesBasicOutlineCellModel *)&v13 isEqual:v6])
    {
      ...
      v8 = v7;
      if (v7 == self->_recentsItem || [(HistoryEntryRecentsItem *)v7 isEqual:?])
      {
        v9 = [(TwoLinesHistoryEntryRecentsItemOutlineCellModel *)v6 accessoryModels];
        v10 = v9;
...
- (TwoLinesHistoryEntryRecentsItemOutlineCellModel)initWithHistoryEntryRecentsItem:(id)a3 accessoryModels:(id)a4 backgroundModel:(id)a5
{
  ...
  if (v12)
  {
    objc_storeStrong(&v12->_recentsItem, a3);
