...
- (BOOL)matchesLoadDirectionsMessage:(id)a3
{
  ...
  if (v6 && (v7 = v6, [v5 routeContextData], v8 = objc_claimAutoreleasedReturnValue(), objc_msgSend(v4, "routeContextData"), v9 = objc_claimAutoreleasedReturnValue(), v10 = objc_msgSend(v8, "isEqualToData:", v9), v9, v8, v7, (v10 & 1) != 0))
  {
    v11 = 1;
  }
