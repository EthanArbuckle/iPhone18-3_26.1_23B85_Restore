...
+ (id)defaultLayout;
+ (id)layoutAtEdge:(unint64_t)a3 primaryAxis:(int64_t)a4 pinnedEdges:(unint64_t)a5 primaryAxisFillMode:(unint64_t)a6 secondaryAxisFillMode:(unint64_t)a7;
+ (id)layoutInCorner:(unint64_t)a3 primaryAxis:(int64_t)a4 pinnedEdges:(unint64_t)a5 primaryAxisFillMode:(unint64_t)a6 secondaryAxisFillMode:(unint64_t)a7;
...
+ (id)layoutAtEdge:(unint64_t)a3 primaryAxis:(int64_t)a4 pinnedEdges:(unint64_t)a5 primaryAxisFillMode:(unint64_t)a6 secondaryAxisFillMode:(unint64_t)a7
{
  ...
  [(CarCardLayout *)v12 setEdgePosition:a3];
  [(CarCardLayout *)v12 setCornerPosition:0];
  [(CarCardLayout *)v12 setPrimaryAxis:a4];
  [(CarCardLayout *)v12 setPinnedEdges:a5];
  [(CarCardLayout *)v12 setPrimaryAxisFillMode:a6];
  ...
  [(CarCardLayout *)v12 setSecondaryAxisFillMode:a7];
...
+ (id)layoutInCorner:(unint64_t)a3 primaryAxis:(int64_t)a4 pinnedEdges:(unint64_t)a5 primaryAxisFillMode:(unint64_t)a6 secondaryAxisFillMode:(unint64_t)a7
{
  ...
  [(CarCardLayout *)v12 setCornerPosition:a3];
  [(CarCardLayout *)v12 setPrimaryAxis:a4];
  [(CarCardLayout *)v12 setPinnedEdges:a5];
  [(CarCardLayout *)v12 setPrimaryAxisFillMode:a6];
  if ((a6 & 0xFFFFFFFFFFFFFFFELL) == 2)
...
+ (id)defaultLayout
{
  ...
  v5 = v2;
  v6 = [(CarCardLayout *)v5 primaryAxis];
  v7 = [(CarCardLayout *)v5 cornerPosition];
  if (v6 == 1)
  {
    if (v7 == 4 || [(CarCardLayout *)v5 cornerPosition]== 1 || [(CarCardLayout *)v5 edgePosition]== 2)
    {
      v8 = 8;
    }
  ...
  {
    v9 = v7 == 4 || [(CarCardLayout *)v5 cornerPosition]== 8 || [(CarCardLayout *)v5 edgePosition]== 4;
