...
- (BOOL)listener:(id)listener shouldAcceptNewConnection:(id)connection
{
  ...
  if (xpcListener == listenerCopy)
  {
    ...
    [connectionCopy setInterruptionHandler:&stru_10163C128];
    connectionQueue = self->_connectionQueue;
    block[0] = _NSConcreteStackBlock;
    block[1] = 3221225472;
    block[2] = sub_100BA08A4;
...
- (void)performWithMapsRunning:(id)running
{
  ...
  if (qword_10195E920 != -1)
  {
    dispatch_once(&qword_10195E920, &stru_10163C0E0);
  }

  v5 = [FBSOpenApplicationOptions optionsWithDictionary:qword_10195E918];
  v6 = sub_100E9E6E8();
