...
- (id)maneuverUniqueId
{
  ...
  v3 = [v2 UUIDString];
  v4 = [NSString stringWithFormat:@"ManeuverBannerItem-%@", v3];
...
- (BOOL)shouldPresentNextGuidanceUpdate:(id)a3 forType:(unint64_t)a4 target:(id)a5
{
  ...
  if (a4 == 2)
  {
    ...
    v21 = [v19 stopIndex];
    v20 = [v8 alightMessage];
    if (v21 == [v20 stopIndex])
    {
...
LABEL_34:
          ...
          v16 = [(IPCGuidanceStateReply *)self laneGuidanceInfo];
          if (v16)
          {
            v17 = v16;
          ...
          {
            v27 = v26;
            v28 = [(IPCGuidanceStateReply *)self laneGuidanceInfo];
            v29 = [v28 laneInfoId];
            v30 = [v8 laneGuidanceInfo];
            v31 = [v30 laneInfoId];
            v32 = [v29 isEqual:v31];
          ...
          if ([v8 isAlerting] && (!SBUIIsSystemApertureEnabled() || objc_msgSend(v9, "destination")) || -[IPCGuidanceStateReply isArrived](self, "isArrived") && (objc_msgSend(v8, "isParking") & 1) != 0 || -[IPCGuidanceStateReply isParking](self, "isParking") && (objc_msgSend(v8, "isArrived") & 1) != 0 || -[IPCGuidanceStateReply isParked](self, "isParked") && (objc_msgSend(v8, "isArrived") & 1) != 0)
          {
            goto LABEL_34;
          }
        }
    ...
    v20 = [v8 trafficAlertUniqueId];
    LODWORD(self) = [v19 isEqualToString:v20] ^ 1;
  }
...
- (id)transitAlightUniqueId
{
  ...
  v3 = [v2 identifier];
  v4 = [NSString stringWithFormat:@"TransitAlightBannerItem-%@", v3];
...
- (id)trafficAlertUniqueId
{
  ...
  v3 = [v2 identifier];
  v4 = [NSString stringWithFormat:@"TrafficAlertBannerItem-%@", v3];
...
- (id)uniqueIdForBannerType:(unint64_t)a3
{
  ...
  if (a3 > 1)
  {
    if (a3 == 2)
    {
      v4 = [(IPCGuidanceStateReply *)self transitAlightUniqueId];
    }

    else if (a3 == 3)
    {
      v4 = [(IPCGuidanceStateReply *)self transitDestinationUniqueId];
    }
  }
  ...
  else if (a3)
  {
    if (a3 == 1)
    {
      v4 = [(IPCGuidanceStateReply *)self trafficAlertUniqueId];
    }
  }

  else
  {
    v4 = [(IPCGuidanceStateReply *)self maneuverUniqueId];
  }
...
- (id)description
{
  ...
  v20 = sub_100021DB0(v3, &stru_101660D90);

  v4 = [(IPCGuidanceStateReply *)self secondaryInstructions];
  v19 = sub_100021DB0(v4, &stru_101660DB0);
...
- (IPCGuidanceStateReply)initWithDictionary:(id)a3
{
  ...
  v17 = sub_10002E398(v4, @"kIPCGuidanceStateReplyPrimaryInstructionsKey");
  [(IPCGuidanceStateReply *)v5 setPrimaryInstructions:v17];

  v18 = sub_10002E398(v4, @"kIPCGuidanceStateReplySecondaryInstructionsKey");
