...
- (id)description
{
  ...
  v5 = sub_100AD6E38(engineType & 1 | (((engineType >> 2) & 1) << 16) & 0xFEFFFEFF | (((engineType >> 3) & 1) << 24) | (((engineType >> 1) & 1) << 8));
...
+ (void)prepareForUse
{
  if (qword_10195E510 != -1)
  {
    dispatch_once(&qword_10195E510, &stru_101637590);
  }
}
