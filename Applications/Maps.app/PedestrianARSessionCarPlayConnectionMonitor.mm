...
- (PedestrianARSessionCarPlayConnectionMonitor)initWithObserver:(id)observer;
- (id)debugDescription;
- (void)dealloc;
...
LABEL_7:
    ...
    [(PedestrianARSessionCarPlayConnectionMonitor *)&v16 observeValueForKeyPath:pathCopy ofObject:objectCopy change:changeCopy context:context];
    goto LABEL_8;
  }
...
LABEL_6:
  ...
  [(PedestrianARSessionMonitor *)self setShouldShowPedestrianAR:state != 2];
}
