...
- (_TtC23ShelfKitCollectionViews14DownloadButton)initWithCoder:(id)a3
{
  ...
  *(&self->super.super.super.super.super.super.super.super.isa + OBJC_IVAR____TtC23ShelfKitCollectionViews14DownloadButton_progressView) = 0;
  v3 = self + OBJC_IVAR____TtC23ShelfKitCollectionViews14DownloadButton_progressState;
  *v3 = 0;
  *(v3 + 4) = 256;
  result = sub_30D648();
  __break(1u);
