...
- (_TtC23ShelfKitCollectionViews31ArtworkCheckmarkProgressOverlay)initWithCoder:(id)coder;
- (_TtC23ShelfKitCollectionViews31ArtworkCheckmarkProgressOverlay)initWithFrame:(CGRect)frame;
- (void)layoutSubviews;
@end
