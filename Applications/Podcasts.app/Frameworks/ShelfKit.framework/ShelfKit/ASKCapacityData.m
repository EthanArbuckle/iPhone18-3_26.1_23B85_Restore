...
- (ASKCapacityData)init
{
  ...
  {
    v3 = MGCopyAnswer();
    v4 = [v3 objectForKey:kMGQDiskUsageTotalSystemCapacity];
    v5 = v4;
    if (v4)
    {
      v6 = v4;
    ...
    v7 = [v3 objectForKey:kMGQDiskUsageTotalSystemAvailable];
    v8 = v7;
    if (v7)
    {
      v9 = v7;
    ...
    v10 = [v3 objectForKey:kMGQDiskUsageTotalDataCapacity];
    v11 = v10;
    if (v10)
    {
      v12 = v10;
    ...
    v13 = [v3 objectForKey:kMGQDiskUsageTotalDataAvailable];
    v14 = v13;
    if (v13)
    {
      v15 = v13;
    ...
    v16 = [v3 objectForKey:kMGQDiskUsageTotalDiskCapacity];
    v17 = v16;
    if (v16)
    {
      v18 = v16;
