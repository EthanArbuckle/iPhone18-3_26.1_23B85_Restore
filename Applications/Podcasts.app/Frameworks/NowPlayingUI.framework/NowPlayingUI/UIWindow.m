...
UIEdgeInsets __67__UIWindow_MusicLayoutAdditions__music_setWantsDefaultLayoutInsets__block_invoke(id a1, UIView *a2)
{
  ...
  v4 = 16.0;
  if ([v3 horizontalSizeClass] != &dword_0 + 2 || objc_msgSend(v3, "verticalSizeClass") != &dword_0 + 2 || (-[UIView bounds](v2, "bounds"), v6 = 32.0, v7 <= 1025.0) && (v4 = 20.0, v5 <= 1025.0))
  {
    if (_MusicDefaultLayoutInsetsForView_sOnceToken != -1)
    {
      __67__UIWindow_MusicLayoutAdditions__music_setWantsDefaultLayoutInsets__block_invoke_cold_1();
    }

    v6 = v4;
    if (_MusicDefaultLayoutInsetsForView_sViewControllerResponds == 1)
    {
...
UIEdgeInsets __65__UIWindow_MusicLayoutAdditions__music_setWantsMusicLayoutInsets__block_invoke(id a1, UIView *a2)
{
  ...
  {
    v3 = MTMPUFloatGreaterThanOrEqualToFloat();
    v2 = 20.0;
    if (v3)
    {
      v2 = 34.0;
...
id __71__UIWindow_MusicLayoutAdditions__music_setWantsLayoutInsetsUsingBlock___block_invoke_6(uint64_t a1, void *a2, uint64_t a3, uint64_t a4, double a5, double a6, double a7, double a8)
{
  ...
  if (v16)
  {
    v16(v15, *(a1 + 48), a3, a4, a5, a6, a7, a8);
    v17 = LABEL_3:;
  ...
  {
    MethodImplementation = class_getMethodImplementation([v15 superclass], *(a1 + 48));
    if (MethodImplementation)
    {
      (MethodImplementation)(v15, *(a1 + 48), a3, a4, a5, a6, a7, a8);
      goto LABEL_3;
    }
  }
