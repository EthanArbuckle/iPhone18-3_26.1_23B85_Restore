...
- (MTActionButtonContainerView)initWithActionButtons:(id)buttons;
- (void)layoutSubviews;
...
- (MTActionButtonContainerView)initWithActionButtons:(id)buttons
{
  ...
  if (v5)
  {
    ...
    [(MTActionButtonContainerView *)v5 setActionButtons:buttonsCopy];
  }
...
- (void)setActionButtons:(id)buttons
{
  ...
  self->_actionButtons = buttonsCopy;
  v6 = buttonsCopy;
...
- (CGSize)sizeThatFits:(CGSize)fits
{
  ...
  v12 = 0x2020000000;
  v13 = 0;
  actionButtons = [(MTActionButtonContainerView *)self actionButtons];
  ...
  *&v9[6] = height;
  v9[4] = &v10;
  [actionButtons enumerateObjectsUsingBlock:v9];
...
- (void)layoutSubviews
{
  ...
  v4[4] = self;
  v4[5] = v5;
  [actionButtons enumerateObjectsUsingBlock:v4];
