...
- (ShowViewControllerOperation)initWithViewControllerToShow:(id)a3 toBeShownInViewController:(id)a4 shouldBeModal:(BOOL)a5 shouldShowWithAnimation:(BOOL)a6
{
  ...
  if (v13)
  {
    objc_storeStrong(&v13->_shownViewController, a3);
    objc_storeStrong(&v14->_parentOfShownViewController, a4);
...
- (void)doInternalPresentation
{
  ...
  v10 = [(UIViewController *)self->_shownViewController presentingViewController];
...
- (void)start
{
  v3 = [(ShowViewControllerOperation *)self queue];
