...
- (InboxRepliedSectionScrollTest)initWithApplication:(id)application model:(id)model options:(id)options;
...
- (void)_inboxDidAppear:(id)appear
{
  ...
  showRepliedSection = [switcherViewController showRepliedSection];
  testName = [objc_opt_class() testName];
  tableView = [showRepliedSection tableView];
  if (tableView)
  {
