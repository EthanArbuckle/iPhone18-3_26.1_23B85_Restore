...
- (_TtC9MobileCal32DockableEventContainerController)initWithCoder:(id)a3;
- (_TtC9MobileCal32DockableEventContainerController)initWithFullViewController:(id)a3;
- (_TtC9MobileCal32DockableEventContainerController)initWithNibName:(id)a3 bundle:(id)a4;
...
- (void)viewWillAppear:(BOOL)a3
{
  ...
  v4 = v5.receiver;
  [(DockableEventContainerController *)&v5 viewWillAppear:v3];
...
- (void)viewDidDisappear:(BOOL)a3
{
  ...
  v5.super_class = type metadata accessor for DockableEventContainerController();
  v4 = v5.receiver;
  [(DockableEventContainerController *)&v5 viewDidDisappear:v3];
