...
- (void)__restoreSelectedCalendarsFromPreferences
{
  ...
  if (os_log_type_enabled(kCalUILogHandle, OS_LOG_TYPE_INFO))
  {
    ...
    v7 = [(CUIKCalendarModel *)self->_model sourceForSelectedIdentity];
    *buf = 138412802;
    v44 = model;
    v45 = 2112;
    v46 = v6;
  ...
  v11 = [v8 initWithEventStore:v9 limitedToSource:v10 visibilityChangedCallback:0 queue:0];

  v12 = [v11 invisibleCalendarsForAllIdentities];
  ...
  v26 = [[NSSet alloc] initWithArray:v12];
  ...
  v28 = [v27 collapsedSectionIdentifiers];
...
{
  v2 = self;
  v3 = [(CalendarSceneManager *)self model];
  v4 = [v3 sourceForSelectedIdentity];
  ...
  if (v4)
  {
    v6 = [(CalendarSceneManager *)v2 model];
    v7 = [v6 sourceForSelectedIdentity];
    v8 = [v7 sourceIdentifier];

    v9 = [CalendarSceneManager _encodeIdentifier:v8];
  ...
  v36 = 0u;
  v31 = v2;
  v12 = [(CalendarSceneManager *)v2 model];
  v13 = [v12 eventStore];
  v14 = [v13 delegateSources];
  ...
  if (v15)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        v19 = [*(*(&v33 + 1) + 8 * v18) sourceIdentifier];
        v20 = [CalendarSceneManager _encodeIdentifier:v19];
...
LABEL_17:
  ...
  v29 = [(CalendarSceneManager *)v2 mobileCalWindow];
  v30 = [v29 windowScene];
  ...
  if (EKUIDeviceCanTransform())
  {
    ...
    else
    {
      if ([(CalendarSceneManager *)self _isAnyWindowShowingDelegateCalendar])
      {
        ...
        [v4 localizedStringForKey:@"My Calendar" value:&stru_1002133B8 table:0];
      }
    ...
    v6 = [(CalendarSceneManager *)self mobileCalWindow];
    v7 = [v6 windowScene];
    [v7 setTitle:v8];
  }
}
...
- (void)_showDate:(id)a3 inView:(unint64_t)a4
{
  ...
  v8 = [(CUIKCalendarModel *)self->_model calendar];
  v9 = [v8 timeZone];
...
LABEL_16:
  v14 = [(RootNavigationController *)self->_rootNavigationController traitCollection];
  v15 = v14;
  if (v11)
  {
    if ([v14 horizontalSizeClass] == 1 && objc_msgSend(v15, "verticalSizeClass") == 2)
    {
      v16 = [(CalendarSceneManager *)self model];
      v17 = [v16 numDaysToShow];
...
- (void)diagnosticsViewControllerDidDismiss
{
  v3 = [(CalendarSceneManager *)self diagnosticsViewController];
  [v3 setDelegate:0];
...
- (void)showDebugMenu
{
  ...
  else if (sub_10011F368())
  {
    ...
    v7 = [(CalendarSceneManager *)self diagnosticsViewController];
    [v7 setDelegate:self];

    v8 = [(CalendarSceneManager *)self rootNavigationController];
    v9 = [(CalendarSceneManager *)self diagnosticsViewController];
...
- (void)_stateRestoreSelectedCalendarsFromUserActivity:(id)a3
{
  ...
  if ([(CalendarSceneManager *)self _isUserActivityForStateRestoration:v4])
  {
    if (([UIApp launchedToTest] & 1) == 0)
    {
      v5 = +[NSMutableSet set];
      v6 = [v4 userInfo];
      v7 = [v6 objectForKeyedSubscript:@"_UserActivityStateRestore_InvisibleCalendars"];
      ...
      v51 = v7;
      v52 = self;
      v14 = [(CUIKCalendarModel *)self->_model eventStore];
      v15 = [v14 calendarsForEntityType:0];
      ...
      v35 = [v4 userInfo];
      v36 = [v35 objectForKeyedSubscript:@"_UserActivityStateRestore_CollapsedSectionIdentifiers"];
      ...
      {
        v44 = [v4 userInfo];
        v45 = [v44 objectForKeyedSubscript:@"_UserActivityStateRestore_FocusFilterMode"];
...
{
  v2 = [a1 _sharedState];
  v3 = [v2 applicationLastActiveTimeProvider];
  v4 = [v3 applicationLastActiveTime];
  ...
  if (v5)
  {
    ...
    while (2)
    {
      for (i = 0; i != v6; i = i + 1)
      {
        ...
        v10 = [*(*(&v14 + 1) + 8 * i) role];
        v11 = [v10 isEqualToString:UIWindowSceneSessionRoleApplication];
...
- (void)scene:(id)a3 willConnectToSession:(id)a4 options:(id)a5
{
  ...
  if (objc_opt_isKindOfClass())
  {
    ...
    v85 = v8;
    v12 = [v85 windows];
    v13 = [v12 countByEnumeratingWithState:&v90 objects:v98 count:16];
    if (v13)
    {
      v14 = v13;
      v15 = *v91;
      while (2)
      {
        ...
        v14 = [v12 countByEnumeratingWithState:&v90 objects:v98 count:16];
        if (v14)
        {
          continue;
        }
    ...
    v17 = [(CalendarSceneManager *)self _setUpModel];
    model = self->_model;
    self->_model = v17;

    v19 = [v85 _sceneIdentifier];
    ...
    {
      v20 = [v9 stateRestorationActivity];
      if (v20)
      {
        v24 = kCalUILogHandle;
        if (os_log_type_enabled(kCalUILogHandle, OS_LOG_TYPE_INFO))
...
LABEL_28:
    ...
    {
      v39 = [(RootNavigationController *)v33 view];
    }
    ...
    v55 = [v54 lastSidebarMode];
    v56 = [v55 unsignedIntegerValue];

    [(CalRootViewController *)self->_rootViewController setCurrentSidebarState:v56];
    ...
    v63 = [v10 shortcutItem];
    shortcutItemToRunAfterConnection = self->_shortcutItemToRunAfterConnection;
    self->_shortcutItemToRunAfterConnection = v63;

    v65 = [v10 userActivities];
    v66 = [v65 allObjects];
    userActivitiesToContinueAfterConnection = self->_userActivitiesToContinueAfterConnection;
    self->_userActivitiesToContinueAfterConnection = v66;

    v68 = [v10 URLContexts];
    if (v68)
    {
      [(CalendarSceneManager *)self scene:v85 openURLContexts:v68];
    }

    else
    {
      v69 = [v10 notificationResponse];

      if (v69)
      {
        v81 = v10;
        v70 = [v10 notificationResponse];
        v71 = [v70 notification];
        v72 = [v71 request];
        v73 = [v72 content];
        v74 = [v73 defaultActionURL];
        ...
        if (v74)
        {
          ...
          [(CalendarSceneManager *)self _openURL:v74];
          v10 = v81;
        }
...
- (void)sceneDidDisconnect:(id)a3
{
  ...
  if (v10)
  {
    ...
    while (2)
    {
      for (i = 0; i != v11; i = i + 1)
      {
        ...
        {
          v15 = [v14 _sceneIdentifier];
          v16 = [(CalendarSceneManager *)self mobileCalWindow];
          v17 = [v16 windowScene];
  ...
  v20 = [(CalendarSceneManager *)self rootNavigationController];
  v21 = [v20 currentViewType];
  ...
  v28 = [(CalRootViewController *)self->_rootViewController currentSidebarState];
...
- (void)sceneDidBecomeActive:(id)a3
{
  ...
  v6 = [(CalendarSceneManager *)self _shouldResumeToTodayOnBecomeActive];
  v7 = [(RootNavigationController *)self->_rootNavigationController view];
  v8 = [v7 window];
  EKUIPushFallbackSizingContextWithViewHierarchy();
  ...
  v10 = [(RootNavigationController *)self->_rootNavigationController view];
  v11 = [v10 window];
  EKUIPopFallbackSizingContextWithViewHierarchy();
...
- (id)stateRestorationActivityForScene:(id)a3
{
  ...
  if (self->_finishedSetup)
  {
    v6 = [(RootNavigationController *)self->_rootNavigationController currentViewType];
    if (v6 > 4)
    {
      v7 = 0;
    }
    ...
    {
      v7 = qword_1001F8690[v6];
    }

    v10 = [(CUIKCalendarModel *)self->_model selectedDate];
    v11 = [v10 date];
    ...
    v14 = [v12 initWithDate:v11 view:v7 calendar:v13];
    ...
    v17 = [(CUIKCalendarModel *)self->_model unselectedCalendarsIgnoringFocus];
    v18 = [v17 valueForKey:@"calendarIdentifier"];

    [v15 setObject:v18 forKey:@"_UserActivityStateRestore_InvisibleCalendars"];
    v19 = [(CUIKCalendarModel *)self->_model collapsedSectionIdentifiers];
    ...
    v21 = [(CUIKCalendarModel *)self->_model sourceForSelectedIdentity];

    if (v21)
    {
      v22 = [(CUIKCalendarModel *)self->_model sourceForSelectedIdentity];
    ...
    v25 = [(CUIKCalendarModel *)self->_model selectedOccurrence];
    if (!v25)
    {
      goto LABEL_18;
    }
    ...
    v28 = v14;
    v29 = v11;
    v30 = [(CUIKCalendarModel *)self->_model selectedOccurrence];
    v31 = [v30 uniqueID];
    if (v31)
    {
      v32 = v31;
      v33 = [(RootNavigationController *)self->_rootNavigationController shouldSaveSelectedEvent];
...
LABEL_18:
      ...
      v34 = [(CUIKCalendarModel *)self->_model selectedOccurrence];
      v35 = [v34 uniqueID];
      [v15 setObject:v35 forKey:@"_UserActivityStateRestore_SelectedOccurrenceUID_Key"];

      v26 = [(CUIKCalendarModel *)self->_model selectedOccurrence];
      v30 = [v26 startDate];
...
{
  v13 = a3;
  v4 = [(CUIKCalendarModel *)self->_model persistedSceneState];
  v5 = v4;
  if (v4)
  {
    [v4 dayViewHourScale];
...
{
  v3 = [a3 userInfo];
  v4 = [v3 objectForKeyedSubscript:@"_UserActivityStateRestore_Flag"];
...
- (void)_restoreModelPersistedStateFromUserActivity:(id)a3
{
  ...
  {
    v4 = [(CUIKCalendarModel *)self->_model persistedSceneState];
    v5 = [(CalendarSceneManager *)self _extractNumberFromUserActivity:v16 forKey:@"_UserActivityStateRestore_ShowDayAsList_Key"];
    v6 = [(CalendarSceneManager *)self _extractNumberFromUserActivity:v16 forKey:@"_UserActivityStateRestore_ShowMonthAsDivided_Key"];
    if (v5)
    {
      v7 = [v5 BOOLValue];
    }
    ...
    v9 = [(CalendarSceneManager *)self _extractNumberFromUserActivity:v16 forKey:@"_UserActivityStateRestore_DayHourScale_Key"];
    v10 = [(CalendarSceneManager *)self _extractNumberFromUserActivity:v16 forKey:@"_UserActivityStateRestore_WeekHourScale_Key"];
    v11 = [(CalendarSceneManager *)self _extractNumberFromUserActivity:v16 forKey:@"_UserActivityStateRestore_DayViewFirstVisibleSecond_Key"];
    v12 = -1.0;
    v13 = -1.0;
    if (v9)
    {
...
{
  v4 = a3;
  v5 = [(CalendarSceneManager *)self _isUserActivityForStateRestoration:v4];
  v6 = kCalUILogHandle;
  ...
  {
    v21 = [v4 userInfo];
    v17 = [v21 objectForKeyedSubscript:@"_UserActivityStateRestore_Timestamp"];
...
LABEL_19:
  ...
  v30 = [v4 userInfo];
  v31 = [v30 objectForKeyedSubscript:@"_UserActivityStateRestore_MaintainToday_Key"];
...
LABEL_25:
  ...
  v36 = [v4 userInfo];
  v37 = [v36 objectForKeyedSubscript:@"_UserActivityStateRestore_SelectedSource"];
  ...
  v64 = 0u;
  v65 = 0u;
  v39 = [(CUIKCalendarModel *)self->_model eventStore];
  v40 = [v39 sources];

  v41 = [v40 countByEnumeratingWithState:&v62 objects:v66 count:16];
  if (!v41)
  {
    v48 = v40;
    goto LABEL_45;
...
LABEL_37:
    if (v42 == ++v44)
    {
      v42 = [v40 countByEnumeratingWithState:&v62 objects:v66 count:16];
      if (v42)
      {
        goto LABEL_30;
      }
...
LABEL_47:
  if ((EKUIShouldSaveStateInPreferences() & 1) == 0)
  {
    ...
    v52 = [v4 userInfo];
    v53 = [v52 objectForKeyedSubscript:@"_UserActivityStateRestore_SelectedOccurrenceDate_Key"];
    ...
    if (objc_opt_isKindOfClass())
    {
      ...
      if (objc_opt_isKindOfClass())
      {
        v54 = [(CUIKCalendarModel *)self->_model eventStore];
        v55 = [v54 allEventsWithUniqueId:v51 occurrenceDate:v53];
  ...
  v58 = [v4 userInfo];
  v59 = [v58 objectForKeyedSubscript:@"_UserActivityStateRestore_LastSidebarMode_Key"];
...
- (BOOL)_continueUserActivity:(id)a3 restoreSelectedOccurrence:(BOOL)a4 restoreSelectedDate:(BOOL)a5 restorationHandler:(id)a6
{
  ...
  if ([v100 isEqualToString:v99])
  {
    ...
    if (v14)
    {
      ...
      v19 = [(CUIKCalendarModel *)self->_model eventStore];
      v20 = [v19 calendarItemWithIdentifier:v16];

      v21 = [(CUIKCalendarModel *)self->_model eventStore];
      v22 = [v20 objectID];
      [v18 doubleValue];
      v23 = [NSDate dateWithTimeIntervalSinceReferenceDate:?];
      v24 = [v21 eventForObjectID:v22 occurrenceDate:v23];
...
LABEL_67:
  ...
  if (v32)
  {
    v47 = [CUIKUserActivity activityForActivity:v7];
    v48 = [v47 type];
    if (v48)
    {
      if (v48 == 4098)
      {
        ...
        if (v96)
        {
          v59 = [(CUIKCalendarModel *)v58 eventStore];
          v60 = [v57 eventFromStore:v59];
          ...
          if (v60)
          {
            ...
            v67 = [v60 calendar];
            v68 = [v67 source];
            [(CUIKCalendarModel *)v66 updateSourceForSelectedIdentity:v68 selectedCalendars:0];

            -[CalendarSceneManager _showEvent:inView:](self, "_showEvent:inView:", v60, [v57 view]);
          }
        }

        else
        {
          v83 = [(CUIKCalendarModel *)v58 selectedDate];
          v60 = [v83 date];
          ...
          -[CalendarSceneManager _showDate:inView:](self, "_showDate:inView:", v60, [v57 view]);
        }
      ...
      if (v48 == 4097)
      {
        ...
        {
          v88 = [(CUIKCalendarModel *)self->_model selectedDate];
          v50 = [v88 date];
        ...
        [(CalendarSceneManager *)self _showDate:v50 inView:v49];
  ...
  if (objc_opt_isKindOfClass())
  {
    ...
    if (v37)
    {
      ...
      if ([v70 count] == 2)
      {
        ...
        v73 = [v70 lastObject];
        v74 = [NSTimeZone timeZoneWithName:v73];
    ...
    v76 = [v35 locationName];

    if (v76)
    {
      v77 = [v35 locationName];
      v76 = [EKStructuredLocation locationWithTitle:v77];

      v78 = [v35 geolocation];
      v79 = [v78 location];
      [v76 setGeoLocation:v79];

      v80 = [v35 locationAddress];
      [v76 setAddress:v80];
    }

    rootViewController = self->_rootViewController;
    v82 = [v35 title];
    [(CalRootViewController *)rootViewController showAddEventWithTitle:v82 startDate:v94 endDate:v75 location:v76 suggestionsKey:v46 allDay:v92];
    ...
    while (2)
    {
      for (i = 0; i != v4; i = i + 1)
      {
        ...
        if (isKindOfClass)
        {
          v10 = [v7 delegate];
          v11 = [v10 model];
          v12 = [v11 sourceForSelectedIdentity];
...
- (void)scene:(id)a3 openURLContexts:(id)a4
{
  ...
  {
    v19 = v18;
    v20 = [(CalendarSceneManager *)self mobileCalWindow];
    v21 = [v20 windowScene];
    *buf = 138412546;
    v28 = v21;
    v29 = 2112;
...
- (void)_openURL:(id)a3
{
  ...
  {
    v26 = 0;
    v8 = [(CalendarSceneManager *)self _eventURLFromLaunchURL:v4 isTravel:&v26];

    v10 = [(CalendarSceneManager *)self model];
    v11 = [v10 currentlyLocked];
    ...
    if (v11)
    {
      ...
      *&buf[16] = 0x3032000000;
      ...
      v13 = [(CalendarSceneManager *)self model];
      ...
      v21 = v15;
      v22 = buf;
      v16 = [v12 addObserverForName:v14 object:v13 queue:0 usingBlock:v20];
      v17 = *(*&buf[8] + 40);
      *(*&buf[8] + 40) = v16;
        ...
        do
        {
          for (i = 0; i != v10; i = i + 1)
          {
            ...
            if ([*(*(&v18 + 1) + 8 * i) isEqualToString:@"travel=true"])
            {
              ...
              v14 = [v13 stringByReplacingOccurrencesOfString:@"?travel=true" withString:&stru_1002133B8];
...
+ (id)_encodeIdentifier:(id)a3
{
  ...
  v5 = [v4 stringByAddingPercentEncodingWithAllowedCharacters:qword_100251D20];
...
- (void)windowScene:(id)a3 performActionForShortcutItem:(id)a4 completionHandler:(id)a5
{
  ...
  {
    v15 = [v9 type];
    v16 = [v15 isEqualToString:@"com.apple.mobilecal.addevent"];
...
- (void)_splashScreenDidDismissShouldNotify:(BOOL)a3
{
  ...
  v5 = [(CalendarSceneManager *)self splashScreenCompletionAction];
  ...
  if (v5)
  {
    ...
    v7 = [(CalendarSceneManager *)self splashScreenCompletionAction];
    v7[2]();
