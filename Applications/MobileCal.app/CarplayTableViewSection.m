...
- (CarplayTableViewSection)initWithPaddingCellEnabled:(BOOL)a3 titleForSectionHeader:(id)a4 shouldCollapseMultipleAllDayEvents:(BOOL)a5 model:(id)a6
{
  ...
  if (v13)
  {
    ...
    objc_storeStrong(&v13->_sectionTitle, a4);
    v14->_shouldCollapseAllDay = a5;
    v14->_currentlyCollapsed = 1;
    objc_storeStrong(&v14->_model, a6);
  }
...
- (id)cellForRow:(int64_t)a3 underDate:(id)a4 inTableView:(id)a5
{
  ...
  {
    if (!([(NSArray *)self->_events count]| a3) || self->_paddingCellEnabled && [(CarplayTableViewSection *)self numberOfRows]- 1 == a3)
    {
      v11 = objc_opt_new();
      goto LABEL_12;
    }
    ...
    v10 = [(NSArray *)timedEvents objectAtIndexedSubscript:v13];
    v11 = [(CarplayTableViewSection *)self _reusableOccurrenceTableViewCellForEvent:v10 underDate:v8 inTableView:v9];
  }
...
- (id)tableView:(id)a3 didSelectRowAtIndexPath:(id)a4
{
  ...
  if (-[CarplayTableViewSection _cellInRowIsCollapsedAllDayCell:](self, "_cellInRowIsCollapsedAllDayCell:", [v7 row]))
  {
    ...
    if ([(NSArray *)self->_allDayEvents count]>= 2)
    {
      ...
      do
      {
        v12 = +[NSIndexPath indexPathForRow:inSection:](NSIndexPath, "indexPathForRow:inSection:", v11, [v7 section]);
        [v10 addObject:v12];
    ...
    v13 = [v9 cellForRowAtIndexPath:v7];
  ...
  else
  {
    ...
    v20 = [v19 birthdayContactIdentifier];
    ...
    else if ([v19 isIntegrationEvent])
    {
      if ([v19 CUIK_reminderShouldBeEditable])
      {
        ...
        v26 = [v6 EKUI_editor];
        v32 = 0;
        v27 = [v26 saveEvent:v19 span:0 error:&v32];
        v28 = v32;
...
LABEL_5:
  ...
  v15 = [v6 startDate];
  v16 = [v6 endDateUnadjustedForLegacyClients];
  v17 = [v14 cal_isMultidayEventForUIWithStartDate:v15 endDate:v16];
