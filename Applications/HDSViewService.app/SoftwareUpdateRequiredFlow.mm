...
- (_TtC14HDSViewService26SoftwareUpdateRequiredFlow)initWithCoder:(id)coder;
- (_TtC14HDSViewService26SoftwareUpdateRequiredFlow)initWithNibName:(id)name bundle:(id)bundle;
