...
- (HPdetector_SceneClassifier_B520Input)initWithImageDescriptors:(id)descriptors;
...
- (HPdetector_SceneClassifier_B520Input)initWithImageDescriptors:(id)descriptors
{
  ...
  v9.receiver = self;
  v9.super_class = HPdetector_SceneClassifier_B520Input;
...
- (id)featureValueForName:(id)name
{
  ...
  {
    imageDescriptors = [(HPdetector_SceneClassifier_B520Input *)self imageDescriptors];
