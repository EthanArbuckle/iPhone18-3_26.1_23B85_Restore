...
- (HPdetector_SmartCam_B238)initWithConfiguration:(id)configuration error:(id *)error;
- (HPdetector_SmartCam_B238)initWithContentsOfURL:(id)l configuration:(id)configuration error:(id *)error;
- (HPdetector_SmartCam_B238)initWithContentsOfURL:(id)l error:(id *)error;
- (HPdetector_SmartCam_B238)initWithMLModel:(id)model;
...
- (HPdetector_SmartCam_B238)init
{
  ...
  v4 = [(HPdetector_SmartCam_B238 *)self initWithContentsOfURL:uRLOfModelInThisBundle error:0];
...
- (HPdetector_SmartCam_B238)initWithConfiguration:(id)configuration error:(id *)error
{
  ...
  uRLOfModelInThisBundle = [objc_opt_class() URLOfModelInThisBundle];
  v8 = [(HPdetector_SmartCam_B238 *)self initWithContentsOfURL:uRLOfModelInThisBundle configuration:configurationCopy error:error];
...
- (id)predictionFromFeatures:(id)features error:(id *)error
{
  ...
  v8 = [(HPdetector_SmartCam_B238 *)self predictionFromFeatures:featuresCopy options:v7 error:error];
...
- (id)predictionFromFeatures:(id)features options:(id)options error:(id *)error
{
  optionsCopy = options;
  featuresCopy = features;
  model = [(HPdetector_SmartCam_B238 *)self model];
  ...
  if (v11)
  {
    ...
    v15 = [(HPdetector_SmartCam_B238Output *)v12 initWithHomePodDetected:multiArrayValue];
  }
...
- (id)predictionFromImageDescriptors:(id)descriptors error:(id *)error
{
  ...
  v7 = [[HPdetector_SmartCam_B238Input alloc] initWithImageDescriptors:descriptorsCopy];

  v8 = [(HPdetector_SmartCam_B238 *)self predictionFromFeatures:v7 error:error];
  ...
  if (v12)
  {
    ...
    if ([v12 count] >= 1)
    {
      ...
      do
      {
        ...
        v19 = [(HPdetector_SmartCam_B238Output *)v16 initWithHomePodDetected:multiArrayValue];
