...
- (_TtC8Freeform22CRLCommandReplaceImage)initWithId:(id)a3 imageData:(id)a4 thumbnailData:(id)a5
{
  ...
  *(self + OBJC_IVAR____TtC8Freeform22CRLCommandReplaceImage_imageData) = a4;
  *(self + OBJC_IVAR____TtC8Freeform22CRLCommandReplaceImage_thumbnailData) = a5;
  v12 = type metadata accessor for CRLCommandReplaceImage();
  v17.receiver = self;
  v17.super_class = v12;
  v13 = a4;
  v14 = a5;
...
- (_TtC8Freeform22CRLCommandReplaceImage)initWithImageItem:(id)a3 imageData:(id)a4 thumbnailData:(id)a5
{
  ...
  (*(v10 + 8))(v13, v9);
  v18 = [(CRLCommandReplaceImage *)self initWithId:isa imageData:v15 thumbnailData:v16];
