...
- (id)originalNodeForNode:(id)a3
{
  v4 = [(NSMapTable *)self->mOriginalNodeIndexMapping objectForKeyedSubscript:a3];
  if (v4)
  {
    v5 = [(CRLEditableBezierPathSource *)self->mOriginal subpaths];
    v6 = [v4 objectAtIndexedSubscript:0];
    v7 = [v5 objectAtIndexedSubscript:{objc_msgSend(v6, "unsignedIntegerValue")}];

    v8 = [v7 nodes];
    v9 = [v4 objectAtIndexedSubscript:1];
    v10 = [v8 objectAtIndexedSubscript:{objc_msgSend(v9, "unsignedIntegerValue")}];
  }
...
- (id)originalSmoothNodeForNode:(id)a3
{
  ...
  if (v4)
  {
    v5 = [(CRLEditableBezierPathSource *)self->mSmoothOriginal subpaths];
    v6 = [v4 objectAtIndexedSubscript:0];
    v7 = [v5 objectAtIndexedSubscript:{objc_msgSend(v6, "unsignedIntegerValue")}];
