...
- (CGSize)size;
- (CRLCGImage)initWithCGImage:(CGImage *)image scale:(double)scale orientation:(int64_t)orientation;
- (double)scale;
...
{
  v11.receiver = self;
  v11.super_class = CRLCGImage;
  v8 = [(CRLImage *)&v11 init];
  if (v8)
  {
