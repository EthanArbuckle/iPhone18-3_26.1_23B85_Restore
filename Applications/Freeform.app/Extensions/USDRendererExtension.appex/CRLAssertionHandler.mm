...
+ (id)p_performBlockIgnoringAssertions:(id)assertions onlyFatal:(BOOL)fatal
{
  ...
  v15[3] = &unk_100092AF3;
  v16 = 0;
  v7 = objc_retainBlock(qword_1000D9348);
    ...
    do
    {
      for (i = 0; i != v8; i = i + 1)
      {
        ...
        if (dladdr(pointerValue, &v80))
        {
          ...
          {
            [v5 addObject:v12];
            os_unfair_lock_lock(&dword_1000D9368);
            v13 = [qword_1000D9360 objectForKeyedSubscript:v12];
            os_unfair_lock_unlock(&dword_1000D9368);
            if (v13)
            {
              v14 = v56;
              v15 = v13;
...
LABEL_29:
        ...
        if (ncmds)
        {
          ...
          {
            v33 = v32;
            v34 = [NSMutableDictionary dictionaryWithSharedKeySet:qword_1000D9358];
            ...
            os_unfair_lock_lock(&dword_1000D9368);
            [qword_1000D9360 setObject:v34 forKeyedSubscript:v21];
            os_unfair_lock_unlock(&dword_1000D9368);
            [v56 addObject:v34];
...
+ (void)handleFailureInFunction:(id)function file:(id)file lineNumber:(int64_t)number isFatal:(BOOL)fatal format:(id)format args:(char *)args
{
  ...
  else
  {
    ...
    v19 = atomic_load(dword_1000D9380);
