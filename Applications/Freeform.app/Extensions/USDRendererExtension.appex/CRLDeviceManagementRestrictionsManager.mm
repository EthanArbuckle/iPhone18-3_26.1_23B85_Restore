...
- (BOOL)isKeyboardMathSolvingAllowed
{
  v3 = OBJC_IVAR____TtC20USDRendererExtension38CRLDeviceManagementRestrictionsManager_isKeyboardMathSolvingAllowed;
  swift_beginAccess();
  return *(&self->super.isa + v3);
}
...
- (BOOL)isDefinitionLookupAllowed
{
  v3 = OBJC_IVAR____TtC20USDRendererExtension38CRLDeviceManagementRestrictionsManager_isDefinitionLookupAllowed;
  swift_beginAccess();
  return *(&self->super.isa + v3);
}
...
- (_TtC20USDRendererExtension38CRLDeviceManagementRestrictionsManager)init
{
  *(&self->super.isa + OBJC_IVAR____TtC20USDRendererExtension38CRLDeviceManagementRestrictionsManager_isMathPaperSolvingAllowed) = 1;
  *(&self->super.isa + OBJC_IVAR____TtC20USDRendererExtension38CRLDeviceManagementRestrictionsManager_isKeyboardMathSolvingAllowed) = 1;
  *(&self->super.isa + OBJC_IVAR____TtC20USDRendererExtension38CRLDeviceManagementRestrictionsManager_isDefinitionLookupAllowed) = 1;
  *(&self->super.isa + OBJC_IVAR____TtC20USDRendererExtension38CRLDeviceManagementRestrictionsManager____lazy_storage___connection) = 1;
  v3.receiver = self;
