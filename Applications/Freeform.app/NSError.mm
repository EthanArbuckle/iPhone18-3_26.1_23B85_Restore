...
+ (id)crl_fileReadCorruptedFileErrorWithUserInfo:(id)info;
+ (id)crl_fileReadPOSIXErrorWithNumber:(int)number userInfo:(id)info;
+ (id)crl_fileReadUnknownErrorWithUserInfo:(id)info;
+ (id)crl_fileWritePOSIXErrorWithNumber:(int)number userInfo:(id)info;
+ (id)crl_fileWriteUnknownErrorWithUserInfo:(id)info;
+ (id)crl_userInfoWithErrorType:(int64_t)type userInfo:(id)info;
...
+ (id)crl_fileReadUnknownErrorWithUserInfo:(id)info
{
  v3 = [self crl_userInfoWithErrorType:1 userInfo:info];
...
{
  numberCopy = number;
  v5 = [self crl_userInfoWithErrorType:1 userInfo:info];
...
+ (id)crl_fileWriteUnknownErrorWithUserInfo:(id)info
{
  v3 = [self crl_userInfoWithErrorType:2 userInfo:info];
...
+ (id)crl_fileWritePOSIXErrorWithNumber:(int)number userInfo:(id)info
{
  infoCopy = info;
  v7 = [NSError alloc];
  v8 = [self crl_userInfoWithErrorType:2 userInfo:infoCopy];
