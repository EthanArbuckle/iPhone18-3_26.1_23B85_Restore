...
- (NSURL)previewItemURL
{
  ...
  v5 = &v14 - v4;
  v6 = OBJC_IVAR____TtC8Freeform21CRLUSDZRepPlaceholder_previewItemURL;
  swift_beginAccess();
...
- (NSString)previewItemTitle
{
  if (*(self + OBJC_IVAR____TtC8Freeform21CRLUSDZRepPlaceholder_previewItemTitle + 8))
  {
...
- (void)setPreviewItemTitle:(id)title
{
  ...
  v6 = (self + OBJC_IVAR____TtC8Freeform21CRLUSDZRepPlaceholder_previewItemTitle);
  *v6 = v4;
  v6[1] = v5;
}
