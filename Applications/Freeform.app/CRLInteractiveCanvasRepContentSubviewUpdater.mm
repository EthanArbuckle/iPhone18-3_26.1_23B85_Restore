...
+ (id)p_contentPlatformViewForRepContentPlatformViewPile:(id)pile layerDelegate:(id)delegate reusableMaskView:(id *)view;
- (CRLInteractiveCanvasRepContentSubviewUpdater)initWithRepContainerView:(id)view;
- (void)p_backgroundThreadUpdateSubviewsFromRepContentPiles:(id)piles;
- (void)p_mainThreadUpdateSubviewsFromRepContentPiles:(id)piles;
- (void)updateSubviewFrames;
- (void)updateSubviewsFromRepContentPiles:(id)piles;
@end
...
- (CRLInteractiveCanvasRepContentSubviewUpdater)initWithRepContainerView:(id)view
{
  ...
  if (v6)
  {
    objc_storeStrong(&v6->_repContainerView, view);
  }
...
- (void)updateSubviewsFromRepContentPiles:(id)piles
{
  ...
  {
    [(CRLInteractiveCanvasRepContentSubviewUpdater *)self p_mainThreadUpdateSubviewsFromRepContentPiles:pilesCopy];
  }

  else
  {
    [(CRLInteractiveCanvasRepContentSubviewUpdater *)self p_backgroundThreadUpdateSubviewsFromRepContentPiles:pilesCopy];
  }
}
...
- (void)p_mainThreadUpdateSubviewsFromRepContentPiles:(id)piles
{
  ...
  v20 = [subviews crl_arrayOfObjectsPassingTest:&stru_1018531D8];

  v21 = [v20 count];
  subviews2 = [(CRLCanvasSubview *)self->_repContainerView subviews];
  v23 = [subviews2 count];
  ...
  {
    subviews3 = [(CRLCanvasSubview *)self->_repContainerView subviews];
    v25 = [subviews3 crl_arrayOfObjectsPassingTest:&stru_1018531F8];
  }
  ...
  v35[8] = v18;
  v35[9] = v21;
  [pilesCopy enumerateObjectsUsingBlock:v35];
  v27 = v17;
  v28 = v27;
  if ([v25 count])
  {
  ...
  subviews4 = [(CRLCanvasSubview *)self->_repContainerView subviews];
  v30 = [v28 isEqualToArray:subviews4];
...
+ (id)p_contentPlatformViewForRepContentPlatformViewPile:(id)pile layerDelegate:(id)delegate reusableMaskView:(id *)view
{
  ...
  contentPlatformView = [pileCopy contentPlatformView];
  if (contentPlatformView)
  {
    [pileCopy contentPlatformViewFrame];
    v11 = v10;
    v13 = v12;
    v15 = v14;
    v17 = v16;
    [pileCopy contentPlatformViewMaskRect];
    x = v29.origin.x;
    y = v29.origin.y;
    ...
    else
    {
      ...
      [(CRLCanvasSubview *)v22 setLayerDelegate:delegateCopy];
      ...
      *view = v22;
      ...
      {
LABEL_4:
        [contentPlatformView setFrame:{v11, v13, v15, v17}];
        v22 = contentPlatformView;
        goto LABEL_10;
      }
    }
    ...
    [contentPlatformView setFrame:{v32.origin.x, v32.origin.y, v32.size.width, v32.size.height}];
    v27 = contentPlatformView;
  ...
  if (v11)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        if (v23)
        {
          contentLayers = [v23 contentLayers];
          [v9 addObjectsFromArray:contentLayers];
        }
        ...
        else
        {
          ...
          if (v32)
          {
            ...
            while (1)
            {
              ...
              canReuseForRepContentLayersDuringBackgroundUpdate = [v38 canReuseForRepContentLayersDuringBackgroundUpdate];
              v40 = v34;
              if ((canReuseForRepContentLayersDuringBackgroundUpdate & 1) == 0)
              {
                v41 = [v38 canReuseUnmodifiedForRepContentPile:contentLayers];
                v40 = v35;
                if (v41)
                {
                  break;
            ...
            if (v36)
            {
              v46 = [(NSArray *)selfCopy->_backgroundUpdateSubviewReusers objectAtIndexedSubscript:v82];
              v47 = v33;
...
LABEL_24:
          ...
          else
          {
            ...
            contentLayers = [NSString stringWithUTF8String:"[CRLInteractiveCanvasRepContentSubviewUpdater p_backgroundThreadUpdateSubviewsFromRepContentPiles:]"];
            ...
            [CRLAssertionHandler handleFailureInFunction:contentLayers file:v45 lineNumber:362 isFatal:0 description:"Rep content pile did not implement either CRLInteractiveCanvasRepLayerPile or CRLInteractiveCanvasRepContentPlatformViewPile: %@", v22];
  ...
  if (v82 + 1 < v81)
  {
    do
    {
      v69 = [(NSArray *)selfCopy->_backgroundUpdateSubviewReusers objectAtIndexedSubscript:v68];
  ...
  if ([v61 count])
  {
    lastMainThreadUpdateSeed = selfCopy->_lastMainThreadUpdateSeed;
...
- (void)updateSubviewFrames
{
  ...
  v23 = 0u;
  subviews = [(CRLCanvasSubview *)self->_repContainerView subviews];
  v15 = [subviews countByEnumeratingWithState:&v20 objects:v24 count:16];
  if (v15)
  {
    v16 = v15;
    v17 = *v21;
