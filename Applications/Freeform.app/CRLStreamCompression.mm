...
- (CRLStreamCompression)initWithAlgorithm:(int)algorithm operation:(int)operation;
- (void)dealloc;
@end
...
- (void)dealloc
{
  ...
  v3.receiver = self;
  v3.super_class = CRLStreamCompression;
...
- (BOOL)processBytes:(char *)bytes size:(unint64_t)size flags:(int)flags
{
  ...
  while (1)
  {
    ...
    {
LABEL_46:
      self->_stream.dst_ptr = malloc_type_malloc(0x400uLL, 0xD1BFC9E5uLL);
...
LABEL_42:
  result = 0;
LABEL_43:
  self->_stream.src_ptr = &unk_101A34D38;
