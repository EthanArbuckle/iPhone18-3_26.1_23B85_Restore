...
{
  v6.receiver = self;
  v6.super_class = _s4ItemC14ViewControllerC8ItemViewCMa();
  v2 = v6.receiver;
  [(CRLiOSFolderGridViewController.Item.ViewController.ItemView *)&v6 updateConstraints];
  Strong = swift_unknownObjectWeakLoadStrong();
  if (Strong)
  {
    v5 = Strong;
    (*((swift_isaMask & *Strong) + 0x1C8))(Strong, v4);
  }
}
