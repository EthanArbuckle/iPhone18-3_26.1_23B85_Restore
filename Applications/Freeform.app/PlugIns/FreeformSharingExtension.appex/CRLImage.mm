...
+ (id)crl_quickInspectorImageNamed:(id)named isPrivateImage:(BOOL)image isBundledImage:(BOOL)bundledImage
{
  ...
  if (qword_1000B4B58 != -1)
  {
    sub_10007C1B4();
  }

  v14 = [qword_1000B4B50 objectForKeyedSubscript:namedCopy];
  if (!v14)
  {
    if (bundledImageCopy)
    {
    ...
    v14 = v15;
    [qword_1000B4B50 setObject:v15 forKeyedSubscript:namedCopy];
  }
...
- (id)copyWithZone:(_NSZone *)zone
{
  ...
  if (CRLAssertCat_init_token != -1)
  {
    dispatch_once(&CRLAssertCat_init_token, &stru_1000A6218);
  }
  ...
  if (CRLAssertCat_init_token != -1)
  {
    dispatch_once(&CRLAssertCat_init_token, &stru_1000A6238);
  }
...
- (CRLImage)initWithContentsOfFile:(id)file
{
  ...
  if (CRLAssertCat_init_token != -1)
  {
    dispatch_once(&CRLAssertCat_init_token, &stru_1000A6258);
  }
  ...
  if (CRLAssertCat_init_token != -1)
  {
    dispatch_once(&CRLAssertCat_init_token, &stru_1000A6278);
  }
...
- (CRLImage)initWithData:(id)data
{
  ...
  if (CRLAssertCat_init_token != -1)
  {
    dispatch_once(&CRLAssertCat_init_token, &stru_1000A6298);
  }
  ...
  if (CRLAssertCat_init_token != -1)
  {
    dispatch_once(&CRLAssertCat_init_token, &stru_1000A62B8);
  }
...
- (CRLImage)initWithCGImage:(CGImage *)image
{
  ...
  if (CRLAssertCat_init_token != -1)
  {
    dispatch_once(&CRLAssertCat_init_token, &stru_1000A62D8);
  }
  ...
  if (CRLAssertCat_init_token != -1)
  {
    dispatch_once(&CRLAssertCat_init_token, &stru_1000A62F8);
  }
...
- (CRLImage)initWithCGImage:(CGImage *)image scale:(double)scale orientation:(int64_t)orientation
{
  ...
  if (CRLAssertCat_init_token != -1)
  {
    dispatch_once(&CRLAssertCat_init_token, &stru_1000A6318);
  }
  ...
  if (CRLAssertCat_init_token != -1)
  {
    dispatch_once(&CRLAssertCat_init_token, &stru_1000A6338);
  }
...
- (CRLImage)initWithImageSourceRef:(CGImageSource *)ref
{
  ...
  if (CRLAssertCat_init_token != -1)
  {
    dispatch_once(&CRLAssertCat_init_token, &stru_1000A6358);
  }
  ...
  if (CRLAssertCat_init_token != -1)
  {
    dispatch_once(&CRLAssertCat_init_token, &stru_1000A6378);
  }
...
- (CRLImage)initWithSystemImageNamed:(id)named
{
  ...
  if (CRLAssertCat_init_token != -1)
  {
    dispatch_once(&CRLAssertCat_init_token, &stru_1000A6398);
  }
  ...
  if (CRLAssertCat_init_token != -1)
  {
    dispatch_once(&CRLAssertCat_init_token, &stru_1000A63B8);
  }
...
- (CRLImage)initWithSystemImageNamed:(id)named pointSize:(double)size
{
  ...
  if (CRLAssertCat_init_token != -1)
  {
    dispatch_once(&CRLAssertCat_init_token, &stru_1000A63D8);
  }
  ...
  if (CRLAssertCat_init_token != -1)
  {
    dispatch_once(&CRLAssertCat_init_token, &stru_1000A63F8);
  }
...
- (CRLImage)initWithPrivateSystemImageNamed:(id)named
{
  ...
  if (CRLAssertCat_init_token != -1)
  {
    dispatch_once(&CRLAssertCat_init_token, &stru_1000A6418);
  }
  ...
  if (CRLAssertCat_init_token != -1)
  {
    dispatch_once(&CRLAssertCat_init_token, &stru_1000A6438);
  }
...
- (CRLImage)initWithPrivateSystemImageNamed:(id)named pointSize:(double)size
{
  ...
  if (CRLAssertCat_init_token != -1)
  {
    dispatch_once(&CRLAssertCat_init_token, &stru_1000A6458);
  }
  ...
  if (CRLAssertCat_init_token != -1)
  {
    dispatch_once(&CRLAssertCat_init_token, &stru_1000A6478);
  }
...
- (CGSize)size
{
  ...
  if (CRLAssertCat_init_token != -1)
  {
    dispatch_once(&CRLAssertCat_init_token, &stru_1000A6498);
  }
  ...
  if (CRLAssertCat_init_token != -1)
  {
    dispatch_once(&CRLAssertCat_init_token, &stru_1000A64B8);
  }
...
- (double)scale
{
  ...
  if (CRLAssertCat_init_token != -1)
  {
    dispatch_once(&CRLAssertCat_init_token, &stru_1000A64D8);
  }
  ...
  if (CRLAssertCat_init_token != -1)
  {
    dispatch_once(&CRLAssertCat_init_token, &stru_1000A64F8);
  }
...
- (CGImage)CGImageForSize:(CGSize)size
{
  ...
  if (CRLAssertCat_init_token != -1)
  {
    dispatch_once(&CRLAssertCat_init_token, &stru_1000A6518);
  }
  ...
  if (CRLAssertCat_init_token != -1)
  {
    dispatch_once(&CRLAssertCat_init_token, &stru_1000A6538);
  }
...
- (CGImage)CGImage
{
  ...
  if (CRLAssertCat_init_token != -1)
  {
    dispatch_once(&CRLAssertCat_init_token, &stru_1000A6558);
  }
  ...
  if (CRLAssertCat_init_token != -1)
  {
    dispatch_once(&CRLAssertCat_init_token, &stru_1000A6578);
  }
...
- (int64_t)imageOrientation
{
  ...
  if (CRLAssertCat_init_token != -1)
  {
    dispatch_once(&CRLAssertCat_init_token, &stru_1000A6598);
  }
  ...
  if (CRLAssertCat_init_token != -1)
  {
    dispatch_once(&CRLAssertCat_init_token, &stru_1000A65B8);
  }
...
- (CRLImage)initWithUIImage:(id)image
{
  ...
  if (CRLAssertCat_init_token != -1)
  {
    dispatch_once(&CRLAssertCat_init_token, &stru_1000A6600);
  }
  ...
  if (CRLAssertCat_init_token != -1)
  {
    dispatch_once(&CRLAssertCat_init_token, &stru_1000A6620);
  }
