...
- (BCUIHoverInteraction)initWithDelegate:(id)delegate view:(id)view;
...
- (void)rebuildRegionWithKey:(id)key block:(id)block
{
  ...
  bounds = [(_BCUIHoverRegionBuilder *)v7 bounds];
  v9 = [bounds count];

  if (v9)
  {
    bounds2 = [(_BCUIHoverRegionBuilder *)v7 bounds];
...
- (void)_updateState
{
  isHovering = [(BCUIHoverInteraction *)self isHovering];
