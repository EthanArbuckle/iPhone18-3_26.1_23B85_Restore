...
- (id)p_fireworksSystemsForTR:(id)a3 build:(id)a4 context:(id)a5
{
  ...
  while (1)
  {
    ...
    v33 = [v9 metalContext];
    v34 = [KNBuildFireworksSystem newParticleSystemWithParticleSize:v31 particleSystemSize:v10 objectSize:metalFireworksShader slideSize:v33 duration:1.0 direction:1.0 randomGenerator:v23 shader:1.0 metalContext:self->_drawableFrame.size.width, self->_drawableFrame.size.height, v19, v21, v30];
...
- (void)p_setupShadersWithMetalContext:(id)a3
{
  ...
  v7 = [[TSDMetalShader alloc] initDefaultTextureAndOpacityShaderWithDevice:v17 colorAttachment:v5];
  metalObjectShader = self->_metalObjectShader;
  self->_metalObjectShader = v7;

  v9 = [[TSDMetalShader alloc] initCustomShaderWithVertexShader:@"buildFireworksParticlesVertexShader" fragmentShader:@"buildFireworksParticlesFragmentShader" device:v17 library:@"KeynoteMetalLibrary" colorAttachment:v5];
  metalFireworksShader = self->_metalFireworksShader;
  self->_metalFireworksShader = v9;

  [v5 setDestinationRGBBlendFactor:0];
  [v5 setDestinationAlphaBlendFactor:0];
  v11 = [[TSDMetalShader alloc] initQuadTextureShaderWithFragmentShader:@"buildFireworksTrailsFragmentShader" device:v17 library:@"KeynoteMetalLibrary" colorAttachment:v5];
  ...
  v13 = [[TSDMetalShader alloc] initQuadTextureShaderWithFragmentShader:@"buildFireworksTrailsFragmentShader" device:v17 library:@"KeynoteMetalLibrary" colorAttachment:v5];
  metalFBOShader = self->_metalFBOShader;
  self->_metalFBOShader = v13;

  [v5 setDestinationRGBBlendFactor:5];
  [v5 setDestinationAlphaBlendFactor:5];
  v15 = [[TSDMetalShader alloc] initDefaultTextureAndOpacityShaderWithDevice:v17 colorAttachment:v5];
...
- (void)metalPrepareAnimationWithContext:(id)a3
{
  ...
  if ([v5 count] != &dword_0 + 1)
  {
    ...
    [v8 handleFailureInFunction:v9 file:v10 lineNumber:443 description:{@"Effect expects one texture. Passed (%lu) textures.", objc_msgSend(v5, "count")}];
  }
  ...
  *&self->_baseOrthoTransform.m23 = v28;
  ...
  v29 = [(KNBuildFireworks *)self p_fireworksSystemsForTR:v11 build:v6 context:v4];
  ...
  v33 = TSDRectUnit[2];
  v34 = TSDRectUnit[3];
  v35 = [TSDGPUDataBuffer newDataBufferWithVertexRect:"newDataBufferWithVertexRect:textureRect:device:" textureRect:v12 device:?];
  metalObjectDataBuffer = self->_metalObjectDataBuffer;
  self->_metalObjectDataBuffer = v35;

  TSDRectWithSize();
  v37 = [TSDGPUDataBuffer newDataBufferWithVertexRect:"newDataBufferWithVertexRect:textureRect:device:" textureRect:v12 device:?];
  ...
  v40 = v39;
  [(TSDTexturedRectangle *)self->_centerBurstTR size];
  v42 = [TSDGPUDataBuffer newDataBufferWithVertexRect:v12 textureRect:0.0 device:0.0, v40, v41, v31, v32, v33, v34];
...
- (void)metalAnimationWillBeginWithContext:(id)a3
{
  ...
  v5 = [[TSDMetalRenderTarget alloc] initWithSize:v13 metalContext:{self->_frameRect.size.width, self->_frameRect.size.height}];
  frameRenderTarget = self->_frameRenderTarget;
  self->_frameRenderTarget = v5;

  v7 = [[TSDMetalRenderTarget alloc] initWithSize:v13 metalContext:{self->_frameRect.size.width, self->_frameRect.size.height}];
  ...
  v11 = [v9 initWithEffectSize:v13 blurScale:self->_frameRect.size.width metalContext:{self->_frameRect.size.height, v10}];
...
- (void)p_drawParticleSystemsWithPercent:(double)a3 sparkles:(BOOL)a4 particleSystemOpacity:(double)a5 context:(id)a6 renderEncoder:(id)a7
{
  ...
  v12 = a6;
  v13 = a7;
  v51 = [v12 randomGenerator];
  *&self->_anon_194[44] = v9;
  v57 = 0u;
  v58 = 0u;
  v59 = 0u;
  v60 = 0u;
  ...
  if (v14)
  {
    ...
    do
    {
      for (i = 0; i != v15; i = i + 1)
      {
        ...
        *&v30 = v26;
        v56 = LODWORD(v30);
        if (([v12 isWarmingUp] | !v9) == 1 && (objc_msgSend(v17, "didDrawCenterBurst") & 1) == 0)
        {
          [(TSDTexturedRectangle *)self->_centerBurstTR size];
          v32 = v31;
          v34 = v33;
          ...
          *&v47 = v47;
          ...
          v48 = [(TSDTexturedRectangle *)self->_centerBurstTR metalTexture];
        ...
        v49 = [(TSDTexturedRectangle *)self->_particleTR metalTexture];
...
- (void)metalRenderFrameWithContext:(id)a3
{
  ...
  v10 = [(TSDMetalRenderTarget *)self->_frameRenderTarget passDescriptor];
  v11 = [v7 renderCommandEncoderWithDescriptor:v10];
  ...
  *&self->_anon_194[48] = LODWORD(v30);
  if (self->_previousPercent > 0.0)
  {
    ...
    *self->_anon_2b8 = v36;
    ...
    v38 = [(TSDMetalRenderTarget *)self->_frameRenderTarget texture];
  ...
  *&v39 = 1.0 - v39;
  ...
  [v11 endEncoding];
  v41 = [(TSDMetalRenderTarget *)self->_bloomRenderTarget passDescriptor];
  v42 = [v7 renderCommandEncoderWithDescriptor:v41];
  ...
  v43 = [(TSDMetalRenderTarget *)self->_frameRenderTarget texture];
  ...
  [v42 endEncoding];
  [v7 commit];
  v44 = [v53 objectAtIndexedSubscript:0];
  [(KNBuildFireworks *)self p_drawObject:v44 percent:v54 encoder:v13];

  metalBloomEffect = self->_metalBloomEffect;
  v46 = [(TSDMetalRenderTarget *)self->_bloomRenderTarget texture];
  v47 = [v4 metalContext];
