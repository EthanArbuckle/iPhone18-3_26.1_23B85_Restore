...
- (THBookmarkMenuTableViewCell)initWithStyle:(int64_t)a3 reuseIdentifier:(id)a4
{
  ...
  if (v4)
  {
    v6 = [(THBookmarkMenuTableViewCell *)v4 contentView];
    ...
    [v15 addObject:{+[NSLayoutConstraint constraintWithItem:attribute:relatedBy:toItem:attribute:multiplier:constant:](NSLayoutConstraint, "constraintWithItem:attribute:relatedBy:toItem:attribute:multiplier:constant:", v7, 10, 0, v6, 10, 1.0, 0.0)}];
