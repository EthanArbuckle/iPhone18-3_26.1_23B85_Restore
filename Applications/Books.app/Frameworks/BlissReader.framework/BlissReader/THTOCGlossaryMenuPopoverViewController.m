...
- (void)viewDidLoad
{
  ...
  v3 = [(THTOCGlossaryMenuPopoverViewController *)self view];
  [v3 setBackgroundColor:{+[UIColor systemBackgroundColor](UIColor, "systemBackgroundColor")}];
  ...
  [v3 addConstraints:{+[NSArray arrayWithObjects:count:](NSArray, "arrayWithObjects:count:", v9, 12)}];
