...
- (BOOL)checkIfOneOrMoreAnnotationsForStorage:(id)storage range:(_NSRange)range passesTest:(id)test;
- (BOOL)hasAnnotationWithNoteInAbsolutePhysicalPageIndex:(unint64_t)index;
- (BOOL)hasAnnotationWithNoteOnPageInfo:(id)info;
- (BOOL)storage:(id)storage containsSomeUnhighlightedTextInRange:(_NSRange)range;
- (BOOL)storage:(id)storage hasAnnotationStrictlyContainingRange:(_NSRange)range;
- (BOOL)storage:(id)storage hasAnnotationThatMatchesStyle:(int)style inRange:(_NSRange)range;
- (BOOL)storage:(id)storage hasAnnotationWithExactRange:(_NSRange)range;
- (THAnnotationCache)initWithAnnotations:(id)annotations contentNode:(id)node needsMigration:(BOOL)migration;
- (THAnnotationCache)initWithAnnotationsByStorage:(id)storage bookmarkAnnotations:(id)annotations orphanedAnnotations:(id)orphanedAnnotations needsMigration:(BOOL)migration temporaryAnnotation:(id)annotation contentNode:(id)node;
- (_NSRange)differenceRangeWithCache:(id)cache storageUID:(id)d;
- (id)annotationWithUUID:(id)d;
- (id)annotationsForStorage:(id)storage;
- (id)annotationsForStorage:(id)storage range:(_NSRange)range;
- (id)annotationsForStorageUID:(id)d;
- (id)bookmarkForAbsolutePhysicalPageIndex:(unint64_t)index;
- (id)highlightAnnotations;
- (id)highlightAnnotationsSortedByRange;
- (id)newAnnotationCacheWithRemovedAnnotation:(id)annotation;
- (id)newAnnotationCacheWithTemporaryAnnotation:(id)annotation;
- (id)newAnnotationCacheWithUpdatedAnnotation:(id)annotation;
- (id)p_newBookmarkAbsolutePhysicalPageIndexSetFromBookmarks:(id)bookmarks;
- (void)dealloc;
- (void)enumerateAnnotationsForStorage:(id)storage range:(_NSRange)range withBlock:(id)block;
- (void)enumerateAnnotationsWithBlock:(id)block;
- (void)p_updateAnnotationsByStorage:(id)storage byAddingAnnotation:(id)annotation storageUUID:(id)d;
- (void)p_updateAnnotationsByStorage:(id)storage byRemovingAnnotation:(id)annotation storageUUID:(id)d;
@end
...
- (THAnnotationCache)initWithAnnotationsByStorage:(id)storage bookmarkAnnotations:(id)annotations orphanedAnnotations:(id)orphanedAnnotations needsMigration:(BOOL)migration temporaryAnnotation:(id)annotation contentNode:(id)node
{
  ...
  if (v14)
  {
    v14->_contentNode = node;
    v14->_annotationsByStorage = [storage copy];
    v15->_bookmarkAnnotations = [annotations copy];
    v15->_orphanedAnnotations = [orphanedAnnotations copy];
    v15->_temporaryAnnotation = annotation;
    ...
    v15->_needsMigration = migration;
    v15->_numberOfHighlightAnnotations = 0;
    v22 = 0u;
    v23 = 0u;
    v24 = 0u;
    v25 = 0u;
    objectEnumerator = [storage objectEnumerator];
    v17 = [objectEnumerator countByEnumeratingWithState:&v22 objects:v27 count:16];
    if (v17)
    {
      v18 = v17;
      v19 = *v23;
      do
      {
        ...
        v18 = [objectEnumerator countByEnumeratingWithState:&v22 objects:v27 count:16];
      }
...
- (THAnnotationCache)initWithAnnotations:(id)annotations contentNode:(id)node needsMigration:(BOOL)migration
{
  ...
  v10 = [[NSMutableDictionary alloc] initWithCapacity:{objc_msgSend(annotations, "count")}];
  ...
  *(p_numberOfBookmarkAnnotations - 16) = migration;
  v37 = 0u;
  v38 = 0u;
  v39 = 0u;
  v40 = 0u;
  v13 = [annotations countByEnumeratingWithState:&v37 objects:v43 count:16];
  if (!v13)
  {
    goto LABEL_15;
  }
  ...
  do
  {
    for (i = 0; i != v14; i = i + 1)
    {
      ...
      if (([v17 annotationIsOrphan] & 1) == 0)
      {
        ...
        if (([v17 annotationIsBookmark] & 1) == 0)
        {
          ...
          annotationStorageUID = [v17 annotationStorageUID];
          v18 = [v10 objectForKey:annotationStorageUID];
          v19 = v29;
          if (!v18)
          {
            v18 = +[NSMutableArray array];
            [v10 setObject:v18 forKey:annotationStorageUID];
            v19 = v29;
          }
        }
      }
    ...
    v14 = [annotations countByEnumeratingWithState:&v37 objects:v43 count:16];
  }
    ...
    if (v6)
    {
      ...
      do
      {
        ...
        do
        {
          ...
          annotationAbsolutePhysicalPageIndex = [*(*(&v11 + 1) + 8 * v9) annotationAbsolutePhysicalPageIndex];
          if (annotationAbsolutePhysicalPageIndex != 0x7FFFFFFFFFFFFFFFLL)
          {
            [v5 addIndex:annotationAbsolutePhysicalPageIndex];
          }
        ...
        while (v7 != v9);
        v7 = [bookmarks countByEnumeratingWithState:&v11 objects:v15 count:16];
      }
...
LABEL_3:
  ...
  while (1)
  {
    ...
    v9 = *(*(&v11 + 1) + 8 * v8);
    if ([v9 annotationAbsolutePhysicalPageIndex] == index)
    {
      return v9;
    }
...
- (BOOL)hasAnnotationWithNoteInAbsolutePhysicalPageIndex:(unint64_t)index
{
  ...
  v22 = 0u;
  v23 = 0u;
  objectEnumerator = [(NSDictionary *)self->_annotationsByStorage objectEnumerator];
  v5 = [(NSEnumerator *)objectEnumerator countByEnumeratingWithState:&v20 objects:v25 count:16];
  if (v5)
  {
    v6 = v5;
    v7 = *v21;
    do
    {
        ...
        if (v10)
        {
          ...
          while (2)
          {
            for (j = 0; j != v11; j = j + 1)
            {
              ...
              v14 = *(*(&v16 + 1) + 8 * j);
              if ([v14 annotationAbsolutePhysicalPageIndex] == index && objc_msgSend(objc_msgSend(v14, "annotationNote"), "length"))
              {
                LOBYTE(v5) = 1;
                return v5;
              }
      ...
      v6 = [(NSEnumerator *)objectEnumerator countByEnumeratingWithState:&v20 objects:v25 count:16];
      LOBYTE(v5) = 0;
    }
...
- (BOOL)hasAnnotationWithNoteOnPageInfo:(id)info
{
  ...
  if (NSInvalidRange[0] == bodyStorageRange && NSInvalidRange[1] == v5)
  {
  ...
  else
  {
    ...
    v28 = 0u;
    objectEnumerator = [(NSDictionary *)self->_annotationsByStorage objectEnumerator];
    v10 = [(NSEnumerator *)objectEnumerator countByEnumeratingWithState:&v27 objects:v32 count:16];
    if (v10)
    {
      v11 = v10;
      v12 = *v28;
      ...
      do
      {
        ...
        v11 = [(NSEnumerator *)objectEnumerator countByEnumeratingWithState:&v27 objects:v32 count:16];
        LOBYTE(v10) = 0;
      }
...
- (id)annotationsForStorage:(id)storage
{
  result = [(THModelContentNode *)self->_contentNode annotationIDForInfo:storage];
  if (result)
  {
    v5 = result;
...
- (id)annotationsForStorage:(id)storage range:(_NSRange)range
{
  ...
  v5[3] = &unk_45DCB8;
  rangeCopy = range;
  return [-[THAnnotationCache annotationsForStorage:](self annotationsForStorage:{storage), "tsu_arrayOfObjectsPassingTest:", v5}];
}
...
- (id)annotationWithUUID:(id)d
{
  ...
  if (annotationsByUUIDOnceToken == -1)
  {
    if (d)
    {
      return [(NSDictionary *)self->_annotationsByUUID objectForKey:d];
    }
  }
...
- (id)newAnnotationCacheWithUpdatedAnnotation:(id)annotation
{
  annotationStorageUID = [annotation annotationStorageUID];
  if ([annotation annotationIsOrphan])
  {
    v6 = [(NSArray *)self->_orphanedAnnotations mutableCopy];
    [(NSArray *)v6 addObject:annotation];
  ...
  if (![annotation annotationIsBookmark])
  {
    if ([annotation annotationIsPlaceholder])
    {
      [+[TSUAssertionHandler currentHandler](TSUAssertionHandler "currentHandler")];
    }

    else if (annotationStorageUID)
    {
      v6 = [(NSDictionary *)self->_annotationsByStorage mutableCopy];
      [(THAnnotationCache *)self p_updateAnnotationsByStorage:v6 byAddingAnnotation:annotation storageUUID:annotationStorageUID];
      v7 = [THAnnotationCache alloc];
      bookmarkAnnotations = self->_bookmarkAnnotations;
...
LABEL_13:
  ...
  v14 = [(NSArray *)v6 indexOfObject:annotation];
  ...
  {
    [(NSArray *)v6 replaceObjectAtIndex:v14 withObject:annotation];
  }
...
- (id)newAnnotationCacheWithRemovedAnnotation:(id)annotation
{
  ...
  {
    v6 = [(NSArray *)self->_orphanedAnnotations mutableCopy];
    v7 = [(NSArray *)v6 indexOfObject:annotation];
  ...
  else
  {
    if (![annotation annotationIsBookmark])
    {
      ...
      {
        v6 = [(NSDictionary *)self->_annotationsByStorage mutableCopy];
        [(THAnnotationCache *)self p_updateAnnotationsByStorage:v6 byRemovingAnnotation:annotation storageUUID:annotationStorageUID];
        v9 = [THAnnotationCache alloc];
        bookmarkAnnotations = self->_bookmarkAnnotations;
        orphanedAnnotations = self->_orphanedAnnotations;
        needsMigration = self->_needsMigration;
...
LABEL_16:
    ...
    v6 = [(NSArray *)self->_bookmarkAnnotations mutableCopy];
    v8 = [(NSArray *)v6 indexOfObject:annotation];
...
- (void)p_updateAnnotationsByStorage:(id)storage byAddingAnnotation:(id)annotation storageUUID:(id)d
{
  ...
  v9 = [v10 indexOfObject:annotation];
  if (v9 == 0x7FFFFFFFFFFFFFFFLL)
  {
    [v10 addObject:annotation];
  }

  else
  {
    [v10 replaceObjectAtIndex:v9 withObject:annotation];
  }

  [storage setObject:objc_msgSend(v10 forKey:{"sortedArrayWithOptions:usingComparator:", 1, &stru_45ECE0), d}];
}
...
- (void)p_updateAnnotationsByStorage:(id)storage byRemovingAnnotation:(id)annotation storageUUID:(id)d
{
  ...
  [storage setObject:objc_msgSend(v10 forKey:{"sortedArrayWithOptions:usingComparator:", 1, &stru_45ED00), d}];
}

- (id)newAnnotationCacheWithTemporaryAnnotation:(id)annotation
{
  if ([(THAnnotationCache *)self temporaryAnnotation]== annotation)
  {
  ...
  else
  {
    ...
    if (annotation)
    {
      -[THAnnotationCache p_updateAnnotationsByStorage:byAddingAnnotation:storageUUID:](self, "p_updateAnnotationsByStorage:byAddingAnnotation:storageUUID:", v4, annotation, [annotation annotationStorageUID]);
    }

    v6 = [[THAnnotationCache alloc] initWithAnnotationsByStorage:v4 bookmarkAnnotations:self->_bookmarkAnnotations orphanedAnnotations:self->_orphanedAnnotations needsMigration:self->_needsMigration temporaryAnnotation:annotation contentNode:self->_contentNode];
...
- (_NSRange)differenceRangeWithCache:(id)cache storageUID:(id)d
{
  v6 = [(THAnnotationCache *)self annotationsForStorageUID:d];
  v7 = [cache annotationsForStorageUID:d];
  v8 = [v6 count];
  v9 = [v7 count];
  v11 = v9;
  if (!v8)
...
- (void)enumerateAnnotationsForStorage:(id)storage range:(_NSRange)range withBlock:(id)block
{
  ...
  v19 = 0u;
  v20 = 0u;
  v8 = [(THAnnotationCache *)self annotationsForStorage:storage, 0];
...
LABEL_3:
    ...
    while (1)
    {
      ...
      if (location + length <= annotationStorageRange)
      {
        break;
      }

      v23.location = annotationStorageRange;
      v23.length = v15;
...
- (BOOL)checkIfOneOrMoreAnnotationsForStorage:(id)storage range:(_NSRange)range passesTest:(id)test
{
  ...
  v22 = 0u;
  v23 = 0u;
  v8 = [(THAnnotationCache *)self annotationsForStorage:storage];
...
LABEL_3:
  ...
  while (1)
  {
    ...
    v14 = *(*(&v20 + 1) + 8 * v13);
    annotationStorageRange = [v14 annotationStorageRange];
    v17 = v12 > annotationStorageRange;
    if (v12 <= annotationStorageRange)
    {
      return v17;
    }

    v26.location = annotationStorageRange;
    v26.length = v16;
    ...
    if (test)
    {
      if (v18.length && ((*(test + 2))(test, v14) & 1) != 0)
      {
        return v17;
      }
    }
...
- (BOOL)storage:(id)storage hasAnnotationStrictlyContainingRange:(_NSRange)range
{
  ...
  v5[3] = &unk_45ED80;
  rangeCopy = range;
  return [(THAnnotationCache *)self checkIfOneOrMoreAnnotationsForStorage:storage range:range.location passesTest:range.length, v5];
}
...
- (BOOL)storage:(id)storage hasAnnotationThatMatchesStyle:(int)style inRange:(_NSRange)range
{
  ...
  rangeCopy = range;
  styleCopy = style;
  return [(THAnnotationCache *)self checkIfOneOrMoreAnnotationsForStorage:storage range:range.location passesTest:range.length, v6];
}
...
- (BOOL)storage:(id)storage containsSomeUnhighlightedTextInRange:(_NSRange)range
{
  ...
  v10[3] = &unk_45EDC8;
  v10[4] = &v11;
  [(THAnnotationCache *)self enumerateAnnotationsForStorage:storage range:range.location withBlock:range.length, v10];
...
- (id)highlightAnnotationsSortedByRange
{
  ...
  v14 = 0u;
  objectEnumerator = [(NSDictionary *)self->_annotationsByStorage objectEnumerator];
  v5 = [(NSEnumerator *)objectEnumerator countByEnumeratingWithState:&v11 objects:v15 count:16];
  if (v5)
  {
    v6 = v5;
    v7 = *v12;
    do
    {
      ...
      while (v6 != v8);
      v6 = [(NSEnumerator *)objectEnumerator countByEnumeratingWithState:&v11 objects:v15 count:16];
    }
