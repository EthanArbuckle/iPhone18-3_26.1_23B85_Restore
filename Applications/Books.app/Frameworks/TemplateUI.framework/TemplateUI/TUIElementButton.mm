...
+ (id)builderWithNode:(id)node object:(id)object attributes:(id)attributes context:(id)context
{
  ...
  v14 = [attributesCopy stringForAttribute:116 node:node.var0];
  [(_TUIElementButtonBuilder *)v10 setButtonType:[TUIButtonBox buttonTypeFromString:v14]];

  v15 = [attributesCopy stringForAttribute:44 node:node.var0];
  [(_TUIElementButtonBuilder *)v10 setButtonRole:[TUIButtonBox buttonRoleFromString:v15]];

  v16 = [attributesCopy BOOLForAttribute:139 node:node.var0];
...
+ (void)configureBox:(id)box withNode:(id)node attributes:(id)attributes context:(id)context
{
  ...
  v10 = [attributesCopy stringForAttribute:216 node:var0];
  [boxCopy setUserInterfaceStyle:{+[TUIBox userInterfaceStyleFromString:](TUIBox, "userInterfaceStyleFromString:", v10)}];

  v11 = [attributesCopy focusStyleForAttribute:88 node:var0];
  [boxCopy setFocusStyle:v11];
  ...
  [boxCopy setTouchInsets:{UIEdgeInsetsZero.top - v13, UIEdgeInsetsZero.left - v15, UIEdgeInsetsZero.bottom - v17, UIEdgeInsetsZero.right - v19}];
}
...
+ (void)configureObject:(id)object withBuilder:(id)builder context:(id)context
{
  ...
  builderCopy = builder;
  contextCopy = context;
  [objectCopy setButtonType:{objc_msgSend(builderCopy, "buttonType")}];
  [objectCopy setButtonRole:{objc_msgSend(builderCopy, "buttonRole")}];
