...
- (NSDictionary)engagementData
{
  if (*(self + OBJC_IVAR____TtCC5Books20AMDCollectionServiceP33_4EFD11BC7D3B203388E5898071D414945Event_engagementData))
  {
...
- (void)setEngagementData:(id)data
{
  ...
  *(self + OBJC_IVAR____TtCC5Books20AMDCollectionServiceP33_4EFD11BC7D3B203388E5898071D414945Event_engagementData) = v4;
}
