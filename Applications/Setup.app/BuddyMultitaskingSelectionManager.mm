...
- (_TtC5Setup33BuddyMultitaskingSelectionManager)initWithDeviceProvider:(id)provider preferences:(id)preferences;
- (_TtC5Setup33BuddyMultitaskingSelectionManager)initWithDeviceProvider:(id)provider preferences:(id)preferences modeProvider:(id)modeProvider;
...
- (_TtC5Setup33BuddyMultitaskingSelectionManager)initWithDeviceProvider:(id)provider preferences:(id)preferences modeProvider:(id)modeProvider
{
  *(&self->super.isa + OBJC_IVAR____TtC5Setup33BuddyMultitaskingSelectionManager_deviceProvider) = provider;
  *(&self->super.isa + OBJC_IVAR____TtC5Setup33BuddyMultitaskingSelectionManager_preferences) = preferences;
  *(&self->super.isa + OBJC_IVAR____TtC5Setup33BuddyMultitaskingSelectionManager_modeProvider) = modeProvider;
  swift_unknownObjectRetain_n();
  preferencesCopy = preferences;
  swift_unknownObjectRetain_n();
  v9 = preferencesCopy;
  currentMultitaskingOption = [modeProvider currentMultitaskingOption];
  *(&self->super.isa + OBJC_IVAR____TtC5Setup33BuddyMultitaskingSelectionManager_initialValue) = currentMultitaskingOption;
  v13.receiver = self;
...
- (void)resetSettingsUsing:(id)using
{
  ...
  v5 = *(&selfCopy->super.isa + OBJC_IVAR____TtC5Setup33BuddyMultitaskingSelectionManager_initialValue);
  v6 = OBJC_IVAR____TtC5Setup33BuddyMultitaskingSelectionManager_modeProvider;
  if ([*(&selfCopy->super.isa + OBJC_IVAR____TtC5Setup33BuddyMultitaskingSelectionManager_modeProvider) currentMultitaskingOption] == v5)
  {
    v7 = usingCopy;
    usingCopy = selfCopy;
  }
