...
- (_TtC5Setup25SolariumOnBoardingManager)initWithChronicle:(id)chronicle featureFlags:(id)flags;
...
- (_TtC5Setup25SolariumOnBoardingManager)initWithChronicle:(id)chronicle featureFlags:(id)flags
{
  *(&self->super.isa + OBJC_IVAR____TtC5Setup25SolariumOnBoardingManager_chronicle) = chronicle;
  *(&self->super.isa + OBJC_IVAR____TtC5Setup25SolariumOnBoardingManager_featureFlags) = flags;
  v7.receiver = self;
...
- (BOOL)shouldLaunchToOnBoardUserToSolarium
{
  ...
  {
    v4 = [*(&selfCopy->super.isa + OBJC_IVAR____TtC5Setup25SolariumOnBoardingManager_chronicle) entryForFeature:6];
