...
- (_TtC17SequoiaTranslator15MoreHistoryView)initWithCoder:(id)coder
{
  ...
  *(&self->super.super.super.isa + v4) = sub_100189B54();
  v5 = OBJC_IVAR____TtC17SequoiaTranslator15MoreHistoryView_disclosureIndictor;
  *(&self->super.super.super.isa + v5) = sub_100189CD8();
