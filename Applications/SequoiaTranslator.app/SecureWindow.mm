...
- (_TtC17SequoiaTranslator12SecureWindow)initWithCoder:(id)coder;
- (_TtC17SequoiaTranslator12SecureWindow)initWithFrame:(CGRect)frame;
- (_TtC17SequoiaTranslator12SecureWindow)initWithWindowScene:(id)scene;
@end
