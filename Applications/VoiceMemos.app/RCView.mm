...
{
  renderer = [(RCView *)self renderer];
  splitViewController = [renderer splitViewController];

  LOBYTE(renderer) = [splitViewController isTransitioningBetweenVisibleColumnStates];
  return renderer;
}
