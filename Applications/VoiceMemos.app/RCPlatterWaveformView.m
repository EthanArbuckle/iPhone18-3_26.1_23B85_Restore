...
- (RCPlatterWaveformView)initWithFrame:(CGRect)a3 dataProvider:(id)a4
{
  ...
  v10 = [(RCPlatterWaveformView *)&v18 initWithFrame:x, y, width, height];
  v11 = v10;
  if (v10)
  {
    [(RCPlatterWaveformView *)v10 setDataProvider:v9];
    v12 = [(RCPlatterWaveformView *)v11 _defaultActiveSliceColor];
    [(RCPlatterWaveformView *)v11 setActiveSliceColor:v12];
    ...
    v16 = [(RCPlatterWaveformView *)v11 layer];
...
- (id)_defaultActiveSliceColor
{
  ...
  v3 = [v2 platterWaveformActiveSliceColor];
...
- (void)resetSliceColor
{
  v3 = [(RCPlatterWaveformView *)self _defaultActiveSliceColor];
  [(RCPlatterWaveformView *)self setSliceColor:v3];
}
