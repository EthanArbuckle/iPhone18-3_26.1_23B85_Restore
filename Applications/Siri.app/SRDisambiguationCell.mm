...
- (SRDisambiguationCell)initWithFrame:(CGRect)a3
{
  ...
  v3 = [(SRDisambiguationCell *)&v33 initWithFrame:a3.origin.x, a3.origin.y, a3.size.width, a3.size.height];
  if (v3)
  {
...
LABEL_7:
  ...
  v6 = [(SRDisambiguationCell *)self semanticContentAttribute];
...
- (void)updateConstraints
{
  ...
  if (!self->_constraintsCreated)
  {
    ...
    v4 = [(SRDisambiguationCell *)self contentView];
    ...
    v12 = [(SRDisambiguationCell *)self keyline];
...
- (void)updateConstraintConstants
{
  ...
  v16 = [(SRDisambiguationCell *)self item];
...
- (void)setImageView:(id)a3
{
  ...
  if (self->_imageView)
  {
    v6 = [(SRDisambiguationCell *)self contentView];
    [v6 addSubview:self->_imageView];

    [(UIImageView *)self->_imageView setTranslatesAutoresizingMaskIntoConstraints:0];
    v7 = [(SRDisambiguationCell *)self contentView];
...
- (void)setSemanticContentAttribute:(int64_t)a3
{
  v5 = [(SRDisambiguationCell *)self contentView];
  v6 = [v5 constraints];
  ...
  v8 = [(SRDisambiguationCell *)self contentView];
