...
+ (Reachability)reachabilityWithAddress:(const sockaddr *)address;
+ (Reachability)reachabilityWithHostName:(id)name;
...
- (BOOL)startNotifier
{
  ...
  v7.info = self;
  v3 = SCNetworkReachabilitySetCallback(self->_reachabilityRef, sub_10001B504, &v7);
  if (v3)
  {
