...
- (ComposeNavigationController)initWithUserActivity:(id)a3 scene:(id)a4
{
  v5 = sub_10004ADBC(ComposeNavigationController, a3, a4);
...
- (void)viewDidAppear:(BOOL)a3
{
  ...
  v5 = [(ComposeNavigationController *)self view];
  ...
  v6 = [(ComposeNavigationController *)self _mailComposeView];
  [v6 didAppear];
}
...
- (void)viewWillDisappear:(BOOL)a3
{
  ...
  v4 = [(ComposeNavigationController *)self _mailComposeView];
  [v4 willDisappear];
...
{
  v3 = a3;
  v4 = [(MFMailComposeController *)self->_composeViewController mailComposeView];
