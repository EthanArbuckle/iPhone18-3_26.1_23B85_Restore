...
- (void)configureOutlineCell:(id)a3
{
  ...
  if (v5)
  {
    ...
    [v4 setLegacyMailboxes:v8 showUnreadCount:-[FavoriteItem showUnreadCount](self unreadCountIncludesRead:{"showUnreadCount"), v7 == 5}];
  }
  ...
  v11 = [v10 isDisplayingMultipleAccounts];
