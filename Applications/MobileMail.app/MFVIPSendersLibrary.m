...
+ (id)log
{
  ...
  block[1] = 3221225472;
  block[2] = sub_100236B08;
  block[3] = &unk_10064C4F8;
  block[4] = a1;
  if (qword_1006DD788 != -1)
  {
    dispatch_once(&qword_1006DD788, block);
  }
...
+ (id)defaultInstance
{
  block[0] = _NSConcreteStackBlock;
  block[1] = 3221225472;
  block[2] = sub_100236C2C;
  block[3] = &unk_10064C4F8;
  block[4] = a1;
  if (qword_1006DD798 != -1)
  {
    dispatch_once(&qword_1006DD798, block);
  }
...
- (void)dealloc
{
  ...
  if (addressBook)
  {
    ...
    block[0] = _NSConcreteStackBlock;
    block[1] = 3221225472;
    block[2] = sub_1002371B8;
    block[3] = &unk_100651598;
    block[4] = v8;
    block[5] = self;
...
- (void)checkForAddressBookChanges
{
  ...
  if (!self->_addressBook)
  {
    ...
    if (v4)
    {
      ...
      ABAddressBookRegisterExternalChangeCallback(self->_addressBook, sub_1002372D0, self);
    }
