...
- (void)_createSubviews
{
  ...
  v14 = [v13 localizedStringForKey:@"TO" value:&stru_100662A88 table:@"Main"];
  ...
  v18 = [v17 localizedStringForKey:@"CC/BCC" value:&stru_100662A88 table:@"Main"];
...
- (void)_setSubject:(id)a3
{
  ...
  else
  {
    ...
    if (v7)
      v3 = {;
      [v3 localizedStringForKey:@"NEW_MESSAGE_LONG" value:&stru_100662A88 table:@"Main"];
    }

    else
      v4 = {;
      [v4 localizedStringForKey:@"NEW_MESSAGE" value:&stru_100662A88 table:@"Main"];
    }
    v9 = ;
    v8 = v7 ^ 1;
  }
