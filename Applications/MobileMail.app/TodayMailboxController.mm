...
- (id)mailboxTitle
{
  ...
  v3 = [v2 localizedStringForKey:@"TODAY_MAILBOX" value:&stru_100662A88 table:@"Main"];
...
{
  v2 = [NSBundle bundleForClass:objc_opt_class()];
  v3 = [v2 localizedStringForKey:@"TODAY_NAVIGATION_TITLE" value:&stru_100662A88 table:@"Main"];
