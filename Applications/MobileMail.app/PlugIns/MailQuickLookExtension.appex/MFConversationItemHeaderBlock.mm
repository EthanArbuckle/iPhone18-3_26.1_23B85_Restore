...
+ (OS_os_log)log
{
  ...
  block[4] = self;
  if (qword_10003DF68 != -1)
  {
    dispatch_once(&qword_10003DF68, block);
  }
...
- (MFConversationItemHeaderBlock)initWithFrame:(CGRect)frame contactStore:(id)store
{
  ...
  if (height)
  {
    ...
    byte_10003DF70 = [v12 BOOLForKey:@"ShowMessageHeaderDetails"];

    v11->_showDetails = byte_10003DF70;
...
- (void)createPrimaryViews
{
  ...
  v16 = [v15 localizedStringForKey:@"FROM_HEADER" value:&stru_100035108 table:@"Main"];
  v17 = +[NSBundle mainBundle];
  v18 = [v17 localizedStringForKey:@"FROM_TITLE" value:&stru_100035108 table:@"Main"];
...
- (id)_bimiLearnMoreMenuWithSenderDomain:(id)domain
{
  ...
  v11 = [UIAction actionWithTitle:v10 image:v9 identifier:0 handler:&stru_1000349F8];
...
- (void)setOtherSigners:(id)signers
{
  v6 = [signers ef_map:&stru_100034C18];
  captionView = [(MFConversationItemHeaderBlock *)self captionView];
  if (v6)
  {
    v5 = v6;
