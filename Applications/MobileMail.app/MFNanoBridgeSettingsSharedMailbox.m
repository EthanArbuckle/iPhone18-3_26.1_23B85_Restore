...
- (id)displayName
{
  ...
  if (type > 3)
  {
    switch(type)
    {
      case 4:
        ...
        v5 = [v4 localizedStringForKey:@"TO_OR_CC" value:&stru_100662A88 table:@"Main"];
        break;
      case 6:
        v4 = [NSBundle bundleForClass:objc_opt_class()];
        v5 = [v4 localizedStringForKey:@"IMPORTANT_THREADS" value:&stru_100662A88 table:@"Main"];
        break;
      case 7:
        v4 = [NSBundle bundleForClass:objc_opt_class()];
        v5 = [v4 localizedStringForKey:@"TODAY" value:&stru_100662A88 table:@"Main"];
        break;
      default:
        goto LABEL_15;
    }
  ...
  else
  {
    switch(type)
    {
      case 1:
        v4 = [NSBundle bundleForClass:objc_opt_class()];
        v5 = [v4 localizedStringForKey:@"VIP" value:&stru_100662A88 table:@"Main"];
        break;
      case 2:
        v4 = [NSBundle bundleForClass:objc_opt_class()];
        v5 = [v4 localizedStringForKey:@"FLAGGED" value:&stru_100662A88 table:@"Main"];
        break;
      case 3:
        v4 = [NSBundle bundleForClass:objc_opt_class()];
        v5 = [v4 localizedStringForKey:@"UNREAD" value:&stru_100662A88 table:@"Main"];
        break;
      default:
        goto LABEL_15;
    }
...
- (id)_includesMeIconImage
{
  ...
  if (!qword_1006DD5F8)
  {
    ...
    v4 = [NSBundle bundleForClass:objc_opt_class()];
    v5 = sub_10014A14C(2, v3, v4, 35.0);

    v6 = [NSBundle bundleForClass:objc_opt_class()];
    v7 = sub_10014A14C(3, v3, v6, 35.0);
    ...
    v10 = sub_100149B0C(2, v3, v8, v9, 0, v5);

    v11 = [NSBundle bundleForClass:objc_opt_class()];
    v12 = +[UIColor systemGrayColor];
    v13 = sub_100149B0C(3, v3, v11, v12, 0, v5);
