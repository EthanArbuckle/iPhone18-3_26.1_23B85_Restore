...
- (_TtC22GuestUserHandoverSetup12SecureWindow)initWithCoder:(id)coder;
- (_TtC22GuestUserHandoverSetup12SecureWindow)initWithFrame:(CGRect)frame;
- (_TtC22GuestUserHandoverSetup12SecureWindow)initWithWindowScene:(id)scene;
@end
