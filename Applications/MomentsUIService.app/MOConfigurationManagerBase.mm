...
- (int)getIntegerSettingForKey:(id)a3 withFallback:(int)a4
{
  v4 = *&a4;
  v6 = a3;
  v7 = [(MOConfigurationManagerBase *)self getIntegerDefaultsForKey:v6 withFallback:[(MOConfigurationManagerBase *)self getIntegerTrialLevelForKey:v6 withFallback:v4]];
...
- (BOOL)getBoolSettingForKey:(id)a3 withFallback:(BOOL)a4
{
  v4 = a4;
  v6 = a3;
  v7 = [(MOConfigurationManagerBase *)self getBoolDefaultsForKey:v6 withFallback:[(MOConfigurationManagerBase *)self getBoolTrialLevelForKey:v6 withFallback:v4]];
  v8 = _mo_log_facility_get_os_log(&MOLogFacilitySettings);
  if (os_log_type_enabled(v8, OS_LOG_TYPE_DEBUG))
  {
    v10 = 138412802;
