...
- (_TtC28LocalAuthenticationUIService31BiometryCompanionViewController)initWithCoder:(id)a3;
- (_TtC28LocalAuthenticationUIService31BiometryCompanionViewController)initWithInternalInfo:(id)a3 mechanism:(id)a4 backoffCounter:(id)a5 remoteUIHost:(id)a6 allowsLandscape:(BOOL)a7;
- (_TtC28LocalAuthenticationUIService31BiometryCompanionViewController)initWithInternalInfo:(id)a3 parent:(id)a4;
- (_TtC28LocalAuthenticationUIService31BiometryCompanionViewController)initWithNibName:(id)a3 bundle:(id)a4;
- (_TtC28LocalAuthenticationUIService31BiometryCompanionViewController)initWithRequestID:(id)a3 endpoint:(id)a4;
- (_TtC28LocalAuthenticationUIService31BiometryCompanionViewController)initWithRequestID:(id)a3 endpoint:(id)a4 remoteAlertPresentationMode:(int64_t)a5;
...
{
  v4 = self;
  BiometryCompanionViewController.viewDidAppear(_:)(a3);
}
