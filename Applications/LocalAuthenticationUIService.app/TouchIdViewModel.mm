...
- (id)alertActionsFromOptions:(id)options event:(int64_t)event
{
  ...
  v8 = [optionsCopy objectForKeyedSubscript:&off_1000AF650];
  v9 = v8;
  if (v8)
  {
  ...
  v11 = [optionsCopy objectForKeyedSubscript:&off_1000AF668];
...
LABEL_15:
      v17 = [optionsCopy objectForKeyedSubscript:&off_1000AF698];
...
- (id)fallbackActionFromOptions:(id)options
{
  v3 = [options objectForKeyedSubscript:&off_1000AF680];
...
- (id)alertTintFromOptions:(id)options
{
  v3 = [options objectForKeyedSubscript:&off_1000AF6C8];
  if (v3)
  {
    objc_opt_class();
