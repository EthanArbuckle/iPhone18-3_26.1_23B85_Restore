...
- (_TtC28LocalAuthenticationUIService27PasscodeSheetViewController)initWithInternalInfo:(id)a3 mechanism:(id)a4 backoffCounter:(id)a5 remoteUIHost:(id)a6 allowsLandscape:(BOOL)a7;
- (_TtC28LocalAuthenticationUIService27PasscodeSheetViewController)initWithInternalInfo:(id)a3 parent:(id)a4;
- (_TtC28LocalAuthenticationUIService27PasscodeSheetViewController)initWithNibName:(id)a3 bundle:(id)a4;
- (_TtC28LocalAuthenticationUIService27PasscodeSheetViewController)initWithRequestID:(id)a3 endpoint:(id)a4;
- (_TtC28LocalAuthenticationUIService27PasscodeSheetViewController)initWithRequestID:(id)a3 endpoint:(id)a4 remoteAlertPresentationMode:(int64_t)a5;
...
- (_TtC28LocalAuthenticationUIService27PasscodeSheetViewController)initWithNibName:(id)a3 bundle:(id)a4
{
  ...
  v8 = a4;
  return PasscodeSheetViewController.init(nibName:bundle:)(v5, v7, a4);
}
