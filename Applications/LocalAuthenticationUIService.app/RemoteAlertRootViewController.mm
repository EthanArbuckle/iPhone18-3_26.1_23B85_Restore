...
- (_TtC28LocalAuthenticationUIService29RemoteAlertRootViewController)initWithCoder:(id)coder;
- (_TtC28LocalAuthenticationUIService29RemoteAlertRootViewController)initWithNibName:(id)name bundle:(id)bundle;
- (_TtC28LocalAuthenticationUIService29RemoteAlertRootViewController)initWithScene:(id)scene;
@end
