...
+ (id)deprecatedStorageLocation
{
  ...
  v3 = [v2 initWithIdentifier:off_100045C68];
  v4 = [v3 url];
...
- (void)addAccessory:(id)a3 withCompletion:(id)a4
{
  ...
  block[0] = _NSConcreteStackBlock;
  block[1] = 3221225472;
  block[2] = sub_10001A4CC;
  block[3] = &unk_100039BD8;
  block[4] = self;
  v12 = v6;
  v13 = v7;
  v9 = v7;
