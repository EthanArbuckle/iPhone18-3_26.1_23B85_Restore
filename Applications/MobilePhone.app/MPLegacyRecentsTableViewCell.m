...
- (void)configureCellForHighlightingWithText:(id)a3
{
  ...
  {
    v25 = [(PHTableViewCell *)self titleLabel];
    v4 = [v25 text];
    v5 = [(PHTableViewCell *)self titleLabel];
    v6 = [v5 textColor];
    v7 = [v6 colorWithAlphaComponent:0.6];
    v8 = [(PHTableViewCell *)self titleLabel];
    v9 = [v8 textColor];
    v10 = [v9 colorWithAlphaComponent:1.0];
    v11 = [v4 attributedStringToHighlightText:v26 primaryColour:v7 secondaryColour:v10];
    v12 = [(PHTableViewCell *)self titleLabel];
    [v12 setAttributedText:v11];

    v13 = [(PHTableViewCell *)self titleLabel];
    v14 = [v13 textColor];
    v15 = [v14 colorWithAlphaComponent:0.6];
    v16 = [(MPLegacyRecentsTableViewCell *)self callerCountLabel];
  ...
  else
  {
    ...
    v13 = [(PHTableViewCell *)self titleLabel];
    v14 = [v13 text];
    v15 = [v14 attributedStringToHighlightText:v26];
    v16 = [(PHTableViewCell *)self titleLabel];
    [v16 setAttributedText:v15];
  }

  v21 = [(PHTableViewCell *)self subtitleLabel];
  v22 = [v21 text];
  v23 = [v22 attributedStringToHighlightText:v26];
