...
- (BOOL)isTranscriptionEnabled
{
  ...
  _s11MobilePhone44VoicemailAccountManagerWithDelegateDecoratorC3vmdAA011VMVoicemailE8Protocol_pvgAaE_pAaE_pSgzYuYTXEfU_(v2 + 1, v3, v7);
...
- (NSProgress)transcriptionProgress
{
  ...
  v3 = self;
  os_unfair_lock_lock(v2);
  _s11MobilePhone44VoicemailAccountManagerWithDelegateDecoratorC3vmdAA011VMVoicemailE8Protocol_pvgAaE_pAaE_pSgzYuYTXEfU_(v2 + 1, v3, v8);
  os_unfair_lock_unlock(v2);
  v4 = v8[1];
  ObjectType = swift_getObjectType();
...
- (BOOL)isCallVoicemailSupportedForAccountUUID:(id)a3
{
  ...
  _s11MobilePhone44VoicemailAccountManagerWithDelegateDecoratorC3vmdAA011VMVoicemailE8Protocol_pvgAaE_pAaE_pSgzYuYTXEfU_(v8 + 1, v9, v14);
...
- (int64_t)maximumPasscodeLengthForAccountUUID:(id)a3
{
  ...
  v9 = self;
  os_unfair_lock_lock(v8);
  _s11MobilePhone44VoicemailAccountManagerWithDelegateDecoratorC3vmdAA011VMVoicemailE8Protocol_pvgAaE_pAaE_pSgzYuYTXEfU_(v8 + 1, v9, v15);
  os_unfair_lock_unlock(v8);
  v10 = v15[1];
  ObjectType = swift_getObjectType();
...
- (void)setPasscode:(id)a3 forAccountUUID:(id)a4 completion:(id)a5
{
  ...
  *(v15 + 16) = v11;
  ...
  _s11MobilePhone44VoicemailAccountManagerWithDelegateDecoratorC3vmdAA011VMVoicemailE8Protocol_pvgAaE_pAaE_pSgzYuYTXEfU_(v16 + 1, v17, v21);
...
- (void)greetingForAccountUUID:(id)a3 completion:(id)a4
{
  ...
  *(v11 + 16) = v10;
  ...
  _s11MobilePhone44VoicemailAccountManagerWithDelegateDecoratorC3vmdAA011VMVoicemailE8Protocol_pvgAaE_pAaE_pSgzYuYTXEfU_(v12 + 1, v13, v17);
...
- (void)setGreeting:(id)a3 forAccountUUID:(id)a4 completion:(id)a5
{
  ...
  *(v13 + 16) = v12;
  ...
  _s11MobilePhone44VoicemailAccountManagerWithDelegateDecoratorC3vmdAA011VMVoicemailE8Protocol_pvgAaE_pAaE_pSgzYuYTXEfU_(v14 + 1, v16, v20);
  os_unfair_lock_unlock(v14);
  v17 = v20[1];
  ObjectType = swift_getObjectType();
  (*(v17 + 160))(v15, v11, partial apply for thunk for @escaping @callee_unowned @convention(block) @Sendable (@unowned ObjCBool, @unowned NSError?) -> (), v13, ObjectType, v17);
