...
- (_TtC11MobilePhone27VoicemailAccountManagerData)initWithAnyAccountSubscribed:(BOOL)a3 online:(BOOL)a4 isMessageWaiting:(BOOL)a5 storageUsage:(unint64_t)a6 transcriptionEnabled:(BOOL)a7 transcriptionProgress:(id)a8 accounts:(id)a9;
@end
...
- (_TtC11MobilePhone27VoicemailAccountManagerData)initWithAnyAccountSubscribed:(BOOL)a3 online:(BOOL)a4 isMessageWaiting:(BOOL)a5 storageUsage:(unint64_t)a6 transcriptionEnabled:(BOOL)a7 transcriptionProgress:(id)a8 accounts:(id)a9
{
  ...
  *(self + OBJC_IVAR____TtC11MobilePhone27VoicemailAccountManagerData_anyAccountSubscribed) = a3;
  *(self + OBJC_IVAR____TtC11MobilePhone27VoicemailAccountManagerData_online) = a4;
  *(self + OBJC_IVAR____TtC11MobilePhone27VoicemailAccountManagerData_isMessageWaiting) = a5;
  *(self + OBJC_IVAR____TtC11MobilePhone27VoicemailAccountManagerData_storageUsage) = a6;
  *(self + OBJC_IVAR____TtC11MobilePhone27VoicemailAccountManagerData_transcriptionEnabled) = a7;
  *(self + OBJC_IVAR____TtC11MobilePhone27VoicemailAccountManagerData_transcriptionProgress) = a8;
