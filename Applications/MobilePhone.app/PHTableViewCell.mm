...
- (void)updateFontsAndLayoutMetrics
{
  ...
  v6 = &UIDeviceProximityStateDidChangeNotification_ptr;
  ...
  telephonyUIBodyShortEmphasizedFont = [(NSNotificationName *)v6[310] telephonyUIBodyShortEmphasizedFont];
  titleLabel2 = [(PHTableViewCell *)self titleLabel];
  [titleLabel2 setFont:telephonyUIBodyShortEmphasizedFont];

  telephonyUISubheadlineShortFont = [(NSNotificationName *)v6[310] telephonyUISubheadlineShortFont];
