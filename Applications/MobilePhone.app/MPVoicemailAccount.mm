...
{
  accountCopy = account;
  v10 = specialized VoicemailAccount.init(vmAccount:callVoicemailSupported:subscribed:greetingChangeSupported:)(accountCopy, supported, subscribed, changeSupported);
...
{
  selfCopy = self;
  VoicemailAccount.description.getter();
...
LABEL_8:
  ...
  v7 = specialized static VoicemailAccount.== infix(_:_:)(self, v9);
