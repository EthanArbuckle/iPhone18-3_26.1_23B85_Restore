...
{
  v3 = a3;
  v4 = specialized VoicemailAccountManagerDecorator.init(vmd:)(v3);
...
- (void)setGreeting:(id)a3 forAccountUUID:(id)a4 completion:(id)a5
{
  ...
  *(v12 + 16) = v11;
  ...
  v16 = a3;
  v17 = self;
  v15(v16, v10, partial apply for thunk for @escaping @callee_unowned @convention(block) @Sendable (@unowned ObjCBool, @unowned NSError?) -> (), v12, ObjectType, v13);
