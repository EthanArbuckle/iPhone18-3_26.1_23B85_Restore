...
- (void)commonInit;
- (void)configureCellForHighlightingWithText:(id)text;
...
- (void)configureCellForHighlightingWithText:(id)text
{
  ...
  if ([(MPLegacyRecentsTableViewCell *)self isMissedCall])
  {
    ...
    titleLabel2 = [(PHTableViewCell *)self titleLabel];
    textColor = [titleLabel2 textColor];
    v7 = [textColor colorWithAlphaComponent:0.6];
    titleLabel3 = [(PHTableViewCell *)self titleLabel];
    textColor2 = [titleLabel3 textColor];
    v10 = [textColor2 colorWithAlphaComponent:1.0];
    v11 = [text attributedStringToHighlightText:textCopy primaryColour:v7 secondaryColour:v10];
    titleLabel4 = [(PHTableViewCell *)self titleLabel];
    [titleLabel4 setAttributedText:v11];

    titleLabel5 = [(PHTableViewCell *)self titleLabel];
    textColor3 = [titleLabel5 textColor];
    v15 = [textColor3 colorWithAlphaComponent:0.6];
    callerCountLabel = [(MPLegacyRecentsTableViewCell *)self callerCountLabel];
    [callerCountLabel setTextColor:v15];
  }

  else
  {
    v17 = +[UIColor secondaryLabelColor];
    titleLabel6 = [(PHTableViewCell *)self titleLabel];
    [titleLabel6 setTextColor:v17];

    v19 = +[UIColor secondaryLabelColor];
    callerCountLabel2 = [(MPLegacyRecentsTableViewCell *)self callerCountLabel];
    [callerCountLabel2 setTextColor:v19];

    titleLabel5 = [(PHTableViewCell *)self titleLabel];
    textColor3 = [titleLabel5 text];
    v15 = [textColor3 attributedStringToHighlightText:textCopy];
    callerCountLabel = [(PHTableViewCell *)self titleLabel];
    [callerCountLabel setAttributedText:v15];
  }

  subtitleLabel = [(PHTableViewCell *)self subtitleLabel];
  text2 = [subtitleLabel text];
  v23 = [text2 attributedStringToHighlightText:textCopy];
  subtitleLabel2 = [(PHTableViewCell *)self subtitleLabel];
  [subtitleLabel2 setAttributedText:v23];
}
...
- (void)configureGridViewArrangedSubviews
{
  ...
  v106[1] = 3221225472;
  v106[2] = __65__MPLegacyRecentsTableViewCell_configureGridViewArrangedSubviews__block_invoke;
  v106[3] = &unk_100284FD0;
  v106[4] = self;
