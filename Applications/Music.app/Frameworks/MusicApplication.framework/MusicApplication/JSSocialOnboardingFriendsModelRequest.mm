...
- (_TtC16MusicApplicationP33_B8BEB5E19410BDA0BB2B4503F9E0BB4137JSSocialOnboardingFriendsModelRequest)initWithCoder:(id)coder;
...
- (id)newOperationWithResponseHandler:(id)handler
{
  ...
  *(v12 + 5) = v5;
  ...
  [(JSSocialOnboardingFriendsModelRequest *)selfCopy copy];
  sub_ABAB50();
  type metadata accessor for JSSocialOnboardingFriendsModelRequest();
  swift_dynamicCast();
