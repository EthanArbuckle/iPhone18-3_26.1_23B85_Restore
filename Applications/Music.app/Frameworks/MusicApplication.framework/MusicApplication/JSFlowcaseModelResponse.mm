...
- (_TtC16MusicApplication23JSFlowcaseModelResponse)initWithRequest:(id)request;
...
- (id)newOperationForDetailedKeepLocalStatusConfigurationForSectionAtIndex:(int64_t)index responseHandler:(id)handler
{
  ...
  *(v7 + 16) = v6;
  v8 = *&self->MPModelResponse_opaque[OBJC_IVAR____TtC16MusicApplication23JSFlowcaseModelResponse_personalizationResponse];
  v13[4] = sub_AACD4;
  v13[5] = v7;
