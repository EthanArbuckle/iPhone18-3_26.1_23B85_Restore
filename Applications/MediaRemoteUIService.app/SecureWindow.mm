...
- (_TtC20MediaRemoteUIService12SecureWindow)initWithCoder:(id)coder;
- (_TtC20MediaRemoteUIService12SecureWindow)initWithFrame:(CGRect)frame;
- (_TtC20MediaRemoteUIService12SecureWindow)initWithWindowScene:(id)scene;
@end
