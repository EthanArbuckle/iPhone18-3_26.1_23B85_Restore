...
LABEL_15:
  self->_dismissType = *(v4 + 4);
  *&self->_has |= 2u;
  if ((*(v4 + 40) & 0x10) != 0)
  {
LABEL_9:
    self->_visibleMs = *(v4 + 9);
    *&self->_has |= 0x10u;
  }
...
LABEL_29:
  ...
  if ((has & 8) != 0)
  {
    if ((v6 & 8) == 0 || self->_smoothedRSSI != *(v4 + 8))
    {
      goto LABEL_29;
    }
  }
  ...
  if ((has & 2) != 0)
  {
    if ((v6 & 2) == 0 || self->_dismissType != *(v4 + 4))
    {
      goto LABEL_29;
    }
  }
  ...
  if ((has & 0x10) != 0)
  {
    if ((v6 & 0x10) == 0 || self->_visibleMs != *(v4 + 9))
    {
      goto LABEL_29;
    }
...
LABEL_15:
  *(v4 + 4) = self->_dismissType;
  *(v4 + 40) |= 2u;
  if ((*&self->_has & 0x10) != 0)
  {
LABEL_9:
    *(v4 + 9) = self->_visibleMs;
    *(v4 + 40) |= 0x10u;
  }
...
- (id)description
{
  ...
  v4 = [(AWDSharingProximityStatusResult *)self dictionaryRepresentation];
