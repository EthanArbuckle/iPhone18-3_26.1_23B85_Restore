...
LABEL_9:
      ...
      v12 = [v14 localizedStringForKey:@"UNKNOWN_CALLER" value:&stru_10010E930 table:@"PHRecents"];
    }
  }
...
- (void)fetchContactsForHandles:(id)a3
{
  ...
  if ([v6 count])
  {
    ...
    v31 = v15;
    v19 = [v15 contactsForHandles:v18 keyDescriptors:qword_100126988 alwaysUnifyLabeledValues:0];
      ...
      switch(v37)
      {
        ...
        case 1:
          ...
          if (v150 == 1)
          {
            v98 = v36;
            v38 = TUBundle();
            v99 = [v38 localizedStringForKey:@"%@_AND_ONE_OTHER" value:&stru_10010E930 table:@"TelephonyUtilities"];
...
LABEL_65:
    ...
    if (-[PHRecentsController isLocalizedSubtitleUnknown:](self, "isLocalizedSubtitleUnknown:", v15) && [v4 isJunk])
    {
      ...
      v64 = [v63 localizedStringForKey:v62 value:&stru_10010E930 table:@"PHRecents"];
