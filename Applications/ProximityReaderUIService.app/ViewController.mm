...
- (_TtC24ProximityReaderUIService14ViewController)initWithCoder:(id)coder;
- (_TtC24ProximityReaderUIService14ViewController)initWithNibName:(id)name bundle:(id)bundle;
- (void)viewDidLoad;
@end
