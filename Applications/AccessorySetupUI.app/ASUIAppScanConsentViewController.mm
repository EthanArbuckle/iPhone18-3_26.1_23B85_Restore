...
@implementation ASUIAppScanConsentViewController
...
- (void)viewDidLoad
{
  ...
  v2 = v3.receiver;
  [(ASUIAppScanConsentViewController *)&v3 viewDidLoad];
...
- (_TtC16AccessorySetupUI32ASUIAppScanConsentViewController)initWithContentView:(id)view
{
  ...
  *&self->type[OBJC_IVAR____TtC16AccessorySetupUI32ASUIAppScanConsentViewController_router] = 0;
  swift_unknownObjectWeakInit();
  v6 = &self->PRXCardContentViewController_opaque[OBJC_IVAR____TtC16AccessorySetupUI32ASUIAppScanConsentViewController_routingContext];
  *v6 = 0;
  *(v6 + 1) = 0;
  *(v6 + 2) = 1;
  *(v6 + 24) = 0u;
