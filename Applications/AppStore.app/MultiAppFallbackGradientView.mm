...
- (_TtC8AppStore28MultiAppFallbackGradientView)initWithFrame:(CGRect)frame;
- (void)layoutSubviews;
@end
...
- (_TtC8AppStore28MultiAppFallbackGradientView)initWithFrame:(CGRect)frame
{
  ...
  *(&self->super.super.super.super.isa + v9) = [objc_allocWithZone(type metadata accessor for GradientView()) init];
  ...
  v11 = sub_1001ADFA4();
  v12 = *(&height->super.super.super.super.isa + OBJC_IVAR____TtC8AppStore28MultiAppFallbackGradientView_overlayGradientView);
  *(&height->super.super.super.super.isa + OBJC_IVAR____TtC8AppStore28MultiAppFallbackGradientView_overlayGradientView) = v11;
