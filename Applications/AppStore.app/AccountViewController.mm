...
- (void)scrollViewDidEndDragging:(id)a3 willDecelerate:(BOOL)a4
{
  ...
  if (*(&v13->super.super.super.super.super.isa + OBJC_IVAR____TtC8AppStore21AccountViewController_pendingRefresh) != 1 || v4)
  {
  }

  else
  {
    *(&v13->super.super.super.super.super.isa + OBJC_IVAR____TtC8AppStore21AccountViewController_pendingRefresh) = 0;
    v8 = objc_opt_self();
...
- (void)scrollViewDidEndDecelerating:(id)a3
{
  ...
  if (*(&v11->super.super.super.super.super.isa + OBJC_IVAR____TtC8AppStore21AccountViewController_pendingRefresh) == 1)
  {
    *(&v11->super.super.super.super.super.isa + OBJC_IVAR____TtC8AppStore21AccountViewController_pendingRefresh) = 0;
    v6 = objc_opt_self();
...
LABEL_8:
  ...
  *(&v10->super.super.super.super.super.isa + OBJC_IVAR____TtC8AppStore21AccountViewController_pendingRefresh) = 1;
}
