...
- (void)_setContinuousCornerRadius:(double)a3
{
  ...
  [*&v4[OBJC_IVAR____TtC8AppStore35TodayCardMarketingLockupOverlayView_materialBackground] _setCornerRadius:1 continuous:12 maskedCorners:{a3, v5.receiver, v5.super_class}];
}
...
- (void)handleTapWithGestureRecognizer:(id)a3
{
  v5 = self;
  sub_1002F9904(1);
  v3 = *(&v5->super.super.super.super.isa + OBJC_IVAR____TtC8AppStore35TodayCardMarketingLockupOverlayView_clickActionHandler);
  if (v3)
  {
