...
- (_TtC8AppStore28AlertActionTrailingImageView)initWithFrame:(CGRect)frame;
- (void)layoutSubviews;
...
- (void)tintColorDidChange
{
  ...
  v3 = *&v2[OBJC_IVAR____TtC8AppStore28AlertActionTrailingImageView_label];
