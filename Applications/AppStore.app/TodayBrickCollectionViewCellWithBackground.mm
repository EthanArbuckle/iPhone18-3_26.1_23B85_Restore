...
- (void)layoutSubviews
{
  ...
  v3 = *&v2[OBJC_IVAR____TtC8AppStore42TodayBrickCollectionViewCellWithBackground_imageBackgroundView];
  [*&v2[OBJC_IVAR____TtC8AppStore32BaseTodayBrickCollectionViewCell_mainContentView] bounds];
  [v3 setFrame:?];
}
