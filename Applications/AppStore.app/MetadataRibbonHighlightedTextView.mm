...
- (JUMeasurements)measurementsWithFitting:(CGSize)fitting in:(id)in
{
  ...
  v9 = type metadata accessor for MetadataRibbonHighlightedTextViewLayout();
  v10 = *(v9 - 8);
  __chkstk_darwin(v9);
  v12 = v28 - ((v11 + 15) & 0xFFFFFFFFFFFFFFF0);
  v13 = *(&self->super.super.super.isa + OBJC_IVAR____TtC8AppStore33MetadataRibbonHighlightedTextView_descriptionLabel);
  v28[4] = type metadata accessor for DynamicTypeLabel();
  v28[5] = &protocol witness table for UILabel;
  v28[1] = v13;
  (*(v6 + 16))(v8, self + OBJC_IVAR____TtC8AppStore33MetadataRibbonHighlightedTextView_metrics, v5);
