...
- (void)layoutSubviews
{
  ...
  v3 = OBJC_IVAR____TtC8AppStore15VideoMirrorView_videoLayer;
  v4 = *&v2[OBJC_IVAR____TtC8AppStore15VideoMirrorView_videoLayer];
  v5 = OBJC_IVAR____TtC8AppStore10MirrorView_artworkLayer;
  [*&v2[OBJC_IVAR____TtC8AppStore10MirrorView_artworkLayer] bounds];
  [v4 setBounds:?];
  v6 = *&v2[v3];
  [*&v2[v5] position];
  [v6 setPosition:?];
