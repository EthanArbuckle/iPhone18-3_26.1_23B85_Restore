...
- (_TtC8AppStore35TransitioningPresentedContainerView)initWithCoder:(id)coder;
- (_TtC8AppStore35TransitioningPresentedContainerView)initWithFrame:(CGRect)frame;
...
- (_TtC8AppStore35TransitioningPresentedContainerView)initWithFrame:(CGRect)frame
{
  ...
  *(&self->super.super.super.isa + OBJC_IVAR____TtC8AppStore35TransitioningPresentedContainerView_hidesInsertedSubviews) = 0;
  v10.receiver = self;
