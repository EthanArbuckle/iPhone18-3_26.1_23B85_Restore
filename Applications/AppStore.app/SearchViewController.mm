...
- (void)viewWillTransitionToSize:(CGSize)a3 withTransitionCoordinator:(id)a4
{
  ...
  [*&v7[OBJC_IVAR____TtC8AppStore20SearchViewController_searchResultsContainerViewController] viewWillTransitionToSize:a4 withTransitionCoordinator:{width, height, v8.receiver, v8.super_class}];
...
- (void)viewWillLayoutSubviews
{
  ...
  v3 = [*&v2[OBJC_IVAR____TtC8AppStore20SearchViewController_searchController] searchBar];
  [v2 pageMarginInsets];
  [v3 setLayoutMargins:?];
}
