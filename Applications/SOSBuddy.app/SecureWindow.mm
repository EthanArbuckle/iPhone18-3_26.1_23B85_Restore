...
- (_TtC8SOSBuddy12SecureWindow)initWithCoder:(id)coder;
- (_TtC8SOSBuddy12SecureWindow)initWithFrame:(CGRect)frame;
- (_TtC8SOSBuddy12SecureWindow)initWithWindowScene:(id)scene;
@end
