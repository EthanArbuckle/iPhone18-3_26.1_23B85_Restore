...
- (_TtC8SOSBuddy12SecureWindow)initWithCoder:(id)a3;
- (_TtC8SOSBuddy12SecureWindow)initWithFrame:(CGRect)a3;
- (_TtC8SOSBuddy12SecureWindow)initWithWindowScene:(id)a3;
@end
