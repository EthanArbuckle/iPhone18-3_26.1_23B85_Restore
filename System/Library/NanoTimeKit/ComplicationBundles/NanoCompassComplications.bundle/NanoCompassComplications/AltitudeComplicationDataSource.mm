...
+ (BOOL)acceptsComplicationFamily:(int64_t)family forDevice:(id)device
{
  ...
  {
    v12 = objc_msgSend_supportsPolaris(deviceCopy, v9, v10, v11);
    v13 = 0x1CDFu >> family;
    if (family > 0xC)
    {
      LOBYTE(v13) = 0;
...
LABEL_38:
    ...
    switch(v13)
    {
      case 10:
        ...
        objc_msgSend__setMetadataForProvider_withAltitude_privacyEnabled_(self, v89, v22, v12, enabledCopy);
      ...
      case 11:
        ...
        objc_msgSend__setMetadataForProvider_withAltitude_privacyEnabled_(self, v107, v22, v12, enabledCopy);
      ...
      case 12:
        ...
        objc_msgSend__setMetadataForProvider_withAltitude_privacyEnabled_(self, v23, v22, v12, enabledCopy);
...
- (void)_setMetadataForProvider:(id)provider withAltitude:(id)altitude privacyEnabled:(BOOL)enabled
{
  ...
  if (enabledCopy)
  {
    ...
    objc_msgSend_setMetadata_(providerCopy, v16, v15, v17);
...
LABEL_6:
  ...
  objc_msgSend_setMetadata_(providerCopy, v21, v20, v22);
