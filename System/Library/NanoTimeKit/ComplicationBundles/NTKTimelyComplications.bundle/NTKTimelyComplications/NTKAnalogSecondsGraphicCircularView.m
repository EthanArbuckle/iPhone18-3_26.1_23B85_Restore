...
- (void)pauseLiveFullColorImageView
{
  v2 = [(NTKAnalogSecondsGraphicCircularView *)self worldClockCircularView];
...
{
  v6 = a3;
  v7 = [(NTKAnalogSecondsGraphicCircularView *)self worldClockCircularView];
...
{
  v4 = a3;
  v5 = [(NTKAnalogSecondsGraphicCircularView *)self worldClockCircularView];
  [v5 setFilterProvider:v4];
}

- (void)transitionToMonochromeWithFraction:(double)a3
{
  v4 = [(NTKAnalogSecondsGraphicCircularView *)self worldClockCircularView];
...
{
  v3 = a3;
  v4 = [[NTKWorldClockGraphicCircularViewSecondsOnly alloc] initWithDevice:v3 smallTickCount:5];
