...
- (_TtC30NTKParmesanFaceBundleCompanion41ParmesanFacePreviewTitleSupplementaryView)initWithCoder:(id)a3
{
  ...
  *(&self->super.super.super.super.isa + v4) = [objc_allocWithZone(MEMORY[0x277D756B8]) init];
  v5 = OBJC_IVAR____TtC30NTKParmesanFaceBundleCompanion41ParmesanFacePreviewTitleSupplementaryView_subtitleLabel;
  *(&self->super.super.super.super.isa + v5) = [objc_allocWithZone(MEMORY[0x277D756B8]) init];
