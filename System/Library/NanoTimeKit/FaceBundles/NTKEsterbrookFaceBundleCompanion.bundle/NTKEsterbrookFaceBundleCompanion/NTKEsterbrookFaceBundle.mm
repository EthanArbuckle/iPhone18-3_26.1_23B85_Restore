...
- (id)defaultFaceForDevice:(id)a3
{
  ...
  v15 = objc_msgSend_bundledFaceWithIdentifier_analyticsIdentifier_forDevice_initCustomization_(NTKEsterbrookFace, v14, v8, v13, v3, 0);
...
- (id)galleryFacesForDevice:(id)a3
{
  ...
  if (objc_msgSend_isRunningNapiliGMOrLater(v4, v5, v6, v7))
  {
    ...
    v10 = [(NTKFaceBundle *)&v16 galleryFacesForDevice:v4];
  ...
  {
    v13 = objc_msgSend_defaultFaceForDevice_(self, v8, v4, v9);
