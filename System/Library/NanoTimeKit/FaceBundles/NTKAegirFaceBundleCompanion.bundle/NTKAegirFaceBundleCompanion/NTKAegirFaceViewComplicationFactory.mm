...
- (void)configureComplicationView:(id)view forSlot:(id)slot faceView:(id)faceView
{
  ...
  [(NTKAegirFaceViewComplicationFactory *)&v11 configureComplicationView:viewCopy forSlot:slotCopy faceView:faceView];
  if ([slotCopy isEqualToString:NTKComplicationSlotTopRight] && (objc_msgSend(viewCopy, "conformsToProtocol:", &OBJC_PROTOCOL___NTKUtilityComplicationView) & 1) != 0)
  {
    v10 = 0;
LABEL_6:
    [viewCopy setPlacement:v10];
    goto LABEL_7;
  }
...
- (void)loadLayoutRulesForFaceView:(id)view
{
  ...
  [(NTKAegirFaceViewComplicationFactory *)&v25 loadLayoutRulesForFaceView:viewCopy];
  device = [(NTKAegirFaceViewComplicationFactory *)self device];
  v21 = 0u;
  v22 = 0u;
  v23 = 0u;
  v24 = 0u;
  ...
  if (v6)
  {
    ...
    do
    {
      for (i = 0; i != v7; i = i + 1)
      {
        ...
        {
          v14 = [NTKComplicationLayoutRule layoutRuleForDevice:device withReferenceFrame:3 horizontalLayout:3 verticalLayout:1 clip:self->_topComplicationFrame.origin.x, self->_topComplicationFrame.origin.y, self->_topComplicationFrame.size.width, self->_topComplicationFrame.size.height];
          v19 = v13;
          v20 = v14;
          v15 = v14;
