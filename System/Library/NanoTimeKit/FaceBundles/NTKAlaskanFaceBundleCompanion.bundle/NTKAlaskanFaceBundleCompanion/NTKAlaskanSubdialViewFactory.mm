...
- (id)_subdialViewWithOptions:(id)a3 palette:(id)a4 tag:(int64_t)a5
{
  ...
  v12 = [(NTKAlaskanChronoSubdialView *)v11 initWithFrame:v8 options:v7 palette:0.0, 0.0, v15];
...
- (id)_12HoursSubdialView
{
  ...
  [v3 setTicksCount:60];
  [v3 setLargerTicksTestBlock:&stru_38768];
  [v3 setMarkersCount:12];
  [v3 setVisibleMarkersTestBlock:&stru_38788];
...
- (id)_60MinutesSubdialView
{
  ...
  [v3 setMarkersCount:12];
  [v3 setVisibleMarkersTestBlock:&stru_38808];
  [v3 setMarkerTextBlock:&stru_38828];
...
- (id)_30MinutesSubdialView
{
  v3 = [(NTKAlaskanSubdialViewFactory *)self createDefaultOptions];
  [v3 setTicksCount:30];
  [v3 setLargerTicksTestBlock:&stru_38848];
  ...
  sub_297C(v8, v11);
  [v3 setMarkersDiameter:*&v12];
  v9 = [(NTKAlaskanSubdialViewFactory *)self _subdialViewWithOptions:v3 palette:self->_palette tag:30];
...
- (id)_15MinutesSubdialView
{
  ...
  memset(v11, 0, sizeof(v11));
  sub_297C(v8, v11);
  [v3 setMarkersDiameter:*(&v12 + 1)];
  v9 = [(NTKAlaskanSubdialViewFactory *)self _subdialViewWithOptions:v3 palette:self->_palette tag:15];
...
- (id)_3MinutesSubdialView
{
  v3 = [(NTKAlaskanSubdialViewFactory *)self createDefaultOptions];
  [v3 setTicksCount:60];
  [v3 setLargerTicksTestBlock:&stru_388D8];
  [v3 setMarkersCount:12];
  v4 = +[NSMutableDictionary dictionary];
  ...
  v7 = [(NTKAlaskanSubdialViewFactory *)self _subdialViewWithOptions:v3 palette:self->_palette tag:3, v9, v10, v11, v12];
...
- (id)_2MinutesSubdialView
{
  v3 = [(NTKAlaskanSubdialViewFactory *)self createDefaultOptions];
  [v3 setTicksCount:60];
  [v3 setLargerTicksTestBlock:&stru_388F8];
  [v3 setMarkersCount:12];
  v4 = +[NSMutableDictionary dictionary];
  ...
  v6 = v5;
  [v3 setMarkerTextBlock:&v9];
  v7 = [(NTKAlaskanSubdialViewFactory *)self _subdialViewWithOptions:v3 palette:self->_palette tag:2, v9, v10, v11, v12];
...
- (id)_60secondsSubdialView
{
  v3 = [(NTKAlaskanSubdialViewFactory *)self createDefaultOptions];
  [v3 setTicksCount:60];
  [v3 setLargerTicksTestBlock:&stru_38918];
  [v3 setMarkersCount:12];
  [v3 setVisibleMarkersTestBlock:&stru_38938];
  [v3 setMarkerTextBlock:&stru_38958];
...
- (id)createDefaultOptions
{
  ...
  v6 = [(NTKAlaskanSubdialViewFactory *)self markersFont];
