...
- (id)unsafeDailySnapshotKey
{
  ...
  unsafeDailySnapshotKey = [(NTKTroutFace *)&v6 unsafeDailySnapshotKey];
  ...
  {
    v3 = [unsafeDailySnapshotKey stringByAppendingString:@".trout"];
  }
...
- (unint64_t)_numberOfOptionsForCustomEditMode:(int64_t)mode slot:(id)slot
{
  slot = [(NTKTroutFace *)self _optionClassForCustomEditMode:mode, slot];
  device = [(NTKTroutFace *)self device];
...
{
  optionCopy = option;
  v8 = [(NTKTroutFace *)self _optionClassForCustomEditMode:mode];
  device = [(NTKTroutFace *)self device];
...
- (id)_optionAtIndex:(unint64_t)index forCustomEditMode:(int64_t)mode slot:(id)slot
{
  v7 = [(NTKTroutFace *)self _optionClassForCustomEditMode:mode];
  device = [(NTKTroutFace *)self device];
