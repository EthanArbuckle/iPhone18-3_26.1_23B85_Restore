...
- (NTKGalleonDegreeDialView)initWithDevice:(id)device;
...
- (void)setChevronAndLabelOpacity:(double)opacity
{
  ...
  objc_msgSend_setAlpha_(labelView, v7, v8, v9, opacity);
}

- (void)galleon_setHeading:(double)heading
{
  v5 = heading / -180.0 * 3.14159265;
...
{
  paletteCopy = palette;
  v34 = objc_msgSend_outerDegreeLabelColor(paletteCopy, v5, v6, v7);
  objc_msgSend_setTintColor_(self->_labelTickView, v8, v34, v9);
  v13 = objc_msgSend_outerCompassMajorTickColor(paletteCopy, v10, v11, v12);
  objc_msgSend_setTintColor_(self->_labelView, v14, v13, v15);
  v19 = objc_msgSend_outerCompassMinorTickColor(paletteCopy, v16, v17, v18);
  objc_msgSend_setTintColor_(self->_minorTickView, v20, v19, v21);
  v25 = objc_msgSend_outerCompassMedialTickColor(paletteCopy, v22, v23, v24);
  objc_msgSend_setTintColor_(self->_majorTickView, v26, v25, v27);
  v31 = objc_msgSend_compassChevronColor(paletteCopy, v28, v29, v30);
...
+ (id)_newLabelViewWithDevice:(id)device
{
  ...
  _NTKGalleonLayoutConstants(deviceCopy, v45);
