...
- (void)updateViewStateProperties
{
  ...
  -[ICNoteResultsListCollectionViewCell setIsInSplitView:](self, "setIsInSplitView:", [v7 _splitViewControllerContext] == &dword_0 + 3);
...
- (void)updateBackgroundConfigurationUsingState:(id)a3
{
  ...
  v4 = ;
  if ([v10 cellDropState] == &dword_0 + 2)
  {
    [v10 setCellDropState:1];
    [v10 setFocused:0];
  }
  ...
  v9 = [v4 updatedConfigurationForState:v10];
...
- (void)updateColorsUsingState:(id)a3
{
  ...
  if ([v4 cellDropState] == &dword_0 + 2 || objc_msgSend(v4, "cellDropState") == &dword_0 + 1)
  {
...
- (void)updateLabelsFromConfiguration
{
  ...
  if (v20)
  {
    ...
    v49 = [(ICNoteResultsListCollectionViewCell *)self folderLabelImageView];
    [v49 setHidden:1];
LABEL_22:
  }
}
