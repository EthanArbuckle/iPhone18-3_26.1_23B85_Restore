...
- (void)performWithCompletion:(id)a3
{
  ...
  if (![(NSString *)self->_requestAceHash length])
  {
    ...
    v7 = sub_233505670(@"Set Repeat Mode", v6);
  ...
  v15 = [(MPAssistantSetRepeatMode *)self hashedRouteUIDs];
  sub_2335057BC(@"Set Repeat Mode", v14, v15);

  v16 = [(MPAssistantSetRepeatMode *)self repeatMode];
  LOBYTE(v15) = [v16 isEqualToString:*MEMORY[0x277D486F8]];
  ...
  else
  {
    ...
    v19 = [v18 isEqualToString:*MEMORY[0x277D48708]];
    ...
    else
    {
      ...
      v21 = [v20 isEqualToString:*MEMORY[0x277D48700]];
  ...
  v26 = [MEMORY[0x277D27850] nowPlayingApplicationDestination];
