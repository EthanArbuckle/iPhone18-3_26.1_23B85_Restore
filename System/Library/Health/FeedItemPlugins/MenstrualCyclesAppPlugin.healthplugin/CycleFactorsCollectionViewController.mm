...
- (_TtC24MenstrualCyclesAppPlugin36CycleFactorsCollectionViewController)initWithCoder:(id)coder;
- (_TtC24MenstrualCyclesAppPlugin36CycleFactorsCollectionViewController)initWithCollectionViewLayout:(id)layout;
- (_TtC24MenstrualCyclesAppPlugin36CycleFactorsCollectionViewController)initWithNibName:(id)name bundle:(id)bundle;
- (void)viewDidLoad;
@end
