@interface ListCell
- (_TtC24MenstrualCyclesAppPlugin8ListCell)initWithCoder:(id)coder;
- (_TtC24MenstrualCyclesAppPlugin8ListCell)initWithFrame:(CGRect)frame;
@end
...
- (_TtC24MenstrualCyclesAppPlugin8ListCell)initWithFrame:(CGRect)frame
{
  ...
  *(v9 + 4) = 0;
  ...
  v12 = *((*MEMORY[0x29EDCA1E8] & height->super.super.super.super.super.super.super.isa) + 0x60);
  v13 = height;
  v12();
