...
- (FitnessPlusEntityWrapper)initWithCoder:(id)coder
{
  ...
  if (decodeDataObject)
  {
    ...
    isa = sub_748A8().super.isa;
    v11 = [(FitnessPlusEntityWrapper *)self initWithData:isa];
    sub_FB28(v7, v9);
...
- (FitnessPlusEntityWrapper)initWithData:(id)data
{
  ...
  v8 = (self + OBJC_IVAR___FitnessPlusEntityWrapper_serializedEntity);
  *v8 = v5;
  v8[1] = v7;
  v10.receiver = self;
  v10.super_class = type metadata accessor for FitnessPlusPropertyRecordEntity.EntityWrapper();
  return [(FitnessPlusEntityWrapper *)&v10 init];
}

- (id)data
{
  v2 = *(&self->super.isa + OBJC_IVAR___FitnessPlusEntityWrapper_serializedEntity);
  v3 = *&self->serializedEntity[OBJC_IVAR___FitnessPlusEntityWrapper_serializedEntity];
  sub_398C(v2, v3);
...
- (int64_t)encodedByteCount
{
  v2 = *(self + OBJC_IVAR___FitnessPlusEntityWrapper_serializedEntity);
  v3 = *(self + OBJC_IVAR___FitnessPlusEntityWrapper_serializedEntity + 8);
  v4 = v3 >> 62;
  if ((v3 >> 62) <= 1)
  {
    if (!v4)
