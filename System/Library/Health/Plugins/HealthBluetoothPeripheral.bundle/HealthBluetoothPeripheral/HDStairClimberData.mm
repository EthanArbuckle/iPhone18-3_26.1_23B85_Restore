...
- (id)description
{
  ...
  isSet2 = [(HDFitnessMachineCharacteristicField *)self->_stepsPerMinuteField isSet];
  if (isSet2)
  {
  ...
  isSet3 = [(HDFitnessMachineCharacteristicField *)self->_averageStepRateField isSet];
  if (isSet3)
  {
  ...
  isSet4 = [(HDFitnessMachineCharacteristicField *)self->_positiveElevationGainField isSet];
  if (isSet4)
  {
  ...
  isSet5 = [(HDFitnessMachineCharacteristicField *)self->_stepCountField isSet];
  if (isSet5)
  {
