...
- (HDClinicalIngestionTaskAccountContext)initWithIngestionTask:(id)a3 account:(id)a4 queryMode:(int64_t)a5 ingestStartDate:(id)a6 didSaveResourcesHandler:(id)a7;
...
- (HDClinicalIngestionTaskAccountContext)initWithIngestionTask:(id)a3 account:(id)a4 queryMode:(int64_t)a5 ingestStartDate:(id)a6 didSaveResourcesHandler:(id)a7
{
  ...
  if (v17)
  {
    ...
    v29 = [v14 identifier];
    v30 = [NSString stringWithFormat:@"IngestionQueue-%@", v29];
...
LABEL_13:
        ...
        v15 = [v14 atLeastOneFetchSucceeded];
        v11 = [v15 BOOLValue];
      }
...
LABEL_23:
  ...
  if (os_log_type_enabled(HKLogHealthRecords, OS_LOG_TYPE_DEFAULT))
  {
    ...
    v17 = v7;
    v18 = [(HDClinicalAccount *)account identifier];
    *buf = 138543874;
    v30 = self;
    v31 = 2114;
    v32 = v18;
...
- (void)saveResourceObjects:(id)a3
{
  ...
  if ([v4 count])
  {
    ...
    if (account)
    {
      (*(self->_didSaveResourcesHandler + 2))(self->_didSaveResourcesHandler, [v4 count]);
    }
    ...
    else
    {
      ...
      if (os_log_type_enabled(HKLogHealthRecords, OS_LOG_TYPE_ERROR))
      {
        v9 = self->_account;
        v10 = v8;
        v11 = [(HDClinicalAccount *)v9 identifier];
        *buf = 138543874;
        v14 = self;
        v15 = 2114;
        v16 = v11;
...
- (void)runAndAwaitFeatureOperations:(id)a3
{
  ...
  if (os_log_type_enabled(HKLogHealthRecords, OS_LOG_TYPE_DEFAULT))
  {
    account = self->_account;
    v7 = v6;
    v9 = [(HDClinicalAccount *)account identifier];
    v10 = 138543874;
    v11 = self;
    v12 = 2114;
    v13 = v9;
...
- (void)didEncounterErrors:(id)a3
{
  v4 = a3;
  os_unfair_lock_lock(&self->_accumulatedErrorLock);
  [(NSMutableArray *)self->_mutableAccumulatedErrors addObjectsFromArray:v4];
  [(HDClinicalIngestionTaskAccountContext *)self _withLock_evaluateNewErrors:v4];
