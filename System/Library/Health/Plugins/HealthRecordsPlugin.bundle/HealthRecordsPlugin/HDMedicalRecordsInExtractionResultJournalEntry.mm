...
- (HDMedicalRecordsInExtractionResultJournalEntry)initWithCoder:(id)coder;
- (HDMedicalRecordsInExtractionResultJournalEntry)initWithExtractionResult:(id)result accountIdentifier:(id)identifier;
  ...
  if (v7)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        v25 = 0;
        v18 = [HDMedicalRecordEntity processMedicalRecordsInExtractionResult:extractionResult accountIdentifier:accountIdentifier2 profile:profileCopy error:&v25];
        v19 = v25;
...
LABEL_18:
    ...
    extractionResult = [(HDMedicalRecordsInExtractionResultJournalEntry *)v7 extractionResult];
    if (extractionResult == extractionResult)
    {
      goto LABEL_9;
    }

    extractionResult2 = [(HDMedicalRecordsInExtractionResultJournalEntry *)v7 extractionResult];
...
LABEL_17:
    ...
    extractionResult3 = [(HDMedicalRecordsInExtractionResultJournalEntry *)v7 extractionResult];
    if ([(HDExtractionResult *)v12 isEqual:extractionResult3])
    {
LABEL_9:
      accountIdentifier = self->_accountIdentifier;
      accountIdentifier = [(HDMedicalRecordsInExtractionResultJournalEntry *)v7 accountIdentifier];
      ...
      {
        accountIdentifier2 = [(HDMedicalRecordsInExtractionResultJournalEntry *)v7 accountIdentifier];
        if (accountIdentifier2)
        {
          v18 = accountIdentifier2;
          v19 = self->_accountIdentifier;
          accountIdentifier3 = [(HDMedicalRecordsInExtractionResultJournalEntry *)v7 accountIdentifier];
