...
LABEL_18:
    ...
    v11 = [(HDClinicalRecordsInExtractionResultJournalEntry *)v7 extractionResult];
    if (!v11)
    {
      v13 = 0;
LABEL_17:
    ...
    v8 = [(HDClinicalRecordsInExtractionResultJournalEntry *)v7 extractionResult];
    if ([(HDExtractionResult *)v12 isEqual:v8])
    {
LABEL_9:
      clinicalExternalID = self->_clinicalExternalID;
      v15 = [(HDClinicalRecordsInExtractionResultJournalEntry *)v7 clinicalExternalID];
      v16 = v15;
      if (clinicalExternalID == v15)
      {
      ...
      {
        v17 = [(HDClinicalRecordsInExtractionResultJournalEntry *)v7 clinicalExternalID];
        if (v17)
        {
          v18 = v17;
...
- (HDClinicalRecordsInExtractionResultJournalEntry)initWithCoder:(id)a3
{
  ...
  v6 = [v4 decodeObjectOfClass:objc_opt_class() forKey:@"clinicalExternalID"];
  v7 = v6;
  if (v5)
  {
    v8 = v6 == 0;
