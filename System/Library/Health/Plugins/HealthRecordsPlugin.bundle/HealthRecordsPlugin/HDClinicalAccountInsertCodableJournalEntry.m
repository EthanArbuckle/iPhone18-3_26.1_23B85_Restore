    ...
    *&v8 = 138543618;
    ...
    do
    {
      for (i = 0; i != v9; i = i + 1)
      {
        ...
        v12 = *(*(&v21 + 1) + 8 * i);
        v13 = [v12 codableAccounts];
        v14 = [v12 syncProvenance];
        v20 = 0;
        v15 = [HDClinicalAccountEntity _insertCodableAccounts:v13 syncProvenance:v14 profile:v6 error:&v20];
        v16 = v20;
...
- (HDClinicalAccountInsertCodableJournalEntry)initWithCoder:(id)a3
{
  ...
  v7 = [v4 decodeObjectOfClasses:v6 forKey:@"codableAccounts"];
  if (v7 && ([v4 containsValueForKey:@"syncProvenance"] & 1) != 0)
  {
    v13.receiver = self;
    v13.super_class = HDClinicalAccountInsertCodableJournalEntry;
    v8 = [(HDClinicalAccountInsertCodableJournalEntry *)&v13 initWithCoder:v4];
    if (v8)
    {
      v9 = [v7 copy];
...
{
  v4 = a3;
  v5 = [(HDClinicalAccountInsertCodableJournalEntry *)self codableAccounts];
  [v4 encodeObject:v5 forKey:@"codableAccounts"];

  [v4 encodeInteger:-[HDClinicalAccountInsertCodableJournalEntry syncProvenance](self forKey:{"syncProvenance"), @"syncProvenance"}];
  v6.receiver = self;
