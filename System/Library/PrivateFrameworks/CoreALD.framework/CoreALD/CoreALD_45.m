uint64_t sub_244CBD04C()
{
  v1 = v0 ^ 0x1B72u;
  v2 = (STACK[0x1CE8] & 1) == 0;
  STACK[0x2620] = v1;
  return (*(STACK[0x2678] + 8 * ((((v1 - 19141) ^ (v0 - 20493)) * v2) ^ v0)))();
}

uint64_t sub_244CBD090()
{
...
uint64_t sub_244CBD68C()
{
  LODWORD(STACK[0x1710]) = (v2 - 1943781845) ^ v1;
  STACK[0x24F8] = v0 ^ 0xF893436FC8E4D3AELL;
  return (*(STACK[0x2678] + 8 * ((((v2 ^ 0x46D7) - 1229) * (STACK[0x1B50] & 1)) ^ v2)))();
}

uint64_t sub_244CBD6E8()
{
  ...
  LODWORD(STACK[0x1F28]) = 0;
  LODWORD(STACK[0x1C28]) = 0;
  v2 = v0 ^ 0x8C247BF2 ^ (157 * (v0 < 0xB4A671AE));
  v3 = v0 + 1943785432;
  v4 = v1 ^ LODWORD(STACK[0xA08]);
  STACK[0x2620] = v3;
  v5 = v4 ^ v3 ^ 0xFFFFFFC8;
  LODWORD(STACK[0xCEC]) = v4 ^ 0x27;
  LOBYTE(STACK[0xFB2F]) = v4 ^ 0x27;
  v6 = *(STACK[0x2678] + 8 * v2);
  STACK[0x23A0] = STACK[0x25C8];
  LODWORD(STACK[0x20F8]) = 801165310;
...
uint64_t sub_244CBDE44()
{
  ...
  LODWORD(STACK[0x1E90]) = 0;
  LODWORD(STACK[0x1C38]) = 0;
  v2 = v1 ^ LODWORD(STACK[0x157C]);
  LOBYTE(STACK[0x129D5]) = v1 ^ LOBYTE(STACK[0x157C]) ^ 0x92;
  v3 = v1 ^ 0x2C;
  v4 = v0 ^ 0xF893436FC8E4D3AELL;
  v5 = v2 ^ 0x60;
  v6 = *(STACK[0x2678] + 8 * ((STACK[0x2620] - 746694967) ^ 0xD37EA62E ^ (1186 * (STACK[0x2620] != 142006718))));
  STACK[0x23A0] = STACK[0x25C8];
  STACK[0x24F8] = v4;
  LODWORD(STACK[0x20F8]) = 801165506;
  LODWORD(STACK[0x1714]) = v5;
...
uint64_t sub_244CBE558()
{
  ...
  LODWORD(STACK[0x1C38]) = 0;
  v2 = (v0 + 15163) | 0xF80u;
  v3 = v1 ^ LODWORD(STACK[0x1390]);
  LODWORD(STACK[0xD14]) = v3 ^ 0xFFFFFFFD;
  LOBYTE(STACK[0xFB06]) = v3 ^ 0xFD;
  v4 = *(STACK[0x2678] + 8 * v0);
  STACK[0x2620] = v2;
  LODWORD(STACK[0x1718]) = (v2 - 13) ^ v3;
  STACK[0x23A0] = STACK[0x25C8];
  LODWORD(STACK[0x20F8]) = 801165419;
  LODWORD(STACK[0x1CBC]) = 1;
  LODWORD(STACK[0x25F8]) = 1;
  LODWORD(STACK[0x25E8]) = 1;
  LODWORD(STACK[0x25B0]) = 1;
...
uint64_t sub_244CBEC98@<X0>(unsigned int a1@<W8>)
{
  LODWORD(STACK[0x24C0]) = 0;
  LODWORD(STACK[0x1C50]) = 0;
  LODWORD(STACK[0x1F30]) = 0;
  ...
  v6 = a1 ^ 0x4B47;
  STACK[0x2620] = v6;
  HIDWORD(v4) = (v6 + 115) ^ v5;
  LODWORD(v4) = (v5 ^ 0xC0) << 24;
  v7 = -93 * ((v4 >> 28) ^ 0xFFFFFF80) - ((70 * ((v4 >> 28) ^ 0xFFFFFF80)) & 0xFFFFFF98) + 76;
  LODWORD(STACK[0x1714]) = v7;
  LODWORD(STACK[0xC80]) = v7 ^ 0xFFFFFF81;
  LOBYTE(STACK[0xFAF5]) = v7 ^ 0x81;
  v8 = *(STACK[0x2678] + 8 * a1);
  STACK[0x23A0] = STACK[0x25C8];
  STACK[0x24F8] = v1 ^ 0xF893436FC8E4D3AELL;
  LODWORD(STACK[0x1710]) = v2 ^ 0x2C;
  LODWORD(STACK[0x20F8]) = 801165281;
  LODWORD(STACK[0x1968]) = 1;
  LODWORD(STACK[0x25F8]) = 1;
  LODWORD(STACK[0x25E8]) = 1;
  LODWORD(STACK[0x25B0]) = 1;
...
uint64_t sub_244CBF474@<X0>(int a1@<W8>)
{
  LODWORD(STACK[0x25F8]) = 0;
  LODWORD(STACK[0x25D0]) = 0;
  LODWORD(STACK[0x24C0]) = 0;
  ...
  LODWORD(STACK[0x1E90]) = 0;
  LODWORD(STACK[0x1C38]) = 0;
  v2 = v1 ^ LODWORD(STACK[0x14F8]);
  HIDWORD(v3) = v2 ^ 0xC;
  LODWORD(v3) = (v2 ^ 0x20) << 24;
  LOBYTE(v2) = v3 >> 29;
  v4 = LOBYTE(STACK[0x11FCB]);
  HIDWORD(v3) = v4 ^ 0xC;
  LODWORD(v3) = (v4 ^ 0x40) << 24;
  LOBYTE(v2) = *(STACK[0x2660] + (v2 ^ 0x69));
  STACK[0x2620] = (a1 + 8607);
  LOBYTE(STACK[0x12999]) = ((v2 ^ (a1 - 97) ^ 0xF7) - 63) ^ 0xB4;
  v5 = *(STACK[0x2640] + ((v3 >> 29) ^ 0xC7));
  HIDWORD(v3) = v5 ^ 4;
  LODWORD(v3) = (v5 ^ 0xC0) << 24;
  v6 = -93 * ((v3 >> 28) ^ 0xFFFFFF80);
  HIDWORD(v3) = v6 ^ 0xFFFFFFFD;
  LODWORD(v3) = (v6 ^ 0x20) << 24;
  v7 = *(STACK[0x2670] + ((v3 >> 29) ^ 0xB1)) ^ 0x10;
  LODWORD(STACK[0x1718]) = -93 * v7 - ((70 * v7) & 0xFFFFFF98) + 76;
  v8 = *(STACK[0x2678] + 8 * a1);
  STACK[0x23A0] = STACK[0x25C8];
  LODWORD(STACK[0x20F8]) = 801165565;
  LODWORD(STACK[0x1F50]) = 1;
  LODWORD(STACK[0x25E8]) = 1;
  LODWORD(STACK[0x25B0]) = 1;
  LODWORD(STACK[0x24D0]) = 1;
...
uint64_t sub_244CBFB4C@<X0>(int a1@<W8>)
{
  STACK[0x24F8] = v1 ^ 0xF893436FC8E4D3AELL;
  LODWORD(STACK[0x1710]) = v2 ^ ((a1 - 16280) | 0x4D4) ^ 0xFFFFFFFA;
  return (*(STACK[0x2678] + 8 * (((a1 - 16239) * (STACK[0x19C0] & 1)) ^ a1)))();
}

uint64_t sub_244CBFBAC@<X0>(int a1@<W8>)
{
  LODWORD(STACK[0x24C0]) = 0;
  LODWORD(STACK[0x1C50]) = 0;
  LODWORD(STACK[0x1F30]) = 0;
  ...
  LODWORD(STACK[0x1E90]) = 0;
  LODWORD(STACK[0x1C38]) = 0;
  v2 = v1 ^ LODWORD(STACK[0xC80]);
  LOBYTE(STACK[0x129BC]) = v2 ^ 0x87;
  v3 = a1 - 15044;
  v4 = (a1 - 15385) | 0x4C10u;
  STACK[0x2620] = v4;
  LODWORD(STACK[0x1714]) = v2 ^ v4 ^ 0xFFFFFFF1;
  v5 = *(STACK[0x2678] + 8 * v3);
  STACK[0x23A0] = STACK[0x25C8];
  LODWORD(STACK[0x20F8]) = 801165482;
  LODWORD(STACK[0x2300]) = 1;
  LODWORD(STACK[0x25F8]) = 1;
  LODWORD(STACK[0x25E8]) = 1;
  LODWORD(STACK[0x25B0]) = 1;
