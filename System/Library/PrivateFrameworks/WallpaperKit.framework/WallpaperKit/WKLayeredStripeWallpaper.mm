...
- (WKLayeredStripeWallpaper)initWithIdentifier:(int64_t)identifier name:(id)name backgroundColor:(id)color stripeAngleDegrees:(double)degrees stripeHeightFactor:(double)factor firstStripeOffsetScaleFactor:(double)scaleFactor;
...
- (WKLayeredStripeWallpaper)initWithIdentifier:(int64_t)identifier name:(id)name backgroundColor:(id)color stripeAngleDegrees:(double)degrees stripeHeightFactor:(double)factor firstStripeOffsetScaleFactor:(double)scaleFactor
{
  ...
  v15 = [(WKAbstractWallpaper *)&v19 initWithIdentifier:identifier name:name type:5 representedType:5 backingType:1];
  if (v15)
  {
    v16 = [[WKLayeredStripeWallpaperInput alloc] initWithBackgroundColor:colorCopy stripeAngleDegrees:degrees stripeHeightFactor:factor firstStripeOffsetScaleFactor:scaleFactor];
...
- (id)copyWithZone:(_NSZone *)zone
{
  ...
  wallpaperValue = [(WKLayeredStripeWallpaper *)self wallpaperValue];
  backgroundColor = [wallpaperValue backgroundColor];
  wallpaperValue2 = [(WKLayeredStripeWallpaper *)self wallpaperValue];
  [wallpaperValue2 stripeAngleDegrees];
  v11 = v10;
  wallpaperValue3 = [(WKLayeredStripeWallpaper *)self wallpaperValue];
  [wallpaperValue3 stripeHeightFactor];
  v14 = v13;
  wallpaperValue4 = [(WKLayeredStripeWallpaper *)self wallpaperValue];
  [wallpaperValue4 firstStripeOffsetScaleFactor];
  v17 = [v4 initWithIdentifier:identifier name:name backgroundColor:backgroundColor stripeAngleDegrees:v11 stripeHeightFactor:v14 firstStripeOffsetScaleFactor:v16];
...
- (id)propertyListRepresentation
{
  v19.receiver = self;
  v19.super_class = WKLayeredStripeWallpaper;
  propertyListRepresentation = [(WKAbstractWallpaper *)&v19 propertyListRepresentation];
  ...
  wallpaperValue = [(WKLayeredStripeWallpaper *)self wallpaperValue];
  backgroundColor = [wallpaperValue backgroundColor];
  wk_colorHexString = [backgroundColor wk_colorHexString];
  [v5 na_safeSetObject:wk_colorHexString forKey:@"backgroundColor"];
