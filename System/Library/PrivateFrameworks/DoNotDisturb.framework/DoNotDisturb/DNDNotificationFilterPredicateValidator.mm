...
- (BOOL)validatePredicate:(id)predicate compileTimeIssues:(id *)issues runTimeIssues:(id *)timeIssues
{
  ...
  {
    v17 = 0;
    v12 = [MEMORY[0x277CCAAB0] archivedDataWithRootObject:predicateCopy requiringSecureCoding:1 error:&v17];
    v13 = v17;
    v11 = 0;
...
LABEL_9:
  ...
  expressionCopy = [MEMORY[0x277CCACA8] stringWithFormat:v5, expressionCopy];
  compileTimeIssues = self->_compileTimeIssues;
