...
- (id)descriptionWithLevel:(int)a3
{
  ...
  if (shouldPrintSensitiveData())
  {
    ...
    if (activityLevel)
    {
      ...
      {
        v18 = off_1E7C941E8[activityLevel - 1];
      }
    ...
    if (self->_operatingSystemVersion.majorVersion)
    {
      ...
      patchVersion = self->_operatingSystemVersion.patchVersion;
      v64 = v6;
      v49 = RPNSOperatingSystemVersionToString(&v62);
      NSAppendPrintF();
      v33 = v64;
...
LABEL_28:
  ...
  {
    [(IDSDevice *)v8 operatingSystemVersion];
    v28 = RPModelOSVersionToSourceVersionString(v10, &v46);
  }
...
LABEL_25:
    ...
    RPStringToOperatingSystemVersion(v28, &v38);
...
LABEL_26:
  ...
  RPStringToOperatingSystemVersion(v30, &v38);
...
LABEL_107:
  ...
  v109 = vandq_s8(vshlq_u32(vdupq_n_s32(v130), xmmword_1B6F2E1F0), xmmword_1B6F2E200);
