...
void __54__SCKOperationThrottler_initWithDelegate_updateQueue___block_invoke(uint64_t a1)
{
  ...
  if (WeakRetained)
  {
    ...
    __54__SCKOperationThrottler_initWithDelegate_updateQueue___block_invoke_2(v4, v3);
...
void __54__SCKOperationThrottler_initWithDelegate_updateQueue___block_invoke_2(id *a1, void *a2)
{
  ...
  if (WeakRetained)
  {
    ...
    __54__SCKOperationThrottler_initWithDelegate_updateQueue___block_invoke_3(v6, v5);
...
- (void)dealloc
{
  ...
  v3.receiver = self;
  v3.super_class = SCKOperationThrottler;
