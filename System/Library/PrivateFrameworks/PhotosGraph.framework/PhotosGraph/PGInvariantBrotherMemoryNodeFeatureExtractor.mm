...
- (PGInvariantBrotherMemoryNodeFeatureExtractor)initWithError:(id *)error
{
  ...
  v17.receiver = self;
  v17.super_class = PGInvariantBrotherMemoryNodeFeatureExtractor;
  v14 = [(PGGraphMemoryNodeFeatureExtractor *)&v17 initWithName:@"BROTHER" featureNames:v4 relation:v13 labelForTargetBlock:&__block_literal_global_7_38146];
