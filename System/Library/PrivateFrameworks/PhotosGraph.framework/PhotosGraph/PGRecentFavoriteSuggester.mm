...
LABEL_44:
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *&v50[8] = 2112;
      *&v50[10] = v11;
      _os_log_impl(&dword_22F0FC000, v19, OS_LOG_TYPE_DEFAULT, "Recent Favorite: Computing eligible favorited assets between %@ and %@", buf, 0x16u);
    }

    v20 = [MEMORY[0x277CCAC30] predicateWithFormat:@"favorite == YES"];
    v21 = [objc_opt_class() noVideoPredicate];
    v42 = [objc_opt_class() internalPredicateForProcessedAssetsWithMinimumSceneAnalysisVersion:1];
    v43 = v21;
    v44 = v20;
    v22 = [objc_alloc(MEMORY[0x277CBEB18]) initWithObjects:{v20, v21, v42, 0}];
    if (v10)
    {
      v23 = [MEMORY[0x277CCAC30] predicateWithFormat:@"dateCreated >= %@", v10];
      [v22 addObject:v23];
    }

    if (v11)
    {
      v24 = [MEMORY[0x277CCAC30] predicateWithFormat:@"dateCreated <= %@", v11];
      [v22 addObject:v24];
    }

    if (v12)
    {
      v25 = [MEMORY[0x277CCAC30] predicateWithFormat:@"uuid == %@", v12];
      [v22 addObject:v25];
    }
    ...
    v31 = [v18 curationContext];
    v32 = [v30 clsAllAssetsFromFetchResult:v46 prefetchOptions:v29 curationContext:v31];
...
- (void)reset
{
  ...
  {
    *v6 = 0;
    _os_log_impl(&dword_22F0FC000, v4, OS_LOG_TYPE_DEFAULT, "Recent Favorite: Resetting", v6, 2u);
  }
...
- (id)nextSuggestionWithProgress:(id)a3
{
  ...
  {
    LOWORD(v22) = 0;
    _os_log_impl(&dword_22F0FC000, v6, OS_LOG_TYPE_DEFAULT, "Recent Favorite: nextSuggestion", &v22, 2u);
  }
  ...
  if (!suggestedAssetEnumerator)
  {
    ...
    if (!suggestedAssets)
    {
      ...
      v11 = [(PGRecentFavoriteSuggester *)self favoritedAssetsBetweenStartDate:v9 andEndDate:v10 matchingAssetUUID:0 progress:v4];
  ...
  if (v16 && (v17 = [[PGSingleAssetSuggestion alloc] initWithType:3 subtype:301 asset:v16]) != 0)
  {
    v18 = v17;
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_DEFAULT))
    {
      v22 = 138477827;
      v23 = v18;
      _os_log_impl(&dword_22F0FC000, v6, OS_LOG_TYPE_DEFAULT, "Recent Favorite: Suggesting %{private}@", &v22, 0xCu);
    }
  }
  ...
  else
  {
    ...
    {
      LOWORD(v22) = 0;
      _os_log_impl(&dword_22F0FC000, v6, OS_LOG_TYPE_DEFAULT, "Recent Favorite: Nothing to suggest", &v22, 2u);
    }
...
- (void)startSuggestingWithOptions:(id)a3
{
  ...
  {
    *v10 = 0;
    _os_log_impl(&dword_22F0FC000, v6, OS_LOG_TYPE_DEFAULT, "Recent Favorite: Starting suggesting", v10, 2u);
  }
...
- (BOOL)canGenerateSuggestionWithAsset:(id)a3 onDate:(id)a4
{
  v5 = a3;
  v6 = [v5 uuid];
  v7 = [(PGRecentFavoriteSuggester *)self favoritedAssetsBetweenStartDate:0 andEndDate:0 matchingAssetUUID:v6 progress:&__block_literal_global];
...
- (id)suggestionsWithOptions:(id)a3 progress:(id)a4
{
  ...
  if (!v6 || (v7 = CFAbsoluteTimeGetCurrent(), v7 - v51[3] < 0.01) || (v51[3] = v7, v49 = 0, (*(v6 + 2))(v6, &v49, 0.0), v8 = *(v55 + 24) | v49, *(v55 + 24) = v8, (v8 & 1) == 0))
  {
    ...
    v37 = [v39 universalStartDate];
    v11 = [v39 universalEndDate];
    ...
    v34 = v11;
    v36 = [(PGRecentFavoriteSuggester *)self favoritedAssetsBetweenStartDate:v37 andEndDate:v11 matchingAssetUUID:0 progress:v44];
    if (*(v55 + 24) == 1)
    {
      if (os_log_type_enabled(MEMORY[0x277D86220], OS_LOG_TYPE_INFO))
      {
...
LABEL_10:
    ...
    else
    {
      ...
      if ([v36 count])
      {
        v16 = [(PGRecentFavoriteSuggester *)self suggestedAssetsInAssets:v36 options:v39];
        v17 = [v39 maximumNumberOfSuggestions];
        v33 = self;
        if (v17)
        {
          v18 = v17;
          ...
          while (2)
          {
            for (i = 0; i != v19; ++i)
            {
              ...
              if (v26)
              {
                ...
                {
                  v27 = [(PGRecentFavoriteSuggester *)v33 reasonsForSuggestion:v26];
