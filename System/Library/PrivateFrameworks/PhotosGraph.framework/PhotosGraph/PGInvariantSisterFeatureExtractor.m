...
- (PGInvariantSisterFeatureExtractor)initWithError:(id *)a3
{
  ...
  v16.receiver = self;
  v16.super_class = PGInvariantSisterFeatureExtractor;
  v13 = [(PGGraphFeatureExtractor *)&v16 initWithName:@"SISTER" featureNames:v4 relation:v12 labelForTargetBlock:&__block_literal_global_39927];
