...
- (PGInvariantDaughterFeatureExtractor)initWithError:(id *)a3
{
  ...
  v16.receiver = self;
  v16.super_class = PGInvariantDaughterFeatureExtractor;
  v13 = [(PGGraphFeatureExtractor *)&v16 initWithName:@"DAUGHTER" featureNames:v4 relation:v12 labelForTargetBlock:&__block_literal_global_41301];
