...
- (PGInvariantFatherMemoryNodeFeatureExtractor)initWithError:(id *)error;
@end
...
- (PGInvariantFatherMemoryNodeFeatureExtractor)initWithError:(id *)error
{
  ...
  v17.receiver = self;
  v17.super_class = PGInvariantFatherMemoryNodeFeatureExtractor;
  v14 = [(PGGraphMemoryNodeFeatureExtractor *)&v17 initWithName:@"FATHER" featureNames:v4 relation:v13 labelForTargetBlock:&__block_literal_global_7_69202];
