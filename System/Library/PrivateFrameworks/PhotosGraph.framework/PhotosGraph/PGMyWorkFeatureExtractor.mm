...
- (PGMyWorkFeatureExtractor)initWithError:(id *)a3
{
  ...
  v16.receiver = self;
  v16.super_class = PGMyWorkFeatureExtractor;
  v13 = [(PGGraphFeatureExtractor *)&v16 initWithName:@"MyWork" featureNames:v4 relation:v12 labelForTargetBlock:&__block_literal_global_8348];
