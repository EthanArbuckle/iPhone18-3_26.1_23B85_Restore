...
- (PGInvariantCoworkerFeatureExtractor)initWithError:(id *)error
{
  ...
  v16.receiver = self;
  v16.super_class = PGInvariantCoworkerFeatureExtractor;
  v13 = [(PGGraphFeatureExtractor *)&v16 initWithName:v4 featureNames:v5 relation:v12 labelForTargetBlock:&__block_literal_global_22163];
