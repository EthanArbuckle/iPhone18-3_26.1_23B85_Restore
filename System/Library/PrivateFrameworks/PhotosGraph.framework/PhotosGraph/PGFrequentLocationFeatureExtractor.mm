...
- (PGFrequentLocationFeatureExtractor)initWithGraph:(id)graph error:(id *)error;
@end
...
- (PGFrequentLocationFeatureExtractor)initWithGraph:(id)graph error:(id *)error
{
  ...
  v7 = [(PGGraphNodeCollection *)PGGraphFrequentLocationNodeCollection nodesInGraph:graphCopy];
