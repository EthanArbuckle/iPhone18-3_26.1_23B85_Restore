...
- (id)_generateErrorWithErrorCode:(int64_t)a3 message:(id)a4 underlyingError:(id)a5
{
  ...
  v11 = [MEMORY[0x277CCA9B8] errorWithDomain:@"com.apple.PhotosGraph.PGFeatureExtractorPCAPrint" code:a3 userInfo:v10];
...
- (id)featureValuesForAssets:(id)a3 error:(id *)a4
{
  ...
  if (a4)
  {
    *a4 = [(PGFeatureExtractorPCAPrint *)self _generateErrorWithErrorCode:0 message:@"PGFingerprintVersionAssetPrintTypeScene2048 print is deprecated. Use PGFingerprintVersionAssetPrintTypeSceneCLIP768 instead." underlyingError:0];
  }
...
- (id)floatVectorWithEntity:(id)a3 error:(id *)a4
{
  ...
  v9 = [(PGFeatureExtractorPCAPrint *)self featureValuesForAssets:v8 error:a4, v14, v15];
