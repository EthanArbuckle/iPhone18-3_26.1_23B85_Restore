...
- (PGInvariantMotherFeatureExtractor)initWithError:(id *)a3
{
  ...
  v16.receiver = self;
  v16.super_class = PGInvariantMotherFeatureExtractor;
  v13 = [(PGGraphFeatureExtractor *)&v16 initWithName:@"MOTHER" featureNames:v4 relation:v12 labelForTargetBlock:&__block_literal_global_45376];
