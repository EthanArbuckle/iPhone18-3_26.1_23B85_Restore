...
- (id)description
{
  ...
  v4 = [(MOContextStringFeedback *)self stringIdentifier];
  v5 = [(MOContextStringFeedback *)self textString];
  v6 = [(MOContextStringFeedback *)self timestamp];
  v7 = [(MOContextStringFeedback *)self score];
  v8 = [(MOContextStringFeedback *)self describeFeedbackMode];
  v9 = [(MOContextStringFeedback *)self describeUsageFeedback];
