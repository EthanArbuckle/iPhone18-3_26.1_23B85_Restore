...
+ (id)createPredicateWithLeftExpression:(id)a3 rightExpression:(id)a4 operation:(unint64_t)a5
{
  v7 = a4;
  v8 = a3;
  v9 = +[NSComparisonPredicate predicateWithLeftExpression:rightExpression:modifier:type:options:](NSComparisonPredicate, "predicateWithLeftExpression:rightExpression:modifier:type:options:", v8, v7, 0, [objc_opt_class() predicateOperatorFromType:a5], 0);
...
+ (id)createPredicateForValue:(id)a3 inCollection:(id)a4
{
  ...
  v8 = [NSExpression expressionForKeyPath:v6];

  v9 = [NSExpression expressionForConstantValue:v5];
          ...
          if (v15)
          {
            ...
            do
            {
              for (i = 0; i != v16; i = i + 1)
              {
                ...
                [a1 inspectExpression:*(*(&v23 + 1) + 8 * i)];
              }
        ...
        if (v8)
        {
          ...
          do
          {
            for (j = 0; j != v9; j = j + 1)
            {
              ...
              [a1 inspectExpression:*(*(&v19 + 1) + 8 * j)];
            }
    ...
    if (v14)
    {
      ...
      do
      {
        ...
        do
        {
          ...
          [a1 disassemblePredicate:*(*(&v18 + 1) + 8 * v17)];
          v17 = v17 + 1;
        }
...
LABEL_3:
    ...
    while (1)
    {
      ...
      if (objc_opt_isKindOfClass())
      {
        ...
        v27 = [a1 extractFirstValueForKeyPath:v31 fromPredicates:v25];
