...
- (unsigned)APSInterfaceToAONInterface:(int64_t)a3;
- (unsigned)PCAddressFamilyToAONAddressFamily:(int)a3;
- (void)offloadKeepAlive:(int64_t)a3;
...
- (void)sendAPOriginatedKeepAlive:(int64_t)a3;
- (void)stopOffloading;
@end
...
- (void)stopOffloading
{
  ...
  {
    v5 = v4;
    v6 = [(APSConnectionOffloader *)self APSInterfaceToAONInterface:v3, v11, v12, v13, v14, v15, v16];
    v7 = 0;
    v8 = 1;
    do
    {
      v9 = v8;
      v10 = [(APSConnectionOffloader *)self PCAddressFamilyToAONAddressFamily:v7, v11, v12, v13, v14, v15, v16];
...
- (void)reportOffloadEvents:(const aonmicroapsd_telemetryeventrecord_v_s *)a3 droppedEvents:(aonmicroapsd_droppedtelemetryeventcount_s *)a4
{
  v6 = [(APSConnectionOffloader *)self metricDelegate];
  v7 = *a4;
