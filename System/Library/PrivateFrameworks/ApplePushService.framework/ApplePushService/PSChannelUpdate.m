...
{
  v7.receiver = self;
  v7.super_class = PSChannelUpdate;
  v3 = [(PSChannelUpdate *)&v7 description];
  v4 = [(PSChannelUpdate *)self dictionaryRepresentation];
...
LABEL_13:
  ...
  if (*&self->_has)
  {
    if ((*(v4 + 28) & 1) == 0 || self->_checkpoint != *(v4 + 1))
    {
      goto LABEL_13;
    }
...
- (void)mergeFrom:(id)a3
{
  ...
  {
    v6 = v4;
    [(PSChannelUpdate *)self setChannelId:?];
    v4 = v6;
  }
