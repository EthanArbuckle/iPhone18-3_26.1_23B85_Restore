...
- (AVTCameraItemView)initWithFrame:(CGRect)a3
{
  ...
  v3 = [(AVTCameraItemView *)&v24 initWithFrame:a3.origin.x, a3.origin.y, a3.size.width, a3.size.height];
  v4 = v3;
  if (v3)
  {
...
- (void)updateCameraImage
{
  ...
  v8 = [v12 isEqualToConfiguration:v7];
  ...
  if ((v8 & 1) == 0)
  {
    ...
    v11 = [(AVTCameraItemView *)self imageView];
    [(AVTCameraItemView *)self bounds];
    [v11 setFrame:?];
  }
}
