...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    v5 = [(GCGenericDeviceDataMultiplyExpressionModel *)self leftExpression];
    v6 = [v4 leftExpression];
    if ([v5 isEqual:v6])
    {
      v7 = [(GCGenericDeviceDataMultiplyExpressionModel *)self rightExpression];
...
- (id)description
{
  ...
  v4 = [(GCGenericDeviceDataMultiplyExpressionModel *)self leftExpression];
  v5 = [v4 description];
...
- (id)debugDescription
{
  ...
  v6 = [(GCGenericDeviceDataMultiplyExpressionModel *)self leftExpression];
  v7 = [v6 debugDescription];
  v8 = [v7 stringByReplacingOccurrencesOfString:@"\n" withString:@"\n\t"];
  v9 = [(GCGenericDeviceDataMultiplyExpressionModel *)self rightExpression];
...
- (id)buildExpressionWithContext:(id)a3 error:(id *)a4
{
  ...
  v8 = [(GCGenericDeviceDataMultiplyExpressionModel *)self leftExpression];
  v9 = v8;
  if (v7)
  {
    v40 = 0;
  ...
  if (v12)
  {
    ...
    v16 = [(GCGenericDeviceDataMultiplyExpressionModel *)self rightExpression];
    v17 = v16;
    if (v15)
    {
      v38 = 0;
...
- (id)buildReactiveExpressionWithContext:(id)a3 consumer:(id)a4 error:(id *)a5
{
  ...
  {
    v10 = [(GCGenericDeviceDataMultiplyExpressionModel *)self leftExpression];
    v11 = v39;
