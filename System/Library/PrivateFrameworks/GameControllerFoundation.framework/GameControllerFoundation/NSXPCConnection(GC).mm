...
- (id)gc_peerBundleIdentifier
{
  ...
  if (!v1 || (v2 = SecTaskCopyValueForEntitlement(v1, @"application-identifier", 0)) == 0 || (v3 = v2, *token.val = 0, CopyBundleIdentifierAndTeamFromApplicationIdentifier(v2, &token, 0), CFRelease(v3), (bundleIdentifier = *token.val) == 0))
  {
