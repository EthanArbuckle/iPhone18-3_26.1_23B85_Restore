...
- (SFMessage)initWithCoder:(id)a3
{
  ...
  if (v5)
  {
    ...
    {
      v7 = [v4 decodeObjectOfClass:objc_opt_class() forKey:@"bodyData"];
      bodyData = v5->_bodyData;
      v5->_bodyData = v7;
    }

    v9 = [v4 containsValueForKey:@"deviceIDs"];
    v10 = 0x1E696A000uLL;
    ...
    if (v9)
    {
      ...
      v15 = [v4 decodeObjectOfClasses:v14 forKey:@"deviceIDs"];
      objc_opt_class();
    ...
    if ([v4 containsValueForKey:@"headerFields"])
    {
      ...
      v28 = [v4 decodeObjectOfClasses:v27 forKey:@"headerFields"];
    ...
    {
      v32 = *(v10 + 4016);
      v33 = [v4 decodeObjectOfClass:objc_opt_class() forKey:@"identifier"];
    ...
    {
      v35 = [v4 decodeObjectOfClass:objc_opt_class() forKey:@"peerDevice"];
