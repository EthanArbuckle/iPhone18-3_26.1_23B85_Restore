...
- (id)predictionFromFeatures:(id)a3 error:(id *)a4
{
  ...
  v9 = [(Te_c3seuakuh8 *)self predictionFromFeatures:v7 options:v8 error:a4];
...
- (id)predictionFromFeatures:(id)a3 options:(id)a4 error:(id *)a5
{
  ...
  if (v11)
  {
    ...
    v15 = [(Te_c3seuakuh8Output *)v12 initWithRHYTHM_TYPE_HEAD_FC_1_fully_connected_BiasAdd:v14];
  }
...
{
  v6 = a3;
  v7 = [[Te_c3seuakuh8Input alloc] initWithPlaceholder:v6];

  v8 = [(Te_c3seuakuh8 *)self predictionFromFeatures:v7 error:a4];
