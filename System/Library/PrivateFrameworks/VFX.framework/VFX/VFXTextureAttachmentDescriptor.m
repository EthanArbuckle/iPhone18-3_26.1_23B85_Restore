...
- (BOOL)isEqual:(id)a3
{
  ...
  if (v8 != objc_msgSend_width(a3, v9, v10, v11))
  {
    return 0;
  }

  v15 = objc_msgSend_height(self, v12, v13, v14);
  if (v15 != objc_msgSend_height(a3, v16, v17, v18))
  {
    return 0;
  }

  v22 = objc_msgSend_pixelFormat(self, v19, v20, v21);
  if (v22 != objc_msgSend_pixelFormat(a3, v23, v24, v25))
  {
    return 0;
  }

  v29 = objc_msgSend_arrayLength(self, v26, v27, v28);
  return v29 == objc_msgSend_arrayLength(a3, v30, v31, v32);
}
