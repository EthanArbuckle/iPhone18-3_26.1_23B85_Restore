@interface VFXModel
+ (VFXModel)modelWithGeometry:(id)a3;
...
+ (VFXModel)modelWithModelRef:(__CFXModel *)a3;
...
+ (id)presentationModelWithModelRef:(__CFXModel *)a3;
...
- (VFXModel)initWithModelRef:(__CFXModel *)a3;
- (VFXWorld)world;
...
- (id)identifier;
- (id)initPresentationModelWithModelRef:(__CFXModel *)a3;
- (id)interleavedCopy;
...
- (void)_setModelRef:(__CFXModel *)a3;
...
- (void)setModelRef:(__CFXModel *)a3;
- (void)setName:(id)a3;
...
+ (VFXModel)modelWithGeometry:(id)a3
{
  ...
  objc_msgSend_setGeometry_(v4, v5, a3, v6);
...
+ (VFXModel)modelWithModelRef:(__CFXModel *)a3
{
  ...
  {
    v6 = [a1 alloc];
    v9 = objc_msgSend_initWithModelRef_(v6, v7, a3, v8);
...
- (void)setGeometry:(id)a3
{
  ...
  if (geometry != a3)
  {
    ...
    if (a3)
    {
      ...
      if (v12)
      {
        objc_msgSend_addWorldReference_(v9, v10, v12, v11);
      }
...
- (void)setModelRef:(__CFXModel *)a3
{
  if (self->_model != a3)
  {
    objc_msgSend__setModelRef_(self, a2, a3, v3);
    objc_msgSend__recreateMeshFromPresentation(self, v5, v6, v7);
  ...
  MEMORY[0x1EEE66B58](self, sel__resetMaterialsFromPresentation, a3, v3);
}
...
+ (id)presentationModelWithModelRef:(__CFXModel *)a3
{
  ...
  v9 = objc_alloc(*v5);
  inited = objc_msgSend_initPresentationModelWithModelRef_(v9, v10, a3, v11);
...
- (BOOL)getBoundingBoxMin:(VFXModel *)self max:(SEL)a2
{
  ...
  if (!v6 || (*(self + 16) & 1) != 0)
  {
    v8 = objc_msgSend_geometry(self, a2, v2, v3);
...
- (void)_setupObjCModelFrom:(id)a3
{
  ...
  v14 = objc_msgSend_levelsOfDetail(a3, v8, v9, v10);
  objc_msgSend_setLevelsOfDetail_(self, v15, v14, v16);
  v20 = objc_msgSend_materials(a3, v17, v18, v19);
  objc_msgSend_setMaterials_(self, v21, v20, v22);
  v26 = objc_msgSend_edgeCreasesSource(a3, v23, v24, v25);
  objc_msgSend_setEdgeCreasesSource_(self, v27, v26, v28);
  v32 = objc_msgSend_edgeCreasesElement(a3, v29, v30, v31);
  objc_msgSend_setEdgeCreasesElement_(self, v33, v32, v34);
  v38 = objc_msgSend_subdivisionLevel(a3, v35, v36, v37);
  objc_msgSend_setSubdivisionLevel_(self, v39, v38, v40);
  v44 = objc_msgSend_wantsAdaptiveSubdivision(a3, v41, v42, v43);
  objc_msgSend_setWantsAdaptiveSubdivision_(self, v45, v44, v46);
  v50 = objc_msgSend__subdivisionSettings(a3, v47, v48, v49);
  objc_msgSend_set_subdivisionSettings_(self, v51, v50, v52);
  objc_msgSend__copyAnimationsFrom_(self, v53, a3, v54);
  objc_msgSend__copyBindingsFrom_(self, v55, a3, v56);
  ...
  v63 = objc_msgSend_tessellator(a3, v60, v61, v62);
...
- (void)_copyAttributesTo:(id)a3
{
  ...
  objc_msgSend_copyShaderModifiersAndLanguageVersionFrom_(a3, v11, self, v12);
}

- (void)copyTo:(id)a3 withContext:(id)a4
{
  v60[1] = *MEMORY[0x1E69E9840];
  objc_msgSend__setupObjCModelFrom_(a3, a2, self, a4);
  if (objc_msgSend_behaviorGraph(self, v7, v8, v9))
  {
    ...
    objc_msgSend_setBehaviorGraph_(a3, v18, v17, v19);
  ...
  objc_msgSend__copyAttributesTo_(self, v10, a3, v12);
  ...
  if (v44)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        v50 = sub_1AF2BED30(*(*(&v54 + 1) + 8 * v49), a4);
  ...
  objc_msgSend_setMaterials_(a3, v45, v42, v46);
}
...
- (void)enumerateReferencesForOperation:(int64_t)a3 usingBlock:(id)a4
{
  ...
  v19 = 0u;
  v20 = 0u;
  v6 = objc_msgSend_materials(self, a2, a3, a4);
  ...
  if (geometry)
  {
    ...
    v16[3] = &unk_1E7A7C0C8;
    v16[4] = self;
    (*(a4 + 2))(a4, geometry, 1, v16);
  }

  behaviorGraph = self->_behaviorGraph;
  if (behaviorGraph)
  {
    (*(a4 + 2))(a4, behaviorGraph, 0, 0);
  }

  objc_msgSend_enumerateAnimationReferencesUsingBlock_(self, behaviorGraph, a4, v9);
}
...
- (id)_materialWithName:(id)a3
{
  ...
  v21 = 0u;
  v22 = 0u;
  v5 = objc_msgSend_materials(self, a2, a3, v3, 0);
...
LABEL_3:
  ...
  while (1)
  {
    ...
    if (objc_msgSend_isEqualToString_(v15, v16, a3, v17))
    {
      return v14;
    }
...
- (id)materialWithName:(id)a3
{
  result = objc_msgSend__materialWithName_(self, a2, a3, v3);
  if (*(self + 16))
  {
...
- (void)insertObject:(id)a3 inMaterialsAtIndex:(unint64_t)a4
{
  ...
  objc_msgSend_insertObject_atIndex_(self->_materials, a2, a3, a4);
  world = self->_world;
  if (world)
  {
    objc_msgSend_addWorldReference_(a3, v14, world, v15);
  }
...
- (void)removeObjectFromMaterialsAtIndex:(unint64_t)a3
{
  if (objc_msgSend_count(self->_materials, a2, a3, v3) <= a3)
  {
    v8 = sub_1AF0D5194();
  ...
  if (self->_world)
  {
    v14 = objc_msgSend_objectAtIndex_(self->_materials, v6, a3, v7);
    objc_msgSend_removeWorldReference_(v14, v15, self->_world, v16);
  }

  objc_msgSend_removeObjectAtIndex_(self->_materials, v6, a3, v7);
...
- (void)replaceObjectInMaterialsAtIndex:(unint64_t)a3 withObject:(id)a4
{
  ...
  if (world)
  {
    objc_msgSend_addWorldReference_(a4, v14, world, v15);
    v19 = objc_msgSend_objectAtIndex_(self->_materials, v17, a3, v18);
    objc_msgSend_removeWorldReference_(v19, v20, self->_world, v21);
  }

  objc_msgSend_replaceObjectAtIndex_withObject_(self->_materials, v14, a3, a4);
}
...
- (void)setFirstMaterial:(id)a3
{
  v6 = objc_msgSend_materials(self, a2, a3, v3);
  ...
  if (a3)
  {
    if (v10)
    {
      ...
      MEMORY[0x1EEE66B58](self, sel_replaceObjectInMaterialsAtIndex_withObject_, 0, a3);
    }

    else
    {

      objc_msgSend_insertMaterial_atIndex_(self, v11, a3, 0);
    }
  }
...
{
  v6 = objc_msgSend_materials(self, a2, a3, v3);
  v9 = objc_msgSend_indexOfObject_(v6, v7, a3, v8);
...
- (void)replaceMaterial:(id)a3 with:(id)a4
{
  v7 = objc_msgSend_materials(self, a2, a3, a4);
  v10 = objc_msgSend_indexOfObject_(v7, v8, a3, v9);
  if (v10 != 0x7FFFFFFFFFFFFFFFLL)
  {

    MEMORY[0x1EEE66B58](self, sel_replaceObjectInMaterialsAtIndex_withObject_, v10, a4);
  }
}
...
- (void)setMaterials:(id)a3
{
  objc_msgSend_removeAllMaterials(self, a2, a3, v3);
  ...
  if (v10)
  {
    ...
    while (2)
    {
      ...
      do
      {
        ...
        if (objc_msgSend_hasPrefix_(a3, v18, v17, v19))
        {
          v21 = objc_msgSend_length(v17, v11, v20, v12);
          v25 = objc_msgSend_length(a4, v22, v23, v24);
          v27 = objc_msgSend_substringWithRange_(a4, v26, v21, v25 - v21);
...
- (id)copyAnimationChannelForKeyPath:(id)a3 animation:(id)a4
{
  ...
  v74 = 0;
  v75 = 0;
  sub_1AF3716AC(a3, &v75, &v74, v7);
  v72 = 0;
  v73 = 0;
  if (objc_msgSend_parseSpecialKey_withPath_intoDestination_remainingPath_(self, v8, v75, a3, &v72, &v73))
  {
    v11 = objc_msgSend_copyAnimationChannelForKeyPath_animation_(v72, v9, v73, a4);
    if (v11)
    {
  ...
  if ((objc_opt_respondsToSelector() & 1) != 0 && (v27 = objc_msgSend_copyAnimationChannelForKeyPath_animation_(v72, v24, v74, a4)) != 0)
  {
  ...
  else
  {
    ...
    {
      os_unfair_lock_lock(&self->_valuesForUndefinedKeysLock);
      v41 = objc_msgSend_objectForKey_(self->_valuesForUndefinedKeys, v39, a3, v40);
      os_unfair_lock_unlock(&self->_valuesForUndefinedKeysLock);
      if (!v41)
      {
        v43 = sub_1AF290E58(a4);
        if (v43)
        {
          ...
          if (v51)
          {
            ...
            objc_msgSend_setValue_forUndefinedKey_(self, v61, v47, a3);
          ...
          else
          {
            ...
            objc_msgSend_setValue_forUndefinedKey_(self, v68, v47, a3);
    ...
    return sub_1AF291EF0(self, a3, v25, v26);
  }
...
- (void)setLevelsOfDetail:(id)a3
{
  ...
  if (levelsOfDetail != a3)
  {
    ...
    self->_levelsOfDetail = objc_msgSend_copy(a3, v8, v9, v10);
    v13 = objc_msgSend_sortedArrayUsingComparator_(a3, v11, &unk_1F24EC058, v12);
...
- (void)setTessellator:(id)a3
{
  ...
  if (tessellator != a3)
  {
    ...
    MEMORY[0x1EEE66B58](v7, sel_addClient_, self, v8);
  }
}
...
LABEL_5:
    ...
    if (objc_msgSend_primitiveType(a3, a2, a3, v3) == 2)
    {
      edgeCreasesElement = self->_edgeCreasesElement;
      goto LABEL_5;
    }
...
LABEL_5:
    ...
    v9 = objc_msgSend_semantic(a3, a2, a3, v3);
...
- (void)setValue:(id)a3 forUndefinedKey:(id)a4
{
  if (objc_msgSend_hasPrefix_(a4, a2, @"materials[", a4))
  {
    v10 = 0;
    if (objc_msgSend_parseSpecialKey_withPath_intoDestination_remainingPath_(self, v7, a4, a4, &v10, 0) && v10)
    {
      if (a3)
      {
        objc_msgSend_replaceMaterial_with_(self, v8, v10, a3);
      }
  ...
  else
  {
    ...
    objc_msgSend__shadableSetValue_forUndefinedKey_(self, v7, a3, a4);
  }
}
...
- (id)valueForUndefinedKey:(id)a3
{
  if (*(self + 16))
  {
    ...
    v10 = sub_1AF16E3F4(self->_model, a3);
    v7 = v10;
    if (v10)
    {
    ...
    v16 = sub_1AF1DB6D0(&self->_model->var0.var0.var0, a3, 0);
    if (v16)
    {
      v17 = v16;
  ...
  v30 = 0;
  v28 = 0;
  sub_1AF3716AC(a3, &v29, &v28, v3);
  if (objc_msgSend_parseSpecialKey_withPath_intoDestination_remainingPath_(self, v6, v29, a3, &v30, 0))
  {
    return v30;
  }

  os_unfair_lock_lock(&self->_valuesForUndefinedKeysLock);
  v27 = objc_msgSend_objectForKey_(self->_valuesForUndefinedKeys, v25, a3, v26);
  os_unfair_lock_unlock(&self->_valuesForUndefinedKeysLock);
  return v27;
}
...
- (void)_customEncodingOfVFXModel:(id)a3
{
  ...
  if (v6)
  {
    v7 = objc_msgSend_valueWithVFXFloat3_(MEMORY[0x1E696B098], a2, a3, v3, *v6);
  ...
  sub_1AF2C1024(a3, self->_geometry);
  os_unfair_lock_lock(&self->_valuesForUndefinedKeysLock);
  valuesForUndefinedKeys = self->_valuesForUndefinedKeys;
  if (valuesForUndefinedKeys)
  {
    objc_msgSend_encodeObject_forKey_(a3, v14, valuesForUndefinedKeys, @"valuesForUndefinedKeys");
  }
...
- (void)_customDecodingOfVFXModel:(id)a3
{
  ...
  {
    v9 = objc_opt_class();
    v11 = objc_msgSend_decodeObjectOfClass_forKey_(a3, v10, v9, @"fixedBoundingBoxExtrema[0]");
    objc_msgSend_VFXFloat3Value(v11, v12, v13, v14);
    v38 = v15;
    v16 = objc_opt_class();
    v18 = objc_msgSend_decodeObjectOfClass_forKey_(a3, v17, v16, @"fixedBoundingBoxExtrema[1]");
    objc_msgSend_VFXFloat3Value(v18, v19, v20, v21);
    v39 = v22;
    objc_msgSend_setBoundingBoxMin_max_(self, v23, &v38, &v39);
  }

  v24 = sub_1AF2C10E0(a3, v6, v7, v8);
  objc_msgSend_setGeometry_(self, v25, v24, v26);
  v27 = MEMORY[0x1E695DFD8];
  v28 = objc_opt_class();
  v31 = objc_msgSend_setWithObject_(v27, v29, v28, v30);
  v32 = sub_1AF373968();
  v34 = objc_msgSend_vfx_decodeDictionaryWithKeysOfClasses_objectsOfClasses_forKey_(a3, v33, v31, v32, @"valuesForUndefinedKeys");
...
- (void)encodeWithCoder:(id)a3
{
  ...
  objc_msgSend__customEncodingOfVFXModel_(self, a2, a3, v3);
  materials = self->_materials;
  if (materials)
  {
    objc_msgSend_encodeObject_forKey_(a3, v6, materials, @"materials");
  }

  levelsOfDetail = self->_levelsOfDetail;
  if (levelsOfDetail)
  {
    objc_msgSend_encodeObject_forKey_(a3, v6, levelsOfDetail, @"levelsOfDetail");
  }
  ...
  {
    objc_msgSend_encodeObject_forKey_(a3, v10, edgeCreasesSource, @"edgeCreasesSource");
  }

  edgeCreasesElement = self->_edgeCreasesElement;
  if (edgeCreasesElement)
  {
    objc_msgSend_encodeObject_forKey_(a3, v10, edgeCreasesElement, @"edgeCreasesElement");
  }

  shadableHelper = self->_shadableHelper;
  if (shadableHelper)
  {
    objc_msgSend_encodeObject_forKey_(a3, v10, shadableHelper, @"shadableHelper");
  }

  objc_msgSend_encodeBytes_length_forKey_(a3, v10, &self->_subdivisionSettings, 4, @"subdivisionSettings");
  name = self->_name;
  if (name)
  {
    objc_msgSend_encodeObject_forKey_(a3, v14, name, @"name");
  }

  sub_1AF372440(a3, self, name, v15);
  sub_1AF3728B4(a3, self, v17, v18);
  tessellator = self->_tessellator;

  objc_msgSend_encodeObject_forKey_(a3, v19, tessellator, @"tessellator");
}
...
- (VFXModel)initWithCoder:(id)a3
{
  ...
  if (v7)
  {
    ...
    *(v7 + 40) = 0;
    objc_msgSend__customDecodingOfVFXModel_(v7, v18, a3, v19);
    v20 = objc_opt_class();
    v22 = objc_msgSend_vfx_decodeArrayOfObjectsOfClass_containingNestedContainersForKey_(a3, v21, v20, @"materials");
    objc_msgSend_setMaterials_(v7, v23, v22, v24);
    v25 = objc_opt_class();
    v27 = objc_msgSend_vfx_decodeArrayOfObjectsOfClass_forKey_(a3, v26, v25, @"levelsOfDetail");
    objc_msgSend_setLevelsOfDetail_(v7, v28, v27, v29);
    v32 = objc_msgSend_decodeIntegerForKey_(a3, v30, @"subdivisionLevel", v31);
    objc_msgSend_setSubdivisionLevel_(v7, v33, v32, v34);
    v37 = objc_msgSend_decodeBoolForKey_(a3, v35, @"wantsAdaptiveSubdivision", v36);
    objc_msgSend_setWantsAdaptiveSubdivision_(v7, v38, v37, v39);
    v40 = objc_opt_class();
    v42 = objc_msgSend_decodeObjectOfClass_forKey_(a3, v41, v40, @"edgeCreasesSource");
    objc_msgSend_setEdgeCreasesSource_(v7, v43, v42, v44);
    v45 = objc_opt_class();
    v47 = objc_msgSend_decodeObjectOfClass_forKey_(a3, v46, v45, @"edgeCreasesElement");
    objc_msgSend_setEdgeCreasesElement_(v7, v48, v47, v49);
    v50 = objc_opt_class();
    v52 = objc_msgSend_decodeObjectOfClass_forKey_(a3, v51, v50, @"shadableHelper");
    *(v7 + 15) = v52;
    ...
    v71 = 0;
    v57 = objc_msgSend_decodeBytesForKey_returnedLength_(a3, v56, @"subdivisionSettings", &v71);
    if (v71 == 4)
    {
      *(v7 + 97) = *v57;
    }
    ...
    v58 = objc_opt_class();
    v60 = objc_msgSend_decodeObjectOfClass_forKey_(a3, v59, v58, @"name");
    objc_msgSend_setName_(v7, v61, v60, v62);
    *(v7 + 14) = 0;
    sub_1AF37249C(a3, v7);
    sub_1AF372B94(a3, v7);
    v63 = objc_opt_class();
    v65 = objc_msgSend_decodeObjectOfClass_forKey_(a3, v64, v63, @"tessellator");
...
+ (VFXModel)modelWithSources:(id)a3 elements:(id)a4
{
  v5 = objc_msgSend_meshWithSources_elements_(VFXMesh, a2, a3, a4);
...
+ (VFXModel)modelWithSources:(id)a3 elements:(id)a4 sourceChannels:(id)a5
{
  v6 = objc_msgSend_meshWithSources_elements_sourceChannels_(VFXMesh, a2, a3, a4, a5);
...
- (id)modelSourcesForSemantic:(id)a3
{
  v5 = objc_msgSend_mesh(self, a2, a3, v3);

  return objc_msgSend_meshSourcesForSemantic_(v5, v6, a3, v7);
}
...
- (id)modelElementAtIndex:(int64_t)a3
{
  ...
  return objc_msgSend_meshElementAtIndex_(v5, v6, a3, v7);
}
...
+ (VFXModel)modelWithMDLMesh:(id)a3 submesh:(id)a4 options:(id)a5
{
  ...
  if (a3 && a4)
  {
    if (objc_msgSend_indexCount(a4, a2, a3, a4))
    {
      v9 = objc_alloc_init(MEMORY[0x1E695DF70]);
      v10 = objc_alloc_init(MEMORY[0x1E695DF70]);
      v11 = objc_alloc_init(MEMORY[0x1E695DF70]);
      v12 = objc_alloc_init(MEMORY[0x1E695DF70]);
      v15 = objc_msgSend_modelElementWithMDLSubmesh_(VFXMeshElement, v13, a4, v14);
      if (v15)
      {
      ...
      if (v19)
      {
        v22 = objc_msgSend_materialWithMDLMaterial_options_(VFXMaterial, v20, v19, a5);
        if (v22)
        {
      ...
      v59 = v60;
      v60[0] = 0;
      sub_1AF2F4F6C(a4, &v61, &v59, v21);
      sub_1AF2F5118(v11, v12, a3, a5);
      v57 = 0;
      v58 = 0;
      sub_1AF2F533C(v11, &v59, a3, v24);
...
+ (VFXModel)modelWithMDLMesh:(id)a3
{
  ...
  return objc_msgSend_modelWithMDLMesh_options_context_(a1, v6, a3, 0, v7);
}
...
+ (VFXModel)modelWithMDLMesh:(id)a3 options:(id)a4 context:(id)a5
{
  ...
  v163 = 0u;
  v153 = a3;
  v10 = objc_msgSend_submeshes(a3, v7, v8, v9);
...
LABEL_15:
          ...
          v29 = objc_msgSend_materialWithMDLMaterial_options_(VFXMaterial, v23, v26, a4);
          if (v29)
          {
            if (v28)
            {
...
LABEL_20:
  v31 = v148;
  v32 = v153;
  sub_1AF2F5118(v148, obj, v153, a4);
  v158 = 0;
  v159 = 0;
  sub_1AF2F533C(v148, &v164, v153, v33);
  sub_1AF2F54E4(&v167, &v159, &v158, v34);
  v38 = objc_msgSend_submeshes(v153, v35, v36, v37);
  if (objc_msgSend_count(v38, v39, v40, v41))
  {
    ...
    while (1)
    {
      v47 = objc_msgSend_vertexDescriptor(v153, v42, v43, v44, v148);
      ...
      v59 = objc_msgSend_vertexDescriptor(v153, v55, v56, v57);
    ...
    if (v86)
    {
      ...
      do
      {
        for (j = 0; j != v86; ++j)
        {
          ...
          v94 = objc_msgSend_submeshes(v153, v91, v92, v93);
          ...
          {
            v108 = objc_msgSend_submeshes(v153, v105, v106, v107);
...
+ (id)morpherWithMDLMesh:(id)a3
{
  ...
  v5 = objc_msgSend_vertexDescriptor(a3, a2, a3, v3);
  ...
  if (objc_msgSend_count(v6, v14, v15, v16))
  {
    ...
    if (v41)
    {
      ...
      do
      {
        for (j = 0; j != v43; ++j)
        {
          ...
          v46 = objc_msgSend_meshSourceWithMDLVertexAttribute_mesh_(VFXMeshSource, v42, *(*(&v127 + 1) + 8 * j), a3);
    ...
    if (v58)
    {
      ...
      do
      {
        for (k = 0; k != v61; ++k)
        {
          ...
          v64 = objc_msgSend_meshSourceWithMDLVertexAttribute_mesh_(VFXMeshSource, v59, *(*(&v123 + 1) + 8 * k), a3);
    ...
    v67 = objc_msgSend_modelWithMDLMesh_(a1, v59, a3, v60);
...
- (void)setValueForKey:(id)a3 optionKey:(id)a4 options:(id)a5
{
  v7 = objc_msgSend_objectForKey_(a5, a2, a4, a4);
  if (v7)
  {

    objc_msgSend_setValue_forKey_(self, v8, v7, a3);
  }
}

+ (id)planeWithWidth:(float)a3 height:(float)a4 options:(id)a5
{
  v7 = objc_msgSend_planeWithWidth_height_(VFXParametricModel, a2, a5, v5);
...
+ (id)cubeWithWidth:(float)a3 height:(float)a4 length:(float)a5 cornerRadius:(float)a6 options:(id)a7
{
  v9 = objc_msgSend_cubeWithWidth_height_length_chamferRadius_(VFXParametricModel, a2, a7, v7);
...
+ (id)pyramidWithWidth:(float)a3 height:(float)a4 length:(float)a5 options:(id)a6
{
  v8 = objc_msgSend_pyramidWithWidth_height_length_(VFXParametricModel, a2, a6, v6);
...
+ (id)sphereWithRadius:(float)a3 options:(id)a4
{
  v6 = objc_msgSend_sphereWithRadius_(VFXParametricModel, a2, a4, v4);
  objc_msgSend_setValueForKey_optionKey_options_(v6, v7, @"segmentCount", @"kPrimitiveRotationSegments", a4);
  v10 = objc_msgSend_objectForKey_(a4, v8, @"kPrimitiveSphereType", v9);
  if (v10)
  {
...
+ (id)cylinderWithRadius:(float)a3 height:(float)a4 options:(id)a5
{
  v7 = objc_msgSend_cylinderWithRadius_height_(VFXParametricModel, a2, a5, v5);
...
+ (id)coneWithHeight:(float)a3 topRadius:(float)a4 bottomRadius:(float)a5 options:(id)a6
{
  ...
  *&v10 = a5;
  *&v11 = a3;
  v12 = objc_msgSend_coneWithTopRadius_bottomRadius_height_(VFXParametricModel, a2, a6, v6, v9, v10, v11);
...
+ (id)tubeWithInnerRadius:(float)a3 outerRadius:(float)a4 height:(float)a5 options:(id)a6
{
  v8 = objc_msgSend_tubeWithInnerRadius_outerRadius_height_(VFXParametricModel, a2, a6, v6);
...
+ (id)capsuleWithRadius:(float)a3 height:(float)a4 options:(id)a5
{
  v7 = objc_msgSend_capsuleWithCapRadius_height_(VFXParametricModel, a2, a5, v5);
  objc_msgSend_setValueForKey_optionKey_options_(v7, v8, @"radialSegmentCount", @"kPrimitiveRotationSegments", a5);
  objc_msgSend_setValueForKey_optionKey_options_(v7, v9, @"heightSegmentCount", @"kPrimitiveHeightSegments", a5);
  return v7;
}
...
+ (id)torusWithRingRadius:(float)a3 pipeRadius:(float)a4 options:(id)a5
{
  v7 = objc_msgSend_torusWithRingRadius_pipeRadius_(VFXParametricModel, a2, a5, v5);
  objc_msgSend_setValueForKey_optionKey_options_(v7, v8, @"radialSegmentCount", @"kPrimitiveRotationSegments", a5);
...
- (id)debugQuickLookObjectWithWorld:(id)a3
{
  ...
  return MEMORY[0x1EEE66B58](v8, sel_debugQuickLookObjectWithWorld_, a3, v9);
}
