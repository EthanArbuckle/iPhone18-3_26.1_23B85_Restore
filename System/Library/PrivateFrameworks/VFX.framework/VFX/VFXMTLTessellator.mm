...
- (VFXMTLTessellator)initWithModel:(__CFXModel *)a3 resourceManager:(id)a4;
...
- (unsigned)pipelineStateHashForMeshElement:(id)a3 patchType:(unsigned __int8)a4
{
  ...
  {
    return objc_msgSend__pipelineStateHashForMeshElement_patchType_(self, a2, a3, a4);
  }
}
...
- (id)newPipelineStateConfiguratorForMeshElement:(id)a3 patchType:(unsigned __int8)a4 device:(id)a5
{
  ...
  v13 = v5;
  v14 = v6;
  v9 = objc_msgSend__pipelineStateHashForMeshElement_patchType_(self, a2, a3, a4);
...
- (void)draw:(id *)a3
{
  ...
  *&v7 = sub_1AF1B40F0(self->_model, &v12).n128_u64[0];
  if (v12.n128_u8[0] <= 1u)
  {
    ...
    objc_msgSend_uniformTessellationDrawMeshElement_forMesh_instanceCount_renderContext_(self, v5, a3->var3, a3->var1, a3->var4, a3->var5);
    return;
  }
  ...
  {
    case 2u:
      objc_msgSend_screenSpaceAdaptiveTessellationDrawMeshElement_forMesh_instanceCount_renderContext_(self, v5, a3->var3, a3->var1, a3->var4, a3->var5, v7);
      break;
    case 3u:
      objc_msgSend_constrainedEdgeLengthTessellationDrawMeshElement_forMesh_instanceCount_renderContext_(self, v5, a3->var3, a3->var1, a3->var4, a3->var5, v7);
      break;
    case 4u:
      v8 = *&a3->var2;
      v10[0] = *&a3->var0;
...
- (void)updateUniformTessellator:(id *)a3
{
  ...
  if (tessellationFactorBuffer)
  {
    ...
    {
      *objc_msgSend_contents(tessellationFactorBuffer, a2, a3, v3) = v27;
    }
  }
...
- (void)uniformTessellationDrawMeshElement:(id)a3 forMesh:(id)a4 instanceCount:(unint64_t)a5 renderContext:(id)a6
{
  v10 = objc_msgSend_renderEncoder(a6, a2, a3, a4);
  *&v11 = self->_cachedTessellator.tessellationFactorScale;
  ...
  objc_msgSend__drawPatchForMeshElement_instanceCount_(a6, v16, a3, a5);
}
...
- (void)updateScreenSpaceAdaptiveTessellator:(id *)a3 parameters:(id *)a4
{
  ...
  var0 = a4->var0;
  v6 = objc_msgSend_resourceComputeEncoder(a4->var1, a2, a3, a4);
  v106 = v6;
  v107 = self;
  if (!self->_tessellationFactorBuffer)
  {
    ...
    sub_1AFDE851C(v107->_resourceManager, v15, 32);
    v107->_tessellationFactorBuffer = v16;
    v6 = v106;
  }
  ...
  if (v108)
  {
    ...
    do
    {
      for (j = 0; j != v108; ++j)
      {
        ...
        v51 = objc_msgSend_computePipelineStateForKernel_(v107->_resourceManager, v46, v48, v47);
        ...
        v77 = objc_msgSend_engineContext(a4->var1, v74, v75, v76);
        v78 = sub_1AF130548(v77);
        v79 = a3->var4.var0.var0;
        v124 = 0u;
        v125 = 0u;
        v122 = 0u;
        v123 = 0u;
        ...
        objc_msgSend_setBuffer_offset_atIndex_(v106, v92, v107->_tessellationFactorBuffer, 24 * v42, 0);
...
LABEL_3:
  ...
  v21 = objc_msgSend_renderEncoder(a6, v13, v14, v15, v28);
  *&v22 = self->_cachedTessellator.tessellationFactorScale;
  ...
  objc_msgSend__drawPatchForMeshElement_instanceCount_(a6, v27, a3, a5);
}
...
- (void)updateConstrainedEdgeLengthTessellator:(id *)a3 parameters:(id *)a4
{
  ...
  v91 = self;
  v18 = objc_msgSend_resourceComputeEncoder(a4->var1, a2, a3, a4);
  ...
  if (v93)
  {
    ...
    do
    {
      for (j = 0; j != v93; ++j)
      {
        ...
        v52 = objc_msgSend_computePipelineStateForKernel_(v91->_resourceManager, v47, v49, v48);
        ...
        v95[0] = v54;
        v95[1] = v76;
        v95[2] = LODWORD(a3->var4.var0.var0);
        objc_msgSend_setComputePipelineState_(v92, v77, v53, v78);
        objc_msgSend_setBuffer_offset_atIndex_(v92, v79, v91->_tessellationFactorBuffer, 24 * v43, 0);
...
- (void)updateSubdivisionSurfaceTessellator:(id *)a3 parameters:(id *)a4
{
  ...
  v7[1] = a3->var1;
  v10 = sub_1AFDEA180(a4->var0, 0, v8, v9);
  ...
  if (v14)
  {
    v15 = sub_1AF1762AC(v7, v10, a4->var1, a4->var3);
LABEL_10:
    sub_1AF176448(v7, a4->var1, a4->var2, a4->var3, *&v15);
    goto LABEL_11;
  }
...
LABEL_11:
  v19 = objc_msgSend_engineContext(a4->var1, v16, v17, v18);
...
- (void)subdivisionSurfaceTessellationDraw:(id *)a3
{
  v5 = sub_1AF1A516C(a3->var0, 0);
  v8 = objc_msgSend_indexOfObject_(v5, v6, a3->var2, v7);
