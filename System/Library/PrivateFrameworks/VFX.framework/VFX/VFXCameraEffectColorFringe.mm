...
- (id)copyWithZone:(_NSZone *)zone
{
  ...
  v4 = [(VFXCameraEffect *)&v14 copyWithZone:zone];
...
- (void)encodeWithCoder:(id)coder
{
  ...
  LODWORD(v5) = *(&self->super._enabled + 1);
  objc_msgSend_encodeFloat_forKey_(coder, v6, @"strength", v7, v5);
  *&v8 = self->_strength;
...
- (VFXCameraEffectColorFringe)initWithCoder:(id)coder
{
  ...
  if (v7)
  {
    ...
    objc_msgSend_decodeFloatForKey_(coder, v11, @"strength", v12);
