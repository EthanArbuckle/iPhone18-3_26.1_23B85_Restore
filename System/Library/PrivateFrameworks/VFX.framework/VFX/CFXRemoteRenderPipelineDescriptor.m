...
- ($0A5B5EE80FF9A3BD0C0D8CB2CCC95C0F)blendingDescAt:(int64_t)a3;
- (BOOL)isEqual:(id)a3;
- (CFXRemoteRenderPipelineDescriptor)initWithCoder:(id)a3;
- (CFXRemoteRenderPipelineDescriptor)initWithDescriptor:(id *)a3;
- (unint64_t)hash;
- (void)dealloc;
- (void)encodeWithCoder:(id)a3;
- (void)setBlendingDesc:(id)a3 at:(int64_t)a4;
@end
...
- (CFXRemoteRenderPipelineDescriptor)initWithDescriptor:(id *)a3
{
  ...
  if (v4)
  {
    ...
    objc_msgSend_setProgramHashCode_(v4, v13, a3->var0.var0, v14);
    objc_msgSend_setVertexDescriptor_(v4, v15, a3->var7, v16);
    objc_msgSend_setPrimitiveTopologyClass_(v4, v17, a3->var5, v18);
...
- (BOOL)isEqual:(id)a3
{
  if (!objc_msgSend_isEqual_(self->_vertexFunction, a2, *(a3 + 10), v3))
  {
    return 0;
  }

  if (!objc_msgSend_isEqual_(self->_fragmentFunction, v6, *(a3 + 11), v7))
  {
    return 0;
  }
...
- (void)encodeWithCoder:(id)a3
{
  ...
  if (vertexFunction)
  {
    objc_msgSend_encodeObject_forKey_(a3, a2, vertexFunction, @"vertexFunction");
  }

  fragmentFunction = self->_fragmentFunction;
  if (fragmentFunction)
  {
    objc_msgSend_encodeObject_forKey_(a3, a2, fragmentFunction, @"fragmentFunction");
  }
  ...
  if (vertexDescriptor)
  {
    ...
    if (v9)
    {
      objc_msgSend_encodeObject_forKey_(a3, a2, v9, @"vertexDescriptor");
    }
  }

  objc_msgSend_encodeInteger_forKey_(a3, a2, self->_primitiveTopologyClass, @"primitiveTopologyClass");
  objc_msgSend_encodeBool_forKey_(a3, v10, self->_rasterizationEnabled, @"rasterizationEnabled");
  objc_msgSend_encodeInteger_forKey_(a3, v11, self->_maxVertexAmplificationCount, @"maxVertexAmp");
  v13 = objc_msgSend_dataWithBytesNoCopy_length_freeWhenDone_(MEMORY[0x1E695DEF0], v12, self->_blendingDesc, 64, 0);
  objc_msgSend_encodeObject_forKey_(a3, v14, v13, @"blendingDesc");
  programHashCode = self->_programHashCode;
  if (programHashCode)
  {
    v19 = objc_msgSend_programHashCodeEncoderWithHashCode_(CFXProgramHashCodeEncoder, v15, programHashCode, v16);

    objc_msgSend_encodeObject_forKey_(a3, v18, v19, @"hashCode");
  }
}
...
- (CFXRemoteRenderPipelineDescriptor)initWithCoder:(id)a3
{
  ...
  {
    v5 = objc_opt_class();
    v7 = objc_msgSend_decodeObjectOfClass_forKey_(a3, v6, v5, @"vertexFunction");
    objc_msgSend_setVertexFunction_(v4, v8, v7, v9);
    v10 = objc_opt_class();
    v12 = objc_msgSend_decodeObjectOfClass_forKey_(a3, v11, v10, @"fragmentFunction");
    objc_msgSend_setFragmentFunction_(v4, v13, v12, v14);
    v15 = objc_opt_class();
    v17 = objc_msgSend_decodeObjectOfClass_forKey_(a3, v16, v15, @"vertexDescriptor");
    if (v17)
    {
    ...
    v23 = objc_msgSend_decodeIntegerForKey_(a3, v18, @"primitiveTopologyClass", v19);
    objc_msgSend_setPrimitiveTopologyClass_(v4, v24, v23, v25);
    v28 = objc_msgSend_decodeBoolForKey_(a3, v26, @"rasterizationEnabled", v27);
    objc_msgSend_setRasterizationEnabled_(v4, v29, v28, v30);
    v33 = objc_msgSend_decodeIntegerForKey_(a3, v31, @"maxVertexAmp", v32);
    objc_msgSend_setMaxVertexAmplificationCount_(v4, v34, v33, v35);
    v36 = objc_opt_class();
    v38 = objc_msgSend_decodeObjectOfClass_forKey_(a3, v37, v36, @"blendingDesc");
    ...
    v50 = objc_opt_class();
    v52 = objc_msgSend_decodeObjectOfClass_forKey_(a3, v51, v50, @"hashCode");
