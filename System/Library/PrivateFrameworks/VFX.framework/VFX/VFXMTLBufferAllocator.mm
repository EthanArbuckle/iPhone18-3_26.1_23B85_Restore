...
- (VFXMTLBufferAllocator)initWithDevice:(__CFXGPUDevice *)a3 fixedSizeElement:(unint64_t)a4 buffersize:(unint64_t)a5 name:(id)a6;
- (id)_newSubBuffer;
- (id)newSubBufferWithBytes:(const void *)a3 length:(unint64_t)a4 renderContext:(id)a5;
- (void)dealloc;
- (void)deallocateElementAtOffset:(unint64_t)a3 inPage:(id)a4;
@end
...
- (VFXMTLBufferAllocator)initWithDevice:(__CFXGPUDevice *)a3 fixedSizeElement:(unint64_t)a4 buffersize:(unint64_t)a5 name:(id)a6
{
  ...
  v10->_gpuDevice = a3;
  v10->_name = objc_msgSend_copy(a6, v11, v12, v13);
  CFXGPUDeviceGetMTLDevice(a3);
  v14 = (a4 + 15) & 0xFFFFFFFFFFFFFFF0;
  v15 = a5 / a4;
  if (a4 > a5)
  {
    v15 = 100;
...
- (id)newSubBufferWithBytes:(const void *)a3 length:(unint64_t)a4 renderContext:(id)a5
{
  ...
  if (self->_elementSize < a4)
  {
    ...
    {
      sub_1AFDE5754(a4, p_elementSize, v10);
    }
  }

  v11 = objc_msgSend__newSubBuffer(self, a2, a3, a4);
  v15 = objc_msgSend_frameConstantBufferPool(a5, v12, v13, v14);
  v16 = v15;
  if (v15)
  {
    CFRetain(v15);
  ...
  v17 = CFXBufferAllocatorPerFrameAllocateWithBytes(v16, a3, a4);
  v19 = v18;
  v22 = objc_msgSend_resourceBlitEncoder(a5, v18, v20, v21);
  ...
  objc_msgSend_copyFromBuffer_sourceOffset_toBuffer_destinationOffset_size_(*v22, v32, MTLBuffer, v19, v27, v31, a4);
  if (v16)
  {
    CFRelease(v16);
  }
