...
+ (VFXForceField)forceFieldWithForceFieldRef:(__CFXForceField *)a3
{
  ...
  {
    v6 = [a1 alloc];
    v9 = objc_msgSend_initWithForceFieldRef_(v6, v7, a3, v8);
...
+ (id)presentationForceFieldWithForceFieldRef:(__CFXForceField *)a3
{
  ...
  inited = objc_msgSend_initPresentationForceFieldWithForceFieldRef_(v4, v5, a3, v6);
...
- (void)setFieldType:(int64_t)a3
{
  if ((*(self + 28) & 1) != 0 || self->_settings.kind != a3)
  {
    v5[6] = v3;
    v5[7] = v4;
...
- (void)setStrength:(float)a3
{
  if ((*(self + 28) & 1) != 0 || self->_settings.strength != a3)
  {
    v7 = v3;
    v8 = v4;
...
- (void)setCategoryBitMask:(unint64_t)a3
{
  if ((*(self + 28) & 1) != 0 || self->_settings.categoryBitMask != a3)
  {
    v5[6] = v3;
    v5[7] = v4;
...
- (void)setFalloffExponent:(float)a3
{
  if ((*(self + 28) & 1) != 0 || self->_settings.falloffExponent != a3)
  {
    v7 = v3;
    v8 = v4;
...
- (void)setActive:(BOOL)a3
{
  if ((*(self + 28) & 1) != 0 || self->_settings.active != a3)
  {
    v7 = v3;
    v8 = v4;
...
- (void)setLocal:(BOOL)a3
{
  if ((*(self + 28) & 1) != 0 || self->_settings.local != a3)
  {
    v7 = v3;
    v8 = v4;
    self->_settings.local = a3;
    v5[0] = MEMORY[0x1E69E9820];
    v5[1] = 3221225472;
    v5[2] = sub_1AF352BF0;
    v5[3] = &unk_1E7A7E298;
...
- (void)setScope:(int64_t)a3
{
  if ((*(self + 28) & 1) != 0 || self->_settings.scope != a3)
  {
    v5[6] = v3;
    v5[7] = v4;
...
- (double)halfExtent
{
  if (*(a1 + 28))
  {
    ...
    if (v6)
    {
      v7 = v6;
      sub_1AF1CEA20(v6);
      v10 = sub_1AF3507C8(*(a1 + 8)).n128_u64[0];
      sub_1AF1CEA9C(v7);
      *&v5 = v10;
    }
...
- (double)offset
{
  if (*(a1 + 28))
  {
    ...
    if (v6)
    {
      v7 = v6;
      sub_1AF1CEA20(v6);
      v10 = sub_1AF350940(*(a1 + 8)).n128_u64[0];
      sub_1AF1CEA9C(v7);
      *&v5 = v10;
    }
...
- (void)setSmoothness:(float)a3
{
  if ((*(self + 28) & 1) != 0 || *&self->_anon_78[40] != a3)
  {
    v7 = v3;
    v8 = v4;
    *&self->_anon_78[40] = a3;
...
- (void)setShape:(int64_t)a3
{
  if ((*(self + 28) & 1) != 0 || self->_settings.shape != a3)
  {
    v5[6] = v3;
    v5[7] = v4;
...
- (void)setCullMode:(int64_t)a3
{
  if ((*(self + 28) & 1) != 0 || self->_settings.cullMode != a3)
  {
    v5[6] = v3;
    v5[7] = v4;
...
- (void)setSpeed:(float)a3
{
  if ((*(self + 28) & 1) != 0 || *&self->_anon_78[44] != a3)
  {
    v7 = v3;
    v8 = v4;
    *&self->_anon_78[44] = a3;
...
- (void)encodeWithCoder:(id)a3
{
  sub_1AF371A8C(a3, @"halfExtent", *&self->_anon_78[8]);
  ...
  objc_msgSend_encodeDouble_forKey_(a3, v13, @"smoothness", v14, *&self->_anon_78[40]);
  objc_msgSend_encodeInteger_forKey_(a3, v15, self->_settings.categoryBitMask, @"categoryMask");
  objc_msgSend_encodeDouble_forKey_(a3, v16, @"speed", v17, *&self->_anon_78[44]);
  v18 = *&self->_anon_78[24];

  sub_1AF371A8C(a3, @"offset", v18);
}
...
- (VFXForceField)initWithCoder:(id)a3
{
  ...
  if (v7)
  {
    ...
    *&v15 = sub_1AF3502DC().n128_u64[0];
    ...
    v18 = objc_msgSend_decodeIntForKey_(a3, v16, @"type", v17);
    objc_msgSend_setFieldType_(v7, v19, v18, v20);
    v21 = sub_1AF371BC4(a3, @"halfExtent");
    objc_msgSend_setHalfExtent_(v7, v22, v23, v24, v21);
    objc_msgSend_decodeDoubleForKey_(a3, v25, @"strength", v26);
    *&v27 = v27;
    objc_msgSend_setStrength_(v7, v28, v29, v30, v27);
    objc_msgSend_decodeDoubleForKey_(a3, v31, @"falloffExponent", v32);
    *&v33 = v33;
    objc_msgSend_setFalloffExponent_(v7, v34, v35, v36, v33);
    v39 = objc_msgSend_decodeBoolForKey_(a3, v37, @"active", v38);
    objc_msgSend_setActive_(v7, v40, v39, v41);
    v44 = objc_msgSend_decodeIntegerForKey_(a3, v42, @"scope", v43);
    objc_msgSend_setScope_(v7, v45, v44, v46);
    v49 = objc_msgSend_decodeIntegerForKey_(a3, v47, @"shape", v48);
    objc_msgSend_setShape_(v7, v50, v49, v51);
    v52 = sub_1AF371BC4(a3, @"offset");
    objc_msgSend_setOffset_(v7, v53, v54, v55, v52);
    objc_msgSend_decodeDoubleForKey_(a3, v56, @"smoothness", v57);
    *&v58 = v58;
    objc_msgSend_setSmoothness_(v7, v59, v60, v61, v58);
    objc_msgSend_decodeDoubleForKey_(a3, v62, @"speed", v63);
    *&v64 = v64;
    objc_msgSend_setSpeed_(v7, v65, v66, v67, v64);
    v70 = objc_msgSend_decodeIntForKey_(a3, v68, @"categoryMask", v69);
...
- (void)setValue:(id)a3 forKey:(id)a4
{
  if (objc_msgSend_isEqualToString_(a4, a2, @"halfExtent", a4))
  {
