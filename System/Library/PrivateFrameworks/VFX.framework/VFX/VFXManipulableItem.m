...
- (unint64_t)hash;
- (void)dealloc;
- (void)setTransform:(uint64_t)a1;
- (void)setWorldTransform:(uint64_t)a1;
@end
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (objc_opt_isKindOfClass())
  {
    ...
    if (v8 == objc_msgSend_node(a3, v9, v10, v11) && (v15 = objc_msgSend_elementIndex(self, v12, v13, v14), v15 == objc_msgSend_elementIndex(a3, v16, v17, v18)))
    {
