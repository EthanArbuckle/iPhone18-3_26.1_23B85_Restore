...
+ (VFXPhysicsShape)shapeWithModel:(id)a3
{
  ...
  v7 = objc_msgSend_initWithContent_(v4, v5, a3, v6);
...
+ (VFXPhysicsShape)shapeWithNode:(id)a3 flattened:(BOOL)a4
{
  ...
  v9 = objc_msgSend_initWithContent_(v6, v7, a3, v8);
  v9[80] = a4;
...
+ (VFXPhysicsShape)shapeWithShapes:(id)a3 transforms:(id)a4
{
  v6 = objc_alloc(objc_opt_class());
  v9 = objc_msgSend_initWithContent_(v6, v7, a3, v8);
  objc_msgSend__setTransforms_(v9, v10, a4, v11);
...
- (void)didRemoveFromPhysicsBody:(id)a3
{
  ...
  v8.location = 0;
  FirstIndexOfValue = CFArrayGetFirstIndexOfValue(physicsBodies, v8, a3);
  ...
  if (!result)
  {
    ...
    else
    {
      ...
      else
      {
        ...
        else if (!a3 || ((v16 = sub_1AF1B75A0(a3), type = self->_type, !v16) ? (v10 = sub_1AF35D5F8(a3, type, self->_flattened)) : (v10 = sub_1AF35D594(v16, type)), !v10))
        {
          v18 = sub_1AF0D5194();
...
- (void)setShapeNode:(id)a3
{
  ...
  if (referenceObject != a3)
  {
    ...
    objc_msgSend_setWeakRef_(v7, v8, a3, v9);
...
- (void)_setShapeObject:(id)a3
{
  ...
  if (objc_opt_isKindOfClass())
  {
    ...
    objc_msgSend_setShapeNode_(self, v5, a3, v7);
  }
...
- (void)enumerateReferencesForOperation:(int64_t)a3 usingBlock:(id)a4
{
  ...
  v5[3] = &unk_1E7A7C0C8;
  v5[4] = self;
  (*(a4 + 2))(a4, referenceObject, 1, v5);
}

- (void)copyTo:(id)a3 withContext:(id)a4
{
  v7 = objc_msgSend_shapeNode(self, a2, a3, a4);
  if (v7)
  {
    v10 = sub_1AF2BED30(v7, a4);
    objc_msgSend__setShapeObject_(a3, v11, v10, v12);
  }

  else
  {
    objc_msgSend__setShapeObject_(a3, v8, self->_referenceObject, v9);
  }

  objc_msgSend_margin(self, v13, v14, v15);
  objc_msgSend_setMargin_(a3, v16, v17, v18);
  objc_msgSend_scale(self, v19, v20, v21);
  objc_msgSend_setScale_(a3, v22, v23, v24);
  *(a3 + 80) = self->_flattened;
  v28 = objc_msgSend_type(self, v25, v26, v27);
  objc_msgSend_setType_(a3, v29, v28, v30);
  *(a3 + 2) = objc_msgSend_transforms(self, v31, v32, v33);
}
...
+ (id)defaultShapeForModel:(id)a3
{
  v5 = objc_msgSend_valueForKey_(a3, a2, @"VFXDefaultPhysicsShape", v3);
  v11 = objc_msgSend_pointerValue(v5, v6, v7, v8);
  if (!v11)
  {
    v11 = objc_msgSend_shapeWithModel_(VFXPhysicsShape, v9, a3, v10);
...
- (void)_customEncodingOfVFXPhysicsShape:(id)a3
{
  ...
  if (transforms)
  {
    ...
    v13[2] = 0x2020000000;
    v14 = 0;
    v7 = objc_msgSend_count(transforms, a2, a3, v3);
...
- (void)_customDecodingOfVFXPhysicsShape:(id)a3
{
  v6 = objc_msgSend_decodeIntegerForKey_(a3, a2, @"transformsCount", v3);
  if (v6 >= 1)
  {
    v9 = v6;
    v10 = 0;
    ...
    do
    {
      ...
      *&v16 = sub_1AF371C4C(a3, v15).n128_u64[0];
...
- (void)encodeWithCoder:(id)a3
{
  objc_msgSend__customEncodingOfVFXPhysicsShape_(self, a2, a3, v3);
  referenceObject = self->_referenceObject;
  objc_opt_class();
  if (objc_opt_isKindOfClass())
  {
  ...
  if (referenceObject)
  {
    objc_msgSend_encodeObject_forKey_(a3, v7, referenceObject, @"referenceObject");
  }

  *&v10 = self->_margin;
  objc_msgSend_encodeFloat_forKey_(a3, v7, @"margin", v9, v10);
  if (self->_flattened)
  {
    objc_msgSend_encodeBool_forKey_(a3, v11, 1, @"flattened");
  }

  sub_1AF371A8C(a3, @"scale", *self->_scale);
  type = self->_type;

  objc_msgSend_encodeInteger_forKey_(a3, v12, type, @"type");
}
...
- (VFXPhysicsShape)initWithCoder:(id)a3
{
  ...
  if (v4)
  {
    ...
    objc_msgSend__customDecodingOfVFXPhysicsShape_(v8, v15, a3, v16);
    ...
    v8->_referenceObject = objc_msgSend_decodeObjectOfClasses_forKey_(a3, v23, v22, @"referenceObject");
    objc_opt_class();
    if (objc_opt_isKindOfClass())
    {
    ...
    v8->_margin = v28;
    v8->_flattened = objc_msgSend_decodeBoolForKey_(a3, v29, @"flattened", v30);
    if (objc_msgSend_containsValueForKey_(a3, v31, @"scale", v32))
    {
      *&v35 = sub_1AF371BC4(a3, @"scale");
      *v8->_scale = v35;
    }

    if (objc_msgSend_containsValueForKey_(a3, v33, @"type", v34))
    {
      v8->_type = objc_msgSend_decodeIntegerForKey_(a3, v36, @"type", v37);
    }
...
- (void)setValue:(id)a3 forKey:(id)a4
{
  if (objc_msgSend_isEqualToString_(a4, a2, @"scale", a4))
  {
