...
- (void)dealloc;
- (void)destroyBufferWithRemoteID:(id)a3;
- (void)destroyTextureWithRemoteID:(id)a3;
- (void)newBuffer:(id)a3 remoteID:(id)a4;
- (void)newFrame:(id)a3 index:(int64_t)a4;
@end
...
- (void)newBuffer:(id)a3 remoteID:(id)a4
{
  ...
  v17 = objc_msgSend_unsignedIntegerValue(a4, v14, v15, v16);
  ...
  v30 = objc_msgSend_unsignedIntegerValue(a4, v27, v28, v29);
  objc_msgSend_remoteRegisterBuffer_remoteID_(v26, v31, v12, v30);
}

- (void)destroyBufferWithRemoteID:(id)a3
{
  v5 = objc_msgSend_resourceConsumer(self->_decoder, a2, a3, v3);
  v9 = objc_msgSend_unsignedIntegerValue(a3, v6, v7, v8);
