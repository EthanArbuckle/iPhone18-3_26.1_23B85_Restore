...
+ (VFXBehaviorGraph)behaviorGraphWithEntityHandle:(id)a3;
+ (VFXBehaviorGraph)behaviorGraphWithEntityObject:(id)a3;
+ (id)presentationBehaviorGraphWithEntityHandle:(id)a3;
...
- (id)unsafeParameterHandleForKey:(id)a3;
...
{
  v4 = [a1 alloc];
  v7 = objc_msgSend_initWithCoreEntityHandle_(v4, v5, a3, v6);
...
{
  v4 = [a1 alloc];
  inited = objc_msgSend_initPresentationBehaviorGraphWithCoreEntityHandle_(v4, v5, a3, v6);
...
- (void)resolveTag:(id)a3 remap:(id)a4
{
  objc_msgSend_resolveTag_remap_(self->_coreHandle, a2, a3, a4);
...
- (id)presentationObject
{
  ...
  if ((*(self + 24) & 1) == 0)
  {
    ...
    else
    {
      ...
      inited = objc_msgSend_initPresentationBehaviorGraphWithCoreEntityHandle_(v11, v12, v2[1], v13);
...
- (void)enumerateReferencesForOperation:(int64_t)a3 usingBlock:(id)a4
{
  ...
  objc_msgSend_enumerateAnimationReferencesUsingBlock_(self, coreHandle, a4, a4);
}
...
- (id)valueForUndefinedKey:(id)a3
{
  if ((*(self + 24) & 1) != 0 || (v6 = objc_msgSend_valueForKey_(self->_valueForKey, a2, a3, v3)) == 0)
  {
    ...
    if (*(self + 24))
    {
      v12 = objc_msgSend_bindingPresentationValueForKey_(coreHandle, v8, a3, v9);
    }

    else
    {
      v12 = objc_msgSend_bindingValueForKey_(coreHandle, v8, a3, v9);
    }

    v6 = v12;
    if (!v12)
    {
      v6 = objc_msgSend_valueForKeyPath_(self->_coreHandle, v13, a3, v14);
    }
...
- (void)setValue:(id)a3 forUndefinedKey:(id)a4
{
  if (objc_msgSend_setBindingValue_forKey_(self->_coreHandle, a2, a3, a4))
  {
    valueForKey = self->_valueForKey;
    if (!valueForKey)
    {
    ...
    objc_msgSend_setValue_forKey_(valueForKey, v7, a3, a4);
  }
  ...
  else
  {
    ...
    objc_msgSend_setValue_forKeyPath_(coreHandle, v7, a3, a4);
  }
}
...
- (id)unsafeParameterHandleForKey:(id)a3
{
  ...
  if (v4)
  {
    return objc_msgSend_presentationBindingForKey_(coreHandle, a2, a3, v3);
  }

  else
  {
    return (MEMORY[0x1EEE66B58])(coreHandle, sel_bindingForKey_, a3);
  }
}
...
- (void)copyTo:(id)a3 withContext:(id)a4
{
  ...
  *(a3 + 1) = sub_1AF2BED30(self->_coreHandle, a4);
  objc_msgSend__updateModelFromPresentation(a3, v9, v10, v11);
  objc_msgSend__copyAnimationsFrom_(a3, v12, self, v13);
  objc_msgSend__copyBindingsFrom_(a3, v14, self, v15);

  *(a3 + 5) = objc_msgSend_mutableCopy(self->_valueForKey, v16, v17, v18);
...
- (VFXBehaviorGraph)initWithCoder:(id)a3
{
  ...
  if (v7)
  {
    ...
    {
      v23 = objc_opt_class();
      v19 = objc_msgSend_decodeObjectOfClass_forKey_(a3, v24, v23, @"coreHandle");
    }
