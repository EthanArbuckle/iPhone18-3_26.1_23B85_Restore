...
- (double)__updateTextureWithLayer:(id)a3 texture:(id)a4 engineContext:(__CFXEngineContext *)a5 sampler:(id)a6;
...
- (void)dealloc;
- (void)renderWithEngineContext:(__CFXEngineContext *)a3 textureSampler:(id)a4 nextFrameTime:(double *)a5 status:(id *)a6;
- (void)setLayer:(id)a3;
@end
...
- (void)renderWithEngineContext:(__CFXEngineContext *)a3 textureSampler:(id)a4 nextFrameTime:(double *)a5 status:(id *)a6
{
  if (sub_1AF12E2AC(a3))
  {
    FrameTime_status = objc_msgSend_metalTextureWithEngineContext_textureSampler_nextFrameTime_status_(self, v11, a3, *&a4, a5, a6);
    v13 = sub_1AF12E2AC(a3);
...
- (void)_resizeLayer:(id)a3 toSize:(CGSize)a4 updateLayer:(BOOL)a5 updateTransform:(BOOL)a6 caRenderer:(id)a7
{
  height = a4.height;
  width = a4.width;
  v14 = objc_msgSend_requiresMainThreadUpdates(self, a2, a3, a5);
...
- (double)__renderLayerUsingMetal:(id)a3 withCARenderer:(id)a4 engineContext:(__CFXEngineContext *)a5 viewport:(double)a6 atTime:
{
  ...
  objc_msgSend_bounds(a4, a2, a3, a4, a5);
  ...
  {
    objc_msgSend_setBounds_(a4, v9, v10, v11, 0.0, 0.0, *&rect2);
  }

  v15 = objc_msgSend_layer(a4, v9, v10, v11);
  if (v15 != a3 || a3 && (objc_msgSend_transform(a3, v12, v13, v14), v24 > 0.0))
  {
    objc_msgSend__resizeLayer_toSize_updateLayer_updateTransform_caRenderer_(self, v12, a3, v15 != a3, 1, a4, *&rect2);
  }

  objc_msgSend_addUpdateRect_(a4, v12, v13, v14, 0.0, 0.0, *&rect2);
...
- (double)__updateTextureWithLayer:(id)a3 texture:(id)a4 engineContext:(__CFXEngineContext *)a5 sampler:(id)a6
{
  ...
  if (self->super._framebufferSize.width > 0.0 && self->_lastUpdate != v15)
  {
    ...
    v18 = objc_msgSend_sourceRendererForEngineContext_source_textureSource_targetTexture_(v16, v17, a5, a3, self, a4);
    v19 = sub_1AF1302D4(a5);
    ...
    if ((objc_msgSend_requiresMainThreadUpdates(self, v21, v22, v23) & 1) == 0)
    {
      ...
      objc_msgSend_setTimeOffset_(a3, v29, v30, v31, v19 - v20);
...
LABEL_18:
      ...
      if (a4)
      {
        objc_msgSend___renderLayerUsingMetal_withCARenderer_engineContext_viewport_atTime_(self, v39, a3, v18, a5, *vcvt_hight_f32_f64(0, self->super._framebufferSize).i64, v20);
        v42 = v43;
      }
...
- (id)metalTextureWithEngineContext:(__CFXEngineContext *)a3 textureSampler:(id)a4 nextFrameTime:(double *)a5 status:(id *)a6
{
  if (objc_msgSend_supportsMetal(self, a2, a3, *&a4))
  {
    v11 = sub_1AF12E2AC(a3);
    v12 = sub_1AF12DE14(a3);
    ...
    if (v17)
    {
      ...
      a6->var0 = v32;
      a6->var1 = 1;
      objc_msgSend___updateTextureWithLayer_texture_engineContext_sampler_(self, v30, v21, v31, a3, a4);
      *a5 = v41;
  ...
  else
  {
    ...
    return [(VFXTextureSource *)&v47 metalTextureWithEngineContext:a3 textureSampler:a4 nextFrameTime:a5 status:a6];
  }
