...
{
  v3.receiver = self;
  v3.super_class = UARPTLVPersonalizationSecurityDomain;
...
- (void)setSecurityDomain:(unsigned int)domain
{
  obj = self;
  objc_sync_enter(obj);
  *(&obj->super.super._tlvLength + 1) = domain;
  objc_sync_exit(obj);
}

- (id)description
{
  v3 = +[UARPTLVPersonalizationSecurityDomain metaDataTableEntry];
...
- (id)generateTLV
{
  v3 = +[UARPTLVPersonalizationSecurityDomain tlvType];
  v4 = *(&self->super.super._tlvLength + 1);
  v7.receiver = self;
  v7.super_class = UARPTLVPersonalizationSecurityDomain;
...
- (id)tlvValue
{
  ...
  v5.receiver = self;
  v5.super_class = UARPTLVPersonalizationSecurityDomain;
...
+ (id)metaDataTableEntry
{
  ...
  v6[0] = @"Name";
  v6[1] = @"Value";
  v2 = [MEMORY[0x277CCABB0] numberWithUnsignedInt:{+[UARPTLVPersonalizationSecurityDomain tlvType](UARPTLVPersonalizationSecurityDomain, "tlvType")}];
  v7[1] = v2;
