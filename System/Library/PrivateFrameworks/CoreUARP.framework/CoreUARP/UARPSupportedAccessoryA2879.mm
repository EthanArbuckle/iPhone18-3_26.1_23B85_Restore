...
{
  v7.receiver = self;
  v7.super_class = UARPSupportedAccessoryA2879;
  ...
  if (v2)
  {
    ...
    v4 = [[UARPAccessoryHardwareHID alloc] initWithVendorID:+[UARPSupportedAccessoryHID vendorID](UARPSupportedAccessoryHID productID:"vendorID"), +[UARPSupportedAccessoryA2879 productID]];
    hwID = v2->hwID;
    v2->hwID = v4;
