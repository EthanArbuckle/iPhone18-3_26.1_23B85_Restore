...
- (UARPAssetTag)init;
- (UARPAssetTag)initWithChar1:(char)char1 char2:(char)char2 char3:(char)char3 char4:(char)char4;
- (UARPAssetTag)initWithCoder:(id)coder;
- (UARPAssetTag)initWithString:(id)string;
...
- (UARPAssetTag)initWithString:(id)string
{
  ...
  if ([stringCopy length] == 4)
  {
    ...
    self = [(UARPAssetTag *)self initWithChar1:*uTF8String char2:uTF8String[1] char3:uTF8String[2] char4:uTF8String[3]];
    selfCopy = self;
  }
...
{
  coderCopy = coder;
  selfCopy = [(UARPAssetTag *)self decodeCharForKey:coderCopy key:@"char1"];
  if (selfCopy)
  {
    v6 = [(UARPAssetTag *)self decodeCharForKey:coderCopy key:@"char2"];
    if (v6 && (v7 = v6, (v8 = [(UARPAssetTag *)self decodeCharForKey:coderCopy key:@"char3"]) != 0) && (v9 = v8, (v10 = [(UARPAssetTag *)self decodeCharForKey:coderCopy key:@"char4"]) != 0))
    {
      self = [(UARPAssetTag *)self initWithChar1:*selfCopy char2:*v7 char3:*v9 char4:*v10];
      selfCopy = self;
    }
