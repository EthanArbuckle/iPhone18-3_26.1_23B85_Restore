...
- (UARPAccessoryHardwareIPv6)initWithAppleModelNumber:(id)number;
- (id)description;
@end
...
- (BOOL)isEqual:(id)equal
{
  ...
  else
  {
    ...
    if (objc_opt_isKindOfClass())
    {
      ...
      {
        appleModelNumber = [(UARPAccessoryHardwareIPv6 *)self appleModelNumber];
        appleModelNumber2 = [(UARPAccessoryHardwareIPv6 *)v5 appleModelNumber];
...
- (id)description
{
  v3 = objc_opt_new();
  appleModelNumber = [(UARPAccessoryHardwareIPv6 *)self appleModelNumber];
  [v3 appendFormat:@"IPv6, <AMN = %@>", appleModelNumber];
