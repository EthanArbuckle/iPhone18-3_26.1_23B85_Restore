...
- (UARPTLVMeasuredPayload)initWithCoder:(id)a3
{
  ...
  if (v5)
  {
    v6 = [v4 decodeObjectOfClass:objc_opt_class() forKey:@"payload4cc"];
    payload4cc = v5->_payload4cc;
    v5->_payload4cc = v6;

    v8 = [v4 decodeObjectOfClass:objc_opt_class() forKey:@"payloadLongname"];
    payloadLongname = v5->_payloadLongname;
    v5->_payloadLongname = v8;

    v5->_hashAlgorithm = [v4 decodeIntegerForKey:@"hashAlgorithm"];
    v10 = [v4 decodeObjectOfClass:objc_opt_class() forKey:@"effectiveSecurityMode"];
    effectiveSecurityMode = v5->_effectiveSecurityMode;
    v5->_effectiveSecurityMode = v10;

    v12 = [v4 decodeObjectOfClass:objc_opt_class() forKey:@"effectiveProductionMode"];
    effectiveProductionMode = v5->_effectiveProductionMode;
    v5->_effectiveProductionMode = v12;

    v14 = [v4 decodeObjectOfClass:objc_opt_class() forKey:@"isTrusted"];
    isTrusted = v5->_isTrusted;
    v5->_isTrusted = v14;

    v16 = [v4 decodeObjectOfClass:objc_opt_class() forKey:@"digestListSize"];
    digestListSize = v5->_digestListSize;
    v5->_digestListSize = v16;

    v18 = [v4 decodeObjectOfClass:objc_opt_class() forKey:@"payloadDigest"];
