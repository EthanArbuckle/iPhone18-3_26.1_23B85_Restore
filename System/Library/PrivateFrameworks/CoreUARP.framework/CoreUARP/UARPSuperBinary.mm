...
- (UARPSuperBinary)initWithData:(id)data delegate:(id)delegate delegateQueue:(id)queue;
- (UARPSuperBinary)initWithFilePath:(id)path delegate:(id)delegate delegateQueue:(id)queue;
- (UARPSuperBinary)initWithURL:(id)l delegate:(id)delegate delegateQueue:(id)queue;
...
- (UARPSuperBinary)initWithFilePath:(id)path delegate:(id)delegate delegateQueue:(id)queue
{
  ...
  v13 = [(UARPSuperBinary *)self initWithData:v12 delegate:delegateCopy delegateQueue:queueCopy];
...
- (UARPSuperBinary)initWithURL:(id)l delegate:(id)delegate delegateQueue:(id)queue
{
  ...
  v12 = [(UARPSuperBinary *)self initWithData:v11 delegate:delegateCopy delegateQueue:queueCopy];
...
- (BOOL)expandMetaData:(UARPSuperBinaryHeader *)data
{
  superBinaryMetadataLength = data->superBinaryMetadataLength;
  if (!superBinaryMetadataLength)
  {
    return 1;
  }

  v6 = data->superBinaryMetadataOffset + superBinaryMetadataLength;
  if ([(NSData *)self->_data length]< v6)
  {
    return 0;
  }

  v8 = [(NSData *)self->_data subdataWithRange:data->superBinaryMetadataOffset, data->superBinaryMetadataLength];
...
- (BOOL)preparePayload:(UARPPayloadHeader2 *)payload
{
  v5 = [[UARPAssetTag alloc] initWithChar1:payload->var1.char1 char2:payload->var1.char2 char3:payload->var1.char3 char4:payload->var1.char4];
  v6 = [[UARPAssetVersion alloc] initWithMajorVersion:payload->var2.major minorVersion:payload->var2.minor releaseVersion:payload->var2.release buildVersion:payload->var2.build];
...
- (id)generatePersonalizedSuperBinaryInternal:(id)internal
{
  ...
  v34[1] = 44;
  majorVersion = [(UARPAssetVersion *)self->_version majorVersion];
  minorVersion = [(UARPAssetVersion *)self->_version minorVersion];
  releaseVersion = [(UARPAssetVersion *)self->_version releaseVersion];
  buildVersion = [(UARPAssetVersion *)self->_version buildVersion];
  v42 = 44;
  v43 = 40 * [internalCopy count];
  personalizedMetaData = [(UARPSuperBinary *)self personalizedMetaData];
  v40 = v43 + 44;
  ...
  v10 = malloc_type_calloc([internalCopy count], 0x28uLL, 0x10000400A747E1EuLL);
...
- (BOOL)generateTatsuMeasurements:(unint64_t)measurements relativeURL:(id)l
{
  ...
  {
    [(UARPSuperBinary *)self generateTatsuMeasurements:measurements];
  }

  else
  {
    [(UARPSuperBinary *)self generateTatsuMeasurementsPerPayload:measurements];
  }
...
- (id)tatsuMeasurements:(unint64_t)measurements
{
  ...
  if (v5)
  {
    v5 = [(UARPSuperBinary *)self composeTSSRequest:measurements asMeasurement:1];
  }
...
- (id)composeTSSRequest:(unint64_t)request asMeasurement:(BOOL)measurement
{
  ...
  requiredTSSOptions = [(UARPSuperBinary *)self requiredTSSOptions];
  v10 = objc_opt_new();
      ...
      do
      {
        ...
        if (unsignedLongValue <= 9)
        {
          if (unsignedLongValue <= 6)
          {
            ...
            {
              v19 = [(UARPSuperBinary *)self tssKeyName:@"BoardID" unitNumber:request];
              v24 = MEMORY[0x277CCABB0];
              boardID = [(UARPSuperBinary *)self boardID];
            }
            ...
            else
            {
              ...
              v19 = [(UARPSuperBinary *)self tssKeyName:@"ChipID" unitNumber:request];
              v24 = MEMORY[0x277CCABB0];
              boardID = [(UARPSuperBinary *)self chipID];
            }
          ...
          {
            v19 = [(UARPSuperBinary *)self tssKeyName:@"ECID" unitNumber:request];
            nonce = [MEMORY[0x277CCABB0] numberWithUnsignedLongLong:{-[UARPSuperBinary ecID](self, "ecID")}];
            goto LABEL_32;
          }

          if (unsignedLongValue != 8)
          {
            v19 = [(UARPSuperBinary *)self tssKeyName:@"SecurityMode" unitNumber:request];
            securityMode = [(UARPSuperBinary *)self securityMode];
            goto LABEL_34;
          }

          v19 = [(UARPSuperBinary *)self tssKeyName:@"SecurityDomain" unitNumber:request];
          v20 = MEMORY[0x277CCABB0];
          securityDomain = [(UARPSuperBinary *)self securityDomain];
          goto LABEL_30;
        }
        ...
        if (unsignedLongValue > 25)
        {
          ...
          {
            v19 = [(UARPSuperBinary *)self tssKeyName:@"Provisioning" unitNumber:request];
...
LABEL_38:
          ...
          v19 = [(UARPSuperBinary *)self tssKeyName:@"ManifestEpoch" unitNumber:request];
          v20 = MEMORY[0x277CCABB0];
          securityDomain = [(UARPSuperBinary *)self manifestEpoch];
          goto LABEL_30;
        }

        if (unsignedLongValue == 10)
        {
          v19 = [(UARPSuperBinary *)self tssKeyName:@"ProductionMode" unitNumber:request];
          securityMode = [(UARPSuperBinary *)self productionMode];
LABEL_34:
          if (securityMode)
          {
            ecidData = MEMORY[0x277CBEC38];
        ...
        if (unsignedLongValue != 24)
        {
          ...
          v19 = [(UARPSuperBinary *)self tssKeyName:@"Life" unitNumber:request];
          v20 = MEMORY[0x277CCABB0];
          securityDomain = [(UARPSuperBinary *)self life];
LABEL_30:
          nonce = [v20 numberWithUnsignedChar:securityDomain];
          goto LABEL_32;
        }

        v19 = [(UARPSuperBinary *)self tssKeyName:@"Nonce" unitNumber:request];
        nonce = [(UARPSuperBinary *)self nonce];
LABEL_32:
        v27 = nonce;
                  ...
                  for (j = 0; j != v14; ++j)
                  {
                    ...
                    else
                    {
                      ...
                      else
                      {
                        ...
                        {
                          if ([(UARPSuperBinary *)selfCopy productionMode])
                          {
...
- (id)getDataBlock:(unint64_t)block offset:(unint64_t)offset
{
  ...
  self->_totalBytesRequested += [block length];
