...
+ (FedStatsSQLiteDatabase)databaseWithURL:(id)a3 mode:(char)a4 error:(id *)a5
{
  ...
  if (objc_opt_isKindOfClass())
  {
    ...
    v10 = [MEMORY[0x277CCACE0] componentsWithURL:v8 resolvingAgainstBaseURL:1];
    v38 = 0;
    if (v6 == 97)
    {
      v26 = [v8 path];
      v27 = [v9 fileExistsAtPath:v26 isDirectory:&v38];
...
LABEL_35:
        ...
        v15 = [MEMORY[0x277CCACA8] stringWithFormat:@"Cannot load database: %s", sqlite3_errmsg(ppDb)];
        v25 = v15;
        goto LABEL_38;
      }
    ...
    if (v6 != 119)
    {
      ...
      v11 = [v8 path];
      v12 = [v9 fileExistsAtPath:v11 isDirectory:&v38];
      ...
      if (v38 != 1)
      {
        ...
        if (v14)
        {
          v15 = [MEMORY[0x277CCAD18] queryItemWithName:@"nolock" value:@"1"];
          v39[0] = v15;
...
LABEL_40:
    ...
    v21 = [v9 fileExistsAtPath:v20 isDirectory:&v38];
    v22 = v38;
    ...
    if (v21 && v22)
    {
      v17 = 33554502;
      v23 = [v8 path];
      v24 = [v9 fileExistsAtPath:v23 isDirectory:&v38];
...
LABEL_34:
      ...
      {
        v37 = 0;
        v29 = [v9 removeItemAtURL:v8 error:&v37];
        v16 = v37;
        if ((v29 & 1) == 0)
        {
          if (a5)
...
- (BOOL)execute:(id)a3 error:(id *)a4
{
  ...
  if (a4 && v9)
  {
    v11 = [MEMORY[0x277CCACA8] stringWithFormat:@"Database execute error: %s", errmsg];
