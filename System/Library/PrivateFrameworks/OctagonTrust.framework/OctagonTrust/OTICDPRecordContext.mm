...
- (void)mergeFrom:(id)from
{
  ...
  else
  {
    ...
    [(OTICDPRecordContext *)self setCdpInfo:?];
  }
...
LABEL_7:
  ...
  {
    [(OTICDPRecordContext *)self setAuthInfo:?];
  }
...
- (id)description
{
  ...
  v8.receiver = self;
  v8.super_class = OTICDPRecordContext;
  v4 = [(OTICDPRecordContext *)&v8 description];
  dictionaryRepresentation = [(OTICDPRecordContext *)self dictionaryRepresentation];
