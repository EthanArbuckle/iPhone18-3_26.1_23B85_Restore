...
LABEL_72:
    ...
    v40[10] = @"FaceTime";
    v40[11] = @"CoreSpeech";
    v41[10] = &unk_285379EA0;
    v41[11] = &unk_285379EF0;
    v40[12] = @"WiFi";
    v41[12] = v11;
...
+ (void)allowDampeningExceptionFor:(uint64_t)a1 .cold.1(uint64_t a1, NSObject *a2)
{
  ...
  v3 = 138412290;
  v4 = a1;
  _os_log_debug_impl(&dword_241804000, a2, OS_LOG_TYPE_DEBUG, "Comparing case signature %@ against allowed exceptions list.", &v3, 0xCu);
...
+ (void)allowDampeningExceptionFor:(uint64_t)a1 .cold.2(uint64_t a1, void *a2)
{
  ...
  OUTLINED_FUNCTION_0();
  OUTLINED_FUNCTION_1(&dword_241804000, v5, v6, "Found unexpected object %@ of class %@ as exception for domain %@", v7, v8, v9, v10, v12);
...
+ (void)allowDampeningExceptionFor:(uint64_t)a1 .cold.3(uint64_t a1, void *a2)
{
  ...
  v4 = NSStringFromClass(v3);
  OUTLINED_FUNCTION_0();
  OUTLINED_FUNCTION_1(&dword_241804000, v5, v6, "Found unexpected object %@ of class %@ as exception for type %@", v7, v8, v9, v10, v12);
...
+ (void)allowDampeningExceptionFor:(uint64_t)a1 .cold.4(uint64_t a1, void *a2)
{
  ...
  v4 = NSStringFromClass(v3);
  OUTLINED_FUNCTION_0();
  OUTLINED_FUNCTION_1(&dword_241804000, v5, v6, "Found unexpected object %@ of class %@ as exception for subtype %@", v7, v8, v9, v10, v12);
