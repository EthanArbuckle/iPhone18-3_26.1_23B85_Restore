...
{
  v5 = a4;
  v6 = -[WFStageManagerTriggerConfigurationViewController infoForSection:](self, "infoForSection:", [v5 section]);
...
- (id)tableView:(id)a3 titleForHeaderInSection:(int64_t)a4
{
  v4 = [(WFStageManagerTriggerConfigurationViewController *)self infoForSection:a4];
...
- (int64_t)tableView:(id)a3 numberOfRowsInSection:(int64_t)a4
{
  v5 = [(WFStageManagerTriggerConfigurationViewController *)self infoForSection:a4];
...
- (WFStageManagerTriggerConfigurationViewController)initWithTrigger:(id)a3 mode:(unint64_t)a4
{
  ...
  if ((objc_opt_isKindOfClass() & 1) == 0)
  {
    ...
    [v12 handleFailureInMethod:a2 object:self file:@"WFStageManagerTriggerConfigurationViewController.m" lineNumber:32 description:{@"Invalid parameter not satisfying: %@", @"[trigger isKindOfClass:[WFStageManagerTrigger class]]"}];
  }
