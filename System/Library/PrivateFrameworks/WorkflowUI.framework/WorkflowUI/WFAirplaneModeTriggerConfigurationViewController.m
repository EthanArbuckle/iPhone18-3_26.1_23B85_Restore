...
{
  v5 = a4;
  v6 = -[WFAirplaneModeTriggerConfigurationViewController infoForSection:](self, "infoForSection:", [v5 section]);
...
- (int64_t)tableView:(id)a3 numberOfRowsInSection:(int64_t)a4
{
  v5 = [(WFAirplaneModeTriggerConfigurationViewController *)self infoForSection:a4];
...
- (WFAirplaneModeTriggerConfigurationViewController)initWithTrigger:(id)a3 mode:(unint64_t)a4
{
  ...
  if ((objc_opt_isKindOfClass() & 1) == 0)
  {
    ...
    [v12 handleFailureInMethod:a2 object:self file:@"WFAirplaneModeTriggerConfigurationViewController.m" lineNumber:32 description:{@"Invalid parameter not satisfying: %@", @"[trigger isKindOfClass:[WFAirplaneModeTrigger class]]"}];
  }
