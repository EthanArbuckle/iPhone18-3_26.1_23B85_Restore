...
{
  v5 = a4;
  v7 = -[WFPlugInTriggerConfigurationViewController infoForSection:](self, "infoForSection:", [v5 section]);
...
- (id)tableView:(id)a3 titleForHeaderInSection:(int64_t)a4
{
  v4 = [(WFPlugInTriggerConfigurationViewController *)self infoForSection:a4];
...
- (int64_t)tableView:(id)a3 numberOfRowsInSection:(int64_t)a4
{
  v5 = [(WFPlugInTriggerConfigurationViewController *)self infoForSection:a4];
...
- (WFPlugInTriggerConfigurationViewController)initWithTrigger:(id)a3 mode:(unint64_t)a4
{
  ...
  if ((objc_opt_isKindOfClass() & 1) == 0)
  {
    ...
    [v12 handleFailureInMethod:a2 object:self file:@"WFPlugInTriggerConfigurationViewController.m" lineNumber:32 description:{@"Invalid parameter not satisfying: %@", @"[trigger isKindOfClass:[WFPlugInTrigger class]]"}];
  }
