...
- (void)viewDidLoad
{
  ...
  [platterView setAccessibilityIdentifier:@"junior_link_snippet_action_platter_view"];

  objc_initWeak(&location, self);
  doneButton = [MEMORY[0x277D79F28] doneButton];
  v7 = MEMORY[0x277D85DD0];
  v8 = 3221225472;
  v9 = __54__WFLinkSnippetActionDialogViewController_viewDidLoad__block_invoke;
  v10 = &unk_279EE8908;
  objc_copyWeak(&v11, &location);
  v5 = [WFCompactDialogAction actionForButton:doneButton handler:&v7];
  v14[0] = v5;
