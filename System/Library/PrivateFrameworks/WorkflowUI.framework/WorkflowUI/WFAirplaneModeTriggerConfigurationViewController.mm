...
- (WFAirplaneModeTriggerConfigurationViewController)initWithTrigger:(id)trigger mode:(unint64_t)mode;
- (id)customSections;
...
{
  pathCopy = path;
  v6 = -[WFAirplaneModeTriggerConfigurationViewController infoForSection:](self, "infoForSection:", [pathCopy section]);
...
- (id)tableView:(id)view titleForHeaderInSection:(int64_t)section
{
  v4 = [(WFAirplaneModeTriggerConfigurationViewController *)self infoForSection:section];
...
- (id)tableView:(id)view cellForRowAtIndexPath:(id)path
{
  pathCopy = path;
  viewCopy = view;
  v8 = -[WFAirplaneModeTriggerConfigurationViewController infoForSection:](self, "infoForSection:", [pathCopy section]);
...
- (int64_t)tableView:(id)view numberOfRowsInSection:(int64_t)section
{
  v5 = [(WFAirplaneModeTriggerConfigurationViewController *)self infoForSection:section];
...
{
  v5.receiver = self;
  v5.super_class = WFAirplaneModeTriggerConfigurationViewController;
  [(WFAirplaneModeTriggerConfigurationViewController *)&v5 viewWillAppear:appear];
  tableView = [(WFTriggerConfigurationViewController *)self tableView];
  [tableView reloadData];
}
...
- (WFAirplaneModeTriggerConfigurationViewController)initWithTrigger:(id)trigger mode:(unint64_t)mode
{
  ...
  if ((objc_opt_isKindOfClass() & 1) == 0)
  {
    ...
    [currentHandler handleFailureInMethod:a2 object:self file:@"WFAirplaneModeTriggerConfigurationViewController.m" lineNumber:32 description:{@"Invalid parameter not satisfying: %@", @"[trigger isKindOfClass:[WFAirplaneModeTrigger class]]"}];
  }

  v13.receiver = self;
  v13.super_class = WFAirplaneModeTriggerConfigurationViewController;
