...
{
  v5 = a4;
  v7 = -[WFCarPlayConnectionTriggerConfigurationViewController infoForSection:](self, "infoForSection:", [v5 section]);
...
- (int64_t)tableView:(id)a3 numberOfRowsInSection:(int64_t)a4
{
  v5 = [(WFCarPlayConnectionTriggerConfigurationViewController *)self infoForSection:a4];
...
- (WFCarPlayConnectionTriggerConfigurationViewController)initWithTrigger:(id)a3 mode:(unint64_t)a4
{
  ...
  if ((objc_opt_isKindOfClass() & 1) == 0)
  {
    ...
    [v12 handleFailureInMethod:a2 object:self file:@"WFCarPlayConnectionTriggerConfigurationViewController.m" lineNumber:31 description:{@"Invalid parameter not satisfying: %@", @"[trigger isKindOfClass:[WFCarPlayConnectionTrigger class]]"}];
  }
