...
- (WFPlugInTriggerConfigurationViewController)initWithTrigger:(id)trigger mode:(unint64_t)mode;
- (id)customSections;
...
{
  pathCopy = path;
  v7 = -[WFPlugInTriggerConfigurationViewController infoForSection:](self, "infoForSection:", [pathCopy section]);
...
- (id)tableView:(id)view titleForHeaderInSection:(int64_t)section
{
  v4 = [(WFPlugInTriggerConfigurationViewController *)self infoForSection:section];
...
- (int64_t)tableView:(id)view numberOfRowsInSection:(int64_t)section
{
  v5 = [(WFPlugInTriggerConfigurationViewController *)self infoForSection:section];
...
- (id)tableView:(id)view cellForRowAtIndexPath:(id)path
{
  pathCopy = path;
  viewCopy = view;
  v8 = -[WFPlugInTriggerConfigurationViewController infoForSection:](self, "infoForSection:", [pathCopy section]);
...
- (WFPlugInTriggerConfigurationViewController)initWithTrigger:(id)trigger mode:(unint64_t)mode
{
  ...
  if ((objc_opt_isKindOfClass() & 1) == 0)
  {
    ...
    [currentHandler handleFailureInMethod:a2 object:self file:@"WFPlugInTriggerConfigurationViewController.m" lineNumber:32 description:{@"Invalid parameter not satisfying: %@", @"[trigger isKindOfClass:[WFPlugInTrigger class]]"}];
  }

  v13.receiver = self;
  v13.super_class = WFPlugInTriggerConfigurationViewController;
