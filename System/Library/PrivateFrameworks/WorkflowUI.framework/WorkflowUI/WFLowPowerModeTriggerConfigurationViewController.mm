...
- (WFLowPowerModeTriggerConfigurationViewController)initWithTrigger:(id)trigger mode:(unint64_t)mode;
- (id)customSections;
...
- (id)tableView:(id)view titleForHeaderInSection:(int64_t)section
{
  v4 = [(WFLowPowerModeTriggerConfigurationViewController *)self infoForSection:section];
...
{
  pathCopy = path;
  v7 = -[WFLowPowerModeTriggerConfigurationViewController infoForSection:](self, "infoForSection:", [pathCopy section]);
...
- (id)tableView:(id)view cellForRowAtIndexPath:(id)path
{
  pathCopy = path;
  viewCopy = view;
  v8 = -[WFLowPowerModeTriggerConfigurationViewController infoForSection:](self, "infoForSection:", [pathCopy section]);
...
- (int64_t)tableView:(id)view numberOfRowsInSection:(int64_t)section
{
  v5 = [(WFLowPowerModeTriggerConfigurationViewController *)self infoForSection:section];
...
{
  v5.receiver = self;
  v5.super_class = WFLowPowerModeTriggerConfigurationViewController;
  [(WFLowPowerModeTriggerConfigurationViewController *)&v5 viewWillAppear:appear];
  tableView = [(WFTriggerConfigurationViewController *)self tableView];
  [tableView reloadData];
}
...
- (WFLowPowerModeTriggerConfigurationViewController)initWithTrigger:(id)trigger mode:(unint64_t)mode
{
  ...
  if ((objc_opt_isKindOfClass() & 1) == 0)
  {
    ...
    [currentHandler handleFailureInMethod:a2 object:self file:@"WFLowPowerModeTriggerConfigurationViewController.m" lineNumber:32 description:{@"Invalid parameter not satisfying: %@", @"[trigger isKindOfClass:[WFLowPowerModeTrigger class]]"}];
  }

  v13.receiver = self;
  v13.super_class = WFLowPowerModeTriggerConfigurationViewController;
