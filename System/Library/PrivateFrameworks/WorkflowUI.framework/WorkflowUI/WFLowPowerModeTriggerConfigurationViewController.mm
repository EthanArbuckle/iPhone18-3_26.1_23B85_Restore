...
{
  v5 = a4;
  v7 = -[WFLowPowerModeTriggerConfigurationViewController infoForSection:](self, "infoForSection:", [v5 section]);
...
- (id)tableView:(id)a3 cellForRowAtIndexPath:(id)a4
{
  ...
  else
  {
    ...
    [v34 setLeftViewSelected:{objc_msgSend(v23, "onEnable")}];

    v24 = [(WFTriggerConfigurationViewController *)self trigger];
    [v34 setRightViewSelected:{objc_msgSend(v24, "onDisable")}];
...
- (int64_t)tableView:(id)a3 numberOfRowsInSection:(int64_t)a4
{
  v5 = [(WFLowPowerModeTriggerConfigurationViewController *)self infoForSection:a4];
...
- (WFLowPowerModeTriggerConfigurationViewController)initWithTrigger:(id)a3 mode:(unint64_t)a4
{
  ...
  if ((objc_opt_isKindOfClass() & 1) == 0)
  {
    ...
    [v12 handleFailureInMethod:a2 object:self file:@"WFLowPowerModeTriggerConfigurationViewController.m" lineNumber:32 description:{@"Invalid parameter not satisfying: %@", @"[trigger isKindOfClass:[WFLowPowerModeTrigger class]]"}];
  }
