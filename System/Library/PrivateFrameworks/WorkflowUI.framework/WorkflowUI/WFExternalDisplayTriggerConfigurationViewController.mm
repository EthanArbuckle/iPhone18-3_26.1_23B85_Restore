...
- (WFExternalDisplayTriggerConfigurationViewController)initWithTrigger:(id)trigger mode:(unint64_t)mode;
- (id)customSections;
...
- (id)tableView:(id)view titleForHeaderInSection:(int64_t)section
{
  v4 = [(WFExternalDisplayTriggerConfigurationViewController *)self infoForSection:section];
...
{
  pathCopy = path;
  v6 = -[WFExternalDisplayTriggerConfigurationViewController infoForSection:](self, "infoForSection:", [pathCopy section]);
...
- (int64_t)tableView:(id)view numberOfRowsInSection:(int64_t)section
{
  v5 = [(WFExternalDisplayTriggerConfigurationViewController *)self infoForSection:section];
...
- (id)tableView:(id)view cellForRowAtIndexPath:(id)path
{
  pathCopy = path;
  viewCopy = view;
  v8 = -[WFExternalDisplayTriggerConfigurationViewController infoForSection:](self, "infoForSection:", [pathCopy section]);
...
- (WFExternalDisplayTriggerConfigurationViewController)initWithTrigger:(id)trigger mode:(unint64_t)mode
{
  ...
  if ((objc_opt_isKindOfClass() & 1) == 0)
  {
    ...
    [currentHandler handleFailureInMethod:a2 object:self file:@"WFExternalDisplayTriggerConfigurationViewController.m" lineNumber:32 description:{@"Invalid parameter not satisfying: %@", @"[trigger isKindOfClass:[WFExternalDisplayTrigger class]]"}];
  }
