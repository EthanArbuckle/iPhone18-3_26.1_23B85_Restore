...
{
  v5 = a4;
  v7 = -[WFDNDTriggerConfigurationViewController infoForSection:](self, "infoForSection:", [v5 section]);
...
- (int64_t)tableView:(id)a3 numberOfRowsInSection:(int64_t)a4
{
  v5 = [(WFDNDTriggerConfigurationViewController *)self infoForSection:a4];
...
{
  v5.receiver = self;
  v5.super_class = WFDNDTriggerConfigurationViewController;
...
- (WFDNDTriggerConfigurationViewController)initWithTrigger:(id)a3 mode:(unint64_t)a4
{
  ...
  if ((objc_opt_isKindOfClass() & 1) == 0)
  {
    ...
    [v12 handleFailureInMethod:a2 object:self file:@"WFDNDTriggerConfigurationViewController.m" lineNumber:32 description:{@"Invalid parameter not satisfying: %@", @"[trigger isKindOfClass:[WFDNDTrigger class]]"}];
  }

  v13.receiver = self;
  v13.super_class = WFDNDTriggerConfigurationViewController;
