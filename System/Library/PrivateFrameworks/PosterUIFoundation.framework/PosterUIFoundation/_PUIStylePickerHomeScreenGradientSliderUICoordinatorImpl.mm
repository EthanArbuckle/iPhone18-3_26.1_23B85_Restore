...
- (void)setVariation:(double)variation
{
  ...
  [(PUIStyleUICoordinatorImpl *)&v5 setVariation:variation];
  effectiveColor = [(_PUIStylePickerHomeScreenGradientSliderUICoordinatorImpl *)self effectiveColor];
...
{
  style = [(PUIStyleUICoordinatorImpl *)self style];
  copyWithResetSaturation = [style copyWithResetSaturation];

  v5 = [copyWithResetSaturation copyWithLuminance:0.0];
...
- (void)_updateVariationSliderTrackView
{
  ...
  v9[5] = v6;
  v7 = [colors bs_map:v9];
  v8 = [colors bs_map:&__block_literal_global_333];
