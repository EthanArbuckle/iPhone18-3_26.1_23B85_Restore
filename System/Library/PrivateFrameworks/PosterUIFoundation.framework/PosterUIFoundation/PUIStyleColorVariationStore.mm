...
- (PUIStyleColorVariationStore)initWithVariationStorage:(id)storage version:(unint64_t)version;
...
{
  colorCopy = color;
  v6 = [[PUIStyleColor alloc] initWithColor:colorCopy preferredStyle:0];

  v7 = variation * -0.25;
  hslValues = [(PUIStyleColor *)v6 hslValues];
  [hslValues luminance];
  v10 = v9;
  ...
  v12 = [(PUIStyleColor *)v6 copyWithLuminance:v11];
...
- (PUIStyleColorVariationStore)initWithVariationStorage:(id)storage version:(unint64_t)version
{
  storageCopy = storage;
  v14.receiver = self;
  v14.super_class = PUIStyleColorVariationStore;
  v7 = [(PUIStyleColorVariationStore *)&v14 init];
  if (v7)
  {
...
- (PUIStyleColorVariationStore)init
{
  ...
  return [(PUIStyleColorVariationStore *)self initWithVariationStorage:0 version:version];
}
...
void __105__PUIStyleColorVariationStore_baseColorForVariedColor_forContextIdentifier_variation_forDataLayerPicker___block_invoke(uint64_t a1, void *a2, void *a3, _BYTE *a4)
{
  ...
  v11 = [(PUIStyleColor *)v16 identifier];
  v12 = [v7 isEqualToString:v11];

  if (v12)
  {
    v13 = [(PUIStyleColor *)v16 color];
    v14 = *(*(a1 + 48) + 8);
    v15 = *(v14 + 40);
    *(v14 + 40) = v13;
