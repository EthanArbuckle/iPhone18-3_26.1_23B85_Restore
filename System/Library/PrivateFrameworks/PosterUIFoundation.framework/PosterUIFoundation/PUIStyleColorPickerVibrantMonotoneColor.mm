...
- (BOOL)isEqual:(id)a3
{
  ...
  else
  {
    ...
    if (isKindOfClass)
    {
      ...
      v9 = [(PUIStyleColorPickerVibrantMonotoneColor *)v7 color];
      v10 = BSEqualObjects();
      ...
      {
        v19 = [(PUIStyleColorPickerVibrantMonotoneColor *)self localizedName];
...
- (unint64_t)hash
{
  ...
  v4 = [(PUIStyleColorPickerVibrantMonotoneColor *)self color];
  v5 = [v3 appendObject:v4];

  v6 = [(PUIStyleColorPickerVibrantMonotoneColor *)self displayColors];
  ...
  {
    v9 = [(PUIStyleColorPickerVibrantMonotoneColor *)self localizedName];
...
- (void)encodeWithCoder:(id)a3
{
  ...
  v5 = [(PUIStyleColorPickerVibrantMonotoneColor *)self displayColors];
  [v7 encodeObject:v5 forKey:@"displayColors"];

  if (self->_localizedName)
  {
    v6 = [(PUIStyleColorPickerVibrantMonotoneColor *)self localizedName];
...
- (void)encodeWithBSXPCCoder:(id)a3
{
  ...
  v4 = a3;
  v5 = [(PUIStyleColorPickerVibrantMonotoneColor *)self color];
  [v4 encodeObject:v5 forKey:@"color"];

  v6 = [(PUIStyleColorPickerVibrantMonotoneColor *)self displayColors];
  v7 = MEMORY[0x1E695DF70];
  v8 = [(PUIStyleColorPickerVibrantMonotoneColor *)self displayColors];
...
- (void)appendDescriptionToFormatter:(id)a3
{
  ...
  v8 = [(PUIStyleColorPickerVibrantMonotoneColor *)self localizedName];
