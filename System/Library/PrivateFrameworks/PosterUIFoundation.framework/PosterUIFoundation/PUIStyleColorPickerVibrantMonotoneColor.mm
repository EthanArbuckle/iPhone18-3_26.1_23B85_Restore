...
- (PUIStyleColorPickerVibrantMonotoneColor)colorWithVariation:(double)variation;
- (PUIStyleColorPickerVibrantMonotoneColor)initWithBSXPCCoder:(id)coder;
- (PUIStyleColorPickerVibrantMonotoneColor)initWithCoder:(id)coder;
- (PUIStyleColorPickerVibrantMonotoneColor)initWithColor:(id)color displayColors:(id)colors localizedName:(id)name;
...
- (PUIStyleColorPickerVibrantMonotoneColor)initWithColor:(id)color displayColors:(id)colors localizedName:(id)name
{
  ...
  nameCopy = name;
  v19.receiver = self;
  v19.super_class = PUIStyleColorPickerVibrantMonotoneColor;
  ...
  if (v12)
  {
    ...
    v14 = [(NSDictionary *)v13->_displayColors objectForKeyedSubscript:&unk_1F1C92988];
...
- (NSString)localizedName
{
  ...
  {
    localizedName = [(PUIStyleColor *)self->_activeDisplayColor localizedName];
  }
...
- (void)setContentsLuminance:(double)luminance
{
  v4 = PUIStyleBackgroundTypeForLuminance(luminance);
...
- (id)displayColorWithVariation:(double)variation
{
  ...
  v4 = [(PUIStyleColor *)self->_activeDisplayColor copyWithLuminance:?];
...
- (BOOL)isEqual:(id)equal
{
  ...
  else
  {
    ...
    {
      v7 = equalCopy;
      color = [(PUIStyleColorPickerVibrantMonotoneColor *)self color];
      color2 = [(PUIStyleColorPickerVibrantMonotoneColor *)v7 color];
      v10 = BSEqualObjects();

      if (v10 && ([(PUIStyleColorPickerVibrantMonotoneColor *)self displayColors], v11 = objc_claimAutoreleasedReturnValue(), [(PUIStyleColorPickerVibrantMonotoneColor *)v7 displayColors], v12 = objc_claimAutoreleasedReturnValue(), v13 = BSEqualObjects(), v12, v11, v13) && ([(PUIStyleColorPickerVibrantMonotoneColor *)self initialVariation], v15 = v14, [(PUIStyleColorPickerVibrantMonotoneColor *)v7 initialVariation], v15 == v16))
      {
        localizedName = [(PUIStyleColorPickerVibrantMonotoneColor *)self localizedName];
        localizedName2 = [(PUIStyleColorPickerVibrantMonotoneColor *)v7 localizedName];
        v17 = BSEqualStrings();
      }
...
- (unint64_t)hash
{
  ...
  displayColors = [(PUIStyleColorPickerVibrantMonotoneColor *)self displayColors];
...
- (PUIStyleColorPickerVibrantMonotoneColor)initWithCoder:(id)coder
{
  ...
  v10 = [(PUIStyleColorPickerVibrantMonotoneColor *)self initWithColor:v6 displayColors:v8 localizedName:v9];
  return v10;
}
...
- (void)encodeWithBSXPCCoder:(id)coder
{
  ...
  displayColors2 = [(PUIStyleColorPickerVibrantMonotoneColor *)self displayColors];
...
- (PUIStyleColorPickerVibrantMonotoneColor)initWithBSXPCCoder:(id)coder
{
  ...
  v13 = [(PUIStyleColorPickerVibrantMonotoneColor *)self initWithColor:v6 displayColors:v11 localizedName:v12];
  return v13;
}
