...
- (PUIStylePickerImageButton)initWithFrame:(CGRect)frame;
...
- (PUIStylePickerImageButton)initWithFrame:(CGRect)frame
{
  ...
  v3 = [(PUIStylePickerButton *)&v26 initWithFrame:frame.origin.x, frame.origin.y, frame.size.width, frame.size.height];
  if (v3)
  {
    ...
    centerXAnchor2 = [(PUIStylePickerImageButton *)v3 centerXAnchor];
    v9 = [centerXAnchor constraintEqualToAnchor:centerXAnchor2];
    v27[2] = v9;
    leadingAnchor = [(UIImageView *)v3->_contentImageView leadingAnchor];
    leadingAnchor2 = [(PUIStylePickerImageButton *)v3 leadingAnchor];
    ...
    trailingAnchor2 = [(PUIStylePickerImageButton *)v3 trailingAnchor];
