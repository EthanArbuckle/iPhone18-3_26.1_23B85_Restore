...
+ (id)createPlatterView
{
  ...
  v7[0] = [(CPSCardPlatterView *)v3 initWithFrame:15 cornerRadius:crsui_clusterTurnCardETATrayBackgroundMaterial maskedCorners:*MEMORY[0x277CBF3A0] backgroundMaterial:*(MEMORY[0x277CBF3A0] + 8) backgroundColor:*(MEMORY[0x277CBF3A0] + 16), *(MEMORY[0x277CBF3A0] + 24), 12.0];
