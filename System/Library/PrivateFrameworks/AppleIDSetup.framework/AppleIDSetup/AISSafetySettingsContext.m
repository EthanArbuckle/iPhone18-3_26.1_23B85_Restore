...
- (AISSafetySettingsContext)initWithFlowType:(int64_t)a3;
...
- (AISSafetySettingsContext)initWithFlowType:(int64_t)a3
{
  *(&self->super.isa + OBJC_IVAR___AISSafetySettingsContext_flowType) = a3;
  v4.receiver = self;
...
- (NSString)description
{
  ...
  v5 = *(&v2->super.isa + OBJC_IVAR___AISSafetySettingsContext_flowType);
  sub_24075A994();
