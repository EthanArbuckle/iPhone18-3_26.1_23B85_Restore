...
{
  v4 = a3;
  v5 = [_SSIdToContactCache objectForKey:v4];
  if (!v5)
  {
    ...
    if (v5)
    {
      [_SSIdToContactCache setObject:v5 forKey:v4];
    }
...
{
  v4 = a3;
  v5 = [_SSEmailToContactCache objectForKey:v4];
  if (!v5)
  {
    v5 = [a1 _contactWithEmail:v4 keysToFetch:MEMORY[0x1E695E0F0]];
  }
...
+ (id)contactWithEmailForMailResults:(id)a3
{
  ...
  if (!v5)
  {
    ...
    if (v5)
    {
      [_SSEmailToContactCache setObject:v5 forKey:v4];
    }
...
+ (id)_contactsWithEmails:(id)a3 keysToFetch:(id)a4
{
  ...
  v9 = [MEMORY[0x1E695CD58] predicateForContactsMatchingHandleStrings:v7];
...
+ (id)_contactsWithIds:(id)a3
{
  v4 = [MEMORY[0x1E695CD58] predicateForContactsWithIdentifiers:a3];
...
+ (void)precacheContactsForResults:(id)a3
{
  ...
  v3 = a3;
  v4 = [SSMailResultBuilder authorEmailsFromResults:v3];
  v5 = objc_opt_new();
  v53 = [_SSEmailToContactCache mapTableRepresentation];
  ...
  v54 = v3;
  v14 = [SSContactResultBuilder contactIdentifiersFromResults:v3];
  v15 = objc_opt_new();
  v51 = [_SSIdToContactCache mapTableRepresentation];
    ...
    if (v35)
    {
      ...
      do
      {
        for (m = 0; m != v36; ++m)
        {
          ...
          v39 = *(*(&v64 + 1) + 8 * m);
          v40 = [v39 identifier];
          [_SSIdToContactCache setObject:v39 forKey:v40];
