...
- (spotlight_l3_1Input)initWithId_features:(id)a3 dense_features:(id)a4
{
  ...
  if (v9)
  {
    objc_storeStrong(&v9->_id_features, a3);
    objc_storeStrong(&v10->_dense_features, a4);
  }
...
- (id)featureValueForName:(id)a3
{
  ...
  if ([v4 isEqualToString:@"id_features"])
  {
    ...
    v6 = [(spotlight_l3_1Input *)self id_features];
LABEL_5:
    v7 = v6;
  ...
  {
    v5 = MEMORY[0x1E695FE60];
    v6 = [(spotlight_l3_1Input *)self dense_features];
    goto LABEL_5;
  }
