...
- (void)_fillTransferFailure:(id)a3 withRowID:(unint64_t)a4 atDate:(id)a5 session:(id)a6
{
  ...
  v12 = a3;
  v13 = [v11 clientDB];
  v14 = [v13 fetch:{@"SELECT ci.zone_rowid, IFNULL(si.pcs_state, 0) FROM client_items AS ci LEFT JOIN server_items AS si ON ci.item_id = si.item_id AND ci.zone_rowid = si.zone_rowid WHERE ci.rowid = %lld", a4}];
  ...
  if ([v14 next])
  {
    ...
    [v12 encounteredErrorWithPCSState:v16 enhancedDrivePrivacyEnabled:objc_msgSend(v18 privateDB:"enhancedDrivePrivacyEnabled") atDate:{objc_msgSend(v18, "isSharedZone") ^ 1, v10}];
  }
  ...
  else
  {
    ...
    v21 = [v15 supportsEnhancedDrivePrivacy];
...
- (void)generateReportWithSession:(id)a3
{
  ...
  v190[4] = self;
  [v4 enumerateClientZones:v190];
  self->_totalZoneCount += 4;
  v6 = [v4 containerScheduler];
  v7 = [v6 internalZoneSyncDownAnalyticsErrors];
  v189[0] = MEMORY[0x277D85DD0];
  v189[1] = 3221225472;
  v189[2] = __49__BRCSyncHealthReport_generateReportWithSession___block_invoke_2;
  v189[3] = &unk_2785002C0;
  v189[4] = self;
  [v7 enumerateKeysAndObjectsUsingBlock:v189];

  v8 = [v4 containerScheduler];
  v9 = [v8 internalZoneSyncUpAnalyticsErrors];
  ...
  v177 = self;
  v188[4] = self;
  [v9 enumerateKeysAndObjectsUsingBlock:v188];
  ...
  v186 = v4;
  v13 = [v4 clientDB];
  v14 = [v13 fetch:{@"SELECT error_domain, error_code, error_message, error_timestamp, underlying_error_domain, underlying_error_code, service, item_rowid FROM item_errors"}];
  ...
  if ([v14 next])
  {
    ...
    do
    {
      ...
      v20 = [(BRCSyncHealthReport *)v177 _injectionForAnalyticsServiceCode:v18];
      v21 = [v186 clientDB];
      v22 = [v21 numberWithSQL:{@"SELECT 1 FROM client_items WHERE rowid = %llu %@", v19, v20}];
      ...
      if ([v22 BOOLValue])
      {
        ...
        if ([v182 length])
        {
          ...
          [v24 setObject:v25 forKeyedSubscript:v169];
        }
        ...
        {
          v32 = v177;
          v41 = [(NSMutableSet *)v177->_syncUpFailures member:v31];
          v42 = v41;
          if (v41)
          {
            v43 = v41;
          ...
          v30 = v184;
          [(NSMutableSet *)v177->_syncUpFailures addObject:v44];
          v31 = v44;
        }
        ...
        else
        {
          ...
          {
            v32 = v177;
            v37 = [(NSMutableSet *)v177->_downloadFailures member:v31];
            v38 = v37;
            if (v37)
            {
              v39 = v37;
            ...
            [(NSMutableSet *)v177->_downloadFailures addObject:v40];
            v31 = v40;
          }
          ...
          {
            v32 = v177;
            v33 = [(NSMutableSet *)v177->_uploadFailures member:v31];
            v34 = v33;
            if (v33)
            {
              v35 = v33;
            ...
            [(NSMutableSet *)v177->_uploadFailures addObject:v36];
            v31 = v36;
          }
      ...
      {
        v24 = [v186 clientDB];
        [v24 execute:{@"DELETE FROM item_errors WHERE item_rowid = %llu AND service = %d", v19, v18}];
        v28 = v15;
        v30 = v184;
      }
  ...
  if ([v50 next])
  {
    ...
    do
    {
      ...
      v60 = [(NSMutableSet *)v177->_downloadFailures member:v59];
      v61 = v60;
      if (v60)
      {
        v62 = v60;
      ...
      [(NSMutableSet *)v177->_downloadFailures addObject:v63];
      [(BRCSyncHealthReport *)v177 _fillTransferFailure:v63 withRowID:v53 atDate:v55 session:v186];
  ...
  v64 = [v186 clientDB];
  v65 = [v64 fetchWithSlowStatementRadar:@"rdar://157727651" sql:{@"SELECT COUNT(item_id), item_depth FROM server_items WHERE item_depth < 0 GROUP BY item_depth"}];
  ...
  if ([v65 next])
  {
    ...
    do
    {
      ...
      else
      {
        ...
        v73 = [(NSMutableSet *)v177->_downloadFailures member:v72];
        v74 = v73;
        if (v73)
        {
          v75 = v73;
  ...
  v77 = [v186 clientDB];
  v78 = [v77 fetch:{@"SELECT cu.throttle_id, cu.last_try_stamp FROM client_uploads AS cu INNER JOIN client_items AS li ON cu.throttle_id = li.rowid WHERE cu.last_try_stamp > 0 AND cu.last_try_stamp < %lld AND cu.retry_count = 0 AND cu.throttle_state = 1 AND cu.transfer_queue != '_done' AND li.item_state IN (0) AND li.item_localsyncupstate = 3", contexta}];
  ...
  if ([v78 next])
  {
    ...
    do
    {
      ...
      v88 = [(NSMutableSet *)v177->_uploadFailures member:v87];
      v89 = v88;
      if (v88)
      {
        v90 = v88;
      ...
      [(NSMutableSet *)v177->_uploadFailures addObject:v91];
      [(BRCSyncHealthReport *)v177 _fillTransferFailure:v91 withRowID:v81 atDate:v83 session:v186];
  ...
  v92 = [v186 clientDB];
  v93 = [v92 fetch:{@"SELECT csu.throttle_id, csu.last_try_stamp, li.zone_rowid FROM client_sync_up AS csu INNER JOIN client_items AS li ON csu.throttle_id = li.rowid WHERE csu.last_try_stamp > 0 AND csu.last_try_stamp < %lld AND csu.retry_count = 0 AND csu.throttle_state IN (1, 50) AND csu.throttle_state != 0  AND NOT item_id_is_documents(li.item_id) AND li.item_localsyncupstate = 4", contexta}];
  ...
  if ([v93 next])
  {
    ...
    do
    {
      ...
      v102 = [v101 clientZone];

      if ([v102 isSyncBlocked])
      {
        v103 = 36;
      }
      ...
      if ([v102 isSyncBlockedBecauseAppNotInstalled])
      {
        ...
        [v102 clearStateBits:4096];
        [v102 scheduleSyncUp];
      }

      v107 = [[BRCTransferFailureReport alloc] initWithError:v104];
      v108 = [(NSMutableSet *)v177->_syncUpFailures member:v107];
      v109 = v108;
      if (v108)
      {
        v110 = v108;
      ...
      [(NSMutableSet *)v177->_syncUpFailures addObject:v111];
      v94 = v186;
      [(BRCSyncHealthReport *)v177 _fillTransferFailure:v111 withRowID:v95 atDate:v97 session:v186];
  ...
  v112 = [v94 clientDB];
  v113 = [v112 fetch:{@"SELECT ci.rowid, item_id_is_documents(ci.item_id) FROM client_items AS ci WHERE ci.item_localsyncupstate = 4 AND ci.item_min_supported_os_rowid IS NULL AND NOT EXISTS (SELECT 1 FROM client_sync_up AS cs WHERE cs.throttle_id = ci.rowid AND cs.throttle_state != 0)"}];
  ...
  if ([v113 next])
  {
    ...
    do
    {
      ...
      v127 = [(NSMutableSet *)v177->_syncUpFailures member:v126];
      v128 = v127;
      if (v127)
      {
        v129 = v127;
      ...
      [(NSMutableSet *)v177->_syncUpFailures addObject:v130];
      [(BRCSyncHealthReport *)v177 _fillTransferFailure:v130 withRowID:v117 atDate:v125 session:v186];
  ...
  v131 = [v186 clientDB];
  v132 = [v131 fetch:{@"SELECT ci.rowid FROM client_items AS ci LEFT JOIN client_uploads AS cu ON ci.rowid = cu.throttle_id WHERE ci.item_localsyncupstate = 3 AND ci.item_localsyncupstate != 0 AND ci.item_type IN (1, 6) AND ci.item_state IN (0) AND IFNULL(cu.throttle_state, 0) = 0"}];
  ...
  if ([v132 next])
  {
    ...
    do
    {
      ...
      v141 = [(NSMutableSet *)v177->_uploadFailures member:v140];
      v142 = v141;
      if (v141)
      {
        v143 = v141;
      ...
      [(NSMutableSet *)v177->_uploadFailures addObject:v144];
      [(BRCSyncHealthReport *)v177 _fillTransferFailure:v144 withRowID:v135 atDate:v139 session:v186];
  ...
  v145 = [v186 clientDB];
  v146 = [v145 numberWithSQL:{@"SELECT COUNT(*) FROM client_items WHERE item_type IN (9, 10)"}];
  v177->_clientTruthDirFaultCount = [v146 unsignedLongLongValue];

  v147 = [v186 clientDB];
  v148 = [v147 numberWithSQL:{@"SELECT COUNT(*) FROM server_items WHERE item_type IN (9, 10)"}];
  v177->_serverTruthDirFaultCount = [v148 unsignedLongLongValue];

  v149 = [v186 clientDB];
  v150 = [v149 numberWithSQL:{@"SELECT COUNT(*) FROM server_items WHERE item_type IN (0, 9, 10)"}];
  v177->_serverTruthDirCount = [v150 unsignedLongLongValue];
  ...
  {
    v152 = [v186 clientDB];
    v153 = [v152 numberWithSQL:@"SELECT COUNT(*) FROM server_share_items_participants WHERE (participant_flags & 1) == 1"];
    v177->_danglingShareRequesters = [v153 unsignedLongLongValue];
  }

  v154 = time(0);
  v155 = [v186 clientDB];
  v156 = [v155 numberWithSQL:@"SELECT MIN(date) FROM boot_history"];
  v177->_timeSinceLogin = v154 - [v156 unsignedLongLongValue];

  v177->_zonesNeverFullSync = 0;
  ...
  v157 = [v186 clientDB];
  v158 = [v157 fetchWithSlowStatementRadar:@"<rdar://problem/29182551>" objectOfClass:objc_opt_class() sql:@"SELECT COUNT(1) FROM client_items"];
  v177->_clientTruthTotalItemsCount = [v158 unsignedLongLongValue];

  v159 = [v186 clientDB];
  v160 = [v159 fetchWithSlowStatementRadar:@"<rdar://problem/29182551>" objectOfClass:objc_opt_class() sql:@"SELECT COUNT(1) FROM server_items"];
  v177->_serverTruthTotalItemsCount = [v160 unsignedLongLongValue];

  [(BRCSyncHealthReport *)v177 _collectAggregatedTelemetryForSession:v186];
  v161 = brc_bread_crumbs();
  v162 = brc_default_log();
  if (os_log_type_enabled(v162, OS_LOG_TYPE_DEBUG))
  {
    [BRCSyncHealthReport generateReportWithSession:v177];
  }

  v163 = [v186 accountFacade];
  v164 = [v163 accountDSID];
  dsid = v177->_dsid;
  v177->_dsid = v164;

  v166 = [MEMORY[0x277CCACA8] stringWithFormat:@"%d", objc_msgSend(v163, "rampNumber")];
  rampNumber = v177->_rampNumber;
  v177->_rampNumber = v166;
...
- (void)syncErrors:(id)a3
{
  ...
  if (v28)
  {
    ...
    do
    {
      for (m = 0; m != v29; ++m)
      {
        ...
        v39 = [v32 stringWithFormat:@"syncUpSharedZoneError: %@%ld pcs:%s count:%@", v34, v36, v37, v38];;
        v4[2](v4, v39);
      }
  ...
  v40 = [BRCCoreAnalyticsReporter dictionaryForErrorsByZone:v85->_syncUpErrorsByMangledID wantPrivateZone:1];
  if (![v40 count])
  {
  ...
  if (v42)
  {
    ...
    do
    {
      for (n = 0; n != v43; ++n)
      {
        ...
        v53 = [v46 stringWithFormat:@"syncUpPrivateZoneError: %@%ld pcs:%s count:%@", v48, v50, v51, v52];;
        v4[2](v4, v53);
      }
  ...
  v54 = [BRCCoreAnalyticsReporter dictionaryForErrorsByZone:v85->_syncDownErrorsByMangledID wantPrivateZone:0];
  if (![v54 count])
  {
  ...
  if (v56)
  {
    ...
    do
    {
      for (ii = 0; ii != v57; ++ii)
      {
        ...
        v67 = [v60 stringWithFormat:@"syncDownSharedZoneError: %@%ld pcs:%s count:%@", v62, v64, v65, v66];;
        v4[2](v4, v67);
      }
  ...
  v68 = [BRCCoreAnalyticsReporter dictionaryForErrorsByZone:v85->_syncDownErrorsByMangledID wantPrivateZone:1];
  if (![v68 count])
  {
  ...
  if (v70)
  {
    ...
    do
    {
      for (jj = 0; jj != v71; ++jj)
      {
        ...
        v81 = [v74 stringWithFormat:@"syncDownPrivateZoneError: %@%ld pcs:%s count:%@", v76, v78, v79, v80];;
        v4[2](v4, v81);
      }
...
- (NSArray)telemetryErrorEvents
{
  ...
  if (v7)
  {
    ...
    do
    {
      for (i = 0; i != v7; ++i)
      {
        ...
        v10 = *(*(&v83 + 1) + 8 * i);
        v11 = [v10 privateDBErrorCountByPCSAndEDPState];
        ...
        v81 = v12;
        v82 = &v87;
        [v11 enumerateKeysAndObjectsUsingBlock:v80];

        v13 = [v10 shareDBErrorCountByPCSAndEDPState];
        ...
        v78 = v12;
        v79 = &v87;
        [v13 enumerateKeysAndObjectsUsingBlock:v77];
      }
  ...
  if (v14)
  {
    ...
    do
    {
      for (j = 0; j != v14; ++j)
      {
        ...
        v17 = *(*(&v69 + 1) + 8 * j);
        v18 = [v17 privateDBErrorCountByPCSAndEDPState];
        ...
        v20 = [v17 shareDBErrorCountByPCSAndEDPState];
        ...
        v64 = v19;
        v65 = &v73;
        [v20 enumerateKeysAndObjectsUsingBlock:v63];
      }
  ...
  if (v21)
  {
    ...
    do
    {
      for (k = 0; k != v21; ++k)
      {
        ...
        v27 = [v24 shareDBErrorCountByPCSAndEDPState];
  ...
  v29 = [v28 telemetryEventQueueSize];
...
- (NSArray)telemetryOtherEvents
{
  ...
  {
    v5 = [(BRCSyncHealthReport *)self dsid];
    v6 = [AppTelemetryTimeSeriesEvent newLongEvent:217 UUID:v5 value:self->_danglingShareRequesters];
    [v3 addObject:v6];
  }
