...
- (unint64_t)hash
{
  ...
  v4 = [v3 appendBool:{-[STBackgroundActivitiesStatusDomainDataChangeContext isUserInitiated](self, "isUserInitiated")}];
  v5 = [v3 hash];
...
- (id)mutableCopyWithZone:(_NSZone *)a3
{
  result = [STMutableBackgroundActivitiesStatusDomainDataChangeContext allocWithZone:a3];
  if (result)
  {
    v5 = result;
    v6 = [(STBackgroundActivitiesStatusDomainDataChangeContext *)self isUserInitiated];
...
- (id)descriptionWithMultilinePrefix:(id)a3
{
  v3 = [(STBackgroundActivitiesStatusDomainDataChangeContext *)self descriptionBuilderWithMultilinePrefix:a3];
  v4 = [v3 build];
...
- (id)debugDescriptionWithMultilinePrefix:(id)a3
{
  v3 = [(STBackgroundActivitiesStatusDomainDataChangeContext *)self _descriptionBuilderWithMultilinePrefix:a3 forDebug:1];
  v4 = [v3 build];
...
{
  v4 = a3;
  [v4 encodeBool:-[STBackgroundActivitiesStatusDomainDataChangeContext isUserInitiated](self forKey:{"isUserInitiated"), @"userInitiated"}];
}
