...
- (id)succinctDescription
{
  v2 = [(STVoiceControlStatusDomainDataDiff *)self succinctDescriptionBuilder];
  v3 = [v2 build];
...
- (id)descriptionWithMultilinePrefix:(id)a3
{
  v3 = [(STVoiceControlStatusDomainDataDiff *)self descriptionBuilderWithMultilinePrefix:a3];
  v4 = [v3 build];
...
- (id)debugDescriptionWithMultilinePrefix:(id)a3
{
  v3 = [(STVoiceControlStatusDomainDataDiff *)&self->super.isa _descriptionBuilderWithMultilinePrefix:a3 forDebug:1];
  v4 = [v3 build];
...
- (id)_descriptionBuilderWithMultilinePrefix:(uint64_t)a3 forDebug:
{
  if (a1)
  {
    ...
    v7 = a1[1];
    v8 = [v6 appendFlag:objc_msgSend(v7 withName:"flagForSetting:" skipIfNotSet:{0), @"voiceControlActive", 1}];
