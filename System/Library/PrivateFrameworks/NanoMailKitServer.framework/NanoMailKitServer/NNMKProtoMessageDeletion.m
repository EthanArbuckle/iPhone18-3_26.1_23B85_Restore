...
- (id)description
{
  ...
  v8.receiver = self;
  v8.super_class = NNMKProtoMessageDeletion;
...
- (id)dictionaryRepresentation
{
  ...
  if (*&self->_has)
  {
    v6 = [MEMORY[0x277CCABB0] numberWithUnsignedInt:self->_deletionState];
...
- (void)writeTo:(id)a3
{
  ...
  if (*&self->_has)
  {
    deletionState = self->_deletionState;
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (*&self->_has)
  {
    if ((*(v4 + 24) & 1) != 0 && self->_deletionState == *(v4 + 2))
    {
      v6 = 1;
      goto LABEL_9;
    }
...
- (void)mergeFrom:(id)a3
{
  ...
  {
    v5 = v4;
    [(NNMKProtoMessageDeletion *)self setMessageId:?];
    v4 = v5;
  }
