...
+ (BOOL)migrateDatabaseAtPath:(id)a3
{
  ...
  v10 = [(MFPersistenceDatabase_iOS *)v7 initWithBasePath:v3 databaseName:@"Envelope Index" minimumCachedReaderConnections:3 schema:v8 protectedSchema:v9 propertyMapper:v5 protectedDatabasePersistence:v6];
