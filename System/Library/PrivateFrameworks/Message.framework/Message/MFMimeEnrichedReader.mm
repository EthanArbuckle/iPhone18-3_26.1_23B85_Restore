...
- (void)mismatchError:(id)a3
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    v6 = 138412290;
    v7 = a3;
    _os_log_impl(&dword_1B0389000, v4, OS_LOG_TYPE_INFO, "Ignoring unmatched </%@> command", &v6, 0xCu);
  }
  ...
  if (v4)
  {
    ...
    if (((*v4)[1] & 0x18) != 0 && !v4[1])
    {
      ...
      if (v6)
      {
        ...
        v13 = -1431655766;
        v14 = -1431655766;
        v7 = [MEMORY[0x1E696AE88] scannerWithString:a3];
        ...
        {
          a3 = [MEMORY[0x1E696AEC0] stringWithFormat:@"rgba(%d, %d, %d, 1)", (vcvtd_n_f64_u32(v15, 0x10uLL) * 255.0), (vcvtd_n_f64_u32(v14, 0x10uLL) * 255.0), (vcvtd_n_f64_u32(v13, 0x10uLL) * 255.0)];
        }
