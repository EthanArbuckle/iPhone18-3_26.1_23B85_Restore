@interface AWDSymptomsNetworkAnalyticsDNSTotalFailure
...
@implementation AWDSymptomsNetworkAnalyticsDNSTotalFailure
...
- (id)description
{
  ...
  v8.receiver = self;
  v8.super_class = AWDSymptomsNetworkAnalyticsDNSTotalFailure;
  v4 = [(AWDSymptomsNetworkAnalyticsDNSTotalFailure *)&v8 description];
  dictionaryRepresentation = [(AWDSymptomsNetworkAnalyticsDNSTotalFailure *)self dictionaryRepresentation];
