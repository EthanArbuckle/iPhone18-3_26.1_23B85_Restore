...
- (id)_shortErrorFromError:(void *)a1;
- (uint64_t)isValidIPv4PingResponsePacket:(BOOL *)a3 isForMe:(_WORD *)a4 sequence:(_BYTE *)a5 isBadPacket:;
- (uint64_t)isValidIPv6PingResponsePacket:(BOOL *)a3 isForMe:(_WORD *)a4 sequence:(_BYTE *)a5 isBadPacket:;
- (void)_didFailWithError:(void *)a1;
- (void)_pingDidFailToSendToAddress:(uint64_t)a3 packet:(uint64_t)a4 sequence:(void *)a5 error:;
- (void)_pingDidReceivePingResponseFromAddress:(void *)a3 packet:(uint64_t)a4 sequence:;
- (void)_pingDidReceiveUnexpectedPingResponseFromAddress:(void *)a3 packet:(uint64_t)a4 sequence:;
- (void)_pingDidSendToAddress:(uint64_t)a3 packet:(uint64_t)a4 sequence:;
- (void)_readData;
- (void)_sendPing;
- (void)_sendPingWithData:(uint64_t)a1;
...
{
  [a1 setRunning:0];
  [(ICMPPingProbe *)a1 _stopDataTransfer];
  v2 = a1[9];
  if (v2)
  {
...
- (void)_startThePinging
{
  ...
  v51 = 0;
  v49 = 0;
  if (!gStringToSockAddrFunc(v3, v50, 28, &v49))
  {
    if (BYTE1(v50[0]) == 2)
    {
...
LABEL_23:
            *(a1 + 112) = v4;
            v25 = *(a1 + 112);
            v26 = [a1 queue];
            v27 = dispatch_source_create(MEMORY[0x277D85D28], v25, 0, v26);
            v28 = *(a1 + 88);
            *(a1 + 88) = v27;
...
LABEL_31:
        ...
        [(ICMPPingProbe *)v45 _didFailWithError:v4];
        goto LABEL_24;
      }
  ...
  {
    v5 = v4;
    v6 = [OUTLINED_FUNCTION_4() ipAddress];
    v52 = 138477827;
    v53 = v6;
    OUTLINED_FUNCTION_10();
...
LABEL_10:
  ...
  if ([a1 burstCount] < 2 || (objc_msgSend(a1, "currentBurst"), v2 >= objc_msgSend(OUTLINED_FUNCTION_4(), "burstCount")))
  {
    v13 = a1[9];
    if (v13)
    {
  ...
  {
    dispatch_source_set_timer(a1[9], 0xFFFFFFFFFFFFFFFFLL, 0xFFFFFFFFFFFFFFFFLL, 0x989680uLL);
    v6 = a1[10];
    [a1 interBurstInterval];
    v8 = v7;
    [a1 interPingInterval];
...
LABEL_12:
      ...
      if (*(a1 + 120) == 1)
      {
        ...
        *(v21 + 6) = v22;
        ...
        memcpy(v18 + 2, v3, v23);
        v73 = 1;
        if (setsockopt(*(a1 + 112), 0xFFFF, 4356, &v73, 4u) < 0)
        {
          v24 = *__error();
        ...
        v79.msg_name = [*(a1 + 104) bytes];
        v79.msg_namelen = [*(a1 + 104) length];
        v77 = v18;
        v78 = v46;
        v79.msg_iov = &v77;
        v79.msg_iovlen = 1;
        v47 = sendmsg(*(a1 + 112), &v79, 0);
        v48 = v47;
        if (v47 < 0 || v47 != v46)
        {
          v24 = *__error();
      ...
      else
      {
        if (*(a1 + 128))
        {
          if (setsockopt(*(a1 + 112), 0, 25, (a1 + 128), 4u))
          {
            v2 = debuggabilityLogHandle;
        ...
        *(v36 + 2) = ~(HIWORD(v44) + v44 + (((v44 >> 16) + v44) >> 16));
    ...
    if (*(a1 + 136) == 56)
    {
      v2 = [objc_alloc(MEMORY[0x277CCACA8]) initWithFormat:@"%28zd bottles of beer on the wall", (100 * (*(a1 + 118) / 0x64u) - *(a1 + 118) + 99)];
      v13 = [v2 dataUsingEncoding:1];
    }

    else
    {
      v14 = [objc_alloc(MEMORY[0x277CBEB28]) initWithLength:*(a1 + 136)];
      v2 = v14;
      if (!v14)
      {
        v7 = 0;
...
- (void)_pingDidSendToAddress:(uint64_t)a3 packet:(uint64_t)a4 sequence:
{
  if (a1)
  {
    ...
    v6 = [MEMORY[0x277CCABB0] numberWithUnsignedInt:a4];
...
- (void)_pingDidFailToSendToAddress:(uint64_t)a3 packet:(uint64_t)a4 sequence:(void *)a5 error:
{
  ...
  if (a1)
  {
    ...
    if (*(a1 + 184) && *(a1 + 200))
    {
      *(a1 + 124) = OUTLINED_FUNCTION_0_5(v10);
    }

    v11 = objc_alloc(MEMORY[0x277CBEB38]);
    v12 = [MEMORY[0x277CCABB0] numberWithUnsignedInt:a4];
    v13 = [v11 initWithObjectsAndKeys:{v12, @"sequence", v9, @"error", 0}];
    ...
    {
      v19 = [a1 delegate];
      [v19 icmpPingProbe:a1 echoRequestSent:v13 success:0];
    }
  }
...
- (void)_pingDidReceivePingResponseFromAddress:(void *)a3 packet:(uint64_t)a4 sequence:
{
  ...
  if (a1)
  {
    ...
    if (*(a1 + 184) && *(a1 + 200))
    {
      *(a1 + 124) = OUTLINED_FUNCTION_0_5(v9);
    }
    ...
    if (v15 <= a4)
    {
      ...
      {
        v29 = v17;
        v30 = [OUTLINED_FUNCTION_11() pings];
        v31 = [v30 count];
        v45 = 134218496;
        v46 = a1;
        v47 = 1024;
    ...
    else
    {
      ...
      if (v17)
      {
        v18 = [MEMORY[0x277CCABB0] numberWithUnsignedInt:a4];
        ...
        v24 = [MEMORY[0x277CCABB0] numberWithUnsignedLongLong:nanosecondsFromMachAbsoluteTime(v22) / 0xF4240];
        OUTLINED_FUNCTION_12();
      ...
      {
        v28 = [a1 delegate];
        [v28 icmpPingProbe:a1 echoResponseReceived:v17 success:1];
      }
    }

    if ((*(a1 + 56) & 1) != 0 || (v37 = [a1 burstCount], objc_msgSend(a1, "pingCount") * v37 - 1 == v13))
    {
      [a1 stopTest];
      v38 = [a1 pings];
      if ([v38 count])
...
LABEL_26:
      ...
      if (v42)
      {
        [a1 delegate];
        objc_claimAutoreleasedReturnValue();
        v43 = [OUTLINED_FUNCTION_21() pings];
        [v43 count];
        [v41 icmpPingProbe:a1 completedIterations:v17 successfulCount:objc_msgSend(OUTLINED_FUNCTION_11() withError:{"successCount"), 0}];
      }
    }
  }
...
- (void)_pingDidReceiveUnexpectedPingResponseFromAddress:(void *)a3 packet:(uint64_t)a4 sequence:
{
  ...
  if (v12 <= a4)
  {
    ...
    v30 = v13;
    v31 = [OUTLINED_FUNCTION_11() pings];
    v32 = [v31 count];
  ...
  else
  {
    ...
    v22 = [a1 pings];
    v13 = [v22 objectAtIndexedSubscript:a4];

    if (v13)
    {
      v23 = [MEMORY[0x277CCABB0] numberWithUnsignedInt:a4];
      OUTLINED_FUNCTION_12();
    ...
    {
      v29 = [a1 delegate];
      [v29 icmpPingProbe:a1 echoResponseReceived:v13 success:0];
    }
  }

LABEL_19:
  v38 = [a1 pingCount];
  if ([a1 burstCount] * v38 - 1 <= v10)
  {
...
- (void)_didFailWithError:(void *)a1
{
  ...
  if (a1)
  {
    ...
    {
      v9 = v4;
      v10 = [(ICMPPingProbe *)a1 _shortErrorFromError:v3];
      *buf = 138412290;
      v14 = v10;
...
LABEL_28:
  ...
  v12 = *v11 == 129 && v11[1] == 0;
  v26 = bswap32(*(v11 + 2)) >> 16;
  v27 = a1[58];
  v28 = bswap32(*(v11 + 3)) >> 16;
  v29 = [a1 pingCount];
  v30 = [a1 burstCount];
  if (a3)
  {
