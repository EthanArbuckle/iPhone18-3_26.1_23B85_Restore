...
+ (id)externalRepresentationDataWithDictionary:(id)a3
{
  ...
  else
  {
    ...
    {
      [(CalExchangeCalendarExternalRepresentation *)v5 externalRepresentationDataWithDictionary:v7, v8, v9, v10, v11, v12, v13];
    }
  }
...
+ (id)dictionaryWithExternalRepresentationData:(id)a3
{
  ...
  if (!v5)
  {
    ...
    {
      [(CalExchangeCalendarExternalRepresentation *)v6 dictionaryWithExternalRepresentationData:v5, v9, v10, v11, v12, v13, v14];
    }
  ...
  if ((objc_opt_isKindOfClass() & 1) == 0)
  {
    ...
    {
      v8 = objc_opt_class();
      [(CalExchangeCalendarExternalRepresentation *)v8 dictionaryWithExternalRepresentationData:buf, v7];
    }
...
+ (void)externalRepresentationDataWithDictionary:(uint64_t)a3 .cold.1(uint64_t a1, NSObject *a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8)
{
  ...
  OUTLINED_FUNCTION_0(&dword_1DEBB1000, a2, a3, "Failed to serialize Exchange calendar external representation data: %@", a5, a6, a7, a8, 2u);
...
{
  v9 = *MEMORY[0x1E69E9840];
  OUTLINED_FUNCTION_0(&dword_1DEBB1000, a2, a3, "Exception caught while deserializating Exchange calendar external representation data: %@", a5, a6, a7, a8, 2u);
  v8 = *MEMORY[0x1E69E9840];
}
...
{
  v9 = *MEMORY[0x1E69E9840];
  OUTLINED_FUNCTION_0(&dword_1DEBB1000, a2, a3, "Failed to deserialize Exchange calendar external representation data: %@", a5, a6, a7, a8, 2u);
  v8 = *MEMORY[0x1E69E9840];
}
