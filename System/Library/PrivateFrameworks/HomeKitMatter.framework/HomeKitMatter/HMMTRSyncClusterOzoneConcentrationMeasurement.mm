...
uint64_t __60__HMMTRSyncClusterOzoneConcentrationMeasurement_logCategory__block_invoke()
{
  ...
  v2 = logCategory__hmf_once_v15_6984;
  logCategory__hmf_once_v15_6984 = v1;
...
- (void)updatedValuePluginMeasuredValueForAttributeReport:(id)a3 responseHandler:(id)a4
{
  ...
  v27 = [v10 cluster];
  if ([v27 isEqualToNumber:&unk_283EE8478])
  {
    v28 = [v10 attribute];
    v29 = [v28 isEqualToNumber:&unk_283EE8490];
    ...
    if (v29)
    {
      ...
      if (v30)
      {
        ...
        v61 = [(MTRClusterOzoneConcentrationMeasurement *)v15 readAttributeMeasurementUnitWithParams:v32];
