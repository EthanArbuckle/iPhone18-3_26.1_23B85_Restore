...
- (void)updatedValuePluginMeasuredValueForAttributeReport:(id)a3 responseHandler:(id)a4
{
  ...
  v27 = [v10 cluster];
  if ([v27 isEqualToNumber:&unk_283EE83D0])
  {
    v28 = [v10 attribute];
    v29 = [v28 isEqualToNumber:&unk_283EE83E8];
    ...
    if (v29)
    {
      ...
      if (v30)
      {
        ...
        v61 = [(MTRClusterTotalVolatileOrganicCompoundsConcentrationMeasurement *)v15 readAttributeMeasurementUnitWithParams:v32];
