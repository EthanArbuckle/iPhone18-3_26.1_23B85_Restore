@interface HMMTRSyncClusterTotalVolatileOrganicCompoundsConcentrationMeasurement
+ (id)logCategory;
...
@implementation HMMTRSyncClusterTotalVolatileOrganicCompoundsConcentrationMeasurement

+ (id)logCategory
{
  if (logCategory__hmf_once_t14_6785 != -1)
  {
    dispatch_once(&logCategory__hmf_once_t14_6785, &__block_literal_global_6786);
  }

  v3 = logCategory__hmf_once_v15_6787;

  return v3;
}

uint64_t __84__HMMTRSyncClusterTotalVolatileOrganicCompoundsConcentrationMeasurement_logCategory__block_invoke()
{
  v0 = *MEMORY[0x277D0F1A8];
  v1 = HMFCreateOSLogHandle();
  v2 = logCategory__hmf_once_v15_6787;
  logCategory__hmf_once_v15_6787 = v1;
...
- (void)updatedValuePluginMeasuredValueForAttributeReport:(id)report responseHandler:(id)handler
{
  ...
  if ([cluster2 isEqualToNumber:&unk_283EE83D0])
  {
    attribute2 = [v10 attribute];
    v29 = [attribute2 isEqualToNumber:&unk_283EE83E8];
    ...
    if (v29)
    {
      ...
      if (v30)
      {
        ...
        v61 = [(MTRClusterTotalVolatileOrganicCompoundsConcentrationMeasurement *)selfCopy readAttributeMeasurementUnitWithParams:v32];
...
LABEL_39:
  ...
  v49 = v66;
  (handlerCopy)[2](handlerCopy, &unk_283EE83B8, v66);
LABEL_30:
...
- (id)readAttributePluginMeasuredValueWithParams:(id)params
{
  ...
  v6 = [(MTRClusterTotalVolatileOrganicCompoundsConcentrationMeasurement *)self readAttributeMeasurementUnitWithParams:v5];
  ...
  {
    v61 = v6;
    v11 = [(MTRClusterTotalVolatileOrganicCompoundsConcentrationMeasurement *)self readAttributeMeasuredValueWithParams:v5];
