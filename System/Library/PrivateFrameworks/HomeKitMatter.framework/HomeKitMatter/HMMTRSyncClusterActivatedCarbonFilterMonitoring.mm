...
+ (id)logCategory
{
  ...
  {
    dispatch_once(&logCategory__hmf_once_t14, &__block_literal_global_282);
  }
...
- (id)readAttributePluginConditionWithParams:(id)params
{
  ...
  if (v10)
  {
    v11 = [(MTRClusterActivatedCarbonFilterMonitoring *)self readAttributeConditionWithParams:v5];
