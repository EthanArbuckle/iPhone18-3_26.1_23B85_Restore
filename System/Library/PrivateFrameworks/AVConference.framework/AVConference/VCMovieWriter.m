...
- (void)setupVisibleRect:(CGRect)a3 withCaptureHeight:(int)a4
{
  ...
  {
    self->_visibleWidth = a3.size.width * a4 / a3.size.height;
    self->_visibleHeight = a4;
...
- (void)finishWritingWithHandler:(id)a3
{
  ...
  v5 = [(AVAssetWriter *)self->_assetWriter status];
  if (objc_opt_class() == self)
  {
    if (VRTraceGetErrorLogLevelForModule() >= 7)
    {
...
LABEL_11:
  ...
  if (v5 != AVAssetWriterStatusWriting)
  {
    ...
    v15 = [(AVAssetWriter *)self->_assetWriter error];
    if (objc_opt_class() == self)
    {
      if (VRTraceGetErrorLogLevelForModule() < 3)
      {
...
LABEL_27:
        v15 = [MEMORY[0x1E696ABC0] errorWithDomain:@"VCMovieWriter" code:-1 userInfo:{0, *v24, *&v24[16], v25, v26, *v27, *&v27[16]}];
        goto LABEL_28;
      }
...
- (id)addAudioTrackForLocalAudio:(BOOL)a3
{
  ...
  {
    [(VCMovieWriter *)v3 addAudioTrackForLocalAudio:?];
    return v15;
  }
...
- (id)addVideoTrackWithWidth:(int)a3 height:(int)a4
{
  ...
  [v8 addEntriesFromDictionary:{objc_msgSend(MEMORY[0x1E695DF20], "dictionaryWithObjects:forKeys:count:", v37, v36, 5)}];
...
- (id)addStillImageMetadataTrackWithTransactionID:(id)a3
{
  ...
  if (cf)
  {
    ...
    if (v9)
    {
      ...
      [(VCMovieWriter *)a3 addStillImageMetadataTrackWithTransactionID:v10, &v16];
    }

    else
    {
      [(VCMovieWriter *)a3 addStillImageMetadataTrackWithTransactionID:?];
    }
  }
...
- (id)setupAssetWriterWithWidth:(int)a3 height:(int)a4 transactionID:(id)a5
{
  ...
  if (v7 && v6)
  {
    ...
    *&self->_lastRemoteAudioPresentationTime.value = v12;
    ...
    {
      v20 = [(VCMovieWriter *)self setupLivePhotoAssetWithTransactionID:a5];
      if (v20)
      {
        [VCMovieWriter setupAssetWriterWithWidth:height:transactionID:];
      }
      ...
      else
      {
        ...
        else if (self->_writerMode == 1 && (v20 = [(VCMovieWriter *)self addStillImageMetadataTrackWithTransactionID:a5]) != 0)
        {
          [VCMovieWriter setupAssetWriterWithWidth:height:transactionID:];
        }
        ...
        else
        {
          ...
          if (![(AVAssetWriter *)self->_assetWriter startWriting]&& VRTraceGetErrorLogLevelForModule() >= 3)
          {
            ...
            if (os_log_type_enabled(*MEMORY[0x1E6986650], OS_LOG_TYPE_ERROR))
            {
              v18 = [(AVAssetWriter *)self->_assetWriter status];
              v19 = [(AVAssetWriter *)self->_assetWriter error];
              *buf = 136316418;
              *&buf[4] = v15;
              *&buf[12] = 2080;
              *&buf[14] = "[VCMovieWriter setupAssetWriterWithWidth:height:transactionID:]";
  ...
  *&self->_lastRemoteAudioPresentationTime.value = v6;
  ...
  else
  {
    ...
    if (![(AVAssetWriter *)self->_assetWriter startWriting]&& VRTraceGetErrorLogLevelForModule() >= 3)
    {
      ...
      if (os_log_type_enabled(*MEMORY[0x1E6986650], OS_LOG_TYPE_ERROR))
      {
        v12 = [(AVAssetWriter *)self->_assetWriter status];
...
- (void)processSampleQueue:(opaqueCMBufferQueue *)a3 input:(id)a4 lastPresentationTime:(id *)a5
{
  ...
  if ([a4 isReadyForMoreMediaData])
  {
    do
    {
      ...
      if ((flags & 1) != 0 && (time1 = *a5, time2 = v23, CMTimeCompare(&time1, &time2) < 0))
      {
        v14 = [a4 appendSampleBuffer:v10];
        if (VRTraceGetErrorLogLevelForModule() >= 8)
        {
          v15 = VRTraceErrorLogLevelToCSTR();
          v16 = *MEMORY[0x1E6986650];
          ...
          if (*MEMORY[0x1E6986640] == 1)
          {
            ...
            {
              v20 = [(AVAssetWriter *)self->_assetWriter error];
              time1 = v23;
          ...
          {
            v21 = [(AVAssetWriter *)self->_assetWriter error];
            time1 = v23;
...
- (void)completeWriting
{
  ...
  v3 = [(AVAssetWriter *)self->_assetWriter status];
...
LABEL_24:
  ...
  {
    v22 = [(AVAssetWriter *)self->_assetWriter error];
    if (!v22)
    {
      v22 = [MEMORY[0x1E696ABC0] errorWithDomain:@"VCMovieWriter" code:-1 userInfo:0];
    }

    (*(self->_completionHandler + 2))(self->_completionHandler, 0, v22, v23, v24, v25, v26, v27, *v30, *&v30[8]);
  }
}
