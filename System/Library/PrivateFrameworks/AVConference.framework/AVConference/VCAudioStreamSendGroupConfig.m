...
- (VCAudioStreamSendGroupConfig)init
{
  ...
  v5.receiver = self;
  v5.super_class = VCAudioStreamSendGroupConfig;
  ...
  if (v2)
  {
    ...
    if (!v3)
    {
      [(VCAudioStreamSendGroupConfig *)v2 init];
      return v6[0];
    }
  }
...
- (void)dealloc
{
  ...
  v3.receiver = self;
  v3.super_class = VCAudioStreamSendGroupConfig;
...
- (void)init
{
  ...
  if (VRTraceGetErrorLogLevelForModule() >= 3)
  {
    ...
    if (os_log_type_enabled(*MEMORY[0x1E6986650], OS_LOG_TYPE_ERROR))
    {
      ...
      v6 = v3;
      v7 = 2080;
      v8 = "[VCAudioStreamSendGroupConfig init]";
      v9 = 1024;
      v10 = 23;
