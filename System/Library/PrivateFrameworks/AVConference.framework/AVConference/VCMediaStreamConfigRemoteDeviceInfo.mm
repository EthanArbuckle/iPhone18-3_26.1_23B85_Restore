...
- (VCMediaStreamConfigRemoteDeviceInfo)init
{
  ...
  v12.receiver = self;
  v12.super_class = VCMediaStreamConfigRemoteDeviceInfo;
...
LABEL_12:
    ...
    else
    {
      ...
      {
        v3 = [(VCMediaStreamConfigRemoteDeviceInfo *)v2 performSelector:sel_logPrefix];
      }
...
LABEL_11:
  ...
  else
  {
    if (objc_opt_respondsToSelector())
    {
      v3 = [(VCMediaStreamConfigRemoteDeviceInfo *)self performSelector:sel_logPrefix];
    }
  ...
  v11.receiver = self;
  v11.super_class = VCMediaStreamConfigRemoteDeviceInfo;
