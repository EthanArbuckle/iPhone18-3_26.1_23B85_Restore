...
- (void)setMotionActivity:(id)a3
{
  ...
  if (VRTraceGetErrorLogLevelForModule() >= 7)
  {
    ...
    if (os_log_type_enabled(*MEMORY[0x1E6986650], OS_LOG_TYPE_DEFAULT))
    {
      ...
      v8 = [(CMMotionActivity *)self->_motionActivity confidence];
      *buf = 136316162;
      v12 = v5;
      v13 = 2080;
...
- (unsigned)getMotionActivityValueForMotionActivity:(id)a3
{
  ...
  else if (([a3 walking] & 1) != 0 || (objc_msgSend(a3, "running") & 1) != 0 || (objc_msgSend(a3, "automotive") & 1) != 0 || (v4 = objc_msgSend(a3, "cycling")) != 0)
  {
    LOBYTE(v4) = 2;
  }
