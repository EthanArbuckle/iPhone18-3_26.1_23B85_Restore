...
- (void)updateStateWithPayload:(id)a3 withTime:(double)a4
{
  if ([a3 objectForKeyedSubscript:@"IsWalkieTalkieMode"])
  {
    [(VCWalkieTalkieData *)self updateDataWithTime:a4];
    if ([objc_msgSend(a3 objectForKeyedSubscript:{@"IsWalkieTalkieMode", "BOOLValue"}])
    {
      self->_startTime = a4;
...
- (void)updateReport:(id)a3
{
  ...
  [a3 setObject:v4 forKeyedSubscript:@"WTDUR"];
}
