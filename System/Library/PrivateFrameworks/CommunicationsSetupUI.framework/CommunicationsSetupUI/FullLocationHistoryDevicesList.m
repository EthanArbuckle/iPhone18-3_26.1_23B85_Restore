...
- (void)setUpConstraints
{
  ...
  v30 = [(FullLocationHistoryDevicesList *)self contentView];
  v28 = [v30 centerYAnchor];
  v27 = [v29 constraintEqualToAnchor:v28];
  v32[0] = v27;
  v26 = [v4 view];
  v24 = [v26 centerXAnchor];
  v25 = [(FullLocationHistoryDevicesList *)self contentView];
  v23 = [v25 centerXAnchor];
  v21 = [v24 constraintEqualToAnchor:v23];
  v32[1] = v21;
  v20 = [v4 view];
  v19 = [v20 widthAnchor];
  v9 = [(FullLocationHistoryDevicesList *)self contentView];
  v10 = [v9 widthAnchor];
