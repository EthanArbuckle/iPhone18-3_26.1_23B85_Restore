...
- (id)_loadiMessageAppsSyncronouslyForExtensionPoint:(id)point
{
  ...
  v23 = 0;
  v6 = [MEMORY[0x277CCA9C8] extensionsWithMatchingAttributes:v5 error:&v23];
  v7 = v23;
  if (v7)
  {
    v8 = csui_log();
    ...
    {
      [(CKSettingsiMessageAppManager *)pointCopy _loadiMessageAppsSyncronouslyForExtensionPoint:v8];
    }
    ...
    if (v11)
    {
      ...
      do
      {
        for (i = 0; i != v12; ++i)
        {
          ...
          v15 = [[CKSettingsiMessageApp alloc] initWithExtension:*(*(&v19 + 1) + 8 * i)];
          if (v15)
          {
            [v8 addObject:v15];
          }
...
void __63__CKSettingsiMessageAppManager__beginMonitoringExtensionPoint___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *buf = 138412290;
    v13 = v6;
    _os_log_impl(&dword_243BE5000, v5, OS_LOG_TYPE_DEFAULT, "Received updated extension list for extension point: %@", buf, 0xCu);
  }
...
- (void)_loadiMessageAppsSyncronouslyForExtensionPoint:(uint64_t)a1 .cold.1(uint64_t a1, NSObject *a2)
{
  ...
  v3 = 138412290;
  v4 = a1;
  _os_log_error_impl(&dword_243BE5000, a2, OS_LOG_TYPE_ERROR, "Error loading extensions for extension point: %@", &v3, 0xCu);
