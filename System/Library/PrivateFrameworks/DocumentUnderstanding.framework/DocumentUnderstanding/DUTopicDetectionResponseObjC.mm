...
- (void)setPersonalTopics:(id)a3
{
  ...
  if (v8)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        v15 = objc_msgSend_topicResultForObjCTopicResult_(DUObjCCompatibilityUtils, v9, *(*(&v23 + 1) + 8 * v14), v10, v11, v23);
  ...
  objc_msgSend_setPersonalTopics_(self->_underlying, v19, v5, v20, v21);
...
- (NSArray)personalTopics
{
  ...
  v25 = 0u;
  v26 = 0u;
  v8 = objc_msgSend_personalTopics(self->_underlying, v4, v5, v6, v7, 0);
  ...
  if (v10)
  {
    ...
    do
    {
      for (i = 0; i != v14; ++i)
      {
        ...
        v17 = objc_msgSend_objCTopicResultForTopicResult_(DUObjCCompatibilityUtils, v11, *(*(&v23 + 1) + 8 * i), v12, v13);
...
- (void)setGlobalTopics:(id)a3
{
  ...
  objc_msgSend_setGlobalTopics_(self->_underlying, v19, v5, v20, v21);
  v22 = *MEMORY[0x277D85DE8];
}
...
- (NSArray)globalTopics
{
  ...
  v25 = 0u;
  v26 = 0u;
  v8 = objc_msgSend_globalTopics(self->_underlying, v4, v5, v6, v7, 0);
  v10 = objc_msgSend_countByEnumeratingWithState_objects_count_(v8, v9, &v23, v27, 16);
  if (v10)
  {
    v14 = v10;
...
{
  v7.receiver = self;
  v7.super_class = DUTopicDetectionResponseObjC;
  v2 = [(DUTopicDetectionResponseObjC *)&v7 init];
  if (v2)
  {
