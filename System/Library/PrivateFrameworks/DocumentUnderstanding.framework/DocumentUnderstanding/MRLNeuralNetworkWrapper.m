...
- (id)lstmPredictions:(id)a3 embeddingDimension:(unint64_t)a4 classSize:(unint64_t)a5 seqLen:(unint64_t)a6
{
  ...
  if (self->model)
  {
    v16 = objc_msgSend_count(v10, v11, v12, v13, v14);
    v66[1] = v66;
    ...
    v68[0] = v36;
    v68[1] = v37;
    v38 = objc_msgSend_numberWithUnsignedInteger_(MEMORY[0x277CCABB0], v22, a4, v23, v24);
    v69[1] = v38;
    v68[2] = *MEMORY[0x277D2A2A0];
    v42 = objc_msgSend_numberWithUnsignedInteger_(MEMORY[0x277CCABB0], v39, a6, v40, v41);
    v69[2] = v42;
...
- (BOOL)load:(id)a3
{
  ...
  v6 = objc_msgSend_fileURLWithPath_(MEMORY[0x277CBEBC0], a2, a3, v3, v4);
