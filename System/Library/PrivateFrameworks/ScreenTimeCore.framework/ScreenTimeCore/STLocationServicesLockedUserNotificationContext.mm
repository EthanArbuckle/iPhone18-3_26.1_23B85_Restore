...
{
  v3.receiver = self;
  v3.super_class = STLocationServicesLockedUserNotificationContext;
...
{
  v2 = [MEMORY[0x1E696AEC0] localizedUserNotificationStringForKey:@"LocationServicesLockedUserNotificationTitle" arguments:0];
  [*(a1 + 32) setTitle:v2];

  v3 = [MEMORY[0x1E696AEC0] localizedUserNotificationStringForKey:@"LocationServicesLockedUserNotificationBody" arguments:0];
  [*(a1 + 32) setBody:v3];
