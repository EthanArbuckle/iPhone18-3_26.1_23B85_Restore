...
- (id)_initWithItem:(id)a3 dataSource:(id)a4 statusItemSequenceNumber:(unint64_t)a5
{
  ...
  v10 = [(IMMessageStatusChatItem *)&v13 _initWithItem:a3 statusType:16 time:0 count:0 expireStatusType:0 statusItemSequenceNumber:a5];
  v11 = v10;
  if (v10)
  {
...
- (id)copyWithStatusItemSequenceNumber:(unint64_t)a3
{
  ...
  v8 = objc_msgSend__initWithItem_dataSource_statusItemSequenceNumber_(v6, v7, v5, self->_dataSource, a3);
