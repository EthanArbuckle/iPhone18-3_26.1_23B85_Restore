...
- (DMCCertificateProperties)initWithTrust:(__SecTrust *)a3
{
  ...
  if (v4)
  {
    v6 = [(DMCCertificateProperties *)v4 _sendablePropertiesFromTrust:a3];
    v7 = [v6 lastObject];
    v8 = [(DMCCertificateProperties *)v5 _sectionsFromProperties:v7];
...
- (void)_setup:(id)a3
{
  ...
  v4 = [DMCCertificateProperties sendablePropertiesFromProperties:a3];
  v29 = self;
  ...
  if ([v33 count])
  {
    objc_storeStrong(&v29->_sections, v33);
    objc_storeStrong(&v29->_sectionTitles, v32);
  }
...
- (id)_sectionInfoForCertSection:(id)a3 title:(id)a4
{
  ...
  v7 = a4;
  v8 = [(DMCCertificateProperties *)self _cellInfosForSection:a3];
...
- (id)_sectionsFromProperties:(id)a3
{
  ...
  if (v4)
  {
    ...
    do
    {
      for (i = 0; i != v5; ++i)
      {
        ...
        v8 = *(*(&v19 + 1) + 8 * i);
        v9 = [v8 objectForKey:{@"localized label", v15}];
        v10 = [v8 objectForKey:@"type"];
        v11 = [v8 objectForKey:@"value"];
        if ([v10 isEqualToString:@"section"])
        {
          v12 = [(DMCCertificateProperties *)v15 _sectionInfoForCertSection:v11 title:v9];
          [v17 addObject:v12];
        }
  ...
  if ([v16 count])
  {
    v13 = [(DMCCertificateProperties *)v15 _sectionInfoForCertSection:v16 title:0];
    [v17 addObject:v13];
  }
  ...
  if (v7)
  {
    ...
    do
    {
      for (i = 0; i != v8; ++i)
      {
        ...
        v11 = [a1 _sendablePropertyFromProperty:{*(*(&v13 + 1) + 8 * i), v13}];
        [v5 addObject:v11];
      }
...
+ (id)_sendablePropertyFromProperty:(id)a3
{
  ...
  else
  {
    ...
    v7 = *MEMORY[0x277CDC510];
    v8 = [v4 objectForKey:*MEMORY[0x277CDC510]];
    v9 = [a1 sendablePropertiesFromProperties:v8];
  }
...
- (id)_sendablePropertiesFromTrust:(__SecTrust *)a3
{
  ...
  v3 = [(DMCCertificateProperties *)self _copyPropertiesFromTrust:a3];
