...
- (DNDSModeAssertionManagerUpdateContext)initWithStore:(id)a3 clientDetailsProvider:(id)a4
{
  ...
  if (v8)
  {
    ...
    objc_storeStrong(&v8->_clientDetailsProvider, a4);
...
- (id)takeAssertionWithUUID:(id)a3 details:(id)a4 source:(id)a5 startDate:(id)a6
{
  ...
  v47 = [(DNDSClientDetailsProvider *)clientDetailsProvider clientDetailsForIdentifier:v17];

  v18 = [objc_alloc(MEMORY[0x277D05938]) initWithUUID:v13 startDate:v11 details:v12 source:v10];
  v19 = [v15 assertions];
  v20 = [v15 invalidations];
  v21 = [v19 containsObject:v18];
  if (v21)
  {
  ...
  else
  {
    ...
    v23 = v18;
    v49 = v23;
    if (([v20 bs_containsObjectPassingTest:v48] & 1) == 0)
    {
      v27 = [v19 arrayByAddingObject:v23];
      ...
      {
        v31 = [v47 identifiers];
        v29 = [DNDSModeAssertionInvalidationPredicate predicateForAssertionClientIdentifiers:v31];
...
- (id)takeAssertionWithDetails:(id)a3 source:(id)a4 startDate:(id)a5
{
  ...
  v11 = a3;
  v12 = [v8 UUID];
  v13 = [(DNDSModeAssertionManagerUpdateContext *)self takeAssertionWithUUID:v12 details:v11 source:v10 startDate:v9];
...
- (void)_resolveStore:(id)a3
{
  ...
  v5 = [v3 invalidations];
  v26 = v3;
  v6 = [v3 invalidationRequests];
  v7 = [v4 sortedArrayUsingComparator:&__block_literal_global_8];

  v30 = [v6 sortedArrayUsingComparator:&__block_literal_global_9];
    ...
    do
    {
      for (i = 0; i != v10; ++i)
      {
        ...
        if (v13)
        {
          ...
          v16 = [v13 details];
          v17 = [v13 source];
          v18 = [v14 initWithAssertion:v12 invalidationDate:v15 details:v16 source:v17 reason:objc_msgSend(v13 reasonOverride:{"reason"), objc_msgSend(v13, "reasonOverride")}];
...
- (void)_cleanupStore:(id)a3
{
  ...
  v90 = v3;
  v8 = [v3 invalidations];
  v9 = [v8 countByEnumeratingWithState:&v128 objects:v138 count:16];
  if (v9)
  {
    v10 = v9;
    v11 = *v129;
    do
    {
      for (i = 0; i != v10; ++i)
      {
        ...
        v23 = [(DNDSClientDetailsProvider *)self->_clientDetailsProvider clientDetailsForIdentifier:v16];
        ...
        [v100 setObject:v24 forKey:v16];
      }

      v10 = [v8 countByEnumeratingWithState:&v128 objects:v138 count:16];
    }
  ...
  v127 = 0u;
  v28 = [v100 allValues];
  v29 = [v28 countByEnumeratingWithState:&v124 objects:v137 count:16];
  if (v29)
  {
    v30 = v29;
    v31 = *v125;
    do
    {
      for (j = 0; j != v30; ++j)
      {
        ...
        v33 = [*(*(&v124 + 1) + 8 * j) allValues];
        [v27 addObjectsFromArray:v33];
      }

      v30 = [v28 countByEnumeratingWithState:&v124 objects:v137 count:16];
    }
      ...
      do
      {
        ...
        else
        {
          ...
          if (v48)
          {
            ...
            v117 = 0u;
            v93 = v49;
            v102 = [v49 clientIdentifiers];
            v51 = [v102 countByEnumeratingWithState:&v116 objects:v135 count:16];
            if (v51)
            {
              v52 = v51;
              v53 = *v117;
              do
              {
                ...
                v52 = [v102 countByEnumeratingWithState:&v116 objects:v135 count:16];
              }
          ...
          else
          {
            ...
            v115 = 0u;
            v66 = [v65 UUIDs];
            v67 = [v66 countByEnumeratingWithState:&v112 objects:v134 count:16];
            if (v67)
            {
              v68 = v67;
              v69 = *v113;
              do
              {
                ...
                v68 = [v66 countByEnumeratingWithState:&v112 objects:v134 count:16];
              }
  ...
  v109 = 0u;
  v72 = [v34 allValues];
  v73 = [v72 countByEnumeratingWithState:&v108 objects:v133 count:16];
  if (v73)
  {
    v74 = v73;
    v75 = *v109;
    do
    {
      for (n = 0; n != v74; ++n)
      {
        ...
        v77 = [*(*(&v108 + 1) + 8 * n) allValues];
        [v71 addObjectsFromArray:v77];
      }

      v74 = [v72 countByEnumeratingWithState:&v108 objects:v133 count:16];
    }
  ...
  v104 = 0u;
  v105 = 0u;
  v78 = [v90 invalidations];
  v79 = [v78 countByEnumeratingWithState:&v104 objects:v132 count:16];
  if (v79)
  {
    v80 = v79;
    v81 = *v105;
    do
    {
      for (ii = 0; ii != v80; ++ii)
      {
        ...
        v83 = [*(*(&v104 + 1) + 8 * ii) assertion];
        v84 = [v83 UUID];
        v85 = [v35 objectForKey:v84];

        [v71 bs_safeAddObject:v85];
      }

      v80 = [v78 countByEnumeratingWithState:&v104 objects:v132 count:16];
    }
  ...
  v86 = [v71 allObjects];
  v87 = [v86 sortedArrayUsingComparator:&__block_literal_global_33_0];
