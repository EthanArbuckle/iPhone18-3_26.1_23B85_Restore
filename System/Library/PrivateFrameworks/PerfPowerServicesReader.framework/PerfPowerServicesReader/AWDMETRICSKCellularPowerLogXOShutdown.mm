...
LABEL_22:
    ...
    {
      v18 = off_279A10810[lastSdmState];
    }
...
LABEL_34:
  ...
  if ((has & 4) != 0)
  {
    if ((*(equalCopy + 44) & 4) == 0 || self->_durationMs != *(equalCopy + 7))
    {
      goto LABEL_34;
    }
  }
  ...
  if ((has & 2) != 0)
  {
    if ((*(equalCopy + 44) & 2) == 0 || self->_duration != *(equalCopy + 6))
    {
      goto LABEL_34;
    }
  }
  ...
  if ((has & 8) != 0)
  {
    if ((*(equalCopy + 44) & 8) == 0 || self->_lastSdmState != *(equalCopy + 8))
    {
      goto LABEL_34;
    }
  }
  ...
  if ((has & 0x10) != 0)
  {
    if ((*(equalCopy + 44) & 0x10) == 0 || self->_shutdownCount != *(equalCopy + 9))
    {
      goto LABEL_34;
    }
  }
  ...
  if ((has & 0x20) != 0)
  {
    if ((*(equalCopy + 44) & 0x20) == 0 || self->_totalNon0States != *(equalCopy + 10))
    {
      goto LABEL_34;
    }
