...
- (id)description
{
  ...
  v5 = [(AWDMETRICSKCellularPowerLogAggregatedDLTBSHist *)self dictionaryRepresentation];
...
- (void)copyTo:(id)a3
{
  ...
  {
    [v10 clearBins];
    v5 = [(AWDMETRICSKCellularPowerLogAggregatedDLTBSHist *)self binsCount];
    if (v5)
    {
      v6 = v5;
      for (i = 0; i != v6; ++i)
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ((has & 4) != 0)
  {
    if ((*(v4 + 40) & 4) == 0 || self->_numSubs != *(v4 + 7))
    {
      goto LABEL_27;
    }
  }
