...
- (id)description
{
  ...
  v8.receiver = self;
  v8.super_class = AWDMETRICSCellularPowerLogHistogram;
  v4 = [(AWDMETRICSCellularPowerLogHistogram *)&v8 description];
...
- (void)copyTo:(id)a3
{
  ...
  {
    [v10 clearBins];
    v5 = [(AWDMETRICSCellularPowerLogHistogram *)self binsCount];
    if (v5)
    {
      v6 = v5;
      for (i = 0; i != v6; ++i)
      {
        v8 = [(AWDMETRICSCellularPowerLogHistogram *)self binAtIndex:i];
        [v10 addBin:v8];
      }
    }
  }
  ...
  if (v7)
  {
    ...
    do
    {
      for (i = 0; i != v8; ++i)
      {
        ...
        [(AWDMETRICSCellularPowerLogHistogram *)self addBin:*(*(&v13 + 1) + 8 * i), v13];
      }
