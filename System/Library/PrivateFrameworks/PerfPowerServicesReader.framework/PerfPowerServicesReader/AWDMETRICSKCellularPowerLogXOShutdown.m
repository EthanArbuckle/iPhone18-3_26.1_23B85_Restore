...
LABEL_34:
  ...
  if ((has & 4) != 0)
  {
    if ((*(v4 + 44) & 4) == 0 || self->_durationMs != *(v4 + 7))
    {
      goto LABEL_34;
    }
  }
  ...
  if ((has & 2) != 0)
  {
    if ((*(v4 + 44) & 2) == 0 || self->_duration != *(v4 + 6))
    {
      goto LABEL_34;
    }
  }
  ...
  if ((has & 8) != 0)
  {
    if ((*(v4 + 44) & 8) == 0 || self->_lastSdmState != *(v4 + 8))
    {
      goto LABEL_34;
    }
  }
  ...
  if ((has & 0x10) != 0)
  {
    if ((*(v4 + 44) & 0x10) == 0 || self->_shutdownCount != *(v4 + 9))
    {
      goto LABEL_34;
    }
  }
  ...
  if ((has & 0x20) != 0)
  {
    if ((*(v4 + 44) & 0x20) == 0 || self->_totalNon0States != *(v4 + 10))
    {
      goto LABEL_34;
    }
