...
{
  causeCopy = cause;
  if ([causeCopy isEqualToString:@"MO"])
  {
    v4 = 0;
  }

  else if ([causeCopy isEqualToString:@"MT"])
  {
    v4 = 1;
  }
...
- (id)description
{
  ...
  v8.receiver = self;
  v8.super_class = AWDMETRICSCellularPowerLog1xEVDORRCStateChange;
  v4 = [(AWDMETRICSCellularPowerLog1xEVDORRCStateChange *)&v8 description];
  dictionaryRepresentation = [(AWDMETRICSCellularPowerLog1xEVDORRCStateChange *)self dictionaryRepresentation];
