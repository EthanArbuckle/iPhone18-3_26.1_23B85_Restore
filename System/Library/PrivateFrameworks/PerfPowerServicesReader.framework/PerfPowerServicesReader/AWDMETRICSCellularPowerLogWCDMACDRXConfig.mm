...
- (id)description
{
  ...
  v8.receiver = self;
  v8.super_class = AWDMETRICSCellularPowerLogWCDMACDRXConfig;
  v4 = [(AWDMETRICSCellularPowerLogWCDMACDRXConfig *)&v8 description];
  dictionaryRepresentation = [(AWDMETRICSCellularPowerLogWCDMACDRXConfig *)self dictionaryRepresentation];
...
LABEL_3:
  ...
  v8 = [MEMORY[0x277CCABB0] numberWithUnsignedInt:self->_drxCycleLength];
  [dictionary setObject:v8 forKey:@"drx_cycle_length"];
...
LABEL_16:
  ...
  if ((*&self->_has & 2) != 0)
  {
    if ((*(equalCopy + 24) & 2) == 0 || self->_drxCycleLength != *(equalCopy + 4))
    {
      goto LABEL_16;
    }
  }
