@interface AWDMETRICSKCellularPowerLogSFTRxTxHist
- (BOOL)isEqual:(id)a3;
...
@implementation AWDMETRICSKCellularPowerLogSFTRxTxHist
...
- (id)description
{
  ...
  v8.receiver = self;
  v8.super_class = AWDMETRICSKCellularPowerLogSFTRxTxHist;
  v4 = [(AWDMETRICSKCellularPowerLogSFTRxTxHist *)&v8 description];
  v5 = [(AWDMETRICSKCellularPowerLogSFTRxTxHist *)self dictionaryRepresentation];
...
- (void)copyTo:(id)a3
{
  ...
  v10 = v4;
  if ([(AWDMETRICSKCellularPowerLogSFTRxTxHist *)self binsCount])
  {
    [v10 clearBins];
    v5 = [(AWDMETRICSKCellularPowerLogSFTRxTxHist *)self binsCount];
    if (v5)
    {
      v6 = v5;
      for (i = 0; i != v6; ++i)
      {
        v8 = [(AWDMETRICSKCellularPowerLogSFTRxTxHist *)self binAtIndex:i];
        [v10 addBin:v8];
      }
    }
  }
  ...
  if (v7)
  {
    ...
    do
    {
      for (i = 0; i != v8; ++i)
      {
        ...
        [(AWDMETRICSKCellularPowerLogSFTRxTxHist *)self addBin:*(*(&v13 + 1) + 8 * i), v13];
      }
