...
- (id)description
{
  ...
  v5 = [(AWDMETRICSKCellularPowerLogNRPagingDRXCycle *)self dictionaryRepresentation];
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ((*&self->_has & 8) != 0)
  {
    if ((*(v4 + 48) & 8) == 0 || self->_pagingDrxCycle != *(v4 + 6))
    {
      goto LABEL_32;
    }
  }
