...
- (int)StringAsStatus:(id)a3
{
  ...
  else if ([v3 isEqualToString:@"ACQ"])
  {
    v4 = 1;
  }

  else if ([v3 isEqualToString:@"ACQ_FAIL"])
  {
    v4 = 2;
  }
...
- (id)description
{
  ...
  v5 = [(AWDMETRICSKCellularPowerLogServiceStatusEvent *)self dictionaryRepresentation];
...
LABEL_21:
  ...
  if ((*&self->_has & 4) != 0)
  {
    if ((*(v4 + 28) & 4) == 0 || self->_status != *(v4 + 5))
    {
      goto LABEL_21;
    }
  }
