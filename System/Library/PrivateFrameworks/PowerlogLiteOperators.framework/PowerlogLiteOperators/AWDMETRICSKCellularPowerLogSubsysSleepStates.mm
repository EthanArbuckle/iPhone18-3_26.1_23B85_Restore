...
- (id)description
{
  ...
  dictionaryRepresentation = [(AWDMETRICSKCellularPowerLogSubsysSleepStates *)self dictionaryRepresentation];
...
- (void)copyTo:(id)to
{
  ...
  {
    [v10 clearBins];
    binsCount = [(AWDMETRICSKCellularPowerLogSubsysSleepStates *)self binsCount];
    if (binsCount)
    {
      v6 = binsCount;
      for (i = 0; i != v6; ++i)
