...
@implementation AWDMETRICSKCellularPowerLogSFTRxTxHistMBin
...
{
  idCopy = id;
  if ([idCopy isEqualToString:@"RX"])
  {
    v4 = 0;
  }

  else if ([idCopy isEqualToString:@"TX"])
  {
    v4 = 1;
  }

  else if ([idCopy isEqualToString:@"IDLE"])
  {
    v4 = 2;
  }

  else if ([idCopy isEqualToString:@"SLEEP"])
  {
    v4 = 3;
  }
...
- (id)description
{
  ...
  v8.receiver = self;
  v8.super_class = AWDMETRICSKCellularPowerLogSFTRxTxHistMBin;
  v4 = [(AWDMETRICSKCellularPowerLogSFTRxTxHistMBin *)&v8 description];
  dictionaryRepresentation = [(AWDMETRICSKCellularPowerLogSFTRxTxHistMBin *)self dictionaryRepresentation];
