...
- (id)description
{
  ...
  v8.receiver = self;
  v8.super_class = KCellularLteRrcState;
  v4 = [(KCellularLteRrcState *)&v8 description];
...
LABEL_16:
  ...
  if (prevState >= 7)
  {
    v11 = [MEMORY[0x277CCACA8] stringWithFormat:@"(unknown: %i)", self->_prevState];
  }

  else
  {
    v11 = off_2782634F8[prevState];
  }

  [dictionary setObject:v11 forKey:@"prev_state"];
...
LABEL_21:
  ...
  switch(cause)
  {
    ...
    default:
      ...
      {
        v14 = [MEMORY[0x277CCACA8] stringWithFormat:@"(unknown: %i)", self->_cause];
      }

      break;
  }

  [dictionary setObject:v14 forKey:@"cause"];
