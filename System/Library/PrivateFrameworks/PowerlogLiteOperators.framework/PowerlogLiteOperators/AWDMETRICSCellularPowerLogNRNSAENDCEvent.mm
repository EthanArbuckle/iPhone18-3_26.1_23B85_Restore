...
- (id)description
{
  ...
  v8.receiver = self;
  v8.super_class = AWDMETRICSCellularPowerLogNRNSAENDCEvent;
  v4 = [(AWDMETRICSCellularPowerLogNRNSAENDCEvent *)&v8 description];
  dictionaryRepresentation = [(AWDMETRICSCellularPowerLogNRNSAENDCEvent *)self dictionaryRepresentation];
