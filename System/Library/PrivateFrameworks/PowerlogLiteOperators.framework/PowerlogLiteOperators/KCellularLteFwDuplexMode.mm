...
- (void)setHasIsInTddMode:(BOOL)mode;
...
- (id)description
{
  ...
  dictionaryRepresentation = [(KCellularLteFwDuplexMode *)self dictionaryRepresentation];
...
LABEL_3:
  ...
  [dictionary setObject:v8 forKey:@"is_in_tdd_mode"];
