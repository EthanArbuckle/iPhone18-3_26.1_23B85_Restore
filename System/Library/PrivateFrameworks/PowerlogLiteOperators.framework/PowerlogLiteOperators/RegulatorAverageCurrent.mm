...
- (void)setHasDuration64ms:(BOOL)duration64ms;
- (void)setHasRegulatorId:(BOOL)id;
...
- (id)description
{
  ...
  dictionaryRepresentation = [(RegulatorAverageCurrent *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  if ((has & 4) != 0)
  {
    ...
    [dictionary setObject:v7 forKey:@"regulator_id"];
...
LABEL_3:
  ...
  [dictionary setObject:v8 forKey:@"sample_count"];
...
LABEL_11:
  ...
  [dictionary setObject:v9 forKey:@"duration_6_4ms"];

  if (*&self->_has)
  {
LABEL_5:
    v5 = [MEMORY[0x277CCABB0] numberWithUnsignedInt:self->_averageCurrentMa];
    [dictionary setObject:v5 forKey:@"average_current_ma"];
  }
...
LABEL_11:
  toCopy[3] = self->_duration64ms;
  *(toCopy + 24) |= 2u;
  if (*&self->_has)
  {
LABEL_5:
    toCopy[2] = self->_averageCurrentMa;
    *(toCopy + 24) |= 1u;
  }
...
- (BOOL)isEqual:(id)equal
{
  ...
  if ((*&self->_has & 4) != 0)
  {
    if ((*(equalCopy + 24) & 4) == 0 || self->_regulatorId != *(equalCopy + 4))
    {
      goto LABEL_21;
    }
  }
...
LABEL_21:
  ...
  if ((*&self->_has & 8) != 0)
  {
    if ((*(equalCopy + 24) & 8) == 0 || self->_sampleCount != *(equalCopy + 5))
    {
      goto LABEL_21;
    }
  }
  ...
  if ((*&self->_has & 2) != 0)
  {
    if ((*(equalCopy + 24) & 2) == 0 || self->_duration64ms != *(equalCopy + 3))
    {
      goto LABEL_21;
    }
  }
  ...
  if (*&self->_has)
  {
    if ((*(equalCopy + 24) & 1) == 0 || self->_averageCurrentMa != *(equalCopy + 2))
    {
      goto LABEL_21;
    }
...
LABEL_11:
  self->_duration64ms = *(fromCopy + 3);
  *&self->_has |= 2u;
  if (*(fromCopy + 24))
  {
LABEL_5:
    self->_averageCurrentMa = *(fromCopy + 2);
    *&self->_has |= 1u;
  }
