...
LABEL_31:
  ...
  if ((*&self->_has & 8) != 0)
  {
    if ((*(v4 + 36) & 8) == 0 || self->_prevCpState != *(v4 + 6))
    {
      goto LABEL_31;
    }
  }
  ...
  if ((*&self->_has & 2) != 0)
  {
    if ((*(v4 + 36) & 2) == 0 || self->_currCpState != *(v4 + 4))
    {
      goto LABEL_31;
    }
  }
