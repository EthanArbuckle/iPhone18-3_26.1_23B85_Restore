...
- (id)description
{
  ...
  dictionaryRepresentation = [(KCellularLtePagingCycle *)self dictionaryRepresentation];
...
LABEL_13:
  ...
  [dictionary setObject:v9 forKey:@"phy_cell_id"];
...
LABEL_14:
  ...
  [dictionary setObject:v10 forKey:@"nb_ms"];
...
LABEL_15:
  ...
  [dictionary setObject:v11 forKey:@"paging_cycle_ms"];
