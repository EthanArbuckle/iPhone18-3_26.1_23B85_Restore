...
LABEL_35:
        ...
        v59 = selfCopy3;
        v72 = v59;
        v60 = [v57 initWithFireDate:v56 withInterval:1 withTolerance:0 repeats:workQueue2 withUserInfo:v71 withQueue:3600.0 withBlock:0.0];
      ...
      if (![MEMORY[0x277D3F258] isPowerlogHelperd])
      {
        if ([MEMORY[0x277D3F180] debugEnabled])
        {
          ...
          if (byte_2811F6E1B == 1)
          {
            ...
            [v66 logMessage:v65 fromFile:lastPathComponent4 fromFunction:v69 fromLineNumber:277];
...
- (void)resetPermissionsForClients
{
  ...
  v20[3] = &unk_2782631C8;
  v20[4] = self;
  [permissionCache enumerateKeysAndObjectsUsingBlock:v20];
      ...
      if (v31)
      {
        ...
        do
        {
          for (i = 0; i != v32; ++i)
          {
            ...
            [(PLXPCService *)self handleSingleMessage:*(*(&v92 + 1) + 8 * i) fromPeer:peerCopy forEvent:eventCopy];
          }
