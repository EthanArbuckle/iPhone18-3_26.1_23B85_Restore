...
- (id)description
{
  ...
  dictionaryRepresentation = [(AWDMETRICSKCellularPowerLogNRSub6SINRHist *)self dictionaryRepresentation];
...
- (void)copyTo:(id)to
{
  ...
  {
    [v10 clearBins];
    binsCount = [(AWDMETRICSKCellularPowerLogNRSub6SINRHist *)self binsCount];
    if (binsCount)
    {
      v6 = binsCount;
      for (i = 0; i != v6; ++i)
