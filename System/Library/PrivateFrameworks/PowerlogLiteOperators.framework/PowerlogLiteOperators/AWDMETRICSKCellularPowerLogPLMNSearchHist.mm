...
- (id)description
{
  ...
  dictionaryRepresentation = [(AWDMETRICSKCellularPowerLogPLMNSearchHist *)self dictionaryRepresentation];
...
LABEL_20:
      ...
      {
        v17 = off_27825DD08[lastSdmState];
      }
...
- (void)copyTo:(id)to
{
  ...
  {
    [v10 clearBins];
    binsCount = [(AWDMETRICSKCellularPowerLogPLMNSearchHist *)self binsCount];
    if (binsCount)
    {
      v6 = binsCount;
      for (i = 0; i != v6; ++i)
