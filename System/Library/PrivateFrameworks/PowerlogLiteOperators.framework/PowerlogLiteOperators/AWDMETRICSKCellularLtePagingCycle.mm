...
- (id)description
{
  ...
  v5 = [(AWDMETRICSKCellularLtePagingCycle *)self dictionaryRepresentation];
...
LABEL_14:
  ...
  [v3 setObject:v10 forKey:@"paging_cycle_ms"];
...
LABEL_7:
    ...
    [v3 setObject:v5 forKey:@"phy_cell_id"];
  }
