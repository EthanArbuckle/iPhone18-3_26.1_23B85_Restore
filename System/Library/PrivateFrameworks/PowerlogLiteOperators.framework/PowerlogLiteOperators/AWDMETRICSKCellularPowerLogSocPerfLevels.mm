@interface AWDMETRICSKCellularPowerLogSocPerfLevels
...
@implementation AWDMETRICSKCellularPowerLogSocPerfLevels
...
- (id)description
{
  ...
  v8.receiver = self;
  v8.super_class = AWDMETRICSKCellularPowerLogSocPerfLevels;
  v4 = [(AWDMETRICSKCellularPowerLogSocPerfLevels *)&v8 description];
  dictionaryRepresentation = [(AWDMETRICSKCellularPowerLogSocPerfLevels *)self dictionaryRepresentation];
...
LABEL_18:
    ...
    {
      v16 = off_27825A098[lastSdmState];
    }
...
- (void)copyTo:(id)to
{
  ...
  v10 = toCopy;
  if ([(AWDMETRICSKCellularPowerLogSocPerfLevels *)self binsCount])
  {
    [v10 clearBins];
    binsCount = [(AWDMETRICSKCellularPowerLogSocPerfLevels *)self binsCount];
    if (binsCount)
    {
      v6 = binsCount;
      for (i = 0; i != v6; ++i)
      {
        v8 = [(AWDMETRICSKCellularPowerLogSocPerfLevels *)self binAtIndex:i];
        [v10 addBin:v8];
      }
    }
  }
...
LABEL_24:
  ...
  if ((has & 8) != 0)
  {
    if ((v6 & 8) == 0 || self->_subsId != *(equalCopy + 9))
    {
      goto LABEL_24;
    }
  }
  ...
  if (has)
  {
    if ((v6 & 1) == 0 || self->_durationMs != *(equalCopy + 1))
    {
      goto LABEL_24;
    }
  }
  ...
  if ((has & 4) != 0)
  {
    if ((v6 & 4) == 0 || self->_lastSdmState != *(equalCopy + 8))
    {
      goto LABEL_24;
    }
  ...
  if (v7)
  {
    ...
    do
    {
      for (i = 0; i != v8; ++i)
      {
        ...
        [(AWDMETRICSKCellularPowerLogSocPerfLevels *)self addBin:*(*(&v13 + 1) + 8 * i), v13];
      }
