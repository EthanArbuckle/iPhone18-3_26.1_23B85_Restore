...
- (NSSet)deletedAppNames
{
  ...
  if (!deletedAppNames)
  {
    ...
    if ([MEMORY[0x277D3F180] debugEnabled])
    {
      ...
      {
        dispatch_once(&qword_2811F6450, v49);
      }
...
- (NSDictionary)installedBundleIDToDisplayName
{
  ...
  if (!installedBundleIDToDisplayName)
  {
    ...
    v59 = v5;
    v81[0] = v5;
    v7 = [MEMORY[0x277CBEA60] arrayWithObjects:v81 count:1];
    v60 = v4;
    v8 = [v6 entriesForKey:v4 withComparisons:v7];
    ...
    if ([MEMORY[0x277D3F180] debugEnabled])
    {
      ...
      v76[1] = 3221225472;
      v76[2] = __59__PLBatteryBreakdownService_installedBundleIDToDisplayName__block_invoke;
      v76[3] = &__block_descriptor_40_e5_v8__0lu32l8;
      v76[4] = v10;
      if (qword_2811F6468 != -1)
      {
        dispatch_once(&qword_2811F6468, v76);
      }
      ...
      if (byte_2811F640B == 1)
      {
        ...
        [v12 logMessage:v11 fromFile:v14 fromFunction:v15 fromLineNumber:323];
          ...
          if (v26 == 101)
          {
            ...
            if ([*(v9 + 384) debugEnabled])
            {
              ...
              if (byte_2811F640C == 1)
              {
                ...
                [v32 logMessage:v31 fromFile:v34 fromFunction:v35 fromLineNumber:333];
            ...
            [(NSDictionary *)v65 setObject:v29 forKeyedSubscript:v28];
    ...
    v69 = 0u;
    v70 = 0u;
    v39 = [v38 countByEnumeratingWithState:&v67 objects:v77 count:16];
    v40 = 0x278257000uLL;
    if (v39)
    {
      v41 = v39;
      ...
      do
      {
        ...
        do
        {
          ...
          if ([v44 mayBeBUIVisible])
          {
            ...
            v46 = [(NSDictionary *)v65 objectForKeyedSubscript:v45];
            ...
            if (!v46)
            {
              ...
              if ([MEMORY[0x277D3F180] debugEnabled])
              {
                ...
                v66[1] = 3221225472;
                v66[2] = __59__PLBatteryBreakdownService_installedBundleIDToDisplayName__block_invoke_334;
                v66[3] = &__block_descriptor_40_e5_v8__0lu32l8;
                v66[4] = v48;
                if (qword_2811F6478 != -1)
                {
                  dispatch_once(&qword_2811F6478, v66);
                }

                if (byte_2811F640D == 1)
                {
                  v49 = [MEMORY[0x277CCACA8] stringWithFormat:@"bundleID=%@, displayName=%@", v45, v47];
                  ...
                  [v63 logMessage:v49 fromFile:v51 fromFunction:v52 fromLineNumber:351];
              ...
              [(NSDictionary *)v65 setObject:v47 forKeyedSubscript:v45];
            }
          }
          ...
          else
          {
            ...
            if (os_log_type_enabled(v45, OS_LOG_TYPE_DEBUG))
            {
              ...
              *buf = 138412290;
              v80 = v55;
              _os_log_debug_impl(&dword_21A4C6000, v45, OS_LOG_TYPE_DEBUG, "LSApplicationRecord Skipping non system / non user bundleID=%@", buf, 0xCu);
            }
          }
...
LABEL_48:
        ...
        while (v41 != v43);
        v41 = [v38 countByEnumeratingWithState:&v67 objects:v77 count:16];
      }
    ...
    v2->_installedBundleIDToDisplayName = v65;
...
- (NSDictionary)installedPluginBundleIDToPluginEntry
{
  ...
  if (!installedPluginBundleIDToPluginEntry)
  {
    ...
    if ([MEMORY[0x277D3F180] debugEnabled])
    {
      ...
      {
        dispatch_once(&qword_2811F6480, v69);
      }
    ...
    v68 = 0u;
    v17 = v8;
    v18 = [v17 countByEnumeratingWithState:&v65 objects:v71 count:16];
    v54 = v17;
    v55 = v2;
    if (v18)
    {
      ...
      do
      {
        ...
        while (v19 != v21);
        v19 = [v17 countByEnumeratingWithState:&v65 objects:v71 count:16];
      }
        ...
        do
        {
          ...
          if (!v37)
          {
            if ([*(v9 + 384) debugEnabled])
            {
              ...
              {
                dispatch_once(&qword_2811F6490, v59);
              }
    ...
    if (v6)
    {
      ...
      if (v9)
      {
        ...
        if (v11)
        {
          ...
          [v5 setObject:&unk_282C12B88 forKeyedSubscript:@"PluginDeletedDate"];
          goto LABEL_9;
        }
...
- (NSDictionary)rootNodeNameToRootNodeEnergyKey
{
  ...
  {
    v24 = [&unk_282C15768 objectAtIndexedSubscript:2];
    v25[0] = v24;
    v26[0] = @"PLBatteryUIAppCPUEnergyKey";
    v23 = [&unk_282C15780 objectAtIndexedSubscript:4];
    v25[1] = v23;
    v26[1] = @"PLBatteryUIAppVENCEnergyKey";
    v22 = [&unk_282C15798 objectAtIndexedSubscript:5];
    v25[2] = v22;
    v26[2] = @"PLBatteryUIAppVDECEnergyKey";
    v21 = [&unk_282C157B0 objectAtIndexedSubscript:6];
    v25[3] = v21;
    v26[3] = @"PLBatteryUIAppISPEnergyKey";
    v20 = [&unk_282C157C8 objectAtIndexedSubscript:7];
    v25[4] = v20;
    v26[4] = @"PLBatteryUIAppRestOfSOCEnergyKey";
    v19 = [&unk_282C157E0 objectAtIndexedSubscript:8];
    v25[5] = v19;
    v26[5] = @"PLBatteryUIAppGPUEnergyKey";
    v18 = [&unk_282C157F8 objectAtIndexedSubscript:9];
    v25[6] = v18;
    v26[6] = @"PLBatteryUIAppDRAMEnergyKey";
    v17 = [&unk_282C15810 objectAtIndexedSubscript:10];
    v25[7] = v17;
    v26[7] = @"PLBatteryUIAppDisplayEnergyKey";
    v16 = [&unk_282C15828 objectAtIndexedSubscript:11];
    v25[8] = v16;
...
- (id)suggestionsWithEnergyEntries:(id)a3
{
  ...
  if ([(PLBatteryBreakdownService *)self shouldSuggestAutoBrightnessWithEnergyEntries:v4 andSavedEnergyPercent:&v52])
  {
    if ([MEMORY[0x277D3F180] debugEnabled])
    {
      ...
      {
        dispatch_once(&qword_2811F6518, v49);
      }
  ...
  if ([(PLBatteryBreakdownService *)self shouldSuggestReduceBrightnessWithEnergyEntries:v4 andSavedEnergyPercent:&v52])
  {
    if ([MEMORY[0x277D3F180] debugEnabled])
    {
      ...
      {
        dispatch_once(&qword_2811F6520, v47);
      }
  ...
  if ([(PLBatteryBreakdownService *)self shouldShowUpgradeInsightWithQueryType:0])
  {
    if ([MEMORY[0x277D3F180] debugEnabled])
    {
      ...
      {
        dispatch_once(&qword_2811F6528, v45);
      }
...
- (BOOL)shouldSuggestAutoLockWithEnergyEntries:(id)a3 andSavedEnergyPercent:(double *)a4
{
  ...
  v5 = a3;
  v6 = [MEMORY[0x277D26298] sharedConnection];
  v7 = [v6 effectiveValueForSetting:*MEMORY[0x277D25D70]];
...
- (id)getUpgradeDataWithLastUpgradeTimestamp:(double)a3 withFirstEntryTimestampFromDB:(double)a4 withNow:(id)a5 withBeforeUpgrade:(BOOL)a6 withRange:(_PLTimeIntervalRange)a7
{
  ...
  {
LABEL_6:
    v23 = [(PLBatteryBreakdownService *)self batteryBreakdownWithTimeRange:0 withDataRange:var0 withEntryTimeInterval:var1 withQueryType:0.0, 0.0, 3600.0];
...
- (id)energyEntriesWithRange:(_PLTimeIntervalRange)a3 withEntryTimeInterval:(double)a4 withQueryType:(int)a5
{
  ...
  if ([MEMORY[0x277D3F180] debugEnabled])
  {
    ...
    {
      dispatch_once(&qword_2811F6530, v192);
    }
  ...
  v24 = var0 + var1;
  v163 = v23;
  v25 = [MEMORY[0x277CCACA8] stringWithFormat:@"timestamp>%f AND timestamp<%f AND timeInterval=%f AND (%@)", *&var0, *&v24, *&a4, v23];
  v178 = v17;
  ...
  if ([MEMORY[0x277D3F180] debugEnabled])
  {
    ...
    {
      dispatch_once(&qword_2811F6538, v191);
    }
  ...
  if ([MEMORY[0x277D3F180] debugEnabled])
  {
    ...
    {
      dispatch_once(&qword_2811F6540, v190);
    }
  ...
  v41 = [MEMORY[0x277CCACA8] stringWithFormat:@"timestamp>%f AND timestamp<%f AND timeInterval=%f AND (%@)", *&var0, *&v24, *&a4, v163];
  ...
  if ([MEMORY[0x277D3F180] debugEnabled])
  {
    ...
    {
      dispatch_once(&qword_2811F6548, v189);
    }
  ...
  if ([MEMORY[0x277D3F180] debugEnabled])
  {
    ...
    {
      dispatch_once(&qword_2811F6550, v188);
    }
  ...
  if (v182)
  {
    ...
    v181 = *v185;
    v176 = *MEMORY[0x277D3F310];
    v173 = *MEMORY[0x277D3F308];
    v168 = *MEMORY[0x277D3F2F8];
    v175 = *MEMORY[0x277D3F330];
    v172 = *MEMORY[0x277D3F320];
    v169 = self;
    do
    {
      v59 = 0;
...
LABEL_90:
          ...
          {
            v76 = [v61 objectForKeyedSubscript:v176];
            v85 = [v76 intValue];
            if ([&unk_282C15AE0 count] > v85)
            {
              v78 = [&unk_282C15B10 objectAtIndexedSubscript:{objc_msgSend(v76, "intValue")}];
              v86 = [v61 objectForKeyedSubscript:v173];
              v87 = [v86 intValue];
              if ([&unk_282C15B28 count] <= v87)
              {
                v88 = PLLogCommon();
              ...
              else
              {
                ...
                v90 = v89 = v86;
                v91 = [v61 objectForKeyedSubscript:v168];
    ...
    do
    {
      ...
      do
      {
        ...
        if ([*(v4 + 384) debugEnabled])
        {
          ...
          {
            dispatch_once(&qword_2811F6560, v52);
          }
          ...
          do
          {
            ...
            do
            {
              ...
              if ([*(v4 + 384) debugEnabled])
              {
                ...
                {
                  dispatch_once(&qword_2811F6570, v46);
                }
...
- (id)addForegroundAndBackgroundDurations:(id)a3 withRange:(_PLTimeIntervalRange)a4 withQueryType:(int)a5
{
  ...
  v152 = 0u;
  v153 = 0u;
  v131 = [(PLBatteryBreakdownService *)v123 nonAppsRuntimesWithRange:var0, var1];
  ...
  if (v92)
  {
    ...
    do
    {
      for (n = 0; n != v94; ++n)
      {
        ...
        [v98 setObject:&unk_282C12B88 forKeyedSubscript:@"PLBatteryUIAppTypeKey"];
        ...
        [v98 setObject:&unk_282C12B88 forKeyedSubscript:@"PLBatteryUIAppEnergyValueKey"];
        [v91 addObject:v98];
      }
...
LABEL_16:
      ...
      _os_log_debug_impl(&dword_21A4C6000, v15, OS_LOG_TYPE_DEBUG, v16, &v18, 0x16u);
      goto LABEL_16;
    }
  }
...
- (double)nonAppRuntimeWithEventForwardTableName:(id)a3 withRange:(_PLTimeIntervalRange)a4 andIdentificationKey:(id)a5
{
  ...
  v40 = v9;
  v21 = [v20 entriesForKey:v9 inTimeRange:0 withFilters:{var0, var1}];
    ...
    do
    {
      ...
      if ([(PLBatteryBreakdownService *)self appTypeForName:v14]== 1)
      {
        ...
        if ([*(v11 + 384) debugEnabled])
        {
          ...
          {
            dispatch_once(&qword_2811F6580, v75);
          }
        ...
        if (v69 > 1 || (v32 == 0.0 ? (v36 = v35 < 60.0) : (v36 = 0), !v36))
        {
          if (v32 > 0.0 && v32 < 60.0)
          {
            ...
            if ([*(v11 + 384) debugEnabled])
            {
              ...
              {
                dispatch_once(&qword_2811F6590, v73);
              }
          ...
          else if ([*(v11 + 384) debugEnabled])
          {
            ...
            {
              dispatch_once(&qword_2811F6598, v72);
            }
...
LABEL_54:
        ...
        v37 = [&unk_282C15CC0 objectAtIndexedSubscript:59];
...
LABEL_46:
          if ([*(v11 + 384) debugEnabled])
          {
            ...
            {
              dispatch_once(&qword_2811F6588, v74);
            }
...
LABEL_56:
    ...
    while (v9 != v12);
    v64 = [obj countByEnumeratingWithState:&v77 objects:v83 count:16];
    v9 = v64;
  }
...
- (id)adjustFGBGTimeForNonAppEnergyEntry:(id)a3
{
  ...
  if (v8 < 60.0 && v8 > 0.0)
  {
    [v3 setObject:&unk_282C12C30 forKeyedSubscript:v5];
  }
...
- (BOOL)checkHomeKitEvents
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_DEBUG))
  {
    v9 = 134217984;
    v10 = v5;
    _os_log_debug_impl(&dword_21A4C6000, v6, OS_LOG_TYPE_DEBUG, "Count of HomeKit events: %ld", &v9, 0xCu);
  }
    ...
    do
    {
      ...
      do
      {
        ...
        if ([v9 isEqualToString:@"com.apple.springboard.lockscreen.navigation"])
        {
          ...
          if (v17)
          {
            if ([*(v6 + 384) debugEnabled])
            {
              ...
              {
                dispatch_once(&qword_2811F65A8, v59);
              }
            ...
            if ([*(v6 + 384) debugEnabled])
            {
              ...
              {
                dispatch_once(&qword_2811F65B0, v58);
              }
        ...
        if ([*(v6 + 384) debugEnabled])
        {
          ...
          {
            dispatch_once(&qword_2811F65B8, v57);
          }
    ...
    do
    {
      ...
      do
      {
        ...
        if ([MEMORY[0x277D3F180] debugEnabled])
        {
          ...
          v50[1] = 3221225472;
          v50[2] = __61__PLBatteryBreakdownService_mapDeletedAppsWithEnergyEntries___block_invoke_1810;
          v50[3] = &__block_descriptor_40_e5_v8__0lu32l8;
          v50[4] = v33;
          if (qword_2811F65C8 != -1)
          {
            dispatch_once(&qword_2811F65C8, v50);
          }
      ...
      do
      {
        ...
        if (v19)
        {
          if ([*(v5 + 384) debugEnabled])
          {
            ...
            {
              dispatch_once(&qword_2811F65D8, v44);
            }
...
- (id)reaccountExchangeEntriesWithEnergyEntries:(id)a3
{
  ...
  if (v3 && [v3 count])
  {
    ...
    if (v14 && ([v14 objectForKeyedSubscript:@"PLBatteryUIAppEnergyValueKey"], v16 = objc_claimAutoreleasedReturnValue(), objc_msgSend(v16, "doubleValue"), v18 = v17, v16, v18 != 0.0))
    {
      ...
      v50 = 0u;
      v49 = 0u;
      v20 = [&unk_282C15CD8 countByEnumeratingWithState:&v49 objects:v58 count:16];
      if (v20)
      {
        v21 = v20;
        v22 = *v50;
        ...
        do
        {
          ...
          v21 = [&unk_282C15CD8 countByEnumeratingWithState:&v49 objects:v58 count:16];
        }
      ...
      v45 = 0u;
      v46 = 0u;
      v31 = [&unk_282C15CD8 countByEnumeratingWithState:&v45 objects:v57 count:16];
      if (v31)
      {
        v32 = v31;
        v33 = *v46;
        do
        {
          ...
          v32 = [&unk_282C15CD8 countByEnumeratingWithState:&v45 objects:v57 count:16];
        }
  ...
  if (v3 && [v3 count])
  {
    ...
    if (v14 && v15)
    {
      ...
      if ([MEMORY[0x277D3F180] debugEnabled])
      {
        ...
        {
          dispatch_once(&qword_2811F65E8, v37);
        }
        ...
        if (byte_2811F643B == 1)
        {
          ...
          [v36 logMessage:v26 fromFile:v28 fromFunction:v29 fromLineNumber:2485];
      ...
      do
      {
        ...
        if (v7)
        {
          ...
          if ([MEMORY[0x277D3F180] debugEnabled])
          {
            ...
            {
              dispatch_once(&qword_2811F65F8, v42);
            }
          ...
          if ([MEMORY[0x277D3F180] debugEnabled])
          {
            ...
            {
              dispatch_once(&qword_2811F6600, v39);
            }
    ...
    do
    {
      ...
      do
      {
        ...
        if ([MEMORY[0x277D3F180] debugEnabled])
        {
          ...
          {
            dispatch_once(&qword_2811F6610, v34);
          }
    ...
    do
    {
      ...
      do
      {
        ...
        if ([*(v7 + 384) debugEnabled])
        {
          ...
          {
            dispatch_once(&qword_2811F6620, v52);
          }
        ...
        if ([*(v7 + 384) debugEnabled])
        {
          ...
          {
            dispatch_once(&qword_2811F6628, v51);
          }
        ...
        else
        {
          ...
          if ([*(v7 + 384) debugEnabled])
          {
            ...
            {
              dispatch_once(&qword_2811F6630, v50);
            }
...
- (id)qualifiersWithEnergyEntry:(id)a3 bucketSize:(double)a4 andTotalEnergy:(double)a5
{
  ...
  if (v7)
  {
    ...
    v35 = v34 > 0.0 && v20 / v34 > dbl_21AA22260[a4 > 3600.0];
    if (v33 > 0.0)
    {
      ...
      if (v39 >= v43 && !v35)
      {
        if ([MEMORY[0x277D3F180] debugEnabled])
        {
          ...
          {
            dispatch_once(&qword_2811F6640, v45);
          }
    ...
    {
      v57 = [&unk_282C15CF0 objectAtIndexedSubscript:1];
      ...
      {
        [v16 addObject:&unk_282C12C60];
      }

      v62 = [&unk_282C15D08 objectAtIndexedSubscript:{2, v61}];
      ...
      if (v66 / v20 > 0.5 && [objc_opt_class() canSetQualifier:2 forBundleID:v17])
      {
        ...
        if (v23 < 300.0 || (v69 = v23 / v26, v23 / v26 < 0.33))
        {
          if (v68)
          {
            ...
            {
              dispatch_once(&qword_2811F6650, v82);
            }
            ...
            if (byte_2811F6448 == 1)
            {
              ...
              if (os_log_type_enabled(v91, OS_LOG_TYPE_DEBUG))
              {
                *buf = 138412290;
                v224 = v86;
                _os_log_debug_impl(&dword_21A4C6000, v91, OS_LOG_TYPE_DEBUG, "%@", buf, 0xCu);
              }
            }
          }
        }
        ...
        else
        {
          if (v68)
          {
            ...
            {
              dispatch_once(&qword_2811F6648, v71);
            }
          ...
          [v16 addObject:{&unk_282C12C78, v69}];
        }
      }
      ...
      if ([v17 isEqualToString:@"com.apple.findmy"])
      {
        ...
        v96 = [&unk_282C15D20 objectAtIndexedSubscript:59];
        v97 = [v7 objectForKeyedSubscript:v96];
        [v97 doubleValue];
        v99 = v98;

        if (v99 / v20 > v95 && ([v16 containsObject:{&unk_282C12C78, v99 / v20}] & 1) == 0)
        {
          [v16 addObject:&unk_282C12C78];
        }
        ...
        if (os_log_type_enabled(v100, OS_LOG_TYPE_DEBUG))
        {
          *buf = 138412290;
          v224 = v16;
          _os_log_debug_impl(&dword_21A4C6000, v100, OS_LOG_TYPE_DEBUG, "IT Qualifier: %@", buf, 0xCu);
        }
      }
      ...
      v218[3] = &unk_2782591D0;
      v218[4] = self;
      v101 = v218;
      if (qword_2811F6658 != -1)
      {
        dispatch_once(&qword_2811F6658, v101);
      }

      v102 = *&qword_2811F6660;
      v103 = [&unk_282C15D38 objectAtIndexedSubscript:48];
      v104 = [v7 objectForKeyedSubscript:v103];
      [v104 doubleValue];
      v106 = v105;

      v107 = [&unk_282C15D50 objectAtIndexedSubscript:12];
      v108 = [v7 objectForKeyedSubscript:v107];
      [v108 doubleValue];
      v110 = v106 + v109;

      v111 = [&unk_282C15D68 objectAtIndexedSubscript:13];
      v112 = [v7 objectForKeyedSubscript:v111];
      [v112 doubleValue];
      v114 = v110 + v113;

      v115 = [&unk_282C15D80 objectAtIndexedSubscript:15];
      v116 = [&unk_282C15D98 objectAtIndexedSubscript:2];
      ...
      v121 = [&unk_282C15DB0 objectAtIndexedSubscript:15];
      v122 = [&unk_282C15DC8 objectAtIndexedSubscript:7];
      ...
      v127 = [&unk_282C15DE0 objectAtIndexedSubscript:15];
      v128 = [&unk_282C15DF8 objectAtIndexedSubscript:9];
      ...
      v133 = [&unk_282C15E10 objectAtIndexedSubscript:15];
      v134 = [&unk_282C15E28 objectAtIndexedSubscript:52];
      ...
      v139 = [&unk_282C15E40 objectAtIndexedSubscript:15];
      v140 = [&unk_282C15E58 objectAtIndexedSubscript:54];
      ...
      if (os_log_type_enabled(v145, OS_LOG_TYPE_DEBUG))
      {
        *buf = 138412546;
        ...
        v225 = 2048;
        v226 = v144;
        _os_log_debug_impl(&dword_21A4C6000, v145, OS_LOG_TYPE_DEBUG, "%@ locEnergy: %.3f", buf, 0x16u);
      }
      ...
      if (v144 / v20 > v102 && [objc_opt_class() canSetQualifier:3 forBundleID:v17])
      {
        ...
        v217[3] = &unk_2782591D0;
        v217[4] = self;
        v146 = v217;
        if (qword_2811F6668 != -1)
        {
          dispatch_once(&qword_2811F6668, v146);
        }

        v147 = *&qword_2811F6670;
        v148 = [&unk_282C15E70 objectAtIndexedSubscript:15];
        ...
        if (os_log_type_enabled(v152, OS_LOG_TYPE_DEBUG))
        {
          *buf = 138412546;
          ...
          v225 = 2048;
          v226 = v151;
          _os_log_debug_impl(&dword_21A4C6000, v152, OS_LOG_TYPE_DEBUG, "%@ bgLocEnergy: %.3f", buf, 0x16u);
        }

        if (v151 / v66 > v147 && [v16 containsObject:{&unk_282C12C78, v151 / v66}])
        {
          [v16 removeObject:&unk_282C12C78];
          v153 = &unk_282C12C90;
        }
      ...
      v216[3] = &unk_2782591D0;
      v216[4] = self;
      v154 = v216;
      if (qword_2811F6678 != -1)
      {
        dispatch_once(&qword_2811F6678, v154);
      }

      v155 = *&qword_2811F6680;
      ...
      {
        dispatch_once(&qword_2811F6688, v156);
      }

      v157 = *&qword_2811F6690;
      ...
      if (v158 && [objc_opt_class() canSetQualifier:9 forBundleID:v17])
      {
        ...
        if (os_log_type_enabled(v164, OS_LOG_TYPE_DEBUG))
        {
          *buf = 138413058;
          ...
          v229 = 2048;
          v230 = v163;
          _os_log_debug_impl(&dword_21A4C6000, v164, OS_LOG_TYPE_DEBUG, "%@ notificationInfo: %@, energy: %.3f, batteryPercent %.3f", buf, 0x2Au);
        }

        if (v161 / v20 > v155 || v163 > v157)
        {
          [v16 addObject:{&unk_282C12CC0, v161 / v20}];
        }
      }

      v165 = [&unk_282C15E88 objectAtIndexedSubscript:3];
      ...
      {
        [v16 addObject:&unk_282C12CD8];
      }

      v170 = [&unk_282C15EA0 objectAtIndexedSubscript:{4, v169}];
      ...
      {
        [v16 addObject:&unk_282C12CF0];
      }

      v175 = [&unk_282C15EB8 objectAtIndexedSubscript:{14, v174}];
      v176 = [v7 objectForKeyedSubscript:v175];
      [v176 doubleValue];
      v178 = v177;

      v179 = [&unk_282C15ED0 objectAtIndexedSubscript:15];
      v180 = [v7 objectForKeyedSubscript:v179];
      [v180 doubleValue];
      v182 = v181;

      v183 = [&unk_282C15EE8 objectAtIndexedSubscript:55];
      ...
      {
        [v16 addObject:&unk_282C12D38];
      }

      v195 = [&unk_282C15F00 objectAtIndexedSubscript:{10, v194}];
      ...
      if (v201)
      {
        ...
        if (v204 / v20 > 0.33)
        {
          ...
          {
            [v16 addObject:&unk_282C12D50];
          }
        }
      }

      v205 = [objc_opt_class() combineQualifiers:v16];
      if ([v16 containsObject:&unk_282C12D08])
      {
        v206 = [v16 containsObject:&unk_282C12C78];
        if (v67 > 0.5 && v206 && ([v205 containsObject:&unk_282C12C48] & 1) == 0)
        {
          v207 = [v205 arrayByAddingObject:&unk_282C12C78];
      ...
      if ([v205 containsObject:&unk_282C12C48])
      {
        [v208 addObject:&unk_282C12C48];
      }
