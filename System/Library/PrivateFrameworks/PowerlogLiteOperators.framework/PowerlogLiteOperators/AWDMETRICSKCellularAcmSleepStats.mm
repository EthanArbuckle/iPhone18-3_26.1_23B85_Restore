...
- (void)addAcm:(id)a3
{
  ...
  [(NSMutableArray *)acms addObject:v4];
}
...
- (id)description
{
  ...
  v5 = [(AWDMETRICSKCellularAcmSleepStats *)self dictionaryRepresentation];
...
- (void)copyTo:(id)a3
{
  ...
  {
    [v11 clearAcms];
    v6 = [(AWDMETRICSKCellularAcmSleepStats *)self acmsCount];
    if (v6)
    {
      v7 = v6;
      for (i = 0; i != v7; ++i)
  ...
  if (v8)
  {
    ...
    do
    {
      for (i = 0; i != v9; ++i)
      {
        ...
        [(AWDMETRICSKCellularAcmSleepStats *)self addAcm:*(*(&v14 + 1) + 8 * i), v14];
      }
