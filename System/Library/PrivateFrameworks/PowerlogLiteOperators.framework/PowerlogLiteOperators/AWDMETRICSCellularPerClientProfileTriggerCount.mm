...
- (id)description
{
  ...
  v8.receiver = self;
  v8.super_class = AWDMETRICSCellularPerClientProfileTriggerCount;
  v4 = [(AWDMETRICSCellularPerClientProfileTriggerCount *)&v8 description];
  dictionaryRepresentation = [(AWDMETRICSCellularPerClientProfileTriggerCount *)self dictionaryRepresentation];
