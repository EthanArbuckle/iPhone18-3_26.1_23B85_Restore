@interface AWDMETRICSKCellularPowerLogNRNSAENDCEvent
...
@implementation AWDMETRICSKCellularPowerLogNRNSAENDCEvent
...
{
  eventCopy = event;
  if ([eventCopy isEqualToString:@"ENDC_OFF"])
  {
    v4 = 0;
  }
  ...
  {
    v4 = [eventCopy isEqualToString:@"ENDC_ON"];
  }
...
- (id)description
{
  ...
  v8.receiver = self;
  v8.super_class = AWDMETRICSKCellularPowerLogNRNSAENDCEvent;
  v4 = [(AWDMETRICSKCellularPowerLogNRNSAENDCEvent *)&v8 description];
  dictionaryRepresentation = [(AWDMETRICSKCellularPowerLogNRNSAENDCEvent *)self dictionaryRepresentation];
...
LABEL_7:
  ...
  {
    v6 = fromCopy;
    [(AWDMETRICSKCellularPowerLogNRNSAENDCEvent *)self setPlmn:?];
    fromCopy = v6;
  }
