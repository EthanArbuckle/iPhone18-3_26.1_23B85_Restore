...
- (id)description
{
  ...
  v5 = [(AWDMETRICSKCellularPowerLogCpuPerfLevels *)self dictionaryRepresentation];
...
LABEL_18:
    ...
    {
      v16 = off_278262750[lastSdmState];
    }
...
- (void)copyTo:(id)a3
{
  ...
  {
    [v10 clearBins];
    v5 = [(AWDMETRICSKCellularPowerLogCpuPerfLevels *)self binsCount];
    if (v5)
    {
      v6 = v5;
      for (i = 0; i != v6; ++i)
