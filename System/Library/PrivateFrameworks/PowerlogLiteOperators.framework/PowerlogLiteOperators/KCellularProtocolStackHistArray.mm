...
- (id)description
{
  ...
  v8.receiver = self;
  v8.super_class = KCellularProtocolStackHistArray;
  v4 = [(KCellularProtocolStackHistArray *)&v8 description];
  dictionaryRepresentation = [(KCellularProtocolStackHistArray *)self dictionaryRepresentation];
...
LABEL_6:
  ...
  {
    [v10 clearHists];
    histsCount = [(KCellularProtocolStackHistArray *)self histsCount];
    if (histsCount)
    {
      v7 = histsCount;
      for (i = 0; i != v7; ++i)
      {
        v9 = [(KCellularProtocolStackHistArray *)self histAtIndex:i];
        [v10 addHist:v9];
      }
    }
  }
  ...
  if (v8)
  {
    ...
    do
    {
      for (i = 0; i != v9; ++i)
      {
        ...
        [(KCellularProtocolStackHistArray *)self addHist:*(*(&v13 + 1) + 8 * i), v13];
      }
