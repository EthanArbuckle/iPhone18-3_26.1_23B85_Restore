...
- (void)initOperatorDependancies
{
  ...
  v3 = [MEMORY[0x277D3F258] torchTypeString];
  if (v3)
  {
...
LABEL_28:
            ...
            v37 = [objc_alloc(MEMORY[0x277D3F190]) initWithEntryKey:v105];
            v109 = [v13 objectForKeyedSubscript:@"Timestamp"];
            v42 = [v109 convertFromSystemToMonotonic];
            ...
            else
            {
              ...
              v47 = [MEMORY[0x277D3F258] bundleIDFromPid:v46];
...
LABEL_62:
  ...
  if ([v104 count])
  {
    ...
    [(PLOperator *)self logEntries:v100 withGroupID:v105];
  }
...
- (void)handleTorchEvent:(id)a3 withEntryKey:(id)a4
{
  ...
  v15 = [v6 objectForKeyedSubscript:@"State"];
  if (v15)
  {
    v16 = v15;
    v17 = [v6 objectForKeyedSubscript:@"Level"];
...
- (void)modelFrontCameraPowerWithEntry:(id)a3
{
  ...
  else
  {
    ...
    v20 = [v4 entryDate];
    v14 = MEMORY[0x277CBEC10];
    [v19 createDistributionEventForwardWithDistributionID:13 withChildNodeNameToWeight:MEMORY[0x277CBEC10] withStartDate:v20];
...
- (void)modelTorchPowerWithEntry:(id)a3
{
  ...
  v9 = [(PLCameraAgent *)self torchPowerModel];
