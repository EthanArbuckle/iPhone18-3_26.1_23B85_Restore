...
- (CADAuditTokenTCCPermissionChecker)initWithAuditToken:(id *)token;
...
- (void)requestAuthorization:(unint64_t)authorization forService:(__CFString *)service clientDictionary:(id)dictionary completion:(id)completion
{
  ...
  v15[4] = self;
  v14 = completionCopy;
  CalRequestAuthorizationForServiceWithCompletion(authorization, v13, service, dictionaryCopy, v15);
}
