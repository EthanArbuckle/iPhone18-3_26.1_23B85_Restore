...
uint64_t __40__GTIntKeyedDictionary_encodeWithCoder___block_invoke(uint64_t a1, uint64_t a2, uint64_t a3)
{
  v4 = *(a1 + 32);
...
uint64_t __38__GTIntKeyedDictionary_initWithCoder___block_invoke(uint64_t a1, void *a2)
{
  v3 = [a2 longLongValue];
