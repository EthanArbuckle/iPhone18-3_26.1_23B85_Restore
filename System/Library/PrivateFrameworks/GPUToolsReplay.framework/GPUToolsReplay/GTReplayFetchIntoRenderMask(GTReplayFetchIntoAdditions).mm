...
@implementation GTReplayFetchIntoRenderMask(GTReplayFetchIntoAdditions)

- (BOOL)encodeFetchIntoOperation:()GTReplayFetchIntoAdditions error:
{
  v7 = *(a3 + 8);
  v8 = *(v7 + 24);
  v9 = GTMTLReplayController_generateWireframeTexture(v7, (a3 + 96), 0, 1, a4);
  v10 = v9;
  if (v9)
  {
    width = [v9 width];
    ...
    v16 = [MEMORY[0x277CCACA8] stringWithFormat:@"%@.%@", @"com.apple.gputools.replay", @"SharedRenderMaskBlit"];
