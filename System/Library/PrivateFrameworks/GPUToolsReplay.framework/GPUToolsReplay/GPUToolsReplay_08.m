...
LABEL_617:
    ...
    *(a1 + 104) = v15;
    v275 = 0;
    sub_24D7C82BC(__s1, a2, &v276, &v275);
    if ((v275 & 1) == 0)
    {
      break;
    }
...
uint64_t sub_24D7BC5A8(uint64_t a1)
{
  v2 = a1 + 0x8000;
  *a1 = &unk_2860BB288;
  if (*(a1 + 200))
...
void sub_24D7BC638(uint64_t a1)
{
  sub_24D7BC5A8(a1);
...
uint64_t sub_24D7BFEF4(uint64_t result, uint64_t a2, uint64_t a3, unsigned int a4, char a5)
{
  v21 = a5;
  if (a4 <= 0xF)
  {
