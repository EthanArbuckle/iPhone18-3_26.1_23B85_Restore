...
- (id)jsonDictionary
{
  ...
  if (v73)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        v75 = v3;
        v4 = *(*(&v99 + 1) + 8 * v3);
        v5 = [(GTCaptureArchiveOverrides *)v59 filenameOverrides];
        v77 = v4;
        ...
        if (v9)
        {
          ...
          do
          {
            for (i = 0; i != v10; ++i)
            {
              ...
              v14 = [v13 originalFilename];
              v112[0] = v14;
              v111[1] = @"overrideFilename";
              v15 = [v13 overrideFilename];
              v112[1] = v15;
  ...
  v93 = 0u;
  v94 = 0u;
  v52 = [(GTCaptureArchiveOverrides *)v59 heapTextureRestoreOverrides];
  v56 = [v52 countByEnumeratingWithState:&v91 objects:v110 count:16];
  if (v56)
  {
    v53 = *v92;
    do
    {
      ...
      do
      {
        ...
        v58 = v18;
        v19 = *(*(&v91 + 1) + 8 * v18);
        v20 = [(GTCaptureArchiveOverrides *)v59 heapTextureRestoreOverrides];
        v57 = v19;
  ...
  v81 = 0u;
  v82 = 0u;
  v37 = [(GTCaptureArchiveOverrides *)v59 reverseAliasMap];
  v38 = [v37 countByEnumeratingWithState:&v79 objects:v105 count:16];
  if (v38)
  {
    v39 = v38;
    v40 = *v80;
  ...
  v46 = [(NSArray *)v59->_heapExtractedTextures copy];
  v104[2] = v46;
  v103[3] = @"reverseAliasMap";
  v47 = [v36 copy];
  v104[3] = v47;
  v103[4] = @"heapAccelerationStructures";
  v48 = [(NSDictionary *)v59->_heapAccelerationStructures copy];
  v104[4] = v48;
...
- (GTCaptureArchiveOverrides)initWithCoder:(id)a3
{
  ...
  if (v5)
  {
    ...
    v7 = [v4 decodeObjectOfClasses:v6 forKey:@"filenameOverrides"];
    filenameOverrides = v5->_filenameOverrides;
    v5->_filenameOverrides = v7;

    v9 = [v4 allowedClasses];
    v10 = [v4 decodeObjectOfClasses:v9 forKey:@"heapTextureRestoreOverrides"];
    ...
    v13 = [v4 allowedClasses];
    v14 = [v4 decodeObjectOfClasses:v13 forKey:@"heapExtractedTextures"];
    ...
    v17 = [v4 allowedClasses];
    v18 = [v4 decodeObjectOfClasses:v17 forKey:@"reverseAliasMap"];
    p_reverseAliasMap = &v5->_reverseAliasMap;
    reverseAliasMap = v5->_reverseAliasMap;
    v5->_reverseAliasMap = v18;

    v21 = [v4 allowedClasses];
    v22 = [v4 decodeObjectOfClasses:v21 forKey:@"heapAccelerationStructures"];
...
- (void)encodeWithCoder:(id)a3
{
  ...
  v5 = a3;
  [v5 encodeObject:filenameOverrides forKey:@"filenameOverrides"];
  [v5 encodeObject:self->_heapTextureRestoreOverrides forKey:@"heapTextureRestoreOverrides"];
  [v5 encodeObject:self->_heapExtractedTextures forKey:@"heapExtractedTextures"];
  [v5 encodeObject:self->_reverseAliasMap forKey:@"reverseAliasMap"];
  [v5 encodeObject:self->_heapAccelerationStructures forKey:@"heapAccelerationStructures"];
}

- (id)copyWithZone:(_NSZone *)a3
{
  v4 = objc_alloc_init(GTCaptureArchiveOverrides);
  v5 = [(GTCaptureArchiveOverrides *)self filenameOverrides];
  [(GTCaptureArchiveOverrides *)v4 setFilenameOverrides:v5];

  v6 = [(GTCaptureArchiveOverrides *)self heapTextureRestoreOverrides];
  [(GTCaptureArchiveOverrides *)v4 setHeapTextureRestoreOverrides:v6];

  v7 = [(GTCaptureArchiveOverrides *)self heapExtractedTextures];
  [(GTCaptureArchiveOverrides *)v4 setHeapExtractedTextures:v7];

  v8 = [(GTCaptureArchiveOverrides *)self reverseAliasMap];
  [(GTCaptureArchiveOverrides *)v4 setReverseAliasMap:v8];
