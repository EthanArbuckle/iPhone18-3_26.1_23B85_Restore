...
+ (id)JSONStringFromNSDictionary:()NSString error:
{
  ...
  if ([MEMORY[0x277CCAAA0] isValidJSONObject:v5])
  {
    ...
    if (v7)
    {
      ...
      v9 = [v8 localizedStringForKey:@"NSJSONSerialization failed" value:&stru_287709218 table:0];
  ...
  else
  {
    ...
    v13 = [v12 localizedStringForKey:@"Invalid dictionary for JSON serialization" value:&stru_287709218 table:0];
    v22[0] = v13;
    v21[1] = *MEMORY[0x277CCA498];
    v14 = [MEMORY[0x277CCA8D8] mainBundle];
    v15 = [v14 localizedStringForKey:@"Refer to NSJSONSerialization spec for valid dictionaries" value:&stru_287709218 table:0];
    v22[1] = v15;
