...
- (id)_tearDownSceneBlock:(id)a3 scenePresenter:(id)a4;
...
- (id)presentableDescription
{
  ...
  v3 = [(FBScene *)self->_scene identifier];
  if ([v3 length])
  {
    v7 = @"sceneID";
    v8[0] = v3;
...
- (BNBannerSourceListenerHostedPresentableViewController)initWithSpecification:(id)a3 serviceDomain:(id)a4 scene:(id)a5 readyCompletion:(id)a6
{
  ...
  v12 = [(BNBannerSourceListenerPresentableViewController *)&v19 initWithSpecification:a3 serviceDomain:a4 readyCompletion:a6];
  v13 = v12;
  if (v12)
  {
    objc_storeStrong(&v12->_scene, a5);
...
- (void)draggingDidBeginWithGestureProxy:(id)a3
{
  ...
  {
    objc_storeStrong(&self->_panGestureProxy, a3);
...
- (NSSet)preferredBackgroundActivitiesToSuppress
{
  ...
  v7 = [v6 preferredBackgroundActivitiesToSuppress];
...
- (void)viewDidLoad
{
  ...
  v3 = [(BNBannerSourceListenerHostedPresentableViewController *)self view];
  v4 = [(FBScene *)self->_scene uiPresentationManager];
  isClippingEnabled = self->_isClippingEnabled;
  v6 = [v4 createPresenterWithIdentifier:@"default"];
  scenePresenter = self->_scenePresenter;
  ...
  v10 = [(BNBannerSourceListenerPresentableViewController *)self contentView];
  [v3 addSubview:v10];
}
...
- (void)viewWillLayoutSubviews
{
  ...
  v3 = [(BNBannerSourceListenerHostedPresentableViewController *)self parentViewController];
  if (-[FBScene isActive](self->_scene, "isActive") && (-[BNBannerSourceListenerHostedPresentableViewController _appearState](self, "_appearState") != 2 || (objc_opt_respondsToSelector() & 1) == 0 || [v3 shouldFenceAnimationsForPresentable:self]))
  {
...
{
  v5 = a3;
  v6 = [(BNBannerSourceListenerPresentableViewController *)self readyCompletion];

  if (v6 != v5)
  {
    v7 = [(BNBannerSourceListenerHostedPresentableViewController *)self isReady];
    if (v5 && v7)
    {
      v8 = [(BNBannerSourceListenerPresentableViewController *)self readyCompletion];
    ...
    else
    {
      ...
      [(BNBannerSourceListenerPresentableViewController *)&v9 _setReadyCompletion:v5];
    }
  }
}
...
- (void)viewWillTransitionToSize:(CGSize)a3 withTransitionCoordinator:(id)a4
{
  ...
  [(BNBannerSourceListenerHostedPresentableViewController *)&v35 viewWillTransitionToSize:v7 withTransitionCoordinator:width, height];
  ...
  v13 = [(BNBannerSourceListenerHostedPresentableViewController *)self view];
  v14 = [v13 window];
...
- (BOOL)isDraggingDismissalEnabled
{
  ...
  v3 = [(BNBannerSourceListenerPresentableViewController *)&v10 isDraggingDismissalEnabled];
  if (![(BNBannerSourceListenerPresentableViewController *)self _isPresentableContextInterfaceAvailable])
  {
    ...
    v3 = [v8 isDraggingDismissalEnabled];
  }
...
- (BOOL)isDraggingInteractionEnabled
{
  v10.receiver = self;
  v10.super_class = BNBannerSourceListenerHostedPresentableViewController;
  v3 = [(BNBannerSourceListenerPresentableViewController *)&v10 isDraggingInteractionEnabled];
  if (![(BNBannerSourceListenerPresentableViewController *)self _isPresentableContextInterfaceAvailable])
  {
    v4 = [(FBScene *)self->_scene clientSettings];
    v5 = objc_opt_class();
    ...
    v3 = [v8 isDraggingInteractionEnabled];
  }
...
- (BOOL)isTouchOutsideDismissalEnabled
{
  v10.receiver = self;
  v10.super_class = BNBannerSourceListenerHostedPresentableViewController;
  v3 = [(BNBannerSourceListenerPresentableViewController *)&v10 isTouchOutsideDismissalEnabled];
  if (![(BNBannerSourceListenerPresentableViewController *)self _isPresentableContextInterfaceAvailable])
  {
    v4 = [(FBScene *)self->_scene clientSettings];
    v5 = objc_opt_class();
    ...
    v3 = [v8 isTouchOutsideDismissalEnabled];
  }
...
- (void)presentableDidDisappearAsBanner:(id)a3 withReason:(id)a4
{
  ...
  {
    v11 = [(FBScene *)self->_scene settings];
    v12 = [v11 mutableCopy];
    v13 = objc_opt_class();
    v14 = v12;
    if (v13)
...
- (void)presentableWillNotAppearAsBanner:(id)a3 withReason:(id)a4
{
  ...
  if (![(BNBannerSourceListenerPresentableViewController *)self _isPresentableContextInterfaceAvailable])
  {
    v7 = [[BNBannerSourceListenerPresentableRejectionAction alloc] initWithReason:v6];
    v8 = [(BNBannerSourceListenerHostedPresentableViewController *)self scene];
    v9 = [objc_alloc(MEMORY[0x1E695DFD8]) initWithObjects:{v7, 0}];
    [v8 sendActions:v9];
  }
...
- (void)scene:(id)a3 didUpdateClientSettings:(id)a4
{
  ...
  v8 = v7;
  v10 = v9;
  [(BNBannerSourceListenerHostedPresentableViewController *)self _updatePreferredContentSizeWithScene:v16 transitionContext:v6];
  v14 = *&self->_bannerContentOutsets.bottom;
  v15 = *&self->_bannerContentOutsets.top;
  [(BNBannerSourceListenerHostedPresentableViewController *)self _updateBannerContentOutsetsWithScene:v16];
  [(BNBannerSourceListenerHostedPresentableViewController *)self preferredContentSize];
  ...
  {
    v13 = [(BNBannerSourceListenerHostedPresentableViewController *)self parentViewController];
    [v13 bannerContentOutsetsDidInvalidateForPresentableViewController:self];
  }

  [(BNBannerSourceListenerHostedPresentableViewController *)self _updateClippingWithScene:v16];
}

- (void)sceneDidInvalidate:(id)a3 withContext:(id)a4
{
  [(BNBannerSourceListenerHostedPresentableViewController *)self _tearDownSceneInfrastructureIfNecessary:a3];
...
- (void)bannerSourceListenerPresentableViewControllerViewDidChangeSize:(id)a3
{
  ...
  v4 = [(BNBannerSourceListenerHostedPresentableViewController *)self view];
  v5 = [v4 superview];
  v6 = v5;
  if (v5)
  {
  ...
  v24 = [MEMORY[0x1E69DD250] _isInAnimationBlockWithAnimationsEnabled];
  scene = self->_scene;
  if (v24)
  {
    ...
    if ([(FBScene *)self->_scene isActive]&& v31)
    {
      ...
      if ((objc_opt_respondsToSelector() & 1) != 0 && ![v33 shouldFenceAnimationsForPresentable:self])
      {
        v35 = 0;
      }
      ...
      {
        v35 = [MEMORY[0x1E69DCE70] _synchronizedDrawingFence];
      }
