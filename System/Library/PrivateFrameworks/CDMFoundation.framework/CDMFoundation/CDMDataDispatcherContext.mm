...
- (CDMDataDispatcherContext)initWithCallingBundleId:(id)id;
@end
...
- (CDMDataDispatcherContext)initWithCallingBundleId:(id)id
{
  ...
  if (v6)
  {
    objc_storeStrong(&v6->_callingBundleId, id);
    uUID = [MEMORY[0x1E696AFB0] UUID];
    streamUUID = v7->_streamUUID;
    v7->_streamUUID = uUID;

    v7->_cdmSELFLoggingPolicyType = [CDMSELFLoggingPolicy getSELFCDMLoggingPolicyType:idCopy];
