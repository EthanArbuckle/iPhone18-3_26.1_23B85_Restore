...
- (id)contextMetadataWithBundleIdentifier:()CoreDuetContext eventUUID:
{
  ...
  v14 = [MEMORY[0x1E696AD98] numberWithBool:{objc_msgSend(self, "_donatedBySiri")}];
  v15 = +[_CDContextQueries intentDonatedBySiriKey];
  [v9 setObject:v14 forKeyedSubscript:v15];

  v16 = [MEMORY[0x1E696AD98] numberWithInteger:{objc_msgSend(self, "intentHandlingStatus")}];
  ...
  v20 = [MEMORY[0x1E696AD98] numberWithInteger:{objc_msgSend(self, "direction")}];
  v21 = +[_CDContextQueries intentDirectionKey];
  [v9 setObject:v20 forKeyedSubscript:v21];

  intent = [self intent];
  contextMetadata = [intent contextMetadata];
  [v9 addEntriesFromDictionary:contextMetadata];
