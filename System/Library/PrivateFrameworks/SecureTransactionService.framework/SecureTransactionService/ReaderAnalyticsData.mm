...
- (id)description
{
  ...
  untrustedIssuerOrganization = [v3 stringWithFormat:@"<%@ trusted = %@; untrustedIdentifier = %@; untrustedOrganization = %@; untrustedIssuerIdentifier = %@; untrustedIssuerOrganization = %@>", v5, v6, v7, v8, v9, untrustedIssuerOrganization];;
