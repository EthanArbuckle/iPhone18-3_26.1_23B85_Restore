...
- (id)px_tintedCircularImageWithColor:()PhotosUIFoundation backgroundColor:
{
  ...
  v7 = a3;
  [a1 contentInsets];
  v8 = [a1 px_tintedCircularImageWithColor:v7 backgroundColor:v6 backgroundInsets:?];
...
- (id)px_tintedImageWithColor:()PhotosUIFoundation size:scale:insets:
{
  ...
  [a1 drawInRect:17 blendMode:v14 alpha:{v15, v16, v17, 1.0}];
  [v18 setFill];
...
- (id)px_tintedImageWithColor:()PhotosUIFoundation
{
  ...
  v8 = v7;
  [a1 scale];
  v10 = [a1 px_tintedImageWithColor:v4 size:v6 scale:v8 insets:{v9, *MEMORY[0x1E69DDCE0], *(MEMORY[0x1E69DDCE0] + 8), *(MEMORY[0x1E69DDCE0] + 16), *(MEMORY[0x1E69DDCE0] + 24)}];
...
+ (id)px_roundedCornerMaskImage:()PhotosUIFoundation size:
{
  ...
  else
  {
    ...
    v14 = [MEMORY[0x1E69DC728] px_bezierPathWithRoundedRect:0.0 topLeftCornerRadius:0.0 topRightCornerRadius:a5 bottomLeftCornerRadius:a6 bottomRightCornerRadius:{a1, a2, a3, a4}];
    [v14 fill];
...
+ (id)px_systemImageNamed:()PhotosUIFoundation
{
  if (a3)
  {
    v4 = [a1 px_systemImageNamed:a3 withConfiguration:0];
  }
