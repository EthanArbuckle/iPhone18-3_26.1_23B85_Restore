...
- (PXUserDefaultsStandardDataSource)init
{
  ...
  [v4 handleFailureInMethod:a2 object:self file:@"PXUserDefaults.m" lineNumber:362 description:{@"%s is not available as initializer", "-[PXUserDefaultsStandardDataSource init]"}];
