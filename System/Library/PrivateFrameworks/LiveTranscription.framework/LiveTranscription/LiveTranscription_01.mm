uint64_t sub_25604B208(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5)
{
  ...
  v12 = v25 - v11;
  sub_2560331D0(a3, v25 - v11, &qword_27F825750, &qword_256055E80);
  v13 = sub_2560537AC();
  v14 = *(v13 - 8);
...
size_t sub_25604B7EC(size_t result, int64_t a2, char a3, void *a4)
{
  v5 = result;
  if (a3)
  {
...
uint64_t sub_25604BAD0(uint64_t a1, char a2)
{
  v3 = v2;
  v5 = *v2;
  if (*(*v2 + 24) > a1)
...
uint64_t sub_25604BD60(uint64_t a1, int a2)
{
  v3 = v2;
  v6 = sub_25605347C();
  v7 = *(v6 - 8);
...
LABEL_17:
      ...
      v30 = *(*(v11 + 56) + 8 * v27);
      v31 = *(v14 + 40);
      sub_2560506F4(&qword_27F8256B8, 255, MEMORY[0x277CC9788]);
...
uint64_t sub_25604C128(uint64_t a1, int a2)
{
  v3 = v2;
  v6 = sub_25605347C();
  v7 = *(v6 - 8);
...
LABEL_11:
      (*(v9 + 16))(v12, a1, v8);
      return sub_25604CE90(v15, v12, v21, a3);
    }
  }
...
void sub_25604CCC4(uint64_t a1, uint64_t a2, char a3)
{
  ...
  if (v20 < v18 || (a3 & 1) == 0)
  {
    ...
    sub_25604C128(v18, a3 & 1);
    v24 = *v4;
    v25 = sub_256035B1C(a2);
    if ((v19 & 1) == (v26 & 1))
    {
      v15 = v25;
      v21 = *v4;
...
uint64_t sub_25604D64C(uint64_t (*a1)(void *), uint64_t a2, uint64_t a3)
{
  v4 = *(a3 + 16);
  if (v4)
  {
...
size_t sub_25604D6F8(size_t a1, int64_t a2, char a3)
{
...
size_t sub_25604D718(size_t result, int64_t a2, char a3, void *a4)
{
  v5 = result;
  if (a3)
  {
...
uint64_t sub_25604D8F0(uint64_t a1, char *a2)
{
  ...
  v11 = *v2;
  v12 = *(*v2 + 40);
  sub_2560506F4(&qword_27F825990, 255, MEMORY[0x277CDC9C0]);
  v36 = a2;
  v13 = sub_25605366C();
  v14 = v11 + 56;
  v34 = v11 + 56;
  ...
  if ((*(v14 + ((v16 >> 3) & 0xFFFFFFFFFFFFFF8)) >> v16))
  {
    ...
    while (1)
    {
      ...
      sub_2560506F4(&qword_27F825998, 255, MEMORY[0x277CDC9C0]);
      v23 = sub_25605368C();
      v24 = *v21;
      (*v21)(v10, v6);
      if (v23)
...
LABEL_7:
    ...
    v17(v10, v36, v6);
    v37 = *v3;
    sub_25604DF38(v10, v16, isUniquelyReferenced_nonNull_native);
    *v3 = v37;
    (*(v7 + 32))(a1, v27, v6);
    return 1;
  }
...
void *sub_25604E8A4(void *a1)
{
  ...
  (*(v10 + 104))(v13, *MEMORY[0x277CE67B8], v9);
  v14 = sub_25605348C();
  (*(v10 + 8))(v13, v9);
  if (v14)
  {
  ...
  else
  {
    ...
    if (v45)
    {
      ...
      v19 = *(v3 + 16);
      v18 = v3 + 16;
      v41 = (*(v18 + 64) + 32) & ~*(v18 + 64);
      v44 = &v15[v41];
      v46 = *(v18 + 56);
      v47 = v19;
      v20 = off_27F825838 + 56;
      v21 = (v18 - 8);
      v48 = v18;
      v40 = (v18 + 16);
      ...
      while (1)
      {
        ...
        v28 = -1 << *(v17 + 32);
        v29 = v27 & ~v28;
        if ((*&v20[(v29 >> 3) & 0xFFFFFFFFFFFFFF8] >> v29))
        {
          v30 = ~v28;
          while (1)
          {
          ...
          {
            v33 = sub_25604B7EC(0, v33[2] + 1, 1, v33);
          }
          ...
          if (v35 >= v34 >> 1)
          {
            v43 = sub_25604B7EC(v34 > 1, v35 + 1, 1, v43);
          }
...
uint64_t _s17LiveTranscription15AXLCTranscriberC18formattedLocaleIDs4fromSaySSGSay10Foundation0E0VG_tFZ_0(uint64_t a1)
{
  v42 = sub_25605347C();
  v2 = *(v42 - 8);
  v3 = *(v2 + 64);
...
uint64_t type metadata accessor for AXLCTranscriber()
{
...
uint64_t sub_2560502B0(uint64_t result)
{
  if (result)
  {
  }
...
uint64_t sub_2560506F4(unint64_t *a1, uint64_t a2, void (*a3)(uint64_t))
{
  result = *a1;
  if (!result)
  {
...
unint64_t sub_25605073C(uint64_t a1)
{
  ...
  if (v7)
  {
    ...
    while (1)
    {
      sub_2560331D0(v10, v6, &qword_27F8259B0, &qword_2560560D8);
      result = sub_256035B1C(v6);
      if (v13)
      {
        break;
      }
...
unint64_t sub_256050924(uint64_t a1)
{
  ...
  if (v7)
  {
    ...
    while (1)
    {
      sub_2560331D0(v10, v6, &qword_27F8259A8, &qword_2560560D0);
      result = sub_256035B1C(v6);
      if (v13)
      {
        break;
...
uint64_t sub_25605113C(void *a1)
{
  v2 = *(v1 + 16);
  if (*a1 == *v2 && a1[1] == v2[1])
  {
...
uint64_t sub_2560513EC(void *a1, void *a2, void *a3)
{
  if (*a1 != -1)
  {
    v6 = a2;
...
void handleInputBuffer_cold_1(int a1, NSObject *a2)
{
  ...
  v3[0] = 67109120;
  v3[1] = a1;
  _os_log_debug_impl(&dword_256022000, a2, OS_LOG_TYPE_DEBUG, "HandleInputBuffer with packets: %i", v3, 8u);
