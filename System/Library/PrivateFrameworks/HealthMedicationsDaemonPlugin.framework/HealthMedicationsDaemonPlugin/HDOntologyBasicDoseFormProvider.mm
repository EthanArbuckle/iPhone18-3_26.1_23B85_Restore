...
+ (id)basicDoseFormsForConceptWithIdentifier:(id)identifier ontologyTransaction:(id)transaction error:(id *)error
{
  ...
  if (v6)
  {
    ...
    if (v7)
    {
      v9 = [MEMORY[0x277D107D0] localizedOntologyPreferredNamesForConcept:v7 withUserDomainConceptPropertyType:160016];
    }
    ...
    else
    {
      ...
      v9 = [MEMORY[0x277D107D0] nullLocalizedOntologyPreferredNamesWithVersion:v13 withUserDomainConceptPropertyType:160016];
    }
