...
+ (id)genericMedicationContentForConceptWithIdentifier:(id)identifier ontologyTransaction:(id)transaction error:(id *)error
{
  ...
  v12 = 0;
  v13 = v5;
  v6 = [MEMORY[0x277D103B8] followRelationshipsWithTypes:&unk_2863C2DF8 startingIdentifier:identifier options:12 ontologyTransaction:transaction conceptOut:&v12 deletedRelationshipVersionOut:&v13 error:error];
  v7 = v12;
  v8 = 0;
  if (v6)
  {
