...
- (HDOntologyCoreMedsFeatureEvaluator)initWithDaemon:(id)daemon;
- (HDOntologyCoreMedsFeatureEvaluator)initWithDaemon:(id)daemon medicationCountProvider:(id)provider;
