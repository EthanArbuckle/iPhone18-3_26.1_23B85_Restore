...
- (BOOL)isEqual:(id)a3
{
  ...
  else
  {
    ...
    {
      v5 = v4;
      v6 = [(HAPAccessCodeCharacterSetWrapper *)self value];
      v7 = [(HAPAccessCodeCharacterSetWrapper *)v5 value];
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v5 = [(HAPAccessCodeCharacterSetWrapper *)self value];
...
- (id)serializeWithError:(id *)a3
{
  v3 = [(HAPAccessCodeCharacterSetWrapper *)self value];
...
+ (id)parsedFromData:(id)a3 error:(id *)a4
{
  ...
  {
    v11 = 0;
    [(HAPAccessCodeCharacterSetWrapper *)v6 parseFromData:v5 error:&v11];
    v8 = v11;
    if (v8)
    {
