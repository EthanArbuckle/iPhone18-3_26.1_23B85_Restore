...
- (BOOL)isEqual:(id)a3
{
  ...
  else
  {
    ...
    {
      v5 = v4;
      v6 = [(HAP2TLVThreadOperationTypeWrapper *)self value];
      v7 = [(HAP2TLVThreadOperationTypeWrapper *)v5 value];
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v5 = [(HAP2TLVThreadOperationTypeWrapper *)self value];
...
- (id)serializeWithError:(id *)a3
{
  v3 = [(HAP2TLVThreadOperationTypeWrapper *)self value];
...
+ (id)parsedFromData:(id)a3 error:(id *)a4
{
  ...
  {
    v11 = 0;
    [(HAP2TLVThreadOperationTypeWrapper *)v6 parseFromData:v5 error:&v11];
    v8 = v11;
    if (v8)
    {
