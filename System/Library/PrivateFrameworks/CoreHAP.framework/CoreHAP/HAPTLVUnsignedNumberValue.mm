...
- (id)description
{
  ...
  v4 = [v2 stringWithFormat:@"<HAPTLVUnsignedNumberValue value=%llu>", objc_msgSend(value, "unsignedLongLongValue")];
...
{
  value = [(HAPTLVNumberValueBase *)self value];
  v3 = HAPTLVWriteUInt64([value unsignedLongLongValue]);
...
- (id)_parseFromData:(const char *)data length:(unint64_t)length status:(int *)status
{
  ...
  v6 = HAPTLVParseUInt64(data, length, status);
