...
- (HAPUpdateNotReadyReasonsWrapper)initWithValue:(unint64_t)value;
...
- (BOOL)isEqual:(id)equal
{
  ...
  else
  {
    ...
    {
      v5 = equalCopy;
      value = [(HAPUpdateNotReadyReasonsWrapper *)self value];
      value2 = [(HAPUpdateNotReadyReasonsWrapper *)v5 value];
...
- (id)copyWithZone:(_NSZone *)zone
{
  v4 = [HAPUpdateNotReadyReasonsWrapper allocWithZone:zone];
  value = [(HAPUpdateNotReadyReasonsWrapper *)self value];

  return [(HAPUpdateNotReadyReasonsWrapper *)v4 initWithValue:value];
}
...
+ (id)parsedFromData:(id)data error:(id *)error
{
  ...
  {
    v11 = 0;
    [(HAPUpdateNotReadyReasonsWrapper *)v6 parseFromData:dataCopy error:&v11];
    v8 = v11;
    if (v8)
    {
