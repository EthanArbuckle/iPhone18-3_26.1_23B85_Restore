...
- (NSString)description
{
  ...
  v5 = [(HAPDataStreamTransportConfiguration *)self maximumControllerTransportMTU];
  v6 = [v3 stringWithFormat:@"<HAPDataStreamTransportConfiguration transport=%@, maximumControllerTransportMTU=%@>", v4, v5];
