...
- (BOOL)isEqual:(id)a3
{
  ...
  else
  {
    ...
    {
      v5 = v4;
      v6 = [(HAPAccessCodeResponseStatusWrapper *)self value];
      v7 = [(HAPAccessCodeResponseStatusWrapper *)v5 value];
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v5 = [(HAPAccessCodeResponseStatusWrapper *)self value];
...
- (id)serializeWithError:(id *)a3
{
  v3 = [(HAPAccessCodeResponseStatusWrapper *)self value];
...
+ (id)parsedFromData:(id)a3 error:(id *)a4
{
  ...
  {
    v11 = 0;
    [(HAPAccessCodeResponseStatusWrapper *)v6 parseFromData:v5 error:&v11];
    v8 = v11;
    if (v8)
    {
