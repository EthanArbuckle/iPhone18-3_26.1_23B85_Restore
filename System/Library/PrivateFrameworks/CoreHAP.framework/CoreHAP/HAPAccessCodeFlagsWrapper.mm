...
- (HAPAccessCodeFlagsWrapper)initWithValue:(unint64_t)value;
...
- (BOOL)isEqual:(id)equal
{
  ...
  else
  {
    ...
    {
      v5 = equalCopy;
      value = [(HAPAccessCodeFlagsWrapper *)self value];
      value2 = [(HAPAccessCodeFlagsWrapper *)v5 value];
...
- (id)copyWithZone:(_NSZone *)zone
{
  v4 = [HAPAccessCodeFlagsWrapper allocWithZone:zone];
  value = [(HAPAccessCodeFlagsWrapper *)self value];

  return [(HAPAccessCodeFlagsWrapper *)v4 initWithValue:value];
}
...
+ (id)parsedFromData:(id)data error:(id *)error
{
  ...
  {
    v11 = 0;
    [(HAPAccessCodeFlagsWrapper *)v6 parseFromData:dataCopy error:&v11];
    v8 = v11;
    if (v8)
    {
