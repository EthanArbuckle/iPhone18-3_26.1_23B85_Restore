...
- (NSString)description
{
  ...
  v4 = [v2 stringWithFormat:@"<HAPSupportedCharacteristicValueTransitionConfiguration transitions=%@>", transitions];
...
- (BOOL)parseFromData:(id)data error:(id *)error
{
  ...
  {
LABEL_18:
    [(HAPSupportedCharacteristicValueTransitionConfiguration *)self setTransitions:array];
    v10 = 0;
    v17 = 1;
  }
...
{
  v3.receiver = self;
  v3.super_class = HAPSupportedCharacteristicValueTransitionConfiguration;
