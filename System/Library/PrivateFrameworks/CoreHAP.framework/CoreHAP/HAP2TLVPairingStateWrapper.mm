...
- (HAP2TLVPairingStateWrapper)initWithValue:(int64_t)value;
...
- (BOOL)isEqual:(id)equal
{
  ...
  else
  {
    ...
    {
      v5 = equalCopy;
      value = [(HAP2TLVPairingStateWrapper *)self value];
      value2 = [(HAP2TLVPairingStateWrapper *)v5 value];
...
- (id)copyWithZone:(_NSZone *)zone
{
  v4 = [HAP2TLVPairingStateWrapper allocWithZone:zone];
  value = [(HAP2TLVPairingStateWrapper *)self value];

  return [(HAP2TLVPairingStateWrapper *)v4 initWithValue:value];
}
...
{
  v5.receiver = self;
  v5.super_class = HAP2TLVPairingStateWrapper;
...
{
  v3.receiver = self;
  v3.super_class = HAP2TLVPairingStateWrapper;
...
+ (id)parsedFromData:(id)data error:(id *)error
{
  ...
  {
    v11 = 0;
    [(HAP2TLVPairingStateWrapper *)v6 parseFromData:dataCopy error:&v11];
    v8 = v11;
    if (v8)
    {
