...
- (id)description
{
  ...
  v18 = [(HAPBLEPeripheralInfo *)self advertisedProtocolVersion];
  v17 = [(HAPBLEPeripheralInfo *)self previousProtocolVersion];
  v16 = [(HAPBLEPeripheralInfo *)self resumeSessionId];
