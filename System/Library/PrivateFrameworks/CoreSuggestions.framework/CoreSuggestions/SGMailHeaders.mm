...
- (SGMailHeaders)initWithCoder:(id)a3
{
  ...
  v5 = objc_opt_class();
  v6 = sgLogHandle();
  v35 = [v4 robustDecodeObjectOfClass:v5 forKey:@"messageId" withCoder:v3 expectNonNull:1 errorDomain:@"SGErrorDomain" errorCode:11 logHandle:v6];

  v7 = MEMORY[0x1E69C5D78];
  v8 = objc_opt_class();
  v9 = sgLogHandle();
  v37 = [v7 robustDecodeObjectOfClass:v8 forKey:@"subject" withCoder:v3 expectNonNull:0 errorDomain:@"SGErrorDomain" errorCode:11 logHandle:v9];
  ...
  v15 = sgLogHandle();
  v36 = [v10 robustDecodeObjectOfClasses:v14 forKey:@"from" withCoder:v3 expectNonNull:0 errorDomain:@"SGErrorDomain" errorCode:11 logHandle:v15];
  ...
  if (v35 && ([v3 error], v30 = objc_claimAutoreleasedReturnValue(), v30, !v30))
  {
...
- (SGMailHeaders)initWithMessageId:(id)a3
{
  ...
  if (!v6)
  {
    ...
    [v10 handleFailureInMethod:a2 object:self file:@"SGMailHeaders.m" lineNumber:27 description:{@"Invalid parameter not satisfying: %@", @"messageId"}];
  }
  ...
  if (v7)
  {
    objc_storeStrong(&v7->_messageId, a3);
  }
