...
- (SGMSuggestedContactDetailShown)init
{
  ...
  v10.receiver = self;
  v10.super_class = SGMSuggestedContactDetailShown;
  v2 = [(SGMSuggestedContactDetailShown *)&v10 init];
  if (v2)
  {
    ...
    v6 = [v4 initWithFeatureId:@"Found" event:@"SuggestedContactDetailShown" registerProperties:v5 propertySubsets:MEMORY[0x1E695E0F0]];
    tracker = v2->_tracker;
    v2->_tracker = v6;
  }
