...
- (SGMEventResultInSpotlight)init
{
  ...
  v10.receiver = self;
  v10.super_class = SGMEventResultInSpotlight;
  v2 = [(SGMEventResultInSpotlight *)&v10 init];
  if (v2)
  {
    ...
    v6 = [v4 initWithFeatureId:@"Found" event:@"EventResultInSpotlight" registerProperties:v5 propertySubsets:MEMORY[0x1E695E0F0]];
    tracker = v2->_tracker;
    v2->_tracker = v6;
  }
