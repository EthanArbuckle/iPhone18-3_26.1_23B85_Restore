...
- (SGMContactRejected)init
{
  ...
  v14.receiver = self;
  v14.super_class = SGMContactRejected;
  v2 = [(SGMContactRejected *)&v14 init];
  if (v2)
  {
    ...
    v10 = [v8 initWithFeatureId:@"Found" event:@"ContactRejected" registerProperties:v9 propertySubsets:MEMORY[0x1E695E0F0]];
    tracker = v2->_tracker;
    v2->_tracker = v10;
  }
