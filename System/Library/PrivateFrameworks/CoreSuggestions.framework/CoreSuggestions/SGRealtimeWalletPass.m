...
- (NSString)description
{
  ...
  v6 = [v3 initWithFormat:@"<SGRealtimeWalletPass identifier='%@' walletPassDictionary='%@'>", identifier, v5];
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    v6 = v4 && (objc_opt_class(), (objc_opt_isKindOfClass() & 1) != 0) && [(SGRealtimeWalletPass *)self isEqualToRealtimeWalletPass:v5];
  }
...
- (SGRealtimeWalletPass)initWithCoder:(id)a3
{
  ...
  if (v5)
  {
    ...
    v10 = [v4 decodeObjectOfClasses:v9 forKey:@"walletPassDictionaryData"];
    ...
    v13 = [v4 decodeObjectOfClasses:v12 forKey:@"walletPassData"];
...
LABEL_13:
    ...
    [v26 handleFailureInMethod:a2 object:self file:@"SGRealtimeWalletPass.m" lineNumber:25 description:{@"Invalid parameter not satisfying: %@", @"passDictionary"}];
  ...
  [v25 handleFailureInMethod:a2 object:self file:@"SGRealtimeWalletPass.m" lineNumber:24 description:{@"Invalid parameter not satisfying: %@", @"identifier"}];
...
LABEL_14:
  ...
  [v27 handleFailureInMethod:a2 object:self file:@"SGRealtimeWalletPass.m" lineNumber:26 description:{@"Invalid parameter not satisfying: %@", @"walletPassData"}];
...
LABEL_4:
  ...
  else
  {
    ...
    if (v19)
    {
      ...
      objc_storeStrong(&v20->_walletPassData, a6);
