...
- (id)createVisibilityPropagationInteraction
{
  ...
  sub_265747104(self + OBJC_IVAR____SEContentProcess_inner, v6, type metadata accessor for _ContentProcess);
  selfCopy = self;
  *atoken.val = _s17ServiceExtensions11_GPUProcessV10auditTokenSo0D8_token_tavg_0();
  ...
  sub_26574716C(v6, type metadata accessor for _ContentProcess);
