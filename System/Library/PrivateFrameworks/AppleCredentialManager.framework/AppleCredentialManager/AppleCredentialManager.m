...
void sub_100001068(uint64_t a1, void *a2)
{
  v3 = a2;
  v4 = os_transaction_create();
  v5 = [NSString stringWithUTF8String:xpc_dictionary_get_string(v3, _xpc_event_key_name)];
  if (os_log_type_enabled(&_os_log_default, OS_LOG_TYPE_INFO))
  {
    *buf = 136315650;
    v17 = "acmd";
    v18 = 2080;
    v19 = "main_block_invoke";
    v20 = 2112;
    v21 = v5;
    _os_log_impl(&_mh_execute_header, &_os_log_default, OS_LOG_TYPE_INFO, "%s: %s: XPC Event: %@ (iokit).\n", buf, 0x20u);
  }
  ...
  if (v7)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        [*(*(&v11 + 1) + 8 * v10) handleXPCEventWithName:{v5, v11}];
        v10 = v10 + 1;
      }
...
id sub_100001238(void *a1, void *a2)
{
  v3 = a2;
  v4 = IORegistryEntryFromPath(kIOMainPortDefault, [a1 UTF8String]);
  if (v4)
  {
    v5 = v4;
...
uint64_t sub_1000012E8(const char *a1, void *a2, int a3)
{
  v5 = a2;
  if (os_log_type_enabled(&_os_log_default, OS_LOG_TYPE_INFO))
  {
    ...
    *buf = 136315906;
    ...
    v21 = 2080;
    v22 = v6;
    _os_log_impl(&_mh_execute_header, &_os_log_default, OS_LOG_TYPE_INFO, "%s: %s: called, filePath=%s (fullSync=%s).\n", buf, 0x2Au);
  }

  v7 = open_dprotected_np(a1, 514, 4, 0, 384);
  if (v7 < 0)
  {
    goto LABEL_14;
  }
  ...
  v10 = v9;
  v11 = fwrite([v5 bytes], 1uLL, objc_msgSend(v5, "length"), v9);
  if (v11 != [v5 length] || a3 && (v12 = fileno(v10), fcntl(v12, 51)) || fclose(v10))
  {
    fclose(v10);
LABEL_14:
    sub_10000B120(buf);
...
{
  if (byte_10002034A <= 0xAu && os_log_type_enabled(&_os_log_default, OS_LOG_TYPE_INFO))
  {
    *buf = 136315394;
    v6 = "ACMLib";
    v7 = 2080;
  ...
  v2 = LibCall_ACMKernelControl_Block(sub_1000019C8);
  if (v2)
  {
    v3 = 70;
  }
  ...
  if (v3 >= byte_10002034A && os_log_type_enabled(&_os_log_default, OS_LOG_TYPE_INFO))
  {
    *buf = 136315906;
    v6 = "ACMLib";
    v7 = 2080;
...
uint64_t sub_1000019C8(uint64_t *a1, char a2, char a3, const void *a4, size_t a5, void *a6, size_t *a7)
{
  if (byte_10002034A <= 0xAu && os_log_type_enabled(&_os_log_default, OS_LOG_TYPE_INFO))
  {
    sub_10000A22C();
  ...
  if (a1)
  {
    ...
    {
      v21 = sub_100001E8C(*a1, a2, a3, a4, a5, a6, a7);
      if (v21)
      {
        v20 = 70;
      }
  ...
  if (v20 >= byte_10002034A && os_log_type_enabled(&_os_log_default, OS_LOG_TYPE_INFO))
  {
    sub_10000A304();
    sub_10000A264();
    sub_10000A1B8();
...
uint64_t sub_100001CD8()
{
  ...
  else
  {
    ...
    v8 = MatchingService;
    v5 = IOServiceOpen(MatchingService, mach_task_self_, 0, &dword_10002039C);
    if (v5)
    {
      v9 = 70;
      goto LABEL_10;
  ...
  v9 = 10;
LABEL_10:
  if (v9 >= byte_10002034A && os_log_type_enabled(&_os_log_default, OS_LOG_TYPE_INFO))
  {
    sub_10000A304();
    sub_10000A264();
    sub_10000A1B8();
...
uint64_t sub_100001E8C(uint64_t a1, char a2, char a3, const void *a4, size_t a5, void *a6, size_t *a7)
{
  if (byte_10002034A <= 0xAu && os_log_type_enabled(&_os_log_default, OS_LOG_TYPE_INFO))
  {
    sub_1000022CC();
  ...
  if (v19)
  {
    ...
    else
    {
      ...
      v44 = v21;
      v22 = IOConnectCallStructMethod(dword_10002039C, 0, v19, inputStructCnt, a6, &v44);
      v23 = v22;
      if (a1)
      {
        v24 = *(a1 + 16);
      ...
      if (v22)
      {
        if (byte_10002034A <= 0x46u && os_log_type_enabled(&_os_log_default, OS_LOG_TYPE_INFO))
        {
          sub_1000022CC();
          sub_100002274();
          v49 = v25;
      ...
      {
        if (byte_10002034A <= 0x28u && os_log_type_enabled(&_os_log_default, OS_LOG_TYPE_INFO))
        {
          sub_1000022CC();
          sub_100002274();
          sub_10000236C();
  ...
  if (v37 >= byte_10002034A && os_log_type_enabled(&_os_log_default, OS_LOG_TYPE_INFO))
  {
    v46 = 136315650;
    v47 = "ACMLib";
    sub_10000A214();
...
const char *acm_mem_alloc_info(const char *result, const void *a2, uint64_t a3, const char *a4, int a5, const char *a6)
{
  ...
  if (gACMLoggingLevel <= 0x1Eu)
  {
    ...
    return printf("%s: %s: mem: type=%s ptr=%p size=%u (total=%u raw=%u data=%u types=%u) %s:%d (%s).\n", "ACM", "acm_mem_alloc_info", v7, a2, a3, qword_100020378, 0, qword_100020380, qword_100020388, v8, a5, v6);
  }

  return result;
}

void sub_1000022F4(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, unint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, uint64_t a16, uint64_t a17, uint64_t a18, uint64_t a19, uint64_t a20, uint64_t a21, uint64_t a22)
{
  a9 = *v22 - v25;
  v29 = *(v27 + 8 * v26);
...
uint64_t sub_100002320(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, const char *a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, __int128 a13, __int128 a14)
{
  a13 = 0u;
  a14 = 0u;
...
uint64_t sub_1000023A8(void *a1, rsize_t __n)
{

  return memset_s(a1, __n, 0, __n);
}

uint64_t sub_1000023C8@<X0>(uint64_t a1@<X8>, uint64_t a2)
{
  a2 = a1;

  return sub_100005800(v4, v3, v2, &a2);
}
...
const char *acm_mem_free_info(const char *result, const void *a2, unint64_t a3, const char *a4, int a5, const char *a6)
{
  if (a2)
  {
    v6 = qword_100020378 - a3;
    if (qword_100020378 < a3)
    {
      v6 = 0;
    }
  ...
  if (gACMLoggingLevel <= 0x1Eu)
  {
    ...
    return printf("%s: %s: mem: type=%s ptr=%p size=%u (total=%u raw=%u data=%u types=%u) %s:%d (%s).\n", "ACM", "acm_mem_free_info", v8, a2, a3, qword_100020378, 0, qword_100020380, qword_100020388, v9, a5, v7);
  }
...
void acm_mem_free_data(void *a1, rsize_t a2)
{
  if (a1)
  {
    sub_1000023A8(a1, a2);
    free(v3);
    v4 = qword_100020380 - v2;
    if (qword_100020380 < v2)
    {
      v4 = 0;
    }
...
{
  if (qword_100020358 != -1)
  {
    sub_10000B0F8();
  }

  return byte_100020350;
}

uint64_t sub_100002A98()
{
  if (qword_100020368 != -1)
  {
    sub_10000B10C();
  }

  return byte_100020360;
}

id sub_100002AF8(uint64_t a1)
{
  if (os_log_type_enabled(&_os_log_default, OS_LOG_TYPE_INFO))
  {
    v5 = 136315650;
    ...
    v9 = 2080;
    v10 = a1;
    _os_log_impl(&_mh_execute_header, &_os_log_default, OS_LOG_TYPE_INFO, "%s: %s: called, filePath = %s.\n", &v5, 0x20u);
  }
...
void start()
{
  ...
  v23 = 0u;
  v3 = v2;
  v4 = [v3 countByEnumeratingWithState:&v22 objects:v21 count:16];
  if (v4)
  {
    v5 = v4;
    v6 = *v23;
      ...
      for (i = 0; i != v5; i = i + 1)
      {
        ...
        if (os_log_type_enabled(&_os_log_default, OS_LOG_TYPE_INFO))
        {
          *buf = 136315650;
          ...
          v19 = 2112;
          v20 = v8;
          _os_log_impl(&_mh_execute_header, &_os_log_default, OS_LOG_TYPE_INFO, "%s: %s: Starting service: %@.\n", buf, 0x20u);
        }

        [v8 start];
      }

      v5 = [v3 countByEnumeratingWithState:&v22 objects:v21 count:16];
    }
...
void sub_100002EB8(uint64_t a1, void *a2)
{
  v3 = a2;
  v4 = os_transaction_create();
  v5 = [NSString stringWithUTF8String:xpc_dictionary_get_string(v3, _xpc_event_key_name)];
  if (os_log_type_enabled(&_os_log_default, OS_LOG_TYPE_INFO))
  {
    *buf = 136315650;
    ...
    v20 = 2112;
    v21 = v5;
    _os_log_impl(&_mh_execute_header, &_os_log_default, OS_LOG_TYPE_INFO, "%s: %s: XPC Event: %@ (notifyd).\n", buf, 0x20u);
  }
...
void sub_100003080(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(&_os_log_default, OS_LOG_TYPE_INFO))
  {
    *buf = 136315650;
    ...
    v20 = 2112;
    v21 = v5;
    _os_log_impl(&_mh_execute_header, &_os_log_default, OS_LOG_TYPE_INFO, "%s: %s: XPC Event: %@ (fsevents).\n", buf, 0x20u);
  }
...
id sub_100003310(uint64_t a1)
{
  if (os_log_type_enabled(&_os_log_default, OS_LOG_TYPE_INFO))
  {
    ...
    v4 = "ACMTRM-D";
    v5 = 2080;
    v6 = "[TransportRestrictedModeService initWithNotificationQueue:]_block_invoke";
    _os_log_impl(&_mh_execute_header, &_os_log_default, OS_LOG_TYPE_INFO, "%s: %s: alarm event received.\n", &v3, 0x16u);
  }

  [*(a1 + 32) cancelAlarm];
  return [*(a1 + 32) entryPoint_onAlarm];
}

id sub_100003B2C()
{
  v0 = +[MCProfileConnection sharedConnection];
  v1 = [v0 isUSBRestrictedModeAllowed];
...
uint64_t sub_100003DAC(uint64_t a1)
{
  ...
  if (a1)
  {
    if (result)
    {
      ...
      v4 = "ACMTRM-D";
      v5 = 2080;
      v6 = "onCheckAppleSetup";
      v7 = 2080;
      v8 = "YES";
      v9 = 2080;
      v10 = a1;
      _os_log_impl(&_mh_execute_header, &_os_log_default, OS_LOG_TYPE_INFO, "%s: %s: appleSetupCompleted = %s (trigger: %s).\n", &v3, 0x2Au);
      return 0;
    }
  }
...
void sub_100004DF0(void *a1, NSObject *a2, uint64_t a3, const char *a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint8_t a9)
{

  _os_log_impl(a1, a2, OS_LOG_TYPE_INFO, a4, &a9, 0x20u);
}
...
LABEL_19:
            if (v22 != v16)
            {
              ...
              if (v16 - (v22 + 1) >= 4)
              {
                ...
                v29 = *(a2 + v22 + 1);
                v37 = v22 + 5;
                v12 = sub_10000593C(a2, v16, &v37, &v36, &v35);
                if (!v12)
                {
                  *v33 = v21;
                  *a7 = v28;
...
LABEL_20:
                            ...
                            else
                            {
                              ...
                              v30 = *(a1 + v21);
                              v40 = v21 + 4;
                              v10 = sub_10000593C(a1, v17, &v40, &v39, &v38);
                              if (!v10)
                              {
                                *v11 = v28;
                                *v36 = v34;
...
uint64_t sub_100005474(unsigned int a1, _DWORD *a2)
{
  if (!a2)
  {
    sub_100005CA4();
...
uint64_t sub_1000055B4(uint64_t a1, uint64_t a2, uint64_t a3, void *a4)
{
  result = 0;
  *a4 = 24;
  return result;
...
uint64_t sub_1000055D4(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, int a10, char a11)
{

  return sub_100005710(a2, a3, &a11);
}

uint64_t sub_10000562C(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, int a5, int a6, int a7, int a8, uint64_t a9, uint64_t a10, uint64_t a11, void *a12, uint64_t a13, uint64_t a14, uint64_t a15, uint64_t a16, uint64_t a17, uint64_t a18, uint64_t a19, uint64_t a20, uint64_t a21, uint64_t a22)
{
  a10 = 0;
  a11 = 0;
...
__n128 sub_100005680(__n128 *a1, uint64_t a2, __n128 *a3, _DWORD *a4)
{
  result = *a1;
  *a3 = *a1;
  *a4 = a1[1].n128_u32[0];
...
__n128 sub_1000056C4@<Q0>(unsigned __int32 a1@<W1>, unsigned __int32 a2@<W2>, __n128 *a3@<X3>, void *a4@<X4>, __n128 *a5@<X8>)
{
  result = *a5;
  *a3 = *a5;
  a3[1].n128_u32[0] = a1;
...
uint64_t sub_100005800(uint64_t a1, int a2, uint64_t a3, uint64_t *a4)
{
  LODWORD(v6) = a2;
  if (gACMLoggingLevel <= 0xAu)
  {
...
uint64_t sub_10000593C(uint64_t a1, unint64_t a2, unint64_t *a3, void *size, _DWORD *a5)
{
  v10 = &DaemonService__metaData;
  if (gACMLoggingLevel <= 0xAu)
  {
...
uint64_t sub_100005BE0(_DWORD *a1)
{
  if (!a1)
  {
    return 4294967293;
...
uint64_t sub_100005D14(int a1, const char *a2)
{
  if (a1)
  {
...
void sub_100005DC8(uint64_t a1, size_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9)
{
...
uint64_t sub_100005E8C(uint64_t a1, uint64_t a2)
{
  ...
  {
    qword_100020390 = ccrng();
    v3 = sub_100005D14(-1, "ccrng");
    if (v3)
    {
      v6 = 0;
      v7 = 70;
...
void sub_100005FD8()
{
  ...
  sub_100005DC8(v6, v7, v8, v9, v10, v11, v12, v13, v20);
  if (v4)
  {
    if (v2)
    {
        ...
        if (v3)
        {
          if (v0)
          {
            ...
            if (v1 != -32)
            {
              ...
              sub_100005DBC();
              v15 = ccgcm_init();
              if (!sub_100005D14(v15, "ccgcm_init") && !sub_100005E8C(v3, 16))
              {
                sub_1000023EC();
                v16 = ccgcm_set_iv();
                if (!sub_100005D14(v16, "ccgcm_set_iv"))
                {
                  sub_100005DBC();
                  v17 = ccgcm_update();
                  if (!sub_100005D14(v17, "ccgcm_update"))
                  {
                    sub_1000023EC();
                    v18 = ccgcm_finalize();
                    if (!sub_100005D14(v18, "ccgcm_finalize"))
                    {
LABEL_13:
                      *v0 = v14;
                    }
...
void sub_100006198()
{
  ...
  sub_1000022BC();
  v6 = __chkstk_darwin(v5);
  sub_100005DC8(v6, v7, v8, v9, v10, v11, v12, v13, v24);
  if (v4)
  {
    if (v2)
    {
        ...
        if (v3)
        {
          if (v0)
          {
            ...
            if (v1 != -33)
            {
              ...
              sub_100005DBC();
              v15 = ccgcm_init();
              if (!sub_100005D14(v15, "ccgcm_init"))
              {
                *v3 = 2;
                v16 = (v3 + 1);
                sub_100005E50();
                if (!v17 && !sub_100005E8C(v16, 16))
                {
                  sub_1000023EC();
                  v18 = ccgcm_set_iv();
                  if (!sub_100005D14(v18, "ccgcm_set_iv"))
                  {
                    v19 = v16 + 16;
                    sub_100005E50();
                    if (!v20)
                    {
                      sub_100005DBC();
                      v21 = ccgcm_update();
                      if (!sub_100005D14(v21, "ccgcm_update") && !__CFADD__(v19, v1))
                      {
                        sub_1000023EC();
                        v22 = ccgcm_finalize();
                        if (!sub_100005D14(v22, "ccgcm_finalize"))
                        {
LABEL_16:
                          *v0 = v14;
                        }
...
void sub_100006388()
{
  ...
  sub_100005DC8(v11, v12, v13, v14, v15, v16, v17, v18, v25);
  if (v9)
  {
    if (v7)
    {
        ...
        if (v3)
        {
          if (v1)
          {
            ...
            if (v19)
            {
              ...
              sub_100005DBC();
              v21 = ccgcm_init();
              if (!sub_100005D14(v21, "ccgcm_init"))
              {
                sub_1000023EC();
                v22 = ccgcm_set_iv();
                if (!sub_100005D14(v22, "ccgcm_set_iv"))
                {
                  sub_100005DBC();
                  v23 = ccgcm_update();
                  if (!sub_100005D14(v23, "ccgcm_update"))
                  {
                    sub_1000023EC();
                    ccgcm_finalize();
                    v24 = cc_cmp_safe();
                    if (!sub_100005D14(v24, "cc_cmp_safe"))
                    {
LABEL_13:
                      *v1 = v20;
                    }
...
void sub_100006564()
{
  ...
  sub_1000022BC();
  v11 = __chkstk_darwin(v10);
  sub_100005DC8(v11, v12, v13, v14, v15, v16, v17, v18, v27);
  if (v9)
  {
    if (v7)
    {
                ...
                if (!sub_100005D14(v21, "ccgcm_init"))
                {
                  ...
                  if (!sub_100005D14(v22, "ccgcm_set_iv"))
                  {
                    ...
                    if (!v23)
                    {
                      sub_100005DBC();
                      v24 = ccgcm_update();
                      if (!sub_100005D14(v24, "ccgcm_update") && !__CFADD__(v7 + 17, v19))
                      {
                        sub_1000023EC();
                        ccgcm_finalize();
                        v25 = cc_cmp_safe();
                        if (!sub_100005D14(v25, "cc_cmp_safe"))
                        {
LABEL_16:
                          *v1 = v19;
                        }
...
rsize_t sub_100006C24(rsize_t result, int a2, unsigned __int8 a3, uint64_t a4, uint64_t a5, uint64_t a6, const void *a7, uint64_t a8, char a9, uint64_t a10, int a11, unsigned int a12, uint64_t a13)
{
  v20 = result;
  if (gACMLoggingLevel <= 0xAu)
  {
...
uint64_t ACMContextCreateWithFlags(uint64_t *a1, uint64_t a2)
{
  ...
  v8 = 0;
  v4 = LibCall_ACMContextCreate(sub_1000019C8, &v8, a1, a2, &byte_10002034A, 1);
  if (v4)
  {
    sub_100009FBC();
    v5 = 70;
  ...
  if (v5 >= byte_10002034A && os_log_type_enabled(&_os_log_default, OS_LOG_TYPE_INFO))
  {
    *buf = 136315650;
    v10 = "ACMLib";
    v11 = 2080;
...
uint64_t ACMContextCreateWithExternalForm(uint64_t a1, uint64_t a2)
{
  ...
  v8 = 0;
  v4 = LibCall_ACMContextCreateWithExternalForm(sub_1000019C8, &v8, a1, a2, &byte_10002034A, 1);
  if (v4)
  {
    if (byte_10002034A <= 0x28u && os_log_type_enabled(&_os_log_default, OS_LOG_TYPE_INFO))
    {
  ...
  if (v6 >= byte_10002034A && os_log_type_enabled(&_os_log_default, OS_LOG_TYPE_INFO))
  {
    *buf = 136315650;
    v10 = "ACMLib";
    v11 = 2080;
...
uint64_t ACMContextDelete(_DWORD *a1, int a2)
{
  ...
  v10 = a1;
  v7 = LibCall_ACMContextDelete(sub_1000019C8, &v10, a1, a2);
  if (v7)
  {
    v8 = 70;
  }
  ...
  if (v8 >= byte_10002034A && os_log_type_enabled(&_os_log_default, OS_LOG_TYPE_INFO))
  {
    *buf = 136315650;
    v12 = "ACMLib";
    v13 = 2080;
...
void ACMContextGetExternalForm(const void *a1, uint64_t a2)
{
  ...
  if (a1 && a2)
  {
    if (!sub_100001CD8() && !sub_100001E8C(a1, 19, 0, a1, 0x10uLL, 0, 0))
    {
      (*(a2 + 16))(a2, a1, 16);
      goto LABEL_9;
    }
...
uint64_t ACMContextVerifyPolicy(uint64_t a1, uint64_t a2, uint64_t a3)
{
  ...
  v9 = a1;
  v6 = LibCall_ACMContextVerifyPolicy_Block(sub_1000019C8, &v9, a1, a2, a3);
  if (v6)
  {
    v7 = 70;
  }
  ...
  if (v7 >= byte_10002034A && os_log_type_enabled(&_os_log_default, OS_LOG_TYPE_INFO))
  {
    *buf = 136315650;
    v11 = "ACMLib";
    v12 = 2080;
...
uint64_t ACMContextVerifyPolicyWithPreflight(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4)
{
  ...
  v11 = a1;
  v8 = LibCall_ACMContextVerifyPolicyWithPreflight_Block(sub_1000019C8, &v11, a1, a2, a3, a4);
  if (v8)
  {
    v9 = 70;
  }
...
void ACMContextVerifyPolicyEx(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7)
{
  ...
  v14 = a1;
  LibCall_ACMContextVerifyPolicyEx_Block(sub_1000019C8, &v14, a1, a2, a3, a4, a5, a6, a7);
  if (byte_10002034A <= 0xAu && os_log_type_enabled(&_os_log_default, OS_LOG_TYPE_INFO))
  {
    *buf = 136315394;
    v16 = "ACMLib";
...
uint64_t ACMParseAclAndCopyConstraintCharacteristics(const void *a1, uint64_t a2, uint64_t a3)
{
  ...
  SerializedProcessAclSize = sub_100001CD8();
...
LABEL_31:
  ...
  v13 = sub_100001E8C(0, 20, 0, v9, size, v12, &__n);
  v11 = __n;
  if (v13)
  {
    v6 = v13;
...
LABEL_19:
  ...
  if (v17 >= byte_10002034A && os_log_type_enabled(&_os_log_default, OS_LOG_TYPE_INFO))
  {
    *buf = 136315650;
    v22 = "ACMLib";
    v23 = 2080;
...
void ACMGetAclAuthMethod(__n128 *a1, uint64_t a2)
{
  ...
  v4 = a1;
  LibCall_ACMGetAclAuthMethod_Block(sub_1000019C8, &v4, a1, a2);
  if (byte_10002034A <= 0xAu && os_log_type_enabled(&_os_log_default, OS_LOG_TYPE_INFO))
  {
    *buf = 136315394;
    v6 = "ACMLib";
...
uint64_t ACMSetEnvironmentVariable(int a1)
{
  ...
  if (v4 >= byte_10002034A && os_log_type_enabled(&_os_log_default, OS_LOG_TYPE_INFO))
  {
    *buf = 136315906;
    v7 = "ACMLib";
    v8 = 2080;
...
uint64_t ACMGetEnvironmentVariable(uint64_t a1, uint64_t a2)
{
  ...
  v7 = 0;
  v4 = LibCall_ACMGetEnvironmentVariable_Block(sub_1000019C8, &v7, a1, a2);
  if (v4)
  {
    v5 = 70;
  }
...
void ACMGlobalContextCredentialGetProperty(int a1, int a2, uint64_t a3)
{
  ...
  v6 = 0;
  LibCall_ACMGlobalContextCredentialGetProperty_Block(sub_1000019C8, &v6, a1, a2, a3);
  if (byte_10002034A <= 0xAu && os_log_type_enabled(&_os_log_default, OS_LOG_TYPE_INFO))
  {
    *buf = 136315394;
    v8 = "ACMLib";
...
void ACMContextCredentialGetProperty(__n128 *a1, unsigned __int32 a2, unsigned __int32 a3, uint64_t a4)
{
  ...
  {
    v9 = a1;
    v8 = LibCall_ACMContextCredentialGetProperty(sub_1000019C8, &v9, a1, a2, a3, buf, &v10);
    (*(a4 + 16))(a4, v8, buf, v10);
  }
...
uint64_t ACMContextSetDataEx(uint64_t a1, int a2, int a3, int a4, int a5, int a6)
{
  ...
  v12 = LibCall_ACMContextSetData(sub_1000019C8, &v16, a1, a2, a3, a4, a5, a6, v15, a1, *buf, *&buf[8], *&buf[16], v18, v19, v20, v21, v22, v23, v24, v25, v26, v27, v28);
  if (v12)
  {
    v13 = 70;
  }
  ...
  if (v13 >= byte_10002034A && os_log_type_enabled(&_os_log_default, OS_LOG_TYPE_INFO))
  {
    *buf = 136315650;
    *&buf[4] = "ACMLib";
    *&buf[12] = 2080;
...
uint64_t ACMContextCopyData(__int128 *a1, uint64_t a2, __int128 *a3, uint64_t a4)
{
  ...
  v11 = 0;
  v8 = LibCall_ACMContextCopyData(sub_1000019C8, &v11, a1, a2, a3, a4);
  if (v8)
  {
    v9 = 70;
  }
...
uint64_t ACMContextGetInfo(__int128 *a1, int a2, void *a3)
{
  ...
  v9 = a1;
  v6 = LibCall_ACMContextGetInfo(sub_1000019C8, &v9, a1, a2, a3);
  if (v6)
  {
    v7 = 70;
  }
...
void sub_100009FBC()
{
  ...
  output = 0;
  outputCnt = 1;
  if (IOConnectCallScalarMethod(dword_10002039C, 2u, 0, 0, &output, &outputCnt))
  {
    goto LABEL_12;
  }

  v0 = output;
  byte_10002034A = output;
...
uint64_t sub_10000A238(uint64_t a1, char a2, uint64_t a3, uint64_t a4, size_t a5)
{

  return sub_100001E8C(a1, a2, 0, v5, a5, 0, 0);
}
...
uint64_t sub_10000A6E8(uint64_t a1, uint64_t a2, unsigned int *a3)
{
  result = 0;
  v4 = *a3;
  return result;
...
uint64_t sub_10000A75C(uint64_t (*a1)(uint64_t, void, void, void *, size_t, _DWORD *, unint64_t *), uint64_t a2, int a3, _OWORD *a4, unsigned __int8 *a5, uint64_t a6, unsigned __int8 *a7, uint64_t a8, const void *a9, unsigned int a10, unsigned int a11, _DWORD *a12, BOOL *a13, void *a14, unint64_t *a15)
{
...
BOOL sub_10000B000(void *a1, void *a2, void *a3)
{
  v5 = a2;
  v6 = a3;
  connect = 0;
  v7 = IOServiceMatching([a1 UTF8String]);
...
void sub_10000B1F4(char a1, _DWORD *a2)
{
  if (a1)
  {
    sub_100002394();
    sub_100004DF0(&_mh_execute_header, &_os_log_default, v3, "%s: %s: returning, err = %ld.\n", v4, v5, v6, v7, 2u);
  }

  *a2 = -3;
}

void sub_10000B2A0(_DWORD *a1)
{
  if (os_log_type_enabled(&_os_log_default, OS_LOG_TYPE_INFO))
  {
    sub_100002394();
    sub_100004DF0(&_mh_execute_header, &_os_log_default, v2, "%s: %s: returning, err = %ld.\n", v3, v4, v5, v6, 2u);
  }

  *a1 = -5;
}

void sub_10000B35C(_DWORD *a1)
{
  if (os_log_type_enabled(&_os_log_default, OS_LOG_TYPE_INFO))
  {
    sub_100002394();
...
void sub_10000B418(int a1, _DWORD *a2)
{
  if (os_log_type_enabled(&_os_log_default, OS_LOG_TYPE_INFO))
  {
    sub_100004DF0(&_mh_execute_header, &_os_log_default, v4, "%s: %s: returning, err = %ld.\n", v5, v6, v7, v8, 2u);
  }
...
void acm_mem_free(void *a1, rsize_t a2)
{
  if (a1)
  {
    sub_1000023A8(a1, a2);
    free(v3);
    v4 = qword_100020388 - v2;
    if (qword_100020388 < v2)
    {
      v4 = 0;
    }
  ...
  if (v5)
  {
    if (v1)
    {
      ...
      if (v4)
      {
        ...
        {
          v10 = v9;
          result = sub_100005710(v8, v7, &v11);
          if (!result)
          {
            *v6 = v10 + v11 + 26;
          }
                ...
                if (v9)
                {
                  ...
                  *v4 = *a1;
                  ...
                  else
                  {
                    ...
                    v21 = *(a1 + v18 + 18);
                    v26 = v18 + 22;
                    result = sub_10000593C(a1, v16, &v26, &v25, &v24);
                    if (!result)
                    {
                      *v11 = v19;
                      *v12 = v20;
  ...
  if (v15)
  {
    if (a11)
    {
      if (a10 <= 0xA && (a9 != 0) == (a10 != 0))
      {
        v16 = v14;
        v17 = v13;
        result = sub_100005710(a9, a10, &v21);
        if (!result)
        {
          v18 = 29;
          if (a1 == 32)
...
uint64_t SerializeVerifyAclConstraint(int a1, _OWORD *a2, const void *a3, unsigned int a4, const void *a5, unsigned int a6, char a7, int a8, uint64_t a9, unsigned int a10, uint64_t a11, void *a12)
{
  ...
  if (a12)
  {
    ...
    {
      v30 = 0;
      result = sub_100005710(a9, a10, &v30);
      if (!result)
      {
        v20 = 29;
        if (a1 == 32)
        ...
        else
        {
          ...
          *(v26 + 1) = v23;
          v29 = v24 + 5;
          result = sub_100005800(a9, a10, a11, &v29);
          if (!result)
          {
            *a12 = v29;
          }
...
uint64_t GetSerializedProcessAclSize(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, void *a9)
{
  ...
  if (v14)
  {
    ...
    if (v10)
    {
      ...
      {
        v16 = v11;
        result = sub_100005710(v12, v13, &v17);
        if (!result)
        {
          *a9 = v15 + v16 + v17 + 36;
        }
          ...
          if (a8 <= 0xA && (a7 != 0) == (a8 != 0))
          {
            ...
            if (!result)
            {
              ...
              else
              {
                ...
                *(a9 + v19) = v15;
                v20 = v19 + 4;
                result = sub_100005800(a7, v13, a9, &v20);
                if (!result)
                {
                  *a10 = v20;
                }
      ...
      if ((v7 & 0x30) != 0)
      {
        *a3 = 20;
        while (*(a2 + 16))
        {
          ...
          sub_100005614(SerializedRequirementSize, v10, v11, v12, v13, v14, v15, v16, v25, v26);
        }
      }
      ...
      else if (v6 == 7)
      {
        *a3 = 24;
        while (*(a2 + 20))
        {
          ...
          sub_100005614(v17, v18, v19, v20, v21, v22, v23, v24, v25, v26);
        }
      }
    }
          ...
          if (v7 == __s2[7])
          {
            switch(*__s1)
            {
              ...
              case 0x17:
                ...
                goto LABEL_8;
              case 7:
                if (sub_100005598() || memcmp(__s1 + 32, v5 + 8, 0x20uLL))
                {
                  break;
                }
              ...
              case 9:
                ...
                goto LABEL_33;
              case 0xA:
                if (sub_100005598() || memcmp(__s1 + 36, v5 + 9, 0x10uLL))
                {
                  break;
                }
...
double LibSer_GetSerializedContainsCredential_Serialize(__n128 *a1, unsigned __int32 a2, unsigned __int32 a3, __n128 *a4, void *a5)
{
  ...
  {
    *&result = sub_1000056C4(a2, a3, a4, a5, a1).n128_u64[0];
  }
...
uint64_t LibSer_ContextCredentialGetProperty_GetSize(uint64_t a1, uint64_t a2, uint64_t a3, void *a4)
{
  if (a4)
  {
    return sub_1000055B4(a1, a2, a3, a4);
  }
...
uint64_t LibSer_StorageSetData_GetSize(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8)
{
  ...
  result = sub_1000055D4(a1, a2, a3, a4, a5, a6, a7, a8, v11, v12, 0);
  if (!result)
  {
    *v8 = v9 + v13 + 28;
  }
...
uint64_t LibSer_StorageSetData_Deserialize(__n128 *a1, unint64_t a2, __n128 *a3, _DWORD *a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8)
{
  ...
  if (a1 && a2 >= 0x18 && a3 && a4 && a5 && a6 && a7 && a8)
  {
    ...
    *v17 = v16;
    ...
    return sub_10000593C(v11, v12, v20, v14, v15);
  }
...
uint64_t LibSer_StorageGetData_Deserialize(__n128 *a1, unint64_t a2, __n128 *a3, _DWORD *a4, uint64_t a5)
{
  ...
  if (a1 && a2 >= 0x15 && a3 && a4 && a5)
  {
    ...
    *v9 = *(v8 + 20) != 0;
    v14[0] = 21;
    return sub_10000593C(v8, v10, v14, v11, v12);
  }
...
void LibSer_GetUnlockSecret_Serialize(_OWORD *a1, uint64_t a2, uint64_t a3, _OWORD *a4, uint64_t a5)
{
  if (a1)
  {
    if (a4)
    {
      ...
      {
        sub_1000056A0();
        if (!sub_100005710(v8, a3, v9))
        {
          sub_100005694();
          if (v10)
          {
            *a4 = *a1;
            v11 = sub_1000023C8(16, v19);
            if (!v11)
            {
              sub_1000056B8(v11, v12, v13, v14, v15, v16, v17, v18, v20);
            }
          }
        }
      }
...
uint64_t LibSer_GetUnlockSecret_Deserialize(_OWORD *a1, unint64_t a2, _OWORD *a3, void *a4, _DWORD *a5)
{
  ...
  if (a2 >= 0x10 && a3 && a4)
  {
    if (a5)
    {
      ...
      *a3 = *a1;
      v9[0] = 16;
      return sub_10000593C(a1, a2, v9, a4, a5);
    }
  }
    ...
    if (v26)
    {
      ...
      if (!sub_100005710(v36, v34, v37))
      {
        ...
        if (v38)
        {
          ...
          a9 = 16;
          if (!sub_100005800(v35, v34, v31, &a9))
          {
            v39 = a9;
            *(v31 + a9) = v32;
            v40 = v39 + 4;
...
uint64_t LibSer_SEPControl_Deserialize(_OWORD *a1, unint64_t a2, _OWORD *a3, void *a4, _DWORD *a5, unint64_t *a6, void *a7)
{
  ...
  if (a2 >= 0x18 && a3 && a4 && a5 && a6 && a7)
  {
    *a3 = *a1;
    v12 = 16;
    result = sub_10000593C(a1, a2, &v12, a4, a5);
    if (!result)
    {
      v11 = a1 + v12 + 4;
      *a7 = *(a1 + v12);
...
uint64_t LibSer_ACMDeserializeSEPControlCode()
{
  ...
  if (v1 && v2)
  {
    ...
    {
      v11 = 16;
      v6 = sub_10000593C(v1, v2, &v11, &v10, &v9);
      if (v6)
      {
        v5 = v6;
      }
...
uint64_t crypto_deriveKeyAndEncryptData(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t *a10)
{
  ...
  else
  {
    ...
    if (a9)
    {
      v30 = sub_100002320(v11, v12, v13, v14, v15, v16, v17, v18, v31, v32, v33, v34, v35[0], v35[1]);
      if (v30)
      {
        v10 = v30;
      }
...
LABEL_25:
  ...
  v28 = sub_100002320(v11, v12, v13, v14, v15, v16, v17, v18, v29, v30, v31, v32, v33[0], v33[1]);
  if (v28)
  {
    v10 = v28;
  }
...
void ACMContextAddCredentialWithScope(int a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, size_t size, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, uint64_t a16, uint64_t a17, uint64_t a18, uint64_t a19, uint64_t a20, uint64_t a21, uint64_t a22, uint64_t a23, uint64_t a24, uint64_t a25, uint64_t a26)
{
  ...
  if (v27 && (v34 & 1) == 0)
  {
    if (sub_100001CD8() || (v35 = sub_10000A190(), GetSerializedAddCredentialSize(v35, v36, v37, v38)))
    {
      sub_10000A2B0();
    }
    ...
    else
    {
      ...
      if (v39)
      {
        ...
        {
          sub_10000A238(v26, 5, v44, v45, size);
        }
  ...
  if (a1 || a3 == 2)
  {
    ...
    else
    {
      ...
      if (v12)
      {
        ...
        *(v12 + 5) = a3;
        sub_10000A280();
        v3 = sub_100001E8C(v18, v19, v20, v21, v22, 0, 0);
        sub_10000A258();
...
void ACMContextRemoveCredentialsByValueAndScope(int a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, size_t size, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, uint64_t a16, uint64_t a17, uint64_t a18, uint64_t a19, uint64_t a20, uint64_t a21, uint64_t a22, uint64_t a23, uint64_t a24, uint64_t a25, uint64_t a26)
{
  ...
  if (v27 && (v34 & 1) == 0)
  {
    if (sub_100001CD8() || (v35 = sub_10000A190(), GetSerializedRemoveCredentialSize(v35, v36, v37, v38)))
    {
      sub_10000A2B0();
    }
    ...
    else
    {
      ...
      if (v39)
      {
        ...
        {
          sub_10000A238(v26, 6, v41, v42, size);
        }
...
void ACMContextReplacePassphraseCredentialsWithScope(int a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, size_t size, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, uint64_t a16, uint64_t a17, uint64_t a18, uint64_t a19, uint64_t a20, uint64_t a21, uint64_t a22, uint64_t a23, uint64_t a24, uint64_t a25, uint64_t a26)
{
  ...
  if (v27 && (v34 & 1) == 0)
  {
    if (sub_100001CD8() || (v35 = sub_10000A190(), GetSerializedReplacePassphraseCredentialSize(v35, v36, v37, v38)))
    {
      sub_10000A2B0();
    }
    ...
    else
    {
      ...
      if (v39)
      {
        ...
        {
          sub_10000A238(v26, 15, v41, v42, size);
        }
...
uint64_t ACMContextContainsPassphraseCredentialWithPurpose(_OWORD *a1, int a2, int a3)
{
    ...
    else
    {
      ...
      if (v14)
      {
        *v14 = *a1;
        ...
        v14[5] = a3;
        sub_10000A280();
        v27 = sub_100001E8C(v20, v21, v22, v23, v24, v25, v26);
        if (v27)
        {
          v28 = v27;
        }
  ...
  if (*(v3 + 842) <= 0x46u && os_log_type_enabled(&_os_log_default, OS_LOG_TYPE_INFO))
  {
    sub_100002420();
    sub_10000236C();
...
LABEL_13:
  ...
  if (v10 >= byte_10002034A && os_log_type_enabled(&_os_log_default, OS_LOG_TYPE_INFO))
  {
    sub_10000A264();
    sub_10000A1B8();
    sub_10000A1C8();
...
LABEL_11:
  v18 = 70;
LABEL_15:
  if (v18 >= byte_10002034A && os_log_type_enabled(&_os_log_default, OS_LOG_TYPE_INFO))
  {
    *size_4 = 136315650;
    *&size_4[4] = "ACMLib";
    *&size_4[12] = 2080;
  ...
  if (!a4)
  {
    switch(a2)
    {
      ...
      case 304:
        ...
        if (v26)
        {
          *(v5 + 185) = sub_10000A65C(v22, v23, v24);
        }
...
LABEL_158:
    ...
    case 0x1F5:
      ...
      {
LABEL_50:
        *(v5 + 36) = sub_10000A65C(v11, v12, v13);
      }
    ...
    case 0x1F6:
      ...
      {
LABEL_143:
        *(v5 + 52) = sub_10000A65C(v65, v66, v67);
      }
    ...
    case 0x1F7:
      ...
      if (v46)
      {
        *(v5 + 68) = sub_10000A65C(v42, v43, v44);
      }
...
LABEL_146:
  ...
  if (a2 != 701)
  {
    if (a2 == 801)
    {
      ...
      if (v38)
      {
        *(v5 + 32) = sub_10000A65C(v34, v35, v36);
      }
