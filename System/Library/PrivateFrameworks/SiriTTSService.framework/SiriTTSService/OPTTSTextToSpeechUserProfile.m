...
- (Offset<siri::speech::schema_fb::TextToSpeechUserProfile>)addObjectToBuffer:(void *)a3
{
  ...
  v5 = [(OPTTSTextToSpeechUserProfile *)self resources];
  v6 = [v5 count];
  if (v6)
  {
    if (!(v6 >> 62))
...
LABEL_3:
  ...
  if (*v10->var0 >= 5u)
  {
    ...
    if (v11)
    {
      ...
      v7 = [[OPTTSTextToSpeechVoiceResource alloc] initWithFlatbuffData:self->_data root:&v12[4 * a3 + 4 + *v12[4 * a3 + 4].var0] verify:0];
      goto LABEL_3;
    }
  }
