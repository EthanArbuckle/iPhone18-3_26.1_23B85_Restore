...
- (void)setLength:(unsigned int)length
{
  v4 = [objc_alloc(MEMORY[0x1E696AD98]) initWithUnsignedInteger:length];
  [NSMutableDictionary setObject:"setObject:forKeyedSubscript:" forKeyedSubscript:?];
}
...
- (void)setOffset:(unsigned int)offset
{
  v4 = [objc_alloc(MEMORY[0x1E696AD98]) initWithUnsignedInteger:offset];
  [NSMutableDictionary setObject:"setObject:forKeyedSubscript:" forKeyedSubscript:?];
}
...
- (void)setSample_idx:(unsigned int)sample_idx
{
  v4 = [objc_alloc(MEMORY[0x1E696AD98]) initWithUnsignedInteger:sample_idx];
  [NSMutableDictionary setObject:"setObject:forKeyedSubscript:" forKeyedSubscript:?];
}
