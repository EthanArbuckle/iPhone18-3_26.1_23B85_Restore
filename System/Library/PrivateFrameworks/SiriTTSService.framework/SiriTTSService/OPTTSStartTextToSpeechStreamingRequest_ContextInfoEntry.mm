...
- (NSString)key;
- (NSString)value;
- (OPTTSStartTextToSpeechStreamingRequest_ContextInfoEntry)initWithFlatbuffData:(id)data root:(const ContextInfoEntry *)root verify:(BOOL)verify;
...
- (Offset<siri::speech::schema_fb::StartTextToSpeechStreamingRequest_::ContextInfoEntry>)addObjectToBuffer:(void *)buffer
{
  ...
  value = [(OPTTSStartTextToSpeechStreamingRequest_ContextInfoEntry *)self value];
  v11 = value;
  if (!value)
  {
    value = &stru_1F28C4E90;
  }
...
- (OPTTSStartTextToSpeechStreamingRequest_ContextInfoEntry)initWithFlatbuffData:(id)data root:(const ContextInfoEntry *)root verify:(BOOL)verify
{
  ...
  dataCopy = data;
  v25.receiver = self;
  v25.super_class = OPTTSStartTextToSpeechStreamingRequest_ContextInfoEntry;
  v10 = [(OPTTSStartTextToSpeechStreamingRequest_ContextInfoEntry *)&v25 init];
  if (!v10)
  {
    goto LABEL_14;
  }
