...
- (id)addKVOBlockForKeyPath:()NSObject_KVOBlock options:handler:
{
  ...
  [a1 addObserver:v10 forKeyPath:v9 options:a4 context:{objc_msgSend(v11, "context")}];
...
- (void)removeKVOBlockForToken:()NSObject_KVOBlock
{
  ...
  else
  {
    ...
    {
      [(NSObject(NSObject_KVOBlock) *)v4 removeKVOBlockForToken:v8, v9, v10, v11, v12, v13, v14];
    }
  }
}
...
- (id)addOneShotKVOBlockForKeyPath:()NSObject_KVOBlock options:handler:
{
  ...
  v12 = [a1 addKVOBlockForKeyPath:v8 options:a4 handler:v11];
  v13 = v20[5];
  v20[5] = v12;
