    ...
    if (v22)
    {
      ...
      do
      {
        for (i = 0; i != v27; ++i)
        {
          ...
          isEqualToString = objc_msgSend_isEqualToString_(v9, v41, v40, v42, v43);

          objc_msgSend__createRecordForAdData_installed_isDupe_rerankingError_(self, v45, v30, isAppInstalled, isEqualToString, v10);
        }
...
- (void)updateDESRecord:(id)a3 forEvent:(int64_t)a4
{
  ...
  if (isPersonalizedAdsEnabled)
  {
    ...
    objc_msgSend_updateWithRecordID_adamID_event_(v22, v28, v27, v6, a4);
  }
...
- (BOOL)isAppInstalled:(id)a3
{
  v5 = objc_msgSend_integerValue(a3, a2, a3, v3, v4);
