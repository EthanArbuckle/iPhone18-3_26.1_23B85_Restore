...
{
  v42 = a3;
  v4 = [MEMORY[0x277CBEBC0] URLWithString:v42];
  v5 = [v4 query];
  v6 = [MTPlaybackIdentifierUtil __queryStringToQueryDictionary:v5];

  v7 = +[(MTSingleton *)MTPlaybackIdentifierUtil];
  ...
  {
    v10 = +[(MTSingleton *)MTPlaybackIdentifierUtil];
    ...
    {
      v12 = +[(MTSingleton *)MTPlaybackIdentifierUtil];
...
- (void)_lookupPodcastUuidIfNecessaryFromURLString:(id)a3
{
  ...
  if ((v19[3] & 1) == 0)
  {
    v8 = [(MTSingleton *)MTPlaybackIdentifierUtil sharedInstance:v11];
