...
- (AXToggleTouchAccommodationsIntentResponse)initWithCode:(int64_t)a3 userActivity:(id)a4;
@end
...
- (AXToggleTouchAccommodationsIntentResponse)initWithCode:(int64_t)a3 userActivity:(id)a4
{
  ...
  {
    v7->_code = a3;
    [(AXToggleTouchAccommodationsIntentResponse *)v7 setUserActivity:v6];
  }
...
+ (id)unspecifiedIntentResponseWithState:(int64_t)a3
{
  ...
  [(AXToggleTouchAccommodationsIntentResponse *)v4 setState:a3];
