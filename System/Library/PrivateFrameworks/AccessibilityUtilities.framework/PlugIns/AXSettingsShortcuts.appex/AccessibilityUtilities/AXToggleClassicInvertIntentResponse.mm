...
- (AXToggleClassicInvertIntentResponse)initWithCode:(int64_t)code userActivity:(id)activity;
@end
...
- (AXToggleClassicInvertIntentResponse)initWithCode:(int64_t)code userActivity:(id)activity
{
  ...
  v10.receiver = self;
  v10.super_class = AXToggleClassicInvertIntentResponse;
  v7 = [(AXToggleClassicInvertIntentResponse *)&v10 init];
  v8 = v7;
  if (v7)
  {
    v7->_code = code;
    [(AXToggleClassicInvertIntentResponse *)v7 setUserActivity:activityCopy];
  }
...
+ (id)unspecifiedIntentResponseWithState:(int64_t)state
{
  ...
  [(AXToggleClassicInvertIntentResponse *)v4 setState:state];
