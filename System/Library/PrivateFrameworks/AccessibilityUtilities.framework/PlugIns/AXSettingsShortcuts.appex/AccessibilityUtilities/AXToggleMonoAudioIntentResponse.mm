...
- (AXToggleMonoAudioIntentResponse)initWithCode:(int64_t)code userActivity:(id)activity;
@end
...
- (AXToggleMonoAudioIntentResponse)initWithCode:(int64_t)code userActivity:(id)activity
{
  ...
  v10.receiver = self;
  v10.super_class = AXToggleMonoAudioIntentResponse;
  v7 = [(AXToggleMonoAudioIntentResponse *)&v10 init];
  v8 = v7;
  if (v7)
  {
    v7->_code = code;
    [(AXToggleMonoAudioIntentResponse *)v7 setUserActivity:activityCopy];
  }
...
+ (id)unspecifiedIntentResponseWithState:(int64_t)state
{
  ...
  [(AXToggleMonoAudioIntentResponse *)v4 setState:state];
