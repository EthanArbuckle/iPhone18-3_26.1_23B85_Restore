...
- (AXToggleCaptionsIntentResponse)initWithCode:(int64_t)code userActivity:(id)activity;
@end
...
- (AXToggleCaptionsIntentResponse)initWithCode:(int64_t)code userActivity:(id)activity
{
  ...
  {
    v7->_code = code;
    [(AXToggleCaptionsIntentResponse *)v7 setUserActivity:activityCopy];
  }
...
+ (id)unspecifiedIntentResponseWithState:(int64_t)state
{
  ...
  [(AXToggleCaptionsIntentResponse *)v4 setState:state];
