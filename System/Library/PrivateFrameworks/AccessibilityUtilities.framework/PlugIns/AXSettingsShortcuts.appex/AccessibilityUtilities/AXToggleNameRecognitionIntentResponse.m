...
- (AXToggleNameRecognitionIntentResponse)initWithCode:(int64_t)a3 userActivity:(id)a4;
@end
...
- (AXToggleNameRecognitionIntentResponse)initWithCode:(int64_t)a3 userActivity:(id)a4
{
  ...
  {
    v7->_code = a3;
    [(AXToggleNameRecognitionIntentResponse *)v7 setUserActivity:v6];
  }
...
+ (id)unspecifiedIntentResponseWithState:(int64_t)a3
{
  ...
  [(AXToggleNameRecognitionIntentResponse *)v4 setState:a3];
