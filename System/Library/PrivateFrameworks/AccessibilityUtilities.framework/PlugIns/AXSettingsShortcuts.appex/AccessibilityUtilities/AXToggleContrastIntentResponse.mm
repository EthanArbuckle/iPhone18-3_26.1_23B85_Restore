...
- (AXToggleContrastIntentResponse)initWithCode:(int64_t)code userActivity:(id)activity;
@end
...
- (AXToggleContrastIntentResponse)initWithCode:(int64_t)code userActivity:(id)activity
{
  ...
  {
    v7->_code = code;
    [(AXToggleContrastIntentResponse *)v7 setUserActivity:activityCopy];
  }
...
+ (id)unspecifiedIntentResponseWithState:(int64_t)state
{
  ...
  [(AXToggleContrastIntentResponse *)v4 setState:state];
