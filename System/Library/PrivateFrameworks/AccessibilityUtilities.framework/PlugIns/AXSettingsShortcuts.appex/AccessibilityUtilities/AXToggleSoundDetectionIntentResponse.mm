...
- (AXToggleSoundDetectionIntentResponse)initWithCode:(int64_t)code userActivity:(id)activity;
@end
...
- (AXToggleSoundDetectionIntentResponse)initWithCode:(int64_t)code userActivity:(id)activity
{
  ...
  {
    v7->_code = code;
    [(AXToggleSoundDetectionIntentResponse *)v7 setUserActivity:activityCopy];
  }
...
+ (id)unspecifiedIntentResponseWithState:(int64_t)state
{
  ...
  [(AXToggleSoundDetectionIntentResponse *)v4 setState:state];
