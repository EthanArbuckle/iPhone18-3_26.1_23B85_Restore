...
- (AXToggleAudioDescriptionsIntentResponse)initWithCode:(int64_t)code userActivity:(id)activity;
@end
...
- (AXToggleAudioDescriptionsIntentResponse)initWithCode:(int64_t)code userActivity:(id)activity
{
  ...
  {
    v7->_code = code;
    [(AXToggleAudioDescriptionsIntentResponse *)v7 setUserActivity:activityCopy];
  }
...
+ (id)unspecifiedIntentResponseWithState:(int64_t)state
{
  ...
  [(AXToggleAudioDescriptionsIntentResponse *)v4 setState:state];
