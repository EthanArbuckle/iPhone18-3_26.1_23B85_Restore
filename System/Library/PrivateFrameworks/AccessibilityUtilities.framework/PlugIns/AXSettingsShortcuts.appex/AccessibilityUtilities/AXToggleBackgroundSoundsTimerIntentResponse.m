...
- (AXToggleBackgroundSoundsTimerIntentResponse)initWithCode:(int64_t)a3 userActivity:(id)a4;
@end
...
- (AXToggleBackgroundSoundsTimerIntentResponse)initWithCode:(int64_t)a3 userActivity:(id)a4
{
  ...
  {
    v7->_code = a3;
    [(AXToggleBackgroundSoundsTimerIntentResponse *)v7 setUserActivity:v6];
  }
...
+ (id)unspecifiedIntentResponseWithState:(int64_t)a3
{
  ...
  [(AXToggleBackgroundSoundsTimerIntentResponse *)v4 setState:a3];
