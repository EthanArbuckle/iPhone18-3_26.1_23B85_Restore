...
LABEL_6:
  ...
  v9 = [[AXIPCClient alloc] initWithPort:v8];
  LODWORD(v10) = 1.0;
...
LABEL_11:
  ...
  v15 = [(AXServerInstanceActionHandlerHelper *)self registrationMessageKey];
  v23 = @"result";
  v16 = [MEMORY[0x1E696AD98] numberWithBool:v11];
  v24[0] = v16;
  v17 = [MEMORY[0x1E695DF20] dictionaryWithObjects:v24 forKeys:&v23 count:1];
  v18 = [(AXIPCMessage *)v14 initWithKey:v15 payload:v17];
