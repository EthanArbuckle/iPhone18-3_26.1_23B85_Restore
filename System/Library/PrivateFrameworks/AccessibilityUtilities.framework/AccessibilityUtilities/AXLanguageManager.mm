...
+ (id)stringByReplacingFatWidthCharactersWithBasicCharacters:(id)a3
{
  ...
  else
  {
    ...
    if (v8 > v11)
    {
      v15 = [v3 substringWithRange:{v11, v8 - v11}];
      [v6 appendString:v15];
    }
  }
...
- (id)debugDescription
{
  ...
  v4 = [(AXLanguageManager *)self basicDescription];
...
- (NSString)systemLanguageID
{
  ...
  {
    v4 = [(AXLanguageManager *)self userLocale];
...
- (NSArray)langMaps
{
  ...
  if (!langMaps)
  {
    v4 = [(AXLanguageManager *)self _loadLangMaps];
    v5 = self->_langMaps;
    self->_langMaps = v4;
...
- (id)dialectForLanguageID:(id)a3
{
  ...
  {
    v5 = v4;
    v6 = [(AXLanguageManager *)self outputLanguageIdentifierForLanguage:v4];
    v7 = v6;
    if (v6)
    {
      v8 = v6;
    ...
    v11 = [(AXLanguageManager *)self dialectForSystemLanguage];
    ...
    {
      v14 = [(AXLanguageManager *)self dialectForCurrentLocale];
      ...
      else
      {
        ...
        v18 = [v17 specificLanguageID];
        v19 = [v18 hasPrefix:v5];
...
LABEL_25:
                  if (v38 != 0x7FFFFFFFFFFFFFFFLL)
                  {
                    ...
                    v42 = 0u;
                    v39 = [v24 dialects];
                    v28 = [v39 countByEnumeratingWithState:&v41 objects:v49 count:16];
                    if (v28)
                    {
                      v29 = v28;
                      v30 = *v42;
                      while (2)
                      {
                        ...
                        v29 = [v39 countByEnumeratingWithState:&v41 objects:v49 count:16];
                        if (v29)
                        {
                          continue;
                        }
...
LABEL_38:
  ...
  {
    _AXAssert();
    v9 = [(AXLanguageManager *)self dialectForSystemLanguage];
  }
...
- (id)_systemPreferredDialectThatCanSpeak:(id)a3
{
  ...
  v4 = a3;
  v5 = [(AXLanguageManager *)self dialectForSystemLanguage];
  if (v4[2](v4, v5))
  {
    v12[0] = v5;
  ...
  {
    v7 = [(AXLanguageManager *)self dialectForCurrentLocale];
    if (v4[2](v4, v7))
    {
      v11 = v7;
    ...
    {
      v8 = [(AXLanguageManager *)self dialectForCurrentRegion];
      if (v4[2](v4, v8))
      {
        v10 = v8;
...
- (id)_preferredOverrideDialectsThatCanSpeak:(id)a3 dialectIsSecondary:(id)a4 overridePreferredLanguages:(id)a5 preferOverrides:(BOOL)a6
{
  ...
  v40 = objc_opt_new();
  v13 = [(AXLanguageManager *)self langMaps];
  ...
  if (!v6 || ![v36[5] count])
  {
    ...
    v19 = [v18 countByEnumeratingWithState:&v25 objects:v41 count:16];
    if (v19)
    {
      v20 = *v26;
      do
...
LABEL_8:
  ...
  if (v14)
  {
    v17 = [(AXLanguageManager *)self _preferredOverrideDialectsThatCanSpeak:v10 dialectIsSecondary:v11 overridePreferredLanguages:v13 preferOverrides:1];
    ...
    v18 = [(AXLanguageManager *)self _systemPreferredDialectThatCanSpeak:v10];
  }

  else
  {
    v19 = [(AXLanguageManager *)self _systemPreferredDialectThatCanSpeak:v10];
    ...
    v18 = [(AXLanguageManager *)self _preferredOverrideDialectsThatCanSpeak:v10 dialectIsSecondary:v11 overridePreferredLanguages:v13 preferOverrides:0];
  }
...
- (id)dialectsThatCanSpeakCharacter:(unsigned __int16)a3 overridePreferredLanguages:(id)a4 allowTransliteration:(BOOL)a5 preferOverrides:(BOOL)a6
{
  ...
  v9 = a3;
  v6 = [(AXLanguageManager *)self _dialectsThatCanSpeak:v10 dialectIsSecondary:v8 overridePreferredLanguages:a4 preferOverrides:a6];
...
- (id)dialectsThatCanSpeakString:(id)a3 overridePreferredLanguages:(id)a4
{
  ...
  v11 = v6;
  v7 = v6;
  v8 = [(AXLanguageManager *)self _dialectsThatCanSpeak:v10 dialectIsSecondary:0 overridePreferredLanguages:a4 preferOverrides:0];
...
- (id)dialectThatCanSpeakCharacter:(unsigned __int16)a3
{
  ...
  v3 = [(AXLanguageManager *)self dialectsThatCanSpeakCharacter:a3 overridePreferredLanguages:0 allowTransliteration:1];
  if ([v3 count] == 1)
  {
    v4 = [v3 firstObject];
  }
          ...
          if (v10)
          {
            ...
            while (2)
            {
              for (i = 0; i != v11; ++i)
              {
                ...
                v14 = *(*(&v38 + 1) + 8 * i);
                v15 = [v14 langMap];
                v16 = [v15 generalLanguageID];
                v17 = [v8 hasPrefix:v16];
      ...
      if (v22)
      {
        ...
        while (2)
        {
          for (j = 0; j != v23; ++j)
          {
            ...
            v26 = *(*(&v34 + 1) + 8 * j);
            v27 = [v26 specificLanguageID];
            v28 = [v27 isEqualToString:@"en-US"];
...
- (id)ambiguousDialectsFromUserKeyboardPreferences
{
  ...
  v3 = [(AXLanguageManager *)self preferredLanguageIDsFromUserSelectedKeyboards];
...
{
  v3 = a3;
  v4 = [(AXLanguageManager *)self commonCharacters];
...
- (BOOL)isStringComposedByCommonCharacters:(id)a3
{
  ...
  if ([v4 length])
  {
    ...
    while (v5 == v8 + v7)
    {
      v8 = v5;
      v7 = v6;
      v9 = [(AXLanguageManager *)self commonCharacters];
...
- (void)updateCachedDialects
{
  ...
  v3 = [(AXLanguageManager *)self systemLanguageID];
  v4 = [(AXLanguageManager *)v2 outputLanguageIdentifierForLanguage:v3];

  v71 = 0u;
  v72 = 0u;
  v69 = 0u;
  v70 = 0u;
  v5 = [(AXLanguageManager *)v2 langMaps];
...
LABEL_18:
  ...
  v19 = [(AXLanguageManager *)v2 userLocale];
  ...
  if (v20)
  {
    ...
    v61 = 0u;
    v62 = 0u;
    v21 = [(AXLanguageManager *)v2 langMaps];
    ...
    if (v22)
    {
      ...
      do
      {
        for (k = 0; k != v23; ++k)
        {
          ...
          v26 = *(*(&v61 + 1) + 8 * k);
          v27 = [v26 generalLanguageID];
          v28 = [v49 hasPrefix:v27];

          if (v28)
          {
            v29 = [v26 defaultDialect];
  ...
  v30 = [(AXLanguageManager *)v2 userLocale];
  v31 = *MEMORY[0x1E695D978];
  v32 = [v30 objectForKey:*MEMORY[0x1E695D978]];
  ...
  if (v32)
  {
    ...
    v57 = 0u;
    v58 = 0u;
    obj = [(AXLanguageManager *)v2 langMaps];
    ...
    if (v50)
    {
      ...
      do
      {
        ...
        do
        {
          ...
          v56 = 0u;
          v35 = [v34 dialects];
          v36 = [v35 countByEnumeratingWithState:&v53 objects:v73 count:16];
          if (v36)
          {
            v37 = v36;
            v38 = *v54;
            while (2)
            {
              ...
              v37 = [v35 countByEnumeratingWithState:&v53 objects:v73 count:16];
              if (v37)
              {
                continue;
              }
...
LABEL_47:
  ...
  if (!v2->_dialectForSystemLanguage)
  {
    ...
    {
      v44 = [(AXLanguageManager *)v2 dialectForCurrentLocale];
LABEL_55:
      v45 = v44;
    ...
    {
      v44 = [(AXLanguageManager *)v2 dialectForCurrentRegion];
      goto LABEL_55;
    }
  }
...
- (id)descriptionOfWord:(id)a3 forLanguage:(id)a4
{
  ...
  v9 = [v8 descriptionOfWord:v7 forLanguage:v6];
  ...
  if (v34)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        v27 = [[AXLangMap alloc] initWithLanguageID:v40 isWestern:v36 isAmbiguous:v37 isRTL:v35 dialects:v44 alternateLanguageIDs:v39 associatedAmbiguousLanguages:v38];
        [v33 addObject:v27];
...
{
  v3 = a3;
  if ([v3 isEqualToString:*MEMORY[0x1E69D9EC0]])
  {
...
- (BOOL)didUpdateForLocaleChange
{
  v3 = [(AXLanguageManager *)self _unitTest_didUpdateForLocaleChange];
  if (v3)
  {
