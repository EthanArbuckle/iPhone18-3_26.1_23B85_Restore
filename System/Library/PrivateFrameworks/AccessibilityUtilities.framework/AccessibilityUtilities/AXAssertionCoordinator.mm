...
- (AXAssertionCoordinator)initWithIdentifier:(id)identifier delegate:(id)delegate;
...
- (AXAssertionCoordinator)initWithIdentifier:(id)identifier delegate:(id)delegate
{
  ...
  if (v8)
  {
    ...
    [(AXAssertionCoordinator *)v8 setDelegate:delegateCopy];
    [(AXAssertionCoordinator *)v8 setIdentifier:identifierCopy];
  }
...
- (id)acquireAssertionWithReason:(id)reason
{
  ...
  identifier = [(AXAssertionCoordinator *)self identifier];
  v9 = MEMORY[0x1E69E9820];
  v10 = 3221225472;
  v11 = __53__AXAssertionCoordinator_acquireAssertionWithReason___block_invoke;
  v12 = &unk_1E71EA750;
  objc_copyWeak(&v13, &location);
  v7 = [v5 initWithIdentifier:identifier forReason:reasonCopy invalidationBlock:&v9];
...
- (void)_startTrackingPoorMansAssertion:(id)assertion
{
  ...
  assertionQueue = [(AXAssertionCoordinator *)self assertionQueue];
...
- (void)dealloc
{
  ...
  block[4] = self;
  dispatch_async(assertionQueue, block);
