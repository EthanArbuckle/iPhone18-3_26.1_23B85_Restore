...
- (CAFrameRateRange)frameRateRange
{
  preferredFrameRateRange = [(SBFFluidBehaviorSettings *)self preferredFrameRateRange];
...
- (id)succinctDescription
{
  succinctDescriptionBuilder = [(SBFFluidBehaviorSettings *)self succinctDescriptionBuilder];
...
- (id)descriptionWithMultilinePrefix:(id)prefix
{
  v3 = [(SBFFluidBehaviorSettings *)self descriptionBuilderWithMultilinePrefix:prefix];
  build = [v3 build];
...
+ (id)_moduleWithSectionTitle:(id)title
{
  ...
  v65 = [MEMORY[0x1E69C6630] sectionWithRows:array title:titleCopy];
