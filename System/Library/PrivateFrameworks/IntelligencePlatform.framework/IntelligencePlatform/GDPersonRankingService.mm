...
- (id)rankedPersonsWithMaxCount:(int64_t)a3 error:(id *)a4
{
  ...
  v5 = [(PersonRankingService *)self->_innerService rankedPersonsForObjCWithMaxCount:a3 error:?];
  if (!v5)
  {
    v6 = GDLifeEventLog();
...
- (GDPersonRankingService)initWithConfig:(id)a3
{
  ...
  if (v5)
  {
    v6 = [[_TtC20IntelligencePlatform20PersonRankingService alloc] initWithConfig:v4];
