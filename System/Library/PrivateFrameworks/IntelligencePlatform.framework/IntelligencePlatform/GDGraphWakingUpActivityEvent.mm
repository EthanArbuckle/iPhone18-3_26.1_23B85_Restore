...
- (GDGraphWakingUpActivityEvent)initWithEntityIdentifierField:(id)field nameField:(id)nameField dateField:(id)dateField attendeesField:(id)attendeesField locationsField:(id)locationsField startLocationField:(id)locationField endLocationField:(id)endLocationField activityTypeObjectField:(id)self0 activityTypeField:(id)self1 confidenceField:(id)self2 allNameField:(id)self3 allDateField:(id)self4 allStartLocationField:(id)self5 allEndLocationField:(id)self6 allActivityTypeObjectField:(id)self7 allActivityTypeField:(id)self8 allConfidenceField:(id)self9;
@end
...
- (GDGraphWakingUpActivityEvent)initWithEntityIdentifierField:(id)field nameField:(id)nameField dateField:(id)dateField attendeesField:(id)attendeesField locationsField:(id)locationsField startLocationField:(id)locationField endLocationField:(id)endLocationField activityTypeObjectField:(id)self0 activityTypeField:(id)self1 confidenceField:(id)self2 allNameField:(id)self3 allDateField:(id)self4 allStartLocationField:(id)self5 allEndLocationField:(id)self6 allActivityTypeObjectField:(id)self7 allActivityTypeField:(id)self8 allConfidenceField:(id)self9
{
  ...
  v49.receiver = self;
  v49.super_class = GDGraphWakingUpActivityEvent;
  v31 = [(GDGraphWakingUpActivityEvent *)&v49 init];
  v32 = v31;
  if (v31)
  {
