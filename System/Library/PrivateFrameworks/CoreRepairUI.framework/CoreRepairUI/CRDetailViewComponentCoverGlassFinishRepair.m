@interface CRDetailViewComponentCoverGlassFinishRepair
- (CRDetailViewComponentCoverGlassFinishRepair)init;
- (id)specifiers;
@end

@implementation CRDetailViewComponentCoverGlassFinishRepair
...
- (id)specifiers
{
  ...
  {
    v5 = objc_opt_new();
    v6 = [@"CoverGlass" stringByAppendingString:@"FinishRepair"];
...
{
  v19.receiver = self;
  v19.super_class = CRDetailViewComponentCoverGlassFinishRepair;
  v2 = [(CRUDetailViewComponent *)&v19 init];
  v3 = v2;
  if (v2)
  {
    v4 = [(CRUDetailViewComponent *)v2 locale];
    v5 = [v4 localizedStringWithKey:@"NEW_COVER_GLASS" defaultString:@"NEW_COVER_GLASS"];
    ...
    v11 = [v10 localizedStringWithKey:@"FINISH_COVER_GLASS_DESC" defaultString:@"FINISH_COVER_GLASS_DESC"];
    ...
    v15 = [v14 localizedStringWithKey:@"COVER_GLASS" defaultString:@"COVER_GLASS"];
    [(CRUDetailViewComponent *)v3 setComponentName:v15];

    v16 = [(CRUDetailViewComponent *)v3 locale];
    v17 = [v16 localizedStringWithKey:@"COVER_GLASS_FOOTER_LEARN_MORE" defaultString:@"COVER_GLASS_FOOTER_LEARN_MORE"];
