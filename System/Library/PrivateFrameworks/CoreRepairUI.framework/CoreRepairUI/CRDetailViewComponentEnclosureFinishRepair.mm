...
- (CRDetailViewComponentEnclosureFinishRepair)init
{
  ...
  if (v2)
  {
    ...
    v5 = [locale localizedStringWithKey:@"NEW_ENCLOSURE" defaultString:@"NEW_ENCLOSURE"];
    ...
    v11 = [locale3 localizedStringWithKey:@"FINISH_ENCLOSURE_DESC" defaultString:@"FINISH_ENCLOSURE_DESC"];
    ...
    v15 = [locale5 localizedStringWithKey:@"ENCLOSURE" defaultString:@"ENCLOSURE"];
    [(CRUDetailViewComponent *)v3 setComponentName:v15];

    locale6 = [(CRUDetailViewComponent *)v3 locale];
    v17 = [locale6 localizedStringWithKey:@"ENCLOSURE_FOOTER_LEARN_MORE" defaultString:@"ENCLOSURE_FOOTER_LEARN_MORE"];
