...
- (CRDetailViewComponentCoverGlassFinishRepair)init
{
  ...
  if (v2)
  {
    ...
    v5 = [locale localizedStringWithKey:@"NEW_COVER_GLASS" defaultString:@"NEW_COVER_GLASS"];
    ...
    v11 = [locale3 localizedStringWithKey:@"FINISH_COVER_GLASS_DESC" defaultString:@"FINISH_COVER_GLASS_DESC"];
    ...
    v15 = [locale5 localizedStringWithKey:@"COVER_GLASS" defaultString:@"COVER_GLASS"];
    [(CRUDetailViewComponent *)v3 setComponentName:v15];

    locale6 = [(CRUDetailViewComponent *)v3 locale];
    v17 = [locale6 localizedStringWithKey:@"COVER_GLASS_FOOTER_LEARN_MORE" defaultString:@"COVER_GLASS_FOOTER_LEARN_MORE"];
