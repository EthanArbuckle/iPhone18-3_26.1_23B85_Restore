...
- (CRDetailViewComponentFaceID)init
{
  ...
  if (v2)
  {
    ...
    v6 = [locale localizedStringWithFormat:@"%_KB_URL" component:1027];
    v7 = [v4 URLWithString:v6];
    [(CRUDetailViewComponent *)v3 setKbArticleURL:v7];

    locale2 = [(CRUDetailViewComponent *)v3 locale];
    v9 = [locale2 localizedStringWithKey:@"FACEID_SETTINGS_TITLE" defaultString:@"FACEID_SETTINGS_TITLE"];
    [(CRUDetailViewComponent *)v3 setTitleText:v9];

    locale3 = [(CRUDetailViewComponent *)v3 locale];
    v11 = [locale3 localizedStringWithKey:@"FACEID_DESC" defaultString:@"FACEID_DESC"];
    ...
    if ([(CRUDetailViewComponent *)v3 deviceClass]== 3)
    {
      ...
      v16 = [locale5 localizedStringWithKey:@"TRUEDEPTH_KB_URL_IPAD" defaultString:@"TRUEDEPTH_KB_URL_IPAD"];
      v17 = [v14 URLWithString:v16];
      [(CRUDetailViewComponent *)v3 setKbArticleURL:v17];

      locale6 = [(CRUDetailViewComponent *)v3 locale];
      v19 = [locale6 localizedStringWithKey:@"FACEID_DESC_IPAD" defaultString:@"FACEID_DESC_IPAD"];
