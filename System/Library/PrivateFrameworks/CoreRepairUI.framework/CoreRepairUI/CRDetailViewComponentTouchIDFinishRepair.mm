...
{
  v19.receiver = self;
  v19.super_class = CRDetailViewComponentTouchIDFinishRepair;
  v2 = [(CRUDetailViewComponent *)&v19 init];
  v3 = v2;
  if (v2)
  {
    locale = [(CRUDetailViewComponent *)v2 locale];
    v5 = [locale localizedStringWithKey:@"NEW_TOUCH_ID" defaultString:@"NEW_TOUCH_ID"];
    ...
    v11 = [locale3 localizedStringWithKey:@"FINISH_TOUCHID_DESC_IPAD" defaultString:@"FINISH_TOUCHID_DESC_IPAD"];
    ...
    v15 = [locale5 localizedStringWithKey:@"TouchID" defaultString:@"TouchID"];
    [(CRUDetailViewComponent *)v3 setComponentName:v15];

    locale6 = [(CRUDetailViewComponent *)v3 locale];
    v17 = [locale6 localizedStringWithKey:@"TOUCHID_FOOTER_LEARN_MORE" defaultString:@"TOUCHID_FOOTER_LEARN_MORE"];
