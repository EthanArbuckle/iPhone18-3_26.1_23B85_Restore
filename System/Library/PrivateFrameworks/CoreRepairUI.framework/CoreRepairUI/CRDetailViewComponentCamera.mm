...
- (CRDetailViewComponentCamera)init
{
  ...
  if (v2)
  {
    ...
    v6 = [locale localizedStringWithKey:@"NONGENUINE_KB_URL" defaultString:@"NONGENUINE_KB_URL"];
    ...
    v11 = [locale3 localizedStringWithKey:@"NONGENUINE_CAMERA_DESC" defaultString:@"NONGENUINE_CAMERA_DESC"];
