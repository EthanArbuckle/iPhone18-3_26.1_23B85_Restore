...
- (BOOL)isTimerNeeded;
- (MicaPlayer)initWithFileName:(id)name bundle:(id)bundle retinaScale:(double)scale;
...
- (MicaPlayer)initWithFileName:(id)name retinaScale:(double)scale
{
  ...
  v9 = [(MicaPlayer *)self initWithFileName:nameCopy bundle:mainBundle retinaScale:scale];
...
{
  nameCopy = name;
  v9 = [bundle URLForResource:nameCopy withExtension:@"caar"];
  v10 = v9;
  if (v9)
  {
    path = [v9 path];
    v12 = [(MicaPlayer *)self initWithPath:path retinaScale:scale];
    self = path;
  }
  ...
  {
    path2 = [0 path];
    NSLog(&cfstr_UnableToFindMi.isa, nameCopy, path2);
