...
+ (double)lifetimeOfFile:(id)a3
{
  ...
  v4 = kSecondsIn3Day;
  v23 = 0;
  v5 = [MEMORY[0x277CBEA90] dataWithContentsOfURL:v3 options:1 error:&v23];
  v6 = v23;
  if (v5)
  {
    v22 = v6;
    ...
    if (!v7)
    {
      ...
      {
        [(_DPTransparencyLogMaintainer *)v3 lifetimeOfFile:v8];
      }
    }
    ...
    else
    {
      ...
      {
        [(_DPTransparencyLogMaintainer *)v3 lifetimeOfFile:v16];
      }
    }
...
LABEL_24:
  ...
  {
    [(_DPTransparencyLogMaintainer *)v3 lifetimeOfFile:v6];
  }
...
+ (BOOL)checkAndRemoveFile:(id)a3
{
  ...
  v3 = a3;
  [objc_opt_class() lifetimeOfFile:v3];
  v5 = v4;
  ...
  v20 = 0;
  v9 = [v3 getResourceValue:&v21 forKey:v8 error:&v20];
  v10 = v21;
  v11 = v20;
  if ((v9 & 1) == 0)
  {
  ...
  if (!v10)
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
    {
      [(_DPTransparencyLogMaintainer *)v3 checkAndRemoveFile:v12];
    }
...
LABEL_9:
  ...
  {
    v19 = 0;
    v13 = [v6 removeItemAtURL:v3 error:&v19];
    v16 = v19;
    ...
    {
      [(_DPTransparencyLogMaintainer *)v3 checkAndRemoveFile:v16];
    }
  }
...
- (BOOL)doMaintenance
{
  ...
  v3 = [_DPReportFilesMaintainer reportsInDirectory:v2];
