...
- (_DPCMSRecord)initWithCoder:(id)a3
{
  ...
  v10 = [v9 BOOLValue];
  v11 = [(_DPCMSRecord *)self initWithKey:v5 creationDate:v10 submitted:0 objectId:v8];
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v7 = v6;
  v8 = [(_DPCMSRecord *)self submitted];
  v9 = [(_DPCMSRecord *)self objectId];
...
- (BOOL)isEqualToCMSRecord:(id)a3
{
  ...
  v12 = v6 ^ [v4 submitted];
  v13 = [(_DPCMSRecord *)self reportVersion];
  v14 = [v4 reportVersion];
  v15 = [(_DPCMSRecord *)self objectId];

  if (v15)
  {
    v16 = [(_DPCMSRecord *)self objectId];
    v17 = [v4 objectId];
    v18 = [v16 isEqual:v17];
  }
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    v6 = v4 && (objc_opt_class(), (objc_opt_isKindOfClass() & 1) != 0) && [(_DPCMSRecord *)self isEqualToCMSRecord:v5];
  }
