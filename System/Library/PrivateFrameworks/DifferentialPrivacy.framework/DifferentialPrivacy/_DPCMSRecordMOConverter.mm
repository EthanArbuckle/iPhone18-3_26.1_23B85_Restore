...
- (id)insertRecord:(id)record inManagedObjectContext:(id)context
{
  ...
  [(_DPCMSRecordMOConverter *)self copyRecord:recordCopy intoManagedObject:v10];
  ...
  if (v10)
  {
    ...
    do
    {
      for (i = 0; i != v11; ++i)
      {
        ...
        {
          v15 = [(_DPCMSRecordMOConverter *)self insertRecord:v14 inManagedObjectContext:contextCopy, v18];
          [v8 addObject:v15];
        }
      }
