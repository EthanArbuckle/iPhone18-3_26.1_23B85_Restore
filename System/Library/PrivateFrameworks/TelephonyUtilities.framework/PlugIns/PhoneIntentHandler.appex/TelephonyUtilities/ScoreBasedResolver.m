...
- (void)addScore:(int64_t)a3 forEntity:(id)a4 reason:(id)a5
{
  ...
  v12 = +[NSNumber numberWithInteger:](NSNumber, "numberWithInteger:", [v10 integerValue] + a3);
  [(NSMutableDictionary *)self->_scoreByEntity setObject:v12 forKeyedSubscript:v16];

  v13 = [(NSMutableDictionary *)self->_scoreReasonsByEntity objectForKeyedSubscript:v16];
  if (!v13)
  {
  ...
  v15 = [NSString stringWithFormat:@"%ld: %@", a3, v8];
  [v13 addObject:v15];
}
  ...
  if (v10)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        [(ScoreBasedResolver *)self addScore:a3 forEntity:*(*(&v14 + 1) + 8 * v13) reason:v9];
        v13 = v13 + 1;
      }
...
- (ScoreBasedResolutionResult)result
{
  ...
  v6 = [v5 countByEnumeratingWithState:&v86 objects:v94 count:16];
  if (v6)
  {
    v7 = v6;
    v8 = *v87;
    do
    {
      for (i = 0; i != v7; i = i + 1)
      {
        ...
        v10 = *(*(&v86 + 1) + 8 * i);
        v11 = [(ScoreBasedResolver *)v2 scoreByEntity];
      ...
      v7 = [v5 countByEnumeratingWithState:&v86 objects:v94 count:16];
    }
  ...
  {
    if (![(ScoreBasedResolver *)v2 confirmationEnabled]|| v19 - v24 < [(ScoreBasedResolver *)v2 confirmationMargin])
    {
LABEL_18:
      ...
      v85 = 0u;
      v26 = v17;
      v27 = [v26 countByEnumeratingWithState:&v82 objects:v93 count:16];
      if (v27)
      {
        v28 = v27;
        v29 = v19 - v25;
...
LABEL_20:
        ...
        while (1)
        {
          ...
          v32 = *(*(&v82 + 1) + 8 * v31);
          if (!-[ScoreBasedResolver includeAllEntitiesInDisambiguation](v2, "includeAllEntitiesInDisambiguation") && [v32 integerValue] < v29)
          {
            break;
          }
          ...
          if (v28 == ++v31)
          {
            v28 = [v26 countByEnumeratingWithState:&v82 objects:v93 count:16];
            if (v28)
            {
              goto LABEL_20;
            }
  ...
  v26 = [v17 firstObject];
  v66 = [v4 objectForKeyedSubscript:v26];
LABEL_31:
