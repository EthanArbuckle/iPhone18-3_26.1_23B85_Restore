...
- (id)_ams_localiTunesAccount
{
  ...
  v2 = [a1 ams_mediaType];
  v14 = 0;
  v3 = [v1 ams_localiTunesAccountForAccountMediaType:v2 error:&v14];
  v4 = v14;
  ...
  if (!v3)
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
    {
      ...
      *buf = 138543618;
      ...
      v17 = 2114;
      v18 = v12;
      _os_log_impl(&dword_192869000, v6, OS_LOG_TYPE_ERROR, "%{public}@Failed to create/fetch the local account. error = %{public}@", buf, 0x16u);
      if (v7)
      {
...
- (id)ams_accountIsBackingAccountForActiveiCloudAccount:()AppleMediaServices_Project
{
  ...
  {
    v5 = [a1 ams_fetchActiveiCloudAccount];
...
- (id)ams_localiTunesAccountForAccountMediaType:()AppleMediaServices_Project error:
{
  ...
  v8 = AMSAccountTypeWithAccountTypeIdentifier(a1, v7, 0);
  v9 = [a1 ams_localiTunesAccountForAccountType:v8 error:a4];
...
- (id)_ams_localiTunesAccountForAccountMediaType:()AppleMediaServices_Project updateStorefront:
{
  v6 = [a1 _accountTypeForMediaType:?];
...
- (id)ams_demoAccount
{
  v1 = [a1 ams_iTunesAccounts];
  v2 = [v1 ams_firstObjectPassingTest:&__block_literal_global_266];
...
- (id)ams_fetchDemoAccount
{
  v1 = [a1 ams_fetchiTunesAccounts];
  v2 = [v1 thenWithBlock:&__block_literal_global_268];
...
{
  v1 = [a1 ams_iTunesAccounts];
  v2 = [v1 ams_firstObjectPassingTest:&__block_literal_global_273];
...
{
  v4 = [a3 identifier];
  v5 = [a1 _ams_accountWithIdentifier:v4 error:0];
  v6 = v5 == 0;
...
- (AMSMutableBinaryPromise)ams_saveAccount:()AppleMediaServices_Project withOptions:
{
  ...
  [a1 _ams_saveAccount:v6 withOptions:a4 sync:0 completion:v8];
...
- (uint64_t)ams_saveVerifiedAccount:()AppleMediaServices_Project withOptions:error:
{
  ...
  v11[4] = &v18;
  v11[5] = &v12;
  [a1 _ams_saveAccount:v8 withOptions:a4 sync:1 completion:v11];
  v9 = *(v19 + 24);
  if (a5 && (v19[3] & 1) == 0)
  {
    *a5 = v13[5];
...
- (id)ams_localiTunesAccountForAccountType:()AppleMediaServices_Project error:
{
  ...
  v6 = a3;
  v35 = 0;
  v7 = [a1 _fetchLocalAccountForAccountType:v6 error:&v35];
  v8 = v35;
  v9 = v8;
  if (!v7)
  {
    ...
    {
      v34 = 0;
      v10 = [a1 _createLocaliTunesAccountForAccountType:v6 error:&v34];
      v11 = v34;
      v12 = v11;
      if (v10)
      {
        v33 = v9;
        v7 = [a1 _fetchLocalAccountForAccountType:v6 error:&v33];
        v13 = v33;
...
LABEL_33:
        ...
        if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR))
        {
          ...
          *buf = 138543618;
          ...
          v38 = 2114;
          v39 = v30;
          _os_log_impl(&dword_192869000, v22, OS_LOG_TYPE_ERROR, "%{public}@Encountered an unexpected error while fetching local account: %{public}@", buf, 0x16u);
          if (v23)
          {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_ERROR))
    {
      ...
      *buf = 138543618;
      ...
      v38 = 2114;
      v39 = v28;
      _os_log_impl(&dword_192869000, v15, OS_LOG_TYPE_ERROR, "%{public}@Encountered an unexpected error while fetching local account: %{public}@", buf, 0x16u);
      if (v16)
      {
...
LABEL_25:
  ...
  if (!v10)
  {
    ...
    if (os_log_type_enabled(v28, OS_LOG_TYPE_ERROR))
    {
      ...
      *buf = 138543874;
      ...
      v49 = 2114;
      v50 = v31;
      _os_log_impl(&dword_192869000, v28, OS_LOG_TYPE_ERROR, "%{public}@ [%{public}@] Someone is attempting to save a nil account. account = %{public}@", buf, 0x20u);
    }
  ...
  if ([v10 ams_isEphemeralAccount])
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_ERROR))
    {
      ...
      *buf = 138543874;
      ...
      v49 = 2114;
      v50 = v18;
      _os_log_impl(&dword_192869000, v15, OS_LOG_TYPE_ERROR, "%{public}@ [%{public}@] Someone is attempting to save an ephemeral account. account = %{public}@", buf, 0x20u);
    }
  ...
  if ([a1 ams_isAccountNew:v10])
  {
    v20 = [v10 ams_isLocalAccount];
    if ((a4 & 1) == 0 && (v20 & 1) == 0)
    {
      v21 = +[AMSLogConfig sharedAccountsConfig];
      if (!v21)
      ...
      if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR))
      {
        ...
        *buf = 138543874;
        ...
        v49 = 2114;
        v50 = v25;
        _os_log_impl(&dword_192869000, v22, OS_LOG_TYPE_ERROR, "%{public}@ [%{public}@] Someone is attempting to save a new account instead of using AMSAuthenticateTask. account = %{public}@", buf, 0x20u);
      }
    ...
    if ((v20 & 1) == 0)
    {
      ...
      if (os_log_type_enabled(v34, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *buf = 138543874;
        ...
        v49 = 2048;
        v50 = a4;
        _os_log_impl(&dword_192869000, v34, OS_LOG_TYPE_DEFAULT, "%{public}@: [%{public}@] Saving a new account. options = %ld", buf, 0x20u);
      }
    }
  }
  ...
  if (([v10 isDirty] & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v40, OS_LOG_TYPE_DEBUG))
    {
      ...
      *buf = 138543874;
      ...
      v49 = 2114;
      v50 = v43;
      _os_log_impl(&dword_192869000, v40, OS_LOG_TYPE_DEBUG, "%{public}@ [%{public}@] Someone attempted to save an unmodified account. account = %{public}@", buf, 0x20u);
    }
  ...
  {
    v44 = 0;
    v37 = [a1 _saveVerifiedAccount:v10 error:&v44];
    v38 = v44;
    v11[2](v11, v37, v38);
