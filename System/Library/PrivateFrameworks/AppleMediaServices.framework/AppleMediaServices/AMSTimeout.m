...
- (AMSTimeout)initWithExpiration:(double)a3 clockSource:(id)a4
{
  ...
  if (v8)
  {
    objc_storeStrong(&v8->_clockSource, a4);
...
- (BOOL)hasExpired
{
  ...
  if (v6 < v7)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      v16 = 2114;
      v17 = v12;
      _os_log_impl(&dword_192869000, v9, OS_LOG_TYPE_ERROR, "%{public}@: [%{public}@] Current timestamp is older than the previous. A monotonic clock source was expected.", &v14, 0x16u);
    }
  }
