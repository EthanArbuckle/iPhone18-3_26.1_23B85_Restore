...
{
  v11 = 0;
  v6 = [MEMORY[0x1E696ACB0] JSONObjectWithData:a3 options:0 error:&v11];
  v7 = v6;
  if (v11)
  {
    goto LABEL_2;
...
- (AMSRatingsStorefrontResult)initWithDictionaries:(id)a3 mediaType:(unint64_t)a4
{
  ...
  if (v7)
  {
    v9 = [(AMSRatingsStorefrontResult *)v7 _mapRatingsDictionaries:v6 withMediaType:a4];
...
{
  v6 = a3;
  v7 = [(AMSRatingsStorefrontResult *)self _ratingInfoMediaTypeForTaskMediaType:a4];
