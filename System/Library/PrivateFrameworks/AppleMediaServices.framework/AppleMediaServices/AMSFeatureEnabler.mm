...
+ (id)_fetchEnabledFeatures
{
  ...
  if (!+[AMSProcessInfo hasAMSEntitlement])
  {
    ...
    {
      *buf = 0;
      _os_log_impl(&dword_192869000, v4, OS_LOG_TYPE_DEBUG, "Current process is attempting to read from shared preferences but does not have the com.apple.private.applemediaservices entitlement.", buf, 2u);
    }
  }
  ...
  if (v5 && (objc_opt_class(), (objc_opt_isKindOfClass() & 1) == 0))
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_ERROR))
    {
      ...
      *buf = 138543362;
      v16 = v9;
      v10 = v9;
      _os_log_impl(&dword_192869000, v8, OS_LOG_TYPE_ERROR, "%{public}@: Unable to generate the ITFE cookie. The features aren't stored in a dictionary.", buf, 0xCu);
    }
