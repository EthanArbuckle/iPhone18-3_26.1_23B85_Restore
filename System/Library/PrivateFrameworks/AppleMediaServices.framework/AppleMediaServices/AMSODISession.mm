...
+ (id)_dispatchQueue;
+ (id)provideFeedbackWithOutcome:(unint64_t)a3 cacheIdentifier:(id)a4 bag:(id)a5;
- (AMSODISession)initWithSessionIdentifier:(id)a3 accountType:(unint64_t)a4 bundleIdentifier:(id)a5 bag:(id)a6;
- (id)createODISession;
- (id)getAssessment;
- (id)provideUpdateWithAttributes:(id)a3;
@end
...
+ (id)provideFeedbackWithOutcome:(unint64_t)a3 cacheIdentifier:(id)a4 bag:(id)a5
{
  ...
  v11 = [v23[5] purchaseServiceProxy];
