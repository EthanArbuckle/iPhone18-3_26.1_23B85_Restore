...
LABEL_6:
    ...
    if (v12)
    {
      ...
      if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
      {
        ...
        *buf = 138543362;
        v26 = v15;
        _os_log_impl(&dword_192869000, v14, OS_LOG_TYPE_ERROR, "%{public}@: Failed to update AMSStorage database scheme. User version did not change", buf, 0xCu);
      }
  ...
  if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
  {
    ...
    *buf = 138543618;
    ...
    v27 = 2112;
    v28 = v20;
    _os_log_impl(&dword_192869000, v14, OS_LOG_TYPE_ERROR, "%{public}@: Failed to update AMSStorage database scheme. Success = NO. Error = %@{public}@", buf, 0x16u);
  }
