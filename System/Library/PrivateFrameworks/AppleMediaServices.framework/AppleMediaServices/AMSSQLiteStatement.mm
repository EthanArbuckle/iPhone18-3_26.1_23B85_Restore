...
{
  v4 = *&a4;
  v6 = [MEMORY[0x1E696ACB0] dataWithJSONObject:a3 options:0 error:0];
...
- (void)bindDouble:(double)a3 atPosition:(int)a4
{
  ...
  {
    [MEMORY[0x1E695DF30] raise:*MEMORY[0x1E695D930] format:{@"[AMSSQLiteStatement] Statement already finalized", a3}];
  }
}
...
- (void)bindNullableString:(id)a3 atPosition:(int)a4
{
  if (a3)
  {
    [(AMSSQLiteStatement *)self bindString:a3 atPosition:*&a4];
  }

  else
  {
    [(AMSSQLiteStatement *)self bindNullAtPosition:*&a4];
  }
}
