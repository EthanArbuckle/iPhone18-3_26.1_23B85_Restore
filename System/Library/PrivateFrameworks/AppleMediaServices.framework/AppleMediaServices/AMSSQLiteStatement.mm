...
- (AMSSQLiteStatement)initWithStatement:(sqlite3_stmt *)statement onConnection:(id)connection;
- (BOOL)isReadOnly;
...
- (int)reset
{
  ...
  {
    [MEMORY[0x1E695DF30] raise:*MEMORY[0x1E695D930] format:{@"[AMSSQLiteStatement] Statement already finalized", v2, v3}];
    return 21;
  }
}
...
- (NSDictionary)columnIndexByName
{
  ...
  {
    [MEMORY[0x1E695DF30] raise:*MEMORY[0x1E695D930] format:@"[AMSSQLiteStatement] Statement already finalized"];
    v5 = 0;
  }
...
- (AMSSQLiteStatement)initWithStatement:(sqlite3_stmt *)statement onConnection:(id)connection
{
  ...
  v11.receiver = self;
  v11.super_class = AMSSQLiteStatement;
...
{
  v4 = *&position;
  v6 = [MEMORY[0x1E696ACB0] dataWithJSONObject:array options:0 error:0];
...
- (void)bindDate:(id)date atPosition:(int)position
{
  ...
  [(AMSSQLiteStatement *)self bindDouble:v4 atPosition:?];
}

- (void)bindDictionary:(id)dictionary atPosition:(int)position
{
  v4 = *&position;
  v6 = [MEMORY[0x1E696ACB0] dataWithJSONObject:dictionary options:0 error:0];
  [(AMSSQLiteStatement *)self bindData:v6 atPosition:v4];
}
...
- (void)bindDouble:(double)double atPosition:(int)position
{
  ...
  {
    [MEMORY[0x1E695DF30] raise:*MEMORY[0x1E695D930] format:{@"[AMSSQLiteStatement] Statement already finalized", double}];
  }
}
...
- (void)bindNullableString:(id)string atPosition:(int)position
{
  if (string)
  {
    [(AMSSQLiteStatement *)self bindString:string atPosition:*&position];
  }

  else
  {
    [(AMSSQLiteStatement *)self bindNullAtPosition:*&position];
  }
}
...
- (void)bindURL:(id)l atPosition:(int)position
{
  ...
  [(AMSSQLiteStatement *)self bindString:absoluteString atPosition:v4];
}
