...
- (AMSDelegateAuthenticateTask)initWithBag:(id)bag account:(id)account;
- (AMSDelegateAuthenticateTask)initWithDelegateAuthenticateRequest:(id)request bag:(id)bag account:(id)account;
...
- (id)_encodedURLRequestWithError:(id *)error
{
  ...
  delegateAuthenticateUrl = [(AMSDelegateAuthenticateTask *)self delegateAuthenticateUrl];
  if (delegateAuthenticateUrl)
  {
    ...
    if (os_log_type_enabled(oSLogObject2, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *buf = 138543618;
      ...
      v38 = 2114;
      v39 = v5;
      _os_log_impl(&dword_192869000, oSLogObject2, OS_LOG_TYPE_DEFAULT, "%{public}@: [%{public}@] Completed extracting URL endpoint from bag", buf, 0x16u);
    }
    ...
    [(AMSURLRequestEncoder *)v15 setAccount:account];
    ...
    formData = [(AMSDelegateAuthenticateTask *)self formData];
    ...
    _urlRequestParameters = [(AMSDelegateAuthenticateTask *)self _urlRequestParameters];
    v33 = delegateAuthenticateUrl;
    v20 = [(AMSURLRequestEncoder *)v15 requestWithMethod:4 URL:delegateAuthenticateUrl headers:v18 parameters:_urlRequestParameters];
    ...
    if (v22)
    {
      ...
      if (os_log_type_enabled(oSLogObject3, OS_LOG_TYPE_ERROR))
      {
        ...
        *buf = 138544130;
        ...
        v42 = 2114;
        v43 = v22;
        _os_log_impl(&dword_192869000, oSLogObject3, OS_LOG_TYPE_ERROR, "%{public}@: [%{public}@] Failed to encode request for URL: %@, error: %{public}@", buf, 0x2Au);
      }
...
- (id)_parseFormDataFromResult:(id)result
{
  ...
  if (os_log_type_enabled(oSLogObject, OS_LOG_TYPE_INFO))
  {
    ...
    v28 = 2114;
    v29 = v5;
    _os_log_impl(&dword_192869000, oSLogObject, OS_LOG_TYPE_INFO, "%{public}@: [%{public}@] Attempting to parse form-data from URL result.", &v26, 0x16u);
  }
...
LABEL_15:
    ...
    if (os_log_type_enabled(oSLogObject2, OS_LOG_TYPE_INFO))
    {
      ...
      v28 = 2114;
      v29 = v5;
      _os_log_impl(&dword_192869000, oSLogObject2, OS_LOG_TYPE_INFO, "%{public}@: [%{public}@] Did not find URL result object or it was not an NSDictionary.", &v26, 0x16u);
    }
...
LABEL_33:
          ...
          if (os_log_type_enabled(oSLogObject3, OS_LOG_TYPE_INFO))
          {
            ...
            v28 = 2114;
            v29 = v5;
            _os_log_impl(&dword_192869000, oSLogObject3, OS_LOG_TYPE_INFO, "%{public}@: [%{public}@] Did not find formData or it was not an NSDictionary", &v26, 0x16u);
          }
...
LABEL_32:
      ...
      if (os_log_type_enabled(oSLogObject3, OS_LOG_TYPE_INFO))
      {
        ...
        v28 = 2114;
        v29 = v5;
        _os_log_impl(&dword_192869000, oSLogObject3, OS_LOG_TYPE_INFO, "%{public}@: [%{public}@] Did not find 'okButtonAction' or it was not an NSDictionary.", &v26, 0x16u);
      }
  ...
  if (os_log_type_enabled(oSLogObject4, OS_LOG_TYPE_INFO))
  {
    ...
    v28 = 2114;
    v29 = v5;
    _os_log_impl(&dword_192869000, oSLogObject4, OS_LOG_TYPE_INFO, "%{public}@: [%{public}@] Did not find 'dialog' or it was not an NSDictionary. Attempt to locate form data as string.", &v26, 0x16u);
  }
...
- (id)_parseFormDataAsStringFromResult:(id)result
{
  ...
  if (os_log_type_enabled(oSLogObject, OS_LOG_TYPE_INFO))
  {
    *buf = 138543618;
    ...
    v34 = 2114;
    v35 = v4;
    _os_log_impl(&dword_192869000, oSLogObject, OS_LOG_TYPE_INFO, "%{public}@: [%{public}@] Attempting to parse form-data as string from URL result.", buf, 0x16u);
  }

  v7 = [resultCopy objectForKeyedSubscript:@"okButtonAction"];
    ...
    if (v8)
    {
      ...
      if (objc_opt_isKindOfClass())
      {
        ...
        if (v10)
        {
          ...
          oSLogObject5 = [v12 mutableCopy];

          if (([oSLogObject5 containsString:@"<dict>"]& 1) == 0)
          {
            [oSLogObject5 insertString:@"<dict>" atIndex:0];
          }

          if (([oSLogObject5 containsString:@"</dict>"]& 1) == 0)
          {
            [oSLogObject5 appendString:@"</dict>"];
          }

          oSLogObject4 = [oSLogObject5 dataUsingEncoding:4];
          if (!oSLogObject4)
          {
            v21 = +[AMSLogConfig sharedConfig];
            if (!v21)
            ...
            if (os_log_type_enabled(oSLogObject2, OS_LOG_TYPE_ERROR))
            {
              ...
              *buf = 138543618;
              ...
              v34 = 2114;
              v35 = v4;
              _os_log_impl(&dword_192869000, oSLogObject2, OS_LOG_TYPE_ERROR, "%{public}@: [%{public}@] Could not convert 'formData' from NSString to NSData.", buf, 0x16u);
            }
          ...
          v31 = 0;
          v15 = [MEMORY[0x1E696AE40] propertyListWithData:oSLogObject4 options:0 format:0 error:&v31];
          v30 = v31;
          if (!v15)
          {
...
LABEL_48:
          ...
          if (os_log_type_enabled(oSLogObject3, OS_LOG_TYPE_INFO))
          {
            ...
            *buf = 138543618;
            ...
            v34 = 2114;
            v35 = v4;
            _os_log_impl(&dword_192869000, oSLogObject3, OS_LOG_TYPE_INFO, "%{public}@: [%{public}@] Parsed formData was not an NSDictionary", buf, 0x16u);
          }
      ...
      if (os_log_type_enabled(oSLogObject4, OS_LOG_TYPE_INFO))
      {
        ...
        *buf = 138543618;
        ...
        v34 = 2114;
        v35 = v4;
        _os_log_impl(&dword_192869000, oSLogObject4, OS_LOG_TYPE_INFO, "%{public}@: [%{public}@] Did not find 'formData' or it was not an NSString.", buf, 0x16u);
      }
  ...
  if (os_log_type_enabled(oSLogObject5, OS_LOG_TYPE_INFO))
  {
    ...
    *buf = 138543618;
    ...
    v34 = 2114;
    v35 = v4;
    _os_log_impl(&dword_192869000, oSLogObject5, OS_LOG_TYPE_INFO, "%{public}@: [%{public}@] Did not find 'okButtonAction' or it was not an NSDictionary.", buf, 0x16u);
  }
...
- (id)_performDelegateAuthenticationWithError:(id *)error
{
  ...
  {
    signatureResult = [(AMSDelegateAuthenticateTask *)self signatureResult];

    if (signatureResult)
    {
      account = [(AMSDelegateAuthenticateTask *)self account];
      properties = [v5 properties];
      keychainOptions = [properties keychainOptions];
      signatureResult2 = [(AMSDelegateAuthenticateTask *)self signatureResult];
      v15 = [AMSBiometrics headersWithAccount:account options:keychainOptions signatureResult:signatureResult2];
      [v5 ams_addHeaders:v15];
    }

    session = [(AMSDelegateAuthenticateTask *)self session];
    v17 = [session dataTaskPromiseWithRequest:v5];
    v25 = 0;
    ...
    if (v7)
    {
      ...
      if (os_log_type_enabled(oSLogObject, OS_LOG_TYPE_ERROR))
      {
        ...
        *buf = 138543874;
        ...
        v31 = 2114;
        v32 = v7;
        _os_log_impl(&dword_192869000, oSLogObject, OS_LOG_TYPE_ERROR, "%{public}@: [%{public}@] URL request failed with error: %{public}@", buf, 0x20u);
      }
...
- (id)_urlRequestParameters
{
  ...
  if (formData)
  {
    formData2 = [(AMSDelegateAuthenticateTask *)self formData];
  }

  else
  {
    v5 = objc_alloc_init(MEMORY[0x1E695DF90]);
    request = [(AMSDelegateAuthenticateTask *)self request];
    challenge = [request challenge];
    [v5 ams_setNullableObject:challenge forKey:@"challenge"];

    request2 = [(AMSDelegateAuthenticateTask *)self request];
    userAgent = [request2 userAgent];
    [v5 ams_setNullableObject:userAgent forKey:@"requesterUserAgent"];
...
LABEL_6:
  ...
  if (v4)
  {
    object = [[AMSDelegateAuthenticateResult alloc] initWithServerResponse:v4];
    token = [(AMSDelegateAuthenticateResult *)object token];
