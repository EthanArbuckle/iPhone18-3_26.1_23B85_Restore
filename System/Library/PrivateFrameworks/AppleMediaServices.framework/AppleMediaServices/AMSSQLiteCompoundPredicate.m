  ...
  if (v12)
  {
    ...
    do
    {
      for (i = 0; i != v13; ++i)
      {
        ...
        v16 = [AMSSQLiteComparisonPredicate predicateWithProperty:v8 value:*(*(&v19 + 1) + 8 * i) comparisonType:a5, v19];
        [v10 addObject:v16];
      }
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ([(AMSSQLitePredicate *)&v12 isEqual:v4]&& ((combinationOperation = self->_combinationOperation, combinationOperation == v4[1]) || [(NSString *)combinationOperation isEqual:?]))
  {
