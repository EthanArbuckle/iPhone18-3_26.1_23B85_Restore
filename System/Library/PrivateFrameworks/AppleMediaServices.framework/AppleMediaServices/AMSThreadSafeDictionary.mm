...
- (NSArray)allKeys
{
  ...
  v11 = 0;
  backingDictionary = [(AMSThreadSafeDictionary *)self backingDictionary];
  v5[0] = MEMORY[0x1E69E9820];
  v5[1] = 3221225472;
  v5[2] = __34__AMSThreadSafeDictionary_allKeys__block_invoke;
  v5[3] = &unk_1E73BCA60;
  v5[4] = &v6;
  [backingDictionary read:v5];
...
- (void)readWrite:(id)write
{
  ...
  v8 = writeCopy;
  v6 = writeCopy;
  [backingDictionary readWrite:v7];
}
...
{
  backingDictionary = [(AMSThreadSafeDictionary *)self backingDictionary];
  [backingDictionary readWrite:&__block_literal_global_140];
}
...
- (void)setObject:(id)object forKey:(id)key
{
  ...
  v9 = keyCopy;
  v10 = objectCopy;
  [backingDictionary readWrite:v11];
}
