...
{
  v6 = *a3;
  v7 = [(USExemptApplication *)self event];
  LOBYTE(a4) = [(USExemptApplication *)self _validateBudget:v6 andEvent:v7 error:a4];
...
- (BOOL)validateEvent:(id *)a3 error:(id *)a4
{
  v7 = [(USExemptApplication *)self budget];
  LOBYTE(a4) = [(USExemptApplication *)self _validateBudget:v7 andEvent:*a3 error:a4];
