    ...
    do
    {
      for (i = 0; i != v44; ++i)
      {
        ...
        else
        {
          ...
          v25 = [(ATXContextAlarmSuggestionProducer *)v40 _criteriaWithAlarm:v10];
          if (v25)
          {
            ...
            v6 = v42;
            v31 = [ATXContextHeuristicSuggestionProducer suggestionWithShortcutAction:v26 predictionReasons:v36 localizedReason:0 title:v42 subtitle:v30 score:0 dateInterval:v40->_score];
...
- (id)_criteriaWithAlarm:(id)a3
{
  ...
  if (v6)
  {
    ...
    if (v7)
    {
      ...
      v13 = [(NSDateInterval *)self->_validDateInterval startDate];
      v14 = [v12 initWithStartDate:v13 endDate:v11 lockScreenEligible:0 predicate:0];
...
- (id)editNextAlarmSuggestionsWithEnvironment:(id)a3
{
  ...
  v9 = [(NSDateInterval *)v5 startDate];
  v10 = [(NSDateInterval *)v5 endDate];
  v11 = [v8 initWithStartDate:v9 endDate:v10 lockScreenEligible:0 predicate:0];
...
- (id)_nextMorningAlarmsWithEnvironment:(id)a3
{
  ...
  v13 = [(ATXContextAlarmSuggestionProducer *)self _alarmsWithEnvironment:v4 startTimestamp:v8 endTimestamp:v12];
...
- (id)_morningAlarmsWithEnvironment:(id)a3
{
  ...
  v9 = [(NSDateInterval *)self->_validDateInterval endDate];
  [v9 timeIntervalSinceReferenceDate];
  v11 = v10;

  v12 = [(ATXContextAlarmSuggestionProducer *)self _alarmsWithEnvironment:v5 startTimestamp:v8 endTimestamp:v11];
...
- (id)_filterAlarmsEligible:(id)a3 proposedInterval:(id)a4
{
  ...
  v10 = v5;
  v6 = v5;
  v7 = [a3 _pas_filteredArrayWithTest:v9];
