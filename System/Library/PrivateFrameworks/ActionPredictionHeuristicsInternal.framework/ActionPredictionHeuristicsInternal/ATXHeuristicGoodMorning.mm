...
- (id)permanentRefreshTriggers
{
  ...
  v2 = [objc_opt_class() contextDateInterval];
...
- (id)heuristicResultWithEnvironment:(id)a3
{
  ...
  if (_os_feature_enabled_impl())
  {
    ...
    v7 = objc_opt_new();
    v8 = [objc_opt_class() contextDateInterval];
    v9 = [MEMORY[0x277CBEAA8] now];
    v10 = [v8 containsDate:v9];
    ...
    if (v10)
    {
      ...
      v25 = v11;
      [v7 addObject:v12];
      v24 = [[ATXContextAlarmSuggestionProducer alloc] initWithValidDateInterval:v8 reasonCode:40 score:45.0];
      v13 = [(ATXContextAlarmSuggestionProducer *)v24 morningAlarmToggleSuggestionsWithEnvironment:v4];
      [v7 addObjectsFromArray:v13];

      v14 = [[ATXContextWebsiteSuggestionProducer alloc] initWithValidDateInterval:v8 reasonCode:40 score:40.0];
...
- (void)_addRefreshTimeTriggerWithHour:(unint64_t)a3 refreshTriggers:(id)a4
{
  ...
  v5 = a4;
  v6 = [objc_opt_class() nextDateWithHour:a3];
...
+ (id)contextDateInterval
{
  ...
  v4 = [v3 dateBySettingHour:6 minute:0 second:0 ofDate:v2 options:0];
  v5 = [v3 dateBySettingHour:10 minute:0 second:0 ofDate:v2 options:0];
