...
- (ARUISpriteRenderState)initWithDevice:(id)a3 library:(id)a4
{
  ...
  if (v8)
  {
    v10 = [(ARUISpriteRenderState *)v8 renderPipelineDescriptorFromLibrary:v7];
...
- (id)renderPipelineDescriptorFromLibrary:(id)a3
{
  v4 = a3;
  v5 = objc_opt_new();
  v6 = [v4 newFunctionWithName:@"vertex_sprite_shader"];
  [v5 setVertexFunction:v6];

  v7 = [v4 newFunctionWithName:@"fragment_sprite_shader"];
  ...
  v10 = [(ARUISpriteRenderState *)self name];
  [v5 setLabel:v10];
