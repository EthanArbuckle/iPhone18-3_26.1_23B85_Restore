...
- (BOOL)_copyIBICFromPath:(char *)a3 withOptions:(__CFDictionary *)a4 intoArray:(const __CFArray *)a5 withError:(__CFError *)a6
{
  if (!a6)
  {
    [(NVMEiBootUpdater *)self _copyIBICFromPath:a2 withOptions:a3 intoArray:a4 withError:a5, 0, v6, v7, v73];
LABEL_36:
    LOBYTE(v10) = 0;
    goto LABEL_26;
  }
  ...
  if (!URLFromString)
  {
    [(NVMEiBootUpdater *)a6 _copyIBICFromPath:v47 withOptions:v48 intoArray:v49 withError:v50, v51, v52, v53];
    goto LABEL_36;
  }
...
LABEL_25:
  ...
  else
  {
    ...
    [(NVMEiBootUpdater *)v74 _copyIBICFromPath:v64 withOptions:v58 intoArray:v59 withError:v60, v61, v62, v63];
    LOBYTE(v10) = 0;
  }
