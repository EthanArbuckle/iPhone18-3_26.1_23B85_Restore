      ...
      if (v19)
      {
        ...
        if ((v20 & 0x80000000) == 0)
        {
          ...
          if (!v14)
          {
            v21 = 0xFFFFFFFFLL;
LABEL_20:
            objc_msgSend__doPingWithSocket_address_timeToRunTestInSeconds_pingTimeout_queue_completionHandler_(self, v34, v21, v41, v42, queueCopy, handlerCopy, ping, 2.0);
            v14 = 0;
          }
        }
      }
