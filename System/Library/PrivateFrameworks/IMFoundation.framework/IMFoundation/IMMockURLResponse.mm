...
- (void)encodeWithCoder:(id)a3
{
  ...
  objc_msgSend_encodeObject_forKey_(v4, v8, v7, @"mockResponse");

  v11 = objc_msgSend_data(self, v9, v10);
  objc_msgSend_encodeObject_forKey_(v4, v12, v11, @"mockData");

  v15 = objc_msgSend_requestBodyKeyPath(self, v13, v14);
  objc_msgSend_encodeObject_forKey_(v4, v16, v15, @"requestBodyKeyPath");

  v20 = objc_msgSend_mockID(self, v17, v18);
  objc_msgSend_encodeObject_forKey_(v4, v19, v20, @"mockID");
}
...
- (IMMockURLResponse)initWithCoder:(id)a3
{
  ...
  if (v6)
  {
    v7 = objc_msgSend_decodeObjectForKey_(v4, v5, @"mockResponse");
    objc_msgSend_setResponse_(v6, v8, v7);

    v9 = objc_opt_class();
    v11 = objc_msgSend_decodeObjectOfClass_forKey_(v4, v10, v9, @"mockData");
    objc_msgSend_setData_(v6, v12, v11);

    v13 = objc_opt_class();
    v15 = objc_msgSend_decodeObjectOfClass_forKey_(v4, v14, v13, @"requestBodyKeyPath");
    objc_msgSend_setRequestBodyKeyPath_(v6, v16, v15);

    v17 = objc_opt_class();
    v19 = objc_msgSend_decodeObjectOfClass_forKey_(v4, v18, v17, @"mockID");
...
{
  v3 = a3;
  v5 = objc_msgSend_objectForKey_(v3, v4, @"status");
  v8 = objc_msgSend_intValue(v5, v6, v7);

  v10 = objc_msgSend_objectForKey_(v3, v9, @"headers");
  v12 = objc_msgSend_objectForKey_(v3, v11, @"requestBodyForKeyPath");
  v14 = objc_msgSend_objectForKey_(v3, v13, @"mockID");
  v15 = objc_alloc(MEMORY[0x1E695DFF8]);
  v17 = objc_msgSend_objectForKey_(v3, v16, @"url");
  ...
  v25 = objc_msgSend_objectForKey_(v3, v24, @"body");
