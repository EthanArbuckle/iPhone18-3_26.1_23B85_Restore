...
- (uint64_t)mergeObject:()HMFMerging
{
  ...
  v35 = 0u;
  selfCopy = self;
  v15 = [selfCopy countByEnumeratingWithState:&v34 objects:v43 count:16];
  if (v15)
  {
    v16 = v15;
    v17 = *v35;
    do
    {
      ...
      v16 = [selfCopy countByEnumeratingWithState:&v34 objects:v43 count:16];
    }
