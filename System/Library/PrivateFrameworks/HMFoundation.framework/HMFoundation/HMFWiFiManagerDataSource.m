...
- (void)deactivate
{
  ...
  MEMORY[0x2821878C8](v2, 0);
}

- (BOOL)isWoWAsserted
{
  v3 = [(HMFWiFiManagerDataSource *)self workQueue];
...
- (void)setWoWAsserted:(BOOL)a3
{
  v3 = a3;
  v14 = *MEMORY[0x277D85DE8];
  v5 = [(HMFWiFiManagerDataSource *)self workQueue];
...
- (HMFWifiNetworkAssociation)currentNetworkAssociation
{
  ...
  if ([(HMFWiFiManagerDataSource *)self currentNetwork])
  {
    ...
    if (v5 && v7 && v9 && v11 && v13)
    {
      v10 = [[HMFWifiNetworkAssociation alloc] initWithMACAddress:v7 SSID:v5 requiresPassword:v15 != 0 BSSID:v9 gatewayIPAddress:v11 gatewayMACAddress:v13];
    }
  }
...
- (void)_setCurrentNetwork:(__WiFiNetwork *)a3
{
  ...
  else
  {
    ...
    os_unfair_lock_unlock(&self->_lock);
    v6 = [(HMFWiFiManagerDataSource *)self delegate];
