...
+ (id)_requestWithID:(id)a3 kind:(id)a4 context:(id)a5 enableAppDistribution:(BOOL)a6
{
  ...
  v10 = a4;
  v11 = a3;
  v12 = [[ASCLockupRequest alloc] _initWithID:v11 kind:v10 context:v9 enableAppDistribution:v6];
...
+ (id)_requestWithID:(id)a3 kind:(id)a4 context:(id)a5 clientID:(id)a6 enableAppDistribution:(BOOL)a7
{
  ...
  v13 = a4;
  v14 = a3;
  v15 = [[ASCLockupRequest alloc] _initWithID:v14 kind:v13 context:v12 clientID:v11 enableAppDistribution:v7];
...
+ (id)_requestWithID:(id)a3 kind:(id)a4 context:(id)a5 clientID:(id)a6 productVariantID:(id)a7 enableAppDistribution:(BOOL)a8
{
  ...
  v16 = a4;
  v17 = a3;
  v18 = [[ASCLockupRequest alloc] _initWithID:v17 kind:v16 context:v15 clientID:v14 productVariantID:v13 enableAppDistribution:v8];
...
+ (id)_requestWithID:(id)a3 kind:(id)a4 context:(id)a5 productVariantID:(id)a6
{
  ...
  v12 = a3;
  +[ASCEligibility assertCurrentProcessEligibility];
  v13 = [[ASCLockupRequest alloc] initWithID:v12 kind:v11 context:v10];
...
- (id)_initWithID:(id)a3 kind:(id)a4 context:(id)a5 includeUnlistedApps:(BOOL)a6
{
  ...
  if (v6)
  {
    v9 = [(ASCLockupRequest *)v7 lockupRequestWithUnlistedAppsIncluded];
  }
...
+ (id)_requestWithID:(id)a3 kind:(id)a4 context:(id)a5 includeUnlistedApps:(BOOL)a6
{
  ...
  v10 = a4;
  v11 = a3;
  v12 = [[ASCLockupRequest alloc] _initWithID:v11 kind:v10 context:v9 includeUnlistedApps:v6];
