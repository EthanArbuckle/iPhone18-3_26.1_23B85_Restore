...
- (ASCAdTransparencyContainerView)initWithCoder:(id)coder;
- (ASCAdTransparencyContainerView)initWithFrame:(CGRect)frame;
...
+ (id)developerNameFontCompatibleWithTraitCollection:(id)collection
{
  ...
  [__ASCLayoutProxy adTransparencyDeveloperNamePointSizeProvider:preferredContentSizeCategory];
  v5 = v4;
...
- (ASCAdTransparencyContainerView)initWithFrame:(CGRect)frame
{
  ...
  v3 = [(ASCAdTransparencyContainerView *)&v17 initWithFrame:frame.origin.x, frame.origin.y, frame.size.width, frame.size.height];
  v4 = v3;
  if (v3)
  {
    ...
    [(ASCAdTransparencyContainerView *)v4 setBackgroundColor:clearColor];
    ...
    [(UILabel *)v11 setTextColor:grayColor];
...
- (BOOL)isBackgroundHidden
{
  backgroundView = [(ASCAdTransparencyContainerView *)self backgroundView];
  ...
  backgroundView2 = [(ASCAdTransparencyContainerView *)self backgroundView];
  isHidden = [backgroundView2 isHidden];
...
- (void)setBackgroundHidden:(BOOL)hidden
{
  ...
  else
  {
    ...
    backgroundView2 = [(ASCAdTransparencyContainerView *)self backgroundView];
    [backgroundView2 setHidden:0];

    grayColor = [MEMORY[0x277D75348] whiteColor];
  }

  v14 = grayColor;
  titleLabel = [(ASCAdTransparencyContainerView *)self titleLabel];
...
- (void)setDeveloperName:(id)name
{
  ...
  if (nameCopy)
  {
    ...
    titleLabel2 = ASCLocalizedFormatString(@"DEVELOPER_NAME_TEXT");
    nameCopy = [v5 localizedStringWithFormat:titleLabel2, nameCopy];
    titleLabel = [(ASCAdTransparencyContainerView *)self titleLabel];
  ...
  {
    titleLabel2 = [(ASCAdTransparencyContainerView *)self titleLabel];
    [titleLabel2 setText:0];
  }

  developerName = self->_developerName;
  self->_developerName = nameCopy;
...
- (CGSize)sizeThatFits:(CGSize)fits
{
  ...
  v9 = v8;
  adTransparencyButton = [(ASCAdTransparencyContainerView *)self adTransparencyButton];
  [adTransparencyButton sizeThatFits:{width, height}];
  v12 = v11;
  v14 = v13;
...
- (void)layoutSubviews
{
  ...
  v63 = v13;
  adTransparencyButton = [(ASCAdTransparencyContainerView *)self adTransparencyButton];
  [adTransparencyButton sizeThatFits:{v8, v10}];
  v16 = v15;
  v18 = v17;

  asc_layoutTraitEnvironment = [(UIView *)self asc_layoutTraitEnvironment];
  [__ASCLayoutProxy rectWithLayoutDirectionForRect:asc_layoutTraitEnvironment inTraitEnvironment:v11 relativeTo:v11, v16, v18, v4, v6, v8, v10];
  v66 = v6;
  v67 = v4;
  v21 = v20;
  v23 = v22;
  ...
  v65 = v10;
  v27 = v26;
  adTransparencyButton2 = [(ASCAdTransparencyContainerView *)self adTransparencyButton];
  [adTransparencyButton2 setFrame:{v21, v23, v25, v27}];
  ...
  titleLabel = [(ASCAdTransparencyContainerView *)self titleLabel];
  [(ASCAdTransparencyContainerView *)self bounds];
  [titleLabel sizeThatFits:{v29, v31}];
  v33 = v32;
  v35 = v34;
  ...
  asc_layoutTraitEnvironment2 = [(UIView *)self asc_layoutTraitEnvironment];
  [__ASCLayoutProxy rectWithLayoutDirectionForRect:asc_layoutTraitEnvironment2 inTraitEnvironment:v36 relativeTo:v38, v29, v35, v67, v66, v8, v65];
  v41 = v40;
  v43 = v42;
  v44 = v8;
  v46 = v45;
  v48 = v47;
  titleLabel2 = [(ASCAdTransparencyContainerView *)self titleLabel];
  [titleLabel2 setFrame:{v41, v43, v46, v48}];
  ...
  asc_layoutTraitEnvironment3 = [(UIView *)self asc_layoutTraitEnvironment];
  [__ASCLayoutProxy rectWithLayoutDirectionForRect:asc_layoutTraitEnvironment3 inTraitEnvironment:0.0 relativeTo:0.0, v51, v65, v67, v66, v44, v65];
  v54 = v53;
  v56 = v55;
  v58 = v57;
  v60 = v59;
  backgroundView = [(ASCAdTransparencyContainerView *)self backgroundView];
  [backgroundView setFrame:{v54, v56, v58, v60}];
}
...
- (void)addAdTransparencyTarget:(id)target action:(SEL)action
{
  targetCopy = target;
  adTransparencyButton = [(ASCAdTransparencyContainerView *)self adTransparencyButton];
  [adTransparencyButton addTarget:targetCopy action:action forControlEvents:64];
}

- (void)updateFont
{
  titleLabel = [(ASCAdTransparencyContainerView *)self titleLabel];
  traitCollection = [(ASCAdTransparencyContainerView *)self traitCollection];
  v4 = [ASCAdTransparencyContainerView developerNameFontCompatibleWithTraitCollection:traitCollection];
