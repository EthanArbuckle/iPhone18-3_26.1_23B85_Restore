...
- (void)encodeWithCoder:(id)a3
{
  ...
  [v4 encodeInteger:-[ASCAppDistributionOffer flags](self forKey:{"flags"), @"flags"}];
  v8 = [(ASCAppDistributionOffer *)self ageRating];
  ...
  v11 = [(ASCAppDistributionOffer *)self distributorId];
...
- (ASCAppDistributionOffer)offerWithMetrics:(id)a3
{
  ...
  v8 = [(ASCAppDistributionOffer *)self subtitles];
  v9 = [(ASCAppDistributionOffer *)self flags];
  v10 = [(ASCAppDistributionOffer *)self ageRating];
  v11 = [(ASCAppDistributionOffer *)self appVersionId];
  v12 = [(ASCAppDistributionOffer *)self distributorId];
  v13 = [v5 initWithID:v6 titles:v7 subtitles:v8 flags:v9 ageRating:v10 metrics:v4 appVersionId:v11 distributorId:v12];
...
- (unint64_t)hash
{
  ...
  v5 = [(ASCAppDistributionOffer *)self titles];
  ...
  v8 = [(ASCAppDistributionOffer *)self metrics];
  [(ASCHasher *)v3 combineObject:v8];

  v9 = [(ASCAppDistributionOffer *)self appVersionId];
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (v7)
  {
    ...
    if (v8 && v9)
    {
      ...
      {
LABEL_10:
        v11 = [(ASCAppDistributionOffer *)self titles];
        v12 = [v7 titles];
        v13 = v12;
        if (v11 && v12)
        {
...
LABEL_13:
            ...
            v18 = [(ASCAppDistributionOffer *)self flags];
            if (v18 == [v7 flags])
            {
              v19 = [(ASCAppDistributionOffer *)self ageRating];
              v20 = [v7 ageRating];
              v21 = v20;
              v47 = v19;
              if (v19 && v20)
...
LABEL_27:
                  v45 = v21;
                  v25 = [(ASCAppDistributionOffer *)self metrics];
                  v26 = [v7 metrics];
                  v27 = v26;
                  v46 = v25;
                  if (v25 && v26)
...
LABEL_30:
                      v43 = v27;
                      v30 = [(ASCAppDistributionOffer *)self appVersionId];
                      v31 = [v7 appVersionId];
                      v32 = v31;
                      v44 = v30;
                      if (v30 && v31)
                      ...
                      {
LABEL_33:
                        v35 = [(ASCAppDistributionOffer *)self distributorId];
                        v36 = [v7 distributorId];
                        v37 = v36;
                        if (v35 && v36)
                        {
                          v38 = v36;
