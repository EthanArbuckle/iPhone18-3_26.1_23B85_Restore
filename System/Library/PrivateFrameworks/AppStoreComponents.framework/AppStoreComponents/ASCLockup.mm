...
- (void)_buyParamsWithCompletionBlock:(id)block
{
  ...
  if ([MEMORY[0x277CEE620] BOOLForEntitlement:@"com.apple.private.appstorecomponents.lockup-buy-params"])
  {
    ...
    if (!v5)
    {
      ...
      v36 = @"Missing lockup app offer data.";
      v19 = [MEMORY[0x277CBEAC0] dictionaryWithObjects:&v36 forKeys:&v35 count:1];
      v20 = [v18 initWithDomain:@"ASCLockupBuyParamsErrorDomain" code:1 userInfo:v19];
...
LABEL_11:
    ...
    {
      *buf = 0;
      _os_log_impl(&dword_21571A000, MEMORY[0x277D86220], OS_LOG_TYPE_INFO, "Not decorating metricsBuyParams because they were nil.", buf, 2u);
    }
  ...
  else
  {
    ...
    v17 = [v15 initWithDomain:@"ASCLockupBuyParamsErrorDomain" code:0 userInfo:v16];
