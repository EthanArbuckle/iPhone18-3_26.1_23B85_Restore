...
+ (id)lockupBatchRequestsFromRequests:(id)a3
{
  ...
  v6 = [v3 firstObject];
  v51 = [v6 enableAppDistribution];

  v7 = [v3 firstObject];
  v49 = [v7 mediaQueryParams];
...
LABEL_31:
            ...
            v41 = [v14 clientID];
            v42 = [v40 stringWithFormat:@"Requests with different clientID cannot be included in batch request: %@ != %@", v41, v5];

            goto LABEL_36;
          }
        }

        if (v51 != [v14 enableAppDistribution])
        {
          v42 = [MEMORY[0x277CCACA8] stringWithFormat:@"Requests with different AppDistribution options cannot be included in batch request: %d != %d", objc_msgSend(v14, "enableAppDistribution"), v51];
          goto LABEL_36;
        }
...
LABEL_32:
            ...
            v44 = [v14 platformOverride];
            [v43 stringWithFormat:@"Requests with different platformOverride options cannot be included in batch request: %@ != %@", v44, v9];
            goto LABEL_34;
          }
        }
...
LABEL_33:
            ...
            v44 = [v14 countryCodeOverride];
            [v45 stringWithFormat:@"Requests with different countryCodeOverride options cannot be included in batch request: %@ != %@", v44, v11];
            v42 = LABEL_34:;
