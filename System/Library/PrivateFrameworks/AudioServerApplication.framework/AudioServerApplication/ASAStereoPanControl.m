...
{
  v4 = a3;
  if (![(ASAObject *)self setMainGlobalProperty:1936745334 withData:&v4 ofSize:4 withQualifier:0 ofSize:0]&& os_log_type_enabled(MEMORY[0x277D86220], OS_LOG_TYPE_DEFAULT))
  {
    *v3 = 0;
