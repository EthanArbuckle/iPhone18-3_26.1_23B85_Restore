...
- (CLPOutdoorEstimatorLogEntryNotification)initWithCoder:(id)a3
{
  ...
  {
    v6 = objc_opt_class();
    v11 = objc_msgSend_decodeObjectOfClass_forKey_(v4, v7, v8, v9, v10, v6, @"outdoorEstimatorLogEntry");
    v12 = v11;
...
- (void)encodeWithCoder:(id)a3
{
  ...
  v9 = ;
  objc_msgSend_encodeObject_forKey_(v14, v10, v11, v12, v13, v9, @"outdoorEstimatorLogEntry");
}
