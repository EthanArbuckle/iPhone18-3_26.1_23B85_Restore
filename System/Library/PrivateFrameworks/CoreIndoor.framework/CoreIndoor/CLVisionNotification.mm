...
- (CLVisionNotification)initWithCoder:(id)coder
{
  ...
  if (v6)
  {
    v6->_arSessionState = objc_msgSend_decodeIntForKey_(coderCopy, v5, v7, v8, v9, @"arSessionState");
    v6->_notificationType = objc_msgSend_decodeIntForKey_(coderCopy, v10, v11, v12, v13, @"notificationType");
    v14 = objc_opt_class();
    v19 = objc_msgSend_decodeObjectOfClass_forKey_(coderCopy, v15, v16, v17, v18, v14, @"vioEstimation");
    v20 = v19;
...
LABEL_6:
    ...
    *(&v6->_serializedVIOEstimation.__rep_.__l + 2) = v54;
    v32 = objc_opt_class();
    v37 = objc_msgSend_decodeObjectOfClass_forKey_(coderCopy, v33, v34, v35, v36, v32, @"vlLocalizationResult");
...
{
  coderCopy = coder;
  objc_msgSend_encodeInt_forKey_(coderCopy, v4, v5, v6, v7, LODWORD(self->_arSessionState), @"arSessionState");
  objc_msgSend_encodeInt_forKey_(coderCopy, v8, v9, v10, v11, self->_notificationType, @"notificationType");
  ...
  v17 = ;
  objc_msgSend_encodeObject_forKey_(coderCopy, v18, v19, v20, v21, v17, @"vioEstimation");
  ...
  v27 = ;
  objc_msgSend_encodeObject_forKey_(coderCopy, v28, v29, v30, v31, v27, @"vlLocalizationResult");
}
