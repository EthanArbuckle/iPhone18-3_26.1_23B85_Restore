...
- (CLGpsPosition)initWithCoder:(id)a3
{
  ...
  if (v5)
  {
    ...
    *(v5 + 1) = v15[0];
    *(v5 + 2) = v12;
    sub_245A85850(v4, v15);
    memcpy(v5 + 176, v15, 0x230uLL);
    *(v5 + 1) = sub_245A8598C(v4);
    v13 = v5;
  }
...
{
  v13 = a3;
  sub_245A39754(v13, v4, v5, v6);
  sub_245A39740(v13, v7, v8, v9);
  sub_245A39730(v13, &self->_expiry, v10, v11, v12);
}
