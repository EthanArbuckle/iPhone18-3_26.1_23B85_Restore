...
- (id)columns
{
  ...
  if (!columns)
  {
    ...
    v5 = [ML3DatabaseColumn columnWithName:@"item_pid" datatype:2 constraints:16 defaultValue:&unk_2840CA400, v4];
    v10[1] = v5;
    v6 = [ML3DatabaseColumn columnWithName:@"seed_order" datatype:2 constraints:16 defaultValue:&unk_2840CA400];
    v10[2] = v6;
