...
- (void)mergeFrom:(id)from
{
  ...
  {
    v5 = fromCopy;
    [(MSPMediaSyncError *)self setErrorDescription:?];
    fromCopy = v5;
  }
...
- (unint64_t)hash
{
  v3 = [(NSString *)self->_errorDescription hash];
  if (*&self->_has)
  {
...
- (BOOL)isEqual:(id)equal
{
  ...
  if (*&self->_has)
  {
    if ((*(equalCopy + 24) & 1) != 0 && self->_errorCode == *(equalCopy + 2))
    {
      v6 = 1;
      goto LABEL_9;
    }
...
- (id)copyWithZone:(_NSZone *)zone
{
  ...
  v6 = [(NSString *)self->_errorDescription copyWithZone:zone];
  v7 = *(v5 + 16);
  *(v5 + 16) = v6;
...
- (id)description
{
  ...
  v8.receiver = self;
  v8.super_class = MSPMediaSyncError;
  v4 = [(MSPMediaSyncError *)&v8 description];
  dictionaryRepresentation = [(MSPMediaSyncError *)self dictionaryRepresentation];
