...
- (BOOL)registerWithConnection:(id)connection
{
  ...
  if (self->_block)
  {
    ...
    LODWORD(_sqliteHandle) = sqlite3_create_function_v2(_sqliteHandle, [name UTF8String], -[ML3DatabaseFunction argumentCount](self, "argumentCount"), 2049, self, _ML3DatabaseFunctionRunBlock, 0, 0, 0);
