...
- (PCSUserRegistry)initWithBackup:(id)backup
{
  ...
  if (v6)
  {
    ...
    v9 = [CKContainer containerIDForContainerIdentifier:off_100040628];
...
- (void)registerCloudKitNotifications
{
  ...
  block[1] = 3221225472;
  block[2] = sub_100001FFC;
  block[3] = &unk_100038C08;
  block[4] = self;
  objc_copyWeak(&v5, &location);
  if (qword_100040708 != -1)
  {
    dispatch_once(&qword_100040708, block);
  }
...
- (id)keyRecordIdentity:(_PCSIdentityData *)identity device:(id)device version:(id)version
{
  ...
  recordName = [recordID recordName];
  v10 = sub_10000874C(identity, recordName, versionCopy);
...
- (id)extractMobilebackupKeyEscrow:(id)escrow
{
  ...
  if (v6)
  {
    v7 = v6;
    v8 = *v26;
    v9 = &NRDeviceSizeForProductType_ptr;
    do
    {
      for (i = 0; i != v7; i = i + 1)
      {
