...
- (PSUIQRCodeGroup)initWithListController:(id)a3 groupSpecifier:(id)a4
{
  ...
  v7 = a4;
  v16.receiver = self;
  v16.super_class = PSUIQRCodeGroup;
  ...
  if (v8)
  {
    ...
    v13 = [v12 localizedStringForKey:@"USE_QR_CODE_FOOTER" value:&stru_287733598 table:@"Cellular"];
...
- (id)specifiers
{
  ...
  v6 = [v5 localizedStringForKey:@"USE_QR_CODE" value:&stru_287733598 table:@"Cellular"];
...
void __37__PSUIQRCodeGroup_scanQRCodePressed___block_invoke(uint64_t a1, void *a2)
{
  ...
  else
  {
    ...
    {
      *v12 = 0;
      _os_log_error_impl(&dword_2658DE000, v9, OS_LOG_TYPE_ERROR, "Invalid PSUIQRCodeGroup", v12, 2u);
    }
  }
}
