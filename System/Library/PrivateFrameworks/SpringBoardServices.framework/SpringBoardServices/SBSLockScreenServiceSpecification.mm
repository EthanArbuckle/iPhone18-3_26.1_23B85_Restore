...
+ (BSServiceInterface)interface
{
  ...
  {
    dispatch_once(&interface_onceToken_3, block);
  }

  v2 = interface___interface_3;
...
void __46__SBSLockScreenServiceSpecification_interface__block_invoke(uint64_t a1)
{
  ...
  v3 = [MEMORY[0x1E698E710] protocolForProtocol:&unk_1F05C8988];
  [v6 setServer:v3];

  v4 = [v6 copy];
  v5 = interface___interface_3;
  interface___interface_3 = v4;
}
