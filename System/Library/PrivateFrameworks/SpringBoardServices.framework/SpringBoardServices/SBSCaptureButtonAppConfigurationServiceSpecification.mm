...
{
  v7 = [MEMORY[0x1E698E710] protocolForProtocol:&unk_1F05C45C0];
  v2 = [MEMORY[0x1E698E710] protocolForProtocol:&unk_1F05BB8E8];
  v3 = MEMORY[0x1E698F470];
  v4 = [*(a1 + 32) identifier];
  v5 = [v3 interfaceWithIdentifier:v4];
  v6 = interface___interface_15;
  interface___interface_15 = v5;

  [interface___interface_15 setServer:v7];
  [interface___interface_15 setClient:v2];
}
