...
+ (BSServiceInterface)interface
{
  ...
  {
    dispatch_once(&interface_onceToken_5, block);
  }

  v2 = interface___interface_5;
...
{
  v7 = [MEMORY[0x1E698E710] protocolForProtocol:&unk_1F05C3C20];
  v2 = [MEMORY[0x1E698E710] protocolForProtocol:&unk_1F05B7298];
  v3 = MEMORY[0x1E698F470];
  v4 = [*(a1 + 32) identifier];
  v5 = [v3 interfaceWithIdentifier:v4];
  v6 = interface___interface_5;
  interface___interface_5 = v5;

  [interface___interface_5 setServer:v7];
  [interface___interface_5 setClient:v2];
}
