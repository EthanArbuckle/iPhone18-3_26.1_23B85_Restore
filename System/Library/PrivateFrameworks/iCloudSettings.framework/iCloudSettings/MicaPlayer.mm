...
- (id)copyWithZone:(void *)zone
{
  ...
  sub_2758607AC();
  v12 = v11;
  v13 = sub_2758647C4(*(&selfCopy->super.isa + OBJC_IVAR____TtC14iCloudSettings10MicaPlayer_publishedObjects));
  (*(v5 + 16))(v8, selfCopy + OBJC_IVAR____TtC14iCloudSettings10MicaPlayer_url, v4);
