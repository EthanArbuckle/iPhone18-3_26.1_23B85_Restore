...
- (ICSBackupFooterView)initWithSpecifier:(id)specifier;
@end
...
- (ICSBackupFooterView)initWithSpecifier:(id)specifier
{
  ...
  v16.receiver = self;
  v16.super_class = ICSBackupFooterView;
  v5 = [(PSFooterHyperlinkView *)&v16 initWithSpecifier:specifierCopy];
  if (v5)
  {
    v6 = [MEMORY[0x277CCA8D8] bundleForClass:objc_opt_class()];
    v7 = [v6 localizedStringForKey:@"BACKUPS_INFO_LEARN_MORE" value:&stru_288487370 table:@"Localizable-Backup"];
