...
- (uint64_t)shouldShowDataclass:()iCloudSettings forAccount:
{
  v6 = a3;
  v7 = a4;
  if ([MEMORY[0x277CEC7B8] isMultiUserMode] & 1) != 0 || (objc_msgSend(MEMORY[0x277CEC7A0], "sharedManager"), v8 = objc_claimAutoreleasedReturnValue(), v9 = objc_msgSend(v8, "isSystemAppMCRestrictedOrRemovedForDataclass:forAccount:", v6, v7), v8, (v9) || (objc_msgSend(self, "_isHiddenDataclass:", v6) & 1) != 0 || objc_msgSend(v6, "isEqualToString:", *MEMORY[0x277CB8A38]) && (objc_msgSend(v7, "isProvisionedForDataclass:", *MEMORY[0x277CB89D0]) & 1) != 0 || (objc_msgSend(self, "isAppRestrictedOnThisDevice:", v6))
  {
    v10 = 0;
  }
...
- (uint64_t)appIsNeitherInstalledOrPlaceholder:()iCloudSettings
{
  ...
  v6 = [sharedManager appBundleIdentifierForDataclass:v4];
