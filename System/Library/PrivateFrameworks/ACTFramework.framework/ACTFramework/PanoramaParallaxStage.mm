...
- (int)_applyWarpToSlice:(id)slice chroma:(id)chroma mask:(id)mask preFlow:(id)flow warpedLuma:(id)luma warpedChroma:(id)warpedChroma warpedMask:(id)warpedMask
{
  ...
  objc_msgSend_setTexture_atIndex_(v35, v46, sliceCopy, 0);
  objc_msgSend_setTexture_atIndex_(v35, v47, chromaCopy, 1);
  objc_msgSend_setTexture_atIndex_(v35, v48, maskCopy, 2);

  objc_msgSend_setTexture_atIndex_(v35, v49, flowCopy, 3);
  objc_msgSend_setTexture_atIndex_(v35, v50, lumaCopy, 4);

  objc_msgSend_setTexture_atIndex_(v35, v51, warpedChromaCopy, 5);
  objc_msgSend_setTexture_atIndex_(v35, v52, warpedMaskCopy, 6);

  v56 = objc_msgSend_width(chromaCopy, v53, v54, v55);
  v60 = objc_msgSend_height(chromaCopy, v57, v58, v59);
...
- (uint64_t)_computePreShift:(simd_float3)shift homography:(simd_float3)homography
{
  ...
  *&v63 = v65.columns[2].i64[0];
  v11 = objc_msgSend_commandQueue(self[1], v8, v9, v10);
  ...
  v25 = objc_msgSend_computePreShifts(self[2], v22, v23, v24);
  getThreadgroupSizeForShader(v25, &v59);

  v29 = objc_msgSend_computePreShifts(self[2], v26, v27, v28);
  objc_msgSend_setComputePipelineState_(v21, v30, v29, v31);

  objc_msgSend_setTexture_atIndex_(v21, v32, v7, 0);
  v35 = objc_msgSend_objectAtIndexedSubscript_(self[5], v33, 0, v34);
...
- (PanoramaParallaxStage)initWithContext:(id)context bitDepth:(int)depth
{
  ...
  v9 = v8;
  if (v8 && (objc_storeStrong(&v8->_metal, context), v10 = [PanoramaParallaxStageShaders alloc], v13 = objc_msgSend_initWithContext_(v10, v11, contextCopy, v12), shaders = v9->_shaders, v9->_shaders = v13, shaders, v9->_shaders))
  {
...
LABEL_9:
  ...
  {
    v23 = objc_msgSend_texture2DDescriptorWithPixelFormat_width_height_mipmapped_(MEMORY[0x277CD7058], v14, self->_MTLPixelFormatY, width >> 1, height >> 1, 0);
...
- (int)_allocateShiftPyramidLike:(id)like
{
  ...
  v36 = objc_msgSend_width(likeCopy, v33, v34, v35);
  v40 = objc_msgSend_height(likeCopy, v37, v38, v39);
...
- (uint64_t)addSlice:(double)slice mask:(double)mask homography:(uint64_t)homography residualFlow:(__CVBuffer *)flow
{
  ...
  v15 = objc_msgSend_prepareToProcessSliceWidth_sliceHeight_(self, v14, Width, Height);
  if (v15)
  {
    v35 = v15;
    v18 = 0;
  ...
  v18 = objc_msgSend_bindPixelBufferToMTL2DTexture_pixelFormat_usage_plane_(*(self + 8), v16, flow, *(self + 48), 1, 0);
  if (!v18)
  {
    v20 = 0;
    goto LABEL_13;
  ...
  v20 = objc_msgSend_bindPixelBufferToMTL2DTexture_pixelFormat_usage_plane_(*(self + 8), v17, flow, *(self + 56), 1, 1);
  if (!v20)
  {
LABEL_13:
    v23 = 0;
  ...
  v23 = objc_msgSend_bindPixelBufferToMTL2DTexture_pixelFormat_usage_plane_(*(self + 8), v19, a8, 65, 1, 0);
  if (!v23)
  {
LABEL_14:
    v35 = 3;
  ...
  ShiftPyramidLike = objc_msgSend__allocateShiftPyramidLike_(self, v21, v23, v22);
  if (ShiftPyramidLike || (ShiftPyramidLike = objc_msgSend__computePreShift_homography_(self, v25, v23, v26, a2, slice, mask), ShiftPyramidLike) || (ShiftPyramidLike = objc_msgSend__buildShiftPyramid(self, v27, v28, v29), ShiftPyramidLike))
  {
  ...
  {
    v33 = objc_msgSend_lastObject(*(self + 40), v30, v31, v32);
    v35 = objc_msgSend__applyWarpToSlice_chroma_mask_preFlow_warpedLuma_warpedChroma_warpedMask_(self, v34, v18, v20, v11, v33, *(self + 24), *(self + 32), *(self + 104));
  }
