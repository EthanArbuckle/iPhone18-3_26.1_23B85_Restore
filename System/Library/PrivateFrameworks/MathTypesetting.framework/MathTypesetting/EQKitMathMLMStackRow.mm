...
{
  {
    std::set<EQKitTypes::Attributes::Enum>::set[abi:ne200100]<EQKitTypes::Attributes::Enum const*>(-[EQKitMathMLMStackRow mathMLAttributes]::sAttributesSet, &-[EQKitMathMLMStackRow mathMLAttributes]::sAttributesData, -[EQKitMathMLMStyle mathMLAttributes]::sAttributesDataInherited);
  }
