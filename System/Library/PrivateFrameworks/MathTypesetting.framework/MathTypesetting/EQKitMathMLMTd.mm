...
{
  {
    std::set<EQKitTypes::Attributes::Enum>::set[abi:ne200100]<EQKitTypes::Attributes::Enum const*>(-[EQKitMathMLMTd mathMLAttributes]::sAttributesSet, &-[EQKitMathMLMTd mathMLAttributes]::sAttributesData, &-[EQKitMathMLMText mathMLAttributes]::sAttributesData);
  }
