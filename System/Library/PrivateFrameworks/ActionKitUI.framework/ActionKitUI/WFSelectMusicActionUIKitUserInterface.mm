...
- (void)showWithSelectMultiple:(BOOL)multiple completionHandler:(id)handler;
@end
...
- (void)finishWithOutput:(id)output error:(id)error
{
  outputCopy = output;
  errorCopy = error;
  completionHandler = [(WFSelectMusicActionUIKitUserInterface *)self completionHandler];

  if (completionHandler)
  {
    completionHandler2 = [(WFSelectMusicActionUIKitUserInterface *)self completionHandler];
...
- (void)showWithSelectMultiple:(BOOL)multiple completionHandler:(id)handler
{
  ...
  if (!handlerCopy)
  {
    ...
    [currentHandler handleFailureInMethod:a2 object:self file:@"WFSelectMusicActionUIKitUserInterface.m" lineNumber:30 description:{@"Invalid parameter not satisfying: %@", @"completionHandler"}];
  }

  [(WFSelectMusicActionUIKitUserInterface *)self setCompletionHandler:handlerCopy];
