...
- (WFAudioInputViewController)initWithNibName:(id)name bundle:(id)bundle;
- (void)loadView;
@end
...
- (void)loadView
{
  ...
  [contentView2 setContentHuggingPriority:1 forAxis:v7];
  ...
  [contentView2 addConstraints:v19];
}
...
- (WFAudioInputViewController)initWithNibName:(id)name bundle:(id)bundle
{
  ...
  v4 = [(WFAudioInputViewController *)&v8 initWithNibName:name bundle:bundle];
  v5 = v4;
  if (v4)
  {
