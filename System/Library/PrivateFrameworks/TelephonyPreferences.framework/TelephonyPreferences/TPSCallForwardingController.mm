...
- (void)updateServiceType:(int64_t)a3
{
  ...
  if (v5 != a3)
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_DEFAULT))
    {
      ...
      v9 = [MEMORY[0x277CCACA8] tps_stringWithTPSCallForwardingServiceType:a3];
      v11 = 138412546;
      v12 = v8;
      v13 = 2112;
      v14 = v9;
...
- (NSArray)conditionalServiceRequests
{
  ...
  if (!conditionalServiceRequests)
  {
    ...
    v6 = [(TPSCallForwardingRequest *)v4 initWithSubscriptionContext:v5 reason:1];
    ...
    v12 = [(TPSCallForwardingRequest *)v10 initWithSubscriptionContext:v11 reason:3];
    v17[2] = v12;
...
- (NSString)conditionalServiceBusyPhoneNumber
{
  ...
  v6 = TPSLocalizedPhoneNumberString(v4, v5);
...
- (void)setConditionalServiceBusyPhoneNumber:(id)a3
{
  ...
  if (v5)
  {
    ...
    v7 = TPSNormalizedPhoneNumberString(v4, v6);
...
- (NSArray)unconditionalServiceRequests
{
  ...
  if (!unconditionalServiceRequests)
  {
    v4 = [TPSCallForwardingRequest alloc];
    v5 = [(TPSCallForwardingController *)self subscriptionContext];
    v6 = [(TPSCallForwardingRequest *)v4 initWithSubscriptionContext:v5 reason:0];
    v11[0] = v6;
...
- (void)sendSetRequestForValue:(id)a3
{
  ...
  v8 = [(TPSSetCallForwardingRequest *)v5 initWithSubscriptionContext:v6 value:v4];
