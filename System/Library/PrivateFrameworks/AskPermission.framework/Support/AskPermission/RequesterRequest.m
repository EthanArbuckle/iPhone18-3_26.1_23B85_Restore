...
- (id)compile
{
  ...
  v6 = [(RequesterRequest *)self uniqueIdentifier];
...
- (NSString)description
{
  v3 = [(RequesterRequest *)self compile];
  v4 = [(RequesterRequest *)self ap_generateDescriptionWithSubObjects:v3];
