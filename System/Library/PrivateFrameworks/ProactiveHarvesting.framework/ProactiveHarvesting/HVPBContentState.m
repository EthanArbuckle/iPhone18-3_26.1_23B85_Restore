  ...
  if (v6)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        [(HVPBContentState *)self addConsumers:*(*(&v11 + 1) + 8 * v9++), v11];
      }
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (*&self->_has)
  {
    if ((*(v4 + 20) & 1) != 0 && self->_levelOfService == *(v4 + 4))
    {
      v6 = 1;
      goto LABEL_9;
    }
...
- (void)copyTo:(id)a3
{
  ...
  {
    [v8 clearConsumers];
    v4 = [(HVPBContentState *)self consumersCount];
    if (v4)
    {
      v5 = v4;
      for (i = 0; i != v5; ++i)
...
- (id)description
{
  ...
  v5 = [(HVPBContentState *)self dictionaryRepresentation];
