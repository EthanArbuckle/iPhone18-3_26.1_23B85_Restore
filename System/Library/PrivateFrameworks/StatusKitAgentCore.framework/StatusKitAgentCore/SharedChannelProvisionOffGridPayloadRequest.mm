...
- (id)description
{
  ...
  dictionaryRepresentation = [(SharedChannelProvisionOffGridPayloadRequest *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  {
    dictionaryRepresentation2 = [(ChannelDeferredPublishInfo *)channelDeferredPublishInfo dictionaryRepresentation];
    [dictionary setObject:dictionaryRepresentation2 forKey:@"channel_deferred_publish_info"];
  }
...
- (id)copyWithZone:(_NSZone *)zone
{
  ...
  v8 = [(ChannelDeferredPublishInfo *)self->_channelDeferredPublishInfo copyWithZone:zone];
  v9 = v5[2];
  v5[2] = v8;
...
- (BOOL)isEqual:(id)equal
{
  ...
  {
    channelDeferredPublishInfo = self->_channelDeferredPublishInfo;
    if (channelDeferredPublishInfo | equalCopy[2])
    {
