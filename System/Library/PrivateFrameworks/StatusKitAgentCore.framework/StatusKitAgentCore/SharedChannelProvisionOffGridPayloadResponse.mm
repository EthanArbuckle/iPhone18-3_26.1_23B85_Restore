...
- (id)description
{
  ...
  v8.receiver = self;
  v8.super_class = SharedChannelProvisionOffGridPayloadResponse;
  v4 = [(SharedChannelProvisionOffGridPayloadResponse *)&v8 description];
  dictionaryRepresentation = [(SharedChannelProvisionOffGridPayloadResponse *)self dictionaryRepresentation];
