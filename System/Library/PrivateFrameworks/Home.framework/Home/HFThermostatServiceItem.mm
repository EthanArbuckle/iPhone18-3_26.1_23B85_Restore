...
- (id)createControlItemsWithOptions:(id)a3
{
  ...
  v10 = [(HFTemperatureThresholdControlItem *)v7 initWithValueSource:v6 displayResults:v9];

  v11 = v10;
  [v5 na_safeAddObject:v10];
  v12 = [HFSimpleIncrementalControlItem alloc];
  v13 = [(HFSimpleIncrementalControlItem *)v12 initWithValueSource:v6 characteristicType:*MEMORY[0x277CCFB58] displayResults:0];
  [v5 addObject:v13];
  v14 = [HFTemperatureUnitControlItem alloc];
  v42 = [(HFTemperatureUnitControlItem *)v14 initWithValueSource:v6 characteristicType:*MEMORY[0x277CCFB88] displayResults:0];
  [v5 addObject:?];
  ...
  v41 = v17;
  v18 = [[HFMultiStateValueSet alloc] initWithCharacteristicMetadata:v17];
  v53 = @"title";
  v19 = HFItemOptionalLocalizedString(@"HFServiceThermostatModeOff", v4);
  v54 = v19;
  ...
  v51 = @"title";
  v21 = HFItemOptionalLocalizedString(@"HFServiceThermostatModeHeat", v4);
  v52 = v21;
  ...
  v49 = @"title";
  v23 = HFItemOptionalLocalizedString(@"HFServiceThermostatModeCool", v4);
  v50 = v23;
  ...
  v47 = @"title";
  v25 = HFItemOptionalLocalizedString(@"HFServiceThermostatModeAuto", v4);
  v48 = v25;
  ...
  v27 = [(HFMultiStateValueSet *)v18 allValues];
  v28 = [v27 count];
  ...
  if (v28 >= 2)
  {
    ...
    if ([(HFMultiStateValueSet *)v18 count]== 2)
    {
      ...
      v45[0] = @"title";
      v32 = HFItemOptionalLocalizedString(@"HFControlShortTitleHeatingCoolingMode", v4);
      v45[1] = @"controlItemPurpose";
      v46[0] = v32;
      v46[1] = &unk_282523460;
      [MEMORY[0x277CBEAC0] dictionaryWithObjects:v46 forKeys:v45 count:2];
      v34 = v33 = v11;
      v35 = [(HFPrimaryStateControlItem *)v31 initWithValueSource:v6 characteristicType:v40 valueTransformer:v30 displayResults:v34];
    ...
    else
    {
      ...
      v35 = [(HFMultiStateControlItem *)v36 initWithValueSource:v6 characteristicType:v40 possibleValueSet:v18 displayResults:v32];
    }
