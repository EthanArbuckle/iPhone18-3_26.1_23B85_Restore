...
- (MTCompanionSyncSession)initWithSession:(id)a3 request:(id)a4 delegate:(id)a5
{
  ...
  if (v12)
  {
    ...
    if ([v9 isSending])
    {
      ...
      v19 = [WeakRetained pendingChanges];
      pendingChanges = v13->_pendingChanges;
      v13->_pendingChanges = v19;
...
- (void)syncSession:(id)a3 didEndWithError:(id)a4
{
  ...
  if (v6)
  {
    ...
    {
      [(MTCompanionSyncSession *)self syncSession:v6 didEndWithError:v9];
    }
...
- (NSString)description
{
  ...
  v4 = objc_opt_class();
  v5 = [(MTCompanionSyncSession *)self sessionDescription];
