...
+ (id)predicateForContextStoreRegistration
{
  ...
  v7 = [v3 predicateForKeyPath:v2 withFormat:@"SUBQUERY(SELF.%@.value, $prediction, $prediction.%K = %@ AND $prediction.%K <= %@ AND $prediction.%K > %@).@count > 0", v2, v4, &unk_283A56A50, v5, &unk_283A56A68, v6, &unk_283A56A80];
