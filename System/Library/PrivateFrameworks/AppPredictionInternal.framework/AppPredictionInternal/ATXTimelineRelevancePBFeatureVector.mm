...
- (void)writeTo:(id)a3
{
  ...
  if ((has & 2) != 0)
  {
    appLaunchPopularity = self->_appLaunchPopularity;
  ...
  if (has)
  {
    appLaunchCount = self->_appLaunchCount;
    PBDataWriterWriteInt64Field();
    v4 = v8;
  }
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ((*&self->_has & 2) != 0)
  {
    if ((*(v4 + 24) & 2) == 0 || self->_appLaunchPopularity != *(v4 + 2))
    {
      goto LABEL_11;
    }
  }
...
LABEL_11:
  ...
  if (*&self->_has)
  {
    if ((*(v4 + 24) & 1) == 0 || self->_appLaunchCount != *(v4 + 1))
    {
      goto LABEL_11;
    }
...
- (void)mergeFrom:(id)a3
{
  ...
  if ((v5 & 2) != 0)
  {
    self->_appLaunchPopularity = *(v4 + 2);
    *&self->_has |= 2u;
    v5 = *(v4 + 24);
  }
