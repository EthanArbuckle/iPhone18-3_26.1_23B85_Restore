...
- (id)coreAnalyticsEvent
{
  ...
  v27 = [v4 numberWithInteger:{objc_msgSend(appLaunchCounts, "numAppLaunchPastDay")}];
  v36[6] = v27;
  v35[7] = @"numAppLaunchPast3Day";
  v5 = MEMORY[0x277CCABB0];
  appLaunchCounts2 = [(ATXNPlusOneStudyEvent *)self appLaunchCounts];
  v25 = [v5 numberWithInteger:{objc_msgSend(appLaunchCounts2, "numAppLaunchPast3Day")}];
  v36[7] = v25;
  v35[8] = @"numAppLaunchPast7Day";
  v6 = MEMORY[0x277CCABB0];
  appLaunchCounts3 = [(ATXNPlusOneStudyEvent *)self appLaunchCounts];
  v23 = [v6 numberWithInteger:{objc_msgSend(appLaunchCounts3, "numAppLaunchPast7Day")}];
  v36[8] = v23;
  v35[9] = @"numAppLaunchPast14Day";
  v7 = MEMORY[0x277CCABB0];
  appLaunchCounts4 = [(ATXNPlusOneStudyEvent *)self appLaunchCounts];
  v21 = [v7 numberWithInteger:{objc_msgSend(appLaunchCounts4, "numAppLaunchPast14Day")}];
  v36[9] = v21;
