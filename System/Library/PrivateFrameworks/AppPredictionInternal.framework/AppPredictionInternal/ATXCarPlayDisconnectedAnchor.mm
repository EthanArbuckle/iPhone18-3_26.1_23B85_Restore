...
+ (id)predicateForContextStoreRegistration
{
  ...
  v4 = [v2 predicateForKeyPath:keyPathForContextStore equalToValue:&unk_283A56B40];
...
+ (id)invalidationPredicateForContextStoreRegistration
{
  v2 = MEMORY[0x277CFE360];
  keyPathForContextStore = [objc_opt_class() keyPathForContextStore];
  v4 = [v2 predicateForKeyPath:keyPathForContextStore equalToValue:&unk_283A56B58];
