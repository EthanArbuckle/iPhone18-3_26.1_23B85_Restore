...
- (id)atxAction
{
  ...
  v15 = 0;
  v6 = [v3 unarchivedObjectOfClass:v4 fromData:interaction error:&v15];
  v7 = v15;
  ...
  if (v6)
  {
    ...
    LOBYTE(v14) = 0;
    v12 = [v8 initWithIntent:intent actionUUID:v10 bundleId:bundleID heuristic:0 heuristicMetadata:0 criteria:0 isFutureMedia:v14 title:0 subtitle:0];
  }
