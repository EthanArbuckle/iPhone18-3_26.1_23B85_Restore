...
- (void)_handleStatusKitAgentAliveNotification:(id)a3;
...
- (void)assertPresenceWithPresencePayload:(id)a3 assertionOptions:(id)a4 completion:(id)a5;
...
- (void)inviteHandle:(id)a3 fromSenderHandle:(id)a4 completion:(id)a5;
...
- (SKPresence)initWithPresenceIdentifier:(id)a3 options:(id)a4
{
  ...
  if (v9)
  {
    ValidateIdentifierMeetsBlastdoorRequirements(v6);
    v10 = [v6 copy];
    ...
    if (_os_feature_enabled_impl())
    {
      if ((_os_feature_enabled_impl() & 1) != 0 || (-[SKPresence options](v9, "options"), v22 = objc_claimAutoreleasedReturnValue(), v23 = [v22 isDaemonIdleExitEnabled], v22, v23))
      {
        ...
        {
          v25 = [(SKPresence *)v9 presenceIdentifier];
          *buf = 138412290;
          v40 = v25;
        ...
        v26 = [SKPresence clientPrefixedPresenceIdentifierForPresenceIdentifier:v6];
        ...
        if (v26)
        {
          if (os_log_type_enabled(v27, OS_LOG_TYPE_DEFAULT))
          {
            *buf = 138412290;
            v40 = v26;
            _os_log_impl(&dword_26BA07000, v28, OS_LOG_TYPE_DEFAULT, "Registering prefixed presenceIdentifier: %@", buf, 0xCu);
          }

          v28 = [MEMORY[0x277CCA9A0] defaultCenter];
          [v28 addObserver:v9 selector:sel__handleStatusKitAgentAliveNotification_ name:v26 object:0];
        }

        else if (os_log_type_enabled(v27, OS_LOG_TYPE_ERROR))
        {
          [(SKPresence *)v28 initWithPresenceIdentifier:v29 options:v30, v31, v32, v33, v34, v35];
        }
      }
    }
  }
...
+ (id)clientPrefixedPresenceIdentifierForPresenceIdentifier:(id)a3
{
  ...
  if (v3)
  {
    ...
    if (v4)
    {
      v6 = [v4 ska_sha256Hash];
      v7 = [v6 substringToIndex:4];

      v8 = [objc_alloc(MEMORY[0x277CCAB68]) initWithFormat:@"%@-%@-%@", v5, v3, v7];
    }
...
- (void)_handleStatusKitAgentAliveNotification:(id)a3
{
  ...
  v4 = [a3 object];
  v5 = [(SKPresence *)self presenceIdentifier];
...
- (void)hasInitialCloudKitImportOccurredWithCompletion:(id)a3
{
  ...
  v6 = [(SKPresence *)self daemonConnection];
...
- (void)assertPresenceWithPresencePayload:(id)a3 completion:(id)a4
{
  ...
  [(SKPresence *)self assertPresenceWithPresencePayload:v7 assertionOptions:v8 completion:v6];
}
...
- (void)assertPresenceWithPresencePayload:(id)a3 assertionOptions:(id)a4 completion:(id)a5
{
  ...
  v10 = a5;
  v11 = [v9 copy];
  v12 = [(SKPresence *)self presenceIdentifier];
  ...
  [(SKPresence *)self _registerForDelegateCallbacksIfNecessary];
  v14 = [(SKPresence *)self daemonConnection];
  ...
  v15 = v10;
  v29 = v15;
  v16 = [v14 asynchronousRemoteDaemonWithErrorHandler:v28];
...
- (void)releasePresenceWithCompletion:(id)a3
{
  ...
  [(SKPresence *)self _registerForDelegateCallbacksIfNecessary];
  v7 = [(SKPresence *)self daemonConnection];
  ...
  v8 = v4;
  v19 = v8;
  v9 = [v7 asynchronousRemoteDaemonWithErrorHandler:v18];
  objc_initWeak(buf, self);
...
- (void)retainTransientSubscriptionAssertionWithCompletion:(id)a3
{
  ...
  v9 = v4;
  v21 = v9;
  v10 = [v7 asynchronousRemoteDaemonWithErrorHandler:v20];
...
- (NSArray)presentDevices
{
  ...
  [(SKPresence *)self _registerForDelegateCallbacksIfNecessary];
  v3 = [(SKPresence *)self presenceIdentifier];
  v4 = +[SKPresence _logger];
  if (os_log_type_enabled(v4, OS_LOG_TYPE_DEFAULT))
  {
  ...
  *(&buf + 1) = &buf;
  ...
  v25 = 0;
  v5 = [(SKPresence *)self daemonConnection];
  objc_initWeak(&location, self);
  ...
  p_buf = &buf;
  v7 = [v5 synchronousRemoteDaemonWithErrorHandler:v16];
  v13[0] = MEMORY[0x277D85DD0];
  v13[1] = 3221225472;
...
- (BOOL)_isHandleInvited:(id)a3 fromSenderHandle:(id)a4
{
  ...
  *&buf[16] = 0x2020000000;
  LOBYTE(v26) = 0;
  v10 = [(SKPresence *)self daemonConnection];
  v22[0] = MEMORY[0x277D85DD0];
  v22[1] = 3221225472;
  ...
  v20 = v14;
  v21 = buf;
  [v12 isHandleInvited:v14 fromSenderHandle:v7 forPresenceIdentifier:v13 completion:v18];
  v15 = *(*&buf[8] + 24);
...
- (void)_isHandleInvited:(id)a3 fromSenderHandle:(id)a4 completion:(id)a5
{
  ...
  v10 = a5;
  [(SKPresence *)self _registerForDelegateCallbacksIfNecessary];
  v11 = [(SKPresence *)self presenceIdentifier];
  ...
  v13 = [(SKPresence *)self daemonConnection];
  ...
  v19 = v15;
  v20 = v14;
  [v17 isHandleInvited:v19 fromSenderHandle:v9 forPresenceIdentifier:v20 completion:v22];
...
- (void)_fetchHandleInvitability:(id)a3 fromSenderHandle:(id)a4 completion:(id)a5
{
  ...
  v17 = v11;
  v30 = v17;
  v18 = [v14 asynchronousRemoteDaemonWithErrorHandler:v27];
  ...
  v20 = v16;
  v21 = v15;
  [v18 fetchHandleInvitability:v20 fromHandle:v9 forPresenceIdentifier:v21 completion:v23];
...
- (void)inviteHandle:(id)a3 fromSenderHandle:(id)a4 completion:(id)a5
{
  ...
  [(SKPresence *)self _inviteHandles:v12 fromSenderHandle:v10 completion:v9, v14, v15];
  v13 = *MEMORY[0x277D85DE8];
}
...
- (void)inviteHandleFromPrimaryAccountHandle:(id)a3 completion:(id)a4
{
  ...
  [(SKPresence *)self _inviteHandles:v9 fromSenderHandle:0 completion:v7, v11, v12];
  v10 = *MEMORY[0x277D85DE8];
}
...
- (void)_inviteHandles:(id)a3 fromSenderHandle:(id)a4 completion:(id)a5
{
  ...
  v17 = v11;
  v27 = v17;
  v18 = [v14 asynchronousRemoteDaemonWithErrorHandler:v24];
  ...
  v19 = v17;
  v22 = v19;
  [v18 inviteHandles:v16 fromSenderHandle:v9 presenceIdentifier:v15 completion:v21];
...
- (void)removeInvitedHandle:(id)a3 completion:(id)a4
{
  ...
  [(SKPresence *)self removeInvitedHandles:v9 completion:v7, v11, v12];
  v10 = *MEMORY[0x277D85DE8];
}
...
- (void)rollChannelWithCompletion:(id)a3
{
  ...
  v8 = v4;
  v16 = v8;
  v9 = [v7 asynchronousRemoteDaemonWithErrorHandler:v15];
  v12[0] = MEMORY[0x277D85DD0];
  v12[1] = 3221225472;
  ...
  v10 = v8;
  v13 = v10;
  [v9 rollChannelForPresenceIdentifier:v5 completion:v12];
...
- (void)fetchPresenceCapability:(id)a3
{
  ...
  v8 = v5;
  v14 = v8;
  v9 = [v7 asynchronousRemoteDaemonWithErrorHandler:v13];
...
- (void)addDelegate:(id)a3 queue:(id)a4
{
  ...
  v10 = [[SKDelegateResponseQueue alloc] initWithQueue:v6];
...
- (void)_registerForDelegateCallbacksIfNecessary
{
  ...
  else
  {
    ...
    os_unfair_lock_unlock(&self->_delegateLock);
    v7 = [(SKPresence *)self presenceIdentifier];
    v8 = +[SKPresence _logger];
    if (os_log_type_enabled(v8, OS_LOG_TYPE_DEFAULT))
    {
      *buf = 138543362;
    ...
    v9 = [(SKPresence *)self daemonConnection];
    objc_initWeak(buf, self);
    v17[0] = MEMORY[0x277D85DD0];
    v17[1] = 3221225472;
    ...
    v10 = [v9 asynchronousRemoteDaemonWithErrorHandler:v17];
    v11 = [(SKPresence *)self options];
    ...
    v12 = v7;
    v15 = v12;
    [v10 registerForDelegateCallbacksWithPresenceIdentifier:v12 options:v11 completion:v14];
...
- (void)presentHandlesChangedForPresenceIdentifier:(id)a3 completion:(id)a4
{
  ...
  v10 = [(SKPresence *)self presenceIdentifier];
...
- (void)setPresenceAssertionOptions:(id)a3
{
  ...
  self->_presenceAssertionOptions = v4;
