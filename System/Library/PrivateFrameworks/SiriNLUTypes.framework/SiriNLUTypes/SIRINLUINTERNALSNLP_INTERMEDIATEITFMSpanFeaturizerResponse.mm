...
{
  v4 = a3;
  if ([v4 isMemberOfClass:objc_opt_class()] && ((response = self->_response, !(response | v4[2])) || -[SIRINLUINTERNALSNLP_INTERMEDIATESpanFeaturizerResponse isEqual:](response, "isEqual:")))
  {
...
- (id)description
{
  ...
  v5 = [(SIRINLUINTERNALSNLP_INTERMEDIATEITFMSpanFeaturizerResponse *)self dictionaryRepresentation];
