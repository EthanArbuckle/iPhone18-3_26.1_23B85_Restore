...
- (void)mergeFrom:(id)from
{
  ...
  else
  {
    ...
    [(SIRINLUEXTERNALUserWantedToPause *)self setTaskId:?];
  }
...
LABEL_7:
  ...
  {
    [(SIRINLUEXTERNALUserWantedToPause *)self setReference:?];
  }
...
- (id)description
{
  ...
  v8.receiver = self;
  v8.super_class = SIRINLUEXTERNALUserWantedToPause;
  v4 = [(SIRINLUEXTERNALUserWantedToPause *)&v8 description];
  dictionaryRepresentation = [(SIRINLUEXTERNALUserWantedToPause *)self dictionaryRepresentation];
