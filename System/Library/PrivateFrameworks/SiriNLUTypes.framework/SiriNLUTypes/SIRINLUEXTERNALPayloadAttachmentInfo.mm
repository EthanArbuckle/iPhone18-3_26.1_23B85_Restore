...
- (BOOL)isEqual:(id)a3
{
  ...
  if (*&self->_has)
  {
    if ((*(v4 + 12) & 1) != 0 && self->_attachmentType == *(v4 + 2))
    {
      v5 = 1;
      goto LABEL_7;
    }
...
- (id)description
{
  ...
  v5 = [(SIRINLUEXTERNALPayloadAttachmentInfo *)self dictionaryRepresentation];
