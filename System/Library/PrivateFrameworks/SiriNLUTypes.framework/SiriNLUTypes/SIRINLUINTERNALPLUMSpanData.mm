...
- (id)description
{
  ...
  v8.receiver = self;
  v8.super_class = SIRINLUINTERNALPLUMSpanData;
  v4 = [(SIRINLUINTERNALPLUMSpanData *)&v8 description];
  dictionaryRepresentation = [(SIRINLUINTERNALPLUMSpanData *)self dictionaryRepresentation];
