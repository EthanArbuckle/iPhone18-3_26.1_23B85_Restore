  ...
  if (v6)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        [(SIRINLUINTERNALPLAN_GENERATIONPlanGenerationResponse *)self addPlans:*(*(&v20 + 1) + 8 * v9++)];
      }
  ...
  if (v11)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        [(SIRINLUINTERNALPLAN_GENERATIONPlanGenerationResponse *)self addMappings:*(*(&v16 + 1) + 8 * v14++), v16];
      }
