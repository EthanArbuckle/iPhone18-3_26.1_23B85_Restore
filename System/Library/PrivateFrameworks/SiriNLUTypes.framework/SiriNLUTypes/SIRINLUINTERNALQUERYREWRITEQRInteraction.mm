...
- (void)copyTo:(id)a3
{
  ...
  if ([(SIRINLUINTERNALQUERYREWRITEQRInteraction *)self originalUtterancesCount])
  {
    ...
    v4 = [(SIRINLUINTERNALQUERYREWRITEQRInteraction *)self originalUtterancesCount];
    if (v4)
    {
      v5 = v4;
      for (i = 0; i != v5; ++i)
  ...
  if ([(SIRINLUINTERNALQUERYREWRITEQRInteraction *)self siriResponsesCount])
  {
    ...
    v8 = [(SIRINLUINTERNALQUERYREWRITEQRInteraction *)self siriResponsesCount];
    if (v8)
    {
      v9 = v8;
      for (j = 0; j != v9; ++j)
...
- (id)description
{
  ...
  v5 = [(SIRINLUINTERNALQUERYREWRITEQRInteraction *)self dictionaryRepresentation];
