...
- (void)copyTo:(id)to
{
  ...
  if ([(SIRINLUINTERNALSNLCSNLCParserRequest *)self matchingSpansCount])
  {
    ...
    matchingSpansCount = [(SIRINLUINTERNALSNLCSNLCParserRequest *)self matchingSpansCount];
...
- (id)description
{
  ...
  dictionaryRepresentation = [(SIRINLUINTERNALSNLCSNLCParserRequest *)self dictionaryRepresentation];
