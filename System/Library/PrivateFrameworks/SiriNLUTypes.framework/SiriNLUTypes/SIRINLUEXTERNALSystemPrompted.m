...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v8 = [(SIRINLUEXTERNALUsoGraph *)self->_target copyWithZone:a3];
  v9 = v5[1];
  v5[1] = v8;
...
- (id)dictionaryRepresentation
{
  ...
  if (target)
  {
    v7 = [(SIRINLUEXTERNALUsoGraph *)target dictionaryRepresentation];
...
- (id)description
{
  ...
  v5 = [(SIRINLUEXTERNALSystemPrompted *)self dictionaryRepresentation];
