...
- (void)mergeFrom:(id)from
{
  ...
  {
    [(SIRINLUEXTERNALNLU_ROUTERSpanMatchedEntity *)self setTypedValue:?];
  }
  ...
  if (v8)
  {
    ...
    do
    {
      for (i = 0; i != v9; ++i)
      {
        ...
        [(SIRINLUEXTERNALNLU_ROUTERSpanMatchedEntity *)self addMatchMetadata:*(*(&v13 + 1) + 8 * i), v13];
      }
...
- (id)dictionaryRepresentation
{
  ...
  {
    v6 = [objc_alloc(MEMORY[0x1E695DF70]) initWithCapacity:{-[NSMutableArray count](self->_matchMetadatas, "count")}];
    v15 = 0u;
    v16 = 0u;
    v17 = 0u;
    v18 = 0u;
