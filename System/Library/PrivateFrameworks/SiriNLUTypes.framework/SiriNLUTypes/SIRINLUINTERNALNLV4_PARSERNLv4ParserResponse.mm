  ...
  if (v5)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        [(SIRINLUINTERNALNLV4_PARSERNLv4ParserResponse *)self addHypotheses:*(*(&v10 + 1) + 8 * v8++), v10];
      }
...
- (void)copyTo:(id)a3
{
  ...
  {
    [v8 clearHypotheses];
    v4 = [(SIRINLUINTERNALNLV4_PARSERNLv4ParserResponse *)self hypothesesCount];
    if (v4)
    {
      v5 = v4;
      for (i = 0; i != v5; ++i)
...
- (id)description
{
  ...
  v5 = [(SIRINLUINTERNALNLV4_PARSERNLv4ParserResponse *)self dictionaryRepresentation];
