...
- (void)mergeFrom:(id)from
{
  ...
  else
  {
    ...
    [(SIRINLUEXTERNALUserWantedToUndo *)self setTaskId:?];
  }
...
LABEL_7:
  ...
  {
    [(SIRINLUEXTERNALUserWantedToUndo *)self setReference:?];
  }
...
- (id)description
{
  ...
  v8.receiver = self;
  v8.super_class = SIRINLUEXTERNALUserWantedToUndo;
  v4 = [(SIRINLUEXTERNALUserWantedToUndo *)&v8 description];
  dictionaryRepresentation = [(SIRINLUEXTERNALUserWantedToUndo *)self dictionaryRepresentation];
