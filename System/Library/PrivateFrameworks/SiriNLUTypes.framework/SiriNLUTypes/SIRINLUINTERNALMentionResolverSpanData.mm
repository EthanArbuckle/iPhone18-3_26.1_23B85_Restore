...
- (BOOL)isEqual:(id)a3
{
  ...
  if (*&self->_has)
  {
    if ((*(v4 + 24) & 1) == 0 || self->_jointScore != *(v4 + 1))
    {
      goto LABEL_11;
    }
  }
...
LABEL_11:
  ...
  if ((*&self->_has & 2) != 0)
  {
    if ((*(v4 + 24) & 2) == 0 || self->_modelScore != *(v4 + 2))
    {
      goto LABEL_11;
    }
...
- (id)description
{
  ...
  v5 = [(SIRINLUINTERNALMentionResolverSpanData *)self dictionaryRepresentation];
