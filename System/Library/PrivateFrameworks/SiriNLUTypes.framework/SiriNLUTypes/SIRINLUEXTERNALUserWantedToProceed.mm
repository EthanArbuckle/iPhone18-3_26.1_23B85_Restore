...
- (void)mergeFrom:(id)from
{
  ...
  else
  {
    ...
    [(SIRINLUEXTERNALUserWantedToProceed *)self setTaskId:?];
  }
...
LABEL_7:
  ...
  {
    [(SIRINLUEXTERNALUserWantedToProceed *)self setReference:?];
  }
...
- (id)description
{
  ...
  v8.receiver = self;
  v8.super_class = SIRINLUEXTERNALUserWantedToProceed;
  v4 = [(SIRINLUEXTERNALUserWantedToProceed *)&v8 description];
  dictionaryRepresentation = [(SIRINLUEXTERNALUserWantedToProceed *)self dictionaryRepresentation];
