...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v20 = [(SIRINLUEXTERNALParser *)self->_parser copyWithZone:a3];
  v21 = v5[4];
  v5[4] = v20;
...
- (void)copyTo:(id)a3
{
  ...
  if ([(SIRINLUINTERNALITFMITFMParserRequest *)self matchingSpansCount])
  {
    ...
    v4 = [(SIRINLUINTERNALITFMITFMParserRequest *)self matchingSpansCount];
    if (v4)
    {
      v5 = v4;
      for (i = 0; i != v5; ++i)
...
- (id)dictionaryRepresentation
{
  ...
  if (parser)
  {
    v20 = [(SIRINLUEXTERNALParser *)parser dictionaryRepresentation];
...
- (id)description
{
  ...
  v5 = [(SIRINLUINTERNALITFMITFMParserRequest *)self dictionaryRepresentation];
