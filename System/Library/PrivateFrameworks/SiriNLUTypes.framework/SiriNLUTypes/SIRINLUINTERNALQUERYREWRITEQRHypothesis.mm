...
+ (id)options
{
  if (options_once_3513 != -1)
  {
    dispatch_once(&options_once_3513, &__block_literal_global_3514);
  }

  v3 = options_sOptions_3515;
...
{
  v0 = options_sOptions_3515;
  options_sOptions_3515 = &unk_1F48968D0;
}
