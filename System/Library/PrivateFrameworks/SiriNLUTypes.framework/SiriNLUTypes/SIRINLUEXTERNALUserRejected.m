...
- (void)mergeFrom:(id)a3
{
  ...
  else
  {
    ...
    [(SIRINLUEXTERNALUserRejected *)self setOfferId:?];
  }
...
LABEL_7:
  ...
  {
    [(SIRINLUEXTERNALUserRejected *)self setReference:?];
  }
...
- (id)description
{
  ...
  v8.receiver = self;
  v8.super_class = SIRINLUEXTERNALUserRejected;
  v4 = [(SIRINLUEXTERNALUserRejected *)&v8 description];
  v5 = [(SIRINLUEXTERNALUserRejected *)self dictionaryRepresentation];
