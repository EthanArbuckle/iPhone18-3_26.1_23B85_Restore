...
- (VUIProgressBarView)initWithFrame:(CGRect)frame;
...
- (VUIProgressBarView)initWithFrame:(CGRect)frame
{
  ...
  v3 = [(VUIProgressBarView *)&v6 initWithFrame:frame.origin.x, frame.origin.y, frame.size.width, frame.size.height];
  v4 = v3;
  if (v3)
  {
...
- (void)drawRect:(CGRect)rect
{
  ...
  {
    completeTintColor = [(VUIProgressBarView *)self completeTintColor];
  ...
  {
    progressTintColor = [(VUIProgressBarView *)self progressTintColor];
