...
- (void)removeAllObservers
{
  v3 = [(VUIAirTrafficController *)self connectionQueue];
...
- (void)_onConnectionQueue_startObservingIfIdle
{
  v3 = [(VUIAirTrafficController *)self observers];
  v4 = [v3 count];
...
- (void)_onConnectionQueue_stopObservingIfIdle
{
  ...
  if (!v4)
  {
    v5 = [(VUIAirTrafficController *)self connection];
...
- (void)connection:(id)a3 updatedProgress:(id)a4
{
  ...
  v8 = [(VUIAirTrafficController *)self connectionQueue];
