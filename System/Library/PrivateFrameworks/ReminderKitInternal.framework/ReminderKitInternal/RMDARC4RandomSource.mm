...
- (RMDARC4RandomSource)initWithCoder:(id)coder;
- (RMDARC4RandomSource)initWithSeed:(id)seed;
- (float)nextUniform;
...
- (RMDARC4RandomSource)init
{
  v3 = malloc_type_malloc(0x10uLL, 0xA81037A5uLL);
...
- (RMDARC4RandomSource)initWithSeed:(id)seed
{
  seedCopy = seed;
  v11.receiver = self;
  v11.super_class = RMDARC4RandomSource;
  ...
  if (v5)
  {
    ...
    if (v6)
    {
      v7 = v6;
      *&v6->var0 = 0;
      v8 = malloc_type_malloc(0x100uLL, 0xF82D2B30uLL);
      v9 = 0;
      v7->var2 = v8;
      do
      {
    ...
    [(RMDARC4RandomSource *)v5 setSeed:seedCopy];
  }
...
{
  v5.receiver = self;
  v5.super_class = RMDARC4RandomSource;
  coderCopy = coder;
  [(RMDRandomSource *)&v5 encodeWithCoder:coderCopy];
...
- (void)dealloc
{
  ...
  free(state);
  v4.receiver = self;
  v4.super_class = RMDARC4RandomSource;
