...
- (MLPLSTMLayer)initWithName:(id)name inputSize:(unint64_t)size outputSize:(unint64_t)outputSize weightAttributes:(unint64_t)attributes;
- (MLPLSTMLayer)initWithName:(id)name parameters:(id *)parameters;
- (id)generateNode:(id)node model:(id)model weightIter:(unint64_t *)iter;
- (id)matrixIDToString:(unint64_t)string;
...
- (void)createKernel;
- (void)exportWeightsWithWeightMatrix:(id)matrix weightID:(unint64_t)d destination:(float *)destination recurrent:(BOOL)recurrent;
- (void)populateActivation:(int *)activation montrealActivationType:(int64_t)type;
- (void)updateSourceMatrix:(id)matrix inference:(BOOL)inference;
@end
...
- (MLPLSTMLayer)initWithName:(id)name inputSize:(unint64_t)size outputSize:(unint64_t)outputSize weightAttributes:(unint64_t)attributes
{
  ...
  v11 = [(MLPLayer *)&v38 initWithLayerType:8 name:nameCopy neuronType:0 neuronParams:0];
  v14 = v11;
  if (v11)
  {
    objc_msgSend_setInputLength_(v11, v12, 1, v13);
    objc_msgSend_setInputSize_(v14, v15, size, v16);
    objc_msgSend_setOutputLength_(v14, v17, 1, v18);
    objc_msgSend_setOutputSize_(v14, v19, outputSize, v20);
    objc_msgSend_setInputChannels_(v14, v21, size, v22);
    objc_msgSend_setOutputChannels_(v14, v23, outputSize, v24);
    objc_msgSend_setWeightAttributes_(v14, v25, attributes, v26);
...
{
  nameCopy = name;
  v8 = objc_msgSend_initWithName_inputSize_outputSize_weightAttributes_(self, v7, nameCopy, parameters->var9[0][0], parameters->var10[0][0], parameters->var8);
  v11 = v8;
  if (v8)
  {
    objc_msgSend_setInitialWeights_0_(v8, v9, parameters->var13[0], v10);
    objc_msgSend_setInitialWeights_1_(v11, v12, parameters->var13[1], v13);
    objc_msgSend_setInitialBias_0_(v11, v14, parameters->var14[0], v15);
    objc_msgSend_setInitialBias_1_(v11, v16, parameters->var14[1], v17);
    objc_msgSend_populateActivation_montrealActivationType_(v11, v18, &v11->_inputGateActivation, parameters->var7[0]);
    objc_msgSend_populateActivation_montrealActivationType_(v11, v19, &v11->_forgetGateActivation, parameters->var7[1]);
    objc_msgSend_populateActivation_montrealActivationType_(v11, v20, &v11->_cellGateActivation, parameters->var7[2]);
    objc_msgSend_populateActivation_montrealActivationType_(v11, v21, &v11->_outputGateActivation, parameters->var7[3]);
    objc_msgSend_populateActivation_montrealActivationType_(v11, v22, &v11->_cellToOutputActivation, parameters->var7[4]);
  }
...
- (void)populateActivation:(int *)activation montrealActivationType:(int64_t)type
{
  if (type)
  {
    *activation = objc_msgSend_mpsNeuronTypeFromMontrealType_(self, a2, type, type);
  }
}
...
- (void)createKernel
{
  ...
  objc_msgSend_setWeightGradients_(selfCopy, v18, v17, v19);

  v23 = objc_msgSend_array(MEMORY[0x1E695DF70], v20, v21, v22);
  objc_msgSend_setTrainingStates_(selfCopy, v24, v23, v25);

  v29 = objc_msgSend_network(selfCopy, v26, v27, v28);
  v33 = objc_msgSend_deviceHandler(v29, v30, v31, v32);
  v37 = objc_msgSend_device(v33, v34, v35, v36);

  v282 = &selfCopy;
  v38 = MEMORY[0x1E69749E0];
  v42 = objc_msgSend_inputSize(selfCopy, v39, v40, v41);
  v46 = objc_msgSend_outputSize(selfCopy, v43, v44, v45);
  v48 = objc_msgSend_createLSTMDescriptorWithInputFeatureChannels_outputFeatureChannels_(v38, v47, v42, v46);
  objc_msgSend_setLstmDesc_(selfCopy, v49, v48, v50);

  v54 = objc_msgSend_inputGateActivation(selfCopy, v51, v52, v53);
  v58 = objc_msgSend_inputSize(selfCopy, v55, v56, v57);
  v62 = objc_msgSend_outputSize(selfCopy, v59, v60, v61);
  v63 = sub_19D43C270(&v282, 3, v54, v58, v62);
  v67 = objc_msgSend_lstmDesc(selfCopy, v64, v65, v66);
  objc_msgSend_setInputGateInputWeights_(v67, v68, v63, v69);

  v73 = objc_msgSend_outputSize(selfCopy, v70, v71, v72);
  v77 = objc_msgSend_outputSize(selfCopy, v74, v75, v76);
  v78 = sub_19D43C270(&v282, 4, 0, v73, v77);
  v82 = objc_msgSend_lstmDesc(selfCopy, v79, v80, v81);
  objc_msgSend_setInputGateRecurrentWeights_(v82, v83, v78, v84);

  v88 = objc_msgSend_forgetGateActivation(selfCopy, v85, v86, v87);
  v92 = objc_msgSend_inputSize(selfCopy, v89, v90, v91);
  v96 = objc_msgSend_outputSize(selfCopy, v93, v94, v95);
  v97 = sub_19D43C270(&v282, 7, v88, v92, v96);
  v101 = objc_msgSend_lstmDesc(selfCopy, v98, v99, v100);
  objc_msgSend_setForgetGateInputWeights_(v101, v102, v97, v103);

  v107 = objc_msgSend_outputSize(selfCopy, v104, v105, v106);
  v111 = objc_msgSend_outputSize(selfCopy, v108, v109, v110);
  v112 = sub_19D43C270(&v282, 8, 0, v107, v111);
  v116 = objc_msgSend_lstmDesc(selfCopy, v113, v114, v115);
  objc_msgSend_setForgetGateRecurrentWeights_(v116, v117, v112, v118);

  v122 = objc_msgSend_cellGateActivation(selfCopy, v119, v120, v121);
  v126 = objc_msgSend_inputSize(selfCopy, v123, v124, v125);
  v130 = objc_msgSend_outputSize(selfCopy, v127, v128, v129);
  v131 = sub_19D43C270(&v282, 11, v122, v126, v130);
  v135 = objc_msgSend_lstmDesc(selfCopy, v132, v133, v134);
  objc_msgSend_setCellGateInputWeights_(v135, v136, v131, v137);

  v141 = objc_msgSend_outputSize(selfCopy, v138, v139, v140);
  v145 = objc_msgSend_outputSize(selfCopy, v142, v143, v144);
  v146 = sub_19D43C270(&v282, 12, 0, v141, v145);
  v150 = objc_msgSend_lstmDesc(selfCopy, v147, v148, v149);
  objc_msgSend_setCellGateRecurrentWeights_(v150, v151, v146, v152);

  v156 = objc_msgSend_outputGateActivation(selfCopy, v153, v154, v155);
  v160 = objc_msgSend_inputSize(selfCopy, v157, v158, v159);
  v164 = objc_msgSend_outputSize(selfCopy, v161, v162, v163);
  v165 = sub_19D43C270(&v282, 15, v156, v160, v164);
  v169 = objc_msgSend_lstmDesc(selfCopy, v166, v167, v168);
  objc_msgSend_setOutputGateInputWeights_(v169, v170, v165, v171);

  v175 = objc_msgSend_outputSize(selfCopy, v172, v173, v174);
  v179 = objc_msgSend_outputSize(selfCopy, v176, v177, v178);
  v180 = sub_19D43C270(&v282, 16, 0, v175, v179);
  v184 = objc_msgSend_lstmDesc(selfCopy, v181, v182, v183);
  objc_msgSend_setOutputGateRecurrentWeights_(v184, v185, v180, v186);

  v190 = objc_msgSend_cellToOutputActivation(selfCopy, v187, v188, v189);
  v194 = objc_msgSend_lstmDesc(selfCopy, v191, v192, v193);
  objc_msgSend_setCellToOutputNeuronType_(v194, v195, v190, v196);

  v200 = objc_msgSend_lstmDesc(selfCopy, v197, v198, v199);
  objc_msgSend_setUseFloat32Weights_(v200, v201, 1, v202);

  v203 = objc_alloc(MEMORY[0x1E6974A50]);
  v207 = objc_msgSend_lstmDesc(selfCopy, v204, v205, v206);
  v211 = objc_msgSend_weights(selfCopy, v208, v209, v210);
  v213 = objc_msgSend_initWithDevice_rnnDescriptor_trainableWeights_(v203, v212, v37, v207, v211);
  objc_msgSend_setFilter_(selfCopy, v214, v213, v215);

  v219 = objc_msgSend_array(MEMORY[0x1E695DF70], v216, v217, v218);
  v223 = objc_msgSend_array(MEMORY[0x1E695DF70], v220, v221, v222);
  v227 = objc_msgSend_filter(selfCopy, v224, v225, v226);
  ...
  v234 = objc_msgSend_filter(selfCopy, v231, v232, v233);
  v238 = objc_msgSend_weightGradients(selfCopy, v235, v236, v237);
  ...
  objc_msgSend_setOptimizers_(selfCopy, v248, v247, v249, v223);
  ...
  for (i = 0; i < objc_msgSend_count(v219, v250, v251, v252); ++i)
  {
    ...
    v258 = objc_msgSend_network(selfCopy, v255, v256, v257);
    ...
    v266 = objc_msgSend_optimizers(selfCopy, v263, v264, v265);
...
- (id)seqForward:(id)forward input:(id)input dataBatch:(id)batch runInference:(BOOL)inference
{
  ...
  forwardCopy = forward;
  inputCopy = input;
  objc_msgSend_updateSourceMatrix_inference_(self, v11, inputCopy, inferenceCopy);
  ...
  if (isKindOfClass)
  {
    objc_msgSend_seqForwardDifferentMatrices_input_(self, v24, forwardCopy, inputCopy);
  }

  else
  {
    objc_msgSend_seqForwardCombinedMatrix_input_(self, v24, forwardCopy, inputCopy);
  }
  v28 = ;
  if (inferenceCopy)
  {
...
- (id)seqForwardDifferentMatrices:(id)matrices input:(id)input
{
  ...
  v72 = inputCopy;
  v12 = objc_msgSend_count(inputCopy, v9, v10, v11);
  ...
  if (v32)
  {
    ...
    do
    {
      for (i = 0; i != v32; ++i)
      {
        ...
        v50 = objc_msgSend_tempMatrixWithRows_columns_cmdBuf_(v40, v49, v44, v48, matricesCopy);
  ...
  objc_msgSend_encodeForwardSequenceToCommandBuffer_sourceMatrices_destinationMatrices_trainingStates_weights_(v56, v65, matricesCopy, v27, v15, v60, v64);
...
- (id)seqForwardCombinedMatrix:(id)matrix input:(id)input
{
  ...
  v31 = 0;
  for (i = 0; i < objc_msgSend_count(inputCopy, v28, v29, v30); ++i)
  {
    v36 = objc_msgSend_objectAtIndexedSubscript_(inputCopy, v33, i, v35);
  ...
  v48 = objc_msgSend_outputSize(self, v45, v46, v47);
  v50 = objc_msgSend_tempMatrixWithRows_columns_cmdBuf_(v44, v49, v31, v48, matrixCopy);

  v54 = objc_msgSend_count(inputCopy, v51, v52, v53);
  if (v54)
  {
    if (!(v54 >> 61))
    {
  ...
  v58 = 0;
  for (j = 0; j < objc_msgSend_count(inputCopy, v55, v56, v57); ++j)
  {
    objc_msgSend_addObject_(v15, v60, v50, v62);
    *(8 * j) = objc_msgSend_rowBytes(v50, v63, v64, v65) * v58;
    v68 = objc_msgSend_objectAtIndexedSubscript_(inputCopy, v66, j, v67);
  ...
  objc_msgSend_encodeForwardSequenceToCommandBuffer_sourceMatrices_sourceOffsets_destinationMatrices_destinationOffsets_trainingStates_recurrentInputState_recurrentOutputStates_weights_(v72, v81, matrixCopy, inputCopy, 0, v15, 0, v76, 0, 0, v80);
...
- (id)seqBackward:(id)backward dataBatch:(id)batch inputGradient:(id)gradient
{
  ...
  if (isKindOfClass)
  {
    objc_msgSend_seqBackwardDifferentMatrices_inputGradient_(self, v16, backwardCopy, gradientCopy);
  }

  else
  {
    objc_msgSend_seqBackwardCombinedMatrix_inputGradient_(self, v16, backwardCopy, gradientCopy);
  }
  v20 = ;
  for (i = 0; ; ++i)
  {
    ...
    objc_msgSend_encodeToCommandBuffer_inputGradientMatrix_inputValuesMatrix_(v47, v48, backwardCopy, v40, v33);
  }
...
- (id)seqBackwardDifferentMatrices:(id)matrices inputGradient:(id)gradient
{
  ...
  v8 = MEMORY[0x1E695DF70];
  v76 = gradientCopy;
  v12 = objc_msgSend_count(gradientCopy, v9, v10, v11);
  v15 = objc_msgSend_arrayWithCapacity_(v8, v13, v12, v14);
  v19 = objc_msgSend_network(self, v16, v17, v18);
  v23 = objc_msgSend_deviceHandler(v19, v20, v21, v22);
  ...
  objc_msgSend_encodeGradientSequenceToCommandBuffer_forwardSources_sourceGradients_destinationGradients_weightGradients_trainingStates_weights_(v56, v73, matricesCopy, v60, v27, v15, v64, v68, v72);
...
- (id)seqBackwardCombinedMatrix:(id)matrix inputGradient:(id)gradient
{
  matrixCopy = matrix;
  gradientCopy = gradient;
  v164 = objc_msgSend_objectAtIndexedSubscript_(gradientCopy, v7, 0, v8);
  ...
  for (i = 0; ; ++i)
  {
    ...
    *(8 * i) = v166;
    ...
    v133 = objc_msgSend_tempMatrixWithRows_columns_cmdBuf_(v116, v132, v127, v131, matrixCopy);
...
- (void)updateSourceMatrix:(id)matrix inference:(BOOL)inference
{
  ...
  if (!inference)
  {
    sub_19D4362A4(matrixCopy);
    objc_msgSend_setSrcMatrices_(self, v6, matrixCopy, v7);
  }
}
...
- (id)generateNode:(id)node model:(id)model weightIter:(unint64_t *)iter
{
  ...
  v21 = objc_msgSend_network(selfCopy, v18, v19, v20);
  ...
  v264[4] = 0;
  v264[0] = 5;
  v264[15] = objc_msgSend_weightAttributes(selfCopy, v33, v34, v35) | 0x80;
  v36 = selfCopy;
  v40 = objc_msgSend_inputGateActivation(selfCopy, v37, v38, v39);
  v264[7] = objc_msgSend_montrealTypeFromMPSNeuronType_(v36, v41, v40, v42);
  v43 = selfCopy;
  v47 = objc_msgSend_forgetGateActivation(selfCopy, v44, v45, v46);
  v264[8] = objc_msgSend_montrealTypeFromMPSNeuronType_(v43, v48, v47, v49);
  v50 = selfCopy;
  v54 = objc_msgSend_cellGateActivation(selfCopy, v51, v52, v53);
  v264[9] = objc_msgSend_montrealTypeFromMPSNeuronType_(v50, v55, v54, v56);
  v57 = selfCopy;
  v61 = objc_msgSend_outputGateActivation(selfCopy, v58, v59, v60);
  v264[10] = objc_msgSend_montrealTypeFromMPSNeuronType_(v57, v62, v61, v63);
  v64 = selfCopy;
  v68 = objc_msgSend_cellToOutputActivation(selfCopy, v65, v66, v67);
  v264[11] = objc_msgSend_montrealTypeFromMPSNeuronType_(v64, v69, v68, v70);
  v265 = objc_msgSend_inputSize(selfCopy, v71, v72, v73);
  v266 = objc_msgSend_outputSize(selfCopy, v74, v75, v76);
  ...
  if (v85)
  {
    ...
    do
    {
      for (i = 0; i != v85; ++i)
      {
        ...
        v88 = *(*(&v259 + 1) + 8 * i);
        v89 = objc_msgSend_network(selfCopy, v82, v83, v84);
        v93 = objc_msgSend_deviceHandler(v89, v90, v91, v92);
        v97 = objc_msgSend_outputSize(selfCopy, v94, v95, v96);
        v101 = objc_msgSend_inputSize(selfCopy, v98, v99, v100);
  ...
  if (v108)
  {
    ...
    do
    {
      for (j = 0; j != v108; ++j)
      {
        ...
        v111 = *(*(&v255 + 1) + 8 * j);
        v112 = objc_msgSend_network(selfCopy, v105, v106, v107);
        v116 = objc_msgSend_deviceHandler(v112, v113, v114, v115);
        v120 = objc_msgSend_outputSize(selfCopy, v117, v118, v119);
        v124 = objc_msgSend_outputSize(selfCopy, v121, v122, v123);
  ...
  if (v131)
  {
    ...
    do
    {
      for (k = 0; k != v131; ++k)
      {
        ...
        v134 = *(*(&v251 + 1) + 8 * k);
        v135 = objc_msgSend_network(selfCopy, v128, v129, v130);
        v139 = objc_msgSend_deviceHandler(v135, v136, v137, v138);
        v143 = objc_msgSend_outputSize(selfCopy, v140, v141, v142);
  ...
  if ((objc_msgSend_weightAttributes(selfCopy, v150, v151, v152) & 0x20) != 0)
  {
    v199 = objc_msgSend_outputSize(selfCopy, v153, v154, v155);
    v203 = objc_msgSend_inputSize(selfCopy, v200, v201, v202);
    v207 = objc_msgSend_outputSize(selfCopy, v204, v205, v206);
  ...
  {
    v156 = objc_msgSend_outputSize(selfCopy, v153, v154, v155);
    v160 = objc_msgSend_inputSize(selfCopy, v157, v158, v159);
    v161 = sub_19D4363B8(4 * v156 * v160);
    v165 = objc_msgSend_outputSize(selfCopy, v162, v163, v164);
    v169 = objc_msgSend_outputSize(selfCopy, v166, v167, v168);
  ...
  objc_msgSend_outputSize(selfCopy, v185, v186, v187);
  operator new[]();
}
...
{
  matrixCopy = matrix;
  v12 = objc_msgSend_data(matrixCopy, v9, v10, v11);
  v13 = v12;
      ...
      switch(d)
      {
        case 0xFuLL:
          if ((v21 & 0x20) != 0)
          {
            ...
            if (objc_msgSend_rows(matrixCopy, v388, v389, v390))
            {
              v394 = 0;
              v395 = 0;
              v396 = &destination[3 * v371 * (v379 + v375)];
              v397 = 4 * (v387 + v383);
              do
              {
                if (objc_msgSend_columns(matrixCopy, v391, v392, v393))
                {
                  v401 = 0;
                  do
                  {
                    v396[v401] = *(v17 + v394 * objc_msgSend_columns(matrixCopy, v398, v399, v400) + 4 * v401);
                    ++v401;
                  }

                  while (objc_msgSend_columns(matrixCopy, v402, v403, v404) > v401);
                }
              ...
              while (objc_msgSend_rows(matrixCopy, v398, v399, v400) > v395);
            }
          }
          ...
          else
          {
            ...
            if (objc_msgSend_rows(matrixCopy, v151, v152, v153))
            {
              v157 = 0;
              v158 = 0;
              v159 = 3 * v140 * v144;
              do
              {
                if (objc_msgSend_columns(matrixCopy, v154, v155, v156))
                {
                  v163 = 0;
                  do
                  {
                    destination[v159 + v163] = *(v17 + v157 * objc_msgSend_columns(matrixCopy, v160, v161, v162) + 4 * v163);
                    ++v163;
                  }

                  while (objc_msgSend_columns(matrixCopy, v164, v165, v166) > v163);
                  v159 += v163;
                }
              ...
              while (objc_msgSend_rows(matrixCopy, v160, v161, v162) > v158);
            }
          }
        ...
        case 0x10uLL:
          if ((v21 & 0x20) != 0)
          {
            ...
            if (objc_msgSend_rows(matrixCopy, v535, v536, v537))
            {
              v541 = 0;
              v542 = 0;
              v543 = &destination[3 * v514 * (v522 + v518) + v526];
              v544 = 4 * (v534 + v530);
              do
              {
                if (objc_msgSend_columns(matrixCopy, v538, v539, v540))
                {
                  v548 = 0;
                  do
                  {
                    v543[v548] = *(v17 + v541 * objc_msgSend_columns(matrixCopy, v545, v546, v547) + 4 * v548);
                    ++v548;
                  }

                  while (objc_msgSend_columns(matrixCopy, v549, v550, v551) > v548);
                }
              ...
              while (objc_msgSend_rows(matrixCopy, v545, v546, v547) > v542);
            }
          }
          ...
          else
          {
            ...
            if (objc_msgSend_rows(matrixCopy, v257, v258, v259))
            {
              v263 = 0;
              v264 = 0;
              v265 = 3 * v252 * v256;
              do
              {
                if (objc_msgSend_columns(matrixCopy, v260, v261, v262))
                {
                  v269 = 0;
                  do
                  {
                    destination[v265 + v269] = *(v17 + v263 * objc_msgSend_columns(matrixCopy, v266, v267, v268) + 4 * v269);
                    ++v269;
                  }

                  while (objc_msgSend_columns(matrixCopy, v270, v271, v272) > v269);
                  v265 += v269;
                }
              ...
              while (objc_msgSend_rows(matrixCopy, v266, v267, v268) > v264);
            }
          }
        ...
        case 0x12uLL:
          if (objc_msgSend_outputSize(self, v25, v26, v27))
          {
            ...
            {
              v57 = *(v17 + 4 * v56);
              destination[3 * objc_msgSend_outputSize(self, v53, v54, v55) + v56++] = v57;
            }
      ...
      switch(d)
      {
        case 0xBuLL:
          if ((v21 & 0x20) != 0)
          {
            ...
            if (objc_msgSend_rows(matrixCopy, v320, v321, v322))
            {
              v326 = 0;
              v327 = 0;
              v328 = &destination[(v303 << ((v28 >> 4) ^ 1u)) * (v311 + v307)];
              v329 = 4 * (v319 + v315);
              do
              {
                if (objc_msgSend_columns(matrixCopy, v323, v324, v325))
                {
                  v333 = 0;
                  do
                  {
                    v328[v333] = *(v17 + v326 * objc_msgSend_columns(matrixCopy, v330, v331, v332) + 4 * v333);
                    ++v333;
                  }

                  while (objc_msgSend_columns(matrixCopy, v334, v335, v336) > v333);
                }
              ...
              while (objc_msgSend_rows(matrixCopy, v330, v331, v332) > v327);
            }
          }
          ...
          else
          {
            ...
            if (objc_msgSend_rows(matrixCopy, v97, v98, v99))
            {
              v103 = 0;
              v104 = 0;
              ...
              do
              {
                if (objc_msgSend_columns(matrixCopy, v100, v101, v102))
                {
                  v109 = 0;
                  do
                  {
                    destination[v105 + v109] = *(v17 + v103 * objc_msgSend_columns(matrixCopy, v106, v107, v108) + 4 * v109);
                    ++v109;
                  }

                  while (objc_msgSend_columns(matrixCopy, v110, v111, v112) > v109);
                  v105 += v109;
                }
              ...
              while (objc_msgSend_rows(matrixCopy, v106, v107, v108) > v104);
            }
          }
        ...
        case 0xCuLL:
          if ((v21 & 0x20) != 0)
          {
            ...
            if (objc_msgSend_rows(matrixCopy, v460, v461, v462))
            {
              v466 = 0;
              v467 = 0;
              v468 = &destination[(v557 << ((v28 >> 4) ^ 1u)) * (v447 + v443) + v451];
              v469 = 4 * (v459 + v455);
              do
              {
                if (objc_msgSend_columns(matrixCopy, v463, v464, v465))
                {
                  v473 = 0;
                  do
                  {
                    v468[v473] = *(v17 + v466 * objc_msgSend_columns(matrixCopy, v470, v471, v472) + 4 * v473);
                    ++v473;
                  }

                  while (objc_msgSend_columns(matrixCopy, v474, v475, v476) > v473);
                }
              ...
              while (objc_msgSend_rows(matrixCopy, v470, v471, v472) > v467);
            }
          }
          ...
          else
          {
            ...
            if (objc_msgSend_rows(matrixCopy, v203, v204, v205))
            {
              v209 = 0;
              v210 = 0;
              ...
              do
              {
                if (objc_msgSend_columns(matrixCopy, v206, v207, v208))
                {
                  v215 = 0;
                  do
                  {
                    destination[v211 + v215] = *(v17 + v209 * objc_msgSend_columns(matrixCopy, v212, v213, v214) + 4 * v215);
                    ++v215;
                  }

                  while (objc_msgSend_columns(matrixCopy, v216, v217, v218) > v215);
                  v211 += v215;
                }
              ...
              while (objc_msgSend_rows(matrixCopy, v212, v213, v214) > v210);
            }
          }
        ...
        case 0xEuLL:
          if (objc_msgSend_outputSize(self, v25, v26, v27))
          {
            ...
            {
              v41 = *(v17 + 4 * v40);
              destination[(objc_msgSend_outputSize(self, v37, v38, v39) << ((v28 >> 4) ^ 1u)) + v40++] = v41;
            }
    ...
    switch(d)
    {
      case 7uLL:
        if ((v21 & 0x20) != 0)
        {
          ...
          if (objc_msgSend_rows(matrixCopy, v354, v355, v356))
          {
            v360 = 0;
            v361 = 0;
            v362 = &destination[(v337 << (v28 >> 4)) * (v345 + v341)];
            v363 = 4 * (v353 + v349);
            do
            {
              if (objc_msgSend_columns(matrixCopy, v357, v358, v359))
              {
                v367 = 0;
                do
                {
                  v362[v367] = *(v17 + v360 * objc_msgSend_columns(matrixCopy, v364, v365, v366) + 4 * v367);
                  ++v367;
                }

                while (objc_msgSend_columns(matrixCopy, v368, v369, v370) > v367);
              }
            ...
            while (objc_msgSend_rows(matrixCopy, v364, v365, v366) > v361);
          }
        }
        ...
        else
        {
          ...
          if (objc_msgSend_rows(matrixCopy, v124, v125, v126))
          {
            v130 = 0;
            v131 = 0;
            ...
            do
            {
              if (objc_msgSend_columns(matrixCopy, v127, v128, v129))
              {
                v136 = 0;
                do
                {
                  destination[v132 + v136] = *(v17 + v130 * objc_msgSend_columns(matrixCopy, v133, v134, v135) + 4 * v136);
                  ++v136;
                }

                while (objc_msgSend_columns(matrixCopy, v137, v138, v139) > v136);
                v132 += v136;
              }
            ...
            while (objc_msgSend_rows(matrixCopy, v133, v134, v135) > v131);
          }
        }
      ...
      case 8uLL:
        if ((v21 & 0x20) != 0)
        {
          ...
          if (objc_msgSend_rows(matrixCopy, v497, v498, v499))
          {
            v503 = 0;
            v504 = 0;
            v505 = &destination[(v558 << (v28 >> 4)) * (v484 + v480) + v488];
            v506 = 4 * (v496 + v492);
            do
            {
              if (objc_msgSend_columns(matrixCopy, v500, v501, v502))
              {
                v510 = 0;
                do
                {
                  v505[v510] = *(v17 + v503 * objc_msgSend_columns(matrixCopy, v507, v508, v509) + 4 * v510);
                  ++v510;
                }

                while (objc_msgSend_columns(matrixCopy, v511, v512, v513) > v510);
              }
            ...
            while (objc_msgSend_rows(matrixCopy, v507, v508, v509) > v504);
          }
        }
        ...
        else
        {
          ...
          if (objc_msgSend_rows(matrixCopy, v230, v231, v232))
          {
            v236 = 0;
            v237 = 0;
            ...
            do
            {
              if (objc_msgSend_columns(matrixCopy, v233, v234, v235))
              {
                v242 = 0;
                do
                {
                  destination[v238 + v242] = *(v17 + v236 * objc_msgSend_columns(matrixCopy, v239, v240, v241) + 4 * v242);
                  ++v242;
                }

                while (objc_msgSend_columns(matrixCopy, v243, v244, v245) > v242);
                v238 += v242;
              }
            ...
            while (objc_msgSend_rows(matrixCopy, v239, v240, v241) > v237);
          }
        }
      ...
      case 0xAuLL:
        if (objc_msgSend_outputSize(self, v25, v26, v27))
        {
          ...
          {
            v49 = *(v17 + 4 * v48);
            destination[(objc_msgSend_outputSize(self, v45, v46, v47) << (v28 >> 4)) + v48++] = v49;
          }
    ...
    switch(d)
    {
      case 3uLL:
        if ((v21 & 0x20) != 0)
        {
          ...
          if (objc_msgSend_rows(matrixCopy, v287, v288, v289))
          {
            v293 = 0;
            v294 = 0;
            v295 = 4 * (v286 + v282);
            do
            {
              if (objc_msgSend_columns(matrixCopy, v290, v291, v292))
              {
                v299 = 0;
                do
                {
                  destination[v299] = *(v17 + v293 * objc_msgSend_columns(matrixCopy, v296, v297, v298) + 4 * v299);
                  ++v299;
                }

                while (objc_msgSend_columns(matrixCopy, v300, v301, v302) > v299);
              }

              ++v294;
              destination = (destination + v295);
              v293 += 4;
            }

            while (objc_msgSend_rows(matrixCopy, v296, v297, v298) > v294);
          }
        }
        ...
        else
        {
          ...
          if (objc_msgSend_rows(matrixCopy, v70, v71, v72))
          {
            v76 = 0;
            v77 = 0;
            v78 = 0;
            do
            {
              if (objc_msgSend_columns(matrixCopy, v73, v74, v75))
              {
                v82 = 0;
                do
                {
                  destination[v78 + v82] = *(v17 + v76 * objc_msgSend_columns(matrixCopy, v79, v80, v81) + 4 * v82);
                  ++v82;
                }

                while (objc_msgSend_columns(matrixCopy, v83, v84, v85) > v82);
                v78 += v82;
              }
            ...
            while (objc_msgSend_rows(matrixCopy, v79, v80, v81) > v77);
          }
        }
      ...
      case 4uLL:
        if ((v21 & 0x20) != 0)
        {
          ...
          if (objc_msgSend_rows(matrixCopy, v423, v424, v425))
          {
            v429 = 0;
            v430 = 0;
            v431 = &destination[v414];
            v432 = 4 * (v422 + v418);
            do
            {
              if (objc_msgSend_columns(matrixCopy, v426, v427, v428))
              {
                v436 = 0;
                do
                {
                  v431[v436] = *(v17 + v429 * objc_msgSend_columns(matrixCopy, v433, v434, v435) + 4 * v436);
                  ++v436;
                }

                while (objc_msgSend_columns(matrixCopy, v437, v438, v439) > v436);
              }
            ...
            while (objc_msgSend_rows(matrixCopy, v433, v434, v435) > v430);
          }
        }
        ...
        else
        {
          ...
          if (objc_msgSend_rows(matrixCopy, v176, v177, v178))
          {
            v182 = 0;
            v183 = 0;
            v184 = 0;
            do
            {
              if (objc_msgSend_columns(matrixCopy, v179, v180, v181))
              {
                v188 = 0;
                do
                {
                  destination[v184 + v188] = *(v17 + v182 * objc_msgSend_columns(matrixCopy, v185, v186, v187) + 4 * v188);
                  ++v188;
                }

                while (objc_msgSend_columns(matrixCopy, v189, v190, v191) > v188);
                v184 += v188;
              }
            ...
            while (objc_msgSend_rows(matrixCopy, v185, v186, v187) > v183);
          }
        }
...
LABEL_162:
        ...
        v553 = objc_msgSend_stringWithFormat_(MEMORY[0x1E696AEC0], v25, @"Unknown weight ID %tu", v27, d);
