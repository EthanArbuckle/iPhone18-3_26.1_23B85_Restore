...
- (MLPDenseLayer)initWithName:(id)a3 previousLayer:(id)a4 numOutputs:(unint64_t)a5 neuronType:(int)a6 neuronParams:(id)a7
{
  ...
  v28 = objc_msgSend_initWithName_numInputs_numOutputs_neuronType_neuronParams_(self, v24, v12, v23, a5, v8, v14);
...
- (MLPDenseLayer)initWithName:(id)a3 numInputs:(unint64_t)a4 numOutputs:(unint64_t)a5 neuronType:(int)a6 neuronParams:(id)a7
{
  ...
  v14 = [(MLPMatrixLayer *)&v29 initWithLayerType:6 name:v12 neuronType:v8 neuronParams:v13];
  v17 = v14;
  if (v14)
  {
...
- (MLPDenseLayer)initWithName:(id)a3 parameters:(id *)a4
{
  ...
  if (v7)
  {
    ...
    objc_msgSend_setInitialWeights_(v10, v29, a4->var13[0], v30);
    objc_msgSend_setInitialBias_(v10, v31, a4->var14[0], v32);
  }
...
- (id)forward:(id)a3 inputMatrix:(id)a4 index:(id)a5 runInference:(BOOL)a6
{
  ...
  objc_msgSend_updateInputMatrixToFirstKernel_index_inference_(self, v17, v11, v12, v6);
  ...
  v35 = objc_msgSend_tempMatrixWithRows_columns_cmdBuf_(v25, v34, v29, v33, v10);

  v39 = objc_msgSend_weights(self, v36, v37, v38);
  v43 = objc_msgSend_biasVector(self, v40, v41, v42);
  objc_msgSend_encodeToCommandBuffer_inputMatrix_weightMatrix_biasVector_resultMatrix_(v16, v44, v10, v11, v39, v43, v35);

  v49 = objc_msgSend_secondaryForwardKernel(self, v45, v46, v47);
  if (v49)
  {
    objc_msgSend_updateInputMatrixToSecondKernel_index_inference_(self, v48, v35, v12, v6);
    ...
    v67 = objc_msgSend_tempMatrixWithRows_columns_cmdBuf_(v57, v66, v61, v65, v10);

    objc_msgSend_encodeToCommandBuffer_inputMatrix_biasVector_resultMatrix_(v49, v68, v10, v35, 0, v67);
  }
...
- (id)forward:(id)a3 input:(id)a4 labels:(id)a5 runInference:(BOOL)a6
{
  ...
  v28 = objc_msgSend_tempMatrixFromImages_i2mKernel_cmdBuf_(v18, v27, v10, v26, v9);

  v30 = objc_msgSend_forward_inputMatrix_index_runInference_(self, v29, v9, v28, &unk_1F10C5190, v6);
  ...
  v52 = objc_msgSend_imageBatchFromMatrix_m2iKernel_cmdBuf_width_height_channels_(v38, v51, v30, v46, v9, 1, 1, v50);
...
- (id)seqForward:(id)a3 input:(id)a4 dataBatch:(id)a5 runInference:(BOOL)a6
{
  ...
  {
    v40 = objc_msgSend_objectAtIndexedSubscript_(v11, v38, i, v39);
    v43 = objc_msgSend_numberWithUnsignedInteger_(MEMORY[0x1E696AD98], v41, i, v42);
    v45 = objc_msgSend_forward_inputMatrix_index_runInference_(self, v44, v10, v40, v43, v6);
...
- (id)backward:(id)a3 index:(id)a4 inputGradientMatrix:(id)a5
{
  ...
  if (v20)
  {
    ...
    v31 = objc_msgSend_tempMatrixWithRows_columns_cmdBuf_(v25, v30, v13, v29, v8);

    v35 = objc_msgSend_inputMatrixToSecondKernel(self, v32, v33, v34);
    v38 = objc_msgSend_objectForKeyedSubscript_(v35, v36, v123, v37);
    objc_msgSend_encodeToCommandBuffer_gradientMatrix_inputMatrix_biasVector_resultGradientForDataMatrix_resultGradientForBiasVector_(v20, v39, v8, v9, v38, 0, v31, 0);
  }
  ...
  v90 = objc_msgSend_vectorWithLength_cmdBuf_(v84, v89, v88, v8);

  v94 = objc_msgSend_weights(self, v91, v92, v93);
  objc_msgSend_encodeGradientForDataToCommandBuffer_gradientMatrix_weightMatrix_resultGradientForDataMatrix_(v44, v95, v8, v31, v94, v58);

  v99 = objc_msgSend_inputMatrixToFirstKernel(self, v96, v97, v98);
  v102 = objc_msgSend_objectForKeyedSubscript_(v99, v100, v123, v101);
  objc_msgSend_encodeGradientForWeightsAndBiasToCommandBuffer_gradientMatrix_inputMatrix_resultGradientForWeightMatrix_resultGradientForBiasVector_(v44, v103, v8, v31, v102, v76, v90);

  v107 = objc_msgSend_optimizerBiases(self, v104, v105, v106);
  v111 = objc_msgSend_biasVector(self, v108, v109, v110);
  objc_msgSend_encodeToCommandBuffer_inputGradientVector_inputValuesVector_(v107, v112, v8, v90, v111);

  v116 = objc_msgSend_optimizerWeights(self, v113, v114, v115);
  v120 = objc_msgSend_weights(self, v117, v118, v119);
  objc_msgSend_encodeToCommandBuffer_inputGradientMatrix_inputValuesMatrix_(v116, v121, v8, v76, v120);
...
- (id)backward:(id)a3 inputGradient:(id)a4
{
  ...
  v24 = objc_msgSend_tempMatrixFromImages_i2mKernel_cmdBuf_(v14, v23, v63, v22, v6);

  v62 = v24;
  v26 = objc_msgSend_backward_index_inputGradientMatrix_(self, v25, v6, &unk_1F10C5190, v24);
  ...
  v60 = objc_msgSend_imageBatchFromMatrix_m2iKernel_cmdBuf_width_height_channels_(v34, v59, v26, v42, v6, v50, 1, v58);
...
- (id)seqBackward:(id)a3 dataBatch:(id)a4 inputGradient:(id)a5
{
  ...
  {
    v25 = objc_msgSend_objectAtIndexedSubscript_(v10, v23, i, v24);
    v28 = objc_msgSend_numberWithUnsignedInteger_(MEMORY[0x1E696AD98], v26, i, v27);
    v30 = objc_msgSend_backward_index_inputGradientMatrix_(self, v29, v8, v28, v25);
...
- (id)generateNode:(id)a3 model:(id)a4 weightIter:(unint64_t *)a5
{
  ...
  v162 = objc_msgSend_generateNode_model_weightIter_params_inputChunks_outputChunks_(self, v161, v168, v169, v164, v171, v148, v160);
