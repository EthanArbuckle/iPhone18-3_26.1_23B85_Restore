...
- (SHSBadgeView)init
{
  ...
  if (v2)
  {
    ...
    widthAnchor = [(SHSBadgeView *)v3 widthAnchor];
    heightAnchor = [(SHSBadgeView *)v3 heightAnchor];
    v24 = [widthAnchor constraintGreaterThanOrEqualToAnchor:heightAnchor multiplier:1.0];
    [v24 setActive:1];

    widthAnchor2 = [(SHSBadgeView *)v3 widthAnchor];
    ...
    heightAnchor2 = [(SHSBadgeView *)v3 heightAnchor];
    ...
    topAnchor = [(SHSBadgeView *)v3 topAnchor];
    ...
    trailingAnchor = [(SHSBadgeView *)v3 trailingAnchor];
    ...
    leadingAnchor2 = [(SHSBadgeView *)v3 leadingAnchor];
    ...
    bottomAnchor2 = [(SHSBadgeView *)v3 bottomAnchor];
    defaultMetrics8 = [MEMORY[0x277D75520] defaultMetrics];
    [defaultMetrics8 scaledValueForValue:v3->_minPadding];
    v46 = [bottomAnchor constraintGreaterThanOrEqualToAnchor:bottomAnchor2 constant:?];
    [v46 setActive:1];

    badgeLabel = [(SHSBadgeView *)v3 badgeLabel];
    centerYAnchor = [badgeLabel centerYAnchor];
    centerYAnchor2 = [(SHSBadgeView *)v3 centerYAnchor];
    v50 = [centerYAnchor constraintEqualToAnchor:centerYAnchor2];
    [v50 setActive:1];

    badgeLabel2 = [(SHSBadgeView *)v3 badgeLabel];
    centerXAnchor = [badgeLabel2 centerXAnchor];
    centerXAnchor2 = [(SHSBadgeView *)v3 centerXAnchor];
