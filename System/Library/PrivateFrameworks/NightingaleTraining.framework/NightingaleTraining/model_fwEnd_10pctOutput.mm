...
- (model_fwEnd_10pctOutput)initWithOut:(id)out lstm_1_h_out:(id)lstm_1_h_out lstm_1_c_out:(id)lstm_1_c_out;
@end
...
- (model_fwEnd_10pctOutput)initWithOut:(id)out lstm_1_h_out:(id)lstm_1_h_out lstm_1_c_out:(id)lstm_1_c_out
{
  ...
  v15.receiver = self;
  v15.super_class = model_fwEnd_10pctOutput;
...
- (id)featureValueForName:(id)name
{
  ...
  if ([nameCopy isEqualToString:@"out"])
  {
    ...
    lstm_1_h_out = [(model_fwEnd_10pctOutput *)self out];
LABEL_7:
    v7 = lstm_1_h_out;
  ...
  {
    v5 = MEMORY[0x277CBFEF8];
    lstm_1_h_out = [(model_fwEnd_10pctOutput *)self lstm_1_h_out];
    goto LABEL_7;
  }
  ...
  {
    v5 = MEMORY[0x277CBFEF8];
    lstm_1_h_out = [(model_fwEnd_10pctOutput *)self lstm_1_c_out];
    goto LABEL_7;
  }
