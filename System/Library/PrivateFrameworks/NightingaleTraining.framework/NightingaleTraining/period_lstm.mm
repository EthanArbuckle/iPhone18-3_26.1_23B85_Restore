...
- (id)predictionFromFeatures:(id)a3 error:(id *)a4
{
  ...
  v9 = [(period_lstm *)self predictionFromFeatures:v7 options:v8 error:a4];
...
- (id)predictionFromIn:(id)a3 lstm_1_h_in:(id)a4 lstm_1_c_in:(id)a5 error:(id *)a6
{
  ...
  v14 = [(period_lstm *)self predictionFromFeatures:v13 error:a6];
