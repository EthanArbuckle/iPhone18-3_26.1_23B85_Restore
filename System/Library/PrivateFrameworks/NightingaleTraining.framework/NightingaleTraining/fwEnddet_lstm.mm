...
- (fwEnddet_lstm)init;
- (fwEnddet_lstm)initWithConfiguration:(id)configuration error:(id *)error;
- (fwEnddet_lstm)initWithContentsOfURL:(id)l configuration:(id)configuration error:(id *)error;
- (fwEnddet_lstm)initWithContentsOfURL:(id)l error:(id *)error;
- (fwEnddet_lstm)initWithMLModel:(id)model;
...
- (fwEnddet_lstm)init
{
  ...
  v4 = [(fwEnddet_lstm *)self initWithContentsOfURL:uRLOfModelInThisBundle error:0];
...
- (fwEnddet_lstm)initWithConfiguration:(id)configuration error:(id *)error
{
  ...
  uRLOfModelInThisBundle = [objc_opt_class() URLOfModelInThisBundle];
  v8 = [(fwEnddet_lstm *)self initWithContentsOfURL:uRLOfModelInThisBundle configuration:configurationCopy error:error];
...
- (id)predictionFromFeatures:(id)features error:(id *)error
{
  ...
  v9 = [(fwEnddet_lstm *)self predictionFromFeatures:featuresCopy options:v8 error:error];
...
- (id)predictionFromFeatures:(id)features options:(id)options error:(id *)error
{
  optionsCopy = options;
  featuresCopy = features;
  model = [(fwEnddet_lstm *)self model];
  ...
  if (v11)
  {
    ...
    v19 = [(fwEnddet_lstmOutput *)v12 initWithOut:multiArrayValue lstm_1_h_out:multiArrayValue2 lstm_1_c_out:multiArrayValue3];
  }
...
- (id)predictionFromIn:(id)in lstm_1_h_in:(id)lstm_1_h_in lstm_1_c_in:(id)lstm_1_c_in error:(id *)error
{
  ...
  inCopy = in;
  v13 = [[fwEnddet_lstmInput alloc] initWithIn:inCopy lstm_1_h_in:lstm_1_h_inCopy lstm_1_c_in:lstm_1_c_inCopy];

  v14 = [(fwEnddet_lstm *)self predictionFromFeatures:v13 error:error];
  ...
  if (v12)
  {
    ...
    if ([v12 count] >= 1)
    {
      ...
      do
      {
        ...
        v24 = [(fwEnddet_lstmOutput *)v16 initWithOut:multiArrayValue lstm_1_h_out:multiArrayValue2 lstm_1_c_out:multiArrayValue3];
