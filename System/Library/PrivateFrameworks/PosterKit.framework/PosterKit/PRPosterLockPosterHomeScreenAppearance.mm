...
- (PRPosterLockPosterHomeScreenAppearance)initWithBSXPCCoder:(id)coder;
- (PRPosterLockPosterHomeScreenAppearance)initWithCoder:(id)coder;
- (PRPosterLockPosterHomeScreenAppearance)initWithLegibilityBlurEnabled:(BOOL)enabled allowsModifyingLegibilityBlur:(BOOL)blur;
...
- (id)copyWithLegibilityBlurEnabled:(BOOL)enabled
{
  ...
  allowsModifyingLegibilityBlur = [(PRPosterLockPosterHomeScreenAppearance *)self allowsModifyingLegibilityBlur];
...
{
  coderCopy = coder;
  [coderCopy encodeBool:-[PRPosterLockPosterHomeScreenAppearance isLegibilityBlurEnabled](self forKey:{"isLegibilityBlurEnabled"), @"legibilityBlurEnabled"}];
  [coderCopy encodeBool:-[PRPosterLockPosterHomeScreenAppearance allowsModifyingLegibilityBlur](self forKey:{"allowsModifyingLegibilityBlur"), @"allowsModifyingLegibilityBlur"}];
}
...
- (void)appendDescriptionToFormatter:(id)formatter
{
  ...
  v4 = [formatterCopy appendBool:-[PRPosterLockPosterHomeScreenAppearance isLegibilityBlurEnabled](self withName:{"isLegibilityBlurEnabled"), @"legibilityBlurEnabled"}];
  v5 = [formatterCopy appendBool:-[PRPosterLockPosterHomeScreenAppearance allowsModifyingLegibilityBlur](self withName:{"allowsModifyingLegibilityBlur"), @"allowsModifyingLegibilityBlur"}];
}
