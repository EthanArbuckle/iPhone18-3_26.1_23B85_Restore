...
- (void)buildCoordinators
{
  ...
  if (!self->_coordinators)
  {
    ...
    v4 = [(PREditorContentStylePickerConfiguration *)self->_configuration suggestedStyle];
    v5 = [(PREditorContentStylePickerConfiguration *)self->_configuration stylePalette];
    if (self->_includeSuggestedStyle && [(PREditorContentStylePickerConfiguration *)self->_configuration showsSuggestedContentStyleItem]&& v4)
    {
      ...
      if ([v5 isDefaultPalette] && objc_msgSend(v5, "context") == 1)
      {
        ...
        v12 = [(PREditorContentStylePalette *)v10 initWithContentStyles:v9 localizedName:v11];
