...
{
  v2 = [(DAABLegacyContact *)self person];
  v3 = ABRecordCopyValue(v2, kABPersonExternalModificationTagProperty);
...
- (void)setETag:(id)a3
{
  ...
  ABRecordSetValue(v4, kABPersonExternalModificationTagProperty, value, 0);
}

- (id)externalUUID
{
  v2 = [(DAABLegacyContact *)self person];
  v3 = ABRecordCopyValue(v2, kABPersonExternalUUIDProperty);
...
- (void)setExternalUUID:(id)a3
{
  value = a3;
  v4 = [(DAABLegacyContact *)self person];
  ABRecordSetValue(v4, kABPersonExternalUUIDProperty, value, 0);
}

- (id)externalIdentifier
{
  v2 = [(DAABLegacyContact *)self person];
  v3 = ABRecordCopyValue(v2, kABPersonExternalIdentifierProperty);
...
- (void)setExternalIdentifier:(id)a3
{
  value = a3;
  v4 = [(DAABLegacyContact *)self person];
  ABRecordSetValue(v4, kABPersonExternalIdentifierProperty, value, 0);
}
