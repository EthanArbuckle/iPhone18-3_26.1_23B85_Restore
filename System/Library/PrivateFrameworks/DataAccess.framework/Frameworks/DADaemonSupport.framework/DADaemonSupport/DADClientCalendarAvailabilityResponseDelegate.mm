...
- (DADClientCalendarAvailabilityResponseDelegate)initWithAccountID:(id)a3 client:(id)a4 startDate:(id)a5 endDate:(id)a6 ignoredEventID:(id)a7 addresses:(id)a8;
- (void)calendarAvailabilityRequestReturnedResults:(id)a3;
- (void)dealloc;
...
- (DADClientCalendarAvailabilityResponseDelegate)initWithAccountID:(id)a3 client:(id)a4 startDate:(id)a5 endDate:(id)a6 ignoredEventID:(id)a7 addresses:(id)a8
{
  ...
  v18 = [(DADClientDelegate *)&v27 initWithAccountID:a3 client:a4];
  v19 = v18;
  if (v18)
  {
    objc_storeStrong(&v18->_startDate, a5);
    objc_storeStrong(&v19->_endDate, a6);
    objc_storeStrong(&v19->_ignoredEventID, a7);
    objc_storeStrong(&v19->_addresses, a8);
    v20 = objc_opt_class();
        ...
        if (v10 == -1)
        {
          ...
          else
          {
            ...
            if (os_log_type_enabled(v18, v19))
            {
              v20 = objc_opt_class();
              v21 = v20;
              v22 = [(DADClientDelegate *)self accountID];
              *buf = 138412546;
              v30 = v20;
              v31 = 2114;
              v32 = v22;
...
{
  v4 = a3;
  if (v4 && !-[DADisableableObject isDisabled](self, "isDisabled") && [v4 count])
  {
    queue = self->_queue;
