...
- (DADStatusReportAggregator)initWithStatusReports:(id)a3 numOutstandingReports:(int)a4 timeout:(double)a5 completionBlock:(id)a6;
...
- (DADStatusReportAggregator)initWithStatusReports:(id)a3 numOutstandingReports:(int)a4 timeout:(double)a5 completionBlock:(id)a6
{
  ...
  v11 = a6;
  v34.receiver = self;
  v34.super_class = DADStatusReportAggregator;
  v12 = [(DADStatusReportAggregator *)&v34 init];
  v13 = v12;
  if (v12)
  {
