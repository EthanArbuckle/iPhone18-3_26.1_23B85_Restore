...
- (id)URLWithUsername:()DAKeychainAddition withPassword:
{
  v6 = a3;
  v7 = a4;
  if (v6 && ![(__CFString *)v6 isEqualToString:&stru_285AA6518])
  {
    if (v7)
    {
      v11 = [a1 scheme];
      ...
      {
        v16 = CFURLCreateStringByAddingPercentEscapes(0, v6, &stru_285AA6518, @"?@/|:", 0x8000100u);
        v17 = CFURLCreateStringByAddingPercentEscapes(0, v7, &stru_285AA6518, @"?@/|:", 0x8000100u);
...
- (id)URLWithUsername:()DAKeychainAddition
{
  ...
  if (v4 && ![(__CFString *)v4 isEqualToString:&stru_285AA6518])
  {
    ...
    if ([v10 hasPrefix:v8])
    {
      v11 = CFURLCreateStringByAddingPercentEscapes(0, v5, &stru_285AA6518, @"?@/|:", 0x8000100u);
