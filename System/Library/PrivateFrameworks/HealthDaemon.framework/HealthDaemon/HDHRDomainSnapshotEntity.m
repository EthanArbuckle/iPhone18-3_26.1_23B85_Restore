@interface HDHRDomainSnapshotEntity
+ (id)databaseTable;
+ (id)defaultForeignKey;
+ (id)foreignKeys;
+ (id)privateSubEntities;
- (_TtC12HealthDaemon24HDHRDomainSnapshotEntity)init;
- (_TtC12HealthDaemon24HDHRDomainSnapshotEntity)initWithPersistentID:(int64_t)a3;
@end

@implementation HDHRDomainSnapshotEntity
...
+ (id)privateSubEntities
{
  ...
  *(v2 + 32) = type metadata accessor for HDHRDomainSnapshotMEntity();
  sub_2289BF80C();
  v3 = sub_22911C44C();
...
{
  v5.receiver = self;
  v5.super_class = type metadata accessor for HDHRDomainSnapshotEntity();
...
- (_TtC12HealthDaemon24HDHRDomainSnapshotEntity)init
{
  ...
  return [(HDHRDomainSnapshotEntity *)&v3 init];
}
