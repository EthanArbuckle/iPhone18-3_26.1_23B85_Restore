...
- (BOOL)combineWithTask:(id)a3
{
  v4 = a3;
  objc_opt_class();
  if ((objc_opt_isKindOfClass() & 1) != 0 && (-[HDCloudSyncManagerRepositoryTask context](self, "context"), v5 = objc_claimAutoreleasedReturnValue(), [v4 context], v6 = objc_claimAutoreleasedReturnValue(), v7 = objc_msgSend(v5, "isEquivalent:", v6), v6, v5, v7))
  {
    [v4 mirrorTask:self];
    v8 = 1;
  }
