...
- (BOOL)performWithProfile:(id)a3 transaction:(id)a4 error:(id *)a5
{
  ...
  v88 = 0;
  v81 = v10;
  v13 = [(HDDataEntity *)HDQuantitySampleSeriesEntity anyInDatabase:v10 predicate:v12 error:&v88];
  v14 = v88;

  v80 = v9;
  if (v13)
  {
    v15 = [v13 hasSeriesDataWithTransaction:v9 error:a5];
    v16 = v15;
    if (!v15)
    {
      v22 = 0;
...
LABEL_72:
    ...
    if ([v15 BOOLValue])
    {
      ...
      v75 = a5;
      v18 = [v13 countForSeriesWithTransaction:v9 error:a5];
      v19 = v18;
      if (v18)
      {
        v20 = v78;
        ...
        {
          v21 = [v13 HFDKeyWithDatabase:v81 error:a5];
          if (!v21)
          {
            v14 = 0;
LABEL_28:
...
LABEL_69:
        ...
        v14 = [v13 freezeWithEndDate:self->_endDate transaction:v17 profile:v78 error:a5];
...
LABEL_51:
            ...
            if (v51)
            {
              ...
              {
                v53 = v52;
                v54 = [v20 dataProvenanceManager];
                v82 = v71;
                v55 = [v54 originProvenanceForPersistentID:v53 transaction:v80 error:&v82];
                v14 = v82;
              ...
              [v61 shouldNotifyForDataObjects:v62 provenance:v55 database:v81 anchor:v56];
...
LABEL_50:
          v45 = v26;
          v46 = v36[59];
          v47 = [v21 longLongValue];
          v48 = v46;
          v26 = v45;
          if ([(__objc2_class *)v48 deleteSeriesDataWithKey:v47 database:v81 error:v75])
          {
            goto LABEL_51;
          }
        ...
        v87 = 0;
        v27 = [(HDDataEntity *)HDQuantitySampleSeriesEntity objectWithID:v26 encodingOptions:0 profile:v78 error:&v87];
        v28 = v87;
        if (!v27)
        {
          if (v28)
...
LABEL_67:
        ...
        v67 = v27;
        v70 = v32;
        v33 = [(HDDataEntity *)HDQuantitySampleSeriesEntity shouldInsertObject:v27 sourceID:v32 profile:v78 transaction:v29 objectToReplace:&v86 objectID:&v85 error:v75];
        v34 = v86;
        v35 = v85;
        v65 = v35;
        v66 = v34;
        ...
        else
        {
          if (v33 == 1)
          {
            ...
            v26 = v69;
            v21 = v72;
            if (![HDQuantitySampleSeriesEntity deleteSeriesWithID:v69 deleteSeriesData:1 profile:v78 transaction:v80 error:v75])
            {
              v41 = 0;
              v22 = 0;
              v39 = v67;
...
LABEL_68:
          ...
          v22 = v35;
          v42 = [v78 metadataManager];
          v39 = v27;
          v43 = [v42 insertMetadata:self->_metadata forObjectID:v69 sourceID:v70 externalSyncObjectCode:objc_msgSend(v27 objectDeleted:"_externalSyncObjectCode") error:{0, v75}];

          v21 = v72;
          if (v43)
          {
            v26 = v69;
            if ([HDQuantitySampleSeriesEntity replaceObjectID:v22 replacementObjectID:v69 deleteOriginalSeriesData:1 profile:v78 transaction:v80 error:v75])
            {
              v36 = off_27860F000;
              goto LABEL_37;
            }
    ...
    else
    {
      ...
      v20 = v78;
      v23 = [HDQuantitySampleSeriesEntity deleteSeriesWithID:v19 deleteSeriesData:1 profile:v78 transaction:v9 error:a5];
      v22 = 0;
    }
