...
+ (id)insertDataObject:(id)a3 withProvenance:(id)a4 inDatabase:(id)a5 persistentID:(id)a6 error:(id *)a7
{
  ...
  if (([v15 isEqual:objc_opt_class()] & 1) == 0)
  {
    ...
    [v24 handleFailureInMethod:a2 object:a1 file:@"HDFitnessFriendWorkoutEntity.m" lineNumber:108 description:{@"Subclasses must override %s", "+[HDFitnessFriendWorkoutEntity insertDataObject:withProvenance:inDatabase:persistentID:error:]"}];
  }
...
+ (BOOL)enumerateWorkoutsWithPredicate:(id)a3 anchor:(id *)a4 profile:(id)a5 error:(id *)a6 handler:(id)a7
{
  ...
  v16 = [MEMORY[0x277CCD720] fitnessFriendWorkoutType];
  v17 = [(HDSampleEntity *)HDFitnessFriendWorkoutEntity entityEnumeratorWithType:v16 profile:v11];
