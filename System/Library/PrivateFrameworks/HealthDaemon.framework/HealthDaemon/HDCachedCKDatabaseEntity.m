...
+ (id)insertWithContainerIdentifier:(id)a3 databaseScope:(int64_t)a4 userRecordName:(id)a5 serverChangeToken:(id)a6 transaction:(id)a7 error:(id *)a8
{
  ...
  v28 = v21;
  v29 = v15;
  v22 = [v20 executeCachedStatementForKey:&insertWithContainerIdentifier_databaseScope_userRecordName_serverChangeToken_transaction_error__lookupKey error:a8 SQLGenerator:v31 bindingHandler:v26 enumerationHandler:0];
  v19 = 0;
  if (v22)
  {
...
+ (BOOL)updateServerChangeToken:(id)a3 containerIdentifier:(id)a4 databaseScope:(int64_t)a5 transaction:(id)a6 error:(id *)a7
{
  ...
  v15 = [MEMORY[0x277CCAAB0] archivedDataWithRootObject:v12 requiringSecureCoding:1 error:a7];
  if (v15)
  {
LABEL_5:
    v17 = [v14 databaseForEntityClass:a1];
    v18 = HDPredicateForContainerIdentifierAndDatabaseScope(v13, a5);
    ...
    v24 = v15;
    v20 = v15;
    v16 = [a1 updateProperties:v19 predicate:v18 database:v17 error:a7 bindingHandler:v23];
...
+ (id)entityForContainerIdentifier:(id)a3 databaseScope:(int64_t)a4 userRecordName:(id)a5 transaction:(id)a6 shouldCreate:(BOOL)a7 error:(id *)a8
{
  ...
  v28[3] = &unk_278614620;
  v28[4] = &v33;
  v20 = [v18 executeCachedStatementForKey:&entityForContainerIdentifier_databaseScope_userRecordName_transaction_shouldCreate_error__lookupKey error:a8 SQLGenerator:v32 bindingHandler:v29 enumerationHandler:v28];
  ...
  if (v20)
  {
    ...
    if (v16)
    {
      v22 = [a1 insertWithContainerIdentifier:v19 databaseScope:a4 userRecordName:v16 serverChangeToken:0 transaction:v17 error:a8];
LABEL_7:
      v23 = v22;
      goto LABEL_14;
    }
...
+ (BOOL)deleteDatabasesNotMatchingUserRecordName:(id)a3 profile:(id)a4 error:(id *)a5
{
  ...
  v12 = [v9 stringWithFormat:@"DELETE FROM %@ WHERE %@ != ?", v11, @"account_user_record_name"];
  ...
  v14 = v8;
  v15 = v12;
  LOBYTE(a5) = [(HDHealthEntity *)HDCachedCKDatabaseEntity performWriteTransactionWithHealthDatabase:v13 error:a5 block:v17];
...
+ (BOOL)insertOrUpdateWithContainerIdentifier:(id)a3 databaseScope:(int64_t)a4 userRecordName:(id)a5 serverChangeToken:(id)a6 profile:(id)a7 error:(id *)a8
{
  ...
  v19 = v15;
  v20 = v14;
  LOBYTE(a8) = [(HDHealthEntity *)HDCachedCKDatabaseEntity performWriteTransactionWithHealthDatabase:v17 error:a8 block:v22];
...
{
  v10 = a5;
  v11 = HDPredicateForContainerIdentifierAndDatabaseScope(a3, a4);
  v12 = [v10 database];

  v13 = [a1 propertyValueForAnyWithProperty:@"server_change_token" predicate:v11 healthDatabase:v12 error:a6];

  if (v13)
  {
    v14 = [MEMORY[0x277CCAAC8] unarchivedObjectOfClass:objc_opt_class() fromData:v13 error:a6];
  }
...
- (BOOL)setCurrentEpoch:(int64_t)a3 transaction:(id)a4 error:(id *)a5
{
  ...
  v10[4] = self;
  v10[5] = a3;
  LOBYTE(a5) = [v8 executeCachedStatementForKey:&setCurrentEpoch_transaction_error__lookupKey error:a5 SQLGenerator:&__block_literal_global_198 bindingHandler:v10 enumerationHandler:0];
...
+ (int64_t)previousEpochForTransaction:(id)a3 error:(id *)a4
{
  ...
  v18[3] = &unk_278614620;
  v8 = [v7 executeCachedStatementForKey:&previousEpochForTransaction_error__lookupKey error:&v20 SQLGenerator:v19 bindingHandler:0 enumerationHandler:v18];
  v9 = v20;
  v10 = v9;
  if ((v8 & 1) == 0)
  {
