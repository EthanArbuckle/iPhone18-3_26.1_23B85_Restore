@interface HDHRIndicatorSnapshotEntity
+ (id)databaseTable;
...
+ (id)privateSubEntities
{
  ...
  *(v2 + 32) = type metadata accessor for HDHRIndicatorSnapshotMEntity();
  sub_2289BF80C();
  v3 = sub_22911C44C();
...
{
  v3.receiver = self;
  v3.super_class = type metadata accessor for HDHRIndicatorSnapshotEntity();
  return [(HDHRIndicatorSnapshotEntity *)&v3 init];
}
