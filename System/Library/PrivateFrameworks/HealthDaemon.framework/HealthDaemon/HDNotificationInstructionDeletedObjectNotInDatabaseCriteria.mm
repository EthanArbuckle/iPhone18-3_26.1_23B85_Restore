...
- (int64_t)isValidWithDatabaseTransaction:(id)transaction error:(id *)error
{
  ...
  v11[3] = &unk_278614620;
  v11[4] = &v13;
  if (![v7 executeCachedStatementForKey:&isValidWithDatabaseTransaction_error__lookupKey error:error SQLGenerator:&__block_literal_global_189 bindingHandler:v12 enumerationHandler:v11])
  {
LABEL_5:
    v9 = 0;
    goto LABEL_6;
