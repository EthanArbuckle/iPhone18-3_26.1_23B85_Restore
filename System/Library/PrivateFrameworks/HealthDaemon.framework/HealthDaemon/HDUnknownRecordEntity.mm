...
+ (id)insertDataObject:(id)a3 withProvenance:(id)a4 inDatabase:(id)a5 persistentID:(id)a6 error:(id *)a7
{
  ...
  if (([v15 isEqual:objc_opt_class()] & 1) == 0)
  {
    ...
    [v24 handleFailureInMethod:a2 object:a1 file:@"HDUnknownRecordEntity.m" lineNumber:51 description:{@"Subclasses must override %s", "+[HDUnknownRecordEntity insertDataObject:withProvenance:inDatabase:persistentID:error:]"}];
  }
