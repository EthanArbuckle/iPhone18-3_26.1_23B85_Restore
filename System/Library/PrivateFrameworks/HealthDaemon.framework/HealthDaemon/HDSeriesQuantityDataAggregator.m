...
- (id)initForQuantityType:(id)a3 dataCollectionManager:(id)a4
{
  ...
  result = [(HDActiveQuantityDataAggregator *)&v5 initForQuantityType:a3 dataCollectionManager:a4];
  if (result)
  {
    *(result + 26) = 0;
  }
...
- (id)aggregateForState:(id)a3 collector:(id)a4 device:(id)a5 requestedAggregationDate:(id)a6 mode:(int64_t)a7 options:(unint64_t)a8 error:(id *)a9
{
  ...
  if (self)
  {
    ...
    if (objc_opt_isKindOfClass())
    {
      ...
      if (v14 && (objc_opt_class(), (objc_opt_isKindOfClass() & 1) == 0))
      {
        ...
        v21 = [v13 unaggregatedSensorData];
        v98 = [v20 initWithRemainingSensorData:v21];
      }
    ...
    else
    {
      ...
      v14 = [v13 unaggregatedSensorData];
      v98 = [(HDDataAggregationState *)v16 initWithRemainingSensorData:v14];
    }
  }
  ...
  *&buf[16] = 0x3032000000;
  ...
  v158 = [(HDDataAggregationState *)v98 openSeries];
  v148 = 0;
  v149 = &v148;
  v150 = 0x3032000000;
  v151 = __Block_byref_object_copy__9;
  v152 = __Block_byref_object_dispose__9;
  v153 = [(_HDSeriesQuantityDataAggregationState *)v98 lastDatum];
  v142 = 0;
  v143 = &v142;
  v144 = 0x3032000000;
  ...
  if (*(*&buf[8] + 40))
  {
    ...
    if ((objc_opt_isKindOfClass() & 1) == 0)
    {
      ...
      [v88 handleFailureInMethod:a2 object:v102 file:@"HDSeriesQuantityDataAggregator.m" lineNumber:187 description:{@"Invalid parameter not satisfying: %@", @"currentSeries == nil || [currentSeries isKindOfClass:[HKQuantitySample class]]"}];
  ...
  [(HDActiveDataAggregator *)v22 aggregationIntervalForCollector:v97];
  v25 = v24;
  v101 = [(HDDataAggregator *)v22 configuration];
  v132 = 0;
  v133 = &v132;
  v134 = 0x3032000000;
  ...
  v137 = 0;
  v26 = [(HDDataAggregator *)v22 dataCollectionManager];
  v27 = [v26 profile];
  v28 = [v27 dataManager];
  v29 = [v28 quantitySeriesManager];
  ...
  if ([(HDSeriesQuantityDataAggregator *)v102 shouldAggregateToSeriesForState:v98 collector:v97 device:v95 requestedAggregationDate:v99 mode:a7 options:a8])
  {
    ...
    v113 = 0u;
    v114 = 0u;
    v32 = [(HDDataAggregationState *)v98 unaggregatedSensorData];
    v33 = [v32 countByEnumeratingWithState:&v113 objects:v154 count:16];
    if (v33)
    {
      v34 = *v114;
      do
      {
        for (i = 0; i != v33; ++i)
        {
          ...
          if ((objc_opt_isKindOfClass() & 1) == 0)
          {
            ...
            [v44 handleFailureInMethod:a2 object:v102 file:@"HDSeriesQuantityDataAggregator.m" lineNumber:270 description:{@"Invalid parameter not satisfying: %@", @"[datum isKindOfClass:[HDQuantityDatum class]]"}];
          }
          ...
          if (*(*&buf[8] + 40))
          {
            ...
            v38 = v139[3];
            v39 = [v133[5] count];
            if ([(HDSeriesQuantityDataAggregator *)v102 requiresNewSeriesForDatum:v36 lastDatum:v37 seriesLength:v39 + v38 currentSeries:*(*&buf[8] + 40) configuration:v101 aggregationInterval:v25])
            {
              v31[2](v31);
            }
          }
          ...
          [(HDSeriesQuantityDataAggregator *)v102 addDatum:v36 toAccumulatedData:v40];
    ...
    if ([v133[5] count])
    {
      ...
      for (j = 0; j < [v133[5] count]; ++j)
      {
        ...
        v53 = [v51 endDate];
        v54 = [v53 hk_isBeforeOrEqualToDate:v99];

        if (v54 & 1) != 0 || !a7 && ([v52 startDate], v55 = objc_claimAutoreleasedReturnValue(), v56 = objc_msgSend(v55, "hk_isBeforeOrEqualToDate:", v99), v55, (v56))
        {
        }
...
LABEL_44:
      ...
      if (j)
      {
        ...
        v64 = [(HDSeriesQuantityDataAggregator *)v102 _codableDatumsFromData:v61];
    ...
    v72 = *(*&buf[8] + 40);
    if (v72 && [(HDSeriesQuantityDataAggregator *)v45 shouldFreezeCurrentSeries:v72 lastDatum:v149[5] seriesLength:v139[3] configuration:v101 aggregationInterval:v25])
    {
      v31[2](v31);
    }
  ...
  else
  {
    ...
    v60 = [(HDActiveQuantityDataAggregator *)&v121 aggregateForState:v98 collector:v97 device:v95 requestedAggregationDate:v99 mode:a7 options:a8 error:a9];
  }
