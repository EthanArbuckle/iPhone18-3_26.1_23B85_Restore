...
- (id)description
{
  ...
  v8.receiver = self;
  v8.super_class = HDCodableCompanionUserNotificationResponse;
  v4 = [(HDCodableCompanionUserNotificationResponse *)&v8 description];
  dictionaryRepresentation = [(HDCodableCompanionUserNotificationResponse *)self dictionaryRepresentation];
...
- (void)mergeFrom:(id)from
{
  ...
  if (*(fromCopy + 2))
  {
    [(HDCodableCompanionUserNotificationResponse *)self setRequestIdentifier:?];
    fromCopy = v7;
  }
