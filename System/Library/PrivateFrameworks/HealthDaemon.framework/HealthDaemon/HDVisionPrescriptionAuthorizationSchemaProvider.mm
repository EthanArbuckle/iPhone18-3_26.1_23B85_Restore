...
- (int64_t)isClientAuthorizedToReadObject:(id)object sourceBundleIdentifier:(id)identifier clientEntitlements:(id)entitlements profile:(id)profile error:(id *)error
{
  ...
  if (objc_opt_respondsToSelector())
  {
    ...
    if (hk_objectType)
    {
      ...
      v38 = 0;
      v23 = [sourceManager localSourceForBundleIdentifier:identifierCopy error:&v38];
      v18 = v38;
...
- (BOOL)setObjectAuthorizationStatusContext:(id)context forObjectType:(id)type bundleIdentifier:(id)identifier profile:(id)profile error:(id *)error
{
  ...
  sourceManager = [profileCopy sourceManager];
  v50 = 0;
  v15 = [sourceManager localSourceForBundleIdentifier:identifierCopy error:&v50];
  v16 = v50;

  if (v15)
  {
    v44 = [v15 sourceUUIDWithProfile:profileCopy error:error];
    if (v44)
    {
      errorCopy = error;
      v39 = v16;
      ...
      if (v19)
      {
        ...
        while (2)
        {
          for (i = 0; i != v20; ++i)
          {
            ...
            {
              typeCopy = v43;
              [MEMORY[0x277CCA9B8] hk_assignError:errorCopy code:2000 format:{@"%@: Domain of the concept identifier does not match the right domain for the following object type %@:", objc_opt_class(), v43}];
            ...
            v33 = [v29 initWithObjectUUID:v28 sourceUUID:v44 sessionUUID:sessionIdentifier status:v32 modificationDate:CFAbsoluteTimeGetCurrent()];
      ...
      profileCopy = v41;
      v34 = +[HDObjectAuthorizationEntity setObjectAuthorizationRecords:syncProvenance:syncIdentity:profile:error:](HDObjectAuthorizationEntity, "setObjectAuthorizationRecords:syncProvenance:syncIdentity:profile:error:", v17, 0, [v41 currentSyncIdentityPersistentID], v41, errorCopy);
      typeCopy = v43;
LABEL_16:
