...
uint64_t _HDConcreteStatisticsCollectionCalculatorImplementation<HDStatisticsRelative<HDStatisticsCumulative>>::_primitiveAddSample(uint64_t a1, uint64_t a2, int a3, uint64_t a4)
{
  ...
  if (v9 >= _HDConcreteStatisticsCollectionCalculatorImplementation<HDStatisticsRelative<HDStatisticsCumulative>>::_earliestStartTimeWithoutInvalidation(a1))
  {
    if (*(a1 + 40) && a3)
    {
      _HDConcreteStatisticsCollectionCalculatorImplementation<HDStatisticsRelative<HDStatisticsCumulative>>::_advanceToTime(a1, v9);
    }
...
LABEL_16:
  v33 = v20;
  v34 = v15;
  std::__hash_table<long long,std::hash<long long>,std::equal_to<long long>,std::allocator<long long>>::__emplace_unique_key_args<long long,long long const&>((a1 + 256), v18);
...
void HDStatisticsCollectionEngine<HDStatisticsRelative<HDStatisticsCumulative>>::advanceBucket(void *a1, double a2, double a3)
{
  v9 = 0;
  v10 = 0;
  v11 = 0;
...
LABEL_46:
      ...
      if (v46)
      {
        ...
        while (2)
        {
          for (j = 0; j != v46; ++j)
          {
            ...
            v49 = *(*(&v70 + 1) + 8 * j);
            v50 = _HDConcreteStatisticsCollectionCalculatorImplementation<HDStatisticsCumulative>::_primitiveInvalidateInterval(a1, v49, v68);
    ...
    if (_HDConcreteStatisticsCollectionCalculatorImplementation<HDStatisticsCumulative>::_primitiveInvalidateInterval(a1, 0, v68))
    {
      goto LABEL_58;
    }
...
void _HDConcreteStatisticsCollectionCalculatorImplementation<HDStatisticsCumulative>::encodeInternalsWithEncoder(uint64_t a1, void *a2)
{
  ...
  HDStatisticsCumulative::archive((a1 + 240), &v40);
  statistics::Statistics::operator=(*(&v23 + 1), &v40);
  statistics::Statistics::~Statistics(&v40);
  v9 = *(a1 + 296);
  if (v9 != a1 + 304)
  {
    HDStatisticsCumulative::archive((v9 + 40), &v40);
    v10 = *(v9 + 32);
    v47 |= 0x200u;
    v46 = v10;
...
void sub_228ED7FB8(_Unwind_Exception *a1, uint64_t a2, void *a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, ...)
{
  va_start(va, a10);
...
id _HDConcreteStatisticsCollectionCalculatorImplementation<HDStatisticsCumulative>::_statisticsFromFinishedBucket(uint64_t a1, double *a2)
{
  ...
  v13 = [objc_alloc(MEMORY[0x277CCDA50]) initWithDataType:v9 startDate:v71 endDate:v8];
  if (*(a1 + 24))
  {
    WeakRetained = objc_loadWeakRetained((a1 + 48));
  ...
  *__p = *(v74 + 120);
  ...
  v25 = *(v23 + 24);
  v27 = *(v23 + 32);
  v28 = [MEMORY[0x277CCD7E8] quantityWithUnit:v73 doubleValue:*v23];
  [v72 setSumQuantity:v28];

  [v72 setDataCount:v24];
  v29 = *(a1 + 24);
  v70 = v29;
  if ((v29 & 0x20) != 0)
  {
    v30 = [MEMORY[0x277CCD7E8] quantityWithUnit:v73 doubleValue:v26];
    [v72 setMostRecentQuantity:v30];

    v31 = [MEMORY[0x277CCA970] hk_dateIntervalWithStart:v25 end:v27];
    [v72 setMostRecentQuantityDateInterval:v31];
  ...
  *__p = 0u;
  ...
  do
  {
    v33 = HDStatisticsBucket<HDStatisticsCumulative>::_bundleIdentifierForSourceID(v74, v32[4]);
    v34 = v33;
    if (!v33)
    {
      goto LABEL_48;
...
LABEL_48:
  ...
  {
    v55 = i[2];
    if (!v80 || ([MEMORY[0x277CCD7E8] quantityWithUnit:v73 doubleValue:{*(*(*v80 + 48))(v80, i + 3)}], v56 = objc_claimAutoreleasedReturnValue(), objc_msgSend(v69, "setObject:forKeyedSubscript:", v56, v55), v56, !v80))
    {
      std::__throw_bad_function_call[abi:ne200100]();
    }

    v57 = [MEMORY[0x277CCABB0] numberWithLongLong:{*((*(*v80 + 48))(v80, i + 3) + 8)}];
    [v68 setObject:v57 forKeyedSubscript:v55];
    ...
    if ((v70 & 0x20) != 0)
    {
      ...
      v59 = *(v58 + 24);
      v60 = *(v58 + 32);
      v61 = [MEMORY[0x277CCD7E8] quantityWithUnit:v73 doubleValue:*(v58 + 16)];
      [v65 setObject:v61 forKeyedSubscript:v55];

      v62 = [MEMORY[0x277CCA970] hk_dateIntervalWithStart:v59 end:v60];
      [v66 setObject:v62 forKeyedSubscript:v55];
    }
  }
...
LABEL_63:
  ...
  [v72 setSumQuantityBySource:v69];
  [v72 setDataCountBySource:v68];
  if ((v70 & 0x20) != 0)
  {
    [v72 setMostRecentQuantityBySource:v65];
    [v72 setMostRecentQuantityDateIntervalBySource:v66];
  }

LABEL_66:
  std::__function::__value_func<HDStatisticsCumulative const& ()(HDStatisticsCumulative const&)>::~__value_func[abi:ne200100](v79);
...
void *HDStatisticsBucket<HDStatisticsCumulative>::_statisticsForSource(uint64_t a1, uint64_t a2)
{
  v8 = a2;
  v4 = *(a1 + 184);
  v2 = (a1 + 184);
...
void *std::__tree<std::__value_type<long long,HDStatisticsCumulative>,std::__map_value_compare<long long,std::__value_type<long long,HDStatisticsCumulative>,std::less<long long>,true>,std::allocator<std::__value_type<long long,HDStatisticsCumulative>>>::__emplace_unique_key_args<long long,std::piecewise_construct_t const&,std::tuple<long long const&>,std::tuple<>>(uint64_t a1, uint64_t a2)
{
  v2 = *(a1 + 8);
  if (!v2)
  {
...
LABEL_375:
    ...
    if (v13 == 4)
    {
      ...
      std::__sort4[abi:ne200100]<std::_ClassicAlgPolicy,HDStatisticsBucket<HDStatisticsCumulative>::_mergeTowardTime(double)::{lambda(HDStatisticsBucket<HDStatisticsCumulative>::_SampleRemainder const&,HDStatisticsBucket<HDStatisticsCumulative>::_SampleRemainder const&)#1} &,HDStatisticsBucket<HDStatisticsCumulative>::_SampleRemainder*,0>(v11, v11 + 48, v11 + 96, (a2 - 3), a3);
      return;
    }
    ...
    if (v13 == 5)
    {
      ...
      std::__sort5[abi:ne200100]<std::_ClassicAlgPolicy,HDStatisticsBucket<HDStatisticsCumulative>::_mergeTowardTime(double)::{lambda(HDStatisticsBucket<HDStatisticsCumulative>::_SampleRemainder const&,HDStatisticsBucket<HDStatisticsCumulative>::_SampleRemainder const&)#1} &,HDStatisticsBucket<HDStatisticsCumulative>::_SampleRemainder*,0>(v11, v11 + 48, v11 + 96, v11 + 144, (a2 - 3), a3);
      return;
    }
...
LABEL_87:
      ...
      *(v11 - 16) = v244;
      ...
      {
LABEL_98:
        std::__introsort<std::_ClassicAlgPolicy,HDStatisticsBucket<HDStatisticsCumulative>::_mergeTowardTime(double)::{lambda(HDStatisticsBucket<HDStatisticsCumulative>::_SampleRemainder const&,HDStatisticsBucket<HDStatisticsCumulative>::_SampleRemainder const&)#1} &,HDStatisticsBucket<HDStatisticsCumulative>::_SampleRemainder*,false>(a1, v11 - 48, a3, a4, a5 & 1);
        a5 = 0;
      }
    }
  }
  ...
  std::__sort3[abi:ne200100]<std::_ClassicAlgPolicy,HDStatisticsBucket<HDStatisticsCumulative>::_mergeTowardTime(double)::{lambda(HDStatisticsBucket<HDStatisticsCumulative>::_SampleRemainder const&,HDStatisticsBucket<HDStatisticsCumulative>::_SampleRemainder const&)#1} &,HDStatisticsBucket<HDStatisticsCumulative>::_SampleRemainder*,0>(v11, (v11 + 48), a2 - 3, a3);
}
...
__n128 std::__sort5[abi:ne200100]<std::_ClassicAlgPolicy,HDStatisticsBucket<HDStatisticsCumulative>::_mergeTowardTime(double)::{lambda(HDStatisticsBucket<HDStatisticsCumulative>::_SampleRemainder const&,HDStatisticsBucket<HDStatisticsCumulative>::_SampleRemainder const&)#1} &,HDStatisticsBucket<HDStatisticsCumulative>::_SampleRemainder*,0>(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6)
{
...
uint64_t _HDConcreteStatisticsCollectionCalculatorImplementation<HDStatisticsCumulative>::_primitiveAddSample(uint64_t a1, uint64_t a2, int a3, uint64_t a4)
{
  ...
  if (v9 >= _HDConcreteStatisticsCollectionCalculatorImplementation<HDStatisticsCumulative>::_earliestStartTimeWithoutInvalidation(a1))
  {
    if (*(a1 + 40) && a3)
    {
      _HDConcreteStatisticsCollectionCalculatorImplementation<HDStatisticsCumulative>::_advanceToTime(a1, v9);
    }
...
LABEL_16:
  v33 = v20;
  v34 = v15;
  std::__hash_table<long long,std::hash<long long>,std::equal_to<long long>,std::allocator<long long>>::__emplace_unique_key_args<long long,long long const&>((a1 + 208), v18);
...
void HDStatisticsCollectionEngine<HDStatisticsCumulative>::advanceBucket(void *a1, double a2, double a3)
{
  v9 = 0;
  v10 = 0;
  v11 = 0;
...
LABEL_46:
      ...
      if (v46)
      {
        ...
        while (2)
        {
          for (j = 0; j != v46; ++j)
          {
            ...
            v49 = *(*(&v63 + 1) + 8 * j);
            v50 = _HDConcreteStatisticsCollectionCalculatorImplementation<HDStatisticsRelative<HDStatisticsCombined<HDStatisticsTemporalBucketWeightedDiscrete<HDStatisticsTemporalBucketWeightedDiscreteParameters>,HDStatisticsTimeInterval>>>::_primitiveInvalidateInterval(a1, v49, v61);
    ...
    if (_HDConcreteStatisticsCollectionCalculatorImplementation<HDStatisticsRelative<HDStatisticsCombined<HDStatisticsTemporalBucketWeightedDiscrete<HDStatisticsTemporalBucketWeightedDiscreteParameters>,HDStatisticsTimeInterval>>>::_primitiveInvalidateInterval(a1, 0, v61))
    {
      goto LABEL_58;
    }
...
void _HDConcreteStatisticsCollectionCalculatorImplementation<HDStatisticsRelative<HDStatisticsCombined<HDStatisticsTemporalBucketWeightedDiscrete<HDStatisticsTemporalBucketWeightedDiscreteParameters>,HDStatisticsTimeInterval>>>::encodeInternalsWithEncoder(uint64_t a1, void *a2)
{
  ...
  statistics::StatisticsBucket::makeStatistics(&v14);
  HDStatisticsRelative<HDStatisticsCombined<HDStatisticsTemporalBucketWeightedDiscrete<HDStatisticsTemporalBucketWeightedDiscreteParameters>,HDStatisticsTimeInterval>>::archive(&v40, (a1 + 240));
  statistics::Statistics::operator=(*(&v23 + 1), &v40);
  statistics::Statistics::~Statistics(&v40);
  v9 = *(a1 + 440);
  if (v9 != a1 + 448)
  {
    HDStatisticsRelative<HDStatisticsCombined<HDStatisticsTemporalBucketWeightedDiscrete<HDStatisticsTemporalBucketWeightedDiscreteParameters>,HDStatisticsTimeInterval>>::archive(&v40, (v9 + 40));
    v10 = *(v9 + 32);
    v47 |= 0x200u;
    v46 = v10;
    PB::PtrVector<statistics::Statistics>::emplace_back<statistics::Statistics&>();
...
void _HDConcreteStatisticsCollectionCalculatorImplementation<HDStatisticsRelative<HDStatisticsCombined<HDStatisticsTemporalBucketWeightedDiscrete<HDStatisticsTemporalBucketWeightedDiscreteParameters>,HDStatisticsTimeInterval>>>::decodeInternalsWithDecoder(uint64_t k, void *a2)
{
  ...
  *(k + 680) = [v34 decodeBoolForKey:@"needs_config"];
  ...
  if (v76)
  {
    ...
    v73 = 0u;
    v74 = 1065353216;
    v42 = vextq_s8(*(v76 + 8), *(v76 + 8), 8uLL);
    v4 = *(v76 + 72);
    v43 = *(v76 + 64);
    LOWORD(v44) = *(v76 + 185);
    v46 = vextq_s8(*(v76 + 24), *(v76 + 24), 8uLL);
    v47 = v4;
    v5 = *(v76 + 80);
    v6 = *(v76 + 88);
    v36 = v3;
    ...
    if (v10)
    {
      HDStatisticsRelative<HDStatisticsCombined<HDStatisticsTemporalBucketWeightedDiscrete<HDStatisticsTemporalBucketWeightedDiscreteParameters>,HDStatisticsTimeInterval>>::unarchive(v84, v10);
      v52 = *v84;
      v57 = v88;
      v58[0] = v89;
      v58[1] = v90;
    ...
    {
      v13 = *v12;
      HDStatisticsRelative<HDStatisticsCombined<HDStatisticsTemporalBucketWeightedDiscrete<HDStatisticsTemporalBucketWeightedDiscreteParameters>,HDStatisticsTimeInterval>>::unarchive(v84, *v12);
      v14 = *(v13 + 144);
      v15 = v60[0];
      if (!v60[0])
      {
...
void sub_228EDF660(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, void *a4, uint64_t a5, uint64_t a6, void *a7, uint64_t a8, ...)
{
  va_start(va, a8);
...
LABEL_121:
        ...
        *&v78 = v56;
        for (i = *(a1 + 64); i != *(a1 + 72) && *(&v77 + 1) >= *i; i += 2)
        {
          if (*(&v77 + 1) < i[1])
          {
            goto LABEL_121;
        ...
        {
          v60 = *(&v78 + 1);
          if (v52 == *(&v78 + 1) || *(a1 + 24) == 1)
          {
            HDStatisticsRelative<HDStatisticsCombined<HDStatisticsTemporalBucketWeightedDiscrete<HDStatisticsTemporalBucketWeightedDiscreteParameters>,HDStatisticsTimeInterval>>::addSample((a1 + 120), &v77, v58 ^ 1);
          }
        }
        ...
        v61 = HDStatisticsBucket<HDStatisticsRelative<HDStatisticsCombined<HDStatisticsTemporalBucketWeightedDiscrete<HDStatisticsTemporalBucketWeightedDiscreteParameters>,HDStatisticsTimeInterval>>>::_bundleIdentifierForSourceID(a1, v60);
        if (!v61)
        {
          goto LABEL_119;
        }
        ...
        if (v62)
        {
          if ([v62 longLongValue] != v60 && *(a1 + 24) != 1)
          {
LABEL_118:
...
LABEL_120:
        ...
        {
          v64 = [MEMORY[0x277CCABB0] numberWithLongLong:v60];
          [v75 setObject:v64 forKeyedSubscript:v61];
        }

        v65 = HDStatisticsBucket<HDStatisticsRelative<HDStatisticsCombined<HDStatisticsTemporalBucketWeightedDiscrete<HDStatisticsTemporalBucketWeightedDiscreteParameters>,HDStatisticsTimeInterval>>>::_canonicalSourceIDForSourceID(a1, v60);
        v66 = HDStatisticsBucket<HDStatisticsRelative<HDStatisticsCombined<HDStatisticsTemporalBucketWeightedDiscrete<HDStatisticsTemporalBucketWeightedDiscreteParameters>,HDStatisticsTimeInterval>>>::_statisticsForSource(a1, v65);
        HDStatisticsRelative<HDStatisticsCombined<HDStatisticsTemporalBucketWeightedDiscrete<HDStatisticsTemporalBucketWeightedDiscreteParameters>,HDStatisticsTimeInterval>>::addSample(v66, &v77, v59 ^ 1);
        goto LABEL_118;
      }
...
LABEL_122:
      *(a1 + 272) = HKIntervalMask<double>::removeIntervalsBefore((a1 + 248), v17) + *(a1 + 272);
      ...
      if (v67 != v74)
      {
        do
        {
          *(v67 + 24) = HKIntervalMask<double>::removeIntervalsBefore(v67 + 21, v17) + *(v67 + 24);
          v68 = v67[1];
          if (v68)
          {
            do
...
LABEL_131:
    ...
    *(&v81 + 1) = v37;
    ...
    if (v35)
    {
      HDStatisticsRelative<HDStatisticsCombined<HDStatisticsTemporalBucketWeightedDiscrete<HDStatisticsTemporalBucketWeightedDiscreteParameters>,HDStatisticsTimeInterval>>::addSample((a1 + 120), &v77, v25 ^ 1);
      if (*(a1 + 25) == 1)
      {
        v47 = HDStatisticsBucket<HDStatisticsRelative<HDStatisticsCombined<HDStatisticsTemporalBucketWeightedDiscrete<HDStatisticsTemporalBucketWeightedDiscreteParameters>,HDStatisticsTimeInterval>>>::_canonicalSourceIDForSourceID(a1, v31);
        v48 = HDStatisticsBucket<HDStatisticsRelative<HDStatisticsCombined<HDStatisticsTemporalBucketWeightedDiscrete<HDStatisticsTemporalBucketWeightedDiscreteParameters>,HDStatisticsTimeInterval>>>::_statisticsForSource(a1, v47);
        HDStatisticsRelative<HDStatisticsCombined<HDStatisticsTemporalBucketWeightedDiscrete<HDStatisticsTemporalBucketWeightedDiscreteParameters>,HDStatisticsTimeInterval>>::addSample(v48, &v77, v26 ^ 1);
      }
...
__n128 *HDStatisticsRelative<HDStatisticsCombined<HDStatisticsTemporalBucketWeightedDiscrete<HDStatisticsTemporalBucketWeightedDiscreteParameters>,HDStatisticsTimeInterval>>::addSample(__n128 *result, double *a2, int a3)
{
  v5 = result;
  ...
  if (!v6)
  {
    if (v7 || result[4].n128_u64[1])
    {
      return result;
    }

    HDStatisticsTemporalBucketWeightedDiscrete<HDStatisticsTemporalBucketWeightedDiscreteParameters>::addSample(&result->n128_i64[1], a2);
    v9 = (v5 + 120);
    goto LABEL_21;
  }
...
LABEL_14:
    ...
    *(result + 8) = xmmword_229170D40;
    result[7].n128_u64[1] = 0;
    v13 = result + 8;
    v12 = result[8].n128_u64[0];
    *(&v5[1] + 8) = 0u;
    *(&v5[2] + 8) = 0u;
    *(&v5[3] + 8) = 0u;
    *(&v5[4] + 8) = 0u;
    ...
    *(&v5[6] + 8) = 0u;
    if (v12)
    {
      ...
      *v13 = 0u;
      v5[9] = 0u;
      if (v14 && v5[5].n128_f64[1] > v5[10].n128_f64[1])
      {
        goto LABEL_20;
      }
    }
    ...
    v5[5] = v5[10];
    v5[6] = v15;
    v5[7].n128_u16[0] = v5[12].n128_u16[0];
LABEL_20:
    HDStatisticsTemporalBucketWeightedDiscrete<HDStatisticsTemporalBucketWeightedDiscreteParameters>::addSample(&v5->n128_i64[1], a2);
    v9 = (v5 + 120);
LABEL_21:
    v10 = a2;
    v11 = a3;
...
void *HDStatisticsBucket<HDStatisticsRelative<HDStatisticsCombined<HDStatisticsTemporalBucketWeightedDiscrete<HDStatisticsTemporalBucketWeightedDiscreteParameters>,HDStatisticsTimeInterval>>>::_statisticsForSource(uint64_t a1, uint64_t a2)
{
  v7 = a2;
  v3 = *(a1 + 328);
  if (!v3)
...
LABEL_8:
    v8 = &v7;
    std::__tree<std::__value_type<long long,HDStatisticsRelative<HDStatisticsCombined<HDStatisticsTemporalBucketWeightedDiscrete<HDStatisticsTemporalBucketWeightedDiscreteParameters>,HDStatisticsTimeInterval>>>,std::__map_value_compare<long long,std::__value_type<long long,HDStatisticsRelative<HDStatisticsCombined<HDStatisticsTemporalBucketWeightedDiscrete<HDStatisticsTemporalBucketWeightedDiscreteParameters>,HDStatisticsTimeInterval>>>,std::less<long long>,true>,std::allocator<std::__value_type<long long,HDStatisticsRelative<HDStatisticsCombined<HDStatisticsTemporalBucketWeightedDiscrete<HDStatisticsTemporalBucketWeightedDiscreteParameters>,HDStatisticsTimeInterval>>>>>::__emplace_unique_key_args<long long,std::piecewise_construct_t const&,std::tuple<long long const&>,std::tuple<>>(a1 + 320, a2);
    v8 = &v7;
    v5 = std::__tree<std::__value_type<long long,HDStatisticsRelative<HDStatisticsCombined<HDStatisticsTemporalBucketWeightedDiscrete<HDStatisticsTemporalBucketWeightedDiscreteParameters>,HDStatisticsTimeInterval>>>,std::__map_value_compare<long long,std::__value_type<long long,HDStatisticsRelative<HDStatisticsCombined<HDStatisticsTemporalBucketWeightedDiscrete<HDStatisticsTemporalBucketWeightedDiscreteParameters>,HDStatisticsTimeInterval>>>,std::less<long long>,true>,std::allocator<std::__value_type<long long,HDStatisticsRelative<HDStatisticsCombined<HDStatisticsTemporalBucketWeightedDiscrete<HDStatisticsTemporalBucketWeightedDiscreteParameters>,HDStatisticsTimeInterval>>>>>::__emplace_unique_key_args<long long,std::piecewise_construct_t const&,std::tuple<long long const&>,std::tuple<>>(a1 + 320, v7);
  }
...
LABEL_87:
      ...
      *(v11 - 16) = v244;
      ...
      v65 = std::__insertion_sort_incomplete[abi:ne200100]<std::_ClassicAlgPolicy,HDStatisticsBucket<HDStatisticsRelative<HDStatisticsCombined<HDStatisticsTemporalBucketWeightedDiscrete<HDStatisticsTemporalBucketWeightedDiscreteParameters>,HDStatisticsTimeInterval>>>::_mergeTowardTime(double)::{lambda(HDStatisticsBucket<HDStatisticsRelative<HDStatisticsCombined<HDStatisticsTemporalBucketWeightedDiscrete<HDStatisticsTemporalBucketWeightedDiscreteParameters>,HDStatisticsTimeInterval>>>::_SampleRemainder const&,HDStatisticsBucket<HDStatisticsRelative<HDStatisticsCombined<HDStatisticsTemporalBucketWeightedDiscrete<HDStatisticsTemporalBucketWeightedDiscreteParameters>,HDStatisticsTimeInterval>>>::_SampleRemainder const&)#1} &,HDStatisticsBucket<HDStatisticsRelative<HDStatisticsCombined<HDStatisticsTemporalBucketWeightedDiscrete<HDStatisticsTemporalBucketWeightedDiscreteParameters>,HDStatisticsTimeInterval>>>::_SampleRemainder*>(a1, v11 - 48, a3);
