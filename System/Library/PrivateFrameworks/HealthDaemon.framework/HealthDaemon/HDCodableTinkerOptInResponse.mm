...
- (id)description
{
  ...
  v8.receiver = self;
  v8.super_class = HDCodableTinkerOptInResponse;
  v4 = [(HDCodableTinkerOptInResponse *)&v8 description];
  dictionaryRepresentation = [(HDCodableTinkerOptInResponse *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  if (*&self->_has)
  {
    v6 = [MEMORY[0x277CCABB0] numberWithBool:self->_accepted];
...
- (void)mergeFrom:(id)from
{
  ...
  if (*(fromCopy + 2))
  {
    [(HDCodableTinkerOptInResponse *)self setRequestIdentifier:?];
    fromCopy = v7;
  }
  ...
  else
  {
    ...
    error = [(HDCodableTinkerOptInResponse *)self setError:?];
  }
