...
{
  v62 = a3;
  v10 = objc_msgSend_type(v62, v4, v5, v6, v7, v8, v9);
  objc_msgSend_setType_(self, v11, v10, v12, v13, v14, v15);
  v22 = objc_msgSend_mergeableValueID(v62, v16, v17, v18, v19, v20, v21);

  if (v22)
  {
    v29 = objc_msgSend_location(self, v23, v24, v25, v26, v27, v28);
    v36 = objc_msgSend_mergeableValueID(v62, v30, v31, v32, v33, v34, v35);
    objc_msgSend_copyFromMergeableValueID_(v29, v37, v36, v38, v39, v40, v41);
  }

  v42 = objc_msgSend_timestamp(v62, v23, v24, v25, v26, v27, v28);

  if (v42)
  {
    v49 = objc_msgSend_timestamp(self, v43, v44, v45, v46, v47, v48);
    v56 = objc_msgSend_timestamp(v62, v50, v51, v52, v53, v54, v55);
