...
- (unint64_t)size;
- (unsigned)modifier;
- (void)copySiteIdentifierBytes:(void *)bytes length:(unint64_t *)length isNull:(BOOL *)null;
@end
...
- (void)copySiteIdentifierBytes:(void *)bytes length:(unint64_t *)length isNull:(BOOL *)null
{
  ...
  if (v11)
  {
    ...
    objc_msgSend_copyBytes_length_isNull_forToken_(self, v19, bytes, length, null, v18[17], v20);
