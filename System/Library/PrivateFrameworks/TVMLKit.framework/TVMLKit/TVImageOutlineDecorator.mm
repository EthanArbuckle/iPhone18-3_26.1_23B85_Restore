...
- (TVImageOutlineDecorator)initWithOutlineColor:(id)color outlineWidths:(UIEdgeInsets)widths;
...
+ (id)decoratorWithOutlineColor:(id)color outlineWidths:(UIEdgeInsets)widths
{
  ...
  top = widths.top;
  colorCopy = color;
  right = [[TVImageOutlineDecorator alloc] initWithOutlineColor:colorCopy outlineWidths:top, left, bottom, right];
...
- (TVImageOutlineDecorator)initWithOutlineColor:(id)color outlineWidths:(UIEdgeInsets)widths
{
  ...
  colorCopy = color;
  v14.receiver = self;
  v14.super_class = TVImageOutlineDecorator;
...
- (BOOL)isEqual:(id)equal
{
  equalCopy = equal;
  v22.receiver = self;
  v22.super_class = TVImageOutlineDecorator;
  if ([(TVImageScaleDecorator *)&v22 isEqual:equalCopy])
  {
    outlineColor = [(TVImageOutlineDecorator *)self outlineColor];
...
{
  v3.receiver = self;
  v3.super_class = TVImageOutlineDecorator;
...
- (id)decoratorIdentifier
{
  ...
  v15.receiver = self;
  v15.super_class = TVImageOutlineDecorator;
  decoratorIdentifier = [(TVImageScaleDecorator *)&v15 decoratorIdentifier];
...
- (void)drawInContext:(id)context imageRect:(CGRect)rect
{
  ...
  else
  {
    ...
    v39 = [TVCornerUtilities createPathForRadii:[(TVImageScaleDecorator *)self cornerContinuous] inRect:-(v38 * 0.5 - v22 * v14) isContinuous:-(v38 * 0.5 - v24 * v14), -(v38 * 0.5 - v26 * v14), -(v38 * 0.5 - v28 * v14), v50.origin.x, v50.origin.y, v50.size.width, v50.size.height];
