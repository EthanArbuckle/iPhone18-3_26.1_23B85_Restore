      ...
      do
      {
        ...
        if ([v17 isEqualToData:v19])
        {
          ...
          if (v35)
          {
            ...
            {
              [THThreadNetworkCredentialsKeychainBackingStore checkIfActiveDatasetRecordIsPresentInTheGivenList:v10 Missinglist:v31 record:v26];
            }
...
- (id)getTheKeyFromPreferredNetworkEntry:(id)a3
{
  ...
  encode_data_into_string(v17, [v19 length], v22, 0x29uLL, 0);
...
LABEL_12:
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
  {
    [THThreadNetworkCredentialsKeychainBackingStore isMatchingMdnsRecords:v7 preferredNw:v5];
  }
...
LABEL_52:
    ...
    {
      [THThreadNetworkCredentialsKeychainBackingStore isMatchingNetworkSignature:v12 preferredNwSignature:? preferred:? signaturePrefEntries:? updatedPreferred:?];
    }
...
LABEL_70:
    ...
    v18 = [v84 initWithSignatures:v85 ipv6NwSignature:v86 wifSSID:&stru_1004D2028 wifiPassword:@"ApplePreferredNetworkRecordLabel"];
...
- (id)sortAndReturnPreferredNetwork:(id)a3 onlyMdns:(BOOL)a4
{
  ...
  if (v4)
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
    {
      [THThreadNetworkCredentialsKeychainBackingStore sortAndReturnPreferredNetwork:v6 onlyMdns:?];
    }
...
- (BOOL)storePreferredEntryAndCheckForDup:(id)a3 isDuplicate:(int *)a4
{
  ...
  if (v19 == -25299)
  {
    ...
    if (os_log_type_enabled(v20, OS_LOG_TYPE_ERROR))
    {
      [THThreadNetworkCredentialsKeychainBackingStore storePreferredEntryAndCheckForDup:v5 isDuplicate:?];
    }
...
LABEL_49:
        ...
        else
        {
          ...
          if (os_log_type_enabled(v66, OS_LOG_TYPE_ERROR))
          {
            [THThreadNetworkCredentialsKeychainBackingStore updateRecordToPreferredNetworkEntry:v6 credentialsDataSetRecord:?];
          }
        }
      }
...
- (BOOL)areValidDataSetTLVs:(id)a3 creds:(id *)a4 updateATS:(BOOL)a5 isATSAppended:(BOOL *)a6
{
  ...
  encode_data_into_string(v7, v8, buf, 0x3E8uLL, 0);
  v11 = THCredentialsServerLogHandleForCategory(1);
  if (os_log_type_enabled(v11, OS_LOG_TYPE_DEFAULT))
  {
    *v98 = 136642819;
...
- (id)appendActiveTimeStampTLV:(id)a3
{
  ...
  encode_data_into_string(v4, v5, v19, 0x3E8uLL, 0);
  v8 = THCredentialsServerLogHandleForCategory(1);
  if (os_log_type_enabled(v8, OS_LOG_TYPE_DEFAULT))
  {
