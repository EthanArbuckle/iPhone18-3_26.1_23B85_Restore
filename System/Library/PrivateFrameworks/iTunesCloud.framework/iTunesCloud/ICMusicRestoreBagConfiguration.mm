...
- (ICMusicRestoreBagConfiguration)initWithServerConfiguration:(id)a3
{
  ...
  if (v5)
  {
    v6 = [v4 ic_arrayValueForKey:@"allowed-kinds"];
    allowedKinds = v5->_allowedKinds;
    v5->_allowedKinds = v6;

    v8 = [v4 ic_arrayValueForKey:@"allowed-match-status"];
    ...
    v5->_shouldGZip = [v4 ic_BOOLValueForKey:@"gzip"];
    v12 = [v4 ic_stringValueForKey:@"url"];
    if (v12)
    {
