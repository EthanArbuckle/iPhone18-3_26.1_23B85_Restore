...
- (void)getAccountNotificationsWithCompletionHandler:(id)handler;
- (void)setAccountNotificationsArtistContentFeature:(BOOL)feature withCompletionHandler:(id)handler;
- (void)setCachedAccountNotificationsNewMusicEnabled:(BOOL)enabled;
...
- (id)_getSwitchesDependingOnSubscriptionStatus:(id)status withResponse:(id)response togglingSwitchesToValue:(BOOL)value
{
  ...
  statusCopy = status;
  settingsSwitches = [response settingsSwitches];
  v9 = objc_alloc_init(MEMORY[0x1E695DF70]);
  v26 = 0u;
  v27 = 0u;
  v28 = 0u;
  v29 = 0u;
  v10 = settingsSwitches;
  ...
  if (v11)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        v15 = *(*(&v26 + 1) + 8 * v14);
        if (([statusCopy hasCapability:128] & 1) == 0)
        {
          identifier = [v15 identifier];
          if ([identifier isEqualToString:ICMusicAccountNotificationsSettingsSwitchArtistsAndShows])
          {
          }
...
- (id)cachedAccountNotificationsNewMusicSwitch
{
  ...
  accountNotificationsShowInLibraryDictionary = [v2 accountNotificationsShowInLibraryDictionary];

  v4 = [[ICMusicAccountNotificationsSettingsSwitch alloc] initWithItemResponseDictionary:accountNotificationsShowInLibraryDictionary];
...
- (void)setCachedAccountNotificationsNewMusicEnabled:(BOOL)enabled
{
  ...
  v7 = [(ICMusicAccountNotificationsSettingsSwitch *)v6 initWithToggleState:enabledCopy hasBeenToggled:1 identifier:ICMusicAccountNotificationsSettingsSwitchArtistsAndShows];
  v8 = +[ICDefaults standardDefaults];
  itemResponseDictionary = [(ICMusicAccountNotificationsSettingsSwitch *)v7 itemResponseDictionary];
  [v8 setAccountNotificationsShowInLibraryDictionary:itemResponseDictionary];
}
...
- (void)setCachedAccountNotificationsShowInLibraryEnabled:(BOOL)enabled
{
  ...
  v6 = [ICMusicAccountNotificationsSettingsSwitch alloc];
  v7 = [(ICMusicAccountNotificationsSettingsSwitch *)v6 initWithToggleState:enabledCopy hasBeenToggled:1 identifier:ICMusicAccountNotificationsSettingsSwitchShowInLibrary];
  v8 = +[ICDefaults standardDefaults];
  itemResponseDictionary = [(ICMusicAccountNotificationsSettingsSwitch *)v7 itemResponseDictionary];
  [v8 setAccountNotificationsShowInLibraryDictionary:itemResponseDictionary];
}
...
- (void)setAccountNotificationsArtistContentFeature:(BOOL)feature withCompletionHandler:(id)handler
{
  ...
  v8 = [(ICMusicAccountNotificationsSettingsSwitch *)v7 initWithToggleState:featureCopy hasBeenToggled:1 identifier:ICMusicAccountNotificationsSettingsSwitchShowInLibrary];
  ...
  itemResponseDictionary = [(ICMusicAccountNotificationsSettingsSwitch *)v8 itemResponseDictionary];
  [v10 setAccountNotificationsShowInLibraryDictionary:itemResponseDictionary];

  storeRequestContext = [(ICMusicAccountNotificationsSettingsManager *)self storeRequestContext];
  v13 = [[ICMusicAccountNotificationsSettingsRequestOperation alloc] initWithRequestContext:storeRequestContext withRequestMethod:0];
...
- (void)getAccountNotificationsWithCompletionHandler:(id)handler
{
  ...
  storeRequestContext = [(ICMusicAccountNotificationsSettingsManager *)self storeRequestContext];
  v8 = [(ICMusicAccountNotificationsSettingsRequestOperation *)v6 initWithRequestContext:storeRequestContext withRequestMethod:0];
