...
- (void)mergeFrom:(id)from
{
  ...
  if (fromCopy[1])
  {
    [(ICIAMParameter *)self setKey:?];
    fromCopy = v5;
  }

  if (fromCopy[2])
  {
    [(ICIAMParameter *)self setValue:?];
    fromCopy = v5;
  }
}
...
- (id)description
{
  ...
  v8.receiver = self;
  v8.super_class = ICIAMParameter;
  v4 = [(ICIAMParameter *)&v8 description];
  dictionaryRepresentation = [(ICIAMParameter *)self dictionaryRepresentation];
