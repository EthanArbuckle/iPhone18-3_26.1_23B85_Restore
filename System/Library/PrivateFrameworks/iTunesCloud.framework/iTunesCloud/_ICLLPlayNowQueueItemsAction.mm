  ...
  if (v9)
  {
    ...
    do
    {
      for (i = 0; i != v10; ++i)
      {
        ...
        [(_ICLLPlayNowQueueItemsAction *)v6 addItems:v13];
      }
...
- (id)description
{
  ...
  v8.receiver = self;
  v8.super_class = _ICLLPlayNowQueueItemsAction;
  v4 = [(_ICLLPlayNowQueueItemsAction *)&v8 description];
  dictionaryRepresentation = [(_ICLLPlayNowQueueItemsAction *)self dictionaryRepresentation];
