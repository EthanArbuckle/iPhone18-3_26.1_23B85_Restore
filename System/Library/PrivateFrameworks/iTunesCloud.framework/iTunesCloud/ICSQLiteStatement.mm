...
- (BOOL)isReadOnly;
- (ICSQLiteStatement)initWithStatement:(sqlite3_stmt *)statement connection:(id)connection;
...
- (void)bindDouble:(double)double atPosition:(int)position
{
  ...
  {
    [MEMORY[0x1E695DF30] raise:*MEMORY[0x1E695D930] format:{@"Statement already finalized", double}];
  }
}
