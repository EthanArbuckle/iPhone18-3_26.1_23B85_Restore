...
- (void)setBuildFeatures:(id)features;
...
- (void)setProvidedAudioQuality:(id)quality;
- (void)setQueueGroupingID:(id)d;
...
- (void)setTargetedAudioQuality:(id)quality;
...
- (void)setProvidedAudioQuality:(id)quality
{
  if (self->super._providedAudioQuality != quality)
  {
    v5 = [quality copy];
...
- (void)setTargetedAudioQuality:(id)quality
{
  if (self->super._targetedAudioQuality != quality)
  {
    v5 = [quality copy];
...
- (void)setQueueGroupingID:(id)d
{
  if (self->super._queueGroupingID != d)
  {
    v5 = [d copy];
...
- (void)setBuildFeatures:(id)features
{
  if (self->super._buildFeatures != features)
  {
    v5 = [features copy];
