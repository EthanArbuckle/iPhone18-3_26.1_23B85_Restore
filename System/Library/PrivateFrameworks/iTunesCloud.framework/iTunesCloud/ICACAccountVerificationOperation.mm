...
- (void)authenticateTask:(id)a3 handleDialogRequest:(id)a4 completion:(id)a5
{
  ...
  v13 = v8;
  v11 = v8;
  [(ICStoreDialogResponseHandler *)v10 handleAMSDialogRequest:v7 completion:v12];
}
...
- (void)finishWithError:(id)a3
{
  ...
  v9 = [(ICUserVerificationOperation *)self responseHandler];
  v10 = v9;
  if (v9)
  {
    (*(v9 + 16))(v9, v4 == 0, v4);
...
- (void)execute
{
  ...
  v60 = [v4 ACAccountStore];
  v6 = [v4 interactionLevel];
  ...
  else
  {
    ...
    else
    {
      ...
      v17 = [v16 shouldForceSilentAuthentications];
      ...
      else if (v6 - 3 >= 2)
      {
        if (v6 == 5)
        {
          ...
          v20 = [v19 lastAllowedInteractiveAuthenticationTime];
    ...
    else
    {
      ...
      if (v15 != 1)
      {
        ...
        [v42 setLastAllowedInteractiveAuthenticationTime:v43];
      }

      v40 = objc_alloc_init(MEMORY[0x1E698C7B0]);
      [v40 setAllowServerDialogs:v6 != 1];
      [v40 setAuthenticationType:v15];
      [v40 setEnableAccountCreation:v6 == 4];
      [v40 setCanMakeAccountActive:v6 == 4];
      [v40 setIgnoreAccountConversion:v6 == 1];
      v44 = [v4 debugReason];
      v56 = v24;
      v57 = self;
      if (![(__CFString *)v44 length])
      {
        ...
        v44 = @"This action requires authentication to proceed";
      }

      [v40 setDebugReason:{v44, v44}];
      v45 = [v3 storeRequestContext];
      if (!v45)
      {
        v46 = [*&v5 ic_DSID];
        if ([v46 longLongValue])
        {
          v47 = [*&v5 ic_DSID];
          v48 = [ICUserIdentity specificAccountWithDSID:v47];
        }
        ...
        v45 = [[ICStoreRequestContext alloc] initWithIdentity:v48];
      }

      v49 = [[ICAMSBagAdapter alloc] initWithRequestContext:v45];
      ...
      v52 = [v51 performAuthentication];
      if (([*&v5 ic_isActive] & 1) == 0)
      {
        [v52 promiseWithTimeout:3.0];
        v54 = v53 = v3;
