...
{
  v7.receiver = self;
  v7.super_class = AMPMusicArtistNewContentRequest;
  v3 = [(AMPMusicArtistNewContentRequest *)&v7 description];
  dictionaryRepresentation = [(AMPMusicArtistNewContentRequest *)self dictionaryRepresentation];
