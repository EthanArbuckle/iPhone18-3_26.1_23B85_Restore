...
- (id)queryFilter
{
  ...
  0x400000 = [NSString stringWithFormat:@"('%@:%d')", v2, 0x400000];
...
- (void)main
{
  queryStoreIDs = [(JaliscoLoadBooksOperation *)self queryStoreIDs];
  if (queryStoreIDs && (-[JaliscoLoadBooksOperation queryStoreIDs](self, "queryStoreIDs"), v4 = objc_claimAutoreleasedReturnValue(), v5 = [v4 count], v4, queryStoreIDs, !v5))
  {
  ...
  else
  {
    ...
    metadataFilter = [(JaliscoLoadBooksOperation *)self metadataFilter];
    queryFilter = [(JaliscoLoadBooksOperation *)self queryFilter];
    v18 = [ICItemsRequest requestWithDatabaseID:databaseID metadataFilter:metadataFilter queryFilter:queryFilter purchaseTokens:0 includeHiddenItems:0];
    ...
    *&v39[8] = 0;
    ...
    v25 = v24;
    v35 = v25;
    [connection sendRequest:v18 withResponseHandler:&v31];
    dispatch_semaphore_wait(v25, 0xFFFFFFFFFFFFFFFFLL);
    if ([*(*&buf[8] + 40) responseCode] == 200)
    {
      responseDataFileURL = [*(*&buf[8] + 40) responseDataFileURL];
      v27 = [NSInputStream inputStreamWithURL:responseDataFileURL];
