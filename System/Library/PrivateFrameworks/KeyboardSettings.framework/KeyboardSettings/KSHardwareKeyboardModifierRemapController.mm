...
- (void)reloadSpecifiersWithAnimation
{
  v4 = [(KSHardwareKeyboardModifierRemapController *)self specifiers];
  v3 = [(KSHardwareKeyboardModifierRemapController *)self newSpecifiers];
...
LABEL_23:
  ...
  if ([v30 count])
  {
    if (!v29[185] || ([v30 containsObject:?] & 1) == 0)
    {
      v18 = [v30 firstObject];
      v29[185] = v18;
LABEL_33:
  ...
  {
    v29[185] = 0;
    v19 = [v29 navigationController];
    v20 = [v19 viewControllers];
    v21 = [v20 indexOfObject:v29];

    if (v21 && v21 != 0x7FFFFFFFFFFFFFFFLL)
    {
      v22 = [v29 navigationController];
      v23 = [v22 viewControllers];
      v18 = [v23 objectAtIndex:v21 - 1];

      v24 = [v29 navigationController];
      v25 = [v24 popToViewController:v18 animated:1];
...
- (id)newSpecifiers
{
  ...
  {
    v4 = [(KSHardwareKeyboardModifierRemapController *)self keyboardsSectionSpecifiers];
    [v3 addObjectsFromArray:v4];

    v5 = [(KSHardwareKeyboardModifierRemapController *)self keysSectionSpecifiers];
...
- (id)tableView:(id)a3 cellForRowAtIndexPath:(id)a4
{
  ...
  v7 = [(KSHardwareKeyboardModifierRemapController *)&v15 tableView:a3 cellForRowAtIndexPath:v6];
  ...
  {
    v8 = [(KSHardwareKeyboardModifierRemapController *)self specifierAtIndexPath:v6];
