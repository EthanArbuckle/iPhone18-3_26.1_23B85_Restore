...
+ (id)hkmc_requestForCategoryIdentifier:()HKMenstrualCycles fertileWindowEndDayIndex:daysShiftedFromCalendarMethod:
{
  ...
  v10 = a3;
  v11 = [v8 date];
  v12 = [a1 _hkmc_requestForCategoryIdentifier:v10 startDate:v11 fertileWindowEndDayIndex:a4 daysShiftedFromCalendarMethod:v9];
...
+ (id)hkmc_requestForCategoryIdentifier:()HKMenstrualCycles fertileWindowEndDayIndex:
{
  ...
  v7 = a3;
  v8 = [v6 date];
  v9 = [a1 _hkmc_requestForCategoryIdentifier:v7 startDate:v8 fertileWindowEndDayIndex:a4 daysShiftedFromCalendarMethod:0];
...
LABEL_50:
    v48 = HKMCLocalizedString(v41);
    v17 = [v40 localizedStringWithFormat:v48, HKMCNotificationDateComponentScalarFromCategory(v13)];
LABEL_51:
...
LABEL_52:
  ...
  if (a5 >= 1 && v49)
  {
    v48 = [MEMORY[0x277CBEA80] hk_gregorianCalendar];
    v71 = [MEMORY[0x277CBEAA8] hk_dateOnDayIndex:a5 atHour:20 calendar:v48];
    v73 = 0;
    v50 = [MEMORY[0x277CCA968] hkmc_shouldUseRelativeFormatForFertileWindowEndDate:v71 gregorianCalendar:v48 dateFormatArgumentOut:&v73];
    v51 = v73;
  ...
  if (v56)
  {
    v69 = [v14 integerValue];
    v57 = [MEMORY[0x277CBEA80] hk_gregorianCalendar];
    v72 = [MEMORY[0x277CBEAA8] hk_dateOnDayIndex:a5 atHour:20 calendar:v57];
    v73 = 0;
    v58 = [MEMORY[0x277CCA968] hkmc_shouldUseRelativeFormatForFertileWindowEndDate:v72 gregorianCalendar:v57 dateFormatArgumentOut:&v73];
    v59 = v73;
...
LABEL_31:
  ...
  if (v34 <= 6)
  {
    ...
    v27 = [v26 dateByAddingUnit:16 value:v35 toDate:v25 options:1024];
    v11 = v68;
    goto LABEL_31;
  }
...
LABEL_32:
  ...
  v28 = [a1 _hkmc_notificationRequestWithCategory:v24 body:v70 title:v23 expirationDate:v27 fertileWindowEndDayIndex:a5 daysShiftedFromCalendarMethod:v14];
...
+ (id)_hkmc_notificationRequestWithCategory:()HKMenstrualCycles body:title:expirationDate:fertileWindowEndDayIndex:daysShiftedFromCalendarMethod:
{
  ...
  v3 = [a1 _hkmc_notificationRequestWithContent:v2];
