  ...
  if (v9)
  {
    ...
    do
    {
      for (i = 0; i != v9; ++i)
      {
        ...
        v23[1] = 3221225472;
        v23[2] = __129__ACAccountStore_DAExtensions___daAccountsWithAccountTypeIdentifiers_enabledForDADataclasses_filterOnDataclasses_withCompletion___block_invoke_34;
        v23[3] = &unk_278D4C730;
        v23[4] = v13;
        v26 = v31;
        v24 = v7;
  ...
  if (v12)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        v15 = [DAAccount daAccountSubclassWithBackingAccountInfo:*(*(&v17 + 1) + 8 * v14), v17];
        if (v15)
        {
          [*(a1 + 40) addObject:v15];
        }
