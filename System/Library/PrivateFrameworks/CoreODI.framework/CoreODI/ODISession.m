...
- (ODISession)initWithServiceIdentifier:(id)a3 forDSIDType:(unint64_t)a4 andLocationBundleIdentifier:(id)a5
{
  ...
  if (v13)
  {
    ...
    v15 = [(ODIPartialAssessmentInitiator *)v14 makeInitialPartialAssessmentPayload];
    availablePartialAssessment = v13->_availablePartialAssessment;
    v13->_availablePartialAssessment = v15;

    v17 = [(ODIPartialAssessmentInitiator *)v14 makeInitialPartialAssessmentID];
    partialAssessmentID = v13->_partialAssessmentID;
    v13->_partialAssessmentID = v17;
...
- (ODISession)initWithServiceIdentifier:(id)a3 forDSIDType:(unint64_t)a4 andLocationBundle:(id)a5
{
  ...
  if (v15)
  {
    ...
    v17 = [(ODIPartialAssessmentInitiator *)v16 makeInitialPartialAssessmentPayload];
    availablePartialAssessment = v15->_availablePartialAssessment;
    v15->_availablePartialAssessment = v17;

    v19 = [(ODIPartialAssessmentInitiator *)v16 makeInitialPartialAssessmentID];
    partialAssessmentID = v15->_partialAssessmentID;
    v15->_partialAssessmentID = v19;
...
- (ODISession)initWithServiceIdentifier:(id)a3 forDSIDType:(unint64_t)a4
{
  ...
  v9 = [(ODISession *)self initWithServiceIdentifier:v6 forDSIDType:a4 andLocationBundleIdentifier:0];
...
- (id)initForTransaction
{
  ...
  if (v6)
  {
    ...
    v8 = [(ODIPartialAssessmentInitiator *)v7 makeInitialPartialAssessmentPayload];
    availablePartialAssessment = v6->_availablePartialAssessment;
    v6->_availablePartialAssessment = v8;

    v10 = [(ODIPartialAssessmentInitiator *)v7 makeInitialPartialAssessmentID];
    partialAssessmentID = v6->_partialAssessmentID;
    v6->_partialAssessmentID = v10;
...
- (void)setAvailablePartialAssessment:(id)a3
{
  ...
  v4->_availablePartialAssessment = v5;
...
- (void)provideFeedbackOnPayloadOutcome:(unint64_t)a3
{
  ...
  *&buf[16] = 0x3032000000;
  ...
  v9[3] = &unk_278E9C098;
  v9[4] = buf;
  [(ODISessionInternal *)internalSession provideFeedbackOnPayloadOutcome:a3 feedbackRecorded:v9];
