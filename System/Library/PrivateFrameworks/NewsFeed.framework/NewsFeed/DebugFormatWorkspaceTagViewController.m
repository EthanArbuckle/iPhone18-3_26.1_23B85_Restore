...
- (_TtC8NewsFeed37DebugFormatWorkspaceTagViewController)initWithCoder:(id)a3;
- (_TtC8NewsFeed37DebugFormatWorkspaceTagViewController)initWithNibName:(id)a3 bundle:(id)a4;
...
- (id)tableView:(id)a3 titleForHeaderInSection:(int64_t)a4
{
  ...
  if (*(*(self + OBJC_IVAR____TtC8NewsFeed37DebugFormatWorkspaceTagViewController_sections) + 16) <= a4)
  {
LABEL_7:
    __break(1u);
    return self;
