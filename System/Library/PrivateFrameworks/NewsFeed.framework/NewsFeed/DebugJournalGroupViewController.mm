...
- (id)tableView:(id)a3 titleForHeaderInSection:(int64_t)a4
{
  ...
  if (*(*(self + OBJC_IVAR____TtC8NewsFeed31DebugJournalGroupViewController_sections) + 16) <= a4)
  {
LABEL_7:
    __break(1u);
    return self;
...
{
  v4 = self;
  v2 = [(DebugJournalGroupViewController *)v4 presentingViewController];
  if (v2)
  {
    v3 = v2;
