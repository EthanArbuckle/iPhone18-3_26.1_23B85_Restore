...
- (BOOL)isLocked
{
  ...
  v2 = [(DBKeybagMonitor *)self currentState];
  v3 = v2;
  if (v2 != 3 && v2)
  {
...
{
  v4 = a3;
  v5 = [(DBKeybagMonitor *)self observers];
  [v5 addObserver:v4];
}
...
- (void)_handleKeybagStatusChanged
{
  v3 = [(DBKeybagMonitor *)self callbackQueue];
  BSDispatchQueueAssert();

  v4 = [(DBKeybagMonitor *)self queue];
  block[0] = MEMORY[0x277D85DD0];
  block[1] = 3221225472;
