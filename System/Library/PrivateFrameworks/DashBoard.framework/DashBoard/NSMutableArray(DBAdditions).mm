...
- (uint64_t)db_removeFirstObjectsIfMatching:()DBAdditions
{
  v4 = a3;
  v5 = [v4 count];
  if (v5 <= [self count] && (v6 = objc_msgSend(v4, "count"), objc_msgSend(self, "subarrayWithRange:", 0, v6), v7 = objc_claimAutoreleasedReturnValue(), v8 = objc_msgSend(v7, "isEqualToArray:", v4), v7, v8))
  {
    [self removeObjectsInRange:{0, v6}];
    v9 = 1;
  }
