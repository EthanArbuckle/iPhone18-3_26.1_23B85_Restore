...
- (id)nms_syncInfoContainerIdentifier
{
  ...
  {
    v2 = [a1 identifiers];
    v3 = [v2 nms_syncInfoPlaylistIdentifier];
  }
  ...
  else
  {
    ...
    if ((objc_opt_isKindOfClass() & 1) == 0)
    {
      ...
      {
        [(MPModelObject(NanoMusicSync) *)a1 nms_syncInfoContainerIdentifier];
      }
    ...
    v2 = [a1 identifiers];
    v3 = [v2 nms_syncInfoAlbumIdentifier];
  }
...
+ (id)nms_modelObjectWithLibraryPersistentID:()NanoMusicSync
{
  ...
  v6 = [MEMORY[0x277CD5EA0] kindWithModelClass:a1];
  v7 = [v5 nms_identifierSetWithLibraryPersistentID:a3 modelKind:v6];

  v8 = [[a1 alloc] initWithIdentifiers:v7];
...
+ (id)nms_modelObjectWithLibraryPersistentID:()NanoMusicSync block:
{
  ...
  v11 = [[a1 alloc] initWithIdentifiers:v10 block:v8];
