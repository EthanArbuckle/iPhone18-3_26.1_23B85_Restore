...
- (CGPoint)center;
- (CGSize)size;
- (CHScribbleRecognitionResult)initWithCoder:(id)coder;
- (CHScribbleRecognitionResult)initWithString:(id)string score:(double)score rotation:(double)rotation center:(CGPoint)center size:(CGSize)size;
...
- (CHScribbleRecognitionResult)initWithString:(id)string score:(double)score rotation:(double)rotation center:(CGPoint)center size:(CGSize)size
{
  ...
  x = center.x;
  v12.receiver = self;
  v12.super_class = CHScribbleRecognitionResult;
...
- (CHScribbleRecognitionResult)initWithCoder:(id)coder
{
  coderCopy = coder;
  v20.receiver = self;
  v20.super_class = CHScribbleRecognitionResult;
...
- (void)encodeWithCoder:(id)coder
{
  coderCopy = coder;
  v25.receiver = self;
  v25.super_class = CHScribbleRecognitionResult;
