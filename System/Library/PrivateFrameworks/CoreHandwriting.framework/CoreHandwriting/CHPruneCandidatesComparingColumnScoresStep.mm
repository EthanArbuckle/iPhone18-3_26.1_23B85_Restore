...
- (id)process:(id)process options:(id)options
{
  ...
  if (v24)
  {
    v192 = objc_msgSend_array(MEMORY[0x1E695DF70], v25, v26, v27, v28, v29, optionsCopy);
    for (i = 0; ; ++i)
    {
      ...
      if (i)
      {
        for (j = 0; ; ++j)
        {
          ...
          v106 = objc_msgSend_result(processCopy, v92, v105, v94, v95, v96);
          ...
          {
            v128 = objc_msgSend_result(processCopy, v92, v93, v94, v95, v96);
            v134 = objc_msgSend_result(processCopy, v129, v130, v131, v132, v133);
            ...
            v156 = objc_msgSend_result(processCopy, v151, v152, v153, v154, v155);
...
LABEL_8:
    ...
    v167 = objc_msgSend_result(processCopy, v162, v163, v164, v165, v166);
    ...
    if (v161 != v179)
    {
      ...
      objc_msgSend_setResult_(processCopy, v186, v185, v187, v188, v189);
    }
  }
