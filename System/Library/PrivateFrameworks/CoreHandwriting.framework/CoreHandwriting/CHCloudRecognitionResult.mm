...
- (CGPoint)center;
- (CGSize)size;
- (CHCloudRecognitionResult)initWithCoder:(id)coder;
- (CHCloudRecognitionResult)initWithString:(id)string score:(double)score rotation:(double)rotation center:(CGPoint)center size:(CGSize)size;
