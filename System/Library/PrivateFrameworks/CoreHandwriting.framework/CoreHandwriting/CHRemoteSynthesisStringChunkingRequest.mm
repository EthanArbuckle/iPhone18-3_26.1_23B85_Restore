...
- (CHRemoteSynthesisStringChunkingRequest)initWithCoder:(id)a3;
- (CHRemoteSynthesisStringChunkingRequest)initWithString:(id)a3 allowedSynthesizers:(id)a4 mode:(id)a5;
...
- (CHRemoteSynthesisStringChunkingRequest)initWithCoder:(id)a3
{
  ...
  v21 = objc_msgSend_decodeObjectOfClasses_forKey_(v4, v18, v17, @"allowedSynthesizers", v19, v20);
  v26 = objc_msgSend_decodeIntForKey_(v4, v22, @"mode", v23, v24, v25);
...
- (void)encodeWithCoder:(id)a3
{
  ...
  objc_msgSend_encodeObject_forKey_(v20, v8, self->_allowedSynthesizers, @"allowedSynthesizers", v9, v10);
  v16 = objc_msgSend_intValue(self->_mode, v11, v12, v13, v14, v15);
  objc_msgSend_encodeInteger_forKey_(v20, v17, v16, @"mode", v18, v19);
}
