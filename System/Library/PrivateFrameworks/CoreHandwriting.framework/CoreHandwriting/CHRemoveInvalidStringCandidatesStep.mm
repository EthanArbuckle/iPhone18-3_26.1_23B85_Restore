...
- (id)process:(id)a3 options:(id)a4
{
  ...
  {
    v237 = objc_msgSend_array(MEMORY[0x1E695DF70], v25, v26, v27, v28, v29, v236);
    for (i = 0; ; ++i)
    {
    ...
    *buf = 0;
    ...
    for (j = 0; ; ++j)
    {
      v115 = objc_msgSend_result(v5, v109, v110, v111, v112, v113);
      ...
      v127 = objc_msgSend_result(v5, v122, v123, v124, v125, v126);
...
LABEL_27:
        ...
        for (n = 0; ; ++n)
        {
          v167 = objc_msgSend_result(v5, v150, v151, v152, v153, v154);
          ...
          v185 = objc_msgSend_result(v5, v180, v181, v182, v183, v184);
    ...
    objc_msgSend_setResult_(v5, v230, v229, v231, v232, v233);
