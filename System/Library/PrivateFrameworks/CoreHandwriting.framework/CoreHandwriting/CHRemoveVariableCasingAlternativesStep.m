...
- (id)process:(id)a3 options:(id)a4
{
  ...
  if (v24)
  {
    ...
    v51 = objc_msgSend_retrievePathTokens_atPathIndex_(self, v48, v186, 0, v49, v50);
    ...
    for (i = 1; ; i = v184 + 1)
    {
      ...
      for (j = 0; ; ++j)
      {
        ...
        if (v114 == objc_msgSend_indexAtPosition_(v47, v115, j, v116, v117, v118) || (objc_msgSend_result(v186, v119, v120, v121, v122, v123), v124 = objc_claimAutoreleasedReturnValue(), objc_msgSend_transcriptionWithPath_columnRange_(v124, v125, v91, j, 1, v126), v127 = objc_claimAutoreleasedReturnValue(), objc_msgSend_lowercaseString(v127, v128, v129, v130, v131, v132), v133 = objc_claimAutoreleasedReturnValue(), objc_msgSend_result(v186, v134, v135, v136, v137, v138), v139 = objc_claimAutoreleasedReturnValue(), v140 = v47, objc_msgSend_transcriptionWithPath_columnRange_(v139, v141, v47, j, 1, v142), v143 = objc_claimAutoreleasedReturnValue(), objc_msgSend_lowercaseString(v143, v144, v145, v146, v147, v148), v149 = objc_claimAutoreleasedReturnValue(), isEqualToString = objc_msgSend_isEqualToString_(v133, v150, v149, v151, v152, v153), v149, v143, v139, v133, v127, v124, v47 = v140, !isEqualToString))
        {
    ...
    objc_msgSend_setResult_(v186, v177, v176, v178, v179, v180);
  }
