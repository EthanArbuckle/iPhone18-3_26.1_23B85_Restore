...
- (BOOL)isAlphabetic:(id)alphabetic;
...
- (id)_trimSubscriptTokens:(id)tokens
{
  ...
  v10 = 0;
  while (v10 < objc_msgSend_count(tokensCopy, v4, v5, v6, v7, v8))
  {
    if (v10 >= objc_msgSend_count(tokensCopy, v11, v12, v13, v14, v15) - 1)
    {
      goto LABEL_9;
    }

    v16 = objc_msgSend_objectAtIndexedSubscript_(tokensCopy, v4, v10, v6, v7, v8);
    v22 = objc_msgSend_string(v16, v17, v18, v19, v20, v21);
    if (objc_msgSend_isEqualToString_(v22, v23, @"_", v24, v25, v26))
    {
      v31 = objc_msgSend_objectAtIndexedSubscript_(tokensCopy, v27, v10 + 1, v28, v29, v30);
...
LABEL_9:
      v43 = objc_msgSend_objectAtIndex_(tokensCopy, v4, v10, v6, v7, v8);
      v49 = objc_msgSend_string(v43, v44, v45, v46, v47, v48);
      v54 = objc_msgSend_isEqualToString_(v49, v50, @"}", v51, v52, v53);

      if ((v54 & 1) == 0)
      {
        v55 = objc_msgSend_objectAtIndex_(tokensCopy, v4, v10, v6, v7, v8);
...
- (BOOL)isAlphabetic:(id)alphabetic
{
  alphabeticCopy = alphabetic;
  v9 = objc_msgSend_letterCharacterSet(MEMORY[0x1E696AB08], v4, v5, v6, v7, v8);
  v15 = objc_msgSend_invertedSet(v9, v10, v11, v12, v13, v14);

  LOBYTE(v9) = objc_msgSend_rangeOfCharacterFromSet_(alphabeticCopy, v16, v15, v17, v18, v19) == 0x7FFFFFFFFFFFFFFFLL;
  return v9;
}
...
- (id)process:(id)process options:(id)options
{
  ...
  if (v24)
  {
    ...
    for (i = 0; ; ++i)
    {
      v41 = objc_msgSend_result(processCopy, v35, v36, v37, v38, v39);
      ...
      if (i >= v53)
      {
        ...
        objc_msgSend_setResult_(processCopy, v140, v139, v141, v142, v143);
      ...
      *buf = 0;
      ...
      v115 = objc_msgSend_result(processCopy, v110, v111, v112, v113, v114);
