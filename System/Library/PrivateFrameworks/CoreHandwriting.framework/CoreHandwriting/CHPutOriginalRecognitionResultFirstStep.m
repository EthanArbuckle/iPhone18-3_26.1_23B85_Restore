...
- (id)process:(id)a3 options:(id)a4
{
  ...
  if (v5)
  {
    objc_storeStrong(v5 + 3, v177);
  }

  v183 = objc_msgSend_result(v5, v178, v179, v180, v181, v182);
