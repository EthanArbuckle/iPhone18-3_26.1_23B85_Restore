...
- (CHSegmentDescriptor)initWithSegmentID:(id)a3 startCutPoint:(id)a4 endCutPoint:(id)a5 referenceDrawing:(id)a6
{
  ...
  objc_storeStrong(&v15->_segmentID, a3);
  objc_storeStrong(&v15->_startCutPoint, a4);
  objc_storeStrong(&v15->_endCutPoint, a5);
  ...
  if (v26 == objc_msgSend_strokeIndex(v15->_endCutPoint, v27, v28, v29, v30, v31) && objc_msgSend_isStartOfStroke(v15->_startCutPoint, v32, v33, v34, v35, v36) && objc_msgSend_isEndOfStroke(v15->_endCutPoint, v37, v38, v39, v40, v41))
  {
    ...
    objc_msgSend_boundsForStrokeIndex_(v14, v48, v47, v49, v50, v51);
  }

  else
  {
    v52 = sub_183705AEC(v14, v15->_startCutPoint, v15->_endCutPoint);
  }
...
+ (id)generateSegmentsFromDrawing:(id)a3
{
  ...
  for (i = 0; i < objc_msgSend_strokeCount(v3, v9, v10, v11, v12, v13); ++i)
  {
    ...
    started = objc_msgSend_initWithSegmentID_startCutPoint_endCutPoint_referenceDrawing_(v29, v35, v34, isEndOfStroke, v28, v3);
...
+ (CGRect)boundingBoxFromSegmentID:(int64_t)a3 toSegmentID:(int64_t)a4 withSegments:(id)a5 withSourceDrawing:(id)a6
{
  v9 = a5;
  v10 = a6;
  v15 = objc_msgSend_objectAtIndex_(v9, v11, a3, v12, v13, v14);
  v20 = objc_msgSend_objectAtIndex_(v9, v16, a4, v17, v18, v19);
  v26 = objc_msgSend_startCutPoint(v15, v21, v22, v23, v24, v25);
  v32 = objc_msgSend_endCutPoint(v20, v27, v28, v29, v30, v31);
  v33 = sub_183705AEC(v10, v26, v32);
  v35 = v34;
  v37 = v36;
  v39 = v38;
...
+ (int64_t)indexForSegmentID:(id)a3 fromSegments:(id)a4
{
  ...
  v14 = v5;
  v6 = v5;
  v11 = objc_msgSend_indexOfObjectPassingTest_(a4, v7, v13, v8, v9, v10);
