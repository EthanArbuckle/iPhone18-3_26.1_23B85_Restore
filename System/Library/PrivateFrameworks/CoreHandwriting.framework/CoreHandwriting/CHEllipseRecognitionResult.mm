...
- (CGPoint)center;
- (CGSize)size;
- (CHEllipseRecognitionResult)initWithCoder:(id)coder;
- (CHEllipseRecognitionResult)initWithString:(id)string score:(double)score rotation:(double)rotation center:(CGPoint)center size:(CGSize)size;
...
- (CHEllipseRecognitionResult)initWithString:(id)string score:(double)score rotation:(double)rotation center:(CGPoint)center size:(CGSize)size
{
  ...
  x = center.x;
  v12.receiver = self;
  v12.super_class = CHEllipseRecognitionResult;
...
- (CHEllipseRecognitionResult)initWithCoder:(id)coder
{
  coderCopy = coder;
  v20.receiver = self;
  v20.super_class = CHEllipseRecognitionResult;
...
- (void)encodeWithCoder:(id)coder
{
  coderCopy = coder;
  v25.receiver = self;
  v25.super_class = CHEllipseRecognitionResult;
