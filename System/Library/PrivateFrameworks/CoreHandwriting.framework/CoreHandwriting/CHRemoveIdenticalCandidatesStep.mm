...
- (id)process:(id)process options:(id)options
{
  ...
  if (v24 >= 2)
  {
    ...
    for (i = 0; ; ++i)
    {
      v37 = objc_msgSend_result(processCopy, v30, v31, v32, v33, v34);
      ...
      v49 = objc_msgSend_result(processCopy, v44, v45, v46, v47, v48);
      ...
      if (objc_msgSend_count(v54, v55, v56, v57, v58, v59) >= 2)
      {
        ...
        for (j = 0; j < objc_msgSend_count(v54, v65, v66, v67, v68, v69); ++j)
        {
          ...
          v117 = objc_msgSend_result(processCopy, v81, v82, v83, v84, v85);
...
LABEL_15:
            for (k = 0; ; ++k)
            {
              v87 = objc_msgSend_result(processCopy, v81, v82, v83, v84, v85);
              ...
              v100 = objc_msgSend_result(processCopy, v65, v66, v67, v68, v69);
...
LABEL_25:
    ...
    if (objc_msgSend_count(v35, v44, v45, v46, v47, v48))
    {
      ...
      for (m = 0; ; ++m)
      {
        v167 = objc_msgSend_result(processCopy, v161, v162, v163, v164, v165);
        ...
        if ((objc_msgSend_containsIndex_(v35, v180, m, v181, v182, v183) & 1) == 0)
        {
          ...
          v189 = objc_msgSend_result(processCopy, v184, v185, v186, v187, v188);
          v195 = objc_msgSend_result(processCopy, v190, v191, v192, v193, v194);
          ...
          v212 = objc_msgSend_result(processCopy, v207, v208, v209, v210, v211);
      ...
      objc_msgSend_setResult_(processCopy, v231, v230, v232, v233, v234);
    }
  }
