...
- (CHLineWrappableLine)initWithQuad:(id)a3 text:(id)a4 locale:(id)a5
{
  ...
  if (v12)
  {
    objc_storeStrong(&v12->_boundingQuad, a3);
...
- (void)encodeWithCoder:(id)a3
{
  ...
  objc_msgSend_encodeObject_forKey_(v4, v38, v37, @"locale", v39, v40);
...
- (CHLineWrappableLine)initWithCoder:(id)a3
{
  ...
  {
    v6 = objc_opt_class();
    v10 = objc_msgSend_decodeObjectOfClass_forKey_(v4, v7, v6, @"boundingQuad", v8, v9);
    ...
    v20 = objc_opt_class();
    v24 = objc_msgSend_decodeObjectOfClass_forKey_(v4, v21, v20, @"locale", v22, v23);
    locale = v5->_locale;
    v5->_locale = v24;
