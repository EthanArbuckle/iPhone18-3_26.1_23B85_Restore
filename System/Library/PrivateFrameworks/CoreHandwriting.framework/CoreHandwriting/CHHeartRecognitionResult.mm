...
- (CGPoint)center;
- (CGSize)size;
- (CHHeartRecognitionResult)initWithCoder:(id)coder;
- (CHHeartRecognitionResult)initWithString:(id)string score:(double)score rotation:(double)rotation center:(CGPoint)center size:(CGSize)size;
...
- (CHHeartRecognitionResult)initWithString:(id)string score:(double)score rotation:(double)rotation center:(CGPoint)center size:(CGSize)size
{
  ...
  x = center.x;
  v12.receiver = self;
  v12.super_class = CHHeartRecognitionResult;
...
- (CHHeartRecognitionResult)initWithCoder:(id)coder
{
  coderCopy = coder;
  v20.receiver = self;
  v20.super_class = CHHeartRecognitionResult;
...
- (void)encodeWithCoder:(id)coder
{
  coderCopy = coder;
  v25.receiver = self;
  v25.super_class = CHHeartRecognitionResult;
