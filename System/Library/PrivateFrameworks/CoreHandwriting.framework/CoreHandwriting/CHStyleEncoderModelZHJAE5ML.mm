...
+ (id)modelHash;
+ (id)outputNames;
- (CHStyleEncoderModelZHJAE5ML)initWithProgramLibrary:(id)a3 functionName:(id)a4 error:(id *)a5;
- (CHStyleEncoderModelZHJAE5ML)initWithProgramLibrary:(id)a3 width:(unint64_t)a4;
...
- (CHStyleEncoderModelZHJAE5ML)initWithProgramLibrary:(id)a3 functionName:(id)a4 error:(id *)a5
{
  ...
  if (v12 && (objc_msgSend_E5RTFunctionDescriptorForFunction_inProgramLibrary_error_(CHStyleEncoderModelZHJAE5ML, v10, v9, v8, a5, v11), v13 = objc_claimAutoreleasedReturnValue(), functionDescriptor = v12->_functionDescriptor, v12->_functionDescriptor = v13, functionDescriptor, v12->_functionDescriptor))
  {
    v15 = v12;
  }
