...
- (void)clear:(int64_t)a3
{
  v11 = objc_msgSend_objectAtIndexedSubscript_(self->_table, a2, a3 - 1, v3, v4, v5);
...
- (id)cellWithLength:(int64_t)a3 range:(_NSRange)a4 nonTerminal:(id)a5
{
  ...
  v9 = a5;
  v14 = objc_msgSend_objectAtIndexedSubscript_(self->_table, v10, a3 - 1, v11, v12, v13);
  ...
  if (v23)
  {
    v29 = objc_msgSend_objectForKeyedSubscript_(v23, v24, v9, v25, v26, v27);
  }
...
- (id)cellsOfLength:(int64_t)a3
{
  v8 = objc_msgSend_array(MEMORY[0x1E695DF70], a2, a3, v3, v4, v5);
  v13 = objc_msgSend_objectAtIndexedSubscript_(self->_table, v9, a3 - 1, v10, v11, v12);
...
- (id)cellsByRangeForLength:(int64_t)a3
{
  ...
  v36 = 0u;
  v37 = 0u;
  v13 = objc_msgSend_objectAtIndexedSubscript_(self->_table, v9, a3 - 1, v10, v11, v12, 0);
  v19 = objc_msgSend_allValues(v13, v14, v15, v16, v17, v18);
...
- (id)startCellsWithLength:(int64_t)a3 inRange:(_NSRange)a4 startSymbol:(id)a5
{
  ...
  location = a4.location;
  v9 = a5;
  v14 = objc_msgSend_cellsOfLength_(self, v10, a3, v11, v12, v13);
