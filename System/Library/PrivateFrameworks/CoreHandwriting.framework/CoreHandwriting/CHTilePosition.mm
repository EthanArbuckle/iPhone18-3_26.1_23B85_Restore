...
+ (id)tilePositionWithRow:(int64_t)a3 column:(int64_t)a4;
- (BOOL)isEqual:(id)a3;
- (CHTilePosition)initWithCoder:(id)a3;
- (CHTilePosition)initWithRow:(int64_t)a3 column:(int64_t)a4 subtileIndex:(id)a5;
- (id)description;
- (unint64_t)hash;
...
- (CHTilePosition)initWithRow:(int64_t)a3 column:(int64_t)a4 subtileIndex:(id)a5
{
  ...
  if (v9)
  {
    v9->_row = a3;
    v9->_column = a4;
    v16 = objc_msgSend_copy(v8, v10, v11, v12, v13, v14);
...
+ (id)tilePositionWithRow:(int64_t)a3 column:(int64_t)a4
{
  ...
  v9 = objc_msgSend_initWithRow_column_subtileIndex_(v6, v7, a3, a4, 0, v8);
...
{
  v4 = a3;
  v9 = objc_msgSend_decodeIntegerForKey_(v4, v5, @"row", v6, v7, v8);
  v14 = objc_msgSend_decodeIntegerForKey_(v4, v10, @"column", v11, v12, v13);
  if (objc_msgSend_containsValueForKey_(v4, v15, @"subtileIndex", v16, v17, v18))
  {
    v21 = objc_opt_class();
    v25 = objc_msgSend_decodeObjectOfClass_forKey_(v4, v22, v21, @"subtileIndex", v23, v24);
...
{
  v14 = a3;
  objc_msgSend_encodeInteger_forKey_(v14, v4, self->_row, @"row", v5, v6);
  objc_msgSend_encodeInteger_forKey_(v14, v7, self->_column, @"column", v8, v9);
  subtileIndex = self->_subtileIndex;
  if (subtileIndex)
  {
    objc_msgSend_encodeObject_forKey_(v14, v10, subtileIndex, @"subtileIndex", v11, v12);
  }
}
