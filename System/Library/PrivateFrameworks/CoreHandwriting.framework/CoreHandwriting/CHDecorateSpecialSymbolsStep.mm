...
- (id)process:(id)a3 options:(id)a4
{
  v6 = a3;
  v106 = a4;
  v15 = objc_msgSend_objectForKeyedSubscript_(v106, v7, qword_1EA84BB60, v8, v9, v10);
  if (!v15 || (objc_msgSend_objectForKeyedSubscript_(v106, v11, qword_1EA84BB60, v12, v13, v14), v16 = objc_claimAutoreleasedReturnValue(), v22 = objc_msgSend_BOOLValue(v16, v17, v18, v19, v20, v21), v16, v15, (v22 & 1) == 0))
  {
    ...
    for (i = 0; ; ++i)
    {
      v35 = objc_msgSend_result(v6, v29, v30, v31, v32, v33);
      ...
      v53 = objc_msgSend_result(v6, v48, v49, v50, v51, v52);
      ...
      v76 = objc_msgSend_result(v6, v71, v72, v73, v74, v75);
      v82 = objc_msgSend_result(v6, v77, v78, v79, v80, v81);
    ...
    objc_msgSend_setResult_(v6, v101, v100, v102, v103, v104);
  }
