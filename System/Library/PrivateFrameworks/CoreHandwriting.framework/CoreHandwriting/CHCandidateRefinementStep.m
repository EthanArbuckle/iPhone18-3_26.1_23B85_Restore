...
- (id)process:(id)a3 options:(id)a4
{
  ...
  v16 = objc_opt_class();
  if (objc_msgSend_shouldAdjustColumnsFromPostprocessingStepOptions_(v16, v17, v7, v18, v19, v20))
  {
    ...
    v83 = 0u;
    v84 = 0u;
    v32 = objc_msgSend_result(v6, v27, v28, v29, v30, v31, 0);
    ...
    if (v46)
    {
      ...
      do
      {
        for (i = 0; i != v46; ++i)
        {
          ...
          v49 = *(*(&v83 + 1) + 8 * i);
          v50 = objc_msgSend_result(v6, v41, v42, v43, v44, v45);
    ...
    v65 = objc_msgSend_result(v6, v60, v61, v62, v63, v64);
    v71 = objc_msgSend_result(v6, v66, v67, v68, v69, v70);
