@interface CHStyleEncoderModelKOE5ML
+ (id)E5RTFunctionDescriptorForFunction:(id)function inProgramLibrary:(id)library error:(id *)error;
+ (id)defaultURLOfModelInThisBundle;
+ (id)inputNames;
+ (id)modelHash;
+ (id)outputNames;
- (CHStyleEncoderModelKOE5ML)initWithProgramLibrary:(id)library functionName:(id)name error:(id *)error;
- (CHStyleEncoderModelKOE5ML)initWithProgramLibrary:(id)library width:(unint64_t)width;
- (id)createExecutionContext;
@end

@implementation CHStyleEncoderModelKOE5ML
...
+ (id)inputNames
{
  ...
  v4 = objc_msgSend_arrayWithObjects_count_(MEMORY[0x1E695DEC8], a2, v6, 7, v2, v3);
...
+ (id)defaultURLOfModelInThisBundle
{
  ...
  if (v6)
  {
    ...
    v25[0] = v14;
    v25[1] = @"diffusion_ko_style_encoder.bundle";
...
+ (id)modelHash
{
  ...
  block[1] = 3221225472;
  block[2] = sub_183699E30;
  block[3] = &unk_1E6DDC0E0;
  block[4] = self;
  if (qword_1EA84CCF0 == -1)
  {
    v2 = qword_1EA84CCE8;
  }
  ...
  {
    dispatch_once(&qword_1EA84CCF0, block);
    v2 = qword_1EA84CCE8;
  }
...
- (CHStyleEncoderModelKOE5ML)initWithProgramLibrary:(id)library functionName:(id)name error:(id *)error
{
  ...
  nameCopy = name;
  v17.receiver = self;
  v17.super_class = CHStyleEncoderModelKOE5ML;
  v12 = [(CHStyleEncoderModelKOE5ML *)&v17 init];
  if (v12 && (objc_msgSend_E5RTFunctionDescriptorForFunction_inProgramLibrary_error_(CHStyleEncoderModelKOE5ML, v10, nameCopy, libraryCopy, error, v11), v13 = objc_claimAutoreleasedReturnValue(), functionDescriptor = v12->_functionDescriptor, v12->_functionDescriptor = v13, functionDescriptor, v12->_functionDescriptor))
  {
    v15 = v12;
  }
