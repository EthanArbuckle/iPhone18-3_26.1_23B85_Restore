...
- (CHTransliterateHalfWidthPunctuationStep)initWithShouldAddAlternatives:(BOOL)alternatives;
...
- (CHTransliterateHalfWidthPunctuationStep)initWithShouldAddAlternatives:(BOOL)alternatives
{
  ...
  if (v4)
  {
    v4->_shouldAddAlternatives = alternatives;
...
- (id)process:(id)process options:(id)options
{
  ...
  v209 = optionsCopy;
  v24 = objc_msgSend_leftContext(processCopy, v19, v20, v21, v22, v23);
  ...
  for (i = 0; ; ++i)
  {
    ...
    *buf = 0;
    ...
    v79 = objc_msgSend_result(processCopy, v73, v74, v75, v76, v77);
    ...
    v111 = objc_msgSend_result(processCopy, v106, v107, v108, v109, v110);
    v112 = v8;
    ...
    v132 = objc_msgSend_result(processCopy, v127, v128, v129, v130, v131);
    ...
    if ((objc_msgSend_modifiesOriginalTokens(self, v148, v149, v150, v151, v152) & 1) == 0 && (objc_msgSend_isEqualToArray_(v119, v153, v120, v154, v155, v156) & 1) == 0)
    {
      ...
      v162 = objc_msgSend_result(processCopy, v157, v158, v159, v160, v161);
    ...
    if (self && self->_shouldAddAlternatives && (objc_msgSend_isEqualToArray_(v121, v153, v120, v154, v155, v156) & 1) == 0)
    {
      ...
      v187 = objc_msgSend_result(processCopy, v182, v183, v184, v185, v186);
