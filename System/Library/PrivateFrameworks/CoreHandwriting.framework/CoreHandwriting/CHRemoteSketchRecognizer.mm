...
- (BOOL)isEqualToRemoteSketchRecognizer:(id)recognizer;
- (CHRemoteSketchRecognizer)initWithPriority:(int64_t)priority;
...
- (CHRemoteSketchRecognizer)initWithPriority:(int64_t)priority
{
  ...
  objc_msgSend_setPriority_(v4, v5, priority, v6, v7, v8);
  return v4;
}
...
- (id)sketchRecognitionResultsForDrawing:(id)drawing options:(id)options error:(id *)error
{
  if (self)
  {
    ...
    v18 = objc_msgSend_initWithDrawing_options_priority_(v9, v16, drawingCopy, optionsCopy, v15, v17);
    ...
    if (!selfCopy->__connection)
    {
      ...
      objc_msgSend_setRemoteObjectInterface_(selfCopy->__connection, v76, v128, v77, v78, v79);
      objc_initWeak(&location, selfCopy);
      v80 = selfCopy->__connection;
      *buf = MEMORY[0x1E69E9820];
      ...
      objc_msgSend_setInvalidationHandler_(selfCopy->__connection, v85, &unk_1EF1BC5F8, v86, v87, v88);
      objc_msgSend_resume(selfCopy->__connection, v89, v90, v91, v92, v93);
...
- (BOOL)isEqualToRemoteSketchRecognizer:(id)recognizer
{
  ...
  else
  {
    ...
    v33 = objc_msgSend_activeCharacterSet(recognizerCopy, v28, v29, v30, v31, v32);
    v39 = v33;
    if (v27 == v33)
    {
    }
    ...
    else
    {
      ...
      v46 = objc_msgSend_activeCharacterSet(recognizerCopy, v41, v42, v43, v44, v45);
    ...
    if (v58 != objc_msgSend_maxRecognitionResultCount(recognizerCopy, v59, v60, v61, v62, v63))
    {
LABEL_14:
      v57 = 0;
      goto LABEL_15;
    ...
    v57 = v69 == objc_msgSend_priority(recognizerCopy, v70, v71, v72, v73, v74);
  }
...
- (BOOL)isEqual:(id)equal
{
  ...
  {
    isEqualToRemoteSketchRecognizer = objc_msgSend_isEqualToRemoteSketchRecognizer_(self, v5, equalCopy, v6, v7, v8);
...
- (void)dealloc
{
  if (self)
  {
    selfCopy = self;
    objc_sync_enter(selfCopy);
    objc_msgSend_invalidate(selfCopy->__connection, v4, v5, v6, v7, v8);
    connection = selfCopy->__connection;
    selfCopy->__connection = 0;
