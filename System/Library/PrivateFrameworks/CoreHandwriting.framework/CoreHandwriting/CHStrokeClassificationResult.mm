...
- (BOOL)isEquivalentToStrokeClassificationResult:(id)result;
- (BOOL)isHighConfidenceForStrokesIdentifiers:(id)identifiers scripts:(id)scripts confidenceThreshold:(double)threshold;
- (CHStrokeClassificationResult)init;
- (CHStrokeClassificationResult)initWithCoder:(id)coder;
- (CHStrokeClassificationResult)initWithStrokeClassificationsByStrokeIdentifier:(id)identifier scriptClassificationsByStrokeIdentifier:(id)strokeIdentifier scriptClassificationRawResultsByStrokeIdentifier:(id)byStrokeIdentifier substrokesByStrokeIdentifier:(id)substrokesByStrokeIdentifier midYPositionByStrokeIdentifier:(id)positionByStrokeIdentifier nontextCandidates:(id)candidates;
...
- (CHStrokeClassificationResult)initWithStrokeClassificationsByStrokeIdentifier:(id)identifier scriptClassificationsByStrokeIdentifier:(id)strokeIdentifier scriptClassificationRawResultsByStrokeIdentifier:(id)byStrokeIdentifier substrokesByStrokeIdentifier:(id)substrokesByStrokeIdentifier midYPositionByStrokeIdentifier:(id)positionByStrokeIdentifier nontextCandidates:(id)candidates
{
  ...
  if (v25)
  {
    v26 = objc_msgSend_copy(identifierCopy, v20, v21, v22, v23, v24);
    ...
    v33 = objc_msgSend_copy(strokeIdentifierCopy, v28, v29, v30, v31, v32);
    ...
    v40 = objc_msgSend_copy(byStrokeIdentifierCopy, v35, v36, v37, v38, v39);
...
- (NSSet)textStrokeIdentifiers
{
  ...
  if (!selfCopy->_textStrokeIdentifiers)
  {
    v8 = objc_msgSend_strokeClassificationsByStrokeIdentifier(selfCopy, v3, v4, v5, v6, v7);
    v13 = objc_msgSend_keysOfEntriesPassingTest_(v8, v9, &unk_1EF1BC850, v10, v11, v12);

    textStrokeIdentifiers = selfCopy->_textStrokeIdentifiers;
    selfCopy->_textStrokeIdentifiers = v13;
  }

  objc_sync_exit(selfCopy);

  v15 = selfCopy->_textStrokeIdentifiers;
...
- (BOOL)isEquivalentToStrokeClassificationResult:(id)result
{
  ...
  v22 = objc_msgSend_strokeClassificationsByStrokeIdentifier(resultCopy, v17, v18, v19, v20, v21);
    ...
    if (v48)
    {
      ...
      while (2)
      {
        for (i = 0; i != v48; ++i)
        {
          ...
          v63 = objc_msgSend_strokeClassificationsByStrokeIdentifier(resultCopy, v58, v59, v60, v61, v62);
...
- (void)encodeWithCoder:(id)coder
{
  ...
  v10 = objc_msgSend_strokeClassificationsByStrokeIdentifier(self, v5, v6, v7, v8, v9);
  objc_msgSend_encodeObject_forKey_(coderCopy, v11, v10, @"strokeClassificationsByStrokeIdentifier", v12, v13);

  v19 = objc_msgSend_scriptClassificationsByStrokeIdentifier(self, v14, v15, v16, v17, v18);
  objc_msgSend_encodeObject_forKey_(coderCopy, v20, v19, @"scriptClassificationsByStrokeIdentifier", v21, v22);

  v28 = objc_msgSend_scriptClassificationRawResultsByStrokeIdentifier(self, v23, v24, v25, v26, v27);
  objc_msgSend_encodeObject_forKey_(coderCopy, v29, v28, @"scriptClassificationRawResultsByStrokeIdentifier", v30, v31);

  v37 = objc_msgSend_midYPositionByStrokeIdentifier(self, v32, v33, v34, v35, v36);
  objc_msgSend_encodeObject_forKey_(coderCopy, v38, v37, @"midYPositionByStrokeIdentifier", v39, v40);

  v46 = objc_msgSend_substrokesByStrokeIdentifier(self, v41, v42, v43, v44, v45);
  objc_msgSend_encodeObject_forKey_(coderCopy, v47, v46, @"substrokesByStrokeIdentifier", v48, v49);

  v55 = objc_msgSend_nontextCandidates(self, v50, v51, v52, v53, v54);
  objc_msgSend_encodeObject_forKey_(coderCopy, v56, v55, @"nontextCandidates", v57, v58);
...
- (CHStrokeClassificationResult)initWithCoder:(id)coder
{
  ...
  selfCopy = self;
  v95 = objc_msgSend_decodeObjectOfClasses_forKey_(coderCopy, v16, v14, @"strokeClassificationsByStrokeIdentifier", v17, v18);
  ...
  v32 = objc_msgSend_decodeObjectOfClasses_forKey_(coderCopy, v29, v28, @"scriptClassificationsByStrokeIdentifier", v30, v31);
  ...
  v46 = objc_msgSend_decodeObjectOfClasses_forKey_(coderCopy, v43, v42, @"substrokesByStrokeIdentifier", v44, v45);
  ...
  v60 = objc_msgSend_decodeObjectOfClasses_forKey_(coderCopy, v57, v56, @"scriptClassificationRawResultsByStrokeIdentifier", v58, v59);
  ...
  v74 = objc_msgSend_decodeObjectOfClasses_forKey_(coderCopy, v71, v70, @"midYPositionByStrokeIdentifier", v72, v73);
  ...
  v90 = objc_msgSend_decodeObjectOfClasses_forKey_(coderCopy, v87, v86, @"nontextCandidates", v88, v89);

  v92 = objc_msgSend_initWithStrokeClassificationsByStrokeIdentifier_scriptClassificationsByStrokeIdentifier_scriptClassificationRawResultsByStrokeIdentifier_substrokesByStrokeIdentifier_midYPositionByStrokeIdentifier_nontextCandidates_(selfCopy, v91, v95, v32, v60, v46, v76, v90);
...
- (BOOL)isHighConfidenceForStrokesIdentifiers:(id)identifiers scripts:(id)scripts confidenceThreshold:(double)threshold
{
  ...
  scriptsCopy = scripts;
  v90 = identifiersCopy;
  if (objc_msgSend_count(identifiersCopy, v10, v11, v12, v13, v14))
  {
    v104 = 0u;
    v105 = 0u;
    v102 = 0u;
...
LABEL_26:
    ...
    v83 = v23 / objc_msgSend_count(obj, v84, v85, v86, v87, v88) >= threshold;
  }
...
- (double)scriptClassificationScoreForStrokeIdentifier:(id)identifier script:(id)script
{
  ...
  v18 = objc_msgSend_objectForKeyedSubscript_(v13, v14, identifierCopy, v15, v16, v17);
  ...
  v35 = objc_msgSend_objectForKeyedSubscript_(v30, v31, identifierCopy, v32, v33, v34);
  ...
  v69 = objc_msgSend_objectForKeyedSubscript_(v64, v65, scriptCopy, v66, v67, v68);
  objc_msgSend_floatValue(v69, v70, v71, v72, v73, v74);
  v76 = v75;

  v82 = objc_msgSend_orderedScriptClassification(v35, v77, v78, v79, v80, v81);
  LOBYTE(v69) = objc_msgSend_containsObject_(v82, v83, scriptCopy, v84, v85, v86);

  v92 = 0.0;
  if (v69)
  {
    v93 = objc_msgSend_integerValue(scriptCopy, v87, v88, v89, v90, v91);
    v92 = v76;
    if (v46 != v24)
    {
      if (v93 == v46)
...
- (id)subResultForStrokeIdentifiers:(id)identifiers
{
  ...
  v10 = objc_msgSend_count(identifiersCopy, v5, v6, v7, v8, v9);
  ...
  v32 = objc_msgSend_count(identifiersCopy, v27, v28, v29, v30, v31);
  v225 = objc_msgSend_dictionaryWithCapacity_(v26, v33, v32, v34, v35, v36);
  v37 = MEMORY[0x1E695DF90];
  v43 = objc_msgSend_count(identifiersCopy, v38, v39, v40, v41, v42);
  ...
  v65 = objc_msgSend_count(identifiersCopy, v60, v61, v62, v63, v64);
