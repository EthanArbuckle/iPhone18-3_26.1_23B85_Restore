...
- (CHLineWrappableGroup)initWithCoder:(id)coder;
- (CHLineWrappableGroup)initWithLines:(id)lines;
...
- (CHLineWrappableGroup)initWithLines:(id)lines
{
  ...
  if (v6)
  {
    ...
    v18 = objc_msgSend_firstObject(linesCopy, v7, v8, v9, v10, v11);
    if (v18)
    {
      v19 = objc_msgSend_firstObject(linesCopy, v13, v14, v15, v16, v17);
    ...
    objc_storeStrong(&v12->_subregions, lines);
...
- (void)encodeWithCoder:(id)coder
{
  ...
  objc_msgSend_encodeBool_forKey_(coderCopy, v20, canWrapToNextGroup, @"canWrapToNextGroup", v21, v22);
  v28 = objc_msgSend_layoutDirection(self, v23, v24, v25, v26, v27);
  objc_msgSend_encodeInteger_forKey_(coderCopy, v29, v28, @"layoutDirection", v30, v31);
  v37 = objc_msgSend_subregions(self, v32, v33, v34, v35, v36);
  objc_msgSend_encodeObject_forKey_(coderCopy, v38, v37, @"subregions", v39, v40);
...
- (CHLineWrappableGroup)initWithCoder:(id)coder
{
  ...
  if (v9)
  {
    v10 = objc_msgSend_decodeObjectForKey_(coderCopy, v5, @"boundingQuad", v6, v7, v8);
    boundingQuad = v9->_boundingQuad;
    v9->_boundingQuad = v10;

    v9->_canWrapToNextGroup = objc_msgSend_decodeBoolForKey_(coderCopy, v12, @"canWrapToNextGroup", v13, v14, v15);
    v9->_layoutDirection = objc_msgSend_decodeIntegerForKey_(coderCopy, v16, @"layoutDirection", v17, v18, v19);
    v20 = objc_opt_class();
    v24 = objc_msgSend_decodeArrayOfObjectsOfClass_forKey_(coderCopy, v21, v20, @"subregions", v22, v23);
    ...
    v9->_textRegionType = objc_msgSend_decodeIntegerForKey_(coderCopy, v32, @"textRegionType", v33, v34, v35);
    v36 = objc_opt_class();
