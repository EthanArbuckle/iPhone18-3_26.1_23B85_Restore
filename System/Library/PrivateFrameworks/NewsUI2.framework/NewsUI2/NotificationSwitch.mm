...
- (_TtC7NewsUI218NotificationSwitch)initWithCoder:(id)coder;
- (_TtC7NewsUI218NotificationSwitch)initWithFrame:(CGRect)frame;
@end
...
- (_TtC7NewsUI218NotificationSwitch)initWithCoder:(id)coder
{
  ...
  *(&self->super.super.super.super.super.isa + v6) = [v8 init];
  ...
  v13 = [(NotificationSwitch *)&v15 initWithCoder:coderCopy];
...
- (BOOL)accessibilityActivate
{
  ...
  selfCopy = self;
  isOn = [(NotificationSwitch *)selfCopy isOn];
