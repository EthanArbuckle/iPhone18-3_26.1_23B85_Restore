...
- (void)viewDidAppear:(BOOL)a3
{
  ...
  v10 = *(&v9->super.super._responderFlags + OBJC_IVAR____TtC7NewsUI225EmailSignupViewController_eventHandler);
...
- (void)viewWillLayoutSubviews
{
  ...
  sub_218AB2404();
  sub_218AB25C4();
  v3 = [*&v2[OBJC_IVAR____TtC7NewsUI225EmailSignupViewController_obController] headerView];
  v4 = v2;
  sub_218AB3A8C(v3, v4, v4);
}
...
- (void)traitCollectionDidChange:(id)a3
{
  ...
  v6 = [*&v5[OBJC_IVAR____TtC7NewsUI225EmailSignupViewController_obController] headerView];
  v7 = v5;
  sub_218AB3A8C(v6, v7, v7);
}
