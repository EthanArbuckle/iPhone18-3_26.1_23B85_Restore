              ...
              if (v21)
              {
                ...
                while (2)
                {
                  for (i = 0; i != v22; ++i)
                  {
                    ...
                    {
                      v34 = [[SCROIOSerialElement alloc] initWithFileDescriptor:descriptor];
                      v35 = _SCROD_LOG();
...
- (void)_detectSerialPorts:(id)ports
{
  ...
  else
  {
    ...
    _serialPortMatchingDictionary = [(SCROBrailleDisplayAutoDetector *)self _serialPortMatchingDictionary];
    v10 = v27;
    v11 = CFRetain(_serialPortMatchingDictionary);
...
- (void)addAutodetectBLEIdentifier:(id)identifier
{
  ...
  if (identifierCopy && ([(NSMutableArray *)self->_bleIdentifiers containsObject:identifierCopy]& 1) == 0)
  {
    [(NSMutableArray *)self->_bleIdentifiers addObject:identifierCopy];
  }
  ...
  v25 = 0u;
  centralManager = [(SCROBrailleDisplayAutoDetector *)self centralManager];
  v11 = [centralManager retrieveConnectedPeripheralsWithServices:0 allowAll:1];
  ...
  if (v12)
  {
    ...
    do
    {
      for (i = 0; i != v13; ++i)
      {
        ...
        identifier = [(CBCentralManager *)v16 identifier];
        uUIDString = [identifier UUIDString];
        ...
        if (bleIdentifiers)
        {
          ...
          [(SCROBrailleDisplayAutoDetector *)self _addBLEPeripheral:v16 central:centralManager2];
        }
      }
...
- (void)centralManagerDidUpdateState:(id)state
{
  ...
  if (state == 5)
  {
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_DEFAULT))
    {
      v20 = [MEMORY[0x277CCABB0] numberWithBool:isScanning];
      *buf = 138412546;
      v32 = stateCopy;
      v33 = 2112;
      v34 = v20;
    ...
    if ((isScanning & 1) == 0)
    {
      ...
      [stateCopy scanForPeripheralsWithServices:0 options:v22];
    }
  }
    ...
    if (v8)
    {
      ...
      do
      {
        ...
        do
        {
          ...
          [peripheralCopy discoverCharacteristics:0 forService:*(*(&v13 + 1) + 8 * v11++)];
        }

        while (v9 != v11);
        v9 = [services countByEnumeratingWithState:&v13 objects:v17 count:16];
      }
...
- (void)peripheral:(id)peripheral didDiscoverCharacteristicsForService:(id)service error:(id)error
{
  ...
  if ((v9 & 1) == 0)
  {
    ...
    v11 = [characteristics countByEnumeratingWithState:&v17 objects:v21 count:16];
    if (v11)
    {
      v12 = v11;
      v13 = *v18;
      do
      {
        ...
        v12 = [characteristics countByEnumeratingWithState:&v17 objects:v21 count:16];
      }
...
- (void)centralManager:(id)manager didDisconnectPeripheral:(id)peripheral error:(id)error
{
  ...
  if (v11)
  {
    [(SCROBrailleDisplayAutoDetector *)self centralManagerDidUpdateState:managerCopy];
    v14 = _SCROD_LOG();
    if (os_log_type_enabled(v14, OS_LOG_TYPE_DEFAULT))
    {
      LOWORD(v16) = 0;
