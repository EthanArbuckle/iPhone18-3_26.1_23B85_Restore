...
- (BOOL)trimDatabaseWithOperation:(IMDSqlOperation *)operation
{
  objc_msgSend_performMessageSelectionWithOperation_(self, a2, operation);
  if (operation->var5)
  {
    return 0;
  }
  ...
  _IMDSqlOperationBeginQuery(operation, v9);
  ...
  _IMDSqlOperationBeginQuery(operation, v11);
  IMDSqlOperationFinishQuery(operation);
  if (operation->var5)
  {
    return 0;
  ...
  _IMDSqlOperationBeginQuery(operation, v13);
  IMDSqlOperationFinishQuery(operation);
  if (operation->var5)
  {
    return 0;
...
- (BOOL)copyDatabase:(id)database
{
  v5 = objc_msgSend_sourcePath(self, a2, database);
