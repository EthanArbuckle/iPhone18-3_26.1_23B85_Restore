...
- (id)_addressComponentsFromMapMetadata:(id)metadata
{
  ...
  v7 = objc_msgSend_address(metadataCopy, v5, v6);

  if (v7)
  {
    v10 = objc_msgSend_address(metadataCopy, v8, v9);
    objc_msgSend_addObject_(v4, v11, v10);
  }

  v12 = objc_msgSend_addressComponents(metadataCopy, v8, v9);
...
- (void)_mapPropertiesFromMetadata:(id)metadata toAttributes:(id)attributes
{
  ...
  if (v46)
  {
    ...
    objc_msgSend_setAddressCategories_(attributesCopy, v52, v51);
  }

  v53 = objc_msgSend__addressComponentsFromMapMetadata_(self, v47, v11);
  objc_msgSend_setAddresses_(attributesCopy, v54, v53);
