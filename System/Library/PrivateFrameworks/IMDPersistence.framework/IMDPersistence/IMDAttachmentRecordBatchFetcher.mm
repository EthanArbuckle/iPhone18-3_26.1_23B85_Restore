...
- (id)nextBatchWithSize:(unint64_t)size
{
  ...
  v7 = objc_msgSend_initWithKey_ascending_(v5, v6, @"rowID", 1);
  v8 = MEMORY[0x1E696AE18];
  RowID = objc_msgSend_lastRowID(self, v9, v10);
  v13 = objc_msgSend_predicateWithFormat_(v8, v12, @"%K > %lld", @"rowID", RowID);
  ...
  v27 = objc_msgSend_synchronousDatabase(IMDDatabase, v25, v26);
  v51 = v7;
  ...
  v44[3] = &unk_1E7CB6860;
  v44[4] = &v45;
  objc_msgSend_fetchAttachmentRecordsFilteredUsingPredicate_sortedUsingDescriptors_limit_completionHandler_(v27, v30, v24, v29, size, v44);
