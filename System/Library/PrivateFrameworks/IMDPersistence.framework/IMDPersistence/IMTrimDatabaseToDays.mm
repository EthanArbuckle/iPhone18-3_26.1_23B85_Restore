...
- (void)performMessageSelectionWithOperation:(IMDSqlOperation *)operation
{
  objc_msgSend_timeIntervalSinceReferenceDate(MEMORY[0x1E695DF00], a2, operation);
  ...
  _IMDSqlOperationBeginQuery(operation, v8);
  IMDSqlStatementBindInt64(&operation->var4, v6);
