...
- (void)_mapPropertiesFromMetadata:(id)a3 toAttributes:(id)a4
{
  v135 = a4;
  v6 = a3;
  v9 = objc_msgSend_appleSummary(v6, v7, v8);
  objc_msgSend_setContentDescription_(v135, v10, v9);

  v13 = objc_msgSend_siteName(v6, v11, v12);
  objc_msgSend_setUrlDescription_(v135, v14, v13);

  v17 = objc_msgSend_specialization(v6, v15, v16);
  ...
  if (objc_opt_respondsToSelector())
  {
    ...
    if (v23)
    {
      ...
      if (v28)
      {
        ...
        objc_msgSend_setLinkName_(v135, v36, v35);
      }

      else
      {
        v30 = objc_msgSend_name(v17, v26, v27);
        objc_msgSend_setLinkName_(v135, v37, v30);
      }
    }
  }
  ...
  if (objc_opt_respondsToSelector())
  {
    ...
    if (v43)
    {
      ...
      objc_msgSend_setArtist_(v135, v50, v49);
    }
  }
  ...
  if (objc_opt_respondsToSelector())
  {
    ...
    if (v56)
    {
      ...
      objc_msgSend_setAlbum_(v135, v63, v62);
    }
  }
  ...
  if (objc_opt_respondsToSelector())
  {
    ...
    if (v69)
    {
      ...
      objc_msgSend_setGenre_(v135, v76, v75);
    }
  }
  ...
  if (objc_opt_respondsToSelector())
  {
    ...
    if (v82)
    {
      ...
      objc_msgSend_setCurator_(v135, v89, v88);
    }
  }
  ...
  if (objc_opt_respondsToSelector())
  {
    ...
    if (v95)
    {
      ...
      objc_msgSend_setEpisode_(v135, v102, v101);
    }
  }
  ...
  if (objc_opt_respondsToSelector())
  {
    ...
    if (v108)
    {
      ...
      objc_msgSend_setPodcastName_(v135, v113, v112);
    }
  }

  v114 = objc_msgSend_linkName(v135, v103, v104);
  ...
  if (!v117 && (objc_opt_respondsToSelector() & 1) != 0)
  {
    ...
    if (v123)
    {
      ...
      objc_msgSend_setLinkName_(v135, v130, v129);
    }
  }
  ...
  if (objc_opt_respondsToSelector())
  {
    ...
    objc_msgSend_setRecordingDate_(v135, v134, v133);
  }
}
