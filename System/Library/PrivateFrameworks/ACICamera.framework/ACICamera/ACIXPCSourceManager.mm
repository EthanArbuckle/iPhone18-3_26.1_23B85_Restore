...
- (ACIXPCSourceManager)initWithDelegate:(void *)a3;
- (id)allServiceProps;
...
- (ACIXPCSourceManager)initWithDelegate:(void *)a3
{
  ...
  if (v4)
  {
    ...
    aci::SP<aci::SourceManager,&(void ACISPRetain<aci::SourceManager>(aci::SourceManager &)),&(void ACISPRelease<aci::SourceManager>(aci::SourceManager &))>::setPtr(&v5->_delegate, a3);
...
- (void)initiateConnection
{
  ...
  v14 = [v10 stringWithFormat:@"%@#%d", v12, objc_msgSend(v13, "processIdentifier")];
