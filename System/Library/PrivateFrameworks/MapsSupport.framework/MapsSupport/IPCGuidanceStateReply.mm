...
- (IPCGuidanceStateReply)initWithDictionary:(id)a3
{
  ...
  v17 = sub_1000373C4(v4, @"kIPCGuidanceStateReplyPrimaryInstructionsKey");
  [(IPCGuidanceStateReply *)v5 setPrimaryInstructions:v17];

  v18 = sub_1000373C4(v4, @"kIPCGuidanceStateReplySecondaryInstructionsKey");
...
- (id)description
{
  ...
  v20 = sub_1000282B8(v3, &stru_1000864C8);

  v4 = [(IPCGuidanceStateReply *)self secondaryInstructions];
  v19 = sub_1000282B8(v4, &stru_1000864E8);
