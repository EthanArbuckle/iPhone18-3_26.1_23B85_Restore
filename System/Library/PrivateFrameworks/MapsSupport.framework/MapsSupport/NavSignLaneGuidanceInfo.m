...
- (NavSignLaneGuidanceInfo)initWithGuidanceLaneInfo:(id)a3
{
  ...
  if (v4)
  {
    ...
    if (v10)
    {
      ...
      v12 = sub_1000282B8(v11, &stru_100085488);
    }
    ...
    if (v16)
    {
      ...
      v18 = sub_1000282B8(v17, &stru_1000854D0);
    }
...
- (id)description
{
  ...
  {
    v9 = [NSString stringWithFormat:@"laneInfoID: [%@] %d lanes (forManeuver:%d) %@", v3, v5, v6, &stru_100087EB8];
  }
