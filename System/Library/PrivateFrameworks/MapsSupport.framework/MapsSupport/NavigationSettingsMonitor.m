  ...
  if (v4)
  {
    ...
    do
    {
      for (i = 0; i != v5; i = i + 1)
      {
        ...
        [v9 addObserver:self forKeyPath:v8 options:0 context:&off_100086208];
      }
  ...
  if (v10)
  {
    ...
    do
    {
      for (j = 0; j != v11; j = j + 1)
      {
        ...
        [v15 addObserver:self forKeyPath:v14 options:0 context:&off_100086208];
      }
...
- (void)observeValueForKeyPath:(id)a3 ofObject:(id)a4 change:(id)a5 context:(void *)a6
{
  ...
  if (([qword_10009E7D8 containsObject:v10] & 1) != 0 || objc_msgSend(&off_10008CA40, "containsObject:", v10))
  {
    [(NavigationSettingsMonitor *)self _updateUserOptionsAndNotifyObservers:1];
  }
