...
- (void)_handleFake:(id)a3
{
  ...
  if ([v23 hasPrefix:@"com.apple.maps.FakeExternalAccessory.engine.type"])
  {
    ...
    v9 = [NSNumber numberWithUnsignedInt:sub_100002288(v5) | v8];
  ...
  else
  {
    if ([v23 hasPrefix:@"com.apple.maps.FakeExternalAccessory.engine.low"])
    {
      v10 = qword_1000758B8;
      v11 = qword_100075870;
      v12 = [NSNumber numberWithUnsignedInt:sub_100002288(v5)];
      v13 = [v11 objectForKeyedSubscript:v12];
      [v10 setObject:&__kCFBooleanTrue forKeyedSubscript:v13];

      v14 = qword_1000758B8;
      v15 = qword_100075868;
      v9 = [NSNumber numberWithUnsignedInt:sub_100002288(v5)];
    ...
    else
    {
      ...
      v18 = qword_1000758B8;
      v19 = qword_100075870;
      v20 = [NSNumber numberWithUnsignedInt:sub_100002288(v5)];
...
- (id)identifier
{
  v3 = VirtualGarageConfig_EVRoutingUseCarDisplaySimIdentifier[1];
  if (GEOConfigGetBOOL())
  {
    v4 = @"CarDisplaySim";
  }
  ...
  {
    v4 = [(EAAccessory *)self->_accessory serialNumber];
  }
