...
- (id)suspendWithError:(id *)a3
{
  ...
  if (![(AFSCFileInterface *)self aaStream])
  {
    ...
    v15 = sub_10000151C("[AFSCFileInterface suspendWithError:]", 352, @"SZExtractorErrorDomain", 1, 0, 0, @"AAStream was NULL when trying to suspend %@", v14, v5);
    goto LABEL_12;
  }
  ...
  if (!v6)
  {
    ...
    v15 = sub_10000151C("[AFSCFileInterface suspendWithError:]", 359, @"SZExtractorErrorDomain", 1, v7, 0, @"Failed to create MemoryBufferStream while suspending %@", v17, v5);
...
LABEL_12:
  ...
  *__error() = 0;
  ...
  if (v8)
  {
    ...
    v15 = sub_10000151C("[AFSCFileInterface suspendWithError:]", 365, @"SZExtractorErrorDomain", 1, v25, 0, @"Failed to suspend AAAFSC stream for %@", v27, v5);
...
- (BOOL)finalizeFileWithAccessTime:(timeval)a3 modTime:(timeval)a4 mode:(unsigned __int16)a5 error:(id *)a6
{
  ...
  if (!v14)
  {
    ...
    v17 = sub_10000151C("[AFSCFileInterface finalizeFileWithAccessTime:modTime:mode:error:]", 321, @"SZExtractorErrorDomain", 1, 0, 0, @"AAStream was NULL when trying to finalize %@", v20, v13);
    if (!a6)
    {
      goto LABEL_11;
    }
  ...
  if (!v16)
  {
    ...
    v24 = sub_10000151C("[AFSCFileInterface finalizeFileWithAccessTime:modTime:mode:error:]", 328, @"SZExtractorErrorDomain", 1, v17, 0, @"Failed to close AAAFSC stream for %@", v23, v13);
...
LABEL_7:
  ...
  sub_10000C408(-[AFSCFileInterface outputFD](self, "outputFD"), [v13 fileSystemRepresentation], v11, v10, tv_sec, v8, v7);
  v18 = 1;
LABEL_12:
...
- (void)configureFileAndSetOwnership:(BOOL)a3 toUID:(unsigned int)a4 GID:(unsigned int)a5
{
  ...
  v10 = v11;
  sub_10000C628(v9, [v11 fileSystemRepresentation], -[AFSCFileInterface fileSize](self, "fileSize"), v7, a4, a5);
}
...
- (void)setIncompleteExtractionAttribute
{
  ...
  v5 = [(AFSCFileInterface *)self path];
  v4 = v5;
  sub_10000C8E8(v3, [v5 fileSystemRepresentation]);
}
...
- (BOOL)setCurrentOffset:(int64_t)a3 error:(id *)a4
{
  ...
  if (v9 == 1)
  {
    ...
    v12 = sub_10000151C("[AFSCFileInterface setCurrentOffset:error:]", 293, @"SZExtractorErrorDomain", 1, 0, 0, @"AAFSC stream expected file to resume at offset %lld but StreamingZip believes it should resume at offset %lld", v11, v7);
    if (a4)
    {
      v12 = v12;
      *a4 = v12;
...
LABEL_5:
  ...
  v10 = sub_10000151C("[AFSCFileInterface closeOutputFDWithError:]", 264, @"SZExtractorErrorDomain", 1, v9, 0, @"Failed to close AAFSC stream for %@", v15, v14);
...
- (BOOL)writeBuffer:(const void *)a3 length:(unint64_t)a4 error:(id *)a5
{
  ...
  if (v9)
  {
    ...
    *__error() = 0;
    ...
    if (v11 < 0)
    {
      ...
      v14 = sub_10000151C("[AFSCFileInterface writeBuffer:length:error:]", 231, @"SZExtractorErrorDomain", 1, v28, v30, @"AAAFSC stream failed to write data to output file at %@", v31, v17);
    }
  ...
  else
  {
    ...
    v17 = [(AFSCFileInterface *)self path];
    v14 = sub_10000151C("[AFSCFileInterface writeBuffer:length:error:]", 224, @"SZExtractorErrorDomain", 1, 0, 0, @"AAStream was NULL when trying to write to %@", v18, v17);
  }
