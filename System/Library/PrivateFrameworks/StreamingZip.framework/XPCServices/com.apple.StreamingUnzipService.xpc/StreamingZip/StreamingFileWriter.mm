  ...
  if (v8)
  {
    ...
    else
    {
      ...
      if ((objc_opt_isKindOfClass() & 1) == 0)
      {
        ...
        v17 = sub_10000151C("[StreamingFileWriter suspendWithError:]", 322, @"SZExtractorErrorDomain", 1, 0, 0, @"Unknown file interface class for path %@ : %@", v20, v6);
    ...
    v17 = sub_10000151C("[StreamingFileWriter suspendWithError:]", 330, @"SZExtractorErrorDomain", 1, v14, 0, @"Failed to archive StreamingFileWriterState for path %@", v16, v6);
    v9 = v14;
LABEL_18:
