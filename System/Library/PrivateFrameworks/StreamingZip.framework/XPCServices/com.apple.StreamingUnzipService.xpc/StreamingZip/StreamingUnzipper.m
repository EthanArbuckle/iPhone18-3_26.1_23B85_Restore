...
- (void)setupUnzipperWithOutputPath:(id)a3 sandboxExtensionToken:(char *)a4 options:(id)a5 withReply:(id)a6
{
  ...
  if (isKindOfClass)
  {
    ...
    if (v17 != v16)
    {
      ...
      sub_10000151C("[StreamingUnzipper setupUnzipperWithOutputPath:sandboxExtensionToken:options:withReply:]", 91, NSPOSIXErrorDomain, 22, 0, 0, @"Streaming Unzipper running with unexpected QOS: expected=0x%x actual=0x%x", v36, v16);
      goto LABEL_32;
    }
  }
  ...
  if (a4)
  {
    ...
    if (v21 == -1)
    {
      ...
      strerror(v37);
      sub_10000151C("[StreamingUnzipper setupUnzipperWithOutputPath:sandboxExtensionToken:options:withReply:]", 106, NSPOSIXErrorDomain, v37, 0, 0, @"Failed to consume sandbox extension token for %@ : %s (%d)", v39, v10);
      goto LABEL_32;
    }
  }
  ...
  if (self->_hasConnection)
  {
    ...
    *&buf[16] = v23;
    ...
    if (v24)
    {
      ...
      strerror(v25);
      sub_10000151C("[StreamingUnzipper setupUnzipperWithOutputPath:sandboxExtensionToken:options:withReply:]", 118, NSPOSIXErrorDomain, v25, 0, 0, @"Cannot write to path %@ : %s (%d)", v42, v10);
      v31 = LABEL_32:;
      v12[2](v12, v31, 0);
      goto LABEL_33;
    }
