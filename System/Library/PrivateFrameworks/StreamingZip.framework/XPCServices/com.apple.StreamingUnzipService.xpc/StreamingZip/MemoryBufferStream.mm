...
- (id)closeAndReturnBufferWithError:(id *)error
{
  ...
  v10 = sub_10000151C("[MemoryBufferStream closeAndReturnBufferWithError:]", v8, @"SZExtractorErrorDomain", 1, 0, 0, v7, v6, *v14);
  v11 = 0;
  if (!error)
  {
    goto LABEL_12;
...
- (MemoryBufferStream)initWithBuffer:(id)buffer error:(id *)error
{
  ...
  v8 = v7;
  if (v7 && !sub_10000B7E4(v7, bufferCopy, error))
  {
    v9 = 0;
  }
...
- (MemoryBufferStream)initWithError:(id *)error
{
  ...
  v5 = v4;
  if (!v4 || (v6 = sub_10000B7E4(v4, 0, error), v7 = 0, v6))
  {
    v7 = v5;
  }
