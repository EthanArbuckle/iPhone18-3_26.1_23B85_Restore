...
- (void)configureFileAndSetOwnership:(BOOL)a3 toUID:(unsigned int)a4 GID:(unsigned int)a5
{
  ...
  v10 = v11;
  sub_10000C628(v9, [v11 fileSystemRepresentation], -[DirectFileInterface fileSize](self, "fileSize"), v7, a4, a5);
}
...
- (BOOL)setCurrentOffset:(int64_t)a3 error:(id *)a4
{
  ...
  if (v7 == -1)
  {
    ...
    strerror(v8);
    v13 = sub_10000151C("[DirectFileInterface setCurrentOffset:error:]", 134, NSPOSIXErrorDomain, v8, 0, v11, @"Failed to seek to offset %llu in output file at path %@ : %s", v12, a3);
...
- (int64_t)currentOffsetWithError:(id *)a3
{
  ...
  if (v5 == -1)
  {
    ...
    strerror(v6);
    v11 = sub_10000151C("[DirectFileInterface currentOffsetWithError:]", 120, NSPOSIXErrorDomain, v6, 0, v9, @"Failed to seek to current offset in output file at path %@ : %s", v10, v7);
...
- (BOOL)writeBuffer:(const void *)a3 length:(unint64_t)a4 error:(id *)a5
{
  ...
  strerror(v12);
  v17 = sub_10000151C("[DirectFileInterface writeBuffer:length:error:]", 88, NSPOSIXErrorDomain, v12, 0, v15, @"Failed to write data to output file at %@: %s", v16, v13);
