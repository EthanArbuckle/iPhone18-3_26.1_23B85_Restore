...
- (BOOL)setCurrentOffset:(int64_t)a3 error:(id *)a4
{
  ...
  v9 = sub_10000151C("[AsyncStreamingFileWriter setCurrentOffset:error:]", 413, @"SZExtractorErrorDomain", 1, 0, 0, @"Setting current output offset not available on async file operation for %@", v8, v7);
...
- (int64_t)currentOffsetWithError:(id *)a3
{
  ...
  else
  {
    ...
    v11 = sub_10000151C("[AsyncStreamingFileWriter currentOffsetWithError:]", 404, @"SZExtractorErrorDomain", 1, 0, 0, @"Getting current output offset not available on async file operation for %@", v10, v9);
