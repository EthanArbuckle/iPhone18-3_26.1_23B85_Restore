...
- (StreamingFileWriterState)initWithCoder:(id)coder
{
  ...
  if ((unsignedIntegerValue - 1) >= 2)
  {
    ...
    sub_1000015F4("[StreamingFileWriterState initWithCoder:]", 74, @"SZExtractorErrorDomain", 2, 0, 0, @"Found unknown file interface type on decode: %lu", v12, v5->_fileInterfaceType);
    goto LABEL_12;
  }
  ...
  if (!v5->_fileInterfaceState)
  {
    ...
    sub_1000015F4("[StreamingFileWriterState initWithCoder:]", 80, @"SZExtractorErrorDomain", 2, 0, 0, @"Missing file interface state data on decode", v14, v18);
    v15 = LABEL_12:;
