id sub_10000126C()
{
  if (qword_10002F100 != -1)
  {
    dispatch_once(&qword_10002F100, &stru_1000286B0);
  }
...
void sub_1000012D0(id a1)
{
  off_10002ED90 = os_log_create("com.apple.streamingzip", "unzip_service");
...
id sub_100001314()
{
  if (qword_10002F108 != -1)
  {
    dispatch_once(&qword_10002F108, &stru_1000286D0);
  }
...
{
  off_10002ED98 = os_log_create("com.apple.streamingzip.signposts", "unzip_service");
...
int main(int argc, const char **argv, const char **envp)
{
  ...
  dispatch_source_set_event_handler(v8, &stru_100028710);
...
id sub_1000015F4(uint64_t a1, uint64_t a2, void *a3, uint64_t a4, void *a5, void *a6, void *a7, uint64_t a8, uint64_t a9)
{
  v15 = a3;
  v16 = a5;
  v17 = a6;
...
uint64_t sub_100001794(uint64_t result, int a2)
{
  *(result + 212) = 0;
  *(result + 196) = 0u;
  *(result + 180) = 0u;
...
unsigned __int8 *sub_10000183C(unsigned __int8 *result, uint64_t a2)
{
  v2 = *a2;
  if (*a2 > 4)
  {
...
uint64_t sub_1000018A8(uint64_t a1, unsigned __int16 *a2, unsigned int a3)
{
  v3 = *(a1 + 28);
  if (*(a1 + 28))
  {
...
uint64_t sub_10000191C(uint64_t a1)
{
  if ((*(a1 + 18) == -1 || *(a1 + 22) == -1) && (v2 = sub_1000018A8(a1, &word_10001A712, 0x10u)) != 0 && *(v2 + 2) == 16)
  {
    return *(v2 + 4);
  }
...
time_t sub_100001984(unsigned int a1)
{
  v6 = time(0);
  v3 = qword_10002F130;
  if (!qword_10002F130)
  {
    v3 = localtime_r(&v6, &stru_10002F138);
    qword_10002F130 = v3;
  }

  v3->tm_isdst = -1;
  v2.i32[0] = a1;
  v4 = vshlq_u32(vdupq_n_s32(a1), xmmword_10001A6F0);
  v4.i32[0] = vshlq_u32(v2, xmmword_10001A6E0).u32[0];
  *&v3->tm_sec = vandq_s8(v4, xmmword_10001A700);
...
void sub_100001E30(void *a1, void *a2)
{
  v3 = a2;
  if (a1)
  {
    if (qword_10002F190 != -1)
    {
      dispatch_once(&qword_10002F190, &stru_1000288C8);
    }
      ...
      while (2)
      {
        ...
        do
        {
          ...
          if (v11)
          {
            ...
            {
              v29 = __error();
              v31 = sub_1000015F4("[StreamingUnzipper _applyAppleDoubleAtPath:error:]", 1900, NSPOSIXErrorDomain, *v29, 0, 0, @"copyfile failed when called with source %s dest %s flags 0x%x", v30, v27);
              v32 = sub_10000126C();
              ...
              *v122 = v23;
              ...
              v35 = sub_1000015F4("[StreamingUnzipper _applyAppleDoubleAtPath:error:]", 1901, @"SZExtractorErrorDomain", 1, v31, v33, @"Failed to apply AppleDouble file at %@ to %@", v34, v23);
          ...
          if ((v40 & 1) == 0)
          {
            ...
            *v122 = v22;
            ...
            v38 = sub_1000015F4("[StreamingUnzipper _processAppleDoublePathsWithError:]", 1937, @"SZExtractorErrorDomain", 1, v19, v43, @"Failed to remove AppleDouble file at path %@", v44, v22);
...
LABEL_60:
  ...
  if (!v54)
  {
    ...
    v73 = 1750;
LABEL_68:
    v75 = sub_1000015F4("_ValidateAllSymlinksUnderPath", v73, @"SZExtractorErrorDomain", 2, 0, 0, v72, v71, v98);
    v55 = 0;
    goto LABEL_91;
  }
  ...
  *&v122[8] = 0;
  ...
  if (!v59)
  {
    ...
    v79 = 1697;
LABEL_75:
    v69 = sub_1000015F4("_TraverseDirectory", v79, @"SZExtractorErrorDomain", 2, 0, 0, v78, v77, v98);
    goto LABEL_87;
  }
...
LABEL_80:
  ...
  v69 = sub_1000015F4("_TraverseDirectory", 1706, @"SZExtractorErrorDomain", 2, 0, 0, @"Error for path %s: %s", v84, v112);
...
uint64_t sub_100003150(uint64_t a1, uint64_t a2, void *a3)
{
  if (!a2)
  {
    return 1;
  ...
  v6 = [v5 path];
  v7 = [*(a1 + 32) path];
  LODWORD(a3) = sub_1000031FC(v6, v7, a3);
...
uint64_t sub_1000031FC(void *a1, void *a2, void *a3)
{
  v5 = a1;
  v6 = a2;
  bzero(__s, 0x400uLL);
      ...
      while (2)
      {
        ...
        for (i = 0; i != v12; i = i + 1)
        {
          ...
          if (v13 >= [v9 count] || (objc_msgSend(v9, "objectAtIndexedSubscript:", v13), v19 = objc_claimAutoreleasedReturnValue(), v20 = objc_msgSend(v18, "isEqualToString:", v19), v19, (v20 & 1) == 0))
          {
            ...
            v21 = sub_1000015F4("_CheckRealpathHasBasePrefix", 466, @"SZExtractorErrorDomain", 5, 0, v24, @"Rejecting %s because its resolved path %@ points outside or to the unzip dir %@", v26, v25);
...
LABEL_17:
  ...
  else
  {
    ...
    strerror(v29);
    v21 = sub_1000015F4("_CheckRealpathHasBasePrefix", 454, @"SZExtractorErrorDomain", 5, v8, v9, @"Call to realpath failed for suspicious path %s: %s", v33, v32);
    v22 = 0;
  }
...
void sub_100003DA0(uint64_t a1, const Bytef *a2, uint64_t a3, uint64_t a4, _BYTE *a5)
{
  v10 = sub_10000126C();
...
void sub_100003F04(uint64_t a1, void *a2, char a3)
{
...
void sub_100003F64(uint64_t a1, const Bytef *a2, uint64_t a3, void *a4)
{
  v7 = a4;
  if (!a1)
  {
...
LABEL_78:
        ...
        v63 = sub_100009B78(*v9);
        v64 = *v9;
        if (v62 == v63)
        {
          v65 = [v64 currentCRC32];
          v66 = sub_10000A35C(*v9);
          v67 = [*v9 currentLFRecord];
          if (v65 == v66)
          {
            v68 = sub_1000018A8(v67, &word_10001A710, 8u);
            v69 = sub_100009D94([*v9 currentLFRecord]);
...
LABEL_406:
                ...
                else
                {
                  ...
                  {
                    v108 = sub_100001984(*([*v9 currentLFRecord] + 10));
                    v109 = v108;
                  }
...
LABEL_396:
                      ...
                      {
                        sub_10000A21C(a1, [*(a1 + 64) recordsProcessed] / objc_msgSend(*(a1 + 64), "totalRecordCount"));
                      }
...
LABEL_279:
          ...
          sub_10000A35C(*v9);
          sub_1000015F4("[StreamingUnzipper _supplyBytes:length:withReply:]", 1287, @"SZExtractorErrorDomain", 2, 0, v321, @"CRC mismatch; got: 0x%lx expected: 0x%x for file %@", v327, v326);
        }
        ...
        else
        {
          ...
          sub_100009B78(*v9);
          sub_1000015F4("[StreamingUnzipper _supplyBytes:length:withReply:]", 1279, @"SZExtractorErrorDomain", 2, 0, v321, @"Decompression failed to produce all expected output data for file %@; produced %llu bytes, expected %llu", v323, v319);
        }
        v16 = ;
      ...
      v14 = sub_1000018A8([*v9 currentLFRecord], &word_10001A712, 0x10u);
      if (v14)
      {
        v15 = 24;
      }
      ...
      if (*[*v9 dataDescriptor] != 134695760)
      {
        ...
        v344 = v12;
LABEL_484:
        v10 = sub_100009408(v343, v342, v344);
        goto LABEL_534;
      }
...
LABEL_502:
    ...
    {
      v36 = sub_100009B78(*v9);
      v37 = sub_100009C68(*v9);
      v38 = *v9;
      if (!v37 && v36)
      {
        v371 = [v38 unsureData];
...
LABEL_49:
    v39 = sub_100009D94([*v9 currentLFRecord]);
...
LABEL_114:
    ...
    v95 = sub_1000018A8([v94 currentLFRecord], word_10001A714, 2u);
    if (v95)
    {
      v96 = *(v95 + 4);
      v94 = *v9;
...
LABEL_216:
    ...
    v159 = sub_10000191C([*v9 currentLFRecord]);
    if (v159 > 0x500000)
    {
      v160 = v159;
      v161 = sub_10000126C();
...
LABEL_506:
        ...
        v10 = sub_1000015F4("[StreamingUnzipper _supplyBytes:length:withReply:]", 1198, @"SZExtractorErrorDomain", 2, 0, v384, @"Unknown compression method %hu for file %@", v387, v386[4]);
...
LABEL_320:
      ...
      while (1)
      {
        ...
        if (!v234 && v230 && v230 == src_size && dst_size == 0x10000)
        {
          ...
          v10 = sub_1000015F4("[StreamingUnzipper _supplyBytes:length:withReply:]", 1136, @"SZExtractorErrorDomain", 1, 0, v305, @"compression_stream_process did not consume data for output file %@ input buffer size: %zu, output buffer size: %zu", v308, v307);;
...
LABEL_433:
        ...
        else
        {
          ...
          {
            sub_10000A21C(a1, [*(a1 + 64) totalFileSizeWritten] / objc_msgSend(*(a1 + 64), "totalUncompressedBytes"));
          }
        }
...
id sub_1000092F8(uint64_t a1, uint64_t a2, void *a3, const void **a4, size_t *a5)
{
  v9 = *a5;
  v10 = a3;
...
id sub_100009408(uint64_t a1, uint64_t a2, uint64_t a3)
{
  v6 = [*(a1 + 64) unzipPath];
  if ((*(a1 + 116) & 1) == 0)
  {
    ...
    v21 = sub_1000015F4("[StreamingUnzipper _beginNonStreamablePassthroughWithRemainingBytes:length:]", 196, @"SZExtractorErrorDomain", 2, 0, v26, @"Byte stream does not represent a valid streamable archive", v27, v40);
...
LABEL_28:
  ...
  if (!v12)
  {
    ...
    v21 = sub_1000015F4("[StreamingUnzipper _beginNonStreamablePassthroughWithRemainingBytes:length:]", 221, @"SZExtractorErrorDomain", 1, v13, v29, @"Failed to open passthrough output file at %@", v30, v6);
...
LABEL_29:
    ...
    v21 = sub_1000015F4("[StreamingUnzipper _beginNonStreamablePassthroughWithRemainingBytes:length:]", 236, @"SZExtractorErrorDomain", 1, v20, v36, @"Failed to write remaining initial data to passthrough output file", v37, v40);
  ...
  else
  {
    ...
    v21 = sub_1000015F4("[StreamingUnzipper _beginNonStreamablePassthroughWithRemainingBytes:length:]", 230, @"SZExtractorErrorDomain", 1, v18, v33, @"Failed to write initial data to passthrough output file", v34, v40);
...
uint64_t sub_100009B78(void *a1)
{
  ...
  if (*([v1 currentLFRecord] + 4) && objc_msgSend(v1, "currentLFRequiresDataDescriptor"))
  {
    ...
    v3 = sub_1000018A8([v1 currentLFRecord], &word_10001A712, 0x10u);
...
uint64_t sub_100009C68(void *a1)
{
  v1 = a1;
  v2 = [v1 currentLFRecord];
  if (*([v1 currentLFRecord] + 4) && objc_msgSend(v1, "currentLFRequiresDataDescriptor"))
  ...
  else
  {
    ...
    if (v5 == -1 || *(v2 + 22) == -1)
    {
      v6 = sub_1000018A8(v2, &word_10001A712, 0x10u);
      if (v6)
      {
        if (*(v6 + 2) == 16)
        {
      ...
      for (i = 0; i != v23; ++i)
      {
        ...
        if (v25)
        {
          ...
          while (1)
          {
            ...
            if (v27 && (([v28 isEqualToString:@"."] & 1) != 0 || objc_msgSend(v28, "isEqualToString:", &stru_10002A2A0)))
            {
              goto LABEL_68;
            }
...
void sub_10000A21C(uint64_t a1, double a2)
{
...
uint64_t sub_10000A35C(void *a1)
{
  ...
  if ([v1 currentLFRequiresDataDescriptor])
  {
    ...
    sub_1000018A8([v1 currentLFRecord], &word_10001A712, 0x10u);
...
id sub_10000A428(unsigned __int8 *a1, uint64_t a2)
{
  v2 = a2;
...
uint64_t sub_10000A4B0(const char *a1, int a2, int *a3)
{
...
BOOL sub_10000B8BC(uint64_t a1, void *a2, void *a3)
{
  v5 = a2;
  v6 = v5;
  if (v5)
  ...
  *(a1 + 24) = 0;
  ...
  if (v9)
  {
    ...
    AACustomByteStreamSetCloseProc(v10, sub_10000C01C);
    AACustomByteStreamSetReadProc(v10, sub_10000BF8C);
    AACustomByteStreamSetPReadProc(v10, sub_10000BED8);
    AACustomByteStreamSetWriteProc(v10, sub_10000BE48);
    AACustomByteStreamSetPWriteProc(v10, sub_10000BD98);
    AACustomByteStreamSetSeekProc(v10, sub_10000BADC);
    AACustomByteStreamSetCancelProc(v10, sub_10000BACC);
  }
  ...
  else
  {
    ...
    v13 = sub_1000015F4("[MemoryBufferStream _createStreamWithError:]", 267, @"SZExtractorErrorDomain", 1, 0, 0, @"AACustomByteStreamOpen returned NULL", v12, *v15);
    if (a3)
    {
      v13 = v13;
      *a3 = v13;
...
uint64_t sub_10000BADC(void *a1, unint64_t a2, int a3)
{
  if (a1)
  {
    v5 = a1;
...
uint64_t sub_10000BC8C(void *a1, uint64_t a2, uint64_t a3)
{
  v5 = a1;
  v6 = [v5 buffer];
  v7 = v6;
...
uint64_t sub_10000BE48(void *a1, const void *a2, size_t a3)
{
  ...
  if ([v5 allowReadWriteSeek])
  {
    v6 = sub_10000BD98(v5, a2, a3, [v5 offset]);
...
uint64_t sub_10000BF8C(void *a1, void *a2, size_t a3)
{
  ...
  if ([v5 allowReadWriteSeek])
  {
    v6 = sub_10000BED8(v5, a2, a3, [v5 offset]);
    if ((v6 & 0x8000000000000000) == 0)
    {
      [v5 setOffset:{objc_msgSend(v5, "offset") + v6}];
    }
...
uint64_t sub_10000C01C(void *a1)
{
  if (!a1)
  {
    return 0xFFFFFFFFLL;
...
BOOL sub_10000C364(AAByteStream_impl *a1, void *a2)
{
  ...
  *__error() = 0;
  ...
  if (v4)
  {
    ...
    v11 = sub_1000015F4("_StreamClose", 87, @"SZAppleArchiveError", v7, v8, 0, @"AAByteStreamClose failed, returning %d", v10, v4);
    if (a2)
    {
      v11 = v11;
      *a2 = v11;
...
void sub_10000C4E0(int a1, uint64_t a2, __darwin_time_t a3, uint64_t a4, uint64_t a5, uint64_t a6, int a7)
{
  v19.tv_sec = a3;
  *&v19.tv_usec = a4;
  v20 = a5;
...
void sub_10000C700(int a1, uint64_t a2, uint64_t a3, int a4, uid_t a5, gid_t a6)
{
  if (a3 > 0x4000)
  {
    *&buf[16] = a3;
...
void sub_10000C9C0(int a1, uint64_t a2)
{
...
uint64_t sub_10000D8E8(char *a1, __int16 a2, uint64_t a3, char a4, uint64_t a5, void *a6)
{
  if ((a2 & 0x200) != 0)
  {
    v25 = a3;
...
LABEL_21:
  ...
  strerror(v12);
  v15 = sub_1000015F4("SZFileOpen", 34, NSPOSIXErrorDomain, v12, 0, 0, @"Failed to open %s : %d (%s)", v14, a1);
  if (a6)
  {
    v15 = v15;
    *a6 = v15;
...
void sub_100010E8C(id a1)
{
  v1 = +[NSUserDefaults standardUserDefaults];
  byte_10002F178 = [v1 BOOLForKey:@"PerformAllWritesSynchronously"];
}

id sub_100011D38(uint64_t a1, unint64_t a2)
{
  if (a1)
  {
    v4 = a1 + 128;
    v5 = qword_10001A758[*(a1 + 128)];
    sub_10000183C(&buf[-((v5 + 15) & 0xFFFFFFFFFFFFFFF0)], a1 + 128);
    v6 = sub_10000A428(&buf[-((v5 + 15) & 0xFFFFFFFFFFFFFFF0)], v5);
    v7 = *(v4 - 72);
    if (v7)
    {
      v8 = a2 / v7;
    ...
    if (v8 >= [*(a1 + 96) count])
    {
      ...
      [*(a1 + 96) count];
      v15 = sub_1000015F4("[StreamingUnzipState _checkHashForOffset:]", 426, @"SZExtractorErrorDomain", 4, 0, v9, @"Cannot validate hash this chunk is index %llu, but we only have %lu hashes.", v19, v8);;
    }
    ...
    else
    {
      ...
      if ([v9 caseInsensitiveCompare:v6])
      {
        ...
        v15 = sub_1000015F4("[StreamingUnzipState _checkHashForOffset:]", 435, @"SZExtractorErrorDomain", 4, 0, v12, @"Hash mismatch for chunk containing offset %llu: expected %@, got %@", v14, a2);
      }
...
char *sub_1000137B8(void *a1, void *a2, void *a3, void *a4)
{
  v7 = a2;
  v8 = a3;
  if (!a1)
  ...
  if (!v9)
  {
    ...
    v50 = sub_1000015F4("[StreamingUnzipState initWithPath:options:error:]", 827, NSPOSIXErrorDomain, 12, 0, 0, @"Failed to init", v49, v225);
    v46 = v50;
    if (a4)
    {
      v51 = v50;
...
LABEL_55:
        v59 = 22;
LABEL_56:
        v46 = sub_1000015F4("[StreamingUnzipState initWithPath:options:error:]", v58, v56, v59, 0, 0, v57, v55, v225);
        v62 = 0;
        v63 = 0;
LABEL_229:
        [v63 finishDecoding];
...
LABEL_72:
      ...
      *(v9 + 8) = 0u;
      ...
      if (stat([v7 fileSystemRepresentation], &v265))
      {
        ...
        strerror(v75);
        v46 = sub_1000015F4("[StreamingUnzipState initWithPath:options:error:]", 904, NSPOSIXErrorDomain, v75, 0, v77, @"Failed to stat path %@: %s", v78, v7);
...
LABEL_76:
      ...
      if (v79 != 0x4000 && v79 != 0x8000)
      {
        ...
        v46 = sub_1000015F4("[StreamingUnzipState initWithPath:options:error:]", 910, @"SZExtractorErrorDomain", 3, 0, v103, @"Extraction path at %@ should be a file or directory, but was not (had mode 0x%ho)", v104, v7);
                      ...
                      if (*(v9 + 15) < __n)
                      {
                        ...
                        *(v9 + 48) = v158;
                        if (!v158)
                        {
                          ...
                          sub_1000015F4("[StreamingUnzipState initWithPath:options:error:]", 1134, NSPOSIXErrorDomain, 12, 0, 0, @"Could not allocate memory for local file record", v192, v225);
                          goto LABEL_240;
                        }
                  ...
                  *(v9 + 10) = [v165 unsignedLongLongValue];
                  ...
                  if (v166)
                  {
                    ...
                    if (!v167)
                    {
                      ...
                      v190 = sub_1000015F4("[StreamingUnzipState initWithPath:options:error:]", 1172, @"SZExtractorErrorDomain", 1, 0, v188, @"Failed to get path from current local file record.", v189, v225);
                    ...
                    if ([v235 decodeBoolForKey:@"OpenCurrentOutputFile"])
                    {
                      ...
                      *(v9 + 50) = v195;
                      ...
                      if (!*(v9 + 50))
                      {
                        ...
                        v233 = sub_1000015F4("[StreamingUnzipState initWithPath:options:error:]", 1191, @"SZExtractorErrorDomain", 1, v228, v213, @"Failed to open output file at path %@", v214, objb);
...
LABEL_269:
                    ...
                    v233 = sub_1000015F4("[StreamingUnzipState initWithPath:options:error:]", v207, @"SZExtractorErrorDomain", 1, 0, 0, v206, v205, v225);
LABEL_268:
                  ...
                  sub_1000015F4("[StreamingUnzipState initWithPath:options:error:]", 1223, @"SZExtractorErrorDomain", 1, 0, 0, @"Invalid state in resumption data at path %@", v180, v7);
LABEL_240:
                  v233 = v168 = v233;
LABEL_270:
...
LABEL_271:
                ...
                {
                  v219 = *(v9 + 32);
                  v220 = off_100028750[v219];
                  v221 = qword_10001A718[v219];
                  *buf = 136315650;
                  *v278 = v220;
                  *&v278[8] = 2048;
                  *v279 = __n;
...
LABEL_228:
      ...
      if (v93 == -1)
      {
        ...
        else
        {
          ...
          strerror(v129);
          v114 = sub_1000015F4("[StreamingUnzipState initWithPath:options:error:]", 943, NSPOSIXErrorDomain, v129, 0, v131, @"Failed to get size of xattr %s from path %@: %s", v132, "com.apple.StreamingPassthroughResumptionData");
...
LABEL_227:
        ...
        v114 = sub_1000015F4("[StreamingUnzipState initWithPath:options:error:]", 1027, @"SZExtractorErrorDomain", 1, v46, v112, @"Failed to open output file at path %@", v113, v7);
...
LABEL_219:
              ...
              {
                v222 = *(v9 + 32);
                v223 = off_100028750[v222];
                v224 = qword_10001A718[v222];
                *buf = 136315650;
                *v278 = v223;
                *&v278[8] = 2048;
                *v279 = __n;
...
LABEL_31:
  ...
  v45 = sub_1000015F4("[StreamingUnzipState initWithPath:options:error:]", 835, @"SZExtractorErrorDomain", 2, 0, 0, @"Options dictionary supplied has one or more options with an incorrect type: %@", v44, v10);
  v46 = v45;
  if (!a4)
  {
    goto LABEL_42;
...
uint64_t sub_100015E3C(void *a1, void *a2)
{
  v3 = a1;
  ...
  if (v7 < 0)
  {
    ...
    strerror(v12);
    v17 = sub_1000015F4("_GetDataProtectionClassForPath", 555, NSPOSIXErrorDomain, v12, 0, 0, @"Failed to open %s : %s", v16, v15);
  }
  ...
  else
  {
    ...
    strerror(v18);
    v17 = sub_1000015F4("_GetDataProtectionClassForPath", 562, NSPOSIXErrorDomain, v18, 0, 0, @"Failed to get protection class on %s : %s", v21, v20);
    close(v8);
  }
...
LABEL_14:
    ...
    if (v30)
    {
      ...
      if (v32 < 0)
      {
        ...
        strerror(v45);
        v38 = sub_1000015F4("_SetDataProtectionClassOnPath", 584, NSPOSIXErrorDomain, v45, 0, 0, @"Failed to open %s : %s", v48, v47);
      }
...
LABEL_40:
        ...
        strerror(v34);
        v38 = sub_1000015F4("_SetDataProtectionClassOnPath", 590, NSPOSIXErrorDomain, v34, 0, 0, @"Failed to set protection class on %s to %d: %s", v37, v36);
        close(v33);
      }
...
uint64_t sub_100016584(void *a1, void *a2, objc_class *a3)
{
  v5 = a2;
...
LABEL_10:
  ...
  v13 = strerror(v11);
  v10 = sub_1000015F4("FetchGroupIDs", 219, NSPOSIXErrorDomain, v11, 0, 0, @"Failed to get current group access list: %s", v14, v13);
  v4 = 0;
  v9 = 0;
  if (a1)
  {
