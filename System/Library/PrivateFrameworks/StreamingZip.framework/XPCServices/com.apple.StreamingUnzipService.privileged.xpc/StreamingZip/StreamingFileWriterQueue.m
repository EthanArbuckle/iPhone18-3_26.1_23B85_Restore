...
- (BOOL)insertAsyncFileOperation:(id)a3 error:(id *)a4
{
  ...
  else
  {
    ...
    v14 = [v7 reservedSize];
    v16 = sub_1000015F4("[StreamingFileWriterQueue insertAsyncFileOperation:error:]", 237, @"SZExtractorErrorDomain", 1, 0, 0, @"Rejecting insert of file operation because the reservation for size %llu was not valid", v15, v14);
    v10 = v16;
    if (a4)
    {
      v17 = v16;
