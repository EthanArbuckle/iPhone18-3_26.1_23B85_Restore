...
- (BOOL)insertAsyncFileOperation:(id)operation error:(id *)error
{
  ...
  if (isValid)
  {
    ...
    if (runningOperationCount < maxConcurrency)
    {
      ...
      block[1] = 3221225472;
      block[2] = sub_10001046C;
      block[3] = &unk_100028810;
      block[4] = self;
      v27 = operationCopy;
  ...
  else
  {
    ...
    v16 = sub_1000015F4("[StreamingFileWriterQueue insertAsyncFileOperation:error:]", 237, @"SZExtractorErrorDomain", 1, 0, 0, @"Rejecting insert of file operation because the reservation for size %llu was not valid", v15, reservedSize3);
    trackingGroup = v16;
    if (error)
    {
      v17 = v16;
