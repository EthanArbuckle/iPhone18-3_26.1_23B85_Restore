...
+ (id)supportedOS
{
  ...
  v29[0] = &unk_28746AF10;
  v22 = [MEMORY[0x277CBEB98] setWithArray:&unk_287466680];
  v28[0] = v22;
  v21 = [MEMORY[0x277CBEB98] setWithArray:&unk_287466698];
  v28[1] = v21;
  v20 = [MEMORY[0x277CBEA60] arrayWithObjects:v28 count:2];
  v30[0] = v20;
  v29[1] = &unk_28746AF28;
  v19 = [MEMORY[0x277CBEB98] setWithArray:&unk_2874666B0];
  v27[0] = v19;
  v18 = [MEMORY[0x277CBEB98] setWithArray:&unk_2874666C8];
  v27[1] = v18;
  v17 = [MEMORY[0x277CBEA60] arrayWithObjects:v27 count:2];
  v30[1] = v17;
  v29[2] = &unk_28746AF40;
  v16 = [MEMORY[0x277CBEB98] setWithArray:&unk_2874666E0];
  v26[0] = v16;
  v15 = [MEMORY[0x277CBEB98] setWithArray:&unk_2874666F8];
  v26[1] = v15;
  v14 = [MEMORY[0x277CBEA60] arrayWithObjects:v26 count:2];
  v30[2] = v14;
  v29[3] = &unk_28746AF58;
  v2 = [MEMORY[0x277CBEB98] setWithArray:&unk_287466710];
  v25[0] = v2;
  v3 = [MEMORY[0x277CBEB98] setWithArray:&unk_287466728];
  v25[1] = v3;
  v4 = [MEMORY[0x277CBEA60] arrayWithObjects:v25 count:2];
  v30[3] = v4;
  v29[4] = &unk_28746AF70;
  v5 = [MEMORY[0x277CBEB98] setWithArray:&unk_287466740];
  v24[0] = v5;
  v6 = [MEMORY[0x277CBEB98] setWithArray:&unk_287466758];
  v24[1] = v6;
  v7 = [MEMORY[0x277CBEA60] arrayWithObjects:v24 count:2];
  v30[4] = v7;
  v29[5] = &unk_28746AF88;
  v8 = [MEMORY[0x277CBEB98] setWithArray:&unk_287466770];
  v23[0] = v8;
  v9 = [MEMORY[0x277CBEB98] setWithArray:&unk_287466788];
  v23[1] = v9;
...
- (BOOL)loadPayloadFromDictionary:(id)dictionary serializationType:(signed __int16)type error:(id *)error
{
  ...
  v12 = +[RMModelAssetCredentialIdentityDeclaration allowedPayloadKeys];
  [v11 minusSet:v12];
...
{
  v5 = objc_opt_new();
  payloadReference = [(RMModelAssetCredentialIdentityDeclaration *)self payloadReference];
  ...
  payloadAuthentication = [(RMModelAssetCredentialIdentityDeclaration *)self payloadAuthentication];
  ...
  payloadAccessible = [(RMModelAssetCredentialIdentityDeclaration *)self payloadAccessible];
...
{
  v12.receiver = self;
  v12.super_class = RMModelAssetCredentialIdentityDeclaration;
