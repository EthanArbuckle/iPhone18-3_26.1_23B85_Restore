...
{
  v4 = objc_opt_new();
  payloadEnabled = [(RMModelAccountMailDeclaration_SMIMESigning *)self payloadEnabled];
  ...
  payloadIdentityAssetReference = [(RMModelAccountMailDeclaration_SMIMESigning *)self payloadIdentityAssetReference];
  ...
  payloadUserOverrideable = [(RMModelAccountMailDeclaration_SMIMESigning *)self payloadUserOverrideable];
  ...
  payloadIdentityUserOverrideable = [(RMModelAccountMailDeclaration_SMIMESigning *)self payloadIdentityUserOverrideable];
