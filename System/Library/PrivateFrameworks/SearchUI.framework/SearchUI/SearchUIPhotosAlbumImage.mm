...
- (id)fetchAsset
{
  ...
  if (v4)
  {
    ...
    v18 = [v17 allObjects];
    v19 = [MEMORY[0x1E6978650] fetchAssetCollectionsWithLocalIdentifiers:v18 options:v9];
    if ([v19 count])
    {
    ...
    else
    {
      ...
      {
        [(SearchUIPhotosAlbumImage *)v18 fetchAsset];
      }
...
{
  v4 = a3;
  v5 = [(SearchUIPhotosAlbumImage *)self fetchAsset];
  if (!v5)
  {
