...
+ (id)defaultOptionsForCellSizeSubclass:(int64_t)subclass
{
  ...
  [v4 setIconInnerHorizontalMargin:{HUConstantForCellSizeSubclass(subclass, v5)}];
  ...
  v7 = HUConstantForCellSizeSubclass(subclass, v6);
  ...
  v13 = HUConstantForCellSizeSubclass(subclass, v12);
  ...
  [v4 setCellHeight:{HUConstantForCellSizeSubclass(subclass, v19)}];
  ...
  if ([MEMORY[0x277D14CE8] shouldUseControlCenterMaterials])
  {
    ...
    v21 = HUConstantForCellSizeSubclass(subclass, v20);
    ...
    [v4 setTitleDescriptionLineSpacing:{HUConstantForCellSizeSubclass(subclass, v29)}];
...
- (id)copyWithZone:(_NSZone *)zone
{
  ...
  v4 = [(HUGridCellLayoutOptions *)&v7 copyWithZone:zone];
  [(HUGridSceneCellLayoutOptions *)self iconInnerHorizontalMargin];
  [v4 setIconInnerHorizontalMargin:?];
  descriptionFont = [(HUGridSceneCellLayoutOptions *)self descriptionFont];
