...
- (HUHomeEnergyManagerHelper)initWithHome:(id)a3
{
  *(&self->super.isa + OBJC_IVAR___HUHomeEnergyManagerHelper_home) = a3;
  v6.receiver = self;
...
{
  v7 = sub_20D567838();
  LOBYTE(a5) = sub_20CF24FF0(v7, v8, a4, a5);
...
{
  v3 = a3;
  v4 = _s6HomeUI0A19EnergyManagerHelperC15redirectToOAuthySbs5Error_pFZ_0(v3);
