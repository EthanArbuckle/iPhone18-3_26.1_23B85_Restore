...
- (id)_subclass_updateWithOptions:(id)options
{
  ...
  if ([MEMORY[0x277D14CE8] isAnIPhone] && (-[HUServiceDetailsAbstractItem sourceServiceItem](self, "sourceServiceItem"), v6 = objc_claimAutoreleasedReturnValue(), objc_msgSend(v6, "accessories"), v7 = objc_claimAutoreleasedReturnValue(), v8 = objc_msgSend(v7, "count"), v7, v6, v8 == 1))
  {
    ...
    [v12 na_safeAddObject:home];

    [v12 na_safeAddObject:anyObject];
    v14 = [v12 copy];
    [dictionary na_safeSetObject:v14 forKey:*MEMORY[0x277D13DA8]];

    v15 = _HULocalizedStringWithDefaultValue(@"HUHomeSettingsLockAddHomeKeyToWallet", @"HUHomeSettingsLockAddHomeKeyToWallet", 1);
    [dictionary na_safeSetObject:v15 forKey:*MEMORY[0x277D13F60]];

    if ([anyObject hf_showAsIndividualServices] && (-[HUServiceDetailsAbstractItem sourceServiceItem](self, "sourceServiceItem"), v16 = objc_claimAutoreleasedReturnValue(), objc_opt_class(), isKindOfClass = objc_opt_isKindOfClass(), v16, (isKindOfClass & 1) == 0))
    {
      [dictionary setObject:MEMORY[0x277CBEC38] forKeyedSubscript:*MEMORY[0x277D13FB8]];
      v30 = MEMORY[0x277D2C900];
      v31 = [MEMORY[0x277D14780] outcomeWithResults:dictionary];
      v22 = [v30 futureWithResult:v31];
    }

    else if ([anyObject supportsWalletKey] && (-[HUServiceDetailsAbstractItem home](self, "home"), v18 = objc_claimAutoreleasedReturnValue(), v19 = objc_msgSend(v18, "hasOnboardedForWalletKey"), v18, (v19 & 1) != 0))
    {
      ...
      hf_fetchWalletKeyDeviceStateForCurrentDeviceIfNecessary = [home2 hf_fetchWalletKeyDeviceStateForCurrentDeviceIfNecessary];
      ...
      v22 = [hf_fetchWalletKeyDeviceStateForCurrentDeviceIfNecessary flatMap:v33];
    ...
    else
    {
      ...
      {
        supportsWalletKey = [anyObject supportsWalletKey];
        ...
        *&location[4] = self;
        ...
        v39 = 1024;
        v40 = supportsWalletKey;
        v41 = 1024;
        hasOnboardedForWalletKey = [home3 hasOnboardedForWalletKey];
  ...
  {
    [dictionary na_safeSetObject:MEMORY[0x277CBEC38] forKey:*MEMORY[0x277D13FB8]];
    v23 = MEMORY[0x277D2C900];
    v24 = [MEMORY[0x277D14780] outcomeWithResults:dictionary];
