...
- (HUServiceGridItemManager)initWithDelegate:(id)a3 sourceItem:(id)a4
{
  ...
  [v6 handleFailureInMethod:a2 object:self file:@"HUServiceGridItemManager.m" lineNumber:26 description:{@"%s is unavailable; use %@ instead", "-[HUServiceGridItemManager initWithDelegate:sourceItem:]", v7}];
      ...
      if (v28)
      {
        ...
        do
        {
          for (j = 0; j != v29; ++j)
          {
            ...
            v35 = [v34 UUIDString];
            v36 = [v33 initWithIdentifier:v35];
    ...
    if (v10)
    {
      ...
      do
      {
        for (i = 0; i != v11; ++i)
        {
          ...
          v14 = *(*(&v18 + 1) + 8 * i);
          v15 = [(HFItemManager *)self delegate];
          v16 = [v15 serviceGridItemManager:self shouldHideItem:v14];
...
- (id)_roomComparator
{
  ...
  v3 = [v2 hf_dashboardSectionReorderableHomeKitObjectComparator];
...
{
  v4 = [a3 latestResults];
  v5 = [v4 objectForKeyedSubscript:*MEMORY[0x277D14090]];

  if (!v5 || (-[HFItemManager home](self, "home"), v6 = objc_claimAutoreleasedReturnValue(), [v6 hf_roomWithIdentifier:v5], v7 = objc_claimAutoreleasedReturnValue(), v6, !v7))
  {
    v8 = [(HFItemManager *)self home];
    v7 = [v8 roomForEntireHome];
  }
