...
- (id)_subclass_updateWithOptions:(id)options
{
  ...
  {
    settingsReaderWriter = [(HUServiceDetailsCameraNightModeItem *)self settingsReaderWriter];
...
- (BOOL)_canReadWriteNightVisionControl
{
  ...
  if (v5)
  {
    ...
    v8 = ([userSettings supportedFeatures] >> 3) & 1;
  }
...
- (id)itemTitle
{
  itemTitleLocalizationKey = [(HUServiceDetailsCameraNightModeItem *)self itemTitleLocalizationKey];
