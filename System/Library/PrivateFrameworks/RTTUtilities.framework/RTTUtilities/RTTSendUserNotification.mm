...
void ___RTTSendUserNotification_block_invoke_51(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v3, OS_LOG_TYPE_INFO))
  {
    ...
    _os_log_impl(&dword_261754000, v3, OS_LOG_TYPE_INFO, "Posted notification with authorization status: %i", v5, 8u);
  }
...
void ___RTTSendUserNotification_block_invoke_cold_1(uint64_t a1, NSObject *a2)
{
  ...
  v3 = 138412290;
  v4 = a1;
  _os_log_error_impl(&dword_261754000, a2, OS_LOG_TYPE_ERROR, "Unable to send notification: %@", &v3, 0xCu);
