...
- (void)acceptInvitationWithIdentifier:(id)a3 passcode:(id)a4 sharingFlow:(int64_t)a5 completionHandler:(id)a6;
...
- (void)sendSharingInvitationForKeyIdentifier:(id)a3 toIdsIdentifier:(id)a4 auth:(id)a5 config:(id)a6 completionHandler:(id)a7
{
  ...
  if (v12 && v13 && v14 && [v15 count])
  {
    ...
    *&buf[32] = __Block_byref_object_dispose__4;
    ...
    v26[4] = buf;
    v26[5] = &v28;
    [v19 sendSharingInviteForKeyIdentifier:v12 toIdsIdentifier:v13 auth:v14 config:v15 completionHandler:v26];

    v16[2](v16, v29[5], *(*&buf[8] + 40));
...
- (void)sendSilentSharingInvitationWithKeyIdentifier:(id)a3 config:(id)a4 groupIdentifier:(id)a5 completionHandler:(id)a6
{
  ...
  if (v10 && v11 && v12)
  {
    ...
    *&buf[32] = __Block_byref_object_dispose__4;
    ...
    v23[4] = buf;
    v23[5] = &v25;
    [v16 sendSilentSharingInviteForKeyIdentifier:v10 config:v11 groupIdentifier:v12 completionHandler:v23];

    v13[2](v13, v26[5], *(*&buf[8] + 40));
...
- (void)authorizeSharingInvitationIdentifier:(id)a3 auth:(id)a4 completionHandler:(id)a5
{
  ...
  if (v8)
  {
    ...
    *&buf[24] = __Block_byref_object_copy__4;
    ...
    v20[3] = &unk_278F6FB00;
    v20[4] = buf;
    [v13 authorizeSharingInvitationIdentifier:v8 auth:v9 completionHandler:v20];
...
- (id)cancelSharingInvitation:(id)a3
{
  ...
  if (v4)
  {
    ...
    *&buf[24] = __Block_byref_object_copy__4;
    ...
    v15[3] = &unk_278F709C8;
    v15[4] = buf;
    [v7 cancelSharingInvitation:v4 completionHandler:v15];
...
- (void)cancelSharingInvitation:(id)a3 completionHandler:(id)a4
{
  ...
  if (v6)
  {
    ...
    *&buf[24] = __Block_byref_object_copy__4;
    ...
    v23[3] = &unk_278F709C8;
    v23[4] = &v25;
    [v9 cancelSharingInvitation:v6 completionHandler:v23];
...
- (void)acceptSharingInvitationWithIdentifier:(id)a3 completionHandler:(id)a4
{
  ...
  [(DAKeySharingSession *)self acceptSharingInvitationWithIdentifier:v7 passcode:0 productPlanIdentifier:0 completionHandler:v6];
  v9 = *MEMORY[0x277D85DE8];
}
...
- (void)acceptSharingInvitationWithIdentifier:(id)a3 passcode:(id)a4 completionHandler:(id)a5
{
  ...
  [(DAKeySharingSession *)self acceptSharingInvitationWithIdentifier:v10 passcode:v9 productPlanIdentifier:0 completionHandler:v8];
...
- (void)acceptSharingInvitationWithIdentifier:(id)a3 passcode:(id)a4 productPlanIdentifier:(id)a5 completionHandler:(id)a6
{
  ...
  if (v10)
  {
    ...
    *&buf[24] = __Block_byref_object_copy__4;
    ...
    v23[4] = buf;
    v23[5] = &v25;
    [v16 acceptSharingInvitationWithIdentifier:v10 passcode:v11 productPlanIdentifier:v12 completionHandler:v23];
...
- (void)requestInviteWithConfig:(id)a3 completionHandler:(id)a4
{
  ...
  if (v6)
  {
    ...
    *&buf[16] = 0x3032000000;
    ...
    v17[3] = &unk_278F6FB00;
    v17[4] = buf;
    [v10 requestInviteWithConfig:v6 completionHandler:v17];
...
- (void)createSharingInvitationsForKeyIdentifier:(id)a3 friendIdentifier:(id)a4 auth:(id)a5 config:(id)a6 completionHandler:(id)a7
{
  ...
  [(DAKeySharingSession *)self createSharingInvitationsForKeyIdentifier:v16 friendIdentifier:v15 auth:v14 ourBindingAttestation:0 config:v13 completionHandler:v12];
...
- (void)createSharingInvitationsForKeyIdentifier:(id)a3 friendIdentifier:(id)a4 auth:(id)a5 ourBindingAttestation:(id)a6 config:(id)a7 completionHandler:(id)a8
{
  ...
  if (v14 && [v18 count])
  {
    ...
    *&buf[32] = __Block_byref_object_dispose__4;
    ...
    v28[4] = buf;
    v28[5] = &v30;
    [v21 createSharingInvitationsForKeyIdentifier:v14 friendIdentifier:v15 auth:v16 ourBindingAttestation:v17 config:v18 completionHandler:v28];

    v19[2](v19, v31[5], *(*&buf[8] + 40));
...
- (void)createSilentSharingInvitationWithGroupIdentifier:(id)a3 completionHandler:(id)a4
{
  ...
  if (v6)
  {
    ...
    *&buf[24] = __Block_byref_object_copy__4;
    ...
    v16[4] = buf;
    v16[5] = &v18;
    [v9 createSilentSharingInvitationWithGroupIdentifier:v6 completionHandler:v16];
...
- (void)setMailboxIdentifier:(id)a3 forOwnerKeyIdentifier:(id)a4 forInvitationIdentifier:(id)a5 completionHandler:(id)a6
{
  ...
  if (v10 && v11 && v12)
  {
    ...
    *&buf[32] = __Block_byref_object_dispose__4;
    ...
    v24[3] = &unk_278F6FB00;
    v24[4] = buf;
    [v17 setMailboxIdentifier:v10 forOwnerKeyIdentifier:v11 forInvitationIdentifier:v12 completionHandler:v24];
...
- (void)startShareAcceptanceFlowWithInvitation:(id)a3 completionHandler:(id)a4
{
  ...
  if (v6)
  {
    [DAKeySharingSession startShareAcceptanceFlowWithInvitation:v8 completionHandler:v6];
    ...
    *&buf[16] = 0x3032000000;
    ...
    v16[3] = &unk_278F6FB00;
    v16[4] = buf;
    [v10 startShareAcceptanceFlowWithInvitation:v6 completionHandler:v16];
...
- (void)startShareAcceptanceFlowWithInvitation:(id)a3 fromMailboxIdentifier:(id)a4 completionHandler:(id)a5
{
  ...
  if (v8 && v9)
  {
    ...
    *&buf[24] = __Block_byref_object_copy__4;
    ...
    v20[3] = &unk_278F6FB00;
    v20[4] = buf;
    [v13 startShareAcceptanceFlowWithInvitation:v8 fromMailboxIdentifier:v9 completionHandler:v20];
...
- (void)acceptSharingInvitation:(id)a3 fromMailboxIdentifier:(id)a4 completionHandler:(id)a5
{
  ...
  [(DAKeySharingSession *)self acceptSharingInvitation:v10 fromMailboxIdentifier:v9 passcode:0 completionHandler:v8];
  v12 = *MEMORY[0x277D85DE8];
}
...
- (void)acceptSharingInvitation:(id)a3 fromMailboxIdentifier:(id)a4 passcode:(id)a5 completionHandler:(id)a6
{
  ...
  if (v10 && v11)
  {
    ...
    *&buf[24] = __Block_byref_object_copy__4;
    ...
    v25[4] = &v27;
    v25[5] = buf;
    [v16 acceptSharingInvitation:v10 withIdentifier:v18 fromMailboxIdentifier:v11 passcode:v12 productPlanIdentifier:0 completionHandler:v25];

    v13[2](v13, v28[5], *(*&buf[8] + 40));
...
- (void)acceptCrossPlatformInvitationWithIdentifier:(id)a3 passcode:(id)a4 productPlanIdentifier:(id)a5 completionHandler:(id)a6
{
  ...
  if (v10)
  {
    ...
    *&buf[24] = __Block_byref_object_copy__4;
    ...
    v23[4] = &v25;
    v23[5] = buf;
    [v16 acceptSharingInvitation:0 withIdentifier:v10 fromMailboxIdentifier:0 passcode:v11 productPlanIdentifier:v12 completionHandler:v23];
...
- (void)acceptInvitationWithIdentifier:(id)a3 passcode:(id)a4 sharingFlow:(int64_t)a5 completionHandler:(id)a6
{
  ...
  [(DAKeySharingSession *)self acceptInvitationWithIdentifier:v11 passcode:v10 completionHandler:v9];
  v13 = *MEMORY[0x277D85DE8];
}
...
- (void)acceptInvitationWithIdentifier:(id)a3 passcode:(id)a4 completionHandler:(id)a5
{
  ...
  if (v8)
  {
    ...
    *&buf[24] = __Block_byref_object_copy__4;
    ...
    v32[5] = buf;
    v32[6] = &v34;
    [v12 acceptSharingInvitation:0 withIdentifier:v8 fromMailboxIdentifier:0 passcode:v9 productPlanIdentifier:0 completionHandler:v32];

    if (v41[5])
    {
      v13 = [DAShareRecipientResult alloc];
      v14 = [v35[5] publicKeyIdentifier];
      v15 = [(DAShareRecipientResult *)v13 initDataRequiredResultWithCredentialIdentifier:v14 response:v41[5] keyInformation:v35[5]];
    }
    ...
    else
    {
      ...
      v14 = [v35[5] publicKeyIdentifier];
      v15 = [(DAShareRecipientResult *)v28 initFailureResultWithCredentialIdentifier:v14 error:*(*&buf[8] + 40)];
    }
...
- (void)handleRecipientMessage:(id)a3 forInvitationIdentifier:(id)a4 completionHandler:(id)a5
{
  ...
  if (v9)
  {
    ...
    *&buf[24] = __Block_byref_object_copy__4;
    ...
    v23[3] = &unk_278F709C8;
    v23[4] = buf;
    [v12 handleRecipientMessage:v8 forInvitationIdentifier:v9 completionHandler:v23];
...
- (void)handleInitiatorMessage:(id)a3 forInvitationIdentifier:(id)a4 completionHandler:(id)a5
{
  ...
  if (v9)
  {
    ...
    *&buf[24] = __Block_byref_object_copy__4;
    ...
    v23[3] = &unk_278F70A68;
    v23[4] = buf;
    [v12 handleInitiatorMessage:v8 forInvitationIdentifier:v9 completionHandler:v23];
...
- (void)updateSharingAnalyticsWithConfig:(id)a3 completionHandler:(id)a4
{
  ...
  if (v6)
  {
    v9 = [v6 invitationIdentifiers];
    if (!v9 || ([v6 invitationIdentifiers], v10 = objc_claimAutoreleasedReturnValue(), v11 = objc_msgSend(v10, "count") == 0, v10, v9, v11))
    {
      v12 = KmlLogger();
    ...
    if (([v6 recipientFlow] & 1) == 0 && (objc_msgSend(v6, "keyIdentifier"), v24 = objc_claimAutoreleasedReturnValue(), v25 = v24 == 0, v24, v25))
    {
      v32 = KmlLogger();
    ...
    else
    {
      ...
      *&buf[24] = __Block_byref_object_copy__4;
      ...
      v38[3] = &unk_278F6FB00;
      v38[4] = buf;
      [v26 updateSharingAnalyticsWithConfig:v6 completionHandler:v38];
...
- (void)retryPasscode:(id)a3 forInvitationIdentifier:(id)a4 completionHandler:(id)a5
{
  ...
  *&v54[24] = v14;
  ...
  v32[5] = v54;
  v32[6] = &v34;
  [v17 retryPasscode:v8 forInvitationIdentifier:v9 completionHandler:v32];

  if (v41[5])
  {
    v18 = [DAShareRecipientResult alloc];
    v19 = [v35[5] publicKeyIdentifier];
    v20 = [(DAShareRecipientResult *)v18 initDataRequiredResultWithCredentialIdentifier:v19 response:v41[5] keyInformation:v35[5]];
  }
  ...
  else
  {
    ...
    v19 = [v35[5] publicKeyIdentifier];
    v20 = [(DAShareRecipientResult *)v26 initFailureResultWithCredentialIdentifier:v19 error:*(*&v54[8] + 40)];
  }
...
- (void)retryPasscode:(id)a3 forKeyIdentifier:(id)a4 completionHandler:(id)a5
{
  ...
  *&v22[16] = v15;
  ...
  v19[3] = &unk_278F6FB00;
  v19[4] = buf;
  [v17 retryPasscode:v8 forKeyIdentifier:v9 completionHandler:v19];
