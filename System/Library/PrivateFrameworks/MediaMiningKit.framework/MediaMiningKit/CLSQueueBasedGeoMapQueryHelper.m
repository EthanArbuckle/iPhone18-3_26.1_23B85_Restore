...
- (void)_handleError:(id)a3
{
  ...
  if (retryLevel < self->_numberOfRetries && ([v7 code] == -3 || objc_msgSend(v7, "code") == -9))
  {
...
void __45__CLSQueueBasedGeoMapQueryHelper__startQuery__block_invoke(uint64_t a1, uint64_t a2, void *a3)
{
  ...
  if (WeakRetained)
  {
    ...
    {
      sleep((*(WeakRetained + 5) + *(WeakRetained + 5)));
    }

    v6 = WeakRetained[9];
    block[0] = MEMORY[0x277D85DD0];
    block[1] = 3221225472;
    block[2] = __45__CLSQueueBasedGeoMapQueryHelper__startQuery__block_invoke_12;
...
- (void)launchPublicEventQueryWithCancellerBlock:(id)a3 completionBlock:(id)a4
{
  ...
  v13[1] = 3221225472;
  v13[2] = __91__CLSQueueBasedGeoMapQueryHelper_launchPublicEventQueryWithCancellerBlock_completionBlock___block_invoke_2;
  v13[3] = &unk_2788A8210;
  v13[4] = self;
  v14 = v9;
  v15 = v6;
...
void __91__CLSQueueBasedGeoMapQueryHelper_launchPublicEventQueryWithCancellerBlock_completionBlock___block_invoke_2(uint64_t a1)
{
  v2 = [*(a1 + 40) copy];
  v3 = *(a1 + 32);
  v4 = *(v3 + 32);
...
uint64_t __54__CLSQueueBasedGeoMapQueryHelper_initWithQueryObject___block_invoke_2(uint64_t a1)
{
  ...
  if (WeakRetained)
  {
    ...
    if (v2[4])
    {
      ...
      v5 = [MEMORY[0x277CCACA8] stringWithFormat:@"%@ did %ld retries of %fs", objc_opt_class(), v10[6], v10[5]];
