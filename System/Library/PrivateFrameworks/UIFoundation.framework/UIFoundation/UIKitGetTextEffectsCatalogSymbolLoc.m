...
void *__get_UIKitGetTextEffectsCatalogSymbolLoc_block_invoke(uint64_t a1)
{
  ...
  *(*(*(a1 + 32) + 8) + 24) = result;
  get_UIKitGetTextEffectsCatalogSymbolLoc_ptr = *(*(*(a1 + 32) + 8) + 24);
  return result;
}
...
void __get_UIKitGetTextEffectsCatalogSymbolLoc_block_invoke_cold_1(void *a1)
{
  ...
  [v2 handleFailureInFunction:objc_msgSend(MEMORY[0x1E696AEC0] file:"stringWithUTF8String:" lineNumber:"void *UIKitLibrary(void)") description:{@"__NSTextAppearanceInterface.m", 16, @"%s", *a1}];
  __break(1u);
}
