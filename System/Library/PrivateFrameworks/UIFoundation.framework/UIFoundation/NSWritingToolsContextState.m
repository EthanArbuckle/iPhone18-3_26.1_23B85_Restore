...
+ (_NSRange)contextRangeForString:(id)a3 proposedRange:(_NSRange)a4
{
  ...
  v6 = a3;
  v7 = [v6 paragraphRangeForRange:{location, length}];
  v9 = v8;
  ...
  if (v7)
  {
    v11 = v7 + v9++;
    --v7;
    while ([v10 characterIsMember:{objc_msgSend(v6, "characterAtIndex:", v7)}])
    {
      ++v9;
      if (--v7 == -1)
      {
  ...
  v11 = v9;
LABEL_7:
  v12 = [v6 paragraphRangeForRange:{v7, v11}];
  v14 = v13;
...
- (NSWritingToolsContextState)initWithContextString:(id)a3 contextLocation:(unint64_t)a4 proposedRange:(_NSRange)a5
{
  ...
  {
    v12 = [v10 length];
    [(NSWritingToolsContextState *)v11 setContextString:v10];
    [(NSWritingToolsContextState *)v11 setContextRange:a4, v12];
...
- (NSWritingToolsContextState)initWithDocumentString:(id)a3 proposedRange:(_NSRange)a4
{
  ...
  v8 = objc_opt_class();
  v9 = [v7 string];
  v10 = [v8 contextRangeForString:v9 proposedRange:{location, length}];
  v12 = v11;

  v13 = [v7 attributedSubstringFromRange:{v10, v12}];
