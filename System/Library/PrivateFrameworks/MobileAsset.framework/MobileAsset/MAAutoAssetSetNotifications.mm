...
{
  v4 = a3;
  [v4 encodeBool:-[MAAutoAssetSetNotifications atomicInstanceDiscovered](self forKey:{"atomicInstanceDiscovered"), @"atomicInstanceDiscovered"}];
  [v4 encodeBool:-[MAAutoAssetSetNotifications atomicInstanceAvailableForUse](self forKey:{"atomicInstanceAvailableForUse"), @"atomicInstanceAvailableForUse"}];
  [v4 encodeBool:-[MAAutoAssetSetNotifications lockUsageCheck](self forKey:{"lockUsageCheck"), @"lockUsageCheck"}];
  [v4 encodeBool:-[MAAutoAssetSetNotifications filesystemSpaceCritical](self forKey:{"filesystemSpaceCritical"), @"filesystemSpaceCritical"}];
  [v4 encodeBool:-[MAAutoAssetSetNotifications atomicInstancePurged](self forKey:{"atomicInstancePurged"), @"atomicInstancePurged"}];
  [v4 encodeBool:-[MAAutoAssetSetNotifications downloadPending](self forKey:{"downloadPending"), @"downloadPending"}];
  [v4 encodeBool:-[MAAutoAssetSetNotifications downloadProgress](self forKey:{"downloadProgress"), @"downloadProgress"}];
  [v4 encodeBool:-[MAAutoAssetSetNotifications downloadAbandoned](self forKey:{"downloadAbandoned"), @"downloadAbandoned"}];
  [v4 encodeBool:-[MAAutoAssetSetNotifications downloadedBecameIncomplete](self forKey:{"downloadedBecameIncomplete"), @"downloadedBecameIncomplete"}];
}
