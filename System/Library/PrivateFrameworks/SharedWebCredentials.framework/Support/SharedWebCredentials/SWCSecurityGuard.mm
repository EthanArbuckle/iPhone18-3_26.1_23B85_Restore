...
+ (SWCSecurityGuard)sharedSecurityGuard
{
  if (qword_1000325A0 != -1)
  {
    dispatch_once(&qword_1000325A0, &stru_10002CFE8);
  }
...
- (optional<SecTrustResultType>)_evaluateTrust:(__SecTrust *)a3 error:(id *)a4
{
  ...
  if (qword_1000325B0 != -1)
  {
    dispatch_once(&qword_1000325B0, &stru_10002D008);
  }

  v25 = qword_1000325A8;
  if (os_log_type_enabled(qword_1000325A8, OS_LOG_TYPE_ERROR))
  {
    *buf = 138412546;
    v34 = a3;
    v35 = 2112;
...
LABEL_10:
  ...
  v18 = qword_1000325A8;
  if (os_log_type_enabled(qword_1000325A8, OS_LOG_TYPE_DEBUG))
  {
    v19 = @"NOT ";
    *buf = 138412802;
    v25 = a3;
