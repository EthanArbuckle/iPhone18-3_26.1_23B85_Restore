...
uint64_t __78__BLSHCacheFlipbookOnDisplayWakeAttributeHandler_activateForSceneEnvironment___block_invoke(uint64_t a1)
{
  ...
  {
    __78__BLSHCacheFlipbookOnDisplayWakeAttributeHandler_activateForSceneEnvironment___block_invoke_cold_1(v3, a1);
  }
...
void __78__BLSHCacheFlipbookOnDisplayWakeAttributeHandler_activateForSceneEnvironment___block_invoke_cold_1(id *a1, uint64_t a2)
{
  ...
  v9 = [v4 stringWithFormat:@"class %@ must respond to selector setCacheFlipbookOnDisplayWake: in order to acquire assertion with BLSCacheFlipbookOnDisplayWakeAttribute : %@", v7, v8];
  ...
  if (os_log_type_enabled(MEMORY[0x277D86220], OS_LOG_TYPE_ERROR))
  {
    ...
    *buf = 138544642;
    ...
    v20 = v14;
    v21 = 2114;
    v22 = @"BLSHCacheFlipbookOnDisplayWakeAttributeHandler.m";
    v23 = 1024;
    v24 = 31;
    v25 = 2114;
    v26 = v9;
