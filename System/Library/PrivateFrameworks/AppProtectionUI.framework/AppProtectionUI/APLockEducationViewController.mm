...
- (id)initForApplication:(id)a3
{
  ...
  if (v6)
  {
    ...
    v23 = [v22 isEqualToString:@"com.apple.Passbook"];
    ...
    v63 = [v34 systemImageNameForCurrentBestAuthenticationMechanism];
    ...
    [(OBWelcomeController *)v33 addBulletedListItemWithTitle:v38 description:v42 symbolName:v63];
    ...
    v53 = [MEMORY[0x1E69B7D38] linkButton];
    ...
    v59 = [MEMORY[0x1E69DC938] currentDevice];
...
- (void)phase1ViewCancelButtonPressed:(id)a3
{
  ...
  v5 = [(APLockEducationViewController *)self delegate];
...
- (void)createTCCAccessDisclosureController
{
  v3 = [MEMORY[0x1E698B0F8] sharedManager];
  app = self->_app;
