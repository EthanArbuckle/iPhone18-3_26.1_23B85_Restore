...
- (void)copyTo:(id)a3
{
  ...
  if ([(NPKProtoAddSecureElementPassWithPropertiesRequest *)self payloadDatasCount])
  {
    ...
    v4 = [(NPKProtoAddSecureElementPassWithPropertiesRequest *)self payloadDatasCount];
    if (v4)
    {
      v5 = v4;
      for (i = 0; i != v5; ++i)
...
{
  v4 = a3;
  if ([v4 isMemberOfClass:objc_opt_class()] && ((passUniqueID = self->_passUniqueID, !(passUniqueID | v4[1])) || -[NSString isEqual:](passUniqueID, "isEqual:")))
  {
    payloadDatas = self->_payloadDatas;
    if (payloadDatas | v4[2])
    {
