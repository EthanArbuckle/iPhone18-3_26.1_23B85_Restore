...
- (id)description
{
  ...
  dictionaryRepresentation = [(NPKProtoPerformProductActionRequest *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  {
    [dictionary setObject:productsActionData forKey:@"productsActionData"];
  }
...
- (void)copyTo:(id)to
{
  ...
  if (productsActionData)
  {
    [to setProductsActionData:productsActionData];
  }
}
...
- (id)copyWithZone:(_NSZone *)zone
{
  ...
  v6 = [(NSData *)self->_productsActionData copyWithZone:zone];
  v7 = v5[1];
  v5[1] = v6;
...
- (BOOL)isEqual:(id)equal
{
  ...
  {
    productsActionData = self->_productsActionData;
    if (productsActionData | equalCopy[1])
    {
