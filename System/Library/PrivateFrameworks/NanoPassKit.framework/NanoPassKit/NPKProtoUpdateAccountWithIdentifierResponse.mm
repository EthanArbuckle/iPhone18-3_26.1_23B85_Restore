...
- (id)description
{
  ...
  dictionaryRepresentation = [(NPKProtoUpdateAccountWithIdentifierResponse *)self dictionaryRepresentation];
...
- (id)copyWithZone:(_NSZone *)zone
{
  ...
  v7 = [(NSData *)self->_accountData copyWithZone:zone];
  v8 = v6[1];
  v6[1] = v7;
...
LABEL_4:
  accountData = self->_accountData;
  if (accountData | *(equalCopy + 1) && ![(NSData *)accountData isEqual:?])
  {
    goto LABEL_9;
  }
