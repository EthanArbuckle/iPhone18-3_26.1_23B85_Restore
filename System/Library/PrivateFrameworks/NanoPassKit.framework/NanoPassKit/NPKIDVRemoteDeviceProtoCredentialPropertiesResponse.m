...
- (void)copyTo:(id)a3
{
  ...
  if (self->_credentialPropertiesData)
  {
    [v4 setCredentialPropertiesData:?];
    v4 = v5;
  }
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v6 = [(NSData *)self->_credentialPropertiesData copyWithZone:a3];
  v7 = v5[1];
  v5[1] = v6;
...
{
  v4 = a3;
  if ([v4 isMemberOfClass:objc_opt_class()] && ((credentialPropertiesData = self->_credentialPropertiesData, !(credentialPropertiesData | v4[1])) || -[NSData isEqual:](credentialPropertiesData, "isEqual:")))
  {
    errorData = self->_errorData;
    if (errorData | v4[2])
    {
