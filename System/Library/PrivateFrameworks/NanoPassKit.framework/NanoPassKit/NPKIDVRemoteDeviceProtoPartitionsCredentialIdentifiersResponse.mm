...
- (void)copyTo:(id)a3
{
  ...
  if (self->_partitionsCredentialIdentifiersData)
  {
    [v4 setPartitionsCredentialIdentifiersData:?];
    v4 = v5;
  }
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v6 = [(NSData *)self->_partitionsCredentialIdentifiersData copyWithZone:a3];
  v7 = v5[2];
  v5[2] = v6;
...
{
  v4 = a3;
  if ([v4 isMemberOfClass:objc_opt_class()] && ((partitionsCredentialIdentifiersData = self->_partitionsCredentialIdentifiersData, !(partitionsCredentialIdentifiersData | v4[2])) || -[NSData isEqual:](partitionsCredentialIdentifiersData, "isEqual:")))
  {
    errorData = self->_errorData;
    if (errorData | v4[1])
    {
