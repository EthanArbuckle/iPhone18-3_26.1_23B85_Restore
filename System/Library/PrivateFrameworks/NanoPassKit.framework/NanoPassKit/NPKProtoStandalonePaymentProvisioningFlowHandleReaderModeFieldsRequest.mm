...
- (void)copyTo:(id)a3
{
  ...
  if ([(NPKProtoStandalonePaymentProvisioningFlowHandleReaderModeFieldsRequest *)self readerModeFieldsCount])
  {
    ...
    v4 = [(NPKProtoStandalonePaymentProvisioningFlowHandleReaderModeFieldsRequest *)self readerModeFieldsCount];
    if (v4)
    {
      v5 = v4;
      for (i = 0; i != v5; ++i)
  ...
  if (v8)
  {
    ...
    do
    {
      for (i = 0; i != v9; ++i)
      {
        ...
        [(NPKProtoStandalonePaymentProvisioningFlowHandleReaderModeFieldsRequest *)self addReaderModeFields:*(*(&v13 + 1) + 8 * i), v13];
      }
