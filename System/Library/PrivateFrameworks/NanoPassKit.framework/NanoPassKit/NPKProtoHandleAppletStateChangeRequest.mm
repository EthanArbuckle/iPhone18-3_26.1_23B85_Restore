...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v8 = [(NSData *)self->_passAppletState copyWithZone:a3];
  v9 = v5[1];
  v5[1] = v8;
...
{
  v4 = a3;
  if ([v4 isMemberOfClass:objc_opt_class()] && ((passID = self->_passID, !(passID | v4[2])) || -[NSString isEqual:](passID, "isEqual:")))
  {
    passAppletState = self->_passAppletState;
    if (passAppletState | v4[1])
    {
