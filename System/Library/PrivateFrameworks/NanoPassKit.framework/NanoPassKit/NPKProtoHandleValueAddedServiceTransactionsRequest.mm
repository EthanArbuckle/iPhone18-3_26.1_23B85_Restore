...
- (id)description
{
  ...
  dictionaryRepresentation = [(NPKProtoHandleValueAddedServiceTransactionsRequest *)self dictionaryRepresentation];
...
- (void)copyTo:(id)to
{
  ...
  if ([(NPKProtoHandleValueAddedServiceTransactionsRequest *)self transactionsBytesCount])
  {
    ...
    transactionsBytesCount = [(NPKProtoHandleValueAddedServiceTransactionsRequest *)self transactionsBytesCount];
  ...
  if ([(NPKProtoHandleValueAddedServiceTransactionsRequest *)self transactionPassIDsCount])
  {
    ...
    transactionPassIDsCount = [(NPKProtoHandleValueAddedServiceTransactionsRequest *)self transactionPassIDsCount];
