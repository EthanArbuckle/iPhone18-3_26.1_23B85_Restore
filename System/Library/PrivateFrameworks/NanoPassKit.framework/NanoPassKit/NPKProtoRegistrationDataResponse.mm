...
- (id)description
{
  ...
  dictionaryRepresentation = [(NPKProtoRegistrationDataResponse *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  {
    [dictionary setObject:registrationDataBytes forKey:@"registrationDataBytes"];
  }
...
- (void)copyTo:(id)to
{
  ...
  if (self->_registrationDataBytes)
  {
    [toCopy setRegistrationDataBytes:?];
    toCopy = v5;
  }
...
- (id)copyWithZone:(_NSZone *)zone
{
  ...
  v7 = [(NSData *)self->_registrationDataBytes copyWithZone:zone];
  v8 = v6[2];
  v6[2] = v7;

  v9 = [(NSString *)self->_pushToken copyWithZone:zone];
  v10 = v6[1];
  v6[1] = v9;
...
LABEL_4:
  registrationDataBytes = self->_registrationDataBytes;
  if (registrationDataBytes | *(equalCopy + 2) && ![(NSData *)registrationDataBytes isEqual:?])
  {
    goto LABEL_9;
  }
