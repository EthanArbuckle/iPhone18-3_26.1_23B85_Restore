...
- (id)description
{
  ...
  v5 = [(NPKIDVRemoteDeviceProtoDeletePIIHashDataRequest *)self dictionaryRepresentation];
...
- (void)copyTo:(id)a3
{
  ...
  if ([(NPKIDVRemoteDeviceProtoDeletePIIHashDataRequest *)self configuredPartitionsIdentifiersCount])
  {
    ...
    v4 = [(NPKIDVRemoteDeviceProtoDeletePIIHashDataRequest *)self configuredPartitionsIdentifiersCount];
    if (v4)
    {
      v5 = v4;
      for (i = 0; i != v5; ++i)
  ...
  if (v6)
  {
    ...
    do
    {
      for (i = 0; i != v7; ++i)
      {
        ...
        [(NPKIDVRemoteDeviceProtoDeletePIIHashDataRequest *)self addConfiguredPartitionsIdentifiers:*(*(&v11 + 1) + 8 * i), v11];
      }
