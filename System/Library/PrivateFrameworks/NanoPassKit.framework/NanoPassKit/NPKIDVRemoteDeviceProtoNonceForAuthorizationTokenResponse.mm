...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v6 = [(NSData *)self->_nonceData copyWithZone:a3];
  v7 = v5[2];
  v5[2] = v6;
...
{
  v4 = a3;
  if ([v4 isMemberOfClass:objc_opt_class()] && ((nonceData = self->_nonceData, !(nonceData | v4[2])) || -[NSData isEqual:](nonceData, "isEqual:")))
  {
    errorData = self->_errorData;
    if (errorData | v4[1])
    {
