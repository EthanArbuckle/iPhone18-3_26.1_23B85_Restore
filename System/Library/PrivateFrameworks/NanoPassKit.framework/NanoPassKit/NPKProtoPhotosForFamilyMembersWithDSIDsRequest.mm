...
- (void)copyTo:(id)a3
{
  ...
  if ([(NPKProtoPhotosForFamilyMembersWithDSIDsRequest *)self requestDSIDsCount])
  {
    ...
    v4 = [(NPKProtoPhotosForFamilyMembersWithDSIDsRequest *)self requestDSIDsCount];
    if (v4)
    {
      v5 = v4;
      for (i = 0; i != v5; ++i)
  ...
  if (v5)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        [(NPKProtoPhotosForFamilyMembersWithDSIDsRequest *)self addRequestDSIDs:*(*(&v10 + 1) + 8 * v8++), v10];
      }
