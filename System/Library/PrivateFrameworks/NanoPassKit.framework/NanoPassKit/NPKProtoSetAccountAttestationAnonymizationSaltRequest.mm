...
- (id)description
{
  ...
  dictionaryRepresentation = [(NPKProtoSetAccountAttestationAnonymizationSaltRequest *)self dictionaryRepresentation];
...
- (void)copyTo:(id)to
{
  ...
  if (anonymizationSalt)
  {
    [to setAnonymizationSalt:anonymizationSalt];
  }
}
...
- (BOOL)isEqual:(id)equal
{
  ...
  {
    anonymizationSalt = self->_anonymizationSalt;
    if (anonymizationSalt | equalCopy[1])
    {
