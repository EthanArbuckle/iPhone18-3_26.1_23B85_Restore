...
- (id)description
{
  ...
  dictionaryRepresentation = [(NPKProtoSignWithFidoKeyResponse *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  if (fidoAttestation)
  {
    [dictionary setObject:fidoAttestation forKey:@"fidoAttestation"];
  }
...
- (id)copyWithZone:(_NSZone *)zone
{
  ...
  v6 = [(NSData *)self->_fidoAttestation copyWithZone:zone];
  v7 = v5[2];
  v5[2] = v6;
...
{
  equalCopy = equal;
  if ([equalCopy isMemberOfClass:objc_opt_class()] && ((fidoAttestation = self->_fidoAttestation, !(fidoAttestation | equalCopy[2])) || -[NSData isEqual:](fidoAttestation, "isEqual:")))
  {
    errorData = self->_errorData;
