...
- (void)copyTo:(id)a3
{
  ...
  if ([(NPKProtoHandleRemoveTransactionsRequest *)self identifiersCount])
  {
    ...
    v4 = [(NPKProtoHandleRemoveTransactionsRequest *)self identifiersCount];
    if (v4)
    {
      v5 = v4;
      for (i = 0; i != v5; ++i)
  ...
  {
    [v12 clearPassIDs];
    v8 = [(NPKProtoHandleRemoveTransactionsRequest *)self passIDsCount];
    if (v8)
    {
      v9 = v8;
      for (j = 0; j != v9; ++j)
...
{
  v4 = a3;
  if ([v4 isMemberOfClass:objc_opt_class()] && ((identifiers = self->_identifiers, !(identifiers | v4[1])) || -[NSMutableArray isEqual:](identifiers, "isEqual:")))
  {
    passIDs = self->_passIDs;
    if (passIDs | v4[2])
    {
