...
- (id)description
{
  ...
  v8.receiver = self;
  v8.super_class = NPKProtoInitializeCloudStoreIfNecessaryWithHandlerResponse;
  v4 = [(NPKProtoInitializeCloudStoreIfNecessaryWithHandlerResponse *)&v8 description];
  dictionaryRepresentation = [(NPKProtoInitializeCloudStoreIfNecessaryWithHandlerResponse *)self dictionaryRepresentation];
...
- (void)mergeFrom:(id)from
{
  ...
  {
    v6 = fromCopy;
    [(NPKProtoInitializeCloudStoreIfNecessaryWithHandlerResponse *)self setErrorData:?];
    fromCopy = v6;
  }
}
