...
- (id)description
{
  ...
  v8.receiver = self;
  v8.super_class = NPKProtoStandalonePaymentPassListRequest;
  v4 = [(NPKProtoStandalonePaymentPassListRequest *)&v8 description];
  dictionaryRepresentation = [(NPKProtoStandalonePaymentPassListRequest *)self dictionaryRepresentation];
...
- (void)mergeFrom:(id)from
{
  ...
  else
  {
    ...
    v7 = fromCopy;
    [(NPKProtoStandalonePaymentPassListRequest *)self setRequestHeader:?];
  }
