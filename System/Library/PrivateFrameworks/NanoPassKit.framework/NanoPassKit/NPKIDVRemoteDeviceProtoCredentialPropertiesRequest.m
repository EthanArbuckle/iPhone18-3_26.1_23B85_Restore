...
- (void)copyTo:(id)a3
{
  ...
  if ([(NPKIDVRemoteDeviceProtoCredentialPropertiesRequest *)self configuredPartitionsIdentifiersCount])
  {
    ...
    v4 = [(NPKIDVRemoteDeviceProtoCredentialPropertiesRequest *)self configuredPartitionsIdentifiersCount];
    if (v4)
    {
      v5 = v4;
      for (i = 0; i != v5; ++i)
  ...
  if (v6)
  {
    ...
    do
    {
      for (i = 0; i != v7; ++i)
      {
        ...
        [(NPKIDVRemoteDeviceProtoCredentialPropertiesRequest *)self addConfiguredPartitionsIdentifiers:*(*(&v11 + 1) + 8 * i), v11];
      }
