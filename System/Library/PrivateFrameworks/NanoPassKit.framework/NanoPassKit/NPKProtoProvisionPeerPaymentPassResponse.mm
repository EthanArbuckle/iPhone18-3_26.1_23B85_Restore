...
- (id)description
{
  ...
  v8.receiver = self;
  v8.super_class = NPKProtoProvisionPeerPaymentPassResponse;
  v4 = [(NPKProtoProvisionPeerPaymentPassResponse *)&v8 description];
  dictionaryRepresentation = [(NPKProtoProvisionPeerPaymentPassResponse *)self dictionaryRepresentation];
...
- (void)mergeFrom:(id)from
{
  ...
  {
    v6 = fromCopy;
    [(NPKProtoProvisionPeerPaymentPassResponse *)self setErrorData:?];
    fromCopy = v6;
  }
}
