...
- (void)copyTo:(id)a3
{
  ...
  if ([(NPKProtoAddPendingProvisioningRequest *)self pendingProvisioningsCount])
  {
    ...
    v4 = [(NPKProtoAddPendingProvisioningRequest *)self pendingProvisioningsCount];
    if (v4)
    {
      v5 = v4;
      for (i = 0; i != v5; ++i)
  ...
  if (v5)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        [(NPKProtoAddPendingProvisioningRequest *)self addPendingProvisioning:*(*(&v10 + 1) + 8 * v8++), v10];
      }
