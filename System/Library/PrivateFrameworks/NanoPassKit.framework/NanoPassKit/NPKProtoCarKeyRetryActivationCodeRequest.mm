...
{
  v4 = a3;
  if ([v4 isMemberOfClass:objc_opt_class()] && ((invitationIdentifier = self->_invitationIdentifier, !(invitationIdentifier | v4[2])) || -[NSString isEqual:](invitationIdentifier, "isEqual:")))
  {
    activationCode = self->_activationCode;
