...
- (id)description
{
  ...
  dictionaryRepresentation = [(NPKProtoUpdatePushTokenRequest *)self dictionaryRepresentation];
...
- (id)copyWithZone:(_NSZone *)zone
{
  ...
  v6 = [(NSString *)self->_pushToken copyWithZone:zone];
  v7 = v5[1];
  v5[1] = v6;
