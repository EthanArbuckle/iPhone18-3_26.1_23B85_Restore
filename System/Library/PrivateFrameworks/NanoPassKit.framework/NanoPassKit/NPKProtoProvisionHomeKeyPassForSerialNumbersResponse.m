...
- (void)copyTo:(id)a3
{
  ...
  if ([(NPKProtoProvisionHomeKeyPassForSerialNumbersResponse *)self provisionedPassesDatasCount])
  {
    ...
    v4 = [(NPKProtoProvisionHomeKeyPassForSerialNumbersResponse *)self provisionedPassesDatasCount];
    if (v4)
    {
      v5 = v4;
      for (i = 0; i != v5; ++i)
...
{
  v4 = a3;
  if ([v4 isMemberOfClass:objc_opt_class()] && ((provisionedPassesDatas = self->_provisionedPassesDatas, !(provisionedPassesDatas | v4[2])) || -[NSMutableArray isEqual:](provisionedPassesDatas, "isEqual:")))
  {
    errorData = self->_errorData;
    if (errorData | v4[1])
    {
  ...
  if (v6)
  {
    ...
    do
    {
      for (i = 0; i != v7; ++i)
      {
        ...
        [(NPKProtoProvisionHomeKeyPassForSerialNumbersResponse *)self addProvisionedPassesData:*(*(&v11 + 1) + 8 * i), v11];
      }
