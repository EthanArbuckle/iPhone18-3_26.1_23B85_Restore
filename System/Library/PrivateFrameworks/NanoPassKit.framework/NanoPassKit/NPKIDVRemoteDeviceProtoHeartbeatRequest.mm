...
- (void)copyTo:(id)a3
{
  ...
  if ([(NPKIDVRemoteDeviceProtoHeartbeatRequest *)self inProgressResponseIdentifiersCount])
  {
    ...
    v4 = [(NPKIDVRemoteDeviceProtoHeartbeatRequest *)self inProgressResponseIdentifiersCount];
    if (v4)
    {
      v5 = v4;
      for (i = 0; i != v5; ++i)
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    inProgressResponseIdentifiers = self->_inProgressResponseIdentifiers;
    if (inProgressResponseIdentifiers | v4[1])
    {
  ...
  if (v5)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        [(NPKIDVRemoteDeviceProtoHeartbeatRequest *)self addInProgressResponseIdentifiers:*(*(&v10 + 1) + 8 * v8++), v10];
      }
