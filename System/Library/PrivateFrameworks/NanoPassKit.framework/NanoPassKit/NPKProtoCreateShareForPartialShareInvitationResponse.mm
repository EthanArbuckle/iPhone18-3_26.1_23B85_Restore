...
- (id)description
{
  ...
  dictionaryRepresentation = [(NPKProtoCreateShareForPartialShareInvitationResponse *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  if (shareURLData)
  {
    [dictionary setObject:shareURLData forKey:@"shareURLData"];
  }
...
- (id)copyWithZone:(_NSZone *)zone
{
  ...
  v6 = [(NSData *)self->_shareURLData copyWithZone:zone];
  v7 = v5[2];
  v5[2] = v6;
...
{
  equalCopy = equal;
  if ([equalCopy isMemberOfClass:objc_opt_class()] && ((shareURLData = self->_shareURLData, !(shareURLData | equalCopy[2])) || -[NSData isEqual:](shareURLData, "isEqual:")))
  {
    errorData = self->_errorData;
