...
- (id)description
{
  ...
  dictionaryRepresentation = [(NPKProtoAccountAttestationAnonymizationSaltResponse *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  {
    [dictionary setObject:anonymizationSalt forKey:@"anonymizationSalt"];
  }
...
- (id)copyWithZone:(_NSZone *)zone
{
  ...
  v6 = [(NSString *)self->_anonymizationSalt copyWithZone:zone];
  v7 = v5[1];
  v5[1] = v6;
...
{
  equalCopy = equal;
  if ([equalCopy isMemberOfClass:objc_opt_class()] && ((anonymizationSalt = self->_anonymizationSalt, !(anonymizationSalt | equalCopy[1])) || -[NSString isEqual:](anonymizationSalt, "isEqual:")))
  {
    errorData = self->_errorData;
