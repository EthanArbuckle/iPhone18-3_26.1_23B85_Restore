...
- (id)description
{
  ...
  dictionaryRepresentation = [(NPKProtoRegistrationDataRequest *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  if (authToken)
  {
    [dictionary setObject:authToken forKey:@"authToken"];
  }
...
- (id)copyWithZone:(_NSZone *)zone
{
  ...
  v6 = [(NSString *)self->_authToken copyWithZone:zone];
  v7 = v5[1];
  v5[1] = v6;
