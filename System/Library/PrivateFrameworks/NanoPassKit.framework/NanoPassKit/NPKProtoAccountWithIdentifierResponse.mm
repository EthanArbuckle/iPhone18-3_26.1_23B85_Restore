...
- (id)description
{
  ...
  dictionaryRepresentation = [(NPKProtoAccountWithIdentifierResponse *)self dictionaryRepresentation];
...
{
  equalCopy = equal;
  if ([equalCopy isMemberOfClass:objc_opt_class()] && ((accountData = self->_accountData, !(accountData | equalCopy[1])) || -[NSData isEqual:](accountData, "isEqual:")))
  {
    errorData = self->_errorData;
