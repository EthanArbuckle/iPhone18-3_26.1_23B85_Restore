...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v6 = [(NSData *)self->_signingKeyData copyWithZone:a3];
  v7 = v5[2];
  v5[2] = v6;
...
{
  v4 = a3;
  if ([v4 isMemberOfClass:objc_opt_class()] && ((signingKeyData = self->_signingKeyData, !(signingKeyData | v4[2])) || -[NSData isEqual:](signingKeyData, "isEqual:")))
  {
    errorData = self->_errorData;
    if (errorData | v4[1])
    {
