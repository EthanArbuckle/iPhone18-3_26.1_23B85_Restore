...
- (id)description
{
  ...
  v8.receiver = self;
  v8.super_class = NPKProtoCanAcceptInvitationRequest;
  v4 = [(NPKProtoCanAcceptInvitationRequest *)&v8 description];
  dictionaryRepresentation = [(NPKProtoCanAcceptInvitationRequest *)self dictionaryRepresentation];
...
- (void)mergeFrom:(id)from
{
  if (*(from + 1))
  {
    [(NPKProtoCanAcceptInvitationRequest *)self setInvitationData:?];
  }
}
