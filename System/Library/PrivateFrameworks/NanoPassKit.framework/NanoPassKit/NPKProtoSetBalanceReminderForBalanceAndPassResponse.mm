...
- (id)description
{
  ...
  v8.receiver = self;
  v8.super_class = NPKProtoSetBalanceReminderForBalanceAndPassResponse;
  v4 = [(NPKProtoSetBalanceReminderForBalanceAndPassResponse *)&v8 description];
  dictionaryRepresentation = [(NPKProtoSetBalanceReminderForBalanceAndPassResponse *)self dictionaryRepresentation];
