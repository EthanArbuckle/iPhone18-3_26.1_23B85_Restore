...
- (id)description
{
  ...
  v8.receiver = self;
  v8.super_class = NPKProtoStandalonePaymentProvisioningFlowSkipProvisioningRequest;
  v4 = [(NPKProtoStandalonePaymentProvisioningFlowSkipProvisioningRequest *)&v8 description];
  dictionaryRepresentation = [(NPKProtoStandalonePaymentProvisioningFlowSkipProvisioningRequest *)self dictionaryRepresentation];
...
- (void)mergeFrom:(id)from
{
  ...
  else
  {
    ...
    v7 = fromCopy;
    [(NPKProtoStandalonePaymentProvisioningFlowSkipProvisioningRequest *)self setRequestHeader:?];
  }
