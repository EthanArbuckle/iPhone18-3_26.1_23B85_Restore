...
- (id)description
{
  ...
  v8.receiver = self;
  v8.super_class = NPKProtoPerformDeviceCheckInResponse;
  v4 = [(NPKProtoPerformDeviceCheckInResponse *)&v8 description];
  dictionaryRepresentation = [(NPKProtoPerformDeviceCheckInResponse *)self dictionaryRepresentation];
...
- (void)mergeFrom:(id)from
{
  ...
  {
    v6 = fromCopy;
    [(NPKProtoPerformDeviceCheckInResponse *)self setErrorData:?];
    fromCopy = v6;
  }
}
