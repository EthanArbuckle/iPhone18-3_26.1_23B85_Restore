...
- (id)description
{
  ...
  dictionaryRepresentation = [(NPKProtoCarKeyDecryptDataResponse *)self dictionaryRepresentation];
...
{
  equalCopy = equal;
  if ([equalCopy isMemberOfClass:objc_opt_class()] && ((encryptedData = self->_encryptedData, !(encryptedData | equalCopy[1])) || -[NSData isEqual:](encryptedData, "isEqual:")))
  {
    errorData = self->_errorData;
