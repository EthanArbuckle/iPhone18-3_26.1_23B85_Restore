...
- (id)description
{
  ...
  v8.receiver = self;
  v8.super_class = NPKProtoOwnershipTokenRequest;
  v4 = [(NPKProtoOwnershipTokenRequest *)&v8 description];
  dictionaryRepresentation = [(NPKProtoOwnershipTokenRequest *)self dictionaryRepresentation];
...
- (void)mergeFrom:(id)from
{
  if (*(from + 1))
  {
    [(NPKProtoOwnershipTokenRequest *)self setIdentifier:?];
  }
}
