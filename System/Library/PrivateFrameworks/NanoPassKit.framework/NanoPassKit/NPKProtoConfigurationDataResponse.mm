...
- (id)description
{
  ...
  v8.receiver = self;
  v8.super_class = NPKProtoConfigurationDataResponse;
  v4 = [(NPKProtoConfigurationDataResponse *)&v8 description];
  dictionaryRepresentation = [(NPKProtoConfigurationDataResponse *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  {
    [dictionary setObject:configurationDataBytes forKey:@"configurationDataBytes"];
  }
...
- (void)copyTo:(id)to
{
  ...
  {
    v5 = toCopy;
    [toCopy setConfigurationDataBytes:?];
    toCopy = v5;
  }
}
...
- (id)copyWithZone:(_NSZone *)zone
{
  ...
  v7 = [(NSData *)self->_configurationDataBytes copyWithZone:zone];
  v8 = v6[1];
  v6[1] = v7;
...
LABEL_4:
  configurationDataBytes = self->_configurationDataBytes;
  if (configurationDataBytes | *(equalCopy + 1))
  {
    v7 = [(NSData *)configurationDataBytes isEqual:?];
  }
...
- (void)mergeFrom:(id)from
{
  ...
  {
    v5 = fromCopy;
    [(NPKProtoConfigurationDataResponse *)self setConfigurationDataBytes:?];
    fromCopy = v5;
  }
}
