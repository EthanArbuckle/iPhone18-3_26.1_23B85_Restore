...
- (id)description
{
  ...
  v8.receiver = self;
  v8.super_class = NPKProtoCarKeyDecryptDataResponse;
...
{
  v4 = a3;
  if ([v4 isMemberOfClass:objc_opt_class()] && ((encryptedData = self->_encryptedData, !(encryptedData | v4[1])) || -[NSData isEqual:](encryptedData, "isEqual:")))
  {
    errorData = self->_errorData;
    if (errorData | v4[2])
    {
...
- (void)mergeFrom:(id)a3
{
  ...
  if (v4[1])
  {
    [(NPKProtoCarKeyDecryptDataResponse *)self setEncryptedData:?];
    v4 = v5;
  }

  if (v4[2])
  {
    [(NPKProtoCarKeyDecryptDataResponse *)self setErrorData:?];
    v4 = v5;
  }
}
