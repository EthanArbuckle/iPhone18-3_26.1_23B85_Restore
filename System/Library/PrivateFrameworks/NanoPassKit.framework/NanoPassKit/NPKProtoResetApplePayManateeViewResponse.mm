...
- (id)description
{
  ...
  v8.receiver = self;
  v8.super_class = NPKProtoResetApplePayManateeViewResponse;
  v4 = [(NPKProtoResetApplePayManateeViewResponse *)&v8 description];
  dictionaryRepresentation = [(NPKProtoResetApplePayManateeViewResponse *)self dictionaryRepresentation];
...
- (void)mergeFrom:(id)from
{
  ...
  {
    v6 = fromCopy;
    [(NPKProtoResetApplePayManateeViewResponse *)self setErrorData:?];
    fromCopy = v6;
  }
}
