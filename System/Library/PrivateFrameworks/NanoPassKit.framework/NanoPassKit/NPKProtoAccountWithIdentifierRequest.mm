...
- (id)description
{
  ...
  v8.receiver = self;
  v8.super_class = NPKProtoAccountWithIdentifierRequest;
  v4 = [(NPKProtoAccountWithIdentifierRequest *)&v8 description];
  dictionaryRepresentation = [(NPKProtoAccountWithIdentifierRequest *)self dictionaryRepresentation];
...
- (void)mergeFrom:(id)from
{
  if (*(from + 1))
  {
    [(NPKProtoAccountWithIdentifierRequest *)self setAccountIdentifier:?];
  }
}
