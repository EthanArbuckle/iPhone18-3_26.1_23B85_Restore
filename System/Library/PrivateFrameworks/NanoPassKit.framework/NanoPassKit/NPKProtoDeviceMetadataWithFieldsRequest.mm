...
- (id)description
{
  ...
  dictionaryRepresentation = [(NPKProtoDeviceMetadataWithFieldsRequest *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  [dictionary setObject:v4 forKey:@"metadataFields"];
...
- (BOOL)isEqual:(id)equal
{
  ...
  {
    v5 = self->_metadataFields == equalCopy[2];
  }
