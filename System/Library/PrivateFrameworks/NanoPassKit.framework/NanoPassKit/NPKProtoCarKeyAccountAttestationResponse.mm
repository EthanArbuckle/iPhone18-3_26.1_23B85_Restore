...
- (id)description
{
  ...
  dictionaryRepresentation = [(NPKProtoCarKeyAccountAttestationResponse *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  {
    [dictionary setObject:attestationRequestData forKey:@"attestationRequestData"];
  }
...
- (void)copyTo:(id)to
{
  ...
  if (self->_attestationRequestData)
  {
    [toCopy setAttestationRequestData:?];
    toCopy = v5;
  }
...
- (id)copyWithZone:(_NSZone *)zone
{
  ...
  v6 = [(NSData *)self->_attestationRequestData copyWithZone:zone];
  v7 = v5[1];
  v5[1] = v6;
...
{
  equalCopy = equal;
  if ([equalCopy isMemberOfClass:objc_opt_class()] && ((attestationRequestData = self->_attestationRequestData, !(attestationRequestData | equalCopy[1])) || -[NSData isEqual:](attestationRequestData, "isEqual:")))
  {
    errorData = self->_errorData;
