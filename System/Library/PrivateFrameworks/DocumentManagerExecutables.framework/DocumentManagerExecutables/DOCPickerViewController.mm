...
- (_TtC26DocumentManagerExecutables23DOCPickerViewController)initWithCoder:(id)coder;
- (_TtC26DocumentManagerExecutables23DOCPickerViewController)initWithNibName:(id)name bundle:(id)bundle;
...
- (void)_displayLocationsMenuFromRect:(CGRect)rect
{
  ...
  if (v7())
  {
    v9 = v8;
    ObjectType = swift_getObjectType();
    (*(v9 + 8))(selfCopy, ObjectType, v9, x, y, width, height);
    swift_unknownObjectRelease();
  }
}
