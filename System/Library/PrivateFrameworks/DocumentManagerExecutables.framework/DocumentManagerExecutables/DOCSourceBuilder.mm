...
- (DOCSourceBuilder)initWithUserAction:(unint64_t)a3 hostIdentifier:(id)a4
{
  ...
  v7 = a4;
  v8 = [v6 defaultPermission];
  v9 = [(DOCSourceBuilder *)self initWithUserAction:a3 hostIdentifier:v7 managedPermissions:v8];
...
- (id)buildSourcesProviders:(id)a3 legacyWebViewFileProviders:(id)a4
{
  ...
  if (v6)
  {
    v13 = [(DOCSourceBuilder *)self filterNonObsoleteLegacyPickersFromPickers:v6 modernProviders:v11, v18, v19, v20, v21, v22];
...
- (id)buildSourcesFromProviderDomains:(id)a3
{
  ...
  v4 = a3;
  v20 = [MEMORY[0x277CBEB18] arrayWithCapacity:{objc_msgSend(v4, "count") + 1}];
  v21 = 0u;
  v22 = 0u;
  v23 = 0u;
  v24 = 0u;
  ...
  if (v6)
  {
    ...
    do
    {
      for (i = 0; i != v7; ++i)
      {
        ...
        v12 = [v11 hostAppCanSeeFileProviderDomain:v10];

        if (v12)
        {
          v13 = [MEMORY[0x277D06218] defaultPermission];
          v14 = [v13 canHostAppPerformAction:-[DOCSourceBuilder userAction](self fileProviderDomain:{"userAction"), v10}];

          if (v14)
          {
            v15 = [(DOCSourceBuilder *)self hostIdentifier];
            v16 = [_TtC26DocumentManagerExecutables21DOCFileProviderSource createSourceFrom:v10 with:v15];
    ...
    *&v8 = 136315650;
    ...
    do
    {
      ...
      do
      {
        ...
        v13 = *(*(&v38 + 1) + 8 * v12);
        v14 = [*(v11 + 536) defaultPermission];
        v15 = [v14 canHostAppPerformAction:-[DOCSourceBuilder userAction](self legacyPickerExtension:{"userAction"), v13}];
        ...
        if (!v18)
        {
          ...
          v22 = [v32 filteredArrayUsingPredicate:v21];
          v23 = [v22 firstObject];
          ...
          if (!v23)
          {
            ...
            v35 = 0;
            v23 = [MEMORY[0x277CC6420] providerDomainWithID:v20 cachePolicy:1 error:&v35];
            v25 = v35;
            if (v25)
            {
          ...
          v27 = [[DOCPickerSource alloc] initWithPicker:v13 providerDomain:v23];
          if (v27)
          {
            [v31 addObject:v27];
          }
...
- (id)filterNonObsoleteLegacyPickersFromPickers:(id)a3 modernProviders:(id)a4
{
  ...
  v18 = [v6 filteredArrayUsingPredicate:{v17, v20, v21, v22, v23, v24}];
...
- (id)containingAppBundleIdentifierForBundleURL:(id)a3
{
  v3 = [MEMORY[0x277CC1E90] doc_applicationExtensionRecordAtURL:a3];
...
- (id)matchingLegacyProviderIdentifierForPicker:(id)a3
{
  ...
  if (objc_opt_isKindOfClass())
  {
    ...
    v19 = 0u;
    v20 = 0u;
    v9 = [v7 applicationExtensionRecords];
