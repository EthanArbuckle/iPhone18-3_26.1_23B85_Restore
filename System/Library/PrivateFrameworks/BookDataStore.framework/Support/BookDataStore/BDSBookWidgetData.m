...
- (id)description
{
  ...
  v4 = [(BDSBookWidgetData *)self title];
  v5 = [(BDSBookWidgetData *)self pageProgressionDirection];
  v6 = [(BDSBookWidgetData *)self cloudAssetType];
  v7 = [(BDSBookWidgetData *)self libraryAssetType];
  v8 = [(BDSBookWidgetData *)self readingProgress];
  [v8 doubleValue];
  v10 = v9 * 100.0;
  v11 = [(BDSBookWidgetData *)self totalDuration];
  v12 = [(BDSBookWidgetData *)self coverURL];
  v13 = &stru_10024C800;
  if (!v12)
  {
  ...
  v14 = [NSString stringWithFormat:@"[%@ '%@' %@ %@ %@ (%.0f%%) %@%@]", v3, v4, v5, v6, v7, *&v10, v11, v13];
