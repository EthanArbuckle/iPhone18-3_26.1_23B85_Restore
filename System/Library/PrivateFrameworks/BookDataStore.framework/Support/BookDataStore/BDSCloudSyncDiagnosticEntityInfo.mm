...
- (BDSCloudSyncDiagnosticEntityInfo)initWithCoder:(id)a3
{
  ...
  if (v5)
  {
    ...
    v10 = [v4 decodeObjectOfClasses:v9 forKey:@"dirtyCloudDataInfos"];
    dirtyCloudDataInfos = v5->_dirtyCloudDataInfos;
    v5->_dirtyCloudDataInfos = v10;
  }
...
- (id)description
{
  ...
  v5 = [(BDSCloudSyncDiagnosticEntityInfo *)self enabledSync];
  v6 = [(BDSCloudSyncDiagnosticEntityInfo *)self dirtyCloudDataInfos];
  v7 = [v6 count];
  v8 = [(BDSCloudSyncDiagnosticEntityInfo *)self dirtyCloudDataInfos];
  v9 = [NSString stringWithFormat:@"<%@: name:%@, enabledSync:%d, dirtyInfos(count=%lu):%@>", v3, v4, v5, v7, v8];
...
- (NSDictionary)stateForLog
{
  ...
  v5 = [NSNumber numberWithBool:[(BDSCloudSyncDiagnosticEntityInfo *)self enabledSync]];
