...
- (BDSCloudSyncDiagnosticInfo)initWithCoder:(id)coder
{
  ...
  if (v5)
  {
    ...
    v15 = [coderCopy decodeObjectOfClasses:v14 forKey:@"entityInfos"];
...
- (id)description
{
  ...
  privateDatabaseSyncEngineInfo = [(BDSCloudSyncDiagnosticInfo *)self privateDatabaseSyncEngineInfo];
  entityInfos = [(BDSCloudSyncDiagnosticInfo *)self entityInfos];
  v12 = [v3 stringWithFormat:@"<%@: enabledSync:%d, accountStatus:%ld, container:%@, gettingAccountInfo:%d, privateDatabase:%@, privateDatabaseSyncEngine:%@, entities:%@>", v4, enabledSync, accountStatus, container, gettingAccountInfo, privateDatabaseInfo, privateDatabaseSyncEngineInfo, entityInfos];
