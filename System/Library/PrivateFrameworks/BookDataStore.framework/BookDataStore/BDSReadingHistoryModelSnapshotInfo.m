...
- (id)description
{
  ...
  v4 = objc_opt_class();
  v5 = [(BDSReadingHistoryModelSnapshotInfo *)self loaded];
  v6 = [(BDSReadingHistoryModelSnapshotInfo *)self lastSource];
  v7 = [(BDSReadingHistoryModelSnapshotInfo *)self modelReadingDay];
  v8 = [(BDSReadingHistoryModelSnapshotInfo *)self modelLongestStreak];
  v9 = [(BDSReadingHistoryModelSnapshotInfo *)self remoteModelReadingDay];
  v10 = [(BDSReadingHistoryModelSnapshotInfo *)self remoteModelLongestStreak];
  v11 = [v3 stringWithFormat:@"<%@: %p loaded:%ld, lastSource:%ld, modelReadingDay:%@, modelLongestStreak:%@, remoteModelReadingDay:%@, remoteModelLongestStreak:%@>", v4, self, v5, v6, v7, v8, v9, v10];
