...
- (id)description
{
  ...
  remoteModelReadingDay = [(BDSReadingHistoryModelSnapshotInfo *)self remoteModelReadingDay];
  remoteModelLongestStreak = [(BDSReadingHistoryModelSnapshotInfo *)self remoteModelLongestStreak];
  v11 = [v3 stringWithFormat:@"<%@: %p loaded:%ld, lastSource:%ld, modelReadingDay:%@, modelLongestStreak:%@, remoteModelReadingDay:%@, remoteModelLongestStreak:%@>", v4, self, loaded, lastSource, modelReadingDay, modelLongestStreak, remoteModelReadingDay, remoteModelLongestStreak];
