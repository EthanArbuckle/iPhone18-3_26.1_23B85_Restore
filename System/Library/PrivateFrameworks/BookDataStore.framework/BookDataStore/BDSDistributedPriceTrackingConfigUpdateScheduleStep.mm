...
{
  v4 = a3;
  [v4 decodeIntegerForKey:@"duration"];
  [v4 decodeIntegerForKey:@"minUpdateInterval"];
  [v4 decodeIntegerForKey:@"schedulerConfigIdealInterval"];
  [v4 decodeIntegerForKey:@"schedulerConfigMinInterval"];
