...
{
  coderCopy = coder;
  [coderCopy decodeIntegerForKey:@"duration"];
  [coderCopy decodeIntegerForKey:@"minUpdateInterval"];
  [coderCopy decodeIntegerForKey:@"schedulerConfigIdealInterval"];
  [coderCopy decodeIntegerForKey:@"schedulerConfigMinInterval"];

  return MEMORY[0x1EEE66B58](self, sel_initWithDuration_minUpdateInterval_schedulerConfigIdealInterval_schedulerConfigMinInterval_);
}
