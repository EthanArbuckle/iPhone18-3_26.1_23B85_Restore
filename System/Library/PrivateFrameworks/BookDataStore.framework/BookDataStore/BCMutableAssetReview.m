...
- (NSString)description
{
  ...
  v4 = [(BCMutableAssetReview *)self assetReviewID];
  v5 = [(BCMutableAssetReview *)self starRating];
  v6 = [(BCMutableAssetReview *)self reviewTitle];
  v7 = [(BCMutableAssetReview *)self reviewBody];
