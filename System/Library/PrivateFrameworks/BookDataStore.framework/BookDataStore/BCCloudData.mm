...
{
  v36 = a3;
  v5 = [MEMORY[0x1E696AD98] numberWithBool:{objc_msgSend(v36, "deletedFlag")}];
  [(NSManagedObject *)self setDifferentNumber:v5 forKey:@"deletedFlag"];

  v6 = [v36 modificationDate];
  [(NSManagedObject *)self setDifferentDate:v6 forKey:@"modificationDate"];
    ...
    if ([v3 establishedSalt])
    {
      ...
      if (v14)
      {
        ...
        if (v17)
        {
          ...
          v21 = [v19 initWithZoneName:v20 ownerName:*MEMORY[0x1E695B728]];
...
- (void)incrementEditGeneration
{
  ...
  if (v4)
  {
    ...
    {
      v7 = 134218242;
      v8 = [(BCCloudData *)self editGeneration];
      v9 = 2112;
      v10 = self;
