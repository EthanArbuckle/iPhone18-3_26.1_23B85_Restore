...
- (id)description
{
  ...
  v5 = [(BCMutableCloudSyncVersions *)self cloudVersion];
  v6 = [(BCMutableCloudSyncVersions *)self localVersion];
  v7 = [(BCMutableCloudSyncVersions *)self syncVersion];
  v8 = [(BCMutableCloudSyncVersions *)self historyToken];
  v9 = [v3 stringWithFormat:@"dataType: %@, cloudVersion: %lld, localVersion: %lld, syncVersion: %lld historyToken:%@ historyTokenOffset=%lld", v4, v5, v6, v7, v8, -[BCMutableCloudSyncVersions historyTokenOffset](self, "historyTokenOffset")];
