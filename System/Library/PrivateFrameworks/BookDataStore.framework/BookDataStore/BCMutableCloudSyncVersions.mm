...
- (id)description
{
  ...
  v9 = [v3 stringWithFormat:@"dataType: %@, cloudVersion: %lld, localVersion: %lld, syncVersion: %lld historyToken:%@ historyTokenOffset=%lld", dataType, cloudVersion, localVersion, syncVersion, historyToken, -[BCMutableCloudSyncVersions historyTokenOffset](self, "historyTokenOffset")];
