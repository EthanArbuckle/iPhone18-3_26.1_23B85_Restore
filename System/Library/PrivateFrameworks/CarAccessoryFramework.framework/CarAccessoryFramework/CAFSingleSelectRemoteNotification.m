...
- (id)name
{
  ...
  v4 = [(CAFSingleSelectRemoteNotification *)self identifierCharacteristic];
  ...
  v7 = [(CAFSingleSelectRemoteNotification *)self displayPanelIdentifierCharacteristic];
  ...
  v10 = [(CAFSingleSelectRemoteNotification *)self displayZoneIdentifierCharacteristic];
...
- (NSString)userVisibleLabel
{
  v2 = [(CAFSingleSelectRemoteNotification *)self userVisibleLabelCharacteristic];
  v3 = [v2 stringValue];
...
- (NSString)userVisibleDescription
{
  v2 = [(CAFSingleSelectRemoteNotification *)self userVisibleDescriptionCharacteristic];
  v3 = [v2 stringValue];
...
- (NSString)identifier
{
  v2 = [(CAFSingleSelectRemoteNotification *)self identifierCharacteristic];
  v3 = [v2 stringValue];
...
- (CAFSymbolImageWithColor)symbolNameAndColor
{
  v2 = [(CAFSingleSelectRemoteNotification *)self symbolNameAndColorCharacteristic];
...
- (NSString)displayPanelIdentifier
{
  v2 = [(CAFSingleSelectRemoteNotification *)self displayPanelIdentifierCharacteristic];
  v3 = [v2 stringValue];
...
- (NSString)displayZoneIdentifier
{
  v2 = [(CAFSingleSelectRemoteNotification *)self displayZoneIdentifierCharacteristic];
  v3 = [v2 stringValue];
...
- (CAFTrailingButton)trailingButton
{
  v2 = [(CAFSingleSelectRemoteNotification *)self trailingButtonCharacteristic];
...
- (unsigned)trailingButtonState
{
  v2 = [(CAFSingleSelectRemoteNotification *)self trailingButtonStateCharacteristic];
...
- (CAFSelectableNotificationEntryList)selectableNotificationEntries
{
  v2 = [(CAFSingleSelectRemoteNotification *)self selectableNotificationEntriesCharacteristic];
...
- (unsigned)selectedEntryIndex
{
  v2 = [(CAFSingleSelectRemoteNotification *)self selectedEntryIndexCharacteristic];
  v3 = [v2 uint8Value];
