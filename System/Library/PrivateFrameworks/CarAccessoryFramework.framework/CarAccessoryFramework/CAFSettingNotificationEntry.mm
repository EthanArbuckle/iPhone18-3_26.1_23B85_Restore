...
- (CAFSettingNotificationEntry)initWithDictionary:(id)dictionary;
- (CAFSettingNotificationEntry)initWithSymbolColor:(unsigned __int8)color symbolName:(id)name userVisibleLabel:(id)label;
...
- (id)description
{
  ...
  v4 = objc_opt_class();
  symbolColor = [(CAFSettingNotificationEntry *)self symbolColor];
  symbolName = [(CAFSettingNotificationEntry *)self symbolName];
  userVisibleLabel = [(CAFSettingNotificationEntry *)self userVisibleLabel];
