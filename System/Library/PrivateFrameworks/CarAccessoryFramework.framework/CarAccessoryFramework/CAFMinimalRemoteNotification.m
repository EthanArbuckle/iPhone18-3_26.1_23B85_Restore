...
- (id)name
{
  ...
  v4 = [(CAFMinimalRemoteNotification *)self identifierCharacteristic];
  ...
  v7 = [(CAFMinimalRemoteNotification *)self displayPanelIdentifierCharacteristic];
  ...
  v10 = [(CAFMinimalRemoteNotification *)self displayZoneIdentifierCharacteristic];
...
- (NSString)userVisibleLabel
{
  v2 = [(CAFMinimalRemoteNotification *)self userVisibleLabelCharacteristic];
  v3 = [v2 stringValue];
...
- (NSString)userVisibleDescription
{
  v2 = [(CAFMinimalRemoteNotification *)self userVisibleDescriptionCharacteristic];
  v3 = [v2 stringValue];
...
- (NSString)identifier
{
  v2 = [(CAFMinimalRemoteNotification *)self identifierCharacteristic];
  v3 = [v2 stringValue];
...
- (CAFSymbolImageWithColor)symbolNameAndColor
{
  v2 = [(CAFMinimalRemoteNotification *)self symbolNameAndColorCharacteristic];
...
- (NSString)displayPanelIdentifier
{
  v2 = [(CAFMinimalRemoteNotification *)self displayPanelIdentifierCharacteristic];
  v3 = [v2 stringValue];
...
- (NSString)displayZoneIdentifier
{
  v2 = [(CAFMinimalRemoteNotification *)self displayZoneIdentifierCharacteristic];
  v3 = [v2 stringValue];
...
- (CAFTrailingButton)trailingButton
{
  v2 = [(CAFMinimalRemoteNotification *)self trailingButtonCharacteristic];
...
- (unsigned)trailingButtonState
{
  v2 = [(CAFMinimalRemoteNotification *)self trailingButtonStateCharacteristic];
