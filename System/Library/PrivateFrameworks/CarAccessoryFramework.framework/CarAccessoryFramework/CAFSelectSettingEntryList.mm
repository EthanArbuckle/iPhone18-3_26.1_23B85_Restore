...
void __43__CAFSelectSettingEntryList_initWithArray___block_invoke(uint64_t a1, void *a2)
{
  ...
  {
    v4 = [[CAFSelectSettingEntry alloc] initWithDictionary:v3];
    [*(a1 + 32) addObject:v4];
  }

  else
  {
    v5 = [MEMORY[0x277CCA9B8] CAF_elementParseFailedForDataSupportType:@"SelectSettingEntryList"];
    v7 = *(a1 + 40);
    v6 = (a1 + 40);
    v8 = *(v7 + 16);
    *(v7 + 16) = v5;
    ...
    {
      __43__CAFSelectSettingEntryList_initWithArray___block_invoke_cold_1(v6, v3, &v4->super);
    }
  }
}
...
void __43__CAFSelectSettingEntryList_initWithArray___block_invoke_cold_1(uint64_t *a1, uint64_t a2, os_log_t log)
{
  ...
  v7 = 2114;
  v8 = a2;
  _os_log_error_impl(&dword_231618000, log, OS_LOG_TYPE_ERROR, "%{public}@: Error parsing dictionary from SelectSettingEntryList array - %{public}@", &v5, 0x16u);
