...
- (id)name
{
  ...
  v4 = [(CAFLocalNotification *)self identifierCharacteristic];
...
- (NSString)identifier
{
  v2 = [(CAFLocalNotification *)self identifierCharacteristic];
  v3 = [v2 stringValue];
...
- (NSString)displayPanelIdentifier
{
  v2 = [(CAFLocalNotification *)self displayPanelIdentifierCharacteristic];
  v3 = [v2 stringValue];
...
- (NSString)displayZoneIdentifier
{
  v2 = [(CAFLocalNotification *)self displayZoneIdentifierCharacteristic];
  v3 = [v2 stringValue];
