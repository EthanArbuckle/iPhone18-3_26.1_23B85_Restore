...
- (id)name
{
  ...
  v4 = [(CAFFan *)self vehicleLayoutKeyCharacteristic];
...
- (unsigned)fanLevel
{
  v2 = [(CAFFan *)self fanLevelCharacteristic];
  v3 = [v2 uint8Value];
...
- (BOOL)on
{
  v2 = [(CAFFan *)self onCharacteristic];
  v3 = [v2 BOOLValue];
...
- (BOOL)autoMode
{
  v2 = [(CAFFan *)self autoModeCharacteristic];
  v3 = [v2 BOOLValue];
...
- (NSString)vehicleLayoutKey
{
  v2 = [(CAFFan *)self vehicleLayoutKeyCharacteristic];
  v3 = [v2 stringValue];
