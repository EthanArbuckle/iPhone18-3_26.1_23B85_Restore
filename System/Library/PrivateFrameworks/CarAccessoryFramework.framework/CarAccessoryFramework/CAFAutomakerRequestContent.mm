...
- (NSArray)requestContentServices
{
  ...
  [registrations validateRegisteredForAccessory:accessoryIdentifier service:@"0x0000000017000004"];
...
- (NSArray)requestTemporaryContentServices
{
  ...
  registrations = [config registrations];
  accessoryIdentifier = [objc_opt_class() accessoryIdentifier];
  [registrations validateRegisteredForAccessory:accessoryIdentifier service:@"0x000000001700000C"];
