...
{
  v4 = a3;
  v5 = [[a1 alloc] initWithTestComplexItems:v4];
...
- (CAFTestComplexItems)initWithTestComplexItems:(id)a3
{
  ...
  if (v6)
  {
    objc_storeStrong(&v6->_testComplexItems, a3);
  }
...
- (NSString)formattedValue
{
  v3 = [(CAFTestComplexItems *)self testComplexItems];
  if ([v3 count])
  {
    v4 = MEMORY[0x277CCACA8];
    v5 = [(CAFTestComplexItems *)self testComplexItems];
...
- (NSArray)arrayRepresentation
{
  ...
  v14 = 0u;
  v15 = 0u;
  v4 = [(CAFTestComplexItems *)self testComplexItems];
...
- (unint64_t)countByEnumeratingWithState:(id *)a3 objects:(id *)a4 count:(unint64_t)a5
{
  v8 = [(CAFTestComplexItems *)self testComplexItems];
...
void __37__CAFTestComplexItems_initWithArray___block_invoke_cold_1(uint64_t *a1, uint64_t a2, os_log_t log)
{
  ...
  v7 = 2114;
  v8 = a2;
  _os_log_error_impl(&dword_231618000, log, OS_LOG_TYPE_ERROR, "%{public}@: Error parsing dictionary from TestComplexItems array - %{public}@", &v5, 0x16u);
