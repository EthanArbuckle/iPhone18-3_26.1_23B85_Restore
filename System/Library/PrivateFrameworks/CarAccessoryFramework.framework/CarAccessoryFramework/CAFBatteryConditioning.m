...
- (CAFBatteryConditioningStateCharacteristic)batteryConditioningStateCharacteristic
{
  ...
  [v6 validateRegisteredForAccessory:v8 service:v9 characteristic:@"0x000000004000000B"];
...
- (unsigned)batteryConditioningState
{
  v2 = [(CAFBatteryConditioning *)self batteryConditioningStateCharacteristic];
  v3 = [v2 batteryConditioningStateValue];
...
- (BOOL)registeredForBatteryConditioningState
{
  ...
  v8 = [objc_opt_class() accessoryIdentifier];
  v9 = [objc_opt_class() serviceIdentifier];
  v10 = [v6 hasAccessory:v8 service:v9 characteristic:@"0x000000004000000B"];
