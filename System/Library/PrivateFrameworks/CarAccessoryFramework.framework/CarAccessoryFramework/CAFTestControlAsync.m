...
{
  v4 = a3;
  v5 = [(CAFTestControlAsync *)self testDevRequestNoParamsControl];
  v6 = v5;
  if (v5)
  {
...
- (BOOL)hasTestDevRequestNoParams
{
  v2 = [(CAFTestControlAsync *)self testDevRequestNoParamsControl];
  v3 = v2 != 0;
...
- (BOOL)hasTestDevRequestWithReqParams
{
  v2 = [(CAFTestControlAsync *)self testDevRequestWithReqParamsControl];
  v3 = v2 != 0;
...
{
  v4 = a3;
  v5 = [(CAFTestControlAsync *)self testDevRequestWithResParamsControl];
  v6 = v5;
  if (v5)
  {
...
- (BOOL)hasTestDevRequestWithResParams
{
  v2 = [(CAFTestControlAsync *)self testDevRequestWithResParamsControl];
  v3 = v2 != 0;
...
- (BOOL)hasTestDevRequestWithReqAndResParams
{
  v2 = [(CAFTestControlAsync *)self testDevRequestWithReqAndResParamsControl];
  v3 = v2 != 0;
...
- (id)testAccRequestNoParamsHandler
{
  v2 = [(CAFTestControlAsync *)self testAccRequestNoParamsControl];
  v3 = [v2 handler];
...
{
  v4 = a3;
  v5 = [(CAFTestControlAsync *)self testAccRequestNoParamsControl];
  [v5 setHandler:v4];
}
...
- (id)testAccRequestWithReqParamsHandler
{
  v2 = [(CAFTestControlAsync *)self testAccRequestWithReqParamsControl];
  v3 = [v2 handler];
...
{
  v4 = a3;
  v5 = [(CAFTestControlAsync *)self testAccRequestWithReqParamsControl];
  [v5 setHandler:v4];
}
...
- (id)testAccRequestWithResParamsHandler
{
  v2 = [(CAFTestControlAsync *)self testAccRequestWithResParamsControl];
  v3 = [v2 handler];
...
{
  v4 = a3;
  v5 = [(CAFTestControlAsync *)self testAccRequestWithResParamsControl];
  [v5 setHandler:v4];
}
...
- (id)testAccRequestWithReqAndResParamsHandler
{
  v2 = [(CAFTestControlAsync *)self testAccRequestWithReqAndResParamsControl];
  v3 = [v2 handler];
...
{
  v4 = a3;
  v5 = [(CAFTestControlAsync *)self testAccRequestWithReqAndResParamsControl];
  [v5 setHandler:v4];
}
