...
- (NSArray)arrayRepresentation
{
  ...
  v15 = 0u;
  prominenceInformations = [(CAFProminenceInfo *)self prominenceInformations];
  v5 = [prominenceInformations countByEnumeratingWithState:&v12 objects:v16 count:16];
  if (v5)
  {
    v6 = v5;
    v7 = *v13;
    do
    {
      ...
      v6 = [prominenceInformations countByEnumeratingWithState:&v12 objects:v16 count:16];
    }
