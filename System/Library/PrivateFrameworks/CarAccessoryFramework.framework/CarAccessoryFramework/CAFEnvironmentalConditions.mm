...
{
  v2.receiver = self;
  v2.super_class = &OBJC_METACLASS___CAFEnvironmentalConditions;
...
- (void)registerObserver:(id)observer
{
  ...
  v6.receiver = self;
  v6.super_class = CAFEnvironmentalConditions;
...
- (CAFExteriorConditions)exteriorConditionsService
{
  ...
  [registrations validateRegisteredForAccessory:accessoryIdentifier service:@"0x0000000011000009"];
...
- (CAFInteriorConditions)interiorConditionsService
{
  ...
  registrations = [config registrations];
  accessoryIdentifier = [objc_opt_class() accessoryIdentifier];
  [registrations validateRegisteredForAccessory:accessoryIdentifier service:@"0x0000000011000013"];
