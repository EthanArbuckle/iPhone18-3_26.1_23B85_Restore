...
- (NSString)userVisibleValue
{
  v2 = [(CAFStaticSetting *)self userVisibleValueCharacteristic];
  v3 = [v2 stringValue];
...
- (NSArray)childrenSettingsIdentifiers
{
  v2 = [(CAFStaticSetting *)self childrenSettingsIdentifiersCharacteristic];
  v3 = [v2 arrayValue];
...
- (CAFUserVisibleDetailedDescription)userVisibleDetailedDescription
{
  v2 = [(CAFStaticSetting *)self userVisibleDetailedDescriptionCharacteristic];
...
- (NSString)userVisibleDescription
{
  v2 = [(CAFStaticSetting *)self userVisibleDescriptionCharacteristic];
  v3 = [v2 stringValue];
...
- (BOOL)registeredForChildrenSettingsIdentifiers
{
  ...
  v8 = [objc_opt_class() accessoryIdentifier];
  v9 = [objc_opt_class() serviceIdentifier];
  v10 = [v6 hasAccessory:v8 service:v9 characteristic:@"0x0000000036000012"];
