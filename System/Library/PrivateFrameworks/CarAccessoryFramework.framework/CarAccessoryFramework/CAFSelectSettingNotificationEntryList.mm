...
+ (id)selectSettingNotificationEntryListWithArray:(id)a3;
+ (id)selectSettingNotificationEntryListWithSelectSettingNotificationEntrys:(id)a3;
- (CAFSelectSettingNotificationEntryList)initWithArray:(id)a3;
- (CAFSelectSettingNotificationEntryList)initWithSelectSettingNotificationEntrys:(id)a3;
...
{
  v4 = a3;
  v5 = [[a1 alloc] initWithSelectSettingNotificationEntrys:v4];
...
- (CAFSelectSettingNotificationEntryList)initWithSelectSettingNotificationEntrys:(id)a3
{
  ...
  if (v6)
  {
    objc_storeStrong(&v6->_selectSettingNotificationEntrys, a3);
  }
...
- (NSString)formattedValue
{
  v3 = [(CAFSelectSettingNotificationEntryList *)self selectSettingNotificationEntrys];
  if ([v3 count])
  {
    v4 = MEMORY[0x277CCACA8];
    v5 = [(CAFSelectSettingNotificationEntryList *)self selectSettingNotificationEntrys];
...
- (NSArray)arrayRepresentation
{
  ...
  v14 = 0u;
  v15 = 0u;
  v4 = [(CAFSelectSettingNotificationEntryList *)self selectSettingNotificationEntrys];
...
- (unint64_t)countByEnumeratingWithState:(id *)a3 objects:(id *)a4 count:(unint64_t)a5
{
  v8 = [(CAFSelectSettingNotificationEntryList *)self selectSettingNotificationEntrys];
