...
- (id)name
{
  ...
  v4 = [(CAFOverlayView *)self displayPanelIdentifierCharacteristic];
  ...
  v7 = [(CAFOverlayView *)self identifierCharacteristic];
...
- (NSString)displayPanelIdentifier
{
  v2 = [(CAFOverlayView *)self displayPanelIdentifierCharacteristic];
  v3 = [v2 stringValue];
...
- (NSString)identifier
{
  v2 = [(CAFOverlayView *)self identifierCharacteristic];
  v3 = [v2 stringValue];
...
- (BOOL)on
{
  v2 = [(CAFOverlayView *)self onCharacteristic];
  v3 = [v2 BOOLValue];
...
- (CAFFloatCharacteristic)originXCharacteristic
{
  ...
  v8 = [objc_opt_class() accessoryIdentifier];
  v9 = [objc_opt_class() serviceIdentifier];
  [v6 validateRegisteredForAccessory:v8 service:v9 characteristic:@"0x000000003600006A"];
...
- (float)originX
{
  v2 = [(CAFOverlayView *)self originXCharacteristic];
  [v2 floatValue];
  v4 = v3;
...
- (CAFFloatCharacteristic)originYCharacteristic
{
  ...
  v8 = [objc_opt_class() accessoryIdentifier];
  v9 = [objc_opt_class() serviceIdentifier];
  [v6 validateRegisteredForAccessory:v8 service:v9 characteristic:@"0x000000003600006B"];
...
- (float)originY
{
  v2 = [(CAFOverlayView *)self originYCharacteristic];
  [v2 floatValue];
  v4 = v3;
...
- (CAFFloatCharacteristic)widthCharacteristic
{
  ...
  v8 = [objc_opt_class() accessoryIdentifier];
  v9 = [objc_opt_class() serviceIdentifier];
  [v6 validateRegisteredForAccessory:v8 service:v9 characteristic:@"0x000000003600006C"];
...
- (float)width
{
  v2 = [(CAFOverlayView *)self widthCharacteristic];
  [v2 floatValue];
  v4 = v3;
...
- (CAFFloatCharacteristic)heightCharacteristic
{
  ...
  v8 = [objc_opt_class() accessoryIdentifier];
  v9 = [objc_opt_class() serviceIdentifier];
  [v6 validateRegisteredForAccessory:v8 service:v9 characteristic:@"0x000000003600006D"];
...
- (float)height
{
  v2 = [(CAFOverlayView *)self heightCharacteristic];
  [v2 floatValue];
  v4 = v3;
...
- (BOOL)registeredForOriginX
{
  ...
  v8 = [objc_opt_class() accessoryIdentifier];
  v9 = [objc_opt_class() serviceIdentifier];
  v10 = [v6 hasAccessory:v8 service:v9 characteristic:@"0x000000003600006A"];
...
- (BOOL)registeredForOriginY
{
  ...
  v8 = [objc_opt_class() accessoryIdentifier];
  v9 = [objc_opt_class() serviceIdentifier];
  v10 = [v6 hasAccessory:v8 service:v9 characteristic:@"0x000000003600006B"];
...
- (BOOL)registeredForWidth
{
  ...
  v8 = [objc_opt_class() accessoryIdentifier];
  v9 = [objc_opt_class() serviceIdentifier];
  v10 = [v6 hasAccessory:v8 service:v9 characteristic:@"0x000000003600006C"];
...
- (BOOL)registeredForHeight
{
  ...
  v8 = [objc_opt_class() accessoryIdentifier];
  v9 = [objc_opt_class() serviceIdentifier];
  v10 = [v6 hasAccessory:v8 service:v9 characteristic:@"0x000000003600006D"];
