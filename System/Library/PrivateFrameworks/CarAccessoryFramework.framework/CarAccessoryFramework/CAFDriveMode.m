...
{
  v2.receiver = a1;
  v2.super_class = &OBJC_METACLASS___CAFDriveMode;
...
{
  v4 = a3;
  if ([v4 conformsToProtocol:&unk_2846A75B8])
  {
    v5 = v4;
  }
...
- (BOOL)hidden
{
  v2 = [(CAFDriveMode *)self hiddenCharacteristic];
  v3 = [v2 BOOLValue];
