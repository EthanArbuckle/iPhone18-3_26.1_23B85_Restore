...
- (NSArray)arrayRepresentation
{
  ...
  v15 = 0u;
  coordinates = [(CAFCoordinates *)self coordinates];
  v5 = [coordinates countByEnumeratingWithState:&v12 objects:v16 count:16];
  if (v5)
  {
    v6 = v5;
    v7 = *v13;
    do
    {
      ...
      v6 = [coordinates countByEnumeratingWithState:&v12 objects:v16 count:16];
    }
...
void __32__CAFCoordinates_initWithArray___block_invoke_cold_1(uint64_t *a1, uint64_t a2, os_log_t log)
{
  ...
  v7 = 2114;
  v8 = a2;
  _os_log_error_impl(&dword_231618000, log, OS_LOG_TYPE_ERROR, "%{public}@: Error parsing dictionary from Coordinates array - %{public}@", &v5, 0x16u);
