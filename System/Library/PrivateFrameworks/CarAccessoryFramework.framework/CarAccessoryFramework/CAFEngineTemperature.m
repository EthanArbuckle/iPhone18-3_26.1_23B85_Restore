...
- (NSMeasurement)temperature
{
  v2 = [(CAFEngineTemperature *)self temperatureCharacteristic];
...
- (CAFMeasurementRange)temperatureMeasurementRange
{
  v3 = [(CAFEngineTemperature *)self temperatureRange];
  v4 = [(CAFEngineTemperature *)self temperature];
  v5 = [v4 unit];
...
- (unsigned)temperatureState
{
  v2 = [(CAFEngineTemperature *)self temperatureStateCharacteristic];
...
- (NSMeasurement)temperatureMin
{
  v2 = [(CAFEngineTemperature *)self temperatureMinCharacteristic];
  v3 = [v2 measurementValue];
...
- (CAFMeasurementRange)temperatureMinMeasurementRange
{
  v3 = [(CAFEngineTemperature *)self temperatureMinRange];
  v4 = [(CAFEngineTemperature *)self temperatureMin];
  v5 = [v4 unit];
  v6 = [v3 measurementRangeWithUnit:v5];
...
- (NSMeasurement)temperatureMax
{
  v2 = [(CAFEngineTemperature *)self temperatureMaxCharacteristic];
  v3 = [v2 measurementValue];
...
- (CAFMeasurementRange)temperatureMaxMeasurementRange
{
  v3 = [(CAFEngineTemperature *)self temperatureMaxRange];
  v4 = [(CAFEngineTemperature *)self temperatureMax];
  v5 = [v4 unit];
  v6 = [v3 measurementRangeWithUnit:v5];
...
- (NSMeasurement)temperatureMarkerCold
{
  v2 = [(CAFEngineTemperature *)self temperatureMarkerColdCharacteristic];
  v3 = [v2 measurementValue];
...
- (CAFMeasurementRange)temperatureMarkerColdMeasurementRange
{
  v3 = [(CAFEngineTemperature *)self temperatureMarkerColdRange];
  v4 = [(CAFEngineTemperature *)self temperatureMarkerCold];
  v5 = [v4 unit];
  v6 = [v3 measurementRangeWithUnit:v5];
...
- (NSMeasurement)temperatureMarkerHot
{
  v2 = [(CAFEngineTemperature *)self temperatureMarkerHotCharacteristic];
  v3 = [v2 measurementValue];
...
- (CAFMeasurementRange)temperatureMarkerHotMeasurementRange
{
  v3 = [(CAFEngineTemperature *)self temperatureMarkerHotRange];
  v4 = [(CAFEngineTemperature *)self temperatureMarkerHot];
  v5 = [v4 unit];
  v6 = [v3 measurementRangeWithUnit:v5];
