...
+ (id)supportedColorsWithArray:(id)a3;
+ (id)supportedColorsWithSupportedColors:(id)a3;
- (CAFSupportedColors)initWithArray:(id)a3;
- (CAFSupportedColors)initWithSupportedColors:(id)a3;
...
{
  v4 = a3;
  v5 = [[a1 alloc] initWithSupportedColors:v4];
...
- (CAFSupportedColors)initWithSupportedColors:(id)a3
{
  ...
  if (v6)
  {
    objc_storeStrong(&v6->_supportedColors, a3);
  }
...
- (NSString)formattedValue
{
  v3 = [(CAFSupportedColors *)self supportedColors];
  if ([v3 count])
  {
    v4 = MEMORY[0x277CCACA8];
    v5 = [(CAFSupportedColors *)self supportedColors];
...
- (NSArray)arrayRepresentation
{
  ...
  v14 = 0u;
  v15 = 0u;
  v4 = [(CAFSupportedColors *)self supportedColors];
...
- (unint64_t)countByEnumeratingWithState:(id *)a3 objects:(id *)a4 count:(unint64_t)a5
{
  v8 = [(CAFSupportedColors *)self supportedColors];
