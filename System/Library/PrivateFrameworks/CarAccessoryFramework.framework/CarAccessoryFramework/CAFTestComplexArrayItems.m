...
{
  v4 = a3;
  v5 = [[a1 alloc] initWithTestComplexArrayItems:v4];
...
- (CAFTestComplexArrayItems)initWithTestComplexArrayItems:(id)a3
{
  ...
  if (v6)
  {
    objc_storeStrong(&v6->_testComplexArrayItems, a3);
  }
...
- (NSString)formattedValue
{
  v3 = [(CAFTestComplexArrayItems *)self testComplexArrayItems];
  if ([v3 count])
  {
    v4 = MEMORY[0x277CCACA8];
    v5 = [(CAFTestComplexArrayItems *)self testComplexArrayItems];
...
- (NSArray)arrayRepresentation
{
  ...
  v14 = 0u;
  v15 = 0u;
  v4 = [(CAFTestComplexArrayItems *)self testComplexArrayItems];
...
- (unint64_t)countByEnumeratingWithState:(id *)a3 objects:(id *)a4 count:(unint64_t)a5
{
  v8 = [(CAFTestComplexArrayItems *)self testComplexArrayItems];
