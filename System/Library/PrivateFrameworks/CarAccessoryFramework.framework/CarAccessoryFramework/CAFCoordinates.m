...
+ (id)coordinatesWithArray:(id)a3;
+ (id)coordinatesWithCoordinates:(id)a3;
- (CAFCoordinates)initWithArray:(id)a3;
- (CAFCoordinates)initWithCoordinates:(id)a3;
...
{
  v4 = a3;
  v5 = [[a1 alloc] initWithCoordinates:v4];
...
- (CAFCoordinates)initWithCoordinates:(id)a3
{
  ...
  if (v6)
  {
    objc_storeStrong(&v6->_coordinates, a3);
  }
...
- (NSString)formattedValue
{
  v3 = [(CAFCoordinates *)self coordinates];
  if ([v3 count])
  {
    v4 = MEMORY[0x277CCACA8];
    v5 = [(CAFCoordinates *)self coordinates];
...
- (NSArray)arrayRepresentation
{
  ...
  v14 = 0u;
  v15 = 0u;
  v4 = [(CAFCoordinates *)self coordinates];
...
- (unint64_t)countByEnumeratingWithState:(id *)a3 objects:(id *)a4 count:(unint64_t)a5
{
  v8 = [(CAFCoordinates *)self coordinates];
