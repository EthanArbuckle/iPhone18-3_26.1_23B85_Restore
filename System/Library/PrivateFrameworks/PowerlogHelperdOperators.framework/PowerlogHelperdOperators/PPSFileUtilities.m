    ...
    else
    {
      ...
      if (!v9)
      {
        if (os_log_type_enabled(v10, OS_LOG_TYPE_DEBUG))
        {
          ...
          *&v24[12] = 2112;
          *&v24[14] = v23;
          _os_log_debug_impl(&dword_25EE51000, v11, OS_LOG_TYPE_DEBUG, "Marked file '%@' as purgeable with label: '%@'", v24, 0x16u);
        }
...
LABEL_16:
        _os_log_error_impl(&dword_25EE51000, v11, OS_LOG_TYPE_ERROR, v16, v24, 0x26u);
      }
    }
...
void __33__PPSFileUtilities_containerPath__block_invoke_cold_1(uint64_t *a1)
{
  ...
  v3 = 134217984;
  v4 = v1;
  _os_log_error_impl(&dword_25EE51000, MEMORY[0x277D86220], OS_LOG_TYPE_ERROR, "Error fetching group container systemgroup.com.apple.powerlog : %llu", &v3, 0xCu);
