    ...
    *host_info64_out = 0u;
    ...
    else
    {
      ...
      else
      {
        ...
        [_sumMemoryAtEachPriority setObject:_freeBytes forKeyedSubscript:&unk_2871454A8];

        v11 = [MEMORY[0x277CCABB0] numberWithUnsignedLongLong:_wiredBytes];
        [_sumMemoryAtEachPriority setObject:v11 forKeyedSubscript:&unk_2871454C0];
      }
    }
