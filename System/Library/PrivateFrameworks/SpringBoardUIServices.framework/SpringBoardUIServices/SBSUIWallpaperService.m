...
+ (id)_setupAndActivateServiceClientConnection
{
  ...
  v4 = +[SBSUIWallpaperServiceInterfaceSpecification identifier];
...
{
  v3 = a2;
  v4 = +[SBSUIWallpaperServiceInterfaceSpecification interface];
  [v3 setInterface:v4];
...
void __65__SBSUIWallpaperService__setupAndActivateServiceClientConnection__block_invoke_2(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_DEFAULT))
  {
    ...
    v8 = 2114;
    v9 = v2;
    _os_log_impl(&dword_1A9A79000, v5, OS_LOG_TYPE_DEFAULT, "%{public}@ Received invalidation for connection: %{public}@", &v6, 0x16u);
  }
}
