...
- (void)_handleTimePassed
{
  ...
  v3 = [(SBUIPreciseClockTimer *)self _nowWithAnimationLead];
  v16 = 0uLL;
  v14 = 0;
  v15 = 0;
  [(NSCalendar *)self->_calendar getHour:&v16 + 8 minute:&v16 second:&v15 nanosecond:&v14 fromDate:v3];
...
- (SBUIPreciseClockTimer)init
{
  ...
  if (v2)
  {
    ...
    *(v2 + 2) = v3;
    ...
    v5 = [MEMORY[0x1E695DEE8] autoupdatingCurrentCalendar];
    v6 = *(v2 + 4);
    *(v2 + 4) = v5;
