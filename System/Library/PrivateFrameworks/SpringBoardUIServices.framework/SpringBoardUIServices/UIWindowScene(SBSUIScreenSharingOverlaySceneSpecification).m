...
- (void)SBSUI_preferredSystemRootLayerTransform
{
  ...
  [v4 handleFailureInMethod:a1 object:a2 file:@"SBSUIScreenSharingOverlaySceneSpecification.m" lineNumber:54 description:{@"*** SBSUI_preferredSystemRootLayerTransform is unavailable for this window scene. If this message surprises you, contact your friendly SBSUI engineer. ***"}];
}
