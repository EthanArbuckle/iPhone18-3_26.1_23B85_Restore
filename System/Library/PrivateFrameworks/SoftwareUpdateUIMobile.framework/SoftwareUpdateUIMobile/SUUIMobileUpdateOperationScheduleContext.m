...
- (SUUIMobileUpdateOperationScheduleContext)initWithUnattendedPurge:(BOOL)a3 andAgreementStatusRegistry:(id)a4;
@end
...
- (SUUIMobileUpdateOperationScheduleContext)initWithUnattendedPurge:(BOOL)a3 andAgreementStatusRegistry:(id)a4
{
  ...
  v7 = [(SUUIUpdateOperationScheduleContext *)&v8 initWithUnattendedPurge:v10];
  v12 = v7;
