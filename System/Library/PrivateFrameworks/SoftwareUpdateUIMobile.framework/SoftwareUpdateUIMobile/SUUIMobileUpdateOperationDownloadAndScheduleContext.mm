...
- (SUUIMobileUpdateOperationDownloadAndScheduleContext)initWithUnattendedPurge:(BOOL)purge andAgreementStatusRegistry:(id)registry;
@end
...
- (SUUIMobileUpdateOperationDownloadAndScheduleContext)initWithUnattendedPurge:(BOOL)purge andAgreementStatusRegistry:(id)registry
{
  ...
  v7 = [(SUUIUpdateOperationDownloadAndScheduleContext *)&v8 initWithUnattendedPurge:purgeCopy];
  selfCopy = v7;
