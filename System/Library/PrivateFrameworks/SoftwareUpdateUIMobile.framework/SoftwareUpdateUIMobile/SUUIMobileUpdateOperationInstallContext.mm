...
- (SUUIMobileUpdateOperationInstallContext)initWithUnattendedPurge:(BOOL)purge andAgreementStatusRegistry:(id)registry;
@end
...
- (SUUIMobileUpdateOperationInstallContext)initWithUnattendedPurge:(BOOL)purge andAgreementStatusRegistry:(id)registry
{
  ...
  v7 = [(SUUIUpdateOperationInstallContext *)&v8 initWithUnattendedPurge:purgeCopy];
  selfCopy = v7;
