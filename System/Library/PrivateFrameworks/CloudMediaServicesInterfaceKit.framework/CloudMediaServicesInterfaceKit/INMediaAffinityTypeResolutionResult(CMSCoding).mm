...
+ (id)instanceFromCMSCoded:()CMSCoding
{
  ...
  if (!v5)
  {
    ...
    if (v10)
    {
      ...
      unsupported = [MEMORY[0x277CD3DA0] confirmationRequiredWithMediaAffinityTypeToConfirm:v13];
    }
    ...
    else
    {
      ...
      if (v15)
      {
        unsupported = [MEMORY[0x277CD3DA0] unsupported];
      }
      ...
      else
      {
        ...
        if (v16)
        {
          unsupported = [MEMORY[0x277CD3DA0] needsValue];
        }
...
LABEL_14:
          ...
          unsupported = [MEMORY[0x277CD3DA0] notRequired];
        }
      }
    }
  ...
  v9 = [MEMORY[0x277CD3DA0] successWithResolvedMediaAffinityType:v8];
LABEL_15:
