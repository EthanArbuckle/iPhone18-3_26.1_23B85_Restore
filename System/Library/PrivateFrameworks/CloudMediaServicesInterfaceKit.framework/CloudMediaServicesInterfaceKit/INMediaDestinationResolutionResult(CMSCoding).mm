...
+ (id)instanceFromCMSCoded:()CMSCoding
{
  ...
  if (!v5 || ([v4 cmsOptionalDecodedClass:objc_opt_class() forKey:@"resolvedMediaDestination"], (v6 = objc_claimAutoreleasedReturnValue()) == 0))
  {
    ...
    if (v7)
    {
      ...
      {
        v10 = v9;
        unsupported = [MEMORY[0x277CD3DB0] disambiguationWithMediaDestinationsToDisambiguate:v9];
LABEL_18:
        v8 = unsupported;
        goto LABEL_19;
      }
    ...
    else
    {
      ...
      if (v14)
      {
        unsupported = [MEMORY[0x277CD3DB0] unsupported];
        goto LABEL_18;
      }
      ...
      if (v15)
      {
        unsupported = [MEMORY[0x277CD3DB0] needsValue];
        goto LABEL_18;
      }
      ...
      if (v8)
      {
        unsupported = [MEMORY[0x277CD3DB0] notRequired];
        goto LABEL_18;
      }
    }
