...
+ (id)instanceFromCMSCoded:()CMSCoding
{
  ...
  if (!v5)
  {
    ...
    if (v10)
    {
      ...
      v14 = [MEMORY[0x277CD3DA0] confirmationRequiredWithMediaAffinityTypeToConfirm:v13];
    }
    ...
    else
    {
      ...
      if (v15)
      {
        v14 = [MEMORY[0x277CD3DA0] unsupported];
      }
      ...
      else
      {
        ...
        if (v16)
        {
          v14 = [MEMORY[0x277CD3DA0] needsValue];
        }
...
LABEL_14:
          ...
          v14 = [MEMORY[0x277CD3DA0] notRequired];
        }
      }
    }
