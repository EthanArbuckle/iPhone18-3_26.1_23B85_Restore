...
LABEL_12:
  ...
  if (([v3 isEqualToString:@"com.apple.shortcuts.dataRoamingDestination"] & 1) != 0 || (objc_msgSend(v3, "isEqualToString:", @"com.apple.shortcuts.defaultLineDestination") & 1) != 0 || (objc_msgSend(v3, "isEqualToString:", @"com.apple.shortcuts.toggleCellularLineDestination") & 1) != 0 || objc_msgSend(v3, "isEqualToString:", @"com.apple.shortcuts.cellularDataStatisticsDestination"))
  {
LABEL_18:
    v4 = MEMORY[0x277D79E20];
    v5 = 3;
