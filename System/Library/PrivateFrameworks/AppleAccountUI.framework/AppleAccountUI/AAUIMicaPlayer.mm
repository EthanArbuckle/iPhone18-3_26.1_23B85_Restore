...
LABEL_6:
  ...
  v10 = v9;
  [v9 setGeometryFlipped:{+[AAUIMicaPlayer BOOLFromDictionary:key:defaultValue:](AAUIMicaPlayer, "BOOLFromDictionary:key:defaultValue:", v8, @"geometryFlipped", 0) ^ 1}];
...
- (void)notifyDelegateDidStartPlaying
{
  ...
  if (WeakRetained)
  {
    ...
    if (v6)
    {
      ...
      [v7 AAUIMicaPlayerDidStartPlaying:self];
    }
  }
}
...
- (void)notifyDelegateDidStopPlaying
{
  ...
  if (WeakRetained)
  {
    ...
    {
      v7 = objc_loadWeakRetained(&self->_delegate);
      [v7 AAUIMicaPlayerDidStopPlaying:self];
    }
  }
}
...
- (void)notifyDelegateDidChangePlaybackTime
{
  ...
  if (WeakRetained)
  {
    ...
    {
      v7 = objc_loadWeakRetained(&self->_delegate);
      [v7 AAUIMicaPlayerDidChangePlaybackTime:self];
    }
  }
}
