...
- (id)symbolImageForFont:()MUAmenityItemViewModel
{
  ...
  if (!v4 || (v5 = MEMORY[0x1E69DCAB8], [a1 symbolName], v6 = objc_claimAutoreleasedReturnValue(), objc_msgSend(v5, "_mapsui_resolvedSymbolImageNamed:withConfiguration:", v6, v2), v7 = objc_claimAutoreleasedReturnValue(), v6, !v7))
  {
