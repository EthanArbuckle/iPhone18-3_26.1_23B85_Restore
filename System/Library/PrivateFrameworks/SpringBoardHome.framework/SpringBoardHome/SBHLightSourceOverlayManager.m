...
- (SBHLightSourceOverlayManager)initWithWindowScene:(id)a3;
- (void)invalidate;
- (void)noteLightAngleDidUpdate;
- (void)updateOverlay;
- (void)updateTimerDidFire:(id)a3;
@end
...
- (SBHLightSourceOverlayManager)initWithWindowScene:(id)a3
{
  ...
  if (v5)
  {
    ...
    v29 = [(UILabel *)v5->_label topAnchor];
    v15 = [(UIWindow *)v5->_overlayWindow topAnchor];
    v16 = [v29 constraintEqualToAnchor:v15 constant:40.0];
    v32[0] = v16;
    v17 = [(UILabel *)v5->_label leadingAnchor];
    v18 = [(UIWindow *)v5->_overlayWindow leadingAnchor];
    v19 = [v17 constraintEqualToAnchor:v18 constant:8.0];
    v32[1] = v19;
    v20 = [(UILabel *)v5->_label trailingAnchor];
    v21 = [(UIWindow *)v5->_overlayWindow trailingAnchor];
    ...
    [v26 addTimer:v5->_updateTimer forMode:*MEMORY[0x1E695DA28]];
...
- (void)updateTimerDidFire:(id)a3
{
  v4 = [(SBHLightSourceOverlayManager *)self batchUpdateCount];
  [(SBHLightSourceOverlayManager *)self setBatchUpdateCount:0];
  [(SBHLightSourceOverlayManager *)self setLastBatchUpdateCount:v4];
...
- (void)updateOverlay
{
  ...
  v3 = [v41 layerCount];
  v4 = [v41 observerCount];
  v5 = [v41 currentActivityLevel];
  v6 = [(SBHLightSourceOverlayManager *)self lastBatchUpdateCount];
  [v41 lastLightAngle];
  v40 = v7;
  ...
  v32 = [objc_alloc(MEMORY[0x1E696AEC0]) initWithFormat:@"%lu layers\n%lu observers\nActivity level: %li\nUpdate rate: %lu㎐\nAngle: %.1fº\nDirection: (%.2f, %.2f, %.2f)\nIntensity: %.2f\nInitial direction: (%.2f, %.2f, %.2f)\nDistance: %.2f (accum: %.2f, thres: %.2f)\nVelocity: %.2f", v3, v4, v5, v6, v40 / 0.0174532925, *&v9, *&v11, *&v13, v39, *&v38, *&v37, *&v20, *&v35, v34, v36, SBH3DPointVelocityMagnitude(v24, v26, v28, v9, v11, v13, v30 - v31)];
  v33 = [(SBHLightSourceOverlayManager *)self label];
  [v33 setText:v32];
}

- (void)invalidate
{
  v3 = [(SBHLightSourceOverlayManager *)self updateTimer];
  [v3 invalidate];

  v4 = [(SBHLightSourceOverlayManager *)self overlayWindow];
  [v4 setHidden:1];
}
