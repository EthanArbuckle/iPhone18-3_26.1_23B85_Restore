...
- (SBIconDragUndoLayoutDelegatePreModificationInfo)initWithRootFolderController:(id)controller;
@end
...
- (SBIconDragUndoLayoutDelegatePreModificationInfo)initWithRootFolderController:(id)controller
{
  ...
  if (v6)
  {
    ...
    v31 = v6;
    v32 = controllerCopy;
    visibleIconListViews = [controllerCopy visibleIconListViews];
    ...
    if (v36)
    {
      ...
      do
      {
        ...
        do
        {
          ...
          v11 = *(*(&v43 + 1) + 8 * v10);
          icons = [v11 icons];
          [(NSMapTable *)strongToStrongObjectsMapTable setObject:icons forKey:v11];
          v41 = 0u;
          v42 = 0u;
          v39 = 0u;
          v40 = 0u;
            ...
            do
            {
              for (i = 0; i != v15; ++i)
              {
                ...
                if (v19)
                {
                  ...
                  [(NSMapTable *)strongToStrongObjectsMapTable2 setObject:v23 forKey:v18];
                }
              }
