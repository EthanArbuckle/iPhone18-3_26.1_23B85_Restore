...
+ (SBIcon)defaultIcon;
- (BOOL)containsImage:(id)a3;
- (BOOL)hasAnyImagesForIcon:(id)a3;
- (id)copyWithZone:(_NSZone *)a3;
- (id)imageEnumeratorForIcon:(id)a3;
...
- (void)removeImageForIconIdentifier:(id)a3 appearance:(id)a4;
...
{
  v6 = a3;
  v7 = [a4 sbh_iconImageAppearance];
  v8 = [(SBHIconImageAppearanceStore *)self imageForIcon:v6 appearance:v7];
...
- (id)imageForIcon:(id)a3 appearance:(id)a4
{
  ...
  if (SBHIconImageAppearanceTypeHasTintColor([v6 appearanceType]))
  {
    [(SBHIconImageAppearanceStore *)v9 imageForIcon:v6 appearance:&v11];
    v9 = v11;
  }
...
- (id)imageForIcon:(id)a3 appearanceType:(int64_t)a4
{
  v6 = [(SBHIconImageAppearanceStore *)self _cacheKeyForIcon:a3];
  v7 = [(SBHIconImageAppearanceStore *)self imagesForAppearanceType:a4 createIfNecessary:0];
  v8 = [v7 objectForKey:v6];
  if (SBHIconImageAppearanceTypeHasTintColor(a4))
  {
    if (v8)
    {
      v9 = v8[1];
...
- (void)setImage:(id)a3 forIcon:(id)a4 traitCollection:(id)a5
{
  v8 = a4;
  v9 = a3;
  v10 = [a5 sbh_iconImageAppearance];
...
- (void)setImage:(id)a3 forIcon:(id)a4 appearance:(id)a5
{
  v13 = a3;
  v8 = a5;
  v9 = [(SBHIconImageAppearanceStore *)self _cacheKeyForIcon:a4];
  v10 = [(SBHIconImageAppearanceStore *)self imagesForAppearance:v8 createIfNecessary:1];
  if (SBHIconImageAppearanceTypeHasTintColor([v8 appearanceType]))
  {
    v11 = [[SBHIconImageAppearanceStoreTintedValue alloc] initWithValue:v13 imageAppearance:v8];
  }
...
{
  v6 = a4;
  v8 = [(SBHIconImageAppearanceStore *)self _cacheKeyForIcon:a3];
  v7 = [(SBHIconImageAppearanceStore *)self imagesForAppearance:v6 createIfNecessary:0];
...
{
  v6 = a3;
  v7 = [(SBHIconImageAppearanceStore *)self imagesForAppearance:a4 createIfNecessary:0];
  [v7 removeObjectForKey:v6];
}

- (void)removeAllImagesForIcon:(id)a3
{
  v4 = [(SBHIconImageAppearanceStore *)self _cacheKeyForIcon:a3];
...
- (void)removeAllImagesForAppearance:(id)a3
{
  v3 = [(SBHIconImageAppearanceStore *)self imagesForAppearance:a3 createIfNecessary:0];
  [v3 removeAllObjects];
}
...
{
  v4 = a3;
  v5 = [(SBHIconImageAppearanceStore *)self _cacheKeyForIcon:v4];
  v11 = 0;
  v12 = &v11;
  v13 = 0x2020000000;
  v14 = 0;
...
- (id)imageEnumeratorForIcon:(id)a3
{
  ...
  v8 = v7;
  v9 = v6;
  [(SBHIconImageAppearanceStore *)self enumerateImagesForIcon:v5 usingBlock:&v13];
...
- (id)imagesForTraitCollection:(id)a3 createIfNecessary:(BOOL)a4
{
  ...
  v7 = [(SBHIconImageAppearanceStore *)self imagesForAppearance:v6 createIfNecessary:v4];
...
- (void)enumerateImageCachesUsingBlock:(id)a3
{
  ...
  v13 = 0;
  lightImages = self->_lightImages;
  if (!lightImages || ((*(v4 + 2))(v4, lightImages, 0, &v13), (v13 & 1) == 0))
  {
    darkImages = self->_darkImages;
...
- (unint64_t)numberOfCachedImagesForAppearanceType:(int64_t)a3
{
  v3 = [(SBHIconImageAppearanceStore *)self imagesForAppearanceType:a3 createIfNecessary:0];
  v4 = [v3 count];
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  if (v5)
  {
    v6 = [(NSMutableDictionary *)self->_lightImages mutableCopyWithZone:a3];
    v7 = v5[1];
    v5[1] = v6;

    v8 = [(NSMutableDictionary *)self->_darkImages mutableCopyWithZone:a3];
    v9 = v5[2];
    v5[2] = v8;

    v10 = [(NSMutableDictionary *)self->_clearLightImages mutableCopyWithZone:a3];
    v11 = v5[3];
    v5[3] = v10;

    v12 = [(NSMutableDictionary *)self->_clearDarkImages mutableCopyWithZone:a3];
    v13 = v5[4];
    v5[4] = v12;

    v14 = [(NSMutableDictionary *)self->_tintedLightImages mutableCopyWithZone:a3];
    v15 = v5[5];
    v5[5] = v14;

    v16 = [(NSMutableDictionary *)self->_tintedDarkImages mutableCopyWithZone:a3];
    v17 = v5[6];
    v5[6] = v16;

    v18 = [(NSMutableDictionary *)self->_tintableImages mutableCopyWithZone:a3];
    v19 = v5[7];
    v5[7] = v18;
