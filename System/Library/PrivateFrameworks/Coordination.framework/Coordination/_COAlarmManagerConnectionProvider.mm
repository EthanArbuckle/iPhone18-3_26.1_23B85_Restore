...
- (NSXPCConnection)alarmManagerServiceConnection
{
  ...
  if (!v3)
  {
    if (!selfCopy->_alarmManagerServiceConnection)
    {
      ...
      selfCopy->_alarmManagerServiceConnection = v4;
    }
    ...
    [(NSXPCConnection *)selfCopy->_alarmManagerServiceConnection setInterruptionHandler:v6, v8, v9, v10, v11];
    [(NSXPCConnection *)selfCopy->_alarmManagerServiceConnection setInvalidationHandler:v6];
    v3 = selfCopy->_alarmManagerServiceConnection;
