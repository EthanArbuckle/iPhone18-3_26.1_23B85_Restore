...
- (void)addComplicationCollectionLifecycleObserver:(id)observer;
- (void)checkoutStoreForComplicationCollectionIdentifier:(id)identifier deviceUUID:(id)d withHandler:(id)handler;
- (void)removeComplicationCollectionLifecycleObserver:(id)observer;
@end
...
- (void)addComplicationCollectionLifecycleObserver:(id)observer
{
  ...
  v3 = observerCopy;
  [(NTKDComplicationStoreCoordinator *)selfCopy _onQueue_async:v4];
}
