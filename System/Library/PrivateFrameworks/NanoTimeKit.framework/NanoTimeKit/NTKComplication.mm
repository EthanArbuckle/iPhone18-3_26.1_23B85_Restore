...
+ (id)timerComplicationWithDuration:(double)a3;
...
- (id)ntk_localizedNameWithOptions:(unint64_t)a3 forRichComplicationSlot:(BOOL)a4
{
  ...
  if ((v4 & 2) != 0)
  {
    ...
    if ((v10 & 1) == 0)
    {
      ...
      v12 = [MEMORY[0x277CCACA8] stringWithFormat:v11, v7, v6];
...
- (id)localizedSectionHeaderName
{
  ...
  {
    v4 = [(NTKComplication *)v2 complication];
  ...
  if (objc_opt_isKindOfClass())
  {
    ...
    v12 = [(NTKComplication *)v9 descriptor];

    v13 = [v11 infoForDescriptor:v12];

    v7 = [v13 localizedAppName];
  ...
  if (objc_opt_isKindOfClass())
  {
    ...
    v14 = [(NTKComplication *)v2 clientIdentifier];
    v7 = [v5 localizedAppNameForClientIdentifier:v14];
  ...
  {
    v17 = [(NTKComplication *)v2 ntk_sectionIdentifier];
    v18 = [v17 isEqualToString:@"com.apple.NanoWorldClock"];
    ...
    v19 = [(NTKComplication *)v2 ntk_sectionIdentifier];
    v20 = [v19 isEqualToString:@"com.apple.SafetyMonitorApp"];
    ...
    else
    {
      ...
      {
        v24 = [NTKCompanion1stPartyApp appForBundleIdentifier:v5];
        v25 = v24;
        if (v24)
        {
          v26 = [v24 name];
        ...
        else
        {
          ...
          v28 = [v27 localizedAppNameForBundleIdentifier:v5];
          ...
          if (v30)
          {
            ...
            while (2)
            {
              for (i = 0; i != v31; ++i)
              {
                ...
                v34 = *(*(&v38 + 1) + 8 * i);
                v35 = [v34 watchApplicationIdentifier];
                v36 = [v35 isEqual:v5];
          ...
          v26 = NTKComplicationTypeLocalizedLabelText([(NTKComplication *)v2 complicationType]);
LABEL_59:
        }
    ...
    v7 = NTKClockFaceLocalizedString(v22, v23);
LABEL_9:
  ...
  v16 = @"Alarms";
LABEL_16:
  v7 = NTKCompanionClockFaceLocalizedString(v15, v16);
LABEL_17:
...
+ (id)allComplicationsOfType:(unint64_t)a3
{
  v4 = [a1 _complicationClassForType:?];

  return [v4 _allComplicationConfigurationsWithType:a3];
}
...
+ (id)nullComplication
{
  v2 = [[a1 alloc] initWithComplicationType:0];
...
- (NTKComplication)initWithComplicationType:(unint64_t)a3
{
  ...
  if (v4)
  {
    ...
    v9 = [(NTKComplication *)v5 _generateAppIdentifier];
    appIdentifier = v5->_appIdentifier;
    v5->_appIdentifier = v9;
  }
...
- (id)_generateAppIdentifier
{
  v3 = [(NTKComplication *)self complicationType];
  if (v3 > 37)
  {
    if ((v3 - 38) >= 4)
    {
...
LABEL_18:
      ...
      v7 = NTKComplicationTypesToBundleIDMappingForDevice(v6);
...
+ (id)_allComplicationConfigurationsWithType:(unint64_t)a3
{
  ...
  v3 = [[a1 alloc] initWithComplicationType:a3];
  v6[0] = v3;
...
- (id)customDailySnapshotKeyForFamily:(int64_t)a3 device:(id)a4
{
  ...
  v5 = [v4 supportsPDRCapability:710010803];
...
- (BOOL)snapshotContext:(id)a3 isStaleRelativeToContext:(id)a4
{
  ...
  {
    v7 = [v5 buildVersionMatchesContext:v6] ^ 1;
  }
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (objc_opt_isKindOfClass())
  {
    v5 = [(NSString *)self->_uniqueIdentifier isEqual:v4[1]];
  }
...
- (id)JSONObjectRepresentation
{
  ...
  if (objc_opt_isKindOfClass())
  {
    v3 = [(NTKComplication *)self complication];
    v4 = [v3 JSONObjectRepresentation];
...
LABEL_10:
  ...
  [(NTKComplication *)self _addKeysToJSONDictionary:v4];
LABEL_12:
...
+ (NTKComplication)complicationWithJSONObjectRepresentation:(id)a3
{
  ...
  {
    [MEMORY[0x277CBEAD8] raise:@"NTKFaceBundleException" format:{@"object must be dictionary - invalid value: %@", v4}];
  }

  v5 = [v4 objectForKeyedSubscript:@"bundle identifier"];
  v6 = [v4 objectForKeyedSubscript:@"bundle app identifier"];
  objc_opt_class();
  if (objc_opt_isKindOfClass() & 1) != 0 && (!v6 || (objc_opt_class(), (objc_opt_isKindOfClass())))
  {
    v7 = [v4 objectForKeyedSubscript:@"bundle app complication descriptor"];
  ...
  else
  {
    ...
    if (!NTKFaceBundleGetComplicationTypeFromString(v9, &v21))
    {
      ...
      if (v10)
      {
        ...
        {
          [MEMORY[0x277CBEAD8] raise:@"NTKFaceBundleException" format:{@"Disallowed complication type encoded: %lu", v11}];
        }
      }
    ...
    v14 = [a1 _complicationClassForType:v21];
    if (v14 != objc_opt_class() || ([NTKBundleComplication _revertedBundleComplicationFromJSONDictionary:v4], (v16 = objc_claimAutoreleasedReturnValue()) == 0))
    {
      v15 = [v14 alloc];
      v16 = [v15 _initWithComplicationType:v21 JSONDictionary:v4];
    }
...
- (NTKComplication)initWithCoder:(id)a3
{
  ...
  if (v5)
  {
    v6 = [v4 decodeIntegerForKey:@"ComplicationEncodingVersionKey"];
    v7 = [v4 decodeIntegerForKey:@"ComplicationTypeKey"];
    v8 = v7;
    if (v6 < 2)
    {
    ...
    v15 = [(NTKComplication *)v5 _generateAppIdentifier];
    appIdentifier = v5->_appIdentifier;
    v5->_appIdentifier = v15;
  }
...
- (id)awakeAfterUsingCoder:(id)a3
{
  ...
  if (v3->_complicationType == 9)
  {
    ...
    v6 = [MEMORY[0x277CBBAE8] currentDevice];
    v4 = [NTKRemoteComplication _remoteStocksComplicationWithIdentifier:v5 forDevice:v6];
  }
...
- (id)_migrateToFamily:(int64_t)a3 withAllowedComplications:(id)a4
{
  ...
  v6 = [(NTKComplication *)self complicationType];
  if (v6 == 16)
  {
    if (a3 != 11)
    {
