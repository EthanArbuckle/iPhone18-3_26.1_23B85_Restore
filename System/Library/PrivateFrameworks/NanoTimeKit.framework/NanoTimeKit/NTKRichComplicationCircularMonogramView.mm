...
- (void)setComplicationTemplate:(id)template reason:(int64_t)reason
{
  ...
  _labelFont = [(NTKRichComplicationCircularMonogramView *)self _labelFont];
...
- (id)_labelFont
{
  ...
  v4 = ___LayoutConstants_block_invoke_63(device, device);
  v6 = v5;
  v8 = v7;
...
- (id)_createLabelViewWithFont:(id)font
{
  ...
  device = [(CDRichComplicationView *)self device];
  ___LayoutConstants_block_invoke_63(device, device);
  [v5 setMaxWidth:v7];
