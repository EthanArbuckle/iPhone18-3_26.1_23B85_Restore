...
id ___MediumFontForDynamicSize_block_invoke(uint64_t a1, void *a2)
{
  v2 = a2;
  ...
  if (!v3 || (v4 = [v2 version], v4 != _block_invoke_11___previousCLKDeviceVersion))
  {
    ...
    v5 = ___MediumFontForDynamicSize_block_invoke_2(_block_invoke_11___previousCLKDeviceVersion, v2);
    v6 = _block_invoke_11_value;
    _block_invoke_11_value = v5;
  }

  v7 = _block_invoke_11_value;
  os_unfair_lock_unlock(&_block_invoke_11_lock);

  return v7;
}

id ___MediumFontForDynamicSize_block_invoke_2(uint64_t a1, void *a2)
{
  v10[3] = *MEMORY[0x277D85DE8];
  v8 = 0;
  memset(v7, 0, sizeof(v7));
  ___LayoutConstantsMedium_block_invoke(a2, v7);
  v9[0] = &unk_284185680;
  v2 = _MakeFont(0);
  v10[0] = v2;
  v9[1] = &unk_284185608;
