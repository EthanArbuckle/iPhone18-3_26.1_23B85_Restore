...
+ (NTKPhotoAnalysis)analysisWithImage:(id)image alignment:(unint64_t)alignment deviceSizeClass:(unint64_t)class;
+ (id)defaultAnalysis;
+ (id)invalidAnalysis;
- ($BBBA91DF173D22D92F8479248DC92AE7)structure;
- (NTKPhotoAnalysis)initWithCoder:(id)coder;
- (NTKPhotoAnalysis)initWithStructure:(id *)structure;
...
+ (BOOL)_dictionaryHasValidValues:(id)values
{
  ...
  v4 = [MEMORY[0x277CBEA60] arrayWithObjects:v22 count:11];
  v5 = [MEMORY[0x277CCABB0] numberWithFloat:0.0];
  LODWORD(v6) = 1.0;
...
- (NTKPhotoAnalysis)initWithCoder:(id)coder
{
  coderCopy = coder;
  v17.receiver = self;
  v17.super_class = NTKPhotoAnalysis;
  v5 = [(NTKPhotoAnalysis *)&v17 init];
...
- (id)initFromDictionary:(id)dictionary
{
  dictionaryCopy = dictionary;
  v28.receiver = self;
  v28.super_class = NTKPhotoAnalysis;
  v5 = [(NTKPhotoAnalysis *)&v28 init];
...
{
  v10.receiver = self;
  v10.super_class = NTKPhotoAnalysis;
  v4 = [(NTKPhotoAnalysis *)&v10 init];
  v5 = v4;
  if (v4)
  {
    v6 = *&structure->var0;
...
+ (NTKPhotoAnalysis)analysisWithImage:(id)image alignment:(unint64_t)alignment deviceSizeClass:(unint64_t)class
{
  ...
  else
  {
    v12 = Width;
    v13 = Height;
    v14 = dbl_22DCE8E90[v11];
    v15 = dbl_22DCE8EC0[v11];
    v16 = dbl_22DCE8EF0[v11];
    v17 = dbl_22DCE8F20[v11];
    v18 = Width / Height;
    if (v18 > v17 / v16)
    {
      v12 = v17 / v16 * Height;
    ...
    v34.origin.x = 0.0;
    v34.origin.y = 0.0;
    v34.size.width = dbl_22DCE8F20[v11];
    v34.size.height = dbl_22DCE8EF0[v11];
    v35 = CGRectInset(v34, dbl_22DCE8E60[v11], dbl_22DCE8E60[v11]);
    x = v35.origin.x;
    v22 = v35.size.width;
    if (alignment == 1)
    {
    ...
    *&v31[2] = v22;
    *&v31[3] = v14;
    v23 = [MEMORY[0x277CCAE60] valueWithBytes:v31 objCType:{"{CGRect={CGPoint=dd}{CGSize=dd}}", *&v27, *&v29}];
    v32[0] = v23;
    v24 = [MEMORY[0x277CBEA60] arrayWithObjects:v32 count:1];
    invalidAnalysis = NTKAnalyzePhoto(imageCopy, v24, 0, v20, v19, v28, v30, v17, v16);
  }
...
{
  v3 = objc_opt_new();
  [v3 setObject:&unk_284183CA0 forKeyedSubscript:@"version"];
  v4 = [MEMORY[0x277CCABB0] numberWithBool:self->_data.isComplexBackground];
  [v3 setObject:v4 forKeyedSubscript:@"complexBackground"];

  v5 = [MEMORY[0x277CCABB0] numberWithBool:self->_data.isColoredText];
