...
- (NTKFloatCurve)initWithFloatCurveElements:(id)a3
{
  ...
  if (v5)
  {
    v6 = [v4 sortedArrayUsingComparator:&__block_literal_global_109];
...
- (double)floatValueForFraction:(double)a3
{
  if ([(NSArray *)self->_valueCurveElements count])
  {
    ...
    v6 = [(NSArray *)self->_valueCurveElements firstObject];
    v7 = v6;
    if (v5 != 1)
    {
      [v6 fraction];
      ...
      if (v9 >= a3)
      {
        v6 = [(NSArray *)valueCurveElements firstObject];
      }

      else
      {
        v11 = [(NSArray *)valueCurveElements lastObject];
        [v11 fraction];
        v13 = v12;
