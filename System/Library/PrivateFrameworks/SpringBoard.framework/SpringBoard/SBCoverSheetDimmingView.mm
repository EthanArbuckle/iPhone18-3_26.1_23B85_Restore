...
- (SBCoverSheetDimmingView)initWithFrame:(CGRect)frame;
- (void)layoutSubviews;
@end
...
- (SBCoverSheetDimmingView)initWithFrame:(CGRect)frame
{
  ...
  v3 = [(SBCoverSheetDimmingView *)&v9 initWithFrame:frame.origin.x, frame.origin.y, frame.size.width, frame.size.height];
  if (v3)
  {
