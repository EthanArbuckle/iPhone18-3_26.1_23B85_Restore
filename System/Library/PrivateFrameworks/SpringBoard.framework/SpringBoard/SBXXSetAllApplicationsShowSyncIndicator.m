...
void ___SBXXSetAllApplicationsShowSyncIndicator_block_invoke(uint64_t a1)
{
  ...
  if (*(a1 + 48))
  {
    ...
    v10 = 3221225472;
    v11 = ___SBXXSetAllApplicationsShowSyncIndicator_block_invoke_109;
    v12 = &unk_2783A92D8;
    v13 = *(a1 + 32);
    v14 = *(a1 + 40);
    ...
    [SBDaemonHandler addRequest:v2 forKey:*(a1 + 32) forDaemonPid:*(a1 + 52), v9, v10, v11, v12];
  }
  ...
  else
  {
    ...
    [SBDaemonHandler removeRequestForKey:*(a1 + 32) forDaemonPid:*(a1 + 52)];
  }
}
...
void ___SBXXSetAllApplicationsShowSyncIndicator_block_invoke_109(uint64_t a1)
{
  v10 = *MEMORY[0x277D85DE8];
  v2 = SBLogStatusBarish();
  if (os_log_type_enabled(v2, OS_LOG_TYPE_INFO))
