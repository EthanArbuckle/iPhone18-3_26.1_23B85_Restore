...
- (SBTraitsRoleResolvesOrientationInIsolationPolicySpecifier)initWithComponentOrder:(id)a3
{
  ...
  if (v3)
  {
    v5 = [(SBTraitsRoleResolvesOrientationInIsolationPolicySpecifier *)v3 targetRole];
...
- (NSString)targetRole
{
  ...
  [v4 handleFailureInMethod:a2 object:self file:@"SBTraitsOrientationStageComponents.m" lineNumber:541 description:{@"This class[%@] shouldn't be directly used, pick a subclass.", v6}];
  ...
  if (v6)
  {
    ...
    while (2)
    {
      for (i = 0; i != v7; ++i)
      {
        ...
        if (v12)
        {
          v13 = [MEMORY[0x277D734D0] resolutionPolicyInfoIsolation];
