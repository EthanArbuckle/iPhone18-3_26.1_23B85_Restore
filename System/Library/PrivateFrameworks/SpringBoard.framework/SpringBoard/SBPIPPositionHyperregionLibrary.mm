...
- (id)regionWithType:(int64_t)a3 geometry:(SBPIPPositionGeometryContext *)a4
{
  ...
  v80 = *&a4->stashedMinimumPadding.top;
  v81 = v7;
  v82 = *&a4->offscreenCorners;
  v8 = *&a4->edgeInsets.bottom;
  v76 = *&a4->edgeInsets.top;
  v77 = v8;
  v9 = *&a4->minimumPadding.bottom;
  v78 = *&a4->minimumPadding.top;
  v79 = v9;
  ...
  if ((SBPIPPositionGeometryContextIsEqualToContext(&pipCurrentSize, v69) & 1) == 0)
  {
    ...
    *&self->_lastGeometryContext.edgeInsets.top = v23;
    v25 = *&a4->minimumPadding.bottom;
    v26 = *&a4->stashedMinimumPadding.top;
    v27 = *&a4->offscreenCorners;
  ...
  if (!v28)
  {
    if (a3 > 3)
    {
      ...
      {
        case 4:
          v49 = *&a4->stashedMinimumPadding.bottom;
          v80 = *&a4->stashedMinimumPadding.top;
          v81 = v49;
          v82 = *&a4->offscreenCorners;
          v50 = *&a4->edgeInsets.bottom;
          v76 = *&a4->edgeInsets.top;
          v77 = v50;
          v51 = *&a4->minimumPadding.bottom;
          v78 = *&a4->minimumPadding.top;
          v79 = v51;
          v52 = a4->pipAnchorPointOffset;
          pipStashedSize = a4->pipStashedSize;
          v73 = v52;
          v53 = a4->containerBounds.size;
          origin = a4->containerBounds.origin;
          v75 = v53;
          v54 = a4->pipLastSteadySize;
          pipCurrentSize = a4->pipCurrentSize;
          v71 = v54;
        ...
        case 5:
          ...
          goto LABEL_19;
        case 6:
          v37 = *&a4->stashedMinimumPadding.bottom;
          v80 = *&a4->stashedMinimumPadding.top;
          v81 = v37;
          v82 = *&a4->offscreenCorners;
          v38 = *&a4->edgeInsets.bottom;
          v76 = *&a4->edgeInsets.top;
          v77 = v38;
          v39 = *&a4->minimumPadding.bottom;
          v78 = *&a4->minimumPadding.top;
          v79 = v39;
    ...
    else
    {
      ...
      {
        case 1:
          v43 = *&a4->stashedMinimumPadding.bottom;
          v80 = *&a4->stashedMinimumPadding.top;
          v81 = v43;
          v82 = *&a4->offscreenCorners;
          v44 = *&a4->edgeInsets.bottom;
          v76 = *&a4->edgeInsets.top;
          v77 = v44;
          v45 = *&a4->minimumPadding.bottom;
          v78 = *&a4->minimumPadding.top;
          v79 = v45;
          v46 = a4->pipAnchorPointOffset;
          pipStashedSize = a4->pipStashedSize;
          v73 = v46;
          v47 = a4->containerBounds.size;
          origin = a4->containerBounds.origin;
          v75 = v47;
          v48 = a4->pipLastSteadySize;
          pipCurrentSize = a4->pipCurrentSize;
          v71 = v48;
          ...
          goto LABEL_19;
        case 2:
          v55 = *&a4->stashedMinimumPadding.bottom;
          v80 = *&a4->stashedMinimumPadding.top;
          v81 = v55;
          v82 = *&a4->offscreenCorners;
          v56 = *&a4->edgeInsets.bottom;
          v76 = *&a4->edgeInsets.top;
          v77 = v56;
          v57 = *&a4->minimumPadding.bottom;
          v78 = *&a4->minimumPadding.top;
          v79 = v57;
          v58 = a4->pipAnchorPointOffset;
          pipStashedSize = a4->pipStashedSize;
          v73 = v58;
          v59 = a4->containerBounds.size;
          origin = a4->containerBounds.origin;
          v75 = v59;
          v60 = a4->pipLastSteadySize;
          pipCurrentSize = a4->pipCurrentSize;
          v71 = v60;
          ...
          goto LABEL_19;
        case 3:
          v29 = *&a4->stashedMinimumPadding.bottom;
          v80 = *&a4->stashedMinimumPadding.top;
          v81 = v29;
          v82 = *&a4->offscreenCorners;
          v30 = *&a4->edgeInsets.bottom;
          v76 = *&a4->edgeInsets.top;
          v77 = v30;
          v31 = *&a4->minimumPadding.bottom;
          v78 = *&a4->minimumPadding.top;
          v79 = v31;
...
- (id)_lastKnownRegionForType:(int64_t)a3
{
  if ((a3 - 1) <= 5)
  {
    self = *(&self->_lastGeometryContext.orientation + a3);
  }
...
- (id)_cornersRegionWithGeometry:(SBPIPPositionGeometryContext *)a3
{
  ...
  v10 = *&a3->stashedMinimumPadding.bottom;
  v38[10] = *&a3->stashedMinimumPadding.top;
  v38[11] = v10;
  v38[12] = *&a3->offscreenCorners;
  v11 = *&a3->edgeInsets.bottom;
  v38[6] = *&a3->edgeInsets.top;
  v38[7] = v11;
  v12 = *&a3->minimumPadding.bottom;
  v38[8] = *&a3->minimumPadding.top;
  v38[9] = v12;
  ...
  [(SBPIPPositionHyperregionLibrary *)self _insetRectForEdgeInsets:a3->edgeInsets.top pipSize:a3->edgeInsets.left containerBounds:a3->edgeInsets.bottom, a3->edgeInsets.right, a3->pipCurrentSize.width, a3->pipCurrentSize.height, *&a3->containerBounds.origin.x, *&a3->containerBounds.origin.y, *&a3->containerBounds.size.width, *&a3->containerBounds.size.height];
...
- (id)_offscreenCornersRegionWithGeometry:(SBPIPPositionGeometryContext *)a3
{
  ...
  v34 = *&a3->minimumPadding.bottom;
  v7 = *&a3->stashedMinimumPadding.bottom;
  v35 = *&a3->stashedMinimumPadding.top;
  v36 = v7;
  v37 = *&a3->offscreenCorners;
  origin = a3->containerBounds.origin;
  size = a3->containerBounds.size;
  v9 = *&a3->edgeInsets.bottom;
  v31 = *&a3->edgeInsets.top;
  v32 = v9;
  v33 = v6;
...
- (id)_stashedLeftRegionWithGeometry:(SBPIPPositionGeometryContext *)a3
{
  ...
  v6 = *&a3->stashedMinimumPadding.bottom;
  v25[10] = *&a3->stashedMinimumPadding.top;
  v25[11] = v6;
  v25[12] = *&a3->offscreenCorners;
  v7 = *&a3->edgeInsets.bottom;
  v25[6] = *&a3->edgeInsets.top;
  v25[7] = v7;
  v8 = *&a3->minimumPadding.bottom;
  v25[8] = *&a3->minimumPadding.top;
  v25[9] = v8;
  pipAnchorPointOffset = a3->pipAnchorPointOffset;
...
- (id)_containerInsetRegionWithGeometry:(SBPIPPositionGeometryContext *)a3
{
  ...
  v5 = [objc_alloc(MEMORY[0x277D76010]) initWithDimensions:2];
  v6 = *&a3->stashedMinimumPadding.bottom;
  v23[10] = *&a3->stashedMinimumPadding.top;
  v23[11] = v6;
  v23[12] = *&a3->offscreenCorners;
  v7 = *&a3->edgeInsets.bottom;
  v23[6] = *&a3->edgeInsets.top;
  v23[7] = v7;
  v8 = *&a3->minimumPadding.bottom;
  v23[8] = *&a3->minimumPadding.top;
  v23[9] = v8;
  pipAnchorPointOffset = a3->pipAnchorPointOffset;
...
- (CGRect)_validatedInsetRectWithinContainerBoundsWithGeometry:(SBPIPPositionGeometryContext *)a3
{
  ...
  [(SBPIPPositionHyperregionLibrary *)self _insetRectForEdgeInsets:a3->edgeInsets.top pipSize:a3->edgeInsets.left containerBounds:a3->edgeInsets.bottom, a3->edgeInsets.right, a3->pipCurrentSize.width, height, *&x, *&y, *&v11, *&v10];
  v83 = v13;
  v84 = v12;
  v81 = v15;
  v82 = v14;
...
LABEL_12:
  ...
  v82 = v102.size.width;
LABEL_22:
  [(SBPIPPositionHyperregionLibrary *)self _insetRectForEdgeInsets:a3->minimumPadding.top pipSize:a3->minimumPadding.left containerBounds:a3->minimumPadding.bottom, a3->minimumPadding.right, width, height, *&x, *&y, *&v11, *&v10];
  v76 = v11;
  v77 = v10;
  v79 = x;
  v80 = y;
  ...
  if (CGRectIsNull(*(&v34 - 3)))
  {
    ...
    if (os_log_type_enabled(v46, OS_LOG_TYPE_ERROR))
    {
      ...
      v62 = NSStringFromUIEdgeInsets(a3->minimumPadding);
      v112.origin.x = v38;
      v112.origin.y = v39;
      v112.size.width = v40;
...
LABEL_42:
  ...
  if (CGRectIsNull(v105))
  {
    ...
    if (os_log_type_enabled(v46, OS_LOG_TYPE_ERROR))
    {
      ...
      v68 = NSStringFromUIEdgeInsets(a3->minimumPadding);
      v116.origin.x = v38;
      v116.origin.y = v39;
      v116.size.width = v40;
...
LABEL_44:
  ...
  if (os_log_type_enabled(v49, OS_LOG_TYPE_DEBUG))
  {
    ...
    v55 = NSStringFromUIEdgeInsets(a3->edgeInsets);
    v107.origin.y = v74;
    v107.origin.x = v75;
...
- (CGRect)_validatedMinimumPaddingAndEdgeInsetInsetRect:(SBPIPPositionGeometryContext *)a3
{
  ...
  [(SBPIPPositionHyperregionLibrary *)self _insetRectForEdgeInsets:a3->stashedMinimumPadding.top pipSize:a3->stashedMinimumPadding.left containerBounds:a3->stashedMinimumPadding.bottom, a3->stashedMinimumPadding.right, width, height, *&a3->containerBounds.origin.x, *&a3->containerBounds.origin.y, *&a3->containerBounds.size.width, *&a3->containerBounds.size.height];
  v8 = v7;
  v10 = v9;
  v12 = v11;
  v14 = v13;
  [(SBPIPPositionHyperregionLibrary *)self _insetRectForEdgeInsets:a3->edgeInsets.top pipSize:a3->edgeInsets.left containerBounds:a3->edgeInsets.bottom, a3->edgeInsets.right, width, height, *&a3->containerBounds.origin.x, *&a3->containerBounds.origin.y, *&a3->containerBounds.size.width, *&a3->containerBounds.size.height];
  v92.origin.x = v15;
  v92.origin.y = v16;
  v92.size.width = v17;
  v92.size.height = v18;
  ...
  if (CGRectIsNull(v82))
  {
    ...
    if (os_log_type_enabled(v28, OS_LOG_TYPE_ERROR))
    {
      ...
      v47 = NSStringFromSize(a3->pipCurrentSize);
      v48 = NSStringFromRect(a3->containerBounds);
      v49 = NSStringFromUIEdgeInsets(a3->stashedMinimumPadding);
      v90.origin.y = v61;
      v90.origin.x = v62;
      v90.size.height = v59;
      v90.size.width = v60;
  ...
  if (os_log_type_enabled(v34, OS_LOG_TYPE_DEBUG))
  {
    ...
    v40 = NSStringFromUIEdgeInsets(a3->edgeInsets);
    v84.origin.x = v8;
    v84.origin.y = v10;
    v84.size.width = v12;
    v84.size.height = v14;
...
- (CGRect)_validatedStashedToStashedMaximumumRectWithGeometry:(SBPIPPositionGeometryContext *)a3
{
  ...
  v7 = *&a3->stashedMinimumPadding.bottom;
  v8 = *&a3->offscreenCorners;
  v52 = *&a3->stashedMinimumPadding.top;
  v53 = v7;
  v54 = v8;
  size = a3->containerBounds.size;
  v10 = *&a3->edgeInsets.bottom;
  v11 = *&a3->minimumPadding.top;
  v48 = *&a3->edgeInsets.top;
  v49 = v10;
  v50 = v11;
  v51 = v6;
  pipLastSteadySize = a3->pipLastSteadySize;
...
LABEL_19:
  ...
  v32 = *&a3->stashedMinimumPadding.bottom;
  v52 = *&a3->stashedMinimumPadding.top;
  v53 = v32;
  v54 = *&a3->offscreenCorners;
  v33 = *&a3->edgeInsets.bottom;
  v48 = *&a3->edgeInsets.top;
  v49 = v33;
  v34 = *&a3->minimumPadding.bottom;
  v50 = *&a3->minimumPadding.top;
  v51 = v34;
