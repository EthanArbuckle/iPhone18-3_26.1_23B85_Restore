...
- (void)handleVolumeIncrease
{
  while (!self->_item)
  {
    _nextAlertItemToTest = [(SBOmnibusAlertItemTestRecipe *)self _nextAlertItemToTest];
    item = self->_item;
...
- (id)_anyAppIcon
{
  ...
  v12 = 0u;
  v13 = 0u;
  iconController = [(SBOmnibusAlertItemTestRecipe *)self iconController];
...
LABEL_16:
      v30 = [v26 alloc];
      _mapsApp = [(SBOmnibusAlertItemTestRecipe *)self _mapsApp];
      v25 = [v30 initWithApp:_mapsApp];
      goto LABEL_17;
    case 5:
      v38 = [SBBuddyLockScreenDismissOnlyAlertItem alloc];
      mainBundle = [MEMORY[0x277CCA8D8] mainBundle];
      v7 = [mainBundle localizedStringForKey:@"ACTIVATION_REQUIRED" value:@"Activation Required" table:@"SpringBoard"];
    ...
    case 7:
      ...
      v16 = [mainBundle2 localizedStringForKey:@"CARRIER_DEBUGGING_TITLE" value:&stru_283094718 table:@"SpringBoard"];

      mainBundle3 = [MEMORY[0x277CCA8D8] mainBundle];
      v18 = [mainBundle3 localizedStringForKey:@"CARRIER_DEBUGGING_BODY" value:&stru_283094718 table:@"SpringBoard"];

      v19 = @"SBCarrierDebuggingAlert";
      goto LABEL_45;
    case 8:
    case 9:
      mainBundle = [SBApp telephonyStateProvider];
      if ([mainBundle isSIMPresentForSlot:1])
      {
        v6 = 1;
      }
      ...
      v7 = [mainBundle carrierBundleInfoForSlot:v6];
      carrierName = [v7 carrierName];
      if (v3 == 8)
      {
        v9 = [[SBDataPlanCompletionAlertItem alloc] initWithCarrierName:carrierName newAccount:1];
      }

      else
      {
        v9 = [[SBDataPlanFailureAlertItem alloc] initWithAccountURL:0 carrierName:carrierName newAccount:1];
      }
    ...
    case 11:
      ...
      v16 = [mainBundle4 localizedStringForKey:@"WAITING_FOR_ACTIVATION_TITLE" value:&stru_283094718 table:@"SpringBoard"];

      mainBundle5 = [MEMORY[0x277CCA8D8] mainBundle];
      v18 = [mainBundle5 localizedStringForKey:@"WAITING_FOR_ACTIVATION_BODY" value:&stru_283094718 table:@"SpringBoard"];
...
LABEL_34:
      mainBundle = [mainBundle6 localizedStringForKey:v37 value:&stru_283094718 table:@"SpringBoard"];

      v40 = SBDismissOnlyAlertItem;
LABEL_35:
      v51 = [[v40 alloc] initWithTitle:mainBundle body:0];
      goto LABEL_38;
    case 14:
...
LABEL_27:
      mainBundle = [mainBundle7 localizedStringForKey:v22 value:&stru_283094718 table:@"SpringBoard"];

      v41 = MEMORY[0x277CCACA8];
      mainBundle8 = [MEMORY[0x277CCA8D8] mainBundle];
      v43 = [mainBundle8 localizedStringForKey:@"RESTRICTED_URL_BODY" value:&stru_283094718 table:@"SpringBoard"];
      v44 = [v41 stringWithFormat:v43, @"http://www.apple.com"];

      v31 = [(SBDismissOnlyAlertItem *)[SBUnsupportedURLAlertItem alloc] initWithTitle:mainBundle body:v44];
      goto LABEL_61;
    case 16:
      mainBundle9 = [MEMORY[0x277CCA8D8] mainBundle];
      v16 = [mainBundle9 localizedStringForKey:@"REORDER_INFO_TITLE" value:&stru_283094718 table:@"SpringBoard"];

      mainBundle10 = [MEMORY[0x277CCA8D8] mainBundle];
      v18 = [mainBundle10 localizedStringForKey:@"REORDER_INFO_BODY" value:&stru_283094718 table:@"SpringBoard"];

      v19 = @"SBHomeScreenNagAlert";
      goto LABEL_45;
    case 17:
      mainBundle = [(SBOmnibusAlertItemTestRecipe *)self _mapsApp];
...
LABEL_37:
      v51 = [[v45 alloc] initWithApplication:mainBundle];
LABEL_38:
      v31 = v51;
      goto LABEL_61;
    case 19:
      ...
      mainBundle = [MEMORY[0x277CCA8D8] mainBundle];
      v7 = [mainBundle localizedStringForKey:@"NON_COMPLIANT_PASSCODE_CONTINUE" value:&stru_283094718 table:@"SpringBoard"];
...
LABEL_60:
    ...
    case 20:
      ...
      mainBundle = [MEMORY[0x277CCA8D8] mainBundle];
      v47 = [mainBundle localizedStringForKey:@"NON_COMPLIANT_PASSCODE_CONTINUE" value:&stru_283094718 table:@"SpringBoard"];
      mainBundle11 = [MEMORY[0x277CCA8D8] mainBundle];
      v49 = [mainBundle11 localizedStringForKey:@"NON_COMPLIANT_PASSCODE_LATER" value:&stru_283094718 table:@"SpringBoard"];
    ...
    case 21:
      ...
      v47 = [mainBundle localizedStringForKey:@"NON_COMPLIANT_PASSCODE_CONTINUE" value:&stru_283094718 table:@"SpringBoard"];
      mainBundle11 = [MEMORY[0x277CCA8D8] mainBundle];
      v49 = [mainBundle11 localizedStringForKey:@"PASSCODE_REMINDER_CANCEL" value:&stru_283094718 table:@"SpringBoard"];
...
LABEL_61:
    ...
    case 22:
      ...
      v16 = [mainBundle12 localizedStringForKey:@"REORDER_INFO_TITLE" value:&stru_283094718 table:@"SpringBoard"];

      mainBundle13 = [MEMORY[0x277CCA8D8] mainBundle];
      v18 = [mainBundle13 localizedStringForKey:@"REORDER_INFO_BODY" value:&stru_283094718 table:@"SpringBoard"];
...
LABEL_56:
    ...
    case 33:
      ...
      _mapsApp = [(SBOmnibusAlertItemTestRecipe *)self _mapsApp];
      v25 = [(SBApplication32BitDeprecationAlertItem *)v23 initWithApplication:_mapsApp];
LABEL_17:
      v31 = v25;
