...
- (void)_evaluateClientExternallyBlockedReasons
{
  ...
  [v4 handleFailureInMethod:a1 object:a2 file:@"_SBContinuitySessionStateMachineStateFlushing.m" lineNumber:114 description:@"Must have _SBContinuitySessionStateMachineExternallyBlockedReasonsProvider"];
}
