...
{
  v4 = a3;
  v5 = [(SBWindowCommitSwitcherModifier *)self windowManagementContext];
...
LABEL_8:
    ...
    v8 = [(SBWindowCommitSwitcherModifier *)&v11 appLayoutContainingAppLayout:v4];
    goto LABEL_9;
  }
...
- (id)adjustedContinuousExposeIdentifiersInStripFromPreviousIdentifiersInStrip:(id)a3
{
  v4 = a3;
  v5 = [(SBWindowCommitSwitcherModifier *)self windowManagementContext];
  if (![v5 isChamoisOrFlexibleWindowing] || -[SBTransitionSwitcherModifier transitionPhase](self, "transitionPhase") < 2 || self->_fullScreenAppLayout)
  {

LABEL_5:
    v12.receiver = self;
    v12.super_class = SBWindowCommitSwitcherModifier;
    v6 = [(SBWindowCommitSwitcherModifier *)&v12 adjustedContinuousExposeIdentifiersInStripFromPreviousIdentifiersInStrip:v4];
    goto LABEL_6;
  }

  v8 = [(SBWindowCommitSwitcherModifier *)self appLayoutOnStage];
  ...
  v9 = [(SBWindowCommitSwitcherModifier *)&v18 appLayouts];
...
- (id)appLayoutsToEnsureExistForMainTransitionEvent:(id)a3
{
  ...
  v4 = [(SBWindowCommitSwitcherModifier *)&v7 appLayoutsToEnsureExistForMainTransitionEvent:a3];
...
- (id)animationAttributesForLayoutElement:(id)a3
{
  ...
  {
    v8 = [(SBWindowCommitSwitcherModifier *)self entityRemovalSettings];
...
- (double)dimmingAlphaForLayoutRole:(int64_t)a3 inAppLayout:(id)a4
{
  ...
  {
    v7 = [(SBWindowCommitSwitcherModifier *)self medusaSettings];
...
- (CGRect)frameForIndex:(unint64_t)a3
{
  v5 = [(SBWindowCommitSwitcherModifier *)self appLayouts];
  ...
  if (v6 == self->_centerWindowAppLayout)
  {
    ...
    if ([(SBTransitionSwitcherModifier *)self isUpdatingLayout])
    {
      ...
      v16 = [(SBWindowCommitSwitcherModifier *)self entityRemovalSettings];
      v17 = [v16 dosidoDeclineIntentAnimationSettings];
...
- (CGRect)frameForLayoutRole:(int64_t)a3 inAppLayout:(id)a4 withBounds:(CGRect)a5
{
  ...
  {
    [(SBWindowCommitSwitcherModifier *)&v34 frameForLayoutRole:a3 inAppLayout:v12 withBounds:x, y, width, height, self, SBWindowCommitSwitcherModifier, v35.receiver, v35.super_class];
  }
...
- (double)scaleForIndex:(unint64_t)a3
{
  ...
  {
    v7 = [(SBWindowCommitSwitcherModifier *)self entityRemovalSettings];
...
- (id)topMostLayoutElements
{
  ...
  v3 = [(SBWindowCommitSwitcherModifier *)&v9 topMostLayoutElements];
  v4 = [v3 mutableCopy];
  v5 = v4;
  if (v4)
  {
...
- (id)visibleAppLayouts
{
  v6.receiver = self;
  v6.super_class = SBWindowCommitSwitcherModifier;
  v3 = [(SBWindowCommitSwitcherModifier *)&v6 visibleAppLayouts];
  v4 = [v3 mutableCopy];
...
- (CGPoint)perspectiveAngleForIndex:(unint64_t)a3
{
  ...
  else
  {
    v13.receiver = self;
    v13.super_class = SBWindowCommitSwitcherModifier;
    [(SBWindowCommitSwitcherModifier *)&v13 perspectiveAngleForIndex:a3];
    v7 = v9;
    v8 = v10;
  }
...
- (SBSwitcherWallpaperGradientAttributes)wallpaperGradientAttributesForLayoutRole:(int64_t)a3 inAppLayout:(id)a4
{
  ...
  else
  {
    v13.receiver = self;
    v13.super_class = SBWindowCommitSwitcherModifier;
    [(SBWindowCommitSwitcherModifier *)&v13 wallpaperGradientAttributesForLayoutRole:a3 inAppLayout:v6];
  }
