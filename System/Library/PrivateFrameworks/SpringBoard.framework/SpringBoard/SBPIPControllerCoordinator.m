...
- (id)acquireAssertionToPreventVideoCallPIPFromStartingUnderControlCenter:(id)a3;
...
- (BOOL)isHostingAnApp
{
  v2 = [(SBPIPControllerCoordinator *)self hostedAppSceneHandles];
  v3 = [v2 count] != 0;
...
- (void)setWindowSceneManager:(id)a3
{
  ...
  {
    objc_storeStrong(&self->_windowSceneManager, a3);
    v13 = 0u;
    v14 = 0u;
    v11 = 0u;
    v12 = 0u;
    v6 = [(NSMutableDictionary *)self->_controllersByType objectEnumerator];
    ...
    if (v7)
    {
      ...
      do
      {
        for (i = 0; i != v8; ++i)
        {
          ...
          [*(*(&v11 + 1) + 8 * i) setWindowSceneManager:v5];
        }
...
- (void)registerController:(id)a3 forType:(int64_t)a4
{
  ...
  if (!SBPIPContentTypeIsValid(a4))
  {
    ...
    v9 = SBStringFromSBPIPContentType(a4);
    [v8 handleFailureInMethod:a2 object:self file:@"SBPIPControllerCoordinator.m" lineNumber:65 description:{@"Attempt to register pipController %@ for invalid contentType: %@", v7, v9}];
  }
  ...
  if (v11)
  {
    ...
    [v18 handleFailureInMethod:a2 object:self file:@"SBPIPControllerCoordinator.m" lineNumber:70 description:{@"Attempt to register pipController %@ for type %@ when one is already registered: %@", v7, v19, v11}];
  }
  ...
  if (v12 != a4)
  {
    ...
    [v21 handleFailureInMethod:a2 object:self file:@"SBPIPControllerCoordinator.m" lineNumber:73 description:{@"Attempt to register pipController %@ for contentType %@ when the pipController itself reports contentType %@", v7, v22, v23}];
  }
  ...
  if (v14)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        [v7 setPictureInPictureWindowsHidden:1 forReason:*(*(&v24 + 1) + 8 * v17++)];
      }
...
- (id)controllerForType:(int64_t)a3
{
  if (SBPIPContentTypeIsValid(a3))
  {
    ...
    v7 = [(NSMutableDictionary *)self->_controllersByType objectForKey:v6];
  }

  else
  {
    v6 = [MEMORY[0x277CCA890] currentHandler];
    v8 = SBStringFromSBPIPContentType(a3);
    [v6 handleFailureInMethod:a2 object:self file:@"SBPIPControllerCoordinator.m" lineNumber:87 description:{@"invalid contentType received: %@", v8}];
...
- (void)setPictureInPictureWindowsHidden:(BOOL)a3 withReason:(id)a4
{
  v4 = a3;
  v6 = a4;
  v7 = [(NSMutableSet *)self->_pictureInPictureWindowsHiddenReasons containsObject:v6];
  if (v4)
  {
    if ((v7 & 1) == 0)
    {
...
{
  v6 = a3;
  v7 = [(SBPIPControllerCoordinator *)self controllerForType:a4];
  v8 = [v7 tetheringModeForScenePersistenceIdentifier:v6];
...
- (id)acquireAssertionToPreventVideoCallPIPFromStartingUnderControlCenter:(id)a3
{
  ...
  v9 = [(BSCompoundAssertion *)preventPIPFromStartingUnderControllerCenterCompoundAssertion acquireForReason:v4];
...
- (id)hostedAppSceneHandle
{
  ...
  [v4 handleFailureInMethod:a2 object:self file:@"SBPIPControllerCoordinator.m" lineNumber:252 description:{@"%@ should never be called", v5}];
...
- (void)hostedAppWillRotateToInterfaceOrientation:(int64_t)a3
{
  v6 = [MEMORY[0x277CCA890] currentHandler];
  v5 = NSStringFromSelector(a2);
  [v6 handleFailureInMethod:a2 object:self file:@"SBPIPControllerCoordinator.m" lineNumber:265 description:{@"%@ should never be called", v5}];
}
