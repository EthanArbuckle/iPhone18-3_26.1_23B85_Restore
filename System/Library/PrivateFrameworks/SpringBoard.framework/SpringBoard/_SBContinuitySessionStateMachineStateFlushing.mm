...
- (void)_evaluateSystemEvents
{
  if (self->_isCurrentState)
  {
    ...
    if ([(SBContinuitySessionSystemEventMonitor *)self->_systemEventMonitor isUIBlocked])
    {
      ...
      {
        *v9 = 0;
        _os_log_impl(&dword_21ED4E000, v5, OS_LOG_TYPE_DEFAULT, "[State.Flushing] --> moving to .invalid because UI blocked ", v9, 2u);
      }
...
LABEL_14:
    ...
    if (![(SBContinuitySessionSystemEventMonitor *)self->_systemEventMonitor isUILocked])
    {
      ...
      {
        *v9 = 0;
        _os_log_impl(&dword_21ED4E000, v5, OS_LOG_TYPE_DEFAULT, "[State.Flushing] --> moving to .invalid because UI unlocked", v9, 2u);
      }
    ...
    if ([(SBContinuitySessionSystemEventMonitor *)self->_systemEventMonitor isInCall])
    {
      ...
      {
        *v9 = 0;
        _os_log_impl(&dword_21ED4E000, v5, OS_LOG_TYPE_DEFAULT, "[State.Flushing] --> moving to .invalid because in call", v9, 2u);
      }
    ...
    if ([(SBContinuitySessionSystemEventMonitor *)self->_systemEventMonitor isSOSActive])
    {
      ...
      {
        *v9 = 0;
        _os_log_impl(&dword_21ED4E000, v5, OS_LOG_TYPE_DEFAULT, "[State.Flushing] --> moving to .invalid because SOS active", v9, 2u);
      }
    ...
    if ([(SBContinuitySessionSystemEventMonitor *)self->_systemEventMonitor isLockScreenSearchPresented])
    {
      ...
      {
        *v9 = 0;
        _os_log_impl(&dword_21ED4E000, v5, OS_LOG_TYPE_DEFAULT, "[State.Flushing] --> moving to .invalid because lock screen search presented", v9, 2u);
      }
    ...
    if ([(SBContinuitySessionSystemEventMonitor *)self->_systemEventMonitor isUsingSecureApp])
    {
      ...
      {
        *v9 = 0;
        _os_log_impl(&dword_21ED4E000, v5, OS_LOG_TYPE_DEFAULT, "[State.Flushing] --> moving to .invalid because using secure app", v9, 2u);
      }
    ...
    if ([(SBContinuitySessionSystemEventMonitor *)self->_systemEventMonitor isAirplayMirroring])
    {
      ...
      {
        *v9 = 0;
        _os_log_impl(&dword_21ED4E000, v5, OS_LOG_TYPE_DEFAULT, "[State.Flushing] --> moving to .invalid because airplay mirroring", v9, 2u);
      }
    ...
    if ([(SBContinuitySessionSystemEventMonitor *)self->_systemEventMonitor isUserInitiatedRemoteTransientOverlayPresented])
    {
      ...
      {
        *v9 = 0;
        _os_log_impl(&dword_21ED4E000, v5, OS_LOG_TYPE_DEFAULT, "[State.Flushing] --> moving to .invalid because user-initiated remote transient overlay is presented", v9, 2u);
      }
...
- (void)_reevaluateStateForReason:(id)reason
{
  ...
  if (self->_isCurrentState)
  {
    ...
    if (os_log_type_enabled(v5, OS_LOG_TYPE_DEFAULT))
    {
      v13 = 138543362;
      v14 = reasonCopy;
      _os_log_impl(&dword_21ED4E000, v5, OS_LOG_TYPE_DEFAULT, "[State.Flushing] Re-evaluating state for reason: %{public}@", &v13, 0xCu);
    }
    ...
    if (v8)
    {
      if (v10)
      {
        ...
        v13 = 138543362;
        v14 = bs_array;
        _os_log_impl(&dword_21ED4E000, v9, OS_LOG_TYPE_DEFAULT, "[State.Flushing] still blocked by %{public}@", &v13, 0xCu);
      }
    ...
    else
    {
      ...
      {
        LOWORD(v13) = 0;
        _os_log_impl(&dword_21ED4E000, v9, OS_LOG_TYPE_DEFAULT, "[State.Flushing] --> moving to .active", &v13, 2u);
      }
