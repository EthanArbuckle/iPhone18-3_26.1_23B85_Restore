...
- (void)_evaluateClientExternallyBlockedReasons
{
  ...
  [v4 handleFailureInMethod:a1 object:a2 file:@"_SBContinuitySessionStateMachineStateUpdatingActiveDisplay.m" lineNumber:110 description:@"Must have _SBContinuitySessionStateMachineExternallyBlockedReasonsProvider"];
}
