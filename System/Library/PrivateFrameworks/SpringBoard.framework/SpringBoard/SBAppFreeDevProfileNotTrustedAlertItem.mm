...
- (void)configure:(BOOL)a3 requirePasscodeForActions:(BOOL)a4
{
  ...
  v7 = [v6 localizedStringForKey:@"APP_FREE_DEVELOPER_PROFILE_NOT_TRUSTED_TITLE" value:&stru_283094718 table:@"SpringBoard"];
  [v5 setTitle:v7];
  ...
  v16 = [v15 localizedStringForKey:@"APP_FREE_DEVELOPER_PROFILE_NOT_TRUSTED_CANCEL" value:&stru_283094718 table:@"SpringBoard"];
