...
- (SBAppFreeDevProfileNotTrustedAlertItem)initWithApp:(id)app;
...
- (void)configure:(BOOL)configure requirePasscodeForActions:(BOOL)actions
{
  ...
  v7 = [mainBundle localizedStringForKey:@"APP_FREE_DEVELOPER_PROFILE_NOT_TRUSTED_TITLE" value:&stru_283094718 table:@"SpringBoard"];
  [v5 setTitle:v7];
  ...
  v12 = [MEMORY[0x277D75418] modelSpecificLocalizedStringKeyForKey:@"APP_FREE_DEVELOPER_PROFILE_NOT_TRUSTED_BODY"];
  ...
  v16 = [mainBundle3 localizedStringForKey:@"APP_FREE_DEVELOPER_PROFILE_NOT_TRUSTED_CANCEL" value:&stru_283094718 table:@"SpringBoard"];
