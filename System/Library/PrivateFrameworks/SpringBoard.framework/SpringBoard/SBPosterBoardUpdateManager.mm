...
- (id)_backgroundTaskIdentifierForUpdate:(int64_t)a3;
- (void)_notifyDidFinishUpdate:(int64_t)a3 error:(id)a4;
- (void)_notifyWillBeginUpdate:(int64_t)a3;
- (void)_registerForWork:(int64_t)a3;
- (void)_schedulerQueue_submitTaskRequestForUpdate:(int64_t)a3 updateIdentifier:(id)a4;
- (void)_unregisterForWork:(int64_t)a3;
- (void)addObserver:(id)a3;
- (void)dealloc;
- (void)executeUpdate:(int64_t)a3 forBackgroundTask:(id)a4 updateIdentifier:(id)a5;
...
- (void)executeUpdate:(int64_t)a3 forBackgroundTask:(id)a4 updateIdentifier:(id)a5
{
  v8 = a4;
  v9 = a5;
  v10 = [MEMORY[0x277D65ED8] sharedInstance];
  ...
  v11 = v9;
  v12 = v8;
  [v10 performAfterFirstUnlockSinceBootUsingBlock:v13];
}
...
- (void)_registerForWork:(int64_t)a3
{
  ...
  else if (a3 == 2)
  {
    ...
    [v6 addObserver:self selector:sel__noteApplicationsChanged_ name:@"com.apple.LaunchServices.applicationRegistered" object:0];
    [v6 addObserver:self selector:sel__noteApplicationsChanged_ name:@"com.apple.LaunchServices.applicationUnregistered" object:0];
  }
}
...
- (id)_backgroundTaskIdentifierForUpdate:(int64_t)a3
{
  ...
  v7 = [MEMORY[0x277CCACA8] stringWithFormat:@"Unknown update type: %ld", a3];
  if (os_log_type_enabled(MEMORY[0x277D86220], OS_LOG_TYPE_ERROR))
  {
    [(SBPosterBoardUpdateManager *)a2 _backgroundTaskIdentifierForUpdate:v7];
  }
...
- (void)_schedulerQueue_submitTaskRequestForUpdate:(int64_t)a3 updateIdentifier:(id)a4
{
  ...
  v6 = a4;
  v7 = [(SBPosterBoardUpdateManager *)self _backgroundTaskIdentifierForUpdate:a3];
  if (a3 == 1)
  {
  ...
  v23 = 0;
  v15 = [v14 submitTaskRequest:v8 error:&v23];
  v16 = v23;
...
- (void)_notifyWillBeginUpdate:(int64_t)a3
{
  ...
  v4 = self;
  objc_sync_enter(v4);
  v5 = [(NSHashTable *)v4->_observers copy];
  objc_sync_exit(v4);
  ...
  if (v7)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        if (objc_opt_respondsToSelector())
        {
          [v10 updateManager:v4 willBeginUpdate:{a3, v11}];
        }
...
- (void)_notifyDidFinishUpdate:(int64_t)a3 error:(id)a4
{
  ...
  v7 = self;
  objc_sync_enter(v7);
  v8 = [(NSHashTable *)v7->_observers copy];
  objc_sync_exit(v7);
  ...
  if (v10)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        if (objc_opt_respondsToSelector())
        {
          [v13 updateManager:v7 didFinishUpdate:a3 error:{v6, v14}];
        }
