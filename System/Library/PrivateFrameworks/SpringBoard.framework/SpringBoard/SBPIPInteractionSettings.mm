...
- (void)setDefaultValues
{
  ...
  [initWithDefaultValues setName:@"PIP Behavior"];
  ...
  [initWithDefaultValues setDampingRatio:0.86];
  [initWithDefaultValues setResponse:0.55];
  [initWithDefaultValues setTrackingDampingRatio:0.92];
  [initWithDefaultValues setTrackingResponse:0.18];
  [(SBPIPInteractionSettings *)self setInteractiveFluidBehavior:initWithDefaultValues];
  v4 = [initWithDefaultValues copy];
  ...
  [initWithDefaultValues2 setName:@"Stash Tab Behavior"];
  ...
  [initWithDefaultValues2 setDampingRatio:0.92];
  [initWithDefaultValues2 setResponse:0.35];
  [initWithDefaultValues2 setTrackingDampingRatio:0.92];
  [initWithDefaultValues2 setTrackingResponse:0.18];
  [(SBPIPInteractionSettings *)self setStashTabFluidBehavior:initWithDefaultValues2];
  initWithDefaultValues3 = [objc_alloc(MEMORY[0x277D65E60]) initWithDefaultValues];
  [initWithDefaultValues3 setName:@"Rotation Behavior"];
  [initWithDefaultValues3 setBehaviorType:1];
  [initWithDefaultValues3 setRetargetImpulse:0.14];
  [initWithDefaultValues3 setTrackingRetargetImpulse:0.0];
  [initWithDefaultValues3 setDampingRatio:1.0];
  [initWithDefaultValues3 setResponse:0.8];
  [(SBPIPInteractionSettings *)self setRotationFluidBehavior:initWithDefaultValues3];
