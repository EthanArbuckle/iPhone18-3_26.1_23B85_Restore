...
+ (id)mostRecentReasonInSet:(id)set strength:(int64_t)strength;
+ (id)screenIsDim;
+ (id)systemModalAlert;
+ (id)universalControl;
+ (int64_t)maximumStrengthInSet:(id)set;
- (BOOL)isEqual:(id)equal;
- (BOOL)isMoreRecentThanReason:(id)reason;
- (id)_initReasonWithName:(void *)name strength:;
- (id)_initReasonWithName:(void *)name strength:(char)strength avoidOverridingAppFocusOnOtherDisplays:;
...
- (BOOL)isEqual:(id)equal
{
  equalCopy = equal;
  objc_opt_class();
  v5 = (objc_opt_isKindOfClass() & 1) != 0 && [(NSString *)self->_name isEqual:equalCopy[4]]&& self->_strength == equalCopy[2];
...
+ (id)accessibility:(id)accessibility
{
  ...
  if (!accessibilityCopy)
  {
    ...
    {
      [(SBKeyboardFocusLockReason *)a2 accessibility:self, v10];
    }
  ...
  {
    [(SBKeyboardFocusLockReason *)accessibilityCopy accessibility:a2, self];
  }

  [(SBKeyboardFocusLockReason *)accessibilityCopy accessibility:?];
  return v11;
}
...
{
  reasonCopy = reason;
  timestamp = [(SBKeyboardFocusLockReason *)self timestamp];
  timestamp2 = [reasonCopy timestamp];

  LOBYTE(reasonCopy) = [timestamp compare:timestamp2] == 1;
  return reasonCopy;
}
...
+ (id)mostRecentReasonInSet:(id)set strength:(int64_t)strength
{
  ...
  v16 = 0u;
  v17 = 0u;
  v6 = [setCopy countByEnumeratingWithState:&v14 objects:v18 count:16];
  if (v6)
  {
    v7 = v6;
    v8 = 0;
    ...
    do
    {
      ...
      v7 = [setCopy countByEnumeratingWithState:&v14 objects:v18 count:16];
    }
...
- (id)_initReasonWithName:(void *)name strength:
{
  if (result)
  {
    return [(SBKeyboardFocusLockReason *)result _initReasonWithName:a2 strength:name avoidOverridingAppFocusOnOtherDisplays:0];
  }
