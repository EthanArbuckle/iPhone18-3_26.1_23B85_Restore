...
- (void)initWithReason:(uint64_t)a1 jetsamMode:(uint64_t)a2 invalidationBlock:.cold.1(uint64_t a1, uint64_t a2)
{
  v4 = [MEMORY[0x277CCA890] currentHandler];
  [v4 handleFailureInMethod:a1 object:a2 file:@"SBSceneHandleJetsamModeAssertion.m" lineNumber:16 description:{@"Invalid parameter not satisfying: %@", @"updateJetsamModeReason != nil"}];
}
