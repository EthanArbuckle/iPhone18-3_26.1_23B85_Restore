...
- (void)handleVolumeIncrease
{
  ...
  [v4 setWallpaperStyle:23 forPriority:4 forVariant:activeVariant withAnimationFactory:v3];
}
...
- (void)handleVolumeDecrease
{
  ...
  activeVariant = [v4 activeVariant];
  v3 = [MEMORY[0x277CF0D38] factoryWithDuration:0.3];
  [v4 removeWallpaperStyleForPriority:4 forVariant:activeVariant withAnimationFactory:v3];
}
