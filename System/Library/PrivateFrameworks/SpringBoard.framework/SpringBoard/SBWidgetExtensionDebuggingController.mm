...
- (SBWidgetExtensionDebuggingController)initWithWorkspace:(id)a3 toolService:(id)a4 homeScreenDataSource:(id)a5 controlCenterDataSource:(id)a6
{
  ...
  if (v15)
  {
    objc_storeStrong(&v15->_workspace, a3);
    objc_storeStrong(&v16->_homeScreenDataSource, a5);
    objc_storeStrong(&v16->_controlCenterDataSource, a6);
    objc_storeStrong(&v16->_toolService, a4);
    v17 = objc_alloc(MEMORY[0x277CFA3C0]);
    v18 = [MEMORY[0x277CFA390] visible];
    v19 = [MEMORY[0x277CFA218] visible];
    v20 = [v17 initWithWidgetsPredicate:v18 controlsPredicate:v19];
...
- (void)launchExtensionWithBundleID:(id)a3 options:(id)a4 completion:(id)a5
{
  ...
  v12 = [v9 bs_safeObjectForKey:*MEMORY[0x277CFA1B0] ofType:objc_opt_class()];
  v13 = [v9 bs_safeObjectForKey:*MEMORY[0x277CFA1A0] ofType:objc_opt_class()];
...
- (void)_reallyFindDescriptorForWidgetFromExtension:(id)a3 forRequestedKind:(id)a4 requestedWidgetFamily:(int64_t)a5 completion:(id)a6
{
  ...
  v74 = v11;
  v12 = [v11 identity];
  v73 = [v12 extensionBundleIdentifier];

  v13 = [v11 orderedDescriptors];
  v14 = [v11 orderedControlDescriptors];
  if (!v73)
  {
  ...
  BSDispatchQueueAssertMain();
  v76 = [v13 sortedArrayUsingComparator:&__block_literal_global_452];

  v72 = [v14 sortedArrayUsingComparator:&__block_literal_global_97_0];
  ...
  if (v75 && [v75 length])
  {
    ...
    v15 = v75;
    v96 = v15;
    v16 = [v76 bs_firstObjectPassingTest:v95];
    ...
    v17 = v15;
    v94 = v17;
    v18 = [v72 bs_firstObjectPassingTest:v93];
    if (!(v16 | v18))
    {
      ...
      v40 = [v25 componentsJoinedByString:{@", "}];
...
LABEL_45:
  ...
  else
  {
    ...
    {
      v20 = [(SBWidgetExtensionDebugHomeScreenDataSource *)self->_homeScreenDataSource hasExistingWidgetFromExtension:v73];
      v16 = v20;
      if (v20)
      {
        v21 = [v20 kind];
        ...
        if (v22)
        {
          ...
          [v68 handleFailureInMethod:a2 object:self file:@"SBWidgetExtensionDebuggingController.m" lineNumber:253 description:@"Must provide a kind"];
        }
      ...
      {
        v44 = [(SBWidgetExtensionDebugControlCenterDataSource *)self->_controlCenterDataSource hasExistingControlFromExtension:v73];
        v24 = v44;
        if (v44)
        {
          v45 = [v44 kind];
          ...
          if (v46)
          {
            ...
            [v69 handleFailureInMethod:a2 object:self file:@"SBWidgetExtensionDebuggingController.m" lineNumber:263 description:@"Must provide a kind"];
          }
          ...
          v24 = v24;
          v82 = v24;
          v18 = [v72 bs_firstObjectPassingTest:v81];
        }
...
LABEL_46:
  if (!(v16 | v18))
  {
    ...
    [v67 handleFailureInMethod:a2 object:self file:@"SBWidgetExtensionDebuggingController.m" lineNumber:287 description:@"Should have a widget or control descriptor to use by now"];
  ...
  [v16 supportedFamilies];
  if (CHSWidgetFamilyMaskContainsFamily())
  {
    v98[3] = a5;
LABEL_49:
    v47 = [_SBWidgetExtensionLaunchRequestResult alloc];
    v48 = [(_SBWidgetExtensionLaunchRequestResult *)v47 initWithWidgetDescriptor:v16 widgetFamily:v98[3] controlDescriptor:v18];
    (v71)[2](v71, v48, 0);
  ...
  v62 = MEMORY[0x223D6C060](a5);
  v63 = [v16 kind];
  v64 = [v61 stringWithFormat:@"Request widget family (%@) is not supported by this widget kind (%@)", v62, v63];
