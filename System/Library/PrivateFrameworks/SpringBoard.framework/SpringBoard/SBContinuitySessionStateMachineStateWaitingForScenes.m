...
{
  v2 = [*(a1 + 32) appendBool:*(*(a1 + 40) + 28) withName:@"isCurrentState"];
  result = [*(a1 + 32) hasSuccinctStyle];
  if ((result & 1) == 0)
  {
    v4 = [*(a1 + 32) appendBool:*(*(a1 + 40) + 27) withName:@"validDisplayUUID"];
    v5 = [*(a1 + 32) appendBool:*(*(a1 + 40) + 24) withName:@"mainSceneConnected"];
    result = SBSIsSystemApertureAvailable();
    if (result)
    {
      v6 = [*(a1 + 32) appendBool:*(*(a1 + 40) + 25) withName:@"systemApertureSceneConnected"];
      return [*(a1 + 32) appendBool:*(*(a1 + 40) + 26) withName:@"systemApertureCurtainSceneConnected"];
    }
  }
