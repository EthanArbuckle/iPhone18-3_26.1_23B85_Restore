...
- (id)copyWithZone:(_NSZone *)zone
{
  ...
  activeVolumeCategoryName = [(SBVolumeControlState *)self activeVolumeCategoryName];
  [(SBVolumeControlState *)v4 setActiveVolumeCategoryName:activeVolumeCategoryName];
...
- (id)description
{
  ...
  activeVolumeCategoryName = [(SBVolumeControlState *)self activeVolumeCategoryName];
  [v3 appendString:activeVolumeCategoryName withName:@"activeVolumeCategoryName"];
