...
- (id)_iconDragPreviewContainerView
{
  rootViewController = [(SBIconDragPlatterWindow *)self rootViewController];
...
- (void)beginTrackingPlatterView:(id)view
{
  ...
  _iconDragPreviewContainerView = [(SBIconDragPlatterWindow *)self _iconDragPreviewContainerView];
