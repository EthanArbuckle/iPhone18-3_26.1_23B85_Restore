...
- (void)enteredStateFrom:(unint64_t)from
{
  ...
  {
    *buf = 0;
    _os_signpost_emit_with_name_impl(&dword_21ED4E000, v5, OS_SIGNPOST_INTERVAL_BEGIN, 0xEEEEB0B5B2B2EEEELL, "SB_ONENESS_STATE_MACHINE_WAITING_FOR_HID_SERVICES", &unk_21F8B82DE, buf, 2u);
  }
...
- (void)exitedStateTo:(unint64_t)to
{
  ...
  {
    *v4 = 0;
    _os_signpost_emit_with_name_impl(&dword_21ED4E000, v3, OS_SIGNPOST_INTERVAL_END, 0xEEEEB0B5B2B2EEEELL, "SB_ONENESS_STATE_MACHINE_WAITING_FOR_HID_SERVICES", &unk_21F8B82DE, v4, 2u);
  }
}
...
- (void)_evaluateSystemEvents
{
  if (self->_isCurrentState)
  {
    ...
    if ([(SBContinuitySessionSystemEventMonitor *)self->_systemEventMonitor isUIBlocked])
    {
      ...
      {
        *v9 = 0;
        _os_log_impl(&dword_21ED4E000, v5, OS_LOG_TYPE_DEFAULT, "[State.WaitingForHIDServices] --> moving to .invalid because UI blocked ", v9, 2u);
      }
...
LABEL_14:
    ...
    if (![(SBContinuitySessionSystemEventMonitor *)self->_systemEventMonitor isUILocked])
    {
      ...
      {
        *v9 = 0;
        _os_log_impl(&dword_21ED4E000, v5, OS_LOG_TYPE_DEFAULT, "[State.WaitingForHIDServices] --> moving to .invalid because UI unlocked", v9, 2u);
      }
    ...
    if ([(SBContinuitySessionSystemEventMonitor *)self->_systemEventMonitor isInCall])
    {
      ...
      {
        *v9 = 0;
        _os_log_impl(&dword_21ED4E000, v5, OS_LOG_TYPE_DEFAULT, "[State.WaitingForHIDServices] --> moving to .invalid because in call", v9, 2u);
      }
    ...
    if ([(SBContinuitySessionSystemEventMonitor *)self->_systemEventMonitor isSOSActive])
    {
      ...
      {
        *v9 = 0;
        _os_log_impl(&dword_21ED4E000, v5, OS_LOG_TYPE_DEFAULT, "[State.WaitingForHIDServices] --> moving to .invalid because SOS active", v9, 2u);
      }
    ...
    if ([(SBContinuitySessionSystemEventMonitor *)self->_systemEventMonitor isLockScreenSearchPresented])
    {
      ...
      {
        *v9 = 0;
        _os_log_impl(&dword_21ED4E000, v5, OS_LOG_TYPE_DEFAULT, "[State.WaitingForHIDServices] --> moving to .invalid because lock screen search presented", v9, 2u);
      }
    ...
    if ([(SBContinuitySessionSystemEventMonitor *)self->_systemEventMonitor isUsingSecureApp])
    {
      ...
      {
        *v9 = 0;
        _os_log_impl(&dword_21ED4E000, v5, OS_LOG_TYPE_DEFAULT, "[State.WaitingForHIDServices] --> moving to .invalid because using secure app", v9, 2u);
      }
    ...
    if ([(SBContinuitySessionSystemEventMonitor *)self->_systemEventMonitor isAirplayMirroring])
    {
      ...
      {
        *v9 = 0;
        _os_log_impl(&dword_21ED4E000, v5, OS_LOG_TYPE_DEFAULT, "[State.WaitingForHIDServices] --> moving to .invalid because airplay mirroring", v9, 2u);
      }
    ...
    if ([(SBContinuitySessionSystemEventMonitor *)self->_systemEventMonitor isUserInitiatedRemoteTransientOverlayPresented])
    {
      ...
      {
        *v9 = 0;
        _os_log_impl(&dword_21ED4E000, v5, OS_LOG_TYPE_DEFAULT, "[State.WaitingForHIDServices] --> moving to .invalid because user-initiated remote transient overlay is presented", v9, 2u);
      }
...
- (void)_evaluateLockState
{
  if (self->_isCurrentState)
  {
    ...
    if (lockState == 2)
    {
      ...
      {
        *v10 = 0;
        _os_log_impl(&dword_21ED4E000, v6, OS_LOG_TYPE_DEFAULT, "[State.WaitingForHIDServices] --> moving to .invalid keybag has been unexpectedly unlocked", v10, 2u);
      }
    ...
    else
    {
      ...
      {
        *buf = 0;
        _os_log_impl(&dword_21ED4E000, v6, OS_LOG_TYPE_DEFAULT, "[State.WaitingForHIDServices] --> moving to .invalid keybag has been unexpectedly locked", buf, 2u);
      }
...
- (void)_reevaluateStateForReason:(id)reason
{
  ...
  if (self->_isCurrentState)
  {
    ...
    else
    {
      ...
      {
        LOWORD(v13) = 0;
        _os_log_impl(&dword_21ED4E000, v9, OS_LOG_TYPE_DEFAULT, "[State.WaitingForHIDServices] --> moving to .Activating", &v13, 2u);
      }
