  ...
  if (v4)
  {
    ...
    *&v5 = 138412802;
    ...
    do
    {
        ...
        if ([(FedStatsCohortQueryInstalledApps *)self _isSupportedIntentMediaApp:v8])
        {
          ...
          if (os_log_type_enabled(v20, OS_LOG_TYPE_DEBUG))
          {
            ...
            *buf = v24;
            ...
            v30 = 2112;
            v31 = v22;
            _os_log_debug_impl(&dword_21A3C2000, v20, OS_LOG_TYPE_DEBUG, "bundle record: %@ has supported intent %@ and supported media categories: %@", buf, 0x20u);
          }
      ...
      {
        v11 = [*(v7 + 3856) framework];
        if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
        {
          *buf = 138412290;
          v27 = v6;
          _os_log_error_impl(&dword_21A3C2000, v11, OS_LOG_TYPE_ERROR, "Error enumerating app records; app record: %@ has nil bundle identifier", buf, 0xCu);
        }
      }
