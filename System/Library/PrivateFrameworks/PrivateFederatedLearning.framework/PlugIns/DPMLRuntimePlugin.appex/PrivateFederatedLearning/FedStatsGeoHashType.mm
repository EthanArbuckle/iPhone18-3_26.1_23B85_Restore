...
LABEL_15:
  ...
  v9 = [NSNumber numberWithUnsignedLong:v18];
LABEL_18:
...
- (id)sampleForIndex:(unint64_t)index
{
  ...
  {
    v5 = [&stru_10002D560 stringByPaddingToLength:-[FedStatsGeoHashType hashLength](self withString:"hashLength") startingAtIndex:{@"@", 0}];
  }
