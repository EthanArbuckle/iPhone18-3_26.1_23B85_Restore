...
- (id)performTask:(id)a3 outError:(id *)a4
{
  ...
  v6 = objc_opt_new();
  v7 = [v5 parameters];
  v8 = [v7 stringValueForKey:@"namespaceID" defaultValue:&stru_10002D560];
  [v6 setNamespaceIdentifier:v8];

  v9 = [v6 namespaceIdentifier];
  v10 = [v9 isEqualToString:&stru_10002D560];
  ...
  {
    v20 = [v5 parameters];
    v21 = [v20 stringValueForKey:@"recipeURL" defaultValue:&stru_10002D560];
