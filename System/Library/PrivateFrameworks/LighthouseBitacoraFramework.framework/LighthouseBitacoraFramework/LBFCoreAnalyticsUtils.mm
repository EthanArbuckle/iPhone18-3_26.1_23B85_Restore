...
+ (void)upload:(id)upload
{
  ...
  if (objc_msgSend_hasCountPerformTaskFailed(uploadCopy, v4, v5, v6, v7))
  {
    v12 = MEMORY[0x277CCABB0];
    v13 = objc_msgSend_countPerformTaskFailed(uploadCopy, v8, v9, v10, v11);
  ...
  if (objc_msgSend_hasCountPerformTaskSucceeded(uploadCopy, v17, v18, v19, v20))
  {
    v25 = MEMORY[0x277CCABB0];
    v26 = objc_msgSend_countPerformTaskSucceeded(uploadCopy, v21, v22, v23, v24);
  ...
  if (objc_msgSend_hasCountStopFailed(uploadCopy, v30, v31, v32, v33))
  {
    v38 = MEMORY[0x277CCABB0];
    v39 = objc_msgSend_countStopFailed(uploadCopy, v34, v35, v36, v37);
  ...
  if (objc_msgSend_hasCountStopSucceeded(uploadCopy, v43, v44, v45, v46))
  {
    v51 = MEMORY[0x277CCABB0];
    v52 = objc_msgSend_countStopSucceeded(uploadCopy, v47, v48, v49, v50);
  ...
  if (objc_msgSend_hasCountTaskCompletedFailed(uploadCopy, v56, v57, v58, v59))
  {
    v64 = MEMORY[0x277CCABB0];
    v65 = objc_msgSend_countTaskCompletedFailed(uploadCopy, v60, v61, v62, v63);
  ...
  if (objc_msgSend_hasCountTaskCompletedSucceeded(uploadCopy, v69, v70, v71, v72))
  {
    v77 = MEMORY[0x277CCABB0];
    v78 = objc_msgSend_countTaskCompletedSucceeded(uploadCopy, v73, v74, v75, v76);
  ...
  if (objc_msgSend_hasCountTaskFetchedFailed(uploadCopy, v82, v83, v84, v85))
  {
    v90 = MEMORY[0x277CCABB0];
    v91 = objc_msgSend_countTaskFetchedFailed(uploadCopy, v86, v87, v88, v89);
  ...
  if (objc_msgSend_hasCountTaskFetchedSucceeded(uploadCopy, v95, v96, v97, v98))
  {
    v103 = MEMORY[0x277CCABB0];
    v104 = objc_msgSend_countTaskFetchedSucceeded(uploadCopy, v99, v100, v101, v102);
  ...
  if (objc_msgSend_hasCountTaskScheduledFailed(uploadCopy, v108, v109, v110, v111))
  {
    v116 = MEMORY[0x277CCABB0];
    v117 = objc_msgSend_countTaskScheduledFailed(uploadCopy, v112, v113, v114, v115);
  ...
  if (objc_msgSend_hasCountTaskScheduledSucceeded(uploadCopy, v121, v122, v123, v124))
  {
    v129 = MEMORY[0x277CCABB0];
    v130 = objc_msgSend_countTaskScheduledSucceeded(uploadCopy, v125, v126, v127, v128);
  ...
  if (objc_msgSend_hasIsActivated(uploadCopy, v134, v135, v136, v137))
  {
    v142 = MEMORY[0x277CCABB0];
    isActivated = objc_msgSend_isActivated(uploadCopy, v138, v139, v140, v141);
  ...
  if (objc_msgSend_hasIsAllocated(uploadCopy, v147, v148, v149, v150))
  {
    v155 = MEMORY[0x277CCABB0];
    isAllocated = objc_msgSend_isAllocated(uploadCopy, v151, v152, v153, v154);
  ...
  if (objc_msgSend_hasTrialTaskID(uploadCopy, v160, v161, v162, v163))
  {
    objc_msgSend_trialTaskID(uploadCopy, v164, v165, v166, v167);
  }
  ...
  if (objc_msgSend_hasTrialDeploymentID(uploadCopy, v169, v170, v171, v172))
  {
    objc_msgSend_trialDeploymentID(uploadCopy, v173, v174, v175, v176);
  }
  ...
  if (objc_msgSend_hasTrialExperimentID(uploadCopy, v178, v179, v180, v181))
  {
    objc_msgSend_trialExperimentID(uploadCopy, v182, v183, v184, v185);
  }
  ...
  if (objc_msgSend_hasTrialTreatmentID(uploadCopy, v187, v188, v189, v190))
  {
    objc_msgSend_trialTreatmentID(uploadCopy, v191, v192, v193, v194);
  }
  ...
  v201 = objc_msgSend_timestamp(uploadCopy, v197, v198, v199, v200);
  v205 = objc_msgSend_numberWithUnsignedLongLong_(v196, v202, v201, v203, v204);
  v243[16] = v205;
  v242[17] = @"timestamp_str";
  v206 = MEMORY[0x277CCACA8];
  v211 = objc_msgSend_timestamp(uploadCopy, v207, v208, v209, v210);
  v215 = objc_msgSend_stringWithFormat_(v206, v212, @"%llu", v213, v214, v211);
  v243[17] = v215;
  v242[18] = @"telemetryID";
  v220 = objc_msgSend_telemetryID(uploadCopy, v216, v217, v218, v219);
  v243[18] = v220;
  v242[19] = @"contextID";
  v225 = objc_msgSend_contextID(uploadCopy, v221, v222, v223, v224);
  v243[19] = v225;
