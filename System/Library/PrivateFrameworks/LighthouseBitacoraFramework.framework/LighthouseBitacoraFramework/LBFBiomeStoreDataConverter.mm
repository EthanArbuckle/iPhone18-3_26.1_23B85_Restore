...
+ (id)createTrialIdentifiers:(id)identifiers
{
  ...
  v9 = objc_msgSend_identifierType(identifiersCopy, v4, v5, v6, v7);
  if (v9 != 1)
  {
    if (v9 == 2)
    {
...
+ (id)createMLRuntimedEvent:(id)event identifiers:(id)identifiers timestamp:(id)timestamp
{
  ...
  if (timestampCopy)
  {
    v16 = objc_msgSend_intValue(timestampCopy, v11, v12, v13, v14);
  ...
  v36 = identifiersCopy;
  v40 = objc_msgSend_createTrialIdentifiers_(self, v37, identifiersCopy, v38, v39);
  v41 = objc_alloc(MEMORY[0x277CF1270]);
  v46 = objc_msgSend_scheduled(eventCopy, v42, v43, v44, v45);
  v50 = objc_msgSend_initWithScheduled_(v41, v47, v46, v48, v49);

  v51 = objc_alloc(MEMORY[0x277CF1278]);
  v56 = objc_msgSend_succeeded(eventCopy, v52, v53, v54, v55);
  v61 = objc_msgSend_errorDomain(eventCopy, v57, v58, v59, v60);
  v66 = objc_msgSend_errorCode(eventCopy, v62, v63, v64, v65);
  v68 = objc_msgSend_initWithSucceeded_errorDomain_errorCode_(v51, v67, v56, v61, v66);

  v73 = objc_msgSend_eventType(eventCopy, v69, v70, v71, v72);
  if (v73 > 2)
  {
    if (v73 == 3)
    {
...
+ (id)createDprivacydEvent:(id)event identifiers:(id)identifiers timestamp:(id)timestamp
{
  ...
  if (timestampCopy)
  {
    ...
    v22 = objc_msgSend_intValue(timestampCopy, v16, v17, v18, v19);
  ...
  v45 = objc_msgSend_eventPhase(eventCopy, v41, v42, v43, v44);
  if ((v45 - 1) >= 5)
  {
    v94 = LBFLogContextEventManager;
    if (os_log_type_enabled(LBFLogContextEventManager, OS_LOG_TYPE_ERROR))
    {
      sub_255F0ABC8(v94, eventCopy);
    }
  ...
  v50 = v45;
  v51 = objc_msgSend_aggregateFunction(eventCopy, v46, v47, v48, v49);
  if (v51 >= 4)
  {
    v95 = LBFLogContextEventManager;
    if (os_log_type_enabled(LBFLogContextEventManager, OS_LOG_TYPE_ERROR))
    {
      sub_255F0AC54(v95, eventCopy);
    }
...
LABEL_11:
  ...
  v58 = objc_msgSend_succeeded(eventCopy, v54, v55, v56, v57);
  v63 = objc_msgSend_errorMessage(eventCopy, v59, v60, v61, v62);
  v65 = objc_msgSend_initWithPhase_succeeded_errorMessage_(v53, v64, v50, v58, v63);

  v97 = objc_alloc(MEMORY[0x277CF1248]);
  v70 = objc_msgSend_eventUUID(eventCopy, v66, v67, v68, v69);
  v71 = MEMORY[0x277CCABB0];
  v76 = objc_msgSend_errorCode(eventCopy, v72, v73, v74, v75);
  v80 = objc_msgSend_numberWithInt_(v71, v77, v76, v78, v79);
  v81 = MEMORY[0x277CCABB0];
  v86 = objc_msgSend_count(eventCopy, v82, v83, v84, v85);
...
+ (id)createLighthousePluginEvent:(id)event identifiers:(id)identifiers timestamp:(id)timestamp
{
  ...
  if (timestampCopy)
  {
    v17 = objc_msgSend_intValue(timestampCopy, v11, v12, v13, v14);
  ...
  v46 = objc_msgSend_succeeded(eventCopy, v42, v43, v44, v45);
  v51 = objc_msgSend_errorDomain(eventCopy, v47, v48, v49, v50);
  v56 = objc_msgSend_errorCode(eventCopy, v52, v53, v54, v55);
  v58 = objc_msgSend_initWithSucceeded_errorDomain_errorCode_(v41, v57, v46, v51, v56);

  v63 = objc_msgSend_eventType(eventCopy, v59, v60, v61, v62);
  switch(v63)
  {
    case 3:
      v84 = objc_alloc(MEMORY[0x277CF1258]);
      v70 = objc_msgSend_usePrivateUpload(eventCopy, v85, v86, v87, v88);
      v91 = v58;
      v71 = v84;
      v72 = v40;
      v73 = v36;
    ...
    case 2:
      ...
      v70 = objc_msgSend_usePrivateUpload(eventCopy, v78, v79, v80, v81);
    ...
    case 1:
      ...
      v70 = objc_msgSend_usePrivateUpload(eventCopy, v65, v66, v67, v68);
      v91 = 0;
      v71 = v64;
      v72 = v40;
      v73 = v36;
...
+ (id)createTrialdEvent:(id)event identifiers:(id)identifiers timestamp:(id)timestamp
{
  ...
  v40 = objc_msgSend_createTrialIdentifiers_(self, v37, identifiersCopy, v38, v39);
  v45 = objc_msgSend_eventType(eventCopy, v41, v42, v43, v44);
  v46 = v45 - 1;
  if ((v45 - 1) > 2 || (v47 = objc_alloc(MEMORY[0x277CF1298]), objc_msgSend_succeeded(eventCopy, v48, v49, v50, v51), v52 = objc_claimAutoreleasedReturnValue(), v54 = objc_msgSend_initWithTrialIdentifiers_contextID_timestamp_eventType_eventSucceeded_(v47, v53, v40, v36, v26, (v46 + 1), v52), v52, !v54))
  {
    if (os_log_type_enabled(LBFLogContextEventManager, OS_LOG_TYPE_ERROR))
    {
      sub_255F0AB94();
...
+ (id)protoFromTrialIdentifier:(id)identifier
{
  ...
  v57 = objc_msgSend_bmltIdentifiers(identifierCopy, v10, v11, v12, v13);

  if (v57)
  {
    v58 = objc_alloc_init(LIGHTHOUSE_BITACORA_PROTOBMLTIdentifiers);
    v63 = objc_msgSend_bmltIdentifiers(identifierCopy, v59, v60, v61, v62);
    v68 = objc_msgSend_trialTaskID(v63, v64, v65, v66, v67);
    objc_msgSend_setTrialTaskID_(v58, v69, v68, v70, v71);

    v76 = objc_msgSend_bmltIdentifiers(identifierCopy, v72, v73, v74, v75);
...
+ (id)protoFromBiomeLighthousePluginEvent:(id)event
{
  ...
  v9 = objc_msgSend_trialIdentifiers(eventCopy, v5, v6, v7, v8);
  ...
  v21 = objc_msgSend_timestamp(eventCopy, v17, v18, v19, v20);
  objc_msgSend_timeIntervalSince1970(v21, v22, v23, v24, v25);
  objc_msgSend_setTimestamp_(v4, v26, v27, v28, v29);

  v34 = objc_msgSend_contextID(eventCopy, v30, v31, v32, v33);
  objc_msgSend_setContextID_(v4, v35, v34, v36, v37);

  v42 = objc_msgSend_performTaskStatus(eventCopy, v38, v39, v40, v41);
  ...
  if (v42)
  {
    ...
    v55 = objc_msgSend_performTaskStatus(eventCopy, v51, v52, v53, v54);
    ...
    v73 = objc_msgSend_performTaskStatus(eventCopy, v69, v70, v71, v72);
    ...
    v91 = objc_msgSend_performTaskStatus(eventCopy, v87, v88, v89, v90);
  ...
  v105 = objc_msgSend_performTrialTaskStatus(eventCopy, v43, v44, v45, v46);
  ...
  if (v105)
  {
    ...
    v118 = objc_msgSend_performTrialTaskStatus(eventCopy, v114, v115, v116, v117);
    ...
    v136 = objc_msgSend_performTrialTaskStatus(eventCopy, v132, v133, v134, v135);
    ...
    v154 = objc_msgSend_performTrialTaskStatus(eventCopy, v150, v151, v152, v153);
  ...
  v168 = objc_msgSend_stop(eventCopy, v106, v107, v108, v109);
  ...
  if (v168)
  {
    ...
    v177 = objc_msgSend_stop(eventCopy, v173, v174, v175, v176);
    ...
    v195 = objc_msgSend_stop(eventCopy, v191, v192, v193, v194);
    ...
    v213 = objc_msgSend_stop(eventCopy, v209, v210, v211, v212);
...
+ (id)protoFromBiomeMlruntimedEvent:(id)event
{
  ...
  v42 = objc_msgSend_activityScheduleStatus(eventCopy, v38, v39, v40, v41);
  ...
  if (v42)
  {
    ...
    v55 = objc_msgSend_activityScheduleStatus(eventCopy, v51, v52, v53, v54);
  ...
  v69 = objc_msgSend_taskFetched(eventCopy, v43, v44, v45, v46);
  ...
  if (v69)
  {
    ...
    v82 = objc_msgSend_taskFetched(eventCopy, v78, v79, v80, v81);
    ...
    v100 = objc_msgSend_taskFetched(eventCopy, v96, v97, v98, v99);
    ...
    v118 = objc_msgSend_taskFetched(eventCopy, v114, v115, v116, v117);
  ...
  v132 = objc_msgSend_taskScheduled(eventCopy, v70, v71, v72, v73);
  ...
  if (v132)
  {
    ...
    v145 = objc_msgSend_taskScheduled(eventCopy, v141, v142, v143, v144);
    ...
    v163 = objc_msgSend_taskScheduled(eventCopy, v159, v160, v161, v162);
    ...
    v181 = objc_msgSend_taskScheduled(eventCopy, v177, v178, v179, v180);
  ...
  v195 = objc_msgSend_taskCompleted(eventCopy, v133, v134, v135, v136);
  ...
  if (v195)
  {
    ...
    v204 = objc_msgSend_taskCompleted(eventCopy, v200, v201, v202, v203);
    ...
    v222 = objc_msgSend_taskCompleted(eventCopy, v218, v219, v220, v221);
    ...
    v240 = objc_msgSend_taskCompleted(eventCopy, v236, v237, v238, v239);
...
+ (id)protoFromBiomeTrialdEvent:(id)event
{
  ...
  v42 = objc_msgSend_eventType(eventCopy, v38, v39, v40, v41);
  if (v42 - 1 >= 3)
  {
  ...
  v50 = objc_msgSend_eventSucceeded(eventCopy, v46, v47, v48, v49);
