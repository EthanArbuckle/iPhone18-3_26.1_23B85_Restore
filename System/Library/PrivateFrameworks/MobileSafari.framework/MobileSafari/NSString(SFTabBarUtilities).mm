...
- (id)truncatedTitleWithFont:()SFTabBarUtilities desiredWidth:truncatedSize:sortedTabBarItemTitles:
{
  ...
  v43 = 0x2020000000;
  v44 = 0;
  v18 = [v17 indexOfObject:v16 inSortedRange:0 options:objc_msgSend(v17 usingComparator:{"count"), 1024, &__block_literal_global_50}];
  ...
  if (v19)
  {
    ...
    while (1)
    {
      ...
      v27 = deleteOneWord(v23, v19 - v24, 0);
      if (!v27)
      {
        break;
      }
    ...
    {
      v30 = [MEMORY[0x1E696AB08] alphanumericCharacterSet];
      v31 = [v30 invertedSet];
      v32 = truncatedTitleWithFont_desiredWidth_truncatedSize_sortedTabBarItemTitles__nonAlphanumericCharacters;
      truncatedTitleWithFont_desiredWidth_truncatedSize_sortedTabBarItemTitles__nonAlphanumericCharacters = v31;
    }
    ...
    if (v24)
    {
      ...
      while (deleteOneWord(v23, v33, truncatedTitleWithFont_desiredWidth_truncatedSize_sortedTabBarItemTitles__nonAlphanumericCharacters));
    }
  }
