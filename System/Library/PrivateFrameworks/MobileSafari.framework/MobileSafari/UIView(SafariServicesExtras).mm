...
- (id)sf_privacyPreservingDescription
{
  ...
  v6 = [v2 stringWithFormat:@"<%@: %p bounds = %@; center = %@", v3, a1, v4, v5];;
...
- (id)_sf_viewAncestrySummaryWithMinDepth:()SafariServicesExtras paddingLevel:
{
  ...
  if (v9)
  {
    ...
    do
    {
      v13 = [v10 sf_privacyPreservingDescription];
...
- (id)sf_commonAncestrySummaryWithView:()SafariServicesExtras
{
  ...
  else
  {
    ...
    if (v17)
    {
      v24 = [a1 sf_viewAncestrySummary];
      [v5 sf_viewAncestrySummary];
    }

    else
    {
      v24 = [v12 _sf_viewAncestrySummaryWithMinDepth:v8 paddingLevel:0];
      [v13 _sf_viewAncestrySummaryWithMinDepth:v8 + 1 paddingLevel:1];
    }
    v25 = ;
    v22 = [v23 stringWithFormat:@"%@\n%@", v24, v25];
  }
...
- (uint64_t)_sf_snapshotImageFromIOSurface
{
  ...
  return [a1 safari_snapshotImageFromIOSurfaceInRect:?];
}

- (id)safari_snapshotImageFromIOSurfaceInRect:()SafariServicesExtras
{
  v1 = [a1 _imageFromRect:?];
  if ([v1 ioSurface])
  {
...
+ (void)_sf_animateLinkImage:()SafariServicesExtras withAnimation:fromPoint:inView:toRect:inView:afterImageDisappearsBlock:afterDestinationLayerBouncesBlock:
{
  ...
  [a1 _sf_animateLinkImage:v36 withAnimation:a10 fromRect:v37 inView:v28 toRect:v27 inView:v26 afterImageDisappearsBlock:v34 afterDestinationLayerBouncesBlock:{v35, v31, v33, a4, a5, a6, a7}];
}
...
+ (void)_sf_animateLinkImage:()SafariServicesExtras withAnimation:fromRect:inView:toRect:inView:afterImageDisappearsBlock:afterDestinationLayerBouncesBlock:
{
  ...
  if (v31)
  {
    ...
    v36 = v35 = v30;
    v116 = a1;
    [a1 _sf_cancelLinkAnimationsOnSourceWindow:v120 destinationWindow:v36];
    [v120 layer];
    v37 = v121 = a12;
    v122 = [v36 layer];
    ...
    v43 = [v35 layer];
    [v43 convertRect:v38 toLayer:{a2, a3, a4, a5}];
    [v42 setFrame:?];
    ...
    v46 = v31;
    v47 = _Block_copy(v45);
    [v44 setValue:v47 forKey:@"afterImageDisappearsKey"];

    [v44 setValue:v42 forKey:@"layer"];
    [v44 setDuration:?];
    UIAnimationDragCoefficient();
    *&v49 = 1.0 / v48;
    [v44 setSpeed:v49];
    v135 = CAFrameRateRangeMake(80.0, 120.0, 120.0);
    [v44 setPreferredFrameRateRange:{*&v135.minimum, *&v135.maximum, *&v135.preferred}];
    v114 = v44;
    [v44 setHighFrameRateReason:1638403];
    v50 = [v31 layer];
    [v37 bounds];
    ...
    v52 = v38;
    [v122 bounds];
    [v120 convertRect:v36 fromWindow:?];
    v117 = v37;
    v53 = v42;
    ...
    v115 = v36;
    [v120 convertPoint:v36 fromWindow:{MidX, CGRectGetMidY(v140)}];
    v112 = v52;
    v113 = v50;
    [v50 convertPoint:v52 toLayer:?];
    v67 = v66;
    v69 = v68;
    v70 = (v63 + v66) * 0.5;
    if (v121 == 1)
...
{
  v5 = [a4 layer];
  v6 = [v5 animationForKey:@"SafariLinkAnimation"];
