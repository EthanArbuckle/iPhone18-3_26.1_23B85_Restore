...
- (SFQuickLookDocumentWriter)initWithFileName:(id)name uti:(id)uti;
- (void)setFilePathAccessedOnDispatchQueue:(id)queue;
- (void)writeDataAndClose:(id)close completionHandler:(id)handler;
@end
...
- (SFQuickLookDocumentWriter)initWithFileName:(id)name uti:(id)uti
{
  ...
  if (v8)
  {
    safari_lastPathComponentWithoutZipExtension = [nameCopy safari_lastPathComponentWithoutZipExtension];
    ...
    safari_lastPathComponentWithoutZipExtension2 = [nameCopy safari_lastPathComponentWithoutZipExtension];
    v22 = [(SFQuickLookDocument *)v20 initWithFileName:safari_lastPathComponentWithoutZipExtension2 mimeType:0 uti:utiCopy needsQuickLookDocumentView:0];
