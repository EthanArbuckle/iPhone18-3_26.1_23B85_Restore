...
- (void)safari_copyAnimationsFromLayer:()MobileSafariExtras applyingModifications:
{
  ...
  v6 = a3;
  v7 = a4;
  animationKeys = [v6 animationKeys];
  v16 = 0u;
  v17 = 0u;
  v18 = 0u;
  v19 = 0u;
  v9 = [animationKeys countByEnumeratingWithState:&v16 objects:v20 count:16];
  if (v9)
  {
    v10 = v9;
    v11 = *v17;
    do
    {
      for (i = 0; i != v10; ++i)
      {
        ...
        if (v15)
        {
          ...
          [self addAnimation:v15 forKey:v13];
        }
      }

      v10 = [animationKeys countByEnumeratingWithState:&v16 objects:v20 count:16];
    }
