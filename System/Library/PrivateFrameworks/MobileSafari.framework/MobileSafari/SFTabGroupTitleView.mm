...
- (SFTabGroupTitleView)initWithFrame:(CGRect)frame;
...
- (SFTabGroupTitleView)initWithFrame:(CGRect)frame
{
  ...
  v3 = [(SFTabGroupTitleView *)&v39 initWithFrame:frame.origin.x, frame.origin.y, frame.size.width, frame.size.height];
  if (v3)
  {
    ...
    leadingAnchor2 = [(SFTabGroupTitleView *)v3 leadingAnchor];
    [(SFTabGroupTitleView *)v3 _horizontalPadding];
    v36 = [leadingAnchor constraintEqualToAnchor:leadingAnchor2 constant:?];
    v40[0] = v36;
    widthAnchor = [(UILabel *)v3->_titleLabel widthAnchor];
    widthAnchor2 = [(SFTabGroupTitleView *)v3 widthAnchor];
    [(SFTabGroupTitleView *)v3 _horizontalPadding];
    v33 = [widthAnchor constraintEqualToAnchor:widthAnchor2 constant:v13 * -2.0];
    v40[1] = v33;
    topAnchor = [(UILabel *)v3->_titleLabel topAnchor];
    topAnchor2 = [(SFTabGroupTitleView *)v3 topAnchor];
    ...
    leadingAnchor4 = [(SFTabGroupTitleView *)v3 leadingAnchor];
    v15 = [leadingAnchor3 constraintEqualToAnchor:leadingAnchor4];
    v40[4] = v15;
    widthAnchor3 = [(UILabel *)v3->_subtitleLabel widthAnchor];
    widthAnchor4 = [(SFTabGroupTitleView *)v3 widthAnchor];
    v18 = [widthAnchor3 constraintEqualToAnchor:widthAnchor4];
    v40[5] = v18;
    bottomAnchor2 = [(UILabel *)v3->_subtitleLabel bottomAnchor];
    bottomAnchor3 = [(SFTabGroupTitleView *)v3 bottomAnchor];
...
- (void)updateTitle
{
  ...
  v9 = [v7 stringWithFormat:@"%@ ", displayTitle];
  v10 = [v6 initWithString:v9];
  [v3 appendAttributedString:v10];

  v11 = *MEMORY[0x1E69DDD08];
  secondaryLabelColor = [MEMORY[0x1E69DC888] secondaryLabelColor];
  v13 = [(SFTabGroupTitleView *)self _attributedStringWithImageNamed:@"chevron.forward" textStyle:v11 additionalSymbolicTraits:2 color:secondaryLabelColor baselineOffset:0.5];
...
- (CGSize)sizeThatFits:(CGSize)fits
{
  ...
  [(SFTabGroupTitleView *)&v11 systemLayoutSizeFittingSize:fits.width, fits.height];
  v5 = v4;
  v7 = v6;
...
- (id)_attributedStringWithImageNamed:(id)named textStyle:(id)style additionalSymbolicTraits:(unsigned int)traits color:(id)color baselineOffset:(double)offset
{
  ...
  styleCopy = style;
  v14 = [v12 systemImageNamed:named];
  v15 = MEMORY[0x1E696AAB0];
  v16 = [MEMORY[0x1E69DB7F0] textAttachmentWithImage:v14];
  v17 = [v15 attributedStringWithAttachment:v16];
  v18 = [v17 mutableCopy];

  v19 = [MEMORY[0x1E69DB880] preferredFontDescriptorWithTextStyle:styleCopy];

  v20 = MEMORY[0x1E69DB878];
  v21 = [v19 fontDescriptorWithSymbolicTraits:{objc_msgSend(v19, "symbolicTraits") | traits}];
  [v19 pointSize];
  ...
  if (colorCopy)
  {
    [v18 addAttribute:*MEMORY[0x1E69DB650] value:colorCopy range:{0, 1}];
  }

  if (offset != 0.0)
  {
    v23 = *MEMORY[0x1E69DB610];
    v24 = [MEMORY[0x1E696AD98] numberWithDouble:offset];
