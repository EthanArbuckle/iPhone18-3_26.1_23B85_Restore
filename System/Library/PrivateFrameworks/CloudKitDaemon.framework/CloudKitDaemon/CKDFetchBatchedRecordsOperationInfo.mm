...
- (CKDFetchBatchedRecordsOperationInfo)initWithCoder:(id)coder;
...
- (void)encodeWithCoder:(id)coder
{
  ...
  objc_msgSend_encodeObject_forKey_(coderCopy, v25, v24, @"assetTransferOptionsByKeyByRecordType");
...
- (CKDFetchBatchedRecordsOperationInfo)initWithCoder:(id)coder
{
  ...
  if (v5)
  {
    ...
    v33 = objc_msgSend_decodeObjectOfClasses_forKey_(coderCopy, v32, v31, @"assetTransferOptionsByKeyByRecordType");
