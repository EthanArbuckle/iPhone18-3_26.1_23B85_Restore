...
- (id)description
{
  ...
  v11.receiver = self;
  v11.super_class = CKDPRecordSaveRequestConflictLoserUpdate;
...
- (id)dictionaryRepresentation
{
  ...
  if (conflictLoserEtags)
  {
    objc_msgSend_setObject_forKey_(v4, v5, conflictLoserEtags, @"conflictLoserEtags");
  }
...
- (void)copyTo:(id)to
{
  ...
  {
    objc_msgSend_clearConflictLoserEtags(toCopy, v6, v7);
    ...
    if (v10)
    {
      ...
      for (i = 0; i != v12; ++i)
      {
        v14 = objc_msgSend_conflictLoserEtagsAtIndex_(self, v11, i);
        objc_msgSend_addConflictLoserEtags_(toCopy, v15, v14);
      }
    }
  }
}
  ...
  if (v13)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        objc_msgSend_addConflictLoserEtags_(v10, v19, v18);
  ...
  if (v6)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        objc_msgSend_addConflictLoserEtags_(self, v7, *(*(&v12 + 1) + 8 * v10++), v12);
      }
