...
- (void)addCryptoSessions:(id)sessions
{
  ...
  objc_msgSend_addObject_(cryptoSessions, sessionsCopy, sessionsCopy);
}
...
- (id)description
{
  ...
  v11.receiver = self;
  v11.super_class = CKDPCodeFunctionInvokeRequestProtectedCloudComputeMetadata;
...
- (id)dictionaryRepresentation
{
  ...
  if (objc_msgSend_count(self->_cryptoSessions, v5, v6))
  {
    ...
    objc_msgSend_setObject_forKey_(v4, v23, v12, @"cryptoSessions");
  }
...
- (void)copyTo:(id)to
{
  ...
  {
    objc_msgSend_clearCryptoSessions(toCopy, v6, v7);
    ...
    if (v10)
    {
      ...
      for (i = 0; i != v12; ++i)
      {
        v14 = objc_msgSend_cryptoSessionsAtIndex_(self, v11, i);
        objc_msgSend_addCryptoSessions_(toCopy, v15, v14);
      }
    }
  }
}
  ...
  if (v13)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        objc_msgSend_addCryptoSessions_(v10, v19, v18);
  ...
  if (v6)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        objc_msgSend_addCryptoSessions_(self, v7, *(*(&v12 + 1) + 8 * v10++), v12);
      }
