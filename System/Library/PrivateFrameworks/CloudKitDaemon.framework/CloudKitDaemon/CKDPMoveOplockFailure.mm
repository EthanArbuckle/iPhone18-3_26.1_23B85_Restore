...
- (void)copyTo:(id)to
{
  ...
  if (movedRecordDestinationIdentifier)
  {
    objc_msgSend_setMovedRecordDestinationIdentifier_(to, a2, movedRecordDestinationIdentifier);
  }
}
...
- (id)copyWithZone:(_NSZone *)zone
{
  ...
  v12 = objc_msgSend_copyWithZone_(self->_movedRecordDestinationIdentifier, v11, zone);
  v13 = v10[1];
  v10[1] = v12;
...
- (void)mergeFrom:(id)from
{
  ...
  if (movedRecordDestinationIdentifier)
  {
    if (v6)
    {
      objc_msgSend_mergeFrom_(movedRecordDestinationIdentifier, fromCopy, v6);
    }
  }

  else if (v6)
  {
    objc_msgSend_setMovedRecordDestinationIdentifier_(self, fromCopy, v6);
  }
