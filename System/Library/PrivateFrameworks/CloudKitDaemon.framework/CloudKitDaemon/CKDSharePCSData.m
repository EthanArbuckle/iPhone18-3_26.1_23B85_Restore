...
- (CKDSharePCSData)initWithShareID:(id)a3 pcsData:(id)a4
{
  ...
  if (v8)
  {
    objc_storeStrong(&v8->_shareID, a3);
  }
...
+ (CKDSharePCSData)dataWithShareID:(id)a3 pcsData:(id)a4
{
  ...
  v9 = objc_msgSend_initWithShareID_pcsData_(v7, v8, v6, v5);
...
- (void)encodeWithCoder:(id)a3
{
  ...
  objc_msgSend_encodeObject_forKey_(v4, v9, v8, @"ShareID");

  v12 = objc_msgSend_publicPCSData(self, v10, v11);
  objc_msgSend_encodeObject_forKey_(v4, v13, v12, @"PublicPCSData");

  v16 = objc_msgSend_publicPCSEtag(self, v14, v15);
  objc_msgSend_encodeObject_forKey_(v4, v17, v16, @"PublicPCSEtag");

  v20 = objc_msgSend_myParticipantPCSData(self, v18, v19);
  objc_msgSend_encodeObject_forKey_(v4, v21, v20, @"MyParticipantPCS");
  ...
  objc_msgSend_encodeObject_forKey_(v4, v41, v40, @"ShareEtag");

  v44 = objc_msgSend_shareModificationDate(self, v42, v43);
  objc_msgSend_encodeObject_forKey_(v4, v45, v44, @"shareModificationDate");
...
- (CKDSharePCSData)initWithCoder:(id)a3
{
  ...
  v5 = [(CKDPCSData *)&v36 initWithCoder:v4];
  if (v5)
  {
    v6 = objc_autoreleasePoolPush();
    v7 = objc_opt_class();
    v9 = objc_msgSend_decodeObjectOfClass_forKey_(v4, v8, v7, @"ShareID");
    shareID = v5->_shareID;
    v5->_shareID = v9;

    v11 = objc_opt_class();
    v13 = objc_msgSend_decodeObjectOfClass_forKey_(v4, v12, v11, @"PublicPCSData");
    publicPCSData = v5->_publicPCSData;
    v5->_publicPCSData = v13;

    v15 = objc_opt_class();
    v17 = objc_msgSend_decodeObjectOfClass_forKey_(v4, v16, v15, @"PublicPCSEtag");
    publicPCSEtag = v5->_publicPCSEtag;
    v5->_publicPCSEtag = v17;

    v19 = objc_opt_class();
    v21 = objc_msgSend_decodeObjectOfClass_forKey_(v4, v20, v19, @"MyParticipantPCS");
    ...
    v27 = objc_opt_class();
    v29 = objc_msgSend_decodeObjectOfClass_forKey_(v4, v28, v27, @"ShareEtag");
    shareEtag = v5->_shareEtag;
    v5->_shareEtag = v29;

    v31 = objc_opt_class();
    v33 = objc_msgSend_decodeObjectOfClass_forKey_(v4, v32, v31, @"shareModificationDate");
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v4 = [(CKDPCSData *)&v78 copyWithZone:a3];
