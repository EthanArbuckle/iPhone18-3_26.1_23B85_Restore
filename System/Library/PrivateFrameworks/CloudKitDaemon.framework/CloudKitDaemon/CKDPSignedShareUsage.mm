...
- (id)description
{
  ...
  v11.receiver = self;
  v11.super_class = CKDPSignedShareUsage;
...
- (id)dictionaryRepresentation
{
  ...
  if (shareUsage)
  {
    objc_msgSend_setObject_forKey_(v5, v4, shareUsage, @"shareUsage");
  }
...
- (void)copyTo:(id)to
{
  ...
  if (shareUsage)
  {
    objc_msgSend_setShareUsage_(v8, v5, shareUsage);
    toCopy = v8;
  }
}
...
- (id)copyWithZone:(_NSZone *)zone
{
  ...
  v16 = objc_msgSend_copyWithZone_(self->_shareUsage, v15, zone);
  v17 = v12[1];
  v12[1] = v16;
...
LABEL_11:
  ...
  if (shareUsage | v12)
  {
    isEqual = objc_msgSend_isEqual_(shareUsage, v7, v12);
  }
