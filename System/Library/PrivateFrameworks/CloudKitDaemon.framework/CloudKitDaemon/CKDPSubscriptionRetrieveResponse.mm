...
- (void)addSubscriptions:(id)subscriptions
{
  ...
  objc_msgSend_addObject_(subscriptions, subscriptionsCopy, subscriptionsCopy);
}
...
- (id)description
{
  ...
  v11.receiver = self;
  v11.super_class = CKDPSubscriptionRetrieveResponse;
...
- (id)dictionaryRepresentation
{
  ...
  if (objc_msgSend_count(self->_subscriptions, v5, v6))
  {
    ...
    objc_msgSend_setObject_forKey_(v4, v23, v12, @"subscriptions");
  }
...
- (void)copyTo:(id)to
{
  ...
  {
    objc_msgSend_clearSubscriptions(toCopy, v6, v7);
    ...
    if (v10)
    {
      ...
      for (i = 0; i != v12; ++i)
      {
        v14 = objc_msgSend_subscriptionsAtIndex_(self, v11, i);
        objc_msgSend_addSubscriptions_(toCopy, v15, v14);
      }
    }
  }
}
  ...
  if (v13)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        objc_msgSend_addSubscriptions_(v10, v19, v18);
  ...
  if (v6)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        objc_msgSend_addSubscriptions_(self, v7, *(*(&v12 + 1) + 8 * v10++), v12);
      }
