...
- (void)fetchMetadataRecursivelyForMergeableValueIDs:(id)a3 continuationTokens:(id)a4 completionHandler:(id)a5
{
  ...
  v14 = objc_msgSend_initWithOperation_mergeableValueIDs_continuationTokens_(v12, v13, self, v8, v9);
...
- (void)handleFetchedMetadatasForMergeableValueID:(id)a3 metadatas:(id)a4 result:(id)a5
{
  ...
  if (v12)
  {
    if (objc_msgSend_code(v77, v13, v14) == 1)
    {
      if (*MEMORY[0x277CBC880] != -1)
      {
        dispatch_once(MEMORY[0x277CBC880], *MEMORY[0x277CBC878]);
        ...
        if (v25)
        {
          ...
          do
          {
            ...
            do
            {
              ...
              v28 = *(*(&v90 + 1) + 8 * v27);
              if (objc_msgSend_isEncrypted(v8, v23, v24) && objc_msgSend_needsDecryption(v28, v23, v24))
              {
      ...
      else
      {
        ...
        v68 = objc_msgSend_errorWithDomain_code_userInfo_format_(MEMORY[0x277CBC560], v67, *MEMORY[0x277CBC120], 1017, 0, @"Must specify a record ID and field name for value %@", v8);
    ...
    {
      v48 = sub_2253962A4(v77);
      v51 = objc_msgSend_request(self, v49, v50);
      v52 = sub_225395734(v51, v77);

      v53 = MEMORY[0x277CBC560];
      v56 = objc_msgSend_error(v77, v54, v55);
      v59 = objc_msgSend_errorDescription(v56, v57, v58);
      v61 = objc_msgSend_errorWithDomain_code_userInfo_format_(v53, v60, *MEMORY[0x277CBC120], v48, v52, @"Error fetching delta for value %@ from server: %@", v8, v59);
