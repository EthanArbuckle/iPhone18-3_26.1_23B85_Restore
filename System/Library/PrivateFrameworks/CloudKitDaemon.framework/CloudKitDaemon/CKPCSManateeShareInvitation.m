...
- (void)copyTo:(id)a3
{
  ...
  if (exportedPCSData)
  {
    objc_msgSend_setExportedPCSData_(v4, v5, exportedPCSData);
    v4 = v8;
  }
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v12 = objc_msgSend_copyWithZone_(self->_exportedPCSData, v11, a3);
  v13 = v10[1];
  v10[1] = v12;

  v15 = objc_msgSend_copyWithZone_(self->_shareePublicKeyData, v14, a3);
  v16 = v10[2];
  v10[2] = v15;
...
- (BOOL)isEqual:(id)a3
{
  v4 = a3;
  v5 = objc_opt_class();
  if (objc_msgSend_isMemberOfClass_(v4, v6, v5) && ((exportedPCSData = self->_exportedPCSData, v9 = v4[1], !(exportedPCSData | v9)) || objc_msgSend_isEqual_(exportedPCSData, v7, v9)))
  {
    shareePublicKeyData = self->_shareePublicKeyData;
    v11 = v4[2];
