...
- (void)encodeWithCoder:(id)a3
{
  ...
  v26.receiver = self;
  v26.super_class = CKDFetchBatchedRecordsOperationInfo;
  ...
  objc_msgSend_encodeObject_forKey_(v4, v25, v24, @"assetTransferOptionsByKeyByRecordType");
...
- (CKDFetchBatchedRecordsOperationInfo)initWithCoder:(id)a3
{
  v4 = a3;
  v36.receiver = self;
  v36.super_class = CKDFetchBatchedRecordsOperationInfo;
  ...
  if (v5)
  {
    ...
    v5->_fetchAllChanges = objc_msgSend_decodeBoolForKey_(v4, v25, @"fetchAllChanges");
    v26 = MEMORY[0x277CBEB98];
    v27 = objc_opt_class();
    v28 = objc_opt_class();
    v29 = objc_opt_class();
    v31 = objc_msgSend_setWithObjects_(v26, v30, v27, v28, v29, 0);
    v33 = objc_msgSend_decodeObjectOfClasses_forKey_(v4, v32, v31, @"assetTransferOptionsByKeyByRecordType");
