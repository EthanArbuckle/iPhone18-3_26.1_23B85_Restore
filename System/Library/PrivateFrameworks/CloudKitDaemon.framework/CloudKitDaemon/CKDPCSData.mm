...
- (void)encodeWithCoder:(id)a3
{
  ...
  if (objc_msgSend_shouldEncodePCSData(self, v5, v6))
  {
    ...
    objc_msgSend_encodeObject_forKey_(v17, v10, v9, @"PCSData");

    v13 = objc_msgSend_etag(self, v11, v12);
    objc_msgSend_encodeObject_forKey_(v17, v14, v13, @"Etag");
  }

  v15 = objc_msgSend_pcsKeyID(self, v7, v8);
  objc_msgSend_encodeObject_forKey_(v17, v16, v15, @"KeyID");
...
- (CKDPCSData)initWithCoder:(id)a3
{
  ...
  if (v5)
  {
    v6 = objc_autoreleasePoolPush();
    v7 = objc_opt_class();
    v9 = objc_msgSend_decodeObjectOfClass_forKey_(v4, v8, v7, @"PCSData");
    pcsData = v5->_pcsData;
    v5->_pcsData = v9;

    v11 = objc_opt_class();
    v13 = objc_msgSend_decodeObjectOfClass_forKey_(v4, v12, v11, @"Etag");
    etag = v5->_etag;
    v5->_etag = v13;

    v15 = objc_opt_class();
    v17 = objc_msgSend_decodeObjectOfClass_forKey_(v4, v16, v15, @"KeyID");
