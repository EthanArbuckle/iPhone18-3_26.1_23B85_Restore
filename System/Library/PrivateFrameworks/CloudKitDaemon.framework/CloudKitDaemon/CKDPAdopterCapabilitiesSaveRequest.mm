...
- (void)copyTo:(id)to
{
  ...
  if (signedSupportedAdopterCapabilities)
  {
    objc_msgSend_setSignedSupportedAdopterCapabilities_(to, a2, signedSupportedAdopterCapabilities);
  }
}
...
- (id)copyWithZone:(_NSZone *)zone
{
  ...
  v12 = objc_msgSend_copyWithZone_(self->_signedSupportedAdopterCapabilities, v11, zone);
  v13 = v10[1];
  v10[1] = v12;
...
- (void)mergeFrom:(id)from
{
  ...
  if (signedSupportedAdopterCapabilities)
  {
    if (v6)
    {
      objc_msgSend_mergeFrom_(signedSupportedAdopterCapabilities, fromCopy, v6);
    }
  }

  else if (v6)
  {
    objc_msgSend_setSignedSupportedAdopterCapabilities_(self, fromCopy, v6);
  }
