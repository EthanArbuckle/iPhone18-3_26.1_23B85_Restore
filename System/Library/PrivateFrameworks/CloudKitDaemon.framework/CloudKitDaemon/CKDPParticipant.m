...
- (void)copyTo:(id)a3
{
  ...
  if (participantId)
  {
    objc_msgSend_setParticipantId_(v4, v5, participantId);
    v4 = v22;
  }
...
LABEL_9:
  ...
  *(v4 + 24) = self->_participantType;
  *(v4 + 76) |= 8u;
  if ((*&self->_has & 0x10) != 0)
  {
LABEL_10:
    *(v4 + 25) = self->_permission;
    *(v4 + 76) |= 0x10u;
  }
...
LABEL_11:
  ...
  if ((v14 & 4) != 0)
  {
    *(v4 + 19) = self->_outOfNetworkKeyType;
    *(v4 + 76) |= 4u;
    v14 = self->_has;
    if ((v14 & 0x20) == 0)
    {
...
LABEL_56:
  *(v4 + 144) = self->_acceptedInProcess;
  *(v4 + 76) |= 0x80u;
  if ((*&self->_has & 0x800) != 0)
  {
LABEL_27:
    *(v4 + 148) = self->_isInNetwork;
    *(v4 + 76) |= 0x800u;
  }
...
LABEL_28:
  ...
  if ((v18 & 0x200) != 0)
  {
    *(v4 + 146) = self->_isAnonymousInvitedParticipant;
    *(v4 + 76) |= 0x200u;
    v18 = self->_has;
  }
  ...
  if ((v18 & 0x400) != 0)
  {
    *(v4 + 147) = self->_isApprovedRequester;
    *(v4 + 76) |= 0x400u;
  }
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v12 = objc_msgSend_copyWithZone_(self->_participantId, v11, a3);
  v13 = *(v10 + 88);
  *(v10 + 88) = v12;

  v15 = objc_msgSend_copyWithZone_(self->_userId, v14, a3);
  v16 = *(v10 + 136);
  *(v10 + 136) = v15;

  v18 = objc_msgSend_copyWithZone_(self->_contactInformation, v17, a3);
  v19 = *(v10 + 32);
  *(v10 + 32) = v18;
...
LABEL_5:
  v22 = objc_msgSend_copyWithZone_(self->_inviterId, v20, a3);
  v23 = *(v10 + 64);
  *(v10 + 64) = v22;
  ...
  v25 = objc_msgSend_copyWithZone_(self->_publicKey, v24, a3);
  v26 = *(v10 + 120);
  *(v10 + 120) = v25;
  ...
  v28 = objc_msgSend_copyWithZone_(self->_protectionInfo, v27, a3);
  v29 = *(v10 + 104);
  *(v10 + 104) = v28;

  v31 = objc_msgSend_copyWithZone_(self->_outOfNetworkPrivateKey, v30, a3);
  v32 = *(v10 + 80);
  *(v10 + 80) = v31;
...
LABEL_14:
  v35 = objc_msgSend_copyWithZone_(self->_acceptedTimestampDate, v33, a3);
  v36 = *(v10 + 24);
  *(v10 + 24) = v35;
  ...
  v38 = objc_msgSend_copyWithZone_(self->_protectionInfoPublicKey, v37, a3);
  v39 = *(v10 + 112);
  *(v10 + 112) = v38;
  ...
  v41 = objc_msgSend_copyWithZone_(self->_inviteTimestampDate, v40, a3);
  v42 = *(v10 + 56);
  *(v10 + 56) = v41;
  ...
  v45 = objc_msgSend_copyWithZone_(self->_encryptedContactInformation, v43, a3);
  v46 = *(v10 + 40);
  *(v10 + 40) = v45;

  v48 = objc_msgSend_copyWithZone_(self->_inviteNSSecTimestampDate, v47, a3);
  v49 = *(v10 + 48);
  *(v10 + 48) = v48;

  v51 = objc_msgSend_copyWithZone_(self->_acceptedNSSecTimestampDate, v50, a3);
  v52 = *(v10 + 16);
  *(v10 + 16) = v51;
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ((has & 0x40) != 0)
  {
    if ((v15 & 0x40) == 0 || self->_state != *(v4 + 33))
    {
      goto LABEL_48;
    }
  }
  ...
  if ((has & 8) != 0)
  {
    if ((v15 & 8) == 0 || self->_participantType != *(v4 + 24))
    {
      goto LABEL_48;
    }
  }
  ...
  if ((has & 0x10) != 0)
  {
    if ((v15 & 0x10) == 0 || self->_permission != *(v4 + 25))
    {
      goto LABEL_48;
    }
  }
  ...
  if ((v25 & 4) != 0)
  {
    if ((v26 & 4) == 0 || self->_outOfNetworkKeyType != *(v4 + 19))
    {
      goto LABEL_48;
    }
  }
  ...
  if ((v25 & 0x20) != 0)
  {
    if ((v26 & 0x20) == 0 || self->_publicKeyVersion != *(v4 + 32))
    {
      goto LABEL_48;
    }
  }
  ...
  if ((v25 & 2) != 0)
  {
    if ((v26 & 2) == 0 || self->_keyHealth != *(v4 + 18))
    {
      goto LABEL_48;
    }
  }
...
- (void)mergeFrom:(id)a3
{
  ...
  if (participantId)
  {
    ...
    objc_msgSend_mergeFrom_(participantId, v4, v6);
  }
  ...
  else
  {
    ...
    objc_msgSend_setParticipantId_(self, v4, v6);
  }
...
LABEL_7:
  ...
  if (userId)
  {
    ...
    objc_msgSend_mergeFrom_(userId, v4, v8);
  }
  ...
  else
  {
    ...
    objc_msgSend_setUserId_(self, v4, v8);
  }
...
LABEL_13:
  ...
  if (contactInformation)
  {
    ...
    objc_msgSend_mergeFrom_(contactInformation, v4, v10);
  }
  ...
  else
  {
    ...
    objc_msgSend_setContactInformation_(self, v4, v10);
  }
...
LABEL_21:
  ...
  self->_participantType = *(v4 + 24);
  *&self->_has |= 8u;
  if ((*(v4 + 76) & 0x10) != 0)
  {
LABEL_22:
    self->_permission = *(v4 + 25);
    *&self->_has |= 0x10u;
  }
...
LABEL_23:
  ...
  if (inviterId)
  {
    ...
    objc_msgSend_mergeFrom_(inviterId, v4, v13);
  }
  ...
  else
  {
    ...
    objc_msgSend_setInviterId_(self, v4, v13);
  }
...
LABEL_32:
  ...
  if (publicKey)
  {
    ...
    objc_msgSend_mergeFrom_(publicKey, v4, v15);
  }
  ...
  else
  {
    ...
    objc_msgSend_setPublicKey_(self, v4, v15);
  }
...
LABEL_40:
  ...
  if (protectionInfo)
  {
    ...
    objc_msgSend_mergeFrom_(protectionInfo, v4, v17);
  }
  ...
  else
  {
    ...
    objc_msgSend_setProtectionInfo_(self, v4, v17);
  }
...
LABEL_48:
  ...
  if (v18)
  {
    objc_msgSend_setOutOfNetworkPrivateKey_(self, v4, v18);
    v4 = v31;
  }
  ...
  if ((v19 & 4) != 0)
  {
    self->_outOfNetworkKeyType = *(v4 + 19);
    *&self->_has |= 4u;
    v19 = *(v4 + 76);
    if ((v19 & 0x20) == 0)
    {
...
LABEL_60:
  self->_acceptedInProcess = *(v4 + 144);
  *&self->_has |= 0x80u;
  if ((*(v4 + 76) & 0x800) != 0)
  {
LABEL_54:
    self->_isInNetwork = *(v4 + 148);
    *&self->_has |= 0x800u;
  }
...
LABEL_55:
  ...
  if (acceptedTimestampDate)
  {
    ...
    objc_msgSend_mergeFrom_(acceptedTimestampDate, v4, v21);
  }
  ...
  else
  {
    ...
    objc_msgSend_setAcceptedTimestampDate_(self, v4, v21);
  }
...
LABEL_65:
  ...
  if (v22)
  {
    objc_msgSend_setProtectionInfoPublicKey_(self, v4, v22);
    v4 = v31;
  }

  if ((*(v4 + 76) & 2) != 0)
  {
    self->_keyHealth = *(v4 + 18);
    *&self->_has |= 2u;
  }
  ...
  if (inviteTimestampDate)
  {
    ...
    objc_msgSend_mergeFrom_(inviteTimestampDate, v4, v24);
  }
  ...
  else
  {
    ...
    objc_msgSend_setInviteTimestampDate_(self, v4, v24);
  }
...
LABEL_77:
  ...
  if ((v25 & 0x200) != 0)
  {
    self->_isAnonymousInvitedParticipant = *(v4 + 146);
    *&self->_has |= 0x200u;
    v25 = *(v4 + 76);
  }
  ...
  if ((v25 & 0x400) != 0)
  {
    self->_isApprovedRequester = *(v4 + 147);
    *&self->_has |= 0x400u;
  }
  ...
  if (v26)
  {
    objc_msgSend_setEncryptedContactInformation_(self, v4, v26);
    v4 = v31;
  }
  ...
  if (inviteNSSecTimestampDate)
  {
    ...
    objc_msgSend_mergeFrom_(inviteNSSecTimestampDate, v4, v28);
  }
  ...
  else
  {
    ...
    objc_msgSend_setInviteNSSecTimestampDate_(self, v4, v28);
  }
...
LABEL_89:
  ...
  if (acceptedNSSecTimestampDate)
  {
    if (v30)
    {
      objc_msgSend_mergeFrom_(acceptedNSSecTimestampDate, v4, v30);
    }
  }

  else if (v30)
  {
    objc_msgSend_setAcceptedNSSecTimestampDate_(self, v4, v30);
  }
