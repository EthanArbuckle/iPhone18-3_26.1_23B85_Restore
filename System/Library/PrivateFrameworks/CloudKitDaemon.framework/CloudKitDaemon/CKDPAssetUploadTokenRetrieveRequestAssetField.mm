...
- (void)copyTo:(id)a3
{
  ...
  if (field)
  {
    objc_msgSend_setField_(v16, v4, field);
  }
  ...
  if (objc_msgSend_assetsCount(self, v4, field))
  {
    ...
    if (v10)
    {
      ...
      for (i = 0; i != v12; ++i)
      {
        ...
        objc_msgSend_addAssets_(v16, v15, v14);
      }
    }
  }
}
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v12 = objc_msgSend_copyWithZone_(self->_field, v11, a3);
  v13 = v10[2];
  v10[2] = v12;
...
- (BOOL)isEqual:(id)a3
{
  v4 = a3;
  v5 = objc_opt_class();
  if (objc_msgSend_isMemberOfClass_(v4, v6, v5) && ((field = self->_field, v9 = v4[2], !(field | v9)) || objc_msgSend_isEqual_(field, v7, v9)))
  {
    assets = self->_assets;
    v11 = v4[1];
    if (assets | v11)
