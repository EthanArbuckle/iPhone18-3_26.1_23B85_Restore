...
- (id)description
{
  ...
  v11.receiver = self;
  v11.super_class = CKCDPStopContainerRequest;
...
LABEL_15:
      ...
      if ((v31 >> 3) == 2)
      {
        v32 = &OBJC_IVAR___CKCDPStopContainerRequest__environment;
LABEL_21:
...
LABEL_23:
    ...
    v32 = &OBJC_IVAR___CKCDPStopContainerRequest__containerName;
    goto LABEL_21;
  }
