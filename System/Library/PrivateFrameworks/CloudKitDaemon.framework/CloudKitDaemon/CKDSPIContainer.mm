...
- (void)fetchPCSFromCacheForZoneWithZoneID:(id)a3 databaseScope:(int64_t)a4 localCacheOnly:(BOOL)a5 unitTestOverrides:(id)a6 completionHandler:(id)a7;
...
- (void)performSerializeRecordModificationsOperation:(id)a3 withBlock:(id)a4
{
  ...
  objc_msgSend_performOperation_initialMessageReplyBlock_(self, v14, v12, v7, v15, v16, v17, v18);
...
- (void)serverEnvironmentWithCompletionHandler:(id)a3
{
  ...
  objc_msgSend_fetchServerEnvironmentForOperation_withCompletionHandler_(self, v15, v14, v5);
}
...
- (void)performAggregateZonePCSOperation:(id)a3 withBlock:(id)a4
{
  ...
  v10 = objc_msgSend_containerForOperationInfo_(self, v9, v7);
  v13 = objc_msgSend_initWithOperationInfo_container_(v8, v11, v7, v10);

  objc_msgSend_performOperation_initialMessageReplyBlock_(self, v12, v13, v6);
}
...
- (void)showAssetCacheWithDatabaseScope:(int64_t)a3
{
  v4 = objc_msgSend_uncancellableOperationQueue(self, a2, a3);
...
- (void)clearRecordCacheWithDatabaseScope:(int64_t)a3
{
  v5 = objc_msgSend_uncancellableOperationQueue(self, a2, a3);
  v7[0] = MEMORY[0x277D85DD0];
  v7[1] = 3221225472;
  v7[2] = sub_225188330;
  v7[3] = &unk_278546110;
...
- (void)clearPILSCacheForLookupInfos:(id)a3
{
  ...
  objc_msgSend_removeCacheForLookupInfos_(v7, v8, v4);

  v12 = objc_msgSend_foregroundPublicIdentityLookupService(self, v9, v10);
  objc_msgSend_removeCacheForLookupInfos_(v12, v11, v4);
}
...
- (void)setFakeError:(id)a3 forNextRequestOfClassName:(id)a4 completionHandler:(id)a5
{
  ...
  v19 = objc_msgSend_objectForKeyedSubscript_(v17, v18, v35);

  if (!v19)
  {
    v22 = objc_opt_new();
    v25 = objc_msgSend_fakeErrorsByClassName(self, v23, v24);
    objc_msgSend_setObject_forKeyedSubscript_(v25, v26, v22, v35);
  }

  v27 = objc_msgSend_fakeErrorsByClassName(self, v20, v21);
  v29 = objc_msgSend_objectForKeyedSubscript_(v27, v28, v35);
  v30 = objc_alloc(MEMORY[0x277CBC7A0]);
  v31 = _Block_copy(v8);

  v33 = objc_msgSend_initWithObject1_object2_(v30, v32, v9, v31);
