...
- (void)copyTo:(id)to
{
  ...
  if (recordForOplockFailure)
  {
    objc_msgSend_setRecordForOplockFailure_(to, a2, recordForOplockFailure);
  }
}
...
- (id)copyWithZone:(_NSZone *)zone
{
  ...
  v12 = objc_msgSend_copyWithZone_(self->_recordForOplockFailure, v11, zone);
  v13 = v10[1];
  v10[1] = v12;
...
- (void)mergeFrom:(id)from
{
  ...
  if (recordForOplockFailure)
  {
    if (v6)
    {
      objc_msgSend_mergeFrom_(recordForOplockFailure, fromCopy, v6);
    }
  }

  else if (v6)
  {
    objc_msgSend_setRecordForOplockFailure_(self, fromCopy, v6);
  }
