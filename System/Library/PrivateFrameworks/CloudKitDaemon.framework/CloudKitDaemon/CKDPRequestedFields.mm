  ...
  if (v25)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        objc_msgSend__CKLogToFileHandle_atDepth_(*(*(&v54 + 1) + 8 * v30), v26, handleCopy, (depth + 1));
        if (v31 < v18)
        {
          v32 = sub_225199D20();
  ...
  if (v38)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        objc_msgSend__CKLogToFileHandle_atDepth_(*(*(&v50 + 1) + 8 * v42), v39, handleCopy, (depth + 1));
        if (v43 < v18)
        {
          v44 = sub_225199D20();
