...
- (id)contexts
{
  ...
  v9 = 0;
  v3 = [client getSubscriptionInfoWithError:&v9];
  v4 = v9;
...
- (BOOL)resetCellularDataStatisticsWithError:(id *)error
{
  ...
  if (!v4)
  {
    ...
    [currentHandler handleFailureInFunction:v12 file:@"WFCellularManager.m" lineNumber:37 description:{@"%s", dlerror()}];
...
- (BOOL)setDefaultVoiceLineToPlan:(id)plan error:(id *)error
{
  ...
  if (error)
  {
    ...
    v22[0] = client;
    ctContext = [MEMORY[0x277CBEAC0] dictionaryWithObjects:v22 forKeys:&v21 count:1];
...
- (NSArray)allPlans
{
  ...
  client = [(WFCellularPlansManager *)self client];
  v17 = 0;
  v6 = [client getSubscriptionInfoWithError:&v17];
  v7 = v17;
