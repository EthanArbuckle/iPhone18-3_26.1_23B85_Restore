...
- (WFImageRemoveBackgroundAction)initWithIdentifier:(id)identifier definition:(id)definition serializedParameters:(id)parameters;
...
- (WFImageRemoveBackgroundAction)initWithIdentifier:(id)identifier definition:(id)definition serializedParameters:(id)parameters
{
  ...
  return sub_23DEC7100(v7, v9, definition, parameters);
}
