...
- (WFIntercomAction)initWithIdentifier:(id)identifier definition:(id)definition serializedParameters:(id)parameters;
...
- (WFIntercomAction)initWithIdentifier:(id)identifier definition:(id)definition serializedParameters:(id)parameters
{
  ...
  return sub_23DEEAA44(v7, v9, definition, parameters);
}
