...
- (CDPCustodianRecoveryInfo)initWithCoder:(id)coder;
- (CDPCustodianRecoveryInfo)initWithWrappedRKC:(id)c wrappingKey:(id)key custodianUUID:(id)d recordBuildVersion:(id)version;
...
- (CDPCustodianRecoveryInfo)initWithWrappedRKC:(id)c wrappingKey:(id)key custodianUUID:(id)d recordBuildVersion:(id)version
{
  ...
  versionCopy = version;
  v18.receiver = self;
  v18.super_class = CDPCustodianRecoveryInfo;
...
- (id)copyWithZone:(_NSZone *)zone
{
  v4 = [[CDPCustodianRecoveryInfo allocWithZone:?]];
