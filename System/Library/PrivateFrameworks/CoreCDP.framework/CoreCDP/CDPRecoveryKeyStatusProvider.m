...
- (BOOL)isRecoveryKeySetInOctagonWithError:(id *)a3
{
  ...
  {
    v17 = 0;
    v5 = [MEMORY[0x1E697AA80] isRecoveryKeySetInOctagon:v4 error:&v17];
    v6 = v17;
    if (v6)
    {
      v7 = _CDPLogSystem();
  ...
  else
  {
    ...
    if (a3)
    {
      [MEMORY[0x1E696ABC0] cdp_errorWithCode:-5217 underlyingError:*a3];
      *a3 = v5 = 0;
    }
...
- (BOOL)isRecoveryKeySetInSOSWithError:(id *)a3
{
  v4 = [(CDPContext *)self->_context cliqueConfiguration];
  v16 = 0;
  v5 = [MEMORY[0x1E697AA80] isRecoveryKeySetInSOS:v4 error:&v16];
  v6 = v16;
  if (v6)
  {
    v7 = _CDPLogSystem();
...
- (void)idmsHasRK
{
  ...
  OUTLINED_FUNCTION_0_3(&dword_1DED99000, a1, a3, "%s: Can't find account. Returning...", a5, a6, a7, a8, 2u);
