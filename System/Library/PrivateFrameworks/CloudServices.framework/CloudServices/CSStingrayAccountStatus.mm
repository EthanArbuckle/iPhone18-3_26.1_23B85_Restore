...
- (void)copyTo:(id)to
{
  ...
  if (stingrayRecord)
  {
    objc_msgSend_setStingrayRecord_(toCopy, v5, stingrayRecord);
    toCopy = v10;
  }
...
- (id)copyWithZone:(_NSZone *)zone
{
  ...
  v12 = objc_msgSend_copyWithZone_(self->_stingrayRecord, v11, zone);
  v13 = v10[4];
  v10[4] = v12;

  v15 = objc_msgSend_copyWithZone_(self->_gfRecord, v14, zone);
  v16 = v10[3];
  v10[3] = v15;

  v18 = objc_msgSend_copyWithZone_(self->_dbrRecord, v17, zone);
  v19 = v10[1];
  v10[1] = v18;

  v21 = objc_msgSend_copyWithZone_(self->_fdeRecord, v20, zone);
  v22 = v10[2];
  v10[2] = v21;
...
- (BOOL)isEqual:(id)equal
{
  equalCopy = equal;
  v5 = objc_opt_class();
  if (objc_msgSend_isMemberOfClass_(equalCopy, v6, v5) && ((stingrayRecord = self->_stingrayRecord, v9 = equalCopy[4], !(stingrayRecord | v9)) || objc_msgSend_isEqual_(stingrayRecord, v7, v9)) && ((gfRecord = self->_gfRecord, v11 = equalCopy[3], !(gfRecord | v11)) || objc_msgSend_isEqual_(gfRecord, v7, v11)) && ((dbrRecord = self->_dbrRecord, v13 = equalCopy[1], !(dbrRecord | v13)) || objc_msgSend_isEqual_(dbrRecord, v7, v13)))
  {
    fdeRecord = self->_fdeRecord;
    v15 = equalCopy[2];
    if (fdeRecord | v15)
...
- (void)mergeFrom:(id)from
{
  ...
  if (stingrayRecord)
  {
    if (v6)
    {
      objc_msgSend_mergeFrom_(stingrayRecord, fromCopy, v6);
    }
  }

  else if (v6)
  {
    objc_msgSend_setStingrayRecord_(self, fromCopy, v6);
  }
