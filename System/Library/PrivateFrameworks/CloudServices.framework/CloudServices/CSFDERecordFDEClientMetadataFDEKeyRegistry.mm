...
- (void)copyTo:(id)a3
{
  ...
  if (entry)
  {
    objc_msgSend_setEntry_(a3, a2, entry);
  }
}
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v12 = objc_msgSend_copyWithZone_(self->_entry, v11, a3);
  v13 = v10[1];
  v10[1] = v12;
...
- (void)mergeFrom:(id)a3
{
  ...
  if (entry)
  {
    if (v6)
    {
      objc_msgSend_mergeFrom_(entry, v4, v6);
    }
  }

  else if (v6)
  {
    objc_msgSend_setEntry_(self, v4, v6);
  }
