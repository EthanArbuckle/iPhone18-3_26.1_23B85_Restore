...
+ (void)reportClient:(id)a3 withProcessName:(id)a4 clientUUID:(id)a5 platform:(id)a6 forReporter:(id)a7
{
  ...
  v13 = a6;
  v14 = a7;
  v15 = [MEMORY[0x277CCACA8] stringWithFormat:@"GraylistedClient/%@/%@", v18, v11];
  v16 = [v14 issueForTag:v15];

  if (!v16)
  {
    v17 = [(EntitlementABCIssue *)[GraylistedClientABCIssue alloc] initWithClient:v18 processName:v11 clientUUID:v12 platform:v13 forReporter:v14];
    [v14 addIssue:v17];
...
- (id)tag
{
  ...
  v7 = [v3 stringWithFormat:@"GraylistedClient/%@/%@/%@", v4, v5, v6];
