...
- (void)handleReactiveRecoveryRequest:()XPCHandling .cold.1()
{
...
- (void)handleReactiveRecoveryRequest:()XPCHandling .cold.2()
{
  v6 = *MEMORY[0x277D85DE8];
  OUTLINED_FUNCTION_3();
  _os_log_error_impl(v0, v1, v2, v3, v4, 0xCu);
...
- (void)handleReactiveRecoveryRequest:()XPCHandling .cold.3()
{
  v6 = *MEMORY[0x277D85DE8];
  OUTLINED_FUNCTION_3();
  _os_log_error_impl(v0, v1, v2, v3, v4, 0xCu);
...
- (void)handleIncomingMessage:()XPCHandling .cold.2()
{
  v6 = *MEMORY[0x277D85DE8];
  OUTLINED_FUNCTION_3();
