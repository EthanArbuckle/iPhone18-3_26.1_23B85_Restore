          ...
          else
          {
            ...
            if (v23 != 3)
            {
              if (v23 == 4)
              {
                ...
                if ([v18 _es_isCompatibleWithThisDevice] && sub_100003CCC(v21))
                {
      ...
      while (2)
      {
        for (i = 0; i != v17; i = i + 1)
        {
          ...
          if (v23)
          {
            ...
            if ([v20 _es_isCompatibleWithThisDevice] && (sub_100003CCC(v14) & 1) != 0)
            {
...
LABEL_25:
  ...
  if (v15 == 1)
  {
    ...
    else
    {
      ...
      v13 = [NSError errorWithDomain:@"kRXAssetDownloadErrorDomain" code:101 userInfo:&off_10001E1E0];
      if ([(RDAssetManager *)self sendCallback])
      {
