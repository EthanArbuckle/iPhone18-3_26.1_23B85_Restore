...
- (void)setHasFirstCollapsedViewTimestamp:(BOOL)timestamp;
- (void)setHasFirstScheduledViewTimestamp:(BOOL)timestamp;
- (void)setHasFirstUpcomingViewTimestamp:(BOOL)timestamp;
- (void)writeTo:(id)to;
@end
...
- (id)description
{
  ...
  dictionaryRepresentation = [(ATXPBDigestTimeline *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  if ((has & 8) != 0)
  {
    ...
    [dictionary setObject:v7 forKey:@"firstUpcomingViewTimestamp"];
...
LABEL_3:
  ...
  [dictionary setObject:v8 forKey:@"firstCollapsedViewTimestamp"];
...
LABEL_11:
  ...
  [dictionary setObject:v9 forKey:@"firstScheduledViewTimestamp"];

  if (*&self->_has)
  {
LABEL_5:
    v5 = [MEMORY[0x1E696AD98] numberWithDouble:self->_digestRemovedTimestamp];
    [dictionary setObject:v5 forKey:@"digestRemovedTimestamp"];
  }
...
- (void)copyTo:(id)to
{
  ...
  if ((has & 8) != 0)
  {
    toCopy[4] = *&self->_firstUpcomingViewTimestamp;
    *(toCopy + 40) |= 8u;
    has = self->_has;
    if ((has & 2) == 0)
    {
LABEL_3:
  ...
  toCopy[2] = *&self->_firstCollapsedViewTimestamp;
  *(toCopy + 40) |= 2u;
  has = self->_has;
  if ((has & 4) == 0)
  {
...
LABEL_11:
  toCopy[3] = *&self->_firstScheduledViewTimestamp;
  *(toCopy + 40) |= 4u;
  if (*&self->_has)
  {
LABEL_5:
    toCopy[1] = *&self->_digestRemovedTimestamp;
    *(toCopy + 40) |= 1u;
  }
...
- (BOOL)isEqual:(id)equal
{
  ...
  if ((*&self->_has & 8) != 0)
  {
    if ((*(equalCopy + 40) & 8) == 0 || self->_firstUpcomingViewTimestamp != *(equalCopy + 4))
    {
      goto LABEL_21;
    }
  }
...
LABEL_21:
  ...
  if ((*&self->_has & 2) != 0)
  {
    if ((*(equalCopy + 40) & 2) == 0 || self->_firstCollapsedViewTimestamp != *(equalCopy + 2))
    {
      goto LABEL_21;
    }
  }
  ...
  if ((*&self->_has & 4) != 0)
  {
    if ((*(equalCopy + 40) & 4) == 0 || self->_firstScheduledViewTimestamp != *(equalCopy + 3))
    {
      goto LABEL_21;
    }
  }
  ...
  if (*&self->_has)
  {
    if ((*(equalCopy + 40) & 1) == 0 || self->_digestRemovedTimestamp != *(equalCopy + 1))
    {
      goto LABEL_21;
    }
...
- (void)mergeFrom:(id)from
{
  ...
  if ((v5 & 8) != 0)
  {
    self->_firstUpcomingViewTimestamp = *(fromCopy + 4);
    *&self->_has |= 8u;
    v5 = *(fromCopy + 40);
    if ((v5 & 2) == 0)
    {
LABEL_3:
  ...
  self->_firstCollapsedViewTimestamp = *(fromCopy + 2);
  *&self->_has |= 2u;
  v5 = *(fromCopy + 40);
  if ((v5 & 4) == 0)
  {
...
LABEL_11:
  self->_firstScheduledViewTimestamp = *(fromCopy + 3);
  *&self->_has |= 4u;
  if (*(fromCopy + 40))
  {
LABEL_5:
    self->_digestRemovedTimestamp = *(fromCopy + 1);
    *&self->_has |= 1u;
  }
...
- (id)jsonRepresentation
{
  ...
  hasFirstUpcomingViewTimestamp = [(ATXPBDigestTimeline *)self hasFirstUpcomingViewTimestamp];
  if (hasFirstUpcomingViewTimestamp)
  {
    v3 = MEMORY[0x1E696AD98];
    [(ATXPBDigestTimeline *)self firstUpcomingViewTimestamp];
    v20 = [v3 numberWithDouble:?];
    null = [ATXJSONHelper wrapObject:?];
  }
  ...
  hasFirstCollapsedViewTimestamp = [(ATXPBDigestTimeline *)self hasFirstCollapsedViewTimestamp];
  if (hasFirstCollapsedViewTimestamp)
  {
    v5 = MEMORY[0x1E696AD98];
    [(ATXPBDigestTimeline *)self firstCollapsedViewTimestamp];
    v19 = [v5 numberWithDouble:?];
    null2 = [ATXJSONHelper wrapObject:?];
  }
  ...
  hasFirstScheduledViewTimestamp = [(ATXPBDigestTimeline *)self hasFirstScheduledViewTimestamp];
  v8 = off_1E80BF000;
  if (hasFirstScheduledViewTimestamp)
  {
    v9 = MEMORY[0x1E696AD98];
    [(ATXPBDigestTimeline *)self firstScheduledViewTimestamp];
    v10 = [v9 numberWithDouble:?];
    null3 = [ATXJSONHelper wrapObject:v10];
  }
  ...
  hasDigestRemovedTimestamp = [(ATXPBDigestTimeline *)self hasDigestRemovedTimestamp];
  if (hasDigestRemovedTimestamp)
  {
