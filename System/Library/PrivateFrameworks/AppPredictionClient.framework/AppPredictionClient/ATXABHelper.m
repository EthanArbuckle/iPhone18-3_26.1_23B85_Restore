...
+ (id)abGroupForConsumerSubType:(unsigned __int8)a3
{
  ...
  if (v5 || (v15 = abGroupForConsumerSubType__cache, objc_sync_enter(v15), v16 = abGroupForConsumerSubType__cache, [MEMORY[0x1E696AD98] numberWithUnsignedChar:v3], v17 = objc_claimAutoreleasedReturnValue(), objc_msgSend(v16, "objectForKeyedSubscript:", v17), v18 = objc_claimAutoreleasedReturnValue(), v17, objc_sync_exit(v15), v15, !v18))
  {
    ...
    if (!v5)
    {
      ...
      v21 = [MEMORY[0x1E696AD98] numberWithUnsignedChar:v3];
