...
- (ATXModeConfigurationUIFlowLoggingBiomeStream)initWithStoreConfig:(id)config;
@end
...
- (ATXModeConfigurationUIFlowLoggingBiomeStream)initWithStoreConfig:(id)config
{
  ...
  if (v5)
  {
    ...
    v7 = atx_storeConfig;
    v8 = [objc_alloc(MEMORY[0x1E698F318]) initWithPrivateStreamIdentifier:@"modeConfigurationUIFlowLoggingEvent" storeConfig:atx_storeConfig eventDataClass:objc_opt_class()];
    inner = v5->_inner;
    v5->_inner = v8;
  }
