...
- (void)copyTo:(id)a3
{
  ...
  if (has)
  {
    v4[1] = *&self->_expirationTimestamp;
    *(v4 + 24) |= 1u;
    has = self->_has;
  }
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (*&self->_has)
  {
    if ((*(v4 + 24) & 1) == 0 || self->_expirationTimestamp != *(v4 + 1))
    {
      goto LABEL_11;
    }
  }
...
LABEL_11:
  ...
  if ((*&self->_has & 2) != 0)
  {
    if ((*(v4 + 24) & 2) == 0 || self->_pauseDuration != *(v4 + 2))
    {
      goto LABEL_11;
    }
...
- (void)mergeFrom:(id)a3
{
  ...
  if (v5)
  {
    self->_expirationTimestamp = *(v4 + 1);
    *&self->_has |= 1u;
    v5 = *(v4 + 24);
  }
