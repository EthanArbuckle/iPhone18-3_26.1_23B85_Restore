...
- (ATXInterruptionManager)initWithModesModels:(id)a3 notificationSettingsReader:(id)a4 modeConfigurationClient:(id)a5
{
  ...
  if (v12)
  {
    objc_storeStrong(&v12->_modesModels, a3);
    objc_storeStrong(&v13->_notificationSettingsReader, a4);
    objc_storeStrong(&v13->_modeConfigurationClient, a5);
...
- (BOOL)appSatisfiesRelevanceCriteriaForAllowOrSilenceList:(id)a3
{
  ...
  v6 = [v5 objectForKeyedSubscript:@"correlationEntitySpecificFeatures"];
  v7 = [v6 objectForKeyedSubscript:@"notificationsReceivedInLastTwoWeeks"];

  v8 = [v5 objectForKeyedSubscript:@"correlationNumGlobalOccurrences"];
...
- (id)recommendedDeniedContactsForMode:(unint64_t)a3 options:(unint64_t)a4
{
  ...
  v6 = [(ATXModeEntityScorerProtocol *)self->_modesModels rankedContactsForDenyListForMode:a3 options:a4];
  v12 = 0;
  v13 = &v12;
  v14 = 0x2020000000;
  v15 = 0;
