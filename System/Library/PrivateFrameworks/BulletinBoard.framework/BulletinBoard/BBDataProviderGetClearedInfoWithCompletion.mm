...
void ___BBDataProviderGetClearedInfoWithCompletion_block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(BBLogGeneral, OS_LOG_TYPE_DEFAULT))
  {
    ...
    v8 = 138543362;
    v9 = v3;
    _os_log_impl(&dword_241EFF000, v2, OS_LOG_TYPE_DEFAULT, "BBDataProvider: Get cleared info for section %{public}@", &v8, 0xCu);
  }

  v4 = objc_autoreleasePoolPush();
  v5 = [__server _clearedInfoForSectionID:*(a1 + 32)];
  v6 = *(a1 + 40);
  if (v6)
  {
    (*(v6 + 16))(v6, v5);
