...
- (void)updateTextures:(unsigned __int8)a3 textureManager:(void *)a4
{
  ...
  if (v38 == 1)
  {
    ...
    if (size)
    {
      [(VKPolygonGroup *)self _textureForName:&v34 textureManager:a4];
    ...
    *&__p.__r_.__value_.__l.__data_ = 0uLL;
    ...
    v18 = v35[3];
    if (gss::QueryableLocker<gss::PropertyID>::hasTargetValueForKeyAtZ(v18, 0x88u, v5))
    {
    ...
    *&v32.__r_.__value_.__l.__data_ = 0uLL;
    ...
    v26 = v35[3];
    if (gss::QueryableLocker<gss::PropertyID>::hasTargetValueForKeyAtZ(v26, 0x14Du, v5))
    {
      ...
      if (v27)
      {
        [(VKPolygonGroup *)self _textureForName:&v32 textureManager:a4];
        v28 = v31;
      }
...
- (unsigned)styleIndexForAttributes:(const void *)a3 edgePair:(const GeoCodecsFeatureStylePair *)a4
{
  geo::codec::copyFeatureStyleAttributes(&v12, *a3);
  v6 = v12;
  FeatureStyleAttributes::replaceAttributes(v12, a4, 1);
  v7 = v13;
  v10 = v6;
  v11 = v13;
  if (v13)
...
- (BOOL)addFillForSection:(const void *)a3 precision:(unsigned __int8)a4 styleIndex:(unsigned int)a5 cullingMask:(unsigned int)a6 accessor:(ResourceAccessor *)a7 triangulator:(void *)a8
{
  md::Triangulator<float>::triangulate(a8, *(a3 + 1), *(a3 + 11));
  if (*(a8 + 12) != *(a8 + 11))
  {
...
- (void)addPolygon:(void *)a3 accessor:(ResourceAccessor *)a4 triangulator:(void *)a5 withRounder:(PolygonRound *)a6
{
  v9 = *(a3 + 24);
  v20 = 0;
  StrokeSpecifications = geo::codec::polygonFeatureGetStrokeSpecifications(a3, &v20);
  ...
  if (v9)
  {
    ...
    for (i = 0; i != v9; ++i)
    {
      ...
      v19 = 0;
      v15 = geo::codec::multiSectionFeaturePoints(a3, i, &v19);
      __p = 0;
      v17 = 0;
      v18 = 0;
      [(VKPolygonGroup *)self createStrokePointStyleList:a3 section:i outPointStyles:&__p withRounder:a6];
      if (geo::codec::multiSectionFeaturePrecision(a3) <= 0x10 && v19 >= 3)
      {
...
- (void)willAddDataWithAccessor:(ResourceAccessor *)a3
{
  ...
  {
    ggl::DataAccess<ggl::TrafficBase::DefaultVbo>::DataAccess(v13, **(*v9 + 64), 0, *p_strokeMeshInfo->var0.__val_._vertexAndIndexCounts.__begin_, a3);
    ggl::BufferMemory::operator=(&self->_strokeMeshInfo.var0.__val_._vertexDataWrite, v13);
    ggl::BufferMemory::~BufferMemory(v13);
    ggl::DataAccess<ggl::DaVinci::TexturedCompressedVbo>::DataAccess(v13, *(*self->_strokeMeshInfo.var0.__val_._meshes.__begin_ + 96), 0, *(self->_strokeMeshInfo.var0.__val_._vertexAndIndexCounts.__begin_ + 1), 1, 1, a3);
...
- (void)prepareToStrokeSection:(const void *)a3 key:(const void *)a4 styles:(void *)a5 paddedCount:(unsigned int)a6
{
  ...
  if (v11)
  {
    ...
    {
      v15 = *(*a5 + 12 * v13) + v12;
      if ((*(*(a3 + 8) + ((v13 >> 3) & 0x1FFFFFFFFFFFFFF8)) >> v13))
      {
        v16 = v13 + 1;
        v12 = v15 + 1;
      }
...
- (void)prepareForPolygon:(void *)a3 withRounder:(PolygonRound *)a4
{
  v7 = *(a3 + 24);
  v25 = 0;
  StrokeSpecifications = geo::codec::polygonFeatureGetStrokeSpecifications(a3, &v25);
  [(VKPolygonalItemGroup *)self indexForGeoFeatureAttributes:a3 + 24];
  if (v25)
  {
    v9 = 0;
    ...
    do
    {
      ...
      v10 += 4;
      HIDWORD(v17) = v11;
      geo::codec::copyFeatureStyleAttributes(&__p, *(a3 + 3));
      v12 = __p;
  ...
  v22 = 0x100000038;
  geo::codec::copyFeatureStyleAttributes(&v23, *(a3 + 3));
  v14 = v23;
  ...
  if (v7)
  {
    ...
    {
      v21 = 0;
      geo::codec::multiSectionFeaturePoints(a3, i, &v21);
      __p = 0;
      v19 = 0;
      v20 = 0;
      [(VKPolygonGroup *)self createStrokePointStyleList:a3 section:i outPointStyles:&__p withRounder:a4];
      if (v21 >= 3)
      {
        if (a4)
        {
...
- (unsigned)createStrokePointStyleList:(void *)a3 section:(unint64_t)a4 outPointStyles:(void *)a5 withRounder:(PolygonRound *)a6
{
  ...
  v68 = 0;
  StrokeSpecifications = geo::codec::polygonFeatureGetStrokeSpecifications(a3, &v68);
  v67 = 0;
  CharacteristicPoints = geo::codec::polygonFeatureGetCharacteristicPoints(a3, &v67);
  if (v68)
  {
    v10 = 0;
  ...
  v66 = 0;
  v58 = geo::codec::multiSectionFeaturePoints(a3, a4, &v66);
  v16 = v66;
  if (v66 < 3)
  {
    v17 = 0;
  ...
  do
  {
    if (v10 < v68 && (v19 = (StrokeSpecifications + 16 * v10), HIDWORD(v19->__vftable) == a4) && v18 == LODWORD(v19->__shared_owners_))
    {
    ...
    else if (v13 < v67 && (v21 = CharacteristicPoints + 100 * v13, *(v21 + 2) == a4) && v18 == *(v21 + 3))
    {
      v20 = v21[28] & 1;
      if (v20)
      {
    ...
    else if (v13 && (v23 = CharacteristicPoints + 100 * v13, *(v23 - 23) == a4) && v18 == *(v23 - 22) + 1)
    {
      v20 = *(v23 - 72) & 1;
      if (v20)
      {
...
LABEL_35:
        ...
        if (v26 >= v25)
        {
          v45 = 0xAAAAAAAAAAAAAAABLL * ((v26 - *a5) >> 2);
          v46 = v45 + 1;
...
LABEL_79:
          ...
          v47 = 0xAAAAAAAAAAAAAAABLL * ((v25 - *a5) >> 2);
          if (2 * v47 > v46)
          {
            v46 = 2 * v47;
          }
    ...
    md::PolygonRound::smoothTwoSegments(&__p, &a6->var0, v69);
    v32 = __p;
    if (v65 != __p)
    {
      v61 = v18 + 1;
      ...
      do
      {
        ...
        if (v34 >= v36)
        {
          v37 = 0xAAAAAAAAAAAAAAABLL * ((v34 - *a5) >> 2);
          v38 = v37 + 1;
          ...
          v39 = 0xAAAAAAAAAAAAAAABLL * ((v36 - *a5) >> 2);
          if (2 * v39 > v38)
          {
            v38 = 2 * v39;
          }
...
- (VKPolygonGroup)initWithStyleQuery:(void *)a3 tileZoom:(float)a4 fixedAroundCentroid:(const void *)a5 contentScale:(float)a6 storage:(shared_ptr<md::MeshSetStorage>)a7
{
  ...
  v9 = [(VKPolygonalItemGroup *)&v17 initWithStyleQuery:a3 tileZoom:a5 fixedAroundCentroid:&v18 contentScale:a7.__cntrl_ storage:?];
  if (v19)
  {
    std::__shared_weak_count::__release_shared[abi:nn200100](v19);
  }
...
- (VKPolygonGroup)initWithStyleQuery:(void *)a3 tileZoom:(float)a4 fixedAroundCentroid:(const void *)a5 contentScale:(float)a6
{
  v8 = 0;
  v9 = 0;
  v6 = [VKPolygonGroup initWithStyleQuery:"initWithStyleQuery:tileZoom:fixedAroundCentroid:contentScale:storage:" tileZoom:a3 fixedAroundCentroid:a5 contentScale:&v8 storage:?];
  if (v9)
  {
    std::__shared_weak_count::__release_shared[abi:nn200100](v9);
  }
