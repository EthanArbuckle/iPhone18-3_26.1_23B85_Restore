...
- (void)start
{
  ...
  obj = keyList;
  v4 = [keyList countByEnumeratingWithState:&v26 objects:v30 count:16];
  if (v4)
  {
    v20 = *v27;
    do
    {
      ...
      for (i = 0; i != v21; ++i)
      {
        ...
        0x3F = [MEMORY[0x1E696AEC0] stringWithFormat:@"%u", *(v6 + 6) & 0x3F];
        v8 = [v25 stringByAppendingPathComponent:0x3F];
        v9 = [MEMORY[0x1E696AEC0] stringWithFormat:@"%u", *(v6 + 6) >> 6];
        v10 = [v8 stringByAppendingPathComponent:v9];
        0x3FFFFFF = [MEMORY[0x1E696AEC0] stringWithFormat:@"%u", *(v6 + 10) & 0x3FFFFFF];
        v12 = [v10 stringByAppendingPathComponent:0x3FFFFFF];
        ...
        delegate = [(GEOTileRequester *)self delegate];
        if (v15)
        {
          v17 = [objc_alloc(MEMORY[0x1E69A2600]) initWithData:v15];
          [delegate tileRequester:self receivedData:v17 tileEdition:1 tileSetDB:1 tileSet:0 etag:0 forKey:*v6 userInfo:{v6[1], 0}];
        }

        else
        {
          v17 = [MEMORY[0x1E696ABC0] errorWithDomain:@"VKTestTileRequesterDomain" code:42 userInfo:0];
          [delegate tileRequester:self receivedError:v17 forKey:{*v6, v6[1]}];
        }
      }
  ...
  delegate2 = [(GEOTileRequester *)self delegate];
  [delegate2 tileRequesterFinished:self];
}
