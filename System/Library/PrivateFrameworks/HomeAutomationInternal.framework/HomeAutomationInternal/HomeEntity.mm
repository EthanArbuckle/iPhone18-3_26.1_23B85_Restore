...
- (HomeEntity)initWithCoder:(id)coder;
- (HomeEntity)initWithIdentifier:(id)identifier displayString:(id)string pronunciationHint:(id)hint;
@end
...
- (HomeEntity)initWithCoder:(id)coder
{
  ...
  coderCopy = coder;
  v5 = [(HomeEntity *)&v7 initWithCoder:coderCopy];
