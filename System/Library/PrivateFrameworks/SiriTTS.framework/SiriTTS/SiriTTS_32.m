...
LABEL_5:
  ...
  {
    v4 = qword_1C37AB4E0[(*(a1 + 136 + i[1]) - 5)];
    goto LABEL_5;
  }
...
char *FileFullPath(char *result, _BYTE *a2, unsigned __int8 *a3)
{
  *result = 0;
  if (!a3)
  {
...
LABEL_52:
  ...
  if (*v12)
  {
    ...
    {
      v14 = v30[v10];
      if ((v14 - 48) < 0xAu || (v30[v10] - 65 <= 0x25 ? (v15 = ((1 << (v14 - 65)) & 0x3F0000003FLL) == 0) : (v15 = 1), !v15))
      {
        v16 = v12[2];
        if ((v16 - 48) < 0xAu || (v16 - 65 <= 0x25 ? (v17 = ((1 << (v16 - 65)) & 0x3F0000003FLL) == 0) : (v17 = 1), !v17))
        {
          LODWORD(v18) = 0;
          v31 = v30[v10];
          v10 += 2;
          ...
          while (v27);
          __sprintf_chk(&v31, 0, 3uLL, "%c", v18);
          a3 = v28;
          result = v29;
          v29[v11] = v31;
        }
...
char *UriCompleteUrl(char *__src, char *a2, char *__dst)
{
  v4 = __src;
...
LABEL_13:
    ...
    if (v6 == 47)
    {
      v17 = v16;
      v18 = strchr(v4, 58);
      if (!v18 || (v19 = v18, (__src = strchr(v4, 47)) != 0) && v19 >= __src)
      {
        __srca[0] = 0;
      }
      ...
      v24 = strchr(v4, 47);
      if (!v24 || (v25 = v24, v26 = v24 - v4, v24 - v4 + 1 >= v17) || *v24 != 47)
      {
        LOBYTE(v32[0]) = 0;
LABEL_37:
        if (__srca[0])
        {
          v28 = strcpy(__dst, __srca);
          *&__dst[strlen(v28)] = 58;
        }
...
LABEL_12:
  v11 = (v5 - v9);
  result = heap_Calloc(a1, 1, (v11 + 1));
  if (result)
  {
    result = strncpy(result, &__s[v9], v11);
    result[v11] = 0;
  }
...
void *strhelper_Strdup(uint64_t a1, char *__s)
{
  ...
  return memcpy(v5, __s, v4 + 1);
}

char *strhelper_SafeStrtok(uint64_t a1, char *__s, uint64_t *a3)
{
  v3 = *a3;
  v4 = (a1 + *a3);
  v5 = *v4;
...
{
  v1 = glob_heap_Realloc;
  v2 = glob_heap_Free;
  if (result)
  {
    global_hooks = glob_heap_Alloc;
    v3 = *result;
    if (!*result)
    {
      v3 = glob_heap_Alloc;
    ...
    if (v2 == glob_heap_Free && v3 == glob_heap_Alloc)
    {
      v1 = glob_heap_Realloc;
    }
...
uint64_t hashtable_Dump(uint64_t a1)
{
  ...
  {
    if (LH_stricmp(v9, "stdout"))
    {
      if (LH_stricmp(v9, "trace"))
      {
        result = fopen(v9, "w");
        v12 = result;
        if (!result)
...
LABEL_12:
  ...
  __sprintf_chk(v37, 0, 0x1000uLL, "<HASH address=%p title=%s type=%s>", v6, v11, v16);
  if (v12)
  {
    fputs(v37, v12);
    fputs("\n", v12);
  ...
  {
    log_OutText(*(*(v6 + 96) + 32), "HASHTABLE", 4, 0, "%s", v17, v18, v19, v37);
  }
  ...
  if (*(v6 + 16))
  {
    ...
    do
    {
      ...
      if (v21)
      {
        __sprintf_chk(v37, 0, 0x1000uLL, "<ELEM value=%lu>", v20);
        if (v12)
        {
          fputs(v37, v12);
          fputs("\n", v12);
        ...
        {
          log_OutText(*(*(v6 + 96) + 32), "HASHTABLE", 4, 0, "%s", v22, v23, v24, v37);
        }
        ...
        do
        {
          while (1)
          {
            ...
            {
              __sprintf_chk(v36, 0, 0x50uLL, "%s", v21[1]);
            }

            v25 = *v21;
            if (*(v6 + 8) == 1)
            {
              __sprintf_chk(v37, 0, 0x1000uLL, "<DUPLA key =%lu value = %s/>");
            }

            else
            {
              __sprintf_chk(v37, 0, 0x1000uLL, "<DUPLA key =%s value = %s/>");
            }
            ...
            if (!v21)
            {
              __sprintf_chk(v37, 0, 0x1000uLL, "</ELEM>");
              fputs(v37, v12);
              fputs("\n", v12);
              goto LABEL_37;
            }
          ...
          log_OutText(*(*(v6 + 96) + 32), "HASHTABLE", 4, 0, "%s", v26, v27, v28, v37);
          v21 = v21[2];
        }

        while (v21);
        __sprintf_chk(v37, 0, 0x1000uLL, "</ELEM>");
        log_OutText(*(*(v6 + 96) + 32), "HASHTABLE", 4, 0, "%s", v29, v30, v31, v37);
      }
...
LABEL_37:
  ...
  __sprintf_chk(v37, 0, 0x1000uLL, "</HASH>");
  if (v12)
  {
    fputs(v37, v12);
    result = fputs("\n", v12);
    if (v12 != *MEMORY[0x1E69E9858] && v12 != *MEMORY[0x1E69E9848])
    {
      result = fclose(v12);
    }
  }
  ...
  {
    result = log_OutText(*(*(v6 + 96) + 32), "HASHTABLE", 4, 0, "%s", v32, v33, v34, v37);
  }
...
uint64_t Num2Hashval(void *a1, const void *a2)
{
  *&v11[19] = *MEMORY[0x1E69E9840];
  __sprintf_chk(&v10, 0, 0x14uLL, "%p", a2);
  v3 = a1[5];
  if (v3)
  {
    result = v3(&v10, a1[6]);
