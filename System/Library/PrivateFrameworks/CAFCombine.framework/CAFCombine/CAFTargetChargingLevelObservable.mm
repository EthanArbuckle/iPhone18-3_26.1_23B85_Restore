...
- (void)chargingLevelService:(id)a3 didUpdateChargingLevel:(id)a4
{
  ...
  v11 = a3;
  v12 = self;
  CAFTargetChargingLevelObservable.chargingLevelService(_:didUpdateChargingLevel:)(v12, v10);
...
- (void)serviceDidUpdate:(id)a3 characteristic:(id)a4 fromGroupUpdate:(BOOL)a5
{
  ...
  v9 = a4;
  v11 = self;
  CAFTargetChargingLevelObservable.serviceDidUpdate(_:characteristic:fromGroupUpdate:)(v11, v10, a5);
}
...
- (void)serviceDidUpdate:(id)a3 receivedAllValues:(BOOL)a4
{
  v6 = a3;
  v7 = self;
  CAFTargetChargingLevelObservable.serviceDidUpdate(_:receivedAllValues:)(v7, a4);
}
