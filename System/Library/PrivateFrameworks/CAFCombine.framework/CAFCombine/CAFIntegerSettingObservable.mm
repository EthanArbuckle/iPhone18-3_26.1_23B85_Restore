...
- (void)automakerSettingService:(id)service didUpdateProminenceInfo:(id)info
{
  ...
  infoCopy = info;
  selfCopy = self;
  CAFIntegerSettingObservable.automakerSettingService(_:didUpdateProminenceInfo:)(selfCopy, info);
}
...
- (void)serviceDidUpdate:(id)update characteristic:(id)characteristic fromGroupUpdate:(BOOL)groupUpdate
{
  ...
  selfCopy = self;
  CAFIntegerSettingObservable.serviceDidUpdate(_:characteristic:fromGroupUpdate:)(selfCopy, v10, groupUpdate);
}
...
- (void)serviceDidUpdate:(id)update receivedAllValues:(BOOL)values
{
  updateCopy = update;
  selfCopy = self;
  CAFIntegerSettingObservable.serviceDidUpdate(_:receivedAllValues:)(selfCopy, values);
}
