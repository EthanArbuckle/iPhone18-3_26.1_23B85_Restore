...
- (void)serviceDidUpdate:(id)update characteristic:(id)characteristic fromGroupUpdate:(BOOL)groupUpdate
{
  ...
  selfCopy = self;
  CAFVehicleVariantObservable.serviceDidUpdate(_:characteristic:fromGroupUpdate:)(selfCopy, v10, groupUpdate);
}
...
- (void)serviceDidUpdate:(id)update receivedAllValues:(BOOL)values
{
  updateCopy = update;
  selfCopy = self;
  CAFVehicleVariantObservable.serviceDidUpdate(_:receivedAllValues:)(selfCopy, values);
}
