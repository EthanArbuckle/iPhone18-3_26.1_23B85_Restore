...
- (WLKSearchWatchListRequestOperation)initWithQuery:(id)query caller:(id)caller;
...
- (WLKSearchWatchListRequestOperation)initWithQuery:(id)query caller:(id)caller
{
  v5 = [WLKURLRequestProperties requestPropertiesWithEndpoint:@"watchlist/search" queryParameters:query httpMethod:0 caller:caller];
  v8.receiver = self;
  v8.super_class = WLKSearchWatchListRequestOperation;
