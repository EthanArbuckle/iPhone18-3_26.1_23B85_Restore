...
- (void)makeRequestWithCompletion:(id)a3
{
  ...
  if (v6)
  {
    if (self->_canonicalID)
    {
      ...
      v10 = [(WLKWatchListModificationRequestOperation *)v7 initWithAction:0 canonicalID:canonicalID caller:v9];
    }
    ...
    else
    {
      ...
      v9 = [(WLKRequest *)self caller];
      v10 = [(WLKWatchListModificationRequestOperation *)v13 initWithAction:0 statsID:statsID caller:v9];
    }
