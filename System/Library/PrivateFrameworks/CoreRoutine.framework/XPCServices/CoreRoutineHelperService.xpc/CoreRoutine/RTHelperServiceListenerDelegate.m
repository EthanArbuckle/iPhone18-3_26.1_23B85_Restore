...
- (void)_configureXpcInterface:(id)a3
{
  ...
  [v3 setClasses:v20 forSelector:"inferLocalBluePOIWithReferenceLocation:locations:accessPoints:bluePOITile:signalEnv:refreshAOI:handler:" argumentIndex:0 ofReply:0];

  v21 = objc_opt_class();
  v22 = [NSSet setWithObjects:v21, objc_opt_class(), 0];
  [v3 setClasses:v22 forSelector:"inferLocalBluePOIWithReferenceLocation:locations:accessPoints:bluePOITile:signalEnv:refreshAOI:handler:" argumentIndex:1 ofReply:0];

  v23 = objc_opt_class();
  v24 = [NSSet setWithObjects:v23, objc_opt_class(), 0];
  [v3 setClasses:v24 forSelector:"inferLocalBluePOIWithReferenceLocation:locations:accessPoints:bluePOITile:signalEnv:refreshAOI:handler:" argumentIndex:2 ofReply:0];

  v25 = [NSSet setWithObjects:objc_opt_class(), 0];
  [v3 setClasses:v25 forSelector:"inferLocalBluePOIWithReferenceLocation:locations:accessPoints:bluePOITile:signalEnv:refreshAOI:handler:" argumentIndex:3 ofReply:0];

  v26 = objc_opt_class();
  v27 = [NSSet setWithObjects:v26, objc_opt_class(), 0];
  [v3 setClasses:v27 forSelector:"downloadBluePOITilesForDownloadKeys:handler:" argumentIndex:0 ofReply:0];

  v28 = [NSSet setWithObject:objc_opt_class()];
  [v3 setClasses:v28 forSelector:"fetchConfidenceWeightForMapItem:startDate:endDate:options:handler:" argumentIndex:0 ofReply:0];

  v29 = [NSSet setWithObject:objc_opt_class()];
  [v3 setClasses:v29 forSelector:"fetchConfidenceWeightForMapItem:startDate:endDate:options:handler:" argumentIndex:1 ofReply:0];

  v30 = [NSSet setWithObject:objc_opt_class()];
  [v3 setClasses:v30 forSelector:"fetchConfidenceWeightForMapItem:startDate:endDate:options:handler:" argumentIndex:2 ofReply:0];

  v31 = [NSSet setWithObject:objc_opt_class()];
  [v3 setClasses:v31 forSelector:"fetchConfidenceWeightForMapItem:startDate:endDate:options:handler:" argumentIndex:3 ofReply:0];

  v32 = objc_opt_class();
  v33 = [NSSet setWithObjects:v32, objc_opt_class(), 0];
  [v3 setClasses:v33 forSelector:"fetchBluePOITilesForDownloadKeys:handler:" argumentIndex:0 ofReply:0];

  v34 = [NSSet setWithObjects:objc_opt_class(), 0];
  [v3 setClasses:v34 forSelector:"computeWithInputSignals:handler:" argumentIndex:0 ofReply:0];
}
