...
- (RTStoredLocationEnumerationContext)initWithCoder:(id)coder;
- (RTStoredLocationEnumerationContext)initWithEnumerationOptions:(id)options offset:(unint64_t)offset;
...
- (id)copyWithZone:(_NSZone *)zone
{
  ...
  options = [(RTStoredLocationEnumerationContext *)self options];
  v6 = [v4 initWithEnumerationOptions:options offset:{-[RTStoredLocationEnumerationContext offset](self, "offset")}];
...
- (BOOL)isEqual:(id)equal
{
  ...
  {
    v6 = equalCopy && (objc_opt_class(), (objc_opt_isKindOfClass() & 1) != 0) && [(RTStoredLocationEnumerationContext *)self isEqualToContext:v5];
  }
...
LABEL_4:
    options = [v6 options];
    v10 = [(RTStoredLocationEnumerationOptions *)v8 isEqual:options];
