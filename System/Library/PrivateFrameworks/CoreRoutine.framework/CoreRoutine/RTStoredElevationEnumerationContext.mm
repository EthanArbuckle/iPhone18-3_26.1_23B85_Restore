...
- (RTStoredElevationEnumerationContext)initWithCoder:(id)coder;
- (RTStoredElevationEnumerationContext)initWithEnumerationOptions:(id)options offset:(unint64_t)offset;
...
- (RTStoredElevationEnumerationContext)initWithEnumerationOptions:(id)options offset:(unint64_t)offset
{
  optionsCopy = options;
  v11.receiver = self;
  v11.super_class = RTStoredElevationEnumerationContext;
...
- (id)copyWithZone:(_NSZone *)zone
{
  ...
  options = [(RTStoredElevationEnumerationContext *)self options];
  v6 = [v4 initWithEnumerationOptions:options offset:{-[RTStoredElevationEnumerationContext offset](self, "offset")}];
...
- (BOOL)isEqual:(id)equal
{
  ...
  {
    v6 = equalCopy && (objc_opt_class(), (objc_opt_isKindOfClass() & 1) != 0) && [(RTStoredElevationEnumerationContext *)self isEqualToContext:v5];
  }
...
LABEL_4:
    options = [v6 options];
    v10 = [(RTStoredElevationEnumerationOptions *)v8 isEqual:options];
...
- (unint64_t)hash
{
  v3 = [(RTStoredElevationEnumerationOptions *)self->_options hash];
