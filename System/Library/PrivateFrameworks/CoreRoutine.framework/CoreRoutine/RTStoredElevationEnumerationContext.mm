...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v6 = [v4 initWithEnumerationOptions:v5 offset:{-[RTStoredElevationEnumerationContext offset](self, "offset")}];
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    v6 = v4 && (objc_opt_class(), (objc_opt_isKindOfClass() & 1) != 0) && [(RTStoredElevationEnumerationContext *)self isEqualToContext:v5];
  }
...
LABEL_4:
    v9 = [v6 options];
    v10 = [(RTStoredElevationEnumerationOptions *)v8 isEqual:v9];
