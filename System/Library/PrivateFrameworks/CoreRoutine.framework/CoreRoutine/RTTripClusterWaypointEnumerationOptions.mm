...
- (RTTripClusterWaypointEnumerationOptions)initWithClusterID:(id)d;
- (RTTripClusterWaypointEnumerationOptions)initWithCoder:(id)coder;
- (RTTripClusterWaypointEnumerationOptions)initWithbatchSize:(unint64_t)size;
...
- (BOOL)isEqual:(id)equal
{
  ...
  {
    v6 = equalCopy && (objc_opt_class(), (objc_opt_isKindOfClass() & 1) != 0) && [(RTTripClusterWaypointEnumerationOptions *)self isEqualToOptions:v5];
  }
