...
- (DetectedROI)initWithTrackingSessionId:(unint64_t)a3 roiId:(int64_t)a4 roi:(CGRect)a5 trackId:(int)a6;
@end
...
- (DetectedROI)initWithTrackingSessionId:(unint64_t)a3 roiId:(int64_t)a4 roi:(CGRect)a5 trackId:(int)a6
{
  result = [(DetectedROI *)self initWithTrackingSessionId:a3 roiId:a4 andRoi:a5.origin.x, a5.origin.y, a5.size.width, a5.size.height];
  result->_trackID = a6;
  return result;
}
...
- (DetectedROI)initWithTrackingSessionId:(unint64_t)a3 roiId:(int64_t)a4 roi:(CGRect)a5 LSRoi:(CGRect)a6 descriptor:(id *)a7 propertiesForPostProcPipeVisualization:(id *)a8
{
  ...
  if (v14)
  {
    ...
    memcpy(&v14[1], a7, 0xA0uLL);
    v15->_trackID = a8->var0;
    v15->_isTracked = a8->var1;
    v15->_trackedCnt = a8->var3;
    v15->_isPredictedFromPast = a8->var2;
    *v15->_trajectoryFromPast = *&a8[1].var0;
    v15->_predictedFromPastCnt = a8->var4;
    v15->_lowSaliencyCnt = a8->var5;
    v15->_isTrajectoryPruningPassed = a8[1].var3;
    v15->_isReflectedLS = BYTE1(a8[1].var3);
    v16 = v15;
  }
