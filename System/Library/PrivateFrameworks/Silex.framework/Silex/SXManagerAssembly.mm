...
- (void)loadInRegistry:(id)registry
{
  ...
  v5 = [publicContainer registerProtocol:&unk_1F53EA430 factory:&__block_literal_global_80];
  v6 = [v5 withConfiguration:&__block_literal_global_55_17];

  publicContainer2 = [registryCopy publicContainer];
  v8 = [publicContainer2 registerProtocol:&unk_1F53C03A8 factory:&__block_literal_global_62_1];

  privateContainer = [registryCopy privateContainer];
  v10 = [privateContainer registerClass:objc_opt_class() factory:&__block_literal_global_66];

  privateContainer2 = [registryCopy privateContainer];

  v11 = [privateContainer2 registerClass:objc_opt_class() factory:&__block_literal_global_83];
}
