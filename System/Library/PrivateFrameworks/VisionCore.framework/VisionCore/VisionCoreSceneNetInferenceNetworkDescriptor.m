...
- (VisionCoreSceneNetInferenceNetworkDescriptor)initWithCoder:(id)a3
{
  ...
  if (v5)
  {
    ...
    v50 = [v4 decodeObjectOfClass:v45 forKey:@"VNVYvzEtX1JlUdu8xx5qhDI"];
    ...
    v52 = [v4 decodeObjectOfClass:v45 forKey:@"potentialLandmark"];
    ...
    v54 = [v4 decodeObjectOfClass:v45 forKey:@"VN5kJNH3eYuyaLxNpZr5Z7zi"];
    ...
    v56 = [v4 decodeObjectOfClass:v45 forKey:@"VNdGg5skzXHSAENO6T3enHE"];
    ...
    v58 = [v4 decodeObjectOfClass:v45 forKey:@"cityNature"];
...
- (void)encodeWithCoder:(id)a3
{
  ...
  [v4 encodeInteger:self->_model forKey:{@"model", v5.receiver, v5.super_class}];
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    objc_opt_class();
    if ((objc_opt_isKindOfClass() & 1) != 0 && (v34.receiver = self, v34.super_class = VisionCoreSceneNetInferenceNetworkDescriptor, [(VisionCoreInferenceNetworkDescriptor *)&v34 isEqual:v4]))
    {
      v5 = v4;
...
- (VisionCoreTensorDescriptor)sceneLabelConfidencesOutput
{
  v3 = [(VisionCoreSceneNetInferenceNetworkDescriptor *)self sceneClassificationLabelsBlobName];
...
- (VisionCoreTensorDescriptor)sceneprintOutput
{
  v3 = [(VisionCoreSceneNetInferenceNetworkDescriptor *)self sceneRepresentationBlobName];
  v4 = [(VisionCoreInferenceNetworkDescriptor *)self outputNamed:v3 error:0];
...
- (id)_newCustomClassifierDescriptorWithModelName:(id)a3 labelsFileName:(id)a4 inputBlobName:(id)a5 outputBlobName:(id)a6 error:(id *)a7
{
  ...
  v13 = a6;
  v14 = a3;
  v15 = [objc_opt_class() URLForEspressoModelNamed:v14 error:a7];

  if (v15)
  {
    v16 = [objc_opt_class() URLForResourceNamed:v11 error:a7];
    if (v16)
    {
      v17 = [[VisionCoreSceneNetInferenceNetworkCustomClassifierDescriptor alloc] initWithModelFileURL:v15 labelsFileURL:v16 inputBlobName:v12 outputBlobName:v13];
    }
...
+ (id)sceneNetObjDetNetSliderNetV3AndReturnError:(id *)a3
{
  ...
  v7 = [v6 objectForIdentifier:@"SceneNetObjDetNetSliderNetV3" creationBlock:v4 error:a3];
...
+ (id)sceneNetV3AndReturnError:(id *)a3
{
  ...
  v5 = +[VisionCoreFrameworkManager sharedManager];
  v6 = [v5 inferenceNetworkDescriptorsCache];
  v7 = [v6 objectForIdentifier:@"SceneNetV3" creationBlock:v4 error:a3];
...
+ (id)descriptorForModel:(unint64_t)a3 requireObjDetNet:(BOOL)a4 requireSliderNet:(BOOL)a5 error:(id *)a6
{
  ...
  v76 = 0;
  v74 = 0;
  v11 = [a1 _getAnalyzerName:&v76 ANESpecificAnalyzerName:&v75 specifier:&v74 forModel:a3 objDetNet:a4 sliderNet:a5 error:a6];
  v12 = v76;
  v13 = v75;
  v14 = v74;
  v15 = 0;
...
LABEL_32:
    ...
    if (v13)
    {
      v17 = [a1 URLForEspressoModelNamed:v13 error:a6];
      if (!v17)
      {
        goto LABEL_5;
      }
...
LABEL_31:
      ...
      v64 = NSStringFromVisionCoreSceneNetInferenceNetworkModel(a3);
...
LABEL_30:
    ...
    v73 = 0;
    v68 = v18;
    LODWORD(v25) = [VisionCoreEspressoUtils getInputImageTensorDescriptor:&v73 outputTensorDescriptors:&v72 forNetworkModelFileURL:v69 inputBlobName:@"data" pixelFormatType:1111970369 outputBlobNamesWithTypes:v18 confidencesBlobNamesWithLabelsFiles:0 error:a6];
    v26 = v73;
    v27 = v72;
    v15 = 0;
    v28 = v19;
...
LABEL_29:
    ...
    v31 = v29;
    v32 = [v29 allValues];
    v33 = [v30 initWithURL:v69 specifier:v71 networkHeadVersions:v28 inputImage:v26 outputs:v32 confidencesOutput:0];
    ...
    if (v33)
    {
      ...
      *(v33 + 184) = @"saliency/map";
      ...
      v49 = [v33 _newCustomClassifierDescriptorWithModelName:@"junk_leaf.r14.j9.espresso" labelsFileName:@"junk_leaf.labels_basic-v3b.txt" inputBlobName:@"stem/SpatialSqueeze_COPY254" outputBlobName:@"leaf/probabilities" error:a6];
      v50 = *(v33 + 264);
      *(v33 + 264) = v49;

      if (*(v33 + 264))
      {
        v51 = [v33 _newCustomClassifierDescriptorWithModelName:@"junk_hierarchical.r14.j9.espresso" labelsFileName:@"junk_hierarchical.labels_higher_order-v3b.txt" inputBlobName:@"stem/SpatialSqueeze_COPY254" outputBlobName:@"hierarchical/probabilities" error:a6];
        v52 = *(v33 + 272);
        *(v33 + 272) = v51;

        if (*(v33 + 272))
        {
          v53 = [v33 _newCustomClassifierDescriptorWithModelName:@"vienna.r14.n4.1.espresso" labelsFileName:@"labels_vienna-v1e.txt" inputBlobName:@"stem/SpatialSqueeze_COPY254" outputBlobName:@"leaf/probabilities" error:a6];
          v54 = *(v33 + 280);
          *(v33 + 280) = v53;

          if (*(v33 + 280))
          {
            v55 = [v33 _newCustomClassifierDescriptorWithModelName:@"landmarks_gating.r14.l3.espresso" labelsFileName:@"landmarks_gating_labels.txt" inputBlobName:@"stem/SpatialSqueeze_COPY254" outputBlobName:@"labels/probabilities" error:a6];
            v56 = *(v33 + 288);
            *(v33 + 288) = v55;

            if (*(v33 + 288))
            {
              v57 = [v33 _newCustomClassifierDescriptorWithModelName:@"sg.r14.s4.espresso" labelsFileName:@"sg_labels.txt" inputBlobName:@"stem/SpatialSqueeze_NEW254" outputBlobName:@"hierarchical/probabilities" error:a6];
              v58 = *(v33 + 296);
              *(v33 + 296) = v57;

              if (*(v33 + 296))
              {
                v59 = [v33 _newCustomClassifierDescriptorWithModelName:@"events_gating.r14.e4.espresso" labelsFileName:@"events_gating_labels_basic-v1c.txt" inputBlobName:@"stem/SpatialSqueeze_COPY254" outputBlobName:@"leaf/probabilities" error:a6];
                v60 = *(v33 + 304);
                *(v33 + 304) = v59;

                if (*(v33 + 304))
                {
                  v61 = [v33 _newCustomClassifierDescriptorWithModelName:@"d76p746ctq_50001_split.espresso" labelsFileName:@"d76p746ctq_50001.txt" inputBlobName:@"stem/gap/Mean" outputBlobName:@"leaf/probabilities" error:a6];
                  v62 = *(v33 + 312);
                  *(v33 + 312) = v61;
