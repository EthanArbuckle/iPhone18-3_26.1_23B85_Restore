...
+ (void)initializeJSContext:(id)a3
{
  ...
  objc_msgSend_setObject_forKeyedSubscript_(v5, v4, v6, &unk_287F2B9B0, @"background");
}
...
+ (id)executeFunction:(id)a3 argument:(id)a4
{
  ...
  v24 = objc_msgSend_stringWithFormat_(MEMORY[0x277CCACA8], v22, v23, @"var _tmlResult=%@ _tmlResult", v8);;
...
+ (void)handleException:(id)a3
{
  ...
  v3 = a3;
  v6 = objc_msgSend_objectForKeyedSubscript_(v3, v4, v5, @"stack");
