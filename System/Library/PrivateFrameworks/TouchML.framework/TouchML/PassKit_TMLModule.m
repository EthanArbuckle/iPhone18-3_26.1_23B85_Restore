...
+ (void)initializeJSContext:(id)a3
{
  ...
  objc_msgSend_setObject_forKeyedSubscript_(v4, v7, v8, &unk_287F2B850, @"PKPaymentSummaryItem");
  objc_msgSend_setObject_forKeyedSubscript_(v4, v9, v10, &unk_287F2B870, @"PKPass");
