...
- (MCCertificateRevocationPayload)initWithDictionary:(id)a3 profile:(id)a4 outError:(id *)a5
{
  ...
  v51 = 0;
  v11 = [v8 MCValidateAndRemoveArrayOfClass:objc_opt_class() withKey:@"EnabledForCerts" isRequired:0 outError:&v51];
  v12 = v51;
  if (v12)
  {
    goto LABEL_31;
...
- (id)stubDictionary
{
  ...
  [v16 setObject:v3 forKeyedSubscript:@"EnabledForCerts"];
