...
+ (BOOL)p_stylesAreEqualForOutgoingStorage:(id)a3 incomingStorage:(id)a4;
+ (Class)drawableInfoSubclassForClass:(Class)a3 unarchiver:(id)a4;
+ (id)defaultGalleryCaptionParagraphStyleInStylesheet:(id)a3;
+ (id)i_newCaptionStorageWithContext:(id)a3;
+ (id)p_overrideCaptionParagraphStyleIdentifier;
+ (id)p_paragraphStyleWithLocalizedNameKey:(id)a3 inStylesheet:(id)a4;
- (BOOL)canCopyData;
- (BOOL)needsDownload;
- (BOOL)supportsHyperlinks;
- (CGSize)targetSizeForImageData:(id)a3 associatedHint:(id)a4;
- (NSArray)childInfos;
- (TSAGalleryInfo)initWithContext:(id)a3 geometry:(id)a4;
- (TSAGalleryInfo)initWithContext:(id)a3 geometry:(id)a4 captionStorage:(id)a5;
- (id)animationFilters;
...
- (void)setCaptionMode:(int64_t)a3;
...
- (void)setCaptionMode:(int64_t)a3
{
  if (self->_captionMode != a3)
  {
    objc_msgSend_willModify(self, a2, a3, v3);
    self->_captionMode = a3;
  }
}
...
- (TSAGalleryInfo)initWithContext:(id)a3 geometry:(id)a4
{
  ...
  v8 = [(TSAGalleryInfo *)&v19 initWithContext:v6 geometry:v7];
  v9 = v8;
  if (v8)
  {
    items = v8->_items;
    ...
    v11 = objc_opt_class();
    v14 = objc_msgSend_i_newCaptionStorageWithContext_(v11, v12, v6, v13);
...
- (TSAGalleryInfo)initWithContext:(id)a3 geometry:(id)a4 captionStorage:(id)a5
{
  ...
  v11 = [(TSAGalleryInfo *)&v20 initWithContext:v8 geometry:v9];
  v12 = v11;
  if (v11)
  {
    items = v11->_items;
    ...
    objc_storeStrong(&v12->_captionStorage, a5);
    v14 = objc_opt_class();
...
- (void)setItems:(id)a3
{
  ...
  {
    v104 = v5;
    isEqualToArray = objc_msgSend_isEqualToArray_(items, v4, v5, v6);
    v5 = v104;
...
- (id)childEnumerator
{
  ...
  v4 = [(TSAGalleryInfo *)&v17 childEnumerator];
  v8 = objc_msgSend_childInfos(self, v5, v6, v7);
  v12 = objc_msgSend_objectEnumerator(v8, v9, v10, v11);
  v15 = objc_msgSend_aggregateEnumeratorWithObjects_(v3, v13, v4, v14, v12, 0);
...
- (id)childEnumeratorForUserSearch
{
  ...
  v3 = [(TSAGalleryInfo *)&v29 childEnumeratorForUserSearch];
  if (objc_msgSend_captionMode(self, v4, v5, v6))
  {
    v10 = objc_alloc_init(MEMORY[0x277CBEB18]);
    while (1)
    {
      v14 = objc_msgSend_nextObject(v3, v7, v8, v9);
      if (!v14)
      {
        break;
      }
...
- (void)insertContainedModel:(id)a3 atIndex:(unint64_t)a4
{
  ...
  if (objc_msgSend_count(v14, v15, v16, v17) < a4)
  {
  ...
  objc_msgSend_insertObject_atIndex_(v14, v18, v6, a4);
...
- (void)moveModel:(id)a3 toIndex:(unint64_t)a4
{
  ...
  objc_msgSend_insertObject_atIndex_(v14, v28, v6, a4);
  objc_msgSend_setItems_(self, v29, v14, v30);
}
...
- (void)willBeAddedToDocumentRoot:(id)a3 dolcContext:(id)a4
{
  ...
  [(TSAGalleryInfo *)&v22 willBeAddedToDocumentRoot:v6 dolcContext:v7];
  v20 = 0u;
  v21 = 0u;
  v18 = 0u;
  v19 = 0u;
  ...
  if (v14)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        objc_msgSend_willBeAddedToDocumentRoot_dolcContext_(*(*(&v18 + 1) + 8 * v16++), v13, v6, v7);
      }
  ...
  objc_msgSend_willBeAddedToDocumentRoot_dolcContext_(self->_captionStorage, v17, v6, v7);
}
...
- (void)wasAddedToDocumentRoot:(id)a3 dolcContext:(id)a4
{
  ...
  v22.receiver = self;
  v22.super_class = TSAGalleryInfo;
  [(TSAGalleryInfo *)&v22 wasAddedToDocumentRoot:v6 dolcContext:v7];
  ...
  if (v14)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        objc_msgSend_wasAddedToDocumentRoot_dolcContext_(*(*(&v18 + 1) + 8 * v16++), v13, v6, v7);
      }
  ...
  objc_msgSend_wasAddedToDocumentRoot_dolcContext_(self->_captionStorage, v17, v6, v7);
}
...
- (void)willBeRemovedFromDocumentRoot:(id)a3
{
  ...
  [(TSAGalleryInfo *)&v21 willBeRemovedFromDocumentRoot:v4];
  v19 = 0u;
  v20 = 0u;
  v17 = 0u;
  v18 = 0u;
  ...
  if (v12)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        objc_msgSend_willBeRemovedFromDocumentRoot_(*(*(&v17 + 1) + 8 * v14++), v10, v4, v11);
      }
  ...
  objc_msgSend_willBeRemovedFromDocumentRoot_(self->_captionStorage, v15, v4, v16);
...
- (void)wasRemovedFromDocumentRoot:(id)a3
{
  ...
  v21.receiver = self;
  v21.super_class = TSAGalleryInfo;
  [(TSAGalleryInfo *)&v21 wasRemovedFromDocumentRoot:v4];
  v19 = 0u;
  v20 = 0u;
  v17 = 0u;
  v18 = 0u;
  ...
  if (v12)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        objc_msgSend_wasRemovedFromDocumentRoot_(*(*(&v17 + 1) + 8 * v14++), v10, v4, v11);
      }
  ...
  objc_msgSend_wasRemovedFromDocumentRoot_(self->_captionStorage, v15, v4, v16);
}
...
+ (id)i_newCaptionStorageWithContext:(id)a3
{
  ...
  v15 = objc_msgSend_defaultGalleryCaptionParagraphStyleInStylesheet_(a1, v13, v12, v14);
  v16 = objc_alloc(MEMORY[0x277D80F28]);
  v20 = objc_msgSend_initialListStyle(v15, v17, v18, v19);
  v40 = -1;
  v22 = objc_msgSend_initWithContext_string_kind_stylesheet_paragraphStyle_listStyle_section_columnStyle_paragraphDirection_(v16, v21, v4, 0, 3, v12, v15, v20, 0, 0, v40);

  objc_msgSend_i_configureCaptionStorage_(a1, v23, v22, v24);
  v28 = objc_msgSend_sharedDelegate(MEMORY[0x277D80610], v25, v26, v27);
  LODWORD(a1) = objc_msgSend_imageGalleryCaptionsUsePlaceholderText(v28, v29, v30, v31);
...
+ (id)defaultGalleryCaptionParagraphStyleInStylesheet:(id)a3
{
  ...
  v4 = a3;
  objc_opt_class();
  v8 = objc_msgSend_p_overrideCaptionParagraphStyleIdentifier(a1, v5, v6, v7);
  v11 = objc_msgSend_styleWithIdentifier_(v4, v9, v8, v10);
  v12 = TSUCheckedDynamicCast();

  if (!v12)
  {
    objc_opt_class();
    v16 = objc_msgSend_documentRoot(v4, v13, v14, v15);
    ...
    if (!v12)
    {
      ...
      if (v35)
      {
        ...
        while (2)
        {
          for (i = 0; i != v35; ++i)
          {
            ...
            v12 = objc_msgSend_p_paragraphStyleWithLocalizedNameKey_inStylesheet_(a1, v34, *(*(&v53 + 1) + 8 * i), v4);
            if (v12)
            {
      ...
      v12 = objc_msgSend_defaultParagraphStyle(v4, v38, v39, v40);
      if (!v12)
      {
...
+ (id)p_paragraphStyleWithLocalizedNameKey:(id)a3 inStylesheet:(id)a4
{
  v5 = a3;
  v6 = a4;
  v10 = objc_msgSend_context(v6, v7, v8, v9);
  v14 = objc_msgSend_documentRoot(v10, v11, v12, v13);
  v18 = objc_msgSend_documentLocale(v14, v15, v16, v17);

  v20 = objc_msgSend_localizedStringForKey_value_table_(v18, v19, v5, &stru_288512028, @"TSApplication");
  objc_opt_class();
  ...
  v21 = v20;
  v28 = v21;
  v24 = objc_msgSend_firstCascadedStylePassingTest_(v6, v22, v27, v23);
...
- (void)adoptStylesheet:(id)a3 withMapper:(id)a4
{
  ...
  [(TSAGalleryInfo *)&v30 adoptStylesheet:v6 withMapper:v7];
  ...
  if (v21)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        objc_msgSend_adoptStylesheet_withMapper_(*(*(&v26 + 1) + 8 * v23++), v20, v6, v7);
      }
  ...
  objc_msgSend_popMappingContext_(v7, v24, self, v25);
}
...
- (CGSize)targetSizeForImageData:(id)a3 associatedHint:(id)a4
{
    ...
    do
    {
      for (i = 0; i != v15; ++i)
      {
        ...
        if (v20)
        {
          ...
          v37[4] = v18;
          v37[5] = &v42;
          objc_msgSend_performBlockWithTemporaryLayout_(v6, v12, v37, v14);
        }
      }
  ...
  if (v26)
  {
    objc_msgSend_highestScaleFactorForRenderingDrawableInfo_(v26, v27, v6, v28, &unk_288541558);
    v29 = v43;
    if (v30 > 1.0)
    {
...
- (unint64_t)chunkCountForTextureDeliveryStyle:(unint64_t)a3 animationFilter:(id)a4
{
  if (!objc_msgSend_isEqualToString_(a4, a2, *MEMORY[0x277D80590], a4))
  {
    return 1;
  }
...
- (int64_t)mixingTypeWithObject:(id)a3 context:(id)a4
{
  ...
  if (!v9)
  {
    ...
    objc_msgSend_handleFailureInFunction_file_lineNumber_isFatal_description_(v10, v15, v11, v14, 712, 0, "invalid nil value for '%{public}s'", "otherGalleryInfo", v110);
  ...
  objc_msgSend_mixingTypeWithObject_context_(v19, v24, v23, v111);
...
+ (BOOL)p_stylesAreEqualForOutgoingStorage:(id)a3 incomingStorage:(id)a4
{
  v5 = a3;
  v6 = a4;
  v10 = objc_msgSend_range(v5, v7, v8, v9);
  v12 = v11;
  v13 = MEMORY[0x277D81510];
  v36 = *MEMORY[0x277D81510];
  v16 = objc_msgSend_range(v6, v11, v14, v15);
  v18 = v17;
  v35 = *v13;
  v19 = objc_msgSend_paragraphStyleAtCharIndex_effectiveRange_(v5, v17, v10, &v36);
  v21 = objc_msgSend_paragraphStyleAtCharIndex_effectiveRange_(v6, v20, v16, &v35);
  if (*(&v36 + 1) != *(&v35 + 1))
  {
    isEqual = 0;
...
LABEL_8:
    v30 = objc_msgSend_characterStyleAtCharIndex_effectiveRange_(v5, v27, v10, &v36);
    v21 = objc_msgSend_characterStyleAtCharIndex_effectiveRange_(v6, v31, v16, &v35);
...
- (void)loadFromArchive:(const void *)a3 unarchiver:(id)a4
{
  ...
  [(TSAGalleryInfo *)&v39 loadFromArchive:v7 unarchiver:v6];
  self->_isInDocument = objc_msgSend_sourceType(v6, v8, v9, v10) == 1;
  ...
  if ((v31 & 0x400) != 0)
  {
    v32 = objc_msgSend_readDataReferenceMessage_(v26, v29, *(a3 + 16), v30);
    v31 = *(a3 + 10);
  }

  if ((v31 & 0x200) != 0)
  {
    v33 = objc_msgSend_readDataReferenceMessage_(v26, v29, *(a3 + 15), v30);
  }
}
...
- (void)saveToArchive:(void *)a3 archiver:(id)a4
{
  ...
  v10 = objc_msgSend_setIgnoreAndPreserveUntilModifiedRuleForField_message_(v7, v9, 200, a3);
  ...
  if (v11)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        objc_msgSend_processStorageForStatistics_processSelection_(v4, v10, *(*(&v14 + 1) + 8 * v13++), 0);
      }
