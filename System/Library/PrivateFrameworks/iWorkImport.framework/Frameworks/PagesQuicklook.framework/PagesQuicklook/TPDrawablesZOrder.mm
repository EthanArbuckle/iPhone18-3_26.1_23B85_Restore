...
- (void)loadFromUnarchiver:(id)unarchiver
{
  ...
  v10 = objc_msgSend_messageWithDescriptor_(unarchiverCopy, v5, v6, v7, v8, v9, off_2812F85B8[18]);
  ...
  if (v11)
  {
    ...
    v18[4] = self;
    v18[5] = v11;
    sub_275FDE79C(unarchiverCopy, v10 + 16, &unk_2885108A0, v18);
    v17[0] = MEMORY[0x277D85DD0];
    v17[1] = 3221225472;
    v17[2] = sub_275FDE9FC;
    v17[3] = &unk_27A6A8768;
    v17[4] = self;
    objc_msgSend_addFinalizeHandler_(unarchiverCopy, v12, v13, v14, v15, v16, v17);
  }
}
...
- (void)saveToArchiver:(id)archiver
{
  ...
  google::protobuf::internal::AssignDescriptors();
  v10 = objc_msgSend_messageWithNewFunction_descriptor_(archiverCopy, v5, v6, v7, v8, v9, sub_275FDFB2C, off_2812F85B8[18]);
  ...
  if (v18)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        {
          *(v10 + 24) = v27 + 1;
          objc_msgSend_setStrongReference_message_(archiverCopy, v17, v19, v20, v21, v22, v25, *&v26[2 * v27 + 2], v37);
          goto LABEL_13;
        }
...
LABEL_11:
        ...
        *(v10 + 24) = v30 + 1;
        *(v31 + 8) = v29;
        objc_msgSend_setStrongReference_message_(archiverCopy, v32, v33, v34, v35, v36, v25, v29, v37);
LABEL_13:
        ++v24;
      }
...
- (id)drawableAtZOrder:(unint64_t)order
{
  ...
  if (drawables)
  {
    if (objc_msgSend_count(drawables, a2, v3, v4, v5, v6) <= order)
    {
      drawables = 0;
    }
    ...
    {
      drawables = objc_msgSend_objectAtIndexedSubscript_(self->_drawables, v10, v11, v12, v13, v14, order);
    }
  }
...
- (unint64_t)zOrderOfDrawable:(id)drawable
{
  ...
  if (drawableCopy)
  {
    ...
    if (drawables)
    {
      v10 = objc_msgSend_indexOfObjectIdenticalTo_(drawables, v4, v6, v7, v8, v9, drawableCopy);
    }
  }
...
- (void)moveDrawables:(id)drawables toIndexes:(id)indexes
{
  ...
  if (drawablesCopy && indexesCopy)
  {
    ...
    v18 = objc_msgSend_count(drawablesCopy, v13, v14, v15, v16, v17);
    v24 = objc_msgSend_count(indexesCopy, v19, v20, v21, v22, v23);
    Index = objc_msgSend_lastIndex(indexesCopy, v25, v26, v27, v28, v29);
    if (v18 != v24)
    {
    ...
    v72 = objc_msgSend_count(drawablesCopy, v30, v32, v33, v34, v35);
    v78 = objc_msgSend_count(indexesCopy, v73, v74, v75, v76, v77);
    if (Index < v12 && v72 == v78)
    {
      objc_msgSend_willModify(self, v79, v80, v81, v82, v83);
      objc_msgSend_removeObjectsInArray_(self->_drawables, v84, v85, v86, v87, v88, drawablesCopy);
      objc_msgSend_insertObjects_atIndexes_(self->_drawables, v89, v90, v91, v92, v93, drawablesCopy, indexesCopy);
    }
  }
}
...
- (unint64_t)insertDrawable:(id)drawable atZOrder:(unint64_t)order
{
  ...
  if (drawableCopy)
  {
    ...
    if (drawables)
    {
      ...
      if (objc_msgSend_indexOfObjectIdenticalTo_(drawables, v6, v8, v9, v10, v11, drawableCopy) == 0x7FFFFFFFFFFFFFFFLL)
      {
        orderCopy = objc_msgSend_count(self->_drawables, v13, v14, v15, v16, v17);
        ...
        objc_msgSend_insertObject_atIndex_(self->_drawables, v24, v25, v26, v27, v28, drawableCopy, orderCopy);
      }
    }
...
{
  drawables = self->_drawables;
  if (drawables && objc_msgSend_count(drawables, a2, v3, v4, v5, v6) > order)
  {
    objc_msgSend_willModify(self, v10, v11, v12, v13, v14);
    v20 = self->_drawables;

    objc_msgSend_removeObjectAtIndex_(v20, v15, v16, v17, v18, v19, order);
  }
}
...
- (void)moveDrawableAtZOrder:(unint64_t)order toZOrder:(unint64_t)zOrder
{
  if (order != zOrder && order + 1 != zOrder)
  {
    ...
    if (zOrder != 0xFFFFFFFF || v11 - 1 != order)
    {
      objc_msgSend_willModify(self, v12, v13, v14, v15, v16);
      v38 = objc_msgSend_objectAtIndexedSubscript_(self->_drawables, v17, v18, v19, v20, v21, order);
      objc_msgSend_removeObjectAtIndex_(self->_drawables, v22, v23, v24, v25, v26, order);
      ...
      {
        v32 = (__PAIR128__(zOrder, order) - zOrder) >> 64;
      }
...
- (void)moveDrawable:(id)drawable toZOrder:(unint64_t)order
{
  ...
  objc_msgSend_moveDrawableAtZOrder_toZOrder_(self, v12, v13, v14, v15, v16, v11, order);
}
...
- (void)moveDrawables:(id)drawables toZOrder:(unint64_t)order
{
  ...
  v23 = 0u;
  drawablesCopy = drawables;
  v13 = objc_msgSend_countByEnumeratingWithState_objects_count_(drawablesCopy, v7, v8, v9, v10, v11, &v20, v24, 16);
  if (v13)
  {
    v18 = *v21;
    do
    {
      ...
      do
      {
        ...
        objc_msgSend_moveDrawable_toZOrder_(self, v12, v14, v15, v16, v17, *(*(&v20 + 1) + 8 * v19), order, v20);
        if (order != 0xFFFFFFFF)
        {
          ++order;
        }
      ...
      while (v13 != v19);
      v13 = objc_msgSend_countByEnumeratingWithState_objects_count_(drawablesCopy, v12, v14, v15, v16, v17, &v20, v24, 16);
    }
...
{
  v11 = objc_msgSend_count(self->_drawables, a2, v4, v5, v6, v7);
  if (order != zOrder && v11 > order && v11 > zOrder)
  {
    objc_msgSend_willModify(self, v12, v13, v14, v15, v16);
    drawables = self->_drawables;
