...
- (TSDCanvasSelection)initWithArchive:(const void *)archive unarchiver:(id)unarchiver;
- (TSDCanvasSelection)initWithInfos:(id)infos;
- (TSDCanvasSelection)initWithInteractiveInfos:(id)infos nonInteractiveInfos:(id)interactiveInfos;
- (id)UUIDDescription;
...
- (TSDCanvasSelection)initWithInteractiveInfos:(id)infos nonInteractiveInfos:(id)interactiveInfos
{
  ...
  if (v8)
  {
    ...
    v11 = objc_msgSend_initWithInteractiveInfos_nonInteractiveInfos_(v9, v10, infosCopy, interactiveInfosCopy);
...
- (TSDCanvasSelection)initWithArchive:(const void *)archive unarchiver:(id)unarchiver
{
  ...
  if (v7)
  {
    ...
    if (*(archive + 8) >= 1)
    {
      ...
      v16[3] = &unk_27A6CDD58;
      v16[4] = v19;
      sub_27679B15C(unarchiverCopy, archive + 24, &unk_2885A16B8, v16);
    }
    ...
    if (v8 >= 1)
    {
      ...
      v15[3] = &unk_27A6CDD58;
      v15[4] = v17;
      sub_27679B15C(unarchiverCopy, archive + 48, &unk_2885A16B8, v15);
    }
...
- (void)saveToArchive:(void *)archive archiver:(id)archiver
{
  ...
  objc_msgSend_setWeakReferenceSet_message_(archiverCopy, v12, v11, archive + 24);

  v15 = objc_msgSend_selectionHelper(self, v13, v14);
  v18 = objc_msgSend_nonInteractiveInfos(v15, v16, v17);
  objc_msgSend_setWeakReferenceSet_message_(archiverCopy, v19, v18, archive + 48);
}
