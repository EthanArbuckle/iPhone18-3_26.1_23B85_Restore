...
- (void)drawImageInContext:(CGContext *)a3 rect:(CGRect)a4
{
  ...
  if (TSUCGFloatIsValid())
  {
    if (TSUCGFloatIsValid())
    {
      ...
      if (v57.size.width != 0.0)
      {
        height = v57.size.height;
        if (v57.size.height != 0.0)
        {
          x = v57.origin.x;
          y = v57.origin.y;
          if (!CGRectIsInfinite(*(&width - 2)) && !CGRectIsNull(v57))
          {
            ...
            CGContextFillRect(a3, v57);
            v11 = TSUCGColorCreateDeviceRGB();
            CGContextSetStrokeColorWithColor(a3, v11);
            CGColorRelease(v11);
            memset(&v56, 0, sizeof(v56));
            CGContextGetCTM(&v56, a3);
            TSUDistance();
            v13 = 1.0 / v12;
            CGContextSetLineWidth(a3, 1.0 / v12);
            v55 = CGRectInset(v57, v13 * 0.5, v13 * 0.5);
            if (TSUCGFloatIsValid())
            {
              if (TSUCGFloatIsValid())
              {
                ...
                if (v55.size.width != 0.0)
                {
                  ...
                  if (v55.size.height != 0.0)
                  {
                    ...
                    if (!CGRectIsInfinite(*(&v14 - 2)) && !CGRectIsNull(v55))
                    {
                      ...
                      CGContextMoveToPoint(a3, v22, v23);
                      v24 = CGRectGetMinX(v55);
                      v25 = CGRectGetMaxY(v55);
                      CGContextAddLineToPoint(a3, v24, v25);
                      ...
                      if (v28)
                      {
                        ...
                        if (Page)
                        {
                          ...
                          if (v41 <= v57.size.width && v40 <= v57.size.height)
                          {
                            TSURectWithSize();
                            ...
                            *&v48.tx = v51;
                            ...
                            CGContextTranslateCTM(a3, 0.0, v47);
                            CGContextScaleCTM(a3, 1.0, -1.0);
                            CGContextDrawPDFPage(a3, v30);
                          }
                        }
                      }
                    }
