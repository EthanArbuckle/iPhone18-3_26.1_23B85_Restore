...
- (BOOL)p_shouldUseSourceImageForDescription:(id)description clipBounds:(CGRect)bounds transform:(CGAffineTransform *)transform image:(CGImage *)image;
...
- (void)p_drawInContext:(CGContext *)context withContent:(BOOL)content strokeDrawOptions:(unint64_t)options withOpacity:(double)opacity withMask:(BOOL)mask withIAMask:(BOOL)aMask forLayer:(BOOL)layer forShadow:(BOOL)self0 forHitTest:(BOOL)self1;
...
- (TSDImageRep)initWithLayout:(id)layout canvas:(id)canvas
{
  ...
  v4 = [(TSDRep *)&v28 initWithLayout:layout canvas:canvas];
  v7 = v4;
  if (v4)
  {
...
- (id)layoutsForChildReps
{
  ...
  layoutsForChildReps = [(TSDRep *)&v21 layoutsForChildReps];
  ...
  if (v9)
  {
    ...
    v19 = objc_msgSend_tsu_arrayByRemovingObjectsIdenticalToObjectsInArray_(layoutsForChildReps, v18, v17);

    layoutsForChildReps = v19;
  }
...
- (void)drawInContextWithoutEffects:(CGContext *)effects withContent:(BOOL)content strokeDrawOptions:(unint64_t)options withOpacity:(BOOL)opacity forAlphaOnly:(BOOL)only drawChildren:(BOOL)children keepingChildrenPassingTest:(id)test
{
  ...
  objc_msgSend_p_drawInContext_withContent_strokeDrawOptions_withOpacity_withMask_withIAMask_forLayer_forShadow_forHitTest_(self, a2, effects, contentCopy, options, 1, 1, 0, v13);
}
...
- (void)p_drawInContext:(CGContext *)context withContent:(BOOL)content strokeDrawOptions:(unint64_t)options withOpacity:(double)opacity withMask:(BOOL)mask withIAMask:(BOOL)aMask forLayer:(BOOL)layer forShadow:(BOOL)self0 forHitTest:(BOOL)self1
{
  ...
  optionsCopy = options;
  contentCopy = content;
  v19 = objc_msgSend_styledLayout(self, a2, context);
...
LABEL_15:
  v62 = opacity < 1.0 && contentCopy;
  v63 = optionsCopy & v62;
  if ((optionsCopy & v62) == 1 && (CGContextSaveGState(context), CGContextSetAlpha(context, opacity), v45))
  {
  ...
  objc_msgSend_imageRectInContext_(*&self->_frameInUnscaledCanvasIsValid, v67, context);
  v71 = v70;
  v73 = v72;
  v75 = v74;
  v77 = v76;
  if (contentCopy)
  {
    ...
    if (maskCopy)
    {
      ...
      if (v80)
      {
        ...
        if (hasMask)
        {
          ...
          objc_msgSend_applyMaskForRectWithCoverage_toContext_(v108, v109, context, v93, v95, v97, v99);
      ...
      if (v198)
      {
        ...
        if (v199)
        {
          v120 = objc_msgSend_aliasedPathInContext_effectiveStrokeWidth_(v117, v119, context, 0.0);
    ...
    if (v127 && aMaskCopy)
    {
      ...
      if (v199)
      {
        v150 = objc_msgSend_aliasedPathInContext_effectiveStrokeWidth_(v136, v149, context, 0.0);
    ...
    CGContextConcatCTM(context, &v203);
    CGContextSaveGState(context);
    if (maskCopy)
    {
      ...
      if (v156)
      {
        ...
        if (v159)
        {
          ...
          objc_msgSend_blendMaskBeforeRenderingImageInContext_(v161, v162, context);
        }
      }
    }

    objc_msgSend_drawInContext_forLayer_forShadowOrHitTest_(*&self->_frameInUnscaledCanvasIsValid, v154, context, layerCopy, shadow | test);
  ...
  if (objc_msgSend_pathToStroke(v66, v163, v164))
  {
    ...
    if (v167)
    {
      ...
      if (!objc_msgSend_isFrame(v45, v173, v174))
      {
        ...
        CGContextConcatCTM(context, &v203);
        objc_msgSend_paintPath_inContext_(v45, v183, v168, context);
        goto LABEL_88;
      }
      ...
      if (objc_msgSend_shouldRenderFrameStroke(v66, v175, v176))
      {
        ...
        CGContextGetCTM(&v203, context);
        TSUTransformScale();
        objc_msgSend_frameRect_inContext_withTotalScale_(v190, v191, context, x, y, width, height, v192);
LABEL_87:
      }
    }
  }
  ...
  else
  {
    if (!objc_msgSend_isFrame(v45, v165, v166))
    {
      ...
      if (v186)
      {
        objc_msgSend_paintPath_inContext_(v45, v187, v186, context);
      }

      else
      {
        objc_msgSend_paintRect_inContext_(v45, v187, context, v71, v73, v75, v77);
      }
    ...
    if (objc_msgSend_shouldRenderFrameStroke(v66, v179, v180))
    {
      ...
      CGContextGetCTM(&v203, context);
      TSUTransformScale();
      objc_msgSend_frameRect_inContext_withTotalScale_(v190, v195, context, v71, v73, v75, v77, v196);
      goto LABEL_87;
    }
  }
...
- (id)imageDrawingHelperImageData:(id)data
{
  v3 = objc_msgSend_imageInfo(self, a2, data);
...
- (CGRect)imageDrawingHelperImageRect:(id)rect
{
  v3 = objc_msgSend_imageLayout(self, a2, rect);
...
- (CGAffineTransform)imageDrawingHelperImageTransformInRootForAntialiasingDefeat:(SEL)defeat
{
  v12 = objc_msgSend_imageLayout(self, defeat, a4);
...
- (BOOL)imageDrawingHelperImageHasAlpha:(id)alpha
{
  v3 = objc_msgSend_imageLayout(self, a2, alpha);
...
- (void)setTextureAttributes:(id)attributes textureBounds:(CGRect)bounds
{
  ...
  [(TSDStyledRep *)&v16 setTextureAttributes:attributesCopy textureBounds:x, y, width, height];
  objc_msgSend_setObjectType_(attributesCopy, v10, 3, v16.receiver, v16.super_class);
    ...
    if ((CanBeReset & 1) == 0)
    {
      ...
      if (!v53)
      {
        ...
        if ((isPDF & 1) == 0)
        {
          ...
          {
            shouldUseSourceImage = objc_msgSend_shouldUseSourceImage(descriptionCopy, v26, v27);
            goto LABEL_11;
          }
...
LABEL_10:
  shouldUseSourceImage = 0;
LABEL_11:
  if ((objc_msgSend_shouldIgnoreScaleInSourceImage(descriptionCopy, v26, v27) & 1) == 0 && (width < CGImageGetWidth(image) / 1.5 || height < CGImageGetHeight(image) / 1.5))
  {
    shouldUseSourceImage = 0;
  }
...
- (id)textureForDescription:(id)description
{
  ...
  else
  {
    ...
    v31 = objc_msgSend_session(descriptionCopy, v29, v30);
    ...
    objc_msgSend_calculateTextureClipBounds_andOffset_withTransform_andRectOnCanvas_textureDescription_isUsingImageTexture_(self, v39, &v70, &v68, &v72, 0, descriptionCopy, 1);
    v67[0] = v72;
    v67[1] = v73;
    v67[2] = v74;
    if (objc_msgSend_p_shouldUseSourceImageForDescription_clipBounds_transform_image_(self, v40, descriptionCopy, v67, v38, v70, v71))
    {
      if (v38)
      {
        isMagicMove = objc_msgSend_isMagicMove(descriptionCopy, v41, v42);
        ...
        if ((objc_msgSend_shouldNotAddContainedReps(descriptionCopy, v61, v62) & 1) == 0)
        {
          objc_msgSend_addChildTexturesToTextureSet_forDescription_passingTest_(self, v63, v20, descriptionCopy, 0);
        }
      }
    ...
    else
    {
      ...
      v20 = [(TSDStyledRep *)&v66 textureForDescription:descriptionCopy];
...
LABEL_8:
    ...
    v55 = TSDMixingTypeWithObjects(v59, v65, contextCopy);
...
LABEL_9:
  ...
  v77 = TSDMixingTypeWithObjects(v70, v76, contextCopy);
