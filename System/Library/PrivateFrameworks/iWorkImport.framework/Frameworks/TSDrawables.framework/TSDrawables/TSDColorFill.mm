...
- (CGColor)CGColor;
- (TSDColorFill)initWithArchive:(const void *)a3 unarchiver:(id)a4;
...
+ (id)colorWithColor:(id)a3
{
  v4 = a3;
  v5 = [a1 alloc];
  v7 = objc_msgSend_initWithColor_(v5, v6, v4);
...
{
  v4 = [a1 alloc];
  v6 = objc_msgSend_initWithCGColor_(v4, v5, a3);
...
{
  v10 = [a1 alloc];
  v13 = objc_msgSend_initWithRed_green_blue_alpha_(v10, v11, v12, a3, a4, a5, a6);
...
{
  v6 = [a1 alloc];
  v9 = objc_msgSend_initWithWhite_alpha_(v6, v7, v8, a3, a4);
...
+ (id)colorWithUIColor:(id)a3
{
  v4 = a3;
  v5 = [a1 alloc];
  v7 = objc_msgSend_initWithUIColor_(v5, v6, v4);
...
- (TSDColorFill)initWithColor:(id)a3
{
  ...
  if (v15)
  {
    v16 = objc_msgSend_copy(v5, v13, v14);
    color = v15->_color;
    v15->_color = v16;
  }
...
- (TSDColorFill)initWithCGColor:(CGColor *)a3
{
  v4 = objc_msgSend_colorWithCGColor_(MEMORY[0x277D81180], a2, a3);
...
- (TSDColorFill)initWithRed:(double)a3 green:(double)a4 blue:(double)a5 alpha:(double)a6
{
  v8 = objc_msgSend_colorWithRed_green_blue_alpha_(MEMORY[0x277D81180], a2, v6, a3, a4, a5, a6);
...
- (TSDColorFill)initWithWhite:(double)a3 alpha:(double)a4
{
  v6 = objc_msgSend_colorWithWhite_alpha_(MEMORY[0x277D81180], a2, v4, a3, a4);
...
- (TSDColorFill)initWithUIColor:(id)a3
{
  ...
  v13 = objc_msgSend_colorWithUIColor_(MEMORY[0x277D81180], v4, v5);
...
{
  v3 = a3;
  v4 = objc_msgSend_color(self, a2, a3);
  LOBYTE(v3) = objc_msgSend_requiresOutlineOnBackgroundWithAppearance_(v4, v5, v3);
...
- (void)paintRect:(CGRect)a3 inContext:(CGContext *)a4
{
  ...
  y = a3.origin.y;
  x = a3.origin.x;
  v10 = objc_msgSend_color(self, a2, a4);
  objc_msgSend_paintRect_inContext_(v10, v9, a4, x, y, width, height);
}

- (void)paintPath:(CGPath *)a3 inContext:(CGContext *)a4
{
  v7 = objc_msgSend_color(self, a2, a3);
...
- (double)p_hsbComponentWithIndex:(unint64_t)a3
{
  ...
  v4 = objc_msgSend_color(self, a2, a3, 0, 0, 0, 0);
