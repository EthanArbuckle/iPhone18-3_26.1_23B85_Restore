...
- (TSPDataDownloadManager)initWithContext:(id)context;
...
- (id)documentResourceDataWithDigestString:(id)string locator:(id)locator filename:(id)filename
{
  ...
  if (WeakRetained)
  {
    ...
    v21 = objc_msgSend_documentResourceInfoForDigestString_locator_(v19, v20, stringCopy, locatorCopy);

    if (v21 || (v23 = [TSPDocumentResourceInfo alloc], objc_msgSend_pathExtension(filenameCopy, v24, v25), v26 = objc_claimAutoreleasedReturnValue(), v21 = objc_msgSend_initWithDigestString_locator_fileExtension_fileSize_tags_pixelSize_fallbackColor_(v23, v27, stringCopy, locatorCopy, v26, 0, 0, 0, *MEMORY[0x277CBF3A8], *(MEMORY[0x277CBF3A8] + 8)), v26, v21))
    {
      ...
      if (ResourceRequestIfNeeded_error)
      {
        ...
        v34 = objc_msgSend_documentResourceDataForInfo_withStorage_filename_(v32, v33, v21, ResourceRequestIfNeeded_error, filenameCopy);
    ...
    else
    {
      ...
      objc_msgSend_handleFailureInFunction_file_lineNumber_isFatal_description_(v35, v39, v36, v38, 479, 0, "Unknown Document Resource for digest %{public}@, locator %{public}@, filename %{public}@", stringCopy, locatorCopy, filenameCopy);
  ...
  objc_msgSend_handleFailureInFunction_file_lineNumber_isFatal_description_(v42, v46, v43, v45, 484, 0, "Unable to obtain TSPData for digest %{public}@, locator %{public}@, filename %{public}@", stringCopy, locatorCopy, filenameCopy);
