...
- (BOOL)_initializeNewDocumentDirectory:(id)a3;
- (BOOL)handleArchivedVersions:(id)a3 error:(id *)a4;
- (BOOL)readFromDistributableArchiveStream:(id)a3 estimatedDataLength:(int64_t)a4 supplementalDataBundle:(id)a5 error:(id *)a6;
- (TSPDistributableReader)initWithDestinationPath:(id)a3;
@end
...
- (TSPDistributableReader)initWithDestinationPath:(id)a3
{
  ...
  if (v5)
  {
    ...
    if (objc_msgSend__initializeNewDocumentDirectory_(v5, v6, v4))
    {
      v8 = [TSPDatabase alloc];
      v19 = 0;
      v10 = objc_msgSend_initWithPath_error_(v8, v9, v4, &v19);
      v11 = v19;
      ...
      if (v7->_database)
      {
        ...
        v15 = objc_msgSend_initWithPath_shouldCreate_(v13, v14, v4, 1);
...
- (BOOL)readFromDistributableArchiveStream:(id)a3 estimatedDataLength:(int64_t)a4 supplementalDataBundle:(id)a5 error:(id *)a6
{
  ...
  if ((v20 & 1) == 0)
  {
    v23 = objc_msgSend_beginTransactionWithError_(self->_database, v11, a6);
    ...
    if ((v24 & 1) == 0)
    {
      ...
      if (v23)
      {
        v23 = objc_msgSend_streamDistributableArchive_estimatedDataLength_toUnarchiver_supplementalDataBundle_closedCleanly_context_error_(TSPDistributableArchive, v11, v10, a4, self, v12, &v31, 0, a6);
        if (v23)
        {
          v23 = objc_msgSend_setClosedCleanlyToken_error_(self->_database, v11, v31, a6);
        }
      }
    }
...
LABEL_11:
    ...
    if ((v25 & 1) == 0 && v23)
    {
      if (objc_msgSend_commitTransactionWithError_(self->_database, v11, a6))
      {
        v22 = objc_msgSend_commitWithError_(self->_fileManager, v11, a6);
      }
...
LABEL_16:
  ...
  if ((v26 & 1) == 0)
  {
    objc_msgSend_closeWithError_(self->_database, v11, a6);
  }
...
- (BOOL)handleArchivedVersions:(id)a3 error:(id *)a4
{
  if (a3.var1 <= 0x774120E28)
  {
    database = self->_database;

    return MEMORY[0x2821F9670](database, sel_setDocumentVersion_error_, a3.var0);
  }
  ...
  else
  {
    if (a4)
    {
      *a4 = objc_msgSend_tsp_errorWithCode_(MEMORY[0x277CCA9B8], a2, 7);
    }
...
- (BOOL)_initializeNewDocumentDirectory:(id)a3
{
  ...
  if ((objc_msgSend_fileExistsAtPath_(v13, v14, v5) & 1) == 0)
  {
    if (objc_msgSend_createDirectoryAtPath_withIntermediateDirectories_attributes_error_(v13, v15, v5, 1, 0, 0))
    {
      v16 = 1;
      goto LABEL_10;
    }
