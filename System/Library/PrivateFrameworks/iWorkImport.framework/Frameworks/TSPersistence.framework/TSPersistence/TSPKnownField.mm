...
+ (id)knownFieldWithFieldDescriptor:(const void *)a3 fieldInfo:(const void *)a4 message:(const Message *)a5 reflection:(const Reflection *)a6;
- (TSPKnownField)init;
- (TSPKnownField)initWithFieldDescriptor:(const void *)a3 fieldInfo:(const void *)a4 message:(const Message *)a5 reflection:(const Reflection *)a6;
- (id)debugDescription;
...
+ (id)knownFieldWithFieldDescriptor:(const void *)a3 fieldInfo:(const void *)a4 message:(const Message *)a5 reflection:(const Reflection *)a6
{
  ...
  v9 = *(a3 + 15);
  v28 = google::protobuf::FieldDescriptor::kTypeToCppTypeMap[*(a3 + 14)];
  if (v28 == 8)
  {
    v10 = *(a3 + 17);
    UnknownFields = google::protobuf::Reflection::GetUnknownFields(a6, a5);
  ...
  if (!v31)
  {
    if (v9 == 3)
    {
      if (google::protobuf::Reflection::FieldSize(a6, a5, a3))
      {
        goto LABEL_11;
      }
    }

    else if (google::protobuf::Reflection::HasField(a6, a5, a3))
    {
      goto LABEL_11;
    }

    v18 = [TSPKnownFieldToRemove alloc];
    v20 = objc_msgSend_initWithFieldDescriptor_fieldInfo_message_reflection_(v18, v19, a3, a4, a5, a6);
    goto LABEL_32;
  }
...
LABEL_29:
      ...
      v24 = objc_alloc(*v16);
      v20 = objc_msgSend_initWithFieldDescriptor_fieldInfo_message_reflection_(v24, v25, a3, a4, a5, a6);
      goto LABEL_32;
  }
  ...
  v22 = objc_alloc(*v21);
  v20 = objc_msgSend_initWithFieldDescriptor_fieldInfo_message_reflection_unknownFieldSet_(v22, v23, a3, a4, a5, a6, &v31);
LABEL_32:
  v26 = v20;
  if (*(&v31 + 1))
  {
...
- (TSPKnownField)initWithFieldDescriptor:(const void *)a3 fieldInfo:(const void *)a4 message:(const Message *)a5 reflection:(const Reflection *)a6
{
  ...
  if (v8)
  {
    ...
    v10 = *(a3 + 17);
    *(v8 + 2) = google::protobuf::FieldDescriptor::kTypeToCppTypeMap[*(a3 + 14)];
    *(v8 + 3) = v10;
    sub_2769E211C(v8 + 2, a4);
  }
...
- (void)mergeToMessage:(Message *)a3 reflection:(const Reflection *)a4
{
  ...
  v5 = objc_msgSend_stringWithUTF8String_(MEMORY[0x277CCACA8], a2, "[TSPKnownField mergeToMessage:reflection:]", a4);
