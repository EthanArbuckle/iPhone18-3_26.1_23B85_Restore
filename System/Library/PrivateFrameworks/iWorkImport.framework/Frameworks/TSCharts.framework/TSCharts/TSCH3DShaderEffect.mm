...
- (BOOL)isEqual:(id)equal
{
  equalCopy = equal;
  v4 = objc_opt_class();
  isMemberOfClass = objc_msgSend_isMemberOfClass_(equalCopy, v5, v6, v7, v8, v4);
...
- (void)uploadData:(id)data effectsStates:(id)states updateCurrentStates:(id)currentStates
{
  ...
  if ((v16 & 1) == 0)
  {
    v20 = objc_msgSend_stateForStateInfo_createIfNil_(statesCopy, v15, v17, v18, v19, self, 1);
    v26 = objc_msgSend_stateForStateInfo_createIfNil_(currentStatesCopy, v21, v22, v23, v24, self, 0);
  ...
  objc_msgSend_uploadData_effectsStates_(self, v15, v17, v18, v19, dataCopy, statesCopy);
  if ((v16 & 1) == 0)
  {
    v20 = objc_msgSend_stateForStateInfo_createIfNil_(statesCopy, v34, v35, v36, v37, self, 1);
    objc_msgSend_setState_forStateInfo_(currentStatesCopy, v38, v39, v40, v41, v20, self);
LABEL_12:
  }
}
...
- (void)injectCommonShaderInto:(id)into context:(id)context
{
  ...
  v8 = objc_msgSend_stringWithUTF8String_(MEMORY[0x277CCACA8], a2, v4, v5, v6, "[TSCH3DShaderEffect injectCommonShaderInto:context:]", context);
