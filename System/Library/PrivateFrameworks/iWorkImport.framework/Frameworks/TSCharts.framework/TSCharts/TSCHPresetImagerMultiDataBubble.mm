...
- (void)p_drawShadowedContentIntoContext:(CGContext *)a3 size:(CGSize)a4 contentsScale:(double)a5 preset:(id)a6 target:(int)a7 shouldCache:(BOOL *)a8
{
  ...
  [TSCHPresetImagerBubble p_drawShadowedContentIntoContext:sel_p_drawShadowedContentIntoContext_size_contentsScale_preset_target_shouldCache_ size:a3 contentsScale:v15 preset:v9 target:a8 shouldCache:?];
