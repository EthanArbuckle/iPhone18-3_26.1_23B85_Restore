...
{
  v39 = a3;
  objc_msgSend_addAttributeVariable_(v39, v4, v5, v6, v7, qword_280A465D8);
  objc_msgSend_addAttributeVariable_(v39, v8, v9, v10, v11, qword_280A46620);
  v16 = objc_msgSend_variableTexture(self, v12, v13, v14, v15);
  objc_msgSend_addUniformVariable_(v39, v17, v18, v19, v20, v16);

  v25 = objc_msgSend_variableShadowColor(self, v21, v22, v23, v24);
  objc_msgSend_addUniformVariable_(v39, v26, v27, v28, v29, v25);

  v34 = objc_msgSend_variableShadowBorderFade(self, v30, v31, v32, v33);
  objc_msgSend_addUniformVariable_(v39, v35, v36, v37, v38, v34);
}
...
- (void)injectCommonShaderInto:(id)a3 context:(id)a4
{
  ...
  objc_msgSend_addFragmentDeclarationWithFormat_(v66, v36, v37, v38, v39, v30, v35, qword_280A465D8);

  v40 = qword_280A46620;
  v45 = objc_msgSend_variableShadowBorderFade(self, v41, v42, v43, v44);
  objc_msgSend_addFragmentDeclarationWithFormat_(v66, v46, v47, v48, v49, @"tsch_mediump_float fadeValue = shadowFadeValue(@@.xy, @@)", v40, v45);

  objc_msgSend_addFragmentDeclarationWithFormat_(v66, v50, v51, v52, v53, @"tsch_mediump_vec4 finalShadow = @@", v15);
  objc_msgSend_addFragmentDeclaration_(v66, v54, v55, v56, v57, @"finalShadow.a *= fadeValue * blurValue;");
  objc_msgSend_addFragmentOutcome_statement_(v66, v58, v59, v60, v61, qword_280A464B8, @"finalShadow");
  objc_msgSend_addConclusion_statement_(v66, v62, v63, v64, v65, qword_280A46758, @"@@", qword_280A464B8);
}
...
- (void)uploadData:(id)a3 effectsStates:(id)a4
{
  ...
  objc_msgSend_uniform_vec4_(v6, v82, v83, v84, v85, v81, v104);

  v90 = objc_msgSend_variableShadowBorderFade(self, v86, v87, v88, v89);
  objc_msgSend_uniform_vec2_(v6, v91, v92, v93, v94, v90, &v106);

  v99 = objc_msgSend_variableTexture(self, v95, v96, v97, v98);
  LODWORD(sizep) = v105;
  objc_msgSend_uniform_ivec1_(v6, v100, v101, v102, v103, v99, &sizep);
}
