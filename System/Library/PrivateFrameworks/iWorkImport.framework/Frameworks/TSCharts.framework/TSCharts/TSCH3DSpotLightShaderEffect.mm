...
- (void)uploadSpotLightWithUploader:(id)a3 effectsStates:(id)a4;
@end
...
- (void)uploadSpotLightWithUploader:(id)a3 effectsStates:(id)a4
{
  v6 = a3;
  v102 = a4;
  v12 = objc_msgSend_stateForStateInfo_createIfNil_(v102, v7, v8, v9, v10, self, 1);
  if (!v12)
  {
  ...
  if (v32)
  {
    ...
    for (i = 0; i != v32; ++i)
    {
      ...
      *&v89 = v79;
      v104 = LODWORD(v89);
      objc_msgSend_uniform_vec1_(v6, v90, v89, v91, v92, v88, &v104);

      v97 = objc_msgSend_variableAtIndex_name_(v52, v93, v94, v95, v96, i, @"DropOff");
      *&v98 = fmaxf(fminf(v84, 1.0), 0.0) * 128.0;
      v103 = LODWORD(v98);
      objc_msgSend_uniform_vec1_(v6, v99, v98, v100, v101, v97, &v103);
    }
  }
}
...
- (void)uploadData:(id)a3 effectsStates:(id)a4
{
  ...
  [(TSCH3DLightShaderEffect *)&v20 uploadData:v6 effectsStates:v7];
  objc_msgSend_uploadLightPositionablesWithUploader_effectsStates_(self, v8, v9, v10, v11, v6, v7);
  objc_msgSend_uploadLightDirectionalWithUploader_effectsStates_(self, v12, v13, v14, v15, v6, v7);
  objc_msgSend_uploadSpotLightWithUploader_effectsStates_(self, v16, v17, v18, v19, v6, v7);
}
...
- (void)injectCommonShaderInto:(id)a3 context:(id)a4
{
  ...
  if (self->super._lightCount)
  {
    ...
    do
    {
      ...
      objc_msgSend_assignVariable_statement_substitutes_type_toSection_(v105, v65, v66, v67, v68, v59, @"SpotLight(@@, @@, @@, @@, @@, @@, @@, @@, @@, @@, @@, @@, @@, @@)", v64, 0, 2);
      v69 = qword_280A46448;
      v108 = v59;
      v74 = objc_msgSend_arrayWithObjects_count_(MEMORY[0x277CBEA60], v70, v71, v72, v73, &v108, 1);
      objc_msgSend_assignVariable_statement_substitutes_type_toSection_(v105, v75, v76, v77, v78, v69, @"@@[0]", v74, 0, 2);

      v79 = qword_280A465B8;
      v107 = v59;
      v84 = objc_msgSend_arrayWithObjects_count_(MEMORY[0x277CBEA60], v80, v81, v82, v83, &v107, 1);
      objc_msgSend_assignVariable_statement_substitutes_type_toSection_(v105, v85, v86, v87, v88, v79, @"@@[1]", v84, 0, 2);

      v89 = qword_280A46648;
      v106 = v59;
      v94 = objc_msgSend_arrayWithObjects_count_(MEMORY[0x277CBEA60], v90, v91, v92, v93, &v106, 1);
      objc_msgSend_assignVariable_statement_substitutes_type_toSection_(v105, v95, v96, v97, v98, v89, @"@@[2]", v94, 0, 2);
