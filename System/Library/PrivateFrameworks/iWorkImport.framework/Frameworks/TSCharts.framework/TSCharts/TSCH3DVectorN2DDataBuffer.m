...
- (TSCH3DVectorN2DDataBuffer)initWithCapacityDimension:(const void *)a3;
- (id).cxx_construct;
...
- (TSCH3DVectorN2DDataBuffer)initWithCapacityDimension:(const void *)a3
{
  ...
  v3 = [(TSCH3D2DDataBuffer *)&v7 initWithCapacityDimension:a3];
  v4 = v3;
  if (v3)
  {
...
- (unint64_t)componentByteSize
{
  ...
  if ([(TSCH3DDataBuffer *)&v26 componentByteSize]!= 1)
  {
    ...
    objc_msgSend_handleFailureInFunction_file_lineNumber_isFatal_description_(v7, v15, v16, v17, v18, v8, v13, 382, 0, "componentByteSize mismatch %lu %lu", v14, 1);
