...
- (void)p_drawShadowedContentIntoContext:(CGContext *)a3 size:(CGSize)a4 contentsScale:(double)a5 preset:(id)a6 target:(int)a7 shouldCache:(BOOL *)a8
{
  ...
  *&v121[14] = v36;
  ...
  do
  {
    ...
    v93 = v89;
    v94 = v83;
    objc_msgSend_renderInRoundedCornerClippedContext_forPreset_stroke_barRect_clipRect_isVertical_renderBlock_(self, v95, *&v111, *(&v111 + 1), *&v113, a3, v109, v94, 1, v114, *(&v113 + 1), v111, v113);
