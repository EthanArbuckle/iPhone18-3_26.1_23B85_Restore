...
- (id)genericToSpecificPropertyMap
{
  ...
  block[1] = 3221225472;
  block[2] = sub_2762462EC;
  block[3] = &unk_27A6B6888;
  block[4] = self;
  if (qword_280A46F68 != -1)
  {
    dispatch_once(&qword_280A46F68, block);
  }

  return qword_280A46F60;
}

- (id)userInterfaceName
{
  v5 = sub_276360774(v2, v3, v4);
  v10 = objc_msgSend_localizedStringForKey_value_table_(v5, v6, v7, v8, v9, @"Pie 3D", &stru_288528678, @"TSCharts");
