...
- (TSCH3DUShortDataBuffer)initWithCapacity:(unint64_t)a3
{
  ...
  v4 = [(TSCH3DUShortDataBuffer *)&v7 init];
  v5 = v4;
  if (v4)
  {
...
{
  v26.receiver = self;
  v26.super_class = TSCH3DUShortDataBuffer;
  if ([(TSCH3DDataBuffer *)&v26 componentByteSize]!= 2)
  {
    v7 = MEMORY[0x277D81150];
    v8 = objc_msgSend_stringWithUTF8String_(MEMORY[0x277CCACA8], v3, v4, v5, v6, "[TSCH3DUShortDataBuffer componentByteSize]");
  ...
  v24.receiver = self;
  v24.super_class = TSCH3DUShortDataBuffer;
