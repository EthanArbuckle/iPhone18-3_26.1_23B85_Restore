...
- (TSCHTSWPTextWithDelegate)initWithText:(id)text textDelegate:(id)delegate;
@end
...
- (TSCHTSWPTextWithDelegate)initWithText:(id)text textDelegate:(id)delegate
{
  ...
  if (v10)
  {
    v14 = objc_msgSend_delegate(textCopy, v9, v11, v12, v13);
    ...
    if (v14 != delegateCopy)
    {
      ...
      v30 = objc_msgSend_delegate(textCopy, v26, v27, v28, v29);
      objc_msgSend_handleFailureInFunction_file_lineNumber_isFatal_description_(v19, v31, v32, v33, v34, v20, v25, 233, 0, "Text delegate mismatch %@ expects %@", v30, delegateCopy);

      objc_msgSend_logBacktraceThrottled(MEMORY[0x277D81150], v35, v36, v37, v38);
    }

    objc_storeStrong(&v10->_text, text);
    objc_storeStrong(&v10->_textDelegate, delegate);
  }
