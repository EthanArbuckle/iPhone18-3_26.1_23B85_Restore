...
@implementation TSCHChartTypeStackedColumn3D
...
- (id)userInterfaceName
{
  ...
  v10 = objc_msgSend_localizedStringForKey_value_table_(v5, v6, v7, v8, v9, @"3D Stacked Column", &stru_288528678, @"TSCharts");
...
{
  v11.receiver = self;
  v11.super_class = TSCHChartTypeStackedColumn3D;
...
{
  v5 = sub_276360774(v2, v3, v4);
  v10 = objc_msgSend_localizedStringForKey_value_table_(v5, v6, v7, v8, v9, @"3D Stacked Column Chart", &stru_288528678, @"TSCharts");
