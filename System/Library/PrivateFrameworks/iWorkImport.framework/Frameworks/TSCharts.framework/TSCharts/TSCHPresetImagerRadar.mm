...
- (BOOL)p_isEllipticalWithPreset:(id)a3;
- (UIEdgeInsets)nativeSwatchImageEdgeInsets;
- (UIEdgeInsets)swatchImageEdgeInsetsForSize:(CGSize)a3;
- (double)p_circumscribingRadiusToFitRegularPolygonWithSideCount:(unint64_t)a3 intoHeight:(double)a4;
...
- (double)p_circumscribingRadiusToFitRegularPolygonWithSideCount:(unint64_t)a3 intoHeight:(double)a4
{
  v5 = 3.14159265 / a3;
  v6 = 1.0 / sin(v5);
  return v6 * ((a4 + a4) / (v6 + 1.0 / tan(v5)) * 0.5);
}
...
- (void)p_drawShadowedContentIntoContext:(CGContext *)a3 size:(CGSize)a4 contentsScale:(double)a5 preset:(id)a6 target:(int)a7 shouldCache:(BOOL *)a8
{
  ...
  isEllipticalWithPreset = objc_msgSend_p_isEllipticalWithPreset_(self, a2, a4.width, a4.height, a5, a6);
  ...
  CGContextSaveGState(a3);
  CGContextTranslateCTM(a3, v21, v58);
  objc_msgSend_paintPath_wantsInteriorStroke_inContext_(v38, v41, v42, v43, v44, v40, 0, a3);
  ...
  for (i = 0; i != 5; ++i)
  {
    ...
    v61[0] = v48;
    v61[1] = v49;
    sub_27628C654(a3, &points.x, v61, 2, 0.5);
    CGContextStrokeLineSegments(a3, &points, 2uLL);
    CGContextRestoreGState(a3);
  }
...
- (void)p_drawUnshadowedContentIntoContext:(CGContext *)a3 size:(CGSize)a4 contentsScale:(double)a5 preset:(id)a6 target:(int)a7 shouldCache:(BOOL *)a8
{
  ...
  v12 = a6;
  isEllipticalWithPreset = objc_msgSend_p_isEllipticalWithPreset_(self, v13, v14, v15, v16, v12);
  objc_msgSend_p_squareRectFromSize_inset_(self, v18, width, height, 5.0);
  v23 = v22 * 0.5;
  if (a7 == 1 && (isEllipticalWithPreset & 1) == 0)
  {
  ...
  TSUCenterOfRect();
  TSUAddPoints();
  CGContextTranslateCTM(a3, v26, v27);
  v106 = v12;
  v110 = objc_msgSend_seriesStyles(v12, v28, v29, v30, v31);
  ...
  do
  {
    ...
    sub_27628CBE8(v25, v114, 5uLL, 1u, v65, v61, v66, v67);
    ...
    if (v55)
    {
      ...
      objc_msgSend_p_fillPath_withFill_inContext_(self, v102, v103, v104, v105, v69, v55, v25);
      CGContextRestoreGState(v25);
    }

    objc_msgSend_paintPath_wantsInteriorStroke_inContext_(v50, v68, v70, v71, v72, v69, 0, v25);
    CGPathRelease(v69);
...
- (UIEdgeInsets)swatchImageEdgeInsetsForSize:(CGSize)a3
{
  height = a3.height;
  width = a3.width;
  objc_msgSend_nativeSwatchImageEdgeInsets(self, a2, a3.width, a3.height, v3);
  v8 = v7;
  v10 = v9;
  v12 = v11;
  v14 = v13;
