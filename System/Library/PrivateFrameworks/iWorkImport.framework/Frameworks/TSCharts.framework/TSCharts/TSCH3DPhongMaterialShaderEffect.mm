...
- (void)injectCommonShaderInto:(id)a3 context:(id)a4
{
  ...
  if (v11)
  {
    ...
    objc_msgSend_addDeclaration_statement_(v74, v43, v44, v45, v46, v27, v32, v37, v42);
    ...
    objc_msgSend_addStatement_statement_(v74, v62, v63, v64, v65, v51, @"@@ * @@", v56, v61);
  }
  ...
  else
  {
    ...
    objc_msgSend_addVertexStatement_statement_(v74, v70, v71, v72, v73, v22, @"@@", v51);
  }
}
