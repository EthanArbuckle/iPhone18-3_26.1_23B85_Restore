...
- (void)uploadData:(id)data effectsStates:(id)states
{
  ...
  objc_msgSend_uploadLightDirectionalWithUploader_effectsStates_(self, v8, v9, v10, v11, dataCopy, statesCopy);
}
...
- (void)injectCommonShaderInto:(id)into context:(id)context
{
  ...
  if (self->super._lightCount)
  {
    ...
    do
    {
      ...
      objc_msgSend_assignVariable_statement_substitutes_type_toSection_(intoCopy, v49, v50, v51, v52, v43, @"DirectionalLight(@@, @@, @@, @@, @@, @@, @@, @@, @@, @@)", v48, 0, 2);
      v53 = qword_280A46448;
      v88 = v43;
      v58 = objc_msgSend_arrayWithObjects_count_(MEMORY[0x277CBEA60], v54, v55, v56, v57, &v88, 1);
      objc_msgSend_assignVariable_statement_substitutes_type_toSection_(intoCopy, v59, v60, v61, v62, v53, @"@@[0]", v58, 0, 2);

      v63 = qword_280A465B8;
      v87 = v43;
      v68 = objc_msgSend_arrayWithObjects_count_(MEMORY[0x277CBEA60], v64, v65, v66, v67, &v87, 1);
      objc_msgSend_assignVariable_statement_substitutes_type_toSection_(intoCopy, v69, v70, v71, v72, v63, @"@@[1]", v68, 0, 2);

      v73 = qword_280A46648;
      v86 = v43;
      v78 = objc_msgSend_arrayWithObjects_count_(MEMORY[0x277CBEA60], v74, v75, v76, v77, &v86, 1);
      objc_msgSend_assignVariable_statement_substitutes_type_toSection_(intoCopy, v79, v80, v81, v82, v73, @"@@[2]", v78, 0, 2);
