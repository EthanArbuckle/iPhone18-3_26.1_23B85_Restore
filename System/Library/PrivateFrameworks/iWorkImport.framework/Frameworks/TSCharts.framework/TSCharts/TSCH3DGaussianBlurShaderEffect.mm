...
+ (id)variableAccum;
+ (id)variableTapUnit;
+ (void)setTapUnit:(tvec2<float>)unit effectsStates:(id)states;
...
- (void)injectCommonShaderInto:(id)into context:(id)context
{
  ...
  v94 = contextCopy;
  v25 = objc_msgSend_textureFunctionNameForVariable_projective_(contextCopy, v21, v22, v23, v24, v20, 0);
  ...
  objc_msgSend_assignVariable_statement_substitutes_type_toSection_(intoCopy, v42, v43, v44, v45, v11, v30, v41, 2, 0);
  ...
  do
  {
    ...
    do
    {
      ...
      objc_msgSend_assignVariable_statement_substitutes_type_toSection_(intoCopy, v67, v68, v69, v70, v57, v61, v66, 1, 4);
      ...
      objc_msgSend_assignVariable_statement_substitutes_type_toSection_(intoCopy, v86, v87, v88, v89, v11, v74, v85, 2, 0);
  ...
  while ((v53 & 1) != 0);
  objc_msgSend_addOutcome_statement_(intoCopy, v46, v47, v48, v49, qword_280A464B8, @"@@", v11);
  objc_msgSend_addConclusion_statement_(intoCopy, v90, v91, v92, v93, qword_280A46758, @"@@", qword_280A464B8);
}
...
- (void)uploadData:(id)data effectsStates:(id)states
{
  ...
  sub_2761AC6E8(statesCopy, v12, &v25, v13, v14, v15);

  v20 = objc_msgSend_variableTapUnit(self, v16, v17, v18, v19);
  objc_msgSend_uniform_vec2_(dataCopy, v21, v22, v23, v24, v20, &v25);
}
...
+ (void)setTapUnit:(tvec2<float>)unit effectsStates:(id)states
{
  ...
  sub_2761AC2E4(statesCopy, v9, *&unit);
}
