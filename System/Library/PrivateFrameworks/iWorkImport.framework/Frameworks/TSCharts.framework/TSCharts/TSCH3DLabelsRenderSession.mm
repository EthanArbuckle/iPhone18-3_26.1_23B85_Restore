...
+ (void)performBlockWithRenderer:(id)renderer pipeline:(id)pipeline useLabelBounds:(BOOL)bounds block:(id)block;
@end
...
+ (void)performBlockWithRenderer:(id)renderer pipeline:(id)pipeline useLabelBounds:(BOOL)bounds block:(id)block
{
  ...
  v97 = 0;
  v99 = 1065353216;
  v46 = objc_msgSend_processor(pipelineCopy, v11, v13, v14, v15);
  objc_msgSend_copyProjectionInto_(v46, v47, v48, v49, v50, &v90);

  v55 = objc_msgSend_processor(pipelineCopy, v51, v52, v53, v54);
  objc_msgSend_pushMatrix(v55, v56, v57, v58, v59);

  objc_msgSend_setUseLabelBounds_(rendererCopy, v60, v61, v62, v63, boundsCopy);
  objc_msgSend_prerender_(rendererCopy, v64, v65, v66, v67, pipelineCopy);
  blockCopy[2](blockCopy, pipelineCopy);
  v72 = objc_msgSend_processor(pipelineCopy, v68, v69, v70, v71);
  objc_msgSend_projection_(v72, v73, v74, v75, v76, &v90);

  v81 = objc_msgSend_processor(pipelineCopy, v77, v78, v79, v80);
  objc_msgSend_popMatrix(v81, v82, v83, v84, v85);

  objc_msgSend_postrender_(rendererCopy, v86, v87, v88, v89, pipelineCopy);
}
