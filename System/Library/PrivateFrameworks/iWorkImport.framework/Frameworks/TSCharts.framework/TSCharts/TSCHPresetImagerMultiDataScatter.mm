...
- (void)p_drawShadowedContentIntoContext:(CGContext *)context size:(CGSize)size contentsScale:(double)scale preset:(id)preset target:(int)target shouldCache:(BOOL *)cache
{
  ...
  [TSCHPresetImagerScatter p_drawShadowedContentIntoContext:sel_p_drawShadowedContentIntoContext_size_contentsScale_preset_target_shouldCache_ size:context contentsScale:presetCopy preset:v9 target:cache shouldCache:?];
