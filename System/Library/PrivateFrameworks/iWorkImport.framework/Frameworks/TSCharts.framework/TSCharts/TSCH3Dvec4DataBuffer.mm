...
- (TSCH3Dvec4DataBuffer)initWithCapacity:(unint64_t)capacity;
- (id).cxx_construct;
- (id)elementsAtIndices:(id)indices;
- (unint64_t)componentByteSize;
@end

@implementation TSCH3Dvec4DataBuffer

- (TSCH3Dvec4DataBuffer)initWithCapacity:(unint64_t)capacity
{
  v7.receiver = self;
  v7.super_class = TSCH3Dvec4DataBuffer;
  v4 = [(TSCH3Dvec4DataBuffer *)&v7 init];
  v5 = v4;
  if (v4)
  {
    sub_2761FAEE0(&v4->_container.__begin_, capacity);
  }
...
{
  v26.receiver = self;
  v26.super_class = TSCH3Dvec4DataBuffer;
  if ([(TSCH3DDataBuffer *)&v26 componentByteSize]!= 4)
  {
    v7 = MEMORY[0x277D81150];
    v8 = objc_msgSend_stringWithUTF8String_(MEMORY[0x277CCACA8], v3, v4, v5, v6, "[TSCH3Dvec4DataBuffer componentByteSize]");
    ...
    v25.receiver = self;
    v25.super_class = TSCH3Dvec4DataBuffer;
    componentByteSize = [(TSCH3DDataBuffer *)&v25 componentByteSize];
    objc_msgSend_handleFailureInFunction_file_lineNumber_isFatal_description_(v7, v15, v16, v17, v18, v8, v13, 245, 0, "componentByteSize mismatch %lu %lu", componentByteSize, 4);

    objc_msgSend_logBacktraceThrottled(MEMORY[0x277D81150], v19, v20, v21, v22);
  }

  v24.receiver = self;
  v24.super_class = TSCH3Dvec4DataBuffer;
