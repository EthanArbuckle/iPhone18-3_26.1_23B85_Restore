...
+ (void)setBlendFactor:(float)a3 unit:(int64_t)a4 effectsStates:(id)a5;
- (id)variableBlendFactor;
- (id)variableBlendTexture;
...
+ (void)setBlendFactor:(float)a3 unit:(int64_t)a4 effectsStates:(id)a5
{
  v7 = a5;
  *&v23 = a3;
  v12 = objc_msgSend_stateSharingID(TSCH3DTextureBlendShaderEffect, v8, v9, v10, v11, v23, a4);
  v13 = v7;
...
- (void)addVariables:(id)a3
{
  ...
  objc_msgSend_addUniformVariable_(v26, v9, v10, v11, v12, v8);

  v17 = objc_msgSend_variableBlendTexture(self, v13, v14, v15, v16);
  objc_msgSend_addUniformVariable_(v26, v18, v19, v20, v21, v17);

  objc_msgSend_addAttributeVariable_(v26, v22, v23, v24, v25, qword_280A465D8);
}
...
- (void)injectCommonShaderInto:(id)a3 context:(id)a4
{
  ...
  objc_msgSend_addOutcome_statement_(v44, v40, v41, v42, v43, v17, v22, v23, v28, v33, v34, v39);
}
...
- (void)uploadData:(id)a3 effectsStates:(id)a4
{
  ...
  v76 = 0;
  v77 = 0;
  v17 = objc_msgSend_valueStateForKey_(v7, v13, v14, v15, v16, v12);
  v18 = v17;
  if (v17)
  {
    v19 = v17;
  ...
  LODWORD(v76) = v57;
  objc_msgSend_uniform_vec1_(v6, v63, v64, v65, v66, v62, &v76);

  v71 = objc_msgSend_variableBlendTexture(self, v67, v68, v69, v70);
  LODWORD(v76) = v56;
  objc_msgSend_uniform_ivec1_(v6, v72, v73, v74, v75, v71, &v76);
}
