...
- (double)totalForGroupIndex:(unint64_t)a3
{
  ...
  [(TSCHChartStackedPercentValueAxis *)&v4 totalForGroupIndex:a3 series:0];
  return result;
}
...
- (id)formattedStringForSeries:(id)a3 groupIndex:(unint64_t)a4
{
  ...
  v38 = objc_msgSend_intValueForProperty_defaultValue_(v6, v32, v33, v34, v35, 1167, 0);
  if (v11)
  {
  ...
  {
    objc_msgSend_doubleModelToAxisValue_forSeries_(self, v37, v42, v44, v41, v6);
    v46 = fabs(v45);
    v47 = NAN;
    if (v17 != 0.0)
    {
...
LABEL_14:
  ...
  v49 = objc_msgSend_dataFormatterForSeries_groupIndex_(self, v37, v48, INFINITY, v41, v6, a4);
