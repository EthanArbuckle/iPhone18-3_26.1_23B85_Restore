...
+ (CGSize)mipmapSizeForTexturableSize:(CGSize)size;
+ (CGSize)optimizedMipmapLevel0Size;
+ (id)mipmapNameFromImageName:(id)name;
+ (id)mipmapsFromData:(id)data;
+ (id)mipmapsWithWidth:(int)width height:(int)height components:(unint64_t)components mipmapData:(id)data;
- (BOOL)valid;
- (BOOL)writeToFile:(id)file;
- (TSCH3DMipmaps)initWithWidth:(int)width height:(int)height components:(unint64_t)components mipmapData:(id)data;
- (id)description;
...
+ (id)mipmapNameFromImageName:(id)name
{
  ...
  v7 = objc_msgSend_stringByDeletingPathExtension(name, a2, v3, v4, v5);
...
+ (CGSize)mipmapSizeForTexturableSize:(CGSize)size
{
  v3 = size.width / 1.64999998;
  v4 = size.height / 1.64999998;
  result.height = v4;
  result.width = v3;
  return result;
}
...
+ (id)mipmapsWithWidth:(int)width height:(int)height components:(unint64_t)components mipmapData:(id)data
{
  ...
  dataCopy = data;
  v11 = [self alloc];
  v16 = objc_msgSend_initWithWidth_height_components_mipmapData_(v11, v12, v13, v14, v15, v8, v7, components, dataCopy);
...
+ (id)mipmapsFromData:(id)data
{
  dataCopy = data;
  v5 = [self alloc];
  v10 = objc_msgSend_initFromData_(v5, v6, v7, v8, v9, dataCopy);
...
- (id)initFromData:(id)data
{
  ...
  v94 = 0;
  v10 = objc_msgSend_propertyListWithData_options_format_error_(MEMORY[0x277CCAC58], v5, v7, v8, v9, dataCopy, 0, 0, &v94);
  v11 = v94;
  if (v11)
  {
    v16 = v11;
    ...
    objc_msgSend_handleFailureInFunction_file_lineNumber_isFatal_description_(v17, v29, v30, v31, v32, v18, v23, 96, 0, "failed to load plist %@ error %@", dataCopy, v28);
...
LABEL_10:
    ...
    objc_msgSend_handleFailureInFunction_file_lineNumber_isFatal_description_(v78, v85, v86, v87, v88, v79, v84, 109, 0, "failed to load plist %@, %@", dataCopy, v6);
...
- (BOOL)writeToFile:(id)file
{
  ...
  if (v64)
  {
    v70 = objc_msgSend_writeToFile_atomically_(v64, v65, v67, v68, v69, fileCopy, 1);
  }
