...
- (TSCH3Dvec4DataBuffer)initWithCapacity:(unint64_t)a3;
- (id).cxx_construct;
...
- (TSCH3Dvec4DataBuffer)initWithCapacity:(unint64_t)a3
{
  ...
  if (v4)
  {
    sub_2761FAEE0(&v4->_container.__begin_, a3);
  }
...
- (unint64_t)componentByteSize
{
  ...
  if ([(TSCH3DDataBuffer *)&v26 componentByteSize]!= 4)
  {
    ...
    objc_msgSend_handleFailureInFunction_file_lineNumber_isFatal_description_(v7, v15, v16, v17, v18, v8, v13, 245, 0, "componentByteSize mismatch %lu %lu", v14, 4);
