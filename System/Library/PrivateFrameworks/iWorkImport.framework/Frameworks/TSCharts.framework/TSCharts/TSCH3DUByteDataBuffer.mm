...
- (TSCH3DUByteDataBuffer)initWithCapacity:(unint64_t)capacity;
- (id).cxx_construct;
...
- (TSCH3DUByteDataBuffer)initWithCapacity:(unint64_t)capacity
{
  ...
  if (v4)
  {
    sub_2761FB370(&v4->_container.__begin_, capacity);
  }
...
- (unint64_t)componentByteSize
{
  ...
  if ([(TSCH3DDataBuffer *)&v26 componentByteSize]!= 1)
  {
    ...
    objc_msgSend_handleFailureInFunction_file_lineNumber_isFatal_description_(v7, v15, v16, v17, v18, v8, v13, 296, 0, "componentByteSize mismatch %lu %lu", componentByteSize, 1);
