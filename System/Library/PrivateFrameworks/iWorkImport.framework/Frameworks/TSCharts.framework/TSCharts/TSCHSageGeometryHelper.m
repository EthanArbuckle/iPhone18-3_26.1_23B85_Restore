...
+ (CGRect)sageChartAreaBoundsForExportWithChartInfo:(id)a3 geometryRect:(CGRect)a4 returningContainingViewportSize:(id *)a5;
+ (id)helperWithImportedChartInfo:(id)a3 importedInfoGeometry:(id)a4;
- (CGSize)naturalSize;
- (TSCHSageGeometryHelper)initWithImportedChartInfo:(id)a3 importedInfoGeometry:(id)a4;
@end
...
+ (id)helperWithImportedChartInfo:(id)a3 importedInfoGeometry:(id)a4
{
  ...
  v36 = objc_msgSend_chartType(v6, v17, v18, v19, v20);
  v41 = objc_alloc(objc_msgSend_sageGeometeryHelperClass(v36, v37, v38, v39, v40));
  v46 = objc_msgSend_initWithImportedChartInfo_importedInfoGeometry_(v41, v42, v43, v44, v45, v6, v5);
...
+ (CGRect)sageChartAreaBoundsForExportWithChartInfo:(id)a3 geometryRect:(CGRect)a4 returningContainingViewportSize:(id *)a5
{
  ...
  v40 = objc_msgSend_chartType(v10, v21, v22, v23, v24);
  v45 = objc_msgSend_sageGeometeryHelperClass(v40, v41, v42, v43, v44);
  objc_msgSend_computeSageChartAreaBoundsForChartInfo_geometryRect_returningContainingViewportSize_(v45, v46, x, y, width, v10, a5, height);
  v48 = v47;
  v50 = v49;
  v52 = v51;
  v54 = v53;
...
- (TSCHSageGeometryHelper)initWithImportedChartInfo:(id)a3 importedInfoGeometry:(id)a4
{
  ...
  if (v9)
  {
    objc_storeStrong(&v9->_chartInfo, a3);
    if (v8)
    {
      v15 = objc_msgSend_mutableCopy(v8, v11, v12, v13, v14);
