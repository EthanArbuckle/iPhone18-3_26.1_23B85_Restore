...
- (id)tokenSharegroup
{
  ...
  if (!v2->_sharegroup)
  {
    ...
    v12 = objc_msgSend_uniqueSharegroupWithOwningThread_token_(TSCH3DGPUSharegroup, v8, v9, v10, v11, v7, v2);
    sharegroup = v2->_sharegroup;
    v2->_sharegroup = v12;
  }

  objc_msgSend_invalidateCondition(v2->_checker, v3, v4, v5, v6);
  v14 = v2->_sharegroup;
  objc_sync_exit(v2);
...
- (void)releaseSharegroup:(id)a3
{
  ...
  if (sharegroup != v4)
  {
    ...
    v10 = objc_msgSend_stringWithUTF8String_(MEMORY[0x277CCACA8], v4, v5, v6, v7, "[TSCH3DCachedSharegroupToken releaseSharegroup:]");
  ...
  objc_msgSend_setOwningThread_(sharegroup, v4, v5, v6, v7, 0);
}
