...
@implementation TSCHChartFeatureArea
...
- (id)genericToSpecificPropertyMap
{
  ...
  block[1] = 3221225472;
  block[2] = sub_27635627C;
  block[3] = &unk_27A6B6888;
  block[4] = self;
  if (qword_280A47B70 != -1)
  {
    dispatch_once(&qword_280A47B70, block);
  }

  return qword_280A47B68;
}
