...
@implementation TSCHChartFeatureStackedColumn
...
- (id)defaultDataFileName
{
  ...
  {
    v10 = @"TSCHDefaultDataStackedColumn.plist";
  }
...
- (id)genericToSpecificPropertyMap
{
  ...
  block[1] = 3221225472;
  block[2] = sub_276356E20;
  block[3] = &unk_27A6B6888;
  block[4] = self;
  if (qword_280A47B90 != -1)
  {
    dispatch_once(&qword_280A47B90, block);
  }

  return qword_280A47B88;
}
