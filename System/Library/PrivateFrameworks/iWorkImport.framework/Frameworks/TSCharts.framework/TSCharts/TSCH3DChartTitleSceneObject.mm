...
+ (BOOL)setLabelWrapBounds:(void *)bounds forScene:(id)scene
{
  sceneCopy = scene;
  v31 = 0;
  objc_msgSend_p_labelWrapSizeForScene_returningSizeValue_(self, v7, v8, v9, v10, sceneCopy, &v31);
  v28 = v12;
  v29 = v11;
  v13 = v31;
  v14 = *bounds;
  *&v30[0] = vsub_f32(*(bounds + 8), *bounds);
  objc_msgSend_adjustLabelWrapSize_forScene_(TSCH3DChartResizer, v15, v30[0], *&v14, v16, v30, sceneCopy);
  ...
  else
  {
    ...
    objc_msgSend_setProperties_forType_(sceneCopy, v22, v23, v24, v25, v21, @"TSCH3DChartTitleSceneObjectLabelWrapBoundsPropertyKey");
