...
- (void)injectCommonShaderInto:(id)into context:(id)context
{
  ...
  objc_msgSend_addConclusion_statement_(intoCopy, v40, v41, v42, v43, qword_280A46758, @"@@", qword_280A464B8);
}
...
- (void)uploadData:(id)data effectsStates:(id)states
{
  dataCopy = data;
  statesCopy = states;
  v12 = objc_msgSend_stateForStateInfo_createIfNil_(statesCopy, v8, v9, v10, v11, self, 0);
  v17 = v12;
  if (v12)
  {
    ...
    objc_msgSend_uniform_ivec1_(dataCopy, v42, v43, v44, v45, v37, &v46);
  }
}
