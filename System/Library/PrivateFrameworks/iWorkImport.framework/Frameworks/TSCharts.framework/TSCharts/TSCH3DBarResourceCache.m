...
+ (id)barWithExtrusionSetting:(const BarExtrusionSetting *)a3;
+ (id)instance;
- (TSCH3DBarResourceCache)init;
- (id)p_barWithExtrusionSetting:(const BarExtrusionSetting *)a3;
@end
...
{
  size = a3->size;
  hasBottomBevel = a3->hasBottomBevel;
  if (hasBottomBevel || (LODWORD(v3) = 1.0, a3->hasTopBevel))
  {
    if (a3->isStackedBar || (LODWORD(v3) = 1.0, a3->isCylindrical || hasBottomBevel))
    {
      if (size >= 1.0)
      {
LABEL_9:
  ...
  v19 = *&a3->details.spine.bevelHeight;
  LODWORD(v17) = LODWORD(v3);
  v10 = objc_msgSend_instance(a1, a2, *&v19, v3, *&v9, v17, v18, v19, v9);
...
- (id)p_barWithExtrusionSetting:(const BarExtrusionSetting *)a3
{
  ...
  if (!v15)
  {
    v15 = objc_msgSend_itemWithExtrusionSetting_(TSCH3DBarResourceCacheItem, v14, v16, v17, v18, a3);
