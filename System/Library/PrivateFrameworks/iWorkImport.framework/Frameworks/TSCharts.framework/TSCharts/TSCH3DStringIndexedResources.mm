...
- (id)resourceAtIndex:(const void *)a3 string:(id)a4;
@end
...
{
  v6 = a4;
  if ((objc_msgSend_hasResourceAtIndex_(self, v7, v8, v9, v10, a3) & 1) == 0)
  {
    ...
    v64 = *(a3 + 1);
    sub_276152FD4("ivec2(%d, %d)", v23, v24, v25, v26, v27, v28, v29, *a3);
    if (v67 >= 0)
    {
  ...
  v44 = [(TSCH3DArray2DResources *)&v65 resourceAtIndex:a3];
  if (!v44)
  {
  ...
  objc_msgSend_setString_(v44, v43, v45, v46, v47, v6);
