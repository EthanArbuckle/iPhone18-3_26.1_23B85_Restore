...
- (TSCH3DDefaultNormalDirectionMapper)initWithNormalBias:(void *)bias;
- (id).cxx_construct;
...
{
  v4 = [self alloc];
  v9 = objc_msgSend_initWithNormalBias_(v4, v5, v6, v7, v8, bias);
...
- (TSCH3DDefaultNormalDirectionMapper)initWithNormalBias:(void *)bias
{
  ...
  if (result)
  {
    result->_normalBias.var0.var0 = *bias;
    result->_normalBias.var1.var0 = *(bias + 1);
    result->_normalBias.var2.var0 = *(bias + 2);
  }
...
- (void)mapFromVertexArray:(const void *)array normalArray:(const void *)normalArray normalMatrix:(void *)matrix numVertices:(int64_t)vertices destination:(void *)destination
{
  ...
  if (vertices != 3 * (vertices / 3))
  {
    ...
    v17 = objc_msgSend_stringWithUTF8String_(MEMORY[0x277CCACA8], a2, v7, v8, v9, "[TSCH3DDefaultNormalDirectionMapper mapFromVertexArray:normalArray:normalMatrix:numVertices:destination:]", normalArray);
  ...
  v31 = *(destination + 1) - *destination;
  if (v15 <= v31)
  {
    if (v15 < v31)
    {
      *(destination + 1) = *destination + v15;
    }
  }

  else
  {
    sub_2761FC724(destination, v15 - v31);
  }
  ...
  if (vertices >= 1)
  {
    ...
    do
    {
      ...
      v62 = (((v59 * *(matrix + 5)) + (*(matrix + 2) * v58)) + (*(matrix + 8) * v60)) * self->_normalBias.var2.var0;
      v63 = vmul_f32(vmla_n_f32(vmla_n_f32(vmul_n_f32(*(matrix + 12), v59), *matrix, v58), *(matrix + 24), v60), *&self->_normalBias.var0.var0);
