...
- (KNNoteInfo)initWithContext:(id)a3 containedStorage:(id)a4;
- (NSArray)childInfos;
- (TSDInfo)parentInfo;
- (id)childEnumerator;
...
- (KNNoteInfo)initWithContext:(id)a3 containedStorage:(id)a4
{
  ...
  v8 = [(KNNoteInfo *)&v35 initWithContext:v6];
  if (v8)
  {
    if (v7)
    {
    ...
    {
      objc_opt_class();
      v13 = objc_msgSend_documentRoot(v6, v11, v12);
      ...
      v31 = objc_msgSend_initWithContext_string_kind_stylesheet_paragraphStyle_listStyle_section_columnStyle_(v23, v30, v6, 0, 4, v26, v22, v29, 0, 0);
...
- (id)copyWithContext:(id)a3
{
  v4 = a3;
  v5 = [KNNoteInfo alloc];
  v8 = objc_msgSend_initWithContext_(v5, v6, v4);
  if (v8)
  {
    v9 = objc_msgSend_copyWithContext_(self->_containedStorage, v7, v4);
    v10 = v8[10];
    v8[10] = v9;
...
- (void)adoptStylesheet:(id)a3 withMapper:(id)a4
{
  ...
  objc_msgSend_adoptStylesheet_withMapper_(v13, v12, v7, v6);
}

- (void)setContainedStorage:(id)a3
{
  v5 = a3;
  if (self->_containedStorage != v5)
  {
    v10 = v5;
...
- (void)wasAddedToDocumentRoot:(id)a3 dolcContext:(id)a4
{
  ...
  objc_msgSend_wasAddedToDocumentRoot_dolcContext_(v15, v14, v7, v6);
}
...
- (void)willBeRemovedFromDocumentRoot:(id)a3
{
  ...
  v12 = objc_msgSend_context(v4, v9, v10);
...
- (void)loadFromUnarchiver:(id)a3
{
  ...
  v5 = objc_msgSend_messageWithDescriptor_(v7, v4, off_2812EA908[20]);
...
- (void)saveToArchiver:(id)a3
{
  v7 = a3;
  google::protobuf::internal::AssignDescriptors();
  v5 = objc_msgSend_messageWithNewFunction_descriptor_(v7, v4, sub_275DBB1D8, off_2812EA908[20]);
...
- (void)saveToArchive:(void *)a3 archiver:(id)a4
{
  ...
  *(a3 + 4) |= 1u;
  ...
  objc_msgSend_setStrongReference_message_(v12, v8, v9, v10);
}
