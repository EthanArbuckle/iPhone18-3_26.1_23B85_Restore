...
- (KNRecordingEventTrack)initWithContext:(id)a3 type:(id)a4 events:(id)a5;
- (id)description;
- (id)eventTrackByReplacingSegmentAfterTime:(double)a3 withEventTrack:(id)a4;
...
- (KNRecordingEventTrack)initWithContext:(id)a3 type:(id)a4 events:(id)a5
{
  ...
  v12 = [(KNRecordingEventTrack *)&v20 initWithContext:a3];
  if (v12)
  {
...
- (id)eventTrackByReplacingSegmentAfterTime:(double)a3 withEventTrack:(id)a4
{
  ...
  v27 = objc_msgSend_events(v6, v25, v26);
  ...
  if (v61)
  {
    ...
    do
    {
      for (i = 0; i != v64; ++i)
      {
        ...
        v67 = objc_msgSend_recordingEventByAddingTimeOffset_(*(*(&v76 + 1) + 8 * i), v62, v63, a3);
...
- (void)loadFromArchive:(const void *)a3 unarchiver:(id)a4
{
  ...
  if (v6 >= 1)
  {
    ...
    do
    {
      ...
      if ((v12 & 1) != 0 || (v12 & 4) != 0 || (v12 & 2) != 0 || (v12 & 8) != 0)
      {
        ...
        {
          v14 = [v13 alloc];
          v16 = objc_msgSend_initWithMessage_unarchiver_parentEventTrack_(v14, v15, v11, v24, self);
  ...
  if (*(a3 + 16))
  {
    v19 = objc_msgSend_tsp_stringWithProtobufString_(MEMORY[0x277CCACA8], v18, *(a3 + 6) & 0xFFFFFFFFFFFFFFFELL);
...
- (void)loadFromUnarchiver:(id)a3
{
  ...
  v5 = objc_msgSend_messageWithDescriptor_(v7, v4, off_2812EA908[76]);
...
- (void)saveToArchiver:(id)a3
{
  v7 = a3;
  google::protobuf::internal::AssignDescriptors();
  v5 = objc_msgSend_messageWithNewFunction_descriptor_(v7, v4, sub_275DC486C, off_2812EA908[76]);
