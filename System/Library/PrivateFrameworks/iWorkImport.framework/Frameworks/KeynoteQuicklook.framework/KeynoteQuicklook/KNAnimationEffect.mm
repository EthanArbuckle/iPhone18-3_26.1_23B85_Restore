...
+ (id)updateDirectionAttributeValue:(int64_t)value andCustomTextDirectionValue:(unint64_t)directionValue turnOffBounce:(BOOL)bounce turnOffMotionBlur:(BOOL)blur forAttributes:(id)attributes
{
  blurCopy = blur;
  bounceCopy = bounce;
  v12 = objc_msgSend_mutableCopy(attributes, a2, value);
  v14 = objc_msgSend_numberWithInteger_(MEMORY[0x277CCABB0], v13, value);
  objc_msgSend_setObject_forKey_(v12, v15, v14, @"KNBuildAttributesDirection");
  if (!objc_msgSend_objectForKey_(attributes, v16, @"KNBuildCustomAttributesTextDelivery"))
  {
    objc_msgSend_setObject_forKey_(v12, v17, &unk_2884F3600, @"KNBuildCustomAttributesTextDelivery");
  }

  v18 = objc_msgSend_numberWithUnsignedInteger_(MEMORY[0x277CCABB0], v17, directionValue);
...
- (CATransform3D)mvpMatrixWithContext:(SEL)context
{
  if (!objc_msgSend_isTransition(a4, context, a4))
  {
...
- (CATransform3D)mvpMatrixWithTexture:(SEL)texture andFrame:(id)frame
{
  ...
  *&retstr->m13 = 0u;
  ...
  v13 = objc_msgSend_parent(frame, v11, v12);
  objc_msgSend_frame(v13, v14, v15);
  v17 = v16;
  objc_msgSend_frame(frame, v18, v19);
  v21 = v17 + v20;
  v45.origin.x = x;
  v45.origin.y = y;
  ...
  v25 = objc_msgSend_parent(frame, v23, v24);
  objc_msgSend_frame(v25, v26, v27);
  v29 = v28;
  objc_msgSend_frame(frame, v30, v31);
...
- (CATransform3D)perspectiveMVPMatrixWithTexture:(SEL)texture andFrame:(id)frame
{
  ...
  y = a5.origin.y;
  x = a5.origin.x;
  v12 = objc_msgSend_parent(frame, texture, frame);
  objc_msgSend_frame(v12, v13, v14);
  v16 = v15;
  objc_msgSend_frame(frame, v17, v18);
  v20 = v16 + v19;
  v53.origin.x = x;
  v53.origin.y = y;
  ...
  v23 = objc_msgSend_parent(frame, v21, v22);
  objc_msgSend_frame(v23, v24, v25);
  v27 = v26;
  objc_msgSend_frame(frame, v28, v29);
