...
- (BOOL)drawPolyPageInContext:(CGContext *)a3 viewScale:(double)a4 unscaledClipRect:(CGRect)a5 createPage:(BOOL)a6;
...
{
  v6 = a6;
  objc_msgSend_beginPageInContext_viewScale_unscaledClipRect_createPage_(self, a2, a3, a4, a5.origin.x, a5.origin.y, a5.size.width, a5.size.height);
  v10 = v9;
  v12 = v11;
  v14 = v13;
  v16 = v15;
  ...
  objc_msgSend_drawPolyPageBodyInContext_scaledClipRect_(self, v24, a3);
  CGContextRestoreGState(a3);
  objc_msgSend_drawDateForRect_context_(self, v25, a3, v10, v12, v14, v16);
  objc_msgSend_endPageInContext_createPage_(self, v26, a3, v6);
  return 1;
}
...
- (void)drawPolyPageBodyInContext:(CGContext *)a3 scaledClipRect:(CGRect)a4
{
  ...
  v5 = objc_msgSend_stringWithUTF8String_(MEMORY[0x277CCACA8], a2, "[KNPdfPolyExporter drawPolyPageBodyInContext:scaledClipRect:]", a4.origin.x, a4.origin.y, a4.size.width, a4.size.height);
