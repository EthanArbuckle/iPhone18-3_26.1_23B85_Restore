...
+ (id)axDescriptionForStyleIdentifier:(id)a3;
+ (id)backgroundNameForStyleIdentifier:(id)a3;
+ (id)defaultStyleWithContext:(id)a3;
+ (id)nextUnusedStyleIdentifierInStylesheet:(id)a3;
+ (id)properties;
+ (id)propertiesAllowingNSNull;
+ (id)toolTipForStyle:(id)a3;
- (KNMotionBackgroundStyle)initWithContext:(id)a3 name:(id)a4 overridePropertyMap:(id)a5 isVariation:(BOOL)a6;
- (TSUColor)referenceColor;
- (id)makeAlternateFill;
- (id)targetParentForStyleMappingByStyleMapper:(id)a3 intoStylesheet:(id)a4;
- (void)copyAuxiliaryInformationToMigratedStyle:(id)a3;
- (void)loadFromArchive:(const void *)a3 unarchiver:(id)a4;
- (void)loadFromUnarchiver:(id)a3;
- (void)loadMotionBackgroundStylePropertiesIntoPropertyMap:(id)a3 fromArchive:(const void *)a4 unarchiver:(id)a5;
- (void)notifyClientsOfUpdate;
- (void)saveMotionBackgroundStylePropertyMap:(id)a3 toArchive:(void *)a4 archiver:(id)a5;
- (void)saveToArchive:(void *)a3 archiver:(id)a4;
- (void)saveToArchiver:(id)a3;
- (void)setOverridePropertyMap:(id)a3;
- (void)setPosterFrameData:(id)a3;
@end
...
- (KNMotionBackgroundStyle)initWithContext:(id)a3 name:(id)a4 overridePropertyMap:(id)a5 isVariation:(BOOL)a6
{
  ...
  return [(KNMotionBackgroundStyle *)&v7 initWithContext:a3 name:a4 overridePropertyMap:a5 isVariation:a6];
}
...
- (void)setOverridePropertyMap:(id)a3
{
  ...
  v7.receiver = self;
  v7.super_class = KNMotionBackgroundStyle;
  [(KNMotionBackgroundStyle *)&v7 setOverridePropertyMap:v4];
...
- (void)setPosterFrameData:(id)a3
{
  ...
  objc_storeStrong(&self->_posterFrameData, a3);
...
- (id)targetParentForStyleMappingByStyleMapper:(id)a3 intoStylesheet:(id)a4
{
  ...
  if (v23)
  {
    v25 = objc_msgSend_cascadedStyleWithIdentifier_(v5, v24, v23);
    if (v17[2](v17, v25))
    {
      if (v25)
      {
  ...
  v25 = objc_msgSend_firstCascadedStylePassingTest_(v5, v24, v17);
LABEL_9:
...
+ (id)backgroundNameForStyleIdentifier:(id)a3
{
  ...
  v5 = objc_msgSend_objectForKeyedSubscript_(qword_280A3BF80, v3, v4);
  if (!v5)
  {
    v6 = sub_275DC204C();
...
+ (id)axDescriptionForStyleIdentifier:(id)a3
{
  ...
  v5 = objc_msgSend_objectForKeyedSubscript_(qword_280A3BF90, v3, v4);
  if (!v5)
  {
    v6 = sub_275DC204C();
...
+ (id)toolTipForStyle:(id)a3
{
  v4 = objc_msgSend_styleIdentifier(a3, a2, a3);
  v6 = objc_msgSend_backgroundNameForStyleIdentifier_(a1, v5, v4);
...
+ (id)nextUnusedStyleIdentifierInStylesheet:(id)a3
{
  ...
  do
  {
    ...
    v10 = objc_msgSend_styleWithIdentifier_(v3, v9, v8);
...
- (void)loadMotionBackgroundStylePropertiesIntoPropertyMap:(id)a3 fromArchive:(const void *)a4 unarchiver:(id)a5
{
  ...
  if ((v11 & 0x80) != 0)
  {
    ...
    objc_msgSend_setObject_forProperty_(v7, v13, v12, 4108);
  ...
  if ((v11 & 0x100) != 0)
  {
    ...
    objc_msgSend_setObject_forProperty_(v7, v15, v14, 4109);
  ...
  if ((v11 & 0x200) != 0)
  {
    ...
    objc_msgSend_setObject_forProperty_(v7, v17, v16, 4110);
  ...
  if ((v11 & 0x800) != 0)
  {
    ...
    objc_msgSend_setObject_forProperty_(v7, v19, v18, 4191);
  ...
  if ((v11 & 0x400) != 0)
  {
    ...
    objc_msgSend_setObject_forProperty_(v7, v21, v20, 4111);
  ...
  if (v11)
  {
    ...
    v24 = objc_msgSend_tsp_initWithProtobufString_(v22, v23, *(a4 + 5) & 0xFFFFFFFFFFFFFFFELL);
    v263 = v24;
    v25 = objc_opt_class();
    ...
    if (v27)
    {
      objc_msgSend_setObject_forProperty_(v7, v29, v28, 4101);
    }
  ...
  if ((v11 & 2) != 0)
  {
    ...
    v32 = objc_msgSend_tsp_initWithProtobufString_(v30, v31, *(a4 + 6) & 0xFFFFFFFFFFFFFFFELL);
    v262 = v32;
    v33 = objc_opt_class();
    ...
    if (v35)
    {
      objc_msgSend_setObject_forProperty_(v7, v37, v36, 4102);
    }
  ...
  if ((v11 & 0x40) != 0)
  {
    v38 = objc_msgSend_instanceWithArchive_unarchiver_(MEMORY[0x277D80248], v9, *(a4 + 11), v8);
    v261 = v38;
    v39 = objc_opt_class();
    ...
    if (v41)
    {
      objc_msgSend_setObject_forProperty_(v7, v43, v42, 4107);
    }
  }
  ...
  if ((*(a4 + 21) & 8) != 0)
  {
    ...
    {
      objc_msgSend_setIntValue_forProperty_(v7, v9, LODWORD(v260), 4112);
    }
  }
  ...
  if ((*(a4 + 17) & 0x10) != 0)
  {
    ...
    {
      *&v45 = v260;
      objc_msgSend_setFloatValue_forProperty_(v7, v9, 4118, v45);
    }
  }
  ...
  if ((v46 & 0x80000) != 0)
  {
    ...
    {
      *&v48 = v260;
      objc_msgSend_setFloatValue_forProperty_(v7, v9, 4119, v48);
    }
  ...
  if ((v46 & 0x100000) != 0)
  {
    ...
    {
      *&v50 = v260;
      objc_msgSend_setFloatValue_forProperty_(v7, v9, 4120, v50);
    }
  ...
  if ((v46 & 0x200000) != 0)
  {
    ...
    {
      *&v52 = v260;
      objc_msgSend_setFloatValue_forProperty_(v7, v9, 4121, v52);
    }
  ...
  if ((v46 & 0x400000) != 0)
  {
    ...
    {
      *&v54 = v260;
      objc_msgSend_setFloatValue_forProperty_(v7, v9, 4122, v54);
    }
  ...
  if ((v46 & 0x800000) != 0)
  {
    ...
    {
      *&v56 = v260;
      objc_msgSend_setFloatValue_forProperty_(v7, v9, 4123, v56);
    }
  ...
  if ((v46 & 0x1000000) != 0)
  {
    ...
    {
      *&v58 = v260;
      objc_msgSend_setFloatValue_forProperty_(v7, v9, 4124, v58);
    }
  }
  ...
  if ((*(a4 + 17) & 0x20) != 0)
  {
    ...
    {
      *&v60 = v260;
      objc_msgSend_setFloatValue_forProperty_(v7, v9, 4146, v60);
    }
  }
  ...
  if ((*(a4 + 27) & 2) != 0)
  {
    ...
    {
      *&v62 = v260;
      objc_msgSend_setFloatValue_forProperty_(v7, v9, 4147, v62);
    }
  }
  ...
  if ((v63 & 0x4000) != 0)
  {
    ...
    {
      *&v65 = v260;
      objc_msgSend_setFloatValue_forProperty_(v7, v9, 4148, v65);
    }
  ...
  if ((v63 & 0x8000) != 0)
  {
    ...
    {
      *&v67 = v260;
      objc_msgSend_setFloatValue_forProperty_(v7, v9, 4149, v67);
    }
  }
  ...
  if ((v68 & 0x10000000) != 0)
  {
    ...
    {
      *&v70 = v260;
      objc_msgSend_setFloatValue_forProperty_(v7, v9, 4150, v70);
    }
  ...
  if ((v68 & 0x20000000) != 0)
  {
    ...
    {
      *&v72 = v260;
      objc_msgSend_setFloatValue_forProperty_(v7, v9, 4151, v72);
    }
  ...
  if ((v68 & 0x40000000) != 0)
  {
    ...
    {
      *&v74 = v260;
      objc_msgSend_setFloatValue_forProperty_(v7, v9, 4152, v74);
    }
  ...
  if (v68 < 0)
  {
    ...
    {
      *&v76 = v260;
      objc_msgSend_setFloatValue_forProperty_(v7, v9, 4153, v76);
    }
  }
  ...
  if ((v77 & 0x10000) != 0)
  {
    ...
    {
      *&v79 = v260;
      objc_msgSend_setFloatValue_forProperty_(v7, v9, 4156, v79);
    }
  ...
  if ((v77 & 0x20000) != 0)
  {
    ...
    {
      objc_msgSend_setIntValue_forProperty_(v7, v9, LODWORD(v260), 4177);
    }
  ...
  if ((v77 & 0x40000) != 0)
  {
    ...
    {
      *&v81 = v260;
      objc_msgSend_setFloatValue_forProperty_(v7, v9, 4176, v81);
    }
  }
  ...
  if ((*(a4 + 21) & 0x10) != 0)
  {
    ...
    {
      objc_msgSend_setIntValue_forProperty_(v7, v9, LODWORD(v260) != 0, 4178);
    }
  }
  ...
  if ((v82 & 4) != 0)
  {
    ...
    v85 = objc_msgSend_tsp_initWithProtobufString_(v83, v84, *(a4 + 7) & 0xFFFFFFFFFFFFFFFELL);
    v259 = v85;
    v86 = objc_opt_class();
    ...
    if (v88)
    {
      objc_msgSend_setObject_forProperty_(v7, v90, v89, 4103);
    }
  ...
  if ((v82 & 8) != 0)
  {
    ...
    v93 = objc_msgSend_tsp_initWithProtobufString_(v91, v92, *(a4 + 8) & 0xFFFFFFFFFFFFFFFELL);
    v258 = v93;
    v94 = objc_opt_class();
    ...
    if (v96)
    {
      objc_msgSend_setObject_forProperty_(v7, v98, v97, 4104);
    }
  ...
  if ((v82 & 0x10) != 0)
  {
    ...
    v101 = objc_msgSend_tsp_initWithProtobufString_(v99, v100, *(a4 + 9) & 0xFFFFFFFFFFFFFFFELL);
    v257 = v101;
    v102 = objc_opt_class();
    ...
    if (v104)
    {
      objc_msgSend_setObject_forProperty_(v7, v106, v105, 4105);
    }
  ...
  if ((v82 & 0x20) != 0)
  {
    ...
    v109 = objc_msgSend_tsp_initWithProtobufString_(v107, v108, *(a4 + 10) & 0xFFFFFFFFFFFFFFFELL);
    v256 = v109;
    v110 = objc_opt_class();
    ...
    if (v112)
    {
      objc_msgSend_setObject_forProperty_(v7, v114, v113, 4106);
    }
  ...
  if ((v82 & 0x80000) != 0)
  {
    ...
    {
      *&v116 = v260;
      objc_msgSend_setFloatValue_forProperty_(v7, v9, 4113, v116);
    }
  ...
  if ((v82 & 0x100000) != 0)
  {
    ...
    {
      *&v118 = v260;
      objc_msgSend_setFloatValue_forProperty_(v7, v9, 4114, v118);
    }
  ...
  if ((v82 & 0x200000) != 0)
  {
    ...
    {
      *&v120 = v260;
      objc_msgSend_setFloatValue_forProperty_(v7, v9, 4115, v120);
    }
  ...
  if ((v82 & 0x400000) != 0)
  {
    ...
    {
      *&v122 = v260;
      objc_msgSend_setFloatValue_forProperty_(v7, v9, 4116, v122);
    }
  ...
  if ((v82 & 0x800000) != 0)
  {
    ...
    {
      *&v124 = v260;
      objc_msgSend_setFloatValue_forProperty_(v7, v9, 4117, v124);
    }
  ...
  if ((v82 & 0x1000000) != 0)
  {
    ...
    {
      *&v126 = v260;
      objc_msgSend_setFloatValue_forProperty_(v7, v9, 4125, v126);
    }
  ...
  if ((v82 & 0x2000000) != 0)
  {
    ...
    {
      *&v128 = v260;
      objc_msgSend_setFloatValue_forProperty_(v7, v9, 4126, v128);
    }
  ...
  if ((v82 & 0x4000000) != 0)
  {
    ...
    {
      *&v130 = v260;
      objc_msgSend_setFloatValue_forProperty_(v7, v9, 4127, v130);
    }
  ...
  if ((v82 & 0x8000000) != 0)
  {
    ...
    {
      *&v132 = v260;
      objc_msgSend_setFloatValue_forProperty_(v7, v9, 4128, v132);
    }
  ...
  if ((v82 & 0x10000000) != 0)
  {
    ...
    {
      *&v134 = v260;
      objc_msgSend_setFloatValue_forProperty_(v7, v9, 4129, v134);
    }
  ...
  if ((v82 & 0x20000000) != 0)
  {
    ...
    {
      *&v136 = v260;
      objc_msgSend_setFloatValue_forProperty_(v7, v9, 4130, v136);
    }
  ...
  if ((v82 & 0x40000000) != 0)
  {
    ...
    {
      *&v138 = v260;
      objc_msgSend_setFloatValue_forProperty_(v7, v9, 4131, v138);
    }
  ...
  if (v82 < 0)
  {
    ...
    {
      *&v140 = v260;
      objc_msgSend_setFloatValue_forProperty_(v7, v9, 4132, v140);
    }
  }
  ...
  if (v141)
  {
    ...
    {
      *&v143 = v260;
      objc_msgSend_setFloatValue_forProperty_(v7, v9, 4133, v143);
    }
  ...
  if ((v141 & 2) != 0)
  {
    ...
    {
      *&v145 = v260;
      objc_msgSend_setFloatValue_forProperty_(v7, v9, 4134, v145);
    }
  ...
  if ((v141 & 4) != 0)
  {
    ...
    {
      *&v147 = v260;
      objc_msgSend_setFloatValue_forProperty_(v7, v9, 4135, v147);
    }
  ...
  if ((v141 & 8) != 0)
  {
    ...
    {
      *&v149 = v260;
      objc_msgSend_setFloatValue_forProperty_(v7, v9, 4136, v149);
    }
  ...
  if ((v141 & 0x10) != 0)
  {
    ...
    {
      *&v151 = v260;
      objc_msgSend_setFloatValue_forProperty_(v7, v9, 4137, v151);
    }
  ...
  if ((v141 & 0x20) != 0)
  {
    ...
    {
      *&v153 = v260;
      objc_msgSend_setFloatValue_forProperty_(v7, v9, 4138, v153);
    }
  ...
  if ((v141 & 0x40) != 0)
  {
    ...
    {
      *&v155 = v260;
      objc_msgSend_setFloatValue_forProperty_(v7, v9, 4139, v155);
    }
  ...
  if ((v141 & 0x80) != 0)
  {
    ...
    {
      *&v157 = v260;
      objc_msgSend_setFloatValue_forProperty_(v7, v9, 4140, v157);
    }
  ...
  if ((v141 & 0x100) != 0)
  {
    ...
    {
      *&v159 = v260;
      objc_msgSend_setFloatValue_forProperty_(v7, v9, 4141, v159);
    }
  ...
  if ((v141 & 0x200) != 0)
  {
    ...
    {
      *&v161 = v260;
      objc_msgSend_setFloatValue_forProperty_(v7, v9, 4142, v161);
    }
  ...
  if ((v141 & 0x400) != 0)
  {
    ...
    {
      *&v163 = v260;
      objc_msgSend_setFloatValue_forProperty_(v7, v9, 4143, v163);
    }
  ...
  if ((v141 & 0x10000) != 0)
  {
    ...
    {
      *&v165 = v260;
      objc_msgSend_setFloatValue_forProperty_(v7, v9, 4144, v165);
    }
  ...
  if ((v141 & 0x20000) != 0)
  {
    ...
    {
      *&v167 = v260;
      objc_msgSend_setFloatValue_forProperty_(v7, v9, 4145, v167);
    }
  ...
  if ((v141 & 0x40000) != 0)
  {
    ...
    {
      *&v169 = v260;
      objc_msgSend_setFloatValue_forProperty_(v7, v9, 4154, v169);
    }
  ...
  if ((v141 & 0x80000) != 0)
  {
    ...
    {
      *&v171 = v260;
      objc_msgSend_setFloatValue_forProperty_(v7, v9, 4155, v171);
    }
  ...
  if ((v141 & 0x100000) != 0)
  {
    ...
    {
      *&v173 = v260;
      objc_msgSend_setFloatValue_forProperty_(v7, v9, 4157, v173);
    }
  ...
  if ((v141 & 0x200000) != 0)
  {
    ...
    {
      *&v175 = v260;
      objc_msgSend_setFloatValue_forProperty_(v7, v9, 4158, v175);
    }
  ...
  if ((v141 & 0x400000) != 0)
  {
    ...
    {
      *&v177 = v260;
      objc_msgSend_setFloatValue_forProperty_(v7, v9, 4159, v177);
    }
  ...
  if ((v141 & 0x800000) != 0)
  {
    ...
    {
      *&v179 = v260;
      objc_msgSend_setFloatValue_forProperty_(v7, v9, 4160, v179);
    }
  ...
  if ((v141 & 0x1000000) != 0)
  {
    ...
    {
      *&v181 = v260;
      objc_msgSend_setFloatValue_forProperty_(v7, v9, 4161, v181);
    }
  }
  ...
  if ((*(a4 + 27) & 4) != 0)
  {
    ...
    {
      *&v183 = v260;
      objc_msgSend_setFloatValue_forProperty_(v7, v9, 4162, v183);
    }
  }
  ...
  if ((v184 & 0x2000000) != 0)
  {
    ...
    {
      *&v186 = v260;
      objc_msgSend_setFloatValue_forProperty_(v7, v9, 4163, v186);
    }
  ...
  if ((v184 & 0x4000000) != 0)
  {
    ...
    {
      *&v188 = v260;
      objc_msgSend_setFloatValue_forProperty_(v7, v9, 4164, v188);
    }
  ...
  if ((v184 & 0x8000000) != 0)
  {
    ...
    {
      *&v190 = v260;
      objc_msgSend_setFloatValue_forProperty_(v7, v9, 4165, v190);
    }
  ...
  if ((v184 & 0x10000000) != 0)
  {
    ...
    {
      *&v192 = v260;
      objc_msgSend_setFloatValue_forProperty_(v7, v9, 4166, v192);
    }
  ...
  if ((v184 & 0x20000000) != 0)
  {
    ...
    {
      *&v194 = v260;
      objc_msgSend_setFloatValue_forProperty_(v7, v9, 4167, v194);
    }
  ...
  if ((v184 & 0x40000000) != 0)
  {
    ...
    {
      *&v196 = v260;
      objc_msgSend_setFloatValue_forProperty_(v7, v9, 4168, v196);
    }
  ...
  if (v184 < 0)
  {
    ...
    {
      *&v198 = v260;
      objc_msgSend_setFloatValue_forProperty_(v7, v9, 4169, v198);
    }
  }
  ...
  if (v199)
  {
    ...
    {
      *&v201 = v260;
      objc_msgSend_setFloatValue_forProperty_(v7, v9, 4170, v201);
    }
  ...
  if ((v199 & 2) != 0)
  {
    ...
    {
      *&v203 = v260;
      objc_msgSend_setFloatValue_forProperty_(v7, v9, 4171, v203);
    }
  ...
  if ((v199 & 4) != 0)
  {
    ...
    {
      *&v205 = v260;
      objc_msgSend_setFloatValue_forProperty_(v7, v9, 4172, v205);
    }
  ...
  if ((v199 & 8) != 0)
  {
    ...
    {
      *&v207 = v260;
      objc_msgSend_setFloatValue_forProperty_(v7, v9, 4173, v207);
    }
  ...
  if ((v199 & 0x10) != 0)
  {
    ...
    {
      *&v209 = v260;
      objc_msgSend_setFloatValue_forProperty_(v7, v9, 4174, v209);
    }
  ...
  if ((v199 & 0x20) != 0)
  {
    ...
    {
      *&v211 = v260;
      objc_msgSend_setFloatValue_forProperty_(v7, v9, 4175, v211);
    }
  }
  ...
  if ((v212 & 0x2000) != 0)
  {
    ...
    {
      objc_msgSend_setIntValue_forProperty_(v7, v9, LODWORD(v260) != 0, 4179);
    }
  ...
  if ((v212 & 0x4000) != 0)
  {
    ...
    {
      objc_msgSend_setIntValue_forProperty_(v7, v9, LODWORD(v260) != 0, 4180);
    }
  ...
  if ((v212 & 0x8000) != 0)
  {
    ...
    {
      objc_msgSend_setIntValue_forProperty_(v7, v9, LODWORD(v260) != 0, 4181);
    }
  }
  ...
  if ((v213 & 0x40) != 0)
  {
    ...
    {
      objc_msgSend_setIntValue_forProperty_(v7, v9, LODWORD(v260), 4182);
    }
  ...
  if ((v213 & 0x80) != 0)
  {
    ...
    {
      objc_msgSend_setIntValue_forProperty_(v7, v9, LODWORD(v260) != 0, 4183);
    }
  ...
  if ((v213 & 0x100) != 0)
  {
    ...
    {
      objc_msgSend_setIntValue_forProperty_(v7, v9, LODWORD(v260) != 0, 4184);
    }
  ...
  if ((v213 & 0x200) != 0)
  {
    ...
    {
      *&v215 = v260;
      objc_msgSend_setFloatValue_forProperty_(v7, v9, 4185, v215);
    }
  ...
  if ((v213 & 0x400) != 0)
  {
    ...
    {
      *&v217 = v260;
      objc_msgSend_setFloatValue_forProperty_(v7, v9, 4186, v217);
    }
  ...
  if ((v213 & 0x800) != 0)
  {
    ...
    {
      *&v219 = v260;
      objc_msgSend_setFloatValue_forProperty_(v7, v9, 4187, v219);
    }
  ...
  if ((v213 & 0x1000) != 0)
  {
    ...
    {
      *&v221 = v260;
      objc_msgSend_setFloatValue_forProperty_(v7, v9, 4188, v221);
    }
  ...
  if ((v213 & 0x2000) != 0)
  {
    ...
    {
      *&v223 = v260;
      objc_msgSend_setFloatValue_forProperty_(v7, v9, 4189, v223);
    }
  ...
  if ((v213 & 0x4000) != 0)
  {
    ...
    {
      *&v225 = v260;
      objc_msgSend_setFloatValue_forProperty_(v7, v9, 4190, v225);
    }
  ...
  if ((v213 & 0x8000) != 0)
  {
    ...
    {
      *&v227 = v260;
      objc_msgSend_setFloatValue_forProperty_(v7, v9, 4192, v227);
    }
  ...
  if ((v213 & 0x10000) != 0)
  {
    ...
    {
      *&v229 = v260;
      objc_msgSend_setFloatValue_forProperty_(v7, v9, 4193, v229);
    }
  ...
  if ((v213 & 0x20000) != 0)
  {
    ...
    {
      *&v231 = v260;
      objc_msgSend_setFloatValue_forProperty_(v7, v9, 4194, v231);
    }
  ...
  if ((v213 & 0x8000000) != 0)
  {
    ...
    {
      *&v233 = v260;
      objc_msgSend_setFloatValue_forProperty_(v7, v9, 4195, v233);
    }
  ...
  if ((v213 & 0x40000) != 0)
  {
    ...
    {
      *&v235 = v260;
      objc_msgSend_setFloatValue_forProperty_(v7, v9, 4196, v235);
    }
  }
  ...
  if ((v236 & 0x20) != 0)
  {
    ...
    {
      objc_msgSend_setIntValue_forProperty_(v7, v9, LODWORD(v260), 4197);
    }
  ...
  if (v236)
  {
    ...
    {
      *&v238 = v260;
      objc_msgSend_setFloatValue_forProperty_(v7, v9, 4198, v238);
    }
  ...
  if ((v236 & 2) != 0)
  {
    ...
    {
      *&v240 = v260;
      objc_msgSend_setFloatValue_forProperty_(v7, v9, 4199, v240);
    }
  ...
  if ((v236 & 4) != 0)
  {
    ...
    {
      *&v242 = v260;
      objc_msgSend_setFloatValue_forProperty_(v7, v9, 4200, v242);
    }
  ...
  if ((v236 & 8) != 0)
  {
    ...
    {
      *&v244 = v260;
      objc_msgSend_setFloatValue_forProperty_(v7, v9, 4201, v244);
    }
  ...
  if ((v236 & 0x10) != 0)
  {
    ...
    {
      *&v246 = v260;
      objc_msgSend_setFloatValue_forProperty_(v7, v9, 4202, v246);
    }
  ...
  if ((v236 & 0x80) != 0)
  {
    ...
    {
      *&v248 = v260;
      objc_msgSend_setFloatValue_forProperty_(v7, v9, 4203, v248);
    }
  ...
  if ((v236 & 0x100) != 0)
  {
    ...
    {
      *&v250 = v260;
      objc_msgSend_setFloatValue_forProperty_(v7, v9, 4204, v250);
    }
  ...
  if ((v236 & 0x200) != 0)
  {
    ...
    {
      *&v252 = v260;
      objc_msgSend_setFloatValue_forProperty_(v7, v9, 4205, v252);
    }
  ...
  if ((v236 & 0x400) != 0)
  {
    ...
    {
      *&v254 = v260;
      objc_msgSend_setFloatValue_forProperty_(v7, v9, 4206, v254);
    }
  ...
  if ((v236 & 0x40) != 0)
  {
    ...
    {
      objc_msgSend_setIntValue_forProperty_(v7, v255, LODWORD(v260), 4207);
    }
  }
}
...
- (void)saveMotionBackgroundStylePropertyMap:(id)a3 toArchive:(void *)a4 archiver:(id)a5
{
  ...
  v8 = a5;
  v9 = objc_opt_class();
  if (objc_msgSend_containsProperty_(v7, v10, 4108))
  {
    v12 = objc_msgSend_objectForProperty_(v7, v11, 4108);
    *(a4 + 4) |= 0x80u;
    if (!*(a4 + 12))
    {
      v13 = *(a4 + 1);
      ...
      *(a4 + 12) = MEMORY[0x277C8F010](v13);
    }

    TSPTSUColorCopyToMessage();
  }

  if (objc_msgSend_containsProperty_(v7, v11, 4109))
  {
    v15 = objc_msgSend_objectForProperty_(v7, v14, 4109);
    *(a4 + 4) |= 0x100u;
    if (!*(a4 + 13))
    {
      v16 = *(a4 + 1);
      ...
      *(a4 + 13) = MEMORY[0x277C8F010](v16);
    }

    TSPTSUColorCopyToMessage();
  }

  if (objc_msgSend_containsProperty_(v7, v14, 4110))
  {
    v18 = objc_msgSend_objectForProperty_(v7, v17, 4110);
    *(a4 + 4) |= 0x200u;
    if (!*(a4 + 14))
    {
      v19 = *(a4 + 1);
      ...
      *(a4 + 14) = MEMORY[0x277C8F010](v19);
    }

    TSPTSUColorCopyToMessage();
  }

  if (objc_msgSend_containsProperty_(v7, v17, 4191))
  {
    v21 = objc_msgSend_objectForProperty_(v7, v20, 4191);
    *(a4 + 4) |= 0x800u;
    if (!*(a4 + 16))
    {
      v22 = *(a4 + 1);
      ...
      *(a4 + 16) = MEMORY[0x277C8F010](v22);
    }

    TSPTSUColorCopyToMessage();
  }

  if (objc_msgSend_containsProperty_(v7, v20, 4111))
  {
    v24 = objc_msgSend_objectForProperty_(v7, v23, 4111);
    *(a4 + 4) |= 0x400u;
    if (!*(a4 + 15))
    {
      v25 = *(a4 + 1);
      ...
      *(a4 + 15) = MEMORY[0x277C8F010](v25);
    }

    TSPTSUColorCopyToMessage();
  }

  if (objc_msgSend_containsProperty_(v7, v23, 4101))
  {
    v27 = objc_msgSend_objectForProperty_(v7, v26, 4101);
    v459 = v27;
    v28 = objc_opt_class();
  ...
  if (objc_msgSend_containsProperty_(v7, v26, 4102))
  {
    v35 = objc_msgSend_objectForProperty_(v7, v34, 4102);
    v458 = v35;
    v36 = objc_opt_class();
  ...
  if (objc_msgSend_containsProperty_(v7, v34, 4107))
  {
    v43 = objc_msgSend_objectForProperty_(v7, v42, 4107);
    v457 = v43;
    v44 = objc_opt_class();
    ...
    if (v46)
    {
      *(a4 + 4) |= 0x40u;
      ...
      objc_msgSend_saveToArchive_archiver_(v47, v48, v49, v8);
    }
  }

  if (objc_msgSend_containsProperty_(v7, v42, 4112))
  {
    LODWORD(v456) = objc_msgSend_intValueForProperty_(v7, v51, 4112);
  ...
  if (objc_msgSend_containsProperty_(v7, v51, 4118))
  {
    objc_msgSend_floatValueForProperty_(v7, v54, 4118);
    v456 = v55;
  ...
  if (objc_msgSend_containsProperty_(v7, v54, 4119))
  {
    objc_msgSend_floatValueForProperty_(v7, v58, 4119);
    v456 = v59;
  ...
  if (objc_msgSend_containsProperty_(v7, v58, 4120))
  {
    objc_msgSend_floatValueForProperty_(v7, v62, 4120);
    v456 = v63;
  ...
  if (objc_msgSend_containsProperty_(v7, v62, 4121))
  {
    objc_msgSend_floatValueForProperty_(v7, v66, 4121);
    v456 = v67;
  ...
  if (objc_msgSend_containsProperty_(v7, v66, 4122))
  {
    objc_msgSend_floatValueForProperty_(v7, v70, 4122);
    v456 = v71;
  ...
  if (objc_msgSend_containsProperty_(v7, v70, 4123))
  {
    objc_msgSend_floatValueForProperty_(v7, v74, 4123);
    v456 = v75;
  ...
  if (objc_msgSend_containsProperty_(v7, v74, 4124))
  {
    objc_msgSend_floatValueForProperty_(v7, v78, 4124);
    v456 = v79;
  ...
  if (objc_msgSend_containsProperty_(v7, v78, 4146))
  {
    objc_msgSend_floatValueForProperty_(v7, v82, 4146);
    v456 = v83;
  ...
  if (objc_msgSend_containsProperty_(v7, v82, 4147))
  {
    objc_msgSend_floatValueForProperty_(v7, v86, 4147);
    v456 = v87;
  ...
  if (objc_msgSend_containsProperty_(v7, v86, 4148))
  {
    objc_msgSend_floatValueForProperty_(v7, v90, 4148);
    v456 = v91;
  ...
  if (objc_msgSend_containsProperty_(v7, v90, 4149))
  {
    objc_msgSend_floatValueForProperty_(v7, v94, 4149);
    v456 = v95;
  ...
  if (objc_msgSend_containsProperty_(v7, v94, 4150))
  {
    objc_msgSend_floatValueForProperty_(v7, v98, 4150);
    v456 = v99;
  ...
  if (objc_msgSend_containsProperty_(v7, v98, 4151))
  {
    objc_msgSend_floatValueForProperty_(v7, v102, 4151);
    v456 = v103;
  ...
  if (objc_msgSend_containsProperty_(v7, v102, 4152))
  {
    objc_msgSend_floatValueForProperty_(v7, v106, 4152);
    v456 = v107;
  ...
  if (objc_msgSend_containsProperty_(v7, v106, 4153))
  {
    objc_msgSend_floatValueForProperty_(v7, v110, 4153);
    v456 = v111;
  ...
  if (objc_msgSend_containsProperty_(v7, v110, 4156))
  {
    objc_msgSend_floatValueForProperty_(v7, v114, 4156);
    v456 = v115;
  ...
  if (objc_msgSend_containsProperty_(v7, v114, 4177))
  {
    LODWORD(v456) = objc_msgSend_intValueForProperty_(v7, v118, 4177);
  ...
  if (objc_msgSend_containsProperty_(v7, v118, 4176))
  {
    objc_msgSend_floatValueForProperty_(v7, v121, 4176);
    v456 = v122;
  ...
  if (objc_msgSend_containsProperty_(v7, v121, 4178))
  {
    LODWORD(v456) = objc_msgSend_intValueForProperty_(v7, v125, 4178);
  ...
  if (objc_msgSend_containsProperty_(v7, v125, 4103))
  {
    v129 = objc_msgSend_objectForProperty_(v7, v128, 4103);
    v455 = v129;
    v130 = objc_opt_class();
  ...
  if (objc_msgSend_containsProperty_(v7, v128, 4104))
  {
    v137 = objc_msgSend_objectForProperty_(v7, v136, 4104);
    v454 = v137;
    v138 = objc_opt_class();
  ...
  if (objc_msgSend_containsProperty_(v7, v136, 4105))
  {
    v145 = objc_msgSend_objectForProperty_(v7, v144, 4105);
    v453 = v145;
    v146 = objc_opt_class();
  ...
  if (objc_msgSend_containsProperty_(v7, v144, 4106))
  {
    v153 = objc_msgSend_objectForProperty_(v7, v152, 4106);
    v452 = v153;
    v154 = objc_opt_class();
  ...
  if (objc_msgSend_containsProperty_(v7, v152, 4113, v452))
  {
    objc_msgSend_floatValueForProperty_(v7, v160, 4113);
    v456 = v161;
  ...
  if (objc_msgSend_containsProperty_(v7, v160, 4114))
  {
    objc_msgSend_floatValueForProperty_(v7, v164, 4114);
    v456 = v165;
  ...
  if (objc_msgSend_containsProperty_(v7, v164, 4115))
  {
    objc_msgSend_floatValueForProperty_(v7, v168, 4115);
    v456 = v169;
  ...
  if (objc_msgSend_containsProperty_(v7, v168, 4116))
  {
    objc_msgSend_floatValueForProperty_(v7, v172, 4116);
    v456 = v173;
  ...
  if (objc_msgSend_containsProperty_(v7, v172, 4117))
  {
    objc_msgSend_floatValueForProperty_(v7, v176, 4117);
    v456 = v177;
  ...
  if (objc_msgSend_containsProperty_(v7, v176, 4125))
  {
    objc_msgSend_floatValueForProperty_(v7, v180, 4125);
    v456 = v181;
  ...
  if (objc_msgSend_containsProperty_(v7, v180, 4126))
  {
    objc_msgSend_floatValueForProperty_(v7, v184, 4126);
    v456 = v185;
  ...
  if (objc_msgSend_containsProperty_(v7, v184, 4127))
  {
    objc_msgSend_floatValueForProperty_(v7, v188, 4127);
    v456 = v189;
  ...
  if (objc_msgSend_containsProperty_(v7, v188, 4128))
  {
    objc_msgSend_floatValueForProperty_(v7, v192, 4128);
    v456 = v193;
  ...
  if (objc_msgSend_containsProperty_(v7, v192, 4129))
  {
    objc_msgSend_floatValueForProperty_(v7, v196, 4129);
    v456 = v197;
  ...
  if (objc_msgSend_containsProperty_(v7, v196, 4130))
  {
    objc_msgSend_floatValueForProperty_(v7, v200, 4130);
    v456 = v201;
  ...
  if (objc_msgSend_containsProperty_(v7, v200, 4131))
  {
    objc_msgSend_floatValueForProperty_(v7, v204, 4131);
    v456 = v205;
  ...
  if (objc_msgSend_containsProperty_(v7, v204, 4132))
  {
    objc_msgSend_floatValueForProperty_(v7, v208, 4132);
    v456 = v209;
  ...
  if (objc_msgSend_containsProperty_(v7, v208, 4133))
  {
    objc_msgSend_floatValueForProperty_(v7, v212, 4133);
    v456 = v213;
  ...
  if (objc_msgSend_containsProperty_(v7, v212, 4134))
  {
    objc_msgSend_floatValueForProperty_(v7, v216, 4134);
    v456 = v217;
  ...
  if (objc_msgSend_containsProperty_(v7, v216, 4135))
  {
    objc_msgSend_floatValueForProperty_(v7, v220, 4135);
    v456 = v221;
  ...
  if (objc_msgSend_containsProperty_(v7, v220, 4136))
  {
    objc_msgSend_floatValueForProperty_(v7, v224, 4136);
    v456 = v225;
  ...
  if (objc_msgSend_containsProperty_(v7, v224, 4137))
  {
    objc_msgSend_floatValueForProperty_(v7, v228, 4137);
    v456 = v229;
  ...
  if (objc_msgSend_containsProperty_(v7, v228, 4138))
  {
    objc_msgSend_floatValueForProperty_(v7, v232, 4138);
    v456 = v233;
  ...
  if (objc_msgSend_containsProperty_(v7, v232, 4139))
  {
    objc_msgSend_floatValueForProperty_(v7, v236, 4139);
    v456 = v237;
  ...
  if (objc_msgSend_containsProperty_(v7, v236, 4140))
  {
    objc_msgSend_floatValueForProperty_(v7, v240, 4140);
    v456 = v241;
  ...
  if (objc_msgSend_containsProperty_(v7, v240, 4141))
  {
    objc_msgSend_floatValueForProperty_(v7, v244, 4141);
    v456 = v245;
  ...
  if (objc_msgSend_containsProperty_(v7, v244, 4142))
  {
    objc_msgSend_floatValueForProperty_(v7, v248, 4142);
    v456 = v249;
  ...
  if (objc_msgSend_containsProperty_(v7, v248, 4143))
  {
    objc_msgSend_floatValueForProperty_(v7, v252, 4143);
    v456 = v253;
  ...
  if (objc_msgSend_containsProperty_(v7, v252, 4144))
  {
    objc_msgSend_floatValueForProperty_(v7, v256, 4144);
    v456 = v257;
  ...
  if (objc_msgSend_containsProperty_(v7, v256, 4145))
  {
    objc_msgSend_floatValueForProperty_(v7, v260, 4145);
    v456 = v261;
  ...
  if (objc_msgSend_containsProperty_(v7, v260, 4154))
  {
    objc_msgSend_floatValueForProperty_(v7, v264, 4154);
    v456 = v265;
  ...
  if (objc_msgSend_containsProperty_(v7, v264, 4155))
  {
    objc_msgSend_floatValueForProperty_(v7, v268, 4155);
    v456 = v269;
  ...
  if (objc_msgSend_containsProperty_(v7, v268, 4157))
  {
    objc_msgSend_floatValueForProperty_(v7, v272, 4157);
    v456 = v273;
  ...
  if (objc_msgSend_containsProperty_(v7, v272, 4158))
  {
    objc_msgSend_floatValueForProperty_(v7, v276, 4158);
    v456 = v277;
  ...
  if (objc_msgSend_containsProperty_(v7, v276, 4159))
  {
    objc_msgSend_floatValueForProperty_(v7, v280, 4159);
    v456 = v281;
  ...
  if (objc_msgSend_containsProperty_(v7, v280, 4160))
  {
    objc_msgSend_floatValueForProperty_(v7, v284, 4160);
    v456 = v285;
  ...
  if (objc_msgSend_containsProperty_(v7, v284, 4161))
  {
    objc_msgSend_floatValueForProperty_(v7, v288, 4161);
    v456 = v289;
  ...
  if (objc_msgSend_containsProperty_(v7, v288, 4162))
  {
    objc_msgSend_floatValueForProperty_(v7, v292, 4162);
    v456 = v293;
  ...
  if (objc_msgSend_containsProperty_(v7, v292, 4163))
  {
    objc_msgSend_floatValueForProperty_(v7, v296, 4163);
    v456 = v297;
  ...
  if (objc_msgSend_containsProperty_(v7, v296, 4164))
  {
    objc_msgSend_floatValueForProperty_(v7, v300, 4164);
    v456 = v301;
  ...
  if (objc_msgSend_containsProperty_(v7, v300, 4165))
  {
    objc_msgSend_floatValueForProperty_(v7, v304, 4165);
    v456 = v305;
  ...
  if (objc_msgSend_containsProperty_(v7, v304, 4166))
  {
    objc_msgSend_floatValueForProperty_(v7, v308, 4166);
    v456 = v309;
  ...
  if (objc_msgSend_containsProperty_(v7, v308, 4167))
  {
    objc_msgSend_floatValueForProperty_(v7, v312, 4167);
    v456 = v313;
  ...
  if (objc_msgSend_containsProperty_(v7, v312, 4168))
  {
    objc_msgSend_floatValueForProperty_(v7, v316, 4168);
    v456 = v317;
  ...
  if (objc_msgSend_containsProperty_(v7, v316, 4169))
  {
    objc_msgSend_floatValueForProperty_(v7, v320, 4169);
    v456 = v321;
  ...
  if (objc_msgSend_containsProperty_(v7, v320, 4170))
  {
    objc_msgSend_floatValueForProperty_(v7, v324, 4170);
    v456 = v325;
  ...
  if (objc_msgSend_containsProperty_(v7, v324, 4171))
  {
    objc_msgSend_floatValueForProperty_(v7, v328, 4171);
    v456 = v329;
  ...
  if (objc_msgSend_containsProperty_(v7, v328, 4172))
  {
    objc_msgSend_floatValueForProperty_(v7, v332, 4172);
    v456 = v333;
  ...
  if (objc_msgSend_containsProperty_(v7, v332, 4173))
  {
    objc_msgSend_floatValueForProperty_(v7, v336, 4173);
    v456 = v337;
  ...
  if (objc_msgSend_containsProperty_(v7, v336, 4174))
  {
    objc_msgSend_floatValueForProperty_(v7, v340, 4174);
    v456 = v341;
  ...
  if (objc_msgSend_containsProperty_(v7, v340, 4175))
  {
    objc_msgSend_floatValueForProperty_(v7, v344, 4175);
    v456 = v345;
  ...
  if (objc_msgSend_containsProperty_(v7, v344, 4179))
  {
    LODWORD(v456) = objc_msgSend_intValueForProperty_(v7, v348, 4179);
  ...
  if (objc_msgSend_containsProperty_(v7, v348, 4180))
  {
    LODWORD(v456) = objc_msgSend_intValueForProperty_(v7, v351, 4180);
  ...
  if (objc_msgSend_containsProperty_(v7, v351, 4181))
  {
    LODWORD(v456) = objc_msgSend_intValueForProperty_(v7, v354, 4181);
  ...
  if (objc_msgSend_containsProperty_(v7, v354, 4182))
  {
    LODWORD(v456) = objc_msgSend_intValueForProperty_(v7, v357, 4182);
  ...
  if (objc_msgSend_containsProperty_(v7, v357, 4183))
  {
    LODWORD(v456) = objc_msgSend_intValueForProperty_(v7, v360, 4183);
  ...
  if (objc_msgSend_containsProperty_(v7, v360, 4184))
  {
    LODWORD(v456) = objc_msgSend_intValueForProperty_(v7, v363, 4184);
  ...
  if (objc_msgSend_containsProperty_(v7, v363, 4185))
  {
    objc_msgSend_floatValueForProperty_(v7, v366, 4185);
    v456 = v367;
  ...
  if (objc_msgSend_containsProperty_(v7, v366, 4186))
  {
    objc_msgSend_floatValueForProperty_(v7, v370, 4186);
    v456 = v371;
  ...
  if (objc_msgSend_containsProperty_(v7, v370, 4187))
  {
    objc_msgSend_floatValueForProperty_(v7, v374, 4187);
    v456 = v375;
  ...
  if (objc_msgSend_containsProperty_(v7, v374, 4188))
  {
    objc_msgSend_floatValueForProperty_(v7, v378, 4188);
    v456 = v379;
  ...
  if (objc_msgSend_containsProperty_(v7, v378, 4189))
  {
    objc_msgSend_floatValueForProperty_(v7, v382, 4189);
    v456 = v383;
  ...
  if (objc_msgSend_containsProperty_(v7, v382, 4190))
  {
    objc_msgSend_floatValueForProperty_(v7, v386, 4190);
    v456 = v387;
  ...
  if (objc_msgSend_containsProperty_(v7, v386, 4192))
  {
    objc_msgSend_floatValueForProperty_(v7, v390, 4192);
    v456 = v391;
  ...
  if (objc_msgSend_containsProperty_(v7, v390, 4193))
  {
    objc_msgSend_floatValueForProperty_(v7, v394, 4193);
    v456 = v395;
  ...
  if (objc_msgSend_containsProperty_(v7, v394, 4194))
  {
    objc_msgSend_floatValueForProperty_(v7, v398, 4194);
    v456 = v399;
  ...
  if (objc_msgSend_containsProperty_(v7, v398, 4195))
  {
    objc_msgSend_floatValueForProperty_(v7, v402, 4195);
    v456 = v403;
  ...
  if (objc_msgSend_containsProperty_(v7, v402, 4196))
  {
    objc_msgSend_floatValueForProperty_(v7, v406, 4196);
    v456 = v407;
  ...
  if (objc_msgSend_containsProperty_(v7, v406, 4197))
  {
    LODWORD(v456) = objc_msgSend_intValueForProperty_(v7, v410, 4197);
  ...
  if (objc_msgSend_containsProperty_(v7, v410, 4198))
  {
    objc_msgSend_floatValueForProperty_(v7, v413, 4198);
    v456 = v414;
  ...
  if (objc_msgSend_containsProperty_(v7, v413, 4199))
  {
    objc_msgSend_floatValueForProperty_(v7, v417, 4199);
    v456 = v418;
  ...
  if (objc_msgSend_containsProperty_(v7, v417, 4200))
  {
    objc_msgSend_floatValueForProperty_(v7, v421, 4200);
    v456 = v422;
  ...
  if (objc_msgSend_containsProperty_(v7, v421, 4201))
  {
    objc_msgSend_floatValueForProperty_(v7, v425, 4201);
    v456 = v426;
  ...
  if (objc_msgSend_containsProperty_(v7, v425, 4202))
  {
    objc_msgSend_floatValueForProperty_(v7, v429, 4202);
    v456 = v430;
  ...
  if (objc_msgSend_containsProperty_(v7, v429, 4203))
  {
    objc_msgSend_floatValueForProperty_(v7, v433, 4203);
    v456 = v434;
  ...
  if (objc_msgSend_containsProperty_(v7, v433, 4204))
  {
    objc_msgSend_floatValueForProperty_(v7, v437, 4204);
    v456 = v438;
  ...
  if (objc_msgSend_containsProperty_(v7, v437, 4205))
  {
    objc_msgSend_floatValueForProperty_(v7, v441, 4205);
    v456 = v442;
  ...
  if (objc_msgSend_containsProperty_(v7, v441, 4206))
  {
    objc_msgSend_floatValueForProperty_(v7, v445, 4206);
    v456 = v446;
  ...
  if (objc_msgSend_containsProperty_(v7, v445, 4207))
  {
    LODWORD(v456) = objc_msgSend_intValueForProperty_(v7, v449, 4207);
...
- (void)loadFromUnarchiver:(id)a3
{
  ...
  v5 = objc_msgSend_messageWithDescriptor_(v7, v4, off_2812EA908[118]);
...
- (void)loadFromArchive:(const void *)a3 unarchiver:(id)a4
{
  ...
  [(KNMotionBackgroundStyle *)&v23 loadFromArchive:v7 unarchiver:v6];
  v10 = *(a3 + 12);
  if (v10)
  {
    ...
    if (*(a3 + 4))
    {
      objc_msgSend_loadMotionBackgroundStylePropertiesIntoPropertyMap_fromArchive_unarchiver_(self, v13, v14, *(a3 + 4), v6);
    }

    else
    {
      objc_msgSend_loadMotionBackgroundStylePropertiesIntoPropertyMap_fromArchive_unarchiver_(self, v13, v14, &unk_2812EBDF0, v6);
    }
  ...
  if ((*(a3 + 16) & 4) != 0)
  {
    v17 = objc_msgSend_readDataReferenceMessage_(v6, v8, *(a3 + 5));
...
- (void)saveToArchiver:(id)a3
{
  v7 = a3;
  google::protobuf::internal::AssignDescriptors();
  v5 = objc_msgSend_messageWithNewFunction_descriptor_(v7, v4, sub_275D6D55C, off_2812EA908[118]);
...
- (void)saveToArchive:(void *)a3 archiver:(id)a4
{
  ...
  *(a3 + 4) |= 1u;
  ...
  [(KNMotionBackgroundStyle *)&v26 saveToArchive:v7 archiver:v6];
  ...
  if (v11)
  {
    ...
    *(a3 + 4) = v13 | 0xA;
    ...
    objc_msgSend_saveMotionBackgroundStylePropertyMap_toArchive_archiver_(self, v12, *(&self->super.super.super.isa + *MEMORY[0x277D80AF0]), v14, v6);
  }
  ...
  if (posterFrameData)
  {
    *(a3 + 4) |= 4u;
    ...
    objc_msgSend_setDataReference_message_(v6, v12, posterFrameData, v17);
  }
}
