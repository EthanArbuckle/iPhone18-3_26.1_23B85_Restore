...
{
  v2 = sub_275DC204C();
  v4 = objc_msgSend_localizedStringForKey_value_table_(v2, v3, @"Title", &stru_2884D8E20, @"Keynote");
...
- (void)acceptVisitor:(id)visitor
{
  ...
  if (v5)
  {
    objc_msgSend_visitKNTitlePlaceholderInfo_(v5, v6, self, &unk_2885462B0);
  }
