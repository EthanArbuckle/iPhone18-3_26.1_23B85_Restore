...
- (KNBodyPlaceholderInfo)initWithKNPlaceholderInfo:(id)a3;
...
- (id)copyToInstantiateTemplatePlaceholder
{
  ...
  v2 = [(KNBodyPlaceholderInfo *)&v14 copyToInstantiateTemplatePlaceholder];
...
- (void)acceptVisitor:(id)a3
{
  ...
  else
  {
    ...
    [(KNBodyPlaceholderInfo *)&v8 acceptVisitor:v4, &unk_2885462B0];
  }
}
