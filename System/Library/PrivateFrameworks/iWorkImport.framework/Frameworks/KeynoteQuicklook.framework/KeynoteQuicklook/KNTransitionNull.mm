...
- (void)addAnimationsTo:(id)to context:(id)context
{
  ...
  v14 = objc_msgSend_textures(contextCopy, v12, v13);
  v17 = objc_msgSend_lastObject(v14, v15, v16);

  isFrameRenderer = objc_msgSend_isFrameRenderer(contextCopy, v18, v19);
  ...
  if (isFrameRenderer)
  {
    ...
    objc_msgSend_setObject_forKey_(toCopy, v36, v25, v35);
    ...
    objc_msgSend_setObject_forKey_(toCopy, v47, v38, v46);
  ...
  else
  {
    ...
    objc_msgSend_setObject_forKey_(toCopy, v54, v25, v38);
  }
}
