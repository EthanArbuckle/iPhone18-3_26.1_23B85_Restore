...
- (KNAnimParameterSavedParameter)initWithCoder:(id)coder
{
  ...
  if (v5)
  {
    ...
    v5->_type = objc_msgSend_decodeIntegerForKey_(coderCopy, v13, @"tp");
    objc_msgSend_decodeDoubleForKey_(coderCopy, v14, @"dblValue");
    v5->_doubleValue = v15;
    objc_msgSend_decodeDoubleForKey_(coderCopy, v16, @"max");
    v5->_maxValue = v17;
    objc_msgSend_decodeDoubleForKey_(coderCopy, v18, @"min");
    v5->_minValue = v19;
    v5->_hasMaxValue = objc_msgSend_decodeBoolForKey_(coderCopy, v20, @"hmax");
    v5->_hasMinValue = objc_msgSend_decodeBoolForKey_(coderCopy, v21, @"hmin");
    v22 = MEMORY[0x277CBEB98];
    v23 = objc_opt_class();
    v24 = objc_opt_class();
    v26 = objc_msgSend_setWithObjects_(v22, v25, v23, v24, 0);
    v28 = objc_msgSend_decodeObjectOfClasses_forKey_(coderCopy, v27, v26, @"svdPth");

    v30 = objc_msgSend_p_bezierPathFromSavedPathElements_(v5, v29, v28);
    pathValue = v5->_pathValue;
    v5->_pathValue = v30;

    v5->_removed = objc_msgSend_decodeBoolForKey_(coderCopy, v32, @"removed");
    v5->_debugOnly = objc_msgSend_decodeBoolForKey_(coderCopy, v33, @"dbg");
    v34 = objc_opt_class();
    v36 = objc_msgSend_decodeObjectOfClass_forKey_(coderCopy, v35, v34, @"desc");
...
- (void)encodeWithCoder:(id)coder
{
  ...
  objc_msgSend_encodeInteger_forKey_(coderCopy, v12, v11, @"tp");
  objc_msgSend_doubleValue(self, v13, v14);
  objc_msgSend_encodeDouble_forKey_(coderCopy, v15, @"dblValue");
  objc_msgSend_maxValue(self, v16, v17);
  objc_msgSend_encodeDouble_forKey_(coderCopy, v18, @"max");
  objc_msgSend_minValue(self, v19, v20);
  objc_msgSend_encodeDouble_forKey_(coderCopy, v21, @"min");
  hasMaxValue = objc_msgSend_hasMaxValue(self, v22, v23);
  objc_msgSend_encodeBool_forKey_(coderCopy, v25, hasMaxValue, @"hmax");
  hasMinValue = objc_msgSend_hasMinValue(self, v26, v27);
  objc_msgSend_encodeBool_forKey_(coderCopy, v29, hasMinValue, @"hmin");
  v32 = objc_msgSend_pathValue(self, v30, v31);
  v34 = objc_msgSend_p_savedPathFromPath_(self, v33, v32);
  objc_msgSend_encodeObject_forKey_(coderCopy, v35, v34, @"svdPth");

  v38 = objc_msgSend_removed(self, v36, v37);
  objc_msgSend_encodeBool_forKey_(coderCopy, v39, v38, @"removed");
  v42 = objc_msgSend_debugOnly(self, v40, v41);
  objc_msgSend_encodeBool_forKey_(coderCopy, v43, v42, @"dbg");
  v47 = objc_msgSend_parameterDescription(self, v44, v45);
  objc_msgSend_encodeObject_forKey_(coderCopy, v46, v47, @"desc");
}
...
- (id)p_savedPathFromPath:(id)path
{
  ...
  if (pathCopy)
  {
    ...
    if (objc_msgSend_elementCount(pathCopy, v7, v8) >= 1)
    {
      ...
      while (1)
      {
        v11 = objc_msgSend_elementAtIndex_associatedPoints_(pathCopy, v9, v10, &v26);
...
LABEL_14:
        ...
        if (++v10 >= objc_msgSend_elementCount(pathCopy, v23, v24))
        {
          goto LABEL_17;
        }
      }
