...
- (BOOL)incrementPage;
- (KNPdfHandoutExporter)initWithDocumentRoot:(id)a3;
- (id)currentInfos;
- (id)p_noteSegmentsForSlideNode:(id)a3 withScaledClipRect:(CGRect)a4 firstSegmentIndex:(unint64_t)a5;
- (id)p_segmentsForPage:(unint64_t)a3;
- (id)p_segmentsForSlideNode:(id)a3 withScaledClipRect:(CGRect)a4 firstSegmentIndex:(unint64_t)a5;
- (unint64_t)pageCount;
- (void)drawPolyPageBodyInContext:(CGContext *)a3 scaledClipRect:(CGRect)a4;
- (void)p_drawDividerLineForRect:(CGRect)a3 pageRect:(CGRect)a4 context:(CGContext *)a5;
- (void)p_drawNotesForNode:(id)a3 index:(unint64_t)a4 forRect:(CGRect)a5 notesIndex:(unint64_t)a6 scaledClipRect:(CGRect)a7 context:(CGContext *)a8;
- (void)p_drawRuledLinesForRect:(CGRect)a3 pageRect:(CGRect)a4 numberOfLines:(unint64_t)a5 context:(CGContext *)a6;
- (void)p_segmentSlideNodesWithScaledClipRect:(CGRect)a3;
  ...
  if (v21)
  {
    ...
    do
    {
      for (i = 0; i != v21; ++i)
      {
        ...
        if (!v33)
        {
          objc_msgSend_drawImageForSlideNode_event_slideSize_intoRect_annotationFlagsScale_context_(self, v37, v27, v30, a3, v39, v40, x + v17 * 0.5 - v39 * 0.5, v44, v39, v40, 0.0);
        }
        ...
        if (objc_msgSend_isPrintingSlideNumbers(self, v37, v38))
        {
          if (!v33)
          {
            objc_msgSend_drawSlideNumberForNode_buildIndex_forRect_context_position_(self, v45, v27, v30, a3, 1, x, v24, v17, v65);
          }
        ...
        objc_msgSend_p_drawNotesForNode_index_forRect_notesIndex_scaledClipRect_context_(self, v52, v27, v30, v33, a3, x, v24, v17, v48, x, y, width, height);
        objc_msgSend_setIsPrinting_(*(&self->super.super.super.super.super.isa + v49), v53, isPrinting);
        if (!v33)
        {
          objc_msgSend_drawBorderForRect_context_(self, v54, a3, v43, v44, v41, v42);
        }

        v22 += v36;
        if (v64 != v22)
        {
          objc_msgSend_p_drawDividerLineForRect_pageRect_context_(self, v54, a3, x, v24, v17, v48, x, y, width, height);
        }

        objc_msgSend_p_drawRuledLinesForRect_pageRect_numberOfLines_context_(self, v54, v62, a3, x, v24, v17, v48, x, y, width, height);
...
- (id)p_segmentsForSlideNode:(id)a3 withScaledClipRect:(CGRect)a4 firstSegmentIndex:(unint64_t)a5
{
  ...
  if (objc_msgSend_isPrintingNotes(self, v15, v16) && objc_msgSend_hasNote(v11, v17, v18))
  {
    v19 = objc_msgSend_p_noteSegmentsForSlideNode_withScaledClipRect_firstSegmentIndex_(self, v17, v11, a5, x, y, width, height);
    objc_msgSend_addObjectsFromArray_(v14, v20, v19);
  }

  if (objc_msgSend_isPrintingBuilds(self, v17, v18) && objc_msgSend_safeHasBuildEvents(v11, v21, v22))
  {
    for (i = objc_msgSend_count(v14, v21, v22) != 0; i <= objc_msgSend_safeBuildEventCount(v11, v23, v24); ++i)
    {
      v28 = [KNPrintSegment alloc];
      v30 = objc_msgSend_initWithSlideNode_buildIndex_notesIndex_span_(v28, v29, v11, i, 0, 1);
  ...
  else if (!objc_msgSend_count(v14, v21, v22))
  {
    ...
    v34 = objc_msgSend_initWithSlideNode_buildIndex_notesIndex_span_(v32, v33, v11, 0, 0, 1);
...
- (id)p_noteSegmentsForSlideNode:(id)a3 withScaledClipRect:(CGRect)a4 firstSegmentIndex:(unint64_t)a5
{
  ...
  if (objc_msgSend_hasNote(v106, v13, v14))
  {
    ...
    objc_opt_class();
    v22 = objc_msgSend_slide(v106, v20, v21);
    v23 = TSUDynamicCast();
    ...
    if (v109)
    {
      ...
      v42 = (v104 + a5 / v104 * v104 - a5 - 1) * 18.0 + (height + (v104 - 1) * -18.0) / v104 * (v104 + a5 / v104 * v104 - a5);
      v103 = v104 + a5 / v104 * v104 - a5;
      v105 = v103;
      do
      {
        ...
        if (&v79[v77] >= v109)
        {
          ...
          if (v103 >= v94)
          {
            v95 = objc_msgSend_initWithSlideNode_buildIndex_notesIndex_span_(v92, v93, v106, 0, v39, v94);
          }

          else
          {
            v95 = objc_msgSend_initWithSlideNode_buildIndex_notesIndex_span_(v92, v93, v106, 0, v39, v103);
          }
        ...
        else
        {
          ...
          v85 = objc_msgSend_initWithSlideNode_buildIndex_notesIndex_span_(v83, v84, v106, 0, v39, v105);
          v105 = v104;
          v42 = height;
...
- (void)p_drawDividerLineForRect:(CGRect)a3 pageRect:(CGRect)a4 context:(CGContext *)a5
{
  ...
  CGContextSetStrokeColorWithColor(a5, v18);
  v19 = MinY + -9.0;

  CGContextSetLineWidth(a5, 0.25);
  CGContextBeginPath(a5);
  CGContextMoveToPoint(a5, v10, v19);
  CGContextAddLineToPoint(a5, v10 + MaxX - v10, v19);
...
- (void)p_drawRuledLinesForRect:(CGRect)a3 pageRect:(CGRect)a4 numberOfLines:(unint64_t)a5 context:(CGContext *)a6
{
  ...
  v14 = a3.origin.y;
  v15 = a3.origin.x;
  if (objc_msgSend_isPrintingRuledLines(self, a2, a5))
  {
    v26.origin.x = v15;
    v26.origin.y = v14;
    v26.size.width = v13;
    ...
    CGContextSetStrokeColorWithColor(a6, v23);

    CGContextSetLineWidth(a6, 0.25);
    if (v7)
    {
      ...
      do
      {
        ...
        CGContextMoveToPoint(a6, MaxX + 9.0, MaxY);
        CGContextAddLineToPoint(a6, v24, MaxY);
...
- (void)p_drawNotesForNode:(id)a3 index:(unint64_t)a4 forRect:(CGRect)a5 notesIndex:(unint64_t)a6 scaledClipRect:(CGRect)a7 context:(CGContext *)a8
{
  ...
  {
    v25 = objc_msgSend_hasNote(v20, v23, v24) ^ 1;
    if (a4)
    {
      LOBYTE(v25) = 1;
    }
    ...
    if ((v25 & 1) == 0)
    {
      ...
      CGContextTranslateCTM(a8, MaxX + 18.0, v16);
      v83.origin.x = x;
      v83.origin.y = y;
      ...
      nullsub_1(a8, v36, 0.0, 0.0, v37, v14);

      objc_msgSend_setCurrentSlideNode_(self, v38, v20);
      objc_opt_class();
      ...
      objc_msgSend_setInitialCharacterIndexForExporting_(v45, v49, a6);
      ...
      if (![(TSARenderingExporter *)&v80 drawCurrentPageInContext:a8 viewScale:0 unscaledClipRect:1.0 createPage:0.0, 0.0, v37, v14])
      {
