...
+ (id)p_newArrayByScanningString:(id)a3 scanRange:(_NSRange)a4 returnAllResults:(BOOL)a5 dataDetector:(id)a6;
+ (id)p_rangesSplitByNewLineOfString:(id)a3 scanRange:(_NSRange)a4;
- (TSWPURLDataDetector)init;
- (TSWPURLDataDetector)initWithTextCheckingType:(unint64_t)a3;
- (id)scanString:(id)a3;
@end
...
+ (_NSRange)expandValidRange:(_NSRange)a3 inString:(id)a4
{
  ...
  v9 = objc_msgSend_rangeOfCharacterFromSet_options_range_(v8, v7, qword_280A584C0, 6, 0, location);
  v11 = v10;
...
+ (_NSRange)calculateScanRangeForString:(id)a3 changedRange:(_NSRange)a4
{
  ...
  v6 = a3;
  if (objc_msgSend_length(v6, v7, v8) >= 3)
  {
    v10 = objc_opt_class();
    location = objc_msgSend_expandValidRange_inString_(v10, v11, location, length, v6);
    length = v9;
  }

  for (; length; --length)
  {
    v12 = objc_msgSend_characterAtIndex_(v6, v9, location);
...
+ (id)p_newArrayByScanningString:(id)a3 scanRange:(_NSRange)a4 returnAllResults:(BOOL)a5 dataDetector:(id)a6
{
  ...
  v28 = sub_276E20A28;
  v29 = 0;
  v15.length = objc_msgSend_length(v11, v13, v14);
  if (v15.length >= 3 && length >= 3)
  {
    ...
    v20[6] = a1;
    v21 = a5;
    objc_msgSend_enumerateMatchesInString_options_range_usingBlock_(v12, v16, v11, 0, v17.location, v17.length, v20);
...
+ (id)newURLFromString:(id)a3
{
  ...
  if (!objc_msgSend_compare_options_range_(v5, v7, @"file://", 1, 0, v6))
  {
    v24 = objc_msgSend_length(@"file://", v8, v9);
    v26 = objc_msgSend_substringFromIndex_(v5, v25, v24);
    v29 = v26;
...
LABEL_18:
  ...
  v12 = objc_msgSend_initWithString_(v10, v11, v5);
  v15 = v12;
  if (v12)
  {
...
LABEL_22:
          ...
          v42 = objc_msgSend_substringFromIndex_(v5, v41, v40);
...
+ (id)p_rangesSplitByNewLineOfString:(id)a3 scanRange:(_NSRange)a4
{
  ...
  for (i = objc_msgSend_arrayWithCapacity_(MEMORY[0x277CBEB18], v9, length / v11 + 2);
  {
    ...
    if (v12 - location > v11)
    {
      v16 = objc_msgSend_rangeOfCharacterFromSet_options_range_(v6, v13, v10, 4, location, v11);
      v17 = &v13[v16];
      if (location <= &v13[v16])
      {
        v18 = &v13[v16];
...
+ (BOOL)detectedDataInString:(id)a3 scanRange:(_NSRange)a4 withTextCheckingTypes:(unint64_t)a5
{
  ...
  location = a4.location;
  v9 = a3;
  v11 = objc_msgSend_p_rangesSplitByNewLineOfString_scanRange_(a1, v10, v9, location, length);
  v24 = 0;
  v25 = &v24;
  v26 = 0x2020000000;
  v27 = 0;
...
- (TSWPURLDataDetector)initWithTextCheckingType:(unint64_t)a3
{
  ...
  {
    v18 = 0;
    v6 = objc_msgSend_dataDetectorWithTypes_error_(MEMORY[0x277CCA948], v4, a3, &v18);
    v7 = v18;
...
- (id)scanString:(id)a3
{
  ...
  v10 = objc_msgSend_p_newArrayByScanningString_scanRange_returnAllResults_dataDetector_(v5, v9, v4, 0, v8, 1, self->_detector);
