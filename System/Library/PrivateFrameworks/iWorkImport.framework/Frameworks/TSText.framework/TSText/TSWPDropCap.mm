...
- (BOOL)isEqual:(id)a3;
- (TSWPDropCap)initWithArchive:(const void *)a3 unarchiver:(id)a4;
- (TSWPDropCap)initWithLocalizationDictionary:(id)a3;
- (TSWPDropCap)initWithType:(int64_t)a3 numberOfLines:(unint64_t)a4 numberOfRaisedLines:(unint64_t)a5 outdent:(double)a6 padding:(double)a7 shapeEnabled:(BOOL)a8 cornerRadius:(double)a9 characterScale:(double)a10 wrapType:(int64_t)a11 numberOfCharacters:(unint64_t)a12;
- (id)localizationDictionary;
- (id)mutableCopyWithZone:(_NSZone *)a3;
- (unint64_t)hash;
- (void)saveToArchive:(void *)a3 archiver:(id)a4;
- (void)setNumberOfLines:(unint64_t)a3;
- (void)setNumberOfRaisedLines:(unint64_t)a3;
- (void)setValuesWithLocalizationDictionary:(id)a3;
@end
...
- (TSWPDropCap)initWithArchive:(const void *)a3 unarchiver:(id)a4
{
  ...
  return objc_msgSend_initWithType_numberOfLines_numberOfRaisedLines_outdent_padding_shapeEnabled_cornerRadius_characterScale_wrapType_numberOfCharacters_(self, a2, v5, *(a3 + 20), *(a3 + 7), *(a3 + 44), v7, *(a3 + 21), v9, v10, v11, v12);
}

- (void)saveToArchive:(void *)a3 archiver:(id)a4
{
  v6 = objc_msgSend_dropCapType(self, a2, a3, a4);
  if (v6 <= 2)
  {
    *(a3 + 4) |= 1u;
    *(a3 + 6) = v6;
...
- (TSWPDropCap)initWithType:(int64_t)a3 numberOfLines:(unint64_t)a4 numberOfRaisedLines:(unint64_t)a5 outdent:(double)a6 padding:(double)a7 shapeEnabled:(BOOL)a8 cornerRadius:(double)a9 characterScale:(double)a10 wrapType:(int64_t)a11 numberOfCharacters:(unint64_t)a12
{
  ...
  if (v22)
  {
    objc_msgSend_setDropCapType_(v22, v23, a3);
    objc_msgSend_setNumberOfLines_(v24, v25, a4);
    objc_msgSend_setNumberOfRaisedLines_(v24, v26, a5);
    objc_msgSend_setOutdent_(v24, v27, v28, a6);
    objc_msgSend_setPadding_(v24, v29, v30, a7);
    objc_msgSend_setShapeEnabled_(v24, v31, v14);
    objc_msgSend_setCornerRadius_(v24, v32, v33, a9);
    objc_msgSend_setCharacterScale_(v24, v34, v35, a10);
    objc_msgSend_setWrapType_(v24, v36, a11);
    objc_msgSend_setNumberOfCharacters_(v24, v37, a12);
  }
...
- (TSWPDropCap)initWithLocalizationDictionary:(id)a3
{
  ...
  if (v7)
  {
    objc_msgSend_setValuesWithLocalizationDictionary_(v7, v8, v4);
  }
...
- (void)setValuesWithLocalizationDictionary:(id)a3
{
  ...
  v3[3] = &unk_27A6F4B78;
  v3[4] = self;
  objc_msgSend_enumerateKeysAndObjectsUsingBlock_(a3, a2, v3);
}

- (id)mutableCopyWithZone:(_NSZone *)a3
{
  v4 = objc_msgSend_allocWithZone_(TSWPMutableDropCap, a2, a3);
...
- (void)setNumberOfRaisedLines:(unint64_t)a3
{
  objc_msgSend_numberOfLines(self, a2, a3);
  TSUClamp();
