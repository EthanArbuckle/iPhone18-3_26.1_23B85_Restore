...
- (TSWPTextPresetDisplayItem)initWithArchive:(const void *)a3 unarchiver:(id)a4;
- (TSWPTextPresetDisplayItem)initWithPreset:(id)a3 displayName:(id)a4;
- (id)description;
...
- (TSWPTextPresetDisplayItem)initWithArchive:(const void *)a3 unarchiver:(id)a4
{
  ...
  if (v7)
  {
    ...
    v14 = objc_msgSend_tsp_stringWithProtobufString_(MEMORY[0x277CCACA8], v8, *(a3 + 3) & 0xFFFFFFFFFFFFFFFELL);
