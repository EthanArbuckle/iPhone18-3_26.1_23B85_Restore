...
- (int64_t)delta;
- (void)performWithStorage:(id)a3 delta:(int64_t)a4 actionBuilder:(TSWPStorageActionBuilder *)a5 withFlags:(unsigned int)a6 replaceBlock:(id)a7;
@end
...
- (TSWPTextReplacement)initWithSelection:(id)a3 string:(id)a4
{
  ...
  if (v11)
  {
    v12 = objc_msgSend_ranges(v7, v9, v10);
    ...
    objc_storeStrong(&v11->_selection, a3);
    if (v8)
    {
      objc_opt_class();
    ...
    objc_storeStrong(&v11->_string, a4);
  }
...
- (void)performWithStorage:(id)a3 delta:(int64_t)a4 actionBuilder:(TSWPStorageActionBuilder *)a5 withFlags:(unsigned int)a6 replaceBlock:(id)a7
{
  ...
  if (a4)
  {
    ...
    v21 = objc_msgSend_copyWithNewRange_(selection, v20, Range + a4, v20);
    v22 = self->_selection;
    self->_selection = v21;
  }
  ...
  if (v8)
  {
    ...
    v42.length = v23;
    v25 = objc_msgSend_insertionChangesTable(v12, v23, v24);
    v26 = v25;
    if (v25)
    {
  ...
  objc_msgSend_p_updateChangeTimestampForDeletedRange_actionBuilder_(v12, v33, v32, v33, a5);
  v15[2](v15, self->_selection, self->_string);
  v36 = objc_msgSend_insertedRange(self, v34, v35);
  objc_msgSend_p_handleChangeSplittingForInsertedRange_changeSession_actionBuilder_(v12, v37, v36, v37, 0, a5);
}
