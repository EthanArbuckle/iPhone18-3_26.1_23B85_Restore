...
- (CGRect)nonAutosizedFrameForTextLayout:(id)a3
{
  ...
  [(TSWPShapeLayout *)&v19 nonAutosizedFrameForTextLayout:a3];
  v5 = v4;
  v7 = v6;
...
- (id)paragraphStyleAtParIndex:(unint64_t)a3 effectiveRange:(_NSRange *)a4
{
  v7 = objc_msgSend_commentInfo(self, a2, a3);
  objc_opt_class();
  ...
  if (a4)
  {
    ...
    a4->location = objc_msgSend_textRangeForParagraphAtIndex_(v29, v30, a3);
    a4->length = v31;
  }
...
- (id)characterStyleAtCharIndex:(unint64_t)a3 effectiveRange:(_NSRange *)a4
{
  v6 = objc_msgSend_commentInfo(self, a2, a3);
...
- (id)dropCapStyleAtParIndex:(unint64_t)a3
{
  v4 = objc_msgSend_commentInfo(self, a2, a3);
