...
- (BOOL)isEqual:(id)a3;
- (BOOL)isEqualToStyleDiff:(id)a3;
- (TSWPStyleDiff)initWithContext:(id)a3 changeSet:(id)a4;
- (TSWPStyleDiff)initWithContext:(id)a3 style:(id)a4;
- (id)changedPropertyNames:(id)a3;
- (id)description;
- (id)styleDiffForTable:(unint64_t)a3 storage:(id)a4 currentObject:(id)a5;
- (unint64_t)hash;
- (void)didInitFromSOS;
...
- (TSWPStyleDiff)initWithContext:(id)a3 style:(id)a4
{
  ...
  v8 = [(TSWPStyleDiff *)&v12 initWithContext:v6];
  v10 = v8;
  if (v8)
  {
    objc_msgSend_setStyle_(v8, v9, v7);
  }
...
- (TSWPStyleDiff)initWithContext:(id)a3 changeSet:(id)a4
{
  ...
  if (v8)
  {
    objc_msgSend_setChangeSet_(v8, v9, v7);
  }
...
- (void)loadFromUnarchiver:(id)a3
{
  ...
  v5 = objc_msgSend_messageWithDescriptor_(v7, v4, off_2812DCBA8[86]);
...
- (void)saveToArchive:(void *)a3 archiver:(id)a4
{
  ...
  if (style)
  {
    *(a3 + 4) |= 1u;
    ...
    objc_msgSend_setStrongReference_message_(v10, v6, style, v8);
  }
}
...
- (void)saveToArchiver:(id)a3
{
  v7 = a3;
  google::protobuf::internal::AssignDescriptors();
  v5 = objc_msgSend_messageWithNewFunction_descriptor_(v7, v4, sub_276EADE54, off_2812DCBA8[86]);
...
- (id)styleDiffForTable:(unint64_t)a3 storage:(id)a4 currentObject:(id)a5
{
  ...
  v13 = objc_msgSend_context(v8, v11, v12);
  ...
  if (v27)
  {
    v31 = objc_msgSend_stylesheet(v8, v28, v29);
    if (a3 <= 2)
    {
      if (!a3)
      {
  ...
  if (v16)
  {
    ...
    do
    {
      for (i = 0; i != v16; ++i)
      {
        ...
        v19 = objc_msgSend_stringWithFormat_(MEMORY[0x277CCACA8], v15, @"%@.%@", v4, *(*(&v22 + 1) + 8 * i));
...
- (BOOL)isEqualToStyleDiff:(id)a3
{
  ...
  if (v7)
  {
    ...
    if (v10 || (objc_msgSend_style(v7, v8, v9), (v3 = objc_claimAutoreleasedReturnValue()) != 0))
    {
      v11 = objc_msgSend_style(self, v8, v9);
      v14 = objc_msgSend_style(v7, v12, v13);
      v15 = v11 == v14;
...
LABEL_9:
        ...
        if (v21 || (objc_msgSend_changeSet(v7, v19, v20), (v3 = objc_claimAutoreleasedReturnValue()) != 0))
        {
          v22 = objc_msgSend_changeSet(self, v19, v20);
          v25 = objc_msgSend_changeSet(v7, v23, v24);
...
- (BOOL)isEqual:(id)a3
{
  ...
  else
  {
    ...
    {
      isEqualToStyleDiff = objc_msgSend_isEqualToStyleDiff_(self, v5, v4);
    }
