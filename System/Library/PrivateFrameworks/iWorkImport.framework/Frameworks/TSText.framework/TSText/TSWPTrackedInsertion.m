...
- (TSWPTrackedInsertion)initWithSelection:(id)a3 string:(id)a4 changeSession:(id)a5
{
  ...
  if (v13)
  {
    ...
    v30 = objc_msgSend_ranges(v9, v14, v15);
    ...
    objc_storeStrong(&v13->_selection, a3);
    v44 = objc_msgSend_copy(v10, v42, v43);
    string = v13->_string;
    v13->_string = v44;

    objc_storeStrong(&v13->_changeSession, a5);
  }
...
- (void)performWithStorage:(id)a3 delta:(int64_t)a4 actionBuilder:(void *)a5 withFlags:(unsigned int)a6 replaceBlock:(id)a7
{
  ...
  if (a4)
  {
    ...
    v19 = objc_msgSend_copyWithNewRange_(selection, v18, Range + a4, v18);
    v20 = self->_selection;
    self->_selection = v19;
  }

  v21 = objc_msgSend_insertionChangesTable(v11, v12, v13);
  v25 = objc_msgSend_firstRange(self->_selection, v22, v23);
  v26 = 0;
  if (!v27 && v21)
  {
    objc_msgSend_range(v11, 0, v24);
...
LABEL_15:
  v82[2](v82, self->_selection, self->_string);
  v39 = *(a5 + 2);
  if (!v39)
  {
    v39 = a5 + 24;
  ...
  objc_msgSend_p_handleChangeSplittingForInsertedRange_changeSession_actionBuilder_(v11, v41, v40, v41, self->_changeSession, a5);
  if (v26)
  {
    *(a5 + 120) &= 0xFFFFFE7F;
  ...
  v47 = v51;
  v55 = objc_msgSend_insertionChangesTable(v11, v51, v52);
  if (v55)
  {
    v87.location = 0;
    v87.length = 0;
    objc_msgSend_range(v11, v53, v54);
    v87.location = NSExpandedRange();
    v87.length = v56;
    ...
    for (j = v86; j != v84; j = ++v86)
    {
      ...
      if (objc_msgSend_canMergeWithKind_session_(v59, v60, 1, self->_changeSession))
      {
        ...
        if (NSIntersectionRange(v88, v87).length)
        {
          ...
          v68 = objc_msgSend_context(v11, v66, v67);
  ...
  v64 = objc_msgSend_context(v11, v73, v74);
  v71 = objc_msgSend_initWithContext_kind_session_(v72, v75, v64, 1, self->_changeSession);
  v50 = 0;
LABEL_31:

  objc_msgSend_applyObject_toCharRange_forKind_actionBuilder_(v11, v76, v71, v45, v47, 15, a5);
  if (v50)
  {
LABEL_32:
    if (v45 != *MEMORY[0x277D81490] || v47 != *(MEMORY[0x277D81490] + 8))
    {
      ...
      objc_msgSend_applyObject_toCharRange_forKind_actionBuilder_(v11, v78, v77, v45, v47, 15, a5);
    }
  }
