...
- (TSWPFootnoteReferenceAttachment)initWithContext:(id)context wpStorage:(id)storage
{
  ...
  v8 = [(TSWPAttachment *)&v20 initWithContext:contextCopy];
  v10 = v8;
  if (v8)
  {
    objc_msgSend_setContainedStorage_(v8, v9, storageCopy);
...
{
  contextCopy = context;
  v7 = objc_msgSend_documentRoot(contextCopy, v5, v6);
  ...
  v28 = -1;
  v22 = objc_msgSend_initWithContext_string_kind_stylesheet_paragraphStyle_listStyle_section_columnStyle_paragraphDirection_(v14, v21, contextCopy, 0, 2, v17, v13, v20, 0, 0, v28);

  v24 = objc_msgSend_initWithContext_wpStorage_(self, v23, contextCopy, v22);
...
- (BOOL)isEqual:(id)equal
{
  ...
  if ([(TSWPAttachment *)&v19 isEqual:equalCopy])
  {
    objc_opt_class();
    v5 = TSUDynamicCast();
    v8 = v5;
...
- (id)copyWithContext:(id)context
{
  ...
  v10 = objc_msgSend_newSubstorageWithRange_context_flags_(containedStorage, v9, 0, v8, contextCopy, 1);
  v11 = objc_alloc(objc_opt_class());
  v13 = objc_msgSend_initWithContext_wpStorage_(v11, v12, contextCopy, v10);
...
- (void)setParentStorage:(id)storage
{
  ...
  objc_msgSend_setContainedStorageParentInfoToStorage_(self, v5, storageCopy);
}
...
- (void)setCustomMarkString:(id)string
{
  ...
  v9 = objc_msgSend_copy(stringCopy, v7, v8);
  customMarkString = self->_customMarkString;
...
- (unint64_t)findCharIndexWithHintIndex:(unint64_t *)index
{
  v5 = objc_msgSend_parentStorage(self, a2, index);
  CharIndexForFootnoteAttachment_withHintIndex = objc_msgSend_findCharIndexForFootnoteAttachment_withHintIndex_(v5, v6, self, index);
...
- (void)willBeAddedToDocumentRoot:(id)root dolcContext:(id)context
{
  ...
  [(TSWPAttachment *)&v12 willBeAddedToDocumentRoot:rootCopy dolcContext:contextCopy];
...
- (void)wasAddedToDocumentRoot:(id)root dolcContext:(id)context
{
  ...
  v12.receiver = self;
  v12.super_class = TSWPFootnoteReferenceAttachment;
  [(TSWPAttachment *)&v12 wasAddedToDocumentRoot:rootCopy dolcContext:contextCopy];
  v10 = objc_msgSend_containedStorage(self, v8, v9);
...
- (void)willBeRemovedFromDocumentRoot:(id)root
{
  ...
  [(TSWPAttachment *)&v9 willBeRemovedFromDocumentRoot:rootCopy];
...
- (void)wasRemovedFromDocumentRoot:(id)root
{
  ...
  v9.receiver = self;
  v9.super_class = TSWPFootnoteReferenceAttachment;
  [(TSWPAttachment *)&v9 wasRemovedFromDocumentRoot:rootCopy];
  v7 = objc_msgSend_containedStorage(self, v5, v6);
...
- (void)adoptStylesheet:(id)stylesheet withMapper:(id)mapper
{
  ...
  objc_msgSend_adoptStylesheet_withMapper_(self->_containedStorage, v9, stylesheetCopy, mapperCopy);
...
- (void)loadFromUnarchiver:(id)unarchiver
{
  ...
  v6 = objc_msgSend_messageWithDescriptor_(unarchiverCopy, v5, off_2812DC408[132]);
  ...
  [(TSWPTextualAttachment *)&v18 loadFromArchive:v7 unarchiver:unarchiverCopy];
  v9 = *(v6 + 16);
  if ((v9 & 4) != 0)
  {
    v10 = *(v6 + 40);
...
- (void)saveToArchiver:(id)archiver
{
  ...
  google::protobuf::internal::AssignDescriptors();
  v6 = objc_msgSend_messageWithNewFunction_descriptor_(archiverCopy, v5, sub_276DF68F0, off_2812DC408[132]);
  ...
  *(v6 + 16) |= 2u;
  ...
  [(TSWPTextualAttachment *)&v16 saveToArchive:v7 archiver:archiverCopy];
  containedStorage = self->_containedStorage;
  if (containedStorage)
  {
    *(v6 + 16) |= 4u;
    ...
    objc_msgSend_setStrongReference_message_(archiverCopy, v9, containedStorage, v12);
  }
