...
+ (id)evaluateForArgsWithContext:(id)context functionSpec:(id)spec arguments:(const void *)arguments
{
  ...
  v9 = *(*arguments + 8);
  v70 = 0;
  v11 = objc_msgSend_asNumber_functionSpec_argumentIndex_outError_(v8, v10, context, spec, 0, &v70);
  v12 = v70;
  if (v12)
  {
    v16 = v12;
  ...
  {
    v69 = 0;
    v18 = objc_msgSend_asNumber_functionSpec_argumentIndex_outError_(v9, v13, context, spec, 1, &v69);
    v16 = v69;
    if (v16)
    {
    ...
    else
    {
      ...
      else
      {
        ...
        if (v8)
        {
          objc_msgSend_formatWithContext_(v8, v28, context, v30, v31);
        }
        ...
        if (v9)
        {
          objc_msgSend_formatWithContext_(v9, v28, context, v30, v31);
        }
        ...
        *&v66._formatType = v37;
        ...
        {
          v49 = objc_msgSend_functionName(spec, v42, v43, v44, v45);
          v53 = objc_msgSend_signsMustMatchErrorForFunctionName_(TSCEError, v50, v49, v51, v52);
          v17 = objc_msgSend_raiseErrorOrConvert_(context, v54, v53, v55, v56);
        }
