@interface TSCEFunction_OCT2HEX
+ (id)evaluateForArgsWithContext:(id)context functionSpec:(id)spec arguments:(const void *)arguments;
@end

@implementation TSCEFunction_OCT2HEX
...
+ (id)evaluateForArgsWithContext:(id)context functionSpec:(id)spec arguments:(const void *)arguments
{
  ...
  else
  {
    ...
    v15 = objc_msgSend_initWithBase_basePlaces_baseUseMinusSign_(v36, v37, 16, v23, 0);
    v16 = sub_2211F78B4(context, spec, v10, 8, 1, v15);
  }
