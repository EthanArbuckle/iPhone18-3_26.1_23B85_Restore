...
+ (BOOL)p_rangeRef:(const TSCERangeRef *)a3 isContainedWithinSummaryAndLabelRowsInTable:(id)a4;
+ (RefTypeHolder<TSCERangeRef,)p_expandedViewRangeRefForViewRangeRef:(id)a2 forLabelRowsInTable:(SEL)a3;
+ (TSUCellRect)p_cellRangeForSingleCategoryRefInViewRangeRef:(const void *)a3 inTable:(id)a4 rangeContext:(unsigned __int8)a5;
+ (id)p_singleCategoryRefForViewRangeRef:(const void *)a3 rangeContext:(unsigned __int8)a4 calculationEngine:(id)a5 hostCellRef:(const TSCECellRef *)a6;
+ (id)p_spanningCategoryRefForViewRangeRef:(const void *)a3 groupByUid:(TSKUIDStruct)a4 categoryLevel:(unsigned __int8)a5 calculationEngine:(id)a6;
+ (unsigned)preserveFlagsForReference:(const TSCERangeRef *)a3 calcEngine:(id)a4;
...
- (TSTGroupBy)groupBy;
- (TSTReferenceNode)initWithContext:(id)a3 calculationEngine:(id)a4 baseRangeRef:(const void *)a5 preserveFlags:(unsigned __int8)a6 hostCellRef:(const TSCECellRef *)a7 referenceColorHelper:(id)a8 suppressAutomaticNamedReferenceInvalidation:(BOOL)a9;
- (TSTReferenceNode)initWithContext:(id)a3 calculationEngine:(id)a4 chromeRangeRef:(const void *)a5 preserveFlags:(unsigned __int8)a6 hostCellRef:(const void *)a7 referenceColorHelper:(id)a8 suppressAutomaticNamedReferenceInvalidation:(BOOL)a9;
- (TSTReferenceNode)initWithContext:(id)a3 calculationEngine:(id)a4 uidRectRef:(id)a5 categoryRef:(id)a6 hostCellRef:(const TSCECellRef *)a7 referenceColorHelper:(id)a8 suppressAutomaticNamedReferenceInvalidation:(BOOL)a9;
- (TSTReferenceNode)initWithContext:(id)a3 calculationEngine:(id)a4 viewRangeRef:(const void *)a5 preserveFlags:(unsigned __int8)a6 hostCellRef:(const void *)a7 referenceColorHelper:(id)a8 suppressAutomaticNamedReferenceInvalidation:(BOOL)a9;
- (TSTReferenceNode)initWithReferenceStart:(id)a3 referenceEnd:(id)a4 suppressAutomaticNamedReferenceInvalidation:(BOOL)a5;
...
- (id)p_convertCategoryRefToRelativeForHostCell:(TSUCellCoord)a3;
- (id)referenceAsStringWithContext:(id)a3;
- (id)string;
- (id)subregionForRange:(id)a3;
- (unint64_t)hash;
...
- (void)p_buildASTNodeArray:(TSCEASTNodeArray *)a3 forCoord:(TSUCellCoord)a4 preserveFlags:(unsigned __int8)a5 hostCell:(TSUCellCoord)a6;
- (void)processChanges:(id)a3 forChangeSource:(id)a4;
- (void)saveToArchive:(void *)a3 archiver:(id)a4;
- (void)saveToArchiver:(id)a3;
- (void)setBasePreserveFlags:(unsigned __int8)a3;
- (void)setBaseRangeRef:(const void *)a3 preserveFlags:(unsigned __int8)a4;
- (void)setCategoryRef:(id)a3;
- (void)setChromeRangeRef:(const void *)a3 preserveFlags:(unsigned __int8)a4;
- (void)setHostCellRef:(TSCECellRef *)a3;
- (void)setHostTableUID:(TSKUIDStruct)a3;
- (void)setIsBlankForKeyboardInsertion:(BOOL)a3;
- (void)setRangeWithFunction:(BOOL)a3;
- (void)setSpillRangeSuffix:(BOOL)a3;
...
- (TSTReferenceNode)initWithContext:(id)a3 calculationEngine:(id)a4 uidRectRef:(id)a5 categoryRef:(id)a6 hostCellRef:(const TSCECellRef *)a7 referenceColorHelper:(id)a8 suppressAutomaticNamedReferenceInvalidation:(BOOL)a9
{
  ...
  if (v17)
  {
    v22 = objc_msgSend_calcEngine(v17, v18, v19, v20, v21, v60);
  ...
  v37 = [(TSTExpressionNode *)&v63 initWithContext:v15 children:0 firstIndex:0 lastIndex:0, v60];
  v38 = v37;
  if (v37)
  {
    objc_storeWeak(&v37->_calcEngine, v16);
    upper = a7->_tableUID._upper;
    *&v38->_hostCellRef.coordinate.row = *&a7->coordinate.row;
    v38->_hostCellRef._tableUID._upper = upper;
    v44 = objc_msgSend_copy(v17, v40, v41, v42, v43);
    uidRectRef = v38->_uidRectRef;
    v38->_uidRectRef = v44;

    objc_storeStrong(&v38->_categoryRef, a6);
    v38->_isCategoryRef = objc_msgSend_isValid(v62, v46, v47, v48, v49);
    v38->_rangeContext = 1;
    objc_storeStrong(&v38->_referenceColorHelper, a8);
    v38->_suppressAutomaticNamedReferenceInvalidation = a9;
    if (objc_msgSend_isValid(v38->_categoryRef, v50, v51, v52, v53))
    {
      v57 = objc_msgSend_p_convertCategoryRefToRelativeForHostCell_(v38, v54, *&a7->coordinate, v55, v56);
...
- (TSTReferenceNode)initWithContext:(id)a3 calculationEngine:(id)a4 viewRangeRef:(const void *)a5 preserveFlags:(unsigned __int8)a6 hostCellRef:(const void *)a7 referenceColorHelper:(id)a8 suppressAutomaticNamedReferenceInvalidation:(BOOL)a9
{
  ...
  v16 = a4;
  v17 = a8;
  v19 = objc_msgSend_tableInfoForTableUID_withCalcEngine_(TSTTableInfo, v18, *(a5 + 2), *(a5 + 3), v16);
  v20 = objc_opt_class();
  if (v20)
  {
    objc_msgSend_p_expandedViewRangeRefForViewRangeRef_forLabelRowsInTable_(v20, v21, a5, v19, v22);
  }
  ...
  v25 = objc_msgSend_initWithCalcEngine_viewRangeRef_preserveFlags_(v23, v24, v16, v32, v11);
  v26 = objc_opt_class();
  v28 = objc_msgSend_p_singleCategoryRefForViewRangeRef_rangeContext_calculationEngine_hostCellRef_(v26, v27, v32, 1, v16, a7);
  v30 = objc_msgSend_initWithContext_calculationEngine_uidRectRef_categoryRef_hostCellRef_referenceColorHelper_suppressAutomaticNamedReferenceInvalidation_(self, v29, v15, v16, v25, v28, a7, v17, a9);
...
- (TSTReferenceNode)initWithContext:(id)a3 calculationEngine:(id)a4 chromeRangeRef:(const void *)a5 preserveFlags:(unsigned __int8)a6 hostCellRef:(const void *)a7 referenceColorHelper:(id)a8 suppressAutomaticNamedReferenceInvalidation:(BOOL)a9
{
  ...
  v20 = objc_msgSend_initWithCalcEngine_chromeRangeRef_preserveFlags_(v18, v19, v16, a5, v11);
  v22 = objc_msgSend_initWithContext_calculationEngine_uidRectRef_categoryRef_hostCellRef_referenceColorHelper_suppressAutomaticNamedReferenceInvalidation_(self, v21, v15, v16, v20, 0, a7, v17, a9);
...
- (TSTReferenceNode)initWithContext:(id)a3 calculationEngine:(id)a4 baseRangeRef:(const void *)a5 preserveFlags:(unsigned __int8)a6 hostCellRef:(const TSCECellRef *)a7 referenceColorHelper:(id)a8 suppressAutomaticNamedReferenceInvalidation:(BOOL)a9
{
  ...
  v17 = a8;
  v18 = [TSTUIDRectRef alloc];
  v20 = objc_msgSend_initWithCalcEngine_baseRangeRef_preserveFlags_(v18, v19, v16, a5, v11);
  v22 = objc_msgSend_initWithContext_calculationEngine_uidRectRef_categoryRef_hostCellRef_referenceColorHelper_suppressAutomaticNamedReferenceInvalidation_(self, v21, v15, v16, v20, 0, a7, v17, a9);
...
- (TSTReferenceNode)initWithReferenceStart:(id)a3 referenceEnd:(id)a4 suppressAutomaticNamedReferenceInvalidation:(BOOL)a5
{
  v8 = a3;
  v9 = a4;
  v14 = objc_msgSend_hostTableUID(v8, v10, v11, v12, v13);
  v16 = v15;
  if (v14 != objc_msgSend_hostTableUID(v9, v15, v17, v18, v19) || v16 != v20)
  {
  ...
  v35 = objc_msgSend_calcEngine(v8, v20, v21, v22, v23);
  v40 = objc_msgSend_calcEngine(v9, v36, v37, v38, v39);
  ...
  if (objc_msgSend_spillRangeSuffix(v8, v41, v42, v43, v44))
  {
  ...
  if (objc_msgSend_spillRangeSuffix(v9, v56, v57, v58, v59))
  {
  ...
  v86 = objc_msgSend_uidRectRef(v8, v71, v72, v73, v74);
  v91 = objc_msgSend_viewTopLeftCoord(v86, v87, v88, v89, v90);

  v96 = objc_msgSend_uidRectRef(v9, v92, v93, v94, v95);
  v101 = objc_msgSend_viewBottomRightCoord(v96, v97, v98, v99, v100);

  v177._topLeft = v91;
  v177._bottomRight = v101;
  LOBYTE(v91) = objc_msgSend_viewPreserveFlags(v8, v102, v103, v104, v105);
  v176._flags = objc_msgSend_viewPreserveFlags(v9, v106, v107, v108, v109) & 0xFC | v91 & 3;
  TSCERangeCoordinate::fixInversions(&v177, &v176);
  flags = v176._flags;
  v115 = objc_msgSend_tableUID(v8, v111, v112, v113, v114);
  v117 = v116;
  if ((objc_msgSend_isNonSpillRangeExpression(v8, v116, v118, v119, v120) & 1) != 0 || (objc_msgSend_isNonSpillRangeExpression(v9, v121, v122, v123, v124) & 1) != 0 || (v155 = objc_msgSend_hostTableUID(v8, v125, v126, v127, v128), v157 = v156, v155 != objc_msgSend_hostTableUID(v9, v156, v158, v159, v160)) || v157 != v161 || (v165 = objc_msgSend_tableUID(v8, v161, v162, v163, v164), v167 = v166, v165 != objc_msgSend_tableUID(v9, v166, v168, v169, v170)) || v167 != v171 || !TSCERangeCoordinate::isValidOrSpanning(&v177))
  {
  ...
  v134 = objc_msgSend_calcEngine(v8, v130, v131, v132, v133);
  v172 = v175;
  v173 = v115;
  v174 = v117;
  v136 = objc_msgSend_initWithCalcEngine_viewRangeRef_preserveFlags_(v129, v135, v134, &v172, flags);

  v141 = objc_msgSend_context(v8, v137, v138, v139, v140);
  v150 = objc_msgSend_calcEngine(v8, v142, v143, v144, v145);
  if (v8)
  {
    objc_msgSend_hostCellRef(v8, v146, v147, v148, v149);
  }
  ...
  v151 = objc_msgSend_referenceColorHelper(v8, v146, v147, v148, v149);
  v153 = objc_msgSend_initWithContext_calculationEngine_uidRectRef_categoryRef_hostCellRef_referenceColorHelper_suppressAutomaticNamedReferenceInvalidation_(self, v152, v141, v150, v136, 0, &v172, v151, a5);
...
- (id)initAsCopyOf:(id)a3 intoContext:(id)a4 children:(id)a5
{
  ...
  v31 = [(TSTExpressionNode *)&v84 initAsCopyOf:v8 intoContext:v9 children:v10];
  if (v31)
  {
    ...
    {
      v38 = objc_msgSend_documentRoot(v9, v33, v34, v35, v36);
...
- (id)copyWithZone:(_NSZone *)a3
{
  if (objc_msgSend_isCategoryRef(self, a2, a3, v3, v4))
  {
...
- (void)setRangeWithFunction:(BOOL)a3
{
  if (self->_rangeWithFunction != a3)
  {
    self->_rangeWithFunction = a3;
    objc_msgSend_invalidate(self, a2, a3, v3, v4);
  }
}
...
- (void)setBasePreserveFlags:(unsigned __int8)a3
{
  ...
  objc_msgSend_setBasePreserveFlags_(uidRectRef, v7, v5, v9, v10);
...
- (void)setViewPreserveFlags:(unsigned __int8)a3
{
  ...
  if (uidRectRef)
  {
    if (objc_msgSend_spansAllRows(uidRectRef, a2, a3, v3, v4))
    {
      LODWORD(v5) = v5 & 0xF5;
    }
  ...
  objc_msgSend_setViewPreserveFlags_(uidRectRef, a2, v5, v3, v4);
...
- (void)setViewRangeRef:(const void *)a3 preserveFlags:(unsigned __int8)a4
{
  ...
  v14 = objc_msgSend_tableInfoForTableUID_withCalcEngine_(TSTTableInfo, v13, *(a3 + 2), *(a3 + 3), v12);
  v15 = objc_opt_class();
  if (v15)
  {
    objc_msgSend_p_expandedViewRangeRefForViewRangeRef_forLabelRowsInTable_(v15, v16, a3, v14, v19);
  }
  ...
  v53 = objc_msgSend_initWithCalcEngine_viewRangeRef_preserveFlags_(v51, v52, v12, v64, v5);
  uidRectRef = self->_uidRectRef;
...
- (void)setChromeRangeRef:(const void *)a3 preserveFlags:(unsigned __int8)a4
{
  ...
  v15 = objc_msgSend_initWithCalcEngine_chromeRangeRef_preserveFlags_(v8, v14, v13, a3, v5);
  uidRectRef = self->_uidRectRef;
...
- (void)setBaseRangeRef:(const void *)a3 preserveFlags:(unsigned __int8)a4
{
  ...
  v8 = [TSTUIDRectRef alloc];
  v13 = objc_msgSend_calcEngine(self, v9, v10, v11, v12);
  v15 = objc_msgSend_initWithCalcEngine_baseRangeRef_preserveFlags_(v8, v14, v13, a3, v5);
  uidRectRef = self->_uidRectRef;
  self->_uidRectRef = v15;
...
{
  v6 = a4;
  v8 = objc_msgSend_tableInfoForTableUID_withCalcEngine_(TSTTableInfo, a2, *(a3 + 2), *(a3 + 3), a5, a6);
  v13 = v8;
  if (v8 && objc_msgSend_isCategorized(v8, v9, v10, v11, v12) && (v14 = *(a3 + 1), v28 = *a3, v29 = v14, v15 = objc_opt_class(), objc_msgSend_p_rangeRef_isContainedWithinSummaryAndLabelRowsInTable_(v15, v16, &v28, v13, v17)))
  {
    v18 = objc_opt_class();
    v20 = objc_msgSend_p_cellRangeForSingleCategoryRefInViewRangeRef_inTable_rangeContext_(v18, v19, a3, v13, v6);
    v27 = v29;
    v26 = v20;
...
+ (id)p_spanningCategoryRefForViewRangeRef:(const void *)a3 groupByUid:(TSKUIDStruct)a4 categoryLevel:(unsigned __int8)a5 calculationEngine:(id)a6
{
  ...
  v50 = a4;
  v10 = a6;
  v12 = objc_msgSend_tableInfoForTableUID_withCalcEngine_(TSTTableInfo, v11, *(a3 + 2), *(a3 + 3), v10);
  v17 = v12;
  if (v12 && objc_msgSend_isCategorized(v12, v13, v14, v15, v16))
  {
    ...
    v49[1] = v33;
    v34 = objc_msgSend_groupByForUID_withCalcEngine_(TSTGroupBy, v33, lower, upper, v10);
    v35 = [TSCECategoryRef alloc];
    v48[0] = objc_msgSend_topLevelGroupUid(v34, v36, v37, v38, v39);
    v48[1] = v40;
    v41 = objc_msgSend_initWithGroupByUID_absGroupUid_columnUid_aggType_groupLevel_(v35, v40, &v50, v48, v49, 11, v6);
...
+ (RefTypeHolder<TSCERangeRef,)p_expandedViewRangeRefForViewRangeRef:(id)a2 forLabelRowsInTable:(SEL)a3
{
  ...
  v18.range = *a4;
  v18._tableUID = v8;
  v9 = objc_msgSend_indexesForLabelRows(a5, a3, a4, a5, v5);
  v13 = v9;
...
+ (TSUCellRect)p_cellRangeForSingleCategoryRefInViewRangeRef:(const void *)a3 inTable:(id)a4 rangeContext:(unsigned __int8)a5
{
  ...
  v8 = *a3;
  v9 = *(a3 + 1);
  v14 = objc_msgSend_range(v7, v10, v11, v12, v13);
  v16 = v15;
  v20 = objc_msgSend_bodyRange(v7, v15, v17, v18, v19);
  v22 = v21;
  v26 = objc_msgSend_categoryColumnRange(v7, v21, v23, v24, v25);
  v29 = sub_221387E00(v8, v9, v5, v14, v16, v20, v22, v28, v26, v27);
  v32 = objc_msgSend_regionFromRange_(TSTCellRegion, v30, v29, v30, v31);
  v36 = objc_msgSend_indexesForSummaryRowsInRegion_(v7, v33, v32, v34, v35);
  LODWORD(v9) = objc_msgSend_firstIndex(v36, v37, v38, v39, v40);
  v45 = objc_msgSend_boundingTopLeftCellID(v32, v41, v42, v43, v44);
  v50 = objc_msgSend_range(v7, v46, v47, v48, v49);
...
+ (BOOL)p_rangeRef:(const TSCERangeRef *)a3 isContainedWithinSummaryAndLabelRowsInTable:(id)a4
{
  ...
  v12 = objc_msgSend_range(v5, v8, v9, v10, v11);
  ...
  v25 = objc_msgSend_indexesOfHiddenRowsInCellRange_(v5, v23, v13, v15, v24);
  v29 = objc_msgSend_tsu_indexSetByExcludingIndexes_(v22, v26, v25, v27, v28);
  v33 = objc_msgSend_indexesForSummaryAndLabelRowsInRegion_(v5, v30, v17, v31, v32);
...
- (void)setHostTableUID:(TSKUIDStruct)a3
{
  ...
  if (!(a3._lower | a3._upper))
  {
    ...
    v8 = objc_msgSend_stringWithUTF8String_(MEMORY[0x277CCACA8], a2, "[TSTReferenceNode setHostTableUID:]", a3._upper, v3);
...
- (void)setIsBlankForKeyboardInsertion:(BOOL)a3
{
  ...
  {
    self->_isBlankForKeyboardInsertion = a3;
    objc_msgSend_invalidate(self, a2, a3, v3, v4);
  }
}
...
+ (unsigned)preserveFlagsForReference:(const TSCERangeRef *)a3 calcEngine:(id)a4
{
  v5 = objc_msgSend_tableInfoForTableUID_withCalcEngine_(TSTTableInfo, a2, a3->_tableUID._lower, a3->_tableUID._upper, a4);
  v9 = v5;
  if ((*&a3->range._topLeft & 0xFFFF00000000) != 0x7FFF00000000 && *&a3->range._topLeft == 0x7FFFFFFFLL)
  {
    v11 = 0;
  }
  ...
  {
    v11 = *&a3->range._topLeft;
  }

  v16 = objc_msgSend_tableAreaForCellID_(v5, v6, v11 | *&a3->range._topLeft & 0xFFFFFFFF00000000, v7, v8);
  bottomRight = a3->range._bottomRight;
...
- (id)subregionForRange:(id)a3
{
  ...
  v12 = objc_msgSend_p_subregionForRange_rangeContext_(self, v10, v4, v9, v11);
...
- (TSTCSENodeData)recordHashesForSubexpressions:(id)a3
{
  ...
  objc_msgSend_recordExpression_data_(v4, v19, self, v18, 1);
  v20 = v18;
  v21 = 1;
  result.var1 = v21;
  result.var0 = v20;
...
- (BOOL)isEqualToExpressionNode:(id)a3
{
  ...
  else
  {
    ...
    if ([(TSTExpressionNode *)&v21 isEqualToExpressionNode:v4])
    {
      v5 = v4;
...
- (id)referenceAsStringWithContext:(id)a3
{
  ...
  if (objc_msgSend_isCategoryRef(self, v9, v10, v11, v12))
  {
    ...
    v48 = objc_msgSend_prettyStringForCategoryRef_forHostCellRef_namingContext_(v46, v47, v33, &self->_hostCellRef, v4);
LABEL_23:
  ...
  if (v33)
  {
    ...
    objc_msgSend_setHostTableUID_(v4, v88, v87, v88, v89);
    isRangeWithFunction = objc_msgSend_isRangeWithFunction(self, v90, v91, v92, v93);
    objc_msgSend_setSuppressIdenticalEndReference_(v4, v95, isRangeWithFunction, v96, v97);
    objc_msgSend_setAllowSpanningColumnReferenceBodyQualifier_(v4, v98, 1, v99, v100);
    v48 = objc_opt_new();
    v161[0] = 0;
    v161[1] = v161;
    v161[2] = 0x2020000000;
    ...
    {
      if (objc_msgSend_useSymbolicNames(v4, v132, v133, v134, v135) && objc_msgSend_isRectangularRange(v114, v136, v137, v138, v139))
      {
        v141 = objc_msgSend_isAPivotTable(v33, v136, v140, v138, v139) ^ 1;
        objc_msgSend_setUseSymbolicNames_(v4, v142, v141, v143, v144);
      }

      else
      {
        objc_msgSend_setUseSymbolicNames_(v4, v136, 0, v138, v139);
      }
...
- (void)insertFormulaText:(id)a3 printingOptions:(unsigned int)a4
{
  ...
  if (v4)
  {
    ...
    if (v31)
    {
      ...
      objc_msgSend_takeText_(v81, v37, v36, v38, v39);
    }
  }
  ...
  if ((v4 & 2) != 0)
  {
    ...
    objc_msgSend_takeText_(v81, v65, v64, v66, v67);
  }
  ...
  else
  {
    ...
    objc_msgSend_insertUIGraphicalAttachment_(v81, v49, v48, v50, v51);
  }
  ...
  if (v4)
  {
    ...
    if (v72)
    {
      ...
      objc_msgSend_takeText_(v81, v78, v77, v79, v80);
    }
  }
}
  ...
  *(&v70.var3 + 7) = a5;
  ...
  if (a4.row != 0x7FFFFFFF)
  {
    if (v9 != 0x7FFF00000000)
    {
      LOBYTE(v70.var0) = a5;
      v43 = &v70;
      v70.var2 = TSCERelativeCellCoordinate::makeRelativeCellCoordinateFromAbsoluteCoordinates(*&a6, a4, v43, *&a4);
    ...
    v26 = a4.row - row;
    if (objc_msgSend_isLocalReference(self, a2, a3, *&a4, a5))
    {
      v31 = 0;
      v32 = 0;
    }
    ...
    v60 = ((a5 & 1) << 56) | ((a5 & 2) << 47) | v26 | 0x7FFF00000000;
LABEL_28:
    v70.var2 = v60;
    v65 = (&v70.var3 + 7);
LABEL_31:
    TSCEASTRelativeCoordRefElement::appendRelativeCoordRefElement(a3, &v70, &v70.var2, v65, 0, v53);
    return;
  }
  ...
  if (v9 != 0x7FFF00000000)
  {
    ...
    v60 = ((a5 & 2) << 47) | ((a5 & 1) << 56) | (v36 << 32) | 0x7FFFFFFF;
    goto LABEL_28;
  }

  if (objc_msgSend_isValid(self->_uidRectRef, a2, a3, *&a4, a5, a6))
  {
    ...
    {
      TSCEASTRelativeCoordRefElement::appendReferenceErrorWithTractList(a3, LOBYTE(v70.var2), v15, v22, v23, v24);
    }
    ...
    else
    {
      ...
      v70.var1 = v66;
      TSCEASTRelativeCoordRefElement::appendReferenceErrorWithTractList(a3, &v70, LOBYTE(v70.var2), v15, v67, v68);
    }
  }
  ...
  else
  {
    ...
    TSCEASTRelativeCoordRefElement::appendReferenceError(a3, v10, v11, v12, v13, v14);
  }
}
...
{
  v184 = a4;
  v8 = objc_msgSend_children(self, a2, a3, *&a4, a5);
  ...
  {
    v33 = objc_msgSend_p_convertCategoryRefToRelativeForHostCell_(self, v29, *&a4, v31, v32);
    categoryRef = self->_categoryRef;
    self->_categoryRef = v33;

    v36 = self->_categoryRef;

    TSCEASTCategoryRefElement::appendCategoryRefElement(a3, v36, v35);
    return;
  }
    ...
    if (objc_msgSend_isValid(v59, v60, v61, v62, v63))
    {
      *&v183[0]._flags = 0;
      ...
      if (v95 != 1 || (objc_msgSend_bottomRight(v59, v96, v97, v98, v99) & 0x101FFFFFFFFFFFFLL) != 0 || (objc_msgSend_spansAllRows(v59, v96, v97, v98, v99) & 1) != 0 || (objc_msgSend_spansAllColumns(v59, v96, v97, v98, v99) & 1) != 0)
      {
        ...
        v182 = v100;
        TSCEASTViewTractRefElement::appendViewTractRefElement(a3, &v181, &v183[1], v183, v73, 255, 255, 0xFFFF);
      }
      ...
      else
      {
        ...
        TSCEASTViewTractRefElement::appendViewTractRefElement(a3, v176, v180);
      }
...
LABEL_26:
    TSCEASTRelativeCoordRefElement::appendReferenceError(a3, v64, v65, v66, v67, v68);
    goto LABEL_27;
  }
  ...
  if (objc_msgSend_isSingleCellOrSpanningRange(v59, v111, v112, v113, v114) && (v110 & 3) == v110 >> 2)
  {
    ...
    objc_msgSend_p_buildASTNodeArray_forCoord_preserveFlags_hostCell_(self, v120, a3, v119, v110 & 3, a4);
    v73 = objc_msgSend_whitespaceBefore(self, v121, v122, v123, v124);
    TSCEASTWhitespaceElement::appendWhitespaceElement(a3, 31, v73);
  }
  ...
  else
  {
    if (v59 && objc_msgSend_isValid(v59, v115, v116, v117, v118))
    {
      ...
      v73 = objc_msgSend_initWithAbsoluteTractRef_hostCell_(v125, v126, v59, &v184, v127);
      ...
      TSCEASTColonTractElement::appendColonTractElement(a3, v73, 0, v139);
      goto LABEL_25;
    }
    ...
    TSCEASTRelativeCoordRefElement::appendReferenceErrorWithTractList(a3, v181, v73, v156, v157, v158);
  }
...
LABEL_27:
  ...
  {
    TSCEASTTagOnlyElement::appendTagOnlyElement(a3, 70, v164, v165, v166);
  }

  v167 = objc_msgSend_whitespaceAfter(self, v163, v164, v165, v166);
  TSCEASTWhitespaceElement::appendWhitespaceElement(a3, 32, v167);
}
...
- (void)loadFromUnarchiver:(id)a3
{
  ...
  v7 = objc_msgSend_messageWithDescriptor_(v10, v4, off_2812E4498[224], v5, v6);
...
- (void)saveToArchiver:(id)a3
{
  v9 = a3;
  google::protobuf::internal::AssignDescriptors();
  v6 = objc_msgSend_messageWithNewFunction_descriptor_(v9, v4, sub_2212DF6B0, off_2812E4498[224], v5);
...
- (void)loadFromArchive:(const void *)a3 unarchiver:(id)a4
{
  ...
  [(TSTExpressionNode *)&v81 loadFromArchive:v7 unarchiver:v6];
  v11 = *(a3 + 24);
  v12 = *(a3 + 4);
  if ((v12 & 0x80) != 0)
  {
...
LABEL_48:
    ...
    TSCERangeRefFromArchive(*(a3 + 5), &v76[16]);
    v71 = v77;
    v79 = 0u;
    v80 = 0u;
    v78 = 0u;
...
LABEL_49:
  ...
  if ((v61 & 0x400) != 0)
  {
    self->_spillRangeSuffix = *(a3 + 100);
  }

  if ((v61 & 0x100) != 0)
  {
    sub_221269DB8(*(a3 + 11), &v78);
...
- (void)saveToArchive:(void *)a3 archiver:(id)a4
{
  ...
  *(a3 + 4) |= 2u;
  ...
  [(TSTExpressionNode *)&v55 saveToArchive:v7 archiver:v6];
  v54._lower = 0;
  v54._upper = 0;
