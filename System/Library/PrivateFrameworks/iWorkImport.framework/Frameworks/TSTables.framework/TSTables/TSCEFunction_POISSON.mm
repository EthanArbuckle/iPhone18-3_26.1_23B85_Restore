...
+ (id)evaluateForArgsWithContext:(id)context functionSpec:(id)spec arguments:(const void *)arguments
{
  ...
  if (v11)
  {
    v22 = objc_msgSend_raiseErrorOrConvert_(context, v17, v11, v19, v20);
    goto LABEL_20;
  }
  ...
  if (!objc_msgSend_hasUnits(v10, v17, v18, v19, v20))
  {
    v28 = *(*arguments + 8);
    v117 = 0;
    v31 = objc_msgSend_asNumber_functionSpec_argumentIndex_outError_(v28, v35, context, spec, 1, &v117);
    v36 = v117;
    if (v36)
    {
      v11 = v36;
      v22 = objc_msgSend_raiseErrorOrConvert_(context, v37, v36, v39, v40);
      goto LABEL_19;
    }
    ...
    if (objc_msgSend_hasUnits(v31, v41, v42, v43, v44))
    {
      ...
      v22 = objc_msgSend_raiseErrorOrConvert_(context, v53, v52, v54, v55);
...
LABEL_18:
    ...
    v49 = *(*arguments + 16);
    v115 = 0;
    v57 = objc_msgSend_asBoolean_functionSpec_argumentIndex_outError_(v49, v56, context, spec, 2, &v115);
    v11 = v115;
    if (v11)
    {
      v61 = objc_msgSend_raiseErrorOrConvert_(context, v58, v11, v59, v60);
LABEL_11:
      v22 = v61;
      goto LABEL_18;
    }
    ...
    {
      v70 = objc_msgSend_functionName(spec, v62, v63, v64, v65);
      ...
      v76 = objc_msgSend_raiseErrorOrConvert_(context, v78, v72, v79, v80);
    }
    ...
    else
    {
      ...
      if (!TSUDecimal::operator<())
      {
        ...
        if (v57)
        {
          ...
          if (TSUDecimal::operator<=())
          {
            ...
            if (v82 >= 0xF4241)
            {
              v70 = objc_msgSend_functionName(spec, v85, v86, v87, v88);
              v72 = objc_msgSend_numberErrorForFunctionName_(TSCEError, v89, v70, v90, v91);
              v76 = objc_msgSend_raiseErrorOrConvert_(context, v92, v72, v93, v94);
              goto LABEL_17;
            }
        ...
        if (v8)
        {
          objc_msgSend_formatWithContext_(v8, v101, context, v102, v103);
        }
      ...
      v70 = objc_msgSend_functionName(spec, v66, v67, v68, v69);
      ...
      v76 = objc_msgSend_raiseErrorOrConvert_(context, v73, v72, v74, v75);
    }
...
LABEL_17:
  ...
  v28 = objc_msgSend_functionName(spec, v24, v25, v26, v27);
  v31 = objc_msgSend_unitsNotAllowedErrorForFunctionName_argumentNumber_(TSCEError, v29, v28, 1, v30);
  v22 = objc_msgSend_raiseErrorOrConvert_(context, v32, v31, v33, v34);
  v11 = 0;
LABEL_19:
