...
+ (id)evaluateForArgsWithContext:(id)context functionSpec:(id)spec arguments:(const void *)arguments
{
  v8 = **arguments;
  v86 = 0;
  v78 = objc_msgSend_asNumber_functionSpec_argumentIndex_outError_(v8, v9, context, spec, 0, &v86);
  v10 = v86;
  v11 = *(*arguments + 8);
  v85 = v10;
  v13 = objc_msgSend_asNumber_functionSpec_argumentIndex_outError_(v11, v12, context, spec, 1, &v85);
  v14 = v85;

  v15 = *(*arguments + 16);
  v84 = v14;
  v17 = objc_msgSend_asNumber_functionSpec_argumentIndex_outError_(v15, v16, context, spec, 2, &v84);
  v18 = v84;
  ...
  if (!objc_msgSend_dimensionsMatchModuloCurrency_(v78, v19, v13, v20, v21) || (objc_msgSend_dimensionsMatchModuloCurrency_(v78, v23, v17, v24, v25) & 1) == 0)
  {
    ...
    v22 = objc_msgSend_raiseErrorOrConvert_(context, v44, v43, v45, v46);
  ...
  v26 = *(*arguments + 24);
  v83 = 0;
  v28 = objc_msgSend_asBoolean_functionSpec_argumentIndex_outError_(v26, v27, context, spec, 3, &v83);
  v29 = v83;
  if (!v29)
  {
    if ((v28 & 1) != 0 || !objc_msgSend_isDuration(v78, v30, v31, v32, v33))
    {
      v76 = v28;
      v82 = 0;
      v54 = objc_msgSend_subtract_functionSpec_outError_(v78, v30, v13, spec, &v82);
      v55 = v82;
      v81 = v55;
      v77 = v54;
      ...
      if (v18)
      {
        v68 = objc_msgSend_raiseErrorOrConvert_(context, v62, v18, v64, v65);
      }
      ...
      if (v8)
      {
        objc_msgSend_formatWithContext_(v8, v73, context, v74, v75);
      }
    ...
    v22 = objc_msgSend_raiseErrorOrConvert_(context, v51, v40, v52, v53);
LABEL_8:
    v18 = 0;
LABEL_9:
  ...
  v18 = v29;
  v22 = objc_msgSend_raiseErrorOrConvert_(context, v30, v29, v32, v33);
LABEL_10:
