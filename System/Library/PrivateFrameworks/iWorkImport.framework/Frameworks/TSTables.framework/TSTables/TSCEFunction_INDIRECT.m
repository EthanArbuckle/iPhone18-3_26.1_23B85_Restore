...
+ (id)indirectValueWithContext:(id)a3 functionSpec:(id)a4 arguments:(const void *)a5;
@end
...
+ (id)indirectValueWithContext:(id)a3 functionSpec:(id)a4 arguments:(const void *)a5
{
  ...
  v415 = 0;
  v390 = v8;
  v391 = objc_msgSend_asString_functionSpec_argumentIndex_outError_(v8, v9, v7, a4, 0, &v415);
  v10 = v415;
  if (v10)
  {
    v15 = v10;
    v16 = objc_msgSend_raiseErrorOrConvert_(v7, v11, v10, v13, v14);
    goto LABEL_127;
  }
  ...
  if (*(a5 + 1) - *a5 >= 9uLL)
  {
    ...
    {
      v414 = 0;
      v63 = objc_msgSend_asBoolean_functionSpec_argumentIndex_outError_(v17, v22, v7, a4, 1, &v414);
      v64 = v414;
      if (v64)
      {
        v15 = v64;
        v16 = objc_msgSend_raiseErrorOrConvert_(v7, v65, v64, v66, v67);
      ...
      if (v391)
      {
        ...
        if (!v63)
        {
          v102 = objc_msgSend_calcEngine(v7, v11, v12, v13, v14);
          v107 = objc_msgSend_refParser(v102, v103, v104, v105, v106);
          v112 = objc_msgSend_containingCell(v7, v108, v109, v110, v111);
          v117 = objc_msgSend_containingTable(v7, v113, v114, v115, v116);
...
LABEL_34:
      ...
      v16 = objc_msgSend_raiseErrorOrConvert_(v7, v120, v119, v121, v122);
  ...
  v413 = 0;
LABEL_8:
  v23 = objc_msgSend_calcEngine(v7, v11, v12, v13, v14);
  v28 = objc_msgSend_containingTable(v7, v24, v25, v26, v27);
  ...
  v54 = objc_msgSend_calcEngine(v7, v50, v51, v52, v53);
  ...
  do
  {
    for (i = 0; i != v90; ++i)
    {
      ...
      v96 = v95;
      v100 = objc_msgSend_containingTable(v7, v95, v97, v98, v99);
...
LABEL_52:
    ...
    {
      v386 = v83;
      v166 = objc_msgSend_containingCell(v7, v161, v162, v163, v164);
      v167 = *v166;
      v168 = *(v166 + 4);
      ...
      if (!v178 || v167 < v173)
      {
        ...
        v16 = objc_msgSend_raiseErrorOrConvert_(v7, v193, v192, v194, v195);
    ...
    if (v139)
    {
      ...
      while (2)
      {
        for (j = 0; j != v139; ++j)
        {
          ...
          v142 = *(*(&v405 + 1) + 8 * j);
          v143 = objc_msgSend_calcEngine(v7, v135, v136, v137, v138);
...
LABEL_59:
  ...
  if (v73)
  {
    v183 = objc_msgSend_calcEngine(v7, v179, v180, v181, v182);
...
LABEL_65:
  ...
  {
LABEL_88:
    v257 = objc_msgSend_calcEngine(v7, v179, v180, v181, v182);
    v262 = objc_msgSend_containingTable(v7, v258, v259, v260, v261);
    ...
    v284 = objc_msgSend_calcEngine(v7, v280, v281, v282, v283);
...
LABEL_117:
      ...
      if (*&v388 != 0)
      {
        ...
        *&v397[8] = v416;
        ...
        v400 = 0;
        v401 = 0;
        objc_msgSend_addCalculatedPrecedent_(v7, v368, v397, v369, v370);
      }

      v240 = objc_msgSend_invalidReferenceError(TSCEError, v364, v365, v366, v367);
      v16 = objc_msgSend_raiseErrorOrConvert_(v7, v371, v240, v372, v373);
LABEL_120:
      v15 = 0;
      goto LABEL_126;
    }
    ...
    if (v307 == 11)
    {
      v308 = objc_msgSend_calcEngine(v7, v303, v304, v305, v306);
      v307 = objc_msgSend_aggregateTypeForCategoryRef_(v308, v309, v292, v310, v311);

      v302 = v389;
    }

    objc_msgSend_addCalculatedPrecedentForCategoryRef_(v7, v303, v292, v305, v306);
    if (v302)
    {
      ...
      *&v397[8] = v416;
      ...
      v400 = 0;
      v401 = 0;
      objc_msgSend_addCalculatedPrecedent_(v7, v319, v397, v320, v321);
    }
    ...
    if (v307 == 10)
    {
      ...
      if (v322 | v323)
      {
        v395.i64[0] = objc_msgSend_containingRowUid(v7, v323, v324, v325, v326);
        v395.i64[1] = v323;
      }

      v327 = objc_msgSend_calcEngine(v7, v323, v324, v325, v326);
      v16 = v327;
      if (v327)
      {
      ...
      else
      {
        ...
        do
        {
          ...
          *&v397[8] = v348;
          *&v397[16] = v350;
          v352 = objc_msgSend_initWithContext_rangeRef_preserveFlags_(v349, v351, v7, v397, &v394);
...
LABEL_124:
    ...
    if (v330 | *&v331)
    {
      v416.range._topLeft = objc_msgSend_containingRowUid(v7, *&v331, v332, v333, v334);
      v416.range._bottomRight = v331;
    }

    v335 = objc_msgSend_calcEngine(v7, *&v331, v332, v333, v334);
    v340 = objc_msgSend_hidingActionMask(v7, v336, v337, v338, v339);
    v392 = 0;
    if (v335)
    {
      ...
      if (v15)
      {
        v16 = objc_msgSend_raiseErrorOrConvert_(v7, v342, v15, v343, v344);
LABEL_123:
...
LABEL_84:
  ...
  *v397 = v387;
  *&v397[16] = v388;
  v16 = objc_msgSend_initWithContext_rangeRef_preserveFlags_(v218, v219, v7, v397, &v413);
  ...
  *&v397[24] = v388;
  ...
  v400 = 0;
  v401 = 0;
  objc_msgSend_addCalculatedPrecedent_(v7, v223, v397, v224, v225);
  ...
  *&v397[8] = v416;
  ...
  v400 = 0;
  v401 = 0;
  objc_msgSend_addCalculatedPrecedent_(v7, v229, v397, v230, v231);

  v236 = objc_msgSend_calcEngine(v7, v232, v233, v234, v235);
  *v397 = v388;
  ...
  if (v240)
  {
    if (objc_msgSend_isPivotTable(v240, v241, v242, v243, v244))
    {
      ...
      *&v397[8] = v416;
      ...
      v400 = 0;
      v401 = 0;
      objc_msgSend_addCalculatedPrecedent_(v7, v248, v397, v249, v250);
      ...
      *&v397[8] = v416;
      ...
      v400 = 0;
      v401 = 0;
      objc_msgSend_addCalculatedPrecedent_(v7, v254, v397, v255, v256);
    }
...
LABEL_12:
    ...
    if (v12)
    {
      objc_msgSend_formatWithContext_(v12, v18, a3, v20, v21);
      if (v13)
      {
LABEL_8:
        objc_msgSend_formatWithContext_(v13, v18, a3, v20, v21);
LABEL_11:
...
LABEL_13:
  v22 = objc_msgSend_indirectValueWithContext_functionSpec_arguments_(TSCEFunction_INDIRECT, v9, a3, a4, a5, *&v27._tskFormat, *&v27._durationFormat, v28._tskFormat, *&v28._formatType, *&v28._durationFormat, *&v28._numberFormat.decimalPlaces);
