...
+ (id)evaluateForArgsWithContext:(id)a3 functionSpec:(id)a4 arguments:(const void *)a5
{
  ...
  if ((v6 & 0x7FFFFFFF8) == 8)
  {
    v7 = **a5;
    v33 = 0;
    HasError_context_outError = objc_msgSend_valueHasError_context_outError_(v7, v8, 0, a3, &v33);
    v10 = v33;
    if (objc_msgSend_isCircularReferenceError(v10, v11, v12, v13, v14))
    {
      v18 = objc_msgSend_raiseErrorOrConvert_(a3, v15, v10, v16, v17);
    }
  ...
  else
  {
    ...
    v18 = objc_msgSend_raiseErrorOrConvert_(a3, v21, v10, v22, v23);
  }
