...
+ (id)evaluateForArgsWithContext:(id)context functionSpec:(id)spec arguments:(const void *)arguments
{
  ...
  v80 = 0;
  v14 = objc_msgSend_asDate_functionSpec_argumentIndex_outError_(v12, v13, context, spec, 0, &v80);
  v15 = v80;
  if (v15)
  {
    v20 = v15;
  ...
  sub_22114F414(&v82, &v81);
  v79 = 0;
  v33 = objc_msgSend_asDate_functionSpec_argumentIndex_outError_(v31, v32, context, spec, 1, &v79);
  v34 = v79;
  if (!v34)
  {
    ...
    else
    {
      ...
      else
      {
        if (v41)
        {
          objc_msgSend_formatWithContext_(v41, v46, context, v47, v48);
        }
        ...
        sub_22114F414(&v82, &v81);
        v78 = 0;
        v51 = objc_msgSend_asNumber_functionSpec_argumentIndex_outError_(v41, v50, context, spec, 2, &v78);
        v20 = v78;
        v56 = objc_msgSend_trunc(v51, v52, v53, v54, v55);

        if (v20)
        {
          v61 = objc_msgSend_raiseErrorOrConvert_(context, v57, v20, v59, v60);
LABEL_25:
          v21 = v61;
    ...
    if (v20)
    {
      v61 = objc_msgSend_raiseErrorOrConvert_(context, v67, v20, v68, v69);
    }
