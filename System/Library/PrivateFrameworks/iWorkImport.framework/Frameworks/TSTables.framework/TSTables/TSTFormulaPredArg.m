...
- (BOOL)BOOLValue;
- (BOOL)isBoolValueInList:(BOOL)a3;
- (BOOL)isCellValueInList:(id)a3;
- (BOOL)isDateValueInListYear:(int64_t)a3 month:(int64_t)a4 day:(int64_t)a5;
- (BOOL)isDurationValueInList:(double)a3;
- (BOOL)isEqual:(id)a3;
- (BOOL)isEqual:(id)a3 atHostCoord:(TSUModelCellCoord)a4;
- (BOOL)isNumberValueInList:(const TSUDecimal *)a3 locale:(id)a4;
- (BOOL)isStringValueInList:(id)a3;
- (NSArray)dataList;
- (NSDate)date;
- (NSNumber)number;
- (NSString)string;
- (TSCECategoryRef)categoryRef;
- (TSCECellRef)cellRefForHostCoord:(SEL)a3;
- (TSCECrossTableReference)crossTableRef;
- (TSCEFormulaCreator)formulaCreatorForPredArg;
- (TSCEFormulaCreator)formulaCreatorForPredArg0UsingLinkedRef:(BOOL)a3 useColumnRef:(BOOL)a4;
- (TSCENumberValue)duration;
- (TSCEViewTractRef)viewTractRef;
- (TSTFormulaPredArg)init;
- (TSTFormulaPredArg)initWithBaseCellRef:(const void *)a3 preserveFlags:(const TSUPreserveFlags *)a4;
- (TSTFormulaPredArg)initWithBaseCellReference:(id)a3 preserveColumn:(BOOL)a4 preserveRow:(BOOL)a5;
- (TSTFormulaPredArg)initWithBool:(BOOL)a3;
- (TSTFormulaPredArg)initWithCategoryRef:(id)a3;
- (TSTFormulaPredArg)initWithCrossTableRef:(const TSCECrossTableReference *)a3;
- (TSTFormulaPredArg)initWithDataList:(id)a3;
- (TSTFormulaPredArg)initWithDate:(id)a3;
- (TSTFormulaPredArg)initWithDouble:(double)a3;
- (TSTFormulaPredArg)initWithDuration:(double)a3 units:(unsigned __int8)a4;
- (TSTFormulaPredArg)initWithNumber:(id)a3;
- (TSTFormulaPredArg)initWithRelativeCellRef:(const TSCERelativeCellRef *)a3;
- (TSTFormulaPredArg)initWithString:(id)a3;
- (TSTFormulaPredArg)initWithTableUID:(const TSKUIDStruct *)a3 uidTractList:(id)a4;
- (TSTFormulaPredArg)initWithViewTractRef:(id)a3;
...
- (id)initAsBadRefWithTableUID:(const TSKUIDStruct *)a3 uidTractList:(id)a4;
- (id)initFromArchive:(const void *)a3;
- (id)rewriteWithContext:(TSCEFormulaRewriteContext *)a3 forArgAt:(int64_t)a4 usingLinkedRef:(BOOL)a5 useColumnRef:(BOOL)a6 hostCellRef:(TSCEUidCellRef *)a7 rewriteBlock:(id)a8;
- (unint64_t)hash;
- (unsigned)durationUnits;
- (void)encodeToArchive:(void *)a3 archiver:(id)a4;
- (void)setBaseCellRef:(const void *)a3;
- (void)setBaseCellRef:(const void *)a3 preserveColumn:(BOOL)a4 preserveRow:(BOOL)a5;
- (void)setBaseCellRef:(const void *)a3 preserveFlags:(const TSUPreserveFlags *)a4;
- (void)setBaseCellReference:(id)a3;
- (void)setBaseCellReference:(id)a3 preserveColumn:(BOOL)a4 preserveRow:(BOOL)a5;
- (void)setBoolValue:(BOOL)a3;
- (void)setDate:(id)a3;
- (void)setDurationUnits:(unsigned __int8)a3;
- (void)setDurationValue:(double)a3;
- (void)setNumber:(id)a3;
- (void)setNumberValue:(double)a3;
- (void)setPreserveFlags:(TSUPreserveFlags)a3;
- (void)setRelativeCellRef:(const TSCERelativeCellRef *)a3;
  ...
  if (v9 <= 8)
  {
    if ((v9 - 1) < 3 || (v9 - 5) < 2)
    {
      if (*(a3 + 16))
      {
        ...
        if (*(a3 + 6))
        {
          v14 = objc_msgSend_initFromArchive_(v10, v11, *(a3 + 6), v12, v13);
        }
    ...
    if ((v24 & 0x200) != 0)
    {
      v4->_preserveFlags._flags = v4->_preserveFlags._flags & 0xFE | *(a3 + 109);
      if ((v24 & 0x100) == 0)
      {
LABEL_27:
        if ((v24 & 4) == 0)
...
LABEL_54:
        ...
        if ((v44 & 0x20) != 0)
        {
          v8->_hostCellCoord = sub_2212697C0(*(a3 + 11));
        }
...
LABEL_50:
      ...
      if (*(a3 + 10))
      {
        v42 = objc_msgSend_initWithArchive_(v38, v39, *(a3 + 10), v40, v41);
      }
  ...
  if (v9 > 10)
  {
    if (v9 == 11)
    {
      ...
      if (v26 >= 1)
      {
        ...
        do
        {
          ...
          v36 = objc_msgSend_initFromArchive_(v29, v30, *(*(a3 + 5) + v28), v31, v32);
          if (v36)
          {
    ...
    if (v9 != 12)
    {
      if (v9 == 13 && (*(a3 + 16) & 0x40) != 0)
      {
        v16 = sub_22126A4CC(*(a3 + 12), v5);
  ...
  if (type <= 8)
  {
    ...
    else
    {
      ...
      *(a3 + 4) |= 1u;
      ...
      objc_msgSend_encodeToArchive_archiver_(data, v6, v17, v9, v8);
    }
...
LABEL_80:
    ...
    while (1)
    {
      ...
      *(a3 + 8) = v54 + 1;
      objc_msgSend_encodeToArchive_archiver_(v52, v47, *&v53[2 * v54 + 2], v9, v48, v61);
LABEL_90:
      if (v49 == ++v51)
      {
...
LABEL_88:
    ...
    *v53 = v55 + 1;
    v56 = google::protobuf::Arena::CreateMaybeMessage<TST::FormulaPredArgDataArchive>(*(a3 + 3));
    v57 = *(a3 + 8);
    v58 = *(a3 + 5) + 8 * v57;
    *(a3 + 8) = v57 + 1;
    *(v58 + 8) = v56;
    objc_msgSend_encodeToArchive_archiver_(v52, v59, v56, v9, v60, v61);
    goto LABEL_90;
  }
...
- (TSTFormulaPredArg)initWithBool:(BOOL)a3
{
  ...
  if (v4)
  {
    ...
    v10 = objc_msgSend_initWithBool_(v6, v7, v3, v8, v9);
    data = v5->_data;
    v5->_data = v10;
...
- (void)setBoolValue:(BOOL)a3
{
  ...
  v24 = objc_msgSend_initWithBool_(v20, v21, v5, v22, v23);
  data = self->_data;
  self->_data = v24;
...
- (TSTFormulaPredArg)initWithDouble:(double)a3
{
  v7 = objc_msgSend_numberWithDouble_(MEMORY[0x277CCABB0], a2, v3, v4, v5, a3);
...
- (TSTFormulaPredArg)initWithNumber:(id)a3
{
  ...
  if (v5)
  {
    ...
    v11 = objc_msgSend_initWithNumber_(v7, v8, v4, v9, v10);
    data = v6->_data;
    v6->_data = v11;
...
- (void)setNumber:(id)a3
{
  ...
  v23 = objc_msgSend_initWithNumber_(v19, v20, v25, v21, v22);
  data = self->_data;
  self->_data = v23;
...
- (void)setNumberValue:(double)a3
{
  v10 = objc_msgSend_numberWithDouble_(MEMORY[0x277CCABB0], a2, v3, v4, v5, a3);
...
- (TSTFormulaPredArg)initWithDate:(id)a3
{
  ...
  if (v5)
  {
    v5->_type = 2;
    v7 = [TSTFormulaPredArgData alloc];
    v11 = objc_msgSend_initWithDate_(v7, v8, v4, v9, v10);
    data = v6->_data;
    v6->_data = v11;
...
- (void)setDate:(id)a3
{
  ...
  v19 = [TSTFormulaPredArgData alloc];
  v23 = objc_msgSend_initWithDate_(v19, v20, v25, v21, v22);
  data = self->_data;
  self->_data = v23;
...
- (TSTFormulaPredArg)initWithString:(id)a3
{
  ...
  if (v5)
  {
    v5->_type = 3;
    v7 = [TSTFormulaPredArgData alloc];
    v11 = objc_msgSend_initWithString_(v7, v8, v4, v9, v10);
    data = v6->_data;
    v6->_data = v11;
...
- (void)setString:(id)a3
{
  ...
  v20 = [TSTFormulaPredArgData alloc];
  v24 = objc_msgSend_initWithString_(v20, v21, v26, v22, v23);
  data = self->_data;
  self->_data = v24;
...
- (TSTFormulaPredArg)initWithDataList:(id)a3
{
  ...
  if (v5)
  {
    ...
    v18 = objc_msgSend_count(v4, v14, v15, v16, v17);
...
{
  v4 = a3;
  v9 = objc_msgSend_lowercaseString(v4, v5, v6, v7, v8);
  ...
  if (v14)
  {
    ...
    while (2)
    {
      for (i = 0; i != v14; ++i)
      {
        ...
        v17 = *(*(&v20 + 1) + 8 * i);
        if (objc_msgSend_dataType(v17, v10, v11, v12, v13, v20) == 2 && objc_msgSend_day(v17, v10, v11, v12, v13) == a5 && objc_msgSend_year(v17, v10, v11, v12, v13) == a3 && objc_msgSend_month(v17, v10, v11, v12, v13) == a4)
        {
          v18 = 1;
          goto LABEL_14;
        }
    ...
    while (2)
    {
      for (i = 0; i != v15; ++i)
      {
        ...
        if (objc_msgSend_dataType(v18, v11, v12, v13, v14, v25) == 1)
        {
          ...
          if (objc_msgSend_isEqualViaFormattingAsDouble::(v6, v19, v20, v21, v22, v8, v23))
          {
            LOBYTE(v15) = 1;
            goto LABEL_12;
          }
  ...
  if (v10)
  {
    ...
    while (2)
    {
      for (i = 0; i != v10; ++i)
      {
        ...
        v13 = *(*(&v16 + 1) + 8 * i);
        if (objc_msgSend_dataType(v13, v6, v7, v8, v9, v16) == 6 && objc_msgSend_BOOLValue(v13, v6, v7, v8, v9) == v3)
        {
          v14 = 1;
          goto LABEL_12;
        }
...
- (BOOL)isCellValueInList:(id)a3
{
  ...
  if ((isStringValueInList & 1) == 0)
  {
    ...
    if (v19 > 5)
    {
      ...
      {
        case 6:
          v39 = objc_msgSend_BOOLValue(v4, v20, v21, v22, v23);
          isBoolValueInList = objc_msgSend_isBoolValueInList_(self, v40, v39, v41, v42);
          break;
        case 7:
          objc_msgSend_durationTimeIntervalValue(v4, v20, v21, v22, v23);
    ...
    if (v19 != 2)
    {
      ...
      v24 = objc_msgSend_dateValue(v4, v20, v21, v22, v23);
...
LABEL_11:
    v51[0] = objc_msgSend_underlyingDecimalValue(v4, v20, v21, v22, v23);
    v51[1] = v33;
    v24 = objc_msgSend_locale(v4, v33, v34, v35, v36);
...
- (TSTFormulaPredArg)initWithRelativeCellRef:(const TSCERelativeCellRef *)a3
{
  ...
  {
    v4->_type = 4;
    objc_msgSend_setRelativeCellRef_(v4, v5, a3, v6, v7);
...
- (void)setRelativeCellRef:(const TSCERelativeCellRef *)a3
{
  ...
  v19 = *&a3->relativeCoord._row;
  *(&self->_relativeCellRef.tableUID + 1) = *(&a3->tableUID + 1);
...
- (TSTFormulaPredArg)initWithCategoryRef:(id)a3
{
  ...
  if (v5)
  {
    objc_msgSend_setCategoryRef_(v5, v6, v4, v7, v8);
  }
...
- (TSTFormulaPredArg)initWithViewTractRef:(id)a3
{
  ...
  if (v5)
  {
    objc_msgSend_setViewTractRef_(v5, v6, v4, v7, v8);
  }
...
- (id)initAsBadRefWithTableUID:(const TSKUIDStruct *)a3 uidTractList:(id)a4
{
  result = objc_msgSend_initWithTableUID_uidTractList_(self, a2, a3, a4, v4);
  if (result)
  {
    *(result + 113) = 9;
  }
...
- (TSTFormulaPredArg)initWithTableUID:(const TSKUIDStruct *)a3 uidTractList:(id)a4
{
  ...
  if (v7)
  {
    v7->_relativeCellRef.tableUID = *a3;
    v7->_type = 12;
    v13 = objc_msgSend_copy(v6, v8, v9, v10, v11);
    uidTractList = v12->_uidTractList;
    v12->_uidTractList = v13;

    v12->_preserveFlags._flags = objc_msgSend_preserveFlags(v6, v15, v16, v17, v18);
...
- (TSTFormulaPredArg)initWithBaseCellRef:(const void *)a3 preserveFlags:(const TSUPreserveFlags *)a4
{
  ...
  {
    v7 = *a3;
    result->_baseCellRef._ref._tableUID._upper = *(a3 + 2);
    *&result->_baseCellRef._ref.coordinate.row = v7;
    result->_type = 4;
    result->_preserveFlags = a4->_flags;
    result->_hostCellCoord = 0x7FFF7FFFFFFFLL;
  }
...
- (TSCECellRef)cellRefForHostCoord:(SEL)a3
{
  ...
  if (type != 4 && type != 9)
  {
    ...
    v12 = objc_msgSend_stringWithUTF8String_(MEMORY[0x277CCACA8], a3, "[TSTFormulaPredArg cellRefForHostCoord:]", v4, v5);
  ...
  {
    result = objc_msgSend_baseCellRef(self, a3, *&a4, v4, v5);
...
- (id)convertToRelativeRefIfPossible
{
  v2 = self;
  v3 = v2;
  if (v2->_type == 4 && !v2->_hasRelativeCellRef)
  {
...
- (void)setBaseCellRef:(const void *)a3
{
  ...
  v19 = *a3;
  self->_baseCellRef._ref._tableUID._upper = *(a3 + 2);
...
- (void)setBaseCellRef:(const void *)a3 preserveFlags:(const TSUPreserveFlags *)a4
{
  objc_msgSend_setBaseCellRef_(self, a2, a3, a4, v4);
  flags = a4->_flags;
...
- (void)setBaseCellRef:(const void *)a3 preserveColumn:(BOOL)a4 preserveRow:(BOOL)a5
{
  v5 = a5;
  v6 = a4;
  objc_msgSend_setBaseCellRef_(self, a2, a3, a4, a5);
  v11 = 2;
  if (!v5)
  {
    v11 = 0;
  ...
  objc_msgSend_setPreserveFlags_(self, v8, v11 | v6, v9, v10);
}

- (TSTFormulaPredArg)initWithBaseCellReference:(id)a3 preserveColumn:(BOOL)a4 preserveRow:(BOOL)a5
{
  v5 = a5;
  TSCECellRef::TSCECellRef(&v13, a3);
  v14 = v13;
  if (v5)
  {
    v10 = 2;
...
- (void)setBaseCellReference:(id)a3
{
  ...
  if (v4)
  {
    objc_msgSend_cellRef(v4, v5, v6, v7, v8);
  }
...
- (void)setBaseCellReference:(id)a3 preserveColumn:(BOOL)a4 preserveRow:(BOOL)a5
{
  ...
  if (v8)
  {
    objc_msgSend_cellRef(v8, v9, v10, v11, v12);
  }
...
- (TSTFormulaPredArg)initWithDuration:(double)a3 units:(unsigned __int8)a4
{
  ...
  if (v6)
  {
    ...
    v12 = objc_msgSend_initWithDuration_units_(v8, v9, v4, v10, v11, a3);
    data = v7->_data;
    v7->_data = v12;
  }
...
- (void)setDurationValue:(double)a3
{
  ...
  v32 = objc_msgSend_initWithDuration_units_(v23, v29, v28, v30, v31, a3);
  data = self->_data;
  self->_data = v32;
...
- (void)setDurationUnits:(unsigned __int8)a3
{
  ...
  v31 = objc_msgSend_initWithDuration_units_(v23, v28, v5, v29, v30);
  data = self->_data;
  self->_data = v31;
...
LABEL_40:
  ...
  if (self->_type > 2u)
  {
    if (type != 3)
    {
      if (type == 4)
      {
        hasRelativeCellRef = objc_msgSend_hasRelativeCellRef(self, a2, a3, v3, v4);
...
LABEL_9:
      ...
      objc_msgSend_cellRefForHostCoord_(self, v22, *&a4, v24, v25);
      objc_msgSend_cellRefForHostCoord_(v11, v34, *&a4, v35, v36);
...
- (id)rewriteWithContext:(TSCEFormulaRewriteContext *)a3 forArgAt:(int64_t)a4 usingLinkedRef:(BOOL)a5 useColumnRef:(BOOL)a6 hostCellRef:(TSCEUidCellRef *)a7 rewriteBlock:(id)a8
{
  ...
  v14 = a8;
  v15 = self;
  if (objc_msgSend_needsFormulaRewriting(v15, v16, v17, v18, v19))
  {
    TSCEFormulaCreationMagic::nop(v20, v21, v22, v23, &v99);
    if (a4)
    {
      objc_msgSend_formulaCreatorForPredArg(v15, v24, v25, v26, v27);
    }

    else
    {
      objc_msgSend_formulaCreatorForPredArg0UsingLinkedRef_useColumnRef_(v15, v24, v10, v9, v27);
    }

    TSCEFormulaCreator::operator=(&v99.var0, v93, v28, v29, v30);

    v36 = objc_msgSend_type(v15, v32, v33, v34, v35) == 12;
    ...
    if ((objc_msgSend_translationFlags(v41, v42, v43, v44, v45) & 0x20) != 0 && *&a7->_columnUid != 0)
    {
      p_rowUid = &a7->_rowUid;
      if (*&a7->_rowUid != 0)
      {
        v48 = objc_msgSend_copyBySettingHostTableUID_hostColumnUID_hostRowUID_(v41, v46, &a7->_tableUid, a7, p_rowUid);

        v41 = v48;
      }
    }

    v49 = objc_msgSend_copyByRewritingWithContext_rewriteBlock_(v41, v46, a3, v14, p_rowUid);
    ...
    sub_2212C3620(v93, v58, a3, 0, -1, -1);
...
- (TSCEFormulaCreator)formulaCreatorForPredArg0UsingLinkedRef:(BOOL)a3 useColumnRef:(BOOL)a4
{
  ...
  if (type > 0xC || ((1 << type) & 0x1210) == 0)
  {
    ...
    v13 = objc_msgSend_stringWithUTF8String_(MEMORY[0x277CCACA8], a2, "[TSTFormulaPredArg formulaCreatorForPredArg0UsingLinkedRef:useColumnRef:]", a4, v4);
  ...
  if (type != 12)
  {
    if (type == 9)
    {
      v27 = objc_msgSend_uidRectRef(self, a2, a3, a4, v4);
      v32 = v27;
      if (v27)
      {
      ...
      {
        v52 = objc_msgSend_preserveColumn(self, a2, a3, a4, v4);
    ...
    {
      objc_msgSend_crossTableRef(self, a2, a3, a4, v4);
...
LABEL_40:
    ...
    return TSCEFormulaCreationMagic::nop(a2, a3, a4, v4, v9);
  }
