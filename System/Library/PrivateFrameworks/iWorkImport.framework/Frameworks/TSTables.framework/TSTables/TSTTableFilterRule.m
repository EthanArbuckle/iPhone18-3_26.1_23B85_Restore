...
+ (id)ruleWhereValuesInTable:(id)a3 inBaseColumn:(TSUModelColumnIndex)a4 matchCell:(id)a5;
+ (id)ruleWithFormulaPredicate:(id)a3;
- (BOOL)isEqual:(id)a3;
- (BOOL)matchesCell:(id)a3;
- (BOOL)matchesRow:(unsigned int)a3 withFormulaTableUID:(const TSKUIDStruct *)a4 withCalculationEngine:(id)a5;
- (BOOL)needsFormulaRewriteForImport;
- (TSTTableFilterRule)initWithFormulaPredicate:(id)a3;
- (TSUModelColumnIndex)baseColumnIndexForFilterRuleInTableModel:(id)a3;
- (id)copyByRewritingFromTableModel:(id)a3 toTableModel:(id)a4;
- (id)copyByRewritingToGeometricFormWithTableInfo:(id)a3 containsBadRef:(BOOL *)a4;
- (id)copyByRewritingToUidFormWithTableInfo:(id)a3;
- (id)copyWithZone:(_NSZone *)a3;
- (id)initFromArchive:(const void *)a3;
- (id)initFromPrePivotArchive:(const void *)a3;
- (id)initRuleWhereValuesInTable:(id)a3 andDataList:(id)a4 inBaseColumn:(TSUModelColumnIndex)a5 matchCell:(id)a6;
- (void)encodeToArchive:(void *)a3 archiver:(id)a4;
- (void)encodeToPrePivotArchive:(void *)a3 archiver:(id)a4;
@end
...
+ (id)ruleWithFormulaPredicate:(id)a3
{
  ...
  v8 = objc_msgSend_initWithFormulaPredicate_(v4, v5, v3, v6, v7);
...
{
  v3 = a3;
  if (objc_msgSend_valueType(v3, v4, v5, v6, v7) == 8)
  {
  ...
  v25 = objc_msgSend_getPredArgDataFromCell_(TSTFormulaPredArgData, v8, v3, v9, v10);
  if (!v25)
  {
...
- (id)initRuleWhereValuesInTable:(id)a3 andDataList:(id)a4 inBaseColumn:(TSUModelColumnIndex)a5 matchCell:(id)a6
{
  ...
  if (v17)
  {
    v18 = objc_msgSend_filteringTableUID(v10, v13, v14, v15, v16);
    v20 = v19;
    v27 = objc_msgSend_filterFormulaContainingCell(TSTHiddenStates, v19, v21, v22, v23);
    if (!v11)
    {
      v28 = objc_msgSend_getPredArgDataFromCell_(TSTTableFilterRule, v24, v12, v25, v26);
      v43[0] = v28;
      v11 = objc_msgSend_arrayWithObjects_count_(MEMORY[0x277CBEA60], v29, v43, 1, v30);
    }

    v31 = [TSTFormulaPredArg alloc];
    v35 = objc_msgSend_initWithDataList_(v31, v32, v11, v33, v34);
...
+ (id)ruleWhereValuesInTable:(id)a3 inBaseColumn:(TSUModelColumnIndex)a4 matchCell:(id)a5
{
  ...
  inited = objc_msgSend_initRuleWhereValuesInTable_andDataList_inBaseColumn_matchCell_(v9, v10, v7, 0, a4._column, v8);
...
- (id)copyWithZone:(_NSZone *)a3
{
  v6 = objc_msgSend_copyWithZone_(self->_predicate, a2, a3, v3, v4);
  v10 = objc_msgSend_allocWithZone_(TSTTableFilterRule, v7, a3, v8, v9);
...
- (id)copyByRewritingToUidFormWithTableInfo:(id)a3
{
  v5 = objc_msgSend_copyToUidFormForHiddenRowsWithTableInfo_(self->_predicate, a2, a3, v3, v4);
...
- (id)copyByRewritingToGeometricFormWithTableInfo:(id)a3 containsBadRef:(BOOL *)a4
{
  v5 = objc_msgSend_copyToGeometricFormForHiddenRowsWithTableInfo_containsBadRef_(self->_predicate, a2, a3, a4, v4);
  v6 = [TSTTableFilterRule alloc];
  v10 = objc_msgSend_initWithFormulaPredicate_(v6, v7, v5, v8, v9);
...
- (id)copyByRewritingFromTableModel:(id)a3 toTableModel:(id)a4
{
  v6 = a3;
  v7 = a4;
  v11 = objc_msgSend_baseColumnIndexForFilterRuleInTableModel_(self, v8, v6, v9, v10);
  v16 = objc_msgSend_columnRowUIDMap(v6, v12, v13, v14, v15);
  v20 = objc_msgSend_columnUIDForColumnIndex_(v16, v17, v11, v18, v19);
  v22 = v21;

  if (v20 | v22 && (objc_msgSend_columnRowUIDMap(v7, v23, v24, v25, v26), v27 = objc_claimAutoreleasedReturnValue(), v30 = objc_msgSend_columnIndexForColumnUID_(v27, v28, v20, v22, v29), v27, v30 != 0x7FFF))
  {
...
- (BOOL)matchesRow:(unsigned int)a3 withFormulaTableUID:(const TSKUIDStruct *)a4 withCalculationEngine:(id)a5
{
  ...
  LOBYTE(a4) = objc_msgSend_evaluateAtCellID_onOwnerUID_calcEngine_(predicate, v14, v13, a4, v8);
...
- (TSUModelColumnIndex)baseColumnIndexForFilterRuleInTableModel:(id)a3
{
  ...
  v18 = objc_msgSend_calcEngine(v4, v10, v11, v12, v13);
  if (!v18)
  {
    v19 = objc_msgSend_tableInfo(v4, v14, v15, v16, v17);
  ...
  if (v18 && v29)
  {
    ...
    v61 = objc_msgSend_tableUID(v4, v41, v42, v43, v44);
    v62 = v45;
...
- (BOOL)matchesCell:(id)a3
{
  ...
  if ((objc_msgSend_predicateType(self->_predicate, v5, v6, v7, v8) - 55) >= 0xFEu)
  {
    ...
    v28 = objc_msgSend_getPredArgDataFromCell_(TSTFormulaPredArgData, v14, v4, v15, v16);
...
- (void)encodeToPrePivotArchive:(void *)a3 archiver:(id)a4
{
  ...
  *(a3 + 4) |= 1u;
  ...
  objc_msgSend_encodeToPrePivotArchive_archiver_(predicate, v6, v9, v6, v7);
  *(a3 + 4) |= 2u;
  *(a3 + 32) = 0;
}
...
- (id)initFromPrePivotArchive:(const void *)a3
{
  ...
  if (v4 && ((v5 = [TSTFormulaPredicate alloc], *(a3 + 3)) ? (v9 = objc_msgSend_initFromPrePivotArchive_(v5, v6, *(a3 + 3), v7, v8)) : (v9 = objc_msgSend_initFromPrePivotArchive_(v5, v6, &TST::_FormulaPredicatePrePivotArchive_default_instance_, v7, v8)), predicate = v4->_predicate, v4->_predicate = v9, predicate, !v4->_predicate))
  {
    v11 = 0;
  }
...
- (void)encodeToArchive:(void *)a3 archiver:(id)a4
{
  ...
  *(a3 + 4) |= 1u;
  ...
  objc_msgSend_encodeToArchive_archiver_(predicate, v6, v9, v6, v7);
}
...
- (id)initFromArchive:(const void *)a3
{
  ...
  v13.super_class = TSTTableFilterRule;
  v4 = [(TSTTableFilterRule *)&v13 init];
  if (v4 && ((v5 = [TSTFormulaPredicate alloc], *(a3 + 3)) ? (v9 = objc_msgSend_initFromArchive_(v5, v6, *(a3 + 3), v7, v8)) : (v9 = objc_msgSend_initFromArchive_(v5, v6, &TST::_FormulaPredicateArchive_default_instance_, v7, v8)), predicate = v4->_predicate, v4->_predicate = v9, predicate, !v4->_predicate))
  {
    v11 = 0;
  }
