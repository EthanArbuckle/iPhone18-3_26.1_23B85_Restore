...
+ (id)evaluateForArgsWithContext:(id)a3 functionSpec:(id)a4 arguments:(const void *)a5
{
  v8 = **a5;
  v115[0] = 0;
  v10 = objc_msgSend_asNumber_functionSpec_argumentIndex_outError_(v8, v9, a3, a4, 0, v115);
  v11 = v115[0];
  ...
  v22 = *(*a5 + 8);
  v114 = 0;
  v24 = objc_msgSend_asNumber_functionSpec_argumentIndex_outError_(v22, v23, a3, a4, 1, &v114);
  v11 = v114;
  ...
  if (!v11)
  {
    ...
    v34 = *(*a5 + 16);
    v113 = 0;
    v36 = objc_msgSend_asNumber_functionSpec_argumentIndex_outError_(v34, v35, a3, a4, 2, &v113);
    v11 = v113;
    objc_msgSend_doubleRepresentation(v36, v37, v38, v39, v40);
    if (v11)
    {
      v20 = objc_msgSend_raiseErrorOrConvert_(a3, v41, v11, v43, v44);
LABEL_34:
    ...
    v46 = v45;
    if (*(a5 + 1) - *a5 < 0x19uLL || (objc_msgSend_isTokenOrEmptyArg(*(*a5 + 24), v41, v42, v43, v44) & 1) != 0)
    {
      v47 = 0.0;
      if (v21 < 0.0)
      {
        v48 = objc_msgSend_functionName(a4, v41, v42, v43, v44);
        ...
        v54 = objc_msgSend_raiseErrorOrConvert_(a3, v51, v50, v52, v53);
        goto LABEL_32;
      }
    ...
    v112 = 0;
    v107 = v55;
    v57 = objc_msgSend_asNumber_functionSpec_argumentIndex_outError_(v55, v56, a3, a4, 3, &v112);
    v11 = v112;
    v105 = v57;
    v58 = v57;
    v34 = v108;
    ...
    if (v11)
    {
      v20 = objc_msgSend_raiseErrorOrConvert_(a3, v63, v11, v65, v66);
    }
...
LABEL_17:
        if (*(a5 + 1) - *a5 < 0x21uLL || (objc_msgSend_isTokenOrEmptyArg(*(*a5 + 32), v41, v42, v43, v44) & 1) != 0)
        {
          v74 = 1.0;
          if (v21 > 1.0)
          {
            ...
            v54 = objc_msgSend_raiseErrorOrConvert_(a3, v76, v50, v77, v78);
            goto LABEL_32;
          }
        ...
        v111 = 0;
        v107 = v79;
        v81 = objc_msgSend_asNumber_functionSpec_argumentIndex_outError_(v79, v80, a3, a4, 4, &v111);
        v11 = v111;
        objc_msgSend_doubleRepresentation(v81, v82, v83, v84, v85);
        if (v11)
        {
          v20 = objc_msgSend_raiseErrorOrConvert_(a3, v86, v11, v88, v89);
        }
...
LABEL_28:
            if (v47 < v74)
            {
              ...
              if (v8)
              {
                objc_msgSend_formatWithContext_(v8, v97, a3, v98, v99);
              }
            ...
            v54 = objc_msgSend_raiseErrorOrConvert_(a3, v101, v50, v102, v103);
LABEL_32:
            v20 = v54;
...
LABEL_33:
          ...
          v106 = objc_msgSend_functionName(a4, v86, v87, v88, v89);
          ...
          v20 = objc_msgSend_raiseErrorOrConvert_(a3, v93, v92, v94, v95);
        }
...
LABEL_26:
      ...
      v68 = objc_msgSend_functionName(a4, v63, v64, v65, v66);
      ...
      v20 = objc_msgSend_raiseErrorOrConvert_(a3, v71, v70, v72, v73);
    }
