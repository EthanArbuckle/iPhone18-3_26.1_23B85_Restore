...
- (TSCEAggregateGrid)initWithGrids:(const void *)a3;
...
- (TSCEAggregateGrid)initWithGrids:(const void *)a3
{
  ...
  if (v4)
  {
    ...
    if (&v4->_grids != a3)
    {
      sub_22116CF34(&v4->_grids, *a3, *(a3 + 1), (*(a3 + 1) - *a3) >> 3);
    }
...
- (id)deepResolveInPlace:(id)a3
{
  ...
  {
    v7 = *begin;
    v11 = objc_msgSend_deepResolveInPlace_(v7, v8, v4, v9, v10);
...
- (id)valueAtGridCoord:(const TSCEGridCoord *)a3 accessContext:(TSCEGridAccessContext *)a4
{
  ...
  v6 = objc_msgSend_stringWithUTF8String_(MEMORY[0x277CCACA8], a2, "[TSCEAggregateGrid valueAtGridCoord:accessContext:]", a4, v4);
...
- (id)valueAtIndex:(unint64_t)a3 accessContext:(TSCEGridAccessContext *)a4
{
  ...
  if (lastReturnedIndex != 0x7FFFFFFFFFFFFFFFLL && lastReturnedIndex + 1 == a3)
  {
    ...
    {
      v13 = lastReturnedSubindex + 1;
LABEL_23:
      self->_lastReturnedSubindex = v13;
      goto LABEL_24;
    }
    ...
    v21 = objc_msgSend_stringWithUTF8String_(MEMORY[0x277CCACA8], a2, "[TSCEAggregateGrid valueAtIndex:accessContext:]", a4, v4);
    ...
    v35 = objc_msgSend_functionName(a4->var1, v31, v32, v33, v34);
...
LABEL_24:
      self->_lastReturnedIndex = a3;
      v47 = objc_msgSend_valueAtIndex_accessContext_(begin[self->_lastReturnedArgIndex], a2, self->_lastReturnedSubindex, a4, v4);
      goto LABEL_25;
    }
    ...
    v52 = objc_msgSend_stringWithUTF8String_(MEMORY[0x277CCACA8], a2, "[TSCEAggregateGrid valueAtIndex:accessContext:]", a4, v4);
    ...
    v35 = objc_msgSend_functionName(a4->var1, v62, v63, v64, v65);
...
{
  v5 = MEMORY[0x277D81150];
  v6 = objc_msgSend_stringWithUTF8String_(MEMORY[0x277CCACA8], a2, "[TSCEAggregateGrid deepType:outError:]", a4, v4);
  v10 = objc_msgSend_stringWithUTF8String_(MEMORY[0x277CCACA8], v7, "/Library/Caches/com.apple.xbs/Sources/iWorkImport/shared/calculationEngine/TSCEAggregateGrid.mm", v8, v9);
  v11 = objc_opt_class();
