...
+ (id)evaluateForArgsWithContext:(id)a3 functionSpec:(id)a4 arguments:(const void *)a5
{
  v7 = **a5;
  v182[0] = 0;
  v8 = objc_msgSend_asGrid_functionSpec_argumentIndex_applyPreferredFormat_outError_(v7, a2, a3, a4, 0, 1, v182);
  v9 = v182[0];
  v164 = v8;
  if (v9)
  {
...
LABEL_23:
    v172 = 0;
    v173 = 0;
    v51 = objc_msgSend_modeArrayForArray_context_functionSpec_originalArray_outError_(TSCEFunction_MODE, v26, v163, v165, a4, &v173, &v172);
    v33 = v173;
    v89 = v172;
    v161 = v89;
    if (v89)
    {
      v15 = objc_msgSend_raiseErrorOrConvert_(v165, v90, v89, v92, v93);
    }
    ...
    else
    {
      ...
      if (v164)
      {
        objc_msgSend_formatWithContext_(v164, v141, v165, v142, v143);
      }
  ...
  while (1)
  {
    ...
    {
      v51 = objc_msgSend_errorWithContext_(v33, v38, v165, v39, v40);
      v15 = objc_msgSend_raiseErrorOrConvert_(v165, v94, v51, v95, v96);
      goto LABEL_49;
    }

    v41 = objc_msgSend_deepType_(v33, v38, v165, v39, v40);
    ...
    if (v41 == 3)
    {
      ...
      {
        v174 = 0;
        v73 = objc_msgSend_asDate_functionSpec_argumentIndex_outError_(v33, v46, v165, a4, 0, &v174);
        v74 = v174;

        if (v74)
        {
          v15 = objc_msgSend_raiseErrorOrConvert_(v165, v75, v74, v76, v77);
          v161 = v74;
          goto LABEL_51;
        }
...
LABEL_48:
      v51 = objc_msgSend_functionName(a4, v46, v47, v48, v49);
...
LABEL_19:
    ...
    v175 = 0;
    v51 = objc_msgSend_asNumber_functionSpec_argumentIndex_outError_(v33, v46, v165, a4, 0, &v175);
    v55 = v175;
    if (v55)
    {
      v15 = objc_msgSend_raiseErrorOrConvert_(v165, v52, v55, v53, v54);
      v161 = v55;
      goto LABEL_58;
    }
...
LABEL_20:
  ...
  v153 = objc_msgSend_functionName(a4, v56, v57, v58, v59);
  v157 = objc_msgSend_mismatchedUnitsErrorForFunctionName_(TSCEError, v154, v153, v155, v156);
  v161 = 0;
  v15 = objc_msgSend_raiseErrorOrConvert_(v165, v158, v157, v159, v160);
