...
+ (id)evaluateForArgsWithContext:(id)a3 functionSpec:(id)a4 arguments:(const void *)a5
{
  v8 = **a5;
  v61 = 0;
  v10 = objc_msgSend_asDate_functionSpec_argumentIndex_outError_(v8, v9, a3, a4, 0, &v61);
  v11 = v61;
  if (v11)
  {
    v16 = v11;
  ...
  else
  {
    ...
    v23 = *(*a5 + 8);
    v60 = 0;
    v25 = objc_msgSend_asNumber_functionSpec_argumentIndex_outError_(v23, v24, a3, a4, 1, &v60);
    v16 = v60;
    if (v16)
    {
      v17 = objc_msgSend_raiseErrorOrConvert_(a3, v26, v16, v28, v29);
    }
    ...
    else
    {
      ...
      *&v59._formatType = v30;
      ...
      if ((v35 - 1200001) > 0xFFDB60FE)
      {
        ...
        v52 = objc_msgSend_locale(a3, v48, v49, v50, v51);
      ...
      {
        v36 = objc_msgSend_functionName(a4, v31, v32, v33, v34);
        ...
        v17 = objc_msgSend_raiseErrorOrConvert_(a3, v39, v38, v40, v41);
      }
    }
