...
- (BOOL)validatedLoadFromUnarchiver:(id)unarchiver
{
  ...
  v8 = objc_msgSend_messageWithDescriptor_(unarchiverCopy, v5, off_2812E4498[90], v6, v7);
...
- (void)saveToArchiver:(id)archiver
{
  ...
  google::protobuf::internal::AssignDescriptors();
  v7 = objc_msgSend_messageWithNewFunction_descriptor_(archiverCopy, v5, sub_221287BCC, off_2812E4498[90], v6);
...
- (TSTColumnRowUIDMap)initWithContext:(id)context tableUUID:(id)d numberOfRows:(unsigned int)rows numberOfColumns:(unsigned int)columns
{
  ...
  *(&v35 + 1) = v26;
  ...
  v32 = objc_msgSend_initWithContext_columnUIDs_rowUIDs_(self, v27, contextCopy, &v39, &__p, v28);
  if (__p)
  {
    v37 = __p;
    operator delete(__p);
...
- (id)copyWithContext:(id)context
{
  ...
  v17 = objc_msgSend_initWithContext_columnUIDs_rowUIDs_(v5, v16, contextCopy, v10, v15);
...
- (id)mutableIndexesForUIDSet:(id)set isRows:(BOOL)rows notFoundUIDs:(id)ds
{
  ...
  if (rowsCopy)
  {
    objc_msgSend_p_mutableRowIndexesForUIDSet_notFoundUIDs_(self, v9, setCopy, dsCopy, v10);
  }

  else
  {
    objc_msgSend_p_mutableColumnIndexesForUIDSet_notFoundUIDs_(self, v9, setCopy, dsCopy, v10);
  }
  v12 = ;
...
- (id)p_mutableColumnIndexesForUIDSet:(id)set notFoundUIDs:(id)ds
{
  ...
  v8 = dsCopy;
  v15 = v8;
  objc_msgSend_foreachUuid_(setCopy, v9, v14, v10, v11);
...
- (TSKUIDStruct)firstUidFromUIDSet:(id)set isRows:(BOOL)rows
{
  ...
  if (rowsCopy)
  {
    ...
    v24[4] = self;
    v24[5] = &v25;
    objc_msgSend_foreachUuid_(setCopy, v7, v24, v8, v9);
  ...
  else
  {
    ...
    v23[4] = self;
    v23[5] = &v25;
    objc_msgSend_foreachUuid_(setCopy, v7, v23, v8, v9);
...
- (id)mutableColumnIndexesForUIDs:(const void *)ds
{
  v7 = objc_msgSend_indexSet(MEMORY[0x277CCAB58], a2, ds, v3, v4);
  v8 = *(ds + 1) - *ds;
  if (v8)
  {
    v9 = 0;
    ...
    do
    {
      v11 = sub_2210875C4(&self->_columnIndexForUid.__table_.__bucket_list_.__ptr_, (*ds + 16 * v9));
      if (v11)
      {
        if (v10 <= v9 + 1)
        {
...
- (id)mutableRowIndexesForUIDs:(const void *)ds
{
  ...
  if (v8)
  {
    ...
    do
    {
      v11 = sub_2210875C4(&self->_rowIndexForUid.__table_.__bucket_list_.__ptr_, (*ds + 16 * v9));
      if (v11)
      {
        v14 = *(v11 + 8);
        if (v10 <= v9 + 1)
...
- (_NSRange)columnRangeForUIDs:(const void *)ds
{
  ...
  v8 = objc_msgSend_columnIndexForColumnUID_(self, a2, **ds, *(*ds + 8), v3);
  if (v8 != 0x7FFF)
  {
    v11 = v8;
    v13 = *ds;
...
- (_NSRange)rowRangeForUIDs:(const void *)ds
{
  v6 = MEMORY[0x277D81490];
  v7 = *(MEMORY[0x277D81490] + 8);
  v8 = objc_msgSend_rowIndexForRowUID_(self, a2, **ds, *(*ds + 8), v3);
  if (v8 != 0x7FFFFFFF)
  {
    v11 = v8;
    v13 = *ds;
...
- (TSKUIDStructCoord)cellUIDForCellID:(SEL)d
{
  objc_msgSend_columnUIDForColumnIndex_(self, d, a4.column, v4, v5);
...
- (TSUCellCoord)cellIDForCellUID:(TSKUIDStructCoord *)d
{
  ...
  v11 = objc_msgSend_rowIndexForRowUID_(self, v9, d->_row._lower, d->_row._upper, v10);
  if (v8 == 0x7FFF && (d->_column._lower || d->_column._upper))
  {
LABEL_11:
    v8 = 0x7FFFLL;
LABEL_12:
...
- (TSKUIDStructVectorTemplate<TSKUIDStruct>)prunedColumnUIDsFromColumnUIDs:(SEL)ds
{
  ...
  if (*a4 != v6)
  {
    ...
    do
    {
      self = objc_msgSend_columnIndexForColumnUID_(selfCopy, ds, *v5, v5[1], v4);
      if (self != 0x7FFF)
      {
...
- (TSKUIDStructVectorTemplate<TSKUIDStruct>)prunedRowUIDsFromRowUIDs:(SEL)ds
{
  ...
  if (*a4 != v6)
  {
    ...
    do
    {
      self = objc_msgSend_rowIndexForRowUID_(selfCopy, ds, *v5, v5[1], v4);
      if (self != 0x7FFFFFFF)
      {
        sub_221083454(retstr, v5);
      }
...
{
  v7 = 0x7FFF7FFFFFFFLL;
  v8 = objc_msgSend_columnRangeForUIDs_(self, a2, range, v3, v4);
  if (v8 == 0x7FFFFFFFFFFFFFFFLL || (v12 = v8, v13 = v9, v14 = objc_msgSend_rowRangeForUIDs_(self, v9, range + 24, v10, v11), v14 == 0x7FFFFFFFFFFFFFFFLL))
  {
    v17 = 0;
  }
...
- (TSKUIDStructTract)cellUIDRangeForCellRange:(SEL)range
{
  size = a4.size;
  row = a4.origin.row;
  v9 = objc_msgSend_indexSetWithIndexesInRange_(MEMORY[0x277CCAA78], range, a4.origin.column, a4.size.numberOfColumns, v4);
...
- (id)cellRegionForUIDRange:(const void *)range
{
  v7 = objc_msgSend_columnIndexesForUIDs_(self, a2, range, v3, v4);
  v11 = objc_msgSend_rowIndexesForUIDs_(self, v8, range + 24, v9, v10);
...
- (id)cellTractRefForUIDRectRef:(id)ref
{
  ...
  if (refCopy)
  {
    objc_msgSend_uidRange(refCopy, v5, v6, v7, v8);
  }
...
{
  refCopy = ref;
  v9 = objc_msgSend_columns(refCopy, v5, v6, v7, v8);
  v10 = TSUIndexSet::asNSIndexSet(v9);
  v15 = objc_msgSend_rows(refCopy, v11, v12, v13, v14);
  ...
  v28 = objc_msgSend_tableUID(refCopy, v24, v25, v26, v27);
  v33 = objc_msgSend_preserveFlags(refCopy, v29, v30, v31, v32, v28, v29);
...
- (void)removeRowsAtIndexes:(id)indexes
{
  ...
  v30[3] = &unk_27845E958;
  v30[4] = self;
  objc_msgSend_enumerateIndexesInRange_options_usingBlock_(indexesCopy, v14, 0, v13, 0, v30);
  ...
  v29[3] = &unk_27845E1D0;
  v29[4] = self;
  objc_msgSend_enumerateRangesInRange_options_usingBlock_(indexesCopy, v16, 0, v15, 2, v29);
  Index = objc_msgSend_firstIndex(indexesCopy, v17, v18, v19, v20);
  v26 = Index;
  begin = self->_rowUidForIndex.__begin_;
  if (Index < self->_rowUidForIndex.__end_ - begin)
  {
...
- (void)replaceRowsWithUids:(const void *)uids
{
  objc_msgSend_willModify(self, a2, uids, v3, v4);
  ...
  objc_msgSend_insertRowsWithUIDs_atIndex_(self, v11, uids, 0, v12);
...
- (void)replaceColumnsWithUids:(const void *)uids
{
  ...
  objc_msgSend_insertColumnsWithUIDs_atIndex_(self, v11, uids, 0, v12);
...
- (void)insertColumnsWithUIDs:(const void *)ds atIndex:(unsigned __int16)index
{
  if (index == 0x7FFF)
  {
    ...
    v6 = objc_msgSend_stringWithUTF8String_(MEMORY[0x277CCACA8], a2, "[TSTColumnRowUIDMap insertColumnsWithUIDs:atIndex:]", index, v4);
  ...
  {
    indexCopy = index;
    objc_msgSend_willModify(self, a2, ds, index, v4);
...
- (void)insertRowsWithUIDs:(const void *)ds atIndex:(unsigned int)index
{
  ...
  {
    v5 = MEMORY[0x277D81150];
    v6 = objc_msgSend_stringWithUTF8String_(MEMORY[0x277CCACA8], a2, "[TSTColumnRowUIDMap insertRowsWithUIDs:atIndex:]", *&index, v4);
    v10 = objc_msgSend_stringWithUTF8String_(MEMORY[0x277CCACA8], v7, "/Library/Caches/com.apple.xbs/Sources/iWorkImport/shared/tables/TSTColumnRowUIDMap.mm", v8, v9);
  ...
  else
  {
    ...
    for (i = self->_rowUidForIndex.__begin_; indexCopy < (self->_rowUidForIndex.__end_ - i); v24 = indexCopy)
    {
      *(sub_221287990(&self->_rowIndexForUid.__table_.__bucket_list_.__ptr_, &i[v24]._lower) + 8) = indexCopy;
...
- (void)swapRowAtIndex:(unsigned int)index withRowAtIndex:(unsigned int)atIndex
{
  ...
  begin[atIndex] = v13;
  *(sub_221287990(&self->_rowIndexForUid.__table_.__bucket_list_.__ptr_, &self->_rowUidForIndex.__begin_[index]._lower) + 8) = index;
  *(sub_221287990(&self->_rowIndexForUid.__table_.__bucket_list_.__ptr_, &self->_rowUidForIndex.__begin_[atIndex]._lower) + 8) = atIndex;
...
{
  rowsCopy = rows;
  objc_msgSend_willModify(self, a2, map, rows, v4);
  objc_msgSend_incrementVersionCounter(self, v8, v9, v10, v11);
  v16 = *(map + 2);
  if (rowsCopy)
  {
...
- (BOOL)writeCellIDsInCellUIDList:(id)list toVector:(void *)vector prunedCellUIDs:(void *)ds
{
  ...
  *(ds + 1) = *ds;
  v52 = listCopy;
  v13 = objc_msgSend_count(listCopy, v9, v10, v11, v12);
  sub_2211687C4(vector, v13);
...
LABEL_22:
  ...
  v50 = v58 && v58 == HIDWORD(v57) * v57 && (v48 = sub_221286760(**vector, 0x100000001uLL, *(*(vector + 1) - 8)), v48 == v56) && ((v48 ^ v56) & 0x101FFFF00000000) == 0 && v49 == v57;
  if (__p)
  {
    v63 = __p;
    operator delete(__p);
...
- (void)convertCellUIDLookupList:(id)list toCellRangeVector:(void *)vector prunedSummaryCellUIDs:(void *)ds
{
  ...
  if (listCopy)
  {
    v14 = objc_msgSend_UIDLookupList(listCopy, v9, v10, v11, v12);
