...
+ (id)extremumIfs:(id)a3 functionSpec:(id)a4 maxVector:(id)a5 criteria:(id)a6 isMax:(BOOL)a7;
@end
...
+ (id)evaluateForArgsWithContext:(id)a3 functionSpec:(id)a4 arguments:(const void *)a5
{
  ...
  else
  {
    ...
    {
      objc_msgSend_extremumIfs_functionSpec_maxVector_criteria_isMax_(TSCEFunction_MAXIFS, v21, a3, a4, v10, v20, 1);
    }
    v17 = ;
  }
...
+ (id)extremumIfs:(id)a3 functionSpec:(id)a4 maxVector:(id)a5 criteria:(id)a6 isMax:(BOOL)a7
{
  ...
  {
    v151[0] = 0;
    v19 = objc_msgSend_asReference_functionSpec_argumentIndex_outError_(v10, v15, v9, a4, 0, v151);
    v20 = v151[0];
    v29 = objc_msgSend_calcEngine(v9, v21, v22, v23, v24);
    if (v19)
    {
    ...
    if ((IsWithinTable & 1) == 0)
    {
      ...
      v35 = objc_msgSend_raiseErrorOrConvert_(v9, v104, v103, v105, v106);
    ...
    if (v20)
    {
      v35 = objc_msgSend_raiseErrorOrConvert_(v9, v15, v20, v17, v18);
      goto LABEL_57;
    }
  }

  v36 = objc_msgSend_dimensions(v10, v15, v16, v17, v18);
  v37 = 0x27845C000uLL;
  v19 = objc_msgSend_sortCriteriaByCost_(TSCEGridValue, v38, v135, v39, v40);
  v41 = v9;
  *&v145 = v41;
  *(&v145 + 1) = a4;
  *v146 = 0;
...
LABEL_42:
    ...
    if (v132 + 1 == v131)
    {
      if (v53)
      {
        ...
        if (v10)
        {
          objc_msgSend_formatWithContext_(v10, v47, v41, v49, v50);
        }
...
LABEL_10:
  ...
  while (1)
  {
    ...
    v60 = v10;
    v61 = objc_msgSend_valueAtGridCoord_accessContext_(v10, v47, v57, &v145, v50);
...
LABEL_26:
  ...
  if (v65 != 3)
  {
    if (v65 == 5)
    {
      ...
      v143 = v20;
      v74 = objc_msgSend_asNumber_functionSpec_argumentIndex_outError_(v61, v70, v41, a4, 0, &v143);
      v75 = v143;
      ...
      if (v54)
      {
        if ((objc_msgSend_isNil(v74, v76, v77, v78, v79) & 1) == 0)
        {
          ...
          {
            v120 = objc_msgSend_functionName(a4, v83, v84, v85, v86);
          ...
          {
            v120 = objc_msgSend_functionName(a4, v80, v87, v81, v82);
...
LABEL_51:
  ...
  {
    v142 = v20;
    v89 = objc_msgSend_asDate_functionSpec_argumentIndex_outError_(v61, v70, v41, a4, 0, &v142);
    v90 = v142;
  ...
  {
    v141 = v20;
    v91 = objc_msgSend_asDate_functionSpec_argumentIndex_outError_(v61, v70, v41, a4, 0, &v141);
    v75 = v141;
  ...
  {
    v140 = v20;
    v91 = objc_msgSend_asDate_functionSpec_argumentIndex_outError_(v61, v70, v41, a4, 0, &v140);
    v75 = v140;
