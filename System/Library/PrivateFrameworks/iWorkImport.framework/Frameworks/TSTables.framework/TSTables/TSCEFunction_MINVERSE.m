...
+ (id)evaluateForArgsWithContext:(id)a3 functionSpec:(id)a4 arguments:(const void *)a5
{
  v7 = **a5;
  v80 = 0;
  v8 = objc_msgSend_asGrid_functionSpec_argumentIndex_applyPreferredFormat_outError_(v7, a2, a3, a4, 0, 0, &v80);
  v9 = v80;
  if (v9)
  {
    v14 = v9;
...
LABEL_3:
  ...
  if (!(HIDWORD(v17) * v17))
  {
    ...
    v15 = objc_msgSend_raiseErrorOrConvert_(a3, v29, v14, v30, v31);
    goto LABEL_3;
  }

  if (v17 >> 33 > 4 || v17 >= 0xA)
  {
    v14 = objc_msgSend_functionName(a4, v18, v19, v20, v21);
    v32 = objc_msgSend_matrixTooLargeError_(TSCEError, v23, v14, v24, v25);
    v16 = objc_msgSend_raiseErrorOrConvert_(a3, v26, v32, v27, v28);
  }

  else
  {
    v32 = objc_msgSend_asValueGrid_(v8, v18, a3, v20, v21);
    ...
    *(v76 + 7) = 0;
    ...
    {
      v14 = v40;
      v16 = objc_msgSend_raiseErrorOrConvert_(v36, v41, v40, v42, v43);
    }
    ...
    else
    {
      ...
      if (v45)
      {
        ...
        v16 = objc_msgSend_raiseErrorOrConvert_(v36, v50, v14, v52, v53);
      }
