...
+ (int64_t)compareValue:(id)a3 functionSpec:(id)a4 left:(id)a5 right:(id)a6 outError:(id *)a7;
@end
...
+ (int64_t)compareValue:(id)a3 functionSpec:(id)a4 left:(id)a5 right:(id)a6 outError:(id *)a7
{
  ...
  v12 = a5;
  v13 = a6;
  v17 = objc_msgSend_deepType_(v12, v14, v11, v15, v16);
  v21 = objc_msgSend_deepType_(v13, v18, v11, v19, v20);
  if (v17 != v21)
  {
    if (v17 != 10 || v21 != 5)
    {
...
LABEL_33:
  ...
  if (v17 <= 4u)
  {
    ...
    {
      v98 = 0;
      v74 = objc_msgSend_asBoolean_functionSpec_argumentIndex_outError_(v12, v22, v11, a4, 1, &v98);
      v75 = v98;
      v97 = v75;
      v77 = objc_msgSend_asBoolean_functionSpec_argumentIndex_outError_(v13, v76, v11, a4, 0, &v97);
      v54 = v97;
      ...
      {
        v96 = v54;
        v79 = objc_msgSend_asBoolean_functionSpec_argumentIndex_outError_(v12, v78, v11, a4, 1, &v96);
        v80 = v96;
...
LABEL_32:
    ...
    v93 = 0;
    v49 = objc_msgSend_asDate_outError_(v12, v22, v11, &v93, v25);
    v50 = v93;
    v92 = v50;
    v53 = objc_msgSend_asDate_outError_(v13, v51, v11, &v92, v52);
    v54 = v92;
...
LABEL_35:
  ...
  if (v17 == 9)
  {
    objc_msgSend_errorWithContext_(v12, v22, v11, v24, v25);
    *a7 = v58 = 0;
    goto LABEL_38;
  }
  ...
  if (v17 == 7)
  {
    v49 = objc_msgSend_locale(v11, v22, v23, v24, v25);
    v95 = 0;
    v67 = objc_msgSend_asString_outError_(v12, v65, v11, &v95, v66);
    v68 = v95;
    v94 = v68;
    v71 = objc_msgSend_asString_outError_(v13, v69, v11, &v94, v70);
    v54 = v94;
...
LABEL_9:
  v101 = 0;
  v26 = objc_msgSend_asNumber_outError_(v12, v22, v11, &v101, v25);
  v27 = v101;
  v100 = v27;
  v30 = objc_msgSend_asNumber_outError_(v13, v28, v11, &v100, v29);
  v31 = v100;
...
+ (id)evaluateForArgsWithContext:(id)a3 functionSpec:(id)a4 arguments:(const void *)a5
{
  ...
  v13 = v12;
  v21 = objc_msgSend_deepType_(v13, v14, a3, v15, v16);
  v22 = v13;
  if (v21 == 10)
  {
  ...
  v204 = v23;
  v202 = a4;
  v25 = objc_msgSend_asGrid_functionSpec_argumentIndex_applyPreferredFormat_outError_(v23, v24, a3, a4, 1, 1, &v219);
  v26 = v219;
  if (v26)
  {
    v30 = v26;
    v5 = objc_msgSend_raiseErrorOrConvert_(a3, v27, v26, v28, v29);
    goto LABEL_18;
  }

  if (v25)
  {
    objc_msgSend_formatWithContext_(v25, v27, a3, v28, v29);
  }
...
LABEL_17:
  ...
  if (v48 != 1 && (v48 & 0xFFFFFFFF00000000) != 0x100000000)
  {
    ...
    v47 = objc_msgSend_raiseErrorOrConvert_(a3, v53, v43, v54, v55);
    goto LABEL_17;
  }
  ...
  else
  {
    ...
    if ((objc_msgSend_isTokenOrEmptyArg(v57, v58, v59, v60, v61) & 1) == 0)
    {
      if (v57)
      {
        objc_msgSend_formatWithContext_(v57, v62, a3, v63, v64);
      }
      ...
      sub_22114F414(&v220, &v216);
      v218 = 0;
      v5 = objc_msgSend_asNumber_functionSpec_argumentIndex_outError_(v57, v178, a3, a4, 2, &v218);
      v30 = v218;
      v183 = objc_msgSend_trunc(v5, v179, v180, v181, v182);

      if (v30)
      {
        v5 = objc_msgSend_raiseErrorOrConvert_(a3, v184, v30, v186, v187);
    ...
    else
    {
      ...
      if (v65 != -1.0 && v65 != 0.0)
      {
        ...
        v47 = objc_msgSend_raiseErrorOrConvert_(a3, v193, v43, v194, v195);
        goto LABEL_17;
      }
    }
  }
...
LABEL_87:
    ...
    while (1)
    {
      ...
      if (objc_msgSend_isError(v91, v92, v93, v94, v95))
      {
        ...
        {
          v5 = objc_msgSend_raiseErrorOrConvert_(v201, v105, v100, v106, v107);
          v108 = 1;
        }
      ...
      v210 = v86;
      v113 = v86;
      v114 = objc_msgSend_compareValue_functionSpec_left_right_outError_(TSCEFunction_MATCH, v112, v201, v202, v91, v200, &v210);
      v86 = v210;
      ...
      if (v65 == 1.0 && v114 == -1)
      {
        ...
        v209 = 0;
        v121 = objc_msgSend_compareValue_functionSpec_left_right_outError_(TSCEFunction_MATCH, v120, v201, v202, v91, v198, &v209);
        v122 = v209;
        if (!v122)
        {
          if (v121 == -1)
      ...
      if (v65 == -1.0 && v114 == 1)
      {
        ...
        v208 = 0;
        v127 = objc_msgSend_compareValue_functionSpec_left_right_outError_(TSCEFunction_MATCH, v126, v201, v202, v91, v198, &v208);
        v122 = v208;
        if (!v122)
        {
          if (v127 == 1)
...
LABEL_45:
  ...
  if (v86)
  {
    v5 = objc_msgSend_raiseErrorOrConvert_(v201, v132, v86, v133, v134);
...
LABEL_89:
  if (v197)
  {
    ...
    v5 = objc_msgSend_numberWithDecimal_format_(TSCENumberValue, v159, v206, v205, v160);
  }
  ...
  else
  {
    ...
    v172 = objc_msgSend_functionName(v202, v168, v169, v170, v171);
    v174 = objc_msgSend_matchNotFoundErrorForValue_isRegex_functionName_(TSCEError, v173, v167, isRegexString, v172);
    v5 = objc_msgSend_raiseErrorOrConvert_(v201, v175, v174, v176, v177);
