...
+ (id)evaluateForArgsWithContext:(id)a3 functionSpec:(id)a4 arguments:(const void *)a5
{
  ...
  if (*(a5 + 1) != *a5)
  {
    ...
    {
      v83 = 0;
      v13 = objc_msgSend_asReference_functionSpec_argumentIndex_outError_(v7, v12, a3, a4, 0, &v83);
      v18 = v83;
      if (!v18)
      {
        if (v13)
...
LABEL_14:
  objc_msgSend_containingCellRef(a3, a2, a3, a4, a5);
...
LABEL_15:
  ...
  {
    v23 = tableUID;
    if (tableUID != 0uLL && v23 == *objc_msgSend_containingTable(a3, a2, a3, a4, a5))
    {
      v24 = objc_msgSend_calcEngine(a3, a2, a3, a4, a5);
      v81.origin = 0;
      v81.size = 0;
      v80 = 0;
      ...
      v81.origin = v27;
      v81.size = v29;
      v35 = objc_msgSend_calcEngine(a3, v31, v32, v33, v34);
      v44 = objc_msgSend_dependencyTracker(v35, v36, v37, v38, v39);
      if (a3)
      {
        objc_msgSend_containingCellRef(a3, v40, v41, v42, v43);
      }
      ...
      v50 = *objc_msgSend_containingCell(a3, v46, v47, v48, v49);
      if (TSUCellRect::contains(&v81, v50) & HasThisCellPrecedent_precedent)
      {
        ...
        else
        {
          ...
          if (a3)
          {
            objc_msgSend_containingCellRef(a3, v59, v60, v61, v62);
          }
          ...
          if (objc_msgSend_isCircularReferenceError(v19, v63, v64, v65, v66))
          {
            if (a3)
            {
              objc_msgSend_containingCellRef(a3, v67, v68, v69, v70);
            }
            ...
            if ((objc_msgSend_cellIsInACycle_(v24, v67, &v82, v69, v70) & 1) == 0)
            {
              if (a3)
              {
                objc_msgSend_containingCellRef(a3, v71, v72, v73, v74);
              }
  ...
  if (!v19)
  {
    v19 = objc_msgSend_spillFunctionDeleteFormulaError(TSCEError, a2, a3, a4, a5);
  }

  v78 = objc_msgSend_errorValue_(TSCEErrorValue, a2, v19, a4, a5);
