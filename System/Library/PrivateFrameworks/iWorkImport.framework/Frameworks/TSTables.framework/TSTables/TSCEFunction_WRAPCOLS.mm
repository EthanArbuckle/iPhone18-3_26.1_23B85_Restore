...
+ (id)evaluateForArgsWithContext:(id)context functionSpec:(id)spec arguments:(const void *)arguments
{
  ...
  v9 = **arguments;
  v114[0] = 0;
  v11 = objc_msgSend_asGrid_functionSpec_argumentIndex_applyPreferredFormat_outError_(v9, v10, context, spec, 0, 0, v114);
  v16 = v114[0];
  if (v16)
  {
  ...
  if (objc_msgSend_dimensions(v11, v12, v13, v14, v15) >> 32 != 1 && objc_msgSend_dimensions(v11, v18, v19, v20, v21) != 1)
  {
    ...
    v17 = objc_msgSend_raiseErrorOrConvert_(context, v68, v32, v69, v70);
    v16 = 0;
    goto LABEL_38;
  }
  ...
  v26 = *(*arguments + 8);
  v113 = 0;
  v102 = objc_msgSend_asNumber_functionSpec_argumentIndex_outError_(v26, v27, context, spec, 1, &v113);
  v16 = v113;
  if (!v16)
  {
    if (objc_msgSend_integer(v102, v28, v29, v30, v31) <= 0)
    {
      v51 = objc_msgSend_functionName(spec, v33, v34, v35, v36);
    ...
    else
    {
      ...
      v43 = objc_msgSend_functionName(spec, v39, v40, v41, v42);
      ...
      else
      {
        ...
        v26 = v101;
        v32 = v102;
        if ((objc_msgSend_isTokenOrEmptyArg(v56, v57, v58, v59, v60) & 1) == 0 && objc_msgSend_deepType_(v56, v61, context, v62, v63) != 9)
        {
          v64 = v56;
          v65 = v51;
          v51 = v64;
      ...
      v76 = objc_msgSend_raiseErrorOrConvert_(context, v89, v72, v90, v91);
    }
...
LABEL_37:
  ...
  v17 = objc_msgSend_raiseErrorOrConvert_(context, v28, v16, v30, v31);
  v32 = v102;
LABEL_38:
