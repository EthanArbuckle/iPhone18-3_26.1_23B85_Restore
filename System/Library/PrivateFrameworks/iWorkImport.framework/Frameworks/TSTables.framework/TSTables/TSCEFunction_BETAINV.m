...
+ (id)evaluateForArgsWithContext:(id)a3 functionSpec:(id)a4 arguments:(const void *)a5
{
  v8 = **a5;
  v99[0] = 0;
  v10 = objc_msgSend_asNumber_functionSpec_argumentIndex_outError_(v8, v9, a3, a4, 0, v99);
  v11 = v99[0];
  ...
  v98 = 0;
  v92 = v22;
  v24 = objc_msgSend_asNumber_functionSpec_argumentIndex_outError_(v22, v23, a3, a4, 1, &v98);
  v25 = v98;
  objc_msgSend_doubleRepresentation(v24, v26, v27, v28, v29);
  v31 = v30;
  v32 = *(*a5 + 16);
  v97 = v25;
  v34 = objc_msgSend_asNumber_functionSpec_argumentIndex_outError_(v32, v33, a3, a4, 2, &v97);
  v11 = v97;
  ...
  if (!v11)
  {
    ...
    if ((objc_msgSend_isTokenOrEmptyArg(v44, v45, v46, v47, v48) & 1) == 0)
    {
      v91 = v24;
      v96 = 0;
      v51 = objc_msgSend_asNumber_functionSpec_argumentIndex_outError_(v44, v49, a3, a4, 3, &v96);
      v11 = v96;
      v90 = v51;
      v52 = v51;
      v24 = v91;
      ...
      if (v11)
      {
        v20 = objc_msgSend_raiseErrorOrConvert_(a3, v57, v11, v58, v59);
...
LABEL_15:
    ...
    if (*(a5 + 1) - *a5 >= 0x21uLL)
    {
      ...
      {
        v95 = 0;
        v71 = objc_msgSend_asNumber_functionSpec_argumentIndex_outError_(v44, v70, a3, a4, 4, &v95);
        v11 = v95;
        objc_msgSend_doubleRepresentation(v71, v72, v73, v74, v75);
        if (v11)
        {
          v20 = objc_msgSend_raiseErrorOrConvert_(a3, v76, v11, v77, v78);
    ...
    if (v50 >= v65)
    {
      v84 = objc_msgSend_functionName(a4, v61, v62, v63, v64);
      ...
      v20 = objc_msgSend_raiseErrorOrConvert_(a3, v87, v86, v88, v89);
    }
...
LABEL_19:
      ...
      if (v8)
      {
        objc_msgSend_formatWithContext_(v8, v80, a3, v81, v82);
      }
  ...
  v20 = objc_msgSend_raiseErrorOrConvert_(a3, v39, v11, v40, v41);
LABEL_24:
