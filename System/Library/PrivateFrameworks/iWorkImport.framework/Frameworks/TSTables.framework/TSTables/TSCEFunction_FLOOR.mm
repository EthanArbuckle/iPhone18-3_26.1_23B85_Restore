...
+ (id)evaluateForArgsWithContext:(id)context functionSpec:(id)spec arguments:(const void *)arguments
{
  ...
  v9 = *(*arguments + 8);
  v79 = 0;
  v11 = objc_msgSend_asNumber_functionSpec_argumentIndex_outError_(v8, v10, context, spec, 0, &v79);
  v12 = v79;
  if (v12)
  {
    v16 = v12;
  ...
  v78 = 0;
  v18 = objc_msgSend_asNumber_functionSpec_argumentIndex_outError_(v9, v13, context, spec, 1, &v78);
  v16 = v78;
  if (!v16)
  {
    ...
    else
    {
      ...
      v42 = objc_msgSend_functionName(spec, v51, v52, v53, v54);
      v46 = objc_msgSend_argumentEqualsToZeroErrorForFunctionName_argumentNumber_(TSCEError, v55, v42, 2, v56);
      v50 = objc_msgSend_raiseErrorOrConvert_(context, v57, v46, v58, v59);
    }
  ...
  v23 = objc_msgSend_raiseErrorOrConvert_(context, v19, v16, v21, v22);
LABEL_5:
  v17 = v23;
LABEL_18:
