...
- (BOOL)hasHeightForRow:(unsigned int)a3;
- (BOOL)hasWidthForColumn:(unsigned __int16)a3;
- (CGSize)capturedTableSize;
- (TSTLayoutDynamicResizeInfo)initWithDynamicResizeInfo:(id)a3;
- (TSTLayoutDynamicResizeInfo)initWithLayoutEngine:(id)a3;
- (TSTLayoutDynamicResizeInfo)initWithLayoutEngine:(id)a3 columnRegion:(id)a4 rowRegion:(id)a5;
- (double)getColumnInitialWidth:(unsigned __int16)a3;
- (double)getColumnWidth:(unsigned __int16)a3;
- (double)getColumnWidthResize:(unsigned __int16)a3;
- (double)getMinimumColumnWidth:(unsigned __int16)a3;
- (double)getMinimumRowHeight:(unsigned int)a3;
- (double)getRowHeight:(unsigned int)a3;
- (double)getRowHeightResize:(unsigned int)a3;
- (double)getRowInitialHeight:(unsigned int)a3;
...
- (TSTLayoutDynamicResizeInfo)initWithLayoutEngine:(id)a3 columnRegion:(id)a4 rowRegion:(id)a5
{
  ...
  if (v15)
  {
    v15->_tableRowsBehavior = objc_msgSend_tableRowsBehavior(v8, v11, v12, v13, v14);
    objc_msgSend_p_captureRowColumnInformation_columnRegion_rowRegion_(v15, v16, v8, v9, v10);
    v15->_valid = 1;
  }
...
{
  v4 = a3;
  v9 = objc_msgSend_cellRange(v4, v5, v6, v7, v8);
  v12 = objc_msgSend_regionFromRange_(TSTCellRegion, v10, v9, v10, v11);
  v14 = objc_msgSend_initWithLayoutEngine_columnRegion_rowRegion_(self, v13, v4, v12, v12);
...
- (TSTLayoutDynamicResizeInfo)initWithDynamicResizeInfo:(id)a3
{
  ...
  if (v9)
  {
    *(v9 + 152) = objc_msgSend_valid(v4, v5, v6, v7, v8);
    *(v9 + 39) = objc_msgSend_tableRowsBehavior(v4, v10, v11, v12, v13);
    v18 = objc_msgSend_rowRegion(v4, v14, v15, v16, v17);
    v19 = v9[25];
    v9[25] = v18;

    *(v9 + 40) = objc_msgSend_startRowIndex(v4, v20, v21, v22, v23);
    v28 = objc_msgSend_numberOfRows(v4, v24, v25, v26, v27);
    *(v9 + 41) = v28;
    if (v28 && v9 != v4)
    {
      sub_22128026C(v9 + 1, v4[1], v4[2], (v4[2] - v4[1]) >> 3);
      sub_22128026C(v9 + 4, v4[4], v4[5], (v4[5] - v4[4]) >> 3);
      sub_22128026C(v9 + 7, v4[7], v4[8], (v4[8] - v4[7]) >> 3);
    }

    objc_msgSend_capturedRowHeightTotal(v4, v29, v30, v31, v32);
    v9[23] = v33;
    v38 = objc_msgSend_columnRegion(v4, v34, v35, v36, v37);
    v39 = v9[26];
    v9[26] = v38;

    *(v9 + 77) = objc_msgSend_startColumnIndex(v4, v40, v41, v42, v43);
    v48 = objc_msgSend_numberOfColumns(v4, v44, v45, v46, v47);
    *(v9 + 43) = v48;
    if (v48 && v9 != v4)
    {
      sub_22128026C(v9 + 10, v4[10], v4[11], (v4[11] - v4[10]) >> 3);
      sub_22128026C(v9 + 13, v4[13], v4[14], (v4[14] - v4[13]) >> 3);
      sub_22128026C(v9 + 16, v4[16], v4[17], (v4[17] - v4[16]) >> 3);
    }

    objc_msgSend_capturedColumnWidthTotal(v4, v49, v50, v51, v52);
    v9[24] = v53;
  }
...
- (void)p_captureRowColumnInformation:(id)a3 columnRegion:(id)a4 rowRegion:(id)a5
{
  ...
  if (v10)
  {
    objc_storeStrong(&self->_rowRegion, a5);
    self->_startRowIndex = objc_msgSend_boundingCellRange(v10, v53, v54, v55, v56);
    objc_msgSend_boundingCellRange(v10, v57, v58, v59, v60);
    self->_numberOfRows = HIDWORD(v61);
    self->_numberOfResizableRows = objc_msgSend_numberOfIntersectingRows(v10, v61, v62, v63, v64);
    v135 = 0;
    v136 = &v135;
    v137 = 0x4812000000;
    v138 = sub_22141FF04;
    ...
    v113 = 0x2020000000;
    v114 = 0;
    isGrouped = objc_msgSend_isGrouped(v8, v65, v66, v67, v68);
    ...
    v107 = &v115;
    v108 = &v111;
    objc_msgSend_enumerateRowsUsingBlock_(v10, v70, v101, v71, v72);
    v73 = v136;
  ...
  if (v9)
  {
    objc_storeStrong(&self->_columnRegion, a4);
    self->_startColumnIndex = objc_msgSend_boundingCellRange(v9, v74, v75, v76, v77) >> 32;
    objc_msgSend_boundingCellRange(v9, v78, v79, v80, v81);
    self->_numberOfColumns = v82;
    self->_numberOfResizableColumns = objc_msgSend_numberOfIntersectingColumns(v9, v82, v83, v84, v85);
    v135 = 0;
    v136 = &v135;
    v137 = 0x4812000000;
    v138 = sub_22141FF04;
    ...
    v98 = &v115;
    v99 = &v111;
    objc_msgSend_enumerateColumnsUsingBlock_(v9, v88, v92, v89, v90);
    v91 = v136;
...
- (BOOL)hasWidthForColumn:(unsigned __int16)a3
{
  ...
  v4 = a3 >= startColumnIndex;
  v5 = a3 - startColumnIndex;
...
- (double)getRowInitialHeight:(unsigned int)a3
{
  ...
  {
    startRowIndex = self->_startRowIndex;
    if (a3 >= startRowIndex && self->_numberOfRows + startRowIndex > a3)
    {
      return begin[a3 - startRowIndex];
    }
  }
...
- (double)getColumnInitialWidth:(unsigned __int16)a3
{
  ...
  {
    startColumnIndex = self->_startColumnIndex;
    if (startColumnIndex <= a3 && self->_numberOfColumns + startColumnIndex > a3)
    {
      return begin[a3 - startColumnIndex];
    }
  }
...
- (double)getRowHeightResize:(unsigned int)a3
{
  ...
  {
    startRowIndex = self->_startRowIndex;
    if (startRowIndex <= a3 && self->_numberOfRows + startRowIndex > a3 && objc_msgSend_hasHeightForRow_(self, a2, *&a3, v3, v4))
    {
      return self->_currentRowHeights.__begin_[a3 - self->_startRowIndex] - self->_capturedRowHeights.__begin_[a3 - self->_startRowIndex];
    }
  }
...
- (double)getColumnWidthResize:(unsigned __int16)a3
{
  ...
  if (self->_currentColumnWidths.__begin_ != self->_currentColumnWidths.__end_)
  {
    v6 = a3;
    startColumnIndex = self->_startColumnIndex;
    if (startColumnIndex <= a3 && self->_numberOfColumns + startColumnIndex > a3 && objc_msgSend_hasWidthForColumn_(self, a2, a3, v3, v4))
    {
      return self->_currentColumnWidths.__begin_[v6 - self->_startColumnIndex] - self->_capturedColumnWidths.__begin_[v6 - self->_startColumnIndex];
    }
  }
