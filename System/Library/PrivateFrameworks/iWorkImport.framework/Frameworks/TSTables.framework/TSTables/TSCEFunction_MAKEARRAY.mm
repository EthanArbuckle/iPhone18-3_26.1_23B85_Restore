...
+ (id)evaluateForArgsWithContext:(id)context functionSpec:(id)spec arguments:(const void *)arguments
{
  ...
  {
    v118[0] = 0;
    v19 = objc_msgSend_asNumber_functionSpec_argumentIndex_outError_(v7, v13, context, spec, 0, v118);
    v17 = v118[0];
  ...
  if (objc_msgSend_isTokenOrEmptyArg(v8, v13, v14, v15, v16))
  {
    ...
    {
LABEL_6:
      v29 = objc_msgSend_raiseErrorOrConvert_(context, v25, v17, v27, v28);
      goto LABEL_27;
    }
  }
  ...
  {
    v117 = v17;
    v30 = objc_msgSend_asNumber_functionSpec_argumentIndex_outError_(v8, v25, context, spec, 1, &v117);
    v31 = v117;
  ...
  if (!v18 || !v109)
  {
    ...
    v29 = objc_msgSend_raiseErrorOrConvert_(context, v40, v39, v41, v42);
    v17 = v39;
    goto LABEL_27;
  }

  v37 = objc_msgSend_functionName(spec, v25, v26, v27, v28);
  ...
  v43 = *(*arguments + 16);
  v116 = 0;
  v45 = objc_msgSend_asFunctorValue_functionSpec_argumentIndex_outError_(v43, v44, context, spec, 2, &v116);
  v17 = v116;
  if (v17)
  {
    v50 = objc_msgSend_raiseErrorOrConvert_(context, v46, v17, v48, v49);
  }
  ...
  else
  {
    ...
    if (*(v51 + 8) == 2)
    {
      ...
      do
      {
        ...
        do
        {
          ...
          v67 = TSCEFunctor::evaluateWithArgs(v107, contextCopy, &v113);
          v71 = objc_msgSend_errorWithContext_(v67, v68, contextCopy, v69, v70);
          v76 = v71;
          if (v71 && objc_msgSend_errorType(v71, v72, v73, v74, v75) == 168)
          {
            v79 = objc_msgSend_functionName(spec, v72, v77, v78, v75);
    ...
    v96 = objc_msgSend_functionName(spec, v52, v53, v54, v55);
    v17 = objc_msgSend_wrongArityForLambdaError_providedArity_expectedArity_(TSCEError, v97, v96, *(v56 + 8), 2);

    v50 = objc_msgSend_raiseErrorOrConvert_(context, v98, v17, v99, v100);
  }
