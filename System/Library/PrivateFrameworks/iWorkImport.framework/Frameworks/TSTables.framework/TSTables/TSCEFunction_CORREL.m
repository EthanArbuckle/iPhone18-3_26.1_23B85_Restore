...
+ (TSUDecimal)covarianceWithVector:(id)a3 functionSpec:(id)a4 vector1:(id)a5 vector2:(id)a6 outStdDev:(TSUDecimal *)a7 durationAllowed:(BOOL)a8 isSample:(BOOL)a9 outError:(id *)a10;
...
+ (TSUDecimal)covarianceWithVector:(id)a3 functionSpec:(id)a4 vector1:(id)a5 vector2:(id)a6 outStdDev:(TSUDecimal *)a7 durationAllowed:(BOOL)a8 isSample:(BOOL)a9 outError:(id *)a10
{
  ...
  v30 = objc_msgSend_count(v13, v14, v15, v16, v17);
  if (objc_msgSend_count(v18, v31, v32, v33, v34) != v30)
  {
    v40 = objc_msgSend_functionName(a4, v35, v36, v37, v38);
    *a10 = objc_msgSend_differentNumberOfDataPointsErrorForFunctionName_(TSCEError, v41, v40, v42, v43);
  ...
  if (v39 && v30 <= 1)
  {
    *a10 = objc_msgSend_divideByZeroError(TSCEError, v35, v36, v37, v38);
LABEL_11:
    TSUDecimal::operator=();
    goto LABEL_12;
  }
...
LABEL_42:
    ...
    if (v124)
    {
      ...
      if (v156)
      {
        ...
        v156->_decimal.w[0] = v191._decimal.w[0];
        v156->_decimal.w[1] = v134;
      }
    ...
    {
      *a10 = objc_msgSend_divideByZeroError(TSCEError, v51, v52, v53, v54);
      TSUDecimal::operator=();
    }
  ...
  {
    v58 = v13;
    v59 = objc_msgSend_valueAtIndex_accessContext_(v13, v51, v57, &v178, v54);
    v60 = v18;
    v63 = objc_msgSend_valueAtIndex_accessContext_(v18, v61, v57, v172, v62);
    ...
    {
      v135 = objc_msgSend_functionName(a4, v87, v88, v89, v90);
      *a10 = objc_msgSend_mismatchedUnitsErrorForFunctionName_(TSCEError, v136, v135, v137, v138);
    ...
    v92 = objc_msgSend_asDate_functionSpec_argumentIndex_outError_(v59, v91, v55, a4, 0, a10);
    v98 = objc_msgSend_asDate_functionSpec_argumentIndex_outError_(v63, v93, v55, a4, 1, a10);
    if (*a10)
    {
      goto LABEL_65;
    }
    ...
    if ((v160 & 1) == 0)
    {
      v144 = objc_msgSend_functionName(a4, v94, v95, v96, v97);
      *a10 = objc_msgSend_mismatchedUnitsErrorForFunctionName_(TSCEError, v145, v144, v146, v147);
...
LABEL_39:
  ...
  v157 = objc_msgSend_asNumber_functionSpec_argumentIndex_outError_(v59, v91, v55, a4, 0, a10);
  v103 = objc_msgSend_asNumber_functionSpec_argumentIndex_outError_(v63, v102, v55, a4, 1, a10);
  v98 = v103;
  if (*a10)
  {
    goto LABEL_71;
  ...
  {
    v139 = objc_msgSend_functionName(a4, v108, v109, v110, v111);
...
LABEL_32:
    ...
    else
    {
      ...
      {
LABEL_63:
        v139 = objc_msgSend_functionName(a4, v104, v105, v106, v107);
    ...
    {
      v148 = objc_msgSend_functionName(a4, v116, v117, v118, v119);
      *a10 = objc_msgSend_mismatchedUnitsErrorForFunctionName_(TSCEError, v149, v148, v150, v151);
  ...
  v139 = objc_msgSend_functionName(a4, v104, v113, v106, v107);
...
+ (id)evaluateForArgsWithContext:(id)a3 functionSpec:(id)a4 arguments:(const void *)a5
{
  v8 = **a5;
  v41 = 0;
  v9 = objc_msgSend_asGrid_functionSpec_argumentIndex_applyPreferredFormat_outError_(v8, a2, a3, a4, 0, 1, &v41);
  v10 = v41;
  if (v10)
  {
    v14 = v10;
  ...
  v16 = *(*a5 + 8);
  v40 = 0;
  v17 = objc_msgSend_asGrid_functionSpec_argumentIndex_applyPreferredFormat_outError_(v16, v11, a3, a4, 1, 1, &v40);
  v18 = v40;
  if (!v18)
  {
    TSUDecimal::operator=();
    v38 = 0;
    isSample_outError = objc_msgSend_covarianceWithVector_functionSpec_vector1_vector2_outStdDev_durationAllowed_isSample_outError_(TSCEFunction_CORREL, v23, a3, a4, v9, v17, v39, 1, 0, &v38);
    v26 = v25;
    v14 = v38;
    ...
    if (v14)
    {
      v22 = objc_msgSend_raiseErrorOrConvert_(a3, v27, v14, v29, v30);
      goto LABEL_13;
    }
    ...
    if (v9)
    {
      ...
      {
LABEL_9:
        objc_msgSend_formatWithContext_(v17, v27, a3, v29, v30);
LABEL_12:
