...
+ (id)objectWithFormulaError:(id)a3 refCount:(unsigned int)a4;
- (id)description;
- (id)initObjectWithFormulaError:(id)a3 refCount:(unsigned int)a4;
...
+ (id)objectWithFormulaError:(id)a3 refCount:(unsigned int)a4
{
  ...
  v6 = a3;
  v7 = [a1 alloc];
  inited = objc_msgSend_initObjectWithFormulaError_refCount_(v7, v8, v6, v4, v9);
