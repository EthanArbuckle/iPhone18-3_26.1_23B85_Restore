...
+ (id)evaluateForArgsWithContext:(id)context functionSpec:(id)spec arguments:(const void *)arguments
{
  v8 = **arguments;
  v80 = 0;
  v10 = objc_msgSend_asNumber_functionSpec_argumentIndex_outError_(v8, v9, context, spec, 0, &v80);
  v11 = v80;
  ...
  else
  {
    ...
    else
    {
      v27 = *(*arguments + 8);
      v79 = 0;
      v30 = objc_msgSend_asNumber_functionSpec_argumentIndex_outError_(v27, v34, context, spec, 1, &v79);
      v35 = v79;
      if (v35)
      {
        v11 = v35;
        v21 = objc_msgSend_raiseErrorOrConvert_(context, v36, v35, v37, v38);
      }
      ...
      else
      {
        v39 = *(*arguments + 16);
        v78 = 0;
        v41 = objc_msgSend_asNumber_functionSpec_argumentIndex_outError_(v39, v40, context, spec, 2, &v78);
        v11 = v78;
        if (v11)
        {
          v21 = objc_msgSend_raiseErrorOrConvert_(context, v42, v11, v43, v44);
        }
        ...
        else
        {
          if (objc_msgSend_dimensionsMatchModuloCurrency_(v30, v42, v41, v43, v44))
          {
            ...
            v50 = objc_msgSend_multiply_context_(v74, v48, v41, context, v49);
            v77 = 0;
            v52 = objc_msgSend_add_functionSpec_outError_(v50, v51, v30, spec, &v77);
            v11 = v77;

            if (v11)
            {
              v56 = v74;
              v57 = objc_msgSend_raiseErrorOrConvert_(context, v53, v11, v54, v55);
            }
            ...
            else
            {
              ...
              if (v27)
              {
                objc_msgSend_formatWithContext_(v27, v53, context, v54, v55);
              }
          ...
          else
          {
            ...
            v52 = objc_msgSend_functionName(spec, v60, v61, v62, v63);
            v66 = objc_msgSend_mismatchedUnitsErrorForFunctionName_argumentNumberString_(TSCEError, v64, v52, v56, v65);
            v21 = objc_msgSend_raiseErrorOrConvert_(context, v67, v66, v68, v69);
