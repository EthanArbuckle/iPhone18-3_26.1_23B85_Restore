...
+ (id)evaluateForArgsWithContext:(id)a3 functionSpec:(id)a4 arguments:(const void *)a5
{
  v8 = **a5;
  v60 = 0;
  v10 = objc_msgSend_asNumber_functionSpec_argumentIndex_outError_(v8, v9, a3, a4, 0, &v60);
  v11 = v60;
  ...
  else
  {
    ...
    v22 = *(*a5 + 8);
    v59 = 0;
    v24 = objc_msgSend_asNumber_functionSpec_argumentIndex_outError_(v22, v23, a3, a4, 1, &v59);
    v11 = v59;
    ...
    else
    {
      ...
      v34 = *(*a5 + 16);
      v58 = 0;
      v36 = objc_msgSend_asNumber_functionSpec_argumentIndex_outError_(v34, v35, a3, a4, 2, &v58);
      v11 = v58;
      objc_msgSend_doubleRepresentation(v36, v37, v38, v39, v40);
      if (v11)
      {
        v45 = objc_msgSend_raiseErrorOrConvert_(a3, v41, v11, v42, v43);
      }
