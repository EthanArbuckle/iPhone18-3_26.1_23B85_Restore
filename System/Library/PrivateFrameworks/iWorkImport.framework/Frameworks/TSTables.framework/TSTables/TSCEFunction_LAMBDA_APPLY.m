...
+ (id)evaluateForArgsWithContext:(id)a3 functionSpec:(id)a4 arguments:(const void *)a5
{
  ...
  v9 = *(*a5 + 8 * v8);
  v54 = 0;
  v11 = objc_msgSend_asFunctorValue_functionSpec_argumentIndex_outError_(v9, v10, a3, a4, v8, &v54);
  v16 = v54;
  if (v16)
  {
...
LABEL_12:
  ...
  v24 = TSCEFunctor::evaluateWithArgs(v22, a3, v53);
  v28 = objc_msgSend_errorWithContext_(v24, v25, a3, v26, v27);
  v33 = v28;
