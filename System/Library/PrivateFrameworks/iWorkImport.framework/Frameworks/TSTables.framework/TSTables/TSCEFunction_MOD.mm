...
+ (id)evaluateForArgsWithContext:(id)context functionSpec:(id)spec arguments:(const void *)arguments
{
  ...
  v9 = *(*arguments + 8);
  v89 = 0;
  v11 = objc_msgSend_asNumber_functionSpec_argumentIndex_outError_(v8, v10, context, spec, 0, &v89);
  v12 = v89;
  if (v12)
  {
    v16 = v12;
  ...
  v88 = 0;
  v18 = objc_msgSend_asNumber_functionSpec_argumentIndex_outError_(v9, v13, context, spec, 1, &v88);
  v16 = v88;
  if (!v16)
  {
    if ((objc_msgSend_dimensionsMatchModuloCurrency_(v11, v19, v18, v20, v21) & 1) == 0)
    {
      ...
      v17 = objc_msgSend_raiseErrorOrConvert_(context, v31, v30, v32, v33);
    ...
    if (v8)
    {
      objc_msgSend_formatWithContext_(v8, v22, context, v24, v25);
      if (v9)
      {
LABEL_8:
        objc_msgSend_formatWithContext_(v9, v22, context, v24, v25);
        goto LABEL_12;
      }
    }
...
LABEL_12:
    ...
    *&v91._tskFormat = *objc_msgSend_rawDecimalValue(v11, v34, v35, v36, v37);
    ...
    if (TSUDecimal::operator<())
    {
      ...
      v17 = objc_msgSend_raiseErrorOrConvert_(context, v47, v46, v48, v49);
    }
    ...
    else
    {
      ...
      if (TSUDecimal::divide(&v84, &v83, &v82) == 5)
      {
        ...
        v17 = objc_msgSend_raiseErrorOrConvert_(context, v55, v54, v56, v57);
      }
      ...
      else
      {
        ...
        TSUDecimal::operator=();
        v62 = objc_msgSend_locale(context, v58, v59, v60, v61);
