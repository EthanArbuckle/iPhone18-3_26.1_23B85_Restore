...
+ (id)evaluateForArgsWithContext:(id)a3 functionSpec:(id)a4 arguments:(const void *)a5
{
  ...
  v9 = *(*a5 + 8);
  v58 = 0;
  v11 = objc_msgSend_asNumber_functionSpec_argumentIndex_outError_(v8, v10, a3, a4, 0, &v58);
  v12 = v58;
  if (v12)
  {
    v16 = v12;
  ...
  v57 = 0;
  v18 = objc_msgSend_asNumber_functionSpec_argumentIndex_outError_(v9, v13, a3, a4, 1, &v57);
  v16 = v57;
  if (!v16)
  {
    if (objc_msgSend_isDuration(v11, v19, v20, v21, v22))
    {
      objc_msgSend_reportLossOfUnitsWarningInContext_(TSCEWarning, v23, a3, v25, v26);
    }

    if (objc_msgSend_isDuration(v18, v23, v24, v25, v26))
    {
      objc_msgSend_reportLossOfUnitsWarningInContext_(TSCEWarning, v27, a3, v28, v29);
    }
    ...
    if (v16)
    {
      v35 = objc_msgSend_raiseErrorOrConvert_(a3, v31, v16, v33, v34);
    }
    ...
    else
    {
      if ((objc_msgSend_isFinite(v30, v31, v32, v33, v34) & 1) == 0)
      {
        ...
        v17 = objc_msgSend_raiseErrorOrConvert_(a3, v45, v44, v46, v47);
...
LABEL_21:
      ...
      if (v8)
      {
        objc_msgSend_formatWithContext_(v8, v36, a3, v38, v39);
      }
  ...
  v17 = objc_msgSend_raiseErrorOrConvert_(a3, v19, v16, v21, v22);
LABEL_22:
