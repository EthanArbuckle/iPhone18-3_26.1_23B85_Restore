...
- (TSCENumberCellValue)initWithDouble:(double)double locale:(id)locale
{
  ...
  v6 = [(TSCECellValue *)&v19 initWithLocale:localeCopy];
  v7 = v6;
  if (v6)
  {
    ...
    TSUDecimal::operator=();
    v11 = objc_msgSend_defaultFormatWithFormatType_locale_(MEMORY[0x277D80680], v9, 256, localeCopy, v10);
...
- (TSCENumberCellValue)initWithDecimal:(const TSUDecimal *)decimal locale:(id)locale
{
  ...
  v19.receiver = self;
  v19.super_class = TSCENumberCellValue;
  v7 = [(TSCECellValue *)&v19 initWithLocale:localeCopy];
  v8 = v7;
  if (v7)
  {
    v7->super._valueType = 5;
    v9 = [TSCENumberValue alloc];
    v12 = objc_msgSend_defaultFormatWithFormatType_locale_(MEMORY[0x277D80680], v10, 256, localeCopy, v11);
    TSCEFormat::TSCEFormat(&v18, v12, 0);
    v15 = objc_msgSend_initWithDecimal_format_(v9, v13, decimal, &v18, v14);
...
- (TSCENumberCellValue)initWithNumberValue:(id)value locale:(id)locale
{
  ...
  v8 = [(TSCECellValue *)&v31 initWithLocale:localeCopy];
  v13 = v8;
  if (v8)
  {
    ...
    if (!valueCopy)
    {
      valueCopy = objc_msgSend_zero(TSCENumberValue, v9, v10, v11, v12);
    }

    v14 = [TSCENumberValue alloc];
    v23 = objc_msgSend_rawDecimalValue(valueCopy, v15, v16, v17, v18);
    if (valueCopy)
    {
      objc_msgSend_format(valueCopy, v19, v20, v21, v22);
    }
    ...
    v24 = objc_msgSend_unit(valueCopy, v19, v20, v21, v22, v29, v30);
...
{
  valueCopy = value;
  if (objc_msgSend_valueType(valueCopy, v5, v6, v7, v8) == 5)
  {
    v13 = objc_msgSend_numberValue(valueCopy, v9, v10, v11, v12);
...
LABEL_18:
  ...
  v18 = objc_msgSend_numberValue(valueCopy, v14, v15, v16, v17);
  v48 = 0;
...
- (TSCENumberCellValue)initWithArchive:(const void *)archive locale:(id)locale
{
  ...
  v7 = [(TSCECellValue *)&v58 initWithLocale:localeCopy];
  v11 = v7;
  if (v7)
  {
    v7->super._valueType = 5;
    ...
    if (v19)
    {
      v24 = objc_msgSend_tsp_stringWithProtobufString_(MEMORY[0x277CCACA8], v15, *(archive + 3) & 0xFFFFFFFFFFFFFFFELL, v17, v18);
    ...
    else
    {
      if ((v19 & 8) != 0)
      {
        if (objc_msgSend_formatType(v12, v15, v16, v17, v18) == 268 && (*(archive + 12) == 6 || (objc_msgSend_asDurationFormat(v12, v33, v34, v35, v36), v37 = objc_claimAutoreleasedReturnValue(), v42 = objc_msgSend_useAutomaticUnits(v37, v38, v39, v40, v41), v37, v42)))
        {
        ...
        else
        {
          ...
          v23 = objc_msgSend_initWithDecimal_format_baseUnit_(v52, v53, &v56, &v57, *(archive + 24));
        }
      }
...
- (void)encodeToArchive:(void *)archive
{
  objc_msgSend_rawDoubleValue(self->_numberValue, a2, archive, v3, v4);
  *(archive + 4) |= 4u;
  *(archive + 5) = v7;
