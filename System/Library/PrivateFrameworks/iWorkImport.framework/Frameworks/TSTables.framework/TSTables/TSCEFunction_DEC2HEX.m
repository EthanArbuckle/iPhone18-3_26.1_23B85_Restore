@interface TSCEFunction_DEC2HEX
+ (id)evaluateForArgsWithContext:(id)a3 functionSpec:(id)a4 arguments:(const void *)a5;
@end

@implementation TSCEFunction_DEC2HEX

+ (id)evaluateForArgsWithContext:(id)a3 functionSpec:(id)a4 arguments:(const void *)a5
{
  v8 = **a5;
  v57 = 0;
  v10 = objc_msgSend_asNumber_functionSpec_argumentIndex_outError_(v8, v9, a3, a4, 0, &v57);
  v11 = v57;
...
LABEL_3:
  ...
  {
    v38 = objc_msgSend_functionName(a4, v26, v27, v28, v29);
    v30 = objc_msgSend_durationNotAllowedError_argumentNumber_(TSCEError, v48, v38, 1, v49);
    v21 = objc_msgSend_raiseErrorOrConvert_(a3, v50, v30, v51, v52);
    goto LABEL_13;
  }
...
LABEL_15:
    ...
    v56 = 0;
    v37 = objc_msgSend_asNumber_functionSpec_argumentIndex_outError_(v30, v35, a3, a4, 1, &v56);
    v38 = v56;
    ...
    v21 = objc_msgSend_raiseErrorOrConvert_(a3, v44, v38, v46, v47);
...
LABEL_13:
  ...
  v36 = 0;
LABEL_16:
  v21 = sub_2211F8024(a3, a4, v16, 16, v36, 0);
LABEL_17:
