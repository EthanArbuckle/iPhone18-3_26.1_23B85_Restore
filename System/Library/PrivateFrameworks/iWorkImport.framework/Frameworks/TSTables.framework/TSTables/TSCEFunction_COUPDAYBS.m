@interface TSCEFunction_COUPDAYBS
+ (id)evaluateForArgsWithContext:(id)a3 functionSpec:(id)a4 arguments:(const void *)a5;
@end

@implementation TSCEFunction_COUPDAYBS
...
LABEL_42:
    ...
    if (v65 <= 4 && ((1 << v65) & 0x16) != 0)
    {
      ...
      if (objc_msgSend_compare_(v25, v66, v125, v68, v69) != 1 && objc_msgSend_compare_(v25, v104, v125, v106, v107))
      {
        ...
        v108 = a4;
        v47 = v125;
        objc_msgSend_getCouponDaysBeforeSettlementDateWithSettlementDate_settlement_maturity_numCoupons_dayBasisMode_outError_(TSCEFinancialFunctions, v104, v108, v25, v125, v79, &v128, v70);
        v109 = v128;
        if (v109)
        {
          v19 = v109;
