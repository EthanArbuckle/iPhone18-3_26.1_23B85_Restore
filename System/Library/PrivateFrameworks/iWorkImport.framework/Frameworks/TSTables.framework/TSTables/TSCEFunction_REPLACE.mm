...
+ (id)evaluateForArgsWithContext:(id)context functionSpec:(id)spec arguments:(const void *)arguments
{
  ...
  if (v12)
  {
    objc_msgSend_asRichTextStorage_functionSpec_argumentIndex_outError_(v12, v13, context, spec, 0, &v98);
    v14 = v98;
    if (v14)
    {
      v18 = v14;
  ...
  if (objc_msgSend_isEmptyArg(v20, v21, v22, v23, v24))
  {
    ...
    v19 = objc_msgSend_raiseErrorOrConvert_(context, v32, v31, v33, v34);
    v18 = 0;
LABEL_36:
  ...
  if (v20)
  {
    objc_msgSend_formatWithContext_(v20, v25, context, v27, v28);
  }
  ...
  sub_22114F414(&v103, &v102);
  v97 = 0;
  v29 = objc_msgSend_asNumber_functionSpec_argumentIndex_outError_(v20, v35, context, spec, 1, &v97);
  v36 = v97;
  if (!v36)
  {
    ...
    *&v102._formatType = v41;
    ...
    if (v51)
    {
      objc_msgSend_formatWithContext_(v51, v52, context, v53, v54);
    }
    ...
    v92 = v50;
    v96 = 0;
    v93 = objc_msgSend_asNumber_functionSpec_argumentIndex_outError_(v31, v55, context, spec, 2, &v96);
    v56 = v96;
    if (v56)
    {
      v18 = v56;
      v19 = objc_msgSend_raiseErrorOrConvert_(context, v57, v56, v59, v60);
LABEL_35:
    ...
    *&v102._formatType = v61;
    ...
    if (v69)
    {
      objc_msgSend_formatWithContext_(v69, v70, context, v71, v72);
    }
    ...
    if (v73)
    {
      objc_msgSend_asRichTextStorage_functionSpec_argumentIndex_outError_(v73, v74, context, spec, 3, &v95);
      v78 = v95;
      if (v78)
      {
        v18 = v78;
        v19 = objc_msgSend_raiseErrorOrConvert_(context, v74, v78, v76, v77);
LABEL_34:
  ...
  v18 = v36;
  v19 = objc_msgSend_raiseErrorOrConvert_(context, v37, v36, v39, v40);
LABEL_37:
