...
+ (id)evaluateForArgsWithContext:(id)a3 functionSpec:(id)a4 arguments:(const void *)a5 isLarge:(BOOL)a6 ignoreError:(BOOL)a7 ignoreDuplicate:(BOOL)a8;
@end
...
+ (id)evaluateForArgsWithContext:(id)a3 functionSpec:(id)a4 arguments:(const void *)a5 isLarge:(BOOL)a6 ignoreError:(BOOL)a7 ignoreDuplicate:(BOOL)a8
{
  ...
  v14 = *(*a5 + 8);
  v93 = 0;
  v16 = objc_msgSend_asNumber_functionSpec_argumentIndex_outError_(v14, v15, a3, a4, 1, &v93);
  v17 = v93;
  ...
  if (v17)
  {
    v28 = objc_msgSend_raiseErrorOrConvert_(a3, v24, v17, v26, v27);
    goto LABEL_15;
  }

  if (v23 >= 1.0 || (v23 = 1.0, v9))
  {
    v35 = **a5;
    v92 = 0;
    v29 = objc_msgSend_asGrid_functionSpec_argumentIndex_applyPreferredFormat_outError_(v35, v24, a3, a4, 0, 1, &v92);
    v36 = v92;
    if (v36)
    {
      v17 = v36;
    ...
    v90 = objc_msgSend_deepResolveInPlace_(v29, v41, a3, v42, v43);
    v48 = objc_msgSend_gridValue(v90, v44, v45, v46, v47);
    v91 = 0;
    v50 = objc_msgSend_createFromGridValue_functionSpec_argumentIndex_evaluationContext_ignoreError_ignoreDuplicates_outError_(TSCETaggedDecimalListObject, v49, v48, a4, 0, a3, v9, v8, &v91);
    v17 = v91;
    v89 = v50;
    if (v17)
    {
      v28 = objc_msgSend_raiseErrorOrConvert_(a3, v51, v17, v53, v54);
    }
    ...
    else
    {
      ...
      v64 = v63[4];
      if (v64 && (v23 <= v64 || (v23 = v64, v9)))
      {
        if (v64 < objc_msgSend_count(v48, v59, v60, v61, v62))
        {
          objc_msgSend_reportNonNumericCellWarningInContext_(TSCEWarning, v83, a3, v84, v85);
        }
      ...
      {
        v65 = objc_msgSend_functionName(a4, v59, v60, v61, v62);
        v69 = objc_msgSend_positionLargerThanArrayErrorForFunctionName_(TSCEError, v66, v65, v67, v68);
        v28 = objc_msgSend_raiseErrorOrConvert_(a3, v70, v69, v71, v72);
      }
    }
...
LABEL_13:
  ...
  v29 = objc_msgSend_functionName(a4, v24, v25, v26, v27);
  ...
  v28 = objc_msgSend_raiseErrorOrConvert_(a3, v32, v31, v33, v34);
