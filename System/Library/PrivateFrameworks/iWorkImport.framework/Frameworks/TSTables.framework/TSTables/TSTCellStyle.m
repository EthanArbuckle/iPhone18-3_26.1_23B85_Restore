...
+ (id)p_regionStringForTableStyleArea:(unint64_t)a3;
+ (id)properties;
+ (id)propertiesAllowingNSNull;
+ (id)styleIDForPreset:(unint64_t)a3 andTableStyleArea:(unint64_t)a4;
+ (id)textStyleIDForPreset:(unint64_t)a3 andTableStyleArea:(unint64_t)a4;
+ (void)initDefaultPropertyMap:(id)a3 forTableStyleArea:(unint64_t)a4 presetID:(unint64_t)a5 colors:(id)a6 alternate:(unint64_t)a7;
+ (void)p_initBodyRegionPropertyMap:(id)a3 presetID:(unint64_t)a4 colors:(id)a5 alternate:(unint64_t)a6;
+ (void)p_initFooterRowRegionPropertyMap:(id)a3 presetID:(unint64_t)a4 colors:(id)a5 alternate:(unint64_t)a6;
+ (void)p_initHeaderColumnRegionPropertyMap:(id)a3 presetID:(unint64_t)a4 colors:(id)a5 alternate:(unint64_t)a6;
+ (void)p_initHeaderRowRegionPropertyMap:(id)a3 presetID:(unint64_t)a4 colors:(id)a5 alternate:(unint64_t)a6;
- (BOOL)isObsolete;
- (CGSize)targetSizeForImageData:(id)a3 associatedHint:(id)a4;
- (id)mixedObjectWithFraction:(double)a3 ofObject:(id)a4;
- (id)objectByRemovingPropertiesInMap:(id)a3 addingPropertiesInMap:(id)a4 updateInverseResetPropertyMap:(id)a5 updateInverseSetPropertyMap:(id)a6 optionalConcurrentStylesheet:(id)a7;
- (int64_t)mixingTypeWithObject:(id)a3 context:(id)a4;
- (void)loadCellStyleFromArchive:(const void *)a3 unarchiver:(id)a4;
- (void)loadCellStylePropertiesIntoPropertyMap:(id)a3 fromArchive:(const void *)a4 unarchiver:(id)a5;
- (void)loadFromUnarchiver:(id)a3;
- (void)saveCellStylePropertiesToArchive:(void *)a3 archiver:(id)a4;
- (void)saveCellStyleToArchive:(void *)a3 archiver:(id)a4;
...
+ (id)styleIDForPreset:(unint64_t)a3 andTableStyleArea:(unint64_t)a4
{
  v5 = objc_msgSend_p_regionStringForTableStyleArea_(a1, a2, a4, a4, v4);
  v6 = String();
...
+ (void)p_initBodyRegionPropertyMap:(id)a3 presetID:(unint64_t)a4 colors:(id)a5 alternate:(unint64_t)a6
{
  ...
  v16 = v13;
  objc_msgSend_setObject_forProperty_(v17, v14, v13, 898, v15);
}
...
+ (void)p_initHeaderRowRegionPropertyMap:(id)a3 presetID:(unint64_t)a4 colors:(id)a5 alternate:(unint64_t)a6
{
  ...
  if (v8)
  {
    v15 = objc_msgSend_objectAtIndex_(v8, v9, qword_2217E0378[4 * a4 + 1], v11, v12);
  ...
  objc_msgSend_setObject_forProperty_(v22, v20, v19, 898, v21);
}
...
+ (void)p_initHeaderColumnRegionPropertyMap:(id)a3 presetID:(unint64_t)a4 colors:(id)a5 alternate:(unint64_t)a6
{
  ...
  if (v8)
  {
    v15 = objc_msgSend_objectAtIndex_(v8, v9, qword_2217E0378[4 * a4 + 2], v11, v12);
    v19 = objc_msgSend_colorWithColor_(v14, v16, v15, v17, v18);
  }
...
+ (void)p_initFooterRowRegionPropertyMap:(id)a3 presetID:(unint64_t)a4 colors:(id)a5 alternate:(unint64_t)a6
{
  ...
  {
    v14 = MEMORY[0x277D801F8];
    v15 = objc_msgSend_objectAtIndex_(v8, v9, qword_2217E0378[4 * a4 + 3], v11, v12);
    v19 = objc_msgSend_colorWithColor_(v14, v16, v15, v17, v18);
  }
...
+ (void)initDefaultPropertyMap:(id)a3 forTableStyleArea:(unint64_t)a4 presetID:(unint64_t)a5 colors:(id)a6 alternate:(unint64_t)a7
{
  ...
  if (a4 <= 4)
  {
    if (a4 > 2)
    {
      ...
      if (a4 != 3)
      {
        objc_msgSend_p_initFooterRowRegionPropertyMap_presetID_colors_alternate_(a1, v27, v27, a5, v14, a7);
        goto LABEL_15;
      }
    ...
    {
LABEL_9:
      objc_msgSend_p_initBodyRegionPropertyMap_presetID_colors_alternate_(a1, v15, v15, a5, v14, a7);
      goto LABEL_15;
    }
  ...
  else
  {
    ...
    {
LABEL_3:
      objc_msgSend_p_initHeaderRowRegionPropertyMap_presetID_colors_alternate_(a1, v15, v15, a5, v14, a7);
      goto LABEL_15;
    }
    ...
    {
LABEL_13:
      objc_msgSend_p_initHeaderColumnRegionPropertyMap_presetID_colors_alternate_(a1, v15, v15, a5, v14, a7);
      goto LABEL_15;
    }
  }
...
- (void)loadCellStylePropertiesIntoPropertyMap:(id)a3 fromArchive:(const void *)a4 unarchiver:(id)a5
{
  ...
  if ((v13 & 0x400) != 0)
  {
    ...
    {
      objc_msgSend_setIntValue_forProperty_(v7, v10, v94, 896, v11);
    }
  ...
  if (v13)
  {
    v14 = objc_msgSend_instanceWithArchive_unarchiver_(MEMORY[0x277D80248], v10, *(a4 + 3), v8, v11);
    v93 = v14;
    v15 = objc_opt_class();
    ...
    if (v17)
    {
      objc_msgSend_setObject_forProperty_(v7, v19, v18, 898, v20);
    }
  ...
  if ((v13 & 2) != 0)
  {
    if (*(*(a4 + 4) + 24))
    {
      objc_msgSend_instanceWithArchive_unarchiver_(MEMORY[0x277D803C0], v10, *(*(a4 + 4) + 24), v8, v11);
    }

    else
    {
      objc_msgSend_instanceWithArchive_unarchiver_(MEMORY[0x277D803C0], v10, MEMORY[0x277D804A0], v8, v11);
    }
    v49 = ;
    v92 = v49;
    v50 = objc_opt_class();
    ...
    if (v52)
    {
      objc_msgSend_setObject_forProperty_(v7, v54, v53, 899, v55);
    }
...
LABEL_35:
    if (*(*(a4 + 5) + 24))
    {
      objc_msgSend_instanceWithArchive_unarchiver_(MEMORY[0x277D803C0], v10, *(*(a4 + 5) + 24), v8, v11);
    }
    ...
    if (v59)
    {
      objc_msgSend_setObject_forProperty_(v7, v61, v60, 902, v62);
    }
  ...
  if ((v13 & 8) == 0 && (v13 & 0x10) == 0)
  {
    if ((v13 & 0x40) != 0)
    {
      v21 = objc_msgSend_instanceWithArchive_unarchiver_(MEMORY[0x277D803C0], v10, *(a4 + 9), v8, v11);
      v88 = v21;
      v22 = objc_opt_class();
      ...
      if (v24)
      {
        objc_msgSend_setObject_forProperty_(v7, v26, v25, 899, v27);
      }
    ...
    if ((v13 & 0x80) != 0)
    {
      v28 = objc_msgSend_instanceWithArchive_unarchiver_(MEMORY[0x277D803C0], v10, *(a4 + 10), v8, v11);
      v87 = v28;
      v29 = objc_opt_class();
      ...
      if (v31)
      {
        objc_msgSend_setObject_forProperty_(v7, v33, v32, 902, v34);
      }
    ...
    if ((v13 & 0x100) != 0)
    {
      v35 = objc_msgSend_instanceWithArchive_unarchiver_(MEMORY[0x277D803C0], v10, *(a4 + 11), v8, v11);
      v86 = v35;
      v36 = objc_opt_class();
      ...
      if (v38)
      {
        objc_msgSend_setObject_forProperty_(v7, v40, v39, 900, v41);
      }
    ...
    if ((v13 & 0x200) != 0)
    {
      v42 = objc_msgSend_instanceWithArchive_unarchiver_(MEMORY[0x277D803C0], v10, *(a4 + 12), v8, v11);
      v85 = v42;
      v43 = objc_opt_class();
      ...
      if (v45)
      {
        objc_msgSend_setObject_forProperty_(v7, v47, v46, 901, v48);
      }
...
LABEL_41:
  if ((v13 & 8) != 0)
  {
    if (*(*(a4 + 6) + 24))
    {
      objc_msgSend_instanceWithArchive_unarchiver_(MEMORY[0x277D803C0], v10, *(*(a4 + 6) + 24), v8, v11);
    }
    ...
    if (v66)
    {
      objc_msgSend_setObject_forProperty_(v7, v68, v67, 900, v69);
    }
  ...
  if ((v13 & 0x10) != 0)
  {
    if (*(*(a4 + 7) + 24))
    {
      objc_msgSend_instanceWithArchive_unarchiver_(MEMORY[0x277D803C0], v10, *(*(a4 + 7) + 24), v8, v11);
    }
    ...
    if (v73)
    {
      objc_msgSend_setObject_forProperty_(v7, v74, v46, 901, v75);
    }
...
LABEL_55:
  ...
  if ((v76 & 0x800) != 0)
  {
    ...
    {
      objc_msgSend_setIntValue_forProperty_(v7, v10, v94, 903, v11);
    }
  ...
  if ((v76 & 0x20) != 0)
  {
    v77 = objc_msgSend_instanceWithArchive_unarchiver_(MEMORY[0x277D80EB0], v10, *(a4 + 8), v8, v11);
    v84 = v77;
    v78 = objc_opt_class();
    ...
    if (v80)
    {
      objc_msgSend_setObject_forProperty_(v7, v82, v81, 904, v83);
    }
  }
}
  ...
  if (objc_msgSend_containsProperty_(v8, v12, 898, v13, v14))
  {
    ...
    if (v24)
    {
      *(a3 + 4) |= 1u;
      ...
      objc_msgSend_saveToArchive_archiver_(v25, v26, v28, v6, v27);
    }
  }
  ...
  if (objc_msgSend_containsProperty_(v8, v30, 904, v31, v32))
  {
    ...
    if (v42)
    {
      *(a3 + 4) |= 0x20u;
      ...
      objc_msgSend_saveToArchive_archiver_(v43, v44, v46, v6, v45);
    }
  }
}
...
- (void)loadCellStyleFromArchive:(const void *)a3 unarchiver:(id)a4
{
  ...
  [(TSTCellStyle *)&v17 loadFromArchive:v7 unarchiver:v6];
  v8 = *(a3 + 10);
  if (v8)
  {
    ...
    if (*(a3 + 4))
    {
      objc_msgSend_loadCellStylePropertiesIntoPropertyMap_fromArchive_unarchiver_(self, v13, v14, *(a3 + 4), v6);
    }

    else
    {
      objc_msgSend_loadCellStylePropertiesIntoPropertyMap_fromArchive_unarchiver_(self, v13, v14, &qword_2812E9B30, v6);
    }
...
- (void)saveCellStyleToArchive:(void *)a3 archiver:(id)a4
{
  ...
  *(a3 + 4) |= 1u;
  ...
  [(TSTCellStyle *)&v19 saveToArchive:v7 archiver:v6];
  ...
  if (v13)
  {
    ...
    *(a3 + 4) = v16 | 6;
    ...
    objc_msgSend_saveCellStylePropertiesToArchive_archiver_(self, v14, v17, v6, v15);
  }
}
...
- (void)loadFromUnarchiver:(id)a3
{
  ...
  v7 = objc_msgSend_messageWithDescriptor_(v10, v4, off_2812E4498[162], v5, v6);

  objc_msgSend_loadCellStyleFromArchive_unarchiver_(self, v8, v7, v10, v9);
}
...
- (void)saveToArchiver:(id)a3
{
  v9 = a3;
  google::protobuf::internal::AssignDescriptors();
  v6 = objc_msgSend_messageWithNewFunction_descriptor_(v9, v4, sub_221130FF0, off_2812E4498[162], v5);

  objc_msgSend_saveCellStyleToArchive_archiver_(self, v7, v6, v9, v8);
}
...
- (id)objectByRemovingPropertiesInMap:(id)a3 addingPropertiesInMap:(id)a4 updateInverseResetPropertyMap:(id)a5 updateInverseSetPropertyMap:(id)a6 optionalConcurrentStylesheet:(id)a7
{
  ...
  v15 = a6;
  v16 = a7;
  if (objc_msgSend_containsProperty_(v13, v17, 905, v18, v19))
  {
    v24 = objc_opt_class();
    v29 = objc_msgSend_properties(v24, v25, v26, v27, v28);
    v33 = objc_msgSend_containsAnyPropertyInProperties_(v13, v30, v29, v31, v32);
    ...
    objc_msgSend_setObject_forProperty_(v15, v34, self, 905, v36);
    v51 = objc_msgSend_objectForProperty_(v13, v48, 905, v49, v50);
    goto LABEL_32;
  }
  ...
  v73 = objc_msgSend_parent(v57, v69, v70, v71, v72);
  ...
  {
    v84 = objc_msgSend_documentRoot(v57, v79, v80, v81, v82);
  ...
  if (v16)
  {
    objc_msgSend_repairOrReplaceErrantStyle_(v16, v90, v57, v91, v92);
  }

  else
  {
    objc_msgSend_repairOrReplaceErrantStyle_(v52, v90, v57, v91, v92);
  }
  v93 = ;
...
LABEL_16:
    isVariation = objc_msgSend_isVariation(v57, v53, v54, v55, v56);
    goto LABEL_17;
  }
...
LABEL_17:
  ...
  if (isVariation)
  {
    v115 = objc_msgSend_overridePropertyMap(v57, v99, v100, v101, v102);
  ...
  v187 = v12;
  v130 = objc_msgSend_propertyMapWithProperties_(v12, v127, v126, v128, v129);
  ...
  v146 = objc_msgSend_propertyMapWithProperties_(v13, v143, v142, v144, v145);
  ...
  if (((objc_msgSend_containsProperty_(v13, v154, 898, v155, v156) & 1) != 0 || objc_msgSend_containsProperty_(v187, v157, 898, v159, v160)) && (!objc_msgSend_isVariation(v148, v157, v158, v159, v160) || (objc_msgSend_overridesProperty_(v148, v157, 898, v159, v160) & 1) == 0))
  {
  ...
  if (v16)
  {
    ...
    v181 = objc_msgSend_variationOfStyle_propertyMap_(v16, v179, v178, v147, v180);
    v51 = TSUDynamicCast();
