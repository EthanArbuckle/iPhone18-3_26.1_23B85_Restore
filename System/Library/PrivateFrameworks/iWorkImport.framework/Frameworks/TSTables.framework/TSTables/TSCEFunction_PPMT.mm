...
+ (id)evaluateForArgsWithContext:(id)context functionSpec:(id)spec arguments:(const void *)arguments
{
  ...
  v9 = *(*arguments + 8);
  v132 = 0;
  v11 = objc_msgSend_asNumber_functionSpec_argumentIndex_outError_(v9, v10, context, spec, 1, &v132);
  v12 = v132;
  ...
  v21 = *(*arguments + 16);
  v130 = 0;
  v23 = objc_msgSend_asNumber_functionSpec_argumentIndex_outError_(v21, v22, context, spec, 2, &v130);
  v12 = v130;
  ...
  if (!v12)
  {
    ...
    {
      v118 = objc_msgSend_functionName(spec, v31, v32, v33, v34);
    ...
    v128 = 0;
    v118 = v35;
    v37 = objc_msgSend_asNumber_functionSpec_argumentIndex_outError_(v35, v36, context, spec, 0, &v128);
    v12 = v128;
...
LABEL_21:
    ...
    v126 = 0;
    v117 = v49;
    v51 = objc_msgSend_asNumber_functionSpec_argumentIndex_outError_(v49, v50, context, spec, 3, &v126);
    v12 = v126;
    v116 = v51;
    ...
    if (v12)
    {
      v59 = objc_msgSend_raiseErrorOrConvert_(context, v56, v12, v57, v58);
    }
    ...
    else
    {
      ...
      if (*(arguments + 1) - *arguments >= 0x21uLL)
      {
        ...
        {
          v123 = 0;
          v68 = objc_msgSend_asNumber_functionSpec_argumentIndex_outError_(v113, v67, context, spec, 4, &v123);
          v12 = v123;
          ...
          if (v12)
          {
            v20 = objc_msgSend_raiseErrorOrConvert_(context, v73, v12, v74, v75);
      ...
      if (v134)
      {
        v20 = objc_msgSend_raiseErrorOrConvert_(context, v60, v134, v61, v62);
        v12 = 0;
        goto LABEL_20;
      }
      ...
      else
      {
        ...
        {
          v122 = 0;
          v84 = objc_msgSend_asNumber_functionSpec_argumentIndex_outError_(v77, v82, context, spec, 5, &v122);
          v12 = v122;
          if (v12)
          {
            v20 = objc_msgSend_raiseErrorOrConvert_(context, v85, v12, v87, v88);
      ...
      v121 = 0;
      FixedPaymentWithRate_rate_nper_pv_fv_dueBeginning_outError = objc_msgSend_getFixedPaymentWithRate_rate_nper_pv_fv_dueBeginning_outError_(TSCEFinancialFunctions, v60, spec, v127, v129, v125, v124, v83, &v121);
      v115 = v91;
      ...
      {
        v12 = v93;
        v59 = objc_msgSend_raiseErrorOrConvert_(context, v94, v93, v95, v96);
      }
      ...
      else
      {
        v120[0] = 0;
        LOBYTE(v112) = v83;
        InterestPortionOfPaymentWithRate_rate_per_nper_pv_fv_dueBeginning_outError = objc_msgSend_getInterestPortionOfPaymentWithRate_rate_per_nper_pv_fv_dueBeginning_outError_(TSCEFinancialFunctions, v94, spec, v127, v131, v129, v125, v124, v112, v120);
        v99 = v98;
        v100 = v120[0];
        v12 = v100;
        ...
        if (v100)
        {
          v59 = objc_msgSend_raiseErrorOrConvert_(context, v101, v100, v102, v103);
        }
