...
+ (id)evaluateForArgsWithContext:(id)context functionSpec:(id)spec arguments:(const void *)arguments
{
  v7 = **arguments;
  v139[0] = 0;
  v125 = objc_msgSend_asGrid_functionSpec_argumentIndex_applyPreferredFormat_outError_(v7, a2, context, spec, 0, 1, v139);
  v8 = v139[0];
  if (v8)
  {
    v13 = v8;
    v14 = objc_msgSend_raiseErrorOrConvert_(context, v9, v8, v11, v12);
    goto LABEL_49;
  }
  ...
  *(v135 + 7) = 0;
  ...
  if (v19)
  {
    ...
    while (1)
    {
      ...
      {
        v55 = objc_msgSend_errorWithContext_(v29, v34, contextCopy, v36, v37);
        v14 = objc_msgSend_raiseErrorOrConvert_(contextCopy, v94, v55, v95, v96);
        goto LABEL_44;
      }

      if ((objc_msgSend_isNil(v29, v34, v35, v36, v37) & 1) == 0)
      {
        v45 = objc_msgSend_deepType_(v29, v38, contextCopy, v39, v40);
        if (v45 > 4)
        {
          if (v45 != 10 && v45 != 5)
          {
...
LABEL_16:
          ...
          {
LABEL_42:
            v55 = objc_msgSend_functionName(spec, v41, v42, v43, v44);
            v108 = objc_msgSend_mixedTypeManipulationErrorForFunctionName_(TSCEError, v116, v55, v117, v118);
            v14 = objc_msgSend_raiseErrorOrConvert_(contextCopy, v119, v108, v120, v121);
LABEL_43:
...
LABEL_44:
          ...
          {
            v131 = 0;
            v55 = objc_msgSend_asNumber_functionSpec_argumentIndex_outError_(v29, v41, contextCopy, spec, 0, &v131);
            v56 = v131;
            if (v56)
            {
              v13 = v56;
              v14 = objc_msgSend_raiseErrorOrConvert_(contextCopy, v57, v56, v58, v59);
              v124 = 0;
LABEL_45:
            ...
            {
              v108 = objc_msgSend_functionName(spec, v60, v61, v62, v63);
              v112 = objc_msgSend_mismatchedUnitsErrorForFunctionName_(TSCEError, v109, v108, v110, v111);
              v14 = objc_msgSend_raiseErrorOrConvert_(contextCopy, v113, v112, v114, v115);
            ...
            v130 = 0;
            v64 = objc_msgSend_add_functionSpec_outError_(v123, v60, v55, spec, &v130);
            v13 = v130;

            if (v13)
            {
              v14 = objc_msgSend_raiseErrorOrConvert_(contextCopy, v65, v13, v66, v67, v64);
              v123 = v64;
              v124 = 0;
              goto LABEL_45;
            }
          ...
          {
            v132 = 0;
            v64 = objc_msgSend_asNumber_functionSpec_argumentIndex_outError_(v29, v41, contextCopy, spec, 0, &v132);
            v13 = v132;

            if (v13)
            {
              v124 = 0;
              v14 = objc_msgSend_raiseErrorOrConvert_(contextCopy, v68, v13, v69, v70);
              goto LABEL_47;
            }
          }
        ...
        {
          v128 = 0;
          v46 = objc_msgSend_asDate_functionSpec_argumentIndex_outError_(v29, v41, contextCopy, spec, 0, &v128);
          v13 = v128;
          ...
          if (v13)
          {
            v14 = objc_msgSend_raiseErrorOrConvert_(contextCopy, v52, v13, v53, v54);
            goto LABEL_46;
          }
        ...
        {
          v129 = 0;
          v82 = objc_msgSend_asDate_functionSpec_argumentIndex_outError_(v29, v41, contextCopy, spec, 0, &v129);
          v83 = v129;
          if (v83)
          {
            v13 = v83;
            v14 = objc_msgSend_raiseErrorOrConvert_(contextCopy, v84, v83, v85, v86);
            v124 = v82;
            goto LABEL_46;
          }
...
LABEL_27:
      ...
      if (v19 == ++v25)
      {
        ...
        if (v13)
        {
          v107 = objc_msgSend_raiseErrorOrConvert_(contextCopy, v103, v13, v104, v105);
        }
...
LABEL_32:
  ...
  v14 = objc_msgSend_raiseErrorOrConvert_(contextCopy, v91, v29, v92, v93);
  v13 = 0;
  v124 = v90;
LABEL_46:
  v64 = v123;
