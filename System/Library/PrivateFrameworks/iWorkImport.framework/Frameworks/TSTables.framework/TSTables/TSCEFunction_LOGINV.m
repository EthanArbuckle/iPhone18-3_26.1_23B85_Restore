...
+ (id)evaluateForArgsWithContext:(id)a3 functionSpec:(id)a4 arguments:(const void *)a5
{
  v8 = **a5;
  v71 = 0;
  v10 = objc_msgSend_asNumber_functionSpec_argumentIndex_outError_(v8, v9, a3, a4, 0, &v71);
  v11 = v71;
  ...
  else
  {
    ...
    else
    {
      v30 = *(*a5 + 8);
      v70 = 0;
      v35 = objc_msgSend_asNumber_functionSpec_argumentIndex_outError_(v30, v34, a3, a4, 1, &v70);
      v27 = v70;
      objc_msgSend_doubleRepresentation(v35, v36, v37, v38, v39);
      if (v27)
      {
        v21 = objc_msgSend_raiseErrorOrConvert_(a3, v40, v27, v41, v42);
      }
      ...
      else
      {
        ...
        v45 = *(*a5 + 16);
        v69 = 0;
        v47 = objc_msgSend_asNumber_functionSpec_argumentIndex_outError_(v45, v46, a3, a4, 2, &v69);
        v27 = v69;
        objc_msgSend_doubleRepresentation(v47, v48, v49, v50, v51);
        if (v27)
        {
          v21 = objc_msgSend_raiseErrorOrConvert_(a3, v52, v27, v53, v54);
        }

        else
        {
          v56 = v55;
          v60 = objc_msgSend_errorForDuration_argumentIndex_(v47, v52, a4, 2, v54);
          if (v60)
          {
            v21 = objc_msgSend_raiseErrorOrConvert_(a3, v57, v60, v58, v59);
            v27 = v60;
          }
          ...
          else
          {
            ...
            if (v8)
            {
              objc_msgSend_formatWithContext_(v8, v63, a3, v64, v65);
            }
