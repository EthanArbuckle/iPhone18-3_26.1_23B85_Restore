...
+ (TSUDecimal)solveByNewtonsWithNumPeriods:(const TSUDecimal *)a3 pmt:(const TSUDecimal *)a4 pv:(const TSUDecimal *)a5 fv:(const TSUDecimal *)a6 dueBeginning:(BOOL)a7 initial:(const TSUDecimal *)a8 context:(id)a9;
...
+ (id)evaluateForArgsWithContext:(id)a3 functionSpec:(id)a4 arguments:(const void *)a5
{
  v9 = **a5;
  v127[0] = 0;
  v11 = objc_msgSend_asNumber_functionSpec_argumentIndex_outError_(v9, v10, a3, a4, 0, v127);
  v12 = v127[0];
  ...
  v21 = *(*a5 + 8);
  v126 = 0;
  v23 = objc_msgSend_asNumber_functionSpec_argumentIndex_outError_(v21, v22, a3, a4, 1, &v126);
  v12 = v126;
  ...
  *(&v125 + 1) = v28;
  if (!v12)
  {
    ...
    v31 = *(*a5 + 16);
    v124 = 0;
    v33 = objc_msgSend_asNumber_functionSpec_argumentIndex_outError_(v31, v32, a3, a4, 2, &v124);
    v12 = v124;
    v110 = v33;
...
LABEL_42:
    ...
    else
    {
      ...
      {
        v121 = 0;
        v47 = objc_msgSend_asNumber_functionSpec_argumentIndex_outError_(v41, v46, a3, a4, 3, &v121);
        v12 = v121;
        v122[0] = objc_msgSend_decimalRepresentation(v47, v48, v49, v50, v51);
        v122[1] = v52;
        if (v12)
        {
          v20 = objc_msgSend_raiseErrorOrConvert_(a3, v52, v12, v53, v54);
...
LABEL_27:
      ...
      else
      {
        ...
        {
          v120 = 0;
          v55 = objc_msgSend_asBoolean_functionSpec_argumentIndex_outError_(v41, v60, a3, a4, 4, &v120);
          v61 = v120;
          if (v61)
          {
            v12 = v61;
            v20 = objc_msgSend_raiseErrorOrConvert_(a3, v62, v61, v63, v64);
            goto LABEL_19;
          }
        }
      }
    ...
    if (*(a5 + 1) - *a5 >= 0x29uLL)
    {
      ...
      {
        v118 = 0;
        v75 = objc_msgSend_asNumber_functionSpec_argumentIndex_outError_(v65, v74, a3, a4, 5, &v118);
        v12 = v118;
        v119[0] = objc_msgSend_decimalRepresentation(v75, v76, v77, v78, v79);
        v119[1] = v80;
        if (v12)
        {
          v20 = objc_msgSend_raiseErrorOrConvert_(a3, v80, v12, v81, v82);
    ...
    *&v114._tskFormat = v125;
    ...
    else
    {
      ...
      TSUDecimal::operator=();
      v115._decimal.w[0] = objc_msgSend_solveByNewtonsWithNumPeriods_pmt_pv_fv_dueBeginning_initial_context_(a1, v90, &v114, &v125, v123, v122, v55, v119, a3);
      ...
      if (TSUDecimal::isNaN(&v115))
      {
        ...
        if ((TSUDecimal::operator==() & 1) == 0)
        {
          TSUDecimal::operator=();
          TSUDecimal::operator=();
          v115._decimal.w[0] = objc_msgSend_solveByNewtonsWithNumPeriods_pmt_pv_fv_dueBeginning_initial_context_(a1, v92, &v114, &v125, v123, v122, v55, v112, a3);
      ...
      if (TSUDecimal::isNaN(&v115))
      {
        v98 = objc_msgSend_functionName(a4, v94, v95, v96, v97);
        v102 = objc_msgSend_numberDoesNotConvergeWithEstimateErrorForFunctionName_(TSCEError, v99, v98, v100, v101);
        v20 = objc_msgSend_raiseErrorOrConvert_(a3, v103, v102, v104, v105);
      }
