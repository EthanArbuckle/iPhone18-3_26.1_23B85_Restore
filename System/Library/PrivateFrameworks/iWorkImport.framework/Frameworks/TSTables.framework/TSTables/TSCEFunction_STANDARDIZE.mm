...
+ (id)evaluateForArgsWithContext:(id)a3 functionSpec:(id)a4 arguments:(const void *)a5
{
  ...
  else
  {
    v17 = *(*a5 + 8);
    v60 = 0;
    v19 = objc_msgSend_asNumber_functionSpec_argumentIndex_outError_(v17, v18, a3, a4, 1, &v60);
    v20 = v60;
    if (v20)
    {
      v15 = v20;
    ...
    else
    {
      v24 = *(*a5 + 16);
      v59 = 0;
      v26 = objc_msgSend_asNumber_functionSpec_argumentIndex_outError_(v24, v25, a3, a4, 2, &v59);
      v15 = v59;
      if (v15)
      {
        v16 = objc_msgSend_raiseErrorOrConvert_(a3, v27, v15, v28, v29);
      }
      ...
      else
      {
        ...
        {
          v58 = 0;
          v34 = objc_msgSend_subtract_functionSpec_outError_(v10, v30, v19, a4, &v58);
          v35 = v58;
          v57 = v35;
          v54 = v34;
          ...
          if (v15)
          {
            v42 = objc_msgSend_raiseErrorOrConvert_(a3, v39, v15, v40, v41);
          }
        ...
        {
          v38 = objc_msgSend_functionName(a4, v30, v31, v32, v33);
          v46 = objc_msgSend_mismatchedUnitsErrorForFunctionName_(TSCEError, v43, v38, v44, v45);
          v16 = objc_msgSend_raiseErrorOrConvert_(a3, v47, v46, v48, v49);
