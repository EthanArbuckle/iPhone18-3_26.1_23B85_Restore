...
+ (id)evaluateForArgsWithContext:(id)a3 functionSpec:(id)a4 arguments:(const void *)a5
{
  v8 = **a5;
  v96 = 0;
  v9 = objc_msgSend_asGrid_functionSpec_argumentIndex_applyPreferredFormat_outError_(v8, a2, a3, a4, 0, 0, &v96);
  v10 = v96;
  if (v10)
  {
    v15 = v10;
  ...
  {
    v95 = 0;
    v31 = objc_msgSend_asNumber_functionSpec_argumentIndex_outError_(v24, v29, a3, a4, 1, &v95);
    v15 = v95;
    if (v15)
    {
...
LABEL_22:
  ...
  if (*(a5 + 1) - *a5 >= 0x11uLL)
  {
    ...
    {
      v93 = 0;
      v31 = objc_msgSend_asNumber_functionSpec_argumentIndex_outError_(v24, v74, a3, a4, 2, &v93);
      v15 = v93;
      if (v15)
      {
        v36 = objc_msgSend_raiseErrorOrConvert_(a3, v75, v15, v77, v78);
        goto LABEL_22;
      }
  ...
  if (v30 >= v23)
  {
    if (v37 < v22)
    {
      v80 = objc_msgSend_functionName(a4, v18, v19, v20, v21);
      ...
      v86 = objc_msgSend_raiseErrorOrConvert_(a3, v88, v82, v89, v90);
      goto LABEL_29;
    }
...
LABEL_8:
    ...
    if (v37 * v30)
    {
      ...
      {
        v46 = *(*a5 + 24);
        if ((objc_msgSend_isTokenOrEmptyArg(v46, v47, v48, v49, v50) & 1) == 0 && objc_msgSend_deepType_(v46, v51, a3, v52, v53) != 9)
        {
          v54 = v46;
      ...
      v55 = objc_msgSend_asValueGrid_(v9, v43, a3, v44, v45);
    ...
    else
    {
      ...
      v16 = objc_msgSend_raiseErrorOrConvert_(a3, v66, v42, v67, v68);
    }
  ...
  v86 = objc_msgSend_raiseErrorOrConvert_(a3, v83, v82, v84, v85);
LABEL_29:
  v16 = v86;
