...
+ (id)evaluateForArgsWithContext:(id)context functionSpec:(id)spec arguments:(const void *)arguments
{
  ...
  else
  {
    ...
    v29[1] = v16;
    isEven_value_warningType = objc_msgSend_isEven_value_warningType_(TSCEFunction_ISEVEN, v16, context, v29, 103);
    v22 = 0;
    v23 = 0;
    v24 = 0;
    v25 = 1057;
    ...
    v27 = -50266102;
    v28 = 253;
    v15 = objc_msgSend_BOOLValue_format_(TSCEBooleanValue, v18, isEven_value_warningType ^ 1u, &v22, v19);
  }
