...
+ (id)evaluateForArgsWithContext:(id)a3 functionSpec:(id)a4 arguments:(const void *)a5
{
  v8 = **a5;
  v65 = 0;
  v10 = objc_msgSend_asDate_functionSpec_argumentIndex_outError_(v8, v9, a3, a4, 0, &v65);
  v11 = v65;
  ...
  v25 = *(*a5 + 8);
  v64 = 0;
  v27 = objc_msgSend_asDate_functionSpec_argumentIndex_outError_(v25, v26, a3, a4, 1, &v64);
  v11 = v64;
  ...
  if (*(a5 + 1) - *a5 >= 0x11uLL)
  {
    ...
    {
      v63 = 0;
      v54 = objc_msgSend_asBoolean_functionSpec_argumentIndex_outError_(v36, v41, a3, a4, 2, &v63);
      v55 = v63;
      if (v55)
      {
        v11 = v55;
        v24 = objc_msgSend_raiseErrorOrConvert_(a3, v56, v55, v57, v58);
...
LABEL_9:
  ...
  v11 = v43;
  v35 = objc_msgSend_raiseErrorOrConvert_(a3, v44, v43, v45, v46);
LABEL_11:
  v24 = v35;
LABEL_12:
