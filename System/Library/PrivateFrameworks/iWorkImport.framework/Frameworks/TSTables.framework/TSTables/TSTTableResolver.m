...
- (BOOL)hasCellCoord:(const TSUCellCoord *)a3;
- (BOOL)hasNamesInHeaders;
- (BOOL)isCategorized;
- (BOOL)isFooterCell:(const TSUCellCoord *)a3;
- (BOOL)isHeaderCell:(const TSUCellCoord *)a3;
- (BOOL)isPivotDataModel;
- (BOOL)rangeIsWithinTable:(const TSCERangeRef *)a3;
- (BOOL)rangeIsWithinTableInView:(const TSCERangeRef *)a3;
- (NSString)sheetName;
- (TSCECalculationEngine)calcEngine;
- (TSCECellCoordSet)cellsModifiedInCurrentRecalcCycle;
- (TSCECellRef)allAggsInGroupRootPrecedent:(SEL)a3;
- (TSCECellRef)groupingColumnHeadersPrecedent:(SEL)a3;
- (TSCECellRef)groupingColumnOrderPrecedent:(SEL)a3;
- (TSCECellRef)groupingColumnsPrecedent:(SEL)a3;
- (TSCECellRef)groupingColumnsPrecedentForCategoryRef:(SEL)a3;
- (TSCECellRef)groupingRowOrderPrecedent:(SEL)a3 ignoreRecalc:(const TSKUIDStruct *)a4;
- (TSCECellRef)indirectAggTypeChangePrecedent:(SEL)a3;
- (TSCECellTractRefCore)apparentTractRefForTractRef:(SEL)a3 rangeContext:(const TSCECellTractRefCore *)a4;
- (TSCECoordMapper)coordMapper;
- (TSCEFormat)format:(SEL)a3 fromCell:(id)a4;
- (TSCERangeCoordinate)apparentRangeForRange:(const TSCERangeCoordinate *)a3 rangeContext:(unsigned __int8)a4;
- (TSCERangeCoordinate)bodyRangeCoordinate;
- (TSCERangeCoordinate)expandCellRangeToCoverMergedCells:(const TSCERangeCoordinate *)a3;
- (TSCERangeCoordinate)footerRangeCoordinate;
- (TSCERangeCoordinate)preMergeRangeFromUidTract:(id)a3;
...
- (TSKUIDStruct)convertToRelativeAncestorUid:(const TSKUIDStruct *)a3 rowUid:(const TSKUIDStruct *)a4;
...
- (TSKUIDStruct)resolveRelativeAncestorUid:(const TSKUIDStruct *)a3 sourceRowUID:(const TSKUIDStruct *)a4;
...
- (TSKUIDStructVectorTemplate<TSKUIDStruct>)viewOrderedRowUids:(SEL)a3;
- (TSTTableInfo)tableInfo;
- (TSTTableResolver)initWithTableModel:(id)a3;
- (TSTTableTranslator)tableTranslator;
- (TSUCellCoord)resolvedCellCoordForIntersection:(const TSCERangeCoordinate *)a3 hostCell:(const TSUCellCoord *)a4 useImplicitIntersection:(BOOL)a5;
- (TSUCellCoord)resolvedCellCoordForIntersectionRef:(id)a3 hostCell:(const TSUCellCoord *)a4 useImplicitIntersection:(BOOL)a5;
- (TSUModelCellRect)mergedRangeForBaseCellCoord:(const TSUModelCellCoord *)a3;
- (id)UIDSetForIndexes:(id)a3 isRows:(BOOL)a4;
- (id)UIDSetForRange:(_NSRange)a3 isRows:(BOOL)a4;
- (id)apparentGridForRangeContext:(id)a3 rangeContext:(unsigned __int8)a4 spansAllColumns:(BOOL)a5 spansAllRows:(BOOL)a6;
- (id)canonicalCellReferenceForReference:(id)a3;
- (id)cellTractRefForViewTractRef:(id)a3;
- (id)filteredCellTractRef:(id)a3 hidingActionMask:(unsigned __int8)a4;
- (id)makeReferenceWithTopLeft:(const TSUCellCoord *)a3 bottomRight:(const TSUCellCoord *)a4 preserveFlags:(const TSUPreserveFlags *)a5;
...
- (id)readValueForReference:(id)a3 fromCellRef:(const TSCECellRef *)a4 outValue:(id *)a5 readOptions:(unsigned __int16)a6;
- (id)resolveCategoryRefAtRowUid:(id)a3 rowUid:(const TSKUIDStruct *)a4 containingTableUID:(const TSKUIDStruct *)a5;
- (id)solveGetPivotData:(id)a3 functionSpec:(id)a4 context:(id)a5;
- (id)unpersistedFormulaStorageForCoord:(const TSUCellCoord *)a3 withPrefix:(id)a4 withStyle:(id)a5 allowHeaderNames:(BOOL)a6;
- (id)valueForCellCoord:(const TSUCellCoord *)a3 fetchRichTextAttributesIfPlainText:(BOOL)a4;
- (id)valueForCellUID:(const TSKUIDStructCoord *)a3 outGeometricPrecedent:(TSCECellRef *)a4 fetchRichTextAttributesIfPlainText:(BOOL)a5;
- (id)valuesForViewTractRef:(id)a3 hidingActionMask:(unsigned __int8)a4 outError:(id *)a5;
- (id)valuesForViewTractRef:(id)a3 hidingActionMask:(unsigned __int8)a4 outError:(id *)a5 outGeometricPrecedents:(void *)a6 forceHidingOfPivotFiltered:(BOOL)a7;
- (id)viewTractRefForCellTractRef:(id)a3;
- (int64_t)interactionTypeForCell:(const TSUModelCellCoord *)a3;
...
- (unsigned)columnIndexForColumnUID:(const TSKUIDStruct *)a3;
- (unsigned)columnWidthInBodyOfTable:(id)a3;
- (unsigned)getHidingAction:(id)a3 forRow:(BOOL)a4;
...
- (unsigned)rowIndexForRowUID:(const TSKUIDStruct *)a3;
- (vector<TSUModelCellRect,)mergeRangesIntersectingCellRange:(TSTTableResolver *)self;
- (void)dirtyColumnOrderChanged;
- (void)resetAllFormulaDependenciesForCell:(const TSUCellCoord *)a3 calcEngine:(id)a4;
- (void)resetDependenciesForCell:(const TSUCellCoord *)a3 calcEngine:(id)a4;
...
- (TSTTableResolver)initWithTableModel:(id)a3
{
  ...
  if (v6)
  {
    objc_storeStrong(&v6->_tableModel, a3);
    v12 = objc_msgSend_tableInfo(v5, v8, v9, v10, v11);
    tableInfo = v7->_tableInfo;
    v7->_tableInfo = v12;

    v18 = objc_msgSend_calcEngine(v5, v14, v15, v16, v17);
    v7->_calcEngine = v18;
...
- (id)unpersistedFormulaStorageForCoord:(const TSUCellCoord *)a3 withPrefix:(id)a4 withStyle:(id)a5 allowHeaderNames:(BOOL)a6
{
  ...
  v16 = *a3;
  v21 = objc_msgSend_stylesheet(v10, v17, v18, v19, v20);
  ...
  v44 = objc_msgSend_initWithContext_string_kind_stylesheet_paragraphStyle_listStyle_section_columnStyle_paragraphDirection_(v37, v43, v15, v80, 5, v21, v10, v42, 0, 0, isLanguageFormulasDirectionRightToLeft);
  ...
  if (v76)
  {
    ...
    if (v77)
    {
      objc_msgSend_insertString_atCharIndex_undoTransaction_(v77, v78, v80, 0, 0);
    }
  }
...
{
  v6 = *a3;
  v17.origin = objc_msgSend_headerRowRange(self->_tableModel, a2, a3, v3, v4);
  v17.size = v7;
  v8 = v6;
...
{
  v5 = *a3;
  v9.origin = objc_msgSend_footerRowRange(self->_tableModel, a2, a3, v3, v4);
  v9.size = v6;
  v7 = v5;
...
- (BOOL)hasCellCoord:(const TSUCellCoord *)a3
{
  v9.origin = objc_msgSend_range(self->_tableModel, a2, a3, v3, v4);
  v9.size = v6;
  v7 = *a3;
  return TSUCellRect::contains(&v9, v7);
}
...
- (id)makeReferenceWithTopLeft:(const TSUCellCoord *)a3 bottomRight:(const TSUCellCoord *)a4 preserveFlags:(const TSUPreserveFlags *)a5
{
  v9 = objc_msgSend_calcEngine(self, a2, a3, a4, a5);
  ...
  if (v17)
  {
    v18 = TSCETableResolverWrapper::makeReferenceWithTopLeft(v17, a3, a4, a5);
  }
...
- (BOOL)rangeIsWithinTable:(const TSCERangeRef *)a3
{
  v7 = objc_msgSend_tableRangeCoordinate(self, a2, a3, v3, v4);
  v9 = v8;
  if (!objc_msgSend_isPivotTable(self, v8, v10, v11, v12))
  {
    topLeft = a3->range._topLeft;
    bottomRight = a3->range._bottomRight;
    v19 = *&a3->range._topLeft;
    v20 = *&a3->range._topLeft & 0xFFFF00000000;
    ...
    {
      v22 = *&bottomRight & 0xFFFF00000000;
      if (bottomRight.row != 0x7FFFFFFF && v22 != 0x7FFF00000000 && WORD2(*&a3->range._topLeft) <= bottomRight.column && topLeft.row <= bottomRight.row)
      {
        goto LABEL_31;
      }
    }
    ...
    else
    {
      ...
      result = 0;
      if (bottomRight.row != 0x7FFFFFFF || WORD2(*&a3->range._topLeft) > WORD2(*&a3->range._bottomRight))
      {
        return result;
      }
    }
...
LABEL_50:
  ...
  return objc_msgSend_rangeIsWithinTableInView_(self, v13, a3, v14, v15);
}

- (BOOL)rangeIsWithinTableInView:(const TSCERangeRef *)a3
{
  v6 = objc_msgSend_range(self->_tableInfo, a2, a3, v3, v4);
  v8 = j__TSUCellRectToTSCERangeCoordinate(v6, v7);
  topLeft = a3->range._topLeft;
  bottomRight = a3->range._bottomRight;
  v12 = *&a3->range._topLeft;
  v13 = *&a3->range._topLeft & 0xFFFF00000000;
  ...
  {
    v15 = *&bottomRight & 0xFFFF00000000;
    if (bottomRight.row != 0x7FFFFFFF && v15 != 0x7FFF00000000 && WORD2(*&a3->range._topLeft) <= bottomRight.column && topLeft.row <= bottomRight.row)
    {
      goto LABEL_27;
    }
  }
...
- (unsigned)rowHeightInBodyOfTable:(id)a3
{
  ...
  if (objc_msgSend_spansAllRows(v4, v17, v18, v19, v20))
  {
    v23 = v13 - v11 + 1;
  }
  ...
  else
  {
    ...
    v28[6] = v13;
    v28[4] = &v29;
    objc_msgSend_foreachRangeRef_(v4, v24, v28, v25, v26);
...
- (unsigned)columnWidthInBodyOfTable:(id)a3
{
  ...
  if (objc_msgSend_spansAllColumns(v4, v17, v18, v19, v20))
  {
...
- (void)upgradeStyleForFormulatextForCellCoord:(const TSUCellCoord *)a3
{
  if ((*a3 & 0x101FFFFFFFFFFFFLL) != 0x7FFF7FFFFFFFLL)
  {
    v9 = objc_msgSend_cellsPendingWrite(self->_tableModel, a2, a3, v3, v4);
    objc_msgSend_upgradeStyleForFormulatextForCellCoord_(v9, v6, a3, v7, v8);
  }
}
...
{
  v5 = *&a3;
  v6 = objc_msgSend_columnRowUIDMap(self->_tableModel, a2, *&a3, v3, v4);
...
- (unsigned)rowIndexForRowUID:(const TSKUIDStruct *)a3
{
  v5 = a3;
  v6 = objc_msgSend_columnRowUIDMap(self->_tableModel, a2, a3, v3, v4);
  LODWORD(v5) = objc_msgSend_rowIndexForRowUID_(v6, v7, v5->_lower, v5->_upper, v8);
...
- (TSKUIDStructVectorTemplate<TSKUIDStruct>)rowUIDsForRowRange:(SEL)a3
{
  ...
  v8 = objc_msgSend_columnRowUIDMap(self->_tableModel, a3, a4.location, a4.length, v4);
  v12 = v8;
  if (v8)
  {
...
- (TSKUIDStructVectorTemplate<TSKUIDStruct>)viewOrderedRowUids:(SEL)a3
{
  v8 = objc_msgSend_rowIndexesForUIDs_(self->_tableInfo, a3, a4, v4, v5);
  tableInfo = self->_tableInfo;
  v13 = v8;
  if (tableInfo)
  {
...
- (unsigned)columnIndexForColumnUID:(const TSKUIDStruct *)a3
{
  v5 = a3;
  v6 = objc_msgSend_columnRowUIDMap(self->_tableModel, a2, a3, v3, v4);
  LOWORD(v5) = objc_msgSend_columnIndexForColumnUID_(v6, v7, v5->_lower, v5->_upper, v8);
...
- (TSCERangeCoordinate)expandCellRangeToCoverMergedCells:(const TSCERangeCoordinate *)a3
{
  ...
  v8 = objc_msgSend_range(self->_tableModel, a2, a3, v3, v4);
...
- (TSUModelCellRect)mergedRangeForBaseCellCoord:(const TSUModelCellCoord *)a3
{
  v5 = objc_msgSend_mergedRangeForBaseCellCoord_(self->_tableModel, a2, *a3, v3, v4);
  result.var0.size = v6;
...
{
  v3 = a3;
  v8 = objc_msgSend_rangeCoord(v3, v4, v5, v6, v7);
  v31._topLeft = v8;
  v31._bottomRight = v9;
  if (v8 == 0x7FFFFFFF || (v8 & 0xFFFF00000000) == 0x7FFF00000000 || v9.row == 0x7FFFFFFF || (*&v9 & 0xFFFF00000000) == 0x7FFF00000000 || WORD2(v8) > v9.column || v8 > v9.row || !TSCERangeCoordinate::isSingleCell(&v31) || (v18 = objc_msgSend_tableResolver(v3, v10, v11, v12, v13)) == 0 || (v30.origin = objc_msgSend_topLeft(v3, v14, v15, v16, v17), v30.origin = TSCETableResolverWrapper::mergedRangeForBaseCellCoord(v18, &v30, v19, v20, v21), v30.size = v22, !TSUCellRect::isValid(&v30)))
  {
    v25 = v3;
  }
...
- (TSCERangeCoordinate)apparentRangeForRange:(const TSCERangeCoordinate *)a3 rangeContext:(unsigned __int8)a4
{
  v5 = a4;
  v8 = 0x7FFF7FFFFFFFLL;
  v9 = objc_msgSend_bodyRange(self->_tableModel, a2, a3, a4, v4);
  v11 = j__TSUCellRectToTSCERangeCoordinate(v9, v10);
  v13 = v12;
...
- (TSCECellTractRefCore)apparentTractRefForTractRef:(SEL)a3 rangeContext:(const TSCECellTractRefCore *)a4
{
  ...
  v50.size = v13;
  v14 = TSCECellTractRefCore::topLeft(a4);
  v15 = TSCECellTractRefCore::bottomRight(a4);
  v49.origin = v14;
    ...
    if (spanType != 2)
    {
      if (spanType != 1)
      {
        if (v5 == 2)
        {
          ...
          *(&retstr->_tableUID._upper + 5) = *(&a4->_tableUID._upper + 5);
          if (isPivotTable)
          {
...
- (id)apparentGridForRangeContext:(id)a3 rangeContext:(unsigned __int8)a4 spansAllColumns:(BOOL)a5 spansAllRows:(BOOL)a6
{
  ...
  v68.size = v15;
  v19 = objc_msgSend_topLeftCoord(v10, v15, v16, v17, v18);
  v24 = objc_msgSend_topLeftCoord(v10, v20, v21, v22, v23);
  v29 = objc_msgSend_dimensions(v10, v25, v26, v27, v28);
  v34 = objc_msgSend_dimensions(v10, v30, v31, v32, v33);
  *(&v35 + 1) = v19;
  *&v35 = v24;
...
LABEL_22:
            objc_msgSend_intersectionWithCellRect_(v10, v51, v50, v51, v52);
            goto LABEL_23;
          }

          v59 = objc_msgSend_bodyColumnRange(self->_tableModel, v46, v47, v48, v49);
          v58 = objc_msgSend_intersectionWithCellRect_(v10, v60, v59, v60, v61);
          goto LABEL_24;
        }
    ...
    else
    {
      if (!v6)
      {
        if (v8 == 2)
        {
          ...
          v58 = objc_msgSend_intersectionWithCellRect_(v10, v56, v55, v56, v57);
LABEL_24:
          v54 = v58;
          goto LABEL_25;
        }
...
LABEL_25:
      ...
      if (v8 != 1)
      {
        if ((v8 & 0xFFFFFFFD) == 0)
        {
          if (!isPivotTable)
          {
            ...
            v58 = objc_msgSend_intersectionWithCellRect_(v10, v65, v64, v65, v66);
            goto LABEL_24;
          }
    ...
    objc_msgSend_intersectionWithCellRect_(v10, v46, *&v68.origin, *&v68.size, v49);
    v58 = LABEL_23:;
    goto LABEL_24;
  }
...
- (void)resetDependenciesForCell:(const TSUCellCoord *)a3 calcEngine:(id)a4
{
  v12 = a4;
  v6 = *a3;
  v11 = objc_msgSend_formulaSpecAtBaseCellCoord_(self->_tableModel, v7, *a3, v8, v9);
  if (v11)
  {
    objc_msgSend_updateCalculationEngineForFormula_inBaseCellCoord_usingCalcEngine_(self->_tableModel, v10, v11, v6, v12);
  }
}
...
- (void)resetAllFormulaDependenciesForCell:(const TSUCellCoord *)a3 calcEngine:(id)a4
{
  v6 = a4;
  v7 = *a3;
  if (!objc_msgSend_cellExistsAtBaseCellCoord_(self->_tableModel, v8, *a3, v9, v10))
  {
    goto LABEL_4;
  }
...
LABEL_4:
    ...
    v60 = v17;
    objc_msgSend_removeFormulaAt_inOwner_(v6, v17, a3, &v59, v18);
    v23 = objc_msgSend_conditionalStyleFormulaOwner(self->_tableModel, v19, v20, v21, v22);
    objc_msgSend_removeFormulaAtCellID_(v23, v24, *a3, v25, v26);
    v15 = v23;
    goto LABEL_5;
  }
  ...
  if (objc_msgSend_hasFormula(v15, v11, v12, v13, v14))
  {
    ...
    if (v36)
    {
      objc_msgSend_updateCalculationEngineForFormula_inBaseCellCoord_usingCalcEngine_(self->_tableModel, v37, v36, v7, v6);
    }
  }
  ...
  else
  {
    ...
    v60 = v42;
    objc_msgSend_removeFormulaAt_inOwner_(v6, v42, a3, &v59, v43);
  }
  ...
  if (objc_msgSend_hasConditionalStyle(v15, v38, v39, v40, v41))
  {
    ...
    objc_msgSend_replaceFormulaForConditionalStyle_atCellID_(v53, v54, v48, *a3, v55);
  }

  else
  {
    v48 = objc_msgSend_conditionalStyleFormulaOwner(self->_tableModel, v44, v45, v46, v47);
    objc_msgSend_removeFormulaAtCellID_(v48, v56, *a3, v57, v58);
  }
...
- (TSUCellCoord)resolvedCellCoordForIntersectionRef:(id)a3 hostCell:(const TSUCellCoord *)a4 useImplicitIntersection:(BOOL)a5
{
  v5 = a5;
  v7 = a3;
  v12 = objc_msgSend_rangeCoord(v7, v8, v9, v10, v11);
  if (objc_msgSend_tableResolver(v7, v13, v14, v15, v16, v12, v13))
  {
    v21 = objc_msgSend_tableResolver(v7, v17, v18, v19, v20);
    v12 = TSCETableResolverWrapper::resolvedCellCoordForIntersection(v21, &v23, a4, v5);
  }
...
- (TSUCellCoord)resolvedCellCoordForIntersection:(const TSCERangeCoordinate *)a3 hostCell:(const TSUCellCoord *)a4 useImplicitIntersection:(BOOL)a5
{
  ...
  topLeft = a3->_topLeft;
  bottomRight = a3->_bottomRight;
  if (bottomRight.row == *&a3->_topLeft && ((*&a3->_topLeft ^ *&bottomRight) & 0x101FFFF00000000) == 0)
  {
  ...
  v12 = objc_msgSend_apparentRangeForRange_rangeContext_(self, a2, a3, 0, a5);
  v13 = v12;
  v15 = v14;
  v16 = HIDWORD(v12);
  v17 = WORD2(v12);
...
LABEL_50:
      ...
      v35 = vmovn_s64(vceqq_s64(vandq_s8(*a3, v34), vdupq_n_s64(0x7FFF00000000uLL)));
      v36 = vuzp1_s16(v35, v35);
      v36.i32[1] = vuzp1_s16(v36, vmovn_s64(vmvnq_s8(vceqq_s64(vandq_s8(*a3, v33), vdupq_n_s64(0x7FFFFFFFuLL))))).i32[1];
  ...
  if (*&a3->_topLeft != 0x7FFFFFFF)
  {
    return 0x7FFF7FFFFFFFLL;
  }

  if ((*&a3->_topLeft & 0xFFFF00000000) == 0x7FFF00000000)
  {
    return 0x7FFF7FFFFFFFLL;
  }
...
- (id)valueForCellCoord:(const TSUCellCoord *)a3 fetchRichTextAttributesIfPlainText:(BOOL)a4
{
  ...
  {
    v6 = objc_msgSend_invalidReferenceError(TSCEError, a2, a3, a4, v4);
  ...
  {
    v11 = a4;
    if (objc_msgSend_isPivotTable(self, a2, a3, a4, v4))
    {
      tableInfo = self->_tableInfo;
      v45 = 0;
      v17 = &v45;
      RichTextAttributesIfPlainText = objc_msgSend_getValue_atCellID_fetchRichTextAttributesIfPlainText_(tableInfo, v15, &v45, *a3, v11);
    }
    ...
    else
    {
      ...
      v44 = 0;
      v17 = &v44;
      RichTextAttributesIfPlainText = objc_msgSend_getValue_atBaseCellCoord_fetchRichTextAttributesIfPlainText_(tableModel, v15, &v44, v19, v11);
    }
...
- (id)valueForCellUID:(const TSKUIDStructCoord *)a3 outGeometricPrecedent:(TSCECellRef *)a4 fetchRichTextAttributesIfPlainText:(BOOL)a5
{
  if (*&a3->_column == 0 || *&a3->_row == 0)
  {
    v29 = objc_msgSend_invalidReferenceError(TSCEError, a2, a3, a4, a5);
  ...
  if (!tableInfo)
  {
    v34 = objc_msgSend_identityTranslator(self->_tableModel, a2, a3, a4, a5);
    row = a3->_row;
    column = a3->_column;
    v70 = row;
    ...
    a4->coordinate = v39;
    a4->_tableUID._lower = v44;
    a4->_tableUID._upper = v45;
    v18 = objc_msgSend_valueForCellCoord_fetchRichTextAttributesIfPlainText_(self, v45, &v67, v6, v46);
    if (v18)
    {
      goto LABEL_8;
    }
  ...
  v10 = objc_msgSend_translator(tableInfo, a2, a3, a4, a5);
  v11 = a3->_row;
  column = a3->_column;
  v70 = v11;
  ...
  v16 = self->_tableInfo;
  v68 = 0;
  objc_msgSend_getValue_atCellID_fetchRichTextAttributesIfPlainText_(v16, v17, &v68, v15, v6);
  v18 = v68;
  ...
  if (v26 == 0x7FFFFFFF || (v26 & 0xFFFF00000000) == 0x7FFF00000000)
  {
    ...
    if (v55 != 0x7FFFFFFF && (v55 & 0xFFFF00000000) != 0x7FFF00000000)
    {
      ...
      a4->coordinate = v55;
      a4->_tableUID._lower = v65;
      a4->_tableUID._upper = v66;
    }
  }
  ...
  else
  {
    ...
    a4->coordinate = v26;
    a4->_tableUID._lower = v27;
    a4->_tableUID._upper = v28;
  }
...
- (id)readValueForReference:(id)a3 fromCellRef:(const TSCECellRef *)a4 outValue:(id *)a5 readOptions:(unsigned __int16)a6
{
  ...
  v15 = objc_msgSend_tableResolver(v10, v11, v12, v13, v14);
  v20 = v15;
  if (v15)
  {
    v25 = TSCETableResolverWrapper::tableUID(v15, v16, v17, v18, v19) == a4->_tableUID._lower && v21 == a4->_tableUID._upper;
    goto LABEL_9;
  }

  v26 = objc_msgSend_tableUID(v10, v16, v17, v18, v19);
  v25 = (v26 | v27) == 0;
  if (v26 | v27)
  {
    v31 = objc_msgSend_calcEngine(self, v27, v28, v29, v30);
    *&v157._columns = objc_msgSend_tableUID(v10, v40, v41, v42, v43);
  ...
  {
LABEL_9:
    v47 = objc_msgSend_tractRef(v10, v21, v22, v23, v24);
    *&v157._columns |= 3u;
    ...
    *(&v157._tableUID._upper + 5) = *(v47 + 77);
    ...
    if ((sub_2210EE8F8(&v157._columns) & 1) == 0)
    {
      ...
      *a5 = objc_msgSend_errorValue_(TSCEErrorValue, v71, v70, v72, v73);
      v74 = v70;
      v75 = 0;
      v6 = v74;
      goto LABEL_53;
    ...
    {
      if ((v6 & 4) == 0 || v157._spanType != 1)
      {
LABEL_13:
        *&v153 = TSCETableResolverWrapper::tableUID(v20, v54, v55, v56, v57);
        v153._singleRange._begin = v58;
        v59 = objc_msgSend_resolvedCellCoordForIntersectionRef_hostCell_useImplicitIntersection_(self, v58, v10, &coordinate, (v6 & 4) == 0);
        v152 = v59;
        ...
        else if (v59 != 0x7FFFFFFF && (v59 & 0xFFFF00000000) != 0x7FFF00000000)
        {
          *&v156._columns = v59;
          ...
          {
            v69 = TSCETableResolverWrapper::valueForCellCoord(v20, &v152, (v6 >> 1) & 1, v67, v68);
            goto LABEL_44;
          }
...
LABEL_44:
        ...
        *&v156._columns = objc_msgSend_rangeCoord(v10, v60, v61, v62, v63, v150);
        v156._columns._singleRange._begin = v137;
        *&v156._columns._singleRange._end = v153;
        if (v25 && TSCERangeRef::containsCellRef(&v156, a4))
        {
...
LABEL_53:
    ...
    v98 = objc_msgSend_rangeContextOverride(v10, v54, v55, v56, v57, v150);
    if (v98 == 3)
    {
      v99 = 1;
    }
    ...
    {
      v99 = objc_msgSend_rangeContextOverride(v10, v94, v95, v96, v97);
    }
    ...
    *(&v156._tableUID._upper + 5) = *(&v157._tableUID._upper + 5);
    ...
    if (v25 && TSCECellTractRefCore::containsCoord(&v156, &coordinate))
    {
      ...
      *a5 = objc_msgSend_errorValue_(TSCEErrorValue, v107, v106, v108, v109);
      v74 = v106;
      v110 = 0;
      v6 = v74;
    }
    ...
    else
    {
      if (v157._spanType - 1 > 1)
      {
        ...
        *&v153 = 0;
        isOutputOfAFunction = objc_msgSend_initWithEvalRef_hostCell_preserveFlags_permitsAccessInsideMergeRegions_isOutputOfAFunction_(v126, v127, v10, &coordinate, &v153, v6 & 1, 0);
      ...
      else
      {
        ...
        *&v153 = 0;
        v121 = objc_msgSend_initWithEvalRef_hostCell_preserveFlags_permitsAccessInsideMergeRegions_isOutputOfAFunction_(v119, v120, isOutputOfAFunction, &coordinate, &v153, v6 & 1, 0);
        v122 = [TSCEReferenceBackedGrid alloc];
        inited = objc_msgSend_initWitRefValue_rangeContext_(v122, v123, v121, v99, v124);
      }

      objc_msgSend_setPermitsAccessInsideMergeRegions_(inited, v131, v6 & 1, v132, v133);
      *a5 = objc_msgSend_gridValue_(TSCEGridValue, v134, inited, v135, v136);
  ...
  *a5 = objc_msgSend_nilValue(TSCENilValue, v87, v88, v89, v90);
...
{
  v8 = a4;
  v10 = objc_msgSend_resolvedCellCoordForIntersectionRef_hostCell_useImplicitIntersection_(self, v9, v8, a5, 1);
  v22 = 0;
  v15 = objc_msgSend_tableResolver(v8, v11, v12, v13, v14);
  v21 = v10;
  if (v15)
  {
...
- (int64_t)interactionTypeForCell:(const TSUModelCellCoord *)a3
{
  v7 = objc_msgSend_newCell(self->_tableModel, a2, a3, v3, v4);
  objc_msgSend_getCell_atBaseCellCoord_suppressCellBorder_(self->_tableModel, v8, v7, *a3, 1);
...
- (unsigned)getHidingAction:(id)a3 forRow:(BOOL)a4
{
  v4 = a4;
  v5 = a3;
  v10 = objc_msgSend_topLeft(v5, v6, v7, v8, v9);
  v15 = objc_msgSend_bottomRight(v5, v11, v12, v13, v14);
  ...
  v31 = objc_msgSend_tableResolver(v5, v16, v17, v18, v19);
  if (v31)
  {
  ...
  v51 = objc_msgSend_topLeft(v5, v47, v48, v49, v50);
  if (v4)
  {
...
- (TSKUIDStruct)resolveRelativeAncestorUid:(const TSKUIDStruct *)a3 sourceRowUID:(const TSKUIDStruct *)a4
{
  v7 = objc_msgSend_tableInfo(self->_tableModel, a2, a3, a4, v4);
  v12 = objc_msgSend_groupBy(v7, v8, v9, v10, v11);

  v15 = objc_msgSend_resolveRelativeAncestorUid_atRowUid_(v12, v13, a3, a4, v14);
  v17 = v16;
...
- (TSKUIDStruct)convertToRelativeAncestorUid:(const TSKUIDStruct *)a3 rowUid:(const TSKUIDStruct *)a4
{
  ...
  v15 = objc_msgSend_convertToRelativeAncestorUid_atRowUid_(v12, v13, a3, a4, v14);
  v17 = v16;
...
- (id)resolveCategoryRefAtRowUid:(id)a3 rowUid:(const TSKUIDStruct *)a4 containingTableUID:(const TSKUIDStruct *)a5
{
  ...
  v20 = objc_msgSend_resolveCategoryRef_atRowUid_inHostTable_(v18, v19, v8, a4, a5);
...
- (unsigned)groupLevelForGroupUid:(const TSKUIDStruct *)a3
{
  ...
  LOBYTE(v6) = objc_msgSend_groupLevelForGroupUid_(v11, v12, a3->_lower, a3->_upper, v13);
  return v6;
}
...
- (TSKUIDStruct)relativeAncestorGroupUid:(int)a3
{
  v5 = objc_msgSend_relativeAncestorGroupUid_(TSTGroupBy, a2, *&a3, v3, v4);
  result._upper = v6;
  result._lower = v5;
  return result;
}
...
- (TSCECellRef)indirectAggTypeChangePrecedent:(SEL)a3
{
  v17 = objc_msgSend_calcEngine(self->_tableModel, a3, a4, v4, v5);
...
- (TSCECellRef)groupingColumnOrderPrecedent:(SEL)a3
{
  v8 = objc_msgSend_calcEngine(self->_tableModel, a3, a4, v4, v5);
...
{
  v6 = a5;
  v9 = objc_msgSend_calcEngine(self->_tableModel, a3, a4, a5, v5);
  v11 = objc_msgSend_groupByForUID_withCalcEngine_(TSTGroupBy, v10, a4->_lower, a4->_upper, v9);
  v16 = v11;
  retstr->_tableUID._lower = 0;
  retstr->_tableUID._upper = 0;
  retstr->coordinate = 0x7FFF7FFFFFFFLL;
...
- (id)valuesForViewTractRef:(id)a3 hidingActionMask:(unsigned __int8)a4 outError:(id *)a5 outGeometricPrecedents:(void *)a6 forceHidingOfPivotFiltered:(BOOL)a7
{
  ...
  if (v242 && objc_msgSend_isValidOrSpanning(v9, v29, v30, v31, v32))
  {
    v244 = objc_msgSend_tableInfo(v242, v29, v30, v31, v32);
    v37 = objc_msgSend_spansAllColumns(v9, v33, v34, v35, v36);
    v42 = objc_msgSend_spansAllRows(v9, v38, v39, v40, v41);
    if (objc_msgSend_isFixedAtZeroRef(v9, v43, v44, v45, v46))
    {
    ...
    {
      v58 = objc_msgSend_tract(v9, v47, v48, v49, v50);
      v63 = objc_msgSend_columnUids(v58, v59, v60, v61, v62);

      v68 = objc_msgSend_tract(v9, v64, v65, v66, v67);
    ...
    if (a6)
    {
      ...
      v255._upper = v206;
      TSCECellRefSet::addCellRefs(a6, &v255, (*&v271.size + 48));
      ...
      v255._upper = v216;
      TSCECellRefSet::addCellRefs(a6, &v255, (v262 + 6));
    ...
    else
    {
      ...
      if (a5 && !v233)
      {
        *a5 = objc_msgSend_invalidReferenceError(TSCEError, v234, v235, v236, v237);
...
- (id)valuesForViewTractRef:(id)a3 hidingActionMask:(unsigned __int8)a4 outError:(id *)a5
{
  v5 = objc_msgSend_valuesForViewTractRef_hidingActionMask_outError_outGeometricPrecedents_forceHidingOfPivotFiltered_(self, a2, a3, a4, a5, 0, 0);
  ...
  if (v4)
  {
    ...
    if (v12)
    {
      ...
      if (objc_msgSend_isValid(v6, v8, v9, v10, v11))
      {
        ...
        v26 = objc_msgSend_spansAllColumns(v6, v22, v23, v24, v25);
        v31 = objc_msgSend_spansAllRows(v6, v27, v28, v29, v30);
        v36 = objc_msgSend_columns(v6, v32, v33, v34, v35);
        v37 = TSUIndexSet::asNSIndexSet(v36);
        v42 = objc_msgSend_rows(v6, v38, v39, v40, v41);
...
- (id)solveGetPivotData:(id)a3 functionSpec:(id)a4 context:(id)a5
{
  ...
  if (v27)
  {
    ...
    v210 = objc_msgSend_aggregateFieldName(v8, v33, v34, v35, v36);
    v43 = objc_msgSend_aggregateIndexForAggName_locale_(v27, v37, v210, v214, v38);
    if (v43 == 0xFFFF)
    {
      v58 = objc_msgSend_functionName(v9, v39, v40, v41, v42);
...
LABEL_31:
    ...
    v215 = 0;
    v198 = objc_msgSend_isForChartFormulas(v213, v194, v195, v196, v197);
    ...
    else
    {
      ...
      {
LABEL_30:
        objc_msgSend_addCalculatedPrecedents_(v213, v201, &v219, v203, v204);
...
{
  v4 = a3;
  v151[0] = objc_msgSend_tableUID(v4, v5, v6, v7, v8);
  v151[1] = v9;
  if (!(v151[0] | v9))
  {
  ...
  if (v27 && objc_msgSend_isValidOrSpanning(v4, v23, v24, v25, v26))
  {
    v32 = objc_msgSend_tableInfo(v27, v28, v29, v30, v31);
    v37 = objc_msgSend_spansAllColumns(v4, v33, v34, v35, v36);
    v42 = objc_msgSend_spansAllRows(v4, v38, v39, v40, v41);
    if (objc_msgSend_isFixedAtZeroRef(v4, v43, v44, v45, v46))
    {
      v55 = objc_msgSend_indexSetWithIndex_(MEMORY[0x277CCAA78], v47, 0, v49, v50);
      v56 = v55;
    }
    ...
    {
      v58 = objc_msgSend_tract(v4, v47, v48, v49, v50);
      v63 = objc_msgSend_columnUids(v58, v59, v60, v61, v62);

      v68 = objc_msgSend_tract(v4, v64, v65, v66, v67);
      v73 = objc_msgSend_rowUids(v68, v69, v70, v71, v72);
    ...
    v144 = objc_msgSend_preserveFlags(v4, v140, v141, v142, v143);
...
- (id)viewTractRefForCellTractRef:(id)a3
{
  ...
  v18 = objc_msgSend_uidRectRefForCellTractRef_(v14, v15, v4, v16, v17);
  ...
  if (v18)
  {
    ...
    if (objc_msgSend_spansAllRows(v4, v23, v24, v25, v26))
    {
      operator new();
    }

    if (objc_msgSend_spansAllColumns(v4, v27, v28, v29, v30))
    {
      operator new();
    }
    ...
    v45 = objc_msgSend_preserveFlags(v4, v41, v42, v43, v44, v40, v41);
