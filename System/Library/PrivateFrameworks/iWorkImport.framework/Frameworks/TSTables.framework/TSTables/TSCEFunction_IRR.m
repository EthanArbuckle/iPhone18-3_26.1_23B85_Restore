...
+ (TSUDecimal)solveByNewtonsWithVector:(id)a3 vector:(id)a4 initial:(const TSUDecimal *)a5 outError:(id *)a6;
...
+ (id)evaluateForArgsWithContext:(id)a3 functionSpec:(id)a4 arguments:(const void *)a5
{
  ...
  v112[0] = 0;
  v98 = v9;
  v11 = objc_msgSend_asGrid_functionSpec_argumentIndex_applyPreferredFormat_outError_(v9, v10, a3, a4, 0, 1, v112);
  v12 = v112[0];
  if (v12)
  {
    v16 = v12;
  ...
  if (*(a5 + 1) - *a5 >= 9uLL)
  {
    ...
    {
      v110 = 0;
      v28 = objc_msgSend_asNumber_functionSpec_argumentIndex_outError_(v22, v27, a3, a4, 1, &v110);
      v16 = v110;
      v111[0] = objc_msgSend_decimalRepresentation(v28, v29, v30, v31, v32);
      v111[1] = v33;
      if (v16)
      {
        v17 = objc_msgSend_raiseErrorOrConvert_(a3, v33, v16, v34, v35);
  ...
  *(v106 + 7) = 0;
  ...
  {
LABEL_21:
    v67 = objc_msgSend_functionName(a4, v37, v38, v39, v40);
    v71 = objc_msgSend_onlyPositiveOrNegativeErrorForFunctionName_(TSCEError, v68, v67, v69, v70);
    v75 = objc_msgSend_raiseErrorOrConvert_(v41, v72, v71, v73, v74);
LABEL_22:
    v17 = v75;
  ...
  do
  {
    v45 = objc_msgSend_valueAtIndex_accessContext_(v11, v37, v42, v104, v40, v97);
    if ((objc_msgSend_isNil(v45, v46, v47, v48, v49) & 1) == 0)
    {
      v103 = 0;
      v51 = objc_msgSend_asNumber_functionSpec_argumentIndex_outError_(v45, v50, v41, a4, 0, &v103);
      v16 = v103;
      ...
      if (v16)
      {
        v17 = objc_msgSend_raiseErrorOrConvert_(v41, v57, v16, v58, v59);
  ...
  v101 = 0;
  v60 = objc_msgSend_solveByNewtonsWithVector_vector_initial_outError_(v97, v37, v41, v11, v111, &v101);
  v62 = v61;
  v16 = v101;
  ...
  if (v16)
  {
    v66 = objc_msgSend_raiseErrorOrConvert_(v41, v63, v16, v64, v65);
LABEL_20:
    v17 = v66;
    goto LABEL_25;
  }
  ...
  if (TSUDecimal::isNaN(&v102))
  {
    ...
    if ((TSUDecimal::operator==() & 1) == 0)
    {
      TSUDecimal::operator=();
      v100 = 0;
      v78 = objc_msgSend_solveByNewtonsWithVector_vector_initial_outError_(v97, v77, v41, v11, v99, &v100);
      v80 = v79;
      v81 = v100;
      ...
      {
        v16 = v81;
        v66 = objc_msgSend_raiseErrorOrConvert_(v41, v82, v81, v83, v84);
        goto LABEL_20;
      }
    }
  }
  ...
  if (TSUDecimal::isNaN(&v102))
  {
    v67 = objc_msgSend_functionName(a4, v85, v86, v87, v88);
    v71 = objc_msgSend_numberDoesNotConvergeWithEstimateErrorForFunctionName_(TSCEError, v89, v67, v90, v91);
    v75 = objc_msgSend_raiseErrorOrConvert_(v41, v92, v71, v93, v94);
    goto LABEL_22;
  }
...
+ (TSUDecimal)solveByNewtonsWithVector:(id)a3 vector:(id)a4 initial:(const TSUDecimal *)a5 outError:(id *)a6
{
  ...
  v66 = a3;
  v10 = a4;
  v15 = objc_msgSend_functionSpec(a1, v11, v12, v13, v14);
  TSUDecimal::operator=();
  TSUDecimal::operator=();
  TSUDecimal::operator=();
  TSUDecimal::operator=();
...
LABEL_7:
    ...
    if (v20)
    {
      ...
      for (i = 0; i != v20; ++i)
      {
        ...
        {
          v51 = objc_msgSend_asNumber_functionSpec_argumentIndex_outError_(v27, v50, v21, v15, 0, a6);
...
LABEL_27:
  ...
  while (1)
  {
    ...
    {
      v33 = objc_msgSend_asNumber_functionSpec_argumentIndex_outError_(v27, v32, v21, v15, 0, a6);
