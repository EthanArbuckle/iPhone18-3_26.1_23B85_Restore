...
+ (id)evaluateForArgsWithContext:(id)context functionSpec:(id)spec arguments:(const void *)arguments
{
  ...
  v36 = 0;
  v17 = objc_msgSend_asNumber_functionSpec_argumentIndex_outError_(v8, v13, context, spec, 0, &v36);
  v22 = v36;
  if (v22)
  {
    v23 = objc_msgSend_raiseErrorOrConvert_(context, v18, v22, v20, v21);
LABEL_5:
    v24 = v23;
    goto LABEL_10;
  }
  ...
  if (v26 >= 1 && v26 < ((*(arguments + 1) - *arguments) >> 3))
  {
    v23 = *(*arguments + 8 * (v26 & 0x7FFFFFFF));
    goto LABEL_5;
  }

  v30 = objc_msgSend_invalidIndexForChooseError_(TSCEError, v27, v26, v28, v29);
  v24 = objc_msgSend_raiseErrorOrConvert_(context, v31, v30, v32, v33);
