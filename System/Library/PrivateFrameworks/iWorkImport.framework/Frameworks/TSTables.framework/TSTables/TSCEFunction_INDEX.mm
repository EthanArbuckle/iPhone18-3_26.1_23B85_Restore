...
+ (id)evaluateForArgsWithContext:(id)context functionSpec:(id)spec arguments:(const void *)arguments
{
  ...
  v242 = 0;
  v228 = v8;
  v10 = objc_msgSend_asGrid_functionSpec_argumentIndex_applyPreferredFormat_outError_(v8, v9, context, spec, 0, 1, &v242);
  v11 = v242;
  if (v11)
  {
    v15 = v11;
  ...
  if (v10)
  {
    objc_msgSend_formatWithContext_(v10, v12, context, v13, v14);
  }
  ...
  v227 = *(*arguments + 8);
  if (objc_msgSend_deepType_(v227, v17, context, v18, v19) == 10)
  {
    v24 = 0;
  }
  ...
  else
  {
    if (v227)
    {
      objc_msgSend_formatWithContext_(v227, v20, context, v22, v23);
    }
    ...
    sub_22114F414(&v243, v235);
    v241 = 0;
    v26 = objc_msgSend_asNumber_functionSpec_argumentIndex_outError_(v227, v25, context, spec, 1, &v241);
    v15 = v241;
    if (v15)
    {
      v16 = objc_msgSend_raiseErrorOrConvert_(context, v27, v15, v29, v30);
  ...
  else
  {
    if (v32)
    {
      objc_msgSend_formatWithContext_(v32, v41, context, v42, v43);
    }
    ...
    sub_22114F414(&v243, v235);
    v240 = 0;
    v122 = objc_msgSend_asNumber_functionSpec_argumentIndex_outError_(v32, v121, context, spec, 2, &v240);
    v15 = v240;
    if (v15)
    {
      v16 = objc_msgSend_raiseErrorOrConvert_(context, v123, v15, v125, v126);
...
LABEL_84:
      ...
      v91 = objc_msgSend_raiseErrorOrConvert_(context, v135, v87, v136, v137);
      goto LABEL_85;
    }
  ...
  else
  {
    ...
    sub_22114F414(&v243, v235);
    v239 = 0;
    v129 = objc_msgSend_asNumber_functionSpec_argumentIndex_outError_(v44, v128, context, spec, 3, &v239);
    v15 = v239;
    if (v15)
    {
      v16 = objc_msgSend_raiseErrorOrConvert_(context, v130, v15, v132, v133);
...
LABEL_85:
    ...
    {
      v87 = objc_msgSend_functionName(spec, v93, v94, v95, v96);
      v117 = objc_msgSend_numberErrorForFunctionName_(TSCEError, v114, v87, v115, v116);
      v16 = objc_msgSend_raiseErrorOrConvert_(context, v118, v117, v119, v120);
...
LABEL_127:
  ...
  *&v235[8] = spec;
  ...
  while (1)
  {
    ...
    {
      v139 = objc_msgSend_errorWithContext_(v64, v69, contextCopy, v71, v72);
      v16 = objc_msgSend_raiseErrorOrConvert_(contextCopy, v140, v139, v141, v142);
LABEL_98:
...
LABEL_46:
  ...
  if (v78 != 1)
  {
    if (v78 != 6)
    {
      v139 = objc_msgSend_functionName(spec, v79, v80, v81, v82);
    ...
    {
      v234 = 0;
      v83 = objc_msgSend_asGrid_functionSpec_argumentIndex_applyPreferredFormat_outError_(v64, v79, contextCopy, spec, 0, 1, &v234);
      v15 = v234;
  ...
  v233 = 0;
  v83 = objc_msgSend_asGrid_functionSpec_argumentIndex_applyPreferredFormat_outError_(v64, v79, contextCopy, spec, 0, 1, &v233);
  v15 = v233;
