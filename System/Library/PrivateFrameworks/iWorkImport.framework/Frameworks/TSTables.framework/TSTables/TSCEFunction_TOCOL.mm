...
+ (id)evaluateForArgsWithContext:(id)a3 functionSpec:(id)a4 arguments:(const void *)a5
{
  ...
  v9 = **a5;
  v105 = 0;
  v11 = objc_msgSend_asGrid_functionSpec_argumentIndex_applyPreferredFormat_outError_(v9, v10, a3, a4, 0, 0, &v105);
  v12 = v105;
  if (v12)
  {
    v17 = v12;
  ...
  v19 = *(*a5 + 8);
  if ((objc_msgSend_isTokenOrEmptyArg(v19, v20, v21, v22, v23) & 1) != 0 || objc_msgSend_deepType_(v19, v24, a3, v25, v26) == 10)
  {
    v28 = 0;
    goto LABEL_7;
  }
  ...
  v104 = 0;
  v72 = objc_msgSend_asNumber_functionSpec_argumentIndex_outError_(v19, v27, a3, a4, 1, &v104);
  v17 = v104;
  v77 = objc_msgSend_integer(v72, v73, v74, v75, v76);

  if (v17)
  {
    v18 = objc_msgSend_raiseErrorOrConvert_(a3, v78, v17, v80, v81);
LABEL_42:
  ...
  if (v77 >= 4)
  {
    v86 = objc_msgSend_functionName(a4, v78, v79, v80, v81);
    v89 = objc_msgSend_invalidArgumentsErrorForFunctionName_argumentIndex_(TSCEError, v87, v86, 2, v88);
    v18 = objc_msgSend_raiseErrorOrConvert_(a3, v90, v89, v91, v92);
...
LABEL_7:
  ...
  if (*(a5 + 1) - *a5 >= 0x11uLL)
  {
    ...
    {
      v103 = 0;
      v35 = objc_msgSend_asBoolean_functionSpec_argumentIndex_outError_(v29, v34, a3, a4, 2, &v103);
      v82 = v103;
      if (v82)
      {
        v17 = v82;
        v18 = objc_msgSend_raiseErrorOrConvert_(a3, v83, v82, v84, v85);
...
LABEL_12:
  ...
  if (!(v102.height * v102.width))
  {
    ...
    v18 = objc_msgSend_raiseErrorOrConvert_(a3, v65, v40, v66, v67);
    goto LABEL_31;
  }
  ...
  *(&v96 + 7) = 0;
  ...
  do
  {
    ...
    if (objc_msgSend_deepType_(v44, v45, v43, v46, v47, v93, v94, v95, v96, *(&v96 + 1), *&v97, v98, v99, v100, *(&v100 + 1)) != 9)
    {
      if (v28 & 0xFFFFFFFFFFFFFFFDLL) == 1 && (objc_msgSend_valueIsEmptyWithContext_(v48, v45, v43, v49, v47))
      {
        goto LABEL_21;
      }
...
LABEL_21:
  ...
  else
  {
    ...
    objc_msgSend_raiseErrorOrConvert_(v43, v68, v61, v69, v70);
  }
  v18 = ;
