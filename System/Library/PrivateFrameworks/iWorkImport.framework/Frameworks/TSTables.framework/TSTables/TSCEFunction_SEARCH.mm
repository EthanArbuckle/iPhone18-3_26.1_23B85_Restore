...
+ (id)evaluateForArgsWithContext:(id)a3 functionSpec:(id)a4 arguments:(const void *)a5
{
  ...
  v141 = 0;
  v14 = objc_msgSend_asString_functionSpec_argumentIndex_outError_(v12, v13, a3, a4, 0, &v141);
  v15 = v141;
  if (v15)
  {
    v20 = v15;
  ...
  if (v23)
  {
    objc_msgSend_formatWithContext_(v23, v24, a3, v25, v26);
  }
  ...
  sub_22114F414(&v143, &v142);
  v140 = 0;
  v29 = objc_msgSend_asString_functionSpec_argumentIndex_outError_(v27, v28, a3, a4, 1, &v140);
  v30 = v140;
  if (!v30)
  {
    if (*(a5 + 1) - *a5 < 0x11uLL)
...
LABEL_16:
      ...
      if (objc_msgSend_length(v14, v43, v44, v45, v46) || objc_msgSend_length(v29, v47, v48, v49, v50))
      {
        ...
        {
          v73 = objc_msgSend_functionName(a4, v51, v52, v53, v54);
          v77 = objc_msgSend_startNumberExceedsStringLengthErrorForFunctionName_(TSCEError, v74, v73, v75, v76);
          v21 = objc_msgSend_raiseErrorOrConvert_(a3, v78, v77, v79, v80);
        }
        ...
        else
        {
          if (objc_msgSend_length(v14, v51, v52, v53, v54))
          {
            ...
            if (v20)
            {
              v95 = objc_msgSend_raiseErrorOrConvert_(a3, v70, v20, v71, v72);
            }
            ...
            else
            {
              ...
              if (MatchInString_options_range == 0x7FFFFFFFFFFFFFFFLL)
              {
                ...
                v122 = objc_msgSend_functionName(a4, v118, v119, v120, v121);
                v124 = objc_msgSend_matchNotFoundErrorForValue_isRegex_functionName_(TSCEError, v123, v117, isRegexString, v122);
                v21 = objc_msgSend_raiseErrorOrConvert_(a3, v125, v124, v126, v127);
...
LABEL_42:
      ...
      else
      {
        ...
        v21 = objc_msgSend_raiseErrorOrConvert_(a3, v91, v90, v92, v93);
      }
    ...
    if (v34)
    {
      objc_msgSend_formatWithContext_(v34, v39, a3, v40, v41);
    }
    ...
    {
      v104 = objc_msgSend_functionName(a4, v100, v101, v102, v103);
      ...
      v21 = objc_msgSend_raiseErrorOrConvert_(a3, v107, v106, v108, v109);
    ...
    {
      v139 = 0;
      v104 = objc_msgSend_asNumber_functionSpec_argumentIndex_outError_(v34, v100, a3, a4, 2, &v139);
      v20 = v139;
      v135 = v104;
      if (!v20)
      {
      ...
      v21 = objc_msgSend_raiseErrorOrConvert_(a3, v110, v20, v112, v113);
    }
