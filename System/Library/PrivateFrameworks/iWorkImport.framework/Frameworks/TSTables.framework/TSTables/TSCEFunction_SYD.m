...
+ (id)evaluateForArgsWithContext:(id)a3 functionSpec:(id)a4 arguments:(const void *)a5
{
  ...
  sub_221327DF4(v91, a4, v8);

  v9 = **a5;
  v90 = 0;
  v11 = objc_msgSend_asNumber_functionSpec_argumentIndex_outError_(v9, v10, a3, a4, 0, &v90);
  v12 = v90;
  ...
  v24 = *(*a5 + 8);
  v89 = 0;
  v26 = objc_msgSend_asNumber_functionSpec_argumentIndex_outError_(v24, v25, a3, a4, 1, &v89);
  v12 = v89;
  ...
  if (!v12)
  {
    if (v92)
    {
      v21 = objc_msgSend_raiseErrorOrConvert_(a3, v31, v92, v32, v33);
      v12 = 0;
      goto LABEL_17;
    }
    ...
    v88[0] = 0;
    v81 = v34;
    v36 = objc_msgSend_asNumber_functionSpec_argumentIndex_outError_(v34, v35, a3, a4, 2, v88);
    v12 = v88[0];
    v80 = v36;
    v37 = v36;
    v24 = v82;
    ...
    *(&v87 + 1) = v42;
    if (v12)
    {
      v21 = objc_msgSend_raiseErrorOrConvert_(a3, v42, v12, v43, v44);
LABEL_16:
    ...
    v86 = 0;
    v79 = v45;
    v47 = objc_msgSend_asNumber_functionSpec_argumentIndex_outError_(v45, v46, a3, a4, 3, &v86);
    v12 = v86;
    v84 = objc_msgSend_decimalRepresentation(v47, v48, v49, v50, v51);
    v85 = v52;
    if (v12)
    {
      v55 = objc_msgSend_raiseErrorOrConvert_(a3, v52, v12, v53, v54);
    }
    ...
    else
    {
      ...
      {
        v60 = objc_msgSend_functionName(a4, v56, v57, v58, v59);
        ...
        v21 = objc_msgSend_raiseErrorOrConvert_(a3, v63, v62, v64, v65);
