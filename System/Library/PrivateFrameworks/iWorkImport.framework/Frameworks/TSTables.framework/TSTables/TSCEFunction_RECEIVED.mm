...
+ (id)evaluateForArgsWithContext:(id)context functionSpec:(id)spec arguments:(const void *)arguments
{
  ...
  v148 = 0;
  v14 = objc_msgSend_asDate_functionSpec_argumentIndex_outError_(v12, v13, context, spec, 0, &v148);
  v19 = v148;
  if (v19)
  {
  ...
  if (v14)
  {
    ...
    sub_22114F414(&v150, &v149);
    v147 = 0;
    v37 = objc_msgSend_asDate_functionSpec_argumentIndex_outError_(v30, v36, context, spec, 1, &v147);
    v19 = v147;
    if (v19)
    {
...
LABEL_48:
    ...
    if (!v37)
    {
      v139 = objc_msgSend_functionName(spec, v38, v39, v40, v41);
...
LABEL_47:
    ...
    sub_22114F414(&v150, &v149);
    v146 = 0;
    v54 = objc_msgSend_asNumber_functionSpec_argumentIndex_outError_(v46, v53, context, spec, 2, &v146);
    v19 = v146;
    v137 = v54;
    v55 = v54;
    v49 = v138;
...
LABEL_46:
    ...
    sub_22114F414(&v150, &v149);
    v145 = 0;
    v69 = objc_msgSend_asNumber_functionSpec_argumentIndex_outError_(v136, v68, context, spec, 3, &v145);
    v19 = v145;
    v135 = v69;
...
LABEL_45:
    ...
    else
    {
      ...
      else
      {
        ...
        sub_22114F414(&v150, &v149);
        v144 = 0;
        v89 = objc_msgSend_asNumber_functionSpec_argumentIndex_outError_(v79, v88, context, spec, 4, &v144);
        v19 = v144;
        v128 = v89;
    ...
    *&v149._formatType = v133;
    ...
    v20 = objc_msgSend_raiseErrorOrConvert_(context, v122, v79, v123, v124);
LABEL_44:
