...
- (BOOL)auditTilesForRowOverlapAndExtensionPastTableBounds:(TSUCellCoord)a3 withDataStore:(id)a4 result:(id *)a5;
- (BOOL)needToUpgradeCellStorage;
- (NSIndexSet)populatedRows;
- (NSIndexSet)populatedTiles;
- (TSTTableTileStorage)initWithOwner:(id)a3;
- (TSTTableTileStorage)initWithStorageArchive:(const void *)a3 treeArchive:(const void *)a4 nextTileID:(unint64_t)a5 unarchiver:(id)a6 owner:(id)a7;
- (id)_createTileWithID:(unint64_t)a3;
- (id)_groupForTileID:(unint64_t)a3;
- (id)_tileForID:(unint64_t)a3 createIfMissing:(BOOL)a4;
- (id)_tileFromGroupForTileID:(unint64_t)a3;
- (id)_yankRowRange:(_NSRange)a3;
- (id)columnCellCountsOfRowsInRange:(_NSRange)a3;
- (id)removeColumnsAtIndex:(unsigned __int16)a3 count:(unsigned int)a4;
- (id)rowInfoAtIndex:(unsigned int)a3;
- (id)tileForWritingAtRowIndex:(unsigned int)a3 outTileRange:(_NSRange *)a4;
- (id)tileStartingAtOrAfterRowIndex:(unsigned int)a3 outTileRange:(_NSRange *)a4;
- (id)tileStartingAtOrBeforeRowIndex:(unsigned int)a3 outTileRange:(_NSRange *)a4;
- (multimap<TSUCellCoord,)makeStorageMap;
- (unint64_t)archivingCompatibilityVersion;
- (unsigned)lastPopulatedRowIndex;
- (void)_clearContentAtIndex:(unsigned int)a3 count:(unsigned int)a4;
- (void)_enumerateGroups:(id)a3;
- (void)_enumerateLoadedTiles:(id)a3;
- (void)_enumerateTiles:(id)a3;
- (void)_insertRowsAtIndex:(unsigned int)a3 count:(unsigned int)a4;
- (void)_removeRowsAtIndex:(unsigned int)a3 count:(unsigned int)a4;
- (void)_removeTileForID:(unint64_t)a3;
- (void)_setTile:(id)a3 forID:(unint64_t)a4;
- (void)_shiftRowsDownAtIndex:(unsigned int)a3 count:(unsigned int)a4;
- (void)_shiftRowsUpAtIndex:(unsigned int)a3 count:(unsigned int)a4;
- (void)_spliceRows:(id)a3 atIndex:(unsigned int)a4;
- (void)_upgradeFromTileIDMap:(void *)a3 referenceMap:(void *)a4;
- (void)enumerateRowByRowInRange:(_NSRange)a3 withBlock:(id)a4;
- (void)enumerateRowsInRange:(_NSRange)a3 withBlock:(id)a4;
- (void)enumerateRowsWithBlock:(id)a3;
- (void)enumerateTilesConcurrentlyUsingBlock:(id)a3;
- (void)insertColumnsAtIndex:(unsigned __int16)a3 count:(unsigned int)a4;
- (void)insertRowsAtIndex:(unsigned int)a3 count:(unsigned int)a4;
...
- (void)pruneTileForRowIndex:(unsigned int)a3;
- (void)pruneTilesForRows:(id)a3;
- (void)removeRowsAtIndex:(unsigned int)a3 count:(unsigned int)a4;
- (void)reset;
- (void)saveToStorageArchive:(void *)a3 treeArchive:(void *)a4 archiver:(id)a5;
...
- (TSTTableTileStorage)initWithOwner:(id)a3
{
  ...
  v9 = [(TSTTableTileStorage *)&v17 initWithOwner:v4];
  if (v9)
  {
...
- (TSTTableTileStorage)initWithStorageArchive:(const void *)a3 treeArchive:(const void *)a4 nextTileID:(unint64_t)a5 unarchiver:(id)a6 owner:(id)a7
{
  ...
  v16 = [(TSTTableTileStorage *)&v104 initWithOwner:v11];
  if (v16)
  {
    ...
    v16->_shouldUseWideRows = *(a3 + 52) & (v19 << 30 >> 31);
    v16->_archivingCompatibilityVersion = objc_msgSend_messageVersion(v81, v21, v22, v23, v24);
    if ((v19 & 1) == 0 || v20 != 256)
    {
      v90 = 0;
      v91 = &v90;
      ...
      v84 = &v90;
      v85 = v87;
      objc_msgSend_addFinalizeHandler_(v81, v75, v82, v76, v77);
    ...
    v11 = v79;
    v16 = p_isa;
    if (objc_msgSend_fileFormatVersion(v81, v25, v26, v27, v28) <= 0xB000000000000)
    {
      ...
      v99[3] = &unk_27845E3F8;
      v100 = p_isa;
      objc_msgSend_addFinalizeHandler_(v81, v40, v99, v41, v42);
...
- (void)saveToStorageArchive:(void *)a3 treeArchive:(void *)a4 archiver:(id)a5
{
  ...
  *(a3 + 12) = 256;
  ...
  objc_msgSend_setMessageVersion_(v8, v20, v19, v21, v22);
  ...
  if (v19 != 0xA000000000003)
  {
    ...
    {
      objc_msgSend_requiresDocumentVersion_featureIdentifier_(v8, v23, v19, @"TSTFutureProofCell", v25);
      goto LABEL_27;
    }
    ...
    if (v19 <= 0xD000000000000)
    {
      ...
      {
        objc_msgSend_requiresDocumentVersion_featureIdentifier_(v8, v23, 0xB000200000006, @"TSTPivotTables", v25);
        goto LABEL_27;
      }

      if (v19 == 0xC000000000007)
      {
        objc_msgSend_requiresDocumentVersion_featureIdentifier_(v8, v23, 0xC000000000007, @"TSTPivotTables v2", v25);
        goto LABEL_27;
      }
    }
    ...
    else
    {
      switch(v19)
      {
        case 0xD000000000001:
          objc_msgSend_requiresDocumentVersion_featureIdentifier_(v8, v23, 0xD000000000001, @"TSTDropPreBNCData", v25);
          goto LABEL_27;
        case 0xD000000000002:
          objc_msgSend_requiresDocumentVersion_featureIdentifier_(v8, v23, 0xD000000000002, @"TSTPivotTables MoreAggregates", v25);
          goto LABEL_27;
        case 0xE000400000001:
          objc_msgSend_requiresDocumentVersion_featureIdentifier_(v8, v23, 0xE000400000001, @"TSTArrayFormulas", v25);
          goto LABEL_27;
      }
    }
...
LABEL_26:
    objc_msgSend_requiresDocumentVersion_(v8, v23, v19, v24, v25);
    goto LABEL_27;
  }

  objc_msgSend_requiresDocumentVersion_featureIdentifier_(v8, v23, 0xA000000000003, @"TSTExpandedTables", v25);
LABEL_27:
}
...
- (id)_groupForTileID:(unint64_t)a3
{
  ...
  v7 = self->_tileGroups[a3 >> 8];
  if (!v7)
  {
    v8 = objc_msgSend_groupWithStartingTileID_(TSTTableTileGroup, a2, a3 & 0xF00, v3, v4);
    v9 = tileGroups[v5];
    tileGroups[v5] = v8;
...
- (id)_tileFromGroupForTileID:(unint64_t)a3
{
  ...
  v6 = a3 >> 8;
  tileGroups = self->_tileGroups;
  v8 = self->_tileGroups[a3 >> 8];
  if (!v8)
  {
    v9 = objc_msgSend_groupWithStartingTileID_(TSTTableTileGroup, a2, a3 & 0xF00, v3, v4);
    v10 = tileGroups[v6];
    tileGroups[v6] = v9;
  ...
  v11 = objc_msgSend_objectAtIndexedSubscript_(v8, a2, a3, v3, v4);
...
{
  v5 = a4;
  if (objc_msgSend_containsIndex_(self->_tileIDSet, a2, a3, a4, v4))
  {
    v11 = objc_msgSend__tileFromGroupForTileID_(self, v8, a3, v9, v10);
    if (v11)
    {
      goto LABEL_7;
    }
  ...
  if (v5)
  {
    v11 = objc_msgSend__createTileWithID_(self, v8, a3, v9, v10);
  }
...
- (void)_setTile:(id)a3 forID:(unint64_t)a4
{
  ...
  objc_msgSend_addIndex_(self->_tileIDSet, v10, a4, v11, v12);
  v16 = objc_msgSend__groupForTileID_(self, v13, a4, v14, v15);
  objc_msgSend_setObject_atIndexedSubscript_(v16, v17, v19, a4, v18);
}
...
- (id)_createTileWithID:(unint64_t)a3
{
  ...
  objc_msgSend__setTile_forID_(self, v21, shouldUseWideRows_context, a3, v22);
...
{
  objc_msgSend_willModify(self, a2, a3, v3, v4);
  objc_msgSend_removeIndex_(self->_tileIDSet, v7, a3, v8, v9);
  v15 = objc_msgSend__groupForTileID_(self, v10, a3, v11, v12);
  objc_msgSend_setObject_atIndexedSubscript_(v15, v13, 0, a3, v14);
}
...
- (void)_clearContentAtIndex:(unsigned int)a3 count:(unsigned int)a4
{
  ...
  v63 = a3 + a4;
  v64 = a3 + a4 - 1;
  v8 = objc_msgSend_indexGreaterThanOrEqualToIndex_(self->_tileIDSet, a2, a3 >> 8, *&a4, v4);
...
LABEL_21:
    ...
    if (v15 - a3 + 1 < v5)
    {
      objc_msgSend_clearRowsAtTileRowIndex_numberOfRows_(v19, v38, v52, v15 - a3 + 1, v40);
    }

    else
    {
      objc_msgSend_clearRowsAtTileRowIndex_numberOfRows_(v19, v38, v52, v5, v40);
    }
...
LABEL_15:
    ...
    if (Index <= v24)
    {
      objc_msgSend_shiftUpAtTileRowIndex_count_(v30, v26, a3 - (Index << 8), v4, v29);
      v35 = 0;
    }
...
{
  v5 = *&a4;
  v10 = objc_msgSend_indexGreaterThanOrEqualToIndex_(self->_tileIDSet, a2, a3 >> 8, *&a4, v4);
  v40 = 0;
  v11 = 0x277D81000uLL;
  do
  {
    ...
    if (v16)
    {
      if (a3 >= v10 << 8)
      {
        objc_msgSend_insertRowsAtTileRowIndex_numberOfRows_(v16, v12, a3 - (v10 << 8), v5, v15);
      }
...
{
  v6 = *&a3;
  PopulatedRowIndex = objc_msgSend_lastPopulatedRowIndex(self, a2, *&a3, *&a4, v4);
  if (a4)
  {
    if (PopulatedRowIndex != 0x7FFFFFFF && PopulatedRowIndex >= v6)
    {
      ...
      v15 = a4 / v14;
      v16 = a4 % v14;
      objc_msgSend__shiftRowsDownAtIndex_count_(self, v17, v6, a4 % v14, v18);
      if (v15 * v14)
      {
        if ((a4 - v16) % v14)
        {
...
- (id)_yankRowRange:(_NSRange)a3
{
  ...
  v61 = objc_msgSend_strongObjectsPointerArray(MEMORY[0x277CCAC18], a2, a3.location, a3.length, v3);
...
- (void)_spliceRows:(id)a3 atIndex:(unsigned int)a4
{
  ...
  v15 = objc_msgSend_count(v65, v11, v12, v13, v14);
  v20 = v15;
  v21 = v10 - a4;
  if (v15 >= v21)
  {
  ...
  v27 = v23;
  v72 = v27;
  objc_msgSend_tsu_enumerateNonNullPointersUsingBlock_(v65, v28, v71, v29, v30);
  if (*(v77 + 24) == 1)
  {
    v35 = objc_msgSend__tileForID_createIfMissing_(self, v31, a4 >> 8, 1, v34);
    objc_msgSend_spliceRows_atTileRowIndex_(v35, v36, v27, a4, v37);
    if (objc_msgSend_isEmpty(v35, v38, v39, v40, v41))
    {
      objc_msgSend__removeTileForID_(self, v31, a4 >> 8, v33, v34);
    }
  }
  ...
  else
  {
    ...
    do
    {
      ...
      *(v77 + 24) = 0;
      ...
      v27 = v45;
      v67 = v27;
      objc_msgSend_tsu_enumerateNonNullPointersUsingBlock_(v65, v49, v66, v50, v51);
      if (*(v77 + 24) == 1)
      {
...
- (id)rowInfoAtIndex:(unsigned int)a3
{
  ...
  if (objc_msgSend_containsIndex_(self->_tileIDSet, a2, v7, v3, v4))
  {
    ...
    if (v16)
    {
      v20 = objc_msgSend_rowInfoForTileRowIndex_(v16, v17, a3, v18, v19);
      goto LABEL_9;
    }
...
- (id)tileForWritingAtRowIndex:(unsigned int)a3 outTileRange:(_NSRange *)a4
{
  v7 = objc_msgSend__tileForID_createIfMissing_(self, a2, a3 >> 8, 1, v4);
  if (a4)
  {
    v8 = objc_opt_class();
    v13 = objc_msgSend_tileSize(v8, v9, v10, v11, v12);
    a4->location = a3 & 0xFFFFFF00;
    a4->length = v13;
  }
...
- (id)tileStartingAtOrAfterRowIndex:(unsigned int)a3 outTileRange:(_NSRange *)a4
{
  v7 = objc_msgSend_indexGreaterThanOrEqualToIndex_(self->_tileIDSet, a2, a3 >> 8, a4, v4);
...
- (void)swapRowAtIndex:(unsigned int)a3 withRowAtIndex:(unsigned int)a4
{
  ...
  v10 = objc_msgSend__tileForID_createIfMissing_(self, v8, a3 >> 8, 0, v9);
  v13 = v10;
  if (a3 >> 8 != a4 >> 8)
  {
    v37 = a4 >> 8;
    ...
    if (v13)
    {
      v19 = objc_msgSend_yankRowInfoAtTileRowIndex_(v13, v15, a3, v16, v17);
      v21 = v19;
      if (!v18)
      {
        v22 = 0;
...
LABEL_25:
    ...
    v25 = objc_msgSend_yankRowInfoAtTileRowIndex_(v18, v15, a4, v16, v17);
    v22 = v25;
    if (!v21)
    {
      v23 = v18;
...
LABEL_15:
      if (!v13)
      {
        v13 = objc_msgSend__createTileWithID_(self, v15, a3 >> 8, v16, v17);
      }

      objc_msgSend_spliceRowInfo_atTileRowIndex_overwrite_(v13, v15, v22, a3, 0);
LABEL_18:
      if (!v13)
      {
LABEL_21:
...
LABEL_19:
      ...
      {
        objc_msgSend__removeTileForID_(self, v15, a3 >> 8, v16, v17);
      }
...
LABEL_12:
    v23 = v18;
    objc_msgSend_spliceRowInfo_atTileRowIndex_overwrite_(v18, v15, v21, a4, 0);
    if (!v22)
    {
      goto LABEL_18;
    }
  ...
  if (v10)
  {
    objc_msgSend_swapRowAtTileRowIndex_withRowAtTileRowIndex_(v10, v11, a3, a4, v12);
  }
...
- (void)moveRowIndexRange:(_NSRange)a3 toIndex:(unsigned int)a4
{
  ...
  length = a3.length;
  location = a3.location;
  PopulatedRowIndex = objc_msgSend_lastPopulatedRowIndex(self, a2, a3.location, a3.length, *&a4);
  if (TSTTilesCat_init_token != -1)
  {
    sub_2216F6D70();
  }
...
- (id)columnCellCountsOfRowsInRange:(_NSRange)a3
{
  ...
  v14 = sub_2211A40A8;
  v15 = sub_2211A40B8;
  v16 = objc_msgSend_dictionary(MEMORY[0x277D81208], a2, a3.location, a3.length, v3);
...
{
  v30 = a3;
  if (objc_msgSend_count(v30, v4, v5, v6, v7))
  {
    v16 = objc_msgSend_firstIndex(v30, v8, v9, v10, v11) >> 8;
    v19 = objc_msgSend_lastIndex(v30, v12, v13, v14, v15) >> 8;
    if (v16 <= v19)
    {
      do
      {
...
- (BOOL)auditTilesForRowOverlapAndExtensionPastTableBounds:(TSUCellCoord)a3 withDataStore:(id)a4 result:(id *)a5
{
  ...
  v25[3] = sub_2211A40A8;
  v25[4] = sub_2211A40B8;
  v26 = objc_msgSend_indexSet(MEMORY[0x277CCAB58], a2, *&a3, a4, a5);
...
- (void)prepareToApplyConcurrentCellMap:(id)a3
{
  ...
  v5[3] = &unk_2784608A8;
  v5[4] = self;
  objc_msgSend_gatherRowState_(a3, a2, v5, v3, v4);
}
