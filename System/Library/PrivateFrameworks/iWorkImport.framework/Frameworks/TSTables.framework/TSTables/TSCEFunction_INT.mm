...
+ (id)evaluateForArgsWithContext:(id)context functionSpec:(id)spec arguments:(const void *)arguments
{
  v7 = **arguments;
  v29 = 0;
  v9 = objc_msgSend_asNumber_functionSpec_argumentIndex_outError_(v7, v8, context, spec, 0, &v29);
  v13 = v29;
  if (v13)
  {
  ...
  {
    v19 = objc_msgSend_errorForDuration_argumentIndex_(v9, v10, spec, 0, v12);
    if (v19)
    {
      v14 = objc_msgSend_raiseErrorOrConvert_(context, v15, v19, v17, v18);
    }
