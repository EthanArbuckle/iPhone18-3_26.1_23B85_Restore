...
{
  v8 = **a5;
  if ((objc_msgSend_deepType_(v8, v9, a3, v10, v11) & 0xFFFFFFFD) != 5)
  {
    v17 = objc_msgSend_functionName(a4, v12, v13, v14, v15);
    v30 = objc_msgSend_invalidArgumentsErrorForFunctionName_argumentIndex_(TSCEError, v28, v17, 1, v29);
    v27 = objc_msgSend_raiseErrorOrConvert_(a3, v31, v30, v32, v33);

    goto LABEL_5;
  }

  v169 = 0;
  v16 = objc_msgSend_asNumber_functionSpec_argumentIndex_outError_(v8, v12, a3, a4, 0, &v169);
  v17 = v169;
  v22 = objc_msgSend_integer(v16, v18, v19, v20, v21);

  if (v17)
  {
    v27 = objc_msgSend_raiseErrorOrConvert_(a3, v23, v17, v25, v26);
LABEL_5:
  ...
  if (v22 >= 1 && v22 <= 0x6F && (v22 - 12) > 0x58)
  {
    ...
    v168 = 0;
    v144 = v35;
    v37 = objc_msgSend_asGrid_functionSpec_argumentIndex_applyPreferredFormat_outError_(v35, v36, a3, a4, 1, 1, &v168);
    v38 = v168;
    v145 = v37;
    if (v38)
    {
      v17 = v38;
      v27 = objc_msgSend_raiseErrorOrConvert_(a3, v39, v38, v41, v42);
LABEL_83:

      goto LABEL_5;
    }

    v143 = objc_msgSend_hidingActionMask(a3, v39, v40, v41, v42);
    if (v22 <= 0x64)
    {
      objc_msgSend_setHidingActionMask_(a3, v50, 66, v51, v52);
    }

    else
    {
      objc_msgSend_setHidingActionMask_(a3, v50, 67, v51, v52);
    }
    ...
    *(v162 + 7) = 0;
    ...
    if (v57)
    {
      for (i = 0; i != v57; ++i)
      {
        ...
        {
          v159 = 0;
          v68 = objc_msgSend_asReference_functionSpec_argumentIndex_outError_(v62, v67, v146, a4, 1, &v159);
          v69 = v159;
          if (v69)
          {
            v17 = v69;
            v27 = objc_msgSend_raiseErrorOrConvert_(v146, v70, v69, v72, v73);
          ...
          *&v152[8] = v170;
          ...
          v155 = 0;
          v156 = 0;
          objc_msgSend_addCalculatedPrecedent_(v146, v88, v152, v89, v90);
          ...
          if (v22 >= 0x65)
          {
            ...
            *&v152[8] = v170;
            ...
            v155 = 0;
            v156 = 0;
            objc_msgSend_addCalculatedPrecedent_(v146, v98, v152, v99, v100);
          }
...
LABEL_42:
              ...
              v103 = sub_22121D2C8(v146, v102, *(*a5 + 8), 1, 1, 0, 0, 0);
LABEL_67:
              v27 = v103;
              goto LABEL_68;
            }
...
LABEL_66:
            ...
            v103 = sub_22121D2C8(v146, v123, *(*a5 + 8), 1, 0, 0, 0, 0);
            goto LABEL_67;
          }

LABEL_70:
          v126 = objc_msgSend_functionSpecForFunctionIndex_(TSCEFunctionSpec, v58, 113, v59, v60);
          v27 = objc_msgSend_getResultWithVector_context_functionSpec_index_(TSCEFunction_PRODUCT, v127, v37, v146, v126, 1);
          if (v144)
          {
            objc_msgSend_formatWithContext_(v144, v128, v146, v129, v130);
          }
...
LABEL_58:
            ...
            v108 = objc_msgSend_getResultWithVector_context_functionSpec_index_(TSCEFunction_VARP, v107, v37, v146, v106, 1);
LABEL_73:
            v27 = v108;
            goto LABEL_74;
          }
...
LABEL_69:
          ...
          v108 = objc_msgSend_getResultWithVector_context_functionSpec_index_(TSCEFunction_VAR, v125, v37, v146, v124, 1);
          goto LABEL_73;
        }

LABEL_72:
        v131 = objc_msgSend_functionSpecForFunctionIndex_(TSCEFunctionSpec, v58, 168, v59, v60);
        v108 = objc_msgSend_getResultWithVector_context_functionSpec_index_(TSCEFunction_SUM, v132, v37, v146, v131, 1);
        goto LABEL_73;
      }
...
LABEL_51:
            ...
            v103 = objc_msgSend_extremum_functionSpec_arg_index_isMax_isA_(TSCEFunction_MAX, v105, v146, v104, *(*a5 + 8), 1, 0, 0);
            goto LABEL_67;
          }

LABEL_63:
          v114 = objc_msgSend_functionSpecForFunctionIndex_(TSCEFunctionSpec, v58, 84, v59, v60);
          v103 = objc_msgSend_extremum_functionSpec_arg_index_isMax_isA_(TSCEFunction_MAX, v115, v146, v114, *(*a5 + 8), 1, 1, 0);
          goto LABEL_67;
        }
...
LABEL_62:
        ...
        v27 = objc_msgSend_getResultWithVector_context_functionSpec_index_countBehavior_(TSCEFunction_COUNT, v110, v37, v146, v109, 1, 0);
      ...
      if (v22 > 5)
      {
        ...
        if (v22 != 9)
        {
          if (v22 != 10)
          {
            ...
            {
LABEL_74:
              objc_msgSend_setHidingActionMask_(v146, v58, v143, v59, v60);
              if (!v27)
              {
              ...
              if (v101)
              {
                if (v37)
                {
                  objc_msgSend_formatWithContext_(v37, v133, v146, v135, v136);
                }
...
LABEL_64:
        ...
        v27 = objc_msgSend_getResultWithVector_context_functionSpec_index_countBehavior_(TSCEFunction_COUNT, v117, v37, v146, v116, 1, 1);
    ...
    v108 = objc_msgSend_averageOfVector_functionSpec_argVector_argumentIndex_(TSCEFunction_AVERAGE, v122, v146, v121, v37, 1);
    goto LABEL_73;
  }

  v43 = objc_msgSend_functionName(a4, v23, v24, v25, v26);
  v46 = objc_msgSend_invalidArgumentsErrorForFunctionName_argumentIndex_(TSCEError, v44, v43, 1, v45);
  v27 = objc_msgSend_raiseErrorOrConvert_(a3, v47, v46, v48, v49);
