...
+ (id)evaluateForArgsWithContext:(id)a3 functionSpec:(id)a4 arguments:(const void *)a5
{
  ...
  v182 = 0;
  v14 = objc_msgSend_asDate_functionSpec_argumentIndex_outError_(v12, v13, a3, a4, 0, &v182);
  v19 = v182;
  if (v19)
  {
  ...
  if (v14)
  {
    ...
    sub_22114F414(&v184, &v183);
    v181 = 0;
    v37 = objc_msgSend_asDate_functionSpec_argumentIndex_outError_(v30, v36, a3, a4, 1, &v181);
    v19 = v181;
    if (v19)
    {
...
LABEL_61:
    ...
    if (!v37)
    {
      v46 = objc_msgSend_functionName(a4, v38, v39, v40, v41);
      v166 = objc_msgSend_invalidArgumentsErrorForFunctionName_argumentIndex_(TSCEError, v47, v46, 2, v48);
      v20 = objc_msgSend_raiseErrorOrConvert_(a3, v49, v166, v50, v51);
      v19 = 0;
LABEL_60:
    ...
    sub_22114F414(&v184, &v183);
    v180 = 0;
    v165 = objc_msgSend_asDate_functionSpec_argumentIndex_outError_(v166, v52, a3, a4, 2, &v180);
    v19 = v180;
    if (v19)
    {
      v20 = objc_msgSend_raiseErrorOrConvert_(a3, v53, v19, v54, v55);
      v46 = v164;
      v56 = v165;
LABEL_59:
    ...
    if (!v165)
    {
      v162 = objc_msgSend_functionName(a4, v53, 0, v54, v55);
      v46 = v164;
      v56 = 0;
      v163 = objc_msgSend_invalidArgumentsErrorForFunctionName_argumentIndex_(TSCEError, v61, v162, 3, v62);
      v20 = objc_msgSend_raiseErrorOrConvert_(a3, v63, v163, v64, v65);
      v19 = 0;
LABEL_58:
    ...
    if (v57)
    {
      objc_msgSend_formatWithContext_(v57, v58, a3, v59, v60);
    }
    ...
    sub_22114F414(&v184, &v183);
    v179 = 0;
    v67 = objc_msgSend_asNumber_functionSpec_argumentIndex_outError_(v163, v66, a3, a4, 3, &v179);
    v19 = v179;
    v161 = v67;
...
LABEL_57:
    ...
    sub_22114F414(&v184, &v183);
    v178[0] = 0;
    v80 = objc_msgSend_asNumber_functionSpec_argumentIndex_outError_(v160, v79, a3, a4, 4, v178);
    v19 = v178[0];
    v159 = v80;
    ...
    if (v19)
    {
      v88 = objc_msgSend_raiseErrorOrConvert_(a3, v85, v19, v86, v87);
LABEL_32:
      v20 = v88;
LABEL_56:
      v46 = v164;
    ...
    else
    {
      ...
      else
      {
        ...
        if (v89)
        {
          objc_msgSend_formatWithContext_(v89, v94, a3, v95, v96);
        }
        ...
        sub_22114F414(&v184, &v183);
        v177[0] = 0;
        v99 = objc_msgSend_asNumber_functionSpec_argumentIndex_outError_(v89, v98, a3, a4, 5, v177);
        v19 = v177[0];
        ...
        *&v183._formatType = v109;
        ...
        if (v19)
        {
          v20 = objc_msgSend_raiseErrorOrConvert_(a3, v111, v19, v112, v113);
    ...
    {
      v132 = objc_msgSend_functionName(a4, v114, v115, v116, v117);
      ...
      v138 = objc_msgSend_raiseErrorOrConvert_(a3, v135, v134, v136, v137);
    }

    else if (objc_msgSend_compare_(v164, v114, v162, v116, v117) == -1 || !objc_msgSend_compare_(v164, v118, v162, v120, v121))
    {
      v132 = objc_msgSend_functionName(a4, v118, v119, v120, v121);
      ...
      v138 = objc_msgSend_raiseErrorOrConvert_(a3, v140, v134, v141, v142);
    }
    ...
    else
    {
      if (objc_msgSend_compare_(v25, v118, v162, v120, v121) != -1 && objc_msgSend_compare_(v25, v122, v162, v124, v125))
      {
        ...
        if (v19)
        {
          v88 = objc_msgSend_raiseErrorOrConvert_(a3, v129, v19, v130, v131);
        }
      ...
      v132 = objc_msgSend_functionName(a4, v122, v123, v124, v125);
      ...
      v138 = objc_msgSend_raiseErrorOrConvert_(a3, v144, v134, v145, v146);
    }
