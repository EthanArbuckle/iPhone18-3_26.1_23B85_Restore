...
+ (id)evaluateForArgsWithContext:(id)a3 functionSpec:(id)a4 arguments:(const void *)a5
{
  ...
  *&v116._formatType = v22;
  ...
  {
    v28 = objc_msgSend_functionName(a4, v23, v24, v25, v26);
    ...
    v21 = objc_msgSend_raiseErrorOrConvert_(a3, v41, v35, v42, v43);
    v11 = 0;
    goto LABEL_22;
  }
  ...
  v28 = *(*a5 + 8);
  v118 = 0;
  v30 = objc_msgSend_asNumber_functionSpec_argumentIndex_outError_(v28, v29, a3, a4, 1, &v118);
  v11 = v118;
  ...
  if (!v11)
  {
    ...
    *&v116._formatType = v44;
    ...
    if (v49 < -2147483650.0 || v49 > 2147483650.0)
    {
      ...
      v21 = objc_msgSend_raiseErrorOrConvert_(a3, v63, v57, v64, v65);
      v11 = 0;
      goto LABEL_21;
    }
    ...
    v50 = *(*a5 + 16);
    v117 = 0;
    v52 = objc_msgSend_asNumber_functionSpec_argumentIndex_outError_(v50, v51, a3, a4, 2, &v117);
    v11 = v117;
    v57 = objc_msgSend_floor(v52, v53, v54, v55, v56);

    if (v11)
    {
      v21 = objc_msgSend_raiseErrorOrConvert_(a3, v58, v11, v60, v61);
LABEL_21:
    ...
    *&v116._formatType = v66;
    ...
    {
      v90 = objc_msgSend_functionName(a4, v67, v68, v69, v70);
      ...
      v95 = objc_msgSend_raiseErrorOrConvert_(a3, v97, v91, v98, v99);
    }
    ...
    else
    {
      ...
      if ((v81 % 60) + ((v81 / 60 + v76) % 60) * 60.0 + (((v81 / 60 + v76) / 60 + v113) % 24) * 3600.0 >= 0.0)
      {
        ...
        v114 = objc_msgSend_locale(a3, v101, v102, v103, v104);
      ...
      v95 = objc_msgSend_raiseErrorOrConvert_(a3, v92, v91, v93, v94);
    }
...
LABEL_20:
  ...
  v21 = objc_msgSend_raiseErrorOrConvert_(a3, v36, v11, v38, v39);
LABEL_22:
