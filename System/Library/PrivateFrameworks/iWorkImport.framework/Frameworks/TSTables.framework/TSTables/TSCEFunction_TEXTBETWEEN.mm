...
+ (id)evaluateForArgsWithContext:(id)context functionSpec:(id)spec arguments:(const void *)arguments
{
  ...
  v136[0] = 0;
  v20 = objc_msgSend_asString_functionSpec_argumentIndex_outError_(v128, v19, context, spec, 0, v136);
  v21 = v136[0];
  v135 = v21;
  v23 = objc_msgSend_asString_functionSpec_argumentIndex_outError_(v8, v22, context, spec, 1, &v135);
  v24 = v135;

  v134 = v24;
  v127 = objc_msgSend_asString_functionSpec_argumentIndex_outError_(v9, v25, context, spec, 2, &v134);
  v26 = v134;

  if (v26)
  {
    v31 = objc_msgSend_raiseErrorOrConvert_(context, v27, v26, v29, v30);
  ...
  v32 = *(*arguments + 24);
  if ((objc_msgSend_isTokenOrEmptyArg(v32, v33, v34, v35, v36) & 1) != 0 || objc_msgSend_deepType_(v32, v37, context, v38, v39) == 10)
  {
    v41 = 1;
    goto LABEL_7;
  }
  ...
  v133 = 0;
  v124 = objc_msgSend_asNumber_functionSpec_argumentIndex_outError_(v32, v40, context, spec, 3, &v133);
  v91 = v133;
  if (v91)
  {
    v31 = objc_msgSend_raiseErrorOrConvert_(context, v87, v91, v89, v90);
LABEL_22:
  ...
  if (!v98)
  {
    v108 = objc_msgSend_functionName(spec, v99, v100, v101, v102);
    v111 = objc_msgSend_invalidArgumentsErrorForFunctionName_argumentIndex_(TSCEError, v109, v108, 4, v110);
    v31 = objc_msgSend_raiseErrorOrConvert_(context, v112, v111, v113, v114);
...
LABEL_7:
  ...
  {
    v42 = *(*arguments + 32);
    if ((objc_msgSend_isTokenOrEmptyArg(v42, v43, v44, v45, v46) & 1) != 0 || objc_msgSend_deepType_(v42, v47, context, v48, v49) == 10)
    {
      v51 = 1;
LABEL_11:
    ...
    v132 = 0;
    v92 = objc_msgSend_asNumber_functionSpec_argumentIndex_outError_(v42, v50, context, spec, 4, &v132);
    v91 = v132;
    if (v91)
    {
      v31 = objc_msgSend_raiseErrorOrConvert_(context, v93, v91, v95, v96);
    }
    ...
    else
    {
      ...
      v115 = objc_msgSend_functionName(spec, v104, v105, v106, v107);
      v118 = objc_msgSend_invalidArgumentsErrorForFunctionName_argumentIndex_(TSCEError, v116, v115, 5, v117);
      v31 = objc_msgSend_raiseErrorOrConvert_(context, v119, v118, v120, v121);
    }
...
LABEL_14:
  ...
  {
    v59 = v131;
    v60 = objc_msgSend_functionName(spec, v55, v56, v57, v58);
    v122 = v59;
    v23 = v125;
    ...
    v31 = objc_msgSend_raiseErrorOrConvert_(context, v63, v62, v64, v65);
  }
  ...
  else
  {
    ...
    {
      v77 = v130;
      v78 = objc_msgSend_functionName(spec, v73, 0x7FFFFFFFFFFFFFFFLL, v75, v76);
      v123 = v77;
      v23 = v125;
      ...
      v31 = objc_msgSend_raiseErrorOrConvert_(context, v81, v80, v82, v83);
    }
    ...
    else
    {
      ...
      if (v128)
      {
        objc_msgSend_formatWithContext_(v128, v84, context, v85, v86);
      }
