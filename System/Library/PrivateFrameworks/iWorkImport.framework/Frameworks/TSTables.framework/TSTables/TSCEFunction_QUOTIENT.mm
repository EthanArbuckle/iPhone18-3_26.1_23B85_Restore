...
+ (id)evaluateForArgsWithContext:(id)a3 functionSpec:(id)a4 arguments:(const void *)a5
{
  ...
  v9 = *(*a5 + 8);
  v75 = 0;
  v11 = objc_msgSend_asNumber_functionSpec_argumentIndex_outError_(v8, v10, a3, a4, 0, &v75);
  v12 = v75;
  if (v12)
  {
    v16 = v12;
  ...
  v74 = 0;
  v18 = objc_msgSend_asNumber_functionSpec_argumentIndex_outError_(v9, v13, a3, a4, 1, &v74);
  v16 = v74;
  if (!v16)
  {
    if (objc_msgSend_dimensionsMatchModuloCurrency_(v11, v19, v18, v20, v21))
    {
      ...
      if (v16)
      {
        v22 = objc_msgSend_raiseErrorOrConvert_(a3, v31, v16, v33, v34);
        goto LABEL_5;
      }
      ...
      if (TSUDecimal::divide(&v72, &v71, &v70) == 5)
      {
        ...
        v17 = objc_msgSend_raiseErrorOrConvert_(a3, v58, v57, v59, v60);
      }
      ...
      else
      {
        ...
        if (v8)
        {
          objc_msgSend_formatWithContext_(v8, v61, a3, v63, v64);
        }
        ...
        if (v9)
        {
          objc_msgSend_formatWithContext_(v9, v61, a3, v63, v64);
        }
    ...
    {
      v39 = objc_msgSend_functionName(a4, v23, v24, v25, v26);
      v43 = objc_msgSend_mismatchedUnitsErrorForFunctionName_(TSCEError, v40, v39, v41, v42);
      v17 = objc_msgSend_raiseErrorOrConvert_(a3, v44, v43, v45, v46);
    }
  ...
  v22 = objc_msgSend_raiseErrorOrConvert_(a3, v19, v16, v20, v21);
LABEL_5:
  v17 = v22;
LABEL_11:
