...
+ (id)evaluateForArgsWithContext:(id)a3 functionSpec:(id)a4 arguments:(const void *)a5
{
  v7 = **a5;
  v56 = 0;
  v9 = objc_msgSend_asGrid_functionSpec_argumentIndex_applyPreferredFormat_outError_(v7, v8, a3, a4, 0, 1, &v56);
  v10 = v56;
  if (v10)
  {
    v15 = v10;
    ...
    *(v52 + 7) = 0;
    ...
    if (v17)
    {
      ...
      do
      {
        ...
        {
          v49 = 0;
          v32 = objc_msgSend_asBoolean_functionSpec_argumentIndex_outError_(v26, v31, v22, a4, 0, &v49);
          v33 = v49;
          if (v33)
          {
            v15 = v33;
    ...
    {
LABEL_13:
      v39 = objc_msgSend_functionName(a4, v18, v19, v20, v21);
      v42 = objc_msgSend_noSuitableArgumentsFoundErrorForFunctionName_requiredType_(TSCEError, v40, v39, 2, v41);
      v16 = objc_msgSend_raiseErrorOrConvert_(v22, v43, v42, v44, v45);
    }
