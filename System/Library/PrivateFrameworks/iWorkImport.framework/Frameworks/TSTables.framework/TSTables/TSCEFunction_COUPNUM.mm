@interface TSCEFunction_COUPNUM
+ (id)evaluateForArgsWithContext:(id)context functionSpec:(id)spec arguments:(const void *)arguments;
@end

@implementation TSCEFunction_COUPNUM
...
+ (id)evaluateForArgsWithContext:(id)context functionSpec:(id)spec arguments:(const void *)arguments
{
  ...
  v132 = 0;
  v14 = objc_msgSend_asDate_functionSpec_argumentIndex_outError_(v12, v13, context, spec, 0, &v132);
  v19 = v132;
  if (v19)
  {
  ...
  if (v14)
  {
    ...
    sub_22114F414(&v134, &v133);
    v131 = 0;
    v37 = objc_msgSend_asDate_functionSpec_argumentIndex_outError_(v30, v36, context, spec, 1, &v131);
    v19 = v131;
    if (v19)
    {
...
LABEL_44:
    ...
    if (!v37)
    {
      v47 = objc_msgSend_functionName(spec, v38, v39, v40, v41);
      v126 = objc_msgSend_invalidArgumentsErrorForFunctionName_argumentIndex_(TSCEError, v48, v47, 2, v49);
      v20 = objc_msgSend_raiseErrorOrConvert_(context, v50, v126, v51, v52);
      v19 = 0;
LABEL_43:
    ...
    sub_22114F414(&v134, &v133);
    v130 = 0;
    v54 = objc_msgSend_asNumber_functionSpec_argumentIndex_outError_(v46, v53, context, spec, 2, &v130);
    v19 = v130;
    ...
    *&v133._formatType = v64;
    ...
    if (v19)
    {
      v20 = objc_msgSend_raiseErrorOrConvert_(context, v66, v19, v68, v69);
LABEL_20:
      v47 = v125;
LABEL_42:
    ...
    if (v65 <= 4 && ((1 << v65) & 0x16) != 0)
    {
      ...
      else
      {
        ...
        else
        {
          if (v71)
          {
            objc_msgSend_formatWithContext_(v71, v76, context, v77, v78);
          }
          ...
          sub_22114F414(&v134, &v133);
          v129 = 0;
          v89 = objc_msgSend_asNumber_functionSpec_argumentIndex_outError_(v71, v88, context, spec, 3, &v129);
          v19 = v129;
          v120 = v89;
      ...
      if (objc_msgSend_compare_(v25, v66, v125, v68, v69) != 1 && objc_msgSend_compare_(v25, v104, v125, v106, v107))
      {
        ...
        specCopy = spec;
        v47 = v125;
        objc_msgSend_getNumFutureCouponsWithSettlementDate_settlement_maturity_numCoupons_dayBasisMode_outError_(TSCEFinancialFunctions, v104, specCopy, v25, v125, v79, &v128, v70);
        v109 = v128;
        if (v109)
        {
          v19 = v109;
          v20 = objc_msgSend_raiseErrorOrConvert_(context, v110, v109, v111, v112);
          goto LABEL_42;
        }
...
LABEL_41:
      ...
      v80 = objc_msgSend_functionName(spec, v104, v105, v106, v107);
      ...
      v47 = v125;
      v87 = objc_msgSend_raiseErrorOrConvert_(context, v114, v83, v115, v116);
    }

    else
    {
      v80 = objc_msgSend_functionName(spec, v66, v67, v68, v69);
      v47 = v125;
