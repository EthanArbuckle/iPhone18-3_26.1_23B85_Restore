...
- (TSCEListFormulaNode)initWithNumArgs:(unsigned int)a3;
...
- (void)appendToNodeArray:(TSCEASTNodeArray *)a3 hostCellRef:(const TSCECellRef *)a4 symbolTable:(void *)a5 calcEngine:(id)a6
{
  ...
  if (objc_msgSend_count(v15, v16, v17, v18, v19) == 1)
  {
    ...
    {
      TSCEASTListElement::appendListNode(a3, 0, v29, v30, v31);
  ...
  if (v35)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        objc_msgSend_appendToNodeArray_hostCellRef_symbolTable_calcEngine_(*(*(&v67 + 1) + 8 * v37++), v34, a3, a4, a5, v10, v67);
      }
  ...
  TSCEASTListElement::appendListNode(a3, v42, v43, v44, v45);
