...
+ (id)containerNameForTable:(id)table
{
  ...
  v19 = objc_msgSend_sheetName(tableCopy, v3, v4, v5, v6);
  v20 = v19;
  if (v19)
  {
    v21 = v19;
...
+ (id)tableNameForTable:(id)table
{
  ...
  v19 = objc_msgSend_tableName(tableCopy, v3, v4, v5, v6);
  v20 = v19;
  if (v19)
  {
    v21 = v19;
...
- (void)addTable:(id)table
{
  ...
  {
    v35 = tableCopy;
    v7 = objc_msgSend_containerNameForTable_(TSCETablesByName, tableCopy, tableCopy, v5, v6);
...
- (void)dropTable:(id)table withTableName:(id)name withContainerName:(id)containerName
{
  ...
  if (tableCopy)
  {
    v13 = objc_msgSend_objectForKey_(self->_tablesByTableNameByContainerName, v9, containerNameCopy, v10, v11);
    v17 = v13;
    if (v13)
    {
      v22 = objc_msgSend_objectForKey_(v13, v14, nameCopy, v15, v16);
      if (v22)
      {
        v23 = objc_msgSend_resolverUID(tableCopy, v18, v19, v20, v21);
        objc_msgSend_didRemoveTableName_forTableUID_(self->_tableNameChangeDistributor, v24, nameCopy, v23, v24);
        objc_msgSend_removeObject_(v22, v25, tableCopy, v26, v27);
        if (!objc_msgSend_count(v22, v28, v29, v30, v31))
        {
          objc_msgSend_removeObjectForKey_(v17, v32, nameCopy, v33, v34);
        }
      }
    }
  }
...
- (void)renameTable:(id)table fromName:(id)name
{
  ...
  if (tableCopy)
  {
    v10 = objc_msgSend_containerNameForTable_(TSCETablesByName, v6, tableCopy, v7, v8);
    v14 = objc_msgSend_tableNameForTable_(TSCETablesByName, v11, tableCopy, v12, v13);
    objc_msgSend_dropTable_withTableName_withContainerName_(self, v15, tableCopy, nameCopy, v10);
    objc_msgSend_addTable_(self, v16, tableCopy, v17, v18);
    v23 = objc_msgSend_resolverUID(tableCopy, v19, v20, v21, v22);
    objc_msgSend_didChangeTableName_fromTableName_forTableUID_(self->_tableNameChangeDistributor, v24, v14, nameCopy, v23, v24);
  }
}
  ...
  if (v32)
  {
    ...
    do
    {
      for (i = 0; i != v32; ++i)
      {
        ...
        v13 = *(*(&v47 + 1) + 8 * i);
        v14 = objc_msgSend_objectForKey_(selfCopy->_tablesByTableNameByContainerName, v10, v13, v11, v12);
        v45 = 0u;
        v46 = 0u;
        v43 = 0u;
        v44 = 0u;
  ...
  if (v10)
  {
    ...
    while (2)
    {
      for (i = 0; i != v10; ++i)
      {
        ...
        v17 = objc_msgSend_objectForKey_(v13, v14, nameCopy, v15, v16);
...
- (id)resolverMatchingName:(id)name
{
  ...
  nameCopy = name;
  v10 = objc_msgSend_tableForTableName_containerName_(self, v5, nameCopy, 0, v6);
  if (!v10)
  {
    ...
    if (v22)
    {
      ...
      while (2)
      {
        for (i = 0; i != v22; ++i)
        {
          ...
          v25 = *(*(&v37 + 1) + 8 * i);
          if (objc_msgSend_localizedCaseInsensitiveIsEqual_toString_(v17, v20, nameCopy, v25, v21, v37))
          {
            if (v10)
            {
...
- (id)resolversMatchingPrefix:(id)prefix
{
  ...
  if (objc_msgSend_length(prefixCopy, v9, v10, v11, v12))
  {
    WeakRetained = objc_loadWeakRetained(&self->_calcEngine);
    ...
    if (v32)
    {
      ...
      do
      {
        for (i = 0; i != v32; ++i)
        {
          ...
          v35 = *(*(&v46 + 1) + 8 * i);
          if (objc_msgSend_tsce_hasCaseInsensitivePrefix_withLocale_(v35, v30, prefixCopy, v27, v31))
          {
...
- (BOOL)resolverNameIsUsed:(id)used
{
  ...
  v12 = objc_msgSend_objectForKey_(v8, v9, usedCopy, v10, v11);
    ...
    if (v18)
    {
      ...
      while (2)
      {
        for (i = 0; i != v18; ++i)
        {
          ...
          if (!objc_msgSend_caseInsensitiveCompare_(*(*(&v27 + 1) + 8 * i), v21, usedCopy, v22, v23, v27))
          {
            LOBYTE(v18) = 1;
            goto LABEL_13;
          }
