...
+ (id)evaluateForArgsWithContext:(id)a3 functionSpec:(id)a4 arguments:(const void *)a5
{
  ...
  else
  {
    ...
    {
      v167[0] = 0;
      v17 = objc_msgSend_asNumber_functionSpec_argumentIndex_outError_(v9, v14, a3, a4, 0, v167);
      v15 = v167[0];
...
LABEL_11:
    v29 = objc_msgSend_raiseErrorOrConvert_(a3, a2, v15, a4, a5);
    goto LABEL_53;
  }
  ...
  {
    v166 = v15;
    v30 = objc_msgSend_asNumber_functionSpec_argumentIndex_outError_(v23, v28, a3, a4, 1, &v166);
    v31 = v166;
...
LABEL_14:
  ...
  if (*(a5 + 1) - *a5 >= 0x11uLL)
  {
    ...
    {
      shouldTreatValueAsDateArgument = TSCEArgumentAccessor::shouldTreatValueAsDateArgument(v49, a3, v54, v55, v56);
      if (shouldTreatValueAsDateArgument)
      {
        v165 = 0;
        v128 = objc_msgSend_asDate_functionSpec_argumentIndex_outError_(v49, v127, a3, a4, 2, &v165);
        v15 = v165;
        isDuration = 0;
        v48 = 86400.0;
        v61 = v128;
      ...
      {
        v164 = 0;
        v133 = objc_msgSend_asNumber_functionSpec_argumentIndex_outError_(v49, v127, a3, a4, 2, &v164);
        v15 = v164;
      ...
      if (v15)
      {
        v29 = objc_msgSend_raiseErrorOrConvert_(a3, v44, v15, v46, v47);
        goto LABEL_52;
      }
...
LABEL_18:
  ...
  else
  {
    ...
    {
      v163 = 0;
      v68 = objc_msgSend_asNumber_functionSpec_argumentIndex_outError_(v154, v66, a3, a4, 3, &v163);
      v15 = v163;

      if (v15)
      {
        v29 = objc_msgSend_raiseErrorOrConvert_(a3, v129, v15, v131, v132);
        v152 = v68;
        goto LABEL_51;
      }
...
LABEL_47:
  ...
  while (1)
  {
    ...
    if (shouldTreatValueAsDateArgument)
    {
      ...
      if (v49)
      {
        objc_msgSend_formatWithContext_(v49, v82, a3, v83, v84);
      }
...
LABEL_38:
    v159 = v15;
    v108 = objc_msgSend_asNumber_functionSpec_argumentIndex_outError_(v76, v78, a3, a4, 2, &v159);
    v109 = v159;

    v158 = v109;
    v73 = objc_msgSend_add_functionSpec_outError_(v108, v110, v152, a4, &v158);
    v15 = v158;

    if (v49)
    {
      v61 = v151;
      objc_msgSend_formatWithContext_(v49, v111, a3, v112, v113);
    }
    ...
    if (v15)
    {
      v29 = objc_msgSend_raiseErrorOrConvert_(a3, v71, v15, v117, v72);
      goto LABEL_50;
    }
...
LABEL_44:
  ...
  v160 = 0;
  v86 = objc_msgSend_asNumber_functionSpec_argumentIndex_outError_(v49, v78, a3, a4, 2, &v160);
  v15 = v160;
  ...
  v143 = objc_msgSend_functionName(a4, v104, v105, v106, v107);
  v145 = objc_msgSend_inconsistantParameterFormatError_argIndex2_functionName_(TSCEError, v144, 3, 4, v143);
  v29 = objc_msgSend_raiseErrorOrConvert_(a3, v146, v145, v147, v148);
