...
+ (id)evaluateForArgsWithContext:(id)context functionSpec:(id)spec arguments:(const void *)arguments
{
  ...
  {
    v63 = 0;
    v44 = objc_msgSend_asNumber_functionSpec_argumentIndex_outError_(v26, v31, context, spec, 1, &v63);
    v43 = v63;

    if (v43)
    {
      v15 = objc_msgSend_raiseErrorOrConvert_(context, v45, v43, v47, v48);
    }
    ...
    else
    {
      ...
      v53 = objc_msgSend_functionName(spec, v49, v50, v51, v52);
      v56 = objc_msgSend_unitsNotAllowedErrorForFunctionName_argumentNumber_(TSCEError, v54, v53, 2, v55);
      v15 = objc_msgSend_raiseErrorOrConvert_(context, v57, v56, v58, v59);
    }
