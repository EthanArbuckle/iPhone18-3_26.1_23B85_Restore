...
+ (id)evaluateForArgsWithContext:(id)a3 functionSpec:(id)a4 arguments:(const void *)a5
{
  ...
  {
    v59 = 0;
    v35 = objc_msgSend_asNumber_functionSpec_argumentIndex_outError_(v25, v30, a3, a4, 1, &v59);
    v14 = v59;
    ...
    else
    {
      if (!objc_msgSend_hasUnits(v34, v40, v41, v42, v43))
      {
        if (v8)
        {
          objc_msgSend_formatWithContext_(v8, v44, a3, v46, v47);
        }
        ...
        if (v25)
        {
          objc_msgSend_formatWithContext_(v25, v44, a3, v46, v47);
        }
