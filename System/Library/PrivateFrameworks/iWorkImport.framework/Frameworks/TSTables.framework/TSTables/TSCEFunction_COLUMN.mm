...
LABEL_25:
    ...
    *&v108._formatType = v53;
    ...
    v111 = 0uLL;
    v111.i64[0] = objc_msgSend_range(v29, v56, v57, v58, v59);
    v111.i64[1] = v60;
    if (v39)
    {
      ...
      v71 = vmovn_s64(vceqq_s64(vandq_s8(v111, v70), vdupq_n_s64(0x7FFF00000000uLL)));
      v72 = vuzp1_s16(v71, v71);
      v72.i32[1] = vuzp1_s16(v72, vmovn_s64(vmvnq_s8(vceqq_s64(vandq_s8(v111, v69), vdupq_n_s64(0x7FFFFFFFuLL))))).i32[1];
      if (vminv_u16(v72))
      {
    ...
    if (v111.u16[6] - v111.u16[2] + 1 >= 2)
    {
      ...
      if (v86 <= v111.u16[6])
      {
        do
        {
          ...
          objc_msgSend_setValue_atCoord_(v43, v90, v89, &v110, v91);
          LODWORD(v110) = v110 + 1;

          ++v86;
        }

        while (v111.u16[6] >= v86);
      }
