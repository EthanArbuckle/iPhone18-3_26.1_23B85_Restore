...
+ (id)evaluateForArgsWithContext:(id)a3 functionSpec:(id)a4 arguments:(const void *)a5
{
  v8 = **a5;
  v221[0] = 0;
  v9 = objc_msgSend_asGrid_functionSpec_argumentIndex_applyPreferredFormat_outError_(v8, a2, a3, a4, 0, 0, v221);
  v10 = v221[0];
  v196 = v9;
  if (v10)
  {
  ...
  if (!(v220.height * v220.width))
  {
    ...
    v16 = objc_msgSend_raiseErrorOrConvert_(a3, v31, v30, v32, v33);
  ...
  else
  {
    ...
    {
      v219 = 0;
      v195 = objc_msgSend_asBoolean_functionSpec_argumentIndex_outError_(v24, v29, a3, a4, 3, &v219);
      v34 = v219;
      if (v34)
      {
        v15 = v34;
...
LABEL_20:
    ...
    {
      v52 = *(*a5 + 16);
      if ((objc_msgSend_isTokenOrEmptyArg(v52, v53, v54, v55, v56) & 1) == 0 && objc_msgSend_deepType_(v52, v57, a3, v58, v59) != 10)
      {
        v203 = 0;
        v64 = objc_msgSend_asGrid_functionSpec_argumentIndex_applyPreferredFormat_outError_(v52, v60, a3, a4, 2, 0, &v203);
        v118 = v203;
        if (v118)
        {
          v15 = v118;
          v16 = objc_msgSend_raiseErrorOrConvert_(a3, v119, v118, v121, v122);
LABEL_45:
        ...
        if (v145)
        {
          ...
          *(v211 + 7) = 0;
          ...
          while (1)
          {
            ...
            v202 = 0;
            v151 = objc_msgSend_asNumber_functionSpec_argumentIndex_outError_(v149, v150, v194, a4, 1, &v202);
            v15 = v202;
            v156 = objc_msgSend_integer(v151, v152, v153, v154, v155);

            if (v15)
            {
              v16 = objc_msgSend_raiseErrorOrConvert_(v194, v157, v15, v159, v160);
              goto LABEL_83;
            }
          ...
          v171 = objc_msgSend_functionName(a4, v157, v158, v159, v160);
          v174 = objc_msgSend_invalidArgumentsErrorForFunctionName_argumentIndex_(TSCEError, v172, v171, 2, v173);
          v16 = objc_msgSend_raiseErrorOrConvert_(v194, v175, v174, v176, v177);
...
LABEL_71:
    ...
    if (v51 <= i >> 2)
    {
      v192 = objc_msgSend_asValueGrid_(v196, v47, a3, v49, v50);
      objc_msgSend_deepResolveInPlace_(v192, v68, a3, v69, v70);
      p_height = &v220;
      if (!v195)
      {
      ...
      v103 = objc_msgSend_shuffleMapForSortDirections_unsortedTags_sortDirections_(TSCEFunction_SORTBY, v79, a3, v64, &__p);
      v52 = v192;
      if (v195)
      {
    ...
    {
      v52 = objc_msgSend_functionName(a4, v47, v48, v49, v50);
      v64 = objc_msgSend_invalidArgumentsErrorForFunctionName_argumentIndex_(TSCEError, v62, v52, 2, v63);
      v16 = objc_msgSend_raiseErrorOrConvert_(a3, v65, v64, v66, v67);
    }
...
LABEL_18:
  ...
  v215 = 0;
  v112 = objc_msgSend_asGrid_functionSpec_argumentIndex_applyPreferredFormat_outError_(v38, v46, a3, a4, 1, 0, &v215);
  v113 = v215;
  if (!v113)
  {
...
LABEL_63:
    ...
    *(v211 + 7) = 0;
    ...
    {
      v127 = v112;
      v128 = objc_msgSend_valueAtIndex_accessContext_(v112, v125, v124, &v208, v126, v191);
      v207 = 0;
      v193 = v128;
      v130 = objc_msgSend_asNumber_functionSpec_argumentIndex_outError_(v128, v129, v191, a4, 1, &v207);
      v15 = v207;
      ...
      {
        v139 = v193;
        v16 = objc_msgSend_raiseErrorOrConvert_(v191, v136, v15, v137, v138);
        goto LABEL_87;
      }
      ...
      if (v135 < 0)
      {
        v162 = v220.width;
        height = v220.height;
        v164 = objc_msgSend_functionName(a4, v141, v142, v143, v144);
        if (v195)
        {
          v165 = height;
        }
        ...
        v170 = objc_msgSend_raiseErrorOrConvert_(v191, v167, v166, v168, v169);
        goto LABEL_78;
      }
    ...
    if (v195)
    {
      ...
      v170 = objc_msgSend_raiseErrorOrConvert_(v191, v183, v166, v184, v185);
    }
...
LABEL_85:
        ...
        v16 = objc_msgSend_raiseErrorOrConvert_(v191, v178, v164, v179, v180);
LABEL_86:
...
LABEL_87:
      ...
      v170 = objc_msgSend_raiseErrorOrConvert_(v191, v188, v166, v189, v190);
    }
...
LABEL_78:
  ...
  v15 = v113;
  v16 = objc_msgSend_raiseErrorOrConvert_(a3, v114, v113, v116, v117);
LABEL_88:
