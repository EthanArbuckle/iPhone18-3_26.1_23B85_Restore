...
+ (id)mergeLeftRef:(id)a3 rightRef:(id)a4 outError:(int *)a5;
- (TSCECalculationEngine)calcEngine;
- (TSCEEvalRef)init;
- (TSCEEvalRef)initWithTableResolver:(TSCETableResolverWrapper *)a3 topLeft:(const TSUCellCoord *)a4 bottomRight:(const TSUCellCoord *)a5 preserveFlags:(const TSUPreserveFlags *)a6;
- (TSCEEvalRef)initWithTableResolver:(TSCETableResolverWrapper *)a3 tractRefCore:(const TSCECellTractRefCore *)a4;
- (TSCEFormat)format:(SEL)a3;
...
- (id)intersectionWithHostCellRef:(const TSCECellRef *)a3 rangeContext:(unsigned __int8)a4 evaluationContext:(id)a5;
- (id)makeCellReferenceForOffset:(const TSCEGridCoord *)a3 apparentTractRef:(const TSCECellTractRefCore *)a4;
- (id)makeCellReferenceInSameTable:(const TSUCellCoord *)a3;
- (id)scalarValueFromCoord:(const TSUCellCoord *)a3 readOptions:(unsigned __int16)a4;
- (id)valueForEvalContext:(id)a3 readOptions:(unsigned __int16)a4;
- (unsigned)getHidingActionForRows:(BOOL)a3;
- (void)resetResolver:(id)a3;
@end
...
- (TSCEEvalRef)initWithTableResolver:(TSCETableResolverWrapper *)a3 topLeft:(const TSUCellCoord *)a4 bottomRight:(const TSUCellCoord *)a5 preserveFlags:(const TSUPreserveFlags *)a6
{
  ...
  if (v10)
  {
    v10->_tableResolver = a3;
    v19._lower = TSCETableResolverWrapper::tableUID(a3, v11, v12, v13, v14);
    v19._upper = v16;
    TSCECellTractRefCore::TSCECellTractRefCore(&v20, a4, a5, &v19);
    ...
    *(&v15->_tractRef._tableUID._upper + 5) = v17;
    ...
    v15->_tractRef._preserveFlags = a6->_flags;
...
- (TSCEEvalRef)initWithTableResolver:(TSCETableResolverWrapper *)a3 tractRefCore:(const TSCECellTractRefCore *)a4
{
  ...
  if (v6)
  {
    v6->_tableResolver = a3;
    TSUIndexSet::operator=();
    TSUIndexSet::operator=();
    v12 = *(&a4->_tableUID._upper + 5);
    v7->_tractRef._tableUID = a4->_tableUID;
    *(&v7->_tractRef._tableUID._upper + 5) = v12;
    v7->_rangeContextOverride = 3;
    if (!v7->_tractRef._tableUID._lower && a3 && !v7->_tractRef._tableUID._upper)
    {
      v7->_tractRef._tableUID._lower = TSCETableResolverWrapper::tableUID(a3, v8, v9, v10, v11);
...
- (void)resetResolver:(id)a3
{
  ...
  if (v4)
  {
    v12 = objc_msgSend_tableResolverWrapperForTableUID_(v4, v9, v13, v10, v11);
  }
...
- (id)makeCellReferenceForOffset:(const TSCEGridCoord *)a3 apparentTractRef:(const TSCECellTractRefCore *)a4
{
  v16 = TSCECellTractRefCore::coordAtColumnOffset(a4, a3->column, a3->row, a4, v4);
  v7 = [TSCEEvalRef alloc];
  tableResolver = self->_tableResolver;
  flags = a4->_preserveFlags._flags;
...
- (id)makeCellReferenceInSameTable:(const TSUCellCoord *)a3
{
  ...
  v6 = v5 | a3->_preserveColumn;
  v7 = [TSCEEvalRef alloc];
  tableResolver = self->_tableResolver;
  v12 = 5 * v6;
  v10 = objc_msgSend_initWithTableResolver_topLeft_bottomRight_preserveFlags_(v7, v9, tableResolver, a3, a3, &v12);
...
- (id)intersectionWithHostCellRef:(const TSCECellRef *)a3 rangeContext:(unsigned __int8)a4 evaluationContext:(id)a5
{
  ...
  {
    tableResolver = self->_tableResolver;
    if (tableResolver && ((lower = a3->_tableUID._lower, upper = a3->_tableUID._upper, lower == TSCETableResolverWrapper::tableUID(tableResolver, v8, v9, v10, v11)) ? (v16 = upper == v8) : (v16 = 0), v16))
    {
    ...
    if (self->_tableResolver)
    {
      if (*(objc_msgSend_tractRef(self, v8, v9, v10, v11) + 80) == 1 || *(objc_msgSend_tractRef(self, v22, v23, v24, v25) + 80) == 2)
      {
        ...
        *&v69._columns._multipleRanges = *&v68._columns._singleRange._end;
        ...
        objc_msgSend_addCalculatedPrecedent_(v12, v29, &v69, v30, v31);
      }
...
LABEL_21:
  ...
  if (v50)
  {
    ...
    TSCETableResolverWrapper::apparentTractRefForTractRef(v50, v51, v5, v52, &v68);
    TSUIndexSet::operator=();
    TSUIndexSet::operator=();
...
- (unsigned)getHidingActionForRows:(BOOL)a3
{
  ...
  if (tableResolver)
  {
    LOBYTE(tableResolver) = TSCETableResolverWrapper::getHidingActionForRow(tableResolver, self, a3, v3, v4);
  }
...
- (id)valueForEvalContext:(id)a3 readOptions:(unsigned __int16)a4
{
  ...
  if (!(v12 | v13))
  {
    p_var0 = objc_msgSend_containingTableResolverWrapper(v10, v13, v14, v15, v16);
    if (p_var0)
    {
      goto LABEL_9;
    }
...
LABEL_7:
  ...
  v17 = objc_msgSend_calcEngine(v10, v13, v14, v15, v16);
...
LABEL_9:
  objc_msgSend_containingCellRef(v10, v6, v7, v8, v9);
  v44 = 0;
  v37 = TSCETableResolverWrapper::readValueForReference(p_var0, self, v45, &v44, v4);
  v36 = v44;
  if (!v36)
  {
...
- (id)scalarValueFromCoord:(const TSUCellCoord *)a3 readOptions:(unsigned __int16)a4
{
  ...
  if (p_var0)
  {
    ...
    v14 = 0;
    var18[0] = v7;
    v8 = TSCETableResolverWrapper::readValueForReference(p_var0, self, var18, &v14, a4);
    p_var0 = v14;
    if (!p_var0)
    {
...
+ (id)mergeLeftRef:(id)a3 rightRef:(id)a4 outError:(int *)a5
{
  v7 = a3;
  v8 = a4;
  if ((objc_msgSend_topLeft(v7, v9, v10, v11, v12) & 0xFFFFFFFFFFFFLL) == 0x7FFF7FFFFFFFLL || (objc_msgSend_bottomRight(v7, v13, v14, v15, v16) & 0xFFFFFFFFFFFFLL) == 0x7FFF7FFFFFFFLL || (objc_msgSend_topLeft(v8, v13, v14, v15, v16) & 0xFFFFFFFFFFFFLL) == 0x7FFF7FFFFFFFLL || (objc_msgSend_bottomRight(v8, v13, v14, v15, v16) & 0xFFFFFFFFFFFFLL) == 0x7FFF7FFFFFFFLL)
  {
    v17 = 0;
    v18 = 1;
  }
  ...
  {
    v84 = objc_msgSend_tableUID(v7, v13, v14, v15, v16);
    v86 = v85;
    v90 = objc_msgSend_tableUID(v8, v85, v87, v88, v89);
    v17 = 0;
    v18 = 1;
    if (v84 == v90 && v86 == v13)
    {
      v91 = objc_msgSend_topLeft(v7, v13, v14, v15, v16);
      v96 = objc_msgSend_topLeft(v8, v92, v93, v94, v95);
      v17 = 0;
      v18 = 1;
  ...
  if (v17)
  {
    v19 = *(objc_msgSend_tractRef(v7, v13, v14, v15, v16) + 81);
    v24 = *(objc_msgSend_tractRef(v8, v20, v21, v22, v23) + 81);
    v29 = objc_msgSend_topLeft(v7, v25, v26, v27, v28);
    v34 = objc_msgSend_bottomRight(v7, v30, v31, v32, v33);
    v39 = objc_msgSend_topLeft(v7, v35, v36, v37, v38);
    v44 = objc_msgSend_bottomRight(v7, v40, v41, v42, v43);
    v53 = HIDWORD(v29);
    if ((objc_msgSend_topLeft(v8, v45, v46, v47, v48) >> 32) >= WORD2(v29))
    {
      v54 = v19 & 3;
    }
    ...
    {
      v53 = objc_msgSend_topLeft(v8, v49, v50, v51, v52) >> 32;
      v54 = v19 & 2 | v24 & 1;
    }

    if (objc_msgSend_topLeft(v8, v49, v50, v51, v52) < v39)
    {
      v39 = objc_msgSend_topLeft(v8, v56, v57, v58, v59);
      v54 = v24 & 2 | v54 & 1;
    }

    v64 = HIDWORD(v34);
    if ((objc_msgSend_bottomRight(v8, v56, v57, v58, v59) >> 32) >= v64)
    {
      v64 = objc_msgSend_bottomRight(v8, v60, v61, v62, v63) >> 32;
      v65 = (v19 >> 2) & 2 | (v24 >> 2) & 1;
    }
    ...
    if (objc_msgSend_bottomRight(v8, v60, v61, v62, v63) >= v44)
    {
      v44 = objc_msgSend_bottomRight(v8, v66, v67, v68, v69);
      v65 = v65 & 1 | (2 * ((v24 >> 3) & 1));
    }
    ...
    v74 = objc_msgSend_tableResolver(v7, v70, v71, v72, v73);
    v105._lower = objc_msgSend_tableUID(v7, v75, v76, v77, v78);
    v105._upper = v79;
