...
+ (id)evaluateForArgsWithContext:(id)a3 functionSpec:(id)a4 arguments:(const void *)a5
{
  ...
  else
  {
    if ((objc_msgSend_isDuration(v9, v10, v11, v12, v13) & 1) == 0)
    {
      ...
      v21 = objc_msgSend_stringWithUTF8String_(MEMORY[0x277CCACA8], v16, "+[TSCEFunction_DUR2HOURS evaluateForArgsWithContext:functionSpec:arguments:]", v18, v19);
      ...
      objc_msgSend_handleFailureInFunction_file_lineNumber_isFatal_description_(v20, v26, v21, v25, 623, 0, "Shouldn't get a non-duration in DUR2HOURS");
