@interface TSCEFunction_DUR2WEEKS
+ (id)evaluateForArgsWithContext:(id)a3 functionSpec:(id)a4 arguments:(const void *)a5;
@end

@implementation TSCEFunction_DUR2WEEKS

+ (id)evaluateForArgsWithContext:(id)a3 functionSpec:(id)a4 arguments:(const void *)a5
{
  v7 = **a5;
  v37 = 0;
  v9 = objc_msgSend_asNumber_functionSpec_argumentIndex_outError_(v7, v8, a3, a4, 0, &v37);
  v14 = v37;
  if (v14)
  {
  ...
  else
  {
    if ((objc_msgSend_isDuration(v9, v10, v11, v12, v13) & 1) == 0)
    {
      ...
      v21 = objc_msgSend_stringWithUTF8String_(MEMORY[0x277CCACA8], v16, "+[TSCEFunction_DUR2WEEKS evaluateForArgsWithContext:functionSpec:arguments:]", v18, v19);
      ...
      objc_msgSend_handleFailureInFunction_file_lineNumber_isFatal_description_(v20, v26, v21, v25, 601, 0, "Shouldn't get a non-duration in DUR2WEEKS");
