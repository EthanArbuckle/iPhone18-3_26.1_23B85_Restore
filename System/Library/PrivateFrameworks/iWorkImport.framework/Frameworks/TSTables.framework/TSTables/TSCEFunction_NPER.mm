...
+ (id)evaluateForArgsWithContext:(id)a3 functionSpec:(id)a4 arguments:(const void *)a5
{
  ...
  v132 = 0;
  v14 = objc_msgSend_asNumber_functionSpec_argumentIndex_outError_(v12, v13, a3, a4, 0, &v132);
  v15 = v132;
  ...
  sub_22114F414(&v134, &v133);
  v131[0] = 0;
  v30 = objc_msgSend_asNumber_functionSpec_argumentIndex_outError_(v28, v29, a3, a4, 1, v131);
  v15 = v131[0];
  ...
  *(&v130 + 1) = v35;
  if (!v15)
  {
    ...
    if (v38)
    {
      objc_msgSend_formatWithContext_(v38, v39, a3, v40, v41);
    }
    ...
    sub_22114F414(&v134, &v133);
    v129 = 0;
    v44 = objc_msgSend_asNumber_functionSpec_argumentIndex_outError_(v42, v43, a3, a4, 2, &v129);
    v15 = v129;
    v113 = v44;
    ...
    *(&v128 + 1) = v49;
    if (v15)
    {
      v23 = objc_msgSend_raiseErrorOrConvert_(a3, v49, v15, v50, v51);
LABEL_16:
      v52 = v113;
LABEL_39:
    ...
    if ((objc_msgSend_isTokenOrEmptyArg(v53, v54, v55, v56, v57) & 1) == 0)
    {
      ...
      if (v53)
      {
        objc_msgSend_formatWithContext_(v53, v58, a3, v59, v60);
      }
      ...
      sub_22114F414(&v134, &v133);
      v127[0] = 0;
      v62 = objc_msgSend_asNumber_functionSpec_argumentIndex_outError_(v53, v61, a3, a4, 3, v127);
      v15 = v127[0];
      v111 = v62;
      ...
      if (v15)
      {
        v23 = objc_msgSend_raiseErrorOrConvert_(a3, v67, v15, v68, v69);
...
LABEL_28:
    ...
    else
    {
      ...
      else
      {
        if (v70)
        {
          objc_msgSend_formatWithContext_(v70, v75, a3, v76, v77);
        }
        ...
        sub_22114F414(&v134, &v133);
        v126 = 0;
        v105 = objc_msgSend_asNumber_functionSpec_argumentIndex_outError_(v70, v104, a3, a4, 4, &v126);
        v15 = v126;
        if (v15)
        {
          v23 = objc_msgSend_raiseErrorOrConvert_(a3, v106, v15, v108, v109);
    ...
    {
      v93 = objc_msgSend_functionName(a4, v89, v90, v91, v92);
      v97 = objc_msgSend_numberErrorForFunctionName_(TSCEError, v94, v93, v95, v96);
      v23 = objc_msgSend_raiseErrorOrConvert_(a3, v98, v97, v99, v100);
    }
  ...
  v23 = objc_msgSend_raiseErrorOrConvert_(a3, v35, v15, v36, v37);
LABEL_40:
