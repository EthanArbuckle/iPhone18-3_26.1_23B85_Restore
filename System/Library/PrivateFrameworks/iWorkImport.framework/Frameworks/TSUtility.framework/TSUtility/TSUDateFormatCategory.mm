...
- (TSUDateFormatCategory)initWithInitialPattern:(id)a3 locale:(id)a4;
...
- (TSUDateFormatCategory)initWithInitialPattern:(id)a3 locale:(id)a4
{
  ...
  if (v8)
  {
    ...
    CFDateFormatterSetFormat(v9, v6);
...
- (void)addSeparator:(unsigned __int16)a3 format:(id)a4 locale:(id)a5
{
  ...
  v10 = a4;
  v8 = a5;
  v9 = [(TSUDateFormatCategory *)self entryForSeparator:v6];
  if (!v9)
  {
    v9 = [[TSUDateFormatCategoryEntry alloc] initWithSeparator:v6];
    [(NSMutableArray *)self->_entries addObject:v9];
  }

  [(TSUDateFormatCategoryEntry *)v9 addFormat:v10 locale:v8];
}
