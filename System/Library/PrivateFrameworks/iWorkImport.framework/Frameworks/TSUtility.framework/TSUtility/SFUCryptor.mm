...
- (SFUCryptor)initWithKey:(id)key operation:(int)operation iv:(const char *)iv ivLength:(unint64_t)length usePKCS7Padding:(BOOL)padding
{
  ...
  if (![key keyType])
  {
    ...
    if (v17)
    {
      ...
      +[TSUAssertionHandler handleFailureInFunction:file:lineNumber:isFatal:description:](TSUAssertionHandler, "handleFailureInFunction:file:lineNumber:isFatal:description:", v19, [MEMORY[0x277CCACA8] stringWithUTF8String:"/Library/Caches/com.apple.xbs/Sources/iWorkImport/shared/utility/sf/SFUCryptor.m"], 67, 0, "CCCryptorCreate() failed: %d", v18);
LABEL_15:
      +[TSUAssertionHandler logBacktraceThrottled];
  ...
  if (!v12->mCryptor)
  {
    v20 = [MEMORY[0x277CCACA8] stringWithUTF8String:"-[SFUCryptor initWithKey:operation:iv:ivLength:usePKCS7Padding:]"];
    +[TSUAssertionHandler handleFailureInFunction:file:lineNumber:isFatal:description:](TSUAssertionHandler, "handleFailureInFunction:file:lineNumber:isFatal:description:", v20, [MEMORY[0x277CCACA8] stringWithUTF8String:"/Library/Caches/com.apple.xbs/Sources/iWorkImport/shared/utility/sf/SFUCryptor.m"], 79, 0, "Failed to initialize SFUCommonCryptoCryptor.");
    goto LABEL_15;
  }
...
- (BOOL)cryptDataFromBuffer:(const char *)buffer length:(unint64_t)length toStream:(id)stream finished:(BOOL)finished crc32:(unsigned int *)crc32 error:(id *)error
{
  ...
  if (self->mOperation)
  {
    ...
    +[TSUAssertionHandler handleFailureInFunction:file:lineNumber:isFatal:description:](TSUAssertionHandler, "handleFailureInFunction:file:lineNumber:isFatal:description:", v15, [MEMORY[0x277CCACA8] stringWithUTF8String:"/Library/Caches/com.apple.xbs/Sources/iWorkImport/shared/utility/sf/SFUCryptor.m"], 118, 0, "Decryption to stream not supported");
    +[TSUAssertionHandler logBacktraceThrottled];
  }
    ...
    while (1)
    {
      ...
      if (dataOutMoved)
      {
        ...
        if (crc32)
        {
          ...
          {
            v31 = [MEMORY[0x277CCACA8] stringWithUTF8String:"-[SFUCryptor cryptDataFromBuffer:length:toStream:finished:crc32:error:]"];
            v28 = [MEMORY[0x277CCACA8] stringWithUTF8String:"/Library/Caches/com.apple.xbs/Sources/iWorkImport/shared/utility/sf/SFUCryptor.m"];
            v29 = v31;
            v30 = 140;
            goto LABEL_28;
          }
...
LABEL_32:
    ...
    if (dataOutMoved)
    {
      ...
      if (crc32)
      {
        if (HIDWORD(dataOutMoved))
        {
          v27 = [MEMORY[0x277CCACA8] stringWithUTF8String:"-[SFUCryptor cryptDataFromBuffer:length:toStream:finished:crc32:error:]"];
          v28 = [MEMORY[0x277CCACA8] stringWithUTF8String:"/Library/Caches/com.apple.xbs/Sources/iWorkImport/shared/utility/sf/SFUCryptor.m"];
          v29 = v27;
          v30 = 180;
LABEL_28:
...
- (BOOL)cryptDataFromStream:(id)stream toBuffer:(char *)buffer length:(unint64_t)length bytesRead:(unint64_t *)read error:(id *)error
{
  ...
  {
    v13 = [MEMORY[0x277CCACA8] stringWithUTF8String:"-[SFUCryptor cryptDataFromStream:toBuffer:length:bytesRead:error:]"];
    +[TSUAssertionHandler handleFailureInFunction:file:lineNumber:isFatal:description:](TSUAssertionHandler, "handleFailureInFunction:file:lineNumber:isFatal:description:", v13, [MEMORY[0x277CCACA8] stringWithUTF8String:"/Library/Caches/com.apple.xbs/Sources/iWorkImport/shared/utility/sf/SFUCryptor.m"], 200, 0, "Encryption from stream not supported");
    +[TSUAssertionHandler logBacktraceThrottled];
  }
