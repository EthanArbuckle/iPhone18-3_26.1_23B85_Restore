...
- (id)propertyForKey:(id)key
{
  if ([key isEqualToString:*MEMORY[0x277CBE748]])
  {
...
- (BOOL)setProperty:(id)property forKey:(id)key
{
  ...
  keyCopy = key;
  if ([keyCopy isEqualToString:*MEMORY[0x277CBE748]] && (objc_opt_class(), (objc_opt_isKindOfClass() & 1) != 0) && -[SFUInputStream canSeek](self->_inputStream, "canSeek"))
  {
