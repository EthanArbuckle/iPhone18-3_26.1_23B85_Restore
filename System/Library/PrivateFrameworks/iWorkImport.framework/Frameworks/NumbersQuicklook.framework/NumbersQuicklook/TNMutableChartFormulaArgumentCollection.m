...
- (TNMutableChartFormulaArgumentCollection)initWithArray:(id)a3;
- (void)addElement:(id)a3;
- (void)insertElement:(id)a3 atIndex:(unint64_t)a4;
@end
...
- (TNMutableChartFormulaArgumentCollection)initWithArray:(id)a3
{
  ...
  v13 = [(TNChartFormulaArgumentCollection *)&v19 initWithArray:v5];
  if (v13)
  {
...
{
  v8 = a3;
  if (!objc_msgSend_isBadRef(v8, v4, v5) || objc_msgSend_storeBadRef(self, v6, v7))
  {
    objc_msgSend_addObject_(self->super._array, v6, v8);
  }
}
...
{
  v10 = a3;
  if (!objc_msgSend_isBadRef(v10, v6, v7) || objc_msgSend_storeBadRef(self, v8, v9))
  {
    objc_msgSend_insertObject_atIndex_(self->super._array, v8, v10, a4);
  }
}
