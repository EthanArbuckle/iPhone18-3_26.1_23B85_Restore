@interface TNSheet
+ (id)sheetForSelectionModel:(id)model outIsPaginated:(BOOL *)paginated;
- (BOOL)canMoveDrawables:(id)drawables toIndexes:(id)indexes;
- (BOOL)hasReferenceToTables:(id)tables;
...
- (TNSheet)initWithContext:(id)context suppressingHeaderFooterCreation:(BOOL)creation;
...
- (id)p_storagesForHeaderType:(int64_t)type;
- (id)printableInfosIncludingComments:(BOOL)comments;
- (id)resolverMatchingName:(id)name;
- (id)resolversMatchingPrefix:(id)prefix;
- (id)tableInfoForName:(id)name caseSensitive:(BOOL)sensitive;
- (id)tableInfos;
...
- (void)enumerateHeaderFooterStoragesWithBlock:(id)block;
- (void)i_importHeadersFooters:(id)footers headerType:(int64_t)type useSingleHeaderFooter:(BOOL)footer;
...
- (void)insertDrawableInfo:(id)info atIndex:(unint64_t)index context:(id)context;
- (void)insertDrawableInfo:(id)info context:(id)context;
- (void)insertDrawableInfos:(id)infos atIndex:(unint64_t)index context:(id)context;
...
- (void)p_createHeadersFooters:(int64_t)footers stylesheet:(id)stylesheet mayAlreadyExist:(BOOL)exist;
- (void)p_dolcDispatch:(id)dispatch skippingTextBoxes:(BOOL)boxes;
...
- (void)setInPortraitPageOrientation:(BOOL)orientation;
- (void)setIsAutofitOn:(BOOL)on;
- (void)setLayoutDirection:(unint64_t)direction;
- (void)setName:(id)name;
- (void)setPageFooterInset:(double)inset;
- (void)setPageHeaderInset:(double)inset;
- (void)setPageOrder:(unint64_t)order;
- (void)setPrintMargins:(UIEdgeInsets)margins;
- (void)setShouldPrintComments:(BOOL)comments;
- (void)setShowPageNumbers:(BOOL)numbers;
- (void)setStartPageNumber:(int64_t)number;
- (void)setStyle:(id)style;
- (void)setUsesSingleHeaderFooter:(BOOL)footer;
- (void)setUsingStartPageNumber:(BOOL)number;
...
- (TNSheet)initWithContext:(id)context suppressingHeaderFooterCreation:(BOOL)creation
{
  ...
  v7 = [(TNSheet *)&v27 initWithContext:contextCopy];
  if (v7)
  {
...
- (id)p_newHeaderFooterStorageWithStylesheet:(id)stylesheet
{
  ...
  v7 = objc_msgSend_headerAndFooterStyle(stylesheetCopy, v5, v6);
  v8 = objc_alloc(MEMORY[0x277D80F28]);
  v11 = objc_msgSend_context(self, v9, v10);
  v14 = objc_msgSend_initialListStyle(v7, v12, v13);
  v16 = objc_msgSend_initWithContext_string_kind_stylesheet_paragraphStyle_listStyle_section_columnStyle_(v8, v15, v11, &stru_2884F65E0, 1, stylesheetCopy, v7, v14, 0, 0);
...
{
  stylesheetCopy = stylesheet;
  v9 = self->_headerFooters[footers];
  v10 = 3;
  do
  {
    if (!exist && *v9)
    ...
    if (!*v9)
    {
      v18 = objc_msgSend_p_newHeaderFooterStorageWithStylesheet_(self, v8, stylesheetCopy);
...
- (void)enumerateHeaderFooterStoragesWithBlock:(id)block
{
  ...
  do
  {
    ...
    do
    {
      (*(block + 2))(block, headerFooters[v4][v7], v4, v7, &v9);
      if (v7 > 1)
      {
        break;
      }
...
- (id)headerFooter:(int64_t)footer fragmentAtIndex:(int64_t)index
{
  ...
  v14 = self->_headerFooters[footer][index];
...
- (TNDocumentRoot)documentRoot
{
  ...
  documentRoot = [(TNSheet *)&v4 documentRoot];
...
- (void)setLayoutDirection:(unint64_t)direction
{
  ...
  {
    objc_msgSend_willModify(self, a2, direction);
...
- (void)setInPortraitPageOrientation:(BOOL)orientation
{
  if (self->_inPortraitPageOrientation != orientation)
  {
    objc_msgSend_willModify(self, a2, orientation);
    self->_inPortraitPageOrientation = orientation;
  }
}

- (void)setShowPageNumbers:(BOOL)numbers
{
  if (self->_showPageNumbers != numbers)
  {
    objc_msgSend_willModify(self, a2, numbers);
    self->_showPageNumbers = numbers;
  }
}

- (void)setIsAutofitOn:(BOOL)on
{
  if (self->_isAutofitOn != on)
  {
    objc_msgSend_willModify(self, a2, on);
    self->_isAutofitOn = on;
  }
}
...
- (void)setPageOrder:(unint64_t)order
{
  if (self->_pageOrder != order)
  {
    objc_msgSend_willModify(self, a2, order);
    self->_pageOrder = order;
  }
}

- (void)setUsingStartPageNumber:(BOOL)number
{
  if (self->_usingStartPageNumber != number)
  {
    objc_msgSend_willModify(self, a2, number);
    self->_usingStartPageNumber = number;
  }
}

- (void)setStartPageNumber:(int64_t)number
{
  if (self->_startPageNumber != number)
  {
    objc_msgSend_willModify(self, a2, number);
    self->_startPageNumber = number;
  }
}

- (void)setPageHeaderInset:(double)inset
{
  if (self->_pageHeaderInset != inset)
  {
    objc_msgSend_willModify(self, a2, v3);
    self->_pageHeaderInset = inset;
  }
}

- (void)setPageFooterInset:(double)inset
{
  if (self->_pageFooterInset != inset)
  {
    objc_msgSend_willModify(self, a2, v3);
    self->_pageFooterInset = inset;
  }
}

- (void)setShouldPrintComments:(BOOL)comments
{
  if (self->_shouldPrintComments != comments)
  {
    objc_msgSend_willModify(self, a2, comments);
    self->_shouldPrintComments = comments;
  }
}
...
- (void)setUsesSingleHeaderFooter:(BOOL)footer
{
  ...
  {
    objc_msgSend_willModify(self, a2, footer);
...
- (void)setPrintMargins:(UIEdgeInsets)margins
{
  ...
  v5.f64[0] = margins.top;
  v5.f64[1] = margins.left;
  v6.f64[0] = margins.bottom;
  v6.f64[1] = margins.right;
...
{
  infosCopy = infos;
  if (self->_childInfos != infosCopy)
  {
    objc_msgSend_willModify(self, v4, v5);
    v7 = objc_msgSend_arrayWithArray_(MEMORY[0x277CBEB18], v6, infosCopy);
...
- (id)printableInfosIncludingComments:(BOOL)comments
{
  v4 = objc_msgSend_childInfos(self, a2, comments);
...
- (void)insertDrawableInfo:(id)info context:(id)context
{
  ...
  objc_msgSend_setParentInfo_(infoCopy, v12, self);
  if (self->_inDocument)
  {
    objc_msgSend_willBeAddedToDocumentRoot_dolcContext_(infoCopy, v13, v9, contextCopy);
  }

  objc_msgSend_addObject_(self->_childInfos, v13, infoCopy);
  if (self->_inDocument)
  {
    objc_msgSend_wasAddedToDocumentRoot_dolcContext_(infoCopy, v14, v9, contextCopy);
  }

  v16 = objc_msgSend_documentRoot(self, v14, v15);
  objc_msgSend_sheet_insertedDrawable_(v16, v17, self, infoCopy);
}
...
- (void)insertDrawableInfo:(id)info atIndex:(unint64_t)index context:(id)context
{
  ...
  objc_msgSend_setParentInfo_(infoCopy, v14, self);
  if (self->_inDocument)
  {
    objc_msgSend_willBeAddedToDocumentRoot_dolcContext_(infoCopy, v15, v11, contextCopy);
  }

  objc_msgSend_insertObject_atIndex_(self->_childInfos, v15, infoCopy, index);
  if (self->_inDocument)
  {
    objc_msgSend_wasAddedToDocumentRoot_dolcContext_(infoCopy, v16, v11, contextCopy);
  }

  v18 = objc_msgSend_documentRoot(self, v16, v17);
  objc_msgSend_sheet_insertedDrawable_(v18, v19, self, infoCopy);
}
...
- (void)insertDrawableInfos:(id)infos atIndex:(unint64_t)index context:(id)context
{
    ...
    if (v24)
    {
      ...
      do
      {
        ...
        do
        {
          ...
          objc_msgSend_willBeAddedToDocumentRoot_dolcContext_(*(*(&v52 + 1) + 8 * v26++), v23, v11, contextCopy);
        }
  ...
  objc_msgSend_replaceObjectsInRange_withObjectsFromArray_(self->_childInfos, v20, index, 0, v14);
  v50 = 0u;
  v51 = 0u;
  v48 = 0u;
  v49 = 0u;
    ...
    if (v40)
    {
      ...
      do
      {
        ...
        do
        {
          ...
          objc_msgSend_wasAddedToDocumentRoot_dolcContext_(*(*(&v44 + 1) + 8 * v42++), v39, v11, contextCopy);
        }
...
- (void)insertDrawableInfos:(id)infos context:(id)context
{
  ...
  objc_msgSend_insertDrawableInfos_atIndex_context_(self, v10, infosCopy, v9, contextCopy);
}
...
- (void)removeDrawableInfo:(id)info
{
  ...
  if (self->_inDocument)
  {
    objc_msgSend_willBeRemovedFromDocumentRoot_(infoCopy, v9, v6);
  }

  objc_msgSend_setParentInfo_(infoCopy, v9, 0);
  objc_msgSend_removeObject_(self->_childInfos, v10, infoCopy);
  v13 = objc_msgSend_documentRoot(self, v11, v12);
  objc_msgSend_sheet_removedDrawable_(v13, v14, self, infoCopy);

  if (self->_inDocument)
  {
    objc_msgSend_wasRemovedFromDocumentRoot_(infoCopy, v15, v6);
  }
}
...
- (void)removeDrawableInfos:(id)infos
{
  ...
  objc_msgSend_removeObjectsInArray_(self->_childInfos, v10, infosCopy);
  v40 = 0u;
  v41 = 0u;
  v38 = 0u;
  v39 = 0u;
...
- (BOOL)canMoveDrawables:(id)drawables toIndexes:(id)indexes
{
  ...
  {
    v12 = objc_msgSend_count(drawablesCopy, v8, v9);
...
- (void)moveDrawables:(id)drawables toIndexes:(id)indexes
{
  ...
  if (drawablesCopy && indexesCopy)
  {
    v11 = objc_msgSend_count(drawablesCopy, v8, v9);
  ...
  if (v10)
  {
    ...
    do
    {
      for (i = 0; i != v10; ++i)
      {
        ...
        {
          v20 = objc_msgSend_documentRoot(selfCopy, v14, v15);
          v23 = objc_msgSend_documentLocale(v20, v21, v22);
          v26 = objc_msgSend_tableName(v16, v24, v25);
          IsEqual_toString = objc_msgSend_localizedCaseInsensitiveIsEqual_toString_(v23, v27, v26, nameCopy);
...
- (BOOL)hasReferenceToTables:(id)tables
{
  ...
  v10 = objc_msgSend_allObjects(tablesCopy, v8, v9);
...
- (void)adoptStylesheet:(id)stylesheet withMapper:(id)mapper
{
  ...
  stylesheetCopy = stylesheet;
  mapperCopy = mapper;
  v10 = objc_msgSend_mappedStyleForStyle_(mapperCopy, v8, self->_style);
  if (!v10)
  {
    v11 = MEMORY[0x277D81150];
  ...
  if (v34)
  {
    ...
    do
    {
      for (i = 0; i != v34; ++i)
      {
        ...
        objc_msgSend_adoptStylesheet_withMapper_(*(*(&v55 + 1) + 8 * i), v33, stylesheetCopy, mapperCopy);
      }
  ...
  if (v14)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        else if (!boxesCopy || (objc_opt_class(), (objc_opt_isKindOfClass() & 1) == 0))
        {
          objc_msgSend_invokeWithTarget_(dispatchCopy, v18, v17);
        }
  ...
  if (v22)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        objc_msgSend_invokeWithTarget_(dispatchCopy, v21, *(*(&v25 + 1) + 8 * v24++), v25);
      }
...
- (void)willBeAddedToDocumentRoot:(id)root dolcContext:(id)context
{
  rootCopy = root;
  contextCopy = context;
  if ((objc_msgSend_wasMigratingStyles(contextCopy, v7, v8) & 1) == 0)
  {
    objc_opt_class();
    v10 = TSUDynamicCast();
  ...
  objc_msgSend_setArgument_atIndex_(v27, v29, &rootCopy, 2);
  objc_msgSend_setArgument_atIndex_(v27, v30, &contextCopy, 3);
  v33 = objc_msgSend_wasUnarchived(contextCopy, v31, v32);
  ...
  do
  {
    objc_msgSend_willBeAddedToDocumentRoot_dolcContext_(v38[v36++], v35, rootCopy, contextCopy);
  }

  while (v36 != 3);
  for (i = 0; i != 3; ++i)
  {
    objc_msgSend_willBeAddedToDocumentRoot_dolcContext_((*headerFooters)[i], v35, rootCopy, contextCopy);
  }
}
...
- (void)wasAddedToDocumentRoot:(id)root dolcContext:(id)context
{
  ...
  objc_msgSend_setArgument_atIndex_(v15, v17, &rootCopy, 2);
  objc_msgSend_setArgument_atIndex_(v15, v18, &contextCopy, 3);
  v21 = objc_msgSend_wasUnarchived(contextCopy, v19, v20);
  objc_msgSend_p_dolcDispatch_skippingTextBoxes_(self, v22, v15, v21);
  for (i = 0; i != 3; ++i)
  {
    objc_msgSend_wasAddedToDocumentRoot_dolcContext_(self->_headerFooters[1][i], v23, rootCopy, contextCopy);
  }

  for (j = 0; j != 3; ++j)
  {
    objc_msgSend_wasAddedToDocumentRoot_dolcContext_(self->_headerFooters[0][j], v23, rootCopy, contextCopy);
  }
...
- (void)willBeRemovedFromDocumentRoot:(id)root
{
  ...
  objc_msgSend_setArgument_atIndex_(v9, v11, &rootCopy, 2);
  objc_msgSend_p_dolcDispatch_skippingTextBoxes_(self, v12, v9, 0);
  for (i = 0; i != 3; ++i)
  {
    objc_msgSend_willBeRemovedFromDocumentRoot_(self->_headerFooters[1][i], v13, rootCopy);
  }

  for (j = 0; j != 3; ++j)
  {
    objc_msgSend_willBeRemovedFromDocumentRoot_(self->_headerFooters[0][j], v13, rootCopy);
  }

  v17 = objc_msgSend_context(rootCopy, v13, v16);
...
- (void)wasRemovedFromDocumentRoot:(id)root
{
  ...
  for (i = 0; i != 3; ++i)
  {
    objc_msgSend_wasRemovedFromDocumentRoot_(self->_headerFooters[1][i], v13, rootCopy);
  }

  for (j = 0; j != 3; ++j)
  {
    objc_msgSend_wasRemovedFromDocumentRoot_(self->_headerFooters[0][j], v13, rootCopy);
  }
  ...
  if (v9)
  {
    ...
    while (2)
    {
      for (i = 0; i != v9; ++i)
      {
        ...
        IsEqual_toString = objc_msgSend_localizedCaseInsensitiveIsEqual_toString_(v20, v21, nameCopy, v14);
  ...
  if (v13)
  {
    ...
    do
    {
      for (i = 0; i != v13; ++i)
      {
        ...
        if (!objc_msgSend_length(prefixCopy, v18, v19) || (objc_msgSend_objectLocale(v16, v20, v21), v22 = objc_claimAutoreleasedReturnValue(), objc_msgSend_locale(v22, v23, v24), v25 = objc_claimAutoreleasedReturnValue(), hasCaseInsensitivePrefix_withLocale = objc_msgSend_tst_hasCaseInsensitivePrefix_withLocale_(v17, v26, prefixCopy, v25), v25, v22, hasCaseInsensitivePrefix_withLocale))
        {
      ...
      for (i = 0; i != v5; ++i)
      {
        ...
        if (objc_opt_isKindOfClass())
        {
          ...
          if (v15)
          {
            ...
            IsEqual_toString = objc_msgSend_localizedCaseInsensitiveIsEqual_toString_(v19, v20, usedCopy, v15);
...
- (void)addRemappedTableName:(id)name
{
  ...
  objc_msgSend_addObject_(remappedTableNames, nameCopy, nameCopy);
}
...
- (void)insertContainedModel:(id)model atIndex:(unint64_t)index
{
  ...
  if (v6)
  {
    objc_msgSend_insertChildInfo_atIndex_(self, v6, v6, index, &unk_2885092B0);
  }
...
- (void)moveModel:(id)model toIndex:(unint64_t)index
{
  ...
  if (v7)
  {
    ...
    v12 = objc_msgSend_indexSetWithIndex_(MEMORY[0x277CCAA78], v11, index);
...
- (void)addChildInfo:(id)info
{
  ...
  objc_msgSend_insertChildInfo_atIndex_(self, v7, infoCopy, v6);
}
...
- (void)insertChildInfo:(id)info atIndex:(unint64_t)index
{
  ...
  objc_msgSend_insertDrawableInfo_atIndex_context_(self, v10, v6, index, v9);
}
...
- (void)insertChildInfo:(id)info below:(id)below
{
  infoCopy = info;
  belowCopy = below;
  v8 = objc_msgSend_indexOfObject_(self->_childInfos, v7, belowCopy);
  objc_msgSend_insertChildInfo_atIndex_(self, v9, infoCopy, v8 + 1);
}
...
- (void)insertChildInfo:(id)info above:(id)above
{
  infoCopy = info;
  aboveCopy = above;
  v8 = objc_msgSend_indexOfObject_(self->_childInfos, v7, aboveCopy);
  objc_msgSend_insertChildInfo_atIndex_(self, v9, infoCopy, v8);
}
...
- (void)replaceChildInfo:(id)info with:(id)with
{
  ...
  withCopy = with;
  objc_msgSend_willModify(self, v7, v8);
  v10 = objc_msgSend_indexOfObject_(self->_childInfos, v9, infoCopy);
  objc_msgSend_replaceObjectAtIndex_withObject_(self->_childInfos, v11, v10, withCopy);
  objc_msgSend_setParentInfo_(infoCopy, v12, 0);
  objc_msgSend_setParentInfo_(withCopy, v13, self);
}

- (void)loadFromArchive:(const void *)archive unarchiver:(id)unarchiver
{
  unarchiverCopy = unarchiver;
  v8 = objc_msgSend_tsp_stringWithProtobufString_(MEMORY[0x277CCACA8], v7, *(archive + 12) & 0xFFFFFFFFFFFFFFFELL);
  name = self->_name;
  self->_name = v8;
  ...
  v70[3] = &unk_27A6A2A68;
  v70[4] = self;
  sub_275F0CFF8(unarchiverCopy, archive + 24, &unk_2885092B0, v70);
  self->_inDocument = 1;
  self->_tableNameCounter = 1;
  v12 = *(archive + 4);
  self->_inPortraitPageOrientation = ((v12 & 0x40) == 0) | *(archive + 144) & 1;
  self->_showPageNumbers = ((v12 & 0x100) == 0) | *(archive + 146) & 1;
  self->_isAutofitOn = ((v12 & 0x200) == 0) | *(archive + 147) & 1;
  self->_printBackgrounds = ((v12 & 0x20000) == 0) | *(archive + 170) & 1;
  if ((v12 & 0x400) != 0)
  {
    v13 = *(archive + 37);
...
LABEL_10:
  self->_pageOrder = 0;
  self->_pageOrder = (*(archive + 38) == 1) & (v12 >> 11);
  if ((v12 & 2) != 0)
  {
  ...
  if ((v19 & 0x40000) != 0)
  {
    self->_shouldPrintComments = *(archive + 171);
  }
  ...
  if ((v19 & 0x2000) != 0)
  {
    TSPCGFloatFromFloat(*(archive + 40));
...
LABEL_21:
  ...
  TSPCGFloatFromFloat(*(archive + 41));
  self->_pageFooterInset = v23;
  v19 = *(archive + 4);
LABEL_24:
  self->_layoutDirection = (*(archive + 43) != 0) & (v19 >> 19);
  v68[0] = 0;
  v68[1] = v68;
  v68[2] = 0x3032000000;
  v68[3] = sub_275F0D1F4;
  ...
  if ((v19 & 0x10000) != 0)
  {
    self->_usesSingleHeaderFooter = *(archive + 169);
  }
  ...
  if (v32 >= 1)
  {
    ...
    while (1)
    {
      ...
      v38 = *(v37 + 1);
LABEL_39:
      TSP::Reference::CopyFrom(v38, *(*(archive + 8) + v33));
      v33 += 8;
      if (!--v34)
      {
        goto LABEL_40;
...
LABEL_40:
  ...
  if (v40 >= 1)
  {
    ...
    while (1)
    {
      ...
      v46 = *(v45 + 1);
LABEL_49:
      TSP::Reference::CopyFrom(v46, *(*(archive + 11) + v41));
      v41 += 8;
      if (!--v42)
      {
        goto LABEL_50;
...
- (void)loadFromUnarchiver:(id)unarchiver
{
  ...
  v5 = objc_msgSend_messageWithDescriptor_(unarchiverCopy, v4, off_2812DAFE8[22]);
...
- (void)saveToArchiver:(id)archiver
{
  ...
  google::protobuf::internal::AssignDescriptors();
  v5 = objc_msgSend_messageWithNewFunction_descriptor_(archiverCopy, v4, sub_275F0ECD4, off_2812DAFE8[22]);
...
- (void)saveToArchive:(void *)archive archiver:(id)archiver
{
  ...
  sub_275F0E0DC(archive, v11);

  objc_msgSend_setStrongReferenceArray_message_(archiverCopy, v12, self->_childInfos, archive + 24);
...
LABEL_10:
  v28 = *(archive + 4);
  *(archive + 144) = self->_inPortraitPageOrientation;
  *(archive + 146) = self->_showPageNumbers;
  *(archive + 147) = self->_isAutofitOn;
  ...
  *(archive + 4) = v28 | 0x742;
  if (!*(archive + 13))
  {
    ...
    *(archive + 13) = MEMORY[0x277C90F20](v30);
  }
  ...
  if (style)
  {
    *(archive + 4) |= 0x20u;
    ...
    objc_msgSend_setStrongReference_message_(archiverCopy, v31, style, v34);
  ...
  if (v40)
  {
    ...
    if ((isEqual & 1) == 0)
    {
      objc_msgSend_requiresDocumentReadVersion_writeVersion_featureIdentifier_(archiverCopy, v38, *MEMORY[0x277D80968], *MEMORY[0x277D808C8], @"TNSheetBackgrounds");
    }
  }

  v50 = objc_msgSend_layoutDirection(self, v38, v39);
  v53 = *(archive + 4) | 0x80000;
  *(archive + 4) = v53;
  if (v50)
  {
    *(archive + 43) = 1;
    objc_msgSend_requiresDocumentVersion_(archiverCopy, v51, *MEMORY[0x277D80990]);
    v53 = *(archive + 4);
  }
  ...
  *(archive + 4) = v74 | 0x30000;
  *(archive + 169) = usesSingleHeaderFooter;
  v76 = 1;
  do
  {
    v77 = 0;
...
LABEL_49:
          ...
          *v84 = v86 + 1;
          v91 = MEMORY[0x277C90F90](*(archive + 9));
          v92 = *(archive + 20);
          v93 = *(archive + 11) + 8 * v92;
          *(archive + 20) = v92 + 1;
          *(v93 + 8) = v91;
          objc_msgSend_setStrongReference_message_(archiverCopy, v94, v83, v91);
          goto LABEL_51;
        }

        *(archive + 20) = v85 + 1;
        objc_msgSend_setStrongReference_message_(archiverCopy, v73, v83, *&v84[2 * v85 + 2]);
LABEL_51:
        if (++v77 == 3)
        {
          goto LABEL_54;
      ...
      {
        *(archive + 14) = v81 + 1;
        objc_msgSend_setStrongReference_message_(archiverCopy, v73, v79, *&v80[2 * v81 + 2]);
        goto LABEL_46;
      }
...
LABEL_44:
      ...
      *v80 = v82 + 1;
      v87 = MEMORY[0x277C90F90](*(archive + 6));
      v88 = *(archive + 14);
      v89 = *(archive + 8) + 8 * v88;
      *(archive + 14) = v88 + 1;
      *(v89 + 8) = v87;
      objc_msgSend_setStrongReference_message_(archiverCopy, v90, v79, v87);
LABEL_46:
      ++v77;
    }
...
- (void)i_importHeadersFooters:(id)footers headerType:(int64_t)type useSingleHeaderFooter:(BOOL)footer
{
  ...
  footersCopy = footers;
  objc_msgSend_willModify(self, v8, v9);
  self->_usesSingleHeaderFooter = footerCopy;
  if (footerCopy)
  {
    if (objc_msgSend_count(footersCopy, v10, v11) == 1)
    {
      goto LABEL_7;
    }
  ...
  {
    if (objc_msgSend_count(footersCopy, v10, v11) == 3)
    {
      goto LABEL_7;
    }
...
LABEL_7:
  ...
  do
  {
    ...
    if (v33 == 1 || !self->_usesSingleHeaderFooter)
    {
      ...
      {
        objc_msgSend_objectAtIndexedSubscript_(footersCopy, v36, 0);
      }

      else
      {
        objc_msgSend_objectAtIndexedSubscript_(footersCopy, v36, v33);
      }
      v40 = ;
      v41 = v34[v33];
      v34[v33] = v40;
