...
- (id)dictionaryRepresentation
{
  ...
  {
    v6 = [objc_alloc(MEMORY[0x1E695DF70]) initWithCapacity:{-[NSMutableArray count](self->_changes, "count")}];
    v15 = 0u;
    v16 = 0u;
    v17 = 0u;
    v18 = 0u;
...
- (void)mergeFrom:(id)from
{
  ...
  {
    [(SYChangeMessage *)self setHeader:?];
  }
  ...
  if (v8)
  {
    ...
    do
    {
      for (i = 0; i != v9; ++i)
      {
        ...
        [(SYChangeMessage *)self addChanges:*(*(&v13 + 1) + 8 * i), v13];
      }
