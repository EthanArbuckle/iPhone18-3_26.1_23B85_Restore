...
- (id)createLanguageViewControllerWithLocales:(id)locales
{
  ...
  {
    v4 = [(CACLanguageViewBridge *)self->_viewBridge makeLanguageUIWithLocales:locales];
...
{
  identifierCopy = identifier;
  delegate = [(CACUILanguageViewBridgeController *)self delegate];
  [delegate selectedLanguageWithIdentifier:identifierCopy];
}
