    ...
    if (v68)
    {
      ...
      do
      {
        for (ii = 0; ii != v87; ++ii)
        {
          ...
          integerValue7 = [*(*(&v105 + 1) + 8 * ii) integerValue];
          ...
          if (v73)
          {
            ...
            do
            {
              for (jj = 0; jj != v73; ++jj)
              {
                ...
                integerValue8 = [*(*(&v98 + 1) + 8 * jj) integerValue];
        ...
        if (integerValue > 2)
        {
          if (integerValue == 3)
          {
            ...
            else
            {
              v17 = v23;
              v24 = v10;
              relevantDrainPredictorModelForPhoneSecondStage95Limit = v54;
            }
          }
...
- (id)predictedRelevantDrainwithFeatures:(id)features forModel:(id)model withThreshold:(id)threshold
{
  ...
  if (featuresCopy)
  {
    ...
    if (v13)
    {
      ...
      v29 = 0;
      v15 = [modelCopy predictionFromFeatures:v14 error:&v29];
      v16 = v29;
      if (v16)
      {
        v17 = v16;
