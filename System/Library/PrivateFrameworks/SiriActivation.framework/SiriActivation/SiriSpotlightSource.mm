...
void __42__SiriSpotlightSource_configureConnection__block_invoke_2(uint64_t a1, void *a2)
{
  ...
  {
    v7 = 136315394;
    v8 = "[SiriSpotlightSource configureConnection]_block_invoke_2";
    v9 = 2112;
    v10 = v3;
...
void __42__SiriSpotlightSource_configureConnection__block_invoke_26(uint64_t a1, void *a2)
{
  ...
  if (WeakRetained)
  {
    ...
    {
      v9 = 136315394;
      v10 = "[SiriSpotlightSource configureConnection]_block_invoke";
      v11 = 2112;
      v12 = v3;
...
- (void)activateWithContext:(id)a3
{
  ...
  [v5 activationRequestFromSpotlightWithContext:v4];
...
void __42__SiriSpotlightSource_configureConnection__block_invoke_24_cold_1(uint64_t a1, NSObject *a2)
{
  ...
  v3 = 136315394;
  v4 = "[SiriSpotlightSource configureConnection]_block_invoke";
  v5 = 2112;
  v6 = a1;
