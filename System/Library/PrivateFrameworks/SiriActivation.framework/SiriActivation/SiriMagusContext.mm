...
- (id)description
{
  ...
  v8 = [v3 stringWithFormat:@"<SiriMagusContext contextOverride:%@, speechRequestOptions:%@, requestInfo:%@, userActivity:%@>", contextOverride, speechRequestOptions, requestInfo, userActivity];
