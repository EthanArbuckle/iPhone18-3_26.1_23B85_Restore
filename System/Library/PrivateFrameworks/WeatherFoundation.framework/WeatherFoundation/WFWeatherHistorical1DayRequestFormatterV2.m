...
+ (id)forecastRequest:(unint64_t)a3 forLocation:(id)a4 withUnits:(int)a5 locale:(id)a6 date:(id)a7 rules:(id)a8 options:(id)a9
{
  ...
  if (v14)
  {
    v15 = [objc_opt_class() dateFormatter];
  ...
  else
  {
    ...
    {
      [WFWeatherStoreServiceConfiguration forecastRequestForTypes:v11 location:v22 units:? date:? apiVersion:? error:? requestOptions:?];
    }
