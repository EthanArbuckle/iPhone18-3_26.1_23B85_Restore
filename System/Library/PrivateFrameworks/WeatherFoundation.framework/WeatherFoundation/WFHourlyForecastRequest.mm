...
- (WFHourlyForecastRequest)initWithLocation:(id)location completionHandler:(id)handler;
- (id)description;
...
- (void)startWithService:(id)service
{
  serviceCopy = service;
  location = [(WFAggregateForecastRequest *)self location];
  locale = [(WFHourlyForecastRequest *)self locale];
  identifier = [(WFTask *)self identifier];
  [serviceCopy hourlyForecastForLocation:location locale:locale taskIdentifier:identifier];
}
