...
- (PXExistingMemoriesDebugCollectionItem)initWithMemory:(id)memory;
@end
...
- (PXExistingMemoriesDebugCollectionItem)initWithMemory:(id)memory
{
  memoryCopy = memory;
  v28.receiver = self;
  v28.super_class = PXExistingMemoriesDebugCollectionItem;
  v6 = [(PXExistingMemoriesDebugCollectionItem *)&v28 init];
  if (v6)
  {
    v7 = [MEMORY[0x1E6978630] fetchKeyAssetsInAssetCollection:memoryCopy options:0];
