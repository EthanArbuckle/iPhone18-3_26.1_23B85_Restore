...
- (PXPeopleMeDataSource)init
{
  ...
  [v4 handleFailureInMethod:a2 object:self file:@"PXPeopleMeDataSource.m" lineNumber:231 description:{@"%s is not available as initializer", "-[PXPeopleMeDataSource init]"}];
...
- (void)_assertIsOnFetchQueue
{
  ...
  if (label != v6)
  {
    ...
    [v7 handleFailureInMethod:a2 object:self file:@"PXPeopleMeDataSource.m" lineNumber:225 description:{@"Invalid parameter not satisfying: %@", @"dispatch_queue_get_label(DISPATCH_CURRENT_QUEUE_LABEL) == dispatch_queue_get_label(self.fetchQueue)"}];
  }
}
...
{
  v4 = a3;
  v5 = [(PXPeopleMeDataSource *)self photoLibrary];
  v6 = [PXPeopleUtilities personWithPersonUri:v4 photoLibrary:v5];
...
- (id)_fetchQueue_suggestedPersonForMe
{
  ...
  {
    v3 = [(PXPeopleMeDataSource *)self suggestedPerson];
    goto LABEL_22;
  }
  ...
  if (PFOSVariantHasInternalUI())
  {
    ...
    v7 = [v6 integerForKey:@"PhotosPeopleSuggestedMeIndex"];
...
LABEL_16:
  ...
  v26 = 0;
  v19 = [v18 suggestedMePersonIdentifierWithError:&v26];
  v20 = v26;
  ...
  if (v19)
  {
    ...
    v23 = [(PXPeopleMeDataSource *)self photoLibrary];
    v3 = [PXPeopleUtilities personWithLocalIdentifier:v19 photoLibrary:v23];
...
- (void)_fetchQueue_requestMeContactWithCompletion:(id)a3
{
  ...
  v19 = 0;
  v5 = [(PXPeopleMeDataSource *)self meContactIsolationQueue];
...
- (void)rejectSuggestedMePerson
{
  v2 = [(PXPeopleMeDataSource *)self fetchQueue];
  dispatch_async(v2, &__block_literal_global_146673);
}
...
{
  objc_initWeak(&location, self);
  v3 = [(PXPeopleMeDataSource *)self fetchQueue];
...
- (void)requestSuggestedMePersonWithCompletion:(id)a3
{
  ...
  objc_initWeak(&location, self);
  v6 = [(PXPeopleMeDataSource *)self fetchQueue];
  block[0] = MEMORY[0x1E69E9820];
  block[1] = 3221225472;
...
- (PXPeopleMeDataSource)initWithPhotoLibrary:(id)a3
{
  ...
  if (v6)
  {
    ...
    [v16 registerDefaults:&unk_1F190F648];
  }
...
{
  v4 = [MEMORY[0x1E696AAA8] currentHandler];
  [v4 handleFailureInMethod:a2 object:a1 file:@"PXPeopleMeDataSource.m" lineNumber:235 description:{@"%s is not available as initializer", "+[PXPeopleMeDataSource new]"}];
