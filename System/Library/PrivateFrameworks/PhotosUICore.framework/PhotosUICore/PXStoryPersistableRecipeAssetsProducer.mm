...
- (PXStoryPersistableRecipeAssetsProducer)initWithPersistableRecipe:(id)recipe;
...
- (id)requestAssetsWithOptions:(unint64_t)options storyQueue:(id)queue resultHandler:(id)handler
{
  optionsCopy = options;
  handlerCopy = handler;
  persistableRecipe = [(PXStoryPersistableRecipeAssetsProducer *)self persistableRecipe];
  ...
  else
  {
    ...
    workQueue = [(PXStoryPersistableRecipeAssetsProducer *)self workQueue];
...
- (PXStoryPersistableRecipeAssetsProducer)initWithPersistableRecipe:(id)recipe
{
  ...
  if (v6)
  {
    objc_storeStrong(&v6->_persistableRecipe, recipe);
    v8 = objc_opt_class();
...
- (PXStoryPersistableRecipeAssetsProducer)init
{
  ...
  [currentHandler handleFailureInMethod:a2 object:self file:@"PXStoryPersistableRecipeAssetsProducer.m" lineNumber:26 description:{@"%s is not available as initializer", "-[PXStoryPersistableRecipeAssetsProducer init]"}];
