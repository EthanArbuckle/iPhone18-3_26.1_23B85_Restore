...
- (unint64_t)endingType
{
  ...
  v3 = [(PXNewMagazineGrid *)self _rowsUsed];
...
- (PXNewMagazineGrid)init
{
  ...
  [v4 handleFailureInMethod:a2 object:self file:@"PXNewMagazineGrid.m" lineNumber:24 description:{@"%s is not available as initializer", "-[PXNewMagazineGrid init]"}];
