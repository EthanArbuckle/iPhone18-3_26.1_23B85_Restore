...
- (PXActionMenuController)initWithActionManagers:(id)managers;
- (id)_actionableActionManagerForActionType:(id)type;
- (id)_menuElementsForSection:(int64_t)section;
...
- (void)setDefaultActivityTypeOrder:(id)order;
- (void)setDisabledActionTypes:(id)types;
- (void)setExcludedActionTypes:(id)types;
- (void)updateActions;
@end
...
- (id)_menuElementsForSection:(int64_t)section
{
  ...
  v4 = [(PXActionMenuController *)self availableActionTypesInSection:section];
  disabledActionTypes = [(PXActionMenuController *)self disabledActionTypes];
  ...
  if (v9)
  {
    ...
    do
    {
      for (i = 0; i != v10; ++i)
      {
        ...
        v13 = *(*(&v18 + 1) + 8 * i);
        if (([excludedActionTypes containsObject:{v13, v18}] & 1) == 0 && (objc_msgSend(disabledActionTypes, "containsObject:", v13) & 1) == 0 && -[PXActionMenuController shouldAllowPerformanceOfActionType:](self, "shouldAllowPerformanceOfActionType:", v13))
        {
...
- (void)_updateSectionedActions
{
  ...
  numberOfSections = [(PXActionMenuController *)self numberOfSections];
  array = [MEMORY[0x1E695DF70] array];
  if (numberOfSections >= 1)
  {
    v5 = 0;
    v6 = 0x1E69DC000uLL;
    v20 = numberOfSections;
    do
    {
...
- (void)_updateActionsUsingActivityTypeOrder
{
  ...
  availableActionTypes = [(PXActionMenuController *)self availableActionTypes];
  availableInternalActionTypes = [(PXActionMenuController *)self availableInternalActionTypes];
  availableDestructiveActionTypes = [(PXActionMenuController *)self availableDestructiveActionTypes];
  disabledActionTypes = [(PXActionMenuController *)self disabledActionTypes];
  if ([(PXActionMenuController *)self actionsAreExcludedWhenCustomized])
  {
    excludedActionTypes = 0;
  }
  ...
  v67 = [objc_alloc(MEMORY[0x1E695DF70]) initWithCapacity:{objc_msgSend(availableActionTypes, "count")}];
  v7 = [objc_alloc(MEMORY[0x1E695DF70]) initWithCapacity:{objc_msgSend(availableInternalActionTypes, "count")}];
  v8 = objc_alloc_init(MEMORY[0x1E695DF70]);
  v9 = [objc_alloc(MEMORY[0x1E695DF70]) initWithCapacity:{objc_msgSend(availableDestructiveActionTypes, "count")}];
  v10 = [objc_alloc(MEMORY[0x1E695DF90]) initWithCapacity:{objc_msgSend(availableActionTypes, "count")}];
  ...
  v86[3] = &unk_1E7738908;
  v59 = excludedActionTypes;
  selfCopy = self;
  v87 = v59;
  selfCopy2 = self;
  v57 = disabledActionTypes;
  v89 = v57;
  v55 = v12;
  v90 = v55;
  v66 = v8;
  ...
  v13 = v10;
  v92 = v13;
  v14 = availableInternalActionTypes;
  v93 = v14;
  v64 = v7;
  v94 = v64;
  v15 = availableDestructiveActionTypes;
  v95 = v15;
  v62 = v9;
  v96 = v62;
  v68 = v67;
  ...
  v33 = selfCopy;
  defaultActivityTypeOrder = [(PXActionMenuController *)selfCopy defaultActivityTypeOrder];
  v35 = [defaultActivityTypeOrder count];
  ...
  if (v35)
  {
    ...
    v70 = 0u;
    v71 = 0u;
    allValues = [(PXActionMenuController *)selfCopy defaultActivityTypeOrder:v17];
    v37 = [allValues countByEnumeratingWithState:&v70 objects:v102 count:16];
    if (v37)
    {
      v38 = v37;
      v39 = *v71;
      do
      {
        ...
        v38 = [allValues countByEnumeratingWithState:&v70 objects:v102 count:16];
      }
  ...
  else
  {
    ...
    [v32 addObjectsFromArray:allValues];
  }
...
- (id)_actionableActionManagerForActionType:(id)type
{
  ...
  v13 = 0u;
  v14 = 0u;
  actionManagers = [(PXActionMenuController *)self actionManagers];
  v6 = [actionManagers countByEnumeratingWithState:&v11 objects:v15 count:16];
  if (v6)
  {
    v7 = *v12;
    while (2)
    {
      for (i = 0; i != v6; i = i + 1)
      {
        if (*v12 != v7)
        {
          objc_enumerationMutation(actionManagers);
        }

        v9 = *(*(&v11 + 1) + 8 * i);
        if ([v9 canPerformActionType:typeCopy])
        {
          v6 = v9;
          goto LABEL_11;
        }
...
- (BOOL)sectionDisplaysInline:(int64_t)inline
{
  ...
  [currentHandler handleFailureInMethod:a2 object:self file:@"PXActionMenuController.m" lineNumber:113 description:{@"Method %s is a responsibility of subclass %@", "-[PXActionMenuController sectionDisplaysInline:]", v7}];
...
- (id)iconForSection:(int64_t)section
{
  ...
  v6 = objc_opt_class();
  v7 = NSStringFromClass(v6);
  [currentHandler handleFailureInMethod:a2 object:self file:@"PXActionMenuController.m" lineNumber:109 description:{@"Method %s is a responsibility of subclass %@", "-[PXActionMenuController iconForSection:]", v7}];
...
- (id)titleForSection:(int64_t)section
{
  ...
  v6 = objc_opt_class();
  v7 = NSStringFromClass(v6);
  [currentHandler handleFailureInMethod:a2 object:self file:@"PXActionMenuController.m" lineNumber:105 description:{@"Method %s is a responsibility of subclass %@", "-[PXActionMenuController titleForSection:]", v7}];
...
- (id)availableActionTypesInSection:(int64_t)section
{
  ...
  v6 = objc_opt_class();
  v7 = NSStringFromClass(v6);
  [currentHandler handleFailureInMethod:a2 object:self file:@"PXActionMenuController.m" lineNumber:101 description:{@"Method %s is a responsibility of subclass %@", "-[PXActionMenuController availableActionTypesInSection:]", v7}];
...
- (int64_t)numberOfSections
{
  ...
  [currentHandler handleFailureInMethod:a2 object:self file:@"PXActionMenuController.m" lineNumber:97 description:{@"Method %s is a responsibility of subclass %@", "-[PXActionMenuController numberOfSections]", v6}];
...
- (BOOL)shouldAllowPerformanceOfActionType:(id)type
{
  ...
  [currentHandler handleFailureInMethod:a2 object:self file:@"PXActionMenuController.m" lineNumber:89 description:{@"Method %s is a responsibility of subclass %@", "-[PXActionMenuController shouldAllowPerformanceOfActionType:]", v8}];
...
- (NSArray)availableActionTypes
{
  ...
  v5 = objc_opt_class();
  v6 = NSStringFromClass(v5);
  [currentHandler handleFailureInMethod:a2 object:self file:@"PXActionMenuController.m" lineNumber:81 description:{@"Method %s is a responsibility of subclass %@", "-[PXActionMenuController availableActionTypes]", v6}];
...
- (void)setExcludedActionTypes:(id)types
{
  if (self->_excludedActionTypes != types)
  {
    v5 = [types copy];
...
- (void)setDisabledActionTypes:(id)types
{
  if (self->_disabledActionTypes != types)
  {
    v5 = [types copy];
...
- (void)setDefaultActivityTypeOrder:(id)order
{
  if (self->_defaultActivityTypeOrder != order)
  {
    v5 = [order copy];
...
- (PXActionMenuController)initWithActionManagers:(id)managers
{
  ...
  if (v6)
  {
    objc_storeStrong(&v6->_actionManagers, managers);
...
{
  currentHandler = [MEMORY[0x1E696AAA8] currentHandler];
  [currentHandler handleFailureInMethod:a2 object:self file:@"PXActionMenuController.m" lineNumber:34 description:{@"%s is not available as initializer", "-[PXActionMenuController init]"}];
