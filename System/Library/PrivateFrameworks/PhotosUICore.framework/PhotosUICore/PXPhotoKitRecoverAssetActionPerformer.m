...
+ (BOOL)canPerformWithSelectionSnapshot:(id)a3 person:(id)a4 socialGroup:(id)a5
{
  ...
  if (!v8)
  {
    ...
    [v12 handleFailureInMethod:a2 object:a1 file:@"PXPhotoKitRecoverAssetActionPerformer.m" lineNumber:23 description:{@"%@ should be an instance inheriting from %@, but it is nil", @"selectionSnapshot.dataSource", v14}];
LABEL_9:
  ...
  if ((objc_opt_isKindOfClass() & 1) == 0)
  {
    ...
    [v12 handleFailureInMethod:a2 object:a1 file:@"PXPhotoKitRecoverAssetActionPerformer.m" lineNumber:23 description:{@"%@ should be an instance inheriting from %@, but it is %@", @"selectionSnapshot.dataSource", v14, v16}];
...
LABEL_4:
  ...
  v10 = [v9 px_isRecoveredSmartAlbum];
