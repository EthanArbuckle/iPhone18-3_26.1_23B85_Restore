...
void ___UpdateRulesForLibraryScope_block_invoke_636(uint64_t a1, void *a2)
{
  v5 = a2;
  if (![v5 contactType])
  {
...
{
  v7 = [MEMORY[0x1E69788A8] changeRequestForLibraryScope:*(a1 + 32)];
  [v7 setAutoSharePolicy:*(a1 + 56)];
  if (*(a1 + 56) == 2)
  {
    ...
    if (*(a1 + 40))
    {
      ...
      v4 = PXSharedLibraryDateConditionForSelectedStartDate(*(a1 + 40));
      [v3 addCondition:v4];
      [v2 addObject:v3];
    }
    ...
    if ([*(a1 + 48) count])
    {
      ...
      v6 = PXSharedLibraryPersonConditionForSelectedPeople(*(a1 + 48));
      [v5 addCondition:v6];
      [v2 addObject:v5];
    }
...
void ___UpdateRulesForLibraryScope_block_invoke_3(uint64_t a1, int a2, void *a3)
{
  ...
  {
    *buf = 0;
    _os_signpost_emit_with_name_impl(&dword_1A3C1C000, v7, OS_SIGNPOST_INTERVAL_END, v8, "UpdateRulesForLibraryScope", "", buf, 2u);
  }
...
LABEL_10:
  ...
  if (v16)
  {
    ...
    block[1] = 3221225472;
    block[2] = ___UpdateRulesForLibraryScope_block_invoke_641;
