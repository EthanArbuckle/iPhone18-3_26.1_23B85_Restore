...
- (NSArray)clipLayouts;
- (PXStoryTransitionProducerSegment)initWithSegmentInfo:(id *)info;
- (void)addClipWithIdentifier:(int64_t)identifier layout:(id)layout info:(id *)info;
- (void)dealloc;
...
- (void)enumerateClipsUsingBlock:(id)block
{
  ...
  if (count >= 1)
  {
    ...
    for (i = 0; i < count; ++i)
    {
      ...
      v12(blockCopy, count, i, v14, __dst, v11, v16);
...
- (void)addClipWithIdentifier:(int64_t)identifier layout:(id)layout info:(id *)info
{
  [(NSMutableArray *)self->_clipLayouts addObject:layout];
  ++self->_count;
...
- (PXStoryTransitionProducerSegment)initWithSegmentInfo:(id *)info
{
  ...
  if (v4)
  {
    *(v4 + 40) = *&info->var0;
    ...
    v7 = *&info->var1.var3;
    v8 = *&info->var2.var0;
    *(v4 + 104) = *&info->var2.var2.var1;
    *(v4 + 88) = v8;
    *(v4 + 72) = v7;
    *(v4 + 56) = v6;
    v9 = *&info->var2.var3;
    v10 = *&info->var3.var0.var0;
    v11 = *&info->var3.var0.var3;
    *(v4 + 168) = *&info->var3.var1.var1;
    *(v4 + 152) = v11;
    *(v4 + 136) = v10;
    *(v4 + 120) = v9;
    v12 = *&info->var3.var2.var0;
    v13 = *&info->var3.var2.var3;
    v14 = *&info->var3.var3.var0.var1;
    *(v4 + 29) = info->var3.var3.var1;
    *(v4 + 216) = v14;
    *(v4 + 200) = v13;
    *(v4 + 184) = v12;
