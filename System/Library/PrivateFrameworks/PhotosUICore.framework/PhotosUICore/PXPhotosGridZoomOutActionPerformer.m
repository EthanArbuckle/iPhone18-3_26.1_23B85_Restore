...
- (id)menuElement
{
  ...
  if (v4)
  {
    ...
    if ((objc_opt_isKindOfClass() & 1) == 0)
    {
      ...
      [v6 handleFailureInMethod:a2 object:self file:@"PXPhotosGridZoomOutActionPerformer.m" lineNumber:34 description:{@"%@ should be nil or an instance inheriting from %@, but it is %@", @"[super menuElement]", v8, v9}];
    }
  }
...
+ (BOOL)canPerformActionType:(id)a3 withViewModel:(id)a4
{
  ...
  {
    [v4 zoomStep];
    v8 = v7 + 1.0 < [v4 numberOfZoomSteps];
  }
