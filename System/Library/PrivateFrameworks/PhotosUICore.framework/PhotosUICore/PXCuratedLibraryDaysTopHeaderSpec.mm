...
- (PXCuratedLibraryDaysTopHeaderSpec)initWithExtendedTraitCollection:(id)collection options:(unint64_t)options variant:(int64_t)variant;
@end
...
- (PXCuratedLibraryDaysTopHeaderSpec)initWithExtendedTraitCollection:(id)collection options:(unint64_t)options variant:(int64_t)variant
{
  ...
  v6 = [(PXCuratedLibrarySectionHeaderLayoutSpec *)&v8 initWithExtendedTraitCollection:collection options:options variant:?];
  if (v6)
  {
