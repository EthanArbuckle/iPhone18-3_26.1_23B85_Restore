...
- (BOOL)px_isTruncatedForWidth:()Truncation lines:
{
  ...
  [a1 textRectForBounds:*MEMORY[0x1E695F058] limitedToNumberOfLines:{v8, a2, 9.22337204e18}];
  v10 = v9;
  [a1 textRectForBounds:a4 + 1 limitedToNumberOfLines:{v7, v8, a2, 9.22337204e18}];
  return v11 > v10;
}
...
+ (uint64_t)px_isTruncatedForAttributedString:()Truncation forWidth:lines:
{
  ...
  return [v9 px_isTruncatedForWidth:a5 lines:a1];
}
