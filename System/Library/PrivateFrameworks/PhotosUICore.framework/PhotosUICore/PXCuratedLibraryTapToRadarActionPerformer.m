...
{
  v6 = [a4 activityType];
  v7 = [(PXCuratedLibraryTapToRadarActionPerformer *)self activityType];
  v8 = v7;
  if (v6 == v7)
  {
  ...
  if ((v9 & 1) == 0)
  {
    ...
    [v6 handleFailureInMethod:a2 object:self file:@"PXCuratedLibraryAssetCollectionActionPerformer.m" lineNumber:441 description:{@"Invalid parameter not satisfying: %@", @"PXStringEqualToString(activity.activityType, self.activityType)"}];
LABEL_5:
  }
...
- (PXCuratedLibraryTapToRadarActionPerformer)initWithViewModel:(id)a3 assetCollectionReference:(id)a4 diagnosticLayout:(id)a5
{
  ...
  v9 = [(PXCuratedLibraryAssetCollectionActionPerformer *)&v12 initWithActionType:@"PXCuratedLibraryActionTapToRadar" viewModel:a3 assetCollectionReference:a4];
  v10 = v9;
  if (v9)
  {
