...
- (PXNavigationPersonListItem)initWithPerson:(id)a3 reorderable:(BOOL)a4 topLevelIdentifier:(id)a5;
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v6 = [(PXNavigationPersonListItem *)self representedObject];
...
- (PXNavigationPersonListItem)initWithPerson:(id)a3 reorderable:(BOOL)a4 topLevelIdentifier:(id)a5
{
  ...
  v12 = [PXPeopleUtilities titleStringForPerson:v9];
  v15.receiver = self;
