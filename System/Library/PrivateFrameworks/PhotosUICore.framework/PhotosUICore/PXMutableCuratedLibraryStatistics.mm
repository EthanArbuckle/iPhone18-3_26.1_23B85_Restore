...
- (void)_incrementCountForPlaybackStyle:(int64_t)style displayProminence:(int64_t)prominence autoPlaybackEligibility:(int64_t)eligibility;
- (void)appendStatisticsForSection:(int64_t)section assetsDataSource:(id)source playbackController:(id)controller visibleItems:(id)items heroItems:(id)heroItems keyItem:(int64_t)item;
- (void)dealloc;
@end
...
- (void)appendStatisticsForSection:(int64_t)section assetsDataSource:(id)source playbackController:(id)controller visibleItems:(id)items heroItems:(id)heroItems keyItem:(int64_t)item
{
  ...
  *(&v30 + 1) = section;
  ...
  v25 = v21;
  selfCopy = self;
  [itemsCopy enumerateIndexesUsingBlock:v22];
...
{
  counts = self->_counts;
  v6 = [(PXMutableCuratedLibraryStatistics *)self _coutIndexForPlaybackStyle:style displayProminence:prominence autoPlaybackEligibility:eligibility];
  ++counts[v6];
}
