...
- (id)description
{
  ...
  v10 = [v3 stringWithFormat:@"<IMRecoverJunkCommandPipelineParameter %p GUID = %@; timestamp = %@; isFromStorage = %@; isLastFromStorage = %@; isFromMe = %@; OUTPUT chat = %@;", self, v4, v5, v7, v8, v6, v9];;
