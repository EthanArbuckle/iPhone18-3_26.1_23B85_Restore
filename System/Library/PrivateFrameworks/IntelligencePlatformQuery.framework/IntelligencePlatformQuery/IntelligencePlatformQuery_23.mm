  ...
  if (v8 <= 519)
  {
    ...
    if (v11 == 675)
    {
      ...
      **(v7 + 14) = v7[120];
      ...
      v15 = *(v7 + 12);
      if (strlen(v15) != 1 || (v16 = *v15, (*(MEMORY[0x277D85DE0] + 4 * v16 + 60) & 0x10000) != 0) || (v16 <= 0x2B ? (v17 = ((1 << v16) & 0x88400000000) == 0) : (v17 = 1), !v17 || scanner_isspace(v16)))
      {
