...
- (id)_composeSpeakerConfusionWithScores:(id)scores forProfiles:(id)profiles
{
  ...
  v27 = 0u;
  obj = scoresCopy;
  v6 = [obj countByEnumeratingWithState:&v26 objects:v31 count:{16, scoresCopy}];
  if (v6)
  {
    v7 = *v27;
    do
    ...
    if (v30)
    {
      ...
      do
      {
        ...
        do
        {
          ...
          [v32 setVoiceProfileConfusionScores:array2];
          ++v31;
...
- (void)_logSpeakerConfusionWithExplicitScores:(id)scores withImplicitScores:(id)implicitScores withPurgeUtterances:(unint64_t)utterances forProfile:(id)profile forConfigVersion:(id)version
{
  ...
  if (scoresCopy && [scoresCopy count])
  {
    ...
    if ([v20 containsObject:profileID])
    {
      ...
      v51 = [(SSRVoiceProfileRetrainerPSR *)self _composeSpeakerConfusionWithScores:scoresCopy forProfiles:v20];
      v50 = [(SSRVoiceProfileRetrainerPSR *)self _composeSpeakerConfusionWithScores:implicitScoresCopy forProfiles:v20];
      v56[0] = @"locale";
      ...
      [mEMORY[0x277CEF150] logEventWithType:6113 context:v49 contextNoCopy:0];
...
LABEL_8:
    ...
    if (v14 > 2)
    {
      if (getSATVectorCount >= v14)
      {
        ...
        v53 = [objc_alloc(MEMORY[0x277CBEB18]) initWithCapacity:getSATVectorCount - v14];
...
LABEL_55:
  ...
  v56 = [v5 stringWithFormat:@"Cannot create comparative scorers from %@ on profile %@", v6, profileID9];
...
- (void)addUtterances:(id)utterances withPolicy:(id)policy withCompletion:(id)completion
{
  ...
  if (utterancesCopy && [utterancesCopy count])
  {
    ...
    [MEMORY[0x277D016E0] inputRecordingSampleRate];
    v62 = [v8 initWithConfigFile:psrConfigFilePath configRoot:psrConfigRoot sampleRate:v11 delegate:self queue:self->_queue];
    ...
    if (v54)
    {
      [context addObjectsFromArray:v54];
    }
...
LABEL_17:
    ...
    while (1)
    {
      ...
      if ((v25 & 1) == 0)
      {
        ...
        path2 = [v23 path];
        [v65 setObject:v26 forKey:path2];
        goto LABEL_41;
      }
      ...
      path3 = [v23 path];
      [v65 setObject:v26 forKey:path3];
LABEL_42:
...
LABEL_41:
      ...
      if (os_log_type_enabled(v34, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *buf = 136316674;
        ...
        v77 = 2114;
        v78 = lastPathComponent2;
        v79 = 2114;
        v80 = lastPathComponent3;
        v81 = 2114;
        v82 = lastPathComponent4;
        v83 = 2050;
        v84 = getSATVectorCount;
        v85 = 2114;
        v86 = path3;
      ...
      {
        path4 = [v23 path];
        [v57 setObject:path3 forKey:path4];
        v26 = 0;
      }
      ...
      else
      {
        ...
        path5 = [v23 path];
        [v65 setObject:v26 forKey:path5];
      }
    }
    ...
    else
    {
      ...
      path4 = [v23 path];
      [v65 setObject:v26 forKey:path4];
    }
...
- (BOOL)needsRetrainingWithAudioFiles:(id)files
{
  ...
  v32 = 0;
  if (([defaultManager fileExistsAtPath:voiceProfileBasePath isDirectory:&v32] & 1) == 0)
  {
    v7 = v32;
    if ((v32 & 1) == 0)
    {
