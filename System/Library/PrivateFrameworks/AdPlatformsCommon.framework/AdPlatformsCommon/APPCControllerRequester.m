...
- (void)requestPromotedContentOfTypes:(id)a3 forContext:(id)a4 completionHandler:(id)a5
{
  ...
  v9 = a4;
  v10 = a5;
  v16 = objc_msgSend__preprocessHandler_(self, v11, v10, v12, v13, v14, v15);
  if (v16)
  {
    ...
    v28 = v16;
    objc_msgSend_requestPromotedContentOfTypes_forRequester_forContext_completionHandler_(v23, v24, v8, self, v9, v25, v26, v27);
...
- (void)sendAndRankContent:(id)a3 forContext:(id)a4 placement:(unint64_t)a5 responseHandler:(id)a6 completionHandler:(id)a7
{
  ...
  v14 = a6;
  v15 = a7;
  v21 = objc_msgSend__preprocessHandler_(self, v16, v15, v17, v18, v19, v20);
  if (v21)
  {
    objc_initWeak(&location, self);
    ...
    v33 = v21;
    objc_msgSend_sendAndRankContent_forContext_placement_completionHandler_(v28, v29, v12, v13, a5, v30, v31, v32);
...
- (void)contentResponses:(id)a3
{
  ...
  if (v24)
  {
    ...
    if ((v32 & 1) == 0)
    {
      ...
      {
        v70 = 134217984;
        v71 = objc_msgSend_count(v4, v34, v35, v36, v37, v38, v39);
...
- (void)proxyURLWithCompletionHandler:(id)a3
{
  ...
  objc_msgSend_proxyURLForRequester_withCompletionHandler_(v15, v11, self, v4, v12, v13, v14);
}
...
- (void)preWarm:(id)a3 completion:(id)a4
{
  ...
  objc_msgSend_preWarm_forRequester_completion_(v17, v14, v7, self, v6, v15, v16);
}
...
- (void)_invalidateAndfulfillAllRequestsWithError:(id)a3
{
  ...
  objc_msgSend_setLastError_(self, v18, v4, v19, v20, v21, v22);
...
- (void)handleCompletionOfRequest:(id)a3
{
  ...
  v30 = objc_msgSend_objectForKey_(v24, v25, v4, v26, v27, v28, v29);

  v37 = objc_msgSend_requestCompletionBlockByRequestID(self, v31, v32, v33, v34, v35, v36);
  objc_msgSend_removeObjectForKey_(v37, v38, v4, v39, v40, v41, v42);
