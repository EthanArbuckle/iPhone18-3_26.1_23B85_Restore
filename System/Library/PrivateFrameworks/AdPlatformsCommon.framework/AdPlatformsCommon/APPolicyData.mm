...
- (APPolicyData)initWithCoder:(id)a3
{
  ...
  {
    v6 = objc_opt_class();
    v11 = objc_msgSend_decodeObjectOfClass_forKey_(v4, v7, v6, @"creativeIdentifier", v8, v9, v10);
    ...
    v27 = objc_msgSend_decodeObjectOfClasses_forKey_(v4, v23, v22, @"policyValue", v24, v25, v26);
...
- (void)encodeWithCoder:(id)a3
{
  ...
  v13 = a3;
  objc_msgSend_encodeObject_forKey_(v13, v5, creativeIdentifier, @"creativeIdentifier", v6, v7, v8);
  objc_msgSend_encodeObject_forKey_(v13, v9, self->_policyValue, @"policyValue", v10, v11, v12);
}
...
- (BOOL)isEqualToAPPolicyData:(id)a3
{
  ...
  if (objc_opt_isKindOfClass())
  {
    ...
    v18 = objc_msgSend_creativeIdentifier(v4, v12, v13, v14, v15, v16, v17);
