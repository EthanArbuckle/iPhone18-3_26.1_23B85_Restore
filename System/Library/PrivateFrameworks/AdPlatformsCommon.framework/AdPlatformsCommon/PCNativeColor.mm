...
- (PCNativeColor)initWithCoder:(id)coder
{
  ...
  if (v11)
  {
    ...
    v25 = objc_msgSend_decodeObjectOfClasses_forKey_(coderCopy, v21, v20, @"lightModeColors", v22, v23, v24);
    lightModeColors = v11->_lightModeColors;
    v11->_lightModeColors = v25;

    v31 = objc_msgSend_decodeObjectOfClasses_forKey_(coderCopy, v27, v20, @"darkModeColors", v28, v29, v30);
    darkModeColors = v11->_darkModeColors;
    v11->_darkModeColors = v31;

    v11->_gradientOrientation = objc_msgSend_decodeInt32ForKey_(coderCopy, v33, @"gradientOrientation", v34, v35, v36, v37);
  }
...
- (void)encodeWithCoder:(id)coder
{
  ...
  objc_msgSend_encodeObject_forKey_(coderCopy, v11, v10, @"lightModeColors", v12, v13, v14);

  v21 = objc_msgSend_darkModeColors(self, v15, v16, v17, v18, v19, v20);
  objc_msgSend_encodeObject_forKey_(coderCopy, v22, v21, @"darkModeColors", v23, v24, v25);

  v32 = objc_msgSend_gradientOrientation(self, v26, v27, v28, v29, v30, v31);
  objc_msgSend_encodeInt32_forKey_(coderCopy, v33, v32, @"gradientOrientation", v34, v35, v36);
}
