...
- (void)encodeWithCoder:(id)a3
{
  ...
  objc_msgSend_encodeObject_forKey_(v4, v56, v55, @"adNetworkId", v57, v58, v59);

  v66 = objc_msgSend_attributionSignature(self, v60, v61, v62, v63, v64, v65);
  objc_msgSend_encodeObject_forKey_(v4, v67, v66, @"attributionSignature", v68, v69, v70);

  v77 = objc_msgSend_contextIdentifier(self, v71, v72, v73, v74, v75, v76);
  objc_msgSend_encodeObject_forKey_(v4, v78, v77, @"contextIdentifier", v79, v80, v81);

  v92 = objc_msgSend_version(self, v82, v83, v84, v85, v86, v87);
  objc_msgSend_encodeObject_forKey_(v4, v88, v92, @"version", v89, v90, v91);
}
...
- (APInstallAttribution)initWithCoder:(id)a3
{
  ...
  if (v8)
  {
    ...
    v26 = objc_opt_class();
    v31 = objc_msgSend_decodeObjectOfClass_forKey_(v4, v27, v26, @"adNetworkId", v28, v29, v30);
    adNetworkId = v8->_adNetworkId;
    v8->_adNetworkId = v31;

    v33 = objc_opt_class();
    v38 = objc_msgSend_decodeObjectOfClass_forKey_(v4, v34, v33, @"attributionSignature", v35, v36, v37);
    attributionSignature = v8->_attributionSignature;
    v8->_attributionSignature = v38;

    v40 = objc_opt_class();
    v45 = objc_msgSend_decodeObjectOfClass_forKey_(v4, v41, v40, @"contextIdentifier", v42, v43, v44);
    contextIdentifier = v8->_contextIdentifier;
    v8->_contextIdentifier = v45;

    v47 = objc_opt_class();
    v52 = objc_msgSend_decodeObjectOfClass_forKey_(v4, v48, v47, @"version", v49, v50, v51);
    version = v8->_version;
    v8->_version = v52;
  }
