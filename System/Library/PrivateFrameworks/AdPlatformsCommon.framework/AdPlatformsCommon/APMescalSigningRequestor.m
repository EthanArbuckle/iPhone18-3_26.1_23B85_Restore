...
- (void)signatureForData:(id)a3 completion:(id)a4
{
  ...
  v21 = v6;
  v15 = v6;
  objc_msgSend_signatureForData_completion_(v14, v16, v7, v20, v17, v18, v19);
}
...
- (id)signatureForData:(id)a3
{
  ...
  v15[3] = &unk_1E7F20FD0;
  v15[4] = &v16;
  objc_msgSend_signatureForData_completion_(v9, v10, v4, v15, v11, COERCE_DOUBLE(3221225472), v12);
...
- (void)signatureForData:(id)a3 waitTime:(double)a4 completion:(id)a5
{
  ...
  v22 = v8;
  v17 = v8;
  objc_msgSend_signatureForData_waitTime_completion_(v16, v18, v9, v21, v19, a4, v20);
}
