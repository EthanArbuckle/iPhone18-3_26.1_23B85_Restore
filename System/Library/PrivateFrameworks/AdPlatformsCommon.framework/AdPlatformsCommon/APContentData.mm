...
+ (id)createForServerUnfilledReason:(int64_t)reason placementType:(int64_t)type contextIdentifier:(id)identifier size:(id)size
{
  ...
  objc_msgSend_setServerUnfilledReason_(v11, v12, reason, v13, v14, v15, v16);
  objc_msgSend_setContextIdentifier_(v11, v17, identifierCopy, v18, v19, v20, v21);

  v22 = objc_alloc_init(APRepresentationData);
  objc_msgSend_setPlacementType_(v22, v23, type, v24, v25, v26, v27);
...
+ (id)mockDataFromContext:(id)context types:(id)types
{
  ...
  v135 = contextCopy;
  v14 = objc_msgSend_identifier(contextCopy, v8, v9, v10, v11, v12, v13);
...
- (APContentData)initWithCoder:(id)coder
{
  ...
  if (v5)
  {
    ...
    v13 = objc_opt_class();
    v18 = objc_msgSend_decodeObjectOfClass_forKey_(coderCopy, v14, v13, @"contextIdentifier", v15, v16, v17);
    contextIdentifier = v5->_contextIdentifier;
    v5->_contextIdentifier = v18;

    v20 = objc_opt_class();
    v25 = objc_msgSend_decodeObjectOfClass_forKey_(coderCopy, v21, v20, @"journeyIdentifier", v22, v23, v24);
    journeyIdentifier = v5->_journeyIdentifier;
    v5->_journeyIdentifier = v25;

    v27 = objc_opt_class();
    v32 = objc_msgSend_decodeObjectOfClass_forKey_(coderCopy, v28, v27, @"impressionId", v29, v30, v31);
    ...
    v47 = objc_msgSend_decodeObjectOfClasses_forKey_(coderCopy, v43, v42, @"metadata", v44, v45, v46);
    metadata = v5->_metadata;
    v5->_metadata = v47;

    v49 = objc_opt_class();
    v54 = objc_msgSend_decodeObjectOfClass_forKey_(coderCopy, v50, v49, @"disclosureURL", v51, v52, v53);
    disclosureURL = v5->_disclosureURL;
    v5->_disclosureURL = v54;

    if (objc_msgSend_containsValueForKey_(coderCopy, v56, @"disclosureRendererPayload", v57, v58, v59, v60))
    {
      v66 = objc_opt_class();
      v71 = objc_msgSend_decodeObjectOfClass_forKey_(coderCopy, v67, v66, @"disclosureRendererPayload", v68, v69, v70);
      disclosureRendererPayload = v5->_disclosureRendererPayload;
      v5->_disclosureRendererPayload = v71;
    }

    v5->_minimumTimeBetweenPresentation = objc_msgSend_decodeIntForKey_(coderCopy, v61, @"minimumTimeBetweenPresentation", v62, v63, v64, v65);
    v73 = objc_opt_class();
    v78 = objc_msgSend_decodeObjectOfClass_forKey_(coderCopy, v74, v73, @"brandName", v75, v76, v77);
    brandName = v5->_brandName;
    v5->_brandName = v78;

    v80 = objc_opt_class();
    v85 = objc_msgSend_decodeObjectOfClass_forKey_(coderCopy, v81, v80, @"campaignText", v82, v83, v84);
    campaignText = v5->_campaignText;
    v5->_campaignText = v85;

    v87 = objc_opt_class();
    v92 = objc_msgSend_decodeObjectOfClass_forKey_(coderCopy, v88, v87, @"targetingExpressionId", v89, v90, v91);
    targetingExpressionId = v5->_targetingExpressionId;
    v5->_targetingExpressionId = v92;

    v94 = objc_opt_class();
    v99 = objc_msgSend_decodeObjectOfClass_forKey_(coderCopy, v95, v94, @"startDate", v96, v97, v98);
    startDate = v5->_startDate;
    v5->_startDate = v99;

    v101 = objc_opt_class();
    v106 = objc_msgSend_decodeObjectOfClass_forKey_(coderCopy, v102, v101, @"expirationDate", v103, v104, v105);
    expirationDate = v5->_expirationDate;
    v5->_expirationDate = v106;

    objc_msgSend_decodeDoubleForKey_(coderCopy, v108, @"impressionThreshold", v109, v110, v111, v112);
    v5->_impressionThreshold = v113;
    objc_msgSend_decodeDoubleForKey_(coderCopy, v114, @"impressionVisiblityThreshold", v115, v116, v113, v117);
    v5->_impressionVisibilityThreshold = v118;
    v5->_serverUnfilledReason = objc_msgSend_decodeIntForKey_(coderCopy, v119, @"serverUnfilledReason", v120, v121, v118, v122);
    v123 = objc_opt_class();
    v128 = objc_msgSend_decodeObjectOfClass_forKey_(coderCopy, v124, v123, @"error", v125, v126, v127);
    error = v5->_error;
    v5->_error = v128;

    v130 = objc_opt_class();
    v135 = objc_msgSend_decodeObjectOfClass_forKey_(coderCopy, v131, v130, @"installAttribution", v132, v133, v134);
    ...
    v152 = objc_msgSend_decodeObjectOfClasses_forKey_(coderCopy, v148, v147, @"representationsKey", v149, v150, v151);
    ...
    objc_msgSend_decodeDoubleForKey_(coderCopy, v161, @"serverResponseReceivedTimestamp", v162, v163, v164, v165);
    v5->_serverResponseReceivedTimestamp = v166;
    v167 = objc_opt_class();
    v172 = objc_msgSend_decodeObjectOfClass_forKey_(coderCopy, v168, v167, @"receivedReferenceTime", v169, v170, v171);
    receivedReferenceTime = v5->_receivedReferenceTime;
    v5->_receivedReferenceTime = v172;

    v5->_isPAAvailableForAd = objc_msgSend_decodeBoolForKey_(coderCopy, v174, @"personalizedAdsEnabledKey", v175, v176, v177, v178);
    v5->_isLocationAvailableForAd = objc_msgSend_decodeBoolForKey_(coderCopy, v179, @"locationEnabledKey", v180, v181, v182, v183);
    v184 = MEMORY[0x1E695DFD8];
    v185 = objc_opt_class();
    v186 = objc_opt_class();
    v192 = objc_msgSend_setWithObjects_(v184, v187, v185, v188, v189, v190, v191, v186, 0);
    v197 = objc_msgSend_decodeObjectOfClasses_forKey_(coderCopy, v193, v192, @"adServerEnvironment", v194, v195, v196);
    adServerEnvironment = v5->_adServerEnvironment;
    v5->_adServerEnvironment = v197;

    v5->_diagnosticCode = objc_msgSend_decodeIntForKey_(coderCopy, v199, @"diagnosticCode", v200, v201, v202, v203);
...
- (void)encodeWithCoder:(id)coder
{
  ...
  objc_msgSend_encodeObject_forKey_(coderCopy, v23, v22, @"contextIdentifier", v24, v25, v26);

  v33 = objc_msgSend_journeyIdentifier(self, v27, v28, v29, v30, v31, v32);
  objc_msgSend_encodeObject_forKey_(coderCopy, v34, v33, @"journeyIdentifier", v35, v36, v37);

  v44 = objc_msgSend_impressionId(self, v38, v39, v40, v41, v42, v43);
  objc_msgSend_encodeObject_forKey_(coderCopy, v45, v44, @"impressionId", v46, v47, v48);

  v55 = objc_msgSend_metadata(self, v49, v50, v51, v52, v53, v54);
  objc_msgSend_encodeObject_forKey_(coderCopy, v56, v55, @"metadata", v57, v58, v59);

  v66 = objc_msgSend_disclosureURL(self, v60, v61, v62, v63, v64, v65);
  objc_msgSend_encodeObject_forKey_(coderCopy, v67, v66, @"disclosureURL", v68, v69, v70);

  v77 = objc_msgSend_disclosureRendererPayload(self, v71, v72, v73, v74, v75, v76);
  objc_msgSend_encodeObject_forKey_(coderCopy, v78, v77, @"disclosureRendererPayload", v79, v80, v81);

  v88 = objc_msgSend_minimumTimeBetweenPresentation(self, v82, v83, v84, v85, v86, v87);
  objc_msgSend_encodeInt_forKey_(coderCopy, v89, v88, @"minimumTimeBetweenPresentation", v90, v91, v92);
  v99 = objc_msgSend_brandName(self, v93, v94, v95, v96, v97, v98);
  objc_msgSend_encodeObject_forKey_(coderCopy, v100, v99, @"brandName", v101, v102, v103);

  v110 = objc_msgSend_campaignText(self, v104, v105, v106, v107, v108, v109);
  objc_msgSend_encodeObject_forKey_(coderCopy, v111, v110, @"campaignText", v112, v113, v114);

  v121 = objc_msgSend_targetingExpressionId(self, v115, v116, v117, v118, v119, v120);
  objc_msgSend_encodeObject_forKey_(coderCopy, v122, v121, @"targetingExpressionId", v123, v124, v125);

  v132 = objc_msgSend_startDate(self, v126, v127, v128, v129, v130, v131);
  objc_msgSend_encodeObject_forKey_(coderCopy, v133, v132, @"startDate", v134, v135, v136);

  v143 = objc_msgSend_expirationDate(self, v137, v138, v139, v140, v141, v142);
  objc_msgSend_encodeObject_forKey_(coderCopy, v144, v143, @"expirationDate", v145, v146, v147);

  objc_msgSend_impressionThreshold(self, v148, v149, v150, v151, v152, v153);
  objc_msgSend_encodeDouble_forKey_(coderCopy, v154, @"impressionThreshold", v155, v156, v157, v158);
  objc_msgSend_impressionVisibilityThreshold(self, v159, v160, v161, v162, v163, v164);
  objc_msgSend_encodeDouble_forKey_(coderCopy, v165, @"impressionVisiblityThreshold", v166, v167, v168, v169);
  v176 = objc_msgSend_serverUnfilledReason(self, v170, v171, v172, v173, v174, v175);
  objc_msgSend_encodeInt_forKey_(coderCopy, v177, v176, @"serverUnfilledReason", v178, v179, v180);
  v187 = objc_msgSend_error(self, v181, v182, v183, v184, v185, v186);
  objc_msgSend_encodeObject_forKey_(coderCopy, v188, v187, @"error", v189, v190, v191);

  v198 = objc_msgSend_installAttribution(self, v192, v193, v194, v195, v196, v197);
  objc_msgSend_encodeObject_forKey_(coderCopy, v199, v198, @"installAttribution", v200, v201, v202);

  objc_msgSend_serverResponseReceivedTimestamp(self, v203, v204, v205, v206, v207, v208);
  objc_msgSend_encodeDouble_forKey_(coderCopy, v209, @"serverResponseReceivedTimestamp", v210, v211, v212, v213);
  v220 = objc_msgSend_receivedReferenceTime(self, v214, v215, v216, v217, v218, v219);
  objc_msgSend_encodeObject_forKey_(coderCopy, v221, v220, @"receivedReferenceTime", v222, v223, v224);

  isPAAvailableForAd = objc_msgSend_isPAAvailableForAd(self, v225, v226, v227, v228, v229, v230);
  objc_msgSend_encodeBool_forKey_(coderCopy, v232, isPAAvailableForAd, @"personalizedAdsEnabledKey", v233, v234, v235);
  isLocationAvailableForAd = objc_msgSend_isLocationAvailableForAd(self, v236, v237, v238, v239, v240, v241);
  objc_msgSend_encodeBool_forKey_(coderCopy, v243, isLocationAvailableForAd, @"locationEnabledKey", v244, v245, v246);
  ...
  objc_msgSend_encodeObject_forKey_(coderCopy, v263, v262, @"representationsKey", v264, v265, v266);

  v273 = objc_msgSend_adServerEnvironment(self, v267, v268, v269, v270, v271, v272);
  objc_msgSend_encodeObject_forKey_(coderCopy, v274, v273, @"adServerEnvironment", v275, v276, v277);

  v284 = objc_msgSend_diagnosticCode(self, v278, v279, v280, v281, v282, v283);
  objc_msgSend_encodeInt_forKey_(coderCopy, v285, v284, @"diagnosticCode", v286, v287, v288);
...
- (void)addRepresentation:(id)representation
{
  ...
  objc_msgSend_addObject_(representations, v6, representationCopy, v7, v8, v9, v10);
  v22 = objc_msgSend_identifier(self, v11, v12, v13, v14, v15, v16);
  objc_msgSend_setContentDataIdentifier_(representationCopy, v17, v22, v18, v19, v20, v21);
}
...
- (void)addRepresentations:(id)representations
{
  ...
  v19 = 0u;
  v20 = 0u;
  v7 = objc_msgSend_countByEnumeratingWithState_objects_count_(representationsCopy, v5, &v17, v21, 16, 0.0, v6);
  if (v7)
  {
    v13 = v7;
    v14 = *v18;
    do
    {
      ...
      while (v13 != v15);
      v13 = objc_msgSend_countByEnumeratingWithState_objects_count_(representationsCopy, v8, &v17, v21, 16, v11, v12);
    }
...
- (void)removeRepresentation:(id)representation
{
  representations = self->_representations;
  representationCopy = representation;
  objc_msgSend_removeObject_(representations, v4, representationCopy, v5, v6, v7, v8);
  objc_msgSend_setContentDataIdentifier_(representationCopy, v9, 0, v10, v11, v12, v13);
}
