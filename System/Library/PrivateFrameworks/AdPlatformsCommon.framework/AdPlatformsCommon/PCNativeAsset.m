...
- (PCNativeAsset)initWithCoder:(id)a3
{
  ...
  {
    v12 = objc_opt_class();
    v17 = objc_msgSend_decodeObjectOfClass_forKey_(v4, v13, v12, @"name", v14, v15, v16);
    name = v11->_name;
    v11->_name = v17;

    v11->_location = objc_msgSend_decodeInt32ForKey_(v4, v19, @"location", v20, v21, v22, v23);
    v24 = objc_alloc(MEMORY[0x1E695DFD8]);
    v25 = objc_opt_class();
    v26 = objc_opt_class();
    v32 = objc_msgSend_initWithObjects_(v24, v27, v25, v28, v29, v30, v31, v26, 0);
    v37 = objc_msgSend_decodeObjectOfClasses_forKey_(v4, v33, v32, @"assetInformation", v34, v35, v36);
    ...
    v44 = objc_opt_class();
    v49 = objc_msgSend_decodeObjectOfClass_forKey_(v4, v45, v44, @"treatment", v46, v47, v48);
...
- (void)encodeWithCoder:(id)a3
{
  ...
  objc_msgSend_encodeObject_forKey_(v4, v12, v11, @"name", v13, v14, v15);
  ...
  objc_msgSend_encodeObject_forKey_(v4, v34, v33, @"assetInformation", v35, v36, v37);
  ...
  objc_msgSend_encodeObject_forKey_(v4, v55, v59, @"treatment", v56, v57, v58);
}
