...
- (APContentDepiction)initWithCoder:(id)a3
{
  ...
  if (v5)
  {
    ...
    v5->_placement = objc_msgSend_decodeIntForKey_(v4, v13, @"placement", v14, v15, v16, v17);
    v5->_adjacency = objc_msgSend_decodeIntForKey_(v4, v18, @"adjacency", v19, v20, v21, v22);
    v23 = objc_opt_class();
    v28 = objc_msgSend_decodeObjectOfClass_forKey_(v4, v24, v23, @"language", v25, v26, v27);
    language = v5->_language;
    v5->_language = v28;

    v30 = objc_opt_class();
    v35 = objc_msgSend_decodeObjectOfClass_forKey_(v4, v31, v30, @"locale", v32, v33, v34);
    locale = v5->_locale;
    v5->_locale = v35;
    ...
    v50 = objc_msgSend_decodeObjectOfClasses_forKey_(v4, v46, v45, @"searchTerms", v47, v48, v49);
    searchTerms = v5->_searchTerms;
    v5->_searchTerms = v50;

    v56 = objc_msgSend_decodeObjectOfClasses_forKey_(v4, v52, v45, @"keywords", v53, v54, v55);
    keywords = v5->_keywords;
    v5->_keywords = v56;

    v62 = objc_msgSend_decodeObjectOfClasses_forKey_(v4, v58, v45, @"categories", v59, v60, v61);
...
- (void)encodeWithCoder:(id)a3
{
  ...
  objc_msgSend_encodeObject_forKey_(v4, v45, v44, @"language", v46, v47, v48);

  v55 = objc_msgSend_locale(self, v49, v50, v51, v52, v53, v54);
  objc_msgSend_encodeObject_forKey_(v4, v56, v55, @"locale", v57, v58, v59);

  v66 = objc_msgSend_searchTerms(self, v60, v61, v62, v63, v64, v65);
  objc_msgSend_encodeObject_forKey_(v4, v67, v66, @"searchTerms", v68, v69, v70);

  v77 = objc_msgSend_keywords(self, v71, v72, v73, v74, v75, v76);
  objc_msgSend_encodeObject_forKey_(v4, v78, v77, @"keywords", v79, v80, v81);

  v92 = objc_msgSend_categories(self, v82, v83, v84, v85, v86, v87);
  objc_msgSend_encodeObject_forKey_(v4, v88, v92, @"categories", v89, v90, v91);
}
