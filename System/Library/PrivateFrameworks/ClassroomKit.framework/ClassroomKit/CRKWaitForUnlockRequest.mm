...
- (CRKWaitForUnlockRequest)initWithCoder:(id)coder;
...
- (CRKWaitForUnlockRequest)initWithCoder:(id)coder
{
  coderCopy = coder;
  v8.receiver = self;
  v8.super_class = CRKWaitForUnlockRequest;
...
{
  v6.receiver = self;
  v6.super_class = CRKWaitForUnlockRequest;
  coderCopy = coder;
  [(CATTaskRequest *)&v6 encodeWithCoder:coderCopy];
  v5 = [MEMORY[0x277CCABB0] numberWithBool:{-[CRKWaitForUnlockRequest shouldBecomeExclusive](self, "shouldBecomeExclusive", v6.receiver, v6.super_class)}];
