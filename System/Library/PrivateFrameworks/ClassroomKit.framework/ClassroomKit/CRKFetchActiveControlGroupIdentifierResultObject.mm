...
- (CRKFetchActiveControlGroupIdentifierResultObject)initWithCoder:(id)coder;
...
- (CRKFetchActiveControlGroupIdentifierResultObject)initWithCoder:(id)coder
{
  coderCopy = coder;
  v10.receiver = self;
  v10.super_class = CRKFetchActiveControlGroupIdentifierResultObject;
...
{
  v6.receiver = self;
  v6.super_class = CRKFetchActiveControlGroupIdentifierResultObject;
  coderCopy = coder;
  [(CATTaskResultObject *)&v6 encodeWithCoder:coderCopy];
  v5 = [(CRKFetchActiveControlGroupIdentifierResultObject *)self groupIdentifier:v6.receiver];
