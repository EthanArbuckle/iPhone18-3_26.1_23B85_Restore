...
- (CRKFetchDeviceGestaltResultObject)initWithCoder:(id)coder;
...
- (CRKFetchDeviceGestaltResultObject)initWithCoder:(id)coder
{
  ...
  if (v5)
  {
    ...
    v7 = [coderCopy decodeObjectOfClasses:v6 forKey:@"deviceGestalt"];
...
- (void)encodeWithCoder:(id)coder
{
  ...
  [coderCopy encodeObject:v5 forKey:@"deviceGestalt"];
}
