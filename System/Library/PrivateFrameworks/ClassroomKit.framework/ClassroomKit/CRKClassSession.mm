...
- (CRKClassSession)initWithIdentifier:(id)a3
{
  ...
  v8 = [(CRKSession *)&v10 initWithEndpoint:v7];
...
- (void)lostBeacon
{
  ...
  [v5 handleFailureInMethod:a1 object:a2 file:@"CRKClassSession.m" lineNumber:56 description:{@"%@ must be called from the main thread", v4}];
}
...
- (void)logBeaconFound
{
  ...
  {
    v6 = [(CRKClassSession *)self identifier];
    v7 = [v6 stringValue];
    v8 = 134349570;
    v9 = self;
    v10 = 2114;
