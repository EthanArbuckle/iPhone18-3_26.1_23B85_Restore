...
- (CRKFetchBooksResultObject)initWithCoder:(id)coder;
...
- (CRKFetchBooksResultObject)initWithCoder:(id)coder
{
  coderCopy = coder;
  v12.receiver = self;
  v12.super_class = CRKFetchBooksResultObject;
...
{
  v6.receiver = self;
  v6.super_class = CRKFetchBooksResultObject;
  coderCopy = coder;
  [(CATTaskResultObject *)&v6 encodeWithCoder:coderCopy];
  v5 = [(CRKFetchBooksResultObject *)self books:v6.receiver];
