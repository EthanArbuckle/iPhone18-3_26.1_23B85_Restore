...
+ (id)crk_managedXPCGroupIdentifier
{
  ...
  v1 = [MEMORY[0x277CCAD78] crk_zerosUUID];
  v2 = [v0 initWithOrganizationUUID:v1 groupID:0];
...
+ (id)crk_adHocXPCGroupIdentifier
{
  v0 = objc_alloc(MEMORY[0x277D04C00]);
  v1 = [MEMORY[0x277CCAD78] crk_zerosUUID];
  v2 = [v0 initWithOrganizationUUID:v1 groupID:1];
...
+ (id)crk_asmXPCGroupIdentifier
{
  v0 = objc_alloc(MEMORY[0x277D04C00]);
  v1 = [MEMORY[0x277CCAD78] crk_zerosUUID];
  v2 = [v0 initWithOrganizationUUID:v1 groupID:2];
