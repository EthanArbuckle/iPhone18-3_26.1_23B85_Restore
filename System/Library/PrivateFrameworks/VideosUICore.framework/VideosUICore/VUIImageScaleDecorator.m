...
- (BOOL)isEqual:(id)a3
{
  ...
  if (v9 == v16 && ([(VUIImageScaleDecorator *)self cornerRadii], v11 == v17) && ([(VUIImageScaleDecorator *)self cornerRadii], v13 == v18))
  {
    [(VUIImageScaleDecorator *)self cornerRadii];
    v20 = v15 == v19;
  }
...
LABEL_13:
  if (![VUICoreUtilities radiiIsZero:self->_cornerRadii.topLeft, self->_cornerRadii.topRight, self->_cornerRadii.bottomLeft, self->_cornerRadii.bottomRight])
  {
...
LABEL_44:
          ...
          v93[1] = 3221225472;
          v93[2] = __63__VUIImageScaleDecorator_decorate_scaledWithSize_croppedToFit___block_invoke;
          v93[3] = &unk_279E21CB8;
          v93[4] = self;
          v95 = v60;
          v96 = v61;
...
LABEL_43:
      ...
      [VUICoreUtilities centerRect:0.0 inRect:0.0, v46, v45, v47, v48, v49, v50];
      goto LABEL_43;
    }
  }
  ...
  v87[1] = 3221225472;
  v87[2] = __63__VUIImageScaleDecorator_decorate_scaledWithSize_croppedToFit___block_invoke_2;
  v87[3] = &unk_279E21CE0;
  v89 = 0;
  v90 = 0;
  v87[4] = self;
  ...
  if (v78)
  {
    v70 = +[VUIImage imageWithCGImageRef:preserveAlpha:](VUIImage, "imageWithCGImageRef:preserveAlpha:", [v78 vuiCGImage], v77);
  }
...
- (BOOL)needsAlphaForImage:(id)a3
{
  ...
  if ([(VUIImageScaleDecorator *)self preservesAlpha])
  {
    ...
    {
      [(VUIImageScaleDecorator *)self cornerRadii];
      v5 = ![VUICoreUtilities radiiIsZero:?];
    }
  }
...
void __49__VUIImageScaleDecorator__imageFixedForRotation___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (v5 <= 4)
  {
    ...
    {
      case 2:
        v6 = xmmword_270EA2C90;
        v7 = xmmword_270EA2CA0;
        v4 = *(a1 + 64);
        goto LABEL_13;
      case 3:
        v6 = xmmword_270EA2CB0;
        v7 = xmmword_270EA2CA0;
        v4 = *(a1 + 64);
        v8 = *(a1 + 72);
        goto LABEL_17;
  ...
  v6 = xmmword_270EA2C80;
  if (v5 > 6)
  {
    v7 = xmmword_270EA2C90;
    if (v5 == 7)
    {
LABEL_13:
      v8 = 0.0;
