...
- (id)responseForServerData:(id)data
{
  account = [objc_msgSend(-[MFSASLAuthenticator account](self account];
  ...
  v6 = v5;
  v9 = 0;
  v7 = [MEMORY[0x277CBEB28] dataWithCapacity:{objc_msgSend(account, "length") + objc_msgSend(v5, "length") + 2}];
  [v7 appendBytes:&v9 length:1];
  [v7 appendData:account];
  [v7 appendBytes:&v9 length:1];
  [v7 appendData:v6];
  return v7;
}
