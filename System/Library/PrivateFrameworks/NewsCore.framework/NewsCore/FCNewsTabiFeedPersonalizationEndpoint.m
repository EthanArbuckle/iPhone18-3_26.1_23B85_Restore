...
- (FCNewsTabiFeedPersonalizationEndpoint)initWithDictionary:(id)a3
{
  ...
  if (v5)
  {
    ...
    else
    {
      ...
      v19[3] = &unk_1E7C36F98;
      v20 = v4;
      v16 = __60__FCNewsTabiFeedPersonalizationEndpoint_initWithDictionary___block_invoke_5(v19);
      v10 = v20;
    }
  }
  ...
  else
  {
    ...
    v21[3] = &unk_1E7C36F98;
    v22 = v4;
    v16 = __60__FCNewsTabiFeedPersonalizationEndpoint_initWithDictionary___block_invoke(v21);
    v7 = v22;
  }
...
uint64_t __60__FCNewsTabiFeedPersonalizationEndpoint_initWithDictionary___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(FCTabiConfigurationLog, OS_LOG_TYPE_ERROR))
  {
    ...
    v8 = 138543362;
    v9 = v7;
    _os_log_error_impl(&dword_1B63EF000, v6, OS_LOG_TYPE_ERROR, "Failed to initialize FCNewsTabiFeedPersonalizationEndpoint due to failure to decode packageAssetID from configuration %{public}@", &v8, 0xCu);
  }
...
uint64_t __60__FCNewsTabiFeedPersonalizationEndpoint_initWithDictionary___block_invoke_5(uint64_t a1)
{
  ...
  if (os_log_type_enabled(FCTabiConfigurationLog, OS_LOG_TYPE_ERROR))
  {
    ...
    v8 = 138543362;
    v9 = v7;
    _os_log_error_impl(&dword_1B63EF000, v6, OS_LOG_TYPE_ERROR, "Failed to initialize FCNewsTabiFeedPersonalizationEndpoint due to failure to decode configuration from configuration %{public}@", &v8, 0xCu);
  }
