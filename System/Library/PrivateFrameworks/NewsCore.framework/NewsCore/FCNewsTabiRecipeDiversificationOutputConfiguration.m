...
- (FCNewsTabiRecipeDiversificationOutputConfiguration)initWithDictionary:(id)a3;
- (id)description;
@end
...
- (id)description
{
  ...
  v4 = [(FCNewsTabiRecipeDiversificationOutputConfiguration *)self recipeScoresOutputName];
  [v3 appendFormat:@"\n\recipeScoresOutputName: %@;", v4];
...
- (FCNewsTabiRecipeDiversificationOutputConfiguration)initWithDictionary:(id)a3
{
  ...
  else
  {
    ...
    v13[3] = &unk_1E7C36F98;
    v14 = v4;
    v10 = __73__FCNewsTabiRecipeDiversificationOutputConfiguration_initWithDictionary___block_invoke(v13);
    v7 = v14;
  }
