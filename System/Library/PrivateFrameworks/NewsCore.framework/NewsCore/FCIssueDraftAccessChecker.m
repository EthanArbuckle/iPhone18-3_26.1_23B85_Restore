...
- (FCIssueDraftAccessChecker)initWithPrivateChannelMembershipController:(id)a3
{
  ...
  if (!v5 && os_log_type_enabled(MEMORY[0x1E69E9C10], OS_LOG_TYPE_ERROR))
  {
    ...
    *buf = 136315906;
    v13 = "[FCIssueDraftAccessChecker initWithPrivateChannelMembershipController:]";
    v14 = 2080;
  ...
  v11.receiver = self;
  v11.super_class = FCIssueDraftAccessChecker;
...
- (BOOL)canSynchronouslyCheckAccessToItem:(id)a3
{
  ...
  if (!v4 && os_log_type_enabled(MEMORY[0x1E69E9C10], OS_LOG_TYPE_ERROR))
  {
    ...
    *buf = 136315906;
    v10 = "[FCIssueDraftAccessChecker canSynchronouslyCheckAccessToItem:]";
    v11 = 2080;
    v12 = "FCIssueDraftAccessChecker.m";
    v13 = 1024;
    v14 = 42;
    v15 = 2114;
    v16 = v8;
...
- (BOOL)hasAccessToItem:(id)a3 blockedReason:(unint64_t *)a4 error:(id *)a5
{
  ...
  if (!v7 && os_log_type_enabled(MEMORY[0x1E69E9C10], OS_LOG_TYPE_ERROR))
  {
    ...
    *buf = 136315906;
    v14 = "[FCIssueDraftAccessChecker hasAccessToItem:blockedReason:error:]";
    v15 = 2080;
    v16 = "FCIssueDraftAccessChecker.m";
    v17 = 1024;
    v18 = 50;
    v19 = 2114;
    v20 = v12;
...
- (void)checkAccessToItem:(id)a3 withQualityOfService:(int64_t)a4 completion:(id)a5
{
  ...
  if (!v8 && os_log_type_enabled(MEMORY[0x1E69E9C10], OS_LOG_TYPE_ERROR))
  {
    ...
    *buf = 136315906;
    v20 = "[FCIssueDraftAccessChecker checkAccessToItem:withQualityOfService:completion:]";
    v21 = 2080;
    v22 = "FCIssueDraftAccessChecker.m";
    v23 = 1024;
    v24 = 72;
    v25 = 2114;
    v26 = v13;
