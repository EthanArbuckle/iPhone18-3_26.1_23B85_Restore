...
- (FCNewsTabiNotificationScoringOutputConfiguration)initWithDictionary:(id)a3
{
  ...
  if (v5)
  {
    v7 = v5;
    v12.receiver = self;
    v12.super_class = FCNewsTabiNotificationScoringOutputConfiguration;
    v8 = [(FCNewsTabiNotificationScoringOutputConfiguration *)&v12 init];
    v9 = v8;
    if (v8)
    {
      objc_storeStrong(&v8->_notificationScoresOutputName, v6);
    }
  ...
  else
  {
    ...
    v13[3] = &unk_1E7C36F98;
    v14 = v4;
    v10 = __71__FCNewsTabiNotificationScoringOutputConfiguration_initWithDictionary___block_invoke(v13);
    v7 = v14;
  }
...
uint64_t __71__FCNewsTabiNotificationScoringOutputConfiguration_initWithDictionary___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(FCTabiConfigurationLog, OS_LOG_TYPE_ERROR))
  {
    ...
    v8 = 138543362;
    v9 = v7;
    _os_log_error_impl(&dword_1B63EF000, v6, OS_LOG_TYPE_ERROR, "Failed to initialize FCNewsTabiNotificationScoringOutputConfiguration due to failure to decode defaultHeadlineScoringOutputName from configuration %{public}@", &v8, 0xCu);
  }
