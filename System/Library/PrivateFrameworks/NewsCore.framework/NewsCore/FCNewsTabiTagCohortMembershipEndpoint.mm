...
- (FCNewsTabiTagCohortMembershipEndpoint)initWithDictionary:(id)a3
{
  ...
  if (v5)
  {
    ...
    else
    {
      ...
      v19[3] = &unk_1E7C36F98;
      v20 = v4;
      v16 = __60__FCNewsTabiTagCohortMembershipEndpoint_initWithDictionary___block_invoke_5(v19);
      v10 = v20;
    }
  }
  ...
  else
  {
    ...
    v21[3] = &unk_1E7C36F98;
    v22 = v4;
    v16 = __60__FCNewsTabiTagCohortMembershipEndpoint_initWithDictionary___block_invoke(v21);
    v7 = v22;
  }
...
- (id)description
{
  ...
  v4 = [(FCNewsTabiTagCohortMembershipEndpoint *)self packageAssetID];
  [v3 appendFormat:@"\n\tpackageAssetID: %@;", v4];
  ...
  v7 = [(FCNewsTabiTagCohortMembershipEndpoint *)self eventAggregationOutputs];
