...
@implementation FCNewsTabiRecipeScoringEndpoint
...
- (FCNewsTabiRecipeScoringEndpoint)initWithDictionary:(id)dictionary
{
  ...
  if (v5)
  {
    ...
    if (v8)
    {
      v10 = v8;
      v15.receiver = self;
      v15.super_class = FCNewsTabiRecipeScoringEndpoint;
      v11 = [(FCNewsTabiRecipeScoringEndpoint *)&v15 init];
      p_isa = &v11->super.isa;
      if (v11)
      {
...
uint64_t __54__FCNewsTabiRecipeScoringEndpoint_initWithDictionary___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(FCTabiConfigurationLog, OS_LOG_TYPE_ERROR))
  {
    ...
    v8 = 138543362;
    v9 = v7;
    _os_log_error_impl(&dword_1B63EF000, v6, OS_LOG_TYPE_ERROR, "Failed to initialize FCNewsTabiRecipeScoringEndpoint due to failure to decode packageAssetID from configuration %{public}@", &v8, 0xCu);
  }
...
uint64_t __54__FCNewsTabiRecipeScoringEndpoint_initWithDictionary___block_invoke_76(uint64_t a1)
{
  v10 = *MEMORY[0x1E69E9840];
  v2 = FCTabiConfigurationLog;
  if (os_log_type_enabled(FCTabiConfigurationLog, OS_LOG_TYPE_ERROR))
  {
    ...
    v8 = 138543362;
    v9 = v7;
    _os_log_error_impl(&dword_1B63EF000, v6, OS_LOG_TYPE_ERROR, "Failed to initialize FCNewsTabiRecipeScoringConfiguration due to failure to decode configuration from configuration %{public}@", &v8, 0xCu);
  }
