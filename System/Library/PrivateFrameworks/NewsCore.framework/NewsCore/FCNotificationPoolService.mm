...
- (FCNotificationPoolService)initWithContext:(id)context contentVariantProvider:(id)provider;
- (void)fetchPoolWithCompletionHandler:(id)handler;
@end
...
- (void)fetchPoolWithCompletionHandler:(id)handler
{
  ...
  context = [(FCNotificationPoolService *)self context];
  contentVariantProvider = [(FCNotificationPoolService *)self contentVariantProvider];
  v8 = [(FCNotificationPoolOperation *)v5 initWithContext:context contentVariantProvider:contentVariantProvider];
