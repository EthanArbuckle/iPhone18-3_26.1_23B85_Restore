...
- (FCFetchedValueManager)initWithDescriptor:(id)a3
{
  ...
  if (v5)
  {
    ...
    v12 = v4;
    v28 = v12;
    v13 = [(FCFetchedValueObservable *)v10 initWithManager:v5 initialValue:v11 equalityTest:v27];
...
{
  v8 = a5;
  v9 = [(FCFetchedValueManager *)self _optionsForCachePolicy:a3];
  v10 = [(FCFetchedValueManager *)self operationThrottler];
...
- (void)addObserver:(id)a3
{
  ...
  v5 = [(FCFetchedValueManager *)self observable];
  [v5 addObserver:v4];
...
- (void)fetchedValueDescriptorValueIsDirty:(id)a3
{
  v3 = [(FCFetchedValueManager *)self operationThrottler];
  [v3 tickleWithQualityOfService:17 data:1 completion:0];
}

- (void)fetchedObjectManager:(id)a3 valueDidChange:(id)a4
{
  v4 = [(FCFetchedValueManager *)self operationThrottler:a3];
...
{
  v7 = a5;
  v8 = [(FCFetchedValueManager *)self operationThrottler];
  v9 = [v8 mergedData];
