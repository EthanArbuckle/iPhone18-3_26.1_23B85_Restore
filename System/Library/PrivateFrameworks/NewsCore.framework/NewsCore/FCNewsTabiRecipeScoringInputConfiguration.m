...
- (FCNewsTabiRecipeScoringInputConfiguration)initWithDictionary:(id)a3;
@end
...
- (FCNewsTabiRecipeScoringInputConfiguration)initWithDictionary:(id)a3
{
  ...
  else
  {
    ...
    v13[3] = &unk_1E7C36F98;
    v14 = v4;
    v10 = __64__FCNewsTabiRecipeScoringInputConfiguration_initWithDictionary___block_invoke(v13);
    v7 = v14;
  }
...
uint64_t __64__FCNewsTabiRecipeScoringInputConfiguration_initWithDictionary___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(FCTabiConfigurationLog, OS_LOG_TYPE_ERROR))
  {
    ...
    v8 = 138543362;
    v9 = v7;
    _os_log_error_impl(&dword_1B63EF000, v6, OS_LOG_TYPE_ERROR, "Failed to initialize FCNewsTabiRecipeScoringInputConfiguration due to failure to decode inputNames from configuration %{public}@", &v8, 0xCu);
  }
