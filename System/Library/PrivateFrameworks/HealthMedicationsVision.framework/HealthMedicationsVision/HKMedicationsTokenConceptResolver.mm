  ...
  if (v5)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        v22 = 0;
        v13 = [v11 genericMedicationsFromTokens:v12 error:&v22];
        v14 = v22;
        ...
        if (v9)
        {
          ...
          do
          {
            ...
            do
            {
              ...
              v13 = *(*(&v29 + 1) + 8 * v12);
              v14 = [(HKMedicationsTokenConceptResolver *)self assetInterface];
              v28 = 0;
              v15 = [v14 expandedGenericMedicationSearchResult:v13 error:&v28];
              v16 = v28;
  ...
  if (v39)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        v40 = v6;
        v44 = [v42 objectForKeyedSubscript:{*(*(&v67 + 1) + 8 * v6), context}];
        if (v44)
        {
          v65 = 0u;
          v66 = 0u;
  ...
  if (v26)
  {
    ...
    do
    {
      for (i = 0; i != v26; ++i)
      {
        ...
        v40 = 0u;
        v8 = [v7 ingredients];
        v32 = [v8 countByEnumeratingWithState:&v37 objects:v46 count:16];
        if (!v32)
        {
...
- (id)rankMedicationsUsingTokens:(id)a3 candidates:(id)a4
{
  ...
  v13 = [v12 initWithArray:{v11, v15, v16, v17, v18, v19}];
  ...
  if (v10)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        v14 = *(*(&v25 + 1) + 8 * v13);
        v15 = [(HKMedicationsTokenConceptResolver *)self tokenizer];
        v16 = [v14 ingredientName];
