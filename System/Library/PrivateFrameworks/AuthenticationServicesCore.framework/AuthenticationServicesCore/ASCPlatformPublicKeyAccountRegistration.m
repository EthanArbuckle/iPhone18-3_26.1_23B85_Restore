...
- (_TtC26AuthenticationServicesCore39ASCPlatformPublicKeyAccountRegistration)initWithEmailIdentifier:(id)a3 phoneIdentifier:(id)a4 name:(id)a5 credentialRegistration:(id)a6;
...
LABEL_8:
  ...
  *(&self->super.isa + OBJC_IVAR____TtC26AuthenticationServicesCore39ASCPlatformPublicKeyAccountRegistration_credentialRegistration) = a6;
