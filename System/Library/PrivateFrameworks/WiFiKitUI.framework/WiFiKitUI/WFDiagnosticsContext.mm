...
- (void)updateInfo:(id)info
{
  ...
  {
    v16 = off_279EC5280[intValue - 1];
  }

  v17 = [v14 localizedStringForKey:v16 value:&stru_288308678 table:@"WiFiKitLocalizableStrings"];
...
LABEL_14:
  v23 = [v20 localizedStringForKey:v22 value:&stru_288308678 table:@"WiFiKitLocalizableStrings"];
  motion = self->_motion;
  self->_motion = v23;
  ...
  if (v102)
  {
    ...
    v34 = [v30 localizedStringForKey:v32 value:&stru_288308678 table:@"WiFiKitLocalizableStrings"];
    ...
    v42 = [v38 localizedStringForKey:v40 value:&stru_288308678 table:@"WiFiKitLocalizableStrings"];
    cca = self->_cca;
    self->_cca = v42;
  ...
  if (v45)
  {
    ...
    else
    {
      ...
      v49 = [gateway localizedStringForKey:@"kWFLocDiagnosticsProbeNoConnection" value:&stru_288308678 table:@"WiFiKitLocalizableStrings"];
      v50 = self->_gateway;
      self->_gateway = v49;
    }
  }
  ...
  if (v53)
  {
    ...
    else
    {
      ...
      v58 = [internet localizedStringForKey:@"kWFLocDiagnosticsProbeNoConnection" value:&stru_288308678 table:@"WiFiKitLocalizableStrings"];
      v59 = self->_internet;
      self->_internet = v58;
    }
  ...
  if (v61)
  {
    ...
    v68 = [v65 localizedStringForKey:v67 value:&stru_288308678 table:@"WiFiKitLocalizableStrings"];
    awdl = self->_awdl;
    self->_awdl = v68;
  }
  ...
  if (v70)
  {
    ...
    {
      v75 = off_279EC52A0[intValue4];
    }

    v76 = [v73 localizedStringForKey:v75 value:&stru_288308678 table:@"WiFiKitLocalizableStrings"];
  ...
  v81 = [v80 localizedStringForKey:v79 value:&stru_288308678 table:@"WiFiKitLocalizableStrings"];
  scan = self->_scan;
  self->_scan = v81;
  ...
  if (v83)
  {
    ...
    if (v85 && v86)
    {
      ...
      v88 = [v97 localizedStringForKey:@"kWFLocDiagnosticsLastScan" value:&stru_288308678 table:@"WiFiKitLocalizableStrings"];
...
- (void)initWithNetwork:profile:detailsContext:.cold.1()
{
  ...
  if (WFCurrentLogLevel() && v0 && os_log_type_enabled(v0, v1))
  {
    ...
    _os_log_impl(&dword_273FB9000, v0, v1, "%s: nil network", &v3, 0xCu);
  }
