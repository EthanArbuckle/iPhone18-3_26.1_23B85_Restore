...
- (MTLLegacySVIndirectComputeCommand)initWithIndirectComputeCommand:(id)command commandIndex:(unint64_t)index indirectCommandBuffer:(id)buffer;
...
{
  v7.receiver = self;
  v7.super_class = MTLLegacySVIndirectComputeCommand;
...
- (void)concurrentDispatchThreads:(id *)threads threadsPerThreadgroup:(id *)threadgroup
{
  ...
  v5 = *threadgroup;
  v4.receiver = self;
  v4.super_class = MTLLegacySVIndirectComputeCommand;
...
{
  v2.receiver = self;
  v2.super_class = MTLLegacySVIndirectComputeCommand;
