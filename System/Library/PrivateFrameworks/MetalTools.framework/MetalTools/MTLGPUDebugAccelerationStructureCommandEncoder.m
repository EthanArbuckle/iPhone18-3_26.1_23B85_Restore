...
- (void)newBaseAccelerationStructureCommandEncoder
{
  ...
  {
    v4 = [v3 accelerationStructureCommandEncoderWithDescriptor:{-[MTLToolsObject unwrapMTLAccelerationStructurePassDescriptor:](self->super.super.super._parent, "unwrapMTLAccelerationStructurePassDescriptor:")}];
  }
...
- (void)blitTypeFromAccelerationStructureDescriptor:(id)a3 toAccelerationStructure:(id)a4
{
  v6 = MTLAccelerationStructureTypeFromDescriptor(a3);
...
- (id)createChildrenWrappersBufferWithASDescriptor:(id)a3
{
  ...
  if ([v5 isSubclassOfClass:objc_opt_class()])
  {
    if ([a3 instanceCount])
    {
      v6 = [(MTLGPUDebugAccelerationStructureCommandEncoder *)self createChildrenWrappersBufferWithIASDescriptor:a3];
      goto LABEL_6;
    }
  ...
  v6 = [(MTLGPUDebugAccelerationStructureCommandEncoder *)self createChildrenWrappersBufferWithIndirectIASDescriptor:a3];
LABEL_6:
  v8 = v6;
  if (v6)
  {
...
{
  [(MTLGPUDebugAccelerationStructureCommandEncoder *)self destroyBaseAccelerationStructureCommandEncoder];
  v11 = [(MTLGPUDebugAccelerationStructureCommandEncoder *)self createChildrenWrappersBufferWithASDescriptor:a4];
  v12 = [(MTLGPUDebugAccelerationStructureCommandEncoder *)self encodeUnwrapAccelerationStructureDescriptor:a4];
...
{
  [(MTLGPUDebugAccelerationStructureCommandEncoder *)self destroyBaseAccelerationStructureCommandEncoder];
  v13 = [(MTLGPUDebugAccelerationStructureCommandEncoder *)self createChildrenWrappersBufferWithASDescriptor:a4];
  v14 = [(MTLGPUDebugAccelerationStructureCommandEncoder *)self encodeUnwrapAccelerationStructureDescriptor:a4];
  [(MTLGPUDebugAccelerationStructureCommandEncoder *)self newBaseAccelerationStructureCommandEncoder];
  v15.receiver = self;
...
{
  [(MTLGPUDebugAccelerationStructureCommandEncoder *)self destroyBaseAccelerationStructureCommandEncoder];
  v15 = [(MTLGPUDebugAccelerationStructureCommandEncoder *)self createChildrenWrappersBufferWithASDescriptor:a4];
  v16 = [(MTLGPUDebugAccelerationStructureCommandEncoder *)self encodeUnwrapAccelerationStructureDescriptor:a4];
  [(MTLGPUDebugAccelerationStructureCommandEncoder *)self newBaseAccelerationStructureCommandEncoder];
  v17.receiver = self;
