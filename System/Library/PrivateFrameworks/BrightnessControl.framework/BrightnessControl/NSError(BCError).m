...
- (uint64_t)initWithBCError:()BCError
{
  ...
  v10[0] = v5;
  result = [a1 initWithDomain:v6 code:a3 userInfo:{objc_msgSend(MEMORY[0x277CBEAC0], "dictionaryWithObjects:forKeys:count:", v10, &v9, 1)}];
...
- (uint64_t)initWithIOKitError:()BCError
{
  ...
  result = [a1 initWithDomain:v5 code:17 userInfo:{objc_msgSend(MEMORY[0x277CBEAC0], "dictionaryWithObjects:forKeys:count:", v9, v8, 2)}];
