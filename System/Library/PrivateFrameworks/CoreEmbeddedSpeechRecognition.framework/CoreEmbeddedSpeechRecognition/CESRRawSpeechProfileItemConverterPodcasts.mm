  ...
  if (v8 && [v8 count])
  {
    if ([v8 count] == 1)
    {
      if ([v9 isEqualToString:@"podcastTitle"])
      {
        ...
        v38 = 0;
        v12 = [(KVItemBuilder *)builder setItemType:16 itemId:v10 error:&v38];
        v13 = v38;
        v14 = [v8 firstObject];
        v15 = [v14 orthography];
...
LABEL_7:
      ...
      v10 = [MEMORY[0x277CCACA8] stringWithFormat:@"Unexpected namespace: %@ for category: %@", v9, @"com.apple.media.podcasts"];
      v42 = v10;
    ...
    else
    {
      ...
      v10 = [MEMORY[0x277CCACA8] stringWithFormat:@"rawSpeechProfile contains a Podcasts item with an unexpected number of speech words (expected only 1): %@ namespace: %@", v8, v9];
      v44 = v10;
