...
LABEL_28:
        ...
        v40 = 0;
        v23 = [(KVItemBuilder *)builder setItemType:4 itemId:v13 error:&v40];
        v24 = v40;
        v25 = [v8 firstObject];
        v26 = [v25 orthography];
...
LABEL_30:
      ...
      v13 = [MEMORY[0x277CCACA8] stringWithFormat:@"Unexpected namespace: %@ for category: %@", v10, @"com.apple.homekit.name"];
      v44 = v13;
    ...
    else
    {
      ...
      v13 = [MEMORY[0x277CCACA8] stringWithFormat:@"rawSpeechProfile contains a HomeKit item with an unexpected number of speech words (expected only 1): %@ namespace: %@", v8, v9];
      v46 = v13;
