...
- (id)copyWithZone:(_NSZone *)a3
{
  if ([(OISFURegularExpression *)self zone]== a3)
  {
...
- (_NSRange)matchedRangeForCString:(const char *)a3 range:(_NSRange)a4 subexpressionRanges:(_NSRange *)a5 count:(unsigned int)a6
{
  ...
  v12 = [(OISFURegularExpression *)self numberOfSubexpressions];
  v13 = a6;
  if (v12 >= a6)
  {
    v14 = a6;
...
- (_NSRange)matchedRangeForString:(id)a3 range:(_NSRange)a4 subexpressionRanges:(_NSRange *)a5 count:(unsigned int)a6
{
  ...
  v12 = [(OISFURegularExpression *)self matchedRangeForCString:[(__CFData *)ASCIIData bytes] range:location subexpressionRanges:length count:a5, v6];
  v14 = v13;
