...
- (OISFUMemoryInputStream)initWithData:(id)data;
- (OISFUMemoryInputStream)initWithData:(id)data offset:(unint64_t)offset length:(unint64_t)length;
...
- (OISFUMemoryInputStream)initWithData:(id)data
{
  ...
  return [(OISFUMemoryInputStream *)self initWithData:data offset:0 length:v5];
}

- (OISFUMemoryInputStream)initWithData:(id)data offset:(unint64_t)offset length:(unint64_t)length
{
  v14.receiver = self;
  v14.super_class = OISFUMemoryInputStream;
...
{
  v3.receiver = self;
  v3.super_class = OISFUMemoryInputStream;
...
- (BOOL)seekWithinBufferToOffset:(int64_t)offset
{
  ...
  if (v4 >= offset)
  {
    [(OISFUMemoryInputStream *)self seekToOffset:offset];
  }
