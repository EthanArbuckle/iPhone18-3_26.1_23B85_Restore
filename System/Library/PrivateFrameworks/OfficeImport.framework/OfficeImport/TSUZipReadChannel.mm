...
- (BOOL)processData:(id)a3 CRC:(unsigned int *)a4 isDone:(BOOL)a5 handler:(id)a6
{
  ...
  v10 = a3;
  v11 = a6;
  if (a4 && self->_validateCRC && (applier[0] = MEMORY[0x277D85DD0], applier[1] = 3221225472, applier[2] = __52__TSUZipReadChannel_processData_CRC_isDone_handler___block_invoke, applier[3] = &__block_descriptor_40_e47_B40__0__NSObject_OS_dispatch_data__8Q16r_v24Q32l, applier[4] = a4, dispatch_data_apply(v10, applier), v7) && [(TSUZipEntry *)self->_entry CRC]!= *a4)
  {
    if (TSUDefaultCat_init_token != -1)
    {
...
- (void)handleFailureWithHandler:(id)a3 error:(id)a4
{
  ...
  else
  {
    ...
    v7 = a3;
    v8 = [v6 tsu_fileReadCorruptedFileErrorWithUserInfo:0];
    (*(a3 + 2))(v7, 1, 0);
  }
}
