...
- (OISFUBufferedInputStream)initWithStream:(id)stream bufferSize:(unint64_t)size;
- (OISFUBufferedInputStream)initWithStream:(id)stream dataLength:(int64_t)length;
...
- (OISFUBufferedInputStream)initWithStream:(id)stream dataLength:(int64_t)length
{
  ...
  return [(OISFUBufferedInputStream *)self initWithStream:stream bufferSize:length];
}
...
{
  __src = 0;
  v5 = [(OISFUBufferedInputStream *)self readToOwnBuffer:&__src size:size];
