...
- (id)initForReadingFromURL:(id)l options:(unint64_t)options error:(id *)error
{
  ...
  v11 = [(TSUZipArchive *)&v15 initWithOptions:options];
  if (v11)
  {
...
- (TSUZipFileArchive)initWithWriter:(id)writer forReadingFromURL:(id)l options:(unint64_t)options error:(id *)error
{
  ...
  if (v12)
  {
    ...
    else
    {
      ...
      path = [lCopy path];
      +[OITSUAssertionHandler handleFailureInFunction:file:lineNumber:isFatal:description:](OITSUAssertionHandler, "handleFailureInFunction:file:lineNumber:isFatal:description:", v15, v16, 228, 0, "Length of archive at %@ doesn't match archive length of writer. %llu != %llu", path, v13->_archiveLength, [writerCopy archiveLength]);
