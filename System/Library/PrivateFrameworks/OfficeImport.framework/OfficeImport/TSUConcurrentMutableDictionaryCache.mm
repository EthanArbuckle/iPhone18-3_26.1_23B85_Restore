...
- (TSUConcurrentMutableDictionaryCache)initWithName:(id)name
{
  ...
  if (v5)
  {
    ...
    v10 = [(OITSUReadWriteQueue *)v8 initWithIdentifier:nameCopy];
    ...
    [defaultCenter addObserver:v5 selector:sel_p_didReceiveMemoryWarning_ name:v15 object:mEMORY[0x277D75128]];

    v17 = *MEMORY[0x277D76660];
    mEMORY[0x277D75128]2 = [MEMORY[0x277D75128] sharedApplication];
    [defaultCenter addObserver:v5 selector:sel_p_didEnterBackground_ name:v17 object:mEMORY[0x277D75128]2];
  }
