...
- (OADLinearShade)initWithDefaults
{
  ...
  if (initWithDefaults)
  {
    [(OADLinearShade *)initWithDefaults setAngle:0.0];
...
- (void)fixPropertiesForChangingParentPreservingEffectiveValues:(id)values
{
  ...
  if ((LOBYTE(self->mAngle) & 1) != 0 || ([(OADProperties *)self parent], v5 = objc_claimAutoreleasedReturnValue(), v5, v5 != valuesCopy))
  {
  ...
  if ((BYTE2(self->mAngle) & 1) != 0 || ([(OADProperties *)self parent], v9 = objc_claimAutoreleasedReturnValue(), v9, v9 != valuesCopy))
  {
    scaled = [(OADLinearShade *)self scaled];
    if (scaled == [valuesCopy scaled])
    {
      BYTE2(self->mAngle) = 0;
    }
