  ...
  if (type <= 175)
  {
    switch(type)
    {
      ...
      case 12:
        ...
        v13 = self;
        v14 = 5;
        return [(CMCanonicalShapeBuilder *)v13 copyStarWithTransform:&v54 aspectRatio:v14 andBranchNumber:v7, v54, v55, v56];
      case 13:
      case 78:
        v21 = *&a3->c;
        v54 = *&a3->a;
...
- (CGPath)copyTrapezoidWithTransform:(CGAffineTransform *)a3 andAspectRatio:(float)a4
{
  ...
  v21 = v20;
  Mutable = CGPathCreateMutable();
  v23 = [(CMShapeBuilder *)self isOffice12];
  v24 = v13 + v15;
  if (v23)
  {
    v25 = v17 + v21;
    ...
    v26 = v15 + v19;
    CGPathAddLineToPoint(Mutable, a3, v26 - v13, v25);
  }

  else
  {
    CGPathMoveToPoint(Mutable, a3, v24, v17);
    v26 = v15 + v19;
    CGPathAddLineToPoint(Mutable, a3, v26 - v13, v17);
    v17 = v17 + v21;
  }

  CGPathAddLineToPoint(Mutable, a3, v26, v17);
  CGPathAddLineToPoint(Mutable, a3, v15, v17);
  CGPathCloseSubpath(Mutable);
  return Mutable;
}
...
- (CGPath)copyTriangleWithTransform:(CGAffineTransform *)a3 andAspectRatio:(float)a4
{
  ...
  Mutable = CGPathCreateMutable();
  CGPathMoveToPoint(Mutable, a3, v15, v17);
  CGPathAddLineToPoint(Mutable, a3, v15 + v19, v17);
  CGPathAddLineToPoint(Mutable, a3, v13 + v15, v17 + v21);
  CGPathCloseSubpath(Mutable);
  return Mutable;
}
...
- (CGPath)copyHexagonWithTransform:(CGAffineTransform *)a3 andAspectRatio:(float)a4
{
  ...
  Mutable = CGPathCreateMutable();
  v23 = v13 + v15;
  CGPathMoveToPoint(Mutable, a3, v13 + v15, v17);
  v24 = v15 + v19;
  v25 = v24 - v13;
  CGPathAddLineToPoint(Mutable, a3, v25, v17);
  v26 = v17 + v21;
  ...
  CGPathAddLineToPoint(Mutable, a3, v15, v26 * 0.5);
  CGPathCloseSubpath(Mutable);
  return Mutable;
}
...
- (CGPath)copyWedgeRectWithTransform:(CGAffineTransform *)a3 andAspectRatio:(float)a4
{
  ...
  v64 = v14;
  Mutable = CGPathCreateMutable();
  v16 = [(CMShapeBuilder *)self isOffice12];
  v17 = v7;
  v18 = 5.0;
  if (v16)
  {
  ...
  if (adjustValues)
  {
    ...
    {
      v25 = [v24 intValue];
      v26 = [(CMShapeBuilder *)self isOffice12];
      v27 = -0.0;
      if (v26)
      {
        v27 = v7;
    ...
    {
      v31 = [v30 intValue];
      v32 = [(CMShapeBuilder *)self isOffice12];
      v33 = -0.0;
      if (v32)
      {
        v33 = v7;
...
- (CGPath)copyQuadArrowWithTransform:(CGAffineTransform *)a3 andAspectRatio:(float)a4
{
  ...
  Mutable = CGPathCreateMutable();
  v35 = (v29 + v33) * 0.5;
  CGPathMoveToPoint(Mutable, a3, v27, v35);
  CGPathAddLineToPoint(Mutable, a3, v14 + v27, v35 - v13);
  CGPathAddLineToPoint(Mutable, a3, v14 + v27, v35 - v39);
  v36 = v27 + v31;
  v37 = (v27 + v31) * 0.5;
  CGPathAddLineToPoint(Mutable, a3, v37 - v39, v35 - v39);
  CGPathAddLineToPoint(Mutable, a3, v37 - v39, v14 + v29);
  CGPathAddLineToPoint(Mutable, a3, v37 - v13, v14 + v29);
  CGPathAddLineToPoint(Mutable, a3, v37, v29);
  CGPathAddLineToPoint(Mutable, a3, v13 + v37, v14 + v29);
  CGPathAddLineToPoint(Mutable, a3, v39 + v37, v14 + v29);
  CGPathAddLineToPoint(Mutable, a3, v39 + v37, v35 - v39);
  CGPathAddLineToPoint(Mutable, a3, v36 - v14, v35 - v39);
  CGPathAddLineToPoint(Mutable, a3, v36 - v14, v35 - v13);
  CGPathAddLineToPoint(Mutable, a3, v36, v35);
  CGPathAddLineToPoint(Mutable, a3, v36 - v14, v13 + v35);
  CGPathAddLineToPoint(Mutable, a3, v36 - v14, v39 + v35);
  CGPathAddLineToPoint(Mutable, a3, v39 + v37, v39 + v35);
  CGPathAddLineToPoint(Mutable, a3, v39 + v37, v29 + v33 - v14);
  CGPathAddLineToPoint(Mutable, a3, v13 + v37, v29 + v33 - v14);
  CGPathAddLineToPoint(Mutable, a3, v37, v29 + v33);
  CGPathAddLineToPoint(Mutable, a3, v37 - v13, v29 + v33 - v14);
  CGPathAddLineToPoint(Mutable, a3, v37 - v39, v29 + v33 - v14);
  CGPathAddLineToPoint(Mutable, a3, v37 - v39, v39 + v35);
  CGPathAddLineToPoint(Mutable, a3, v14 + v27, v39 + v35);
  CGPathAddLineToPoint(Mutable, a3, v14 + v27, v13 + v35);
  CGPathCloseSubpath(Mutable);
  return Mutable;
}
...
- (CGPath)copyLeftRightUpArrowWithTransform:(CGAffineTransform *)a3 andAspectRatio:(float)a4
{
  ...
  v43 = v29 + v32;
  v34 = (v29 + v32) * 0.5;
  CGPathMoveToPoint(Mutable, a3, v27, v34);
  v44 = v14 + v27;
  v35 = v13;
  v36 = v34 - v13;
  CGPathAddLineToPoint(Mutable, a3, v14 + v27, v36);
  v37 = v15;
  v38 = v34 - v15;
  CGPathAddLineToPoint(Mutable, a3, v14 + v27, v38);
  v39 = v27 + v42;
  v40 = v27 + v42 - v14;
  CGPathAddLineToPoint(Mutable, a3, v40, v38);
  CGPathAddLineToPoint(Mutable, a3, v40, v36);
  CGPathAddLineToPoint(Mutable, a3, v39, v34);
  CGPathAddLineToPoint(Mutable, a3, v40, v35 + v34);
  CGPathAddLineToPoint(Mutable, a3, v40, v37 + v34);
  CGPathAddLineToPoint(Mutable, a3, v37 + v39 * 0.5, v37 + v34);
  CGPathAddLineToPoint(Mutable, a3, v37 + v39 * 0.5, v43 - v14);
  CGPathAddLineToPoint(Mutable, a3, v35 + v39 * 0.5, v43 - v14);
  CGPathAddLineToPoint(Mutable, a3, v39 * 0.5, v43);
  CGPathAddLineToPoint(Mutable, a3, v39 * 0.5 - v35, v43 - v14);
  CGPathAddLineToPoint(Mutable, a3, v39 * 0.5 - v37, v43 - v14);
  CGPathAddLineToPoint(Mutable, a3, v39 * 0.5 - v37, v37 + v34);
  CGPathAddLineToPoint(Mutable, a3, v44, v37 + v34);
  CGPathAddLineToPoint(Mutable, a3, v44, v35 + v34);
  CGPathCloseSubpath(Mutable);
  return Mutable;
}
...
- (CGPath)copyHomePlateWithTransform:(CGAffineTransform *)a3 andAspectRatio:(float)a4
{
  ...
  v23 = v22;
  Mutable = CGPathCreateMutable();
  CGPathMoveToPoint(Mutable, a3, v17, v19);
  v25 = v15 + v17;
  CGPathAddLineToPoint(Mutable, a3, v25, v19);
  v26 = v19 + v23;
  CGPathAddLineToPoint(Mutable, a3, v17 + v21, v26 * 0.5);
  CGPathAddLineToPoint(Mutable, a3, v25, v26);
  CGPathAddLineToPoint(Mutable, a3, v17, v26);
  CGPathCloseSubpath(Mutable);
  return Mutable;
}
...
- (CGPath)copyChevronWithTransform:(CGAffineTransform *)a3 andAspectRatio:(float)a4
{
  ...
  if (adjustValues)
  {
    ...
    if (v10)
    {
      [v10 floatValue];
      v12 = v11;
      v13 = [(CMShapeBuilder *)self isOffice12];
      v14 = v12 * 10.0 / (v8 + v8);
      if (v13)
      {
        v15 = v14 * 0.125;
  ...
  if ((v16 & 1) == 0)
  {
    CGPathAddLineToPoint(Mutable, a3, v19 + v21, v30 * 0.5);
  }
