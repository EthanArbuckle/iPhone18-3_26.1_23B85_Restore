...
- (OITSUDescription)initWithObject:(id)a3 class:(Class)a4 header:(id)a5
{
  ++TSUDescriptionDepth;
  v11.receiver = self;
  v11.super_class = OITSUDescription;
...
- (OITSUDescription)initWithCFType:(void *)a3 header:(id)a4
{
  ++TSUDescriptionDepth;
  v9.receiver = self;
  v9.super_class = OITSUDescription;
...
{
  v3.receiver = self;
  v3.super_class = OITSUDescription;
...
- (void)addSuperDescription
{
  ...
  v5 = [(OITSUDescription *)&v6 description];
  [(OITSUDescription *)self addFieldValue:v5, v6.receiver];
}
...
LABEL_5:
  ...
  v4 = [MEMORY[0x277CCAB68] stringWithFormat:@"%@ {", -[OITSUDescription p_header](self, "p_header")];
