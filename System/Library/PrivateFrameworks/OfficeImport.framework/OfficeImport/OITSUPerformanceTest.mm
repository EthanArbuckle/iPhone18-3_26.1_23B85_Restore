...
- (OITSUPerformanceTest)initWithName:(id)name selector:(SEL)selector target:(id)target goalTime:(double)time;
- (TSUOpstat_s)timing;
- (id)csvString;
- (void)dealloc;
- (void)report;
...
{
  v13.receiver = self;
  v13.super_class = OITSUPerformanceTest;
...
{
  v3.receiver = self;
  v3.super_class = OITSUPerformanceTest;
...
- (void)run
{
  ...
  if (!v5)
  {
    v6 = [MEMORY[0x277CCACA8] stringWithUTF8String:"-[OITSUPerformanceTest run]"];
    v7 = [MEMORY[0x277CCACA8] stringWithUTF8String:"/Library/Caches/com.apple.xbs/Sources/OfficeImport/OfficeParser/shared/utility/TSUPerformanceTest.m"];
    if (*p_mSelector)
    {
      v8 = *p_mSelector;
    }
    ...
    [OITSUAssertionHandler handleFailureInFunction:v6 file:v7 lineNumber:61 isFatal:0 description:"Can't get signature for test selector '%@'!", NSStringFromSelector(v8)];
  ...
  if (self->mTiming.running)
  {
    ...
    +[OITSUAssertionHandler handleFailureInFunction:file:lineNumber:isFatal:description:](OITSUAssertionHandler, "handleFailureInFunction:file:lineNumber:isFatal:description:", v14, [MEMORY[0x277CCACA8] stringWithUTF8String:"/Library/Caches/com.apple.xbs/Sources/OfficeImport/OfficeParser/shared/utility/TSUOpstat.h"], 48, 0, "Opstat is already running!");
    +[OITSUAssertionHandler logBacktraceThrottled];
  }
  ...
  if (!self->mTiming.running)
  {
    ...
    +[OITSUAssertionHandler handleFailureInFunction:file:lineNumber:isFatal:description:](OITSUAssertionHandler, "handleFailureInFunction:file:lineNumber:isFatal:description:", v18, [MEMORY[0x277CCACA8] stringWithUTF8String:"/Library/Caches/com.apple.xbs/Sources/OfficeImport/OfficeParser/shared/utility/TSUOpstat.h"], 69, 0, "Opstat is already stopped!");
    +[OITSUAssertionHandler logBacktraceThrottled];
  }
...
- (id)csvString
{
  ...
  listSeparator = [v3 listSeparator];
