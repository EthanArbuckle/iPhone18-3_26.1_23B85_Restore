...
- (id)localizedStringForKey:()TSULocaleAdditions value:table:locale:
{
  ...
  [objc_msgSend(v8 preferredLocalizationsFromArray:v9 forPreferences:{objc_msgSend(MEMORY[0x277CBEA60], "arrayWithObjects:count:", v13, 1)), "objectAtIndexedSubscript:", 0}];
  v10 = CFBundleCreate(0, [a1 bundleURL]);
