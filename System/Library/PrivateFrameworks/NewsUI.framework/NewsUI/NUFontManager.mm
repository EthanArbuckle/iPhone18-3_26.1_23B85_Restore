...
{
  v4 = a3;
  v5 = [(NUFontManager *)self registrationQueue];
...
- (void)increaseReferenceCountForFontWithURL:(id)a3
{
  ...
  v6 = [(NUFontManager *)self referenceCounts];
  [v6 addObject:v4];
...
- (void)decreaseReferenceCountForFontWithURL:(id)a3
{
  ...
  {
    v8 = 0;
    [(NUFontManager *)self unregisterFontAtURL:v4 error:&v8];
  }
...
{
  v4 = a3;
  v5 = [(NUFontManager *)self referenceCounts];
