...
- (id)buildSection
{
  ...
  v5 = [(SPUISSectionBuilder *)v2 section];
  v6 = [v5 results];
  v7 = [v6 copy];
  [v4 setResults:v7];
  ...
  v8 = objc_opt_new();
  v9 = objc_opt_new();
  v10 = [(SPUISSectionBuilder *)v2 isTopHitSection];
  v57 = objc_opt_new();
  v69 = 0u;
  v70 = 0u;
  v71 = 0u;
    ...
    do
    {
      ...
      do
      {
        ...
        else
        {
          ...
          v38 = [(SPUISSectionBuilder *)v2 queryContext];
...
LABEL_30:
  ...
  [v4 setResults:v40];
  v48 = [(SPUISSectionBuilder *)v2 buildButtonItem];
  [v4 setButton:v48];
