...
@implementation SPUISNumberFormatManager
...
{
  v9.receiver = self;
  v9.super_class = SPUISNumberFormatManager;
  v2 = [(SPUISNumberFormatManager *)&v9 init];
  if (v2)
  {
    v3 = objc_opt_new();
    [(SPUISNumberFormatManager *)v2 setNumberFormatter:v3];
