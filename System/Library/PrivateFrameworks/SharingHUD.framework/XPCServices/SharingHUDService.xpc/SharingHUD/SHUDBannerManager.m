...
- (void)postBannerWithModel:(id)a3
{
  ...
  v5 = [(SHUDBannerManager *)self bannerPresentable];
  v6 = [v5 model];
...
LABEL_5:
    ...
    {
      v8 = +[SFHUDBannerModel descriptionForType:](SFHUDBannerModel, "descriptionForType:", [v4 type]);
      *buf = 138412290;
      v57 = v8;
      _os_log_impl(&_mh_execute_header, v7, OS_LOG_TYPE_DEFAULT, "Showing banner of type %@", buf, 0xCu);
    }

    v9 = [[SHUDBannerPresentable alloc] initWithModel:v4];
    ...
    if (v10)
    {
      if (v10 == 1)
      {
        ...
        [v11 setViewDidAppearHandler:v51];
    ...
    else if (([v4 needsUpdate] & 1) == 0)
    {
      ...
      [v12 setViewDidAppearHandler:v53];

      objc_destroyWeak(&v54);
    }

    v15 = [(SHUDBannerPresentable *)v9 bannerViewController];
    [v15 setViewDidDisappearHandler:&stru_100014448];
    ...
    v18 = v16;
    v46 = v18;
    [(SHUDBannerPresentable *)v9 setBannerDidDisappearHandler:v45];
    ...
    [v29 setPreferredContentSize:{v31, v28}];

    [(SHUDBannerManager *)self setBannerPresentable:v9];
    v32 = [(SHUDBannerManager *)self bannerSource];
    v33 = [(SHUDBannerManager *)self bannerUserInfo];
    v44 = 0;
    [v32 postPresentable:v9 options:1 userInfo:v33 error:&v44];
    v34 = v44;
  ...
  v37 = [(SHUDBannerManager *)self bannerPresentable];
  v38 = [v37 model];
  v39 = [v38 needsUpdate];
  ...
  v41 = [(SHUDBannerManager *)self bannerPresentable];
  v9 = [v41 bannerViewController];

  [(SHUDBannerPresentable *)v9 setNeedsUpdate:0];
  v42 = [(SHUDBannerManager *)self bannerPresentable];
  v43 = [v42 bannerViewController];
  [v43 updateUI];
...
- (void)dismissBanner
{
  v3 = [(SHUDBannerManager *)self bannerPresentable];
  v4 = [v3 model];
  v5 = [v4 type];
  ...
  v8 = [(SHUDBannerManager *)self bannerSource];
  v9 = +[SHUDBannerPresentable requestIdentifier];
  v13 = 0;
  v10 = [v8 revokePresentableWithRequestIdentifier:v9 reason:@"SHUDBannerDismissedReason" animated:1 userInfo:&__NSDictionary0__struct error:&v13];
  v11 = v13;
...
- (void)setUpDismissalTimer
{
  ...
  v4 = [(SHUDBannerManager *)self dismissalTimer];

  if (v4)
  {
    v5 = [(SHUDBannerManager *)self dismissalTimer];
...
LABEL_7:
  ...
  else
  {
    ...
    v11 = [(SHUDBannerManager *)self dismissalTimer];
    ...
    if (v11)
    {
      ...
      v13 = [(SHUDBannerManager *)self dismissalTimer];
...
- (void)cancelDismissalTimer
{
  v3 = [(SHUDBannerManager *)self dismissalTimer];
