...
- (Offset<siri::speech::schema_fb::PostItnHammerRequest>)addObjectToBuffer:(void *)a3
{
  ...
  v5 = [(FTPostItnHammerRequest *)self speech_id];
  v6 = v5;
  if (!v5)
  {
    v5 = &stru_284834138;
  ...
  v15 = [(FTPostItnHammerRequest *)self language];
  v16 = v15;
  if (!v15)
  {
    v15 = &stru_284834138;
  ...
  v20 = [(FTPostItnHammerRequest *)self post_itn_string];
  v21 = v20;
  if (!v20)
  {
    v20 = &stru_284834138;
  ...
  v25 = [(FTPostItnHammerRequest *)self tokens];
  std::vector<apple::aiml::flatbuffers2::Offset<siri::speech::schema_fb::RecognitionToken>>::reserve(&v43, [v25 count]);

  v41 = 0u;
  v42 = 0u;
  v39 = 0u;
  v40 = 0u;
  v26 = [(FTPostItnHammerRequest *)self tokens];
  ...
  if (v27)
  {
    ...
    do
    {
      for (i = 0; i != v27; ++i)
      {
        ...
        v38 = [*(*(&v39 + 1) + 8 * i) addObjectToBuffer:a3];
  ...
  v31 = apple::aiml::flatbuffers2::FlatBufferBuilder::CreateVector<apple::aiml::flatbuffers2::String>(a3, begin, v43.__end_ - v43.__begin_);
  *(a3 + 70) = 1;
  v32 = *(a3 + 8);
  v33 = *(a3 + 12);
  v34 = *(a3 + 10);
  ...
  apple::aiml::flatbuffers2::FlatBufferBuilder::AddOffset<apple::aiml::flatbuffers2::String>(a3, 12, v31);
