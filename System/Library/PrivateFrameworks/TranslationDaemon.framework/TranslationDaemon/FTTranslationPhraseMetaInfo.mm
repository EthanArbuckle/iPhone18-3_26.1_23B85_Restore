...
- (FTTranslationPhraseMetaInfo)initWithFlatbuffData:(id)data root:(const TranslationPhraseMetaInfo *)root verify:(BOOL)verify
{
  ...
  if (!siri::speech::schema_fb::TranslationPhraseMetaInfo::Verify(v18, v21))
  {
LABEL_14:
    v19 = 0;
  }
...
- (Offset<siri::speech::schema_fb::TranslationPhraseMetaInfo>)addObjectToBuffer:(void *)buffer
{
  ...
  std::vector<apple::aiml::flatbuffers2::Offset<siri::speech::schema_fb::RecognitionToken>>::reserve(&v37, [selection_spans count]);
  ...
  v32 = uTF8String;
  v11 = [selection_spans2 countByEnumeratingWithState:&v33 objects:v38 count:16];
  if (v11)
  {
    v12 = *v34;
    do
