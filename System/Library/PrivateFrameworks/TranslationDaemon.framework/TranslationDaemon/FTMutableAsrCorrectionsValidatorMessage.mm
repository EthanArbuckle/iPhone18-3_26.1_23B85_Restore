...
- (void)setSession_messageAsFTCorrectionsValidatorRequest:(id)request;
- (void)setSession_messageAsFTCorrectionsValidatorResponse:(id)response;
...
{
  v6.receiver = self;
  v6.super_class = FTMutableAsrCorrectionsValidatorMessage;
...
- (void)setSession_message:(id)session_message
{
  ...
  -[FTMutableAsrCorrectionsValidatorMessage setSession_message_type:](self, "setSession_message_type:", [objc_opt_class() session_message_typeForObject:session_messageCopy]);
