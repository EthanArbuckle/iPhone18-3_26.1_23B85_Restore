...
- (FLTBFBufferAccessor)content
{
  v3 = [(FTBatchTranslationStreamingResponse *)self content_type];
  switch(v3)
  {
    case 3:
      v4 = [(FTBatchTranslationStreamingResponse *)self contentAsFTTranslationSupportedLanguagesResponse];
      break;
    case 2:
      v4 = [(FTBatchTranslationStreamingResponse *)self contentAsFTFinalBlazarResponse];
      break;
    case 1:
      v4 = [(FTBatchTranslationStreamingResponse *)self contentAsFTBatchTranslationResponse];
      break;
    default:
      v4 = 0;
      break;
...
- (Offset<siri::speech::qss_fb::BatchTranslationStreamingResponse>)addObjectToBuffer:(void *)a3
{
  v5 = [(FTBatchTranslationStreamingResponse *)self content_type];
  if ([(FTBatchTranslationStreamingResponse *)self content_type]== 1)
  {
