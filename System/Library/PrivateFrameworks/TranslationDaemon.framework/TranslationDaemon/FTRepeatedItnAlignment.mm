...
- (FTRepeatedItnAlignment)initWithFlatbuffData:(id)data root:(const RepeatedItnAlignment *)root verify:(BOOL)verify;
- (NSArray)itn_alignment;
- (Offset<siri::speech::schema_fb::RepeatedItnAlignment>)addObjectToBuffer:(void *)buffer;
- (id)flatbuffData;
- (id)itn_alignment_objectAtIndex:(unint64_t)index;
- (unint64_t)itn_alignment_count;
- (void)itn_alignment_enumerateObjectsUsingBlock:(id)block;
@end
...
- (Offset<siri::speech::schema_fb::RepeatedItnAlignment>)addObjectToBuffer:(void *)buffer
{
  ...
  itn_alignment = [(FTRepeatedItnAlignment *)self itn_alignment];
  std::vector<apple::aiml::flatbuffers2::Offset<siri::speech::schema_fb::RecognitionToken>>::reserve(&v23, [itn_alignment count]);

  v21 = 0u;
  v22 = 0u;
  v19 = 0u;
  v20 = 0u;
  itn_alignment2 = [(FTRepeatedItnAlignment *)self itn_alignment];
