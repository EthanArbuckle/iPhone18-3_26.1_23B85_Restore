...
- (Offset<siri::speech::schema_fb::StartMultilingualSpeechRequest>)addObjectToBuffer:(void *)buffer
{
  ...
  std::vector<apple::aiml::flatbuffers2::Offset<siri::speech::schema_fb::RecognitionToken>>::reserve(&v35, [language_parameters_by_id count]);
  ...
  v30 = v6;
  v9 = [language_parameters_by_id2 countByEnumeratingWithState:&v31 objects:v36 count:16];
  if (v9)
  {
    v10 = *v32;
    do
