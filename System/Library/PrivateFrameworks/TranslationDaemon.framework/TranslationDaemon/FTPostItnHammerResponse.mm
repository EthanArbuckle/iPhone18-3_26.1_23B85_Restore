...
- (Offset<siri::speech::schema_fb::PostItnHammerResponse>)addObjectToBuffer:(void *)buffer
{
  ...
  std::vector<apple::aiml::flatbuffers2::Offset<siri::speech::schema_fb::RecognitionToken>>::reserve(&v44, [tokens count]);
  ...
  v28 = [tokens2 countByEnumeratingWithState:&v40 objects:v45 count:16];
  if (v28)
  {
    v29 = *v41;
    do
