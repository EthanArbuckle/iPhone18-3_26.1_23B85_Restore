...
- (FTTextToSpeechRequestContext_ContextInfoEntry)initWithFlatbuffData:(id)a3 root:(const ContextInfoEntry *)a4 verify:(BOOL)a5
{
  ...
  v9 = a3;
  v25.receiver = self;
  v25.super_class = FTTextToSpeechRequestContext_ContextInfoEntry;
  v10 = [(FTTextToSpeechRequestContext_ContextInfoEntry *)&v25 init];
  if (!v10)
  {
    goto LABEL_13;
  }
...
- (Offset<siri::speech::schema_fb::TextToSpeechRequestContext_::ContextInfoEntry>)addObjectToBuffer:(void *)a3
{
  v5 = [(FTTextToSpeechRequestContext_ContextInfoEntry *)self key];
  v6 = v5;
  if (!v5)
  {
    v5 = &stru_284834138;
...
- (id)flatbuffData
{
  ...
  v10 = 256;
  v11 = 0;
  apple::aiml::flatbuffers2::FlatBufferBuilder::Finish(&v3, [(FTTextToSpeechRequestContext_ContextInfoEntry *)self addObjectToBuffer:&v3], 0, 0);
  operator new();
}
