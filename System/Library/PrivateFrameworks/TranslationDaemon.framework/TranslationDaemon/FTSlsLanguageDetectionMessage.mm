...
- (FLTBFBufferAccessor)session_message
{
  v3 = [(FTSlsLanguageDetectionMessage *)self session_message_type];
  v4 = 0;
  if (v3 > 2)
  {
    if (v3 == 3)
    {
      v4 = [(FTSlsLanguageDetectionMessage *)self session_messageAsFTFinishAudio];
    }

    else if (v3 == 4)
    {
      v4 = [(FTSlsLanguageDetectionMessage *)self session_messageAsFTLanguageDetectionResponse];
    }
  }

  else if (v3 == 1)
  {
    v4 = [(FTSlsLanguageDetectionMessage *)self session_messageAsFTStartLanguageDetectionRequest];
  }

  else if (v3 == 2)
  {
    v4 = [(FTSlsLanguageDetectionMessage *)self session_messageAsFTAudioPacket];
  }
...
- (Offset<siri::speech::qss_fb::SlsLanguageDetectionMessage>)addObjectToBuffer:(void *)a3
{
  v5 = [(FTSlsLanguageDetectionMessage *)self session_message_type];
  if ([(FTSlsLanguageDetectionMessage *)self session_message_type]== 1)
  {
