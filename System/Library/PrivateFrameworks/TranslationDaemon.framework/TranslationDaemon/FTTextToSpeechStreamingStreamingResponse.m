...
- (FLTBFBufferAccessor)content
{
  v3 = [(FTTextToSpeechStreamingStreamingResponse *)self content_type];
  v4 = 0;
  if (v3 > 2)
  {
    if (v3 == 3)
    {
      v4 = [(FTTextToSpeechStreamingStreamingResponse *)self contentAsFTPartialTextToSpeechStreamingResponse];
    }

    else if (v3 == 4)
    {
      v4 = [(FTTextToSpeechStreamingStreamingResponse *)self contentAsFTFinalTextToSpeechStreamingResponse];
    }
  }

  else if (v3 == 1)
  {
    v4 = [(FTTextToSpeechStreamingStreamingResponse *)self contentAsFTQssAckResponse];
  }

  else if (v3 == 2)
  {
    v4 = [(FTTextToSpeechStreamingStreamingResponse *)self contentAsFTBeginTextToSpeechStreamingResponse];
  }
...
- (Offset<siri::speech::qss_fb::TextToSpeechStreamingStreamingResponse>)addObjectToBuffer:(void *)a3
{
  v5 = [(FTTextToSpeechStreamingStreamingResponse *)self content_type];
  if ([(FTTextToSpeechStreamingStreamingResponse *)self content_type]== 1)
  {
