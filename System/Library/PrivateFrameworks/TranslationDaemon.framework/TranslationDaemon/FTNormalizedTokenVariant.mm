...
- (FTNormalizedTokenVariant)initWithFlatbuffData:(id)data root:(const NormalizedTokenVariant *)root verify:(BOOL)verify;
- (NSArray)normalized_tokens;
- (Offset<siri::speech::schema_fb::NormalizedTokenVariant>)addObjectToBuffer:(void *)buffer;
- (id)flatbuffData;
- (id)normalized_tokens_objectAtIndex:(unint64_t)index;
- (unint64_t)normalized_tokens_count;
- (void)normalized_tokens_enumerateObjectsUsingBlock:(id)block;
@end
...
- (Offset<siri::speech::schema_fb::NormalizedTokenVariant>)addObjectToBuffer:(void *)buffer
{
  ...
  normalized_tokens = [(FTNormalizedTokenVariant *)self normalized_tokens];
  std::vector<apple::aiml::flatbuffers2::Offset<siri::speech::schema_fb::RecognitionToken>>::reserve(&v25, [normalized_tokens count]);

  v23 = 0u;
  v24 = 0u;
  v21 = 0u;
  v22 = 0u;
  normalized_tokens2 = [(FTNormalizedTokenVariant *)self normalized_tokens];
