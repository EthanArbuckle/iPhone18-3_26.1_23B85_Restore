...
- (FTTextToSpeechSpeechFeatureInputText)initWithFlatbuffData:(id)data root:(const TextToSpeechSpeechFeatureInputText *)root verify:(BOOL)verify;
- (NSArray)words;
- (Offset<siri::speech::schema_fb::TextToSpeechSpeechFeatureInputText>)addObjectToBuffer:(void *)buffer;
- (id)flatbuffData;
- (id)words_objectAtIndex:(unint64_t)index;
- (unint64_t)words_count;
- (void)words_enumerateObjectsUsingBlock:(id)block;
@end
...
- (FTTextToSpeechSpeechFeatureInputText)initWithFlatbuffData:(id)data root:(const TextToSpeechSpeechFeatureInputText *)root verify:(BOOL)verify
{
  ...
  dataCopy = data;
  v25.receiver = self;
  v25.super_class = FTTextToSpeechSpeechFeatureInputText;
  v10 = [(FTTextToSpeechSpeechFeatureInputText *)&v25 init];
  if (!v10)
  {
    goto LABEL_13;
  }
  ...
  if (!siri::speech::schema_fb::TextToSpeechSpeechFeatureInputText::Verify(v18, v21))
  {
LABEL_14:
    v19 = 0;
  }
...
- (id)words_objectAtIndex:(unint64_t)index
{
  v5 = [(NSMutableDictionary *)self->_storage objectForKeyedSubscript:@"words"];
  v6 = v5;
  if (v5)
  {
...
LABEL_3:
  ...
  if (*v10->var0 >= 5u)
  {
    ...
    if (v11)
    {
      ...
      v7 = [[FTTextToSpeechSpeechFeatureInputWord alloc] initWithFlatbuffData:self->_data root:v12 + 4 + *(v12 + 4) verify:0];
      goto LABEL_3;
    }
  }
    ...
    if (*v8->var0 >= 5u)
    {
      ...
      if (v9)
      {
        ...
        if (v11)
        {
          ...
          do
          {
            v15 = [[FTTextToSpeechSpeechFeatureInputWord alloc] initWithFlatbuffData:self->_data root:&v13[*v13->var0] verify:0];
...
- (Offset<siri::speech::schema_fb::TextToSpeechSpeechFeatureInputText>)addObjectToBuffer:(void *)buffer
{
  ...
  words = [(FTTextToSpeechSpeechFeatureInputText *)self words];
  std::vector<apple::aiml::flatbuffers2::Offset<siri::speech::schema_fb::RecognitionToken>>::reserve(&v32, [words count]);

  v30 = 0u;
  v31 = 0u;
  v28 = 0u;
  v29 = 0u;
  words2 = [(FTTextToSpeechSpeechFeatureInputText *)self words];
  v7 = [words2 countByEnumeratingWithState:&v28 objects:v33 count:16];
  if (v7)
  {
    v8 = *v29;
    do
    {
      for (i = 0; i != v7; ++i)
      {
        if (*v29 != v8)
        {
          objc_enumerationMutation(words2);
        }
...
- (id)flatbuffData
{
  ...
  v10 = 256;
  v11 = 0;
  apple::aiml::flatbuffers2::FlatBufferBuilder::Finish(&v3, [(FTTextToSpeechSpeechFeatureInputText *)self addObjectToBuffer:&v3], 0, 0);
  operator new();
}
