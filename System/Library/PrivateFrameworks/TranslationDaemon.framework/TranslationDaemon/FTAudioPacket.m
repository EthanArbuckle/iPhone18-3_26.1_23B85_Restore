...
- (FTAudioPacket)initWithFlatbuffData:(id)a3 root:(const AudioPacket *)a4 verify:(BOOL)a5
{
  ...
  v9 = a3;
  v25.receiver = self;
  v25.super_class = FTAudioPacket;
  v10 = [(FTAudioPacket *)&v25 init];
  if (!v10)
  {
    goto LABEL_13;
  }
...
- (id)flatbuffData
{
  ...
  v10 = 256;
  v11 = 0;
  apple::aiml::flatbuffers2::FlatBufferBuilder::Finish(&v3, [(FTAudioPacket *)self addObjectToBuffer:&v3], 0, 0);
  operator new();
}
