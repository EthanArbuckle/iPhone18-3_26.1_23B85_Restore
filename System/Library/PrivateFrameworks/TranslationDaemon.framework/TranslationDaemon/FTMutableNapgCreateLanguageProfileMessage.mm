...
- (void)setSession_messageAsFTCreateLanguageProfileRequest:(id)request;
- (void)setSession_messageAsFTCreateLanguageProfileResponse:(id)response;
...
{
  v6.receiver = self;
  v6.super_class = FTMutableNapgCreateLanguageProfileMessage;
...
- (void)setSession_message:(id)session_message
{
  ...
  -[FTMutableNapgCreateLanguageProfileMessage setSession_message_type:](self, "setSession_message_type:", [objc_opt_class() session_message_typeForObject:session_messageCopy]);
