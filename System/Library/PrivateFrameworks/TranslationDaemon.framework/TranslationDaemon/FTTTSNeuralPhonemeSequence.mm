...
- (FTTTSNeuralPhonemeSequence)initWithFlatbuffData:(id)data root:(const TTSNeuralPhonemeSequence *)root verify:(BOOL)verify;
- (NSArray)phonemes;
...
- (FTTTSNeuralPhonemeSequence)initWithFlatbuffData:(id)data root:(const TTSNeuralPhonemeSequence *)root verify:(BOOL)verify
{
  ...
  dataCopy = data;
  v25.receiver = self;
  v25.super_class = FTTTSNeuralPhonemeSequence;
  v10 = [(FTTTSNeuralPhonemeSequence *)&v25 init];
  if (!v10)
  {
    goto LABEL_13;
  }
...
- (Offset<siri::speech::schema_fb::TTSNeuralPhonemeSequence>)addObjectToBuffer:(void *)buffer
{
  ...
  phonemes = [(FTTTSNeuralPhonemeSequence *)self phonemes];
  ...
  v21 = 0u;
  v22 = 0u;
  phonemes2 = [(FTTTSNeuralPhonemeSequence *)self phonemes];
...
- (id)flatbuffData
{
  ...
  v10 = 256;
  v11 = 0;
  apple::aiml::flatbuffers2::FlatBufferBuilder::Finish(&v3, [(FTTTSNeuralPhonemeSequence *)self addObjectToBuffer:&v3], 0, 0);
  operator new();
}
