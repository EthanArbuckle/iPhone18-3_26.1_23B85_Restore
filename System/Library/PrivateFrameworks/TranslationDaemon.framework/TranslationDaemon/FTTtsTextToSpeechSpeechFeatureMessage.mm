...
- (FTTtsTextToSpeechSpeechFeatureMessage)initWithFlatbuffData:(id)a3 root:(const TtsTextToSpeechSpeechFeatureMessage *)a4 verify:(BOOL)a5
{
  ...
  if (v10)
  {
    ...
    if (v5)
    {
      ...
      if (v19)
      {
        if (!siri::speech::qss_fb::TtsTextToSpeechSpeechFeatureMessage::Verify(v19, &v24))
        {
LABEL_15:
          v22 = 0;
          goto LABEL_16;
...
- (id)flatbuffData
{
  ...
  v10 = 256;
  v11 = 0;
  apple::aiml::flatbuffers2::FlatBufferBuilder::Finish(&v3, [(FTTtsTextToSpeechSpeechFeatureMessage *)self addObjectToBuffer:&v3], 0, 0);
  operator new();
}
