...
- (FTSiriPayloadTranslationInfo)initWithFlatbuffData:(id)data root:(const SiriPayloadTranslationInfo *)root verify:(BOOL)verify
{
  ...
  if (!siri::speech::schema_fb::SiriPayloadTranslationInfo::Verify(v18, v21))
  {
LABEL_14:
    v19 = 0;
  }
...
- (id)flatbuffData
{
  ...
  v10 = 256;
  v11 = 0;
  apple::aiml::flatbuffers2::FlatBufferBuilder::Finish(&v3, [(FTSiriPayloadTranslationInfo *)self addObjectToBuffer:&v3], 0, 0);
  operator new();
}
