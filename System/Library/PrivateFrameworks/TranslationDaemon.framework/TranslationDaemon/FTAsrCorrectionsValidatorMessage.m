...
- (FLTBFBufferAccessor)session_message
{
  v3 = [(FTAsrCorrectionsValidatorMessage *)self session_message_type];
  if (v3 == 2)
  {
    v4 = [(FTAsrCorrectionsValidatorMessage *)self session_messageAsFTCorrectionsValidatorResponse];
  }

  else if (v3 == 1)
  {
    v4 = [(FTAsrCorrectionsValidatorMessage *)self session_messageAsFTCorrectionsValidatorRequest];
  }
...
- (Offset<siri::speech::qss_fb::AsrCorrectionsValidatorMessage>)addObjectToBuffer:(void *)a3
{
  v5 = [(FTAsrCorrectionsValidatorMessage *)self session_message_type];
  if ([(FTAsrCorrectionsValidatorMessage *)self session_message_type]== 1)
  {
