...
- (FTCategoryData)initWithFlatbuffData:(id)a3 root:(const CategoryData *)a4 verify:(BOOL)a5
{
  ...
  v9 = a3;
  v25.receiver = self;
  v25.super_class = FTCategoryData;
  v10 = [(FTCategoryData *)&v25 init];
  if (!v10)
  {
    goto LABEL_13;
  }
  ...
  if (!siri::speech::schema_fb::CategoryData::Verify(v18, v21))
  {
LABEL_14:
    v19 = 0;
  }
...
- (id)category_data_objectAtIndex:(unint64_t)a3
{
  v5 = [(NSMutableDictionary *)self->_storage objectForKeyedSubscript:@"category_data"];
  v6 = v5;
  if (v5)
  {
...
LABEL_3:
  ...
  if (*v10->var0 >= 7u)
  {
    ...
    if (v11)
    {
      ...
      v7 = [[FTUserDataEntity alloc] initWithFlatbuffData:self->_data root:v12 + 4 + *(v12 + 4) verify:0];
      goto LABEL_3;
    }
  }
    ...
    if (*v8->var0 >= 7u)
    {
      ...
      if (v9)
      {
        ...
        if (v11)
        {
          ...
          do
          {
            v15 = [[FTUserDataEntity alloc] initWithFlatbuffData:self->_data root:&v13[*v13->var0] verify:0];
            v4[2](v4, v15, v12, &v18);
            v16 = v18;
...
- (Offset<siri::speech::schema_fb::CategoryData>)addObjectToBuffer:(void *)a3
{
  ...
  v5 = [(FTCategoryData *)self category_name];
  v6 = v5;
  if (!v5)
  {
    v5 = &stru_284834138;
  ...
  v9 = [(FTCategoryData *)self category_data];
  ...
  {
    v24 = &apple::aiml::flatbuffers2::data<apple::aiml::flatbuffers2::Offset<siri::speech::schema_fb::UserDataEntity>,std::allocator<apple::aiml::flatbuffers2::Offset<siri::speech::schema_fb::UserDataEntity>>>(std::vector<apple::aiml::flatbuffers2::Offset<siri::speech::schema_fb::UserDataEntity>> const&)::t;
  }
...
- (id)flatbuffData
{
  ...
  v10 = 256;
  v11 = 0;
  apple::aiml::flatbuffers2::FlatBufferBuilder::Finish(&v3, [(FTCategoryData *)self addObjectToBuffer:&v3], 0, 0);
  operator new();
}
