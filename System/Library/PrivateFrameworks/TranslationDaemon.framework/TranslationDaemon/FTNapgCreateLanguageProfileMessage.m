...
- (FLTBFBufferAccessor)session_message
{
  v3 = [(FTNapgCreateLanguageProfileMessage *)self session_message_type];
  if (v3 == 2)
  {
    v4 = [(FTNapgCreateLanguageProfileMessage *)self session_messageAsFTCreateLanguageProfileResponse];
  }

  else if (v3 == 1)
  {
    v4 = [(FTNapgCreateLanguageProfileMessage *)self session_messageAsFTCreateLanguageProfileRequest];
  }
...
- (Offset<siri::speech::qss_fb::NapgCreateLanguageProfileMessage>)addObjectToBuffer:(void *)a3
{
  v5 = [(FTNapgCreateLanguageProfileMessage *)self session_message_type];
  if ([(FTNapgCreateLanguageProfileMessage *)self session_message_type]== 1)
  {
