...
- (void)setSession_messageAsFTErrorBlamerRequest:(id)request;
- (void)setSession_messageAsFTErrorBlamerResponse:(id)response;
...
{
  v6.receiver = self;
  v6.super_class = FTMutableAsrErrorBlamerMessage;
...
- (void)setSession_message:(id)session_message
{
  ...
  -[FTMutableAsrErrorBlamerMessage setSession_message_type:](self, "setSession_message_type:", [objc_opt_class() session_message_typeForObject:session_messageCopy]);
