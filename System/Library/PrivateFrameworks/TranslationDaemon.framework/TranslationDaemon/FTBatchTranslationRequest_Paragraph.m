...
- (Offset<siri::speech::schema_fb::BatchTranslationRequest_::Paragraph>)addObjectToBuffer:(void *)a3
{
  ...
  v5 = [(FTBatchTranslationRequest_Paragraph *)self paragraph_id];
  v6 = v5;
  if (!v5)
  {
    v5 = &stru_284834138;
  ...
  v15 = [(FTBatchTranslationRequest_Paragraph *)self span];
  std::vector<apple::aiml::flatbuffers2::Offset<siri::speech::schema_fb::RecognitionToken>>::reserve(&v33, [v15 count]);

  v31 = 0u;
  v32 = 0u;
  v29 = 0u;
  v30 = 0u;
  v16 = [(FTBatchTranslationRequest_Paragraph *)self span];
  ...
  if (v17)
  {
    ...
    do
    {
      for (i = 0; i != v17; ++i)
      {
        ...
        v28 = [*(*(&v29 + 1) + 8 * i) addObjectToBuffer:a3];
  ...
  v21 = apple::aiml::flatbuffers2::FlatBufferBuilder::CreateVector<apple::aiml::flatbuffers2::String>(a3, begin, v33.__end_ - v33.__begin_);
  *(a3 + 70) = 1;
  v22 = *(a3 + 8);
  v23 = *(a3 + 12);
  v24 = *(a3 + 10);
  ...
  v25.var0 = apple::aiml::flatbuffers2::FlatBufferBuilder::EndTable(a3, v22 - v23 + v24);
  if (v33.__begin_)
  {
