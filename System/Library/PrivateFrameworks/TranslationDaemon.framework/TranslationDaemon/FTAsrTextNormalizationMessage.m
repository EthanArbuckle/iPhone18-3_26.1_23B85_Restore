...
- (FLTBFBufferAccessor)session_message
{
  v3 = [(FTAsrTextNormalizationMessage *)self session_message_type];
  if (v3 == 2)
  {
    v4 = [(FTAsrTextNormalizationMessage *)self session_messageAsFTTextNormalizationResponse];
  }

  else if (v3 == 1)
  {
    v4 = [(FTAsrTextNormalizationMessage *)self session_messageAsFTTextNormalizationRequest];
  }
...
- (Offset<siri::speech::qss_fb::AsrTextNormalizationMessage>)addObjectToBuffer:(void *)a3
{
  v5 = [(FTAsrTextNormalizationMessage *)self session_message_type];
  if ([(FTAsrTextNormalizationMessage *)self session_message_type]== 1)
  {
