...
- (FTTranslationResponse_TranslationToken)initWithFlatbuffData:(id)a3 root:(const TranslationToken *)a4 verify:(BOOL)a5
{
  ...
  if (!siri::speech::schema_fb::TranslationResponse_::TranslationToken::Verify(v18, v21))
  {
LABEL_14:
    v19 = 0;
  }
...
- (Offset<siri::speech::schema_fb::TranslationResponse_::TranslationToken>)addObjectToBuffer:(void *)a3
{
  v5 = [(FTTranslationResponse_TranslationToken *)self token];
  v6 = v5;
  if (!v5)
  {
    v5 = &stru_284834138;
  ...
  v13 = [(FTTranslationResponse_TranslationToken *)self add_space_after];
  *(a3 + 70) = 1;
  v14 = *(a3 + 10);
  v15 = *(a3 + 8) - *(a3 + 12);
