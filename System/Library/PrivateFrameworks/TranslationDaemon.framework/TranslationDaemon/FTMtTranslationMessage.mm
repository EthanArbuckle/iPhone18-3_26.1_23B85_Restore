...
- (FTMtTranslationMessage)initWithFlatbuffData:(id)a3 root:(const MtTranslationMessage *)a4 verify:(BOOL)a5
{
  ...
  if (v10)
  {
    ...
    if (v5)
    {
      ...
      if (v19)
      {
        if (!siri::speech::qss_fb::MtTranslationMessage::Verify(v19, &v24))
        {
LABEL_15:
          v22 = 0;
          goto LABEL_16;
...
- (FLTBFBufferAccessor)session_message
{
  v3 = [(FTMtTranslationMessage *)self session_message_type];
  if (v3 == 2)
  {
    v4 = [(FTMtTranslationMessage *)self session_messageAsFTTranslationResponse];
  }

  else if (v3 == 1)
  {
    v4 = [(FTMtTranslationMessage *)self session_messageAsFTTranslationRequest];
  }
...
- (Offset<siri::speech::qss_fb::MtTranslationMessage>)addObjectToBuffer:(void *)a3
{
  v5 = [(FTMtTranslationMessage *)self session_message_type];
  if ([(FTMtTranslationMessage *)self session_message_type]== 1)
  {
