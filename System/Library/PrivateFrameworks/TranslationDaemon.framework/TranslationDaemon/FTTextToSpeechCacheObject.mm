...
- (Offset<siri::speech::schema_fb::TextToSpeechCacheObject>)addObjectToBuffer:(void *)a3
{
  ...
  v5 = [(FTTextToSpeechCacheObject *)self word_timing_info];
  ...
  v19 = 0u;
  v20 = 0u;
  v6 = [(FTTextToSpeechCacheObject *)self word_timing_info];
  ...
  *(a3 + 70) = 1;
  ...
  v13 = *(a3 + 12);
  v14 = *(a3 + 10);
  apple::aiml::flatbuffers2::FlatBufferBuilder::AddOffset<apple::aiml::flatbuffers2::String>(a3, 4, *(v26 + 12));
  apple::aiml::flatbuffers2::FlatBufferBuilder::AddOffset<apple::aiml::flatbuffers2::String>(a3, 6, v11);
  v15.var0 = apple::aiml::flatbuffers2::FlatBufferBuilder::EndTable(a3, v12 - v13 + v14);
  if (v23.__begin_)
  {
