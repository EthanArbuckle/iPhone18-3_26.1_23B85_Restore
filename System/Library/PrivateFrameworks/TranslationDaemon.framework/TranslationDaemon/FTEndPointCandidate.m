...
- (FTEndPointCandidate)initWithFlatbuffData:(id)a3 root:(const EndPointCandidate *)a4 verify:(BOOL)a5
{
  ...
  if (!siri::speech::schema_fb::EndPointCandidate::Verify(v18, v21))
  {
LABEL_14:
    v19 = 0;
  }
...
- (Offset<siri::speech::schema_fb::EndPointCandidate>)addObjectToBuffer:(void *)a3
{
  v5 = [(FTEndPointCandidate *)self speech_id];
  v6 = v5;
  if (!v5)
  {
    v5 = &stru_284834138;
  ...
  v15 = [(FTEndPointCandidate *)self return_code];
  ...
  v20 = [(FTEndPointCandidate *)self end_point_likelihood];
  v21 = [(FTEndPointCandidate *)self processed_audio_duration_ms];
  *(a3 + 70) = 1;
  v22 = *(a3 + 10);
  v23 = *(a3 + 8) - *(a3 + 12);
