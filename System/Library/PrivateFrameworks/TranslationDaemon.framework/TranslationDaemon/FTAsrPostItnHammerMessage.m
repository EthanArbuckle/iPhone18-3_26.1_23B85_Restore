...
- (FLTBFBufferAccessor)session_message
{
  v3 = [(FTAsrPostItnHammerMessage *)self session_message_type];
  if (v3 == 2)
  {
    v4 = [(FTAsrPostItnHammerMessage *)self session_messageAsFTPostItnHammerResponse];
  }

  else if (v3 == 1)
  {
    v4 = [(FTAsrPostItnHammerMessage *)self session_messageAsFTPostItnHammerRequest];
  }
...
- (Offset<siri::speech::qss_fb::AsrPostItnHammerMessage>)addObjectToBuffer:(void *)a3
{
  v5 = [(FTAsrPostItnHammerMessage *)self session_message_type];
  if ([(FTAsrPostItnHammerMessage *)self session_message_type]== 1)
  {
