...
- (FTAsrItnMessage)initWithFlatbuffData:(id)a3 root:(const AsrItnMessage *)a4 verify:(BOOL)a5
{
  ...
  if (v10)
  {
    ...
    if (v5)
    {
      ...
      if (v19)
      {
        if (!siri::speech::qss_fb::AsrItnMessage::Verify(v19, &v24))
        {
LABEL_15:
          v22 = 0;
          goto LABEL_16;
...
- (FLTBFBufferAccessor)session_message
{
  v3 = [(FTAsrItnMessage *)self session_message_type];
  if (v3 == 2)
  {
    v4 = [(FTAsrItnMessage *)self session_messageAsFTItnResponse];
  }

  else if (v3 == 1)
  {
    v4 = [(FTAsrItnMessage *)self session_messageAsFTItnRequest];
  }
...
- (Offset<siri::speech::qss_fb::AsrItnMessage>)addObjectToBuffer:(void *)a3
{
  v5 = [(FTAsrItnMessage *)self session_message_type];
  if ([(FTAsrItnMessage *)self session_message_type]== 1)
  {
