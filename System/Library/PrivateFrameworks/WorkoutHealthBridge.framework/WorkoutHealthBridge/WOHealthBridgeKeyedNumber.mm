...
- (id)description
{
  ...
  v4 = [(WOHealthBridgeKeyedNumber *)v9 dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  v4 = [MEMORY[0x277CCABB0] numberWithDouble:{v7->_number, v6[0]}];
  [v3 setObject:? forKey:?];
  MEMORY[0x277D82BD8](v4);
...
- (BOOL)readFrom:(id)a3
{
  ...
  v4 = WOHealthBridgeKeyedNumberReadFrom(v6, location[0]);
...
- (void)mergeFrom:(id)a3
{
  ...
  if (*(location[0] + 2))
  {
    [(WOHealthBridgeKeyedNumber *)v4 setKey:*(location[0] + 2)];
  }

  v4->_number = *(location[0] + 1);
  objc_storeStrong(location, 0);
}
