...
- (void)dbQueueDeletePersistentValueWithKey:(id)a3
{
  ...
  v7 = v6;
  MSSqliteTrapForDBLockError(v6);
  if (v7 || (v8 = sqlite3_bind_text(v5, 1, [v4 UTF8String], -1, 0xFFFFFFFFFFFFFFFFLL), v9 = v8, MSSqliteTrapForDBLockError(v8), v9) || (v10 = sqlite3_step(v5), v11 = v10, MSSqliteTrapForDBLockError(v10), v11 != 101))
  {
...
- (void)dbQueueSetPersistentObject:(id)a3 forKey:(id)a4
{
  ...
  v6 = a4;
  v14 = 0;
  v7 = [MEMORY[0x277CCAAB0] archivedDataWithRootObject:a3 requiringSecureCoding:1 error:&v14];
  v8 = v14;
  v9 = v8;
  if (!v7)
  {
    ...
    v11 = [v8 userInfo];
    v12 = [v10 stringWithFormat:@"Failed to archive an object. Error: %@ Info: %@", v9, v11];
...
LABEL_3:
      ...
      v11 = sqlite3_bind_text(v8, 1, [v7 UTF8String], -1, 0xFFFFFFFFFFFFFFFFLL);
      v12 = v11;
      ...
      v14 = sqlite3_bind_blob(v8, 2, [v6 bytes], v13, 0xFFFFFFFFFFFFFFFFLL);
      goto LABEL_10;
    }
  }
  ...
  v14 = sqlite3_bind_text(v8, 1, [v7 UTF8String], -1, 0xFFFFFFFFFFFFFFFFLL);
LABEL_10:
  v17 = v14;
...
- (id)dbQueuePersistentObjectForKey:(id)a3
{
  v17 = *MEMORY[0x277D85DE8];
  v4 = a3;
  v5 = [(MSASModelBase *)self dbQueuePersistentDataForKey:v4];
  if (v5)
  {
    v10 = 0;
...
- (id)dbQueuePersistentDataForKey:(id)a3
{
  ...
  v6 = 1;
  v7 = sqlite3_bind_text(v5, 1, [v4 UTF8String], -1, 0xFFFFFFFFFFFFFFFFLL);
  v8 = v7;
...
- (void)setPersistentObject:(id)a3 forKey:(id)a4
{
  ...
  v6 = a4;
  v20 = 0;
  v7 = [MEMORY[0x277CCAAB0] archivedDataWithRootObject:a3 requiringSecureCoding:1 error:&v20];
  v8 = v20;
  v9 = v8;
  if (!v7)
  {
  ...
  v13 = [(MSASModelBase *)self dbQueue];
  block[0] = MEMORY[0x277D85DD0];
  block[1] = 3221225472;
...
- (sqlite3_stmt)statementForString:(id)a3
{
  ...
  if (v4)
  {
    v5 = [(MSASModelBase *)self statementQueue];
    block[0] = MEMORY[0x277D85DD0];
    block[1] = 3221225472;
...
- (MSASModelBase)initWithPersonID:(id)a3 databasePath:(id)a4 currentVersion:(int)a5
{
  ...
  if (v11)
  {
    ...
    objc_storeStrong(&v11->_personID, a3);
