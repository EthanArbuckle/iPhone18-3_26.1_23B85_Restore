...
- (void)_putItemDone:(unint64_t)a3 putReceipt:(id)a4 error:(id)a5
{
  ...
  v9 = a5;
  v10 = [v9 domain];
  if ([v10 isEqualToString:*MEMORY[0x277D25460]])
  {
    v11 = [v9 code];
    ...
    v10 = MSCFCopyLocalizedString(@"ERROR_PUBLISH_STORAGE_NEED_RESUBMISSION");
    v13 = [v12 MSErrorWithDomain:@"MSPublishStorageProtocolErrorDomain" code:2 description:v10 underlyingError:v9];
...
LABEL_5:
  if (os_log_type_enabled(MEMORY[0x277D86220], OS_LOG_TYPE_DEBUG))
  {
    v18 = objc_opt_class();
    v19 = v18;
    v20 = [(MSMMCSProtocol *)self personID];
    v21 = [v9 MSVerboseDescription];
    v22 = 138543874;
    v23 = v18;
    v24 = 2112;
    v25 = v20;
...
- (void)publishAssets:(id)a3 URL:(id)a4
{
  ...
  if (v7)
  {
    ...
    do
    {
      ...
      v11 = [v10 metadata];
      v12 = [v11 objectForKey:@"MSAssetMetadataItemID"];
      v13 = [v10 MMCSAccessHeader];
      ...
      v17 = [v13 cStringUsingEncoding:4];
      v18 = strlen(v17);
  ...
  if (v22)
  {
    if (os_log_type_enabled(MEMORY[0x277D86220], OS_LOG_TYPE_ERROR))
    {
      v26 = objc_opt_class();
      v27 = v26;
      v28 = [(MSMMCSProtocol *)self personID];
      v29 = [v22 MSVerboseDescription];
      *buf = 138544130;
      v37 = v26;
      v38 = 2112;
      v39 = v28;
...
- (id)_getUTIFromItem:(unint64_t)a3
{
  ...
  else
  {
    if (os_log_type_enabled(MEMORY[0x277D86220], OS_LOG_TYPE_ERROR))
    {
      v15 = objc_opt_class();
      v16 = v15;
      v17 = [(MSMMCSProtocol *)self personID];
      v18 = 138543874;
      v19 = v15;
      v20 = 2112;
      v21 = v17;
...
- (int)_getFileDescriptorFromItem:(unint64_t)a3
{
  ...
  else
  {
    if (os_log_type_enabled(MEMORY[0x277D86220], OS_LOG_TYPE_ERROR))
    {
      v14 = objc_opt_class();
      v15 = v14;
      v16 = [(MSMMCSProtocol *)self personID];
      v17 = 138543874;
      v18 = v14;
      v19 = 2112;
      v20 = v16;
...
- (void)computeHashForAsset:(id)a3
{
  v30 = *MEMORY[0x277D85DE8];
  v4 = a3;
  v5 = [MSMMCSProtocol computeItemIDForAsset:v4];
  ...
  v8 = [v4 metadata];
  v9 = [v8 objectForKey:@"MSAssetMetadataSHA1HashKey"];

  if (!v9)
  {
    v10 = [(MSPublishStorageProtocolDelegate *)self->_delegate publishStorageProtocol:self didRequestFDForAsset:v4];
    if ((v10 & 0x80000000) != 0)
    {
      if (!os_log_type_enabled(MEMORY[0x277D86220], OS_LOG_TYPE_ERROR))
      {
      ...
      v20 = objc_opt_class();
      v12 = v20;
      v21 = [(MSMMCSProtocol *)self personID];
      *buf = 138543874;
      v23 = v20;
      v24 = 2112;
      v25 = v21;
    ...
    else
    {
      ...
      [(MSPublishStorageProtocolDelegate *)self->_delegate publishStorageProtocol:self didFinishUsingFD:v11 forAsset:v4];
    }
  }
...
{
  v4 = a3;
  v5 = MSPathPublishMMCSLibraryForPersonID(v4);
  v10.receiver = self;
  v10.super_class = MSPublishMMCSProtocol;
  v6 = [(MSMMCSProtocol *)&v10 initWithPersonID:v4 path:v5];
