  ...
  if (v4 + v6)
  {
    ...
    do
    {
      ...
      else
      {
        ...
        v18 = [v28 vk_substringWithRange:{v13, v15}];
        v19 = [VKTextRange rangeWithNSRange:v13, v15];
...
- (VKCImageTextSelectionView)initWithFrame:(CGRect)a3
{
  ...
  v3 = [(VKCImageBaseOverlayView *)&v8 initWithFrame:a3.origin.x, a3.origin.y, a3.size.width, a3.size.height];
  if (v3)
  {
...
- (CGPoint)selectionQuadsVertexCentroid
{
  ...
  v4 = [(VKCImageTextSelectionView *)self selectionRectsForRange:v3];
...
- (void)setRecognitionResult:(id)a3
{
  ...
  v6 = [(VKCImageTextSelectionView *)self text];
  v7 = [v6 vk_range];
  ...
  if ([(VKCImageTextSelectionView *)self highlightSelectableItems])
  {
    ...
    else
    {
      ...
      v13 = [(VKCImageTextSelectionView *)self highlightLayer];
      [v13 setHidden:1];
...
- (void)setHighlightSelectableItems:(BOOL)a3 animated:(BOOL)a4
{
  if (self->_highlightSelectableItems != a3)
  {
    ...
    {
      v6 = [(VKCImageTextSelectionView *)self highlightLayer];
      v7 = [(VKCImageTextSelectionView *)self highlightShadowLayer];
      if (v4)
      {
        [MEMORY[0x1E6979518] begin];
...
- (void)setFrame:(CGRect)a3
{
  ...
  [(VKCImageTextSelectionView *)&v4 setFrame:a3.origin.x, a3.origin.y, a3.size.width, a3.size.height];
...
{
  v3 = [(VKCImageTextSelectionView *)self text];
  v4 = [(VKCImageTextSelectionView *)self selectedVKRange];
  v5 = [v3 vk_substringWithVKRange:v4];
...
{
  v3 = [(VKCImageTextSelectionView *)self selectedVKRange];
  v4 = [(VKCImageTextSelectionView *)self attributedTextInRange:v3];
...
- (void)setBounds:(CGRect)a3
{
  ...
  if (!CGRectEqualToRect(v26, v27))
  {
    ...
    [v24 textSelectionView:self boundsDidChangeFromRect:v9 toRect:{v11, v13, v15, v17, v19, v21, v23}];
  }
}
...
- (void)updateHighlightLayerGeometry
{
  ...
  v4 = [(VKCImageTextSelectionView *)self highlightShadowLayer];
  ...
  v8 = v7;
  v24 = v25;
  [v3 setAffineTransform:&v24];
  [v3 setPosition:{v6, v8}];
  [(VKCImageTextSelectionView *)self currentContentsRectInLayerCoordinates];
  v10 = v9;
  v12 = v11;
  v14 = v13;
  ...
  v17 = [(VKCImageTextSelectionView *)self normalizedHighlightPath];
  v18 = [v17 copy];

  v23 = v24;
  [v18 vk_applyTransform:&v23];
  [v4 setAnchorPoint:{0.5, 0.5}];
  [v4 setFrame:{v10, v12, v14, v16}];
  [v4 setShadowPath:{objc_msgSend(v18, "vk_CGPath")}];
  v19 = objc_alloc_init(MEMORY[0x1E69794A0]);
  [v19 setAnchorPoint:{0.5, 0.5}];
  [v4 bounds];
  [v19 setFrame:?];
  v20 = [(VKCImageTextSelectionView *)self borderedNormalizedHighlightPath];
  v21 = [v20 copy];
...
- (id)summaryDescription
{
  v2 = [(VKCImageTextSelectionView *)self text];
  v3 = [v2 vk_substringToIndex:40];
...
- (void)performHighlightSelectableTextAnimated:(BOOL)a3
{
  ...
  v7 = [v6 vk_range];
  v9 = [VKTextRange rangeWithNSRange:v7, v8];
  v10 = [v5 normalizedSelectionQuadsForRange:v9];

  v11 = [(VKCImageTextSelectionView *)self textSelectionDelegate];
  v12 = [v11 nonTextNormalizedHighlightAllQuadsForTextSelectionView:self];

  v13 = [(VKCImageBaseOverlayView *)self recognitionResult];
  [v13 imageSize];
  ...
  v19 = [(VKCImageTextSelectionView *)self highlightShadowLayer];
  v20 = [(VKCImageTextSelectionView *)self highlightLayer];
  v21 = [v32 copy];
  ...
  [MEMORY[0x1E6979518] setDisableActions:1];
  [v20 setHidden:1];
  [v20 setPath:{objc_msgSend(v32, "vk_CGPath")}];
  v24 = [MEMORY[0x1E69DC888] blackColor];
  v25 = [v24 colorWithAlphaComponent:0.25];
  [v20 setFillColor:{objc_msgSend(v25, "CGColor")}];

  [v20 setFillRule:*MEMORY[0x1E69797F8]];
  [(VKCImageTextSelectionView *)self updateHighlightLayerGeometry];
  [v20 setOpacity:0.0];
  [v19 setHidden:1];
  [v19 setOpacity:0.0];
  ...
  [v19 setShadowOffset:{0.0, v26}];
  v27 = [MEMORY[0x1E69DC888] blackColor];
  [v19 setShadowColor:{objc_msgSend(v27, "CGColor")}];
...
- (CAShapeLayer)highlightLayer
{
  ...
  if (!highlightLayer)
  {
    ...
    v7 = [(VKCImageTextSelectionView *)self layer];
...
- (CALayer)highlightShadowLayer
{
  ...
  if (!highlightShadowLayer)
  {
    ...
    v6 = [(VKCImageTextSelectionView *)self layer];
...
{
  v4 = a3;
  v5 = [(VKCImageTextSelectionView *)self documentRange];
  if ([v5 length])
  {
    v6 = [v5 end];
    v7 = [v4 isEqual:v6];
    ...
    v8 = [v4 offset];
    v9 = [VKTextRange rangeWithStartOffset:v8 - v7 endOffset:v8 - v7 + 1];
...
- (id)characterRangeAtPoint:(CGPoint)a3
{
  ...
  v9 = [v8 characterRangeAtPoint:{v5, v7}];
...
- (id)positionFromPosition:(id)a3 offset:(int64_t)a4
{
  v5 = [a3 positionByAddingOffset:a4];
...
- (id)positionFromPosition:(id)a3 inDirection:(unint64_t)a4 offset:(int64_t)a5
{
  ...
  v8 = [a3 positionByAddingOffset:v7];
...
- (id)characterRangeByExtendingPosition:(id)a3 inDirection:(unint64_t)a4
{
  ...
  v6 = a3;
  v7 = [v6 positionByAddingOffset:v5];
  v8 = [(VKCImageTextSelectionView *)self boundedPositionFromPosition:v7];

  v9 = [[VKTextRange alloc] initWithStart:v6 end:v8];
...
{
  v4 = a3;
  v5 = [(VKTextPosition *)v4 offset];
  v6 = [(VKCImageTextSelectionView *)self text];
  v7 = VKMClampInt(v5, 0, [v6 length]);
...
- (id)closestPositionToPoint:(CGPoint)a3
{
  ...
  v7 = [(VKCImageTextSelectionView *)self closestPositionToPoint:v6 withinRange:x, y];
...
- (id)closestPositionToPoint:(CGPoint)a3 withinRange:(id)a4
{
  ...
  v11 = v10;
  v12 = [(VKCImageBaseOverlayView *)self recognitionResult];
  v13 = [v12 closestPositionToPoint:v7 withinRange:{v9, v11}];
...
- (id)closestQuadForBlockOfType:(unint64_t)a3 toPoint:(CGPoint)a4 maxDistance:(double)a5
{
  v6 = [(VKCImageTextSelectionView *)self closestBlockOfType:a3 toPoint:a4.x maxDistance:a4.y, a5];
  if (v6)
  {
    [(VKCImageBaseOverlayView *)self contentsRect];
    v7 = [v6 vk_quadConvertedToView:self withContentsRect:?];
  }
...
- (id)closestBlockOfType:(unint64_t)a3 toPoint:(CGPoint)a4 maxDistance:(double)a5
{
  ...
  v11 = v10;
  v13 = v12;
  v14 = [(VKCImageBaseOverlayView *)self recognitionResult];
  v15 = [v14 closestBlockOfType:a3 toPoint:{v11, v13}];

  if (v15)
  {
    [(VKCImageBaseOverlayView *)self contentsRect];
    v16 = [v15 vk_quadConvertedToView:self withContentsRect:?];
    if (([v16 containsPoint:{x, y}] & 1) != 0 || a5 > 0.0 && (objc_msgSend(v16, "mininumDistanceToPoint:", x, y), v18 <= a5))
    {
      v17 = v15;
    }
...
- (CGRect)firstRectForRange:(id)a3
{
  ...
  v5 = [(VKCImageBaseOverlayView *)self recognitionResult];
  [(VKCImageBaseOverlayView *)self contentsRect];
  [v5 firstRectForRange:v4 documentView:self contentRect:?];
  v7 = v6;
  v9 = v8;
  v11 = v10;
  v13 = v12;
...
- (id)selectionRectsForRange:(id)a3
{
  ...
  v5 = [(VKCImageBaseOverlayView *)self recognitionResult];
  [(VKCImageBaseOverlayView *)self contentsRect];
  v6 = [v5 selectionRectsForRange:v4 documentView:self contentRect:?];
...
{
  v4 = a3;
  v5 = [(VKCImageTextSelectionView *)self text];
  v6 = [v5 vk_substringWithVKRange:v4];
...
- (id)attributedTextInRange:(id)a3
{
  v4 = a3;
  v5 = [(VKCImageBaseOverlayView *)self recognitionResult];
  v6 = [v5 convertPlainTextRangeToAttributedRange:v4];

  v7 = [(VKCImageTextSelectionView *)self attributedText];
  v8 = [v7 vk_attributedSubstringFromVKRange:v6];
...
- (BOOL)containsTextAtPoint:(CGPoint)a3
{
  ...
  v5 = v4;
  v7 = v6;
  v8 = [(VKCImageTextSelectionView *)self allLineQuads];
  ...
  v11[4] = v5;
  v11[5] = v7;
  v9 = [v8 vk_containsObjectPassingTest:v11];
...
- (BOOL)containsSelectedTextAtPoint:(CGPoint)a3
{
  y = a3.y;
  x = a3.x;
  v6 = [(VKCImageTextSelectionView *)self selectedVKRange];
  if ([v6 isEmpty])
  {
    v7 = 0;
  }
  ...
  else
  {
    ...
    if (v8)
    {
      v9 = [(VKCImageBaseOverlayView *)self recognitionResult];
      v10 = [v9 sourceVNDocument];
      v11 = [v8 vk_textBlock];
      v12 = [v10 rangeOfTextBlock:v11];
      v14 = v13;

      v7 = [v6 intersectsNSRange:{v12, v14}];
    }
...
- (void)sendAnalyticsEventWithSelector:(SEL)a3 type:(int64_t)a4 source:(int64_t)a5
{
  v9 = [(VKCImageTextSelectionView *)self text];
  v10 = [(VKCImageTextSelectionView *)self selectedVKRange];
  v11 = [(VKCImageBaseOverlayView *)self recognitionResult];
  v12 = [(VKCImageBaseOverlayView *)self customAnalyticsIdentifier];
  objc_initWeak(&location, self);
  v13 = [(VKCImageTextSelectionView *)self analyticsQueue];
