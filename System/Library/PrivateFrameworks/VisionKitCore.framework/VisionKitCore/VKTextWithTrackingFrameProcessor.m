...
{
  v4 = a3;
  v5 = [(VKTextWithTrackingFrameProcessor *)self configuration];
  v6 = [v5 isEqual:v4];
...
- (void)processFrame:(id)a3
{
  ...
  v7 = [(VKTextWithTrackingFrameProcessor *)self _performRecognitionAndTracking:v4];
...
- (void)_processResults:(void *)a1
{
  ...
  if (a1)
  {
    ...
    [(VKTextWithTrackingFrameProcessor *)a1 sendResult:v9];
...
- (id)_createRequest
{
  if (a1)
  {
    ...
    v2 = [OUTLINED_FUNCTION_1_1() documentBlockType];
    v11 = *MEMORY[0x1E6960CC0];
    v12 = *(MEMORY[0x1E6960CC0] + 16);
    v3 = [v1 initWithFrameAnalysisSpacing:&v11 trackingLevelBlockType:v2 completionHandler:0];
    ...
    v4 = [OUTLINED_FUNCTION_1_1() customWords];
    v5 = [v4 count];

    if (v5)
    {
      v6 = [OUTLINED_FUNCTION_1_1() customWords];
      [v3 setCustomWords:v6];
    }

    v7 = [OUTLINED_FUNCTION_1_1() recognitionLanguages];
    v8 = v7;
    if (!v7 || ![v7 count])
    {
...
- (void)_performRecognitionAndTracking:(void *)a1
{
  ...
  {
    v3 = a2;
    v4 = [v3 imageRequestHandler];
    [v2 lock];
    v5 = v2[13];
    if (!v5)
    {
      v6 = [(VKTextWithTrackingFrameProcessor *)v2 _createRequest];
      v7 = v2[13];
      v2[13] = v6;
    ...
    v2 = [(VKTextWithTrackingFrameProcessor *)v12 _filterDocuments:v10];
  }
...
- (id)_filterDocuments:(uint64_t)a1
{
  ...
  if (a1)
  {
    ...
    if (v4)
    {
      ...
      {
        _FilterByBlockType(v4, [*(a1 + 112) documentBlockType]);
      }
      v7 = ;
    ...
    if ([*(a1 + 112) isForSingleItem] && objc_msgSend(v5, "count"))
    {
      [*(a1 + 112) comparisonPoint];
