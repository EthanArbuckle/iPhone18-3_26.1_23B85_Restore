...
id getkDDRVInteractionDidFinishNotification()
{
  ...
  v8 = getkDDRVInteractionDidFinishNotificationSymbolLoc_ptr;
...
void sub_1B4339194(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, ...)
{
  va_start(va, a11);
...
uint64_t __VisualIntelligenceCoreLibraryCore_block_invoke()
{
  result = _sl_dlopen();
...
uint64_t __VisualIntelligenceUILibraryCore_block_invoke()
{
  result = _sl_dlopen();
...
void sub_1B434418C(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, uint64_t a16, uint64_t a17, uint64_t a18, uint64_t a19, uint64_t a20, uint64_t a21, uint64_t a22, uint64_t a23, uint64_t a24, uint64_t a25, void *a26, uint64_t a27, uint64_t a28, uint64_t a29, uint64_t a30, uint64_t a31, uint64_t a32, uint64_t a33, uint64_t a34, void *a35, uint64_t a36, uint64_t a37, uint64_t a38, uint64_t a39, uint64_t a40, uint64_t a41, uint64_t a42, uint64_t a43, uint64_t a44, uint64_t a45, uint64_t a46, uint64_t a47, uint64_t a48, uint64_t a49, uint64_t a50, uint64_t a51, uint64_t a52, uint64_t a53, const void *a54, uint64_t a55, uint64_t a56, uint64_t a57, uint64_t a58, uint64_t a59, uint64_t a60, uint64_t a61, uint64_t a62, uint64_t a63)
{
  ...
  CF<CMPhotoCompressionSession *>::~CF(&a67);
  CF<CMPhotoDecompressionContainer *>::~CF(&a68);
  CF<CMPhotoDecompressionContainer *>::~CF(&a69);
  CF<CMPhotoDecompressionSession *>::~CF(&a70);
...
VKQuad *VKImageSpaceQuadFromObservation(void *a1, double a2, double a3, double a4)
{
  ...
  v14 = v13;
  v16 = v15;
  v17 = VKMPointFromNormalizedRect(v36, v34, a2, a3, a4);
  v35 = v18;
  v37 = v17;
  v19 = VKMPointFromNormalizedRect(v32, v30, a2, a3, a4);
  v31 = v20;
  v33 = v19;
  v21 = VKMPointFromNormalizedRect(v29, v28, a2, a3, a4);
  v23 = v22;
  v24 = VKMPointFromNormalizedRect(v14, v16, a2, a3, a4);
  v26 = [[VKQuad alloc] initWithBottomLeft:v37 bottomRight:v35 topLeft:v33 topRight:v31, v21, v23, v24, v25];

  return v26;
}

void sub_1B4347CB4(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, ...)
{
  va_start(va, a9);
  _Block_object_dispose(va, 8);
  _Unwind_Resume(a1);
...
void *std::vector<ClipperLib::PolyNode *>::reserve(void *result, unint64_t a2)
{
  if (a2 > (result[2] - *result) >> 3)
  {
    if (!(a2 >> 61))
    {
      std::__allocate_at_least[abi:ne200100]<std::allocator<ClipperLib::PolyNode *>>(result, a2);
    }
...
void sub_1B4353124(_Unwind_Exception *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, void *__p, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, uint64_t a16, uint64_t a17, char a18)
{
  if (__p)
  {
    operator delete(__p);
...
void sub_1B4353A10(_Unwind_Exception *a1, uint64_t a2, ...)
{
  va_start(va, a2);
...
void sub_1B4353BA4(_Unwind_Exception *a1, uint64_t a2, ...)
{
  va_start(va, a2);
  ClipperLib::Clipper::~Clipper(va);
  _Unwind_Resume(a1);
