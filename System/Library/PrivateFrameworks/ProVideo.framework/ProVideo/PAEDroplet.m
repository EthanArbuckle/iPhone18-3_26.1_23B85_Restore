...
- (BOOL)addParameters
{
  ...
  if (!v5)
  {
    ...
    [v3 addFloatSliderWithName:v9 parmId:2 defaultValue:0 parameterMin:300.0 parameterMax:-50.0 sliderMin:dbl_260343F20[v7 < 2] sliderMax:-50.0 delta:dbl_260343F30[v7 < 2] parmFlags:1.0];
...
- (BOOL)canThrowRenderOutput:(id)a3 withInput:(id)a4 withInfo:(id *)a5
{
  ...
  if (v9)
  {
    ...
    v27[0] = _Q0;
    [v9 getXValue:v27 YValue:v27 + 8 fromParm:1 atFxTime:a5->var0.var1];
    ...
    [v9 getFloatValue:&v24 fromParm:2 atFxTime:{a5->var0.var1, PCMatrix44Tmpl<double>::leftTranslate(v25, v17, -*(v27 + 1), 0.0).f64[0]}];
    v23 = 40.0;
