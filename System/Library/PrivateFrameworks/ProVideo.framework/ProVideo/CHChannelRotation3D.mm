...
- (void)getRotationAtTime:(id *)time curveX:(double *)x curveY:(double *)y curveZ:(double *)z;
- (void)getRotationAtTime:(id *)time x:(double *)x y:(double *)y z:(double *)z;
- (void)ozChannel;
...
- (void)setRotationAtTime:(id *)time curveX:(double)x curveY:(double)y curveZ:(double)z options:(unsigned int)options;
@end
...
- (void)getRotationAtTime:(id *)time x:(double *)x y:(double *)y z:(double *)z
{
  ...
  v15 = 0;
  v16 = 0;
  (*(*v11 + 336))(&v13, v11, time);
  OZChannelRotation3D::getValueAsEulerAngles(v11, &v13, &v14, 0.0);
  v12 = v15;
  *x = v14;
  *y = v12;
  *z = v16;
