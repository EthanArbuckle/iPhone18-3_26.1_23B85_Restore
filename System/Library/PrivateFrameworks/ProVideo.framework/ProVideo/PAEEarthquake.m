...
- (BOOL)canThrowRenderOutput:(id)a3 withInput:(id)a4 withInfo:(id *)a5
{
  ...
  {
    v39 = 0.0;
    [v9 getFloatValue:&v39 fromParm:1 atFxTime:a5->var0.var1];
    v38 = 0.0;
    [v10 getFloatValue:&v38 fromParm:2 atFxTime:a5->var0.var1];
    v37 = 0.0;
    [v10 getFloatValue:&v37 fromParm:3 atFxTime:a5->var0.var1];
    v36 = 0;
    [v10 getIntValue:&v36 fromParm:4 atFxTime:a5->var0.var1];
    v34 = 0.0;
    v35 = 0.0;
    [v10 getXValue:&v35 YValue:&v34 fromParm:5 atFxTime:a5->var0.var1];
    v33 = 0;
    [v10 getIntValue:&v33 fromParm:6 atFxTime:a5->var0.var1];
    v32 = 0;
    v30 = 0u;
    v31 = 0u;
    v28 = 0u;
    ...
    if (v12)
    {
      ...
      *&v22 = v39;
      [(PAEEarthquake *)self quakeHeliumNodeWithInputImage:&v26 inputImage:a4 outputImage:a3 renderInfo:v24 twist:v33 horizontalShake:v22 verticalShake:v21 layers:v20 centerX:*&v19 centerY:v13 randomSeed:v14];
      if (v26)
      {
        (*(*v26 + 24))(v26);
      }
...
- (HGRef<HGNode>)quakeHeliumNodeWithInputImage:(HGRef<HGNode>)a3 inputImage:(id)a4 outputImage:(id)a5 renderInfo:(id *)a6 twist:(float)a7 horizontalShake:(float)a8 verticalShake:(float)a9 layers:(float)a10 centerX:(float)a11 centerY:(float)a12 randomSeed:(int)a13
{
  ...
  v25 = [objc_msgSend(a4 "pixelTransform")];
  v26 = [objc_msgSend(a4 "inversePixelTransform")];
  ...
  v30 = *(a6->var0.var1 + 2);
  *&time.value = *a6->var0.var1;
  time.epoch = v30;
  v31 = a13 + 2302755 + (CMTimeGetSeconds(&time) / (v28 / v29) * 1000.0);
  for (i = 1; i != 102; ++i)
  {
  ...
  if (a10 > 0.0)
  {
    ...
    do
    {
      ...
      *(v56 + v34) = (((a8 * 25.0) + (a8 * 25.0)) * (v39 / 714020.0)) - (a8 * 25.0);
      v39 %= 0x65uLL;
      v33 = v54[v39 + 1];
      v54[v39 + 1] = ((v33 << 12) + 150889) % 0xAE529;
      *(v55 + v34++) = (((a9 * 25.0) + (a9 * 25.0)) * (v33 / 714020.0)) - (a9 * 25.0);
    }
  ...
  if (a10 == 1.0)
  {
    ...
    HGTransform::Translate(&time, -a11, -a12, 0.0);
  ...
  {
    v41 = HGMultiTexBlendBase::create(a10);
    v40 = v41;
    if (a10 <= 0.0)
    {
      if (!v41)
    ...
    else
    {
      ...
      do
      {
        ...
        HGTransform::Translate(&time, v46, v47, 0.0);
        HGTransform::HGTransform(v52);
        HGTransform::LoadMatrixd(v52, v25);
        HGTransform::Transpose(v52);
