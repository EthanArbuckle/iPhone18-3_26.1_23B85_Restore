...
+ (uint64_t)oz_arrayWithSIMDFloat3x3:()OZAdditions
{
  ...
  v10[6] = [MEMORY[0x277CCABB0] numberWithFloat:{COERCE_DOUBLE(__PAIR64__(a1.n128_u32[1], a1.n128_u32[2]))}];
...
+ (uint64_t)oz_arrayWithSIMDFloat4x4:()OZAdditions
{
  ...
  v13[8] = [MEMORY[0x277CCABB0] numberWithFloat:{COERCE_DOUBLE(__PAIR64__(a1.n128_u32[1], a1.n128_u32[2]))}];
  ...
  v13[12] = [MEMORY[0x277CCABB0] numberWithFloat:{COERCE_DOUBLE(__PAIR64__(a1.n128_u32[1], a1.n128_u32[3]))}];
