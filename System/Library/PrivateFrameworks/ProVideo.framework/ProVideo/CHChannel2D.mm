...
- (void)getDoubleValuesAtTime:(id *)time curveX:(double *)x curveY:(double *)y;
- (void)getDoubleValuesAtTime:(id *)time x:(double *)x y:(double *)y;
- (void)getMaxCurveX:(double *)x curveY:(double *)y;
- (void)getMinCurveX:(double *)x curveY:(double *)y;
- (void)offsetDoubleValuesAtTime:(id *)time deltaX:(double)x deltaY:(double)y options:(unsigned int)options;
- (void)ozChannel;
- (void)setDefaultCurveX:(double)x curveY:(double)y;
- (void)setDoubleValuesAtTime:(id *)time curveX:(double)x curveY:(double)y options:(unsigned int)options;
...
- (void)getDoubleValuesAtTime:(id *)time curveX:(double *)x curveY:(double *)y
{
  ...
  {
LABEL_3:
    *x = OZChannel::getCurveValue((v9 + 136), time, 0);
  }

LABEL_4:
  if (y)
  {
    *y = OZChannel::getCurveValue((v9 + 288), time, 0);
  }
}
...
- (void)setDoubleValuesAtTime:(id *)time curveX:(double)x curveY:(double)y options:(unsigned int)options
{
  ...
  *(OZCoreGlobals::getInstance(Instance) + 8) = optionsCopy & 1;
  ...
  (*(*v11 + 336))(v18, v11, time);
  v16 = v11[17];
  v15 = v11 + 17;
  (*(v16 + 712))(v15, v18, 0, x);
  v17 = (*(v15[19] + 712))(v15 + 19, v18, 0, y);
...
- (void)offsetDoubleValuesAtTime:(id *)time deltaX:(double)x deltaY:(double)y options:(unsigned int)options
{
  ...
  *(OZCoreGlobals::getInstance(Instance) + 8) = optionsCopy & 1;
  ...
  (*(*v11 + 336))(&v16, v11, time);
  v15 = OZChannel2D::setValueOffsetByBehaviors(v11, &v16, x, y);
