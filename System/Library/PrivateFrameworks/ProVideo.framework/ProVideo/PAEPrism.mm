...
- (BOOL)addParameters
{
  ...
  if (!v5)
  {
    ...
    [v3 addFloatSliderWithName:objc_msgSend(v8 parmId:"localizedStringForKey:value:table:" defaultValue:@"Prism::Amount" parameterMin:0 parameterMax:0) sliderMin:1 sliderMax:0 delta:7.0 parmFlags:{0.0, dbl_260343800[v7], 0.0, 32.0, 1.0}];
    [v3 addAngleSliderWithName:objc_msgSend(v8 parmId:"localizedStringForKey:value:table:" defaultValue:@"Prism::Angle" parameterMin:0 parameterMax:0) parmFlags:{2, 0, 0.0, 0.0, 6.28318531}];
    [v3 addToggleButtonWithName:objc_msgSend(v8 parmId:"localizedStringForKey:value:table:" defaultValue:@"Prism::Crop" parmFlags:{0, 0), 3, 0, 33}];
    [v3 addPointParameterWithName:objc_msgSend(v8 parmId:"localizedStringForKey:value:table:" defaultX:@"Prism::OSC Center" defaultY:0 parmFlags:{0), 4, 2, 0.5, 0.5}];
  }
  ...
  if (v9)
  {
    ...
    if ([(PAESharedDefaultBase *)self getRenderMode:info->var0.var1]&& imageType == 3)
    {
      ...
      else
      {
        ...
        HPrism::HPrism(v11);
        v12 = __sincos_stret(v19);
        v14.f64[0] = v20[2];
        v13.f64[0] = v20[1];
        v13.f64[1] = v20[5];
        v14.f64[1] = v20[6];
        v16 = vmulq_n_f64(vaddq_f64(vmulq_n_f64(v13, v12.__cosval), vmulq_n_f64(v14, v12.__sinval)), v20[0]);
        HPrism::init(v11, v16.f64);
        (*(*v11 + 120))(v11, 0, v17);
        *&v16.f64[0] = v11;
        (*(*v11 + 16))(v11);
        if (v18 == 1)
