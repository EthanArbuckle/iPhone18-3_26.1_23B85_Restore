...
- (__n128)doIntersectionFrom:(uint64_t)from lookingAt:(uint64_t)at scene:(void *)scene;
@end
...
- (__n128)doIntersectionFrom:(uint64_t)from lookingAt:(uint64_t)at scene:(void *)scene
{
  ...
  *v9.f32 = vmul_f32(*v9.f32, vrsqrts_f32(v10, vmul_f32(*v9.f32, *v9.f32)));
  ...
  v13 = vaddq_f32(self, v12);
  v11.i32[0] = self.i32[2];
  v12.i32[0] = self.i32[1];
  LODWORD(v14) = v13.i32[1];
  LODWORD(v15) = v13.i32[2];
  v16 = [rootNode hitTestWithSegmentFromPoint:v8 toPoint:*self.i64 options:{*v12.i64, *&v11, *v13.i64, v14, v15}];
  v37 = 0u;
  v38 = 0u;
  v39 = 0u;
  v40 = 0u;
