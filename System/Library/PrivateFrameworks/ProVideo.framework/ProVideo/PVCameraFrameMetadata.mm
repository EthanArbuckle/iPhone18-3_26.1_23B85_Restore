...
+ (id)frameMetadata:(int64_t)metadata :(id)a4 :(double)a5 :(int64_t)a6 :(int64_t)a7;
+ (id)frameMetadataWithAngle:(int64_t)angle :(id)a4 :(double)a5 :(int64_t)a6 :(double)a7;
...
- (id)description
{
  ...
  v4 = objc_opt_class();
  cameraPosition = [(PVCameraFrameMetadata *)self cameraPosition];
  ...
  v17 = [v3 stringWithFormat:@"<%@ %p> camPos: %ld | orientation: <%f %f %f %f> | rollRad: %f | AVCaptureVideoOrientation: %@ | interfaceOrientation: %ld", v4, self, cameraPosition, v7, v9, v11, v13, v15, v16, -[PVCameraFrameMetadata interfaceOrientation](self, "interfaceOrientation")];
