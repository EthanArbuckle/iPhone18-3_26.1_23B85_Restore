...
- (id)description
{
  ...
  dictionaryRepresentation = [(C2MPGenericEventMetric *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  if (value)
  {
    dictionaryRepresentation = [(C2MPGenericEventMetricValue *)value dictionaryRepresentation];
...
- (id)copyWithZone:(_NSZone *)zone
{
  ...
  v8 = [(C2MPGenericEventMetricValue *)self->_value copyWithZone:zone];
  v9 = v5[2];
  v5[2] = v8;
