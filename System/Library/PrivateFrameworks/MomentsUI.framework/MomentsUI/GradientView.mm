...
- (_TtC9MomentsUIP33_F25610CE9E90E29B6B7C67E2D8ADA9C612GradientView)initWithCoder:(id)a3;
- (_TtC9MomentsUIP33_F25610CE9E90E29B6B7C67E2D8ADA9C612GradientView)initWithFrame:(CGRect)a3;
- (void)layoutSubviews;
@end
...
- (_TtC9MomentsUIP33_F25610CE9E90E29B6B7C67E2D8ADA9C612GradientView)initWithFrame:(CGRect)a3
{
  ...
  *(&self->super.super.super.isa + OBJC_IVAR____TtC9MomentsUIP33_F25610CE9E90E29B6B7C67E2D8ADA9C612GradientView_gradient) = v9;
  ...
  v10 = v9;
  v11 = [(GradientView *)&v14 initWithFrame:x, y, width, height];
  v12 = [(GradientView *)v11 layer:v14.receiver];
  [v12 addSublayer_];
