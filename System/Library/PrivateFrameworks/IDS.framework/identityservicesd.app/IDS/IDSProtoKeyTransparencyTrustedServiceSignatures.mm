...
- (id)dictionaryRepresentation
{
  ...
  {
    v4 = [[NSMutableArray alloc] initWithCapacity:{-[NSMutableArray count](self->_serviceSignatures, "count")}];
    v12 = 0u;
    v13 = 0u;
    v14 = 0u;
    v15 = 0u;
  ...
  if (v5)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        [(IDSProtoKeyTransparencyTrustedServiceSignatures *)self addServiceSignatures:*(*(&v9 + 1) + 8 * v8), v9];
        v8 = v8 + 1;
      }
