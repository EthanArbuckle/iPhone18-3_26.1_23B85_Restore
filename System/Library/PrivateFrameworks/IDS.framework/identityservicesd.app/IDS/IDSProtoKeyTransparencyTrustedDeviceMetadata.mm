...
{
  v7.receiver = self;
  v7.super_class = IDSProtoKeyTransparencyTrustedDeviceMetadata;
  v3 = [(IDSProtoKeyTransparencyTrustedDeviceMetadata *)&v7 description];
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ((*&self->_has & 2) != 0)
  {
    if ((*(v4 + 20) & 2) == 0 || self->_status != *(v4 + 4))
    {
      goto LABEL_11;
    }
  }
