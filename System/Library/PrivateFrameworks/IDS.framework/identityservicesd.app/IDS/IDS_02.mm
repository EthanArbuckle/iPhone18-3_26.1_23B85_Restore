uint64_t sub_100051DC4(uint64_t a1)
{
  *a1 = 0;
  *(a1 + 8) = 0;
  *(a1 + 16) = 26;
...
uint64_t sub_100051E4C(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, unsigned int a12, int a13)
{
...
uint64_t sub_100051F54(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, unsigned int a12, uint64_t a13, uint64_t a14, uint64_t a15, uint64_t a16, int a17, int a18, char *a19)
{
  ...
  return sub_10008C134(v23, v24, v25, v26, v27, v28, v29, v30, a9, a10, a11, a12);
}

uint64_t sub_100052038(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, int a10, char a11, uint64_t a12, uint64_t a13, uint64_t a14, int a15, unsigned int a16, uint64_t a17, char *a18)
{
...
uint64_t sub_100052144@<X0>(char a1@<W8>)
{
...
uint64_t sub_100053030@<X0>(int a1@<W8>)
{
...
uint64_t sub_1000530A0@<X0>(uint64_t a1@<X8>)
{
  STACK[0x640] = 0;
  STACK[0x478] = 0;
  STACK[0x500] = *(v2 + 8 * v1);
  return sub_1000F79AC(a1);
}

uint64_t sub_100053130(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, unsigned int a12, int a13)
{
...
uint64_t sub_1000532C0(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, int a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, char a15)
{
  v16 = 6 * (a8 ^ 0xE76);
...
void sub_100053534(_DWORD *a1)
{
  ...
  v2 = *(&off_100BFFA10 + (v1 ^ 0x19E)) - 8;
  (*&v2[8 * (v1 + 9571)])(&v5);
  v4 = v6 != 33 && **(&off_100BFFA10 + (v1 | 0x16)) == 96;
  __asm { BRAA            X8, X17 }
}

uint64_t sub_1000536C0@<X0>(uint64_t a1@<X0>, uint64_t a2@<X1>, uint64_t a3@<X2>, int a4@<W8>)
{
  v5 = STACK[0x538];
...
uint64_t sub_100053710(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, char a13, uint64_t a14, int a15, unsigned int a16, uint64_t a17, char *a18, unsigned int a19, unsigned int a20)
{
...
uint64_t sub_1000537F4(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, char a16, uint64_t a17, uint64_t a18, char *a19, int a20, unsigned int a21)
{
...
uint64_t sub_1000538EC(uint64_t a1, uint64_t a2)
{
  v2 = STACK[0x3F8] - 8541;
...
uint64_t sub_100053978(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, char a11, uint64_t a12, uint64_t a13, uint64_t a14, char *a15, int a16, unsigned int a17)
{
  a15 = &a11;
...
uint64_t sub_100053BAC(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, char a12, uint64_t a13, unsigned int a14)
{
  a13 = a9;
  a14 = (v17 + v16) ^ (((489902743 - (&a12 | 0x1D335297) + (&a12 | 0xE2CCAD68)) ^ 0xBAA57E0A) * v15);
  v18 = (*(v14 + 8 * (v17 + v16 + 1266)))(&a12);
  return sub_100053C10(v18);
}

uint64_t sub_100053C10(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, char a12, uint64_t a13, unsigned int a14)
{
  a13 = a10;
  a14 = (v17 + v16) ^ (((2 * (&a12 & 0x2161CE8) - &a12 - 35003632) ^ 0xA5803072) * v15);
  v18 = (*(v14 + 8 * (v17 ^ 0x60293BE3)))(&a12);
  return sub_100053C74(v18);
}

uint64_t sub_100053CB8@<X0>(unsigned int a1@<W3>, __int16 a2@<W8>)
{
...
uint64_t sub_100053EE0(uint64_t a1, uint64_t a2, uint64_t a3, int a4, uint64_t a5, uint64_t a6, uint64_t a7, int a8)
{
...
uint64_t sub_100053FF8(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, char a14, uint64_t a15, char *a16, int a17, unsigned int a18)
{
...
uint64_t sub_100054090@<X0>(uint64_t a1@<X0>, int a2@<W1>, int a3@<W5>, unsigned int a4@<W8>)
{
  v11 = v7 + 32;
...
uint64_t sub_1000540D0@<X0>(int a1@<W8>, int8x16_t a2@<Q5>, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, uint64_t a16, uint64_t a17, uint64_t a18, uint64_t a19, uint64_t a20, uint64_t a21, int8x16_t *a22)
{
  v25 = (v23 + 908);
...
uint64_t sub_1000541C8(uint64_t a1)
{
  ...
  result = (**(&off_100BFFA10 + ((*a1 - v2) & 0x4881CA5C)))((*(a1 + 8) + v2) ^ 0x4BDB88A3AECF6862);
  *(a1 + 4) = (result ^ 0x67FF37FF) - 1728521264 + ((2 * result) & 0xCFFE6FFE);
  return result;
}

void sub_1000542AC(uint64_t a1, uint64_t a2)
{
  if (a1)
  {
    v2 = a2 == 0;
...
uint64_t sub_1000547D4@<X0>(uint64_t a1@<X8>)
{
  v8 = v5 - 1;
...
uint64_t sub_100054834@<X0>(int a1@<W8>)
{
  v2 = STACK[0x438];
  STACK[0x508] = *(v1 + 8 * a1);
...
uint64_t sub_10005485C@<X0>(uint64_t a1@<X0>, int a2@<W8>, uint64_t a3, uint64_t a4, uint64_t *a5)
{
  v6 = a2 - 5594;
  v7 = (a2 - 5699) | 0x1D0;
...
uint64_t sub_1000564E0@<X0>(__int16 a1@<W8>)
{
  v3 = STACK[0x880];
  STACK[0x638] = *(v2 + 8 * v1);
  return sub_100112120(v3, a1);
}

void sub_10005658C(uint64_t a1, uint64_t a2)
{
  if (a1)
  {
    v2 = a2 == 0;
...
uint64_t sub_100056754(unint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, uint64_t a16, uint64_t a17, uint64_t a18, uint64_t a19, uint64_t a20, uint64_t a21, uint64_t a22, uint64_t a23, uint64_t a24, uint64_t a25, uint64_t a26, uint64_t a27, uint64_t a28, uint64_t a29, uint64_t a30, uint64_t a31, uint64_t a32, uint64_t a33, uint64_t a34, uint64_t a35, uint64_t a36, uint64_t a37, uint64_t a38, uint64_t a39, uint64_t a40, uint64_t a41, uint64_t a42, uint64_t a43, uint64_t a44, uint64_t a45, uint64_t a46, uint64_t a47, uint64_t a48, uint64_t a49, uint64_t a50, uint64_t a51, uint64_t a52, uint64_t a53, uint64_t a54, uint64_t a55, uint64_t a56, uint64_t a57, uint64_t a58, uint64_t a59, uint64_t a60, uint64_t a61, uint64_t a62, uint64_t a63)
{
...
void sub_1000573E8()
{
  v0 = *(&off_100BFFA10 + ((-85 * ((dword_100CBC1F0 + dword_100CBC270) ^ 0xDF)) ^ byte_1009DB0B0[byte_1009D41D0[(-85 * ((dword_100CBC1F0 + dword_100CBC270) ^ 0xDF))] ^ 0x2A]) + 129);
  v1 = *(&off_100BFFA10 + (byte_1009DB0B8[(byte_1009D41D0[(-85 * ((dword_100CBC1F0 + *v0) ^ 0xDF))] ^ 0x2A) - 8] ^ (-85 * ((dword_100CBC1F0 + *v0) ^ 0xDF))) + 29);
  v2 = &v4[*v0 + *v1];
  ...
  *v1 = 2054362027 * (v2 ^ 0xB4207763EF64BDFLL);
  ...
  v3 = *(&off_100BFFA10 + ((-85 * ((dword_100CBC1F0 + dword_100CBC270) ^ 0xDF)) ^ byte_1009D3FD0[byte_1009C9A60[(-85 * ((dword_100CBC1F0 + dword_100CBC270) ^ 0xDF))] ^ 0xEE]) + 163) - 8;
  (*&v3[8 * (byte_1009C9D6C[(byte_1009E331C[v1 - 12] ^ 0x1F) - 12] ^ v1) + 76384])(v5);
  __asm { BRAA            X8, X17 }
}

uint64_t sub_10005764C(int a1, uint64_t a2, int a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, int a8)
{
...
uint64_t sub_100058BC0(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, int a10, char a11, uint64_t a12, int a13, char a14, uint64_t a15, int a16, unsigned int a17, uint64_t a18, char *a19)
{
...
uint64_t sub_100058D34@<X0>(uint64_t a1@<X2>, uint64_t a2@<X5>, uint64_t a3@<X6>, uint64_t a4@<X7>, int a5@<W8>, int8x16_t a6@<Q0>, int8x16_t a7@<Q1>, int64x2_t a8@<Q2>, int8x16_t a9@<Q3>, int64x2_t a10@<Q4>, int8x16_t a11@<Q5>, int8x16_t a12@<Q6>, int8x16_t a13@<Q7>, uint64_t a14, uint64_t a15, uint64_t a16, uint64_t a17, uint64_t a18, uint64_t a19, uint64_t a20, uint64_t a21, uint64_t a22, uint64_t a23, uint64_t a24, uint64_t a25, uint64_t a26, uint64_t a27, uint64_t a28, uint64_t a29, uint64_t a30, uint64_t a31, uint64_t a32, uint64_t a33, uint64_t a34, uint64_t a35, uint64_t a36, uint64_t a37, uint64_t a38, uint64_t a39, uint64_t a40, uint64_t a41, uint64_t a42, uint64_t a43, uint64_t a44, uint64_t a45, uint64_t a46, uint64_t a47, uint64_t a48, uint64_t a49, uint64_t a50, uint64_t a51, uint64_t a52, uint64_t a53, uint64_t a54, uint64_t a55, uint64_t a56, uint64_t a57, uint64_t a58, uint64_t a59, uint64_t a60, uint64_t a61, uint64_t a62, uint64_t a63)
{
  v77 = a1 - 8;
  v78.i64[0] = a3 + v77 + 11;
  v78.i64[1] = a3 + v77 + 10;
...
uint64_t sub_100058EA8(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, char a11, uint64_t a12, uint64_t a13, char *a14, int a15, unsigned int a16)
{
  a14 = &a11;
...
uint64_t sub_100058F2C@<X0>(uint64_t a1@<X0>, uint64_t a2@<X1>, uint64_t a3@<X2>, int a4@<W8>, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, uint64_t a16, int a17)
{
...
uint64_t sub_100059140(int a1, uint64_t a2, uint64_t a3, unint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, uint64_t a16, uint64_t a17, uint64_t a18, uint64_t a19, uint64_t a20, uint64_t a21, uint64_t a22, uint64_t a23, uint64_t a24, uint64_t a25, uint64_t a26, uint64_t a27, uint64_t a28, uint64_t a29, uint64_t a30, uint64_t a31, uint64_t a32, uint64_t a33, uint64_t a34, uint64_t a35, uint64_t a36, uint64_t a37, uint64_t a38, uint64_t a39, uint64_t a40, uint64_t a41, uint64_t a42, uint64_t a43, uint64_t a44, uint64_t a45, uint64_t a46, uint64_t a47, uint64_t a48, uint64_t a49, uint64_t a50, uint64_t a51, uint64_t a52, uint64_t a53, uint64_t a54, uint64_t a55, uint64_t a56, uint64_t a57, uint64_t a58, uint64_t a59, uint64_t a60, uint64_t a61, uint64_t a62, uint64_t a63)
{
  v71 = a1 - 5430;
...
uint64_t sub_100059DD0@<X0>(uint64_t a1@<X8>)
{
...
uint64_t sub_10005A00C(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, char a10, uint64_t a11, char *a12, int a13, unsigned int a14)
{
  a12 = &a10;
...
uint64_t sub_10005A118(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, int a10, int a11, int a12, uint64_t a13, uint64_t a14)
{
...
uint64_t sub_10005A2A8@<X0>(uint64_t a1@<X0>, uint64_t a2@<X8>)
{
...
uint64_t sub_10005A300@<X0>(uint64_t a1@<X2>, uint64_t a2@<X3>, int a3@<W8>)
{
...
uint64_t sub_10005A484@<X0>(int a1@<W8>)
{
  v2 = a1 + 5738;
  (*(v1 + 8 * (a1 ^ 0x2BD7)))();
...
void sub_10005A730(uint64_t a1)
{
  ...
  v2 = *(a1 + 8);
  v3 = *(&off_100BFFA10 + v1 - 3084) - 8;
  (*&v3[8 * v1 + 50224])(*(&off_100BFFA10 + v1 - 3232), sub_1000D3B58);
  __asm { BRAA            X10, X17 }
}

uint64_t sub_10005A818(uint64_t a1, uint64_t a2, uint64_t a3, _DWORD *a4)
{
  v8 = (v4 - 4941) ^ 0xE8B;
  *v6 = a1;
  *a4 = v11;
...
uint64_t sub_10005A93C@<X0>(uint64_t a1@<X0>, uint64_t a2@<X8>)
{
  v5 = (v3 - 1565510552);
  v6 = *(a2 + v5 - 7062 + v2 - 31);
  v7 = a1 + v5 - 7062 + v2;
...
uint64_t sub_10005AA08(uint64_t result)
{
...
uint64_t sub_10005ABA0(int a1, int a2, int a3, uint64_t a4, uint64_t a5, int a6)
{
...
_DWORD *sub_10005AD30(uint64_t a1)
{
  v1 = 1824088897 * ((a1 + 988125058 - 2 * (a1 & 0x3AE59782)) ^ 0x628C44E0);
  v2 = *(a1 + 20) + v1;
  v3 = *(a1 + 24) + v1;
  v4 = *(a1 + 32);
  v5 = *(&off_100BFFA10 + (v2 ^ 0x2C5EF54B)) - 8;
  if (v3 == 1461241532)
  {
    __asm { BRAA            X12, X17 }
  }
  ...
  return sub_1000A96C0(a1, 16215968);
}

uint64_t sub_10005AFD0(uint64_t a1, uint64_t a2)
{
  LOWORD(STACK[0x9FE]) = v2;
  LODWORD(STACK[0x380]) = v2;
  return sub_100162C60(a1, a2, v3 - 8549);
}

uint64_t sub_10005AFEC@<X0>(int a1@<W5>, int a2@<W6>, int a3@<W8>)
{
...
uint64_t sub_10005F908(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, int a12, unsigned int a13, uint64_t a14, uint64_t *a15, unsigned int a16, unsigned int a17)
{
...
uint64_t sub_10005F9DC(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, int a14, uint64_t a15, uint64_t a16, int a17)
{
...
uint64_t sub_10005FAC8(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, char a11, uint64_t a12, uint64_t a13, char *a14, int a15, unsigned int a16)
{
  a14 = &a11;
...
void sub_10005FB5C(unsigned int a1@<W8>)
{
  ...
  JUMPOUT(0x100060A1CLL);
}

uint64_t sub_100060AD8(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, int a9, char a10, __int16 a11, char a12, int a13, char a14, char *a15, char *a16, uint64_t a17, unsigned int a18, int a19)
{
...
uint64_t sub_100060C0C(uint64_t a1)
{
...
void sub_100060E64(uint64_t a1)
{
  v2 = *(&off_100BFFA10 + ((-85 * (dword_100CBBED0 ^ 0xDF ^ dword_100CBC1F0)) ^ byte_1009D3FD0[byte_1009C9A60[(-85 * (dword_100CBBED0 ^ 0xDF ^ dword_100CBC1F0))] ^ 0x21]) + 84);
  v3 = -85 * (*v2 ^ dword_100CBC1F0 ^ 0xDF);
  v4 = *(&off_100BFFA10 + (byte_1009C9B60[byte_1009E3218[v3 - 8] ^ 0xDD] ^ v3) - 42);
  v5 = (*v4 ^ *v2) - &v9;
  ...
  *v4 = v7;
  LODWORD(v4) = *v2;
  v8 = *(&off_100BFFA10 + ((-85 * ((dword_100CBC1F0 - dword_100CBBED0) ^ 0xDF)) ^ byte_1009C9D60[byte_1009E3310[(-85 * ((dword_100CBC1F0 - dword_100CBBED0) ^ 0xDF))] ^ 0x71]) + 120) - 8;
  (*&v8[8 * (byte_1009D3FDC[(byte_1009C9A60[(-85 * ((v7 + v4) ^ 0xDF))] ^ 0xEE) - 12] ^ (-85 * ((v7 + v4) ^ 0xDF))) + 76200])(*(&off_100BFFA10 + (byte_1009C9D6C[(byte_1009E331C[(-85 * (v4 ^ 0xDF ^ v7)) - 12] ^ 0xE9) - 12] ^ (-85 * (v4 ^ 0xDF ^ v7))) - 13), sub_1000D3B58);
  __asm { BRAA            X9, X17 }
}

uint64_t sub_100061058@<X0>(int a1@<W8>)
{
  v5 = a1 - 1201;
  v6 = (*(v3 + 8 * (a1 + 7123)))(v4);
  if (v1)
...
uint64_t sub_100061140(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, unsigned int a16, int a17)
{
...
uint64_t sub_100061224@<X0>(uint64_t a1@<X0>, uint64_t a2@<X1>, uint64_t a3@<X2>, uint64_t a4@<X4>, char a5@<W8>)
{
  v10 = STACK[0x270];
  v11 = *STACK[0x300] + 6;
...
uint64_t sub_100061DCC@<X0>(int a1@<W0>, int a2@<W1>, int a3@<W2>, __int16 a4@<W8>)
{
  v9 = 2493 * (v5 ^ 0x1392);
  v10 = ((v9 ^ 0x1375) & v4) + 19;
  ...
  *(&STACK[0x6E0] + v39) = v40;
  ...
  v43 = (*(*(&off_100BFFA10 + (v9 ^ 0x121B)) + (353 * (v42 ^ 0xBF) + 6354 - 944 * ((4549754 * (353 * (v42 ^ 0xBFu) + 6354)) >> 32)) - 4) ^ v42 ^ 0x81 ^ ((v42 ^ 0x81) + 116) ^ 0x4D) * a1;
  *(STACK[0x5A0] + (70942 - 73 * a3)) = *(STACK[0x5A0] + ((v43 + 3002) & 0xFFFEu) % ((((v43 + 3002) & 0x2BCA) + ((13381 - v43) & 0x2BCB)) & 0x47CDu));
  return (*(v7 + 8 * (v9 ^ 0xEA)))();
}

uint64_t sub_1000623D0@<X0>(uint64_t a1@<X0>, uint64_t a2@<X8>)
{
  v5 = v2 - 1;
  *(a1 + v5) = *(a2 + v5);
...
uint64_t sub_100062670@<X0>(uint64_t a1@<X0>, uint64_t a2@<X1>, int a3@<W2>, uint64_t a4@<X8>)
{
  v11 = v8 + 32;
  v12 = (((v7 + v6) + a2) ^ v11) + v5;
  v13 = *(a4 + v12 - 15);
...
uint64_t sub_100062678@<X0>(uint64_t a1@<X0>, uint64_t a2@<X8>)
{
  v6 = v3 - 1;
  *(a1 + v6) = *(a2 + v6);
...
uint64_t sub_10006269C(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13)
{
  v16 = v13 ^ 0x1E31;
...
uint64_t sub_10006281C@<X0>(uint64_t a1@<X0>, int a2@<W8>)
{
  v3 = a2 - 2915;
...
uint64_t sub_100062880(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, uint64_t a16, uint64_t a17, uint64_t a18, uint64_t a19, uint64_t a20, uint64_t a21, unsigned int a22, uint64_t a23, uint64_t a24)
{
...
uint64_t sub_100062ABC(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, int a15, int a16, unint64_t a17, uint64_t a18, uint64_t a19)
{
...
uint64_t sub_100062C24@<X0>(uint64_t a1@<X8>)
{
  v4 = *(a1 + 40 * v1 + 28);
  switch(v4)
  {
...
uint64_t sub_100062D84(void *a1)
{
  *a1 = 0;
  a1[1] = 0;
  *v1 = a1;
...
void sub_100062DC0(uint64_t a1, uint64_t a2, uint64_t a3, int a4)
{
...
uint64_t sub_1000643D8@<X0>(uint64_t a1@<X0>, uint64_t a2@<X8>)
{
...
uint64_t sub_100064464(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, int a12, char a13, uint64_t a14, uint64_t a15, uint64_t a16, int a17, unsigned int a18, uint64_t a19, char *a20)
{
  v23 = v20 ^ 0x17D3;
...
void sub_10006460C(uint64_t a1)
{
  v1 = *(a1 + 12) - 956911519 * ((((2 * a1) | 0xF065BBFC) - a1 - 2016599550) ^ 0x92A3ADFB);
  __asm { BRAA            X10, X17 }
}

uint64_t sub_100064718(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, char a13, uint64_t a14, unsigned int a15)
{
  a14 = a12;
  a15 = (v15 + 3198) ^ (1824088897 * ((((2 * &a13) | 0x1A25E81C) - &a13 + 1928137714) ^ 0xD57B276C));
  v17 = (*(v16 + 8 * (v15 ^ 0x3190)))(&a13);
  return sub_100064784(v17);
}

uint64_t sub_100064784(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, char a13, uint64_t a14, unsigned int a15)
{
  a14 = a10;
  a15 = (v17 + 6171) ^ (((&a13 & 0xA595133C | ~(&a13 | 0xA595133C)) ^ 0x2033FA1) * v15);
  v18 = (*(v16 + 8 * (v17 + 7437)))(&a13);
  return sub_1000647E4(v18);
}
...
uint64_t sub_10006487C@<X0>(uint64_t a1@<X0>, int a2@<W1>, void *a3@<X8>)
{
...
uint64_t sub_100064B58@<X0>(uint64_t a1@<X0>, uint64_t a2@<X8>)
{
  v8 = (v5 ^ v3) + v4;
  *(a1 + v8) = *(a2 + v8);
...
uint64_t sub_100064B80@<X0>(int a1@<W8>)
{
  (*(v2 + 8 * (a1 ^ 0x3BB7)))();
  *(v1 + 24) = 0;
  return sub_1000D38E8();
}

uint64_t sub_100064CE4(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, uint64_t a16, uint64_t a17, uint64_t a18, uint64_t a19, uint64_t a20, uint64_t a21, uint64_t a22, uint64_t a23, uint64_t a24, uint64_t a25, uint64_t a26, uint64_t a27, uint64_t a28, uint64_t a29, uint64_t a30, uint64_t a31, uint64_t a32, uint64_t a33, uint64_t a34, uint64_t a35, uint64_t a36, uint64_t a37, uint64_t a38, uint64_t a39, uint64_t a40, uint64_t a41, uint64_t a42, uint64_t a43, uint64_t a44, uint64_t a45, uint64_t a46, uint64_t a47, uint64_t a48, uint64_t a49, uint64_t a50, uint64_t a51, int a52, int a53, uint64_t a54, uint64_t a55, uint64_t a56, uint64_t a57, uint64_t a58, uint64_t a59, uint64_t a60, uint64_t a61, uint64_t a62, uint64_t a63)
{
...
uint64_t sub_100064DB8@<X0>(uint64_t a1@<X8>)
{
  STACK[0x680] = 0;
  STACK[0x7B0] = 0;
  STACK[0x500] = *(v2 + 8 * v1);
...
uint64_t sub_100064DE4@<X0>(uint64_t a1@<X8>)
{
  STACK[0x718] = 0;
  STACK[0x3F0] = 0;
  STACK[0x500] = *(v2 + 8 * v1);
...
uint64_t sub_100064F40(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, uint64_t a16, uint64_t a17, uint64_t a18, uint64_t a19, uint64_t a20, uint64_t a21, uint64_t a22, uint64_t a23, uint64_t a24, uint64_t a25, uint64_t a26, uint64_t a27, uint64_t a28, uint64_t a29, uint64_t a30, uint64_t a31, uint64_t a32, uint64_t a33, uint64_t a34, uint64_t a35, uint64_t a36, uint64_t a37, uint64_t a38, uint64_t a39, uint64_t a40, uint64_t a41, uint64_t a42, uint64_t a43, uint64_t a44, uint64_t a45, uint64_t a46, uint64_t a47, uint64_t a48, uint64_t a49, uint64_t a50, uint64_t a51, uint64_t a52, uint64_t a53, uint64_t a54, uint64_t a55, uint64_t a56, uint64_t a57, uint64_t a58, uint64_t a59, uint64_t a60, uint64_t a61, uint64_t a62, uint64_t a63)
{
  v72 = STACK[0x360];
...
uint64_t sub_10006523C@<X0>(uint64_t a1@<X0>, int a2@<W8>)
{
  v3 = a2 + 2984;
...
uint64_t sub_100065434(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, unsigned int a15, int a16)
{
...
uint64_t sub_100065500@<X0>(int a1@<W8>)
{
  v2 = a1 ^ 0x1C;
  v3 = (2 * (a1 ^ 0x1C)) ^ 0x28B2;
  STACK[0xAB8] = v1;
...
uint64_t sub_100065548(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, unsigned int a5, uint64_t a6, int a7)
{
  v12 = v8 + 8;
...
uint64_t sub_1000655EC(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, int a10, char a11, uint64_t a12, int a13, char a14, uint64_t a15, char a16, int a17, int a18, unsigned int a19, uint64_t a20, char *a21, unsigned int a22, char *a23)
{
  a23 = &a14;
...
uint64_t sub_100065764@<X0>(int a1@<W3>, unint64_t a2@<X8>)
{
...
LABEL_6:
  ...
  if (a1 == 16257999)
  {
    ...
    else
    {
      ...
      return sub_10011C584((v11 - 8474) ^ 0x2352);
    }
  }
...
uint64_t sub_100065B2C(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, int a11, char a12, uint64_t a13, char a14, int a15, int a16, char a17, int a18, unsigned int a19, uint64_t a20, char *a21, unsigned int a22, char *a23)
{
  v26 = v23 + 1369;
...
uint64_t sub_100065DE4(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, int a14)
{
  *(v16 + 24) = 107;
  *(v16 + 40) = 0;
  v18 = (*(v17 + 8 * ((v15 + 531) ^ 0x3747)))(v14);
  return sub_1000E1B18(v18, v19, v20, v21, v22, v23, v24, v25, a9, a10, a11, a12, a13, a14);
}

uint64_t sub_100065E94(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, uint64_t a16, uint64_t a17, uint64_t a18, uint64_t a19, uint64_t a20, char a21, int a22, unsigned int a23, uint64_t a24)
{
...
uint64_t sub_100065FFC@<X0>(int a1@<W8>)
{
  v2 = *(STACK[0x610] + 24);
  STACK[0x7E0] = v2;
...
uint64_t sub_100066178(uint64_t a1)
{
  STACK[0x5B0] = v1;
...
uint64_t sub_1000662DC(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, unsigned int a12, int a13)
{
...
uint64_t sub_100066494(uint64_t a1, uint64_t a2, uint64_t a3, char a4, uint64_t a5, int a6)
{
  v12 = v7 - 1;
...
uint64_t sub_100066628(uint64_t a1, uint64_t a2, unint64_t a3, uint64_t a4, int a5, int a6, int a7, int a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, uint64_t a16, uint64_t a17, uint64_t a18, uint64_t a19, uint64_t a20, uint64_t a21, uint64_t a22, uint64_t a23, uint64_t a24, uint64_t a25, uint64_t a26, uint64_t a27, uint64_t a28, uint64_t a29, uint64_t a30, uint64_t a31, uint64_t a32, uint64_t a33, uint64_t a34, uint64_t a35, int a36, int a37, int a38, int a39, int a40, int a41, int a42, int a43, int a44, int a45, int a46, int a47, int a48, int a49, int a50, int a51, int a52, unsigned __int8 a53, unsigned int a54, int a55, unsigned int a56, uint64_t a57, uint64_t a58, _BYTE *a59, uint64_t a60)
{
  ...
  *&v546 = __ROR8__(v567, 8);
  ...
  v573 = v69;
  v574 = *(&off_100BFFA10 + (v69 ^ 0xB6D)) - 4;
...
uint64_t sub_100069FC8@<X0>(_DWORD *a1@<X3>, int a2@<W8>, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, unsigned int a11, int a12)
{
  *a1 = 0;
  v14 = v13 + a2;
...
uint64_t sub_10006A638(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, int a14, unint64_t a15, uint64_t a16, int a17)
{
...
uint64_t sub_10006A81C@<X0>(uint64_t a1@<X0>, uint64_t a2@<X8>)
{
...
uint64_t sub_10006A870@<X0>(int a1@<W8>)
{
  STACK[0xBA0] = v1;
  v2 = STACK[0x968];
...
uint64_t sub_10006A8D8(uint64_t a1, uint64_t a2, uint64_t a3)
{
  v4 = STACK[0x680];
...
uint64_t sub_10006AD54(uint64_t a1, int8x16_t a2, int8x16_t a3, int64x2_t a4, int8x16_t a5, int64x2_t a6, int8x16_t a7, int8x16_t a8, int8x16_t a9, uint64_t a10, unsigned int a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, int a16)
{
  v27 = v17 - 16;
  v28.i64[0] = v27 + a1 - 5;
  v28.i64[1] = v27 + a1 - 6;
...
uint64_t sub_10006AD64(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, char a12, uint64_t a13, uint64_t a14, char *a15, int a16, unsigned int a17)
{
  a15 = &a12;
...
uint64_t sub_10006AFA0(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, char a11, uint64_t a12, uint64_t a13, char *a14, int a15, unsigned int a16)
{
  a14 = &a11;
...
uint64_t sub_10006B0E0(void *a1)
{
  *a1 = 0;
  a1[1] = 0;
...
uint64_t sub_10006B140@<X0>(uint64_t a1@<X0>, uint64_t a2@<X8>)
{
  v6 = (a1 + v2 - 16);
  v7 = (a2 + v2 - 16);
  v8 = *v7;
...
uint64_t sub_10006B498(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t *a10, int a11, uint64_t a12, int a13, unsigned int a14)
{
...
void sub_10006B58C(int a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, int a10, char a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, uint64_t a16, uint64_t a17, unsigned int a18, int a19, char *a20)
{
  ...
  JUMPOUT(0x10006B62CLL);
}

uint64_t sub_10006B670(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9)
{
  v12 = v9 - 1;
  a9 = v12;
...
uint64_t sub_10006B6C8(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, void *a5, _DWORD *a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, uint64_t a16, uint64_t a17, uint64_t a18, uint64_t a19, uint64_t a20, unsigned int a21, int a22)
{
  *a5 = 0;
  *a6 = 0;
...
uint64_t sub_10006B784@<X0>(int a1@<W8>, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, char a6)
{
  v9 = a1 - 7070;
...
uint64_t sub_10006B834@<X0>(unsigned int a1@<W8>, uint64_t a2, uint64_t a3, int a4)
{
  if (v6)
  {
...
uint64_t sub_10006B9C0(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, unsigned int a15, int a16, unsigned int a17, uint64_t a18, uint64_t a19)
{
...
uint64_t sub_10006BB08(uint64_t a1)
{
  *v3 = a1;
  *v2 = v8;
...
uint64_t sub_10006C74C()
{
  ...
  return sub_100163E9C(0x435B154A729201BFLL, 0xEAD4E3DB691550A9, 0x126AA61F6F56C0D8, v2, 0x5F83E4240040270ALL, 83, 0x5EA5347A8335DC6CLL, 0x5963B6C555D97F1FLL);
}
...
uint64_t sub_10006D8B0(uint64_t a1)
{
  *a1 = 0;
  *(a1 + 8) = 0;
...
uint64_t sub_10006D988@<X0>(int a1@<W8>)
{
  result = (*(v1 + 8 * (a1 + 6244)))();
  *(v3 + 4) = v4;
  return result;
...
void sub_10006DA24(uint64_t a1)
{
  v1 = *(a1 + 8) + 869295389 * ((a1 & 0x846F91CA | ~(a1 | 0x846F91CA)) ^ 0xCAC44266);
  v2 = *(&off_100BFFA10 + v1 - 1545) - 8;
...
uint64_t sub_10006DC40(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, char a12, uint64_t a13, uint64_t a14, uint64_t a15, uint64_t a16, char *a17, int a18, unsigned int a19)
{
...
uint64_t sub_10006DD4C@<X0>(uint64_t a1@<X1>, int a2@<W2>, uint64_t a3@<X8>)
{
...
void sub_10006DF1C(uint64_t a1, uint64_t a2, uint64_t a3, unint64_t a4)
{
  STACK[0x918] = a4;
  v4 = STACK[0x868];
  *(v4 + 112) = 197499219;
  ...
  *(v4 + 108) = 0;
  *(v4 + 104) = 0;
  JUMPOUT(0x10005054CLL);
}

uint64_t sub_10006DF3C(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, void *a9, uint64_t a10, _DWORD *a11)
{
  *a9 = a1;
  *a11 = v12;
...
uint64_t sub_10006E53C@<X0>(int a1@<W8>)
{
  ...
  *&STACK[0x200] = vdupq_n_s64(v1);
  return sub_100197CF4(2021819248, 1070421257, (a1 & 0x1D8E53DFu) + 4287);
}

void sub_10006E7B0(uint64_t a1@<X6>, char a2@<W8>, uint64_t a3, unint64_t a4)
{
  v4 = *(a1 + 24);
...
uint64_t sub_10006F934(uint64_t a1, uint64_t a2, uint64_t a3)
{
...
uint64_t sub_10006FB58(int a1, uint64_t a2, int a3, int a4, int a5, int a6)
{
...
void sub_1000702A8(uint64_t a1)
{
...
uint64_t sub_100070374()
{
  (*(v1 + 8 * (v0 + 144)))();
  STACK[0x688] = 0;
  return sub_1000AA2E4();
}

_DWORD *sub_100070488@<X0>(_DWORD *result@<X0>, int a2@<W8>)
{
  *(v2 + 24) = a2;
  *result = 16215812;
  return result;
...
void sub_1000704E0()
{
  v0 = *(&off_100BFFA10 + ((-85 * ((dword_100CBC1F0 + dword_100CBC0D0) ^ 0xDF)) ^ byte_1009DAFB0[byte_1009D40D0[(-85 * ((dword_100CBC1F0 + dword_100CBC0D0) ^ 0xDF))] ^ 0x67]) + 29);
  v1 = *(v0 - 4);
  ...
  *v2 = 2054362027 * (v3 ^ 0xB4207763EF64BDFLL);
  ...
  v4 = *(&off_100BFFA10 + ((-85 * ((dword_100CBC1F0 + dword_100CBC0D0) ^ 0xDF)) ^ byte_1009D3FD0[byte_1009C9A60[(-85 * ((dword_100CBC1F0 + dword_100CBC0D0) ^ 0xDF))] ^ 0xEE]) + 163) - 8;
...
void sub_100070754(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, int a14, int a15, char a16, uint64_t a17, unsigned int a18)
{
  *v20 = a1;
  *v19 = a15;
...
void sub_100070878()
{
  v0 = *(&off_100BFFA10 + ((-85 * ((dword_100CBC1F0 - dword_100CBBEA0) ^ 0xDF)) ^ byte_1009C9B60[byte_1009E3210[(-85 * ((dword_100CBC1F0 - dword_100CBBEA0) ^ 0xDF))] ^ 0xDD]) - 82);
  v1 = -85 * ((dword_100CBC1F0 + *v0) ^ 0xDF);
  v2 = *(&off_100BFFA10 + (byte_1009DAFB8[(byte_1009D40D8[v1 - 8] ^ 0x6D) - 8] ^ v1) + 184);
  v3 = &v5[*v2 ^ *v0];
  ...
  *v2 = 2054362027 * (v3 ^ 0xB4207763EF64BDFLL);
  ...
  v4 = *(&off_100BFFA10 + ((-85 * ((dword_100CBC1F0 - dword_100CBBEA0) ^ 0xDF)) ^ byte_1009DAFB0[byte_1009D40D0[(-85 * ((dword_100CBC1F0 - dword_100CBBEA0) ^ 0xDF))] ^ 0x6D]) + 262) - 8;
  (*&v4[8 * (byte_1009C9D6C[(byte_1009E331C[v0 - 12] ^ 0xE2) - 12] ^ v0) + 76848])(v6);
  __asm { BRAA            X8, X17 }
}

uint64_t sub_100070AD4(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, char a15, uint64_t a16, unsigned int a17)
{
  a17 = (v18 + 6822) ^ (1824088897 * ((((2 * &a15) | 0x32C017CE) - &a15 - 425724903) ^ 0x4109D885));
  a16 = a11;
  v19 = (*(v17 + 8 * (v18 + 8088)))(&a15);
  return sub_1000E7F50(v19);
}

uint64_t sub_100070AE0(uint64_t a1)
{
...
uint64_t sub_100070B8C(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, char a12, uint64_t a13, unsigned int a14)
{
  a14 = (v16 + 4610) ^ (((1784851517 - (&a12 | 0x6A62AC3D) + (&a12 | 0x959D53C2)) ^ 0xCDF480A0) * v14);
  a13 = a9;
  v17 = (*(v15 + 8 * (v16 + 5876)))(&a12);
  return sub_100070C00(v17);
}
...
void sub_100070C98(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6)
{
  if (a3)
  {
    v6 = a6 == 0;
...
uint64_t sub_100070F18(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, int a15, unsigned int a16, int a17, uint64_t a18, uint64_t a19)
{
...
uint64_t sub_100071110(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, char a12, uint64_t a13, uint64_t a14, char *a15, int a16, unsigned int a17)
{
  a15 = &a12;
...
uint64_t sub_1000711B8@<X0>(uint64_t a1@<X5>, uint64_t a2@<X6>, int a3@<W8>, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, uint64_t a16, uint64_t a17, uint64_t a18, uint64_t a19, uint64_t a20, uint64_t a21, uint64_t a22, uint64_t a23, uint64_t a24, void *a25, uint64_t a26, uint64_t a27, uint64_t a28, uint64_t a29, uint64_t a30, uint64_t a31, uint64_t a32, uint64_t a33, uint64_t a34, uint64_t a35, uint64_t a36, uint64_t a37, uint64_t a38, uint64_t a39, uint64_t a40, uint64_t a41, uint64_t a42, uint64_t a43, uint64_t a44, uint64_t a45, uint64_t a46, uint64_t a47, uint64_t a48, uint64_t a49, uint64_t a50, uint64_t a51, uint64_t a52, uint64_t a53, uint64_t a54, uint64_t a55, uint64_t a56, uint64_t a57, uint64_t a58, uint64_t a59, unint64_t a60)
{
  ...
  return sub_1000D8230(0x9508DCB2F33ECE2BLL, 0x5963B6C555D97F1FLL, 0x2A11B965E67D9C56, a3 + 349, a60, a1, a2, STACK[0x2BC], a4, a5, a6, a7, a8, a9, a10, a11, a12, a13, a14, a15, a16, a17, a18, a19, a20, a21, a22, a23, a24, a25);
}

uint64_t sub_100072120()
{
...
uint64_t sub_10007215C(uint64_t a1, int a2, uint64_t a3)
{
  v7 = *(v4 + a3 + 16);
  v8 = (v5 + a3);
  *(v8 - 1) = *(v4 + a3);
...
uint64_t sub_100072190(int8x16_t a1, int8x16_t a2, int64x2_t a3, int8x16_t a4, int8x16_t a5, int8x16_t a6, int8x16_t a7, int8x16_t a8, uint64_t a9, uint64_t a10, int a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, uint64_t a16)
{
  v26 = a10 - 16;
...
uint64_t sub_100072198@<X0>(int a1@<W8>, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, int a11, int a12)
{
  v14 = a1 - 5502;
  if (v12)
  {
...
uint64_t sub_100072278@<X0>(int a1@<W8>)
{
  v2 = a1 + 8431;
  v3 = STACK[0x730];
  v4 = STACK[0x924];
...
uint64_t sub_1000724A0@<X0>(int a1@<W8>)
{
...
void sub_100072600(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7)
{
  if (a6)
  {
    v7 = a7 == 0;
...
uint64_t sub_10007286C()
{
  ...
  return sub_1000F79AC(v2);
}

uint64_t sub_1000728AC@<X0>(int a1@<W8>)
{
  ...
  *(v1 + 112) = *(v2 - 232) ^ (v4 - 1232140833);
  return sub_1000AFAB4(v4 - 8669);
}

uint64_t sub_1000729E0@<X0>(uint64_t a1@<X0>, char a2@<W8>)
{
  v8 = (v2 ^ v4 ^ v5) + v3;
  STACK[0xA30] = v8;
  *(a1 + v8) = ((a2 + 1) ^ v6) * (a2 + 18);
...
uint64_t sub_100072A28(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, int a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, uint64_t a16, uint64_t a17, uint64_t a18, uint64_t a19, uint64_t a20, uint64_t a21, uint64_t a22, uint64_t a23, uint64_t a24, uint64_t a25, uint64_t a26, uint64_t a27, uint64_t a28, uint64_t a29, uint64_t a30, uint64_t a31, uint64_t a32, uint64_t a33, uint64_t a34, uint64_t a35, uint64_t a36, uint64_t a37, uint64_t a38, uint64_t a39, uint64_t a40, uint64_t a41, uint64_t a42, uint64_t a43, uint64_t a44, uint64_t a45, uint64_t a46, uint64_t a47, uint64_t a48, uint64_t a49, uint64_t a50, uint64_t a51, uint64_t a52, uint64_t a53)
{
  v55 = (a7 - 4584);
...
uint64_t sub_100072B70@<X0>(int a1@<W8>)
{
  v2 = STACK[0x508];
  STACK[0x478] = *(v1 + 8 * a1);
  return sub_1000D2F40(v2);
...
void sub_100072C9C(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7)
{
  if (a4)
  {
    v7 = a7 == 0;
...
uint64_t sub_100072DE4(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, _DWORD *a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, uint64_t a16, uint64_t a17, uint64_t a18, unsigned int a19, int a20)
{
  *a5 = 0;
...
uint64_t sub_100072F40(uint64_t a1, unint64_t a2)
{
  ...
  *&STACK[0x2C0] = vdupq_n_s64(0xAB3042D228875C41);
  return sub_1000417D8();
}

uint64_t sub_100073250@<X0>(uint64_t a1@<X4>, uint64_t a2@<X5>, uint64_t a3@<X8>, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, uint64_t a16, uint64_t a17, uint64_t a18, uint64_t a19, uint64_t a20, uint64_t a21, uint64_t a22, uint64_t a23, uint64_t a24, uint64_t a25, uint64_t a26, uint64_t a27, uint64_t a28, uint64_t a29, uint64_t a30, uint64_t a31, uint64_t a32, uint64_t a33, uint64_t a34, uint64_t a35, uint64_t a36, uint64_t a37, uint64_t a38, uint64_t a39, uint64_t a40, uint64_t a41, uint64_t a42, uint64_t a43, uint64_t a44, uint64_t a45, uint64_t a46, uint64_t a47, uint64_t a48, uint64_t a49, uint64_t a50, uint64_t a51, uint64_t a52, uint64_t a53, uint64_t a54, uint64_t a55, uint64_t a56, uint64_t a57, uint64_t a58, uint64_t a59, uint64_t a60, uint64_t a61, uint64_t a62)
{
  STACK[0x2B0] = v65;
...
uint64_t sub_1000738D0@<X0>(int a1@<W8>)
{
  (*(v3 + 8 * (a1 ^ v1)))();
  *(v2 + 24) = 0;
  return sub_100044DFC();
}

void sub_100073934()
{
  v0 = *(&off_100BFFA10 + ((-85 * ((dword_100CBC1F0 + dword_100CBC260) ^ 0xDF)) ^ byte_1009D42D0[byte_1009C9C60[(-85 * ((dword_100CBC1F0 + dword_100CBC260) ^ 0xDF))] ^ 0x80]) + 102);
  v1 = -85 * ((dword_100CBC1F0 + *v0) ^ 0xDF);
  v2 = *(&off_100BFFA10 + (byte_1009DAFB8[(byte_1009D40D8[v1 - 8] ^ 0x6D) - 8] ^ v1) + 184);
  v3 = *v2 - *v0 - &v5;
  *v0 = (2054362027 * v3) ^ 0xB4207763EF64BDFLL;
  *v2 = 2054362027 * (v3 ^ 0xB4207763EF64BDFLL);
  ...
  v4 = *(&off_100BFFA10 + ((-85 * (dword_100CBC260 ^ 0xDF ^ dword_100CBC1F0)) ^ byte_1009D3FD0[byte_1009C9A60[(-85 * (dword_100CBC260 ^ 0xDF ^ dword_100CBC1F0))] ^ 0x21]) + 150) - 8;
  (*&v4[8 * (byte_1009DB0B8[(byte_1009D41D0[v2] ^ 0x2A) - 8] ^ v2) + 75712])(v6);
  __asm { BRAA            X8, X17 }
}

uint64_t sub_100073C20@<X0>(unsigned __int16 a1@<W8>)
{
...
void sub_100073CB4(_DWORD *a1)
{
  v1 = *a1 + 1358806181 * (((a1 | 0x3472B3FC) - (a1 & 0x3472B3FC)) ^ 0xB5DDF7F);
  __asm { BRAA            X11, X17 }
}

uint64_t sub_100073DE8(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, unsigned int a12, unsigned int a13, unsigned int a14, uint64_t a15, uint64_t a16)
{
...
uint64_t sub_1000740A0@<X0>(uint64_t a1@<X0>, uint64_t a2@<X8>)
{
  v5 = *(a2 + v2 - 1 - 31);
  v6 = a1 + v2 - 1;
  *(v6 - 15) = *(a2 + v2 - 1 - 15);
...
uint64_t sub_1000743D8(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4)
{
...
uint64_t sub_100074420(_DWORD *a1)
{
  v1 = 2048652491 * ((-871686245 - (a1 | 0xCC0B1F9B) + (a1 | 0x33F4E064)) ^ 0x82457761);
  v2 = a1[1] + v1;
  return (*(*(&off_100BFFA10 + (v2 ^ 0x1D2F)) + (((*a1 - v1 - 16258000 < 0x63) * (((v2 - 6712) ^ 0x22FA) + ((v2 - 6712) | 0x44A) - 9962)) ^ v2) - 1))();
}

uint64_t sub_10007453C@<X0>(int a1@<W8>)
{
  STACK[0x9C8] = v1;
  v4 = STACK[0x6A8];
...
uint64_t sub_1000747CC(uint64_t a1)
{
...
uint64_t sub_100074908(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, unsigned int *a6)
{
  v8 = (v6 - 2043) | 0x102;
...
uint64_t sub_100074D94(uint64_t a1, uint64_t a2, uint64_t a3, unsigned int a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, uint64_t a16, uint64_t a17, uint64_t a18, uint64_t a19, uint64_t a20)
{
  *(v26 - 148) = a4;
  HIDWORD(a18) = 0;
  v27 = a4;
  ...
  *(v26 - 160) = a4 | 0xALL;
  ...
  v78 ^= 0x92CE5349;
  v79 = *(&off_100BFFA10 + (v22 & 0x1FD78B5A)) - 8;
  v80 = *(&off_100BFFA10 + (v22 ^ 0x1550)) - 4;
  v81 = *&v80[4 * ((v58 ^ 0xD14400D5) >> 16)];
  DWORD1(v40) = v81 ^ v20;
  LODWORD(v40) = v81 ^ v23;
  v82 = *(&off_100BFFA10 + (v22 ^ 0x15FB)) - 12;
  ...
  LODWORD(v40) = v87 ^ v23;
  v88 = BYTE3(v43);
  v89 = *(&off_100BFFA10 + (v22 ^ 0x15C0)) - 12;
  ...
  v179 = *(&off_100BFFA10 + (v22 ^ 0x154D)) - 4;
  ...
  v183 = *(&off_100BFFA10 + (v22 ^ 0x1533)) - 4;
  *(a11 + (v27 | 1)) = ~v183[((v71 ^ 0xBD206F14) >> 16) ^ 0xC1];
  v184 = *(&off_100BFFA10 + (v22 ^ 0x155A)) - 8;
  ...
  *(a11 + v196) = v183[((v58 ^ 0x174D7BDB) >> 16) ^ 0xADLL] ^ 0xD1;
  v186 = *(&off_100BFFA10 + (v22 ^ 0x15BD)) - 8;
  ...
  *(a11 + v201) = ((BYTE1(v182) ^ 4) + v186[BYTE1(v182) ^ 0xD8] - 15) ^ 0xB7;
  v188 = *(&off_100BFFA10 + v22 - 5376) - 12;
...
uint64_t sub_100076874(uint64_t a1, uint64_t a2, uint64_t a3, void *a4, _DWORD *a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, unsigned int a15, int a16)
{
  *a4 = 0;
  *a5 = 0;
...
uint64_t sub_1000769D4(int8x16_t a1, int8x16_t a2, int64x2_t a3, int8x16_t a4, int8x16_t a5, int8x16_t a6, int8x16_t a7, int8x16_t a8, uint64_t a9, uint64_t a10, int a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, uint64_t a16)
{
  v29 = a14 - 8;
  v30.i64[0] = a15 + v29 - 5;
  v30.i64[1] = a15 + v29 - 6;
...
uint64_t sub_1000769DC(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, unint64_t a6)
{
  STACK[0x308] = a6;
...
uint64_t sub_100076AC8(int8x16_t a1, int8x16_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, unint64_t a10)
{
  v29 = a7 - 8;
  v30 = a8 - 8;
  v31.i64[0] = v30 + v19 - 5;
...
uint64_t sub_100076AD8(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, uint64_t a16, int a17, int a18, uint64_t a19, uint64_t a20, uint64_t a21)
{
...
uint64_t sub_100076D6C(void *a1)
{
  *a1 = 0;
  a1[1] = 0;
  *(v1 + 8) = a1;
...
uint64_t sub_100076DE8(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, char a12, int a13, int a14, char a15, _BYTE *a16, uint64_t a17, int a18, unsigned int a19, char *a20, char *a21, _BYTE *a22)
{
  a20 = &a12;
  a22 = a16;
...
uint64_t sub_1000770F0(uint64_t a1, uint64_t a2, _DWORD *a3, void *a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, int a15, int a16)
{
  *a4 = a1;
  *a3 = a16;
  return sub_1001A0728();
}

uint64_t sub_100077244@<X0>(uint64_t a1@<X0>, uint64_t a2@<X1>, uint64_t a3@<X2>, unint64_t a4@<X8>)
{
...
uint64_t sub_10007CA8C(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, int a9, unsigned int a10, int a11, unsigned int a12, unsigned int a13, int a14)
{
...
uint64_t sub_10007CB48(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, int a10, char a11, uint64_t a12, int a13, unsigned int a14, uint64_t a15, char *a16)
{
  a15 = a9;
  a16 = &a11;
...
uint64_t sub_10007CC24(int a1, unint64_t a2)
{
  v8 = (v5 - 1) & 0xF;
...
uint64_t sub_10007CCA8(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t *a10, int a11, uint64_t a12, int a13, unsigned int a14)
{
...
uint64_t sub_10007CD6C(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7)
{
...
uint64_t sub_10007CF90(uint64_t a1, _BYTE *a2, _BYTE *a3, uint64_t a4, uint64_t a5, char a6)
{
  v11 = a4 - 1;
...
uint64_t sub_10007D1C4@<X0>(uint64_t a1@<X0>, int a2@<W8>)
{
  v5 = 109 * (a2 ^ 0x1C44);
...
uint64_t sub_10007D2B4(uint64_t a1, uint64_t a2, double a3, int8x16_t a4, int64x2_t a5, int8x16_t a6, int64x2_t a7, int8x16_t a8, int8x16_t a9, int8x16_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, uint64_t a16, uint64_t a17, uint64_t a18, uint64_t a19, uint64_t a20, uint64_t a21, uint64_t a22, uint64_t a23, uint64_t a24, uint64_t a25, uint64_t a26, uint64_t a27, uint64_t a28, uint64_t a29, uint64_t a30, uint64_t a31, uint64_t a32, uint64_t a33, uint64_t a34, uint64_t a35, uint64_t a36, uint64_t a37, uint64_t a38, uint64_t a39, uint64_t a40, uint64_t a41, uint64_t a42, uint64_t a43, uint64_t a44, uint64_t a45, uint64_t a46, uint64_t a47, uint64_t a48, uint64_t a49, uint64_t a50, uint64_t a51, uint64_t a52, uint64_t a53, uint64_t a54, uint64_t a55, uint64_t a56, uint64_t a57, uint64_t a58, uint64_t a59, uint64_t a60, uint64_t a61, uint64_t a62, uint64_t a63)
{
  v91 = a1 - 8;
...
uint64_t sub_10007D4D4(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, void *a5, _DWORD *a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, uint64_t a16, unsigned int a17, int a18)
{
  *a5 = 0;
  *a6 = 0;
...
uint64_t sub_10007D5B4(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, int a11, char a12, uint64_t a13, uint64_t a14, int a15, unsigned int a16, uint64_t a17, char *a18)
{
  a17 = a13;
  a18 = &a12;
...
void sub_10007D6B4(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5)
{
  if (a4)
  {
    v5 = a5 == 0;
...
uint64_t sub_10007D824@<X0>(int a1@<W8>)
{
  v2 = a1 - 3276;
...
uint64_t sub_10007D8C4(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, int a10, char a11, uint64_t a12, uint64_t a13, uint64_t a14, int a15, unsigned int a16, uint64_t a17, char *a18)
{
  a17 = a13;
  a18 = &a11;
...
uint64_t sub_10007DA24(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, int a14, unsigned int a15, unsigned int a16, uint64_t a17)
{
...
uint64_t sub_10007DB0C(int a1, uint64_t a2, int8x16_t *a3, uint64_t a4, double a5, __n128 a6, __n128 a7, __n128 a8, int8x16_t a9, double a10, int8x16_t a11, uint64_t a12, int a13)
{
  v18 = (v16 - 16) & 0xF;
...
uint64_t sub_10007DBB4@<X0>(uint64_t a1@<X0>, uint64_t a2@<X8>)
{
  v6 = (a1 + v2 - 16);
  v7 = (a2 + v2 - 16);
  v8 = *v7;
...
uint64_t sub_10007DC08(uint64_t a1, double a2, double a3, double a4, double a5, double a6, double a7, double a8, int8x16_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, int a14, uint64_t a15, uint64_t a16, uint64_t a17, uint64_t a18, uint64_t a19, uint64_t a20, uint64_t a21, uint64_t a22, uint64_t a23, uint64_t a24, uint64_t a25, uint64_t a26, uint64_t a27, uint64_t a28, uint64_t a29, uint64_t a30, uint64_t a31, uint64_t a32, uint64_t a33, uint64_t a34, uint64_t a35, uint64_t a36, uint64_t a37, uint64_t a38, uint64_t a39, uint64_t a40, uint64_t a41, uint64_t a42, uint64_t a43, uint64_t a44, uint64_t a45, uint64_t a46, uint64_t a47, uint64_t a48, uint64_t a49, uint64_t a50, uint64_t a51, uint64_t a52, uint64_t a53, uint64_t a54, uint64_t a55, uint64_t a56, uint64_t a57, uint64_t a58, uint64_t a59, uint64_t a60, int8x16_t a61, uint64_t a62, uint64_t a63)
{
  v77 = a1 + a52 - a68;
  v78.i64[0] = v77 - 7;
  v78.i64[1] = v77 - 8;
...
uint64_t sub_10007E178(uint64_t a1, uint64_t a2, uint64_t a3, int a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15)
{
  ...
  *(v22 - a2 + a1 + 2) = veor_s8(vrev64_s8(*&vqtbl4q_s8(v138, xmmword_1009E3420)), *(a15 - a2 - 8 + a1));
...
uint64_t sub_10007E8FC(uint64_t a1)
{
  *a1 = 0;
  *(a1 + 8) = 0;
  *(a1 + 16) = 42;
...
uint64_t sub_10007E9B8@<X0>(uint64_t a1@<X0>, uint64_t a2@<X8>)
{
...
uint64_t sub_10007EAB4(uint64_t a1, uint64_t a2, uint64_t a3)
{
  v5 = *(STACK[0x660] + 24);
  STACK[0x528] = v5;
...
uint64_t sub_10007F03C@<X0>(uint64_t a1@<X0>, uint64_t a2@<X1>, uint64_t a3@<X2>, uint64_t a4@<X3>, uint64_t a5@<X4>, uint64_t a6@<X5>, int a7@<W8>)
{
...
uint64_t sub_10007F0A8@<X0>(int a1@<W8>)
{
  v2 = STACK[0x438];
  STACK[0x508] = *(v1 + 8 * a1);
...
uint64_t sub_10007F0E0(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t *a12, int a13, unsigned int a14)
{
  a12 = &a9;
...
uint64_t sub_10007F1B4(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4)
{
  v6 = *v5;
  STACK[0x640] = 0;
  STACK[0x410] = 0;
...
uint64_t sub_10007FF04(uint64_t a1, int a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, uint64_t a16, uint64_t a17, uint64_t a18, uint64_t a19, uint64_t a20, uint64_t a21, uint64_t a22, uint64_t a23, uint64_t a24, uint64_t a25, uint64_t a26, uint64_t a27, uint64_t a28, uint64_t a29, uint64_t a30, uint64_t a31, uint64_t a32, uint64_t a33, uint64_t a34, uint64_t a35, uint64_t a36, uint64_t a37, uint64_t a38, uint64_t a39, uint64_t a40, uint64_t a41, uint64_t a42, uint64_t a43, uint64_t a44, uint64_t a45, uint64_t a46, uint64_t a47, uint64_t a48, uint64_t a49, uint64_t a50, uint64_t a51, uint64_t a52, uint64_t a53, uint64_t a54, uint64_t a55, uint64_t a56, uint64_t a57, uint64_t a58, uint64_t a59, uint64_t a60, uint64_t a61, uint64_t a62, uint64_t a63)
{
  v80 = v72 - 8;
  v81.i64[0] = v75 + v80 - 7;
  v81.i64[1] = v75 + v80 - 8;
...
void sub_10007FF0C(uint64_t a1)
{
  if (*(a1 + 24))
  {
    v2 = *(a1 + 8) == 0;
...
uint64_t sub_10007FFCC(uint64_t a1)
{
  v3 = v1 & 0x61B24AFF;
...
uint64_t sub_100080030@<X0>(uint64_t a1@<X0>, int a2@<W8>)
{
  v10 = v2 + v6 + (v4 & v5);
  STACK[0xA18] = v10;
...
uint64_t sub_100080038@<X0>(uint64_t a1@<X3>, unint64_t a2@<X8>)
{
  STACK[0x850] = a2;
...
uint64_t sub_1000800AC(unint64_t a1)
{
  STACK[0x730] = a1;
...
uint64_t sub_100080514(uint64_t a1, uint64_t a2, uint64_t a3)
{
...
uint64_t sub_10008055C(void *a1)
{
  *a1 = 0;
  a1[1] = 0;
...
uint64_t sub_1000805CC@<X0>(uint64_t a1@<X0>, uint64_t a2@<X1>, uint64_t a3@<X2>, int a4@<W8>)
{
  v5 = STACK[0x928];
...
uint64_t sub_100080684()
{
  (*(v2 + 8 * ((v0 | 0x702) + 7781)))();
  *(v1 + 24) = 0;
  return sub_1000778EC();
}

uint64_t sub_1000806C4(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, char a14, uint64_t a15, uint64_t a16, uint64_t a17, uint64_t a18, char *a19, int a20, unsigned int a21)
{
  a19 = &a14;
...
uint64_t sub_1000807A8(uint64_t a1)
{
  v4 = v3 ^ 0x1D92;
...
uint64_t sub_10008088C(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, _DWORD *a5, void *a6)
{
...
uint64_t sub_100080A64(unint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, uint64_t a16, uint64_t a17, uint64_t a18, uint64_t a19, uint64_t a20, uint64_t a21, uint64_t a22, uint64_t a23, uint64_t a24, uint64_t a25, uint64_t a26, uint64_t a27, uint64_t a28, uint64_t a29, uint64_t a30, uint64_t a31, uint64_t a32, uint64_t a33, uint64_t a34, uint64_t a35, uint64_t a36, uint64_t a37, uint64_t a38, uint64_t a39, uint64_t a40, uint64_t a41, uint64_t a42, uint64_t a43, uint64_t a44, uint64_t a45, uint64_t a46, uint64_t a47, uint64_t a48, uint64_t a49, uint64_t a50, uint64_t a51, uint64_t a52, uint64_t a53, uint64_t a54, uint64_t a55, uint64_t a56, uint64_t a57, uint64_t a58, uint64_t a59, uint64_t a60)
{
  *a1 = 0;
  *(a1 + 8) = 0;
  STACK[0x270] = a1;
...
uint64_t sub_100080B38(uint64_t result)
{
  **(result + 8) = 0;
  *(result + 4) = 242661640;
  return result;
...
void sub_100080B50(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8)
{
  if (a2)
  {
    v8 = a3 == 0;
...
uint64_t sub_100080BD8(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, char a10, uint64_t a11, int a12, unsigned int a13, uint64_t a14, char *a15, unsigned int a16, unsigned int a17)
{
...
uint64_t sub_100080C7C(uint64_t a1, uint64_t a2, int a3, int a4, uint64_t a5, int a6, int a7, int a8, uint64_t a9, uint64_t a10, uint64_t a11, int a12, int a13, int a14, int a15, int a16, int a17, int a18, int a19, int a20, int a21, int a22, int a23, int a24, int a25, int a26, int a27, int a28, unsigned int a29, int a30, int a31, uint64_t a32, uint64_t a33, uint64_t a34, uint64_t a35, int a36, int a37, int a38, int a39, int a40, int a41, int a42, int a43, int a44, int a45, int a46, int a47, int a48, int a49, int a50)
{
  ...
  *(v54 - 116) = v63;
  ...
  v77 = *(&off_100BFFA10 + v55 - 5484);
  v78 = (a28 ^ v72) >> 24;
  v79 = *(&off_100BFFA10 + v55 - 5595) - 4;
  v80 = *(v77 + 4 * (BYTE2(v71) ^ 0x21u)) * v53;
  v81 = ((a28 ^ v72) >> 8);
  v82 = *(&off_100BFFA10 + (v55 ^ 0x1504)) - 8;
  v83 = *&v82[4 * v81];
  v84 = *(&off_100BFFA10 + (v55 ^ 0x14B9)) - 8;
  ...
  v179 = *(&off_100BFFA10 + (v55 ^ 0x14EF)) - 12;
  v180 = *&v179[4 * ((v178 ^ 0xCB23) >> 8)];
  v181 = *(&off_100BFFA10 + v55 - 5564) - 4;
  v182 = *(&off_100BFFA10 + v55 - 5552);
  v183 = *(&off_100BFFA10 + (v55 & 0x82066A66)) - 12;
