...
- (IDSPersistentMapKeychainPersister)initWithIdentifier:(id)a3 keychainWrapper:(id)a4 systemMonitor:(id)a5
{
  ...
  if (v12)
  {
    ...
    objc_storeStrong(&v13->_keychainWrapper, a4);
    objc_storeStrong(&v13->_systemMonitor, a5);
  }
...
- (id)data
{
  ...
  {
    v3 = [(IDSPersistentMapKeychainPersister *)self keychainWrapper];
    ...
    if (!v5)
    {
      ...
      {
        v8 = self->_identifier;
        v9 = [(IDSPersistentMapKeychainPersister *)self keychainWrapper];
        *buf = 138543874;
        v14 = v6;
        v15 = 2114;
        v16 = v8;
      ...
      {
        v11 = [(IDSPersistentMapKeychainPersister *)self keychainWrapper];
        _IDSLogV();
      }
    }
  }
...
- (void)saveData:(id)a3 allowBackup:(BOOL)a4
{
  ...
  if ([(IDSPersistentMapKeychainPersister *)self isAvailable])
  {
    ...
    identifier = self->_identifier;
    v15 = 0;
    v9 = [v7 saveData:v6 forIdentifier:identifier allowSync:0 allowBackup:v4 dataProtectionClass:2 error:&v15];
    v10 = v15;
    ...
    if ((v9 & 1) == 0)
    {
      ...
      if (os_log_shim_legacy_logging_enabled() && _IDSShouldLog())
      {
        v14 = [(IDSPersistentMapKeychainPersister *)self keychainWrapper];
        _IDSLogV();
      }
    }
  }
