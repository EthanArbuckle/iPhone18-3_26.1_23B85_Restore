...
LABEL_14:
    ...
    if ([v5 isEqualToString:@"com.apple.madrid"] & 1) != 0 || (objc_msgSend(v5, "isEqualToString:", @"com.apple.ess") & 1) != 0 || (objc_msgSend(v5, "isEqualToString:", @"com.apple.private.ac"))
    {
      goto LABEL_11;
    }
...
- (void)_postAvailability:(int64_t)a3
{
  ...
  [v5 __mainThreadPostNotificationName:@"__kIDSServiceMonitorAvailabilityDidChangeNotification" object:self userInfo:v4];
}
