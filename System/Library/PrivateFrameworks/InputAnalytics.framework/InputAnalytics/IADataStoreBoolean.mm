...
- (BOOL)persist
{
  ...
  v21.receiver = self;
  v21.super_class = IADataStoreBoolean;
...
LABEL_8:
  ...
  isTrue = objc_msgSend_isTrue(self, v8, v9);
  v13 = objc_msgSend_name(self, v11, v12);
  v15 = objc_msgSend_stringByAppendingString_(v13, v14, @"_isTrue");
  objc_msgSend_setBool_forKey_(v7, v16, isTrue, v15);
...
- (BOOL)destroy
{
  ...
  v18.receiver = self;
  v18.super_class = IADataStoreBoolean;
...
LABEL_8:
  ...
  v12 = objc_msgSend_stringByAppendingString_(v10, v11, @"_isTrue");
