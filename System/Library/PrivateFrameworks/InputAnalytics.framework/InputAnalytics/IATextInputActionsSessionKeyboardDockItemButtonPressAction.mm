...
- (IATextInputActionsSessionKeyboardDockItemButtonPressAction)initWithCoder:(id)a3
{
  ...
  v5 = [(IATextInputActionsSessionAction *)&v67 initWithCoder:v4];
  if (v5)
  {
    v6 = objc_opt_class();
    v8 = objc_msgSend_decodeObjectOfClass_forKey_(v4, v7, v6, @"buttonPressResult");
    v5->_buttonPressResult = objc_msgSend_unsignedLongValue(v8, v9, v10);

    v11 = objc_opt_class();
    v13 = objc_msgSend_decodeObjectOfClass_forKey_(v4, v12, v11, @"buttonType");
    v5->_buttonType = objc_msgSend_unsignedLongValue(v13, v14, v15);

    v16 = objc_opt_class();
    v18 = objc_msgSend_decodeObjectOfClass_forKey_(v4, v17, v16, @"uiOrientation");
    v5->_uiOrientation = objc_msgSend_longValue(v18, v19, v20);

    v21 = objc_opt_class();
    v23 = objc_msgSend_decodeObjectOfClass_forKey_(v4, v22, v21, @"buttonSize_width");
    objc_msgSend_doubleValue(v23, v24, v25);
    v27 = v26;
    v28 = objc_opt_class();
    v30 = objc_msgSend_decodeObjectOfClass_forKey_(v4, v29, v28, @"buttonSize_height");
    objc_msgSend_doubleValue(v30, v31, v32);
    v5->_buttonSize.width = v27;
    v5->_buttonSize.height = v33;

    v34 = objc_opt_class();
    v36 = objc_msgSend_decodeObjectOfClass_forKey_(v4, v35, v34, @"touchDownPoint_x");
    objc_msgSend_doubleValue(v36, v37, v38);
    v40 = v39;
    v41 = objc_opt_class();
    v43 = objc_msgSend_decodeObjectOfClass_forKey_(v4, v42, v41, @"touchDownPoint_y");
    objc_msgSend_doubleValue(v43, v44, v45);
    v5->_touchDownPoint.x = v40;
    v5->_touchDownPoint.y = v46;

    v47 = objc_opt_class();
    v49 = objc_msgSend_decodeObjectOfClass_forKey_(v4, v48, v47, @"touchUpPoint_x");
    objc_msgSend_doubleValue(v49, v50, v51);
    v53 = v52;
    v54 = objc_opt_class();
    v56 = objc_msgSend_decodeObjectOfClass_forKey_(v4, v55, v54, @"touchUpPoint_y");
    objc_msgSend_doubleValue(v56, v57, v58);
    v5->_touchUpPoint.x = v53;
    v5->_touchUpPoint.y = v59;

    v60 = objc_opt_class();
    v62 = objc_msgSend_decodeObjectOfClass_forKey_(v4, v61, v60, @"touchDuration");
...
- (id)initFromDictionary:(id)a3
{
  ...
  v3 = a3;
  v4 = [(IATextInputActionsSessionAction *)&v56 initFromDictionary:v3];
  v6 = objc_msgSend_objectForKeyedSubscript_(v3, v5, @"buttonPressResult", v56.receiver, v56.super_class);
  v4[23] = objc_msgSend_unsignedLongValue(v6, v7, v8);

  v10 = objc_msgSend_objectForKeyedSubscript_(v3, v9, @"buttonType");
  v4[24] = objc_msgSend_unsignedLongValue(v10, v11, v12);

  v14 = objc_msgSend_objectForKeyedSubscript_(v3, v13, @"uiOrientation");
  v4[25] = objc_msgSend_longValue(v14, v15, v16);

  v18 = objc_msgSend_objectForKeyedSubscript_(v3, v17, @"touchDuration");
  objc_msgSend_doubleValue(v18, v19, v20);
  v4[26] = v21;

  v23 = objc_msgSend_objectForKeyedSubscript_(v3, v22, @"buttonSize_width");
  objc_msgSend_doubleValue(v23, v24, v25);
  v27 = v26;
  v29 = objc_msgSend_objectForKeyedSubscript_(v3, v28, @"buttonSize_height");
  objc_msgSend_doubleValue(v29, v30, v31);
  v4[27] = v27;
  v4[28] = v32;

  v34 = objc_msgSend_objectForKeyedSubscript_(v3, v33, @"touchDownPoint_x");
  objc_msgSend_doubleValue(v34, v35, v36);
  v38 = v37;
  v40 = objc_msgSend_objectForKeyedSubscript_(v3, v39, @"touchDownPoint_y");
  objc_msgSend_doubleValue(v40, v41, v42);
  v4[29] = v38;
  v4[30] = v43;

  v45 = objc_msgSend_objectForKeyedSubscript_(v3, v44, @"touchUpPoint_x");
  objc_msgSend_doubleValue(v45, v46, v47);
  v49 = v48;
  v51 = objc_msgSend_objectForKeyedSubscript_(v3, v50, @"touchUpPoint_y");
