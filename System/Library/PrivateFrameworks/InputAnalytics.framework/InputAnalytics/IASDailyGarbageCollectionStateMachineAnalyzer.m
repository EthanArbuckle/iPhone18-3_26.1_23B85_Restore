...
- (BOOL)asynchronousSignalIsConsistent:(id)a3;
@end
...
{
  v4 = a3;
  v7 = objc_msgSend_creationTimestamp(v4, v5, v6);
  ...
  if (!v10)
  {
    objc_msgSend_setLastConsumedAsyncSignal_(self, v11, v4);
LABEL_7:
    v25 = 1;
    goto LABEL_8;
  }
  ...
  v19 = objc_msgSend_creationTimestamp(v4, v17, v18);
  objc_msgSend_setLastConsumedAsyncSignal_(self, v20, v4);
