...
- (int64_t)mergeActionIfPossible:(id)a3
{
  ...
  {
    v10 = objc_msgSend_asInsertion(v4, v6, v7);
    if (!v10)
    {
      v60 = 0;
LABEL_13:
    ...
    v63 = objc_msgSend_inputMode(v4, v61, v62);
...
- (IATextInputActionsSessionInsertionAction)initWithCoder:(id)a3
{
  ...
  if (v5)
  {
    ...
    v11 = objc_opt_class();
    v13 = objc_msgSend_decodeObjectOfClass_forKey_(v4, v12, v11, @"withAlternativesCount");
...
- (void)encodeWithCoder:(id)a3
{
  ...
  v4 = a3;
  [(IATextInputActionsSessionAction *)&v11 encodeWithCoder:v4];
  ...
  objc_msgSend_encodeObject_forKey_(v4, v10, v9, @"withAlternativesCount");
}
...
- (id)initFromDictionary:(id)a3
{
  ...
  v3 = a3;
  v4 = [(IATextInputActionsSessionAction *)&v14 initFromDictionary:v3];
  v6 = objc_msgSend_objectForKeyedSubscript_(v3, v5, @"options", v14.receiver, v14.super_class);
  v4[23] = objc_msgSend_longValue(v6, v7, v8);

  v10 = objc_msgSend_objectForKeyedSubscript_(v3, v9, @"withAlternativesCount");
...
- (id)toDictionary
{
  v11.receiver = self;
  v11.super_class = IATextInputActionsSessionInsertionAction;
  v3 = [(IATextInputActionsSessionAction *)&v11 toDictionary];
  ...
  objc_msgSend_setObjectIfNotNil_forKey_(v3, v9, v8, @"withAlternativesCount");
