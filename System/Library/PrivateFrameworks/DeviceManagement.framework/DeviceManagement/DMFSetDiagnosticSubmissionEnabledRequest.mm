...
- (DMFSetDiagnosticSubmissionEnabledRequest)initWithCoder:(id)coder;
...
- (DMFSetDiagnosticSubmissionEnabledRequest)initWithCoder:(id)coder
{
  coderCopy = coder;
  v8.receiver = self;
  v8.super_class = DMFSetDiagnosticSubmissionEnabledRequest;
...
{
  v6.receiver = self;
  v6.super_class = DMFSetDiagnosticSubmissionEnabledRequest;
  coderCopy = coder;
  [(CATTaskRequest *)&v6 encodeWithCoder:coderCopy];
  v5 = [MEMORY[0x1E696AD98] numberWithBool:{-[DMFSetDiagnosticSubmissionEnabledRequest enabled](self, "enabled", v6.receiver, v6.super_class)}];
