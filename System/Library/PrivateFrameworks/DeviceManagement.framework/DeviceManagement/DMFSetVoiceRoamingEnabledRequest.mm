...
- (DMFSetVoiceRoamingEnabledRequest)initWithCoder:(id)coder;
...
- (DMFSetVoiceRoamingEnabledRequest)initWithCoder:(id)coder
{
  coderCopy = coder;
  v8.receiver = self;
  v8.super_class = DMFSetVoiceRoamingEnabledRequest;
...
{
  v6.receiver = self;
  v6.super_class = DMFSetVoiceRoamingEnabledRequest;
  coderCopy = coder;
  [(CATTaskRequest *)&v6 encodeWithCoder:coderCopy];
  v5 = [MEMORY[0x1E696AD98] numberWithBool:{-[DMFSetVoiceRoamingEnabledRequest enabled](self, "enabled", v6.receiver, v6.super_class)}];
