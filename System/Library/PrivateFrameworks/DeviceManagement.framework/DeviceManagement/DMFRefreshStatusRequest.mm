...
- (DMFRefreshStatusRequest)initWithCoder:(id)coder;
...
- (DMFRefreshStatusRequest)initWithCoder:(id)coder
{
  coderCopy = coder;
  v10.receiver = self;
  v10.super_class = DMFRefreshStatusRequest;
...
{
  v6.receiver = self;
  v6.super_class = DMFRefreshStatusRequest;
  coderCopy = coder;
  [(CATTaskRequest *)&v6 encodeWithCoder:coderCopy];
  v5 = [(DMFRefreshStatusRequest *)self organizationIdentifier:v6.receiver];
