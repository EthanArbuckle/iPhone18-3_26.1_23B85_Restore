...
- (DMFSetAppAnalyticsEnabledRequest)initWithCoder:(id)coder;
...
- (DMFSetAppAnalyticsEnabledRequest)initWithCoder:(id)coder
{
  coderCopy = coder;
  v8.receiver = self;
  v8.super_class = DMFSetAppAnalyticsEnabledRequest;
...
{
  v6.receiver = self;
  v6.super_class = DMFSetAppAnalyticsEnabledRequest;
  coderCopy = coder;
  [(CATTaskRequest *)&v6 encodeWithCoder:coderCopy];
  v5 = [MEMORY[0x1E696AD98] numberWithBool:{-[DMFSetAppAnalyticsEnabledRequest enabled](self, "enabled", v6.receiver, v6.super_class)}];
