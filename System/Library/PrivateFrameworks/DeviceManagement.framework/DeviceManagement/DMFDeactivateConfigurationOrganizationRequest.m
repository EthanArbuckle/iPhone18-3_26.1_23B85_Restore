...
- (DMFDeactivateConfigurationOrganizationRequest)initWithCoder:(id)a3
{
  v4 = a3;
  v10.receiver = self;
  v10.super_class = DMFDeactivateConfigurationOrganizationRequest;
...
{
  v6.receiver = self;
  v6.super_class = DMFDeactivateConfigurationOrganizationRequest;
  v4 = a3;
  [(CATTaskRequest *)&v6 encodeWithCoder:v4];
  v5 = [(DMFDeactivateConfigurationOrganizationRequest *)self organizationIdentifier:v6.receiver];
