...
- (DMFLockDeviceRequest)initWithCoder:(id)coder;
...
- (DMFLockDeviceRequest)initWithCoder:(id)coder
{
  ...
  if (v5)
  {
    ...
    v13 = [coderCopy decodeObjectOfClasses:v12 forKey:@"pin"];
    pin = v5->_pin;
    v5->_pin = v13;
  }
...
- (void)encodeWithCoder:(id)coder
{
  ...
  phoneNumber = [(DMFLockDeviceRequest *)self phoneNumber];
  [coderCopy encodeObject:phoneNumber forKey:@"phoneNumber"];

  v7 = [(DMFLockDeviceRequest *)self pin];
  [coderCopy encodeObject:v7 forKey:@"pin"];
}
