...
- (DMFProcessDeclarationsRequest)initWithCoder:(id)coder;
...
- (DMFProcessDeclarationsRequest)initWithCoder:(id)coder
{
  coderCopy = coder;
  v10.receiver = self;
  v10.super_class = DMFProcessDeclarationsRequest;
...
{
  v6.receiver = self;
  v6.super_class = DMFProcessDeclarationsRequest;
  coderCopy = coder;
  [(CATTaskRequest *)&v6 encodeWithCoder:coderCopy];
  v5 = [(DMFProcessDeclarationsRequest *)self organizationIdentifier:v6.receiver];
