...
+ (NSSet)policyTypes;
- (BOOL)hasAnyRestrictivePoliciesWithError:(id *)a3;
- (DMFWebsitePolicyMonitor)initWithPolicyChangeHandler:(id)a3;
- (void)dealloc;
- (void)hasAnyRestrictivePoliciesWithCompletionHandler:(id)a3;
...
- (DMFWebsitePolicyMonitor)initWithPolicyChangeHandler:(id)a3
{
  ...
  if (v5)
  {
    ...
    if (v4)
    {
      ...
      v9 = [[DMFPolicyRegistration alloc] initWithIdentifier:@"dmf.policy.monitor.web" policyTypes:v8 callback:v4];
...
- (void)hasAnyRestrictivePoliciesWithCompletionHandler:(id)a3
{
  ...
  v9 = v3;
  v7 = v3;
  [v4 requestPoliciesForTypes:v6 completionHandler:v8];
}
...
- (BOOL)hasAnyRestrictivePoliciesWithError:(id *)a3
{
  ...
  v6 = [v5 allObjects];
  v22 = 0;
  v7 = [v4 requestPoliciesForTypes:v6 withError:&v22];
  v8 = v22;
