...
- (DMFDDMStartManagingAppResultObject)initWithBundleIdentifier:(id)a3 state:(unint64_t)a4;
- (DMFDDMStartManagingAppResultObject)initWithCoder:(id)a3;
- (id)description;
...
- (id)description
{
  ...
  v4 = [(DMFDDMStartManagingAppResultObject *)self bundleIdentifier];
