...
- (DMFEndTransactionRequest)initWithCoder:(id)coder;
...
- (DMFEndTransactionRequest)initWithCoder:(id)coder
{
  coderCopy = coder;
  v10.receiver = self;
  v10.super_class = DMFEndTransactionRequest;
...
{
  v6.receiver = self;
  v6.super_class = DMFEndTransactionRequest;
  coderCopy = coder;
  [(CATTaskRequest *)&v6 encodeWithCoder:coderCopy];
  v5 = [(DMFEndTransactionRequest *)self UUID:v6.receiver];
