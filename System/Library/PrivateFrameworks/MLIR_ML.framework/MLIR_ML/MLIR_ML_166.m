...
LABEL_15:
  ...
  isSplat = mlir::ElementsAttr::isSplat(&v140);
  v19 = v140;
...
LABEL_239:
  ...
  RawData = mlir::DenseElementsAttr::getRawData(v142);
  v4 = v21;
  if (isSplat)
  {
    goto LABEL_20;
...
LABEL_15:
  ...
  isSplat = mlir::ElementsAttr::isSplat(&v151);
  v19 = v151;
  ...
  if (v20)
  {
    RawData = mlir::DenseElementsAttr::getRawData(v153);
    v4 = v21;
    if (isSplat)
    {
      goto LABEL_20;
...
LABEL_27:
    ...
    if (mlir::Type::isF16(&ElementType))
    {
      ...
      v67 = 0;
      if (NumElements < 4 || (a3 - RawData) < 0x20)
      {
        goto LABEL_190;
      }
...
LABEL_220:
  ...
  if (v24)
  {
    RawData = mlir::mps::MPSBufferTensorAttr::getRawData(v153);
    v4 = v25;
    if ((isSplat & 1) == 0)
    {
      goto LABEL_27;
...
LABEL_173:
    if (!mlir::Type::isInteger(&ElementType, 1))
    {
      mlir::Type::getIntOrFloatBitWidth(&ElementType);
      IntOrFloatBitWidth = mlir::Type::getIntOrFloatBitWidth(&ElementType);
      mlir::detail::unpackQuantizedData<half>(RawData, v4, a3, NumElements, IntOrFloatBitWidth);
      return _Q0.i16[0];
    }

    llvm::SmallVector<char,40u>::SmallVector(v153, NumElements);
    mlir::detail::unpackBooleanData(RawData, v4, v153[0], v153[1]);
    v81 = v153[0];
    if (NumElements < 1)
    {
      goto LABEL_211;
...
LABEL_171:
  if (NumElements >= 2)
  {
    ...
    do
    {
      ...
      _Q0.i32[0] = *&RawData[2 * v102] << 16;
      _S1 = *&RawData[2 * v103] << 16;
      __asm
      {
        FCVT            H0, S0
        FCVT            H1, S1
...
LABEL_15:
  ...
  if (v20)
  {
    RawData = mlir::DenseElementsAttr::getRawData(v94);
    v3 = v21;
    if (isSplat)
    {
      goto LABEL_20;
...
LABEL_78:
      if (NumElements >= 2)
      {
        ...
        do
        {
          ...
          v50 = HIWORD(COERCE_UNSIGNED_INT(*&RawData[4 * v49] + (COERCE_FLOAT(COERCE_UNSIGNED_INT(*&RawData[4 * v49]) & 0xFF800000) * 0.0039062)));
          *(v47 - 1) = HIWORD(COERCE_UNSIGNED_INT(*&RawData[4 * v48] + (COERCE_FLOAT(COERCE_UNSIGNED_INT(*&RawData[4 * v48]) & 0xFF800000) * 0.0039062)));
          *v47 = v50;
          v47 += 2;
          v46 += 2;
        }
      ...
      do
      {
        ...
        a3[v38++] = HIWORD(COERCE_UNSIGNED_INT(*&RawData[4 * v51] + (COERCE_FLOAT(COERCE_UNSIGNED_INT(*&RawData[4 * v51]) & 0xFF800000) * 0.0039062)));
      }
...
LABEL_98:
      if (NumElements >= 2)
      {
        ...
        do
        {
          ...
          v57 = HIWORD(COERCE_UNSIGNED_INT(*&RawData[8 * v56] + (COERCE_FLOAT(COERCE_UNSIGNED_INT(*&RawData[8 * v56]) & 0x7F800000) * 0.0039062)));
          *(v54 - 1) = HIWORD(COERCE_UNSIGNED_INT(*&RawData[8 * v55] + (COERCE_FLOAT(COERCE_UNSIGNED_INT(*&RawData[8 * v55]) & 0x7F800000) * 0.0039062)));
          *v54 = v57;
          v54 += 2;
          v53 += 2;
        }
      ...
      do
      {
        ...
        a3[v45++] = HIWORD(COERCE_UNSIGNED_INT(*&RawData[8 * v58] + (COERCE_FLOAT(COERCE_UNSIGNED_INT(*&RawData[8 * v58]) & 0x7F800000) * 0.0039062)));
      }
...
LABEL_118:
      if (NumElements >= 2)
      {
        ...
        do
        {
          ...
          v72 = HIWORD(COERCE_UNSIGNED_INT(*&RawData[8 * v71] + (COERCE_FLOAT(COERCE_UNSIGNED_INT(*&RawData[8 * v71]) & 0xFF800000) * 0.0039062)));
          *(v69 - 1) = HIWORD(COERCE_UNSIGNED_INT(*&RawData[8 * v70] + (COERCE_FLOAT(COERCE_UNSIGNED_INT(*&RawData[8 * v70]) & 0xFF800000) * 0.0039062)));
          *v69 = v72;
          v69 += 2;
          v68 += 2;
        }
      ...
      do
      {
        ...
        a3[v52++] = HIWORD(COERCE_UNSIGNED_INT(*&RawData[8 * v73] + (COERCE_FLOAT(COERCE_UNSIGNED_INT(*&RawData[8 * v73]) & 0xFF800000) * 0.0039062)));
      }
...
LABEL_188:
      if (mlir::Type::isInteger(&ElementType, 1))
      {
        ...
        mlir::detail::unpackBooleanData(RawData, v3, v94[0], v94[1]);
        v86 = v94[0];
        if (NumElements >= 1)
        {
          for (i = 0; i != NumElements; ++i)
      ...
      else
      {
        mlir::Type::getIntOrFloatBitWidth(&ElementType);
        IntOrFloatBitWidth = mlir::Type::getIntOrFloatBitWidth(&ElementType);
        mlir::detail::unpackQuantizedData<__emulated_bf16>(RawData, v3, a3, NumElements, IntOrFloatBitWidth);
      }
...
LABEL_182:
  ...
  if (v24)
  {
    RawData = mlir::mps::MPSBufferTensorAttr::getRawData(v94);
    v3 = v25;
    if ((isSplat & 1) == 0)
    {
      goto LABEL_27;
...
LABEL_162:
      for (kk = 0; kk != NumElements; ++kk)
      {
        ...
        v76 = *&RawData[4 * v75] + (COERCE_FLOAT(*&RawData[4 * v75] & 0xFF800000) * 0.0039062);
        a3[kk] = HIWORD(v76);
      }
...
LABEL_89:
      ...
      a3[nn] = HIWORD(COERCE_UNSIGNED_INT(*&RawData[4 * v44] + (COERCE_FLOAT(COERCE_UNSIGNED_INT(*&RawData[4 * v44]) & 0x7F800000) * 0.0039062)));
    }
  ...
  do
  {
    ...
    v43 = HIWORD(COERCE_UNSIGNED_INT(*&RawData[4 * v42] + (COERCE_FLOAT(COERCE_UNSIGNED_INT(*&RawData[4 * v42]) & 0x7F800000) * 0.0039062)));
    *(v40 - 1) = HIWORD(COERCE_UNSIGNED_INT(*&RawData[4 * v41] + (COERCE_FLOAT(COERCE_UNSIGNED_INT(*&RawData[4 * v41]) & 0x7F800000) * 0.0039062)));
    *v40 = v43;
    v40 += 2;
    v39 += 2;
  }
...
LABEL_15:
  ...
  isSplat = mlir::ElementsAttr::isSplat(&v149);
  v19 = v149;
  ...
  if (v20)
  {
    RawData = mlir::DenseElementsAttr::getRawData(v151);
    v4 = v21;
    if (isSplat)
    {
      goto LABEL_20;
...
LABEL_187:
      ...
      mlir::detail::unpackBooleanData(RawData, v4, v151[0], v151[1]);
      v96 = v151[0];
      if (NumElements < 1)
      {
        goto LABEL_206;
...
LABEL_206:
      ...
      if (NumElements >= 0x10)
      {
        ...
        {
          v131 = *v130++;
          v129[2] = vcvtq_n_f32_s32(vqtbl1q_s8(v131, xmmword_2573742E0), 0x18uLL);
          v129[3] = vcvtq_n_f32_s32(vqtbl1q_s8(v131, xmmword_2573742D0), 0x18uLL);
          *v129 = vcvtq_n_f32_s32(vqtbl1q_s8(v131, xmmword_257374300), 0x18uLL);
          v129[1] = vcvtq_n_f32_s32(vqtbl1q_s8(v131, xmmword_2573742F0), 0x18uLL);
          v129 += 4;
          v128 -= 16;
        }
...
LABEL_215:
  ...
  if (v24)
  {
    RawData = mlir::mps::MPSBufferTensorAttr::getRawData(v151);
    v4 = v25;
    if ((isSplat & 1) == 0)
    {
      goto LABEL_27;
...
LABEL_15:
  v177[0] = Type;
  v177[1] = v17;
  ElementType = mlir::ShapedType::getElementType(v177);
  isSplat = mlir::ElementsAttr::isSplat(&v178);
  v19 = v178;
...
LABEL_280:
  ...
  RawData = mlir::DenseElementsAttr::getRawData(v180);
  v4 = v21;
  if (isSplat)
  {
    goto LABEL_20;
...
LABEL_15:
  ...
  isSplat = mlir::ElementsAttr::isSplat(&v114);
  v19 = v114;
  ...
  if (v20)
  {
    RawData = mlir::DenseElementsAttr::getRawData(v116);
    v4 = v21;
    if (isSplat)
    {
      goto LABEL_20;
...
LABEL_27:
    ...
    if (mlir::Type::isUnsignedInteger(&ElementType, 64))
    {
      ...
      if (NumElements >= 0x20)
      {
        ...
        do
        {
          *&v59 = vqtbl4q_s8(v56[-2], xmmword_25738F050).u64[0];
          *&v60 = vqtbl4q_s8(*v56, xmmword_25738F050).u64[0];
          *(&v59 + 1) = vqtbl4q_s8(v56[-1], xmmword_25738F050).u64[0];
          *(&v60 + 1) = vqtbl4q_s8(v56[1], xmmword_25738F050).u64[0];
          *(v57 - 1) = v59;
          *v57 = v60;
          v56 += 4;
          v57 += 2;
...
LABEL_97:
      ...
      do
      {
        *v63 = vqtbl4q_s8(*v62, xmmword_25738F060).u64[0];
        v63 += 8;
        ++v62;
        v64 += 8;
      }
    ...
    if (mlir::Type::isInteger(&ElementType, 64))
    {
      ...
      if (NumElements >= 0x20)
      {
        ...
        do
        {
          *&v73 = vqtbl4q_s8(v70[-2], xmmword_25738F050).u64[0];
          *&v74 = vqtbl4q_s8(*v70, xmmword_25738F050).u64[0];
          *(&v73 + 1) = vqtbl4q_s8(v70[-1], xmmword_25738F050).u64[0];
          *(&v74 + 1) = vqtbl4q_s8(v70[1], xmmword_25738F050).u64[0];
          *(v71 - 1) = v73;
          *v71 = v74;
          v70 += 4;
          v71 += 2;
...
LABEL_106:
      ...
      do
      {
        *v77 = vqtbl4q_s8(*v76, xmmword_25738F060).u64[0];
        v77 += 8;
        ++v76;
        v78 += 8;
      }
...
LABEL_139:
  ...
  if (v23)
  {
    RawData = mlir::mps::MPSBufferTensorAttr::getRawData(v116);
    v4 = v24;
    if ((isSplat & 1) == 0)
    {
      goto LABEL_27;
...
LABEL_162:
  if (!mlir::Type::isInteger(&ElementType, 1))
  {
    mlir::Type::getIntOrFloatBitWidth(&ElementType);
    IntOrFloatBitWidth = mlir::Type::getIntOrFloatBitWidth(&ElementType);
    mlir::detail::unpackQuantizedData<unsigned char>(RawData, v4, a3, NumElements, IntOrFloatBitWidth);
    return;
  }

  llvm::SmallVector<char,40u>::SmallVector(v116, NumElements);
  mlir::detail::unpackBooleanData(RawData, v4, v116[0], v116[1]);
  v67 = v116[0];
  if (NumElements < 1)
  {
    goto LABEL_211;
...
LABEL_15:
  v101[0] = Type;
  v101[1] = v17;
  ElementType = mlir::ShapedType::getElementType(v101);
  ...
  if (v20)
  {
    RawData = mlir::DenseElementsAttr::getRawData(v104);
    v3 = v21;
    if (isSplat)
    {
      goto LABEL_20;
...
LABEL_142:
  ...
  if (v24)
  {
    RawData = mlir::mps::MPSBufferTensorAttr::getRawData(v104);
    v3 = v25;
    if ((isSplat & 1) == 0)
    {
      goto LABEL_27;
...
LABEL_148:
  if (mlir::Type::isInteger(&ElementType, 1))
  {
    ...
    mlir::detail::unpackBooleanData(RawData, v3, v104[0], v104[1]);
    v73 = v104[0];
    if (NumElements >= 1)
    {
      v74 = 0;
  ...
  else
  {
    ...
    if (v78 != &mlir::detail::TypeIDResolver<mlir::ComplexType,void>::id)
    {
      mlir::Type::getIntOrFloatBitWidth(&ElementType);
      IntOrFloatBitWidth = mlir::Type::getIntOrFloatBitWidth(&ElementType);
      mlir::detail::unpackQuantizedData<complex_support::complex_fp<float,(void *)0>>(RawData, v3, a3, NumElements, IntOrFloatBitWidth);
      return;
    }

    v99 = mlir::ComplexType::getElementType(v104);
    if (mlir::Type::isF32(&v99))
    {
      if (NumElements < 1)
      {
        return;
      ...
      if (isSplat)
      {
        if (NumElements >= 8 && ((RawData + 8) <= a3 || a3 + 8 * NumElements <= RawData))
        {
          v80 = NumElements & 0x7FFFFFFFFFFFFFFCLL;
          v96 = vld1q_dup_f64(RawData);
          v97 = (a3 + 16);
