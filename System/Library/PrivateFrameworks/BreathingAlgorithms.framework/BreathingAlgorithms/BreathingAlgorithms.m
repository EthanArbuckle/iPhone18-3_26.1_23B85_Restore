...
void *std::vector<NebulaNotification::BDReport>::reserve(void *result, unint64_t a2)
{
  if (0xAAAAAAAAAAAAAAABLL * ((result[2] - *result) >> 3) < a2)
  {
    ...
    {
      v2 = result[1] - *result;
      std::__allocate_at_least[abi:ne200100]<std::allocator<NebulaNotification::BDReport>>(result, a2);
    }
...
void writeJsonFile(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v3, OS_LOG_TYPE_DEFAULT))
  {
    *buf = 138543362;
    *&buf[4] = v2;
    _os_log_impl(&dword_241E46000, v3, OS_LOG_TYPE_DEFAULT, "writing to %{public}@", buf, 0xCu);
  }
...
void sub_241E49BB4(void *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, char a10, uint64_t a11, std::locale a12)
{
  MEMORY[0x245D021B0](&a10);
...
void sub_241E4D47C(_Unwind_Exception *a1, uint64_t a2, ...)
{
  va_start(va, a2);
...
void sub_241E4D850(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, ...)
{
  va_start(va, a4);
  std::__split_buffer<nlohmann::basic_json<std::map,std::vector,std::string,BOOL,long long,unsigned long long,double,std::allocator,nlohmann::adl_serializer,std::vector<unsigned char>>>::~__split_buffer(va);
  _Unwind_Resume(a1);
...
void sub_241E4F32C(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, ...)
{
  va_start(va, a4);
  std::__split_buffer<nlohmann::basic_json<std::map,std::vector,std::string,BOOL,long long,unsigned long long,double,std::allocator,nlohmann::adl_serializer,std::vector<unsigned char>>>::~__split_buffer(va);
  _Unwind_Resume(a1);
...
void NebulaNotification::Processor::Impl::process(uint64_t a1@<X1>, uint64_t a2@<X8>)
{
  ...
  if (v4 > 9)
  {
    if (v7)
    {
      NebulaNotification::Processor::Impl::process((a1 + 8), a1);
    }
...
void *OUTLINED_FUNCTION_0_0@<X0>(void *result@<X0>, void *a2@<X1>, uint64_t a3@<X8>)
{
  *(v3 - 8) = a3;
  v4 = *result - *a2;
  return result;
...
void NebulaNotification::Processor::Processor(os_log_t log)
{
  ...
  v2 = 136315138;
  v3 = "1.0.3";
  _os_log_debug_impl(&dword_241E46000, log, OS_LOG_TYPE_DEBUG, "Nebula Notification Algs Version: %s", &v2, 0xCu);
  v1 = *MEMORY[0x277D85DE8];
}

void NebulaNotification::Processor::Impl::process(void *a1, void *a2)
{
  OUTLINED_FUNCTION_0_0(a1, a2, *MEMORY[0x277D85DE8]);
  LODWORD(v7) = 134217984;
  *(&v7 + 4) = v2 / v3;
  OUTLINED_FUNCTION_1_0(&dword_241E46000, v4, v5, "Nebula Notification BD length: %zu", v7);
  v6 = *MEMORY[0x277D85DE8];
}

{
  ...
  LODWORD(v7) = 134217984;
  *(&v7 + 4) = v2 / v3;
  OUTLINED_FUNCTION_1_0(&dword_241E46000, v4, v5, "Nebula Notification BD length lower than 10: %zu", v7);
  v6 = *MEMORY[0x277D85DE8];
}
...
void NebulaNotification::Processor::Impl::process(char a1, NSObject *a2, float a3)
{
  ...
  v8 = 2080;
  v9 = v3;
  _os_log_debug_impl(&dword_241E46000, a2, OS_LOG_TYPE_DEBUG, "Nebula Notification BD Portion: %f, Result: %s", &v6, 0x16u);
