...
- (PKPeerPaymentService)init
{
  ...
  if (v3)
  {
    ...
    *(v3 + 5) = 0;
    v13 = [MEMORY[0x1E696AC70] pk_weakObjectsHashTableUsingPointerPersonality];
    self = *(v3 + 6);
    *(v3 + 6) = v13;
LABEL_7:
  }
...
- (PKPeerPaymentAccount)account
{
  ...
  v4 = [v13[5] isAccountStateDirty];
  v5 = v13[5];
  if ((v4 & 1) != 0 || (v6 = [v5 isAccountOutOfDate], v5 = v13[5], (v5 == 0) | v6 & 1))
  {
    v7 = v5;
...
- (void)setSharedPeerPaymentWebServiceContext:(id)a3
{
  ...
  if (v5)
  {
    ...
    [v6 usingSynchronousProxy:1 setSharedPeerPaymentWebServiceContext:v5 withCompletion:&__block_literal_global_235];
  }
...
- (void)presentPeerPaymentTermsAndConditionsWithAccount:(id)a3 orientation:(id)a4 completion:(id)a5
{
  ...
  v10 = a4;
  v11 = a5;
  v12 = [v9 termsIdentifier];
  v13 = [v9 termsURL];
  v14 = [v9 associatedPassUniqueID];
  if (!v13)
  {
...
- (void)setLastUsedAlternateFundingSourcePassUniqueIdentifier:(id)a3
{
  v5 = a3;
  v6 = [(PKPeerPaymentService *)self _synchronousRemoteObjectProxyForSelector:a2];
  [v6 setLastUsedAlternateFundingSourcePassUniqueIdentifier:v5 handler:&__block_literal_global_54_2];
}
...
- (void)insertOrUpdateUserInfo:(id)a3 completion:(id)a4
{
  ...
  v14 = v8;
  v12 = v8;
  [v11 insertOrUpdateUserInfo:v9 completion:v13];
}
