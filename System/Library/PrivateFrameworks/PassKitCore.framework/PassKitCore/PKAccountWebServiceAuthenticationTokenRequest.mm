@interface PKAccountWebServiceAuthenticationTokenRequest
- (id)_urlRequestWithAppleAccountInformation:(id)information;
@end

@implementation PKAccountWebServiceAuthenticationTokenRequest
...
LABEL_11:
  ...
  if (accountIdentifier)
  {
    ...
    v15[2] = @"authenticationToken";
    v7 = [MEMORY[0x1E695DEC8] arrayWithObjects:v15 count:3];
    v8 = [(PKAccountWebServiceRequest *)self _murlRequestWithServiceURL:self->_baseURL endpointComponents:v7 queryParameters:&unk_1F23B59F0 appleAccountInformation:v5];
