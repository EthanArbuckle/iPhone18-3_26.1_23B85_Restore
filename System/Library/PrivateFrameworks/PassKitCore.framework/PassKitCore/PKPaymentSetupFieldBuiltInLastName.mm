...
- (PKPaymentSetupFieldBuiltInLastName)initWithIdentifier:(id)identifier type:(unint64_t)type;
@end
...
- (PKPaymentSetupFieldBuiltInLastName)initWithIdentifier:(id)identifier type:(unint64_t)type
{
  ...
  v4 = [(PKPaymentSetupFieldText *)&v7 initWithIdentifier:@"lastName" type:type];
  if (v4)
  {
