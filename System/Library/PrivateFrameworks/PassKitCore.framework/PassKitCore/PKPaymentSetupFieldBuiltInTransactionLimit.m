...
{
  v18.receiver = self;
  v18.super_class = PKPaymentSetupFieldBuiltInTransactionLimit;
  v9 = [(PKPaymentSetupFieldText *)&v18 initWithIdentifier:@"transactionLimit" type:a4];
  if (v9)
  {
    v10 = PKLocalizedFeatureString(@"TRANSACTION_LIMIT_AMOUNT", 2, 0, v4, v5, v6, v7, v8, v18.receiver);
