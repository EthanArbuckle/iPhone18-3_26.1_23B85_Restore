...
- (PKPeerPaymentDynamicFraudPageBodyBulletedListContent)initWithCoder:(id)coder;
- (PKPeerPaymentDynamicFraudPageBodyBulletedListContent)initWithDictionary:(id)dictionary;
- (id)description;
- (unint64_t)hash;
...
- (PKPeerPaymentDynamicFraudPageBodyBulletedListContent)initWithDictionary:(id)dictionary
{
  ...
  v5 = [(PKPeerPaymentDynamicFraudPageBodyContent *)&v26 initWithDictionary:dictionaryCopy];
  if (v5)
  {
    v6 = [dictionaryCopy PKArrayContaining:objc_opt_class() forKey:@"lines"];
    ...
    v18 = [dictionaryCopy PKDictionaryForKey:@"footer"];
...
- (PKPeerPaymentDynamicFraudPageBodyBulletedListContent)initWithCoder:(id)coder
{
  ...
  v5 = [(PKPeerPaymentDynamicFraudPageBodyContent *)&v14 initWithCoder:coderCopy];
  if (v5)
  {
    v6 = MEMORY[0x1E695DFD8];
    v7 = objc_opt_class();
    v8 = [v6 setWithObjects:{v7, objc_opt_class(), 0}];
    v9 = [coderCopy decodeObjectOfClasses:v8 forKey:@"lines"];
    lines = v5->_lines;
    v5->_lines = v9;

    v11 = [coderCopy decodeObjectOfClass:objc_opt_class() forKey:@"footer"];
    footer = v5->_footer;
    v5->_footer = v11;
  }
...
- (void)encodeWithCoder:(id)coder
{
  ...
  [coderCopy encodeObject:self->_lines forKey:{@"lines", v5.receiver, v5.super_class}];
...
- (unint64_t)hash
{
  ...
  [array safelyAddObject:self->_lines];
  [array safelyAddObject:self->_footer];
