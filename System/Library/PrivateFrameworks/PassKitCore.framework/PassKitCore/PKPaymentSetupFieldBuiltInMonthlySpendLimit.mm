...
- (PKPaymentSetupFieldBuiltInMonthlySpendLimit)initWithIdentifier:(id)identifier type:(unint64_t)type;
@end
...
- (PKPaymentSetupFieldBuiltInMonthlySpendLimit)initWithIdentifier:(id)identifier type:(unint64_t)type
{
  ...
  v9 = [(PKPaymentSetupFieldText *)&v18 initWithIdentifier:@"monthlySpendLimit" type:type];
  if (v9)
  {
