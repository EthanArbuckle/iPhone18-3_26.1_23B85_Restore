  ...
  if (v3)
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v8, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *buf = 138543362;
        v16 = v12;
        _os_log_impl(&dword_1AD337000, v8, OS_LOG_TYPE_DEFAULT, "Malformed PKPeerPaymentAssociatedAccountActionResponse: expected dictionary and received %{public}@", buf, 0xCu);
      }
    }
  }
