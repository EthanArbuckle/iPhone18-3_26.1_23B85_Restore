...
- (id)description
{
  ...
  dictionaryRepresentation = [(PKProtobufPromptDetailsForVirtualCard *)self dictionaryRepresentation];
...
- (void)copyTo:(id)to
{
  ...
  if (*&self->_has)
  {
    toCopy[16] = self->_showNotification;
    toCopy[20] |= 1u;
  }
}
...
- (void)mergeFrom:(id)from
{
  ...
  if (fromCopy[20])
  {
    self->_showNotification = fromCopy[16];
    *&self->_has |= 1u;
  }
}
