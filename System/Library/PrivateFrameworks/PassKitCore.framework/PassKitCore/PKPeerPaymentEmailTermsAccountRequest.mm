...
- (id)_urlRequestWithServiceURL:(id)l appleAccountInformation:(id)information
{
  ...
  if (lCopy)
  {
    if (informationCopy)
    {
      v9 = [(PKPeerPaymentWebServiceRequest *)self _murlRequestWithServiceURL:lCopy endpointComponents:&unk_1F23B4838 queryParameters:0 appleAccountInformation:informationCopy];
      [v9 setHTTPMethod:@"POST"];
      [v9 setValue:@"application/json" forHTTPHeaderField:@"Content-Type"];
      dictionary = [MEMORY[0x1E695DF90] dictionary];
      [dictionary setObject:@"emailTerms" forKey:@"action"];
