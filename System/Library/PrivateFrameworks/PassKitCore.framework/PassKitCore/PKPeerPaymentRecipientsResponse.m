@interface PKPeerPaymentRecipientsResponse
- (PKPeerPaymentRecipientsResponse)initWithData:(id)a3;
@end

@implementation PKPeerPaymentRecipientsResponse

- (PKPeerPaymentRecipientsResponse)initWithData:(id)a3
{
  v30 = *MEMORY[0x1E69E9840];
  v24.receiver = self;
  v24.super_class = PKPeerPaymentRecipientsResponse;
  ...
  if (v3)
  {
    ...
    if (objc_opt_isKindOfClass())
    {
      ...
      v22 = 0u;
      v23 = 0u;
      v8 = [v6 PKArrayForKey:@"recipients", 0];
      ...
      if (v9)
      {
        ...
        do
        {
          ...
          do
          {
            ...
            v13 = [PKPeerPaymentRecipient recipientWithDictionary:*(*(&v20 + 1) + 8 * v12)];
            [v7 addObject:v13];
