...
- (PKAccountFundingSourceVerificationAction)initWithCoder:(id)coder;
- (PKAccountFundingSourceVerificationAction)initWithDictionary:(id)dictionary;
...
- (void)encodeWithCoder:(id)coder
{
  ...
  [coderCopy encodeObject:self->_verificationOptions forKey:@"options"];
}
...
- (unint64_t)hash
{
  ...
  [array safelyAddObject:self->_verificationOptions];
...
- (id)copyWithZone:(_NSZone *)zone
{
  ...
  v5->_type = self->_type;
  v6 = [(NSArray *)self->_verificationOptions copyWithZone:zone];
  verificationOptions = v5->_verificationOptions;
