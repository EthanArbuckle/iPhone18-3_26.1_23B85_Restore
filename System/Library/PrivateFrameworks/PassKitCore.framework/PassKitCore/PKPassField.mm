...
- (NSString)value;
- (PKPassField)init;
- (PKPassField)initWithCoder:(id)coder;
- (id)asDictionary;
...
- (void)setUnformattedValue:(id)value;
@end
...
- (PKPassField)initWithCoder:(id)coder
{
  ...
  if (v5)
  {
    ...
    v9 = [coderCopy decodeObjectOfClass:objc_opt_class() forKey:@"label"];
    label = v5->_label;
    v5->_label = v9;

    v11 = [coderCopy decodeObjectOfClass:objc_opt_class() forKey:@"labelImage"];
    labelImage = v5->_labelImage;
    v5->_labelImage = v11;

    v13 = [coderCopy decodeObjectOfClass:objc_opt_class() forKey:@"accessibilityLabel"];
    ...
    v17 = [coderCopy decodeObjectOfClass:objc_opt_class() forKey:@"valueImage"];
    ...
    v23 = [coderCopy decodeObjectOfClasses:v22 forKey:@"unformattedValue"];
    unformattedValue = v5->_unformattedValue;
    v5->_unformattedValue = v23;

    v25 = [coderCopy decodeObjectOfClass:objc_opt_class() forKey:@"accessibilityValue"];
    accessibilityValue = v5->_accessibilityValue;
    v5->_accessibilityValue = v25;

    v27 = [coderCopy decodeObjectOfClass:objc_opt_class() forKey:@"accessoryImage"];
    accessoryImage = v5->_accessoryImage;
    v5->_accessoryImage = v27;

    v29 = [coderCopy decodeObjectOfClass:objc_opt_class() forKey:@"link"];
    link = v5->_link;
    v5->_link = v29;

    v31 = [coderCopy decodeObjectOfClass:objc_opt_class() forKey:@"changeMessage"];
    changeMessage = v5->_changeMessage;
    v5->_changeMessage = v31;

    v5->_textAlignment = [coderCopy decodeIntegerForKey:@"textAlignment"];
    v5->_dataDetectorTypes = [coderCopy decodeIntegerForKey:@"dataDetectorTypes"];
    v33 = MEMORY[0x1E695DFD8];
    v34 = objc_opt_class();
    v35 = objc_opt_class();
    v36 = [v33 setWithObjects:{v34, v35, objc_opt_class(), 0}];
    v37 = [coderCopy decodeObjectOfClasses:v36 forKey:@"semantics"];
    semantics = v5->_semantics;
    v5->_semantics = v37;

    v5->_cellStyle = [coderCopy decodeIntegerForKey:@"cellStyle"];
    v5->_foreignReferenceType = [coderCopy decodeIntegerForKey:@"foreignReferenceType"];
    v5->_unitType = [coderCopy decodeIntForKey:@"unitType"];
    v39 = objc_alloc(MEMORY[0x1E695DFD8]);
    v40 = objc_opt_class();
    v41 = [v39 initWithObjects:{v40, objc_opt_class(), 0}];
    v42 = [coderCopy decodeObjectOfClasses:v41 forKey:@"combinedForeignReferenceIdentifiers"];
    foreignReferenceIdentifiers = v5->_foreignReferenceIdentifiers;
    v5->_foreignReferenceIdentifiers = v42;

    v44 = [coderCopy decodeObjectOfClass:objc_opt_class() forKey:@"row"];
    v5->_row = [v44 unsignedIntegerValue];

    [coderCopy decodeFloatForKey:@"amount"];
    v5->_amount = v45;
...
- (void)encodeWithCoder:(id)coder
{
  ...
  [coderCopy encodeObject:self->_labelImage forKey:@"labelImage"];
  [coderCopy encodeObject:self->_accessibilityLabel forKey:@"accessibilityLabel"];
  [coderCopy encodeObject:self->_value forKey:@"value"];
  [coderCopy encodeObject:self->_valueImage forKey:@"valueImage"];
  [coderCopy encodeObject:self->_unformattedValue forKey:@"unformattedValue"];
  [coderCopy encodeObject:self->_accessibilityValue forKey:@"accessibilityValue"];
  [coderCopy encodeObject:self->_accessoryImage forKey:@"accessoryImage"];
  [coderCopy encodeObject:self->_link forKey:@"link"];
  [coderCopy encodeObject:self->_changeMessage forKey:@"changeMessage"];
  [coderCopy encodeInteger:self->_textAlignment forKey:@"textAlignment"];
  [coderCopy encodeInteger:self->_dataDetectorTypes forKey:@"dataDetectorTypes"];
  [coderCopy encodeObject:self->_semantics forKey:@"semantics"];
  [coderCopy encodeInteger:self->_cellStyle forKey:@"cellStyle"];
  [coderCopy encodeInteger:self->_foreignReferenceType forKey:@"foreignReferenceType"];
  [coderCopy encodeInteger:self->_unitType forKey:@"unitType"];
  [coderCopy encodeObject:self->_foreignReferenceIdentifiers forKey:@"combinedForeignReferenceIdentifiers"];
  v7 = [MEMORY[0x1E696AD98] numberWithUnsignedInteger:self->_row];
  [coderCopy encodeObject:v7 forKey:@"row"];

  amount = self->_amount;
  *&amount = amount;
  [coderCopy encodeFloat:@"amount" forKey:amount];
  threshold = self->_threshold;
  *&threshold = threshold;
  [coderCopy encodeFloat:@"threshold" forKey:threshold];
}
...
- (id)asMutableDictionary
{
  ...
  if (self->_labelImage)
  {
    ...
    v58[0] = @"symbolName";
    symbolName = [(PKPassFieldImage *)self->_labelImage symbolName];
    v59[0] = symbolName;
    v58[1] = @"imageName";
    imageName = [(PKPassFieldImage *)self->_labelImage imageName];
    v59[1] = imageName;
    v58[2] = @"tintColor";
  ...
  if (self->_valueImage)
  {
    ...
    v56[0] = @"symbolName";
    symbolName2 = [(PKPassFieldImage *)self->_valueImage symbolName];
    v57[0] = symbolName2;
    v56[1] = @"imageName";
    imageName2 = [(PKPassFieldImage *)self->_valueImage imageName];
    v57[1] = imageName2;
    v56[2] = @"tintColor";
  ...
  if (self->_accessoryImage)
  {
    ...
    v54[0] = @"symbolName";
    symbolName3 = [(PKPassFieldImage *)self->_accessoryImage symbolName];
    v55[0] = symbolName3;
    v54[1] = @"imageName";
    imageName3 = [(PKPassFieldImage *)self->_accessoryImage imageName];
    v55[1] = imageName3;
    v54[2] = @"tintColor";
...
- (id)description
{
  ...
  label = self->_label;
  value = [(PKPassField *)self value];
  v5 = [v2 stringWithFormat:@"[%@][%@]", label, value];
