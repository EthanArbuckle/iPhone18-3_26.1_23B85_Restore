...
- (PKCreditAccountDetails)initWithDictionary:(id)a3
{
  ...
  if (v5)
  {
    ...
    v10 = [v4 PKDateForKey:@"mergeDate"];
    mergeDate = v5->_mergeDate;
    v5->_mergeDate = v10;

    v12 = [v4 PKStringForKey:@"countryCode"];
    ...
    if (v7)
    {
      ...
      while (1)
      {
        for (i = 0; i != v8; ++i)
        {
          ...
          {
            v18 = [v12 mergeVirtualCardWith:v4];
            [v21 removeObject:v12];
            [v21 addObject:v18];
          }
...
- (PKCreditAccountDetails)initWithCoder:(id)a3
{
  ...
  if (v5)
  {
    ...
    v10 = [v4 decodeObjectOfClass:objc_opt_class() forKey:@"mergeDate"];
    mergeDate = v5->_mergeDate;
    v5->_mergeDate = v10;
    ...
    v16 = [v4 decodeObjectOfClass:objc_opt_class() forKey:@"productTimeZone"];
    productTimeZone = v5->_productTimeZone;
    ...
    v21 = [v4 decodeObjectOfClasses:v20 forKey:@"virtualCards"];
    virtualCards = v5->_virtualCards;
    v5->_virtualCards = v21;

    v23 = [v4 decodeObjectOfClass:objc_opt_class() forKey:@"termsURL"];
    termsURL = v5->_termsURL;
    v5->_termsURL = v23;
    ...
    v27 = [v4 decodeObjectOfClass:objc_opt_class() forKey:@"associatedPassURL"];
    associatedPassURL = v5->_associatedPassURL;
    v5->_associatedPassURL = v27;

    v29 = [v4 decodeObjectOfClass:objc_opt_class() forKey:@"associatedPassTypeIdentifier"];
    associatedPassTypeIdentifier = v5->_associatedPassTypeIdentifier;
    ...
    v33 = [v4 decodeObjectOfClass:objc_opt_class() forKey:@"accountSummary"];
    accountSummary = v5->_accountSummary;
    v5->_accountSummary = v33;

    v35 = [v4 decodeObjectOfClass:objc_opt_class() forKey:@"rates"];
    rates = v5->_rates;
    v5->_rates = v35;
    ...
    v40 = [v4 decodeObjectOfClasses:v39 forKey:@"installmentPlans"];
    installmentPlans = v5->_installmentPlans;
...
LABEL_72:
  if (self->_termsAcceptanceRequired != *(v4 + 8) || self->_cardType != v4[15] || self->_rewardsDestination != v4[19])
  {
    goto LABEL_78;
  }
...
- (id)description
{
  ...
  v8 = [(NSTimeZone *)self->_productTimeZone name];
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v10 = [(NSDate *)self->_mergeDate copyWithZone:a3];
  mergeDate = v5->_mergeDate;
  v5->_mergeDate = v10;

  v12 = [(NSString *)self->_countryCode copyWithZone:a3];
  countryCode = v5->_countryCode;
  v5->_countryCode = v12;
  ...
  v16 = [(NSTimeZone *)self->_productTimeZone copyWithZone:a3];
  productTimeZone = v5->_productTimeZone;
  v5->_productTimeZone = v16;
  ...
  v27 = [(NSURL *)self->_termsURL copyWithZone:a3];
  termsURL = v5->_termsURL;
  v5->_termsURL = v27;

  v29 = [(NSString *)self->_termsIdentifier copyWithZone:a3];
  termsIdentifier = v5->_termsIdentifier;
  v5->_termsIdentifier = v29;

  v5->_termsAcceptanceRequired = self->_termsAcceptanceRequired;
  v31 = [(NSURL *)self->_associatedPassURL copyWithZone:a3];
  associatedPassURL = v5->_associatedPassURL;
  v5->_associatedPassURL = v31;

  v33 = [(NSString *)self->_associatedPassSerialNumber copyWithZone:a3];
  associatedPassSerialNumber = v5->_associatedPassSerialNumber;
  v5->_associatedPassSerialNumber = v33;

  v35 = [(NSString *)self->_associatedPassTypeIdentifier copyWithZone:a3];
  associatedPassTypeIdentifier = v5->_associatedPassTypeIdentifier;
...
- (PKCurrencyAmount)cardBalance
{
  ...
  v4 = [(PKCreditAccountSummary *)self->_accountSummary balanceSummary];
  v5 = [v4 pendingPurchases];
  ...
  if (!v6)
  {
    v8 = [(NSDecimalNumber *)v3 decimalNumberByAdding:v5];
LABEL_11:
    v9 = v8;
    v7 = PKCurrencyAmountCreate(v8, self->_currencyCode, 0);
  ...
  v7 = PKCurrencyAmountCreate(v3, self->_currencyCode, 0);
LABEL_12:
...
- (BOOL)isInMonthOfMerge
{
  ...
  v3 = [(PKCreditAccountSummary *)self->_accountSummary balanceSummary];
  v4 = v3;
  if (v3)
  {
    v5 = [v3 openingDate];
