...
+ (id)generateSummaryOfType:(unint64_t)type startingAt:(id)at withSegmentLimit:(unint64_t)limit generateBeyondCurrentDay:(BOOL)day;
@end
...
+ (id)generateSummaryOfType:(unint64_t)type startingAt:(id)at withSegmentLimit:(unint64_t)limit generateBeyondCurrentDay:(BOOL)day
{
  ...
  switch(type)
  {
    ...
    case 0uLL:
      ...
      v11 = 0x2000;
LABEL_7:
      [v9 rangeOfUnit:v10 inUnit:v11 forDate:atCopy];
      v13 = v12;
      goto LABEL_9;
  }
...
LABEL_9:
  ...
  v53[0] = v16;
  v43 = v15;
  [currentCalendar rangeOfUnit:v15 startDate:v53 interval:0 forDate:atCopy];
  v45 = v53[0];
  ...
  if (v13)
  {
    ...
    {
      v47 = v17;
      v20 = [currentCalendar dateByAddingUnit:v43 value:v41 toDate:? options:?];
      ...
      do
      {
        if (v22)
        {
          if (([currentCalendar compareDate:v20 toDate:atCopy toUnitGranularity:16] != 1 || dayCopy) && arc4random_uniform(3u))
          {
            v24 = arc4random_uniform(limitCopy + 1);
          }
  ...
  [(PKSpendingSummary *)v33 setSummaryType:type];
  firstObject = [v46 firstObject];
  startDate = [firstObject startDate];
  [(PKSpendingSummary *)v33 setStartDate:startDate];

  lastObject = [v46 lastObject];
  endDate = [lastObject endDate];
  [(PKSpendingSummary *)v33 setEndDate:endDate];
