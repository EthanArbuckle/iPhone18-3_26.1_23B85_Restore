...
- (PKPaymentSetupFieldBuiltInTransactionLimit)initWithIdentifier:(id)identifier type:(unint64_t)type;
@end
...
- (PKPaymentSetupFieldBuiltInTransactionLimit)initWithIdentifier:(id)identifier type:(unint64_t)type
{
  ...
  v9 = [(PKPaymentSetupFieldText *)&v18 initWithIdentifier:@"transactionLimit" type:type];
  if (v9)
  {
