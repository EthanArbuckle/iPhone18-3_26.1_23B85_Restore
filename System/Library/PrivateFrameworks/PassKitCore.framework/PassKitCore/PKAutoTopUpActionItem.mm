...
- (PKAutoTopUpActionItem)initWithCoder:(id)a3
{
  ...
  if (v5)
  {
    ...
    v12 = [v4 decodeObjectOfClasses:v8 forKey:@"defaultThresholdSuggestions"];
    v13 = [v12 copy];
    defaultThresholdSuggestions = v5->_defaultThresholdSuggestions;
    v5->_defaultThresholdSuggestions = v13;

    v15 = [v4 decodeObjectOfClasses:v8 forKey:@"lowBalanceReminderOptions"];
    v16 = [v15 copy];
    lowBalanceReminderOptions = v5->_lowBalanceReminderOptions;
    ...
    v27 = [v4 decodeObjectOfClasses:v26 forKey:@"serviceProviderData"];
    v28 = [v27 copy];
    serviceProviderData = v5->_serviceProviderData;
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v6 = [(NSArray *)self->_defaultAmountSuggestions copyWithZone:a3];
  v7 = v5[1];
  v5[1] = v6;

  v8 = [(NSArray *)self->_defaultThresholdSuggestions copyWithZone:a3];
  v9 = v5[2];
  v5[2] = v8;
  ...
  v12 = [(NSArray *)self->_lowBalanceReminderOptions copyWithZone:a3];
  v13 = v5[3];
  v5[3] = v12;
