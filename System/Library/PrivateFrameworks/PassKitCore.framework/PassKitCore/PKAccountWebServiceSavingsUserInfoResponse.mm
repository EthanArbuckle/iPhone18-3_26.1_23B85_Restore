...
- (PKAccountWebServiceSavingsUserInfoResponse)initWithData:(id)data;
@end
...
- (PKAccountWebServiceSavingsUserInfoResponse)initWithData:(id)data
{
  ...
  v15.receiver = self;
  v15.super_class = PKAccountWebServiceSavingsUserInfoResponse;
  ...
  {
    v6 = [[PKSavingsAccountUserInfo alloc] initWithDictionary:jSONObject];
