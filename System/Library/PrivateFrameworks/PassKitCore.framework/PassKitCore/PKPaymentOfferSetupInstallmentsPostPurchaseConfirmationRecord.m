...
@implementation PKPaymentOfferSetupInstallmentsPostPurchaseConfirmationRecord

- (id)_init
{
  v3.receiver = self;
  v3.super_class = PKPaymentOfferSetupInstallmentsPostPurchaseConfirmationRecord;
