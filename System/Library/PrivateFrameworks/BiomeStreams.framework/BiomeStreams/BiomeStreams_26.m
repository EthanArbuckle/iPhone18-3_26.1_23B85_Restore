...
uint64_t pg_query_scan(uint64_t a1)
{
  ...
  *v2 = 0u;
  ...
  v45 = 0;
  v44 = 0;
  v41 = xmmword_1E6E55A08;
  v42 = unk_1E6E55A18;
  v43 = xmmword_1E6E55A28;
  ...
  else
  {
    ...
    v40 = v3;
    *v9 = v48;
    v14 = scanner_init(v1, v46, &ScanKeywords, &ScanKeywordTokens);
    v15 = -1;
    v16 = -8;
    do
    {
    ...
    while (v19);
    scanner_finish(v14);
    v22 = malloc_type_malloc(v21, 0x2004093837F09uLL);
    v23 = scanner_init(v1, v46, &ScanKeywords, &ScanKeywordTokens);
    v24 = core_yylex(&v45, &v44, v23);
    if (v24)
    {
      v25 = v24;
      v26 = v22;
      do
      {
        ...
        *v26 = v29;
        pg_query__scan_token__init(v29);
        v30 = v44;
        *(*v26 + 6) = v44;
    ...
    *&v43 = v20;
    *(&v43 + 1) = v22;
    packed_size = pg_query__scan_result__get_packed_size(&v41);
    *v40 = packed_size;
    v33 = malloc_type_malloc(packed_size, 0x3121CBB5uLL);
    *(v40 + 1) = v33;
    pg_query__scan_result__pack(&v41, v33);
    if (v20)
    {
      v34 = 0;
      do
