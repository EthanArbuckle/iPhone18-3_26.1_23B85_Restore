...
LABEL_11:
  ...
  v22 = [optionCopy isEqualToString:@"aboveDoorShortAddress"];
  ...
  if ((v22 & 1) == 0)
  {
    ...
    v23 = 138412802;
    v24 = structuredAddress2;
    v25 = 2112;
    v26 = optionCopy;
    v27 = 2112;
    v28 = aboveDoorShortAddress;
    _os_log_error_impl(&dword_22D8C5000, address2, OS_LOG_TYPE_ERROR, "%@, unrecognized format option, %@, will use default, %@", &v23, 0x20u);
LABEL_3:
