...
- (id)description
{
  v2 = [objc_alloc(MEMORY[0x277CCACA8]) initWithFormat:@"isGComplete, %d, pr, %lu, social context count, %@, density score, %@, scan duration, %@", self->_isGComplete, self->_gaPR, self->_pCount, self->_densityScore, self->_densityScanDuration];
