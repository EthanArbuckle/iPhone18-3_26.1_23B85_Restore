...
LABEL_39:
  ...
  v10 = [(MOAssetProperty *)self favorite];
  v11 = @"NO";
  if (v10)
  {
    v11 = @"YES";
  ...
  v12 = [v7 stringWithFormat:@"<MOAssetProperty localToPhotoLibraryIdentifier: %@, location: %@, mediaType: %@, mediaSubtypes: %@, favorite: %@>", v8, v9, v3, v6, v11];
