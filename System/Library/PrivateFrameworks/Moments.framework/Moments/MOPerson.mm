...
- (id)description
{
  ...
  v15 = [v17 stringWithFormat:@"<MOPerson localIdentifier, %@, name, %@, contactIdentifier, %@, isPHPersonTypeImportant, %d, isMePerson, %d, mePersonIdentified, %d, peopleClassification, %@, family, %@, significanceScore, %.1f, priorityScore, %.1f>", localIdentifier, mask, contactIdentifier, isPHPersonTypeImportant, isMePerson, mePersonIdentified, personRelationships, family, v13, v14];
...
- (MOPerson)initWithCoder:(id)coder
{
  ...
  v14 = [coderCopy decodeObjectOfClasses:v13 forKey:@"personRelationships"];
  ...
  if (v18)
  {
    v19 = [coderCopy decodeObjectOfClass:objc_opt_class() forKey:@"sourceEventIdentifier"];
    [(MOPerson *)v18 setSourceEventIdentifier:v19];

    -[MOPerson setSourceEventAccessType:](v18, "setSourceEventAccessType:", [coderCopy decodeInt64ForKey:@"sourceEventAccessType"]);
    v20 = [coderCopy decodeObjectOfClass:objc_opt_class() forKey:@"givenName"];
