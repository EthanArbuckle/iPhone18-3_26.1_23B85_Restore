...
- (MapsSyncManagedHistoryPlaceItem)initWithEntity:(id)entity insertIntoManagedObjectContext:(id)context;
@end
...
{
  v7.receiver = self;
  v7.super_class = type metadata accessor for MapsSyncManagedHistoryPlaceItem();
