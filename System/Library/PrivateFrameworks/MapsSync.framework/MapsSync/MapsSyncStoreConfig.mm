...
+ (id)withConfigWithPrimary:(int64_t)primary cache:(int64_t)cache;
...
+ (id)withConfigWithPrimary:(int64_t)primary cache:(int64_t)cache
{
  ...
  *&v7[OBJC_IVAR____TtC8MapsSync19MapsSyncStoreConfig_primary] = primary;
  *&v7[OBJC_IVAR____TtC8MapsSync19MapsSyncStoreConfig_cache] = cache;
  v10.receiver = v7;
  v10.super_class = v6;
