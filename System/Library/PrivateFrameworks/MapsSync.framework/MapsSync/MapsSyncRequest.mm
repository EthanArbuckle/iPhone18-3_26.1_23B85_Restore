...
- (void)batchDeleteWithOptions:(_TtC8MapsSync20MapsSyncQueryOptions *)a3 completionHandler:(id)a4;
- (void)batchUpdateWithOptions:(_TtC8MapsSync20MapsSyncQueryOptions *)a3 propertiesToUpdate:(NSDictionary *)a4 completionHandler:(id)a5;
...
- (void)fetchPropertiesWithOptions:(_TtC8MapsSync30MapsSyncDictionaryQueryOptions *)a3 completionHandler:(id)a4;
@end
