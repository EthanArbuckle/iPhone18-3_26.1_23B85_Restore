...
- (BOOL)listener:(id)a3 shouldAcceptNewConnection:(id)a4
{
  ...
  [a4 setExportedInterface:{objc_msgSend(MEMORY[0x277CCAE90], "interfaceWithProtocol:", &unk_286AB78B0)}];
  [objc_msgSend(a4 "exportedInterface")];
  [objc_msgSend(a4 "exportedInterface")];
  [objc_msgSend(a4 "exportedInterface")];
  [objc_msgSend(a4 "exportedInterface")];
  [objc_msgSend(a4 "exportedInterface")];
  [objc_msgSend(a4 "exportedInterface")];
  [objc_msgSend(a4 "exportedInterface")];
  [a4 setRemoteObjectInterface:{objc_msgSend(MEMORY[0x277CCAE90], "interfaceWithProtocol:", &unk_286AB90F0)}];
  [a4 setExportedObject:{+[AUServiceAdapter sharedInstance](AUServiceAdapter, "sharedInstance")}];
  v16[0] = 0;
  v16[1] = v16;
  v16[2] = 0x3052000000;
  ...
  {
    [+[AUServiceAdapter sharedInstance](AUServiceAdapter setActiveConnection:"setActiveConnection:", a4];
    [a4 resume];
    v11 = 1;
  }
