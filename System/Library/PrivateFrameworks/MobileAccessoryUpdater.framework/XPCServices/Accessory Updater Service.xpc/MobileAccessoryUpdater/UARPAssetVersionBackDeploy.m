...
LABEL_8:
  v11 = [(UARPAssetVersionBackDeploy *)self initWithMajorVersion:v6 minorVersion:v7 releaseVersion:v9 buildVersion:v10];
...
- (UARPAssetVersionBackDeploy)initWithBVERString:(id)a3
{
  ...
  v15 = [(UARPAssetVersionBackDeploy *)self initWithMajorVersion:v10 minorVersion:v9 releaseVersion:v7 buildVersion:v8];
...
{
  v4 = a3;
  v5 = [(UARPAssetVersionBackDeploy *)self majorVersion];
  if (v5 < [v4 majorVersion])
  {
    goto LABEL_2;
  }

  v7 = [(UARPAssetVersionBackDeploy *)self majorVersion];
...
LABEL_4:
  ...
  v9 = [(UARPAssetVersionBackDeploy *)self minorVersion];
  if (v9 >= [v4 minorVersion])
  {
    v10 = [(UARPAssetVersionBackDeploy *)self minorVersion];
    if (v10 > [v4 minorVersion])
    {
      goto LABEL_4;
    }

    v11 = [(UARPAssetVersionBackDeploy *)self releaseVersion];
    if (v11 >= [v4 releaseVersion])
    {
      v12 = [(UARPAssetVersionBackDeploy *)self releaseVersion];
      if (v12 <= [v4 releaseVersion])
      {
        v13 = [(UARPAssetVersionBackDeploy *)self buildVersion];
        if (v13 >= [v4 buildVersion])
        {
          v14 = [(UARPAssetVersionBackDeploy *)self buildVersion];
