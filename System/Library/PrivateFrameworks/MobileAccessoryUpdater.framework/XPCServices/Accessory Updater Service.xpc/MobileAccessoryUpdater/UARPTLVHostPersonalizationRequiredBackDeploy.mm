...
{
  v3.receiver = self;
  v3.super_class = UARPTLVHostPersonalizationRequiredBackDeploy;
...
- (id)description
{
  v3 = +[UARPTLVHostPersonalizationRequiredBackDeploy metaDataTableEntry];
...
- (id)generateTLV
{
  v3 = +[UARPTLVHostPersonalizationRequiredBackDeploy tlvType];
  v4 = *(&self->super.super._tlvLength + 4);
  v7.receiver = self;
  v7.super_class = UARPTLVHostPersonalizationRequiredBackDeploy;
...
- (id)tlvValue
{
  ...
  v5.receiver = self;
  v5.super_class = UARPTLVHostPersonalizationRequiredBackDeploy;
...
+ (id)metaDataTableEntry
{
  ...
  v5[0] = @"Name";
  v5[1] = @"Value";
  v2 = +[NSNumber numberWithUnsignedInt:](NSNumber, "numberWithUnsignedInt:", +[UARPTLVHostPersonalizationRequiredBackDeploy tlvType]);
  v6[1] = v2;
