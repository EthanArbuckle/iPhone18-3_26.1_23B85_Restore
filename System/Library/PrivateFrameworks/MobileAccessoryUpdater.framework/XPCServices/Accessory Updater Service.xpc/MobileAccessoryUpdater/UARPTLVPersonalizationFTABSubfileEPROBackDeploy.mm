...
{
  v3.receiver = self;
  v3.super_class = UARPTLVPersonalizationFTABSubfileEPROBackDeploy;
...
- (id)description
{
  v3 = +[UARPTLVPersonalizationFTABSubfileEPROBackDeploy metaDataTableEntry];
...
- (id)generateTLV
{
  v3 = +[UARPTLVPersonalizationFTABSubfileEPROBackDeploy tlvType];
  v4 = *(&self->super.super._tlvLength + 2);
  v7.receiver = self;
  v7.super_class = UARPTLVPersonalizationFTABSubfileEPROBackDeploy;
...
- (id)tlvValue
{
  ...
  v5.receiver = self;
  v5.super_class = UARPTLVPersonalizationFTABSubfileEPROBackDeploy;
...
+ (id)metaDataTableEntry
{
  ...
  v5[0] = @"Name";
  v5[1] = @"Value";
  v2 = +[NSNumber numberWithUnsignedInt:](NSNumber, "numberWithUnsignedInt:", +[UARPTLVPersonalizationFTABSubfileEPROBackDeploy tlvType]);
  v6[1] = v2;
