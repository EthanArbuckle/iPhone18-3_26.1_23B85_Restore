...
void sub_100007264(void *a1, NSObject *a2, uint64_t a3, const char *a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint8_t a9)
{
...
void sub_100007C28(void *a1, uint64_t a2, _DWORD *a3)
{
  ...
  if (v14)
  {
    if ([v5 dfuModeActive])
    {
      ...
      {
        uarpLogError(3u, "%s: Failed to accept superbinary; 0x%08x");
      }
    }
...
void sub_10000920C(void *a1, NSObject *a2, uint64_t a3, const char *a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint8_t a9)
{
...
void sub_100009764(uint64_t a1, void *a2, uint64_t a3, uint64_t a4, int a5)
{
...
uint64_t sub_10000DAC8(uint64_t a1, uint64_t a2, unsigned int a3)
{
  result = 30;
  if (a1 && a2)
  {
...
uint64_t sub_10000FC7C(uint64_t a1, uint64_t a2, unsigned int a3, unsigned int a4)
{
...
{
  vsnprintf(byte_10002AE10, 0x200uLL, a3, &a9);
  v10 = sub_1000121E0(a2);
  if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
  {
    sub_1000177F4(v10, v11, v12, v13, v14, v15, v16, v17);
  }
}
...
{
  vsnprintf(byte_10002B010, 0x200uLL, a3, &a9);
  v10 = sub_1000121E0(a2);
...
{
  vsnprintf(byte_10002B210, 0x200uLL, a3, &a9);
  v10 = sub_1000121E0(a2);
...
{
  vsnprintf(byte_10002B410, 0x200uLL, a3, &a9);
  v10 = sub_1000121E0(a2);
