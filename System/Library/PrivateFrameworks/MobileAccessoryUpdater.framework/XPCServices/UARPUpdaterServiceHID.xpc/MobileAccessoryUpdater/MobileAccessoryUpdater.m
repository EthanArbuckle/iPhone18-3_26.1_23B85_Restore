...
void sub_100001AD0(uint64_t a1)
{
  ...
  v46 = 0u;
  obj = *(a1 + 32);
  v2 = [obj countByEnumeratingWithState:&v43 objects:v48 count:16];
  if (v2)
  {
    v3 = v2;
    v4 = *v44;
    v5 = &compression_decode_buffer_ptr;
    v32 = *v44;
    do
    {
      v6 = 0;
      ...
      do
      {
        ...
        if (isKindOfClass)
        {
          v11 = [v7 hardwareID];
          v12 = *(a1 + 40);
          if (!v12 || ([v7 identifier], v13 = objc_claimAutoreleasedReturnValue(), v14 = objc_msgSend(v12, "isEqualToString:", v13), v13, v14))
          {
            v35 = v11;
            v36 = v6;
            v41 = 0u;
            ...
            v39 = 0u;
            v40 = 0u;
            v37 = [v11 personalities];
            v15 = [v37 countByEnumeratingWithState:&v39 objects:v47 count:16];
            if (v15)
            {
              v16 = v15;
              v17 = *v40;
              do
              {
                for (i = 0; i != v16; i = i + 1)
                {
                  ...
                  v19 = *(*(&v39 + 1) + 8 * i);
                  v20 = *(a1 + 48);
                  v21 = +[NSNumber numberWithUnsignedShort:](NSNumber, "numberWithUnsignedShort:", [v19 vendorID]);
                  v22 = +[NSNumber numberWithUnsignedShort:](NSNumber, "numberWithUnsignedShort:", [v19 productID]);
                  v23 = [v20 matchingDictionaryForVendorID:v21 productID:v22];
                  ...
                  if (!IOServiceGetMatchingServices(kIOMasterPortDefault, v24, &existing))
                  {
                    ...
                    if (v25)
                    {
                      ...
                      do
                      {
                        v27 = [*(a1 + 48) createAndSaveUARPHIDAccessoryFromService:v26 identifier:*(a1 + 40)];
                        IOObjectRelease(v26);
                        if (v27)
                        {
                          v28 = [UARPAccessoryIDWithLocationID alloc];
                          v29 = [v27 uarpAccessoryID];
                          v30 = [v27 locationID];
                          v31 = [(UARPAccessoryIDWithLocationID *)v28 initWithAccessoryID:v29 locationID:v30];
                ...
                v16 = [v37 countByEnumeratingWithState:&v39 objects:v47 count:16];
              }
...
void sub_100001F58(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, ...)
{
  va_start(va, a9);
...
uint64_t sub_100001F88(uint64_t a1)
{
  ...
  if (result)
  {
    v4 = [*(a1 + 32) createAndSaveUARPHIDAccessoryFromService:result identifier:*(a1 + 40)];
    v5 = *(*(a1 + 48) + 8);
    v6 = *(v5 + 40);
    *(v5 + 40) = v4;
...
void sub_100008780(uint64_t a1)
{
  ...
  if (v2)
  {
    if ([v2 goldrestoreQueryInProgress])
    {
      v4 = *(*(a1 + 32) + 120);
...
void sub_10000CA08(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, ...)
{
  va_start(va, a7);
  _Block_object_dispose(va, 8);
  _Unwind_Resume(a1);
...
void sub_10000CBCC(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, ...)
{
  va_start(va, a7);
  _Block_object_dispose(va, 8);
  _Unwind_Resume(a1);
...
void sub_10000E38C(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, ...)
{
  va_start(va, a11);
  _Block_object_dispose(va, 8);
  _Unwind_Resume(a1);
...
void sub_10000E7B4(void *a1, NSObject *a2, uint64_t a3, const char *a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint8_t a9)
{
...
void sub_10000E974(void *a1, uint64_t a2, uint64_t a3, const char *a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint8_t a9)
{
...
uint64_t sub_1000159E0(uint64_t a1, uint64_t a2, unsigned int a3)
{
  result = 30;
  if (a1 && a2)
  {
...
uint64_t sub_100017B94(uint64_t a1, uint64_t a2, unsigned int a3, unsigned int a4)
{
...
{
  vsnprintf(byte_1000338B8, 0x200uLL, a3, &a9);
  v10 = sub_1000191A8(a2);
  if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
  {
    sub_10001E568(v10, v11, v12, v13, v14, v15, v16, v17);
  }
}
...
{
  vsnprintf(byte_100033AB8, 0x200uLL, a3, &a9);
  v10 = sub_1000191A8(a2);
...
{
  vsnprintf(byte_100033CB8, 0x200uLL, a3, &a9);
  v10 = sub_1000191A8(a2);
...
{
  vsnprintf(byte_100033EB8, 0x200uLL, a3, &a9);
  v10 = sub_1000191A8(a2);
