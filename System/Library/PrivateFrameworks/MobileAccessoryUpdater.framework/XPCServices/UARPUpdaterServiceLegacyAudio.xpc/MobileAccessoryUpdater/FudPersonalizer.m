...
- (__CFDictionary)createPersonalizationManifestCFDict:(id)a3
{
  ...
  if ([a3 requestPrefix])
  {
    ...
    CFDictionaryBuildKeySetTag(v8, @"ApBoardID", [a3 requestPrefix], @"BoardID");
    CFDictionaryBuildKeySetTag(v8, @"ApChipID", [a3 requestPrefix], @"ChipID");
    CFDictionaryBuildKeySetTag(v8, @"ApECID", [a3 requestPrefix], @"ECID");
    CFDictionaryBuildKeySetTag(v8, @"ApSecurityDomain", [a3 requestPrefix], @"SecurityDomain");
    CFDictionaryBuildKeySetTag(v8, @"ApProductionMode", [a3 requestPrefix], @"ProductionMode");
    CFDictionaryBuildKeySetTag(v8, @"ApManifestEpoch", [a3 requestPrefix], @"ManifestEpoch");
    if ([a3 isSecurityModeSet])
    {
      CFDictionaryBuildKeySetTag(v8, @"ApSecurityMode", [a3 requestPrefix], @"SecurityMode");
    }

    CFDictionaryBuildKeySetTag(v8, @"ApNonce", [a3 requestPrefix], @"Nonce");
    v9 = CFStringCreateMutable(kCFAllocatorDefault, 0);
    CFStringAppendFormat(v9, 0, @"@%@", @"ApImg4Ticket");
    CFDictionaryBuildKeySetTicket(v8, v9, [a3 requestPrefix], @"Ticket");
    CFRelease(v9);
  ...
  CFRelease(v10);
  CFDictionaryBuildKeySetInt32(v6, @"ApBoardID", [a3 boardID]);
  CFDictionaryBuildKeySetInt32(v6, @"ApChipID", [a3 chipID]);
  if ([a3 globalSigning])
  {
  ...
  else
  {
    if (![a3 extEcID])
    {
      CFDictionaryBuildKeySetInt64(v6, @"ApECID", [a3 ecID]);
      goto LABEL_20;
    }
...
LABEL_20:
  ...
  {
    CFDictionaryBuildKeySetInt32(v6, @"ApManifestEpoch", [a3 chipEpoch]);
  }
