...
{
  v5 = a3;
  v6 = [MEMORY[0x277CCACA8] stringWithFormat:@"%@-%@", self, v5];
  uTF8String = [v6 UTF8String];

  if (!uTF8String)
  {
    currentHandler = [MEMORY[0x277CCA890] currentHandler];
    [currentHandler handleFailureInMethod:a2 object:self file:@"TRIExpressionCategories.m" lineNumber:27 description:{@"Invalid parameter not satisfying: %@", @"charString"}];
  }
