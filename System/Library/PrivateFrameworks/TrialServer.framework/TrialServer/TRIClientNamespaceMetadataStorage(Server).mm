...
- (uint64_t)mergeNamespaceMetadata:()Server forNamespaceName:
{
  ...
  if (!v11)
  {
    ...
    [v17 handleFailureInMethod:a2 object:a1 file:@"TRIClientNamespaceMetadataStorage+Server.m" lineNumber:29 description:{@"Expression was unexpectedly nil/false: %@", @"[namespaceMetadataUrl path]"}];
  }
  ...
  v21 = &v23;
  v22 = a2;
  v14 = [v10 acquireLockOnPath:v11 fileLockMode:1 blocking:1 andRunBlock:v18];
...
- (uint64_t)removeOutdatedNamespaceMetadataForNamespaceName:()Server currentCompatibilityVersion:
{
  ...
  v23 = 0x2020000000;
  v24 = 1;
  v8 = [a1 urlForNamespaceMetadataForNamespaceName:v7];
  v9 = MEMORY[0x277D73730];
  v10 = [v8 path];
  if (!v10)
  {
    v15 = [MEMORY[0x277CCA890] currentHandler];
    [v15 handleFailureInMethod:a2 object:a1 file:@"TRIClientNamespaceMetadataStorage+Server.m" lineNumber:74 description:{@"Expression was unexpectedly nil/false: %@", @"[namespaceMetadataUrl path]"}];
  }
  ...
  v20 = a4;
  v19 = a2;
  v12 = [v9 acquireLockOnPath:v10 fileLockMode:1 blocking:1 andRunBlock:v16];
