...
- (GTReplayADSReplyStream)initWithCallback:(id)callback bulkDataProxy:(id)proxy andToken:(id)token;
...
{
  messageCopy = message;
  uint64 = xpc_dictionary_get_uint64(messageCopy, "bulkDataHandle");
  if (uint64)
  {
    v7 = uint64;
  ...
  {
    v9 = xpc_dictionary_get_uint64(messageCopy, "streamState");
