...
- (id)specifiers
{
  ...
  {
    v23.receiver = self;
    v23.super_class = STAllowContactsRestrictionsController;
    specifiers = [(PUIContactsPrivacyController *)&v23 specifiers];
    objc_opt_class();
    ...
    v15 = [v8 localizedStringForKey:@"CONTACTS_EXPLANATION" value:&stru_28766E5A8 table:@"Restrictions"];
...
- (void)tableView:(id)view didSelectRowAtIndexPath:(id)path
{
  ...
  {
    v30.receiver = self;
    v30.super_class = STAllowContactsRestrictionsController;
    [(STAllowContactsRestrictionsController *)&v30 tableView:viewCopy didSelectRowAtIndexPath:pathCopy];
    ...
    v17 = allowedGroup;
    v18 = pathCopy;
    v19 = [(STAllowContactsRestrictionsController *)selfCopy2 indexPathForIndex:[(STAllowContactsRestrictionsController *)selfCopy2 indexOfSpecifier:v17]];
    ...
    if ([v18 section] == section3)
    {
      ...
      [(STAllowContactsRestrictionsController *)selfCopy2 specifierAtIndex:[(STAllowContactsRestrictionsController *)selfCopy2 indexForIndexPath:v18]];
      v23 = v22 = viewCopy;
      ...
      [(PUIContactsPrivacyController *)selfCopy2 updateSpecifiersForImposedSettings];
...
void __75__STAllowContactsRestrictionsController_tableView_didSelectRowAtIndexPath___block_invoke(uint64_t a1, int a2)
{
  if (a2)
  {
    ...
    v4 = *(a1 + 32);
    v25.receiver = *(a1 + 48);
    v25.super_class = STAllowContactsRestrictionsController;
