...
- (id)specifiers
{
  ...
  {
    v23.receiver = self;
    v23.super_class = STAllowCalendarRestrictionsController;
    specifiers = [(PUICalendarPrivacyController *)&v23 specifiers];
    objc_opt_class();
    ...
    v15 = [v8 localizedStringForKey:@"CALENDARS_EXPLANATION" value:&stru_28766E5A8 table:@"Restrictions"];
...
- (void)tableView:(id)view didSelectRowAtIndexPath:(id)path
{
  ...
  {
    v30.receiver = self;
    v30.super_class = STAllowCalendarRestrictionsController;
    [(STAllowCalendarRestrictionsController *)&v30 tableView:viewCopy didSelectRowAtIndexPath:pathCopy];
    ...
    v17 = allowedGroup;
    v18 = pathCopy;
    v19 = [(STAllowCalendarRestrictionsController *)selfCopy2 indexPathForIndex:[(STAllowCalendarRestrictionsController *)selfCopy2 indexOfSpecifier:v17]];
    ...
    if ([v18 section] == section3)
    {
      ...
      [(STAllowCalendarRestrictionsController *)selfCopy2 specifierAtIndex:[(STAllowCalendarRestrictionsController *)selfCopy2 indexForIndexPath:v18]];
      v23 = v22 = viewCopy;
      ...
      [(PUICalendarPrivacyController *)selfCopy2 updateSpecifiersForImposedSettings];
...
void __75__STAllowCalendarRestrictionsController_tableView_didSelectRowAtIndexPath___block_invoke(uint64_t a1, int a2)
{
  if (a2)
  {
    ...
    v4 = *(a1 + 32);
    v25.receiver = *(a1 + 48);
    v25.super_class = STAllowCalendarRestrictionsController;
