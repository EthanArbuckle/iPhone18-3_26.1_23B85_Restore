...
- (_TtC20ScreenTimeSettingsUI39STAppRatingChangedReviewRestrictionCell)initWithCoder:(id)coder;
- (_TtC20ScreenTimeSettingsUI39STAppRatingChangedReviewRestrictionCell)initWithStyle:(int64_t)style reuseIdentifier:(id)identifier;
- (_TtC20ScreenTimeSettingsUI39STAppRatingChangedReviewRestrictionCell)initWithStyle:(int64_t)style reuseIdentifier:(id)identifier specifier:(id)specifier;
...
- (_TtC20ScreenTimeSettingsUI39STAppRatingChangedReviewRestrictionCell)initWithCoder:(id)coder
{
  ...
  coderCopy = coder;
  v5 = [(STAppRatingChangedReviewRestrictionCell *)&v7 initWithCoder:coderCopy];
