...
- (CGImage)image;
- (MADMLScalingResult)initWithCoder:(id)coder;
- (MADMLScalingResult)initWithSurface:(id)surface;
...
- (MADMLScalingResult)initWithSurface:(id)surface
{
  surfaceCopy = surface;
  v9.receiver = self;
  v9.super_class = MADMLScalingResult;
...
- (void)encodeWithCoder:(id)coder
{
  coderCopy = coder;
  v5.receiver = self;
  v5.super_class = MADMLScalingResult;
