...
- (SSBlurringFlashView)initWithFrame:(CGRect)frame;
...
- (SSBlurringFlashView)initWithFrame:(CGRect)frame
{
  ...
  v3 = [(SSFlashView *)&v9 initWithFrame:frame.origin.x, frame.origin.y, frame.size.width, frame.size.height];
...
- (void)flashWithCompletion:(id)completion
{
  ...
  selfCopy = self;
  [(SSBlurView *)selfCopy->_blurView setHidden:0];
  [(_SSSFlashSuperColorView *)selfCopy->_superColorView setHidden:0];
  style = [(SSFlashView *)selfCopy style];
  ...
  superColorViewOpacityAnimator = selfCopy->_superColorViewOpacityAnimator;
  selfCopy->_superColorViewOpacityAnimator = v19;

  v21 = selfCopy->_superColorViewOpacityAnimator;
  ...
  blurViewRadiusAnimator = selfCopy->_blurViewRadiusAnimator;
  selfCopy->_blurViewRadiusAnimator = v22;

  v24 = selfCopy->_blurViewRadiusAnimator;
  ...
  v25 = selfCopy->_blurViewRadiusAnimator;
  ...
  v26 = selfCopy->_blurViewRadiusAnimator;
  ...
  v27 = selfCopy->_superColorViewOpacityAnimator;
  ...
  [(UIViewPropertyAnimator *)selfCopy->_superColorViewOpacityAnimator startAnimationAfterDelay:0.1];
  [(UIViewPropertyAnimator *)selfCopy->_blurViewRadiusAnimator startAnimationAfterDelay:0.0];
...
- (void)_setCornerRadius:(double)radius
{
  ...
  [(_SSSFlashSuperColorView *)superColorView _setCornerRadius:radius];
}
