...
- (CGImage)createImageWithIdentifier:(id)identifier orIndex:(unint64_t)index
{
  ...
  v7 = v6;
  v8 = [(PLPositionalImageTable *)self readImageDataAtIndex:index intoBuffer:v6 bytesRead:&v22 imageWidth:&v26 + 4 imageHeight:&v26 imageDataWidth:&v25 + 4 imageDataHeight:&v25 startingOffset:&v23 bytesPerRow:&v24 uuidBytes:0];
  ImageAtIndex = 0;
  if (v8)
  {
    v10 = HIDWORD(v26) + 6;
