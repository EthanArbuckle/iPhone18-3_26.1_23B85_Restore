@interface PLNonBindingAssetsdPhotoKitClient
- (BOOL)sendChangesRequest:(id)request error:(id *)error;
- (PLNonBindingAssetsdPhotoKitClient)initWithQueue:(id)queue proxyCreating:(id)creating libraryURL:(id)l;
- (void)sendChangesRequest:(id)request reply:(id)reply;
@end

@implementation PLNonBindingAssetsdPhotoKitClient
...
- (BOOL)sendChangesRequest:(id)request error:(id *)error
{
  ...
  *(&buf + 1) = &buf;
  v29 = 0x3032000000;
  v30 = __Block_byref_object_copy__12846;
  v31 = __Block_byref_object_dispose__12847;
  v32 = 0;
  proxyFactory = self->_proxyFactory;
  v20[0] = MEMORY[0x1E69E9820];
  v20[1] = 3221225472;
  v20[2] = __62__PLNonBindingAssetsdPhotoKitClient_sendChangesRequest_error___block_invoke;
  v20[3] = &unk_1E7932E20;
  v20[4] = self;
  v20[5] = &v21;
  v20[6] = &buf;
  ...
  v19[1] = 3221225472;
  v19[2] = __62__PLNonBindingAssetsdPhotoKitClient_sendChangesRequest_error___block_invoke_9;
  v19[3] = &unk_1E7932E48;
  v19[4] = &v21;
  v19[5] = &buf;
  [v11 PhotoKitService_applyChangesRequest:requestCopy libraryToken:libraryToken reply:v19];
...
void __62__PLNonBindingAssetsdPhotoKitClient_sendChangesRequest_error___block_invoke(void *a1, void *a2)
{
...
- (void)sendChangesRequest:(id)request reply:(id)reply
{
  ...
  v26[1] = 3221225472;
  v26[2] = __62__PLNonBindingAssetsdPhotoKitClient_sendChangesRequest_reply___block_invoke;
  v26[3] = &unk_1E7932DA8;
  v12 = replyCopy;
  v27 = v12;
  ...
  block[1] = 3221225472;
  block[2] = __62__PLNonBindingAssetsdPhotoKitClient_sendChangesRequest_reply___block_invoke_3;
...
void __62__PLNonBindingAssetsdPhotoKitClient_sendChangesRequest_reply___block_invoke(uint64_t a1, void *a2)
{
  ...
  {
    v5 = 136446466;
    v6 = "[PLNonBindingAssetsdPhotoKitClient sendChangesRequest:reply:]_block_invoke";
    v7 = 2112;
    v8 = v3;
...
void __62__PLNonBindingAssetsdPhotoKitClient_sendChangesRequest_reply___block_invoke_3(uint64_t a1)
{
  ...
  v5[1] = 3221225472;
  v5[2] = __62__PLNonBindingAssetsdPhotoKitClient_sendChangesRequest_reply___block_invoke_2;
  v5[3] = &unk_1E7932DD0;
  v6 = *(a1 + 56);
  [v3 PhotoKitService_applyChangesRequest:v2 libraryToken:v4 reply:v5];
...
- (PLNonBindingAssetsdPhotoKitClient)initWithQueue:(id)queue proxyCreating:(id)creating libraryURL:(id)l
{
  ...
  lCopy = l;
  v20.receiver = self;
  v20.super_class = PLNonBindingAssetsdPhotoKitClient;
  v12 = [(PLNonBindingAssetsdPhotoKitClient *)&v20 init];
  v13 = v12;
  if (v12)
  {
