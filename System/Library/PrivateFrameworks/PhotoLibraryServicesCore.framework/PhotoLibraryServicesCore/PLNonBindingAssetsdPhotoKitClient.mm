...
- (PLNonBindingAssetsdPhotoKitClient)initWithQueue:(id)a3 proxyCreating:(id)a4 libraryURL:(id)a5;
...
- (BOOL)sendChangesRequest:(id)a3 error:(id *)a4
{
  ...
  *(&buf + 1) = &buf;
  ...
  v19[4] = &v21;
  v19[5] = &buf;
  [v11 PhotoKitService_applyChangesRequest:v6 libraryToken:libraryToken reply:v19];
