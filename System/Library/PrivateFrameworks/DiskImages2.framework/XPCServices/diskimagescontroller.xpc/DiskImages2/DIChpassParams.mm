...
- (BOOL)changePassWithXpcHandler:(id)a3 error:(id *)a4
{
  ...
  if ([(DIChpassParams *)self prepareImageWithXpcHandler:v6 fileMode:1 encChpass:v7 error:a4])
  {
    v8 = [(DIEncryptionChpass *)v7 replacePassWithXpcHandler:v6 params:self error:a4];
  }
...
- (BOOL)chpassWithError:(id *)a3
{
  ...
  {
    v6 = [(DIChpassParams *)self changePassWithXpcHandler:v5 error:a3];
  }
