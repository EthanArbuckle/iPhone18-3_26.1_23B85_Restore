...
- (BOOL)isDeviceWithProperty:(const char *)property registryEntryID:(unint64_t)d predicate:(function<BOOL)(iokit_utils::di_io_obj_t
{
  ...
  if (d)
  {
    sub_100049E20(&dCopy, v21);
    sub_100049E98(v21, "device not found in registry", &v19);
    sub_10015607C(v18, 3, &v19);
    sub_100156088(v18, &v16);
    sub_100156240(v18, &v15);
    sub_10004A3EC(v26, a5);
    sub_100049F1C(&v16, &v15, v26, &v17);
    sub_10004A484(v26);
    IOObjectRelease(HIDWORD(v15));
    IOObjectRelease(v15);
    IOObjectRelease(HIDWORD(v16));
    IOObjectRelease(v16);
    sub_100156240(v18, &v14);
    v8 = sub_100156020(&v17, &v14);
