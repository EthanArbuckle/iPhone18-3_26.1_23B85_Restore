...
LABEL_10:
  a1[2] = 0;
  v18 = __error();
  sub_10001E554("/Library/Caches/com.apple.xbs/Sources/ParallelCompression/AppleArchiveS3/AAS3Common.c", "s3StringBufferAppend", 437, 84, *v18, "malloc", v19, v20, v21);
  *a1 = 0;
  a1[1] = 0;
  return 0xFFFFFFFFLL;
}
...
LABEL_10:
  ...
  v17 = 662;
LABEL_15:
  sub_10001E554("/Library/Caches/com.apple.xbs/Sources/ParallelCompression/AppleArchiveS3/AAS3Common.c", "s3StreamBaseInit", v17, 84, v13, v16, v14, v15, v19);
  sub_10001A104(__s);
  return 0xFFFFFFFFLL;
}
...
AAByteStream sub_10001BB74(char *a1, uint64_t a2, uint64_t a3, int a4)
{
  ...
  if ((sub_100019FD4(v10, a1, a2, a3) & 0x80000000) != 0)
  {
    ...
    v20 = 697;
LABEL_11:
    sub_10001E554("/Library/Caches/com.apple.xbs/Sources/ParallelCompression/AppleArchiveS3/AAS3DownloadStreamURLSession.m", "s3DownloadStreamOpen_urlsession", v20, 121, 0, v19, v11, v12, v22.tv_sec);
LABEL_12:
    free(v8);
    sub_10001B9E0(v10);
    return 0;
...
uint64_t sub_10001BEA0(char **a1, uint64_t a2)
{
  v4 = malloc(0x58uLL);
  v5 = v4;
  if (!v4)
  {
    ...
    v11 = 308;
LABEL_12:
    sub_10001E554("/Library/Caches/com.apple.xbs/Sources/ParallelCompression/AppleArchiveS3/AAS3Knox.c", "contextCreate", v11, 125, v7, v10, v8, v9, v16);
    goto LABEL_13;
  }
  ...
  *(v5 + 80) = a2;
  ...
  else
  {
    ...
    v13 = sub_10001DF7C(v5, 8u, 0, "KNOX_USER_AGENT");
    v6 = 0;
    if (v13 < 0)
    {
      goto LABEL_13;
...
LABEL_13:
  ...
  if (!*(v5 + 16))
  {
    ...
    if (v15)
    {
      if ((sub_10001E060(v5, 2u, v15) & 0x80000000) != 0)
      {
  ...
  if (!*(v5 + 32))
  {
    ...
    if (v14)
    {
      if ((sub_10001E060(v5, 4u, v14) & 0x80000000) != 0)
      {
...
uint64_t sub_10001C168(uint64_t a1, char *__s)
{
  if (*(a1 + 32))
  {
    return 0;
...
LABEL_71:
    v60 = __error();
    sub_10001E554("/Library/Caches/com.apple.xbs/Sources/ParallelCompression/AppleArchiveS3/AAS3Knox.c", "contextGetServiceName", 345, 125, *v60, "malloc", v61, v62, v112);
    v27 = 0;
    v37 = 0;
    v30 = 0;
LABEL_100:
  ...
  if (!v30)
  {
    ...
    v84 = 348;
LABEL_93:
    sub_10001E554("/Library/Caches/com.apple.xbs/Sources/ParallelCompression/AppleArchiveS3/AAS3Knox.c", "contextGetServiceName", v84, 125, 0, v83, v28, v29, v112);
    v37 = 0;
    goto LABEL_100;
  }

  snprintf(v27, v12, "https://%s/westgate/appinfo", __s);
  if ((sub_10001CEC4(a1, 1u, v27, 0, v30) & 0x80000000) != 0)
  {
    v112 = v27;
  ...
  do
  {
    while (1)
    {
      ...
      *__sa = 0u;
      v117 = 0u;
      *__s1 = 0u;
      if ((sub_10001EE0C(v37, __s1, v31, v32, v33, v34, v35, v36) & 0x80000000) != 0)
      {
        v94 = "parsing JSON";
        v95 = 363;
        goto LABEL_99;
      ...
      if (!strcmp(__s1[1], "realm"))
      {
        ...
        v95 = 377;
LABEL_99:
        sub_10001E554("/Library/Caches/com.apple.xbs/Sources/ParallelCompression/AppleArchiveS3/AAS3Knox.c", "contextGetServiceName", v95, 125, 0, v94, v35, v36, v114);
        goto LABEL_100;
      }

LABEL_33:
      if (!strcmp(v40, "serviceName") && (sub_10001DF7C(a1, 7u, __sa[0], 0) & 0x80000000) != 0)
      {
        v94 = "serviceName";
        v95 = 378;
        goto LABEL_99;
...
LABEL_44:
  ...
  if (!v43 || (v44 = *(a1 + 56)) == 0)
  {
    sub_10001E554("/Library/Caches/com.apple.xbs/Sources/ParallelCompression/AppleArchiveS3/AAS3Knox.c", "contextGetDAWToken", 411, 125, 0, "missing service name or realm", v41, v42, v114);
    v47 = 0;
LABEL_110:
    v49 = 0;
LABEL_115:
  ...
  if (!v46)
  {
    ...
    __sa[0] = 0;
    v86 = __error();
    sub_10001E554("/Library/Caches/com.apple.xbs/Sources/ParallelCompression/AppleArchiveS3/AAS3Knox.c", "contextGetDAWToken", 420, 125, *v86, "malloc", v87, v88, v114);
    goto LABEL_110;
  }
  ...
  if (!v48)
  {
    ...
    v93 = 422;
LABEL_114:
    sub_10001E554("/Library/Caches/com.apple.xbs/Sources/ParallelCompression/AppleArchiveS3/AAS3Knox.c", "contextGetDAWToken", v93, 125, v89, v92, v90, v91, v114);
    goto LABEL_115;
  }
  ...
  while (1)
  {
    ...
    if (ferror(v53))
    {
      ...
      v98 = 452;
LABEL_136:
      sub_10001E554("/Library/Caches/com.apple.xbs/Sources/ParallelCompression/AppleArchiveS3/AAS3Knox.c", "contextGetDAWToken", v98, 125, v99, v97, v56, v57, v112);
      __s1[0] = v54;
      goto LABEL_155;
    }
...
LABEL_153:
    v59 = 459;
LABEL_154:
    sub_10001E554("/Library/Caches/com.apple.xbs/Sources/ParallelCompression/AppleArchiveS3/AAS3Knox.c", "contextGetDAWToken", v59, 125, 0, "token is too long", v56, v57, v112);
LABEL_155:
    v105 = v47;
LABEL_156:
    pclose(v53);
...
LABEL_116:
    ...
    v25 = 650;
LABEL_101:
    sub_10001E554("/Library/Caches/com.apple.xbs/Sources/ParallelCompression/AppleArchiveS3/AAS3Knox.c", "contextResolveWestgateToken", v25, 125, 0, v24, v22, v23, v113);
    return 0xFFFFFFFFLL;
  }
...
LABEL_140:
  ...
  if ((v54 + 1) < 6 || (*v105 == 1415004484 ? (v107 = *(v105 + 2) == 20043) : (v107 = 0), !v107))
  {
    ...
    v109 = 460;
LABEL_146:
    sub_10001E554("/Library/Caches/com.apple.xbs/Sources/ParallelCompression/AppleArchiveS3/AAS3Knox.c", "contextGetDAWToken", v109, 125, 0, v108, v56, v57, v112);
    goto LABEL_156;
  }

  if ((sub_10001DF7C(a1, 2u, v105, 0) & 0x80000000) != 0)
  {
    v108 = "daw token";
    v109 = 463;
    goto LABEL_146;
  ...
  if (!v5)
  {
    sub_10001E554("/Library/Caches/com.apple.xbs/Sources/ParallelCompression/AppleArchiveS3/AAS3Knox.c", "contextGetWestgateToken", 486, 125, 0, "missing host or DAW token", v110, v111, v112);
    v20 = 0;
    v8 = 0;
LABEL_17:
    v21 = 0;
...
LABEL_4:
  ...
  if (!v8)
  {
    ...
    v15 = 0;
LABEL_16:
    sub_10001E554("/Library/Caches/com.apple.xbs/Sources/ParallelCompression/AppleArchiveS3/AAS3Knox.c", "contextGetWestgateToken", v14, 125, v15, v13, v6, v7, v112);
    v20 = 0;
    goto LABEL_17;
  }
...
LABEL_90:
    v80 = __error();
    sub_10001E554("/Library/Caches/com.apple.xbs/Sources/ParallelCompression/AppleArchiveS3/AAS3Knox.c", "contextGetWestgateToken", 498, 125, *v80, "malloc", v81, v82, v112);
    v20 = 0;
    v21 = 0;
    goto LABEL_18;
  }
  ...
  if ((sub_10001CEC4(a1, 2u, v17, v119, v8) & 0x80000000) != 0)
  {
    sub_10001E554("/Library/Caches/com.apple.xbs/Sources/ParallelCompression/AppleArchiveS3/AAS3Knox.c", "contextGetWestgateToken", 505, 125, 0, "Knox request failed: %s", v64, v65, v17);
    v20 = 0;
    goto LABEL_18;
  }

  AAByteStreamSeek(v8, 0, 0);
  v66 = sub_10001ECC4(v8);
  v20 = v66;
  if (!v66)
  {
  ...
  *__sa = 0u;
  v117 = 0u;
  *__s1 = 0u;
  if ((sub_10001EE0C(v66, __s1, v67, v68, v69, v70, v71, v72) & 0x80000000) != 0)
  {
LABEL_89:
    v78 = "parsing JSON";
    v79 = 516;
LABEL_105:
    sub_10001E554("/Library/Caches/com.apple.xbs/Sources/ParallelCompression/AppleArchiveS3/AAS3Knox.c", "contextGetWestgateToken", v79, 125, 0, v78, v71, v72, v113);
    goto LABEL_18;
  }
...
LABEL_88:
    ...
    *__sa = 0u;
    v117 = 0u;
    *__s1 = 0u;
    if ((sub_10001EE0C(v20, __s1, v73, v74, v75, v76, v71, v72) & 0x80000000) != 0)
    {
      goto LABEL_89;
    }
  }
...
uint64_t sub_10001CEC4(uint64_t a1, unsigned int a2, char *a3, const char **a4, uint64_t a5)
{
  ...
  if (!v10)
  {
    ...
    v57 = 189;
LABEL_40:
    sub_10001E554("/Library/Caches/com.apple.xbs/Sources/ParallelCompression/AppleArchiveS3/AAS3Knox.c", "knoxRequest", v57, 125, 0, v56, v11, v12, v67);
    v22 = 0;
LABEL_41:
    v29 = 0;
    v28 = 0;
LABEL_42:
  ...
  {
LABEL_39:
    sub_10001E554("/Library/Caches/com.apple.xbs/Sources/ParallelCompression/AppleArchiveS3/AAS3Knox.c", "knoxPageStreamOpen", 165, 125, 0, "malloc", v20, v21, v67);
    free(v15);
    free(v22);
  ...
  *v16 = v15;
  ...
  if ((AAS3ContextSetFieldString(v13, 5, *(a1 + 64), v17, v18, v19, v20, v21) & 0x80000000) != 0)
  {
    v60 = 194;
LABEL_46:
    sub_10001E554("/Library/Caches/com.apple.xbs/Sources/ParallelCompression/AppleArchiveS3/AAS3Knox.c", "knoxRequest", v60, 125, 0, "setup context", v26, v27, v67);
    goto LABEL_41;
  }
  ...
  if (!v28)
  {
    ...
    v62 = 200;
LABEL_52:
    sub_10001E554("/Library/Caches/com.apple.xbs/Sources/ParallelCompression/AppleArchiveS3/AAS3Knox.c", "knoxRequest", v62, 125, v61, "malloc", v54, v55, v67);
    v29 = 0;
    goto LABEL_42;
  }
...
LABEL_15:
      ...
      sub_10001E554("/Library/Caches/com.apple.xbs/Sources/ParallelCompression/AppleArchiveS3/AAS3Knox.c", "knoxPageStreamEndPage", v64, 125, 0, v63, v31, v32, v67);
      sub_10001E554("/Library/Caches/com.apple.xbs/Sources/ParallelCompression/AppleArchiveS3/AAS3Knox.c", "knoxRequest", 209, 125, 0, "page stream next page", v65, v66, v68);
      goto LABEL_42;
    }

LABEL_16:
    if ((sub_100018C8C(a2, v33, v76, 0, &v74, &v71, a4) & 0x80000000) != 0)
    {
      sub_10001E554("/Library/Caches/com.apple.xbs/Sources/ParallelCompression/AppleArchiveS3/AAS3Knox.c", "knoxRequest", 212, 125, 0, "request: %s", v35, v36, v33);
      goto LABEL_42;
    }
      ...
      do
      {
        ...
        if (v41 - v39 >= 5)
        {
          ...
          if (!strncmp(&v28[v39], v30, 5uLL))
          {
            ...
            {
              sub_10001E554("/Library/Caches/com.apple.xbs/Sources/ParallelCompression/AppleArchiveS3/AAS3Knox.c", "knoxRequest", 231, 125, 0, "invalid link header (1): %s", v46, v47, v42);
              goto LABEL_42;
            }

            if (!strstr(v45, "rel=next"))
            {
              sub_10001E554("/Library/Caches/com.apple.xbs/Sources/ParallelCompression/AppleArchiveS3/AAS3Knox.c", "knoxRequest", 233, 125, 0, "invalid link header (2): %s", v49, v50, v42);
              goto LABEL_42;
            }
...
uint64_t sub_10001D420(uint64_t a1, const char *a2, const char *a3, const char *a4, void *a5, void *a6, uint64_t a7, uint64_t a8)
{
  v8 = *(a1 + 32);
  v9 = *(a1 + 80);
  *a5 = 0;
  *a6 = 0;
  if (!v8)
  {
    sub_10001E554("/Library/Caches/com.apple.xbs/Sources/ParallelCompression/AppleArchiveS3/AAS3Knox.c", "contextGetDecryptionComponents", 568, 125, 0, "missing Westgate token", a7, a8, v64);
    v21 = 0;
    v18 = 0;
LABEL_14:
    v27 = 0;
  ...
  if (!v18)
  {
    ...
    v24 = 0;
LABEL_13:
    sub_10001E554("/Library/Caches/com.apple.xbs/Sources/ParallelCompression/AppleArchiveS3/AAS3Knox.c", "contextGetDecryptionComponents", v23, 125, v24, v22, v16, v17, v64);
    v21 = 0;
    v8 = 0;
    goto LABEL_14;
  }
...
LABEL_54:
    v59 = __error();
    sub_10001E554("/Library/Caches/com.apple.xbs/Sources/ParallelCompression/AppleArchiveS3/AAS3Knox.c", "contextGetDecryptionComponents", 580, 125, *v59, "malloc", v60, v61, v64);
    v21 = 0;
    v8 = 0;
    v28 = 0xFFFFFFFFLL;
    v27 = __str;
  ...
  if ((sub_10001CEC4(a1, 2u, __str, v76, v18) & 0x80000000) != 0)
  {
    sub_10001E554("/Library/Caches/com.apple.xbs/Sources/ParallelCompression/AppleArchiveS3/AAS3Knox.c", "contextGetDecryptionComponents", 587, 125, 0, "Knox request failed: %s", v31, v32, __str);
    v21 = 0;
    goto LABEL_15;
  }

  AAByteStreamSeek(v18, 0, 0);
  v33 = sub_10001ECC4(v18);
  v21 = v33;
  if (!v33)
  {
  ...
  *__s = 0u;
  v74 = 0u;
  *__s1 = 0u;
  if ((sub_10001EE0C(v33, __s1, v34, v35, v36, v37, v38, v39) & 0x80000000) != 0)
  {
LABEL_56:
    v62 = "parsing JSON";
    v63 = 600;
...
LABEL_64:
        *a6 = 0;
        sub_10001E554("/Library/Caches/com.apple.xbs/Sources/ParallelCompression/AppleArchiveS3/AAS3Knox.c", "contextGetDecryptionComponents", 618, 125, 0, "key", v38, v39, v66);
        v8 = v70;
        v27 = __str;
        goto LABEL_15;
      }
...
LABEL_66:
        *a5 = 0;
        sub_10001E554("/Library/Caches/com.apple.xbs/Sources/ParallelCompression/AppleArchiveS3/AAS3Knox.c", "contextGetDecryptionComponents", 623, 125, 0, "uri", v38, v39, v66);
        v27 = __str;
        goto LABEL_15;
      }
...
LABEL_48:
    ...
    *__s = 0u;
    v74 = 0u;
    *__s1 = 0u;
    if ((sub_10001EE0C(v21, __s1, v40, v41, v42, v43, v38, v39) & 0x80000000) != 0)
    {
      goto LABEL_56;
    }
  }
...
LABEL_47:
  ...
  v63 = 631;
LABEL_62:
  sub_10001E554("/Library/Caches/com.apple.xbs/Sources/ParallelCompression/AppleArchiveS3/AAS3Knox.c", "contextGetDecryptionComponents", v63, 125, 0, v62, v38, v39, v66);
LABEL_15:
  v28 = 0xFFFFFFFFLL;
LABEL_16:
  sub_10001EDB0(v21);
...
uint64_t AAS3KnoxResolveURL(uint64_t a1, char **a2, void *a3, size_t a4, _BYTE *a5, size_t *a6, unint64_t a7)
{
  ...
  {
    sub_10001E554("/Library/Caches/com.apple.xbs/Sources/ParallelCompression/AppleArchiveS3/AAS3Knox.c", "AAS3KnoxResolveURL", 854, 125, 0, "invalid Knox scheme: %s", v14, v15, a1);
LABEL_11:
    v23 = 0;
    v24 = 0;
    v20 = 0;
  ...
  if (!v17)
  {
    sub_10001E554("/Library/Caches/com.apple.xbs/Sources/ParallelCompression/AppleArchiveS3/AAS3Knox.c", "AAS3KnoxResolveURL", 859, 125, 0, "invalid Knox host: %s", v18, v19, a1);
    v23 = 0;
    v24 = 0;
LABEL_12:
    v32 = 0;
...
LABEL_10:
    v29 = *__error();
    sub_10001E554("/Library/Caches/com.apple.xbs/Sources/ParallelCompression/AppleArchiveS3/AAS3Knox.c", "AAS3KnoxResolveURL", 863, 125, v29, "malloc", v30, v31, v72);
    goto LABEL_11;
  }
  ...
  {
    sub_10001E554("/Library/Caches/com.apple.xbs/Sources/ParallelCompression/AppleArchiveS3/AAS3Knox.c", "AAS3KnoxResolveURL", 869, 125, 0, "invalid Knox action: %s", v27, v28, a1);
LABEL_36:
    v23 = 0;
    v24 = 0;
    v20 = 0;
  ...
  if (!v36)
  {
    sub_10001E554("/Library/Caches/com.apple.xbs/Sources/ParallelCompression/AppleArchiveS3/AAS3Knox.c", "AAS3KnoxResolveURL", 874, 125, 0, "invalid Knox space: %s", v37, v38, a1);
    v23 = 0;
    v24 = 0;
LABEL_37:
    v32 = 0;
...
LABEL_35:
    v49 = *__error();
    sub_10001E554("/Library/Caches/com.apple.xbs/Sources/ParallelCompression/AppleArchiveS3/AAS3Knox.c", "AAS3KnoxResolveURL", 878, 125, v49, "malloc", v50, v51, v72);
    goto LABEL_36;
  }
...
LABEL_48:
    v67 = __error();
    sub_10001E554("/Library/Caches/com.apple.xbs/Sources/ParallelCompression/AppleArchiveS3/AAS3Knox.c", "AAS3KnoxResolveURL", 895, 125, *v67, "malloc", v68, v69, v72);
    v23 = 0;
    v24 = 0;
    v20 = 0;
    goto LABEL_13;
  ...
  if (!v53)
  {
    ...
    v71 = 909;
LABEL_51:
    sub_10001E554("/Library/Caches/com.apple.xbs/Sources/ParallelCompression/AppleArchiveS3/AAS3Knox.c", "AAS3KnoxResolveURL", v71, 125, 0, v70, v54, v55, v72);
    v23 = 0;
    goto LABEL_13;
  }

  if ((sub_10001C168(v53, v26) & 0x80000000) != 0)
  {
  ...
  if ((sub_10001D420(v24, v26, v32, v20, a3, &__s, v54, v55) & 0x80000000) != 0)
  {
    sub_10001E554("/Library/Caches/com.apple.xbs/Sources/ParallelCompression/AppleArchiveS3/AAS3Knox.c", "AAS3KnoxResolveURL", 915, 125, 0, "getting decryption credentials", v56, v57, v72);
    v33 = 0xFFFFFFFFLL;
    v23 = __s;
    goto LABEL_14;
  }
  ...
  else
  {
    ...
    if (v58 >> 1 <= a4)
    {
      if ((sub_10001EA54(v58 >> 1, a5, __s, v59, v60, v61, v62, v63) & 0x80000000) == 0)
      {
        v33 = 0;
        *v73 = v64;
        goto LABEL_14;
  ...
  sub_10001E554("/Library/Caches/com.apple.xbs/Sources/ParallelCompression/AppleArchiveS3/AAS3Knox.c", "AAS3KnoxResolveURL", v66, 125, 0, v65, v62, v63, v72);
LABEL_13:
  v33 = 0xFFFFFFFFLL;
LABEL_14:
  free(v26);
...
uint64_t sub_10001DF7C(uint64_t a1, unsigned int a2, char *__s, char *a4)
{
  ...
  *(a1 + 8 * a2) = 0;
  v12 = __error();
  sub_10001E554("/Library/Caches/com.apple.xbs/Sources/ParallelCompression/AppleArchiveS3/AAS3Knox.c", "contextSetString", 259, 125, *v12, "malloc", v13, v14, v15);
  return 0xFFFFFFFFLL;
}
...
uint64_t sub_10001E060(uint64_t a1, unsigned int a2, char *a3)
{
  ...
  if ((v6 & 0x80000000) == 0)
  {
    ...
    {
      sub_10001E554("/Library/Caches/com.apple.xbs/Sources/ParallelCompression/AppleArchiveS3/AAS3Knox.c", "contextLoadString", 274, 125, 0, "invalid file: %s", v8, v9, a3);
    }
    ...
    else
    {
      if ((v30.st_size + 1) < 0x2000000001)
      {
        ...
        if (v16)
        {
          ...
          sub_10001E554("/Library/Caches/com.apple.xbs/Sources/ParallelCompression/AppleArchiveS3/AAS3Knox.c", "contextLoadString", v27, 125, v26, v28, v19, v20, v29);
LABEL_23:
          free(v17);
          v15 = 0xFFFFFFFFLL;
LABEL_24:
      ...
      v22 = *__error();
      sub_10001E554("/Library/Caches/com.apple.xbs/Sources/ParallelCompression/AppleArchiveS3/AAS3Knox.c", "contextLoadString", 277, 125, v22, "malloc", v23, v24, v29);
    }
  ...
  v12 = __error();
  sub_10001E554("/Library/Caches/com.apple.xbs/Sources/ParallelCompression/AppleArchiveS3/AAS3Knox.c", "contextLoadString", 273, 125, *v12, a3, v13, v14, v29);
  return 0xFFFFFFFFLL;
}

uint64_t sub_10001E280(int *a1)
{
  if (!a1)
  {
    return 0;
  ...
  {
    sub_10001E554("/Library/Caches/com.apple.xbs/Sources/ParallelCompression/AppleArchiveS3/AAS3Knox.c", "knoxPageStreamClose", 67, 125, 0, "writing final ']'", v2, v3, v6);
    v4 = 0xFFFFFFFFLL;
  }
...
uint64_t sub_10001E31C(uint64_t a1, _BYTE *a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8)
{
  v8 = a3;
  v9 = a2;
  v11 = *(a1 + 8);
  ...
  if (a3 && *(a1 + 12))
  {
    if (*a2 != 91)
    {
      ...
      v15 = 93;
LABEL_41:
      sub_10001E554("/Library/Caches/com.apple.xbs/Sources/ParallelCompression/AppleArchiveS3/AAS3Knox.c", "knoxPageStreamWrite", v15, 125, 0, v14, a7, a8, v22);
      return -1;
    }
...
LABEL_35:
    ...
    v13 = -1;
LABEL_37:
    sub_10001E554("/Library/Caches/com.apple.xbs/Sources/ParallelCompression/AppleArchiveS3/AAS3Knox.c", "knoxPageStreamWrite", 124, 125, 0, "write", a7, a8, v22);
  }
...
size_t sub_10001E554(uint64_t a1, uint64_t a2, __int16 a3, int a4, int a5, const char *a6, uint64_t a7, uint64_t a8, char a9)
{
  ...
  {
    sub_10001E774(__str, v15 | 0x80000000);
  }

  return ParallelCompressionUpdateError((v15 | 0x80000000), __str);
}

uint64_t sub_10001E660(uint64_t a1, uint64_t a2, __int16 a3, int a4, const char *a5, uint64_t a6, uint64_t a7, uint64_t a8, char a9)
{
  bzero(__s, 0x400uLL);
...
size_t sub_10001E800(size_t result)
{
  if (result)
  {
    v1 = result;
...
uint64_t sub_10001EA54(int a1, _BYTE *a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8)
{
  v8 = (2 * a1);
  if (!v8)
  {
...
LABEL_9:
  ...
  v15 = 18;
LABEL_17:
  sub_10001E554("/Library/Caches/com.apple.xbs/Sources/ParallelCompression/AppleArchive/AASerialization.c", "aaParseHexString", v15, 106, 0, v14, a7, a8, v17);
  return (v11 << 31 >> 31);
}
...
uint64_t sub_10001EB54(uint64_t a1, char a2)
{
  ...
  if (v5 >= v4)
  {
    ...
    *(a1 + 88) = v7;
    ...
    {
      v11 = __error();
      sub_10001E554("/Library/Caches/com.apple.xbs/Sources/ParallelCompression/AppleArchive/AAJSONStreams.c", "jsonPushLabel", 358, 109, *v11, "malloc", v12, v13, v14);
      *v6 = 0;
      v6[1] = 0;
      return 0xFFFFFFFFLL;
    }
...
uint64_t sub_10001EC0C(uint64_t a1, char a2)
{
  ...
  if (v5 >= v4)
  {
    ...
    *(a1 + 112) = v7;
    ...
    {
      v11 = __error();
      sub_10001E554("/Library/Caches/com.apple.xbs/Sources/ParallelCompression/AppleArchive/AAJSONStreams.c", "jsonPushValue", 372, 109, *v11, "malloc", v12, v13, v14);
      *v6 = 0;
      v6[1] = 0;
      return 0xFFFFFFFFLL;
    }
...
void *sub_10001ECC4(uint64_t a1)
{
  ...
  if (v2)
  {
    ...
    {
      v8 = __error();
      sub_10001E554("/Library/Caches/com.apple.xbs/Sources/ParallelCompression/AppleArchive/AAJSONStreams.c", "AAJSONInputStreamOpen", 387, 109, *v8, "malloc", v9, v10, v12);
      sub_10001EDB0(v3);
      return 0;
    }
  }
  ...
  {
    v5 = __error();
    sub_10001E554("/Library/Caches/com.apple.xbs/Sources/ParallelCompression/AppleArchive/AAJSONStreams.c", "AAJSONInputStreamOpen", 382, 109, *v5, "malloc", v6, v7, v12);
  }
...
uint64_t sub_10001EE0C(uint64_t a1, int *a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8)
{
  if (atomic_load(a1))
  {
    return 0xFFFFFFFFLL;
  ...
  if (v10 == 9 || v10 == -1)
  {
    sub_10001E554("/Library/Caches/com.apple.xbs/Sources/ParallelCompression/AppleArchive/AAJSONStreams.c", "AAJSONInputStreamRead", 418, 109, 0, "unexpected read call", a7, a8, v43);
    return 0xFFFFFFFFLL;
  }
        ...
        while (1)
        {
          while (1)
          {
            ...
            if (v14 >= *(a1 + 48))
            {
              ...
              if (v16 < 0)
              {
                sub_10001E554("/Library/Caches/com.apple.xbs/Sources/ParallelCompression/AppleArchive/AAJSONStreams.c", "AAJSONInputStreamRead", 430, 109, 0, "read error: %zd", a7, a8, v16);
                goto LABEL_113;
              }
            ...
            *(a1 + 56) = v14 + 1;
            ...
            if (v19 > 1)
            {
              if (v19 == 2)
              {
                ...
                {
                  v21 = asc_1001C6798[(((v18 - 98) >> 1) | ((v18 - 98) << 7))];
                }
                ...
                if ((sub_10001EC0C(a1, v21) & 0x80000000) != 0)
                {
                  v28 = "jsonPushValue";
                  v29 = 512;
                  goto LABEL_112;
...
LABEL_55:
              ...
              if ((sub_10001EC0C(a1, v17) & 0x80000000) != 0)
              {
                v28 = "jsonPushValue";
                v29 = 533;
                goto LABEL_112;
            ...
            else if (v19)
            {
              ...
              if (v17 == 34)
              {
                *(a1 + 16) = 5;
                ...
                v29 = 499;
LABEL_112:
                sub_10001E554("/Library/Caches/com.apple.xbs/Sources/ParallelCompression/AppleArchive/AAJSONStreams.c", "AAJSONInputStreamRead", v29, 109, 0, v28, a7, a8, v43);
LABEL_113:
                result = 0xFFFFFFFFLL;
                *(a1 + 16) = -1;
                return result;
...
LABEL_70:
            ...
            case 7:
              ...
              if ((sub_10001EB54(a1, v17) & 0x80000000) != 0)
              {
                v28 = "jsonPushLabel";
                v29 = 591;
                goto LABEL_112;
...
uint64_t sub_10001F948(void *a1, uint64_t a2)
{
  ...
  sub_100020DF4(&v23, __p);
  sub_100008510(&v24, __p);
  v4 = (a1 + *(*a1 - 136));
  if (*(v4 + 31) < 0)
  {
...
void sub_10001FCC4(_Unwind_Exception *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, uint64_t a10, uint64_t a11, void *__p, uint64_t a13, int a14, __int16 a15, char a16, char a17, char a18)
{
  std::ios::~ios();
  _Unwind_Resume(a1);
}
...
void sub_10001FF68(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, ...)
{
  va_start(va, a7);
  sub_10002331C(va);
  _Unwind_Resume(a1);
...
void sub_10001FF84(uint64_t a1, uint64_t a2)
{
  ...
  *(a1 + 232) = 0u;
  *(a1 + 248) = 0u;
  sub_10002082C((a1 + 264), &off_1002031A8, a2);
}

void sub_1000207C8(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, ...)
{
  va_start(va, a6);
  sub_100023A28(va);
  sub_100023A28(v8);
  sub_100020A3C(v9, &off_1002031A8);
  sub_100020AFC(v7, &off_100203188);
  sub_100020BC4(v6, &off_100203148);
  _Unwind_Resume(a1);
}
...
void sub_1000209F4(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, const void *a9, const void *a10)
{
  sub_100023024(&a9);
  sub_100023A5C(&a10);
...
uint64_t sub_100020BC4(uint64_t a1, uint64_t *a2)
{
  v3 = *a2;
  *a1 = *a2;
  *(a1 + *(v3 - 24)) = a2[3];
...
void sub_1000213A0(_Unwind_Exception *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, void *__p, uint64_t a10, int a11, __int16 a12, char a13, char a14, char a15)
{
  if (a14 < 0)
  {
    operator delete(__p);
...
void sub_1000215E4(_Unwind_Exception *a1, uint64_t a2, ...)
{
  va_start(va, a2);
  sub_100004450((v2 + 8));
  sub_1000043E8(va);
...
void sub_100021710(uint64_t a1)
{
  *a1 = off_100204348;
  *(a1 + 40) = off_1002043A0;
  sub_100023024((a1 + 32));
...
void sub_100021ECC(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, ...)
{
  va_start(va1, a4);
  va_start(va, a4);
...
void sub_1000222B4(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, ...)
{
  va_start(va, a3);
  sub_100004450((v3 + 8));
  sub_1000043E8(va);
...
uint64_t sub_10002244C(uint64_t a1)
{
  ...
  *(v2 + 264) = off_100203E20;
  *(v2 + 64) = off_100203E78;
  sub_100023024((v2 + 288));
...
void sub_100022840(_Unwind_Exception *a1, uint64_t a2, ...)
{
  va_start(va, a2);
  sub_100004450((v2 + 8));
  sub_1000043E8(va);
...
uint64_t sub_10002323C(uint64_t a1, void *a2)
{
  v4 = a2[1];
  *a1 = *a2;
  *(a1 + 8) = v4;
...
uint64_t sub_100023AE8(uint64_t result, void *a2, void *a3)
{
  if (a2 != a3)
  {
    ...
    do
    {
      result = sub_100023B70(v5, (v5 + 8), (v4 + 4));
      v6 = v4[1];
      if (v6)
      {
        do
...
uint64_t sub_100023B70(uint64_t **a1, uint64_t *a2, uint64_t a3)
{
...
void sub_100024DE0(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, ...)
{
  va_start(va, a3);
  v6 = *(v4 - 200);
  if (v6)
...
void sub_1000257D0(_Unwind_Exception *a1, uint64_t a2, ...)
{
  va_start(va, a2);
  sub_1000036E8(v2);
  sub_100003780(va);
...
uint64_t sub_1000257F4(uint64_t a1, uint64_t a2)
{
  if (*(a1 + 256) == 1)
  {
    v3 = *a2;
...
unint64_t sub_100025E70(uint64_t (*a1)(__int128 *), uint64_t a2, uint64_t a3, unint64_t a4)
{
...
unint64_t sub_1000264D4(uint64_t (*a1)(__int128 *), uint64_t a2, uint64_t a3, unint64_t a4)
{
  sub_100026898(&v26, a2);
  v28 = *(a2 + 112);
  v29 = *(a2 + 120);
...
void sub_100026C80(uint64_t a1, void *a2)
{
  v4 = (a2 + 3);
  v3 = *a2;
  if (v4 == v3)
  {
    sub_100026CF8(a1, v3, v3 + 24 * a2[1]);
...
void sub_100027018(uint64_t a1, unint64_t a2)
{
  v3 = *(a1 + 8);
  v4 = a2 - v3;
  if (a2 >= v3)
  {
    ...
    if (*(a1 + 16) - v3 < v4)
    {
      sub_10002709C(a1, v5, v4, &v6);
    }

    else
    {
      sub_1001A3264(a1, v5, v5, v4);
      *(a1 + 8) += v4;
    }
  }
...
void sub_10002709C(void **a1@<X0>, char *a2@<X1>, uint64_t a3@<X2>, void *a4@<X8>)
{
  v8 = *a1;
  v9 = sub_10002712C(a1, a3);
  if (v9 >> 60)
  {
    sub_100026DEC("get_next_capacity, allocator's max size reached");
  }
  ...
  sub_1001A3344(a1, v11, v10, a2, a3);
  *a4 = *a1 + a2 - v8;
}
...
int *sub_1000273B4(int *result)
{
  v1 = *result;
  *result = 0;
  if (v1)
  {
    return sub_1001519CC(result + 2, v1);
  }

  return result;
}

uint64_t sub_1000273E0(uint64_t a1)
{
  *a1 = off_100228258;
  sub_100027454((a1 + 48));
  *a1 = off_100204580;
...
int *sub_100027454(int *result)
{
  v1 = *result;
  *result = 0;
  if (v1)
  {
    return sub_100151A90(result + 2, v1);
  }
...
void sub_100027584(uint64_t a1, uint64_t a2)
{
  *a2 = off_100228230;
  sub_1000273B4((a2 + 56));
  v3 = *(a2 + 48);
...
void sub_100027630(uint64_t a1, uint64_t a2)
{
  *a2 = off_100228258;
  sub_100027454((a2 + 48));
  *a2 = off_100204580;
...
void sub_100027CE8(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, ...)
{
  va_start(va, a11);
...
void sub_100027DD8(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, ...)
{
  va_start(va, a10);
  sub_1000287DC(va);
  JUMPOUT(0x100027DD0);
...
void *sub_100028504(void *result)
{
  if (*result)
  {
    if (result[2])
...
void *sub_100028558(void *result)
{
  if (*result)
  {
    if (result[2])
...
uint64_t *sub_100028ACC(uint64_t *a1)
{
  if (*a1)
  {
    sub_100028B28(a1);
...
uint64_t *sub_100028B28(uint64_t *result)
{
  v1 = result[2];
  if (v1)
  {
...
uint64_t *sub_100028B80(uint64_t *a1)
{
  v2 = *a1;
  if (v2)
  {
...
void sub_100028C9C(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, ...)
{
  va_start(va, a4);
  sub_100028DD8(va);
  _Unwind_Resume(a1);
...
uint64_t *sub_100029758(uint64_t *result)
{
  v1 = result[2];
  if (v1)
  {
...
uint64_t sub_100029B3C(void *a1)
{
  sub_10014F6E8(a1);
  sub_100029B80(a1 + 28);
...
unint64_t sub_100029E98(uint64_t (*a1)(__int128 *), uint64_t *a2, uint64_t a3, unint64_t a4, char a5)
{
  v8 = 0;
  v9 = 0;
  v10 = *(a3 + 208);
...
void sub_10002C4FC(_Unwind_Exception *a1, int a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12)
{
  if (a12)
  {
    (*(*a12 + 16))(a12);
...
void sub_10002C8AC(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, ...)
{
  va_start(va, a6);
  sub_10002ECF4(va);
  if (a6)
