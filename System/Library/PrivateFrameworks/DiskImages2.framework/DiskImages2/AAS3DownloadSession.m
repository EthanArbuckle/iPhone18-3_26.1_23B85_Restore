...
- (AAS3DownloadSession)initWithURL:(id)a3 streamBase:(id *)a4 maxAttempts:(unsigned int)a5 pauseInterval:(float)a6 maxRequestsInFlight:(unsigned int)a7
{
  ...
  if (v14)
  {
    ...
    v55 = a7;
    v57 = v13;
    v56 = [MEMORY[0x277CBABC8] ephemeralSessionConfiguration];
    ...
    v35 = [MEMORY[0x277CBABB8] sessionWithConfiguration:v56];
...
LABEL_2:
  ...
  if (v12 && (v34 = [v12 description]) != 0)
  {
    v35 = v34;
    [v34 UTF8String];
    pc_log_warning("/Library/Caches/com.apple.xbs/Sources/ParallelCompression/AppleArchiveS3/AAS3DownloadStreamURLSession.m", "+[AAS3DownloadSession completeRequest:data:response:error:]", 546, 121, "Request failed: %03ld %s", v36, v37, v38, v14);
  }

  else
  {
    pc_log_warning("/Library/Caches/com.apple.xbs/Sources/ParallelCompression/AppleArchiveS3/AAS3DownloadStreamURLSession.m", "+[AAS3DownloadSession completeRequest:data:response:error:]", 547, 121, "Request failed: %03ld (error not set)", v15, v16, v17, v14);
  }
