...
- (DIImageHandle)initWithDiskImage:(void *)a3 lockableResources:(const void *)a4
{
  ...
  if (v6)
  {
    ...
    *a3 = 0;
    ...
    if (v7 + 2 != a4)
    {
      std::vector<std::shared_ptr<LockableResource>>::__assign_with_size[abi:ne200100]<std::shared_ptr<LockableResource>*,std::shared_ptr<LockableResource>*>(v7 + 2, *a4, *(a4 + 1), (*(a4 + 1) - *a4) >> 4);
    }
  }
