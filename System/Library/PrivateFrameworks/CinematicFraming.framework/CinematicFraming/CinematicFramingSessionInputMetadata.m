...
- (CinematicFramingSessionInputMetadata)initWithDetectedObjectsInfo:(id)a3 calibrationData:(id)a4 timestamp:(id *)a5 aspectRatio:(float)a6 sensorID:(int)a7 filteredFaceIDs:(id)a8 filteredBodyIDs:(id)a9 calibrationDistortionCoefficientsSupported:(BOOL)a10 calibrationValidMaxRadiusSupported:(BOOL)a11
{
  ...
  if (v23)
  {
    objc_storeStrong(&v23->_detectedObjectsInfo, a3);
    ...
    if (v20)
    {
      v25 = [(CinematicFramingSessionInputMetadata *)v24 _validateCalibrationDictionary:v20];
...
- (CinematicFramingSessionInputMetadata)initWithDetectedObjectsInfo:(id)a3 calibrationData:(id)a4 timestamp:(id *)a5 aspectRatio:(float)a6 sensorID:(int)a7
{
  v9 = *a5;
  LOWORD(v8) = 257;
  return [CinematicFramingSessionInputMetadata initWithDetectedObjectsInfo:"initWithDetectedObjectsInfo:calibrationData:timestamp:aspectRatio:sensorID:filteredFaceIDs:filteredBodyIDs:calibrationDistortionCoefficientsSupported:calibrationValidMaxRadiusSupported:" calibrationData:a3 timestamp:a4 aspectRatio:&v9 sensorID:*&a7 filteredFaceIDs:0 filteredBodyIDs:0 calibrationDistortionCoefficientsSupported:v8 calibrationValidMaxRadiusSupported:?];
}
...
- (CinematicFramingSessionInputMetadata)initWithCoder:(id)a3
{
  ...
  if (v5)
  {
    ...
    v25 = [v4 decodeObjectOfClasses:v24 forKey:@"calibrationDataDictionary"];
    ...
    if (v30)
    {
      ...
      do
      {
        ...
        do
        {
          ...
          v32 = v9;
          v10 = *(*(&v48 + 1) + 8 * v9);
          v11 = [(NSDictionary *)obj objectForKeyedSubscript:v10, v27];
...
- (id)_validateCalibrationDictionary:(id)a3
{
  ...
  v6 = [v4 objectForKeyedSubscript:@"PixelSize"];
  if (!v6)
  {
LABEL_25:
    v7 = 0;
