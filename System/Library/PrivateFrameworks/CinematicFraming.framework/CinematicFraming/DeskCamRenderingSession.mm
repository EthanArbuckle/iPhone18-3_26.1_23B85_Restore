...
- (float32x2_t)_projectPoint:(int8x16_t)a3 intrinsicMatrix:(double)a4 rotationMatrix:(float32x4_t)a5;
- (float32x2_t)focusPoint;
- (float32x2_t)trapezoidForZoomFactorValue:(float32x2_t *)a1;
...
- (DeskCamRenderingSession)initWithOutputDimensions:(id)a3 portType:(id)a4 deviceType:(int)a5 isFrontFacingCamera:(BOOL)a6
{
  ...
  v12->_outputDimensions = a3;
  objc_storeStrong(&v12->_portType, a4);
  v13->_deviceType = a5;
  ...
  *&v13->_anon_1d0[3] = v16;
  ...
  v13->_autoZoomSupported = (a5 - 3) < 2;
  LODWORD(v13->_autoZoomScalingFactor) = dword_2434F78A8[(a5 - 3) < 2];
...
- (void)registerCameraCalibrationDictionary:(id)a3
{
  ...
  *&self->_anon_d0[7] = v10;
  ...
  v11 = [v4 objectForKeyedSubscript:@"LensDistortionCenter"];
  v12 = [v11 objectForKeyedSubscript:@"X"];
  [v12 floatValue];
  *&self->_anon_d0[123] = v13;

  v14 = [v4 objectForKeyedSubscript:@"LensDistortionCenter"];
  ...
  *&self->_anon_d0[131] = v19 * v19;
  v34 = [v4 objectForKeyedSubscript:@"LensDistortionCoefficients"];
  v20 = v34;
  v21 = [v34 bytes];
  v22 = v21[1];
  *&self->_anon_d0[171] = *v21;
  *&self->_anon_d0[187] = v22;
  v23 = [v4 objectForKeyedSubscript:@"InverseLensDistortionCoefficients"];
  v24 = [v23 bytes];
  v25 = v24[1];
  *&self->_anon_d0[139] = *v24;
  *&self->_anon_d0[155] = v25;
  v26 = [v4 objectForKeyedSubscript:@"IntrinsicMatrix"];
  v27 = [v26 bytes];
  v29 = v27[1];
  v28 = v27[2];
  *&self->_anon_d0[67] = *v27;
  ...
  *&self->_anon_d0[99] = vzip1q_s32(vdupq_laneq_s32(v30, 2), vdupq_laneq_s32(v31, 2)).u64[0];
  v33 = [v4 objectForKeyedSubscript:@"DistortionCalibrationValidMaxRadiusInPixels"];
...
- (void)_updateSubjectRectangleInSensorSpace:(CGRect *)a3 withDetections:(id)a4
{
  ...
  v35 = 0u;
  v36 = 0u;
  v7 = [v5 countByEnumeratingWithState:&v33 objects:v32 count:16];
  if (v7)
  {
    v8 = v7;
    v9 = *v34;
    ...
    do
    {
      ...
      v8 = [v5 countByEnumeratingWithState:&v33 objects:v32 count:16];
    }
...
LABEL_17:
  ...
  if (!CGRectIsNull(*a3))
  {
    v28 = vmlaq_f64(vmulq_f64(v30, vdupq_n_s64(0x3FB47AE100000000uLL)), vdupq_n_s64(0x3FED70A3E0000000uLL), a3->size);
    v27 = vmlaq_f64(vmulq_f64(v29, vdupq_n_s64(0x3FB70A3D00000000uLL)), vdupq_n_s64(0x3FED1EB860000000uLL), a3->origin);
    goto LABEL_17;
  }
...
- (int)processBuffer:(__CVBuffer *)a3 outputPixelBuffer:(__CVBuffer *)a4
{
  ...
  v98 = 0;
  v99 = 0;
  v9 = cachedTexturesFromPixelBuffer(a3, v100, self->_metalTextureCacheRef);
  if (v9)
  {
    fig_log_get_emitter();
    FigDebugAssert3();
LABEL_35:
  ...
  v9 = cachedTexturesFromPixelBuffer(a4, v97, self->_metalTextureCacheRef);
  if (v9)
  {
    fig_log_get_emitter();
    FigDebugAssert3();
  ...
  if ((deviceType - 2) >= 3)
  {
    if (deviceType == 1)
    {
      ...
      [v8 setTexture:v101 atIndex:0];
      [v8 setTexture:v102 atIndex:1];
      [v8 setTexture:v98 atIndex:2];
      [v8 setTexture:v99 atIndex:3];
      [v8 setBytes:&v65 length:512 atIndex:0];
      ...
      *&v64[16] = 1;
      [v8 dispatchThreads:&v61 threadsPerThreadgroup:v64];
      goto LABEL_31;
    }

LABEL_8:
    v19 = qword_27ED77998;
    [v8 setComputePipelineState:v19];
    [v8 setTexture:v101 atIndex:0];
    [v8 setTexture:v102 atIndex:1];
    [v8 setTexture:self->_warpedRGBLowResTexture atIndex:2];
    [v8 setBytes:&v65 length:512 atIndex:0];
    v20 = [v19 threadExecutionWidth];
    v56 = v7;
    v21 = [v19 maxTotalThreadsPerThreadgroup];
    v22 = [(MTLTexture *)self->_warpedRGBLowResTexture width];
    v23 = [(MTLTexture *)self->_warpedRGBLowResTexture height];
    v61 = v22;
    v62 = v23;
    v63 = 1;
    *v64 = v20;
    ...
    *&v64[16] = 1;
    ...
    do
    {
      ...
      [v8 setTexture:*p_warpedRGBLowResTexture atIndex:0];
      if (v24)
      {
      ...
      [v8 setTexture:*v28 atIndex:1];
      [v8 setBytes:&self->_imageBlurringControls length:1036 atIndex:0];
      v29 = [v19 threadExecutionWidth];
      v30 = [v19 maxTotalThreadsPerThreadgroup];
      v31 = [(MTLTexture *)*p_blurredRGBLowResTexture width];
      v32 = [(MTLTexture *)*p_blurredRGBLowResTexture height];
      v61 = v31;
      v62 = v32;
      v63 = 1;
      *v64 = v29;
    ...
    [v8 setTexture:v101 atIndex:0];
    [v8 setTexture:v102 atIndex:1];
    [v8 setTexture:*p_blurredRGBLowResTexture atIndex:2];
    [v8 setTexture:v98 atIndex:3];
    [v8 setTexture:v99 atIndex:4];
    [v8 setBytes:&v65 length:512 atIndex:0];
    [v8 setBytes:&self->_imageBlendingControls length:8 atIndex:1];
    [v8 setImageblockWidth:32 height:32];
    v33 = [v98 width];
    v34 = [v98 height];
    v61 = v33;
    ...
    *&v64[16] = 1;
    ...
    if (self->_autoZoomSupported)
    {
      ...
      *&v104.origin.y = *&self->_translationVector[3];
      ...
      v59 = 1065353216;
      v60 = 1;
      [v8 setComputePipelineState:v39];
      [v8 setTexture:v101 atIndex:0];
      [v8 setTexture:v102 atIndex:1];
      [v8 setTexture:self->_lineDetectionController.inputTexture atIndex:2];
      [v8 setBytes:&v65 length:512 atIndex:0];
      [v8 setBytes:&v60 length:4 atIndex:1];
      [v8 setBytes:&v59 length:4 atIndex:2];
      v40 = [v39 threadExecutionWidth];
      v41 = [v39 maxTotalThreadsPerThreadgroup];
      p_lineDetectionController = &self->_lineDetectionController;
      v43 = [(MTLTexture *)self->_lineDetectionController.inputTexture width];
      v44 = [(MTLTexture *)self->_lineDetectionController.inputTexture height];
      *v64 = v43;
      *&v64[8] = v44;
      *&v64[16] = 1;
      *&v57 = v40;
      *(&v57 + 1) = v41 / v40;
      v58 = 1;
      [v8 dispatchThreads:v64 threadsPerThreadgroup:&v57];
      v16 = qword_27ED779A8;
      ...
      do
      {
        ...
        [v8 setTexture:p_auxiliaryTexture->inputTexture atIndex:0];
        if (v46)
        {
        ...
        [v8 setTexture:v48->inputTexture atIndex:1];
        [v8 setBytes:&self->_anon_ad0[64] length:1036 atIndex:0];
        v49 = [v16 threadExecutionWidth];
        v50 = [v16 maxTotalThreadsPerThreadgroup];
        v51 = [(MTLTexture *)p_lineDetectionController->inputTexture width];
        v52 = [(MTLTexture *)p_lineDetectionController->inputTexture height];
        *v64 = v51;
        *&v64[8] = v52;
        *&v64[16] = 1;
        *&v57 = v49;
      ...
      for (i = 0; i != 31; ++i)
      {
        ...
        *(&v61 + i) = __PAIR64__(LODWORD(v54.__sinval), LODWORD(v54.__cosval));
      }

      [v8 setComputePipelineState:qword_27ED779F8];
      [v8 setTexture:p_lineDetectionController->inputTexture atIndex:0];
      [v8 setBytes:&v61 length:248 atIndex:0];
      [v8 setTexture:*&self->_anon_ad0[16] atIndex:1];
  ...
  [v8 setTexture:v101 atIndex:0];
  [v8 setTexture:v102 atIndex:1];
  [v8 setTexture:self->_warpedRGBHiResTexture atIndex:2];
  [v8 setBytes:&v65 length:512 atIndex:0];
  [v8 setBytes:&self->_imageToneMappingControls length:12 atIndex:1];
  v12 = [v11 threadExecutionWidth];
  v13 = [v11 maxTotalThreadsPerThreadgroup];
  v14 = [(MTLTexture *)self->_warpedRGBHiResTexture width];
  v15 = [(MTLTexture *)self->_warpedRGBHiResTexture height];
  v61 = v14;
  v62 = v15;
  v63 = 1;
  *v64 = v12;
  ...
  *&v64[16] = 1;
  ...
  [v8 setComputePipelineState:v16];
  [v8 setTexture:self->_warpedRGBHiResTexture atIndex:0];
  [v8 setTexture:v98 atIndex:1];
  [v8 setTexture:v99 atIndex:2];
  [v8 setBytes:&self->_imageSharpeningControls length:1040 atIndex:0];
  [v8 setImageblockWidth:32 height:32];
  v17 = [v98 width];
  v18 = [v98 height];
  v61 = v17;
...
- (float32x2_t)_mapPointFromNormalizedSensorSpaceToNormalizedFramingSpace:(uint64_t)a1
{
  ...
  v5 = *(a1 + 336) * vaddv_f32(vmul_f32(v4, v4));
  v6 = vmla_n_f32(v3, v4, 1.0 / (((*(a1 + 344) + ((*(a1 + 348) + ((*(a1 + 352) + ((*(a1 + 356) + ((*(a1 + 360) + ((*(a1 + 364) + ((*(a1 + 368) + (*(a1 + 372) * v5)) * v5)) * v5)) * v5)) * v5)) * v5)) * v5)) * 0.01) + 1.0));
  v7 = vcvt_f32_f64(vdivq_f64(vcvtq_f64_f32(v2), *(a1 + 96)));
  return vdiv_f32(vmla_f32(vcvt_f32_f64(vmlsq_f64(0, vcvtq_f64_f32(v7), *(a1 + 80))), v7, v6), v2);
}
...
- (float32x2_t)_mapNormalizedPointInFramingSpaceToOutputCropRect:(simd_float3)a3 withTransformMatrix:(simd_float3)a4
{
  ...
  v6.columns[2] = a4;
  v7 = __invert_f3(v6);
  v7.columns[0] = vaddq_f32(v7.columns[2], vmlaq_lane_f32(vmulq_n_f32(v7.columns[0], *&a1), v7.columns[1], *&a1, 1));
...
- (float)_filterAutoZoomScalingFactor:(float)a3
{
  ...
  v15 = fabsf(a3 - autoZoomScalingFactor);
  if (v15 <= self->_autoZoomFilteringController.largeChangeThresh)
  {
    if (v15 < self->_autoZoomFilteringController.smallChangeThresh)
    {
      ...
      if (v19 < 0 == v18)
      {
        result = ((1.0 - temporalAlpha) * a3) + (self->_autoZoomScalingFactor * temporalAlpha);
    ...
    {
      return ((1.0 - temporalAlpha) * a3) + (self->_autoZoomScalingFactor * temporalAlpha);
    }
...
- (double)_translationVector
{
  ...
  *&v12 = v10 + v11;
  ...
  [a1 _projectPoint:v9 intrinsicMatrix:*(a1 + 272) rotationMatrix:{*(a1 + 288), *(a1 + 304), *(a1 + 464), *(a1 + 480), *(a1 + 496), *&a6}];
  v14 = v13;
  [a1 _projectPoint:v43 intrinsicMatrix:*(a1 + 272) rotationMatrix:{*(a1 + 288), *(a1 + 304), *(a1 + 464), *(a1 + 480), *(a1 + 496)}];
  v16 = v15;
  [a1 _projectPoint:v44 intrinsicMatrix:*(a1 + 272) rotationMatrix:{*(a1 + 288), *(a1 + 304), *(a1 + 464), *(a1 + 480), *(a1 + 496)}];
  v18 = v17;
  [a1 _projectPoint:v45 intrinsicMatrix:*(a1 + 272) rotationMatrix:{*(a1 + 288), *(a1 + 304), *(a1 + 464), *(a1 + 480), *(a1 + 496)}];
  v20 = v19;
  v21 = *(a1 + 80);
  v22 = *(a1 + 88);
  v23 = *(a1 + 96);
...
- (float32x2_t)_projectPoint:(int8x16_t)a3 intrinsicMatrix:(double)a4 rotationMatrix:(float32x4_t)a5
{
  v7 = vaddq_f32(a7, vmlaq_n_f32(vmulq_n_f32(a5, (*&a1 - *&a2.i32[2]) / *a2.i32), a6, (*(&a1 + 1) - *&a3.i32[2]) / *&a3.i32[1]));
  v8 = vdiv_f32(*v7.i8, *&vdupq_laneq_s32(v7, 2));
  v7.i64[0] = vextq_s8(a2, a2, 8uLL).u64[0];
  a2.i32[1] = a3.i32[1];
  return vmla_f32(vzip1_s32(*v7.i8, *&vextq_s8(a3, a3, 8uLL)), *a2.i8, v8);
}
...
- (double)_transformMatrixWithOutputCropRectangle:(double)a3
{
  ...
  *&v11 = a3;
  ...
  v25 = __invert_f3(v67);
  v24 = 0;
  v25.columns[2] = vaddq_f32(v25.columns[2], vaddq_f32(*(a1 + 560), *(a1 + 528)));
  v61 = v56;
  v62 = v55;
  v63 = v54;
  v64 = 0u;
  ...
  HIDWORD(v38) = 0;
  HIDWORD(v39) = 0;
  v40 = vaddq_f32(v66, vaddq_f32(*(a1 + 576), *(a1 + 512)));
  v61 = v38;
  v62 = v39;
  v63 = v40;
  v64 = 0u;
  ...
  v44.i32[3] = 0;
  v45.i64[0] = *(a1 + 208);
  v46 = vcvt_f32_f64(vdivq_f64(vcvtq_f64_f32(*v45.f32), *(a1 + 96)));
  v47 = v46.u32[0];
  v48.i32[0] = 0;
  v48.i64[1] = 0;
  v48.i32[1] = v46.i32[1];
  v49.i64[1] = v60;
  *v49.f32 = vcvt_f32_f64(vmlsq_f64(0, vcvtq_f64_f32(v46), *(a1 + 80)));
  v61 = v42;
  v62 = v43;
  v63 = v44;
  v64 = 0u;
...
- (float32x2_t)focusPoint
{
  ...
  v7 = v1[26];
  v1 += 26;
  *v4.f32 = vcvt_f32_f64(vdivq_f64(vcvtq_f64_f32(v7), *v1[-14].f32));
  return vdiv_f32(distortPoint(v1, vdiv_f32(vsub_f32(vmul_f32(v7, vdiv_f32(*v6.i8, *&vdupq_laneq_s32(v6, 2))), vcvt_f32_f64(vmlsq_f64(0, vcvtq_f64_f32(*v4.f32), *v1[-16].f32))), *v4.f32)), *v1);
}
...
- (int)_allocateTextures
{
  ...
  else
  {
    ...
    v6 = [(MTLCommandQueue *)self->_commandQueue device];
    ...
    v9 = [(MTLCommandQueue *)self->_commandQueue device];
    v10 = [v9 newTextureWithDescriptor:v5];
    ...
    v12 = [(MTLCommandQueue *)self->_commandQueue device];
    ...
    if (self->_autoZoomSupported)
    {
      ...
      v15 = [(MTLCommandQueue *)self->_commandQueue device];
      v16 = [v15 newTextureWithDescriptor:v5];
      ...
      v18 = [(MTLCommandQueue *)self->_commandQueue device];
      v19 = [v18 newTextureWithDescriptor:v5];
      ...
      v22 = [(MTLCommandQueue *)self->_commandQueue device];
      v23 = [v22 newTextureWithDescriptor:v5];
      ...
      *&self->_anon_ad0[16] = v23;
      ...
      v26 = [v25 height];
      v27 = [*&self->_anon_ad0[16] width];
      v28 = malloc_type_calloc(v27 * v26, 0x10uLL, 0x1000040451B5BE8uLL);
      ...
      *&self->_anon_ad0[32] = v29;
      ...
      v30 = malloc_type_calloc(v27, 0x20uLL, 0x1000040E0EAB150uLL);
...
- (id)_newBufferWithLength:(unint64_t)a3 options:(unint64_t)a4 label:(id)a5
{
  ...
  if (metalDevice)
  {
    v10 = [(MTLDevice *)metalDevice newBufferWithLength:a3 options:a4];
    [v10 setLabel:v8];
  }
...
- ($7350132BDA356DD21C3911335718E94B)_deskEdgeDetectorResult
{
  ...
  *v2->f32 = xmmword_2434F7A28;
  v5 = [(MTLTexture *)self->_lineDetectionController.inputTexture width];
  v6 = [*&self->_anon_ad0[16] width];
  v7 = [*&self->_anon_ad0[16] height];
  ...
  if (v6)
  {
    if (!v5 || v7 != 31 || (v11 = v79) == 0 || (bzero(v79, (496 * v6) & 0xFFFFFFFF0), !v8) || (v12 = v6, bzero(v8, 4 * v6), !v9))
    {
      fig_log_get_emitter();
    ...
    v73 = v10;
    [v10 getBytes:v79 bytesPerRow:16 * v6 fromRegion:v83 mipmapLevel:0];
    v14 = 0;
    v15 = 0;
    v76 = 0;
    v75 = (v6 * 0.5) + -0.5;
...
LABEL_24:
      ...
      if (v23)
      {
        ...
        if (v23 >= 1)
        {
          ...
          do
          {
            if ((v41[4] - v41[3]) > 0.062745 && OUTLINED_FUNCTION_3_0(v41[7], v41[5], v41[6]) >= ((v6 * 0.05) * (v6 * 0.05)))
            {
              v40 = v41;
            }
        ...
        v80 = [(MTLTexture *)self->_lineDetectionController.inputTexture width];
        v49 = [(MTLTexture *)self->_lineDetectionController.inputTexture height];
        v50 = v47 / sqrtf(v46);
      ...
      if (v15 == 31)
      {
        ...
        v82 = v63;
        v81 = [(MTLTexture *)self->_lineDetectionController.inputTexture width];
        v64 = [(MTLTexture *)self->_lineDetectionController.inputTexture height];
        v65.f32[0] = v81;
        v65.f32[1] = v64;
        v66 = v65;
