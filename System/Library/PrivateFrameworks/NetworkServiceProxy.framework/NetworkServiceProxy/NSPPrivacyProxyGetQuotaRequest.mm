...
- (id)description
{
  ...
  v5 = [(NSPPrivacyProxyGetQuotaRequest *)self dictionaryRepresentation];
...
- (void)copyTo:(id)a3
{
  ...
  if (useCaseIdentifier)
  {
    [a3 setUseCaseIdentifier:useCaseIdentifier];
  }
}
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v6 = [(NSString *)self->_useCaseIdentifier copyWithZone:a3];
  v7 = v5[1];
  v5[1] = v6;
