...
- (id)description
{
  ...
  v5 = [(NSPPrivacyProxyCost *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  if ((has & 2) != 0)
  {
    ...
    [v3 setObject:v6 forKey:@"remaining"];
  }
...
LABEL_11:
  ...
  if ((*&self->_has & 2) != 0)
  {
    if ((*(v4 + 24) & 2) == 0 || self->_remaining != *(v4 + 2))
    {
      goto LABEL_11;
    }
