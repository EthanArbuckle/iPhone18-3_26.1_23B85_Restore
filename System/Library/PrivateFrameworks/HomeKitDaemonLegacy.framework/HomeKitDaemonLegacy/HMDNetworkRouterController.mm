  ...
  else
  {
    ...
    else
    {
      ...
      if (v22)
      {
        ...
        {
          v41 = [MEMORY[0x277CCA9B8] hmErrorWithCode:qword_253D4C018[v39 - 1]];
        }
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t30_129437 != -1)
  {
    dispatch_once(&logCategory__hmf_once_t30_129437, &__block_literal_global_129438);
  }

  v3 = logCategory__hmf_once_v31_129439;
