...
- (void)handleUpdatedGroupModel:(id)a3 completion:(id)a4
{
  ...
  if (!v11)
  {
    v24 = [(HMDAccessorySettingsController *)self groupsMap];
    v25 = [(HMDAccessorySettingGroup *)v6 parentUUID];
    ...
    if (os_log_type_enabled(v35, OS_LOG_TYPE_ERROR))
    {
      ...
      v37 = [(HMDAccessorySettingGroup *)v6 parentUUID];
      v39 = 138543874;
      v40 = v36;
      v41 = 2112;
      v42 = v37;
...
LABEL_19:
  ...
  v17 = [(HMDAccessorySettingsController *)v13 home];
  [v17 isOwnerUser];
...
LABEL_14:
  [(HMDAccessorySettingsController *)self settingsHierarchyDidChange];
  v7[2](v7, 0);
  v31 = [(HMDAccessorySettingsController *)self ownerController];
  v32 = v31;
  if (v31)
  {
    [v31 scheduleAuditWithReason:4 from:self];
  }
...
{
  v3 = [a3 keyPath];
  v4 = [&unk_286627250 containsObject:v3];
