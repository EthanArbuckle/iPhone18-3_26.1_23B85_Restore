...
- (void)_callDelegate
{
  ...
  if ([v4 conformsToProtocol:&unk_286685390])
  {
    v5 = v4;
  }
      ...
      if (v20)
      {
        ...
        else
        {
          ...
          if (os_log_type_enabled(v67, OS_LOG_TYPE_INFO))
          {
            ...
            v76 = [(HMDUserPresenceFeedSession *)v66 presenceAuthStatus];
            v75 = [(HMDUserPresenceFeedSession *)v66 presenceRegionStatus];
          ...
          [v72 sendMessage:v80 completionHandler:0];
