...
- (HMDSharedUserInviteOwnerSendLogEventBuilder)initWithHome:(id)home sessionIdentifier:(id)identifier invitationType:(unint64_t)type invitationAge:(double)age invitationSource:(unint64_t)source
{
  ...
  v15 = [(HMDSharedUserInviteOwnerSendLogEventBuilder *)self initWithHome:homeCopy sessionIdentifier:identifierCopy invitationType:type invitationAge:source invitationSource:v14 logEventSubmitter:&__block_literal_global_176924 currentUpTicksBlock:age submissionTimerFactory:&__block_literal_global_4_176925];
