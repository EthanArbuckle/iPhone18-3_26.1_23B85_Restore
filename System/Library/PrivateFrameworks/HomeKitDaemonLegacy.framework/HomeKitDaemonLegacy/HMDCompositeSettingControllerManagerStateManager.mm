  ...
  if (v8 && [v8 isHomePod])
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
      {
        ...
        v19 = 138543362;
        v20 = v17;
        _os_log_impl(&dword_2531F8000, v16, OS_LOG_TYPE_ERROR, "%{public}@Couldn't find home for removed accessory, will not process language change", &v19, 0xCu);
      }
...
- (void)_handleAccessoryLanguagesChangedNotification:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v22 = 2112;
    v23 = v4;
    _os_log_impl(&dword_2531F8000, v7, OS_LOG_TYPE_INFO, "%{public}@Received notification for language list change: %@", &v20, 0x16u);
  }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR))
    {
      ...
      v20 = 138543362;
      v21 = v18;
      _os_log_impl(&dword_2531F8000, v17, OS_LOG_TYPE_ERROR, "%{public}@Couldn't find home to work with, will not process language change", &v20, 0xCu);
    }
...
- (void)_computeResidentStateChangeForHome:(id)a3
{
  ...
  if ([v4 isCurrentDeviceAvailableResident])
  {
    ...
    if (os_log_type_enabled(v20, OS_LOG_TYPE_INFO))
    {
      ...
      v28 = 2112;
      v29 = v17;
      _os_log_impl(&dword_2531F8000, v20, OS_LOG_TYPE_INFO, "%{public}@updated device is a resident and is the current device, state: %@ -> %@", &v24, 0x20u);
    }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
    {
      ...
      _os_log_impl(&dword_2531F8000, v14, OS_LOG_TYPE_INFO, "%{public}@Current device is not a resident, will update current state to %@", &v24, 0x16u);
    }

    objc_autoreleasePoolPop(v12);
    os_unfair_lock_lock_with_options();
    [(HMDCompositeSettingControllerManagerStateManager *)v13 _createStateForHomeUUIDIfNotExist:v5];
    [(NSMutableDictionary *)v13->_homeUUIDToState setObject:&unk_286629290 forKeyedSubscript:v5];
...
- (void)_handleResidentDeviceUpdated:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v26 = 2114;
    v27 = v9;
    _os_log_impl(&dword_2531F8000, v7, OS_LOG_TYPE_INFO, "%{public}@Received notification for resident update: %{public}@", &v24, 0x16u);
  }
...
LABEL_16:
      _os_log_impl(&dword_2531F8000, v20, OS_LOG_TYPE_ERROR, v22, &v24, 0xCu);
    }
...
- (void)_handleSiriEndpointProfileCreation:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v24 = 2112;
    v25 = v4;
    _os_log_impl(&dword_2531F8000, v7, OS_LOG_TYPE_INFO, "%{public}@Handling HMDSiriEndpointProfileAddedNotification:%@", &v22, 0x16u);
  }
  ...
  if (v11)
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR))
      {
        ...
        v22 = 138543362;
        v23 = v20;
        _os_log_impl(&dword_2531F8000, v19, OS_LOG_TYPE_ERROR, "%{public}@HomeUUID or home are null, will not update state after siri endpoint profile creation", &v22, 0xCu);
      }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_ERROR))
    {
      ...
      v24 = 2112;
      v25 = 0;
      _os_log_impl(&dword_2531F8000, v15, OS_LOG_TYPE_ERROR, "%{public}@Accessory %@ is not a HAPAccessory", &v22, 0x16u);
    }
...
- (void)_handleSiriEndpointProfileSettingsUpdate:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v27 = 2112;
    v28 = v4;
    _os_log_impl(&dword_2531F8000, v7, OS_LOG_TYPE_INFO, "%{public}@received notification:%@", &v25, 0x16u);
  }
  ...
  if (!v14 || (v15 = v14, [v12 uuid], v16 = objc_claimAutoreleasedReturnValue(), v16, v15, !v16))
  {
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR))
    {
      ...
      v29 = 2112;
      v30 = v13;
      _os_log_impl(&dword_2531F8000, v19, OS_LOG_TYPE_ERROR, "%{public}@nil home:%@ or accessory:%@", &v25, 0x20u);
    }
...
- (void)_handleCompositeSettingsControllerConfiguredNotification:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v21 = 138543362;
    v22 = v8;
    _os_log_impl(&dword_2531F8000, v7, OS_LOG_TYPE_INFO, "%{public}@Did handle CompositeSettingsControllerDidConfigure notification", &v21, 0xCu);
  }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v18, OS_LOG_TYPE_ERROR))
    {
      ...
      v25 = 2112;
      v26 = v13;
      _os_log_impl(&dword_2531F8000, v18, OS_LOG_TYPE_ERROR, "%{public}@Nil hapAccessoryUUID:%@ or homeUUID:%@", &v21, 0x20u);
    }
...
- (void)_createStateForHomeUUIDIfNotExist:(id)a3
{
  ...
  if (!v5)
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
    {
      ...
      _os_log_impl(&dword_2531F8000, v8, OS_LOG_TYPE_INFO, "%{public}@Initializing state for home %@ as %@", &v11, 0x20u);
    }

    objc_autoreleasePoolPop(v6);
    [(NSMutableDictionary *)self->_homeUUIDToState setObject:&unk_286629290 forKeyedSubscript:v4];
  }
...
LABEL_14:
          ...
          v12 = 2112;
          v13 = v8;
          _os_log_impl(&dword_2531F8000, v5, OS_LOG_TYPE_INFO, "%{public}@Register for notification with option: %@", &v10, 0x16u);
...
uint64_t __63__HMDCompositeSettingControllerManagerStateManager_logCategory__block_invoke()
{
  ...
  v2 = logCategory__hmf_once_v30_136389;
  logCategory__hmf_once_v30_136389 = v1;
