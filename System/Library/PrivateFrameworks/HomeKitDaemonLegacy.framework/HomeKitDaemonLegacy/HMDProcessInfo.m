  ...
  *&buf[16] = v3;
  ...
  if (!v5->_processHandle)
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
    {
      ...
      *&buf[22] = 2112;
      *&buf[24] = v9;
      _os_log_impl(&dword_2531F8000, v13, OS_LOG_TYPE_ERROR, "%{public}@Unable to determine process handle for pid %@: %@", buf, 0x20u);
    }
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t5_167169 != -1)
  {
    dispatch_once(&logCategory__hmf_once_t5_167169, &__block_literal_global_35_167170);
  }

  v3 = logCategory__hmf_once_v6_167171;
...
+ (NSData)privateClientIdentifierSalt
{
  ...
  {
    dispatch_once(&privateClientIdentifierSalt_onceToken, &__block_literal_global_167178);
  }
