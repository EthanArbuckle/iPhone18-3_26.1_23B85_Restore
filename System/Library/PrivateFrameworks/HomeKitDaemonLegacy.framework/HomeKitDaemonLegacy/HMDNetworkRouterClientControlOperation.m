...
LABEL_9:
  ...
  v10 = [(HMDNetworkRouterClientControlOperation *)self configuration];
...
LABEL_24:
  self = v22;
LABEL_25:
  [(HMDNetworkRouterClientControlOperation *)self setOperation:v11, v22];
...
+ (id)parsedFromData:(id)a3 error:(id *)a4
{
  ...
  {
    v11 = 0;
    [(HMDNetworkRouterClientControlOperation *)v6 parseFromData:v5 error:&v11];
    v8 = v11;
    if (v8)
    {
