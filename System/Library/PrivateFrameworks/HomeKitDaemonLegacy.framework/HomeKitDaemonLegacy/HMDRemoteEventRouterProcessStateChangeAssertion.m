...
- (void)_backgroundTimerDidExpire:(id)a3
{
  ...
  if (os_log_type_enabled(v24, OS_LOG_TYPE_INFO))
  {
    ...
    v36 = 2112;
    v37 = v28;
    _os_log_impl(&dword_2531F8000, v24, OS_LOG_TYPE_INFO, "%{public}@self.isProcessForeground %@, isProcessForeground %@", &v32, 0x20u);
  }
...
void __101__HMDRemoteEventRouterProcessStateChangeAssertion_handleProcessWithBundleIdentifier_updatedIsActive___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    v41 = 1024;
    LODWORD(v42) = v7;
    _os_log_impl(&dword_2531F8000, v4, OS_LOG_TYPE_INFO, "%{public}@Application %@ isActive state changed to %{BOOL}d", &v37, 0x1Cu);
  }
  ...
  if (v8 == 1)
  {
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
    {
      ...
      v39 = 2112;
      v40 = v20;
      _os_log_impl(&dword_2531F8000, v17, OS_LOG_TYPE_INFO, "%{public}@self.isProcessForeground %@, isProcessForeground YES", &v37, 0x16u);
    }
...
LABEL_13:
  ...
  else
  {
    ...
    if (os_log_type_enabled(v35, OS_LOG_TYPE_ERROR))
    {
      ...
      v37 = 138543362;
      v38 = v36;
      _os_log_impl(&dword_2531F8000, v35, OS_LOG_TYPE_ERROR, "%{public}@Failed to enable background timer.", &v37, 0xCu);
    }
...
LABEL_14:
  ...
  if (os_log_type_enabled(v28, OS_LOG_TYPE_INFO))
  {
    ...
    v41 = 2112;
    v42 = v31;
    _os_log_impl(&dword_2531F8000, v28, OS_LOG_TYPE_INFO, "%{public}@foregroundProcesses %@, backgroundProcesses %@", &v37, 0x20u);
  }
...
uint64_t __62__HMDRemoteEventRouterProcessStateChangeAssertion_logCategory__block_invoke()
{
  ...
  v2 = logCategory__hmf_once_v11_126269;
  logCategory__hmf_once_v11_126269 = v1;
