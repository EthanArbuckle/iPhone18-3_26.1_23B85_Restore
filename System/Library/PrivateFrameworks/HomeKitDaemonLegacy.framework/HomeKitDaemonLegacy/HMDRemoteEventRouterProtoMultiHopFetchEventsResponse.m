  ...
  if (v5)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        [(HMDRemoteEventRouterProtoMultiHopFetchEventsResponse *)self addChangedEvents:*(*(&v10 + 1) + 8 * v8++), v10];
      }
...
- (void)copyTo:(id)a3
{
  ...
  if ([(HMDRemoteEventRouterProtoMultiHopFetchEventsResponse *)self changedEventsCount])
  {
    ...
    v4 = [(HMDRemoteEventRouterProtoMultiHopFetchEventsResponse *)self changedEventsCount];
    if (v4)
    {
      v5 = v4;
      for (i = 0; i != v5; ++i)
      {
        v7 = [(HMDRemoteEventRouterProtoMultiHopFetchEventsResponse *)self changedEventsAtIndex:i];
...
- (id)description
{
  ...
  v8.receiver = self;
  v8.super_class = HMDRemoteEventRouterProtoMultiHopFetchEventsResponse;
  v4 = [(HMDRemoteEventRouterProtoMultiHopFetchEventsResponse *)&v8 description];
  v5 = [(HMDRemoteEventRouterProtoMultiHopFetchEventsResponse *)self dictionaryRepresentation];
