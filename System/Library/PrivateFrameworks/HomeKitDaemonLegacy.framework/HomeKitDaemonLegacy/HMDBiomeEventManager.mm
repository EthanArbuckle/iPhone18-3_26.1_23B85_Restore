...
- (HMDBiomeEventManager)init
{
  ...
  v12 = [(HMDBiomeEventManager *)self initWithNotificationCenter:v8 actionSetStream:v9 mediaAccessoryStream:v10 accessoryStream:v11 prunableStreamFactory:&__block_literal_global_79866 workQueue:v7];
