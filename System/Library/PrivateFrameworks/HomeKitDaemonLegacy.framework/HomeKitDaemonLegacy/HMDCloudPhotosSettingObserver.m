...
- (void)handleAccountStoreDidChangeNotification:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v18 = 138543362;
    v19 = v8;
    _os_log_impl(&dword_2531F8000, v7, OS_LOG_TYPE_INFO, "%{public}@Received account change notification", &v18, 0xCu);
  }
  ...
  if (v9 != [(HMDCloudPhotosSettingObserver *)v6 isCloudPhotosEnabled])
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
    {
      ...
      v22 = 2112;
      v23 = v15;
      _os_log_impl(&dword_2531F8000, v12, OS_LOG_TYPE_INFO, "%{public}@Updating cloudPhotosEnabled from %@ to %@", &v18, 0x20u);
    }
...
uint64_t __44__HMDCloudPhotosSettingObserver_logCategory__block_invoke()
{
  ...
  v2 = logCategory__hmf_once_v3_100558;
  logCategory__hmf_once_v3_100558 = v1;
