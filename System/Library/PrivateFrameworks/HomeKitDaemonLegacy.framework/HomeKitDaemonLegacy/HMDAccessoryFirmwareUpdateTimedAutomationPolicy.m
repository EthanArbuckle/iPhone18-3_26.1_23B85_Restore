...
- (void)_startReevaluateTimer:(double)a3
{
  ...
  if (a3 < 0.0)
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_DEBUG))
    {
      ...
      v15 = 138543362;
      v16 = v8;
      _os_log_impl(&dword_2531F8000, v7, OS_LOG_TYPE_DEBUG, "%{public}@Invalid time interval", &v15, 0xCu);
    }
        ...
        if ([v10 isAssociatedWithAccessory:v3])
        {
          ...
          if (v13)
          {
            ...
            if (os_log_type_enabled(v19, OS_LOG_TYPE_DEBUG))
            {
              ...
              *buf = 138543362;
              v72 = v21;
              _os_log_impl(&dword_2531F8000, v19, OS_LOG_TYPE_DEBUG, "%{public}@Evaluating timer trigger...", buf, 0xCu);
            ...
            if (v24)
            {
              ...
              if (os_log_type_enabled(v49, OS_LOG_TYPE_INFO))
              {
                ...
                *buf = 138543618;
                ...
                v73 = 2112;
                v74 = v52;
                _os_log_impl(&dword_2531F8000, v49, OS_LOG_TYPE_INFO, "%{public}@Update could be interrupted by trigger:%@", buf, 0x16u);
          ...
          else
          {
            ...
            if (v16)
            {
              if (v27)
              {
                ...
                *buf = 138543362;
                v72 = v28;
                _os_log_impl(&dword_2531F8000, v26, OS_LOG_TYPE_DEBUG, "%{public}@Evaluating event trigger...", buf, 0xCu);
              }
                    ...
                    if (v36 == 1)
                    {
                      ...
                      if (os_log_type_enabled(v42, OS_LOG_TYPE_INFO))
                      {
                        ...
                        *buf = 138543618;
                        ...
                        v73 = 2112;
                        v74 = v44;
                        _os_log_impl(&dword_2531F8000, v42, OS_LOG_TYPE_INFO, "%{public}@Update could be interrupted by trigger:%@", buf, 0x16u);
                      }
            ...
            else
            {
              if (v27)
              {
                ...
                *buf = 138543362;
                v72 = v37;
                _os_log_impl(&dword_2531F8000, v26, OS_LOG_TYPE_DEBUG, "%{public}@Unknown trigger type", buf, 0xCu);
...
- (BOOL)evaluate
{
  ...
  if (!v10)
  {
    ...
    if (os_log_type_enabled(v21, OS_LOG_TYPE_INFO))
    {
      ...
      v24 = 138543362;
      v25 = v22;
      _os_log_impl(&dword_2531F8000, v21, OS_LOG_TYPE_INFO, "%{public}@Invalid max update apply end time, policy status evaluated to NO", &v24, 0xCu);
    }
  ...
  if (v12)
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
    {
      ...
      v24 = 138543362;
      v25 = v17;
      _os_log_impl(&dword_2531F8000, v16, OS_LOG_TYPE_INFO, "%{public}@Policy status evaluated to NO", &v24, 0xCu);
    }
...
LABEL_2:
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v24 = 138543362;
    v25 = v8;
    _os_log_impl(&dword_2531F8000, v7, OS_LOG_TYPE_INFO, "%{public}@Policy status evaluated to YES", &v24, 0xCu);
  }
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t0_133163 != -1)
  {
    dispatch_once(&logCategory__hmf_once_t0_133163, &__block_literal_global_133164);
  }

  v3 = logCategory__hmf_once_v1_133165;
...
uint64_t __62__HMDAccessoryFirmwareUpdateTimedAutomationPolicy_logCategory__block_invoke()
{
  ...
  v2 = logCategory__hmf_once_v1_133165;
  logCategory__hmf_once_v1_133165 = v1;
