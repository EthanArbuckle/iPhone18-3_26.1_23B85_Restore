...
LABEL_7:
  ...
  if (os_log_type_enabled(v21, OS_LOG_TYPE_DEBUG))
  {
    ...
    *buf = 138543618;
    ...
    v26 = 2112;
    v27 = v18;
    _os_log_impl(&dword_2531F8000, v21, OS_LOG_TYPE_DEBUG, "%{public}@Dropping incoming message from unsupported device: %@", buf, 0x16u);
  }
...
LABEL_15:
  ...
  if (!v9)
  {
    ...
    if (os_log_type_enabled(v18, OS_LOG_TYPE_DEBUG))
    {
      ...
      v25 = 2112;
      v26 = device2;
      _os_log_impl(&dword_2531F8000, v18, OS_LOG_TYPE_DEBUG, "%{public}@Cannot send message, the device, %@, is not currently connected", &v23, 0x16u);
    }
  ...
  if ((v12 & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_DEBUG))
    {
      ...
      v25 = 2112;
      v26 = device4;
      _os_log_impl(&dword_2531F8000, v14, OS_LOG_TYPE_DEBUG, "%{public}@Cannot send message, the device, %@, is not supported", &v23, 0x16u);
    }
  ...
  if (v8)
  {
    ...
    if (v10)
    {
      ...
      if (os_log_type_enabled(v12, OS_LOG_TYPE_DEBUG))
      {
        ...
        v24 = 2112;
        v25 = v10;
        _os_log_impl(&dword_2531F8000, v12, OS_LOG_TYPE_DEBUG, "%{public}@Replacing device destination, %@, with device: %@", &v20, 0x20u);
      }
...
uint64_t __42__HMDIDSProxyMessageTransport_logCategory__block_invoke()
{
  ...
  v2 = logCategory__hmf_once_v3_178666;
  logCategory__hmf_once_v3_178666 = v1;
