...
- (BOOL)_shouldFallbackLocallyWithError:(id)a3 accessory:(id)a4
{
  ...
  else
  {
    if (![v5 isHAPError])
    {
      ...
      {
        v10 = [v5 domain];
        v11 = [v10 isEqual:*MEMORY[0x277CD5120]];
...
LABEL_34:
  ...
  else
  {
    ...
    if (v7 == 4)
    {
      if ([v6 hasBTLELink] && ((objc_msgSend(v6, "isReachable") & 1) != 0 || (objc_msgSend(v6, "isBLELinkConnected") & 1) != 0))
      {
        goto LABEL_35;
      }
    }
