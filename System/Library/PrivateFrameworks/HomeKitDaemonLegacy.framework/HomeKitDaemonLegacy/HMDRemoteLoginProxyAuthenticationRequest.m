...
- (HMDRemoteLoginProxyAuthenticationRequest)initWithCoder:(id)a3
{
  ...
  if (v5)
  {
    ...
    v8 = [v4 decodeObjectOfClass:objc_opt_class() forKey:@"passwordToken"];
    ...
    v12 = [v4 decodeObjectOfClass:objc_opt_class() forKey:@"rawPassword"];
...
- (void)encodeWithCoder:(id)a3
{
  ...
  v6 = [(HMDRemoteLoginProxyAuthenticationRequest *)self passwordToken];
  ...
  v8 = [(HMDRemoteLoginProxyAuthenticationRequest *)self rawPassword];
...
- (NSString)description
{
  ...
  v6 = [(HMDRemoteLoginProxyAuthenticationRequest *)self rawPassword];
  [v6 length];
  v7 = HMFBooleanToString();
  v8 = [(HMDRemoteLoginProxyAuthenticationRequest *)self passwordToken];
  v9 = [(HMDRemoteLoginProxyAuthenticationRequest *)self altDSID];
  v10 = [v3 stringWithFormat:@"HMDRemoteLoginProxyAuthenticationRequest: %@, Username: %@, Password Present: %@, Token: %@, altDSID: %@", v4, v5, v7, v8, v9];
...
- (NSDictionary)messagePayload
{
  ...
  v3 = encodeRootObject();
  v4 = [(HMDRemoteLoginProxyAuthenticationRequest *)self messageName];
  v8 = v4;
  v9[0] = v3;
...
+ (id)objWithMessage:(id)a3
{
  ...
  v6 = [v5 hmf_dataForKey:@"kHMDRemoteLoginProxyAuthenticationRequest"];
...
+ (id)objWithDict:(id)a3
{
  ...
  v4 = a3;
  v5 = [v4 hmf_dataForKey:@"kHMDRemoteLoginProxyAuthenticationRequest"];
  v14 = 0;
