...
void __22__HMDWACScanner_start__block_invoke(uint64_t a1)
{
  ...
  if (!v1[2])
  {
    ...
    if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
    {
      ...
      *(&buf + 4) = v5;
      _os_log_impl(&dword_2531F8000, v4, OS_LOG_TYPE_INFO, "%{public}@Initializing CUWiFiScanner...", &buf, 0xCu);
    }
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t7_92819 != -1)
  {
    dispatch_once(&logCategory__hmf_once_t7_92819, &__block_literal_global_92820);
  }

  v3 = logCategory__hmf_once_v8_92821;
