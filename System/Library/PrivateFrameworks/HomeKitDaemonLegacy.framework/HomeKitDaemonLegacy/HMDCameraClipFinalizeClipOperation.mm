...
id __42__HMDCameraClipFinalizeClipOperation_main__block_invoke(uint64_t a1, void *a2)
{
  ...
  if (v10 <= 0.0)
  {
    if (v14)
    {
      ...
      v29 = 2048;
      v30 = v19;
      _os_log_impl(&dword_2531F8000, v13, OS_LOG_TYPE_INFO, "%{public}@Finalized clip has duration %fs, deleting", &v27, 0x16u);
    }
  ...
  else
  {
    if (v14)
    {
      ...
      v27 = 138543362;
      v28 = v15;
      _os_log_impl(&dword_2531F8000, v13, OS_LOG_TYPE_INFO, "%{public}@Marking clip complete", &v27, 0xCu);
    }
...
void __42__HMDCameraClipFinalizeClipOperation_main__block_invoke_3(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    v9 = 138543362;
    v10 = v7;
    _os_log_impl(&dword_2531F8000, v6, OS_LOG_TYPE_INFO, "%{public}@Successfully finalized clip", &v9, 0xCu);
  }
...
void __42__HMDCameraClipFinalizeClipOperation_main__block_invoke_5(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
  {
    ...
    v11 = 2112;
    v12 = v3;
    _os_log_impl(&dword_2531F8000, v6, OS_LOG_TYPE_ERROR, "%{public}@Failed to update clip model: %@", &v9, 0x16u);
  }
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t4_54798 != -1)
  {
    dispatch_once(&logCategory__hmf_once_t4_54798, &__block_literal_global_54799);
  }

  v3 = logCategory__hmf_once_v5_54800;
...
uint64_t __49__HMDCameraClipFinalizeClipOperation_logCategory__block_invoke()
{
  ...
  v2 = logCategory__hmf_once_v5_54800;
  logCategory__hmf_once_v5_54800 = v1;
