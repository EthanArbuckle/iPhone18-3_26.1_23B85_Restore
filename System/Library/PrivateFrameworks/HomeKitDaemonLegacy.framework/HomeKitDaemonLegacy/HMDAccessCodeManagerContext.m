...
- (NSArray)accessoriesSupportingAccessCodes
{
  ...
  v4 = [v3 na_filter:&__block_literal_global_2789];
...
{
  v2 = [MEMORY[0x277D0F8D0] sharedPreferences];
  v3 = [v2 preferenceForKey:@"HMDAccessCodeManagerAccessoryReadWriteRetryTimeInterval"];
  v4 = [v3 numberValue];
  v5 = [v4 integerValue];
...
{
  v2 = [MEMORY[0x277D0F8D0] sharedPreferences];
  v3 = [v2 preferenceForKey:@"HMDAccessCodeManagerAccessoryReadWriteRetries"];
  v4 = [v3 numberValue];
  v5 = [v4 integerValue];
