...
void __56__HMDAccessoryFirmwareUpdateSession_rescindStagedAsset___block_invoke(uint64_t a1)
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      v15 = 2112;
      v16 = v3;
      _os_log_impl(&dword_2531F8000, v9, OS_LOG_TYPE_ERROR, "%{public}@Failed to rescind staged firmware for UARP accessory %@", &v13, 0x16u);
    }
...
void __56__HMDAccessoryFirmwareUpdateSession_rescindStagedAsset___block_invoke_174(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
  {
    ...
    v11 = 2112;
    v12 = v3;
    _os_log_impl(&dword_2531F8000, v6, OS_LOG_TYPE_ERROR, "%{public}@Error opening socket for UARP communication: %@", &v9, 0x16u);
  }
...
uint64_t __51__HMDAccessoryFirmwareUpdateSession_logDebugStates__block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    v18 = 2112;
    v19 = v9;
    _os_log_impl(&dword_2531F8000, v4, OS_LOG_TYPE_INFO, "%{public}@Accessory: %@, asset: %@, auto update: %@", &v12, 0x2Au);
  }
...
- (void)socket:(id)a3 didFailWithError:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
  {
    ...
    v23 = 2112;
    v24 = v7;
    _os_log_impl(&dword_2531F8000, v10, OS_LOG_TYPE_ERROR, "%{public}@HDS socket %@ closed: %@ failed for accessory %@ with error %@", &v15, 0x34u);
  }
  ...
  if ((_os_feature_enabled_impl() & 1) == 0 && !CFPreferencesGetAppBooleanValue(@"MatterOTA", @"/Library/Managed Preferences/mobile/com.apple.homed.plist", 0) || (-[HMDAccessoryFirmwareUpdateSession hapAccessory](self, "hapAccessory"), v6 = objc_claimAutoreleasedReturnValue(), v7 = [v6 supportsCHIP], v6, !v7))
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
    {
      ...
      *&v43[14] = v17;
      ...
      v46 = 2112;
      v47 = v20;
      _os_log_impl(&dword_2531F8000, v14, OS_LOG_TYPE_INFO, "%{public}@HDS socket closed in state %@ for %@accessory %@", v43, 0x2Au);
    }
    ...
    _os_log_impl(&dword_2531F8000, v33, v34, v32, v43, 0xCu);
...
LABEL_21:
    ...
    else if ([(HMDAccessoryFirmwareUpdateSession *)v28 internalState]== 5 && [(HMDAccessoryFirmwareUpdateSession *)v28 isFirmwareVersionUpToDate])
    {
      ...
      if (os_log_type_enabled(v41, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *v43 = 138543362;
        *&v43[4] = v42;
        _os_log_impl(&dword_2531F8000, v41, OS_LOG_TYPE_DEFAULT, "%{public}@Registration complete", v43, 0xCu);
      }
...
LABEL_24:
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
  {
    ...
    *&v43[14] = "[HMDAccessoryFirmwareUpdateSession socketDidClose:]";
    _os_log_impl(&dword_2531F8000, v10, OS_LOG_TYPE_ERROR, "%{public}@%s: Matter accessory does not use this function", v43, 0x16u);
  }
...
void __58__HMDAccessoryFirmwareUpdateSession__verifyUpdateComplete__block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    v28 = 138543362;
    v29 = v5;
    _os_log_impl(&dword_2531F8000, v4, OS_LOG_TYPE_INFO, "%{public}@Asking UARP for Apply Results", &v28, 0xCu);
  }
  ...
  if (!v8)
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_DEBUG))
    {
      ...
      v28 = 138543362;
      v29 = v12;
      _os_log_impl(&dword_2531F8000, v11, OS_LOG_TYPE_DEBUG, "%{public}@Start the timer for querying result", &v28, 0xCu);
    }
...
void __58__HMDAccessoryFirmwareUpdateSession__verifyUpdateComplete__block_invoke_133(uint64_t a1, void *a2)
{
  ...
  if (v3)
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
    {
      ...
      v11 = 2112;
      v12 = v3;
      _os_log_impl(&dword_2531F8000, v6, OS_LOG_TYPE_ERROR, "%{public}@Error opening HDS socket: %@", &v9, 0x16u);
    }
        ...
        else
        {
          ...
          else
          {
            ...
            if (os_log_type_enabled(v18, OS_LOG_TYPE_ERROR))
            {
              ...
              v21 = 138543362;
              v22 = v19;
              _os_log_impl(&dword_2531F8000, v18, OS_LOG_TYPE_ERROR, "%{public}@Unknown timer", &v21, 0xCu);
            }
...
void __78__HMDAccessoryFirmwareUpdateSession_stagedFirmwareRescindComplete_withStatus___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_DEFAULT))
  {
    ...
    v15 = 2112;
    v16 = v8;
    _os_log_impl(&dword_2531F8000, v5, OS_LOG_TYPE_DEFAULT, "%{public}@Staged firmware rescinded with status: %@ for accessory %@", &v11, 0x20u);
  }
...
void __85__HMDAccessoryFirmwareUpdateSession_firmwareUpdateResult_vendorSpecificStatus_error___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_DEFAULT))
  {
    ...
    v17 = 2112;
    v18 = v8;
    _os_log_impl(&dword_2531F8000, v5, OS_LOG_TYPE_DEFAULT, "%{public}@Results from apply accessory %@ status %@", &v13, 0x20u);
  }
  ...
  if (v4 > 2)
  {
    if ((v4 - 4) < 2)
    {
      ...
      if (os_log_type_enabled(v28, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *buf = 138543362;
        v51 = v29;
        _os_log_impl(&dword_2531F8000, v28, OS_LOG_TYPE_DEFAULT, "%{public}@Update canceled", buf, 0xCu);
      }
...
LABEL_37:
  ...
  if (!v4)
  {
    ...
    if (os_log_type_enabled(v34, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *buf = 138543362;
      v51 = v35;
      _os_log_impl(&dword_2531F8000, v34, OS_LOG_TYPE_DEFAULT, "%{public}@Asset staging complete", buf, 0xCu);
    }
...
LABEL_34:
      _os_log_impl(&dword_2531F8000, v42, OS_LOG_TYPE_DEFAULT, v44, buf, 0xCu);
...
- (void)firmwareStagingProgress:(id)a3 assetID:(id)a4 bytesSent:(unint64_t)a5 bytesTotal:(unint64_t)a6
{
  ...
  if (os_log_type_enabled(v14, OS_LOG_TYPE_DEBUG))
  {
    ...
    v25 = 2112;
    v26 = v17;
    _os_log_impl(&dword_2531F8000, v14, OS_LOG_TYPE_DEBUG, "%{public}@firmwareStagingProgress called for accessory %@ %@/%@ bytes sent", &v19, 0x2Au);
  }
...
LABEL_76:
        ...
        if (os_log_type_enabled(v121, OS_LOG_TYPE_DEFAULT))
        {
          ...
          *buf = 138543362;
          v135 = v122;
          _os_log_impl(&dword_2531F8000, v121, OS_LOG_TYPE_DEFAULT, "%{public}@Firmware downloading", buf, 0xCu);
...
- (void)_updateAvailableSoftwareUpdateDocumentation
{
  ...
  if (v3)
  {
    ...
    if (!v5)
    {
      ...
      [v6 updateSoftwareUpdate:v5 completionHandler:&__block_literal_global_111_125732];
    }
  }
...
- (void)_updateAvailableSoftwareUpdateState:(int64_t)a3
{
  ...
  if (!v7)
  {
    ...
    if (os_log_type_enabled(v26, OS_LOG_TYPE_ERROR))
    {
      ...
      v44 = 2112;
      v45 = v36;
      _os_log_impl(&dword_2531F8000, v26, OS_LOG_TYPE_ERROR, "%{public}@Not updating state from %@ to %@ because update firmware version is not set by UARP", &v40, 0x20u);
    }
  ...
  if (a3 == 2 && [(HMDAccessoryFirmwareUpdateSession *)self isFirmwareVersionUpToDate])
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_DEBUG))
    {
      ...
      v42 = 2112;
      v43 = v13;
      _os_log_impl(&dword_2531F8000, v10, OS_LOG_TYPE_DEBUG, "%{public}@Not updating state from %@ to downloaded because firmware version is up to date", &v40, 0x16u);
    }
...
LABEL_24:
  ...
  if (v14 && ([v14 version], v16 = objc_claimAutoreleasedReturnValue(), v17 = objc_msgSend(v7, "isEqualToVersion:", v16), v16, v17))
  {
    ...
    if (os_log_type_enabled(v20, OS_LOG_TYPE_INFO))
    {
      ...
      v44 = 2112;
      v45 = v38;
      _os_log_impl(&dword_2531F8000, v20, OS_LOG_TYPE_INFO, "%{public}@Updating available software update state from %@ to %@", &v40, 0x20u);
    }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v32, OS_LOG_TYPE_INFO))
    {
      ...
      v42 = 2112;
      v43 = v34;
      _os_log_impl(&dword_2531F8000, v32, OS_LOG_TYPE_INFO, "%{public}@New available software update with state %@", &v40, 0x16u);
    }
    ...
    [v6 updateSoftwareUpdate:v35 completionHandler:&__block_literal_global_109_125738];
  }
...
void __72__HMDAccessoryFirmwareUpdateSession_updateAvailableSoftwareUpdateState___block_invoke(uint64_t a1)
{
  ...
  if (v2)
  {
    ...
    if (os_log_type_enabled(v5, OS_LOG_TYPE_DEFAULT))
    {
      ...
      v19 = 2112;
      v20 = v13;
      _os_log_impl(&dword_2531F8000, v5, OS_LOG_TYPE_DEFAULT, "%{public}@Not updating available software update state from %@ to %@ because apply timer is active", &v15, 0x20u);
    }
...
- (void)_resetAvailableSoftwareUpdate
{
  ...
  if (v4)
  {
    [v5 updateSoftwareUpdate:0 completionHandler:&__block_literal_global_107_125741];
  }
}
...
LABEL_38:
      if ([v4 isEqualToVersion:v8])
      {
        ...
        if (os_log_type_enabled(v30, OS_LOG_TYPE_INFO))
        {
          ...
          *buf = 138543362;
          v49 = v31;
          _os_log_impl(&dword_2531F8000, v30, OS_LOG_TYPE_INFO, "%{public}@Session available firmware version is the same as the current accessory version. Software Update has been installed.", buf, 0xCu);
        }
...
LABEL_22:
      ...
      if ([v4 isEqualToVersion:v9])
      {
        ...
        if (os_log_type_enabled(v36, OS_LOG_TYPE_INFO))
        {
          ...
          *buf = 138543362;
          v49 = v37;
          _os_log_impl(&dword_2531F8000, v36, OS_LOG_TYPE_INFO, "%{public}@Session available firmware version is staged on accessory. Software Update has been downloaded.", buf, 0xCu);
        }
    ...
    _os_log_impl(&dword_2531F8000, v12, OS_LOG_TYPE_INFO, v39, buf, 0xCu);
...
- (void)incrementMatterFirmwareUpdateRetryCount
{
  ...
  if ([(HMDAccessoryFirmwareUpdateSession *)self isMatterFirmwareUpdateRetryAllowed])
  {
    ...
    if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
    {
      ...
      v12 = 2048;
      v13 = 5;
      _os_log_impl(&dword_2531F8000, v5, OS_LOG_TYPE_INFO, "%{public}@Matter firmware update retry attempt %lu of %lu", &v8, 0x20u);
    }
...
void __72__HMDAccessoryFirmwareUpdateSession_updateAccessoryVendorIDAndProductID__block_invoke(uint64_t a1)
{
  ...
  if ((v8 & 1) == 0)
  {
    if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
    {
      ...
      v27 = 138543362;
      v28 = v24;
      _os_log_impl(&dword_2531F8000, v12, OS_LOG_TYPE_ERROR, "%{public}@Failed to update UARP accessory vendor ID property", &v27, 0xCu);
    }
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
  {
    ...
    v29 = 2112;
    v30 = v14;
    _os_log_impl(&dword_2531F8000, v12, OS_LOG_TYPE_INFO, "%{public}@Accessory vendor ID updated to %@", &v27, 0x16u);
  }
  ...
  if ((v18 & 1) == 0)
  {
    if (os_log_type_enabled(v20, OS_LOG_TYPE_ERROR))
    {
      ...
      v27 = 138543362;
      v28 = v25;
      _os_log_impl(&dword_2531F8000, v21, OS_LOG_TYPE_ERROR, "%{public}@Failed to update UARP accessory product ID property", &v27, 0xCu);
    }
...
LABEL_14:
  ...
  if (os_log_type_enabled(v20, OS_LOG_TYPE_INFO))
  {
    ...
    v29 = 2112;
    v30 = v23;
    _os_log_impl(&dword_2531F8000, v21, OS_LOG_TYPE_INFO, "%{public}@Accessory product ID updated to %@", &v27, 0x16u);
  }
...
void __82__HMDAccessoryFirmwareUpdateSession_handleFirmwareUpdateStateChangedNotification___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v21 = 2112;
    v22 = v9;
    _os_log_impl(&dword_2531F8000, v7, OS_LOG_TYPE_INFO, "%{public}@Accessory state changed to %@", &v19, 0x16u);
  }
  ...
  if ([v6 internalState] == 2 && (!objc_msgSend(v4, "longValue") || objc_msgSend(v4, "longValue") == 2))
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_DEFAULT))
    {
      ...
      v19 = 138543362;
      v20 = v13;
      _os_log_impl(&dword_2531F8000, v12, OS_LOG_TYPE_DEFAULT, "%{public}@Restarting staging", &v19, 0xCu);
    }
  ...
  else if ([v6 internalState] == 3 && objc_msgSend(v4, "longValue") == 4)
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_DEFAULT))
    {
      ...
      v19 = 138543362;
      v20 = v17;
      _os_log_impl(&dword_2531F8000, v16, OS_LOG_TYPE_DEFAULT, "%{public}@Detected remote apply in progress", &v19, 0xCu);
    }
...
void __73__HMDAccessoryFirmwareUpdateSession_updateAccessoryStagedFirmwareVersion__block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v42 = 2112;
    v43 = v4;
    _os_log_impl(&dword_2531F8000, v7, OS_LOG_TYPE_INFO, "%{public}@Staged firmware version changed from %@ to %@", &v38, 0x20u);
  }
  ...
  if (!v13)
  {
    ...
    if (v26)
    {
      if (os_log_type_enabled(v29, OS_LOG_TYPE_INFO))
      {
        ...
        v38 = 138543362;
        v39 = v31;
        _os_log_impl(&dword_2531F8000, v30, OS_LOG_TYPE_INFO, "%{public}@Updated UARP staged firmware version property", &v38, 0xCu);
      }
...
LABEL_19:
      ...
      if (os_log_type_enabled(v30, OS_LOG_TYPE_ERROR))
      {
        ...
        v42 = 2112;
        v43 = v37;
        _os_log_impl(&dword_2531F8000, v30, OS_LOG_TYPE_ERROR, "%{public}@checkForUpdate failed for accessory %@ %@", &v38, 0x20u);
    ...
    else if (os_log_type_enabled(v29, OS_LOG_TYPE_ERROR))
    {
      ...
      v38 = 138543362;
      v39 = v32;
      _os_log_impl(&dword_2531F8000, v30, OS_LOG_TYPE_ERROR, "%{public}@Failed to update UARP staged firmware version property", &v38, 0xCu);
LABEL_17:
    }
  ...
  if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
  {
    ...
    v40 = 2112;
    v41 = v18;
    _os_log_impl(&dword_2531F8000, v16, OS_LOG_TYPE_INFO, "%{public}@Staged firmware version newer than available version (%@)", &v38, 0x16u);
  }
  ...
  if (([v11 checkForUpdateForAccessory:v2] & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v21, OS_LOG_TYPE_ERROR))
    {
      ...
      v38 = 138543362;
      v39 = v22;
      _os_log_impl(&dword_2531F8000, v21, OS_LOG_TYPE_ERROR, "%{public}@Error request UARP to check for available updates", &v38, 0xCu);
    }
...
LABEL_19:
    _os_log_impl(&dword_2531F8000, v28, OS_LOG_TYPE_INFO, v30, &v33, 0xCu);
...
LABEL_20:
  ...
  if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
  {
    ...
    v37 = 2112;
    v38 = v13;
    _os_log_impl(&dword_2531F8000, v16, OS_LOG_TYPE_INFO, "%{public}@Version mismatch detected. Comparing Matter firmware = %@ and UARP version = %@", &v33, 0x20u);
  }
  ...
  if (os_log_type_enabled(v20, OS_LOG_TYPE_INFO))
  {
    ...
    v39 = 2048;
    v40 = v23;
    _os_log_impl(&dword_2531F8000, v20, OS_LOG_TYPE_INFO, "%{public}@Matter firmware version = %llu is larger than UARP version = %@ with valid asset version number = %llu", &v33, 0x2Au);
  }
...
- (void)handleAccessoryFirmwareVersionChangedNotification:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v10 = 138543362;
    v11 = v8;
    _os_log_impl(&dword_2531F8000, v7, OS_LOG_TYPE_INFO, "%{public}@Received accessory firmware updated notification", &v10, 0xCu);
  }
...
- (void)handleAccessoryVIDPIDChangedNotification:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v10 = 138543362;
    v11 = v8;
    _os_log_impl(&dword_2531F8000, v7, OS_LOG_TYPE_INFO, "%{public}@Received matter VID PID updated notification", &v10, 0xCu);
  }
...
- (void)handleAccessoryFirmwareVersionNumberChangedNotification:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v10 = 138543362;
    v11 = v8;
    _os_log_impl(&dword_2531F8000, v7, OS_LOG_TYPE_INFO, "%{public}@Received accessory firmware version number updated notification", &v10, 0xCu);
  }
...
- (void)_updateSoftwareUpdateStateForMatterAccessoryWithState:(unint64_t)a3
{
  ...
  if (a3 == 1)
  {
    ...
    if ([v7 isEqualToVersion:v6])
    {
      ...
      if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
      {
        ...
        v34 = 2112;
        v35 = v5;
        _os_log_impl(&dword_2531F8000, v10, OS_LOG_TYPE_INFO, "%{public}@Update is already installed for acc:%@ uarpAcc:%@ softwareUpdate:%@", &v28, 0x2Au);
      }
    ...
    if (os_log_type_enabled(v24, OS_LOG_TYPE_INFO))
    {
      ...
      v30 = 2112;
      v31 = v26;
      _os_log_impl(&dword_2531F8000, v24, OS_LOG_TYPE_INFO, "%{public}@Marking Update as %@, matter accessory will trigger staging by itself.", &v28, 0x16u);
    }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR))
    {
      ...
      v31 = v20;
      v21 = v20;
      _os_log_impl(&dword_2531F8000, v17, OS_LOG_TYPE_ERROR, "%{public}@Unsupported state %@ for Matter Accessory, ignoring.", &v28, 0x16u);
    }
...
- (void)_cancelApplyTimer
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    v13 = 138543362;
    v14 = v9;
    _os_log_impl(&dword_2531F8000, v8, OS_LOG_TYPE_INFO, "%{public}@Apply timer cancelled", &v13, 0xCu);
  }
...
- (void)_endSession
{
  ...
  if (((_os_feature_enabled_impl() & 1) != 0 || CFPreferencesGetAppBooleanValue(@"MatterOTA", @"/Library/Managed Preferences/mobile/com.apple.homed.plist", 0)) && [v4 supportsCHIP])
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
      {
        ...
        v24 = 138543362;
        v25 = v11;
        _os_log_impl(&dword_2531F8000, v10, OS_LOG_TYPE_INFO, "%{public}@Couldn't get a strong ref to the software update provider delegate", &v24, 0xCu);
      }
  ...
  if (os_log_type_enabled(v14, OS_LOG_TYPE_DEFAULT))
  {
    ...
    v26 = 2112;
    v27 = v16;
    _os_log_impl(&dword_2531F8000, v14, OS_LOG_TYPE_DEFAULT, "%{public}@Session ended (already ended: %@)", &v24, 0x16u);
  }
...
LABEL_21:
      _os_log_impl(&dword_2531F8000, v20, v21, v19, &v24, 0xCu);
    }
...
LABEL_22:
  ...
  else
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
    {
      ...
      v26 = 2112;
      v27 = v14;
      _os_log_impl(&dword_2531F8000, v11, OS_LOG_TYPE_INFO, "%{public}@Scheduling next operation, state %@", &v24, 0x16u);
    }
...
- (void)_applyFailed
{
  ...
  if (((_os_feature_enabled_impl() & 1) != 0 || CFPreferencesGetAppBooleanValue(@"MatterOTA", @"/Library/Managed Preferences/mobile/com.apple.homed.plist", 0)) && (-[HMDAccessoryFirmwareUpdateSession hapAccessory](self, "hapAccessory"), v4 = objc_claimAutoreleasedReturnValue(), v5 = [v4 supportsCHIP], v4, v5))
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
    {
      ...
      _os_log_impl(&dword_2531F8000, v8, OS_LOG_TYPE_INFO, "%{public}@%s: Matter Accessory responsible for managing firmware application. No action taken.", &v15, 0x16u);
    }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
    {
      ...
      v15 = 138543362;
      v16 = v13;
      _os_log_impl(&dword_2531F8000, v12, OS_LOG_TYPE_ERROR, "%{public}@Apply did not complete or failed in the accessory", &v15, 0xCu);
    }
...
- (void)_stagingFailed
{
  ...
  if (((_os_feature_enabled_impl() & 1) != 0 || CFPreferencesGetAppBooleanValue(@"MatterOTA", @"/Library/Managed Preferences/mobile/com.apple.homed.plist", 0)) && [v4 supportsCHIP])
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
    {
      ...
      _os_log_impl(&dword_2531F8000, v7, OS_LOG_TYPE_INFO, "%{public}@%s: Matter Accessory responsible for managing firmware staging. No action taken.", &v21, 0x16u);
    }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
    {
      ...
      v21 = 138543362;
      v22 = v12;
      _os_log_impl(&dword_2531F8000, v11, OS_LOG_TYPE_ERROR, "%{public}@Staging failed", &v21, 0xCu);
    }
    ...
    else
    {
      ...
      if (os_log_type_enabled(v18, OS_LOG_TYPE_ERROR))
      {
        ...
        v21 = 138543362;
        v22 = v19;
        _os_log_impl(&dword_2531F8000, v18, OS_LOG_TYPE_ERROR, "%{public}@No more staging retries for this accessory's firmware update session", &v21, 0xCu);
      }
...
- (double)_expectedApplyDuration
{
  ...
  if (!v6)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_DEBUG))
    {
      ...
      v13 = 138543362;
      v14 = v10;
      _os_log_impl(&dword_2531F8000, v9, OS_LOG_TYPE_DEBUG, "%{public}@Expected duration is not set - default to minimum apply duration", &v13, 0xCu);
    }
...
- (void)startApplyDurationTimers
{
  ...
  if (os_log_type_enabled(v17, OS_LOG_TYPE_DEFAULT))
  {
    ...
    v25 = 2112;
    v26 = v19;
    _os_log_impl(&dword_2531F8000, v17, OS_LOG_TYPE_DEFAULT, "%{public}@Waiting up to %@ seconds for accessory to apply update", &v23, 0x16u);
  }
...
- (void)stagingComplete
{
  ...
  if (((_os_feature_enabled_impl() & 1) != 0 || CFPreferencesGetAppBooleanValue(@"MatterOTA", @"/Library/Managed Preferences/mobile/com.apple.homed.plist", 0)) && [v4 supportsCHIP])
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
    {
      ...
      _os_log_impl(&dword_2531F8000, v7, OS_LOG_TYPE_INFO, "%{public}@%s: Matter Accessory responsible for managing firmware staging. No action taken.", &v15, 0x16u);
    }
  ...
  else
  {
    ...
    if (([v4 isAutomaticThirdPartyAccessorySoftwareUpdateEnabled] & 1) != 0 || -[HMDAccessoryFirmwareUpdateSession isUserInitiatedInstall](self, "isUserInitiatedInstall"))
    {
      ...
      if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
      {
        ...
        v15 = 138543362;
        v16 = v12;
        _os_log_impl(&dword_2531F8000, v11, OS_LOG_TYPE_INFO, "%{public}@Staging complete", &v15, 0xCu);
      }
...
void __50__HMDAccessoryFirmwareUpdateSession_stageFirmware__block_invoke(uint64_t a1)
{
  ...
  if (v6)
  {
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      v15 = 138543362;
      v16 = v11;
      _os_log_impl(&dword_2531F8000, v10, OS_LOG_TYPE_INFO, "%{public}@UARP initiated asset staging", &v15, 0xCu);
    }
  ...
  else
  {
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      v15 = 138543362;
      v16 = v13;
      _os_log_impl(&dword_2531F8000, v10, OS_LOG_TYPE_ERROR, "%{public}@Failed to initiate asset staging in UARP controller", &v15, 0xCu);
    }
  ...
  if (![v6 isAtLeastVersion:v7] || !objc_msgSend(v6, "isGreaterThanVersion:", v3))
  {
    if (![v7 isGreaterThanVersion:v6])
    {
      ...
      if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
      {
        ...
        v18 = 138543362;
        v19 = v15;
        _os_log_impl(&dword_2531F8000, v14, OS_LOG_TYPE_ERROR, "%{public}@Unhandled version combination in nextStateToSchedule", &v18, 0xCu);
      }
...
- (BOOL)isCurrentUpdateLatest
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_ERROR))
    {
      ...
      v15 = 138543362;
      v16 = v9;
      _os_log_impl(&dword_2531F8000, v8, OS_LOG_TYPE_ERROR, "%{public}@No available version from UARP", &v15, 0xCu);
    }
...
void __70__HMDAccessoryFirmwareUpdateSession__evaluateHDSRetryForApplyFirmware__block_invoke(uint64_t a1)
{
  ...
  if ([*(a1 + 32) sessionEnded])
  {
    ...
    if (os_log_type_enabled(v4, OS_LOG_TYPE_DEBUG))
    {
      ...
      v9 = 138543362;
      v10 = v5;
      _os_log_impl(&dword_2531F8000, v4, OS_LOG_TYPE_DEBUG, "%{public}@Session has been ended, stop performing retries", &v9, 0xCu);
    }
...
- (void)_syncStateWithAccessoryOnResume
{
  ...
  if ([(HMDAccessoryFirmwareUpdateSession *)self internalState])
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_DEFAULT))
    {
      ...
      v14 = 2112;
      v15 = v9;
      _os_log_impl(&dword_2531F8000, v6, OS_LOG_TYPE_DEFAULT, "%{public}@Synced state is: %@", &v12, 0x16u);
    }
  ...
  if (WeakRetained)
  {
    ...
    if (v4)
    {
      ...
      if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
      {
        ...
        v30 = 138543362;
        v31 = v8;
        _os_log_impl(&dword_2531F8000, v7, OS_LOG_TYPE_INFO, "%{public}@Opened HDS connection to accessory", &v30, 0xCu);
      }
      ...
      if (v14)
      {
        if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
        {
          ...
          v30 = 138543362;
          v31 = v19;
          _os_log_impl(&dword_2531F8000, v18, OS_LOG_TYPE_INFO, "%{public}@Notified UARP accessory is reachable", &v30, 0xCu);
        }
      ...
      else
      {
        if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR))
        {
          ...
          v30 = 138543362;
          v31 = v26;
          _os_log_impl(&dword_2531F8000, v18, OS_LOG_TYPE_ERROR, "%{public}@Failed to notify about reachable accessory to UARP", &v30, 0xCu);
        }
    ...
    else
    {
      ...
      if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR))
      {
        ...
        v32 = 2112;
        v33 = v24;
        _os_log_impl(&dword_2531F8000, v22, OS_LOG_TYPE_ERROR, "%{public}@Couldn't open HDS connection to accessory error %@", &v30, 0x16u);
      }
...
- (void)_handleRegisterFailureRetryTimeout
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_DEBUG))
  {
    ...
    v9 = 138543362;
    v10 = v7;
    _os_log_impl(&dword_2531F8000, v6, OS_LOG_TYPE_DEBUG, "%{public}@Register failure retry timeout", &v9, 0xCu);
  }
...
- (void)_cancelRegisterFailureRetryTimer
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_DEBUG))
  {
    ...
    v10 = 138543362;
    v11 = v7;
    _os_log_impl(&dword_2531F8000, v6, OS_LOG_TYPE_DEBUG, "%{public}@Cancel register failure retry timer", &v10, 0xCu);
  }
...
- (void)_handleQueryFirmwareUpdateResultTimeout
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_DEBUG))
  {
    ...
    v9 = 138543362;
    v10 = v7;
    _os_log_impl(&dword_2531F8000, v6, OS_LOG_TYPE_DEBUG, "%{public}@Query firmware update result duration timeout", &v9, 0xCu);
  }
...
- (void)_cancelQueryFirmwareUpdateResultTimer
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_DEBUG))
  {
    ...
    v10 = 138543362;
    v11 = v7;
    _os_log_impl(&dword_2531F8000, v6, OS_LOG_TYPE_DEBUG, "%{public}@Cancel query firmware update result duration timer", &v10, 0xCu);
  }
...
- (void)_handleSocketTimeout
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_DEBUG))
  {
    ...
    v15 = 138543362;
    v16 = v7;
    _os_log_impl(&dword_2531F8000, v6, OS_LOG_TYPE_DEBUG, "%{public}@Socket idle timeout", &v15, 0xCu);
  }
  ...
  if ((_os_feature_enabled_impl() & 1) != 0 || CFPreferencesGetAppBooleanValue(@"MatterOTA", @"/Library/Managed Preferences/mobile/com.apple.homed.plist", 0))
  {
    ...
    if ([v8 supportsCHIP])
    {
      ...
      if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
      {
        ...
        _os_log_impl(&dword_2531F8000, v11, OS_LOG_TYPE_INFO, "%{public}@%s: called to control Matter Accessory. No sockets used with Matter Accessories. No action taken.", &v15, 0x16u);
      }
...
- (void)_cancelSocketIdleTimer
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_DEBUG))
  {
    ...
    v16 = 138543362;
    v17 = v7;
    _os_log_impl(&dword_2531F8000, v6, OS_LOG_TYPE_DEBUG, "%{public}@Cancel socket idle timer", &v16, 0xCu);
  }
  ...
  if (((_os_feature_enabled_impl() & 1) != 0 || CFPreferencesGetAppBooleanValue(@"MatterOTA", @"/Library/Managed Preferences/mobile/com.apple.homed.plist", 0)) && (-[HMDAccessoryFirmwareUpdateSession hapAccessory](v5, "hapAccessory"), v8 = objc_claimAutoreleasedReturnValue(), v9 = [v8 supportsCHIP], v8, v9))
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
    {
      ...
      _os_log_impl(&dword_2531F8000, v12, OS_LOG_TYPE_INFO, "%{public}@%s: called to control Matter Accessory. No sockets used with Matter Accessories. No action taken.", &v16, 0x16u);
    }
...
- (void)_resetSocketIdleTimer
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_DEBUG))
  {
    ...
    v16 = 138543362;
    v17 = v7;
    _os_log_impl(&dword_2531F8000, v6, OS_LOG_TYPE_DEBUG, "%{public}@Reset socket idle timer", &v16, 0xCu);
  }
...
- (void)_startSocketIdleTimer
{
  ...
  if (((_os_feature_enabled_impl() & 1) != 0 || CFPreferencesGetAppBooleanValue(@"MatterOTA", @"/Library/Managed Preferences/mobile/com.apple.homed.plist", 0)) && (-[HMDAccessoryFirmwareUpdateSession hapAccessory](self, "hapAccessory"), v4 = objc_claimAutoreleasedReturnValue(), v5 = [v4 supportsCHIP], v4, v5))
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
    {
      ...
      _os_log_impl(&dword_2531F8000, v8, OS_LOG_TYPE_INFO, "%{public}@%s: called to control Matter Accessory. No sockets used with Matter Accessories. No action taken.", &v26, 0x16u);
    }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_DEBUG))
    {
      ...
      v28 = 2112;
      v29 = v19;
      _os_log_impl(&dword_2531F8000, v17, OS_LOG_TYPE_DEBUG, "%{public}@Start socket idle timer for %@ seconds", &v26, 0x16u);
    }
      ...
      if (v5 > 2)
      {
        if (v5 == 3)
        {
          ...
          if (os_log_type_enabled(v23, OS_LOG_TYPE_DEBUG))
          {
            ...
            v31 = 138543362;
            v32 = v24;
            _os_log_impl(&dword_2531F8000, v23, OS_LOG_TYPE_DEBUG, "%{public}@Next action: applyFirmware", &v31, 0xCu);
          }
        ...
        if (v5 != 4)
        {
          if (v5 == 5)
          {
            ...
            if (os_log_type_enabled(v15, OS_LOG_TYPE_DEBUG))
            {
              ...
              v31 = 138543362;
              v32 = v16;
              _os_log_impl(&dword_2531F8000, v15, OS_LOG_TYPE_DEBUG, "%{public}@Next action: register", &v31, 0xCu);
            }
        ...
        if (os_log_type_enabled(v26, OS_LOG_TYPE_ERROR))
        {
          ...
          v33 = 2112;
          v34 = v29;
          _os_log_impl(&dword_2531F8000, v26, OS_LOG_TYPE_ERROR, "%{public}@Ignoring resume in state %@", &v31, 0x16u);
        }
      }
...
LABEL_40:
          ...
          _os_log_impl(&dword_2531F8000, v8, OS_LOG_TYPE_DEBUG, v10, &v31, 0xCu);
        ...
        if (os_log_type_enabled(v19, OS_LOG_TYPE_DEBUG))
        {
          ...
          v31 = 138543362;
          v32 = v20;
          _os_log_impl(&dword_2531F8000, v19, OS_LOG_TYPE_DEBUG, "%{public}@Next action: -", &v31, 0xCu);
        }
      }
...
void __53__HMDAccessoryFirmwareUpdateSession_resumeWithState___block_invoke_90(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    v7 = 138543362;
    v8 = v5;
    _os_log_impl(&dword_2531F8000, v4, OS_LOG_TYPE_INFO, "%{public}@rescheduling task after socket open failed", &v7, 0xCu);
  }
...
LABEL_24:
    ...
    if (os_log_type_enabled(v54, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *buf = 138543362;
      v66 = v48;
      _os_log_impl(&dword_2531F8000, v54, OS_LOG_TYPE_DEFAULT, "%{public}@Starting user-initiated update", buf, 0xCu);
    }
...
LABEL_45:
          _os_log_impl(&dword_2531F8000, v61, v62, v60, buf, 0xCu);
...
- (void)setInternalState:(unint64_t)a3
{
  ...
  if (internalState != a3)
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_DEFAULT))
    {
      ...
      v15 = 2112;
      v16 = v11;
      _os_log_impl(&dword_2531F8000, v8, OS_LOG_TYPE_DEFAULT, "%{public}@State changed to %@", &v13, 0x16u);
    }
