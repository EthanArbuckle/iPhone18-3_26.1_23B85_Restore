...
- (BOOL)componentsSupportsHomeLevelLocationServiceSetting
{
  ...
  v4 = [v3 na_map:&__block_literal_global_112_97815];
  v5 = [v4 count];
  if (v5 == [v3 count])
  {
...
- (void)encodeWithCoder:(id)a3
{
  ...
  [v16 encodeObject:v5 forKey:*MEMORY[0x277CD2458]];

  v6 = [(HMDMediaSystem *)self configuredName];
  [v16 encodeObject:v6 forKey:*MEMORY[0x277CD2440]];

  v7 = [(HMDMediaSystem *)self uuid];
  [v16 encodeObject:v7 forKey:*MEMORY[0x277CD2470]];

  v8 = [(HMDMediaSystem *)self components];
  [v16 encodeObject:v8 forKey:*MEMORY[0x277CD2438]];

  if ([v16 hmd_isForLocalStore])
  {
  ...
  if (![v16 hmd_isForXPCTransport] || objc_msgSend(v16, "hmd_isForXPCTransportEntitledForSPIAccess"))
  {
    v11 = [(HMDMediaSystem *)self audioDestination];
    [v16 encodeObject:v11 forKey:*MEMORY[0x277CD09B8]];
  }

  [v16 encodeConditionalObject:v4 forKey:@"home"];
  if (([v16 hmd_homeManagerOptions] & 0x20) != 0 && ((objc_msgSend(v16, "hmd_isForRemoteTransport") & 1) != 0 || objc_msgSend(v16, "hmd_isForXPCTransport") && (objc_msgSend(v16, "hmd_isForXPCTransportEntitledForSPIAccess") & 1) != 0 || objc_msgSend(v16, "hmd_isForLocalStore")))
  {
    v12 = [(HMDMediaSystem *)self settingsController];
    [v12 encodeWithCoder:v16];
  }

  v13 = [v16 hmd_isForXPCTransport];
  v14 = [(HMDMediaSystem *)self appData];
  v15 = v14;
  if (v13)
  {
...
LABEL_8:
    ...
    v9 = [(HMDMediaSystem *)self targetAccessory];
    v10 = [v9 isCurrentAccessory];
    ...
    if (v10)
    {
      ...
      objc_autoreleasePoolPop(v11);
      v7 = [(HMDMediaSystem *)v12 settingsController];
...
- (void)_registerForNotifications
{
  ...
  v5 = [(HMDMediaSystem *)self notificationCenter];
...
- (void)_registerForMessages
{
  ...
  v3 = [(HMDMediaSystem *)self home];
  v4 = [(HMDMediaSystem *)self msgDispatcher];
  ...
  v17[1] = v8;
  v17[2] = v6;
  v9 = [HMDUserMessagePolicy userMessagePolicyWithHome:v3 userPrivilege:4 remoteAccessRequired:0];
  v17[3] = v9;
  v10 = [MEMORY[0x277CBEA60] arrayWithObjects:v17 count:4];

  [v4 registerForMessage:*MEMORY[0x277CD2778] receiver:self policies:v10 selector:sel__routeUpdateMediaSystem_];
  ...
  [v4 registerForMessage:*MEMORY[0x277CD2468] receiver:self policies:v14 selector:sel__handleAppData_];
...
- (id)_modelForMediaSystem
{
  ...
  if (a1)
  {
    ...
    if (v4)
    {
      ...
      v18 = objc_alloc(*v11);
      v19 = [v1 uuid];
      v1 = [v18 initWithUUID:v19 parentUUID:v6];
    }
...
{
  v2 = [(HMDMediaSystem *)self components];
  v3 = [v2 na_any:&__block_literal_global_68];
...
{
  v3 = [(HMDMediaSystem *)self accessories];
  v4 = [v3 na_any:&__block_literal_global_62];
...
- (BOOL)isValid
{
  ...
  if (v4 > 1)
  {
    ...
    v26 = 0u;
    v27 = 0u;
    v10 = [(HMDMediaSystem *)self components];
    ...
    if (v11)
    {
      ...
      while (2)
      {
        for (i = 0; i != v12; ++i)
        {
          ...
          v15 = *(*(&v26 + 1) + 8 * i);
          v16 = [v15 accessory];
          if (!v16 || (-[HMDMediaSystem home](self, "home"), v17 = objc_claimAutoreleasedReturnValue(), [v17 accessories], v18 = objc_claimAutoreleasedReturnValue(), v19 = objc_msgSend(v18, "containsObject:", v16), v18, v17, (v19 & 1) == 0))
          {
            v20 = objc_autoreleasePoolPush();
            v21 = self;
            v22 = HMFGetOSLogHandle();
...
- (id)assistantObject
{
  ...
  if (v4 && v3)
  {
    ...
    if (v6)
    {
      ...
      v16 = [v47 accessories];
      v17 = [v16 na_map:&__block_literal_global_37_115774];
