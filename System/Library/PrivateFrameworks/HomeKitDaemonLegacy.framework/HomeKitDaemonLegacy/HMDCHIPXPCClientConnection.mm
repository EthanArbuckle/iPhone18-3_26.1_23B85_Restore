...
- (void)downloadLogWithController:(id)controller nodeId:(id)id type:(int64_t)type timeout:(double)timeout completion:(id)completion
{
  ...
  if (os_log_type_enabled(v18, OS_LOG_TYPE_INFO))
  {
    ...
    v48 = 2112;
    v49 = v21;
    _os_log_impl(&dword_2531F8000, v18, OS_LOG_TYPE_INFO, "%{public}@Download log via controller %@, nodeId %@, logType %@, timeout %@", &v40, 0x34u);
  }
  ...
  if (v24)
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v30, OS_LOG_TYPE_ERROR))
      {
        ...
        v42 = 2112;
        v43 = v25;
        _os_log_impl(&dword_2531F8000, v30, OS_LOG_TYPE_ERROR, "%{public}@Could not send remote message using invalid home UUID: %@", &v40, 0x16u);
      }
  ...
  if (os_log_type_enabled(v35, OS_LOG_TYPE_ERROR))
  {
    ...
    v45 = v37;
    v38 = v37;
    _os_log_impl(&dword_2531F8000, v35, OS_LOG_TYPE_ERROR, "%{public}@Download log called with controller of unexpected class: %@ (%@)", &v40, 0x20u);
  }
...
- (void)readAttributeCacheWithController:(id)controller nodeId:(unint64_t)id endpointId:(id)endpointId clusterId:(id)clusterId attributeId:(id)attributeId completion:(id)completion
{
  ...
  if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR))
  {
    ...
    v30 = 2048;
    idCopy = id;
    _os_log_impl(&dword_2531F8000, v22, OS_LOG_TYPE_ERROR, "%{public}@Not reading attribute cache with controller: %@, nodeID: 0x%llx: Unsupported", &v26, 0x20u);
  }
...
- (void)subscribeWithController:(id)controller nodeId:(unint64_t)id minInterval:(id)interval maxInterval:(id)maxInterval params:(id)params shouldCache:(BOOL)cache completion:(id)completion
{
  ...
  if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR))
  {
    ...
    v30 = 2048;
    idCopy = id;
    _os_log_impl(&dword_2531F8000, v22, OS_LOG_TYPE_ERROR, "%{public}@Not subscribing with controller: %@, nodeID: 0x%llx: Unsupported", &v26, 0x20u);
  }
...
- (void)stopReportsWithController:(id)controller nodeId:(unint64_t)id completion:(id)completion
{
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_DEBUG))
  {
    ...
    v20 = 2048;
    idCopy = id;
    _os_log_impl(&dword_2531F8000, v13, OS_LOG_TYPE_DEBUG, "%{public}@Stop reports with controller %@, nodeId 0x%llx", &v16, 0x20u);
  }
        ...
        else
        {
          ...
          if (os_log_type_enabled(v54, OS_LOG_TYPE_ERROR))
          {
            ...
            *buf = 138543618;
            ...
            v64 = 2112;
            v65 = v31;
            _os_log_impl(&dword_2531F8000, v54, OS_LOG_TYPE_ERROR, "%{public}@Could not send remote message using unknown home UUID: %@", buf, 0x16u);
          }
...
- (BOOL)allowsOperation
{
  ...
  if (isForegrounded)
  {
    if (v8)
    {
      ...
      v14 = 138543362;
      v15 = v9;
      _os_log_impl(&dword_2531F8000, v7, OS_LOG_TYPE_DEBUG, "%{public}@Client foregrounded", &v14, 0xCu);
    }
  ...
  else
  {
    if (v8)
    {
      ...
      v16 = 2112;
      v17 = v12;
      _os_log_impl(&dword_2531F8000, v7, OS_LOG_TYPE_DEBUG, "%{public}@Client is not foregrounded: entitlement %@", &v14, 0x16u);
    }
...
LABEL_11:
  ...
  if (os_log_type_enabled(v29, OS_LOG_TYPE_ERROR))
  {
    ...
    *buf = 138543618;
    ...
    v43 = 2048;
    idCopy2 = id;
    _os_log_impl(&dword_2531F8000, v29, OS_LOG_TYPE_ERROR, "%{public}@Failed to retrieve remote controller with fabric Id %llu", buf, 0x16u);
  }
...
void __69__HMDCHIPXPCClientConnection__registerReportHandlerWithHomeWithUUID___block_invoke(uint64_t a1, uint64_t a2, void *a3)
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    v18 = 2112;
    v19 = v5;
    _os_log_impl(&dword_2531F8000, v8, OS_LOG_TYPE_INFO, "%{public}@Dispatching report to client using nodeId %tu, reports %@", &v14, 0x20u);
  }
