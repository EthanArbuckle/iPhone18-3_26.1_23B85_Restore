...
- (BOOL)isPresenceRegionKnownForUser:(id)user
{
  ...
  if (value == 1)
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
      {
        ...
        v25 = 2112;
        v26 = userCopy;
        _os_log_impl(&dword_2531F8000, v19, OS_LOG_TYPE_INFO, "%{public}@Could not find user %@", &v23, 0x16u);
      }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_DEBUG))
    {
      ...
      v25 = 2112;
      v26 = userCopy;
      _os_log_impl(&dword_2531F8000, v15, OS_LOG_TYPE_DEBUG, "%{public}@%@ is not presence-authorized, cannot determine isUserPresenceRegionKnown", &v23, 0x16u);
    }
...
- (BOOL)isUserNotAtHome:(id)home
{
  ...
  if (value == 1)
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v18, OS_LOG_TYPE_INFO))
      {
        ...
        v24 = 2112;
        v25 = homeCopy;
        _os_log_impl(&dword_2531F8000, v18, OS_LOG_TYPE_INFO, "%{public}@Could not find user %@", &v22, 0x16u);
      }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_DEBUG))
    {
      ...
      v24 = 2112;
      v25 = homeCopy;
      _os_log_impl(&dword_2531F8000, v14, OS_LOG_TYPE_DEBUG, "%{public}@%@ is not presence-authorized, cannot determine isUserNotAtHome", &v22, 0x16u);
    }
...
- (BOOL)isUserAtHome:(id)home
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_DEBUG))
    {
      ...
      v24 = 2112;
      v25 = homeCopy;
      _os_log_impl(&dword_2531F8000, v14, OS_LOG_TYPE_DEBUG, "%{public}@%@ is not presence-authorized, cannot determine isUserAtHome", &v22, 0x16u);
    }
...
LABEL_7:
  ...
  if (!v12)
  {
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
    {
      ...
      v22 = 2112;
      v23 = v7;
      _os_log_impl(&dword_2531F8000, v17, OS_LOG_TYPE_INFO, "%{public}@Using HMDUserPresenceRegionStatusUnknown for user with nil presence: %@", &v20, 0x16u);
    }
...
LABEL_7:
  ...
  if (!v10)
  {
    ...
    if (os_log_type_enabled(v18, OS_LOG_TYPE_INFO))
    {
      ...
      v24 = 2112;
      v25 = v7;
      _os_log_impl(&dword_2531F8000, v18, OS_LOG_TYPE_INFO, "%{public}@Using HMDUserPresenceRegionStatusUnknown for user with nil presence: %@", &v22, 0x16u);
    }
...
uint64_t __30__HMDHomePresence_logCategory__block_invoke()
{
  ...
  v2 = logCategory__hmf_once_v4_140492;
  logCategory__hmf_once_v4_140492 = v1;
