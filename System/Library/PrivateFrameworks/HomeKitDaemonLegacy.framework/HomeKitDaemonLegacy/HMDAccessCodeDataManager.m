...
- (NSArray)cachedAccessCodes
{
  ...
  v4 = [v3 na_map:&__block_literal_global_74_142976];
...
- (void)handleRemovedHomeAccessCodeModel:(id)a3 message:(id)a4 flow:(id)a5
{
  ...
  if (v17)
  {
    ...
    if (v18)
    {
      ...
      v28 = MEMORY[0x277CD1A68];
      v29 = [v8 label];
      v30 = [v28 homeAccessCodeValueWithStringValue:v18 label:v29];
      v40 = v30;
      v31 = [MEMORY[0x277CBEA60] arrayWithObjects:&v40 count:1];
      [v27 accessCodeDataManager:v20 didRemoveHomeAccessCodes:v31 removedByUserUUID:0 flow:v10];
    }
...
LABEL_16:
  ...
  if (v24)
  {
    ...
    if ((v29 & 1) == 0)
    {
      ...
      v38 = [v9 transactionResult];
      [v38 markChanged];

      v39 = MEMORY[0x277CD1A68];
      v40 = [v8 value];
      v41 = [v8 label];
      v42 = [v39 homeAccessCodeValueWithStringValue:v40 label:v41];
      v66 = v42;
      v43 = [MEMORY[0x277CBEA60] arrayWithObjects:&v66 count:1];
      [v21 accessCodeDataManager:v31 didUpdateHomeAccessCodes:v43 changedByUserUUID:0 flow:v65];
    }
  ...
  else
  {
    ...
    v56 = [v8 label];
    v57 = [v17 labelsByAccessCode];
    v58 = [v8 value];
    [v57 setObject:v56 forKeyedSubscript:v58];

    v59 = [v9 transactionResult];
    [v59 markChanged];
    ...
    v61 = [v8 value];
    v62 = [v8 label];
    v63 = [v60 homeAccessCodeValueWithStringValue:v61 label:v62];
    v67 = v63;
    v64 = [MEMORY[0x277CBEA60] arrayWithObjects:&v67 count:1];
    [v21 accessCodeDataManager:v52 didAddHomeAccessCodes:v64 addedByUserUUID:0 flow:v10];
  }
...
- (NSSet)accessCodeValuesWithRemovedUserInfo
{
  ...
  if (v4)
  {
    ...
    v7 = [v6 allKeys];
    v8 = [v7 na_map:&__block_literal_global_44_143063];
...
- (NSSet)accessCodeValuesWithUserLabel
{
  ...
  if (v4)
  {
    v5 = MEMORY[0x277CBEB98];
    v6 = [v4 users];
    v7 = [v6 na_map:&__block_literal_global_41_143068];
...
- (NSSet)accessCodeValuesWithSimpleLabel
{
  ...
  if (v4)
  {
    ...
    v7 = [v6 allKeys];
    v8 = [v7 na_map:&__block_literal_global_38_143074];
    v9 = [v5 setWithArray:v8];
  }
...
- (id)_removeUserAccessCodeValue:(id)a3 removedByUserUUID:(id)a4 flow:(id)a5
{
  ...
  if (v14)
  {
    ...
    if (v16)
    {
      ...
      [(HMDUserAccessCodeModel *)v19 setChangedByUserUUID:v9];
...
- (id)_setUserWithUUID:(id)a3 forAccessCodeValue:(id)a4 changedByUserUUID:(id)a5 flow:(id)a6
{
  ...
  if (v17)
  {
    ...
    v19 = v10;
    v47 = v19;
    v20 = [v18 na_firstObjectPassingTest:v46];
    ...
    if (v20)
    {
      ...
      v23 = [(HMDAccessCodeDataManager *)self addOrUpdateUserAccessCodeModel:v21 flow:v13];
...
- (NSArray)homeAccessCodeValuesWithRemovedUserInfo
{
  ...
  if (v4)
  {
    ...
    {
      v6 = [v4 removedUserInfoByAccessCode];
      v7 = [v6 na_map:&__block_literal_global_17_143104];
...
- (NSArray)homeAccessCodeValuesWithUserLabels
{
  ...
  {
    v5 = [v4 users];
    v6 = [v5 na_map:&__block_literal_global_14_143108];
  }
...
- (NSArray)homeAccessCodeValuesWithSimpleLabels
{
  ...
  if (v4)
  {
    ...
    {
      v6 = [v4 labelsByAccessCode];
      v7 = [v6 na_map:&__block_literal_global_8_143113];
