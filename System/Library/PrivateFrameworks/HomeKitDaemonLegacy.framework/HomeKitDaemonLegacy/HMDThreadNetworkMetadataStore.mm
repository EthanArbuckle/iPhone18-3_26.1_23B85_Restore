...
- (void)_removePreferredNetworkWithCompletion:(id)completion
{
  ...
  v18 = &v17;
  v19 = 0x3032000000;
  v20 = __Block_byref_object_copy__135889;
  v21 = __Block_byref_object_dispose__135890;
  threadClientFactory = [(HMDThreadNetworkMetadataStore *)self threadClientFactory];
...
- (void)_retrievePreferredNetwork:(id)network completion:(id)completion
{
  ...
  if (isFeatureMatteriPhoneOnlyPairingControlForThreadEnabled())
  {
    ...
    *(&buf + 1) = &buf;
    v34 = 0x3032000000;
    v35 = __Block_byref_object_copy__135889;
    v36 = __Block_byref_object_dispose__135890;
    threadClientFactory = [(HMDThreadNetworkMetadataStore *)self threadClientFactory];
    ...
    else
    {
      ...
      if (os_log_type_enabled(v20, OS_LOG_TYPE_ERROR))
      {
        ...
        *v31 = 138543362;
        v32 = v21;
        _os_log_impl(&dword_2531F8000, v20, OS_LOG_TYPE_ERROR, "%{public}@CoreThreadCommissionerService is not reachable.", v31, 0xCu);
      }
...
void __118__HMDThreadNetworkMetadataStore__validateOperationalDatasetWithTHClient_operationalDataset_storeCachedAOD_completion___block_invoke_28(uint64_t a1, void *a2)
{
  ...
  if (v3)
  {
    if (v7)
    {
      ...
      v11 = 22;
LABEL_6:
      _os_log_impl(&dword_2531F8000, v10, OS_LOG_TYPE_INFO, v9, &v14, v11);
    }
  }
...
+ (HMDThreadNetworkMetadataStore)defaultStore
{
  ...
  if (WeakRetained)
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_DEBUG))
    {
      ...
      v12 = 138543362;
      v13 = v7;
      _os_log_impl(&dword_2531F8000, v6, OS_LOG_TYPE_DEBUG, "%{public}@Reusing existing store", &v12, 0xCu);
    }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_DEBUG))
    {
      ...
      v12 = 138543362;
      v13 = v9;
      _os_log_impl(&dword_2531F8000, v8, OS_LOG_TYPE_DEBUG, "%{public}@Creating new store", &v12, 0xCu);
    }
...
uint64_t __44__HMDThreadNetworkMetadataStore_logCategory__block_invoke()
{
  ...
  v2 = logCategory__hmf_once_v1_135959;
  logCategory__hmf_once_v1_135959 = v1;
