...
- (HMDSiriEndpointEnablementLogEvent)initWithDictionary:(id)dictionary
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
    {
      ...
      v18 = 2112;
      v19 = dictionaryCopy;
      _os_log_impl(&dword_2531F8000, v12, OS_LOG_TYPE_ERROR, "%{public}@Could not init HMDSiriEndpointEnablementLogEvent with dictionary %@", &v16, 0x16u);
    }
...
uint64_t __48__HMDSiriEndpointEnablementLogEvent_logCategory__block_invoke()
{
  ...
  v2 = logCategory__hmf_once_v12_195514;
  logCategory__hmf_once_v12_195514 = v1;
