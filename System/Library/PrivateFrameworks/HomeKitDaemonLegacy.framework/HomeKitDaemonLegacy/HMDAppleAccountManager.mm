...
void __71__HMDAppleAccountManager_accountChangeObserver_observedDeletedAccount___block_invoke_2(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    v12 = 2112;
    v13 = v8;
    _os_log_impl(&dword_2531F8000, v6, OS_LOG_TYPE_INFO, "%{public}@Completed handling of removed account %@", &v10, 0x16u);
  }
...
- (void)service:(id)a3 devicesChanged:(id)a4
{
  ...
  if (v9)
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
    {
      ...
      v16 = 138543362;
      v17 = v13;
      _os_log_impl(&dword_2531F8000, v12, OS_LOG_TYPE_INFO, "%{public}@Received notification that devices changed on the current account", &v16, 0xCu);
    }
...
- (void)account:(id)a3 aliasesChanged:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    v15 = 138543362;
    v16 = v11;
    _os_log_impl(&dword_2531F8000, v10, OS_LOG_TYPE_INFO, "%{public}@Received notification that aliases changed", &v15, 0xCu);
  }
...
- (void)account:(id)a3 isActiveChanged:(BOOL)a4
{
  ...
  if (v8)
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
    {
      ...
      v16 = 138543362;
      v17 = v12;
      _os_log_impl(&dword_2531F8000, v11, OS_LOG_TYPE_INFO, "%{public}@Received notification that account is active changed", &v16, 0xCu);
    }
...
uint64_t __59__HMDAppleAccountManager_connection_didReceivePublicToken___block_invoke(uint64_t a1)
{
  ...
  if (v2)
  {
    if (os_log_type_enabled(v5, OS_LOG_TYPE_DEFAULT))
    {
      ...
      v12 = 138543362;
      v13 = v7;
      _os_log_impl(&dword_2531F8000, v6, OS_LOG_TYPE_DEFAULT, "%{public}@Received notification that the push token changed", &v12, 0xCu);
    }
  ...
  else
  {
    if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
    {
      ...
      v14 = 2048;
      v15 = v10;
      _os_log_impl(&dword_2531F8000, v6, OS_LOG_TYPE_INFO, "%{public}@We got the push token before the apple account manager is started. Will process this token once it starts up. token length: %lu", &v12, 0x16u);
    }
...
LABEL_10:
  ...
  if ((v12 & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v29, OS_LOG_TYPE_FAULT))
    {
      ...
      *buf = 138543362;
      v35 = v30;
      _os_log_impl(&dword_2531F8000, v29, OS_LOG_TYPE_FAULT, "%{public}@Submitting ABC event for failure: Account update does not match current account identifier", buf, 0xCu);
    }
  ...
  if (v8)
  {
    ...
    if ((v12 & 1) == 0)
    {
      ...
      if (os_log_type_enabled(v31, OS_LOG_TYPE_FAULT))
      {
        ...
        *buf = 138543362;
        v37 = v32;
        _os_log_impl(&dword_2531F8000, v31, OS_LOG_TYPE_FAULT, "%{public}@Submitting ABC event for failure: Account update does not match current account identifier", buf, 0xCu);
      }
...
{
  v4 = a3;
  v5 = [(HMDAppleAccountManager *)self watchManager];
  v6 = [v5 connectedWatches];
...
{
  v4 = a3;
  v5 = ([v4 isCurrentDevice] & 1) != 0 || -[HMDAppleAccountManager isDeviceLocallyPairedWatch:](self, "isDeviceLocallyPairedWatch:", v4);
...
LABEL_27:
    ...
    _os_log_impl(&dword_2531F8000, v20, OS_LOG_TYPE_INFO, v22, &v31, 0xCu);
  ...
  if (os_log_type_enabled(v25, OS_LOG_TYPE_ERROR))
  {
    ...
    v31 = 138543362;
    v32 = v26;
    _os_log_impl(&dword_2531F8000, v25, OS_LOG_TYPE_ERROR, "%{public}@Manager cannot confirm account model process due to nil parameter.", &v31, 0xCu);
  }
...
- (void)__updateMergeIDOnAccount
{
  ...
  if (v5)
  {
    ...
    {
      v13 = MEMORY[0x259C01FB0](v12);
    }

    else if ([v12 _appearsToBeBusinessID])
    {
      v13 = MEMORY[0x259C01F90](v12);
    }
...
void __50__HMDAppleAccountManager___updateMergeIDOnAccount__block_invoke_3(uint64_t a1, void *a2, uint64_t a3, _BYTE *a4)
{
  ...
  if (v7)
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
    {
      ...
      v27 = 2112;
      v28 = v14;
      _os_log_impl(&dword_2531F8000, v11, OS_LOG_TYPE_INFO, "%{public}@Found mergeID %@ for destination %@, new attribute %@", &v21, 0x2Au);
    }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
    {
      ...
      v23 = 2112;
      v24 = v19;
      _os_log_impl(&dword_2531F8000, v17, OS_LOG_TYPE_INFO, "%{public}@Did not get the mergeID after querying IDS: %@", &v21, 0x16u);
    }
...
void __51__HMDAppleAccountManager___handleMigrationUpdated___block_invoke(uint64_t a1)
{
  ...
  if ((v3 & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
    {
      ...
      v12 = 138543362;
      v13 = v7;
      _os_log_impl(&dword_2531F8000, v6, OS_LOG_TYPE_INFO, "%{public}@Received notification that migration completed", &v12, 0xCu);
    }
  ...
  if (v2)
  {
    ...
    if ((v4 & 1) == 0)
    {
      ...
      if (os_log_type_enabled(v8, OS_LOG_TYPE_DEFAULT))
      {
        ...
        v21 = 2112;
        v22 = v10;
        _os_log_impl(&dword_2531F8000, v8, OS_LOG_TYPE_DEFAULT, "%{public}@Updating name: %@", &v19, 0x16u);
      }
...
- (void)__handleRemovedAccountWithCompletion:(id)a3
{
  ...
  if (v5)
  {
    if (os_log_type_enabled(v8, OS_LOG_TYPE_DEFAULT))
    {
      ...
      v39 = 138543362;
      v40 = v10;
      _os_log_impl(&dword_2531F8000, v9, OS_LOG_TYPE_DEFAULT, "%{public}@Received notification account was removed", &v39, 0xCu);
    }
    ...
    if (v12)
    {
      ...
      if (os_log_type_enabled(v15, OS_LOG_TYPE_FAULT))
      {
        ...
        v39 = 138543362;
        v40 = v16;
        _os_log_impl(&dword_2531F8000, v15, OS_LOG_TYPE_FAULT, "%{public}@Got primary iCloud account removed notification even though user is still signed in", &v39, 0xCu);
      }
      ...
      if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR))
      {
        ...
        v39 = 138543362;
        v40 = v20;
        _os_log_impl(&dword_2531F8000, v19, OS_LOG_TYPE_ERROR, "%{public}@Got primary iCloud account removed notification even though user is still signed in", &v39, 0xCu);
      }
    ...
    else
    {
      ...
      if (os_log_type_enabled(v26, OS_LOG_TYPE_INFO))
      {
        ...
        v41 = 2112;
        v42 = account;
        _os_log_impl(&dword_2531F8000, v26, OS_LOG_TYPE_INFO, "%{public}@Current account: %@", &v39, 0x16u);
      }
      ...
      if (os_log_type_enabled(v33, OS_LOG_TYPE_DEFAULT))
      {
        ...
        v39 = 138543362;
        v40 = v34;
        _os_log_impl(&dword_2531F8000, v33, OS_LOG_TYPE_DEFAULT, "%{public}@Primary apple account is removed & logged out", &v39, 0xCu);
      }
  ...
  else
  {
    if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
    {
      ...
      v39 = 138543362;
      v40 = v22;
      _os_log_impl(&dword_2531F8000, v9, OS_LOG_TYPE_INFO, "%{public}@Ignoring account notification", &v39, 0xCu);
    }
...
- (void)__handleAccountAddedOrModified:(BOOL)a3
{
  ...
  if (v5)
  {
    if (os_log_type_enabled(v8, OS_LOG_TYPE_DEFAULT))
    {
      ...
      v21 = 138543362;
      v22 = v10;
      _os_log_impl(&dword_2531F8000, v9, OS_LOG_TYPE_DEFAULT, "%{public}@Received notification account was modified", &v21, 0xCu);
    }
      ...
      if (!v12)
      {
        ...
        else
        {
          ...
          if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR))
          {
            ...
            v21 = 138543362;
            v22 = v18;
            _os_log_impl(&dword_2531F8000, v17, OS_LOG_TYPE_ERROR, "%{public}@Failed to create account", &v21, 0xCu);
          }
  ...
  else
  {
    if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
    {
      ...
      v21 = 138543362;
      v22 = v14;
      _os_log_impl(&dword_2531F8000, v9, OS_LOG_TYPE_INFO, "%{public}@Ignoring account notification", &v21, 0xCu);
    }
...
void __43__HMDAppleAccountManager___localDataReset___block_invoke(uint64_t a1)
{
  ...
  if ([*(a1 + 32) isMonitoring])
  {
    ...
    if (os_log_type_enabled(v4, OS_LOG_TYPE_DEFAULT))
    {
      ...
      v18 = 138543362;
      v19 = v5;
      _os_log_impl(&dword_2531F8000, v4, OS_LOG_TYPE_DEFAULT, "%{public}@Repushing account transactions", &v18, 0xCu);
    }
...
LABEL_14:
    ...
    else
    {
      ...
      if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
      {
        ...
        v18 = 138543362;
        v19 = v12;
        _os_log_impl(&dword_2531F8000, v11, OS_LOG_TYPE_ERROR, "%{public}@Failed to re-create account", &v18, 0xCu);
      }
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_ERROR))
    {
      ...
      v18 = 138543362;
      v19 = v16;
      _os_log_impl(&dword_2531F8000, v15, OS_LOG_TYPE_ERROR, "%{public}@Cannot add account after local reset", &v18, 0xCu);
    }
...
void __58__HMDAppleAccountManager__registerForRapportNotifications__block_invoke(uint64_t a1)
{
  ...
  if (WeakRetained)
  {
    ...
    if (os_log_type_enabled(v4, OS_LOG_TYPE_DEFAULT))
    {
      ...
      v8 = 138543362;
      v9 = v5;
      _os_log_impl(&dword_2531F8000, v4, OS_LOG_TYPE_DEFAULT, "%{public}@Received notification that rapport identity changed, update current device", &v8, 0xCu);
    }
...
- (BOOL)maybeSkipUpdatesOfType:(unint64_t)a3 whileMigrating:(BOOL)a4
{
  ...
  if (!v8)
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
    {
      ...
      v21 = 2114;
      v22 = v7;
      _os_log_impl(&dword_2531F8000, v11, OS_LOG_TYPE_INFO, "%{public}@Skipping update of %{public}@ while the service is inactive, will try again later", &v19, 0x16u);
    }
  ...
  if (v4)
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
    {
      ...
      v21 = 2114;
      v22 = v7;
      _os_log_impl(&dword_2531F8000, v15, OS_LOG_TYPE_INFO, "%{public}@Skipping update of %{public}@ during migration, will try again later", &v19, 0x16u);
    }
...
- (HMDAppleAccountManager)initWithIDSService:(id)a3 activityBroadcaster:(id)a4 dataSource:(id)a5
{
  ...
  {
    v45.receiver = self;
    v45.super_class = HMDAppleAccountManager;
    v12 = [(HMDAppleAccountManager *)&v45 init];
    if (v12)
    {
      ...
      v36 = [(HMDAppleAccountManager *)v12 devicesChangeBackoffTimer];
      [v36 setDelegate:v12];

      v37 = [(HMDAppleAccountManager *)v12 devicesChangeBackoffTimer];
...
- (HMDAppleAccountManager)initWithIDSServiceManager:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v20 = 138543362;
    v21 = v8;
    _os_log_impl(&dword_2531F8000, v7, OS_LOG_TYPE_INFO, "%{public}@Creating an HMDAppleAccountManager", &v20, 0xCu);
  }
