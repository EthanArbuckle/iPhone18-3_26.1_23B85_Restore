...
- (HMDPowerLogObserverContext)initWithLogEventDispatcher:(id)dispatcher powerLogger:(id)logger;
...
- (HMDPowerLogObserverContext)initWithLogEventDispatcher:(id)dispatcher powerLogger:(id)logger
{
  ...
  if (v8)
  {
    objc_storeWeak(&v8->_logEventDispatcher, dispatcherCopy);
    objc_storeWeak(&v9->_powerLogger, loggerCopy);
