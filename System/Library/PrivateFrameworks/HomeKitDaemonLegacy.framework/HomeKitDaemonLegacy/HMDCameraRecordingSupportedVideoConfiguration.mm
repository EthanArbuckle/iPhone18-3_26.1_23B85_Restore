...
{
  v4 = a3;
  v5 = [(HMDCameraRecordingSupportedVideoConfiguration *)self codecConfigurations];
...
- (HMDCameraRecordingSupportedVideoConfiguration)initWithCoder:(id)a3
{
  ...
  if (v5)
  {
    ...
    v9 = [v4 decodeObjectOfClasses:v8 forKey:@"kSupportedVideoConfigurationCodecConfigurations"];
...
- (void)description:(id)a3 indent:(id)a4
{
  ...
  v10 = [(HMDCameraRecordingSupportedVideoConfiguration *)self codecConfigurations];
...
- (NSData)tlvData
{
  ...
  v4 = [(HMDCameraRecordingSupportedVideoConfiguration *)self codecConfigurations];
  v5 = [v4 firstObject];
  v6 = [v5 tlvData];
