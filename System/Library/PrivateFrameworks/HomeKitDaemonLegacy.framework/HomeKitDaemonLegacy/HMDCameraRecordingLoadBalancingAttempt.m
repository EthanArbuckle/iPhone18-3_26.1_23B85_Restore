  ...
  if (v5 == v4)
  {
    ...
    if (v6)
    {
      ...
      if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
      {
        ...
        v13 = 138543362;
        v14 = v10;
        _os_log_impl(&dword_2531F8000, v9, OS_LOG_TYPE_ERROR, "%{public}@Timed out waiting for load balancing message response", &v13, 0xCu);
      }
...
uint64_t __53__HMDCameraRecordingLoadBalancingAttempt_logCategory__block_invoke()
{
  ...
  v2 = logCategory__hmf_once_v2_68893;
  logCategory__hmf_once_v2_68893 = v1;
