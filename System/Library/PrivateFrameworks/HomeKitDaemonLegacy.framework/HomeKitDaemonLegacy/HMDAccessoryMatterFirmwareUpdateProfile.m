...
- (void)readMatterFirmwareUpdateCharacteristics
{
  ...
  [(HMDAccessoryMatterFirmwareUpdateProfile *)self readAndProcessCharacteristics:v3 withCompletion:&__block_literal_global_44_138198];
}
...
- (void)_enableCharacteristicsNotifications:(BOOL)a3
{
  ...
  if (v3)
  {
    ...
    [(HMDAccessoryMatterFirmwareUpdateProfile *)self readAndProcessCharacteristics:v7 withCompletion:&__block_literal_global_38_138214];
  }
}
