...
void __44__HMDLibXPCServer_handleIncomingConnection___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (!WeakRetained)
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
    {
      ...
      *v40 = 138543362;
      *&v40[4] = v17;
      _os_log_impl(&dword_2531F8000, v16, OS_LOG_TYPE_ERROR, "%{public}@Lost self when handling XPC event on listener connection", v40, 0xCu);
    }
    ...
    if (v3 != MEMORY[0x277D86420])
    {
      if (v3 == MEMORY[0x277D863F0])
      {
        ...
        if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
        {
          ...
          *&v40[12] = 2112;
          *&v40[14] = v38;
          _os_log_impl(&dword_2531F8000, v10, OS_LOG_TYPE_INFO, "%{public}@Connection interrupted: %@", v40, 0x16u);
        }
      ...
      else if (v26)
      {
        ...
        *&v40[22] = 2112;
        ...
        v31 = 32;
LABEL_26:
        _os_log_impl(&dword_2531F8000, v30, OS_LOG_TYPE_INFO, v29, v40, v31);
      }
    ...
    if (os_log_type_enabled(v34, OS_LOG_TYPE_INFO))
    {
      ...
      *&v40[12] = 2112;
      *&v40[14] = v36;
      _os_log_impl(&dword_2531F8000, v34, OS_LOG_TYPE_INFO, "%{public}@Termination imminent for connection: %@", v40, 0x16u);
    }
...
LABEL_11:
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    *&v40[22] = 2080;
    ...
    v42 = 2112;
    v43 = v3;
    _os_log_impl(&dword_2531F8000, v10, OS_LOG_TYPE_INFO, "%{public}@Received unexpected event type for connection %@: (%s) %@", v40, 0x2Au);
  }
...
LABEL_12:
    ...
    v17 = 138543362;
    v18 = v12;
    _os_log_impl(&dword_2531F8000, v11, OS_LOG_TYPE_ERROR, "%{public}@Lost self when handling XPC event on listener connection", &v17, 0xCu);
LABEL_11:
  ...
  if (v8 != MEMORY[0x277D86450])
  {
    ...
    if (v8 == v9)
    {
      if (v13)
      {
        ...
        v17 = 138543362;
        v18 = v15;
        _os_log_impl(&dword_2531F8000, v12, OS_LOG_TYPE_INFO, "%{public}@Listener connection locally invalidated", &v17, 0xCu);
      }
    }
    ...
    else if (v13)
    {
      ...
      v21 = 2112;
      v22 = v3;
      _os_log_impl(&dword_2531F8000, v12, OS_LOG_TYPE_INFO, "%{public}@Received unexpected event type for listener connection: (%s) %@", &v17, 0x20u);
    }
...
uint64_t __30__HMDLibXPCServer_logCategory__block_invoke()
{
  ...
  v2 = logCategory__hmf_once_v11_101752;
  logCategory__hmf_once_v11_101752 = v1;
