...
LABEL_10:
      _os_log_impl(&dword_2531F8000, v8, OS_LOG_TYPE_INFO, v10, &v12, 0xCu);
    }
...
- (void)_handleFMFDeviceChanged
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    v12 = 2112;
    v13 = v8;
    _os_log_impl(&dword_2531F8000, v6, OS_LOG_TYPE_INFO, "%{public}@FMF device changed, isThisDesignatedFMFDevice: %@", &v10, 0x16u);
  }
...
- (void)_handleUpdatedCloudPhotosSetting
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v13 = 2112;
    v14 = v9;
    _os_log_impl(&dword_2531F8000, v7, OS_LOG_TYPE_INFO, "%{public}@Cloud photos enabled changed to %@", &v11, 0x16u);
  }
...
- (void)_unconfigure
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    v10 = 138543362;
    v11 = v7;
    _os_log_impl(&dword_2531F8000, v6, OS_LOG_TYPE_INFO, "%{public}@Unconfiguring photo library person importer", &v10, 0xCu);
  }
...
- (void)_configure
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    v13 = 138543362;
    v14 = v7;
    _os_log_impl(&dword_2531F8000, v6, OS_LOG_TYPE_INFO, "%{public}@Configuring photo library person importer", &v13, 0xCu);
  }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v64, OS_LOG_TYPE_INFO))
    {
      ...
      *buf = 138543618;
      ...
      v89 = 2112;
      v90 = v76;
      _os_log_impl(&dword_2531F8000, v64, OS_LOG_TYPE_INFO, "%{public}@Photo library query returned nil when querying face crops for person %@, so not modifying their face crops.", buf, 0x16u);
    }
...
- (id)_importPersonsUsingBatchChange:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    *buf = 138543362;
    v102 = v8;
    _os_log_impl(&dword_2531F8000, v7, OS_LOG_TYPE_INFO, "%{public}@Importing persons from Photos", buf, 0xCu);
  }
...
LABEL_20:
              _os_log_impl(&dword_2531F8000, v41, OS_LOG_TYPE_INFO, v42, buf, 0x16u);
...
LABEL_22:
    ...
    obja = [obj na_map:&__block_literal_global_95941];
    v85 = 0u;
    v86 = 0u;
    v87 = 0u;
    v88 = 0u;
          ...
          if ((v50 & 1) == 0)
          {
            ...
            if (os_log_type_enabled(v53, OS_LOG_TYPE_INFO))
            {
              ...
              *buf = 138543618;
              ...
              v103 = 2112;
              v104 = v47;
              _os_log_impl(&dword_2531F8000, v53, OS_LOG_TYPE_INFO, "%{public}@Removing person: %@", buf, 0x16u);
            }
        ...
        for (k = 0; k != v58; ++k)
        {
          ...
          if (os_log_type_enabled(v64, OS_LOG_TYPE_INFO))
          {
            ...
            *buf = 138543618;
            ...
            v103 = 2112;
            v104 = v61;
            _os_log_impl(&dword_2531F8000, v64, OS_LOG_TYPE_INFO, "%{public}@Removing duplicate person: %@", buf, 0x16u);
          }
  ...
  else
  {
    if (v15)
    {
      ...
      *buf = 138543362;
      v102 = v68;
      _os_log_impl(&dword_2531F8000, v14, OS_LOG_TYPE_INFO, "%{public}@Photo library query returned nil when querying current photo library persons, so aborting import process", buf, 0xCu);
    }
  ...
  if (v7)
  {
    ...
    if (v10 == 1)
    {
      if (v14)
      {
        ...
        v26 = 2112;
        v27 = v3;
        _os_log_impl(&dword_2531F8000, v13, OS_LOG_TYPE_INFO, "%{public}@Ignoring person with duplicate external person UUID: %@", &v24, 0x16u);
      }
...
- (void)_import
{
  ...
  if (v4)
  {
    ...
    if (v6)
    {
      if ([(HMDPhotoLibraryPersonImporter *)self hasActiveImport])
      {
        ...
        if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
        {
          ...
          *buf = 138543362;
          v39 = v10;
          _os_log_impl(&dword_2531F8000, v9, OS_LOG_TYPE_INFO, "%{public}@Queueing import because active import exists", buf, 0xCu);
        }
      ...
      else
      {
        ...
        if (os_log_type_enabled(v21, OS_LOG_TYPE_INFO))
        {
          ...
          *buf = 138543362;
          v39 = v22;
          _os_log_impl(&dword_2531F8000, v21, OS_LOG_TYPE_INFO, "%{public}@Importing persons and face crops from Photos", buf, 0xCu);
        }
    ...
    else
    {
      ...
      if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR))
      {
        ...
        *buf = 138543362;
        v39 = v18;
        _os_log_impl(&dword_2531F8000, v17, OS_LOG_TYPE_ERROR, "%{public}@Failed to create batch change for person and face crop import", buf, 0xCu);
      }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *buf = 138543362;
      v39 = v14;
      _os_log_impl(&dword_2531F8000, v13, OS_LOG_TYPE_DEFAULT, "%{public}@Not importing persons and face crops because data source is nil", buf, 0xCu);
    }
...
id __40__HMDPhotoLibraryPersonImporter__import__block_invoke(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    *buf = 138543362;
    v51 = v7;
    _os_log_impl(&dword_2531F8000, v6, OS_LOG_TYPE_INFO, "%{public}@Importing persons and face crops from Photos after fetching current HomeKit persons and face crops", buf, 0xCu);
  }
        ...
        for (j = 0; j != v18; ++j)
        {
          ...
          if (os_log_type_enabled(v24, OS_LOG_TYPE_INFO))
          {
            ...
            *buf = 138543618;
            ...
            v52 = 2112;
            v53 = v21;
            _os_log_impl(&dword_2531F8000, v24, OS_LOG_TYPE_INFO, "%{public}@Removing face crops for person that no longer exists: %@", buf, 0x16u);
          }
...
id __40__HMDPhotoLibraryPersonImporter__import__block_invoke_9(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    v18 = 2112;
    v19 = v8;
    _os_log_impl(&dword_2531F8000, v6, OS_LOG_TYPE_INFO, "%{public}@Committing batch change: %@", &v16, 0x16u);
  }
...
void __40__HMDPhotoLibraryPersonImporter__import__block_invoke_11(uint64_t a1, void *a2, void *a3)
{
  ...
  if ([*(a1 + 32) hasQueuedImport])
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      v12 = 138543362;
      v13 = v10;
      _os_log_impl(&dword_2531F8000, v9, OS_LOG_TYPE_INFO, "%{public}@Starting queued import after finishing import", &v12, 0xCu);
    }
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t30_95972 != -1)
  {
    dispatch_once(&logCategory__hmf_once_t30_95972, &__block_literal_global_38_95973);
  }

  v3 = logCategory__hmf_once_v31_95974;
...
uint64_t __44__HMDPhotoLibraryPersonImporter_logCategory__block_invoke()
{
  ...
  v2 = logCategory__hmf_once_v31_95974;
  logCategory__hmf_once_v31_95974 = v1;
