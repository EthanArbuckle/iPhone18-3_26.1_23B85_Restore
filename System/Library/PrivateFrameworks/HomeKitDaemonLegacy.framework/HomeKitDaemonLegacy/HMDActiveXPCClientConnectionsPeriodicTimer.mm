...
- (void)timerDidFire:(id)fire
{
  ...
  if (timer == fireCopy)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      v13 = 138543362;
      v14 = v10;
      _os_log_impl(&dword_2531F8000, v9, OS_LOG_TYPE_INFO, "%{public}@Notifying delegate of timer firing", &v13, 0xCu);
    }
...
- (void)_updateTimer
{
  ...
  if (v5)
  {
    if (v9)
    {
      ...
      v15 = 138543362;
      v16 = v10;
      _os_log_impl(&dword_2531F8000, v8, OS_LOG_TYPE_INFO, "%{public}@Starting timer", &v15, 0xCu);
    }
  ...
  else
  {
    if (v9)
    {
      ...
      v15 = 138543362;
      v16 = v13;
      _os_log_impl(&dword_2531F8000, v8, OS_LOG_TYPE_INFO, "%{public}@Suspending timer", &v15, 0xCu);
    }
...
uint64_t __57__HMDActiveXPCClientConnectionsPeriodicTimer_logCategory__block_invoke()
{
  ...
  v2 = logCategory__hmf_once_v3_87048;
  logCategory__hmf_once_v3_87048 = v1;
