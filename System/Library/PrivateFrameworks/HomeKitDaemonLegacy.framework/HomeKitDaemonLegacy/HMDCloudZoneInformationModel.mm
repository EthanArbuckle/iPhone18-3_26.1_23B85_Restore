...
+ (id)properties
{
  if (properties_onceToken_87603 != -1)
  {
    dispatch_once(&properties_onceToken_87603, &__block_literal_global_87604);
  }

  v3 = properties__properties_87605;
...
void __42__HMDCloudZoneInformationModel_properties__block_invoke()
{
  ...
  v2 = properties__properties_87605;
  properties__properties_87605 = v1;
