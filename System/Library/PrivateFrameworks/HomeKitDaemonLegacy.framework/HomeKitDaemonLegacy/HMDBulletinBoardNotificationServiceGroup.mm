...
- (void)_updateAssociatedServices:(id)a3 associatedCameras:(id)a4
{
  ...
  if (v15)
  {
    ...
    if (!v17)
    {
      [(HMDBulletinBoardNotificationServiceGroup *)self _updateAssociatedServicesTable:v6];
    }
  }
  ...
  else
  {
    ...
    [(HMDBulletinBoardNotificationServiceGroup *)v20 _updateAssociatedServicesTable:v6];
    v7 = v18;
  }
  ...
  if ((v32 & 1) == 0)
  {
    ...
    [(HMDBulletinBoardNotificationServiceGroup *)v40 setCameraProfileUUIDs:v10];
    [(HMDBulletinBoardNotificationServiceGroup *)v40 setCameraProfilesTable:v23];
...
LABEL_24:
    ...
    [v45 saveWithReason:@"HMDBulletinBoardNotificationServiceGroupUpdatedSaveReason" postSyncNotification:0];
    goto LABEL_25;
  }
