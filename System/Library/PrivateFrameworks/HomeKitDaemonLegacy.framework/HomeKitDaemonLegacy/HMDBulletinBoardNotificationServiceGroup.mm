  ...
  else
  {
    ...
    if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR))
    {
      ...
      *buf = 138543618;
      ...
      v30 = 2112;
      v31 = 0;
      _os_log_impl(&dword_2531F8000, v22, OS_LOG_TYPE_ERROR, "%{public}@Could not initialize from decoded bulletinBoardNotification: %@", buf, 0x16u);
    }
...
LABEL_40:
  ...
  if (os_log_type_enabled(v15, OS_LOG_TYPE_ERROR))
  {
    ...
    *buf = 138543618;
    ...
    v103 = 2112;
    v104 = dCopy;
    _os_log_impl(&dword_2531F8000, v15, OS_LOG_TYPE_ERROR, "%{public}@Could not find the camera profile with unique id %@, not providing any context", buf, 0x16u);
  }
  ...
  if (v7 == 0x7FFFFFFFFFFFFFFFLL)
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
    {
      ...
      *buf = 138543618;
      ...
      v19 = 2112;
      v20 = v6;
      _os_log_impl(&dword_2531F8000, v10, OS_LOG_TYPE_ERROR, "%{public}@Could not find the camera profile with unique id %@", buf, 0x16u);
    }
...
- (void)_updateAssociatedServices:(id)services associatedCameras:(id)cameras
{
  ...
  if (v15)
  {
    ...
    if (!v17)
    {
      [(HMDBulletinBoardNotificationServiceGroup *)self _updateAssociatedServicesTable:servicesCopy];
    }
  }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v21, OS_LOG_TYPE_INFO))
    {
      ...
      *buf = 138543618;
      ...
      v56 = 2112;
      v57 = v13;
      _os_log_impl(&dword_2531F8000, v21, OS_LOG_TYPE_INFO, "%{public}@Updating associated services with %@", buf, 0x16u);
  ...
  v25 = [allValues countByEnumeratingWithState:&v49 objects:v53 count:16];
  if (v25)
  {
    v26 = v25;
    v27 = *v50;
    do
    {
      ...
      do
      {
        ...
        cameraProfile = [*(*(&v49 + 1) + 8 * v28) cameraProfile];
      ...
      while (v26 != v28);
      v26 = [allValues countByEnumeratingWithState:&v49 objects:v53 count:16];
    }
  ...
  if ((v32 & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v41, OS_LOG_TYPE_INFO))
    {
      ...
      *buf = 138543618;
      ...
      v56 = 2112;
      v57 = v10;
      _os_log_impl(&dword_2531F8000, v41, OS_LOG_TYPE_INFO, "%{public}@Updating associated cameras with %@", buf, 0x16u);
    }

    objc_autoreleasePoolPop(v39);
    [(HMDBulletinBoardNotificationServiceGroup *)selfCopy2 setCameraProfileUUIDs:v10];
    [(HMDBulletinBoardNotificationServiceGroup *)selfCopy2 setCameraProfilesTable:weakObjectsHashTable];
    [bulletinBoardNotification registerForCharacteristicNotifications];
    goto LABEL_24;
  }
...
LABEL_24:
  ...
  if (os_log_type_enabled(v37, OS_LOG_TYPE_DEBUG))
  {
    ...
    *buf = 138543362;
    v55 = v38;
    _os_log_impl(&dword_2531F8000, v37, OS_LOG_TYPE_DEBUG, "%{public}@No change in service and camera associations", buf, 0xCu);
  }
...
- (void)_configureServices
{
  ...
  if (room)
  {
    ...
    if (home)
    {
      ...
      if (accessory2)
      {
                    ...
                    if ([(HMDBulletinBoardNotificationServiceGroup *)selfCopy _isSupportedAssociationService:v34])
                    {
                      ...
                      if (os_log_type_enabled(v37, OS_LOG_TYPE_DEBUG))
                      {
                        ...
                        *buf = 138543874;
                        ...
                        v106 = 2112;
                        v107 = serviceType;
                        _os_log_impl(&dword_2531F8000, v37, OS_LOG_TYPE_DEBUG, "%{public}@Service %@ with type %@ is a supported service for association", buf, 0x20u);
                    ...
                    if ([(HMDBulletinBoardNotificationServiceGroup *)selfCopy _isAlarmService:v50])
                    {
                      ...
                      if (os_log_type_enabled(v53, OS_LOG_TYPE_DEBUG))
                      {
                        ...
                        *buf = 138543874;
                        ...
                        v106 = 2112;
                        v107 = serviceType2;
                        _os_log_impl(&dword_2531F8000, v53, OS_LOG_TYPE_DEBUG, "%{public}@Service %@ with type %@ contains an alarm system, adding it to association", buf, 0x20u);
        ...
        if (os_log_type_enabled(v59, OS_LOG_TYPE_DEBUG))
        {
          ...
          *buf = 138543618;
          ...
          v104 = 2112;
          v105 = v67;
          _os_log_impl(&dword_2531F8000, v59, OS_LOG_TYPE_DEBUG, "%{public}@Configuring with camera notification services: %@", buf, 0x16u);
        }
      ...
      else
      {
        ...
        if (os_log_type_enabled(v23, OS_LOG_TYPE_INFO))
        {
          ...
          *buf = 138543362;
          v103 = v24;
          _os_log_impl(&dword_2531F8000, v23, OS_LOG_TYPE_INFO, "%{public}@No accessory, bailing out", buf, 0xCu);
        }
    ...
    else
    {
      ...
      if (os_log_type_enabled(v18, OS_LOG_TYPE_INFO))
      {
        ...
        *buf = 138543362;
        v103 = v19;
        _os_log_impl(&dword_2531F8000, v18, OS_LOG_TYPE_INFO, "%{public}@No home, bailing out", buf, 0xCu);
      }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
    {
      ...
      *buf = 138543362;
      v103 = v14;
      _os_log_impl(&dword_2531F8000, v13, OS_LOG_TYPE_INFO, "%{public}@No room, bailing out", buf, 0xCu);
    }
...
- (void)configureBulletinNotification
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_ERROR))
    {
      ...
      v11 = 138543362;
      v12 = v9;
      _os_log_impl(&dword_2531F8000, v8, OS_LOG_TYPE_ERROR, "%{public}@configureBulletinNotification called before configure", &v11, 0xCu);
    }
...
- (void)_handleBulletinBoardNotificationServiceGroupRequest:(id)request
{
  ...
  if (responseHandler)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      _os_log_impl(&dword_2531F8000, v9, OS_LOG_TYPE_INFO, "%{public}@Responding to a request for notification service group with payload %@", &v13, 0x16u);
    }
...
+ (id)logCategory
{
  ...
  {
    dispatch_once(&logCategory__hmf_once_t24, &__block_literal_global_9506);
  }
