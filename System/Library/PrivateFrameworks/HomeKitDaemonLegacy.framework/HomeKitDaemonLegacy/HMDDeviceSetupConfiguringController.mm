...
- (HMDDeviceSetupConfiguringController)initWithDiagnosticInfoControllerInternal:(id)internal
{
  ...
  v8 = [(HMDDeviceSetupConfiguringController *)self initWithQueue:v7 rpCompanionLinkClientFactory:&__block_literal_global_119429 diagnosticInfoController:internalCopy];
