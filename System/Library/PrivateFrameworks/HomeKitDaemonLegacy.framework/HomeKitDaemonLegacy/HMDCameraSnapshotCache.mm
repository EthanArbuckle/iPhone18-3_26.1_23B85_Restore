...
- (void)requestSnapshot:(id)a3 streamingTierType:(unint64_t)a4 completionHandler:(id)a5
{
  ...
  if (!v12)
  {
    ...
    if (os_log_type_enabled(v22, OS_LOG_TYPE_INFO))
    {
      ...
      v28 = 2112;
      v29 = v7;
      _os_log_impl(&dword_2531F8000, v22, OS_LOG_TYPE_INFO, "%{public}@Did not find the snapshot cache file for %@", &v26, 0x16u);
    }
  ...
  if (v13)
  {
    if (v17)
    {
      ...
      v28 = 2112;
      v29 = v7;
      _os_log_impl(&dword_2531F8000, v16, OS_LOG_TYPE_INFO, "%{public}@Found the snapshot cache file for %@", &v26, 0x16u);
    }
...
LABEL_11:
  ...
  if (v17)
  {
    ...
    v26 = 138543362;
    v27 = v24;
    _os_log_impl(&dword_2531F8000, v16, OS_LOG_TYPE_INFO, "%{public}@Found the snapshot cache file placeholder, saving the completion handler", &v26, 0xCu);
  }
...
- (void)setSnapshotFile:(id)a3 forEntryWithCharacteristicEventUUID:(id)a4
{
  ...
  if (v10)
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
    {
      ...
      v30 = 2112;
      v31 = v6;
      _os_log_impl(&dword_2531F8000, v13, OS_LOG_TYPE_INFO, "%{public}@Snapshot request completion is already set for %@, calling completion with %@", &v26, 0x20u);
    }
  ...
  if (os_log_type_enabled(v22, OS_LOG_TYPE_INFO))
  {
    ...
    v30 = 2112;
    v31 = v7;
    _os_log_impl(&dword_2531F8000, v22, OS_LOG_TYPE_INFO, "%{public}@Setting Cache Entry %@ for snapshotCharacteristicEventUUID: %@", &v26, 0x20u);
  }
...
- (void)removeEntryWithCharacteristicEventUUID:(id)a3 error:(id)a4
{
  ...
  if (v10)
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
    {
      ...
      v26 = 2112;
      v27 = v7;
      _os_log_impl(&dword_2531F8000, v13, OS_LOG_TYPE_INFO, "%{public}@Snapshot request completion is already set for %@, calling completion with error %@", &v22, 0x20u);
    }
  ...
  if (os_log_type_enabled(v18, OS_LOG_TYPE_INFO))
  {
    ...
    v24 = 2112;
    v25 = v6;
    _os_log_impl(&dword_2531F8000, v18, OS_LOG_TYPE_INFO, "%{public}@Removing Cache Entry for snapshotCharacteristicEventUUID: %@", &v22, 0x16u);
  }
...
- (void)addEntryWithCharacteristicEventUUID:(id)a3
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    v17 = 2112;
    v18 = v4;
    _os_log_impl(&dword_2531F8000, v9, OS_LOG_TYPE_INFO, "%{public}@Added Cache Entry %@ for snapshotCharacteristicEventUUID: %@", &v13, 0x20u);
  }
...
uint64_t __37__HMDCameraSnapshotCache_logCategory__block_invoke()
{
  ...
  v2 = logCategory__hmf_once_v9_178734;
  logCategory__hmf_once_v9_178734 = v1;
