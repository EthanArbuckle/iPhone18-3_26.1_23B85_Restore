...
- (void)submitMultiUserSettingsDailyEvent
{
  ...
  if (v3)
  {
    if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
    {
      ...
      v22 = 138543362;
      v23 = v8;
      _os_log_impl(&dword_2531F8000, v7, OS_LOG_TYPE_INFO, "%{public}@Submitting multi user settings daily event", &v22, 0xCu);
    }
...
LABEL_14:
    ...
    if (os_log_type_enabled(v18, OS_LOG_TYPE_INFO))
    {
      ...
      v24 = 2112;
      v25 = v20;
      _os_log_impl(&dword_2531F8000, v18, OS_LOG_TYPE_INFO, "%{public}@numSharedUsers is %@. Don't submit logs", &v22, 0x16u);
    }
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
  {
    ...
    v22 = 138543362;
    v23 = v15;
    _os_log_impl(&dword_2531F8000, v7, OS_LOG_TYPE_ERROR, "%{public}@No DataSource is set for submitMultiUserSettingsDailyEvent", &v22, 0xCu);
  }
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t3_25149 != -1)
  {
    dispatch_once(&logCategory__hmf_once_t3_25149, &__block_literal_global_25150);
  }

  v3 = logCategory__hmf_once_v4_25151;
...
uint64_t __57__HMDMultiUserSettingsMetricsEventDispatcher_logCategory__block_invoke()
{
  ...
  v2 = logCategory__hmf_once_v4_25151;
  logCategory__hmf_once_v4_25151 = v1;
