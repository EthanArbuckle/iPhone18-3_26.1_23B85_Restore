...
{
  v41 = a3;
  v4 = [v41 hmd_isForXPCTransport];
  v5 = [v41 hmd_isForXPCTransportEntitledForSPIAccess];
  v6 = +[HMDHAPMetadata getSharedInstance];
  v7 = [(HMDCharacteristic *)self service];
  v8 = [(HMDCharacteristic *)self accessory];
  v9 = v8;
  if ([v41 hmd_isForXPCTransport])
  {
    v9 = accessoryToEncodeForXPCTransportForAccessory(v8);
  }

  [v41 encodeConditionalObject:v7 forKey:*MEMORY[0x277CD2580]];
  v10 = [(HMDCharacteristic *)self characteristicInstanceID];
  [v41 encodeObject:v10 forKey:*MEMORY[0x277CD2138]];

  v11 = [(HMDCharacteristic *)self characteristicType];
  [v41 encodeObject:v11 forKey:*MEMORY[0x277CD21A8]];
  ...
  [v41 encodeInt32:v13 forKey:*MEMORY[0x277CD2190]];
  if (([v41 hmd_isForRemoteGatewayCoder] & 1) == 0)
  {
    v17 = [(HMDCharacteristic *)self metadata];
    [v41 encodeObject:v17 forKey:*MEMORY[0x277CD2148]];

    v18 = [v41 hmd_isForLocalStore];
    ...
    else if (([v41 hmd_isForRemoteTransportOnSameAccount] & 1) == 0)
    {
LABEL_17:
      if (!v18)
      {
      ...
      v20 = [(HMDCharacteristic *)self notificationRegistrations];
      v21 = [v20 na_map:&__block_literal_global_133_77144];

      if ([v21 count])
      {
        [v41 encodeObject:v21 forKey:*MEMORY[0x277CD2178]];
      }

      v22 = [(HMDCharacteristic *)self value];
      if (v13)
      {
        v23 = [(HMDCharacteristic *)self type];
        if (![v6 isStandardCharacteristicType:v23] || !v22 || !isAllowedCharType())
        {
          goto LABEL_26;
        }
        ...
        if (v24)
        {
          v25 = [(HMDCharacteristic *)self value];
          [v41 encodeObject:v25 forKey:*MEMORY[0x277CD21B0]];

          v23 = [(HMDCharacteristic *)self stateNumber];
          [v41 encodeObject:v23 forKey:*MEMORY[0x277CD21C8]];
LABEL_26:
        }
      }

      [v41 encodeBool:-[HMDCharacteristic broadcastNotificationEnabled](self forKey:{"broadcastNotificationEnabled"), @"characteristicBroadcastNotificationEnabled"}];
...
LABEL_28:
      ...
      v28 = [v7 type];
      v29 = [v26 requiresDeviceUnlock:v27 forService:v28];

      v30 = [(HMDCharacteristic *)self notificationRegistrations];
      v31 = [v30 count] != 0;

      [v41 encodeBool:v31 forKey:*MEMORY[0x277CD2170]];
      if (v5)
      {
        v32 = 1;
      }
      ...
      else
      {
        v33 = [v41 hmd_message];
        v34 = [v8 vendorInfo];
        v32 = [v33 isEntitledForVendorAccessForAccessoryWithVendorInfo:v34];
      }

      v35 = [(HMDCharacteristic *)self fixedValueFromAccessoryIncludeSerialNumber:v32];
      if (v35)
      {
        [v41 encodeBool:1 forKey:*MEMORY[0x277CD2130]];
        v36 = v35;
      }
      ...
      else
      {
        ...
        {
LABEL_39:
          if ([v41 hmd_isForXPCTransportEntitledForSPIAccess])
          {
            if (v29)
            {
              [v41 encodeBool:1 forKey:@"HM.requiresDeviceUnlock"];
            }

            v37 = [(HMDCharacteristic *)self authorizationData];
            v38 = [v37 length] != 0;
            [v41 encodeBool:v38 forKey:*MEMORY[0x277CD2108]];

            v39 = [(HMDCharacteristic *)self lastKnownValueUpdateTime];
            [v41 encodeObject:v39 forKey:*MEMORY[0x277CD21D8]];

            v40 = [(HMDCharacteristic *)self notificationEnabledTime];
            [v41 encodeObject:v40 forKey:*MEMORY[0x277CD2160]];
          }
      ...
      if (isAllowedCharType() && ((isAppleTV() & v29) != 1 || [v41 hmd_isForXPCTransportEntitledForSPIAccess]))
      {
        [v41 encodeObject:v36 forKey:*MEMORY[0x277CD21B0]];
      }

      goto LABEL_39;
    }

    [v41 encodeObject:self->_authorizationData forKey:*MEMORY[0x277CD2100]];
    goto LABEL_17;
  }
...
- (id)_initWithCoder:(id)a3
{
  ...
  if (v5)
  {
    ...
    v5->_characteristicProperties = [v4 decodeInt32ForKey:*MEMORY[0x277CD2190]];
    ...
    {
      v25 = [v4 decodeObjectOfClass:objc_opt_class() forKey:v24];
...
{
  v2 = [(HMDCharacteristic *)self notificationRegistrations];
  v3 = [v2 na_map:&__block_literal_global_123];
  v4 = [v3 allObjects];
...
{
  v2 = [(HMDCharacteristic *)self notificationRegistrations];
  v3 = [v2 na_any:&__block_literal_global_118_77171];
...
{
  v2 = [(HMDCharacteristic *)self notificationRegistrations];
  v3 = [v2 na_any:&__block_literal_global_116_77173];
...
{
  v2 = [(HMDCharacteristic *)self notificationRegistrations];
  v3 = [v2 na_any:&__block_literal_global_114_77175];
...
- (void)setStateNumber:(id)a3
{
  ...
  {
    v7 = v5;
    v5 = [(HMDCharacteristic *)self properties];
    v6 = v7;
    if (v5)
    {
      os_unfair_lock_lock_with_options();
...
- (BOOL)updateWithDictionary:(id)a3
{
  ...
  v18 = [v4 hmf_dictionaryForKey:*MEMORY[0x277CD2148]];
  if (v18)
  {
