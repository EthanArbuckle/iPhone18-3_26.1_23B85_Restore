  ...
  if (self)
  {
    ...
    else
    {
      if (v11)
      {
        ...
        v21 = 138543362;
        v22 = v19;
        _os_log_impl(&dword_2531F8000, v10, OS_LOG_TYPE_INFO, "%{public}@Nil database adapter (_handleModelDeletion)", &v21, 0xCu);
      }
...
LABEL_50:
  ...
  if (!v54)
  {
    ...
    if (os_log_type_enabled(v34, OS_LOG_TYPE_INFO))
    {
      ...
      *v74 = 138543362;
      v75 = v35;
      _os_log_impl(&dword_2531F8000, v34, OS_LOG_TYPE_INFO, "%{public}@Nil database (_updateSettingsForKeyPaths)", v74, 0xCu);
    }
...
void __90__HMDCompositeSettingsController__updateSettingForKeyPath_value_callerVersion_completion___block_invoke_82(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    v16 = 2112;
    v17 = v9;
    _os_log_impl(&dword_2531F8000, v6, OS_LOG_TYPE_INFO, "%{public}@updating setting:%@, error:%@", &v12, 0x20u);
  }
...
- (void)_createSettingsFromModel:(id)a3
{
  ...
  if (v56)
  {
    ...
    if (os_log_type_enabled(v24, OS_LOG_TYPE_INFO))
    {
      ...
      *&v59[12] = 2112;
      *&v59[14] = v21;
      _os_log_impl(&dword_2531F8000, v24, OS_LOG_TYPE_INFO, "%{public}@Updated Settings %@", v59, 0x16u);
    }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v44, OS_LOG_TYPE_INFO))
    {
      ...
      *v59 = 138543362;
      *&v59[4] = v45;
      _os_log_impl(&dword_2531F8000, v44, OS_LOG_TYPE_INFO, "%{public}@Nil database (_createSettingsFromModel)", v59, 0xCu);
    }
...
void __62__HMDCompositeSettingsController_filteredSettingsForSettings___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (v4)
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
    {
      ...
      v12 = 2112;
      v13 = v3;
      _os_log_impl(&dword_2531F8000, v7, OS_LOG_TYPE_INFO, "%{public}@Filtering setting with blocked key path: %@", &v10, 0x16u);
    }
...
uint64_t __45__HMDCompositeSettingsController_logCategory__block_invoke()
{
  ...
  v2 = logCategory__hmf_once_v14_82167;
  logCategory__hmf_once_v14_82167 = v1;
