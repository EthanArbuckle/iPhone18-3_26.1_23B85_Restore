...
- (void)triggerThrottledMicroLocationLocalizationScanWithMetadata:(id)a3 triggerType:(unint64_t)a4
{
  ...
  if (a4 >= 3)
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
    {
      ...
      v36 = 2112;
      v37 = v12;
      _os_log_impl(&dword_2531F8000, v10, OS_LOG_TYPE_ERROR, "%{public}@Invalid HMDMicroLocationScanTriggerType: %@ for Localization Scan", &v34, 0x16u);
    }
  ...
  else
  {
    ...
    if (v20 >= 2.22044605e-16)
    {
      ...
      if (os_log_type_enabled(v23, OS_LOG_TYPE_INFO))
      {
        ...
        v25 = off_279735028[a4];
        v34 = 138543618;
        v35 = v24;
        v36 = 2112;
        v37 = v25;
        _os_log_impl(&dword_2531F8000, v23, OS_LOG_TYPE_INFO, "%{public}@Skipping microlocation localization scan for event: %@, throttling in effect", &v34, 0x16u);
      }
  ...
  if (os_log_type_enabled(v29, OS_LOG_TYPE_INFO))
  {
    ...
    v31 = off_279735028[a4];
    v34 = 138543618;
    v35 = v30;
    v36 = 2112;
    v37 = v31;
    _os_log_impl(&dword_2531F8000, v29, OS_LOG_TYPE_INFO, "%{public}@Performing microlocation localization scan for event: %@", &v34, 0x16u);
  }
...
- (void)triggerThrottledMicroLocationRecordingScanWithMetadata:(id)a3 triggerType:(unint64_t)a4
{
  ...
  if (a4 >= 3)
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
    {
      ...
      v36 = 2112;
      v37 = v12;
      _os_log_impl(&dword_2531F8000, v10, OS_LOG_TYPE_ERROR, "%{public}@Invalid HMDMicroLocationScanTriggerType: %@ for Recording Scan", &v34, 0x16u);
    }
  ...
  else
  {
    ...
    if (v20 >= 2.22044605e-16)
    {
      ...
      if (os_log_type_enabled(v23, OS_LOG_TYPE_INFO))
      {
        ...
        v36 = 2112;
        v37 = v25;
        _os_log_impl(&dword_2531F8000, v23, OS_LOG_TYPE_INFO, "%{public}@Skipping microlocation recording scan for event type: %@, throttling in effect", &v34, 0x16u);
      }
  ...
  if (os_log_type_enabled(v29, OS_LOG_TYPE_INFO))
  {
    ...
    v36 = 2112;
    v37 = v31;
    _os_log_impl(&dword_2531F8000, v29, OS_LOG_TYPE_INFO, "%{public}@Performing microlocation recording scan for event: %@", &v34, 0x16u);
  }
...
uint64_t __38__HMDMicroLocationManager_logCategory__block_invoke()
{
  ...
  v2 = logCategory__hmf_once_v9_188878;
  logCategory__hmf_once_v9_188878 = v1;
