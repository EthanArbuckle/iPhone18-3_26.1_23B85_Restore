...
- (BOOL)_compareEventValue:(id)value
{
  ...
  if (eventValue)
  {
    characteristic = [(HMDCharacteristicEventBase *)self characteristic];
    eventValue2 = [(HMDCharacteristicEvent *)self eventValue];
    v8 = [HMDCharacteristicEventBase compareValueOfCharacteristic:characteristic againstValue:eventValue2 operatorType:&unk_286629CB0];
...
- (BOOL)_evaluateNewValue:(id)value
{
  ...
  if (valueCopy && [(HMDCharacteristicEvent *)self _compareEventValue:valueCopy])
  {
    ...
    {
      characteristic = [(HMDCharacteristicEventBase *)self characteristic];
      v7 = [HMDCharacteristicEventBase compareValueOfCharacteristic:characteristic againstValue:previousValue operatorType:&unk_286629C98];
