...
- (id)newUploader
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_ERROR))
    {
      ...
      _os_log_impl(&dword_2531F8000, v7, OS_LOG_TYPE_ERROR, "%{public}@%s: Matter Accessory Software Update not enabled.", &v10, 0x16u);
    }
...
- (BOOL)sendMessageToAccessory:(id)a3 uarpMsg:(id)a4 error:(id *)a5
{
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
  {
    ...
    v15 = 138543362;
    v16 = v12;
    _os_log_impl(&dword_2531F8000, v11, OS_LOG_TYPE_ERROR, "%{public}@sendMessageToAccessory: failed. This function should not be called for Matter accessories", &v15, 0xCu);
  }
...
uint64_t __46__HMDMatterUARPControllerDelegate_logCategory__block_invoke()
{
  ...
  v2 = logCategory__hmf_once_v1_111166;
  logCategory__hmf_once_v1_111166 = v1;
