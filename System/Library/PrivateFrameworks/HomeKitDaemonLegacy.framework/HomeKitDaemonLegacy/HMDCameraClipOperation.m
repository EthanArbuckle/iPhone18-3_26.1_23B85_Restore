...
- (id)updateClipModel:(id)a3
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
    {
      ...
      v23 = 2112;
      v24 = v16;
      _os_log_impl(&dword_2531F8000, v14, OS_LOG_TYPE_ERROR, "%{public}@Aborting save of clip model because no video streaming asset was found: %@", &v21, 0x16u);
    }
...
uint64_t __37__HMDCameraClipOperation_logCategory__block_invoke()
{
  ...
  v2 = logCategory__hmf_once_v5_32419;
  logCategory__hmf_once_v5_32419 = v1;
