...
LABEL_32:
      ...
      else
      {
        ...
        if (os_log_type_enabled(v69, OS_LOG_TYPE_ERROR))
        {
          ...
          *v87 = 138543618;
          ...
          v89 = 2048;
          v90 = 32;
          _os_log_impl(&dword_2531F8000, v69, OS_LOG_TYPE_ERROR, "%{public}@Failed to allocate %lu bytes to hold digest", v87, 0x16u);
        }
    ...
    if (os_log_type_enabled(v63, OS_LOG_TYPE_ERROR))
    {
      ...
      *v87 = 138543874;
      ...
      v91 = 2112;
      v92 = v66;
      _os_log_impl(&dword_2531F8000, v63, OS_LOG_TYPE_ERROR, "%{public}@Error reading data from record %@: %@", v87, 0x20u);
...
LABEL_45:
  ...
  if (os_log_type_enabled(v55, OS_LOG_TYPE_ERROR))
  {
    ...
    *v87 = 138543874;
    ...
    v91 = 2112;
    v92 = v58;
    _os_log_impl(&dword_2531F8000, v55, OS_LOG_TYPE_ERROR, "%{public}@Data size is bigger than maximum %ld bytes on record %@", v87, 0x20u);
...
- (BOOL)__canRecoverFromError:(id)a3 fetchInfo:(id)a4
{
  ...
  if ([v6 hmbIsCKPartialFailureError])
  {
    ...
    *&buf[8] = buf;
    *&buf[16] = 0x3032000000;
    v35 = __Block_byref_object_copy__142630;
    v36 = __Block_byref_object_dispose__142631;
    v37 = 0;
    v8 = [v6 userInfo];
  ...
  switch(v15)
  {
    case 21:
      ...
      if (os_log_type_enabled(v29, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *&buf[12] = 2112;
        *&buf[14] = v6;
        _os_log_impl(&dword_2531F8000, v29, OS_LOG_TYPE_DEFAULT, "%{public}@Change token has expired: %@", buf, 0x16u);
      }
    ...
    case 28:
      ...
      if (os_log_type_enabled(v24, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *&buf[12] = 2112;
        *&buf[14] = v6;
        _os_log_impl(&dword_2531F8000, v24, OS_LOG_TYPE_DEFAULT, "%{public}@Zone was deleted: %@", buf, 0x16u);
      }
    ...
    case 26:
      ...
      if (os_log_type_enabled(v19, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *&buf[12] = 2112;
        *&buf[14] = v6;
        _os_log_impl(&dword_2531F8000, v19, OS_LOG_TYPE_DEFAULT, "%{public}@Zone does not exist: %@", buf, 0x16u);
      }
    ...
    if ((v4 & 1) == 0)
    {
      ...
      if (os_log_type_enabled(v10, OS_LOG_TYPE_FAULT))
      {
        ...
        *buf = 138543618;
        ...
        v19 = 2112;
        v20 = v12;
        _os_log_impl(&dword_2531F8000, v10, OS_LOG_TYPE_FAULT, "%{public}@Submitting ABC event for failure: recordZoneFetchCompletionBlock called with unknown zone: %@", buf, 0x16u);
      }
    ...
    if ((v4 & 1) == 0)
    {
      ...
      if (os_log_type_enabled(v10, OS_LOG_TYPE_FAULT))
      {
        ...
        *buf = 138543618;
        ...
        v19 = 2112;
        v20 = v12;
        _os_log_impl(&dword_2531F8000, v10, OS_LOG_TYPE_FAULT, "%{public}@Submitting ABC event for failure: recordZoneChangeTokensUpdatedBlock called with unknown zone: %@", buf, 0x16u);
      }
...
- (HMDNetworkRouterFirewallRuleCloudZone)initWithCloudDatabase:(id)a3 state:(id)a4 useAnonymousRequests:(BOOL)a5 watchedRecordIDs:(id)a6 signatureVerificationPublicKeys:(id)a7
{
  ...
  if (![v15 count])
  {
    ...
    if (os_log_type_enabled(v22, OS_LOG_TYPE_FAULT))
    {
      ...
      *buf = 138543362;
      v29 = v25;
      _os_log_impl(&dword_2531F8000, v22, OS_LOG_TYPE_FAULT, "%{public}@Submitting ABC event for failure: Must have verification keys", buf, 0xCu);
    }
