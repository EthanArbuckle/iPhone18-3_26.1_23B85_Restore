  ...
  if (v11)
  {
    ...
    if (v12)
    {
      ...
      if (v17)
      {
        ...
        v22 = [(HMDCameraClipImporter *)v19 initWithLocalZone:v20 cameraProfileUUID:v21];
...
- (void)configure
{
  ...
  if (v5)
  {
    ...
    v46 = [HMDUserMessagePolicy userMessagePolicyWithHome:v5 userPrivilege:3 remoteAccessRequired:0];
    v53[0] = v7;
    v53[1] = v8;
    v41 = v8;
    ...
    v30 = [(HMDCameraClipManager *)self zoneManager];
    ...
    v35 = [(HMDCameraClipManager *)self clientConnectionsTimer];
...
- (NSDictionary)stateDump
{
  ...
  v4 = [v3 na_map:&__block_literal_global_145489];
  v9[0] = v4;
