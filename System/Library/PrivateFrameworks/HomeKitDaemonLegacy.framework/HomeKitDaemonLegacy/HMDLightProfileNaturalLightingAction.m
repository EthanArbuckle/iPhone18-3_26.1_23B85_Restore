  ...
  if (v12)
  {
    ...
    if (v15)
    {
      ...
      if (v16)
      {
        v17 = v9;
        v40 = [v15 home];
        v18 = [v40 lightProfileWithUUID:v16];
        ...
        if (v18)
        {
          ...
          v24 = [v12 uuid];
          v25 = -[HMDLightProfileNaturalLightingAction initWithUUID:lightProfileUUID:naturalLightingEnabled:actionSet:](v20, "initWithUUID:lightProfileUUID:naturalLightingEnabled:actionSet:", v24, v16, [v12 isNaturalLightingEnabled], v15);
