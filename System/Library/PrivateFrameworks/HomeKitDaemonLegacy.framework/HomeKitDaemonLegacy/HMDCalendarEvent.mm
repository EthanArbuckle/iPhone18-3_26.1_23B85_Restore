...
- (id)_nextTimerDateAfterDate:(id)date timeZone:(id)zone
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    v28 = 2112;
    v29 = recurrences;
    _os_log_impl(&dword_2531F8000, v10, OS_LOG_TYPE_INFO, "%{public}@Determining next fire date after date %@ using components: %@ recurrence: %@", &v22, 0x2Au);
  }
...
uint64_t __31__HMDCalendarEvent_logCategory__block_invoke()
{
  ...
  logCategory__hmf_once_v1_9897 = HMFCreateOSLogHandle();
