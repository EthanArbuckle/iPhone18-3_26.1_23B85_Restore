...
- (void)_invalidateDestinationDeviceWithIDSIdentifier:(id)a3
{
  ...
  if (v8)
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
    {
      ...
      v18 = 2114;
      v19 = v4;
      _os_log_impl(&dword_2531F8000, v11, OS_LOG_TYPE_INFO, "%{public}@Invalidating Rapport client for device: %{public}@", &v16, 0x16u);
    }
...
- (id)_createRapportClientForDevice:(id)a3
{
  ...
  v22[1] = 3221225472;
  v22[2] = __53__HMDRapportMessaging__createRapportClientForDevice___block_invoke_121;
  v22[3] = &unk_279732E78;
...
void __53__HMDRapportMessaging__createRapportClientForDevice___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    v12 = 2114;
    v13 = v7;
    _os_log_impl(&dword_2531F8000, v5, OS_LOG_TYPE_INFO, "%{public}@Rapport client disconnected for device: %{public}@", &v10, 0x16u);
  }
...
void __53__HMDRapportMessaging__createRapportClientForDevice___block_invoke_2(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    v11 = 2114;
    v12 = v7;
    _os_log_impl(&dword_2531F8000, v5, OS_LOG_TYPE_INFO, "%{public}@Rapport client invalidated for device: %{public}@", &v9, 0x16u);
  }
...
void __58__HMDRapportMessaging__clientForIDSIdentifier_withDevice___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (v3)
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
    {
      ...
      v14 = 2112;
      v15 = v3;
      _os_log_impl(&dword_2531F8000, v6, OS_LOG_TYPE_ERROR, "%{public}@Failed to activate Rapport client for device: %@, error: %@", &v10, 0x20u);
    }
  ...
  if (!v5)
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_FAULT))
    {
      ...
      *buf = 138543618;
      ...
      v23 = 2112;
      v24 = v18;
      _os_log_impl(&dword_2531F8000, v16, OS_LOG_TYPE_FAULT, "%{public}@Submitting ABC event for failure: %@ Request handler is nil", buf, 0x16u);
    }
...
- (void)_configureDiscoveryClientWithCompletion:(id)a3 forRequestIDs:(id)a4
{
  ...
  v72[1] = 3221225472;
  v72[2] = __77__HMDRapportMessaging__configureDiscoveryClientWithCompletion_forRequestIDs___block_invoke_97;
  v72[3] = &unk_279732FD8;
  ...
  v70[1] = 3221225472;
  v70[2] = __77__HMDRapportMessaging__configureDiscoveryClientWithCompletion_forRequestIDs___block_invoke_98;
  v70[3] = &unk_27972FEB8;
  ...
  v68[1] = 3221225472;
  v68[2] = __77__HMDRapportMessaging__configureDiscoveryClientWithCompletion_forRequestIDs___block_invoke_100;
  v68[3] = &unk_27972FEB8;
  ...
  v66[1] = 3221225472;
  v66[2] = __77__HMDRapportMessaging__configureDiscoveryClientWithCompletion_forRequestIDs___block_invoke_101;
  v66[3] = &unk_27972FEE0;
  ...
  v64[1] = 3221225472;
  v64[2] = __77__HMDRapportMessaging__configureDiscoveryClientWithCompletion_forRequestIDs___block_invoke_103;
  v64[3] = &unk_279732FD8;
...
void __77__HMDRapportMessaging__configureDiscoveryClientWithCompletion_forRequestIDs___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    v7 = 138543362;
    v8 = v5;
    _os_log_impl(&dword_2531F8000, v4, OS_LOG_TYPE_INFO, "%{public}@Discovery client interrupted", &v7, 0xCu);
  }
...
void __77__HMDRapportMessaging__configureDiscoveryClientWithCompletion_forRequestIDs___block_invoke_97(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    v7 = 138543362;
    v8 = v5;
    _os_log_impl(&dword_2531F8000, v4, OS_LOG_TYPE_INFO, "%{public}@Discovery client invalidated", &v7, 0xCu);
  }
...
void __77__HMDRapportMessaging__configureDiscoveryClientWithCompletion_forRequestIDs___block_invoke_98(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v13 = 2112;
    v14 = v3;
    _os_log_impl(&dword_2531F8000, v7, OS_LOG_TYPE_INFO, "%{public}@Discovery client lost device: %@", &v11, 0x16u);
  }
...
void __77__HMDRapportMessaging__configureDiscoveryClientWithCompletion_forRequestIDs___block_invoke_100(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v12 = 2112;
    v13 = v3;
    _os_log_impl(&dword_2531F8000, v7, OS_LOG_TYPE_INFO, "%{public}@Discovery client found device: %@", &v10, 0x16u);
  }
...
void __77__HMDRapportMessaging__configureDiscoveryClientWithCompletion_forRequestIDs___block_invoke_101(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v12 = 2112;
    v13 = v3;
    _os_log_impl(&dword_2531F8000, v7, OS_LOG_TYPE_INFO, "%{public}@Discovery client device changed: %@", &v10, 0x16u);
  }
...
void __77__HMDRapportMessaging__configureDiscoveryClientWithCompletion_forRequestIDs___block_invoke_2(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_DEFAULT))
  {
    ...
    v13 = 2112;
    v14 = v3;
    _os_log_impl(&dword_2531F8000, v7, OS_LOG_TYPE_DEFAULT, "%{public}@Activated Rapport client with error: %@", &v11, 0x16u);
  }
...
uint64_t __34__HMDRapportMessaging_logCategory__block_invoke()
{
  ...
  v2 = logCategory__hmf_once_v17_157062;
  logCategory__hmf_once_v17_157062 = v1;
