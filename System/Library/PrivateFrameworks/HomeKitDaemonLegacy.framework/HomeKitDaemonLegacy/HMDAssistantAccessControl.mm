  ...
  if (v6)
  {
    ...
    if ([coderCopy containsValueForKey:*MEMORY[0x277CCF258]])
    {
      ...
      if ([v18 count])
      {
        ...
        v20 = [v18 na_map:&__block_literal_global_83_180367];
...
- (void)transactionObjectUpdated:(id)updated newValues:(id)values message:(id)message
{
  ...
  if (v13)
  {
    ...
    if ([v15 propertyWasSet:@"siriEndpointAccessoryModelUUIDs"])
    {
      ...
      if (selfCopy)
      {
        v46 = [v44 na_map:&__block_literal_global_51_180384];
      }
...
- (HMDAssistantAccessControlModel)model
{
  ...
  v9 = [_hapAccessoryIdentifiers na_map:&__block_literal_global_65_180425];
...
- (void)_populateModel:(void *)model withAccessoryIdsFromAccessories:
{
  ...
  {
    v4 = a2;
    v6 = [model na_map:&__block_literal_global_48_180427];
...
{
  v2 = [*(a1 + 32) transactionWithObjectChangeType:2];
  v3 = [(HMDAssistantAccessControl *)*(a1 + 32) _appleMediaAccessories];
  v4 = [v3 mutableCopy];

  [v4 removeObjectsInArray:*(a1 + 40)];
  [(HMDAssistantAccessControl *)*(a1 + 32) _populateModel:v2 withAccessoryIdsFromAccessories:v4];
  v5 = [(HMDAssistantAccessControl *)*(a1 + 32) _hapAccessoryIdentifiers];
  v6 = [v5 mutableCopy];
...
- (NSArray)accessories
{
  ...
  if ([allObjects count])
  {
    v6 = __accessoriesWithModelIDs(self, allObjects);
  ...
  v8 = [allObjects2 arrayByAddingObjectsFromArray:array];
...
- (void)configure
{
  ...
  if (user && home)
  {
    ...
    [defaultCenter2 addObserver:self selector:sel_handleRemovedAccessory_ name:@"HMDHomeAccessoryRemovedNotification" object:home];
  }
}
...
+ (id)logCategory
{
  ...
  {
    dispatch_once(&logCategory__hmf_once_t62, &__block_literal_global_68_180475);
  }
...
+ (id)modelIDNamespace
{
  if (modelIDNamespace_onceToken_180480 != -1)
  {
    dispatch_once(&modelIDNamespace_onceToken_180480, &__block_literal_global_62_180481);
  }

  v3 = modelIDNamespace_modelIDNamespace_180482;
...
uint64_t __45__HMDAssistantAccessControl_modelIDNamespace__block_invoke()
{
  ...
  v1 = modelIDNamespace_modelIDNamespace_180482;
  modelIDNamespace_modelIDNamespace_180482 = v0;
