  ...
  if (IsLocalOrigin)
  {
    ...
    if (v7)
    {
      ...
      if (v11)
      {
        ...
        v29 = [v5 state];
        v28 = [v17 numberWithInteger:{objc_msgSend(v29, "playbackState")}];
        v33[1] = v28;
        v32[2] = *MEMORY[0x277CD0990];
        v18 = MEMORY[0x277CCABB0];
        v19 = [v5 state];
        v20 = [v18 numberWithInteger:{objc_msgSend(v19, "shuffleState")}];
        v33[2] = v20;
        v32[3] = *MEMORY[0x277CD0960];
        v21 = MEMORY[0x277CCABB0];
        v22 = [v5 state];
        v23 = [v21 numberWithInteger:{objc_msgSend(v22, "repeatState")}];
...
- (void)_sessionPlaybackStateUpdated:(id)a3 notifyXPCClients:(BOOL)a4
{
  ...
  v154 = v12;
  v143 = [(HMDMediaProfile *)v8 mediaSession];
  v13 = [v143 state];
  ...
  else
  {
    ...
    v13 = [v149 mediaSessionStateWithIdentifier:v16];
    v137 = v13 == 0;
    if (!v13)
    {
      v21 = v149;
  ...
  v150 = [(HMDMediaProfile *)v8 parseAndSetPlaybackStateFromResponsePayload:v5 mediaSessionState:v13 outDidUpdateMediaSessionState:&v154];
  v29 = v13;
  v30 = v29;
  ...
  if (v8)
  {
    ...
    v41 = v37;
    v42 = [v5 hmf_numberForKey:*v32];
    if (v42)
    {
      v43 = [(HMDMediaSessionState *)v41 volume];
      if (!v43)
      {
        goto LABEL_30;
      }
      ...
      [v42 floatValue];
      v46 = v45;
      v47 = [(HMDMediaSessionState *)v41 volume];
      [v47 floatValue];
...
LABEL_30:
  ...
  v55 = [v5 objectForKeyedSubscript:*MEMORY[0x277CD0968]];
  objc_opt_class();
  if (objc_opt_isKindOfClass())
  {
    v56 = v55;
  ...
  if (v58)
  {
    if (v8 && (v154 & 1) != 0)
    {
      ...
      v65 = [(HMDMediaProfile *)v61 notificationCenter];
      [v65 postNotificationName:@"HMDMediaProfileHasMediaSessionStateChangedNotificationName" object:v61 userInfo:v64];
    }
    ...
    if (a4 || v154 == 1)
    {
      if (v8)
      {
        ...
        v73 = [(HMDAccessoryProfile *)v61 uniqueIdentifier];
        v74 = [v72 initWithTarget:v73];
        [v71 setDestination:v74];

        v75 = [(HMDAccessoryProfile *)v61 msgDispatcher];
        v76 = [v71 copy];
        [v75 sendMessage:v76];
      }
      ...
      if (v78)
      {
        ...
        if (v145)
        {
          if (v79 && v149 && v8)
          {
            ...
            v81 = v144;
            v133 = [v80 alloc];
            v129 = [(HMDMediaSessionState *)v81 mediaUniqueIdentifier];
            v82 = [(HMDMediaSessionState *)v81 volume];
            [v82 doubleValue];
            v84 = v83;
            v85 = [(HMDMediaSessionState *)v81 playbackState];
            v86 = [(HMDMediaSessionState *)v81 shuffleState];
            v87 = [(HMDMediaSessionState *)v81 repeatState];

            v134 = [v133 initWithMediaIdentifier:v129 volume:v85 playbackState:v86 shuffleState:v87 repeatState:v84];
            [MEMORY[0x277CBEAA8] timeIntervalSinceReferenceDate];
            v89 = v88;
            v90 = objc_alloc(MEMORY[0x277D174B0]);
            v91 = [v141 uuid];
            v92 = [v91 UUIDString];
            v130 = [v90 initWithSource:v92 cachePolicy:2 combineType:2 timestamp:v89];

            v93 = objc_alloc(MEMORY[0x277D174A0]);
            v94 = [v134 protoData];
            v128 = [v93 initWithEventData:v94 metadata:v130];
            ...
            v99 = [v95 topicFromSuffixID:v96 homeUUID:v97 accessoryUUID:v98];

            v6 = v136;
            v100 = [(HMDMediaProfile *)v61 eventForwarder];
            [v100 forwardEvent:v128 topic:v99 completion:0];
          }
        }
      }
    }

    if (!v147 || ([v149 primaryResident], v101 = objc_claimAutoreleasedReturnValue(), objc_msgSend(v101, "device"), v102 = objc_claimAutoreleasedReturnValue(), v103 = objc_msgSend(v102, "isCurrentDevice"), v102, v101, v103))
    {
      v104 = v150;
      v142 = v153;
      v105 = v151;
      ...
      if (v8)
      {
        ...
        if (v104)
        {
          ...
          v110 = [HMDMediaPropertyResponse responseWithRequest:v109 value:v104 updatedTime:v107];
          [v106 addObject:v110];
        ...
        if (v142)
        {
          ...
          v112 = [HMDMediaPropertyResponse responseWithRequest:v111 value:v142 updatedTime:v107];
          [v106 addObject:v112];
        ...
        if (v105)
        {
          ...
          v114 = [HMDMediaPropertyResponse responseWithRequest:v113 value:v105 updatedTime:v107];
          [v106 addObject:v114];
        ...
        if (v139)
        {
          ...
          v116 = [HMDMediaPropertyResponse responseWithRequest:v115 value:v139 updatedTime:v107];
          [v106 addObject:v116];
        ...
        if (v131)
        {
          ...
          v119 = [HMDMediaPropertyResponse responseWithRequest:v118 value:v131 updatedTime:v107];
          [v106 addObject:v119];
        }
      ...
      {
        v123 = [v120 copy];
        [v149 notifyRemoteUsersOfChangedProperties:v123 requestMessageInformation:v147];
      }
...
- (id)payloadForUpdatedPlaybackState:(void *)a3 shuffleStateNumber:(void *)a4 repeatStateNumber:(void *)a5 volume:(void *)a6 mediaUniqueIdentifier:
{
  ...
  v19 = [v18 UUIDString];
  [v17 setValue:v19 forKey:*MEMORY[0x277CD09A8]];

  [v17 setValue:v16 forKey:*MEMORY[0x277CD0938]];
  [v17 setValue:v15 forKey:*MEMORY[0x277CD0990]];

  [v17 setValue:v14 forKey:*MEMORY[0x277CD0960]];
  [v17 setValue:v13 forKey:*MEMORY[0x277CD09B0]];

  [v17 setValue:v12 forKey:*MEMORY[0x277CD0920]];
  v20 = [v17 copy];
...
- (void)registerForMessages
{
  ...
  [v5 registerForMessage:*MEMORY[0x277CD0980] receiver:self policies:v8 selector:sel__handleSetPlayback_];
  [v5 registerForMessage:*MEMORY[0x277CD0950] receiver:self policies:v8 selector:sel__handleRefreshPlayback_];
  [v5 registerForMessage:*MEMORY[0x277CD0978] receiver:self policies:v8 selector:sel__handleMediaSessionSetAudioControl_];
