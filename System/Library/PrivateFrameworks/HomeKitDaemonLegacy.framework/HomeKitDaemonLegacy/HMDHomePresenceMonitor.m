...
- (void)_evaluatePresence:(id)a3 newUserPresence:(id)a4 presenceStatusUpdateReason:(id)a5
{
  ...
  v47 = a4;
  v9 = a5;
  v10 = [(HMDHomePresenceBase *)self home];
  [(HMDHomePresenceMonitor *)self _auditPresenceMap];
  v11 = [(HMDHomePresenceMonitor *)self presenceMap];
  ...
  v16 = [[HMDHomePresence alloc] initWithHome:v10 userPresenceMap:v11 lastUpdateByDevice:v8];
  v17 = [(HMDHomePresenceMonitor *)v13 currentHomePresence];

  v43 = v11;
  v44 = v10;
  if (v17)
  {
    v18 = [(HMDHomePresenceMonitor *)v13 currentHomePresence];
    v45 = HMFEqualObjects();
  }
  ...
  if ((v45 & 1) == 0)
  {
    ...
    v35 = [(HMDHomePresenceUpdate *)v33 initWithHomePresence:v34 userPresence:v47 update:v32 causingDevice:v8];
...
- (void)handleUserHomePresencePayload:(id)a3 device:(id)a4 user:(id)a5 completion:(id)a6
{
  ...
  if (v11)
  {
    ...
    v58 = [HMDUserPresenceRegion regionWithDict:v10];
    v57 = [HMDUserPresenceUpdateReason reasonWithDict:v10];
    ...
    v27 = [v11 uuid];
    v59 = [v26 objectForKeyedSubscript:v27];
    ...
    v53 = [(HMDUserPresence *)v50 initWithUser:v51 presenceRegionStatus:v58 timeStamp:v52 presenceUpdateReason:v57 device:v60];
    ...
    v65 = v60;
    v66 = v57;
    [(HMDHomePresenceMonitor *)v22 _updateUserPresence:v54 presenceAuth:v18 completion:v61];
...
- (void)_registerForMessages
{
  ...
  v13[0] = v4;
  v7 = [HMDUserMessagePolicy userMessagePolicyWithHome:v5 userPrivilege:0 remoteAccessRequired:0];
  v13[1] = v7;
