...
- (HMDHomePersonManager)initWithUUID:(id)a3 zoneManager:(id)a4 dataInterfaces:(id)a5 workQueue:(id)a6 featuresDataSource:(id)a7 home:(id)a8;
...
- (HMIHomePersonManager)hmiPersonManager
{
  ...
  v3 = [v2 na_map:&__block_literal_global_77779];
  v4 = [v3 anyObject];
...
- (HMDHomePersonManager)initWithUUID:(id)a3 zoneManager:(id)a4 dataInterfaces:(id)a5 workQueue:(id)a6 featuresDataSource:(id)a7 home:(id)a8
{
  ...
  v13 = a8;
  v14 = [(HMDPersonManager *)&v16 initWithUUID:a3 zoneManager:a4 dataInterfaces:a5 workQueue:a6 featuresDataSource:a7];
  objc_storeWeak(&v14->_home, v13);
...
LABEL_4:
  ...
  v31 = [(HMDHomePersonManager *)self initWithUUID:v13 zoneManager:v26 dataInterfaces:v14 workQueue:v9 featuresDataSource:v30 home:v8];
...
uint64_t __35__HMDHomePersonManager_logCategory__block_invoke()
{
  ...
  v2 = logCategory__hmf_once_v2_77804;
  logCategory__hmf_once_v2_77804 = v1;
