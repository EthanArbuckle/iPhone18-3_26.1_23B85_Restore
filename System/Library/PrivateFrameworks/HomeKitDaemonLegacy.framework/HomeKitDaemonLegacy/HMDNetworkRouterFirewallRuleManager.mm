  ...
  if (v1)
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v12, OS_LOG_TYPE_FAULT))
      {
        ...
        v16 = 138543362;
        v17 = v13;
        _os_log_impl(&dword_2531F8000, v12, OS_LOG_TYPE_FAULT, "%{public}@Submitting ABC event for failure: Operation count unbalanced", &v16, 0xCu);
      }
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_DEBUG))
    {
      ...
      v18 = 2048;
      v19 = v4;
      _os_log_impl(&dword_2531F8000, v7, OS_LOG_TYPE_DEBUG, "%{public}@Operation finished (%lu operations now pending)", &v16, 0x16u);
    }
    ...
    if ((state & 0xFFFFFFFFFFFFFFFDLL) == 0)
    {
      ...
      if (v6)
      {
        ...
        if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
        {
          ...
          *&v58[22] = 2048;
          v59 = v5;
          _os_log_impl(&dword_2531F8000, v12, OS_LOG_TYPE_INFO, "%{public}@Purged %lu deallocated client(s) (now have %lu)", v58, 0x20u);
        }
        ...
        else
        {
          ...
          if ([(os_unfair_lock_s *)self state]!= 2)
          {
            ...
            if (os_log_type_enabled(v48, OS_LOG_TYPE_FAULT))
            {
              ...
              *v58 = 138543362;
              *&v58[4] = v49;
              _os_log_impl(&dword_2531F8000, v48, OS_LOG_TYPE_FAULT, "%{public}@Submitting ABC event for failure: Must be running", v58, 0xCu);
            }
          ...
          if ([(os_unfair_lock_s *)self operationsInProgressCount])
          {
            ...
            if (os_log_type_enabled(v54, OS_LOG_TYPE_FAULT))
            {
              ...
              *v58 = 138543362;
              *&v58[4] = v55;
              _os_log_impl(&dword_2531F8000, v54, OS_LOG_TYPE_FAULT, "%{public}@Submitting ABC event for failure: Must have finished all operations", v58, 0xCu);
            }
          ...
          if (os_log_type_enabled(v28, OS_LOG_TYPE_INFO))
          {
            ...
            *v58 = 138543362;
            *&v58[4] = v29;
            _os_log_impl(&dword_2531F8000, v28, OS_LOG_TYPE_INFO, "%{public}@Shutdown initiated", v58, 0xCu);
          }
      ...
      else
      {
        ...
        if ([(os_unfair_lock_s *)self state])
        {
          ...
          if (os_log_type_enabled(v42, OS_LOG_TYPE_FAULT))
          {
            ...
            *v58 = 138543362;
            *&v58[4] = v43;
            _os_log_impl(&dword_2531F8000, v42, OS_LOG_TYPE_FAULT, "%{public}@Submitting ABC event for failure: Must be stopped", v58, 0xCu);
          }
        ...
        if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
        {
          ...
          *v58 = 138543362;
          *&v58[4] = v20;
          _os_log_impl(&dword_2531F8000, v19, OS_LOG_TYPE_INFO, "%{public}@Startup initiated", v58, 0xCu);
        }
...
void __49__HMDNetworkRouterFirewallRuleManager___shutdown__block_invoke(uint64_t a1, void *a2)
{
  ...
  if (v3)
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_ERROR))
    {
      ...
      v12 = 2112;
      v13 = v3;
      _os_log_impl(&dword_2531F8000, v7, OS_LOG_TYPE_ERROR, "%{public}@Failed to shut down: %@", &v10, 0x16u);
    }
...
void __48__HMDNetworkRouterFirewallRuleManager___startup__block_invoke_2(uint64_t a1, void *a2)
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_FAULT))
    {
      ...
      v15 = 138543362;
      v16 = v12;
      _os_log_impl(&dword_2531F8000, v11, OS_LOG_TYPE_FAULT, "%{public}@Submitting ABC event for failure: Completion should not have been called yet", &v15, 0xCu);
    }
...
void __57__HMDNetworkRouterFirewallRuleManager_shutdownForClient___block_invoke(uint64_t a1)
{
  ...
  v40 = &v39;
  v41 = 0x3032000000;
  v42 = __Block_byref_object_copy__38198;
  v43 = __Block_byref_object_dispose__38199;
  v44 = 0;
  v35 = 0;
  v36 = &v35;
  v37 = 0x2020000000;
      ...
      if ((v9 & 0xFFFFFFFFFFFFFFFDLL) != 1)
      {
        ...
        if (os_log_type_enabled(v23, OS_LOG_TYPE_FAULT))
        {
          ...
          *buf = 138543362;
          v47 = v24;
          v25 = v24;
          _os_log_impl(&dword_2531F8000, v23, OS_LOG_TYPE_FAULT, "%{public}@Submitting ABC event for failure: Must be starting or stopping", buf, 0xCu);
        }
...
void __67__HMDNetworkRouterFirewallRuleManager_startupForClient_completion___block_invoke(id *a1)
{
  ...
  v32 = &v31;
  v33 = 0x3032000000;
  v34 = __Block_byref_object_copy__38198;
  v35 = __Block_byref_object_dispose__38199;
  v36 = 0;
...
- (void)dealloc
{
  ...
  if (self->_state)
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_FAULT))
    {
      ...
      *buf = 138543362;
      v12 = v7;
      _os_log_impl(&dword_2531F8000, v6, OS_LOG_TYPE_FAULT, "%{public}@Submitting ABC event for failure: should be stopped", buf, 0xCu);
    }
...
uint64_t __50__HMDNetworkRouterFirewallRuleManager_logCategory__block_invoke()
{
  ...
  v2 = logCategory__hmf_once_v1_38261;
  logCategory__hmf_once_v1_38261 = v1;
