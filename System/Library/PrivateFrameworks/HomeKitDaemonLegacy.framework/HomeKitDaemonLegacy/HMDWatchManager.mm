...
+ (id)logCategory
{
  if (logCategory__hmf_once_t7_153285 != -1)
  {
    dispatch_once(&logCategory__hmf_once_t7_153285, &__block_literal_global_153286);
  }

  v3 = logCategory__hmf_once_v8_153287;
...
uint64_t __30__HMDWatchManager_logCategory__block_invoke()
{
  ...
  v2 = logCategory__hmf_once_v8_153287;
  logCategory__hmf_once_v8_153287 = v1;
...
+ (id)sharedManager
{
  if (+[HMDDeviceCapabilities isCompanionCapable])
  {
    ...
    block[4] = a1;
    if (sharedManager_onceToken_153296 != -1)
    {
      dispatch_once(&sharedManager_onceToken_153296, block);
    }
