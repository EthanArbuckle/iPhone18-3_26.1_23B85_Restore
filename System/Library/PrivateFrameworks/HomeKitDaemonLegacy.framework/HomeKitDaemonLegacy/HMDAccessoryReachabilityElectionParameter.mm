  ...
  if (v4)
  {
    ...
    if ([v6 count] != 1)
    {
      ...
      if (os_log_type_enabled(v18, OS_LOG_TYPE_ERROR))
      {
        ...
        v35 = 2112;
        v36 = v5;
        _os_log_impl(&dword_2531F8000, v18, OS_LOG_TYPE_ERROR, "%{public}@Unexpected representation, invalid keys: %@", &v33, 0x16u);
      }
    ...
    if (v9)
    {
      ...
      if (v10)
      {
        ...
        else
        {
          ...
          if (os_log_type_enabled(v29, OS_LOG_TYPE_ERROR))
          {
            ...
            v35 = 2112;
            v36 = v32;
            _os_log_impl(&dword_2531F8000, v29, OS_LOG_TYPE_ERROR, "%{public}@Invalid reachability: %@", &v33, 0x16u);
          }
      ...
      v35 = 2112;
      v36 = v9;
      _os_log_impl(&dword_2531F8000, v22, OS_LOG_TYPE_ERROR, "%{public}@Invalid identifier: %@", &v33, 0x16u);
    }
...
LABEL_24:
      ...
      v35 = 2112;
      v36 = v24;
      _os_log_impl(&dword_2531F8000, v22, OS_LOG_TYPE_ERROR, "%{public}@Invalid key type: %@", &v33, 0x16u);
    }
