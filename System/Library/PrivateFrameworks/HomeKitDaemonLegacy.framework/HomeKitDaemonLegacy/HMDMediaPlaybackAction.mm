...
- (id)associatedAccessories
{
  ...
  v3 = [v2 na_map:&__block_literal_global_38_177460];
  v4 = [v3 allObjects];
...
- (NSString)description
{
  ...
  v4 = [v3 na_map:&__block_literal_global_177463];
  v5 = [v4 allObjects];
...
- (id)validate
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
    {
      ...
      v23 = 2048;
      v24 = [v14 count];
      _os_log_impl(&dword_2531F8000, v10, OS_LOG_TYPE_ERROR, "%{public}@Invalid configuration for media playback action - state: %tu  volume: %@  #Profiles: %tu", &v17, 0x2Au);
    }
...
- (void)configureWithHome:(id)a3
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    v18 = 2112;
    v19 = v12;
    _os_log_impl(&dword_2531F8000, v9, OS_LOG_TYPE_INFO, "%{public}@Mapped profile UUIDs %@ to profiles %@", &v14, 0x20u);
  }
...
uint64_t __37__HMDMediaPlaybackAction_logCategory__block_invoke()
{
  ...
  v2 = logCategory__hmf_once_v25_177505;
  logCategory__hmf_once_v25_177505 = v1;
