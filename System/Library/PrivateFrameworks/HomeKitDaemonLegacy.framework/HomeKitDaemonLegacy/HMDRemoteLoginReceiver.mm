  ...
  if (!v5)
  {
    ...
    if (v12)
    {
      ...
      if (v15)
      {
        ...
        v16 = [v13 accountTypeWithAccountTypeIdentifier:*MEMORY[0x277CB8D58]];
        if (!v16)
        {
        ...
        if (v57)
        {
          ...
          else
          {
            ...
            if (os_log_type_enabled(v21, OS_LOG_TYPE_INFO))
            {
              ...
              v54 = [MEMORY[0x277D0F8D8] defaultFormatter];
              v22 = [v54 stringForObjectValue:*(*&buf[8] + 40)];
