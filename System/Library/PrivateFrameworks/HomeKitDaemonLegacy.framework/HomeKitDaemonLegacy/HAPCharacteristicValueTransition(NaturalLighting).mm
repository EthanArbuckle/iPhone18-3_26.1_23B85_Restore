...
- (id)naturalLightingActiveTransitionContextLightProfile:()NaturalLighting
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
    {
      ...
      v19 = 2112;
      v20 = v6;
      _os_log_impl(&dword_2531F8000, v11, OS_LOG_TYPE_ERROR, "%{public}@Service doesn't support Color Temperature Characteristic %@:%@", &v15, 0x20u);
    }
    ...
    if (!v10)
    {
      ...
      if (os_log_type_enabled(v21, OS_LOG_TYPE_ERROR))
      {
        ...
        *buf = 138543874;
        ...
        v34 = 2112;
        v35 = v11;
        _os_log_impl(&dword_2531F8000, v21, OS_LOG_TYPE_ERROR, "%{public}@Failed to decode controller context %@:%@", buf, 0x20u);
      }
    ...
    else
    {
      ...
      if (os_log_type_enabled(v24, OS_LOG_TYPE_ERROR))
      {
        ...
        *buf = 138543618;
        ...
        v32 = 2112;
        v33 = v10;
        _os_log_impl(&dword_2531F8000, v24, OS_LOG_TYPE_ERROR, "%{public}@Start time missing in the controller context %@", buf, 0x16u);
      }
    ...
    if (v27)
    {
      ...
      if (os_log_type_enabled(v31, OS_LOG_TYPE_ERROR))
      {
        ...
        *buf = 138543618;
        ...
        v72 = 2112;
        v73 = v26;
        _os_log_impl(&dword_2531F8000, v31, OS_LOG_TYPE_ERROR, "%{public}@No transition points found: %@", buf, 0x16u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v46, OS_LOG_TYPE_INFO))
      {
        ...
        *buf = 138544130;
        ...
        v76 = 2048;
        v77 = v42;
        _os_log_impl(&dword_2531F8000, v46, OS_LOG_TYPE_INFO, "%{public}@Sending coalesced transition points to accessory, transition points count: %lu, start transition point: %@, time elapsed since start of the day: %llums", buf, 0x2Au);
      }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v38, OS_LOG_TYPE_ERROR))
    {
      ...
      *buf = 138543874;
      ...
      v74 = 2112;
      v75 = v39;
      _os_log_impl(&dword_2531F8000, v38, OS_LOG_TYPE_ERROR, "%{public}@Failed to serialize controller context %@:%@", buf, 0x20u);
      ...
      if (v10 && [a1 canCoalesceTransitionPoint1:v9 transitionPoint2:v10 ofCurve:v40])
      {
        ...
        if (os_log_type_enabled(v18, OS_LOG_TYPE_DEBUG))
        {
          ...
          *buf = v38;
          ...
          v51 = 2048;
          v52 = v12;
          _os_log_impl(&dword_2531F8000, v18, OS_LOG_TYPE_DEBUG, "%{public}@Coalescing transition point: %@ at index: %lu with transition point: %@ at index: %lu", buf, 0x34u);
...
LABEL_20:
      _os_log_impl(&dword_2531F8000, v43, OS_LOG_TYPE_ERROR, v45, buf, 0x16u);
    }
  ...
  if (!v71)
  {
    ...
    if (os_log_type_enabled(v48, OS_LOG_TYPE_ERROR))
    {
      ...
      *buf = 138543874;
      ...
      v76 = 2112;
      v77 = v10;
      _os_log_impl(&dword_2531F8000, v48, OS_LOG_TYPE_ERROR, "%{public}@Natural lighting curve is not set on light profile %@:%@", buf, 0x20u);
    }
  ...
  if (!v70)
  {
    ...
    if (os_log_type_enabled(v52, OS_LOG_TYPE_ERROR))
    {
      ...
      *buf = 138543874;
      ...
      v76 = 2112;
      v77 = v21;
      _os_log_impl(&dword_2531F8000, v52, OS_LOG_TYPE_ERROR, "%{public}@Service doesn't support Color Temperature Characteristic %@:%@", buf, 0x20u);
    }
  ...
  if (!v23)
  {
    ...
    if (os_log_type_enabled(v56, OS_LOG_TYPE_ERROR))
    {
      ...
      *buf = 138543874;
      ...
      v76 = 2112;
      v77 = v22;
      _os_log_impl(&dword_2531F8000, v56, OS_LOG_TYPE_ERROR, "%{public}@Service doesn't support brightness Characteristic %@:%@", buf, 0x20u);
    }
  ...
  if (a4)
  {
    ...
    if (([objc_opt_class() updateTransition:v28 withCurve:v71 brightnessCharacteristic:v24 millisecondsElapsedSinceStartOfDay:v19 transitionStartTimeInMilliseconds:v18] & 1) == 0)
    {
      ...
      if (os_log_type_enabled(v60, OS_LOG_TYPE_ERROR))
      {
        ...
        *buf = 138543362;
        v73 = v61;
        _os_log_impl(&dword_2531F8000, v60, OS_LOG_TYPE_ERROR, "%{public}@Failed to update transition with Natural Lighting Curve", buf, 0xCu);
      }
