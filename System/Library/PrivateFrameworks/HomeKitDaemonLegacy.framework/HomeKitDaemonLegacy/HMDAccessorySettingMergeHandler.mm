...
+ (id)_mergeValidValueConstraintsFirst:(id)a3 second:(id)a4 shouldAddMissing:(BOOL)a5
{
  ...
  if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
  {
    ...
    v36 = 2048;
    v37 = [v16 count];
    _os_log_impl(&dword_2531F8000, v19, OS_LOG_TYPE_INFO, "%{public}@Valid value constraints: this: %lu, second: %lu", &v32, 0x20u);
  }
  ...
  _os_log_impl(&dword_2531F8000, v23, OS_LOG_TYPE_INFO, v26, &v32, 0x16u);
...
+ (BOOL)_extractMinMaxStep:(id)a3 minConstraint:(id *)a4 maxConstraint:(id *)a5 stepConstraint:(id *)a6 first:(id)a7
{
  ...
  if (!a4 || !a5 || !a6)
  {
    ...
    if (os_log_type_enabled(v27, OS_LOG_TYPE_ERROR))
    {
      ...
      *buf = 138543362;
      v43 = v28;
      _os_log_impl(&dword_2531F8000, v27, OS_LOG_TYPE_ERROR, "%{public}@Cannot return result in invalid data", buf, 0xCu);
    }
  ...
  if (!*a4 || !*a5 || !*a6)
  {
    ...
    if (os_log_type_enabled(v27, OS_LOG_TYPE_ERROR))
    {
      ...
      *buf = 138544130;
      ...
      v48 = 2112;
      v49 = v33;
      _os_log_impl(&dword_2531F8000, v27, OS_LOG_TYPE_ERROR, "%{public}@Could not find min %@ or max %@ or step %@", buf, 0x2Au);
    }
...
LABEL_47:
      _os_log_impl(&dword_2531F8000, v62, OS_LOG_TYPE_ERROR, v64, buf, 0xCu);
    }
...
LABEL_48:
    ...
    if (!v12)
    {
      ...
      if (os_log_type_enabled(v34, OS_LOG_TYPE_INFO))
      {
        ...
        *buf = 138543618;
        ...
        v90 = 2112;
        v91 = *&v18;
        _os_log_impl(&dword_2531F8000, v34, OS_LOG_TYPE_INFO, "%{public}@Taking step constraint from %@", buf, 0x16u);
      }
  ...
  if (os_log_type_enabled(v38, OS_LOG_TYPE_ERROR))
  {
    ...
    *buf = 138543362;
    v89 = v39;
    _os_log_impl(&dword_2531F8000, v38, OS_LOG_TYPE_ERROR, "%{public}@Min, max or step is nil", buf, 0xCu);
...
LABEL_28:
    ...
    if (os_log_type_enabled(v47, OS_LOG_TYPE_INFO))
    {
      ...
      *buf = 138544130;
      ...
      v94 = 2112;
      v95 = v78;
      _os_log_impl(&dword_2531F8000, v47, OS_LOG_TYPE_INFO, "%{public}@Chosen min: %@, step: %@, max: %@", buf, 0x2Au);
...
LABEL_58:
        _os_log_impl(&dword_2531F8000, v70, OS_LOG_TYPE_ERROR, v72, buf, 0x16u);
      }
    }
    ...
    else
    {
      ...
      v54 = compareCharacteristicValue(v76, v53, 1, &unk_28662BF68);
...
+ (BOOL)_isNumber:(id)a3 betweenStart:(id)a4 andEnd:(id)a5 first:(id)a6
{
  ...
  if (!v9)
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
    {
      ...
      v20 = 138543362;
      v21 = v17;
      _os_log_impl(&dword_2531F8000, v16, OS_LOG_TYPE_ERROR, "%{public}@Given value is nil, cannot determine whether within the range", &v20, 0xCu);
    }
  ...
  if (v19)
  {
    ...
    if (!v20 || !v93 || !v92)
    {
      if (os_log_type_enabled(v23, OS_LOG_TYPE_ERROR))
      {
        ...
        *buf = 138543362;
        v98 = v40;
        _os_log_impl(&dword_2531F8000, v24, OS_LOG_TYPE_ERROR, "%{public}@Min, max or step is nil", buf, 0xCu);
    ...
    if (v41 == 4)
    {
      ...
      if (v62 && v63)
      {
        if (v65)
        {
          ...
          *buf = 138543362;
          v98 = v66;
          _os_log_impl(&dword_2531F8000, v52, OS_LOG_TYPE_INFO, "%{public}@Current values are within the merged range", buf, 0xCu);
        }
        ...
        if (v67 != -1)
        {
          if (v71)
          {
            ...
            *buf = 138543618;
            ...
            v99 = 2112;
            v100 = v91;
            _os_log_impl(&dword_2531F8000, v70, OS_LOG_TYPE_INFO, "%{public}@Retaining current value %@", buf, 0x16u);
          }
        ...
        if (v71)
        {
          ...
          *buf = 138543618;
          ...
          v99 = 2112;
          v100 = v88;
          _os_log_impl(&dword_2531F8000, v70, OS_LOG_TYPE_INFO, "%{public}@Choosing second setting's value %@", buf, 0x16u);
        }
...
LABEL_52:
          ...
          *buf = 138543618;
          ...
          v99 = 2112;
          v100 = v91;
          _os_log_impl(&dword_2531F8000, v52, OS_LOG_TYPE_INFO, "%{public}@Only current value %@ is within the merged range", buf, 0x16u);
        }
      ...
      if (!v63)
      {
        if (v65)
        {
          ...
          *buf = 138543618;
          ...
          v99 = 2112;
          v100 = v93;
          _os_log_impl(&dword_2531F8000, v52, OS_LOG_TYPE_INFO, "%{public}@Neither of the values are within the merged range, choosing the max %@", buf, 0x16u);
        }
      ...
      if (v41 == 1)
      {
        ...
        else
        {
          if (os_log_type_enabled(v44, OS_LOG_TYPE_ERROR))
          {
            ...
            *buf = 138543362;
            v98 = v77;
            _os_log_impl(&dword_2531F8000, v45, OS_LOG_TYPE_ERROR, "%{public}@Cannot find the conflict value", buf, 0xCu);
    ...
    if (v48 && v49)
    {
      ...
      if (v56 == -1)
      {
        if (v60)
        {
          ...
          *buf = 138543618;
          ...
          v99 = 2112;
          v100 = v91;
          _os_log_impl(&dword_2531F8000, v59, OS_LOG_TYPE_INFO, "%{public}@Retaining current value %@", buf, 0x16u);
        }
      ...
      if (v60)
      {
        ...
        *buf = 138543618;
        ...
        v99 = 2112;
        v100 = v55;
        _os_log_impl(&dword_2531F8000, v59, OS_LOG_TYPE_INFO, "%{public}@Choosing second setting's value %@", buf, 0x16u);
      }
...
LABEL_64:
        ...
        *buf = 138543618;
        ...
        v99 = 2112;
        v100 = v18;
        _os_log_impl(&dword_2531F8000, v52, OS_LOG_TYPE_INFO, "%{public}@Only second setting's value %@ is within the merged range", buf, 0x16u);
      }
...
LABEL_72:
    ...
    if (v53)
    {
      ...
      *buf = 138543618;
      ...
      v99 = 2112;
      v100 = v90;
      _os_log_impl(&dword_2531F8000, v52, OS_LOG_TYPE_INFO, "%{public}@Neither of the values are within the merged range, choosing the min %@", buf, 0x16u);
    }
