  ...
  if (v6 == v4)
  {
    ...
    if (!v5)
    {
      ...
      if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
      {
        ...
        *buf = 138543362;
        v52 = v12;
        _os_log_impl(&dword_2531F8000, v11, OS_LOG_TYPE_INFO, "%{public}@Accessory disappeared, stopping accessory metric timer", buf, 0xCu);
      }
  ...
  if (v5)
  {
    ...
    if (os_log_type_enabled(v20, OS_LOG_TYPE_INFO))
    {
      ...
      *buf = 138543618;
      ...
      v28 = 2048;
      v29 = timerInterval;
      _os_log_impl(&dword_2531F8000, v20, OS_LOG_TYPE_INFO, "%{public}@[AccessoryMetric] Initialized session metric for accessory with submission interval: %f", buf, 0x16u);
    }
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t4_64899 != -1)
  {
    dispatch_once(&logCategory__hmf_once_t4_64899, &__block_literal_global_148_64900);
  }

  v3 = logCategory__hmf_once_v5_64901;
...
uint64_t __33__HMDAccessoryMetric_logCategory__block_invoke()
{
  ...
  v2 = logCategory__hmf_once_v5_64901;
  logCategory__hmf_once_v5_64901 = v1;
