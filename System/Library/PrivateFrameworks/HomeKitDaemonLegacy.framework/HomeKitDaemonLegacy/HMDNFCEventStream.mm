...
- (void)_handleXPCEvent:(id)event
{
  ...
  if (v5 != MEMORY[0x277D86468])
  {
    ...
    else if (v11)
    {
      ...
      v15 = 12;
LABEL_11:
      _os_log_impl(&dword_2531F8000, v14, OS_LOG_TYPE_ERROR, v13, &v30, v15);
    }
...
LABEL_13:
  ...
  if (os_log_type_enabled(v18, OS_LOG_TYPE_INFO))
  {
    ...
    v32 = 2112;
    v33 = eventCopy;
    _os_log_impl(&dword_2531F8000, v18, OS_LOG_TYPE_INFO, "%{public}@Received XPC dictionary event: %@", &v30, 0x16u);
  }
  ...
  if (!string)
  {
    ...
    if (os_log_type_enabled(v28, OS_LOG_TYPE_ERROR))
    {
      ...
      v32 = 2112;
      v33 = @"Payload";
      _os_log_impl(&dword_2531F8000, v28, OS_LOG_TYPE_ERROR, "%{public}@No value for '%@' in dictionary event", &v30, 0x16u);
    }
...
uint64_t __32__HMDNFCEventStream_logCategory__block_invoke()
{
  ...
  v2 = logCategory__hmf_once_v6_26798;
  logCategory__hmf_once_v6_26798 = v1;
