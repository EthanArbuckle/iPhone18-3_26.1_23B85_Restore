...
- (void)removeHH2SentinelZoneWithCompletion:(id)a3
{
  ...
  else
  {
    ...
    v13 = [v12 na_firstObjectPassingTest:&__block_literal_global_126690];
...
+ (id)errorFromHMDCKAccountStatus:(int64_t)a3
{
  ...
  {
    v5 = [MEMORY[0x277CCA9B8] hmPrivateErrorWithCode:{qword_253D4BF70[a3 - 2], v3}];
  }
