...
void __64__HMDDataStreamControlProtocol__sendVersionRequestOnDataStream___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (v3)
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
    {
      ...
      v11 = 2112;
      v12 = v3;
      _os_log_impl(&dword_2531F8000, v6, OS_LOG_TYPE_ERROR, "%{public}@Failed to send version control message (%@)", &v9, 0x16u);
    }
...
void __62__HMDDataStreamControlProtocol__sendHelloMessageOnDataStream___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (v3)
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
    {
      ...
      v11 = 2112;
      v12 = v3;
      _os_log_impl(&dword_2531F8000, v6, OS_LOG_TYPE_ERROR, "%{public}@Failed to send hello control message (%@)", &v9, 0x16u);
    }
...
- (void)dataStream:(id)a3 didReceiveResponse:(id)a4 header:(id)a5 payload:(id)a6
{
  ...
  if ([(HMDDataStreamControlProtocol *)self isExpectedHelloControlMessage:v11 header:v12])
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
    {
      ...
      v30 = 138543362;
      v31 = v17;
      _os_log_impl(&dword_2531F8000, v16, OS_LOG_TYPE_INFO, "%{public}@Hello control message reply received", &v30, 0xCu);
    }
  ...
  else
  {
    ...
    if (v19)
    {
      if (v23)
      {
        ...
        v32 = 2112;
        v33 = v13;
        _os_log_impl(&dword_2531F8000, v22, OS_LOG_TYPE_INFO, "%{public}@Received Peer Request Version Response %@", &v30, 0x16u);
      }
    ...
    else
    {
      if (v23)
      {
        ...
        v30 = 138543362;
        v31 = v28;
        _os_log_impl(&dword_2531F8000, v22, OS_LOG_TYPE_INFO, "%{public}@Expected hello reply or Version but got something else", &v30, 0xCu);
      }
...
- (void)dataStream:(id)a3 didReceiveRequest:(id)a4 header:(id)a5 payload:(id)a6
{
  ...
  if ([v11 isEqual:@"hello"])
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
    {
      ...
      v30 = 138543362;
      v31 = v17;
      _os_log_impl(&dword_2531F8000, v16, OS_LOG_TYPE_INFO, "%{public}@Hello control message received", &v30, 0xCu);
    }

    objc_autoreleasePoolPop(v14);
    [v10 sendResponseForRequestHeader:v12 payload:MEMORY[0x277CBEC10] status:0 completion:&__block_literal_global_191028];
  }
  ...
  else
  {
    ...
    if (v18)
    {
      if (os_log_type_enabled(v21, OS_LOG_TYPE_INFO))
      {
        ...
        v30 = 138543362;
        v31 = v23;
        _os_log_impl(&dword_2531F8000, v22, OS_LOG_TYPE_INFO, "%{public}@Version control message received", &v30, 0xCu);
      }
      ...
      [v10 sendResponseForRequestHeader:v12 payload:v27 status:0 completion:&__block_literal_global_3_191030];
    }
    ...
    else
    {
      if (os_log_type_enabled(v21, OS_LOG_TYPE_ERROR))
      {
        ...
        v32 = 2112;
        v33 = v11;
        _os_log_impl(&dword_2531F8000, v22, OS_LOG_TYPE_ERROR, "%{public}@Control Protocol received unexpected request '%@'", &v30, 0x16u);
      }
...
- (void)dataStreamDidOpen:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v10 = 138543362;
    v11 = v8;
    _os_log_impl(&dword_2531F8000, v7, OS_LOG_TYPE_INFO, "%{public}@Sending hello control message", &v10, 0xCu);
  }
