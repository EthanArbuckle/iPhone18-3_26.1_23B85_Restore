...
+ (id)properties
{
  if (properties_onceToken_180993 != -1)
  {
    dispatch_once(&properties_onceToken_180993, &__block_literal_global_252);
  }

  v3 = properties__properties_180994;
...
void __38__HMDAccessorySettingModel_properties__block_invoke()
{
  ...
  v6 = properties__properties_180994;
  properties__properties_180994 = v5;
