...
void __39__HMDSharedUserDataModel_hmbProperties__block_invoke(uint64_t a1)
{
  ...
  v11.receiver = *(a1 + 32);
  v11.super_class = &OBJC_METACLASS___HMDSharedUserDataModel;
  ...
  v12[0] = @"assistantAccessControlModelUUID";
  v5 = [MEMORY[0x277D170B8] fieldWithClass:objc_opt_class()];
  v13[0] = v5;
  v12[1] = @"userListeningHistoryUpdateControlModelUUID";
  v6 = [MEMORY[0x277D170B8] fieldWithClass:objc_opt_class()];
  v13[1] = v6;
  v12[2] = @"supportsAutomaticHH2MigrationModelUUID";
  v7 = [MEMORY[0x277D170B8] fieldWithClass:objc_opt_class()];
  v13[2] = v7;
  v12[3] = @"mediaContentProfileAccessControlModelUUID";
