...
- (void)_postNotificationForUpdatedSignificantEvent:(id)a3 allClipSignificantEvents:(id)a4 homePresence:(id)a5;
...
- (void)clipManager:(id)a3 didUpdateSignificantEvent:(id)a4 withHomePresence:(id)a5
{
  ...
  v9 = [(HMDCameraProfile *)self hapAccessory];
  v10 = [v9 doorbellChimeController];
...
- (void)_postNotificationForUpdatedSignificantEvent:(id)a3 allClipSignificantEvents:(id)a4 homePresence:(id)a5
{
  ...
  v11 = [(HMDCameraProfile *)self clipUserNotificationCenter];
  v12 = [v11 createBulletinForSignificantEvents:v9 cameraProfile:self];

  if (v12)
  {
    v13 = [objc_opt_class() bulletinBoard];
    v14 = [v13 hasDoorbellPressNotificationToUpdateWithSignificantEventBulletin:v12];
    ...
    v15 = [objc_opt_class() bulletinBoard];
    [v15 updateDoorbellPressNotificationsWithSignificantEventBulletin:v12];

    v16 = [v12 significantEvents];
    v17 = [v16 na_any:&__block_literal_global_110_156650];

    if (v17)
    {
LABEL_11:
      if ([(HMDCameraProfile *)self _shouldNotifyForSignificantEvent:v19 homePresence:v8])
      {
        v18 = [(HMDCameraProfile *)self clipUserNotificationCenter];
        [v18 postNotificationForBulletin:v12 significantEvent:v19];
      }
    }
  }
}
...
- (void)_postNotificationForUpdatedSignificantEvent:(id)a3 homePresence:(id)a4
{
  ...
  v9 = [v6 clipUUID];
  v10 = [v8 significantEventsForClipWithUUID:v9];
  ...
  [(HMDCameraProfile *)self _postNotificationForUpdatedSignificantEvent:v6 allClipSignificantEvents:v10 homePresence:v7];
...
- (BOOL)_shouldNotifyForSignificantEvent:(id)a3 homePresence:(id)a4
{
  ...
  v9 = [(HMDCameraProfile *)self clipUserNotificationCenter];
...
LABEL_9:
  ...
  v10 = [(HMDCameraProfile *)self currentSettings];
  v11 = [v10 notificationSettings];
  v12 = [v11 isSmartBulletinBoardNotificationEnabled];
  ...
  v13 = [(HMDCameraProfile *)self currentSettings];
  v14 = [v13 notificationSettings];
  v15 = [v14 smartBulletinBoardNotificationCondition];

  if (v15)
  {
    v16 = [(HMDCameraProfile *)self hapAccessory];
    v17 = [v16 home];

    v63 = v17;
    v18 = [v17 currentUser];
    v19 = [(HMDCameraProfile *)self predicateUtilities];
    v20 = v6;
    v21 = v15;
    v65 = v7;
    v62 = v18;
...
- (void)registerForMessages
{
  ...
  if (v8)
  {
    ...
    v28 = [(HMDAccessoryProfile *)v5 accessory];
    v29 = [v28 home];
    v30 = [HMDUserMessagePolicy userMessagePolicyWithHome:v29 userPrivilege:0 remoteAccessRequired:1 requiresCameraStreamingAccess:1];
    ...
    v34 = [(HMDAccessoryProfile *)v5 msgDispatcher];
    [v34 registerForMessage:*MEMORY[0x277CCF5F0] receiver:v5 policies:v33 selector:?];

    v35 = [(HMDAccessoryProfile *)v5 msgDispatcher];
    [v35 registerForMessage:*MEMORY[0x277CCF608] receiver:v5 policies:v33 selector:sel__handleStreamControlRequest_];

    v36 = [(HMDAccessoryProfile *)v5 msgDispatcher];
    [v36 registerForMessage:*MEMORY[0x277CCF5F8] receiver:v5 policies:v33 selector:sel__handleStreamControlRequest_];

    v71[0] = v30;
    v71[1] = v32;
    v37 = [MEMORY[0x277CBEA60] arrayWithObjects:v71 count:2];
    v38 = [(HMDAccessoryProfile *)v5 msgDispatcher];
    [v38 registerForMessage:*MEMORY[0x277CCF600] receiver:v5 policies:v37 selector:sel__handleStreamControlRequest_];

    v39 = [(HMDAccessoryProfile *)v5 msgDispatcher];
    [v39 registerForMessage:*MEMORY[0x277CCF618] receiver:v5 policies:v37 selector:sel__handleStreamControlRequest_];
...
- (void)unconfigure
{
  ...
  v3 = [(HMDCameraProfile *)self hapAccessory];
  v4 = [v3 home];
  v5 = v4;
  if (v3 && [v4 isCurrentDeviceAvailableResident])
  {
    v6 = [v5 notificationRegistry];
    v7 = [v3 uuid];
    v11[0] = v7;
  ...
  v9 = [(HMDCameraProfile *)self notificationCenter];
...
- (void)_setUpBulletinNotificationManagerObserver
{
  v2 = [(HMDAccessoryProfile *)self workQueue];
...
- (void)setUp
{
  ...
  if (v4)
  {
    ...
    if (v6)
    {
      ...
      {
        v14 = HMFGetLogIdentifier();
        v15 = [(HMDCameraProfile *)v12 cameraSettingsManager];
        v16 = [v15 zoneName];
        v35 = 138543618;
        v36 = v14;
        v37 = 2112;
      ...
      objc_autoreleasePoolPop(v11);
      v17 = [(HMDCameraProfile *)v12 cameraSettingsManager];
      v18 = [v5 msgDispatcher];
      v19 = [v6 administratorHandler];
      v20 = +[HMDDeviceCapabilities deviceCapabilities];
      [v17 configureWithMessageDispatcher:v18 adminMessageDispatcher:v19 deviceIsResidentCapable:{objc_msgSend(v20, "isResidentCapable")}];

      v21 = [(HMDCameraProfile *)v12 reachabilityEventManager];
      v22 = [(HMDAccessoryProfile *)v12 msgDispatcher];
      v23 = [(HMDCameraProfile *)v12 currentSettings];
      v24 = [v6 isCurrentDeviceConfirmedPrimaryResident];
      v25 = [(HMDCameraProfile *)v12 networkMonitor];
      [v21 configureWithMessageDispatcher:v22 currentSettings:v23 isCurrentDeviceConfirmedPrimaryResident:v24 isCurrentDeviceConnectedToNetwork:{objc_msgSend(v25, "isReachable")}];
    }
