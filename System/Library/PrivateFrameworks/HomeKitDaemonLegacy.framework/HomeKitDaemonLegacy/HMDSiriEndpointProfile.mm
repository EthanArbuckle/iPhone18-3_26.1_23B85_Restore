...
LABEL_7:
  ...
  else if ((v2 & 2) == 0)
  {
    ...
    if (os_log_type_enabled(v5, OS_LOG_TYPE_ERROR))
    {
      ...
      v14 = 2048;
      v15 = v7;
      _os_log_impl(&dword_2531F8000, v5, OS_LOG_TYPE_ERROR, "%{public}@[Notifications] options is not valid: %ld", &v12, 0x16u);
    }
...
- (void)_handleRefreshProfileState:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v10 = 138543362;
    v11 = v8;
    _os_log_impl(&dword_2531F8000, v7, OS_LOG_TYPE_INFO, "%{public}@Handle refresh profile state", &v10, 0xCu);
  }
...
void __69__HMDSiriEndpointProfile_notifyClientsDidUpdateStagedNeedsOnboarding__block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    v17 = 2112;
    v18 = v3;
    _os_log_impl(&dword_2531F8000, v6, OS_LOG_TYPE_INFO, "%{public}@Notifying XPC clients of updated needsOnboarding: %@", &v15, 0x16u);
  }
...
- (void)stagedValue:(id)a3 didExpireValue:(id)a4
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
    {
      ...
      v19 = 2112;
      v20 = v7;
      _os_log_impl(&dword_2531F8000, v11, OS_LOG_TYPE_ERROR, "%{public}@Unknown stage value: %@ did expire value: %@", &v15, 0x20u);
    }
...
- (void)handleEnableNotifications:(id)a3
{
  ...
  if (!v5)
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
    {
      ...
      v14 = 138543362;
      v15 = v11;
      _os_log_impl(&dword_2531F8000, v10, OS_LOG_TYPE_ERROR, "%{public}@[Profile Notifications] parameters not specific", &v14, 0xCu);
    }
    ...
    if (v9)
    {
      ...
      if (v11)
      {
        ...
        if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
        {
          ...
          v29 = 2112;
          v30 = v17;
          _os_log_impl(&dword_2531F8000, v14, OS_LOG_TYPE_INFO, "%{public}@Handling %@/%@", &v25, 0x20u);
        }
...
void __58__HMDSiriEndpointProfile_handleDeviceCapabilitiesUpdated___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
  {
    ...
    v32 = 2112;
    v33 = v14;
    _os_log_impl(&dword_2531F8000, v12, OS_LOG_TYPE_INFO, "%{public}@Handling updated resident capabilities: %@ notification: %@", &v28, 0x20u);
  }
    ...
    if (v21 == v4 && ([v9 containsObject:@"supportsSiriEndpointSetup"] & 1) != 0)
    {
      ...
      if (v22)
      {
        ...
        if (os_log_type_enabled(v25, OS_LOG_TYPE_INFO))
        {
          ...
          v30 = 2112;
          v31 = v20;
          _os_log_impl(&dword_2531F8000, v25, OS_LOG_TYPE_INFO, "%{public}@Current device was updated to support Siri Endpoint Settings (%@)", &v28, 0x16u);
        }
...
uint64_t __52__HMDSiriEndpointProfile_handleAccessoryConfigured___block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    v14 = 2112;
    v15 = v6;
    _os_log_impl(&dword_2531F8000, v4, OS_LOG_TYPE_INFO, "%{public}@Handling %@", &v12, 0x16u);
  }
...
- (void)stageNeedsOnboarding:(int64_t)a3 withTimeout:(double)a4
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    v16 = 2048;
    v17 = a3;
    _os_log_impl(&dword_2531F8000, v9, OS_LOG_TYPE_INFO, "%{public}@Staging needsOnboarding: %ld", &v14, 0x16u);
  }
...
- (void)registerForMessages
{
  ...
  v4 = [v3 home];
  v12.receiver = self;
  v12.super_class = HMDSiriEndpointProfile;
  ...
  v11[1] = 3221225472;
  v11[2] = __45__HMDSiriEndpointProfile_registerForMessages__block_invoke;
  v11[3] = &unk_279735D00;
  v11[4] = self;
  dispatch_async(v5, v11);

  v6 = [(HMDAccessoryProfile *)self msgDispatcher];
  ...
  [v6 registerForMessage:*MEMORY[0x277CD1020] receiver:self policies:v9 selector:sel__handleRefreshProfileState_];
  [v6 registerForMessage:*MEMORY[0x277CD0FF8] receiver:self policies:v9 selector:sel_handleEnableNotifications_];
...
void __45__HMDSiriEndpointProfile_registerForMessages__block_invoke(uint64_t a1)
{
  ...
  if (v4)
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
    {
      ...
      v10 = 138543362;
      v11 = v8;
      _os_log_impl(&dword_2531F8000, v7, OS_LOG_TYPE_INFO, "%{public}@Registering for characteristic notifications since current device supports home hub", &v10, 0xCu);
    }
