...
void __64__HMDCameraRemoteStreamTracker_stopTrackingStreamWithSessionID___block_invoke(uint64_t a1)
{
  ...
  if (v3)
  {
    if (v7)
    {
      ...
      v16 = 2112;
      v17 = v9;
      _os_log_impl(&dword_2531F8000, v6, OS_LOG_TYPE_INFO, "%{public}@No longer tracking stream with session ID: %@", &v14, 0x16u);
    }
  ...
  else
  {
    if (v7)
    {
      ...
      v16 = 2112;
      v17 = v12;
      _os_log_impl(&dword_2531F8000, v6, OS_LOG_TYPE_INFO, "%{public}@Cannot find stream to stop tracking: %@", &v14, 0x16u);
    }
...
void __59__HMDCameraRemoteStreamTracker_startTrackingStreamSession___block_invoke(uint64_t a1)
{
  ...
  if (v3 >= v4)
  {
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
    {
      ...
      v28 = 2112;
      v29 = v22;
      _os_log_impl(&dword_2531F8000, v19, OS_LOG_TYPE_INFO, "%{public}@Cannot start tracking stream session: %@. Already tracking maximum number of stream sessions: %@", &v24, 0x20u);
    }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
    {
      ...
      v28 = 2048;
      v29 = [v16 count];
      _os_log_impl(&dword_2531F8000, v13, OS_LOG_TYPE_INFO, "%{public}@Started tracking stream session: %@. Total count is now %lu", &v24, 0x20u);
    }
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t4_102396 != -1)
  {
    dispatch_once(&logCategory__hmf_once_t4_102396, &__block_literal_global_5_102397);
  }

  v3 = logCategory__hmf_once_v5_102398;
...
uint64_t __43__HMDCameraRemoteStreamTracker_logCategory__block_invoke()
{
  ...
  v2 = logCategory__hmf_once_v5_102398;
  logCategory__hmf_once_v5_102398 = v1;
...
+ (HMDCameraRemoteStreamTracker)sharedTracker
{
  if (sharedTracker_onceToken_102403 != -1)
  {
    dispatch_once(&sharedTracker_onceToken_102403, &__block_literal_global_102404);
  }
