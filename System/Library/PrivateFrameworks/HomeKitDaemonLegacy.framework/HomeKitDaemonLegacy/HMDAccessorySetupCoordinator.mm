...
- (void)_handleStagedPairingServer:(id)server error:(id)error forRequest:(id)request activity:(id)activity
{
  ...
  if (os_log_type_enabled(v18, OS_LOG_TYPE_INFO))
  {
    ...
    *buf = 138544130;
    ...
    v101 = 2112;
    v102 = uUID;
    _os_log_impl(&dword_2531F8000, v18, OS_LOG_TYPE_INFO, "%{public}@Handling staged pairing identifier %@ and error %@ for request UUID: %@", buf, 0x2Au);
  }
  ...
  if (!identifier || ([requestCopy pendingRequestMessage], v21 = objc_claimAutoreleasedReturnValue(), v21, v21))
  {
    ...
    if (productID)
    {
      ...
      if (v26)
      {
        ...
        *buf = 138544386;
        ...
        v103 = 2112;
        v104 = productID2;
        _os_log_impl(&dword_2531F8000, productID4, OS_LOG_TYPE_INFO, "%{public}@tag=%{public}@ desc=%@ %{public}@=%@", buf, 0x34u);
    ...
    if (identifier)
    {
      ...
      if (os_log_type_enabled(v54, OS_LOG_TYPE_INFO))
      {
        ...
        *buf = 138543874;
        ...
        v99 = 2112;
        v100 = uUID3;
        _os_log_impl(&dword_2531F8000, v54, OS_LOG_TYPE_INFO, "%{public}@Successfully staged CHIP accessory server with identifier %@ in multiple steps for request UUID: %@", buf, 0x20u);
      }
    ...
    if (os_log_type_enabled(v62, OS_LOG_TYPE_ERROR))
    {
      ...
      *buf = 138543874;
      ...
      v99 = 2112;
      v100 = v59;
      _os_log_impl(&dword_2531F8000, v62, OS_LOG_TYPE_ERROR, "%{public}@Failed to stage CHIP accessory pairing for request UUID %@: %@", buf, 0x20u);
    }
    ...
    if (!pendingRequestMessage)
    {
      if (v69)
      {
        ...
        *buf = 138543874;
        ...
        v99 = 2112;
        v100 = uUID5;
        _os_log_impl(&dword_2531F8000, v68, OS_LOG_TYPE_INFO, "%{public}@Queueing staging error %@ for request UUID: %@", buf, 0x20u);
      }
    ...
    if (v69)
    {
      ...
      *buf = 138543874;
      ...
      v99 = 2112;
      v100 = v59;
      _os_log_impl(&dword_2531F8000, v68, OS_LOG_TYPE_INFO, "%{public}@Responding for request UUID %@ with error: %@", buf, 0x20u);
    }
...
LABEL_40:
  ...
  if (os_log_type_enabled(v40, OS_LOG_TYPE_ERROR))
  {
    ...
    *buf = 138543618;
    ...
    v97 = 2112;
    v98 = uUID7;
    _os_log_impl(&dword_2531F8000, v40, OS_LOG_TYPE_ERROR, "%{public}@Unexpectedly received staged pairing identifier for request UUID: %@", buf, 0x16u);
  }
  ...
  if (os_log_type_enabled(v45, OS_LOG_TYPE_ERROR))
  {
    ...
    *buf = 138543874;
    ...
    _os_log_impl(&dword_2531F8000, v45, OS_LOG_TYPE_ERROR, "%{public}@tag=%{public}@ desc=%@", buf, 0x20u);
  }
    ...
    if (v7)
    {
      if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
      {
        ...
        *buf = 138543874;
        ...
        v67 = 2112;
        v68 = v14;
        _os_log_impl(&dword_2531F8000, v11, OS_LOG_TYPE_INFO, "%{public}@Passing back pairing UUID %@ for staged pairing identifier: %@", buf, 0x20u);
      }
      ...
      if (v26)
      {
        ...
        *buf = 138544386;
        ...
        v71 = 2112;
        v72 = v35;
        _os_log_impl(&dword_2531F8000, v25, OS_LOG_TYPE_INFO, "%{public}@tag=%{public}@ desc=%@ %{public}@=%@", buf, 0x34u);
    ...
    else
    {
      if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
      {
        ...
        *buf = 138543874;
        ...
        v67 = 2112;
        v68 = v5;
        _os_log_impl(&dword_2531F8000, v11, OS_LOG_TYPE_ERROR, "%{public}@Could not find system commissioner pairing for newly staged server with identifier %@ in all pairings: %@", buf, 0x20u);
      }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v38, OS_LOG_TYPE_ERROR))
    {
      ...
      *buf = 138543618;
      ...
      v65 = 2112;
      v66 = v6;
      _os_log_impl(&dword_2531F8000, v38, OS_LOG_TYPE_ERROR, "%{public}@System commissioner failed to fetch pairings: %@", buf, 0x16u);
    }
...
- (void)_handleStagedPairingCommissioneeInfo:(id)info forRequest:(id)request
{
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
  {
    ...
    *buf = 138543618;
    ...
    v28 = 2112;
    v29 = uUID;
    _os_log_impl(&dword_2531F8000, v11, OS_LOG_TYPE_INFO, "%{public}@Handling commissionee info for request UUID: %@", buf, 0x16u);
  }
...
- (void)_handleStagedPairingProgressState:(int64_t)state forRequest:(id)request
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    *buf = 138543874;
    ...
    v30 = 2112;
    v31 = uUID;
    _os_log_impl(&dword_2531F8000, v10, OS_LOG_TYPE_INFO, "%{public}@Handling progress state (%ld) for request UUID: %@", buf, 0x20u);
  }
...
- (void)_handleStagedPairingReadyToCancel:(id)cancel forRequest:(id)request
{
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
  {
    ...
    v28 = 2112;
    v29 = uUID;
    _os_log_impl(&dword_2531F8000, v11, OS_LOG_TYPE_INFO, "%{public}@Handling ready to cancel for request UUID: %@", &v26, 0x16u);
  }
  ...
  if (pendingCancelMessage)
  {
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
    {
      ...
      v26 = 138543362;
      v27 = v18;
      _os_log_impl(&dword_2531F8000, v17, OS_LOG_TYPE_INFO, "%{public}@Responding to a pending Cancel message", &v26, 0xCu);
    }
...
- (void)_handleStagedPairingThreadNetworkScanResults:(id)results completionHandler:(id)handler forRequest:(id)request activity:(id)activity
{
  ...
  if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
  {
    ...
    *buf = 138543874;
    ...
    v54 = 2112;
    v55 = uUID;
    _os_log_impl(&dword_2531F8000, v17, OS_LOG_TYPE_INFO, "%{public}@Handling Thread scan results %@ for request UUID: %@", buf, 0x20u);
  }
...
LABEL_6:
    ...
    if (os_log_type_enabled(v24, OS_LOG_TYPE_ERROR))
    {
      ...
      *buf = 138543618;
      ...
      v52 = 2112;
      v53 = uUID2;
      _os_log_impl(&dword_2531F8000, v24, OS_LOG_TYPE_ERROR, "%{public}@Unexpectedly received Thread scan results for request UUID: %@", buf, 0x16u);
    }
    ...
    if (os_log_type_enabled(v29, OS_LOG_TYPE_ERROR))
    {
      ...
      *buf = 138543874;
      ...
      _os_log_impl(&dword_2531F8000, v29, OS_LOG_TYPE_ERROR, "%{public}@tag=%{public}@ desc=%@", buf, 0x20u);
    }
  ...
  if (os_log_type_enabled(v43, OS_LOG_TYPE_INFO))
  {
    ...
    *buf = 138543874;
    ...
    _os_log_impl(&dword_2531F8000, v43, OS_LOG_TYPE_INFO, "%{public}@tag=%{public}@ desc=%@", buf, 0x20u);
  }
...
- (void)_handleStagedPairingWiFiNetworkScanResults:(id)results completionHandler:(id)handler forRequest:(id)request activity:(id)activity
{
  ...
  if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
  {
    ...
    *buf = 138543874;
    ...
    v43 = 2112;
    v44 = uUID;
    _os_log_impl(&dword_2531F8000, v17, OS_LOG_TYPE_INFO, "%{public}@Handling WiFi scan results %@ for request UUID: %@", buf, 0x20u);
  }
  ...
  if (os_log_type_enabled(v24, OS_LOG_TYPE_ERROR))
  {
    ...
    *buf = 138543618;
    ...
    v41 = 2112;
    v42 = uUID3;
    _os_log_impl(&dword_2531F8000, v24, OS_LOG_TYPE_ERROR, "%{public}@Unexpectedly received WiFi scan results for request UUID: %@", buf, 0x16u);
  }
...
- (void)_handleStagedPairingDeviceCredential:(id)credential completionHandler:(id)handler forRequest:(id)request activity:(id)activity
{
  ...
  if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
  {
    ...
    *buf = 138543874;
    ...
    v41 = 2112;
    v42 = uUID;
    _os_log_impl(&dword_2531F8000, v17, OS_LOG_TYPE_INFO, "%{public}@Handling device credential %@ for request UUID: %@", buf, 0x20u);
  }
  ...
  if (pendingRequestMessage)
  {
    ...
    if (os_log_type_enabled(v27, OS_LOG_TYPE_INFO))
    {
      ...
      *buf = 138543874;
      ...
      _os_log_impl(&dword_2531F8000, v27, OS_LOG_TYPE_INFO, "%{public}@tag=%{public}@ desc=%@", buf, 0x20u);
    }
...
- (id)_setupPayloadWithCHIPSetupPayload:(id)payload setupPayloadURL:(id)l
{
  ...
  if (os_log_type_enabled(v32, OS_LOG_TYPE_INFO))
  {
    ...
    *buf = 138543618;
    ...
    v40 = 2112;
    v41 = v12;
    _os_log_impl(&dword_2531F8000, v32, OS_LOG_TYPE_INFO, "%{public}@Created CHIP setup accessory payload: %@", buf, 0x16u);
  }
...
- (id)_createCHIPSetupAccessoryPayloadWithSetupPayloadDecimalStringRepresentation:(id)representation error:(id *)error
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
    {
      ...
      v20 = 2112;
      v21 = v7;
      _os_log_impl(&dword_2531F8000, v14, OS_LOG_TYPE_ERROR, "%{public}@Failed to create CHIP accessory setup payload from decimal string representation: %@", &v18, 0x16u);
    }
  ...
  if (v6)
  {
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      *buf = 138543618;
      ...
      v21 = 2112;
      v22 = v6;
      _os_log_impl(&dword_2531F8000, v10, OS_LOG_TYPE_INFO, "%{public}@Discarding staged accessory server with identifier: %@", buf, 0x16u);
    }
  ...
  else
  {
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      *buf = 138543618;
      ...
      v21 = 2112;
      v22 = messagePayload;
      _os_log_impl(&dword_2531F8000, v10, OS_LOG_TYPE_ERROR, "%{public}@Could not find CHIP accessory pairing identifier in message payload: %@", buf, 0x16u);
    }
...
void __78__HMDAccessorySetupCoordinator_handleCancelStagedCHIPAccessoryPairingMessage___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (v3)
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
    {
      ...
      v13 = 2112;
      v14 = v3;
      _os_log_impl(&dword_2531F8000, v6, OS_LOG_TYPE_ERROR, "%{public}@Failed to discard staged accessory server: %@", &v11, 0x16u);
    }
    ...
    if (v8)
    {
      ...
      if ((v10 & 1) == 0)
      {
        ...
        if (!metricsActivity || (v12 = metricsActivity, -[HMDAccessorySetupCoordinator metricsActivity](self, "metricsActivity"), v13 = objc_claimAutoreleasedReturnValue(), v14 = [v13 isValid], v13, v12, (v14 & 1) == 0))
        {
          ...
          if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
          {
            ...
            *buf = 138543362;
            v60 = v18;
            _os_log_impl(&dword_2531F8000, v17, OS_LOG_TYPE_INFO, "%{public}@Starting metrics collection for 3rd party pairing via locker", buf, 0xCu);
          }
          ...
          if (v23)
          {
            ...
            *buf = 138544386;
            ...
            _os_log_impl(&dword_2531F8000, v22, OS_LOG_TYPE_INFO, "%{public}@tag=%{public}@ desc=%@ %{public}@=%@", buf, 0x34u);
      ...
      if (os_log_type_enabled(v49, OS_LOG_TYPE_INFO))
      {
        ...
        *buf = 138543618;
        ...
        v61 = 2112;
        v62 = v8;
        _os_log_impl(&dword_2531F8000, v49, OS_LOG_TYPE_INFO, "%{public}@Opening pairing window with PIN on CHIP accessory server: %@", buf, 0x16u);
      }
    ...
    else
    {
      ...
      if (os_log_type_enabled(v37, OS_LOG_TYPE_ERROR))
      {
        ...
        *buf = 138543618;
        ...
        v61 = 2112;
        v62 = v6;
        _os_log_impl(&dword_2531F8000, v37, OS_LOG_TYPE_ERROR, "%{public}@Could not find CHIP accessory server with identifier: %@", buf, 0x16u);
      }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v32, OS_LOG_TYPE_ERROR))
    {
      ...
      *buf = 138543618;
      ...
      v61 = 2112;
      v62 = messagePayload;
      _os_log_impl(&dword_2531F8000, v32, OS_LOG_TYPE_ERROR, "%{public}@Could not find CHIP accessory pairing identifier in message payload: %@", buf, 0x16u);
    }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
    {
      ...
      *buf = 138543618;
      ...
      v18 = 2112;
      v19 = v6;
      _os_log_impl(&dword_2531F8000, v10, OS_LOG_TYPE_ERROR, "%{public}@Failed to open pairing window with PIN: %@", buf, 0x16u);
    }
...
- (void)handleCancelStagingMessage:(id)message
{
  ...
  if (v6)
  {
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      v40 = 2112;
      v41 = v6;
      _os_log_impl(&dword_2531F8000, v10, OS_LOG_TYPE_INFO, "%{public}@Handling cancel staging message with staging request UUID: %@", &v38, 0x16u);
    }
    ...
    if (v13)
    {
      ...
      if (error)
      {
        ...
        if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
        {
          ...
          v40 = 2112;
          v41 = error2;
          _os_log_impl(&dword_2531F8000, v17, OS_LOG_TYPE_INFO, "%{public}@Responding to cancel staging message with success in presence of queued pairing error: %@", &v38, 0x16u);
        }
      ...
      else
      {
        ...
        else
        {
          ...
          if (os_log_type_enabled(v35, OS_LOG_TYPE_INFO))
          {
            ...
            v40 = 2112;
            v41 = v6;
            _os_log_impl(&dword_2531F8000, v35, OS_LOG_TYPE_INFO, "%{public}@Staging request UUID: %@ is not ready to cancel yet", &v38, 0x16u);
          }
    ...
    else
    {
      ...
      if (os_log_type_enabled(v25, OS_LOG_TYPE_ERROR))
      {
        ...
        v40 = 2112;
        v41 = v6;
        _os_log_impl(&dword_2531F8000, v25, OS_LOG_TYPE_ERROR, "%{public}@Could not find staging request for cancel staging message with staging request UUID: %@", &v38, 0x16u);
      }
  ...
  else
  {
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      v40 = 2112;
      v41 = messagePayload;
      _os_log_impl(&dword_2531F8000, v10, OS_LOG_TYPE_ERROR, "%{public}@Could not find staging request in cancel staging message payload: %@", &v38, 0x16u);
    }
  ...
  if (v6)
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
    {
      ...
      *buf = 138543618;
      ...
      v47 = 2112;
      v48 = v6;
      _os_log_impl(&dword_2531F8000, v12, OS_LOG_TYPE_INFO, "%{public}@Handling select wifi network message for request UUID: %@", buf, 0x16u);
    }
    ...
    if (!v15)
    {
      ...
      if (os_log_type_enabled(v31, OS_LOG_TYPE_ERROR))
      {
        ...
        *buf = 138543618;
        ...
        v47 = 2112;
        v48 = v6;
        _os_log_impl(&dword_2531F8000, v31, OS_LOG_TYPE_ERROR, "%{public}@Could not find staging request for select wifi network message with staging request UUID: %@", buf, 0x16u);
      }
    ...
    if (error)
    {
      ...
      if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR))
      {
        ...
        *buf = 138543618;
        ...
        v47 = 2112;
        v48 = error2;
        _os_log_impl(&dword_2531F8000, v19, OS_LOG_TYPE_ERROR, "%{public}@Responding to select wifi network message with queued pairing error: %@", buf, 0x16u);
      }
...
LABEL_25:
    ...
    _os_log_impl(&dword_2531F8000, v39, OS_LOG_TYPE_ERROR, v41, buf, 0x16u);
  ...
  if (os_log_type_enabled(v26, OS_LOG_TYPE_ERROR))
  {
    ...
    *buf = 138543618;
    ...
    v47 = 2112;
    v48 = messagePayload;
    _os_log_impl(&dword_2531F8000, v26, OS_LOG_TYPE_ERROR, "%{public}@Could not find staging request in select-wifi-network message payload: %@", buf, 0x16u);
  }
  ...
  if (v6)
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
    {
      ...
      *buf = 138543618;
      ...
      v47 = 2112;
      v48 = v6;
      _os_log_impl(&dword_2531F8000, v12, OS_LOG_TYPE_INFO, "%{public}@Handling select Thread network message for request UUID: %@", buf, 0x16u);
    }
    ...
    if (!v15)
    {
      ...
      if (os_log_type_enabled(v31, OS_LOG_TYPE_ERROR))
      {
        ...
        *buf = 138543618;
        ...
        v47 = 2112;
        v48 = v6;
        _os_log_impl(&dword_2531F8000, v31, OS_LOG_TYPE_ERROR, "%{public}@Could not find staging request for select Thread network message with staging request UUID: %@", buf, 0x16u);
      }
    ...
    if (error)
    {
      ...
      if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR))
      {
        ...
        *buf = 138543618;
        ...
        v47 = 2112;
        v48 = error2;
        _os_log_impl(&dword_2531F8000, v19, OS_LOG_TYPE_ERROR, "%{public}@Responding to select Thread network message with queued pairing error: %@", buf, 0x16u);
      }
...
LABEL_25:
  ...
  if (os_log_type_enabled(v26, OS_LOG_TYPE_ERROR))
  {
    ...
    *buf = 138543618;
    ...
    v47 = 2112;
    v48 = messagePayload;
    _os_log_impl(&dword_2531F8000, v26, OS_LOG_TYPE_ERROR, "%{public}@Could not find staging request in select-thread-network message payload: %@", buf, 0x16u);
  }
...
- (void)handleRejectDeviceCredentialMessage:(id)message
{
  ...
  if (v6)
  {
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      v46 = 2112;
      v47 = v6;
      _os_log_impl(&dword_2531F8000, v10, OS_LOG_TYPE_INFO, "%{public}@Handling reject device credential message with staging request UUID: %@", &v44, 0x16u);
    }
    ...
    if (v13)
    {
      ...
      if (error)
      {
        ...
        if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR))
        {
          ...
          v46 = 2112;
          v47 = error2;
          _os_log_impl(&dword_2531F8000, v17, OS_LOG_TYPE_ERROR, "%{public}@Responding to reject device credential message with queued pairing error: %@", &v44, 0x16u);
        }
...
LABEL_21:
          _os_log_impl(&dword_2531F8000, v33, OS_LOG_TYPE_ERROR, v35, &v44, 0x16u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v26, OS_LOG_TYPE_ERROR))
      {
        ...
        v46 = 2112;
        v47 = v6;
        _os_log_impl(&dword_2531F8000, v26, OS_LOG_TYPE_ERROR, "%{public}@Could not find staging request for reject device credential message with staging request UUID: %@", &v44, 0x16u);
      }
  ...
  else
  {
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      v46 = 2112;
      v47 = messagePayload;
      _os_log_impl(&dword_2531F8000, v10, OS_LOG_TYPE_ERROR, "%{public}@Could not find staging request in reject device credential message payload: %@", &v44, 0x16u);
    }
...
- (void)handleConfirmDeviceCredentialMessage:(id)message
{
  ...
  if (v6)
  {
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      v43 = 2112;
      v44 = v6;
      _os_log_impl(&dword_2531F8000, v10, OS_LOG_TYPE_INFO, "%{public}@Handling confirm device credential message with staging request UUID: %@", &v41, 0x16u);
    }
    ...
    if (v13)
    {
      ...
      if (error)
      {
        ...
        if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR))
        {
          ...
          v43 = 2112;
          v44 = error2;
          _os_log_impl(&dword_2531F8000, v17, OS_LOG_TYPE_ERROR, "%{public}@Responding to confirm device credential message with queued pairing error: %@", &v41, 0x16u);
        }
...
LABEL_9:
      ...
      if (!confirmDeviceCredentialCompletionHandler)
      {
        ...
        if (os_log_type_enabled(v39, OS_LOG_TYPE_ERROR))
        {
          ...
          v43 = 2112;
          v44 = v6;
          _os_log_impl(&dword_2531F8000, v39, OS_LOG_TYPE_ERROR, "%{public}@No pending confirm device credential completion handler exists for staging request UUID: %@", &v41, 0x16u);
        }
    ...
    else
    {
      ...
      if (os_log_type_enabled(v26, OS_LOG_TYPE_ERROR))
      {
        ...
        v43 = 2112;
        v44 = v6;
        _os_log_impl(&dword_2531F8000, v26, OS_LOG_TYPE_ERROR, "%{public}@Could not find staging request for confirm device credential message with staging request UUID: %@", &v41, 0x16u);
      }
  ...
  else
  {
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      v43 = 2112;
      v44 = messagePayload;
      _os_log_impl(&dword_2531F8000, v10, OS_LOG_TYPE_ERROR, "%{public}@Could not find staging request in confirm device credential message payload: %@", &v41, 0x16u);
    }
  ...
  if (v9)
  {
    ...
    if (v25)
    {
      ...
      *buf = 138546434;
      ...
      v151 = 2112;
      v152 = v35;
      _os_log_impl(&dword_2531F8000, v24, OS_LOG_TYPE_INFO, "%{public}@tag=%{public}@ desc=%@ %{public}@=%@ %{public}@=%@ %{public}@=%@ %{public}@=%@ %{public}@=%@", buf, 0x84u);
    ...
    if (chipAccessorySetupPayload)
    {
      ...
      if (os_log_type_enabled(v51, OS_LOG_TYPE_INFO))
      {
        ...
        *buf = 138545410;
        ...
        v143 = 2112;
        v144 = v56;
        _os_log_impl(&dword_2531F8000, v51, OS_LOG_TYPE_INFO, "%{public}@tag=%{public}@ desc=%@ %{public}@=%@ %{public}@=%@ %{public}@=%@", buf, 0x5Cu);
      ...
      if (os_log_type_enabled(v78, OS_LOG_TYPE_INFO))
      {
        ...
        *buf = 138543874;
        ...
        v131 = 2112;
        v132 = uUID2;
        _os_log_impl(&dword_2531F8000, v78, OS_LOG_TYPE_INFO, "%{public}@Handling stage CHIP accessory pairing in steps message with setup payload: %@, request UUID: %@", buf, 0x20u);
      }
    ...
    else
    {
      ...
      if (os_log_type_enabled(v61, OS_LOG_TYPE_ERROR))
      {
        ...
        *buf = 138543618;
        ...
        v129 = 2112;
        v130 = v108;
        _os_log_impl(&dword_2531F8000, v61, OS_LOG_TYPE_ERROR, "%{public}@Could not find CHIP accessory setup payload on setup accessory payload: %@", buf, 0x16u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
    {
      ...
      *buf = 138543618;
      ...
      v129 = 2112;
      v130 = v17;
      _os_log_impl(&dword_2531F8000, v14, OS_LOG_TYPE_ERROR, "%{public}@Could not find setup accessory payload in message payload: %@", buf, 0x16u);
...
- (void)handleCreateCHIPSetupAccessoryPayloadMessage:(id)message
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    *buf = 138543618;
    ...
    v33 = 2112;
    v34 = messagePayload;
    _os_log_impl(&dword_2531F8000, v8, OS_LOG_TYPE_INFO, "%{public}@Handling create CHIP setup accessory payload message payload: %@", buf, 0x16u);
  }
    ...
    if (!v12)
    {
      ...
      if (os_log_type_enabled(v23, OS_LOG_TYPE_ERROR))
      {
        ...
        *buf = 138543618;
        ...
        v33 = 2112;
        v34 = messagePayload2;
        _os_log_impl(&dword_2531F8000, v23, OS_LOG_TYPE_ERROR, "%{public}@Could not find any setup information in message payload: %@", buf, 0x16u);
      }
...
- (void)stopMetricsForThirdPartyPairingWithError:(id)error
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v26 = 2112;
    v27 = errorCopy;
    _os_log_impl(&dword_2531F8000, v7, OS_LOG_TYPE_INFO, "%{public}@Stop metrics for 3rd party pairing, error:%@", &v24, 0x16u);
  }
  ...
  if (isValid)
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
      {
        ...
        v28 = 2112;
        v29 = @"Stop";
        _os_log_impl(&dword_2531F8000, v15, OS_LOG_TYPE_INFO, "%{public}@tag=%{public}@ desc=%@", &v24, 0x20u);
      }
...
- (void)startMetricsForThirdPartyPairing
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    v24 = 138543362;
    v25 = v6;
    _os_log_impl(&dword_2531F8000, v5, OS_LOG_TYPE_INFO, "%{public}@Start metrics for 3rd party pairing", &v24, 0xCu);
  }
...
- (id)createSetupAccessoryPayloadWithCHIPSetupPayload:(id)payload error:(id *)error
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
    {
      ...
      v20 = 2112;
      v21 = v7;
      _os_log_impl(&dword_2531F8000, v14, OS_LOG_TYPE_ERROR, "%{public}@Failed to create CHIP accessory setup payload from setup payload %@", &v18, 0x16u);
    }
...
- (id)createCHIPSetupAccessoryPayloadWithSetupPayloadURL:(id)l error:(id *)error
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
    {
      ...
      _os_log_impl(&dword_2531F8000, v16, OS_LOG_TYPE_ERROR, "%{public}@Failed to create CHIP accessory setup payload from setup payload URL string: %@", &v20, 0x16u);
    }
...
LABEL_11:
  ...
  if (v16)
  {
    ...
    v17->_urlStringCHIPAccessorySetupPayloadFactory = &__block_literal_global_150712;
    ...
    v17->_decimalStringRepresentationCHIPAccessorySetupPayloadFactory = &__block_literal_global_70_150713;

    payloadCHIPAccessorySetupPayloadFactory = v17->_payloadCHIPAccessorySetupPayloadFactory;
    v17->_payloadCHIPAccessorySetupPayloadFactory = &__block_literal_global_73_150714;
  }
...
+ (id)logCategory
{
  ...
  {
    dispatch_once(&logCategory__hmf_once_t76, &__block_literal_global_186_150733);
  }
