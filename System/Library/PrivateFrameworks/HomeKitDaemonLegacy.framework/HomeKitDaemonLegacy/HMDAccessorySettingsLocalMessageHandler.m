  ...
  if ([v4 isRemote])
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
      {
        ...
        v17 = 2112;
        v18 = v5;
        _os_log_impl(&dword_2531F8000, v11, OS_LOG_TYPE_ERROR, "%{public}@Failed to get caller version from remote source device: %@", &v15, 0x16u);
      }
...
uint64_t __54__HMDAccessorySettingsLocalMessageHandler_logCategory__block_invoke()
{
  ...
  v2 = logCategory__hmf_once_v17_89352;
  logCategory__hmf_once_v17_89352 = v1;
