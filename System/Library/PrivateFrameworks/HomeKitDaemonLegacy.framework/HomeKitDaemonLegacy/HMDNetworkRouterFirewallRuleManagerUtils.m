...
+ (id)dumpTLVsFromJSONData:(id)a3 error:(id *)a4
{
  ...
  if (v45)
  {
    ...
    v55 = &v54;
    v56 = 0x3032000000;
    v57 = __Block_byref_object_copy__110988;
    v58 = __Block_byref_object_dispose__110989;
    v59 = 0;
  ...
  if (v9)
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
      {
        ...
        v19 = 138543362;
        v20 = v14;
        _os_log_impl(&dword_2531F8000, v13, OS_LOG_TYPE_ERROR, "%{public}@Invalid declarations found", &v19, 0xCu);
      }
