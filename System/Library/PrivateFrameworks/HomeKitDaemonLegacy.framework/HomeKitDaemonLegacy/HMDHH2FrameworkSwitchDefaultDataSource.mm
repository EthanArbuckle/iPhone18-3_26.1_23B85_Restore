...
void __70__HMDHH2FrameworkSwitchDefaultDataSource_initiateDaemonRelaunchToHH2___block_invoke(uint64_t a1)
{
  ...
  if (v2 == v3)
  {
    if (v7)
    {
      ...
      v12 = 138543362;
      v13 = v8;
      _os_log_impl(&dword_2531F8000, v6, OS_LOG_TYPE_DEFAULT, "%{public}@We are in the right world, do not relaunch.", &v12, 0xCu);
    }
  ...
  else
  {
    if (v7)
    {
      ...
      v12 = 138543362;
      v13 = v9;
      _os_log_impl(&dword_2531F8000, v6, OS_LOG_TYPE_DEFAULT, "%{public}@See you on the other side - restarting...", &v12, 0xCu);
    }
...
- (id)controller:(id)a3 cloudDatabaseWithContainerID:(id)a4
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
    {
      ...
      v18 = 138543362;
      v19 = v15;
      _os_log_impl(&dword_2531F8000, v14, OS_LOG_TYPE_ERROR, "%{public}@Failed to get default local database", &v18, 0xCu);
    }
