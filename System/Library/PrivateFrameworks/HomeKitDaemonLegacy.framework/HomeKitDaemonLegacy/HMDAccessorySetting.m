  ...
  if (v6 && v9 && [v6 compare:v7] == -1)
  {
    ...
    if (v4)
    {
      ...
      if (os_log_type_enabled(v13, OS_LOG_TYPE_DEFAULT))
      {
        ...
        v17 = 2112;
        v18 = v6;
        _os_log_impl(&dword_2531F8000, v13, OS_LOG_TYPE_DEFAULT, "%{public}@Settings update blocked due to attempting language setting update with homekit version: %@", &v15, 0x16u);
      }
...
- (id)replicatedMissingConstraintsFrom:(id)a3
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
    {
      ...
      v16 = 2112;
      v17 = v6;
      _os_log_impl(&dword_2531F8000, v10, OS_LOG_TYPE_INFO, "%{public}@found constraints that are not present returning, %@", &v14, 0x16u);
    }
...
- (BOOL)canRemoveConstraint:(id)a3
{
  ...
  if ((v6 & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      v15 = 2112;
      v16 = v4;
      _os_log_impl(&dword_2531F8000, v9, OS_LOG_TYPE_INFO, "%{public}@Missing Constraint: %@", &v13, 0x16u);
    }
...
- (BOOL)canAddConstraint:(id)a3 error:(id *)a4
{
  ...
  if (!v8)
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
    {
      ...
      v25 = 2112;
      v26 = v18;
      _os_log_impl(&dword_2531F8000, v16, OS_LOG_TYPE_INFO, "%{public}@Invalid constraint, %@, with error: %@", &v21, 0x20u);
    }
...
LABEL_11:
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
  {
    ...
    v23 = 2112;
    v24 = v6;
    _os_log_impl(&dword_2531F8000, v11, OS_LOG_TYPE_INFO, "%{public}@Duplicate constraint: %@", &v21, 0x16u);
  }
...
LABEL_79:
        ...
        *v96 = 138543618;
        ...
        v99 = v57;
        v58 = v57;
        _os_log_impl(&dword_2531F8000, v55, OS_LOG_TYPE_INFO, "%{public}@Unexpected value class: %@", v96, 0x16u);
...
uint64_t __34__HMDAccessorySetting_logCategory__block_invoke()
{
  ...
  v2 = logCategory__hmf_once_v59_180984;
  logCategory__hmf_once_v59_180984 = v1;
