...
+ (void)configureKeyedArchiverClassMappings
{
  ...
  [MEMORY[0x277CCAAB0] setClassName:@"HMDResidentDeviceManager" forClass:objc_opt_class()];
  [MEMORY[0x277CCAAC8] setClass:objc_opt_class() forClassName:@"HMDResidentDeviceManager"];
