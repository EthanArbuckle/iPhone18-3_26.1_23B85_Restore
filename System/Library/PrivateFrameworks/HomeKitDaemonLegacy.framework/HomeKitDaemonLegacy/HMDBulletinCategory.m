...
+ (NSDictionary)targetCurrentCharacteristicTypeMap
{
  ...
  {
    dispatch_once(&targetCurrentCharacteristicTypeMap_onceToken, &__block_literal_global_121);
  }
...
+ (BOOL)isSecureServiceType:(id)a3
{
  ...
  if (v3 != -1)
  {
    dispatch_once(&isSecureServiceType__onceToken, &__block_literal_global_118_93237);
  }
...
+ (id)_secureStateMap
{
  ...
  {
    dispatch_once(&_secureStateMap_onceToken, &__block_literal_global_54_93284);
  }
...
+ (id)_enumerationValueLocalizationKeys
{
  ...
  {
    dispatch_once(&_enumerationValueLocalizationKeys_onceToken, &__block_literal_global_93290);
  }
