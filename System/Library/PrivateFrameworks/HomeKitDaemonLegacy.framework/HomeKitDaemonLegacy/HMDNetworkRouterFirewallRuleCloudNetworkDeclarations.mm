...
+ (id)__decodeRuleConfigurationWithVersionString:(id)string ruleConfigurationValue:(id)value baseAccessoryIdentifier:(id)identifier
{
  ...
  if (v11)
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v26, OS_LOG_TYPE_ERROR))
      {
        ...
        v34 = 2112;
        v35 = v12;
        _os_log_impl(&dword_2531F8000, v26, OS_LOG_TYPE_ERROR, "%{public}@Rule configuration for version '%@' is not a dictionary: %@", &v30, 0x20u);
      }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR))
    {
      ...
      v32 = 2112;
      v33 = stringCopy;
      _os_log_impl(&dword_2531F8000, v22, OS_LOG_TYPE_ERROR, "%{public}@Rule configuration contains an invalid version string: %@", &v30, 0x16u);
    }
...
uint64_t __67__HMDNetworkRouterFirewallRuleCloudNetworkDeclarations_logCategory__block_invoke()
{
  ...
  v2 = logCategory__hmf_once_v1_164855;
  logCategory__hmf_once_v1_164855 = v1;
