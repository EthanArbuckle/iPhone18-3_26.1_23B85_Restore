...
- (void)extractionEnteredPassThroughMode
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    v8 = 138543362;
    v9 = v6;
    _os_log_impl(&dword_2531F8000, v5, OS_LOG_TYPE_INFO, "%{public}@Unarchive in pass through mode", &v8, 0xCu);
  }
...
- (void)extractionCompleteAtArchivePath:(id)path
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v12 = 2112;
    v13 = pathCopy;
    _os_log_impl(&dword_2531F8000, v7, OS_LOG_TYPE_INFO, "%{public}@Completed unarchiving to path: %@", &v10, 0x16u);
  }
...
- (void)setExtractionProgress:(double)progress
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v12 = 2048;
    v13 = progress * 100.0;
    _os_log_impl(&dword_2531F8000, v7, OS_LOG_TYPE_INFO, "%{public}@Unarchive progress: %.1f%%", &v10, 0x16u);
  }
...
- (void)URLSession:(id)session downloadTask:(id)task didFinishDownloadingToURL:(id)l
{
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
  {
    ...
    *buf = 138543618;
    ...
    v52 = 2112;
    v53 = path;
    _os_log_impl(&dword_2531F8000, v13, OS_LOG_TYPE_INFO, "%{public}@Finished downloading archived asset to: %@", buf, 0x16u);
  }
  ...
  if (v18 && ([v18 statusCode] > 399 || objc_msgSend(v18, "statusCode") <= 199))
  {
    ...
    if (os_log_type_enabled(v21, OS_LOG_TYPE_ERROR))
    {
      ...
      *buf = 138543874;
      ...
      v54 = 2112;
      v55 = v18;
      _os_log_impl(&dword_2531F8000, v21, OS_LOG_TYPE_ERROR, "%{public}@Failed to download asset to '%@' due to bad response status: %@", buf, 0x20u);
    }
    ...
    else
    {
      ...
      if (os_log_type_enabled(v32, OS_LOG_TYPE_ERROR))
      {
        ...
        *buf = 138543874;
        ...
        v54 = 2112;
        v55 = v29;
        _os_log_impl(&dword_2531F8000, v32, OS_LOG_TYPE_ERROR, "%{public}@Failed to move downloaded asset to '%@' with error: %@. Removing existing assets at that path.", buf, 0x20u);
      }
      ...
      if ((v38 & 1) == 0)
      {
        ...
        if (os_log_type_enabled(v41, OS_LOG_TYPE_ERROR))
        {
          ...
          *buf = 138543874;
          ...
          v54 = 2112;
          v55 = v25;
          _os_log_impl(&dword_2531F8000, v41, OS_LOG_TYPE_ERROR, "%{public}@Failed to remove existing asset at url '%@' with error: %@.", buf, 0x20u);
...
- (void)URLSession:(id)session downloadTask:(id)task didWriteData:(int64_t)data totalBytesWritten:(int64_t)written totalBytesExpectedToWrite:(int64_t)write
{
  ...
  if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
  {
    ...
    v21 = 2048;
    v22 = (v16 * 100.0);
    _os_log_impl(&dword_2531F8000, v15, OS_LOG_TYPE_INFO, "%{public}@Download progress: %.1f%%", &v19, 0x16u);
  }
...
- (void)URLSession:(id)session task:(id)task didCompleteWithError:(id)error
{
  ...
  if (errorCopy)
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
    {
      ...
      v18 = 2112;
      v19 = errorCopy;
      _os_log_impl(&dword_2531F8000, v13, OS_LOG_TYPE_ERROR, "%{public}@Failed to download asset with error: %@", &v16, 0x16u);
    }
...
void __54__HMDSoftwareUpdateDocumentationAsset_finishUnarchive__block_invoke(uint64_t a1)
{
  ...
  if (v2)
  {
    if (v6)
    {
      ...
      *buf = 138543362;
      v15 = v7;
      _os_log_impl(&dword_2531F8000, v5, OS_LOG_TYPE_DEFAULT, "%{public}@Finishing unarchive", buf, 0xCu);
    }
...
void __54__HMDSoftwareUpdateDocumentationAsset_cancelUnarchive__block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *buf = 138543362;
    v18 = v5;
    _os_log_impl(&dword_2531F8000, v4, OS_LOG_TYPE_DEFAULT, "%{public}@Cancelling unarchive", buf, 0xCu);
  }
  ...
  if ((v9 & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
    {
      ...
      *buf = 138543618;
      ...
      v19 = 2112;
      v20 = v10;
      _os_log_impl(&dword_2531F8000, v13, OS_LOG_TYPE_INFO, "%{public}@Failed to remove bundle with error: %@", buf, 0x16u);
    }
...
void __53__HMDSoftwareUpdateDocumentationAsset_startUnarchive__block_invoke(uint64_t a1)
{
  ...
  if (v2)
  {
    if (v6)
    {
      ...
      *buf = 138543362;
      v44 = v7;
      _os_log_impl(&dword_2531F8000, v5, OS_LOG_TYPE_DEFAULT, "%{public}@Starting unarchive", buf, 0xCu);
    }
    ...
    if (v13)
    {
      ...
      if (v16)
      {
        ...
        if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
        {
          ...
          *buf = 138543618;
          ...
          v45 = 2112;
          v46 = v13;
          _os_log_impl(&dword_2531F8000, v19, OS_LOG_TYPE_INFO, "%{public}@Starting extraction using options: %@", buf, 0x16u);
        }
      ...
      else
      {
        ...
        if (os_log_type_enabled(v38, OS_LOG_TYPE_ERROR))
        {
          ...
          *buf = 138543362;
          v44 = v39;
          _os_log_impl(&dword_2531F8000, v38, OS_LOG_TYPE_ERROR, "%{public}@Failed to create input stream", buf, 0xCu);
        }
    ...
    else
    {
      ...
      if (os_log_type_enabled(v32, OS_LOG_TYPE_INFO))
      {
        ...
        *buf = 138543618;
        ...
        v45 = 2112;
        v46 = v35;
        _os_log_impl(&dword_2531F8000, v32, OS_LOG_TYPE_INFO, "%{public}@Failed to create validation options for unarchiving with digest: %@", buf, 0x16u);
      }
  ...
  else
  {
    if (v6)
    {
      ...
      *buf = 138543362;
      v44 = v29;
      _os_log_impl(&dword_2531F8000, v5, OS_LOG_TYPE_DEFAULT, "%{public}@Unable to unarchive, asset is not downloaded", buf, 0xCu);
    }
...
uint64_t __53__HMDSoftwareUpdateDocumentationAsset_finishDownload__block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_DEFAULT))
  {
    ...
    v9 = 138543362;
    v10 = v5;
    _os_log_impl(&dword_2531F8000, v4, OS_LOG_TYPE_DEFAULT, "%{public}@Finished download", &v9, 0xCu);
  }
...
uint64_t __53__HMDSoftwareUpdateDocumentationAsset_cancelDownload__block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_DEFAULT))
  {
    ...
    v9 = 138543362;
    v10 = v5;
    _os_log_impl(&dword_2531F8000, v4, OS_LOG_TYPE_DEFAULT, "%{public}@Cancelling download", &v9, 0xCu);
  }
...
LABEL_16:
      _os_log_impl(&dword_2531F8000, v7, v8, v6, &v34, 0xCu);
...
LABEL_18:
  ...
  if ((v9 & 1) == 0)
  {
    if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
    {
      ...
      v34 = 138543362;
      v35 = v29;
      _os_log_impl(&dword_2531F8000, v12, OS_LOG_TYPE_INFO, "%{public}@Not attempting to download documentation now as we are in a backoff", &v34, 0xCu);
    }
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_DEFAULT))
  {
    ...
    v34 = 138543362;
    v35 = v13;
    _os_log_impl(&dword_2531F8000, v12, OS_LOG_TYPE_DEFAULT, "%{public}@Starting download", &v34, 0xCu);
  }
  ...
  if (v21)
  {
    ...
    if (os_log_type_enabled(v26, OS_LOG_TYPE_INFO))
    {
      ...
      v36 = 2112;
      v37 = v23;
      _os_log_impl(&dword_2531F8000, v26, OS_LOG_TYPE_INFO, "%{public}@Resuming task: %@", &v34, 0x16u);
    }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v32, OS_LOG_TYPE_ERROR))
    {
      ...
      v34 = 138543362;
      v35 = v33;
      _os_log_impl(&dword_2531F8000, v32, OS_LOG_TYPE_ERROR, "%{public}@Cannot download software update from nil url", &v34, 0xCu);
    }
...
- (BOOL)purgeWithError:(id *)error
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_DEFAULT))
  {
    ...
    v14 = 138543362;
    v15 = v8;
    _os_log_impl(&dword_2531F8000, v7, OS_LOG_TYPE_DEFAULT, "%{public}@Purging", &v14, 0xCu);
  }
  ...
  if (v7)
  {
      ...
      if ((v13 & 1) == 0)
      {
        ...
        if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR))
        {
          ...
          *buf = 138543618;
          ...
          v35 = 2112;
          v36 = v14;
          _os_log_impl(&dword_2531F8000, v17, OS_LOG_TYPE_ERROR, "%{public}@Failed to archive asset metadata (write) %@", buf, 0x16u);
        }
    ...
    else
    {
      ...
      if (os_log_type_enabled(v27, OS_LOG_TYPE_ERROR))
      {
        ...
        *buf = 138543362;
        v34 = v28;
        _os_log_impl(&dword_2531F8000, v27, OS_LOG_TYPE_ERROR, "%{public}@Failed to archive asset metadata (encode)", buf, 0xCu);
      }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR))
    {
      ...
      *buf = 138543618;
      ...
      v35 = 2112;
      v36 = v8;
      _os_log_impl(&dword_2531F8000, v22, OS_LOG_TYPE_ERROR, "%{public}@Failed to create asset directory with error: %@", buf, 0x16u);
    }
...
- (void)resetDownloadRetryCount
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    v9 = 138543362;
    v10 = v7;
    _os_log_impl(&dword_2531F8000, v6, OS_LOG_TYPE_INFO, "%{public}@Resetting download retry count", &v9, 0xCu);
  }
...
- (void)increaseDownloadRetryCount
{
  ...
  if (downloadRetryCount >= [&unk_286627148 count])
  {
    downloadRetryCount2 = [&unk_286627148 count] - 1;
  }
  ...
  v5 = [&unk_286627148 objectAtIndexedSubscript:downloadRetryCount2];
  ...
  if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
  {
    ...
    _os_log_impl(&dword_2531F8000, v12, OS_LOG_TYPE_INFO, "%{public}@Increased download retry count to: %lu next retry is at: %@", &v15, 0x20u);
  }
...
- (HMSoftwareUpdateDocumentation)documentation
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_DEFAULT))
  {
    ...
    v23 = 138543362;
    v24 = v6;
    _os_log_impl(&dword_2531F8000, v5, OS_LOG_TYPE_DEFAULT, "%{public}@Parsing documentation", &v23, 0xCu);
  }
  ...
  if (state == 4)
  {
    ...
    if (!v11 || (v12 = objc_alloc(MEMORY[0x277CD1E58]), -[HMDSoftwareUpdateDocumentationAsset fileManager](selfCopy, "fileManager"), v13 = objc_claimAutoreleasedReturnValue(), v14 = [v12 initWithBundle:v11 fileManager:v13], v13, !v14))
    {
      ...
      if (os_log_type_enabled(v17, OS_LOG_TYPE_INFO))
      {
        ...
        v23 = 138543362;
        v24 = v18;
        _os_log_impl(&dword_2531F8000, v17, OS_LOG_TYPE_INFO, "%{public}@Failed to find documentation bundle", &v23, 0xCu);
      }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
    {
      ...
      v23 = 138543362;
      v24 = v20;
      _os_log_impl(&dword_2531F8000, v19, OS_LOG_TYPE_INFO, "%{public}@Documentation not cached", &v23, 0xCu);
    }
...
- (HMDSoftwareUpdateDocumentationAsset)initWithDocumentationMetadata:(id)metadata
{
  ...
  v8 = [(HMDSoftwareUpdateDocumentationAsset *)self initWithDocumentationMetadata:metadataCopy dateWithTimeIntervalSinceNowFactory:&__block_literal_global_163 URLSessionFactory:&__block_literal_global_166_120716 extractorFactory:&__block_literal_global_170_120717 notificationCenter:defaultCenter fileManager:v7];
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t74_120742 != -1)
  {
    dispatch_once(&logCategory__hmf_once_t74_120742, &__block_literal_global_190_120743);
  }

  v3 = logCategory__hmf_once_v75_120744;
...
uint64_t __50__HMDSoftwareUpdateDocumentationAsset_logCategory__block_invoke()
{
  ...
  v2 = logCategory__hmf_once_v75_120744;
  logCategory__hmf_once_v75_120744 = v1;
      ...
      if (v10)
      {
        ...
        if (v15 != [v10 state])
        {
          ...
          if (os_log_type_enabled(v30, OS_LOG_TYPE_DEFAULT))
          {
            ...
            v32 = off_27972C030[v15];
            *buf = 138543618;
            v38 = v31;
            v39 = 2112;
            v40 = v32;
            _os_log_impl(&dword_2531F8000, v30, OS_LOG_TYPE_DEFAULT, "%{public}@Setting state to: %@", buf, 0x16u);
          }
      ...
      else
      {
        ...
        if (os_log_type_enabled(v26, OS_LOG_TYPE_ERROR))
        {
          ...
          *buf = 138543618;
          ...
          v39 = 2112;
          v40 = v11;
          _os_log_impl(&dword_2531F8000, v26, OS_LOG_TYPE_ERROR, "%{public}@Failed to unarchive software update documentation asset from serialized object data: %@", buf, 0x16u);
        }
    ...
    else
    {
      ...
      if (os_log_type_enabled(v18, OS_LOG_TYPE_ERROR))
      {
        ...
        *buf = 138543618;
        ...
        v39 = 2112;
        v40 = path2;
        _os_log_impl(&dword_2531F8000, v18, OS_LOG_TYPE_ERROR, "%{public}@Failed to find metadata at path: %@", buf, 0x16u);
      }
...
+ (NSURL)assetDirectoryURL
{
  ...
  {
    dispatch_once(&assetDirectoryURL_onceToken, &__block_literal_global_148_120753);
  }
