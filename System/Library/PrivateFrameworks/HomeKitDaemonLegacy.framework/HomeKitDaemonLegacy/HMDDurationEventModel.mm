...
+ (id)properties
{
  ...
  block[4] = self;
  if (properties_onceToken_182185 != -1)
  {
    dispatch_once(&properties_onceToken_182185, block);
  }

  v2 = properties__properties_182186;
...
void __35__HMDDurationEventModel_properties__block_invoke(uint64_t a1)
{
  ...
  v4 = properties__properties_182186;
  properties__properties_182186 = v3;

  v5 = properties__properties_182186;
  v10 = @"duration";
