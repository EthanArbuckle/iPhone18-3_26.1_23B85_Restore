  ...
  if (v4)
  {
    ...
    if (v5 && [v5 isCurrentDevice])
    {
      ...
      if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
      {
        ...
        v19 = 2112;
        v20 = v13;
        _os_log_impl(&dword_2531F8000, v9, OS_LOG_TYPE_INFO, "%{public}@Current device was added as a resident device (%@ / %@) notification.", &v15, 0x20u);
      }
...
- (void)_disableCharacteristicNotifications
{
  ...
  if ([v3 count])
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      v15 = 2112;
      v16 = v3;
      _os_log_impl(&dword_2531F8000, v9, OS_LOG_TYPE_INFO, "%{public}@Disabling notifications for characteristics :%@", &v13, 0x16u);
    }
...
{
  v9 = a3;
  v6 = [a4 na_filter:&__block_literal_global_167926];
  if ([v6 count])
  {
    v7 = [v6 firstObject];
...
- (id)_mediaSessionStateFromProfile
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
    {
      ...
      v14 = 138543362;
      v15 = v11;
      _os_log_impl(&dword_2531F8000, v10, OS_LOG_TYPE_ERROR, "%{public}@Failed to derive media session state from profile due to no accessory", &v14, 0xCu);
    }
