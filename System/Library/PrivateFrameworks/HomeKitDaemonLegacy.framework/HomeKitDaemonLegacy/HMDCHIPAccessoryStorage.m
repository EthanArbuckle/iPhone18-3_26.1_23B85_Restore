...
LABEL_7:
  ...
  if (os_log_type_enabled(v3, OS_LOG_TYPE_INFO))
  {
    ...
    v106 = 2112;
    v107 = v13;
    _os_log_impl(&dword_2531F8000, v3, OS_LOG_TYPE_INFO, "%{public}@Updating storage node ID from %@ to %@", &v102, 0x20u);
  }
...
LABEL_8:
  ...
  if (v16)
  {
    ...
    if (([v3 isEqualToNumber:&unk_286627AC0]& 1) == 0)
    {
      goto LABEL_18;
    }
  }
...
LABEL_19:
  ...
  if ((v20 & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v3, OS_LOG_TYPE_INFO))
    {
      ...
      v106 = 2112;
      v107 = v25;
      _os_log_impl(&dword_2531F8000, v3, OS_LOG_TYPE_INFO, "%{public}@Updating storage vendor ID from %@ to %@", &v102, 0x20u);
    }
...
LABEL_62:
  ...
  if (v89)
  {
    ...
    if (v90)
    {
      ...
      if (([v89 isEqualToNumber:&unk_286627AC0] & 1) == 0)
      {
