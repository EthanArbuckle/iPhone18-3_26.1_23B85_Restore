...
- (void)driver:(id)a3 didUpdatePrimaryUserInfo:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
  {
    ...
    v13 = 138543362;
    v14 = v11;
    _os_log_impl(&dword_2531F8000, v10, OS_LOG_TYPE_ERROR, "%{public}@Primary user is not supported", &v13, 0xCu);
  }
...
void __90__HMDFetchedAccessorySettingsController_updateSettingWithKeyPath_settingValue_completion___block_invoke(uint64_t a1)
{
  ...
  if (v5)
  {
    if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
    {
      ...
      v39 = 2114;
      v40 = v11;
      _os_log_impl(&dword_2531F8000, v9, OS_LOG_TYPE_INFO, "%{public}@Got setting update request keyPath: %{public}@", &v37, 0x16u);
    }
    ...
    else
    {
      if (!v20)
      {
        ...
        if (os_log_type_enabled(v32, OS_LOG_TYPE_ERROR))
        {
          ...
          v41 = 2112;
          v42 = v35;
          _os_log_impl(&dword_2531F8000, v32, OS_LOG_TYPE_ERROR, "%{public}@Do not support provided type for update keypath: %{public}@ settingValue: %@", &v37, 0x20u);
        }
...
LABEL_23:
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_ERROR))
  {
    ...
    v41 = 2114;
    v42 = v27;
    _os_log_impl(&dword_2531F8000, v9, OS_LOG_TYPE_ERROR, "%{public}@Provided keypath: %{public}@ not in available keypaths: %{public}@", &v37, 0x20u);
  }
...
void __77__HMDFetchedAccessorySettingsController_fetchSettingsForKeyPaths_completion___block_invoke_2(uint64_t a1)
{
  ...
  if ([*(a1 + 32) count])
  {
    ...
    if (os_log_type_enabled(v4, OS_LOG_TYPE_DEBUG))
    {
      ...
      v15 = 138543362;
      v16 = v5;
      _os_log_impl(&dword_2531F8000, v4, OS_LOG_TYPE_DEBUG, "%{public}@At least one of the driver's returned an error setting error on completion", &v15, 0xCu);
    }
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    v19 = 2112;
    v20 = v12;
    _os_log_impl(&dword_2531F8000, v9, OS_LOG_TYPE_INFO, "%{public}@Finishing fetch request for keyPaths: %{public}@ restuls: %@", &v15, 0x20u);
  }
...
void __46__HMDFetchedAccessorySettingsController_start__block_invoke(uint64_t a1)
{
  ...
  v43[1] = v43;
  v43[2] = 0x3032000000;
  v43[3] = __Block_byref_object_copy__175161;
  v43[4] = __Block_byref_object_dispose__175162;
  v44 = 0;
  v39 = 0u;
  v40 = 0u;
  v41 = 0u;
...
uint64_t __52__HMDFetchedAccessorySettingsController_logCategory__block_invoke()
{
  ...
  v2 = logCategory__hmf_once_v1_175195;
  logCategory__hmf_once_v1_175195 = v1;
