...
- (id)plistPath
{
  ...
  if (!plistPath)
  {
    v4 = [(TESLocalizedPListLoader *)self _resolvePlistPath];
    v5 = self->_plistPath;
    self->_plistPath = v4;
...
- (id)_resolvePlistPath
{
  ...
  {
    v6 = [(TESLocalizedPListLoader *)self localeIdentifier];
  ...
  *(&buf + 1) = &buf;
  ...
  v34 = [v7 URLForResource:v8 withExtension:@"plist" subdirectory:0 localization:v4];
  ...
  if (!v9)
  {
    ...
    if (([(__CFString *)v11 isEqualToString:@"nb-NO"]& 1) != 0 || [(__CFString *)v11 isEqualToString:@"nn"])
    {
    ...
    v15 = [v7 URLForResource:v14 withExtension:@"plist" subdirectory:0 localization:v11];
    v16 = *(*(&buf + 1) + 40);
    *(*(&buf + 1) + 40) = v15;
...
- (id)_loadItems
{
  ...
  {
    v22 = 0;
    v4 = [MEMORY[0x1E695DF20] dictionaryWithContentsOfURL:v3 error:&v22];
    v5 = v22;
    if (v5)
    {
      v6 = 1;
    ...
    if (v6 || ![v4 count])
    {
      ...
      if (os_log_type_enabled(v7, OS_LOG_TYPE_ERROR))
      {
        ...
        v19 = [(TESLocalizedPListLoader *)self localeIdentifier];
