...
LABEL_47:
            ...
            v28 = [(SFArchiveViewCardSection *)self type];
            v29 = [(SFArchiveViewCardSection *)v6 type];
            if ((v28 != 0) != (v29 == 0))
            {
              v53 = v29;
              ...
              if (v52)
              {
                v30 = [(SFArchiveViewCardSection *)self type];
...
LABEL_66:
                    ...
                    {
                      v41 = [(SFArchiveViewCardSection *)self archive];
                      if (v41)
                      {
                        v42 = v41;
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v11 = [(SFArchiveViewCardSection *)self type];
  v12 = [v11 copy];
  [v4 setType:v12];
  ...
  v15 = [(SFArchiveViewCardSection *)self archive];
  v16 = [v15 copy];
  [v4 setArchive:v16];
...
- (NSData)jsonData
{
  ...
  v3 = [(_SFPBArchiveViewCardSection *)v2 jsonData];
...
{
  v2 = [[_SFPBArchiveViewCardSection alloc] initWithFacade:self];
  v3 = [(_SFPBArchiveViewCardSection *)v2 dictionaryRepresentation];
