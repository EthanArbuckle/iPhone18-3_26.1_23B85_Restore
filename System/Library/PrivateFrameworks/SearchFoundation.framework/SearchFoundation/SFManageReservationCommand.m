...
- (BOOL)isEqual:(id)a3
{
  ...
  else if ([(SFManageReservationCommand *)v4 isMemberOfClass:objc_opt_class()]&& (v10.receiver = self, v10.super_class = SFManageReservationCommand, [(SFCommand *)&v10 isEqual:v4]))
  {
    v5 = v4;
    v6 = [(SFManageReservationCommand *)self placeHolderProperty];
    v7 = [(SFManageReservationCommand *)v5 placeHolderProperty];
...
- (NSData)jsonData
{
  ...
  v3 = [(_SFPBManageReservationCommand *)v2 jsonData];
...
{
  v2 = [[_SFPBManageReservationCommand alloc] initWithFacade:self];
  v3 = [(_SFPBManageReservationCommand *)v2 dictionaryRepresentation];
