...
- (BOOL)isEqual:(id)a3
{
  ...
  else
  {
    if ([(RFPrimaryHeaderStackedImageCardSection *)v5 isMemberOfClass:objc_opt_class()])
    {
      ...
      {
        v6 = v5;
        v7 = [(RFPrimaryHeaderStackedImageCardSection *)self text];
...
LABEL_31:
        ...
        v9 = [(RFPrimaryHeaderStackedImageCardSection *)self text];
        if (v9)
        {
          v3 = [(RFPrimaryHeaderStackedImageCardSection *)self text];
        ...
        else
        {
          v24 = v17;
          v26 = v18;
          v19 = [(RFPrimaryHeaderStackedImageCardSection *)self images];
          v15 = v29;
          if (v19)
          {
            v23 = v19;
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v5 = [(RFPrimaryHeaderStackedImageCardSection *)self text];
  v6 = [v5 copy];
  [v4 setText_1:v6];
  ...
  v9 = [(RFPrimaryHeaderStackedImageCardSection *)self images];
  v10 = [v9 copy];
  [v4 setImages:v10];
...
- (NSData)jsonData
{
  ...
  v3 = [(_SFPBRFPrimaryHeaderStackedImageCardSection *)v2 jsonData];
...
{
  v2 = [[_SFPBRFPrimaryHeaderStackedImageCardSection alloc] initWithFacade:self];
  v3 = [(_SFPBRFPrimaryHeaderStackedImageCardSection *)v2 dictionaryRepresentation];
