...
- (SFFlightCardSection)initWithProtobuf:(id)a3
{
  ...
  v4 = a3;
  v35.receiver = self;
  v35.super_class = SFFlightCardSection;
...
- (unint64_t)hash
{
  ...
  v20 = [(SFFlightCardSection *)self selectedLegIndex];
...
LABEL_28:
            ...
            if ((v28 != 0) != (v29 == 0))
            {
              v55 = v29;
              v69 = v28;
              v30 = [(SFFlightCardSection *)self type];
              if (v30)
              {
...
LABEL_65:
                ...
                if (!v41 || (-[SFFlightCardSection flight](self, "flight"), v42 = objc_claimAutoreleasedReturnValue(), -[SFFlightCardSection flight](v6, "flight"), v44 = objc_claimAutoreleasedReturnValue(), v45 = v42, [v42 isEqual:?]))
                {
                  v43 = [(SFFlightCardSection *)self selectedLegIndex];
                  v11 = v43 == [(SFFlightCardSection *)v6 selectedLegIndex];
                  if (!v41)
                  {
                    goto LABEL_76;
                  }
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v11 = [(SFFlightCardSection *)self type];
  v12 = [v11 copy];
  [v4 setType:v12];
  ...
  v15 = [(SFFlightCardSection *)self flight];
  v16 = [v15 copy];
  [v4 setFlight:v16];
...
- (NSData)jsonData
{
  ...
  v3 = [(_SFPBFlightCardSection *)v2 jsonData];
...
{
  v2 = [[_SFPBFlightCardSection alloc] initWithFacade:self];
  v3 = [(_SFPBFlightCardSection *)v2 dictionaryRepresentation];
