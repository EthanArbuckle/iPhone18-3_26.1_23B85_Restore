...
LABEL_65:
                ...
                if (!v53 || (-[SFMapsDetailedRowCardSection mapsData](self, "mapsData"), v44 = objc_claimAutoreleasedReturnValue(), -[SFMapsDetailedRowCardSection mapsData](v6, "mapsData"), v50 = objc_claimAutoreleasedReturnValue(), v51 = v44, [v44 isEqual:?]))
                {
                  v52 = [(SFMapsDetailedRowCardSection *)self pinText];
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v11 = [(SFMapsDetailedRowCardSection *)self type];
  v12 = [v11 copy];
  [v4 setType:v12];
  ...
  v15 = [(SFMapsDetailedRowCardSection *)self mapsData];
  v16 = [v15 copy];
  [v4 setMapsData:v16];

  v17 = [(SFMapsDetailedRowCardSection *)self pinText];
  v18 = [v17 copy];
  [v4 setPinText:v18];
...
- (NSData)jsonData
{
  ...
  v3 = [(_SFPBMapsDetailedRowCardSection *)v2 jsonData];
...
{
  v2 = [[_SFPBMapsDetailedRowCardSection alloc] initWithFacade:self];
  v3 = [(_SFPBMapsDetailedRowCardSection *)v2 dictionaryRepresentation];
