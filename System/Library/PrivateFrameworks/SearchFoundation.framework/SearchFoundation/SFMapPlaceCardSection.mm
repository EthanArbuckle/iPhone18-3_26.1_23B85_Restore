...
- (unint64_t)hash
{
  ...
  v20 = [(SFMapPlaceCardSection *)self shouldSearchDirectionsAlongCurrentRoute];
...
LABEL_27:
            ...
            v65 = v13;
            v31 = [(SFMapPlaceCardSection *)self type];
            v32 = [(SFMapPlaceCardSection *)v6 type];
            if ((v31 != 0) != (v32 == 0))
            {
              v78 = v31;
              v64 = v32;
              v33 = [(SFMapPlaceCardSection *)self type];
              if (v33)
              {
                v34 = [(SFMapPlaceCardSection *)self type];
                v35 = [(SFMapPlaceCardSection *)v6 type];
                v62 = v34;
                v36 = v34;
                v31 = v35;
                if (![v36 isEqual:v35])
...
LABEL_82:
                ...
                v48 = [(SFMapPlaceCardSection *)self shouldSearchDirectionsAlongCurrentRoute];
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v11 = [(SFMapPlaceCardSection *)self type];
  v12 = [v11 copy];
  [v4 setType:v12];
  ...
  v15 = [(SFMapPlaceCardSection *)self mapsData];
  v16 = [v15 copy];
  [v4 setMapsData:v16];
  ...
  v17 = [(SFMapPlaceCardSection *)self detourInfoData];
  v18 = [v17 copy];
...
- (NSData)jsonData
{
  ...
  v3 = [(_SFPBMapPlaceCardSection *)v2 jsonData];
...
{
  v2 = [[_SFPBMapPlaceCardSection alloc] initWithFacade:self];
  v3 = [(_SFPBMapPlaceCardSection *)v2 dictionaryRepresentation];
...
- (SFMapPlaceCardSection)initWithCoder:(id)a3
{
  ...
  if (objc_opt_isKindOfClass())
  {
    ...
    v15 = [(SFCardSection *)v8 detourInfoData];
