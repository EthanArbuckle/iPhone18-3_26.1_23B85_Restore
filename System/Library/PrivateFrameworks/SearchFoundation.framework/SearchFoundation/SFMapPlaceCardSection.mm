...
- (SFMapPlaceCardSection)initWithCoder:(id)coder;
- (SFMapPlaceCardSection)initWithProtobuf:(id)protobuf;
...
- (SFMapPlaceCardSection)initWithProtobuf:(id)protobuf
{
  ...
  v35.receiver = self;
  v35.super_class = SFMapPlaceCardSection;
  ...
  if (v5)
  {
    ...
    if (type)
    {
      ...
      [(SFMapPlaceCardSection *)v5 setType:type2];
    }
    ...
    if (mapsData)
    {
      ...
      [(SFMapPlaceCardSection *)v5 setMapsData:mapsData2];
    }

    if ([protobufCopy shouldSearchDirectionsAlongCurrentRoute])
    {
      -[SFMapPlaceCardSection setShouldSearchDirectionsAlongCurrentRoute:](v5, "setShouldSearchDirectionsAlongCurrentRoute:", [protobufCopy shouldSearchDirectionsAlongCurrentRoute]);
    }

    detourInfoData = [protobufCopy detourInfoData];

    if (detourInfoData)
    {
      detourInfoData2 = [protobufCopy detourInfoData];
      [(SFMapPlaceCardSection *)v5 setDetourInfoData:detourInfoData2];
    }
...
{
  v24.receiver = self;
  v24.super_class = SFMapPlaceCardSection;
  ...
  type = [(SFMapPlaceCardSection *)self type];
  v14 = hasBottomPadding ^ [type hash];
  v15 = v14 ^ [(SFCardSection *)self separatorStyle];
  backgroundColor = [(SFCardSection *)self backgroundColor];
  v17 = v15 ^ [backgroundColor hash];
  mapsData = [(SFMapPlaceCardSection *)self mapsData];
  v19 = v11 ^ v17 ^ [mapsData hash];
  shouldSearchDirectionsAlongCurrentRoute = [(SFMapPlaceCardSection *)self shouldSearchDirectionsAlongCurrentRoute];
  detourInfoData = [(SFMapPlaceCardSection *)self detourInfoData];
  v22 = shouldSearchDirectionsAlongCurrentRoute ^ [detourInfoData hash];
...
- (BOOL)isEqual:(id)equal
{
  ...
  {
    if ([(SFMapPlaceCardSection *)equalCopy isMemberOfClass:objc_opt_class()])
    {
      v80.receiver = self;
      v80.super_class = SFMapPlaceCardSection;
...
LABEL_27:
            ...
            type = [(SFMapPlaceCardSection *)self type];
            type2 = [(SFMapPlaceCardSection *)v6 type];
            if ((type != 0) != (type2 == 0))
            {
              v78 = type;
              v64 = type2;
              type3 = [(SFMapPlaceCardSection *)self type];
              if (type3)
              {
                type4 = [(SFMapPlaceCardSection *)self type];
                type5 = [(SFMapPlaceCardSection *)v6 type];
                v62 = type4;
                v36 = type4;
                type = type5;
              ...
              if ((backgroundColor != 0) != (backgroundColor2 == 0))
              {
                ...
                mapsData = [(SFMapPlaceCardSection *)self mapsData];
                mapsData2 = [(SFMapPlaceCardSection *)v6 mapsData];
                v46 = mapsData2;
...
LABEL_65:
                ...
                mapsData3 = [(SFMapPlaceCardSection *)self mapsData];
                if (mapsData3)
                {
                  mapsData4 = [(SFMapPlaceCardSection *)self mapsData];
                  mapsData5 = [(SFMapPlaceCardSection *)v6 mapsData];
                  v55 = mapsData4;
...
LABEL_82:
                ...
                shouldSearchDirectionsAlongCurrentRoute = [(SFMapPlaceCardSection *)self shouldSearchDirectionsAlongCurrentRoute];
                if (shouldSearchDirectionsAlongCurrentRoute == [(SFMapPlaceCardSection *)v6 shouldSearchDirectionsAlongCurrentRoute])
                {
                  detourInfoData = [(SFMapPlaceCardSection *)self detourInfoData];
                  detourInfoData2 = [(SFMapPlaceCardSection *)v6 detourInfoData];
                  if ((detourInfoData != 0) != (detourInfoData2 == 0))
                  {
                    detourInfoData3 = [(SFMapPlaceCardSection *)self detourInfoData];
                    if (detourInfoData3)
                    {
                      detourInfoData4 = [(SFMapPlaceCardSection *)self detourInfoData];
                      detourInfoData5 = [(SFMapPlaceCardSection *)v6 detourInfoData];
                      v11 = [detourInfoData4 isEqual:detourInfoData5];
                    }
...
{
  v20.receiver = self;
  v20.super_class = SFMapPlaceCardSection;
  ...
  [v4 setShouldSearchDirectionsAlongCurrentRoute:{-[SFMapPlaceCardSection shouldSearchDirectionsAlongCurrentRoute](self, "shouldSearchDirectionsAlongCurrentRoute")}];
  detourInfoData = [(SFMapPlaceCardSection *)self detourInfoData];
  v18 = [detourInfoData copy];
...
- (NSData)jsonData
{
  ...
  jsonData = [(_SFPBMapPlaceCardSection *)v2 jsonData];
...
{
  v2 = [[_SFPBMapPlaceCardSection alloc] initWithFacade:self];
  dictionaryRepresentation = [(_SFPBMapPlaceCardSection *)v2 dictionaryRepresentation];
...
{
  v3.receiver = self;
  v3.super_class = SFMapPlaceCardSection;
...
- (SFMapPlaceCardSection)initWithCoder:(id)coder
{
  ...
  if (objc_opt_isKindOfClass())
  {
    ...
    [(SFMapPlaceCardSection *)v5 setType:type];

    [(SFCardSection *)v5 setSeparatorStyle:[(SFCardSection *)v8 separatorStyle]];
    backgroundColor = [(SFCardSection *)v8 backgroundColor];
    [(SFCardSection *)v5 setBackgroundColor:backgroundColor];

    mapsData = [(SFCardSection *)v8 mapsData];
    [(SFMapPlaceCardSection *)v5 setMapsData:mapsData];
    ...
    detourInfoData = [(SFCardSection *)v8 detourInfoData];
    [(SFMapPlaceCardSection *)v5 setDetourInfoData:detourInfoData];
