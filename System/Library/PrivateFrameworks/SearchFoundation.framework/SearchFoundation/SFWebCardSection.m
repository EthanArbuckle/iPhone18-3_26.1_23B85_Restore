...
- (SFWebCardSection)initWithProtobuf:(id)a3
{
  ...
  v4 = a3;
  v33.receiver = self;
  v33.super_class = SFWebCardSection;
...
{
  v21.receiver = self;
  v21.super_class = SFWebCardSection;
...
- (BOOL)isEqual:(id)a3
{
  ...
  else
  {
    ...
    {
      v70.receiver = self;
      v70.super_class = SFWebCardSection;
...
LABEL_47:
            ...
            v28 = [(SFWebCardSection *)self type];
            v29 = [(SFWebCardSection *)v6 type];
            if ((v28 != 0) != (v29 == 0))
            {
              v53 = v29;
              [(SFWebCardSection *)self type];
              v52 = v51 = v28;
              if (v52)
              {
                v30 = [(SFWebCardSection *)self type];
...
LABEL_66:
                    ...
                    {
                      v41 = [(SFWebCardSection *)self htmlString];
                      if (v41)
                      {
                        v42 = v41;
...
{
  v18.receiver = self;
  v18.super_class = SFWebCardSection;
  ...
  v11 = [(SFWebCardSection *)self type];
  v12 = [v11 copy];
  [v4 setType:v12];
  ...
  v15 = [(SFWebCardSection *)self htmlString];
  v16 = [v15 copy];
...
- (NSData)jsonData
{
  ...
  v3 = [(_SFPBWebCardSection *)v2 jsonData];
...
{
  v2 = [[_SFPBWebCardSection alloc] initWithFacade:self];
  v3 = [(_SFPBWebCardSection *)v2 dictionaryRepresentation];
...
{
  v3.receiver = self;
  v3.super_class = SFWebCardSection;
...
- (SFWebCardSection)initWithCoder:(id)a3
{
  ...
  if (objc_opt_isKindOfClass())
  {
    ...
    v14 = [(SFCardSection *)v8 htmlString];
