  ...
  else
  {
    if ([(RFSimpleItemPlayerCardSection *)v4 isMemberOfClass:objc_opt_class()])
    {
      ...
      if ([(SFCardSection *)&v50 isEqual:v4])
      {
        v5 = v4;
        v6 = [(RFSimpleItemPlayerCardSection *)self text];
        v7 = [(RFSimpleItemPlayerCardSection *)v5 text];
        if ((v6 != 0) == (v7 == 0))
        {
          v10 = 0;
LABEL_51:
        ...
        if (v8)
        {
          v9 = [(RFSimpleItemPlayerCardSection *)self text];
        ...
        v11 = [(RFSimpleItemPlayerCardSection *)v5 text];
        if ((v49 != 0) != (v11 == 0))
        {
          v12 = [(RFSimpleItemPlayerCardSection *)self text];
          if (v12)
          {
            v13 = v12;
          ...
          v15 = [(RFSimpleItemPlayerCardSection *)self text];
...
LABEL_43:
              ...
              else
              {
                v32 = v25;
                v34 = v24;
                v26 = [(RFSimpleItemPlayerCardSection *)self player];
                v20 = v45;
                v27 = v37;
                if (v26)
                {
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v5 = [(RFSimpleItemPlayerCardSection *)self text];
  v6 = [v5 copy];
  [v4 setText_1:v6];

  v7 = [(RFSimpleItemPlayerCardSection *)self text];
  v8 = [v7 copy];
  [v4 setText_2:v8];
  ...
  v11 = [(RFSimpleItemPlayerCardSection *)self text];
  v12 = [v11 copy];
  [v4 setText_4:v12];

  v13 = [(RFSimpleItemPlayerCardSection *)self player];
  v14 = [v13 copy];
  [v4 setPlayer:v14];
...
- (NSData)jsonData
{
  ...
  v3 = [(_SFPBRFSimpleItemPlayerCardSection *)v2 jsonData];
...
{
  v2 = [[_SFPBRFSimpleItemPlayerCardSection alloc] initWithFacade:self];
  v3 = [(_SFPBRFSimpleItemPlayerCardSection *)v2 dictionaryRepresentation];
...
- (RFSimpleItemPlayerCardSection)initWithProtobuf:(id)a3
{
  ...
  v4 = a3;
  v37.receiver = self;
  v37.super_class = RFSimpleItemPlayerCardSection;
