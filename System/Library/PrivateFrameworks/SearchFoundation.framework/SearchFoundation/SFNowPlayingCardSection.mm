...
LABEL_24:
                    ...
                    {
                      v39 = [(SFNowPlayingCardSection *)self movies];
                      v38 = [(SFNowPlayingCardSection *)v5 movies];
                      if ((v39 != 0) == (v38 == 0))
                      {
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v19 = [(SFNowPlayingCardSection *)self movies];
  v20 = [v19 copy];
  [v4 setMovies:v20];
...
- (NSData)jsonData
{
  ...
  v3 = [(_SFPBNowPlayingCardSection *)v2 jsonData];
...
{
  v2 = [[_SFPBNowPlayingCardSection alloc] initWithFacade:self];
  v3 = [(_SFPBNowPlayingCardSection *)v2 dictionaryRepresentation];
...
- (SFNowPlayingCardSection)initWithProtobuf:(id)a3
{
  ...
  v4 = a3;
  v47.receiver = self;
  v47.super_class = SFNowPlayingCardSection;
