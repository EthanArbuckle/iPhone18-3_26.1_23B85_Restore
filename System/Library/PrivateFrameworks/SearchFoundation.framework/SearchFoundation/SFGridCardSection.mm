...
LABEL_66:
                    ...
                    {
                      v41 = [(SFGridCardSection *)self cardSections];
                      if (v41)
                      {
                        v42 = v41;
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v11 = [(SFGridCardSection *)self type];
  v12 = [v11 copy];
  [v4 setType:v12];
  ...
  v15 = [(SFGridCardSection *)self cardSections];
  v16 = [v15 copy];
...
- (NSData)jsonData
{
  ...
  v3 = [(_SFPBGridCardSection *)v2 jsonData];
...
{
  v2 = [[_SFPBGridCardSection alloc] initWithFacade:self];
  v3 = [(_SFPBGridCardSection *)v2 dictionaryRepresentation];
