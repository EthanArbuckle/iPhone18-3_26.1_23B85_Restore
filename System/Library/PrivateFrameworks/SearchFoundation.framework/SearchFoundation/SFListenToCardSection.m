...
LABEL_65:
                ...
                if (!v53 || (-[SFListenToCardSection mediaMetadata](self, "mediaMetadata"), v44 = objc_claimAutoreleasedReturnValue(), -[SFListenToCardSection mediaMetadata](v6, "mediaMetadata"), v50 = objc_claimAutoreleasedReturnValue(), v51 = v44, [v44 isEqual:?]))
                {
                  v52 = [(SFListenToCardSection *)self fallbackCardSection];
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v11 = [(SFListenToCardSection *)self type];
  v12 = [v11 copy];
  [v4 setType:v12];
  ...
  v15 = [(SFListenToCardSection *)self mediaMetadata];
  v16 = [v15 copy];
  [v4 setMediaMetadata:v16];

  v17 = [(SFListenToCardSection *)self fallbackCardSection];
  v18 = [v17 copy];
...
- (NSData)jsonData
{
  ...
  v3 = [(_SFPBListenToCardSection *)v2 jsonData];
...
{
  v2 = [[_SFPBListenToCardSection alloc] initWithFacade:self];
  v3 = [(_SFPBListenToCardSection *)v2 dictionaryRepresentation];
...
- (SFListenToCardSection)initWithCoder:(id)a3
{
  ...
  if (objc_opt_isKindOfClass())
  {
    ...
    v14 = [(SFCardSection *)v8 mediaMetadata];
    [(SFListenToCardSection *)v5 setMediaMetadata:v14];

    v15 = [(SFCardSection *)v8 fallbackCardSection];
...
- (SFListenToCardSection)initWithProtobuf:(id)a3
{
  ...
  v4 = a3;
  v39.receiver = self;
  v39.super_class = SFListenToCardSection;
