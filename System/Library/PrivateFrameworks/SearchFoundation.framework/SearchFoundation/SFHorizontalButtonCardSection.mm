...
- (SFHorizontalButtonCardSection)initWithProtobuf:(id)protobuf
{
  ...
  if (v5)
  {
    ...
    v27 = [buttonCardSections2 countByEnumeratingWithState:&v35 objects:v44 count:16];
    if (v27)
    {
      v28 = v27;
      v29 = *v36;
      do
      {
        ...
        v28 = [buttonCardSections2 countByEnumeratingWithState:&v35 objects:v44 count:16];
      }
