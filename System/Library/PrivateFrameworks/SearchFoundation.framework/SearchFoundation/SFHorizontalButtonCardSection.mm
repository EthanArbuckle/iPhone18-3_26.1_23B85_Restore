...
LABEL_66:
                    ...
                    {
                      v41 = [(SFHorizontalButtonCardSection *)self buttonCardSections];
                      if (v41)
                      {
                        v42 = v41;
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v11 = [(SFHorizontalButtonCardSection *)self type];
  v12 = [v11 copy];
  [v4 setType:v12];
  ...
  v15 = [(SFHorizontalButtonCardSection *)self buttonCardSections];
  v16 = [v15 copy];
...
- (NSData)jsonData
{
  ...
  v3 = [(_SFPBHorizontalButtonCardSection *)v2 jsonData];
...
{
  v2 = [[_SFPBHorizontalButtonCardSection alloc] initWithFacade:self];
  v3 = [(_SFPBHorizontalButtonCardSection *)v2 dictionaryRepresentation];
...
- (SFHorizontalButtonCardSection)initWithCoder:(id)a3
{
  ...
  if (objc_opt_isKindOfClass())
  {
    ...
    v14 = [(SFCardSection *)v8 buttonCardSections];
...
- (SFHorizontalButtonCardSection)initWithProtobuf:(id)a3
{
  ...
  v4 = a3;
  v43.receiver = self;
  v43.super_class = SFHorizontalButtonCardSection;
