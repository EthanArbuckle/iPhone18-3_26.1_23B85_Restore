...
- (SFButtonCardSection)initWithCoder:(id)coder;
- (SFButtonCardSection)initWithProtobuf:(id)protobuf;
...
- (SFButtonCardSection)initWithProtobuf:(id)protobuf
{
  ...
  if (v5)
  {
    ...
    if (type)
    {
      ...
      [(SFButtonCardSection *)v5 setType:type2];
    }
    ...
    if (thumbnail)
    {
      ...
      v31 = [(SFImage *)v29 initWithProtobuf:thumbnail2];
...
- (BOOL)isEqual:(id)equal
{
  ...
  {
    if ([(SFButtonCardSection *)equalCopy isMemberOfClass:objc_opt_class()])
    {
      v78.receiver = self;
...
LABEL_27:
            ...
            type = [(SFButtonCardSection *)self type];
            type2 = [(SFButtonCardSection *)v6 type];
            if ((type != 0) != (type2 == 0))
            {
              v63 = type2;
              v76 = type;
              type3 = [(SFButtonCardSection *)self type];
              if (type3)
              {
                type4 = [(SFButtonCardSection *)self type];
                type5 = [(SFButtonCardSection *)v6 type];
                if (![type4 isEqual:?])
                {
                  v11 = 0;
                  goto LABEL_68;
              ...
              if ((backgroundColor != 0) != (backgroundColor2 == 0))
              {
                ...
                title = [(SFButtonCardSection *)self title];
                title2 = [(SFButtonCardSection *)v6 title];
                v43 = title2;
                if ((title != 0) == (title2 == 0))
                {
...
LABEL_65:
                ...
                title3 = [(SFButtonCardSection *)self title];
                if (!title3 || (-[SFButtonCardSection title](self, "title"), v44 = objc_claimAutoreleasedReturnValue(), -[SFButtonCardSection title](v6, "title"), v50 = objc_claimAutoreleasedReturnValue(), v51 = v44, [v44 isEqual:?]))
                {
                  thumbnail = [(SFButtonCardSection *)self thumbnail];
                  thumbnail2 = [(SFButtonCardSection *)v6 thumbnail];
                  v46 = thumbnail2;
                  ...
                  {
                    thumbnail3 = [(SFButtonCardSection *)self thumbnail];
                    if (thumbnail3)
                    {
                      thumbnail4 = [(SFButtonCardSection *)self thumbnail];
                      thumbnail5 = [(SFButtonCardSection *)v6 thumbnail];
...
- (NSData)jsonData
{
  ...
  jsonData = [(_SFPBButtonCardSection *)v2 jsonData];
...
{
  v2 = [[_SFPBButtonCardSection alloc] initWithFacade:self];
  dictionaryRepresentation = [(_SFPBButtonCardSection *)v2 dictionaryRepresentation];
...
- (SFButtonCardSection)initWithCoder:(id)coder
{
  ...
  if (objc_opt_isKindOfClass())
  {
    ...
    [(SFButtonCardSection *)v5 setType:type];
    ...
    [(SFButtonCardSection *)v5 setTitle:title];

    thumbnail = [(SFCardSection *)v8 thumbnail];
    [(SFButtonCardSection *)v5 setThumbnail:thumbnail];
