...
LABEL_40:
        ...
        if (v22 == [(SFCardSection *)v5 canBeHidden])
        {
          ...
          if (v23 == [(SFCardSection *)v5 hasTopPadding])
          {
            ...
            {
              v25 = [(SFLargeTitleDetailedRowCardSection *)self type];
              ...
              if ((v25 != 0) != (v26 == 0))
              {
                ...
                if (v57)
                {
                  ...
                  v53 = [(SFLargeTitleDetailedRowCardSection *)v5 type];
                  if (![v54 isEqual:?])
                  {
                    goto LABEL_50;
                  }
                ...
                if (v27 == [(SFCardSection *)v5 separatorStyle])
                {
                  ...
                  if ((v52 != 0) != (v28 == 0))
                  {
                    ...
                    v49 = [(SFLargeTitleDetailedRowCardSection *)self title];
                    v48 = [(SFLargeTitleDetailedRowCardSection *)v5 title];
                    if ((v49 != 0) == (v48 == 0))
                    {
...
LABEL_57:
                    ...
                    v45 = [(SFLargeTitleDetailedRowCardSection *)self title];
                    if (v45)
                    {
...
LABEL_24:
                    ...
                    v44 = [(SFLargeTitleDetailedRowCardSection *)self subtitleButtonItem];
                    v43 = [(SFLargeTitleDetailedRowCardSection *)v5 subtitleButtonItem];
                    if ((v44 != 0) == (v43 == 0))
                    {
                    ...
                    if (!v40 || (-[SFLargeTitleDetailedRowCardSection subtitleButtonItem](self, "subtitleButtonItem"), v32 = objc_claimAutoreleasedReturnValue(), -[SFLargeTitleDetailedRowCardSection subtitleButtonItem](v5, "subtitleButtonItem"), v36 = objc_claimAutoreleasedReturnValue(), v37 = v32, [v32 isEqual:?]))
                    {
                      v39 = [(SFLargeTitleDetailedRowCardSection *)self trailingButtonItems];
                      v38 = [(SFLargeTitleDetailedRowCardSection *)v5 trailingButtonItems];
                      if ((v39 != 0) == (v38 == 0))
                      {
                      ...
                      {
                        v35 = [(SFLargeTitleDetailedRowCardSection *)self trailingButtonItems];
                        if (v35)
                        {
                          v34 = [(SFLargeTitleDetailedRowCardSection *)self trailingButtonItems];
                          v33 = [(SFLargeTitleDetailedRowCardSection *)v5 trailingButtonItems];
                          v11 = [v34 isEqual:v33];
                        }
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v11 = [(SFLargeTitleDetailedRowCardSection *)self type];
  v12 = [v11 copy];
  [v4 setType:v12];
  ...
  v15 = [(SFLargeTitleDetailedRowCardSection *)self title];
  v16 = [v15 copy];
  [v4 setTitle:v16];

  v17 = [(SFLargeTitleDetailedRowCardSection *)self subtitleButtonItem];
  v18 = [v17 copy];
  [v4 setSubtitleButtonItem:v18];

  v19 = [(SFLargeTitleDetailedRowCardSection *)self trailingButtonItems];
  v20 = [v19 copy];
...
- (NSData)jsonData
{
  ...
  v3 = [(_SFPBLargeTitleDetailedRowCardSection *)v2 jsonData];
...
{
  v2 = [[_SFPBLargeTitleDetailedRowCardSection alloc] initWithFacade:self];
  v3 = [(_SFPBLargeTitleDetailedRowCardSection *)v2 dictionaryRepresentation];
...
- (SFLargeTitleDetailedRowCardSection)initWithCoder:(id)a3
{
  ...
  if (objc_opt_isKindOfClass())
  {
    ...
    v15 = [(SFCardSection *)v8 subtitleButtonItem];
