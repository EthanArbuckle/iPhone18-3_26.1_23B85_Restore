...
- (SFMiniCardSection)initWithProtobuf:(id)a3
{
  ...
  v4 = a3;
  v43.receiver = self;
  v43.super_class = SFMiniCardSection;
...
{
  v25.receiver = self;
  v25.super_class = SFMiniCardSection;
...
- (BOOL)isEqual:(id)a3
{
  ...
  else
  {
    ...
    {
      v67.receiver = self;
      v67.super_class = SFMiniCardSection;
...
LABEL_40:
        ...
        if (v22 == [(SFCardSection *)v5 canBeHidden])
        {
          ...
          if (v23 == [(SFCardSection *)v5 hasTopPadding])
          {
            ...
            {
              v25 = [(SFMiniCardSection *)self type];
...
LABEL_57:
                    ...
                    if (v45)
                    {
                      ...
                      v41 = [(SFMiniCardSection *)v5 title];
                      v42 = v31;
                      if (![v31 isEqual:?])
                      {
                        v11 = 0;
...
LABEL_24:
                    ...
                    v44 = [(SFMiniCardSection *)self subtitle];
                    ...
                    v40 = [(SFMiniCardSection *)self subtitle];
                    if (!v40 || (-[SFMiniCardSection subtitle](self, "subtitle"), v32 = objc_claimAutoreleasedReturnValue(), -[SFMiniCardSection subtitle](v5, "subtitle"), v36 = objc_claimAutoreleasedReturnValue(), v37 = v32, [v32 isEqual:?]))
                    {
                      v39 = [(SFMiniCardSection *)self image];
                      v38 = [(SFMiniCardSection *)v5 image];
                      if ((v39 != 0) == (v38 == 0))
                      {
...
{
  v22.receiver = self;
  v22.super_class = SFMiniCardSection;
  ...
  v11 = [(SFMiniCardSection *)self type];
  v12 = [v11 copy];
  [v4 setType:v12];
  ...
  v15 = [(SFMiniCardSection *)self title];
  v16 = [v15 copy];
  [v4 setTitle:v16];

  v17 = [(SFMiniCardSection *)self subtitle];
  v18 = [v17 copy];
  [v4 setSubtitle:v18];

  v19 = [(SFMiniCardSection *)self image];
  v20 = [v19 copy];
  [v4 setImage:v20];
...
- (NSData)jsonData
{
  ...
  v3 = [(_SFPBMiniCardSection *)v2 jsonData];
...
{
  v2 = [[_SFPBMiniCardSection alloc] initWithFacade:self];
  v3 = [(_SFPBMiniCardSection *)v2 dictionaryRepresentation];
...
{
  v3.receiver = self;
  v3.super_class = SFMiniCardSection;
