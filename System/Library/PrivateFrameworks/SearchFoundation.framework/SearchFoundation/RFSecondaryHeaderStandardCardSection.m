...
- (BOOL)isEqual:(id)a3
{
  ...
  else if ([(RFSecondaryHeaderStandardCardSection *)v4 isMemberOfClass:objc_opt_class()]&& (v13.receiver = self, v13.super_class = RFSecondaryHeaderStandardCardSection, [(SFCardSection *)&v13 isEqual:v4]))
  {
    v5 = v4;
    v6 = [(RFSecondaryHeaderStandardCardSection *)self text];
    v7 = [(RFSecondaryHeaderStandardCardSection *)v5 text];
    if ((v6 != 0) == (v7 == 0))
    {
      v11 = 0;
    }
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v5 = [(RFSecondaryHeaderStandardCardSection *)self text];
  v6 = [v5 copy];
  [v4 setText_1:v6];
...
- (NSData)jsonData
{
  ...
  v3 = [(_SFPBRFSecondaryHeaderStandardCardSection *)v2 jsonData];
...
{
  v2 = [[_SFPBRFSecondaryHeaderStandardCardSection alloc] initWithFacade:self];
  v3 = [(_SFPBRFSecondaryHeaderStandardCardSection *)v2 dictionaryRepresentation];
