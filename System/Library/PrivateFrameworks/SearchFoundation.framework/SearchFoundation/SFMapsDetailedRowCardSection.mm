...
- (SFMapsDetailedRowCardSection)initWithCoder:(id)coder;
- (SFMapsDetailedRowCardSection)initWithProtobuf:(id)protobuf;
...
{
  v23.receiver = self;
  v23.super_class = SFMapsDetailedRowCardSection;
  ...
  type = [(SFMapsDetailedRowCardSection *)self type];
  v14 = hasBottomPadding ^ [type hash];
  v15 = v14 ^ [(SFCardSection *)self separatorStyle];
  backgroundColor = [(SFCardSection *)self backgroundColor];
  v17 = v15 ^ [backgroundColor hash];
  mapsData = [(SFMapsDetailedRowCardSection *)self mapsData];
  v19 = v11 ^ v17 ^ [mapsData hash];
  pinText = [(SFMapsDetailedRowCardSection *)self pinText];
  v21 = [pinText hash];
...
- (BOOL)isEqual:(id)equal
{
  ...
  {
    if ([(SFMapsDetailedRowCardSection *)equalCopy isMemberOfClass:objc_opt_class()])
    {
      v78.receiver = self;
      v78.super_class = SFMapsDetailedRowCardSection;
...
LABEL_27:
            ...
            type = [(SFMapsDetailedRowCardSection *)self type];
            type2 = [(SFMapsDetailedRowCardSection *)v6 type];
            if ((type != 0) != (type2 == 0))
            {
              v63 = type2;
              v76 = type;
              type3 = [(SFMapsDetailedRowCardSection *)self type];
              if (type3)
              {
                type4 = [(SFMapsDetailedRowCardSection *)self type];
                type5 = [(SFMapsDetailedRowCardSection *)v6 type];
                if (![type4 isEqual:?])
                {
                  v11 = 0;
                  goto LABEL_68;
              ...
              if ((backgroundColor != 0) != (backgroundColor2 == 0))
              {
                ...
                mapsData = [(SFMapsDetailedRowCardSection *)self mapsData];
                mapsData2 = [(SFMapsDetailedRowCardSection *)v6 mapsData];
                v43 = mapsData2;
...
LABEL_65:
                ...
                mapsData3 = [(SFMapsDetailedRowCardSection *)self mapsData];
                if (!mapsData3 || (-[SFMapsDetailedRowCardSection mapsData](self, "mapsData"), v44 = objc_claimAutoreleasedReturnValue(), -[SFMapsDetailedRowCardSection mapsData](v6, "mapsData"), v50 = objc_claimAutoreleasedReturnValue(), v51 = v44, [v44 isEqual:?]))
                {
                  pinText = [(SFMapsDetailedRowCardSection *)self pinText];
                  pinText2 = [(SFMapsDetailedRowCardSection *)v6 pinText];
                  v46 = pinText2;
                  ...
                  {
                    pinText3 = [(SFMapsDetailedRowCardSection *)self pinText];
                    if (pinText3)
                    {
                      pinText4 = [(SFMapsDetailedRowCardSection *)self pinText];
                      pinText5 = [(SFMapsDetailedRowCardSection *)v6 pinText];
                      v11 = [pinText4 isEqual:pinText5];
                    }
...
{
  v20.receiver = self;
  v20.super_class = SFMapsDetailedRowCardSection;
...
- (NSData)jsonData
{
  ...
  jsonData = [(_SFPBMapsDetailedRowCardSection *)v2 jsonData];
...
{
  v2 = [[_SFPBMapsDetailedRowCardSection alloc] initWithFacade:self];
  dictionaryRepresentation = [(_SFPBMapsDetailedRowCardSection *)v2 dictionaryRepresentation];
...
{
  v3.receiver = self;
  v3.super_class = SFMapsDetailedRowCardSection;
...
- (SFMapsDetailedRowCardSection)initWithCoder:(id)coder
{
  ...
  if (objc_opt_isKindOfClass())
  {
    ...
    [(SFMapsDetailedRowCardSection *)v5 setType:type];
    ...
    [(SFMapsDetailedRowCardSection *)v5 setMapsData:mapsData];

    pinText = [(SFCardSection *)v8 pinText];
    [(SFMapsDetailedRowCardSection *)v5 setPinText:pinText];
...
- (SFMapsDetailedRowCardSection)initWithProtobuf:(id)protobuf
{
  ...
  v35.receiver = self;
  v35.super_class = SFMapsDetailedRowCardSection;
  ...
  if (v5)
  {
    ...
    if (type)
    {
      ...
      [(SFMapsDetailedRowCardSection *)v5 setType:type2];
    }
    ...
    if (mapsData)
    {
      ...
      [(SFMapsDetailedRowCardSection *)v5 setMapsData:mapsData2];
    }
    ...
    if (pinText)
    {
      ...
      [(SFMapsDetailedRowCardSection *)v5 setPinText:pinText2];
    }
