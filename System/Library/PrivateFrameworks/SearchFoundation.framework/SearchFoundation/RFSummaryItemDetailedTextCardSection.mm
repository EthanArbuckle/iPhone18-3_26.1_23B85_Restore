...
- (BOOL)isEqual:(id)a3
{
  ...
  else
  {
    if ([(RFSummaryItemDetailedTextCardSection *)v5 isMemberOfClass:objc_opt_class()])
    {
      ...
      {
        v6 = v5;
        v7 = [(RFSummaryItemDetailedTextCardSection *)self text];
...
LABEL_50:
        ...
        v9 = [(RFSummaryItemDetailedTextCardSection *)self text];
        if (v9)
        {
          v10 = [(RFSummaryItemDetailedTextCardSection *)self text];
          v11 = [(RFSummaryItemDetailedTextCardSection *)v6 text];
          if (![v10 isEqual:v11])
          {
            v12 = 0;
            goto LABEL_48;
        ...
        v13 = [(RFSummaryItemDetailedTextCardSection *)self text];
        v14 = [(RFSummaryItemDetailedTextCardSection *)v6 text];
        if ((v13 != 0) != (v14 == 0))
        {
          v70 = v14;
          v15 = [(RFSummaryItemDetailedTextCardSection *)self text];
          if (v15)
          {
            v16 = [(RFSummaryItemDetailedTextCardSection *)self text];
            v17 = [(RFSummaryItemDetailedTextCardSection *)v6 text];
...
LABEL_46:
          ...
          v19 = [(RFSummaryItemDetailedTextCardSection *)self text];
          ...
          if ((v19 != 0) != (v20 == 0))
          {
            ...
            if ((v26 != 0) != (v27 == 0))
            {
              ...
              {
                v57 = v30;
                v31 = [(RFSummaryItemDetailedTextCardSection *)self text];
                v56 = v29;
                if (v31)
                {
...
LABEL_71:
                ...
                if (!v51 || (-[RFSummaryItemDetailedTextCardSection text](self, "text"), v37 = objc_claimAutoreleasedReturnValue(), -[RFSummaryItemDetailedTextCardSection text](v6, "text"), v47 = objc_claimAutoreleasedReturnValue(), v48 = v37, [v37 isEqual:?]))
                {
                  ...
                  else
                  {
                    v46 = v41;
                    v49 = v40;
                    v42 = [(RFSummaryItemDetailedTextCardSection *)self thumbnail];
                    v21 = v59;
                    if (v42)
                    {
                      v43 = v42;
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v5 = [(RFSummaryItemDetailedTextCardSection *)self text];
  v6 = [v5 copy];
  [v4 setText_1:v6];
  ...
  v11 = [(RFSummaryItemDetailedTextCardSection *)self text];
  v12 = [v11 copy];
  [v4 setText_4:v12];
  ...
  v17 = [(RFSummaryItemDetailedTextCardSection *)self thumbnail];
  v18 = [v17 copy];
  [v4 setThumbnail:v18];
...
- (NSData)jsonData
{
  ...
  v3 = [(_SFPBRFSummaryItemDetailedTextCardSection *)v2 jsonData];
...
{
  v2 = [[_SFPBRFSummaryItemDetailedTextCardSection alloc] initWithFacade:self];
  v3 = [(_SFPBRFSummaryItemDetailedTextCardSection *)v2 dictionaryRepresentation];
