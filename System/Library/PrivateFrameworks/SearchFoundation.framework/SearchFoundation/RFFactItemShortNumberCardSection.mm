...
- (RFFactItemShortNumberCardSection)initWithCoder:(id)coder;
- (RFFactItemShortNumberCardSection)initWithProtobuf:(id)protobuf;
...
- (unint64_t)hash
{
  ...
  number = [(RFFactItemShortNumberCardSection *)self number];
  v5 = [number hash];
  text = [(RFFactItemShortNumberCardSection *)self text];
  v7 = v5 ^ [text hash];
  text2 = [(RFFactItemShortNumberCardSection *)self text];
  v9 = v7 ^ [text2 hash];
  text3 = [(RFFactItemShortNumberCardSection *)self text];
  v11 = v9 ^ [text3 hash];
  unit = [(RFFactItemShortNumberCardSection *)self unit];
  v13 = v11 ^ [unit hash] ^ v3;
  text4 = [(RFFactItemShortNumberCardSection *)self text];
  v15 = [text4 hash];
  thumbnail = [(RFFactItemShortNumberCardSection *)self thumbnail];
...
- (BOOL)isEqual:(id)equal
{
  ...
  {
    if ([(RFFactItemShortNumberCardSection *)equalCopy isMemberOfClass:objc_opt_class()])
    {
      v73.receiver = self;
      ...
      if ([(SFCardSection *)&v73 isEqual:equalCopy])
      {
        v6 = equalCopy;
        number = [(RFFactItemShortNumberCardSection *)self number];
        number2 = [(RFFactItemShortNumberCardSection *)v6 number];
...
LABEL_50:
        ...
        number3 = [(RFFactItemShortNumberCardSection *)self number];
        if (number3)
        {
          number4 = [(RFFactItemShortNumberCardSection *)self number];
          number5 = [(RFFactItemShortNumberCardSection *)v6 number];
        ...
        text = [(RFFactItemShortNumberCardSection *)self text];
        text2 = [(RFFactItemShortNumberCardSection *)v6 text];
        if ((text != 0) != (text2 == 0))
        {
          v70 = text2;
          text3 = [(RFFactItemShortNumberCardSection *)self text];
          ...
          {
            text4 = [(RFFactItemShortNumberCardSection *)self text];
            text5 = [(RFFactItemShortNumberCardSection *)v6 text];
...
LABEL_46:
          ...
          text6 = [(RFFactItemShortNumberCardSection *)self text];
          text7 = [(RFFactItemShortNumberCardSection *)v6 text];
          v21 = v18;
          v22 = v3;
          if ((text6 != 0) != (text7 == 0))
          {
            v66 = text6;
            v67 = text7;
            text8 = [(RFFactItemShortNumberCardSection *)self text];
            if (text8)
            {
              text9 = [(RFFactItemShortNumberCardSection *)self text];
              text10 = [(RFFactItemShortNumberCardSection *)v6 text];
            ...
            text11 = [(RFFactItemShortNumberCardSection *)self text];
            text12 = [(RFFactItemShortNumberCardSection *)v6 text];
            v21 = v25;
            v22 = v3;
            if ((text11 != 0) != (text12 == 0))
            {
              v62 = text12;
              text13 = [(RFFactItemShortNumberCardSection *)self text];
              if (text13)
              {
                text14 = [(RFFactItemShortNumberCardSection *)self text];
              ...
              unit = [(RFFactItemShortNumberCardSection *)self unit];
              unit2 = [(RFFactItemShortNumberCardSection *)v6 unit];
              if ((unit != 0) != (unit2 == 0))
              {
                v57 = unit2;
                unit3 = [(RFFactItemShortNumberCardSection *)self unit];
                v56 = unit;
                if (unit3)
                {
                  unit4 = [(RFFactItemShortNumberCardSection *)self unit];
                  unit5 = [(RFFactItemShortNumberCardSection *)v6 unit];
                  v54 = unit4;
                  if (![unit4 isEqual:?])
                  {
                    v12 = 0;
...
LABEL_71:
                ...
                text15 = [(RFFactItemShortNumberCardSection *)self text];
                text16 = [(RFFactItemShortNumberCardSection *)v6 text];
                ...
                {
                  thumbnail = [(RFFactItemShortNumberCardSection *)self thumbnail];
                  thumbnail2 = [(RFFactItemShortNumberCardSection *)v6 thumbnail];
                  ...
                  else
                  {
                    v46 = thumbnail2;
                    v49 = thumbnail;
                    thumbnail3 = [(RFFactItemShortNumberCardSection *)self thumbnail];
                    v21 = v59;
                    if (thumbnail3)
                    {
                      v43 = thumbnail3;
                      thumbnail4 = [(RFFactItemShortNumberCardSection *)self thumbnail];
                      thumbnail5 = [(RFFactItemShortNumberCardSection *)v6 thumbnail];
...
- (NSData)jsonData
{
  ...
  jsonData = [(_SFPBRFFactItemShortNumberCardSection *)v2 jsonData];
...
{
  v2 = [[_SFPBRFFactItemShortNumberCardSection alloc] initWithFacade:self];
  dictionaryRepresentation = [(_SFPBRFFactItemShortNumberCardSection *)v2 dictionaryRepresentation];
...
- (RFFactItemShortNumberCardSection)initWithCoder:(id)coder
{
  ...
  if (objc_opt_isKindOfClass())
  {
    ...
    [(RFFactItemShortNumberCardSection *)v5 setNumber:number];

    text = [(SFCardSection *)v8 text];
    [(RFFactItemShortNumberCardSection *)v5 setText_1:text];

    text2 = [(SFCardSection *)v8 text];
    [(RFFactItemShortNumberCardSection *)v5 setText_2:text2];

    text3 = [(SFCardSection *)v8 text];
    [(RFFactItemShortNumberCardSection *)v5 setText_3:text3];

    unit = [(SFCardSection *)v8 unit];
    [(RFFactItemShortNumberCardSection *)v5 setUnit:unit];

    text4 = [(SFCardSection *)v8 text];
    [(RFFactItemShortNumberCardSection *)v5 setText_4:text4];

    thumbnail = [(SFCardSection *)v8 thumbnail];
    [(RFFactItemShortNumberCardSection *)v5 setThumbnail:thumbnail];
