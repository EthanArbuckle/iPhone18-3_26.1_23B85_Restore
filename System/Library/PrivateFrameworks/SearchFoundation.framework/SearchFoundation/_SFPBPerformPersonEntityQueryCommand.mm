...
- (NSData)jsonData;
- (_SFPBPerformPersonEntityQueryCommand)initWithDictionary:(id)dictionary;
- (_SFPBPerformPersonEntityQueryCommand)initWithFacade:(id)facade;
- (_SFPBPerformPersonEntityQueryCommand)initWithJSON:(id)n;
...
- (NSData)jsonData
{
  dictionaryRepresentation = [(_SFPBPerformPersonEntityQueryCommand *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  if (self->_person)
  {
    person = [(_SFPBPerformPersonEntityQueryCommand *)self person];
...
- (BOOL)isEqual:(id)equal
{
  ...
  if ([equalCopy isMemberOfClass:objc_opt_class()])
  {
    ...
    {
      person3 = [(_SFPBPerformPersonEntityQueryCommand *)self person];
      if (!person3)
      {
...
LABEL_10:
      ...
      v9 = person3;
      person4 = [(_SFPBPerformPersonEntityQueryCommand *)self person];
