...
LABEL_65:
                ...
                if (!v53 || (-[SFStockChartCardSection thirdPartyContentURL](self, "thirdPartyContentURL"), v44 = objc_claimAutoreleasedReturnValue(), -[SFStockChartCardSection thirdPartyContentURL](v6, "thirdPartyContentURL"), v50 = objc_claimAutoreleasedReturnValue(), v51 = v44, [v44 isEqual:?]))
                {
                  v52 = [(SFStockChartCardSection *)self chartData];
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v11 = [(SFStockChartCardSection *)self type];
  v12 = [v11 copy];
  [v4 setType:v12];
  ...
  v15 = [(SFStockChartCardSection *)self thirdPartyContentURL];
  v16 = [v15 copy];
  [v4 setThirdPartyContentURL:v16];

  v17 = [(SFStockChartCardSection *)self chartData];
  v18 = [v17 copy];
  [v4 setChartData:v18];
...
- (NSData)jsonData
{
  ...
  v3 = [(_SFPBStockChartCardSection *)v2 jsonData];
...
{
  v2 = [[_SFPBStockChartCardSection alloc] initWithFacade:self];
  v3 = [(_SFPBStockChartCardSection *)v2 dictionaryRepresentation];
...
- (SFStockChartCardSection)initWithCoder:(id)a3
{
  ...
  if (objc_opt_isKindOfClass())
  {
    ...
    v14 = [(SFCardSection *)v8 thirdPartyContentURL];
    [(SFStockChartCardSection *)v5 setThirdPartyContentURL:v14];

    v15 = [(SFCardSection *)v8 chartData];
...
- (SFStockChartCardSection)initWithProtobuf:(id)a3
{
  ...
  v4 = a3;
  v36.receiver = self;
  v36.super_class = SFStockChartCardSection;
