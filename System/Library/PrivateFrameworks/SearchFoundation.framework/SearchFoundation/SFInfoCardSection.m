...
- (id)cardsFromInfoTuple
{
  ...
  v4 = [(SFInfoCardSection *)self infoTuples];
...
- (NSArray)embeddedCards
{
  ...
  v6 = [(SFCardSection *)&v9 embeddedCards];
  [v5 addObjectsFromArray:v6];

  v7 = [(SFInfoCardSection *)self cardsFromInfoTuple];
...
- (unint64_t)hash
{
  ...
  v13 = [(SFInfoCardSection *)self type];
  v14 = v12 ^ [v13 hash];
  ...
  v20 = [(SFInfoCardSection *)self initiallyVisibleTuples];
...
LABEL_28:
            ...
            v28 = [(SFInfoCardSection *)self type];
            v29 = [(SFInfoCardSection *)v6 type];
            if ((v28 != 0) != (v29 == 0))
            {
              v55 = v29;
              v69 = v28;
              v30 = [(SFInfoCardSection *)self type];
              if (v30)
              {
              ...
              if ((v51 != 0) != (v32 == 0))
              {
                ...
                v38 = [(SFInfoCardSection *)self infoTuples];
                v39 = [(SFInfoCardSection *)v6 infoTuples];
                v40 = v39;
                if ((v38 != 0) == (v39 == 0))
                {
...
LABEL_65:
                ...
                v41 = [(SFInfoCardSection *)self infoTuples];
                if (!v41 || (-[SFInfoCardSection infoTuples](self, "infoTuples"), v42 = objc_claimAutoreleasedReturnValue(), -[SFInfoCardSection infoTuples](v6, "infoTuples"), v44 = objc_claimAutoreleasedReturnValue(), v45 = v42, [v42 isEqual:?]))
                {
                  v43 = [(SFInfoCardSection *)self initiallyVisibleTuples];
                  v11 = v43 == [(SFInfoCardSection *)v6 initiallyVisibleTuples];
                  if (!v41)
                  {
                    goto LABEL_76;
                  }
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v11 = [(SFInfoCardSection *)self type];
  v12 = [v11 copy];
  [v4 setType:v12];
  ...
  v15 = [(SFInfoCardSection *)self infoTuples];
  v16 = [v15 copy];
...
- (NSData)jsonData
{
  ...
  v3 = [(_SFPBInfoCardSection *)v2 jsonData];
...
{
  v2 = [[_SFPBInfoCardSection alloc] initWithFacade:self];
  v3 = [(_SFPBInfoCardSection *)v2 dictionaryRepresentation];
...
- (SFInfoCardSection)initWithCoder:(id)a3
{
  ...
  if (objc_opt_isKindOfClass())
  {
    ...
    v14 = [(SFCardSection *)v8 infoTuples];
