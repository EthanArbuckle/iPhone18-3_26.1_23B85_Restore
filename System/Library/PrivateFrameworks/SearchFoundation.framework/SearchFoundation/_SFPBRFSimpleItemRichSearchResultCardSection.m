...
- (id)dictionaryRepresentation
{
  ...
  if (self->_text_1)
  {
    v4 = [(_SFPBRFSimpleItemRichSearchResultCardSection *)self text];
  ...
  if (self->_text_2)
  {
    v7 = [(_SFPBRFSimpleItemRichSearchResultCardSection *)self text];
  ...
  if (self->_text_4)
  {
    v18 = [(_SFPBRFSimpleItemRichSearchResultCardSection *)self text];
  ...
  if (self->_text_6)
  {
    v29 = [(_SFPBRFSimpleItemRichSearchResultCardSection *)self text];
...
- (BOOL)isEqual:(id)a3
{
  ...
  v5 = [(_SFPBRFSimpleItemRichSearchResultCardSection *)self text];
  v6 = [v4 text];
  if ((v5 != 0) == (v6 == 0))
  {
    goto LABEL_46;
  ...
  {
    v8 = v7;
    v9 = [(_SFPBRFSimpleItemRichSearchResultCardSection *)self text];
    v10 = [v4 text];
    v11 = [v9 isEqual:v10];
  ...
  v12 = [(_SFPBRFSimpleItemRichSearchResultCardSection *)self text];
  if (v12)
  {
    v13 = v12;
    v14 = [(_SFPBRFSimpleItemRichSearchResultCardSection *)self text];
    v15 = [v4 text];
    v16 = [v14 isEqual:v15];
  ...
  v5 = [(_SFPBRFSimpleItemRichSearchResultCardSection *)self text_3s];
  v6 = [v4 text_3s];
  if ((v5 != 0) == (v6 == 0))
  {
    goto LABEL_46;
  ...
  v17 = [(_SFPBRFSimpleItemRichSearchResultCardSection *)self text_3s];
  if (v17)
  {
    v18 = v17;
    v19 = [(_SFPBRFSimpleItemRichSearchResultCardSection *)self text_3s];
    v20 = [v4 text_3s];
    v21 = [v19 isEqual:v20];
  ...
  v22 = [(_SFPBRFSimpleItemRichSearchResultCardSection *)self text];
  if (v22)
  {
    v23 = v22;
    v24 = [(_SFPBRFSimpleItemRichSearchResultCardSection *)self text];
    v25 = [v4 text];
    v26 = [v24 isEqual:v25];
  ...
  v5 = [(_SFPBRFSimpleItemRichSearchResultCardSection *)self text_5s];
  v6 = [v4 text_5s];
  if ((v5 != 0) == (v6 == 0))
  {
    goto LABEL_46;
  ...
  v27 = [(_SFPBRFSimpleItemRichSearchResultCardSection *)self text_5s];
  if (v27)
  {
    v28 = v27;
    v29 = [(_SFPBRFSimpleItemRichSearchResultCardSection *)self text_5s];
    v30 = [v4 text_5s];
    v31 = [v29 isEqual:v30];
  ...
  v37 = [(_SFPBRFSimpleItemRichSearchResultCardSection *)self text];
  if (v37)
  {
    v38 = v37;
  ...
  v42 = [(_SFPBRFSimpleItemRichSearchResultCardSection *)self text];
  if (v42)
  {
    v43 = v42;
    v44 = [(_SFPBRFSimpleItemRichSearchResultCardSection *)self text];
    v45 = [v4 text];
    v46 = [v44 isEqual:v45];
  ...
  v5 = [(_SFPBRFSimpleItemRichSearchResultCardSection *)self thumbnail];
  v6 = [v4 thumbnail];
  if ((v5 != 0) != (v6 == 0))
  {
    v47 = [(_SFPBRFSimpleItemRichSearchResultCardSection *)self thumbnail];
    if (!v47)
    {
...
LABEL_50:
    ...
    v48 = v47;
    v49 = [(_SFPBRFSimpleItemRichSearchResultCardSection *)self thumbnail];
    v50 = [v4 thumbnail];
    v51 = [v49 isEqual:v50];
...
- (void)writeTo:(id)a3
{
  ...
  v6 = [(_SFPBRFSimpleItemRichSearchResultCardSection *)self text];
  if (v6)
  {
    PBDataWriterWriteSubmessage();
  }

  v7 = [(_SFPBRFSimpleItemRichSearchResultCardSection *)self text_3s];
  v29 = 0u;
  v30 = 0u;
  v31 = 0u;
  v32 = 0u;
  ...
  v13 = [(_SFPBRFSimpleItemRichSearchResultCardSection *)self text];
  if (v13)
  {
    PBDataWriterWriteSubmessage();
  }

  v14 = [(_SFPBRFSimpleItemRichSearchResultCardSection *)self text_5s];
  v25 = 0u;
  v26 = 0u;
  v27 = 0u;
  v28 = 0u;
  ...
  v21 = [(_SFPBRFSimpleItemRichSearchResultCardSection *)self text];
  if (v21)
  {
    PBDataWriterWriteSubmessage();
  }
  ...
  v23 = [(_SFPBRFSimpleItemRichSearchResultCardSection *)self thumbnail];
  if (v23)
  {
    PBDataWriterWriteSubmessage();
  }
