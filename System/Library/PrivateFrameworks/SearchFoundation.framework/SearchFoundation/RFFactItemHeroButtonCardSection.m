...
- (BOOL)isEqual:(id)a3
{
  ...
  else
  {
    if ([(RFFactItemHeroButtonCardSection *)v5 isMemberOfClass:objc_opt_class()])
    {
      ...
      {
        v6 = v5;
        v7 = [(RFFactItemHeroButtonCardSection *)self number];
...
LABEL_31:
        ...
        v9 = [(RFFactItemHeroButtonCardSection *)self number];
        if (v9)
        {
          v3 = [(RFFactItemHeroButtonCardSection *)self number];
        ...
        else
        {
          v24 = v17;
          v26 = v18;
          v19 = [(RFFactItemHeroButtonCardSection *)self button];
          v15 = v29;
          if (v19)
          {
            v23 = v19;
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v5 = [(RFFactItemHeroButtonCardSection *)self number];
  v6 = [v5 copy];
  [v4 setNumber:v6];

  v7 = [(RFFactItemHeroButtonCardSection *)self text];
  v8 = [v7 copy];
  [v4 setText_1:v8];

  v9 = [(RFFactItemHeroButtonCardSection *)self button];
  v10 = [v9 copy];
  [v4 setButton:v10];
...
- (NSData)jsonData
{
  ...
  v3 = [(_SFPBRFFactItemHeroButtonCardSection *)v2 jsonData];
...
{
  v2 = [[_SFPBRFFactItemHeroButtonCardSection alloc] initWithFacade:self];
  v3 = [(_SFPBRFFactItemHeroButtonCardSection *)v2 dictionaryRepresentation];
