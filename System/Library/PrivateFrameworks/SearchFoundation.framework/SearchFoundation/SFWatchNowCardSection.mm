...
- (SFWatchNowCardSection)initWithCoder:(id)coder;
- (SFWatchNowCardSection)initWithProtobuf:(id)protobuf;
...
- (SFWatchNowCardSection)initWithProtobuf:(id)protobuf
{
  ...
  if (v5)
  {
    ...
    v9 = [punchoutOptions2 countByEnumeratingWithState:&v33 objects:v38 count:16];
    if (v9)
    {
      v10 = v9;
      v11 = *v34;
      do
      {
        ...
        v10 = [punchoutOptions2 countByEnumeratingWithState:&v33 objects:v38 count:16];
      }
    ...
    if (type)
    {
      ...
      [(SFWatchNowCardSection *)v5 setType:type2];
    }
    ...
    if (sectionTitle)
    {
      ...
      [(SFWatchNowCardSection *)v5 setSectionTitle:sectionTitle2];
    }
    ...
    if (watchListItem)
    {
      ...
      v29 = [(SFWatchListItem *)v27 initWithProtobuf:watchListItem2];
...
- (unint64_t)hash
{
  ...
  type = [(SFWatchNowCardSection *)self type];
  v14 = hasBottomPadding ^ [type hash];
  v15 = v14 ^ [(SFCardSection *)self separatorStyle];
  backgroundColor = [(SFCardSection *)self backgroundColor];
  v17 = v15 ^ [backgroundColor hash];
  sectionTitle = [(SFWatchNowCardSection *)self sectionTitle];
  v19 = v11 ^ v17 ^ [sectionTitle hash];
  watchListItem = [(SFWatchNowCardSection *)self watchListItem];
  v21 = [watchListItem hash];
...
- (BOOL)isEqual:(id)equal
{
  ...
  {
    if ([(SFWatchNowCardSection *)equalCopy isMemberOfClass:objc_opt_class()])
    {
      v78.receiver = self;
...
LABEL_27:
            ...
            type = [(SFWatchNowCardSection *)self type];
            type2 = [(SFWatchNowCardSection *)v6 type];
            if ((type != 0) != (type2 == 0))
            {
              v63 = type2;
              v76 = type;
              type3 = [(SFWatchNowCardSection *)self type];
              if (type3)
              {
                type4 = [(SFWatchNowCardSection *)self type];
                type5 = [(SFWatchNowCardSection *)v6 type];
                if (![type4 isEqual:?])
                {
                  v11 = 0;
                  goto LABEL_68;
              ...
              if ((backgroundColor != 0) != (backgroundColor2 == 0))
              {
                ...
                sectionTitle = [(SFWatchNowCardSection *)self sectionTitle];
                sectionTitle2 = [(SFWatchNowCardSection *)v6 sectionTitle];
                v43 = sectionTitle2;
...
LABEL_65:
                ...
                sectionTitle3 = [(SFWatchNowCardSection *)self sectionTitle];
                if (!sectionTitle3 || (-[SFWatchNowCardSection sectionTitle](self, "sectionTitle"), v44 = objc_claimAutoreleasedReturnValue(), -[SFWatchNowCardSection sectionTitle](v6, "sectionTitle"), v50 = objc_claimAutoreleasedReturnValue(), v51 = v44, [v44 isEqual:?]))
                {
                  watchListItem = [(SFWatchNowCardSection *)self watchListItem];
                  watchListItem2 = [(SFWatchNowCardSection *)v6 watchListItem];
                  v46 = watchListItem2;
                  ...
                  {
                    watchListItem3 = [(SFWatchNowCardSection *)self watchListItem];
                    if (watchListItem3)
                    {
                      watchListItem4 = [(SFWatchNowCardSection *)self watchListItem];
                      watchListItem5 = [(SFWatchNowCardSection *)v6 watchListItem];
...
- (NSData)jsonData
{
  ...
  jsonData = [(_SFPBWatchNowCardSection *)v2 jsonData];
...
{
  v2 = [[_SFPBWatchNowCardSection alloc] initWithFacade:self];
  dictionaryRepresentation = [(_SFPBWatchNowCardSection *)v2 dictionaryRepresentation];
...
- (SFWatchNowCardSection)initWithCoder:(id)coder
{
  ...
  if (objc_opt_isKindOfClass())
  {
    ...
    [(SFWatchNowCardSection *)v5 setType:type];
    ...
    [(SFWatchNowCardSection *)v5 setSectionTitle:sectionTitle];

    watchListItem = [(SFCardSection *)v8 watchListItem];
    [(SFWatchNowCardSection *)v5 setWatchListItem:watchListItem];
