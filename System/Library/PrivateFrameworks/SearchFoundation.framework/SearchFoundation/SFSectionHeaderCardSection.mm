...
- (SFSectionHeaderCardSection)initWithProtobuf:(id)a3
{
  ...
  v4 = a3;
  v35.receiver = self;
  v35.super_class = SFSectionHeaderCardSection;
...
LABEL_47:
            ...
            if ((v28 != 0) != (v29 == 0))
            {
              ...
              if (v52)
              {
                v30 = [(SFSectionHeaderCardSection *)self type];
...
LABEL_66:
                    ...
                    {
                      v41 = [(SFSectionHeaderCardSection *)self text];
                      if (v41)
                      {
                        v42 = v41;
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v11 = [(SFSectionHeaderCardSection *)self type];
  v12 = [v11 copy];
  [v4 setType:v12];
  ...
  v15 = [(SFSectionHeaderCardSection *)self text];
  v16 = [v15 copy];
  [v4 setText:v16];
...
- (NSData)jsonData
{
  ...
  v3 = [(_SFPBSectionHeaderCardSection *)v2 jsonData];
...
{
  v2 = [[_SFPBSectionHeaderCardSection alloc] initWithFacade:self];
  v3 = [(_SFPBSectionHeaderCardSection *)v2 dictionaryRepresentation];
