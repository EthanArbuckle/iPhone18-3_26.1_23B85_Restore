...
- (BOOL)isEqual:(id)a3
{
  ...
  else if ([(RFSecondaryHeaderEmphasizedCardSection *)v4 isMemberOfClass:objc_opt_class()]&& (v13.receiver = self, v13.super_class = RFSecondaryHeaderEmphasizedCardSection, [(SFCardSection *)&v13 isEqual:v4]))
  {
    v5 = v4;
    v6 = [(RFSecondaryHeaderEmphasizedCardSection *)self text];
    v7 = [(RFSecondaryHeaderEmphasizedCardSection *)v5 text];
    if ((v6 != 0) == (v7 == 0))
    {
      v11 = 0;
    }
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v5 = [(RFSecondaryHeaderEmphasizedCardSection *)self text];
  v6 = [v5 copy];
  [v4 setText_1:v6];
...
- (NSData)jsonData
{
  ...
  v3 = [(_SFPBRFSecondaryHeaderEmphasizedCardSection *)v2 jsonData];
...
{
  v2 = [[_SFPBRFSecondaryHeaderEmphasizedCardSection alloc] initWithFacade:self];
  v3 = [(_SFPBRFSecondaryHeaderEmphasizedCardSection *)v2 dictionaryRepresentation];
