...
- (SFFindMyCardSection)initWithProtobuf:(id)a3
{
  v4 = a3;
  v12.receiver = self;
  v12.super_class = SFFindMyCardSection;
...
{
  v7.receiver = self;
  v7.super_class = SFFindMyCardSection;
  v3 = [(SFCardSection *)&v7 hash];
  v4 = [(SFFindMyCardSection *)self person];
  v5 = [v4 hash];
...
- (BOOL)isEqual:(id)a3
{
  ...
  else if ([(SFFindMyCardSection *)v4 isMemberOfClass:objc_opt_class()]&& (v13.receiver = self, v13.super_class = SFFindMyCardSection, [(SFCardSection *)&v13 isEqual:v4]))
  {
    v5 = v4;
    v6 = [(SFFindMyCardSection *)self person];
    v7 = [(SFFindMyCardSection *)v5 person];
    if ((v6 != 0) == (v7 == 0))
    {
      v11 = 0;
    }
...
{
  v8.receiver = self;
  v8.super_class = SFFindMyCardSection;
  v4 = [(SFCardSection *)&v8 copyWithZone:a3];
  v5 = [(SFFindMyCardSection *)self person];
  v6 = [v5 copy];
  [v4 setPerson:v6];
...
- (NSData)jsonData
{
  ...
  v3 = [(_SFPBFindMyCardSection *)v2 jsonData];
...
{
  v2 = [[_SFPBFindMyCardSection alloc] initWithFacade:self];
  v3 = [(_SFPBFindMyCardSection *)v2 dictionaryRepresentation];
...
{
  v3.receiver = self;
  v3.super_class = SFFindMyCardSection;
