...
LABEL_27:
            ...
            if ((v31 != 0) != (v32 == 0))
            {
              ...
              if ((v35 != 0) != (v36 == 0))
              {
                ...
                v41 = [(SFKeyValueDataCardSection *)self data];
                v42 = [(SFKeyValueDataCardSection *)v6 data];
                v43 = v42;
                if ((v41 != 0) == (v42 == 0))
                {
...
LABEL_65:
                ...
                if (!v53 || (-[SFKeyValueDataCardSection data](self, "data"), v44 = objc_claimAutoreleasedReturnValue(), -[SFKeyValueDataCardSection data](v6, "data"), v50 = objc_claimAutoreleasedReturnValue(), v51 = v44, [v44 isEqual:?]))
                {
                  v52 = [(SFKeyValueDataCardSection *)self accessoryImage];
                  v45 = [(SFKeyValueDataCardSection *)v6 accessoryImage];
                  v46 = v45;
                  if ((v52 != 0) == (v45 == 0))
                  {
                  ...
                  {
                    v49 = [(SFKeyValueDataCardSection *)self accessoryImage];
                    if (v49)
                    {
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v11 = [(SFKeyValueDataCardSection *)self type];
  v12 = [v11 copy];
  [v4 setType:v12];
  ...
  v15 = [(SFKeyValueDataCardSection *)self data];
  v16 = [v15 copy];
  [v4 setData:v16];

  v17 = [(SFKeyValueDataCardSection *)self accessoryImage];
  v18 = [v17 copy];
...
- (NSData)jsonData
{
  ...
  v3 = [(_SFPBKeyValueDataCardSection *)v2 jsonData];
...
{
  v2 = [[_SFPBKeyValueDataCardSection alloc] initWithFacade:self];
  v3 = [(_SFPBKeyValueDataCardSection *)v2 dictionaryRepresentation];
...
- (SFKeyValueDataCardSection)initWithCoder:(id)a3
{
  ...
  if (objc_opt_isKindOfClass())
  {
    ...
    v14 = [(SFCardSection *)v8 data];
    [(SFKeyValueDataCardSection *)v5 setData:v14];

    v15 = [(SFCardSection *)v8 accessoryImage];
