...
- (unint64_t)hash
{
  ...
  v4 = [(RFFactItemShortHeroNumberCardSection *)self number];
  v5 = [v4 hash];
...
- (BOOL)isEqual:(id)a3
{
  ...
  else
  {
    if ([(RFFactItemShortHeroNumberCardSection *)v5 isMemberOfClass:objc_opt_class()])
    {
      ...
      {
        v6 = v5;
        v7 = [(RFFactItemShortHeroNumberCardSection *)self number];
...
LABEL_50:
        ...
        v9 = [(RFFactItemShortHeroNumberCardSection *)self number];
        if (v9)
        {
          v10 = [(RFFactItemShortHeroNumberCardSection *)self number];
          v11 = [(RFFactItemShortHeroNumberCardSection *)v6 number];
          if (![v10 isEqual:v11])
          {
            v12 = 0;
            goto LABEL_48;
        ...
        v13 = [(RFFactItemShortHeroNumberCardSection *)self text];
        v14 = [(RFFactItemShortHeroNumberCardSection *)v6 text];
        if ((v13 != 0) != (v14 == 0))
        {
          v70 = v14;
          v15 = [(RFFactItemShortHeroNumberCardSection *)self text];
          if (v15)
          {
            v16 = [(RFFactItemShortHeroNumberCardSection *)self text];
            v17 = [(RFFactItemShortHeroNumberCardSection *)v6 text];
...
LABEL_46:
          ...
          v19 = [(RFFactItemShortHeroNumberCardSection *)self text];
          ...
          if ((v19 != 0) != (v20 == 0))
          {
            ...
            if (v65)
            {
              v23 = [(RFFactItemShortHeroNumberCardSection *)self text];
            ...
            v26 = [(RFFactItemShortHeroNumberCardSection *)self text];
            v27 = [(RFFactItemShortHeroNumberCardSection *)v6 text];
            v21 = v25;
            v22 = v3;
            if ((v26 != 0) != (v27 == 0))
            {
              ...
              {
                v57 = v30;
                v31 = [(RFFactItemShortHeroNumberCardSection *)self unit];
                v56 = v29;
                if (v31)
                {
...
LABEL_71:
                ...
                if (!v51 || (-[RFFactItemShortHeroNumberCardSection text](self, "text"), v37 = objc_claimAutoreleasedReturnValue(), -[RFFactItemShortHeroNumberCardSection text](v6, "text"), v47 = objc_claimAutoreleasedReturnValue(), v48 = v37, [v37 isEqual:?]))
                {
                  ...
                  else
                  {
                    v46 = v41;
                    v49 = v40;
                    v42 = [(RFFactItemShortHeroNumberCardSection *)self thumbnail];
                    v21 = v59;
                    if (v42)
                    {
                      v43 = v42;
                      v45 = [(RFFactItemShortHeroNumberCardSection *)self thumbnail];
                      v44 = [(RFFactItemShortHeroNumberCardSection *)v6 thumbnail];
                      v12 = [v45 isEqual:v44];
                    }
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v5 = [(RFFactItemShortHeroNumberCardSection *)self number];
  v6 = [v5 copy];
  [v4 setNumber:v6];

  v7 = [(RFFactItemShortHeroNumberCardSection *)self text];
  v8 = [v7 copy];
  [v4 setText_1:v8];

  v9 = [(RFFactItemShortHeroNumberCardSection *)self text];
  v10 = [v9 copy];
  [v4 setText_2:v10];

  v11 = [(RFFactItemShortHeroNumberCardSection *)self text];
  v12 = [v11 copy];
  [v4 setText_3:v12];

  v13 = [(RFFactItemShortHeroNumberCardSection *)self unit];
  v14 = [v13 copy];
  [v4 setUnit:v14];
  ...
  v17 = [(RFFactItemShortHeroNumberCardSection *)self thumbnail];
  v18 = [v17 copy];
  [v4 setThumbnail:v18];
...
- (NSData)jsonData
{
  ...
  v3 = [(_SFPBRFFactItemShortHeroNumberCardSection *)v2 jsonData];
...
{
  v2 = [[_SFPBRFFactItemShortHeroNumberCardSection alloc] initWithFacade:self];
  v3 = [(_SFPBRFFactItemShortHeroNumberCardSection *)v2 dictionaryRepresentation];
