...
- (id)dictionaryRepresentation
{
  ...
  {
    v4 = [(_SFPBRunVoiceShortcutCommand *)self applicationBundleIdentifier];
    v5 = [v4 copy];
...
- (BOOL)isEqual:(id)a3
{
  ...
  v7 = [(_SFPBRunVoiceShortcutCommand *)self voiceShortcutIdentifier];
  if (v7)
  {
    v8 = v7;
  ...
  if ((v5 != 0) != (v6 == 0))
  {
    v12 = [(_SFPBRunVoiceShortcutCommand *)self applicationBundleIdentifier];
    if (!v12)
    {
...
{
  v6 = a3;
  v4 = [(_SFPBRunVoiceShortcutCommand *)self voiceShortcutIdentifier];
  if (v4)
  {
