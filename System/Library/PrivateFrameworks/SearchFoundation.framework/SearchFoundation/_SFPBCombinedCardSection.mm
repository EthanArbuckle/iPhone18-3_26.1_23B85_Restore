...
- (NSData)jsonData;
- (_SFPBCombinedCardSection)initWithDictionary:(id)dictionary;
- (_SFPBCombinedCardSection)initWithFacade:(id)facade;
- (_SFPBCombinedCardSection)initWithJSON:(id)n;
...
- (_SFPBCombinedCardSection)initWithFacade:(id)facade
{
  ...
  if (v5)
  {
    ...
    if (punchoutPickerTitle)
    {
      ...
      [(_SFPBCombinedCardSection *)v5 setPunchoutPickerTitle:punchoutPickerTitle2];
    }
    ...
    if (punchoutPickerDismissText)
    {
      ...
      [(_SFPBCombinedCardSection *)v5 setPunchoutPickerDismissText:punchoutPickerDismissText2];
    }

    if ([facadeCopy hasCanBeHidden])
    {
      -[_SFPBCombinedCardSection setCanBeHidden:](v5, "setCanBeHidden:", [facadeCopy canBeHidden]);
    }

    if ([facadeCopy hasHasTopPadding])
    {
      -[_SFPBCombinedCardSection setHasTopPadding:](v5, "setHasTopPadding:", [facadeCopy hasTopPadding]);
    }

    if ([facadeCopy hasHasBottomPadding])
    {
      -[_SFPBCombinedCardSection setHasBottomPadding:](v5, "setHasBottomPadding:", [facadeCopy hasBottomPadding]);
    }
    ...
    if (type)
    {
      ...
      [(_SFPBCombinedCardSection *)v5 setType:type2];
    }

    if ([facadeCopy hasSeparatorStyle])
    {
      -[_SFPBCombinedCardSection setSeparatorStyle:](v5, "setSeparatorStyle:", [facadeCopy separatorStyle]);
    }
...
- (NSData)jsonData
{
  dictionaryRepresentation = [(_SFPBCombinedCardSection *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  {
    backgroundColor = [(_SFPBCombinedCardSection *)self backgroundColor];
  ...
  {
    punchoutPickerDismissText = [(_SFPBCombinedCardSection *)self punchoutPickerDismissText];
  ...
  {
    punchoutPickerTitle = [(_SFPBCombinedCardSection *)self punchoutPickerTitle];
  ...
  {
    separatorStyle = [(_SFPBCombinedCardSection *)self separatorStyle];
    if (separatorStyle >= 6)
    {
  ...
  if (self->_type)
  {
    type = [(_SFPBCombinedCardSection *)self type];
    v33 = [type copy];
...
- (BOOL)isEqual:(id)equal
{
  ...
  punchoutOptions = [(_SFPBCombinedCardSection *)self punchoutOptions];
  ...
  punchoutOptions3 = [(_SFPBCombinedCardSection *)self punchoutOptions];
  if (punchoutOptions3)
  {
    v8 = punchoutOptions3;
    punchoutOptions4 = [(_SFPBCombinedCardSection *)self punchoutOptions];
  ...
  punchoutOptions = [(_SFPBCombinedCardSection *)self punchoutPickerTitle];
  ...
  if (punchoutPickerTitle)
  {
    ...
    punchoutPickerTitle2 = [(_SFPBCombinedCardSection *)self punchoutPickerTitle];
  ...
  punchoutOptions = [(_SFPBCombinedCardSection *)self punchoutPickerDismissText];
  ...
  if (punchoutPickerDismissText)
  {
    ...
    punchoutPickerDismissText2 = [(_SFPBCombinedCardSection *)self punchoutPickerDismissText];
  ...
  punchoutOptions = [(_SFPBCombinedCardSection *)self type];
  ...
  {
    v26 = type;
    type2 = [(_SFPBCombinedCardSection *)self type];
  ...
  punchoutOptions = [(_SFPBCombinedCardSection *)self backgroundColor];
  ...
  {
    v32 = backgroundColor;
    backgroundColor2 = [(_SFPBCombinedCardSection *)self backgroundColor];
  ...
  punchoutOptions = [(_SFPBCombinedCardSection *)self cardSections];
...
LABEL_35:
  ...
  cardSections = [(_SFPBCombinedCardSection *)self cardSections];
  if (!cardSections)
  {
...
LABEL_39:
  ...
  v37 = cardSections;
  cardSections2 = [(_SFPBCombinedCardSection *)self cardSections];
