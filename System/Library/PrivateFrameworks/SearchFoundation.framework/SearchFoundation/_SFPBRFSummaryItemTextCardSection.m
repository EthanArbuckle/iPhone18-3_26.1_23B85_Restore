...
- (id)dictionaryRepresentation
{
  ...
  if (self->_text_1)
  {
    v4 = [(_SFPBRFSummaryItemTextCardSection *)self text];
  ...
  if (self->_text_2)
  {
    v7 = [(_SFPBRFSummaryItemTextCardSection *)self text];
  ...
  if (self->_text_4)
  {
    v18 = [(_SFPBRFSummaryItemTextCardSection *)self text];
...
- (BOOL)isEqual:(id)a3
{
  ...
  v5 = [(_SFPBRFSummaryItemTextCardSection *)self text];
  v6 = [v4 text];
  if ((v5 != 0) == (v6 == 0))
  {
    goto LABEL_26;
  ...
  v12 = [(_SFPBRFSummaryItemTextCardSection *)self text];
  if (v12)
  {
    v13 = v12;
    v14 = [(_SFPBRFSummaryItemTextCardSection *)self text];
    v15 = [v4 text];
    v16 = [v14 isEqual:v15];
  ...
  v5 = [(_SFPBRFSummaryItemTextCardSection *)self text_3s];
  v6 = [v4 text_3s];
  if ((v5 != 0) == (v6 == 0))
  {
    goto LABEL_26;
  ...
  v17 = [(_SFPBRFSummaryItemTextCardSection *)self text_3s];
  if (v17)
  {
    v18 = v17;
    v19 = [(_SFPBRFSummaryItemTextCardSection *)self text_3s];
    v20 = [v4 text_3s];
    v21 = [v19 isEqual:v20];
  ...
  v22 = [(_SFPBRFSummaryItemTextCardSection *)self text];
  if (v22)
  {
    v23 = v22;
  ...
  if ((v5 != 0) != (v6 == 0))
  {
    v27 = [(_SFPBRFSummaryItemTextCardSection *)self text];
    if (!v27)
    {
...
LABEL_30:
    ...
    v28 = v27;
    v29 = [(_SFPBRFSummaryItemTextCardSection *)self text];
    v30 = [v4 text];
    v31 = [v29 isEqual:v30];
...
- (void)writeTo:(id)a3
{
  ...
  v6 = [(_SFPBRFSummaryItemTextCardSection *)self text];
  if (v6)
  {
    PBDataWriterWriteSubmessage();
  }

  v7 = [(_SFPBRFSummaryItemTextCardSection *)self text_3s];
  v16 = 0u;
  v17 = 0u;
  v18 = 0u;
  v19 = 0u;
  ...
  v13 = [(_SFPBRFSummaryItemTextCardSection *)self text];
  if (v13)
  {
    PBDataWriterWriteSubmessage();
  }
