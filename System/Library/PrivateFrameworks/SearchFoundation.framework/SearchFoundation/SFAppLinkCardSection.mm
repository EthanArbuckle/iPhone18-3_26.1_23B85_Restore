...
LABEL_24:
                    ...
                    {
                      v39 = [(SFAppLinkCardSection *)self appLinks];
                      v38 = [(SFAppLinkCardSection *)v5 appLinks];
                      if ((v39 != 0) == (v38 == 0))
                      {
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v19 = [(SFAppLinkCardSection *)self appLinks];
  v20 = [v19 copy];
  [v4 setAppLinks:v20];
...
- (NSData)jsonData
{
  ...
  v3 = [(_SFPBAppLinkCardSection *)v2 jsonData];
...
{
  v2 = [[_SFPBAppLinkCardSection alloc] initWithFacade:self];
  v3 = [(_SFPBAppLinkCardSection *)v2 dictionaryRepresentation];
