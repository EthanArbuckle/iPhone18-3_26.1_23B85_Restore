...
- (BOOL)isEqual:(id)a3
{
  ...
  v7 = [(_SFPBRFPrimaryHeaderStandardCardSection *)self text];
  if (v7)
  {
    v8 = v7;
  ...
  v12 = [(_SFPBRFPrimaryHeaderStandardCardSection *)self text];
  if (v12)
  {
    v13 = v12;
  ...
  if ((v5 != 0) != (v6 == 0))
  {
    v17 = [(_SFPBRFPrimaryHeaderStandardCardSection *)self text];
    if (!v17)
    {
...
{
  v7 = a3;
  v4 = [(_SFPBRFPrimaryHeaderStandardCardSection *)self text];
  if (v4)
  {
  ...
  v6 = [(_SFPBRFPrimaryHeaderStandardCardSection *)self text];
  if (v6)
  {
    PBDataWriterWriteSubmessage();
  }
