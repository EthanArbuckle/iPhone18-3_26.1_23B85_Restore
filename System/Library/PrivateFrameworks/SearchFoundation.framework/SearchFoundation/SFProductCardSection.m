...
- (SFProductCardSection)initWithProtobuf:(id)a3
{
  ...
  v4 = a3;
  v33.receiver = self;
  v33.super_class = SFProductCardSection;
...
LABEL_47:
            ...
            v28 = [(SFProductCardSection *)self type];
            v29 = [(SFProductCardSection *)v6 type];
            if ((v28 != 0) != (v29 == 0))
            {
              v53 = v29;
              ...
              if (v52)
              {
                v30 = [(SFProductCardSection *)self type];
...
LABEL_66:
                    ...
                    {
                      v41 = [(SFProductCardSection *)self productJSON];
                      if (v41)
                      {
                        v42 = v41;
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v11 = [(SFProductCardSection *)self type];
  v12 = [v11 copy];
  [v4 setType:v12];
  ...
  v15 = [(SFProductCardSection *)self productJSON];
  v16 = [v15 copy];
...
- (NSData)jsonData
{
  ...
  v3 = [(_SFPBProductCardSection *)v2 jsonData];
...
{
  v2 = [[_SFPBProductCardSection alloc] initWithFacade:self];
  v3 = [(_SFPBProductCardSection *)v2 dictionaryRepresentation];
...
- (SFProductCardSection)initWithCoder:(id)a3
{
  ...
  if (objc_opt_isKindOfClass())
  {
    ...
    v14 = [(SFCardSection *)v8 productJSON];
