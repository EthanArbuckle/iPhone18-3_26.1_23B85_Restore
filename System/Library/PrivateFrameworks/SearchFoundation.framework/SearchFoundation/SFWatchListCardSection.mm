...
LABEL_66:
                    ...
                    {
                      v41 = [(SFWatchListCardSection *)self watchListItem];
                      if (v41)
                      {
                        v42 = v41;
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v11 = [(SFWatchListCardSection *)self type];
  v12 = [v11 copy];
  [v4 setType:v12];
  ...
  v15 = [(SFWatchListCardSection *)self watchListItem];
  v16 = [v15 copy];
...
- (NSData)jsonData
{
  ...
  v3 = [(_SFPBWatchListCardSection *)v2 jsonData];
...
{
  v2 = [[_SFPBWatchListCardSection alloc] initWithFacade:self];
  v3 = [(_SFPBWatchListCardSection *)v2 dictionaryRepresentation];
...
- (SFWatchListCardSection)initWithCoder:(id)a3
{
  ...
  if (objc_opt_isKindOfClass())
  {
    ...
    v14 = [(SFCardSection *)v8 watchListItem];
...
- (SFWatchListCardSection)initWithProtobuf:(id)a3
{
  ...
  v4 = a3;
  v35.receiver = self;
  v35.super_class = SFWatchListCardSection;
