...
- (NSData)jsonData;
- (_SFPBShowPurchaseRequestSheetCommand)initWithDictionary:(id)dictionary;
- (_SFPBShowPurchaseRequestSheetCommand)initWithFacade:(id)facade;
- (_SFPBShowPurchaseRequestSheetCommand)initWithJSON:(id)n;
...
- (_SFPBShowPurchaseRequestSheetCommand)initWithFacade:(id)facade
{
  ...
  if (v5)
  {
    ...
    if (requestIdentifier)
    {
      ...
      [(_SFPBShowPurchaseRequestSheetCommand *)v5 setRequestIdentifier:requestIdentifier2];
    }
...
- (_SFPBShowPurchaseRequestSheetCommand)initWithDictionary:(id)dictionary
{
  ...
  v10.receiver = self;
  v10.super_class = _SFPBShowPurchaseRequestSheetCommand;
...
- (NSData)jsonData
{
  dictionaryRepresentation = [(_SFPBShowPurchaseRequestSheetCommand *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  {
    requestIdentifier = [(_SFPBShowPurchaseRequestSheetCommand *)self requestIdentifier];
...
- (BOOL)isEqual:(id)equal
{
  ...
  if ([equalCopy isMemberOfClass:objc_opt_class()])
  {
    ...
    {
      requestIdentifier3 = [(_SFPBShowPurchaseRequestSheetCommand *)self requestIdentifier];
...
LABEL_10:
      ...
      requestIdentifier4 = [(_SFPBShowPurchaseRequestSheetCommand *)self requestIdentifier];
