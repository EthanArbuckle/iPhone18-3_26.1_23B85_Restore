...
- (unint64_t)hash
{
  ...
  v4 = [(RFReferenceItemLogoCardSection *)self thumbnail];
  v5 = [v4 hash];
...
- (BOOL)isEqual:(id)a3
{
  ...
  else if ([(RFReferenceItemLogoCardSection *)v4 isMemberOfClass:objc_opt_class()]&& (v13.receiver = self, v13.super_class = RFReferenceItemLogoCardSection, [(SFCardSection *)&v13 isEqual:v4]))
  {
    v5 = v4;
    v6 = [(RFReferenceItemLogoCardSection *)self thumbnail];
    v7 = [(RFReferenceItemLogoCardSection *)v5 thumbnail];
    if ((v6 != 0) == (v7 == 0))
    {
      v11 = 0;
    }
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v5 = [(RFReferenceItemLogoCardSection *)self thumbnail];
  v6 = [v5 copy];
  [v4 setThumbnail:v6];
...
- (NSData)jsonData
{
  ...
  v3 = [(_SFPBRFReferenceItemLogoCardSection *)v2 jsonData];
...
{
  v2 = [[_SFPBRFReferenceItemLogoCardSection alloc] initWithFacade:self];
  v3 = [(_SFPBRFReferenceItemLogoCardSection *)v2 dictionaryRepresentation];
