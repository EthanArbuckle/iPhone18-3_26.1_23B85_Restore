...
LABEL_40:
        ...
        if (v22 == [(SFCardSection *)v5 canBeHidden])
        {
          ...
          if (v23 == [(SFCardSection *)v5 hasTopPadding])
          {
            ...
            {
              v25 = [(SFButtonListCardSection *)self type];
              ...
              if ((v25 != 0) != (v26 == 0))
              {
                ...
                if (v27 == [(SFCardSection *)v5 separatorStyle])
                {
                  ...
                  if ((v52 != 0) != (v28 == 0))
                  {
                    ...
                    v49 = [(SFButtonListCardSection *)self SectionTitle];
...
LABEL_57:
                    ...
                    v45 = [(SFButtonListCardSection *)self SectionTitle];
                    if (v45)
                    {
                      v31 = [(SFButtonListCardSection *)self SectionTitle];
                      v41 = [(SFButtonListCardSection *)v5 SectionTitle];
                      v42 = v31;
                      if (![v31 isEqual:?])
                      {
                        v11 = 0;
...
LABEL_24:
                    ...
                    v44 = [(SFButtonListCardSection *)self buttons];
                    v43 = [(SFButtonListCardSection *)v5 buttons];
                    if ((v44 != 0) == (v43 == 0))
                    {
                    ...
                    v40 = [(SFButtonListCardSection *)self buttons];
                    if (!v40 || (-[SFButtonListCardSection buttons](self, "buttons"), v32 = objc_claimAutoreleasedReturnValue(), -[SFButtonListCardSection buttons](v5, "buttons"), v36 = objc_claimAutoreleasedReturnValue(), v37 = v32, [v32 isEqual:?]))
                    {
                      v39 = [(SFButtonListCardSection *)self showMoreButtonTitle];
                      v38 = [(SFButtonListCardSection *)v5 showMoreButtonTitle];
                      if ((v39 != 0) == (v38 == 0))
                      {
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v11 = [(SFButtonListCardSection *)self type];
  v12 = [v11 copy];
  [v4 setType:v12];
  ...
  v15 = [(SFButtonListCardSection *)self SectionTitle];
  v16 = [v15 copy];
  [v4 setSectionTitle:v16];

  v17 = [(SFButtonListCardSection *)self buttons];
  v18 = [v17 copy];
  [v4 setButtons:v18];

  v19 = [(SFButtonListCardSection *)self showMoreButtonTitle];
  v20 = [v19 copy];
...
- (NSData)jsonData
{
  ...
  v3 = [(_SFPBButtonListCardSection *)v2 jsonData];
...
{
  v2 = [[_SFPBButtonListCardSection alloc] initWithFacade:self];
  v3 = [(_SFPBButtonListCardSection *)v2 dictionaryRepresentation];
