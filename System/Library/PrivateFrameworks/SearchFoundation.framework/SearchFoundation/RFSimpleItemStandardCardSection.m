...
- (BOOL)isEqual:(id)a3
{
  ...
  else
  {
    if ([(RFSimpleItemStandardCardSection *)v5 isMemberOfClass:objc_opt_class()])
    {
      ...
      {
        v6 = v5;
        v7 = [(RFSimpleItemStandardCardSection *)self text];
...
LABEL_37:
        ...
        v9 = [(RFSimpleItemStandardCardSection *)self text];
        if (v9)
        {
          v10 = [(RFSimpleItemStandardCardSection *)self text];
        ...
        if (v12)
        {
          v13 = [(RFSimpleItemStandardCardSection *)self text];
          v3 = [(RFSimpleItemStandardCardSection *)v6 text];
...
LABEL_33:
        ...
        v17 = [(RFSimpleItemStandardCardSection *)v6 text];
        v12 = v15;
        v8 = v53;
        if ((v16 != 0) != (v17 == 0))
        {
...
LABEL_57:
            ...
            else
            {
              ...
              {
                v35 = v29;
                v30 = [(RFSimpleItemStandardCardSection *)self text];
                v12 = v48;
                if (v30)
                {
                  v34 = v30;
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v5 = [(RFSimpleItemStandardCardSection *)self text];
  v6 = [v5 copy];
  [v4 setText_1:v6];
  ...
  v11 = [(RFSimpleItemStandardCardSection *)self text];
  v12 = [v11 copy];
  [v4 setText_4:v12];
  ...
  v15 = [(RFSimpleItemStandardCardSection *)self text];
  v16 = [v15 copy];
  [v4 setText_6:v16];
...
- (NSData)jsonData
{
  ...
  v3 = [(_SFPBRFSimpleItemStandardCardSection *)v2 jsonData];
...
{
  v2 = [[_SFPBRFSimpleItemStandardCardSection alloc] initWithFacade:self];
  v3 = [(_SFPBRFSimpleItemStandardCardSection *)v2 dictionaryRepresentation];
