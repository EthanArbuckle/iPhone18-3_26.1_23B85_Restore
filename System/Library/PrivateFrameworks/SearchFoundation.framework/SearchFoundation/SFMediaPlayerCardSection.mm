...
LABEL_40:
        ...
        if (v22 == [(SFCardSection *)v5 canBeHidden])
        {
          ...
          if (v23 == [(SFCardSection *)v5 hasTopPadding])
          {
            ...
            {
              v25 = [(SFMediaPlayerCardSection *)self type];
...
LABEL_24:
                    ...
                    if (!v40 || (-[SFMediaPlayerCardSection subtitle](self, "subtitle"), v32 = objc_claimAutoreleasedReturnValue(), -[SFMediaPlayerCardSection subtitle](v5, "subtitle"), v36 = objc_claimAutoreleasedReturnValue(), v37 = v32, [v32 isEqual:?]))
                    {
                      v39 = [(SFMediaPlayerCardSection *)self mediaItems];
                      v38 = [(SFMediaPlayerCardSection *)v5 mediaItems];
                      if ((v39 != 0) == (v38 == 0))
                      {
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v11 = [(SFMediaPlayerCardSection *)self type];
  v12 = [v11 copy];
  [v4 setType:v12];
  ...
  v15 = [(SFMediaPlayerCardSection *)self title];
  v16 = [v15 copy];
  [v4 setTitle:v16];

  v17 = [(SFMediaPlayerCardSection *)self subtitle];
  v18 = [v17 copy];
  [v4 setSubtitle:v18];

  v19 = [(SFMediaPlayerCardSection *)self mediaItems];
  v20 = [v19 copy];
...
- (NSData)jsonData
{
  ...
  v3 = [(_SFPBMediaPlayerCardSection *)v2 jsonData];
...
{
  v2 = [[_SFPBMediaPlayerCardSection alloc] initWithFacade:self];
  v3 = [(_SFPBMediaPlayerCardSection *)v2 dictionaryRepresentation];
