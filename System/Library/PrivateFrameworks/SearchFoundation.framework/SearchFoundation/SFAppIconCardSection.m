...
{
  v23.receiver = self;
  v23.super_class = SFAppIconCardSection;
  ...
  v20 = [(SFCardSection *)self applicationBundleIdentifier];
  v21 = [v20 hash];
...
- (BOOL)isEqual:(id)a3
{
  ...
  else
  {
    ...
    {
      v78.receiver = self;
      v78.super_class = SFAppIconCardSection;
...
LABEL_65:
                ...
                if (!v53 || (-[SFAppIconCardSection title](self, "title"), v44 = objc_claimAutoreleasedReturnValue(), -[SFAppIconCardSection title](v6, "title"), v50 = objc_claimAutoreleasedReturnValue(), v51 = v44, [v44 isEqual:?]))
                {
                  v52 = [(SFCardSection *)self applicationBundleIdentifier];
                  v45 = [(SFCardSection *)v6 applicationBundleIdentifier];
                  v46 = v45;
                  if ((v52 != 0) == (v45 == 0))
                  {
                  ...
                  {
                    v49 = [(SFCardSection *)self applicationBundleIdentifier];
                    if (v49)
                    {
                      v48 = [(SFCardSection *)self applicationBundleIdentifier];
                      v47 = [(SFCardSection *)v6 applicationBundleIdentifier];
                      v11 = [v48 isEqual:v47];
                    }
...
{
  v20.receiver = self;
  v20.super_class = SFAppIconCardSection;
  ...
  v11 = [(SFAppIconCardSection *)self type];
  v12 = [v11 copy];
  [v4 setType:v12];
  ...
  v15 = [(SFAppIconCardSection *)self title];
  v16 = [v15 copy];
  [v4 setTitle:v16];

  v17 = [(SFCardSection *)self applicationBundleIdentifier];
  v18 = [v17 copy];
...
- (NSData)jsonData
{
  ...
  v3 = [(_SFPBAppIconCardSection *)v2 jsonData];
...
{
  v2 = [[_SFPBAppIconCardSection alloc] initWithFacade:self];
  v3 = [(_SFPBAppIconCardSection *)v2 dictionaryRepresentation];
...
{
  v3.receiver = self;
  v3.super_class = SFAppIconCardSection;
...
- (SFAppIconCardSection)initWithCoder:(id)a3
{
  ...
  if (objc_opt_isKindOfClass())
  {
    ...
    v15 = [(SFCardSection *)v8 applicationBundleIdentifier];
    [(SFCardSection *)v5 setApplicationBundleIdentifier:v15];
...
- (SFAppIconCardSection)initWithProtobuf:(id)a3
{
  ...
  v4 = a3;
  v35.receiver = self;
  v35.super_class = SFAppIconCardSection;
  ...
  if (v5)
  {
    ...
    if (v26)
    {
      ...
      [(SFCardSection *)v5 setApplicationBundleIdentifier:v27];
    }
