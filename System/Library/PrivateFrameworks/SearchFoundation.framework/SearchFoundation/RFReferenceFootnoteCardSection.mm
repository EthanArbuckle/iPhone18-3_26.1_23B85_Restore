...
- (RFReferenceFootnoteCardSection)initWithCoder:(id)coder;
- (RFReferenceFootnoteCardSection)initWithProtobuf:(id)protobuf;
...
- (unint64_t)hash
{
  ...
  text = [(RFReferenceFootnoteCardSection *)self text];
  v5 = [text hash];
  text2 = [(RFReferenceFootnoteCardSection *)self text];
  v7 = v5 ^ [text2 hash];
  text3 = [(RFReferenceFootnoteCardSection *)self text];
  v9 = v7 ^ [text3 hash];
  text4 = [(RFReferenceFootnoteCardSection *)self text];
  v11 = v9 ^ [text4 hash];
...
- (BOOL)isEqual:(id)equal
{
  ...
  {
    if ([(RFReferenceFootnoteCardSection *)equalCopy isMemberOfClass:objc_opt_class()])
    {
      v42.receiver = self;
      ...
      if ([(SFCardSection *)&v42 isEqual:equalCopy])
      {
        v5 = equalCopy;
        text = [(RFReferenceFootnoteCardSection *)self text];
        text2 = [(RFReferenceFootnoteCardSection *)v5 text];
        if ((text != 0) == (text2 == 0))
        {
          LOBYTE(v10) = 0;
LABEL_38:
        ...
        {
          text4 = [(RFReferenceFootnoteCardSection *)self text];
          text5 = [(RFReferenceFootnoteCardSection *)v5 text];
          if (![text4 isEqual:?])
          {
            LOBYTE(v10) = 0;
            goto LABEL_36;
        ...
        text6 = [(RFReferenceFootnoteCardSection *)self text];
        text7 = [(RFReferenceFootnoteCardSection *)v5 text];
        if ((text6 != 0) != (text7 == 0))
        {
          text8 = [(RFReferenceFootnoteCardSection *)self text];
          if (text8)
          {
            v13 = text8;
            text9 = [(RFReferenceFootnoteCardSection *)self text];
          ...
          text10 = [(RFReferenceFootnoteCardSection *)self text];
          text11 = [(RFReferenceFootnoteCardSection *)v5 text];
          if ((text10 != 0) != (text11 == 0))
          {
            v34 = text10;
            v35 = text11;
            text12 = [(RFReferenceFootnoteCardSection *)self text];
            if (text12)
            {
              text13 = [(RFReferenceFootnoteCardSection *)self text];
              text14 = [(RFReferenceFootnoteCardSection *)v5 text];
              v33 = text13;
              if (![text13 isEqual:?])
              {
                LOBYTE(v10) = 0;
            ...
            text15 = [(RFReferenceFootnoteCardSection *)self text];
            v21 = text15 != 0;
            text16 = [(RFReferenceFootnoteCardSection *)v5 text];
            if (v21 == (text16 == 0))
            {
            ...
            {
              addTint = [(RFReferenceFootnoteCardSection *)self addTint];
              v10 = addTint ^ [(RFReferenceFootnoteCardSection *)v5 addTint]^ 1;
              if (!v31)
              {
                goto LABEL_42;
              }
...
- (NSData)jsonData
{
  ...
  jsonData = [(_SFPBRFReferenceFootnoteCardSection *)v2 jsonData];
...
{
  v2 = [[_SFPBRFReferenceFootnoteCardSection alloc] initWithFacade:self];
  dictionaryRepresentation = [(_SFPBRFReferenceFootnoteCardSection *)v2 dictionaryRepresentation];
...
- (RFReferenceFootnoteCardSection)initWithCoder:(id)coder
{
  ...
  if (objc_opt_isKindOfClass())
  {
    ...
    [(RFReferenceFootnoteCardSection *)v5 setText_1:text];

    text2 = [(SFCardSection *)v8 text];
    [(RFReferenceFootnoteCardSection *)v5 setText_2:text2];

    text3 = [(SFCardSection *)v8 text];
    [(RFReferenceFootnoteCardSection *)v5 setText_3:text3];

    text4 = [(SFCardSection *)v8 text];
    [(RFReferenceFootnoteCardSection *)v5 setText_4:text4];
...
- (RFReferenceFootnoteCardSection)initWithProtobuf:(id)protobuf
{
  ...
  if (v5)
  {
    ...
    {
      -[RFReferenceFootnoteCardSection setAddTint:](v5, "setAddTint:", [protobufCopy addTint]);
    }
