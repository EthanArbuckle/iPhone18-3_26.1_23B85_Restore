...
- (BOOL)scanAllPartitionsForModel:(id)a3 csIdentity:(id)a4 expunge:(BOOL)a5
{
  ...
  v9 = &selRef_removeItemAtURL_error_;
  v10 = os_signpost_id_generate(qword_100021AF8);
  ...
  if (v18)
  {
    ...
    while (1)
    {
      ...
      do
      {
        ...
        v24 = [v19[121] modelBinaryName];
        v25 = [v23 isEqualToString:v24];

        if (v25)
        {
          v26 = [v22 URLByDeletingLastPathComponent];
          v27 = [v19[121] modelSourceStoreName];
