    ...
    *attributes = ANECCreateModelDictionary();
    if (!precompiled && ([objc_opt_class() updateAccessTimeForFilePath:pathCopy] & 1) == 0)
    {
      ...
      if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR))
      {
        ...
        sub_10000515C(v18, pathCopy, buf, v17);
      }
    }
      ...
      if (v21)
      {
        ...
        if (v25)
        {
          ...
          else
          {
            ...
            modelCacheRetainName = [v15[67] modelCacheRetainName];
...
+ (BOOL)_markPurgeablePath:(id)path error:(id *)error
{
  ...
  else
  {
    ...
    else
    {
      if (os_log_type_enabled(qword_10000C8C0, OS_LOG_TYPE_DEBUG))
      {
        sub_1000054F0(uTF8String, &v23, v11);
      }
