@interface _ANEVirtualClient(Private)
@end
...
{
  v2 = [OUTLINED_FUNCTION_5_2(a1 a2)];
...
- (void)doEvaluateWithModelLegacy:()Private options:request:qos:completionEvent:error:.cold.23(_DWORD *a1, int a2, _DWORD *a3)
{
  *a1 = 67109120;
  *a3 = a2;
  OUTLINED_FUNCTION_1_6();
...
- (void)doEvaluateWithModelLegacy:()Private options:request:qos:completionEvent:error:.cold.28(uint64_t a1, uint64_t a2)
{
  v2 = [OUTLINED_FUNCTION_5_2(a1 a2)];
  OUTLINED_FUNCTION_9_0(v2, 3.852e-34);
  OUTLINED_FUNCTION_1_6();
