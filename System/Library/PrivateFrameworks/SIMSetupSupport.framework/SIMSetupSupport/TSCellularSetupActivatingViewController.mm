...
- (TSCellularSetupActivatingViewController)initWithTitle:(id)a3 details:(id)a4 symbolName:(id)a5 plans:(id)a6 skip:(BOOL)a7;
- (TSCellularSetupActivatingViewController)initWithTransferOutPlan:(id)a3;
...
- (TSCellularSetupActivatingViewController)initWithTitle:(id)a3 details:(id)a4 symbolName:(id)a5 plans:(id)a6 skip:(BOOL)a7
{
  ...
  v13 = [(OBTableWelcomeController *)&v20 initWithTitle:a3 detailText:a4 symbolName:a5 adoptTableViewScrollView:0];
  if (v13)
  {
    v14 = !v7 && [v12 count] < 2;
    v13->_needShow = v14;
