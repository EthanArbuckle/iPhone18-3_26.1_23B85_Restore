...
- (LogSpecificMedicationsIntent)initWithDomain:(id)domain verb:(id)verb parametersByName:(id)name;
- (LogSpecificMedicationsIntent)initWithIdentifier:(id)identifier backingStore:(id)store;
@end
...
- (LogSpecificMedicationsIntent)initWithIdentifier:(id)identifier backingStore:(id)store
{
  ...
  return LogSpecificMedicationsIntent.init(identifier:backingStore:)(v8, v9, store);
}
