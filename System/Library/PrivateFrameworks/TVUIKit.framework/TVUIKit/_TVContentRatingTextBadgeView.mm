...
- (_TVContentRatingTextBadgeView)initWithFrame:(CGRect)a3
{
  ...
  v3 = [(_TVContentRatingTextBadgeView *)&v6 initWithFrame:a3.origin.x, a3.origin.y, a3.size.width, a3.size.height];
  if (v3)
  {
...
- (void)drawRect:(CGRect)a3
{
  ...
  v9 = objc_opt_class();
  v10 = [(_TVContentRatingTextBadgeView *)self contentRatingAttributedText];
...
- (void)_updateContentRatingAttributedText:(id)a3
{
  v4 = a3;
  v5 = objc_opt_class();
  v6 = [(_TVContentRatingTextBadgeView *)self tintColor];
...
{
  v3 = objc_opt_class();
  v4 = [(_TVContentRatingTextBadgeView *)self contentRatingAttributedText];
