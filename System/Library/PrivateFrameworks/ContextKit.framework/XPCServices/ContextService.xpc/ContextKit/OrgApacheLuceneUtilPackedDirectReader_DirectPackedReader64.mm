...
- (OrgApacheLuceneUtilPackedDirectReader_DirectPackedReader64)initWithOrgApacheLuceneStoreRandomAccessInput:(id)input;
...
- (int64_t)getWithLong:(int64_t)long
{
  ...
  return [(OrgApacheLuceneStoreRandomAccessInput *)in readLongWithLong:8 * long];
}
