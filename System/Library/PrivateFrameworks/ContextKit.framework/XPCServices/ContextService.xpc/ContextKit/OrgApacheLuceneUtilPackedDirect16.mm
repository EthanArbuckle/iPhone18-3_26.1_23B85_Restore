...
- (int64_t)ramBytesUsed
{
  ...
  return OrgApacheLuceneUtilRamUsageEstimator_sizeOfWithShortArray_(self->values_) + v4;
}
...
- (int)setWithInt:(int)int withLongArray:(id)array withInt:(int)withInt withInt:(int)a6
{
  ...
  if (v10 + v8 > v8)
  {
    ...
    do
    {
      ...
      *(&values->super.size_ + v8++ + 2) = *(array + withIntCopy + 2);
...
{
  v3.receiver = self;
  v3.super_class = OrgApacheLuceneUtilPackedDirect16;
