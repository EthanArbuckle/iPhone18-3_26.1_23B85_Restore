...
- (OrgApacheLuceneUtilPackedDirectReader_DirectPackedReader8)initWithOrgApacheLuceneStoreRandomAccessInput:(id)input;
...
- (int64_t)getWithLong:(int64_t)long
{
  ...
  return [(OrgApacheLuceneStoreRandomAccessInput *)in readByteWithLong:long];
}
