...
+ (id)wrapWithLongArray:(id)a3
{
  ...
  return JavaNioLongBuffer_wrapWithLongArray_withInt_withInt_(a3, 0, v5);
}
...
- (id)getWithLongArray:(id)a3
{
  ...
  return [(JavaNioLongBuffer *)self getWithLongArray:a3 withInt:0 withInt:v4];
}
...
- (id)putWithLongArray:(id)a3
{
  ...
  return [(JavaNioLongBuffer *)self putWithLongArray:a3 withInt:0 withInt:v4];
}
...
LABEL_11:
  ...
  v6 = +[IOSLongArray arrayWithLength:](IOSLongArray, "arrayWithLength:", [a3 remaining]);
