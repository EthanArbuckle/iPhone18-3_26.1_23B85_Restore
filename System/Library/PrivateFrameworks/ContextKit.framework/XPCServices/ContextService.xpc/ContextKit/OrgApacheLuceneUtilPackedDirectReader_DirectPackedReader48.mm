...
- (OrgApacheLuceneUtilPackedDirectReader_DirectPackedReader48)initWithOrgApacheLuceneStoreRandomAccessInput:(id)input;
...
- (int64_t)getWithLong:(int64_t)long
{
  ...
  return [(OrgApacheLuceneStoreRandomAccessInput *)in readLongWithLong:6 * long]>> 16;
}
