...
- (ComAppleContextkitUtilBytesRefPool_DirectTrackingAllocator)initWithInt:(int)int withOrgApacheLuceneUtilCounter:(id)counter;
- (ComAppleContextkitUtilBytesRefPool_DirectTrackingAllocator)initWithOrgApacheLuceneUtilCounter:(id)counter;
- (id)getByteBlock;
- (void)dealloc;
