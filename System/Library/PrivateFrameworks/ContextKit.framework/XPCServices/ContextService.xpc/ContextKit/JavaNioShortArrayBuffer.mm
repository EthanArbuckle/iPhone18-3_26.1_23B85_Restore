...
- (id)slice
{
  v2 = sub_100271624([(JavaNioBuffer *)self remaining], self->backingArray_, self->super.super.position_ + self->arrayOffset_, self->isReadOnly_);
...
{
  v3.receiver = self;
  v3.super_class = JavaNioShortArrayBuffer;
