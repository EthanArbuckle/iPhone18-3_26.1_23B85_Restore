...
- (OrgApacheLuceneUtilPackedDirectReader_DirectPackedReader40)initWithOrgApacheLuceneStoreRandomAccessInput:(id)input;
...
- (int64_t)getWithLong:(int64_t)long
{
  ...
  return [(OrgApacheLuceneStoreRandomAccessInput *)in readLongWithLong:5 * long]>> 24;
}
