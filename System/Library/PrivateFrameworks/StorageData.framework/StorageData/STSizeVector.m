...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    objc_opt_class();
    v5 = (objc_opt_isKindOfClass() & 1) != 0 && [(STSizeVector *)self isEqualToSizeVector:v4];
  }
...
- (id)plus:(id)a3
{
  ...
  v12 = [(STSizeVector *)v5 initWithFixed:v7 + fixed docsAndData:v9 + docsAndData purgeable:v11 + purgeable];
