...
- (id)fetchSongWithUID:(id)a3
{
  ...
  if (v8)
  {
    ...
    v18 = objc_msgSend_fetchSongWithUID_(v14, v15, v8, v16, v17);
    ...
    if (!v18)
    {
      ...
      v18 = objc_msgSend_objectForKey_(v24, v25, v8, v26, v27);
...
- (id)fetchSongsWithOptions:(id)a3
{
  ...
  if (v4)
  {
    v24 = objc_msgSend_predicate(v4, v18, v19, v20, v21);
    ...
    if (v24)
    {
      ...
      v108[0] = v22;
      v26 = objc_msgSend_predicate(v4, v18, v19, v20, v21);
      v108[1] = v26;
  ...
  v42 = objc_msgSend_fetchSongsWithOptions_(v38, v39, v4, v40, v41);
...
- (void)_loadBundledSongs
{
  ...
  objc_msgSend_setBundledSongs_(v16, v22, v21, v23, v24);
  ...
  if (v31)
  {
    ...
    do
    {
      for (i = 0; i != v31; ++i)
      {
        ...
        v34 = *(*(&v55 + 1) + 8 * i);
        v35 = objc_msgSend_bundledSongs(v16, v27, v28, v29, v30, v55);
  ...
  {
    v48 = objc_msgSend_bundledSongs(v16, v44, v45, v46, v47);
...
- (void)networkStatusChanged:(id)a3
{
  v6 = objc_msgSend_flexReachability(self, a2, a3, v3, v4);
...
- (void)_notifySongsChanged:(id)a3
{
  v7 = objc_msgSend_defaultCenter(MEMORY[0x277CCAB98], a2, a3, v3, v4);
  ...
  if (v13)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        objc_msgSend_requestDownloadOfAllAssetsWithIDs_withOptions_(*(*(&v20 + 1) + 8 * v18++), v14, v6, v7, v15);
      }
