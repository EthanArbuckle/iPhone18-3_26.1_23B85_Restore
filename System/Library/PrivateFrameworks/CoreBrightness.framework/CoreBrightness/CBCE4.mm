...
- (CBCE4)init
{
  ...
  v6 = 0;
  v6 = [CBCE4 initWithContentsOfURL:"initWithContentsOfURL:error:" error:?];
...
- (CBCE4)initWithConfiguration:(id)a3 error:(id *)a4
{
  ...
  v9 = 0;
  v9 = [CBCE4 initWithContentsOfURL:v5 configuration:"initWithContentsOfURL:configuration:error:" error:?];
...
- (CBCE4)initWithContentsOfURL:(id)a3 error:(id *)a4
{
  ...
  objc_storeStrong(location, a3);
  v7[1] = a4;
  v7[0] = [getMLModelClass_3() modelWithContentsOfURL:location[0] error:a4];
  if (v7[0])
  {
    v4 = v9;
    v9 = 0;
...
- (CBCE4)initWithContentsOfURL:(id)a3 configuration:(id)a4 error:(id *)a5
{
  ...
  v9[1] = a5;
  v9[0] = [getMLModelClass_3() modelWithContentsOfURL:location[0] configuration:v10 error:a5];
  if (v9[0])
  {
    v5 = v12;
    v12 = 0;
...
- (id)predictionFromFeatures:(id)a3 options:(id)a4 error:(id *)a5
{
  ...
  if (v25[0])
  {
    ...
    v29 = [(CBCE4Output *)v7 initWithCBCE4_Q0_output:v20 CBCE4_Q1_output:v18 CBCE4_Q2_output:v16 CBCE4_Q3_output:v14 CBCE4_Q4_output:v12 strength_output:v10 uncertainty:v8];
...
- (id)predictionFromInput:(id)a3 error:(id *)a4
{
  ...
  v7 = [(CBCE4 *)v10 predictionFromFeatures:v8[0] error:a4];
  ...
  *&v6 = MEMORY[0x1E69E5920](v28).n128_u64[0];
  if (v34)
  {
    ...
    for (i = 0; ; ++i)
    {
      ...
      v29 = [(CBCE4Output *)v10 initWithCBCE4_Q0_output:v23 CBCE4_Q1_output:v21 CBCE4_Q2_output:v19 CBCE4_Q3_output:v17 CBCE4_Q4_output:v15 strength_output:v13 uncertainty:v11];
      MEMORY[0x1E69E5920](v11);
      MEMORY[0x1E69E5920](v12);
      MEMORY[0x1E69E5920](v13);
      MEMORY[0x1E69E5920](v14);
