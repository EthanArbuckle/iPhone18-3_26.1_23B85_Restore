...
- (CBCE2)init
{
  ...
  v6 = 0;
  v6 = [CBCE2 initWithContentsOfURL:"initWithContentsOfURL:error:" error:?];
...
- (CBCE2)initWithConfiguration:(id)a3 error:(id *)a4
{
  ...
  v9 = 0;
  v9 = [CBCE2 initWithContentsOfURL:v5 configuration:"initWithContentsOfURL:configuration:error:" error:?];
...
- (CBCE2)initWithContentsOfURL:(id)a3 error:(id *)a4
{
  ...
  objc_storeStrong(location, a3);
  v7[1] = a4;
  v7[0] = [getMLModelClass_0() modelWithContentsOfURL:location[0] error:a4];
  if (v7[0])
  {
    v4 = v9;
    v9 = 0;
...
- (CBCE2)initWithContentsOfURL:(id)a3 configuration:(id)a4 error:(id *)a5
{
  ...
  v9[1] = a5;
  v9[0] = [getMLModelClass_0() modelWithContentsOfURL:location[0] configuration:v10 error:a5];
  if (v9[0])
  {
    v5 = v12;
    v12 = 0;
...
- (id)predictionFromFeatures:(id)a3 options:(id)a4 error:(id *)a5
{
  ...
  if (v24[0])
  {
    ...
    v28 = [(CBCE2Output *)v7 initWithCBCE2_Q0_output:v20 CBCE2_Q1_output:v18 CBCE2_Q2_output:v16 CBCE2_Q3_output:v14 CBCE2_Q4_output:v12 strength_output:v10 uncertainty:v8];
...
- (id)predictionFromInput:(id)a3 error:(id *)a4
{
  ...
  v7 = [(CBCE2 *)v10 predictionFromFeatures:v8[0] error:a4];
...
- (id)predictionsFromInputs:(id)a3 options:(id)a4 error:(id *)a5
{
  ...
  if (v32)
  {
    ...
    for (i = 0; ; ++i)
    {
      ...
      v10 = [v11 multiArrayValue];
      v27 = [(CBCE2Output *)v9 initWithCBCE2_Q0_output:v22 CBCE2_Q1_output:v20 CBCE2_Q2_output:v18 CBCE2_Q3_output:v16 CBCE2_Q4_output:v14 strength_output:v12 uncertainty:v10];
      MEMORY[0x1E69E5920](v10);
      MEMORY[0x1E69E5920](v11);
      MEMORY[0x1E69E5920](v12);
      MEMORY[0x1E69E5920](v13);
