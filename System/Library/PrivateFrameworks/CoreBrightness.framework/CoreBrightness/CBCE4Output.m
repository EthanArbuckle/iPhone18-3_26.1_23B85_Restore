...
- (CBCE4Output)initWithCBCE4_Q0_output:(id)a3 CBCE4_Q1_output:(id)a4 CBCE4_Q2_output:(id)a5 CBCE4_Q3_output:(id)a6 CBCE4_Q4_output:(id)a7 strength_output:(id)a8 uncertainty:(id)a9
{
  ...
  if (v25)
  {
    objc_storeStrong(&v25->_CBCE4_Q0_output, location[0]);
    objc_storeStrong(&v25->_CBCE4_Q1_output, v23);
    objc_storeStrong(&v25->_CBCE4_Q2_output, v22);
    objc_storeStrong(&v25->_CBCE4_Q3_output, v21);
    objc_storeStrong(&v25->_CBCE4_Q4_output, v20);
