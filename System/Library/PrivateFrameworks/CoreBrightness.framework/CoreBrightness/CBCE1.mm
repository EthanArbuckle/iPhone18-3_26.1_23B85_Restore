...
- (CBCE1)init;
- (CBCE1)initWithConfiguration:(id)configuration error:(id *)error;
- (CBCE1)initWithContentsOfURL:(id)l configuration:(id)configuration error:(id *)error;
- (CBCE1)initWithContentsOfURL:(id)l error:(id *)error;
- (CBCE1)initWithMLModel:(id)model;
...
- (CBCE1)init
{
  ...
  selfCopy = 0;
  selfCopy = [CBCE1 initWithContentsOfURL:"initWithContentsOfURL:error:" error:?];
...
- (CBCE1)initWithConfiguration:(id)configuration error:(id *)error
{
  ...
  uRLOfModelInThisBundle = [objc_opt_class() URLOfModelInThisBundle];
  selfCopy = 0;
  selfCopy = [CBCE1 initWithContentsOfURL:v5 configuration:"initWithContentsOfURL:configuration:error:" error:?];
...
- (CBCE1)initWithContentsOfURL:(id)l error:(id *)error
{
  ...
  v7[1] = error;
  v7[0] = [getMLModelClass_2() modelWithContentsOfURL:location[0] error:error];
  if (v7[0])
  {
    v4 = selfCopy;
    selfCopy = 0;
...
- (CBCE1)initWithContentsOfURL:(id)l configuration:(id)configuration error:(id *)error
{
  ...
  v9[1] = error;
  v9[0] = [getMLModelClass_2() modelWithContentsOfURL:location[0] configuration:v10 error:error];
  if (v9[0])
  {
    v5 = selfCopy;
    selfCopy = 0;
...
- (id)predictionFromFeatures:(id)features options:(id)options error:(id *)error
{
  ...
  if (v24[0])
  {
    ...
    v28 = [(CBCE1Output *)v7 initWithCBCE1_Q0_output:multiArrayValue CBCE1_Q1_output:multiArrayValue2 CBCE1_Q2_output:multiArrayValue3 CBCE1_Q3_output:multiArrayValue4 CBCE1_Q4_output:multiArrayValue5 strength_output:multiArrayValue6 uncertainty:multiArrayValue7];
...
- (id)predictionFromInput:(id)input error:(id *)error
{
  ...
  v7 = [(CBCE1 *)selfCopy predictionFromFeatures:v8[0] error:error];
...
- (id)predictionsFromInputs:(id)inputs options:(id)options error:(id *)error
{
  ...
  if (v32)
  {
    ...
    for (i = 0; ; ++i)
    {
      ...
      v27 = [(CBCE1Output *)v9 initWithCBCE1_Q0_output:multiArrayValue CBCE1_Q1_output:multiArrayValue2 CBCE1_Q2_output:multiArrayValue3 CBCE1_Q3_output:multiArrayValue4 CBCE1_Q4_output:multiArrayValue5 strength_output:multiArrayValue6 uncertainty:multiArrayValue7];
      MEMORY[0x1E69E5920](multiArrayValue7);
      MEMORY[0x1E69E5920](v11);
      MEMORY[0x1E69E5920](multiArrayValue6);
      MEMORY[0x1E69E5920](v13);
