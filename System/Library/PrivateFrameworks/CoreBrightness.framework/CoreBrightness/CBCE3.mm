...
- (CBCE3)init;
- (CBCE3)initWithConfiguration:(id)configuration error:(id *)error;
- (CBCE3)initWithContentsOfURL:(id)l configuration:(id)configuration error:(id *)error;
- (CBCE3)initWithContentsOfURL:(id)l error:(id *)error;
- (CBCE3)initWithMLModel:(id)model;
...
- (CBCE3)init
{
  ...
  selfCopy = 0;
  selfCopy = [CBCE3 initWithContentsOfURL:"initWithContentsOfURL:error:" error:?];
...
- (CBCE3)initWithConfiguration:(id)configuration error:(id *)error
{
  ...
  uRLOfModelInThisBundle = [objc_opt_class() URLOfModelInThisBundle];
  selfCopy = 0;
  selfCopy = [CBCE3 initWithContentsOfURL:v5 configuration:"initWithContentsOfURL:configuration:error:" error:?];
...
- (CBCE3)initWithContentsOfURL:(id)l error:(id *)error
{
  ...
  v7[1] = error;
  v7[0] = [getMLModelClass() modelWithContentsOfURL:location[0] error:error];
  if (v7[0])
  {
    v4 = selfCopy;
    selfCopy = 0;
...
- (CBCE3)initWithContentsOfURL:(id)l configuration:(id)configuration error:(id *)error
{
  ...
  v9[1] = error;
  v9[0] = [getMLModelClass() modelWithContentsOfURL:location[0] configuration:v10 error:error];
  if (v9[0])
  {
    v5 = selfCopy;
    selfCopy = 0;
...
- (id)predictionFromFeatures:(id)features options:(id)options error:(id *)error
{
  ...
  if (v25[0])
  {
    ...
    v29 = [(CBCE3Output *)v7 initWithCBCE3_Q0_output:multiArrayValue CBCE3_Q1_output:multiArrayValue2 CBCE3_Q2_output:multiArrayValue3 CBCE3_Q3_output:multiArrayValue4 CBCE3_Q4_output:multiArrayValue5 strength_output:multiArrayValue6 uncertainty:multiArrayValue7];
...
- (id)predictionFromInput:(id)input error:(id *)error
{
  ...
  v7 = [(CBCE3 *)selfCopy predictionFromFeatures:v8[0] error:error];
  ...
  *&v6 = MEMORY[0x1E69E5920](model).n128_u64[0];
  if (v34)
  {
    ...
    for (i = 0; ; ++i)
    {
      ...
      v29 = [(CBCE3Output *)v10 initWithCBCE3_Q0_output:multiArrayValue CBCE3_Q1_output:multiArrayValue2 CBCE3_Q2_output:multiArrayValue3 CBCE3_Q3_output:multiArrayValue4 CBCE3_Q4_output:multiArrayValue5 strength_output:multiArrayValue6 uncertainty:multiArrayValue7];
      MEMORY[0x1E69E5920](multiArrayValue7);
