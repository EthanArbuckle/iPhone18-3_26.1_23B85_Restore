    ...
    if (Count >= 1)
    {
      for (i = 0; i != Count; ++i)
      {
        ...
        if (!v10)
        {
          ...
          [v15 handleFailureInMethod:a2 object:a1 file:@"SGTokenizer.m" lineNumber:141 description:{@"ITSTokenListCopyEscapedTokenAtIndex failed to get token at index %ld", i}];
        }
...
+ (void)enumerateTokensInString:(id)a3 withRange:(_NSRange)a4 block:(id)a5
{
  ...
  else
  {
    ...
    [v17 handleFailureInMethod:a2 object:a1 file:@"SGTokenizer.m" lineNumber:33 description:{@"Invalid parameter not satisfying: %@", @"str"}];
  ...
  [v18 handleFailureInMethod:a2 object:a1 file:@"SGTokenizer.m" lineNumber:34 description:{@"Invalid parameter not satisfying: %@", @"block"}];
