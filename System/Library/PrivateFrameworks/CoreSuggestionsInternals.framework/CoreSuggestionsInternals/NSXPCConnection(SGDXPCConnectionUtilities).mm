...
- (id)sgd_clientName
{
  ...
  if (!v2 || (v3 = v2, v4 = SecTaskCopyValueForEntitlement(v2, @"application-identifier", 0), CFRelease(v3), !v4))
  {
    ...
    if (proc_name([self processIdentifier], &token, 0xFFu) <= 0 || (objc_msgSend(MEMORY[0x277CCACA8], "stringWithUTF8String:", &token), (v5 = objc_claimAutoreleasedReturnValue()) == 0))
    {
      v5 = [objc_alloc(MEMORY[0x277CCACA8]) initWithFormat:@"%d", objc_msgSend(self, "processIdentifier")];
    }
