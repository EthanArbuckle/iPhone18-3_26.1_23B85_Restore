...
+ (id)newTransformerInstanceForLanguage:(id)language
{
  ...
  v41 = [SGTransformerInstance defaultSessionDescriptorForModelId:@"SignificantEmailAddress" featureVersion:@"1.4" language:languageCopy windowAndNgrams:?];
  ...
  v42[1] = v39;
  v38 = [SGTokenizerMappingTransformer forLocale:languageCopy withPersonalNameMapping:@"SG_FEATURE_FULLNAME"];
  v42[2] = v38;
  ...
  v42[4] = v36;
  v35 = [SGModelMappingHelper mappingsForType:@"SG_FEATURE_RECENCY" andLanguage:languageCopy];
  v34 = [SGStringMappingTransformer withMappings:v35];
  v42[5] = v34;
  v32 = [SGModelMappingHelper mappingsForType:@"SG_FEATURE_ENTITYTYPE" andLanguage:languageCopy];
  v31 = [SGStringMappingTransformer withMappings:v32];
  v42[6] = v31;
  v30 = [SGModelMappingHelper mappingsForType:@"SG_FEATURE_ADDRESSTYPE" andLanguage:languageCopy];
  v29 = [SGStringMappingTransformer withMappings:v30];
  v42[7] = v29;
  v28 = [SGModelMappingHelper mappingsForType:@"SG_FEATURE_OTHER" andLanguage:languageCopy];
  v27 = [SGStringMappingTransformer withMappings:v28];
  v42[8] = v27;
  v26 = [SGModelMappingHelper mappingsForType:@"SG_FEATURE_EMAILTYPE" andLanguage:languageCopy];
  v25 = [SGStringMappingTransformer withMappings:v26];
  v42[9] = v25;
  v23 = [SGModelMappingHelper mappingsForType:@"SG_FEATURE_CALLTYPE" andLanguage:languageCopy];
  v22 = [SGStringMappingTransformer withMappings:v23];
  v42[10] = v22;
  v21 = [SGModelMappingHelper mappingsForType:@"SG_FEATURE_PHONETYPE" andLanguage:languageCopy];
