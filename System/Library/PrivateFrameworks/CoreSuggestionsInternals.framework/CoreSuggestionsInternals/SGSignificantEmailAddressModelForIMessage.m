...
+ (id)newTransformerInstanceForLanguage:(id)a3
{
  ...
  v23[1] = v20;
  v19 = [SGTokenizerMappingTransformer forLocale:v21 withPersonalNameMapping:@"SG_FEATURE_FULLNAME"];
  v23[2] = v19;
  ...
  v10 = [v18 second];
  v11 = [v9 withBucketSize:10000 andNgrams:{objc_msgSend(v10, "intValue")}];
  v24[1] = v11;
  v12 = [MEMORY[0x277CBEA60] arrayWithObjects:v24 count:2];
  v13 = [v3 withTransformers:v12];

  v14 = [SGTransformerInstance defaultSessionDescriptorForModelId:@"SignificantEmailAddressForIMessage" featureVersion:@"1.5" language:v21 windowAndNgrams:v18];
