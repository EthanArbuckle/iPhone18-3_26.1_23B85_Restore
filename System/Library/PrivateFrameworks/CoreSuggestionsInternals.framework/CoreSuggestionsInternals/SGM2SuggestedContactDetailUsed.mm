...
- (void)mergeFrom:(id)from
{
  ...
  {
    v5 = fromCopy;
    [(SGM2SuggestedContactDetailUsed *)self setKey:?];
    fromCopy = v5;
  }
...
- (id)description
{
  ...
  v8.receiver = self;
  v8.super_class = SGM2SuggestedContactDetailUsed;
  v4 = [(SGM2SuggestedContactDetailUsed *)&v8 description];
  dictionaryRepresentation = [(SGM2SuggestedContactDetailUsed *)self dictionaryRepresentation];
...
- (NSString)key
{
  ...
  {
    return @"SuggestedContactDetailUsed";
  }
}
