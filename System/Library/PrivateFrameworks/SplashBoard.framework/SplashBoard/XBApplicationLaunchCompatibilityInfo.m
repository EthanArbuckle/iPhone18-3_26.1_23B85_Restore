...
+ (id)compatibilityInfoForAppInfo:(id)a3
{
  ...
  if (v8 && ([v8 bundlePath], v15 = objc_claimAutoreleasedReturnValue(), v16 = objc_msgSend(v10, "isEqualToString:", v15), v15, (v16 & 1) != 0))
  {
    v17 = v8;
    v18 = 0;
  }
  ...
  {
    v19 = [objc_alloc(MEMORY[0x277CF0BB8]) initWithPath:v10];
    v17 = [[a1 alloc] initWithBundle:v19];
...
- (XBApplicationLaunchCompatibilityInfo)initWithCoder:(id)a3
{
  ...
  if (v5)
  {
    ...
    v6 = [v4 decodeObjectOfClass:objc_opt_class() forKey:v32];
    v7 = [v6 copy];
    bundleIdentifier = v5->_bundleIdentifier;
    v5->_bundleIdentifier = v7;

    v9 = [MEMORY[0x277CCACA8] stringWithUTF8String:"bundlePath"];
    v10 = [v4 decodeObjectOfClass:objc_opt_class() forKey:v9];
    v11 = [v10 copy];
    bundlePath = v5->_bundlePath;
    v5->_bundlePath = v11;
...
- (XBApplicationLaunchCompatibilityInfo)initWithBundle:(id)a3
{
  ...
  if (v5)
  {
    ...
    v15 = [v4 localizedInfoDictionary];
    ...
    if ([v17 length])
    {
      v107 = v17;
      v108 = 0;
      v18 = _XBInterfaceWithNameExistsInBundle(&v107, v4, &v108);
      v77 = v107;
      ...
      if (v18)
      {
        ...
        [(NSArray *)v16 addObject:v85->_defaultInterface];
      }
    }
        ...
        do
        {
          for (i = 0; i != v32; ++i)
          {
            ...
            if (objc_opt_isKindOfClass())
            {
              ...
              {
                v102 = v36;
                v39 = _XBInterfaceWithNameExistsInBundle(&v102, v4, &v108);
                v38 = v102;
                ...
                if (v39)
                {
                  ...
                  if (v40)
                  {
                    ...
                    if (v85->_defaultInterface)
                    {
                      ...
                      v79 = [(XBLaunchInterface *)v85->_defaultInterface type];
                      v48 = [(XBLaunchInterface *)v85->_defaultInterface name];
                      v49 = [(XBLaunchInterface *)v85->_defaultInterface identifier];
                      v50 = [(XBLaunchInterface *)v85->_defaultInterface urlSchemes];
                      v81 = [(XBLaunchInterface *)v80 initWithType:v79 name:v48 identifier:v49 urlSchemes:v50 isDefault:0];
...
{
  v4 = a3;
  v5 = [v4 launchInterfaceIdentifier];
  v6 = [(XBApplicationLaunchCompatibilityInfo *)self launchInterfaceWithIdentifier:v5];
  ...
  if (!v13)
  {
    v14 = [(XBApplicationLaunchCompatibilityInfo *)self defaultLaunchInterface];
