...
{
  v4 = a3;
  v5 = [(TISceneTaxonomyGenerator *)self phrases];

  if (v5)
  {
    v6 = [(TISceneTaxonomyGenerator *)self _generateQueryTokens:v4];
  }
...
{
  v4 = a3;
  v5 = [(TISceneTaxonomyGenerator *)self tagger];
  [v5 setString:v4];

  v6 = [MEMORY[0x277CBEB18] array];
  v7 = [(TISceneTaxonomyGenerator *)self tagger];
  v8 = [v4 length];
  ...
  v17 = v10;
  v11 = v4;
  [v7 enumerateTagsInRange:0 unit:v8 scheme:0 options:v9 usingBlock:{6, v15}];
...
LABEL_31:
  ...
  v40 = [objc_alloc(MEMORY[0x277D3B4C8]) initWithLatestTaxonomy];
  if (v40)
  {
    v51 = 0u;
    v52 = 0u;
    v49 = 0u;
    v50 = 0u;
    v5 = [(TISceneTaxonomyGenerator *)self taxonomyIdentifiersAllowListSynonymExclusions];
    ...
    if (v6)
    {
      ...
      do
      {
        for (i = 0; i != v7; ++i)
        {
          ...
          v10 = *(*(&v49 + 1) + 8 * i);
          [v40 nodeRefForSceneClassId:{objc_msgSend(v10, "unsignedIntValue")}];
    ...
    if (v36)
    {
      ...
      do
      {
        for (j = 0; j != v36; ++j)
        {
          ...
          v15 = *(*(&v45 + 1) + 8 * j);
          [v40 nodeRefForSceneClassId:{objc_msgSend(v15, "unsignedIntValue")}];
...
- (NSSet)taxonomyIdentifiers
{
  ...
  if (!taxonomyIdentifiers)
  {
    ...
    v7 = [(TISceneTaxonomyGenerator *)self taxonomyIdentifiersAllowListSynonymExclusions];
    [v6 minusSet:v7];
    ...
    if ((_os_feature_enabled_impl() & 1) == 0)
    {
      ...
      if (v4)
      {
        ...
        if (os_log_type_enabled(v7, OS_LOG_TYPE_ERROR))
        {
          ...
          v13 = [v10 stringWithFormat:@"%s The locale %@ is not supported. Sticker Suggestion would be disabled.", "-[TISceneTaxonomyGenerator init]", v12];
          *buf = 138412290;
          v16 = v13;
