...
- (CARSetupAssetUnavailableViewController)initWithDescription:(id)description responseHandler:(id)handler;
- (void)_cancel;
...
- (CARSetupAssetUnavailableViewController)initWithDescription:(id)description responseHandler:(id)handler
{
  ...
  if (v9)
  {
    objc_storeStrong(&v9->_assetDescription, description);
...
- (void)viewDidLoad
{
  ...
  navigationItem = [(CARSetupAssetUnavailableViewController *)self navigationItem];
  ...
  navigationItem2 = [(CARSetupAssetUnavailableViewController *)self navigationItem];
  ...
  assetDescription = [(CARSetupAssetUnavailableViewController *)self assetDescription];

  if (assetDescription)
  {
    assetDescription2 = [(CARSetupAssetUnavailableViewController *)self assetDescription];
...
- (void)_checkForUpdates
{
  ...
  responseHandler = [(CARSetupAssetUnavailableViewController *)self responseHandler];
  v5 = responseHandler;
  if (responseHandler)
  {
    (*(responseHandler + 16))(responseHandler, 1);
  }
}
...
- (void)_cancel
{
  ...
  if (responseHandler)
  {
    (*(responseHandler + 16))(responseHandler, 0);
  }
}
