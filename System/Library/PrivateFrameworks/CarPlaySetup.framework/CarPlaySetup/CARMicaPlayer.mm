...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v8 = [v7 car_deepCopyLayer];

  v9 = [(CARMicaPlayer *)self publishedObjects];
  v10 = [(CARMicaPlayer *)self rootLayer];
  v11 = [CARMicaPlayer updatePublishedObjects:v9 toReferenceLayersInTree:v8 ratherThanLayersInTree:v10];
...
+ (id)updatePublishedObjects:(id)a3 toReferenceLayersInTree:(id)a4 ratherThanLayersInTree:(id)a5
{
  ...
  if (v7 && [v7 count])
  {
    v10 = [v9 car_allLayersInTree];
    v25 = v9;
    v27 = [v9 car_allAnimationsInTree];
    v11 = [v8 car_allLayersInTree];
    v26 = [v8 car_allAnimationsInTree];
    v30 = 0u;
    v31 = 0u;
    v32 = 0u;
    v33 = 0u;
...
- (void)setPlaybackTime:(double)a3
{
  v5 = [(CARMicaPlayer *)self isPlaying];
  v6 = 0.0;
  if (v5)
  {
...
- (BOOL)isTimerNeeded
{
  if ([(CARMicaPlayer *)self isPlaying])
  {
    ...
    if (v3 == INFINITY)
    {
      v5 = [(CARMicaPlayer *)self delegate];
      if (v5)
      {
        v6 = [(CARMicaPlayer *)self delegate];
