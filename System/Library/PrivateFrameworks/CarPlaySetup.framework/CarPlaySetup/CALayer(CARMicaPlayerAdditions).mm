...
- (id)car_propertiesToCopy
{
  ...
  v2 = [a1 car_basicPropertiesToCopy];
  objc_opt_class();
...
- (id)car_allLayersInTree
{
  ...
  [a1 car_addLayerAndSublayersToArray:v2 allowHiddenLayers:1];
...
- (void)car_addLayerAndSublayersToArray:()CARMicaPlayerAdditions allowHiddenLayers:
{
  ...
  if ((a4 & 1) != 0 || ([a1 isHidden] & 1) == 0)
  {
    ...
    {
      v8 = [a1 mask];
      [v8 car_addLayerAndSublayersToArray:v6 allowHiddenLayers:a4];
    }
...
- (void)car_setFillOfAllShapeLayersToColor:()CARMicaPlayerAdditions
{
  ...
  v4 = [a1 car_allLayersWithKindOfClass:objc_opt_class()];
  v10 = 0u;
  v11 = 0u;
  v12 = 0u;
  v13 = 0u;
