  ...
  if (v11)
  {
    ...
    else
    {
      if (![(BCSActionPickerViewAssistant *)self isShowingPicker])
      {
        ...
        if (v43)
        {
          ...
          do
          {
            for (i = 0; i != v43; ++i)
            {
              ...
              v47 = [v46 shouldDismissAlertWhenActionIsTaken];
              ...
              v61[3] = &unk_278CFE8F8;
              v61[4] = v46;
              [(UIAlertController *)v48 _addActionWithTitle:v49 style:0 handler:v62 shouldDismissHandler:v61];
        ...
        v54 = [(UIAlertController *)self->_alertController popoverPresentationController];
        v55 = [v56 view];
        [v54 setSourceView:v55];

        [v54 setSourceRect:{x, y, width, height}];
