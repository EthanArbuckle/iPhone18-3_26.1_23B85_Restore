...
- (FSServerURLResource)initWithURL:(id)a3
{
  v5 = a3;
  v9.receiver = self;
  v9.super_class = FSServerURLResource;
...
{
  v5.receiver = self;
  v5.super_class = FSServerURLResource;
  v4 = a3;
...
- (FSServerURLResource)initWithCoder:(id)a3
{
  ...
  v10.receiver = self;
  v10.super_class = FSServerURLResource;
...
- (BOOL)isEqual:(id)a3
{
  v4 = [(FSResource *)FSServerURLResource dynamicCast:a3];
  v5 = v4;
  if (v4)
  {
    url = self->_url;
...
- (id)getResourceID
{
  ...
  v4 = [v2 stringWithFormat:@"FSServerURLResource:%@", v3];
...
- (id)makeProxy
{
  ...
  v4 = [(FSServerURLResource *)self url];
