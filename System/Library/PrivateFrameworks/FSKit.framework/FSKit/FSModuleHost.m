...
- (void)_updateProviderListForFilteredFSModuleInstances:(id)a3;
...
- (FSModuleHost)initWithProbeList:(BOOL)a3
{
  ...
  if (v4 && v3)
  {
    v6 = [(FSModuleHost *)v4 loadProbeOrderList];
    moduleOrder = v5->_moduleOrder;
    v5->_moduleOrder = v6;

    v8 = [(FSModuleHost *)v5 loadEnabledList];
    enabledModules = v5->_enabledModules;
    v5->_enabledModules = v8;
  }
...
- (void)forceSynchronousProviderUpdate
{
  ...
  v14 = 0u;
  v15 = 0u;
  v4 = [(FSModuleHost *)v2 extensionPointRecords];
...
- (unsigned)isValidModuleIdentifier:(id)a3 withError:(id *)a4
{
  ...
  if (v7 != 0x7FFFFFFFFFFFFFFFLL)
  {
    ...
    if (a4)
    {
      [MEMORY[0x277CCA9B8] fskit_errorWithPOSIXCode:22 description:{@"Provider identifier '%@' may not contain any of the characters '%@'", v5, @"/:"}];
      goto LABEL_12;
    }
...
LABEL_13:
  ...
  if (([v5 isEqualToString:@"."] & 1) == 0 && !objc_msgSend(v5, "isEqualToString:", @".."))
  {
    v10 = 1;
    goto LABEL_15;
  }
...
- (void)_updateProviderListForFilteredFSModuleInstances:(id)a3
{
  ...
  v7 = objc_opt_new();
  v8 = [(NSDictionary *)self->_modulesByIdentifier allValues];
  v75 = [v8 mutableCopy];
  ...
  v73 = [v4 fs_map:&__block_literal_global_175];
  v14 = fskit_std_log();
  ...
  if (v17)
  {
    ...
    do
    {
      for (i = 0; i != v18; ++i)
      {
        ...
        v21 = *(*(&v91 + 1) + 8 * i);
        v22 = [(NSDictionary *)v21 bundleIdentifier];
        if (v22)
        {
          v23 = [(NSDictionary *)v78->_modulesByIdentifier objectForKeyedSubscript:v22];
          v24 = v23;
  ...
  v25 = v78;
  [(FSModuleHost *)v78 setExtensionsByIdentifierLocked:v6];
  v26 = &off_24A970000;
  v27 = 0x277CBE000uLL;
  if (v78->_moduleOrder)
  {
    ...
    {
      v29 = [objc_alloc(MEMORY[0x277CBEB18]) initWithArray:v78->_moduleOrder];
      ...
      v32 = [objc_alloc(MEMORY[0x277CBEB98]) initWithArray:v78->_moduleOrder];
      [v31 minusSet:v32];
...
- (id)loadProbeOrderList
{
  ...
  v3 = [v2 probeOrderArray];

  if (v3)
  {
    v19 = 0;
    v4 = [objc_alloc(MEMORY[0x277CBEA60]) initWithContentsOfURL:v3 error:&v19];
    v5 = v19;
    if (v4)
    {
      goto LABEL_20;
  ...
  v4 = [objc_opt_class() defaultProbeOrderList];
  if (!v5)
  {
    v17 = fskit_std_log();
...
- (void)saveProbeOrderList
{
  ...
  v16 = 0;
  [(NSArray *)moduleOrder writeToURL:v4 error:&v16];
  v6 = v16;
  if (v6)
  {
    v7 = v6;
...
- (void)saveEnabledList
{
  ...
  v16 = 0;
  [(NSArray *)enabledModules writeToURL:v4 error:&v16];
  v6 = v16;
  if (v6)
  {
    v7 = v6;
...
- (void)setExtensionsByIdentifierLocked:(id)a3
{
  ...
  v6 = [(NSDictionary *)self->_modulesByIdentifier allValues];
  modules = self->_modules;
  self->_modules = v6;

  MEMORY[0x2821F96F8](v6, modules);
}

- (id)configurationForInstance:(id)a3 ofBundle:(id)a4
{
  v6 = a3;
  v7 = [(FSModuleHost *)self moduleForBundleID:a4];
  if (v7)
  {
    ...
    v11 = [objc_alloc(MEMORY[0x277CC5DF0]) initWithExtensionIdentity:v10 instanceIdentifier:v6];
  }
...
- (id)moduleForBundleID:(id)a3
{
  ...
  {
    v8 = [(NSDictionary *)modulesByIdentifier objectForKeyedSubscript:v4];
  }
...
- (void)addBundleToEnableModules:(id)a3
{
  ...
  if (v4)
  {
    ...
    LOBYTE(enabledModules) = [(NSArray *)enabledModules containsObject:v8];
...
- (void)removeBundleFromEnabledModules:(id)a3
{
  ...
  if (v4)
  {
    ...
    enabledModules = self->_enabledModules;
    v8 = [v5 bundleIdentifier];
    LODWORD(enabledModules) = [(NSArray *)enabledModules containsObject:v8];
