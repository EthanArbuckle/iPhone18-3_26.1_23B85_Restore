...
- (FSServerURLResource)initWithCoder:(id)coder;
- (FSServerURLResource)initWithURL:(id)l;
- (id)getResourceID;
- (id)makeProxy;
...
- (BOOL)isEqual:(id)equal
{
  v4 = [(FSResource *)FSServerURLResource dynamicCast:equal];
  v5 = v4;
  if (v4)
  {
    url = self->_url;
...
- (id)getResourceID
{
  ...
  v4 = [v2 stringWithFormat:@"FSServerURLResource:%@", path];
