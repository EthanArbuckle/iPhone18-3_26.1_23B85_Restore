...
LABEL_8:
    ...
    case 0:
      if ([self selectedTagCount] >= 3)
      {
        ...
        v19 = [MEMORY[0x1E696AEC0] localizedStringWithFormat:v17, objc_msgSend(self, "selectedTagCount")];
        v20 = [v18 initWithString:v19 attributes:v15];

        goto LABEL_10;
      }

      if ([self selectedTagCount])
      {
        if ([self selectedTagCount] == 1)
        {
        ...
        hashtagPrefixedDisplayTexts = [self hashtagPrefixedDisplayTexts];
        ...
        v43 = array;
        v38 = dictionary;
        [hashtagPrefixedDisplayTexts enumerateObjectsUsingBlock:v48];
...
LABEL_13:
  string = [v20 string];
  v25 = [string rangeOfString:ICTagSelectionMenuReplacementSubstring];
  v27 = v26;

  if (v25 != 0x7FFFFFFFFFFFFFFFLL)
  {
    v51 = v11;
    v28 = [self boldFontForTextStyle:v8];
    v52 = v28;
