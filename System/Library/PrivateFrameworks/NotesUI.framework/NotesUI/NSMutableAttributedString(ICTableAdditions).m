...
- (void)ic_addTextBlocks:()ICTableAdditions range:
{
  ...
  if (a4 < a4 + a5)
  {
    ...
    {
      v12 = v9;
      v9 = [a1 attribute:v10 atIndex:v11 longestEffectiveRange:&v15 inRange:{a4, a5}];
      ...
      [a1 addAttribute:v10 value:v13 range:{v15, v16}];
      v11 = v16 + v15;
    }
...
- (void)ic_convertParagraphStyleToBodyInRange:()ICTableAdditions
{
  ...
  v11 = v7;
  v9 = v7;
  [a1 enumerateAttribute:v8 inRange:a3 options:a4 usingBlock:{0, v10}];
}
