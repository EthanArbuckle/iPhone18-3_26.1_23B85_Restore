...
+ (id)sortTypeSpecifier
{
  ...
  selfCopy = self;
  v3 = [MEMORY[0x1E69C5748] preferenceSpecifierNamed:v21 target:self set:sel__setNoteSortType_withSpecifier_ get:sel__currentNoteSortType_ detail:objc_opt_class() cell:2 edit:0];
  ...
  NSLog(&cfstr_PValuesTitles.isa, v13, selfCopy, v14, &unk_1F4FC3BD0, v5);
...
+ (id)_currentNoteSortType:(id)type
{
  ...
  currentNoteListSortType = [MEMORY[0x1E69B7A88] currentNoteListSortType];

  return [v3 numberWithInteger:currentNoteListSortType];
}
...
+ (id)_dateHeadersSpecifier
{
  ...
  v4 = [MEMORY[0x1E69C5748] preferenceSpecifierNamed:v3 target:self set:sel__setDateHeadersType_withSpecifier_ get:sel__currentDateHeadersOn_ detail:0 cell:6 edit:0];
...
{
  v3 = MEMORY[0x1E696AD98];
  currentDateHeadersOn = [MEMORY[0x1E69B7A50] currentDateHeadersOn];

  return [v3 numberWithBool:currentDateHeadersOn];
}
...
+ (void)_setDateHeadersType:(id)type withSpecifier:(id)specifier
{
  ...
  if (v7)
  {
    ...
    [MEMORY[0x1E69B7A50] setDateHeadersOn:bOOLValue];
    v5 = v7;
  }
}
