...
- (void)main
{
  ...
  [(ICAttachmentPreviewGeneratorOCROperation *)self setManagedObjectContext:workerManagedObjectContext];

  managedObjectContext = [(ICAttachmentPreviewGeneratorOCROperation *)self managedObjectContext];
  [managedObjectContext setIc_debugName:@"ocrGenerator"];
  ...
  v14 = 0x2020000000;
  v15 = 0;
  managedObjectContext2 = [(ICAttachmentPreviewGeneratorOCROperation *)self managedObjectContext];
  ...
  if (*(v13 + 24) == 1)
  {
    attachmentModel = [(ICAttachmentPreviewGeneratorOCROperation *)self attachmentModel];
    [attachmentModel generateOCRInOperation:self];
  }

  else
  {
    attachmentModel = [(ICAttachmentPreviewGeneratorOCROperation *)self managedObjectContext];
...
void __48__ICAttachmentPreviewGeneratorOCROperation_main__block_invoke(uint64_t a1)
{
  ...
  *(v7 + 40) = v5;
  ...
  if (!v9)
  {
    ...
    {
      __48__ICAttachmentPreviewGeneratorOCROperation_main__block_invoke_cold_1(v2, v6, v11);
    }
...
LABEL_12:
  ...
  if (os_log_type_enabled(v14, OS_LOG_TYPE_DEBUG))
  {
    ...
    *buf = 138413058;
    ...
    v27 = 1024;
    v28 = v19;
    _os_log_debug_impl(&dword_1D4171000, v14, OS_LOG_TYPE_DEBUG, "%@ %@ %@ OCR generate %d", buf, 0x26u);
  }
}
...
void __48__ICAttachmentPreviewGeneratorOCROperation_main__block_invoke_13(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v2, OS_LOG_TYPE_INFO))
  {
    ...
    v4 = 138412290;
    v5 = v3;
    _os_log_impl(&dword_1D4171000, v2, OS_LOG_TYPE_INFO, "Skipping generation for attachment because it is either cancelled or not needed: %@", &v4, 0xCu);
  }
}
...
void __48__ICAttachmentPreviewGeneratorOCROperation_main__block_invoke_cold_1(id *a1, uint64_t a2, NSObject *a3)
{
  ...
  v8 = 2112;
  v9 = a2;
  _os_log_error_impl(&dword_1D4171000, a3, OS_LOG_TYPE_ERROR, "Error getting object from ID %@ for OCR generation %@", &v6, 0x16u);
}
