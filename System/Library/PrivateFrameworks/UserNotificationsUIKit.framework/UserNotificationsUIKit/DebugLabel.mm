...
{
  v4.receiver = self;
  v4.super_class = type metadata accessor for DebugLabel();
  v2 = [(DebugLabel *)&v4 initWithFrame:0.0, 0.0, 0.0, 0.0];
  [(DebugLabel *)v2 setTextAlignment:1];
  [(DebugLabel *)v2 setNumberOfLines:0];
