...
- (NCSnoozeAlarmNotificationStaticContentProvider)initWithNotificationRequest:(id)a3 viewController:(id)a4
{
  ...
  if (v8)
  {
    ...
    v12 = [v10 objectForKey:*MEMORY[0x277D295E0]];
    if (!v12)
    {
    ...
    [v20 addTimer:v9->_tickTimer forMode:*MEMORY[0x277CBE738]];
...
- (id)_formatDuration:(double)a3 includeSeconds:(BOOL)a4
{
  if (a4)
  {
    v5 = [MEMORY[0x277CF0BF0] sharedInstance];
  ...
  else
  {
    ...
    *v6.i64 = a3;
    NCFormatTimeIntervalForMinutesOnly(v5, v6);
  }
  v7 = ;
...
- (void)_updateContentForTime:(double)a3
{
  ...
  v5 = [(NCSnoozeAlarmNotificationStaticContentProvider *)self viewController];
...
- (id)_secondaryTextForTime:(double)a3
{
  ...
  v6 = v5;
  v7 = [(NCSnoozeAlarmNotificationStaticContentProvider *)self viewController];
  v8 = [v7 traitCollection];
  v9 = [v8 _backlightLuminance];

  v10 = v9 != 1 || [(NCSnoozeAlarmNotificationStaticContentProvider *)self _hasOneMinuteOrLessRemainingForTime:a3];
  ...
  if (v8 >= 0.0)
  {
    ...
    if (v15 > 0.0)
    {
      ...
      if (v17)
      {
        ...
        do
        {
          v19 = [v5 dateByAddingTimeInterval:(v8 % 60 + 1) + v18];
    ...
    if (v15 < v10)
    {
      if (v22 >= 0x3D)
      {
        ...
        if (os_log_type_enabled(*MEMORY[0x277D77DB0], OS_LOG_TYPE_FAULT))
        {
          ...
          v42 = [v45 bls_shortLoggingString];
          v43 = [v4 bls_shortLoggingString];
      ...
      do
      {
        v27 = [v5 dateByAddingTimeInterval:v15 + v26];
...
{
  v7 = a4;
  v8 = [(NCSnoozeAlarmNotificationStaticContentProvider *)self _timelinesForDateInterval:a3];
  (*(a4 + 2))(v7, v8);
}
...
- (void)_updateWithFrameSpecifier:(id)a3
{
  ...
  if (v4)
  {
    v6 = [v4 entrySpecifierForTimelineIdentifier:@"NCSnoozeAlarmNotificationStaticContentProvider"];
    v7 = [v6 timelineEntry];
...
- (void)notificationViewControllerWillDismiss:(id)a3
{
  v7 = [(NCNotificationViewController *)self->_viewController view];
  v4 = [v7 window];
  v5 = [v4 windowScene];
  v6 = [v5 _alwaysOnEnvironment];
  [v6 removeObserver:self];
