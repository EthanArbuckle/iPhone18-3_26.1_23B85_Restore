...
+ (id)moduleWithSectionTitle:(id)a3
{
  ...
  v163 = [MEMORY[0x277D43218] sectionWithRows:v5 title:v4];
...
- (void)setDefaultValues
{
  ...
  v3 = [(NCListAnimationSettings *)self insertionAnimation_scaleX];
  [v3 setDefaultValues];

  v4 = [(NCListAnimationSettings *)self insertionAnimation_scaleX];
  [v4 setDampingRatio:0.69762];

  v5 = [(NCListAnimationSettings *)self insertionAnimation_scaleX];
  [v5 setResponse:0.728];

  v6 = [(NCListAnimationSettings *)self insertionAnimation_scaleY];
  [v6 setDefaultValues];

  v7 = [(NCListAnimationSettings *)self insertionAnimation_scaleY];
  [v7 setDampingRatio:0.62275];

  v8 = [(NCListAnimationSettings *)self insertionAnimation_scaleY];
  [v8 setResponse:0.48669];
