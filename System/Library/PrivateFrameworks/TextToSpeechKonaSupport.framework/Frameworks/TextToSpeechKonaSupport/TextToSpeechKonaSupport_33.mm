...
float OUTLINED_FUNCTION_4_65(float a1, float a2, double a3, double a4, float a5)
{
  result = a1 + (a2 * a5);
  *v5 = result;
  return result;
...
uint64_t dynaBufMoveRel(uint64_t a1, unsigned int a2)
{
  ...
  return OUTLINED_FUNCTION_0_85(a1, v2);
}
...
uint64_t hashMoveInt(uint64_t a1, unsigned int a2, unsigned int a3)
{
  ...
  *v6 = a3;
  ...
  return OUTLINED_FUNCTION_2_75(v6);
}
...
{
  *this = &unk_287EDB8C0;
  MEMORY[0x274379A00](*(this + 1), 0x81C40B8603338);
}

void OUTLINED_FUNCTION_2_76()
{
...
void IniFileWriter::~IniFileWriter(IniFileWriter *this)
{
  ...
  if (v2)
  {
    MEMORY[0x2743799F0](v2, 0x1000C8077774924);
    *(this + 514) = 0;
  }
}
...
void init_new(uint64_t a1)
{
  ...
  *(v6 + 24) = "LOOP";
  OUTLINED_FUNCTION_1_82();
  *(v7 + 32) = "COMMAND";
  *(**(a1 + 184) + 40) = &unk_26DBB65D8;
  v8 = *(a1 + 184);
  *(v8 + 8) = 3;
  *(v8 + 28) = 2;
  *(v8 + 444) = 5;
  *(v8 + 496) = 1;
  *(v8 + 528) = &unk_26DBB65D8;
}
...
double logio_new(uint64_t a1)
{
  if (a1)
  {
    ...
    *(v3 + 64) = v5;
    ...
    v6[8] = v7;
    v8 = *&off_28203A150;
    v6[9] = xmmword_28203A140;
    v6[10] = v8;
    v9 = *(a1 + 216);
    v10 = *&off_28203A190;
    v9[13] = xmmword_28203A180;
    v9[14] = v10;
    v11 = unk_28203A170;
    ...
    v15[20] = v16;
    result = *&xmmword_28203A200;
    v18 = *&off_28203A210;
    v15[21] = xmmword_28203A200;
    v15[22] = v18;
  }
...
uint64_t vf_getc(uint64_t a1, int a2)
{
  ...
  if (vf_gets(v2, a2, &unk_26DBB65DA) == 1)
  {
    OUTLINED_FUNCTION_0_92();
