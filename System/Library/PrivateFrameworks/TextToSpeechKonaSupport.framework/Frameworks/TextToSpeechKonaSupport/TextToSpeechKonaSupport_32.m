...
BOOL can_split_stream_line(uint64_t a1, int a2, int a3)
{
  ...
  v5 = OUTLINED_FUNCTION_12_53(a1, a2);
  v8 = *(v3 + v7);
  if (v8 == 124)
  {
    return 1;
...
void OUTLINED_FUNCTION_8_59(int a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, int a6, unsigned int a7, uint64_t a8, uint64_t a9, ...)
{
  va_start(va, a9);
...
void OUTLINED_FUNCTION_11_55(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, int a9, unsigned int a10, uint64_t a11, uint64_t a12, ...)
{
  va_start(va, a12);
            ...
            while (2)
            {
              if (v202 < v197)
              {
                if (!v89[v202])
                {
                  *&v199 = *(v214 - 1);
                  *&v198 = *(a1 + 604) * *&v199;
                  OUTLINED_FUNCTION_4_63(*&v198 + (*(a1 + 600) * *v214), *(a1 + 608), v198, v199, *(v214 - 2));
                  continue;
                }
...
LABEL_244:
                ...
                *(a1 + 156) = 1;
LABEL_245:
                for (ii = &v196[v202]; ; OUTLINED_FUNCTION_4_63(*&v198 + (v218[3] * *ii), v218[9], v198, v199, *(ii - 2)))
                {
                  if (v202 >= v197)
                  {
                    goto LABEL_252;
...
LABEL_233:
                      ...
                      while (1)
                      {
                        ...
                        *&v199 = *(v212 - 1);
                        *&v198 = *algn_2805C060C * *&v199;
                        OUTLINED_FUNCTION_4_63((*algn_2805C060C * *&v199) + (*f1d * *v212), *&dword_2805C0610, v198, v199, *(v212 - 2));
                      }
...
{
  v6 = OUTLINED_FUNCTION_0_84(a1, a2);
  v10 = v7 - v9 * v8;
  v11 = *(*(v6 + 1) + 8 * v10);
...
{
  v2 = OUTLINED_FUNCTION_0_84(a1, a2);
  v8 = v5 - v7 * v6;
  v9 = *(v2 + 1);
  v10 = *(v9 + 8 * v8);
  if (*v10 == v3)
...
void ESList::ESList(ESList *this, const ESList *a2)
{
  ...
  *this = &unk_287EDC100;
  ...
  while (1)
  {
    OUTLINED_FUNCTION_12_54(v4);
    if (!v5)
    {
      break;
    }

    OUTLINED_FUNCTION_6_63(v5);
    (*(v6 + 48))(this);
...
void OUTLINED_FUNCTION_6_63(uint64_t *a1@<X8>)
{
  v2 = *a1;
  v3 = a1[1];
  v4 = *v1;
  ...
  if (result)
  {
    ...
    if (v27)
    {
      ...
      while (1)
      {
        ...
        v47 = **(v32 + 8);
        v33 = OUTLINED_FUNCTION_4_66();
        result = vf_printf(v33, v34, 0, "      %.70s", v35, v36, v37, v38, v47);
        if (result)
        {
          if (*v32 != 1 || (v39 = OUTLINED_FUNCTION_4_66(), result = vf_puts(v39, v40, " (+)", 1), result))
          {
            v41 = OUTLINED_FUNCTION_4_66();
            v43 = vf_puts(v41, v42, "\n", 1);
            result = 0;
            v31 = (v32 + 16);
            if (v43)
    ...
    while (!feof(*(a1 + 16)))
    {
      ...
      if (dynaBufCurrentChar(a2, 0) == 10)
      {
        ...
        else
        {
          if (v8 != v11)
          {
            v14 = OUTLINED_FUNCTION_2_77();
            dynaBufMoveRel(v14, v15);
          }

          dynaBufAddChar(a2, 32, 0);
          v16 = OUTLINED_FUNCTION_1_82();
