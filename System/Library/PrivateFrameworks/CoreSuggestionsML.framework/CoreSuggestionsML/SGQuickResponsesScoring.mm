...
+ (id)categoryScoresWithModelScores:(id)scores configReplies:(id)replies
{
  scoresCopy = scores;
  repliesCopy = replies;
  categoryModels = [repliesCopy categoryModels];
  v8 = [categoryModels count];
  ...
  v19 = v12;
  v13 = models;
  [scoresCopy enumerateObjectsUsingBlock:v17];
  v14 = v19;
  v15 = v12;
...
+ (id)modelScoresWithUnweightedScores:(id)scores configReplies:(id)replies
{
  ...
  v15 = v8;
  v9 = models;
  [scoresCopy enumerateObjectsUsingBlock:v13];
...
+ (id)sortedWithUnweightedScores:(id)scores config:(id)config
{
  ...
  if (isKindOfClass)
  {
    ...
    v11 = [SGQuickResponsesScoring modelScoresWithUnweightedScores:scoresCopy configReplies:replies2];
    v12 = [SGQuickResponsesScoring categoryScoresWithModelScores:v11 configReplies:replies2];
    predictionParams = [configCopy predictionParams];
    [predictionParams weightForCategoryAverage];
    v15 = v14;

    predictionParams2 = [configCopy predictionParams];
    [predictionParams2 weightForCategoryMax];
    v18 = v17;

    predictionParams3 = [configCopy predictionParams];
    [predictionParams3 weightForIndividualModel];
    v21 = v20;

    predictionParams4 = [configCopy predictionParams];
    isPerCategory = [predictionParams4 isPerCategory];
    ...
    else
    {
      ...
      v40 = v21;
      v37 = v7;
      [models enumerateObjectsUsingBlock:v34];
    }
  ...
  else
  {
    ...
    v25 = v7;
    v44 = v25;
    [scoresCopy enumerateObjectsUsingBlock:v43];
