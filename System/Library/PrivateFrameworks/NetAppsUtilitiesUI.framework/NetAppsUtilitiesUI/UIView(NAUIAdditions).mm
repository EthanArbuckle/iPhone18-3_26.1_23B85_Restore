...
- (void)naui_setDynamicFontTextStyleDescriptor:()NAUIAdditions
{
  ...
  {
    objc_setAssociatedObject(a1, "naui_dynamicFontTextStyleDescriptor", value, 0x303);
    if (value)
    {
      v5 = objc_getAssociatedObject(a1, "naui_dynamicFontObserverKey");
      if (!v5)
      {
        v5 = [[_NAUIAutoUpdatingFontObserver alloc] initWithTarget:a1];
        objc_setAssociatedObject(a1, "naui_dynamicFontObserverKey", v5, 0x301);
      }
    ...
    {
      objc_setAssociatedObject(a1, "naui_dynamicFontObserverKey", 0, 0x301);
    }
  }
}
...
+ (void)naui_performAnimateableChangesWithAnimationDuration:()NAUIAdditions setupBlock:animatablesBlock:completion:
{
  ...
  if ([MEMORY[0x277D75D18] areAnimationsEnabled])
  {
    [MEMORY[0x277D75D18] animateWithDuration:v9 animations:v10 completion:a1];
  }
...
{
  v5 = a3;
  v6 = objc_getAssociatedObject(a1, a2);
  v7 = [v6 integerValue];
  ...
  v8 = [MEMORY[0x277CCABB0] numberWithInteger:v7 + 1];
  ...
  {
    [a1 layoutIfNeeded];
    objc_setAssociatedObject(a1, a2, 0, 1);
  }
  ...
  if (v5)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        [a1 naui_addAutoLayoutSubview:*(*(&v9 + 1) + 8 * v8++)];
      }
...
- (uint64_t)naui_replaceConstraint:()NAUIAdditions withConstraints:
{
  ...
  if ((v8 & 1) == 0)
  {
    [a1 naui_removeConstraint:v6];
    [a1 naui_addConstraint:v7];
  }
...
- (uint64_t)naui_replaceConstraints:()NAUIAdditions withConstraints:
{
  ...
  if ((v8 & 1) == 0)
  {
    [a1 naui_removeConstraints:v6];
    [a1 naui_addConstraints:v7];
  }
...
- (id)_naui_constraintsByNameDictionary:()NAUIAdditions
{
  v5 = objc_getAssociatedObject(a1, "_naui_constraintsByNameStorageKey");
  if (v5)
  {
    v6 = 1;
  }
  ...
  if (!v6)
  {
    ...
    objc_setAssociatedObject(a1, "_naui_constraintsByNameStorageKey", v5, 0x301);
  }
...
{
  v4 = a3;
  v5 = [a1 _naui_constraintsByNameDictionary:0];
...
- (void)naui_setNamedConstraints:()NAUIAdditions forName:
{
  ...
  if (v11)
  {
    v7 = [a1 _naui_constraintsNamed:v6];

    if (v7)
    {
      [a1 naui_removeConstraintsNamed:v6];
    }

    v8 = [a1 _naui_constraintsByNameDictionary:1];
    v9 = [v11 constraints];
...
- (void)naui_removeConstraintsNamed:()NAUIAdditions
{
  ...
  if (v4)
  {
    ...
    v8 = [a1 _naui_constraintsByNameDictionary:0];
...
{
  v14 = *MEMORY[0x277D85DE8];
  v2 = [a1 _naui_constraintsByNameDictionary:0];
  v3 = [v2 allKeys];
  ...
  if (v5)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        [a1 naui_removeConstraintsNamed:{*(*(&v9 + 1) + 8 * v8++), v9}];
      }
