...
- (NAUIUIViewControllerNoticationObserver)init
{
  ...
  if (v2)
  {
    ...
    v9 = [defaultCenter addObserverForName:v8 object:0 queue:mainQueue usingBlock:v17];
    ...
    v13 = [defaultCenter addObserverForName:v12 object:0 queue:mainQueue2 usingBlock:v15];
