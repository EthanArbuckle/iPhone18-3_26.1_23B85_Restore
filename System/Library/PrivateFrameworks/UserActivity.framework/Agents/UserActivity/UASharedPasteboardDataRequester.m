...
- (void)requestStreamEndpointData:(id)a3
{
  ...
  v18 = v4;
  v19 = v15;
  [v16 activityPayloadFromDevice:v17 forAdvertisementPayload:v5 command:@"pbpaste" timeout:v8 withCompletionHandler:v20];
}
...
- (void)requestStreamEndpointDataV2:(id)a3
{
  ...
  v18 = v4;
  v19 = v15;
  [v16 activityPayloadFromDevice:v17 forAdvertisementPayload:v5 command:@"pbpaste2" timeout:v8 withCompletionHandler:v20];
}
...
- (void)requestRemotePasteboardInfo:(id)a3
{
  ...
  v18 = v4;
  v19 = v15;
  [v16 activityPayloadFromDevice:v17 forAdvertisementPayload:v5 command:@"pbtypes" timeout:v8 withCompletionHandler:v20];
}
