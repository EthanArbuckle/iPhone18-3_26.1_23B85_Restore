  ...
  if (v8)
  {
    ...
    if (v14)
    {
      if (objc_opt_respondsToSelector())
      {
        ...
        {
          v30 = [a1 _internalUserActivity];
          v17 = [v30 uniqueIdentifier];
          v18 = [v17 UUIDString];
          *buf = 138543362;
          v42 = v18;
        ...
        v38 = v8;
        v19 = v15;
        [v14 _userActivityWillSave:a1 isCurrent:a4 timeout:v35 withCompletionHandler:a2];
...
LABEL_16:
        ...
        v33[3] = &unk_2785C4650;
        v34 = v8;
        [v13 _userActivityWillSave:a1 isCurrent:a4 timeout:v33 withCompletionHandler:a2];
        v20 = v34;
LABEL_20:
