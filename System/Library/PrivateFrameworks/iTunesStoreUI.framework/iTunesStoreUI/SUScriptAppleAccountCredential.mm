...
+ (void)initialize;
- (SUScriptAppleAccountCredential)initWithACAccountCredential:(id)credential;
...
- (id)scriptAttributeKeys
{
  ...
  -[NSMutableArray addObjectsFromArray:](scriptAttributeKeys, "addObjectsFromArray:", [__KeyMapping_69 allKeys]);
