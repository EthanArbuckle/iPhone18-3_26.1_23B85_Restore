...
- (id)trifbCreateCloudKitAssetRecordAssetUsingBlock:()TRIFBCloudKitAssetRecordAsset
{
  ...
  if (!v5)
  {
    ...
    [v14 handleFailureInMethod:a2 object:a1 file:@"TRIFBFastFactorLevels_generated.mm" lineNumber:984 description:{@"Invalid parameter not satisfying: %@", @"block"}];
  }
...
- (id)trifbFinishedBufferWithRootCloudKitAssetRecordAssetOfs:()TRIFBCloudKitAssetRecordAsset error:
{
  ...
  if (!v7)
  {
    ...
    [v20 handleFailureInMethod:a2 object:a1 file:@"TRIFBFastFactorLevels_generated.mm" lineNumber:1006 description:{@"Invalid parameter not satisfying: %@", @"ofs"}];
  }
  ...
  else
  {
    ...
    v22 = 0;
    v12 = [a1 trifbFinishBufferWithRootCloudKitAssetRecordAssetOfs:v7 error:&v22];
    v13 = v22;
    if (v12)
    {
      v21 = v13;
...
- (uint64_t)trifbFinishBufferWithRootCloudKitAssetRecordAssetOfs:()TRIFBCloudKitAssetRecordAsset error:
{
  ...
  if (!v7)
  {
    ...
    [v23 handleFailureInMethod:a2 object:a1 file:@"TRIFBFastFactorLevels_generated.mm" lineNumber:1040 description:{@"Invalid parameter not satisfying: %@", @"ofs"}];
  }
