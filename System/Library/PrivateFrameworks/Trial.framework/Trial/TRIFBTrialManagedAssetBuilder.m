...
- (void)setPath:(id)a3
{
  ...
  if (!v5)
  {
    ...
    [v9 handleFailureInMethod:a2 object:self file:@"TRIFBFastFactorLevels_generated.mm" lineNumber:1517 description:{@"Invalid parameter not satisfying: %@", @"ofs"}];
  }
...
- (void)setFileType:(unsigned __int8)a3
{
  ...
  if (!v5)
  {
    apple::aiml::flatbuffers2::FlatBufferBuilder::AddElement<unsigned char>(self->_bldr->var0, 6, v3);
  }
...
- (void)setAssetId:(id)a3
{
  ...
  {
    v9 = [MEMORY[0x277CCA890] currentHandler];
    [v9 handleFailureInMethod:a2 object:self file:@"TRIFBFastFactorLevels_generated.mm" lineNumber:1536 description:{@"Invalid parameter not satisfying: %@", @"ofs"}];
  }
...
- (void)setCloudKitMetadataWithTreatment:(id)a3
{
  ...
  {
    v9 = [MEMORY[0x277CCA890] currentHandler];
    [v9 handleFailureInMethod:a2 object:self file:@"TRIFBFastFactorLevels_generated.mm" lineNumber:1546 description:{@"Invalid parameter not satisfying: %@", @"ofs"}];
  }
...
- (void)setCloudKitMetadataWithAsset:(id)a3
{
  ...
  {
    v9 = [MEMORY[0x277CCA890] currentHandler];
    [v9 handleFailureInMethod:a2 object:self file:@"TRIFBFastFactorLevels_generated.mm" lineNumber:1557 description:{@"Invalid parameter not satisfying: %@", @"ofs"}];
  }
...
- (void)setIsOnDemand:(BOOL)a3
{
  ...
  if (!v5)
  {
    apple::aiml::flatbuffers2::FlatBufferBuilder::AddElement<unsigned char>(self->_bldr->var0, 14, v3);
  }
...
- (void)setDownloadSize:(unint64_t)a3
{
  ...
  if (!v5)
  {
    apple::aiml::flatbuffers2::FlatBufferBuilder::AddElement<unsigned long long>(self->_bldr->var0, 16, a3);
  }
...
- (void)setAssetName:(id)a3
{
  ...
  {
    v9 = [MEMORY[0x277CCA890] currentHandler];
    [v9 handleFailureInMethod:a2 object:self file:@"TRIFBFastFactorLevels_generated.mm" lineNumber:1582 description:{@"Invalid parameter not satisfying: %@", @"ofs"}];
  }
...
- (void)setHasOnDemandFlag:(BOOL)a3
{
  ...
  if (!v5)
  {
    apple::aiml::flatbuffers2::FlatBufferBuilder::AddElement<unsigned char>(self->_bldr->var0, 20, v3);
  }
