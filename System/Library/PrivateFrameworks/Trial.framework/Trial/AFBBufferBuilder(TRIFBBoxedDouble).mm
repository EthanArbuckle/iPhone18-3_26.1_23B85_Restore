...
- (id)trifbCreateBoxedDoubleFromBoxedDouble:()TRIFBBoxedDouble
{
  ...
  if (!v5)
  {
    ...
    [v13 handleFailureInMethod:a2 object:a1 file:@"TRIFBFastFactorLevels_generated.mm" lineNumber:5673 description:{@"Invalid parameter not satisfying: %@", @"BoxedDouble"}];
  }
...
- (id)trifbCreateVectorOfBoxedDoubleWithCount:()TRIFBBoxedDouble block:
{
  ...
  if (!v7)
  {
    ...
    [v14 handleFailureInMethod:a2 object:a1 file:@"TRIFBFastFactorLevels_generated.mm" lineNumber:5700 description:{@"Invalid parameter not satisfying: %@", @"block"}];
  }
