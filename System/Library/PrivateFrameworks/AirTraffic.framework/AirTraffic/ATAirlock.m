...
- (id)pathForAsset:(id)a3 withDataclass:(id)a4
{
  ...
  v11 = [(NSString *)basePath stringByAppendingPathComponent:v10];
...
LABEL_14:
  ...
  else
  {
    ...
    v38 = self->_fm;
    v57 = 0;
    v39 = [(NSFileManager *)v38 createDirectoryAtPath:v22 withIntermediateDirectories:1 attributes:0 error:&v57];
    v23 = v57;
    if (!v39)
    {
  ...
  v41 = self->_fm;
  v56 = v23;
  v42 = [(NSFileManager *)v41 moveItemAtPath:v14 toPath:v17 error:&v56];
  v28 = v56;
  ...
  if (v42)
  {
    ...
    {
      v44 = [v4 path];
      v45 = [@"/var/mobile/Media/" stringByAppendingPathComponent:v44];
      *buf = 138543618;
      v59 = v14;
      v60 = 2112;
      v61 = v45;
...
LABEL_49:
  ...
  if ([(NSFileManager *)self->_fm fileExistsAtPath:v17])
  {
    ...
    v47 = self->_fm;
    v55 = v28;
    [(NSFileManager *)v47 moveItemAtPath:v14 toPath:v17 error:&v55];
    v48 = v55;
  ...
  if (![(NSFileManager *)self->_fm fileExistsAtPath:v17])
  {
    ...
    v50 = [(NSFileManager *)self->_fm fileExistsAtPath:v22];
...
- (void)purgeAssetWithIdentifier:(id)a3 dataclass:(id)a4
{
  ...
  v10 = [(NSString *)self->_basePath stringByAppendingPathComponent:v7];
