...
- (id)contextFromXPCDictionary:(id)dictionary
{
  ...
  v7 = [_entriesHavingBoolValue countByEnumeratingWithState:&v28 objects:v33 count:16];
  if (v7)
  {
    v8 = v7;
    v9 = *v29;
    do
    {
      ...
      v8 = [_entriesHavingBoolValue countByEnumeratingWithState:&v28 objects:v33 count:16];
    }
  ...
  v14 = [_entriesHavingStringValue countByEnumeratingWithState:&v24 objects:v32 count:16];
  if (v14)
  {
    v15 = v14;
    v16 = *v25;
    do
    {
      ...
      v15 = [_entriesHavingStringValue countByEnumeratingWithState:&v24 objects:v32 count:16];
    }
...
- (void)addContext:(id)context toXPCDictionary:(id)dictionary
{
  ...
  v30 = 0u;
  _entriesHavingBoolValue = [(DMContextManager *)self _entriesHavingBoolValue];
  v9 = [_entriesHavingBoolValue countByEnumeratingWithState:&v27 objects:v32 count:16];
  if (v9)
  {
    v10 = v9;
    v11 = *v28;
    do
    {
      ...
      v10 = [_entriesHavingBoolValue countByEnumeratingWithState:&v27 objects:v32 count:16];
    }
  ...
  v24 = 0u;
  _entriesHavingStringValue = [(DMContextManager *)self _entriesHavingStringValue];
  v16 = [_entriesHavingStringValue countByEnumeratingWithState:&v23 objects:v31 count:16];
  if (v16)
  {
    v17 = v16;
    v18 = *v24;
    do
    {
      ...
      v17 = [_entriesHavingStringValue countByEnumeratingWithState:&v23 objects:v31 count:16];
    }
