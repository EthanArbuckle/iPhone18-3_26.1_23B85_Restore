...
- (id)ak_addAdditiveAnimation:()AKCAUtilities withKeyPath:
{
  ...
  if (location[0])
  {
    v4 = [selfCopy _ak_nextAdditiveAnimationKeyWithKeyPath:v10];
    v5 = v9;
    v9 = v4;
    MEMORY[0x277D82BD8](v5);
    [selfCopy addAnimation:location[0] forKey:v9];
  }
...
- (id)_ak_nextAdditiveAnimationKeyWithKeyPath:()AKCAUtilities
{
  ...
  location[0] = 0;
  objc_storeStrong(location, obj);
  v13 = objc_getAssociatedObject(selfCopy, AdditiveAnimationKeyPrefix);
...
LABEL_9:
  ...
  v5 = [selfCopy ak_additiveAnimationKeyPrefixForKeyPath:location[0]];
