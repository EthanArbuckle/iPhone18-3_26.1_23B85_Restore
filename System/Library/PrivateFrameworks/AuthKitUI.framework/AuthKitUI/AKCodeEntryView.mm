...
- (AKCodeEntryView)initWithFrame:(CGRect)a3
{
  ...
  v20 = [(AKCodeEntryView *)&v25 initWithFrame:a3.origin.x, a3.origin.y, a3.size.width, a3.size.height];
  v27 = v20;
  ...
  if (v20)
  {
    ...
    v23 = [objc_opt_class() generatorFieldFont];
    for (i = 0; i < 6; ++i)
    {
      ...
      v19 = [v21 layer];
      [v19 setDisableUpdateMask:{objc_msgSend(v19, "disableUpdateMask") | 0x12}];
    ...
    *&v15 = MEMORY[0x277D82BD8](tapGestureRecognizer).n128_u64[0];
    ...
    [v18 addObserver:v27 selector:sel__updateFonts_ name:*MEMORY[0x277D76810] object:?];
...
- (void)_updateFonts:(id)a3
{
  ...
  obj = MEMORY[0x277D82BE0](v14->_generatorFields);
  ...
  *&v3 = MEMORY[0x277D82BD8](obj).n128_u64[0];
  [(AKCodeEntryView *)v14 setNeedsUpdateConstraints];
...
- (void)updateConstraints
{
  ...
  {
    [MEMORY[0x277CCAAD0] deactivateConstraints:v27->_activeConstraints];
  }
  ...
  for (i = 0; i < 6; ++i)
  {
    if (i)
    {
      ...
      v16 = [(NSArray *)v27->_generatorFields objectAtIndexedSubscript:i];
      v15 = [(NSArray *)v27->_generatorFields firstObject];
    ...
    else
    {
      ...
      v28 = @"generatorLabel";
      v20 = [(NSArray *)v27->_generatorFields objectAtIndexedSubscript:0];
      v29[0] = v20;
    ...
    v10 = [(NSArray *)v27->_generatorFields objectAtIndexedSubscript:i, *&v2];
    ...
    v12 = [(NSArray *)v27->_generatorFields objectAtIndexedSubscript:i, MEMORY[0x277D82BD8](v10).n128_f64[0]];
  ...
  v4 = [v26[0] copy];
  activeConstraints = v27->_activeConstraints;
  v27->_activeConstraints = v4;
  *&v6 = MEMORY[0x277D82BD8](activeConstraints).n128_u64[0];
  [MEMORY[0x277CCAAD0] activateConstraints:{v27->_activeConstraints, v6}];
  v21.receiver = v27;
...
- (void)emitCodeEnteredNotification
{
  ...
  [v4 postNotificationName:@"AKSecondFactorCodeEntryContentViewControllerDidEnterCodeNotification" object:0 userInfo:?];
  MEMORY[0x277D82BD8](v2);
  MEMORY[0x277D82BD8](v3);
  MEMORY[0x277D82BD8](v4);
  *MEMORY[0x277D85DE8];
...
- (void)setStringValue:(id)a3
{
  ...
  *&v3 = MEMORY[0x277D82BD8](v5).n128_u64[0];
  ...
  {
    [objc_opt_class() cancelPreviousPerformRequestsWithTarget:v7 selector:0x1FCD9D37BuLL object:?];
    [(AKCodeEntryView *)v7 performSelector:0x1FCD9D37BuLL withObject:0 afterDelay:1.0];
  }
...
- (void)insertText:(id)a3
{
  ...
  location[0] = 0;
  objc_storeStrong(location, a3);
  if ([(NSMutableString *)v8->_stringValue length]== 6)
  {
    v6 = 1;
  }
  ...
  else
  {
    ...
    *&v3 = MEMORY[0x277D82BD8](v4).n128_u64[0];
    if ([location[0] rangeOfCharacterFromSet:{v5, v3}] == 0x7FFFFFFFFFFFFFFFLL)
    {
      if ([location[0] length])
      {
        [(NSMutableString *)v8->_stringValue appendString:location[0]];
        [(AKCodeEntryView *)v8 _syncStringValueToLabels];
        if ([(NSMutableString *)v8->_stringValue length]== 6)
        {
          [objc_opt_class() cancelPreviousPerformRequestsWithTarget:v8 selector:0x1FCD9D37BuLL object:?];
          [(AKCodeEntryView *)v8 performSelector:0x1FCD9D37BuLL withObject:0 afterDelay:1.0];
        }
      }
