...
- (void)_onQueue_handleRemovabilityChangedNotification:(id)a3
{
  v4 = a3;
  v23 = self;
  v5 = [(ACXLocalAppRemovabilityManager *)self internalQueue];
  ...
  v6 = [v4 userInfo];
  v7 = [v6 valueForKey:kCFBundleIdentifierKey];
  if (v7)
  {
    v21 = v4;
    v8 = [v6 objectForKeyedSubscript:IXNotificationPayloadRemovabilityValueKey];
    v20 = v6;
    v9 = [v6 objectForKeyedSubscript:IXNotificationPayloadRemovabilityStoreClockKey];
    ...
    v31 = 0u;
    v32 = 0u;
    obj = [(ACXLocalAppRemovabilityManager *)v23 observers];
...
- (ACXLocalAppRemovabilityManager)init
{
  ...
  if (v2)
  {
    ...
    v22 = sub_1000114A0;
    v23 = 0;
    v9 = [(ACXLocalAppRemovabilityManager *)v2 internalQueue];
...
- (void)fetchCurrentRemovabilityStoreUUID:(id *)a3 sequenceNumber:(unint64_t *)a4
{
  v7 = [(ACXLocalAppRemovabilityManager *)self internalQueue];
  block[0] = _NSConcreteStackBlock;
  block[1] = 3221225472;
