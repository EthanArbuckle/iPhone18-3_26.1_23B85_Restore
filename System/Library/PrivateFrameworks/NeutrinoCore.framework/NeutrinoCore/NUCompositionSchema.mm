...
- (BOOL)deserializeContents:(id)contents fromDictionary:(id)dictionary error:(id *)error;
- (BOOL)isValid:(id *)valid;
- (BOOL)itemIsResolved:(id)resolved;
- (BOOL)resolveItem:(id)item resolver:(id)resolver error:(id *)error;
- (BOOL)serializeContents:(id)contents intoDictionary:(id)dictionary error:(id *)error;
...
- (BOOL)validateComposition:(id)composition error:(id *)error;
- (BOOL)validateContents:(id *)contents;
- (BOOL)validateContents:(id)contents error:(id *)error;
- (BOOL)validatePropertyArray:(id)array error:(id *)error;
- (NUCompositionSchema)initWithIdentifier:(id)identifier attributes:(id)attributes;
- (NUCompositionSchema)initWithIdentifier:(id)identifier contents:(id)contents attributes:(id)attributes;
- (id)copy:(id)copy;
- (id)copyComposition:(id)composition;
- (id)deserialize:(id)deserialize error:(id *)error;
- (id)deserializeComposition:(id)composition error:(id *)error;
- (id)modelForProperty:(id)property;
- (id)serialize:(id)serialize error:(id *)error;
- (id)serializeComposition:(id)composition error:(id *)error;
@end
    ...
    while (2)
    {
      for (i = 0; i != v11; ++i)
      {
        ...
        if (v15)
        {
          ...
          v45 = 0;
          v20 = [v19 resolveItem:v16 resolver:resolverCopy error:&v45];
          v21 = v45;
          v22 = v21;
          if ((v20 & 1) == 0)
          {
            *errorCopy = [NUError errorWithCode:1 reason:@"Failed to resolve composition contents" object:v16 underlyingError:v21];
...
- (BOOL)serializeIntoDictionary:(id)dictionary error:(id *)error
{
  ...
  errorCopy = error;
  v36 = dictionaryCopy;
  [dictionaryCopy setObject:@"Composition" forKeyedSubscript:@"isa"];
  ...
  v17 = [(NUSchema *)&v37 serializeIntoDictionary:v36 error:errorCopy];
    ...
    while (2)
    {
      for (i = 0; i != v11; ++i)
      {
        ...
        if (v16)
        {
          ...
          if (!v17)
          {
            *errorCopy = [NUError errorWithCode:1 reason:@"Failed to deserialize content" object:v14 underlyingError:v18];

            goto LABEL_16;
          }

          [contentsCopy setObject:v17 forKeyedSubscript:v14];
        }
      }
  ...
  while (2)
  {
    for (i = 0; i != v12; ++i)
    {
      ...
      if (v17)
      {
        ...
        *errorCopy = [NUError errorWithCode:1 reason:@"Failed to serialize content" object:v15 underlyingError:v19];
...
LABEL_19:
      ...
      requiredContents = [(NUCompositionSchema *)self requiredContents];
      v21 = [requiredContents containsObject:v15];
...
- (id)deserializeComposition:(id)composition error:(id *)error
{
  ...
  v7 = compositionCopy;
  v48 = 0;
  v8 = [(NUSchema *)self deserializeIdentifierFromDictionary:compositionCopy error:&v48];
  v9 = v48;
  if (v8)
  {
...
- (id)serializeComposition:(id)composition error:(id *)error
{
  ...
  v58 = 0;
  v10 = [(NUSchema *)self serializeIdentifier:identifier intoDictionary:v8 error:&v58];
  v11 = v58;
  ...
  if (v10)
  {
    ...
    if (v12)
    {
      ...
      v56 = 0;
      v15 = [(NUCompositionSchema *)self serializeContents:contents intoDictionary:v8 error:&v56];
      v16 = v56;
      ...
      {
        contents2 = [v7 contents];
        *error = [NUError errorWithCode:1 reason:@"Failed to serialize contents" object:contents2 underlyingError:v16];
    ...
    else
    {
      ...
      {
        v20 = off_1E81098D0[mediaType];
      }

      v22 = v20;
      *error = [NUError errorWithCode:1 reason:@"Failed to serialize mediaType" object:v22 underlyingError:v13];
...
- (id)deserialize:(id)deserialize error:(id *)error
{
  ...
  {
    v8 = [(NUCompositionSchema *)self deserializeComposition:v7 error:error];
  }
...
- (id)serialize:(id)serialize error:(id *)error
{
  ...
  if (objc_opt_isKindOfClass())
  {
    v8 = [(NUCompositionSchema *)self serializeComposition:v7 error:error];
  }
...
- (id)modelForProperty:(id)property
{
  ...
  v5 = propertyCopy;
  v6 = [(NSDictionary *)self->_contents objectForKeyedSubscript:propertyCopy];
  if (v6)
  {
...
LABEL_5:
    ...
    while (1)
    {
      ...
      v10 = *(*(&v58 + 1) + 8 * v9);
      v11 = [contentsCopy objectForKeyedSubscript:v10];
      if (v11)
      {
        v12 = [(NSDictionary *)self->_contents objectForKeyedSubscript:v10];
        ...
        if ((v15 & 1) == 0)
        {
          *errorCopy = [NUError errorWithCode:2 reason:@"Invalid property" object:v10 underlyingError:v16];
...
LABEL_18:
      ...
      {
        requiredContents = [(NUCompositionSchema *)self requiredContents];
        v18 = [requiredContents containsObject:v10];
...
- (BOOL)validateComposition:(id)composition error:(id *)error
{
  ...
  identifier = [compositionCopy identifier];
  v51 = 0;
  v9 = [(NUSchema *)self validateIdentifier:identifier error:&v51];
  v10 = v51;
...
LABEL_8:
  ...
  contents = [v7 contents];
  v50 = 0;
  v12 = [(NUCompositionSchema *)self validateContents:contents error:&v50];
  v13 = v50;
...
- (BOOL)validate:(id)validate error:(id *)error
{
  ...
  if (objc_opt_isKindOfClass())
  {
    v8 = [(NUCompositionSchema *)self validateComposition:v7 error:error];
  }
...
- (BOOL)validateContents:(id *)contents
{
  ...
  while (2)
  {
    for (i = 0; i != v6; ++i)
    {
      ...
      v9 = *(*(&v21 + 1) + 8 * i);
      v20 = 0;
      contentsCopy = [(NUModel *)NUSchema validatePropertyName:v9 error:&v20, contentsCopy];
      v11 = v20;
      if (!contentsCopy)
      {
        *contentsCopy = [NUError errorWithCode:2 reason:@"Invalid property name" object:v9 underlyingError:v11];
LABEL_14:
      ...
      if (!v13)
      {
        *contentsCopy = [NUError errorWithCode:2 reason:@"Invalid schema identifier" object:v12 underlyingError:v14];
...
- (BOOL)validatePropertyArray:(id)array error:(id *)error
{
  ...
  v7 = arrayCopy;
  if ([(NUModel *)NUSchema validateStringArray:arrayCopy error:error])
  {
    v51 = 0u;
    v52 = 0u;
    v49 = 0u;
...
- (BOOL)validateAttribute:(id)attribute value:(id)value error:(id *)error
{
  ...
  {
    v10 = [(NUCompositionSchema *)self validatePropertyArray:valueCopy error:error];
  }
...
- (NUCompositionSchema)initWithIdentifier:(id)identifier contents:(id)contents attributes:(id)attributes
{
  ...
  v12 = [(NUSchema *)&v35 initWithIdentifier:identifierCopy attributes:attributesCopy];
  v13 = [contentsCopy copy];
...
+ (id)deserializeFromDictionary:(id)dictionary error:(id *)error
{
  ...
  v7 = dictionaryCopy;
  v52 = 0;
  v8 = [self deserializeIdentifierFromDictionary:dictionaryCopy error:&v52];
  v9 = v52;
  if (!v8)
  {
  ...
  v51 = 0;
  v10 = [self deserializeContentsFromDictionary:v7 error:&v51];
  v11 = v51;
  ...
  if (v10)
  {
    ...
    {
      v50 = 0;
      v14 = [self deserializeArrayFromDictionary:v7 key:@"required" error:&v50];
      v15 = v50;
    ...
    v16 = [[self alloc] initWithIdentifier:v8 contents:v10 attributes:v12];
LABEL_13:
