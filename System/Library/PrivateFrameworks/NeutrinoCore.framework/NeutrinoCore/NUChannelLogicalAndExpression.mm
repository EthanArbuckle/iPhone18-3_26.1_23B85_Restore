@interface NUChannelLogicalAndExpression
- (id)compactDescription;
- (id)description;
- (id)evaluateWithLeftValue:(id)value rightValue:(id)rightValue error:(id *)error;
@end

@implementation NUChannelLogicalAndExpression
...
- (id)evaluateWithLeftValue:(id)value rightValue:(id)rightValue error:(id *)error
{
  ...
  if (!valueCopy)
  {
    ...
    _NUAssertFailHandler("[NUChannelLogicalAndExpression evaluateWithLeftValue:rightValue:error:]", "/Library/Caches/com.apple.xbs/Sources/Photos/workspaces/neutrino/Core/Pipeline/API/NUChannel.m", 3630, @"Invalid parameter not satisfying: %s", v32, v33, v34, v35, "left != nil");
  }
  ...
  if (!rightValueCopy)
  {
    ...
    _NUAssertFailHandler("[NUChannelLogicalAndExpression evaluateWithLeftValue:rightValue:error:]", "/Library/Caches/com.apple.xbs/Sources/Photos/workspaces/neutrino/Core/Pipeline/API/NUChannel.m", 3631, @"Invalid parameter not satisfying: %s", v41, v42, v43, v44, "right != nil");
  }

  bOOLValue = [valueCopy BOOLValue];
  if ((bOOLValue & [v8 BOOLValue]) != 0)
  {
...
- (id)description
{
  ...
  v8 = [v3 stringWithFormat:@"and<%@, %@>", v5, v7];
