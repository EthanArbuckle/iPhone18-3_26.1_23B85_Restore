...
+ (id)transformNodeWithInput:(id)input transform:(id)transform error:(id *)error;
...
LABEL_9:
  ...
  canPropagateOriginalLivePhotoMetadataTrack = [(NURenderNode *)&v8 canPropagateOriginalLivePhotoMetadataTrack];
LABEL_10:
...
- (id)_evaluateGeometrySpaceMap:(id *)map
{
  ...
  if (v5)
  {
    ...
    if (v7)
    {
      ...
      [v5 setSpace:v9 forKey:spaceMapKey];
...
+ (id)transformNodeWithInput:(id)input transform:(id)transform error:(id *)error
{
  ...
  {
    v10 = v9;
    v11 = [[NUAffineTransformNode alloc] initWithAffineTransform:v10 input:inputCopy];
LABEL_8:
    v12 = v11;
  ...
  {
    v10 = v9;
    v11 = [[NUTransform3DNode alloc] initWithTransform3D:v10 input:inputCopy];
    goto LABEL_8;
  }
