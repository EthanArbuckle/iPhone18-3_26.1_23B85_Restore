...
- (id)serializeAdjustment:(id)a3 error:(id *)a4
{
  ...
  v9 = [v7 identifier];
  v50 = 0;
  v10 = [(NUSchema *)self serializeIdentifier:v9 intoDictionary:v8 error:&v50];
  v11 = v50;
...
- (id)deserialize:(id)a3 error:(id *)a4
{
  ...
  {
    v8 = [(NUAdjustmentSchema *)self deserializeAdjustment:v7 error:a4];
  }
...
- (id)serialize:(id)a3 error:(id *)a4
{
  ...
  if (objc_opt_isKindOfClass())
  {
    v8 = [(NUAdjustmentSchema *)self serializeAdjustment:v7 error:a4];
  }
...
- (id)modelForProperty:(id)a3
{
  ...
  v5 = v4;
  v6 = [(NSDictionary *)self->_settings objectForKeyedSubscript:v4];
...
- (BOOL)validateAdjustment:(id)a3 error:(id *)a4
{
  ...
  v10 = v9 && [(NUAdjustmentSchema *)self validateSettings:v7 error:a4];
  return v10;
}
...
- (BOOL)validate:(id)a3 error:(id *)a4
{
  ...
  if (objc_opt_isKindOfClass())
  {
    v8 = [(NUAdjustmentSchema *)self validateAdjustment:v7 error:a4];
  }
...
- (BOOL)validateSettings:(id *)a3
{
  ...
  while (2)
  {
    for (i = 0; i != v6; ++i)
    {
      ...
      if (!v10)
      {
        *v17 = [NUError errorWithCode:2 reason:@"Invalid setting name" object:v9 underlyingError:v11];
LABEL_14:
      ...
      if ((v13 & 1) == 0)
      {
        *v17 = [NUError errorWithCode:2 reason:@"Invalid setting" object:v9 underlyingError:v14];
