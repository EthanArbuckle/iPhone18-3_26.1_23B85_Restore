...
- (NUMutableDataSet)initWithCapacity:(int64_t)capacity;
...
- (void)appendDataSet:(id)set
{
  ...
  if (!setCopy)
  {
    ...
    [currentHandler handleFailureInMethod:a2 object:self file:@"NUDataSet.mm" lineNumber:402 description:{@"Invalid parameter not satisfying: %@", @"dataSet != nil"}];
...
- (id)copyWithZone:(_NSZone *)zone
{
  v4 = [NUDataSet allocWithZone:zone];
...
- (NUMutableDataSet)initWithCapacity:(int64_t)capacity
{
  ...
  if (result && capacity > (result->super._data._values.__cap_ - result->super._data._values.__begin_))
  {
    if (!(capacity >> 61))
    {
      std::__allocate_at_least[abi:ne200100]<std::allocator<double>>(capacity);
    }
