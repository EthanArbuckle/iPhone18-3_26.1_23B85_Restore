...
- (NUChannelSequenceMatching)initWithMatchingSequence:(id)a3;
- (id)description;
- (id)subchannel:(id)a3;
...
- (id)description
{
  ...
  v3 = [(NUChannelSequenceMatching *)self sequence];
...
- (id)subchannel:(id)a3
{
  ...
  v5 = v4;
  v6 = [(NUChannelSequenceMatching *)self sequence];
...
- (BOOL)match:(id)a3
{
  ...
  v4 = a3;
  v5 = [(NSArray *)sequence firstObject];
  v6 = [v5 match:v4];
...
- (id)subsequentMatching
{
  ...
  if (v3 < 3)
  {
    if (v5 == 2)
    {
      v7 = [(NSArray *)self->_sequence lastObject];
    }
  ...
  else
  {
    ...
    v7 = [[NUChannelSequenceMatching alloc] initWithMatchingSequence:v6];
  }
