...
- (NUFitHeightScalePolicy)initWithHeight:(int64_t)height
{
  ...
  if (height <= 0)
  {
    ...
    {
      v6 = [MEMORY[0x1E696AEC0] stringWithFormat:@"Invalid parameter not satisfying: %s", "height > 0"];
      *buf = 138543362;
      v23 = v6;
    ...
    _NUAssertFailHandler("[NUFitHeightScalePolicy initWithHeight:]", "/Library/Caches/com.apple.xbs/Sources/Photos/workspaces/neutrino/Core/Render/NUScalePolicy.m", 367, @"Invalid parameter not satisfying: %s", v17, v18, v19, v20, "height > 0");
  }
...
LABEL_14:
  ...
  _NUAssertFailHandler("[NUFitHeightScalePolicy init]", "/Library/Caches/com.apple.xbs/Sources/Photos/workspaces/neutrino/Core/Render/NUScalePolicy.m", 362, @"Initializer not available: [%@ %@], use designated initializer instead.", v25, v26, v27, v28, v24);
}
