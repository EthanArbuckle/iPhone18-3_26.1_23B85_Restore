...
- (NUChannelStaticExpression)initWithExpressionType:(int64_t)a3 arguments:(id)a4;
- (NUChannelStaticExpression)initWithPort:(id)a3 expressionType:(int64_t)a4;
...
- (id)inputPorts
{
  ...
  v2 = [(NUChannelStaticExpression *)self port];
  v5[0] = v2;
...
{
  v6 = a3;
  v7 = [(NUChannelStaticExpression *)self port];
...
- (id)debugDescription
{
  ...
  v7 = [(NUChannelStaticExpression *)self port];
  v8 = [v3 stringWithFormat:@"<%@:%p type=%@, port=%@>", v4, self, v6, v7];
...
- (id)description
{
  ...
  v3 = [(NUChannelStaticExpression *)self port];
  v4 = [v3 description];
