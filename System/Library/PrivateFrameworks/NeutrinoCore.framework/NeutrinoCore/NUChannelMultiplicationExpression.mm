@interface NUChannelMultiplicationExpression
- (id)compactDescription;
- (id)description;
- (id)evaluateWithLeftValue:(id)value rightValue:(id)rightValue error:(id *)error;
@end

@implementation NUChannelMultiplicationExpression
...
- (id)evaluateWithLeftValue:(id)value rightValue:(id)rightValue error:(id *)error
{
  ...
  if (!valueCopy)
  {
    ...
    _NUAssertFailHandler("[NUChannelMultiplicationExpression evaluateWithLeftValue:rightValue:error:]", "/Library/Caches/com.apple.xbs/Sources/Photos/workspaces/neutrino/Core/Pipeline/API/NUChannel.m", 3359, @"Invalid parameter not satisfying: %s", v36, v37, v38, v39, "left != nil");
  }
  ...
  if (!rightValueCopy)
  {
    ...
    _NUAssertFailHandler("[NUChannelMultiplicationExpression evaluateWithLeftValue:rightValue:error:]", "/Library/Caches/com.apple.xbs/Sources/Photos/workspaces/neutrino/Core/Pipeline/API/NUChannel.m", 3360, @"Invalid parameter not satisfying: %s", v45, v46, v47, v48, "right != nil");
  }
  ...
  if (type == 2)
  {
    [MEMORY[0x1E696AD98] numberWithInteger:{objc_msgSend(v9, "integerValue") * objc_msgSend(valueCopy, "integerValue")}];
  }
...
- (id)description
{
  ...
  v8 = [v3 stringWithFormat:@"mul<%@, %@>", v5, v7];
