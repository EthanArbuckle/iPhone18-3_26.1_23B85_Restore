@interface DRClient
- (DRClient)initWithIdentifier:(id)a3;
- (void)activate:(id)a3;
- (void)addAvailableDataTypes:(unint64_t)a3 completion:(id)a4;
- (void)addRequestedDataTypes:(unint64_t)a3 completion:(id)a4;
- (void)dataHandler:(unint64_t)a3 serviceID:(unint64_t)a4 opcode:(unint64_t)a5 data:(id)a6;
- (void)dealloc;
- (void)removeAvailableDataTypes:(unint64_t)a3 completion:(id)a4;
...
- (DRClient)initWithIdentifier:(id)a3
{
  ...
  v3 = [(DRPeer *)&v10 initWithIdentifier:a3];
  if (v3)
  {
...
- (void)sendEvents
{
  ...
  if ([(NSMutableArray *)self->_events count])
  {
    ...
    [v5 sendEventID:@"com.apple.datarelay.events" event:v4 options:0 completion:0];
...
- (void)dataHandler:(unint64_t)a3 serviceID:(unint64_t)a4 opcode:(unint64_t)a5 data:(id)a6
{
  ...
  {
    [DRClient dataHandler:a5 serviceID:? opcode:? data:?];
  }
}
...
- (void)reset
{
  ...
  [v5 registerEventID:@"com.apple.datarelay.request" options:0 handler:&v10];
