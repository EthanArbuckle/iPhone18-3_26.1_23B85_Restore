...
- (model_period_10pctInput)initWithIn:(id)in lstm_1_h_in:(id)lstm_1_h_in lstm_1_c_in:(id)lstm_1_c_in;
@end
...
- (id)featureValueForName:(id)name
{
  ...
  if ([nameCopy isEqualToString:@"in"])
  {
    ...
    lstm_1_h_in = [(model_period_10pctInput *)self in];
...
LABEL_11:
  ...
  {
    lstm_1_h_in = [(model_period_10pctInput *)self lstm_1_h_in];
    if (lstm_1_h_in)
    {
      v8 = MEMORY[0x277CBFEF8];
      lstm_1_h_in2 = [(model_period_10pctInput *)self lstm_1_h_in];
LABEL_9:
      v10 = lstm_1_h_in2;
  ...
  {
    lstm_1_h_in = [(model_period_10pctInput *)self lstm_1_c_in];
    if (lstm_1_h_in)
    {
      v8 = MEMORY[0x277CBFEF8];
      lstm_1_h_in2 = [(model_period_10pctInput *)self lstm_1_c_in];
      goto LABEL_9;
    }
