...
- (model_period_10pct)initWithConfiguration:(id)configuration error:(id *)error;
- (model_period_10pct)initWithContentsOfURL:(id)l configuration:(id)configuration error:(id *)error;
- (model_period_10pct)initWithContentsOfURL:(id)l error:(id *)error;
- (model_period_10pct)initWithMLModel:(id)model;
...
- (model_period_10pct)initWithMLModel:(id)model
{
  ...
  {
    v10.receiver = self;
    v10.super_class = model_period_10pct;
...
- (model_period_10pct)init
{
  ...
  v4 = [(model_period_10pct *)self initWithContentsOfURL:uRLOfModelInThisBundle error:0];
...
- (model_period_10pct)initWithConfiguration:(id)configuration error:(id *)error
{
  ...
  uRLOfModelInThisBundle = [objc_opt_class() URLOfModelInThisBundle];
  v8 = [(model_period_10pct *)self initWithContentsOfURL:uRLOfModelInThisBundle configuration:configurationCopy error:error];
...
- (id)predictionFromFeatures:(id)features error:(id *)error
{
  ...
  v9 = [(model_period_10pct *)self predictionFromFeatures:featuresCopy options:v8 error:error];
...
- (id)predictionFromFeatures:(id)features options:(id)options error:(id *)error
{
  optionsCopy = options;
  featuresCopy = features;
  model = [(model_period_10pct *)self model];
  ...
  if (v11)
  {
    ...
    v19 = [(model_period_10pctOutput *)v12 initWithOut:multiArrayValue lstm_1_h_out:multiArrayValue2 lstm_1_c_out:multiArrayValue3];
  }
...
- (id)predictionFromIn:(id)in lstm_1_h_in:(id)lstm_1_h_in lstm_1_c_in:(id)lstm_1_c_in error:(id *)error
{
  ...
  inCopy = in;
  v13 = [[model_period_10pctInput alloc] initWithIn:inCopy lstm_1_h_in:lstm_1_h_inCopy lstm_1_c_in:lstm_1_c_inCopy];

  v14 = [(model_period_10pct *)self predictionFromFeatures:v13 error:error];
  ...
  if (v12)
  {
    ...
    if ([v12 count] >= 1)
    {
      ...
      do
      {
        ...
        v24 = [(model_period_10pctOutput *)v16 initWithOut:multiArrayValue lstm_1_h_out:multiArrayValue2 lstm_1_c_out:multiArrayValue3];
