...
- (id)predictionFromFeatures:(id)a3 error:(id *)a4
{
  ...
  v9 = [(model_period_10pct *)self predictionFromFeatures:v7 options:v8 error:a4];
...
- (id)predictionFromFeatures:(id)a3 options:(id)a4 error:(id *)a5
{
  v8 = a4;
  v9 = a3;
  v10 = [(model_period_10pct *)self model];
...
- (void)predictionFromFeatures:(id)a3 completionHandler:(id)a4
{
  v6 = a4;
  v7 = a3;
  v8 = [(model_period_10pct *)self model];
  v10[0] = MEMORY[0x277D85DD0];
  v10[1] = 3221225472;
...
- (void)predictionFromFeatures:(id)a3 options:(id)a4 completionHandler:(id)a5
{
  ...
  v9 = a4;
  v10 = a3;
  v11 = [(model_period_10pct *)self model];
...
- (id)predictionFromIn:(id)a3 lstm_1_h_in:(id)a4 lstm_1_c_in:(id)a5 error:(id *)a6
{
  ...
  v14 = [(model_period_10pct *)self predictionFromFeatures:v13 error:a6];
