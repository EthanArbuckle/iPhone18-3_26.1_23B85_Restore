...
- (WBEnsembleFunctionTF)initWithConfiguration:(id)configuration error:(id *)error;
- (WBEnsembleFunctionTF)initWithContentsOfURL:(id)l configuration:(id)configuration error:(id *)error;
- (WBEnsembleFunctionTF)initWithContentsOfURL:(id)l error:(id *)error;
- (WBEnsembleFunctionTF)initWithMLModel:(id)model;
...
- (WBEnsembleFunctionTF)init
{
  ...
  v4 = [(WBEnsembleFunctionTF *)self initWithContentsOfURL:uRLOfModelInThisBundle error:0];
...
- (WBEnsembleFunctionTF)initWithConfiguration:(id)configuration error:(id *)error
{
  ...
  uRLOfModelInThisBundle = [objc_opt_class() URLOfModelInThisBundle];
  v8 = [(WBEnsembleFunctionTF *)self initWithContentsOfURL:uRLOfModelInThisBundle configuration:configurationCopy error:error];
...
- (id)predictionFromFeatures:(id)features error:(id *)error
{
  ...
  v9 = [(WBEnsembleFunctionTF *)self predictionFromFeatures:featuresCopy options:v8 error:error];
...
- (id)predictionFromFeatures:(id)features options:(id)options error:(id *)error
{
  optionsCopy = options;
  featuresCopy = features;
  model = [(WBEnsembleFunctionTF *)self model];
  ...
  if (v11)
  {
    ...
    v15 = [(WBEnsembleFunctionTFOutput *)v12 initWithOut:multiArrayValue];
  }
...
{
  inCopy = in;
  v7 = [[WBEnsembleFunctionTFInput alloc] initWithIn:inCopy];

  v8 = [(WBEnsembleFunctionTF *)self predictionFromFeatures:v7 error:error];
  ...
  if (v12)
  {
    ...
    if ([v12 count] >= 1)
    {
      ...
      do
      {
        ...
        v19 = [(WBEnsembleFunctionTFOutput *)v16 initWithOut:multiArrayValue];
