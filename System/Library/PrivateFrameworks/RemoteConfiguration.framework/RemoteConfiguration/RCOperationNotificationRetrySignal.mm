...
- (RCOperationNotificationRetrySignal)initWithNotificationName:(id)name timeout:(double)timeout;
- (void)dealloc;
...
- (void)onQueue:(id)queue signal:(id)signal
{
  ...
  v11 = signalCopy;
  v9 = signalCopy;
  RCDispatchGroupNotifyWithTimeout(group, queue, timeoutTime, v10);
}
