...
- (id)description
{
  ...
  v8.receiver = self;
  v8.super_class = MXRepeatedItnAlignment;
  v4 = [(MXRepeatedItnAlignment *)&v8 description];
...
- (id)dictionaryRepresentation
{
  ...
  {
    v4 = [objc_alloc(MEMORY[0x277CBEB18]) initWithCapacity:{-[NSMutableArray count](self->_itnAlignments, "count")}];
    v13 = 0u;
    v14 = 0u;
    v15 = 0u;
    v16 = 0u;
...
- (void)copyTo:(id)a3
{
  ...
  if ([(MXRepeatedItnAlignment *)self itnAlignmentsCount])
  {
    ...
    v4 = [(MXRepeatedItnAlignment *)self itnAlignmentsCount];
    if (v4)
    {
      v5 = v4;
      for (i = 0; i != v5; ++i)
      {
        v7 = [(MXRepeatedItnAlignment *)self itnAlignmentAtIndex:i];
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    itnAlignments = self->_itnAlignments;
    if (itnAlignments | v4[1])
    {
      v6 = [(NSMutableArray *)itnAlignments isEqual:?];
    }
  ...
  if (v5)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        [(MXRepeatedItnAlignment *)self addItnAlignment:*(*(&v10 + 1) + 8 * v8++), v10];
      }
