...
- (BOOL)isEqual:(id)a3
{
  ...
  if ((*&self->_has & 2) != 0)
  {
    if ((*(v4 + 24) & 2) == 0 || self->_firstPreItnTokenIndex != *(v4 + 3))
    {
      goto LABEL_21;
    }
  }
...
LABEL_21:
  ...
  if ((*&self->_has & 8) != 0)
  {
    if ((*(v4 + 24) & 8) == 0 || self->_lastPreItnTokenIndex != *(v4 + 5))
    {
      goto LABEL_21;
    }
  }
  ...
  if (*&self->_has)
  {
    if ((*(v4 + 24) & 1) == 0 || self->_firstPostItnCharPos != *(v4 + 2))
    {
      goto LABEL_21;
    }
  }
  ...
  if ((*&self->_has & 4) != 0)
  {
    if ((*(v4 + 24) & 4) == 0 || self->_lastPostItnCharPos != *(v4 + 4))
    {
      goto LABEL_21;
    }
...
- (void)mergeFrom:(id)a3
{
  ...
  if ((v5 & 2) != 0)
  {
    self->_firstPreItnTokenIndex = *(v4 + 3);
    *&self->_has |= 2u;
    v5 = *(v4 + 24);
    if ((v5 & 8) == 0)
    {
LABEL_3:
  ...
  self->_lastPreItnTokenIndex = *(v4 + 5);
  *&self->_has |= 8u;
  v5 = *(v4 + 24);
  if ((v5 & 1) == 0)
  {
...
LABEL_11:
  self->_firstPostItnCharPos = *(v4 + 2);
  *&self->_has |= 1u;
  if ((*(v4 + 24) & 4) != 0)
  {
LABEL_5:
    self->_lastPostItnCharPos = *(v4 + 4);
    *&self->_has |= 4u;
  }
