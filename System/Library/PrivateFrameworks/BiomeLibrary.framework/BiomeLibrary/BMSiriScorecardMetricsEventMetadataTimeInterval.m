...
+ (id)protoFields;
- (BMSiriScorecardMetricsEventMetadataTimeInterval)initWithJSONDictionary:(id)a3 error:(id *)a4;
- (BMSiriScorecardMetricsEventMetadataTimeInterval)initWithStartTimestampInSecondsSince1970:(id)a3 numberOfSeconds:(id)a4;
- (BOOL)isEqual:(id)a3;
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (objc_opt_isKindOfClass())
  {
    ...
    if (-[BMSiriScorecardMetricsEventMetadataTimeInterval hasStartTimestampInSecondsSince1970](self, "hasStartTimestampInSecondsSince1970") || [v5 hasStartTimestampInSecondsSince1970])
    {
      ...
      v6 = [(BMSiriScorecardMetricsEventMetadataTimeInterval *)self startTimestampInSecondsSince1970];
    ...
    if (-[BMSiriScorecardMetricsEventMetadataTimeInterval hasNumberOfSeconds](self, "hasNumberOfSeconds") && [v5 hasNumberOfSeconds])
    {
      v7 = [(BMSiriScorecardMetricsEventMetadataTimeInterval *)self numberOfSeconds];
