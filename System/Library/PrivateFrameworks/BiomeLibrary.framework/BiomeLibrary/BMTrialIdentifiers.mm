...
+ (id)protoFields;
- (BMTrialIdentifiers)initWithJSONDictionary:(id)a3 error:(id *)a4;
- (BMTrialIdentifiers)initWithTask:(id)a3 treatment:(id)a4 deployment:(id)a5;
- (BOOL)isEqual:(id)a3;
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    v5 = v4;
    v6 = [(BMTrialIdentifiers *)self task];
    v7 = [v5 task];
    v8 = v7;
    if (v6 == v7)
    {
    ...
    {
      v9 = [(BMTrialIdentifiers *)self task];
      v10 = [v5 task];
      v11 = [v9 isEqual:v10];
    ...
    v13 = [(BMTrialIdentifiers *)self treatment];
    v14 = [v5 treatment];
    v15 = v14;
    if (v13 == v14)
    {
    ...
    {
      v16 = [(BMTrialIdentifiers *)self treatment];
      v17 = [v5 treatment];
      v18 = [v16 isEqual:v17];
...
LABEL_15:
    ...
    v19 = [(BMTrialIdentifiers *)self deployment];
    v20 = [v5 deployment];
    if (v19 == v20)
    {
      v12 = 1;
    ...
    {
      v21 = [(BMTrialIdentifiers *)self deployment];
      v22 = [v5 deployment];
      v12 = [v21 isEqual:v22];
    }
...
- (id)jsonDictionary
{
  ...
  v3 = [(BMTrialIdentifiers *)self task];
  v4 = [(BMTrialIdentifiers *)self treatment];
  v5 = [(BMTrialIdentifiers *)self deployment];
  v12[0] = @"task";
  v6 = v3;
  if (!v3)
  {
...
- (BMTrialIdentifiers)initWithJSONDictionary:(id)a3 error:(id *)a4
{
  ...
  if (!v7 || (objc_opt_class(), (objc_opt_isKindOfClass() & 1) != 0))
  {
    v8 = 0;
LABEL_4:
    v9 = [v6 objectForKeyedSubscript:@"treatment"];
    ...
    v11 = [v6 objectForKeyedSubscript:@"deployment"];
    if (v11 && (objc_opt_class(), (objc_opt_isKindOfClass() & 1) == 0))
    {
      ...
      if ((objc_opt_isKindOfClass() & 1) == 0)
      {
        if (a4)
        {
          ...
          v20 = [objc_alloc(MEMORY[0x1E696AEC0]) initWithFormat:@"Unexpected type %@ for element of %@, expecting NSString", objc_opt_class(), @"deployment"];
          v26 = v20;
...
- (NSString)description
{
  ...
  v4 = [(BMTrialIdentifiers *)self task];
  v5 = [(BMTrialIdentifiers *)self treatment];
  v6 = [(BMTrialIdentifiers *)self deployment];
  v7 = [v3 initWithFormat:@"BMTrialIdentifiers with task: %@, treatment: %@, deployment: %@", v4, v5, v6];
...
- (BMTrialIdentifiers)initWithTask:(id)a3 treatment:(id)a4 deployment:(id)a5
{
  ...
  if (v12)
  {
    ...
    objc_storeStrong(&v12->_treatment, a4);
    objc_storeStrong(&v12->_deployment, a5);
  }
