...
+ (id)protoFields;
- (BMSiriCallHistory)initWithInteraction:(id)interaction entities:(id)entities;
- (BMSiriCallHistory)initWithJSONDictionary:(id)dictionary error:(id *)error;
...
+ (id)columns
{
  ...
  v2 = [objc_alloc(MEMORY[0x1E698F2D8]) initWithName:@"interaction_json" dataType:5 requestOnly:1 extractBlock:&__block_literal_global_52327];
  v3 = [objc_alloc(MEMORY[0x1E698F2D8]) initWithName:@"entities_json" dataType:5 requestOnly:1 extractBlock:&__block_literal_global_35_52328];
  v7[0] = v2;
  v7[1] = v3;
...
- (NSString)identifier
{
  ...
  interaction = [(BMSiriCallHistory *)self interaction];
  if (interaction)
  {
    interaction2 = [(BMSiriCallHistory *)self interaction];
    identifier = [interaction2 identifier];
  }
  ...
  v8 = [objc_alloc(MEMORY[0x1E696AEC0]) initWithFormat:@"%@:%@", v4, identifier];
...
- (BOOL)isEqual:(id)equal
{
  ...
  if (objc_opt_isKindOfClass())
  {
    ...
    {
      interaction3 = [(BMSiriCallHistory *)self interaction];
      interaction4 = [v5 interaction];
      v11 = [interaction3 isEqual:interaction4];
...
LABEL_11:
    ...
    entities = [(BMSiriCallHistory *)self entities];
    ...
    {
      entities3 = [(BMSiriCallHistory *)self entities];
...
- (id)jsonDictionary
{
  ...
  _entitiesJSONArray = [(BMSiriCallHistory *)self _entitiesJSONArray];
  v11[0] = @"interaction";
  null = jsonDictionary;
  if (!jsonDictionary)
  {
...
- (BMSiriCallHistory)initWithJSONDictionary:(id)dictionary error:(id *)error
{
  ...
  v7 = [dictionaryCopy objectForKeyedSubscript:@"interaction"];
...
LABEL_19:
  ...
  v8 = v40;
  self = [(BMSiriCallHistory *)self initWithInteraction:v40 entities:v12];
  selfCopy2 = self;
  v7 = v41;
  dictionaryCopy = v42;
LABEL_36:
...
- (void)writeTo:(id)to
{
  ...
  if (self->_interaction)
  {
    ...
    [(BMSiriRemembersInteraction *)self->_interaction writeTo:toCopy];
...
- (id)initByReadFrom:(id)from
{
  fromCopy = from;
  v26.receiver = self;
  v26.super_class = BMSiriCallHistory;
...
LABEL_16:
      ...
      if ((v15 >> 3) == 2)
      {
        v27 = 0;
        v28 = 0;
        if (!PBReaderPlaceMark() || (v18 = [[BMSiriRemembersEntities alloc] initByReadFrom:fromCopy]) == 0)
        {
LABEL_30:
      ...
      else if ((v15 >> 3) == 1)
      {
        ...
        v16 = [[BMSiriRemembersInteraction alloc] initByReadFrom:fromCopy];
        if (!v16)
        {
          goto LABEL_30;
        }
...
- (NSString)description
{
  ...
  interaction = [(BMSiriCallHistory *)self interaction];
  entities = [(BMSiriCallHistory *)self entities];
  v6 = [v3 initWithFormat:@"BMSiriCallHistory with interaction: %@, entities: %@", interaction, entities];
...
- (BMSiriCallHistory)initWithInteraction:(id)interaction entities:(id)entities
{
  ...
  v11.receiver = self;
  v11.super_class = BMSiriCallHistory;
...
+ (id)eventWithData:(id)data dataVersion:(unsigned int)version
{
  ...
  else
  {
    ...
    v8 = [[BMSiriCallHistory alloc] initByReadFrom:v7];
    v4 = v8;
    if (v8)
    {
      v8[4] = 0;
