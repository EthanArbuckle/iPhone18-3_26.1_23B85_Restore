...
- (id)jsonDictionary
{
  ...
  v5 = [(BMSiriCallHistory *)self _entitiesJSONArray];
  v11[0] = @"interaction";
  v6 = v4;
  if (!v4)
  {
...
- (id)_entitiesJSONArray
{
  ...
  v14 = 0u;
  v15 = 0u;
  v4 = [(BMSiriCallHistory *)self entities];
...
- (NSString)description
{
  ...
  v4 = [(BMSiriCallHistory *)self interaction];
  v5 = [(BMSiriCallHistory *)self entities];
  v6 = [v3 initWithFormat:@"BMSiriCallHistory with interaction: %@, entities: %@", v4, v5];
