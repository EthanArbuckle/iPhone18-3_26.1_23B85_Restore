...
+ (id)configurationForMusic
{
  ...
  BYTE2(v17) = 1;
  LOWORD(v17) = 1;
  v14 = [v12 _libraryStreamConfigurationWithUUID:v13 streamIdentifier:@"Siri.AppSelection.Music" eventClass:objc_opt_class() storeConfig:storeConfigurationForMusic syncPolicy:syncPolicyForMusic legacyNames:0 internalMetadata:0 enableSubscriptions:v17 enableSubscriptionSubstream:0 enableTombstoneSubstream:v11 allowedClients:0 pruningTriggers:v18[0] spaceAttributionOwner:?];
