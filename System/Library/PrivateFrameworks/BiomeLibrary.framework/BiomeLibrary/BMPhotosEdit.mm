...
+ (id)protoFields;
- (BMPhotosEdit)initWithIdentifier:(id)identifier subset:(id)subset type:(int)type;
- (BMPhotosEdit)initWithJSONDictionary:(id)dictionary error:(id *)error;
...
- (BOOL)isEqual:(id)equal
{
  ...
  {
    v5 = equalCopy;
    identifier = [(BMPhotosEdit *)self identifier];
    ...
    {
      identifier3 = [(BMPhotosEdit *)self identifier];
    ...
    subset = [(BMPhotosEdit *)self subset];
    subset2 = [v5 subset];
    v15 = subset2;
    if (subset == subset2)
    {
    ...
    {
      subset3 = [(BMPhotosEdit *)self subset];
      subset4 = [v5 subset];
...
- (id)jsonDictionary
{
  ...
  identifier = [(BMPhotosEdit *)self identifier];
  subset = [(BMPhotosEdit *)self subset];
  v5 = [MEMORY[0x1E696AD98] numberWithInt:{-[BMPhotosEdit type](self, "type")}];
  v12[0] = @"identifier";
  null = identifier;
  if (!identifier)
  {
...
LABEL_4:
    ...
    if (v11 && (objc_opt_class(), (objc_opt_isKindOfClass() & 1) == 0))
    {
      ...
      else
      {
        ...
        v13 = [MEMORY[0x1E696AD98] numberWithInt:BMPhotosEditTypeFromString(v11)];
      }
...
- (NSString)description
{
  ...
  identifier = [(BMPhotosEdit *)self identifier];
  subset = [(BMPhotosEdit *)self subset];
  v6 = BMPhotosEditTypeAsString([(BMPhotosEdit *)self type]);
  v7 = [v3 initWithFormat:@"BMPhotosEdit with identifier: %@, subset: %@, type: %@", identifier, subset, v6];
...
+ (id)eventWithData:(id)data dataVersion:(unsigned int)version
{
  ...
  else
  {
    ...
    v8 = [[BMPhotosEdit alloc] initByReadFrom:v7];
    v4 = v8;
    if (v8)
    {
      v8[4] = 0;
