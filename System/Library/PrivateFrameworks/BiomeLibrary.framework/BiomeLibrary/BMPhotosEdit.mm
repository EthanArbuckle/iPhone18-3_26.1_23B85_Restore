...
- (NSString)description
{
  ...
  v4 = [(BMPhotosEdit *)self identifier];
  v5 = [(BMPhotosEdit *)self subset];
  v6 = BMPhotosEditTypeAsString([(BMPhotosEdit *)self type]);
  v7 = [v3 initWithFormat:@"BMPhotosEdit with identifier: %@, subset: %@, type: %@", v4, v5, v6];
