...
- (id)jsonDictionary
{
  ...
  v4 = [(BMSiriRemembersFieldFieldValueNamedValue *)self value];
...
LABEL_16:
      ...
      if ((v14 >> 3) == 2)
      {
        ...
        v17 = [[BMSiriRemembersFieldFieldValueBasicValue alloc] initByReadFrom:v4];
        if (!v17)
        {
          goto LABEL_27;
        }
...
- (NSString)description
{
  ...
  v4 = [(BMSiriRemembersFieldFieldValueNamedValue *)self name];
  v5 = [(BMSiriRemembersFieldFieldValueNamedValue *)self value];
  v6 = [v3 initWithFormat:@"BMSiriRemembersFieldFieldValueNamedValue with name: %@, value: %@", v4, v5];
