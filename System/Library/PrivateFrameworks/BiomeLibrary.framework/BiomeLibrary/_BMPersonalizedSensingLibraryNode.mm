...
+ (id)MomentsContext
{
  ...
  v2 = [a1 configurationForMomentsContext];
  ...
  v10 = [objc_alloc(MEMORY[0x1E698F320]) initWithIdentifier:@"PersonalizedSensing.MomentsContext" schema:v9 configuration:v2];
