...
+ (id)configurationForTroubleshooting
{
  v3 = [a1 storeConfigurationForTroubleshooting];
  v4 = [a1 syncPolicyForTroubleshooting];
...
+ (id)Troubleshooting
{
  ...
  v2 = [a1 configurationForTroubleshooting];
  ...
  v10 = [objc_alloc(MEMORY[0x1E698F320]) initWithIdentifier:@"DeviceExpert.Troubleshooting" schema:v9 configuration:v2];
...
+ (id)streamWithName:(id)a3
{
  if ([a3 isEqualToString:@"Troubleshooting"])
  {
    v4 = [a1 Troubleshooting];
  }
