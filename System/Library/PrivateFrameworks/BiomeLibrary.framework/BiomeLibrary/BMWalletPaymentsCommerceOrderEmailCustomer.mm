@interface BMWalletPaymentsCommerceOrderEmailCustomer
+ (id)columns;
+ (id)eventWithData:(id)a3 dataVersion:(unsigned int)a4;
+ (id)protoFields;
- (BMWalletPaymentsCommerceOrderEmailCustomer)initWithFullName:(id)a3 phoneNumber:(id)a4 emailAddress:(id)a5 billingAddress:(id)a6 givenName:(id)a7 familyName:(id)a8;
- (BMWalletPaymentsCommerceOrderEmailCustomer)initWithJSONDictionary:(id)a3 error:(id *)a4;
- (BOOL)isEqual:(id)a3;
...
@implementation BMWalletPaymentsCommerceOrderEmailCustomer
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    v5 = v4;
    v6 = [(BMWalletPaymentsCommerceOrderEmailCustomer *)self fullName];
    v7 = [v5 fullName];
    v8 = v7;
    if (v6 == v7)
    {
    ...
    {
      v9 = [(BMWalletPaymentsCommerceOrderEmailCustomer *)self fullName];
      v10 = [v5 fullName];
      v11 = [v9 isEqual:v10];
    ...
    v13 = [(BMWalletPaymentsCommerceOrderEmailCustomer *)self phoneNumber];
    v14 = [v5 phoneNumber];
    v15 = v14;
    if (v13 == v14)
    {
    ...
    {
      v16 = [(BMWalletPaymentsCommerceOrderEmailCustomer *)self phoneNumber];
      v17 = [v5 phoneNumber];
      v18 = [v16 isEqual:v17];
    ...
    v19 = [(BMWalletPaymentsCommerceOrderEmailCustomer *)self emailAddress];
    v20 = [v5 emailAddress];
    v21 = v20;
    if (v19 == v20)
    {
    ...
    {
      v22 = [(BMWalletPaymentsCommerceOrderEmailCustomer *)self emailAddress];
      v23 = [v5 emailAddress];
      v24 = [v22 isEqual:v23];
    ...
    v25 = [(BMWalletPaymentsCommerceOrderEmailCustomer *)self billingAddress];
    ...
    {
      v28 = [(BMWalletPaymentsCommerceOrderEmailCustomer *)self billingAddress];
    ...
    v31 = [(BMWalletPaymentsCommerceOrderEmailCustomer *)self givenName];
    v32 = [v5 givenName];
    v33 = v32;
    if (v31 == v32)
    {
    ...
    {
      v34 = [(BMWalletPaymentsCommerceOrderEmailCustomer *)self givenName];
      v35 = [v5 givenName];
      v36 = [v34 isEqual:v35];
...
LABEL_22:
    ...
    v38 = [(BMWalletPaymentsCommerceOrderEmailCustomer *)self familyName];
    v39 = [v5 familyName];
    if (v38 == v39)
    {
      v12 = 1;
    ...
    {
      v40 = [(BMWalletPaymentsCommerceOrderEmailCustomer *)self familyName];
      v41 = [v5 familyName];
      v12 = [v40 isEqual:v41];
    }
...
- (id)jsonDictionary
{
  ...
  v3 = [(BMWalletPaymentsCommerceOrderEmailCustomer *)self fullName];
  v4 = [(BMWalletPaymentsCommerceOrderEmailCustomer *)self phoneNumber];
  v5 = [(BMWalletPaymentsCommerceOrderEmailCustomer *)self emailAddress];
  v6 = [(BMWalletPaymentsCommerceOrderEmailCustomer *)self billingAddress];
  v7 = [v6 jsonDictionary];

  v8 = [(BMWalletPaymentsCommerceOrderEmailCustomer *)self givenName];
  v9 = [(BMWalletPaymentsCommerceOrderEmailCustomer *)self familyName];
  v24[0] = @"fullName";
  v10 = v3;
  if (!v3)
  {
...
LABEL_54:
    ...
    if (!v15 || (objc_opt_class(), (objc_opt_isKindOfClass() & 1) != 0))
    {
      a4 = 0;
LABEL_19:
      v16 = [(BMWalletPaymentsCommerceOrderEmailCustomer *)v57 initWithFullName:v53 phoneNumber:v56 emailAddress:v11 billingAddress:v52 givenName:v14 familyName:a4];
      v57 = v16;
LABEL_49:
...
{
  v3 = objc_opt_new();
  [(BMWalletPaymentsCommerceOrderEmailCustomer *)self writeTo:v3];
  v4 = [v3 immutableData];
...
- (void)writeTo:(id)a3
{
  ...
  if (self->_billingAddress)
  {
    ...
    [(BMWalletPaymentsCommerceOrderEmailAddress *)self->_billingAddress writeTo:v4];
...
- (id)initByReadFrom:(id)a3
{
  v4 = a3;
  v24.receiver = self;
  v24.super_class = BMWalletPaymentsCommerceOrderEmailCustomer;
...
- (NSString)description
{
  ...
  v4 = [(BMWalletPaymentsCommerceOrderEmailCustomer *)self fullName];
  v5 = [(BMWalletPaymentsCommerceOrderEmailCustomer *)self phoneNumber];
  v6 = [(BMWalletPaymentsCommerceOrderEmailCustomer *)self emailAddress];
  v7 = [(BMWalletPaymentsCommerceOrderEmailCustomer *)self billingAddress];
  v8 = [(BMWalletPaymentsCommerceOrderEmailCustomer *)self givenName];
  v9 = [(BMWalletPaymentsCommerceOrderEmailCustomer *)self familyName];
  v10 = [v3 initWithFormat:@"BMWalletPaymentsCommerceOrderEmailCustomer with fullName: %@, phoneNumber: %@, emailAddress: %@, billingAddress: %@, givenName: %@, familyName: %@", v4, v5, v6, v7, v8, v9];
...
- (BMWalletPaymentsCommerceOrderEmailCustomer)initWithFullName:(id)a3 phoneNumber:(id)a4 emailAddress:(id)a5 billingAddress:(id)a6 givenName:(id)a7 familyName:(id)a8
{
  ...
  v17 = a8;
  v23.receiver = self;
  v23.super_class = BMWalletPaymentsCommerceOrderEmailCustomer;
...
+ (id)columns
{
  ...
  v5 = [objc_alloc(MEMORY[0x1E698F2D8]) initWithName:@"billingAddress_json" dataType:5 requestOnly:1 extractBlock:&__block_literal_global_454_92421];
...
id __53__BMWalletPaymentsCommerceOrderEmailCustomer_columns__block_invoke(uint64_t a1, void *a2)
{
...
+ (id)eventWithData:(id)a3 dataVersion:(unsigned int)a4
{
  ...
  else
  {
    ...
    v8 = [[BMWalletPaymentsCommerceOrderEmailCustomer alloc] initByReadFrom:v7];
    v4 = v8;
    if (v8)
    {
      v8[4] = 0;
