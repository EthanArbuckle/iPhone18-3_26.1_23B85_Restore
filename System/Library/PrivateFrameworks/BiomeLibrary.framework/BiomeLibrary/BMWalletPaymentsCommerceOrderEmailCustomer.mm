...
+ (id)protoFields;
- (BMWalletPaymentsCommerceOrderEmailCustomer)initWithFullName:(id)name phoneNumber:(id)number emailAddress:(id)address billingAddress:(id)billingAddress givenName:(id)givenName familyName:(id)familyName;
- (BMWalletPaymentsCommerceOrderEmailCustomer)initWithJSONDictionary:(id)dictionary error:(id *)error;
...
- (BOOL)isEqual:(id)equal
{
  ...
  {
    v5 = equalCopy;
    fullName = [(BMWalletPaymentsCommerceOrderEmailCustomer *)self fullName];
    ...
    {
      fullName3 = [(BMWalletPaymentsCommerceOrderEmailCustomer *)self fullName];
    ...
    phoneNumber = [(BMWalletPaymentsCommerceOrderEmailCustomer *)self phoneNumber];
    ...
    {
      phoneNumber3 = [(BMWalletPaymentsCommerceOrderEmailCustomer *)self phoneNumber];
    ...
    emailAddress = [(BMWalletPaymentsCommerceOrderEmailCustomer *)self emailAddress];
    ...
    {
      emailAddress3 = [(BMWalletPaymentsCommerceOrderEmailCustomer *)self emailAddress];
    ...
    billingAddress = [(BMWalletPaymentsCommerceOrderEmailCustomer *)self billingAddress];
    billingAddress2 = [v5 billingAddress];
    v27 = billingAddress2;
    if (billingAddress == billingAddress2)
    {
    }

    else
    {
      billingAddress3 = [(BMWalletPaymentsCommerceOrderEmailCustomer *)self billingAddress];
      billingAddress4 = [v5 billingAddress];
      v30 = [billingAddress3 isEqual:billingAddress4];
    ...
    givenName = [(BMWalletPaymentsCommerceOrderEmailCustomer *)self givenName];
    ...
    {
      givenName3 = [(BMWalletPaymentsCommerceOrderEmailCustomer *)self givenName];
...
LABEL_22:
    ...
    familyName = [(BMWalletPaymentsCommerceOrderEmailCustomer *)self familyName];
    ...
    {
      familyName3 = [(BMWalletPaymentsCommerceOrderEmailCustomer *)self familyName];
...
LABEL_54:
    ...
    if (!v15 || (objc_opt_class(), (objc_opt_isKindOfClass() & 1) != 0))
    {
      error = 0;
LABEL_19:
      v16 = [(BMWalletPaymentsCommerceOrderEmailCustomer *)selfCopy initWithFullName:v53 phoneNumber:v56 emailAddress:v11 billingAddress:v52 givenName:v14 familyName:error];
      selfCopy = v16;
LABEL_49:
...
- (void)writeTo:(id)to
{
  ...
  if (self->_billingAddress)
  {
    ...
    [(BMWalletPaymentsCommerceOrderEmailAddress *)self->_billingAddress writeTo:toCopy];
...
- (NSString)description
{
  ...
  givenName = [(BMWalletPaymentsCommerceOrderEmailCustomer *)self givenName];
  familyName = [(BMWalletPaymentsCommerceOrderEmailCustomer *)self familyName];
  v10 = [v3 initWithFormat:@"BMWalletPaymentsCommerceOrderEmailCustomer with fullName: %@, phoneNumber: %@, emailAddress: %@, billingAddress: %@, givenName: %@, familyName: %@", fullName, phoneNumber, emailAddress, billingAddress, givenName, familyName];
...
- (BMWalletPaymentsCommerceOrderEmailCustomer)initWithFullName:(id)name phoneNumber:(id)number emailAddress:(id)address billingAddress:(id)billingAddress givenName:(id)givenName familyName:(id)familyName
{
  ...
  if (v18)
  {
    ...
    objc_storeStrong(&v18->_billingAddress, billingAddress);
