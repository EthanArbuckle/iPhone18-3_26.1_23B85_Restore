...
- (id)jsonDictionary
{
  ...
  v4 = [(BMPersonalizedSensingMomentsContextMomentsContextLocationMetaData *)self place];
  v10[0] = @"city";
  v5 = v3;
  if (!v3)
  {
  ...
  if (v9 && (objc_opt_class(), (objc_opt_isKindOfClass() & 1) == 0))
  {
    ...
    if ((objc_opt_isKindOfClass() & 1) == 0)
    {
      if (a4)
      {
        ...
        v19 = [objc_alloc(MEMORY[0x1E696AEC0]) initWithFormat:@"Unexpected type %@ for element of %@, expecting NSString", objc_opt_class(), @"place"];
        v22 = v19;
...
- (NSString)description
{
  ...
  v4 = [(BMPersonalizedSensingMomentsContextMomentsContextLocationMetaData *)self city];
  v5 = [(BMPersonalizedSensingMomentsContextMomentsContextLocationMetaData *)self place];
  v6 = [v3 initWithFormat:@"BMPersonalizedSensingMomentsContextMomentsContextLocationMetaData with city: %@, place: %@", v4, v5];
...
- (BMPersonalizedSensingMomentsContextMomentsContextLocationMetaData)initWithCity:(id)a3 place:(id)a4
{
  ...
  if (v9)
  {
    ...
    objc_storeStrong(&v9->_city, a3);
    objc_storeStrong(&v9->_place, a4);
  }
