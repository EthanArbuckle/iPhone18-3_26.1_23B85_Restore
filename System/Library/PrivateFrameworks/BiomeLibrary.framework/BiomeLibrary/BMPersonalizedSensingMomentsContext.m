...
LABEL_12:
  ...
  if (p_isa)
  {
    ...
    v7 = [objc_alloc(MEMORY[0x1E696AEC0]) initWithFormat:@"Unexpected type %@ for element of %@, expecting NSDictionary", objc_opt_class(), @"personalizedContext"];
    v17[0] = v7;
...
- (id)initByReadFrom:(id)a3
{
  v4 = a3;
  v20.receiver = self;
  v20.super_class = BMPersonalizedSensingMomentsContext;
...
LABEL_16:
      ...
      if ((v14 >> 3) == 1)
      {
        ...
        v15 = [[BMPersonalizedSensingMomentsContextPersonalizedContext alloc] initByReadFrom:v4];
        if (!v15)
        {
          goto LABEL_25;
        }
...
- (NSString)description
{
  ...
  v4 = [(BMPersonalizedSensingMomentsContext *)self personalizedContext];
  v5 = [v3 initWithFormat:@"BMPersonalizedSensingMomentsContext with personalizedContext: %@", v4];
...
- (BMPersonalizedSensingMomentsContext)initWithPersonalizedContext:(id)a3
{
  v5 = a3;
  v8.receiver = self;
  v8.super_class = BMPersonalizedSensingMomentsContext;
  v6 = [(BMEventBase *)&v8 init];
  if (v6)
  {
    v6->_dataVersion = [objc_opt_class() latestDataVersion];
    objc_storeStrong(&v6->_personalizedContext, a3);
  }
...
+ (id)protoFields
{
  ...
  v2 = [objc_alloc(MEMORY[0x1E698F2C8]) initWithName:@"personalizedContext" number:1 type:14 subMessageClass:objc_opt_class()];
  v6[0] = v2;
...
{
  v6[1] = *MEMORY[0x1E69E9840];
  v2 = [objc_alloc(MEMORY[0x1E698F2D8]) initWithName:@"personalizedContext_json" dataType:5 requestOnly:1 extractBlock:&__block_literal_global_592];
  v6[0] = v2;
  v3 = [MEMORY[0x1E695DEC8] arrayWithObjects:v6 count:1];
...
+ (id)eventWithData:(id)a3 dataVersion:(unsigned int)a4
{
  ...
  else
  {
    ...
    v8 = [[BMPersonalizedSensingMomentsContext alloc] initByReadFrom:v7];
    v4 = v8;
    if (v8)
    {
      v8[4] = 0;
