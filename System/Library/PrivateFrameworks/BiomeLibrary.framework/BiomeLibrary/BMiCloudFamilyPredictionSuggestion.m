...
- (BMiCloudFamilyPredictionSuggestion)initWithJSONDictionary:(id)a3 error:(id *)a4
{
  ...
  v6 = a3;
  v7 = [v6 objectForKeyedSubscript:@"heuristicFamilyRelation"];
...
- (NSString)description
{
  ...
  v4 = [(BMiCloudFamilyPredictionSuggestion *)self heuristicFamilyRelation];
  v5 = MEMORY[0x1E696AD98];
  [(BMiCloudFamilyPredictionSuggestion *)self score];
  v6 = [v5 numberWithDouble:?];
  v7 = [v3 initWithFormat:@"BMiCloudFamilyPredictionSuggestion with heuristicFamilyRelation: %@, score: %@", v4, v6];
...
- (BMiCloudFamilyPredictionSuggestion)initWithHeuristicFamilyRelation:(id)a3 score:(id)a4
{
  ...
  if (v9)
  {
    ...
    objc_storeStrong(&v9->_heuristicFamilyRelation, a3);
    if (v8)
    {
      v9->_hasScore = 1;
      [v8 doubleValue];
