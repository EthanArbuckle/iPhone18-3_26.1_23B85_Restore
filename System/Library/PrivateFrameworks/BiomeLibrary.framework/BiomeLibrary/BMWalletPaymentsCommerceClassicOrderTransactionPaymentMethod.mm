...
+ (id)protoFields;
- (BMWalletPaymentsCommerceClassicOrderTransactionPaymentMethod)initWithDisplayName:(id)a3 localizedDisplayName:(id)a4;
- (BMWalletPaymentsCommerceClassicOrderTransactionPaymentMethod)initWithJSONDictionary:(id)a3 error:(id *)a4;
- (BOOL)isEqual:(id)a3;
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    v5 = v4;
    v6 = [(BMWalletPaymentsCommerceClassicOrderTransactionPaymentMethod *)self displayName];
    v7 = [v5 displayName];
    v8 = v7;
    if (v6 == v7)
    {
    ...
    {
      v9 = [(BMWalletPaymentsCommerceClassicOrderTransactionPaymentMethod *)self displayName];
      v10 = [v5 displayName];
      v11 = [v9 isEqual:v10];
...
LABEL_11:
    ...
    v13 = [(BMWalletPaymentsCommerceClassicOrderTransactionPaymentMethod *)self localizedDisplayName];
    v14 = [v5 localizedDisplayName];
    if (v13 == v14)
    {
      v12 = 1;
    }
    ...
    {
      v15 = [(BMWalletPaymentsCommerceClassicOrderTransactionPaymentMethod *)self localizedDisplayName];
      v16 = [v5 localizedDisplayName];
      v12 = [v15 isEqual:v16];
    }
...
- (id)jsonDictionary
{
  ...
  v3 = [(BMWalletPaymentsCommerceClassicOrderTransactionPaymentMethod *)self displayName];
  v4 = [v3 jsonDictionary];

  v5 = [(BMWalletPaymentsCommerceClassicOrderTransactionPaymentMethod *)self localizedDisplayName];
  v11[0] = @"displayName";
  v6 = v4;
  if (!v4)
  {
...
LABEL_4:
    v9 = [v6 objectForKeyedSubscript:@"localizedDisplayName"];
...
LABEL_16:
      ...
      else if ((v14 >> 3) == 1)
      {
        ...
        v15 = [[BMWalletPaymentsCommerceClassicOrderLocalizedString alloc] initByReadFrom:v4];
        if (!v15)
        {
          goto LABEL_27;
        }
...
- (NSString)description
{
  ...
  v4 = [(BMWalletPaymentsCommerceClassicOrderTransactionPaymentMethod *)self displayName];
  v5 = [(BMWalletPaymentsCommerceClassicOrderTransactionPaymentMethod *)self localizedDisplayName];
  v6 = [v3 initWithFormat:@"BMWalletPaymentsCommerceClassicOrderTransactionPaymentMethod with displayName: %@, localizedDisplayName: %@", v4, v5];
...
- (BMWalletPaymentsCommerceClassicOrderTransactionPaymentMethod)initWithDisplayName:(id)a3 localizedDisplayName:(id)a4
{
  ...
  if (v9)
  {
    ...
    objc_storeStrong(&v9->_localizedDisplayName, a4);
  }
