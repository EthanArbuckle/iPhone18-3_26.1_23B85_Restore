...
- (id)jsonDictionary
{
  ...
  v8 = [(BMCustomAttributesBasicValue *)self stringValue];
  v16[0] = @"BOOLValue";
  v9 = v3;
  if (!v3)
  {
...
LABEL_13:
      a4 = v32;
      v15 = [(BMCustomAttributesBasicValue *)v11 initWithBoolValue:v8 int64Value:v32 doubleValue:v12 stringValue:v14];
      v11 = v15;
LABEL_32:
...
- (NSString)description
{
  ...
  v7 = [v6 numberWithDouble:?];
  v8 = [(BMCustomAttributesBasicValue *)self stringValue];
  v9 = [v3 initWithFormat:@"BMCustomAttributesBasicValue with BOOLValue: %@, int64Value: %@, doubleValue: %@, stringValue: %@", v4, v5, v7, v8];
