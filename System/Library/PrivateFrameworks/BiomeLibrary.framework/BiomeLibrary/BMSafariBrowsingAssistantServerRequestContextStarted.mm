...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    v5 = v4;
    v6 = [(BMSafariBrowsingAssistantServerRequestContextStarted *)self requestType];
    v7 = [v5 requestType];
...
- (BMSafariBrowsingAssistantServerRequestContextStarted)initWithJSONDictionary:(id)a3 error:(id *)a4
{
  ...
  v6 = [a3 objectForKeyedSubscript:@"requestType"];
...
LABEL_8:
  ...
  if (a4)
  {
    ...
    v13 = [objc_alloc(MEMORY[0x1E696AEC0]) initWithFormat:@"Unexpected type %@ for element of %@, expecting NSNumber (corresponding to enum value), or NSString (string version of enum)", objc_opt_class(), @"requestType"];
    v16[0] = v13;
