...
LABEL_12:
    ...
    v19 = [(BMPhotosNotification *)self type];
    v12 = v19 == [v5 type];
    goto LABEL_12;
  }
...
- (id)jsonDictionary
{
  ...
  v4 = [(BMPhotosNotification *)self subset];
...
- (NSString)description
{
  ...
  v4 = [(BMPhotosNotification *)self identifier];
  v5 = [(BMPhotosNotification *)self subset];
  v6 = BMPhotosNotificationTypeAsString([(BMPhotosNotification *)self type]);
  v7 = [v3 initWithFormat:@"BMPhotosNotification with identifier: %@, subset: %@, type: %@", v4, v5, v6];
