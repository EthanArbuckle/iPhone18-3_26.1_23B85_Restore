...
+ (id)protoFields;
- (BMMapsNavigation)initWithJSONDictionary:(id)a3 error:(id *)a4;
- (BMMapsNavigation)initWithStarting:(id)a3;
- (BOOL)isEqual:(id)a3;
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (objc_opt_isKindOfClass())
  {
    ...
    if (-[BMMapsNavigation hasStarting](self, "hasStarting") || [v5 hasStarting])
    {
      if (-[BMMapsNavigation hasStarting](self, "hasStarting") && [v5 hasStarting])
      {
        v6 = [(BMMapsNavigation *)self starting];
        v7 = v6 ^ [v5 starting] ^ 1;
      }
...
- (BMMapsNavigation)initWithJSONDictionary:(id)a3 error:(id *)a4
{
  ...
  if (!v6 || (objc_opt_class(), (objc_opt_isKindOfClass() & 1) != 0))
  {
    a4 = 0;
LABEL_4:
    self = [(BMMapsNavigation *)self initWithStarting:a4];
    v7 = self;
    goto LABEL_5;
  }
