...
LABEL_12:
    ...
    v19 = [(BMPhotosFavorite *)self type];
    v12 = v19 == [v5 type];
    goto LABEL_12;
  }
...
- (id)jsonDictionary
{
  ...
  v4 = [(BMPhotosFavorite *)self subset];
...
- (NSString)description
{
  ...
  v4 = [(BMPhotosFavorite *)self identifier];
  v5 = [(BMPhotosFavorite *)self subset];
  v6 = BMPhotosFavoriteTypeAsString([(BMPhotosFavorite *)self type]);
  v7 = [v3 initWithFormat:@"BMPhotosFavorite with identifier: %@, subset: %@, type: %@", v4, v5, v6];
