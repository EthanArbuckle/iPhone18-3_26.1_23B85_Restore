...
LABEL_12:
  ...
  if (objc_opt_isKindOfClass())
  {
    v15 = v10;
    v23 = 0;
    v11 = [[BMDeviceExpertTroubleshootingEntity alloc] initWithJSONDictionary:v15 error:&v23];
    v16 = v23;
    if (v16)
    {
      if (error)
...
id __51__BMDeviceExpertTroubleshootingInteraction_columns__block_invoke(uint64_t a1, void *a2)
{
