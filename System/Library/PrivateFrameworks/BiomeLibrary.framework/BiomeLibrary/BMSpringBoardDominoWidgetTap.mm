...
- (id)jsonDictionary
{
  ...
  v5 = [(BMSpringBoardDominoWidgetTap *)self stackId];
  v11[0] = @"widget";
  v6 = v4;
  if (!v4)
  {
...
LABEL_16:
      ...
      else if ((v14 >> 3) == 1)
      {
        ...
        v15 = [[BMSpringBoardDominoWidget alloc] initByReadFrom:v4];
        if (!v15)
        {
          goto LABEL_27;
        }
...
- (NSString)description
{
  ...
  v4 = [(BMSpringBoardDominoWidgetTap *)self widget];
  v5 = [(BMSpringBoardDominoWidgetTap *)self stackId];
  v6 = [v3 initWithFormat:@"BMSpringBoardDominoWidgetTap with widget: %@, stackId: %@", v4, v5];
...
- (BMSpringBoardDominoWidgetTap)initWithWidget:(id)a3 stackId:(id)a4
{
  ...
  if (v9)
  {
    ...
    objc_storeStrong(&v9->_stackId, a4);
  }
