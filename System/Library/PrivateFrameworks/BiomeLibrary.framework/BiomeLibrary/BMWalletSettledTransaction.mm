...
LABEL_4:
    ...
    if (v22 && (objc_opt_class(), (objc_opt_isKindOfClass() & 1) == 0))
    {
      ...
      if ((objc_opt_isKindOfClass() & 1) == 0)
      {
        if (errorCopy2)
        {
          ...
          *errorCopy2 = [v31 initWithDomain:v30 code:2 userInfo:v27];
        }
    ...
    v17 = -[BMWalletSettledTransaction initWithPassUniqueID:transactionID:merchantType:geoPOICategory:](selfCopy2, "initWithPassUniqueID:transactionID:merchantType:geoPOICategory:", v8, v34, [v13 intValue], v23);
    selfCopy2 = v17;
LABEL_27:
    v7 = v33;
