...
- (BOOL)isEqual:(id)a3
{
  ...
  if (objc_opt_isKindOfClass())
  {
    ...
    if (-[BMSiriUserSamplingId hasValidityDays](self, "hasValidityDays") || [v5 hasValidityDays])
    {
      ...
      v19 = [(BMSiriUserSamplingId *)self validityDays];
    ...
    if (-[BMSiriUserSamplingId hasSwitchedCount](self, "hasSwitchedCount") && [v5 hasSwitchedCount])
    {
      v32 = [(BMSiriUserSamplingId *)self switchedCount];
...
- (id)jsonDictionary
{
  ...
  v5 = [(BMSiriUserSamplingId *)self effectiveFrom];
  if (v5)
  {
    v6 = MEMORY[0x1E696AD98];
    v7 = [(BMSiriUserSamplingId *)self effectiveFrom];
  ...
  if (v10)
  {
    ...
    v12 = [(BMSiriUserSamplingId *)self createdOn];
  ...
  v14 = [(BMSiriUserSamplingId *)self adoptedOn];
  if (v14)
  {
...
- (BMSiriUserSamplingId)initWithJSONDictionary:(id)a3 error:(id *)a4
{
  ...
  v6 = a3;
  v7 = [v6 objectForKeyedSubscript:@"samplingId"];
...
LABEL_40:
    ...
    v22 = [(BMSiriUserSamplingId *)v37 initWithSamplingId:v69 effectiveFrom:v71 validityDays:v70 createdOn:v26 adoptedOn:v38 switchedCount:v47];
    v37 = v22;
LABEL_44:
...
- (NSString)description
{
  ...
  v4 = [(BMSiriUserSamplingId *)self samplingId];
  v5 = [(BMSiriUserSamplingId *)self effectiveFrom];
  v6 = [MEMORY[0x1E696AD98] numberWithUnsignedInt:{-[BMSiriUserSamplingId validityDays](self, "validityDays")}];
  v7 = [(BMSiriUserSamplingId *)self createdOn];
  v8 = [(BMSiriUserSamplingId *)self adoptedOn];
  v9 = [MEMORY[0x1E696AD98] numberWithUnsignedInt:{-[BMSiriUserSamplingId switchedCount](self, "switchedCount")}];
  v10 = [v3 initWithFormat:@"BMSiriUserSamplingId with samplingId: %@, effectiveFrom: %@, validityDays: %@, createdOn: %@, adoptedOn: %@, switchedCount: %@", v4, v5, v6, v7, v8, v9];
