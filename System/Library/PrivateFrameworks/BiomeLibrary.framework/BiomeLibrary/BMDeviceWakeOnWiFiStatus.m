...
- (BOOL)isEqual:(id)a3
{
  ...
  if (objc_opt_isKindOfClass())
  {
    ...
    if (-[BMDeviceWakeOnWiFiStatus hasStarting](self, "hasStarting") || [v5 hasStarting])
    {
      if (-[BMDeviceWakeOnWiFiStatus hasStarting](self, "hasStarting") && [v5 hasStarting])
      {
        v6 = [(BMDeviceWakeOnWiFiStatus *)self starting];
        v7 = v6 ^ [v5 starting] ^ 1;
      }
...
- (id)jsonDictionary
{
  ...
  {
    v3 = [MEMORY[0x1E696AD98] numberWithBool:{-[BMDeviceWakeOnWiFiStatus starting](self, "starting")}];
    v10 = @"starting";
    if (v3)
    {
      v4 = v3;
...
- (id)initByReadFrom:(id)a3
{
  v4 = a3;
  v25.receiver = self;
  v25.super_class = BMDeviceWakeOnWiFiStatus;
...
- (NSString)description
{
  ...
  v4 = [MEMORY[0x1E696AD98] numberWithBool:{-[BMDeviceWakeOnWiFiStatus starting](self, "starting")}];
  v5 = [v3 initWithFormat:@"BMDeviceWakeOnWiFiStatus with starting: %@", v4];
...
- (BMDeviceWakeOnWiFiStatus)initWithStarting:(id)a3
{
  v4 = a3;
  v7.receiver = self;
  v7.super_class = BMDeviceWakeOnWiFiStatus;
