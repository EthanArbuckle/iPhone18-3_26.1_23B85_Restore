...
+ (id)protoFields;
- (BMWatchNearby)initWithJSONDictionary:(id)dictionary error:(id *)error;
- (BMWatchNearby)initWithStarting:(id)starting;
...
- (BOOL)isEqual:(id)equal
{
  ...
  if (objc_opt_isKindOfClass())
  {
    ...
    if (-[BMWatchNearby hasStarting](self, "hasStarting") || [v5 hasStarting])
    {
      if (-[BMWatchNearby hasStarting](self, "hasStarting") && [v5 hasStarting])
      {
        starting = [(BMWatchNearby *)self starting];
...
- (id)jsonDictionary
{
  ...
  {
    v3 = [MEMORY[0x1E696AD98] numberWithBool:{-[BMWatchNearby starting](self, "starting")}];
    v10 = @"starting";
    if (v3)
    {
      v4 = v3;
...
- (BMWatchNearby)initWithJSONDictionary:(id)dictionary error:(id *)error
{
  ...
  if (!v6 || (objc_opt_class(), (objc_opt_isKindOfClass() & 1) != 0))
  {
    error = 0;
LABEL_4:
    self = [(BMWatchNearby *)self initWithStarting:error];
    selfCopy = self;
    goto LABEL_5;
  }
...
- (NSString)description
{
  ...
  v4 = [MEMORY[0x1E696AD98] numberWithBool:{-[BMWatchNearby starting](self, "starting")}];
  v5 = [v3 initWithFormat:@"BMWatchNearby with starting: %@", v4];
