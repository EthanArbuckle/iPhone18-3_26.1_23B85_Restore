...
+ (id)protoFields
{
  ...
  v2 = [objc_alloc(MEMORY[0x1E698F2C8]) initWithName:@"sharedUserId" number:1 type:13 subMessageClass:0];
  v6[0] = v2;
...
{
  v6[1] = *MEMORY[0x1E69E9840];
  v2 = [objc_alloc(MEMORY[0x1E698F2E8]) initWithName:@"sharedUserId" dataType:2 requestOnly:0 fieldNumber:1 protoDataType:13 convertedType:0];
  v6[0] = v2;
  v3 = [MEMORY[0x1E695DEC8] arrayWithObjects:v6 count:1];
