...
- (BOOL)isEqual:(id)a3
{
  ...
  if (objc_opt_isKindOfClass())
  {
    ...
    if (-[BMLocationMicroLocationVisitNumDevicesPerTechnology hasNumDevices](self, "hasNumDevices") && [v5 hasNumDevices])
    {
      v13 = [(BMLocationMicroLocationVisitNumDevicesPerTechnology *)self numDevices];
      v12 = v13 == [v5 numDevices];
LABEL_13:
...
- (BMLocationMicroLocationVisitNumDevicesPerTechnology)initWithJSONDictionary:(id)a3 error:(id *)a4
{
  ...
  v6 = a3;
  v7 = [v6 objectForKeyedSubscript:@"technology"];
...
- (NSString)description
{
  ...
  v4 = [(BMLocationMicroLocationVisitNumDevicesPerTechnology *)self technology];
  v5 = [MEMORY[0x1E696AD98] numberWithInt:{-[BMLocationMicroLocationVisitNumDevicesPerTechnology numDevices](self, "numDevices")}];
  v6 = [v3 initWithFormat:@"BMLocationMicroLocationVisitNumDevicesPerTechnology with technology: %@, numDevices: %@", v4, v5];
...
- (BMLocationMicroLocationVisitNumDevicesPerTechnology)initWithTechnology:(id)a3 numDevices:(id)a4
{
  ...
  if (v9)
  {
    ...
    objc_storeStrong(&v9->_technology, a3);
    if (v8)
    {
      v9->_hasNumDevices = 1;
      v10 = [v8 intValue];
