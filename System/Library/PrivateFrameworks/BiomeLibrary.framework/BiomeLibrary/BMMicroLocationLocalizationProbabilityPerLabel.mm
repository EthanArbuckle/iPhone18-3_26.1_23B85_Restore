...
+ (id)protoFields;
- (BMMicroLocationLocalizationProbabilityPerLabel)initWithJSONDictionary:(id)dictionary error:(id *)error;
- (BMMicroLocationLocalizationProbabilityPerLabel)initWithLabel:(id)label probability:(id)probability;
...
- (BOOL)isEqual:(id)equal
{
  ...
  {
    v5 = equalCopy;
    label = [(BMMicroLocationLocalizationProbabilityPerLabel *)self label];
    label2 = [v5 label];
    v8 = label2;
    if (label == label2)
    {
    ...
    {
      label3 = [(BMMicroLocationLocalizationProbabilityPerLabel *)self label];
      label4 = [v5 label];
...
- (NSString)description
{
  ...
  [(BMMicroLocationLocalizationProbabilityPerLabel *)self probability];
  v6 = [v5 numberWithDouble:?];
  v7 = [v3 initWithFormat:@"BMMicroLocationLocalizationProbabilityPerLabel with label: %@, probability: %@", label, v6];
