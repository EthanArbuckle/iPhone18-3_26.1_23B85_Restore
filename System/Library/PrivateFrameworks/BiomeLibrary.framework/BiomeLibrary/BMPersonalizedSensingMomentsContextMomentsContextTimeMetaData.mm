...
LABEL_4:
  ...
  if (a4)
  {
    ...
    v12 = [objc_alloc(MEMORY[0x1E696AEC0]) initWithFormat:@"Unexpected type %@ for element of %@, expecting NSString", objc_opt_class(), @"timeReference"];
    v15[0] = v12;
...
- (NSString)description
{
  ...
  v4 = [(BMPersonalizedSensingMomentsContextMomentsContextTimeMetaData *)self timeReference];
  v5 = [v3 initWithFormat:@"BMPersonalizedSensingMomentsContextMomentsContextTimeMetaData with timeReference: %@", v4];
...
- (BMPersonalizedSensingMomentsContextMomentsContextTimeMetaData)initWithTimeReference:(id)a3
{
  ...
  if (v6)
  {
    ...
    objc_storeStrong(&v6->_timeReference, a3);
  }
