...
- (BOOL)isEqual:(id)a3
{
  ...
  if (objc_opt_isKindOfClass())
  {
    ...
    v13 = [(BMMediaRouteOutputDeviceClusterMember *)self type];
    if (v13 == [v5 type])
    {
      v14 = [(BMMediaRouteOutputDeviceClusterMember *)self subType];
      v12 = v14 == [v5 subType];
LABEL_10:
...
- (NSString)description
{
  ...
  v4 = [(BMMediaRouteOutputDeviceClusterMember *)self outputDeviceID];
  ...
  v7 = [v3 initWithFormat:@"BMMediaRouteOutputDeviceClusterMember with outputDeviceID: %@, type: %@, subType: %@", v4, v5, v6];
...
- (BMMediaRouteOutputDeviceClusterMember)initWithOutputDeviceID:(id)a3 type:(int)a4 subType:(int)a5
{
  ...
  if (v10)
  {
    ...
    objc_storeStrong(&v10->_outputDeviceID, a3);
    v10->_type = a4;
    v10->_subType = a5;
  }
