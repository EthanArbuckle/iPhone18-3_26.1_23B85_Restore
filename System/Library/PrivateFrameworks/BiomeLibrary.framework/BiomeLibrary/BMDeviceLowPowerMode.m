...
- (BOOL)isEqual:(id)a3
{
  ...
  if (objc_opt_isKindOfClass())
  {
    ...
    if (-[BMDeviceLowPowerMode hasStarting](self, "hasStarting") || [v5 hasStarting])
    {
      if (-[BMDeviceLowPowerMode hasStarting](self, "hasStarting") && [v5 hasStarting])
      {
        v6 = [(BMDeviceLowPowerMode *)self starting];
        v7 = v6 ^ [v5 starting] ^ 1;
      }
...
- (id)jsonDictionary
{
  ...
  {
    v3 = [MEMORY[0x1E696AD98] numberWithBool:{-[BMDeviceLowPowerMode starting](self, "starting")}];
    v10 = @"starting";
    if (v3)
    {
      v4 = v3;
...
- (id)initByReadFrom:(id)a3
{
  v4 = a3;
  v25.receiver = self;
  v25.super_class = BMDeviceLowPowerMode;
...
- (NSString)description
{
  ...
  v4 = [MEMORY[0x1E696AD98] numberWithBool:{-[BMDeviceLowPowerMode starting](self, "starting")}];
  v5 = [v3 initWithFormat:@"BMDeviceLowPowerMode with starting: %@", v4];
...
- (BMDeviceLowPowerMode)initWithStarting:(id)a3
{
  v4 = a3;
  v7.receiver = self;
  v7.super_class = BMDeviceLowPowerMode;
