...
- (BOOL)isEqual:(id)a3
{
  ...
  if (objc_opt_isKindOfClass())
  {
    ...
    if (-[BMSiriOnDeviceDigestExperimentMetricsEventMetadata hasEventTimestampInMSSince1970](self, "hasEventTimestampInMSSince1970") || [v5 hasEventTimestampInMSSince1970])
    {
      ...
      v25 = [(BMSiriOnDeviceDigestExperimentMetricsEventMetadata *)self eventTimestampInMSSince1970];
    ...
    if (!-[BMSiriOnDeviceDigestExperimentMetricsEventMetadata hasUserAggregationIdRotationTimestampInMs](self, "hasUserAggregationIdRotationTimestampInMs") && ![v5 hasUserAggregationIdRotationTimestampInMs] || -[BMSiriOnDeviceDigestExperimentMetricsEventMetadata hasUserAggregationIdRotationTimestampInMs](self, "hasUserAggregationIdRotationTimestampInMs") && objc_msgSend(v5, "hasUserAggregationIdRotationTimestampInMs") && (v32 = -[BMSiriOnDeviceDigestExperimentMetricsEventMetadata userAggregationIdRotationTimestampInMs](self, "userAggregationIdRotationTimestampInMs"), v32 == objc_msgSend(v5, "userAggregationIdRotationTimestampInMs")))
    {
      ...
      if (-[BMSiriOnDeviceDigestExperimentMetricsEventMetadata hasUserAggregationIdExpirationTimestampInMs](self, "hasUserAggregationIdExpirationTimestampInMs") && [v5 hasUserAggregationIdExpirationTimestampInMs])
      {
        v33 = [(BMSiriOnDeviceDigestExperimentMetricsEventMetadata *)self userAggregationIdExpirationTimestampInMs];
...
- (id)jsonDictionary
{
  ...
  v3 = [(BMSiriOnDeviceDigestExperimentMetricsEventMetadata *)self oddIdUUID];
  v4 = [(BMSiriOnDeviceDigestExperimentMetricsEventMetadata *)self deviceAggregationId];
  v5 = [(BMSiriOnDeviceDigestExperimentMetricsEventMetadata *)self userAggregationId];
  if ([(BMSiriOnDeviceDigestExperimentMetricsEventMetadata *)self hasEventTimestampInMSSince1970])
  {
...
LABEL_29:
    ...
    v21 = [(BMSiriOnDeviceDigestExperimentMetricsEventMetadata *)v17 initWithOddIdUUID:v64 deviceAggregationId:v61 userAggregationId:v67 eventTimestampInMSSince1970:v69 timeInterval:v65 userAggregationIdRotationTimestampInMs:v18 userAggregationIdExpirationTimestampInMs:v20];
    v17 = v21;
LABEL_23:
...
LABEL_75:
        ...
        v16 = [[BMSiriOnDeviceDigestExperimentMetricsEventMetadataTimeInterval alloc] initByReadFrom:v4];
        if (!v16)
        {
          goto LABEL_78;
        }
...
- (NSString)description
{
  ...
  v4 = [(BMSiriOnDeviceDigestExperimentMetricsEventMetadata *)self oddIdUUID];
  v5 = [(BMSiriOnDeviceDigestExperimentMetricsEventMetadata *)self deviceAggregationId];
  v6 = [(BMSiriOnDeviceDigestExperimentMetricsEventMetadata *)self userAggregationId];
  ...
  v8 = [(BMSiriOnDeviceDigestExperimentMetricsEventMetadata *)self timeInterval];
  ...
  v11 = [v3 initWithFormat:@"BMSiriOnDeviceDigestExperimentMetricsEventMetadata with oddIdUUID: %@, deviceAggregationId: %@, userAggregationId: %@, eventTimestampInMSSince1970: %@, timeInterval: %@, userAggregationIdRotationTimestampInMs: %@, userAggregationIdExpirationTimestampInMs: %@", v4, v5, v6, v7, v8, v9, v10];
