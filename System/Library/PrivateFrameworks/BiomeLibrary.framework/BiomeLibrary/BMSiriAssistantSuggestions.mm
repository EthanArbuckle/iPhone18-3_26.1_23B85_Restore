...
+ (id)protoFields;
- (BMSiriAssistantSuggestions)initWithInteraction:(id)interaction entities:(id)entities;
- (BMSiriAssistantSuggestions)initWithJSONDictionary:(id)dictionary error:(id *)error;
...
- (BOOL)isEqual:(id)equal
{
  ...
  {
    v5 = equalCopy;
    interaction = [(BMSiriAssistantSuggestions *)self interaction];
    ...
    {
      interaction3 = [(BMSiriAssistantSuggestions *)self interaction];
...
LABEL_11:
    ...
    entities = [(BMSiriAssistantSuggestions *)self entities];
    ...
    {
      entities3 = [(BMSiriAssistantSuggestions *)self entities];
...
- (id)jsonDictionary
{
  ...
  _entitiesJSONArray = [(BMSiriAssistantSuggestions *)self _entitiesJSONArray];
  v11[0] = @"interaction";
  null = jsonDictionary;
  if (!jsonDictionary)
  {
...
- (NSString)description
{
  ...
  interaction = [(BMSiriAssistantSuggestions *)self interaction];
  entities = [(BMSiriAssistantSuggestions *)self entities];
  v6 = [v3 initWithFormat:@"BMSiriAssistantSuggestions with interaction: %@, entities: %@", interaction, entities];
