...
- (BOOL)isEqual:(id)a3
{
  ...
  if (objc_opt_isKindOfClass())
  {
    ...
    if (-[BMDeviceWiFiAvailabilityStatus hasStarting](self, "hasStarting") || [v5 hasStarting])
    {
      ...
      v6 = [(BMDeviceWiFiAvailabilityStatus *)self starting];
      if (v6 != [v5 starting])
      {
        goto LABEL_18;
      }
    ...
    if (-[BMDeviceWiFiAvailabilityStatus hasIsWiFiSwitchOn](self, "hasIsWiFiSwitchOn") || [v5 hasIsWiFiSwitchOn])
    {
      ...
      v7 = [(BMDeviceWiFiAvailabilityStatus *)self isWiFiSwitchOn];
    ...
    if (-[BMDeviceWiFiAvailabilityStatus hasQuality](self, "hasQuality") && [v5 hasQuality])
    {
      v8 = [(BMDeviceWiFiAvailabilityStatus *)self quality];
      v9 = v8 == [v5 quality];
    }
...
- (BMDeviceWiFiAvailabilityStatus)initWithJSONDictionary:(id)a3 error:(id *)a4
{
  ...
  if (!v7 || (objc_opt_class(), (objc_opt_isKindOfClass() & 1) != 0))
  {
    v8 = 0;
LABEL_4:
    v9 = [v6 objectForKeyedSubscript:@"isWiFiSwitchOn"];
