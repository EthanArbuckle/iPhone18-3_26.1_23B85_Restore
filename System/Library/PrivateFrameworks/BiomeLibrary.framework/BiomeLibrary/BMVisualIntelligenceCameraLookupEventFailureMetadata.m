...
+ (id)protoFields;
- (BMVisualIntelligenceCameraLookupEventFailureMetadata)initWithFailureReason:(int)a3 httpErrorCode:(id)a4;
- (BMVisualIntelligenceCameraLookupEventFailureMetadata)initWithJSONDictionary:(id)a3 error:(id *)a4;
- (BOOL)isEqual:(id)a3;
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    v5 = v4;
    v6 = [(BMVisualIntelligenceCameraLookupEventFailureMetadata *)self failureReason];
    if (v6 != [v5 failureReason])
    {
      goto LABEL_9;
    }
    ...
    if (-[BMVisualIntelligenceCameraLookupEventFailureMetadata hasHttpErrorCode](self, "hasHttpErrorCode") && [v5 hasHttpErrorCode])
    {
      v7 = [(BMVisualIntelligenceCameraLookupEventFailureMetadata *)self httpErrorCode];
      v8 = v7 == [v5 httpErrorCode];
    }
...
- (BMVisualIntelligenceCameraLookupEventFailureMetadata)initWithJSONDictionary:(id)a3 error:(id *)a4
{
  ...
  v6 = a3;
  v7 = [v6 objectForKeyedSubscript:@"failureReason"];
  ...
  v10 = [v6 objectForKeyedSubscript:@"httpErrorCode"];
