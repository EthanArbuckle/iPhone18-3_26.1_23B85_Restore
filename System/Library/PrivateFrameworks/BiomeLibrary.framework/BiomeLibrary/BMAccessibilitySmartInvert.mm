...
+ (id)protoFields;
- (BMAccessibilitySmartInvert)initWithJSONDictionary:(id)dictionary error:(id *)error;
- (BMAccessibilitySmartInvert)initWithStarting:(id)starting;
...
- (BOOL)isEqual:(id)equal
{
  ...
  if (objc_opt_isKindOfClass())
  {
    ...
    if (-[BMAccessibilitySmartInvert hasStarting](self, "hasStarting") || [v5 hasStarting])
    {
      if (-[BMAccessibilitySmartInvert hasStarting](self, "hasStarting") && [v5 hasStarting])
      {
        starting = [(BMAccessibilitySmartInvert *)self starting];
...
- (id)jsonDictionary
{
  ...
  {
    v3 = [MEMORY[0x1E696AD98] numberWithBool:{-[BMAccessibilitySmartInvert starting](self, "starting")}];
    v10 = @"starting";
    if (v3)
    {
      v4 = v3;
...
- (BMAccessibilitySmartInvert)initWithJSONDictionary:(id)dictionary error:(id *)error
{
  ...
  if (!v6 || (objc_opt_class(), (objc_opt_isKindOfClass() & 1) != 0))
  {
    error = 0;
LABEL_4:
    self = [(BMAccessibilitySmartInvert *)self initWithStarting:error];
    selfCopy = self;
    goto LABEL_5;
  }
...
- (id)initByReadFrom:(id)from
{
  fromCopy = from;
  v25.receiver = self;
  v25.super_class = BMAccessibilitySmartInvert;
...
- (NSString)description
{
  ...
  v4 = [MEMORY[0x1E696AD98] numberWithBool:{-[BMAccessibilitySmartInvert starting](self, "starting")}];
  v5 = [v3 initWithFormat:@"BMAccessibilitySmartInvert with starting: %@", v4];
...
- (BMAccessibilitySmartInvert)initWithStarting:(id)starting
{
  ...
  v7.receiver = self;
  v7.super_class = BMAccessibilitySmartInvert;
