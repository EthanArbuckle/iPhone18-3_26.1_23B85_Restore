...
+ (id)columns
{
  ...
  v2 = [objc_alloc(MEMORY[0x1E698F2D8]) initWithName:@"interaction_json" dataType:5 requestOnly:1 extractBlock:&__block_literal_global_17287];
  v3 = [objc_alloc(MEMORY[0x1E698F2D8]) initWithName:@"entities_json" dataType:5 requestOnly:1 extractBlock:&__block_literal_global_35];
  v7[0] = v2;
  v7[1] = v3;
...
- (id)jsonDictionary
{
  ...
  v5 = [(BMSiriMessageHistory *)self _entitiesJSONArray];
  v11[0] = @"interaction";
  v6 = v4;
  if (!v4)
  {
...
- (id)_entitiesJSONArray
{
  ...
  v14 = 0u;
  v15 = 0u;
  v4 = [(BMSiriMessageHistory *)self entities];
...
LABEL_19:
  ...
  v8 = v40;
  self = [(BMSiriMessageHistory *)self initWithInteraction:v40 entities:v12];
  v22 = self;
  v7 = v41;
  v6 = v42;
LABEL_36:
...
- (id)initByReadFrom:(id)a3
{
  v4 = a3;
  v26.receiver = self;
  v26.super_class = BMSiriMessageHistory;
...
- (NSString)description
{
  ...
  v4 = [(BMSiriMessageHistory *)self interaction];
  v5 = [(BMSiriMessageHistory *)self entities];
  v6 = [v3 initWithFormat:@"BMSiriMessageHistory with interaction: %@, entities: %@", v4, v5];
...
- (BMSiriMessageHistory)initWithInteraction:(id)a3 entities:(id)a4
{
  ...
  v8 = a4;
  v11.receiver = self;
  v11.super_class = BMSiriMessageHistory;
...
+ (id)eventWithData:(id)a3 dataVersion:(unsigned int)a4
{
  ...
  else
  {
    ...
    v8 = [[BMSiriMessageHistory alloc] initByReadFrom:v7];
    v4 = v8;
    if (v8)
    {
      v8[4] = 0;
