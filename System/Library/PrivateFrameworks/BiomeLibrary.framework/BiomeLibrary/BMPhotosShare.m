...
- (NSString)description
{
  ...
  v4 = [(BMPhotosShare *)self identifier];
  v5 = [(BMPhotosShare *)self subset];
  v6 = BMPhotosShareTypeAsString([(BMPhotosShare *)self type]);
  v7 = [v3 initWithFormat:@"BMPhotosShare with identifier: %@, subset: %@, type: %@", v4, v5, v6];
