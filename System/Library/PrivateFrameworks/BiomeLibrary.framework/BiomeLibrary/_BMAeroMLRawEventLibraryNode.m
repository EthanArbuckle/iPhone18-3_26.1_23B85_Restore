...
+ (id)PhotosSearchSession
{
  ...
  v2 = [a1 configurationForPhotosSearchSession];
  ...
  v10 = [objc_alloc(MEMORY[0x1E698F320]) initWithIdentifier:@"AeroML.RawEvent.PhotosSearchSession" schema:v9 configuration:v2];
