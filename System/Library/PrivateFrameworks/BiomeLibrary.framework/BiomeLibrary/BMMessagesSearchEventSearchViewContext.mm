...
+ (id)protoFields;
- (BMMessagesSearchEventSearchViewContext)initWithJSONDictionary:(id)a3 error:(id *)a4;
- (BMMessagesSearchEventSearchViewContext)initWithMillisecondsSinceSessionStarted:(id)a3 sessionId:(id)a4 queryId:(id)a5 appeared:(id)a6 disappeared:(id)a7;
- (BOOL)isEqual:(id)a3;
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (objc_opt_isKindOfClass())
  {
    ...
    if (-[BMMessagesSearchEventSearchViewContext hasMillisecondsSinceSessionStarted](self, "hasMillisecondsSinceSessionStarted") || [v5 hasMillisecondsSinceSessionStarted])
    {
      ...
      v6 = [(BMMessagesSearchEventSearchViewContext *)self millisecondsSinceSessionStarted];
    ...
    v7 = [(BMMessagesSearchEventSearchViewContext *)self sessionId];
    v8 = [v5 sessionId];
    v9 = v8;
    if (v7 == v8)
    {
    ...
    {
      v10 = [(BMMessagesSearchEventSearchViewContext *)self sessionId];
      v11 = [v5 sessionId];
      v12 = [v10 isEqual:v11];
    ...
    v14 = [(BMMessagesSearchEventSearchViewContext *)self queryId];
    v15 = [v5 queryId];
    v16 = v15;
    if (v14 == v15)
    {
    ...
    {
      v17 = [(BMMessagesSearchEventSearchViewContext *)self queryId];
      v18 = [v5 queryId];
      v19 = [v17 isEqual:v18];
    ...
    v20 = [(BMMessagesSearchEventSearchViewContext *)self appeared];
    v21 = [v5 appeared];
    v22 = v21;
    if (v20 == v21)
    {
    ...
    {
      v23 = [(BMMessagesSearchEventSearchViewContext *)self appeared];
      v24 = [v5 appeared];
      v25 = [v23 isEqual:v24];
...
LABEL_19:
    ...
    v27 = [(BMMessagesSearchEventSearchViewContext *)self disappeared];
    v28 = [v5 disappeared];
    if (v27 == v28)
    {
      v13 = 1;
    ...
    {
      v29 = [(BMMessagesSearchEventSearchViewContext *)self disappeared];
      v30 = [v5 disappeared];
      v13 = [v29 isEqual:v30];
    }
...
- (id)jsonDictionary
{
  ...
  v4 = [(BMMessagesSearchEventSearchViewContext *)self sessionId];
  v5 = [(BMMessagesSearchEventSearchViewContext *)self queryId];
  v6 = [(BMMessagesSearchEventSearchViewContext *)self appeared];
  v7 = [v6 jsonDictionary];

  v8 = [(BMMessagesSearchEventSearchViewContext *)self disappeared];
...
- (void)writeTo:(id)a3
{
  ...
  if (self->_appeared)
  {
    ...
    [(BMMessagesSearchEventSearchViewAppeared *)self->_appeared writeTo:v4];
  ...
  {
    PBDataWriterPlaceMark();
    [(BMMessagesSearchEventSearchViewDisappeared *)self->_disappeared writeTo:v4];
    PBDataWriterRecallMark();
  }
}
...
LABEL_29:
        ...
        case 4:
          ...
          v16 = [[BMMessagesSearchEventSearchViewAppeared alloc] initByReadFrom:v4];
          if (!v16)
          {
            goto LABEL_51;
          }
        ...
        case 5:
          ...
          v16 = [[BMMessagesSearchEventSearchViewDisappeared alloc] initByReadFrom:v4];
          if (!v16)
          {
            goto LABEL_51;
          }
...
- (NSString)description
{
  ...
  v5 = [(BMMessagesSearchEventSearchViewContext *)self sessionId];
  v6 = [(BMMessagesSearchEventSearchViewContext *)self queryId];
  v7 = [(BMMessagesSearchEventSearchViewContext *)self appeared];
  v8 = [(BMMessagesSearchEventSearchViewContext *)self disappeared];
  v9 = [v3 initWithFormat:@"BMMessagesSearchEventSearchViewContext with millisecondsSinceSessionStarted: %@, sessionId: %@, queryId: %@, appeared: %@, disappeared: %@", v4, v5, v6, v7, v8];
