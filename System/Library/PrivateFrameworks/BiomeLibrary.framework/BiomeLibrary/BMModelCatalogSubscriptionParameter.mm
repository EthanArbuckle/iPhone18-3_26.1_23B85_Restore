...
+ (id)protoFields;
- (BMModelCatalogSubscriptionParameter)initWithJSONDictionary:(id)dictionary error:(id *)error;
- (BMModelCatalogSubscriptionParameter)initWithName:(id)name value:(id)value;
...
- (BOOL)isEqual:(id)equal
{
  ...
  {
    v5 = equalCopy;
    name = [(BMModelCatalogSubscriptionParameter *)self name];
    name2 = [v5 name];
    v8 = name2;
    if (name == name2)
    {
    ...
    {
      name3 = [(BMModelCatalogSubscriptionParameter *)self name];
      name4 = [v5 name];
...
LABEL_11:
    ...
    value = [(BMModelCatalogSubscriptionParameter *)self value];
    value2 = [v5 value];
    if (value == value2)
    {
      v12 = 1;
    ...
    {
      value3 = [(BMModelCatalogSubscriptionParameter *)self value];
      value4 = [v5 value];
...
- (NSString)description
{
  ...
  name = [(BMModelCatalogSubscriptionParameter *)self name];
  value = [(BMModelCatalogSubscriptionParameter *)self value];
  v6 = [v3 initWithFormat:@"BMModelCatalogSubscriptionParameter with name: %@, value: %@", name, value];
