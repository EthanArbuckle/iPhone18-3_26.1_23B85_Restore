...
LABEL_13:
  ...
  if (objc_opt_isKindOfClass())
  {
    v8 = v6;
    v15 = 0;
    v7 = [[BMOasisAnalyticsGazeMotionClassifierPayload alloc] initWithJSONDictionary:v8 error:&v15];
    v9 = v15;
    if (!v9)
    {
...
id __47__BMOasisAnalyticsGazeMotionClassifier_columns__block_invoke(uint64_t a1, void *a2)
{
