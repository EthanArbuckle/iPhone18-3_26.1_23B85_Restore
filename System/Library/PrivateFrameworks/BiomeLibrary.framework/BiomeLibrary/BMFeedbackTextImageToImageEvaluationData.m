...
- (id)jsonDictionary
{
  ...
  v5 = [(BMFeedbackTextImageToImageEvaluationData *)self originalContent];
  v6 = [v5 jsonDictionary];

  v7 = [(BMFeedbackTextImageToImageEvaluationData *)self generatedContent];
...
LABEL_16:
      ...
      else if (v15 == 2)
      {
        ...
        v16 = [[BMTextImageContent alloc] initByReadFrom:v4];
        if (!v16)
        {
          goto LABEL_34;
        }
...
- (NSString)description
{
  ...
  v4 = [(BMFeedbackTextImageToImageEvaluationData *)self commonMetadata];
  v5 = [(BMFeedbackTextImageToImageEvaluationData *)self originalContent];
  v6 = [(BMFeedbackTextImageToImageEvaluationData *)self generatedContent];
  v7 = [v3 initWithFormat:@"BMFeedbackTextImageToImageEvaluationData with commonMetadata: %@, originalContent: %@, generatedContent: %@", v4, v5, v6];
