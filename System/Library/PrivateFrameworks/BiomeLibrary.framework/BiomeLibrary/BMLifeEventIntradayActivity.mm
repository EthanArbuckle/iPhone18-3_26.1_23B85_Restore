...
+ (id)protoFields;
- (BMLifeEventIntradayActivity)initWithActivity:(id)activity;
- (BMLifeEventIntradayActivity)initWithJSONDictionary:(id)dictionary error:(id *)p_isa;
...
+ (id)columns
{
  ...
  v2 = [objc_alloc(MEMORY[0x1E698F2D8]) initWithName:@"activity_json" dataType:5 requestOnly:1 extractBlock:&__block_literal_global_33909];
  v6[0] = v2;
...
- (BOOL)isEqual:(id)equal
{
  ...
  {
    v5 = equalCopy;
    activity = [(BMLifeEventIntradayActivity *)self activity];
    ...
    {
      activity3 = [(BMLifeEventIntradayActivity *)self activity];
...
- (id)initByReadFrom:(id)from
{
  fromCopy = from;
  v20.receiver = self;
  v20.super_class = BMLifeEventIntradayActivity;
...
- (NSString)description
{
  ...
  activity = [(BMLifeEventIntradayActivity *)self activity];
  v5 = [v3 initWithFormat:@"BMLifeEventIntradayActivity with activity: %@", activity];
...
- (BMLifeEventIntradayActivity)initWithActivity:(id)activity
{
  ...
  v8.receiver = self;
  v8.super_class = BMLifeEventIntradayActivity;
