...
- (id)jsonDictionary
{
  ...
  v5 = [(BMOasisAnalyticsTrackingLostEvent *)self metadata];
  v6 = [v5 jsonDictionary];

  v7 = [(BMOasisAnalyticsTrackingLostEvent *)self payload];
...
LABEL_16:
      ...
      else if (v15 == 2)
      {
        ...
        v16 = [[BMOasisAnalyticsTrackingLostType alloc] initByReadFrom:v4];
        if (!v16)
        {
          goto LABEL_34;
        }
...
- (NSString)description
{
  ...
  v4 = [(BMOasisAnalyticsTrackingLostEvent *)self qualityTrace];
  v5 = [(BMOasisAnalyticsTrackingLostEvent *)self metadata];
  v6 = [(BMOasisAnalyticsTrackingLostEvent *)self payload];
  v7 = [v3 initWithFormat:@"BMOasisAnalyticsTrackingLostEvent with qualityTrace: %@, metadata: %@, payload: %@", v4, v5, v6];
