...
- (BOOL)isEqual:(id)a3
{
  ...
  if (objc_opt_isKindOfClass())
  {
    ...
    if (-[BMSiriRequestCountsStatistics hasAllRequestCount](self, "hasAllRequestCount") || [v5 hasAllRequestCount])
    {
      ...
      v6 = [(BMSiriRequestCountsStatistics *)self allRequestCount];
    ...
    if (-[BMSiriRequestCountsStatistics hasUserRequestCount](self, "hasUserRequestCount") && [v5 hasUserRequestCount])
    {
      v7 = [(BMSiriRequestCountsStatistics *)self userRequestCount];
      v8 = v7 == [v5 userRequestCount];
    }
...
- (BMSiriRequestCountsStatistics)initWithJSONDictionary:(id)a3 error:(id *)a4
{
  ...
  v6 = a3;
  v7 = [v6 objectForKeyedSubscript:@"allRequestCount"];
  ...
  if (v9 && (objc_opt_class(), (objc_opt_isKindOfClass() & 1) == 0))
  {
    ...
    if ((objc_opt_isKindOfClass() & 1) == 0)
    {
      if (a4)
      {
        ...
        v19 = [objc_alloc(MEMORY[0x1E696AEC0]) initWithFormat:@"Unexpected type %@ for element of %@, expecting NSNumber", objc_opt_class(), @"userRequestCount"];
        v22 = v19;
