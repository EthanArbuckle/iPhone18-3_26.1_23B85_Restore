...
- (NSString)description
{
  ...
  v4 = [(BMPhotosMap *)self identifier];
  v5 = [(BMPhotosMap *)self subset];
  v6 = BMPhotosMapTypeAsString([(BMPhotosMap *)self type]);
  v7 = [v3 initWithFormat:@"BMPhotosMap with identifier: %@, subset: %@, type: %@", v4, v5, v6];
