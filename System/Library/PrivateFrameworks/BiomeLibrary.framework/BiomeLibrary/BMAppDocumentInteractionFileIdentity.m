...
+ (id)protoFields;
- (BMAppDocumentInteractionFileIdentity)initWithItemURL:(id)a3 itemURLBookmarkData:(id)a4;
- (BMAppDocumentInteractionFileIdentity)initWithJSONDictionary:(id)a3 error:(id *)a4;
- (BOOL)isEqual:(id)a3;
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    v5 = v4;
    v6 = [(BMAppDocumentInteractionFileIdentity *)self itemURL];
    v7 = [v5 itemURL];
    v8 = v7;
    if (v6 == v7)
    {
    ...
    {
      v9 = [(BMAppDocumentInteractionFileIdentity *)self itemURL];
      v10 = [v5 itemURL];
      v11 = [v9 isEqual:v10];
...
LABEL_11:
    ...
    v13 = [(BMAppDocumentInteractionFileIdentity *)self itemURLBookmarkData];
    v14 = [v5 itemURLBookmarkData];
    if (v13 == v14)
    {
      v12 = 1;
    }
    ...
    {
      v15 = [(BMAppDocumentInteractionFileIdentity *)self itemURLBookmarkData];
      v16 = [v5 itemURLBookmarkData];
      v12 = [v15 isEqual:v16];
    }
...
- (id)jsonDictionary
{
  ...
  v3 = [(BMAppDocumentInteractionFileIdentity *)self itemURL];
  v4 = [(BMAppDocumentInteractionFileIdentity *)self itemURLBookmarkData];
...
- (BMAppDocumentInteractionFileIdentity)initWithJSONDictionary:(id)a3 error:(id *)a4
{
  ...
  v6 = a3;
  v7 = [v6 objectForKeyedSubscript:@"itemURL"];
  if (!v7 || (objc_opt_class(), (objc_opt_isKindOfClass() & 1) != 0))
  {
    v8 = 0;
LABEL_4:
    v9 = [v6 objectForKeyedSubscript:@"itemURLBookmarkData"];
...
- (NSString)description
{
  ...
  v4 = [(BMAppDocumentInteractionFileIdentity *)self itemURL];
  v5 = [(BMAppDocumentInteractionFileIdentity *)self itemURLBookmarkData];
  v6 = [v3 initWithFormat:@"BMAppDocumentInteractionFileIdentity with itemURL: %@, itemURLBookmarkData: %@", v4, v5];
...
- (BMAppDocumentInteractionFileIdentity)initWithItemURL:(id)a3 itemURLBookmarkData:(id)a4
{
  ...
  if (v9)
  {
    ...
    objc_storeStrong(&v9->_itemURL, a3);
    objc_storeStrong(&v9->_itemURLBookmarkData, a4);
  }
