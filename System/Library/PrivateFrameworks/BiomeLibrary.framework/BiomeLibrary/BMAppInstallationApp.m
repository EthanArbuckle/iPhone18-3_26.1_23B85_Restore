...
+ (id)protoFields;
- (BMAppInstallationApp)initWithBundleID:(id)a3 personaString:(id)a4 isPlaceholder:(id)a5;
- (BMAppInstallationApp)initWithJSONDictionary:(id)a3 error:(id *)a4;
- (BOOL)isEqual:(id)a3;
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    v5 = v4;
    v6 = [(BMAppInstallationApp *)self bundleID];
    v7 = [v5 bundleID];
    v8 = v7;
    if (v6 == v7)
    {
    ...
    {
      v9 = [(BMAppInstallationApp *)self bundleID];
      v10 = [v5 bundleID];
      v11 = [v9 isEqual:v10];
    ...
    v13 = [(BMAppInstallationApp *)self personaString];
    v14 = [v5 personaString];
    v15 = v14;
    if (v13 == v14)
    {
    }
    ...
    {
      v16 = [(BMAppInstallationApp *)self personaString];
      v17 = [v5 personaString];
      v18 = [v16 isEqual:v17];
    ...
    if (-[BMAppInstallationApp hasIsPlaceholder](self, "hasIsPlaceholder") && [v5 hasIsPlaceholder])
    {
      v19 = [(BMAppInstallationApp *)self isPlaceholder];
      v12 = v19 ^ [v5 isPlaceholder] ^ 1;
LABEL_17:
...
- (id)jsonDictionary
{
  ...
  v3 = [(BMAppInstallationApp *)self bundleID];
  v4 = [(BMAppInstallationApp *)self personaString];
...
- (BMAppInstallationApp)initWithJSONDictionary:(id)a3 error:(id *)a4
{
  ...
  if (!v7 || (objc_opt_class(), (objc_opt_isKindOfClass() & 1) != 0))
  {
    v8 = 0;
LABEL_4:
    v9 = [v6 objectForKeyedSubscript:@"personaString"];
    ...
    v11 = [v6 objectForKeyedSubscript:@"isPlaceholder"];
...
- (NSString)description
{
  ...
  v4 = [(BMAppInstallationApp *)self bundleID];
  v5 = [(BMAppInstallationApp *)self personaString];
  v6 = [MEMORY[0x1E696AD98] numberWithBool:{-[BMAppInstallationApp isPlaceholder](self, "isPlaceholder")}];
  v7 = [v3 initWithFormat:@"BMAppInstallationApp with bundleID: %@, personaString: %@, isPlaceholder: %@", v4, v5, v6];
...
- (BMAppInstallationApp)initWithBundleID:(id)a3 personaString:(id)a4 isPlaceholder:(id)a5
{
  ...
  if (v12)
  {
    ...
    objc_storeStrong(&v12->_personaString, a4);
    if (v11)
    {
      v12->_hasIsPlaceholder = 1;
      v12->_isPlaceholder = [v11 BOOLValue];
    }
