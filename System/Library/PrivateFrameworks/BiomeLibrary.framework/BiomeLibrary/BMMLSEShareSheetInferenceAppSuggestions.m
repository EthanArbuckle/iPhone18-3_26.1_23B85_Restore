...
LABEL_14:
      ...
      while (1)
      {
        ...
        if ((objc_opt_isKindOfClass() & 1) == 0)
        {
          ...
          v23 = [objc_alloc(MEMORY[0x1E696AEC0]) initWithFormat:@"Unexpected type %@ for element of %@, expecting NSDictionary", objc_opt_class(), @"appSuggestions"];
          v64 = v23;
        ...
        v22 = v8;
        v23 = v20;
        v24 = [BMMLSEShareSheetInferenceAppSuggestionsAppSuggestion alloc];
        v58 = 0;
        v25 = [(BMMLSEShareSheetInferenceAppSuggestionsAppSuggestion *)v24 initWithJSONDictionary:v23 error:&v58];
        v26 = v58;
        if (v26)
        {
          v43 = v26;
...
LABEL_41:
      ...
      v23 = [objc_alloc(MEMORY[0x1E696AEC0]) initWithFormat:@"Unexpected type null for element of %@, must not be null", @"appSuggestions"];
      v66 = v23;
      v40 = MEMORY[0x1E695DF20];
      v41 = &v66;
      v42 = &v65;
...
id __50__BMMLSEShareSheetInferenceAppSuggestions_columns__block_invoke(uint64_t a1, void *a2)
{
  ...
  v3 = [v2 _appSuggestionsJSONArray];
