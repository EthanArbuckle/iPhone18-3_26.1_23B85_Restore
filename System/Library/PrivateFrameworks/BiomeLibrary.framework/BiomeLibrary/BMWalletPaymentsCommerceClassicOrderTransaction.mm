...
LABEL_4:
    ...
    if (v9 && (objc_opt_class(), (objc_opt_isKindOfClass() & 1) == 0))
    {
      ...
      if ((objc_opt_isKindOfClass() & 1) == 0)
      {
        ...
        v10 = [objc_alloc(MEMORY[0x1E696AEC0]) initWithFormat:@"Unexpected type %@ for element of %@, expecting NSString", objc_opt_class(), @"currencyCode"];
        v40 = v10;
...
LABEL_34:
    ...
    if (objc_opt_isKindOfClass())
    {
      v16 = v10;
      v34 = 0;
      v12 = [[BMWalletPaymentsCommerceClassicOrderTransactionPaymentMethod alloc] initWithJSONDictionary:v16 error:&v34];
      v17 = v34;
      if (!v17)
      {
...
- (void)writeTo:(id)to
{
  ...
  if (self->_applePayTransactionIdentifier)
  {
    PBDataWriterWriteStringField();
  }
}
...
+ (id)protoFields
{
  ...
  v9[0] = v2;
  v3 = [objc_alloc(MEMORY[0x1E698F2C8]) initWithName:@"currencyCode" number:2 type:13 subMessageClass:0];
  v9[1] = v3;
  v4 = [objc_alloc(MEMORY[0x1E698F2C8]) initWithName:@"paymentMethod" number:3 type:14 subMessageClass:objc_opt_class()];
  v9[2] = v4;
  v5 = [objc_alloc(MEMORY[0x1E698F2C8]) initWithName:@"applePayTransactionIdentifier" number:4 type:13 subMessageClass:0];
  v9[3] = v5;
...
+ (id)columns
{
  ...
  v3 = [objc_alloc(MEMORY[0x1E698F2E8]) initWithName:@"currencyCode" dataType:2 requestOnly:0 fieldNumber:2 protoDataType:13 convertedType:0];
  v4 = [objc_alloc(MEMORY[0x1E698F2D8]) initWithName:@"paymentMethod_json" dataType:5 requestOnly:1 extractBlock:&__block_literal_global_497];
  v5 = [objc_alloc(MEMORY[0x1E698F2E8]) initWithName:@"applePayTransactionIdentifier" dataType:2 requestOnly:0 fieldNumber:4 protoDataType:13 convertedType:0];
  v9[0] = v2;
  v9[1] = v3;
  v9[2] = v4;
  v9[3] = v5;
...
id __58__BMWalletPaymentsCommerceClassicOrderTransaction_columns__block_invoke(uint64_t a1, void *a2)
{
