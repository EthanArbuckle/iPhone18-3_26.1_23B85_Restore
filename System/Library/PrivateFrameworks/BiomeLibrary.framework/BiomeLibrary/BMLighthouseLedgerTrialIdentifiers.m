...
- (id)jsonDictionary
{
  ...
  v5 = [(BMLighthouseLedgerTrialIdentifiers *)self bmltIdentifiers];
...
- (BMLighthouseLedgerTrialIdentifiers)initWithJSONDictionary:(id)a3 error:(id *)a4
{
  ...
  v6 = a3;
  v7 = [v6 objectForKeyedSubscript:@"experimentIdentifiers"];
...
LABEL_4:
    v9 = [v6 objectForKeyedSubscript:@"bmltIdentifiers"];
...
LABEL_16:
      ...
      if ((v14 >> 3) == 2)
      {
        ...
        v15 = [[BMLighthouseLedgerTrialIdentifiersBMLTIdentifiers alloc] initByReadFrom:v4];
        if (!v15)
        {
          goto LABEL_30;
        }
      ...
      else
      {
        ...
        v15 = [[BMLighthouseLedgerTrialIdentifiersExperimentIdentifiers alloc] initByReadFrom:v4];
        if (!v15)
        {
          goto LABEL_30;
        }
...
- (NSString)description
{
  ...
  v4 = [(BMLighthouseLedgerTrialIdentifiers *)self experimentIdentifiers];
  v5 = [(BMLighthouseLedgerTrialIdentifiers *)self bmltIdentifiers];
  v6 = [v3 initWithFormat:@"BMLighthouseLedgerTrialIdentifiers with experimentIdentifiers: %@, bmltIdentifiers: %@", v4, v5];
...
- (BMLighthouseLedgerTrialIdentifiers)initWithExperimentIdentifiers:(id)a3 bmltIdentifiers:(id)a4
{
  ...
  if (v9)
  {
    ...
    objc_storeStrong(&v9->_experimentIdentifiers, a3);
    objc_storeStrong(&v9->_bmltIdentifiers, a4);
  }
