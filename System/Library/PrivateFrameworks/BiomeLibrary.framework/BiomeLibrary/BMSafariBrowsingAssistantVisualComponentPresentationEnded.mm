...
LABEL_8:
  ...
  if (objc_opt_isKindOfClass())
  {
    v7 = [MEMORY[0x1E696AD98] numberWithInt:BMSafariBrowsingAssistantHideReasonFromString(v6)];
    goto LABEL_8;
  }
...
- (NSString)description
{
  ...
  v4 = BMSafariBrowsingAssistantHideReasonAsString([(BMSafariBrowsingAssistantVisualComponentPresentationEnded *)self hideReason]);
  v5 = [v3 initWithFormat:@"BMSafariBrowsingAssistantVisualComponentPresentationEnded with hideReason: %@", v4];
...
+ (id)protoFields
{
  ...
  v2 = [objc_alloc(MEMORY[0x1E698F2C8]) initWithName:@"hideReason" number:1 type:4 subMessageClass:0];
  v6[0] = v2;
...
{
  v6[1] = *MEMORY[0x1E69E9840];
  v2 = [objc_alloc(MEMORY[0x1E698F2E8]) initWithName:@"hideReason" dataType:0 requestOnly:0 fieldNumber:1 protoDataType:4 convertedType:0];
  v6[0] = v2;
  v3 = [MEMORY[0x1E695DEC8] arrayWithObjects:v6 count:1];
