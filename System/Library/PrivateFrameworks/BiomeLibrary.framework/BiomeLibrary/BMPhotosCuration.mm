...
+ (id)protoFields;
- (BMPhotosCuration)initWithIdentifier:(id)identifier subset:(id)subset type:(int)type;
- (BMPhotosCuration)initWithJSONDictionary:(id)dictionary error:(id *)error;
...
- (BOOL)isEqual:(id)equal
{
  ...
  {
    v5 = equalCopy;
    identifier = [(BMPhotosCuration *)self identifier];
    ...
    {
      identifier3 = [(BMPhotosCuration *)self identifier];
    ...
    subset = [(BMPhotosCuration *)self subset];
    subset2 = [v5 subset];
    v15 = subset2;
    if (subset == subset2)
    {
    ...
    {
      subset3 = [(BMPhotosCuration *)self subset];
      subset4 = [v5 subset];
...
LABEL_12:
    ...
    type = [(BMPhotosCuration *)self type];
    v12 = type == [v5 type];
    goto LABEL_12;
  }
...
- (NSString)description
{
  ...
  v7 = [v3 initWithFormat:@"BMPhotosCuration with identifier: %@, subset: %@, type: %@", identifier, subset, v6];
