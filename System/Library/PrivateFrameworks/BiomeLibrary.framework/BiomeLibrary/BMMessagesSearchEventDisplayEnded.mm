...
+ (id)protoFields;
- (BMMessagesSearchEventDisplayEnded)initWithJSONDictionary:(id)a3 error:(id *)a4;
- (BMMessagesSearchEventDisplayEnded)initWithReason:(int)a3;
- (BOOL)isEqual:(id)a3;
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    v5 = v4;
    v6 = [(BMMessagesSearchEventDisplayEnded *)self reason];
    v7 = [v5 reason];
...
- (BMMessagesSearchEventDisplayEnded)initWithJSONDictionary:(id)a3 error:(id *)a4
{
  ...
  if (!v6 || (objc_opt_class(), (objc_opt_isKindOfClass() & 1) != 0))
  {
    a4 = 0;
LABEL_9:
    self = -[BMMessagesSearchEventDisplayEnded initWithReason:](self, "initWithReason:", [a4 intValue]);
    v8 = self;
    goto LABEL_10;
  }
