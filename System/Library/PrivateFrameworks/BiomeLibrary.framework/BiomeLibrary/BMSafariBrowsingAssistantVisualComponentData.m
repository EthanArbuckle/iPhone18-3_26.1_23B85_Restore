...
- (BOOL)isEqual:(id)a3
{
  ...
  if (objc_opt_isKindOfClass())
  {
    ...
    if (-[BMSafariBrowsingAssistantVisualComponentData hasTableOfContentsArrayLength](self, "hasTableOfContentsArrayLength") && [v5 hasTableOfContentsArrayLength])
    {
      v13 = [(BMSafariBrowsingAssistantVisualComponentData *)self tableOfContentsArrayLength];
      v12 = v13 == [v5 tableOfContentsArrayLength];
LABEL_13:
...
- (id)jsonDictionary
{
  ...
  v10[1] = @"tableOfContentsArrayLength";
  v11[0] = v5;
  v6 = v4;
  if (!v4)
  {
...
- (BMSafariBrowsingAssistantVisualComponentData)initWithJSONDictionary:(id)a3 error:(id *)a4
{
  ...
  v6 = a3;
  v7 = [v6 objectForKeyedSubscript:@"summaryText"];
  ...
  if (v9 && (objc_opt_class(), (objc_opt_isKindOfClass() & 1) == 0))
  {
    ...
    if ((objc_opt_isKindOfClass() & 1) == 0)
    {
      if (a4)
      {
        ...
        v19 = [objc_alloc(MEMORY[0x1E696AEC0]) initWithFormat:@"Unexpected type %@ for element of %@, expecting NSNumber", objc_opt_class(), @"tableOfContentsArrayLength"];
        v22 = v19;
...
- (void)writeTo:(id)a3
{
  ...
  {
    tableOfContentsArrayLength = self->_tableOfContentsArrayLength;
...
- (NSString)description
{
  ...
  v4 = [(BMSafariBrowsingAssistantVisualComponentData *)self summaryText];
  ...
  v6 = [v3 initWithFormat:@"BMSafariBrowsingAssistantVisualComponentData with summaryText: %@, tableOfContentsArrayLength: %@", v4, v5];
...
- (BMSafariBrowsingAssistantVisualComponentData)initWithSummaryText:(id)a3 tableOfContentsArrayLength:(id)a4
{
  ...
  if (v9)
  {
    ...
    objc_storeStrong(&v9->_summaryText, a3);
    if (v8)
    {
