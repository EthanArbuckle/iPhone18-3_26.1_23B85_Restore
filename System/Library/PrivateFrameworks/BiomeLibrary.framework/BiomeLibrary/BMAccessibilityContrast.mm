...
- (BMAccessibilityContrast)initWithStarting:(id)starting;
...
- (BOOL)isEqual:(id)equal
{
  ...
  if (objc_opt_isKindOfClass())
  {
    ...
    if (-[BMAccessibilityContrast hasStarting](self, "hasStarting") || [v5 hasStarting])
    {
      if (-[BMAccessibilityContrast hasStarting](self, "hasStarting") && [v5 hasStarting])
      {
        starting = [(BMAccessibilityContrast *)self starting];
...
- (BMAccessibilityContrast)initWithJSONDictionary:(id)dictionary error:(id *)error
{
  ...
  if (!v6 || (objc_opt_class(), (objc_opt_isKindOfClass() & 1) != 0))
  {
    error = 0;
LABEL_4:
    self = [(BMAccessibilityContrast *)self initWithStarting:error];
    selfCopy = self;
    goto LABEL_5;
  }
...
- (id)initByReadFrom:(id)from
{
  fromCopy = from;
  v25.receiver = self;
  v25.super_class = BMAccessibilityContrast;
...
- (NSString)description
{
  ...
  v4 = [MEMORY[0x1E696AD98] numberWithBool:{-[BMAccessibilityContrast starting](self, "starting")}];
  v5 = [v3 initWithFormat:@"BMAccessibilityContrast with starting: %@", v4];
...
- (BMAccessibilityContrast)initWithStarting:(id)starting
{
  ...
  v7.receiver = self;
  v7.super_class = BMAccessibilityContrast;
