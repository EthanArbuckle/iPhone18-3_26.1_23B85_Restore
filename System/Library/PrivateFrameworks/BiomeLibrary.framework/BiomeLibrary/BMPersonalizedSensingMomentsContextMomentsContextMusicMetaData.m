...
- (NSString)description
{
  ...
  v4 = [(BMPersonalizedSensingMomentsContextMomentsContextMusicMetaData *)self music];
  v5 = [v3 initWithFormat:@"BMPersonalizedSensingMomentsContextMomentsContextMusicMetaData with music: %@", v4];
