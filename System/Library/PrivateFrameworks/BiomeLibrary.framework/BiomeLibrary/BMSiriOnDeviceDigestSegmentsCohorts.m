...
- (id)jsonDictionary
{
  ...
  v5 = [(BMSiriOnDeviceDigestSegmentsCohorts *)self _deviceSegmentsReportedJSONArray];
...
- (id)_deviceCohortsReportedJSONArray
{
  ...
  v14 = 0u;
  v15 = 0u;
  v4 = [(BMSiriOnDeviceDigestSegmentsCohorts *)self deviceCohortsReported];
...
- (id)_deviceSegmentsReportedJSONArray
{
  ...
  v14 = 0u;
  v15 = 0u;
  v4 = [(BMSiriOnDeviceDigestSegmentsCohorts *)self deviceSegmentsReported];
  v5 = [v4 countByEnumeratingWithState:&v12 objects:v16 count:16];
  if (v5)
  {
    v6 = v5;
...
LABEL_48:
        ...
        v8 = v60;
        v27 = [(BMSiriOnDeviceDigestSegmentsCohorts *)v62 initWithEventMetadata:v60 deviceSegmentsReported:v65 deviceCohortsReported:v17];
        v62 = v27;
        v5 = v61;
LABEL_66:
...
LABEL_16:
      ...
      if (v17 == 2)
      {
        ...
        v20 = [[BMSiriOnDeviceDigestSegmentsCohortsDeviceSegments alloc] initByReadFrom:v4];
        if (!v20)
        {
          goto LABEL_35;
        }
...
LABEL_30:
      ...
      if (v17 == 1)
      {
        ...
        v18 = [[BMSiriOnDeviceDigestSegmentsCohortsEventMetadata alloc] initByReadFrom:v4];
        if (!v18)
        {
          goto LABEL_35;
        }
...
LABEL_32:
    ...
    v33 = 0;
    v34 = 0;
    if (!PBReaderPlaceMark() || (v23 = [[BMSiriOnDeviceDigestSegmentsCohortsDeviceCohorts alloc] initByReadFrom:v4]) == 0)
    {
LABEL_35:
...
- (NSString)description
{
  ...
  v4 = [(BMSiriOnDeviceDigestSegmentsCohorts *)self eventMetadata];
  v5 = [(BMSiriOnDeviceDigestSegmentsCohorts *)self deviceSegmentsReported];
  v6 = [(BMSiriOnDeviceDigestSegmentsCohorts *)self deviceCohortsReported];
  v7 = [v3 initWithFormat:@"BMSiriOnDeviceDigestSegmentsCohorts with eventMetadata: %@, deviceSegmentsReported: %@, deviceCohortsReported: %@", v4, v5, v6];
