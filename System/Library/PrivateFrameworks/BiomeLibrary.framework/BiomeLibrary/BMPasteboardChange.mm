@interface BMPasteboardChange
+ (id)columns;
+ (id)eventWithData:(id)a3 dataVersion:(unsigned int)a4;
+ (id)protoFields;
- (BMPasteboardChange)initWithJSONDictionary:(id)a3 error:(id *)a4;
- (BMPasteboardChange)initWithName:(id)a3;
- (BOOL)isEqual:(id)a3;
...
@implementation BMPasteboardChange
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    v5 = v4;
    v6 = [(BMPasteboardChange *)self name];
    v7 = [v5 name];
    if (v6 == v7)
    {
      v10 = 1;
    ...
    {
      v8 = [(BMPasteboardChange *)self name];
      v9 = [v5 name];
      v10 = [v8 isEqual:v9];
    }
  }
...
- (id)jsonDictionary
{
  ...
  v2 = [(BMPasteboardChange *)self name];
  v7 = @"name";
  v3 = v2;
  if (!v2)
  {
...
- (BMPasteboardChange)initWithJSONDictionary:(id)a3 error:(id *)a4
{
  ...
  if (!v6 || (objc_opt_class(), (objc_opt_isKindOfClass() & 1) != 0))
  {
    a4 = 0;
LABEL_4:
    self = [(BMPasteboardChange *)self initWithName:a4];
    v7 = self;
    goto LABEL_5;
  }
...
{
  v3 = objc_opt_new();
  [(BMPasteboardChange *)self writeTo:v3];
  v4 = [v3 immutableData];
...
- (id)initByReadFrom:(id)a3
{
  v4 = a3;
  v20.receiver = self;
  v20.super_class = BMPasteboardChange;
...
- (NSString)description
{
  ...
  v4 = [(BMPasteboardChange *)self name];
  v5 = [v3 initWithFormat:@"BMPasteboardChange with name: %@", v4];
...
- (BMPasteboardChange)initWithName:(id)a3
{
  v5 = a3;
  v8.receiver = self;
  v8.super_class = BMPasteboardChange;
...
+ (id)eventWithData:(id)a3 dataVersion:(unsigned int)a4
{
  ...
  else
  {
    ...
    v8 = [[BMPasteboardChange alloc] initByReadFrom:v7];
    v4 = v8;
    if (v8)
    {
      v8[4] = 0;
