...
- (BMPasteboardChange)initWithName:(id)name;
...
- (BOOL)isEqual:(id)equal
{
  ...
  if (objc_opt_isKindOfClass())
  {
    ...
    {
      name3 = [(BMPasteboardChange *)self name];
      name4 = [v5 name];
...
- (BMPasteboardChange)initWithJSONDictionary:(id)dictionary error:(id *)error
{
  ...
  if (!v6 || (objc_opt_class(), (objc_opt_isKindOfClass() & 1) != 0))
  {
    error = 0;
LABEL_4:
    self = [(BMPasteboardChange *)self initWithName:error];
    selfCopy = self;
    goto LABEL_5;
  }
...
- (NSString)description
{
  ...
  name = [(BMPasteboardChange *)self name];
  v5 = [v3 initWithFormat:@"BMPasteboardChange with name: %@", name];
