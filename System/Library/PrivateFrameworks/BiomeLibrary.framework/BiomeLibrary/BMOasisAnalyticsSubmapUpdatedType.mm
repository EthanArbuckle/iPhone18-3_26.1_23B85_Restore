...
+ (id)protoFields;
- (BMOasisAnalyticsSubmapUpdatedType)initWithJSONDictionary:(id)dictionary error:(id *)error;
- (BMOasisAnalyticsSubmapUpdatedType)initWithSubmapId:(id)id isLocationAttached:(id)attached bytesWrittenToDisk:(id)disk;
...
- (BOOL)isEqual:(id)equal
{
  ...
  {
    v5 = equalCopy;
    if (-[BMOasisAnalyticsSubmapUpdatedType hasSubmapId](self, "hasSubmapId") || [v5 hasSubmapId])
    {
      ...
      submapId = [(BMOasisAnalyticsSubmapUpdatedType *)self submapId];
    ...
    if (-[BMOasisAnalyticsSubmapUpdatedType hasIsLocationAttached](self, "hasIsLocationAttached") || [v5 hasIsLocationAttached])
    {
      ...
      isLocationAttached = [(BMOasisAnalyticsSubmapUpdatedType *)self isLocationAttached];
    ...
    if (!-[BMOasisAnalyticsSubmapUpdatedType hasBytesWrittenToDisk](self, "hasBytesWrittenToDisk") && ![v5 hasBytesWrittenToDisk])
    {
      v9 = 1;
      goto LABEL_19;
    }
    ...
    if (-[BMOasisAnalyticsSubmapUpdatedType hasBytesWrittenToDisk](self, "hasBytesWrittenToDisk") && [v5 hasBytesWrittenToDisk])
    {
      bytesWrittenToDisk = [(BMOasisAnalyticsSubmapUpdatedType *)self bytesWrittenToDisk];
...
- (id)jsonDictionary
{
  ...
  if ([(BMOasisAnalyticsSubmapUpdatedType *)self hasSubmapId])
  {
    v3 = [MEMORY[0x1E696AD98] numberWithUnsignedLongLong:{-[BMOasisAnalyticsSubmapUpdatedType submapId](self, "submapId")}];
  }
  ...
  if ([(BMOasisAnalyticsSubmapUpdatedType *)self hasIsLocationAttached])
  {
    v4 = [MEMORY[0x1E696AD98] numberWithBool:{-[BMOasisAnalyticsSubmapUpdatedType isLocationAttached](self, "isLocationAttached")}];
  }
  ...
  {
    v5 = [MEMORY[0x1E696AD98] numberWithUnsignedLongLong:{-[BMOasisAnalyticsSubmapUpdatedType bytesWrittenToDisk](self, "bytesWrittenToDisk")}];
  }
...
- (id)initByReadFrom:(id)from
{
  fromCopy = from;
  v40.receiver = self;
  v40.super_class = BMOasisAnalyticsSubmapUpdatedType;
...
- (NSString)description
{
  ...
  v4 = [MEMORY[0x1E696AD98] numberWithUnsignedLongLong:{-[BMOasisAnalyticsSubmapUpdatedType submapId](self, "submapId")}];
  v5 = [MEMORY[0x1E696AD98] numberWithBool:{-[BMOasisAnalyticsSubmapUpdatedType isLocationAttached](self, "isLocationAttached")}];
  v6 = [MEMORY[0x1E696AD98] numberWithUnsignedLongLong:{-[BMOasisAnalyticsSubmapUpdatedType bytesWrittenToDisk](self, "bytesWrittenToDisk")}];
  v7 = [v3 initWithFormat:@"BMOasisAnalyticsSubmapUpdatedType with submapId: %@, isLocationAttached: %@, bytesWrittenToDisk: %@", v4, v5, v6];
...
- (BMOasisAnalyticsSubmapUpdatedType)initWithSubmapId:(id)id isLocationAttached:(id)attached bytesWrittenToDisk:(id)disk
{
  ...
  diskCopy = disk;
  v15.receiver = self;
  v15.super_class = BMOasisAnalyticsSubmapUpdatedType;
...
+ (id)eventWithData:(id)data dataVersion:(unsigned int)version
{
  ...
  else
  {
    ...
    v8 = [[BMOasisAnalyticsSubmapUpdatedType alloc] initByReadFrom:v7];
    v4 = v8;
    if (v8)
    {
      v8[5] = 0;
