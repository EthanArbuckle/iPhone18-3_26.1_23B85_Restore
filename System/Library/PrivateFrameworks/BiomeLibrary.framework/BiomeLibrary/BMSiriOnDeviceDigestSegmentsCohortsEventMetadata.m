...
- (BOOL)isEqual:(id)a3
{
  ...
  if (objc_opt_isKindOfClass())
  {
    ...
    if (-[BMSiriOnDeviceDigestSegmentsCohortsEventMetadata hasEventTimestampInMSSince1970](self, "hasEventTimestampInMSSince1970") || [v5 hasEventTimestampInMSSince1970])
    {
      ...
      v25 = [(BMSiriOnDeviceDigestSegmentsCohortsEventMetadata *)self eventTimestampInMSSince1970];
    ...
    if (!-[BMSiriOnDeviceDigestSegmentsCohortsEventMetadata hasUserAggregationIdRotationTimestampInMs](self, "hasUserAggregationIdRotationTimestampInMs") && ![v5 hasUserAggregationIdRotationTimestampInMs] || -[BMSiriOnDeviceDigestSegmentsCohortsEventMetadata hasUserAggregationIdRotationTimestampInMs](self, "hasUserAggregationIdRotationTimestampInMs") && objc_msgSend(v5, "hasUserAggregationIdRotationTimestampInMs") && (v32 = -[BMSiriOnDeviceDigestSegmentsCohortsEventMetadata userAggregationIdRotationTimestampInMs](self, "userAggregationIdRotationTimestampInMs"), v32 == objc_msgSend(v5, "userAggregationIdRotationTimestampInMs")))
    {
      ...
      if (-[BMSiriOnDeviceDigestSegmentsCohortsEventMetadata hasUserAggregationIdExpirationTimestampInMs](self, "hasUserAggregationIdExpirationTimestampInMs") && [v5 hasUserAggregationIdExpirationTimestampInMs])
      {
        v33 = [(BMSiriOnDeviceDigestSegmentsCohortsEventMetadata *)self userAggregationIdExpirationTimestampInMs];
...
- (id)jsonDictionary
{
  ...
  v3 = [(BMSiriOnDeviceDigestSegmentsCohortsEventMetadata *)self oddIdUUID];
  v4 = [(BMSiriOnDeviceDigestSegmentsCohortsEventMetadata *)self deviceAggregationId];
  v5 = [(BMSiriOnDeviceDigestSegmentsCohortsEventMetadata *)self userAggregationId];
  if ([(BMSiriOnDeviceDigestSegmentsCohortsEventMetadata *)self hasEventTimestampInMSSince1970])
  {
    v24 = [MEMORY[0x1E696AD98] numberWithUnsignedLongLong:{-[BMSiriOnDeviceDigestSegmentsCohortsEventMetadata eventTimestampInMSSince1970](self, "eventTimestampInMSSince1970")}];
  }
...
LABEL_29:
    ...
    if (v15 && (objc_opt_class(), (objc_opt_isKindOfClass() & 1) == 0))
    {
      ...
      v22 = v15;
      v70 = 0;
      v65 = [[BMSiriOnDeviceDigestSegmentsCohortsTimeInterval alloc] initWithJSONDictionary:v22 error:&v70];
      v25 = v70;
      if (v25)
      {
        if (v68)
    ...
    v21 = [(BMSiriOnDeviceDigestSegmentsCohortsEventMetadata *)v17 initWithOddIdUUID:v64 deviceAggregationId:v61 userAggregationId:v67 eventTimestampInMSSince1970:v69 timeInterval:v65 userAggregationIdRotationTimestampInMs:v18 userAggregationIdExpirationTimestampInMs:v20];
    v17 = v21;
LABEL_23:
...
- (NSString)description
{
  ...
  v4 = [(BMSiriOnDeviceDigestSegmentsCohortsEventMetadata *)self oddIdUUID];
  v5 = [(BMSiriOnDeviceDigestSegmentsCohortsEventMetadata *)self deviceAggregationId];
  v6 = [(BMSiriOnDeviceDigestSegmentsCohortsEventMetadata *)self userAggregationId];
  ...
  v8 = [(BMSiriOnDeviceDigestSegmentsCohortsEventMetadata *)self timeInterval];
  ...
  v11 = [v3 initWithFormat:@"BMSiriOnDeviceDigestSegmentsCohortsEventMetadata with oddIdUUID: %@, deviceAggregationId: %@, userAggregationId: %@, eventTimestampInMSSince1970: %@, timeInterval: %@, userAggregationIdRotationTimestampInMs: %@, userAggregationIdExpirationTimestampInMs: %@", v4, v5, v6, v7, v8, v9, v10];
