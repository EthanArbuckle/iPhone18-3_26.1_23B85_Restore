...
- (id)_suggestionsJSONArray
{
  ...
  v14 = 0u;
  v15 = 0u;
  v4 = [(BMiCloudFamilyPrediction *)self suggestions];
...
- (BMiCloudFamilyPrediction)initWithJSONDictionary:(id)a3 error:(id *)p_isa
{
  ...
  v6 = [a3 objectForKeyedSubscript:@"suggestions"];
...
LABEL_8:
    ...
    while (1)
    {
      ...
      v35 = 0;
      v17 = [(BMiCloudFamilyPredictionSuggestion *)v16 initWithJSONDictionary:v15 error:&v35];
      v18 = v35;
      if (v18)
      {
        v25 = v18;
...
LABEL_16:
      ...
      if ((v15 >> 3) == 1)
      {
        v25[0] = 0;
        v25[1] = 0;
        if (!PBReaderPlaceMark() || (v16 = [[BMiCloudFamilyPredictionSuggestion alloc] initByReadFrom:v4]) == 0)
        {
LABEL_26:
...
- (NSString)description
{
  ...
  v4 = [(BMiCloudFamilyPrediction *)self suggestions];
  v5 = [v3 initWithFormat:@"BMiCloudFamilyPrediction with suggestions: %@", v4];
