...
- (id)jsonDictionary
{
  ...
  v4 = [(BMSafariBrowsingAssistantResponseData *)self _tableOfContentsTextsJSONArray];
  v10[0] = @"summaryText";
  v5 = v3;
  if (!v3)
  {
...
- (id)_tableOfContentsTextsJSONArray
{
  ...
  v13 = 0u;
  v14 = 0u;
  v4 = [(BMSafariBrowsingAssistantResponseData *)self tableOfContentsTexts];
...
- (BMSafariBrowsingAssistantResponseData)initWithJSONDictionary:(id)a3 error:(id *)a4
{
  ...
  v9 = [v6 objectForKeyedSubscript:@"tableOfContentsTexts"];
...
- (NSString)description
{
  ...
  v4 = [(BMSafariBrowsingAssistantResponseData *)self summaryText];
  v5 = [(BMSafariBrowsingAssistantResponseData *)self tableOfContentsTexts];
  v6 = [v3 initWithFormat:@"BMSafariBrowsingAssistantResponseData with summaryText: %@, tableOfContentsTexts: %@", v4, v5];
...
- (BMSafariBrowsingAssistantResponseData)initWithSummaryText:(id)a3 tableOfContentsTexts:(id)a4
{
  ...
  if (v9)
  {
    ...
    objc_storeStrong(&v9->_tableOfContentsTexts, a4);
  }
