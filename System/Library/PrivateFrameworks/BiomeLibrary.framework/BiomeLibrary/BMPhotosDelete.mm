...
- (NSString)description
{
  ...
  v4 = [(BMPhotosDelete *)self identifier];
  v5 = [(BMPhotosDelete *)self subset];
  v6 = BMPhotosDeleteTypeAsString([(BMPhotosDelete *)self type]);
  v7 = [v3 initWithFormat:@"BMPhotosDelete with identifier: %@, subset: %@, type: %@", v4, v5, v6];
