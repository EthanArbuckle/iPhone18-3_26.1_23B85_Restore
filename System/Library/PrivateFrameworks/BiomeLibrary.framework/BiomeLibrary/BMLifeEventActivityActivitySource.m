...
- (id)jsonDictionary
{
  ...
  v4 = [(BMLifeEventActivityActivitySource *)self version];
  v10[0] = @"model";
  v5 = v3;
  if (!v3)
  {
...
- (BMLifeEventActivityActivitySource)initWithJSONDictionary:(id)a3 error:(id *)a4
{
  ...
  v6 = a3;
  v7 = [v6 objectForKeyedSubscript:@"model"];
...
- (NSString)description
{
  ...
  v4 = [(BMLifeEventActivityActivitySource *)self model];
  v5 = [(BMLifeEventActivityActivitySource *)self version];
  v6 = [v3 initWithFormat:@"BMLifeEventActivityActivitySource with model: %@, version: %@", v4, v5];
