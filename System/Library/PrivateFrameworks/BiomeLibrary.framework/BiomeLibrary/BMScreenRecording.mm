...
+ (id)protoFields;
- (BMScreenRecording)initWithJSONDictionary:(id)dictionary error:(id *)error;
- (BMScreenRecording)initWithStarting:(id)starting;
...
- (BOOL)isEqual:(id)equal
{
  ...
  if (objc_opt_isKindOfClass())
  {
    ...
    if (-[BMScreenRecording hasStarting](self, "hasStarting") || [v5 hasStarting])
    {
      if (-[BMScreenRecording hasStarting](self, "hasStarting") && [v5 hasStarting])
      {
        starting = [(BMScreenRecording *)self starting];
...
- (id)jsonDictionary
{
  ...
  {
    v3 = [MEMORY[0x1E696AD98] numberWithBool:{-[BMScreenRecording starting](self, "starting")}];
    v10 = @"starting";
    if (v3)
    {
      v4 = v3;
...
- (BMScreenRecording)initWithJSONDictionary:(id)dictionary error:(id *)error
{
  ...
  if (!v6 || (objc_opt_class(), (objc_opt_isKindOfClass() & 1) != 0))
  {
    error = 0;
LABEL_4:
    self = [(BMScreenRecording *)self initWithStarting:error];
    selfCopy = self;
    goto LABEL_5;
  }
...
- (id)initByReadFrom:(id)from
{
  fromCopy = from;
  v25.receiver = self;
  v25.super_class = BMScreenRecording;
...
- (NSString)description
{
  ...
  v4 = [MEMORY[0x1E696AD98] numberWithBool:{-[BMScreenRecording starting](self, "starting")}];
  v5 = [v3 initWithFormat:@"BMScreenRecording with starting: %@", v4];
...
- (BMScreenRecording)initWithStarting:(id)starting
{
  ...
  v7.receiver = self;
  v7.super_class = BMScreenRecording;
...
+ (id)eventWithData:(id)data dataVersion:(unsigned int)version
{
  if (version == 1)
  {
    ...
    v7 = [[BMScreenRecording alloc] initByReadFrom:v6];
    v8 = v7;
    if (v7)
    {
      v7[5] = 1;
