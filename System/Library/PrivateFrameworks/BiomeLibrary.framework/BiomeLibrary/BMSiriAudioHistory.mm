...
+ (id)protoFields;
- (BMSiriAudioHistory)initWithInteraction:(id)interaction entities:(id)entities;
- (BMSiriAudioHistory)initWithJSONDictionary:(id)dictionary error:(id *)error;
...
+ (id)columns
{
  ...
  v2 = [objc_alloc(MEMORY[0x1E698F2D8]) initWithName:@"interaction_json" dataType:5 requestOnly:1 extractBlock:&__block_literal_global_64434];
  v3 = [objc_alloc(MEMORY[0x1E698F2D8]) initWithName:@"entities_json" dataType:5 requestOnly:1 extractBlock:&__block_literal_global_35_64435];
  v7[0] = v2;
  v7[1] = v3;
...
- (BOOL)isEqual:(id)equal
{
  ...
  {
    v5 = equalCopy;
    interaction = [(BMSiriAudioHistory *)self interaction];
    ...
    {
      interaction3 = [(BMSiriAudioHistory *)self interaction];
...
LABEL_11:
    ...
    entities = [(BMSiriAudioHistory *)self entities];
    ...
    {
      entities3 = [(BMSiriAudioHistory *)self entities];
...
- (id)jsonDictionary
{
  ...
  _entitiesJSONArray = [(BMSiriAudioHistory *)self _entitiesJSONArray];
  v11[0] = @"interaction";
  null = jsonDictionary;
  if (!jsonDictionary)
  {
...
LABEL_19:
  ...
  v8 = v40;
  self = [(BMSiriAudioHistory *)self initWithInteraction:v40 entities:v12];
  selfCopy2 = self;
  v7 = v41;
  dictionaryCopy = v42;
LABEL_36:
...
- (id)initByReadFrom:(id)from
{
  fromCopy = from;
  v26.receiver = self;
  v26.super_class = BMSiriAudioHistory;
...
- (NSString)description
{
  ...
  interaction = [(BMSiriAudioHistory *)self interaction];
  entities = [(BMSiriAudioHistory *)self entities];
  v6 = [v3 initWithFormat:@"BMSiriAudioHistory with interaction: %@, entities: %@", interaction, entities];
...
- (BMSiriAudioHistory)initWithInteraction:(id)interaction entities:(id)entities
{
  ...
  v11.receiver = self;
  v11.super_class = BMSiriAudioHistory;
...
+ (id)eventWithData:(id)data dataVersion:(unsigned int)version
{
  ...
  else
  {
    ...
    v8 = [[BMSiriAudioHistory alloc] initByReadFrom:v7];
    v4 = v8;
    if (v8)
    {
      v8[4] = 0;
