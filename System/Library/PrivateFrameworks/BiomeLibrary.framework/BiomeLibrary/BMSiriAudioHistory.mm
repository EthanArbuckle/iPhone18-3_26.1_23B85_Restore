...
- (id)jsonDictionary
{
  ...
  v5 = [(BMSiriAudioHistory *)self _entitiesJSONArray];
  v11[0] = @"interaction";
  v6 = v4;
  if (!v4)
  {
...
- (id)_entitiesJSONArray
{
  ...
  v14 = 0u;
  v15 = 0u;
  v4 = [(BMSiriAudioHistory *)self entities];
...
- (NSString)description
{
  ...
  v4 = [(BMSiriAudioHistory *)self interaction];
  v5 = [(BMSiriAudioHistory *)self entities];
  v6 = [v3 initWithFormat:@"BMSiriAudioHistory with interaction: %@, entities: %@", v4, v5];
