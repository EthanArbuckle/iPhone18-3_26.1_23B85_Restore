...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    v5 = v4;
    v6 = [(BMMLSEDurableFeatureStoreFeatureValueHistogramBucketCount *)self interval];
    if (v6 != [v5 interval])
    {
      goto LABEL_9;
    }
    ...
    if (-[BMMLSEDurableFeatureStoreFeatureValueHistogramBucketCount hasValue](self, "hasValue") && [v5 hasValue])
    {
      v7 = [(BMMLSEDurableFeatureStoreFeatureValueHistogramBucketCount *)self value];
      v8 = v7 == [v5 value];
    }
...
- (BMMLSEDurableFeatureStoreFeatureValueHistogramBucketCount)initWithJSONDictionary:(id)a3 error:(id *)a4
{
  ...
  v6 = a3;
  v7 = [v6 objectForKeyedSubscript:@"interval"];
