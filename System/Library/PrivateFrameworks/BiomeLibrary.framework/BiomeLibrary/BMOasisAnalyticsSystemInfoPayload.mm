...
LABEL_16:
      ...
      if ((v14 >> 3) == 1)
      {
        ...
        v15 = [[BMOasisAnalyticsSystemInfoEvent alloc] initByReadFrom:v4];
        if (!v15)
        {
          goto LABEL_25;
        }
...
- (NSString)description
{
  ...
  v4 = [(BMOasisAnalyticsSystemInfoPayload *)self systemInfo];
  v5 = [v3 initWithFormat:@"BMOasisAnalyticsSystemInfoPayload with systemInfo: %@", v4];
...
- (BMOasisAnalyticsSystemInfoPayload)initWithSystemInfo:(id)a3
{
  ...
  if (v6)
  {
    ...
    objc_storeStrong(&v6->_systemInfo, a3);
  }
