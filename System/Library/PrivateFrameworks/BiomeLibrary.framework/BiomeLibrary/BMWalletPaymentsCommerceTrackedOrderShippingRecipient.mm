...
LABEL_54:
    ...
    if (!v15 || (objc_opt_class(), (objc_opt_isKindOfClass() & 1) != 0))
    {
      error = 0;
LABEL_19:
      v16 = [(BMWalletPaymentsCommerceTrackedOrderShippingRecipient *)selfCopy initWithFullName:v53 phoneNumber:v56 emailAddress:v11 address:v52 givenName:v14 familyName:error];
      selfCopy = v16;
LABEL_49:
