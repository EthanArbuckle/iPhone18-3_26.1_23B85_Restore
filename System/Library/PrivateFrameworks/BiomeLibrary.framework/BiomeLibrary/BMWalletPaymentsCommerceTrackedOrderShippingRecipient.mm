...
+ (id)protoFields;
- (BMWalletPaymentsCommerceTrackedOrderShippingRecipient)initWithFullName:(id)a3 phoneNumber:(id)a4 emailAddress:(id)a5 address:(id)a6 givenName:(id)a7 familyName:(id)a8;
- (BMWalletPaymentsCommerceTrackedOrderShippingRecipient)initWithJSONDictionary:(id)a3 error:(id *)a4;
- (BOOL)isEqual:(id)a3;
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    v5 = v4;
    v6 = [(BMWalletPaymentsCommerceTrackedOrderShippingRecipient *)self fullName];
    v7 = [v5 fullName];
    v8 = v7;
    if (v6 == v7)
    {
    ...
    {
      v9 = [(BMWalletPaymentsCommerceTrackedOrderShippingRecipient *)self fullName];
      v10 = [v5 fullName];
      v11 = [v9 isEqual:v10];
    ...
    v13 = [(BMWalletPaymentsCommerceTrackedOrderShippingRecipient *)self phoneNumber];
    v14 = [v5 phoneNumber];
    v15 = v14;
    if (v13 == v14)
    {
    ...
    {
      v16 = [(BMWalletPaymentsCommerceTrackedOrderShippingRecipient *)self phoneNumber];
      v17 = [v5 phoneNumber];
      v18 = [v16 isEqual:v17];
    ...
    v19 = [(BMWalletPaymentsCommerceTrackedOrderShippingRecipient *)self emailAddress];
    v20 = [v5 emailAddress];
    v21 = v20;
    if (v19 == v20)
    {
    ...
    {
      v22 = [(BMWalletPaymentsCommerceTrackedOrderShippingRecipient *)self emailAddress];
      v23 = [v5 emailAddress];
      v24 = [v22 isEqual:v23];
    ...
    v25 = [(BMWalletPaymentsCommerceTrackedOrderShippingRecipient *)self address];
    v26 = [v5 address];
    v27 = v26;
    if (v25 == v26)
    {
    ...
    {
      v28 = [(BMWalletPaymentsCommerceTrackedOrderShippingRecipient *)self address];
      v29 = [v5 address];
      v30 = [v28 isEqual:v29];
    ...
    v31 = [(BMWalletPaymentsCommerceTrackedOrderShippingRecipient *)self givenName];
    v32 = [v5 givenName];
    v33 = v32;
    if (v31 == v32)
    {
    ...
    {
      v34 = [(BMWalletPaymentsCommerceTrackedOrderShippingRecipient *)self givenName];
      v35 = [v5 givenName];
      v36 = [v34 isEqual:v35];
...
LABEL_22:
    ...
    v38 = [(BMWalletPaymentsCommerceTrackedOrderShippingRecipient *)self familyName];
    v39 = [v5 familyName];
    if (v38 == v39)
    {
      v12 = 1;
    ...
    {
      v40 = [(BMWalletPaymentsCommerceTrackedOrderShippingRecipient *)self familyName];
      v41 = [v5 familyName];
      v12 = [v40 isEqual:v41];
    }
...
- (id)jsonDictionary
{
  ...
  v3 = [(BMWalletPaymentsCommerceTrackedOrderShippingRecipient *)self fullName];
  v4 = [(BMWalletPaymentsCommerceTrackedOrderShippingRecipient *)self phoneNumber];
  v5 = [(BMWalletPaymentsCommerceTrackedOrderShippingRecipient *)self emailAddress];
  v6 = [(BMWalletPaymentsCommerceTrackedOrderShippingRecipient *)self address];
  v7 = [v6 jsonDictionary];

  v8 = [(BMWalletPaymentsCommerceTrackedOrderShippingRecipient *)self givenName];
  v9 = [(BMWalletPaymentsCommerceTrackedOrderShippingRecipient *)self familyName];
  v24[0] = @"fullName";
  v10 = v3;
  if (!v3)
  {
...
LABEL_54:
    ...
    if (!v15 || (objc_opt_class(), (objc_opt_isKindOfClass() & 1) != 0))
    {
      a4 = 0;
LABEL_19:
      v16 = [(BMWalletPaymentsCommerceTrackedOrderShippingRecipient *)v57 initWithFullName:v53 phoneNumber:v56 emailAddress:v11 address:v52 givenName:v14 familyName:a4];
      v57 = v16;
LABEL_49:
...
- (void)writeTo:(id)a3
{
  ...
  if (self->_address)
  {
    ...
    [(BMWalletPaymentsCommerceTrackedOrderAddress *)self->_address writeTo:v4];
...
- (NSString)description
{
  ...
  v4 = [(BMWalletPaymentsCommerceTrackedOrderShippingRecipient *)self fullName];
  v5 = [(BMWalletPaymentsCommerceTrackedOrderShippingRecipient *)self phoneNumber];
  v6 = [(BMWalletPaymentsCommerceTrackedOrderShippingRecipient *)self emailAddress];
  v7 = [(BMWalletPaymentsCommerceTrackedOrderShippingRecipient *)self address];
  v8 = [(BMWalletPaymentsCommerceTrackedOrderShippingRecipient *)self givenName];
  v9 = [(BMWalletPaymentsCommerceTrackedOrderShippingRecipient *)self familyName];
  v10 = [v3 initWithFormat:@"BMWalletPaymentsCommerceTrackedOrderShippingRecipient with fullName: %@, phoneNumber: %@, emailAddress: %@, address: %@, givenName: %@, familyName: %@", v4, v5, v6, v7, v8, v9];
...
id __64__BMWalletPaymentsCommerceTrackedOrderShippingRecipient_columns__block_invoke(uint64_t a1, void *a2)
{
