...
- (BOOL)isEqual:(id)a3
{
  ...
  if (objc_opt_isKindOfClass())
  {
    ...
    if (-[BMMonotonicTimestampValue hasSuspendingNanosecondsSinceBoot](self, "hasSuspendingNanosecondsSinceBoot") || [v5 hasSuspendingNanosecondsSinceBoot])
    {
      ...
      v6 = [(BMMonotonicTimestampValue *)self suspendingNanosecondsSinceBoot];
    ...
    if (-[BMMonotonicTimestampValue hasContinuousNanosecondsSinceBoot](self, "hasContinuousNanosecondsSinceBoot") && [v5 hasContinuousNanosecondsSinceBoot])
    {
      v7 = [(BMMonotonicTimestampValue *)self continuousNanosecondsSinceBoot];
      v8 = v7 == [v5 continuousNanosecondsSinceBoot];
    }
...
- (BMMonotonicTimestampValue)initWithJSONDictionary:(id)a3 error:(id *)a4
{
  ...
  v6 = a3;
  v7 = [v6 objectForKeyedSubscript:@"suspendingNanosecondsSinceBoot"];
