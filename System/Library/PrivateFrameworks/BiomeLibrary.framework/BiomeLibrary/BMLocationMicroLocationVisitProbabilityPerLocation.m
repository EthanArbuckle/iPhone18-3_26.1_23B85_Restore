...
- (BMLocationMicroLocationVisitProbabilityPerLocation)initWithJSONDictionary:(id)a3 error:(id *)a4
{
  ...
  v6 = a3;
  v7 = [v6 objectForKeyedSubscript:@"microLocationIdentifier"];
...
- (NSString)description
{
  ...
  v4 = [(BMLocationMicroLocationVisitProbabilityPerLocation *)self microLocationIdentifier];
  v5 = MEMORY[0x1E696AD98];
  [(BMLocationMicroLocationVisitProbabilityPerLocation *)self probability];
  v6 = [v5 numberWithDouble:?];
  v7 = [v3 initWithFormat:@"BMLocationMicroLocationVisitProbabilityPerLocation with microLocationIdentifier: %@, probability: %@", v4, v6];
...
- (BMLocationMicroLocationVisitProbabilityPerLocation)initWithMicroLocationIdentifier:(id)a3 probability:(id)a4
{
  ...
  if (v9)
  {
    ...
    objc_storeStrong(&v9->_microLocationIdentifier, a3);
    if (v8)
    {
