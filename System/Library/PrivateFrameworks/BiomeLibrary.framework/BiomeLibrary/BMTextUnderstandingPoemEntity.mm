...
- (id)jsonDictionary
{
  ...
  v5 = [(BMTextUnderstandingPoemEntity *)self topic];
...
- (BMTextUnderstandingPoemEntity)initWithJSONDictionary:(id)a3 error:(id *)a4
{
  ...
  v6 = a3;
  v7 = [v6 objectForKeyedSubscript:@"person"];
...
LABEL_4:
    v9 = [v6 objectForKeyedSubscript:@"topic"];
...
LABEL_16:
      ...
      if ((v14 >> 3) == 2)
      {
        ...
        v15 = [[BMTextUnderstandingPoemEntityTopic alloc] initByReadFrom:v4];
        if (!v15)
        {
          goto LABEL_30;
        }
      ...
      else
      {
        ...
        v15 = [[BMTextUnderstandingPoemEntityPerson alloc] initByReadFrom:v4];
        if (!v15)
        {
          goto LABEL_30;
        }
...
- (NSString)description
{
  ...
  v4 = [(BMTextUnderstandingPoemEntity *)self person];
  v5 = [(BMTextUnderstandingPoemEntity *)self topic];
  v6 = [v3 initWithFormat:@"BMTextUnderstandingPoemEntity with person: %@, topic: %@", v4, v5];
