...
+ (id)protoFields;
- (BMMomentsEngagementLight)initWithJSONDictionary:(id)a3 error:(id *)a4;
- (BMMomentsEngagementLight)initWithSuggestionEvent:(id)a3 entryEvent:(id)a4;
- (BOOL)isEqual:(id)a3;
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    v5 = v4;
    v6 = [(BMMomentsEngagementLight *)self suggestionEvent];
    ...
    {
      v9 = [(BMMomentsEngagementLight *)self suggestionEvent];
...
LABEL_11:
    ...
    v13 = [(BMMomentsEngagementLight *)self entryEvent];
    v14 = [v5 entryEvent];
    if (v13 == v14)
    {
      v12 = 1;
    ...
    {
      v15 = [(BMMomentsEngagementLight *)self entryEvent];
      v16 = [v5 entryEvent];
      v12 = [v15 isEqual:v16];
    }
...
- (id)jsonDictionary
{
  ...
  v3 = [(BMMomentsEngagementLight *)self suggestionEvent];
  v4 = [v3 jsonDictionary];

  v5 = [(BMMomentsEngagementLight *)self entryEvent];
  v6 = [v5 jsonDictionary];

  v12[0] = @"suggestionEvent";
  v7 = v4;
  if (!v4)
  {
...
- (BMMomentsEngagementLight)initWithJSONDictionary:(id)a3 error:(id *)a4
{
  ...
  v6 = a3;
  v7 = [v6 objectForKeyedSubscript:@"suggestionEvent"];
  ...
  if (objc_opt_isKindOfClass())
  {
    v9 = v7;
    v24 = 0;
    v8 = [[BMMomentsEngagementLightSuggestionEvent alloc] initWithJSONDictionary:v9 error:&v24];
    v12 = v24;
    if (v12)
    {
      if (a4)
...
LABEL_4:
    v9 = [v6 objectForKeyedSubscript:@"entryEvent"];
...
LABEL_23:
    ...
    if (objc_opt_isKindOfClass())
    {
      v13 = v9;
      v23 = 0;
      v10 = [[BMMomentsEngagementLightAppEntryEvent alloc] initWithJSONDictionary:v13 error:&v23];
      v14 = v23;
      if (!v14)
      {
...
- (void)writeTo:(id)a3
{
  ...
  if (self->_suggestionEvent)
  {
    ...
    [(BMMomentsEngagementLightSuggestionEvent *)self->_suggestionEvent writeTo:v4];
  ...
  {
    PBDataWriterPlaceMark();
    [(BMMomentsEngagementLightAppEntryEvent *)self->_entryEvent writeTo:v4];
    PBDataWriterRecallMark();
  }
}
...
LABEL_16:
      ...
      if ((v14 >> 3) == 2)
      {
        ...
        v15 = [[BMMomentsEngagementLightAppEntryEvent alloc] initByReadFrom:v4];
        if (!v15)
        {
          goto LABEL_30;
        }
      ...
      else
      {
        ...
        v15 = [[BMMomentsEngagementLightSuggestionEvent alloc] initByReadFrom:v4];
        if (!v15)
        {
          goto LABEL_30;
        }
...
- (NSString)description
{
  ...
  v4 = [(BMMomentsEngagementLight *)self suggestionEvent];
  v5 = [(BMMomentsEngagementLight *)self entryEvent];
  v6 = [v3 initWithFormat:@"BMMomentsEngagementLight with suggestionEvent: %@, entryEvent: %@", v4, v5];
...
- (BMMomentsEngagementLight)initWithSuggestionEvent:(id)a3 entryEvent:(id)a4
{
  ...
  if (v9)
  {
    ...
    objc_storeStrong(&v9->_suggestionEvent, a3);
    objc_storeStrong(&v9->_entryEvent, a4);
  }
...
id __35__BMMomentsEngagementLight_columns__block_invoke_2(uint64_t a1, void *a2)
{
...
id __35__BMMomentsEngagementLight_columns__block_invoke(uint64_t a1, void *a2)
{
  v2 = [a2 eventBodyKeepingBackingData:1];
