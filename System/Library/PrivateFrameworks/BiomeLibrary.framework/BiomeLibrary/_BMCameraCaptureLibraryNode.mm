...
+ (id)AutoFocusROI
{
  ...
  v2 = [a1 configurationForAutoFocusROI];
  ...
  v10 = [objc_alloc(MEMORY[0x1E698F320]) initWithIdentifier:@"CameraCapture.AutoFocusROI" schema:v9 configuration:v2];
...
+ (id)configurationForAutoFocusROI
{
  ...
  BYTE2(v9) = 1;
  LOWORD(v9) = 1;
  v7 = [v5 _libraryStreamConfigurationWithUUID:v6 streamIdentifier:@"CameraCapture.AutoFocusROI" eventClass:objc_opt_class() storeConfig:v3 syncPolicy:v4 legacyNames:0 internalMetadata:0 enableSubscriptions:v9 enableSubscriptionSubstream:0 enableTombstoneSubstream:0 allowedClients:@"com.apple.cameracaptured" pruningTriggers:? spaceAttributionOwner:?];
