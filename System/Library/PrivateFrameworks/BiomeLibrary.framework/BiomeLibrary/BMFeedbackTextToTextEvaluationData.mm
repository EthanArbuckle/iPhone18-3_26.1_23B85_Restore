...
- (id)jsonDictionary
{
  ...
  v5 = [(BMFeedbackTextToTextEvaluationData *)self originalContent];
  v6 = [v5 jsonDictionary];

  v7 = [(BMFeedbackTextToTextEvaluationData *)self generatedContent];
...
LABEL_4:
    ...
    if (objc_opt_isKindOfClass())
    {
      v11 = v9;
      v28 = 0;
      v10 = [[BMTextContent alloc] initWithJSONDictionary:v11 error:&v28];
      v15 = v28;
      if (v15)
      {
        if (a4)
...
LABEL_34:
      ...
      if (objc_opt_isKindOfClass())
      {
        v16 = v11;
        v27 = 0;
        v12 = [[BMTextContent alloc] initWithJSONDictionary:v16 error:&v27];
        v17 = v27;
        if (!v17)
        {
...
- (NSString)description
{
  ...
  v4 = [(BMFeedbackTextToTextEvaluationData *)self commonMetadata];
  v5 = [(BMFeedbackTextToTextEvaluationData *)self originalContent];
  v6 = [(BMFeedbackTextToTextEvaluationData *)self generatedContent];
  v7 = [v3 initWithFormat:@"BMFeedbackTextToTextEvaluationData with commonMetadata: %@, originalContent: %@, generatedContent: %@", v4, v5, v6];
