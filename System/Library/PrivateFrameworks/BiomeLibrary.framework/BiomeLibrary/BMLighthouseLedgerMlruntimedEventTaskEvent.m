...
- (BOOL)isEqual:(id)a3
{
  ...
  if (objc_opt_isKindOfClass())
  {
    ...
    if (-[BMLighthouseLedgerMlruntimedEventTaskEvent hasSucceeded](self, "hasSucceeded") || [v5 hasSucceeded])
    {
      ...
      v6 = [(BMLighthouseLedgerMlruntimedEventTaskEvent *)self succeeded];
      if (v6 != [v5 succeeded])
      {
        goto LABEL_17;
      }
    ...
    if (-[BMLighthouseLedgerMlruntimedEventTaskEvent hasErrorCode](self, "hasErrorCode") && [v5 hasErrorCode])
    {
      v14 = [(BMLighthouseLedgerMlruntimedEventTaskEvent *)self errorCode];
...
- (id)jsonDictionary
{
  ...
  v4 = [(BMLighthouseLedgerMlruntimedEventTaskEvent *)self errorDomain];
...
- (NSString)description
{
  ...
  v5 = [(BMLighthouseLedgerMlruntimedEventTaskEvent *)self errorDomain];
  v6 = [MEMORY[0x1E696AD98] numberWithInt:{-[BMLighthouseLedgerMlruntimedEventTaskEvent errorCode](self, "errorCode")}];
  v7 = [v3 initWithFormat:@"BMLighthouseLedgerMlruntimedEventTaskEvent with succeeded: %@, errorDomain: %@, errorCode: %@", v4, v5, v6];
