...
- (id)jsonDictionary
{
  ...
  v5 = [(BMOasisAnalyticsTrackingStateEvent *)self metadata];
  v6 = [v5 jsonDictionary];

  v7 = [(BMOasisAnalyticsTrackingStateEvent *)self payload];
...
LABEL_34:
      ...
      if (objc_opt_isKindOfClass())
      {
        v16 = v11;
        v27 = 0;
        v12 = [[BMOasisAnalyticsTrackingStateType alloc] initWithJSONDictionary:v16 error:&v27];
        v17 = v27;
        if (!v17)
        {
...
LABEL_16:
      ...
      else if (v15 == 2)
      {
        ...
        v16 = [[BMOasisAnalyticsTrackingStateType alloc] initByReadFrom:v4];
        if (!v16)
        {
          goto LABEL_34;
        }
...
- (NSString)description
{
  ...
  v4 = [(BMOasisAnalyticsTrackingStateEvent *)self qualityTrace];
  v5 = [(BMOasisAnalyticsTrackingStateEvent *)self metadata];
  v6 = [(BMOasisAnalyticsTrackingStateEvent *)self payload];
  v7 = [v3 initWithFormat:@"BMOasisAnalyticsTrackingStateEvent with qualityTrace: %@, metadata: %@, payload: %@", v4, v5, v6];
