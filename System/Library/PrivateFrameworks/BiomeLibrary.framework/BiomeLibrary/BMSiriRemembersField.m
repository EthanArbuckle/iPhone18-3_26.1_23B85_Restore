...
- (id)jsonDictionary
{
  ...
  v4 = [(BMSiriRemembersField *)self value];
...
LABEL_7:
  ...
  if (objc_opt_isKindOfClass())
  {
    v14 = v9;
    v22 = 0;
    v10 = [[BMSiriRemembersFieldFieldValue alloc] initWithJSONDictionary:v14 error:&v22];
    v15 = v22;
    if (v15)
    {
      if (a4)
...
LABEL_16:
      ...
      if ((v14 >> 3) == 2)
      {
        ...
        v17 = [[BMSiriRemembersFieldFieldValue alloc] initByReadFrom:v4];
        if (!v17)
        {
          goto LABEL_27;
        }
...
- (NSString)description
{
  ...
  v5 = [(BMSiriRemembersField *)self value];
  v6 = [v3 initWithFormat:@"BMSiriRemembersField with key: %@, value: %@", v4, v5];
