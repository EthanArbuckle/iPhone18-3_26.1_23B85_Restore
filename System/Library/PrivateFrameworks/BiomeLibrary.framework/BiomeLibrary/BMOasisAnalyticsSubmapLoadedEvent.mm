...
+ (id)protoFields;
- (BMOasisAnalyticsSubmapLoadedEvent)initWithJSONDictionary:(id)dictionary error:(id *)error;
- (BMOasisAnalyticsSubmapLoadedEvent)initWithQualityTrace:(id)trace metadata:(id)metadata payload:(id)payload;
...
- (BOOL)isEqual:(id)equal
{
  ...
  {
    v5 = equalCopy;
    qualityTrace = [(BMOasisAnalyticsSubmapLoadedEvent *)self qualityTrace];
    ...
    {
      qualityTrace3 = [(BMOasisAnalyticsSubmapLoadedEvent *)self qualityTrace];
    ...
    metadata = [(BMOasisAnalyticsSubmapLoadedEvent *)self metadata];
    ...
    {
      metadata3 = [(BMOasisAnalyticsSubmapLoadedEvent *)self metadata];
...
LABEL_15:
    ...
    payload = [(BMOasisAnalyticsSubmapLoadedEvent *)self payload];
    payload2 = [v5 payload];
    if (payload == payload2)
    {
      v12 = 1;
    ...
    {
      payload3 = [(BMOasisAnalyticsSubmapLoadedEvent *)self payload];
      payload4 = [v5 payload];
...
LABEL_34:
      ...
      if (objc_opt_isKindOfClass())
      {
        v16 = v11;
        v27 = 0;
        v12 = [[BMOasisAnalyticsSubmapLoadedType alloc] initWithJSONDictionary:v16 error:&v27];
        v17 = v27;
        if (!v17)
        {
...
- (void)writeTo:(id)to
{
  ...
  {
    PBDataWriterPlaceMark();
    [(BMOasisAnalyticsSubmapLoadedType *)self->_payload writeTo:toCopy];
    PBDataWriterRecallMark();
  }
}
...
- (id)initByReadFrom:(id)from
{
  fromCopy = from;
  v22.receiver = self;
  v22.super_class = BMOasisAnalyticsSubmapLoadedEvent;
...
LABEL_16:
      ...
      else if (v15 == 2)
      {
        ...
        v16 = [[BMOasisAnalyticsSubmapLoadedType alloc] initByReadFrom:fromCopy];
        if (!v16)
        {
          goto LABEL_34;
        }
...
- (NSString)description
{
  ...
  metadata = [(BMOasisAnalyticsSubmapLoadedEvent *)self metadata];
  payload = [(BMOasisAnalyticsSubmapLoadedEvent *)self payload];
  v7 = [v3 initWithFormat:@"BMOasisAnalyticsSubmapLoadedEvent with qualityTrace: %@, metadata: %@, payload: %@", qualityTrace, metadata, payload];
...
- (BMOasisAnalyticsSubmapLoadedEvent)initWithQualityTrace:(id)trace metadata:(id)metadata payload:(id)payload
{
  ...
  payloadCopy = payload;
  v14.receiver = self;
  v14.super_class = BMOasisAnalyticsSubmapLoadedEvent;
...
{
  v8[3] = *MEMORY[0x1E69E9840];
  v2 = [objc_alloc(MEMORY[0x1E698F2D8]) initWithName:@"qualityTrace_json" dataType:5 requestOnly:1 extractBlock:&__block_literal_global_576];
  v3 = [objc_alloc(MEMORY[0x1E698F2D8]) initWithName:@"metadata_json" dataType:5 requestOnly:1 extractBlock:&__block_literal_global_578];
  v4 = [objc_alloc(MEMORY[0x1E698F2D8]) initWithName:@"payload_json" dataType:5 requestOnly:1 extractBlock:&__block_literal_global_580];
  v8[0] = v3;
  v8[1] = v4;
  v8[2] = v2;
  v5 = [MEMORY[0x1E695DEC8] arrayWithObjects:v8 count:3];
