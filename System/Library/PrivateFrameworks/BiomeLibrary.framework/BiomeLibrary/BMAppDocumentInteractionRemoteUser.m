...
+ (id)protoFields;
- (BMAppDocumentInteractionRemoteUser)initWithJSONDictionary:(id)a3 error:(id *)p_isa;
- (BMAppDocumentInteractionRemoteUser)initWithNameComponents:(id)a3;
- (BOOL)isEqual:(id)a3;
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    v5 = v4;
    v6 = [(BMAppDocumentInteractionRemoteUser *)self nameComponents];
    ...
    {
      v8 = [(BMAppDocumentInteractionRemoteUser *)self nameComponents];
...
- (id)jsonDictionary
{
  ...
  v2 = [(BMAppDocumentInteractionRemoteUser *)self nameComponents];
...
- (BMAppDocumentInteractionRemoteUser)initWithJSONDictionary:(id)a3 error:(id *)p_isa
{
  ...
  v6 = [a3 objectForKeyedSubscript:@"nameComponents"];
...
LABEL_13:
  ...
  if (objc_opt_isKindOfClass())
  {
    v8 = v6;
    v15 = 0;
    v7 = [[BMAppDocumentInteractionRemoteUserNameComponents alloc] initWithJSONDictionary:v8 error:&v15];
    v9 = v15;
    if (!v9)
    {
...
- (void)writeTo:(id)a3
{
  if (self->_nameComponents)
  {
    ...
    [(BMAppDocumentInteractionRemoteUserNameComponents *)self->_nameComponents writeTo:v4];
...
LABEL_16:
      ...
      if ((v14 >> 3) == 1)
      {
        ...
        v15 = [[BMAppDocumentInteractionRemoteUserNameComponents alloc] initByReadFrom:v4];
        if (!v15)
        {
          goto LABEL_25;
        }
...
- (NSString)description
{
  ...
  v4 = [(BMAppDocumentInteractionRemoteUser *)self nameComponents];
  v5 = [v3 initWithFormat:@"BMAppDocumentInteractionRemoteUser with nameComponents: %@", v4];
...
- (BMAppDocumentInteractionRemoteUser)initWithNameComponents:(id)a3
{
  ...
  if (v6)
  {
    ...
    objc_storeStrong(&v6->_nameComponents, a3);
  }
...
id __45__BMAppDocumentInteractionRemoteUser_columns__block_invoke(uint64_t a1, void *a2)
{
