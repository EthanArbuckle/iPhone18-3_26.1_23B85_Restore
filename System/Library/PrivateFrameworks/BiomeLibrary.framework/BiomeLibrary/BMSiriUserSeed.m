...
- (BOOL)isEqual:(id)a3
{
  ...
  if (objc_opt_isKindOfClass())
  {
    ...
    if (-[BMSiriUserSeed hasValidityDays](self, "hasValidityDays") || [v5 hasValidityDays])
    {
      ...
      v19 = [(BMSiriUserSeed *)self validityDays];
    ...
    if (-[BMSiriUserSeed hasSwitchedCount](self, "hasSwitchedCount") && [v5 hasSwitchedCount])
    {
      v32 = [(BMSiriUserSeed *)self switchedCount];
...
- (id)jsonDictionary
{
  ...
  v5 = [(BMSiriUserSeed *)self effectiveFrom];
  if (v5)
  {
    v6 = MEMORY[0x1E696AD98];
    v7 = [(BMSiriUserSeed *)self effectiveFrom];
  ...
  if (v10)
  {
    ...
    v12 = [(BMSiriUserSeed *)self createdOn];
  ...
  v14 = [(BMSiriUserSeed *)self adoptedOn];
  if (v14)
  {
...
- (BMSiriUserSeed)initWithJSONDictionary:(id)a3 error:(id *)a4
{
  ...
  v6 = a3;
  v7 = [v6 objectForKeyedSubscript:@"seed"];
  ...
  if (objc_opt_isKindOfClass())
  {
    ...
    if (!v11)
    {
      if (a4)
      {
        ...
        v73 = [objc_alloc(MEMORY[0x1E696AEC0]) initWithFormat:@"-initWithUUIDString: for %@ returned nil", @"seed"];
        v87[0] = v73;
...
LABEL_40:
    ...
    v22 = [(BMSiriUserSeed *)v37 initWithSeed:v69 effectiveFrom:v71 validityDays:v70 createdOn:v26 adoptedOn:v38 switchedCount:v47];
    v37 = v22;
LABEL_44:
...
- (NSString)description
{
  ...
  v4 = [(BMSiriUserSeed *)self seed];
  v5 = [(BMSiriUserSeed *)self effectiveFrom];
  v6 = [MEMORY[0x1E696AD98] numberWithUnsignedInt:{-[BMSiriUserSeed validityDays](self, "validityDays")}];
  v7 = [(BMSiriUserSeed *)self createdOn];
  v8 = [(BMSiriUserSeed *)self adoptedOn];
  v9 = [MEMORY[0x1E696AD98] numberWithUnsignedInt:{-[BMSiriUserSeed switchedCount](self, "switchedCount")}];
  v10 = [v3 initWithFormat:@"BMSiriUserSeed with seed: %@, effectiveFrom: %@, validityDays: %@, createdOn: %@, adoptedOn: %@, switchedCount: %@", v4, v5, v6, v7, v8, v9];
...
- (BMSiriUserSeed)initWithSeed:(id)a3 effectiveFrom:(id)a4 validityDays:(id)a5 createdOn:(id)a6 adoptedOn:(id)a7 switchedCount:(id)a8
{
  ...
  v19 = a8;
  v30.receiver = self;
  v30.super_class = BMSiriUserSeed;
