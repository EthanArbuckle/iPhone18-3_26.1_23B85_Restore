...
+ (id)protoFields;
- (BMMessagesSearchEventSessionIdResetStarted)initWithIsInSearchView:(id)a3;
- (BMMessagesSearchEventSessionIdResetStarted)initWithJSONDictionary:(id)a3 error:(id *)a4;
- (BOOL)isEqual:(id)a3;
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (objc_opt_isKindOfClass())
  {
    ...
    if (-[BMMessagesSearchEventSessionIdResetStarted hasIsInSearchView](self, "hasIsInSearchView") || [v5 hasIsInSearchView])
    {
      if (-[BMMessagesSearchEventSessionIdResetStarted hasIsInSearchView](self, "hasIsInSearchView") && [v5 hasIsInSearchView])
      {
        v6 = [(BMMessagesSearchEventSessionIdResetStarted *)self isInSearchView];
        v7 = v6 ^ [v5 isInSearchView] ^ 1;
      }
...
- (BMMessagesSearchEventSessionIdResetStarted)initWithJSONDictionary:(id)a3 error:(id *)a4
{
  ...
  v6 = [a3 objectForKeyedSubscript:@"isInSearchView"];
  if (!v6 || (objc_opt_class(), (objc_opt_isKindOfClass() & 1) != 0))
  {
    a4 = 0;
LABEL_4:
    self = [(BMMessagesSearchEventSessionIdResetStarted *)self initWithIsInSearchView:a4];
    v7 = self;
    goto LABEL_5;
  }
...
- (BMMessagesSearchEventSessionIdResetStarted)initWithIsInSearchView:(id)a3
{
  ...
  if (v5)
  {
    ...
    {
      v5->_hasIsInSearchView = 1;
      v5->_isInSearchView = [v4 BOOLValue];
    }
