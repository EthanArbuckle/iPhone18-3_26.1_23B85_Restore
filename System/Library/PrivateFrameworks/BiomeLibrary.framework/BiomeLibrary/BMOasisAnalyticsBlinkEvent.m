...
+ (id)protoFields;
- (BMOasisAnalyticsBlinkEvent)initWithJSONDictionary:(id)a3 error:(id *)a4;
- (BMOasisAnalyticsBlinkEvent)initWithMetadata:(id)a3 payload:(id)a4 qualityTrace:(id)a5;
- (BOOL)isEqual:(id)a3;
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    v5 = v4;
    v6 = [(BMOasisAnalyticsBlinkEvent *)self metadata];
    v7 = [v5 metadata];
    v8 = v7;
    if (v6 == v7)
    {
    ...
    {
      v9 = [(BMOasisAnalyticsBlinkEvent *)self metadata];
      v10 = [v5 metadata];
      v11 = [v9 isEqual:v10];
    ...
    v13 = [(BMOasisAnalyticsBlinkEvent *)self payload];
    v14 = [v5 payload];
    v15 = v14;
    if (v13 == v14)
    {
    ...
    {
      v16 = [(BMOasisAnalyticsBlinkEvent *)self payload];
      v17 = [v5 payload];
      v18 = [v16 isEqual:v17];
...
LABEL_15:
    ...
    v19 = [(BMOasisAnalyticsBlinkEvent *)self qualityTrace];
    v20 = [v5 qualityTrace];
    if (v19 == v20)
    {
      v12 = 1;
    ...
    {
      v21 = [(BMOasisAnalyticsBlinkEvent *)self qualityTrace];
      v22 = [v5 qualityTrace];
      v12 = [v21 isEqual:v22];
    }
...
- (id)jsonDictionary
{
  ...
  v3 = [(BMOasisAnalyticsBlinkEvent *)self metadata];
  v4 = [v3 jsonDictionary];

  v5 = [(BMOasisAnalyticsBlinkEvent *)self payload];
  v6 = [v5 jsonDictionary];

  v7 = [(BMOasisAnalyticsBlinkEvent *)self qualityTrace];
...
- (void)writeTo:(id)a3
{
  ...
  {
    PBDataWriterPlaceMark();
    [(BMOasisAnalyticsBlinkSample *)self->_payload writeTo:v4];
    PBDataWriterRecallMark();
  }
...
LABEL_16:
      ...
      else if (v15 == 2)
      {
        ...
        v16 = [[BMOasisAnalyticsBlinkSample alloc] initByReadFrom:v4];
        if (!v16)
        {
          goto LABEL_34;
        }
...
- (NSString)description
{
  ...
  v4 = [(BMOasisAnalyticsBlinkEvent *)self metadata];
  v5 = [(BMOasisAnalyticsBlinkEvent *)self payload];
  v6 = [(BMOasisAnalyticsBlinkEvent *)self qualityTrace];
  v7 = [v3 initWithFormat:@"BMOasisAnalyticsBlinkEvent with metadata: %@, payload: %@, qualityTrace: %@", v4, v5, v6];
