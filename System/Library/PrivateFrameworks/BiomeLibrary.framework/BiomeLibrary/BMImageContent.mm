...
- (id)jsonDictionary
{
  ...
  v5 = [(BMImageContent *)self metadata];
...
- (BMImageContent)initWithJSONDictionary:(id)a3 error:(id *)a4
{
  ...
  v6 = a3;
  v7 = [v6 objectForKeyedSubscript:@"imageData"];
  if (v7)
  {
    objc_opt_class();
...
LABEL_7:
  ...
  *a4 = [v24 initWithDomain:v21 code:2 userInfo:v22];
...
- (NSString)description
{
  ...
  v4 = [(BMImageContent *)self imageData];
  v5 = [(BMImageContent *)self metadata];
  v6 = [v3 initWithFormat:@"BMImageContent with imageData: %@, metadata: %@", v4, v5];
