...
+ (id)protoFields;
- (BMLighthouseLedgerTrialIdentifiers)initWithExperimentIdentifiers:(id)identifiers bmltIdentifiers:(id)bmltIdentifiers;
...
- (BOOL)isEqual:(id)equal
{
  ...
  if (objc_opt_isKindOfClass())
  {
    ...
    experimentIdentifiers2 = [v5 experimentIdentifiers];
    v8 = experimentIdentifiers2;
    if (experimentIdentifiers == experimentIdentifiers2)
    {
    }

    else
    {
      experimentIdentifiers3 = [(BMLighthouseLedgerTrialIdentifiers *)self experimentIdentifiers];
      experimentIdentifiers4 = [v5 experimentIdentifiers];
      v11 = [experimentIdentifiers3 isEqual:experimentIdentifiers4];
...
LABEL_11:
    ...
    bmltIdentifiers2 = [v5 bmltIdentifiers];
    if (bmltIdentifiers == bmltIdentifiers2)
    {
      v12 = 1;
    }
    ...
    {
      bmltIdentifiers3 = [(BMLighthouseLedgerTrialIdentifiers *)self bmltIdentifiers];
      bmltIdentifiers4 = [v5 bmltIdentifiers];
      v12 = [bmltIdentifiers3 isEqual:bmltIdentifiers4];
    }
...
LABEL_4:
    v9 = [dictionaryCopy objectForKeyedSubscript:@"bmltIdentifiers"];
...
- (void)writeTo:(id)to
{
  ...
  if (self->_experimentIdentifiers)
  {
    ...
    [(BMLighthouseLedgerTrialIdentifiersExperimentIdentifiers *)self->_experimentIdentifiers writeTo:toCopy];
  ...
  {
    PBDataWriterPlaceMark();
    [(BMLighthouseLedgerTrialIdentifiersBMLTIdentifiers *)self->_bmltIdentifiers writeTo:toCopy];
    PBDataWriterRecallMark();
  }
}
...
- (id)initByReadFrom:(id)from
{
  fromCopy = from;
  v21.receiver = self;
  v21.super_class = BMLighthouseLedgerTrialIdentifiers;
...
LABEL_16:
      ...
      if ((v14 >> 3) == 2)
      {
        ...
        v15 = [[BMLighthouseLedgerTrialIdentifiersBMLTIdentifiers alloc] initByReadFrom:fromCopy];
        if (!v15)
        {
          goto LABEL_30;
        }
      ...
      else
      {
        ...
        v15 = [[BMLighthouseLedgerTrialIdentifiersExperimentIdentifiers alloc] initByReadFrom:fromCopy];
        if (!v15)
        {
          goto LABEL_30;
        }
...
- (NSString)description
{
  ...
  experimentIdentifiers = [(BMLighthouseLedgerTrialIdentifiers *)self experimentIdentifiers];
  bmltIdentifiers = [(BMLighthouseLedgerTrialIdentifiers *)self bmltIdentifiers];
  v6 = [v3 initWithFormat:@"BMLighthouseLedgerTrialIdentifiers with experimentIdentifiers: %@, bmltIdentifiers: %@", experimentIdentifiers, bmltIdentifiers];
...
- (BMLighthouseLedgerTrialIdentifiers)initWithExperimentIdentifiers:(id)identifiers bmltIdentifiers:(id)bmltIdentifiers
{
  ...
  bmltIdentifiersCopy = bmltIdentifiers;
  v11.receiver = self;
  v11.super_class = BMLighthouseLedgerTrialIdentifiers;
  v9 = [(BMEventBase *)&v11 init];
  if (v9)
  {
    v9->_dataVersion = [objc_opt_class() latestDataVersion];
    objc_storeStrong(&v9->_experimentIdentifiers, identifiers);
    objc_storeStrong(&v9->_bmltIdentifiers, bmltIdentifiers);
  }
...
+ (id)eventWithData:(id)data dataVersion:(unsigned int)version
{
  ...
  else
  {
    ...
    v8 = [[BMLighthouseLedgerTrialIdentifiers alloc] initByReadFrom:v7];
    v4 = v8;
    if (v8)
    {
      v8[4] = 0;
