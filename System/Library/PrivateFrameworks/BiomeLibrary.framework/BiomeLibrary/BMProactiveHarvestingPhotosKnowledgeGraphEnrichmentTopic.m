...
- (NSString)description
{
  ...
  v4 = [(BMProactiveHarvestingPhotosKnowledgeGraphEnrichmentTopic *)self identifier];
  v5 = MEMORY[0x1E696AD98];
  [(BMProactiveHarvestingPhotosKnowledgeGraphEnrichmentTopic *)self score];
  v6 = [v5 numberWithDouble:?];
  v7 = [v3 initWithFormat:@"BMProactiveHarvestingPhotosKnowledgeGraphEnrichmentTopic with identifier: %@, score: %@", v4, v6];
