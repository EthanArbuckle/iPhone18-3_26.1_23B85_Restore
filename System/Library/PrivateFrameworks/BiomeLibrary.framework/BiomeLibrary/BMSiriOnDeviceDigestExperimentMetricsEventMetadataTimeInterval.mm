...
+ (id)protoFields;
- (BMSiriOnDeviceDigestExperimentMetricsEventMetadataTimeInterval)initWithJSONDictionary:(id)dictionary error:(id *)error;
- (BMSiriOnDeviceDigestExperimentMetricsEventMetadataTimeInterval)initWithStartTimestampInSecondsSince1970:(id)since1970 numberOfSeconds:(id)seconds;
...
- (BOOL)isEqual:(id)equal
{
  ...
  if (objc_opt_isKindOfClass())
  {
    ...
    if (-[BMSiriOnDeviceDigestExperimentMetricsEventMetadataTimeInterval hasStartTimestampInSecondsSince1970](self, "hasStartTimestampInSecondsSince1970") || [v5 hasStartTimestampInSecondsSince1970])
    {
      ...
      startTimestampInSecondsSince1970 = [(BMSiriOnDeviceDigestExperimentMetricsEventMetadataTimeInterval *)self startTimestampInSecondsSince1970];
    ...
    if (-[BMSiriOnDeviceDigestExperimentMetricsEventMetadataTimeInterval hasNumberOfSeconds](self, "hasNumberOfSeconds") && [v5 hasNumberOfSeconds])
    {
      numberOfSeconds = [(BMSiriOnDeviceDigestExperimentMetricsEventMetadataTimeInterval *)self numberOfSeconds];
...
- (id)jsonDictionary
{
  ...
  if ([(BMSiriOnDeviceDigestExperimentMetricsEventMetadataTimeInterval *)self hasStartTimestampInSecondsSince1970])
  {
    v3 = [MEMORY[0x1E696AD98] numberWithUnsignedLongLong:{-[BMSiriOnDeviceDigestExperimentMetricsEventMetadataTimeInterval startTimestampInSecondsSince1970](self, "startTimestampInSecondsSince1970")}];
  }
  ...
  {
    v4 = [MEMORY[0x1E696AD98] numberWithUnsignedInt:{-[BMSiriOnDeviceDigestExperimentMetricsEventMetadataTimeInterval numberOfSeconds](self, "numberOfSeconds")}];
  }
...
- (id)initByReadFrom:(id)from
{
  fromCopy = from;
  v32.receiver = self;
  v32.super_class = BMSiriOnDeviceDigestExperimentMetricsEventMetadataTimeInterval;
...
- (NSString)description
{
  ...
  v4 = [MEMORY[0x1E696AD98] numberWithUnsignedLongLong:{-[BMSiriOnDeviceDigestExperimentMetricsEventMetadataTimeInterval startTimestampInSecondsSince1970](self, "startTimestampInSecondsSince1970")}];
  v5 = [MEMORY[0x1E696AD98] numberWithUnsignedInt:{-[BMSiriOnDeviceDigestExperimentMetricsEventMetadataTimeInterval numberOfSeconds](self, "numberOfSeconds")}];
  v6 = [v3 initWithFormat:@"BMSiriOnDeviceDigestExperimentMetricsEventMetadataTimeInterval with startTimestampInSecondsSince1970: %@, numberOfSeconds: %@", v4, v5];
...
- (BMSiriOnDeviceDigestExperimentMetricsEventMetadataTimeInterval)initWithStartTimestampInSecondsSince1970:(id)since1970 numberOfSeconds:(id)seconds
{
  ...
  secondsCopy = seconds;
  v12.receiver = self;
  v12.super_class = BMSiriOnDeviceDigestExperimentMetricsEventMetadataTimeInterval;
...
+ (id)eventWithData:(id)data dataVersion:(unsigned int)version
{
  ...
  else
  {
    ...
    v8 = [[BMSiriOnDeviceDigestExperimentMetricsEventMetadataTimeInterval alloc] initByReadFrom:v7];
    v4 = v8;
    if (v8)
    {
      v8[5] = 0;
