...
+ (id)PersonalInference
{
  ...
  v2 = [a1 configurationForPersonalInference];
  ...
  v10 = [objc_alloc(MEMORY[0x1E698F320]) initWithIdentifier:@"HumanUnderstanding.PersonalInference" schema:v9 configuration:v2];
