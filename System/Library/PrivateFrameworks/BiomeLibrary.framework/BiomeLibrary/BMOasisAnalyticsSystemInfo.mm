...
LABEL_16:
      ...
      if ((v14 >> 3) == 1)
      {
        ...
        v15 = [[BMOasisAnalyticsSystemInfoPayload alloc] initByReadFrom:v4];
        if (!v15)
        {
          goto LABEL_25;
        }
...
- (NSString)description
{
  ...
  v4 = [(BMOasisAnalyticsSystemInfo *)self payload];
  v5 = [v3 initWithFormat:@"BMOasisAnalyticsSystemInfo with payload: %@", v4];
