...
- (id)jsonDictionary
{
  ...
  v4 = [(BMMLSEShareSheetFeedbackTrialIdentifier *)self trialTreatmentId];
  v5 = [(BMMLSEShareSheetFeedbackTrialIdentifier *)self trialDeploymentId];
...
LABEL_4:
    ...
    v11 = [v6 objectForKeyedSubscript:@"trialDeploymentId"];
...
- (NSString)description
{
  ...
  v4 = [(BMMLSEShareSheetFeedbackTrialIdentifier *)self trialExperimentId];
  v5 = [(BMMLSEShareSheetFeedbackTrialIdentifier *)self trialTreatmentId];
  v6 = [(BMMLSEShareSheetFeedbackTrialIdentifier *)self trialDeploymentId];
  v7 = [v3 initWithFormat:@"BMMLSEShareSheetFeedbackTrialIdentifier with trialExperimentId: %@, trialTreatmentId: %@, trialDeploymentId: %@", v4, v5, v6];
...
- (BMMLSEShareSheetFeedbackTrialIdentifier)initWithTrialExperimentId:(id)a3 trialTreatmentId:(id)a4 trialDeploymentId:(id)a5
{
  ...
  if (v12)
  {
    ...
    objc_storeStrong(&v12->_trialTreatmentId, a4);
    objc_storeStrong(&v12->_trialDeploymentId, a5);
  }
