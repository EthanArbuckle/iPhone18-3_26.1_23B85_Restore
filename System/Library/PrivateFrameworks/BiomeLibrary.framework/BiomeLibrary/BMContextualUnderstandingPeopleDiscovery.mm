...
- (id)_discoveredPersonsJSONArray
{
  ...
  v14 = 0u;
  v15 = 0u;
  v4 = [(BMContextualUnderstandingPeopleDiscovery *)self discoveredPersons];
...
- (BMContextualUnderstandingPeopleDiscovery)initWithJSONDictionary:(id)a3 error:(id *)p_isa
{
  ...
  v6 = [a3 objectForKeyedSubscript:@"discoveredPersons"];
...
LABEL_8:
    ...
    while (1)
    {
      ...
      v35 = 0;
      v17 = [(BMContextualUnderstandingPeopleDiscoveryPerson *)v16 initWithJSONDictionary:v15 error:&v35];
      v18 = v35;
      if (v18)
      {
        v25 = v18;
...
LABEL_16:
      ...
      if ((v15 >> 3) == 1)
      {
        v25[0] = 0;
        v25[1] = 0;
        if (!PBReaderPlaceMark() || (v16 = [[BMContextualUnderstandingPeopleDiscoveryPerson alloc] initByReadFrom:v4]) == 0)
        {
LABEL_26:
...
- (NSString)description
{
  ...
  v4 = [(BMContextualUnderstandingPeopleDiscovery *)self discoveredPersons];
  v5 = [v3 initWithFormat:@"BMContextualUnderstandingPeopleDiscovery with discoveredPersons: %@", v4];
...
- (BMContextualUnderstandingPeopleDiscovery)initWithDiscoveredPersons:(id)a3
{
  ...
  if (v6)
  {
    ...
    objc_storeStrong(&v6->_discoveredPersons, a3);
  }
...
id __51__BMContextualUnderstandingPeopleDiscovery_columns__block_invoke(uint64_t a1, void *a2)
{
  ...
  v3 = [v2 _discoveredPersonsJSONArray];
