...
LABEL_16:
      ...
      if ((v14 >> 3) == 1)
      {
        ...
        v15 = [[BMOasisAnalyticsDeviceWornEvent alloc] initByReadFrom:v4];
        if (!v15)
        {
          goto LABEL_25;
        }
...
- (NSString)description
{
  ...
  v4 = [(BMOasisAnalyticsDeviceWornPayload *)self deviceWorn];
  v5 = [v3 initWithFormat:@"BMOasisAnalyticsDeviceWornPayload with deviceWorn: %@", v4];
...
- (BMOasisAnalyticsDeviceWornPayload)initWithDeviceWorn:(id)a3
{
  ...
  if (v6)
  {
    ...
    objc_storeStrong(&v6->_deviceWorn, a3);
  }
