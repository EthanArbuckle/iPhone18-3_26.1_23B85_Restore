...
- (NSString)description
{
  ...
  v4 = [(BMPhotosLive *)self identifier];
  v5 = [(BMPhotosLive *)self subset];
  v6 = BMPhotosLiveTypeAsString([(BMPhotosLive *)self type]);
  v7 = [v3 initWithFormat:@"BMPhotosLive with identifier: %@, subset: %@, type: %@", v4, v5, v6];
