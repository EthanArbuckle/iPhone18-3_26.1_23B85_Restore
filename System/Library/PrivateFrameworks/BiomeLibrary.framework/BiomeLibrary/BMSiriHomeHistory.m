...
- (id)jsonDictionary
{
  ...
  v5 = [(BMSiriHomeHistory *)self _entitiesJSONArray];
  v11[0] = @"interaction";
  v6 = v4;
  if (!v4)
  {
...
- (id)_entitiesJSONArray
{
  ...
  v14 = 0u;
  v15 = 0u;
  v4 = [(BMSiriHomeHistory *)self entities];
...
LABEL_19:
  ...
  v8 = v40;
  self = [(BMSiriHomeHistory *)self initWithInteraction:v40 entities:v12];
  v22 = self;
  v7 = v41;
  v6 = v42;
LABEL_36:
...
- (id)initByReadFrom:(id)a3
{
  v4 = a3;
  v26.receiver = self;
  v26.super_class = BMSiriHomeHistory;
...
- (NSString)description
{
  ...
  v4 = [(BMSiriHomeHistory *)self interaction];
  v5 = [(BMSiriHomeHistory *)self entities];
  v6 = [v3 initWithFormat:@"BMSiriHomeHistory with interaction: %@, entities: %@", v4, v5];
...
- (BMSiriHomeHistory)initWithInteraction:(id)a3 entities:(id)a4
{
  ...
  v8 = a4;
  v11.receiver = self;
  v11.super_class = BMSiriHomeHistory;
...
{
  v7[2] = *MEMORY[0x1E69E9840];
  v2 = [objc_alloc(MEMORY[0x1E698F2D8]) initWithName:@"interaction_json" dataType:5 requestOnly:1 extractBlock:&__block_literal_global_80126];
  v3 = [objc_alloc(MEMORY[0x1E698F2D8]) initWithName:@"entities_json" dataType:5 requestOnly:1 extractBlock:&__block_literal_global_35_80127];
  v7[0] = v2;
  v7[1] = v3;
  v4 = [MEMORY[0x1E695DEC8] arrayWithObjects:v7 count:2];
...
+ (id)eventWithData:(id)a3 dataVersion:(unsigned int)a4
{
  ...
  else
  {
    ...
    v8 = [[BMSiriHomeHistory alloc] initByReadFrom:v7];
    v4 = v8;
    if (v8)
    {
      v8[4] = 0;
