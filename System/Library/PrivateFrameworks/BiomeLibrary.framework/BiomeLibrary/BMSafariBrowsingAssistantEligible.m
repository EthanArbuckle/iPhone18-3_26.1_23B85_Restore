...
+ (id)protoFields;
- (BMSafariBrowsingAssistantEligible)initWithJSONDictionary:(id)a3 error:(id *)p_isa;
...
- (NSString)description
{
  ...
  v4 = [(BMSafariBrowsingAssistantEligible *)self webpageViewIdentifier];
  v5 = [v3 initWithFormat:@"BMSafariBrowsingAssistantEligible with webpageViewIdentifier: %@", v4];
