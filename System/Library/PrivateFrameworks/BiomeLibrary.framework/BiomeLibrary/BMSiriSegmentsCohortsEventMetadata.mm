...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    v5 = v4;
    v6 = [(BMSiriSegmentsCohortsEventMetadata *)self oddId];
    v7 = [v5 oddId];
    v8 = v7;
    if (v6 == v7)
    {
    ...
    {
      v9 = [(BMSiriSegmentsCohortsEventMetadata *)self oddId];
      v10 = [v5 oddId];
      v11 = [v9 isEqual:v10];
    ...
    v13 = [(BMSiriSegmentsCohortsEventMetadata *)self deviceAggregationId];
    ...
    {
      v16 = [(BMSiriSegmentsCohortsEventMetadata *)self deviceAggregationId];
    ...
    v19 = [(BMSiriSegmentsCohortsEventMetadata *)self userAggregationId];
    ...
    {
      v22 = [(BMSiriSegmentsCohortsEventMetadata *)self userAggregationId];
    ...
    if (-[BMSiriSegmentsCohortsEventMetadata hasEventTimestampInMSSince1970](self, "hasEventTimestampInMSSince1970") || [v5 hasEventTimestampInMSSince1970])
    {
      ...
      v25 = [(BMSiriSegmentsCohortsEventMetadata *)self eventTimestampInMSSince1970];
    ...
    v26 = [(BMSiriSegmentsCohortsEventMetadata *)self timeInterval];
    v27 = [v5 timeInterval];
    v28 = v27;
    if (v26 == v27)
    {
    ...
    {
      v29 = [(BMSiriSegmentsCohortsEventMetadata *)self timeInterval];
      v30 = [v5 timeInterval];
      v31 = [v29 isEqual:v30];
    ...
    if (!-[BMSiriSegmentsCohortsEventMetadata hasUserAggregationIdRotationTimestampInMs](self, "hasUserAggregationIdRotationTimestampInMs") && ![v5 hasUserAggregationIdRotationTimestampInMs] || -[BMSiriSegmentsCohortsEventMetadata hasUserAggregationIdRotationTimestampInMs](self, "hasUserAggregationIdRotationTimestampInMs") && objc_msgSend(v5, "hasUserAggregationIdRotationTimestampInMs") && (v32 = -[BMSiriSegmentsCohortsEventMetadata userAggregationIdRotationTimestampInMs](self, "userAggregationIdRotationTimestampInMs"), v32 == objc_msgSend(v5, "userAggregationIdRotationTimestampInMs")))
    {
      if (!-[BMSiriSegmentsCohortsEventMetadata hasUserAggregationIdExpirationTimestampInMs](self, "hasUserAggregationIdExpirationTimestampInMs") && ![v5 hasUserAggregationIdExpirationTimestampInMs] || -[BMSiriSegmentsCohortsEventMetadata hasUserAggregationIdExpirationTimestampInMs](self, "hasUserAggregationIdExpirationTimestampInMs") && objc_msgSend(v5, "hasUserAggregationIdExpirationTimestampInMs") && (v33 = -[BMSiriSegmentsCohortsEventMetadata userAggregationIdExpirationTimestampInMs](self, "userAggregationIdExpirationTimestampInMs"), v33 == objc_msgSend(v5, "userAggregationIdExpirationTimestampInMs")))
      {
        if (!-[BMSiriSegmentsCohortsEventMetadata hasEventOrigin](self, "hasEventOrigin") && ![v5 hasEventOrigin] || -[BMSiriSegmentsCohortsEventMetadata hasEventOrigin](self, "hasEventOrigin") && objc_msgSend(v5, "hasEventOrigin") && (v34 = -[BMSiriSegmentsCohortsEventMetadata eventOrigin](self, "eventOrigin"), v34 == objc_msgSend(v5, "eventOrigin")))
        {
          ...
          if (-[BMSiriSegmentsCohortsEventMetadata hasIsLongLivedIDUploadDisabled](self, "hasIsLongLivedIDUploadDisabled") && [v5 hasIsLongLivedIDUploadDisabled])
          {
            v35 = [(BMSiriSegmentsCohortsEventMetadata *)self isLongLivedIDUploadDisabled];
...
- (id)jsonDictionary
{
  ...
  v3 = [(BMSiriSegmentsCohortsEventMetadata *)self oddId];
  v4 = [(BMSiriSegmentsCohortsEventMetadata *)self deviceAggregationId];
  v5 = [(BMSiriSegmentsCohortsEventMetadata *)self userAggregationId];
  if ([(BMSiriSegmentsCohortsEventMetadata *)self hasEventTimestampInMSSince1970])
  {
  ...
  v7 = [(BMSiriSegmentsCohortsEventMetadata *)self timeInterval];
  v8 = [v7 jsonDictionary];

  if ([(BMSiriSegmentsCohortsEventMetadata *)self hasUserAggregationIdRotationTimestampInMs])
  {
    v33 = [MEMORY[0x1E696AD98] numberWithUnsignedLongLong:{-[BMSiriSegmentsCohortsEventMetadata userAggregationIdRotationTimestampInMs](self, "userAggregationIdRotationTimestampInMs")}];
  }
  ...
  {
    v32 = [MEMORY[0x1E696AD98] numberWithUnsignedLongLong:{-[BMSiriSegmentsCohortsEventMetadata userAggregationIdExpirationTimestampInMs](self, "userAggregationIdExpirationTimestampInMs")}];
  }
...
LABEL_59:
      ...
      v19 = v13;
      v94 = 0;
      v86 = [[BMSiriSegmentsCohortsEventMetadataTimeInterval alloc] initWithJSONDictionary:v19 error:&v94];
      v20 = v94;
      if (v20)
      {
        if (v84)
...
LABEL_56:
    ...
    v21 = [(BMSiriSegmentsCohortsEventMetadata *)v87 initWithOddId:v93 deviceAggregationId:v82 userAggregationId:v90 eventTimestampInMSSince1970:v92 timeInterval:v86 userAggregationIdRotationTimestampInMs:v79 userAggregationIdExpirationTimestampInMs:v78 eventOrigin:v34 isLongLivedIDUploadDisabled:v36];
    v87 = v21;
LABEL_53:
...
- (void)writeTo:(id)a3
{
  ...
  if (self->_timeInterval)
  {
    ...
    [(BMSiriSegmentsCohortsEventMetadataTimeInterval *)self->_timeInterval writeTo:v4];
...
LABEL_91:
        ...
        v45 = [[BMSiriSegmentsCohortsEventMetadataTimeInterval alloc] initByReadFrom:v4];
        if (!v45)
        {
          goto LABEL_105;
        }
...
- (NSString)description
{
  ...
  v12 = [v14 initWithFormat:@"BMSiriSegmentsCohortsEventMetadata with oddId: %@, deviceAggregationId: %@, userAggregationId: %@, eventTimestampInMSSince1970: %@, timeInterval: %@, userAggregationIdRotationTimestampInMs: %@, userAggregationIdExpirationTimestampInMs: %@, eventOrigin: %@, isLongLivedIDUploadDisabled: %@", v3, v4, v5, v6, v7, v8, v9, v10, v11];
...
id __45__BMSiriSegmentsCohortsEventMetadata_columns__block_invoke(uint64_t a1, void *a2)
{
