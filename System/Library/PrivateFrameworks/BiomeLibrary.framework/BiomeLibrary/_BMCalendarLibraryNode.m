...
+ (id)EventTitle
{
  ...
  v2 = [a1 configurationForEventTitle];
  ...
  v10 = [objc_alloc(MEMORY[0x1E698F320]) initWithIdentifier:@"Calendar.EventTitle" schema:v9 configuration:v2];
...
+ (id)configurationForEventTitle
{
  ...
  BYTE2(v9) = 1;
  LOWORD(v9) = 1;
  v7 = [v5 _libraryStreamConfigurationWithUUID:v6 streamIdentifier:@"Calendar.EventTitle" eventClass:objc_opt_class() storeConfig:v3 syncPolicy:v4 legacyNames:0 internalMetadata:0 enableSubscriptions:v9 enableSubscriptionSubstream:0 enableTombstoneSubstream:0 allowedClients:@"com.apple.mobilecal" pruningTriggers:? spaceAttributionOwner:?];
