...
- (BMGameCenterAchievementEarned)initWithJSONDictionary:(id)a3 error:(id *)a4
{
  ...
  v6 = a3;
  v7 = [v6 objectForKeyedSubscript:@"achievementID"];
...
LABEL_16:
      ...
      if ((v14 >> 3) == 2)
      {
        ...
        {
          v19 = [v4 data];
          [v19 getBytes:&v24 range:{objc_msgSend(v4, "position"), 4}];
...
- (NSString)description
{
  ...
  v4 = [(BMGameCenterAchievementEarned *)self achievementID];
  v5 = MEMORY[0x1E696AD98];
  [(BMGameCenterAchievementEarned *)self achievementRarityPercent];
  v6 = [v5 numberWithDouble:?];
  v7 = [v3 initWithFormat:@"BMGameCenterAchievementEarned with achievementID: %@, achievementRarityPercent: %@", v4, v6];
...
- (BMGameCenterAchievementEarned)initWithAchievementID:(id)a3 achievementRarityPercent:(id)a4
{
  ...
  if (v9)
  {
    ...
    objc_storeStrong(&v9->_achievementID, a3);
    if (v8)
    {
