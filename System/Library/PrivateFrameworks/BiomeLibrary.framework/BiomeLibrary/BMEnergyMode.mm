...
- (BMEnergyMode)initWithMode:(int)mode reason:(int)reason;
...
- (BOOL)isEqual:(id)equal
{
  ...
  {
    v5 = equalCopy;
    mode = [(BMEnergyMode *)self mode];
    if (mode == [v5 mode])
    {
      reason = [(BMEnergyMode *)self reason];
      v8 = reason == [v5 reason];
    }
...
- (BMEnergyMode)initWithJSONDictionary:(id)dictionary error:(id *)error
{
  ...
  if (v7 && (objc_opt_class(), (objc_opt_isKindOfClass() & 1) == 0))
  {
    ...
    else
    {
      ...
      v9 = [MEMORY[0x1E696AD98] numberWithInt:BMEnergyModeModeFromString(v7)];
    }
  ...
  if (v10 && (objc_opt_class(), (objc_opt_isKindOfClass() & 1) == 0))
  {
    ...
    else
    {
      ...
      v12 = [MEMORY[0x1E696AD98] numberWithInt:BMEnergyModeReasonFromString(v10)];
    }
...
LABEL_46:
        ...
        v28 = &OBJC_IVAR___BMEnergyMode__mode;
      }
      ...
      else
      {
        ...
        if (([fromCopy hasError] & 1) != 0 || (LODWORD(v24) = v17, v17 > 9))
        {
LABEL_42:
          LODWORD(v24) = 0;
        }

        v28 = &OBJC_IVAR___BMEnergyMode__reason;
      }
...
- (NSString)description
{
  ...
  v4 = BMEnergyModeModeAsString([(BMEnergyMode *)self mode]);
  v5 = BMEnergyModeReasonAsString([(BMEnergyMode *)self reason]);
  v6 = [v3 initWithFormat:@"BMEnergyMode with mode: %@, reason: %@", v4, v5];
...
+ (id)eventWithData:(id)data dataVersion:(unsigned int)version
{
  ...
  else
  {
    ...
    v8 = [[BMEnergyMode alloc] initByReadFrom:v7];
    v4 = v8;
    if (v8)
    {
      v8[4] = 0;
