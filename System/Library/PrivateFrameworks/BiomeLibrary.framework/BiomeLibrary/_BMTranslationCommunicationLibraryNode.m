...
+ (id)streamWithName:(id)a3
{
  if ([a3 isEqualToString:@"LanguageCode"])
  {
    v4 = [a1 LanguageCode];
  }
...
+ (id)configurationForLanguageCode
{
  v3 = [a1 storeConfigurationForLanguageCode];
  v4 = [a1 syncPolicyForLanguageCode];
...
+ (id)LanguageCode
{
  ...
  v2 = [a1 configurationForLanguageCode];
  ...
  v10 = [objc_alloc(MEMORY[0x1E698F320]) initWithIdentifier:@"Translation.Communication.LanguageCode" schema:v9 configuration:v2];
