...
+ (id)protoFields;
- (BMWalletPaymentsCommerceTransactionAccount)initWithInstitutionName:(id)a3 lastFourDigits:(id)a4 accountIdentifier:(id)a5;
- (BMWalletPaymentsCommerceTransactionAccount)initWithJSONDictionary:(id)a3 error:(id *)a4;
- (BOOL)isEqual:(id)a3;
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    v5 = v4;
    v6 = [(BMWalletPaymentsCommerceTransactionAccount *)self institutionName];
    v7 = [v5 institutionName];
    v8 = v7;
    if (v6 == v7)
    {
    }
    ...
    {
      v9 = [(BMWalletPaymentsCommerceTransactionAccount *)self institutionName];
      v10 = [v5 institutionName];
      v11 = [v9 isEqual:v10];
    ...
    v13 = [(BMWalletPaymentsCommerceTransactionAccount *)self lastFourDigits];
    ...
    {
      v16 = [(BMWalletPaymentsCommerceTransactionAccount *)self lastFourDigits];
...
LABEL_15:
    ...
    v19 = [(BMWalletPaymentsCommerceTransactionAccount *)self accountIdentifier];
    ...
    {
      v21 = [(BMWalletPaymentsCommerceTransactionAccount *)self accountIdentifier];
      v22 = [v5 accountIdentifier];
      v12 = [v21 isEqual:v22];
    }
...
- (id)jsonDictionary
{
  ...
  v3 = [(BMWalletPaymentsCommerceTransactionAccount *)self institutionName];
  v4 = [(BMWalletPaymentsCommerceTransactionAccount *)self lastFourDigits];
  v5 = [(BMWalletPaymentsCommerceTransactionAccount *)self accountIdentifier];
...
- (BMWalletPaymentsCommerceTransactionAccount)initWithJSONDictionary:(id)a3 error:(id *)a4
{
  ...
  v6 = a3;
  v7 = [v6 objectForKeyedSubscript:@"institutionName"];
...
LABEL_4:
    ...
    v11 = [v6 objectForKeyedSubscript:@"accountIdentifier"];
...
- (NSString)description
{
  ...
  v4 = [(BMWalletPaymentsCommerceTransactionAccount *)self institutionName];
  v5 = [(BMWalletPaymentsCommerceTransactionAccount *)self lastFourDigits];
  v6 = [(BMWalletPaymentsCommerceTransactionAccount *)self accountIdentifier];
  v7 = [v3 initWithFormat:@"BMWalletPaymentsCommerceTransactionAccount with institutionName: %@, lastFourDigits: %@, accountIdentifier: %@", v4, v5, v6];
...
- (BMWalletPaymentsCommerceTransactionAccount)initWithInstitutionName:(id)a3 lastFourDigits:(id)a4 accountIdentifier:(id)a5
{
  ...
  if (v12)
  {
    ...
    objc_storeStrong(&v12->_institutionName, a3);
    objc_storeStrong(&v12->_lastFourDigits, a4);
    objc_storeStrong(&v12->_accountIdentifier, a5);
  }
