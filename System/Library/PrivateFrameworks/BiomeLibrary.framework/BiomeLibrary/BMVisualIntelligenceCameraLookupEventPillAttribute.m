...
+ (id)protoFields;
- (BMVisualIntelligenceCameraLookupEventPillAttribute)initWithIsMaybe:(id)a3 pillType:(int)a4;
- (BMVisualIntelligenceCameraLookupEventPillAttribute)initWithJSONDictionary:(id)a3 error:(id *)a4;
- (BOOL)isEqual:(id)a3;
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (objc_opt_isKindOfClass())
  {
    ...
    {
      v8 = [(BMVisualIntelligenceCameraLookupEventPillAttribute *)self pillType];
      v7 = v8 == [v5 pillType];
    }
...
- (BMVisualIntelligenceCameraLookupEventPillAttribute)initWithJSONDictionary:(id)a3 error:(id *)a4
{
  ...
  v6 = a3;
  v7 = [v6 objectForKeyedSubscript:@"isMaybe"];
  ...
  v9 = [v6 objectForKeyedSubscript:@"pillType"];
