...
LABEL_12:
    ...
    v19 = [(BMPhotosEngagement *)self type];
    v12 = v19 == [v5 type];
    goto LABEL_12;
  }
...
- (id)jsonDictionary
{
  ...
  v4 = [(BMPhotosEngagement *)self subset];
...
- (NSString)description
{
  ...
  v4 = [(BMPhotosEngagement *)self identifier];
  v5 = [(BMPhotosEngagement *)self subset];
  v6 = BMPhotosEngagementTypeAsString([(BMPhotosEngagement *)self type]);
  v7 = [v3 initWithFormat:@"BMPhotosEngagement with identifier: %@, subset: %@, type: %@", v4, v5, v6];
