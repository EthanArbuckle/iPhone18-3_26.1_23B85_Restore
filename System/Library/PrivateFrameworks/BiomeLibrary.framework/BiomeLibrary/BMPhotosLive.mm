...
+ (id)protoFields;
- (BMPhotosLive)initWithIdentifier:(id)identifier subset:(id)subset type:(int)type;
- (BMPhotosLive)initWithJSONDictionary:(id)dictionary error:(id *)error;
...
- (BOOL)isEqual:(id)equal
{
  ...
  {
    v5 = equalCopy;
    identifier = [(BMPhotosLive *)self identifier];
    ...
    {
      identifier3 = [(BMPhotosLive *)self identifier];
    ...
    subset = [(BMPhotosLive *)self subset];
    subset2 = [v5 subset];
    v15 = subset2;
    if (subset == subset2)
    {
    ...
    {
      subset3 = [(BMPhotosLive *)self subset];
      subset4 = [v5 subset];
...
- (id)jsonDictionary
{
  ...
  identifier = [(BMPhotosLive *)self identifier];
  subset = [(BMPhotosLive *)self subset];
  v5 = [MEMORY[0x1E696AD98] numberWithInt:{-[BMPhotosLive type](self, "type")}];
  v12[0] = @"identifier";
  null = identifier;
  if (!identifier)
  {
...
LABEL_4:
    ...
    if (v11 && (objc_opt_class(), (objc_opt_isKindOfClass() & 1) == 0))
    {
      ...
      else
      {
        ...
        v13 = [MEMORY[0x1E696AD98] numberWithInt:BMPhotosLiveTypeFromString(v11)];
      }
...
- (NSString)description
{
  ...
  identifier = [(BMPhotosLive *)self identifier];
  subset = [(BMPhotosLive *)self subset];
  v6 = BMPhotosLiveTypeAsString([(BMPhotosLive *)self type]);
  v7 = [v3 initWithFormat:@"BMPhotosLive with identifier: %@, subset: %@, type: %@", identifier, subset, v6];
...
+ (id)eventWithData:(id)data dataVersion:(unsigned int)version
{
  ...
  else
  {
    ...
    v8 = [[BMPhotosLive alloc] initByReadFrom:v7];
    v4 = v8;
    if (v8)
    {
      v8[4] = 0;
