...
- (NSString)description
{
  ...
  v4 = [(BMPhotosSearch *)self identifier];
  v5 = [(BMPhotosSearch *)self subset];
  v6 = BMPhotosSearchTypeAsString([(BMPhotosSearch *)self type]);
  v7 = [v3 initWithFormat:@"BMPhotosSearch with identifier: %@, subset: %@, type: %@", v4, v5, v6];
