...
- (id)jsonDictionary
{
  ...
  v4 = [(BMPhotosAddToMemories *)self subset];
  v10[0] = @"identifier";
  v5 = v3;
  if (!v3)
  {
...
- (NSString)description
{
  ...
  v4 = [(BMPhotosAddToMemories *)self identifier];
  v5 = [(BMPhotosAddToMemories *)self subset];
  v6 = [v3 initWithFormat:@"BMPhotosAddToMemories with identifier: %@, subset: %@", v4, v5];
