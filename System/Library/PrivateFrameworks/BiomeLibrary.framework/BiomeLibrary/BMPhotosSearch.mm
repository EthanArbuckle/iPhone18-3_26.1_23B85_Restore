...
+ (id)protoFields;
- (BMPhotosSearch)initWithIdentifier:(id)identifier subset:(id)subset type:(int)type;
- (BMPhotosSearch)initWithJSONDictionary:(id)dictionary error:(id *)error;
...
- (BOOL)isEqual:(id)equal
{
  ...
  {
    v5 = equalCopy;
    identifier = [(BMPhotosSearch *)self identifier];
    ...
    {
      identifier3 = [(BMPhotosSearch *)self identifier];
    ...
    subset = [(BMPhotosSearch *)self subset];
    subset2 = [v5 subset];
    v15 = subset2;
    if (subset == subset2)
    {
    ...
    {
      subset3 = [(BMPhotosSearch *)self subset];
      subset4 = [v5 subset];
...
- (id)jsonDictionary
{
  ...
  identifier = [(BMPhotosSearch *)self identifier];
  subset = [(BMPhotosSearch *)self subset];
  v5 = [MEMORY[0x1E696AD98] numberWithInt:{-[BMPhotosSearch type](self, "type")}];
  v12[0] = @"identifier";
  null = identifier;
  if (!identifier)
  {
...
LABEL_4:
    ...
    if (v11 && (objc_opt_class(), (objc_opt_isKindOfClass() & 1) == 0))
    {
      ...
      else
      {
        ...
        v13 = [MEMORY[0x1E696AD98] numberWithInt:{bsearch_b(v11, BMPhotosSearchTypeFromString_sortedStrings, 1uLL, 8uLL, &__block_literal_global_11397) != 0}];
      }
...
- (id)initByReadFrom:(id)from
{
  fromCopy = from;
  v29.receiver = self;
  v29.super_class = BMPhotosSearch;
...
- (NSString)description
{
  ...
  identifier = [(BMPhotosSearch *)self identifier];
  subset = [(BMPhotosSearch *)self subset];
  v6 = BMPhotosSearchTypeAsString([(BMPhotosSearch *)self type]);
  v7 = [v3 initWithFormat:@"BMPhotosSearch with identifier: %@, subset: %@, type: %@", identifier, subset, v6];
...
- (BMPhotosSearch)initWithIdentifier:(id)identifier subset:(id)subset type:(int)type
{
  ...
  subsetCopy = subset;
  v13.receiver = self;
  v13.super_class = BMPhotosSearch;
...
+ (id)eventWithData:(id)data dataVersion:(unsigned int)version
{
  ...
  else
  {
    ...
    v8 = [[BMPhotosSearch alloc] initByReadFrom:v7];
    v4 = v8;
    if (v8)
    {
      v8[4] = 0;
