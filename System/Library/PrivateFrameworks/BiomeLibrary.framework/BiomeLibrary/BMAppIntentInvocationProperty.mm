...
- (id)jsonDictionary
{
  ...
  v4 = [(BMAppIntentInvocationProperty *)self value];
...
LABEL_16:
      ...
      if ((v14 >> 3) == 2)
      {
        ...
        v17 = [[BMAppIntentInvocationValue alloc] initByReadFrom:v4];
        if (!v17)
        {
          goto LABEL_27;
        }
...
- (NSString)description
{
  ...
  v4 = [(BMAppIntentInvocationProperty *)self identifier];
  v5 = [(BMAppIntentInvocationProperty *)self value];
  v6 = [v3 initWithFormat:@"BMAppIntentInvocationProperty with identifier: %@, value: %@", v4, v5];
