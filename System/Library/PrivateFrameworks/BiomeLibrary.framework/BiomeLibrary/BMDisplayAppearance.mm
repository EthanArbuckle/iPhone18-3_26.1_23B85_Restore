...
+ (id)protoFields;
- (BMDisplayAppearance)initWithJSONDictionary:(id)dictionary error:(id *)error;
- (BMDisplayAppearance)initWithState:(int)state reason:(int)reason;
...
- (BOOL)isEqual:(id)equal
{
  ...
  {
    v5 = equalCopy;
    state = [(BMDisplayAppearance *)self state];
    if (state == [v5 state])
    {
      reason = [(BMDisplayAppearance *)self reason];
      v8 = reason == [v5 reason];
    }
...
- (id)jsonDictionary
{
  ...
  v3 = [MEMORY[0x1E696AD98] numberWithInt:{-[BMDisplayAppearance state](self, "state")}];
  v4 = [MEMORY[0x1E696AD98] numberWithInt:{-[BMDisplayAppearance reason](self, "reason")}];
  v10[0] = @"state";
  null = v3;
  if (!v3)
  {
...
- (BMDisplayAppearance)initWithJSONDictionary:(id)dictionary error:(id *)error
{
  ...
  if (v7 && (objc_opt_class(), (objc_opt_isKindOfClass() & 1) == 0))
  {
    ...
    else
    {
      ...
      v9 = [MEMORY[0x1E696AD98] numberWithInt:BMDisplayAppearanceStateFromString(v7)];
    }
  ...
  if (v10 && (objc_opt_class(), (objc_opt_isKindOfClass() & 1) == 0))
  {
    ...
    else
    {
      ...
      v12 = [MEMORY[0x1E696AD98] numberWithInt:BMDisplayAppearanceReasonFromString(v10)];
    }
...
- (id)initByReadFrom:(id)from
{
  fromCopy = from;
  v32.receiver = self;
  v32.super_class = BMDisplayAppearance;
...
LABEL_46:
        ...
        v28 = &OBJC_IVAR___BMDisplayAppearance__state;
      }
...
LABEL_42:
        ...
        v28 = &OBJC_IVAR___BMDisplayAppearance__reason;
      }
...
- (NSString)description
{
  ...
  v4 = BMDisplayAppearanceStateAsString([(BMDisplayAppearance *)self state]);
  v5 = BMDisplayAppearanceReasonAsString([(BMDisplayAppearance *)self reason]);
  v6 = [v3 initWithFormat:@"BMDisplayAppearance with state: %@, reason: %@", v4, v5];
...
{
  v8.receiver = self;
  v8.super_class = BMDisplayAppearance;
...
+ (id)eventWithData:(id)data dataVersion:(unsigned int)version
{
  ...
  else
  {
    ...
    v8 = [[BMDisplayAppearance alloc] initByReadFrom:v7];
    v4 = v8;
    if (v8)
    {
      v8[4] = 0;
