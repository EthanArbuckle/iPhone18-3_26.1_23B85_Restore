...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    v5 = v4;
    v6 = [(BMMomentsEventDataAction *)self type];
    if (v6 == [v5 type])
    {
...
- (id)jsonDictionary
{
  ...
  v4 = [(BMMomentsEventDataAction *)self actionName];
...
LABEL_9:
    ...
    v12 = [v6 objectForKeyedSubscript:@"actionNameConfidence"];
...
LABEL_16:
      ...
      if ((v14 >> 3) == 3)
      {
        ...
        {
          v27 = [v4 data];
          [v27 getBytes:&v32 range:{objc_msgSend(v4, "position"), 4}];
...
- (NSString)description
{
  ...
  v5 = [(BMMomentsEventDataAction *)self actionName];
  v6 = MEMORY[0x1E696AD98];
  [(BMMomentsEventDataAction *)self actionNameConfidence];
  v7 = [v6 numberWithDouble:?];
  v8 = [v3 initWithFormat:@"BMMomentsEventDataAction with type: %@, actionName: %@, actionNameConfidence: %@", v4, v5, v7];
...
- (BMMomentsEventDataAction)initWithType:(int)a3 actionName:(id)a4 actionNameConfidence:(id)a5
{
  ...
  if (v11)
  {
    ...
    v11->_type = a3;
    objc_storeStrong(&v11->_actionName, a4);
    if (v10)
    {
