...
- (BOOL)isEqual:(id)a3
{
  ...
  if (objc_opt_isKindOfClass())
  {
    ...
    if (-[BMMessagesRead hasMarkedUnread](self, "hasMarkedUnread") && [v5 hasMarkedUnread])
    {
      v13 = [(BMMessagesRead *)self markedUnread];
      v12 = v13 ^ [v5 markedUnread] ^ 1;
LABEL_13:
...
- (NSString)description
{
  ...
  v4 = [(BMMessagesRead *)self idsHandle];
  v5 = [MEMORY[0x1E696AD98] numberWithBool:{-[BMMessagesRead markedUnread](self, "markedUnread")}];
  v6 = [v3 initWithFormat:@"BMMessagesRead with idsHandle: %@, markedUnread: %@", v4, v5];
...
- (BMMessagesRead)initWithIdsHandle:(id)a3 markedUnread:(id)a4
{
  ...
  if (v9)
  {
    ...
    objc_storeStrong(&v9->_idsHandle, a3);
    if (v8)
    {
