...
+ (id)Panic
{
  ...
  v10 = [objc_alloc(MEMORY[0x1E698F320]) initWithIdentifier:@"Diagnostics.Panic" schema:v9 configuration:v2];
...
+ (id)configurationForPanic
{
  v3 = [a1 storeConfigurationForPanic];
  v4 = [a1 syncPolicyForPanic];
