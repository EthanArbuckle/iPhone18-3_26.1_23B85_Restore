...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    v5 = v4;
    v6 = [(BMLocationSignificantVisit *)self type];
    if (v6 == [v5 type])
    {
...
- (id)jsonDictionary
{
  ...
  v4 = [(BMLocationSignificantVisit *)self identifier];
  v10[0] = @"type";
  v5 = v3;
  if (!v3)
  {
  ...
  if (v10 && (objc_opt_class(), (objc_opt_isKindOfClass() & 1) == 0))
  {
    ...
    if ((objc_opt_isKindOfClass() & 1) == 0)
    {
      if (a4)
      {
        ...
        v17 = [objc_alloc(MEMORY[0x1E696AEC0]) initWithFormat:@"Unexpected type %@ for element of %@, expecting NSString", objc_opt_class(), @"identifier"];
        v23 = v17;
...
- (NSString)description
{
  ...
  v5 = [(BMLocationSignificantVisit *)self identifier];
  v6 = [v3 initWithFormat:@"BMLocationSignificantVisit with type: %@, identifier: %@", v4, v5];
