...
- (id)jsonDictionary
{
  ...
  v4 = [(BMProactiveHarvestingContentAttachment *)self filename];
  v5 = [(BMProactiveHarvestingContentAttachment *)self path];
  v12[0] = @"type";
  v6 = v3;
  if (!v3)
  {
...
- (NSString)description
{
  ...
  v4 = [(BMProactiveHarvestingContentAttachment *)self type];
  v5 = [(BMProactiveHarvestingContentAttachment *)self filename];
  v6 = [(BMProactiveHarvestingContentAttachment *)self path];
  v7 = [v3 initWithFormat:@"BMProactiveHarvestingContentAttachment with type: %@, filename: %@, path: %@", v4, v5, v6];
...
- (BMProactiveHarvestingContentAttachment)initWithType:(id)a3 filename:(id)a4 path:(id)a5
{
  ...
  if (v12)
  {
    ...
    objc_storeStrong(&v12->_filename, a4);
