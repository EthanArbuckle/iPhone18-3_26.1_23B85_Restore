...
- (BMProactiveHarvestingMailHeaderEntry)initWithKey:(id)key value:(id)value;
...
LABEL_11:
    ...
    {
      value3 = [(BMProactiveHarvestingMailHeaderEntry *)self value];
      value4 = [v5 value];
...
- (id)initByReadFrom:(id)from
{
  fromCopy = from;
  v22.receiver = self;
  v22.super_class = BMProactiveHarvestingMailHeaderEntry;
...
LABEL_16:
      ...
      if ((v14 >> 3) == 1)
      {
        v15 = &OBJC_IVAR___BMProactiveHarvestingMailHeaderEntry__key;
      }
      ...
      else
      {
        ...
        v15 = &OBJC_IVAR___BMProactiveHarvestingMailHeaderEntry__value;
      }
...
- (NSString)description
{
  ...
  v4 = [(BMProactiveHarvestingMailHeaderEntry *)self key];
  value = [(BMProactiveHarvestingMailHeaderEntry *)self value];
  v6 = [v3 initWithFormat:@"BMProactiveHarvestingMailHeaderEntry with key: %@, value: %@", v4, value];
...
- (BMProactiveHarvestingMailHeaderEntry)initWithKey:(id)key value:(id)value
{
  ...
  valueCopy = value;
  v11.receiver = self;
  v11.super_class = BMProactiveHarvestingMailHeaderEntry;
...
+ (id)eventWithData:(id)data dataVersion:(unsigned int)version
{
  if (version == 3)
  {
    ...
    v7 = [[BMProactiveHarvestingMailHeaderEntry alloc] initByReadFrom:v6];
    v8 = v7;
    if (v7)
    {
      v7[4] = 3;
