...
+ (id)protoFields;
- (BMDeviceDisplayConnected)initWithJSONDictionary:(id)a3 error:(id *)a4;
- (BMDeviceDisplayConnected)initWithStarting:(id)a3 deviceName:(id)a4 uniqueId:(id)a5 productName:(id)a6 mirroringMode:(id)a7;
- (BOOL)isEqual:(id)a3;
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (objc_opt_isKindOfClass())
  {
    ...
    if (-[BMDeviceDisplayConnected hasStarting](self, "hasStarting") || [v5 hasStarting])
    {
      ...
      v6 = [(BMDeviceDisplayConnected *)self starting];
      if (v6 != [v5 starting])
      {
        goto LABEL_25;
      }
    ...
    v7 = [(BMDeviceDisplayConnected *)self deviceName];
    v8 = [v5 deviceName];
    v9 = v8;
    if (v7 == v8)
    {
    ...
    {
      v10 = [(BMDeviceDisplayConnected *)self deviceName];
      v11 = [v5 deviceName];
      v12 = [v10 isEqual:v11];
    ...
    v14 = [(BMDeviceDisplayConnected *)self uniqueId];
    v15 = [v5 uniqueId];
    v16 = v15;
    if (v14 == v15)
    {
    ...
    {
      v17 = [(BMDeviceDisplayConnected *)self uniqueId];
      v18 = [v5 uniqueId];
      v19 = [v17 isEqual:v18];
    ...
    v20 = [(BMDeviceDisplayConnected *)self productName];
    v21 = [v5 productName];
    v22 = v21;
    if (v20 == v21)
    {
    ...
    {
      v23 = [(BMDeviceDisplayConnected *)self productName];
      v24 = [v5 productName];
      v25 = [v23 isEqual:v24];
    ...
    if (-[BMDeviceDisplayConnected hasMirroringMode](self, "hasMirroringMode") && [v5 hasMirroringMode])
    {
      v26 = [(BMDeviceDisplayConnected *)self mirroringMode];
...
- (id)jsonDictionary
{
  ...
  v4 = [(BMDeviceDisplayConnected *)self deviceName];
  v5 = [(BMDeviceDisplayConnected *)self uniqueId];
  v6 = [(BMDeviceDisplayConnected *)self productName];
...
LABEL_19:
    ...
    v16 = [(BMDeviceDisplayConnected *)v37 initWithStarting:v35 deviceName:v38 uniqueId:v36 productName:v13 mirroringMode:v15];
    v37 = v16;
LABEL_17:
...
- (NSString)description
{
  ...
  v5 = [(BMDeviceDisplayConnected *)self deviceName];
  v6 = [(BMDeviceDisplayConnected *)self uniqueId];
  v7 = [(BMDeviceDisplayConnected *)self productName];
  v8 = [MEMORY[0x1E696AD98] numberWithBool:{-[BMDeviceDisplayConnected mirroringMode](self, "mirroringMode")}];
  v9 = [v3 initWithFormat:@"BMDeviceDisplayConnected with starting: %@, deviceName: %@, uniqueId: %@, productName: %@, mirroringMode: %@", v4, v5, v6, v7, v8];
