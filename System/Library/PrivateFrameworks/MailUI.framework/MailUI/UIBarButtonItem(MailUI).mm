...
+ (id)_mui_capsuleConfigurationWithTitle:()MailUI titleColor:image:
{
  ...
  v10 = a5;
  filledButtonConfiguration = [v9 filledButtonConfiguration];
  ...
  if (v8)
  {
    [filledButtonConfiguration setBaseForegroundColor:v8];
  }

  if (v7)
  {
    [filledButtonConfiguration setContentInsets:{7.33333333, 12.0, 7.33333333, 12.0}];
    [filledButtonConfiguration setTitle:v7];
  }

  else
  {
    [filledButtonConfiguration setContentInsets:{5.0, 5.0, 5.0, 5.0}];
  }
  ...
  [filledButtonConfiguration setPreferredSymbolConfigurationForImage:v17];
  ...
  v21 = v15;
  v18 = v15;
  [filledButtonConfiguration setTitleTextAttributesTransformer:v20];
