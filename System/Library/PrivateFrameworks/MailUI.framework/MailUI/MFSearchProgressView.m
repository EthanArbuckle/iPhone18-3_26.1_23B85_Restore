...
- (id)_searchingFont
{
  ...
  v3 = [v2 cachedFont:&__block_literal_global_11 forKey:@"MFSearchProgressView.searchingFont"];
...
- (MFSearchProgressView)initWithFrame:(CGRect)a3
{
  ...
  v3 = [(MFSearchProgressView *)&v6 initWithFrame:a3.origin.x, a3.origin.y, a3.size.width, a3.size.height];
  v4 = v3;
  if (v3)
  {
...
- (void)_setupLabels
{
  ...
  v3 = [MEMORY[0x277D75A68] mf_baselineAlignedHorizontalStackView];
  ...
  v6 = [v5 localizedStringForKey:@"SEARCHING" value:&stru_2826EE5B8 table:@"Main"];
  ...
  v12 = [v11 localizedStringForKey:@"SEARCHING_ANIMATED_CHARACTER" value:&stru_2826EE5B8 table:@"Main"];
...
- (void)invalidateLayout
{
  ...
  v6 = [v5 ef_filter:&__block_literal_global_38];

  v7 = [(MFSearchProgressView *)self _searchingFont];
  v13 = 0u;
  v14 = 0u;
  v15 = 0u;
  v16 = 0u;
