...
- (void)_reportBlankCellMetrics
{
  ...
  if (a1)
  {
    ...
    v3 = [MEMORY[0x277CCABB0] numberWithInteger:{-[os_unfair_lock_s loadAttempts](a1, "loadAttempts")}];
    [v2 setObject:v3 forKeyedSubscript:@"loadAttempts"];

    v4 = [MEMORY[0x277CCABB0] numberWithInteger:{-[os_unfair_lock_s loadFailures](a1, "loadFailures")}];
    [v2 setObject:v4 forKeyedSubscript:@"loadFailures"];

    v5 = [(os_unfair_lock_s *)a1 failureCodeCount];
...
- (void)_reportFlickeringCellMetrics
{
  ...
  if (a1)
  {
    ...
    v3 = [MEMORY[0x277CCABB0] numberWithInteger:{objc_msgSend(a1, "numberOfVisibleCells")}];
    [v2 setObject:v3 forKeyedSubscript:@"numberOfVisibleCells"];

    v4 = [MEMORY[0x277CCABB0] numberWithInteger:{objc_msgSend(a1, "numberOfFlickeringCells")}];
    ...
    [a1 setNumberOfVisibleCells:0];
    [a1 setNumberOfFlickeringCells:0];
    v9 = *(a1 + 80);
    [v9 removeAllObjects];
...
- (void)markItemIDsAsVisibleBeforeUpdate:(id)a3
{
  ...
  v6 = [(MessageListCellsController *)self currentUpdateToken];
  [v6 cancel];

  v7 = [(MessageListCellsController *)self visibleItemIDs];
  ...
  v10 = [v9 afterDelay:&v11 performBlock:2.0];
...
- (BOOL)wasItemRecentlyVisible:(id)a3
{
  ...
  v13 = 0x2020000000;
  v14 = 0;
  v5 = [(MessageListCellsController *)self visibleItemIDs];
...
- (void)reportCellDidLoad:(BOOL)a3 error:(id)a4
{
  ...
  if (v15)
  {
    v6 = [(MessageListCellsController *)self failureCodeCount];
    v7 = [MEMORY[0x277CCABB0] numberWithInteger:{objc_msgSend(v15, "code")}];
    v8 = [v7 stringValue];
    ...
    v12 = [(MessageListCellsController *)self failureCodeCount];
