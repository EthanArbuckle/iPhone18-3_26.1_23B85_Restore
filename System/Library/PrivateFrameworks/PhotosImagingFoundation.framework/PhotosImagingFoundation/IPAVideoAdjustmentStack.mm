...
- (void)setNaturalDuration:(id *)duration;
@end
...
{
  var3 = duration->var3;
  *&self->_naturalDuration.value = *&duration->var0;
...
{
  formatCopy = format;
  if ([formatCopy isEqualToString:@"com.apple.video.slomo"])
  {
    v5 = @"1.1";
LABEL_5:
    v6 = v5;
  ...
  if ([formatCopy isEqualToString:@"com.apple.video"])
  {
    v5 = @"1.0";
    goto LABEL_5;
  }
...
- (id)copyWithZone:(_NSZone *)zone
{
  ...
  result = [(IPAAdjustmentStack *)&v6 copyWithZone:zone];
