...
- (void)_enumerateTokenListsInReverse:()Helper handler_emk:
{
  ...
  v11 = v6;
  v9 = v6;
  [self enumerateAttribute:@"EMKEmojiTokenList" inRange:0 options:v7 usingBlock:{v8, v10}];
}
...
- (void)_enumerateTokenListsInRange:()Helper usingBlock_emk:
{
  ...
  v11 = v8;
  v9 = v8;
  [self enumerateAttribute:@"EMKEmojiTokenList" inRange:a3 options:a4 usingBlock:{0, v10}];
}
