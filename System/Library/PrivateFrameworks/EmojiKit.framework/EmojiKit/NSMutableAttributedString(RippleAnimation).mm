...
- (EMKRippleAnimation)addRippleAnimationForRange_emk:()RippleAnimation
{
  ...
  [a1 addAttribute:@"_NSTextFilterAnimation" value:v7 range:{a3, a4}];
  v8 = [MEMORY[0x277D76358] animationWithName:@"scaleRipple"];
  [a1 addAttribute:*MEMORY[0x277D74170] value:v8 range:{a3, a4}];
...
- (void)removeRippleAnimation:()RippleAnimation includingFilterEffect_emk:
{
  ...
  v14 = v9;
  v15 = a1;
  [a1 enumerateAttribute:v8 inRange:0 options:v7 usingBlock:{0, v13}];
  if (a4)
  {
    ...
    v11 = v9;
    v12 = a1;
    [a1 enumerateAttribute:@"_NSTextFilterAnimation" inRange:0 options:v7 usingBlock:{0, v10}];
  }
}
