...
- (NSURLSession)URLSession
{
  ...
  if (!URLSession)
  {
    ...
    else
    {
      ...
      v9 = [objc_alloc(MEMORY[0x277CCACD8]) initWithMemoryCapacity:5242880 diskCapacity:26214400 diskPath:v6];
...
{
  v4 = a3;
  v5 = [(HLPURLSessionManager *)self urlRedirector];
  ...
  v6 = [v4 URL];
  v7 = [(HLPURLSessionManager *)self urlRedirector];
  v8 = [v7 mappedURL:v6];
...
LABEL_5:
  ...
  v12 = [(HLPURLSessionManager *)self authenticationHandler];
  v13 = [v12 customHeaderFields];
  v14 = [v11 dictionaryWithDictionary:v13];

  if ([v14 count])
  {
    v15 = [v9 allHTTPHeaderFields];
...
- (id)newURLSessionItemWithRequest:(id)a3 identifier:(id)a4 networkDelegate:(id)a5 completionHandler:(id)a6
{
  ...
  v12 = a5;
  v30 = a6;
  v13 = [(HLPURLSessionManager *)self _mappedURLRequest:v10];
  v14 = [v13 URL];
  v15 = v14;
  if (v14 && (v11 || ([v14 lastPathComponent], (v11 = objc_claimAutoreleasedReturnValue()) != 0)))
  {
    v40 = 0;
    v41 = &v40;
    v42 = 0x3032000000;
...
LABEL_7:
      ...
      v18 = [(HLPURLSessionManager *)self URLSession];
      v19 = [v18 dataTaskWithRequest:v13];

      v20 = [[HLPURLSessionTask alloc] initWithSessionTask:v19 identifier:v11];
      v21 = v41[5];
      v41[5] = v20;
      ...
      if (v12)
      {
        v23 = [HLPURLSessionTask delegateRespondsWithDelegate:v12];
      }
    ...
    v24 = [(HLPURLSessionItem *)v27 initWithSessionTask:v41[5] completionHandler:v30];
...
- (void)URLSession:(id)a3 dataTask:(id)a4 didReceiveResponse:(id)a5 completionHandler:(id)a6
{
  ...
  v10 = a5;
  v11 = a6;
  v12 = [(HLPURLSessionManager *)self sessionTaskForTask:v9];
  v13 = v12;
  if (v12)
  {
    ...
    v18 = [(HLPURLSessionManager *)self authenticationHandler];
...
{
  v10 = a5;
  v7 = [(HLPURLSessionManager *)self sessionTaskForTask:a4];
  v8 = [v7 dataTaskData];
  v9 = v8;
  if (v8)
  {
...
- (void)URLSession:(id)a3 dataTask:(id)a4 didBecomeDownloadTask:(id)a5
{
  v7 = a4;
  v8 = a5;
  v9 = [(HLPURLSessionManager *)self sessionTaskForTask:v7];
  [v9 setTask:v8];
...
- (void)URLSession:(id)a3 dataTask:(id)a4 willCacheResponse:(id)a5 completionHandler:(id)a6
{
  v12 = a5;
  v9 = a6;
  v10 = [(HLPURLSessionManager *)self sessionTaskForTask:a4];
...
- (void)URLSession:(id)a3 task:(id)a4 willPerformHTTPRedirection:(id)a5 newRequest:(id)a6 completionHandler:(id)a7
{
  ...
  v11 = a6;
  v12 = a7;
  v13 = [(HLPURLSessionManager *)self sessionTaskForTask:a4];
  if (([v13 delegateResponds] & 0x100) != 0)
  {
    v14 = [v13 networkDelegate];
...
- (void)URLSession:(id)a3 downloadTask:(id)a4 didWriteData:(int64_t)a5 totalBytesWritten:(int64_t)a6 totalBytesExpectedToWrite:(int64_t)a7
{
  ...
  if (v8 != -1)
  {
    v9 = [(HLPURLSessionManager *)self sessionTaskForTask:a4];
...
- (void)URLSession:(id)a3 task:(id)a4 didCompleteWithError:(id)a5
{
  v16 = a4;
  v7 = a5;
  v8 = [(HLPURLSessionManager *)self sessionTaskForTask:v16];
  v9 = [v16 response];
  objc_opt_class();
...
- (void)URLSession:(id)a3 task:(id)a4 didReceiveChallenge:(id)a5 completionHandler:(id)a6
{
  ...
  v9 = a6;
  v10 = [(HLPURLSessionManager *)self sessionTaskForTask:a4];
  if (([v10 delegateResponds] & 0x10000000000) != 0 && (objc_msgSend(v15, "protectionSpace"), v11 = objc_claimAutoreleasedReturnValue(), objc_msgSend(v11, "host"), v12 = objc_claimAutoreleasedReturnValue(), v13 = objc_msgSend(v12, "hasSuffix:", @".apple.com"), v12, v11, v13))
  {
