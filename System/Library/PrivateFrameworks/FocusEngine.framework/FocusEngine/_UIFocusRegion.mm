...
- (_UIFocusRegion)initWithFrame:(CGRect)frame coordinateSpace:(id)space
{
  ...
  if (!spaceCopy)
  {
    ...
    [currentHandler handleFailureInMethod:a2 object:self file:@"_UIFocusRegion.m" lineNumber:211 description:{@"Invalid parameter not satisfying: %@", @"coordinateSpace"}];
  }
...
- (id)_focusRegionWithAdjustedFrame:(CGRect)frame coordinateSpace:(id)space
{
  ...
  {
    currentHandler = [MEMORY[0x277CCA890] currentHandler];
    [currentHandler handleFailureInMethod:a2 object:self file:@"_UIFocusRegion.m" lineNumber:223 description:{@"Invalid parameter not satisfying: %@", @"!CGRectIsEmpty(frame)"}];
  ...
  [currentHandler2 handleFailureInMethod:a2 object:self file:@"_UIFocusRegion.m" lineNumber:224 description:{@"Invalid parameter not satisfying: %@", @"coordinateSpace"}];
...
- (id)_descriptionBuilder
{
  ...
  if (regionCoordinateSpace)
  {
    ...
    if (regionCoordinateSpace2)
    {
      ...
      v15 = [v12 stringWithFormat:@"<%@: %p>", v14, regionCoordinateSpace2];
    }
