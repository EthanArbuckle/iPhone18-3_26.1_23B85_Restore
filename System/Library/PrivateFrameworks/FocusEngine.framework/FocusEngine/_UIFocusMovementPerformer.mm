...
- (BOOL)performFocusMovement:(id)movement
{
  ...
  if (!movementCopy)
  {
    ...
    [currentHandler handleFailureInMethod:a2 object:self file:@"_UIFocusMovementPerformer.m" lineNumber:39 description:{@"Invalid parameter not satisfying: %@", @"request"}];
  ...
  do
  {
    focusSystem = [v10 focusSystem];
    if (([v7 overridesDeferredFocusUpdate] & 1) == 0 && objc_msgSend(focusSystem, "_performDeferredFocusUpdateIfAvailable"))
    {
      goto LABEL_19;
    }

    movementInfo = [v10 movementInfo];
    if (!movementInfo)
    {
      goto LABEL_13;
    }
    ...
    if ([v13 _isValidInFocusSystem:focusSystem])
    {
      v14 = [focusSystem _updateFocusImmediatelyWithContext:v13];
      if (!v9)
      {
        goto LABEL_10;
      }
...
LABEL_20:
    ...
    v8 = 1;
LABEL_13:
    fallbackRequest = [v10 fallbackRequest];
  ...
  if (v8)
  {
    ...
    if (delegate)
    {
      v18 = [delegate _handleFailedFocusMovementRequest:v7 withPerformer:self];
    ...
    focusSystem2 = [v7 focusSystem];
    _postsFocusUpdateNotifications = [focusSystem2 _postsFocusUpdateNotifications];

    if (_postsFocusUpdateNotifications)
    {
      if (!v9)
      {
      ...
      focusSystem3 = [v7 focusSystem];
      v27 = @"UIFocusUpdateContextKey";
      v28[0] = v9;
      v24 = [MEMORY[0x277CBEAC0] dictionaryWithObjects:v28 forKeys:&v27 count:1];
      [defaultCenter postNotificationName:@"UIFocusMovementDidFailNotification" object:focusSystem3 userInfo:v24];
    }
  }
...
LABEL_23:
    ...
    [currentHandler handleFailureInFunction:v27 file:@"_UIFocusMovementPerformer.m" lineNumber:339 description:{@"Non-linear focus movement should always produce a context, even if the focus movement failed."}];
  ...
  do
  {
    ...
    do
    {
      ...
      v15 = *(*(&v49 + 1) + 8 * v14);
      owningEnvironment = [v15 owningEnvironment];
      itemContainer = [v15 itemContainer];
      if ([v15 isScrollableContainer] && (objc_msgSend(movementCopy, "movementInfo"), v18 = objc_claimAutoreleasedReturnValue(), v19 = objc_msgSend(v18, "_shouldLoadScrollableContainer"), v18, v19))
      {
        v20 = [(_UIFocusMovementPerformer *)self _findFocusCandidateByExhaustivelySearchingEnvironment:owningEnvironment scrollableContainer:itemContainer forRequest:movementCopy];
        ...
        if (v20)
        {
          ...
          _focusMapSearchInfo = [v20 _focusMapSearchInfo];
          didFindFocusBlockingBoundary = [_focusMapSearchInfo didFindFocusBlockingBoundary];
      ...
      {
        [(_UIFocusMovementPerformer *)self _minimumSearchAreaForContainer:itemContainer inCoordinateSpace:v47];
        v20 = [(_UIFocusMovementPerformer *)self _findFocusCandidateWithoutLoadingScrollableContentInEnvironment:owningEnvironment container:itemContainer forRequest:movementCopy minimumSearchArea:?];
...
LABEL_24:
  _destinationItemInfo = [v12 _destinationItemInfo];
  v29 = _UIFocusEngineCommonEnvironmentScrollableContainerForItems(focusedItemInfo, _destinationItemInfo);
  v30 = v29;
  if (_destinationItemInfo && !v29)
  {
    v30 = _UIFocusEngineFirstScrollableContainerTupleThatScrollsForItem(_destinationItemInfo);
  }

  [v12 _setCommonEnvironmentScrollableContainer:v30];
  focusedRegion = [_destinationItemInfo focusedRegion];
  if (focusedRegion)
  {
    [_UIFocusRegionEvaluator frameForRegion:focusedRegion inCoordinateSpace:coordinateSpace];
    v33 = v32;
    v35 = v34;
    v37 = v36;
    v39 = v38;
...
- (id)_bestCandidateForLinearFocusMovement:(id)movement
{
  ...
  focusSystem = [movementCopy focusSystem];
  focusedItemInfo = [movementCopy focusedItemInfo];
  _focusMovementCache = [focusSystem _focusMovementCache];
  v8 = [_focusMovementCache nextItemForRequest:movementCopy];

  if (!v8 || (v9 = [[UIFocusUpdateContext alloc] _initWithFocusMovementRequest:movementCopy nextFocusedItem:v8]) == 0)
  {
    v9 = [(_UIFocusMovementPerformer *)self _findFocusCandidateBySearchingLinearFocusMovementSequencesForRequest:movementCopy];
    if (!v9)
    {
      v9 = [(_UIFocusMovementPerformer *)self _nextLinearCandidateLoadingScrollableContentForRequest:movementCopy];
    }
  }

  v10 = v9;
  _destinationItemInfo = [v9 _destinationItemInfo];
  v12 = _UIFocusEngineCommonEnvironmentScrollableContainerForItems(focusedItemInfo, _destinationItemInfo);
  v13 = v12;
  if (_destinationItemInfo && !v12)
  {
    v13 = _UIFocusEngineFirstScrollableContainerTupleThatScrollsForItem(_destinationItemInfo);
  }
...
LABEL_18:
  ...
  if (owningEnvironment != v25)
  {
    ...
    {
      currentHandler = [_UIFocusEnvironmentContainerTuple tupleWithOwningEnvironment:v25 itemContainer:focusItemContainer2];
    ...
    else
    {
      ...
      [currentHandler handleFailureInFunction:v23 file:@"_UIFocusMovementPerformer.m" lineNumber:454 description:@"FocusSystem does not have a focusItemContainer."];
    }
  }
...
- (id)_dummyFocusItemForFocusMovement:(id)movement searchArea:(CGRect)area parent:(id)parent
{
  ...
  {
    currentHandler = [MEMORY[0x277CCA890] currentHandler];
    [currentHandler handleFailureInMethod:a2 object:self file:@"_UIFocusMovementPerformer.m" lineNumber:463 description:{@"Invalid parameter not satisfying: %@", @"parent != nil"}];
  }
