...
+ (id)groundDatesFromDateString:(id)string;
...
+ (id)groundDatesFromDateString:(id)string
{
  ...
  queryParserManagerClass = [self queryParserManagerClass];
  if (!queryParserManagerClass)
  {
