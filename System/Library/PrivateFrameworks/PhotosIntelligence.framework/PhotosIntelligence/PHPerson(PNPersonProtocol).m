...
- (void)setKeyFace:()PNPersonProtocol
{
  ...
  if ((v7 & 1) == 0)
  {
    v8 = [MEMORY[0x1E6978990] changeRequestForPerson:a1];
...
- (id)keyFace
{
  v1 = [MEMORY[0x1E69787C8] fetchKeyFaceForPerson:a1 options:0];
  v2 = [v1 firstObject];
...
- (void)setManualOrder:()PNPersonProtocol
{
  v4 = [MEMORY[0x1E6978990] changeRequestForPerson:a1];
  [v4 setManualOrder:a3];
}

- (void)setIsVerified:()PNPersonProtocol
{
  v1 = [MEMORY[0x1E6978990] changeRequestForPerson:a1];
...
- (__CFString)anonymizedName
{
  ...
  v2 = objc_getAssociatedObject(a1, &PHPersonPVPersonProtocolAnonymizedNameKey);
  if (!v2)
  {
    v3 = [a1 name];
    if ([v3 length])
    ...
    objc_setAssociatedObject(a1, &PHPersonPVPersonProtocolAnonymizedNameKey, v6, 1);
  }
