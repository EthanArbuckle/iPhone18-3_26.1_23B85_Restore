...
- (id)description
{
  ...
  v8.receiver = self;
  v8.super_class = ASCodableShareLocations;
  v4 = [(ASCodableShareLocations *)&v8 description];
  dictionaryRepresentation = [(ASCodableShareLocations *)self dictionaryRepresentation];
...
- (void)mergeFrom:(id)from
{
  ...
  if (fromCopy[1])
  {
    [(ASCodableShareLocations *)self setActivityShareURL:?];
    fromCopy = v5;
  }

  if (fromCopy[2])
  {
    [(ASCodableShareLocations *)self setRelationshipShareURL:?];
    fromCopy = v5;
  }
}
