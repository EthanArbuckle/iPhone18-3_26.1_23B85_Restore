uint64_t sub_1D4C19198(int a1, uint64_t a2, int8x16_t *a3, uint64_t a4, double a5, __n128 a6, __n128 a7, __n128 a8, int8x16_t a9, double a10, int8x16_t a11, uint64_t a12, int a13)
{
  v18 = (v16 - 16) & 0xF;
...
uint64_t sub_1D4C19240@<X0>(uint64_t a1@<X0>, uint64_t a2@<X8>)
{
  v6 = (a1 + v2 - 16);
  v7 = (a2 + v2 - 16);
  v8 = *v7;
...
uint64_t sub_1D4C19804(uint64_t a1, uint64_t a2, uint64_t a3, int a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15)
{
  ...
  *(v22 - a2 + a1 + 2) = veor_s8(vrev64_s8(*&vqtbl4q_s8(v138, xmmword_1D4E31470)), *(a15 - a2 - 8 + a1));
  return (*(STACK[0x2A8] + 8 * ((1898 * (a2 - (a1 & 0xFFFFFFF8) == -8)) ^ a4)))();
}

uint64_t sub_1D4C19DF4()
{
...
uint64_t sub_1D4C19F88(uint64_t a1)
{
  *a1 = 0;
  *(a1 + 8) = 0;
  *(a1 + 16) = 42;
...
uint64_t sub_1D4C1A044@<X0>(uint64_t a1@<X0>, uint64_t a2@<X8>)
{
...
uint64_t sub_1D4C1A140(uint64_t a1, uint64_t a2, uint64_t a3)
{
  v5 = *(STACK[0x660] + 24);
  STACK[0x528] = v5;
...
uint64_t sub_1D4C1A6C8@<X0>(uint64_t a1@<X0>, uint64_t a2@<X1>, uint64_t a3@<X2>, uint64_t a4@<X3>, uint64_t a5@<X4>, uint64_t a6@<X5>, int a7@<W8>)
{
...
uint64_t sub_1D4C1A734@<X0>(int a1@<W8>)
{
  v2 = STACK[0x438];
  STACK[0x508] = *(v1 + 8 * a1);
...
uint64_t sub_1D4C1A76C(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t *a12, int a13, unsigned int a14)
{
  a12 = &a9;
...
uint64_t sub_1D4C1A840(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4)
{
  v6 = *v5;
  STACK[0x640] = 0;
  STACK[0x410] = 0;
...
uint64_t sub_1D4C1B590(uint64_t a1, int a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, uint64_t a16, uint64_t a17, uint64_t a18, uint64_t a19, uint64_t a20, uint64_t a21, uint64_t a22, uint64_t a23, uint64_t a24, uint64_t a25, uint64_t a26, uint64_t a27, uint64_t a28, uint64_t a29, uint64_t a30, uint64_t a31, uint64_t a32, uint64_t a33, uint64_t a34, uint64_t a35, uint64_t a36, uint64_t a37, uint64_t a38, uint64_t a39, uint64_t a40, uint64_t a41, uint64_t a42, uint64_t a43, uint64_t a44, uint64_t a45, uint64_t a46, uint64_t a47, uint64_t a48, uint64_t a49, uint64_t a50, uint64_t a51, uint64_t a52, uint64_t a53, uint64_t a54, uint64_t a55, uint64_t a56, uint64_t a57, uint64_t a58, uint64_t a59, uint64_t a60, uint64_t a61, uint64_t a62, uint64_t a63)
{
  v80 = v72 - 8;
  v81.i64[0] = v75 + v80 - 7;
  v81.i64[1] = v75 + v80 - 8;
...
void sub_1D4C1B598(uint64_t a1)
{
  if (*(a1 + 24))
  {
    v2 = *(a1 + 8) == 0;
...
uint64_t sub_1D4C1B658(uint64_t a1)
{
  v3 = v1 & 0x61B24AFF;
...
uint64_t sub_1D4C1B6BC@<X0>(uint64_t a1@<X0>, int a2@<W8>)
{
  v10 = v2 + v6 + (v4 & v5);
  STACK[0xA18] = v10;
...
uint64_t sub_1D4C1B6C4@<X0>(uint64_t a1@<X3>, unint64_t a2@<X8>)
{
  STACK[0x850] = a2;
...
void sub_1D4C1B738(unint64_t a1)
{
  STACK[0x730] = a1;
...
uint64_t sub_1D4C1B914(int a1, uint64_t a2, uint64_t a3, uint64_t a4, int a5)
{
  v13 = *(v8 + 8 * (v10 - 7927));
  v14 = *v5;
  v15 = v9 + 8 + a5;
...
uint64_t sub_1D4C1BBA0(uint64_t a1, uint64_t a2, uint64_t a3)
{
...
uint64_t sub_1D4C1BBE8(void *a1)
{
  *a1 = 0;
  a1[1] = 0;
...
uint64_t sub_1D4C1BC58@<X0>(uint64_t a1@<X0>, uint64_t a2@<X1>, uint64_t a3@<X2>, int a4@<W8>)
{
  v5 = STACK[0x928];
...
uint64_t sub_1D4C1BD50(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, char a14, uint64_t a15, uint64_t a16, uint64_t a17, uint64_t a18, char *a19, int a20, unsigned int a21)
{
  a19 = &a14;
...
uint64_t sub_1D4C1BE34(uint64_t a1)
{
  v4 = v3 ^ 0x1D92;
...
uint64_t sub_1D4C1BF18(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, _DWORD *a5, void *a6)
{
...
uint64_t sub_1D4C1C0F0(unint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, uint64_t a16, uint64_t a17, uint64_t a18, uint64_t a19, uint64_t a20, uint64_t a21, uint64_t a22, uint64_t a23, uint64_t a24, uint64_t a25, uint64_t a26, uint64_t a27, uint64_t a28, uint64_t a29, uint64_t a30, uint64_t a31, uint64_t a32, uint64_t a33, uint64_t a34, uint64_t a35, uint64_t a36, uint64_t a37, uint64_t a38, uint64_t a39, uint64_t a40, uint64_t a41, uint64_t a42, uint64_t a43, uint64_t a44, uint64_t a45, uint64_t a46, uint64_t a47, uint64_t a48, uint64_t a49, uint64_t a50, uint64_t a51, uint64_t a52, uint64_t a53, uint64_t a54, uint64_t a55, uint64_t a56, uint64_t a57, uint64_t a58, uint64_t a59, uint64_t a60)
{
  *a1 = 0;
  *(a1 + 8) = 0;
  STACK[0x270] = a1;
...
uint64_t sub_1D4C1C1C4(uint64_t result)
{
  **(result + 8) = 0;
  *(result + 4) = 242661640;
  return result;
...
uint64_t sub_1D4C1C264(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, char a10, uint64_t a11, int a12, unsigned int a13, uint64_t a14, char *a15, unsigned int a16, unsigned int a17)
{
...
uint64_t sub_1D4C1C308(uint64_t a1, uint64_t a2, int a3, int a4, uint64_t a5, int a6, int a7, int a8, uint64_t a9, uint64_t a10, uint64_t a11, int a12, int a13, int a14, int a15, int a16, int a17, int a18, int a19, int a20, int a21, int a22, int a23, int a24, int a25, int a26, int a27, int a28, unsigned int a29, int a30, int a31, uint64_t a32, uint64_t a33, uint64_t a34, uint64_t a35, int a36, int a37, int a38, int a39, int a40, int a41, int a42, int a43, int a44, int a45, int a46, int a47, int a48, int a49, int a50)
{
  ...
  *(v54 - 116) = v63;
  ...
  v77 = *(&off_1F5090370 + v55 - 5484);
  v78 = (a28 ^ v72) >> 24;
  v79 = *(&off_1F5090370 + v55 - 5595) - 4;
  v80 = *(v77 + 4 * (BYTE2(v71) ^ 0x21u)) * v53;
  v81 = ((a28 ^ v72) >> 8);
  v82 = *(&off_1F5090370 + (v55 ^ 0x1504)) - 8;
  v83 = *&v82[4 * v81];
  v84 = *(&off_1F5090370 + (v55 ^ 0x14B9)) - 8;
  ...
  v179 = *(&off_1F5090370 + (v55 ^ 0x14EF)) - 12;
  v180 = *&v179[4 * ((v178 ^ 0xCB23) >> 8)];
  v181 = *(&off_1F5090370 + v55 - 5564) - 4;
  v182 = *(&off_1F5090370 + v55 - 5552);
  v183 = *(&off_1F5090370 + (v55 & 0x82066A66)) - 12;
...
uint64_t sub_1D4C1C368(uint64_t a1, uint64_t a2, uint64_t a3, void *a4, _DWORD *a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, unsigned int a15, int a16)
{
  *a4 = 0;
  *a5 = 0;
...
uint64_t sub_1D4C1C3F8@<X0>(int a1@<W8>, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10)
{
...
uint64_t sub_1D4C1CC9C(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, char a12, uint64_t a13, char *a14, int a15, unsigned int a16)
{
...
void sub_1D4C1CDA8(uint64_t a1, uint64_t a2, uint64_t a3, unint64_t a4)
{
...
uint64_t sub_1D4C1D320(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, char a16, uint64_t a17, uint64_t a18, char *a19, int a20, unsigned int a21)
{
  a19 = &a16;
...
uint64_t sub_1D4C1D564@<X0>(uint64_t a1@<X0>, uint64_t a2@<X8>)
{
  v6 = v3 - 1;
  *(a1 + v6) = *(a2 + v6);
...
uint64_t sub_1D4C1D58C(uint64_t a1, unsigned int a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, uint64_t a16, uint64_t a17, uint64_t a18, uint64_t a19, uint64_t a20, uint64_t a21, uint64_t a22, uint64_t a23, uint64_t a24, uint64_t a25, uint64_t a26, uint64_t a27, uint64_t a28, uint64_t a29, uint64_t a30, uint64_t a31)
{
  v34 = v31 ^ 0xF29;
...
uint64_t sub_1D4C1D59C@<X0>(uint64_t a1@<X0>, int a2@<W8>)
{
  v7 = (v2 + v3 - 32);
  v9 = *v7;
  v8 = v7[1];
...
uint64_t sub_1D4C1D600(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7)
{
  v10 = (*(a7 + 8 * (v7 + 5750)))(v8);
  v11 = *(v9 - 256);
  *(v9 - 208) = 0;
...
uint64_t sub_1D4C1D710(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, uint64_t a16, uint64_t a17, uint64_t a18, uint64_t a19, uint64_t a20, uint64_t a21, uint64_t a22, uint64_t a23, uint64_t a24, uint64_t a25, uint64_t a26, uint64_t a27, uint64_t a28, uint64_t a29, uint64_t a30, uint64_t a31, uint64_t a32, uint64_t a33, uint64_t a34, uint64_t a35, uint64_t a36, uint64_t a37, uint64_t a38, uint64_t a39, uint64_t a40, uint64_t a41, uint64_t a42, uint64_t a43, uint64_t a44, uint64_t a45)
{
...
uint64_t sub_1D4C1D94C(uint64_t a1)
{
  ...
  result = (*(*(&off_1F5090370 + v2 - 1305607854) + (v2 ^ 0x4DD1DA24) - 1))(&v7);
  *a1 = v7;
  return result;
}

void sub_1D4C1DA7C(uint64_t a1)
{
  ...
  v2 = *(&off_1F5090370 + (v1 ^ 0x10FB)) - 8;
  (*&v2[8 * (v1 ^ 0x3448)])(v3);
  __asm { BRAA            X8, X17 }
}

uint64_t sub_1D4C1DBB0(uint64_t a1, uint64_t a2, void *a3)
{
  v6 = 63 * ((v3 - 42) ^ 0xC17);
  *a3 = a1;
  *v5 = v11;
...
uint64_t sub_1D4C1DD70(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, int a13, unsigned int a14, uint64_t a15, uint64_t *a16, unsigned int a17, unsigned int a18)
{
...
uint64_t sub_1D4C2241C(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, uint64_t a16, uint64_t a17, uint64_t a18, uint64_t a19, uint64_t a20, uint64_t a21, uint64_t a22, uint64_t a23, uint64_t a24, uint64_t a25, uint64_t a26, uint64_t a27, uint64_t a28, uint64_t a29, uint64_t a30, uint64_t a31, uint64_t a32, uint64_t a33, uint64_t a34, uint64_t a35, uint64_t a36, uint64_t a37, uint64_t a38, uint64_t a39, uint64_t a40, uint64_t a41, uint64_t a42, uint64_t a43, uint64_t a44, uint64_t a45, uint64_t a46, uint64_t a47, uint64_t a48, uint64_t a49, uint64_t a50, uint64_t a51, uint64_t a52, uint64_t a53, uint64_t a54, uint64_t a55, uint64_t a56, uint64_t a57, uint64_t a58, uint64_t a59, uint64_t a60, uint64_t a61, uint64_t a62, uint64_t a63)
{
  *a1 = 0;
  *(a1 + 8) = 0;
...
uint64_t sub_1D4C22554@<X0>(uint64_t a1@<X0>, uint64_t a2@<X1>, uint64_t a3@<X2>, int a4@<W3>, unint64_t a5@<X8>)
{
...
uint64_t sub_1D4C23194@<X0>(int a1@<W3>, unsigned int a2@<W4>, unsigned int a3@<W6>, unsigned int a4@<W8>)
{
  ...
  *(v5 + v147) = v142;
  return sub_1D4C26DDC();
}

uint64_t sub_1D4C26DDC@<X0>(int a1@<W0>, char a2@<W1>, int a3@<W2>, int a4@<W4>, int a5@<W5>, int a6@<W6>, int a7@<W7>, __int16 a8@<W8>)
{
...
uint64_t sub_1D4C26EA4(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, int a9, char a10, uint64_t a11, uint64_t a12, int a13, unsigned int a14, uint64_t a15, char *a16)
{
  a15 = a12;
  a16 = &a10;
...
uint64_t sub_1D4C2709C@<X0>(int a1@<W8>)
{
  STACK[0x9D8] = v1;
  v3 = STACK[0x658];
...
uint64_t sub_1D4C270EC(uint64_t a1)
{
  v2 = 1710126949 * (((a1 | 0x52FA8834) - (a1 & 0x52FA8834)) ^ 0x60E1D3A4);
  result = (**(&off_1F5090370 + (*(a1 + 44) - v2 + 1166560586)))((*(a1 + 40) ^ v2) - 1561180546, *(a1 + 16), *(a1 + 24), v2 ^ *(a1 + 8) ^ 0xDC62B379, *(a1 + 32), *a1);
  *(a1 + 12) = (result ^ 0x42FA9BCF) - 1107462144 + ((2 * result) & 0x85F5379E);
  return result;
}

uint64_t sub_1D4C271C4()
{
  v2 = (v0 + 3303) | 0x122;
  v3 = STACK[0x550];
  v4 = STACK[0x454];
...
uint64_t sub_1D4C271E0(uint64_t a1, uint64_t a2, int a3)
{
...
uint64_t sub_1D4C272A0@<X0>(uint64_t a1@<X0>, int a2@<W1>, uint64_t a3@<X2>, int a4@<W8>, int8x16_t a5@<Q0>)
{
  v12 = v9 + 32;
...
uint64_t sub_1D4C27330(uint64_t a1, int a2)
{
  STACK[0x808] = v4 + v5;
...
uint64_t sub_1D4C27544(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, int a5, uint64_t a6, int a7)
{
...
uint64_t sub_1D4C289C8@<X0>(uint64_t a1@<X8>, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, uint64_t a16, uint64_t a17, uint64_t a18, uint64_t a19, uint64_t a20, uint64_t a21, uint64_t a22, uint64_t a23, uint64_t a24, uint64_t a25, uint64_t a26, uint64_t a27, uint64_t a28, uint64_t a29, uint64_t a30, uint64_t a31, uint64_t a32, uint64_t a33, uint64_t a34, uint64_t a35, uint64_t a36, uint64_t a37, uint64_t a38, uint64_t a39, uint64_t a40, uint64_t a41, uint64_t a42, uint64_t a43, uint64_t a44, uint64_t a45, uint64_t a46, uint64_t a47, uint64_t a48, uint64_t a49, uint64_t a50, uint64_t a51, uint64_t a52, uint64_t a53, uint64_t a54, uint64_t a55, uint64_t a56, uint64_t a57, uint64_t a58, uint64_t a59, uint64_t a60, uint64_t a61, uint64_t a62, uint64_t a63)
{
...
uint64_t sub_1D4C28C1C(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, int a10, char a11, uint64_t a12, uint64_t a13, uint64_t a14, int a15, unsigned int a16, uint64_t a17, char *a18)
{
...
uint64_t sub_1D4C28D1C(int a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, int a8)
{
...
uint64_t sub_1D4C28E30(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, uint64_t a16, uint64_t a17, uint64_t a18, uint64_t a19, uint64_t a20, uint64_t a21, uint64_t a22, uint64_t a23, uint64_t a24, uint64_t a25)
{
...
uint64_t sub_1D4C290F4(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, uint64_t a16, uint64_t a17, uint64_t a18, uint64_t a19, uint64_t a20, uint64_t a21)
{
...
uint64_t sub_1D4C292E0@<X0>(uint64_t a1@<X0>, int a2@<W8>, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, uint64_t a16, uint64_t a17, uint64_t a18, uint64_t a19, uint64_t a20, uint64_t a21, uint64_t a22, uint64_t a23, uint64_t a24, uint64_t a25, uint64_t a26, uint64_t a27, uint64_t a28, uint64_t a29, uint64_t a30, uint64_t a31, uint64_t a32, uint64_t a33, uint64_t a34, uint64_t a35, uint64_t a36, uint64_t a37, uint64_t a38, uint64_t a39, uint64_t a40, uint64_t a41, uint64_t a42, uint64_t a43, uint64_t a44, uint64_t a45, uint64_t a46, uint64_t a47, uint64_t a48, uint64_t a49, uint64_t a50, uint64_t a51, uint64_t a52, uint64_t a53, uint64_t a54, uint64_t a55, uint64_t a56, uint64_t a57)
{
  ...
  v183.i64[0] = vqtbl4q_s8(v246, xmmword_1D4E31490).u64[0];
  ...
  v183.i64[1] = vqtbl4q_s8(v246, xmmword_1D4E31490).u64[0];
...
uint64_t sub_1D4C29C78(uint64_t a1)
{
...
void sub_1D4C29E4C(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, int a10, char a11)
{
  v13 = 2008441969 * ((~&a10 & 0xA25BEAEB | &a10 & 0x5DA41514) ^ 0xEAC2BEE5);
  a11 = 9 - v13;
  a10 = v13 + v12 - 791;
  (*(v11 + 8 * (v12 + 1495)))(&a10);
  JUMPOUT(0x1D4C26E4CLL);
}

uint64_t sub_1D4C29EC0(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, char a14, uint64_t a15, uint64_t a16, uint64_t a17, uint64_t a18, int a19, unsigned int a20, uint64_t a21, char *a22, unsigned int a23, unsigned int a24)
{
...
uint64_t sub_1D4C29F7C@<X0>(int a1@<W8>)
{
  v4 = a1 | 0x440;
...
uint64_t sub_1D4C2A094@<X0>(uint64_t a1@<X0>, uint64_t a2@<X8>)
{
  v11 = ~v5 + v2;
  v12 = *(a2 + v11 - 15);
  v13 = *(a2 + v11 - 31);
...
uint64_t sub_1D4C2A29C(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, int a11, char a12, uint64_t a13, uint64_t a14, int a15, unsigned int a16, uint64_t a17, char *a18)
{
  a17 = a13;
  a18 = &a12;
...
uint64_t sub_1D4C2A390(uint64_t a1, uint64_t a2, uint64_t a3, char a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, uint64_t a16, uint64_t a17, uint64_t a18, uint64_t a19, uint64_t a20, uint64_t a21, uint64_t a22, uint64_t a23, uint64_t a24, uint64_t a25, uint64_t a26, uint64_t a27, uint64_t a28, uint64_t a29, uint64_t a30, uint64_t a31, uint64_t a32, uint64_t a33, uint64_t a34, uint64_t a35, uint64_t a36, uint64_t a37, uint64_t a38, uint64_t a39, uint64_t a40, uint64_t a41, uint64_t a42, uint64_t a43, uint64_t a44, uint64_t a45, uint64_t a46, uint64_t a47, uint64_t a48, uint64_t a49, uint64_t a50, uint64_t a51, uint64_t a52, uint64_t a53, uint64_t a54, uint64_t a55, uint64_t a56, uint64_t a57, uint64_t a58, uint64_t a59, uint64_t a60, uint64_t a61, uint64_t a62, uint64_t a63)
{
  v76 = *STACK[0x390] + 6;
...
uint64_t sub_1D4C2A4CC(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, unint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, uint64_t a16, uint64_t a17, uint64_t a18, uint64_t a19, uint64_t a20, uint64_t a21, uint64_t a22, uint64_t a23, uint64_t a24, uint64_t a25, uint64_t a26, uint64_t a27, uint64_t a28, uint64_t a29, uint64_t a30, uint64_t a31, uint64_t a32, uint64_t a33, uint64_t a34, uint64_t a35, uint64_t a36, uint64_t a37, uint64_t a38, uint64_t a39, uint64_t a40, uint64_t a41, uint64_t a42, uint64_t a43, uint64_t a44, uint64_t a45, uint64_t a46, uint64_t a47, uint64_t a48, uint64_t a49, uint64_t a50, uint64_t a51, uint64_t a52, uint64_t a53, uint64_t a54, uint64_t a55, uint64_t a56, uint64_t a57, uint64_t a58, uint64_t a59, uint64_t a60)
{
...
uint64_t sub_1D4C2B1F0(uint64_t a1)
{
  *(a1 + 16) = *v2;
  *(a1 + 88) = *(v2 + 72);
  *(a1 + 92) = *(v2 + 76);
  ...
  *(a1 + 100) = *(v2 + 84);
  *(a1 + 124) = *(v2 + 108) & 1;
  *(a1 + 55) = *(v2 + 39) ^ 0x13 ^ *(*(&off_1F5090370 + (v1 ^ 0x32D4) - 5758) + 7) ^ *(*(&off_1F5090370 + (v1 ^ 0x256C)) + (((v1 ^ 0x32D4) - 729015424) & 0x2B73EFAF) - 8734) ^ *(*(&off_1F5090370 + (v1 ^ 0x2507)) + 15) ^ 0x3C;
  return (*(v3 + 8 * (v1 ^ 0x32D4)))();
}

uint64_t sub_1D4C2B300()
{
  *(v1 - 232) = v0 + 869295389 * (((v1 - 232) & 0xE57AF245 | ~((v1 - 232) | 0xE57AF245)) ^ 0xABD121E9) - 379707652;
  ...
  v5 = *(v1 - 228);
  v6 = (v0 - 86) ^ 1;
  v7 = *(&off_1F5090370 + (v0 ^ 0x113E));
  v8 = *(&off_1F5090370 + (v0 ^ 0x11E9));
  if (v5 == v6)
  {
    v9 = v7 - 12;
  }
...
void PjPfaWZz()
{
  ...
  v0 = *(&off_1F5090370 + ((-85 * ((dword_1EC7E4810 + dword_1EC7E4710) ^ 0xDF)) ^ byte_1D4E29000[byte_1D4E22120[(-85 * ((dword_1EC7E4810 + dword_1EC7E4710) ^ 0xDF))] ^ 0x6D]) + 16);
  v1 = -85 * ((dword_1EC7E4810 + *v0) ^ 0xDF);
  v2 = *(&off_1F5090370 + (*(off_1F5090560 + (*(off_1F5090728 + v1 - 12) ^ 0xE2u) - 12) ^ v1) + 171);
  v3 = *v0 ^ &v5 ^ *v2;
  ...
  *v2 = 2054362027 * (v3 ^ 0xB4207763EF64BDFLL);
  ...
  v4 = *(&off_1F5090370 + ((-85 * ((dword_1EC7E4810 - dword_1EC7E4710) ^ 0xDF)) ^ byte_1D4E17DB0[byte_1D4E31360[(-85 * ((dword_1EC7E4810 - dword_1EC7E4710) ^ 0xDF))] ^ 0xE9]) + 135) - 8;
  (*&v4[8 * (*(off_1F5090BE0 + (*(off_1F5090940 + v2) ^ 0x2Au) - 8) ^ v2) + 75712])(v6);
  __asm { BRAA            X8, X17 }
}

uint64_t sub_1D4C2B640(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, uint64_t a16, uint64_t a17, uint64_t a18, uint64_t a19, uint64_t a20, uint64_t a21, uint64_t a22, uint64_t a23, uint64_t a24, uint64_t a25, uint64_t a26, uint64_t a27, uint64_t a28, uint64_t a29, uint64_t a30, uint64_t a31, uint64_t a32, uint64_t a33, uint64_t a34, uint64_t a35, uint64_t a36, uint64_t a37, uint64_t a38, uint64_t a39, uint64_t a40, uint64_t a41, uint64_t a42, uint64_t a43, uint64_t a44, uint64_t a45, uint64_t a46, uint64_t a47, uint64_t a48, uint64_t a49, uint64_t a50, uint64_t a51, uint64_t a52, uint64_t a53, uint64_t a54, uint64_t a55, uint64_t a56, uint64_t a57, uint64_t a58, uint64_t a59, uint64_t a60, uint64_t a61)
{
  v78 = v64;
  v77 = v63;
  v67 = *(v61 + 8 * (v65 + 389));
...
uint64_t sub_1D4C2B7FC(uint64_t a1)
{
  v1 = 956911519 * (((a1 | 0x8055C80B) - a1 + (a1 & 0x7FAA37F4)) ^ 0x6AC4B80E);
  v2 = *(a1 + 16) ^ v1;
  v3 = *(*(&off_1F5090370 + (v2 ^ 0x1710)) + 83);
  ...
  return (*(*(&off_1F5090370 + v2 - 5355) + (((v2 + 93) ^ v5) & 1 | v2) - 1))();
}

uint64_t sub_1D4C2B934@<X0>(unint64_t a1@<X0>, unint64_t a2@<X1>, unint64_t a3@<X2>, unint64_t a4@<X3>, unint64_t a5@<X4>, unint64_t a6@<X5>, unint64_t a7@<X6>, unint64_t a8@<X7>, uint64_t a9@<X8>)
{
...
uint64_t sub_1D4C2C454(uint64_t a1, uint64_t a2, uint64_t a3, unsigned int a4, int a5, int a6)
{
  v13 = a6 - 30;
...
{
  v7 = *MEMORY[0x1E69E9840];
  v0 = *(&off_1F5090370 + ((-85 * ((dword_1EC7E4810 - dword_1EC7E44B0) ^ 0xDF)) ^ byte_1D4E17DB0[byte_1D4E31360[(-85 * ((dword_1EC7E4810 - dword_1EC7E44B0) ^ 0xDF))] ^ 0x71]) - 118);
  v1 = -85 * ((dword_1EC7E4810 - *v0) ^ 0xDF);
  ...
  *v2 = 2054362027 * (v3 ^ 0xB4207763EF64BDFLL);
  ...
  v4 = *(&off_1F5090370 + ((-85 * ((dword_1EC7E4810 - dword_1EC7E44B0) ^ 0xDF)) ^ byte_1D4E29000[byte_1D4E22120[(-85 * ((dword_1EC7E4810 - dword_1EC7E44B0) ^ 0xDF))] ^ 0x6D]) + 262) - 8;
  (*&v4[8 * (*(off_1F5090560 + (*(off_1F5090728 + v2 - 12) ^ 0xB1u) - 12) ^ v2) + 76728])(v6);
  __asm { BRAA            X8, X17 }
}

uint64_t sub_1D4C2CB9C()
{
  STACK[0x458] = 0;
  STACK[0x8A8] = 0;
...
uint64_t sub_1D4C2CBFC(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, int a14, int a15, uint64_t a16, char a17, uint64_t a18, unsigned int a19)
{
  v22 = v19 ^ 0xA8;
...
uint64_t sub_1D4C2D15C(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, char a12, __int16 a13, char a14, uint64_t a15, char a16, uint64_t a17, uint64_t a18, int a19, unsigned int a20, uint64_t a21, char *a22, unsigned int a23, char *a24)
{
...
uint64_t sub_1D4C2D1E8@<X0>(int a1@<W8>)
{
  v1 = 2811 * (a1 ^ 0xBBF);
...
uint64_t sub_1D4C2D24C(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, int a14, uint64_t a15, uint64_t a16, int a17)
{
...
uint64_t sub_1D4C2D340@<X0>(int a1@<W8>)
{
  v4 = a1 | v1;
  v8 = v4 + 2592;
  v9 = v4 - 5877;
...
uint64_t sub_1D4C2D404@<X0>(uint64_t a1@<X0>, uint64_t a2@<X8>)
{
...
uint64_t sub_1D4C2D440(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, char a10)
{
...
uint64_t sub_1D4C2D5B8(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, int a13, int a14, int a15)
{
  a14 = 0;
  a15 = 0;
...
uint64_t sub_1D4C2D6D8(unsigned int a1, uint64_t a2, uint64_t a3, uint64_t a4, int a5, int a6, uint64_t a7, unsigned int a8)
{
  ...
  LOBYTE(v24) = *(*(&off_1F5090370 + a6) + (v24 - ((v24 * v20) >> 32) * v9) - 4);
...
uint64_t sub_1D4C2D714@<X0>(uint64_t a1@<X0>, uint64_t a2@<X1>, uint64_t a3@<X2>, void *a4@<X8>)
{
  *a4 = v4;
  a4[1] = v4;
...
uint64_t sub_1D4C2D854@<X0>(uint64_t a1@<X0>, int a2@<W3>, uint64_t a3@<X8>)
{
  v18 = v3 - 1;
...
uint64_t sub_1D4C2DBD0(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t *a12)
{
...
uint64_t sub_1D4C2DC24(int8x16_t a1, int8x16_t a2, int64x2_t a3, int8x16_t a4, int64x2_t a5, int8x16_t a6, int8x16_t a7, int8x16_t a8, uint64_t a9, uint64_t a10, uint64_t a11, int a12, uint64_t a13, uint64_t a14, uint64_t a15, uint64_t a16)
{
  v29 = v17 - 16;
...
{
  v7 = *MEMORY[0x1E69E9840];
  v0 = *(&off_1F5090370 + ((-85 * ((dword_1EC7E4810 + dword_1EC7E46C0) ^ 0xDF)) ^ byte_1D4E22020[byte_1D4E17AB0[(-85 * ((dword_1EC7E4810 + dword_1EC7E46C0) ^ 0xDF))] ^ 0xEE]) - 12);
  v1 = *(v0 - 4);
  v2 = *(&off_1F5090370 + (*(off_1F5090560 + (*(off_1F5090728 + (-85 * (v1 ^ dword_1EC7E4810 ^ 0xDF)) - 12) ^ 0xD9u) - 12) ^ (-85 * (v1 ^ dword_1EC7E4810 ^ 0xDF))) - 29);
  v3 = (*v2 + v1) ^ &v5;
  ...
  *v2 = 2054362027 * (v3 ^ 0xB4207763EF64BDFLL);
  ...
  v4 = *(&off_1F5090370 + ((-85 * (dword_1EC7E46C0 ^ 0xDF ^ dword_1EC7E4810)) ^ byte_1D4E17DB0[byte_1D4E31360[(-85 * (dword_1EC7E46C0 ^ 0xDF ^ dword_1EC7E4810))] ^ 0xE9]) + 135) - 8;
  (*&v4[8 * (*(off_1F5090880 + (*(off_1F5090768 + v2 - 8) ^ 0xDDu)) ^ v2) + 75144])(v6);
  __asm { BRAA            X8, X17 }
}

uint64_t sub_1D4C2E264()
{
  v8 = v6;
...
uint64_t sub_1D4C2E394(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, char a13, uint64_t a14, uint64_t a15, char *a16, int a17, unsigned int a18)
{
  a16 = &a13;
...
uint64_t sub_1D4C2E41C(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13)
{
  v21 = v16 ^ 0xB41DBEBE;
...
void sub_1D4C2E714(uint64_t a1)
{
...
uint64_t sub_1D4C2E8A0(uint64_t a1, uint64_t a2, uint64_t a3, char a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, uint64_t a16, uint64_t a17, uint64_t a18, uint64_t a19, uint64_t a20, uint64_t a21, uint64_t a22, uint64_t a23, uint64_t a24, uint64_t a25, uint64_t a26, uint64_t a27, uint64_t a28, uint64_t a29, uint64_t a30, uint64_t a31, uint64_t a32, uint64_t a33, uint64_t a34, uint64_t a35, uint64_t a36, uint64_t a37, uint64_t a38, uint64_t a39, uint64_t a40, uint64_t a41, uint64_t a42, uint64_t a43, uint64_t a44, uint64_t a45, uint64_t a46, uint64_t a47, uint64_t a48, uint64_t a49, uint64_t a50, uint64_t a51, uint64_t a52, uint64_t a53, uint64_t a54, uint64_t a55, uint64_t a56, uint64_t a57, uint64_t a58, uint64_t a59, uint64_t a60, uint64_t a61, uint64_t a62, uint64_t a63)
{
  v76 = *STACK[0x380] + 6;
  v77 = __ROR8__(v76 & 0xFFFFFFFFFFFFFFF8, 8);
  v78 = ((0x6AF7234D0CC131D4 - v77) & 0x435B154A729201BFLL) + v77 - 0x6AF7234D0CC131D5 - ((v77 - 0x6AF7234D0CC131D5) & 0x435B154A729201BFLL);
...
{
  v7 = *MEMORY[0x1E69E9840];
  v0 = *(&off_1F5090370 + ((-85 * ((dword_1EC7E4810 - dword_1EC7E44F8) ^ 0xDF)) ^ byte_1D4E17DB0[byte_1D4E31360[(-85 * ((dword_1EC7E4810 - dword_1EC7E44F8) ^ 0xDF))] ^ 0xE2]) + 100);
  v1 = -85 * ((dword_1EC7E4810 - *v0) ^ 0xDF);
  v2 = *(&off_1F5090370 + (*(off_1F5090418 + (*(off_1F5090A88 + v1 - 8) ^ 0x67u) - 8) ^ v1) + 143);
  v3 = (*v2 ^ *v0) - &v5;
  *v0 = (2054362027 * v3) ^ 0xB4207763EF64BDFLL;
  *v2 = 2054362027 * (v3 ^ 0xB4207763EF64BDFLL);
  v6[0] = 476323082 - 1710126949 * ((-1786473908 - (v6 | 0x9584924C) + (v6 | 0x6A7B6DB3)) ^ 0x58603623);
  LOBYTE(v2) = -85 * ((*v2 - *v0) ^ 0xDF);
  v4 = *(&off_1F5090370 + ((-85 * ((dword_1EC7E4810 - dword_1EC7E44F8) ^ 0xDF)) ^ byte_1D4E22320[byte_1D4E17CB0[(-85 * ((dword_1EC7E4810 - dword_1EC7E44F8) ^ 0xDF))] ^ 0x80]) + 178) - 8;
  (*&v4[8 * (*(off_1F5090A10 + (*(off_1F5090968 + v2 - 4) ^ 0xADu) - 12) ^ v2) + 77072])(v6);
  __asm { BRAA            X8, X17 }
}

uint64_t sub_1D4C2EBF0()
{
  v6 = (v4 + v2 - 16);
  v7 = (v0 + v2 - 16);
  v8 = *v7;
...
uint64_t sub_1D4C2EC50(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, int a10, uint64_t a11, char a12, uint64_t a13, int a14, unsigned int a15, uint64_t a16, char *a17, unsigned int a18, unsigned int a19)
{
...
uint64_t sub_1D4C2ED40@<X0>(int a1@<W8>, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, uint64_t a16)
{
  v20 = (a1 - 96) | 0x43;
...
uint64_t sub_1D4C2F28C@<X0>(uint64_t a1@<X2>, int a2@<W8>, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, uint64_t a16, uint64_t a17, uint64_t a18, uint64_t a19, uint64_t a20, uint64_t a21, uint64_t a22, uint64_t a23, uint64_t a24, uint64_t a25, uint64_t a26, uint64_t a27, uint64_t a28, uint64_t a29, uint64_t a30, uint64_t a31, uint64_t a32, uint64_t a33, uint64_t a34, uint64_t a35, uint64_t a36, uint64_t a37, uint64_t a38, uint64_t a39, uint64_t a40, uint64_t a41, uint64_t a42, uint64_t a43, uint64_t a44, uint64_t a45, uint64_t a46, uint64_t a47, uint64_t a48, uint64_t a49, uint64_t a50, uint64_t a51, uint64_t a52, uint64_t a53, uint64_t a54, uint64_t a55, uint64_t a56, uint64_t a57)
{
  v68 = a1 + v57;
  v69 = a1 + v57 + 9;
...
uint64_t sub_1D4C2F3C0(uint64_t a1)
{
...
uint64_t sub_1D4C2F400(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, char a10, uint64_t a11, char *a12, int a13, unsigned int a14)
{
  a12 = &a10;
...
uint64_t sub_1D4C2F4F0@<X0>(int a1@<W8>)
{
...
uint64_t sub_1D4C304FC(uint64_t a1)
{
  v1 = *(a1 + 8) ^ (914963389 * (((a1 | 0xCE82EC95) - (a1 & 0xCE82EC95)) ^ 0xE27E5DEE));
  v424 = *(&off_1F5090370 + (v1 ^ 0x80660B11));
  v2 = *v424;
  v423 = *(&off_1F5090370 + (v1 ^ 0x80660A75));
  v3 = *(v423 - 4);
  v421 = *(&off_1F5090370 + (v1 ^ 0x80660A17));
  v4 = (*v424)[1] + 46;
  v5 = v4 & 0x32 ^ 0xB7;
  v6 = 2 * ((v4 ^ (2 * ((v4 ^ 0x44) & (2 * ((v4 ^ 0x54) & (2 * ((v4 ^ 0x54) & (2 * ((v4 ^ 0x54) & (2 * ((v4 ^ 0x54) & (2 * ((v4 ^ 0x44) & 0x26 ^ v5)) ^ v5)) ^ v5)) ^ v5)) ^ v5)) ^ v5))) & 0x9E);
  v7 = *(&off_1F5090370 + v1 + 2140796448);
  v8 = *(&off_1F5090370 + (v1 ^ 0x80660B64));
  v411 = v8 + 267;
  ...
  v420 = *(&off_1F5090370 + v1 + 2140796444);
  v16 = *v420;
  ...
  v418 = *(&off_1F5090370 + v1 + 2140796352);
  ...
  v415 = *(&off_1F5090370 + (v1 ^ 0x80660B68));
  v412 = *(&off_1F5090370 + (v1 ^ 0x80660BA8));
  ...
  v409 = *(&off_1F5090370 + (v1 ^ 0x80660A0F));
  ...
  v416 = *(&off_1F5090370 + v1 + 2140796309);
  ...
  v417 = *(&off_1F5090370 + (v1 ^ 0x80660BA4));
  ...
  v414 = *(&off_1F5090370 + (v1 ^ 0x80660BC1));
  ...
  v413 = *(&off_1F5090370 + (v1 ^ 0x80660BBF));
  v51 = *v413;
  v410 = *(&off_1F5090370 + (v1 ^ 0x80660A2D));
  v408 = *(&off_1F5090370 + (v1 ^ 0x80660B7E));
  ...
  v53 = *(&off_1F5090370 + (v1 ^ 0x80660B6C));
  ...
  *v413 = v51 + 1;
  v422 = *(&off_1F5090370 + (v1 ^ 0x80660B2D));
  ...
  v196 = *(&off_1F5090370 + v1 + 2140796428);
...
void woqRTqq9PL5McfBs891()
{
  ...
  v0 = *(&off_1F5090370 + ((-85 * ((dword_1EC7E4810 - dword_1EC7E4838) ^ 0xDF)) ^ byte_1D4E17DB0[byte_1D4E31360[(-85 * ((dword_1EC7E4810 - dword_1EC7E4838) ^ 0xDF))] ^ 0xB1]) + 161);
  ...
  *v1 = 2054362027 * (v2 ^ 0xB4207763EF64BDFLL);
  ...
  v3 = *(&off_1F5090370 + ((-85 * (dword_1EC7E4838 ^ 0xDF ^ dword_1EC7E4810)) ^ byte_1D4E17DB0[byte_1D4E31360[(-85 * (dword_1EC7E4838 ^ 0xDF ^ dword_1EC7E4810))] ^ 0xE9]) + 135) - 8;
  (*&v3[8 * (*(off_1F5090BE0 + (*(off_1F5090940 + v1) ^ 0x2Au) - 8) ^ v1) + 75712])(v5);
  __asm { BRAA            X8, X17 }
}

uint64_t sub_1D4C34E10(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, uint64_t a16, uint64_t a17, uint64_t a18, uint64_t a19, uint64_t a20, uint64_t a21, uint64_t a22, uint64_t a23, uint64_t a24, uint64_t a25, uint64_t a26, uint64_t a27, uint64_t a28, uint64_t a29, uint64_t a30, uint64_t a31, uint64_t a32, uint64_t a33, uint64_t a34, uint64_t a35, uint64_t a36, uint64_t a37, uint64_t a38, uint64_t a39, uint64_t a40)
{
...
uint64_t sub_1D4C361CC(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5)
{
...
uint64_t sub_1D4C36214@<X0>(uint64_t a1@<X0>, uint64_t a2@<X1>, uint64_t a3@<X2>, uint64_t a4@<X3>, int a5@<W4>, uint64_t a6@<X5>, uint64_t a7@<X8>)
{
  v15 = (v12 ^ v9 ^ v10) + a6;
...
uint64_t sub_1D4C36364(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, uint64_t a16, unsigned int a17, int a18)
{
...
uint64_t sub_1D4C364B4(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, char a12, char *a13, int a14, unsigned int a15)
{
  a13 = &a12;
...
uint64_t sub_1D4C36614(uint64_t a1, uint64_t a2, uint64_t a3)
{
  v6 = *(v4 + 8);
  STACK[0x900] = *(v5 + 8 * v3);
...
uint64_t sub_1D4C366A8@<X0>(uint64_t a1@<X0>, _DWORD *a2@<X6>, int a3@<W8>)
{
  v7 = (v3 - 770) | 0x601;
  *v4 = a1;
  *a2 = a3;
...
uint64_t sub_1D4C367DC@<X0>(uint64_t a1@<X0>, int a2@<W2>, uint64_t a3@<X8>)
{
...
uint64_t sub_1D4C3724C(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, char a11, uint64_t a12, int a13, char a14, uint64_t a15, int a16, char a17, uint64_t a18, int a19, unsigned int a20, uint64_t a21, char *a22, unsigned int a23, char *a24)
{
  v27 = 2 * &a19;
...
uint64_t sub_1D4C373E0(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, uint64_t a16, uint64_t a17, uint64_t a18, uint64_t a19, uint64_t a20, uint64_t a21, uint64_t a22, uint64_t a23, uint64_t a24, uint64_t a25, uint64_t a26, uint64_t a27, uint64_t a28, uint64_t a29, uint64_t a30, uint64_t a31, uint64_t a32, uint64_t a33, uint64_t a34, uint64_t a35, uint64_t a36, uint64_t a37, uint64_t a38, uint64_t a39, uint64_t a40, uint64_t a41, uint64_t a42, uint64_t a43, uint64_t a44, uint64_t a45, uint64_t a46, uint64_t a47, uint64_t a48, uint64_t a49, uint64_t a50, uint64_t a51, uint64_t a52, uint64_t a53, uint64_t a54, uint64_t a55, uint64_t a56, uint64_t a57, uint64_t a58, uint64_t a59, uint64_t a60, uint64_t a61, uint64_t a62, int a63)
{
...
uint64_t sub_1D4C376AC(double a1, int8x16_t a2, int64x2_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, uint64_t a16, uint64_t a17, uint64_t a18, uint64_t a19, uint64_t a20, uint64_t a21, uint64_t a22, uint64_t a23, uint64_t a24, uint64_t a25, uint64_t a26, uint64_t a27, uint64_t a28, uint64_t a29, uint64_t a30, uint64_t a31, uint64_t a32, uint64_t a33, uint64_t a34, uint64_t a35, uint64_t a36, uint64_t a37, uint64_t a38, uint64_t a39, uint64_t a40, uint64_t a41, uint64_t a42, uint64_t a43, uint64_t a44, uint64_t a45, uint64_t a46, uint64_t a47, uint64_t a48, uint64_t a49, uint64_t a50, uint64_t a51, uint64_t a52, uint64_t a53, uint64_t a54, uint64_t a55, uint64_t a56, uint64_t a57, uint64_t a58, uint64_t a59, uint64_t a60, uint64_t a61, uint64_t a62, uint64_t a63)
{
  v76 = v72 - 16;
  v77 = STACK[0x2F0] + v76;
  v78 = v77 + STACK[0x200];
...
uint64_t sub_1D4C376B4(uint64_t a1, uint64_t a2, unint64_t a3)
{
...
uint64_t sub_1D4C37770@<X0>(uint64_t a1@<X0>, uint64_t a2@<X8>)
{
  v5 = *(v2 + 4);
  *(a2 + 20) = v5;
...
uint64_t sub_1D4C378E0(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, void *a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, _DWORD *a11, uint64_t a12, uint64_t a13, int a14, int a15)
{
  *a5 = a1;
  *a11 = a15;
...
uint64_t sub_1D4C37B28(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, char a10, __int16 a11, char a12, uint64_t a13, int a14, char a15, uint64_t a16, int a17, unsigned int a18, uint64_t a19, char *a20)
{
...
void sub_1D4C37D5C(uint64_t a1@<X8>)
{
  *v2 = v1;
  *(v1 + 8) = *(a1 + 8);
  *(a1 + 8) = v1;
...
uint64_t sub_1D4C37DA0(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4)
{
  v5 = *STACK[0x5F8];
  STACK[0x5D8] = 0;
  STACK[0x3F8] = 0;
...
uint64_t sub_1D4C37EC4(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, char a14, uint64_t a15, char *a16, int a17, unsigned int a18)
{
...
uint64_t sub_1D4C38038(uint64_t a1, int a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, uint64_t a16, uint64_t a17, uint64_t a18, uint64_t a19, uint64_t a20, uint64_t a21, uint64_t a22, uint64_t a23, uint64_t a24, uint64_t a25, uint64_t a26, uint64_t a27, uint64_t a28, uint64_t a29, uint64_t a30, uint64_t a31, uint64_t a32, uint64_t a33, uint64_t a34, uint64_t a35, uint64_t a36, uint64_t a37, uint64_t a38, uint64_t a39, uint64_t a40, uint64_t a41, uint64_t a42, uint64_t a43, uint64_t a44, uint64_t a45, uint64_t a46, uint64_t a47, uint64_t a48, uint64_t a49, uint64_t a50, uint64_t a51)
{
  v56 = (a51 + v52 + a4 + v51);
  v57 = *(a3 + v51 - 16);
  *&v58 = a3 + v51 - 15;
...
uint64_t sub_1D4C38B6C@<X0>(uint64_t a1@<X8>)
{
  v2 = *(a1 + 8);
  STACK[0x490] = 0;
  STACK[0x6C8] = 0;
...
uint64_t sub_1D4C38E74(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8)
{
  v16 = *(a6 + 24);
...
uint64_t sub_1D4C395B8(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7)
{
  v9 = (*(a7 + 8 * (v7 ^ 0x34C3)))();
  *(v8 + 24) = 0;
  return sub_1D4C395DC(v9);
}

void sub_1D4C39608(uint64_t a1)
{
  v1 = *(a1 + 28) - 1875091903 * ((2 * (a1 & 0xDAE363A6) - a1 + 622632025) ^ 0x13691FDA);
  v2 = *(&off_1F5090370 + (v1 ^ 0x25B6)) - 8;
...
uint64_t sub_1D4C39870@<X0>(char a1@<W0>, uint64_t a2@<X1>, uint64_t a3@<X2>, uint64_t a4@<X3>, uint64_t a5@<X4>, uint64_t a6@<X5>, uint64_t a7@<X6>, uint64_t a8@<X7>, uint64_t a9@<X8>)
{
  v17 = v12 - 1;
...
uint64_t sub_1D4C399A4(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, int a12, unsigned int a13, unsigned int a14, uint64_t a15)
{
...
uint64_t sub_1D4C39A88(uint64_t a1, int a2)
{
...
uint64_t sub_1D4C40834(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, int a12, char a13, uint64_t a14, int a15, unsigned int a16, uint64_t a17, char *a18)
{
  a17 = a10;
  a18 = &a13;
...
uint64_t sub_1D4C40974(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, unint64_t *a10)
{
  v17 = v16 - 136;
...
uint64_t sub_1D4C40C5C(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, unsigned int a15, unsigned int a16, unsigned int a17, uint64_t a18, uint64_t a19)
{
...
uint64_t sub_1D4C40E54@<X0>(uint64_t a1@<X0>, int a2@<W8>)
{
  *v3 = a1;
  *v2 = a2;
  v10 = v7;
...
uint64_t sub_1D4C40E60(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, unsigned __int8 a10)
{
...
uint64_t sub_1D4C40F70(uint64_t a1, int a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, uint64_t a16, uint64_t a17, uint64_t a18, uint64_t a19, uint64_t a20, uint64_t a21, uint64_t a22, uint64_t a23, uint64_t a24, uint64_t a25)
{
...
uint64_t sub_1D4C4109C(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, uint64_t a16, uint64_t a17, uint64_t a18, uint64_t a19, uint64_t a20, uint64_t a21, uint64_t a22, uint64_t a23, uint64_t a24, uint64_t a25, uint64_t a26, uint64_t a27, uint64_t a28, uint64_t a29, uint64_t a30, uint64_t a31, uint64_t a32, uint64_t a33, uint64_t a34, uint64_t a35, uint64_t a36, uint64_t a37, uint64_t a38, uint64_t a39, uint64_t a40, uint64_t a41, uint64_t a42, uint64_t a43, uint64_t a44, uint64_t a45, uint64_t a46, uint64_t a47, uint64_t a48, uint64_t a49, uint64_t a50, uint64_t a51, uint64_t a52, uint64_t a53, uint64_t a54, uint64_t a55, uint64_t a56, uint64_t a57, uint64_t a58, uint64_t a59, uint64_t a60, uint64_t a61, uint64_t a62, uint64_t a63)
{
...
uint64_t sub_1D4C412A0(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, char a11, __int16 a12, char a13, __int16 a14, char a15, uint64_t a16, uint64_t a17, int a18, unsigned int a19, uint64_t a20, char *a21, unsigned int a22, char *a23)
{
...
uint64_t sub_1D4C413FC@<X0>(unint64_t a1@<X8>)
{
...
uint64_t sub_1D4C416C4(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, uint64_t a16, uint64_t a17, uint64_t a18, uint64_t a19, uint64_t a20, uint64_t a21, uint64_t a22, uint64_t a23, uint64_t a24, uint64_t a25, uint64_t a26, uint64_t a27, uint64_t a28, uint64_t a29, uint64_t a30, uint64_t a31, uint64_t a32, uint64_t a33, uint64_t a34, uint64_t a35, uint64_t a36, uint64_t a37, uint64_t a38)
{
...
uint64_t sub_1D4C41778(uint64_t a1, uint64_t a2, unint64_t a3, int a4)
{
...
uint64_t sub_1D4C41898@<X0>(int a1@<W8>)
{
...
uint64_t sub_1D4C41B50@<X0>(uint64_t a1@<X1>, __int16 a2@<W2>, int a3@<W4>, int a4@<W6>, uint64_t a5@<X8>)
{
...
uint64_t sub_1D4C41BD0(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7)
{
...
uint64_t sub_1D4C41C10(uint64_t a1, __int128 *a2)
{
  v7 = *a2;
  *(v5 - 1) = *(a2 - 1);
  *v5 = v7;
...
uint64_t sub_1D4C41CA0@<X0>(int a1@<W8>)
{
  v2 = *(STACK[0x718] + 24);
  STACK[0x498] = v2;
...
uint64_t sub_1D4C41D24(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4)
{
...
uint64_t sub_1D4C41EC4(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, uint64_t a16, uint64_t a17, uint64_t a18, uint64_t a19, uint64_t a20, uint64_t a21, uint64_t a22, uint64_t a23, uint64_t a24, uint64_t a25)
{
  if (v26)
  {
    v27 = a4 == 0;
...
uint64_t sub_1D4C41F8C(uint64_t a1)
{
  v4 = v1 - 4387;
  *v7 = a1;
  v5 = (v1 - 4387) ^ 0xF99;
...
uint64_t sub_1D4C421C0(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, char a11, uint64_t a12, uint64_t a13, uint64_t a14, char *a15, int a16, unsigned int a17)
{
  a15 = &a11;
...
uint64_t sub_1D4C422B4(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, _DWORD *a6, uint64_t a7, void *a8)
{
  v11 = (v8 - 3985) | 0x48C;
  *a8 = a1;
  *a6 = v16;
...
uint64_t sub_1D4C425F4(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, void *a9, _DWORD *a10)
{
  *a9 = a1;
  *a10 = v10;
  return sub_1D4BDE238();
}

uint64_t sub_1D4C4261C(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, uint64_t a16, uint64_t a17, uint64_t a18, uint64_t a19, uint64_t a20, uint64_t a21, uint64_t a22, uint64_t a23, uint64_t a24, uint64_t a25, uint64_t a26, uint64_t a27, uint64_t a28, uint64_t a29, uint64_t a30, uint64_t a31, uint64_t a32, uint64_t a33, uint64_t a34, uint64_t a35, uint64_t a36, uint64_t a37, uint64_t a38, uint64_t a39, uint64_t a40, uint64_t a41, uint64_t a42, uint64_t a43, uint64_t a44, uint64_t a45, uint64_t a46, uint64_t a47, uint64_t a48, uint64_t a49, uint64_t a50, uint64_t a51, uint64_t a52, uint64_t a53, uint64_t a54, uint64_t a55, uint64_t a56, uint64_t a57, uint64_t a58, uint64_t a59, uint64_t a60, uint64_t a61, uint64_t a62, uint64_t a63)
{
...
uint64_t sub_1D4C4263C(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, unsigned int a12, unsigned int a13, unsigned int a14, uint64_t a15, uint64_t a16)
{
...
uint64_t sub_1D4C427CC(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, uint64_t a16, uint64_t a17, uint64_t a18, uint64_t a19, uint64_t a20, uint64_t a21, uint64_t a22, uint64_t a23, uint64_t a24, uint64_t a25, uint64_t a26, uint64_t a27, uint64_t a28, uint64_t a29, uint64_t a30, uint64_t a31, uint64_t a32, uint64_t a33, uint64_t a34, uint64_t a35, uint64_t a36, uint64_t a37, uint64_t a38, uint64_t a39, uint64_t a40, uint64_t a41, uint64_t a42, uint64_t a43, uint64_t a44, uint64_t a45, uint64_t a46, uint64_t a47, uint64_t a48, uint64_t a49, uint64_t a50, uint64_t a51, uint64_t a52, uint64_t a53, uint64_t a54, uint64_t a55, uint64_t a56, uint64_t a57, uint64_t a58, uint64_t a59, uint64_t a60, uint64_t a61, uint64_t a62, uint64_t a63)
{
...
uint64_t sub_1D4C42EE8(void *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, uint64_t a16)
{
  if (a16)
  {
    v18 = v16 == 0;
...
uint64_t sub_1D4C42F84(uint64_t a1)
{
...
uint64_t sub_1D4C43024@<X0>(uint64_t a1@<X8>)
{
...
void sub_1D4C430DC(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, uint64_t a16, uint64_t a17, uint64_t a18, uint64_t a19, uint64_t a20, uint64_t a21, uint64_t a22, uint64_t a23, uint64_t a24, uint64_t a25, uint64_t a26, uint64_t a27, uint64_t a28, uint64_t a29, uint64_t a30, uint64_t a31, uint64_t a32, uint64_t a33, uint64_t a34, uint64_t a35, uint64_t a36, uint64_t a37, uint64_t a38, uint64_t a39, uint64_t a40, uint64_t a41, uint64_t a42, uint64_t a43, uint64_t a44, uint64_t a45, uint64_t a46, uint64_t a47, uint64_t a48, uint64_t a49, uint64_t a50, uint64_t a51, uint64_t a52, uint64_t a53, uint64_t a54, uint64_t a55, uint64_t a56, uint64_t a57, uint64_t a58, uint64_t a59, uint64_t a60, uint64_t a61, uint64_t a62, uint64_t a63)
{
  STACK[0x5E0] = 0;
...
uint64_t sub_1D4C44228(uint64_t a1)
{
  v5 = v4 | 0x1046;
  v6 = *(v3 + 352);
...
uint64_t sub_1D4C442C0(unint64_t a1)
{
  *a1 = 0;
  *(a1 + 8) = 0;
  STACK[0x2B0] = a1;
...
uint64_t sub_1D4C4439C(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, int a8)
{
  v19 = v11 - 1;
...
uint64_t sub_1D4C444F0(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, unsigned int a14, int a15)
{
...
uint64_t sub_1D4C448FC(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7)
{
...
uint64_t sub_1D4C44C58(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, unsigned int a15, int a16, unsigned int a17, uint64_t a18, uint64_t a19)
{
...
uint64_t sub_1D4C44EDC@<X0>(uint64_t a1@<X4>, uint64_t a2@<X8>)
{
  v9 = v3 - 16;
  v10 = STACK[0x260] + v9;
  v11 = v10 + (v5 ^ a2);
...
void sub_1D4C44F54(uint64_t a1, uint64_t a2, uint64_t a3, int a4)
{
  STACK[0x8A0] = 0;
  STACK[0x540] = *(v4 + 8 * a4);
  JUMPOUT(0x1D4CEE024);
...
uint64_t sub_1D4C45040(uint64_t a1)
{
  v3 = STACK[0x3F8];
  v4 = STACK[0x3F8] - 8456;
  v5 = STACK[0x3F8] - 927;
...
void sub_1D4C450E4(uint64_t a1@<X0>, char a2@<W1>, char a3@<W2>, int a4@<W4>, uint64_t a5@<X5>, uint64_t a6@<X8>)
{
...
uint64_t sub_1D4C45390(uint64_t a1, uint64_t a2, uint64_t a3)
{
...
uint64_t sub_1D4C45454@<X0>(int a1@<W8>)
{
  v7 = v5 - 2499;
...
uint64_t sub_1D4C45500(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, int a16, int a17, uint64_t a18, uint64_t a19, uint64_t a20)
{
...
uint64_t sub_1D4C45BE0@<X0>(uint64_t a1@<X2>, int a2@<W8>, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9)
{
  v20 = a1 + v16;
  v21 = a1 + v16 + 9;
...
uint64_t sub_1D4C45D58(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, char a12, uint64_t a13, int a14, unsigned int a15, uint64_t a16, char *a17, unsigned int a18, unsigned int a19)
{
...
uint64_t sub_1D4C45EB4@<X0>(uint64_t a1@<X0>, uint64_t a2@<X8>)
{
  v6 = v4 - 1;
  *(a1 + v6) = *(a2 + v6);
...
uint64_t sub_1D4C45EE4(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, unsigned int a14, int a15)
{
...
uint64_t sub_1D4C45F78(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, char a11, uint64_t a12, uint64_t a13, int a14, int a15, uint64_t a16, char *a17, int a18, int a19)
{
...
uint64_t sub_1D4C480FC@<X0>(uint64_t a1@<X0>, unsigned int a2@<W8>)
{
  v7 = v4 - 1;
  *(a1 + v7) = *(v2 + v7);
...
uint64_t sub_1D4C484F0(unsigned int a1)
{
...
uint64_t sub_1D4C4860C@<X0>(uint64_t a1@<X8>)
{
  *(a1 + v1) = 0;
...
uint64_t sub_1D4C48828@<X0>(uint64_t a1@<X0>, unsigned int a2@<W8>)
{
  v6 = v2 ^ 0xA5E;
...
uint64_t sub_1D4C48A50(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, char a14, uint64_t a15, int a16, unsigned int a17, uint64_t a18, char *a19, unsigned int a20, unsigned int a21)
{
...
uint64_t sub_1D4C48B80@<X0>(uint64_t a1@<X0>, uint64_t a2@<X1>, uint64_t a3@<X2>, uint64_t a4@<X3>, uint64_t a5@<X4>, uint64_t a6@<X5>, uint64_t a7@<X6>, uint64_t a8@<X7>, int a9@<W8>, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13)
{
  v21 = *(v18 + 8 * v13);
  v22 = *v15;
  v23 = v14 + a5;
...
uint64_t sub_1D4C48BC0(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, char a11, uint64_t a12, uint64_t a13, int a14, unsigned int a15, uint64_t a16, char *a17, unsigned int a18, unsigned int a19)
{
...
uint64_t sub_1D4C48C78(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, char a10, __int16 a11, char a12, __int16 a13, char a14, uint64_t a15, uint64_t a16, uint64_t a17, int a18, unsigned int a19, uint64_t a20, char *a21, unsigned int a22, char *a23)
{
  a23 = &a14;
...
uint64_t sub_1D4C48FBC(uint64_t a1, uint64_t a2, uint64_t a3, void *a4, _DWORD *a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, unsigned int a15, int a16)
{
  *a4 = 0;
  *a5 = 0;
...
uint64_t sub_1D4C490AC(unsigned int a1, uint64_t a2, uint64_t a3, uint64_t a4, unsigned int a5, unsigned int a6, unsigned int a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, uint64_t a16, uint64_t a17, uint64_t a18, uint64_t a19, uint64_t a20, uint64_t a21, uint64_t a22, uint64_t a23, uint64_t a24, uint64_t a25, uint64_t a26, uint64_t a27, uint64_t a28, uint64_t a29, uint64_t a30, uint64_t a31, uint64_t a32, int a33, uint64_t a34, uint64_t a35, uint64_t a36, uint64_t a37, uint64_t a38, uint64_t a39, uint64_t a40, uint64_t a41, uint64_t a42, uint64_t a43, uint64_t a44, uint64_t a45, uint64_t a46, uint64_t a47, unsigned __int8 *a48, uint64_t a49, uint64_t a50)
{
  ...
  v76 = a48[27] ^ v57;
  v77 = *(v62 + 15) ^ a48[31];
  v78 = *(&off_1F5090370 + a33 - 744420119) - 4;
  ...
  return (*(a50 + 8 * ((a33 - 744415768) ^ 0x2B)))(v69, a2, v63, 132, v82 ^ v74 ^ 0xFFFFFF87, 4294967256, v75, 4294967260, a9, a10, a11, a12, a13, a14, a15, v84, a17, a18, a19, a20, a21, a22, a23, a24, a25, a26, a27, v85, a29, a30, a31, a32, *(*(&off_1F5090370 + (a33 ^ 0x2C5EF42E)) + ((v82 ^ v74) ^ 0xE0) - 8), v65, v67, v68, v76, v72, v73, v70);
}

uint64_t sub_1D4C490D8()
{
  v13 = v9;
  v14 = &v10;
...
uint64_t sub_1D4C4933C@<X0>(int a1@<W8>)
{
  *v1 = v7;
  v4 = (a1 + 1476) ^ 0x1475;
...
uint64_t sub_1D4C49458(uint64_t a1)
{
  v3 = STACK[0x3F8] - 1966;
  v4 = STACK[0x3F8] - 1189;
  LODWORD(STACK[0x84C]) = v1;
...
uint64_t sub_1D4C4949C(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, char a14, uint64_t a15, uint64_t a16, char *a17, int a18, unsigned int a19)
{
...
uint64_t sub_1D4C495D0(uint64_t a1, unint64_t a2, unint64_t a3, unint64_t a4, unint64_t a5, unint64_t a6, unint64_t a7, unint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, uint64_t a16, uint64_t a17, uint64_t a18, uint64_t a19, uint64_t a20, uint64_t a21, uint64_t a22, uint64_t a23, uint64_t a24, uint64_t a25, uint64_t a26, uint64_t a27, uint64_t a28, uint64_t a29, uint64_t a30, uint64_t a31, uint64_t a32, uint64_t a33, uint64_t a34, uint64_t a35, uint64_t a36, uint64_t a37, uint64_t a38, uint64_t a39, uint64_t a40, uint64_t a41, uint64_t a42, uint64_t a43, uint64_t a44, uint64_t a45, uint64_t a46, uint64_t a47, uint64_t a48, uint64_t a49, uint64_t a50, uint64_t a51, uint64_t a52, uint64_t a53, uint64_t a54, uint64_t a55, uint64_t a56, uint64_t a57, uint64_t a58, uint64_t a59, uint64_t a60, uint64_t a61)
{
  ...
  *(v79 + 8 + v72) = vrev64_s8(*&vqtbl4q_s8(v194, xmmword_1D4E31470));
  return (*(STACK[0x330] + 8 * ((14274 * (v67 - (v72 & 0xFFFFFFF8) == -8)) ^ v68)))();
}

uint64_t sub_1D4C49C08(unint64_t a1)
{
...
uint64_t sub_1D4C49D00@<X0>(int a1@<W8>)
{
...
uint64_t sub_1D4C49D24@<X0>(int a1@<W8>)
{
  v3 = a1 - 3184;
  v4 = (*(v1 + 8 * (a1 + 3999)))();
...
uint64_t sub_1D4C49E3C@<X0>(uint64_t a1@<X0>, int a2@<W8>)
{
  v6 = v3 - 1;
  *(a1 + v6) = *(v2 + v6);
...
uint64_t sub_1D4C49E7C(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, char a14, uint64_t a15, int a16, unsigned int a17, uint64_t a18, char *a19, unsigned int a20, unsigned int a21)
{
...
uint64_t sub_1D4C49FBC(uint64_t a1)
{
  *(a1 + 80) = 16640;
  *a1 = 1442350434;
  *(a1 + 8) = v2;
...
uint64_t sub_1D4C4A0D0(uint64_t a1)
{
  *a1 = 0;
  *(a1 + 8) = 0;
...
uint64_t sub_1D4C4A248(uint64_t a1, int a2)
{
  v6 = v4 + a2 + 1819;
...
uint64_t sub_1D4C4A37C@<X0>(uint64_t a1@<X0>, uint64_t a2@<X8>)
{
  v6 = (a1 + v3 - 16);
  v7 = (a2 + v3 - 16);
  v8 = *v7;
...
uint64_t sub_1D4C4A3D8@<X0>(int a1@<W8>, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, uint64_t a16, void *a17)
{
  v19 = *(v18 - 160);
  v20 = v19[1];
  a17[1] = v20;
...
uint64_t sub_1D4C4A430(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, char a11, int a12, int a13, unsigned int a14, uint64_t a15, char *a16, unsigned int a17, unsigned int a18)
{
...
uint64_t sub_1D4C4A508@<X0>(unint64_t *a1@<X8>)
{
  v3 = *a1;
  STACK[0x5C8] = *a1;
...
uint64_t sub_1D4C4A524@<X0>(uint64_t a1@<X0>, uint64_t a2@<X1>, uint64_t a3@<X5>, char a4@<W8>, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, uint64_t a16, uint64_t a17, uint64_t a18, uint64_t a19, uint64_t a20, uint64_t a21, uint64_t a22, uint64_t a23, uint64_t a24, uint64_t a25, uint64_t a26, uint64_t a27, uint64_t a28, uint64_t a29, uint64_t a30, uint64_t a31, uint64_t a32, uint64_t a33, uint64_t a34, uint64_t a35, uint64_t a36, uint64_t a37, uint64_t a38, uint64_t a39, uint64_t a40, uint64_t a41, uint64_t a42, uint64_t a43, uint64_t a44, uint64_t a45, uint64_t a46, uint64_t a47, uint64_t a48, uint64_t a49, uint64_t a50, uint64_t a51, uint64_t a52, uint64_t a53, uint64_t a54, uint64_t a55, uint64_t a56, uint64_t a57, uint64_t a58, uint64_t a59, uint64_t a60, uint64_t a61, uint64_t a62, uint64_t a63)
{
  v72 = STACK[0x310];
  v73 = *STACK[0x3A0] + 6;
...
uint64_t sub_1D4C4AD24@<X0>(int a1@<W8>)
{
  v7 = a1 ^ 0x1506;
  v8 = *(v4 + 120);
...
uint64_t sub_1D4C4AECC(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, uint64_t a16, uint64_t a17, uint64_t a18, uint64_t a19, uint64_t a20, uint64_t a21, uint64_t a22, uint64_t a23, uint64_t a24, uint64_t a25, uint64_t a26, uint64_t a27, uint64_t a28, uint64_t a29, uint64_t a30)
{
  (*(v32 + 8 * (v30 + 1232700997)))(a25 + a26, 0x100004077774924);
  v33 = (*(v32 + 76968))();
  *v31 = v33;
  return sub_1D4C4AF74(v33, v34, v35, v36, v37, v38, v39, v40, a9, a10, a11, a12, a13, a14, a15, a16, a17, a18, a19, a20, a21, a22, a23, a24, a25, a26, a27, a28, a29, a30);
}

uint64_t sub_1D4C4AFB0()
{
  v3 = v0 - 2297;
...
uint64_t sub_1D4C4AFD4(unint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, uint64_t a16, uint64_t a17, uint64_t a18, uint64_t a19, uint64_t a20, uint64_t a21, uint64_t a22, uint64_t a23, uint64_t a24, uint64_t a25, uint64_t a26, uint64_t a27, uint64_t a28, uint64_t a29, uint64_t a30, uint64_t a31, uint64_t a32, uint64_t a33, uint64_t a34, uint64_t a35, uint64_t a36, uint64_t a37, uint64_t a38, uint64_t a39, uint64_t a40, uint64_t a41, uint64_t a42, uint64_t a43, uint64_t a44, uint64_t a45, uint64_t a46, uint64_t a47, uint64_t a48, uint64_t a49, uint64_t a50, uint64_t a51, uint64_t a52, uint64_t a53, uint64_t a54, uint64_t a55, uint64_t a56, uint64_t a57, uint64_t a58, uint64_t a59, uint64_t a60, uint64_t a61, uint64_t a62, uint64_t a63)
{
  STACK[0x8B0] = a1;
  *a1 = 5;
  *(a1 + 4) = 0;
...
uint64_t sub_1D4C4B37C@<X0>(uint64_t a1@<X0>, int a2@<W8>)
{
  v3 = a2 - 2912;
  v4 = a2 - 4891;
  v5 = v4 ^ 0x50;
...
uint64_t sub_1D4C4B3DC(int a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, int8x16_t a7, int8x8_t a8)
{
  v13 = a3 - 8;
...
uint64_t sub_1D4C4B3EC@<X0>(uint64_t a1@<X0>, char a2@<W6>, uint64_t a3@<X8>)
{
  v7 = v4 - 1;
  *(a1 + v7) = *(a3 + v7);
...
uint64_t sub_1D4C4B4E0(uint64_t a1, uint64_t a2, _BYTE *a3, _BYTE *a4, char a5, char a6, uint64_t a7)
{
...
uint64_t sub_1D4C4B5A4@<X0>(int a1@<W8>)
{
  v3 = a1 + 1406;
  (*(v2 + 8 * (a1 ^ 0x2070)))();
  *(v1 + 368) = 0;
...
uint64_t sub_1D4C4C3C0@<X0>(uint64_t a1@<X0>, int a2@<W2>, uint64_t a3@<X8>)
{
  v6 = (a1 + v3 - 16);
  v7 = (a3 + v3 - 16);
  v8 = *v7;
...
uint64_t sub_1D4C4C45C@<X0>(int a1@<W8>, uint64_t a2, uint64_t a3, uint64_t a4, void *a5, uint64_t a6, uint64_t a7, uint64_t a8, int a9, int a10)
{
  *a5 = a8;
  if (a3)
  {
...
uint64_t sub_1D4C4C4CC(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, unint64_t a10)
{
...
void sub_1D4C4C6B0(uint64_t a1@<X8>)
{
  *v2 = v1;
  *(v1 + 8) = *(a1 + 8);
  *(a1 + 8) = v1;
...
uint64_t sub_1D4C4D27C(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, int a14, int a15, int a16, uint64_t a17)
{
...
uint64_t sub_1D4C4D388(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, int a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, uint64_t a16, uint64_t a17, uint64_t a18, uint64_t a19, uint64_t a20, uint64_t a21, uint64_t a22, uint64_t a23, uint64_t a24, uint64_t a25, uint64_t a26, uint64_t a27, uint64_t a28, uint64_t a29, uint64_t a30, uint64_t a31, uint64_t a32, uint64_t a33, uint64_t a34, uint64_t a35, uint64_t a36, uint64_t a37, uint64_t a38, uint64_t a39, uint64_t a40, uint64_t a41, uint64_t a42, uint64_t a43, uint64_t a44, uint64_t a45, uint64_t a46, uint64_t a47, uint64_t a48, uint64_t a49, uint64_t a50, uint64_t a51, uint64_t a52, uint64_t a53, uint64_t a54, uint64_t a55, uint64_t a56, uint64_t a57, uint64_t a58, uint64_t a59, uint64_t a60, uint64_t a61, uint64_t a62)
{
  v63 = (a6 + 4772);
...
uint64_t sub_1D4C4D4C0(uint64_t a1, uint64_t a2, uint64_t a3, int a4)
{
...
void sub_1D4C4D6CC()
{
  v4 = v0[13];
  *(v2 - 116) = v3;
  v5 = *(&off_1F5090370 + v1 - 2321) - 12;
  v6 = v5[v4 ^ 0xE5];
  LODWORD(v4) = v5[(v1 - 38) & 0xFD ^ v0[1] ^ 0xF3];
  v7 = *(&off_1F5090370 + (v1 ^ 0xB2D));
  v8 = *(v7 + (v0[11] ^ 0xBFLL));
  v9 = *(v7 + (v0[7] ^ 0xC7));
  v10 = *(&off_1F5090370 + (v1 ^ 0xB32)) - 4;
  v11 = *(&off_1F5090370 + (v1 ^ 0xA95)) - 12;
  ...
  v26 = *(&off_1F5090370 + (v1 ^ 0xA60)) - 12;
  v27 = *&v26[4 * (v21 ^ 0x63)];
  *(v2 - 120) = v25;
  v28 = *(&off_1F5090370 + v1 - 2506) - 8;
  LODWORD(v21) = *&v28[4 * (BYTE1(v25) ^ 0x2E)];
  v29 = v23 ^ 0x99u;
  v30 = *(&off_1F5090370 + v1 - 2443) - 12;
  v31 = *&v30[4 * v29];
  v32 = *(&off_1F5090370 + (v1 ^ 0xAB1)) - 12;
