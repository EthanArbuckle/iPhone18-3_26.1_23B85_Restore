...
- (id)sentinelGroup
{
  ...
  v4 = [v3 initWithIdentifier:v2 parentIdentifier:v2 name:&stru_283CF9D50 defaultName:0 destinationIdentifiers:MEMORY[0x277CBEBF8] associatedGroupIdentifier:0];
...
- (id)encodedDestinationControllerEvents
{
  ...
  {
    v5 = [(HMDMediaGroupsAggregateData *)self destinationControllersData];
    v6 = [v5 na_map:&__block_literal_global_20_84039];
  }
...
- (id)encodedDestinationEvents
{
  ...
  {
    v5 = [(HMDMediaGroupsAggregateData *)self destinations];
    v6 = [v5 na_map:&__block_literal_global_16];
  }
...
- (id)decodeMediaGroupsWithEncodedMediaGroups:(id)a3
{
  v4 = [a3 na_map:&__block_literal_global_10_84045];
...
- (id)decodeDestinationControllersWithEncodedDestinationControllers:(id)a3
{
  ...
  v4 = a3;
  v5 = [v4 na_map:&__block_literal_global_6_84048];
  v6 = [v5 count];
  if (v6 == [v4 count])
  {
...
- (id)decodeDestinationsWithEncodedDestinations:(id)a3
{
  v21 = *MEMORY[0x277D85DE8];
  v4 = a3;
  v5 = [v4 na_map:&__block_literal_global_84052];
  v6 = [v5 count];
  if (v6 == [v4 count])
  {
