...
- (void)setNumberValue:(id)value forKeyPath:(id)path
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
    {
      ...
      v20 = 2112;
      v21 = pathCopy;
      _os_log_impl(&dword_229538000, v13, OS_LOG_TYPE_ERROR, "%{public}@Failed to store integer value: %@ for keypath: %@", &v16, 0x20u);
    }
...
void __59__HMDSiriEndpointProfileAccessorySettingFields_logCategory__block_invoke()
{
  ...
  v2 = logCategory__hmf_once_v8_90542;
  logCategory__hmf_once_v8_90542 = v1;
}
