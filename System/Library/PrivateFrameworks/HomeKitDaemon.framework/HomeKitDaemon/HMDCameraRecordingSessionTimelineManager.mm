...
- (void)handleDoorbellDidActivateAtDate:(id)date
{
  ...
  if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
  {
    ...
    v30 = 2048;
    v31 = v18;
    _os_log_impl(&dword_229538000, v14, OS_LOG_TYPE_INFO, "%{public}@Doorbell trigger activated at time offset: %f", &v28, 0x16u);
  }
  ...
  if (os_log_type_enabled(v21, OS_LOG_TYPE_INFO))
  {
    ...
    v30 = 2048;
    v31 = v25;
    _os_log_impl(&dword_229538000, v21, OS_LOG_TYPE_INFO, "%{public}@Doorbell trigger will be deactivated at time offset: %f", &v28, 0x16u);
  }
...
LABEL_12:
        _os_log_impl(&dword_229538000, v21, OS_LOG_TYPE_INFO, v25, &v35, 0x16u);
...
void __55__HMDCameraRecordingSessionTimelineManager_logCategory__block_invoke()
{
  ...
  v2 = logCategory__hmf_once_v5_99732;
  logCategory__hmf_once_v5_99732 = v1;
}
