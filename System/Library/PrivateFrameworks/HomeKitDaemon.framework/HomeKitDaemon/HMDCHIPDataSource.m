...
void __74__HMDCHIPDataSource_stopAccessoryFirmwareUpdateWithFabricUUID_completion___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (v3)
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
    {
      ...
      v11 = 2112;
      v12 = v3;
      _os_log_impl(&dword_229538000, v6, OS_LOG_TYPE_ERROR, "%{public}@Failed to stop thread accessory firmware update, error %@", &v9, 0x16u);
    }
...
void __106__HMDCHIPDataSource_startAccessoryFirmwareUpdateWithExtendedMACAddress_fabricUUID_isWedDevice_completion___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (v3)
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
    {
      ...
      v14 = 2112;
      v15 = v3;
      _os_log_impl(&dword_229538000, v6, OS_LOG_TYPE_ERROR, "%{public}@Failed to start thread accessory firmware update with emac %@, error %@", &v10, 0x20u);
    }
...
void __67__HMDCHIPDataSource_stopAccessoryPairingWithFabricUUID_completion___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (v3)
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
    {
      ...
      v11 = 2112;
      v12 = v3;
      _os_log_impl(&dword_229538000, v6, OS_LOG_TYPE_ERROR, "%{public}@Failed to stop thread accessory pairing, error %@", &v9, 0x16u);
    }
...
- (void)overrideLocationCheckForPairingForFabricUUID:(id)a3
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
    {
      ...
      v13 = 138543362;
      v14 = v11;
      _os_log_impl(&dword_229538000, v7, OS_LOG_TYPE_INFO, "%{public}@Not setting pairing override as fabricID is null.", &v13, 0xCu);
    }
  }
...
void __99__HMDCHIPDataSource_startAccessoryPairingWithExtendedMACAddress_fabricUUID_isWedDevice_completion___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (v3)
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
    {
      ...
      v14 = 2112;
      v15 = v3;
      _os_log_impl(&dword_229538000, v6, OS_LOG_TYPE_ERROR, "%{public}@Failed to start thread accessory pairing with emac %@, error %@", &v10, 0x20u);
    }
...
- (void)handleThreadNetworkPeripheralDeviceNodeTypeChangedNotification:(id)a3
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
    {
      ...
      v14 = 138543362;
      v15 = v12;
      _os_log_impl(&dword_229538000, v11, OS_LOG_TYPE_ERROR, "%{public}@Event not of type HMDThreadNetworkPeripheralDeviceNodeTypeEvent", &v14, 0xCu);
    }
...
- (void)handleThreadNetworkWakeOnConnectionStateChangedNotification:(id)a3
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
    {
      ...
      v16 = 138543362;
      v17 = v14;
      _os_log_impl(&dword_229538000, v13, OS_LOG_TYPE_ERROR, "%{public}@Event not of type thread wake on connection state changed", &v16, 0xCu);
    }
...
void __88__HMDCHIPDataSource_connectToAccessoryWithExtendedMACAddress_withFabricUUID_completion___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (v3)
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
    {
      ...
      v14 = 2112;
      v15 = v3;
      _os_log_impl(&dword_229538000, v6, OS_LOG_TYPE_ERROR, "%{public}@Failed to connect to accessory with emac %@, error %@", &v10, 0x20u);
    }
...
- (void)startThreadRadioForUserPreferredNetwork
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
    {
      ...
      *buf = 138543362;
      v20 = v7;
      _os_log_impl(&dword_229538000, v6, OS_LOG_TYPE_INFO, "%{public}@Starting Thread network for user preferred network", buf, 0xCu);
    }
...
void __60__HMDCHIPDataSource_startThreadRadioForUserPreferredNetwork__block_invoke(uint64_t a1, void *a2, void *a3, void *a4, void *a5)
{
  ...
  if (WeakRetained)
  {
    ...
    else
    {
      ...
      v25[1] = 3221225472;
      v25[2] = __60__HMDCHIPDataSource_startThreadRadioForUserPreferredNetwork__block_invoke_175;
      v25[3] = &unk_27868A1D8;
      v25[4] = v15;
      v26 = v10;
...
void __60__HMDCHIPDataSource_startThreadRadioForUserPreferredNetwork__block_invoke_175(uint64_t a1, void *a2)
{
  ...
  if (v3)
  {
    if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
    {
      ...
      v17 = 2112;
      v18 = v3;
      _os_log_impl(&dword_229538000, v7, OS_LOG_TYPE_ERROR, "%{public}@Failed to attach to user preferred thread network %@: %@", &v13, 0x20u);
    }
  ...
  else
  {
    if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
    {
      ...
      v15 = 2112;
      v16 = v11;
      _os_log_impl(&dword_229538000, v7, OS_LOG_TYPE_INFO, "%{public}@Attached to thread network %@", &v13, 0x16u);
    }
...
- (void)startThreadRadioForUserPreferredNetworkWithGeoAndBorderRouterCheck
{
  ...
  if (v51)
  {
    ...
    *(&buf + 1) = &buf;
    v79 = 0x3032000000;
    v80 = __Block_byref_object_copy__150013;
    ...
    else
    {
      ...
      if (os_log_type_enabled(v25, OS_LOG_TYPE_ERROR))
      {
        ...
        *v71 = 138543362;
        v72 = v26;
        _os_log_impl(&dword_229538000, v25, OS_LOG_TYPE_ERROR, "%{public}@Home manager reference is nil - skipping in-geo && matter check", v71, 0xCu);
      }
    ...
    if (dispatch_group_wait(group, v27))
    {
      ...
      if (os_log_type_enabled(v30, OS_LOG_TYPE_ERROR))
      {
        ...
        *v71 = 138543362;
        v72 = v31;
        _os_log_impl(&dword_229538000, v30, OS_LOG_TYPE_ERROR, "%{public}@Timed out while fetching preferred network.", v71, 0xCu);
      }
    ...
    if (os_log_type_enabled(v34, OS_LOG_TYPE_INFO))
    {
      ...
      *v71 = 138543874;
      ...
      v75 = 2112;
      v76 = v38;
      _os_log_impl(&dword_229538000, v34, OS_LOG_TYPE_INFO, "%{public}@startThreadRadioForUserPreferredNetwork: isLocationAuthorized = %@. isInGeoForAnyHome = %@", v71, 0x20u);
    }
    ...
    if (v50 && (v68[3] & 1) == 0)
    {
      ...
      if (v39)
      {
        ...
        if (os_log_type_enabled(v47, OS_LOG_TYPE_INFO))
        {
          ...
          *v71 = 138543362;
          v72 = v48;
          _os_log_impl(&dword_229538000, v47, OS_LOG_TYPE_INFO, "%{public}@Not in-geo for any home and no accessories in matter locker, not starting thread", v71, 0xCu);
        }
      ...
      if (os_log_type_enabled(v42, OS_LOG_TYPE_INFO))
      {
        ...
        *v71 = 138543362;
        v72 = v43;
        _os_log_impl(&dword_229538000, v42, OS_LOG_TYPE_INFO, "%{public}@Not in-geo for any home and no accessories in matter locker, allowing thread start anyways", v71, 0xCu);
      }
...
void __87__HMDCHIPDataSource_startThreadRadioForUserPreferredNetworkWithGeoAndBorderRouterCheck__block_invoke_2(uint64_t a1, int a2, void *a3)
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    v24 = 2112;
    v25 = v5;
    _os_log_impl(&dword_229538000, v8, OS_LOG_TYPE_INFO, "%{public}@GeoAvailable: %@, error %@", &v20, 0x20u);
  }
  ...
  if (a2)
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
    {
      ...
      v24 = 2112;
      v25 = v17;
      _os_log_impl(&dword_229538000, v13, OS_LOG_TYPE_INFO, "%{public}@Is in Geo for home with fabricID %@ - %@", &v20, 0x20u);
    }
  ...
  if (WeakRetained)
  {
    ...
    if (v9)
    {
      if (!v5 || v6)
      {
        ...
        v22[1] = 3221225472;
        v22[2] = __87__HMDCHIPDataSource_startThreadRadioForUserPreferredNetworkWithGeoAndBorderRouterCheck__block_invoke_172;
        v22[3] = &unk_27867B7B0;
...
LABEL_9:
  ...
  v40[1] = 3221225472;
  v40[2] = __87__HMDCHIPDataSource_startThreadRadioForUserPreferredNetworkWithGeoAndBorderRouterCheck__block_invoke_173;
  v40[3] = &unk_27868A1D8;
  v40[4] = v26;
  v41 = v10;
...
void __62__HMDCHIPDataSource__getPreferredNetworkExistsWithCompletion___block_invoke(uint64_t a1, void *a2, void *a3, void *a4, void *a5)
{
  ...
  if (WeakRetained)
  {
    ...
    if (v11)
    {
      if (v17)
      {
        ...
        v32 = 2112;
        v33 = v11;
        _os_log_impl(&dword_229538000, v16, OS_LOG_TYPE_INFO, "%{public}@Successfully retrieved preferred thread credentials %@ with UUID %@ and operationalDataset %@ for current network", &v26, 0x2Au);
      }
    ...
    else
    {
      if (v17)
      {
        ...
        v26 = 138543362;
        v27 = v24;
        _os_log_impl(&dword_229538000, v16, OS_LOG_TYPE_INFO, "%{public}@No thread network found for current Wifi", &v26, 0xCu);
      }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v21, OS_LOG_TYPE_ERROR))
    {
      ...
      v26 = 138543362;
      v27 = v22;
      _os_log_impl(&dword_229538000, v21, OS_LOG_TYPE_ERROR, "%{public}@Unable to get strong reference to self - abort", &v26, 0xCu);
    }
...
- (void)handleNetworkStateChange
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    v12 = 138543362;
    v13 = v6;
    _os_log_impl(&dword_229538000, v5, OS_LOG_TYPE_INFO, "%{public}@Received network state change from Thread network event listener", &v12, 0xCu);
  }
...
- (void)handleThreadBTCallStateChange:(BOOL)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v13 = 2112;
    v14 = v9;
    _os_log_impl(&dword_229538000, v7, OS_LOG_TYPE_INFO, "%{public}@Received thread call state change - isInCall = %@", &v11, 0x16u);
  }
...
void __50__HMDCHIPDataSource__scheduleThreadNetworkRestart__block_invoke(uint64_t a1)
{
  ...
  if (v2 != [*(a1 + 32) networkChangedLastUpdatedTime])
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
    {
      ...
      v14 = 138543362;
      v15 = v11;
      _os_log_impl(&dword_229538000, v10, OS_LOG_TYPE_INFO, "%{public}@Ignoring Wifi network changed as newer request is queued.", &v14, 0xCu);
    }
  ...
  if (!v3)
  {
    if (v7)
    {
      ...
      v14 = 138543362;
      v15 = v12;
      _os_log_impl(&dword_229538000, v6, OS_LOG_TYPE_INFO, "%{public}@Ignoring WiFi network changed notification when Thread is not up", &v14, 0xCu);
    }
...
LABEL_12:
  ...
  if (v7)
  {
    ...
    v14 = 138543362;
    v15 = v8;
    _os_log_impl(&dword_229538000, v6, OS_LOG_TYPE_INFO, "%{public}@Restarting Thread network for user preferred network upon WiFi network changed notification", &v14, 0xCu);
  }
...
void __69__HMDCHIPDataSource_hasValidGeoOrPreferredNetworkForHome_completion___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (*(a1 + 64) == 1 && ([*(a1 + 32) pnExistsOnCurrentNetwork] & v4) == 1)
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
    {
      ...
      v21 = 2112;
      v22 = v3;
      _os_log_impl(&dword_229538000, v7, OS_LOG_TYPE_INFO, "%{public}@Allowing geo due to valid preferred network for: %@ and error: %@", &v17, 0x20u);
    }
  }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
    {
      ...
      v27 = 2112;
      v28 = v3;
      _os_log_impl(&dword_229538000, v7, OS_LOG_TYPE_INFO, "%{public}@Denying geo due to presence: %@, location authorization: %@, preferred network: %@ for: %@ error: %@", &v17, 0x3Eu);
    }
  }
...
void __69__HMDCHIPDataSource_hasValidGeoOrPreferredNetworkForHome_completion___block_invoke_157(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_DEBUG))
  {
    ...
    v9 = 138543362;
    v10 = v7;
    _os_log_impl(&dword_229538000, v6, OS_LOG_TYPE_DEBUG, "%{public}@Done fetching.", &v9, 0xCu);
  }
...
- (void)unregisterForArrivalNotifications:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v11 = 138543362;
    v12 = v8;
    _os_log_impl(&dword_229538000, v7, OS_LOG_TYPE_INFO, "%{public}@Unregistering arrival notifications.", &v11, 0xCu);
  }
...
- (void)unprotectedRegisterForArrivalNotifications:(id)a3
{
  ...
  if (v4 && (v8 & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
    {
      ...
      v17 = 138543362;
      v18 = v12;
      _os_log_impl(&dword_229538000, v11, OS_LOG_TYPE_INFO, "%{public}@Registering for arrival notifications.", &v17, 0xCu);
    }
...
- (void)unregisterForLeaveNotifications:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v11 = 138543362;
    v12 = v8;
    _os_log_impl(&dword_229538000, v7, OS_LOG_TYPE_INFO, "%{public}@Unregistering leave notifications.", &v11, 0xCu);
  }
...
- (void)unprotectedRegisterForLeaveNotifications:(id)a3
{
  ...
  if (v4 && (v8 & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
    {
      ...
      v17 = 138543362;
      v18 = v12;
      _os_log_impl(&dword_229538000, v11, OS_LOG_TYPE_INFO, "%{public}@Registering for leave notifications.", &v17, 0xCu);
    }
...
- (void)handleLocationAuthorizationChangedNotification:(id)a3
{
  ...
  if (v6)
  {
    ...
    if ([(HMDCHIPDataSource *)self locationAuthorization]!= v7)
    {
      ...
      if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
      {
        ...
        v22 = 2112;
        v23 = v12;
        _os_log_impl(&dword_229538000, v10, OS_LOG_TYPE_INFO, "%{public}@Location Authorization is changing to %@, stopping thread network", &v20, 0x16u);
      }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR))
    {
      ...
      v20 = 138543362;
      v21 = v18;
      _os_log_impl(&dword_229538000, v17, OS_LOG_TYPE_ERROR, "%{public}@No location authorization key in the message", &v20, 0xCu);
    }
...
void __97__HMDCHIPDataSource_requestUserPermissionForBridgeAccessory_withContext_queue_completionHandler___block_invoke(uint64_t a1)
{
  ...
  else
  {
    ...
    v15[1] = 3221225472;
    v15[2] = __97__HMDCHIPDataSource_requestUserPermissionForBridgeAccessory_withContext_queue_completionHandler___block_invoke_151;
    v15[3] = &unk_278683B50;
    v13 = *(a1 + 56);
    v16 = *(a1 + 64);
...
void __106__HMDCHIPDataSource_requestUserPermissionForUnauthenticatedAccessory_withContext_queue_completionHandler___block_invoke(uint64_t a1)
{
  ...
  else
  {
    ...
    v15[0] = MEMORY[0x277D85DD0];
    v15[1] = 3221225472;
    v15[2] = __106__HMDCHIPDataSource_requestUserPermissionForUnauthenticatedAccessory_withContext_queue_completionHandler___block_invoke_149;
    v15[3] = &unk_278683B50;
    v13 = *(a1 + 56);
    v16 = *(a1 + 64);
...
- (void)timerDidFire:(id)a3
{
  ...
  if (v5 == v4)
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
    {
      ...
      v18 = 138543362;
      v19 = v9;
      _os_log_impl(&dword_229538000, v8, OS_LOG_TYPE_INFO, "%{public}@Vendor metadata refresh timer fired; fetching vendor metadata from cloud", &v18, 0xCu);
    }
  ...
  if (v11 == v4)
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
    {
      ...
      v18 = 138543362;
      v19 = v15;
      _os_log_impl(&dword_229538000, v14, OS_LOG_TYPE_INFO, "%{public}@Attestation data refresh timer fired; fetching attestation data from cloud", &v18, 0xCu);
    }
...
- (NSUUID)currentFabricUUID
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
    {
      ...
      v16 = 138543362;
      v17 = v13;
      _os_log_impl(&dword_229538000, v12, OS_LOG_TYPE_ERROR, "%{public}@Home manager reference is nil", &v16, 0xCu);
    }
...
- (NSSet)allTargetFabricUUIDs
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
    {
      ...
      v15 = 138543362;
      v16 = v12;
      _os_log_impl(&dword_229538000, v11, OS_LOG_TYPE_ERROR, "%{public}@Home manager reference is nil", &v15, 0xCu);
    }
...
- (void)handleHomeRemovedNotification:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v19 = 138543362;
    v20 = v8;
    _os_log_impl(&dword_229538000, v7, OS_LOG_TYPE_INFO, "%{public}@Handling home removal by notifying CHIP storage", &v19, 0xCu);
  }
...
- (void)handleAccessoryCHIPStorageChangedNotification:(id)a3
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
    {
      ...
      v18 = 2112;
      v19 = v12;
      _os_log_impl(&dword_229538000, v10, OS_LOG_TYPE_ERROR, "%{public}@Did not find %@ in notification userInfo. Defaulting isLocalChange to %@", &v14, 0x20u);
    }
...
void __60__HMDCHIPDataSource_handleResidentReachabilityNotification___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    v16 = 2112;
    v17 = v5;
    _os_log_impl(&dword_229538000, v8, OS_LOG_TYPE_INFO, "%{public}@Notifying HomeKitMatter of resident reachability change for Home %@ with fabricID %@", &v12, 0x20u);
  }
...
- (void)handleDataReadyAfterBecomingPrimaryNotification:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v11 = 138543362;
    v12 = v8;
    _os_log_impl(&dword_229538000, v7, OS_LOG_TYPE_INFO, "%{public}@Notifying HomeKitMatter of primary resident data ready", &v11, 0xCu);
  }
...
- (void)handleUpdatedDataWithIsLocalChange:(BOOL)a3
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    v11 = 138543362;
    v12 = v7;
    _os_log_impl(&dword_229538000, v6, OS_LOG_TYPE_INFO, "%{public}@Notifying CHIP storage of updated home CHIP storage with both isLocalChange: NO and isLocalChange: YES", &v11, 0xCu);
  }
...
LABEL_7:
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    v15 = 2112;
    v16 = v5;
    _os_log_impl(&dword_229538000, v9, OS_LOG_TYPE_INFO, "%{public}@Configuring with UI dialog presenter: %@", &v13, 0x16u);
  }
...
LABEL_7:
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    v17 = 2112;
    v18 = v5;
    _os_log_impl(&dword_229538000, v9, OS_LOG_TYPE_INFO, "%{public}@Configuring with attestation data store: %@", &v15, 0x16u);
  }
...
LABEL_7:
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    v18 = 2112;
    v19 = v5;
    _os_log_impl(&dword_229538000, v9, OS_LOG_TYPE_INFO, "%{public}@Configuring with vendor metadata store: %@", &v16, 0x16u);
  }
...
LABEL_7:
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    v20 = 2112;
    v21 = v5;
    _os_log_impl(&dword_229538000, v9, OS_LOG_TYPE_INFO, "%{public}@Configuring with storage: %@", &v18, 0x16u);
  }
...
- (void)configureWithThreadRadioManager:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    v20 = 2112;
    v21 = v5;
    _os_log_impl(&dword_229538000, v8, OS_LOG_TYPE_INFO, "%{public}@Configuring with thread radio manager: %@", &v18, 0x16u);
  }
...
LABEL_10:
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    v23 = 2112;
    v24 = v5;
    _os_log_impl(&dword_229538000, v9, OS_LOG_TYPE_INFO, "%{public}@Configuring with resident state manager: %@", &v21, 0x16u);
  }
...
void __32__HMDCHIPDataSource_logCategory__block_invoke()
{
  ...
  v2 = logCategory__hmf_once_v32_150207;
  logCategory__hmf_once_v32_150207 = v1;
}
