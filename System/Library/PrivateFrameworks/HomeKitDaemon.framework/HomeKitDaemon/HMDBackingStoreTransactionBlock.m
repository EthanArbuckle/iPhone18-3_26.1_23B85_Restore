...
- (void)runWithCoreDataBlock:(id)a3 withCompletionBlock:(id)a4
{
  v6 = a4;
  v7 = a3;
  v8 = [(HMDBackingStoreTransactionBlock *)self backingStore];
...
- (void)save:(id)a3
{
  ...
  [v6 commit:self run:0 save:1 archiveInline:objc_msgSend(v5 coreDataBlock:"mustSaveArchiveAtomically") completionHandler:{0, v4}];
}
