...
- (void)removeFabricData
{
  ...
  v25 = 0;
  v5 = [v3 allKeychainItemsForType:&unk_283E72230 identifier:v4 syncable:MEMORY[0x277CBEC28] error:&v25];
  v6 = v25;
...
- (HMMTROperationalFabricData)fabricData
{
  ...
  v4 = [(HMDCHIPSharedHomeKeychainFabricDataStore *)self keychainItemIdentifier];
  v54 = 0;
  v5 = [v3 allKeychainItemsForType:&unk_283E72230 identifier:v4 syncable:MEMORY[0x277CBEC28] error:&v54];
  v6 = v54;
  if (v6)
  {
