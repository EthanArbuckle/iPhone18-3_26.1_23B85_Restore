...
void __45__HMDXPCEntitlementMessageFilter_logCategory__block_invoke()
{
  ...
  v2 = logCategory__hmf_once_v3_185331;
  logCategory__hmf_once_v3_185331 = v1;
}
    ...
    if (proxyConnection)
    {
      ...
      if (v11)
      {
        ...
        if (os_log_type_enabled(v18, OS_LOG_TYPE_ERROR))
        {
          ...
          v33 = 2112;
          v34 = v21;
          _os_log_impl(&dword_229538000, v18, OS_LOG_TYPE_ERROR, "%{public}@Rejecting message, %@, client is missing the following entitlements: %@", &v29, 0x20u);
        }
      ...
      else
      {
        ...
        if (os_log_type_enabled(v25, OS_LOG_TYPE_ERROR))
        {
          ...
          v29 = 138543362;
          v30 = v26;
          _os_log_impl(&dword_229538000, v25, OS_LOG_TYPE_ERROR, "%{public}@Missing XPC policy", &v29, 0xCu);
        }
