  ...
  if (v5)
  {
    ...
    if (os_log_type_enabled(v23, OS_LOG_TYPE_DEBUG))
    {
      ...
      *buf = 138543618;
      ...
      v69 = 2112;
      v70 = v25;
      _os_log_impl(&dword_229538000, v23, OS_LOG_TYPE_DEBUG, "%{public}@Camera accessory settings: %@", buf, 0x16u);
    }
    ...
    if (os_log_type_enabled(v37, OS_LOG_TYPE_DEBUG))
    {
      ...
      *buf = 138543618;
      ...
      v69 = 2112;
      v70 = v39;
      _os_log_impl(&dword_229538000, v37, OS_LOG_TYPE_DEBUG, "%{public}@Camera user settings: %@", buf, 0x16u);
    }
