...
- (HMDRemoteLoginAuthenticationResponse)initWithCoder:(id)a3
{
  v4 = a3;
  v9.receiver = self;
  v9.super_class = HMDRemoteLoginAuthenticationResponse;
...
{
  v8.receiver = self;
  v8.super_class = HMDRemoteLoginAuthenticationResponse;
  v4 = a3;
  [(HMRemoteLoginMessage *)&v8 encodeWithCoder:v4];
  v5 = [MEMORY[0x277CF0130] sharedInstance];
  v6 = [(HMDRemoteLoginAuthenticationResponse *)self loggedInAccount];
...
- (NSString)description
{
  ...
  v6.receiver = self;
  v6.super_class = HMDRemoteLoginAuthenticationResponse;
  v3 = [(HMRemoteLoginMessage *)&v6 description];
  v4 = [v2 stringWithFormat:@"HMDRemoteLoginAuthenticationResponse: %@", v3];
...
- (NSDictionary)messagePayload
{
  ...
  v3 = encodeRootObject();
  v4 = [(HMDRemoteLoginAuthenticationResponse *)self messageName];
  v8 = v4;
  v9[0] = v3;
...
+ (id)objWithMessage:(id)a3
{
  ...
  v6 = [v5 hmf_dataForKey:@"kHMDRemoteLoginAuthenticationResponse"];
...
+ (id)objWithDict:(id)a3
{
  ...
  v4 = a3;
  v5 = [v4 hmf_dataForKey:@"kHMDRemoteLoginAuthenticationResponse"];
  v14 = 0;
