...
- (id)_deviceInformationForDevice:(uint64_t)device
{
  ...
  if (device)
  {
    ...
    deviceCopy = [*(deviceCopy + 104) objectForKey:v3];
  }
    ...
    if (v3)
    {
      ...
      else
      {
        ...
        if (v9)
        {
          ...
          WeakRetained = objc_loadWeakRetained(deviceCopy2 + 12);
...
- (void)_handleIncomingMessageForDevice:(id)device
{
  ...
  os_unfair_lock_lock_with_options();
  v5 = [(HMDRemoteDeviceMonitor *)self _deviceInformationForDevice:deviceCopy];
...
- (void)service:(id)service account:(id)account incomingMessage:(id)message fromID:(id)d context:(id)context
{
  ...
  {
    v28 = [HMDRemoteMessageSerialization remoteMessageWithDictionary:messageCopy isHH2Payload:1 error:0];
    if (v28)
    {
...
- (void)service:(id)service activeAccountsChanged:(id)changed
{
  ...
  if (iCloudAccount && ([iCloudAccount isEqual:WeakRetained] & 1) == 0)
  {
    ...
    objc_storeWeak(v14 + 7, iCloudAccount);
  }
...
- (HMDRemoteDeviceInformation)_startMonitoringDevice:(void *)device withInitialReachability:(void *)reachability forClient:
{
  ...
  if (self)
  {
    ...
    if (v7)
    {
      v66 = reachabilityCopy;
      v70 = 0;
      accountRegistry = [self accountRegistry];
      v10 = [accountRegistry deviceForDevice:v7 exists:&v70];
      ...
      if (([v10 isCurrentDevice] & 1) == 0)
      {
        ...
        if (!hmf_isEmpty)
        {
          ...
          else
          {
            ...
            objc_autoreleasePoolPop(context);
            [(HMDRemoteDeviceMonitor *)selfCopy handleReachabilityChange:v18 deviceInformation:v59 reason:1 didStartMonitoringDevice:?];

            os_unfair_lock_lock_with_options();
            v48 = BYTE1(selfCopy[8]._os_unfair_lock_opaque);
            ...
            if (v48 == 1)
            {
              ...
              v68[4] = selfCopy;
              v69 = v10;
              [(HMDRemoteDeviceMonitor *)selfCopy _confirmDevice:v18 timeout:v68 completionHandler:65.0];
            }
            ...
            if (os_log_type_enabled(v51, OS_LOG_TYPE_INFO))
            {
              ...
              shortDescription2 = [v54 shortDescription];
              *buf = 138543618;
              *&buf[4] = v53;
              *&buf[12] = 2114;
...
LABEL_13:
  ...
  if (*(reachable + 32) != a2)
  {
    *(reachable + 32) = a2;
    ...
    WeakRetained = objc_loadWeakRetained((reachable + 72));
...
- (HMDRemoteDeviceMonitor)initWithAccountRegistry:(id)registry activityObserver:(id)observer queue:(id)queue service:(id)service modernService:(id)modernService accountManager:(id)manager remoteAccountManager:(id)accountManager netMonitor:(id)self0 factory:(id)self1
{
  ...
  if (v20)
  {
    ...
    objc_storeWeak(&v21->_remoteAccountManager, accountManagerCopy);
...
- (HMDRemoteDeviceMonitor)initWithAccountRegistry:(id)registry activityObserver:(id)observer accountManager:(id)manager
{
  ...
  if (service)
  {
    ...
    v19 = [(HMDRemoteDeviceMonitor *)self initWithAccountRegistry:registryCopy activityObserver:observerCopy queue:v16 service:service modernService:0 accountManager:managerCopy remoteAccountManager:v17 netMonitor:v18 factory:self];
