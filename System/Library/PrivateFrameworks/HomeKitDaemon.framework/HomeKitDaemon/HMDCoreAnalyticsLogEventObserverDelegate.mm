...
- (NSDictionary)deviceCapabilitiesAndEnablementsDimensions
{
  ...
  if (!deviceCapabilitiesAndEnablementsDimensions)
  {
    ...
    if (v6)
    {
      ...
      v15 = [MEMORY[0x277CCABB0] numberWithBool:{objc_msgSend(v6, "isResidentSelectionEnabledAnyHome")}];
      [v4 setObject:v15 forKeyedSubscript:@"isResidentSelectionEnabledAnyHome"];

      v16 = [MEMORY[0x277CCABB0] numberWithBool:{objc_msgSend(v6, "isResidentSelectionModeAutoAnyHome")}];
      [v4 setObject:v16 forKeyedSubscript:@"isResidentSelectionModeAutoAnyHome"];

      v17 = [MEMORY[0x277CCABB0] numberWithBool:{objc_msgSend(v6, "isResidentSelectionModeManualAnyHome")}];
      [v4 setObject:v17 forKeyedSubscript:@"isResidentSelectionModeManualAnyHome"];

      v18 = [MEMORY[0x277CCABB0] numberWithBool:{objc_msgSend(v6, "isResidentSelectionModeCoordinationAnyHome")}];
      [v4 setObject:v18 forKeyedSubscript:@"isResidentSelectionModeCoordinationAnyHome"];
    }

    [v4 setObject:MEMORY[0x277CBEC38] forKeyedSubscript:@"isHH2Enabled"];
    [v4 setObject:&unk_283E71CF0 forKeyedSubscript:@"isHH2Enabled_INT"];
    v19 = [v4 copy];
...
- (void)addDimensionsForAccessoryIdentifier:(id)a3 toEventDictionary:(id)a4
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
    {
      ...
      v17 = 2114;
      v18 = v6;
      _os_log_impl(&dword_229538000, v12, OS_LOG_TYPE_ERROR, "%{public}@Accessory with identifier %{public}@ doesn't exist", &v15, 0x16u);
    }
...
{
  v4 = a3;
  v25 = [(HMDCoreAnalyticsLogEventObserverDelegate *)self dataSource];
  ...
  v24 = [v22 numberWithBool:{objc_msgSend(v23, "hh2SentinelZoneExists")}];
