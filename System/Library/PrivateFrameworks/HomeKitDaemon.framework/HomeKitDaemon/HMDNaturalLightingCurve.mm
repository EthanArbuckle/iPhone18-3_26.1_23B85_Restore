...
void __38__HMDNaturalLightingCurve_logCategory__block_invoke()
{
  ...
  v2 = logCategory__hmf_once_v20_103790;
          ...
          if (!v36)
          {
            ...
            if (os_log_type_enabled(v40, OS_LOG_TYPE_ERROR))
            {
              ...
              *buf = 138543874;
              ...
              v62 = 2112;
              v63 = v37;
              _os_log_impl(&dword_229538000, v40, OS_LOG_TYPE_ERROR, "%{public}@Failed to parse encoded transition point %@:%@", buf, 0x20u);
            }
...
LABEL_46:
  ...
  else
  {
    ...
    if (os_log_type_enabled(v43, OS_LOG_TYPE_ERROR))
    {
      ...
      *buf = 138543362;
      v59 = v44;
      _os_log_impl(&dword_229538000, v43, OS_LOG_TYPE_ERROR, "%{public}@Failed to decode transition points", buf, 0xCu);
    }
