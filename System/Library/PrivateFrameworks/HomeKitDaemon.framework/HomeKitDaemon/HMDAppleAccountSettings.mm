...
+ (id)sharedSettings
{
  ...
  {
    dispatch_once(&sharedSettings_onceToken, &__block_literal_global_40079);
  }
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t0_17216 != -1)
  {
    dispatch_once(&logCategory__hmf_once_t0_17216, &__block_literal_global_17217);
  }

  v3 = logCategory__hmf_once_v1_17218;
