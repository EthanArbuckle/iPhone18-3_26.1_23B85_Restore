...
- (BOOL)isEqual:(id)a3
{
  ...
  if (v6 && (v7 = -[HMDBackingStoreTransactionOptions source](self, "source"), v7 == [v6 source]) && (v8 = -[HMDBackingStoreTransactionOptions destination](self, "destination"), v8 == objc_msgSend(v6, "destination")))
  {
    ...
    v10 = [v6 label];
    if ([v9 isEqualToString:v10] && (v11 = -[HMDBackingStoreTransactionOptions mustReplay](self, "mustReplay"), v11 == objc_msgSend(v6, "mustReplay")) && (v12 = -[HMDBackingStoreTransactionOptions mustPush](self, "mustPush"), v12 == objc_msgSend(v6, "mustPush")))
    {
      v15 = [(HMDBackingStoreTransactionOptions *)self cdTransactionAuthor];
      v13 = v15 == [v6 cdTransactionAuthor];
    }
...
- (HMDBackingStoreTransactionOptions)initWithSource:(unint64_t)a3 destination:(unint64_t)a4 label:(id)a5 mustReplay:(BOOL)a6 mustPush:(BOOL)a7 mustSaveArchiveAtomically:(BOOL)a8 cdTransactionAuthor:(unint64_t)a9 clientIdentifier:(id)a10
{
  ...
  v18->_source = a3;
  v18->_destination = a4;
  objc_storeStrong(&v18->_label, a5);
  v19->_mustReplay = a6;
  v19->_mustPush = a7;
  if (a9)
  {
    v19->_cdTransactionAuthor = a9;
    objc_storeStrong(&v19->_clientIdentifier, a10);
    v20 = v19;
LABEL_4:
