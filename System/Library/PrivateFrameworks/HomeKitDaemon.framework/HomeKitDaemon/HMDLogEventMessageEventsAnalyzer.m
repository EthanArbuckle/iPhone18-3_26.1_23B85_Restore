...
- (void)_updateResidentSyncCountersWithRemoteMessageLogEvent:(id)a3
{
  ...
  {
    v4 = [v10 msgName];
    v5 = [v4 isEqualToString:@"HMDHomeDataChangedMessage"];
    ...
    {
      v7 = [v10 msgName];
      v8 = [v7 isEqualToString:@"HMDFetchHomeDataMessage"];
    ...
    v9 = [(HMDLogEventMessageEventsAnalyzer *)self residentSyncGroup];
    [v9 incrementEventCounterForEventName:v6];
  }
