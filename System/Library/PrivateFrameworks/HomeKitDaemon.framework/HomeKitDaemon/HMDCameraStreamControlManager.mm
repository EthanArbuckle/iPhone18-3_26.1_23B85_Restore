...
- (BOOL)_canReconfigureToHigherTier
{
  ...
  v3 = [v2 manufacturer];
  v4 = [&unk_283E76598 objectForKeyedSubscript:v3];
  v5 = [v2 model];
...
- (void)_callStreamStoppedWithError:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    v17 = 2112;
    v18 = v4;
    _os_log_impl(&dword_229538000, v8, OS_LOG_TYPE_INFO, "%{public}@Stream with session ID %@ stopped with error %@", &v13, 0x20u);
  }
...
- (void)_callStreamReconfigured
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    v10 = 138543362;
    v11 = v6;
    _os_log_impl(&dword_229538000, v5, OS_LOG_TYPE_INFO, "%{public}@Stream reconfigured", &v10, 0xCu);
  }
...
- (void)_callStreamFirstFrameReceived
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    v10 = 138543362;
    v11 = v6;
    _os_log_impl(&dword_229538000, v5, OS_LOG_TYPE_INFO, "%{public}@First frame received", &v10, 0xCu);
  }
...
- (void)_callStreamStarted
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    v10 = 138543362;
    v11 = v6;
    _os_log_impl(&dword_229538000, v5, OS_LOG_TYPE_INFO, "%{public}@Stream started", &v10, 0xCu);
  }
...
- (void)_callStreamRemoteConnectionSetup
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    v10 = 138543362;
    v11 = v6;
    _os_log_impl(&dword_229538000, v5, OS_LOG_TYPE_INFO, "%{public}@Stream remote connection setup", &v10, 0xCu);
  }
...
- (void)_callStreamNegotiated:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v12 = 138543362;
    v13 = v8;
    _os_log_impl(&dword_229538000, v7, OS_LOG_TYPE_INFO, "%{public}@Stream negotiated", &v12, 0xCu);
  }
...
void __44__HMDCameraStreamControlManager_logCategory__block_invoke()
{
  ...
  v2 = logCategory__hmf_once_v7_216782;
  logCategory__hmf_once_v7_216782 = v1;
}
