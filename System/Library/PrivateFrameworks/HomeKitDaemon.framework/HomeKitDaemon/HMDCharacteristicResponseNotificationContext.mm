...
+ (id)updateLastSeenStatusDataForResponsePayload:(id)payload home:(id)home isRemote:(BOOL)remote isNotification:(BOOL)notification;
...
+ (id)updateLastSeenStatusDataForResponsePayload:(id)payload home:(id)home isRemote:(BOOL)remote isNotification:(BOOL)notification
{
  ...
  if (remote || notification)
  {
    ...
    if (v13)
    {
      ...
      v19 = 3221225472;
      v20 = __120__HMDCharacteristicResponseNotificationContext_updateLastSeenStatusDataForResponsePayload_home_isRemote_isNotification___block_invoke;
      v21 = &unk_278689488;
      v22 = homeCopy;
      v16 = v15;
      v23 = v16;
...
void __120__HMDCharacteristicResponseNotificationContext_updateLastSeenStatusDataForResponsePayload_home_isRemote_isNotification___block_invoke(uint64_t a1, void *a2, void *a3)
{
  v5 = a2;
  v7[0] = MEMORY[0x277D85DD0];
  v7[1] = 3221225472;
  v7[2] = __120__HMDCharacteristicResponseNotificationContext_updateLastSeenStatusDataForResponsePayload_home_isRemote_isNotification___block_invoke_2;
  v7[3] = &unk_2786894D8;
  v8 = *(a1 + 32);
  v9 = v5;
  v10 = *(a1 + 40);
...
void __120__HMDCharacteristicResponseNotificationContext_updateLastSeenStatusDataForResponsePayload_home_isRemote_isNotification___block_invoke_2(id *a1, uint64_t a2, void *a3, uint64_t a4)
{
  v6[0] = MEMORY[0x277D85DD0];
  v6[1] = 3221225472;
  v6[2] = __120__HMDCharacteristicResponseNotificationContext_updateLastSeenStatusDataForResponsePayload_home_isRemote_isNotification___block_invoke_3;
  v6[3] = &unk_2786894B0;
  v10 = a4;
  v7 = a1[4];
  v8 = a1[5];
