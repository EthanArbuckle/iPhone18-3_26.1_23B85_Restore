...
- (HMDUserActionPredictionModel)initWithUserActionPrediction:(id)a3
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v31, OS_LOG_TYPE_ERROR))
    {
      ...
      v46 = 2112;
      v47 = v30;
      _os_log_impl(&dword_229538000, v31, OS_LOG_TYPE_ERROR, "%{public}@User Action Prediction: %@, resulted in nil hmbModelID for prediction model: %@", &v42, 0x20u);
    }
    ...
    if (!v33)
    {
      ...
      if (os_log_type_enabled(v38, OS_LOG_TYPE_FAULT))
      {
        ...
        v42 = 138543362;
        v43 = v39;
        _os_log_impl(&dword_229538000, v38, OS_LOG_TYPE_FAULT, "%{public}@Submitting ABC event for failure: User Action Prediction ModelID should not be nil", &v42, 0xCu);
      }
