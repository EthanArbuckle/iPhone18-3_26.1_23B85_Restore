...
- (NSString)description
{
  ...
  v8.receiver = self;
  v8.super_class = HMDCameraClipsQuotaGetActiveCamerasMessage;
  v4 = [(HMDCameraClipsQuotaGetActiveCamerasMessage *)&v8 description];
  dictionaryRepresentation = [(HMDCameraClipsQuotaGetActiveCamerasMessage *)self dictionaryRepresentation];
