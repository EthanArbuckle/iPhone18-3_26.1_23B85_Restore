  ...
  if (v11 == 2)
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v31, OS_LOG_TYPE_DEBUG))
      {
        ...
        *buf = 138543362;
        v68 = v32;
        _os_log_impl(&dword_229538000, v31, OS_LOG_TYPE_DEBUG, "%{public}@Phone number is too short to partially redact", buf, 0xCu);
      }
...
LABEL_23:
      _os_log_impl(&dword_229538000, v19, OS_LOG_TYPE_DEBUG, v21, buf, 0xCu);
    }
  }
