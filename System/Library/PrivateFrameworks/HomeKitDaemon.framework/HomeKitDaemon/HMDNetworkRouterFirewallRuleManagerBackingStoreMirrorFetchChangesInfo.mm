      ...
      for (i = 0; i != v13; ++i)
      {
        ...
        if (os_log_type_enabled(v21, OS_LOG_TYPE_INFO))
        {
          ...
          *buf = 138543618;
          ...
          v68 = 2112;
          v69 = v17;
          _os_log_impl(&dword_229538000, v21, OS_LOG_TYPE_INFO, "%{public}@Shutting down mirrored zone %@", buf, 0x16u);
      ...
      for (j = 0; j != v27; ++j)
      {
        ...
        if (os_log_type_enabled(v35, OS_LOG_TYPE_INFO))
        {
          ...
          *buf = 138543618;
          ...
          v68 = 2112;
          v69 = v31;
          _os_log_impl(&dword_229538000, v35, OS_LOG_TYPE_INFO, "%{public}@Shutting down cloud zone %@", buf, 0x16u);
  ...
  if (v7)
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
    {
      ...
      *buf = 138543874;
      ...
      v20 = 2112;
      v21 = v7;
      _os_log_impl(&dword_229538000, v12, OS_LOG_TYPE_ERROR, "%{public}@Failed to shut down zone %@: %@", buf, 0x20u);
    }
