...
- (id)comparePresence:(id)a3 operatorType:(id)a4 homePresence:(id)a5
{
  ...
  if (v11 && [v9 unsignedIntegerValue] == 4)
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
    {
      ...
      v25 = 2112;
      v26 = v8;
      _os_log_impl(&dword_229538000, v15, OS_LOG_TYPE_INFO, "%{public}@Checking whether the homePresence %@ agree with the presence events in condition: %@", &v21, 0x20u);
    }
...
- (id)sunset
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    v16 = 2112;
    v17 = v11;
    _os_log_impl(&dword_229538000, v9, OS_LOG_TYPE_INFO, "%{public}@Sunset time: %@", &v14, 0x16u);
  }
...
- (id)sunrise
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    v16 = 2112;
    v17 = v11;
    _os_log_impl(&dword_229538000, v9, OS_LOG_TYPE_INFO, "%{public}@Sunrise time: %@", &v14, 0x16u);
  }
...
- (HMDPredicateUtilities)initWithHome:(id)a3 logIdentifier:(id)a4
{
  ...
  v9 = [v8 isHomeActivityStateReplacesPresenceMonitorFeatureEnabled];
  ...
  v11 = [(HMDPredicateUtilities *)self initWithHome:v7 logIdentifier:v6 homePresenceProvider:v10];
...
void __36__HMDPredicateUtilities_logCategory__block_invoke()
{
  ...
  v2 = logCategory__hmf_once_v2_203600;
  logCategory__hmf_once_v2_203600 = v1;
}
