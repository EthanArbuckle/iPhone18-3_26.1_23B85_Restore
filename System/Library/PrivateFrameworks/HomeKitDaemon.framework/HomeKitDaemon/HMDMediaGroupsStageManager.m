...
- (id)transformedGroups
{
  ...
  if (v7)
  {
    v8 = addOrReplaceElements(v7, v4, &__block_literal_global_15_286386);
  }
...
- (id)transformedDestinationControllersData
{
  ...
  if (v5)
  {
    v9 = addOrReplaceElements(v5, v8, &__block_literal_global_11_286391);
...
- (id)transformedDestinations
{
  ...
  if (v7)
  {
    v8 = addOrReplaceElements(v7, v4, &__block_literal_global_286395);
  }
