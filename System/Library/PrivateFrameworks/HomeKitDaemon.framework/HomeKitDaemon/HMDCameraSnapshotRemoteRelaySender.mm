...
- (void)snapshotLocal:(id)local didSaveSnapshotFile:(id)file error:(id)error sessionID:(id)d
{
  ...
  if (errorCopy)
  {
    ...
    if (os_log_type_enabled(v17, OS_LOG_TYPE_ERROR))
    {
      ...
      v32 = 2112;
      v33 = errorCopy;
      _os_log_impl(&dword_229538000, v17, OS_LOG_TYPE_ERROR, "%{public}@Snapshot local capture has ended in %@", &v30, 0x16u);
    }
  ...
  else
  {
    ...
    if (idsData)
    {
      ...
      if (os_log_type_enabled(v22, OS_LOG_TYPE_INFO))
      {
        ...
        v32 = 2112;
        v33 = fileCopy;
        _os_log_impl(&dword_229538000, v22, OS_LOG_TYPE_INFO, "%{public}@Scheduling the transfer of file %@ through IDS", &v30, 0x16u);
      }
    ...
    else
    {
      ...
      if (os_log_type_enabled(v27, OS_LOG_TYPE_ERROR))
      {
        ...
        v30 = 138543362;
        v31 = v28;
        _os_log_impl(&dword_229538000, v27, OS_LOG_TYPE_ERROR, "%{public}@Failed to encode snapshot file to send over IDS", &v30, 0xCu);
      }
...
- (void)_callDidSaveSnapshotFileDelegate:(id)delegate
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    v14 = 138543362;
    v15 = v9;
    _os_log_impl(&dword_229538000, v8, OS_LOG_TYPE_INFO, "%{public}@Calling delegate that snapshot file has been saved", &v14, 0xCu);
  }
...
- (void)getSnapshot:(unint64_t)snapshot
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    v13 = 138543362;
    v14 = v9;
    _os_log_impl(&dword_229538000, v8, OS_LOG_TYPE_INFO, "%{public}@Getting the snapshot from local snapshot handler", &v13, 0xCu);
  }
...
void __49__HMDCameraSnapshotRemoteRelaySender_logCategory__block_invoke()
{
  ...
  v2 = logCategory__hmf_once_v2_231760;
  logCategory__hmf_once_v2_231760 = v1;
}
