...
- (void)handleUpdatedGroupModel:(id)model completion:(id)completion
{
  ...
  if (!v11)
  {
    ...
    v32 = [groupsMap objectForKey:parentUUID3];
...
LABEL_23:
  ...
  rootGroup = [(HMDAccessorySettingsController *)selfCopy4 rootGroup];
  v18 = [rootGroup isEqual:v8];
  ...
  if (v18)
  {
    ...
    {
      v22 = HMFGetLogIdentifier();
      rootGroup2 = [(HMDAccessorySettingsController *)v20 rootGroup];
      v45 = 138543874;
      v46 = v22;
      v47 = 2112;
      v48 = rootGroup2;
...
- (BOOL)shouldEncodeForNonAdminSharedUserForSetting:(id)setting
{
  ...
  v4 = [&unk_283E75C20 containsObject:keyPath];
