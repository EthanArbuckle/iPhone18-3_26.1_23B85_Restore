...
- (NSDictionary)coreAnalyticsEventDictionary
{
  ...
  v22 = [legacyUploadReasonCountMap keysSortedByValueUsingComparator:&__block_literal_global_211361];
  ...
  v42 = [uploadErrorCountMap keysSortedByValueUsingComparator:&__block_literal_global_114_211363];
  ...
  v61 = [legacyUploadErrorCountMap keysSortedByValueUsingComparator:&__block_literal_global_125_211368];
  ...
  if ([v64 count])
  {
    ...
    do
    {
      ...
      p_info = v69;
      lowVolumeHistogram = [v69 + 421 lowVolumeHistogram];
