      ...
      if (!v9)
      {
        ...
        if (os_log_type_enabled(v57, OS_LOG_TYPE_ERROR))
        {
          ...
          *buf = 138544130;
          ...
          v103 = v102 = 2112;
          v60 = v103;
          _os_log_impl(&dword_229538000, v57, OS_LOG_TYPE_ERROR, "%{public}@Attempting to remove target %@ for a controller %@/%@ that is not configured with a home", buf, 0x2Au);
...
void __44__HMDTargetControllerManager_updateTargets___block_invoke(uint64_t a1)
{
  ...
  v74 = v6;
  v77 = v1;
  v80 = [v6 countByEnumeratingWithState:&v86 objects:v99 count:16];
  if (v80)
  {
    obj = *v87;
    do
        ...
        if (v9)
        {
          ...
          if (v10)
          {
            if ([v10 isCurrentAccessory])
            {
              ...
              objc_autoreleasePoolPop(v12);
              [v11 configureTargetController:v75];
            }
  ...
  v37 = [MEMORY[0x277CBEB58] setWithArray:v70];
  ...
  v83 = 0u;
  obja = v37;
  v81 = [obja countByEnumeratingWithState:&v82 objects:v91 count:16];
  if (v81)
  {
    v39 = *v83;
    v76 = *v83;
      ...
      for (j = 0; j != v81; ++j)
      {
        ...
        if (v42)
        {
          ...
          if (v44)
          {
            ...
            v55 = *(v1 + 32);
            v90 = v46;
            v56 = [MEMORY[0x277CBEA60] arrayWithObjects:&v90 count:1];
...
LABEL_6:
      _os_log_impl(&dword_229538000, v6, OS_LOG_TYPE_INFO, v9, &v11, 0xCu);
    }
  }
...
void __45__HMDTargetControllerManager__removeTargets___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (v3)
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
    {
      ...
      v21 = 2112;
      v22 = v8;
      _os_log_impl(&dword_229538000, v6, OS_LOG_TYPE_INFO, "%{public}@Failed to write request for removing targets %@", &v19, 0x16u);
    }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
    {
      ...
      v23 = 2112;
      v24 = v12;
      _os_log_impl(&dword_229538000, v15, OS_LOG_TYPE_INFO, "%{public}@Successfully removed targets %@ - response %@", &v19, 0x20u);
    }
...
void __42__HMDTargetControllerManager__addTargets___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (v3)
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
    {
      ...
      v24 = 2112;
      v25 = v3;
      _os_log_impl(&dword_229538000, v6, OS_LOG_TYPE_INFO, "%{public}@Failed to write request for adding targets %@ - error %@", &v20, 0x20u);
    }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
    {
      ...
      v26 = 2112;
      v27 = v12;
      _os_log_impl(&dword_229538000, v15, OS_LOG_TYPE_INFO, "%{public}@Successfully added targets %@ configuredTargets %@ - response %@", &v20, 0x2Au);
    }
        ...
        else if ([v13 length])
        {
          ...
          else
          {
            ...
            if (os_log_type_enabled(v37, OS_LOG_TYPE_INFO))
            {
              ...
              *v56 = 138543362;
              v57 = v38;
              _os_log_impl(&dword_229538000, v37, OS_LOG_TYPE_INFO, "%{public}@Update target name or button configuration", v56, 0xCu);
...
uint64_t __66__HMDTargetControllerManager__refreshConfigurationWithCompletion___block_invoke_3(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    v19 = 2112;
    v20 = v9;
    _os_log_impl(&dword_229538000, v4, OS_LOG_TYPE_INFO, "%{public}@Notifying supported configuration: Maximum Targets: %lu  Ticks Per Second: %lu  Buttons: %@", &v13, 0x2Au);
  }
...
void __51__HMDTargetControllerManager___accessoryConnected___block_invoke_59(uint64_t a1, void *a2)
{
  ...
  if (v3 && WeakRetained)
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
    {
      ...
      v13 = 2112;
      v14 = v3;
      _os_log_impl(&dword_229538000, v8, OS_LOG_TYPE_INFO, "%{public}@Failed to refresh the supported target configuration - error %@", &v11, 0x16u);
    }
  ...
  if (v14)
  {
    ...
    if (v18)
    {
      ...
      if (os_log_type_enabled(v21, OS_LOG_TYPE_INFO))
      {
        ...
        v24 = 138543362;
        v25 = v22;
        _os_log_impl(&dword_229538000, v21, OS_LOG_TYPE_INFO, "%{public}@Disconnected from controller - marking configuation as stale", &v24, 0xCu);
      }
...
- (void)invalidate
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    v9 = 138543362;
    v10 = v6;
    _os_log_impl(&dword_229538000, v5, OS_LOG_TYPE_INFO, "%{public}@Invalidating target controller manager", &v9, 0xCu);
  }
...
void __41__HMDTargetControllerManager_logCategory__block_invoke()
{
  ...
  v2 = logCategory__hmf_once_v7_85613;
  logCategory__hmf_once_v7_85613 = v1;
}
