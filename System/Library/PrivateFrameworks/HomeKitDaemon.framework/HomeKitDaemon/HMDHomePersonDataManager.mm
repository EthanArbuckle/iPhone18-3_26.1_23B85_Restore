...
- (void)configurePersonManagerWithZoneUUID:(id)a3
{
  ...
  if (v6)
  {
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
    {
      ...
      v23 = 2112;
      v24 = v14;
      _os_log_impl(&dword_229538000, v12, OS_LOG_TYPE_INFO, "%{public}@Configuring home person manager: %@", &v21, 0x16u);
    }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v18, OS_LOG_TYPE_DEFAULT))
    {
      ...
      v21 = 138543362;
      v22 = v19;
      _os_log_impl(&dword_229538000, v18, OS_LOG_TYPE_DEFAULT, "%{public}@Home reference is nil", &v21, 0xCu);
    }
...
LABEL_4:
    if (*(a1 + 40))
    {
      ...
      if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
      {
        ...
        v16 = 138543362;
        v17 = v6;
        _os_log_impl(&dword_229538000, v5, OS_LOG_TYPE_INFO, "%{public}@Home person manager zone UUID is now nil. Removing home person manager", &v16, 0xCu);
      }
...
LABEL_8:
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    v20 = 2112;
    v21 = v13;
    _os_log_impl(&dword_229538000, v10, OS_LOG_TYPE_INFO, "%{public}@Home person manager zone UUID changed from %@ to %@. Configuring home person manager", &v16, 0x20u);
  }
...
void __39__HMDHomePersonDataManager_logCategory__block_invoke()
{
  ...
  v2 = logCategory__hmf_once_v19_197119;
  logCategory__hmf_once_v19_197119 = v1;
}
