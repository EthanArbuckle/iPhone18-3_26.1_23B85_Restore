...
void __41__HMDSharedHomeUpdateHandler_logCategory__block_invoke()
{
  ...
  v2 = logCategory__hmf_once_v1_112984;
  logCategory__hmf_once_v1_112984 = v1;
}
  ...
  if (v20 && ([v18 isGreaterThanVersion:v20] & 1) == 0 && (objc_msgSend(v18, "isEqualToVersion:", v20) || !v6))
  {
    ...
    if (os_log_type_enabled(v32, OS_LOG_TYPE_INFO))
    {
      ...
      *buf = 138543618;
      ...
      v38 = 2112;
      v39 = v18;
      _os_log_impl(&dword_229538000, v32, OS_LOG_TYPE_INFO, "%{public}@Leaving shared home source version to %@", buf, 0x16u);
    }
...
uint64_t __49__HMDSharedHomeUpdateHandler_requestHomeDataSync__block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    v8 = 138543362;
    v9 = v5;
    _os_log_impl(&dword_229538000, v4, OS_LOG_TYPE_INFO, "%{public}@Received sync request", &v8, 0xCu);
  }
...
void __47__HMDSharedHomeUpdateHandler_residentsChanged___block_invoke(uint64_t a1)
{
  ...
  if (v2)
  {
    if (v6)
    {
      ...
      v10 = 138543362;
      v11 = v7;
      _os_log_impl(&dword_229538000, v5, OS_LOG_TYPE_INFO, "%{public}@Ignoring resident changed/updated notifications during home merge", &v10, 0xCu);
    }
  ...
  else
  {
    if (v6)
    {
      ...
      v10 = 138543362;
      v11 = v8;
      _os_log_impl(&dword_229538000, v5, OS_LOG_TYPE_INFO, "%{public}@Received residents changed/updated notification", &v10, 0xCu);
    }
...
uint64_t __36__HMDSharedHomeUpdateHandler_resume__block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    v12 = 2112;
    v13 = v7;
    _os_log_impl(&dword_229538000, v4, OS_LOG_TYPE_INFO, "%{public}@Resuming update handler for home %@", &v10, 0x16u);
  }
...
uint64_t __35__HMDSharedHomeUpdateHandler_pause__block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    v12 = 2112;
    v13 = v7;
    _os_log_impl(&dword_229538000, v4, OS_LOG_TYPE_INFO, "%{public}@Pausing update handler for home %@", &v10, 0x16u);
  }
