    ...
    if (v12)
    {
      ...
      do
      {
        ...
        do
        {
          ...
          v17 = [objc_alloc((p_vtable + 487)) initWithOutputDevice:*(*(&v42 + 1) + 8 * v16)];
          v18 = v17;
          if (v17)
          {
            v19 = *(v8 + 44);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v35, OS_LOG_TYPE_DEFAULT))
      {
        ...
        *buf = 138543618;
        ...
        v48 = 2112;
        v49 = v38;
        _os_log_impl(&dword_229538000, v35, OS_LOG_TYPE_DEFAULT, "%{public}@Failed to find accessory with error: %@", buf, 0x16u);
      }
...
void __47__HMDMediaAccessoryBrowseOperation_logCategory__block_invoke()
{
  ...
  v2 = logCategory__hmf_once_v10_70071;
  logCategory__hmf_once_v10_70071 = v1;
}
