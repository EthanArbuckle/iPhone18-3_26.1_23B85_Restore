  ...
  else
  {
    ...
    else
    {
      ...
      if (v9 == v4)
      {
        ...
        [(HMDPrimaryElectionCoordinationAddOn *)v11 createMissingResidentDevicesFromMeshNodes:?];
...
- (void)meshControllerDidUpdatesNodes:(id)a3
{
  ...
  objc_autoreleasePoolPop(v5);
  [(HMDPrimaryElectionCoordinationAddOn *)v6 createMissingResidentDevicesFromMeshNodes:?];
...
- (void)meshController:(id)a3 didReceivePingFromLeaderWithPrimaryResidentUUID:(id)a4
{
  ...
  v6 = a3;
  v7 = a4;
  v8 = [(HMDPrimaryElectionCoordinationAddOn *)self pingTimer];
  [v8 kick];
  ...
  if (v7)
  {
    ...
    objc_autoreleasePoolPop(v9);
    v14 = [(HMDPrimaryElectionCoordinationAddOn *)v10 delegate];
...
- (BOOL)allowExternalUpdateOfPrimaryResidentTo:(id)a3
{
  ...
  {
    v9 = [(HMDPrimaryElectionCoordinationAddOn *)self residentIsPartOfTheCurrentMesh:v4];
    v8 = 1;
...
- (void)start
{
  ...
  v5 = [v4 home];
  v6 = [v5 uuid];
  v7 = [v3 stringWithFormat:@"%@.%@", @"com.apple.HomeKit.HH2", v6];
