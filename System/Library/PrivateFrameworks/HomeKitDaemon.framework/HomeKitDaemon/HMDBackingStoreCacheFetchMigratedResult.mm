...
- (id)mainReturningError
{
  ...
  v41 = &v40;
  v42 = 0x3032000000;
  v43 = __Block_byref_object_copy__23924;
  v44 = __Block_byref_object_dispose__23925;
  v45 = 0;
        ...
        if (!v8 || ([v8 isEqual:v22] & 1) == 0)
        {
          ...
          if (os_log_type_enabled(v25, OS_LOG_TYPE_DEFAULT))
          {
            ...
            *buf = 138543618;
            ...
            v31 = 2048;
            v32 = v27;
            _os_log_impl(&dword_229538000, v25, OS_LOG_TYPE_DEFAULT, "%{public}@detected migrations is need for %lu", buf, 0x16u);
