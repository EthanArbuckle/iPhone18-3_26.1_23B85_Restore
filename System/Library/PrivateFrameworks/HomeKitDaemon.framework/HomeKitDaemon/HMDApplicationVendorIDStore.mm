  ...
  if (v5)
  {
    ...
    if (v9)
    {
      ...
      if (os_log_type_enabled(v12, OS_LOG_TYPE_DEBUG))
      {
        ...
        v20 = 2112;
        v21 = v9;
        _os_log_impl(&dword_229538000, v12, OS_LOG_TYPE_DEBUG, "%{public}@Retrieved application vendor ID store: %@", &v18, 0x16u);
      }
  ...
  if (!machOUUIDs)
  {
    ...
    if (v7)
    {
      ...
      if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
      {
        ...
        v20 = 2112;
        v21 = machOUUIDs;
        _os_log_impl(&dword_229538000, v11, OS_LOG_TYPE_INFO, "%{public}@Updating Mach UUID mapping with application bundle ID %@ and %@", &v16, 0x20u);
      }
...
- (void)_save
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_DEBUG))
  {
    ...
    _os_log_impl(&dword_229538000, v5, OS_LOG_TYPE_DEBUG, "%{public}@Archiving vendor id store %@", &v9, 0x16u);
  }
...
void __68__HMDApplicationVendorIDStore_removeVendorIDForApplicationBundleID___block_invoke(uint64_t a1)
{
  ...
  if (!v3)
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
    {
      ...
      v26 = 2112;
      v27 = v11;
      _os_log_impl(&dword_229538000, v7, OS_LOG_TYPE_INFO, "%{public}@Unknown application %@, cannot remove", &v24, 0x16u);
    }
  ...
  if (v4)
  {
    if (v8)
    {
      ...
      v24 = 138543362;
      v25 = v9;
      _os_log_impl(&dword_229538000, v7, OS_LOG_TYPE_INFO, "%{public}@This is an internal client, do not remove it.", &v24, 0xCu);
    }
...
LABEL_7:
  ...
  if (v8)
  {
    ...
    v26 = 2112;
    v27 = v13;
    _os_log_impl(&dword_229538000, v7, OS_LOG_TYPE_INFO, "%{public}@Removing mapping for application bundle id %@", &v24, 0x16u);
  }
  ...
  if (isWatch())
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v20, OS_LOG_TYPE_INFO))
      {
        ...
        v26 = 2112;
        v27 = v22;
        _os_log_impl(&dword_229538000, v20, OS_LOG_TYPE_INFO, "%{public}@WatchOS : Companion app does not exist for %@. Hence not removing the mapping.", &v24, 0x16u);
      }
  ...
  if (!v6)
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
      {
        ...
        v20 = 2112;
        v21 = vendorIDSHA1;
        _os_log_impl(&dword_229538000, v10, OS_LOG_TYPE_INFO, "%{public}@There is no vendor id for %@, newly extracted vendor id is %@", &v16, 0x20u);
      }
...
uint64_t __42__HMDApplicationVendorIDStore_sharedStore__block_invoke(uint64_t a1)
{
  ...
  if (!sharedStore_sharedStore)
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
    {
      ...
      v13 = 138543362;
      v14 = v8;
      _os_log_impl(&dword_229538000, v7, OS_LOG_TYPE_INFO, "%{public}@No archived vendor ID store, creating a new one", &v13, 0xCu);
    }
