...
- (void)__handleXPCMessage:(id)a3
{
  ...
  if (v5)
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
    {
      ...
      v15 = 2112;
      v16 = v10;
      _os_log_impl(&dword_229538000, v8, OS_LOG_TYPE_INFO, "%{public}@Locally dispatching message: %@", &v13, 0x16u);
    }
...
- (void)registerForMessage:(id)a3 policies:(id)a4
{
  ...
  {
    v6 = a3;
    v9 = [a4 hmf_objectsPassingTest:&__block_literal_global_138_251859];
