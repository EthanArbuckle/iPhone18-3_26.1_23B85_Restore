...
- (void)synchronizeCurveWithActiveTransitionContext:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    v28 = 138543362;
    v29 = v9;
    _os_log_impl(&dword_229538000, v8, OS_LOG_TYPE_INFO, "%{public}@Synchronizing curve...", &v28, 0xCu);
  }
...
LABEL_14:
      _os_log_impl(&dword_229538000, v24, v25, v23, &v28, 0xCu);
...
LABEL_13:
  ...
  if (v21)
  {
    ...
    v28 = 138543362;
    v29 = v27;
    _os_log_impl(&dword_229538000, v20, OS_LOG_TYPE_INFO, "%{public}@Start sychronizing curve", &v28, 0xCu);
  }
...
void __73__HMDNaturalLightingCurveWriter_handlePrimaryResidentUpdateNotification___block_invoke(uint64_t a1)
{
  ...
  if (v5 != [*(a1 + 32) isCurrentDevicePrimaryResident])
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
    {
      ...
      v19 = 2112;
      v20 = v11;
      _os_log_impl(&dword_229538000, v8, OS_LOG_TYPE_INFO, "%{public}@Current device primary changed from: (%@->%@)", &v15, 0x20u);
    }
      ...
      if (v12 >= 0.0)
      {
        ...
        if (v28 - v12 <= 0.0)
        {
          ...
          if (os_log_type_enabled(v46, OS_LOG_TYPE_INFO))
          {
            ...
            v56 = 2048;
            v57 = v28;
            _os_log_impl(&dword_229538000, v46, OS_LOG_TYPE_INFO, "%{public}@Updating curve since time elapsed since transition start is greater than curve update interval %f:%f", &v52, 0x20u);
          }
        ...
        else
        {
          ...
          if (v31 < v34)
          {
            if (v37)
            {
              ...
              v54 = 2048;
              v55 = v29;
              _os_log_impl(&dword_229538000, v36, OS_LOG_TYPE_INFO, "%{public}@Starting timer for natural lighting curve update: %fs", &v52, 0x16u);
            }
          ...
          if (v37)
          {
            ...
            v60 = 2048;
            v61 = v50;
            _os_log_impl(&dword_229538000, v36, OS_LOG_TYPE_INFO, "%{public}@Updating curve because accessory time (%fs) and controller time (%fs) difference (%fs) is greater than threshold (%fs)", &v52, 0x34u);
          }
...
LABEL_25:
    ...
    if (os_log_type_enabled(v24, OS_LOG_TYPE_INFO))
    {
      ...
      v54 = 2112;
      v55 = 0.0;
      _os_log_impl(&dword_229538000, v24, OS_LOG_TYPE_INFO, "%{public}@Stopping characteristic write timer because active transition context is not set: %@", &v52, 0x16u);
    }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v20, OS_LOG_TYPE_INFO))
    {
      ...
      v52 = 138543362;
      v53 = v21;
      _os_log_impl(&dword_229538000, v20, OS_LOG_TYPE_INFO, "%{public}@Skipping active transition context update because current device is not primary resident", &v52, 0xCu);
    }
...
void __44__HMDNaturalLightingCurveWriter_logCategory__block_invoke()
{
  ...
  v2 = logCategory__hmf_once_v20_279508;
  logCategory__hmf_once_v20_279508 = v1;
}
