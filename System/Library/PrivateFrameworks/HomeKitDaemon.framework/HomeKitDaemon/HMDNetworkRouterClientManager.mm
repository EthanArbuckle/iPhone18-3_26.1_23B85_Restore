...
- (void)_getNetworkConfigurationForAccessory:(id)accessory targetProtectionMode:(int64_t)mode completion:(id)completion
{
  ...
  if (mode == 3)
  {
    ...
    (*(completionCopy + 2))(completionCopy, 0, v12, &unk_283E73FE8, 0);
  }
...
void __155__HMDNetworkRouterClientManager__updateClientConfiguration_forAccessory_protectionMode_clientStatus_skipIfFingerprintMatches_clientReconfigurationAllowed___block_invoke_42(void *a1)
{
  ...
  v4 = a1[7];
  v5 = [v3 credential];
  [v1 _migrateAccessory:v2 withConfiguration:v3 clientStatus:v4 fromCredentialType:credentialTypeForCredential(v5) toCredentialType:3 rotate:0 completion:&__block_literal_global_44_207076];
}
...
void __155__HMDNetworkRouterClientManager__updateClientConfiguration_forAccessory_protectionMode_clientStatus_skipIfFingerprintMatches_clientReconfigurationAllowed___block_invoke_4(uint64_t a1)
{
  ...
  if (v4)
  {
    ...
    [v11 resetAccessViolationForClientIdentifier:*(a1 + 72) completion:&__block_literal_global_46_207072];
    ...
    if (*(a1 + 120) == 1 && *(a1 + 112) != 3)
    {
      ...
      v14 = *(a1 + 88);
      v16 = [v15 credential];
      [v12 _migrateAccessory:v13 withConfiguration:v15 clientStatus:v14 fromCredentialType:credentialTypeForCredential(v16) toCredentialType:3 rotate:0 completion:&__block_literal_global_48_207073];
    }
  }
}
...
void __125__HMDNetworkRouterClientManager__createClientConfigurationForAccessory_credential_clientStatus_clientReconfigurationAllowed___block_invoke_3(uint64_t a1)
{
  ...
  if (v4)
  {
    ...
    if (*(a1 + 112) == 1 && *(a1 + 104) != 3)
    {
      ...
      [*(a1 + 32) _migrateAccessory:*(a1 + 48) withConfiguration:*(a1 + 72) clientStatus:*(a1 + 88) fromCredentialType:credentialTypeForCredential(*(a1 + 96)) toCredentialType:3 rotate:0 completion:&__block_literal_global_207082];
    }
  }
}
...
+ (id)logCategory
{
  ...
  {
    dispatch_once(&logCategory__hmf_once_t79, &__block_literal_global_78_207149);
  }
