...
LABEL_15:
      _os_log_impl(&dword_229538000, v28, OS_LOG_TYPE_INFO, v31, buf, 0x16u);
    }
...
LABEL_16:
  ...
  if (v7)
  {
    ...
    v10 = [v9 na_map:&__block_literal_global_182];
    v11 = [v10 mutableCopy];
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
    {
      ...
      *buf = 138543618;
      ...
      v42 = 2048;
      v43 = [v17 count];
      _os_log_impl(&dword_229538000, v14, OS_LOG_TYPE_INFO, "%{public}@Fetch collection completed with %ld items.", buf, 0x16u);
    ...
    v39[1] = 3221225472;
    v39[2] = __64__HMDRemoteEventRouterServer_pendingEventCollectionDidComplete___block_invoke_183;
    v39[3] = &unk_27868A250;
    v39[4] = *(a1 + 32);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v35, OS_LOG_TYPE_ERROR))
    {
      ...
      *buf = 138543618;
      ...
      v42 = 2112;
      v43 = v5;
      _os_log_impl(&dword_229538000, v35, OS_LOG_TYPE_ERROR, "%{public}@Device no longer available %@", buf, 0x16u);
    }
...
void __64__HMDRemoteEventRouterServer_pendingEventCollectionDidComplete___block_invoke_183(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    v16 = 2112;
    v17 = v10;
    _os_log_impl(&dword_229538000, v6, OS_LOG_TYPE_INFO, "%{public}@Fetch collection response completed with %@%@", &v12, 0x20u);
  }
...
- (BOOL)shouldAllowEvent:(id)event topic:(id)topic connection:(id)connection
{
  ...
  if (os_log_type_enabled(logger, OS_LOG_TYPE_DEBUG))
  {
    *buf = 138412546;
    ...
    v34 = 2112;
    v35 = topicCopy;
    _os_log_debug_impl(&dword_229538000, logger, OS_LOG_TYPE_DEBUG, "Checking access control connection: %@, topic: %@", buf, 0x16u);
  }
  ...
  if (v10)
  {
    ...
    if (v14)
    {
      ...
      if (os_log_type_enabled(v28, OS_LOG_TYPE_ERROR))
      {
        *buf = 138412290;
        v33 = v10;
        _os_log_error_impl(&dword_229538000, v28, OS_LOG_TYPE_ERROR, "Could not find user ACL provider for %@", buf, 0xCu);
      }
    }
    ...
    else
    {
      ...
      if (os_log_type_enabled(v27, OS_LOG_TYPE_DEBUG))
      {
        *buf = 138412546;
        ...
        v34 = 2112;
        v35 = connectionCopy;
        _os_log_debug_impl(&dword_229538000, v27, OS_LOG_TYPE_DEBUG, "No device when attempting to check access control for %@ to %@", buf, 0x16u);
      }
    }
...
- (void)server:(id)server sendEvents:(id)events cachedEvents:(id)cachedEvents connection:(id)connection completion:(id)completion
{
  ...
  v19 = [eventsCopy na_map:&__block_literal_global_169_109689];
  v20 = [v19 mutableCopy];
  updatedEvents = [(HMDRemoteEventRouterProtoServerMessage *)v15 updatedEvents];
  [updatedEvents setEvents:v20];

  v22 = [cachedEventsCopy na_map:&__block_literal_global_171_109690];
  v23 = [v22 mutableCopy];
  ...
  if (v27)
  {
    ...
    if (v28)
    {
      ...
      if (v32)
      {
        ...
        if (os_log_type_enabled(logger, OS_LOG_TYPE_DEFAULT))
        {
          ...
          *buf = 138412290;
          v48 = v37;
          _os_log_impl(&dword_229538000, v36, OS_LOG_TYPE_DEFAULT, "Sending events of size: %@", buf, 0xCu);
        ...
        if (os_log_type_enabled(logger, OS_LOG_TYPE_DEBUG))
        {
          *buf = 138412290;
          v48 = eventsCopy;
          _os_log_debug_impl(&dword_229538000, logger, OS_LOG_TYPE_DEBUG, "Sending events: %@", buf, 0xCu);
        }
      ...
      else
      {
        ...
        {
          *buf = 0;
          _os_log_error_impl(&dword_229538000, v43, OS_LOG_TYPE_ERROR, "Could not create destination", buf, 2u);
        }
      }
    }
    ...
    else
    {
      ...
      if (os_log_type_enabled(v41, OS_LOG_TYPE_ERROR))
      {
        *buf = 138412290;
        v48 = v25;
        _os_log_error_impl(&dword_229538000, v41, OS_LOG_TYPE_ERROR, "Device no longer available %@", buf, 0xCu);
      }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v39, OS_LOG_TYPE_ERROR))
    {
      *buf = 138412290;
      v48 = v25;
      _os_log_error_impl(&dword_229538000, v39, OS_LOG_TYPE_ERROR, "Could not find remote connection for connection %@", buf, 0xCu);
    }
...
- (void)server:(id)server connectionDidFail:(id)fail
{
  ...
  if (os_log_type_enabled(logger, OS_LOG_TYPE_ERROR))
  {
    v9 = 138412290;
    v10 = failCopy;
    _os_log_error_impl(&dword_229538000, logger, OS_LOG_TYPE_ERROR, "Removing connection on error %@", &v9, 0xCu);
  }
...
- (void)server:(id)server connectionDidExpire:(id)expire
{
  ...
  if (os_log_type_enabled(logger, OS_LOG_TYPE_ERROR))
  {
    v9 = 138412290;
    v10 = expireCopy;
    _os_log_error_impl(&dword_229538000, logger, OS_LOG_TYPE_ERROR, "Removing connection on expiry %@", &v9, 0xCu);
  }
  ...
  if ([(HMDRemoteEventRouterServer *)self isPrimaryResident])
  {
    ...
    if (idsIdentifier)
    {
      ...
      if (os_log_type_enabled(logger, OS_LOG_TYPE_DEFAULT))
      {
        *buf = 138412290;
        v26 = idsIdentifier;
        _os_log_impl(&dword_229538000, logger, OS_LOG_TYPE_DEFAULT, "Notifying on connecting to primary %@", buf, 0xCu);
      }
...
- (BOOL)server:(id)server shouldProcessEventsForConnection:(id)connection shouldLogState:(BOOL)state
{
  ...
  if (os_log_type_enabled(logger, OS_LOG_TYPE_DEFAULT))
  {
    ...
    v37 = 2112;
    v38 = WeakRetained;
    _os_log_impl(&dword_229538000, logger, OS_LOG_TYPE_DEFAULT, "Checking if server should process events for connection: %@, dataSource: %@", &v35, 0x16u);
  }
    ...
    if (v20)
    {
      ...
      if (![(HMDRemoteEventRouterServer *)self isPrimaryResident]|| !v23)
      {
        ...
        if (os_log_type_enabled(v29, OS_LOG_TYPE_DEFAULT))
        {
          ...
          v41 = 2112;
          v42 = v20;
          _os_log_impl(&dword_229538000, v21, OS_LOG_TYPE_DEFAULT, "Allow connection: %{public}@, for resident connection mode. isReceiverPrimary: %{public}@, incoming device:%@, primary device: %@", &v35, 0x2Au);
...
LABEL_30:
      ...
      if (stateCopy)
      {
        ...
        if (os_log_type_enabled(v24, OS_LOG_TYPE_DEFAULT))
        {
          ...
          v39 = 2112;
          v40 = v20;
          _os_log_impl(&dword_229538000, v25, OS_LOG_TYPE_DEFAULT, "Not allowing connection while both devices are known as primary, this should resolve shortly. isReceiverPrimary: %{public}@, incoming device:%@, primary device: %@", &v35, 0x20u);
...
LABEL_23:
    ...
    else
    {
      ...
      if (os_log_type_enabled(v28, OS_LOG_TYPE_ERROR))
      {
        ...
        v35 = 138412290;
        v36 = v26;
        _os_log_error_impl(&dword_229538000, v25, OS_LOG_TYPE_ERROR, "Unexpectedly did not find device for resident. %@", &v35, 0xCu);
        goto LABEL_23;
      }
    }
...
LABEL_14:
  ...
  if (stateCopy)
  {
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_DEFAULT))
    {
      ...
      v35 = 138543362;
      v36 = v21;
      _os_log_impl(&dword_229538000, v20, OS_LOG_TYPE_DEFAULT, "Allow connection: %{public}@, for primary connection mode.", &v35, 0xCu);
LABEL_29:
...
uint64_t __81__HMDRemoteEventRouterServer_responseHandlerForSendMessageIdentifier_completion___block_invoke_2(void *a1)
{
  ...
  if (v2)
  {
    if (os_log_type_enabled(v4, OS_LOG_TYPE_ERROR))
    {
      ...
      v17 = 2112;
      v18 = v2;
      _os_log_error_impl(&dword_229538000, v4, OS_LOG_TYPE_ERROR, "Failed to send message: %@ error: %@", &v15, 0x16u);
    }
  }

  else
  {
    if (os_log_type_enabled(v4, OS_LOG_TYPE_DEFAULT) && (v6 = a1[6], v15 = 138412290, v16 = v6, _os_log_impl(&dword_229538000, v4, OS_LOG_TYPE_DEFAULT, "Successfully sent message: %@", &v15, 0xCu), (v3 = a1[5]) == 0))
    {
      WeakRetained = 0;
    }
    ...
    v8 = [WeakRetained currentAccessorySetupMetricDispatcher];
    v10 = [WeakRetained currentAccessoryHomeUUID];
    if (v10)
    {
      v11 = a1[5];
      v12 = v11 ? objc_getProperty(v11, v9, 40, 1) : 0;
      if ([v10 hmf_isEqualToUUID:v12])
      {
...
- (void)_handleFetchEventsRequest:(id)request originalMessage:(id)message connectionMode:(int64_t)mode
{
  ...
  if (requestCopy)
  {
    ...
    if (remoteSourceDevice && identifier)
    {
      if (self && self->_isResidentEventProviding)
      {
        ...
        if (v16 && ([WeakRetained routerServerUserAccessControlProviderForIdentifier:v16], (v17 = objc_claimAutoreleasedReturnValue()) != 0))
        {
          ...
          if (v20)
          {
            ...
            if (v22)
            {
              ...
              v29 = [v28 na_map:&__block_literal_global_157];
          ...
          else
          {
            ...
            {
              *buf = 0;
              _os_log_error_impl(&dword_229538000, logger, OS_LOG_TYPE_ERROR, "Got a fetch request with no topics.", buf, 2u);
            }
        ...
        else
        {
          ...
          {
            *buf = 0;
            _os_log_error_impl(&dword_229538000, v40, OS_LOG_TYPE_ERROR, "Could not find user for incoming request.", buf, 2u);
          }
      ...
      {
        *buf = 0;
        _os_log_error_impl(&dword_229538000, v39, OS_LOG_TYPE_ERROR, "Could not process fetch as non-resident event providing device.", buf, 2u);
      }
    ...
    else
    {
      ...
      {
        *buf = 0;
        _os_log_error_impl(&dword_229538000, v36, OS_LOG_TYPE_ERROR, "Could not find device of incoming request.", buf, 2u);
      }
...
LABEL_37:
  ...
  {
    *buf = 0;
    _os_log_error_impl(&dword_229538000, v35, OS_LOG_TYPE_ERROR, "Did not find fetch request in payload.", buf, 2u);
  }
...
id __87__HMDRemoteEventRouterServer__handleFetchEventsRequest_originalMessage_connectionMode___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (([v3 hasTopic] & 1) == 0)
  {
    ...
    {
      *v9 = 0;
      _os_log_error_impl(&dword_229538000, v4, OS_LOG_TYPE_ERROR, "No topic found!", v9, 2u);
    }
  }
...
- (void)_handleKeepAliveRequest:(id)request originalMessage:(id)message
{
  ...
  if (requestCopy)
  {
      ...
      else
      {
        ...
        if (os_log_type_enabled(logger, OS_LOG_TYPE_ERROR))
        {
          ...
          *buf = 138412546;
          ...
          v30 = 2112;
          v31 = v13;
          _os_log_error_impl(&dword_229538000, v22, OS_LOG_TYPE_ERROR, "No connection was found for keep alive request in current connections: %@ device identifier: %@", buf, 0x16u);
        }
    ...
    else
    {
      ...
      {
        *buf = 0;
        _os_log_error_impl(&dword_229538000, v18, OS_LOG_TYPE_ERROR, "Could not find device of incoming request.", buf, 2u);
      }
  ...
  else
  {
    ...
    {
      *buf = 0;
      _os_log_error_impl(&dword_229538000, v17, OS_LOG_TYPE_ERROR, "Did not keep-alive request in payload.", buf, 2u);
    }
...
- (void)_handleChangeRegistrationsRequest:(id)request originalMessage:(id)message
{
  ...
  if (requestCopy)
  {
    ...
    if (remoteSourceDevice && identifier)
    {
      ...
      if (v14)
      {
        ...
        v18 = [topicFilterAdditions na_map:&__block_literal_global_140];
        topicFilterRemovals = [requestCopy topicFilterRemovals];
        v20 = [topicFilterRemovals na_map:&__block_literal_global_142_109734];
      ...
      else
      {
        ...
        if (os_log_type_enabled(logger, OS_LOG_TYPE_ERROR))
        {
          ...
          *buf = 138412546;
          ...
          v41 = 2112;
          v42 = v13;
          _os_log_error_impl(&dword_229538000, v27, OS_LOG_TYPE_ERROR, "No connection was found during change registrations request in current connections: %@ device identifier: %@", buf, 0x16u);
        }
    ...
    else
    {
      ...
      {
        *buf = 0;
        _os_log_error_impl(&dword_229538000, v23, OS_LOG_TYPE_ERROR, "Could not find device of incoming request.", buf, 2u);
      }
  ...
  else
  {
    ...
    {
      *buf = 0;
      _os_log_error_impl(&dword_229538000, v22, OS_LOG_TYPE_ERROR, "Did not change registrations request in payload.", buf, 2u);
    }
...
void __80__HMDRemoteEventRouterServer__handleChangeRegistrationsRequest_originalMessage___block_invoke_3(uint64_t a1, void *a2, void *a3)
{
  ...
  else
  {
    ...
    v12 = [v11 na_map:&__block_literal_global_146];
...
- (void)_handleDisconnectRequest:(id)request originalMessage:(id)message
{
  ...
  if (requestCopy)
  {
    ...
    if (remoteSourceDevice && identifier)
    {
      ...
      else
      {
        ...
        {
          *buf = 0;
          _os_log_error_impl(&dword_229538000, logger, OS_LOG_TYPE_ERROR, "No connection was found to disconnect.", buf, 2u);
        }
  ...
  else
  {
    ...
    {
      *buf = 0;
      _os_log_error_impl(&dword_229538000, v17, OS_LOG_TYPE_ERROR, "Did not find disconnect request in payload.", buf, 2u);
    }
...
- (void)refreshConnections:(id)connections
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    *buf = 138543618;
    ...
    v19 = 2112;
    v20 = connectionsCopy;
    _os_log_impl(&dword_229538000, v9, OS_LOG_TYPE_INFO, "%{public}@Refresh connections for user:%@", buf, 0x16u);
  }
...
- (void)_handleConnectRequest:(id)request originalMessage:(id)message connectionMode:(int64_t)mode
{
  ...
  currentAccessorySetupMetricDispatcher = [WeakRetained currentAccessorySetupMetricDispatcher];
  currentAccessoryHomeUUID = [WeakRetained currentAccessoryHomeUUID];
  if (!currentAccessoryHomeUUID || (!self ? (v16 = 0) : (v16 = objc_getProperty(self, v14, 40, 1)), ![currentAccessoryHomeUUID hmf_isEqualToUUID:v16]))
  {
    v17 = 0;
    if (!requestCopy)
    {
...
LABEL_12:
    ...
    if (!remoteSourceDevice || !identifier)
    {
      ...
      {
        *buf = 0;
        _os_log_error_impl(&dword_229538000, logger, OS_LOG_TYPE_ERROR, "Could not find device of incoming request.", buf, 2u);
      }
    ...
    modeCopy = mode;
    v21 = [WeakRetained routerServerUserAccessControlProviderIdentifierForMessage:messageCopy];
    if (!v21)
    {
      v30 = self->_logger;
      ...
      {
        *buf = 0;
        _os_log_error_impl(&dword_229538000, v30, OS_LOG_TYPE_ERROR, "Could not find user for incoming request.", buf, 2u);
      }
    ...
    v67[1] = 3221225472;
    v67[2] = __83__HMDRemoteEventRouterServer__handleConnectRequest_originalMessage_connectionMode___block_invoke;
    v67[3] = &unk_278678358;
    v56 = v60;
    v68 = v56;
    v23 = [currentConnections na_firstObjectPassingTest:v67];

    v57 = currentAccessorySetupMetricDispatcher;
    if (v23)
    {
      v58 = v23;
      if (v23->_connectionMode == modeCopy)
      {
LABEL_37:
        if ([requestCopy hasConnectEvent])
        {
          v37 = MEMORY[0x277D174A8];
          connectEvent = [requestCopy connectEvent];
          v55 = [v37 fromProtobuff:connectEvent];
        }
        ...
        v53 = currentAccessoryHomeUUID;
        if ([requestCopy hasUnregisterEvent])
        {
          v39 = MEMORY[0x277D174A8];
          unregisterEvent = [requestCopy unregisterEvent];
          v41 = [v39 fromProtobuff:unregisterEvent];
        }
        ...
        topicFilterAdditions = [requestCopy topicFilterAdditions];
        v44 = [topicFilterAdditions count];

        if (v44)
        {
          topicFilterAdditions2 = [requestCopy topicFilterAdditions];
          v47 = [topicFilterAdditions2 na_map:&__block_literal_global_125];
          [array addObjectsFromArray:v47];
        }

        if (self)
        {
          v48 = objc_getProperty(self, v45, 104, 1);
        }
        ...
        v61[1] = 3221225472;
        v61[2] = __83__HMDRemoteEventRouterServer__handleConnectRequest_originalMessage_connectionMode___block_invoke_2;
        v61[3] = &unk_2786783C8;
        v66 = modeCopy;
        v61[4] = self;
        v62 = messageCopy;
        v63 = remoteSourceDevice;
        v64 = v56;
        v65 = v58;
        v51 = v58;
        [v49 connectWithConnection:v51 connectEvent:v55 unregisterEvent:v41 topicFilterAdditions:v50 completion:v61];

        v31 = v68;
        currentAccessorySetupMetricDispatcher = v57;
        currentAccessoryHomeUUID = v53;
LABEL_48:
...
LABEL_49:
      ...
      if (os_log_type_enabled(v24, OS_LOG_TYPE_DEFAULT))
      {
        *buf = 138412290;
        v70 = v23;
        _os_log_impl(&dword_229538000, v24, OS_LOG_TYPE_DEFAULT, "Connection mode is different remove existing %@", buf, 0xCu);
      }

      currentConnections2 = [(HMDRemoteEventRouterServer *)self currentConnections];
      [currentConnections2 removeObject:v23];
    }

    v58 = -[HMDRemoteEventRouterServerConnection initWithDevice:connectionMode:supportsFragmentMessage:userAccessControlProviderUUID:]([HMDRemoteEventRouterServerConnection alloc], "initWithDevice:connectionMode:supportsFragmentMessage:userAccessControlProviderUUID:", remoteSourceDevice, modeCopy, [messageCopy BOOLForKey:@"isFragmented"]);
    if (modeCopy == 1)
    {
      v27 = self->_logger;
      v26 = v54;
...
LABEL_33:
        ...
        [currentConnections3 addObject:v58];
        ...
        if (os_signpost_enabled(v33))
        {
          ...
          v35 = v33;
          v36 = [v34 numberWithInteger:modeCopy];
          *buf = 138412290;
          v70 = v36;
          _os_signpost_emit_with_name_impl(&dword_229538000, v35, OS_SIGNPOST_EVENT, 0xEEEEB0B5B2B2EEEELL, "EventRouterServerConnectionCreated", "connectionMode=%{signpost.description:attribute}@ ", buf, 0xCu);
        ...
        if (v26)
        {
          [currentAccessorySetupMetricDispatcher markSetupEndStage:15 error:0];
          [currentAccessorySetupMetricDispatcher markSetupBeginStage:16 error:0];
        }
    ...
    _os_log_impl(&dword_229538000, v27, OS_LOG_TYPE_DEFAULT, v28, buf, 0xCu);
    goto LABEL_33;
  }

  [currentAccessorySetupMetricDispatcher markSetupBeginStage:15 error:0];
  v17 = 1;
  if (requestCopy)
  {
    goto LABEL_12;
...
LABEL_8:
  ...
  {
    *buf = 0;
    _os_log_error_impl(&dword_229538000, v18, OS_LOG_TYPE_ERROR, "Did not find connect request in payload.", buf, 2u);
  }
...
void __83__HMDRemoteEventRouterServer__handleConnectRequest_originalMessage_connectionMode___block_invoke_2(uint64_t a1, void *a2, void *a3)
{
  ...
  else
  {
    ...
    v10 = [v17 na_map:&__block_literal_global_129_109756];
    v11 = [v10 na_map:&__block_literal_global_132_109757];
...
LABEL_19:
  ...
  switch(request)
  {
    case 0:
      ...
      {
        *buf = 0;
        _os_log_error_impl(&dword_229538000, logger, OS_LOG_TYPE_ERROR, "Unable to find request type.", buf, 2u);
      }
...
LABEL_14:
  ...
  {
    *v18 = 0;
    _os_log_error_impl(&dword_229538000, v16, OS_LOG_TYPE_ERROR, "Received an unrecognized request type.", v18, 2u);
  }
...
- (void)_handleRequestMessage:(id)message connectionMode:(int64_t)mode
{
  ...
  if (os_log_type_enabled(logger, OS_LOG_TYPE_INFO))
  {
    ...
    *buf = 138412546;
    ...
    v26 = 2112;
    v27 = v10;
    _os_log_impl(&dword_229538000, v8, OS_LOG_TYPE_INFO, "Handle request message: %@ connection mode: %@", buf, 0x16u);
  }
  ...
  if (!v12)
  {
    ...
    {
      *buf = 0;
      _os_log_error_impl(&dword_229538000, v16, OS_LOG_TYPE_ERROR, "Did not find message payload.", buf, 2u);
    }
  ...
  if (!v14)
  {
    if (!v15)
    {
      ...
      {
        *buf = 0;
        _os_log_impl(&dword_229538000, v20, OS_LOG_TYPE_DEFAULT, "No payload from fragment message", buf, 2u);
      }
    ...
    if (os_log_type_enabled(v21, OS_LOG_TYPE_ERROR))
    {
      *buf = 138412290;
      v25 = v15;
      _os_log_error_impl(&dword_229538000, v21, OS_LOG_TYPE_ERROR, "Could not decode payload from fragment message %@", buf, 0xCu);
    }
...
LABEL_11:
  ...
  else
  {
    ...
    {
      *buf = 0;
      _os_log_error_impl(&dword_229538000, v18, OS_LOG_TYPE_ERROR, "Decoded payload does not have request.", buf, 2u);
    }
...
- (void)_handleUserPrivilegeChange:(id)change
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_ERROR))
    {
      ...
      *buf = 138543362;
      v19 = v14;
      _os_log_impl(&dword_229538000, v13, OS_LOG_TYPE_ERROR, "%{public}@user UUID missed", buf, 0xCu);
    }
  ...
  if (fragmentMessageCopy)
  {
    ...
    if (os_log_type_enabled(logger, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *buf = 138412546;
      ...
      v33 = 2112;
      v34 = v17;
      _os_log_impl(&dword_229538000, v16, OS_LOG_TYPE_DEFAULT, "Responding to %@ with message size: %@, fragment: 0", buf, 0x16u);
    }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v21, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *buf = 138412546;
      ...
      v33 = 2112;
      v34 = v24;
      _os_log_impl(&dword_229538000, v23, OS_LOG_TYPE_DEFAULT, "Responding to %@ with message size: %@", buf, 0x16u);
    }
  ...
  if ([v8 count])
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
    {
      ...
      *buf = 138543874;
      ...
      v22 = 2112;
      v23 = v13;
      _os_log_impl(&dword_229538000, v11, OS_LOG_TYPE_INFO, "%{public}@Removing connections: %@ due to removed user: %@", buf, 0x20u);
    }
...
uint64_t __85__HMDRemoteEventRouterServer_handlePrimaryResidentIsCurrentDeviceChangeNotification___block_invoke(uint64_t a1)
{
  ...
  if (v4 != result)
  {
    ...
    v16 = 138412290;
    v17 = v10;
    _os_log_impl(&dword_229538000, v9, OS_LOG_TYPE_DEFAULT, "Primary resident status changed to %@", &v16, 0xCu);
...
- (void)_registerForAccessoryMessages:(id)messages
{
  ...
  if (os_log_type_enabled(logger, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *&v39[14] = v7 != 0;
    v40 = 2112;
    v41 = v14;
    _os_log_impl(&dword_229538000, v9, OS_LOG_TYPE_DEFAULT, "Registering for accessory messages %@, user privilege: (exists: %d) %@", v39, 0x1Cu);
  }
...
- (void)_registerForMessages:(id)messages withHome:(id)home
{
  ...
  v14 = Property;
  v15 = [messagesCopy na_firstObjectPassingTest:&__block_literal_global_95_109793];
  objc_opt_class();
  if (objc_opt_isKindOfClass())
  {
    v16 = v15;
  ...
  if (os_log_type_enabled(logger, OS_LOG_TYPE_DEFAULT))
  {
    ...
    v30 = 2112;
    v31 = v22;
    _os_log_impl(&dword_229538000, v21, OS_LOG_TYPE_DEFAULT, "Registering for messages with user privilege: (exists: %d) %@", v29, 0x12u);
  }
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t4_109814 != -1)
  {
    dispatch_once(&logCategory__hmf_once_t4_109814, &__block_literal_global_109815);
  }

  v3 = logCategory__hmf_once_v5_109816;
...
void __41__HMDRemoteEventRouterServer_logCategory__block_invoke()
{
  ...
  v2 = logCategory__hmf_once_v5_109816;
  logCategory__hmf_once_v5_109816 = v1;
}
