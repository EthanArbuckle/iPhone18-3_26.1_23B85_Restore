...
- (void)resetOTAProviderStateForHMDHAPAccessory:(id)accessory
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v28 = 2112;
    v29 = accessoryCopy;
    _os_log_impl(&dword_229538000, v7, OS_LOG_TYPE_INFO, "%{public}@%@ Resetting OTA provider state for %@", &v24, 0x20u);
  }
  ...
  if ([accessoryCopy supportsCHIP])
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v20, OS_LOG_TYPE_ERROR))
      {
        ...
        _os_log_impl(&dword_229538000, v20, OS_LOG_TYPE_ERROR, "%{public}@%@ Couldn't get a strong ref to the software update provider", &v24, 0x16u);
      }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_ERROR))
    {
      ...
      _os_log_impl(&dword_229538000, v15, OS_LOG_TYPE_ERROR, "%{public}@%@ Not a matter accessory", &v24, 0x16u);
    }
...
- (BOOL)canEstablishConnectionForHMDHAPAccessory:(id)accessory
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    _os_log_impl(&dword_229538000, v7, OS_LOG_TYPE_INFO, "%{public}@%@ canEstablishConnectionForHMDHAPAccessory", &v26, 0x16u);
  }
  ...
  if ([accessoryCopy supportsCHIP])
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v21, OS_LOG_TYPE_ERROR))
      {
        ...
        _os_log_impl(&dword_229538000, v21, OS_LOG_TYPE_ERROR, "%{public}@%@ Couldn't get a strong ref to the software update provider", &v26, 0x16u);
      }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_ERROR))
    {
      ...
      _os_log_impl(&dword_229538000, v16, OS_LOG_TYPE_ERROR, "%{public}@%@ Not a matter accessory", &v26, 0x16u);
    }
...
void __122__HMDMatterSoftwareUpdateProviderDelegate_queryImageWithPairing_requestParams_queue_accessoryInitiated_completionHandler___block_invoke(uint64_t a1)
{
  ...
  if (v2)
  {
    ...
    if (v5)
    {
      ...
      v9 = [v8 containsObject:&unk_283E74D80];
      ...
      if ((v9 & 1) == 0)
      {
        ...
        if (os_log_type_enabled(v26, OS_LOG_TYPE_ERROR))
        {
          ...
          *buf = 138543874;
          ...
          v119 = 2112;
          v120 = v29;
          _os_log_impl(&dword_229538000, v26, OS_LOG_TYPE_ERROR, "%{public}@%@ Transfer protocols not supported in request: %@", buf, 0x20u);
        }

        objc_autoreleasePoolPop(v24);
        v30 = *(a1 + 32);
        v31 = [MEMORY[0x277CCA9B8] hmfErrorWithCode:5];
        [v30 manageNonBusyAvailableImageResponses:v4 normalStatus:&unk_283E74DB0 error:v31 completionHandler:*(a1 + 56)];
        goto LABEL_58;
      }
      ...
      if (v10)
      {
        ...
        {
          v38 = *(a1 + 56);
          v39 = [*(a1 + 32) _queryImageResponseWithStatus:&unk_283E74D68 delayedActionTime:0];
          (*(v38 + 16))(v38, v39, 0);
        }
      ...
      if (v33 <= 2)
      {
        if (v33 != 1)
        {
          if (v33 == 2)
          {
            ...
            {
              v65 = *(a1 + 56);
              v66 = [*(a1 + 32) _queryImageResponseWithStatus:&unk_283E74D80 delayedActionTime:0];
              (*(v65 + 16))(v65, v66, 0);
            }
        ...
        if (v33 == 3)
        {
          ...
          if (!v32)
          {
            if (os_log_type_enabled(v42, OS_LOG_TYPE_ERROR))
            {
              ...
              *buf = 138543874;
              ...
              v119 = 2112;
              v120 = v31;
              _os_log_impl(&dword_229538000, v43, OS_LOG_TYPE_ERROR, "%{public}@%@ Received nil asset ID even though status is OnLocalStorage, Error:%@", buf, 0x20u);
          ...
          if (os_log_type_enabled(v42, OS_LOG_TYPE_INFO))
          {
            ...
            *buf = 138543874;
            ...
            v119 = 2112;
            v120 = v44;
            _os_log_impl(&dword_229538000, v43, OS_LOG_TYPE_INFO, "%{public}@%@ A software image is available for accessory with asset = %@", buf, 0x20u);
...
LABEL_32:
          ...
          if (os_log_type_enabled(v49, OS_LOG_TYPE_INFO))
          {
            ...
            *buf = 138543874;
            ...
            v119 = 2112;
            v120 = v53;
            _os_log_impl(&dword_229538000, v49, OS_LOG_TYPE_INFO, "%{public}@Accessory software version: %@. Software update version: %@", buf, 0x20u);
...
LABEL_40:
              v109 = 1;
              _os_log_impl(&dword_229538000, v58, OS_LOG_TYPE_INFO, v61, buf, 0x16u);
            ...
            if (v63 != 5)
            {
              if (v64)
              {
                ...
                *buf = 138543618;
                ...
                v117 = 2112;
                v118 = v68;
                _os_log_impl(&dword_229538000, v58, OS_LOG_TYPE_INFO, "%{public}@%@ User consent pending.", buf, 0x16u);
              }
...
LABEL_46:
              ...
              if (v70 <= v72)
              {
                ...
                if (os_log_type_enabled(v90, OS_LOG_TYPE_ERROR))
                {
                  ...
                  *buf = 138544130;
                  ...
                  v121 = 2112;
                  v122 = v94;
                  _os_log_impl(&dword_229538000, v90, OS_LOG_TYPE_ERROR, "%{public}@%@ Accessory software version (%@) is already at latest available version (%@).", buf, 0x2Au);
                ...
                [*(a1 + 32) manageNonBusyAvailableImageResponses:v4 normalStatus:&unk_283E74D68 error:0 completionHandler:*(a1 + 56)];
                goto LABEL_56;
              }
              ...
              if ((v109 & 1) == 0)
              {
                ...
                if ((v75 & 1) == 0)
                {
                  if (*(a1 + 64) == 1)
                  {
                    ...
                    if (os_log_type_enabled(v100, OS_LOG_TYPE_INFO))
                    {
                      ...
                      *buf = 138543618;
                      ...
                      v117 = 2112;
                      v118 = v102;
                      _os_log_impl(&dword_229538000, v100, OS_LOG_TYPE_INFO, "%{public}@%@ User has not consented to firmware update and requestor cannot consent.", buf, 0x16u);
                    }
                  ...
                  {
                    v103 = *(a1 + 56);
                    v104 = [*(a1 + 32) _queryImageResponseWithStatus:&unk_283E74D80 delayedActionTime:0];
                    (*(v103 + 16))(v103, v104, 0);
                  }
                ...
                if (os_log_type_enabled(v78, OS_LOG_TYPE_INFO))
                {
                  ...
                  *buf = 138543618;
                  ...
                  v117 = 2112;
                  v118 = v80;
                  _os_log_impl(&dword_229538000, v78, OS_LOG_TYPE_INFO, "%{public}@%@ User has not consented yet but requestor can consent. Delegating consent to requestor", buf, 0x16u);
                }
              ...
              [v32 assetVersion];
              v84 = v110 = v32;
              [&unk_283E74D50 unsignedIntValue];
              v85 = HMFRandomDataWithLength();
              v86 = [MEMORY[0x277CCABB0] numberWithBool:v73 ^ 1u];
              v87 = [v105 initWithStatus:&unk_283E74D80 delayedActionTime:&unk_283E75FA8 imageURI:v82 softwareVersion:v83 softwareVersionString:v84 updateToken:v85 userConsentNeeded:v86 metadataForRequestor:0];
              (*(v81 + 16))(v81, v87, 0);
...
LABEL_20:
            ...
            v37 = v31;
LABEL_27:
            [v34 manageNonBusyAvailableImageResponses:v36 normalStatus:&unk_283E74D68 error:v37 completionHandler:v35];
LABEL_57:
...
LABEL_58:
    ...
    if (os_log_type_enabled(v20, OS_LOG_TYPE_ERROR))
    {
      ...
      *buf = 138543362;
      v116 = v21;
      _os_log_impl(&dword_229538000, v20, OS_LOG_TYPE_ERROR, "%{public}@Unexpected, firmware update manager not found", buf, 0xCu);
    }

    objc_autoreleasePoolPop(v18);
    v22 = *(a1 + 32);
    v23 = [MEMORY[0x277CCA9B8] hmfErrorWithCode:2];
    [v22 manageNonBusyAvailableImageResponses:v4 normalStatus:&unk_283E74D68 error:v23 completionHandler:*(a1 + 56)];
  ...
  else
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
    {
      ...
      *buf = 138543618;
      ...
      v117 = 2112;
      v118 = v16;
      _os_log_impl(&dword_229538000, v14, OS_LOG_TYPE_ERROR, "%{public}@Cannot proceed with software update. Accessory not found for pairing : %@", buf, 0x16u);
    }

    objc_autoreleasePoolPop(v12);
    v17 = *(a1 + 56);
    v4 = [*(a1 + 32) _queryImageResponseWithStatus:&unk_283E74D68 delayedActionTime:0];
  ...
  else
  {
    ...
    if (os_log_type_enabled(v18, OS_LOG_TYPE_INFO))
    {
      ...
      *buf = 138544130;
      ...
      v31 = 2112;
      v32 = stringValue;
      _os_log_impl(&dword_229538000, v18, OS_LOG_TYPE_INFO, "%{public}@%@ Firmware version from uarpAccessory (%@) doesn't match accessory version (%@)", buf, 0x2Au);
...
- (void)resetImageResponseCounters:(id)counters
{
  ...
  if (countersCopy)
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
    {
      ...
      _os_log_impl(&dword_229538000, v7, OS_LOG_TYPE_INFO, "%{public}@%@ Sending Available status response, reset all other responses counters", &v11, 0x16u);
    }
...
- (void)manageBusyImageResponses:(id)responses completionHandler:(id)handler
{
  ...
  if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
  {
    ...
    v22 = 2048;
    v23 = v9;
    _os_log_impl(&dword_229538000, v12, OS_LOG_TYPE_INFO, "%{public}@%@ Sending BUSY status response with %.0f seconds delay", &v18, 0x20u);
  }

  objc_autoreleasePoolPop(v10);
  v15 = [MEMORY[0x277CCABB0] numberWithDouble:v9];
  v16 = [(HMDMatterSoftwareUpdateProviderDelegate *)selfCopy _queryImageResponseWithStatus:&unk_283E74D98 delayedActionTime:v15];
...
- (void)manageNonBusyAvailableImageResponses:(id)responses normalStatus:(id)status error:(id)error completionHandler:(id)handler
{
  ...
  if (!responsesCopy)
  {
    ...
    if (os_log_type_enabled(v23, OS_LOG_TYPE_INFO))
    {
      ...
      v27 = 138543362;
      v28 = v24;
      _os_log_impl(&dword_229538000, v23, OS_LOG_TYPE_INFO, "%{public}@AccessoryServer is nil, responding with original status without rate-limiting", &v27, 0xCu);
    }
...
LABEL_9:
  ...
  if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
  {
    ...
    _os_log_impl(&dword_229538000, v16, OS_LOG_TYPE_INFO, "%{public}@%@ Sending BUSY status response with %0.f delay due to request rate exceeding threshold", &v27, 0x20u);
  }
...
void __111__HMDMatterSoftwareUpdateProviderDelegate_notifyCheckFirmwareUpdateSessionWithPairing_queue_completionHandler___block_invoke(uint64_t a1)
{
  ...
  if (!v2)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      v22 = 2112;
      v23 = v11;
      _os_log_impl(&dword_229538000, v9, OS_LOG_TYPE_ERROR, "%{public}@Accessory not found for pairing : %@", &v20, 0x16u);
    }
...
LABEL_7:
  ...
  if (os_log_type_enabled(v15, OS_LOG_TYPE_ERROR))
  {
    ...
    v20 = 138543362;
    v21 = v16;
    _os_log_impl(&dword_229538000, v15, OS_LOG_TYPE_ERROR, "%{public}@Unexpected, firmware update manager not found", &v20, 0xCu);
  }
...
void __98__HMDMatterSoftwareUpdateProviderDelegate_notifyUpdateWithPairing_params_queue_completionHandler___block_invoke(uint64_t a1)
{
  ...
  if (!v2)
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_ERROR))
    {
      ...
      v39 = 2112;
      v40 = v17;
      _os_log_impl(&dword_229538000, v15, OS_LOG_TYPE_ERROR, "%{public}@Accessory not found for pairing : %@", &v37, 0x16u);
    }
  ...
  if (([v2 supportsCHIP] & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v23, OS_LOG_TYPE_ERROR))
    {
      ...
      v39 = 2112;
      v40 = v25;
      _os_log_impl(&dword_229538000, v23, OS_LOG_TYPE_ERROR, "%{public}@%@ Accessory has updated software image, but Accessory does not support Matter", &v37, 0x16u);
    }
...
LABEL_13:
  ...
  v4 = [*(a1 + 48) didTimeout];
  v5 = [v4 isEqualToNumber:&unk_283E74D98];
  ...
  if (v5)
  {
    if (os_log_type_enabled(v8, OS_LOG_TYPE_ERROR))
    {
      ...
      v39 = 2112;
      v40 = v11;
      _os_log_impl(&dword_229538000, v9, OS_LOG_TYPE_ERROR, "%{public}@%@ Accessory update timed out", &v37, 0x16u);
    }
  ...
  else
  {
    if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
    {
      ...
      v41 = 2112;
      v42 = v28;
      _os_log_impl(&dword_229538000, v9, OS_LOG_TYPE_INFO, "%{public}@%@ Accessory has updated software image. New version: %@", &v37, 0x20u);
    }
...
void __104__HMDMatterSoftwareUpdateProviderDelegate_applyUpdateWithPairing_requestParams_queue_completionHandler___block_invoke(uint64_t a1)
{
  ...
  if (v2)
  {
    if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
    {
      ...
      v18 = 2112;
      v19 = v8;
      _os_log_impl(&dword_229538000, v6, OS_LOG_TYPE_INFO, "%{public}@%@ Inform accessory to proceed with applying the software image", &v16, 0x16u);
    }

    objc_autoreleasePoolPop(v3);
    v9 = *(a1 + 48);
    v10 = [objc_alloc(MEMORY[0x277D17B78]) initWithAction:&unk_283E74D80 delayedActionTime:&unk_283E75FA8];
    (*(v9 + 16))(v9, v10, 0);
  }
  ...
  else
  {
    if (os_log_type_enabled(v5, OS_LOG_TYPE_ERROR))
    {
      ...
      v18 = 2112;
      v19 = v12;
      _os_log_impl(&dword_229538000, v6, OS_LOG_TYPE_ERROR, "%{public}@Accessory should not proceed with applying the software image. Accessory not found for pairing : %@", &v16, 0x16u);
    }

    objc_autoreleasePoolPop(v3);
    v13 = *(a1 + 48);
    v10 = [objc_alloc(MEMORY[0x277D17B78]) initWithAction:&unk_283E74D68 delayedActionTime:&unk_283E75FA8];
...
- (void)configureWithSoftwareUpdateProvider:(id)provider
{
  ...
  if (isMatterAccessorySoftwareUpdateEnabled)
  {
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      v14 = 138543362;
      v15 = v11;
      _os_log_impl(&dword_229538000, v10, OS_LOG_TYPE_INFO, "%{public}@Configuring with matter software update provider", &v14, 0xCu);
    }
  ...
  else
  {
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      _os_log_impl(&dword_229538000, v10, OS_LOG_TYPE_ERROR, "%{public}@%s: Matter Accessory Software Update not enabled.", &v14, 0x16u);
    }
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t36_244311 != -1)
  {
    dispatch_once(&logCategory__hmf_once_t36_244311, &__block_literal_global_244312);
  }

  v3 = logCategory__hmf_once_v37_244313;
...
void __54__HMDMatterSoftwareUpdateProviderDelegate_logCategory__block_invoke()
{
  ...
  v2 = logCategory__hmf_once_v37_244313;
  logCategory__hmf_once_v37_244313 = v1;
}
