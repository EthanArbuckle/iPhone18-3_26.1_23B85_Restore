...
- (void)_handleRemoteAnalysisStateUpdate:(id)a3
{
  ...
  if (v8)
  {
    if (os_log_type_enabled(v11, OS_LOG_TYPE_INFO))
    {
      ...
      v20 = 2112;
      v21 = v8;
      _os_log_impl(&dword_229538000, v12, OS_LOG_TYPE_INFO, "%{public}@Handling remote state update: %@", &v18, 0x16u);
    }
  ...
  else
  {
    if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
    {
      ...
      v20 = 2112;
      v21 = v16;
      _os_log_impl(&dword_229538000, v12, OS_LOG_TYPE_ERROR, "%{public}@Received nil analysis state update from message with identifier: %@", &v18, 0x16u);
    }
...
void __62__HMDCameraAnalysisStatePublisher__publishAnalysisStateUpdate__block_invoke(uint64_t a1, void *a2)
{
  ...
  if (([v4 isCurrentDevice] & 1) == 0)
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
    {
      ...
      v20 = 2112;
      v21 = v9;
      _os_log_impl(&dword_229538000, v7, OS_LOG_TYPE_INFO, "%{public}@Sending state update to %@", &v18, 0x16u);
    }
...
void __46__HMDCameraAnalysisStatePublisher_logCategory__block_invoke()
{
  ...
  v2 = logCategory__hmf_once_v7_47448;
  logCategory__hmf_once_v7_47448 = v1;
}
