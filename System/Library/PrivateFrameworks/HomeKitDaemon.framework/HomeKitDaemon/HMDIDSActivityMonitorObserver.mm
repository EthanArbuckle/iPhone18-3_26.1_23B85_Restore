...
- (void)startObservingPresenceForDevice:(id)device
{
  ...
  if (!dataSource)
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_ERROR))
    {
      ...
      v12 = 138543362;
      v13 = v9;
      _os_log_impl(&dword_229538000, v8, OS_LOG_TYPE_ERROR, "%{public}@startObservingPresenceForDevice: called before configureWithDataSource:", &v12, 0xCu);
    }
...
void __44__HMDIDSActivityMonitorObserver_logCategory__block_invoke()
{
  ...
  v2 = logCategory__hmf_once_v18_206263;
  logCategory__hmf_once_v18_206263 = v1;
}
