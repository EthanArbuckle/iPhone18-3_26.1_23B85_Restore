...
- (id)_filterModificationRequestsForPrivilege:(id)a3 flow:(id)a4;
...
- (void)_submitAccessCodeModificationRequestsForMessage:(id)a3
{
  ...
  if (v18 && ![v18 hmf_isEmpty])
  {
    ...
    if ([v25 isAdministrator] & 1) != 0 || (-[objc_class allModificationRequests:areAddingAccessCode:](-[HMDAccessCodeManager utilities](v9, "utilities"), "allModificationRequests:areAddingAccessCode:", v18, v30))
    {
      ...
      v32 = [(HMDAccessCodeManager *)v9 _filterModificationRequestsForPrivilege:v31 flow:v7];

      v33 = [(HMDAccessCodeManager *)v9 accessoryReaderWriter];
      v34 = [v33 performAccessCodeModificationRequests:v32 withRetries:1 flow:v7];
...
- (void)configureWithMessageDispatcher:(id)a3
{
  ...
  v18 = [HMDUserMessagePolicy userMessagePolicyWithHome:v9 userPrivilege:5 remoteAccessRequired:0];
