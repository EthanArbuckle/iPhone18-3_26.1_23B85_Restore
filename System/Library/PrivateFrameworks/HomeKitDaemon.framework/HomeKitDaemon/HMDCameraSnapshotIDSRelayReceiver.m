...
- (void)sessionEnded:(id)a3 withReason:(unsigned int)a4 error:(id)a5
{
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
  {
    ...
    v23 = 2114;
    v24 = v9;
    _os_log_impl(&dword_229538000, v13, OS_LOG_TYPE_INFO, "%{public}@Session %{public}@ has ended with reason: %{public}u and error: %{public}@", &v17, 0x26u);
  }
...
LABEL_21:
      _os_log_impl(&dword_229538000, v55, v56, v54, buf, 0x16u);
    }
        ...
        if (v31)
        {
          ...
          if (os_log_type_enabled(v34, OS_LOG_TYPE_INFO))
          {
            ...
            *buf = 138543874;
            ...
            v89 = 2112;
            v90 = v15;
            _os_log_impl(&dword_229538000, v35, OS_LOG_TYPE_INFO, "%{public}@Received invitation for session %@ from %@", buf, 0x20u);
          ...
          if (os_log_type_enabled(v47, OS_LOG_TYPE_INFO))
          {
            ...
            *buf = 138543362;
            v86 = v48;
            _os_log_impl(&dword_229538000, v47, OS_LOG_TYPE_INFO, "%{public}@Accepted invitation", buf, 0xCu);
          }
        ...
        else
        {
          ...
          if (os_log_type_enabled(v34, OS_LOG_TYPE_DEBUG))
          {
            ...
            *buf = 138543618;
            ...
            v87 = 2112;
            v88 = context;
            _os_log_impl(&dword_229538000, v35, OS_LOG_TYPE_DEBUG, "%{public}@Ignoring invitation for camera session ID: %@", buf, 0x16u);
      ...
      else
      {
        ...
        if (os_log_type_enabled(v68, OS_LOG_TYPE_ERROR))
        {
          ...
          *buf = 138543618;
          ...
          v87 = 2112;
          v88 = v24;
          _os_log_impl(&dword_229538000, v68, OS_LOG_TYPE_ERROR, "%{public}@Could not find camera session ID in payload: %@", buf, 0x16u);
    ...
    else
    {
      ...
      if (os_log_type_enabled(v62, OS_LOG_TYPE_ERROR))
      {
        ...
        *buf = 138543874;
        ...
        v90 = v64;
        v65 = v64;
        _os_log_impl(&dword_229538000, v62, OS_LOG_TYPE_ERROR, "%{public}@Unarchived payload was not an NSDictionary: %@ (%@)", buf, 0x20u);
  ...
  else
  {
    ...
    if (os_log_type_enabled(v59, OS_LOG_TYPE_ERROR))
    {
      ...
      *buf = 138543618;
      ...
      v87 = 2112;
      v88 = v81;
      _os_log_impl(&dword_229538000, v59, OS_LOG_TYPE_ERROR, "%{public}@Failed to unarchive payload from context data: %@", buf, 0x16u);
...
- (void)dealloc
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    *buf = 138543362;
    v13 = v6;
    _os_log_impl(&dword_229538000, v5, OS_LOG_TYPE_INFO, "%{public}@Resetting the HMDCameraSnapshotIDSRelayReceiver", buf, 0xCu);
  }
...
- (void)_handleDataFromSocket:(id)a3
{
  ...
  if (!v6)
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
    {
      ...
      v41 = 138543362;
      v42 = v16;
      _os_log_impl(&dword_229538000, v15, OS_LOG_TYPE_INFO, "%{public}@Socket source is already nil, rejecting the data from socket", &v41, 0xCu);
LABEL_20:
    }
  ...
  if (![(HMDCameraSnapshotIDSRelayReceiver *)self expectedByteCount])
  {
    ...
    if (v18 > 7)
    {
      ...
      if (os_log_type_enabled(v22, OS_LOG_TYPE_INFO))
      {
        ...
        _os_log_impl(&dword_229538000, v22, OS_LOG_TYPE_INFO, "%{public}@Setting expected byte count to %llu", &v41, 0x16u);
      }
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
    {
      ...
      v43 = 2048;
      v44 = [v39 length];
      _os_log_impl(&dword_229538000, v15, OS_LOG_TYPE_INFO, "%{public}@Only received %lu bytes that represent the expected byte count so far; will wait for more", &v41, 0x16u);
...
LABEL_12:
  ...
  if (os_log_type_enabled(v28, OS_LOG_TYPE_INFO))
  {
    ...
    v45 = 2112;
    v46 = v31;
    _os_log_impl(&dword_229538000, v28, OS_LOG_TYPE_INFO, "%{public}@Updating received byte count from %@ to %@", &v41, 0x20u);
  }
  ...
  if (v32 == [(HMDCameraSnapshotIDSRelayReceiver *)v27 expectedByteCount])
  {
    ...
    if (os_log_type_enabled(v35, OS_LOG_TYPE_INFO))
    {
      ...
      v41 = 138543362;
      v42 = v36;
      _os_log_impl(&dword_229538000, v35, OS_LOG_TYPE_INFO, "%{public}@All the bytes have been received, file transfer is complete", &v41, 0xCu);
    }
...
void __54__HMDCameraSnapshotIDSRelayReceiver__startDataReceive__block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    *buf = 138543618;
    ...
    v17 = 2048;
    v18 = v3;
    _os_log_impl(&dword_229538000, v6, OS_LOG_TYPE_INFO, "%{public}@Received data of length %ld", buf, 0x16u);
  }
  ...
  if (v3)
  {
    if (v3 < 1)
    {
      ...
      if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
      {
        ...
        *buf = 138543362;
        v16 = v12;
        _os_log_impl(&dword_229538000, v11, OS_LOG_TYPE_ERROR, "%{public}@Recv from socket returned error, aborting the file receive", buf, 0xCu);
      }
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t0_257520 != -1)
  {
    dispatch_once(&logCategory__hmf_once_t0_257520, &__block_literal_global_257521);
  }

  v3 = logCategory__hmf_once_v1_257522;
...
void __48__HMDCameraSnapshotIDSRelayReceiver_logCategory__block_invoke()
{
  ...
  v2 = logCategory__hmf_once_v1_257522;
  logCategory__hmf_once_v1_257522 = v1;
}
