...
- (void)encodeWithCoder:(id)a3
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
    {
      ...
      v17 = 138543362;
      v18 = v15;
      _os_log_impl(&dword_229538000, v14, OS_LOG_TYPE_ERROR, "%{public}@Did not encode setting as transport is not XPC.", &v17, 0xCu);
    }
            ...
            if (!v22)
            {
              ...
              if (os_log_type_enabled(v66, OS_LOG_TYPE_DEFAULT))
              {
                ...
                *v109 = 138543618;
                ...
                v111 = 2112;
                v112 = v69;
                _os_log_impl(&dword_229538000, v66, OS_LOG_TYPE_DEFAULT, "%{public}@Value is nil but have step value constraint: %@", v109, 0x16u);
              ...
              if (v41 < v42 + -0.00000011920929)
              {
                ...
                if (os_log_type_enabled(v88, OS_LOG_TYPE_DEFAULT))
                {
                  ...
                  *v109 = 138544130;
                  ...
                  v115 = 2112;
                  v116 = v100;
                  _os_log_impl(&dword_229538000, v88, OS_LOG_TYPE_DEFAULT, "%{public}@Value, %@, does not conform to step, %@, from current value: %@", v109, 0x2Au);
          ...
          if ([v22 compare:v33] == 1)
          {
            ...
            if (os_log_type_enabled(v78, OS_LOG_TYPE_DEFAULT))
            {
              ...
              *v109 = 138543874;
              ...
              v113 = 2112;
              v114 = v33;
              _os_log_impl(&dword_229538000, v78, OS_LOG_TYPE_DEFAULT, "%{public}@Value, %@, more than maximum value: %@", v109, 0x20u);
...
LABEL_48:
              _os_log_impl(&dword_229538000, v49, OS_LOG_TYPE_DEFAULT, v50, v109, 0x16u);
...
LABEL_79:
              _os_log_impl(&dword_229538000, v72, OS_LOG_TYPE_DEFAULT, v74, v109, 0x20u);
            }
          ...
          if ([v22 compare:v30] == -1)
          {
            ...
            if (os_log_type_enabled(v84, OS_LOG_TYPE_DEFAULT))
            {
              ...
              *v109 = 138543874;
              ...
              v113 = 2112;
              v114 = v30;
              _os_log_impl(&dword_229538000, v84, OS_LOG_TYPE_DEFAULT, "%{public}@Value, %@, less than minimum value: %@", v109, 0x20u);
        ...
        default:
          ...
          if (os_log_type_enabled(v61, OS_LOG_TYPE_ERROR))
          {
            ...
            *v109 = 138543618;
            ...
            v111 = 2112;
            v112 = v22;
            _os_log_impl(&dword_229538000, v61, OS_LOG_TYPE_ERROR, "%{public}@Did not understand value %@", v109, 0x16u);
...
- (BOOL)updateWithSettingValue:(id)a3
{
  ...
  if (![(HMDSetting *)self isValidValue:v4 error:0])
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
    {
      ...
      v20 = 2112;
      v21 = v4;
      _os_log_impl(&dword_229538000, v14, OS_LOG_TYPE_ERROR, "%{public}@Received value is not valid %@", &v18, 0x16u);
    }
...
LABEL_9:
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v24 = 2112;
    v25 = v4;
    _os_log_impl(&dword_229538000, v7, OS_LOG_TYPE_INFO, "%{public}@Updating setting %@ in transaction from %@ to %@", &v18, 0x2Au);
  }
...
LABEL_8:
    ...
    if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
    {
      ...
      v21 = 2112;
      v22 = v4;
      _os_log_impl(&dword_229538000, v12, OS_LOG_TYPE_ERROR, "%{public}@Unable to determine type of setting value for model %@ of type %@.", &v17, 0x20u);
    }
