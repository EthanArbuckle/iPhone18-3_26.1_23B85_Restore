...
- (void)_handleTakeRemoteSnapshotFailureMessage:(id)a3
{
  ...
  if (v8)
  {
    ...
    if (v9)
    {
      ...
      if ([v11 conformsToProtocol:&unk_283F27458])
      {
        v12 = v11;
      }
...
- (void)_handleRemoteSnapshotReceivedMessage:(id)a3
{
  ...
  if (v8)
  {
    ...
    if (v9)
    {
      v10 = v9;
      v11 = [v9 snapshotGetter];
      v12 = [v11 conformsToProtocol:&unk_283EB51D0];
...
- (void)registerForMessages
{
  ...
  v9 = [v5 featuresDataSource];
  v10 = [v9 isMessageBindingsEnabled];

  if ((v10 & 1) == 0)
  {
    v11 = [HMDUserMessagePolicy userMessagePolicyWithHome:v5 userPrivilege:0 remoteAccessRequired:1 requiresCameraStreamingAccess:1];
...
+ (id)logCategory
{
  ...
  {
    dispatch_once(&logCategory__hmf_once_t77, &__block_literal_global_112_159069);
  }
...
+ (void)cleanStaleSnapshotDirectoriesUsingCurrentAccessories:(id)a3
{
  ...
  v30 = v3;
  v5 = [v3 na_map:&__block_literal_global_159076];
        ...
        if (([v6 containsObject:v14] & 1) == 0)
        {
          ...
          else if (os_log_type_enabled(v22, OS_LOG_TYPE_ERROR))
          {
            ...
            *buf = 138543874;
            ...
            v28 = 32;
LABEL_12:
            _os_log_impl(&dword_229538000, v25, v26, v27, buf, v28);
          }
