...
- (id)personManagerWithUUID:(id)d
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v13, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *buf = 138543362;
      v22 = v14;
      _os_log_impl(&dword_229538000, v13, OS_LOG_TYPE_DEFAULT, "%{public}@Returning nil because home reference is nil", buf, 0xCu);
    }
              ...
              else
              {
                ...
                if (os_log_type_enabled(v42, OS_LOG_TYPE_DEFAULT))
                {
                  ...
                  *buf = 138543618;
                  ...
                  v74 = 2112;
                  v75 = v8;
                  _os_log_impl(&dword_229538000, v42, OS_LOG_TYPE_DEFAULT, "%{public}@Could not determine face classification for significant event face classification: %@", buf, 0x16u);
                }
...
LABEL_43:
    ...
    v55 = ;
    classificationsCopy = v59;
    v56 = [array sortedArrayUsingComparator:&__block_literal_global_133958];
    [v55 addObjectsFromArray:v56];
    [v55 sortWithOptions:16 usingComparator:&__block_literal_global_4_133959];
...
LABEL_47:
  ...
  else
  {
    ...
    if (os_log_type_enabled(v46, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *buf = 138543362;
      v73 = v47;
      _os_log_impl(&dword_229538000, v46, OS_LOG_TYPE_DEFAULT, "%{public}@Not returning a face classification because home reference is nil", buf, 0xCu);
    }
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t3_133969 != -1)
  {
    dispatch_once(&logCategory__hmf_once_t3_133969, &__block_literal_global_8_133970);
  }

  v3 = logCategory__hmf_once_v4_133971;
...
void __66__HMDCameraSignificantEventFaceClassificationResolver_logCategory__block_invoke()
{
  ...
  v2 = logCategory__hmf_once_v4_133971;
  logCategory__hmf_once_v4_133971 = v1;
}
