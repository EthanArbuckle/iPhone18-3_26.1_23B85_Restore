...
- (id)connectionForEndpointUUID:(id)d
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_ERROR))
  {
    ...
    v11 = 138543362;
    v12 = v8;
    _os_log_impl(&dword_229538000, v7, OS_LOG_TYPE_ERROR, "%{public}@Device does not support siri endpoint history deletion", &v11, 0xCu);
  }
...
+ (id)logCategory
{
  ...
  {
    dispatch_once(&logCategory__hmf_once_t6, &__block_literal_global_43160);
  }
...
void __45__HMDAssistantSettingsConnection_logCategory__block_invoke()
{
  ...
  v2 = logCategory__hmf_once_v7;
  logCategory__hmf_once_v7 = v1;
}
