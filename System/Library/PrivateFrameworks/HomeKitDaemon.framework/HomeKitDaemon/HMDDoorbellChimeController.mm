...
- (unint64_t)_numHomePodsWithDoorbellChimeEnabled
{
  ...
  v4 = [v3 home];
  v5 = [v4 accessories];
  v6 = [v5 na_map:&__block_literal_global_39_147918];
...
LABEL_6:
      ...
      else if (v29)
      {
        ...
        if (os_log_type_enabled(v74, OS_LOG_TYPE_INFO))
        {
          ...
          *buf = 138543362;
          v95 = v75;
          _os_log_impl(&dword_229538000, v74, OS_LOG_TYPE_INFO, "%{public}@Fetching significant events from the cloud because no person identification text was found", buf, 0xCu);
        }
...
uint64_t __103__HMDDoorbellChimeController__notifyAllAccessoriesForDoorbellPressAndPlayChimeSound_significantEvents___block_invoke_2(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
  {
    ...
    v8 = 138543362;
    v9 = v5;
    _os_log_impl(&dword_229538000, v4, OS_LOG_TYPE_INFO, "%{public}@Attempting to announce any persons without re-playing chime after finished fetching significant events from the cloud", &v8, 0xCu);
  }
...
void __41__HMDDoorbellChimeController_logCategory__block_invoke()
{
  ...
  v2 = logCategory__hmf_once_v15_147971;
  logCategory__hmf_once_v15_147971 = v1;
}
