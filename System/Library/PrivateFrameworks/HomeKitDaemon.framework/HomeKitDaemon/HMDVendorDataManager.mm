...
- (void)timerDidFire:(id)a3
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_DEBUG))
  {
    ...
    _os_log_impl(&dword_229538000, v8, OS_LOG_TYPE_DEBUG, "%{public}@Timer fired after %.0lf sec", &v11, 0x16u);
  }
...
- (id)_parseVendorModelEntryForManufacturer:(id)a3 model:(id)a4 dictionary:(id)a5
{
  ...
  if (v16)
  {
    ...
    *&buf[8] = buf;
    *&buf[16] = 0x3032000000;
    v38 = __Block_byref_object_copy__191167;
    *v39 = __Block_byref_object_dispose__191168;
...
LABEL_14:
  ...
  if (v25 < [(HMDVendorDataManager *)v14 dataVersion])
  {
    ...
    if (os_log_type_enabled(v51, OS_LOG_TYPE_ERROR))
    {
      ...
      *buf = 138545922;
      ...
      v135 = 2112;
      v136 = v54;
      _os_log_impl(&dword_229538000, v51, OS_LOG_TYPE_ERROR, "%{public}@tag=%{public}@ desc=%@ %{public}@=%@ %{public}@=%@ %{public}@=%@ %{public}@=%@", buf, 0x70u);
    }
  ...
  if (v25 == v57)
  {
    if (os_log_type_enabled(v60, OS_LOG_TYPE_INFO))
    {
      ...
      *buf = 138545410;
      ...
      v131 = 2112;
      v132 = v63;
      _os_log_impl(&dword_229538000, v61, OS_LOG_TYPE_INFO, "%{public}@tag=%{public}@ desc=%@ %{public}@=%@ %{public}@=%@ %{public}@=%@", buf, 0x5Cu);
    }
  ...
  if (!v65)
  {
    ...
    if (os_log_type_enabled(v78, OS_LOG_TYPE_ERROR))
    {
      ...
      *buf = 138545410;
      ...
      v131 = 2112;
      v132 = v80;
      _os_log_impl(&dword_229538000, v78, OS_LOG_TYPE_ERROR, "%{public}@tag=%{public}@ desc=%@ %{public}@=%@ %{public}@=%@ %{public}@=%@", buf, 0x5Cu);
    }
  ...
  if (!v106)
  {
    if (os_log_type_enabled(v66, OS_LOG_TYPE_ERROR))
    {
      ...
      *buf = 138544898;
      ...
      v127 = 2112;
      v128 = MEMORY[0x277CBEC28];
      _os_log_impl(&dword_229538000, v67, OS_LOG_TYPE_ERROR, "%{public}@tag=%{public}@ desc=%@ %{public}@=%@ %{public}@=%@", buf, 0x48u);
    }
  ...
  if (os_log_type_enabled(v66, OS_LOG_TYPE_INFO))
  {
    ...
    *buf = 138545922;
    ...
    v135 = 2112;
    v136 = v101;
    _os_log_impl(&dword_229538000, v67, OS_LOG_TYPE_INFO, "%{public}@tag=%{public}@ desc=%@ %{public}@=%@ %{public}@=%@ %{public}@=%@ %{public}@=%@", buf, 0x70u);
  }
...
- (void)_handleServerResponse:(id)a3 withData:(id)a4 error:(id)a5
{
  ...
  if (v10)
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
    {
      ...
      v18 = 22;
LABEL_9:
      _os_log_impl(&dword_229538000, v17, OS_LOG_TYPE_ERROR, v16, &v27, v18);
...
LABEL_10:
  ...
  else
  {
    ...
    if (os_log_type_enabled(v25, OS_LOG_TYPE_ERROR))
    {
      ...
      v29 = 2048;
      v30 = v22;
      _os_log_impl(&dword_229538000, v25, OS_LOG_TYPE_ERROR, "%{public}@Received status code %ld from vendor info request", &v27, 0x16u);
    }
  ...
  if (([*(a1 + 32) _loadDatabaseFromFilePath:@"/var/mobile/Library/homed/vendor-database" fileDescription:@"cached"] & 1) == 0)
  {
    ...
    if ((v11 & 1) == 0)
    {
      ...
      if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
      {
        ...
        v17 = 138543362;
        v18 = v15;
        _os_log_impl(&dword_229538000, v14, OS_LOG_TYPE_ERROR, "%{public}@Failed to read any local database files", &v17, 0xCu);
      }
...
void __35__HMDVendorDataManager_logCategory__block_invoke()
{
  ...
  v2 = logCategory__hmf_once_v44_191343;
  logCategory__hmf_once_v44_191343 = v1;
}
