...
LABEL_4:
      ...
      if (os_log_type_enabled(v18, OS_LOG_TYPE_INFO))
      {
        ...
        *buf = 138543618;
        ...
        v29 = 2112;
        v30 = v14;
        _os_log_impl(&dword_229538000, v18, OS_LOG_TYPE_INFO, "%{public}@Sync queue delay timer fired, staging %@", buf, 0x16u);
      }
  ...
  if (operationCopy)
  {
    ...
    if ([(HMDSyncOperationQueue *)self hasExponentialBackoff])
    {
      ...
      if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
      {
        ...
        v26 = 2048;
        delayCopy = delay;
        _os_log_impl(&dword_229538000, v15, OS_LOG_TYPE_INFO, "%{public}@Current delay is %g", &v24, 0x16u);
      }
        ...
        if (v13)
        {
          ...
          if (!isDelayRespected)
          {
            if (v19)
            {
              ...
              *buf = 138543362;
              v142 = v35;
              _os_log_impl(&dword_229538000, v18, OS_LOG_TYPE_INFO, "%{public}@Dropping new operation, already have staged operation", buf, 0xCu);
            }
          ...
          if (v19)
          {
            ...
            *buf = 138543362;
            v142 = v20;
            _os_log_impl(&dword_229538000, v18, OS_LOG_TYPE_INFO, "%{public}@Dropping staged operation, new operation has longer delay that must be respected", buf, 0xCu);
          }
        ...
        if (v59)
        {
          ...
          if (os_log_type_enabled(v62, OS_LOG_TYPE_INFO))
          {
            ...
            *buf = 138543618;
            ...
            v143 = 2112;
            v144 = zoneName5;
            _os_log_impl(&dword_229538000, v62, OS_LOG_TYPE_INFO, "%{public}@Dropping scheduled operation, new operation being added directly to staged for %@", buf, 0x16u);
          }
          ...
          if (stagedOperations)
          {
            ...
            if (isDelayRespected2)
            {
              ...
              if (os_log_type_enabled(v69, OS_LOG_TYPE_INFO))
              {
                ...
                *buf = 138543362;
                v142 = v70;
                _os_log_impl(&dword_229538000, v69, OS_LOG_TYPE_INFO, "%{public}@Dropping new operation, found operation has delay that must respected", buf, 0xCu);
              }
...
LABEL_66:
          ...
          if (os_log_type_enabled(v96, OS_LOG_TYPE_INFO))
          {
            ...
            *buf = 138543618;
            ...
            v143 = 2112;
            v144 = operationCopy;
            _os_log_impl(&dword_229538000, v96, OS_LOG_TYPE_INFO, "%{public}@Schedule operation without delay %@", buf, 0x16u);
          }
...
LABEL_76:
              _os_log_impl(&dword_229538000, v48, OS_LOG_TYPE_INFO, v50, buf, 0xCu);
...
LABEL_88:
              _os_log_impl(&dword_229538000, v48, OS_LOG_TYPE_INFO, v76, buf, 0xCu);
...
LABEL_81:
  ...
  if (os_log_type_enabled(v116, OS_LOG_TYPE_INFO))
  {
    ...
    *buf = 138543874;
    ...
    v145 = 2112;
    v146 = zoneName8;
    _os_log_impl(&dword_229538000, v116, OS_LOG_TYPE_INFO, "%{public}@Schedule operation with delay %g: %@", buf, 0x20u);
  }
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t28_145769 != -1)
  {
    dispatch_once(&logCategory__hmf_once_t28_145769, &__block_literal_global_145770);
  }

  v3 = logCategory__hmf_once_v29_145771;
...
void __36__HMDSyncOperationQueue_logCategory__block_invoke()
{
  ...
  v2 = logCategory__hmf_once_v29_145771;
  logCategory__hmf_once_v29_145771 = v1;
}
