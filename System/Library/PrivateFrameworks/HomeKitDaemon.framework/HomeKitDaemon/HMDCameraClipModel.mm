...
+ (HMBModelInfiniteQuery)clipsBeforeDateQuery
{
  ...
  {
    dispatch_once(&clipsBeforeDateQuery_onceToken, &__block_literal_global_78_281170);
  }
...
+ (HMBModelInfiniteQuery)clipsWithNeedsUploadFeedbackStatusQuery
{
  ...
  {
    dispatch_once(&clipsWithNeedsUploadFeedbackStatusQuery_onceToken, &__block_literal_global_69_281175);
  }
...
+ (HMBModelInfiniteQuery)incompleteClipsQuery
{
  ...
  {
    dispatch_once(&incompleteClipsQuery_onceToken, &__block_literal_global_62_281189);
  }
...
+ (NSUUID)sentinelParentUUID
{
  if (sentinelParentUUID_onceToken_281201 != -1)
  {
    dispatch_once(&sentinelParentUUID_onceToken_281201, &__block_literal_global_56_281202);
  }

  v3 = sentinelParentUUID_sentinelParentUUID_281203;
...
void __40__HMDCameraClipModel_sentinelParentUUID__block_invoke()
{
  ...
  v1 = sentinelParentUUID_sentinelParentUUID_281203;
  sentinelParentUUID_sentinelParentUUID_281203 = v0;
}
...
+ (id)hmbProperties
{
  if (hmbProperties_onceToken_281213 != -1)
  {
    dispatch_once(&hmbProperties_onceToken_281213, &__block_literal_global_281214);
  }

  v3 = hmbProperties_properties_281215;
