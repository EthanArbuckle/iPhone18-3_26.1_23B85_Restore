...
LABEL_16:
  ...
  if (v24)
  {
    ...
    if ((v29 & 1) == 0)
    {
      ...
      [delegate accessCodeDataManager:v31 didUpdateHomeAccessCodes:v46 changedByUserUUID:0 flow:v71];
    }
  ...
  else
  {
    ...
    v69 = [v66 homeAccessCodeValueWithStringValue:value9 label:label5];
    v73 = v69;
    v70 = [MEMORY[0x277CBEA60] arrayWithObjects:&v73 count:1];
    [delegate accessCodeDataManager:v55 didAddHomeAccessCodes:v70 addedByUserUUID:0 flow:flowCopy];
  }
...
- (id)_setUserWithUUID:(id)d forAccessCodeValue:(id)value changedByUserUUID:(id)iD flow:(id)flow
{
  ...
  if (home)
  {
    ...
    v19 = dCopy;
    v50 = v19;
    v20 = [users na_firstObjectPassingTest:v49];
...
- (NSArray)homeAccessCodeValuesWithSimpleLabels
{
  ...
  if (home)
  {
    ...
    if (labelsByAccessCode)
    {
      ...
      v14[3] = &unk_278680A38;
      v15 = home;
      v7 = [labelsByAccessCode2 na_map:v14];
