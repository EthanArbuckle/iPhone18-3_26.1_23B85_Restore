...
- (void)timerDidFire:(id)fire
{
  ...
  if (v8 == fireCopy)
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
    {
      ...
      v14 = 138543362;
      v15 = v12;
      _os_log_impl(&dword_229538000, v11, OS_LOG_TYPE_ERROR, "%{public}@Read callback timer fired, closing bulk send session", &v14, 0xCu);
    }
...
- (void)_stopWithReason:(void *)reason
{
  ...
  if (reason)
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
    {
      ...
      v15 = 1024;
      v16 = a2;
      _os_log_impl(&dword_229538000, v7, OS_LOG_TYPE_INFO, "%{public}@Stopping bulk send session reader with reason: %d", &v13, 0x12u);
    }
...
- (void)start
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    v13 = 138543362;
    v14 = v6;
    _os_log_impl(&dword_229538000, v5, OS_LOG_TYPE_INFO, "%{public}@Starting bulk send session reader", &v13, 0xCu);
  }
...
LABEL_30:
      ...
      else
      {
        ...
        if (os_log_type_enabled(v57, OS_LOG_TYPE_INFO))
        {
          ...
          *buf = 138543362;
          v64 = v58;
          _os_log_impl(&dword_229538000, v57, OS_LOG_TYPE_INFO, "%{public}@Data processing marked the bulk send session as inactive", buf, 0xCu);
        }
...
void __54__HMDCameraRecordingBulkSendSessionReader_logCategory__block_invoke()
{
  ...
  v2 = logCategory__hmf_once_v9_180375;
  logCategory__hmf_once_v9_180375 = v1;
}
