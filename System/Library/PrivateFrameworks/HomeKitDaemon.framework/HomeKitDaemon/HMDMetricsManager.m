...
- (void)handleAddEphemeralContainer:(id)a3
{
  v4 = a3;
  v5 = self;
  sub_2298402E0(v4, MEMORY[0x277D17CE0]);
}
...
- (void)handleDeactivateEphemeralContainer:(id)a3
{
  v4 = a3;
  v5 = self;
  sub_2298402E0(v4, MEMORY[0x277D17CF0]);
}
...
- (void)handleDeleteEphemeralContainer:(id)a3
{
  v4 = a3;
  v5 = self;
  sub_2298402E0(v4, MEMORY[0x277D17CE8]);
}
...
- (BOOL)isCurrentDeviceConfirmedPrimaryResident
{
  v2 = [(HMDMetricsManager *)self homeManager];
  v3 = [v2 homes];
  v4 = [v3 na_any:&__block_literal_global_278_122591];
...
- (void)waitToCompleteCurrentlyQueuedTasks
{
  ...
  v2 = [v3 clientQueue];
  dispatch_sync(v2, &__block_literal_global_274_122595);
}
...
- (void)startAnalyzers
{
  ...
  if (isInternalBuild())
  {
    ...
    if (v18)
    {
      ...
      [v19 addObserver:v20 forProtocol:&unk_283E79538];
    }
  }
...
- (void)logEventAggregationAnalysisLogEvents
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v20 = 2114;
    v21 = v10;
    _os_log_impl(&dword_229538000, v7, OS_LOG_TYPE_INFO, "%{public}@Current state of aggregated event counts since last metric submission (reset every 24 hrs): %{public}@", &v18, 0x16u);
  }
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
  {
    ...
    v20 = 2114;
    v21 = v16;
    _os_log_impl(&dword_229538000, v13, OS_LOG_TYPE_INFO, "%{public}@Current state of aggregated error counts since last metric submission (reset every 24 hrs): %{public}@", &v18, 0x16u);
  }
...
- (void)submitResidentSelectionDenominatorEvents
{
  v33 = *MEMORY[0x277D85DE8];
  v3 = [(HMDMetricsManager *)self logEventDispatcher];
  v4 = [MEMORY[0x277D17478] denominatorEvent];
  [v3 submitLogEvent:v4];

  v5 = [(HMDMetricsManager *)self logEventDispatcher];
  v6 = [MEMORY[0x277D17480] denominatorEvent];
  ...
  if (v9)
  {
    ...
    do
    {
      for (i = 0; i != v10; ++i)
      {
        ...
        {
          v14 = [(HMDMetricsManager *)self logEventDispatcher];
          v15 = [v13 uuid];
          v16 = [v13 residentDeviceManager];
          v17 = +[HMDResidentSelectionPrimaryResidentChangedLogEvent denominatorEvent:residentSelectionMode:](HMDResidentSelectionPrimaryResidentChangedLogEvent, "denominatorEvent:residentSelectionMode:", v15, [v16 residentSelectionMode]);
          [v14 submitLogEvent:v17];

          v18 = [(HMDMetricsManager *)self logEventDispatcher];
          v19 = [v13 uuid];
          v20 = [HMDResidentStatusChannelPublishLogEvent denominatorEvent:v19];
          [v18 submitLogEvent:v20];

          v21 = [(HMDMetricsManager *)self logEventDispatcher];
          v22 = [MEMORY[0x277D17488] denominatorEvent];
          [v21 submitLogEvent:v22];
        }

        v23 = [(HMDMetricsManager *)self logEventDispatcher];
        v24 = [v13 uuid];
        v25 = [HMDResidentStatusChannelObserveLogEvent denominatorEvent:v24];
...
- (void)start
{
  ...
  if ([(HMDMetricsManager *)self hasStarted])
  {
    ...
    if (os_log_type_enabled(v5, OS_LOG_TYPE_ERROR))
    {
      ...
      v21 = 138543362;
      v22 = v6;
      _os_log_impl(&dword_229538000, v5, OS_LOG_TYPE_ERROR, "%{public}@Metrics collection already started", &v21, 0xCu);
    }
  ...
  else
  {
    ...
    [v9 addObserver:v10 forProtocol:&unk_283E797A8];
...
- (void)_configureManagers
{
  ...
  v6 = [(HMDMetricsManager *)self legacyCountersManager];
  v7 = [(HMDMetricsHomeDataChangedManager *)v5 initWithCountersManager:v6 currentHomeDataSource:self dateProvider:self->_dateProvider];
  ...
  v9 = [(HMDMetricsManager *)self configureHouseholdLogEventFactories];
  householdLogEventFactories = self->_householdLogEventFactories;
  self->_householdLogEventFactories = v9;

  v11 = [HMDHouseholdMetricsManager alloc];
  v12 = [(HMDMetricsManager *)self legacyCountersManager];
  v13 = [(HMDMetricsManager *)self accessoryDetailsManager];
  v14 = [(HMDMetricsManager *)self metricsHomeDataChangedManager];
  v15 = [(HMDMetricsManager *)self dailyScheduler];
  v16 = [(HMDMetricsManager *)self logEventDispatcher];
  dateProvider = self->_dateProvider;
  v22[0] = self->_userActivityEventsAnalyzer;
  v18 = [MEMORY[0x277CBEA60] arrayWithObjects:v22 count:1];
  v19 = [(HMDHouseholdMetricsManager *)v11 initWithCountersManager:v12 dataSource:self accessoryDetailsManager:v13 metricsHomeDataChangedManager:v14 dailyScheduler:v15 logEventSubmitter:v16 dateProvider:dateProvider activityContributors:v18 logEventFactories:self->_householdLogEventFactories];
...
- (void)addContributor:(id)a3 toListOfAggregationAnalysisEventContributing:(id)a4
{
  v6 = a3;
  v5 = a4;
  if ([v6 conformsToProtocol:&unk_283EC9580])
  {
    [v5 addObject:v6];
  }
}
...
- (void)_configureObservers
{
  ...
  v66[0] = v5;
  v6 = [MEMORY[0x277CBEA60] arrayWithObjects:v66 count:1];
  ...
  v62 = [v61 isUserActivityStateDetectionFeatureEnabled];
...
- (HMDMetricsManager)initWithMessageDispatcher:(id)a3 accountManager:(id)a4 notificationSettingsProvider:(id)a5 logEventDispatcher:(id)a6 dailyScheduler:(id)a7 dateProvider:(id)a8 uptimeProvider:(id)a9 legacyCountersManager:(id)a10 flagsManager:(id)a11 ewsLogger:(id)a12 deviceStateManager:(id)a13 networkObserver:(id)a14 coreAnalyticsTagObserver:(id)a15 backgroundLoggingTimer:(id)a16 radarInitiator:(id)a17 notificationCenter:(id)a18 userDefaults:(id)a19 currentSoftwareVersion:(id)a20 swiftData:(id)a21
{
  ...
  if (v33)
  {
    ...
    [v61 addCommonField:@"isHH2Enabled" withValue:&unk_283E72BF0];
...
void __32__HMDMetricsManager_logCategory__block_invoke()
{
  ...
  v2 = logCategory__hmf_once_v21_122756;
  logCategory__hmf_once_v21_122756 = v1;
}
