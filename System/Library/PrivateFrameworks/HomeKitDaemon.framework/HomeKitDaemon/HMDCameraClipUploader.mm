...
- (void)addSignificantEvent:(id)a3 completionHandler:(id)a4;
...
- (id)_createClipWithSignificantEvent:(id)a3
{
  ...
  [(HMDCameraClipUploader *)self targetFragmentDuration];
  v10 = v9;
  v11 = [(HMDCameraClipUploader *)self startDate];
  v12 = [(HMDCameraClipUploader *)self quality];
...
- (void)addSignificantEvent:(id)a3 completionHandler:(id)a4
{
  ...
  v9 = [(HMDCameraClipUploader *)self didCreateClipFuture];
  if (!v9)
  {
    v9 = [(HMDCameraClipUploader *)self _createClipWithSignificantEvent:v6];
    [(HMDCameraClipUploader *)self setDidCreateClipFuture:v9];
    v27[0] = MEMORY[0x277D85DD0];
    v27[1] = 3221225472;
    v27[2] = __63__HMDCameraClipUploader_addSignificantEvent_completionHandler___block_invoke;
    v27[3] = &unk_278687BA8;
    v28 = v7;
    v10 = [v9 addCompletionBlock:v27];
  }

  v11 = [(HMDCameraClipUploader *)self factory];
  v12 = [(HMDCameraClipUploader *)self clipUUID];
  v13 = [(HMDCameraClipUploader *)self localZone];
  v14 = [v11 createAddSignificantEventOperationForClipModelID:v12 localZone:v13 significantEvent:v6];
  ...
  v16 = [(HMDCameraClipUploader *)self didCreateClipFuture];
