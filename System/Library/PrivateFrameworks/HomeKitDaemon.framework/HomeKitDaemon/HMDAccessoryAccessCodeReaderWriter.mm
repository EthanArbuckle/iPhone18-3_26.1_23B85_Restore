...
- (id)removeAllAccessCodesWithValue_Matter:(id)matter withUserUUID:(id)d guestName:(id)name flow:(id)flow
{
  ...
  v25 = dCopy;
  v26 = matterCopy;
  v27 = [uUIDsOfMatterAccessoriesSupportingAccessCodes na_map:v31];
    ...
    *&v10 = 138544130;
    ...
    do
    {
      for (i = 0; i != v35; ++i)
      {
        ...
        v14 = *(*(&v36 + 1) + 8 * i);
        v15 = [p_info + 51 _accessCodeControlFromWriteResponses:responsesCopy forWriteRequest:v14 flow:{flowCopy, v30}];
        v16 = v15;
        if (v15)
        {
