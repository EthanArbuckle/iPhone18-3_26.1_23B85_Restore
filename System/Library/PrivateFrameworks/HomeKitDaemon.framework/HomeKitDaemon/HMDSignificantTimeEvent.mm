...
- (void)_transactionObjectUpdated:(id)a3 newValues:(id)a4 message:(id)a5
{
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
  {
    ...
    v31 = 138543362;
    v32 = v14;
    _os_log_impl(&dword_229538000, v13, OS_LOG_TYPE_INFO, "%{public}@Handling transaction updated", &v31, 0xCu);
  }
...
void __38__HMDSignificantTimeEvent_logCategory__block_invoke()
{
  ...
  v2 = logCategory__hmf_once_v1_102992;
  logCategory__hmf_once_v1_102992 = v1;
}
