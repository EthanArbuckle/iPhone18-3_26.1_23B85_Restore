...
- (id)getLastProgressStateForAccessory:(id)a3
{
  ...
  if (v6)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      v19 = 2114;
      v20 = v11;
      _os_log_impl(&dword_229538000, v9, OS_LOG_TYPE_INFO, "%{public}@Final pairing progress state map before metric submission for identifier %{public}@ - %{public}@", &v15, 0x20u);
    }
...
LABEL_16:
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
  {
    ...
    v20 = 2112;
    v21 = v12;
    _os_log_impl(&dword_229538000, v8, OS_LOG_TYPE_INFO, "%{public}@Updated Pairing UI state: %lu, recoveryType: %lu on progress: %@", &v14, 0x2Au);
  }
...
- (void)updatePairingProgressState:(id)a3
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
    {
      ...
      v19 = 2112;
      v20 = v7;
      _os_log_impl(&dword_229538000, v14, OS_LOG_TYPE_ERROR, "%{public}@Attempting to update an uninitialized progress state map for %@", &v17, 0x16u);
    }
...
- (void)_handlePairingStateProgressNotification:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_DEBUG))
  {
    ...
    v14 = 2112;
    v15 = v9;
    _os_log_impl(&dword_229538000, v7, OS_LOG_TYPE_DEBUG, "%{public}@Received accessory pairing progress notification %@", &v12, 0x16u);
  }
...
- (void)incrementRetryCount:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v16 = 2112;
    v17 = v4;
    _os_log_impl(&dword_229538000, v7, OS_LOG_TYPE_INFO, "%{public}@Incrementing retry count for identifier %@", &v14, 0x16u);
  }
  ...
  else
  {
    ...
    [v11 setObject:&unk_283E72AB8 forKeyedSubscript:v4];
  }
...
LABEL_6:
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    _os_log_impl(&dword_229538000, v9, OS_LOG_TYPE_INFO, "%{public}@Updated previous recoveryType to: %lu", &v12, 0x16u);
  }
...
- (void)fillUnknownErrorIfMissingErrorForPairingEvent:(id)a3
{
  ...
  if (v5 != 27 && !v6)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      v13 = 138543362;
      v14 = v10;
      _os_log_impl(&dword_229538000, v9, OS_LOG_TYPE_INFO, "%{public}@Filling unknown error before submission because pairing event is missing error", &v13, 0xCu);
    }
  ...
  if (v29 || v30 == 27)
  {
    ...
    if (os_log_type_enabled(v32, OS_LOG_TYPE_ERROR))
    {
      ...
      *buf = 138543874;
      ...
      v153 = 2112;
      v154 = v35;
      _os_log_impl(&dword_229538000, v32, OS_LOG_TYPE_ERROR, "%{public}@Received update to pairing event when metric is completed already %@ %@", buf, 0x20u);
    }
  ...
  if (v138)
  {
    ...
    if (os_log_type_enabled(v39, OS_LOG_TYPE_INFO))
    {
      ...
      *buf = 138543874;
      ...
      v153 = 2048;
      v154 = v138;
      _os_log_impl(&dword_229538000, v39, OS_LOG_TYPE_INFO, "%{public}@Updating mtr metrics %p -> %p", buf, 0x20u);
    }
  ...
  if (!v131)
  {
    ...
    if (os_log_type_enabled(v52, OS_LOG_TYPE_INFO))
    {
      ...
      *buf = 138543874;
      ...
      v153 = 2112;
      v154 = v55;
      _os_log_impl(&dword_229538000, v52, OS_LOG_TYPE_INFO, "%{public}@Updating step %@ -> %@", buf, 0x20u);
    }
  ...
  if (!v130)
  {
    ...
    if (os_log_type_enabled(v57, OS_LOG_TYPE_INFO))
    {
      ...
      *buf = 138543874;
      ...
      v153 = 2112;
      v154 = v60;
      _os_log_impl(&dword_229538000, v57, OS_LOG_TYPE_INFO, "%{public}@Updating matter accessory discovered %@ -> %@", buf, 0x20u);
    }
  ...
  if (v137)
  {
    ...
    if (os_log_type_enabled(v63, OS_LOG_TYPE_INFO))
    {
      ...
      *buf = 138543874;
      ...
      v153 = 2112;
      v154 = v137;
      _os_log_impl(&dword_229538000, v63, OS_LOG_TYPE_INFO, "%{public}@Updating Matter vendorID %@ -> %@", buf, 0x20u);
    }
  ...
  if (v136)
  {
    ...
    if (os_log_type_enabled(v68, OS_LOG_TYPE_INFO))
    {
      ...
      *buf = 138543874;
      ...
      v153 = 2112;
      v154 = v136;
      _os_log_impl(&dword_229538000, v68, OS_LOG_TYPE_INFO, "%{public}@Updating Matter productID %@ -> %@", buf, 0x20u);
    }
  ...
  if (v135)
  {
    ...
    if (os_log_type_enabled(v73, OS_LOG_TYPE_INFO))
    {
      ...
      *buf = 138543874;
      ...
      v153 = 2112;
      v154 = v135;
      _os_log_impl(&dword_229538000, v73, OS_LOG_TYPE_INFO, "%{public}@Updating Matter device type %@ -> %@", buf, 0x20u);
    }
  ...
  if (contexta)
  {
    ...
    if (os_log_type_enabled(v78, OS_LOG_TYPE_INFO))
    {
      ...
      *buf = 138543874;
      ...
      v153 = 2112;
      v154 = contexta;
      _os_log_impl(&dword_229538000, v78, OS_LOG_TYPE_INFO, "%{public}@Updating supported link layer types %@ -> %@", buf, 0x20u);
    }
    ...
    if (os_log_type_enabled(v82, OS_LOG_TYPE_INFO))
    {
      ...
      *buf = 138543874;
      ...
      v153 = 2112;
      v154 = v85;
      _os_log_impl(&dword_229538000, v82, OS_LOG_TYPE_INFO, "%{public}@Updating isThreadAccessory %@ -> %@", buf, 0x20u);
    }
  ...
  if (v134)
  {
    ...
    if (os_log_type_enabled(v88, OS_LOG_TYPE_INFO))
    {
      ...
      *buf = 138543874;
      ...
      v153 = 2112;
      v154 = v134;
      _os_log_impl(&dword_229538000, v88, OS_LOG_TYPE_INFO, "%{public}@Updating Matter Thread capabilities %@ -> %@", buf, 0x20u);
    }
  ...
  if (v133)
  {
    ...
    if (os_log_type_enabled(v92, OS_LOG_TYPE_INFO))
    {
      ...
      *buf = 138543874;
      ...
      v153 = 2112;
      v154 = v95;
      _os_log_impl(&dword_229538000, v92, OS_LOG_TYPE_INFO, "%{public}@Updating isWEDAccessory %@ -> %@", buf, 0x20u);
      if (v93)
      {
      }
    }
  ...
  if (v132)
  {
    ...
    if (v96)
    {
      ...
      if (os_log_type_enabled(v99, OS_LOG_TYPE_INFO))
      {
        ...
        *buf = 138543362;
        v150 = v100;
        _os_log_impl(&dword_229538000, v99, OS_LOG_TYPE_INFO, "%{public}@Updating unauthenticated Matter accessory prompt start time", buf, 0xCu);
      }
    ...
    else
    {
      ...
      if (os_log_type_enabled(v101, OS_LOG_TYPE_INFO))
      {
        ...
        *buf = 138543362;
        v150 = v102;
        _os_log_impl(&dword_229538000, v101, OS_LOG_TYPE_INFO, "%{public}@Updating unauthenticated Matter accessory prompt duration", buf, 0xCu);
      }
  ...
  if (v144)
  {
    ...
    if (!v129)
    {
      ...
      if (os_log_type_enabled(v107, OS_LOG_TYPE_ERROR))
      {
        ...
        *buf = 138543362;
        v150 = v108;
        _os_log_impl(&dword_229538000, v107, OS_LOG_TYPE_ERROR, "%{public}@Received pairing error without source error domain", buf, 0xCu);
      }
    ...
    if (os_log_type_enabled(v112, OS_LOG_TYPE_INFO))
    {
      ...
      *buf = 138544386;
      ...
      v157 = 2112;
      v158 = v129;
      _os_log_impl(&dword_229538000, v112, OS_LOG_TYPE_INFO, "%{public}@Updating error %@ -> %@, sourceErrorDomain %@ -> %@", buf, 0x34u);
    }
  ...
  if (v117)
  {
    ...
    if (os_log_type_enabled(v120, OS_LOG_TYPE_INFO))
    {
      ...
      *buf = 138543618;
      ...
      v151 = 2112;
      v152 = v9;
      _os_log_impl(&dword_229538000, v120, OS_LOG_TYPE_INFO, "%{public}@Submitting Event %@", buf, 0x16u);
    }
...
- (void)configureWithPairingEvent:(id)a3 workQueue:(id)a4 logEventSubmitter:(id)a5
{
  ...
  if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
  {
    ...
    v26 = 2112;
    v27 = v16;
    _os_log_impl(&dword_229538000, v13, OS_LOG_TYPE_INFO, "%{public}@Configuring with workQueue %@ logEventSubmitter %@, from workQueue %@ logEventSubmitter %@", &v18, 0x34u);
  }
...
void __54__HMDAccessoryPairingLogEventStateManager_logCategory__block_invoke()
{
  ...
  v2 = logCategory__hmf_once_v59_111834;
  logCategory__hmf_once_v59_111834 = v1;
}
