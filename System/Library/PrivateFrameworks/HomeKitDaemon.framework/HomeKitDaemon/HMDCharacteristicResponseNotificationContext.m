...
+ (id)updateLastSeenStatusDataForResponsePayload:(id)a3 home:(id)a4 isRemote:(BOOL)a5 isNotification:(BOOL)a6;
...
+ (id)updateLastSeenStatusDataForResponsePayload:(id)a3 home:(id)a4 isRemote:(BOOL)a5 isNotification:(BOOL)a6
{
  ...
  if (a5 || a6)
  {
    v12 = [v9 hmf_dictionaryForKey:@"kModifiedCharacteristicsForAccessoryKey"];
    v13 = [v12 copy];
