...
void __27__HMDHomeInvitation_expire__block_invoke(uint64_t a1)
{
  ...
  if (WeakRetained && ([WeakRetained expirationHandler], v4 = objc_claimAutoreleasedReturnValue(), v4, v4))
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_DEFAULT))
    {
      ...
      v17 = 2112;
      v18 = v8;
      _os_log_impl(&dword_229538000, v6, OS_LOG_TYPE_DEFAULT, "%{public}@Calling invitation (%@) expiration handler", &v15, 0x16u);
    }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_DEFAULT))
    {
      ...
      v17 = 2112;
      v18 = v13;
      _os_log_impl(&dword_229538000, v11, OS_LOG_TYPE_DEFAULT, "%{public}@Not calling invitation (%@) expiration handler, not set", &v15, 0x16u);
    }
