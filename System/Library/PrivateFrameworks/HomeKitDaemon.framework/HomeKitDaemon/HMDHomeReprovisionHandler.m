...
- (void)_reportAccessoryNeedingReprovision:(void *)a3 error:
{
  ...
  if (a1)
  {
    ...
    [v8 setObject:&unk_283E72F20 forKeyedSubscript:*MEMORY[0x277CD2008]];
    if (v16)
    {
  ...
  if (isiOSDevice())
  {
    ...
    if (v11)
    {
      ...
      if ([v11 reachableTransports])
      {
        ...
        [v21 setObject:&unk_283E72EF0 forKeyedSubscript:*MEMORY[0x277CD2008]];
      ...
      if (v12)
      {
        ...
        [v21 setObject:&unk_283E72F08 forKeyedSubscript:*MEMORY[0x277CD2008]];
