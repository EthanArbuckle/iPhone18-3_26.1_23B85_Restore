  ...
  else
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
    {
      ...
      *buf = 138543618;
      ...
      v21 = 2112;
      v22 = 0;
      _os_log_impl(&dword_229538000, v14, OS_LOG_TYPE_ERROR, "%{public}@Failed to parse HAPAccessCodeControl from NSData: %@", buf, 0x16u);
    }
...
- (id)_controlResponseForReadRequest:(id)request
{
  ...
  v4 = [objc_alloc(MEMORY[0x277CFEC98]) initWithValue:&unk_283E74C48];
  v5 = [objc_alloc(MEMORY[0x277CFEC98]) initWithValue:&unk_283E74C60];
  v6 = [objc_alloc(MEMORY[0x277CFEC98]) initWithValue:&unk_283E74C78];
        ...
        if (!v8)
        {
          ...
          if (os_log_type_enabled(v25, OS_LOG_TYPE_ERROR))
          {
            ...
            *buf = 138543618;
            ...
            v52 = 2112;
            v53 = v7;
            _os_log_impl(&dword_229538000, v25, OS_LOG_TYPE_ERROR, "%{public}@Failed to serialize access code control response: %@", buf, 0x16u);
          }
        ...
        if (!v10)
        {
          ...
          if (os_log_type_enabled(v26, OS_LOG_TYPE_ERROR))
          {
            ...
            *buf = 138543618;
            ...
            v53 = 2112;
            v54 = v9;
            _os_log_impl(&dword_229538000, v26, OS_LOG_TYPE_ERROR, "%{public}@Failed to serialize access code control response: %@", buf, 0x16u);
          }
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t3_237246 != -1)
  {
    dispatch_once(&logCategory__hmf_once_t3_237246, &__block_literal_global_237247);
  }

  v3 = logCategory__hmf_once_v4_237248;
...
void __42__HMDAccessCodeDemoDataMocker_logCategory__block_invoke()
{
  ...
  v2 = logCategory__hmf_once_v4_237248;
  logCategory__hmf_once_v4_237248 = v1;
}
