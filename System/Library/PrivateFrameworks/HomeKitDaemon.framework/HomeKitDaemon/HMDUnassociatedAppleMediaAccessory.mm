...
- (id)addTransactionForHome:(id)a3
{
  ...
  v4 = [(HMDUnassociatedMediaAccessory *)&v31 addTransactionForHome:a3];
  objc_opt_class();
  ...
  if (v6)
  {
    ...
    v25 = [(HMDUnassociatedAppleMediaAccessory *)self variant];
    if ((v13 & (v25 == 0)) != 0)
    {
      v26 = 1;
    }
...
- (HMDUnassociatedAppleMediaAccessory)initWithIdentifier:(id)a3 name:(id)a4 category:(id)a5 requiredPairingCapabilities:(unint64_t)a6 minimumPairingSoftware:(id)a7 productColor:(int64_t)a8 idsIdentifierString:(id)a9 rawAccessoryCapabilities:(id)a10 rawResidentCapabilities:(id)a11 messageDispatcher:(id)a12
{
  ...
  v18 = [(HMDUnassociatedMediaAccessory *)&v27 initWithIdentifier:a3 name:a4 category:a5 messageDispatcher:a12];
  if (v18)
  {
    v19 = [[HMDCapabilityFlags alloc] initWithCapabilityOptions:a6];
...
- (id)modelForChangeType:(unint64_t)a3 uuid:(id)a4 parentUUID:(id)a5
{
  v7 = a5;
  v8 = a4;
  v9 = [(HMDBackingStoreModelObject *)[HMDAppleMediaAccessoryModel alloc] initWithObjectChangeType:a3 uuid:v8 parentUUID:v7];
