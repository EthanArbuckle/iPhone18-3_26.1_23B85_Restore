...
- (void)videoStream:(id)stream didGetLastDecodedFrame:(id)frame
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    v13 = 138543362;
    v14 = v11;
    _os_log_impl(&dword_229538000, v10, OS_LOG_TYPE_INFO, "%{public}@Received last decoded frame", &v13, 0xCu);
  }
  ...
  if (delegate)
  {
    if (delegate[8] == 1)
    {
      ...
      if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
      {
        ...
        *(&v24 + 4) = v7;
        _os_log_impl(&dword_229538000, v6, OS_LOG_TYPE_INFO, "%{public}@Captured the last frame, sending stop stream", &v24, 0xCu);
      }
    ...
    if (delegate[9] == 1)
    {
      ...
      if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
      {
        ...
        LODWORD(v24) = 138543362;
        *(&v24 + 4) = v13;
        _os_log_impl(&dword_229538000, v12, OS_LOG_TYPE_INFO, "%{public}@Calling delegate streamSnapshotCapture:didGetNewSnapshot", &v24, 0xCu);
      }
    ...
    if (delegate[8] == 1)
    {
      ...
      if (v3)
      {
        ...
        if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
        {
          ...
          LODWORD(v24) = 138543362;
          *(&v24 + 4) = v20;
          _os_log_impl(&dword_229538000, v19, OS_LOG_TYPE_INFO, "%{public}@Calling delegate streamSnapshotCapture:didGetLastSnapshot", &v24, 0xCu);
        }
...
- (void)timerDidFire:(id)fire
{
  ...
  if (captureCurrentFrameTimer == fireCopy)
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_INFO))
    {
      ...
      v11 = 138543362;
      v12 = v9;
      _os_log_impl(&dword_229538000, v8, OS_LOG_TYPE_INFO, "%{public}@Timed out capturing frame from stream", &v11, 0xCu);
    }
...
void __50__HMDCameraStreamSnapshotCapture_captureLastFrame__block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    v8 = 138543362;
    v9 = v6;
    _os_log_impl(&dword_229538000, v5, OS_LOG_TYPE_INFO, "%{public}@Capturing last frame", &v8, 0xCu);
  }
...
LABEL_6:
  ...
  if (self[7])
  {
    ...
    if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
    {
      ...
      v14 = 138543362;
      v15 = v5;
      _os_log_impl(&dword_229538000, v4, OS_LOG_TYPE_INFO, "%{public}@Not capturing current frame because a current frame capture is in progress", &v14, 0xCu);
    }
...
void __53__HMDCameraStreamSnapshotCapture_captureCurrentFrame__block_invoke(uint64_t a1)
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    v8 = 138543362;
    v9 = v6;
    _os_log_impl(&dword_229538000, v5, OS_LOG_TYPE_INFO, "%{public}@Capturing current frame", &v8, 0xCu);
  }
...
void __45__HMDCameraStreamSnapshotCapture_logCategory__block_invoke()
{
  ...
  v2 = logCategory__hmf_once_v1_222587;
  logCategory__hmf_once_v1_222587 = v1;
}
