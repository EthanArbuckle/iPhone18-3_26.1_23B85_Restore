...
void __63__HMDHomeEventsGenerated_expandedTopicsWithTopics_homeManager___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (v4 && [v4 isIndexTopic])
  {
    ...
    else
    {
      ...
      v65 = 0u;
      v66 = 0u;
      v33 = [&unk_283E78000 countByEnumeratingWithState:&v65 objects:v73 count:16];
      if (v33)
      {
        v34 = v33;
        v35 = *v66;
        do
        {
          for (i = 0; i != v34; ++i)
          {
            ...
            v37 = *(*(&v65 + 1) + 8 * i);
            v38 = [&unk_283E78078 objectForKeyedSubscript:v37];
          ...
          v34 = [&unk_283E78000 countByEnumeratingWithState:&v65 objects:v73 count:16];
        }
...
+ (id)upstreamHomeTopicForTopic:(id)topic homeUUID:(id)d
{
  ...
  v20 = [&unk_283E77F88 objectForKeyedSubscript:topicSuffix2];
