...
- (id)modelsToAdd
{
  ...
  [(HMDCameraClipModel *)v6 setDuration:&unk_283E735B0];
  [(HMDCameraClipModel *)v6 setSize:&unk_283E735B0];
  ...
  [(HMDCameraClipModel *)v6 setEncryptionScheme:&unk_283E735C8];
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t1_154571 != -1)
  {
    dispatch_once(&logCategory__hmf_once_t1_154571, &__block_literal_global_154572);
  }

  v3 = logCategory__hmf_once_v2_154573;
...
void __47__HMDCameraClipCreateClipOperation_logCategory__block_invoke()
{
  ...
  v2 = logCategory__hmf_once_v2_154573;
  logCategory__hmf_once_v2_154573 = v1;
}
