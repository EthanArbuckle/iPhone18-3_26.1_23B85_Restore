...
LABEL_15:
    _os_log_impl(&dword_229538000, v19, OS_LOG_TYPE_INFO, v21, buf, 0x16u);
...
LABEL_16:
    ...
    if ([v24 shouldCloseSessionWithTimeoutReason])
    {
      ...
      if (os_log_type_enabled(v27, OS_LOG_TYPE_INFO))
      {
        ...
        *buf = 138543362;
        v42 = v28;
        _os_log_impl(&dword_229538000, v27, OS_LOG_TYPE_INFO, "%{public}@Skipping invoking the session start callback since handle response timer hasn't expired", buf, 0xCu);
      }
...
LABEL_21:
    ...
    if (os_log_type_enabled(v31, OS_LOG_TYPE_INFO))
    {
      ...
      *buf = 138543618;
      ...
      v43 = 2112;
      v44 = 0;
      _os_log_impl(&dword_229538000, v31, OS_LOG_TYPE_INFO, "%{public}@Could not find expired timer for session with identifier: %@", buf, 0x16u);
    }
...
- (void)_openSessionForFileType:(id)a3 reason:(id)a4 metadata:(id)a5 queue:(id)a6 callback:(id)a7
{
  ...
  if (os_log_type_enabled(v34, OS_LOG_TYPE_INFO))
  {
    ...
    *buf = 138543874;
    ...
    v51 = 2112;
    v52 = v14;
    _os_log_impl(&dword_229538000, v34, OS_LOG_TYPE_INFO, "%{public}@Starting bulk session with identifier: %@ and metadata: %@", buf, 0x20u);
  }
  ...
  if (v12)
  {
    if (v16)
    {
      ...
      *buf = 138543874;
      ...
      v64 = 2112;
      v65 = v7;
      _os_log_impl(&dword_229538000, v15, OS_LOG_TYPE_INFO, "%{public}@Received bulk send open response for session with identifier: %@ error: %@", buf, 0x20u);
    }
    ...
    if ([v12 shouldCloseSessionWithTimeoutReason])
    {
      ...
      if (os_log_type_enabled(v22, OS_LOG_TYPE_INFO))
      {
        ...
        *buf = 138543618;
        ...
        v62 = 2112;
        v63 = v24;
        _os_log_impl(&dword_229538000, v22, OS_LOG_TYPE_INFO, "%{public}@Session with identifier: %@ has timed out, sending close event to accessory", buf, 0x16u);
      }
    ...
    if (!v28)
    {
      ...
      if (os_log_type_enabled(v36, OS_LOG_TYPE_ERROR))
      {
        ...
        *buf = 138543362;
        v61 = v37;
        _os_log_impl(&dword_229538000, v36, OS_LOG_TYPE_ERROR, "%{public}@Could not find a status in header", buf, 0xCu);
      }
    ...
    if (!v32)
    {
      ...
      if (os_log_type_enabled(v46, OS_LOG_TYPE_ERROR))
      {
        ...
        *buf = 138543874;
        ...
        v64 = 2112;
        v65 = v31;
        _os_log_impl(&dword_229538000, v46, OS_LOG_TYPE_ERROR, "%{public}@Received non-success status in header: %@, mapped error: %@", buf, 0x20u);
      }
...
LABEL_28:
    ...
    if (os_log_type_enabled(v46, OS_LOG_TYPE_ERROR))
    {
      ...
      *buf = 138544130;
      ...
      v66 = 2112;
      v67 = v31;
      _os_log_impl(&dword_229538000, v46, OS_LOG_TYPE_ERROR, "%{public}@Received non-success status in header: %@, payload status: %@, mapped error: %@", buf, 0x2Au);
...
LABEL_30:
  ...
  if (v16)
  {
    ...
    *buf = 138543618;
    ...
    v62 = 2112;
    v63 = v27;
    _os_log_impl(&dword_229538000, v15, OS_LOG_TYPE_INFO, "%{public}@Could not find pending bulk send session context for session identifier: %@", buf, 0x16u);
  }
...
- (void)_sendAckMessageWithIdentifier:(id)a3
{
  ...
  if (v5)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
    {
      ...
      v14 = 2112;
      v15 = v4;
      _os_log_impl(&dword_229538000, v9, OS_LOG_TYPE_INFO, "%{public}@Sending 'ack' for sid=%@", &v12, 0x16u);
    }

    objc_autoreleasePoolPop(v7);
    [v5 sendEventForProtocol:@"dataSend" topic:@"ack" payload:v6 completion:&__block_literal_global_46];
  }
...
LABEL_15:
  ...
  if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
  {
    ...
    v22 = 138543362;
    v23 = v20;
    _os_log_impl(&dword_229538000, v19, OS_LOG_TYPE_INFO, "%{public}@Received message with no packets", &v22, 0xCu);
  }
...
- (void)_handleDataMessage:(id)a3
{
  ...
  if (v7)
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v15, OS_LOG_TYPE_DEBUG))
      {
        ...
        v20 = 2112;
        v21 = v7;
        _os_log_impl(&dword_229538000, v15, OS_LOG_TYPE_DEBUG, "%{public}@Data packet for streamIdentifier=%@ dropped because no session is active", &v18, 0x16u);
      }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
    {
      ...
      v18 = 138543362;
      v19 = v12;
      _os_log_impl(&dword_229538000, v11, OS_LOG_TYPE_ERROR, "%{public}@Data packet dropped because no session identifier was present", &v18, 0xCu);
    }
...
- (void)_handleCloseMessage:(id)a3
{
  ...
  if (v7)
  {
    ...
    if (v15)
    {
      if (os_log_type_enabled(v18, OS_LOG_TYPE_DEFAULT))
      {
        ...
        v29 = 2112;
        v30 = v7;
        _os_log_impl(&dword_229538000, v19, OS_LOG_TYPE_DEFAULT, "%{public}@Received close packet for stream identifier: %@", &v27, 0x16u);
      }
    ...
    else
    {
      if (os_log_type_enabled(v18, OS_LOG_TYPE_DEBUG))
      {
        ...
        v29 = 2112;
        v30 = v7;
        _os_log_impl(&dword_229538000, v19, OS_LOG_TYPE_DEBUG, "%{public}@Close packet for streamIdentifier=%@ dropped because no session is active", &v27, 0x16u);
      }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v23, OS_LOG_TYPE_ERROR))
    {
      ...
      v27 = 138543362;
      v28 = v24;
      _os_log_impl(&dword_229538000, v23, OS_LOG_TYPE_ERROR, "%{public}@Close dropped because streamIdentifier was not included", &v27, 0xCu);
    }
...
- (void)_handleOpenWithRequestHeader:(id)a3 payload:(id)a4
{
  ...
  if (v10 && v13)
  {
    ...
    if (v18)
    {
      if (os_log_type_enabled(v21, OS_LOG_TYPE_DEBUG))
      {
        ...
        v34 = 2112;
        v35 = v10;
        _os_log_impl(&dword_229538000, v22, OS_LOG_TYPE_DEBUG, "%{public}@Received 'open' with type=%@; passing to listener", &v32, 0x16u);
      }
    ...
    else
    {
      if (os_log_type_enabled(v21, OS_LOG_TYPE_INFO))
      {
        ...
        v34 = 2112;
        v35 = v10;
        _os_log_impl(&dword_229538000, v22, OS_LOG_TYPE_INFO, "%{public}@Received 'open' for type=%@ but no active listener accepted it", &v32, 0x16u);
      }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v28, OS_LOG_TYPE_INFO))
    {
      ...
      v36 = 2112;
      v37 = v13;
      _os_log_impl(&dword_229538000, v28, OS_LOG_TYPE_INFO, "%{public}@Dropping 'open' because it is missing required keys (type=%@, target=%@)", &v32, 0x20u);
    }
...
- (id)_createSessionFromCandidate:(id)a3 queue:(id)a4
{
  ...
  if (os_log_type_enabled(v14, OS_LOG_TYPE_DEBUG))
  {
    ...
    v22 = 2112;
    v23 = v8;
    _os_log_impl(&dword_229538000, v14, OS_LOG_TYPE_DEBUG, "%{public}@Creating new receive session with streamIdentifier=%@", &v20, 0x16u);
  }
...
- (id)_createSessionCandidateWithRequestHeader:(id)a3 metadata:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_DEBUG))
  {
    ...
    v17 = 2112;
    v18 = v6;
    _os_log_impl(&dword_229538000, v10, OS_LOG_TYPE_DEBUG, "%{public}@Creating new receive candidate session (header %@)", &v15, 0x16u);
  }
  ...
  if ([(HMDDataStreamBulkSendProtocol *)self isConnected])
  {
    ...
    else
    {
      ...
      if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
      {
        ...
        v21 = 2112;
        v22 = v11;
        _os_log_impl(&dword_229538000, v16, OS_LOG_TYPE_INFO, "%{public}@DataSend received unexpected request '%@'", &v19, 0x16u);
      }
...
- (void)dataStreamDidOpen:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_DEBUG))
  {
    ...
    *buf = 138543362;
    v24 = v8;
    _os_log_impl(&dword_229538000, v7, OS_LOG_TYPE_DEBUG, "%{public}@DataStream did open; connected.", buf, 0xCu);
  }
...
- (void)dataStreamDidClose:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v10 = 138543362;
    v11 = v8;
    _os_log_impl(&dword_229538000, v7, OS_LOG_TYPE_INFO, "%{public}@DataStream closed; cleaning up", &v10, 0xCu);
  }
...
- (void)dataStreamInitiatedClose:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v10 = 138543362;
    v11 = v8;
    _os_log_impl(&dword_229538000, v7, OS_LOG_TYPE_INFO, "%{public}@DataStream initiated closing...", &v10, 0xCu);
  }
...
- (void)dataStream:(id)a3 didFailWithError:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    v15 = 2112;
    v16 = v7;
    _os_log_impl(&dword_229538000, v10, OS_LOG_TYPE_INFO, "%{public}@DataStream failed with error; cleaning up. (%@)", &v13, 0x16u);
  }
...
- (void)_closeAllSessionsWithError:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_DEBUG))
  {
    ...
    *buf = 138543874;
    ...
    v47 = 2048;
    v48 = [v11 count];
    _os_log_impl(&dword_229538000, v7, OS_LOG_TYPE_DEBUG, "%{public}@Session closed; removing %lu listeners and closing %lu sessions", buf, 0x20u);
  }
...
- (void)_notifyActiveStatusChangedFromPreviousValue:(BOOL)a3
{
  ...
  if ([(HMDDataStreamBulkSendProtocol *)self isActive]!= a3)
  {
    ...
    if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
    {
      ...
      v13 = 2112;
      v14 = v8;
      _os_log_impl(&dword_229538000, v6, OS_LOG_TYPE_INFO, "%{public}@BulkSend protocol changes active to %@", &v11, 0x16u);
    }
...
- (void)addListener:(id)a3 fileType:(id)a4
{
  ...
  if (v10)
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
    {
      ...
      v20 = 2112;
      v21 = v7;
      _os_log_impl(&dword_229538000, v14, OS_LOG_TYPE_INFO, "%{public}@Rejecting BulkSend registration for file type %@; handler already exists", &v18, 0x16u);
    }
