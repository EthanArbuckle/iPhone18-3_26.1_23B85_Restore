...
{
  v3 = a3;
  if (![v3 conformsToProtocol:&unk_283ECBB38] || (objc_opt_respondsToSelector() & 1) == 0 || (objc_msgSend(v3, "diagnosticReportEventSubType"), (v4 = objc_claimAutoreleasedReturnValue()) == 0))
  {
    v5 = objc_opt_class();
...
{
  v3 = a3;
  if (![v3 conformsToProtocol:&unk_283ECBB38] || (objc_opt_respondsToSelector() & 1) == 0 || (objc_msgSend(v3, "diagnosticReportEventType"), (v4 = objc_claimAutoreleasedReturnValue()) == 0))
  {
    v5 = objc_opt_class();
    if (v5 == objc_opt_class())
    {
