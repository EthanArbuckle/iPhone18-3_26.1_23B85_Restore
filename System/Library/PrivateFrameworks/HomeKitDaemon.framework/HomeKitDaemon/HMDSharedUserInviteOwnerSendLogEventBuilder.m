...
- (HMDSharedUserInviteOwnerSendLogEventBuilder)initWithHome:(id)a3 sessionIdentifier:(id)a4 invitationType:(unint64_t)a5 invitationAge:(double)a6 invitationSource:(unint64_t)a7
{
  ...
  v15 = [(HMDSharedUserInviteOwnerSendLogEventBuilder *)self initWithHome:v13 sessionIdentifier:v12 invitationType:a5 invitationAge:a7 invitationSource:v14 logEventSubmitter:&__block_literal_global_85747 currentUpTicksBlock:a6 submissionTimerFactory:&__block_literal_global_4];
