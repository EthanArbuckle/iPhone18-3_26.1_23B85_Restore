...
{
  v4 = a3;
  [(HMDAccessoryFirmwareUpdateConcurrencyLogEventManager *)self stopWithCategory:qword_22A587768[getAccessoryFirmwareUpdateActiveTransport(v4) - 1] accessory:v4];
}
...
{
  v4 = a3;
  [(HMDAccessoryFirmwareUpdateConcurrencyLogEventManager *)self startWithCategory:qword_22A587768[getAccessoryFirmwareUpdateActiveTransport(v4) - 1] accessory:v4];
}
