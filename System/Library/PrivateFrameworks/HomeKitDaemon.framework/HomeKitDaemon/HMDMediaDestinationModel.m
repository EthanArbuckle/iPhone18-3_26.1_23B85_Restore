...
+ (id)logCategory
{
  if (logCategory__hmf_once_t0_124431 != -1)
  {
    dispatch_once(&logCategory__hmf_once_t0_124431, &__block_literal_global_12_124432);
  }

  v3 = logCategory__hmf_once_v1_124433;
...
+ (id)properties
{
  if (properties_onceToken_124438 != -1)
  {
    dispatch_once(&properties_onceToken_124438, &__block_literal_global_124439);
  }

  v3 = properties__properties_124440;
