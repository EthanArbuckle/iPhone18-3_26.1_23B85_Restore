              ...
              if (v66)
              {
                ...
                else
                {
                  ...
                  if (os_log_type_enabled(v89, OS_LOG_TYPE_ERROR))
                  {
                    ...
                    *buf = 138543362;
                    v103 = v90;
                    _os_log_impl(&dword_229538000, v89, OS_LOG_TYPE_ERROR, "%{public}@Failed to create image destination", buf, 0xCu);
                  }
...
void __36__HMDCameraSnapshotFile_logCategory__block_invoke()
{
  ...
  v2 = logCategory__hmf_once_v23_115187;
  logCategory__hmf_once_v23_115187 = v1;
}
