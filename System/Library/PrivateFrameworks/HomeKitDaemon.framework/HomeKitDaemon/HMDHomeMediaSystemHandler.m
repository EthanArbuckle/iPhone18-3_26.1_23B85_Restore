...
- (void)encodeWithCoder:(id)a3
{
  ...
  [v4 encodeObject:v5 forKey:*MEMORY[0x277CD2480]];
}
...
- (void)_handleAddMediaSystemModel:(id)a3 message:(id)a4
{
  ...
  if (isFeatureHomeTheaterQFAEnabledForTests && ![isFeatureHomeTheaterQFAEnabledForTests BOOLValue])
  {
    ...
    v13 = [[HMDMediaSystem alloc] initWithMediaSystemModel:v6 home:v12];
    v14 = objc_autoreleasePoolPush();
    v15 = self;
    v16 = HMFGetOSLogHandle();
    if (os_log_type_enabled(v16, OS_LOG_TYPE_INFO))
    ...
    if (v13)
    {
      ...
      v20 = [(HMDMediaSystem *)v13 serialize];
      v29 = v20;
...
- (void)messageHandlerAddMediaSystem:(id)a3 configuredName:(id)a4 leftUUID:(id)a5 leftAccessoryUUID:(id)a6 rightUUID:(id)a7 rightAccessoryUUID:(id)a8 builderSession:(id)a9 completion:(id)a10
{
  ...
  if (!v25)
  {
    ...
    if (v38 && (v40 = v39) != 0)
    {
      ...
      {
        v114 = v38;
        v62 = [MEMORY[0x277CBEB98] setWithObjects:{v18, v19, 0}];
        v131 = 0u;
        v132 = 0u;
        v133 = 0u;
        v134 = 0u;
        ...
        if (v109)
        {
          ...
          do
          {
            ...
            do
            {
              ...
              v108 = v68;
              v69 = [v68 components];
              v70 = [v69 countByEnumeratingWithState:&v127 objects:v139 count:16];
              if (v70)
              {
                v71 = v70;
                v72 = *v128;
                while (2)
                {
                  for (i = 0; i != v71; ++i)
                  {
                    ...
                    v74 = [*(*(&v127 + 1) + 8 * i) accessory];
                    v75 = [v74 uuid];
                    v76 = [v62 containsObject:v75];
                  ...
                  v71 = [v69 countByEnumeratingWithState:&v127 objects:v139 count:16];
                  if (v71)
                  {
                    continue;
                  }
        ...
        v77 = [v38 supportedStereoPairVersions];
        if (([v64 supportedStereoPairVersions] & v77) != 0)
        {
          v78 = [HMDMediaSystemModel alloc];
          v79 = [(HMDHomeMediaSystemHandler *)v22 parentUUID];
          v80 = [(HMDBackingStoreModelObject *)v78 initWithObjectChangeType:1 uuid:v118 parentUUID:v79];
          ...
          v81 = [MEMORY[0x277CD1BF8] encodeComponentDataWithLeftComponentUUID:v17 leftAccessoryUUID:v113 rightComponentUUID:v122 rightAccessoryUUID:v29];
          [(HMDMediaSystemModel *)v80 setMediaSystemComponents:v81];

          v116 = [v117 backingStore];
          +[HMDBackingStoreTransactionOptions defaultXPCOptions];
          v83 = v82 = v80;
          v69 = [v116 transaction:@"Add media system" options:v83];
        ...
        else
        {
          ...
          v69 = [v106 hmErrorWithCode:3 description:0 reason:0 suggestion:0 underlyingError:v82];
          v32 = v120;
          v120[2](v120, 0, v69);
        }
...
- (id)filteredMediaSystems
{
  ...
  v3 = [v2 na_filter:&__block_literal_global_3_67696];
...
- (HMDHomeMediaSystemHandler)initWithMediaSystems:(id)a3
{
  ...
  if (v5)
  {
    ...
    v8 = [v4 na_dictionaryWithKeyGenerator:&__block_literal_global_67701];
    v9 = [v8 mutableCopy];
