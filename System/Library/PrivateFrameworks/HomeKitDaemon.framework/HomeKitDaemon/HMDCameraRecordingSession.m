...
- (void)_notifyForSignificantEvent:(id)a3 recordingEventTriggers:(unint64_t)a4 fragmentNumber:(unint64_t)a5
{
  ...
  v14[1] = a4;
  v14[2] = a5;
  [v10 addSignificantEvent:v11 completionHandler:v12];
...
- (void)configure
{
  ...
  if (v5)
  {
    ...
    v12 = [v5 users];
    v13 = [v12 na_map:&__block_literal_global_238660];
...
LABEL_20:
  ...
  if (v23)
  {
    ...
    *&v24->_timelapseClipStartTime.value = v29;
    ...
    v64 = [[HMDAccessoryMetricVendorDetails alloc] initWithAccessory:v20];
    ...
    v38 = v21;
    v40 = v39 = v18;
    v41 = [(HMDAccessoryMetricVendorDetails *)v64 firmwareVersion];
    v42 = [v34 initWithIdentifier:v35 name:v36 manufacturer:v37 model:v40 firmwareVersion:v41 hasBattery:{objc_msgSend(v20, "hasBattery")}];
    ...
    CMTimeMakeWithSeconds(&v72, a8 * 2.5, 1000);
    v71 = v72;
    ...
    v52 = [(HMDCameraRecordingSessionFactory *)v24->_factory createSignificantEventManagerWithWorkQueue:v18 faceClassificationResolver:v51 logIdentifier:v24->_logIdentifier];
...
- (HMDCameraRecordingSession)initWithWorkQueue:(id)a3 camera:(id)a4 hapAccessory:(id)a5 home:(id)a6 localZone:(id)a7 configuredFragmentDuration:(double)a8 timelineManager:(id)a9
{
  ...
  v23 = [(HMDCameraRecordingSession *)self initWithWorkQueue:v21 camera:v20 hapAccessory:v19 home:v18 localZone:v17 configuredFragmentDuration:v16 timelineManager:a8 factory:v22];
