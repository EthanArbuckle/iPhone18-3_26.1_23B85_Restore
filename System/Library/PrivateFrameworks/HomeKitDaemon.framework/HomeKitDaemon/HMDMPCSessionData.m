  ...
  if (v20)
  {
    ...
    if (os_log_type_enabled(v32, OS_LOG_TYPE_INFO))
    {
      ...
      *v81 = 138543618;
      ...
      v83 = 2112;
      v84 = v20;
      _os_log_impl(&dword_229538000, v32, OS_LOG_TYPE_INFO, "%{public}@Decoding playbackArchive in entirety: %@", v81, 0x16u);
    ...
    if (!v34)
    {
      ...
      if (os_log_type_enabled(v38, OS_LOG_TYPE_ERROR))
      {
        ...
        *v81 = 138543618;
        ...
        v83 = 2112;
        v84 = v35;
        _os_log_impl(&dword_229538000, v38, OS_LOG_TYPE_ERROR, "%{public}@Couldn't decode playbackArchive: %@", v81, 0x16u);
      }
  ...
  else
  {
    ...
    if (v21)
    {
      if (v43)
      {
        ...
        *v81 = 138543618;
        ...
        v83 = 2112;
        v84 = v21;
        _os_log_impl(&dword_229538000, v42, OS_LOG_TYPE_INFO, "%{public}@Decoding playbackArchive session identifier: %@", v81, 0x16u);
      }
      ...
      if (v34)
      {
        ...
        if (os_log_type_enabled(v50, OS_LOG_TYPE_INFO))
        {
          ...
          *v81 = 138543874;
          ...
          v85 = 2112;
          v86 = v53;
          _os_log_impl(&dword_229538000, v50, OS_LOG_TYPE_INFO, "%{public}@Decoding playbackArchive: %@ options: %@", v81, 0x20u);
        }
    ...
    else
    {
      if (v43)
      {
        ...
        *v81 = 138543362;
        v82 = v54;
        _os_log_impl(&dword_229538000, v42, OS_LOG_TYPE_INFO, "%{public}@Key to playbackArchive not found", v81, 0xCu);
      }
