...
- (id)_readAccessCodesFromAccessoriesWithUUIDs_Matter:(id)a3 withRetries:(BOOL)a4 flow:(id)a5;
- (id)_readAccessCodesFromAccessory_Matter:(id)a3 withRetries:(BOOL)a4 flow:(id)a5;
- (id)_readConstraintsFromAccessoriesWithUUIDs_Matter:(id)a3 withRetries:(BOOL)a4 flow:(id)a5;
- (id)_readConstraintsFromAccessory_Matter:(id)a3 withRetries:(BOOL)a4 flow:(id)a5;
- (id)logIdentifier;
- (id)performAccessCodeModificationRequests_Matter:(id)a3 withRetries:(BOOL)a4 flow:(id)a5;
...
- (id)removeAllAccessCodesWithValue_Matter:(id)a3 withUserUUID:(id)a4 guestName:(id)a5 flow:(id)a6;
...
- (id)_characteristicsOfType:(id)a3 fromAccessoriesWithUUIDs:(id)a4 flow:(id)a5
{
  ...
  if (v15 == [v13 count])
  {
    ...
    v33[1] = 3221225472;
    v33[2] = __91__HMDAccessoryAccessCodeReaderWriter__characteristicsOfType_fromAccessoriesWithUUIDs_flow___block_invoke_123;
    v33[3] = &unk_27866E7A0;
    v16 = v8;
    v34 = v16;
    v17 = [v14 na_map:v33];
...
id __92__HMDAccessoryAccessCodeReaderWriter__readAccessCodesFromAccessory_Matter_withRetries_flow___block_invoke_3(id *a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    v23 = 2112;
    v24 = v3;
    _os_log_impl(&dword_229538000, v6, OS_LOG_TYPE_INFO, "%{public}@[Flow: %@] Failed to read access codes from Matter accessory: %@, with error: %@", &v17, 0x2Au);
  }
...
- (id)_readAccessCodesFromAccessoriesWithUUIDs_Matter:(id)a3 withRetries:(BOOL)a4 flow:(id)a5
{
  ...
  else
  {
    ...
    v21[1] = 3221225472;
    v21[2] = __103__HMDAccessoryAccessCodeReaderWriter__readAccessCodesFromAccessoriesWithUUIDs_Matter_withRetries_flow___block_invoke;
    v21[3] = &unk_27866E688;
    v21[4] = v12;
    v23 = a4;
    v22 = v9;
    ...
    v18 = [MEMORY[0x277D2C938] immediateScheduler];
    v10 = [v17 combineAllFutures:v16 scheduler:v18];
  }
...
id __100__HMDAccessoryAccessCodeReaderWriter__readAccessCodesFromAccessoriesWithUUIDs_HAP_withRetries_flow___block_invoke(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    v15 = 2112;
    v16 = v8;
    _os_log_impl(&dword_229538000, v6, OS_LOG_TYPE_INFO, "%{public}@[Flow: %@] Got list responses", &v13, 0x16u);
  }
...
id __100__HMDAccessoryAccessCodeReaderWriter__readAccessCodesFromAccessoriesWithUUIDs_HAP_withRetries_flow___block_invoke_3(uint64_t a1, void *a2)
{
  ...
  v19[1] = 3221225472;
  v19[2] = __100__HMDAccessoryAccessCodeReaderWriter__readAccessCodesFromAccessoriesWithUUIDs_HAP_withRetries_flow___block_invoke_105;
  v19[3] = &unk_27868A1B0;
  v20 = v4;
  v11 = v4;
...
id __92__HMDAccessoryAccessCodeReaderWriter__readConstraintsFromAccessory_Matter_withRetries_flow___block_invoke_4(id *a1, void *a2)
{
  ...
  if (os_log_type_enabled(v6, OS_LOG_TYPE_INFO))
  {
    ...
    v21 = 2112;
    v22 = v9;
    _os_log_impl(&dword_229538000, v6, OS_LOG_TYPE_INFO, "%{public}@[Flow: %@] All retries failed to read constraint from accessory: %@", &v17, 0x20u);
  }
...
- (id)_readConstraintsFromAccessoriesWithUUIDs_Matter:(id)a3 withRetries:(BOOL)a4 flow:(id)a5
{
  ...
  else
  {
    ...
    v26[1] = 3221225472;
    v26[2] = __103__HMDAccessoryAccessCodeReaderWriter__readConstraintsFromAccessoriesWithUUIDs_Matter_withRetries_flow___block_invoke;
    v26[3] = &unk_27866E688;
    v26[4] = v11;
    v28 = a4;
    v27 = v9;
    ...
    v23 = [MEMORY[0x277D2C938] immediateScheduler];
    v20 = [v22 combineAllFutures:v21 scheduler:v23];
  }
...
LABEL_23:
  ...
  v76 = v36[441];
  v58 = v76;
  v77 = __77__HMDAccessoryAccessCodeReaderWriter_performModificationRequest_Matter_flow___block_invoke_88;
  v78 = &unk_27866E638;
  v79 = v31;
  v80 = v35;
  v59 = v25;
  ...
  v73[1] = v58;
  v73[2] = __77__HMDAccessoryAccessCodeReaderWriter_performModificationRequest_Matter_flow___block_invoke_3_92;
  v73[3] = &unk_27866E660;
  v73[4] = v11;
  v74 = v59;
  v63 = v59;
...
- (id)performAccessCodeModificationRequests_Matter:(id)a3 withRetries:(BOOL)a4 flow:(id)a5
{
  ...
  v7 = a3;
  v8 = a5;
  v9 = [(HMDAccessoryAccessCodeReaderWriter *)self context];
  v10 = [v9 workQueue];
  ...
  else
  {
    ...
    v23 = 3221225472;
    v24 = __100__HMDAccessoryAccessCodeReaderWriter_performAccessCodeModificationRequests_Matter_withRetries_flow___block_invoke;
    v25 = &unk_27866E5E8;
    v26 = v12;
    v27 = v8;
    v17 = [v7 na_map:&v22];
    v18 = MEMORY[0x277D2C900];
    v19 = [MEMORY[0x277D2C938] immediateScheduler];
    v16 = [v18 combineAllFutures:v17 scheduler:v19];
  }
...
id __97__HMDAccessoryAccessCodeReaderWriter_performAccessCodeModificationRequests_HAP_withRetries_flow___block_invoke_84(uint64_t a1, void *a2)
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_INFO))
  {
    ...
    v17 = 2112;
    v18 = v4;
    _os_log_impl(&dword_229538000, v7, OS_LOG_TYPE_INFO, "%{public}@[Flow: %@] Received modification responses: %@", &v13, 0x20u);
  }
...
void __109__HMDAccessoryAccessCodeReaderWriter__readConstraintsAndAccessCodesFromAccessoriesWithUUIDs_flow_completion___block_invoke(id *a1, void *a2, void *a3)
{
  ...
  v24[0] = MEMORY[0x277D85DD0];
  v24[1] = 3221225472;
  v24[2] = __109__HMDAccessoryAccessCodeReaderWriter__readConstraintsAndAccessCodesFromAccessoriesWithUUIDs_flow_completion___block_invoke_78;
  v24[3] = &unk_27866E550;
  v19 = a1[5];
  v24[4] = a1[4];
  v25 = v19;
...
void __109__HMDAccessoryAccessCodeReaderWriter__readConstraintsAndAccessCodesFromAccessoriesWithUUIDs_flow_completion___block_invoke_78(uint64_t a1, void *a2, void *a3)
{
  ...
  if (v6)
  {
    ...
    if (os_log_type_enabled(v9, OS_LOG_TYPE_ERROR))
    {
      ...
      v21 = 2112;
      v22 = v6;
      _os_log_impl(&dword_229538000, v9, OS_LOG_TYPE_ERROR, "%{public}@[Flow: %@] Failed to read access codes from accessories with uuids: %@, error: %@", &v15, 0x2Au);
    }
...
- (id)removeAllAccessCodesWithValue_Matter:(id)a3 withUserUUID:(id)a4 guestName:(id)a5 flow:(id)a6
{
  ...
  objc_autoreleasePoolPop(v16);
  v21 = [(HMDAccessoryAccessCodeReaderWriter *)v17 context];
  v22 = [v21 UUIDsOfMatterAccessoriesSupportingAccessCodes];
  v31[0] = MEMORY[0x277D85DD0];
  v31[1] = 3221225472;
  v31[2] = __103__HMDAccessoryAccessCodeReaderWriter_removeAllAccessCodesWithValue_Matter_withUserUUID_guestName_flow___block_invoke;
  v31[3] = &unk_27866E4D8;
  v31[4] = v17;
  v32 = v10;
  v33 = v11;
...
+ (id)createWriteRequestForRemoveRequests:(id)a3 characteristic:(id)a4 flow:(id)a5
{
  ...
  else
  {
    ...
    v13 = [v8 na_map:&__block_literal_global_174];
...
+ (id)createWriteRequestForUpdateRequests:(id)a3 characteristic:(id)a4 flow:(id)a5
{
  ...
  else
  {
    ...
    v13 = [v8 na_map:&__block_literal_global_171];
    v14 = [objc_alloc(MEMORY[0x277CFE9C8]) initWithOperationType:v12 accessCodeControlRequest:v13 accessCodeControlResponse:0];
    v26 = 0;
    v15 = [v14 serializeWithError:&v26];
    v16 = v26;
...
+ (id)createWriteRequestForAddRequests:(id)a3 characteristic:(id)a4 flow:(id)a5
{
  ...
  else
  {
    ...
    v13 = [v8 na_map:&__block_literal_global_168];
    v14 = [objc_alloc(MEMORY[0x277CFE9C8]) initWithOperationType:v12 accessCodeControlRequest:v13 accessCodeControlResponse:0];
    v26 = 0;
    v15 = [v14 serializeWithError:&v26];
    v16 = v26;
...
+ (int64_t)hmPrivateErrorCodeForHAPAccessCodeError:(int64_t)a3
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(v8, OS_LOG_TYPE_ERROR))
    {
      ...
      v14 = 2112;
      v15 = v10;
      _os_log_impl(&dword_229538000, v8, OS_LOG_TYPE_ERROR, "%{public}@Encountered an error type that likely indicates a bug: %@", &v12, 0x16u);
    }
...
+ (id)createConstraintsFromReadResponses:(id)a3 readRequests:(id)a4 flow:(id)a5
{
  v8 = a3;
  v9 = a5;
  v10 = [a4 na_map:&__block_literal_global_142];
  v15[0] = MEMORY[0x277D85DD0];
  v15[1] = 3221225472;
    ...
    *&v10 = 138544130;
    ...
    do
    {
      for (i = 0; i != v35; ++i)
      {
        ...
        v14 = *(*(&v36 + 1) + 8 * i);
        v15 = [p_info + 51 _accessCodeControlFromWriteResponses:v7 forWriteRequest:v14 flow:{v9, v30}];
        v16 = v15;
        if (v15)
        {
          v17 = [v15 accessCodeControlResponse];
          v18 = [v17 na_map:&__block_literal_global_139];
      ...
      do
      {
        ...
        if (v17)
        {
          ...
          if (v18)
          {
            ...
            v24 = [v23 na_firstObjectPassingTest:&__block_literal_global_135];
            v25 = [v24 statusCode];
            v26 = [v25 value];
...
LABEL_10:
      _os_log_impl(&dword_229538000, v18, OS_LOG_TYPE_ERROR, v22, &v26, 0x2Au);
    }
