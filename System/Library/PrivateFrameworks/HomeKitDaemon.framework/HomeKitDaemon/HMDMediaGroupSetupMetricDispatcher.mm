...
- (void)timerDidFire:(id)fire
{
  ...
  if (activeGroupIdentifier)
  {
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_INFO))
    {
      ...
      v26 = 2112;
      v27 = v6;
      _os_log_impl(&dword_229538000, v19, OS_LOG_TYPE_INFO, "%{public}@Timer fired, submitting log event with duration: %llu error: %@", &v22, 0x20u);
    }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_INFO))
    {
      ...
      v22 = 138543362;
      v23 = v16;
      _os_log_impl(&dword_229538000, v15, OS_LOG_TYPE_INFO, "%{public}@Timer fired but no active metric type being tracked.", &v22, 0xCu);
    }
...
- (void)_submitLogEvent:(id)event error:(id)error
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    ...
    _os_log_impl(&dword_229538000, v10, OS_LOG_TYPE_INFO, "%{public}@Submitting log event: %@", &v15, 0x16u);
  }
...
- (void)_submitLogEventWithTotalDuration:(unint64_t)duration totalDurationSinceSetupSessionStart:(unint64_t)start error:(id)error
{
  ...
  if (dataSource)
  {
    if (os_log_type_enabled(v12, OS_LOG_TYPE_INFO))
    {
      ...
      *buf = 138543874;
      ...
      v27 = 2112;
      v28 = errorCopy;
      _os_log_impl(&dword_229538000, v13, OS_LOG_TYPE_INFO, "%{public}@Submitting log event: %llu error: %@", buf, 0x20u);
    }
  ...
  else
  {
    if (os_log_type_enabled(v12, OS_LOG_TYPE_ERROR))
    {
      ...
      *buf = 138543362;
      v24 = v21;
      _os_log_impl(&dword_229538000, v13, OS_LOG_TYPE_ERROR, "%{public}@Failed to get data source for metric event submission", buf, 0xCu);
    }
  ...
  if (type)
  {
    ...
    if (activeGroupIdentifier)
    {
      if (([(NSUUID *)activeGroupIdentifier hmf_isEqualToUUID:identifierCopy]& 1) != 0)
      {
        ...
        if (metricType == type)
        {
          ...
          if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
          {
            ...
            v49 = 2112;
            v50 = v18;
            _os_log_impl(&dword_229538000, v14, OS_LOG_TYPE_INFO, "%{public}@Request committed for group identifier %@ metric type: %@", &v45, 0x20u);
          }
        ...
        if (os_log_type_enabled(v24, OS_LOG_TYPE_ERROR))
        {
          ...
          v49 = 2112;
          v50 = v43;
          _os_log_impl(&dword_229538000, v24, OS_LOG_TYPE_ERROR, "%{public}@Dispatcher is tracking metric type %@ but ask to mark metric type %@", &v45, 0x20u);
        }
      }
      ...
      else
      {
        ...
        if (os_log_type_enabled(v24, OS_LOG_TYPE_ERROR))
        {
          ...
          v49 = 2112;
          v50 = v31;
          _os_log_impl(&dword_229538000, v24, OS_LOG_TYPE_ERROR, "%{public}@Tracking different group identifier: %@ active group identifier: %@", &v45, 0x20u);
        }
      }
    }
    ...
    else
    {
      ...
      if (os_log_type_enabled(v24, OS_LOG_TYPE_ERROR))
      {
        ...
        v47 = 2112;
        v48 = v28;
        _os_log_impl(&dword_229538000, v24, OS_LOG_TYPE_ERROR, "%{public}@No active setup tracking for metric type: %@", &v45, 0x16u);
      }
    }
...
LABEL_38:
  ...
  if (os_log_type_enabled(v21, OS_LOG_TYPE_ERROR))
  {
    ...
    v45 = 138543362;
    v46 = v22;
    _os_log_impl(&dword_229538000, v21, OS_LOG_TYPE_ERROR, "%{public}@Dispatcher cannot track unknown metric type for committed request", &v45, 0xCu);
  }
    ...
    if (self->_activeGroupIdentifier)
    {
      ...
      if (os_log_type_enabled(v15, OS_LOG_TYPE_ERROR))
      {
        ...
        *buf = 138543874;
        ...
        v53 = 2112;
        v54 = v20;
        _os_log_impl(&dword_229538000, v15, OS_LOG_TYPE_ERROR, "%{public}@Already has active setup tracking for metric identifier: %@ group type: %@", buf, 0x20u);
      }
    }
    ...
    else
    {
      ...
      if (!metricType)
      {
        ...
        if (os_log_type_enabled(v31, OS_LOG_TYPE_INFO))
        {
          ...
          *buf = 138544386;
          ...
          sCopy = s;
          v46 = v32;
          _os_log_impl(&dword_229538000, v31, OS_LOG_TYPE_INFO, "%{public}@Request received for group identifier %@ metric type: %@ session identifier: %@ setup start time: %llu", buf, 0x34u);
        }
        ...
        if (submissionTimer)
        {
          ...
          if (os_log_type_enabled(v38, OS_LOG_TYPE_INFO))
          {
            ...
            *buf = 138543362;
            v50 = v39;
            v44 = v39;
            _os_log_impl(&dword_229538000, v38, OS_LOG_TYPE_INFO, "%{public}@Resetting the submission timer", buf, 0xCu);
          }
      ...
      if (os_log_type_enabled(v15, OS_LOG_TYPE_ERROR))
      {
        ...
        *buf = 138543618;
        ...
        v51 = 2112;
        v52 = v30;
        _os_log_impl(&dword_229538000, v15, OS_LOG_TYPE_ERROR, "%{public}@Dispatcher already tracking metric type: %@", buf, 0x16u);
      }
    }
...
LABEL_21:
  ...
  if (os_log_type_enabled(v23, OS_LOG_TYPE_ERROR))
  {
    ...
    *buf = 138543362;
    v50 = v24;
    _os_log_impl(&dword_229538000, v23, OS_LOG_TYPE_ERROR, "%{public}@Dispatcher cannot track unknown metric type for request", buf, 0xCu);
  }
...
- (void)_resetActiveTracking
{
  ...
  if (os_log_type_enabled(v5, OS_LOG_TYPE_INFO))
  {
    ...
    _os_log_impl(&dword_229538000, v5, OS_LOG_TYPE_INFO, "%{public}@Reset active tracking for group identifier: %@", &v12, 0x16u);
  }
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t19_98637 != -1)
  {
    dispatch_once(&logCategory__hmf_once_t19_98637, &__block_literal_global_36_98638);
  }

  v3 = logCategory__hmf_once_v20_98639;
...
void __49__HMDMediaGroupSetupMetricDispatcher_logCategory__block_invoke()
{
  ...
  v2 = logCategory__hmf_once_v20_98639;
  logCategory__hmf_once_v20_98639 = v1;
}
