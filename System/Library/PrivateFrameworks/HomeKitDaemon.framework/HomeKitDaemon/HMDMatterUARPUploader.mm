...
- (BOOL)cancelAssetStagingForAccessory:(id)a3 asset:(id)a4
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
  {
    ...
    _os_log_impl(&dword_229538000, v10, OS_LOG_TYPE_ERROR, "%{public}@%s: This function should not be called for Matter accessories", &v14, 0x16u);
  }
...
- (BOOL)resumeAssetTransfersForAccessory:(id)a3
{
  ...
  if (os_log_type_enabled(v7, OS_LOG_TYPE_ERROR))
  {
    ...
    _os_log_impl(&dword_229538000, v7, OS_LOG_TYPE_ERROR, "%{public}@%s: This function should not be called for Matter accessories", &v11, 0x16u);
  }
...
- (BOOL)rescindStagedAssetsForAccessory:(id)a3 error:(id *)a4
{
  ...
  if (os_log_type_enabled(v8, OS_LOG_TYPE_ERROR))
  {
    ...
    _os_log_impl(&dword_229538000, v8, OS_LOG_TYPE_ERROR, "%{public}@%s: This function should not be called for Matter accessories", &v12, 0x16u);
  }
...
- (BOOL)offerAssetToAccessory:(id)a3 asset:(id)a4 error:(id *)a5
{
  ...
  if (os_log_type_enabled(v11, OS_LOG_TYPE_ERROR))
  {
    ...
    _os_log_impl(&dword_229538000, v11, OS_LOG_TYPE_ERROR, "%{public}@%s: This function should not be called for Matter accessories", &v15, 0x16u);
  }
