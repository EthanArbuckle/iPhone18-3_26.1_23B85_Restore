...
- (BOOL)_activate:(unint64_t)_activate completionHandler:(id)handler
{
  ...
  if (os_log_type_enabled(v9, OS_LOG_TYPE_INFO))
  {
    ...
    v22 = 2112;
    v23 = v12;
    _os_log_impl(&dword_229538000, v9, OS_LOG_TYPE_INFO, "%{public}@Updating the activation type from %@ to %@", &v18, 0x20u);
  }
...
- (void)_updateTriggerType
{
  ...
  if (objc_opt_isKindOfClass())
  {
    objc_storeStrong(&self->_triggerType, *MEMORY[0x277CD2308]);
  }

  objc_opt_class();
  if (objc_opt_isKindOfClass())
  {
    v3 = *MEMORY[0x277CD2300];
...
+ (id)logCategory
{
  if (logCategory__hmf_once_t0_167980 != -1)
  {
    dispatch_once(&logCategory__hmf_once_t0_167980, &__block_literal_global_167981);
  }

  v3 = logCategory__hmf_once_v1_167982;
...
void __23__HMDEvent_logCategory__block_invoke()
{
  ...
  v2 = logCategory__hmf_once_v1_167982;
  logCategory__hmf_once_v1_167982 = v1;
}
