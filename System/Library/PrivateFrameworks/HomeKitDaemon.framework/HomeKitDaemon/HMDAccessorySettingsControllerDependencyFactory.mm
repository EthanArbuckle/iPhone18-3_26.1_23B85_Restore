  ...
  if (!condition)
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_FAULT))
    {
      ...
      *buf = 138543618;
      ...
      v16 = 2112;
      v17 = messageCopy;
      _os_log_impl(&dword_229538000, v10, OS_LOG_TYPE_FAULT, "%{public}@Submitting ABC event for failure: %@", buf, 0x16u);
    }
...
- (id)createMessageHandlerWithQueue:(id)queue delegate:(id)delegate
{
  ...
  queueCopy = queue;
  v7 = [[HMDAccessorySettingsMessageHandlerRoar alloc] initWithQueue:queueCopy delegate:delegateCopy];
