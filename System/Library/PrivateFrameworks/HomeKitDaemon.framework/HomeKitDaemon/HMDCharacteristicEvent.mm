...
- (BOOL)_compareEventValue:(id)a3
{
  ...
  if (v5)
  {
    ...
    v8 = [HMDCharacteristicEventBase compareValueOfCharacteristic:v6 againstValue:v7 operatorType:&unk_283E74738];
    v9 = [v8 BOOLValue];
  }
...
- (BOOL)_evaluateNewValue:(id)a3
{
  ...
  if (v4 && [(HMDCharacteristicEvent *)self _compareEventValue:v4])
  {
    ...
    v8 = [(HMDCharacteristicEventBase *)self characteristic];
    v9 = [v8 type];
    v10 = [v7 shouldNotCacheCharacteristicOfType:v9];

    if ((v10 & 1) == 0)
    {
      v25 = [(HMDCharacteristicEventBase *)self characteristic];
      v26 = [HMDCharacteristicEventBase compareValueOfCharacteristic:v25 againstValue:v6 operatorType:&unk_283E74720];
      v11 = [v26 BOOLValue];
    }
...
LABEL_5:
  ...
  if (os_log_type_enabled(v14, OS_LOG_TYPE_INFO))
  {
    ...
    v17 = [(HMDCharacteristicEventBase *)v13 characteristic];
    v18 = [v17 value];
