...
- (void)_safari_enumerateCloudKitErrorsWithBlock:()SafariSharedCloudKitExtras
{
  ...
  if (v6)
  {
    v13 = 0;
    v4[2](v4, a1, &v13);
    if ((v13 & 1) == 0 && [a1 code] == 2)
    {
      v7 = [a1 userInfo];
      v8 = [v7 safari_dictionaryForKey:*MEMORY[0x1E695B798]];
...
- (uint64_t)safari_hasOrContainsErrorWithCloudKitErrorCode:()SafariSharedCloudKitExtras
{
  ...
  v5[4] = &v6;
  v5[5] = a3;
  [a1 _safari_enumerateCloudKitErrorsWithBlock:v5];
  v3 = *(v7 + 24);
...
{
  v1 = [a1 domain];
  v2 = [v1 isEqualToString:*MEMORY[0x1E695B740]];
...
- (uint64_t)safari_isCloudKitBatchTooLargeError
{
  result = [a1 safari_isInCloudKitErrorDomain];
  if (result)
  {
    return [a1 code] == 27;
  }
...
- (uint64_t)safari_isCloudKitMissingZoneError
{
  ...
  v3 = [a1 safari_matchesErrorDomainsAndCodes:v2];
...
- (uint64_t)safari_containsCloudKitMissingZoneErrorForRecordZoneID:()SafariSharedCloudKitExtras
{
  ...
  v8 = [v7 safari_isCloudKitMissingZoneError];
...
{
  v6 = a3;
  if ([a1 safari_isInCloudKitErrorDomain])
  {
    ...
    {
      v12 = [a1 userInfo];
      v13 = [v12 objectForKeyedSubscript:*MEMORY[0x1E695B798]];
...
- (id)safari_errorByAddingCloudKitPrivacyPreservingUserInfoForItemID:()SafariSharedCloudKitExtras
{
  ...
  if (v4)
  {
    v8 = [MEMORY[0x1E695BA20] itemErrorFromError:a1 forID:v4];
    v9 = v8;
    if (v8 && [v8 code] != 2)
    {
      v17 = v9;
  ...
  v10 = [a1 userInfo];
  v9 = [v10 objectForKeyedSubscript:*MEMORY[0x1E695B798]];
  ...
  if ([v9 count])
  {
    ...
    v16 = [MEMORY[0x1E696ABC0] errorWithDomain:v6 code:objc_msgSend(a1 userInfo:{"code"), v12}];
  ...
  v17 = a1;
LABEL_12:
  v16 = [v17 safari_errorByAddingRequestUUIDInPrivacyPreservingUserInfo];
LABEL_15:
...
- (id)safari_errorByAddingRequestUUIDInPrivacyPreservingUserInfo
{
  ...
  if (v4)
  {
    ...
    v10 = [MEMORY[0x1E696ABC0] errorWithDomain:v3 code:objc_msgSend(a1 userInfo:{"code"), v6}];
  }
