...
- (_TtC10SafariCore33WBSWebsitePasskeyAvailabilityInfo)initWithSupportsPasskeys:(BOOL)a3 enrollURL:(id)a4 manageURL:(id)a5;
@end
...
- (_TtC10SafariCore33WBSWebsitePasskeyAvailabilityInfo)initWithSupportsPasskeys:(BOOL)a3 enrollURL:(id)a4 manageURL:(id)a5
{
  ...
  *(&self->super.isa + OBJC_IVAR____TtC10SafariCore33WBSWebsitePasskeyAvailabilityInfo_supportsPasskeys) = a3;
  swift_beginAccess();
