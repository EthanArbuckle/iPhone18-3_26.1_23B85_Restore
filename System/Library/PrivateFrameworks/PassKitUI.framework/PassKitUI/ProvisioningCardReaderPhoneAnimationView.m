...
- (_TtC9PassKitUI40ProvisioningCardReaderPhoneAnimationView)initWithCoder:(id)a3;
- (_TtC9PassKitUI40ProvisioningCardReaderPhoneAnimationView)initWithFrame:(CGRect)a3;
- (void)layoutSubviews;
@end
