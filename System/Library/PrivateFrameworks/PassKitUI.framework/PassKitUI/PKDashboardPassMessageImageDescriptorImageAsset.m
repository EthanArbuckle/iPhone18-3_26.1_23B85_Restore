...
- (BOOL)isEqual:(id)a3;
- (PKDashboardPassMessageImageDescriptorImageAsset)initWithImage:(id)a3 tintColor:(id)a4 backgroundColor:(id)a5;
@end
...
- (PKDashboardPassMessageImageDescriptorImageAsset)initWithImage:(id)a3 tintColor:(id)a4 backgroundColor:(id)a5
{
  ...
  if (v9)
  {
    ...
    v10 = [(PKDashboardPassMessageImageDescriptor *)&v14 initWithType:0 tintColor:a4 backgroundColor:a5];
    v11 = v10;
    if (v10)
    {
