...
+ (id)buttonWithLabel:(int64_t)a3 style:(int64_t)a4
{
  v4 = [objc_alloc(objc_opt_class()) initWithLabel:a3 style:a4];
...
- (void)_sharedInit
{
  ...
  v22 = [(_PKIdentityButton *)self _singleLineTitle];
  ...
  v34 = [(_PKIdentityButton *)self _splitAttributedTitle];
  ...
  [(_PKIdentityButton *)self setAccessibilityLabel:v22];
...
- (void)encodeWithCoder:(id)a3
{
  ...
  [v4 encodeInteger:self->_style forKey:{@"PKIdentityButtonStyle", v5.receiver, v5.super_class}];
...
- (BOOL)_shouldAnimatePropertyWithKey:(id)a3
{
  ...
  else
  {
    ...
    v5 = [(_PKIdentityButton *)&v7 _shouldAnimatePropertyWithKey:v4];
  }
...
- (void)layoutSubviews
{
  ...
  v8 = v7;
  v10 = v9;
  v11 = [(_PKIdentityButton *)self _shouldReverseLayoutDirection];
  if (v11)
  {
    v12 = CGRectMaxXEdge;
  }
...
- (void)_adjustVisibleLabelWithBounds:(CGRect)a3
{
  v4 = [(_PKIdentityButton *)self _singleLineFitsSize:a3.size.width, a3.size.height];
