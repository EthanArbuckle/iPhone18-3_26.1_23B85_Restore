...
- (CGSize)size;
- (PKDynamicPaymentButtonWrapper)initWithCoder:(id)coder;
- (PKDynamicPaymentButtonWrapper)initWithFrame:(CGRect)frame;
- (PKDynamicPaymentButtonWrapper)initWithSize:(CGSize)size style:(int64_t)style type:(int64_t)type interfaceStyle:(int64_t)interfaceStyle request:(id)request action:(id)action;
- (id)action;
- (void)setupView;
@end
...
- (PKDynamicPaymentButtonWrapper)initWithFrame:(CGRect)frame
{
  ...
  v5 = [(PKDynamicPaymentButtonWrapper *)&v9 initWithFrame:frame.origin.x, frame.origin.y];
  v6 = v5;
  if (v5)
  {
    v5->_type = 0;
...
- (PKDynamicPaymentButtonWrapper)initWithCoder:(id)coder
{
  v9.receiver = self;
  v9.super_class = PKDynamicPaymentButtonWrapper;
  v3 = [(PKDynamicPaymentButtonWrapper *)&v9 initWithCoder:coder];
  v4 = v3;
  if (v3)
  {
    v3->_type = 0;
...
- (PKDynamicPaymentButtonWrapper)initWithSize:(CGSize)size style:(int64_t)style type:(int64_t)type interfaceStyle:(int64_t)interfaceStyle request:(id)request action:(id)action
{
  ...
  if (v18)
  {
    ...
    v19->_interfaceStyle = interfaceStyle;
