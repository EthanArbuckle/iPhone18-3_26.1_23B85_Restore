...
- (PKTextFieldTableViewSettingsRow)initWithIdentifier:(id)a3 title:(id)a4 value:(id)a5 formatter:(id)a6 changeHandler:(id)a7
{
  ...
  if (v17)
  {
    ...
    objc_storeStrong(&v17->_formatter, a6);
    v24 = [v16 copy];
...
- (id)tableViewCellForTableView:(id)a3 atIndexPath:(id)a4
{
  ...
  if (!v7)
  {
    v7 = [objc_alloc(MEMORY[0x1E69DD028]) initWithStyle:1000 reuseIdentifier:v6];
  }
...
- (void)_textFieldValueChanged:(id)a3
{
  ...
  if (formatter)
  {
    v4 = a3;
    v5 = [v4 text];
    v6 = [(PKTextFieldTableViewSettingsRowFormatter *)formatter formattedValueFromInput:v5];
