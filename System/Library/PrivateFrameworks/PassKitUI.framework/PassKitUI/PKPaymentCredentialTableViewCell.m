...
- (PKPaymentCredentialTableViewCell)initWithStyle:(int64_t)a3 reuseIdentifier:(id)a4
{
  ...
  if (v4)
  {
    v6 = [(PKPaymentCredentialTableViewCell *)v4 contentView];
...
- (void)layoutSubviews
{
  ...
  v3 = [(PKPaymentCredentialTableViewCell *)self _shouldReverseLayoutDirection];
  v4 = [(PKPaymentCredentialTableViewCell *)self contentView];
  [v4 frame];
  Width = CGRectGetWidth(v32);

  v6 = [(PKPaymentCredentialTableViewCell *)self snapshotImageView];
  v7 = v6;
  if (v3)
  {
    v8 = Width + -53.0 + -15.0;
  ...
  v11 = [(PKPaymentCredentialTableViewCell *)self textLabel];
  [v11 sizeToFit];
  [v11 frame];
  v14 = v13;
  if (v10 >= v12)
...
{
  width = a3.width;
  v5 = [(PKPaymentCredentialTableViewCell *)self textLabel:a3.width];
  v6 = [v5 font];
  [v6 lineHeight];
  v8 = v7 + 20.0;
...
- (void)setSnapshotImageHasBorder:(BOOL)a3
{
  if (self->_snapshotImageHasBorder != a3)
  {
    ...
    v6 = [(UIImageView *)self->_snapshotImageView layer];
...
- (void)prepareForReuse
{
  ...
  v3 = [(PKPaymentCredentialTableViewCell *)self textLabel];
  [v3 setText:0];
