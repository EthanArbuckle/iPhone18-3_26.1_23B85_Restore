...
- (PKPaymentPassActionViewModel)initWithAction:(id)action;
...
- (PKPaymentPassActionViewModel)initWithAction:(id)action
{
  actionCopy = action;
  v12.receiver = self;
  v12.super_class = PKPaymentPassActionViewModel;
...
- (id)copyWithZone:(_NSZone *)zone
{
  ...
  *(v5 + 16) = v6;
  ...
  v8 = [(PKPaymentPassAction *)self->_action copyWithZone:zone];
  v9 = *(v5 + 24);
  *(v5 + 24) = v8;
