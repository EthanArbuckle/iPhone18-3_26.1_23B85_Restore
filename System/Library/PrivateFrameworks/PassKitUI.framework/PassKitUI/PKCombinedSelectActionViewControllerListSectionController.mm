...
- (void)didSelectItem:(id)a3
{
  ...
  v5 = [(PKCombinedSelectActionViewControllerListSectionController *)self delegate];
...
{
  v5 = a3;
  v6 = [(PKCombinedSelectActionViewControllerListSectionController *)self defaultListLayout];
  [v6 setHeaderMode:1];
