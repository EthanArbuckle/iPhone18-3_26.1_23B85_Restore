...
- (id)dictionaryRepresentation
{
  ...
  {
    v5 = [objc_alloc(MEMORY[0x277CBEB18]) initWithCapacity:{-[NSMutableArray count](self->_audioRoutes, "count")}];
    v13 = 0u;
    v14 = 0u;
    v15 = 0u;
    v16 = 0u;
  ...
  if (v7)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        [(RMSAudioRoutesDidUpdateMessage *)self addAudioRoutes:*(*(&v11 + 1) + 8 * v10++), v11];
      }
