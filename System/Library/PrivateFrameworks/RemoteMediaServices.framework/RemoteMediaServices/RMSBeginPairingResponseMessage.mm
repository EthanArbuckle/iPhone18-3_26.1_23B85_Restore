...
- (id)description
{
  ...
  dictionaryRepresentation = [(RMSBeginPairingResponseMessage *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  if (has)
  {
    ...
    [dictionary setObject:v6 forKey:@"responseCode"];
  }
...
LABEL_11:
  ...
  if (*&self->_has)
  {
    if ((*(equalCopy + 16) & 1) == 0 || self->_responseCode != *(equalCopy + 2))
    {
      goto LABEL_11;
    }
