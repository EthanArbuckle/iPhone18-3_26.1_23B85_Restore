...
- (BOOL)isEqual:(id)a3
{
  ...
  if ((*&self->_has & 4) != 0)
  {
    if ((*(v4 + 32) & 4) == 0 || self->_likeState != *(v4 + 6))
    {
      goto LABEL_21;
    }
  }
...
LABEL_21:
  ...
  if ((*&self->_has & 2) != 0)
  {
    if ((*(v4 + 32) & 2) == 0 || self->_itemID != *(v4 + 2))
    {
      goto LABEL_21;
    }
  }
  ...
  if (*&self->_has)
  {
    if ((*(v4 + 32) & 1) == 0 || self->_databaseID != *(v4 + 1))
    {
      goto LABEL_21;
    }
  }
  ...
  if ((*&self->_has & 8) != 0)
  {
    if ((*(v4 + 32) & 8) == 0 || self->_sessionIdentifier != *(v4 + 7))
    {
      goto LABEL_21;
    }
