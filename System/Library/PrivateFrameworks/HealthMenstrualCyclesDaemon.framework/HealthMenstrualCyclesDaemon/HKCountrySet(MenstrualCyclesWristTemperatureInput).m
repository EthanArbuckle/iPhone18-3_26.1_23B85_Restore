...
+ (void)localAvailabilityForMenstrualCyclesWristTemperatureInput
{
  ...
  [v4 handleFailureInMethod:a1 object:a2 file:@"HKCountrySet+MenstrualCyclesWristTemperatureInput.m" lineNumber:40 description:@"Local generated country set should never be nil"];
}
