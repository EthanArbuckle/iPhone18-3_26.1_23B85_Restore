...
+ (void)localAvailabilityForMenstrualCyclesHeartRateInput
{
  ...
  [v4 handleFailureInMethod:a1 object:a2 file:@"HKCountrySet+MenstrualCyclesHeartRateInput.m" lineNumber:40 description:@"Local generated country set should never be nil"];
}
