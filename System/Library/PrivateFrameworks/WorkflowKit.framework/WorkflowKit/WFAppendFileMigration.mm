...
+ (BOOL)workflowNeedsMigration:(id)migration fromClientVersion:(id)version
{
  ...
  {
    HasActionsWithIdentifier = WFWorkflowHasActionsWithIdentifier(@"is.workflow.actions.file.append", migrationCopy);
  }
      ...
      for (i = 0; i != v4; ++i)
      {
        ...
        if ([v9 isEqualToString:@"is.workflow.actions.file.append"])
        {
          ...
          if (v15)
          {
            ...
            [v7 setObject:@"is.workflow.actions.dropbox.appendfile" forKey:actionIdentifierKey2];
          }
