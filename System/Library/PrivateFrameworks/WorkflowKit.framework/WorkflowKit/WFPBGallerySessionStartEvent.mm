...
- (void)mergeFrom:(id)from
{
  ...
  if (fromCopy[1])
  {
    [(WFPBGallerySessionStartEvent *)self setKey:?];
    fromCopy = v5;
  }

  if (fromCopy[2])
  {
    [(WFPBGallerySessionStartEvent *)self setSessionIdentifier:?];
    fromCopy = v5;
  }
}
...
- (id)description
{
  ...
  v8.receiver = self;
  v8.super_class = WFPBGallerySessionStartEvent;
  v4 = [(WFPBGallerySessionStartEvent *)&v8 description];
  dictionaryRepresentation = [(WFPBGallerySessionStartEvent *)self dictionaryRepresentation];
