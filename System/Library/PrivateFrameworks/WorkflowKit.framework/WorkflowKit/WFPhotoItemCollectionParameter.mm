...
- (WFPhotoItemCollectionParameter)initWithDefinition:(id)definition;
@end
...
- (WFPhotoItemCollectionParameter)initWithDefinition:(id)definition
{
  ...
  if (v5)
  {
    v6 = [definitionCopy objectForKey:@"PhotoItemCollectionPickerSelectionLimit"];
    v7 = objc_opt_class();
    v8 = WFEnforceClass_1501(v6, v7);
    v5->_selectionLimit = [v8 integerValue];

    v9 = [definitionCopy objectForKey:@"PhotoItemCollectionPickerMode"];
    v10 = objc_opt_class();
    ...
    v14 = [definitionCopy objectForKey:@"PhotoItemCollectionPickerFilter"];
    v15 = objc_opt_class();
