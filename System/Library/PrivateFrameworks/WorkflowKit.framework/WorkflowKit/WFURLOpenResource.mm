...
- (WFURLOpenResource)initWithDefinition:(id)definition;
- (void)dealloc;
...
- (void)dealloc
{
  ...
  [defaultCenter removeObserver:self name:@"WFResourceAvailabilityChangedNotification" object:v4];
...
- (WFURLOpenResource)initWithDefinition:(id)definition
{
  ...
  v3 = [(WFResource *)&v8 initWithDefinition:definition];
  if (v3)
  {
    defaultCenter = [MEMORY[0x1E696AD88] defaultCenter];
    v5 = +[(WFResource *)WFUserInteractionResource];
    [defaultCenter addObserver:v3 selector:sel_refreshAvailabilityWithNotification name:@"WFResourceAvailabilityChangedNotification" object:v5];
