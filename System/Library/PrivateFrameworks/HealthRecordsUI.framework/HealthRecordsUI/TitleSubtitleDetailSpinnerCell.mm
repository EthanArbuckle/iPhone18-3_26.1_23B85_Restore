...
- (_TtC15HealthRecordsUI30TitleSubtitleDetailSpinnerCell)initWithCoder:(id)coder
{
  ...
  *(&self->super.super.super.super.super.isa + OBJC_IVAR____TtC15HealthRecordsUI30TitleSubtitleDetailSpinnerCell____lazy_storage___spinner) = 0;
  v3 = self + OBJC_IVAR____TtC15HealthRecordsUI30TitleSubtitleDetailSpinnerCell_item;
  *v3 = 0u;
  *(v3 + 1) = 0u;
  *(v3 + 4) = 0;
