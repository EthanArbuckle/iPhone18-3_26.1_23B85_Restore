...
- (STLocationStatusDomainDisplayNameTransformerProvider)initWithEntityResolverProvider:(id)a3;
...
- (id)dataTransformerForClient:(id)a3
{
  ...
  if (!v7)
  {
    ...
    v7 = [(STLocationStatusDomainDisplayNameTransformer *)v10 initWithEntityResolver:v11];
