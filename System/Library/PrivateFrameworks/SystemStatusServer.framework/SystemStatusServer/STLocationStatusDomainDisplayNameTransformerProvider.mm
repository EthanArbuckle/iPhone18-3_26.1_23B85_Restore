...
- (STLocationStatusDomainDisplayNameTransformerProvider)initWithEntityResolverProvider:(id)provider;
...
- (STLocationStatusDomainDisplayNameTransformerProvider)init
{
  ...
  v4 = [(STLocationStatusDomainDisplayNameTransformerProvider *)self initWithEntityResolverProvider:v3];
...
- (STLocationStatusDomainDisplayNameTransformerProvider)initWithEntityResolverProvider:(id)provider
{
  ...
  v11.receiver = self;
  v11.super_class = STLocationStatusDomainDisplayNameTransformerProvider;
  v6 = [(STLocationStatusDomainDisplayNameTransformerProvider *)&v11 init];
  v7 = v6;
  if (v6)
  {
...
- (id)dataTransformerForClient:(id)client
{
  ...
  if (!v7)
  {
    ...
    v7 = [(STLocationStatusDomainDisplayNameTransformer *)v10 initWithEntityResolver:beginBatchResolutionSession];
