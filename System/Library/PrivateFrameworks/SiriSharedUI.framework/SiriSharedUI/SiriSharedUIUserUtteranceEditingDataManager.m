...
- (SiriSharedUIUserUtteranceEditingDataManager)initWithUserUtterance:(id)a3 backingAceObjectRefId:(id)a4
{
  ...
  if (v9)
  {
    objc_storeStrong(&v9->_userUtterance, a3);
    objc_storeStrong(&v10->_refId, a4);
    ...
    *&v13 = 136315650;
    ...
    do
    {
      ...
      do
      {
        ...
        v19 = [MEMORY[0x277D61B38] string:v17 isSameAsUserUtterance:{v8->_userUtterance, v43}];
        ...
        if ((v19 & 1) == 0 && v21)
        {
          ...
          if (v26)
          {
            ...
            do
            {
              for (i = 0; i != v27; ++i)
              {
                ...
                v30 = [*(*(&v57 + 1) + 8 * i) rangeValue];
                [v23 setAttributes:v7 range:{v30, v31}];
              }
          ...
          if (os_log_type_enabled(*MEMORY[0x277CEF098], OS_LOG_TYPE_DEFAULT))
          {
            ...
            v34 = v32;
            v35 = [v33 numberWithUnsignedInteger:{-[NSArray count](v53, "count") - 1}];
            *buf = v43;
            v66 = "[SiriSharedUIUserUtteranceEditingDataManager _createAlternativeDisplayStringsAndMap]";
            v67 = 2112;
            v68 = v23;
...
- (id)selectionResultsForAlternateTextAtIndex:(int64_t)a3
{
  ...
  {
    v5 = [(NSArray *)self->_alternativeDisplayStrings objectAtIndex:a3];
    v6 = [v5 string];

    v7 = [(NSMutableDictionary *)self->_userSelectionResultsMap objectForKey:v6];
