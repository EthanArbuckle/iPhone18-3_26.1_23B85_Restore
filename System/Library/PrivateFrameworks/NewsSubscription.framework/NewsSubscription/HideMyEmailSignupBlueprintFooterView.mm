...
- (_TtC16NewsSubscription36HideMyEmailSignupBlueprintFooterView)initWithCoder:(id)a3
{
  ...
  *(&self->super.super.super.isa + v4) = [objc_allocWithZone(sub_1D78B4524()) initWithFrame_];
  v5 = OBJC_IVAR____TtC16NewsSubscription36HideMyEmailSignupBlueprintFooterView_privacyLabel;
  type metadata accessor for UnselectableLinkEnabledTextView();
  *(&self->super.super.super.isa + v5) = [objc_allocWithZone(swift_getObjCClassFromMetadata()) initWithFrame_];
