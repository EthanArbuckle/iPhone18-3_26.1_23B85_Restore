...
- (_TtC16NewsSubscription30HideMyEmailSignupAlternateView)initWithCoder:(id)coder
{
  ...
  *(&self->super.super.super.isa + v4) = [objc_allocWithZone(MEMORY[0x1E69DCC10]) initWithFrame_];
  v5 = OBJC_IVAR____TtC16NewsSubscription30HideMyEmailSignupAlternateView_checkmark;
  *(&self->super.super.super.isa + v5) = [objc_allocWithZone(MEMORY[0x1E69DCAE0]) initWithFrame_];
