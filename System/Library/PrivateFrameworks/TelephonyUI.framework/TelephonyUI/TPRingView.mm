...
- (TPRingView)initWithFrame:(CGRect)frame;
...
+ (CGSize)ringSize
{
  ...
  *&v8 = 75.0;
  if (v4 <= v7)
  {
    ...
    v8 = *(&unk_1B48EBDA0 + ((userInterfaceIdiom2 & 0xFFFFFFFFFFFFFFFBLL) == 1));
  }
...
- (void)setEnabled:(BOOL)enabled
{
  ...
  {
    currentDevice = [MEMORY[0x1E69DC938] currentDevice];
    v9 = flt_1B48EBD90[[currentDevice _graphicsQuality] == 10];
  }
...
- (TPRingView)initWithFrame:(CGRect)frame
{
  ...
  v3 = [(TPRingView *)&v60 initWithFrame:frame.origin.x, frame.origin.y, frame.size.width, frame.size.height];
  v4 = v3;
  if (v3)
  {
    ...
    [(TPRingView *)v4 setBackgroundColor:clearColor];

    layer = [(TPRingView *)v4 layer];
    [layer setAllowsGroupBlending:0];

    layer2 = [(TPRingView *)v4 layer];
