...
- (void)_deviceFound:(id)a3 altPairedInfo:(id)a4 recheck:(BOOL)a5 event:(int64_t)a6
{
  ...
  v13 = [v10 objectForKeyedSubscript:@"name"];
...
LABEL_38:
        ...
        if (v60)
        {
          [(APBonjourCacheManager *)self _updateCachedDeviceInfoWhenRealDeviceIsFound:v10 event:v61];
          goto LABEL_74;
        }
        ...
        [(APBonjourCacheManager *)self _auditCachesIfNecessary:v10 event:v61];
        v42 = self->_ucat->var0;
...
LABEL_73:
        v37 = v26;
        [(APBonjourCacheManager *)self _addDeviceToCache:v10 pairedPeerInfo:v26 event:v61, v53, v54, v55, v57];
        goto LABEL_74;
      }
...
LABEL_75:
    ...
    if (v35 <= 30)
    {
      ...
      v56 = [(CUSystemMonitor *)self->_systemMonitor primaryNetworkSignature];
      LogPrintF();
...
LABEL_5:
  [(APBonjourCacheManager *)self _deviceFound:v15 altPairedInfo:v6 recheck:1 event:6, v13, v14];
}
...
LABEL_11:
    ...
    if (v8 <= 30)
    {
      ...
      {
LABEL_5:
        v16 = [v18 objectForKeyedSubscript:@"name"];
        LogPrintF();
...
{
  v6 = a3;
  v3 = [v6 objectForKeyedSubscript:@"dnsName"];
  v4 = [v3 rangeOfString:@"%"];
  if (v4 < [v3 length])
  {
...
{
  v12 = a3;
  v4 = [v12 objectForKeyedSubscript:@"services"];
  v5 = [v4 mutableCopy];
...
- (void)_networkSignatureChanged
{
  ...
  [(APBonjourCacheManager *)self _ensureKnownNetworkProfileMonitoringStarted];
  v3 = [(CUSystemMonitor *)self->_systemMonitor primaryNetworkSignature];
  networkSignature = self->_networkSignature;
  v17 = v3;
  v5 = networkSignature;
  v6 = v5;
...
LABEL_22:
      ...
      v12 = [(APBonjourCacheManager *)self _readCachedItems];
      cachedItems = self->_cachedItems;
...
- (void)_updateLastSeenTimestamp:(id)a3
{
  ...
  if (v9 <= 30)
  {
    ...
    [v17 objectForKeyedSubscript:@"name"];
    v16 = v15 = v10;
    LogPrintF();
  }
...
LABEL_21:
    ...
    v12 = [v37 objectForKeyedSubscript:@"name"];
    if ([v10 isEqualToString:v12])
    {
      ...
      v14 = a4;
      v16 = v15 = v11;
      v17 = [v37 objectForKeyedSubscript:@"txt"];
      v18 = [v16 isEqual:v17];
...
LABEL_16:
        ...
        [(APBonjourCacheManager *)self _updateLastSeenTimestamp:v37];
        v29 = [v9 mutableCopy];
    ...
    v19 = [v9 mutableCopy];
    v20 = [v37 objectForKeyedSubscript:@"name"];
    [v19 setObject:v20 forKey:@"name"];

    v21 = [v37 objectForKeyedSubscript:@"txt"];
    [v19 setObject:v21 forKey:@"txt"];

    v22 = [v37 objectForKeyedSubscript:@"services"];
...
- (void)_migrateCacheDirectoryIfNecessary
{
  ...
  if (!v3)
  {
    [(APBonjourCacheManager *)v68 _migrateCacheDirectoryIfNecessary];
    v7 = v82;
    goto LABEL_74;
  }
  ...
  v5 = [MEMORY[0x277CCAA00] defaultManager];
  v80 = v4;
  v6 = [v5 URLForDirectory:13 inDomain:1 appropriateForURL:0 create:0 error:&v80];
  v7 = v80;
  ...
  do
  {
    ...
    do
    {
      ...
      v63 = v11;
      v14 = [v12 path];
      v15 = [v65 fileExistsAtPath:v14 isDirectory:0];
...
LABEL_20:
      v18 = [v67 path];
      v75 = v7;
      v19 = [v65 contentsOfDirectoryAtPath:v18 error:&v75];
      v20 = v75;
...
LABEL_32:
              v29 = [v23 path];
              v30 = [v29 stringByAppendingPathComponent:v27];
              v31 = [v66 path];
              [v31 stringByAppendingPathComponent:v27];
              v59 = v58 = v30;
              LogPrintF();
          ...
          v33 = [v23 path];
          v34 = [v33 stringByAppendingPathComponent:v27];
          v35 = [v66 path];
          v36 = [v35 stringByAppendingPathComponent:v27];
          v70 = 0;
          [v65 moveItemAtPath:v34 toPath:v36 error:&v70];
          v37 = v70;
...
LABEL_38:
            ...
            v40 = [v67 path];
            v41 = [v40 stringByAppendingPathComponent:v27];
            [v65 removeItemAtPath:v41 error:0];
...
LABEL_52:
      ...
      v46 = [v23 path];
      v47 = [v65 contentsOfDirectoryAtPath:v46 error:0];
      v48 = [v47 count];
...
LABEL_55:
        ...
        v51 = [v67 path];
        v69 = 0;
        [v65 removeItemAtPath:v51 error:&v69];
        v20 = v69;
...
- (void)_auditCachesIfNecessary:(id)a3 event:(int64_t)a4
{
  ...
  if (var0 <= 30)
  {
    ...
    v10 = APBonjourCacheEventToString(a4);
    v11 = "yes";
    if (!v6)
    {
      v11 = "no";
...
LABEL_12:
  ...
  v17 = [v14 path];
  v63 = v15;
  v18 = [v16 contentsOfDirectoryAtPath:v17 error:&v63];
  v19 = v63;
