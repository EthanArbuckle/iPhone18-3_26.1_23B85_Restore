...
+ (void)localAvailabilityForHearingAid
{
  ...
  [currentHandler handleFailureInMethod:self object:a2 file:@"HKCountrySet+HearingAid.m" lineNumber:40 description:@"Local generated country set should never be nil"];
}
