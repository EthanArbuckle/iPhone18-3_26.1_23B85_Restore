...
- (INInformationUseCaseParameter)initWithCoder:(id)a3;
- (INInformationUseCaseParameter)initWithIdentifier:(id)a3 displayString:(id)a4 pronunciationHint:(id)a5;
@end
...
- (INInformationUseCaseParameter)initWithCoder:(id)a3
{
  ...
  v4 = a3;
  v5 = [(INInformationUseCaseParameter *)&v7 initWithCoder:v4];
