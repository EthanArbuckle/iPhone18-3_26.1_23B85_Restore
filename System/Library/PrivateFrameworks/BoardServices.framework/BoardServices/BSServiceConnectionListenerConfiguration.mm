...
+ (id)configurationWithDomain:(id)a3 service:(id)a4;
+ (id)configurationWithDomain:(id)a3 service:(id)a4 instance:(id)a5;
- (os_unfair_lock_s)initWithConfigurator:(void *)a1;
