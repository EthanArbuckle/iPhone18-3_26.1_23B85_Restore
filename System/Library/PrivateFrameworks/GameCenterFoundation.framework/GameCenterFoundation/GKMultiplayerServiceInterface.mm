...
+ (void)configureInterface:(id)a3
{
  ...
  [v24 setClasses:v14 forSelector:sel_putMultiPlayerGroup_participants_playedAt_bundleID_numberOfAutomatched_isSharedLink_completionHandler_ argumentIndex:0 ofReply:0];

  v15 = MEMORY[0x277CBEB98];
  v16 = objc_opt_class();
  v17 = [v15 setWithObjects:{v16, objc_opt_class(), 0}];
  [v24 setClasses:v17 forSelector:sel_putMultiPlayerGroup_participants_playedAt_bundleID_numberOfAutomatched_isSharedLink_completionHandler_ argumentIndex:1 ofReply:0];

  v18 = MEMORY[0x277CBEB98];
  v19 = objc_opt_class();
  v20 = [v18 setWithObjects:{v19, objc_opt_class(), 0}];
  [v24 setClasses:v20 forSelector:sel_putMultiPlayerGroup_participants_playedAt_bundleID_numberOfAutomatched_isSharedLink_completionHandler_ argumentIndex:3 ofReply:0];
