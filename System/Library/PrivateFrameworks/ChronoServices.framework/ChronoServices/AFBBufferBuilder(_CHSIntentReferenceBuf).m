...
- (id)_chsCreateIntentReferenceBufUsingBlock:()_CHSIntentReferenceBuf
{
  ...
  if (!v5)
  {
    ...
    [v10 handleFailureInMethod:a2 object:a1 file:@"_CHSRelevanceCache_generated.mm" lineNumber:2443 description:{@"Invalid parameter not satisfying: %@", @"block"}];
  }

  [a1 throwIfFinalizedWithSelector:a2];
  v7 = [[_CHSIntentReferenceBufBuilder alloc] initWithBufferBuilder:a1];
  v5[2](v5, v7);
...
- (id)_chsFinishedBufferWithRootIntentReferenceBufOfs:()_CHSIntentReferenceBuf error:
{
  ...
  if (!v7)
  {
    ...
    [v17 handleFailureInMethod:a2 object:a1 file:@"_CHSRelevanceCache_generated.mm" lineNumber:2465 description:{@"Invalid parameter not satisfying: %@", @"ofs"}];
  }
  ...
  else
  {
    ...
    v19 = 0;
    v12 = [a1 _chsFinishBufferWithRootIntentReferenceBufOfs:v7 error:&v19];
    v13 = v19;
    if (v12)
    {
      v18 = v13;
...
- (uint64_t)_chsFinishBufferWithRootIntentReferenceBufOfs:()_CHSIntentReferenceBuf error:
{
  ...
  if (!v7)
  {
    ...
    [v20 handleFailureInMethod:a2 object:a1 file:@"_CHSRelevanceCache_generated.mm" lineNumber:2499 description:{@"Invalid parameter not satisfying: %@", @"ofs"}];
  }
