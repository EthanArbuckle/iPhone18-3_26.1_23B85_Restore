...
- (id)_chsCreateWidgetRelevanceBufUsingBlock:()_CHSWidgetRelevanceBuf
{
  ...
  if (!v5)
  {
    ...
    [currentHandler handleFailureInMethod:a2 object:self file:@"_CHSRelevanceCache_generated.mm" lineNumber:1921 description:{@"Invalid parameter not satisfying: %@", @"block"}];
  }

  [self throwIfFinalizedWithSelector:a2];
  v7 = [[_CHSWidgetRelevanceBufBuilder alloc] initWithBufferBuilder:self];
  v5[2](v5, v7);
...
- (id)_chsFinishedBufferWithRootWidgetRelevanceBufOfs:()_CHSWidgetRelevanceBuf error:
{
  ...
  {
    currentHandler = [MEMORY[0x1E696AAA8] currentHandler];
    [currentHandler handleFailureInMethod:a2 object:self file:@"_CHSRelevanceCache_generated.mm" lineNumber:1943 description:{@"Invalid parameter not satisfying: %@", @"ofs"}];
  }
  ...
  else
  {
    ...
    v19 = 0;
    v12 = [self _chsFinishBufferWithRootWidgetRelevanceBufOfs:v7 error:&v19];
    v13 = v19;
    if (v12)
    {
      v18 = v13;
...
- (uint64_t)_chsFinishBufferWithRootWidgetRelevanceBufOfs:()_CHSWidgetRelevanceBuf error:
{
  ...
  {
    currentHandler = [MEMORY[0x1E696AAA8] currentHandler];
    [currentHandler handleFailureInMethod:a2 object:self file:@"_CHSRelevanceCache_generated.mm" lineNumber:1977 description:{@"Invalid parameter not satisfying: %@", @"ofs"}];
  }
