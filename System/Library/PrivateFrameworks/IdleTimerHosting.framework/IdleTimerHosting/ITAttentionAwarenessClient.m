...
- (void)_access_resume
{
  ...
  v3 = [(AWAttentionAwarenessClient *)self->_access_attentionAwarenessClient configuration];
  v4 = ITLogIdleTimer();
...
- (id)_initWithCalloutQueue:(id)a3 attentionAwarenessClient:(id)a4
{
  ...
  if (v8)
  {
    ...
    objc_storeStrong(&v8->_access_attentionAwarenessClient, a4);
...
- (void)_access_suspend
{
  ...
  if ((v5 & 1) == 0)
  {
    v7 = [(AWAttentionAwarenessClient *)self->_access_attentionAwarenessClient configuration];
    v8 = ITLogIdleTimer();
...
- (void)_handleAttentionAwarenessEvent:(id)a3
{
  ...
  if (v10)
  {
    ...
    else
    {
      ...
      {
        [(ITAttentionAwarenessClient *)v4 _handleAttentionAwarenessEvent:v11];
      }
