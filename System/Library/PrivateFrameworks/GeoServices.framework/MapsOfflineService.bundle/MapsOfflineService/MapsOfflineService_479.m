...
void sub_19A1248()
{
  ...
  *algn_27ECD68 = 0;
  qword_27ECD70 = 0;
  sub_68678C(&qword_27ECD60, __p, &v4, 1uLL);
  if (v3 < 0)
  {
  ...
  unk_27ECD80 = 0;
  qword_27ECD88 = 0;
  sub_68678C(&qword_27ECD78, __p, &v4, 1uLL);
  if (v3 < 0)
  {
    operator delete(__p[0]);
  }
  ...
  *algn_27ECD98 = 0;
  qword_27ECDA0 = 0;
  sub_68678C(&qword_27ECD90, __p, &v4, 1uLL);
  if (v3 < 0)
  {
    operator delete(__p[0]);
  }
...
void sub_19A1C40(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, void **a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, uint64_t a16, uint64_t a17, char a18)
{
  a10 = &a18;
  sub_19A240C(&a10);
  sub_19A2570(&a10);
...
uint64_t sub_19A1DD0(uint64_t a1, uint64_t *a2)
{
  v3 = *(a1 + 8);
  if (v3 >= *(a1 + 16))
  {
...
uint64_t sub_19A1E10(uint64_t result, int *a2, int *a3)
{
  if (a2 != a3)
  {
    ...
    do
    {
      result = sub_19A26BC(v5, v5 + 1, v4 + 7);
      v6 = *(v4 + 1);
      if (v6)
      {
        do
...
void sub_19A1F94(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, ...)
{
  va_start(va, a4);
  sub_19A20EC(va);
  _Unwind_Resume(a1);
...
uint64_t sub_19A2190(uint64_t a1, uint64_t *a2)
{
...
void sub_19A22AC(_Unwind_Exception *a1, uint64_t a2, ...)
{
  va_start(va, a2);
  sub_19A24E8(va);
  _Unwind_Resume(a1);
...
void sub_19A2328(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, void **a9)
{
  *(v9 + 8) = v10;
  sub_19A240C(&a9);
  _Unwind_Resume(a1);
...
uint64_t sub_19A26BC(void *a1, uint64_t *a2, int *a3)
{
...
void sub_19A284C()
{
  ...
  sub_1966280(qword_27ECE58, v1247, 249);
  v0 = &v1496;
  v1 = -13944;
  do
  {
...
void sub_19AD308()
{
  ...
  *algn_27ECE18 = 0;
  qword_27ECE20 = 0;
  sub_68678C(&qword_27ECE10, __p, &v2, 1uLL);
  if (v1 < 0)
  {
    operator delete(__p[0]);
  }
  ...
  unk_27ECE30 = 0;
  qword_27ECE38 = 0;
  sub_68678C(&qword_27ECE28, __p, &v2, 1uLL);
  if (v1 < 0)
  {
    operator delete(__p[0]);
  }
  ...
  *algn_27ECE48 = 0;
  qword_27ECE50 = 0;
  sub_68678C(&qword_27ECE40, __p, &v2, 1uLL);
  if (v1 < 0)
  {
    operator delete(__p[0]);
  }
...
void sub_19AD58C(char a1, double a2, double a3)
{
  sub_1F71298(a1, a2, a3);
  sub_19ADB7C(&__p);
  std::operator+<char>();
  if (v4 < 0)
  {
...
uint64_t sub_19AD89C@<X0>(char **a1@<X0>, int a2@<W1>, void *a3@<X8>)
{
  *a3 = 0;
  a3[1] = 0;
  a3[2] = 0;
...
void sub_19ADA3C(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, ...)
{
  va_start(va, a4);
  sub_195E3E8(va);
  _Unwind_Resume(a1);
...
uint64_t sub_19ADB7C@<X0>(_BYTE *a1@<X8>)
{
  sub_19594F8(&v8);
...
void sub_19ADDBC(_Unwind_Exception *a1, uint64_t a2, ...)
{
  va_start(va, a2);
  std::ios::~ios();
  _Unwind_Resume(a1);
...
void *sub_19ADDE0(void *result, unint64_t a2)
{
...
uint64_t sub_19ADE9C(uint64_t a1, void **a2, size_t *a3)
{
