...
void sub_209AFB0()
{
  ...
  unk_27F16C0 = 0;
  qword_27F16C8 = 0;
  sub_68678C(&qword_27F16B8, __p, &v4, 1uLL);
  if (v3 < 0)
  {
    operator delete(__p[0]);
  }
  ...
  *algn_27F16D8 = 0;
  qword_27F16E0 = 0;
  sub_68678C(&qword_27F16D0, __p, &v4, 1uLL);
  if (v3 < 0)
  {
    operator delete(__p[0]);
  }
  ...
  unk_27F16F0 = 0;
  qword_27F16F8 = 0;
  sub_68678C(&qword_27F16E8, __p, &v4, 1uLL);
  if (v3 < 0)
  {
    operator delete(__p[0]);
  }
...
void sub_209B868(const void **a1@<X0>, int a2@<W1>, uint64_t a3@<X2>, uint64_t a4@<X3>, uint64_t **a5@<X4>, uint64_t a6@<X5>, void *a7@<X8>)
{
  if (a2 <= 0)
  {
    *a7 = 0;
  ...
  if (v14)
  {
    ...
    sub_209BA3C(a2, &__p, a3, a4, a5, 6u, a6, a7);
    if (v19 < 0)
    {
      operator delete(v18);
    }
...
void sub_209BA3C(int a1@<W1>, const std::string *a2@<X2>, uint64_t a3@<X3>, uint64_t a4@<X4>, uint64_t **a5@<X5>, unsigned int a6@<W6>, uint64_t a7@<X7>, void *a8@<X8>)
{
  *a8 = 0;
  a8[1] = 0;
  a8[2] = 0;
...
void sub_209BEC4(uint64_t a1@<X0>, int a2@<W1>, uint64_t a3@<X2>, uint64_t a4@<X3>, uint64_t **a5@<X4>, uint64_t a6@<X5>, void *a7@<X8>)
{
  *a7 = 0;
  a7[1] = 0;
  a7[2] = 0;
...
void sub_209C0F0(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, ...)
{
  va_start(va, a4);
  sub_1961C3C(va);
  _Unwind_Resume(a1);
...
void sub_209C270(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, ...)
{
  va_start(va, a4);
  sub_19600F4(va);
  _Unwind_Resume(a1);
...
void sub_209C2F8()
{
  ...
  sub_1966280(qword_27F17B0, v1247, 249);
  v0 = &v1496;
  v1 = -13944;
  do
  {
...
void sub_20A6DB4()
{
  ...
  unk_27F1770 = 0;
  qword_27F1778 = 0;
  sub_68678C(&qword_27F1768, __p, &v4, 1uLL);
  if (v3 < 0)
  {
    operator delete(__p[0]);
  }
  ...
  *algn_27F1788 = 0;
  qword_27F1790 = 0;
  sub_68678C(&qword_27F1780, __p, &v4, 1uLL);
  if (v3 < 0)
  {
    operator delete(__p[0]);
  }
  ...
  unk_27F17A0 = 0;
  qword_27F17A8 = 0;
  sub_68678C(&qword_27F1798, __p, &v4, 1uLL);
  if (v3 < 0)
  {
    operator delete(__p[0]);
  }
...
void sub_20A75E0(uint64_t a1, void *a2, int a3, uint64_t a4, _DWORD *a5)
{
  ...
  else
  {
    ...
    if (*a5 != 2)
    {
      ...
      sub_1B10CDC(&v17 + 8, 0);
      v20 = 0;
      sub_198B0D0(a1 + 24, v23, __p);
      sub_19E3C78(&v17 + 8, __p);
      sub_1B11224(__p);
      if (!sub_570C4C(&v17 + 2))
      {
        sub_1E12EF4(&v16, *(&v16 + 1), *a1, *(a1 + 8), (*(a1 + 8) - *a1) >> 5);
        if (SHIBYTE(v22) < 0)
        {
...
uint64_t sub_20A79E8(uint64_t result, __int128 *a2)
{
  v3 = result;
  v4 = *(result + 8);
  v5 = *(result + 16);
...
void sub_20A7B08(__int128 **a1@<X0>, void *a2@<X8>)
{
  v3 = *a1;
  if (a1[1] == *a1)
  {
...
uint64_t *sub_20A7E20@<X0>(uint64_t *result@<X0>, void *a2@<X8>)
{
  a2[2] = 0;
  a2[1] = 0;
  *a2 = a2 + 1;
