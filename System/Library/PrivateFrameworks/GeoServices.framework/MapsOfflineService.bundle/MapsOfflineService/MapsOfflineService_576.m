...
void sub_210B1B0()
{
  ...
  unk_27F1C00 = 0;
  qword_27F1C08 = 0;
  sub_68678C(&qword_27F1BF8, __p, &v4, 1uLL);
  if (v3 < 0)
  {
  ...
  *algn_27F1C18 = 0;
  qword_27F1C20 = 0;
  sub_68678C(&qword_27F1C10, __p, &v4, 1uLL);
  if (v3 < 0)
  {
    operator delete(__p[0]);
  }
  ...
  unk_27F1C30 = 0;
  qword_27F1C38 = 0;
  sub_68678C(&qword_27F1C28, __p, &v4, 1uLL);
  if (v3 < 0)
  {
    operator delete(__p[0]);
  }
  ...
  v30 = 4;
  sub_19664AC(&unk_27F1C58, __p, 14);
  v0 = 56;
  do
  {
    if (*(&__p[v0 - 1] - 1) < 0)
  ...
  sub_3608D0(v69, "EG");
  v70 = 6;
  sub_1966844(&unk_27F1C80, __p, 34);
  v1 = 136;
  do
  {
    if (*(&__p[v1 - 1] - 1) < 0)
...
void sub_210B850(_Unwind_Exception *exception_object, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, void *__p, uint64_t a11, int a12, __int16 a13, char a14, char a15)
{
  v17 = (v15 + 1079);
  v18 = -1088;
  v19 = v17;
...
BOOL sub_210B9DC(void *a1)
{
  result = sub_1A3BC44(a1);
  if (result)
  {
    return *(a1[22] + 24) >= *(a1[20] - 32);
  }

  return result;
}

void sub_210BA1C(uint64_t a1@<X0>, std::string *a2@<X8>)
{
  sub_3608D0(a2, "");
  if ((*(a1 + 4) & 1) == 0)
  {
    sub_1F7C95C(a1 + 8, __p);
    if ((v7 & 0x80u) == 0)
    {
      v4 = __p;
    }
...
void sub_210BAA8(_Unwind_Exception *exception_object, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, void *__p, uint64_t a11, int a12, __int16 a13, char a14, char a15)
{
  if (a15 < 0)
  {
    operator delete(__p);
...
void sub_210BADC(uint64_t a1@<X0>, void *a2@<X8>)
{
  sub_210BB84(v6, *(a1 + 8));
  sub_210BB84(__p, *(a1 + 24));
  sub_83F92C(v6, __p, a2);
  if (v5 < 0)
  {
    operator delete(__p[0]);
  }
...
void sub_210BB50(_Unwind_Exception *exception_object, int a2, int a3, int a4, int a5, int a6, int a7, int a8, void *__p, uint64_t a10, int a11, __int16 a12, char a13, char a14, void *a15, uint64_t a16, int a17, __int16 a18, char a19, char a20)
{
  if (a14 < 0)
  {
    operator delete(__p);
...
void sub_210BB84(uint64_t a1@<X0>, std::string *a2@<X8>)
{
  v4 = *(a1 + 296);
  if (v4 <= 2)
  {
    switch(v4)
    {
      ...
      case 2:
        ...
        {
          *&a2->__r_.__value_.__l.__data_ = *(a1 + 8);
          a2->__r_.__value_.__r.__words[2] = *(a1 + 24);
        }
...
LABEL_24:
    v6 = sub_4A5C(&std::cerr, "type is not supported ", 22);
    sub_210BF60(a1, __p);
    if ((v14 & 0x80u) == 0)
    {
      v7 = __p;
...
void sub_210BE8C(_Unwind_Exception *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, void *__p, uint64_t a10, int a11, __int16 a12, char a13, char a14, std::locale a15)
{
...
void sub_210BEB8(uint64_t a1@<X0>, void *a2@<X8>)
{
  sub_210BB84(v6, *(a1 + 8));
  sub_210BB84(__p, *(a1 + 24));
  sub_83F92C(v6, __p, a2);
...
void sub_210BF2C(_Unwind_Exception *exception_object, int a2, int a3, int a4, int a5, int a6, int a7, int a8, void *__p, uint64_t a10, int a11, __int16 a12, char a13, char a14, void *a15, uint64_t a16, int a17, __int16 a18, char a19, char a20)
{
  if (a14 < 0)
  {
    operator delete(__p);
...
_BYTE *sub_210BF60@<X0>(uint64_t a1@<X0>, _BYTE *a2@<X8>)
{
  v4 = *(a1 + 296);
  if (v4 > 6)
  {
  ...
  return sub_3608D0(a2, v5);
}

float sub_210BF90(_DWORD *a1)
{
  v1 = a1[74];
  result = -1.0;
  if (v1 > 2)
...
void sub_210C03C()
{
  ...
  sub_1966280(qword_27F1CF0, v1247, 249);
  v0 = &v1496;
  v1 = -13944;
  do
  {
...
void sub_2113024(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, void *__p, uint64_t a11, int a12, __int16 a13, char a14, char a15, uint64_t a16, void *a17, uint64_t a18, int a19, __int16 a20, char a21, char a22, void *a23, uint64_t a24, int a25, __int16 a26, char a27, char a28, uint64_t a29, void *a30, uint64_t a31, int a32, __int16 a33, char a34, char a35, void *a36, uint64_t a37, int a38, __int16 a39, char a40, char a41, uint64_t a42, uint64_t a43, uint64_t a44, int a45, __int16 a46, char a47, char a48, uint64_t a49, uint64_t a50, int a51, __int16 a52, char a53, char a54, uint64_t a55, uint64_t a56, uint64_t a57, int a58, __int16 a59, char a60, char a61, uint64_t a62, uint64_t a63)
{
  v86 = -13944;
  v87 = v80;
  do
...
void sub_2116AF8()
{
  ...
  unk_27F1CB0 = 0;
  qword_27F1CB8 = 0;
  sub_68678C(&qword_27F1CA8, __p, &v2, 1uLL);
  if (v1 < 0)
  {
    operator delete(__p[0]);
  }
  ...
  *algn_27F1CC8 = 0;
  qword_27F1CD0 = 0;
  sub_68678C(&qword_27F1CC0, __p, &v2, 1uLL);
  if (v1 < 0)
  {
    operator delete(__p[0]);
  }
  ...
  unk_27F1CE0 = 0;
  qword_27F1CE8 = 0;
  sub_68678C(&qword_27F1CD8, __p, &v2, 1uLL);
  if (v1 < 0)
  {
    operator delete(__p[0]);
  }
...
void sub_2116C18(_Unwind_Exception *exception_object, int a2, int a3, int a4, int a5, int a6, int a7, int a8, void *__p, uint64_t a10, int a11, __int16 a12, char a13, char a14)
{
  if (a14 < 0)
  {
    operator delete(__p);
...
uint64_t sub_2116C44(const std::string **a1)
{
  v2 = *a1;
  v3 = a1[1];
  if (v3 - v2 != 24 || (v5 = sub_1CF72BC(v2), v2 = *a1, v3 = a1[1], (v5 & 1) == 0))
  {
    if (v3 - v2 == 72 && sub_1CF72BC(v2))
    {
      ...
      if (sub_1CF72BC(&(*a1)[2]))
      {
        if (a1[1] != *a1)
        {
          ...
          if (0xAAAAAAAAAAAAAAABLL * ((a1[1] - *a1) >> 3) > 2)
          {
            v6 = std::stoi(*a1 + 2, 0, 10) + 10000 * v7;
            goto LABEL_12;
          }
        }
...
void sub_2116D60()
{
  ...
  v4 = 233;
  sub_195E43C(&v1495, v5, __p);
  sub_1966280(qword_27F1D50, v1247, 249);
  v0 = &v1496;
  v1 = -13944;
  do
  {
