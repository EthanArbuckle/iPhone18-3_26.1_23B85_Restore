...
void sub_1F7114C()
{
  ...
  unk_27F0A00 = 0;
  qword_27F0A08 = 0;
  sub_68678C(&qword_27F09F8, __p, &v2, 1uLL);
  if (v1 < 0)
  {
  ...
  *algn_27F0A18 = 0;
  qword_27F0A20 = 0;
  sub_68678C(&qword_27F0A10, __p, &v2, 1uLL);
  if (v1 < 0)
  {
    operator delete(__p[0]);
  }
  ...
  unk_27F0A30 = 0;
  qword_27F0A38 = 0;
  sub_68678C(&qword_27F0A28, __p, &v2, 1uLL);
  if (v1 < 0)
  {
    operator delete(__p[0]);
  }
...
void sub_1F7126C(_Unwind_Exception *exception_object, int a2, int a3, int a4, int a5, int a6, int a7, int a8, void *__p, uint64_t a10, int a11, __int16 a12, char a13, char a14)
{
  if (a14 < 0)
  {
    operator delete(__p);
...
uint64_t sub_1F71298(char a1, double a2, double a3)
{
  if (fabs(a3) > 180.0)
  {
    exception = __cxa_allocate_exception(0x10uLL);
    std::to_string(&v16, a3);
    sub_23E08("invalid lon: ", &v16, &v17);
    std::logic_error::logic_error(exception, &v17);
  }

  if (fabs(a2) > 85.0511288)
  {
    v15 = __cxa_allocate_exception(0x10uLL);
    std::to_string(&v16, a2);
    sub_23E08("invalid lat: ", &v16, &v17);
    std::logic_error::logic_error(v15, &v17);
  }

  v4 = (1 << a1);
  v5 = (a3 + 180.0) / 360.0 * v4;
  if (v4 + -1.0 <= v5)
  {
    v5 = v4 + -1.0;
  }

  LODWORD(v3) = vcvtmd_s64_f64(fmax(v5, 0.0));
  v6 = a2 / 180.0 * 3.14159265;
  v7 = tan(v6);
  v8 = cos(v6);
  v10 = (1.0 - log(v7 + 1.0 / v8) / 3.14159265) * 0.5 * v4;
  if (v4 + -1.0 <= v10)
  {
    v10 = v4 + -1.0;
  }

  LODWORD(v9) = vcvtmd_s64_f64(fmax(v10, 0.0));
  return v3 | (v9 << 32);
}

void sub_1F714AC(_Unwind_Exception *exception_object, int a2, int a3, int a4, int a5, int a6, int a7, int a8, void *a9, uint64_t a10, int a11, __int16 a12, char a13, char a14, void *__p, uint64_t a16, int a17, __int16 a18, char a19, char a20)
{
  if (a20 < 0)
  {
    operator delete(__p);
...
uint64_t sub_1F71534(int a1)
{
  if (a1 >= 31)
  {
    exception = __cxa_allocate_exception(0x10uLL);
    std::runtime_error::runtime_error(exception, "zoom level > 30 is not supported");
  }

  return (ldexp(1.0, a1) - 1);
}

double sub_1F715B4(int a1, int a2)
{
  if (a1 < 0 || (v2 = a2, sub_1F71534(a2) < a1))
  {
    exception = __cxa_allocate_exception(0x10uLL);
    std::runtime_error::runtime_error(exception, "Invalid tileX value");
  }

  return a1 / (1 << v2) * 360.0 + -180.0;
}

long double sub_1F71660(int a1, int a2)
{
  if (a1 < 0 || (v2 = a2, sub_1F71534(a2) < a1))
  {
    exception = __cxa_allocate_exception(0x10uLL);
    std::runtime_error::runtime_error(exception, "Invalid tileY value");
  }

  v4 = sinh(a1 * -6.28318531 / (1 << v2) + 3.14159265);
  return atan(v4) * 180.0 / 3.14159265;
}

BOOL sub_1F71730(int *a1, int *a2)
{
  v2 = a1[2];
  v3 = a2[2];
  if (v2 == v3)
...
void sub_1F717B8(int32x2_t *a1@<X0>, const void **a2@<X8>)
{
  v4 = sub_1F71534(a1[1].i32[0]);
  v5 = 0;
  a2[1] = 0;
  a2[2] = 0;
  *a2 = 0;
  ...
  do
  {
    ...
    for (i = -1; i != 2; ++i)
    {
      v9 = vadd_s32(*a1, __PAIR64__(i, v22));
      v10 = vadd_s32(vbsl_s8(vcltz_s32(v9), v6, vneg_s32(vand_s8(v6, vcgt_s32(v9, v6)))), v9);
      v11 = a1[1].i32[0];
      v12 = a2[2];
      if (v5 >= v12)
      {
...
void sub_1F71958(_Unwind_Exception *exception_object)
{
  v3 = *v1;
  if (*v1)
  {
...
void sub_1F71978(int *a1@<X0>, uint64_t a2@<X8>)
{
  v4 = sub_1F71534(a1[2]);
  sub_16E58B4(a2, 0, 0);
  v5 = sub_1F71660(a1[1], a1[2]);
  *(a2 + 16) |= 8u;
  *(a2 + 72) = v5;
  v6 = sub_1F715B4(*a1, a1[2]);
  v7 = *(a2 + 16);
  *(a2 + 16) = v7 | 4;
  *(a2 + 64) = v6;
  v8 = a1[1];
...
BOOL sub_1F71A74(int *a1, double *a2)
{
  sub_1F71978(a1, v5);
  v3 = sub_1D0E980(v5, a2);
  sub_16E5B34(v5);
  return v3;
}

uint64_t sub_1F71AD4(uint64_t a1)
{
  v1 = *(a1 + 23);
  if (v1 >= 0)
  {
  ...
  v10[0] = v2;
  v10[1] = v1;
  sub_19AD89C(v10, 95, &v11);
  if (v12 - v11 == 72)
  {
    v3 = std::stoi(v11, 0, 10);
    if (0xAAAAAAAAAAAAAAABLL * ((v12 - v11) >> 3) <= 1)
    {
      sub_6FAB4();
    }

    v4 = v3;
    v5 = std::stoi(v11 + 1, 0, 10);
    if (0xAAAAAAAAAAAAAAABLL * ((v12 - v11) >> 3) <= 2)
    {
      sub_6FAB4();
    }
...
void sub_1F71C10(void *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, void **a10, uint64_t a11, char a12)
{
  a10 = &a12;
  sub_195E3E8(&a10);
...
unint64_t sub_1F71C4C(uint64_t a1, int a2, int a3)
{
  v3 = a3 - a2;
  if (a3 <= a2)
  {
...
void sub_1F71C80()
{
  ...
  sub_1966280(qword_27F0AA0, v1247, 249);
  v0 = &v1496;
  v1 = -13944;
  do
  {
...
void sub_1F78C68(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, void *__p, uint64_t a11, int a12, __int16 a13, char a14, char a15, uint64_t a16, void *a17, uint64_t a18, int a19, __int16 a20, char a21, char a22, void *a23, uint64_t a24, int a25, __int16 a26, char a27, char a28, uint64_t a29, void *a30, uint64_t a31, int a32, __int16 a33, char a34, char a35, void *a36, uint64_t a37, int a38, __int16 a39, char a40, char a41, uint64_t a42, uint64_t a43, uint64_t a44, int a45, __int16 a46, char a47, char a48, uint64_t a49, uint64_t a50, int a51, __int16 a52, char a53, char a54, uint64_t a55, uint64_t a56, uint64_t a57, int a58, __int16 a59, char a60, char a61, uint64_t a62, uint64_t a63)
{
  v86 = -13944;
  v87 = v80;
  do
...
void sub_1F7C73C()
{
  ...
  unk_27F0A60 = 0;
  qword_27F0A68 = 0;
  sub_68678C(&qword_27F0A58, __p, &v2, 1uLL);
  if (v1 < 0)
  {
    operator delete(__p[0]);
  }
  ...
  *algn_27F0A78 = 0;
  qword_27F0A80 = 0;
  sub_68678C(&qword_27F0A70, __p, &v2, 1uLL);
  if (v1 < 0)
  {
    operator delete(__p[0]);
  }
  ...
  unk_27F0A90 = 0;
  qword_27F0A98 = 0;
  sub_68678C(&qword_27F0A88, __p, &v2, 1uLL);
  if (v1 < 0)
  {
    operator delete(__p[0]);
  }
...
void sub_1F7C85C(_Unwind_Exception *exception_object, int a2, int a3, int a4, int a5, int a6, int a7, int a8, void *__p, uint64_t a10, int a11, __int16 a12, char a13, char a14)
{
  if (a14 < 0)
  {
    operator delete(__p);
...
std::string *sub_1F7C888@<X0>(const std::string *a1@<X0>, std::string *a2@<X8>)
{
  result = std::string::find(a1, 46, 0);
  ...
  else
  {
    ...
    if (v5)
    {
      ...
      while (v5)
      {
        ...
        {
          v9 = v5 + 1;
          return std::string::basic_string(a2, a1, v9, 0xFFFFFFFFFFFFFFFFLL, &v12);
        }
      }
    }
...
uint64_t sub_1F7C95C@<X0>(uint64_t a1@<X0>, _BYTE *a2@<X8>)
{
  sub_19594F8(&v29);
  if (*(a1 + 32) == 1)
  {
    v4 = sub_4A5C(&v29, "Key: ", 5);
    if ((*(a1 + 32) & 1) == 0)
    {
      sub_4F0F0C();
    }
    ...
    v5 = v4;
    sub_1961D34(__p, *(a1 + 8), *(a1 + 16), *(a1 + 16) - *(a1 + 8));
    if ((v28 & 0x80u) == 0)
    {
      v6 = __p;
    }
  ...
  if (v12 != (a1 + 48))
  {
    do
    {
      sub_4A5C(&v29, "    trigger type: ", 18);
      v13 = std::ostream::operator<<();
      v14 = sub_4A5C(v13, " trigger: ", 10);
      v15 = v12[10] & 0xFFFFFFFFFFFFFFFELL;
      v16 = *(v15 + 23);
      if (v16 >= 0)
      {
        v17 = v12[10] & 0xFFFFFFFFFFFFFFFELL;
      }
...
void sub_1F7CDF4(_Unwind_Exception *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, void *__p, uint64_t a11, int a12, __int16 a13, char a14, char a15, char a16)
{
  std::locale::~locale((v16 - 88));
  if (a15 < 0)
  {
    operator delete(__p);
  }
...
uint64_t sub_1F7CE68@<X0>(uint64_t result@<X0>, void *a2@<X8>)
{
  *a2 = 0;
  a2[1] = 0;
  a2[2] = 0;
...
void sub_1F7CEF4(_Unwind_Exception *a1, uint64_t a2, ...)
{
  va_start(va, a2);
  sub_195E3E8(va);
  _Unwind_Resume(a1);
...
uint64_t sub_1F7CF0C@<X0>(uint64_t result@<X0>, void *a2@<X8>)
{
  *a2 = 0;
  a2[1] = 0;
  a2[2] = 0;
  if (*(result + 48) >= 1)
  {
    ...
    do
    {
      ...
      if (v4 >= a2[2])
      {
        result = sub_1F7D1A4(a2, v6);
        v4 = result;
      }

      else
      {
        result = sub_130D74C(v4, v6);
        v4 += 216;
      }
...
void sub_1F7CFA4(_Unwind_Exception *a1, uint64_t a2, ...)
{
  va_start(va, a2);
  sub_1B6D24C(va);
  _Unwind_Resume(a1);
...
void sub_1F7CFC8(uint64_t a1@<X0>, uint64_t *a2@<X1>, int a3@<W2>, uint64_t *a4@<X8>)
{
  v5 = *a2;
  v6 = a2[1];
  a4[1] = 0;
  ...
  *a4 = 0;
  if (v5 != v6)
  {
    ...
    if (v9)
    {
      ...
      {
        v13 = *v8;
        v14 = *(*v8 + 48) & 0xFFFFFFFFFFFFFFFELL;
        if (*(v14 + 23) < 0)
        {
          sub_325C(__p, *v14, *(v14 + 8));
        }
...
LABEL_21:
          ...
          while (1)
          {
            ...
            if (!strcmp(v20, "global") || sub_219B0D4(v18, __p))
            {
              break;
            }
...
LABEL_34:
            ...
            if (v23 >= a4[2])
            {
              v24 = sub_1F7D3AC(a4, v13);
            }

            else
            {
              sub_1642FBC(a4[1], v13);
              v24 = v23 + 64;
            }
...
void sub_1F7D168(_Unwind_Exception *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, void *__p, uint64_t a10, int a11, __int16 a12, char a13, char a14, uint64_t a15)
{
  *(v15 + 8) = v16;
  a15 = v15;
  sub_1B6C970(&a15);
...
uint64_t sub_1F7D1A4(uint64_t a1, uint64_t a2)
{
  ...
  v13 = 0;
  v14 = 216 * v2;
  sub_130D74C(216 * v2, a2);
  v15 = 216 * v2 + 216;
  v7 = *(a1 + 8);
  v8 = 216 * v2 + *a1 - v7;
  sub_1F7D2EC(a1, *a1, v7, v8);
  v9 = *a1;
  *a1 = v8;
  v10 = *(a1 + 16);
  v12 = v15;
...
void sub_1F7D2D8(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, ...)
{
  va_start(va, a4);
  sub_1F7D35C(va);
  _Unwind_Resume(a1);
...
void sub_1F7D2EC(uint64_t a1, void *a2, void *a3, uint64_t a4)
{
  if (a2 != a3)
  {
    v6 = a2;
...
uint64_t sub_1F7D35C(uint64_t a1)
{
  v3 = *(a1 + 8);
...
uint64_t sub_1F7D3AC(uint64_t *a1, uint64_t a2)
{
  v2 = (a1[1] - *a1) >> 6;
  v3 = v2 + 1;
  if ((v2 + 1) >> 58)
...
void sub_1F7D4A8(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, ...)
{
  va_start(va, a4);
  sub_1F7D5CC(va);
  _Unwind_Resume(a1);
...
void sub_1F7D4BC(uint64_t a1, uint64_t a2, uint64_t a3, std::string *a4)
{
  if (a2 != a3)
  {
    v6 = a2;
...
std::string *sub_1F7D52C(std::string *a1, uint64_t a2)
{
  sub_1642E0C(a1, 0, 0);
  if (a1 != a2)
  {
...
uint64_t sub_1F7D5CC(uint64_t a1)
{
  v3 = *(a1 + 8);
  for (i = *(a1 + 16); i != v3; i = *(a1 + 16))
  {
...
void sub_1F7D61C()
{
  ...
  v4 = 233;
  sub_195E43C(&v1495, v5, __p);
  sub_1966280(qword_27F0B00, v1247, 249);
  v0 = &v1496;
  v1 = -13944;
  do
  {
