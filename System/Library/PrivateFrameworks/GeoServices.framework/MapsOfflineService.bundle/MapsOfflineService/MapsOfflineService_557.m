...
void sub_1F880D8()
{
  ...
  unk_27F0AC0 = 0;
  qword_27F0AC8 = 0;
  sub_68678C(&qword_27F0AB8, __p, &v2, 1uLL);
  if (v1 < 0)
  {
  ...
  *algn_27F0AD8 = 0;
  qword_27F0AE0 = 0;
  sub_68678C(&qword_27F0AD0, __p, &v2, 1uLL);
  if (v1 < 0)
  {
    operator delete(__p[0]);
  }
  ...
  unk_27F0AF0 = 0;
  qword_27F0AF8 = 0;
  sub_68678C(&qword_27F0AE8, __p, &v2, 1uLL);
  if (v1 < 0)
  {
    operator delete(__p[0]);
  }
...
void sub_1F881F8(_Unwind_Exception *exception_object, int a2, int a3, int a4, int a5, int a6, int a7, int a8, void *__p, uint64_t a10, int a11, __int16 a12, char a13, char a14)
{
  if (a14 < 0)
  {
    operator delete(__p);
...
uint64_t sub_1F88224@<X0>(uint64_t a1@<X0>, uint64_t a2@<X8>)
{
  sub_167E624(v15, 0, 0);
  sub_194DB28(v15, a1);
...
LABEL_17:
  ...
  {
    v7 = *v4;
    if (!std::string::compare((*(*v4 + 24) & 0xFFFFFFFFFFFFFFFELL), "search_suggest_primary_source"))
    {
      if (std::string::compare((*(v7 + 32) & 0xFFFFFFFFFFFFFFFELL), "CATEGORY"))
      {
        goto LABEL_15;
      }
    }
    ...
    {
      if (!std::string::compare((*(v7 + 24) & 0xFFFFFFFFFFFFFFFELL), "browse_category"))
      {
        std::string::operator=(&__str, (*(v7 + 32) & 0xFFFFFFFFFFFFFFFELL));
      }
...
LABEL_16:
  ...
  {
    sub_325C(a2, v11.__r_.__value_.__l.__data_, v11.__r_.__value_.__l.__size_);
  }
  ...
  sub_1AB7564((a2 + 24), &v12);
  *(a2 + 48) = 1;
  sub_1962CE0(&v12, v13[0]);
  if (SHIBYTE(v11.__r_.__value_.__r.__words[2]) < 0)
  {
...
void sub_1F883F0(void *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, char a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, void *__p, uint64_t a17, int a18, __int16 a19, char a20, char a21, char a22)
{
  if (*(v22 + 23) < 0)
  {
    operator delete(*v22);
...
void sub_1F88454()
{
  ...
  sub_1966280(qword_27F0B60, v1247, 249);
  v0 = &v1496;
  v1 = -13944;
  do
  {
...
void sub_1F8F43C(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, void *__p, uint64_t a11, int a12, __int16 a13, char a14, char a15, uint64_t a16, void *a17, uint64_t a18, int a19, __int16 a20, char a21, char a22, void *a23, uint64_t a24, int a25, __int16 a26, char a27, char a28, uint64_t a29, void *a30, uint64_t a31, int a32, __int16 a33, char a34, char a35, void *a36, uint64_t a37, int a38, __int16 a39, char a40, char a41, uint64_t a42, uint64_t a43, uint64_t a44, int a45, __int16 a46, char a47, char a48, uint64_t a49, uint64_t a50, int a51, __int16 a52, char a53, char a54, uint64_t a55, uint64_t a56, uint64_t a57, int a58, __int16 a59, char a60, char a61, uint64_t a62, uint64_t a63)
{
  v86 = -13944;
  v87 = v80;
  do
...
void sub_1F92F10()
{
  ...
  unk_27F0B20 = 0;
  qword_27F0B28 = 0;
  sub_68678C(&qword_27F0B18, __p, &v2, 1uLL);
  if (v1 < 0)
  {
    operator delete(__p[0]);
  }
  ...
  *algn_27F0B38 = 0;
  qword_27F0B40 = 0;
  sub_68678C(&qword_27F0B30, __p, &v2, 1uLL);
  if (v1 < 0)
  {
    operator delete(__p[0]);
  }
  ...
  unk_27F0B50 = 0;
  qword_27F0B58 = 0;
  sub_68678C(&qword_27F0B48, __p, &v2, 1uLL);
  if (v1 < 0)
  {
    operator delete(__p[0]);
  }
...
void sub_1F93030(_Unwind_Exception *exception_object, int a2, int a3, int a4, int a5, int a6, int a7, int a8, void *__p, uint64_t a10, int a11, __int16 a12, char a13, char a14)
{
  if (a14 < 0)
  {
    operator delete(__p);
...
uint64_t sub_1F9308C(uint64_t a1, unsigned int a2, unsigned int a3)
{
  if ((*(a1 + 40) & 0x20) != 0 && (*(a1 + 112) - 3) < 2)
  {
    return 0;
  }
...
void sub_1F931A8()
{
  ...
  v4 = 233;
  sub_195E43C(&v1495, v5, __p);
  sub_1966280(qword_27F0BC0, v1247, 249);
  v0 = &v1496;
  v1 = -13944;
  do
  {
