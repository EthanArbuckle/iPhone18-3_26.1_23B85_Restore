...
uint64_t sub_B638C4(void *a1, unsigned int a2, unsigned int a3, int a4, int a5, int a6)
{
  v54[0] = a2;
...
uint64_t sub_B643C4(uint64_t a1, int a2)
{
  v126 = a2;
  *(a1 + 688) = a2;
  v3 = *(a1 + 104);
...
void sub_B65DA8(uint64_t a1, int a2, int a3)
{
  if (*(a1 + 48) != 1)
  {
    goto LABEL_8;
...
uint64_t sub_B6E574(void *a1, unsigned int a2, unsigned int a3, int a4, int a5, int a6)
{
  v54[0] = a2;
  sub_B61684(a1, v54, v51);
  v11 = a1[6];
...
void sub_B6EC94(uint64_t a1, unint64_t a2, uint64_t a3)
{
  v6 = *(a1 + 8);
  v5 = *(a1 + 16);
  if (a2 <= (v5 - v6) >> 4)
...
void sub_B6EE98(_Unwind_Exception *a1, uint64_t a2, ...)
{
  va_start(va, a2);
  sub_B2F26C(va);
  _Unwind_Resume(a1);
...
void sub_B6EEBC(_Unwind_Exception *a1, uint64_t a2, ...)
{
  va_start(va, a2);
  sub_B2F26C(va);
  _Unwind_Resume(a1);
...
void sub_B6F018(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, ...)
{
  va_start(va, a3);
  sub_B2F210(va);
  _Unwind_Resume(a1);
...
void sub_B6F02C(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, ...)
{
  va_start(va, a3);
  sub_B2F210(va);
  _Unwind_Resume(a1);
