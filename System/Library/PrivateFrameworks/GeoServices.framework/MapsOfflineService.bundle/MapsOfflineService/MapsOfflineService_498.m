...
unint64_t sub_1B025D8(uint64_t a1, unint64_t a2, unsigned int (**a3)(_BYTE *))
{
  v12 = a2;
  v13 = a1;
  sub_1AA82C8(v14, a1);
...
uint64_t sub_1B0297C(uint64_t a1, uint64_t a2, uint64_t (**a3)(uint64_t, uint64_t))
{
  v26 = a2;
  v27 = a1;
...
void sub_1B033B8()
{
  ...
  sub_1966280(qword_27EDC60, v1247, 249);
  v0 = &v1496;
  v1 = -13944;
  do
  {
...
void sub_1B0DE74()
{
  ...
  unk_27EDC20 = 0;
  qword_27EDC28 = 0;
  sub_68678C(&qword_27EDC18, __p, &v4, 1uLL);
  if (v3 < 0)
  {
    operator delete(__p[0]);
  }
  ...
  *algn_27EDC38 = 0;
  qword_27EDC40 = 0;
  sub_68678C(&qword_27EDC30, __p, &v4, 1uLL);
  if (v3 < 0)
  {
    operator delete(__p[0]);
  }
  ...
  unk_27EDC50 = 0;
  qword_27EDC58 = 0;
  sub_68678C(&qword_27EDC48, __p, &v4, 1uLL);
  if (v3 < 0)
  {
    operator delete(__p[0]);
  }
...
void sub_1B0E7CC(_Unwind_Exception *a1, uint64_t a2, ...)
{
  va_start(va1, a2);
  va_start(va, a2);
  v4 = va_arg(va1, void);
...
void sub_1B0E828(uint64_t a1, int *a2, uint64_t a3, uint64_t a4, uint64_t a5)
{
  v11 = *a2;
  v8 = *(a3 + 23);
  if (v8 >= 0)
...
uint64_t sub_1B0E8D8@<X0>(_DWORD *a1@<X0>, uint64_t a2@<X1>, uint64_t a3@<X8>)
{
  *a3 = *a1;
  v3 = *(a2 + 8);
  if (*(a2 + 23) >= 0)
...
void sub_1B0E90C(uint64_t a1, uint64_t a2, uint64_t a3)
{
  sub_1B0F4E8(v3, a3);
  v4 = 0;
  operator new();
...
void sub_1B0EA00(_Unwind_Exception *a1, uint64_t a2, ...)
{
  va_start(va1, a2);
  va_start(va, a2);
  v3 = va_arg(va1, void);
...
void sub_1B0EA3C(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4)
{
  sub_1B0F4E8(v5, a4);
  sub_1B0F840(v6, a3);
  v6[7] = 0;
...
void sub_1B0EB68(_Unwind_Exception *a1, uint64_t a2, ...)
{
  va_start(va1, a2);
  va_start(va, a2);
  v4 = va_arg(va1, void);
...
void sub_1B0EBC4(void *a1@<X0>, uint64_t a2@<X1>, uint64_t a3@<X8>)
{
  v3 = a2;
  v20 = 12;
  v6 = *(a2 + 8);
...
uint64_t sub_1B0ED78(uint64_t result, uint64_t a2, uint64_t a3, uint64_t a4)
{
  if (a4)
  {
...
void sub_1B0F370(uint64_t a1, uint64_t *a2, unsigned __int8 *a3)
{
  v3 = *a2;
  v4 = a2[1];
  *a2 = 0;
...
void sub_1B0FC60(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, void **a13, char a14)
{
  sub_197E14C(&a14);
  a13 = &a9;
  sub_197DF60(&a13);
...
char *sub_1B0FEA0(unsigned int *a1, signed int a2)
{
  if (a2)
  {
...
void **sub_1B10150(uint64_t a1, _BYTE *a2, int a3)
{
  v4 = a1;
  v5 = *a2;
  if (a3)
...
uint64_t sub_1B10C10(int a1, uint64_t a2, void *__src)
{
  if (*(a2 + 4) < a1)
  {
    sub_1B129E8(a2, a1, 0);
...
void sub_1B10CE0(uint64_t a1, uint64_t a2, unsigned int *a3)
{
  v19 = 0;
  v18 = 0;
  if (a2)
...
int *sub_1B10F84(int *a1, unsigned int a2, int a3, char *a4)
{
  v6 = a1;
  v22 = a3;
  if (a3 == 4)
  ...
  {
    v7 = *v6;
    if (*v6 && ((v8 = *(v6 + 1), v7 > 4095) || *(v8 + 2 * v7 - 2) >= a2))
    {
      v14 = 0;
      v15 = v7 - 1;
      if (v7 >= 1)
...
int *sub_1B11538(uint64_t a1, int a2, uint64_t a3, int a4, char *a5)
{
  v6 = a3;
  v7 = a1;
  if (a2 == 4)
