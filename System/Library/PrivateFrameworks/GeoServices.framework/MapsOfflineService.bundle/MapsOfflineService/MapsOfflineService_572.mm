...
void sub_20BEA8C()
{
  ...
  unk_27F18D0 = 0;
  qword_27F18D8 = 0;
  sub_68678C(&qword_27F18C8, __p, &v3, 1uLL);
  if (v2 < 0)
  {
  ...
  *algn_27F18E8 = 0;
  qword_27F18F0 = 0;
  sub_68678C(&qword_27F18E0, __p, &v3, 1uLL);
  if (v2 < 0)
  {
    operator delete(__p[0]);
  }
  ...
  unk_27F1900 = 0;
  qword_27F1908 = 0;
  sub_68678C(&qword_27F18F8, __p, &v3, 1uLL);
  if (v2 < 0)
  {
    operator delete(__p[0]);
  }
...
void sub_20BEBBC(_Unwind_Exception *exception_object, int a2, int a3, int a4, int a5, int a6, int a7, int a8, void *__p, uint64_t a10, int a11, __int16 a12, char a13, char a14)
{
  if (a14 < 0)
  {
    operator delete(__p);
...
void sub_20BEBE8(std::string *__str@<X0>, uint64_t a2@<X8>)
{
  ...
  if (size)
  {
    ...
    v9 = size;
    v10 = v6;
    while (v10->__r_.__value_.__s.__data_[0] != 9)
    {
      v10 = (v10 + 1);
      if (!--v9)
      {
  ...
  std::string::basic_string(&v15, __str, v12 + 1, size, v14);
  sub_130D288(v14, 0, 0);
  sub_194DB28(v14, &v15);
  std::string::basic_string(&__p, __str, 0, v12, &v16);
  sub_20BED3C(a2, &__p, v14);
...
void sub_20BECF4(_Unwind_Exception *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, void *__p, uint64_t a10, int a11, __int16 a12, char a13, char a14, uint64_t a15)
{
  if (a14 < 0)
  {
    operator delete(__p);
...
uint64_t sub_20BED3C(uint64_t a1, __int128 *a2, uint64_t a3)
{
  if (*(a2 + 23) < 0)
  {
    sub_325C(a1, *a2, *(a2 + 1));
  ...
  sub_130D74C(a1 + 24, a3);
  return a1;
}

void sub_20BED9C(_Unwind_Exception *exception_object)
{
  if (*(v1 + 23) < 0)
  {
    operator delete(*v1);
...
void sub_20BEDB8(uint64_t a1@<X0>, uint64_t *a2@<X1>, uint64_t *a3@<X2>, void *a4@<X8>)
{
  v16 = [[ObjcLatinNormalizer alloc] initWithParams:*(a1 + 8) trimSpaces:*(a1 + 16) punctMode:*(a1 + 12) stripAccents:*(a1 + 17)];
  if (*(a2 + 23) >= 0)
  {
    v7 = a2;
  }
  ...
  v12 = [(ObjcLatinNormalizer *)v16 normalize:v8];
  v13 = [v12 UTF8String];
  v14 = [v12 lengthOfBytesUsingEncoding:4];
  v15 = v14;
...
void sub_20BEFA4()
{
  ...
  sub_1966280(qword_27F1970, v1247, 249);
  v0 = &v1496;
  v1 = -13944;
  do
  {
...
void sub_20C5F8C(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, void *__p, uint64_t a11, int a12, __int16 a13, char a14, char a15, uint64_t a16, void *a17, uint64_t a18, int a19, __int16 a20, char a21, char a22, void *a23, uint64_t a24, int a25, __int16 a26, char a27, char a28, uint64_t a29, void *a30, uint64_t a31, int a32, __int16 a33, char a34, char a35, void *a36, uint64_t a37, int a38, __int16 a39, char a40, char a41, uint64_t a42, uint64_t a43, uint64_t a44, int a45, __int16 a46, char a47, char a48, uint64_t a49, uint64_t a50, int a51, __int16 a52, char a53, char a54, uint64_t a55, uint64_t a56, uint64_t a57, int a58, __int16 a59, char a60, char a61, uint64_t a62, uint64_t a63)
{
  v86 = -13944;
  v87 = v80;
  do
...
void sub_20C9A60()
{
  ...
  unk_27F1930 = 0;
  qword_27F1938 = 0;
  sub_68678C(&qword_27F1928, __p, &v3, 1uLL);
  if (v2 < 0)
  {
    operator delete(__p[0]);
  }
  ...
  *algn_27F1948 = 0;
  qword_27F1950 = 0;
  sub_68678C(&qword_27F1940, __p, &v3, 1uLL);
  if (v2 < 0)
  {
    operator delete(__p[0]);
  }
  ...
  unk_27F1960 = 0;
  qword_27F1968 = 0;
  sub_68678C(&qword_27F1958, __p, &v3, 1uLL);
  if (v2 < 0)
  {
    operator delete(__p[0]);
  }
...
void sub_20C9B90(_Unwind_Exception *exception_object, int a2, int a3, int a4, int a5, int a6, int a7, int a8, void *__p, uint64_t a10, int a11, __int16 a12, char a13, char a14)
{
  if (a14 < 0)
  {
    operator delete(__p);
...
uint64_t sub_20C9C6C(uint64_t a1, uint64_t a2, uint64_t a3)
{
  if (sub_209B7DC(a2))
  {
    v4 = os_log_create("com.apple.geo.MapsOfflineService", "Search");
    v5 = os_signpost_id_generate(v4);
    if (v5 - 1 <= 0xFFFFFFFFFFFFFFFDLL && os_signpost_enabled(v4))
    {
      *buf = 0;
      _os_signpost_emit_with_name_impl(&dword_0, v4, OS_SIGNPOST_INTERVAL_BEGIN, v5, "PlacesService::handleRequest", "", buf, 2u);
    }
  ...
  sub_18FDA18(v10);
  sub_1792484(v16);
  return sub_18FDA18(buf);
}

void sub_20C9ED8(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, char a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, uint64_t a16, uint64_t a17, uint64_t a18, uint64_t a19, uint64_t a20, uint64_t a21, uint64_t a22, uint64_t a23, uint64_t a24, uint64_t a25, uint64_t a26, uint64_t a27, uint64_t a28, uint64_t a29, uint64_t a30, uint64_t a31, uint64_t a32, uint64_t a33, uint64_t a34, uint64_t a35, uint64_t a36, uint64_t a37, uint64_t a38, uint64_t a39, uint64_t a40, uint64_t a41, uint64_t a42, uint64_t a43, uint64_t a44, uint64_t a45, uint64_t a46, uint64_t a47, uint64_t a48, uint64_t a49, uint64_t a50, uint64_t a51, uint64_t a52, uint64_t a53, uint64_t a54, uint64_t a55, uint64_t a56, uint64_t a57, uint64_t a58, uint64_t a59, uint64_t a60, uint64_t a61, uint64_t a62, uint64_t a63)
{
  sub_18FDA18(&a10);
  sub_1792484(&STACK[0x2B8]);
  sub_18FDA18(&a69);
  _Unwind_Resume(a1);
}

void *sub_20C9FE8(void *a1)
{
  *a1 = off_2728570;
  sub_1C2A28C((a1 + 3));
  return a1;
...
uint64_t sub_20CA114(uint64_t a1, uint64_t a2)
{
  *a2 = off_2728570;
  *(a2 + 8) = *(a1 + 8);
  return sub_1C2A478(a2 + 24, a1 + 24);
}

void sub_20CA150(void *a1)
{
  sub_1C2A28C(a1 + 24);
...
uint64_t sub_20CA18C(void *a1, uint64_t a2)
{
  sub_11EAD3C(v7, a2);
  sub_1C2A238(v10);
  sub_18FF0F0(v10, v7);
  ...
  if (v3 - 1 <= 0xFFFFFFFFFFFFFFFDLL)
  {
    ...
    {
      *buf = 0;
      _os_signpost_emit_with_name_impl(&dword_0, v4, OS_SIGNPOST_INTERVAL_END, v3, "PlacesService::handleRequest", "", buf, 2u);
    }
  }
  ...
  sub_1792484(v11);
  sub_18FDA18(v10);
  return sub_18FDA18(v7);
}

void sub_20CA2AC(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, char a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, uint64_t a16, uint64_t a17, uint64_t a18, uint64_t a19, uint64_t a20, uint64_t a21, uint64_t a22, uint64_t a23, uint64_t a24, uint64_t a25, uint64_t a26, uint64_t a27, uint64_t a28, uint64_t a29, uint64_t a30, uint64_t a31, uint64_t a32, uint64_t a33, uint64_t a34, uint64_t a35, uint64_t a36, char a37, uint64_t a38, uint64_t a39, uint64_t a40, uint64_t a41, uint64_t a42, uint64_t a43, uint64_t a44, uint64_t a45, uint64_t a46, uint64_t a47, uint64_t a48, uint64_t a49, uint64_t a50, uint64_t a51, uint64_t a52, uint64_t a53, uint64_t a54, uint64_t a55, uint64_t a56, uint64_t a57, uint64_t a58, uint64_t a59, uint64_t a60, uint64_t a61, uint64_t a62, uint64_t a63)
{
  sub_18FDA18(&a37);
  sub_1792484(&STACK[0x2B8]);
  sub_18FDA18(&a69);
...
uint64_t sub_20CA2FC(uint64_t a1, uint64_t a2)
{
  {
    return a1 + 8;
  }
...
void sub_20CA348()
{
  ...
  v4 = 233;
  sub_195E43C(&v1495, v5, __p);
  sub_1966280(qword_27F19D0, v1247, 249);
  v0 = &v1496;
  v1 = -13944;
  do
  {
