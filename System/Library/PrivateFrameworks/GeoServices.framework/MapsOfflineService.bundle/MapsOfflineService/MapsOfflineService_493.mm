void sub_1A9BCFC(_Unwind_Exception *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, uint64_t a16, void *__p, uint64_t a18, int a19, __int16 a20, char a21, char a22, char a23)
{
  sub_195CE20(&a11);
  if (a22 < 0)
  {
...
void sub_1A9BD58(void *a1@<X0>, unsigned int **a2@<X1>, int a3@<W2>, const void **a4@<X8>)
{
  v5 = a1[8];
  a4[1] = 0;
  a4[2] = 0;
  *a4 = 0;
  ...
  if (v5)
  {
    ...
    {
      v25 = *v6;
      v10 = sub_195E4DC(a1 + 5, &v25);
      if (v10)
      {
        v23 = v10[3];
        v24 = a3;
        sub_1A9C564(a1 + 10, &v23);
      }
  ...
  else
  {
    ...
    sub_1A9C1CC(a4, v22, v21, (v21 - v6) >> 2);
  }
}

void sub_1A9BF08(_Unwind_Exception *exception_object)
{
  v3 = *v1;
  if (*v1)
  {
...
uint64_t *sub_1A9BF30(uint64_t a1, unsigned int a2, uint64_t a3)
{
  v4 = a2;
  v5 = a3;
  return sub_1A9C790((a1 + 40), &v4);
}

uint64_t sub_1A9BF6C(uint64_t a1, __int128 *a2, __int128 *a3)
{
  if (*(a2 + 23) < 0)
  {
    sub_325C(a1, *a2, *(a2 + 1));
...
void sub_1A9BFE8(_Unwind_Exception *exception_object)
{
  if (*(v1 + 23) < 0)
  {
    operator delete(*v1);
...
void sub_1A9C004(uint64_t *a1, void *a2)
{
  v4 = *a1;
  v5 = a1[1];
  v6 = a2[1] + *a1 - v5;
...
uint64_t sub_1A9C0E4(uint64_t a1)
{
  v3 = *(a1 + 8);
...
uint64_t sub_1A9C134(uint64_t a1, __int128 *a2, __int128 *a3)
{
  if (*(a2 + 23) < 0)
  {
    sub_325C(a1, *a2, *(a2 + 1));
...
void sub_1A9C1B0(_Unwind_Exception *exception_object)
{
  if (*(v1 + 23) < 0)
  {
    operator delete(*v1);
...
uint64_t sub_1A9C1CC(uint64_t result, uint64_t a2, uint64_t a3, unint64_t a4)
{
  if (a4)
  {
...
void sub_1A9C22C(_Unwind_Exception *exception_object)
{
  v3 = *v1;
  if (*v1)
  {
...
const void **sub_1A9C248(void *a1, const void **a2)
{
...
void sub_1A9C490(_Unwind_Exception *a1, uint64_t a2, ...)
{
  va_start(va, a2);
  sub_2CC94(va);
  _Unwind_Resume(a1);
...
void *sub_1A9C564(void *a1, unint64_t *a2)
{
  v2 = *a2;
  v3 = a1[1];
  if (!*&v3)
...
uint64_t *sub_1A9C790(void *a1, unsigned int *a2)
{
  v2 = *a2;
  v3 = a1[1];
  if (!*&v3)
...
void sub_1A9C9C0()
{
  ...
  sub_1966280(qword_27ED830, v1247, 249);
  v0 = &v1496;
  v1 = -13944;
  do
  {
...
void sub_1AA747C()
{
  ...
  unk_27ED7F0 = 0;
  qword_27ED7F8 = 0;
  sub_68678C(&qword_27ED7E8, __p, &v4, 1uLL);
  if (v3 < 0)
  {
    operator delete(__p[0]);
  }
  ...
  *algn_27ED808 = 0;
  qword_27ED810 = 0;
  sub_68678C(&qword_27ED800, __p, &v4, 1uLL);
  if (v3 < 0)
  {
    operator delete(__p[0]);
  }
  ...
  unk_27ED820 = 0;
  qword_27ED828 = 0;
  sub_68678C(&qword_27ED818, __p, &v4, 1uLL);
  if (v3 < 0)
  {
    operator delete(__p[0]);
  }
  ...
  v30 = 4;
  sub_19664AC(&unk_27ED848, __p, 14);
  v0 = 56;
  do
  {
    if (*(&__p[v0 - 1] - 1) < 0)
  ...
  sub_3608D0(v69, "EG");
  v70 = 6;
  sub_1966844(&unk_27ED870, __p, 34);
  v1 = 136;
  do
  {
    if (*(&__p[v1 - 1] - 1) < 0)
...
void sub_1AA7B1C(_Unwind_Exception *exception_object, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, void *__p, uint64_t a11, int a12, __int16 a13, char a14, char a15)
{
  v17 = (v15 + 1079);
  v18 = -1088;
  v19 = v17;
...
uint64_t sub_1AA7CA8(uint64_t a1)
{
  v2 = sub_68233C(a1);
  if (sub_1F9305C(v2))
  {
  ...
  return sub_1F93074(v4);
}

void sub_1AA7CFC(uint64_t a1@<X0>, uint64_t *a2@<X1>, void *a3@<X8>)
{
  v18 = 0;
  v19 = 0;
  v20 = 0;
  ...
  else
  {
    ...
    while (1)
    {
      ...
      if (*a2 != v10)
      {
        ...
        do
        {
          if (*(v9 + 784) == 1 && (sub_1AA7CA8(v9) & 1) == 0)
          {
            v13 = 402336.0;
            if (*(v9 + 784) == 1)
            {
      ...
      v8 = v18;
      if (0xAFD6A052BF5A814BLL * ((v11 - v18) >> 3) >= v6[1])
      {
        break;
      }
  ...
  *a3 = 0;
  ...
  sub_1AA83D8(a3, v16, v17, 0xAFD6A052BF5A814BLL * ((v17 - v16) >> 3));
  v21 = &v18;
  sub_1A5E0F0(&v21);
}

void sub_1AA7EAC(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, void **a12)
{
  a12 = &a9;
  sub_1A5E0F0(&a12);
  _Unwind_Resume(a1);
...
void sub_1AA7ED8(uint64_t a1@<X0>, uint64_t *a2@<X1>, void *a3@<X8>)
{
  v16 = 0;
  v17 = 0;
  v18 = 0;
  ...
  else
  {
    ...
    while (1)
    {
      ...
      if (*a2 != v9)
      {
        ...
        do
        {
          if ((sub_1AA7CA8(v8) & 1) == 0 && sub_1DED894(v8) < v11)
          {
            v12 = v17;
            if (v17 >= v18)
            {
              v13 = sub_19E2CF8(&v16, v8);
            }
      ...
      v7 = v16;
      if (0x7D6343EB1A1F58D1 * ((v10 - v16) >> 4) >= v5[1])
      {
        break;
      }
  ...
  *a3 = 0;
  ...
  sub_19E41E0(a3, v14, v15, 0x7D6343EB1A1F58D1 * ((v15 - v14) >> 4));
  v19 = &v16;
  sub_19E3210(&v19);
}

void sub_1AA8054(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, void **a12)
{
  a12 = &a9;
  sub_19E3210(&a12);
  _Unwind_Resume(a1);
...
uint64_t sub_1AA8080@<X0>(uint64_t *a1@<X1>, void *a2@<X8>)
{
  *a2 = 0;
  a2[1] = 0;
  a2[2] = 0;
...
uint64_t sub_1AA80B4(uint64_t *a1, uint64_t a2)
{
  v2 = 0xAFD6A052BF5A814BLL * ((a1[1] - *a1) >> 3);
  v3 = v2 + 1;
  if (v2 + 1 > 0x52BF5A814AFD6ALL)
  {
    sub_1794();
  }

  if (0x5FAD40A57EB50296 * ((a1[2] - *a1) >> 3) > v3)
  {
    v3 = 0x5FAD40A57EB50296 * ((a1[2] - *a1) >> 3);
  }

  if (0xAFD6A052BF5A814BLL * ((a1[2] - *a1) >> 3) >= 0x295FAD40A57EB5)
  {
    v6 = 0x52BF5A814AFD6ALL;
  }
  ...
  v13 = 0;
  v14 = 792 * v2;
  sub_19D4B88(792 * v2, a2);
  v15 = 792 * v2 + 792;
  v7 = a1[1];
  v8 = 792 * v2 + *a1 - v7;
  sub_1AA8258(a1, *a1, v7, v8);
  v9 = *a1;
  *a1 = v8;
  v10 = a1[2];
  v12 = v15;
...
void sub_1AA81E8(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, ...)
{
  va_start(va, a4);
  sub_1AA8388(va);
  _Unwind_Resume(a1);
...
void sub_1AA81FC(uint64_t a1, unint64_t a2)
{
  if (a2 < 0x52BF5A814AFD6BLL)
  {
    operator new();
  }
...
void sub_1AA8258(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4)
{
  if (a2 != a3)
  {
    v6 = a2;
...
uint64_t sub_1AA82C8(uint64_t a1, uint64_t a2)
{
  *a1 = 0;
  *(a1 + 784) = -1;
  sub_1AA8300(a1, a2);
...
uint64_t sub_1AA8300(uint64_t a1, uint64_t a2)
{
...
uint64_t sub_1AA8374(_OWORD **a1, uint64_t a2)
{
  v2 = *a1;
  *v2 = *a2;
  return sub_195FFEC((v2 + 1), (a2 + 16));
}

uint64_t sub_1AA8388(uint64_t a1)
{
  v3 = *(a1 + 8);
  for (i = *(a1 + 16); i != v3; i = *(a1 + 16))
  {
...
uint64_t sub_1AA83D8(uint64_t result, uint64_t a2, uint64_t a3, unint64_t a4)
{
  if (a4)
  {
    sub_1AA8460(result, a4);
  }

  return result;
}

void sub_1AA8440(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, void **a9)
{
  *(v9 + 8) = v10;
  sub_1A5E0F0(&a9);
  _Unwind_Resume(a1);
...
void sub_1AA8460(uint64_t a1, unint64_t a2)
{
  if (a2 < 0x52BF5A814AFD6BLL)
  {
    sub_1AA81FC(a1, a2);
...
uint64_t sub_1AA84B0(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4)
{
  if (a2 != a3)
  {
    v6 = a2;
...
void sub_1AA8510(_Unwind_Exception *exception_object)
{
  if (v2)
  {
    v4 = v1 - 792;
...
void sub_1AA8538()
{
  ...
  v4 = 233;
  sub_195E43C(&v1495, v5, __p);
  sub_1966280(qword_27ED8E0, v1247, 249);
  v0 = &v1496;
  v1 = -13944;
  do
  {
