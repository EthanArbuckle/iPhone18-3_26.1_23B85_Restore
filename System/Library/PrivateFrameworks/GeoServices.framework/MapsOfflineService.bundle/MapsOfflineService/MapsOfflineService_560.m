...
void sub_1FCD648()
{
  ...
  unk_27F0DF0 = 0;
  qword_27F0DF8 = 0;
  sub_68678C(&qword_27F0DE8, __p, &v4, 1uLL);
  if (v3 < 0)
  {
  ...
  *algn_27F0E08 = 0;
  qword_27F0E10 = 0;
  sub_68678C(&qword_27F0E00, __p, &v4, 1uLL);
  if (v3 < 0)
  {
    operator delete(__p[0]);
  }
  ...
  unk_27F0E20 = 0;
  qword_27F0E28 = 0;
  sub_68678C(&qword_27F0E18, __p, &v4, 1uLL);
  if (v3 < 0)
  {
    operator delete(__p[0]);
  }
...
double sub_1FCE030@<D0>(char *a1@<X0>, uint64_t a2@<X1>, uint64_t a3@<X2>, uint64_t a4@<X8>)
{
  v5 = *(a2 + 104);
  if (v5)
  {
    ...
    do
    {
      if (*(*v10 + 32))
      {
        v13 = sub_58BBC(a1);
        sub_1D447D4(a2, &v26);
        sub_1AE97FC(v13, &v26, *(a2 + 144) & 0xFFFFFFFFFFFFFFFELL, a1);
      }
...
LABEL_59:
  ...
  if (v39)
  {
    ...
    if (v40)
    {
      sub_83F92C(&v110.__r_.__value_.__l.__data_, v94, &__p);
      v96 = __p;
    }

    sub_83F92C(&v96.__r_.__value_.__l.__data_, v82, &__p);
    ...
    if (v41)
    {
      sub_83F92C(&v96.__r_.__value_.__l.__data_, v94, &__p);
      if ((v109.__r_.__value_.__r.__words[2] & 0x8000000000000000) == 0)
      {
        v42 = &v109;
      }
...
LABEL_166:
    if (*v38 == 20554)
    {
      ...
      if ((v75 & 1) == 0)
      {
        std::string::operator=(&v102, (v104 - 24));
      }
    }
...
void sub_1FCF4C0(uint64_t *a1, uint64_t *a2, unint64_t a3, std::string *a4, uint64_t a5)
{
  v47 = a2;
  v48 = a1;
  if (a3 >= 2)
...
LABEL_32:
              ...
              if (*v23 != v49)
              {
                ...
                v26 = v49[0].__r_.__value_.__l.__size_;
                if ((v49[0].__r_.__value_.__s.__data_[8] & 2) != 0)
                {
                  v26 = 0;
                }

                else if (v49[0].__r_.__value_.__s.__data_[8])
                {
                  v26 = *(v49[0].__r_.__value_.__l.__size_ & 0xFFFFFFFFFFFFFFFCLL);
                }

                if (v25 == v26)
                {
                  v17 = sub_130BBE8(v24, v49);
                }
    ...
    else
    {
      ...
      {
        v46 = 0;
        v49[0].__r_.__value_.__r.__words[0] = a4;
        v49[0].__r_.__value_.__l.__size_ = &v46;
        sub_1FCFA24(a1, &a1[a3 >> 1], a3 >> 1, a4);
        v46 = a3 >> 1;
        v27 = a3 - v10;
        v28 = (v9 + 72 * v10);
        sub_1FCFA24(&v6[a3 >> 1], a2, v27, v28);
        v46 = a3;
        v30 = v9 + 72 * a3;
        v31 = v28;
        while (v31 != v30)
        {
          ...
          if (v9 == v28)
          {
            while (v31 != v30)
            {
              ...
              if (v31 != *v6)
              {
                v41 = v40->__r_.__value_.__l.__size_;
                if ((v41 & 2) != 0)
                {
                  v41 = 0;
                }
...
LABEL_107:
        v43 = v49[0].__r_.__value_.__r.__words[0];
        if (v49[0].__r_.__value_.__r.__words[0])
        {
          v44 = v49[0].__r_.__value_.__l.__size_;
          if (*v49[0].__r_.__value_.__l.__size_)
          {
            v45 = 0;
            do
            {
              ++v45;
              v43 = sub_130B0AC(v43, v29) + 72;
            }
      ...
      {
        sub_1FCF4C0(a1, &a1[a3 >> 1], a3 >> 1, a4, a5);
        v12 = a3 - v10;
...
void sub_1FCF994(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, ...)
{
  va_start(va, a4);
  sub_1FD0340(va);
  _Unwind_Resume(a1);
...
void sub_1FCFA24(uint64_t *a1, uint64_t *a2, unint64_t a3, std::string *a4)
{
  if (!a3)
  {
    return;
...
LABEL_45:
  ...
  if (a3 > 8)
  {
    ...
    sub_1FCF4C0(&v7[a3 >> 1], a2, a3 - (a3 >> 1), &v4[3 * (a3 >> 1)], a3 - (a3 >> 1));
    v24 = &v7[a3 >> 1];
    while (v24 != a2)
    {
      if (*(*v24 + 56) >= *(*v7 + 56))
      ...
      do
      {
        ...
        else
        {
          ...
          if (v14 != v4)
          {
            ...
            {
              v15 = (v4 + v16);
              if (*(*v11 + 56) >= *(&v4->__r_.__value_.__l + v16 - 16))
              {
                break;
              }
...
LABEL_11:
      ...
      {
        v32 = a1;
        sub_1FCFCF4(a3, v10, v62, a4, v7, a6, a7);
        a1 = v32;
        v10 = v24;
        v7 = v17;
        a4 = v25;
    ...
    else if (v12 != a3)
    {
      ...
      while (v12 != v13)
      {
        ...
        v40 = *(v12 - 1);
        v42 = *v38;
        if (SLODWORD(v35[-1].__r_.__value_.__r.__words[1]) >= *(v40 + 56))
        {
          if (v42 == &v35[-3])
          {
            v41 = v12;
          ...
          else
          {
            ...
            v46 = v35[-3].__r_.__value_.__l.__size_;
            if ((v46 & 2) != 0)
            {
              v46 = 0;
            }
            ...
            if (v44 == v46)
            {
              sub_130BBE8(v42, &v35[-3]);
            }

            else
            {
              sub_130BB94(v42, &v35[-3]);
            }
      ...
      sub_1FD0460(v34, v35, a6, a3, v39, v68);
    }
...
void sub_1FD0278(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, ...)
{
  va_start(va, a9);
  sub_1FD0340(va);
  _Unwind_Resume(a1);
...
std::string *sub_1FD02A0(std::string *a1, uint64_t a2)
{
  sub_130AF98(a1, 0, 0);
  if (a1 != a2)
  {
...
uint64_t sub_1FD03A0(uint64_t a1, uint64_t a2, uint64_t a3, std::string **a4)
{
  v4 = a4;
  v5 = a2;
  if (a2 != a3)
...
uint64_t sub_1FD063C(uint64_t a1, uint64_t *a2, __int128 *a3, __int128 *a4, __int128 *a5)
{
  *a1 = 0;
  *(a1 + 8) = 0;
  *(a1 + 16) = 0;
...
void sub_1FD0790()
{
  ...
  sub_1966280(qword_27F0EE0, v1247, 249);
  v0 = &v1496;
  v1 = -13944;
  do
  {
