double sub_1E11318(uint64_t a1, uint64_t a2)
{
  v3 = *(a2 + 8);
  if (v3 != *a2)
  {
    sub_1960144(a1, *(a1 + 8), *a2, v3, 0xA3784A062B2E43DBLL * ((v3 - *a2) >> 3));

    *&result = sub_1E1372C((a1 + 24), (a2 + 24)).u64[0];
  }
...
void sub_1E113EC(_Unwind_Exception *a1, uint64_t a2, ...)
{
  va_start(va, a2);
  sub_196005C(va);
  _Unwind_Resume(a1);
...
void sub_1E11A58(uint64_t *a1@<X0>, uint64_t *a2@<X1>, void *a3@<X2>, void *a4@<X8>)
{
  if (*a2 == a2[1])
  {
    *a4 = 0;
...
void sub_1E11B70(uint64_t *a1@<X0>, __int128 **a2@<X1>, int a3@<W2>, void *a4@<X8>)
{
  v4 = *a1;
...
void sub_1E1242C(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, ...)
{
  va_start(va, a4);
  sub_19E31C0(va);
  _Unwind_Resume(a1);
...
uint64_t sub_1E124D8(uint64_t result, uint64_t a2, uint64_t a3, unint64_t a4)
{
  ...
  v7 = result;
  v8 = *result;
  if (0x7D6343EB1A1F58D1 * ((*(result + 16) - *result) >> 4) < a4)
  {
    sub_19E4180(result);
...
void sub_1E1285C(_Unwind_Exception *a1, uint64_t a2, ...)
{
  va_start(va, a2);
  sub_19E2C00(va);
  _Unwind_Resume(a1);
...
std::string *sub_1E12874(void *a1, uint64_t a2, std::string *a3, __int128 *a4, uint64_t a5)
{
  v5 = a2;
  if (a5 >= 1)
  {
...
std::string *sub_1E12EF4(void *a1, uint64_t a2, uint64_t a3, __int128 *a4, uint64_t a5)
{
  v5 = a2;
  if (a5 >= 1)
  {
    ...
    if (a5 <= (v9 - v10) >> 5)
    {
      ...
      if (v18 >= a5)
      {
        ...
        do
        {
          ...
          LODWORD(v22[1].__r_.__value_.__l.__data_) = *(v7 + 24);
          v7 += 32;
          v22 = (v22 + 32);
        }
        ...
        if (v18 >= 1)
        {
          ...
          if (v10 != v5)
          {
            ...
            do
            {
              ...
              LODWORD(v20[1].__r_.__value_.__l.__data_) = *(v7 + 24);
              v7 += 32;
              v20 = (v20 + 32);
            }
...
void sub_1E134E4(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, ...)
{
  va_start(va, a4);
  sub_19E4100(va);
  _Unwind_Resume(a1);
...
void sub_1E1356C(_Unwind_Exception *a1, uint64_t a2, ...)
{
  va_start(va, a2);
  sub_19E3210(va);
  _Unwind_Resume(a1);
...
void sub_1E13768()
{
  ...
  sub_1966280(qword_27EFCC0, v1247, 249);
  v0 = &v1496;
  v1 = -13944;
  do
  {
...
void sub_1E1E224()
{
  ...
  unk_27EFC80 = 0;
  qword_27EFC88 = 0;
  sub_68678C(&qword_27EFC78, __p, &v4, 1uLL);
  if (v3 < 0)
  {
    operator delete(__p[0]);
  }
  ...
  *algn_27EFC98 = 0;
  qword_27EFCA0 = 0;
  sub_68678C(&qword_27EFC90, __p, &v4, 1uLL);
  if (v3 < 0)
  {
    operator delete(__p[0]);
  }
  ...
  unk_27EFCB0 = 0;
  qword_27EFCB8 = 0;
  sub_68678C(&qword_27EFCA8, __p, &v4, 1uLL);
  if (v3 < 0)
  {
    operator delete(__p[0]);
  }
...
uint64_t sub_1E1EA50(uint64_t result)
{
  v1 = result;
  *(result + 40) |= 4u;
  v2 = *(result + 136);
    ...
    do
    {
      ...
      if (v128)
      {
        ...
        if (v125 != __p)
        {
          ...
          {
            v15 = sub_1916234(*(v2 + 24));
            v14 = sub_19593CC(v2 + 24, v15);
          }
          ...
          *(v16 + 4) |= 1u;
          ...
          while (v21 != v22)
          {
            ...
            {
              v27 = sub_191BA60(*(v14 + 24));
              v26 = sub_19593CC(v14 + 24, v27);
            }
          ...
          *(v14 + 16) |= 1u;
          ...
          {
            v38 = sub_1916190(v32[3]);
            v37 = sub_19593CC((v32 + 3), v38);
          }

          *(v37 + 16) |= 1u;
          *(v37 + 64) = 3;
          v39 = *(v37 + 40);
          if (v39 && (v40 = *(v37 + 32), v40 < *v39))
          {
            *(v37 + 32) = v40 + 1;
            v41 = *&v39[2 * v40 + 2];
          }
          ...
          {
            v42 = sub_1916050(*(v37 + 24));
            v41 = sub_19593CC(v37 + 24, v42);
          }

          v43 = *(v41 + 40);
          if (v43 && (v44 = *(v41 + 32), v44 < *v43))
          {
            *(v41 + 32) = v44 + 1;
            v45 = *&v43[2 * v44 + 2];
          }
          ...
          {
            sub_1915FA8(*(v41 + 24));
            v45 = sub_19593CC(v41 + 24, v46);
          }

          v45[41].i32[0] = 17;
          v45[2] = vorr_s8(v45[2], 0x2000010000);
          if (!*&v45[20])
          {
            v47 = v45[1];
            ...
            v45[20] = sub_1915724(v48);
          }

          v49 = *(v37 + 40);
          if (v49 && (v50 = *(v37 + 32), v50 < *v49))
          {
            *(v37 + 32) = v50 + 1;
            v51 = *&v49[2 * v50 + 2];
          }
          ...
          {
            v52 = sub_1916050(*(v37 + 24));
            v51 = sub_19593CC(v37 + 24, v52);
          }

          v53 = *(v51 + 40);
          if (v53 && (v54 = *(v51 + 32), v54 < *v53))
          {
            *(v51 + 32) = v54 + 1;
            v55 = *&v53[2 * v54 + 2];
          }
          ...
          {
            sub_1915FA8(*(v51 + 24));
            v55 = sub_19593CC(v51 + 24, v56);
          }

          v55[41].i32[0] = 3;
          v55[2] = vorr_s8(v55[2], 0x2000000004);
          v57 = v55[6];
          if (!v57)
          {
            v58 = v55[1];
          ...
          *(v57 + 4) |= 1u;
          ...
          {
            sub_1915FA8(*(v51 + 24));
            v62 = sub_19593CC(v51 + 24, v63);
          }

          v62[41].i32[0] = 16;
          v62[2] = vorr_s8(v62[2], 0x2000008000);
          if (!*&v62[19])
          {
            v64 = v62[1];
            ...
            v62[19] = sub_19156AC(v65);
          }

          v66 = *(v51 + 40);
          if (v66 && (v67 = *(v51 + 32), v67 < *v66))
          {
            *(v51 + 32) = v67 + 1;
            v68 = *&v66[2 * v67 + 2];
          }
          ...
          {
            sub_1915FA8(*(v51 + 24));
            v68 = sub_19593CC(v51 + 24, v69);
          }

          *(v68 + 328) = 6;
          *(v68 + 16) |= 0x2000000020uLL;
          v70 = *(v68 + 72);
          if (!v70)
          {
            v71 = *(v68 + 8);
          ...
          *(v70 + 24) = 3;
          ...
          {
            v76 = sub_1916050(*(v37 + 24));
            v75 = sub_19593CC(v37 + 24, v76);
          }

          v77 = *(v75 + 40);
          if (v77 && (v78 = *(v75 + 32), v78 < *v77))
          {
            *(v75 + 32) = v78 + 1;
            v79 = *&v77[2 * v78 + 2];
          }
          ...
          {
            sub_1915FA8(*(v75 + 24));
            v79 = sub_19593CC(v75 + 24, v80);
          }

          v79[41].i32[0] = 5;
          v79[2] = vorr_s8(v79[2], 0x2000000010);
          v81 = v79[8];
          if (!v81)
          {
            v82 = v79[1];
          ...
          *(v81 + 64) = 2;
          ...
          {
            v103 = sub_1916050(*(v37 + 24));
            v102 = sub_19593CC(v37 + 24, v103);
          }

          *(v102 + 16) |= 1u;
          *(v102 + 48) = 1;
          v104 = *(v102 + 40);
          if (v104 && (v105 = *(v102 + 32), v105 < *v104))
          {
            *(v102 + 32) = v105 + 1;
            v106 = *&v104[2 * v105 + 2];
          }
  ...
  if (v7)
  {
    ...
    if (v103 != v102)
    {
      ...
      *(v57 + 4) |= 1u;
      ...
      v68[41].i32[0] = 15;
      v68[2] = vorr_s8(v68[2], 0x2000004000);
      v70 = v68[18];
      if (!v70)
      {
        v71 = v68[1];
      ...
      *(*&v73 + 16) |= 0x20000u;
      if (!*(*&v73 + 168))
      {
        ...
        *(*&v73 + 168) = sub_191579C(v78);
      }

      v79 = *(v37 + 40);
      if (v79 && (v80 = *(v37 + 32), v80 < *v79))
      {
        *(v37 + 32) = v80 + 1;
        v81 = *&v79[2 * v80 + 2];
      }
      ...
      {
        v82 = sub_1916050(*(v37 + 24));
        v81 = sub_19593CC(v37 + 24, v82);
      }

      *(v81 + 16) |= 1u;
      *(v81 + 48) = 1;
      v83 = *(v81 + 40);
      if (v83 && (v84 = *(v81 + 32), v84 < *v83))
      {
        *(v81 + 32) = v84 + 1;
        v85 = *&v83[2 * v84 + 2];
      }
      ...
      {
        sub_1915FA8(*(v81 + 24));
        v85 = sub_19593CC(v81 + 24, v86);
      }

      v85[41].i32[0] = 14;
      v85[2] = vorr_s8(v85[2], 0x2000002000);
      v87 = v85[17];
      if (!v87)
      {
        v88 = v85[1];
...
uint64_t sub_1E1FE1C(uint64_t result, uint64_t a2)
{
  v2 = result;
  v3 = *(a2 + 192);
  if (!v3)
...
uint64_t sub_1E1FF04(uint64_t result, uint64_t a2)
{
  v2 = result;
  v3 = *(a2 + 192);
  if (!v3)
...
uint64_t sub_1E20AD4@<X0>(uint64_t a1@<X8>)
{
  sub_167E624(v10, 0, 0);
  if (v13 && v12 < *v13)
  {
...
uint64_t sub_1E20BDC(uint64_t *a1, uint64_t a2)
{
  v4 = nullsub_1(*a1);
  v5 = *(a2 + 40);
  if (v5 && (v6 = *(a2 + 32), v6 < *v5))
  {
    *(a2 + 32) = v6 + 1;
    v7 = *&v5[2 * v6 + 2];
  }
  ...
  {
    v8 = sub_14050A4(*(a2 + 24));
    v7 = sub_19593CC(a2 + 24, v8);
  }
  ...
  *(v10 + 16) |= 1u;
  ...
  v17 = sub_1950AC0((v7 + 16), v16, 12, 0);
  v18 = v17;
  if (*(v17 + 23) < 0)
  {
    operator delete(*v17);
  ...
  *(v7 + 184) = 3;
  ...
  HIBYTE(v67) = v22 - locale;
  if (v21)
  {
    memmove(&__dst, locale, v21);
  }
...
LABEL_33:
  ...
  *(v34 + 4) |= 4u;
  *(v34 + 16) = 0;
  sub_3608D0(&v56, "Show on Map");
  sub_3608D0(&__str, "localization_config");
  v37 = sub_19D52D4((v4 + 1216), &__str.__r_.__value_.__l.__data_);
  v38 = v37;
  ...
  sub_3608D0(v51, "ShowOnMap");
  sub_2032A7C(v39, v4, v53, v51, &__str);
  if (v52 < 0)
  {
...
LABEL_64:
  ...
  *(v41 + 4) |= 1u;
  ...
  std::string::append(v46, v47, size);
