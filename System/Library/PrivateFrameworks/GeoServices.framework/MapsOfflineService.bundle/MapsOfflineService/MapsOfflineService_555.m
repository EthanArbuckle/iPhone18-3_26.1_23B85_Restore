void sub_1F59734()
{
  ...
  unk_27F0940 = 0;
  qword_27F0948 = 0;
  sub_68678C(&qword_27F0938, __p, &v2, 1uLL);
  if (v1 < 0)
  {
  ...
  *algn_27F0958 = 0;
  qword_27F0960 = 0;
  sub_68678C(&qword_27F0950, __p, &v2, 1uLL);
  if (v1 < 0)
  {
    operator delete(__p[0]);
  }
  ...
  unk_27F0970 = 0;
  qword_27F0978 = 0;
  sub_68678C(&qword_27F0968, __p, &v2, 1uLL);
  if (v1 < 0)
  {
    operator delete(__p[0]);
  }
...
void sub_1F59880(os_log_t *a1, uint64_t *a2, int a3)
{
  sub_3608D0(__p, "qu");
  v8[0] = off_2726CF0;
  v8[1] = sub_1F59AC8;
  v8[3] = v8;
  sub_1F59984(a1, __p, a2, v8, a3);
  sub_1F5A200(v8);
  if (v7 < 0)
  {
    operator delete(__p[0]);
...
void sub_1F59AC8(uint64_t *a1@<X0>, uint64_t a2@<X8>)
{
  v3 = *a1;
  if (*a1 && *(v3 + 296) == 1)
  {
...
uint64_t sub_1F59E24(uint64_t *a1, uint64_t a2)
{
...
void sub_1F59F58(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, ...)
{
  va_start(va, a4);
  sub_1F5A038(va);
  _Unwind_Resume(a1);
...
void sub_1F59FC8(uint64_t a1, uint64_t a2, uint64_t a3, std::string *a4)
{
  if (a2 != a3)
  {
    v6 = a2;
...
void sub_1F5A280()
{
  ...
  sub_1966280(qword_27F09E0, v1247, 249);
  v0 = &v1496;
  v1 = -13944;
  do
  {
...
void sub_1F64D3C()
{
  ...
  unk_27F09A0 = 0;
  qword_27F09A8 = 0;
  sub_68678C(&qword_27F0998, __p, &v2, 1uLL);
  if (v1 < 0)
  {
    operator delete(__p[0]);
  }
  ...
  *algn_27F09B8 = 0;
  qword_27F09C0 = 0;
  sub_68678C(&qword_27F09B0, __p, &v2, 1uLL);
  if (v1 < 0)
  {
    operator delete(__p[0]);
  }
  ...
  unk_27F09D0 = 0;
  qword_27F09D8 = 0;
  sub_68678C(&qword_27F09C8, __p, &v2, 1uLL);
  if (v1 < 0)
  {
    operator delete(__p[0]);
  }
...
void sub_1F64EE0(uint64_t a1, void *a2)
{
  v4 = a2[1] - *a2;
  if ((v4 >> 2) >= 1)
  {
    ...
    {
      v8 = *(a1 + 24) + 88 * *(*a2 + 4 * v7);
      sub_1F65644(&v11, v8 + 88, *(a1 + 32), v8);
      sub_1F655F0(a1 + 24, v9);
      v10 = v7-- + 1;
    }
...
uint64_t sub_1F65088@<X0>(uint64_t a1@<X0>, void *a2@<X8>)
{
  if ((*(a1 + 48) & 1) == 0)
  {
    v4 = *(a1 + 56);
...
uint64_t sub_1F65114@<X0>(uint64_t a1@<X0>, void *a2@<X8>)
{
  *a2 = 0;
  a2[1] = 0;
  a2[2] = 0;
...
void sub_1F653BC(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, ...)
{
  va_start(va, a3);
  *(v5 - 40) = v4;
  sub_19A240C((v5 - 40));
...
uint64_t sub_1F653FC(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4)
{
  v13 = a4;
  v14 = a4;
  v11[0] = a1;
...
void sub_1F6572C(_DWORD **a1, char *a2, uint64_t a3, char a4)
{
LABEL_1:
  v138 = a2;
  v139 = a2 - 16;
...
LABEL_135:
    ...
    if (v9 < 0x81)
    {
      sub_1F66100(&a1[2 * (v9 >> 1)], a1, v139);
    }

    else
    {
      sub_1F66100(a1, &a1[2 * (v9 >> 1)], v139);
      sub_1F66100(a1 + 2, v11 - 2, v137);
      sub_1F66100(a1 + 4, &a1[2 * (v9 >> 1) + 2], v136);
      sub_1F66100(v11 - 2, &a1[2 * (v9 >> 1)], &a1[2 * (v9 >> 1) + 2]);
      v12 = *a1;
      *a1 = *v11;
      *v11 = v12;
    }
...
void sub_1F66100(_DWORD **a1, _DWORD **a2, _DWORD **a3)
{
  v6 = sub_210BF90(*a2);
  v7 = sub_210BF90(*a1);
  v8 = sub_210BF90(*a3);
...
void sub_1F66258(_DWORD **a1, _DWORD **a2, _DWORD **a3, uint64_t a4)
{
...
void sub_1F6634C(_DWORD **a1, _DWORD **a2, _DWORD **a3, _DWORD **a4, uint64_t a5)
{
...
BOOL sub_1F66488(char *a1, char *a2)
{
  ...
  switch(v4)
  {
    case 3:
      ...
      return 1;
    case 4:
      sub_1F66258(a1, a1 + 2, a1 + 4, (a2 - 16));
      return 1;
    case 5:
      sub_1F6634C(a1, a1 + 2, a1 + 4, a1 + 6, (a2 - 16));
      return 1;
  }
...
void sub_1F66690()
{
  ...
  v4 = 233;
  sub_195E43C(&v1495, v5, __p);
  sub_1966280(qword_27F0A40, v1247, 249);
  v0 = &v1496;
  v1 = -13944;
  do
  {
