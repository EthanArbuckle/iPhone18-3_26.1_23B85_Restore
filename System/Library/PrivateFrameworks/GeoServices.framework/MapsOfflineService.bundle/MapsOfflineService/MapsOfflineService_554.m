uint64_t sub_1F43BB0(uint64_t a1, int a2)
{
  *(a1 + 16) |= 1u;
  result = *(a1 + 24);
  if (!result)
...
void sub_1F43C28(uint64_t a1, void *a2)
{
  if (a2)
  {
    sub_1F43C28(a1, *a2);
...
uint64_t *sub_1F43C84(uint64_t a1, int *a2)
{
  v2 = *(a1 + 8);
  if (!v2)
  {
...
uint64_t sub_1F43DC4(uint64_t a1, uint64_t a2)
{
  sub_1812BD0(a1, 0, 0);
  if (a1 != a2)
  {
...
void sub_1F43E64()
{
  ...
  sub_1966280(qword_27F08F0, v1247, 249);
  v0 = &v1496;
  v1 = -13944;
  do
  {
...
void sub_1F4E920()
{
  ...
  unk_27F08B0 = 0;
  qword_27F08B8 = 0;
  sub_68678C(&qword_27F08A8, __p, v4, 1uLL);
  if (v3 < 0)
  {
    operator delete(__p[0]);
  }
  ...
  *algn_27F08C8 = 0;
  qword_27F08D0 = 0;
  sub_68678C(&qword_27F08C0, __p, v4, 1uLL);
  if (v3 < 0)
  {
    operator delete(__p[0]);
  }
  ...
  unk_27F08E0 = 0;
  qword_27F08E8 = 0;
  sub_68678C(&qword_27F08D8, __p, v4, 1uLL);
  if (v3 < 0)
  {
    operator delete(__p[0]);
  }
  ...
  sub_1F43E64();
  sub_3608D0(__p, "earthstats.length");
  sub_3608D0(v4, "earthstats.highest_point");
  sub_3608D0(v5, "earthstats.lowest_point");
  qword_27F0908 = 0;
  unk_27F0910 = 0;
  qword_27F0918 = 0;
  sub_68678C(&qword_27F0908, __p, &v6, 3uLL);
  for (i = 0; i != -72; i -= 24)
  {
    if (v5[i + 23] < 0)
    {
  ...
  sub_1D119C4(__p, "navigation.trails", &qword_27F0908);
  sub_1D12C10(&qword_27F0920, __p, 1);
  v1 = v4;
  sub_195E3E8(&v1);
  if (v3 < 0)
  {
...
BOOL sub_1F4EBBC(void *a1)
{
  ...
  v4 = 0xAAAAAAAAAAAAAAABLL * (v2 - v1);
  do
  {
    v5 = &v1[3 * (v4 >> 1)];
    v6 = sub_BA6DC(v5, a1 + 208);
    if (v6 >= 0)
    {
      v4 >>= 1;
    }
  ...
  while (v4);
  return v1 != v2 && (sub_BA6DC(a1 + 208, v1) & 0x80u) == 0;
}
...
void sub_1F4EC78()
{
  ...
  v4 = 233;
  sub_195E43C(&v1495, v5, __p);
  sub_1966280(qword_27F0980, v1247, 249);
  v0 = &v1496;
  v1 = -13944;
  do
  {
...
void sub_1F55C60(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, void *__p, uint64_t a11, int a12, __int16 a13, char a14, char a15, uint64_t a16, void *a17, uint64_t a18, int a19, __int16 a20, char a21, char a22, void *a23, uint64_t a24, int a25, __int16 a26, char a27, char a28, uint64_t a29, void *a30, uint64_t a31, int a32, __int16 a33, char a34, char a35, void *a36, uint64_t a37, int a38, __int16 a39, char a40, char a41, uint64_t a42, uint64_t a43, uint64_t a44, int a45, __int16 a46, char a47, char a48, uint64_t a49, uint64_t a50, int a51, __int16 a52, char a53, char a54, uint64_t a55, uint64_t a56, uint64_t a57, int a58, __int16 a59, char a60, char a61, uint64_t a62, uint64_t a63)
{
  v86 = -13944;
  v87 = v80;
  do
