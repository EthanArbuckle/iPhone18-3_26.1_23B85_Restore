...
void sub_B42354(uint64_t a1)
{
  if (sub_A822FC(*(a1 + 24)))
  {
    ...
    *(a1 + 264) = v3 + 1;
    ...
    else if (!sub_B457F4((a1 + 128), 0, v17, v16, 0xFFFFFFFF, 2147483646))
    {
      return;
    }
...
uint64_t sub_B45194(uint64_t a1)
{
  if (*a1 == -1)
  {
    return 0;
...
uint64_t sub_B457F4(void *a1, unsigned int a2, unsigned int a3, unsigned int a4, unsigned int a5, int a6)
{
  v37 = a2;
...
char *sub_B459B8(uint64_t a1, unsigned int a2, char *a3, _BYTE *a4)
{
  v49 = a2;
...
char *sub_B47970(uint64_t a1, unsigned int a2)
{
  v17 = a2;
  v4 = *(a1 + 88);
...
unint64_t sub_B47DDC(uint64_t a1, _DWORD *a2, unsigned int a3, unsigned int a4, unsigned int a5)
{
