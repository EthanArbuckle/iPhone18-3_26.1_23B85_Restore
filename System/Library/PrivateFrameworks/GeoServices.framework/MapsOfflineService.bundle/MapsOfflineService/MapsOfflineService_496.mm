...
void sub_1ADC600()
{
  ...
  unk_27EDA60 = 0;
  qword_27EDA68 = 0;
  sub_68678C(&qword_27EDA58, __p, &v4, 1uLL);
  if (v3 < 0)
  {
  ...
  *algn_27EDA78 = 0;
  qword_27EDA80 = 0;
  sub_68678C(&qword_27EDA70, __p, &v4, 1uLL);
  if (v3 < 0)
  {
    operator delete(__p[0]);
  }
  ...
  unk_27EDA90 = 0;
  qword_27EDA98 = 0;
  sub_68678C(&qword_27EDA88, __p, &v4, 1uLL);
  if (v3 < 0)
  {
    operator delete(__p[0]);
  }
  ...
  v30 = 4;
  sub_19664AC(&unk_27EDAB8, __p, 14);
  v0 = 56;
  do
  {
    if (*(&__p[v0 - 1] - 1) < 0)
  ...
  sub_3608D0(v69, "EG");
  v70 = 6;
  sub_1966844(&unk_27EDAE0, __p, 34);
  v1 = 136;
  do
  {
    if (*(&__p[v1 - 1] - 1) < 0)
...
void sub_1ADCCA0(_Unwind_Exception *exception_object, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, void *__p, uint64_t a11, int a12, __int16 a13, char a14, char a15)
{
  v17 = (v15 + 1079);
  v18 = -1088;
  v19 = v17;
...
uint64_t sub_1ADCE2C@<X0>(uint64_t *a1@<X1>, uint64_t *a2@<X2>, uint64_t a3@<X3>, __int128 *a4@<X4>, uint64_t a5@<X5>, uint64_t a6@<X8>)
{
  sub_1963D78(v28, a1);
  v11 = *a2;
  v12 = a2[1];
  ...
  sub_1965774(v25, a3);
  sub_1965C4C(v14, a4);
  sub_1ADD67C(a6, v28, &v26, v25, v14, a5);
  if (v24 < 0)
  {
    operator delete(__p);
  }
...
void sub_1ADCFF4(_Unwind_Exception *exception_object)
{
  v3 = *(v1 + 8);
  if (v3)
  {
...
void sub_1ADD28C(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, std::__shared_weak_count *a15)
{
  sub_1A5E97C(v15 - 88);
  if (a15)
  {
...
uint64_t sub_1ADD36C(uint64_t a1)
{
  sub_1A5F98C(a1 + 1432);
  sub_18FA778(a1 + 1208);
  if (*(a1 + 1200) == 1)
...
void sub_1ADD3B4(uint64_t *a1, uint64_t a2, uint64_t a3, uint64_t a4)
{
  sub_1A489EC(v9, a2);
  v6 = a1[1];
  v7[0] = *a1;
  ...
  sub_1ADCE2C(a1 + 2, v7, a4, v9, a1[151], v8);
  if (v6)
  {
    sub_1220A18(v6);
  }
...
void sub_1ADD540(_Unwind_Exception *a1, uint64_t a2, ...)
{
  va_start(va1, a2);
  va_start(va, a2);
  v4 = va_arg(va1, void);
...
void sub_1ADD5AC(uint64_t a1, uint64_t a2, uint64_t a3)
{
  v3 = 0;
  v4 = 0;
  sub_1A5F8F4(v5, a3);
...
void sub_1ADD650(_Unwind_Exception *a1, uint64_t a2, ...)
{
  va_start(va, a2);
  sub_1A5F98C(v2 - 72);
  if (STACK[0x4B0])
...
uint64_t sub_1ADD67C(uint64_t a1, uint64_t *a2, uint64_t a3, uint64_t a4, __int128 *a5, uint64_t a6)
{
  v11 = sub_1963D78(a1, a2);
  *(v11 + 1192) = *a3;
  *a3 = 0;
  *(a3 + 8) = 0;
  sub_1965774(v11 + 1208, a4);
  sub_1965C4C(a1 + 1248, a5);
  *(a1 + 1416) = a6;
  return a1;
}

void sub_1ADD6F0(_Unwind_Exception *a1)
{
  sub_1965BCC(v1 + 1208);
  v3 = *(v1 + 1200);
  if (v3)
...
uint64_t sub_1ADD720(uint64_t a1)
{
  if (*(a1 + 1415) < 0)
  {
  ...
  return sub_1965ECC(a1);
}

uint64_t sub_1ADD7D4(uint64_t a1)
{
  *a1 = off_27230F0;
  sub_1A5F98C(a1 + 1440);
  sub_18FA778(a1 + 1216);
...
void sub_1ADD93C(_Unwind_Exception *a1)
{
  sub_18FA778(v1 + 1216);
  if (v1[1208] == 1)
  {
...
uint64_t sub_1ADD97C(uint64_t a1, uint64_t a2)
{
  v4 = *(a1 + 8);
  *a2 = off_27230F0;
  *(a2 + 8) = v4;
  sub_1A5E7C4((a2 + 16), a1 + 16);
  sub_18FA5D4(a2 + 1216, a1 + 1216);
  return sub_1A5F8F4(a2 + 1440, a1 + 1440);
}

void sub_1ADD9E4(_Unwind_Exception *a1)
{
  sub_18FA778(v1 + 1216);
  if (*(v1 + 1208) == 1)
  {
...
uint64_t sub_1ADDA14(uint64_t a1)
{
  sub_1A5F98C(a1 + 1440);
  result = sub_18FA778(a1 + 1216);
  if (*(a1 + 1208) == 1)
  {
...
void sub_1ADDAC8(uint64_t a1, uint64_t *a2)
{
  sub_195FFEC(v5, a2);
  v3 = *(a1 + 8);
  if (*(a1 + 1208) == 1)
  {
    sub_1963D78(v6, (a1 + 16));
  }
  ...
  sub_1A5F8F4(v7, a1 + 1440);
  sub_1ADD3B4(v3, a1 + 1216, v4, v5);
}

void sub_1ADDB98(_Unwind_Exception *exception_object, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, char a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, char a15)
{
  if (a2)
  {
    sub_1A5F98C(v16 - 88);
    ...
    v20 = os_log_create("com.apple.geo.MapsOfflineService", "Search");
...
uint64_t sub_1ADDCD4(uint64_t a1, uint64_t a2)
{
  {
    return a1 + 8;
  }
...
void sub_1ADDE10(std::__shared_weak_count *a1)
{
  a1->__vftable = off_2723170;
  std::__shared_weak_count::~__shared_weak_count(a1);

  operator delete();
}

uint64_t sub_1ADDE64(void *a1)
{
  sub_18FA778(a1 + 187);
  v2 = a1[184];
  if (v2)
  ...
  return sub_1ADD720((a1 + 3));
}

void sub_1ADDF08(uint64_t a1, NSObject *a2)
{
  v3 = (*(*a1 + 16))(a1);
  v4 = 136315138;
  v5 = v3;
  _os_log_error_impl(&dword_0, a2, OS_LOG_TYPE_ERROR, "Exception thrown while processing place request - .%s ", &v4, 0xCu);
}
...
void sub_1ADDFB4()
{
  ...
  sub_1966280(qword_27EDB50, v1247, 249);
  v0 = &v1496;
  v1 = -13944;
  do
  {
...
void sub_1AE4F9C(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, void *__p, uint64_t a11, int a12, __int16 a13, char a14, char a15, uint64_t a16, void *a17, uint64_t a18, int a19, __int16 a20, char a21, char a22, void *a23, uint64_t a24, int a25, __int16 a26, char a27, char a28, uint64_t a29, void *a30, uint64_t a31, int a32, __int16 a33, char a34, char a35, void *a36, uint64_t a37, int a38, __int16 a39, char a40, char a41, uint64_t a42, uint64_t a43, uint64_t a44, int a45, __int16 a46, char a47, char a48, uint64_t a49, uint64_t a50, int a51, __int16 a52, char a53, char a54, uint64_t a55, uint64_t a56, uint64_t a57, int a58, __int16 a59, char a60, char a61, uint64_t a62, uint64_t a63)
{
  v86 = -13944;
  v87 = v80;
  do
...
void sub_1AE8A70()
{
  ...
  unk_27EDB10 = 0;
  qword_27EDB18 = 0;
  sub_68678C(&qword_27EDB08, __p, &v4, 1uLL);
  if (v3 < 0)
  {
    operator delete(__p[0]);
  }
  ...
  *algn_27EDB28 = 0;
  qword_27EDB30 = 0;
  sub_68678C(&qword_27EDB20, __p, &v4, 1uLL);
  if (v3 < 0)
  {
    operator delete(__p[0]);
  }
  ...
  unk_27EDB40 = 0;
  qword_27EDB48 = 0;
  sub_68678C(&qword_27EDB38, __p, &v4, 1uLL);
  if (v3 < 0)
  {
    operator delete(__p[0]);
  }
  ...
  sub_3608D0(v29, "en-ZA_ZA");
  v30 = 4;
  sub_19664AC(&unk_27EDB68, __p, 14);
  v0 = 56;
  do
  {
    if (*(&__p[v0 - 1] - 1) < 0)
  ...
  sub_3608D0(v69, "EG");
  v70 = 6;
  sub_1966844(&unk_27EDB90, __p, 34);
  v1 = 136;
  do
  {
    if (*(&__p[v1 - 1] - 1) < 0)
...
void sub_1AE9110(_Unwind_Exception *exception_object, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, void *__p, uint64_t a11, int a12, __int16 a13, char a14, char a15)
{
  v17 = (v15 + 1079);
  v18 = -1088;
  v19 = v17;
...
uint64_t *sub_1AE929C@<X0>(uint64_t *a1@<X0>, uint64_t a2@<X1>, unsigned __int8 *a3@<X2>, uint64_t a4@<X8>)
{
  v7 = sub_58BBC(a2);
  v8 = sub_1BB311C(&v10, v7, a1, a3);
  return sub_1AE9300(a1, v8, a4);
}

uint64_t *sub_1AE9300@<X0>(uint64_t *result@<X0>, int a2@<W1>, uint64_t a3@<X8>)
{
  v4 = *result;
  v5 = result[1];
  if (*result == v5)
...
uint64_t sub_1AE9390(void *a1, uint64_t a2, uint64_t a3)
{
  v5 = sub_58BBC(a2);
  v19 = 0;
  v20 = 0;
  v18 = 0;
  sub_353184(&v18, *v5, v5[1], 0xAAAAAAAAAAAAAAABLL * ((v5[1] - *v5) >> 3));
  v6 = *(a3 + 23);
  if (v6 < 0)
  {
    if (*(a3 + 8) != 2)
  ...
  if (*v7 == 19272)
  {
    ...
    if (v18 != v19)
    {
      while (1)
      {
        sub_3608D0(&__p, "zh-hans");
        v12 = sub_219B0D4(v10, &__p);
        if (v23 < 0)
        {
      ...
      if (v18 != v19)
      {
        do
        {
          sub_3608D0(&__p, "zh-hant");
          v15 = sub_219B0D4(v14, &__p);
          if (v23 < 0)
          {
            operator delete(__p.n128_u64[0]);
          }
...
LABEL_7:
  v8 = sub_1BB311C(&v21, &v18, a1, a3);
  __p.n128_u64[0] = &v18;
  sub_195E3E8(&__p);
  return v8;
}

void sub_1AE9598(_Unwind_Exception *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, void *__p, uint64_t a14, int a15, __int16 a16, char a17, char a18, uint64_t *a19)
{
  if (a18 < 0)
  {
    operator delete(__p);
...
void **sub_1AE95E8(void *a1, uint64_t a2, __n128 *a3)
{
  v4 = a2;
  v6 = a1[1];
  v7 = a1[2];
  ...
  {
    v9 = *a1;
    v10 = 0xAAAAAAAAAAAAAAABLL * ((v6 - *a1) >> 3) + 1;
    ...
    if (2 * v12 <= v10)
    {
      v13 = 0xAAAAAAAAAAAAAAABLL * ((v6 - *a1) >> 3) + 1;
    }
...
void sub_1AE9798(_Unwind_Exception *a1, uint64_t a2, ...)
{
  va_start(va, a2);
  sub_1D03C(va);
  _Unwind_Resume(a1);
...
void sub_1AE97FC(uint64_t a1, uint64_t a2, uint64_t a3, char *a4)
{
  v16[0] = 0;
  v16[8] = 0;
  v16[16] = 0;
...
void sub_1AE99DC(_Unwind_Exception *exception_object, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, void *__p, uint64_t a11, int a12, __int16 a13, char a14, char a15)
{
  if (a15 < 0)
  {
    operator delete(__p);
...
uint64_t sub_1AE9A00(uint64_t a1, uint64_t a2, unint64_t a3, uint64_t a4)
{
  v6 = *(a1 + 8);
  v7 = a2 + v6 - a4;
  v8 = v6;
  ...
  *(a1 + 8) = v8;
  return sub_1AE9BC4(&v12, a2, v7, v6);
}

__n128 sub_1AE9A70(void *a1, __n128 *a2)
{
  v4 = a1[2];
  if (v4 == a1[3])
  {
    ...
    v7 = -3 * (v6 >> 1);
    sub_1AE9C44(v12, v5, v4, v5 - 24 * (v6 >> 1));
    v4 = v8;
    a1[1] += 8 * v7;
    a1[2] = v8;
  }
...
uint64_t sub_1AE9BC4(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4)
{
  if (a3 != a2)
  {
    v7 = a3;
...
__int128 *sub_1AE9C44(uint64_t a1, __int128 *a2, __int128 *a3, uint64_t a4)
{
  v5 = a2;
  if (a2 != a3)
  {
...
void sub_1AE9CB8()
{
  ...
  v4 = 233;
  sub_195E43C(&v1495, v5, __p);
  sub_1966280(qword_27EDC00, v1247, 249);
  v0 = &v1496;
  v1 = -13944;
  do
  {
