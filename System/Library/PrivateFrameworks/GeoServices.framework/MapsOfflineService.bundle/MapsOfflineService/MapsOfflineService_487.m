...
uint64_t sub_1A2F108(uint64_t result, uint64_t a2, uint64_t a3, unint64_t a4)
{
  if (a4)
  {
...
uint64_t sub_1A2F228(uint64_t a1, __int128 *a2, uint64_t a3, _OWORD *a4, _OWORD *a5, void *a6, int a7, char a8, uint64_t a9, int a10)
{
  ...
  *(a1 + 768) = 1065353216;
  do
  {
    v22 = v20;
    v23 = &v22;
    sub_1A2F4B0((a1 + 456), &v22)[3] = 0xBFF0000000000000;
    ++v20;
  }
...
uint64_t *sub_1A2F4B0(void *a1, int *a2)
{
  v2 = *a2;
  v3 = a1[1];
  if (!*&v3)
...
uint64_t sub_1A2F780(uint64_t a1, uint64_t a2, _OWORD *a3, uint64_t a4, uint64_t a5, void *a6, uint64_t *a7, _DWORD *a8)
{
  *a1 = *a3;
  *(a1 + 24) = 0;
  ...
  *(a1 + 656) = 0;
  do
  {
    v18 = v16;
    v19 = &v18;
    sub_1A2F4B0((a1 + 512), &v18)[3] = 0xBFF0000000000000;
    ++v16;
  }
...
{
  if (__cxa_guard_acquire(&qword_278C268))
  {
    qword_278C258 = 0;
    byte_278C260 = 0;
    dword_278C264 = 0;
    ...
    qword_278C238 = a1;
    byte_278C250 = 0;
    __cxa_guard_release(&qword_278C268);
  }
}
...
void sub_1A2FA84()
{
  ...
  sub_1966280(qword_27ED458, v1247, 249);
  v0 = &v1496;
  v1 = -13944;
  do
  {
...
void sub_1A3ACA8()
{
  ...
  *algn_27ED418 = 0;
  qword_27ED420 = 0;
  sub_68678C(&qword_27ED410, __p, &v4, 1uLL);
  if (v3 < 0)
  {
    operator delete(__p[0]);
  }
  ...
  unk_27ED430 = 0;
  qword_27ED438 = 0;
  sub_68678C(&qword_27ED428, __p, &v4, 1uLL);
  if (v3 < 0)
  {
    operator delete(__p[0]);
  }
  ...
  *algn_27ED448 = 0;
  qword_27ED450 = 0;
  sub_68678C(&qword_27ED440, __p, &v4, 1uLL);
  if (v3 < 0)
  {
    operator delete(__p[0]);
  }
  ...
  *a4 = 0;
  ...
  if (v6 >= 1)
  {
    ...
    do
    {
      ...
      v48 = 0;
      v49 = 0;
      sub_19A22C0(&v47, *(v8 + 24), *(v8 + 32), (*(v8 + 32) - *(v8 + 24)) >> 6);
      memset(v50, 0, sizeof(v50));
      sub_19A22C0(v50, *(v8 + 48), *(v8 + 56), (*(v8 + 56) - *(v8 + 48)) >> 6);
      v10 = *(v8 + 72);
      v52 = *(v8 + 80);
      v51 = v10;
      if (v10 == 14)
      {
        v11 = sub_1A3C8CC(&v38, &v45);
        v13 = v47;
        v12 = v48;
        while (v13 != v12)
        {
...
LABEL_51:
        ...
        sub_1A3B9CC(v11, a3, &v38);
        sub_1A3BB0C(v30, a3, &v38);
        if (sub_1A3BC44(&v38))
        {
          sub_1A3BD14(a1, a3, &v38, &v53);
        }
...
void sub_1A3BD14(uint64_t a1, uint64_t a2, uint64_t *a3, uint64_t a4)
{
  sub_1A3BF68(a3, &v15);
  if (a4 + 8 == sub_19D5254(a4, &v15))
  {
    sub_7E36C(a4, &v15.__r_.__value_.__l.__data_);
    sub_1A3D50C();
  }
  ...
  if (v7)
  {
    ...
    for (i = v14; v8 != i; v8 += 3)
    {
      ...
      if (v8 != v12)
      {
        sub_1A3CD64(v12, *v8, v8[1], (v8[1] - *v8) >> 6);
      }
...
void sub_1A3CB78(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, ...)
{
  va_start(va, a4);
  sub_19A20EC(va);
  _Unwind_Resume(a1);
...
void sub_1A3CD64(uint64_t a1, std::string *__str, std::string *a3, unint64_t a4)
{
  v8 = *a1;
  if (a4 > (*(a1 + 16) - *a1) >> 6)
  {
  ...
  else
  {
    ...
    *(a1 + 8) = sub_19A2384(a1, (__str + v12), a3, *(a1 + 8));
  }
}

void sub_1A3CEA0(void **a1)
{
  v1 = *a1;
  if (*a1)
  {
...
uint64_t **sub_1A3CF90(uint64_t **result, void *a2, void *a3)
{
  v5 = result;
  if (result[2])
  {
...
void sub_1A3D0E0(_Unwind_Exception *a1, uint64_t a2, ...)
{
  va_start(va, a2);
  sub_1A3D164(va);
  _Unwind_Resume(a1);
...
void sub_1A3DB28()
{
  ...
  v4 = 233;
  sub_195E43C(&v1495, v5, __p);
  sub_1966280(qword_27ED508, v1247, 249);
  v0 = &v1496;
  v1 = -13944;
  do
  {
