void sub_1B78070()
{
  ...
  unk_27EE0B0 = 0;
  qword_27EE0B8 = 0;
  sub_68678C(&qword_27EE0A8, __p, &v2, 1uLL);
  if (v1 < 0)
  {
  ...
  *algn_27EE0C8 = 0;
  qword_27EE0D0 = 0;
  sub_68678C(&qword_27EE0C0, __p, &v2, 1uLL);
  if (v1 < 0)
  {
    operator delete(__p[0]);
  }
  ...
  unk_27EE0E0 = 0;
  qword_27EE0E8 = 0;
  sub_68678C(&qword_27EE0D8, __p, &v2, 1uLL);
  if (v1 < 0)
  {
    operator delete(__p[0]);
  }
...
void sub_1B78190(_Unwind_Exception *exception_object, int a2, int a3, int a4, int a5, int a6, int a7, int a8, void *__p, uint64_t a10, int a11, __int16 a12, char a13, char a14)
{
  if (a14 < 0)
  {
    operator delete(__p);
...
uint64_t sub_1B781BC@<X0>(__int128 *a1@<X0>, uint64_t a2@<X8>)
{
  sub_167E624(v19, 0, 0);
  if (v22 && v21 < *v22)
  {
  ...
  *(v5 + 16) |= 1u;
  ...
  sub_10DF26C((v5 + 24), "result_type_all", v8);
  *(v5 + 16) |= 2u;
  v9 = *(v5 + 8);
  ...
  sub_10DF26C((v5 + 32), "CATEGORY_QUERY", v10);
  if (v22 && v21 < *v22)
  {
    v11 = &v22[2 * v21++];
    v12 = *(v11 + 1);
  ...
  *(v12 + 16) |= 1u;
  ...
  sub_10DF26C((v12 + 24), "CANONICAL_NAME", v15);
  *(v12 + 16) |= 2u;
  v16 = *(v12 + 8);
  ...
  sub_194EA1C((v12 + 32), a1, v17);
  sub_1957E24(v19, a2);
  return sub_167E6D8(v19);
}

uint64_t sub_1B78374@<X0>(__int128 *a1@<X0>, uint64_t a2@<X8>)
{
  sub_167E624(v19, 0, 0);
  if (v22 && v21 < *v22)
  {
  ...
  *(v5 + 16) |= 2u;
  ...
  sub_10DF26C((v5 + 32), "CHAIN_QUERY", v10);
  if (v22 && v21 < *v22)
  {
    v11 = &v22[2 * v21++];
    v12 = *(v11 + 1);
...
uint64_t sub_1B7852C@<X0>(uint64_t a1@<X0>, uint64_t a2@<X1>, _BYTE *a3@<X8>)
{
  sub_167E624(v32, 0, 0);
  sub_194DB28(v32, a1);
  ...
  if (v33)
  {
    ...
    {
      v9 = *v6;
      if (!std::string::compare((*(*v6 + 24) & 0xFFFFFFFFFFFFFFFELL), "result_type_all"))
      {
        v10 = *(v9 + 32);
        if (!std::string::compare((v10 & 0xFFFFFFFFFFFFFFFELL), "CATEGORY_QUERY"))
        {
          v8 = 9;
        }

        else if (!std::string::compare((v10 & 0xFFFFFFFFFFFFFFFELL), "CHAIN_QUERY"))
        {
          v8 = 8;
        }
      ...
      else if (!std::string::compare((*(v9 + 24) & 0xFFFFFFFFFFFFFFFELL), "CANONICAL_NAME"))
      {
        std::string::operator=(&v31, (*(v9 + 32) & 0xFFFFFFFFFFFFFFFELL));
      }
    ...
    if (v8 == 8)
    {
      ...
      if (size)
      {
        ...
        {
          v26 |= 2u;
          v18 = (v25 & 0xFFFFFFFFFFFFFFFCLL);
          if (v25)
          {
            v18 = *v18;
          }

          sub_194EA1C(v28, v21, v18);
        }
...
void sub_1B78888(void *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, uint64_t a10, void *__p, uint64_t a12, int a13, __int16 a14, char a15, char a16, char a17, uint64_t a18, uint64_t a19, uint64_t a20, uint64_t a21, uint64_t a22, uint64_t a23, void *a24, uint64_t a25, int a26, __int16 a27, char a28, char a29, char a30)
{
  if (a16 < 0)
  {
    operator delete(__p);
...
void sub_1B78908(uint64_t a1@<X0>, _BYTE *a2@<X8>)
{
  if (sub_194F918(a1 + 16, dword_278D328))
  {
    if ((*(a1 + 40) & 2) != 0)
    {
      v4 = *(*(a1 + 56) + 48) & 0xFFFFFFFFFFFFFFFELL;
      if (*(v4 + 23) < 0)
      {
    ...
    {
      sub_3608D0(__p, &unk_236C720);
    }

    v6 = sub_194FEFC(a1 + 16, dword_278D328, qword_278D330);
    sub_1B7852C(v6, __p, a2);
    if (SHIBYTE(v8) < 0)
    {
      operator delete(__p[0]);
    }
...
void sub_1B789DC(_Unwind_Exception *exception_object, int a2, int a3, int a4, int a5, int a6, int a7, int a8, void *__p, uint64_t a10, int a11, __int16 a12, char a13, char a14)
{
  if (a14 < 0)
  {
    operator delete(__p);
...
uint64_t sub_1B789F8(uint64_t a1)
{
  if (!sub_194F918(a1 + 16, dword_278D328))
  {
    return 0;
  ...
  v2 = sub_194FEFC(a1 + 16, dword_278D328, qword_278D330);
  sub_167E624(v14, 0, 0);
  sub_194DB28(v14, v2);
  if (v16)
  {
...
LABEL_24:
  ...
  while (1)
  {
    ...
    v7 = *v5;
    v8 = *(v5 + 8);
    if (v7 != 0x5F474E4C5F54414CLL || v8 != 21329)
    {
      goto LABEL_23;
    }
...
void sub_1B78B5C()
{
  ...
  sub_1966280(qword_27EE150, v1247, 249);
  v0 = &v1496;
  v1 = -13944;
  do
  {
...
void sub_1B83618()
{
  ...
  unk_27EE110 = 0;
  qword_27EE118 = 0;
  sub_68678C(&qword_27EE108, __p, &v4, 1uLL);
  if (v3 < 0)
  {
    operator delete(__p[0]);
  }
  ...
  *algn_27EE128 = 0;
  qword_27EE130 = 0;
  sub_68678C(&qword_27EE120, __p, &v4, 1uLL);
  if (v3 < 0)
  {
    operator delete(__p[0]);
  }
  ...
  unk_27EE140 = 0;
  qword_27EE148 = 0;
  sub_68678C(&qword_27EE138, __p, &v4, 1uLL);
  if (v3 < 0)
  {
    operator delete(__p[0]);
  }
  ...
  v30 = 4;
  sub_19664AC(&unk_27EE168, __p, 14);
  v0 = 56;
  do
  {
    if (*(&__p[v0 - 1] - 1) < 0)
  ...
  sub_3608D0(v69, "EG");
  v70 = 6;
  sub_1966844(&unk_27EE190, __p, 34);
  v1 = 136;
  do
  {
    if (*(&__p[v1 - 1] - 1) < 0)
...
void sub_1B83CB8(_Unwind_Exception *exception_object, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, void *__p, uint64_t a11, int a12, __int16 a13, char a14, char a15)
{
  v17 = (v15 + 1079);
  v18 = -1088;
  v19 = v17;
...
void sub_1B83E44(std::string *__str@<X0>, std::string *a2@<X8>)
{
  ...
  if (size)
  {
    v7 = (v5 + size);
    v8 = v5;
    while (v8->__r_.__value_.__s.__data_[0] != 45)
    {
      v8 = (v8 + 1);
      if (!--size)
      {
  ...
  std::string::basic_string(&__p, __str, 0, v10, &v18);
  ...
  if (v12)
  {
    v13 = (p_p + v12);
    v14 = p_p;
    while (v14->__r_.__value_.__s.__data_[0] != 95)
    {
      v14 = (v14 + 1);
      if (!--v12)
      {
  ...
  std::string::basic_string(a2, &__p, 0, v16, &v18);
  if (SHIBYTE(__p.__r_.__value_.__r.__words[2]) < 0)
  {
    operator delete(__p.__r_.__value_.__l.__data_);
  }
...
void sub_1B83F50(_Unwind_Exception *exception_object, int a2, int a3, int a4, int a5, int a6, int a7, int a8, void *__p, uint64_t a10, int a11, __int16 a12, char a13, char a14)
{
  if (a14 < 0)
  {
    operator delete(__p);
...
void sub_1B83F6C(uint64_t a1@<X0>, std::string *a2@<X8>)
{
  v4 = sub_58BBC(a1);
  if (v4[1] == *v4)
  {
...
std::string *sub_1B83FE8@<X0>(std::string *__str@<X0>, std::string *a2@<X8>)
{
  ...
  if (v2)
  {
    ...
    if (v8 != -1)
    {
      return std::string::basic_string(a2, __str, v8 + 1, 0xFFFFFFFFFFFFFFFFLL, &v11);
    }
...
uint64_t sub_1B840C0(uint64_t a1)
{
  v2 = sub_58BBC(a1);
  if (v2[1] == *v2)
  {
  ...
  return sub_1B8411C(v3);
}

uint64_t sub_1B8411C(std::string *a1)
{
  if (sub_19D52D4(qword_27EE1B8, &a1->__r_.__value_.__l.__data_))
  {
    v2 = sub_19D52D4(qword_27EE1B8, &a1->__r_.__value_.__l.__data_);
    if (!v2)
    {
  ...
  {
    sub_1B83FE8(a1, &__p);
    if (sub_19D52D4(qword_27EE1B8, &__p.__r_.__value_.__l.__data_))
    {
      v4 = sub_19D52D4(qword_27EE1B8, &__p.__r_.__value_.__l.__data_);
      if (!v4)
      {
        sub_49EC("unordered_map::at: key not found");
      }
...
void sub_1B841E4(_Unwind_Exception *exception_object, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, void *__p, uint64_t a11, int a12, __int16 a13, char a14, char a15)
{
  if (a15 < 0)
  {
    operator delete(__p);
...
void sub_1B84204()
{
  ...
  v4 = 233;
  sub_195E43C(&v1495, v5, __p);
  sub_1966280(qword_27EE250, v1247, 249);
  v0 = &v1496;
  v1 = -13944;
  do
  {
