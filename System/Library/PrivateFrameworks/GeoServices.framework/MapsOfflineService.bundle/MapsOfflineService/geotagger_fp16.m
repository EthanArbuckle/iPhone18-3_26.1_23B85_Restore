...
- (geotagger_fp16)init;
- (geotagger_fp16)initWithConfiguration:(id)a3 error:(id *)a4;
- (geotagger_fp16)initWithContentsOfURL:(id)a3 configuration:(id)a4 error:(id *)a5;
- (geotagger_fp16)initWithContentsOfURL:(id)a3 error:(id *)a4;
- (geotagger_fp16)initWithMLModel:(id)a3;
- (id)predictionFromFeatures:(id)a3 error:(id *)a4;
- (id)predictionFromFeatures:(id)a3 options:(id)a4 error:(id *)a5;
- (id)predictionFromInput_ids:(id)a3 attention_mask:(id)a4 error:(id *)a5;
...
- (geotagger_fp16)init
{
  ...
  v4 = [(geotagger_fp16 *)self initWithContentsOfURL:v3 error:0];
...
- (geotagger_fp16)initWithConfiguration:(id)a3 error:(id *)a4
{
  ...
  v8 = [(geotagger_fp16 *)self initWithContentsOfURL:v7 configuration:v6 error:a4];
...
- (id)predictionFromFeatures:(id)a3 error:(id *)a4
{
  ...
  v8 = [(geotagger_fp16 *)self predictionFromFeatures:v6 options:v7 error:a4];
...
- (id)predictionFromFeatures:(id)a3 options:(id)a4 error:(id *)a5
{
  ...
  if (v11)
  {
    ...
    v15 = [(geotagger_fp16Output *)v12 initWithLogits:v14];
  }
...
- (id)predictionFromInput_ids:(id)a3 attention_mask:(id)a4 error:(id *)a5
{
  v8 = a4;
  v9 = a3;
  v10 = [[geotagger_fp16Input alloc] initWithInput_ids:v9 attention_mask:v8];

  v11 = [(geotagger_fp16 *)self predictionFromFeatures:v10 error:a5];
  ...
  if (v12)
  {
    ...
    if ([v12 count] >= 1)
    {
      ...
      do
      {
        ...
        v19 = [(geotagger_fp16Output *)v16 initWithLogits:v18];
