void sub_1DC6EA0(uint64_t a1, uint64_t *a2)
{
  v3 = *(a1 + 8);
  *v3 = 0;
  v3[1] = 0;
...
uint64_t sub_1DC6F00(uint64_t a1, uint64_t *a2)
{
...
void sub_1DC7028(_Unwind_Exception *a1, uint64_t a2, ...)
{
  va_start(va, a2);
  sub_1A7EC90(va);
  _Unwind_Resume(a1);
...
uint64_t sub_1DC703C(uint64_t *a1, uint64_t a2)
{
...
void sub_1DC7158(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, ...)
{
  va_start(va, a4);
  sub_1DC72CC(va);
  _Unwind_Resume(a1);
...
void *sub_1DC7348(void *a1, uint64_t *a2, void *a3)
{
  *a1 = 0;
  a1[1] = 0;
  a1[2] = 0;
...
uint64_t sub_1DC73F4(uint64_t a1, void *a2)
{
...
_BYTE *sub_1DC7744@<X0>(uint64_t a1@<X0>, const void **a2@<X1>, uint64_t a3@<X2>, _BYTE *a4@<X8>)
{
  if ((*(a1 + 24) & 1) == 0)
  {
    if (*(a2 + 23) >= 0)
    ...
    *&__str.__r_.__value_.__l.__data_ = v14;
    ...
    v15 = std::string::append(&__str, "\t", 1uLL);
  ...
  return sub_3608D0(a4, &unk_237BA93);
}
...
void sub_1DC7A0C(uint64_t a1@<X0>, uint64_t a2@<X1>, uint64_t a3@<X2>, uint64_t a4@<X8>)
{
  if (*(a1 + 24))
  {
    goto LABEL_12;
...
uint64_t sub_1DC7EF8@<X0>(uint64_t result@<X0>, void *a2@<X8>)
{
  if ((*(result + 24) & 1) == 0)
  {
...
uint64_t sub_1DC80F4@<X0>(uint64_t result@<X0>, void *a2@<X8>)
{
  if (*(result + 24) != 1)
  {
    std::operator+<char>();
...
void sub_1DC8558(_Unwind_Exception *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, uint64_t a10, void *__p, uint64_t a12, uint64_t a13, char a14)
{
  sub_197F740(&a14);
  sub_197F7C0(v14 - 56);
  if (__p)
...
void sub_1DC8DB8()
{
  ...
  sub_1966280(qword_27EF940, v1247, 249);
  v0 = &v1496;
  v1 = -13944;
  do
  {
...
void sub_1DD3874()
{
  ...
  unk_27EF900 = 0;
  qword_27EF908 = 0;
  sub_68678C(&qword_27EF8F8, __p, &v2, 1uLL);
  if (v1 < 0)
  {
    operator delete(__p[0]);
  }
  ...
  *algn_27EF918 = 0;
  qword_27EF920 = 0;
  sub_68678C(&qword_27EF910, __p, &v2, 1uLL);
  if (v1 < 0)
  {
    operator delete(__p[0]);
  }
  ...
  unk_27EF930 = 0;
  qword_27EF938 = 0;
  sub_68678C(&qword_27EF928, __p, &v2, 1uLL);
  if (v1 < 0)
  {
    operator delete(__p[0]);
  }
...
void sub_1DD40C4()
{
  ...
  v4 = 233;
  sub_195E43C(&v1495, v5, __p);
  sub_1966280(qword_27EF9A0, v1247, 249);
  v0 = &v1496;
  v1 = -13944;
  do
  {
