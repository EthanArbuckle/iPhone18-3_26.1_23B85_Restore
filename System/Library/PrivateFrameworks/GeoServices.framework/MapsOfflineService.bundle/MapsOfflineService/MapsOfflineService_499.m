...
unint64_t sub_1B127A4(unsigned __int16 *a1, uint64_t a2, unsigned __int16 *a3, uint64_t a4, char *a5)
{
  v5 = 0;
  if (a2 && a4)
  {
...
unint64_t sub_1B12828(unsigned __int16 *__src, unint64_t a2, char *a3, unint64_t a4, char *__dst)
{
  if (a4)
  {
    if (a2)
...
unint64_t sub_1B1296C(unsigned __int16 *a1, unint64_t a2, unsigned __int16 *__src, unint64_t a4, char *a5)
{
  v5 = a2;
  v6 = a1;
  if (a2 >= a4)
...
unint64_t sub_1B12B68(unsigned __int16 **a1, unsigned __int16 **a2, uint64_t a3)
{
  v6 = *a1;
  v7 = *a2;
  if (*(a3 + 4) < v7 + v6)
...
unint64_t sub_1B12BE0(int *a1, int *a2, uint64_t a3)
{
  v6 = *a1;
  v7 = *a2;
  if (v6 >= v7)
...
int *sub_1B12C9C(int *result, unsigned int *a2, unsigned int *a3)
{
  v4 = result;
  if (a2 != a3)
  {
...
void *sub_1B13158(uint64_t a1, uint64_t a2)
{
  v4 = *a1;
  if (*a1 > *(a2 + 4))
  {
...
uint64_t sub_1B1442C(uint64_t result, uint64_t a2, uint64_t a3)
{
  v5 = result;
  v6 = *(result + 8);
  v7 = *result;
...
uint64_t sub_1B14C34(unsigned int *a1, uint64_t a2, void **a3)
{
  v6 = *(a1 + 1);
  v7 = *a1;
  v8 = v7;
...
uint64_t sub_1B156A8(uint64_t a1, uint64_t a2, uint64_t a3)
{
  if (!*(a1 + 184))
  {
    return 0;
  ...
  if ((v8 & 1) != 0 && (QuasarCPDecTranslator_translateResult(), (v9 = QuasarCPDecTranslationResult_string()) != 0))
  {
    ...
    else
    {
      ...
      *(a3 + 28) = v14;
      *(a3 + 32) = QuasarCPDecTranslationResult_isLowConfidence() != 0;
    }
...
void sub_1B15960()
{
  ...
  sub_1966280(qword_27EDD10, v1247, 249);
  v0 = &v1496;
  v1 = -13944;
  do
  {
...
void sub_1B2041C()
{
  ...
  unk_27EDCD0 = 0;
  qword_27EDCD8 = 0;
  sub_68678C(&qword_27EDCC8, __p, &v2, 1uLL);
  if (v1 < 0)
  {
    operator delete(__p[0]);
  }
  ...
  *algn_27EDCE8 = 0;
  qword_27EDCF0 = 0;
  sub_68678C(&qword_27EDCE0, __p, &v2, 1uLL);
  if (v1 < 0)
  {
    operator delete(__p[0]);
  }
  ...
  unk_27EDD00 = 0;
  qword_27EDD08 = 0;
  sub_68678C(&qword_27EDCF8, __p, &v2, 1uLL);
  if (v1 < 0)
  {
    operator delete(__p[0]);
  }
...
void sub_1B2069C(_Unwind_Exception *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, uint64_t a10, int a11, __int16 a12, char a13, char a14, uint64_t a15, void *__p, uint64_t a17, int a18, __int16 a19, char a20, char a21, char a22, uint64_t a23, uint64_t a24, uint64_t a25, uint64_t a26)
{
  sub_16F0320(&a22);
  sub_179DE08(&a26);
  _Unwind_Resume(a1);
...
void sub_1B20A2C(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, uint64_t a16, uint64_t a17, ...)
{
  va_start(va, a17);
  sub_1812FDC(va);
  sub_1B220A0(v17 + 8);
...
uint64_t sub_1B20B94(uint64_t a1, void *a2, uint64_t a3)
{
  ...
  else
  {
    ...
    if (v39)
    {
      ...
      {
        sub_17CBB54(v41, *v12);
        v15 = *((v44 & 0xFFFFFFFFFFFFFFFELL) + 23);
        if (v15 >= 0)
        {
          v16 = *((v44 & 0xFFFFFFFFFFFFFFFELL) + 23);
        }

        else
        {
          v16 = *((v44 & 0xFFFFFFFFFFFFFFFELL) + 8);
        }
...
LABEL_33:
  ...
  {
    sub_184CABC(v41, 0, 0);
    sub_194DB28(v41, *(a1 + 208) & 0xFFFFFFFFFFFFFFFELL);
    v22 = sub_19D5254(a3, a2);
    if (*(v22 + 79) < 0)
    {
      sub_325C(v37, *(v22 + 56), *(v22 + 64));
    }
    ...
    if (v42)
    {
      ...
      {
        v25 = *v23;
        if (sub_194F918(*v23 + 16, dword_278DAF0))
        {
          v26 = sub_194FEFC(v25 + 16, dword_278DAF0, qword_278DAF8);
          v27 = SHIBYTE(v38);
          if (v38 >= 0)
          {
            v28 = HIBYTE(v38);
