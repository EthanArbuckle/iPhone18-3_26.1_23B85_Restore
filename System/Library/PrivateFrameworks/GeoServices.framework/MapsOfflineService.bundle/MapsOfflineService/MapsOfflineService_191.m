...
uint64_t sub_B890CC(uint64_t a1, int a2)
{
  v120 = a2;
  *(a1 + 688) = a2;
  v3 = *(a1 + 104);
...
void sub_B8A9DC(uint64_t a1, int a2, int a3)
{
  if (*(a1 + 48) != 1)
  {
    goto LABEL_8;
...
void sub_B8DF00(uint64_t a1)
{
  if (sub_A822FC(*(a1 + 24)))
  {
    ...
    *(a1 + 264) = v3 + 1;
    ...
    else if (!sub_B9139C((a1 + 128), 0, v19, v18, 0xFFFFFFFF, 2147483646))
    {
      return;
    }
...
uint64_t sub_B90D3C(uint64_t a1)
{
  if (*a1 == -1)
  {
    return 0;
...
uint64_t sub_B9139C(void *a1, unsigned int a2, unsigned int a3, unsigned int a4, unsigned int a5, int a6)
{
  v48[0] = a2;
...
char *sub_B91668(uint64_t a1, unsigned int a2, char *a3, _BYTE *a4)
{
  v49 = a2;
...
char *sub_B93498(uint64_t a1, unsigned int a2)
{
  v17 = a2;
  v4 = *(a1 + 88);
...
uint64_t sub_B93904(uint64_t a1, uint64_t a2, unsigned int a3)
{
  v16 = a3;
  v6 = *(a1 + 88);
