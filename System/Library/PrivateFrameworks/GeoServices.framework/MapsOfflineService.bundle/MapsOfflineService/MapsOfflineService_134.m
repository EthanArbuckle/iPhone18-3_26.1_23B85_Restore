uint64_t sub_85B6F0(uint64_t result, uint64_t a2, uint64_t a3, int a4)
{
  if (*(result + 1939) == 1)
  {
    v4 = *(result + 1928);
...
void sub_85BB28(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, ...)
{
  va_start(va, a13);
  sub_540798(va);
  if (*(v13 - 57) < 0)
...
void sub_85BB8C(uint64_t a1, uint64_t *a2, int a3)
{
  if (*(a1 + 1940) == 1)
  {
    sub_681008(a2, &__p);
...
void sub_85C0C0(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, ...)
{
  va_start(va, a3);
  sub_1A104(va);
  _Unwind_Resume(a1);
...
void sub_85E608(std::string *a1, __int128 **a2, unsigned __int8 a3)
{
...
void sub_85E764(uint64_t a1, uint64_t a2)
{
  if (*(a1 + 1936))
  {
    v4 = "Start_Route";
...
void sub_85E7FC(uint64_t a1, uint64_t a2)
{
  if (*(a1 + 1936))
  {
...
void sub_85E864(uint64_t a1, uint64_t a2)
{
...
void sub_85E948(void *a1, uint64_t a2)
{
  if (*(a1[265] + 1560) == 11)
  {
    v4 = "Resume_Route";
...
void sub_85EBD0(std::string *a1, char *a2, std::string **a3)
{
  sub_67E35C(a3, a2);
...
void sub_85ED5C(uint64_t a1, uint64_t a2)
{
  if (*(a1 + 1935))
  {
    v4 = &qword_27AE1D0;
...
void sub_85EDC4(uint64_t a1, uint64_t a2)
{
  if (*(a1 + 1935))
  {
    v4 = &qword_27AE1E8;
...
void sub_85EE2C(uint64_t a1, std::string **a2)
{
...
void sub_85EE78(uint64_t a1, std::string **a2)
{
...
void sub_85EEC4(uint64_t a1, std::string **a2)
{
...
void sub_85EF10(void *a1, uint64_t a2)
{
...
void sub_85EFBC(uint64_t a1, uint64_t a2)
{
...
void sub_85F090(uint64_t a1, char *a2, uint64_t a3)
{
  if (*(a1 + 1936) == 1)
  {
    sub_67E35C(a3, a2);
...
void sub_85F194(uint64_t a1, uint64_t a2)
{
  v4 = *(a1 + 1928);
  v5 = &qword_27AE1B8;
  if (v4 != 87)
...
void sub_85F204(uint64_t a1, char *a2, uint64_t a3)
{
  sub_67E35C(a3, a2);
...
void sub_85F280(uint64_t a1, char *a2, uint64_t a3)
{
  sub_67E35C(a3, a2);
  sub_67F210(a3, "_ExitNumber", "{ExitNumber}", (a1 + 456));
  sub_67F210(a3, "_Intersection", "{Intersection}", (a1 + 304));
...
void sub_85F6AC(_Unwind_Exception *a1, uint64_t a2, ...)
{
  va_start(va1, a2);
  va_start(va, a2);
  v3 = va_arg(va1, void);
...
void sub_85FB38(_Unwind_Exception *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, char a15, uint64_t a16, uint64_t a17, uint64_t a18, uint64_t a19, uint64_t a20, void *__p, uint64_t a22, int a23, __int16 a24, char a25, char a26)
{
  sub_540798(&a9);
  sub_540798(&a15);
  if (a26 < 0)
...
void sub_85FE1C(uint64_t a1@<X0>, uint64_t a2@<X8>)
{
  if ((*(a1 + 1928) - 82) <= 2)
  {
...
uint64_t sub_8624B4(uint64_t result)
{
...
void sub_863F0C(_Unwind_Exception *a1, uint64_t a2, ...)
{
  va_start(va1, a2);
  va_start(va, a2);
  v3 = va_arg(va1, void);
...
void sub_864F88(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, char a11)
{
  sub_1F1A8(&a9);
  sub_540798(&a11);
  _Unwind_Resume(a1);
...
void sub_864FA4(uint64_t a1@<X0>, uint64_t *a2@<X8>)
{
  if (*(a1 + 1940) != 1)
  {
...
void sub_86517C(_Unwind_Exception *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, char a10, uint64_t a11, char a12, uint64_t a13, void *__p, uint64_t a15, int a16, __int16 a17, char a18, char a19)
{
  sub_1F1A8(&a10);
  if (a19 < 0)
  {
...
void sub_8651B8(uint64_t a1, uint64_t *a2, uint64_t a3, int a4)
{
  if (*(a1 + 1940) == 1)
  {
    sub_868CBC(a1, a2, a3);
...
void sub_8670F0(uint64_t a1@<X0>, uint64_t *a2@<X8>)
{
  v5 = 0;
  v6 = 0;
...
void sub_867E6C(_Unwind_Exception *a1, uint64_t a2, ...)
{
  va_start(va, a2);
  sub_513574(va);
  _Unwind_Resume(a1);
...
uint64_t sub_868248(uint64_t result, uint64_t a2, int a3)
{
...
uint64_t sub_868820(uint64_t result, uint64_t a2, uint64_t a3, int a4)
{
  if (*(result + 1939) == 1)
  {
    v4 = *(result + 1928);
...
void sub_868C58(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, ...)
{
  va_start(va, a13);
  sub_540798(va);
  if (*(v13 - 57) < 0)
...
void sub_868CBC(uint64_t a1, uint64_t *a2, int a3)
{
  if (*(a1 + 1940) == 1)
  {
    sub_681008(a2, &__p);
...
void sub_8691F0(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, ...)
{
  va_start(va, a3);
  sub_1A104(va);
  _Unwind_Resume(a1);
...
void sub_869204(_Unwind_Exception *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, uint64_t a10, char a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, uint64_t a16, uint64_t a17, uint64_t a18, uint64_t a19, uint64_t a20, uint64_t a21, uint64_t a22, uint64_t a23, char a24, uint64_t a25, uint64_t a26, void *__p, uint64_t a28, int a29, __int16 a30, char a31, char a32)
{
  sub_746A0(&a11);
  sub_99B5C((v32 - 160));
  if (*(v32 - 105) < 0)
...
void sub_86941C(_Unwind_Exception *a1, uint64_t a2, ...)
{
  va_start(va, a2);
  sub_6870C4(va);
  _Unwind_Resume(a1);
...
void sub_86973C(_Unwind_Exception *a1, uint64_t a2, ...)
{
  va_start(va, a2);
  sub_6870C4(va);
  _Unwind_Resume(a1);
...
void sub_869750(_Unwind_Exception *a1, uint64_t a2, ...)
{
  va_start(va1, a2);
  va_start(va, a2);
  v3 = va_arg(va1, void);
...
unint64_t sub_86CEB0(void **a1, uint64_t a2, void *a3)
{
  ...
  if (result)
  {
    ...
    v9 = sub_68C454(a3, 0);
    v10 = sub_73EC4(a2);
    result = sub_86CF7C(a1, v8, v9, *v10);
    if (v7 != 1)
    {
      for (i = 1; i != v7; ++i)
      {
        v12 = sub_4C49C0(a2, i);
        v13 = sub_68C454(a3, i);
        result = sub_86CF7C(a1, v12, v13, 0.0);
      }
    }
  }
...
BOOL sub_86CF7C(void **a1, void *a2, void *a3, double a4)
{
  result = sub_4D1F6C(a2);
  if (!result)
  {
    sub_86D1C8(a1, a3, &v20);
    if (v21 != v20)
    {
      v9 = 0;
