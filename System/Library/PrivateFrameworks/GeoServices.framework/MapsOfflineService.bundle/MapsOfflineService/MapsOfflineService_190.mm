...
uint64_t sub_B7C8B8(void *a1, unsigned int a2, unsigned int a3, int a4, int a5, int a6)
{
  v58[0] = a2;
...
uint64_t sub_B7D3A0(uint64_t a1, int a2)
{
  v126 = a2;
  *(a1 + 688) = a2;
  v3 = *(a1 + 104);
...
void sub_B7ED84(uint64_t a1, int a2, int a3)
{
  if (*(a1 + 48) != 1)
  {
    goto LABEL_8;
...
uint64_t sub_B87428(void *a1, unsigned int a2, unsigned int a3, int a4, int a5, int a6)
{
  v58[0] = a2;
  sub_B7A790(a1, v58, v55);
  v11 = a1[6];
...
void sub_B87B30(uint64_t a1, unint64_t a2, uint64_t a3)
{
  v6 = *(a1 + 8);
  v5 = *(a1 + 16);
  if (a2 <= (v5 - v6) >> 4)
...
void sub_B87D34(_Unwind_Exception *a1, uint64_t a2, ...)
{
  va_start(va, a2);
  sub_B2F26C(va);
  _Unwind_Resume(a1);
...
void sub_B87D58(_Unwind_Exception *a1, uint64_t a2, ...)
{
  va_start(va, a2);
  sub_B2F26C(va);
  _Unwind_Resume(a1);
...
void sub_B87EB4(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, ...)
{
  va_start(va, a3);
  sub_B2F210(va);
  _Unwind_Resume(a1);
...
void sub_B87EC8(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, ...)
{
  va_start(va, a3);
  sub_B2F210(va);
  _Unwind_Resume(a1);
