...
void sub_212181C()
{
  ...
  unk_27F1D10 = 0;
  qword_27F1D18 = 0;
  sub_68678C(&qword_27F1D08, __p, &v2, 1uLL);
  if (v1 < 0)
  {
  ...
  *algn_27F1D28 = 0;
  qword_27F1D30 = 0;
  sub_68678C(&qword_27F1D20, __p, &v2, 1uLL);
  if (v1 < 0)
  {
    operator delete(__p[0]);
  }
  ...
  unk_27F1D40 = 0;
  qword_27F1D48 = 0;
  sub_68678C(&qword_27F1D38, __p, &v2, 1uLL);
  if (v1 < 0)
  {
    operator delete(__p[0]);
  }
...
_BYTE *sub_2121968@<X0>(uint64_t a1@<X0>, _BYTE *a2@<X8>)
{
  v4 = *(a1 + 192);
  if (!v4)
  {
...
uint64_t sub_21219D0@<X0>(uint64_t a1@<X0>, uint64_t a2@<X8>)
{
  sub_167E624(v26, 0, 0);
  v4 = *(a1 + 192);
  if (!v4)
...
void sub_2121BFC(_Unwind_Exception *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, void *__p, uint64_t a10, int a11, __int16 a12, char a13, char a14, char a15, uint64_t a16, uint64_t a17, uint64_t a18, uint64_t a19, uint64_t a20, uint64_t a21, char a22)
{
  if (a14 < 0)
  {
    operator delete(__p);
...
uint64_t sub_2121C40(double **a1, uint64_t a2)
{
  v2 = *a1;
  v3 = a1[1];
  if (*a1 == v3)
...
_BYTE *sub_2122060@<X0>(uint64_t a1@<X0>, _BYTE *a2@<X8>)
{
  v5 = a1 + 56;
  v4 = *(a1 + 56);
  if (*(v5 + 8) == v4)
...
void sub_2122E24(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, ...)
{
  va_start(va, a7);
  sub_1641398(va);
  _Unwind_Resume(a1);
...
{
  sub_1640984(v150, 0, 0);
  v152 |= 1u;
  v4 = v153;
  if (!v153)
  {
    v5 = (v151 & 0xFFFFFFFFFFFFFFFCLL);
    if (v151)
    {
      v5 = *v5;
    }
  ...
  *(v4 + 76) = v20;
  ...
  if (v21)
  {
    ...
    *(v4 + 16) = v10 | 0x1E1;
    ...
    sub_194EA1C((v4 + 24), (v48 & 0xFFFFFFFFFFFFFFFELL), v50);
    if (*(v15 + 42))
    {
      v51 = v15[36];
      *(v4 + 16) |= 8u;
...
LABEL_90:
    ...
    if ((*(v78 + 41) & 8) != 0)
    {
      ...
      if (*(v79 + 16))
      {
        ...
        *(v4 + 16) |= 2u;
        ...
        sub_194EA1C((v4 + 32), (v80 & 0xFFFFFFFFFFFFFFFELL), v82);
      }
    }
  ...
  *(v88 + 4) |= 1u;
  ...
  sub_10DF26C(v88 + 6, "", v91);
  if ((*(a2 + 40) & 4) != 0)
  {
    v92 = *(a2 + 184);
    if ((v92[5] & 1) != 0 && (v92[7][5] & 0x40) != 0)
    {
      *(v88 + 4) |= 2u;
      v93 = v88[7];
      if (!v93)
  ...
  if (v102)
  {
    ...
    do
    {
      ...
      {
        v107 = sub_1641CE8(v88[3]);
        v106 = sub_19593CC((v88 + 3), v107);
      }
              ...
              *(v106 + 44) = v132;
              if (*(v131 + 32) >= 1)
              {
                ...
                *(v106 + 16) = v133 | 9;
                ...
                sub_194EA1C((v106 + 24), (v134 & 0xFFFFFFFFFFFFFFFELL), v136);
              }
            }
  ...
  if (!v155)
  {
    v140 = (v151 & 0xFFFFFFFFFFFFFFFCLL);
    if (v151)
    {
      v140 = *v140;
    }
  ...
  *(a2 + 40) |= 0x10u;
  ...
  if (!v141)
  {
    ...
    v141 = sub_19062B0(v143);
    *(a2 + 200) = v141;
  }

  v144 = sub_1950D4C((v141 + 16), dword_278D9F8, 11, &off_277B8D0, 0);
  sub_16411B0(v144, v150);
  return sub_1640AA4(v150);
}

void sub_21237F4(_Unwind_Exception *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, char a14, uint64_t a15, uint64_t a16, uint64_t a17, uint64_t a18, uint64_t a19, void *__p, uint64_t a21, int a22, __int16 a23, char a24, char a25)
{
  if (a25 < 0)
  {
    operator delete(__p);
...
void *sub_21238D4(void *result, uint64_t *a2)
{
  v3 = result;
  v4 = result[2];
  v5 = result[1];
...
void sub_2123B68()
{
  ...
  sub_1966280(qword_27F1DB0, v1247, 249);
  v0 = &v1496;
  v1 = -13944;
  do
  {
