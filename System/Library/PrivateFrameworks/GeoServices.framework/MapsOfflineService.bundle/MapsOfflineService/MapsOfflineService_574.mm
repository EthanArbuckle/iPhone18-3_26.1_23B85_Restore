...
void sub_20E4E88()
{
  ...
  unk_27F19F0 = 0;
  qword_27F19F8 = 0;
  sub_68678C(&qword_27F19E8, __p, &v4, 1uLL);
  if (v3 < 0)
  {
  ...
  *algn_27F1A08 = 0;
  qword_27F1A10 = 0;
  sub_68678C(&qword_27F1A00, __p, &v4, 1uLL);
  if (v3 < 0)
  {
    operator delete(__p[0]);
  }
  ...
  unk_27F1A20 = 0;
  qword_27F1A28 = 0;
  sub_68678C(&qword_27F1A18, __p, &v4, 1uLL);
  if (v3 < 0)
  {
    operator delete(__p[0]);
  }
...
uint64_t sub_20E64B4(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4)
{
  v8 = a4;
  v9 = a4;
  v6[0] = a1;
...
void sub_20E6868(_Unwind_Exception *a1, void *a2, uint64_t a3, uint64_t a4, uint64_t a5, void *__p, uint64_t a7, int a8, __int16 a9, char a10, char a11, uint64_t a12, ...)
{
  va_start(va, a12);
  sub_1A6144C(va);
  if (a11 < 0)
...
void sub_20E68EC(uint64_t a1, void *a2)
{
  ...
  if (v3 < 0)
  {
    if (a2[1] != 12 || (**a2 == 0x72656E6547696F50 ? (v5 = *(*a2 + 8) == 1919906913) : (v5 = 0), !v5))
    {
      if (a2[1] != 12)
      {
        return;
...
LABEL_16:
      ...
      {
        v7 = *(nullsub_1(a1) + 1528);
        v8 = *(nullsub_1(a1) + 1536);
        if (v8 - 1 <= 0xFFFFFFFFFFFFFFFDLL && os_signpost_enabled(v7))
        {
          ...
          v10 = &v11;
LABEL_27:
          _os_signpost_emit_with_name_impl(&dword_0, v7, OS_SIGNPOST_INTERVAL_BEGIN, v8, v9, "", v10, 2u);
          return;
        }
      }
...
LABEL_16:
      if (*a2 == 0x72656E65476F6547 && *(a2 + 2) == 1919906913)
      {
        ...
        if (v8 - 1 <= 0xFFFFFFFFFFFFFFFDLL && os_signpost_enabled(v7))
        {
          ...
          v10 = &v11;
LABEL_27:
          _os_signpost_emit_with_name_impl(&dword_0, v7, OS_SIGNPOST_INTERVAL_END, v8, v9, "", v10, 2u);
          return;
        }
      }
...
uint64_t sub_20E735C(uint64_t a1, uint64_t a2, uint64_t a3)
{
  result = sub_6EECC();
  if (result)
  {
...
void sub_20E74C4(_Unwind_Exception *a1, void *a2, uint64_t a3, uint64_t a4, uint64_t a5, void *__p, uint64_t a7, int a8, __int16 a9, char a10, char a11, uint64_t a12, ...)
{
  va_start(va, a12);
  sub_1A6144C(va);
  if (a11 < 0)
...
uint64_t sub_20E7C3C(uint64_t a1, uint64_t a2, uint64_t a3)
{
  result = sub_6EECC();
  if (result)
  {
...
void sub_20E7DA4(_Unwind_Exception *a1, void *a2, uint64_t a3, uint64_t a4, uint64_t a5, void *__p, uint64_t a7, int a8, __int16 a9, char a10, char a11, uint64_t a12, ...)
{
  va_start(va, a12);
  sub_1A6144C(va);
  if (a11 < 0)
...
uint64_t sub_20E83A0(uint64_t a1, uint64_t a2, uint64_t a3)
{
  result = sub_6EECC();
  if (result)
  {
...
void sub_20E8508(_Unwind_Exception *a1, void *a2, uint64_t a3, uint64_t a4, uint64_t a5, void *__p, uint64_t a7, int a8, __int16 a9, char a10, char a11, uint64_t a12, ...)
{
  va_start(va, a12);
  sub_1A6144C(va);
  if (a11 < 0)
...
uint64_t *sub_20E8A50(void *a1, int *a2)
{
  v2 = *a2;
  v3 = a1[1];
  if (!*&v3)
...
void sub_20E8F14(_Unwind_Exception *a1, void *a2, uint64_t a3, uint64_t a4, uint64_t a5, void *__p, uint64_t a7, int a8, __int16 a9, char a10, char a11, uint64_t a12, ...)
{
  va_start(va, a12);
  sub_1A6144C(va);
  if (a11 < 0)
...
void sub_20E945C()
{
  ...
  sub_1966280(qword_27F1AE0, v1247, 249);
  v0 = &v1496;
  v1 = -13944;
  do
  {
...
void sub_20F3F18()
{
  ...
  unk_27F1AA0 = 0;
  qword_27F1AA8 = 0;
  sub_68678C(&qword_27F1A98, __p, &v4, 1uLL);
  if (v3 < 0)
  {
    operator delete(__p[0]);
  }
  ...
  *algn_27F1AB8 = 0;
  qword_27F1AC0 = 0;
  sub_68678C(&qword_27F1AB0, __p, &v4, 1uLL);
  if (v3 < 0)
  {
    operator delete(__p[0]);
  }
  ...
  unk_27F1AD0 = 0;
  qword_27F1AD8 = 0;
  sub_68678C(&qword_27F1AC8, __p, &v4, 1uLL);
  if (v3 < 0)
  {
    operator delete(__p[0]);
  }
