...
void sub_197D370()
{
  ...
  *algn_27ECBF8 = 0;
  qword_27ECC00 = 0;
  sub_68678C(&qword_27ECBF0, __p, &v2, 1uLL);
  if (v1 < 0)
  {
  ...
  unk_27ECC10 = 0;
  qword_27ECC18 = 0;
  sub_68678C(&qword_27ECC08, __p, &v2, 1uLL);
  if (v1 < 0)
  {
    operator delete(__p[0]);
  }
  ...
  *algn_27ECC28 = 0;
  qword_27ECC30 = 0;
  sub_68678C(&qword_27ECC20, __p, &v2, 1uLL);
  if (v1 < 0)
  {
    operator delete(__p[0]);
  }
...
void sub_197D7CC(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, char a16, uint64_t a17, uint64_t a18, uint64_t a19, char a20)
{
  sub_19800BC(&a20);
  sub_197D814(&a9);
  v22 = sub_197E14C(v20 - 72);
  *(v20 - 72) = &a16;
  sub_1962638(v22);
  _Unwind_Resume(a1);
}
...
uint64_t sub_197D864(uint64_t a1)
{
  *a1 = &off_27217A0;
  v3 = (a1 + 8);
  sub_197DB3C(&v3);
...
void sub_197D990(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, void **a9)
{
  *(v9 + 8) = v10;
  sub_197DB3C(&a9);
  _Unwind_Resume(a1);
...
void sub_197DD28(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, ...)
{
  va_start(va, a4);
  sub_197DEC8(va);
  _Unwind_Resume(a1);
...
void sub_197E4C4(uint64_t a1, uint64_t a2)
{
  sub_197D4D4(a2, (a1 + 8), v9);
  sub_197E8A4(&v8);
  v3 = v9[0];
  if (v9[0] != v9[1])
  {
...
void sub_197EC18(_Unwind_Exception *a1, uint64_t a2, ...)
{
  va_start(va, a2);
  sub_197DB3C(va);
  _Unwind_Resume(a1);
...
void *sub_197EC30(void *result, unint64_t a2)
{
...
void sub_197ECF8(_Unwind_Exception *a1, uint64_t a2, ...)
{
  va_start(va, a2);
  sub_197ED9C(va);
  _Unwind_Resume(a1);
...
void sub_197F114(_Unwind_Exception *a1, uint64_t a2, std::__shared_weak_count *a3, ...)
{
  va_start(va, a3);
  sub_21DD6D8(va);
  if (a3)
...
void sub_197F384(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, ...)
{
  va_start(va, a4);
  sub_197ED9C(va);
  _Unwind_Resume(a1);
...
void sub_19801FC()
{
  ...
  sub_1966280(qword_27ECC98, v1247, 249);
  v0 = &v1496;
  v1 = -13944;
  do
  {
