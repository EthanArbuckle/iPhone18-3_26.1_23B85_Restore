void sub_20F45B8(_Unwind_Exception *exception_object, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, void *__p, uint64_t a11, int a12, __int16 a13, char a14, char a15)
{
  v17 = (v15 + 1079);
  v18 = -1088;
  v19 = v17;
...
uint64_t sub_20F4744(uint64_t a1, uint64_t a2, uint64_t a3, int *a4, uint64_t a5, uint64_t a6, uint64_t a7)
{
  *(a1 + 8) = a7;
  if (*(a2 + 23) < 0)
  {
...
void sub_20F4874(_Unwind_Exception *exception_object, int a2, int a3, int a4, int a5, int a6, int a7, int a8, void *__p, uint64_t a10, int a11, __int16 a12, char a13, char a14)
{
  if (a14 < 0)
  {
    operator delete(__p);
...
float sub_20F4898(uint64_t a1, unsigned int a2)
{
  v2 = *(a1 + 8);
  if (*v2 <= a2)
  {
...
void sub_20F48C0()
{
  ...
  sub_1966280(qword_27F1B90, v1247, 249);
  v0 = &v1496;
  v1 = -13944;
  do
  {
...
void sub_20FF37C()
{
  ...
  unk_27F1B50 = 0;
  qword_27F1B58 = 0;
  sub_68678C(&qword_27F1B48, __p, &v4, 1uLL);
  if (v3 < 0)
  {
    operator delete(__p[0]);
  }
  ...
  *algn_27F1B68 = 0;
  qword_27F1B70 = 0;
  sub_68678C(&qword_27F1B60, __p, &v4, 1uLL);
  if (v3 < 0)
  {
    operator delete(__p[0]);
  }
  ...
  unk_27F1B80 = 0;
  qword_27F1B88 = 0;
  sub_68678C(&qword_27F1B78, __p, &v4, 1uLL);
  if (v3 < 0)
  {
    operator delete(__p[0]);
  }
  ...
  v30 = 4;
  sub_19664AC(&unk_27F1BA8, __p, 14);
  v0 = 56;
  do
  {
    if (*(&__p[v0 - 1] - 1) < 0)
  ...
  sub_3608D0(v69, "EG");
  v70 = 6;
  sub_1966844(&unk_27F1BD0, __p, 34);
  v1 = 136;
  do
  {
    if (*(&__p[v1 - 1] - 1) < 0)
...
void sub_20FFA1C(_Unwind_Exception *exception_object, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, void *__p, uint64_t a11, int a12, __int16 a13, char a14, char a15)
{
  v17 = (v15 + 1079);
  v18 = -1088;
  v19 = v17;
...
void sub_20FFBA8(uint64_t a1@<X0>, uint64_t a2@<X8>)
{
  if (sub_1DED8F8(a1))
  {
    v4 = sub_1DED574(a1);
    std::to_string(&v7, v4);
    v5 = std::string::insert(&v7, 0, "category:", 9uLL);
  }
  ...
  else
  {
    v6 = sub_1DED574(a1);
    std::to_string(&v7, v6);
    v5 = std::string::insert(&v7, 0, "poi:", 4uLL);
  }

  *a2 = *&v5->__r_.__value_.__l.__data_;
...
void sub_20FFC58(_Unwind_Exception *exception_object, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, void *__p, uint64_t a11, int a12, __int16 a13, char a14, char a15)
{
  if (a15 < 0)
  {
    operator delete(__p);
...
void sub_20FFC78(uint64_t a1@<X0>, std::string *a2@<X8>)
{
  v3 = sub_1DED024(a1);
  std::to_string(&v5, v3);
  v4 = std::string::insert(&v5, 0, "geo:", 4uLL);
  *a2 = *v4;
...
void sub_20FFCEC(_Unwind_Exception *exception_object, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, void *__p, uint64_t a11, int a12, __int16 a13, char a14, char a15)
{
  if (a15 < 0)
  {
    operator delete(__p);
...
void sub_20FFD08(os_log_t *a1, uint64_t *a2, uint64_t *a3, uint64_t a4, int a5)
{
  if (a5 == 2)
  {
    v5 = *a3;
    ...
    if (*a3 != v6)
    {
      ...
      while (v5 != v6);
      sub_1CF6F28(v12, ",NSt3__110__function6__funcIPFNS_12basic_stringIcNS_11char_traitsIcEENS_9allocatorIcEEEERKN6search6recall9PoiResultEENS5_ISE_EESD_EE", &__p);
...
void sub_20FFE0C(_Unwind_Exception *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, char *__p, uint64_t a10, int a11, __int16 a12, char a13, char a14, char a15)
{
  if (a14 < 0)
  {
    operator delete(__p);
...
uint64_t sub_20FFE4C(os_log_t *a1, const void **a2, uint64_t a3, uint64_t *a4, int a5)
{
  v6[0] = off_2728BA0;
  v6[1] = sub_20FFBA8;
  v6[3] = v6;
  sub_20FFEF8(a1, a2, a3, a4, v6, a5);
  return sub_2100500(v6);
}

void sub_20FFEE4(_Unwind_Exception *a1, uint64_t a2, ...)
{
  va_start(va, a2);
  sub_2100500(va);
  _Unwind_Resume(a1);
...
void sub_20FFEF8(os_log_t *a1, const void **a2, uint64_t a3, uint64_t *a4, uint64_t a5, int a6)
{
  if (a6 == 2 && *a4 != a4[1])
  {
    sub_19D31BC(a2, 64, &v16);
    sub_1961D34(__p, *(a3 + 8), *(a3 + 16), *(a3 + 16) - *(a3 + 8));
    if ((v15 & 0x80u) == 0)
    {
      v10 = __p;
    }
...
void sub_20FFFEC(_Unwind_Exception *exception_object, int a2, int a3, int a4, int a5, int a6, int a7, int a8, void *a9, uint64_t a10, int a11, __int16 a12, char a13, char a14, uint64_t a15, uint64_t a16, int a17, __int16 a18, char a19, char a20, void *__p, uint64_t a22, int a23, __int16 a24, char a25, char a26)
{
  if (a26 < 0)
  {
    operator delete(__p);
...
uint64_t sub_2100034(os_log_t *a1, const void **a2, uint64_t a3, uint64_t *a4, int a5)
{
  v6[0] = off_2728C50;
  v6[1] = sub_20FFC78;
  v6[3] = v6;
  sub_21000E0(a1, a2, a3, a4, v6, a5);
  return sub_2100674(v6);
}

void sub_21000CC(_Unwind_Exception *a1, uint64_t a2, ...)
{
  va_start(va, a2);
  sub_2100674(va);
  _Unwind_Resume(a1);
...
void sub_21000E0(os_log_t *a1, const void **a2, uint64_t a3, uint64_t *a4, uint64_t a5, int a6)
{
  if (a6 == 2 && *a4 != a4[1])
  {
    sub_19D31BC(a2, 64, &v16);
...
void sub_21001D4(_Unwind_Exception *exception_object, int a2, int a3, int a4, int a5, int a6, int a7, int a8, void *a9, uint64_t a10, int a11, __int16 a12, char a13, char a14, uint64_t a15, uint64_t a16, int a17, __int16 a18, char a19, char a20, void *__p, uint64_t a22, int a23, __int16 a24, char a25, char a26)
{
  if (a26 < 0)
  {
    operator delete(__p);
...
uint64_t sub_210021C(os_log_t *a1, uint64_t *a2, uint64_t *a3, int a4)
{
  v5[0] = off_2728C50;
  v5[1] = sub_20FFC78;
  v5[3] = v5;
  sub_21002C8(a1, a2, a3, v5, a4);
  return sub_2100674(v5);
}

void sub_21002B4(_Unwind_Exception *a1, uint64_t a2, ...)
{
  va_start(va, a2);
  sub_2100674(va);
  _Unwind_Resume(a1);
...
void sub_21002C8(os_log_t *a1, uint64_t *a2, uint64_t *a3, uint64_t a4, int a5)
{
  if (a5 == 2)
  {
    v5 = *a3;
...
void sub_21003CC(_Unwind_Exception *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, char *__p, uint64_t a10, int a11, __int16 a12, char a13, char a14, char a15)
{
  if (a14 < 0)
  {
    operator delete(__p);
...
uint64_t sub_210047C(uint64_t result, void *a2)
{
  v2 = *(result + 8);
  *a2 = off_2728BA0;
  a2[1] = v2;
...
uint64_t sub_21004B4(uint64_t a1, uint64_t a2)
{
  if (sub_197E0F8(a2, &off_2728C20))
  {
    return a1 + 8;
  }
...
uint64_t sub_2100500(uint64_t a1)
{
  v2 = *(a1 + 24);
  if (v2 == a1)
  {
...
uint64_t sub_21005F0(uint64_t result, void *a2)
{
  v2 = *(result + 8);
  *a2 = off_2728C50;
  a2[1] = v2;
...
uint64_t sub_2100628(uint64_t a1, uint64_t a2)
{
  if (sub_197E0F8(a2, &off_2728CD0))
  {
    return a1 + 8;
  }
...
uint64_t sub_2100674(uint64_t a1)
{
  v2 = *(a1 + 24);
  if (v2 == a1)
  {
...
void sub_21006F4()
{
  ...
  v4 = 233;
  sub_195E43C(&v1495, v5, __p);
  sub_1966280(qword_27F1C40, v1247, 249);
  v0 = &v1496;
  v1 = -13944;
  do
  {
