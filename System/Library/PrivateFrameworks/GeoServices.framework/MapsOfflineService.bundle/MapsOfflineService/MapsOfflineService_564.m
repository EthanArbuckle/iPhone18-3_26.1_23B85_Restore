...
void sub_2020488()
{
  ...
  unk_27F11D0 = 0;
  qword_27F11D8 = 0;
  sub_68678C(&qword_27F11C8, __p, &v2, 1uLL);
  if (v1 < 0)
  {
  ...
  *algn_27F11E8 = 0;
  qword_27F11F0 = 0;
  sub_68678C(&qword_27F11E0, __p, &v2, 1uLL);
  if (v1 < 0)
  {
    operator delete(__p[0]);
  }
  ...
  unk_27F1200 = 0;
  qword_27F1208 = 0;
  sub_68678C(&qword_27F11F8, __p, &v2, 1uLL);
  if (v1 < 0)
  {
    operator delete(__p[0]);
  }
...
void sub_20205A8(_Unwind_Exception *exception_object, int a2, int a3, int a4, int a5, int a6, int a7, int a8, void *__p, uint64_t a10, int a11, __int16 a12, char a13, char a14)
{
  if (a14 < 0)
  {
    operator delete(__p);
...
void *sub_20205D4(void *result, uint64_t *a2)
{
  v2 = *a2;
  *a2 = 0;
  *result = v2;
...
void sub_20205F4()
{
  ...
  if (v15 != v16)
  {
    ...
    v21 = 0u;
    v22 = 0;
    sub_1962074(&v21, v15, v16, 0xCCCCCCCCCCCCCCCDLL * ((v16 - v15) >> 5));
    v23[3] = 0;
    operator new();
  }
...
void sub_20209E4(uint64_t a1, uint64_t a2, uint64_t a3)
{
  v5 = nullsub_1(a2);
...
uint64_t sub_2020C64(uint64_t a1)
{
  v2 = *(a1 + 24);
  if (!v2)
  {
...
uint64_t sub_2020CAC(uint64_t a1, uint64_t *a2)
{
  *(a1 + 16) = 0;
  *(a1 + 24) = 0;
  *(a1 + 8) = 0;
  sub_19E41E0(a1 + 8, *a2, a2[1], 0x7D6343EB1A1F58D1 * ((a2[1] - *a2) >> 4));
  *(a1 + 72) = 1;
  *(a1 + 80) = 0x7D6343EB1A1F58D1 * ((a2[1] - *a2) >> 4);
  *(a1 + 88) = 0;
  return a1;
}

uint64_t sub_2020D2C(uint64_t a1)
{
  v3 = (a1 + 4408);
  sub_196232C(&v3);
  sub_1A5EA7C(a1 + 4376);
...
void sub_2020E2C(_Unwind_Exception *a1)
{
  if (*(v1 + 39) < 0)
  {
...
uint64_t sub_2020E50(uint64_t a1)
{
  *a1 = off_2726E60;
  sub_1A5EA7C(a1 + 2712);
  sub_1A6144C(a1 + 40);
...
uint64_t sub_202100C(uint64_t a1, uint64_t a2)
{
  v4 = *(a1 + 8);
  *a2 = off_2726E60;
  *(a2 + 8) = v4;
...
void sub_2021090(_Unwind_Exception *a1)
{
  sub_1A6144C(v1 + 40);
  if (*(v1 + 39) < 0)
  {
...
void sub_2021100(uint64_t a1, void *a2)
{
  *a2 = 0;
  a2[1] = 0;
  sub_2021204();
...
void sub_2021148(_Unwind_Exception *exception_object, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, std::__shared_weak_count *a10)
{
  if (a10)
  {
    sub_1220A18(a10);
...
uint64_t sub_2021160(uint64_t a1, uint64_t a2)
{
  {
    return a1 + 8;
  }
...
void sub_2021614(_Unwind_Exception *a1, int a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, uint64_t a16, uint64_t a17, uint64_t a18, uint64_t a19, uint64_t a20, void *__p, uint64_t a22, int a23, __int16 a24, char a25, char a26, uint64_t a27, uint64_t a28, void *a29, uint64_t a30, uint64_t a31, uint64_t a32, uint64_t a33, uint64_t a34, uint64_t a35, uint64_t a36, uint64_t a37, uint64_t a38, uint64_t a39, uint64_t a40, uint64_t a41, uint64_t a42, uint64_t a43)
{
  if (a2)
  {
    if (a26 < 0)
    ...
    sub_19D4D44(&STACK[0x3F8]);
    a41 = &STACK[0x478];
    sub_19E3210(&a41);
    if (LOBYTE(STACK[0x598]) == 1)
    {
      sub_165674C(&STACK[0x490]);
    }

    sub_1B5CF64(&STACK[0x5A0]);
    __cxa_begin_catch(a1);
    if (a2 == 2)
    {
      v46 = nullsub_1(v43 + 32);
      if (os_log_type_enabled(*(v46 + 1528), OS_LOG_TYPE_ERROR))
      {
        sub_1A63EA8();
      }
      ...
      a42 = 0;
      a43 = 0;
      sub_2020CAC(&STACK[0x5A8], &a41);
      sub_2020C64(v43 + 2704);
      sub_1A5E1FC(&STACK[0x5B0]);
      STACK[0x490] = &a41;
      sub_19E3210(&STACK[0x490]);
      __cxa_end_catch();
    }

    else
    {
      v47 = nullsub_1(v43 + 32);
      if (os_log_type_enabled(*(v47 + 1528), OS_LOG_TYPE_ERROR))
      {
        sub_1A63E74();
      }
      ...
      a42 = 0;
      a43 = 0;
      sub_2020CAC(&STACK[0x608], &a41);
      sub_2020C64(v43 + 2704);
      sub_1A5E1FC(&STACK[0x610]);
      STACK[0x490] = &a41;
      sub_19E3210(&STACK[0x490]);
      __cxa_end_catch();
    }
...
uint64_t sub_20218EC(uint64_t *a1, uint64_t a2)
{
  v3 = a1[1];
  if (v3 >= a1[2])
  {
    result = sub_19E2CF8(a1, a2);
  }
...
void sub_2021B94(_Unwind_Exception *a1, uint64_t a2, ...)
{
  va_start(va2, a2);
  va_start(va1, a2);
  va_start(va, a2);
...
uint64_t sub_2021BBC(uint64_t a1, uint64_t a2)
{
  {
    return a1 + 8;
  }
...
uint64_t sub_2021C08(uint64_t a1)
{
  sub_1A5EA7C(a1 + 2704);
  sub_1A6144C(a1 + 32);
  if (*(a1 + 31) < 0)
...
uint64_t sub_2021C4C(uint64_t a1)
{
  *a1 = off_2726F60;
  v2 = a1 + 16;
  v4 = (a1 + 4416);
...
void sub_2021E18(_Unwind_Exception *a1)
{
  sub_1A5EA7C(v1 + v2);
  sub_196609C(v1 + 2688);
  sub_1A6144C(v1 + 16);
...
uint64_t sub_2021E5C(void *a1, uint64_t a2)
{
  v4 = a1[1];
  *a2 = off_2726F60;
  *(a2 + 8) = v4;
...
void sub_2021F04(_Unwind_Exception *a1)
{
  sub_1A5EA7C(v1 + v2);
  sub_196609C(v1 + 2688);
  sub_1A6144C(v1 + 16);
...
uint64_t sub_2021F38(uint64_t a1)
{
  v3 = (a1 + 4416);
  sub_196232C(&v3);
  sub_1A5EA7C(a1 + 4384);
...
void sub_2021FF0(uint64_t a1, uint64_t *a2)
{
  v3 = *(a1 + 8);
  if (a2[1] == *a2)
  {
    ...
    sub_2022480(v9, (a1 + 16), v13, v10, v11);
    v12[0] = v10;
    sub_196232C(v12);
    sub_1A5EA7C(v13);
    v12[0] = v11;
  ...
  else
  {
    ...
    sub_2022480(v5, (a1 + 16), v13, v11, a2);
    v12[0] = v11;
    sub_196232C(v12);
    sub_1A5EA7C(v13);
  }
...
void sub_20221CC(_Unwind_Exception *exception_object, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, char a13, uint64_t a14, uint64_t a15, char a16, uint64_t a17, uint64_t a18, uint64_t *a19, char *a20, uint64_t a21)
{
  if (a2)
  {
    a20 = &a13;
...
uint64_t sub_2022404(uint64_t a1, uint64_t a2)
{
  {
    return a1 + 8;
  }
...
void sub_2022480(char *a1, char *a2, uint64_t a3, int **a4, uint64_t *a5)
{
  v8 = sub_1D365C4(a2);
  sub_1D3659C(a2, &v42);
  v9 = nullsub_1(a2);
  v10 = sub_20D5C34(&v42, v9 + 8);
  v11 = nullsub_1(a2);
  v12 = nullsub_1(a2);
  sub_19FFE08(a5, v8, a4, v10, (v11 + 8), (v12 + 1528), v53);
  v52[0] = &v42;
  sub_1A3CCC4(v52);
  v13 = nullsub_1(v53);
  if (*v13 != v13[1])
  {
    ...
    v15 = sub_1D365C4(a2);
    v16 = nullsub_1(a2);
    sub_1AB4870(&v42, (v14 + 1256), v15, v16 + 8, a4, v52);
    sub_1962CE0(v45, v45[1]);
    v50 = &v42;
    sub_1A0034C(&v50);
    nullsub_1(v53);
    sub_2022C90(&v50);
    ...
    if (*v17 != v17[1])
    {
      if ((*(sub_1D365AC(a2) + 16) & 1) != 0 || *(sub_1D365AC(a2) + 32) >= 1)
      {
        v46 = *v18;
        v48 = 0;
        v49 = 0;
        __p = 0;
        sub_1963658(&__p, *(v18 + 8), *(v18 + 16), *(v18 + 16) - *(v18 + 8));
        v19 = sub_1D365B4(a2);
        sub_2022D14(&v46, v19, &v42);
        v20 = v42;
        v21 = v43;
        v43 = 0;
        v44 = 0;
      ...
      *(&v40 + 1) = v23;
      ...
      v38 = 0;
      v39 = 0;
      sub_19631E8(&v37, v20, v21, (v21 - v20) >> 3);
      v25 = sub_1D365BC(a2);
      v26 = nullsub_1(a2);
      v36 = 0;
      *&v35 = *(v18 + 32);
      ...
      BYTE12(v35) = 1;
      sub_1D36230(a2, v33);
      sub_2023760(&v42, a4, v22, v52, &v41, &v40, v24, &v37, v25, v26, &v36, v18, &v35, v18 + 48, v33);
      if (v34 < 0)
      {
  ...
  v52[0] = &v42;
  sub_19E3210(v52);
  sub_1962CE0(v54, v54[1]);
  v42 = v53;
  sub_1A0034C(&v42);
}

void sub_20229AC(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, uint64_t a16, uint64_t a17, uint64_t a18, uint64_t a19, void *a20, uint64_t a21, uint64_t a22, uint64_t a23, uint64_t a24, uint64_t a25, void *__p, uint64_t a27, uint64_t a28, uint64_t a29, uint64_t a30, uint64_t a31, uint64_t a32, char a33)
{
  STACK[0x2D8] = &a33;
  sub_19E3210(&STACK[0x2D8]);
  sub_1A001B4(&STACK[0x308]);
  _Unwind_Resume(a1);
}

uint64_t sub_2022B8C(uint64_t result, void *a2)
{
  v2 = *(result + 8);
  *a2 = off_2726FD0;
  a2[1] = v2;
...
uint64_t sub_2022BC4(uint64_t a1, uint64_t a2)
{
  if (sub_197E0F8(a2, &off_2727050))
  {
    return a1 + 8;
  }
...
uint64_t sub_2022C10(uint64_t a1)
{
  v2 = *(a1 + 24);
  if (v2 == a1)
  {
...
void sub_2022D14(uint64_t a1@<X1>, uint64_t a2@<X2>, uint64_t a3@<X8>)
{
  v4 = 0;
  v41 = 0;
  v5 = 0uLL;
...
LABEL_33:
  ...
  while (1)
  {
    ...
    v34 = sub_1F71298(11, *(v13 + 6), *(v13 + 7));
    v35 = v16;
    sub_3608D0(__p, "index_");
    v31 = sub_19AD614(a1, __p);
    v32 = v17;
    v33 = BYTE4(v17);
    if (v30 < 0)
    {
...
void sub_2022FD8(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4)
{
  sub_1963A80(v6, a3);
  sub_1961DE0(&v7, a2);
  sub_2025C50(&v8, a4);
...
void sub_20230C0(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, ...)
{
  va_start(va, a3);
  sub_20268B8(v3 - 104);
  sub_20265E8(va);
...
uint64_t sub_202310C(uint64_t a1, uint64_t a2)
{
  ...
  return sub_202758C(v7);
}

void *sub_202326C(void *a1, unint64_t *a2, dispatch_object_t *a3, uint64_t *a4)
{
  a1[1] = 0;
  a1[2] = 0;
  *a1 = off_2727080;
  sub_2023354((a1 + 3), *a2, *a3, *a4);
  return a1;
}

void sub_20232F4(std::__shared_weak_count *a1)
{
  a1->__vftable = off_2727080;
  std::__shared_weak_count::~__shared_weak_count(a1);

  operator delete();
}

uint64_t sub_2023354(uint64_t a1, unint64_t a2, dispatch_object_t object, uint64_t a4)
{
  *a1 = object;
  *(a1 + 8) = a4;
  *(a1 + 16) = 0;
...
void sub_20233BC(_Unwind_Exception *a1, uint64_t a2, ...)
{
  va_start(va, a2);
  sub_20236A0(va);
  _Unwind_Resume(a1);
...
void *sub_20233D4(void *result, unint64_t a2)
{
...
void sub_20234A8(_Unwind_Exception *a1, uint64_t a2, ...)
{
  va_start(va, a2);
  sub_2023618(va);
  _Unwind_Resume(a1);
...
uint64_t sub_20234BC(uint64_t a1, void **a2, void **a3, uint64_t a4)
{
  v14 = a4;
  v13 = a4;
  v11[0] = a1;
  ...
  return sub_2023594(v11);
}

uint64_t sub_2023594(uint64_t a1)
{
  if ((*(a1 + 24) & 1) == 0)
  {
    sub_20235CC(a1);
...
uint64_t sub_2023714(uint64_t a1)
{
  dispatch_release(*a1);
...
uint64_t sub_2023760(uint64_t a1, uint64_t *a2, uint64_t a3, uint64_t *a4, _OWORD *a5, _OWORD *a6, uint64_t a7, uint64_t *a8, _DWORD *a9, _DWORD *a10, _DWORD *a11, int *a12, _OWORD *a13, uint64_t a14, __int128 *a15)
{
  *a1 = 0;
  *(a1 + 8) = 0;
  *(a1 + 16) = 0;
  sub_1962074(a1, *a2, a2[1], 0xCCCCCCCCCCCCCCCDLL * ((a2[1] - *a2) >> 5));
  sub_1962420((a1 + 24), a3);
  *(a1 + 128) = 0;
  *(a1 + 136) = 0;
  *(a1 + 144) = 0;
  sub_1962488(a1 + 128, *(a3 + 104), *(a3 + 112), 0xAAAAAAAAAAAAAAABLL * ((*(a3 + 112) - *(a3 + 104)) >> 5));
  v22 = *(a3 + 128);
  v23 = *(a3 + 144);
  v24 = *(a3 + 159);
  *(a1 + 192) = 0;
  ...
  *(a1 + 200) = 0;
  *(a1 + 208) = 0;
  sub_19626BC(a1 + 192, *a4, a4[1], 0xAAAAAAAAAAAAAAABLL * ((a4[1] - *a4) >> 4));
  *(a1 + 216) = 0;
  *(a1 + 224) = 0;
  *(a1 + 232) = 0;
  sub_19626BC(a1 + 216, a4[3], a4[4], 0xAAAAAAAAAAAAAAABLL * ((a4[4] - a4[3]) >> 4));
  v25 = *a12;
  *(a1 + 248) = 0;
  *(a1 + 240) = v25;
  *(a1 + 256) = 0;
  *(a1 + 264) = 0;
  sub_1963658(a1 + 248, *(a12 + 1), *(a12 + 2), *(a12 + 2) - *(a12 + 1));
  *(a1 + 272) = *a5;
  *(a1 + 288) = *a6;
  *(a1 + 304) = *a10;
  *(a1 + 308) = *a11;
  sub_1962E1C(a1 + 312, a7);
  *(a1 + 392) = *a9;
  *(a1 + 408) = 0;
  *(a1 + 416) = 0;
  *(a1 + 400) = 0;
  sub_19631E8(a1 + 400, *a8, a8[1], (a8[1] - *a8) >> 3);
  sub_19632A0((a1 + 424), a14);
  *(a1 + 448) = *a13;
  if (*(a15 + 23) < 0)
  {
    sub_325C((a1 + 464), *a15, *(a15 + 1));
  }
...
void sub_202393C(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, void **a10)
{
...
void sub_2023CB8(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, std::__shared_weak_count *a10)
{
  sub_202758C(v11 - 168);
  sub_196609C(v10 + 32);
  sub_20268B8(&STACK[0x11B8]);
  if (a10)
  {
    sub_1220A18(a10);
  }
...
uint64_t sub_2023DB4(uint64_t a1)
{
  v2 = *(a1 + 24);
  if (!v2)
  {
...
void sub_2023E90(_Unwind_Exception *a1)
{
  sub_19639B4((v1 + 3));
  v3 = v1[2];
  if (v3)
...
void sub_2024024(_Unwind_Exception *a1)
{
  sub_19639B4((v1 + 3));
  v3 = v1[2];
  if (v3)
...
uint64_t sub_2024054(uint64_t a1, void *a2)
{
  v5 = *(a1 + 8);
  v4 = *(a1 + 16);
  *a2 = off_27270D0;
...
void sub_20240C4(_Unwind_Exception *a1)
{
  sub_19639B4(v1 + 24);
  v3 = *(v1 + 16);
  if (v3)
...
void sub_2024130(uint64_t a1, __int128 *a2)
{
  v2 = *a2;
  *a2 = 0;
  *(a2 + 1) = 0;
...
void sub_2024178(_Unwind_Exception *exception_object, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, std::__shared_weak_count *a10)
{
  if (a10)
  {
    sub_1220A18(a10);
...
uint64_t sub_2024190(uint64_t a1, uint64_t a2)
{
  {
    return a1 + 8;
  }
...
void sub_2024230(uint64_t *a1, uint64_t *a2)
{
  v2 = *a1;
  v3 = a2[1];
  v4 = *a2;
...
void sub_20242B8(void *a1, int a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, std::__shared_weak_count *a10, __int128 a11, __int128 a12, __int128 a13, __int128 a14, __int128 a15, uint64_t a16)
{
  *(v18 - 40) = v17;
  sub_19E3210((v18 - 40));
  if (a10)
...
void sub_202438C(_Unwind_Exception *a1)
{
  *(v2 - 40) = v1;
  sub_19E3210((v2 - 40));
  __cxa_end_catch();
...
void sub_20243C4(uint64_t a1, uint64_t a2)
{
  os_unfair_lock_lock((a1 + 16));
  sub_2024AE8(a1 + 24, a2);
...
double sub_2024418@<D0>(void *a1@<X0>, uint64_t a2@<X8>)
{
  if (*a1)
  {
    sub_1EDFCDC();
...
void sub_20249E8(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, uint64_t a16, uint64_t a17, uint64_t a18, uint64_t a19, uint64_t a20, uint64_t a21, uint64_t a22, uint64_t a23, uint64_t a24, uint64_t a25, uint64_t a26, uint64_t a27, uint64_t a28, uint64_t a29, uint64_t a30, uint64_t a31, uint64_t a32, uint64_t a33, uint64_t a34, uint64_t a35, uint64_t a36, uint64_t a37, uint64_t a38, uint64_t a39, uint64_t a40, uint64_t a41, void *__p)
{
  sub_19E7920(v42 - 192);
  *(v42 - 192) = &__p;
  sub_19E3210((v42 - 192));
  sub_11BD8(&STACK[0x3F0]);
  *(v42 - 192) = &STACK[0x418];
  sub_19E3210((v42 - 192));
  sub_20250D0(&STACK[0x430]);
  sub_1B5CF64((v42 - 224));
  _Unwind_Resume(a1);
}

uint64_t sub_2024AE8(uint64_t a1, uint64_t a2)
{
  v3 = *(a1 + 8);
  if (v3 >= *(a1 + 16))
  {
    result = sub_2024BBC(a1, a2);
  }
...
__n128 sub_2024B28(uint64_t a1, uint64_t a2)
{
  v4 = *(a1 + 8);
  *v4 = 0;
  *(v4 + 8) = 0;
  *(v4 + 16) = 0;
  sub_19E41E0(v4, *a2, *(a2 + 8), 0x7D6343EB1A1F58D1 * ((*(a2 + 8) - *a2) >> 4));
  result = *(a2 + 24);
  v6 = *(a2 + 40);
  v7 = *(a2 + 56);
  *(v4 + 72) = *(a2 + 72);
...
uint64_t sub_2024BBC(uint64_t a1, uint64_t a2)
{
  ...
  *(v7 + 8) = 0;
  *(v7 + 16) = 0;
  sub_19E41E0(v7, *a2, *(a2 + 8), 0x7D6343EB1A1F58D1 * ((*(a2 + 8) - *a2) >> 4));
  v8 = *(a2 + 56);
  v9 = *(a2 + 72);
  v10 = *(a2 + 24);
  *(v7 + 40) = *(a2 + 40);
...
void sub_2024D34(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, ...)
{
  va_start(va, a4);
  sub_2023618(va);
  _Unwind_Resume(a1);
...
BOOL sub_2024D48(uint64_t *a1)
{
  ...
  if (a1[1] != *a1)
  {
    v2 = sub_19F4338(*(v1 + 8));
    v3 = sub_19F4338(*(v1 + 8));
    result = sub_19F43EC(v3, "pl");
    if (!result)
    {
      return result;
    }

    for (i = *(v2 + 24); i != *(v2 + 32); i += 64)
    {
      v6 = *(i + 48);
      if (v6)
      {
...
uint64_t sub_2024DF0(uint64_t result, uint64_t a2)
{
  if (*(a2 + 1056) == 1)
  {
    v2 = *result;
    ...
    if (*result != v3)
    {
      do
      {
        result = sub_1DED8F8(v2);
        if ((result & 1) == 0)
        {
          if (*(sub_57478(v2) + 121) == 1)
          {
            v5 = sub_1DED88C(v2);
            LOBYTE(v6) = *(a2 + 1056);
            v7 = v6;
LABEL_8:
            result = sub_1DED7E4(v2, v5 * v7);
            goto LABEL_9;
          }
...
void *sub_2024E9C(void *a1, unint64_t *a2)
{
  v2 = *a2;
  v3 = a1[1];
  if (!*&v3)
...
uint64_t sub_20250D0(uint64_t a1)
{
  sub_11BD8(a1 + 80);
  sub_11BD8(a1 + 40);
...
void sub_20251B4(_Unwind_Exception *a1)
{
  sub_196609C(v2);
  operator delete(v1);
  _Unwind_Resume(a1);
...
void sub_2025350(_Unwind_Exception *a1)
{
  sub_196609C(v2);
  operator delete(v1);
  _Unwind_Resume(a1);
...
uint64_t sub_2025374(uint64_t a1, void *a2)
{
  *a2 = off_2727150;
...
uint64_t sub_202545C(uint64_t a1, uint64_t a2)
{
  {
    return a1 + 8;
  }
...
uint64_t sub_20254A8(uint64_t a1)
{
  v2 = *(a1 + 2192);
  if (v2)
  {
...
void sub_202556C(_Unwind_Exception *a1)
{
  *(v2 - 24) = v1;
  sub_19E3210((v2 - 24));
  _Unwind_Resume(a1);
...
uint64_t sub_2025584(uint64_t a1)
{
  sub_196609C(a1 + 504);
  sub_19639B4(a1 + 16);
  v2 = *(a1 + 8);
...
void sub_2025650(_Unwind_Exception *a1)
{
  sub_20268B8(v1 + 8);
  operator delete(v1);
  _Unwind_Resume(a1);
...
void sub_20257A4(_Unwind_Exception *a1)
{
  sub_20268B8(v2);
  operator delete(v1);
  _Unwind_Resume(a1);
...
uint64_t sub_20257C8(uint64_t a1, void *a2)
{
  *a2 = off_27271D0;
  v3 = (a2 + 5);
  sub_2025C50((a2 + 1), a1 + 8);
  return sub_1963A80(v3, a1 + 40);
}

uint64_t sub_2025840(uint64_t a1)
{
  sub_196609C(a1 + 40);

  return sub_20268B8(a1 + 8);
}

void sub_202587C(void *a1)
{
  sub_196609C(a1 + 40);
  sub_20268B8(a1 + 8);
...
uint64_t sub_20258C8(uint64_t a1, uint64_t a2)
{
  {
    return a1 + 8;
  }
...
uint64_t sub_2025914(uint64_t a1, uint64_t a2)
{
  v3 = (a2 + 24);
  v4 = *(a2 + 24);
  if (v4)
...
void sub_2025994(uint64_t a1, uint64_t *a2)
{
  v3 = *a2;
  v4 = a2[1];
  ...
  if (v5 == 1)
  {
    v10 = 0uLL;
    *v11 = 0;
    sub_19E41E0(&v10, *v3, *(v3 + 8), 0x7D6343EB1A1F58D1 * ((*(v3 + 8) - *v3) >> 4));
    v6 = *(v3 + 24);
    v7 = *(v3 + 40);
    v8 = *(v3 + 56);
    *&v11[56] = *(v3 + 72);
...
void sub_2025ADC(void *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, __int128 a9, __int128 a10, __int128 a11, __int128 a12, __int128 a13, uint64_t a14, uint64_t a15, __int128 a16, __int128 a17, __int128 a18, __int128 a19, __int128 a20, uint64_t a21)
{
  __cxa_begin_catch(a1);
...
void sub_2025BAC(_Unwind_Exception *a1)
{
  *(v2 - 56) = v1;
  sub_19E3210((v2 - 56));
  __cxa_end_catch();
...
double sub_2025BE4(uint64_t a1, uint64_t a2)
{
  v3 = *(a2 + 8);
  if (v3 != *a2)
  {
    sub_19E7A38(a1, *(a1 + 8), *a2, v3, 0x7D6343EB1A1F58D1 * ((v3 - *a2) >> 4));
...
uint64_t sub_2025C50(uint64_t a1, uint64_t a2)
{
  v3 = *(a2 + 24);
  if (v3)
  {
...
void sub_2025D80(_Unwind_Exception *a1)
{
  sub_196609C(v2);
  operator delete(v1);
  _Unwind_Resume(a1);
...
void sub_2025F08(_Unwind_Exception *a1)
{
  sub_19639B4(v1 + 1704);
  sub_196609C(v2);
  operator delete(v1);
...
uint64_t sub_2025F3C(uint64_t a1, void *a2)
{
  *a2 = off_2727260;
  sub_1963A80((a2 + 1), a1 + 8);
  sub_1961DE0((a2 + 213), a1 + 1704);
  return sub_2025C50((a2 + 274), a1 + 2192);
}

void sub_2025FAC(_Unwind_Exception *a1)
{
  sub_19639B4(v2 + 1704);
  sub_196609C(v1);
  _Unwind_Resume(a1);
...
uint64_t sub_2025FD0(uint64_t a1)
{
  sub_20268B8(a1 + 2192);
  sub_19639B4(a1 + 1704);
...
void sub_2026060(uint64_t a1, __int128 *a2)
{
  v2 = *a2;
  v3 = *(a2 + 2);
  *(a2 + 1) = 0;
...
void sub_20260D8(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9)
{
  *(v9 - 24) = &a9;
  sub_19E3210((v9 - 24));
  _Unwind_Resume(a1);
...
uint64_t sub_20260F4(uint64_t a1, uint64_t a2)
{
  {
    return a1 + 8;
  }
...
void sub_2026140(uint64_t a1, uint64_t a2)
{
  v4 = (a1 + 1528);
  sub_3608D0(v14, "recall@poi@agg@pre_l1");
  sub_20FFE4C(v4, v14, a1 + 1936, a2, *(a1 + 16));
  if (v15 < 0)
  {
    operator delete(v14[0]);
  }

  if ((0x7D6343EB1A1F58D1 * ((*(a2 + 8) - *a2) >> 4)) >= 2)
  {
    v5 = *(a1 + 2088);
    if (v5 != 9 && v5 != 6)
    {
  ...
  else
  {
    ...
    if (v7 >= 1 && 0x7D6343EB1A1F58D1 * ((*(a2 + 8) - *a2) >> 4) > v7)
    {
      sub_19E82DC(a2, v7);
    }
  }

  sub_3608D0(v14, "recall@poi@agg@post_l1_filtering");
  sub_20FFE4C(v4, v14, a1 + 1936, a2, *(a1 + 16));
  if (v15 < 0)
  {
    operator delete(v14[0]);
  ...
  sub_19E41E0(v9, *a2, *(a2 + 8), 0x7D6343EB1A1F58D1 * ((*(a2 + 8) - *a2) >> 4));
  v10 = *(a2 + 24);
  v11 = *(a2 + 40);
  v12 = *(a2 + 56);
  v13 = *(a2 + 72);
...
void sub_202645C(void *a1, int a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, __int128 a9, __int128 a10, __int128 a11, __int128 a12, __int128 a13, uint64_t a14, uint64_t a15, __int128 a16, __int128 a17, __int128 a18, __int128 a19, __int128 a20, uint64_t a21)
{
  *(v24 - 72) = v23;
  sub_19E3210((v24 - 72));
  __cxa_begin_catch(a1);
...
void sub_20265B0(_Unwind_Exception *a1)
{
  *(v2 - 96) = v1;
  sub_19E3210((v2 - 96));
  __cxa_end_catch();
...
uint64_t sub_20265E8(uint64_t a1)
{
  sub_20268B8(a1 + 2184);
  sub_19639B4(a1 + 1696);
...
uint64_t sub_2026750(uint64_t result, void *a2)
{
  v3 = *(result + 8);
  v2 = *(result + 16);
  *a2 = off_27272F0;
...
void sub_20267D8(uint64_t a1, __int128 *a2)
{
  v2 = *a2;
  v3 = *(a2 + 2);
  *(a2 + 1) = 0;
...
void sub_2026850(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9)
{
  *(v9 - 24) = &a9;
  sub_19E3210((v9 - 24));
  _Unwind_Resume(a1);
...
uint64_t sub_202686C(uint64_t a1, uint64_t a2)
{
  {
    return a1 + 8;
  }
...
uint64_t sub_20268B8(uint64_t a1)
{
  v2 = *(a1 + 24);
  if (v2 == a1)
  {
...
uint64_t sub_2026938(uint64_t a1)
{
  v2 = *(a1 + 56);
  if (!v2)
  {
...
uint64_t sub_202698C(uint64_t a1, uint64_t a2)
{
  result = sub_2026A14(a1 + 32, a2 + 32);
  v5 = *(a2 + 72);
  *(a1 + 64) = *(a2 + 64);
  *(a1 + 72) = v5;
  if (v5)
...
uint64_t sub_20269D4(uint64_t a1)
{
  v2 = *(a1 + 72);
  if (v2)
  {
  ...
  return sub_202758C(a1 + 32);
}

uint64_t sub_2026A14(uint64_t a1, uint64_t a2)
{
  v3 = *(a2 + 24);
  if (v3)
  {
...
void sub_2026C84(_Unwind_Exception *a1)
{
  sub_1A6144C(v1 + 16);
  operator delete(v1);
  _Unwind_Resume(a1);
...
uint64_t sub_2026CA8(uint64_t a1, void *a2)
{
  v4 = *(a1 + 8);
  *a2 = off_27273A0;
  a2[1] = v4;
...
uint64_t sub_2026D18(uint64_t a1)
{
  sub_1A5EA7C(a1 + 2688);
...
void sub_2026D98(uint64_t a1, uint64_t *a2)
{
  memset(v3, 0, sizeof(v3));
  sub_20273CC(v3, *a2, a2[1], 0x2E8BA2E8BA2E8BA3 * ((a2[1] - *a2) >> 3));
  sub_2026E74(a1 + 8, v3);
  v4 = v3;
  sub_20236A0(&v4);
}

void sub_2026E10(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, ...)
{
  va_start(va, a4);
  sub_20236A0(va);
  _Unwind_Resume(a1);
...
uint64_t sub_2026E28(uint64_t a1, uint64_t a2)
{
  {
    return a1 + 8;
  }
...
void sub_2026E74(uint64_t a1, uint64_t a2)
{
  v3 = a1 + 8;
  sub_20270D0(a2, a1 + 8, v5);
  sub_1A5E2E4(v6, a1 + 2680);
  sub_1DE003C(v3, v5, v6);
  sub_1A5EA7C(v6);
  v4 = v5;
  sub_19E3210(&v4);
}

void sub_2026F20(_Unwind_Exception *exception_object, int a2, int a3, int a4, int a5, int a6, int a7, int a8, char *a9, uint64_t a10, uint64_t a11, char a12, uint64_t a13, uint64_t a14, uint64_t *a15, char a16, uint64_t a17, uint64_t a18, uint64_t a19, uint64_t a20, uint64_t a21, uint64_t a22, uint64_t a23, uint64_t a24, uint64_t a25, uint64_t a26, uint64_t a27, char a28, uint64_t a29)
{
  if (a2)
  {
    sub_1A5EA7C(v31 - 88);
    ...
    {
      v34 = nullsub_1(v30);
      if (os_log_type_enabled(*(v34 + 1528), OS_LOG_TYPE_ERROR))
      {
        sub_1A63EA8();
      }
    ...
    {
      v35 = nullsub_1(v30);
      if (os_log_type_enabled(*(v35 + 1528), OS_LOG_TYPE_ERROR))
      {
        sub_1A63E74();
      }
...
void sub_20270D0(uint64_t a1@<X1>, uint64_t a2@<X2>, uint64_t *a3@<X8>)
{
  if (*a1 == *(a1 + 8))
  {
    *a3 = 0;
  ...
  sub_213AFBC(a1, &v18);
  if ((0x7D6343EB1A1F58D1 * ((*(&v18 + 1) - v18) >> 4)) < 2)
  {
    goto LABEL_19;
  }

  if (*sub_1D365BC(a2) == 6 || *sub_1D365BC(a2) == 9)
  {
    v6 = *(&v18 + 1);
    v5 = v18;
    v7 = 126 - 2 * __clz(0x7D6343EB1A1F58D1 * ((*(&v18 + 1) - v18) >> 4));
    *&v16 = off_2721C28;
    v20 = sub_19E43FC;
    if (*(&v18 + 1) == v18)
    {
  ...
  else
  {
    v6 = *(&v18 + 1);
    v5 = v18;
    v9 = 126 - 2 * __clz(0x7D6343EB1A1F58D1 * ((*(&v18 + 1) - v18) >> 4));
    *&v16 = off_2721C90;
    v20 = sub_19E5DD0;
    if (*(&v18 + 1) == v18)
    {
  ...
  sub_19E443C(v5, v6, &v20, v8, 1);
  if (*sub_1D365BC(a2) == 7)
  {
    v10 = v18;
    if (0x7D6343EB1A1F58D1 * ((*(&v10 + 1) - v10) >> 4) > *(nullsub_1(a2) + 28))
    {
      v11 = nullsub_1(a2);
      sub_19E82DC(&v18, *(v11 + 28));
    }
...
LABEL_19:
  ...
  v13 = v18;
  if (0x7D6343EB1A1F58D1 * ((*(&v13 + 1) - v13) >> 4) <= *(nullsub_1(a2) + 24))
  {
    goto LABEL_19;
  }

  memset(v15, 0, sizeof(v15));
  sub_19E41E0(v15, v18, *(&v18 + 1), 0x7D6343EB1A1F58D1 * ((*(&v18 + 1) - v18) >> 4));
  v14 = nullsub_1(a2);
  sub_213B8F0(v15, *(v14 + 24), a3);
  *&v16 = v15;
  sub_19E3210(&v16);
LABEL_20:
  *&v16 = &v18;
...
void sub_202738C(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, char a10, uint64_t a11, uint64_t a12, void **a13, uint64_t a14, uint64_t a15, uint64_t a16, char a17)
{
  a13 = &a10;
  sub_19E3210(&a13);
  a13 = &a17;
...
uint64_t sub_20273CC(uint64_t result, uint64_t a2, uint64_t a3, unint64_t a4)
{
  if (a4)
  {
...
void sub_2027434(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, void **a9)
{
  *(v9 + 8) = v10;
  sub_20236A0(&a9);
  _Unwind_Resume(a1);
...
void sub_2027454(uint64_t a1, unint64_t a2)
{
  if (a2 < 0x2E8BA2E8BA2E8BBLL)
  {
    sub_195E7B0(a1, a2);
...
uint64_t sub_20274A4(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4)
{
  v4 = a4;
  v13 = a4;
  v14 = a4;
  ...
  if (a2 != a3)
  {
    ...
    do
    {
      ...
      *(v4 + 8) = 0;
      *(v4 + 16) = 0;
      sub_19E41E0(v4, *v6, *(v6 + 8), 0x7D6343EB1A1F58D1 * ((*(v6 + 8) - *v6) >> 4));
      v7 = *(v6 + 24);
      v8 = *(v6 + 40);
      v9 = *(v6 + 56);
      *(v4 + 72) = *(v6 + 72);
...
uint64_t sub_202758C(uint64_t a1)
{
  v2 = *(a1 + 24);
  if (v2 == a1)
  {
...
void sub_2027640()
{
  ...
  (*(v0 + 16))();
  sub_1A63DA4();
  sub_1A63D5C(&dword_0, v1, v2, "Exception thrown in POI get response - .%s ", v3, v4, v5, v6, v7);
}

void sub_20276D0(uint64_t a1, NSObject *a2)
{
  ...
  *buf = 136315138;
  v7 = v3;
  _os_log_error_impl(&dword_0, a2, OS_LOG_TYPE_ERROR, "Error retrieving POI data for key = '%s'", buf, 0xCu);
  if (v5 < 0)
  {
    operator delete(__p[0]);
  }
...
void sub_2027794()
{
  ...
  sub_1966280(qword_27F1270, v1247, 249);
  v0 = &v1496;
  v1 = -13944;
  do
  {
...
void sub_202E77C(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, void *__p, uint64_t a11, int a12, __int16 a13, char a14, char a15, uint64_t a16, void *a17, uint64_t a18, int a19, __int16 a20, char a21, char a22, void *a23, uint64_t a24, int a25, __int16 a26, char a27, char a28, uint64_t a29, void *a30, uint64_t a31, int a32, __int16 a33, char a34, char a35, void *a36, uint64_t a37, int a38, __int16 a39, char a40, char a41, uint64_t a42, uint64_t a43, uint64_t a44, int a45, __int16 a46, char a47, char a48, uint64_t a49, uint64_t a50, int a51, __int16 a52, char a53, char a54, uint64_t a55, uint64_t a56, uint64_t a57, int a58, __int16 a59, char a60, char a61, uint64_t a62, uint64_t a63)
{
  v86 = -13944;
  v87 = v80;
  do
