void sub_19ADFB0(_Unwind_Exception *a1, uint64_t a2, ...)
{
  va_start(va, a2);
  sub_1D03C(va);
  _Unwind_Resume(a1);
...
void sub_19ADFC4()
{
  ...
  sub_1966280(qword_27ECEB8, v1247, 249);
  v0 = &v1496;
  v1 = -13944;
  do
  {
...
void sub_19B8A80()
{
  ...
  *algn_27ECE78 = 0;
  qword_27ECE80 = 0;
  sub_68678C(&qword_27ECE70, __p, &v2, 1uLL);
  if (v1 < 0)
  {
    operator delete(__p[0]);
  }
  ...
  unk_27ECE90 = 0;
  qword_27ECE98 = 0;
  sub_68678C(&qword_27ECE88, __p, &v2, 1uLL);
  if (v1 < 0)
  {
    operator delete(__p[0]);
  }
  ...
  *algn_27ECEA8 = 0;
  qword_27ECEB0 = 0;
  sub_68678C(&qword_27ECEA0, __p, &v2, 1uLL);
  if (v1 < 0)
  {
    operator delete(__p[0]);
  }
...
void sub_19B8BA0(_Unwind_Exception *exception_object, int a2, int a3, int a4, int a5, int a6, int a7, int a8, void *__p, uint64_t a10, int a11, __int16 a12, char a13, char a14)
{
  if (a14 < 0)
  {
    operator delete(__p);
...
uint64_t sub_19B8BCC@<X0>(__int128 *a1@<X0>, uint64_t a2@<X8>, double a3@<D0>)
{
  v6 = *a1;
  sub_16E58B4(v7, 0, 0);
  v8 |= 0x1Eu;
  v10 = v6;
  v9 = v6;
  sub_1D0E674(v7, a2, a3);
  return sub_16E5B34(v7);
}

void sub_19B8C48(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, ...)
{
  va_start(va, a3);
  sub_16E5B34(va);
  _Unwind_Resume(a1);
...
uint64_t sub_19B8C5C@<X0>(uint64_t result@<X0>, _BYTE *a2@<X8>)
{
  if (*(result + 8) == *result)
  {
    *a2 = 0;
  ...
  else
  {
    ...
    sub_1D0E674(v16, v15, 0.5);
    sub_19B91BC(a2, v15);
    a2[96] = 1;
    sub_16E5B34(v15);
    return sub_16E5B34(v16);
  }

  return result;
}

void sub_19B8DAC(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, ...)
{
  va_start(va, a15);
  sub_16E5B34(va);
  _Unwind_Resume(a1);
...
uint64_t sub_19B8DC0@<X0>(uint64_t a1@<X0>, _BYTE *a2@<X8>)
{
  sub_16E58B4(v14, 0, 0);
  __p = 0;
  v12 = 0;
  ...
  return sub_16E5B34(v14);
}

void sub_19B8E88(_Unwind_Exception *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, uint64_t a10, uint64_t a11, void *__p, uint64_t a13, uint64_t a14, char a15)
{
  if (__p)
  {
    operator delete(__p);
...
void sub_19B8EB4(uint64_t a1, _OWORD *a2)
{
  v5 = *(a1 + 8);
  v4 = *(a1 + 16);
  if (v5 >= v4)
...
uint64_t sub_19B8F8C@<X0>(uint64_t result@<X0>, _BYTE *a2@<X8>)
{
  v2 = result;
  v4 = *(result + 784);
  if (!v4)
...
LABEL_27:
      if (!*(v2 + 784))
      {
        sub_1DED54C(v2, v12);
        v11 = v12[3];
        sub_19B8BCC(&v11, v13, 1.0);
        sub_19B91BC(a2, v13);
        a2[96] = 1;
        sub_16E5B34(v13);
        return sub_16E4E08(v12);
      }
    }
...
LABEL_23:
  ...
  if ((*(sub_73EEC(result) + 16) & 0x80) == 0)
  {
    if (*(v2 + 784) == 1)
    {
      *&v12[0] = sub_1DED7C0(v2);
      *(&v12[0] + 1) = v5;
      sub_19B8BCC(v12, v13, 1.0);
LABEL_21:
      sub_19B91BC(a2, v13);
      a2[96] = 1;
      return sub_16E5B34(v13);
    }
  ...
  v8 = sub_73EEC(v2);
  sub_194DB28(v13, *(v8 + 104) & 0xFFFFFFFFFFFFFFFELL);
  sub_16E5A88(a2);
  a2[96] = 1;
  return sub_179FDE8(v13);
}

void sub_19B9154(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, ...)
{
  va_start(va, a4);
  sub_16E4E08(va);
  _Unwind_Resume(a1);
...
uint64_t sub_19B9178@<X0>(uint64_t result@<X0>, _BYTE *a2@<X8>)
{
  v2 = 0xAFD6A052BF5A814BLL * ((*(result + 64) - *(result + 56)) >> 3);
  if (v2 == 1)
  {
    return sub_19B8F8C(*(result + 56), a2);
  }

  if (v2)
  {
    return sub_19B8DC0(result, a2);
  }
...
uint64_t sub_19B91BC(uint64_t a1, uint64_t a2)
{
  sub_16E58B4(a1, 0, 0);
  if (a1 != a2)
  {
...
void sub_19B925C(uint64_t a1, unint64_t a2)
{
  if (!(a2 >> 60))
  {
    operator new();
...
void sub_19B92A4()
{
  ...
  v4 = 233;
  sub_195E43C(&v1495, v5, __p);
  sub_1966280(qword_27ECF18, v1247, 249);
  v0 = &v1496;
  v1 = -13944;
  do
  {
...
void sub_19C028C(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, void *__p, uint64_t a11, int a12, __int16 a13, char a14, char a15, uint64_t a16, void *a17, uint64_t a18, int a19, __int16 a20, char a21, char a22, void *a23, uint64_t a24, int a25, __int16 a26, char a27, char a28, uint64_t a29, void *a30, uint64_t a31, int a32, __int16 a33, char a34, char a35, void *a36, uint64_t a37, int a38, __int16 a39, char a40, char a41, uint64_t a42, uint64_t a43, uint64_t a44, int a45, __int16 a46, char a47, char a48, uint64_t a49, uint64_t a50, int a51, __int16 a52, char a53, char a54, uint64_t a55, uint64_t a56, uint64_t a57, int a58, __int16 a59, char a60, char a61, uint64_t a62, uint64_t a63)
{
  v86 = -13944;
  v87 = v80;
  do
