...
void sub_2009394()
{
  ...
  unk_27F1110 = 0;
  qword_27F1118 = 0;
  sub_68678C(&qword_27F1108, __p, &v2, 1uLL);
  if (v1 < 0)
  {
  ...
  *algn_27F1128 = 0;
  qword_27F1130 = 0;
  sub_68678C(&qword_27F1120, __p, &v2, 1uLL);
  if (v1 < 0)
  {
    operator delete(__p[0]);
  }
  ...
  unk_27F1140 = 0;
  qword_27F1148 = 0;
  sub_68678C(&qword_27F1138, __p, &v2, 1uLL);
  if (v1 < 0)
  {
    operator delete(__p[0]);
  }
...
void sub_20094B4(_Unwind_Exception *exception_object, int a2, int a3, int a4, int a5, int a6, int a7, int a8, void *__p, uint64_t a10, int a11, __int16 a12, char a13, char a14)
{
  if (a14 < 0)
  {
    operator delete(__p);
...
uint64_t sub_20094E0(int a1, char a2, uint64_t a3)
{
  if (a2)
  {
    return 57;
...
void sub_2009604(_Unwind_Exception *exception_object, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, char a15)
{
  v17 = (v15 + 71);
  v18 = -72;
  v19 = v17;
...
void sub_2009668()
{
  ...
  sub_1966280(qword_27F11B0, v1247, 249);
  v0 = &v1496;
  v1 = -13944;
  do
  {
...
void sub_2010650(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, void *__p, uint64_t a11, int a12, __int16 a13, char a14, char a15, uint64_t a16, void *a17, uint64_t a18, int a19, __int16 a20, char a21, char a22, void *a23, uint64_t a24, int a25, __int16 a26, char a27, char a28, uint64_t a29, void *a30, uint64_t a31, int a32, __int16 a33, char a34, char a35, void *a36, uint64_t a37, int a38, __int16 a39, char a40, char a41, uint64_t a42, uint64_t a43, uint64_t a44, int a45, __int16 a46, char a47, char a48, uint64_t a49, uint64_t a50, int a51, __int16 a52, char a53, char a54, uint64_t a55, uint64_t a56, uint64_t a57, int a58, __int16 a59, char a60, char a61, uint64_t a62, uint64_t a63)
{
  v86 = -13944;
  v87 = v80;
  do
...
void sub_2014124()
{
  ...
  unk_27F1170 = 0;
  qword_27F1178 = 0;
  sub_68678C(&qword_27F1168, __p, &v2, 1uLL);
  if (v1 < 0)
  {
    operator delete(__p[0]);
  }
  ...
  *algn_27F1188 = 0;
  qword_27F1190 = 0;
  sub_68678C(&qword_27F1180, __p, &v2, 1uLL);
  if (v1 < 0)
  {
    operator delete(__p[0]);
  }
  ...
  unk_27F11A0 = 0;
  qword_27F11A8 = 0;
  sub_68678C(&qword_27F1198, __p, &v2, 1uLL);
  if (v1 < 0)
  {
    operator delete(__p[0]);
  }
...
void sub_2014244(_Unwind_Exception *exception_object, int a2, int a3, int a4, int a5, int a6, int a7, int a8, void *__p, uint64_t a10, int a11, __int16 a12, char a13, char a14)
{
  if (a14 < 0)
  {
    operator delete(__p);
...
uint64_t sub_2014270(uint64_t *a1, uint64_t a2)
{
  v3 = a1[3];
  if (v3 >= a1[4])
  {
    result = sub_2014714(a1 + 2, a2);
  }
...
uint64_t sub_20142C4(uint64_t *a1, uint64_t a2)
{
  v3 = a1[6];
  if (v3 >= a1[7])
  {
    result = sub_2014A44(a1 + 5, a2);
  }
...
void sub_2014318(unsigned __int8 *a1, uint64_t *a2, uint64_t *a3)
{
...
void sub_20144C8(_Unwind_Exception *exception_object, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, std::__shared_weak_count *a10, uint64_t a11, std::__shared_weak_count *a12, uint64_t a13, std::__shared_weak_count *a14, uint64_t a15, uint64_t a16, uint64_t a17, uint64_t a18)
{
  if (a10)
  {
    sub_1220A18(a10);
...
void sub_201451C(uint64_t *a1, uint64_t a2)
{
  v2 = a1[1];
  v3 = *a1;
  v4 = v2;
...
void sub_20145FC(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, std::__shared_weak_count *a4, ...)
{
  va_start(va1, a4);
  va_start(va, a4);
  v5 = va_arg(va1, void);
...
uint64_t sub_2014638(uint64_t a1, uint64_t a2)
{
  ...
  return sub_201581C(v7);
}

uint64_t sub_2014714(uint64_t *a1, uint64_t a2)
{
  v2 = (a1[1] - *a1) >> 5;
  v3 = v2 + 1;
  if ((v2 + 1) >> 59)
  ...
  v14 = 0;
  v15 = 32 * v2;
  sub_2014824(32 * v2, a2);
  v16 = (32 * v2 + 32);
  v8 = a1[1];
  v9 = 32 * v2 + *a1 - v8;
  sub_2014904(a1, *a1, v8, v9);
  v10 = *a1;
  *a1 = v9;
  v11 = a1[2];
  v13 = v16;
...
void sub_2014810(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, ...)
{
  va_start(va, a4);
  sub_20149F4(va);
  _Unwind_Resume(a1);
...
uint64_t sub_2014824(uint64_t a1, uint64_t a2)
{
  v3 = *(a2 + 24);
  if (v3)
  {
...
void sub_20148BC(uint64_t a1, unint64_t a2)
{
  if (!(a2 >> 59))
  {
    operator new();
...
void sub_2014904(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4)
{
  if (a2 != a3)
  {
    v6 = a2;
...
uint64_t sub_2014974(uint64_t a1, uint64_t a2)
{
  v3 = (a2 + 24);
  v4 = *(a2 + 24);
  if (v4)
...
uint64_t sub_20149F4(uint64_t a1)
{
  v3 = *(a1 + 8);
...
uint64_t sub_2014A44(uint64_t *a1, uint64_t a2)
{
  v2 = (a1[1] - *a1) >> 5;
  v3 = v2 + 1;
  if ((v2 + 1) >> 59)
  ...
  v14 = 0;
  v15 = 32 * v2;
  sub_2014B54(32 * v2, a2);
  v16 = (32 * v2 + 32);
  v8 = a1[1];
  v9 = 32 * v2 + *a1 - v8;
  sub_2014BEC(a1, *a1, v8, v9);
  v10 = *a1;
  *a1 = v9;
  v11 = a1[2];
  v13 = v16;
...
void sub_2014B40(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, ...)
{
  va_start(va, a4);
  sub_2014CDC(va);
  _Unwind_Resume(a1);
...
uint64_t sub_2014B54(uint64_t a1, uint64_t a2)
{
  v3 = *(a2 + 24);
  if (v3)
  {
...
void sub_2014BEC(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4)
{
  if (a2 != a3)
  {
    v6 = a2;
...
uint64_t sub_2014C5C(uint64_t a1, uint64_t a2)
{
  v3 = (a2 + 24);
  v4 = *(a2 + 24);
  if (v4)
...
uint64_t sub_2014CDC(uint64_t a1)
{
  v3 = *(a1 + 8);
  for (i = *(a1 + 16); i != v3; i = *(a1 + 16))
  {
...
uint64_t sub_2014D2C(uint64_t a1)
{
  v2 = *(a1 + 56);
  if (!v2)
  {
...
uint64_t sub_2014D80(uint64_t a1, uint64_t a2)
{
  result = sub_2014E08(a1 + 32, a2 + 32);
  v5 = *(a2 + 72);
  *(a1 + 64) = *(a2 + 64);
  *(a1 + 72) = v5;
  if (v5)
...
uint64_t sub_2014DC8(uint64_t a1)
{
  v2 = *(a1 + 72);
  if (v2)
  {
  ...
  return sub_201581C(a1 + 32);
}

uint64_t sub_2014E08(uint64_t a1, uint64_t a2)
{
  v3 = *(a2 + 24);
  if (v3)
  {
...
uint64_t sub_2014EA0(uint64_t a1, uint64_t a2)
{
  v3 = *(a2 + 24);
  if (v3)
  {
...
uint64_t sub_20150C8(uint64_t a1, uint64_t *a2)
{
  ...
  if (*a2 != v4)
  {
    do
    {
      ...
      {
        v6 = os_log_create("com.apple.geo.MapsOfflineService", "Search");
        if (os_log_type_enabled(v6, OS_LOG_TYPE_ERROR))
        {
          sub_201589C(&v9, v10, v6);
        }
      }
  ...
  (*(*v7 + 48))(v7, __p);
  sub_1965BCC(__p);
  return sub_1965BCC(v17);
}

void sub_2015274(void *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, void *__p, uint64_t a11, int a12, __int16 a13, char a14, char a15, char a16, uint64_t a17, uint64_t a18, uint64_t a19, uint64_t a20, uint64_t a21, __int128 a22, __int128 a23, int a24)
{
  sub_1965BCC(&a22);
  v27 = __cxa_begin_catch(a1);
  v28 = os_log_create("com.apple.geo.MapsOfflineService", "Search");
...
void sub_2015364(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, ...)
{
  va_start(va, a11);
  sub_1965BCC(va);
  __cxa_end_catch();
...
uint64_t sub_2015394(uint64_t a1, uint64_t a2)
{
  {
    return a1 + 8;
  }
...
uint64_t sub_20153E0(uint64_t a1, uint64_t a2)
{
  v3 = (a2 + 24);
  v4 = *(a2 + 24);
  if (v4)
...
uint64_t sub_2015460(uint64_t a1)
{
  v2 = *(a1 + 24);
  if (!v2)
  {
...
const void **sub_20154A8(void *a1, const void **a2)
{
...
void sub_20156F0(_Unwind_Exception *a1, uint64_t a2, ...)
{
  va_start(va, a2);
  sub_1965AC4(va);
  _Unwind_Resume(a1);
...
uint64_t sub_2015780(uint64_t a1, __int128 *a2)
{
  if (*(a2 + 23) < 0)
  {
    sub_325C(a1, *a2, *(a2 + 1));
...
uint64_t sub_20157DC(uint64_t a1)
{
  v2 = *(a1 + 32);
  if (v2)
  {
...
uint64_t sub_201581C(uint64_t a1)
{
  v2 = *(a1 + 24);
  if (v2 == a1)
  {
...
void sub_201589C(uint8_t *buf, _BYTE *a2, os_log_t log)
{
  *buf = 0;
  *a2 = 0;
  _os_log_error_impl(&dword_0, log, OS_LOG_TYPE_ERROR, "While populating data store registry, received a null result. Skipping.", buf, 2u);
}

void sub_2015920(uint64_t a1, NSObject *a2)
{
  v3 = (*(*a1 + 16))(a1);
  v4 = 136315138;
  v5 = v3;
  _os_log_error_impl(&dword_0, a2, OS_LOG_TYPE_ERROR, "Exception thrown while building data store registry - .%s ", &v4, 0xCu);
}
...
void sub_20159CC()
{
  ...
  v4 = 233;
  sub_195E43C(&v1495, v5, __p);
  sub_1966280(qword_27F1210, v1247, 249);
  v0 = &v1496;
  v1 = -13944;
  do
  {
