uint64_t sub_1CEBA20(uint64_t result, uint64_t a2, uint64_t a3, unint64_t a4)
{
  if (a4)
  {
...
void sub_1CEBA80(_Unwind_Exception *exception_object)
{
  v3 = *v1;
  if (*v1)
  {
...
uint64_t *sub_1CEBB48(void *a1, int *a2)
{
  v2 = *a2;
  v3 = a1[1];
  if (!*&v3)
...
void sub_1CEBD74()
{
  ...
  sub_1966280(qword_27EF140, v1247, 249);
  v0 = &v1496;
  v1 = -13944;
  do
  {
...
void sub_1CF6830()
{
  ...
  unk_27EF100 = 0;
  qword_27EF108 = 0;
  sub_68678C(&qword_27EF0F8, __p, &v3, 1uLL);
  if (v2 < 0)
  {
    operator delete(__p[0]);
  }
  ...
  *algn_27EF118 = 0;
  qword_27EF120 = 0;
  sub_68678C(&qword_27EF110, __p, &v3, 1uLL);
  if (v2 < 0)
  {
    operator delete(__p[0]);
  }
  ...
  unk_27EF130 = 0;
  qword_27EF138 = 0;
  sub_68678C(&qword_27EF128, __p, &v3, 1uLL);
  if (v2 < 0)
  {
    operator delete(__p[0]);
  }
...
void sub_1CF6960(_Unwind_Exception *exception_object, int a2, int a3, int a4, int a5, int a6, int a7, int a8, void *__p, uint64_t a10, int a11, __int16 a12, char a13, char a14)
{
  if (a14 < 0)
  {
    operator delete(__p);
...
uint64_t sub_1CF698C@<X0>(int a1@<W0>, _BYTE *a2@<X8>)
{
  sub_D7B0(v10);
  v4 = v11;
  *(&v11 + *(v11 - 24) + 8) = *(&v11 + *(v11 - 24) + 8) & 0xFFFFFEFB | 4;
  *(&v13[0].__locale_ + *(v4 - 24)) = a1;
...
void sub_1CF6C3C(_Unwind_Exception *a1, uint64_t a2, ...)
{
  va_start(va, a2);
  std::ios::~ios();
  _Unwind_Resume(a1);
...
unint64_t sub_1CF6C68@<X0>(unint64_t result@<X0>, uint64_t a2@<X8>)
{
  v2 = result;
  v4 = *(result + 23);
  v5 = v4;
  ...
  if (v9)
  {
    ...
    do
    {
      ...
      {
        result = _DefaultRuneLocale.__runetype[v11] & 0x4000;
        if (!result)
        {
          goto LABEL_15;
        }
...
LABEL_15:
  ...
  while (v14 != v2)
  {
    ...
    if (v16 < 0)
    {
      result = __maskrune(v15, 0x4000uLL);
      if (!result)
      {
LABEL_26:
        v2 = (v14 + 1);
    ...
    {
      result = _DefaultRuneLocale.__runetype[v15] & 0x4000;
      if (!result)
      {
        goto LABEL_26;
      }
  ...
  else
  {
    ...
    return sub_195A324(a2, v8, v2, v2 - v8);
  }

  return result;
}

BOOL sub_1CF6D94(void *a1, uint64_t a2)
{
  v2 = a1[1];
  v3 = *(a2 + 8);
  v4 = v2 >= v3;
  v5 = v2 - v3;
  return v4 && memcmp((*a1 + v5), *a2, v3) == 0;
}

void sub_1CF6E24(uint64_t *a1@<X0>, uint64_t a2@<X1>, std::string *a3@<X8>)
{
  v4 = *a1;
  v5 = a1[1];
  if (*a1 == v5)
  ...
  {
    v8 = *(a2 + 8) * (0xAAAAAAAAAAAAAAABLL * ((v5 - v4) >> 3) - 1);
    do
    {
      v9 = *(v4 + 23);
      if (v9 < 0)
...
void sub_1CF6F08(_Unwind_Exception *exception_object)
{
  if (*(v1 + 23) < 0)
  {
    operator delete(*v1);
...
void sub_1CF6F28(uint64_t *a1@<X0>, uint64_t a2@<X1>, std::string *a3@<X8>)
{
  v3[0] = a2;
  v3[1] = 1;
  sub_1CF6E24(a1, v3, a3);
}

void sub_1CF6F54(uint64_t *a1@<X0>, signed int a2@<W1>, signed int a3@<W2>, uint64_t a4@<X3>, std::string *a5@<X8>)
{
  if (a2 >= a3)
  {

    sub_3608D0(a5, &unk_236DCAD);
  }

  else
  {
    v7 = *a1;
    if ((-1431655765 * ((a1[1] - *a1) >> 3)) >= a3)
    {
      v8 = a3;
    }
    ...
    sub_1CF7E1C(v9, v7 + 24 * a2, v7 + 24 * v8, 0xAAAAAAAAAAAAAAABLL * ((24 * v8 - 24 * a2) >> 3));
    sub_1CF6E24(v9, a4, a5);
    v10 = v9;
    sub_195E3E8(&v10);
  }
}

void sub_1CF7038(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, ...)
{
  va_start(va, a4);
  sub_195E3E8(va);
  _Unwind_Resume(a1);
...
std::string *sub_1CF7050@<X0>(uint64_t a1@<X0>, std::string::value_type *a2@<X1>, std::string *a3@<X8>)
{
  v5 = std::string::find(a1, *a2, 0);
  if (*(a1 + 23) >= 0)
  {
    v6 = *(a1 + 23);
  }
  ...
  return std::string::basic_string(a3, a1, v5 + 1, v6, &v8);
}

uint64_t sub_1CF70B0(uint64_t result, unsigned __int8 *a2, _BYTE *a3)
{
  v3 = *(result + 23);
  if ((v3 & 0x80u) == 0)
  {
...
BOOL sub_1CF70F4(char *a1)
{
  ...
  do
  {
    ...
    {
      v5 = _DefaultRuneLocale.__runetype[v4] & 0x100;
    }
...
std::string *sub_1CF7188@<X0>(uint64_t a1@<X0>, std::string *a2@<X8>)
{
  if (*(a1 + 23) < 0)
  {
    sub_325C(a2, *a1, *(a1 + 8));
  ...
  if (v8)
  {
    ...
    else
    {
      ...
      {
        v13 = v7[v12];
        if ((v13 & 0x8000000000000000) == 0 && (_DefaultRuneLocale.__runetype[v13] & 0x400) != 0)
        {
          *v9++ = v13;
        }
...
LABEL_25:
  ...
  return std::string::erase(a2, v9 - v5, v15 - v9);
}

void sub_1CF72A0(_Unwind_Exception *exception_object)
{
  if (*(v1 + 23) < 0)
  {
    operator delete(*v1);
...
uint64_t sub_1CF7674(_BYTE *a1, uint64_t a2, int *a3)
{
  *(a2 + 4) = 0;
  *a2 = 0;
  v3 = *a1;
...
void sub_1CF7738(uint64_t a1@<X0>, const void **a2@<X8>)
{
  v2 = a1;
  *a2 = 0;
  a2[1] = 0;
...
void sub_1CF7884(_Unwind_Exception *exception_object)
{
  v3 = *v1;
  if (*v1)
  {
...
void sub_1CF78A4(uint64_t a1@<X0>, uint64_t a2@<X8>)
{
  v2 = a1;
  *a2 = 0;
  *(a2 + 8) = 0;
...
void sub_1CF7A58(_Unwind_Exception *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, void *__p, uint64_t a10, int a11, __int16 a12, char a13, char a14)
{
  if (a14 < 0)
  {
    operator delete(__p);
...
_BYTE *sub_1CF7A8C@<X0>(unsigned int a1@<W0>, _BYTE *a2@<X8>)
{
  v5 = 0;
  *__s = 0;
  if (a1 > 0x7F)
  {
    ...
    if (a1 > 0x7FF)
    {
      if (HIWORD(a1))
      {
        ...
        {
          __s[0] = (a1 >> 18) | 0xF0;
          __s[1] = (a1 >> 12) & 0x3F | 0x80;
          __s[2] = (a1 >> 6) & 0x30 | (4 * (BYTE1(a1) & 3)) | (a1 >> 6) | 0x80;
          __s[3] = a1 & 0xF | (16 * (v2 & 3)) | 0x80;
        }
      }
      ...
      {
        __s[0] = (a1 >> 12) | 0xE0;
        __s[1] = (a1 >> 6) & 0xC3 | (4 * (BYTE1(a1) & 0xF)) | 0x80;
        __s[2] = a1 & 0xF | (16 * (v2 & 3)) | 0x80;
      }
    }
  ...
  return sub_3608D0(a2, __s);
}

void sub_1CF7B7C(std::string *a1@<X0>, std::string *a2@<X1>, std::__fs::filesystem::path *a3@<X8>)
{
  sub_1CF7EA4(&v6.__pn_, a1);
  sub_1CF7EA4(&__p.__pn_, a2);
  sub_1CF7C54(&v6, &__p);
  ...
  {
    sub_325C(a3, v6.__pn_.__r_.__value_.__l.__data_, v6.__pn_.__r_.__value_.__l.__size_);
    if (SHIBYTE(v6.__pn_.__r_.__value_.__r.__words[2]) < 0)
    {
...
void sub_1CF7C1C(_Unwind_Exception *exception_object, int a2, int a3, int a4, int a5, int a6, int a7, int a8, void *a9, uint64_t a10, int a11, __int16 a12, char a13, char a14, void *__p, uint64_t a16, int a17, __int16 a18, char a19, char a20)
{
  if (a20 < 0)
  {
    operator delete(__p);
...
std::__fs::filesystem::path *sub_1CF7C54(std::__fs::filesystem::path *a1, std::__fs::filesystem::path *this)
{
...
uint64_t sub_1CF7CCC(uint64_t a1, uint64_t *a2)
{
  v3 = *a2;
  *a1 = *a2;
  *(a1 + *(v3 - 24)) = a2[8];
...
uint64_t sub_1CF7E1C(uint64_t result, uint64_t a2, uint64_t a3, unint64_t a4)
{
  if (a4)
  {
...
void sub_1CF7E84(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, void **a9)
{
  *(v9 + 8) = v10;
  sub_195E3E8(&a9);
  _Unwind_Resume(a1);
...
std::string *sub_1CF7EA4(std::string *a1, std::string *a2)
{
  ...
  sub_195A3D4(a1, a2, (a2 + v3));
  return a1;
}

void sub_1CF7EF0(_Unwind_Exception *exception_object)
{
  if (*(v1 + 23) < 0)
  {
    operator delete(*v1);
...
void sub_1CF7F0C()
{
  ...
  v4 = 233;
  sub_195E43C(&v1495, v5, __p);
  sub_1966280(qword_27EF1A0, v1247, 249);
  v0 = &v1496;
  v1 = -13944;
  do
  {
