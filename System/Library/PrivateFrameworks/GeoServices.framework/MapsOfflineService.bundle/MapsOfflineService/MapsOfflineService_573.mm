...
void sub_20D4E04()
{
  ...
  unk_27F1990 = 0;
  qword_27F1998 = 0;
  sub_68678C(&qword_27F1988, __p, &v2, 1uLL);
  if (v1 < 0)
  {
  ...
  *algn_27F19A8 = 0;
  qword_27F19B0 = 0;
  sub_68678C(&qword_27F19A0, __p, &v2, 1uLL);
  if (v1 < 0)
  {
    operator delete(__p[0]);
  }
  ...
  unk_27F19C0 = 0;
  qword_27F19C8 = 0;
  sub_68678C(&qword_27F19B8, __p, &v2, 1uLL);
  if (v1 < 0)
  {
    operator delete(__p[0]);
  }
    ...
    do
    {
      ...
      if (v9 == 3)
      {
        if (v7[50] == 1 && *(a3 + 162) == 1)
        {
          ...
          *&__src = v66;
          sub_195E3E8(&__src);
          if (0xAAAAAAAAAAAAAAABLL * ((v59.__r_.__value_.__l.__size_ - v59.__r_.__value_.__r.__words[0]) >> 3) < 2)
          {
            sub_1BCBACC(v8, &__src);
            sub_20D806C(v66, &v60, v5, &v59, &__src);
            v50 = 0;
            v51 = 0;
            v52 = 0;
            sub_20D7820(&v50, v66, v74, 1uLL);
            if (v72)
            {
              v73 = v72;
              operator delete(v72);
          ...
          else
          {
            sub_1BCBACC(v8, &__src);
            sub_20D806C(v66, &v60, v5, &v59, &__src);
            sub_1C119CC((v8 + 8), &v62);
            p_src = 0;
            v55 = 0;
            v56 = 0;
            sub_68678C(&p_src, &v62, &v64, 1uLL);
            sub_20D772C(&p_src, &__p);
            sub_1BCBACC(v8, v53);
            sub_20D806C(v74, &v60, v5, &__p, v53);
            v50 = 0;
            v51 = 0;
            v52 = 0;
            sub_20D7820(&v50, v66, v75, 2uLL);
            v39 = 40;
            do
            {
              v40 = &v66[v39];
              v41 = *(&__p.__r_.__value_.__l.__data_ + v39 * 8);
              if (v41)
              {
                *(v40 - 2) = v41;
                operator delete(v41);
          ...
          v66[0] = &v59;
          sub_195E3E8(v66);
          sub_20D79A0(v4, *v4, v50, v51, 0xCCCCCCCCCCCCCCCDLL * ((v51 - v50) >> 5));
          v66[0] = &v50;
          sub_196232C(v66);
        }
      }
      ...
      else if (v9 == 2)
      {
        if (v7[52] == 1)
        {
          ...
          {
            sub_325C(&__p, v59.__r_.__value_.__l.__data_, v59.__r_.__value_.__l.__size_);
          }
          ...
          __src = 0uLL;
          v58 = 0;
          sub_68678C(&__src, &__p, v66, 1uLL);
          if (*(v8 + 31) < 0)
          {
            sub_325C(&v62, *(v8 + 8), *(v8 + 16));
          }
          ...
          v56 = 0;
          sub_68678C(&p_src, &v62, &v64, 1uLL);
          sub_20D806C(v66, &v50, v5, &__src, &p_src);
          v45 = v4[1];
          if (v45 >= v4[2])
          {
            v46 = sub_20D7F38(v4, v66);
          }

          else
          {
            sub_20D7578(v4, v4[1], v66);
            v46 = v45 + 160;
          }
        ...
        if (v11 != v10)
        {
          ...
          do
          {
            ...
            else
            {
              if (SHIBYTE(__p.__r_.__value_.__r.__words[2]) < 0)
              {
                sub_325C(v59.__r_.__value_.__l.__size_, __p.__r_.__value_.__l.__data_, __p.__r_.__value_.__l.__size_);
              }

              else
              {
                v16 = *&__p.__r_.__value_.__l.__data_;
                *(v59.__r_.__value_.__l.__size_ + 16) = *(&__p.__r_.__value_.__l + 2);
                *size = v16;
              }
            ...
            v59.__r_.__value_.__l.__size_ = v17;
            v20 = *(v14 + 48);
            v19 = v14 + 48;
            v18 = v20;
            if (v20)
...
LABEL_29:
        ...
        sub_20D806C(v66, v53, v5, &v59, &__p);
        *&v62 = &__p;
        sub_195E3E8(&v62);
        *&v62 = &p_src;
        sub_19A240C(&v62);
        sub_20D724C(&v72, __src, *(&__src + 1), (*(&__src + 1) - __src) >> 2);
        if (__src)
        {
          *(&__src + 1) = __src;
        ...
        *&__src = &v59;
        sub_195E3E8(&__src);
        sub_19E3294(v8, &v59);
        v35 = v59.__r_.__value_.__l.__size_;
        ...
        *&__src = &v59;
        ...
        {
          sub_19E3294(v8, &v59);
          v37 = v59.__r_.__value_.__l.__size_;
          for (i = v59.__r_.__value_.__r.__words[0]; i != v37; i += 24)
          {
            sub_1FFE844();
            sub_794D4(v71, &__src);
            if (SHIBYTE(v58) < 0)
        ...
        sub_195E3E8(&v59);
        v59.__r_.__value_.__r.__words[0] = v70;
        sub_195E3E8(&v59);
        v59.__r_.__value_.__r.__words[0] = v69;
        sub_195E3E8(&v59);
        if (v68)
        {
          sub_1220A18(v68);
...
uint64_t sub_20D5B50(uint64_t *a1, uint64_t a2)
{
  v3 = a1[1];
  if (v3 >= a1[2])
  {
...
void sub_20D5E00(uint64_t *a1@<X0>, uint64_t **a2@<X1>, _BYTE *a3@<X2>, uint64_t *a4@<X8>)
{
  v5 = a4;
  *a4 = 0;
  a4[1] = 0;
...
LABEL_81:
  ...
  sub_20D79A0(v5, v5[1], v34, *(&v34 + 1), 0xCCCCCCCCCCCCCCCDLL * ((*(&v34 + 1) - v34) >> 5));
  v54 = &v38;
  sub_196232C(&v54);
}
...
void sub_20D67D8(void *a1, uint64_t *a2)
{
  v2 = *a1;
  if (*(*a1 + 288) != 2)
  {
...
void sub_20D6B0C(void *a1, uint64_t *a2)
{
  v2 = *a1;
  if (*(*a1 + 288) != 4)
  {
...
void sub_20D6C24(uint64_t *a1@<X0>, uint64_t *a2@<X8>)
{
  *a2 = 0;
  a2[1] = 0;
  a2[2] = 0;
...
void sub_20D6F28(uint64_t a1@<X0>, uint64_t *a2@<X8>)
{
  *a2 = 0;
  ...
  else
  {
    ...
    v7 = nullsub_1(a1);
    v8 = nullsub_1(a1);
    sub_1965C4C(v14, (v8 + 1296));
    v25 = 1;
    sub_20D5E00(v6, v26, (v7 + 8), &v27);
    sub_20D8648(a2);
    *a2 = v27;
    a2[2] = v28;
    v28 = 0;
  ...
  v9 = *a2;
  v10 = a2[1];
  v11 = 0xCCCCCCCCCCCCCCCDLL * ((v10 - *a2) >> 5);
  if (v11 >= 2)
  {
    *&v27 = sub_20D7198;
    v12 = 126 - 2 * __clz(v11);
...
void *sub_20D724C(void *result, char *__src, char *a3, unint64_t a4)
{
  v6 = result;
  v7 = result[2];
  v8 = *result;
...
uint64_t sub_20D7378(uint64_t *a1, uint64_t a2)
{
...
void sub_20D7494(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, ...)
{
  va_start(va, a4);
  sub_20D76AC(va);
  _Unwind_Resume(a1);
...
uint64_t sub_20D79A0(uint64_t *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5)
{
  v5 = a2;
  if (a5 >= 1)
  {
    ...
    v10 = a1[1];
    v9 = a1[2];
    if ((0xCCCCCCCCCCCCCCCDLL * ((v9 - v10) >> 5)) >= a5)
    {
      v16 = v10 - a2;
      if ((0xCCCCCCCCCCCCCCCDLL * ((v10 - a2) >> 5)) >= a5)
      {
        v19 = 5 * a5;
        sub_20D7BCC(a1, a2, a1[1], a2 + 160 * a5);
        v20 = v7 + 32 * v19;
        v21 = v5;
        do
        {
      ...
      {
        v17 = v16 + a3;
        a1[1] = sub_19621A0(a1, v16 + a3, a4, a1[1]);
        if (v16 >= 1)
        {
          sub_20D7BCC(a1, v5, v10, v5 + 160 * a5);
          v18 = v5;
          do
          {
            sub_20D7E28(v18, v7);
    ...
    {
      v11 = *a1;
      v12 = a5 - 0x3333333333333333 * ((v10 - *a1) >> 5);
      ...
      v13 = a2 - v11;
      v14 = 0xCCCCCCCCCCCCCCCDLL * ((v9 - v11) >> 5);
      if (2 * v14 > v12)
      {
        v12 = 2 * v14;
      }
...
void sub_20D7BCC(uint64_t a1, uint64_t a2, unint64_t a3, uint64_t a4)
{
  v7 = *(a1 + 8);
  v8 = a2 + v7 - a4;
  if (v8 >= a3)
...
void sub_20D8058(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, ...)
{
  va_start(va, a4);
  sub_20D76AC(va);
  _Unwind_Resume(a1);
...
uint64_t sub_20D806C(uint64_t a1, _DWORD *a2, void *a3, uint64_t *a4, uint64_t *a5)
{
  *a1 = *a2;
  v7 = a3[1];
  *(a1 + 8) = *a3;
...
void sub_20D8134(_Unwind_Exception *a1, uint64_t a2, ...)
{
  va_start(va, a2);
  sub_195E3E8(va);
  v4 = *(v2 + 32);
...
void sub_20D8688(uint64_t a1, int *a2, uint64_t (**a3)(uint64_t, uint64_t), uint64_t a4, char a5)
{
LABEL_1:
  v9 = a2 - 40;
  v49 = (a2 - 120);
...
LABEL_84:
    ...
    if (v14 == 4)
    {
      ...
      sub_20D8D50(v10, v10 + 160, v10 + 320, (a2 - 40), a3);
      return;
    }

    if (v14 == 5)
    {
      sub_20D8D50(v10, v10 + 160, v10 + 320, v10 + 480, a3);
      if (!(*a3)((a2 - 40), v10 + 480))
      {
        return;
      }

      sub_20D9AF0(v10 + 480, (a2 - 40));
      if (!(*a3)(v10 + 480, v10 + 320))
      {
        return;
      }

      sub_20D9AF0(v10 + 320, v10 + 480);
      if (!(*a3)(v10 + 320, v10 + 160))
      {
        return;
      }
...
LABEL_28:
      ...
      if (v27)
      {
        ...
        sub_20D9AF0(a1 + 160, a1 + 160 * v15 - 160);
        if ((*a3)(v50, a1 + 160 * v15 - 160))
        {
          v29 = a1 + 160 * v15 - 160;
LABEL_40:
          v30 = (a2 - 80);
LABEL_41:
      ...
      {
        sub_20D9AF0(a1 + 160 * v15 - 160, v50);
        if ((*a3)(a1 + 160 * v15 - 160, a1 + 160))
        {
          v29 = a1 + 160;
          v30 = a1 + 160 * v15 - 160;
          goto LABEL_41;
...
LABEL_51:
      ...
      {
        sub_20D9AF0(v31 + 160, v49);
        if ((*a3)(v31 + 160, a1 + 320))
        {
          v34 = a1 + 320;
          v35 = v31 + 160;
          goto LABEL_51;
...
LABEL_63:
    if ((a5 & 1) == 0 && ((*a3)(a1 - 160, a1) & 1) == 0)
    {
      v10 = sub_20D9240(a1, a2, a3);
      goto LABEL_70;
    }

    v40 = sub_20D9478(a1, a2, a3);
    if ((v41 & 1) == 0)
    {
      goto LABEL_68;
    }

    v42 = sub_20D96C4(a1, v40, a3);
    v10 = v40 + 160;
    if (sub_20D96C4(v40 + 160, a2, a3))
    {
      a4 = -v12;
      a2 = v40;
      if (v42)
    ...
    {
LABEL_68:
      sub_20D8688(a1, v40, a3, -v12, a5 & 1);
      v10 = v40 + 160;
LABEL_70:
      a5 = 0;
      a4 = -v12;
...
void sub_20D8D50(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t (**a5)(uint64_t, uint64_t))
{
  v10 = (*a5)(a2, a1);
  v11 = (*a5)(a3, a2);
  if (v10)
...
void sub_20D8EA0(uint64_t a1, _DWORD *a2, uint64_t (**a3)(int *, uint64_t))
{
  if (a1 != a2)
  {
    v5 = (a1 + 160);
...
void sub_20D9074(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, ...)
{
  va_start(va, a3);
  sub_1E11028(va);
  _Unwind_Resume(a1);
...
void sub_20D9088(uint64_t a1, int *a2, uint64_t (**a3)(int *, uint64_t))
{
  if (a1 != a2)
  {
    v4 = a1;
...
void sub_20D922C(_Unwind_Exception *a1, uint64_t a2, ...)
{
  va_start(va, a2);
  sub_1E11028(va);
  _Unwind_Resume(a1);
...
unint64_t sub_20D9240(uint64_t a1, unint64_t a2, uint64_t (**a3)(int *, unint64_t))
{
  v4 = a2;
  v13 = *a1;
  v6 = *(a1 + 8);
  ...
  *(a1 + 152) = 0;
  ...
  if (v9 - 160 != a1)
  {
    sub_20D7D4C(a1, v9 - 160);
  }

  sub_20D7D4C(v9 - 160, &v13);
  if (__p[0])
  {
    __p[1] = __p[0];
    operator delete(__p[0]);
...
void sub_20D9450(_Unwind_Exception *a1, uint64_t a2, ...)
{
  va_start(va, a2);
  sub_1E11028(va);
  _Unwind_Resume(a1);
...
uint64_t sub_20D9478(uint64_t a1, unint64_t a2, uint64_t (**a3)(uint64_t, int *))
{
  v6 = 0;
  v15 = *a1;
  v7 = *(a1 + 8);
...
void sub_20D96A0(_Unwind_Exception *a1, uint64_t a2, ...)
{
  va_start(va, a2);
  sub_1E11028(va);
  _Unwind_Resume(a1);
...
BOOL sub_20D96C4(uint64_t a1, uint64_t a2, uint64_t (**a3)(uint64_t, uint64_t))
{
  ...
  if (v6 > 2)
  {
    switch(v6)
    {
      case 3:
        ...
        break;
      case 4:
        sub_20D8D50(a1, a1 + 160, a1 + 320, a2 - 160, a3);
        return 1;
      case 5:
        v9 = a2 - 160;
        sub_20D8D50(a1, a1 + 160, a1 + 320, a1 + 480, a3);
        if (!(*a3)(v9, a1 + 480))
        {
          return 1;
        }

        sub_20D9AF0(a1 + 480, v9);
        if (!(*a3)(a1 + 480, a1 + 320))
        {
          return 1;
        }

        sub_20D9AF0(a1 + 320, a1 + 480);
        if (!(*a3)(a1 + 320, a1 + 160))
        {
          return 1;
        }
...
void sub_20D9ADC(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, ...)
{
  va_start(va, a3);
  sub_1E11028(va);
  _Unwind_Resume(a1);
...
void sub_20D9AF0(uint64_t a1, uint64_t a2)
{
  v6 = *a1;
  v3 = *(a1 + 8);
  *(a1 + 8) = 0;
...
uint64_t sub_20D9C14(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t (**a4)(uint64_t, uint64_t))
{
  if (a1 != a2)
  {
    v6 = a2;
...
void sub_20D9F98(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, ...)
{
  va_start(va, a5);
  sub_1E11028(va);
  _Unwind_Resume(a1);
...
void sub_20D9FAC(uint64_t a1, uint64_t a2, unsigned int (**a3)(uint64_t, uint64_t), uint64_t a4)
{
  if (a4 >= 2)
  {
    v13 = *a1;
...
void sub_20DA13C(_Unwind_Exception *a1, uint64_t a2, ...)
{
  va_start(va, a2);
  sub_1E11028(va);
  _Unwind_Resume(a1);
...
void sub_20DA3CC()
{
  ...
  sub_1966280(qword_27F1A30, v1247, 249);
  v0 = &v1496;
  v1 = -13944;
  do
  {
