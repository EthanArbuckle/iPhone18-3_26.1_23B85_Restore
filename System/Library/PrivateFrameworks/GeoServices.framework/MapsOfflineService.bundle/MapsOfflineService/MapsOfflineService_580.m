void sub_2153DD4(_Unwind_Exception *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, uint64_t a10, uint64_t a11, void *__p, uint64_t a13, int a14, __int16 a15, char a16, char a17)
{
  *(v17 - 40) = &a9;
  sub_195E3E8((v17 - 40));
  if (a17 < 0)
...
void sub_2153E00()
{
  ...
  sub_1966280(qword_27F2020, v1247, 249);
  v0 = &v1496;
  v1 = -13944;
  do
  {
...
void sub_215E8BC()
{
  ...
  unk_27F1FE0 = 0;
  qword_27F1FE8 = 0;
  sub_68678C(&qword_27F1FD8, __p, &v2, 1uLL);
  if (v1 < 0)
  {
    operator delete(__p[0]);
  }
  ...
  *algn_27F1FF8 = 0;
  qword_27F2000 = 0;
  sub_68678C(&qword_27F1FF0, __p, &v2, 1uLL);
  if (v1 < 0)
  {
    operator delete(__p[0]);
  }
  ...
  unk_27F2010 = 0;
  qword_27F2018 = 0;
  sub_68678C(&qword_27F2008, __p, &v2, 1uLL);
  if (v1 < 0)
  {
    operator delete(__p[0]);
  }
...
void sub_215E9DC(_Unwind_Exception *exception_object, int a2, int a3, int a4, int a5, int a6, int a7, int a8, void *__p, uint64_t a10, int a11, __int16 a12, char a13, char a14)
{
  if (a14 < 0)
  {
    operator delete(__p);
...
void sub_215EA08(uint64_t a1@<X0>, int a2@<W1>, uint64_t a3@<X2>, uint64_t a4@<X3>, uint64_t *a5@<X4>, void *a6@<X5>, int a7@<W6>, uint64_t *a8@<X8>)
{
  sub_1A2D800(a1, a2, &v23);
  v14 = v23;
  if (v23 != v24)
  {
    sub_1A9BD58(a6, &v23, a7, &v21);
    v15 = v21;
    if (v21 == v22)
    {
      *a8 = 0;
...
LABEL_10:
    ...
    {
      sub_1A2E7C4(&v21, v20);
      sub_1A9BA80(a6, a5, v20, 0, a8);
      if (*(a4 + 16) == 2 && 0xAAAAAAAAAAAAAAABLL * ((a8[1] - *a8) >> 4) < 0xAAAAAAAAAAAAAAABLL * ((v20[1] - v20[0]) >> 3))
      {
        sub_3608D0(v18, "missing_partition_data");
        sub_1961D34(__p, *(a3 + 496), *(a3 + 504), *(a3 + 504) - *(a3 + 496));
        sub_1B2F124((a4 + 1528), v18, __p);
        if (v17 < 0)
        {
          operator delete(__p[0]);
        }
...
void sub_215EB88(_Unwind_Exception *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, void *__p, uint64_t a11, int a12, __int16 a13, char a14, char a15, char *a16, uint64_t a17, int a18, __int16 a19, char a20, char a21, char a22, uint64_t a23, uint64_t a24, void *a25, uint64_t a26)
{
  if (a15 < 0)
  {
    operator delete(__p);
...
void sub_215EC18(std::string::size_type *a1@<X0>, int *a2@<X1>, int a3@<W2>, uint64_t a4@<X3>, void *a5@<X8>)
{
  a5[1] = 0;
  v5 = a5 + 1;
  a5[2] = 0;
  *a5 = a5 + 1;
  ...
  if (*a1 != v7)
  {
    ...
    while (1)
    {
      ...
      v27.__r_.__value_.__r.__words[0] = v11;
      v27.__r_.__value_.__l.__size_ = v10;
      sub_19AD89C(&v27.__r_.__value_.__l.__data_, 35, &v34);
      if (0xAAAAAAAAAAAAAAABLL * ((v35 - v34) >> 3) <= 3)
      {
        sub_6FAB4();
      }

      v12 = std::stoi(v34 + 3, 0, 10);
...
LABEL_24:
          ...
          sub_1AB5DBC(v21, v23, v24, 0xCCCCCCCCCCCCCCCDLL * ((v24 - v23) >> 3));
          v22 = v26;
          sub_1AB871C(a5, &v20);
          v38 = v21;
          sub_1AB5F64(&v38);
      ...
      v27.__r_.__value_.__r.__words[0] = &v34;
      sub_195E3E8(&v27);
      v6 += 48;
      if (v6 == v7)
      {
...
void sub_215EECC(_Unwind_Exception *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, char a16, uint64_t a17, uint64_t a18, uint64_t a19, char *__p, uint64_t a21, int a22, __int16 a23, char a24, char a25, uint64_t a26, uint64_t a27, uint64_t a28, uint64_t a29, char a30)
{
  if (a25 < 0)
  {
    operator delete(__p);
  ...
  __p = &a30;
  sub_195E3E8(&__p);
  sub_195A77C(v30 - 120, *(v30 - 112));
  sub_1AB6458(a10, *(a10 + 8));
  _Unwind_Resume(a1);
}

std::string *sub_215EF68@<X0>(const std::string *a1@<X0>, std::string *a2@<X8>)
{
...
LABEL_13:
    ...
    return std::string::basic_string(a2, a1, 0, v9 - 2, v13);
  }

  else if (SHIBYTE(a1->__r_.__value_.__r.__words[2]) < 0)
  {
    return sub_325C(a2, a1->__r_.__value_.__l.__data_, a1->__r_.__value_.__l.__size_);
  }
...
uint64_t sub_215F064(const std::string *a1, void *a2, uint64_t *a3)
{
  sub_215EF68(a1, &__p);
  v6 = *a3;
  v5 = a3[1];
...
void sub_215F140(_Unwind_Exception *exception_object, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, void *__p, uint64_t a11, int a12, __int16 a13, char a14, char a15)
{
  if (a15 < 0)
  {
    operator delete(__p);
...
void sub_215F15C()
{
  ...
  v4 = 233;
  sub_195E43C(&v1495, v5, __p);
  sub_1966280(qword_27F2080, v1247, 249);
  v0 = &v1496;
  v1 = -13944;
  do
  {
...
void sub_2166144(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, void *__p, uint64_t a11, int a12, __int16 a13, char a14, char a15, uint64_t a16, void *a17, uint64_t a18, int a19, __int16 a20, char a21, char a22, void *a23, uint64_t a24, int a25, __int16 a26, char a27, char a28, uint64_t a29, void *a30, uint64_t a31, int a32, __int16 a33, char a34, char a35, void *a36, uint64_t a37, int a38, __int16 a39, char a40, char a41, uint64_t a42, uint64_t a43, uint64_t a44, int a45, __int16 a46, char a47, char a48, uint64_t a49, uint64_t a50, int a51, __int16 a52, char a53, char a54, uint64_t a55, uint64_t a56, uint64_t a57, int a58, __int16 a59, char a60, char a61, uint64_t a62, uint64_t a63)
{
  v86 = -13944;
  v87 = v80;
  do
