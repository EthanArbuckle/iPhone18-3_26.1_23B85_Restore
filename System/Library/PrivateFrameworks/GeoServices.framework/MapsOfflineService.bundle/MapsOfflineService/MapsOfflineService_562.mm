...
void sub_1FF2A28()
{
  ...
  unk_27F1000 = 0;
  qword_27F1008 = 0;
  sub_68678C(&qword_27F0FF8, __p, &v5, 1uLL);
  if (v4 < 0)
  {
  ...
  *algn_27F1018 = 0;
  qword_27F1020 = 0;
  sub_68678C(&qword_27F1010, __p, &v5, 1uLL);
  if (v4 < 0)
  {
    operator delete(__p[0]);
  }
  ...
  unk_27F1030 = 0;
  qword_27F1038 = 0;
  sub_68678C(&qword_27F1028, __p, &v5, 1uLL);
  if (v4 < 0)
  {
    operator delete(__p[0]);
  }
  ...
  v31 = 4;
  sub_19664AC(&unk_27F1058, __p, 14);
  v1 = 56;
  do
  {
    if (*(&__p[v1 - 1] - 1) < 0)
  ...
  sub_3608D0(v70, "EG");
  v71 = 6;
  sub_1966844(&unk_27F1080, __p, 34);
  v2 = 136;
  do
  {
    if (*(&__p[v2 - 1] - 1) < 0)
...
void sub_1FF30E0(_Unwind_Exception *exception_object, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, void *__p, uint64_t a11, int a12, __int16 a13, char a14, char a15)
{
  v17 = (v15 + 1079);
  v18 = -1088;
  v19 = v17;
...
uint64_t sub_1FF326C(int a1, uint64_t a2)
{
  v2 = 360;
  if (a1 == 1)
  {
...
uint64_t sub_1FF3290(int a1, int a2, unsigned int a3, int a4, uint64_t a5, char a6)
{
  if ((*(a5 + 560) & 1) == 0)
  {
    if (a3 >= 2)
...
uint64_t sub_1FF33BC(double **a1)
{
  v1 = *a1;
  v2 = a1[1];
  if (*a1 == v2)
  ...
  do
  {
    v4 = sub_1F71298(11, v1[9], v1[8]);
    v5 = sub_1F71298(11, v1[7], v1[10]);
    v3 = (v5 - v4 + 1 + (v5 - v4 + 1) * (HIDWORD(v5) - HIDWORD(v4)) + v3);
    v1 += 12;
  }
...
unint64_t sub_1FF3474@<X0>(unint64_t result@<X0>, uint64_t a2@<X1>, uint64_t a3@<X2>, void *a4@<X3>, int a5@<W4>, uint64_t a6@<X5>, char a7@<W6>, void *a8@<X8>)
{
  if (*(result + 12) == 1 && *(a2 + 12) == 1)
  {
    v12 = result;
    if (*(a6 + 560))
    {
      ...
      if (*(a2 + 12))
      {
        ...
        *a8 = a8 + 1;
        ...
        if (v33 != v31)
        {
          ...
          {
            v35 = *(v32 + 7);
            result = sub_1FF3290(v16, v34, *(v32 + 7), a5, a6, a7);
            if (result >= 1)
            {
              v38 = v35 | (result << 32);
              result = sub_1FF3790(a8, &v38);
            }
...
uint64_t sub_1FF3730(int a1, uint64_t a2)
{
  v2 = 348;
  if (a1 < 2)
  {
...
uint64_t sub_1FF3748(uint64_t a1, int a2)
{
  v4 = *(a1 + 8);
  v2 = a1 + 8;
  v3 = v4;
...
uint64_t *sub_1FF3790(uint64_t a1, int *a2)
{
  v2 = *(a1 + 8);
  if (!v2)
  {
...
void sub_1FF385C()
{
  ...
  sub_1966280(qword_27F10F0, v1247, 249);
  v0 = &v1496;
  v1 = -13944;
  do
  {
...
void sub_1FFA844(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, void *__p, uint64_t a11, int a12, __int16 a13, char a14, char a15, uint64_t a16, void *a17, uint64_t a18, int a19, __int16 a20, char a21, char a22, void *a23, uint64_t a24, int a25, __int16 a26, char a27, char a28, uint64_t a29, void *a30, uint64_t a31, int a32, __int16 a33, char a34, char a35, void *a36, uint64_t a37, int a38, __int16 a39, char a40, char a41, uint64_t a42, uint64_t a43, uint64_t a44, int a45, __int16 a46, char a47, char a48, uint64_t a49, uint64_t a50, int a51, __int16 a52, char a53, char a54, uint64_t a55, uint64_t a56, uint64_t a57, int a58, __int16 a59, char a60, char a61, uint64_t a62, uint64_t a63)
{
  v86 = -13944;
  v87 = v80;
  do
...
void sub_1FFE318()
{
  ...
  unk_27F10B0 = 0;
  qword_27F10B8 = 0;
  sub_68678C(&qword_27F10A8, __p, &v2, 1uLL);
  if (v1 < 0)
  {
    operator delete(__p[0]);
  }
  ...
  *algn_27F10C8 = 0;
  qword_27F10D0 = 0;
  sub_68678C(&qword_27F10C0, __p, &v2, 1uLL);
  if (v1 < 0)
  {
    operator delete(__p[0]);
  }
  ...
  unk_27F10E0 = 0;
  qword_27F10E8 = 0;
  sub_68678C(&qword_27F10D8, __p, &v2, 1uLL);
  if (v1 < 0)
  {
    operator delete(__p[0]);
  }
...
void sub_1FFE438(_Unwind_Exception *exception_object, int a2, int a3, int a4, int a5, int a6, int a7, int a8, void *__p, uint64_t a10, int a11, __int16 a12, char a13, char a14)
{
  if (a14 < 0)
  {
    operator delete(__p);
...
double sub_1FFE490@<D0>(const void **a1@<X0>, std::string::value_type *a2@<X1>, std::string *a3@<X8>)
{
  if (*(a1 + 23) >= 0)
  {
    v6 = *(a1 + 23);
  ...
  *(&v7->__r_.__value_.__l.__data_ + v6) = 35;
...
void sub_1FFE54C(_Unwind_Exception *exception_object, int a2, int a3, int a4, int a5, int a6, int a7, int a8, void *__p, uint64_t a10, int a11, __int16 a12, char a13, char a14)
{
  if (a14 < 0)
  {
    operator delete(__p);
...
double sub_1FFE5EC@<D0>(const void **a1@<X0>, _BYTE *a2@<X1>, std::string *a3@<X8>)
{
  v6 = 99;
  v5 = 80;
  if (*a2)
  ...
  return sub_1FFE490(a1, v3, a3);
}

void sub_1FFE630(unsigned int a1@<W0>, std::string *a2@<X8>)
{
  std::to_string(&__p, a1);
  v4 = 76;
  sub_1FFE490(&__p.__r_.__value_.__l.__data_, &v4, a2);
...
void sub_1FFE688(_Unwind_Exception *exception_object, int a2, int a3, int a4, int a5, int a6, int a7, int a8, void *__p, uint64_t a10, int a11, __int16 a12, char a13, char a14)
{
  if (a14 < 0)
  {
    operator delete(__p);
...
uint64_t sub_1FFE6A4(const std::string *a1)
{
  v2 = std::string::find(a1, 35, 0);
  std::string::basic_string(&__p, a1, 0, v2, &v6);
...
void sub_1FFE718(_Unwind_Exception *exception_object, int a2, int a3, int a4, int a5, int a6, int a7, int a8, void *__p, uint64_t a10, int a11, __int16 a12, char a13, char a14)
{
  if (a14 < 0)
  {
    operator delete(__p);
...
void sub_1FFE734(unint64_t a1@<X0>, std::string *a2@<X8>)
{
  std::to_string(&v4, a1);
  v3 = std::string::append(&v4, "#m", 2uLL);
  *a2 = *v3;
...
void sub_1FFE7A0(_Unwind_Exception *exception_object, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, void *__p, uint64_t a11, int a12, __int16 a13, char a14, char a15)
{
  if (a15 < 0)
  {
    operator delete(__p);
...
void sub_1FFE7BC(unint64_t a1@<X0>, std::string *a2@<X8>)
{
  std::to_string(&v4, a1);
  v3 = std::string::append(&v4, "#S", 2uLL);
  *a2 = *v3;
  v3->__r_.__value_.__l.__size_ = 0;
  v3->__r_.__value_.__r.__words[2] = 0;
  v3->__r_.__value_.__r.__words[0] = 0;
...
void sub_1FFE828(_Unwind_Exception *exception_object, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, void *__p, uint64_t a11, int a12, __int16 a13, char a14, char a15)
{
  if (a15 < 0)
  {
    operator delete(__p);
...
void sub_1FFE8D8()
{
  ...
  v4 = 233;
  sub_195E43C(&v1495, v5, __p);
  sub_1966280(qword_27F1150, v1247, 249);
  v0 = &v1496;
  v1 = -13944;
  do
  {
