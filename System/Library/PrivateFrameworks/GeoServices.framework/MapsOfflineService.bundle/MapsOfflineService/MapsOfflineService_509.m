...
uint64_t sub_1BD72D0(uint64_t a1, double a2, double a3)
{
  ...
  *(a1 + 48) = 1065353216;
  do
  {
    v7 = v4;
    v8 = &v7;
    sub_1A2F4B0(v5, &v7)[3] = 0xBFF0000000000000;
    ++v4;
  }
...
void sub_1BD7380()
{
  ...
  sub_1966280(qword_27EE590, v1247, 249);
  v0 = &v1496;
  v1 = -13944;
  do
  {
...
void sub_1BE1E3C()
{
  ...
  unk_27EE550 = 0;
  qword_27EE558 = 0;
  sub_68678C(&qword_27EE548, __p, &v4, 1uLL);
  if (v3 < 0)
  {
    operator delete(__p[0]);
  }
  ...
  *algn_27EE568 = 0;
  qword_27EE570 = 0;
  sub_68678C(&qword_27EE560, __p, &v4, 1uLL);
  if (v3 < 0)
  {
    operator delete(__p[0]);
  }
  ...
  unk_27EE580 = 0;
  qword_27EE588 = 0;
  sub_68678C(&qword_27EE578, __p, &v4, 1uLL);
  if (v3 < 0)
  {
    operator delete(__p[0]);
  }
...
void sub_1BE2668(std::string::size_type a1@<X0>, uint64_t a2@<X8>)
{
  v4 = *(a1 + 23);
  if ((v4 & 0x80u) == 0)
  {
  ...
  sub_19AD89C(&__p.__r_.__value_.__l.__data_, 45, &v18);
  if (v19 == v18)
  {
    sub_6FAB4();
  }
...
LABEL_26:
  ...
  if (0xAAAAAAAAAAAAAAABLL * ((v19 - v18) >> 3) < 2)
  {
...
LABEL_40:
  ...
  std::operator+<char>();
  if (0xAAAAAAAAAAAAAAABLL * ((v19 - v18) >> 3) <= 1)
  {
    sub_6FAB4();
  }
...
void sub_1BE28A0(uint64_t **a1@<X0>, std::string::size_type a2@<X1>, _DWORD *a3@<X2>, _BYTE *a4@<X8>)
{
  ...
  sub_1EE001C(*a1, &v29, 0x7FFFFFFF, &v26);
  ...
  if (v26.__r_.__value_.__r.__words[0] == v26.__r_.__value_.__l.__size_)
  {
    v11 = *a1;
    sub_3608D0(__dst, "en#");
    sub_1EE001C(v11, __dst, 0x7FFFFFFF, &v36);
...
void *sub_1BE2E24@<X0>(void *result@<X0>, _BYTE *a2@<X8>)
{
  if (*result)
  {
    sub_1EDFCDC();
...
void sub_1BE3104(unint64_t *a1@<X0>, double *a2@<X1>, void *a3@<X2>, uint64_t a4@<X8>)
{
  ...
  if (v5 != v6)
  {
    ...
    do
    {
      ...
      sub_1BE3BE4(__p, v51, (v6 + v12));
      if (v57 >= v58)
      {
        v57 = sub_1BE392C(&v56, __p);
        if (v49[0])
        {
          v49[1] = v49[0];
...
LABEL_40:
            ...
            else
            {
              ...
              do
              {
                ...
                v37 = v36;
                v38 = sub_1BE3C40(*a2, a2[1], v35, v36) * 6372.79756;
                if (v24 < 0 || v34 > v38)
                {
                  sub_1C4C934(v19, v51, v35, v37);
                  v39 = v52;
                  if ((v52 & 0x80u) == 0)
                  {
                    v40 = v52;
                  ...
                  if (v40 == v41)
                  {
                    v42 = (v52 & 0x80u) == 0 ? v51 : v51[0];
                    v43 = (v47 & 0x80u) == 0 ? __p : __p[0];
                    if (!memcmp(v42, v43, v40))
                    {
                      v24 = v33;
                      v34 = v38;
                    }
...
LABEL_71:
  ...
  *(a4 + 24) = 0;
  *(a4 + 8) = 0;
  sub_1963658(a4 + 8, *(v44 + 8), *(v44 + 16), *(v44 + 16) - *(v44 + 8));
LABEL_72:
  __p[0] = &v56;
  sub_1BE3CE4(__p);
}
...
void sub_1BE3A4C(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, ...)
{
  va_start(va, a4);
  sub_1BE3B94(va);
  _Unwind_Resume(a1);
...
long double sub_1BE3C40(double a1, double a2, double a3, double a4)
{
...
void sub_1BE3D68()
{
  ...
  v4 = 233;
  sub_195E43C(&v1495, v5, __p);
  sub_1966280(qword_27EE640, v1247, 249);
  v0 = &v1496;
  v1 = -13944;
  do
  {
