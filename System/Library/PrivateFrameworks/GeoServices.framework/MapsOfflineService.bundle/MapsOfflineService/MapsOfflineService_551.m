...
void sub_1F0B7D0()
{
  ...
  unk_27F0640 = 0;
  qword_27F0648 = 0;
  sub_68678C(&qword_27F0638, __p, &v5, 1uLL);
  if (v4 < 0)
  {
  ...
  *algn_27F0658 = 0;
  qword_27F0660 = 0;
  sub_68678C(&qword_27F0650, __p, &v5, 1uLL);
  if (v4 < 0)
  {
    operator delete(__p[0]);
  }
  ...
  unk_27F0670 = 0;
  qword_27F0678 = 0;
  sub_68678C(&qword_27F0668, __p, &v5, 1uLL);
  if (v4 < 0)
  {
    operator delete(__p[0]);
  }
...
void sub_1F0C014(void *a1@<X0>, int a2@<W1>, uint64_t a3@<X2>, uint64_t a4@<X3>, void *a5@<X8>)
{
  a5[2] = 0;
  a5[1] = 0;
  *a5 = a5 + 1;
...
uint64_t sub_1F0C450@<X0>(void *a1@<X0>, int a2@<W1>, uint64_t a3@<X2>, void *a4@<X8>)
{
  v5[0] = off_2722EA8;
  v5[1] = sub_1FF3730;
  v5[3] = v5;
...
void sub_1F0C4E4(_Unwind_Exception *a1, uint64_t a2, ...)
{
  va_start(va, a2);
  sub_1AB6100(va);
  _Unwind_Resume(a1);
...
uint64_t sub_1F0C4F8(uint64_t a1, uint64_t a2)
{
  v2 = *(a1 + 32);
  v3 = *(a2 + 32);
  if (v2 > v3)
...
void sub_1F0C564(__n128 *a1, unint64_t a2, uint64_t (**a3)(uint64_t *, uint64_t *), uint64_t a4, char a5, __n128 a6)
{
  v8 = a2;
  v9 = a1;
  v52 = a2;
...
LABEL_2:
  for (i = 1 - a4; ; ++i)
  {
    ...
    {
      v52 = (v8 - 40);
      sub_1F0CD74(v9, &v9[2].n128_i64[1], &v9[5], v8 - 40, a3);
      return;
    }
...
LABEL_65:
    ...
    *&v59[7] = *(&v53->n128_u64[1] + 7);
    ...
    v58 = v9[2].n128_u32[0];
    v39 = *v24;
    v9[1].n128_u64[0] = *(v24 + 2);
    *v9 = v39;
    v40 = *(v24 + 3);
    v9[2].n128_u32[0] = *(v24 + 8);
    v9[1].n128_u64[1] = v40;
    *v24 = v37;
    *(v24 + 1) = *v59;
    *(v24 + 15) = *&v59[7];
...
void sub_1F0CEB4(uint64_t a1, __int128 *a2, uint64_t (**a3)(__int128 *, uint64_t))
{
  if (a1 != a2)
  {
    v5 = (a1 + 40);
...
uint64_t *sub_1F0D170(uint64_t a1, unint64_t a2, unsigned int (**a3)(void **))
{
  v23 = a2;
  v24 = a1;
  *__p = *a1;
...
uint64_t *sub_1F0D38C(uint64_t a1, unint64_t a2, uint64_t (**a3)(void))
{
  v5 = 0;
  v25 = a2;
  *__p = *a1;
...
uint64_t *sub_1F0D974(__n128 *a1, __n128 *a2, uint64_t *a3, unsigned int (**a4)(uint64_t, __int8 *), __n128 a5)
{
  v19 = a1;
  if (a1 != a2)
  {
...
__n128 sub_1F0DAC4(uint64_t a1, unsigned int (**a2)(uint64_t, __int8 *), uint64_t a3, __n128 *a4)
{
  v4 = a3 - 2;
  if (a3 >= 2)
  {
    ...
    if ((v4 >> 1) >= (0xCCCCCCCCCCCCCCCDLL * ((a4 - a1) >> 3)))
    {
      ...
      if (v12 < a3 && (*a2)(a1 + 40 * v10, &v11[2].n128_i8[8]))
      {
        v11 = (v11 + 40);
        v10 = v12;
      }
      ...
      if (((*a2)(v11, v5) & 1) == 0)
      {
        ...
        do
        {
          ...
          *v5 = v17;
          v11[1].n128_u8[7] = 0;
          v11->n128_u8[0] = 0;
          v18 = v11[1].n128_u64[1];
          v5[2].n128_u32[0] = v11[2].n128_u32[0];
          v5[1].n128_u64[1] = v18;
          if (v7 < v10)
          {
            break;
          ...
          else if ((*a2)(a1 + 40 * v19, &v11[2].n128_i8[8]))
          {
            v11 = (v11 + 40);
          }
...
__int128 *sub_1F0DE54(__int128 *a1, unsigned int (**a2)(uint64_t, uint64_t), uint64_t a3)
{
  v6 = 0;
  v7 = (a3 - 2) / 2;
  do
...
void sub_1F0E100()
{
  ...
  sub_1966280(qword_27F0730, v1247, 249);
  v0 = &v1496;
  v1 = -13944;
  do
  {
