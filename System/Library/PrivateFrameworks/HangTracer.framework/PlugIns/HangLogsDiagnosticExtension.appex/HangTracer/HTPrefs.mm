...
- (HTPrefInit)prefInitList
{
  ...
  if (!result)
  {
    ...
    *&result[12].var2.var0 = xmmword_100017DC0;
...
LABEL_11:
    ...
    CFPreferencesSetValue(@"HangTracerInternalSettingsVersion", &off_100027A98, self->__htTaskingDomain, @"mobile", kCFPreferencesAnyHost);
  }
...
- (void)setupPrefsWithQueue:(id)a3 profilePath:(id)a4 taskingDomainName:(__CFString *)a5 hangtracerDomain:(__CFString *)a6 setupInternalPrefs:(BOOL)a7
{
  ...
  *buf = 0;
  ...
  notify_register_dispatch(EPL_STATE_CHANGED_NOTIFICATION[0], v30 + 6, self->__prefsQueue, v18);
  notify_register_dispatch(HANGTRACER_TASKING_CHANGED_NOTIFICATION[0], v42 + 6, self->__prefsQueue, v18);
  notify_register_dispatch(HANGTRACER_TELEMETRY_CHANGED_NOTIFICATION[0], v38 + 6, self->__prefsQueue, v18);
  notify_register_dispatch(HANGTRACER_PROFILE_LIST_CHANGED_NOTIFICATION[0], v34 + 6, self->__prefsQueue, v18);
