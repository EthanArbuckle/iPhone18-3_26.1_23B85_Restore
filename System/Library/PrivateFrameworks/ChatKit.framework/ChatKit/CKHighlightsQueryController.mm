...
- (id)fetchAttributes
{
  ...
  v9[12] = *MEMORY[0x1E6964C38];
  v7 = [MEMORY[0x1E695DEC8] arrayWithObjects:v9 count:13];
...
- (id)queryAttributesForText:(id)text
{
  ...
  if ([text length])
  {
    ...
    v15 = *MEMORY[0x1E69649F8];
    v16 = v4;
    v17 = *MEMORY[0x1E6964BB0];
  ...
  v9 = [v5 arrayWithObjects:v6 count:{v7, v11, v12, v13, v14, v15, v16, v17}];
...
- (id)filterQueries
{
  ...
  {
    [MEMORY[0x1E696AEC0] stringWithFormat:@"%@ == %@", *MEMORY[0x1E69645D0], @"lnk", v10, v11];
  }
  v6 = ;
  v7 = [MEMORY[0x1E696AEC0] stringWithFormat:@"%@ == %@ || %@ == %@", *MEMORY[0x1E6964B98], v2, *MEMORY[0x1E6964B98], v3];
  v12[0] = v7;
  v12[1] = v6;
  ...
  if (v6)
  {
    ...
    do
    {
      for (i = 0; i != v6; ++i)
      {
        ...
        v9 = [MEMORY[0x1E696AEC0] stringWithFormat:@"kMDItemAccountIdentifier == %@ || _kMDItemDomainIdentifier == %@", *(*(&v19 + 1) + 8 * i), *(*(&v19 + 1) + 8 * i)];
        [v4 addObject:v9];
      }
...
void __64__CKHighlightsQueryController_detailsFilterQueriesForChatGUIDs___block_invoke(uint64_t a1, uint64_t a2, uint64_t a3)
{
  v4 = *(*(a1 + 32) + 8);
  v5 = *(v4 + 40);
  if (a3)
...
- (id)createFoundItemsHandler
{
  ...
  v4[1] = 3221225472;
  v4[2] = __54__CKHighlightsQueryController_createFoundItemsHandler__block_invoke;
  v4[3] = &unk_1E72EEDA0;
...
void __54__CKHighlightsQueryController_createFoundItemsHandler__block_invoke(uint64_t a1, void *a2)
{
