...
- (CKGradientView)initWithFrame:(CGRect)frame;
- (UIImage)gradient;
- (id)description;
...
- (id)description
{
  ...
  referenceView = [(CKGradientView *)self referenceView];
  v6 = [v3 stringWithFormat:@"%@ referenceView:%@", v4, referenceView];
...
- (CKGradientView)initWithFrame:(CGRect)frame
{
  ...
  v3 = [(CKGradientView *)&v9 initWithFrame:frame.origin.x, frame.origin.y, frame.size.width, frame.size.height];
  if (v3)
  {
    ...
    layer2 = [(CKGradientView *)v3 layer];
    CATransform3DMakeScale(&v8, -1.0, -1.0, 1.0);
    [layer setSublayerTransform:&v8];
    [(CKGradientView *)v3 setTrackingLayer:layer];
...
- (void)layoutSubviews
{
  ...
  superview = [(CKGradientView *)self superview];
  referenceView = [(CKGradientView *)self referenceView];
  window = [(CKGradientView *)self window];
  trackingLayer = window;
  if (!window || !superview)
  {
    goto LABEL_8;
  }
    ...
    if (!CGRectIsEmpty(v49))
    {
      ...
      if (!CGRectIsEmpty(v50))
      {
        ...
        if (!CGRectIsEmpty(v51))
        {
          ...
          maskImage = [(CKGradientView *)self maskImage];
          [v27 extraInsetsForImage:maskImage];
          v38 = v30;
          v39 = v29;
          v40 = v32;
          v41 = v31;
          ...
          trackingLayer = [(CKGradientView *)self trackingLayer];
          [trackingLayer setBounds:{0.0, 0.0, v37, v14 / v44 * (v26 / v44)}];
          v52.origin.x = v8;
          v52.origin.y = v10;
          v52.size.width = v12;
          v52.size.height = v14;
          ...
          v53.size.width = v12;
          v53.size.height = v14;
          [trackingLayer setPosition:{MidX, CGRectGetMidY(v53)}];
          CATransform3DMakeScale(&v47, -v45, -v44, 1.0);
          [trackingLayer setTransform:&v47];
          gradientLayer = [(CKGradientView *)self gradientLayer];
          [gradientLayer setContentsRect:{-v42 / v45 - v37 * (v38 / v12 + 1.0), -v43 / v44 - v14 / v44 * (v26 / v44) * (v39 / v14 + 1.0), v37 * (1.0 - (v38 + v40) / v12), v14 / v44 * (v26 / v44) * (1.0 - (v39 + v41) / v14)}];
          v35 = MEMORY[0x1E6979398];
          maskImage2 = [(CKGradientView *)self maskImage];
          [v35 boundsForMaskImage:maskImage2 withOriginalSize:{v12, v14}];
          [gradientLayer setBounds:?];

          CATransform3DMakeScale(&v46, 1.0 / v45, 1.0 / v44, 1.0);
          CATransform3DTranslate(&v47, &v46, v38, v39, 0.0);
          [gradientLayer setTransform:&v47];
...
- (void)_checkForInvalidLayoutIfNeeded
{
  ...
  if ([mEMORY[0x1E69A60F0] isInternalInstall])
  {
    ...
    if (superview)
    {
      ...
      maskImage = [(CKGradientView *)self maskImage];
      [(CKGradientView *)self bounds];
      [v4 boundsForMaskImage:maskImage withOriginalSize:{v6, v7}];
      v9 = v8;
      v11 = v10;
      ...
      if (v14 != *MEMORY[0x1E695F060] || v16 != *(MEMORY[0x1E695F060] + 8))
      {
        ...
        v21 = v20 * 0.5;
        v22 = v19 < v20 * 0.5;
        superview2 = [(CKGradientView *)self superview];
        [superview2 bounds];
...
- (void)_removeAllAnimations:(BOOL)animations
{
  layer = [(CKGradientView *)self layer];
...
- (void)updateAnimation
{
  ...
  gradientLayer = [(CKGradientView *)self gradientLayer];
  [gradientLayer removeAnimationForKey:@"matchmove"];
  superview = [(CKGradientView *)self superview];
  referenceView = [(CKGradientView *)self referenceView];
  window = [(CKGradientView *)self window];
  if (window && superview)
  {
    ...
    if (referenceView)
    {
      ...
      [gradientLayer addAnimation:v7 forKey:@"matchmove"];
    }
  }
...
- (void)updateGradientImage
{
  ...
  [MEMORY[0x1E6979518] setDisableActions:1];
  gradientLayer = [(CKGradientView *)self gradientLayer];
  gradient = [(CKGradientView *)self gradient];
  [gradientLayer setContents:{objc_msgSend(gradient, "CGImage")}];
...
- (UIImage)gradient
{
  ...
  colors = [(CKGradientView *)self colors];
  referenceView = [(CKGradientView *)self referenceView];
  v5 = referenceView;
  v6 = 0;
  if (colors && referenceView)
  {
    if (gradient_once != -1)
    {
    ...
    if (CurrentContext)
    {
      ...
      if (v6)
      {
        [v12 setObject:v6 forKey:colors];
      }
