...
- (id)description
{
  ...
  v5 = [(IXRefreshContainerOptions *)self reason];
  v6 = [NSString stringWithFormat:@"<%@<%p> : %@ containerTypes=%lx allowRefreshDuringPostProcessing=%d forceTerminateApp=%d>", v4, self, v5, [(IXRefreshContainerOptions *)self containerTypes], [(IXRefreshContainerOptions *)self allowRefreshDuringPostProcessing], [(IXRefreshContainerOptions *)self forceTerminateApp]];
