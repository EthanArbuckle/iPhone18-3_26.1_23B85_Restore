...
- (void)encodeWithCoder:(id)coder
{
  ...
  v5 = [NSNumber numberWithUnsignedInteger:[(IXRefreshContainerOptions *)self containerTypes]];
...
- (id)description
{
  ...
  reason = [(IXRefreshContainerOptions *)self reason];
  v6 = [NSString stringWithFormat:@"<%@<%p> : %@ containerTypes=%lx allowRefreshDuringPostProcessing=%d forceTerminateApp=%d>", v4, self, reason, [(IXRefreshContainerOptions *)self containerTypes], [(IXRefreshContainerOptions *)self allowRefreshDuringPostProcessing], [(IXRefreshContainerOptions *)self forceTerminateApp]];
