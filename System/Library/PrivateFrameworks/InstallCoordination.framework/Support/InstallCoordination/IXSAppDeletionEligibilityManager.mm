...
- (void)_onQueue_setRemovabilityForAppWithIdentity:(id)a3 usingEligibilityAnswer:(unint64_t)a4
{
  ...
  v15 = 0;
  v12 = [v11 setRemovability:v8 forAppWithIdentity:v6 byClient:4 error:&v15];
  v13 = v15;
...
{
  v3 = objc_opt_new();
  v4 = [(IXSAppDeletionEligibilityManager *)self _systemAppPlaceholderEnumerator];
  v20 = 0u;
  v21 = 0u;
  v22 = 0u;
  v23 = 0u;
    ...
    *&v6 = 136315650;
    ...
    do
    {
      for (i = 0; i != v7; i = i + 1)
      {
        ...
        v10 = *(*(&v20 + 1) + 8 * i);
        v11 = [v10 eligibilityDeletionDomain];
        if (v11)
        {
...
- (void)_onQueue_processEligibilityDomainChange
{
  ...
  v14 = 0x2020000000;
  v15 = 0;
  v4 = [(IXSAppDeletionEligibilityManager *)self _domainToAppIdentitySetMap];
  v5 = [(IXSAppDeletionEligibilityManager *)self domainToEligibilityAnswerMap];
  ...
  if (*(v13 + 24) == 1)
  {
    ...
    {
      v8 = [(IXSAppDeletionEligibilityManager *)self domainToEligibilityAnswerMap];
      *buf = 136315394;
...
{
  v4 = a3;
  v5 = [(IXSAppDeletionEligibilityManager *)self internalQueue];
  ...
  if (v8)
  {
    v10 = [v4 eligibilityDeletionDomain];
    v11 = v10;
    if (v10)
    {
      v12 = -[IXSAppDeletionEligibilityManager _eligibilityAnswerForDomain:](self, "_eligibilityAnswerForDomain:", [v10 longLongValue]);
      if (v12)
      {
        v13 = v12;
        v14 = [NSNumber numberWithLongLong:v12];
        v15 = [(IXSAppDeletionEligibilityManager *)self domainToEligibilityAnswerMap];
...
- (void)reconcileAppRemovabilityForSystemAppPlaceholders
{
  ...
  v4 = [(IXSAppDeletionEligibilityManager *)self internalQueue];
