...
+ (void)configureInterface:(id)a3
{
  ...
  [v4 setClasses:v27 forSelector:sel__remote_IXSCoordinatedAppInstall_setDataImportPromiseUUIDs_completion_ argumentIndex:1 ofReply:0];

  v28 = MEMORY[0x1E695DFD8];
  v29 = objc_opt_class();
  v30 = objc_opt_class();
  v31 = [v28 setWithObjects:{v29, v30, objc_opt_class(), 0}];
  [v4 setClasses:v31 forSelector:sel__remote_IXSCoordinatedAppInstall_getInitialODRAssetPromises_ argumentIndex:0 ofReply:1];

  v32 = MEMORY[0x1E695DFD8];
  v33 = objc_opt_class();
  v34 = objc_opt_class();
  v35 = [v32 setWithObjects:{v33, v34, objc_opt_class(), 0}];
  [v4 setClasses:v35 forSelector:sel__remote_IXSCoordinatedAppInstall_getEssentialAssetPromises_ argumentIndex:0 ofReply:1];

  v36 = MEMORY[0x1E695DFD8];
  v37 = objc_opt_class();
  v38 = objc_opt_class();
  v39 = [v36 setWithObjects:{v37, v38, objc_opt_class(), 0}];
  [v4 setClasses:v39 forSelector:sel__remote_IXSCoordinatedAppInstall_getDataImportPromises_ argumentIndex:0 ofReply:1];

  v40 = MEMORY[0x1E695DFD8];
  v41 = objc_opt_class();
  v42 = [v40 setWithObjects:{v41, objc_opt_class(), 0}];
  [v4 setClasses:v42 forSelector:sel__remote_IXSPlaceholder_setAppExtensionPlaceholderPromiseUUIDs_completion_ argumentIndex:1 ofReply:0];

  v43 = MEMORY[0x1E695DFD8];
  v44 = objc_opt_class();
  v45 = [v43 setWithObjects:{v44, objc_opt_class(), 0}];
  [v4 setClasses:v45 forSelector:sel__remote_IXSPlaceholder_getAppExtensionPlaceholderPromises_ argumentIndex:0 ofReply:1];

  v46 = MEMORY[0x1E695DFD8];
  v47 = objc_opt_class();
  v48 = objc_opt_class();
  v49 = [v46 setWithObjects:{v47, v48, objc_opt_class(), 0}];
  [v4 setClasses:v49 forSelector:sel__remote_removabilityDataWithCompletion_ argumentIndex:0 ofReply:1];

  v50 = [MEMORY[0x1E695DFD8] setWithObjects:{objc_opt_class(), 0}];
  [v4 setClasses:v50 forSelector:sel__remote_defaultAppMetadataForAppIdentity_completion_ argumentIndex:0 ofReply:1];

  v51 = MEMORY[0x1E695DFD8];
  v52 = objc_opt_class();
  v53 = [v51 setWithObjects:{v52, objc_opt_class(), 0}];
  [v4 setClasses:v53 forSelector:sel__remote_defaultAppMetadataListWithCompletion_ argumentIndex:0 ofReply:1];
  ...
  [v4 setClasses:v58 forSelector:sel__remote_stagingLocationForInstallLocation_completion_ argumentIndex:0 ofReply:0];

  v59 = MEMORY[0x1E695DFD8];
  v60 = objc_opt_class();
  v61 = [v59 setWithObjects:{v60, objc_opt_class(), 0}];
  [v4 setClasses:v61 forSelector:sel__remote_setKnownOSModuleURLs_options_completion_ argumentIndex:0 ofReply:0];
}
