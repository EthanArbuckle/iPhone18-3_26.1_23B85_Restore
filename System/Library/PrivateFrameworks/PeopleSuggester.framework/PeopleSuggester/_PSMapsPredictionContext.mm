...
- (_PSMapsPredictionContext)initWithCoder:(id)coder;
...
- (_PSMapsPredictionContext)initWithCoder:(id)coder
{
  ...
  if (v5)
  {
    ...
    v10 = [coderCopy decodeObjectOfClass:objc_opt_class() forKey:@"navigationStartLocationId"];
    navigationStartLocationId = v5->_navigationStartLocationId;
    v5->_navigationStartLocationId = v10;

    v12 = [coderCopy decodeObjectOfClass:objc_opt_class() forKey:@"navigationEndLocationId"];
    ...
    v17 = [coderCopy decodeObjectOfClasses:v16 forKey:@"seedContactIdentifiers"];
...
- (void)encodeWithCoder:(id)coder
{
  ...
  [coderCopy encodeObject:self->_navigationStartLocationId forKey:@"navigationStartLocationId"];
  [coderCopy encodeObject:self->_navigationEndLocationId forKey:@"navigationEndLocationId"];
