...
- (void)generatePersonalizedReflectionPromptWithSystemPrompt:(id)prompt input:(id)input completion:(id)completion
{
  ...
  *(v17 + 16) = v10;
  ...
  v19[9] = v17;
  _sScTss5NeverORs_rlE4name8priority9operationScTyxABGSSSg_ScPSgxyYaYAcntcfCyt_Tt2g5(0, 0, v9, &closure #1 in PersonalizedReflectionPromptGenerator.generatePersonalizedReflectionPrompt(systemPrompt:input:completion:)partial apply, v19);
}
