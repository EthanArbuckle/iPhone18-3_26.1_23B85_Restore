...
- (MTIDSecret)init
{
  [MEMORY[0x277CBEAD8] raise:@"NotImplemented" format:@"Use initWithScheme:date: instead"];
...
- (id)debugInfo
{
  ...
  v9 = [MEMORY[0x277CCABB0] numberWithBool:{-[MTIDSecret isSynchronized](self, "isSynchronized")}];
