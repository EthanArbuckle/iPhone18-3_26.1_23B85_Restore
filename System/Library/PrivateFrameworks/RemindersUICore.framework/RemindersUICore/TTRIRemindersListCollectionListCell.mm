...
- (_TtC15RemindersUICore35TTRIRemindersListCollectionListCell)initWithCoder:(id)coder;
- (_TtC15RemindersUICore35TTRIRemindersListCollectionListCell)initWithFrame:(CGRect)frame;
...
- (_TtC15RemindersUICore35TTRIRemindersListCollectionListCell)initWithCoder:(id)coder
{
  *(&self->super.super.super.super.super.super.isa + OBJC_IVAR____TtC15RemindersUICore35TTRIRemindersListCollectionListCell_lastAppliedBackground) = 4;
  ...
  coderCopy = coder;
  v5 = [(TTRIRemindersListCollectionListCell *)&v7 initWithCoder:coderCopy];
