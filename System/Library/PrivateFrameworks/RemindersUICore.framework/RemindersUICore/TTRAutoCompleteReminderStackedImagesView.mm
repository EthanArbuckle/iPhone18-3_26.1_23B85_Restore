...
- (_TtC15RemindersUICore40TTRAutoCompleteReminderStackedImagesView)initWithCoder:(id)coder
{
  ...
  *(&self->super.super.super.super.super.isa + v4) = sub_21DAA1C64();
  v5 = OBJC_IVAR____TtC15RemindersUICore40TTRAutoCompleteReminderStackedImagesView_secondImageView;
  *(&self->super.super.super.super.super.isa + v5) = sub_21DAA1C64();
