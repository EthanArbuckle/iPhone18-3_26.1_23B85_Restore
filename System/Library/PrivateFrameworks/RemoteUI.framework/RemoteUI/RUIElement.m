...
- (BOOL)_isAppInstalledWithIdentifier:(id)a3;
- (BOOL)_loadSystemImageFromIconServicesWithName:(id)a3 symbolColor:(id)a4 enclosureColor:(id)a5;
- (BOOL)hasImage;
...
- (unint64_t)_horizontalAlignmentForString:(id)a3;
- (void)_loadImageWithIcon:(id)a3 descriptor:(id)a4;
...
- (OpaqueJSClass)_JSClass
{
  ...
  else
  {
    ...
    *&v30->attributes = 0;
    ...
    v31 = [MEMORY[0x277CCAE60] valueWithPointer:v9];
    v32 = _JSClass_cache;
    v33 = objc_opt_class();
...
LABEL_6:
    v16 = [v10 allKeys];
    v17 = [v16 sortedArrayUsingComparator:&__block_literal_global_8];
    ...
    if (v18)
    {
      ...
      while (2)
      {
        for (i = 0; i != v19; ++i)
        {
          ...
          v22 = *(*(&v33 + 1) + 8 * i);
          v23 = [v10 objectForKeyedSubscript:{v22, v31}];
...
LABEL_22:
  if ([v15 length])
  {
    ...
    if (v28)
    {
      [MEMORY[0x277CBEBC0] URLWithString:v27 relativeToURL:v28];
    }
...
- (id)_symbolConfigurationWithRenderingMode:(id)a3 tintColor:(id)a4
{
  ...
  {
    v7 = [MEMORY[0x277D755D0] configurationWithHierarchicalColor:v6];
LABEL_3:
    v8 = v7;
    goto LABEL_6;
  }

  if (![v5 isEqualToString:@"palette"])
  {
...
- (id)systemImageNamed:(id)a3 symbolRenderingMode:(id)a4 tintColor:(id)a5
{
  ...
  if (a5)
  {
    ...
    v12 = [v7 _systemImageNamed:v10 withConfiguration:v11];
  }
  ...
  else
  {
    ...
    v15 = a3;
    v11 = [v13 tintColor];
    v10 = [(RUIElement *)self _symbolConfigurationWithRenderingMode:v14 tintColor:v11];

    v12 = [v7 _systemImageNamed:v15 withConfiguration:v10];
  }
...
- (id)customSymbolImageNamed:(id)a3 symbolRenderingMode:(id)a4 tintColor:(id)a5
{
  ...
  if (v7)
  {
    v13 = [(RUIElement *)self _symbolConfigurationWithRenderingMode:v12 tintColor:v7];
    v14 = [v8 imageNamed:v10 inBundle:v11 withConfiguration:v13];
  }

  else
  {
    v13 = [MEMORY[0x277D75348] tintColor];
    v15 = [(RUIElement *)self _symbolConfigurationWithRenderingMode:v12 tintColor:v13];
    v14 = [v8 imageNamed:v10 inBundle:v11 withConfiguration:v15];
...
- (BOOL)loadImageFromBundleIdentifier
{
  ...
  if (v3 && [(RUIElement *)self _isAppInstalledWithIdentifier:v3])
  {
    ...
    v5 = [(RUIElement *)self _imageDescriptor];
    [(RUIElement *)self _loadImageWithIcon:v4 descriptor:v5];
...
- (BOOL)_loadSystemImageFromIconServicesWithName:(id)a3 symbolColor:(id)a4 enclosureColor:(id)a5
{
  ...
  if (v8)
  {
    v13 = [objc_alloc(MEMORY[0x277D1B148]) initWithCGColor:{objc_msgSend(v8, "CGColor")}];
    v28[0] = v13;
  ...
  if (v9)
  {
    v15 = [objc_alloc(MEMORY[0x277D1B148]) initWithCGColor:{objc_msgSend(v9, "CGColor")}];
    v27 = v15;
    v16 = [MEMORY[0x277CBEA60] arrayWithObjects:&v27 count:1];
    [v12 setEnclosureColors:v16];
  }

  v17 = [objc_alloc(MEMORY[0x277D1B1B0]) initWithSymbolName:v11 configuration:v12];
...
- (id)image:(id)a3 size:(CGSize)a4
{
  ...
  width = a4.width;
  v6 = a3;
  if (!v6 || (width == *MEMORY[0x277CBF3A8] ? (v7 = height == *(MEMORY[0x277CBF3A8] + 8)) : (v7 = 0), v7))
  {
    v10 = 0;
  }
...
LABEL_8:
  v13 = [v4 notificationCenter];
  v14 = RUIImageLoaderDidLoadImageNotification;
  v15 = [v3 absoluteString];
  v16 = [(__CFString *)v14 stringByAppendingString:v15];
...
- (void)configureAccessiblityWithTarget:(id)a3
{
  ...
  v6 = [v5 objectForKeyedSubscript:@"accessibilityIdentifier"];
  v7 = v6;
  if (v6)
  {
    v8 = v6;
...
{
  v2 = self;
  v3 = [(RUIElement *)v2 sourceXMLElement];
  if (v3)
  {
    v4 = v3;
    v5 = [(RUIXMLElement *)v3 name];
  ...
  [(RUIElement *)v2 reportInternalRenderEventWithElementName:v6 deprecated:[(RUIElement *)v2 isDeprecatedForInternalAnalytics]];
}
