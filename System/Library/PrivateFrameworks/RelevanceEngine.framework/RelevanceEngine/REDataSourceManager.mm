...
+ (BOOL)_isPrioritizedDataSourceClass:(Class)a3
{
  v4 = [a1 _prioritizedDataSourceClasses];
...
- (REDataSourceManager)initWithRelevanceEngine:(id)a3 dataSourceLoader:(id)a4 withDelegate:(id)a5
{
  ...
  v11 = [(RERelevanceEngineSubsystem *)&v65 initWithRelevanceEngine:v8];
  if (v11)
  {
    ...
    v11->_dataSourceControllers = v14;
    ...
    objc_storeStrong(&v11->_loader, a4);
...
- (void)_updatePreferences
{
  ...
  if (v4)
  {
    v5 = [v4 disabledDataSourceIdentifiers];
    v6 = [v4 mode] & 1;
    v7 = ~([v4 mode] >> 1) & 1;
...
- (void)resume
{
  ...
  v12 = [(RERelevanceEngineSubsystem *)self queue];
...
- (void)_queue_loadDataSourceWithIdentifier:(id)a3
{
  ...
  if (v18)
  {
    ...
    if (v4)
    {
      v5 = [(NSDictionary *)self->_identifierDataSourceMap objectForKeyedSubscript:v18];
      ...
      if (v6)
      {
        v9 = [(REElementDataSourceController *)v7 initWithRelevanceEngine:v8 dataSource:v6];
      }

      else
      {
        v9 = [(REElementDataSourceController *)v7 initWithRelevanceEngine:v8 dataSourceClass:v5];
      }

      v10 = v9;

      v11 = [(RERelevanceEngineSubsystem *)self isRunning];
...
- (void)_queue_unloadDataSourceWithIdentifier:(id)a3
{
  ...
  if (v4)
  {
    ...
    if (v23[3] != 0x7FFFFFFFFFFFFFFFLL)
    {
      ...
      v8 = [v14[5] elementOperationQueue];
      v12[0] = MEMORY[0x277D85DD0];
      v12[1] = 3221225472;
      ...
      v9 = [(REDataSourceManager *)self currentDataSourceIdentifiers];
      v10 = [v9 mutableCopy];
...
- (BOOL)_isApplicationRemovedOrRestrictedForIdentifier:(id)a3
{
  ...
  {
    v4 = [(NSDictionary *)self->_identifierApplicationIdentifierMap objectForKeyedSubscript:a3];
    v5 = v4;
    if (v4)
    {
...
- (void)_queue_updateAvailableDataSourceIdentifiers
{
  ...
  v15 = 0u;
  v16 = 0u;
  v4 = [(NSDictionary *)self->_identifierDataSourceMap allKeys];
  ...
  v10 = [(REDataSourceManager *)self availableDataSourceIdentifiers];
...
- (NSSet)unrestirctedDataSourceIdentifiers
{
  ...
  v3 = [(NSDictionary *)self->_identifierDataSourceMap allKeys];
...
- (id)elementGroupForIdentifier:(id)a3
{
  v33 = *MEMORY[0x277D85DE8];
  v4 = a3;
  v5 = [(REConcurrentDictionary *)self->_elementGroupMap objectForKeyedSubscript:v4];
  if (v5)
  {
    v6 = v5;
    ...
    if (v10)
    {
      ...
      do
      {
        ...
        do
        {
          ...
          v6 = [*(*(&v28 + 1) + 8 * v14) elementGroupWithIdentifier:{v4, v26}];
          ...
          if (v17)
          {
            if (v6)
            {
              [*(&v27->super.super.isa + v26) setObject:v6 forKeyedSubscript:v4];
              goto LABEL_17;
            }
          }
