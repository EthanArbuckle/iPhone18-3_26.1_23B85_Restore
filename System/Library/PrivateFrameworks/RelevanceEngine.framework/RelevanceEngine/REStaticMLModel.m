...
- (float)_relevanceForFeatureMap:(id)a3
{
  ...
  if (v7 <= 0.0)
  {
    ...
    v20 = [v3 hasValueForFeature:v19];

    if (v20)
    {
      v21 = +[REFeature locationFeature];
      v22 = [v3 valueForFeature:v21];
    ...
    v27 = [v3 hasValueForFeature:v26];

    if (v27)
    {
      v28 = +[REFeature geofenceFeature];
      v29 = [v3 valueForFeature:v28];
    ...
    v32 = [v3 hasValueForFeature:v31];

    if (v32)
    {
      v33 = +[REFeature conditionalFeature];
      v34 = [v3 valueForFeature:v33];
