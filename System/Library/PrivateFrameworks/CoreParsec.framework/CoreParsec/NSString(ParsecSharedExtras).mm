...
- (id)parsec_readableURLStringAfterRemovingSubdomains
{
  ...
  {
    v9 = [self rangeOfString:@":" options:4 range:{v3, v5}];
    if (v9 != 0x7FFFFFFFFFFFFFFFLL)
    {
      v10 = v9;
      v11 = v3 + v5 - v9;
      if ([self rangeOfString:@"]" options:0 range:{v9, v11}] == 0x7FFFFFFFFFFFFFFFLL)
      {
  ...
  {
    parsec_getHighLevelDomainFromHost = [v13 parsec_getHighLevelDomainFromHost];
    v16 = [v13 isEqualToString:parsec_getHighLevelDomainFromHost];
...
- (BOOL)parsec_hasLocalizedCaseInsensitivePrefix:()ParsecSharedExtras
{
  v4 = a3;
  v5 = v4;
  if (v4 && (v6 = [v4 length], v6 <= objc_msgSend(self, "length")))
  {
    currentLocale = [MEMORY[0x1E695DF58] currentLocale];
    v7 = [self compare:v5 options:1 range:0 locale:{v6, currentLocale}] == 0;
  }
