...
- (void)performOperation
{
  v3 = [(NSSNewsAnalyticsSubmitEnvelopesOperation *)self envelopes];
  ...
  if ([v3 count])
  {
    ...
    [MEMORY[0x277D2F918] registerEnvelopesAsSubmittedToUploader:v3];
  }
...
- (void)operationDidFinishWithError:(id)a3
{
  ...
  if (v4)
  {
    v5 = [(NSSNewsAnalyticsSubmitEnvelopesOperation *)self submissionCompletion];
    (v5)[2](v5, v6);
  }
}
