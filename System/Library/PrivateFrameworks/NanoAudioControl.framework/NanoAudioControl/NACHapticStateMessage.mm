...
- (id)description
{
  ...
  v8.receiver = self;
  v8.super_class = NACHapticStateMessage;
  v4 = [(NACHapticStateMessage *)&v8 description];
  dictionaryRepresentation = [(NACHapticStateMessage *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  if (*&self->_has)
  {
    v4 = [MEMORY[0x277CCABB0] numberWithInt:self->_state];
