...
void PartitionStore<vi_onefixedsize_disk_allocator,512>::PartitionStore<vi_onefixedsize_disk_allocator>(uint64_t a1, uint64_t a2, uint64_t *a3)
{
  ...
  *(a1 + 160) = 0;
  ...
  if (!*a2)
  {
    ...
    __message_assert("%s:%u: failed assertion '%s' %s ", "IVFVectorIndex.hh", 1179, "meta.fdPtr != nullptr", v25);
LABEL_32:
    free(v22);
    if (__valid_fs(-1))
    {
  ...
  *&v28.__r_.__value_.__l.__data_ = *&v10->__r_.__value_.__l.__data_;
  ...
  v14 = std::string::append(&v28, v12, size);
  v15 = v14->__r_.__value_.__r.__words[2];
  *&v29.__r_.__value_.__l.__data_ = *&v14->__r_.__value_.__l.__data_;
  v29.__r_.__value_.__r.__words[2] = v15;
  v14->__r_.__value_.__l.__size_ = 0;
  v14->__r_.__value_.__r.__words[2] = 0;
  v14->__r_.__value_.__r.__words[0] = 0;
  v16 = std::string::append(&v29, ")");
  v17 = v16->__r_.__value_.__r.__words[0];
  v30[0] = v16->__r_.__value_.__l.__size_;
  *(v30 + 7) = *(&v16->__r_.__value_.__r.__words[1] + 7);
...
LABEL_26:
    ...
    __message_assert("%s:%u: failed assertion '%s' %s ", "IVFVectorIndex.hh", 1181, "meta.newFile", v23);
    goto LABEL_32;
  }
...
uint64_t IVFVectorIndexen<vi_onefixedsize_disk_allocator,vi_disk_postings>::IVFVectorIndexInstance<float,768>::status(uint64_t a1, uint64_t a2)
{
  ...
  *__p = 0u;
  ...
  IVFVectorIndexTemplate<float,768>::IVFVectorIndexRoot_s<vi_onefixedsize_disk_allocator,vi_disk_postings>::getPartitions(a1 + 48, &v28);
  if (v28)
  {
    IVFVectorIndexTemplate<float,768>::IVFVectorIndexRoot_s<vi_onefixedsize_disk_allocator,vi_disk_postings>::getPartitions(a1 + 48, &v26);
...
LABEL_121:
  ...
  *__error() = v42;
  ...
  v100[1] = 1174405120;
  v100[2] = ___ZNK22IVFVectorIndexTemplateIfLi768EE20IVFVectorIndexRoot_sI30vi_onefixedsize_disk_allocator16vi_disk_postingsE3aNNERK10CIVector_sIfLi768EEfbP20MaxSizePriorityQueueINS0_18candidate_result_sIS3_EENSt3__16vectorISB_NSC_9allocatorISB_EEEENSC_4lessISB_EEEj_block_invoke;
  v100[3] = &unk_1F4280F08;
  v100[6] = a1;
  v100[7] = a2;
  v100[4] = &v115;
...
void ___ZNK22IVFVectorIndexTemplateIfLi768EE20IVFVectorIndexRoot_sI30vi_onefixedsize_disk_allocator16vi_disk_postingsE3aNNERK10CIVector_sIfLi768EEfbP20MaxSizePriorityQueueINS0_18candidate_result_sIS3_EENSt3__16vectorISB_NSC_9allocatorISB_EEEENSC_4lessISB_EEEj_block_invoke(uint64_t a1, uint64_t a2, unsigned int *a3)
{
  ...
  v13 = 1;
  vDSP_distancesq(v12, 1, v11, 1, &v32, 0x300uLL);
  v14 = *&v32;
  v15 = *(v11 + 3080);
  v16 = *(a1 + 72);
  if (v16)
...
void IVFVectorIndexen<vi_onefixedsize_disk_allocator,vi_disk_postings>::IVFVectorIndexInstance<float,768>::aNN(uint64_t a1, int a2, int a3, uint64_t a4, int a5, int a6, uint64_t a7, uint64_t a8, uint64_t a9)
{
  if (*(a1 + 8) == a2 && *(a1 + 20) == a3 && a6 <= 2 && *(a1 + 12) == vector_dimension_vec_sizes_15424[a5] && vector_size_elem_sizes_15423[a6] == *(a1 + 16))
  {
    ...
    v14 = 0x40000000;
    v15 = ___ZNK16IVFVectorIndexenI30vi_onefixedsize_disk_allocator16vi_disk_postingsE22IVFVectorIndexInstanceIfLi768EE3aNNEjtPKv14vec_dimensions15vec_data_formatfjbU13block_pointerFvPvfjE_block_invoke;
    v16 = &unk_1E8195CF8;
    v17 = a9;
    operator new();
  }
...
void IVFVectorIndexen<vi_onefixedsize_disk_allocator,vi_disk_postings>::IVFVectorIndexInstance<float,768>::compactForTest(uint64_t a1, uint64_t a2)
{
...
void IVFVectorIndexTemplate<float,768>::IVFVectorIndexRoot_s<vi_onefixedsize_disk_allocator,vi_disk_postings>::compactForTest<vi_onefixedsize_disk_allocator>(uint64_t a1, uint64_t a2)
{
...
void IVFVectorIndexTemplate<float,768>::IVFVectorIndexRoot_s<vi_onefixedsize_disk_allocator,vi_disk_postings>::train<vi_onefixedsize_disk_allocator>(uint64_t a1, std::__shared_weak_count *a2, void *a3)
{
  ...
  v9 = 0;
  v10 = 0;
  QuantizerManager<float,768>::sharedQuantizer(&v9, a1, 0);
  (*(*v9 + 24))(v9);
  keyExistsAndHasValidFormat[0] = 0;
...
unsigned int *IVFVectorIndexTemplate<float,768>::IVFVectorIndexRoot_s<vi_onefixedsize_disk_allocator,vi_disk_postings>::lookupForInsert(uint64_t a1, unsigned int a2, void *a3, uint64_t a4, char a5, float a6)
{
  ...
  Vector = IVFVectorIndexTemplate<float,768>::IVFVectorIndexRoot_s<vi_onefixedsize_disk_allocator,vi_disk_postings>::findVector(a1, a3, &v126, &v125, a2);
  v9 = v126;
  if (v126 == -1)
  {
LABEL_120:
  ...
  if (v17[770] != a2)
  {
    ...
    *__error() = v19;
    ...
    else
    {
      ...
      {
LABEL_86:
        v80 = data_map_get_data(*(a1 + 144), v17[770], &v124);
        v81 = *__error();
...
void *std::deque<std::shared_ptr<AnyPartitionStore::Enumerator>>::__add_back_capacity(void *a1)
{
  v1 = a1[4];
  v2 = v1 >= 0x100;
  v3 = v1 - 256;
  ...
  v10 = *v4;
  a1[1] = v4 + 1;
  return std::__split_buffer<std::shared_ptr<AnyPartitionStore::Enumerator> *,std::allocator<std::shared_ptr<AnyPartitionStore::Enumerator> *>>::emplace_back<std::shared_ptr<AnyPartitionStore::Enumerator> *&>(a1, &v10);
}

void *std::__split_buffer<std::shared_ptr<AnyPartitionStore::Enumerator> *,std::allocator<std::shared_ptr<AnyPartitionStore::Enumerator> *>>::emplace_back<std::shared_ptr<AnyPartitionStore::Enumerator> *&>(void *result, void *a2)
{
  v3 = result;
  v4 = result[2];
  if (v4 == result[3])
...
void *AnyPartitionStore::candidates(void *this, uint64_t a2, uint64_t a3)
{
  *this = 0;
  this[1] = 0;
  this[2] = 0;
...
void IVFVectorIndexen<vi_onefixedsize_disk_allocator,vi_disk_postings>::IVFVectorIndexInstance<float,768>::compact(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, __int128 *a5)
{
...
uint64_t ___ZNK22IVFVectorIndexTemplateIfLi768EE20IVFVectorIndexRoot_sI30vi_onefixedsize_disk_allocator16vi_disk_postingsE4dumpEbbPViPvU13block_pointerFbjPKvybjfE_block_invoke(uint64_t a1, unsigned int *a2, BOOL *a3)
{
  v5 = a2[2];
  v6 = *(a2 + 2);
  v7 = **(a2 + 3);
...
BOOL IVFVectorIndexTemplate<float,768>::IVFVectorIndexRoot_s<vi_onefixedsize_disk_allocator,vi_disk_postings>::exists(uint64_t a1, uint64_t a2)
{
  ...
  v24 = 3.4028e38;
  v25 = -1;
  Vector = IVFVectorIndexTemplate<float,768>::IVFVectorIndexRoot_s<vi_onefixedsize_disk_allocator,vi_disk_postings>::findVector(a1, a2, &v25, &v24, 0);
  if (Vector == -1)
  {
    v7 = *__error();
    ...
    *&buf[16] = 0x2000000000;
    ...
    v21[1] = 0x40000000;
    v21[2] = ___ZN22IVFVectorIndexTemplateIfLi768EE20IVFVectorIndexRoot_sI30vi_onefixedsize_disk_allocator16vi_disk_postingsE6existsERK10CIVector_sIfLi768EE_block_invoke;
    v21[3] = &unk_1E8195C80;
    v21[5] = a1;
    v21[6] = a2;
    v22 = v25;
    ...
    if (*(*&buf[8] + 24) == -1)
    {
      ...
      v16[1] = 1174405120;
      v16[2] = ___ZN22IVFVectorIndexTemplateIfLi768EE20IVFVectorIndexRoot_sI30vi_onefixedsize_disk_allocator16vi_disk_postingsE6existsERK10CIVector_sIfLi768EE_block_invoke_1732;
      v16[3] = &unk_1F4280ED0;
      v16[5] = a1;
      v16[6] = a2;
      v16[7] = v10;
...
void ___ZN22IVFVectorIndexTemplateIfLi768EE20IVFVectorIndexRoot_sI30vi_onefixedsize_disk_allocator16vi_disk_postingsE6existsERK10CIVector_sIfLi768EE_block_invoke_1732(uint64_t a1, int a2, unsigned int *a3, _BYTE *a4)
{
  ...
  if (!memcmp(v6, v14, 0xC00uLL))
  {
    ...
    *__error() = v32;
    ...
    v41 = _windowsResolvePtr((v36 + 5), v36[3] + v36[2] * v35, 3088);
...
void Quantizer<float,512>::topKPartitions(uint64_t a1@<X0>, const float *a2@<X1>, int a3@<W2>, void *a4@<X8>)
{
  if ((*(*a1 + 24))(a1))
  {
    v8 = 0;
...
void SingleVectorQuantizer<float,512>::topKPartitions(uint64_t a1, const float *__A)
{
  __C = 3.4028e38;
  vDSP_distancesq(__A, 1, (a1 + 33), 1, &__C, 0x200uLL);
  operator new();
}
...
uint64_t IVFVectorIndexen<vi_onefixedsize_disk_allocator,vi_disk_postings>::IVFVectorIndexInstance<float,512>::status(uint64_t a1, uint64_t a2)
{
  ...
  *__p = 0u;
  ...
  v15 = MEMORY[0x1C691FC90](v13, v14);
  std::__put_character_sequence[abi:nn200100]<char,std::char_traits<char>>(v15, "v", 1);
  IVFVectorIndexTemplate<float,512>::IVFVectorIndexRoot_s<vi_onefixedsize_disk_allocator,vi_disk_postings>::getPartitions(a1 + 48, &v28);
  if (v28)
  {
    IVFVectorIndexTemplate<float,512>::IVFVectorIndexRoot_s<vi_onefixedsize_disk_allocator,vi_disk_postings>::getPartitions(a1 + 48, &v26);
    v16 = MEMORY[0x1C691FC80](v15, *(v26 + 76));
    std::__put_character_sequence[abi:nn200100]<char,std::char_traits<char>>(v16, ")", 1);
    v17 = v27;
    if (v27 && !atomic_fetch_add(&v27->__shared_owners_, 0xFFFFFFFFFFFFFFFFLL))
