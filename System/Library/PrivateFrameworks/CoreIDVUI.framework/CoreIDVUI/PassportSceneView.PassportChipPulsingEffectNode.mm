...
- (_TtCC9CoreIDVUI17PassportSceneView29PassportChipPulsingEffectNode)initWithCoder:(id)coder
{
  ...
  *(&self->super.super.isa + v4) = [objc_allocWithZone(MEMORY[0x277CDBAA8]) init];
  *(&self->super.super.isa + OBJC_IVAR____TtCC9CoreIDVUI17PassportSceneView29PassportChipPulsingEffectNode_shouldPlayPulsingAnimation) = 0;
