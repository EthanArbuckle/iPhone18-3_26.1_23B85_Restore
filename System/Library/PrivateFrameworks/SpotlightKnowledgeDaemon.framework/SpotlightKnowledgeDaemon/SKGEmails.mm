...
+ (id)labels
{
  ...
  p_name = &OBJC_PROTOCOL___SKDEventInfo.name;
  {
    ...
    v8[0] = SKGPeopleEmailAddress;
    v7 = [MEMORY[0x277CBEA60] arrayWithObjects:v8 count:1];
    +[SKGEmails labels]::sEmailLabels = [v6 setWithArray:v7];
...
void __47__SKGEmails_enumerateEmailsInGraph_usingBlock___block_invoke(uint64_t a1, void *a2)
{
  v4 = a2;
  v3 = [[SKGEmails alloc] initWithEmailNode:v4 inGraph:*(a1 + 32)];
