...
- (BOOL)convertToEntity:(id *)a3 error:(id *)a4
{
  v8 = objc_msgSend_localizedLabelDictionary(self, a2, a3, a4, v4);
  v71 = 0;
  objc_msgSend_labelDictionaryFromString_directoryWriteBack_error_(CSUSearchableKnowledgeObject, v9, v8, &v71, a4);
  v10 = v71;
  ...
  if (v10)
  {
    ...
    v70 = 0;
    objc_msgSend_synonymsDictionaryFromLocaleString_directoryWriteBack_error_(CSUSearchableKnowledgeObject, v16, v15, &v70, a4);
    v17 = v70;
    ...
    if (a3 && v17)
    {
      ...
      *a3 = objc_msgSend_initWithQID_idType_localizedLabelDictionary_confidence_sensitiveLocation_category_vertical_localizedSynonymsDictionary_longitude_latitude_version_(v69, v66, v23, v28, v10, v39, v44, v49, v34, v55, v61, v17, v68);
    }
  }
...
- (void)copyFromEntity:(id)a3
{
  ...
  v57 = objc_msgSend_category(v4, v53, v54, v55, v56);
  objc_msgSend_setCategory_(self, v58, v57, v59, v60);

  v65 = objc_msgSend_vertical(v4, v61, v62, v63, v64);
