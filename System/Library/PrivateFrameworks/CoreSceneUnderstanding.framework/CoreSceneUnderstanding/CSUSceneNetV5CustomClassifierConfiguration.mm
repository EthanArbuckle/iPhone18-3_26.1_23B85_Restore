...
+ (id)safetyNetLightConfigurationForRevision:(int64_t)a3 error:(id *)a4;
...
+ (id)safetyNetLightConfigurationForRevision:(int64_t)a3 error:(id *)a4
{
  ...
  if (a3 == 1 || a3 == -1)
  {
    ...
    v21 = objc_msgSend_validateAndInitCustomClassifierForRevision_forNetworkPath_forTaxonomyPath_withInputImageTensorName_withVocabularyName_withClassificationTensorName_withIdentifier_error_(a1, v20, 1, v17, v19, @"image_embed_normalize_out", @"leaf", @"safetynet_fc/post_act", 6, a4);
  }

  else
  {
    v22 = MEMORY[0x1E696AEC0];
    v17 = objc_msgSend_numberWithInteger_(MEMORY[0x1E696AD98], v13, a3, v14, v15);
...
+ (id)classifierAlphaConfigurationForRevision:(int64_t)a3 error:(id *)a4
{
  ...
  if (a3 == 1 || a3 == -1)
  {
    ...
    v21 = objc_msgSend_validateAndInitCustomClassifierForRevision_forNetworkPath_forTaxonomyPath_withInputImageTensorName_withVocabularyName_withClassificationTensorName_withIdentifier_error_(a1, v20, 1, v17, v19, @"2590", @"basic", @"events_fc_post_act_1", 1, a4);
  }
...
+ (id)junkLeafConfigurationForRevision:(int64_t)a3 error:(id *)a4
{
  ...
  if (a3 == 1 || a3 == -1)
  {
    ...
    v21 = objc_msgSend_validateAndInitCustomClassifierForRevision_forNetworkPath_forTaxonomyPath_withInputImageTensorName_withVocabularyName_withClassificationTensorName_withIdentifier_error_(a1, v20, 1, v17, v19, @"2593", @"leaf", @"fc_leaf_post_act_1", 2, a4);
  }
...
+ (id)junkHierarchicalConfigurationForRevision:(int64_t)a3 error:(id *)a4
{
  ...
  if (a3 == 1 || a3 == -1)
  {
    ...
    v19 = objc_msgSend_pathForResource_ofType_inDirectory_(v16, v18, @"Junk-v3b_manifest", @"bplist", @"taxonomies/junk/");
    v21 = objc_msgSend_validateAndInitCustomClassifierForRevision_forNetworkPath_forTaxonomyPath_withInputImageTensorName_withVocabularyName_withClassificationTensorName_withIdentifier_error_(a1, v20, 1, v17, v19, @"2593", @"hierarchical", @"fc_hier_post_act_1", 3, a4);
  }
...
+ (id)cityNatureConfigurationForRevision:(int64_t)a3 error:(id *)a4
{
  ...
  if (a3 == 1 || a3 == -1)
  {
    ...
    v21 = objc_msgSend_validateAndInitCustomClassifierForRevision_forNetworkPath_forTaxonomyPath_withInputImageTensorName_withVocabularyName_withClassificationTensorName_withIdentifier_error_(a1, v20, 1, v17, v19, @"2590", @"basic", @"fc_leaf_post_act_1", 4, a4);
  }
...
+ (id)classifierBetaConfigurationForRevision:(int64_t)a3 error:(id *)a4
{
  ...
  if (a3 == 1 || a3 == -1)
  {
    ...
    v21 = objc_msgSend_validateAndInitCustomClassifierForRevision_forNetworkPath_forTaxonomyPath_withInputImageTensorName_withVocabularyName_withClassificationTensorName_withIdentifier_error_(a1, v20, 1, v17, v19, @"2590", @"basic", @"fc_leaf_post_act_1", 5, a4);
LABEL_6:
...
+ (id)validateAndInitCustomClassifierForRevision:(int64_t)a3 forNetworkPath:(id)a4 forTaxonomyPath:(id)a5 withInputImageTensorName:(id)a6 withVocabularyName:(id)a7 withClassificationTensorName:(id)a8 withIdentifier:(int64_t)a9 error:(id *)a10
{
  ...
  if (v16)
  {
    ...
    {
      v24 = [a1 alloc];
      inited = objc_msgSend_initConfigurationForRevision_espressoNetworkPath_inputImageTensorName_vocabularyName_taxonomyPath_identifier_classificationTensorName_(v24, v25, a3, v16, v18, v19, v17, a9, v23);
      goto LABEL_7;
    }
