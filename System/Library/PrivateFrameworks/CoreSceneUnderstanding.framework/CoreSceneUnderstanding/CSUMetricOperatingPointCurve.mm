...
LABEL_18:
  ...
  if ((objc_msgSend_length(v13->_operatingPoints, v16, v17, v18, v19) & 3) != 0)
  {
    if (a5)
    {
      ...
      *a5 = objc_msgSend_errorWithCode_message_(CSUError, v30, 6, v29, v31);
    }
...
LABEL_14:
    if (a5)
    {
      ...
      *a5 = objc_msgSend_errorWithCode_message_(CSUError, v45, 6, v44, v46);
    }
...
- (void)enumerateUsingBlock:(id)a3
{
  ...
  if (!metricPattern)
  {
    ...
    if ((v21 & 1) == 0)
    {
      v4[2](v4, &v21, 0.2, v9[1]);
      if ((v21 & 1) == 0)
      {
        v4[2](v4, &v21, 0.3, v9[2]);
        if ((v21 & 1) == 0)
        {
          v4[2](v4, &v21, 0.4, v9[3]);
          if ((v21 & 1) == 0)
          {
            v4[2](v4, &v21, 0.5, v9[4]);
            if ((v21 & 1) == 0)
            {
              v4[2](v4, &v21, 0.6, v9[5]);
              if ((v21 & 1) == 0)
              {
                v4[2](v4, &v21, 0.7, v9[6]);
                if ((v21 & 1) == 0)
                {
                  v4[2](v4, &v21, 0.8, v9[7]);
                  if ((v21 & 1) == 0)
                  {
                    v4[2](v4, &v21, 0.9, v9[8]);
                  }
                }
              }
            }
  ...
  if (metricPattern == 1)
  {
    ...
    if ((v22 & 1) == 0)
    {
      v4[2](v4, &v22, 1.0, v9[1]);
      if ((v22 & 1) == 0)
      {
        v4[2](v4, &v22, 2.0, v9[2]);
      }
    }
