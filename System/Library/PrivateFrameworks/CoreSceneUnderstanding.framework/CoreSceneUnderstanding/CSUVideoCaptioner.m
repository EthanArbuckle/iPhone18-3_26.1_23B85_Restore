...
- (CSUVideoCaptioner)initWithConfiguration:(id)a3 error:(id *)a4
{
  ...
  v22 = 0;
  v15 = objc_msgSend__initWithConfiguration_error_(self, v13, v6, &v22, v14);
  v16 = v22;
  if (v15)
  {
    v17 = sub_1AC090E50();
...
- (id)_initWithConfiguration:(id)a3 error:(id *)a4
{
  ...
  v14 = objc_msgSend_configPath(v7, v10, v11, v12, v13);
...
LABEL_12:
  ...
  v22 = objc_msgSend_createCSUImageCaptioningDecoderConfigurationWithConfigPath_error_(CSUImageCaptioningDecoderConfiguration, v20, v19, a4, v21);
...
LABEL_11:
  ...
  if (!v9->_imageCaptionDecoder)
  {
    if (a4)
    {
      *a4 = objc_msgSend_errorForUnknownErrorWithLocalizedDescription_(CSUError, v37, @"Failed to init video decoder", v38, v39);
    }
...
{
  v5 = a3;
  v6 = objc_msgSend_imageCaptionDecoder(self, a2, a3, v3, v4);
  LOBYTE(v5) = objc_msgSend_loadResources_(v6, v7, v5, v8, v9);
...
- (id)computeCaptionForVideoEmbedding:(id)a3 error:(id *)a4
{
  ...
  v33 = objc_msgSend_computeDecodedCaptionsForFeatures_withDecodingMethod_error_(v31, v32, v6, v26 != 1, a4);
