...
+ (void)printMLMultiArray:(id)a3
{
  ...
  objc_msgSend_getMutableBytesWithHandler_(v11, v8, &unk_1F20CFFD0, v9, v10);
}
...
LABEL_5:
      if (v25 > 2)
      {
        if (v25 == 3)
        {
          ...
          v212 = objc_msgSend_objectAtIndex_(v6, v22, 1, v23, v24);
          v184 = objc_msgSend_unsignedLongValue(v212, v180, v181, v182, v183);
          v210 = objc_msgSend_objectAtIndex_(v6, v185, 2, v186, v187);
          ...
          v216[0] = v209;
          v208 = objc_msgSend_objectAtIndex_(v6, v196, 2, v197, v198);
          v216[1] = v208;
...
LABEL_18:
        ...
        if (v25 == 4)
        {
          ...
          v210 = objc_msgSend_objectAtIndex_(v6, v43, 2, v44, v45);
          v50 = objc_msgSend_unsignedLongValue(v210, v46, v47, v48, v49);
          v209 = objc_msgSend_objectAtIndex_(v6, v51, 3, v52, v53);
...
LABEL_20:
          ...
          v213 = 0;
          v36 = objc_msgSend_initWithDataPointer_shape_dataType_strides_deallocator_error_(v201, v202, v17, v6, 65568, v35, 0, &v213);
      ...
      v210 = objc_msgSend_objectAtIndex_(v6, v95, 2, v96, v97);
      v102 = objc_msgSend_unsignedLongValue(v210, v98, v99, v100, v101);
      v209 = objc_msgSend_objectAtIndex_(v6, v103, 3, v104, v105);
      v110 = objc_msgSend_unsignedLongValue(v209, v106, v107, v108, v109);
      v208 = objc_msgSend_objectAtIndex_(v6, v111, 4, v112, v113);
      ...
      v206 = objc_msgSend_objectAtIndex_(v6, v123, 2, v124, v125);
      v130 = objc_msgSend_unsignedLongValue(v206, v126, v127, v128, v129);
      v82 = objc_msgSend_objectAtIndex_(v6, v131, 3, v132, v133);
      v138 = objc_msgSend_unsignedLongValue(v82, v134, v135, v136, v137);
      v86 = objc_msgSend_objectAtIndex_(v6, v139, 4, v140, v141);
      ...
      v154 = objc_msgSend_objectAtIndex_(v6, v151, 3, v152, v153);
      v159 = objc_msgSend_unsignedLongValue(v154, v155, v156, v157, v158);
      v163 = objc_msgSend_objectAtIndex_(v6, v160, 4, v161, v162);
      ...
      v214[2] = v172;
      v176 = objc_msgSend_objectAtIndex_(v6, v173, 4, v174, v175);
      v214[3] = v176;
...
+ (id)reshapeMLMultiArray:(id)a3 toShape:(id)a4
{
  ...
  v21 = objc_msgSend_count(v7, v13, v14, v15, v16);
  if (!v21)
  {
    goto LABEL_11;
  }

  v22 = objc_msgSend_shape(v6, v17, v18, v19, v20);
  v25 = objc_msgSend_compareMLMultiArrayShapesForShape1_Shape2_(a1, v23, v22, v7, v24);
  ...
  do
  {
    v32 = objc_msgSend_objectAtIndexedSubscript_(v7, v26, v30, v27, v28);
...
LABEL_11:
  ...
  if (v21 > 2)
  {
    if (v21 == 3)
    {
      ...
      v217 = objc_msgSend_objectAtIndex_(v7, v26, 1, v27, v28);
      v188 = objc_msgSend_unsignedLongValue(v217, v184, v185, v186, v187);
      v215 = objc_msgSend_objectAtIndex_(v7, v189, 2, v190, v191);
      ...
      v233[0] = v214;
      v213 = objc_msgSend_objectAtIndex_(v7, v200, 2, v201, v202);
      v233[1] = v213;
...
LABEL_19:
    ...
    if (v21 == 4)
    {
      ...
      v215 = objc_msgSend_objectAtIndex_(v7, v46, 2, v47, v48);
      v53 = objc_msgSend_unsignedLongValue(v215, v49, v50, v51, v52);
      v214 = objc_msgSend_objectAtIndex_(v7, v54, 3, v55, v56);
...
LABEL_15:
    ...
    v215 = objc_msgSend_objectAtIndex_(v7, v98, 2, v99, v100);
    v105 = objc_msgSend_unsignedLongValue(v215, v101, v102, v103, v104);
    v214 = objc_msgSend_objectAtIndex_(v7, v106, 3, v107, v108);
    v113 = objc_msgSend_unsignedLongValue(v214, v109, v110, v111, v112);
    v213 = objc_msgSend_objectAtIndex_(v7, v114, 4, v115, v116);
    ...
    v211 = objc_msgSend_objectAtIndex_(v7, v126, 2, v127, v128);
    v133 = objc_msgSend_unsignedLongValue(v211, v129, v130, v131, v132);
    v85 = objc_msgSend_objectAtIndex_(v7, v134, 3, v135, v136);
    v141 = objc_msgSend_unsignedLongValue(v85, v137, v138, v139, v140);
    v89 = objc_msgSend_objectAtIndex_(v7, v142, 4, v143, v144);
    ...
    v158 = objc_msgSend_objectAtIndex_(v7, v155, 3, v156, v157);
    v163 = objc_msgSend_unsignedLongValue(v158, v159, v160, v161, v162);
    v167 = objc_msgSend_objectAtIndex_(v7, v164, 4, v165, v166);
    ...
    v231[2] = v176;
    v180 = objc_msgSend_objectAtIndex_(v7, v177, 4, v178, v179);
    v231[3] = v180;
...
LABEL_21:
  ...
  v222 = v229;
  v205 = v39;
  objc_msgSend_getBytesWithHandler_(v6, v206, v218, v207, v208);
  v29 = v224[5];
...
+ (BOOL)compareMLMultiArrayShapesForShape1:(id)a3 Shape2:(id)a4
{
  ...
  if (v11 == objc_msgSend_count(v6, v12, v13, v14, v15))
  {
    ...
    if (v20)
    {
      ...
      do
      {
        v26 = objc_msgSend_objectAtIndexedSubscript_(v5, v21, v24, v22, v23);
        v30 = objc_msgSend_objectAtIndexedSubscript_(v6, v27, v24, v28, v29);
