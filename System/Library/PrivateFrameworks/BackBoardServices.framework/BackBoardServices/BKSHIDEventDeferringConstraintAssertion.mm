...
- (BKSHIDEventDeferringConstraintAssertion)initWithCoder:(id)a3;
- (BOOL)isEqual:(id)a3;
- (id)_init;
...
- (id)_initWithCopyOf:(id *)a1
{
  ...
  if (a1)
  {
    v4 = [(BKSHIDEventDeferringConstraintAssertion *)a1 _init];
    a1 = v4;
    if (v4)
    {
...
- (void)appendDescriptionToStream:(id)a3
{
  ...
  v6 = [v9 appendObject:self->_constraint withName:@"constraint"];
...
- (BKSHIDEventDeferringConstraintAssertion)initWithCoder:(id)a3
{
  ...
  v12 = [v3 decodeObjectOfClass:objc_opt_class() forKey:@"constraint"];
...
{
  v3 = a3;
  v4 = [(BKSHIDEventDeferringConstraintAssertion *)[BKSMutableHIDEventDeferringConstraintAssertion alloc] _init];
  v3[2](v3, v4);
