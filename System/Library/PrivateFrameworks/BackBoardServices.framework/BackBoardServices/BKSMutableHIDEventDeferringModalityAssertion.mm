  ...
  if (!v5)
  {
    ...
    if (os_log_type_enabled(MEMORY[0x1E69E9C10], OS_LOG_TYPE_ERROR))
    {
      ...
      *buf = 138544642;
      ...
      v30 = self;
      v31 = 2114;
      v32 = @"BKSHIDEventDeferringModalityAssertion.m";
      v33 = 1024;
      v34 = 232;
      v35 = 2114;
      v36 = v12;
...
- (void)setModality:(id)a3
{
  ...
  if (!v5)
  {
    ...
    v10 = objc_opt_class();
    v11 = NSStringFromClass(v10);
    v12 = [v9 stringWithFormat:@"Value for '%@' was unexpectedly nil. Expected %@.", @"modality", v11];
  ...
  {
    v16 = MEMORY[0x1E696AEC0];
    v17 = [(BKSHIDEventDeferringModality *)v6 classForCoder];
    if (!v17)
    {
      v17 = objc_opt_class();
    }
    ...
    v19 = objc_opt_class();
    v20 = NSStringFromClass(v19);
    v21 = [v16 stringWithFormat:@"Value for '%@' was of unexpected class %@. Expected %@.", @"modality", v18, v20];
  ...
  else
  {
    ...
    if (v6 != v5)
    {
      ...
      if (os_log_type_enabled(MEMORY[0x1E69E9C10], OS_LOG_TYPE_ERROR))
      {
        ...
        v18 = self;
        v19 = 2114;
        v20 = @"BKSHIDEventDeferringModalityAssertion.m";
        v21 = 1024;
        v22 = 214;
        v23 = 2114;
        v24 = v9;
