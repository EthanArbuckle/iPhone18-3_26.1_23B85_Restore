  ...
  if (!environmentCopy)
  {
    ...
    if (os_log_type_enabled(MEMORY[0x1E69E9C10], OS_LOG_TYPE_ERROR))
    {
      ...
      *buf = 138544642;
      ...
      selfCopy2 = self;
      v31 = 2114;
      v32 = @"BKSHIDEventDeferringChainObserverPredicate.m";
      v33 = 1024;
      v34 = 170;
      v35 = 2114;
      v36 = v12;
...
- (id)copyWithZone:(_NSZone *)zone
{
  ...
  return [(BKSHIDEventDeferringChainObserverPredicate *)&v4->super.isa _initWithCopyOf:?];
}
