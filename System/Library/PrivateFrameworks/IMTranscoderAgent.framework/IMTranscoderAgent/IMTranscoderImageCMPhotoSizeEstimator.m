...
- (unint64_t)optimizedEstimatedSizeForOutputUTI:(id)a3 maximumDimension:(int64_t)a4 quality:(double)a5
{
  ...
  v41[0] = objc_msgSend_numberWithInteger_(MEMORY[0x277CCABB0], v8, a4, v9, v10, v11, v12, 0);
  ...
  v39 = objc_msgSend_numberWithDouble_(MEMORY[0x277CCABB0], v22, v23, v24, v25, v26, v27, a5);
...
- (unint64_t)estimatedSizeForOutputUTI:(id)a3 maximumDimension:(int64_t)a4 quality:(double)a5
{
  if (!UTTypeConformsTo(a3, *MEMORY[0x277CC20C8]) && !UTTypeConformsTo(a3, @"public.heif-standard") || (result = objc_msgSend_optimizedEstimatedSizeForOutputUTI_maximumDimension_quality_(self, v9, a3, a4, v10, v11, v12, a5)) == 0)
  {
    v14.receiver = self;
