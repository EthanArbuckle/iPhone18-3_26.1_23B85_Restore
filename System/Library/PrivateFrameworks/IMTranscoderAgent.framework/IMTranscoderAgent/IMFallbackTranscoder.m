...
- (id)_findPluginFallbackEncoder:(id)a3 withBalloonBundleID:(id)a4
{
  ...
  v9 = objc_msgSend_rangeOfString_(a4, a2, *MEMORY[0x277D19720], a4, v4, v5, v6);
  v76 = 0u;
  v77 = 0u;
  v78 = 0u;
  v79 = 0u;
  v18 = objc_msgSend_countByEnumeratingWithState_objects_count_(a3, v10, &v76, v84, 16, v11, v12);
  if (v18)
  {
    v19 = *v77;
    ...
    while (2)
    {
      ...
      do
      {
        ...
        if ((objc_msgSend_isEqualToString_(v35, v36, a4, v37, v38, v39, v40) & 1) != 0 || !v9 && objc_msgSend_isEqualToString_(v35, v13, v74, v14, v15, v16, v17))
        {
      ...
      while (v18 != v20);
      v18 = objc_msgSend_countByEnumeratingWithState_objects_count_(a3, v13, &v76, v84, 16, v16, v17);
      if (v18)
      {
        continue;
      }
...
- (void)transcodeFileTransferData:(id)a3 balloonBundleID:(id)a4 attachments:(id)a5 inFileURL:(id)a6 fallBack:(BOOL)a7 completionBlock:(id)a8
{
  ...
  PluginFallbackEncoder_withBalloonBundleID = objc_msgSend__findPluginFallbackEncoder_withBalloonBundleID_(self, v16, v15, a4, v17, v18, v19);
  if (PluginFallbackEncoder_withBalloonBundleID)
  {
    ...
    if (v9)
    {
      ...
      {
        v28 = objc_msgSend___imArrayByApplyingBlock_(a5, v23, &unk_28669AED8, v24, v25, v26, v27);
        ...
        v46[8] = a8;
        v46[6] = a5;
        objc_msgSend_fallbackForData_attachments_inFileURL_completionBlockWithText_(v21, v29, a3, v28, a6, v46, v30);
      }
      ...
      else
      {
        ...
        v45[8] = a8;
        v45[6] = a5;
        objc_msgSend_fallbackForData_inFileURL_completionBlock_(v21, v23, a3, a6, v45, v26, v27);
      }
    }
    ...
    else if (objc_opt_respondsToSelector())
    {
      ...
      v44[4] = v21;
      v44[5] = a8;
      objc_msgSend_fullQualityForData_inFileURL_completionBlock_(v21, v32, a3, a6, v44, v33, v34);
    }
    ...
    else
    {
      ...
      if (v36)
      {
        ...
        v43[4] = v21;
        v43[5] = a8;
        objc_msgSend_fullQualityForData_attachments_inFileURL_completionBlock_(v21, v38, a3, 0, a6, v43, v39);
      }
...
- (void)transcodeFileTransferContents:(id)a3 utiType:(id)a4 transcoderUserInfo:(id)a5 completionBlock:(id)a6
{
  v11 = objc_msgSend_objectForKey_(a5, a2, *MEMORY[0x277D19DC8], a4, a5, a6, v6);
  if (objc_msgSend_BOOLValue(v11, v12, v13, v14, v15, v16, v17))
  {

    MEMORY[0x2821F9670](self, sel__transcodeAudioMessageContents_utiType_completionBlock_, a3, a4, a6, v18, v19);
  }

  else
  {

    MEMORY[0x2821F9670](self, sel__transcodeAutoloopContents_utiType_completionBlock_, a3, a4, a6, v18, v19);
  }
}
...
- (void)_transcodeAutoloopContents:(id)a3 utiType:(id)a4 completionBlock:(id)a5
{
  ...
  v9 = objc_msgSend_defaultManager(MEMORY[0x277CCAA00], a2, a3, a4, a5, v5, v6);
  ...
  if (off_27F611A80)
  {
    ...
    v38[5] = a5;
    v38[6] = v39;
    off_27F611A80(a3, v34, &unk_28669AF38, v38);
  }
...
- (void)_transcodeAudioMessageContents:(id)a3 utiType:(id)a4 completionBlock:(id)a5
{
  v9 = objc_msgSend_audioTranscoder(self, a2, a3, a4, a5, v5, v6);

  MEMORY[0x2821F9670](v9, sel_transcodeOpusFile_completionBlock_, a3, a5, v10, v11, v12);
}
