...
+ (id)dataAggregationKeyForCategory:(unint64_t)category subCategory:(unint64_t)subCategory lookupTable:(id)table;
...
+ (id)fullMemoryTypeStringForMemory:(id)memory withWorkingContext:(id)context
{
  ...
  v8 = [photosGraphProperties objectForKeyedSubscript:@"memoryCategorySubcategory"];
  unsignedIntegerValue = [v8 unsignedIntegerValue];

  photosGraphProperties2 = [memoryCopy photosGraphProperties];
  v11 = [photosGraphProperties2 objectForKeyedSubscript:@"encodedFeatures"];
  ...
  [contextCopy performSynchronousConcurrentGraphReadUsingBlock:v16];
  v14 = v21[5];
...
+ (id)dataAggregationKeyForCategory:(unint64_t)category subCategory:(unint64_t)subCategory lookupTable:(id)table
{
  ...
  tableCopy = table;
  v9 = [v7 numberWithUnsignedInteger:category];
  v10 = [tableCopy objectForKey:v9];

  objc_opt_class();
  if (objc_opt_isKindOfClass())
  {
    v11 = [MEMORY[0x277CCABB0] numberWithUnsignedInteger:subCategory];
...
+ (id)aggregatedStatsForMoodKeywordCountedSet:(id)set
{
  ...
  v6 = [MEMORY[0x277CCABB0] numberWithUnsignedInteger:{objc_msgSend(setCopy, "countForObject:", *MEMORY[0x277D3BEB8])}];
  [v5 setValue:v6 forKey:@"disneyKeywordCount"];

  v7 = [MEMORY[0x277CCABB0] numberWithUnsignedInteger:{objc_msgSend(setCopy, "countForObject:", *MEMORY[0x277D3BF10])}];
  [v5 setValue:v7 forKey:@"universalKeywordCount"];

  v8 = [MEMORY[0x277CCABB0] numberWithUnsignedInteger:{objc_msgSend(setCopy, "countForObject:", *MEMORY[0x277D3BEE8])}];
  [v5 setValue:v8 forKey:@"newYorkCityKeywordCount"];

  v9 = [MEMORY[0x277CCABB0] numberWithUnsignedInteger:{objc_msgSend(setCopy, "countForObject:", *MEMORY[0x277D3BED8])}];
  [v5 setValue:v9 forKey:@"londonKeywordCount"];

  v10 = [MEMORY[0x277CCABB0] numberWithUnsignedInteger:{objc_msgSend(setCopy, "countForObject:", *MEMORY[0x277D3BEF0])}];
  [v5 setValue:v10 forKey:@"parisKeywordCount"];

  v11 = [MEMORY[0x277CCABB0] numberWithUnsignedInteger:{objc_msgSend(setCopy, "countForObject:", *MEMORY[0x277D3BED0])}];
  [v5 setValue:v11 forKey:@"hawaiiKeywordCount"];

  v12 = [MEMORY[0x277CCABB0] numberWithUnsignedInteger:{objc_msgSend(setCopy, "countForObject:", *MEMORY[0x277D3BF08])}];
  [v5 setValue:v12 forKey:@"sportsKeywordCount"];

  v13 = [MEMORY[0x277CCABB0] numberWithUnsignedInteger:{objc_msgSend(setCopy, "countForObject:", *MEMORY[0x277D3BE90])}];
  [v5 setValue:v13 forKey:@"anniversaryKeywordCount"];

  v14 = [MEMORY[0x277CCABB0] numberWithUnsignedInteger:{objc_msgSend(setCopy, "countForObject:", *MEMORY[0x277D3BEA8])}];
  [v5 setValue:v14 forKey:@"birthdayKeywordCount"];

  v15 = [MEMORY[0x277CCABB0] numberWithUnsignedInteger:{objc_msgSend(setCopy, "countForObject:", *MEMORY[0x277D3BF18])}];
  [v5 setValue:v15 forKey:@"weddingKeywordCount"];

  v16 = [MEMORY[0x277CCABB0] numberWithUnsignedInteger:{objc_msgSend(setCopy, "countForObject:", *MEMORY[0x277D3BEC0])}];
  [v5 setValue:v16 forKey:@"familyKeywordCount"];

  v17 = [MEMORY[0x277CCABB0] numberWithUnsignedInteger:{objc_msgSend(setCopy, "countForObject:", *MEMORY[0x277D3BEF8])}];
  [v5 setValue:v17 forKey:@"partyKeywordCount"];

  v18 = [MEMORY[0x277CCABB0] numberWithUnsignedInteger:{objc_msgSend(setCopy, "countForObject:", *MEMORY[0x277D3BEC8])}];
  [v5 setValue:v18 forKey:@"gatheringKeywordCount"];

  v19 = [MEMORY[0x277CCABB0] numberWithUnsignedInteger:{objc_msgSend(setCopy, "countForObject:", *MEMORY[0x277D3BF00])}];
  [v5 setValue:v19 forKey:@"petsKeywordCount"];

  v20 = [MEMORY[0x277CCABB0] numberWithUnsignedInteger:{objc_msgSend(setCopy, "countForObject:", *MEMORY[0x277D3BE98])}];
  [v5 setValue:v20 forKey:@"babiesKeywordCount"];

  v21 = [MEMORY[0x277CCABB0] numberWithUnsignedInteger:{objc_msgSend(setCopy, "countForObject:", *MEMORY[0x277D3BF20])}];
  [v5 setValue:v21 forKey:@"winterHolidayKeywordCount"];

  v22 = [MEMORY[0x277CCABB0] numberWithUnsignedInteger:{objc_msgSend(setCopy, "countForObject:", *MEMORY[0x277D3BEA0])}];
  [v5 setValue:v22 forKey:@"beachKeywordCount"];

  v23 = [MEMORY[0x277CCABB0] numberWithUnsignedInteger:{objc_msgSend(setCopy, "countForObject:", *MEMORY[0x277D3BEE0])}];
  [v5 setValue:v23 forKey:@"natureKeywordCount"];

  v24 = [MEMORY[0x277CCABB0] numberWithUnsignedInteger:{objc_msgSend(setCopy, "countForObject:", *MEMORY[0x277D3BEB0])}];
  [v5 setValue:v24 forKey:@"chineseLunarNewYearKeywordCount"];

  v25 = MEMORY[0x277CCABB0];
  v26 = [setCopy countForObject:@"None"];
...
+ (id)aggregatedStatsForMiroMoodCountVector:(id)vector
{
  ...
  v6 = [vectorCopy objectAtIndexedSubscript:1];
  [v5 setValue:v6 forKey:@"dreamyMiroMoodCount"];

  v7 = [vectorCopy objectAtIndexedSubscript:2];
  [v5 setValue:v7 forKey:@"sentimentalMiroMoodCount"];

  v8 = [vectorCopy objectAtIndexedSubscript:4];
  [v5 setValue:v8 forKey:@"gentleMiroMoodCount"];

  v9 = [vectorCopy objectAtIndexedSubscript:8];
  [v5 setValue:v9 forKey:@"chillMiroMoodCount"];

  v10 = [vectorCopy objectAtIndexedSubscript:32];
  [v5 setValue:v10 forKey:@"happyMiroMoodCount"];

  v11 = [vectorCopy objectAtIndexedSubscript:64];
  [v5 setValue:v11 forKey:@"upliftingMiroMoodCount"];

  v12 = [vectorCopy objectAtIndexedSubscript:128];
  [v5 setValue:v12 forKey:@"epicMiroMoodCount"];

  v13 = [vectorCopy objectAtIndexedSubscript:256];
  [v5 setValue:v13 forKey:@"clubMiroMoodCount"];

  v14 = [vectorCopy objectAtIndexedSubscript:512];
