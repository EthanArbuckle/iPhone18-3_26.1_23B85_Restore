...
- (BOOL)runWithGraphManager:(id)a3 progressReporter:(id)a4 error:(id *)a5
{
  ...
  LOBYTE(a5) = [v12 processSyndicatedAssetRevGeoCodingWithError:a5 progressReporter:v8];
...
- (BOOL)shouldRunWithGraphManager:(id)a3
{
  ...
  else
  {
    ...
    {
      *v9 = 0;
      _os_log_impl(&dword_22FA28000, v3, OS_LOG_TYPE_DEFAULT, "Task is running on a non system photo library, not running syndication processing job", v9, 2u);
    }
