...
+ (BOOL)shouldReportSettingsWithLoggingConnection:(id)connection;
+ (id)_dateFormatter;
+ (unsigned)_valueForSetting:(__CFString *)setting withDefaultValue:(unsigned __int8)value;
...
- (BOOL)recordFeatureUsageFromCounts:(id)counts forPhotoLibrary:(id)library loggingConnection:(id)connection error:(id *)error;
...
+ (unsigned)_valueForSetting:(__CFString *)setting withDefaultValue:(unsigned __int8)value
{
  ...
  result = CFPreferencesGetAppBooleanValue(setting, @"com.apple.mobileslideshow", &keyExistsAndHasValidFormat);
...
+ (void)_reportSettings:(id)settings
{
  ...
  v6 = [MEMORY[0x277CCABB0] numberWithUnsignedChar:{objc_msgSend(self, "_valueForSetting:withDefaultValue:", @"shouldModulateImages", 1)}];
  [v7 setObject:v6 forKeyedSubscript:@"view_full_hdr"];

  [settingsCopy sendEvent:@"com.apple.photos.settings" withPayload:v7];
}
...
+ (void)_reportCameraSharingSettingsWithPhotoLibrary:(id)library andAnalytics:(id)analytics
{
  ...
  v8 = [MEMORY[0x277CD98A8] fetchActiveLibraryScopeWithOptions:librarySpecificFetchOptions];
  ...
  if (firstObject)
  {
    ...
    v14 = [MEMORY[0x277CD99C8] fetchParticipantsInShare:firstObject options:librarySpecificFetchOptions2];
    v15 = [v14 count];

    v16 = [MEMORY[0x277CCABB0] numberWithUnsignedInteger:v15];
    [v10 setObject:v16 forKeyedSubscript:@"participantsCount"];

    [analyticsCopy sendEvent:@"com.apple.photos.cpa.camera_sharing" withPayload:v10];
  }
}
...
+ (void)_reportAlchemistSettings:(id)settings
{
  ...
  {
    [settingsCopy sendEvent:@"com.apple.photos.alchemist.disabled" withPayload:MEMORY[0x277CBEC10]];
  }
}
...
+ (void)updateLastReportSettings
{
  ...
  v4 = [v2 components:8 fromDate:date];
  month = [v4 month];

  standardUserDefaults = [MEMORY[0x277CBEBD0] standardUserDefaults];
  [standardUserDefaults setInteger:month forKey:@"PHALastSettingsReportMonth"];
...
+ (BOOL)shouldReportSettingsWithLoggingConnection:(id)connection
{
  ...
  date = [MEMORY[0x277CBEAA8] date];
  v6 = [v4 components:24 fromDate:date];
  ...
  if (v7 < 15)
  {
    month = [v6 month];
    standardUserDefaults = [MEMORY[0x277CBEBD0] standardUserDefaults];
    v14 = [standardUserDefaults integerForKey:@"PHALastSettingsReportMonth"];
...
- (id)_libraryScopedWorkerFeaturesUsageURLForPhotoLibrary:(id)library
{
  ...
  libraryCopy = library;
  v9 = 0;
  v4 = [libraryCopy urlForApplicationDataFolderIdentifier:1 error:&v9];
  v5 = v9;
  if (v4)
  {
...
- (id)_libraryScopedWorkerFeaturesUsageForLibrary:(id)library loggingConnection:(id)connection error:(id *)error
{
  ...
  connectionCopy = connection;
  v9 = [(PHAFeaturesUsageReportingTask *)self _libraryScopedWorkerFeaturesUsageURLForPhotoLibrary:library];
  if (v9)
  {
    v15 = 0;
    ...
    if ([v11 code] == 260)
    {
      if (os_log_type_enabled(connectionCopy, OS_LOG_TYPE_DEFAULT))
      {
        *buf = 138412546;
        ...
        v18 = 2112;
        v19 = v11;
        _os_log_impl(&dword_22FA28000, connectionCopy, OS_LOG_TYPE_DEFAULT, "[PHAFeaturesUsageReportingTask] Cannot find feature usage file at path %@, error: %@", buf, 0x16u);
      }
...
- (BOOL)recordFeatureUsageFromCounts:(id)counts forPhotoLibrary:(id)library loggingConnection:(id)connection error:(id *)error
{
  ...
  if ([countsCopy count])
  {
    v12 = [(PHAFeaturesUsageReportingTask *)self _libraryScopedWorkerFeaturesUsageURLForPhotoLibrary:libraryCopy];
    if (v12)
    {
      _dateFormatter = [objc_opt_class() _dateFormatter];
      date = [MEMORY[0x277CBEAA8] date];
      v15 = [_dateFormatter stringFromDate:date];

      v50 = v15;
      v48 = [_dateFormatter dateFromString:v15];
      if (v48)
      {
        v16 = [(PHAFeaturesUsageReportingTask *)self _libraryScopedWorkerFeaturesUsageForLibrary:libraryCopy loggingConnection:oslog error:0];
        ...
        if (v21 && v22)
        {
          ...
          if (v24)
          {
            ...
            do
            {
              for (i = 0; i != v25; ++i)
              {
                ...
                v30 = [_dateFormatter dateFromString:v29];
                ...
                if (integerValue >= 1)
                {
                  ...
                  v35 = [_dateFormatter dateFromString:v34];
          ...
          else
          {
            ...
            v38 = [MEMORY[0x277CCAC58] dataWithPropertyList:v37 format:100 options:0 error:errorCopy];
            v39 = v38;
            v12 = v45;
            libraryCopy = v46;
            if (v38)
            {
              v20 = [v38 writeToURL:v45 options:1073741825 error:errorCopy];
            }
...
- (BOOL)runWithPhotoLibrary:(id)library analytics:(id)analytics progressReporter:(id)reporter error:(id *)error
{
  ...
  if ([libraryCopy isSystemPhotoLibrary] && objc_msgSend(objc_opt_class(), "shouldReportSettingsWithLoggingConnection:", v13))
  {
    ...
    [analyticsCopy sendEvent:@"com.apple.photos.cpa.featured_content" withPayload:v15];

    [objc_opt_class() _reportCameraSharingSettingsWithPhotoLibrary:libraryCopy andAnalytics:analyticsCopy];
    [objc_opt_class() _reportSettings:analyticsCopy];
    [objc_opt_class() updateLastReportSettings];
  }

  v16 = [(PHAFeaturesUsageReportingTask *)self _libraryScopedWorkerFeaturesUsageForLibrary:libraryCopy loggingConnection:v13 error:error];
  v17 = v16;
  if (!v16)
  {
    v60 = 0;
  ...
  _dateFormatter = [objc_opt_class() _dateFormatter];
  date = [MEMORY[0x277CBEAA8] date];
  v20 = [_dateFormatter stringFromDate:date];

  v77 = _dateFormatter;
  v69 = v20;
  v79 = [_dateFormatter dateFromString:v20];
  ...
  v26 = [v24 count];
  v74 = analyticsCopy;
  systemProperties = [analyticsCopy systemProperties];
  v67 = *MEMORY[0x277CF6E10];
  v70 = [systemProperties propertyForKey:? forEventName:? payloadForSystemPropertyExtraction:?];
  ...
  *&v31 = 138412546;
  ...
  while (2)
  {
    for (i = 0; i != v84; ++i)
    {
      ...
      v35 = *(*(&v86 + 1) + 8 * i);
      if ([reporterCopy isCancelledWithProgress:{v33, v63}])
      {
      ...
      if (v36)
      {
        ...
        if (v37)
        {
          distantPast = [v28 dateFromString:v37];
          if (!distantPast)
          {
            if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
            {
        ...
        v41 = v40 / 86400.0;
        v81 = distantPast;
        [v79 timeIntervalSinceDate:distantPast];
        v43 = v42;
...
LABEL_27:
          ...
          v52 = [MEMORY[0x277CCABB0] numberWithInteger:integerValue];
          v103[2] = v52;
          v102[3] = @"cpa_feature_total_months";
          v73 = integerValue2;
          v53 = [MEMORY[0x277CCABB0] numberWithInteger:integerValue2];
          v103[3] = v53;
...
- (BOOL)runWithGraphManager:(id)manager progressReporter:(id)reporter error:(id *)error
{
  ...
  LOBYTE(error) = [(PHAFeaturesUsageReportingTask *)self runWithPhotoLibrary:photoLibrary analytics:analytics progressReporter:reporterCopy error:error];
  return error;
}
...
- (BOOL)shouldRunWithGraphManager:(id)manager
{
  ...
  LOBYTE(self) = [(PHAFeaturesUsageReportingTask *)self shouldRunWithPhotoLibrary:photoLibrary];
