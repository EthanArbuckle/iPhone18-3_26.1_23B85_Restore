...
- (CBORString)initWith:(id)with
{
  withCopy = with;
  v9.receiver = self;
  v9.super_class = CBORString;
  v5 = [(CBORString *)&v9 init];
  if (v5)
  {
    v6 = [objc_alloc(MEMORY[0x277CCACA8]) initWithString:withCopy];
    m_data = v5->m_data;
    v5->m_data = v6;
  }
...
- (void)write:(id)write
{
  m_data = self->m_data;
  writeCopy = write;
  [(CBORValue *)self encodeStartItems:[(NSString *)m_data length] output:writeCopy];
