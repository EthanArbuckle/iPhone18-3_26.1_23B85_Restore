...
- (PXGEngineRecordingDataStoreSerializable)initWithSerializableObject:(id)object;
...
- (id)createSerializableObject
{
  ...
  v15[0] = @"spriteStyles";
  spriteStyles = [(PXGEngineRecordingDataStoreSerializable *)self spriteStyles];
  v13 = PXGCreateDictionaryWithTransforms(spriteStyles, &__block_literal_global_3, &__block_literal_global_11);
  v16[0] = v13;
  v15[1] = @"spriteInfos";
  spriteInfos = [(PXGEngineRecordingDataStoreSerializable *)self spriteInfos];
  v4 = PXGCreateDictionaryWithTransforms(spriteInfos, &__block_literal_global_3, &__block_literal_global_11);
  v16[1] = v4;
  v15[2] = @"spriteGeometries";
  spriteGeometries = [(PXGEngineRecordingDataStoreSerializable *)self spriteGeometries];
  v6 = PXGCreateDictionaryWithTransforms(spriteGeometries, &__block_literal_global_3, &__block_literal_global_11);
  v16[2] = v6;
  v15[3] = @"spriteEntities";
  spriteEntities = [(PXGEngineRecordingDataStoreSerializable *)self spriteEntities];
  v8 = PXGCreateDictionaryWithTransforms(spriteEntities, &__block_literal_global_3, &__block_literal_global_11);
  v16[3] = v8;
  v15[4] = @"spriteTextureInfos";
  spriteTextureInfos = [(PXGEngineRecordingDataStoreSerializable *)self spriteTextureInfos];
  v10 = PXGCreateDictionaryWithTransforms(spriteTextureInfos, &__block_literal_global_3, &__block_literal_global_11);
  v16[4] = v10;
