...
- (unint64_t)mailboxFilterType
{
  if ([(MFNanoBridgeSettingsSharedMailbox *)self type]== 1)
  {
    return 2;
  }

  if ([(MFNanoBridgeSettingsSharedMailbox *)self type]== 2)
  {
    return 4;
  }

  if ([(MFNanoBridgeSettingsSharedMailbox *)self type]== 3)
  {
    return 8;
  }

  if ([(MFNanoBridgeSettingsSharedMailbox *)self type]== 6)
  {
    return 32;
  }

  if ([(MFNanoBridgeSettingsSharedMailbox *)self type]== 4)
  {
    return 16;
  }

  return ([(MFNanoBridgeSettingsSharedMailbox *)self type]== 7) << 6;
}
...
- (id)displayName
{
  ...
  if (type > 3)
  {
    switch(type)
    {
      case 4:
        ...
        v5 = [v4 localizedStringForKey:@"TO_OR_CC" value:&stru_10015BEC8 table:@"Main"];
        break;
      case 6:
        v4 = [NSBundle bundleForClass:objc_opt_class()];
        v5 = [v4 localizedStringForKey:@"IMPORTANT_THREADS" value:&stru_10015BEC8 table:@"Main"];
        break;
      case 7:
        v4 = [NSBundle bundleForClass:objc_opt_class()];
        v5 = [v4 localizedStringForKey:@"TODAY" value:&stru_10015BEC8 table:@"Main"];
        break;
      default:
        goto LABEL_15;
    }
  ...
  else
  {
    switch(type)
    {
      case 1:
        v4 = [NSBundle bundleForClass:objc_opt_class()];
        v5 = [v4 localizedStringForKey:@"VIP" value:&stru_10015BEC8 table:@"Main"];
        break;
      case 2:
        v4 = [NSBundle bundleForClass:objc_opt_class()];
        v5 = [v4 localizedStringForKey:@"FLAGGED" value:&stru_10015BEC8 table:@"Main"];
        break;
      case 3:
        v4 = [NSBundle bundleForClass:objc_opt_class()];
        v5 = [v4 localizedStringForKey:@"UNREAD" value:&stru_10015BEC8 table:@"Main"];
        break;
      default:
        goto LABEL_15;
    }
...
- (id)_includesMeIconImage
{
  ...
  if (!qword_100185990)
  {
    ...
    v4 = [NSBundle bundleForClass:objc_opt_class()];
    v5 = sub_100047634(2, v3, v4, 35.0);

    v6 = [NSBundle bundleForClass:objc_opt_class()];
    v7 = sub_100047634(3, v3, v6, 35.0);
    ...
    v10 = sub_100046FF4(2, v3, v8, v9, 0, v5);

    v11 = [NSBundle bundleForClass:objc_opt_class()];
    v12 = +[UIColor systemGrayColor];
    v13 = sub_100046FF4(3, v3, v11, v12, 0, v5);
