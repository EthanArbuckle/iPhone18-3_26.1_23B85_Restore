...
+ (id)accountImageForAccount:(id)a3
{
  ...
  v6 = [v3 iconString];
  v7 = [qword_1001855E8 objectForKey:v6];
  if (!v7)
  {
    if (!qword_1001855F0)
    {
    ...
    [qword_1001855E8 setObject:v7 forKey:v6];
  }
...
- (id)mailboxesToBeObserved:(id)a3
{
  ...
  v6 = [(MailAccount *)self pushedMailboxUids];
  v7 = [v5 initWithSet:v6];

  v8 = [v4 favoriteMailboxesForAccount:self];
  [v7 unionSet:v8];
...
- (id)mailboxesToBeObservedWithFavoritesReader:(id)a3
{
  ...
  v20 = 0u;
  v21 = 0u;
  v10 = [v4 mailboxesCollection];
  v11 = [v10 visibleItems];
