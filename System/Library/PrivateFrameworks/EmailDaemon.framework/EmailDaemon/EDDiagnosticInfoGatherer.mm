...
- (void)_copyAndCompressDatabaseIntoDirectoryURL:(id)a3 originalURL:(id)a4 targetName:(id)a5;
- (void)_copyIndexingDiagnosticsDatabaseIntoDirectoryURL:(id)a3 completionPromise:(id)a4;
...
- (EDDiagnosticInfoGatherer)initWithFetchController:(id)a3 remoteClientsProvider:(id)a4 persistence:(id)a5
{
  ...
  if (v12)
  {
    objc_storeStrong(&v12->_fetchController, a3);
    objc_storeStrong(&v13->_remoteClientsProvider, a4);
    objc_storeStrong(&v13->_persistence, a5);
...
- (void)registerDiagnosticInfoProvider:(id)a3 completionHandler:(id)a4
{
  ...
  v7 = a3;
  v8 = a4;
  objc_storeStrong(&self->_diagnosticInfoProvider, a3);
...
- (void)gatherDiagnosticsWithOptions:(unint64_t)a3 completionHandler:(id)a4
{
  ...
  v28 = 0;
  v13 = [v12 createDirectoryAtURL:v11 withIntermediateDirectories:1 attributes:0 error:&v28];
  v14 = v28;
  ...
  if ((v13 & 1) == 0)
  {
    ...
    {
      v16 = [v11 path];
      [(EDDiagnosticInfoGatherer *)v16 gatherDiagnosticsWithOptions:v14 completionHandler:buf, v15];
    }
  }

  v17 = [objc_alloc(MEMORY[0x1E699B970]) initWithFileURL:v11 readOnly:0];
  v18 = [(EDDiagnosticInfoGatherer *)self gathererQueue];
...
- (void)_copySearchIndexerDatabaseIntoDirectoryURL:(id)a3
{
  ...
  v5 = [v4 URLForDirectory:5 inDomain:1 appropriateForURL:0 create:0 error:0];
  ...
  [(EDDiagnosticInfoGatherer *)self _copyAndCompressDatabaseIntoDirectoryURL:v9 originalURL:v8 targetName:@"SearchIndexer-database"];
}
...
- (void)_copyAndCompressDatabaseIntoDirectoryURL:(id)a3 originalURL:(id)a4 targetName:(id)a5
{
  ...
  [v17 createDirectoryAtURL:v16 withIntermediateDirectories:1 attributes:0 error:0];

  v18 = [v16 URLByAppendingPathComponent:v10 isDirectory:0];
  if ([(EDDiagnosticInfoGatherer *)self _copyDatabaseFromURL:v9 intoDatabaseAtURL:v18])
  {
    if ([(EDDiagnosticInfoGatherer *)self _compressDatabaseAtURL:v18 intoDirectoryURL:v8])
    {
    ...
    else
    {
      ...
      {
        [(EDDiagnosticInfoGatherer *)v10 _copyAndCompressDatabaseIntoDirectoryURL:v19 originalURL:v26 targetName:v27, v28, v29, v30, v31];
      }
    }
  }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v19, OS_LOG_TYPE_ERROR))
    {
      [(EDDiagnosticInfoGatherer *)v10 _copyAndCompressDatabaseIntoDirectoryURL:v19 originalURL:v20 targetName:v21, v22, v23, v24, v25];
    }
  }

  v32 = [MEMORY[0x1E696AC08] defaultManager];
  [v32 removeItemAtURL:v16 error:0];
...
- (BOOL)_compressDatabaseAtURL:(id)a3 intoDirectoryURL:(id)a4
{
  ...
  v8 = [v20 stringByAppendingString:@".aar"];
  v9 = [v21 URLByAppendingPathComponent:v8 isDirectory:0];
  ...
  v16 = [(EDDiagnosticInfoGatherer *)self _compressDirectoryAtURL:v7 intoArchiveWithURL:v15];
  if (v16)
  {
    v17 = [MEMORY[0x1E696AC08] defaultManager];
...
- (BOOL)_compressDirectoryAtURL:(id)a3 intoArchiveWithURL:(id)a4
{
  v5 = a3;
  v6 = a4;
  v7 = AAFileStreamOpenWithPath([v6 fileSystemRepresentation], 1537, 0x1A4u);
  ...
  v11 = AAPathListCreateWithDirectoryContents([v5 fileSystemRepresentation], 0, &__block_literal_global_46, entryMessageProc, 0, 0);
  v12 = AAArchiveStreamWritePathList(v9, v11, v10, [v5 fileSystemRepresentation], 0, 0, 0, 0);
...
- (BOOL)_copyDatabaseFromURL:(id)a3 intoDatabaseAtURL:(id)a4
{
  ...
  {
    ppDb = 0;
    if (!sqlite3_open_v2([v6 fileSystemRepresentation], &ppDb, 524289, 0))
    {
      v11 = 0;
...
- (void)_createDiagnosticsJSONForMessagesWithObjectIDs:(id)a3 directoryURL:(id)a4
{
  v12 = a3;
  v6 = a4;
  v7 = [(EDDiagnosticInfoGatherer *)self persistence];
  v8 = [v7 messagePersistence];
  v9 = [v12 allObjects];
  v10 = [v8 diagnosticsForForMessageObjectIDs:v9];

  if (v10)
  {
    v11 = [v6 ef_URLByAppendingTimestampedPathComponent:@"messages" withExtension:@"json"];
...
- (void)_downloadMessagesWithObjectIDs:(id)a3 directoryURL:(id)a4 completionPromise:(id)a5
{
  ...
  v9 = a4;
  v10 = a5;
  v11 = [(EDDiagnosticInfoGatherer *)self gathererQueue];
...
- (void)gatherIndexingDiagnosticsWithRedaction:(int64_t)a3 completionHandler:(id)a4
{
  ...
  v7 = [(EDDiagnosticInfoGatherer *)self persistence];
  v8 = [(EDIndexingDiagnosticsGatherer *)v6 initWithPersistence:v7];

  [(EDIndexingDiagnosticsGatherer *)v8 gatherWithRedaction:a3 completionHandler:v9];
}
