...
- (SuggestionsDataProvider)initWithLibrary:(id)library;
- (id)_libraryMessagesForSGMailMessageKeys:(id)keys;
- (void)_processBackgroundDownload;
- (void)_registerXpcActivity;
- (void)_scheduleBackgroundDownload;
- (void)dealloc;
- (void)refreshLostMessagesUntilDeferred:(id)deferred;
- (void)resume;
- (void)suspend;
@end
...
{
  keysCopy = keys;
  v5 = +[NSMutableDictionary dictionaryWithCapacity:](NSMutableDictionary, "dictionaryWithCapacity:", [keysCopy count]);
  v6 = +[NSMutableSet set];
  ...
  v8 = v6;
  v20 = v8;
  v9 = [keysCopy ef_compactMap:v18];
  v10 = [MFMessageCriterion orCompoundCriterionWithCriteria:v9];
  v11 = +[NSMutableDictionary dictionaryWithCapacity:](NSMutableDictionary, "dictionaryWithCapacity:", [keysCopy count]);
  if (v10)
  {
...
- (void)_processBackgroundDownload
{
  ...
  completionHandlerAdapter = [v23 completionHandlerAdapter];
  [(SGSuggestionsServiceMailProtocol *)harvesterService fullDownloadRequestBatch:5 withCompletion:completionHandlerAdapter];

  future = [v23 future];
  v6 = [future resultWithTimeout:0 error:5.0];
  ...
  if (v7 < [v6 count])
  {
    ...
    allKeys = [v24 allKeys];
    v10 = [v25 arrayByExcludingObjectsInArray:allKeys];
    ...
    if (v12)
    {
      ...
      do
      {
        ...
        do
        {
          ...
          account = [v16 account];
          v19 = [MessageBodyLoader loaderForAccount:account];
