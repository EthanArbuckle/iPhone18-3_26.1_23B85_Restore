...
- (id)_iconImageWithBackgroundColor:(id)color
{
  ...
  v6 = sub_1000475A4(2, preferredContentSizeCategory, 36.0);
  v7 = sub_1000475A4(3, preferredContentSizeCategory, 36.0);
  if (v6 < v7)
  {
    v6 = v7;
  }
  ...
  v9 = sub_100046FF4(2, preferredContentSizeCategory, v8, colorCopy, 0, v6);

  v10 = +[NSBundle mainBundle];
  v11 = sub_100046FF4(3, preferredContentSizeCategory, v10, colorCopy, 0, v6);
...
{
  itemsCopy = items;
  v4 = [itemsCopy ef_map:&stru_100157DE8];
