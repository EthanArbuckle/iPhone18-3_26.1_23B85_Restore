...
+ (int)_createTempMessagesTable:(id)a3
{
  ...
  if (v5)
  {
    v7 = [v3 sqlConnection];
    v15 = v6;
    v8 = [v7 executeStatementString:@"ALTER TABLE messages RENAME TO messages_old" error:&v15];
    v9 = v15;
  ...
  if (v5)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        v11 = [v21 sqlConnection];
        v26 = v8;
        v12 = [v11 executeStatementString:v10 error:&v26];
        v4 = v26;
...
+ (int)_copyMessagesData:(id)a3
{
  ...
  v6 = [v3 sqlConnection];
  v13[0] = 0;
  v7 = [v6 executeStatementString:v5 error:v13];
  v8 = v13[0];
...
+ (int)_swapMessagesTables:(id)a3
{
  ...
  v4 = a3;
  v5 = [a1 _dropTable:@"messages_old" connection:v4];
  if (!v5)
  {
    v6 = [v4 sqlConnection];
    v12[0] = 0;
    v7 = [v6 executeStatementString:@"ALTER TABLE messages_new RENAME TO messages" error:v12];
    v8 = v12[0];
...
+ (int)_dropTable:(id)a3 connection:(id)a4
{
  ...
  v5 = a3;
  v6 = a4;
  v7 = [MEMORY[0x1E696AEC0] stringWithFormat:@"DROP TABLE IF EXISTS %@", v5];
  v8 = [v6 sqlConnection];
  v15[0] = 0;
  v9 = [v8 executeStatementString:v7 error:v15];
  v10 = v15[0];
...
+ (int)_truncateTable:(id)a3 connection:(id)a4
{
  ...
  v5 = a3;
  v6 = a4;
  v7 = [MEMORY[0x1E696AEC0] stringWithFormat:@"DELETE FROM %@", v5];
  v8 = [v6 sqlConnection];
  v15[0] = 0;
  v9 = [v8 executeStatementString:v7 error:v15];
  v10 = v15[0];
...
+ (int)_dropThreadCategoriesIndex:(id)a3
{
  ...
  v4 = [v3 sqlConnection];
  v11[0] = 0;
  v5 = [v4 executeStatementString:@"DROP INDEX IF EXISTS thread_categories_type_active_user_override_thread_index;" error:v11];
  v6 = v11[0];
...
{
  v4 = a3;
  v5 = [a1 _dropTable:@"interaction_log" connection:v4];
  if (!v5)
  {
    v5 = [a1 _dropTable:@"thread_categories" connection:v4];
    if (!v5)
    {
      v5 = [a1 _dropTable:@"read_later" connection:v4];
      if (!v5)
      {
        v5 = [a1 _dropThreadCategoriesIndex:v4];
        if (!v5)
        {
          v5 = [a1 _dropTable:@"categorization_sender_rules" connection:v4];
          if (!v5)
          {
            v5 = [a1 _dropTable:@"categorization_conversation_rules" connection:v4];
            if (!v5)
            {
              v5 = [a1 _dropTable:@"categorization_group_rules" connection:v4];
              if (!v5)
              {
                v7 = [v4 columnExists:@"category_active_types" inTable:@"messages" type:0];
                if ((((v7 | [v4 columnExists:@"times_viewed" inTable:@"messages" type:0]) & 1) == 0 || (v5 = objc_msgSend(a1, "_createTempMessagesTable:", v4)) == 0 && (v5 = objc_msgSend(a1, "_recreateMessagesIndices:", v4)) == 0 && (v5 = objc_msgSend(a1, "_copyMessagesData:", v4)) == 0 && (v5 = objc_msgSend(a1, "_swapMessagesTables:", v4)) == 0) && (!objc_msgSend(v4, "columnExists:inTable:type:", @"read_later_date", @"threads", 0) || (v5 = objc_msgSend(a1, "_dropTable:connection:", @"threads", v4)) == 0 && (v5 = objc_msgSend(a1, "_truncateTable:connection:", @"thread_senders", v4)) == 0 && (v5 = objc_msgSend(a1, "_truncateTable:connection:", @"thread_mailboxes", v4)) == 0 && (v5 = objc_msgSend(a1, "_truncateTable:connection:", @"thread_scopes", v4)) == 0 && (v5 = objc_msgSend(a1, "_truncateTable:connection:", @"thread_recipients", v4)) == 0 && (v5 = objc_msgSend(a1, "_recreateThreadsTable:", v4)) == 0 && (v5 = objc_msgSend(a1, "_recreateThreadsIndices:", v4)) == 0))
                {
                  v5 = 0;
                }
              }
