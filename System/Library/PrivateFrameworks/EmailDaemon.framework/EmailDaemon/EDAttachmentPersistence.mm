...
+ (id)messageAttachmentTableSchema
{
  ...
  columnExpression = [v30 columnExpression];
  isNotNull = [columnExpression isNotNull];
  v33[0] = isNotNull;
  columnExpression2 = [v29 columnExpression];
  ...
  columnExpression3 = [v30 columnExpression];
  isNull2 = [columnExpression3 isNull];
  v32[0] = isNull2;
  columnExpression4 = [v29 columnExpression];
...
+ (id)tablesAndForeignKeysToResolve:(id *)resolve associationsToResolve:(id *)toResolve
{
  ...
  v20[1] = v15;
  *resolve = [MEMORY[0x1E695DEC8] arrayWithObjects:v20 count:2];
...
- (BOOL)updateAttachmentIDForMessageAttachment:(id)attachment
{
  ...
  v18 = attachmentID;
  v28 = v18;
  if ([database __performWriteWithCaller:v15 usingBlock:v25])
  {
    v19 = *(v32 + 24);
  }
...
- (BOOL)messageAttachmentExistsForGlobalMessageID:(int64_t)d remoteURL:(id)l hasAttachmentEntry:(BOOL *)entry
{
  ...
  allColumns = [MEMORY[0x1E699B8C8] allColumns];
  entryCopy = entry;
  v25 = [v8 initWithResult:allColumns table:@"message_attachments"];
  ...
  v32 = entryCopy;
  v30 = v33;
  [database __performReadWithCaller:v20 usingBlock:v27];
...
- (id)attachmentMetadataForMessageIDs:(id)ds
{
  ...
  v18 = dsCopy;
  v26 = v18;
  [database __performReadWithCaller:v15 usingBlock:v23];
...
- (id)attachmentMetadataForMessage:(int64_t)message mimePartNumber:(id)number
{
  ...
  v21 = numberCopy;
  v29 = v21;
  [database __performReadWithCaller:v19 usingBlock:v27];
...
- (id)attachmentMetadataForMessage:(int64_t)message remoteURL:(id)l
{
  ...
  v22 = lCopy;
  v31 = v22;
  [database __performReadWithCaller:v20 usingBlock:v29];
