...
+ (id)log;
+ (void)_registerLibraryCompressionRequiringClassA:(BOOL)a;
+ (void)scheduleLibraryCompressionIfNeededRequiringClassA:(id)a;
@end
...
+ (void)scheduleLibraryCompressionIfNeededRequiringClassA:(id)a
{
  ...
  else
  {
    ...
    [self _registerLibraryCompressionRequiringClassA:aCopy[2](aCopy)];
  }
}
