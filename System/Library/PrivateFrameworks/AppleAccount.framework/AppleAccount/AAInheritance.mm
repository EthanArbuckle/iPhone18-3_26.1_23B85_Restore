...
- (AAInheritance)initWithCoder:(id)coder;
...
- (void)encodeWithCoder:(id)coder
{
  ...
  coderCopy = coder;
  [coderCopy encodeObject:beneficiaries forKey:@"_beneficiaries"];
  [coderCopy encodeObject:self->_benefactors forKey:@"_benefactors"];
}
...
- (AAInheritance)initWithCoder:(id)coder
{
  ...
  if (v5)
  {
    ...
    v12 = [coderCopy decodeObjectOfClasses:v8 forKey:@"_beneficiaries"];
    beneficiaries = v5->_beneficiaries;
    v5->_beneficiaries = v12;

    v14 = [coderCopy decodeObjectOfClasses:v11 forKey:@"_benefactors"];
