...
- (void)dealloc
{
  ...
  v5.receiver = self;
  v5.super_class = AAAgeMigrationDaemonConnection;
...
- (id)_connection
{
  ...
  v5[1] = 3221225472;
  v5[2] = __45__AAAgeMigrationDaemonConnection__connection__block_invoke;
  v5[3] = &unk_1E7C9A840;
  v5[4] = self;
  os_unfair_lock_lock(&self->_unfairLock);
  v3 = __45__AAAgeMigrationDaemonConnection__connection__block_invoke(v5);
  os_unfair_lock_unlock(&self->_unfairLock);

  return v3;
}

id __45__AAAgeMigrationDaemonConnection__connection__block_invoke(uint64_t a1)
{
  v2 = *(a1 + 32);
  v3 = v2[2];
  if (!v3)
  {
    ...
    {
      v6 = [v5 initWithMachServiceName:@"com.apple.aa.ageMigration.xpc" options:0];
    }
    ...
    *(v8 + 16) = v7;
    ...
    v10 = *(*(a1 + 32) + 16);
    v11 = +[AAAgeMigrationDaemonInterface XPCInterface];
    [v10 setRemoteObjectInterface:v11];

    v12 = *(*(a1 + 32) + 16);
    v25[0] = MEMORY[0x1E69E9820];
    v25[1] = 3221225472;
    v25[2] = __45__AAAgeMigrationDaemonConnection__connection__block_invoke_2;
    v25[3] = &unk_1E7C9A818;
    ...
    v23[1] = 3221225472;
    v23[2] = __45__AAAgeMigrationDaemonConnection__connection__block_invoke_3;
    v23[3] = &unk_1E7C9A818;
...
void __45__AAAgeMigrationDaemonConnection__connection__block_invoke_2(uint64_t a1)
{
  WeakRetained = objc_loadWeakRetained((a1 + 32));
  [WeakRetained _connectionInterruptionHandler];
}

void __45__AAAgeMigrationDaemonConnection__connection__block_invoke_3(uint64_t a1)
{
  WeakRetained = objc_loadWeakRetained((a1 + 32));
...
- (void)_connectionInvalidationHandler
{
  ...
  v11[1] = 3221225472;
  v11[2] = __64__AAAgeMigrationDaemonConnection__connectionInvalidationHandler__block_invoke;
  v11[3] = &unk_1E7C9A868;
  v11[4] = self;
  os_unfair_lock_lock(&self->_unfairLock);
  __64__AAAgeMigrationDaemonConnection__connectionInvalidationHandler__block_invoke(v11);
  os_unfair_lock_unlock(&self->_unfairLock);
}

void __64__AAAgeMigrationDaemonConnection__connectionInvalidationHandler__block_invoke(uint64_t a1)
{
  [*(*(a1 + 32) + 16) invalidate];
  v2 = *(a1 + 32);
  v3 = *(v2 + 16);
...
- (void)remoteObjectProxyWithErrorHandler:(uint64_t)a1 .cold.1(uint64_t a1, uint64_t a2)
{
  ...
  [v4 handleFailureInMethod:a1 object:a2 file:@"AAAgeMigrationDaemonConnection.m" lineNumber:50 description:{@"Invalid parameter not satisfying: %@", @"handler"}];
}

- (void)synchronousRemoteObjectProxyWithErrorHandler:(uint64_t)a1 .cold.1(uint64_t a1, uint64_t a2)
{
  v4 = [MEMORY[0x1E696AAA8] currentHandler];
  [v4 handleFailureInMethod:a1 object:a2 file:@"AAAgeMigrationDaemonConnection.m" lineNumber:55 description:{@"Invalid parameter not satisfying: %@", @"handler"}];
}
