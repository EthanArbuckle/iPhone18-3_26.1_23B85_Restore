...
- (id)__unlocked_createSettingsDictionaryForUniqueID:(id)a3;
- (id)__unlocked_ctActiveContextsWithError:(id *)a3;
- (id)__unlocked_ctSubscriptionInfoWithError:(id *)a3;
- (id)__unlocked_getCachedSettingOrReadFromBundleForCarrierBundleKey:(id)a3 bundleType:(int64_t)a4 forContext:(id)a5 defaultValue:(id)a6;
- (id)__unlocked_getCarrierSettingsForUniqueID:(id)a3;
...
- (id)ctActiveContextsWithError:(id *)a3;
...
- (void)__unlocked_resetCachedCarrierSettingsForUniqueID:(id)a3;
- (void)__unlocked_setCachedCarrierSettingValue:(id)a3 bundleKey:(id)a4 uniqueID:(id)a5;
- (void)__unlocked_setCarrierSettings:(id)a3 uniqueID:(id)a4;
...
- (void)generateTokenForUPIWithHostBundleID:(id)a3 subscriptionContext:(id)a4;
- (void)resetCacheSubscriptionInfo;
- (void)resetCacheSubscriptionInfoAndPostNotification;
- (void)setAllowedChatBotExtensions:(id)a3;
...
- (NSArray)ctServiceSubscriptions
{
  ...
  else
  {
    ...
    if (IMOSLoggingEnabled())
    {
      ...
      {
        v8 = [v5 __im_logCTXPCServiceSubscriptionContext];
        v10 = 138412290;
        v11 = v8;
...
- (IMCTSubscriptionUtilities)init
{
  ...
  if (v2)
  {
    ...
    v11 = [v10 isDynamicLQMDisabledByWRM];
...
- (void)_registerForWRM
{
  ...
  v4 = [v3 isDynamicLQMDisabledByWRM];
...
- (unint64_t)numberOfSubscriptions
{
  v2 = [(IMCTSubscriptionUtilities *)self ctSubscriptionInfo];
  v3 = [v2 subscriptions];
  v4 = [v3 count];
...
- (BOOL)isDataConnectionExpensive
{
  ...
  {
    v3 = [(IMCTSubscriptionUtilities *)self ctSubscriptionInfo];
    v4 = [v3 __im_preferredDataSubscriptionContext];

    if (v4)
    {
      v5 = [MEMORY[0x1E6965070] descriptorWithSubscriptionContext:v4];
...
- (id)_registeredSims
{
  ...
  v2 = [(IMCTSubscriptionUtilities *)self _iMessageService];
  v3 = [v2 accounts];
...
- (NSArray)registeredSubscriptionSlotIDs
{
  v2 = [(IMCTSubscriptionUtilities *)self _registeredSims];
  v3 = [v2 __imArrayByApplyingBlock:&unk_1F1BA6108];
...
{
  v2 = [(IMCTSubscriptionUtilities *)self _registeredSims];
  v3 = [v2 arrayByApplyingSelector:sel_SIMIdentifier];
...
- (NSArray)registeredPhoneNumbers
{
  ...
  v15 = 0u;
  v16 = 0u;
  v4 = [(IMCTSubscriptionUtilities *)self registeredSubscriptionSlotIDs];
  ...
  if (v5)
  {
    ...
    do
    {
      for (i = 0; i != v6; ++i)
      {
        ...
        v9 = [*(*(&v13 + 1) + 8 * i) intValue];
        v10 = [(IMCTSubscriptionUtilities *)self ctSubscriptionInfo];
        v11 = [v10 __im_phoneNumberForSlotID:v9];
...
- (id)__unlocked_createSettingsDictionaryForUniqueID:(id)a3
{
  ...
  if ([v4 length])
  {
    v5 = [(IMCTSubscriptionUtilities *)self __unlocked_cachedCarrierSettings];
    [v5 setObject:MEMORY[0x1E695E0F8] forKey:v4];
  }
  ...
  else
  {
    ...
    {
      *v7 = 0;
      _os_log_impl(&dword_1A85E5000, v5, OS_LOG_TYPE_INFO, "Could not create settings dictionary because uniqueID is nil", v7, 2u);
    }
  }
...
- (void)__unlocked_resetCachedCarrierSettingsForUniqueID:(id)a3
{
  ...
  if ([v4 length])
  {
    v5 = [(IMCTSubscriptionUtilities *)self __unlocked_createSettingsDictionaryForUniqueID:v4];
...
- (id)__unlocked_getCarrierSettingsForUniqueID:(id)a3
{
  ...
  if ([v4 length])
  {
    ...
    if (!v6)
    {
      v6 = [(IMCTSubscriptionUtilities *)self __unlocked_createSettingsDictionaryForUniqueID:v4];
    }
  }
...
- (void)__unlocked_setCarrierSettings:(id)a3 uniqueID:(id)a4
{
  ...
  if (v8 && [v6 length])
  {
    v7 = [(IMCTSubscriptionUtilities *)self __unlocked_cachedCarrierSettings];
...
- (id)_cachedCarrierKeyForKeyHierarchy:(id)a3 bundleType:(int64_t)a4
{
  ...
  v6 = a3;
  if ([v6 count] && (objc_msgSend(v6, "lastObject"), v7 = objc_claimAutoreleasedReturnValue(), v8 = objc_msgSend(v7, "length"), v7, v8))
  {
    v9 = MEMORY[0x1E696AD60];
    v10 = [(IMCTSubscriptionUtilities *)self stringForBundleType:a4];
...
- (id)_getCachedCarrierSettingValueForBundleKey:(id)a3 uniqueID:(id)a4
{
  ...
  {
    v8 = [(IMCTSubscriptionUtilities *)self __unlocked_getCarrierSettingsForUniqueID:v7];
...
- (void)__unlocked_setCachedCarrierSettingValue:(id)a3 bundleKey:(id)a4 uniqueID:(id)a5
{
  ...
  if ([v10 length])
  {
    v11 = [(IMCTSubscriptionUtilities *)self __unlocked_getCarrierSettingsForUniqueID:v10];
    v12 = [v11 mutableCopy];
    ...
    if (v8)
    {
      if (v12)
      {
        if ([v9 length])
        {
          ...
          [(IMCTSubscriptionUtilities *)self __unlocked_setCarrierSettings:v12 uniqueID:v10];
          if (IMOSLoggingEnabled())
          {
...
- (id)__unlocked_getCachedSettingOrReadFromBundleForCarrierBundleKey:(id)a3 bundleType:(int64_t)a4 forContext:(id)a5 defaultValue:(id)a6
{
  ...
  v11 = a5;
  v12 = a6;
  v13 = [(IMCTSubscriptionUtilities *)self _cachedCarrierSettingsUniqueIDKeyForSubscriptionContext:v11];
  v14 = [(IMCTSubscriptionUtilities *)self _cachedCarrierKeyForKeyHierarchy:v10 bundleType:a4];
  ...
  if (!v15)
  {
    ...
    v26 = [[qword_1ED8CA330 alloc] initWithBundleType:a4];
    v17 = v12;
    coreTelephonyClient = self->_coreTelephonyClient;
    v27 = 0;
    v19 = [(CoreTelephonyClient *)coreTelephonyClient copyCarrierBundleValueWithDefault:v11 keyHierarchy:v10 bundleType:v26 error:&v27];
    v20 = v27;
    if (v19)
    {
      if (IMOSLoggingEnabled())
...
- (BOOL)simInHomeCountryWithSubscriptionContext:(id)a3
{
  coreTelephonyClient = self->_coreTelephonyClient;
  v9 = 0;
  v4 = [(CoreTelephonyClient *)coreTelephonyClient copyRegistrationDisplayStatus:a3 error:&v9];
  v5 = v9;
  if (v5)
  {
...
- (BOOL)wifiCallingEnabledForSubscriptionContext:(id)a3
{
  coreTelephonyClient = self->_coreTelephonyClient;
  v9 = 0;
  v4 = [(CoreTelephonyClient *)coreTelephonyClient getCallCapabilities:a3 error:&v9];
  v5 = v9;
  if (v5)
  {
...
- (id)copyIsoCountryCodeForSubscriptionContext:(id)a3
{
  coreTelephonyClient = self->_coreTelephonyClient;
  v14 = 0;
  v5 = [(CoreTelephonyClient *)coreTelephonyClient copyMobileSubscriberCountryCode:a3 error:&v14];
  v6 = v14;
  if (v6)
  {
    v7 = v6;
...
{
  v2 = [(IMCTSubscriptionUtilities *)self ctSubscriptionInfo];
  v3 = [v2 preferredOrDefaultSubscriptionContext];
  v4 = [v3 phoneNumber];
...
- (void)__unlocked_fetchAllowedChatBotExtensionsIfNecessary
{
  ...
  if (!self->_allowedChatBotExtensions)
  {
    ...
    v28 = 0u;
    v29 = 0u;
    v4 = [(IMCTSubscriptionUtilities *)v2 __unlocked_ctSubscriptionInfoWithError:0];
    v5 = [v4 subscriptions];
    ...
    if (v6)
    {
      ...
      do
      {
        for (i = 0; i != v7; ++i)
        {
          ...
          v10 = *(*(&v26 + 1) + 8 * i);
          v11 = [(IMCTSubscriptionUtilities *)v2 _cachedCarrierSettingsUniqueIDKeyForSubscriptionContext:v10];
          v12 = v11;
          if (v10)
          {
            if ([v11 length])
            {
              v10 = [(IMCTSubscriptionUtilities *)v2 __unlocked_getCachedSettingOrReadFromBundleForCarrierBundleKey:&unk_1F1BFAD00 bundleType:1 forContext:v10 defaultValue:MEMORY[0x1E695E0F0]];
              if (v10)
              {
                objc_opt_class();
    ...
    allowedChatBotExtensions = v2->_allowedChatBotExtensions;
    v2->_allowedChatBotExtensions = v3;
  }
}
...
- (void)carrierBundleChange:(id)a3
{
  ...
  v6 = [(IMCTSubscriptionUtilities *)self _cachedCarrierSettingsUniqueIDKeyForSubscriptionContext:v4];
  queue = self->_queue;
  v9[0] = MEMORY[0x1E69E9820];
  v9[1] = 3221225472;
  v9[2] = sub_1A866BB68;
...
- (id)rcsConfigurationForSubscriptionContext:(id)a3
{
  v4 = a3;
  v9 = 0;
  v5 = [(IMCTSubscriptionUtilities *)self rcsConfigurationForSubscriptionContext:v4 error:&v9];
  v6 = v9;
  if (v6)
  {
...
- (void)generateTokenForUPIWithHostBundleID:(id)a3 subscriptionContext:(id)a4
{
  ...
  v9 = [(IMCTSubscriptionUtilities *)self coreTelephonyClient];
  [v9 generateTokenForContext:v7 bundleID:v6 completion:&unk_1F1BA6128];
}
