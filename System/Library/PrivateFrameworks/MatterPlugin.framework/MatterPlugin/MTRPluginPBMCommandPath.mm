...
- (BOOL)isEqual:(id)a3
{
  ...
  if (*&self->_has)
  {
    if ((*(v4 + 20) & 1) != 0 && self->_commandID == *(v4 + 4))
    {
      v6 = 1;
      goto LABEL_9;
    }
...
- (MTRCommandPath)commandPath
{
  ...
  v5 = [(MTRPluginPBMCommandPath *)self clusterPath];
  v6 = [v4 numberWithUnsignedInt:{objc_msgSend(v5, "endpointID")}];
  v7 = MEMORY[0x277CCABB0];
  v8 = [(MTRPluginPBMCommandPath *)self clusterPath];
...
- (BOOL)isValid
{
  ...
  v3 = [(MTRPluginPBMCommandPath *)self clusterPath];
  v4 = [v3 isValid];
