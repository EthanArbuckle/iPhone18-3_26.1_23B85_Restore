...
- (MTRPluginPBMUUID)initWithUUID:(id)d;
- (NSUUID)uuid;
...
{
  dCopy = d;
  if (dCopy && (self = [(MTRPluginPBMUUID *)self init]) != 0)
  {
    uUIDString = [dCopy UUIDString];
    [(MTRPluginPBMUUID *)self setValue:uUIDString];
...
- (NSUUID)uuid
{
  ...
  value = [(MTRPluginPBMUUID *)self value];
...
- (id)description
{
  ...
  dictionaryRepresentation = [(MTRPluginPBMUUID *)self dictionaryRepresentation];
