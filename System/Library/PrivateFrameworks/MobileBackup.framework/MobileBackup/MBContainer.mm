...
+ (id)containerWithPropertyList:(id)list volumeMountPoint:(id)point
{
  ...
  v9 = [objc_alloc(*off_1003C28D8[v8]) initWithPropertyList:listCopy volumeMountPoint:pointCopy];
...
- (int)containerType
{
  ...
  v3 = sub_100260ED8(containerTypeString);
...
- (NSString)safeHarborDir
{
  if (![(MBContainer *)self isSafeHarbor])
  {
    ...
    [v7 handleFailureInMethod:a2 object:self file:@"MBApp.m" lineNumber:301 description:@"Not a safe harbor"];
  }
  ...
  if (v5)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        if (qword_100421C08 != -1)
        {
          dispatch_once(&qword_100421C08, &stru_1003C2770);
        }

        if ([qword_100421C00 containsObject:v9])
        {
