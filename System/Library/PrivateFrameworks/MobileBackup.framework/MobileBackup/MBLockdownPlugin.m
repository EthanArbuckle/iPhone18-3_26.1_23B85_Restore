...
- (id)preparingBackupWithEngine:(id)a3
{
  ...
  if (v56)
  {
    v55 = [NSMutableDictionary dictionaryWithCapacity:0];
    v5 = MBGetDefaultLog();
    ...
    v74 = 0u;
    v6 = sub_1001490C0();
    v7 = [v6 countByEnumeratingWithState:&v73 objects:v85 count:16];
    if (v7)
    {
      v8 = *v74;
      do
      {
        for (i = 0; i != v7; i = i + 1)
        {
          ...
          if (v13)
          {
            [v55 setObject:v13 forKeyedSubscript:v10];
          }
        }
    ...
    if ([v45 backsUpPrimaryAccount])
    {
      ...
      v48 = [obj countByEnumeratingWithState:&v69 objects:v80 count:16];
      if (v48)
      {
        v47 = *v70;
        do
        {
          for (j = 0; j != v48; j = j + 1)
          {
            ...
            v17 = [v56 objectForDomain:v15 andKey:0];
            v51 = v17;
            if (v17)
            {
              v67 = 0u;
              ...
              if (v19)
              {
                ...
                do
                {
                  for (k = 0; k != v19; k = k + 1)
                  {
                    ...
                    v22 = *(*(&v65 + 1) + 8 * k);
                    v23 = [v18 objectForKeyedSubscript:{v22, v43, v44}];
                    v24 = MBGetDefaultLog();
              ...
              [v55 setObject:v18 forKeyedSubscript:v49];
            }
      ...
      v61 = 0u;
      v62 = 0u;
      v52 = [&off_1003E1E88 countByEnumeratingWithState:&v61 objects:v78 count:16];
      if (v52)
      {
        v50 = *v62;
        do
        {
          for (m = 0; m != v52; m = m + 1)
          {
            ...
            v31 = [v30 countByEnumeratingWithState:&v57 objects:v77 count:16];
            if (v31)
            {
              v32 = *v58;
              do
              {
                for (n = 0; n != v31; n = n + 1)
                {
                  ...
                  v34 = *(*(&v57 + 1) + 8 * n);
                  v35 = [v56 objectForDomain:v27 andKey:{v34, v43, v44}];
                  v36 = MBGetDefaultLog();
            ...
            [v55 setObject:v29 forKeyedSubscript:v27];
          }
...
LABEL_73:
        ...
        v65 = 0u;
        v66 = 0u;
        v54 = [&off_1003E1E88 countByEnumeratingWithState:&v65 objects:v83 count:16];
        if (v54)
        {
          v56 = *v66;
          do
