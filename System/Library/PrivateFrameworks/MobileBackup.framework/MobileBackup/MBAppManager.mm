...
+ (id)_volumesToBackUpForPersona:(id)a3
{
  ...
  v4 = [v3 allObjects];
  v5 = [v4 sortedArrayUsingComparator:&stru_1003C0228];
        ...
        if (v25)
        {
          ...
          do
          {
            for (j = 0; j != v25; j = j + 1)
            {
              ...
              v33 = MBStringForContainerType(v30);
              v34 = MBGetDefaultLog();
...
- (id)containerWithIdentifier:(id)a3 containerType:(int)a4
{
  ...
  {
    v7 = [*(&self->super.isa + qword_1002B9F50[a4 - 1]) objectForKeyedSubscript:v6];
  }
        ...
        if (v18)
        {
          ...
          do
          {
            for (i = 0; i != v19; i = i + 1)
            {
              ...
              v27 = MBStringForContainerType(v24);
              v28 = MBGetDefaultLog();
