...
- (id)domainForName:(id)a3
{
  ...
  else
  {
    ...
    v13 = v11;
    [(NSMutableDictionary *)self->_domainsByName setObject:v11 forKeyedSubscript:v5, v16];
    v7 = v13;
  }
...
- (void)addDomain:(id)a3
{
  ...
  if (v6)
  {
    ...
    [v7 handleFailureInMethod:a2 object:self file:@"MBDomainManager.m" lineNumber:285 description:{@"Domain already exists: %@", v5}];
  }
