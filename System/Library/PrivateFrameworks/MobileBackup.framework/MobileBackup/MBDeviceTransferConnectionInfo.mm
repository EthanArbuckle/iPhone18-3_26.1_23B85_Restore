...
{
  v4 = a3;
  [v4 encodeInteger:-[MBDeviceTransferConnectionInfo connectionState](self forKey:{"connectionState"), @"connectionState"}];
  [v4 encodeInteger:-[MBDeviceTransferConnectionInfo connectionType](self forKey:{"connectionType"), @"connectionType"}];
}
