...
- (MBDriveRestoreEngine)initWithSettingsContext:(id)context debugContext:(id)debugContext
{
  ...
  if (!v8)
  {
    ...
    v32 = [NSString stringWithUTF8String:"[MBDriveRestoreEngine initWithSettingsContext:debugContext:]"];
    [v31 handleFailureInFunction:v32 file:@"MBDriveRestoreEngine.m" lineNumber:97 description:{@"Unable to obtain personal persona for restore engine: %@", v9}];
  }
  ...
  if (v11)
  {
    ...
    [(MBDomainManager *)v10 setDelegate:v11];
  }
...
- (BOOL)encrypted
{
  ...
  if (!manifest)
  {
    ...
    [v8 handleFailureInMethod:a2 object:self file:@"MBDriveRestoreEngine.m" lineNumber:143 description:@"Manifest not loaded yet"];
...
- (MBManifest)manifest
{
  ...
  if (!manifest)
  {
    ...
    [v6 handleFailureInMethod:a2 object:self file:@"MBDriveRestoreEngine.m" lineNumber:153 description:@"No manifest yet"];
...
- (id)_preconditions
{
  ...
  v59 = 0;
  v11 = [(MBBackupHelper *)backupHelper readBackupManifestWithError:&v59];
  v12 = v59;
  if (v12)
  {
    v13 = v12;
  ...
  if ((shouldRestoreSystemFiles3 & 1) == 0)
  {
    ...
    {
      *buf = 0;
      _os_log_impl(&_mh_execute_header, v26, OS_LOG_TYPE_DEFAULT, "Not restoring system files", buf, 2u);
      _MBLog();
    }
  }
  ...
  if (!v27)
  {
    v28 = +[MBManagedPolicy sharedPolicy];
    v57 = 0;
    v29 = [v28 checkIfDriveRestoreIsAllowed:&v57];
    v30 = v57;
...
LABEL_40:
    ...
    {
      v34 = objc_alloc_init(MBManager);
    }

    v35 = v34;

    v56 = 0;
    v36 = [v35 restoreStateWithError:&v56];
    v37 = v56;
    if (v36)
    {
      state = [v36 state];
      ...
      if (state >= 7 || ((0x71u >> state) & 1) == 0)
      {
        ...
        if (os_log_type_enabled(v40, OS_LOG_TYPE_ERROR))
        {
          *buf = 67109120;
          LODWORD(v61) = v39;
          _os_log_impl(&_mh_execute_header, v40, OS_LOG_TYPE_ERROR, "Restore from iTunes Backup is unavailable while an iCloud Restore is in progress (%d)", buf, 8u);
          v53 = v39;
          _MBLog();
        }

        v41 = @"Restore from iTunes Backup is unavailable while an iCloud Restore is in progress";
        v42 = 25;
LABEL_38:
        v14 = [MBError errorWithCode:v42 format:v41, v53];
        goto LABEL_39;
      }
    }
    ...
    {
      v43 = [MBError isError:v37 withCode:210];
      v44 = MBGetDefaultLog();
      v45 = v44;
      if ((v43 & 1) == 0)
      {
        if (os_log_type_enabled(v44, OS_LOG_TYPE_ERROR))
        {
          *buf = 138543362;
          v61 = v37;
          _os_log_impl(&_mh_execute_header, v45, OS_LOG_TYPE_ERROR, "Failed to fetch iCloud Restore state: %{public}@", buf, 0xCu);
          v53 = v37;
          _MBLog();
        }

        v41 = @"Failed to determine iCloud Restore state";
        v42 = 1;
        goto LABEL_38;
      }
      ...
      {
        *buf = 0;
        _os_log_impl(&_mh_execute_header, v45, OS_LOG_TYPE_DEFAULT, "No iCloud account", buf, 2u);
        _MBLog();
      }
    }
