  ...
  if (v3)
  {
    ...
    if (v2)
    {
      ...
      for (i = 0; i < v2; i += 2)
      {
        ...
        if (i + 1 >= v2)
        {
          v12 = (((*(v5 + i) - ((109 * *(v5 + i)) >> 8)) >> 1) + ((109 * *(v5 + i)) >> 8)) >> 5;
          *v8 = hk_base45Encoded_characterSet[(*(v5 + i) - 45 * v12)];
          LODWORD(v6) = v6 + 2;
...
- (id)hk_zlibCompressedIncludingHeaderAndTrailer:()HealthRecordServices errorOut:
{
  v5 = [a1 compressedDataUsingAlgorithm:3 error:?];
  v6 = v5;
  if (v5)
  {
    if (a3)
    {
      v7 = adler32(0, 0, 0);
      v10 = bswap32(adler32(v7, [a1 bytes], objc_msgSend(a1, "length")));
      v8 = [MEMORY[0x277CBEB28] data];
      [v8 appendBytes:&hk_zlibCompressedIncludingHeaderAndTrailer_errorOut__defaultCompression length:2];
      [v8 appendData:v6];
