...
- (id)formattedInfoStringJoinedByString:(id)a3
{
  ...
  v25 = [v24 componentsJoinedByString:v44];
...
- (BOOL)isEqual:(id)a3
{
  ...
  else
  {
    ...
    if (objc_opt_isKindOfClass())
    {
      ...
      v8 = [(HKClinicalIngestionPerAccountOutcome *)v6 accountIdentifier];
      ...
      else
      {
        ...
        if (v9)
        {
          ...
          v11 = [(HKClinicalIngestionPerAccountOutcome *)v6 accountIdentifier];
...
- (HKClinicalIngestionPerAccountOutcome)initWithCoder:(id)a3
{
  ...
  v6 = [v4 decodeIntegerForKey:@"Info"];
