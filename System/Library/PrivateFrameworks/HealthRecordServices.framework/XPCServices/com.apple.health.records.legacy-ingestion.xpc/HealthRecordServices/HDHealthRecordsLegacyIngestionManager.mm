...
- (id)_credentialedSessionSuitableForConnectionInformation:(id)information;
- (id)logPrefix;
...
- (void)performDownloadRequest:(id)request completion:(id)completion
{
  ...
  {
    v10 = v9;
    logPrefix = [(HDHealthRecordsLegacyIngestionManager *)self logPrefix];
    *buf = 138543618;
    v32 = logPrefix;
    v33 = 2114;
    v34 = requestCopy;
  ...
  v14 = [(HDHealthRecordsLegacyIngestionManager *)self _credentialedSessionSuitableForConnectionInformation:accountInformation];
  ...
  if (v17)
  {
    [(NSOperationQueue *)self->_ingestionQueue addOperation:v17, v23, v24, v25, v26, selfCopy, v28];
  }
  ...
  else
  {
    ...
    v22 = [v21 initWithError:{v19, v23, v24, v25, v26, selfCopy, v28}];
    (*(v16 + 2))(v16, v22);
  }
}
...
- (void)fetchAccessTokenForTokenSession:(id)session connectionInformation:(id)information completion:(id)completion
{
  ...
  v27 = 0;
  v14 = [HDFHIRSpecification specificationWithConnectionInformation:informationCopy error:&v27];
...
- (void)fetchOrRefreshCredentialForAccount:(id)account completion:(id)completion
{
  ...
  v12 = [(HDHealthRecordsLegacyIngestionManager *)self _credentialedSessionSuitableForConnectionInformation:accountCopy];
  credentialVendor = [v12 credentialVendor];
  ...
  v14 = completionCopy;
  v15 = accountCopy;
  [credentialVendor fetchOrRefreshCredentialWithCompletion:v16];
}
...
- (id)_credentialedSessionSuitableForConnectionInformation:(id)information
{
  ...
  v6 = [(NSMutableDictionary *)self->_credentialedSessionByAccountIdentifier objectForKeyedSubscript:accountIdentifier];
  if (!v6)
  {
    v7 = [[HDFHIRSpecification alloc] initWithConnectionInformation:informationCopy];
    authorization = [informationCopy authorization];
    v9 = [[HDFHIRCredentialVendor alloc] initWithCredential:authorization];
    ...
    [(NSMutableDictionary *)self->_credentialedSessionByAccountIdentifier setObject:v6 forKeyedSubscript:accountIdentifier];
  }
