...
void __39__MOConnection_onConnectionInterrupted__block_invoke_cold_1(uint64_t a1, void *a2, NSObject *a3)
{
  ...
  v9 = 2048;
  v10 = [a2 count];
  _os_log_fault_impl(&dword_25A200000, a3, OS_LOG_TYPE_FAULT, "[%s] The connection has been interrupted with %lu pending tasks", &v7, 0x16u);
...
void __39__MOConnection_onConnectionInterrupted__block_invoke_cold_2(uint64_t a1, NSObject *a2)
{
  ...
  v5 = 136315138;
  v6 = v3;
  _os_log_error_impl(&dword_25A200000, a2, OS_LOG_TYPE_ERROR, "[%s] The connection has been interrupted with zero pending tasks", &v5, 0xCu);
