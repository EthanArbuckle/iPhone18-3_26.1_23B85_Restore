...
void __43__MOConnectionManager__getActiveConnection__block_invoke(uint64_t a1)
{
  ...
  if (WeakRetained)
  {
    ...
    if (os_log_type_enabled(v4, OS_LOG_TYPE_INFO))
    {
      ...
      v7 = 138412290;
      v8 = v5;
      _os_log_impl(&dword_25A200000, v4, OS_LOG_TYPE_INFO, "Connection '%@' Invalidated", &v7, 0xCu);
    }
  }
...
- (id)getSyncProxyProvider
{
  ...
  aBlock[1] = 3221225472;
  aBlock[2] = __43__MOConnectionManager_getSyncProxyProvider__block_invoke;
  aBlock[3] = &unk_27991F2A0;
  aBlock[4] = self;
...
- (id)getAsyncProxyProvider
{
  aBlock[0] = MEMORY[0x277D85DD0];
  aBlock[1] = 3221225472;
  aBlock[2] = __44__MOConnectionManager_getAsyncProxyProvider__block_invoke;
  aBlock[3] = &unk_27991F2A0;
  aBlock[4] = self;
  v2 = _Block_copy(aBlock);
  v3 = _Block_copy(v2);
...
- (void)_getActiveConnection
{
  ...
  _os_log_error_impl(&dword_25A200000, v2, OS_LOG_TYPE_ERROR, "Can't activate connection '%@': nil delegate", v4, 0xCu);
...
- (void)withProxyProvider:proxyHandler:onError:.cold.1()
{
  ...
  v3 = 1024;
  v4 = 210;
  _os_log_error_impl(&dword_25A200000, v0, OS_LOG_TYPE_ERROR, "Should use valid sync proxy block handler (in %s:%d)", v2, 0x12u);
...
void __62__MOConnectionManager_withProxyProvider_proxyHandler_onError___block_invoke_cold_1(uint64_t a1, void *a2)
{
  ...
  OUTLINED_FUNCTION_3_0(&dword_25A200000, v6, v7, "%@: proxy error, %@, %@, retrying...", v8, v9, v10, v11, v13);
...
void __62__MOConnectionManager_withProxyProvider_proxyHandler_onError___block_invoke_27_cold_1(uint64_t a1, void *a2)
{
  ...
  v5 = [a2 localizedFailureReason];
  OUTLINED_FUNCTION_0_0();
  OUTLINED_FUNCTION_3_0(&dword_25A200000, v6, v7, "%@: proxy error, %@, %@.", v8, v9, v10, v11, v13);
