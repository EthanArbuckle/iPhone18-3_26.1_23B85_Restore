...
- (PK_PHDevice)init
{
  ...
  if (v2)
  {
    ...
    v5 = [(PK_PHDevice *)v2 dispatchQueue];
...
- (BOOL)isCellularRadioEnabled
{
  ...
  v8 = 0x2020000000;
  v9 = 0;
  v3 = [(PK_PHDevice *)self dispatchQueue];
...
- (void)setCellularRadioEnabled:(BOOL)a3
{
  v5 = [(PK_PHDevice *)self dispatchQueue];
...
- (void)registerForRingerStateNotifications
{
  if ([(PK_PHDevice *)self ringerStateNotifyToken]== -1)
  {
    ...
    v4 = [(PK_PHDevice *)self dispatchQueue];
    v5[0] = MEMORY[0x277D85DD0];
    v5[1] = 3221225472;
...
- (void)airplaneModeChanged
{
  v3 = [(PK_PHDevice *)self fetchCellularRadioEnabled];

  [(PK_PHDevice *)self setCellularRadioEnabled:v3];
}
