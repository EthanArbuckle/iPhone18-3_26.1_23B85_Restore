...
- (FICopyOperation)initWithSourceItems:(id)items destinationItem:(id)item;
- (FICopyOperation)initWithSourceNodes:(id)nodes destinationFolder:(id)folder;
...
- (void)initWithSourceItems:destinationItem:
{
  v4 = TNSWeakPtr<FICopyOperation>::Lock((self + 8));
  if (v4)
  {
    v5 = a2[1];
    if (*(v5 - 8) == 1)
