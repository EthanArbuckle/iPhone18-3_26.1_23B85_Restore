...
- (void)_beginSessionWithAsset:(id)asset fromViewController:(id)controller sourceElement:(id)element includeMarkupInList:(BOOL)list;
- (void)_launchPlugin:(id)plugin afterDismissingViewController:(id)controller;
- (void)_pluginManagerPluginsDidChange:(id)change;
- (void)_unlockScreenIfNeededWithCompletionHandler:(id)handler;
- (void)beginMarkupSessionWithAsset:(id)asset fromViewController:(id)controller;
- (void)beginSessionWithAsset:(id)asset fromViewController:(id)controller sourceElement:(id)element includeMarkupInList:(BOOL)list;
- (void)dealloc;
- (void)editExtensionActivityViewController:(id)controller didSelectActivity:(id)activity;
- (void)editPluginHostViewController:(id)controller commitContentEditingOutput:(id)output withCompletionHandler:(id)handler;
- (void)editPluginHostViewController:(id)controller didFinishWithCompletionType:(unint64_t)type;
- (void)editPluginHostViewController:(id)controller loadItemProviderWithHandler:(id)handler;
...
- (void)editPluginHostViewController:(id)controller didFinishWithCompletionType:(unint64_t)type
{
  ...
  hostViewController = [(PUEditPluginSession *)self hostViewController];
  if (!hostViewController)
  {
    hostViewController = [controllerCopy presentingViewController];
  }
  ...
  v8[4] = self;
  v8[5] = type;
  [hostViewController dismissViewControllerAnimated:1 completion:v8];
}
...
- (void)editPluginHostViewController:(id)controller commitContentEditingOutput:(id)output withCompletionHandler:(id)handler
{
  ...
  [dataSource editPluginSession:self commitContentEditingOutput:outputCopy withCompletionHandler:handlerCopy];
}
...
- (void)editPluginHostViewController:(id)controller loadItemProviderWithHandler:(id)handler
{
  ...
  if (!currentPlugin)
  {
    ...
    [currentHandler handleFailureInMethod:a2 object:self file:@"PUEditPluginSession.m" lineNumber:502 description:@"no current plugin"];
  }
  ...
  if (!dataSource)
  {
    ...
    [currentHandler2 handleFailureInMethod:a2 object:self file:@"PUEditPluginSession.m" lineNumber:503 description:@"data source missing"];
  }
  ...
  dataSource2 = [(PUEditPluginSession *)self dataSource];
  ...
  v13 = handlerCopy;
  v14 = controllerCopy;
  [dataSource2 editPluginSession:self loadAdjustmentDataWithHandler:v17];
}
...
- (void)_launchPlugin:(id)plugin afterDismissingViewController:(id)controller
{
  ...
  {
    currentHandler = [MEMORY[0x1E696AAA8] currentHandler];
    [currentHandler handleFailureInMethod:a2 object:self file:@"PUEditPluginSession.m" lineNumber:437 description:@"previous plugin selected"];
  }
  ...
  [(PUEditPluginSession *)self setCurrentPlugin:pluginCopy];
  delegate = [(PUEditPluginSession *)self delegate];
  v13 = objc_opt_respondsToSelector();

  if (v13)
  {
    delegate2 = [(PUEditPluginSession *)self delegate];
    [delegate2 editPluginSessionWillBegin:self];
  }

  v15 = dispatch_group_create();
  v16 = [[PUEditPluginHostViewController alloc] initWithPlugin:pluginCopy];
  ...
  if (controllerCopy)
  {
    ...
    presentedViewController = [v18 presentedViewController];

    if (presentedViewController)
    {
      presentedViewController2 = [v18 presentedViewController];
      v31[0] = MEMORY[0x1E69E9820];
      v31[1] = 3221225472;
      v31[2] = __67__PUEditPluginSession__launchPlugin_afterDismissingViewController___block_invoke_4;
      v31[3] = &unk_1E7B80C88;
      v32 = v19;
      [presentedViewController2 dismissViewControllerAnimated:0 completion:v31];
    }
  ...
  [(PUProgressView *)v24 showInView:view animated:1 afterDelay:2.0];
...
- (void)presentAlertController:(id)controller
{
  controllerCopy = controller;
  hostViewController = [(PUEditPluginSession *)self hostViewController];
  presentedViewController = [hostViewController presentedViewController];

  if (presentedViewController)
  {
    do
    {
      presentedViewController2 = [hostViewController presentedViewController];

      v6PresentedViewController = [presentedViewController2 presentedViewController];

      hostViewController = presentedViewController2;
    }
  ...
  {
    presentedViewController2 = hostViewController;
  }
...
- (void)editExtensionActivityViewController:(id)controller didSelectActivity:(id)activity
{
  ...
  {
    plugin = [activityCopy plugin];
    if (!plugin)
    {
      currentHandler = [MEMORY[0x1E696AAA8] currentHandler];
      [currentHandler handleFailureInMethod:a2 object:self file:@"PUEditPluginSession.m" lineNumber:405 description:@"no plugin selected"];
    }
    ...
    currentPlugin2 = [(PUEditPluginSession *)self currentPlugin];
...
- (id)_localizedEditorListTitle
{
  pluginManagerMediaType = [(PUEditPluginSession *)self pluginManagerMediaType];
  if (pluginManagerMediaType > 3)
  {
    v3 = 0;
  }
  ...
  {
    v3 = PULocalizedString(off_1E7B76D18[pluginManagerMediaType]);
  }
...
- (void)_beginSessionWithAsset:(id)asset fromViewController:(id)controller sourceElement:(id)element includeMarkupInList:(BOOL)list
{
  ...
  elementCopy = element;
  controllerCopy = controller;
  [(PUEditPluginSession *)self setAsset:asset];
  [(PUEditPluginSession *)self setHostViewController:controllerCopy];
  ...
  {
    dataSource2 = [(PUEditPluginSession *)self dataSource];
    v18 = [dataSource2 pluginActivitiesForEditPluginSession:self];
  ...
  _linkPresentationImage = [(PUEditPluginSession *)self _linkPresentationImage];
  [v26 setThumbnail:_linkPresentationImage];

  v28 = +[PUPhotoEditProtoSettings sharedInstance];
  editMenuEnabled = [v28 editMenuEnabled];
  ...
  {
    currentHandler = [MEMORY[0x1E696AAA8] currentHandler];
    [currentHandler handleFailureInMethod:a2 object:self file:@"PUEditPluginSession.m" lineNumber:365 description:@"source element is not a UIView"];
  }

  v33 = elementCopy;
  popoverPresentationController = [(PUEditExtensionActivityViewController *)v23 popoverPresentationController];
  ...
  popoverPresentationController2 = [(PUEditExtensionActivityViewController *)v23 popoverPresentationController];
  [popoverPresentationController2 setSourceRect:{v36, v38, v40, v42}];

  hostViewController = [(PUEditPluginSession *)self hostViewController];
  [hostViewController presentViewController:v23 animated:1 completion:0];
}
...
- (void)_beginMarkupSessionWithAsset:(id)asset fromViewController:(id)controller
{
  ...
  [(PUEditPluginSession *)self setAsset:assetCopy];
  [(PUEditPluginSession *)self setHostViewController:controllerCopy];
...
- (void)_unlockScreenIfNeededWithCompletionHandler:(id)handler
{
  ...
  if (!v4)
  {
    ...
    [currentHandler handleFailureInFunction:v18 file:@"PUEditPluginSession.m" lineNumber:48 description:{@"%s", dlerror()}];
  ...
  if (!v8)
  {
    ...
    [currentHandler2 handleFailureInFunction:v20 file:@"PUEditPluginSession.m" lineNumber:47 description:{@"%s", dlerror()}];
  ...
  if (v25)
  {
    ...
    [currentHandler3 handleFailureInFunction:v22 file:@"PUEditPluginSession.m" lineNumber:46 description:{@"%s", dlerror()}];
...
- (BOOL)markupIsAvailable
{
  ...
  {
    hasMarkupPlugin = [(PUEditPluginManager *)self->_pluginManager hasMarkupPlugin];
    v5 = @"NO";
    if (hasMarkupPlugin)
    {
      v5 = @"YES";
...
- (void)setIsAvailable:(BOOL)available
{
  if (self->_isAvailable != available)
  {
    ...
    {
      delegate2 = [(PUEditPluginSession *)self delegate];
      [delegate2 editPluginSessionAvailabilityDidChange:self];
    }
  }
}
...
- (void)updateAvailability
{
  ...
  hasNonMarkupPlugins = [(PUEditPluginManager *)self->_pluginManager hasNonMarkupPlugins];
  v4 = PLPhotoEditGetLog();
  if (os_log_type_enabled(v4, OS_LOG_TYPE_DEFAULT))
  {
    v5 = @"NO";
    if (hasNonMarkupPlugins)
    {
      v5 = @"YES";
    }
  ...
  {
    dataSource2 = [(PUEditPluginSession *)self dataSource];
    v9 = [dataSource2 pluginActivitiesForEditPluginSession:self];
  }
...
{
  currentHandler = [MEMORY[0x1E696AAA8] currentHandler];
  [currentHandler handleFailureInMethod:a2 object:self file:@"PUEditPluginSession.m" lineNumber:178 description:@"subclass to implement"];
}

- (unint64_t)pluginManagerMediaType
{
  currentHandler = [MEMORY[0x1E696AAA8] currentHandler];
  [currentHandler handleFailureInMethod:a2 object:self file:@"PUEditPluginSession.m" lineNumber:173 description:@"subclass to implement"];
...
- (void)updatePluginManager
{
  ...
  defaultCenter = [MEMORY[0x1E696AD88] defaultCenter];
  [defaultCenter addObserver:self selector:sel__pluginManagerPluginsDidChange_ name:@"PUEditPluginManagerPluginsDidChangeNotification" object:self->_pluginManager];
