...
- (void)_initializeContent
{
  ...
  v8 = [MEMORY[0x1E69DCC28] footerConfiguration];
...
LABEL_57:
  ...
  do
  {
    ...
    do
    {
      ...
      if (!v19 || (AXDeviceHasHomeButton() & 1) == 0)
      {
        ...
        if ([v26 length])
        {
          v27 = [(PSSpecifier *)self->_specifier target];
          v140 = [v27 safeStringForKey:v26];
        ...
        if ([v25 length])
        {
          ...
          [(UILabel *)self->_headerLabel setBackgroundColor:v32];
          ...
          {
            [(UILabel *)self->_headerLabel setTextColor:v121];
          }

          v134 = [MEMORY[0x1E69DB880] preferredFontDescriptorWithTextStyle:v123 addingSymbolicTraits:2 options:0];
          ...
          v38 = [(AXUISettingsInstructionsView *)self contentView];
          [v38 addSubview:self->_headerLabel];

          v39 = [(UILabel *)self->_headerLabel leadingAnchor];
          v40 = [(AXUISettingsInstructionsView *)self contentView];
          v41 = [v40 leadingAnchor];
          v42 = [v39 constraintEqualToAnchor:v41 constant:0.0];
          ...
          v44 = [v43 topAnchor];
          v45 = [v125 constraintEqualToAnchor:v44 constant:5.0];
          v162[0] = v45;
          v162[1] = v42;
          v46 = [(UILabel *)self->_headerLabel trailingAnchor];
          v47 = [(AXUISettingsInstructionsView *)self contentView];
          v48 = [v47 trailingAnchor];
          [v46 constraintLessThanOrEqualToAnchor:v48 constant:-15.0];
          v50 = v49 = self;
          v162[2] = v50;
          v51 = [MEMORY[0x1E695DEC8] arrayWithObjects:v162 count:3];
          [v124 addObjectsFromArray:v51];
        ...
        if ([v140 length])
        {
          ...
          if (AXProcessIsSetup() && !_UISolariumEnabled())
          {
            v60 = [getBFFStyleClass() sharedStyle];
            [v60 applyThemeToLabel:v34];
          }

          else
          {
            [(UILabel *)v34 setTextColor:v121];
          }
          ...
          v64 = [(UILabel *)v34 topAnchor];
          if (v10)
          {
            v65 = [(UILabel *)v10 bottomAnchor];
            v134 = [v64 constraintEqualToAnchor:v65 constant:0.0];
          }
          ...
          else
          {
            ...
            v66 = [v65 topAnchor];
            v134 = [v64 constraintEqualToAnchor:v66 constant:5.0];
          }

          v67 = [(UILabel *)v34 leadingAnchor];
          v68 = [(AXUISettingsInstructionsView *)self contentView];
          v69 = [v68 leadingAnchor];
          v52 = [v67 constraintEqualToAnchor:v69 constant:0.0];

          [(NSMutableArray *)self->_marginConstraints addObject:v52];
          v161[0] = v134;
          v161[1] = v52;
          v70 = [(UILabel *)v34 trailingAnchor];
          v71 = [(AXUISettingsInstructionsView *)self contentView];
          v72 = [v71 trailingAnchor];
          v73 = [v70 constraintLessThanOrEqualToAnchor:v72 constant:-15.0];
          v161[2] = v73;
          v74 = [MEMORY[0x1E695DEC8] arrayWithObjects:v161 count:3];
          [v124 addObjectsFromArray:v74];

          v141 = 8226;
          v75 = [(UILabel *)v34 accessibilityLabel];
          v76 = [MEMORY[0x1E696AEC0] stringWithCharacters:&v141 length:1];
          v77 = [(UILabel *)v34 accessibilityLabel];
          v78 = [v75 stringByReplacingOccurrencesOfString:v76 withString:&stru_1F4041FC0 options:1 range:{0, objc_msgSend(v77, "length")}];
...
LABEL_39:
        ...
        v54 = [*(v15 + 1808) appearance];
        v55 = [v54 footerHyperlinkColor];
        v56 = v15;
        v57 = v55;
        if (v55)
        {
          v58 = [*(v56 + 1808) appearance];
          v134 = [v58 footerHyperlinkColor];
        ...
        {
          v59 = 0x1E69DC000uLL;
          v134 = [MEMORY[0x1E69DC888] systemBlueColor];
        }

        v79 = [*(v59 + 2184) clearColor];
        ...
        v80 = [v53 textContainer];
        [v80 setLineFragmentPadding:0.0];
...
LABEL_48:
          ...
          [v53 sizeToFit];
          v96 = [(AXUISettingsInstructionsView *)self contentView];
          [v96 addSubview:v53];
        }
        ...
        if (v10)
        {
          v98 = [(UILabel *)v10 bottomAnchor];
          v99 = [v97 constraintEqualToAnchor:v98 constant:0.0];
        }

        else
        {
          v98 = [(AXUISettingsInstructionsView *)self contentView];
          v100 = [v98 topAnchor];
          v99 = [v97 constraintEqualToAnchor:v100 constant:5.0];
        }

        v126 = v99;

        v101 = [v53 leadingAnchor];
        v102 = [(AXUISettingsInstructionsView *)self contentView];
        v103 = [v102 leadingAnchor];
        v104 = [v101 constraintEqualToAnchor:v103 constant:0.0];

        [(NSMutableArray *)self->_marginConstraints addObject:v104];
        v158[0] = v99;
        v158[1] = v104;
        v105 = v104;
        v106 = [v53 trailingAnchor];
        v107 = [(AXUISettingsInstructionsView *)self contentView];
        v108 = [v107 trailingAnchor];
        v109 = [v106 constraintLessThanOrEqualToAnchor:v108 constant:-15.0];
        v158[2] = v109;
        v110 = [MEMORY[0x1E695DEC8] arrayWithObjects:v158 count:3];
        [v124 addObjectsFromArray:v110];
...
LABEL_42:
  ...
  if (v10)
  {
    v112 = [(UILabel *)v10 bottomAnchor];
    v113 = [(AXUISettingsInstructionsView *)self contentView];
    v114 = [v113 bottomAnchor];
    obj = v112;
    v115 = [v112 constraintLessThanOrEqualToAnchor:v114 constant:-5.0];
    [v124 addObject:v115];
...
LABEL_58:
  [MEMORY[0x1E696ACD8] activateConstraints:v124];
}
...
- (id)textView:(id)a3 primaryActionForTextItem:(id)a4 defaultAction:(id)a5
{
  ...
  v36 = a5;
  v43 = v7;
  v40 = [v7 _accessibilityValueForKey:@"additionalContent"];
  v44 = [v7 _accessibilityValueForKey:@"tableIdentifier"];
  v39 = [v7 _accessibilityValueForKey:@"additionalTitleLabel"];
  v38 = [v7 _accessibilityValueForKey:@"additionalSubtitleLabel"];
  v37 = [v7 _accessibilityValueForKey:@"image"];
  v41 = [v7 _accessibilityValueForKey:@"symbolName"];
  ...
  if (v41)
  {
    ...
    v13 = [(AXUISettingsInstructionsView *)self settingsLocString:v39 table:v44];
    v14 = [v12 initWithTitle:v13 detailText:v34 symbolName:v41];
  }
  ...
  else
  {
    ...
    if (v37)
    {
      v14 = [v15 initWithTitle:v13 detailText:v34 icon:v37];
    }

    else
    {
      v16 = [v15 initWithTitle:v13];
...
- (double)preferredHeightForWidth:(double)a3
{
  ...
  v4 = a3 + -15.0;
  [(UILabel *)self->_headerLabel sizeThatFits:a3 + -15.0, 3.40282347e38];
  v6 = v5 + 5.0;
  v24 = 0u;
  v25 = 0u;
  v26 = 0u;
