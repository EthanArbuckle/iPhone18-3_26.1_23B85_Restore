...
- (void)commitChangeBatch:(id)a3 withUnderlyingCompletionHandler:(id)a4
{
  ...
  if ([(CPLChangeSession *)self state]!= 1)
  {
    ...
    [v21 handleFailureInMethod:a2 object:self file:v22 lineNumber:219 description:{@"can't commit a session that is in %@ state", v23}];
  ...
  v16 = v8;
  v17 = v7;
  [v15 commitChangeBatch:v17 withCompletionHandler:v24];
