...
- (NSDate)likelyResetDate
{
  v2 = [(NSArray *)self->_resetReasons firstObject];
  v3 = [v2 date];
  v4 = v3;
  if (v3)
  {
...
- (id)likelyResetReasonWithImmediateReason:(id)a3
{
  ...
  v4 = a3;
  v5 = [(NSArray *)resetReasons firstObject];
  v6 = [v5 reason];
  v7 = v6;
  if (v6)
  {
...
- (CPLResetTracker)initWithResetReasons:(id)a3
{
  ...
  if (v5)
  {
    v6 = [v4 sortedArrayUsingComparator:&__block_literal_global_6472];
    v7 = [v6 copy];
...
+ (id)registerTentativeResetReasonIfCrashing:(id)a3
{
  ...
  v7 = [(CPLResetReason *)v5 initWithDate:v6 reason:v4];
...
+ (void)registerLikelyResetReason:(id)a3 arguments:(char *)a4
{
  ...
  v11 = [(CPLResetReason *)v9 initWithDate:v10 reason:v8];
...
+ (void)initialize
{
  ...
  v5 = [v4 arrayForKey:@"CPLResetReasons"];
