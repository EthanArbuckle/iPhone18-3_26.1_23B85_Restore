...
- (BOOL)matchesParameters:(id)parameters
{
  ...
  if (sub_10001D1E8(self, clientLibraryBaseURL, clientLibraryBaseURL))
  {
    ...
    if (sub_10001D1E8(self, cloudLibraryStateStorageURL, cloudLibraryStateStorageURL))
    {
      ...
      if (sub_10001D1E8(self, cloudLibraryResourceStorageURL, cloudLibraryResourceStorageURL))
      {
