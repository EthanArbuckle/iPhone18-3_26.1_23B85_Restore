...
- (CPLCloudKitResourceKeys)initWithPrefix:(id)a3 resourceType:(unint64_t)a4
{
  ...
  if (v6)
  {
    ...
    if (v7)
    {
      ...
      v11 = [v6 stringByAppendingString:@"FileSize"];
      fileSizeKey = v8->_fileSizeKey;
      v8->_fileSizeKey = v11;

      v13 = [v6 stringByAppendingString:@"FileType"];
      fileUTIKey = v8->_fileUTIKey;
      v8->_fileUTIKey = v13;

      v15 = [v6 stringByAppendingString:@"Width"];
      widthKey = v8->_widthKey;
      v8->_widthKey = v15;

      v17 = [v6 stringByAppendingString:@"Height"];
      heightKey = v8->_heightKey;
      v8->_heightKey = v17;

      v19 = [v6 stringByAppendingString:@"Fingerprint"];
      fingerprintKey = v8->_fingerprintKey;
      v8->_fingerprintKey = v19;

      v21 = [v6 stringByAppendingString:@"HashEnc"];
      stableHashKey = v8->_stableHashKey;
      v8->_stableHashKey = v21;

      v23 = [v6 stringByAppendingString:@"InfoEnc"];
      encryptedInfoKey = v8->_encryptedInfoKey;
      v8->_encryptedInfoKey = v23;

      v25 = [v6 stringByAppendingString:@"ExpungedState"];
      expungedStateKey = v8->_expungedStateKey;
      v8->_expungedStateKey = v25;

      v27 = [v6 stringByAppendingString:@"ExpungedDate"];
      expungedDateKey = v8->_expungedDateKey;
      v8->_expungedDateKey = v27;

      v29 = [v6 stringByAppendingString:@"Res"];
      resourceKey = v8->_resourceKey;
      v8->_resourceKey = v29;

      v31 = [v6 stringByAppendingString:@"Dynamic"];
...
- (id)_allKeys
{
  v3 = [(CPLCloudKitResourceKeys *)self _allKeysWithoutExpungedState];
