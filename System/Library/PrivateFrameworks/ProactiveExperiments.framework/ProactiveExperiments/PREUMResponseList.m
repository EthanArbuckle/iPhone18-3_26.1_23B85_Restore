...
LABEL_10:
  if (*&self->_has)
  {
    if ((*(v4 + 52) & 1) == 0 || self->_responseTimePerf != *(v4 + 1))
    {
      goto LABEL_24;
    }
  }
  ...
  if ((*&self->_has & 2) != 0)
  {
    if ((*(v4 + 52) & 2) == 0 || self->_generationStatus != *(v4 + 6))
    {
      goto LABEL_24;
    }
...
- (void)copyTo:(id)a3
{
  ...
  {
    [v9 clearItems];
    v4 = [(PREUMResponseList *)self itemsCount];
    if (v4)
    {
      v5 = v4;
      for (i = 0; i != v5; ++i)
...
LABEL_11:
  ...
  *(v9 + 1) = self->_responseTimePerf;
  *(v9 + 52) |= 1u;
  if ((*&self->_has & 2) != 0)
  {
LABEL_12:
    *(v9 + 6) = self->_generationStatus;
    *(v9 + 52) |= 2u;
  }
...
- (id)description
{
  ...
  v5 = [(PREUMResponseList *)self dictionaryRepresentation];
