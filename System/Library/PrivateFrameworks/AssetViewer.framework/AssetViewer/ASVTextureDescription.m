...
- (id)debugDescription
{
  ...
  v4 = [(ASVTextureDescription *)self name];
...
{
  var1 = a3.var1;
  v4 = [ASVTextureDescription bytesPerComponentForColorModel:a3.var0];
