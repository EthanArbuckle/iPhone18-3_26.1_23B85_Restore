...
- (void)setThumbnailSize:(CGSize)a3
{
  ...
  v6 = [(ASVBadgeView *)self badgeDescription];
  v7 = [v6 badgeImage];
...
- (void)_updateShadow
{
  ...
  v9 = [(ASVBadgeView *)self badgeDescription];
  [v9 badgeSize];
  v11 = v10;
  v13 = v12;
  ...
  v36 = [v35 bezierPathByReversingPath];
  [v42 appendPath:v36];
...
+ (void)applyBlurWithBackground:(id)a3 offset:(CGPoint)a4
{
  ...
  if ([v6 ioSurface])
  {
    [MEMORY[0x277CBF758] imageWithIOSurface:{objc_msgSend(v6, "ioSurface")}];
  }

  else
  {
    [MEMORY[0x277CBF758] imageWithCGImage:{objc_msgSend(v6, "CGImage")}];
  }
  v11 = ;
  ...
  [v26 setValue:v23 forKey:*MEMORY[0x277CBFAB8]];
  v27 = [v26 outputImage];

  [v14 extent];
  v28 = [v33 createCGImage:v27 fromRect:?];
