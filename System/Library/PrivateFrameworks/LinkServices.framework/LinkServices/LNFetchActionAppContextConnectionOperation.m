...
LABEL_8:
    ...
    [v22 handleFailureInMethod:a2 object:self file:@"LNFetchActionAppContextConnectionOperation.m" lineNumber:30 description:{@"Invalid parameter not satisfying: %@", @"action"}];
  ...
  [v21 handleFailureInMethod:a2 object:self file:@"LNFetchActionAppContextConnectionOperation.m" lineNumber:29 description:{@"Invalid parameter not satisfying: %@", @"connectionInterface"}];
...
LABEL_9:
  ...
  [v23 handleFailureInMethod:a2 object:self file:@"LNFetchActionAppContextConnectionOperation.m" lineNumber:31 description:{@"Invalid parameter not satisfying: %@", @"completionHandler"}];

LABEL_4:
  v15 = [MEMORY[0x1E696AFB0] UUID];
  v24.receiver = self;
  v24.super_class = LNFetchActionAppContextConnectionOperation;
  v16 = [(LNInterfaceConnectionOperation *)&v24 initWithIdentifier:v15 connectionInterface:v11 priority:1 queue:v13 activity:&__block_literal_global_1513];
