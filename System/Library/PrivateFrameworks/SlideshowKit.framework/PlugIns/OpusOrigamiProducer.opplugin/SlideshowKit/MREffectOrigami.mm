...
LABEL_7:
  ...
  if ([(NSString *)self->super.mEffectID isEqualToString:@"Origami2-LS2"])
  {
    ...
    v6 = @"image2";
    [-[NSDictionary objectForKey:](v22 objectForKey:{@"image2", "setDefaultSize:", v20, v21}];
...
LABEL_72:
  ...
  v58 = [(MRLayerEffect *)self->super.mEffectLayer slideProvidersForElementIDs];
  v6 = @"image1";
  [-[NSDictionary objectForKey:](v58 objectForKey:{@"image1", "setDefaultSize:", *&v64}];
...
- (void)setPixelSize:(CGSize)a3
{
  ...
  [(MREffect *)&v4 setPixelSize:a3.width, a3.height];
...
- (void)updateSizes
{
  ...
  if ((v3 == mDescriptionAspectRatio_high) == (v6 == 0) && (v8 & 1) == 0)
  {
    ...
    v112 = 0u;
    v113 = 0u;
    v16 = [(NSDictionary *)[(MRLayerEffect *)*p_mEffectLayer slideProvidersForElementIDs] objectEnumerator];
    v17 = [(NSEnumerator *)v16 countByEnumeratingWithState:&v112 objects:v120 count:16];
    if (v17)
    {
      v18 = v17;
      v19 = *v113;
      do
      {
        ...
        v18 = [(NSEnumerator *)v16 countByEnumeratingWithState:&v112 objects:v120 count:16];
      }
...
LABEL_86:
        ...
        v71 = [(MRLayerEffect *)*p_mEffectLayer slideProvidersForElementIDs];
        v72 = @"image2";
LABEL_87:
        [-[NSDictionary objectForKey:](v71 objectForKey:{v72), "setDefaultSize:", *&v107}];
        v57.f64[0] = v70->f64[0];
        v56 = v70->f64[1];
        v58 = 0.5;
        goto LABEL_59;
...
+ (id)customTimingWithEffectID:(id)a3 effectAttributes:(id)a4 slideInformation:(id)a5 textInformation:(id)a6 inAspectRatio:(double)a7
{
  v8 = [[MREffectOrigamiTiming alloc] initWithEffectID:a3];
...
- (id)_retainedByUserBackColorImageInContext:(id)a3
{
  ...
  {
    *(&self->mDurationStretchFactor + 1) = [a3 retainedByUserBlackImage];
  }

  else
  {
    v8 = [objc_msgSend(a3 imageManager];
    *(&self->mDurationStretchFactor + 1) = v8;
...
- (BOOL)prerenderForTime:(double)a3 inContext:(id)a4 withArguments:(id)a5
{
  ...
  v10 = 0;
  v7 = [(MREffect *)&v9 prerenderForTime:a4 inContext:a5 withArguments:?]| BYTE1(self->_offsetsForTransitions);
  ...
  if ([(MRLayer *)self->super.mEffectLayer isActivated])
  {
    if (a3 >= 0.0)
    {
      v7 |= [(MREffectOrigami *)self _needsRenderingAtTime:&v10 remainingStillDurationAfter:a3];
    }
  }
...
- (void)renderAtTime:(double)a3 inContext:(id)a4 withArguments:(id)a5
{
  if (a3 >= 0.0 && self->super.mPhaseInDuration + self->super.mMainDuration + self->super.mPhaseOutDuration > a3 && [(MRLayerEffect *)self->super.mEffectLayer slideProvidersForElementIDs])
  {
    v8 = self->super.mPixelSize.width * 0.5;
    ...
    *(&self->mSprites + 1) = +[NSMutableArray arrayWithArray:](NSMutableArray, "arrayWithArray:", [*(&self->super._isInInteractiveMode + 1) allKeys]);
    ...
    if ([(NSString *)self->super.mEffectID isEqualToString:@"Origami4"])
    {
      [(MREffectOrigami *)self renderFold4LeftAtTime:a4 andProgress:a5 inContext:0 withArguments:a3 inRect:a3 / (self->super.mPhaseInDuration + self->super.mMainDuration + self->super.mPhaseOutDuration) withAttributes:-1.0, v11 * -0.5, 2.0, v11];
    }

    else if ([(NSString *)self->super.mEffectID hasPrefix:@"Origami-JustASlide"])
    {
      [(MREffectOrigami *)self renderStillAtTime:a4 andProgress:a5 inContext:0 withArguments:a3 inRect:a3 / (self->super.mPhaseInDuration + self->super.mMainDuration + self->super.mPhaseOutDuration) withAttributes:-1.0, v11 * -0.5, 2.0, v11];
    }
        ...
        do
        {
          ...
          do
          {
            ...
            if (v26 <= a3 && v29 > a3)
            {
              ...
              {
                [(MREffectOrigami *)self renderFallAtTime:a4 andProgress:a5 inContext:v34 withArguments:a3 inRect:(a3 - v26) / v28 withAttributes:*&v51, v52];
              }

              else if ([v33 isEqualToString:@"pfall"])
              {
                [(MREffectOrigami *)self renderFallBreakAtTime:a4 andProgress:a5 inContext:v34 withArguments:a3 inRect:(a3 - v26) / v28 withAttributes:*&v51, v52];
              }

              else if ([v33 isEqualToString:@"fall2"])
              {
                [(MREffectOrigami *)self renderFall2AtTime:a4 andProgress:a5 inContext:v34 withArguments:a3 inRect:(a3 - v26) / v28 withAttributes:*&v51, v52];
              }

              else if ([objc_msgSend(v24 objectForKey:{@"isStill", "BOOLValue"}])
              {
                [(MREffectOrigami *)self renderStillAtTime:a4 andProgress:a5 inContext:v34 withArguments:a3 inRect:(a3 - v26) / v28 withAttributes:*&v51, v52];
              }

              else if ([v33 isEqualToString:@"pstill"])
              {
                [(MREffectOrigami *)self renderBreakAtTime:a4 andProgress:a5 inContext:v34 withArguments:a3 inRect:(a3 - v26) / v28 withAttributes:*&v51, v52];
              }
              ...
              else if ([v33 isEqualToString:@"flip"])
              {
                ...
                {
                  [(MREffectOrigami *)self renderFlipLeftAtTime:a4 andProgress:a5 inContext:v34 withArguments:a3 inRect:(a3 - v26) / v28 withAttributes:*&v51, v52];
                }

                else if ([v38 isEqualToString:@"down"])
                {
                  [(MREffectOrigami *)self renderFlipDownAtTime:a4 andProgress:a5 inContext:v34 withArguments:a3 inRect:(a3 - v26) / v28 withAttributes:*&v51, v52];
                }
                ...
                else if ([v38 isEqualToString:@"right"])
                {
                  ...
                  [(MREffectOrigami *)self renderFlipLeftAtTime:a4 andProgress:a5 inContext:v41 withArguments:a3 inRect:(a3 - v26) / v28 withAttributes:*&v51, v52];
                }
              }
              ...
              else if ([v33 isEqualToString:@"fold"])
              {
                ...
                {
                  [(MREffectOrigami *)self renderFoldLeftAtTime:a4 andProgress:a5 inContext:v34 withArguments:a3 inRect:(a3 - v26) / v28 withAttributes:*&v51, v52];
                }

                else if ([v39 isEqualToString:@"down"])
                {
                  [(MREffectOrigami *)self renderFoldDownAtTime:a4 andProgress:a5 inContext:v34 withArguments:a3 inRect:(a3 - v26) / v28 withAttributes:*&v51, v52];
                }
              }
              ...
              else if ([v33 isEqualToString:@"1To3"])
              {
                ...
                {
                  [(MREffectOrigami *)self render1To3LeftAtTime:a4 andProgress:a5 inContext:v34 withArguments:a3 inRect:(a3 - v26) / v28 withAttributes:*&v51, v52];
                }

                else if ([v40 isEqualToString:@"down"])
                {
                  [(MREffectOrigami *)self render1To3DownAtTime:a4 andProgress:a5 inContext:v34 withArguments:a3 inRect:(a3 - v26) / v28 withAttributes:*&v51, v52];
                }
              }

              else if ([v33 isEqualToString:@"flipDiagonal"])
              {
                [(MREffectOrigami *)self renderFlipDiagonalAtTime:a4 andProgress:a5 inContext:v34 withArguments:a3 inRect:(a3 - v26) / v28 withAttributes:*&v51, v52];
              }

              else if ([v33 isEqualToString:@"flower"])
              {
                [(MREffectOrigami *)self renderUnfoldingFlowerAtTime:a4 andProgress:a5 inContext:v34 withArguments:a3 inRect:(a3 - v26) / v28 withAttributes:*&v51, v52];
              }
...
- (void)setPhaseInDuration:(double)a3 mainDuration:(double)a4 phaseOutDuration:(double)a5
{
  ...
  [(MREffect *)&v69 setPhaseInDuration:a3 mainDuration:a4 phaseOutDuration:a5];
  ...
  *(&self->mItemInfos + 1) = (self->super.mPhaseInDuration + self->super.mMainDuration + self->super.mPhaseOutDuration - v68) / (self->super.mDefaultPhaseInDuration + self->super.mDefaultMainDuration + self->super.mDefaultPhaseOutDuration - v68);
  if ([(NSString *)self->super.mEffectID hasPrefix:@"Origami-JustASlide"])
  {
    ...
    v64 = 0u;
    v65 = 0u;
    v9 = [(NSDictionary *)[(MRLayerEffect *)self->super.mEffectLayer slideProvidersForElementIDs] objectEnumerator];
    v10 = [(NSEnumerator *)v9 countByEnumeratingWithState:&v64 objects:v73 count:16];
    if (v10)
    {
      v11 = v10;
      v12 = *v65;
      do
      {
        ...
        v11 = [(NSEnumerator *)v9 countByEnumeratingWithState:&v64 objects:v73 count:16];
      }
...
LABEL_24:
  ...
  v56 = 0uLL;
  v57 = 0uLL;
  v27 = [(NSDictionary *)[(MRLayerEffect *)self->super.mEffectLayer slideProvidersForElementIDs] objectEnumerator];
  v28 = [(NSEnumerator *)v27 countByEnumeratingWithState:&v56 objects:v71 count:16];
  if (v28)
  {
    v29 = v28;
    v30 = *v57;
    do
    {
      ...
      v29 = [(NSEnumerator *)v27 countByEnumeratingWithState:&v56 objects:v71 count:16];
    }
...
- (void)_renderFallImage:(id)a3 atProgress:(double)a4 inContext:(id)a5 withArguments:(id)a6 inRect:(CGRect)a7 withAttributes:(id)a8 :(CGPoint *)a9 :(CGPoint)a10
{
  ...
  *&a4 = a4;
  [*(&self->mLittleSwing + 1) valueAtTime:{a3, a5, a6, a4}];
  v21 = 3.1416 - v20;
  if (y != 0.0)
  {
  ...
  *&v32 = width / height;
  ...
  [a5 cull:2];
  SetLightingColors(v34, v36, *[a5 foreColor]);
...
- (void)_renderFallBreakImage:(id)a3 atProgress:(double)a4 inContext:(id)a5 withArguments:(id)a6 inRect:(CGRect)a7 withAttributes:(id)a8 :(CGPoint *)a9 :(CGPoint)a10
{
  ...
  v19 = a7.origin.x;
  v74 = a7;
  v23 = [objc_msgSend(a8 objectForKey:{@"slideIndex", "intValue"}];
  v24 = ImageKey(v23);
  v25 = *(&(*(&self->mThirdsSwingBottom + 1))->super.isa + 2 * v23);
  if ((v25 & 0x8000000000000000) != 0)
  {

    [(MREffectOrigami *)self _renderFallImage:a3 atProgress:a5 inContext:a6 withArguments:a8 inRect:a9 withAttributes:a4];
  }
  ...
  else
  {
    ...
    v27 = [(MREffectOrigami *)self _checkPanoramaAbsoluteSizeForImage:a3 inRect:&v74];
    if (v25)
    {
      v72 = y;
      v28 = v74.origin.x;
      ...
      *&v43 = a4;
      ...
      cosval = v59.__cosval;
      LODWORD(v57) = *&v59;
      v60 = [objc_msgSend(a8 objectForKey:{@"direction", "isEqualToString:", @"back"}];
      ...
      *&v61 = v42;
      ...
      [a5 cull:2];
      SetLightingColors(v75, v76, *[a5 foreColor]);
      [a5 setShader:@"ColoredTexture"];
...
- (void)renderFallAtTime:(double)a3 andProgress:(double)a4 inContext:(id)a5 withArguments:(id)a6 inRect:(CGRect)a7 withAttributes:(id)a8
{
  ...
  [(MREffectOrigami *)self _renderFallImage:v17 atProgress:a5 inContext:a6 withArguments:a8 inRect:0 withAttributes:a4];
...
- (void)renderFall2AtTime:(double)a3 andProgress:(double)a4 inContext:(id)a5 withArguments:(id)a6 inRect:(CGRect)a7 withAttributes:(id)a8
{
  ...
  v20 = y + height * 0.5;
  v21 = height * 0.5;
  [(MREffectOrigami *)self _renderFallImage:v18 atProgress:a5 inContext:a6 withArguments:a8 inRect:&v22 withAttributes:a4];
  [(MREffectOrigami *)self _renderFallImage:v19 atProgress:a5 inContext:a6 withArguments:a8 inRect:0 withAttributes:a4];
  [v18 releaseByUser];
  [v19 releaseByUser];
}
...
- (void)renderFallBreakAtTime:(double)a3 andProgress:(double)a4 inContext:(id)a5 withArguments:(id)a6 inRect:(CGRect)a7 withAttributes:(id)a8
{
  ...
  x = a7.origin.x;
  v17 = [-[NSDictionary objectForKey:](-[MRLayerEffect slideProvidersForElementIDs](self->super.mEffectLayer "slideProvidersForElementIDs")];
  [(MREffectOrigami *)self _renderFallBreakImage:v17 atProgress:a5 inContext:a6 withArguments:a8 inRect:0 withAttributes:a4];
...
- (void)renderStillAtTime:(double)a3 andProgress:(double)a4 inContext:(id)a5 withArguments:(id)a6 inRect:(CGRect)a7 withAttributes:(id)a8
{
  ...
  v18 = [a8 objectForKey:@"slideIndex"];
  if ((v18 || -[NSString hasPrefix:](self->super.mEffectID, "hasPrefix:", @"Origami-JustASlide")) && (v19 = ImageKey([v18 intValue])) != 0)
  {
    ...
    v22 = [v21 retainedByUserRenderedImageAtTime:a5 inContext:a6 withArguments:a3];
    v23 = 0;
  }

  else
  {
    v22 = [(MREffectOrigami *)self _retainedByUserBackColorImageInContext:a5];
    v21 = 0;
    v20 = 0;
    v23 = 1;
  }
  ...
  if ([v21 defaultKenBurnsType] == 1)
  {
    ...
    *&v25 = SetLightingColors2D(v57, v60.f32, *[a5 foreColor]);
    [a5 setShader:{@"ColoredTexture", v25}];
  ...
  else
  {
    ...
    *&v30 = v30;
    ...
    [v22 setOnContext:a5 onTextureUnit:0 withReferenceAspectRatio:&v54 state:*v42.i64];
    *&v43 = SetLightingColors2D(v57, v56, *[a5 foreColor]);
    [a5 setShader:{@"ColoredTexture", v43}];
  ...
  if ((v23 & 1) == 0)
  {
    ...
    v50 = (v49 * v47);
    [a5 localAspectRatio];
    [(MRCroppingSprite *)v45 fakeRenderInContext:a5 atPosition:v48 andSize:v50 zRotation:width, (v51 * height), 0.0];
  ...
  if ([(NSString *)self->super.mEffectID isEqualToString:@"Origami2-L1"]|| [(NSString *)self->super.mEffectID isEqualToString:@"Origami2-P1"]|| (v7 = [(NSString *)self->super.mEffectID isEqualToString:@"Origami2-Intro-L1"]))
  {
    ...
    if (v11 <= 1.0)
    {
      ...
      if (v19 > v21)
      {
        ...
        width = a4->size.width;
        a4->origin.x = a4->origin.x + width * 0.5 * (1.0 - v23);
        a4->size.width = v23 * width;
        goto LABEL_17;
      }
    }
    ...
    else
    {
      ...
      if (v13 > v15)
      {
        ...
        v18 = a4->size.height;
        a4->origin.y = a4->origin.y + v18 * 0.5 * (1.0 - v17);
        a4->size.height = v17 * v18;
LABEL_17:
        LOBYTE(v7) = 1;
        return v7;
      }
...
- (void)renderBreakAtTime:(double)a3 andProgress:(double)a4 inContext:(id)a5 withArguments:(id)a6 inRect:(CGRect)a7 withAttributes:(id)a8
{
  ...
  x = a7.origin.x;
  v190 = a7;
  v18 = [objc_msgSend(a8 objectForKey:{@"slideIndex", "intValue"}];
  v19 = ImageKey(v18);
  ...
  if (v20)
  {
    ...
    if ((*v22 & 0x8000000000000000) == 0)
    {
      ...
      v26 = [(MREffectOrigami *)self _checkPanoramaAbsoluteSizeForImage:v21 inRect:&v190];
      v28 = v190.origin.x;
      v27 = v190.origin.y;
      if (!v23)
      {
        if (!v26)
        {
          [(MREffectOrigami *)self renderStillAtTime:a5 andProgress:a6 inContext:a8 withArguments:a3 inRect:a4 withAttributes:v190.origin.x, v190.origin.y, v190.size.width, v190.size.height];
LABEL_82:
          [v21 releaseByUser];
          return;
        }
...
LABEL_81:
      ...
      v185 = v190.size.height;
      v187 = v190.size.width;
      v39 = 1.0;
      if (v30 <= 1.0)
      {
        v40 = v30;
      ...
      if (v65 <= v66)
      {
        ...
        if (v68)
        {
          ...
          *&v121 = v121 * 1.57079633;
          ...
          v151 = v118 * v112;
          *&v151 = v118 * v112;
          [v21 setOnContext:a5 onTextureUnit:0 withReferenceAspectRatio:&v189 state:v151];
          SetLightingColors(&v191, &v215, *[a5 foreColor]);
          [a5 setShader:@"ColoredTexture"];
          [a5 setVertex3DPointer:&v215];
          [a5 setTextureCoordinatesPointer:&v199 onTextureUnit:0];
          [a5 setColorsPointer:&v191];
          [a5 drawTriangleStripFromOffset:0 count:4];
          [a5 unsetColorsPointer];
          [a5 unsetTextureCoordinatesPointerOnTextureUnit:0];
          [a5 unsetVertexPointer];
          [a5 unsetShader];
          SetLightingColors(&v191, &v221, *[a5 foreColor]);
          [a5 setShader:@"ColoredTexture"];
          [a5 setVertex3DPointer:&v221];
          [a5 setTextureCoordinatesPointer:&v203 onTextureUnit:0];
          [a5 setColorsPointer:&v191];
          [a5 drawTriangleStripFromOffset:0 count:4];
          [a5 unsetColorsPointer];
          [a5 unsetTextureCoordinatesPointerOnTextureUnit:0];
          [a5 unsetVertexPointer];
          [a5 unsetShader];
          SetLightingColors(&v191, &v227, *[a5 foreColor]);
          [a5 setShader:@"ColoredTexture"];
          [a5 setVertex3DPointer:&v227];
          ...
          [a5 unsetVertexPointer];
          [a5 unsetShader];
          [v21 unsetOnContext:a5 onTextureUnit:0 state:&v189];
        ...
        v171 = v118 * v112;
        *&v171 = v118 * v112;
        [v21 setOnContext:a5 onTextureUnit:0 withReferenceAspectRatio:&v189 state:v171];
        *&v172 = SetLightingColors2D(&v215, &v199, *[a5 foreColor]);
        [a5 setShader:{@"ColoredTexture", v172}];
        [a5 setVertex2DPointer:&v199];
        [a5 setTextureCoordinatesPointer:&v191 onTextureUnit:0];
        [a5 setColorsPointer:&v215];
        [a5 drawTriangleStripFromOffset:0 count:4];
        [a5 unsetColorsPointer];
        [a5 unsetTextureCoordinatesPointerOnTextureUnit:0];
        [a5 unsetVertexPointer];
      ...
      else
      {
        ...
        if (v68)
        {
          ...
          *&v79 = v79 * 1.57079633;
          ...
          v110 = v73 / v69;
          *&v110 = v73 / v69;
          [v21 setOnContext:a5 onTextureUnit:0 withReferenceAspectRatio:&v189 state:v110];
          SetLightingColors(&v191, &v215, *[a5 foreColor]);
          [a5 setShader:@"ColoredTexture"];
          [a5 setVertex3DPointer:&v215];
          [a5 setTextureCoordinatesPointer:&v199 onTextureUnit:0];
        ...
        v162 = v73 / v69;
        *&v162 = v73 / v69;
        [v21 setOnContext:a5 onTextureUnit:0 withReferenceAspectRatio:&v189 state:v162];
        *&v163 = SetLightingColors2D(&v215, &v199, *[a5 foreColor]);
        [a5 setShader:{@"ColoredTexture", v163}];
        [a5 setVertex2DPointer:&v199];
        [a5 setTextureCoordinatesPointer:&v191 onTextureUnit:0];
        [a5 setColorsPointer:&v215];
        [a5 drawTriangleStripFromOffset:0 count:4];
...
LABEL_78:
      ...
      [a5 localAspectRatio];
      [(MRCroppingSprite *)v175 fakeRenderInContext:a5 atPosition:(v84 + (v111 * 0.5)) andSize:v177 zRotation:v111, (v178 * v102), 0.0];
    ...
    [(MREffectOrigami *)self renderStillAtTime:a5 andProgress:a6 inContext:a8 withArguments:a3 inRect:a4 withAttributes:x, y, width, height];
...
- (void)renderFlipLeftAtTime:(double)a3 andProgress:(double)a4 inContext:(id)a5 withArguments:(id)a6 inRect:(CGRect)a7 withAttributes:(id)a8
{
  ...
  y = a7.origin.y;
  x = a7.origin.x;
  v14 = [a8 objectForKey:@"recto"];
  v15 = [a8 objectForKey:@"verso"];
  [objc_msgSend(a8 objectForKey:{@"ratio", "floatValue"}];
  v143 = v16;
  ...
  *&v22 = a4;
  ...
  if (v51 > a4 || v131)
  {
    ...
    *&v56 = *&v56 / (v141 - v53);
    ...
    [v54 setOnContext:a5 onTextureUnit:0 withReferenceAspectRatio:&v145 state:v56];
    v152 = x;
    v153 = y + (v117 * v127);
    v154 = x;
    v155 = v141;
    ...
    *&v146[24] = v57;
    v147 = 1.0;
    *&v58 = SetLightingColors2D(v170, &v152, *[a5 foreColor]);
    [a5 setShader:{@"ColoredTexture", v58}];
    [a5 setVertex2DPointer:&v152];
    [a5 setTextureCoordinatesPointer:v146 onTextureUnit:0];
    [a5 setColorsPointer:v170];
    [a5 drawTriangleStripFromOffset:0 count:4];
    [a5 unsetColorsPointer];
    [a5 unsetTextureCoordinatesPointerOnTextureUnit:0];
    [a5 unsetVertexPointer];
    ...
    else
    {
      ...
      {
        [v55 unsetOnContext:a5 onTextureUnit:0 state:&v145];
        [v55 releaseByUser];
        v61 = v32;
        *&v62 = v144;
        if (v32 != v121)
        ...
        *&v62 = *&v62 / (v53 - v49);
        [v60 setOnContext:a5 onTextureUnit:0 withReferenceAspectRatio:&v145 state:v62];
        v55 = v60;
      }
      ...
      *&v164[24] = v63;
      v165 = 1065353216;
      *&v64 = SetLightingColors2D(v170, v166, *[a5 foreColor]);
      [a5 setShader:{@"ColoredTexture", v64}];
      [a5 setVertex2DPointer:v166];
      [a5 setTextureCoordinatesPointer:v164 onTextureUnit:0];
      [a5 setColorsPointer:v170];
      [a5 drawTriangleStripFromOffset:0 count:4];
      [a5 unsetColorsPointer];
      [a5 unsetTextureCoordinatesPointerOnTextureUnit:0];
  ...
  if (v68 > a4 || !v131)
  {
    ...
    *&v72 = *&v72 / (v141 - v69);
    ...
    [v70 setOnContext:a5 onTextureUnit:0 withReferenceAspectRatio:&v145 state:v72];
    v152 = v48;
    v153 = v69;
    v154 = v48;
    v155 = v141;
    ...
    *&v146[12] = xmmword_163DF0;
    v147 = 1.0;
    *&v74 = SetLightingColors2D(v170, &v152, *[a5 foreColor]);
    [a5 setShader:{@"ColoredTexture", v74}];
    [a5 setVertex2DPointer:&v152];
    [a5 setTextureCoordinatesPointer:v146 onTextureUnit:0];
    [a5 setColorsPointer:v170];
    [a5 drawTriangleStripFromOffset:0 count:4];
    ...
    else
    {
      ...
      {
        [v71 unsetOnContext:a5 onTextureUnit:0 state:&v145];
        [v71 releaseByUser];
        v77 = v119;
        *&v78 = v144;
        if (v45 != v119)
        ...
        v79 = y;
        *&v78 = *&v78 / (v69 - v142);
        [v76 setOnContext:a5 onTextureUnit:0 withReferenceAspectRatio:&v145 state:v78];
        v71 = v76;
      }
      ...
      *&v164[12] = xmmword_163DF0;
      v165 = 1065353216;
      *&v81 = SetLightingColors2D(v170, v166, *[a5 foreColor]);
      [a5 setShader:{@"ColoredTexture", v81}];
      [a5 setVertex2DPointer:v166];
      [a5 setTextureCoordinatesPointer:v164 onTextureUnit:0];
      [a5 setColorsPointer:v170];
      [a5 drawTriangleStripFromOffset:0 count:4];
  ...
  *&v86 = v89 / (v141 - v66);
  ...
  [v85 setOnContext:a5 onTextureUnit:0 withReferenceAspectRatio:&v145 state:v86];
  v152 = v133;
  v153 = v122;
  v154 = v125 * v144;
  v155 = v48;
  ...
  *(&v168 + 1) = v91;
  v169 = 1.0;
  SetLightingColors(v170, &v152, *[a5 foreColor]);
  [a5 setShader:@"ColoredTexture"];
  [a5 setVertex3DPointer:&v152];
  [a5 setTextureCoordinatesPointer:v166 onTextureUnit:0];
  [a5 setColorsPointer:v170];
  [a5 drawTriangleStripFromOffset:0 count:4];
  [a5 unsetColorsPointer];
  [a5 unsetTextureCoordinatesPointerOnTextureUnit:0];
  ...
  else
  {
    ...
    {
      [v87 unsetOnContext:a5 onTextureUnit:0 state:&v145];
      [v87 releaseByUser];
      *&v100 = v144;
      if (v45 != v119)
      {
      ...
      v101 = y;
      *&v100 = *&v100 / (v66 - v142);
      [v98 setOnContext:a5 onTextureUnit:0 withReferenceAspectRatio:&v145 state:v100];
      v87 = v98;
    }
    ...
    *&v164[24] = v102;
    v165 = 1065353216;
    SetLightingColors(v170, v146, *[a5 foreColor]);
    [a5 setShader:@"ColoredTexture"];
    [a5 setVertex3DPointer:v146];
    [a5 setTextureCoordinatesPointer:v164 onTextureUnit:0];
    [a5 setColorsPointer:v170];
    [a5 drawTriangleStripFromOffset:0 count:4];
    [a5 unsetColorsPointer];
  ...
  *&v105 = *&v105 / (v141 - v128);
  ...
  [v103 setOnContext:a5 onTextureUnit:0 withReferenceAspectRatio:&v145 state:v105];
  v152 = v140;
  v153 = v128;
  v154 = 0.0;
  v155 = v130;
  ...
  *(&v167 + 1) = v107;
  ...
  if (v128 > v142)
  {
    ...
    {
      [v104 unsetOnContext:a5 onTextureUnit:0 state:&v145];
      [v104 releaseByUser];
      v111 = v121;
      *&v112 = v144;
      if (v120 != v121)
      ...
      v113 = y;
      *&v112 = *&v112 / (v128 - v142);
      [v110 setOnContext:a5 onTextureUnit:0 withReferenceAspectRatio:&v145 state:v112];
      v104 = v110;
      v114 = v140;
    }
...
- (void)renderFlipDownAtTime:(double)a3 andProgress:(double)a4 inContext:(id)a5 withArguments:(id)a6 inRect:(CGRect)a7 withAttributes:(id)a8
{
  ...
  y = a7.origin.y;
  x = a7.origin.x;
  v15 = [a8 objectForKey:@"recto"];
  v16 = [a8 objectForKey:@"verso"];
  [objc_msgSend(a8 objectForKey:{@"ratio", "floatValue"}];
  v171 = v17;
  ...
  *&v174 = vcvt_f32_f64(v165);
  ...
  if (!(_NF ^ _VF | _ZF))
  {
    ...
    *&v181[16] = v63;
    ...
    [v62 setOnContext:a5 onTextureUnit:0 withReferenceAspectRatio:&v178 state:{COERCE_DOUBLE(vdiv_f32(vdup_lane_s32(v79, 1), v79))}];
    *&v80 = SetLightingColors2D(&v200, &v186, *[a5 foreColor]);
    [a5 setShader:{@"ColoredTexture", v80}];
    [a5 setVertex2DPointer:&v186];
    [a5 setTextureCoordinatesPointer:&v179 onTextureUnit:0];
    [a5 setColorsPointer:&v200];
    [a5 drawTriangleStripFromOffset:0 count:4];
    [a5 unsetColorsPointer];
    [a5 unsetTextureCoordinatesPointerOnTextureUnit:0];
    [a5 unsetVertexPointer];
    ...
    if (*&v167 < v54)
    {
      ...
      {
        [v62 unsetOnContext:a5 onTextureUnit:0 state:&v178];
        [v62 releaseByUser];
        ...
        *&v84 = (v54 - *&v167) / v86;
        [v83 setOnContext:a5 onTextureUnit:0 withReferenceAspectRatio:&v178 state:v84];
        v87 = LODWORD(v167);
        v62 = v83;
      }
      ...
      *(&v197 + 3) = v88;
      *&v89 = SetLightingColors2D(&v200, &v198, *[a5 foreColor]);
      [a5 setShader:{@"ColoredTexture", v89}];
      [a5 setVertex2DPointer:&v198];
      [a5 setTextureCoordinatesPointer:&v195 onTextureUnit:0];
      [a5 setColorsPointer:&v200];
      [a5 drawTriangleStripFromOffset:0 count:4];
      [a5 unsetColorsPointer];
      [a5 unsetTextureCoordinatesPointerOnTextureUnit:0];
    ...
    [v62 unsetOnContext:a5 onTextureUnit:0 state:{&v178, v81}];
    [v62 releaseByUser];
    v49 = v171;
  }
  ...
  *&v94 = (v53 - v176.f32[0]) / v96;
  [v93 setOnContext:a5 onTextureUnit:0 withReferenceAspectRatio:&v178 state:v94];
  v186 = v176;
  *v187 = v53;
  *&v187[4] = v158;
  v188 = *(&v174 + 1);
  ...
  *&v98 = SetLightingColors2D(&v200, &v186, *[a5 foreColor]);
  [a5 setShader:{@"ColoredTexture", v98}];
  [a5 setVertex2DPointer:&v186];
  [a5 setTextureCoordinatesPointer:&v179 onTextureUnit:0];
  [a5 setColorsPointer:&v200];
  [a5 drawTriangleStripFromOffset:0 count:4];
  ...
  if (v53 < v54)
  {
    ...
    {
      [v95 unsetOnContext:a5 onTextureUnit:0 state:&v178];
      [v95 releaseByUser];
      v102 = v155;
      v103 = v177;
      if (v153 != v155)
      ...
      *&v101 = (v54 - v53) / v103;
      [v100 setOnContext:a5 onTextureUnit:0 withReferenceAspectRatio:&v178 state:v101];
      v95 = v100;
    }
    ...
    *(&v196 + 1) = v104;
    v197 = xmmword_163E00;
    *&v105 = SetLightingColors2D(&v200, &v198, *[a5 foreColor]);
    [a5 setShader:{@"ColoredTexture", v105}];
    [a5 setVertex2DPointer:&v198];
    [a5 setTextureCoordinatesPointer:&v195 onTextureUnit:0];
    [a5 setColorsPointer:&v200];
    [a5 drawTriangleStripFromOffset:0 count:4];
  ...
  *&v109 = (v91 - v176.f32[0]) / v110;
  [v107 setOnContext:a5 onTextureUnit:0 withReferenceAspectRatio:&v178 state:v109];
  ...
  *(&v199[2] + 1) = v111;
  SetLightingColors(&v200, &v186, *[a5 foreColor]);
  [a5 setShader:@"ColoredTexture"];
  [a5 setVertex3DPointer:&v186];
  ...
  else
  {
    ...
    {
      [v108 unsetOnContext:a5 onTextureUnit:0 state:&v178];
      [v108 releaseByUser];
      v116 = v54;
      ...
      *&v117 = ((v54 - *&v167) * 1.3333) / v119;
      [v113 setOnContext:a5 onTextureUnit:0 withReferenceAspectRatio:&v178 state:v117];
      v108 = v113;
    }
    ...
    *&v197 = -v170;
    DWORD2(v197) = 1065353216;
    *(&v197 + 3) = v121;
    SetLightingColors(&v200, &v179, *[a5 foreColor]);
    [a5 setShader:@"ColoredTexture"];
    [a5 setVertex3DPointer:&v179];
    [a5 setTextureCoordinatesPointer:&v195 onTextureUnit:0];
    [a5 setColorsPointer:&v200];
    [a5 drawTriangleStripFromOffset:0 count:4];
    [a5 unsetColorsPointer];
  ...
  *&v199[2] = v170;
  ...
  [v122 setOnContext:a5 onTextureUnit:0 withReferenceAspectRatio:&v178 state:{COERCE_DOUBLE(vdiv_f32(vdup_lane_s32(v143, 1), v143))}];
  SetLightingColors(&v200, &v186, *[a5 foreColor]);
  [a5 setShader:@"ColoredTexture"];
  [a5 setVertex3DPointer:&v186];
  [a5 setTextureCoordinatesPointer:&v198 onTextureUnit:0];
  ...
  if (*&v174 < v54)
  {
    v145 = [-[NSDictionary objectForKey:](-[MRLayerEffect slideProvidersForElementIDs](self->super.mEffectLayer slideProvidersForElementIDs];
    v146 = v145;
    if (v145 == v122)
    {
      [v145 releaseByUser];
    ...
    {
      [v122 unsetOnContext:a5 onTextureUnit:0 state:&v178];
      [v122 releaseByUser];
      ...
      *&v147 = (v54 - *&v174) / v148;
      [v146 setOnContext:a5 onTextureUnit:0 withReferenceAspectRatio:&v178 state:v147];
      v149 = LODWORD(v174);
      v122 = v146;
    }
  ...
  [v122 unsetOnContext:a5 onTextureUnit:0 state:{&v178, v144}];
  [v122 releaseByUser];
  [a5 cull:0];
}
...
- (void)renderFoldLeftAtTime:(double)a3 andProgress:(double)a4 inContext:(id)a5 withArguments:(id)a6 inRect:(CGRect)a7 withAttributes:(id)a8
{
  ...
  y = a7.origin.y;
  x = a7.origin.x;
  v17 = [a8 objectForKey:@"recto"];
  v18 = [a8 objectForKey:@"verso"];
  *&v19 = a4;
  ...
  *&v30 = v31;
  ...
  v71[1] = unk_163FD4;
  *&v34 = SetLightingColors2D(v70, v72, *[a5 foreColor]);
  [a5 setShader:{@"ColoredTexture", v34}];
  ...
  *&v36 = v31;
  [v35 setOnContext:a5 onTextureUnit:0 withReferenceAspectRatio:&v50 state:v36];
  [*(&self->mBigSwing + 1) timeFirstAtRestValue];
  if (v37 > a4)
  {
    v58 = v24;
    ...
    v51 = xmmword_163F24;
    v52 = *algn_163F34;
    *&v38 = SetLightingColors2D(v70, &v58, *[a5 foreColor]);
    [a5 setShader:{@"ColoredTexture", v38}];
  ...
  v57[1] = *algn_163E94;
  SetLightingColors(v70, &v58, *[a5 foreColor]);
  [a5 setShader:@"ColoredTexture"];
  ...
  [a5 unsetVertexPointer];
  [a5 unsetShader];
  [v35 unsetOnContext:a5 onTextureUnit:0 state:&v50];
  [v35 releaseByUser];
  [a5 cull:0];
  ...
  *&v40 = v31;
  [v39 setOnContext:a5 onTextureUnit:0 withReferenceAspectRatio:&v50 state:v40];
  [*(&self->mBigSwing + 1) timeFirstAtRestValue];
  ...
  *(&v52 + 1) = *(&v51 + 2);
  ...
  SetLightingColors(v70, &v51, *[a5 foreColor]);
  [a5 setShader:@"ColoredTexture"];
  ...
  [a5 unsetVertexPointer];
  [a5 unsetShader];
  [v39 unsetOnContext:a5 onTextureUnit:0 state:&v50];
  [v39 releaseByUser];
  ...
  *&v43 = v31;
  [v42 setOnContext:a5 onTextureUnit:0 withReferenceAspectRatio:&v50 state:v43];
  [*(&self->mBigSwing + 1) timeFirstAtRestValue];
  *&v51 = v24 + ((v26 * 0.33333) * (1.0 - cosval));
  *(&v51 + 1) = v25 + (v32 * 0.5);
  *(&v51 + 2) = (v26 * 0.33333) * v21;
  ...
  *(&v52 + 1) = *(&v51 + 2);
  ...
  [a5 unsetVertexPointer];
  [a5 unsetShader];
  [v42 unsetOnContext:a5 onTextureUnit:0 state:&v50];
  [v42 releaseByUser];
}
...
- (void)renderFoldDownAtTime:(double)a3 andProgress:(double)a4 inContext:(id)a5 withArguments:(id)a6 inRect:(CGRect)a7 withAttributes:(id)a8
{
  ...
  v43 = a3;
  *&a3 = a4;
  [*(&self->mBreakCurve + 1) valueAtTime:a3];
  ...
  v37 = v21;
  *&y = height;
  v22 = [objc_msgSend(a8 objectForKey:{@"slide0Index", "intValue"}];
  v23 = [objc_msgSend(a8 objectForKey:{@"slide1Index", "intValue"}];
  v38 = height;
  ...
  *&v27 = v27;
  ...
  else
  {
    ...
    v45 = xmmword_163EA4;
    v46 = unk_163EB4;
    *&v33 = SetLightingColors2D(v65, &v53, *[a5 foreColor]);
    [a5 setShader:{@"ColoredTexture", v33}];
  ...
  v52[1] = unk_163ED4;
  SetLightingColors(v65, &v53, *[a5 foreColor]);
  [a5 setShader:@"ColoredTexture"];
  ...
  *(&v45 + 1) = __PAIR64__(LODWORD(v30), LODWORD(v25));
  ...
  SetLightingColors(v65, &v45, *[a5 foreColor]);
  [a5 setShader:@"ColoredTexture"];
...
- (void)render1To3DownAtTime:(double)a3 andProgress:(double)a4 inContext:(id)a5 withArguments:(id)a6 inRect:(CGRect)a7 withAttributes:(id)a8
{
  ...
  x = a7.origin.x;
  height = a7.size.height;
  v90 = [objc_msgSend(a8 objectForKey:{@"slide0Index", "intValue"}];
  v17 = v90;
  v91 = v90;
  if ([a8 objectForKey:@"slide1Index"])
  {
    v91 = [objc_msgSend(a8 objectForKey:{@"slide1Index", "intValue"}];
  }
  ...
  {
    v17 = [objc_msgSend(a8 objectForKey:{@"slide2Index", "intValue"}];
  }

  v21 = a4;
  v89 = height * 0.33333;
  v22 = v18 / (height * 0.33333);
  v23 = [objc_msgSend(a8 objectForKey:{@"slide3Index", "intValue"}];
  v24 = [objc_msgSend(a8 objectForKey:{@"slide4Index", "intValue"}];
  v87 = [objc_msgSend(a8 objectForKey:{@"slide5Index", "intValue"}];
  ...
  v127 = xmmword_163FC4;
  v128 = unk_163FD4;
  v28 = [a8 objectForKey:@"slide3Rect"];
  if (v28)
  {
  ...
  [v25 setOnContext:a5 onTextureUnit:0 withReferenceAspectRatio:&v93 state:*v29.i64];
  *&v31 = SetLightingColors2D(v126, v129, *[a5 foreColor]);
  [a5 setShader:{@"ColoredTexture", v31}];
  [a5 setVertex2DPointer:v129];
  [a5 setTextureCoordinatesPointer:&v127 onTextureUnit:0];
  [a5 setColorsPointer:v126];
  [a5 drawTriangleStripFromOffset:0 count:4];
  [a5 unsetColorsPointer];
  [a5 unsetTextureCoordinatesPointerOnTextureUnit:0];
  [a5 unsetVertexPointer];
  [a5 unsetShader];
  [v25 unsetOnContext:a5 onTextureUnit:0 state:&v93];
  [v25 releaseByUser];
  if (v21 >= 0.33333)
  {
    ...
    v116 = xmmword_163FC4;
    v117 = unk_163FD4;
    v49 = [a8 objectForKey:@"slide4Rect"];
    if (v49)
    {
    ...
    [v47 setOnContext:a5 onTextureUnit:0 withReferenceAspectRatio:&v93 state:*v50.i64];
    *&v65 = SetLightingColors2D(v126, &v118, *[a5 foreColor]);
    [a5 setShader:{@"ColoredTexture", v65}];
    [a5 setVertex2DPointer:&v118];
    [a5 setTextureCoordinatesPointer:&v116 onTextureUnit:0];
    [a5 setColorsPointer:v126];
    [a5 drawTriangleStripFromOffset:0 count:4];
    [a5 unsetColorsPointer];
    [a5 unsetTextureCoordinatesPointerOnTextureUnit:0];
    [a5 unsetVertexPointer];
    [a5 unsetShader];
    [v47 unsetOnContext:a5 onTextureUnit:0 state:&v93];
    [v47 releaseByUser];
    v66 = v21 * 1.5 + -0.5;
    v67 = v66;
    *&v66 = v67;
    ...
    if (v71 > v67)
    {
      ...
      *v110.i64 = _D8;
      ...
      v112 = 1065353216;
      v113 = v70;
      v75 = [a8 objectForKey:@"slide2Rect"];
      if (v75)
      {
      ...
      [v72 setOnContext:a5 onTextureUnit:0 withReferenceAspectRatio:&v93 state:*v76.i64];
      *&v78 = SetLightingColors2D(v126, &v114, *[a5 foreColor]);
      [a5 setShader:{@"ColoredTexture", v78}];
      [a5 setVertex2DPointer:&v114];
      [a5 setTextureCoordinatesPointer:&v110 onTextureUnit:0];
      [a5 setColorsPointer:v126];
      [a5 drawTriangleStripFromOffset:0 count:4];
      [a5 unsetColorsPointer];
      [a5 unsetTextureCoordinatesPointerOnTextureUnit:0];
      ...
      *&v94.i64[1] = -_D8;
      ...
      v96 = v79;
      v97 = _D9;
      v80 = [a8 objectForKey:@"slide0Rect"];
      if (v80)
      {
      ...
      if (v82 != v72)
      {
        [v72 unsetOnContext:a5 onTextureUnit:0 state:&v93];
        *&v83 = (v22 * (v94.f32[3] - v94.f32[1])) / (v95 - v94.f32[0]);
        [v82 setOnContext:a5 onTextureUnit:0 withReferenceAspectRatio:&v93 state:v83];
      }

      [v72 releaseByUser];
      [a5 cull:1];
      SetLightingColors(v126, &v98, *[a5 foreColor]);
      [a5 setShader:@"ColoredTexture"];
      [a5 setVertex3DPointer:&v98];
      [a5 setTextureCoordinatesPointer:&v94 onTextureUnit:0];
      [a5 setColorsPointer:v126];
      [a5 drawTriangleStripFromOffset:0 count:4];
      [a5 unsetColorsPointer];
      [a5 unsetTextureCoordinatesPointerOnTextureUnit:0];
      [a5 unsetVertexPointer];
      [a5 unsetShader];
      [v82 unsetOnContext:a5 onTextureUnit:0 state:&v93];
      [v82 releaseByUser];
    }
    ...
    v115 = unk_163FD4;
    *&v85 = (v22 + v22) * 0.5;
    [v84 setOnContext:a5 onTextureUnit:0 withReferenceAspectRatio:&v93 state:v85];
    [a5 cull:2];
    SetLightingColors(v126, &v98, *[a5 foreColor]);
    [a5 setShader:@"ColoredTexture"];
    [a5 setVertex3DPointer:&v98];
    ...
    [a5 unsetVertexPointer];
    [a5 unsetShader];
    [v84 unsetOnContext:a5 onTextureUnit:0 state:&v93];
    [v84 releaseByUser];
    [a5 cull:0];
  }
  ...
  else
  {
    ...
    *(&v117 + 3) = v42;
    v118 = v19;
    v44 = [a8 objectForKey:{@"slide2Rect", *&_D0}];
    if (v44)
    {
    ...
    [v35 setOnContext:a5 onTextureUnit:0 withReferenceAspectRatio:&v93 state:*v45.i64];
    *&v52 = SetLightingColors2D(v126, &v118, *[a5 foreColor]);
    [a5 setShader:{@"ColoredTexture", v52}];
    [a5 setVertex2DPointer:&v118];
    [a5 setTextureCoordinatesPointer:&v116 onTextureUnit:0];
    [a5 setColorsPointer:v126];
    [a5 drawTriangleStripFromOffset:0 count:4];
    ...
    *(&v111 + 1) = v54;
    v112 = 1065353216;
    v113 = v55;
    v56 = [a8 objectForKey:@"slide1Rect"];
    if (v56)
    {
    ...
    if (v53 != v35)
    {
      [v35 unsetOnContext:a5 onTextureUnit:0 state:{&v93, v57}];
      *&v58 = (v22 * (v110.f32[3] - v110.f32[1])) / (*&v111 - v110.f32[0]);
      [v53 setOnContext:a5 onTextureUnit:0 withReferenceAspectRatio:&v93 state:v58];
    }

    [v35 releaseByUser];
    *&v59 = SetLightingColors2D(v126, &v114, *[a5 foreColor]);
    [a5 setShader:{@"ColoredTexture", v59}];
    [a5 setVertex2DPointer:&v114];
    [a5 setTextureCoordinatesPointer:&v110 onTextureUnit:0];
    [a5 setColorsPointer:v126];
    [a5 drawTriangleStripFromOffset:0 count:4];
    ...
    *&v94.i64[1] = -v88;
    ...
    v96 = v61;
    v97 = v86;
    v62 = [a8 objectForKey:@"slide0Rect"];
    if (v62)
    {
    ...
    if (v60 != v53)
    {
      [v53 unsetOnContext:a5 onTextureUnit:0 state:{&v93, v63}];
      *&v64 = (v22 * (v94.f32[3] - v94.f32[1])) / (v95 - v94.f32[0]);
      [v60 setOnContext:a5 onTextureUnit:0 withReferenceAspectRatio:&v93 state:v64];
    }
    ...
    [a5 unsetVertexPointer];
    [a5 unsetShader];
    [v60 unsetOnContext:a5 onTextureUnit:0 state:&v93];
    [v60 releaseByUser];
  }
}
...
- (void)render1To3LeftAtTime:(double)a3 andProgress:(double)a4 inContext:(id)a5 withArguments:(id)a6 inRect:(CGRect)a7 withAttributes:(id)a8
{
  ...
  v73 = [objc_msgSend(a8 objectForKey:{@"slide0Index", "intValue"}];
  v69 = [objc_msgSend(a8 objectForKey:{@"slide1Index", "intValue"}];
  v72 = [objc_msgSend(a8 objectForKey:{@"slide2Index", "intValue"}];
  v19 = [objc_msgSend(a8 objectForKey:{@"slide3Index", "intValue"}];
  v20 = [objc_msgSend(a8 objectForKey:{@"slide4Index", "intValue"}];
  v70 = [objc_msgSend(a8 objectForKey:{@"slide5Index", "intValue"}];
  v75 = a3;
  ...
  v106 = xmmword_163FC4;
  *v107 = unk_163FD4;
  v23 = [a8 objectForKey:@"slide3Rect"];
  if (v23)
  {
  ...
  [v21 setOnContext:a5 onTextureUnit:0 withReferenceAspectRatio:&v76 state:*v24.i64];
  *&v26 = SetLightingColors2D(v105, v108, *[a5 foreColor]);
  [a5 setShader:{@"ColoredTexture", v26}];
  ...
  if (v13 >= 0.33333)
  {
    ...
    v95 = xmmword_163FC4;
    v96 = unk_163FD4;
    v36 = [a8 objectForKey:@"slide4Rect"];
    v37.i32[0] = 2.0;
    v38 = 2.0;
    if (v36)
    {
    ...
    [v35 setOnContext:a5 onTextureUnit:0 withReferenceAspectRatio:&v76 state:*v37.i64];
    *&v39 = SetLightingColors2D(v105, &v97, *[a5 foreColor]);
    [a5 setShader:{@"ColoredTexture", v39}];
    ...
    *&v40 = v41;
    ...
    if (v44 > v41)
    {
      ...
      *(&v94 + 3) = v22;
      v91 = xmmword_163FC4;
      v92 = unk_163FD4;
      v46 = [a8 objectForKey:@"slide2Rect"];
      if (v46)
      {
      ...
      [v45 setOnContext:a5 onTextureUnit:0 withReferenceAspectRatio:&v76 state:*v47.i64];
      *&v59 = SetLightingColors2D(v105, &v93, *[a5 foreColor]);
      [a5 setShader:{@"ColoredTexture", v59}];
      ...
      v77 = xmmword_163EE4;
      v78 = unk_163EF4;
      v60 = [a8 objectForKey:@"slide0Rect"];
      if (v60)
      {
      ...
      [v45 releaseByUser];
      [a5 cull:2];
      SetLightingColors(v105, &v79, *[a5 foreColor]);
      [a5 setShader:@"ColoredTexture"];
    ...
    v93 = xmmword_163EE4;
    v94 = unk_163EF4;
    v65 = [a8 objectForKey:@"slide5Rect"];
    if (v65)
    {
    ...
    [v64 setOnContext:a5 onTextureUnit:0 withReferenceAspectRatio:&v76 state:*v66.i64];
    [a5 cull:1];
    SetLightingColors(v105, &v79, *[a5 foreColor]);
    [a5 setShader:@"ColoredTexture"];
    [a5 setVertex3DPointer:&v79];
  ...
  else
  {
    *&v27 = v13 * 3.0;
    ...
    v95 = xmmword_163FC4;
    v96 = unk_163FD4;
    v31 = [a8 objectForKey:@"slide2Rect"];
    if (v31)
    {
    ...
    [v30 setOnContext:a5 onTextureUnit:0 withReferenceAspectRatio:&v76 state:*v32.i64];
    *&v49 = SetLightingColors2D(v105, &v97, *[a5 foreColor]);
    [a5 setShader:{@"ColoredTexture", v49}];
    [a5 setVertex2DPointer:&v97];
    [a5 setTextureCoordinatesPointer:&v95 onTextureUnit:0];
    [a5 setColorsPointer:v105];
    [a5 drawTriangleStripFromOffset:0 count:4];
    ...
    *(&v94 + 3) = y + height;
    v91 = xmmword_163FC4;
    v92 = unk_163FD4;
    v51 = [a8 objectForKey:@"slide1Rect"];
    if (v51)
    {
    ...
    if (v50 != v30)
    {
      [v30 unsetOnContext:a5 onTextureUnit:0 state:{&v76, v52}];
      *&v53 = (v18 * (*(&v91 + 3) - *(&v91 + 1))) / (*&v92 - *&v91);
      [v50 setOnContext:a5 onTextureUnit:0 withReferenceAspectRatio:&v76 state:v53];
    }

    [v30 releaseByUser];
    *&v54 = SetLightingColors2D(v105, &v93, *[a5 foreColor]);
    [a5 setShader:{@"ColoredTexture", v54}];
    [a5 setVertex2DPointer:&v93];
    [a5 setTextureCoordinatesPointer:&v91 onTextureUnit:0];
    [a5 setColorsPointer:v105];
    [a5 drawTriangleStripFromOffset:0 count:4];
    ...
    v77 = xmmword_163EE4;
    v78 = unk_163EF4;
    v56 = [a8 objectForKey:@"slide0Rect"];
    if (v56)
    {
    ...
    if (v55 != v50)
    {
      [v50 unsetOnContext:a5 onTextureUnit:0 state:{&v76, v57}];
...
- (void)renderFold4LeftAtTime:(double)a3 andProgress:(double)a4 inContext:(id)a5 withArguments:(id)a6 inRect:(CGRect)a7 withAttributes:(id)a8
{
  ...
  if (v12 >= 0.25)
  {
    v35 = [-[NSDictionary objectForKey:](-[MRLayerEffect slideProvidersForElementIDs](self->super.mEffectLayer slideProvidersForElementIDs];
    LOBYTE(v58[0]) = 0;
    [v35 setOnContext:a5 onTextureUnit:0 withReferenceAspectRatio:v58 state:?];
    v46 = x;
    ...
    v80 = xmmword_163FC4;
    v81 = unk_163FD4;
    *&v36 = SetLightingColors2D(v77, &v46, *[a5 foreColor]);
    [a5 setShader:{@"ColoredTexture", v36}];
    ...
    if (v12 >= 0.66667)
    {
      ...
      *&v42 = (width * 3.0) / height;
      ...
      v78 = xmmword_163FC4;
      v79 = unk_163FD4;
      *&v43 = SetLightingColors2D(v77, &v61, *[a5 foreColor]);
      [a5 setShader:{@"ColoredTexture", v43}];
    ...
    {
      v37 = __sincosf_stret(((v12 * 3.0) + -1.0) * 3.1416);
      ...
      *(&v79 + 3) = *(&v78 + 3);
      v75 = xmmword_163F64;
      v76 = unk_163F74;
      *&v40 = SetLightingColors2D(v77, &v78, *[a5 foreColor]);
      [a5 setShader:{@"ColoredTexture", v40}];
      ...
      v74 = unk_163F94;
      [a5 cull:2];
      SetLightingColors(v77, &v61, *[a5 foreColor]);
      [a5 setShader:@"ColoredTexture"];
  ...
  {
    v17 = __sincosf_stret((v12 * 4.0) * 3.1416);
    v18 = [-[NSDictionary objectForKey:](-[MRLayerEffect slideProvidersForElementIDs](self->super.mEffectLayer "slideProvidersForElementIDs")];
    v45 = 0;
    ...
    *(&v81 + 3) = y + height;
    v78 = xmmword_163F04;
    v79 = unk_163F14;
    *&v21 = SetLightingColors2D(v77, &v80, *[a5 foreColor]);
    [a5 setShader:{@"ColoredTexture", v21}];
    ...
    *(&v76 + 3) = y + height;
    v73 = xmmword_163F24;
    v74 = *algn_163F34;
    *&v26 = SetLightingColors2D(v77, &v75, *[a5 foreColor]);
    [a5 setShader:{@"ColoredTexture", v26}];
    ...
    *&v30 = v29;
    ...
    v58[6] = v20;
    v58[7] = v25;
    *&v31 = SetLightingColors2D(v77, v58, *[a5 foreColor]);
    [a5 setShader:{@"ColoredTexture", v31}];
    [a5 setVertex2DPointer:v58];
    ...
    *&v33 = v29;
    ...
    SetLightingColors(v77, &v46, *[a5 foreColor]);
    [a5 setShader:@"ColoredTexture"];
...
- (void)renderFlipDiagonalAtTime:(double)a3 andProgress:(double)a4 inContext:(id)a5 withArguments:(id)a6 inRect:(CGRect)a7 withAttributes:(id)a8
{
  ...
  y = a7.origin.y;
  x = a7.origin.x;
  v18 = [a8 objectForKey:@"recto"];
  v19 = [v8 objectForKey:@"verso"];
  *&v20 = a4;
  [*(&self->mLittleSwing + 1) valueAtTime:v20];
  v22 = __sincosf_stret(3.1416 - v21);
  LODWORD(v8) = [objc_msgSend(v18 objectForKey:{@"slide0", "intValue"}];
  ...
  SetLightingColors(v37, v40, *[a5 foreColor]);
  ...
  if (v32 > a4)
  {
    ...
    SetLightingColors(v36, v43, *[a5 foreColor]);
    [a5 setColorsPointer:v36];
    [a5 setVertex3DPointer:v43];
    [a5 drawTriangleStripFromOffset:0 count:3];
    [a5 cull:1];
    SetLightingColors(v37, v44, *[a5 foreColor]);
    [a5 setColorsPointer:v36];
    [a5 drawTriangleStripFromOffset:1 count:3];
    if (v29 != v30)
    {
  ...
  [a5 cull:2];
  SetLightingColors(v36, v39, *[a5 foreColor]);
  [a5 setColorsPointer:v36];
  [a5 setVertex3DPointer:v39];
  [a5 drawTriangleStripFromOffset:0 count:3];
  [a5 unsetVertexPointer];
...
- (void)renderUnfoldingFlowerAtTime:(double)a3 andProgress:(double)a4 inContext:(id)a5 withArguments:(id)a6 inRect:(CGRect)a7 withAttributes:(id)a8
{
  ...
  v22 = [objc_msgSend(a8 objectForKey:{@"rectoSlideIndex", "intValue"}];
  v56 = [objc_msgSend(a8 objectForKey:{@"versoSlideIndex", "intValue"}];
  v23 = x;
  v24 = y;
  v25 = width;
  v26 = height;
  ...
  v108 = -v37;
  v109 = -v38;
  v39 = [a8 objectForKey:@"rectoSlideRect"];
  if (v39)
  {
  ...
  *&v48 = SetLightingColors2D(v60, v104, *[a5 foreColor]);
  [a5 setShader:{@"ColoredTexture", v48}];
  ...
  [a5 unsetVertexPointer];
  [a5 unsetShader];
  [a5 setTextureCoordinatesPointer:&v83 + 4 onTextureUnit:0];
  [a5 setShader:@"ColoredTexture"];
  SetLightingColors(v60, v90, *[a5 foreColor]);
  [a5 setColorsPointer:v60];
  [a5 setVertex3DPointer:v90];
  [a5 drawTriangleStripFromOffset:0 count:3];
  SetLightingColors(v61, v91, *[a5 foreColor]);
  [a5 setColorsPointer:v60];
  [a5 cull:v46];
  [a5 drawTriangleStripFromOffset:1 count:3];
  [a5 cull:v45];
  [a5 setTextureCoordinatesPointer:&v70 onTextureUnit:0];
  SetLightingColors(v60, v77, *[a5 foreColor]);
  [a5 setColorsPointer:v60];
  [a5 setVertex3DPointer:v77];
  [a5 cull:v46];
  [a5 drawTriangleStripFromOffset:0 count:3];
  [a5 cull:v45];
  SetLightingColors(v61, v78, *[a5 foreColor]);
  [a5 setColorsPointer:v60];
  [a5 drawTriangleStripFromOffset:1 count:3];
  [a5 unsetShader];
  SetLightingColors(v59, v69, *[a5 foreColor]);
  [a5 setShader:@"ColoredTexture"];
...
- (id)patchworkAtTime:(double)a3 inContext:(id)a4 withArguments:(id)a5
{
  ...
  if (v11 > a3)
  {
    if (v13)
    {
      ...
      v16 = [v15 retainedByUserRenderedImageAtTime:a4 inContext:a5 withArguments:a3];
      if ([v15 defaultKenBurnsType] == 1 || (objc_msgSend(v16, "width"), v18 = v17, objc_msgSend(v16, "height"), *&v19 = v19, v20 = (v18 / *&v19), objc_msgSend(v16, "scale"), v22 = v21, objc_msgSend(a4, "localAspectRatio"), v24 = v22 * v23 / v20, v25 = 1.0, v22 >= 1.0) && v24 >= 1.0)
      {
        v26 = [NSDictionary alloc];
        v27 = [v16 insertingInCollection];
        v28 = [NSValue valueWithCGRect:-1.0, v10 * -0.5, 2.0, v10];
        v29 = 2.0 / v10;
        *&v29 = 2.0 / v10;
        v30 = [v26 initWithObjectsAndKeys:{v27, @"image", v28, @"rectangle", +[NSNumber numberWithFloat:](NSNumber, "numberWithFloat:", v29), @"referenceAspectRatio", 0}];
LABEL_12:
        v38 = v30;
        [v12 addObject:v30];
...
LABEL_190:
      ...
      do
      {
        ...
        do
        {
          ...
          if (v55 == 0.0 && [objc_msgSend(v54 objectForKey:{@"subEffectID", "hasSuffix:", @"still"}])
          {
            ...
            {
              v60 = [(MREffectOrigami *)self _retainedByUserBackColorImageInContext:v228];
              v59 = 0;
            }
            ...
            if (v60)
            {
              ...
              if ([objc_msgSend(v54 objectForKey:{@"subEffectID", StretchRectangle(v235.f64, objc_msgSend(objc_msgSend(v54, "objectForKey:", @"stretchFlags", "intValue"), v48, v9)), "isEqualToString:", @"pstill"}] && ((objc_msgSend(v60, "aspectRatio"), v66 = v65, v65 < v52) || v65 > v50))
              {
                ...
                if ((v65 >= 1.0 || v68 <= 1.0) && (v65 <= 1.0 || v68 >= 1.0))
                {
                  ...
                  if (v69 >= 1.1)
                  {
                    ...
                    if (v217)
                    {
                      v91 = [(MREffectOrigami *)self _retainedByUserBackColorImageInContext:v228];
                      if (v66 < 1.0)
                      {
                        if (v205)
                        {
                        ...
                        v206 = [v91 insertingInCollection];
                        v92 = [NSValue valueWithCGRect:v214, v213, v235.f64[0] - v214, *(&v70 + 1)];
                        *&v93 = v202;
                        v94 = [v218 initWithObjectsAndKeys:{v206, @"image", v92, @"rectangle", +[NSNumber numberWithFloat:](NSNumber, "numberWithFloat:", v93), @"referenceAspectRatio", 0}];
                        [v12 addObject:v94];

                        v219 = [NSDictionary alloc];
                        v95 = v91;
                        v96 = [v91 insertingInCollection];
                        v97 = [v219 initWithObjectsAndKeys:{v96, @"image", +[NSValue valueWithCGRect:](NSValue, "valueWithCGRect:", v235.f64[0] + *&v236, v213, v214 + *&v70 - (v235.f64[0] + *&v236), *(&v70 + 1)), @"rectangle", &__kCFBooleanTrue, @"onTop", 0}];
                      }
                      ...
                      else
                      {
                        ...
                        v220 = v91;
                        v101 = [v91 insertingInCollection];
                        v102 = [NSValue valueWithCGRect:v214, v213, *&v70, v235.f64[1] - v213];
                        *&v103 = v202;
                        v104 = [v207 initWithObjectsAndKeys:{v101, @"image", v102, @"rectangle", +[NSNumber numberWithFloat:](NSNumber, "numberWithFloat:", v103), @"referenceAspectRatio", 0}];
                        [v12 addObject:v104];

                        v208 = [NSDictionary alloc];
                        v95 = v220;
                        v105 = [v220 insertingInCollection];
                        v97 = [v208 initWithObjectsAndKeys:{v105, @"image", +[NSValue valueWithCGRect:](NSValue, "valueWithCGRect:", v214, v235.f64[1] + *(&v236 + 1), *&v70, v213 + *(&v70 + 1) - (v235.f64[1] + *(&v236 + 1))), @"rectangle", &__kCFBooleanTrue, @"onTop", 0}];
                      }
              ...
              [v56 setObject:objc_msgSend(v67 forKey:{"insertingInCollection"), @"image"}];
  ...
  if (v13)
  {
    ...
    v16 = [v31 retainedByUserRenderedImageAtTime:a4 inContext:a5 withArguments:a3];
    if ([v31 defaultKenBurnsType] == 1 || (objc_msgSend(v16, "width"), v33 = v32, objc_msgSend(v16, "height"), *&v34 = v34, v35 = (v33 / *&v34), objc_msgSend(v16, "scale"), v22 = v36, objc_msgSend(a4, "localAspectRatio"), v24 = v22 * v37 / v35, v25 = 1.0, v22 >= 1.0) && v24 >= 1.0)
    {
...
LABEL_186:
    v179 = [(MREffectOrigami *)self _retainedByUserBackColorImageInContext:a4];
    [v16 setCenterX:0.0];
    [v16 setCenterY:0.0];
    v180 = [NSDictionary alloc];
    v181 = [v16 insertingInCollection];
    if (v22 >= v25)
    {
      v193 = [NSValue valueWithCGRect:-1.0, v14 * v24, 2.0, v10 * v24];
      v194 = 2.0 / v10;
      *&v194 = 2.0 / v10;
      v195 = [v180 initWithObjectsAndKeys:{v181, @"image", v193, @"rectangle", +[NSNumber numberWithFloat:](NSNumber, "numberWithFloat:", v194), @"referenceAspectRatio", 0}];
      v185 = v227;
      [v227 addObject:v195];
      ...
      v188 = [v179 insertingInCollection];
      v191 = (v10 + v14) * v24;
    ...
    else
    {
      ...
      v183 = 2.0 / v10;
      *&v183 = 2.0 / v10;
      v184 = [v180 initWithObjectsAndKeys:{v181, @"image", v182, @"rectangle", +[NSNumber numberWithFloat:](NSNumber, "numberWithFloat:", v183), @"referenceAspectRatio", 0}];
      v185 = v227;
      [v227 addObject:v184];
    ...
    v197 = [v187 initWithObjectsAndKeys:{v188, @"image", +[NSValue valueWithCGRect:](NSValue, "valueWithCGRect:", v190, v191, v189, v192), @"rectangle", &__kCFBooleanTrue, @"onTop", 0}];
    [v185 addObject:v197];
    ...
    do
    {
      ...
      do
      {
        ...
        if ([objc_msgSend(v123 objectForKey:{@"isVisibleAtEnd", "BOOLValue"}])
        {
          ...
          {
            v127 = v126;
            v128 = [-[NSDictionary objectForKey:](-[MRLayerEffect slideProvidersForElementIDs](v230->super.mEffectLayer "slideProvidersForElementIDs")];
          }

          else
          {
            v128 = [(MREffectOrigami *)v230 _retainedByUserBackColorImageInContext:v229];
            v127 = 0;
          }
          ...
          if (v128)
          {
            ...
            v235 = v241;
            v236 = v242;
            if (BYTE1(v230->mDescriptionAspectRatio) == 1)
            {
              if (BYTE2(v230->mDescriptionAspectRatio))
              {
                v131 = 0.00130208333;
              }
            ...
            v138 = [objc_msgSend(objc_msgSend(-[NSDictionary objectForKey:](v230->super.mFlattenedAttributes objectForKey:{@"breakInformation", "objectForKey:", v127), "objectForKey:", @"panEndDirection", "intValue"}];
            v215 = v235.f64[1];
            v216 = v235.f64[0];
            v139 = v236;
            v140 = [(MREffectOrigami *)v230 _checkPanoramaAbsoluteSizeForImage:v128 inRect:&v235];
            if (v134 < 1.0)
            {
              [v128 height];
              v148 = v147;
            ...
            if (!v156)
            {
              ...
              [v128 setCenterX:0.0];
              [v128 setCenterY:0.0];
              v135 = [v128 retainedByUserImage];
              [v128 releaseByUser];
              v158 = [*(&v230->mTotalNumberOfFolds + 1) objectForKeyedSubscript:v127];
              v119 = 2.0;
              v121 = 0.5;
              if (v158)
              {
...
LABEL_175:
              v160 = [(MREffectOrigami *)v230 _retainedByUserBackColorImageInContext:v229];
              if (v134 < 1.0)
              {
                if (v210)
                {
                ...
                v161 = [v160 insertingInCollection];
                v162 = [NSValue valueWithCGRect:v216, v215, v235.f64[0] - v216, *(&v139 + 1)];
                *&v163 = v204;
                v164 = [v211 initWithObjectsAndKeys:{v161, @"image", v162, @"rectangle", +[NSNumber numberWithFloat:](NSNumber, "numberWithFloat:", v163), @"referenceAspectRatio", 0}];
                [v227 addObject:v164];

                v165 = [NSDictionary alloc];
                v166 = [v160 insertingInCollection];
              ...
              else
              {
                ...
                {
                  [v135 setScale:*(&v236 + 1) / *(&v139 + 1)];
                  v171 = *(&v139 + 1) / *(&v236 + 1);
                  [v135 centerX];
                  [v135 setCenterX:v172 * v171];
                }

                v212 = [NSDictionary alloc];
                v173 = [v160 insertingInCollection];
                v174 = [NSValue valueWithCGRect:v216, v215, *&v139, v235.f64[1] - v215];
                *&v175 = v204;
                v176 = [v212 initWithObjectsAndKeys:{v173, @"image", v174, @"rectangle", +[NSNumber numberWithFloat:](NSNumber, "numberWithFloat:", v175), @"referenceAspectRatio", 0}];
                [v227 addObject:v176];
              ...
              v177 = [v165 initWithObjectsAndKeys:{v166, @"image", +[NSValue valueWithCGRect:](NSValue, "valueWithCGRect:", v167, v169, v168, v170), @"rectangle", &__kCFBooleanTrue, @"onTop", 0}];
              [v227 addObject:v177];
...
LABEL_130:
            [v124 setObject:objc_msgSend(v135 forKey:{"insertingInCollection"), @"image"}];
...
- (BOOL)_needsRenderingAtTime:(double)a3 remainingStillDurationAfter:(double *)a4
{
  ...
  v8 = [obj countByEnumeratingWithState:&v31 objects:v35 count:{16, a4}];
  if (v8)
  {
    v9 = v8;
    v10 = 0;
      ...
      while (2)
      {
        for (j = 0; j != v20; j = j + 1)
        {
          ...
          if (v25 != 0.0)
          {
            ...
            {
              v26 = [v24 intValue];
              if (v26 == [objc_msgSend(a3 substringFromIndex:{5), "intValue"}])
              {
                return v8;
              }
            }
