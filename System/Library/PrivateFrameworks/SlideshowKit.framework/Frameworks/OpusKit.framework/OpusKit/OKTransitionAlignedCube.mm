...
- (OKTransitionAlignedCube)init;
- (OKTransitionAlignedCube)initWithSettings:(id)settings;
- (void)prepareInView:(id)view;
@end

@implementation OKTransitionAlignedCube

- (OKTransitionAlignedCube)init
{
  v3.receiver = self;
  v3.super_class = OKTransitionAlignedCube;
...
{
  v8.receiver = self;
  v8.super_class = OKTransitionAlignedCube;
...
+ (id)supportedSettings
{
  ...
  v4.receiver = self;
  v4.super_class = &OBJC_METACLASS___OKTransitionAlignedCube;
...
- (void)prepareInView:(id)view
{
  ...
  [(CATransition *)self->super._transition setType:@"alignedCube"];
...
+ (void)setupJavascriptContext:(id)context
{
  [context setObject:objc_opt_class() forKeyedSubscript:@"OKTransitionAlignedCube"];
  v4 = objc_opt_class();
