...
- (double)_gkLuminance
{
  ColorSpace = CGColorGetColorSpace([self CGColor]);
  if (!ColorSpace)
  {
    ...
    v7 = [v3 stringWithFormat:@"%@ (colorSpace != ((void*)0))\n[%s (%s:%d)]", v4, "-[UIColor(GKColorAdditions) _gkLuminance]", objc_msgSend(lastPathComponent, "UTF8String"), 253];
  ...
  else
  {
    ...
    {
      v13 = 0.0;
      [self getWhite:&v14 alpha:{&v13, 0.0}];
      return v14;
    }
  }
