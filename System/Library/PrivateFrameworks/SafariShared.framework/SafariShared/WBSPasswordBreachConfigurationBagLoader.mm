...
- (WBSPasswordBreachConfigurationBagLoader)init
{
  ...
  if (v2)
  {
    ...
    v4 = [safari_safariSharedBundle URLForResource:@"WBSPasswordBreachConfigurationBag" withExtension:@"plist"];
    ...
    v8 = objc_opt_class();
    v9 = [v7 initWithDataFormat:0 builtInListURL:v4 downloadsDirectoryURL:safari_settingsDirectoryURL resourceName:@"PasswordBreachAwarenessConfigurationBag" resourceVersion:@"1" updateDateDefaultsKey:@"WBSPasswordBreachConfigurationBagLastUpdate" updateInterval:86400.0 snapshotClass:v8 snapshotTransformerClass:objc_opt_class()];
