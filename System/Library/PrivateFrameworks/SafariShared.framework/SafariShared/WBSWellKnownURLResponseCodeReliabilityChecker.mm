...
- (WBSWellKnownURLResponseCodeReliabilityChecker)initWithURL:(id)l;
- (void)cancel;
- (void)checkReliabilityWithCompletion:(id)completion;
@end
...
- (WBSWellKnownURLResponseCodeReliabilityChecker)initWithURL:(id)l
{
  ...
  if (v5)
  {
    safari_wellKnownResponseCodeReliabilityURL = [lCopy safari_wellKnownResponseCodeReliabilityURL];
    url = v5->_url;
    v5->_url = safari_wellKnownResponseCodeReliabilityURL;
    ...
    v13 = [v11 sessionWithConfiguration:safari_ephemeralSessionConfiguration delegate:0 delegateQueue:v5->_fetchOperationQueue];
    session = v5->_session;
    v5->_session = v13;
...
- (void)checkReliabilityWithCompletion:(id)completion
{
  ...
  [v5 setAttribution:1];
  v6 = MEMORY[0x1BFB13CE0](completionCopy);
