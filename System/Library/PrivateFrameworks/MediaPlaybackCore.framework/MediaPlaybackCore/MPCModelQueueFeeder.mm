...
- (BOOL)isExportableMediaTypeForItem:(id)item inSection:(id)section;
...
- (void)controller:(id)controller defersResponse:(id)response completion:(id)completion;
- (void)controllerReplacingResponse:(id)response withNewResponse:(id)newResponse fromRequest:(id)request;
- (void)dealloc;
...
- (NSString)playbackEngineID
{
  delegate = [(MPCModelQueueFeeder *)self delegate];
...
- (void)accountManager:(id)manager didChangeAccounts:(id)accounts
{
  ...
  {
    userIdentity = [(MPCPlaybackRequestEnvironment *)playbackRequestEnvironment userIdentity];

    if (userIdentity)
    {
      userIdentity2 = [(MPCPlaybackRequestEnvironment *)self->_playbackRequestEnvironment userIdentity];
      v11 = [managerCopy accountForUserIdentity:userIdentity2];
...
- (void)_clearQueueDueToAccountChange
{
  ...
  {
    uniqueIdentifier = [(MPCModelQueueFeeder *)self uniqueIdentifier];
    v11 = 138543618;
  ...
  _emptyStaticRequest = [(MPCModelQueueFeeder *)self _emptyStaticRequest];
  label = [(MPCModelPlaybackRequest *)self->_request label];
  v7 = label;
  if (label)
  {
    v8 = label;
  ...
  [_emptyStaticRequest setLabel:v9];

  request = [(MPCRequestController *)self->_requestController request];
  [request setModelRequest:_emptyStaticRequest];
...
- (id)_supplementalLibraryRequestWithError:(id *)error
{
  ...
  if (objc_opt_isKindOfClass())
  {
    mediaLibrary = [(MPCModelPlaybackRequest *)self->_request mediaLibrary];
    [v4 setMediaLibrary:mediaLibrary];
  }

  allowedSectionIdentifiers = [v4 allowedSectionIdentifiers];
  v69 = v4;
  if ([allowedSectionIdentifiers count])
  {
    v71 = [MEMORY[0x1E695DF70] arrayWithCapacity:{objc_msgSend(allowedSectionIdentifiers, "count")}];
    v99 = 0u;
    v100 = 0u;
    v101 = 0u;
    v102 = 0u;
    ...
    while (1)
    {
      for (i = 0; i != v9; ++i)
      {
        ...
        v12 = *(*(&v99 + 1) + 8 * i);
        personalizedStore = [v12 personalizedStore];
        universalStore = [v12 universalStore];
        v15 = universalStore;
        if (personalizedStore)
        {
          v16 = [personalizedStore cloudID] != 0;
          if (!v15)
          {
            goto LABEL_14;
          }
...
LABEL_14:
        ...
        globalPlaylistID = [v15 globalPlaylistID];
        ...
        {
          universalCloudLibraryID = [v15 universalCloudLibraryID];
          v18 = [universalCloudLibraryID length] != 0;
        }
...
LABEL_19:
        ...
        modelKind = [v12 modelKind];
        v94[0] = MEMORY[0x1E69E9820];
        v94[1] = 3221225472;
        v94[2] = __60__MPCModelQueueFeeder__supplementalLibraryRequestWithError___block_invoke;
        v94[3] = &unk_1E8234AE8;
        v97 = v16;
        v95 = personalizedStore;
        v98 = v18;
        v96 = v15;
        v22 = [v20 initWithSource:@"ModelQueueFeeder" modelKind:modelKind block:v94];
...
LABEL_22:
        ...
        {
          v59 = 0;
          allowedItemIdentifiers = v71;
          goto LABEL_80;
        }

        v60 = MEMORY[0x1E696ABC0];
        msv_compactDescription = [v7 msv_compactDescription];
        [v60 msv_errorWithDomain:@"MPCError" code:72 debugDescription:{@"Failed to create transportable allowedSectionIDs: %@", msv_compactDescription}];
        *error = v59 = 0;
LABEL_78:
        allowedItemIdentifiers = v71;
        goto LABEL_79;
  ...
  allowedItemIdentifiers = [v5 allowedItemIdentifiers];
  v71 = allowedItemIdentifiers;
  if (![allowedItemIdentifiers count])
  {
    goto LABEL_45;
  }

  obja = [MEMORY[0x1E695DF70] arrayWithCapacity:{objc_msgSend(allowedItemIdentifiers, "count")}];
  v90 = 0u;
  v91 = 0u;
  v92 = 0u;
  v93 = 0u;
  v24 = allowedItemIdentifiers;
  ...
  do
  {
    for (j = 0; j != v26; ++j)
    {
      ...
      v29 = *(*(&v90 + 1) + 8 * j);
      personalizedStore2 = [v29 personalizedStore];
      universalStore2 = [v29 universalStore];
      v32 = universalStore2;
      if (personalizedStore2)
      {
        v33 = [personalizedStore2 cloudID] != 0;
        if (!v32)
        {
          goto LABEL_35;
        }
...
LABEL_35:
      ...
      universalCloudLibraryID2 = [v32 universalCloudLibraryID];
...
LABEL_40:
      ...
      modelKind2 = [v29 modelKind];
      v85[0] = MEMORY[0x1E69E9820];
      v85[1] = 3221225472;
      v85[2] = __60__MPCModelQueueFeeder__supplementalLibraryRequestWithError___block_invoke_4;
      v85[3] = &unk_1E8234AE8;
      v88 = v33;
      v86 = personalizedStore2;
      v89 = v35;
      v87 = v32;
      v39 = [v37 initWithSource:@"ModelQueueFeeder" modelKind:modelKind2 block:v85];
...
LABEL_43:
  ...
  v5 = v69;
  allowedItemIdentifiers = v24;
  msv_compactDescription = obja;
  ...
  if (![obja count])
  {
    if (error)
    {
      ...
      msv_compactDescription2 = [allowedItemIdentifiers msv_compactDescription];
      *error = [v61 msv_errorWithDomain:@"MPCError" code:72 debugDescription:{@"Failed to create transportable allowedItemIDs: %@", msv_compactDescription2}];
  ...
  allowedItemIdentifiers = v71;
LABEL_45:
  msv_compactDescription = [v5 scopedContainers];
  if (![msv_compactDescription count])
  {
    goto LABEL_69;
  }

  v41 = [MEMORY[0x1E695DF70] arrayWithCapacity:{objc_msgSend(msv_compactDescription, "count")}];
  v81 = 0u;
  v82 = 0u;
  v83 = 0u;
  v84 = 0u;
  v66 = msv_compactDescription;
  msv_compactDescription = msv_compactDescription;
  v72 = [msv_compactDescription countByEnumeratingWithState:&v81 objects:v103 count:16];
  if (!v72)
  {
    goto LABEL_67;
  }
  ...
  while (2)
  {
    ...
    while (2)
    {
      ...
      personalizedStore3 = [identifiers personalizedStore];

      identifiers2 = [v44 identifiers];
      universalStore3 = [identifiers2 universalStore];

      if (personalizedStore3)
      {
        v49 = [personalizedStore3 cloudID] != 0;
        if (universalStore3)
        {
          goto LABEL_53;
        }
...
LABEL_53:
        globalPlaylistID2 = [universalStore3 globalPlaylistID];
        if ([globalPlaylistID2 length])
        {
          v51 = 1;
        }
        ...
        {
          universalCloudLibraryID3 = [universalStore3 universalCloudLibraryID];
          ...
          {
            v51 = [universalStore3 purchasedAdamID] != 0;
          }
        }
...
LABEL_64:
        ...
        identifiers3 = [v44 identifiers];
        [identifiers3 modelKind];
        v56 = v55 = v41;
...
LABEL_67:
  ...
  if (![v41 count])
  {
    if (error)
    {
      ...
      v40Msv_compactDescription = [msv_compactDescription msv_compactDescription];
      *error = [v63 msv_errorWithDomain:@"MPCError" code:72 debugDescription:{@"Failed to create transportable scopedContainers: %@", v40Msv_compactDescription}];
...
- (BOOL)section:(id)section shouldShuffleExcludeItem:(id)item
{
  ...
  shouldExcludeFromShuffle = [v7 shouldExcludeFromShuffle];

  return shouldExcludeFromShuffle;
}
...
- (BOOL)isPlayableItem:(id)item inSection:(id)section
{
  ...
  {
    results = os_log_create("com.apple.amp.mediaplaybackcore", "Playback");
    if (os_log_type_enabled(results, OS_LOG_TYPE_ERROR))
    {
      ...
      *buf = 138543874;
      ...
      v28 = 2114;
      v29 = v7;
      _os_log_impl(&dword_1C5C61000, results, OS_LOG_TYPE_ERROR, "[MQF:%{public}@:%p] isPlayableItem:inSection: | returning NO [no index for item in registry] item=%{public}@", buf, 0x20u);
    }
  ...
  {
    v12 = v8;
    results = [(MPCModelPlaybackResponse *)self->_response results];
    v13 = [results indexPathForGlobalIndex:v12];
    v14 = v13;
    if (v13)
    {
      if ([v13 length] != 2)
      {
        ...
        [currentHandler handleFailureInMethod:a2 object:self file:@"MPCModelQueueFeeder.m" lineNumber:1133 description:{@"IndexPath was not an item index path with globalIndex from registry: %ld indexPath=%@", v12, v14}];
      }

      v15 = [results itemAtIndexPath:v14];
      v16 = [MEMORY[0x1E6970670] genericObjectWithModelObject:v15];
      flattenedGenericObject = [v16 flattenedGenericObject];
      mpc_playable = [flattenedGenericObject mpc_playable];
    }
    ...
    else
    {
      ...
      {
        uniqueIdentifier2 = [(MPCModelQueueFeeder *)self uniqueIdentifier];
...
- (id)itemForItem:(id)item inSection:(id)section
{
  ...
  if (v10 != 0x7FFFFFFFFFFFFFFFLL)
  {
    v14 = v10;
    results = [(MPCModelPlaybackResponse *)self->_response results];
    v15 = [results indexPathForGlobalIndex:v14];
    v16 = v15;
    if (!v15)
    {
    ...
    {
      currentHandler = [MEMORY[0x1E696AAA8] currentHandler];
      [currentHandler handleFailureInMethod:a2 object:self file:@"MPCModelQueueFeeder.m" lineNumber:1066 description:{@"IndexPath was not an item index path with globalIndex from registry: %ld indexPath=%@", v14, v16}];
    }

    v17 = [results itemAtIndexPath:v16];
    ...
    if ([v18 type] == 10)
    {
      ...
      mediaClip = [v18 mediaClip];
      v13 = [(MPCModelMediaClipAVItem *)v20 initWithMediaClip:mediaClip];
    ...
    else
    {
      ...
      request = [(MPCModelPlaybackResponse *)self->_response request];
      itemProperties = [request itemProperties];
      v13 = [(MPCModelGenericAVItem *)v24 initWithGenericObject:v18 itemProperties:itemProperties playbackRequestEnvironment:self->_playbackRequestEnvironment identityPropertySet:self->_identityPropertySet];

      v27 = [MEMORY[0x1E696AD98] numberWithBool:self->_isSiriInitiated];
      [(MPCModelMediaClipAVItem *)v13 setSiriInitiated:v27];

      queueDescriptor = [(MPCModelPlaybackContext *)self->_playbackContext queueDescriptor];
      -[MPCModelMediaClipAVItem setPrioritizeStartupOverQuality:](v13, "setPrioritizeStartupOverQuality:", [queueDescriptor prioritizeStartupOverQuality]);

      userIdentity = [(MPCPlaybackRequestEnvironment *)self->_playbackRequestEnvironment userIdentity];
      v30 = [MPCMediaLibraryPlaybackAssetCacheProvider deviceLibraryProviderWithUserIdentity:userIdentity];
      [(MPCModelMediaClipAVItem *)v13 setAssetCacheProvider:v30];

      if (objc_opt_respondsToSelector())
      {
        mediaLibrary = [(MPCModelPlaybackRequest *)self->_request mediaLibrary];
        [(MPCModelMediaClipAVItem *)v13 setMediaLibrary:mediaLibrary];
      }
      ...
      if (!activeModelGenericAVItems)
      {
        ...
        self->_activeModelGenericAVItems = weakObjectsHashTable;
    ...
    v35 = [(MPCModelQueueFeeder *)self modelPlayEventForItem:v9 inSection:sectionCopy];
    ...
    associatedParticipantIdentifier = [*(&self->super.super.isa + v19[638]) associatedParticipantIdentifier];
    [(MPCModelMediaClipAVItem *)v13 setAssociatedParticipantIdentifier:associatedParticipantIdentifier];
...
LABEL_21:
  ...
  if (os_log_type_enabled(results, OS_LOG_TYPE_ERROR))
  {
    uniqueIdentifier2 = [(MPCModelQueueFeeder *)self uniqueIdentifier];
    *buf = 138543874;
    v43 = uniqueIdentifier2;
    v44 = 2048;
    selfCopy2 = self;
    v46 = 2114;
    v47 = v9;
    _os_log_impl(&dword_1C5C61000, results, OS_LOG_TYPE_ERROR, "[MQF:%{public}@:%p] itemForItem:inSection: | returning nil [no index for item in registry] item=%{public}@", buf, 0x20u);
  }
...
- (void)loadPlaybackContext:(id)context completion:(id)completion
{
  ...
  fallbackSectionRepresentation = [contextCopy fallbackSectionRepresentation];
  v9 = [fallbackSectionRepresentation copy];
  ...
  self->_startItemIdentifiers = startItemIdentifiers;

  startTimeModifications = [contextCopy startTimeModifications];
  startTimeModifications = self->_startTimeModifications;
  self->_startTimeModifications = startTimeModifications;

  endTimeModifications = [contextCopy endTimeModifications];
  endTimeModifications = self->_endTimeModifications;
  self->_endTimeModifications = endTimeModifications;

  siriReferenceIdentifier2 = [contextCopy siriReferenceIdentifier];
  self->_isSiriInitiated = siriReferenceIdentifier2 != 0;
  ...
  {
    currentHandler = [MEMORY[0x1E696AAA8] currentHandler];
    [currentHandler handleFailureInMethod:a2 object:self file:@"MPCModelQueueFeeder.m" lineNumber:852 description:{@"Request class (%@) must conform to MPCModelPlaybackRequest", objc_opt_class()}];
  }

  objc_opt_class();
  if (objc_opt_isKindOfClass())
  {
    mqf_requiredItemPlaybackProperties = self->_request;
    sectionKind = [(MPCModelPlaybackRequest *)mqf_requiredItemPlaybackProperties sectionKind];
    objc_opt_class();
    isKindOfClass = objc_opt_isKindOfClass();

    if (isKindOfClass)
    {
      sectionKind2 = [(MPCModelPlaybackRequest *)mqf_requiredItemPlaybackProperties sectionKind];
      if (([sectionKind2 variants] & 8) != 0)
      {
        v132 = [MEMORY[0x1E696ABC0] msv_errorWithDomain:@"MPCError" code:1 debugDescription:{@"Invalid request section kind [playlist variant Folder] kind=%@ request=%@", sectionKind2, self->_request}];
        (*(completionCopy + 2))(completionCopy, 0, 0, v132);

        goto LABEL_104;
      }

      v31 = MEMORY[0x1E6970718];
      variants = [sectionKind2 variants];
      playlistEntryKind = [sectionKind2 playlistEntryKind];
      v34 = [v31 kindWithVariants:variants playlistEntryKind:playlistEntryKind options:{objc_msgSend(sectionKind2, "options") | 8}];
      [(MPCModelPlaybackRequest *)mqf_requiredItemPlaybackProperties setSectionKind:v34];
      ...
      [(MPCModelPlaybackRequest *)mqf_requiredItemPlaybackProperties setScopedContainersPropertySet:v40];
    }
  }
  ...
  if (objc_opt_isKindOfClass())
  {
    ...
    if (self->_isSiriInitiated && ![siriAssetInfo length])
    {
      v51 = os_log_create("com.apple.amp.mediaplaybackcore", "Playback");
      if (os_log_type_enabled(v51, OS_LOG_TYPE_ERROR))
      {
        uniqueIdentifier3 = [(MPCModelQueueFeeder *)self uniqueIdentifier];
        *buf = 138543618;
        *&buf[4] = uniqueIdentifier3;
        *&buf[12] = 2048;
        *&buf[14] = self;
      ...
      siriReferenceIdentifier3 = [contextCopy siriReferenceIdentifier];
      v55 = siriReferenceIdentifier3;
      if (siriReferenceIdentifier3)
      {
        v56 = siriReferenceIdentifier3;
      }
      ...
      v172[0] = v56;
      identifiers = [(MPCModelPlaybackRequest *)v153 identifiers];
      v58 = identifiers;
      v59 = @"nil";
      if (identifiers)
      {
  ...
  itemKind = [(MPCModelPlaybackRequest *)self->_request itemKind];
  ...
  if (mqf_requiredItemPlaybackProperties)
  {
    ...
    {
      genericObjectType = [modelClass genericObjectType];
      if (genericObjectType)
      {
        v65 = [MEMORY[0x1E6970670] relationshipKeyForGenericObjectType:genericObjectType];
        if (v65)
        {
          relationships = [(MPPropertySet *)self->_representativeMetadataPropertySet relationships];
          v67 = [relationships objectForKeyedSubscript:v65];
          v68 = [(MPCModelPlaybackRequest *)mqf_requiredItemPlaybackProperties propertySetByCombiningWithPropertySet:v67];

          mqf_requiredItemPlaybackProperties = v68;
        }
      }
    }

    [(MPCModelPlaybackRequest *)self->_request setItemProperties:mqf_requiredItemPlaybackProperties];
    sectionKind3 = [(MPCModelPlaybackRequest *)self->_request sectionKind];
    modelClass2 = [sectionKind3 modelClass];

    mqf_requiredSectionPlaybackProperties = [modelClass2 mqf_requiredSectionPlaybackProperties];
    if (self->_representativeMetadataPropertySet)
    {
      genericObjectType2 = [modelClass2 genericObjectType];
      if (genericObjectType2)
      {
        v72 = [MEMORY[0x1E6970670] relationshipKeyForGenericObjectType:genericObjectType2];
        if (v72)
        {
          relationships2 = [(MPPropertySet *)self->_representativeMetadataPropertySet relationships];
          v74 = [relationships2 objectForKeyedSubscript:v72];
          v75 = [mqf_requiredSectionPlaybackProperties propertySetByCombiningWithPropertySet:v74];

          mqf_requiredSectionPlaybackProperties = v75;
        }
      }
    }

    [(MPCModelPlaybackRequest *)self->_request setSectionProperties:mqf_requiredSectionPlaybackProperties];
    if (objc_opt_respondsToSelector())
    {
    ...
    {
      v76 = self->_request;
      rtcReportingPlayQueueSourceIdentifier = [(MPCModelPlaybackRequest *)v76 rtcReportingPlayQueueSourceIdentifier];
      rtcReportingPlayQueueSourceIdentifier = self->_rtcReportingPlayQueueSourceIdentifier;
      self->_rtcReportingPlayQueueSourceIdentifier = rtcReportingPlayQueueSourceIdentifier;
    }
    ...
    {
      v81 = self->_request;
      playbackRequestEnvironment2 = [(MPCModelPlaybackRequest *)v81 playbackRequestEnvironment];
      v83 = playbackRequestEnvironment2 == self->_playbackRequestEnvironment;

      if (!v83)
      {
        playbackRequestEnvironment3 = [(MPCModelPlaybackRequest *)v81 playbackRequestEnvironment];
        userIdentity = [playbackRequestEnvironment3 userIdentity];
        userIdentity2 = [(MPCPlaybackRequestEnvironment *)self->_playbackRequestEnvironment userIdentity];
        defaultIdentityStore = [MEMORY[0x1E69E4688] defaultIdentityStore];
        v88 = [userIdentity isEqualToIdentity:userIdentity2 inStore:defaultIdentityStore];
        ...
        if ((v88 & 1) == 0)
        {
          ...
          {
            uniqueIdentifier4 = [(MPCModelQueueFeeder *)self uniqueIdentifier];
            playbackRequestEnvironment4 = [(MPCModelPlaybackRequest *)v81 playbackRequestEnvironment];
            v92 = self->_playbackRequestEnvironment;
            *buf = 138544130;
            *&buf[4] = uniqueIdentifier4;
            *&buf[12] = 2048;
            *&buf[14] = self;
            *&buf[22] = 2114;
            v169 = playbackRequestEnvironment4;
            LOWORD(v170) = 2114;
            *(&v170 + 2) = v92;
    ...
    if (MSVDeviceOSIsInternalInstall())
    {
      ...
      v94 = [standardUserDefaults BOOLForKey:@"_static_qf_debug"];

      if (v94)
      {
        _staticRegistryRequest = [(MPCModelQueueFeeder *)self _staticRegistryRequest];
        v96 = self->_request;
        self->_request = _staticRegistryRequest;
      }
    }
    ...
    request2 = [(MPCRequestController *)self->_requestController request];
    [request2 setTimeoutInterval:0.0];

    request3 = [(MPCRequestController *)self->_requestController request];
    [request3 setQualityOfService:25];

    label2 = [(MPCModelPlaybackRequest *)self->_request label];
    request4 = [(MPCRequestController *)self->_requestController request];
    [request4 setLabel:label2];

    v106 = self->_request;
    request5 = [(MPCRequestController *)self->_requestController request];
    [request5 setModelRequest:v106];

    v108 = [completionCopy copy];
    ...
    v158 = 0;
    v110 = [[MPCModelGenericAVItemUserIdentityPropertySet alloc] initWithRequestContext:_createStoreRequestContext error:&v158];
    v111 = v158;
    ...
    if (v111)
    {
      ...
      {
        uniqueIdentifier5 = [(MPCModelQueueFeeder *)self uniqueIdentifier];
        treeDescription = [v111 treeDescription];
        *buf = 138543874;
        *&buf[4] = uniqueIdentifier5;
        *&buf[12] = 2048;
        *&buf[14] = self;
        *&buf[22] = 2114;
        v169 = treeDescription;
      ...
      if (objc_opt_isKindOfClass())
      {
        ...
        *(&v170 + 1) = 0;
        if (siriAssetInfo)
        {
          ...
          {
            uniqueIdentifier6 = [(MPCModelQueueFeeder *)self uniqueIdentifier];
            *v160 = 138543874;
            v161 = uniqueIdentifier6;
            v162 = 2048;
            selfCopy3 = self;
            v164 = 2114;
            v165 = siriAssetInfo;
          ...
          userIdentity3 = [(MPCPlaybackRequestEnvironment *)self->_playbackRequestEnvironment userIdentity];
          v124 = [MPCModelStorePlaybackItemsRequest MPC_consumeSiriAssetInfo:siriAssetInfo userIdentity:userIdentity3];

          if ([contextCopy shuffleType] && v124)
          {
            v125 = os_log_create("com.apple.amp.mediaplaybackcore", "Playback");
            if (os_log_type_enabled(v125, OS_LOG_TYPE_DEFAULT))
            {
              uniqueIdentifier7 = [(MPCModelQueueFeeder *)self uniqueIdentifier];
              *v160 = 138543874;
              v161 = uniqueIdentifier7;
              v162 = 2048;
              selfCopy3 = self;
              v164 = 2114;
              v165 = v124;
        ...
        identifiers2 = [(MPCModelPlaybackRequest *)v146 identifiers];
        totalItemCount = [identifiers2 totalItemCount];
        v129 = self->_startItemIdentifiers;
        v130 = v129;
        if (totalItemCount >= 1 && !v129)
        {
          if ([contextCopy shuffleType])
          {
            v131 = arc4random_uniform(totalItemCount);
          }
          ...
          v133 = [identifiers2 indexPathForGlobalIndex:v131];
          v134 = *(*&buf[8] + 40);
          *(*&buf[8] + 40) = v133;

          v130 = [identifiers2 identifiersForItemAtIndexPath:*(*&buf[8] + 40)];
          v135 = os_log_create("com.apple.amp.mediaplaybackcore", "Playback");
          if (os_log_type_enabled(v135, OS_LOG_TYPE_DEFAULT))
          {
            uniqueIdentifier8 = [(MPCModelQueueFeeder *)self uniqueIdentifier];
            *v160 = 138544130;
            v161 = uniqueIdentifier8;
            v162 = 2048;
            selfCopy3 = self;
            v164 = 2048;
            v165 = v131;
        ...
        if (v130 && !*(*&buf[8] + 40))
        {
          ...
          v156 = v130;
          v157 = buf;
          [identifiers2 enumerateItemIdentifiersUsingBlock:v155];
...
LABEL_103:
  ...
  if (MSVDeviceOSIsInternalInstall())
  {
    ...
    [currentHandler2 handleFailureInMethod:a2 object:self file:@"MPCModelQueueFeeder.m" lineNumber:910 description:{@"Invalid request item class: %@ for %@", modelClass, self->_request}];
  }

  mqf_requiredItemPlaybackProperties = [MEMORY[0x1E696ABC0] msv_errorWithDomain:@"MPCError" code:1 debugDescription:{@"Invalid request item class: %@ for %@", modelClass, self->_request}];
  (*(completionCopy + 2))(completionCopy, 0, 0, mqf_requiredItemPlaybackProperties);
LABEL_104:
}
...
- (id)firstItemIntersectingIdentifierSet:(id)set
{
  ...
  setCopy = set;
  results = [(MPCModelPlaybackResponse *)response results];
  v7 = [results indexPathForItemWithIdentifiersIntersectingSet:setCopy];

  if (v7)
  {
    results2 = [(MPCModelPlaybackResponse *)self->_response results];
    v9 = [results2 globalIndexForIndexPath:v7];
...
- (id)accountIDForItem:(id)item inSection:(id)section
{
  ...
  v5 = [(MPCModelGenericAVItemUserIdentityPropertySet *)self->_identityPropertySet delegatedIdentityProperties:item];
  v6 = v5;
  if (v5)
  {
    dSID = [v5 DSID];
...
- (BOOL)isExportableMediaTypeForItem:(id)item inSection:(id)section
{
  ...
  if (v7 != 0x7FFFFFFFFFFFFFFFLL)
  {
    ...
    if (v8 < totalItemCount)
    {
      results2 = [(MPCModelPlaybackResponse *)self->_response results];
      v12 = [results2 indexPathForGlobalIndex:v8];

      results3 = [(MPCModelPlaybackResponse *)self->_response results];
      v14 = [results3 itemAtIndexPath:v12];
...
LABEL_19:
        ...
        if ([v18 type] == 5)
        {
          playlistEntry = [v18 playlistEntry];
        }
...
- (BOOL)supportsAutoPlayForItem:(id)item inSection:(id)section
{
  ...
  results = [(MPCModelPlaybackResponse *)self->_response results];
  v12 = [results indexPathForGlobalIndex:v8];

  results2 = [(MPCModelPlaybackResponse *)self->_response results];
  v14 = [results2 itemAtIndexPath:v12];
...
LABEL_20:
  if (song && ([song hasVideo] & 1) == 0)
  {
    v17 = [song isArtistUploadedContent] ^ 1;
  }
...
- (void)controller:(id)controller defersResponse:(id)response completion:(id)completion
{
  ...
  {
    currentHandler = [MEMORY[0x1E696AAA8] currentHandler];
    [currentHandler handleFailureInMethod:a2 object:self file:@"MPCModelQueueFeeder.m" lineNumber:428 description:@"MPCModelQueueFeeder expects non-nil response"];
  }
...
{
  requestCopy = request;
  modelResponse = [newResponse modelResponse];
  modelRequest = [requestCopy modelRequest];

  objc_opt_class();
  if (objc_opt_isKindOfClass())
  {
    [modelRequest setPreviousResponse:modelResponse];
  }
}
...
- (void)getRepresentativeMetadataForPlaybackContext:(id)context properties:(id)properties completion:(id)completion
{
  ...
  self->_representativeMetadataPropertySet = propertiesCopy;
  v12 = propertiesCopy;
...
{
  itemCopy = item;
  v6 = [(MPCModelQueueFeeder *)self _playlistFolderPlayEventForItem:itemCopy];
  v7 = v6;
  if (v6)
  {
    v8 = v6;
  ...
  {
    v8 = [(MPCModelQueueFeeder *)self _modelPlayEventForItem:itemCopy];
  }
...
- (id)_modelPlayEventForItem:(id)item
{
  ...
  results = [(MPCModelPlaybackResponse *)self->_response results];
  v8 = [results indexPathForGlobalIndex:v6];

  if (v8)
  {
    results2 = [(MPCModelPlaybackResponse *)self->_response results];
    v10 = [results2 sectionAtIndex:{objc_msgSend(v8, "section")}];
  }
  ...
  if (v10 == 0 || v12)
  {
    ...
    {
      anyObject2 = [(MPModelGenericObject *)fallbackSectionRepresentation anyObject];
  ...
  v17 = [v15 playEventWithModelObject:v10 featureName:playActivityFeatureName];
...
- (id)firstModelPlayEvent
{
  ...
  v5 = [(MPCModelQueueFeeder *)self _playlistFolderPlayEventForItem:firstItem];
  ...
  else
  {
    ...
    results2 = [(MPCModelPlaybackResponse *)self->_response results];
    firstSection = [results2 firstSection];
    fallbackSectionRepresentation = firstSection;
    if (!firstSection)
    {
      fallbackSectionRepresentation = self->_fallbackSectionRepresentation;
    }
    ...
    playActivityFeatureName = [(MPQueueFeeder *)self playActivityFeatureName];
    v6 = [v7 playEventWithModelObject:fallbackSectionRepresentation featureName:playActivityFeatureName];
  }
...
- (id)_playlistFolderPlayEventForItem:(id)item
{
  ...
  if (objc_opt_isKindOfClass())
  {
    scopedContainers = [(MPCModelPlaybackResponse *)self->_response scopedContainers];
    lastObject = [scopedContainers lastObject];

    if ([lastObject type] == 4)
    {
      playlist = [lastObject playlist];
      if ([playlist type] == 3)
      {
        v8 = MEMORY[0x1E6970708];
        v9 = [(MPCModelQueueFeeder *)self _modelPlayEventForItem:itemCopy];
        playActivityFeatureName = [(MPQueueFeeder *)self playActivityFeatureName];
        v11 = [v8 mpc_playEventWithModelObject:playlist nestedPlayEvent:v9 featureName:playActivityFeatureName];
      }
...
- (id)supplementalPlaybackContextWithReason:(int64_t)reason
{
  ...
  if ([results totalItemCount])
  {
    ...
    if (reason < 2)
    {
      ...
      if ((forceLibrarySupplementalContexts & 1) == 0)
      {
        v16 = 0;
        goto LABEL_25;
      }
    ...
    else if (reason != 2)
    {
      if (reason == 3)
      {
        ...
        if (isKindOfClass)
        {
          ...
          *&buf[16] = 0x2020000000;
          LOBYTE(reasonCopy) = 0;
          v9 = [MEMORY[0x1E695DF70] arrayWithCapacity:{objc_msgSend(results, "numberOfSections")}];
        ...
        storeIDs = [(MPCModelStorePlaybackItemsRequest *)v6 storeIDs];
        v12 = storeIDs == 0;
...
LABEL_20:
          ...
          [(MPCModelPlaybackContext *)v13 setPlayActivityQueueGroupingID:playActivityQueueGroupingID];

          playActivityFeatureName = [(MPQueueFeeder *)self playActivityFeatureName];
          [(MPCModelPlaybackContext *)v13 setPlayActivityFeatureName:playActivityFeatureName];

          playActivityRecommendationData = [(MPQueueFeeder *)self playActivityRecommendationData];
          [(MPCModelPlaybackContext *)v13 setPlayActivityRecommendationData:playActivityRecommendationData];
...
LABEL_18:
    ...
    v19 = [(MPCModelQueueFeeder *)self _sectionedModelObjectsRepresentationForSectionedCollection:results];
...
- (id)playbackInfoForItem:(id)item
{
  ...
  if (v29[5])
  {
    ...
    [dictionary setObject:v29[5] forKey:*MEMORY[0x1E696F7F0]];
  }
  ...
  *(&v44 + 1) = 0;
  ...
  if (*(*&buf[8] + 40))
  {
    ...
    [dictionary setObject:*(*&buf[8] + 40) forKey:*MEMORY[0x1E696F7D8]];
  }
...
- (void)applyVolumeNormalizationForItem:(id)item
{
  ...
  {
    modelGenericObject = [itemCopy modelGenericObject];
    if ([modelGenericObject type] == 1)
    {
      song = [modelGenericObject song];
      album = [song album];
    }
  ...
  if ([album hasLoadedValueForKey:*MEMORY[0x1E696FC50]])
  {
    [album volumeNormalization];
    v9 = v8;
  }
  ...
  [itemCopy setSoundCheckVolumeNormalization:v13];
  *&v14 = v9;
  [itemCopy setLoudnessInfoVolumeNormalization:v14];
}
