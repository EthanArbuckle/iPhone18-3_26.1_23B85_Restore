...
{
  v4 = a2;
  if ([v4 hasLoadedValueForKey:*MEMORY[0x1E696FD70]])
  {
    [v4 setLibraryAddEligible:{objc_msgSend(*(a1 + 32), "isLibraryAddEligible")}];
  }

  if ([v4 hasLoadedValueForKey:*MEMORY[0x1E6970190]])
  {
    v3 = [*(a1 + 32) storeAsset];
    [v4 setStoreAsset:v3];
  }
