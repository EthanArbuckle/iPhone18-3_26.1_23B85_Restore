...
- (CCFitnessGuestMetaContent)initWithJSONDictionary:(id)dictionary error:(id *)error;
- (CCFitnessGuestMetaContent)initWithSourceItemIdentifier:(id)identifier error:(id *)error;
...
- (CCFitnessGuestMetaContent)initWithJSONDictionary:(id)dictionary error:(id *)error
{
  ...
  if (IsInstanceOfExpectedClass)
  {
    ...
    v10 = [[CCFitnessGuestMetaContent alloc] initWithSourceItemIdentifier:v9 error:error];
  }
...
- (id)jsonDictionary
{
  ...
  {
    sourceItemIdentifier = [(CCFitnessGuestMetaContent *)self sourceItemIdentifier];
...
- (void)enumerateFieldsUsingBlock:(id)block parentFieldType:(unsigned __int16)type
{
  if (self->_sourceItemIdentifier)
  {
    ...
    blockCopy = block;
    v8 = [[v6 alloc] initWithFieldType:53618 stringValue:self->_sourceItemIdentifier];
...
+ (id)descriptionForTypeIdentifier:(unsigned __int16)identifier
{
  if (identifier == 53618)
  {
    return @"FitnessGuestMetaContent_sourceItemIdentifier";
  }
