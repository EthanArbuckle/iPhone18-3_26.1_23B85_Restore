...
- (CCWalletPaymentsCommerceOrderEmailPaymentInformationPaymentMethod)initWithDisplayName:(id)a3 lastFourDigits:(id)a4 isApplePay:(id)a5 error:(id *)a6;
- (CCWalletPaymentsCommerceOrderEmailPaymentInformationPaymentMethod)initWithJSONDictionary:(id)a3 error:(id *)a4;
...
- (CCWalletPaymentsCommerceOrderEmailPaymentInformationPaymentMethod)initWithJSONDictionary:(id)a3 error:(id *)a4
{
  ...
  if (IsInstanceOfExpectedClass)
  {
    ...
    v12 = [[CCWalletPaymentsCommerceOrderEmailPaymentInformationPaymentMethod alloc] initWithDisplayName:v9 lastFourDigits:v10 isApplePay:v11 error:a4];
  }
...
- (id)jsonDictionary
{
  ...
  {
    v4 = [(CCWalletPaymentsCommerceOrderEmailPaymentInformationPaymentMethod *)self displayName];
    [v3 setObject:v4 forKeyedSubscript:@"displayName"];
  }

  if (self->_lastFourDigits)
  {
    v5 = [(CCWalletPaymentsCommerceOrderEmailPaymentInformationPaymentMethod *)self lastFourDigits];
