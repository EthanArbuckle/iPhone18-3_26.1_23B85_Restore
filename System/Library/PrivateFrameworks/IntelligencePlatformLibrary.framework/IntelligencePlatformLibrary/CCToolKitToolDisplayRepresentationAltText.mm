@interface CCToolKitToolDisplayRepresentationAltText
- (BOOL)initializeFieldValuesFromData:(id)data error:(id *)error;
- (CCToolKitToolDisplayRepresentationAltText)initWithJSONDictionary:(id)dictionary error:(id *)error;
- (CCToolKitToolDisplayRepresentationAltText)initWithKind:(id)kind kindType:(unsigned int)type error:(id *)error;
- (CCToolKitToolDisplayRepresentationAltTextStatic)staticType;
- (CCToolKitToolDisplayRepresentationStorage)lazy;
- (id)jsonDictionary;
- (void)enumerateFieldsUsingBlock:(id)block parentFieldType:(unsigned __int16)type;
@end

@implementation CCToolKitToolDisplayRepresentationAltText
...
LABEL_10:
      ...
      v17 = [[CCToolKitToolDisplayRepresentationAltText alloc] initWithKind:v10 kindType:v16 error:error];
      goto LABEL_20;
    }

    v19 = 0;
    v13 = [[CCToolKitToolDisplayRepresentationAltTextStatic alloc] initWithJSONDictionary:v12 error:&v19];
    v14 = v19;
    v10 = v14;
    if (v13 && !v14)
    {
...
- (id)jsonDictionary
{
  ...
  if (kindType == 1)
  {
    ...
    lazy = [(CCToolKitToolDisplayRepresentationAltText *)self lazy];
  ...
  {
    staticType = [(CCToolKitToolDisplayRepresentationAltText *)self staticType];
...
- (CCToolKitToolDisplayRepresentationAltTextStatic)staticType
{
  v2 = [(CCToolKitToolDisplayRepresentationAltTextStatic *)self->_staticType copy];
...
LABEL_21:
    if ((v21 >> 3) == 2)
    {
      v28 = [CCToolKitToolDisplayRepresentationAltTextStatic alloc];
