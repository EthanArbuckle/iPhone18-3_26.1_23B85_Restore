...
- (CCContactMetaContent)initWithJSONDictionary:(id)dictionary error:(id *)error;
- (CCContactMetaContent)initWithSourceItemIdentifier:(id)identifier error:(id *)error;
...
- (CCContactMetaContent)initWithJSONDictionary:(id)dictionary error:(id *)error
{
  ...
  if (IsInstanceOfExpectedClass)
  {
    ...
    v10 = [[CCContactMetaContent alloc] initWithSourceItemIdentifier:v9 error:error];
  }
...
- (id)jsonDictionary
{
  ...
  {
    sourceItemIdentifier = [(CCContactMetaContent *)self sourceItemIdentifier];
...
- (void)enumerateFieldsUsingBlock:(id)block parentFieldType:(unsigned __int16)type
{
  if (self->_sourceItemIdentifier)
  {
    ...
    blockCopy = block;
    v8 = [[v6 alloc] initWithFieldType:19704 stringValue:self->_sourceItemIdentifier];
...
+ (id)descriptionForTypeIdentifier:(unsigned __int16)identifier
{
  if (identifier == 19704)
  {
    return @"ContactMetaContent_sourceItemIdentifier";
  }
