...
- (CCToolKitToolValueSearchPredicate)initWithJSONDictionary:(id)a3 error:(id *)a4;
- (CCToolKitToolValueSearchPredicate)initWithValues:(id)a3 error:(id *)a4;
- (NSArray)values;
- (id)jsonDictionary;
...
- (CCToolKitToolValueSearchPredicate)initWithJSONDictionary:(id)a3 error:(id *)a4
{
  ...
  if (IsInstanceOfExpectedClass)
  {
    ...
    v24 = [[CCToolKitToolValueSearchPredicate alloc] initWithValues:v13 error:a4];
    v10 = v13;
LABEL_21:
...
- (id)jsonDictionary
{
  ...
  if (self->_values)
  {
    ...
    v16 = 0u;
    v17 = 0u;
    v5 = [(CCToolKitToolValueSearchPredicate *)self values];
