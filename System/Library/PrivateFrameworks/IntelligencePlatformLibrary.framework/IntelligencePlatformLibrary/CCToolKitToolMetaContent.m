...
- (CCToolKitToolMetaContent)initWithJSONDictionary:(id)a3 error:(id *)a4;
- (CCToolKitToolMetaContent)initWithSourceItemIdentifier:(id)a3 error:(id *)a4;
...
- (CCToolKitToolMetaContent)initWithJSONDictionary:(id)a3 error:(id *)a4
{
  ...
  if (IsInstanceOfExpectedClass)
  {
    ...
    v10 = [[CCToolKitToolMetaContent alloc] initWithSourceItemIdentifier:v9 error:a4];
  }
...
- (id)jsonDictionary
{
  ...
  {
    v4 = [(CCToolKitToolMetaContent *)self sourceItemIdentifier];
