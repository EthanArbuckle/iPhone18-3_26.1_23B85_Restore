...
- (CCWalletExtractedOrderMetaContent)initWithJSONDictionary:(id)a3 error:(id *)a4;
- (CCWalletExtractedOrderMetaContent)initWithSourceItemIdentifier:(id)a3 error:(id *)a4;
...
- (CCWalletExtractedOrderMetaContent)initWithJSONDictionary:(id)a3 error:(id *)a4
{
  ...
  if (IsInstanceOfExpectedClass)
  {
    ...
    v10 = [[CCWalletExtractedOrderMetaContent alloc] initWithSourceItemIdentifier:v9 error:a4];
  }
...
- (id)jsonDictionary
{
  ...
  {
    v4 = [(CCWalletExtractedOrderMetaContent *)self sourceItemIdentifier];
