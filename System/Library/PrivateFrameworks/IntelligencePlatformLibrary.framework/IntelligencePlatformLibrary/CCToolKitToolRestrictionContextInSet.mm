...
- (CCToolKitToolRestrictionContextInSet)initWithDefinition:(id)a3 templates:(id)a4 error:(id *)a5;
- (CCToolKitToolRestrictionContextInSet)initWithJSONDictionary:(id)a3 error:(id *)a4;
...
- (CCToolKitToolRestrictionContextInSet)initWithJSONDictionary:(id)a3 error:(id *)a4
{
  ...
  {
    v9 = [v6 objectForKeyedSubscript:@"definition"];
    if (v9)
    {
      v20[0] = 0;
...
LABEL_13:
      v17 = [[CCToolKitToolRestrictionContextInSet alloc] initWithDefinition:v9 templates:v14 error:a4];
      v12 = v14;
LABEL_16:
...
- (id)jsonDictionary
{
  ...
  if (self->_definition)
  {
    v4 = [(CCToolKitToolRestrictionContextInSet *)self definition];
    v5 = [v4 jsonDictionary];
    [v3 setObject:v5 forKeyedSubscript:@"definition"];
  }

  if (self->_templates)
  {
    v6 = [(CCToolKitToolRestrictionContextInSet *)self templates];
