...
- (CCWalletPaymentsCommerceOrderEmailPaymentInformation)initWithJSONDictionary:(id)a3 error:(id *)a4;
- (CCWalletPaymentsCommerceOrderEmailPaymentInformation)initWithTotalAmount:(id)a3 totalCurrencyCode:(id)a4 paymentMethod:(id)a5 error:(id *)a6;
...
- (CCWalletPaymentsCommerceOrderEmailPaymentInformation)initWithJSONDictionary:(id)a3 error:(id *)a4
{
  ...
  if (IsInstanceOfExpectedClass)
  {
    ...
    v10 = [v6 objectForKeyedSubscript:@"totalCurrencyCode"];
    ...
    v16 = [[CCWalletPaymentsCommerceOrderEmailPaymentInformation alloc] initWithTotalAmount:v9 totalCurrencyCode:v10 paymentMethod:v13 error:a4];
    v12 = v13;
LABEL_10:
...
- (id)jsonDictionary
{
  ...
  {
    v4 = [(CCWalletPaymentsCommerceOrderEmailPaymentInformation *)self totalAmount];
    [v3 setObject:v4 forKeyedSubscript:@"totalAmount"];
  }

  if (self->_totalCurrencyCode)
  {
    v5 = [(CCWalletPaymentsCommerceOrderEmailPaymentInformation *)self totalCurrencyCode];
    [v3 setObject:v5 forKeyedSubscript:@"totalCurrencyCode"];
  }

  if (self->_paymentMethod)
  {
    v6 = [(CCWalletPaymentsCommerceOrderEmailPaymentInformation *)self paymentMethod];
