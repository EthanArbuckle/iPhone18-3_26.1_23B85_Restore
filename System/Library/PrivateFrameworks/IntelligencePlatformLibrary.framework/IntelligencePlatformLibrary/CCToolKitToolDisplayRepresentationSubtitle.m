...
- (CCToolKitToolDisplayRepresentationSubtitle)initWithJSONDictionary:(id)a3 error:(id *)a4;
- (CCToolKitToolDisplayRepresentationSubtitle)initWithKind:(id)a3 kindType:(unsigned int)a4 error:(id *)a5;
...
- (CCToolKitToolDisplayRepresentationSubtitle)initWithJSONDictionary:(id)a3 error:(id *)a4
{
  ...
  {
    v9 = [v6 objectForKeyedSubscript:@"lazy"];
    if (v9)
    {
      v20[0] = 0;
    ...
    v12 = [v6 objectForKeyedSubscript:@"staticType"];
    if (!v12)
    {
LABEL_10:
      if (v9)
      ...
      v17 = [[CCToolKitToolDisplayRepresentationSubtitle alloc] initWithKind:v10 kindType:v16 error:a4];
      goto LABEL_20;
    }
...
- (id)jsonDictionary
{
  ...
  if (kindType == 1)
  {
    ...
    v5 = [(CCToolKitToolDisplayRepresentationSubtitle *)self lazy];
    v6 = [v5 jsonDictionary];
    [v3 setObject:v6 forKeyedSubscript:@"lazy"];
  ...
  {
    v7 = [(CCToolKitToolDisplayRepresentationSubtitle *)self staticType];
    v8 = [v7 jsonDictionary];
    [v3 setObject:v8 forKeyedSubscript:@"staticType"];
  }
