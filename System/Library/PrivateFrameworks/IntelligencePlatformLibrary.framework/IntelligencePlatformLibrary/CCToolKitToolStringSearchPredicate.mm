...
- (CCToolKitToolStringSearchPredicate)initWithJSONDictionary:(id)a3 error:(id *)a4;
- (CCToolKitToolStringSearchPredicate)initWithSearchString:(id)a3 error:(id *)a4;
...
- (CCToolKitToolStringSearchPredicate)initWithJSONDictionary:(id)a3 error:(id *)a4
{
  ...
  if (IsInstanceOfExpectedClass)
  {
    ...
    v10 = [[CCToolKitToolStringSearchPredicate alloc] initWithSearchString:v9 error:a4];
  }
...
- (id)jsonDictionary
{
  ...
  {
    v4 = [(CCToolKitToolStringSearchPredicate *)self searchString];
