...
- (CCToolKitToolSystemToolProtocolShowInAppStringSearchResults)initWithJSONDictionary:(id)a3 error:(id *)a4;
- (CCToolKitToolSystemToolProtocolShowInAppStringSearchResults)initWithValues:(id)a3 error:(id *)a4;
- (NSArray)values;
- (id)jsonDictionary;
...
- (CCToolKitToolSystemToolProtocolShowInAppStringSearchResults)initWithJSONDictionary:(id)a3 error:(id *)a4
{
  ...
  if (IsInstanceOfExpectedClass)
  {
    ...
    v10 = [[CCToolKitToolSystemToolProtocolShowInAppStringSearchResults alloc] initWithValues:v9 error:a4];
  }
...
- (id)jsonDictionary
{
  ...
  if (self->_values)
  {
    v4 = [(CCToolKitToolSystemToolProtocolShowInAppStringSearchResults *)self values];
