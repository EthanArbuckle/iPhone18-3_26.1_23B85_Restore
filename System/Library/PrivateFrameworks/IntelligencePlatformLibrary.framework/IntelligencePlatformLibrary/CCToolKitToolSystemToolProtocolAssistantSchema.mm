...
- (CCToolKitToolSystemToolProtocolAssistantSchema)initWithIdentifier:(id)a3 error:(id *)a4;
- (CCToolKitToolSystemToolProtocolAssistantSchema)initWithJSONDictionary:(id)a3 error:(id *)a4;
- (id)jsonDictionary;
...
- (CCToolKitToolSystemToolProtocolAssistantSchema)initWithJSONDictionary:(id)a3 error:(id *)a4
{
  ...
  if (IsInstanceOfExpectedClass)
  {
    ...
    v14 = [[CCToolKitToolSystemToolProtocolAssistantSchema alloc] initWithIdentifier:v11 error:a4];
    v10 = v11;
LABEL_10:
...
- (id)jsonDictionary
{
  ...
  if (self->_identifier)
  {
    v4 = [(CCToolKitToolSystemToolProtocolAssistantSchema *)self identifier];
