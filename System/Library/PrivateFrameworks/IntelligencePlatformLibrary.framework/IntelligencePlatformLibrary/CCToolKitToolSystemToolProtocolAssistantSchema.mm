@interface CCToolKitToolSystemToolProtocolAssistantSchema
- (BOOL)initializeFieldValuesFromData:(id)data error:(id *)error;
- (CCToolKitToolAssistantSchemaIdentifier)identifier;
- (CCToolKitToolSystemToolProtocolAssistantSchema)initWithIdentifier:(id)identifier error:(id *)error;
- (CCToolKitToolSystemToolProtocolAssistantSchema)initWithJSONDictionary:(id)dictionary error:(id *)error;
- (id)jsonDictionary;
- (void)enumerateFieldsUsingBlock:(id)block parentFieldType:(unsigned __int16)type;
@end

@implementation CCToolKitToolSystemToolProtocolAssistantSchema
...
- (CCToolKitToolSystemToolProtocolAssistantSchema)initWithJSONDictionary:(id)dictionary error:(id *)error
{
  ...
  if (IsInstanceOfExpectedClass)
  {
    ...
    v14 = [[CCToolKitToolSystemToolProtocolAssistantSchema alloc] initWithIdentifier:v11 error:error];
    v10 = v11;
LABEL_10:
...
- (id)jsonDictionary
{
  ...
  if (self->_identifier)
  {
    identifier = [(CCToolKitToolSystemToolProtocolAssistantSchema *)self identifier];
