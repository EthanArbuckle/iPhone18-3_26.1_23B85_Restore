...
- (CCToolKitToolToolDefinitionVersion1ParameterRelationship)initWithJSONDictionary:(id)a3 error:(id *)a4;
- (CCToolKitToolToolDefinitionVersion1ParameterRelationship)initWithKey:(id)a3 relation:(id)a4 error:(id *)a5;
...
- (CCToolKitToolToolDefinitionVersion1ParameterRelationship)initWithJSONDictionary:(id)a3 error:(id *)a4
{
  ...
  if (IsInstanceOfExpectedClass)
  {
    ...
    v10 = [v6 objectForKeyedSubscript:@"relation"];
    if (v10)
    {
      v11 = v10;
      v17[0] = 0;
    ...
    v15 = [[CCToolKitToolToolDefinitionVersion1ParameterRelationship alloc] initWithKey:v9 relation:v12 error:a4];
    v11 = v12;
LABEL_10:
...
- (id)jsonDictionary
{
  ...
  if (self->_relation)
  {
    v5 = [(CCToolKitToolToolDefinitionVersion1ParameterRelationship *)self relation];
    v6 = [v5 jsonDictionary];
    [v3 setObject:v6 forKeyedSubscript:@"relation"];
  }
