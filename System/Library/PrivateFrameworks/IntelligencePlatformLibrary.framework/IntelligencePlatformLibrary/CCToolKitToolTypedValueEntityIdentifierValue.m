@interface CCToolKitToolTypedValueEntityIdentifierValue
- (BOOL)initializeFieldValuesFromData:(id)a3 error:(id *)a4;
- (CCToolKitToolDisplayRepresentation)displayRepresentation;
- (CCToolKitToolTypeIdentifier)type;
- (CCToolKitToolTypedValueEntityIdentifierValue)initWithJSONDictionary:(id)a3 error:(id *)a4;
- (CCToolKitToolTypedValueEntityIdentifierValue)initWithType:(id)a3 identifier:(id)a4 displayRepresentation:(id)a5 error:(id *)a6;
- (NSString)identifier;
- (id)jsonDictionary;
- (void)enumerateFieldsUsingBlock:(id)a3 parentFieldType:(unsigned __int16)a4;
@end

@implementation CCToolKitToolTypedValueEntityIdentifierValue
...
LABEL_13:
      v17 = [[CCToolKitToolTypedValueEntityIdentifierValue alloc] initWithType:v9 identifier:v12 displayRepresentation:v14 error:a4];
      v10 = v14;
LABEL_16:
...
- (id)jsonDictionary
{
  ...
  if (self->_type)
  {
    v4 = [(CCToolKitToolTypedValueEntityIdentifierValue *)self type];
  ...
  if (self->_identifier)
  {
    v6 = [(CCToolKitToolTypedValueEntityIdentifierValue *)self identifier];
    [v3 setObject:v6 forKeyedSubscript:@"identifier"];
  }

  if (self->_displayRepresentation)
  {
    v7 = [(CCToolKitToolTypedValueEntityIdentifierValue *)self displayRepresentation];
      ...
      if ((v21 >> 3) != 3)
      {
        ...
        else
        {
          if (v23 == 1)
          {
            ...
            v40 = 0;
            v26 = [(CCItemMessage *)v24 initWithData:identifier error:&v40];
            v10 = v40;
            v27 = 16;
LABEL_27:
...
LABEL_29:
          ...
          v31 = objc_opt_class();
          identifier = NSStringFromClass(v31);
          v32 = *&v6[*v9];
...
LABEL_28:
      ...
      identifier = CCPBReaderReadDataNoCopy();
      v39 = 0;
      v26 = [(CCItemMessage *)v29 initWithData:identifier error:&v39];
      v10 = v39;
      v27 = 32;
      goto LABEL_27;
    }
