...
- (CCToolKitToolTypedValueQueryValue)initWithJSONDictionary:(id)a3 error:(id *)a4;
- (CCToolKitToolTypedValueQueryValue)initWithType:(id)a3 query:(id)a4 error:(id *)a5;
- (id)jsonDictionary;
...
LABEL_13:
      v17 = [[CCToolKitToolTypedValueQueryValue alloc] initWithType:v9 query:v14 error:a4];
      v12 = v14;
LABEL_16:
...
- (id)jsonDictionary
{
  ...
  if (self->_type)
  {
    v4 = [(CCToolKitToolTypedValueQueryValue *)self type];
  ...
  if (self->_query)
  {
    v6 = [(CCToolKitToolTypedValueQueryValue *)self query];
    v7 = [v6 jsonDictionary];
    [v3 setObject:v7 forKeyedSubscript:@"query"];
  }
