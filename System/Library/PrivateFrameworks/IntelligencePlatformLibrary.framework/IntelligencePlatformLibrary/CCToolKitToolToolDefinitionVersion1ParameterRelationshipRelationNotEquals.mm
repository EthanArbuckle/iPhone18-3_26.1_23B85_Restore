...
- (CCToolKitToolToolDefinitionVersion1ParameterRelationshipRelationNotEquals)initWithJSONDictionary:(id)dictionary error:(id *)error;
- (CCToolKitToolToolDefinitionVersion1ParameterRelationshipRelationNotEquals)initWithValues:(id)values error:(id *)error;
- (NSArray)values;
- (id)jsonDictionary;
...
- (CCToolKitToolToolDefinitionVersion1ParameterRelationshipRelationNotEquals)initWithJSONDictionary:(id)dictionary error:(id *)error
{
  ...
  if (IsInstanceOfExpectedClass)
  {
    ...
    v24 = [[CCToolKitToolToolDefinitionVersion1ParameterRelationshipRelationNotEquals alloc] initWithValues:v13 error:error];
    v10 = v13;
LABEL_21:
...
- (id)jsonDictionary
{
  ...
  if (self->_values)
  {
    ...
    v16 = 0u;
    v17 = 0u;
    values = [(CCToolKitToolToolDefinitionVersion1ParameterRelationshipRelationNotEquals *)self values];
