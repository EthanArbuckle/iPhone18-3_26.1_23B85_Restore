...
- (CCHomeServiceGroup)initWithJSONDictionary:(id)dictionary error:(id *)error;
...
- (CCHomeServiceGroup)initWithJSONDictionary:(id)dictionary error:(id *)error
{
  ...
  if (IsInstanceOfExpectedClass)
  {
    ...
    v10 = [[CCHomeServiceGroup alloc] initWithName:v9 error:error];
  }
...
- (id)jsonDictionary
{
  ...
  if (self->_name)
  {
    name = [(CCHomeServiceGroup *)self name];
...
- (void)enumerateFieldsUsingBlock:(id)block parentFieldType:(unsigned __int16)type
{
  if (self->_name)
  {
    ...
    blockCopy = block;
    v8 = [[v6 alloc] initWithFieldType:7708 stringValue:self->_name];
