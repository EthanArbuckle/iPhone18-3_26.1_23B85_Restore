@interface CCToolKitToolToolDefinitionVersion1ParameterRelationshipRelationEquals
- (BOOL)initializeFieldValuesFromData:(id)a3 error:(id *)a4;
- (CCToolKitToolToolDefinitionVersion1ParameterRelationshipRelationEquals)initWithJSONDictionary:(id)a3 error:(id *)a4;
- (CCToolKitToolToolDefinitionVersion1ParameterRelationshipRelationEquals)initWithValues:(id)a3 error:(id *)a4;
- (NSArray)values;
- (id)jsonDictionary;
- (void)enumerateFieldsUsingBlock:(id)a3 parentFieldType:(unsigned __int16)a4;
@end

@implementation CCToolKitToolToolDefinitionVersion1ParameterRelationshipRelationEquals
...
- (CCToolKitToolToolDefinitionVersion1ParameterRelationshipRelationEquals)initWithJSONDictionary:(id)a3 error:(id *)a4
{
  ...
  if (IsInstanceOfExpectedClass)
  {
    ...
    v24 = [[CCToolKitToolToolDefinitionVersion1ParameterRelationshipRelationEquals alloc] initWithValues:v13 error:a4];
    v10 = v13;
LABEL_21:
...
- (id)jsonDictionary
{
  ...
  if (self->_values)
  {
    ...
    v16 = 0u;
    v17 = 0u;
    v5 = [(CCToolKitToolToolDefinitionVersion1ParameterRelationshipRelationEquals *)self values];
