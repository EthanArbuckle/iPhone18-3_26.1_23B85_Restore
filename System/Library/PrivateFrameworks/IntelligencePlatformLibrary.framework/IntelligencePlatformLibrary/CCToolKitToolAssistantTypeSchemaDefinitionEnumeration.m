@interface CCToolKitToolAssistantTypeSchemaDefinitionEnumeration
- (BOOL)initializeFieldValuesFromData:(id)a3 error:(id *)a4;
- (CCToolKitToolAssistantSchemaIdentifier)identifier;
- (CCToolKitToolAssistantTypeSchemaDefinitionEnumeration)initWithIdentifier:(id)a3 cases:(id)a4 displayRepresentation:(id)a5 error:(id *)a6;
- (CCToolKitToolAssistantTypeSchemaDefinitionEnumeration)initWithJSONDictionary:(id)a3 error:(id *)a4;
...
@implementation CCToolKitToolAssistantTypeSchemaDefinitionEnumeration
...
LABEL_33:
      ...
      if (v18)
      {
        ...
        do
        {
          for (i = 0; i != v19; ++i)
          {
            ...
            v39 = 0;
            v24 = [(CCToolKitToolTypeDefinitionVersion1EnumerationCase *)v23 initWithJSONDictionary:v22 error:&v39];
            v25 = v39;
            if (v24)
            {
              v26 = v25 == 0;
    ...
    v33 = [[CCToolKitToolAssistantTypeSchemaDefinitionEnumeration alloc] initWithIdentifier:v9 cases:v12 displayRepresentation:v29 error:a4];
    v28 = v29;
LABEL_32:
...
- (id)jsonDictionary
{
  ...
  if (self->_identifier)
  {
    v4 = [(CCToolKitToolAssistantTypeSchemaDefinitionEnumeration *)self identifier];
  ...
  if (self->_cases)
  {
    ...
    v20 = 0u;
    v21 = 0u;
    v7 = [(CCToolKitToolAssistantTypeSchemaDefinitionEnumeration *)self cases];
  ...
  {
    v13 = [(CCToolKitToolAssistantTypeSchemaDefinitionEnumeration *)self displayRepresentation];
...
LABEL_21:
      ...
      else
      {
        if (v23 == 2)
        {
          ...
          v28 = [CCToolKitToolTypeDefinitionVersion1EnumerationCase alloc];
          v46 = 0;
