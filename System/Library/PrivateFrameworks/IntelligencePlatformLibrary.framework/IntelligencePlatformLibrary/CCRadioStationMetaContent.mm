...
- (CCRadioStationMetaContent)initWithJSONDictionary:(id)dictionary error:(id *)error;
- (CCRadioStationMetaContent)initWithSourceItemIdentifier:(id)identifier error:(id *)error;
...
- (CCRadioStationMetaContent)initWithJSONDictionary:(id)dictionary error:(id *)error
{
  ...
  if (IsInstanceOfExpectedClass)
  {
    ...
    v10 = [[CCRadioStationMetaContent alloc] initWithSourceItemIdentifier:v9 error:error];
  }
...
- (id)jsonDictionary
{
  ...
  {
    sourceItemIdentifier = [(CCRadioStationMetaContent *)self sourceItemIdentifier];
...
- (void)enumerateFieldsUsingBlock:(id)block parentFieldType:(unsigned __int16)type
{
  if (self->_sourceItemIdentifier)
  {
    ...
    blockCopy = block;
    v8 = [[v6 alloc] initWithFieldType:49074 stringValue:self->_sourceItemIdentifier];
...
+ (id)descriptionForTypeIdentifier:(unsigned __int16)identifier
{
  if (identifier == 49074)
  {
    return @"RadioStationMetaContent_sourceItemIdentifier";
  }
