...
- (CCToolKitToolComparisonPredicateComparisonTemplate)initWithJSONDictionary:(id)dictionary error:(id *)error;
...
- (CCToolKitToolComparisonPredicateComparisonTemplate)initWithJSONDictionary:(id)dictionary error:(id *)error
{
  ...
  {
    v9 = [dictionaryCopy objectForKeyedSubscript:@"equalTo"];
    v10 = 0x1E73E5000uLL;
    if (v9)
    {
      v141[0] = 0;
...
LABEL_124:
    ...
    v13 = [dictionaryCopy objectForKeyedSubscript:@"notEqualTo"];
    if (v13)
    {
...
LABEL_76:
        ...
        v26 = [[CCToolKitToolComparisonPredicateComparisonTemplate alloc] initWithKind:v118 kindType:v94 error:error];
...
- (id)jsonDictionary
{
  ...
  if (kindType == 1)
  {
    ...
    equalTo = [(CCToolKitToolComparisonPredicateComparisonTemplate *)self equalTo];
    jsonDictionary = [equalTo jsonDictionary];
    [v3 setObject:jsonDictionary forKeyedSubscript:@"equalTo"];
  ...
  if (kindType == 2)
  {
    ...
    notEqualTo = [(CCToolKitToolComparisonPredicateComparisonTemplate *)self notEqualTo];
    jsonDictionary2 = [notEqualTo jsonDictionary];
    [v3 setObject:jsonDictionary2 forKeyedSubscript:@"notEqualTo"];
  ...
  if (kindType == 5)
  {
    ...
    greaterThan = [(CCToolKitToolComparisonPredicateComparisonTemplate *)self greaterThan];
  ...
  if (kindType == 6)
  {
    ...
    greaterThanOrEqualTo = [(CCToolKitToolComparisonPredicateComparisonTemplate *)self greaterThanOrEqualTo];
  ...
  if (kindType == 7)
  {
    ...
    lessThan = [(CCToolKitToolComparisonPredicateComparisonTemplate *)self lessThan];
  ...
  if (kindType == 8)
  {
    ...
    lessThanOrEqualTo = [(CCToolKitToolComparisonPredicateComparisonTemplate *)self lessThanOrEqualTo];
  ...
  if (kindType == 9)
  {
    ...
    contains = [(CCToolKitToolComparisonPredicateComparisonTemplate *)self contains];
  ...
  if (kindType == 10)
  {
    ...
    notContains = [(CCToolKitToolComparisonPredicateComparisonTemplate *)self notContains];
  ...
  if (kindType == 11)
  {
    ...
    beginsWith = [(CCToolKitToolComparisonPredicateComparisonTemplate *)self beginsWith];
  ...
  if (kindType == 12)
  {
    ...
    endsWith = [(CCToolKitToolComparisonPredicateComparisonTemplate *)self endsWith];
  ...
  if (kindType == 13)
  {
    ...
    inTheNext = [(CCToolKitToolComparisonPredicateComparisonTemplate *)self inTheNext];
  ...
  if (kindType == 14)
  {
    ...
    inTheLast = [(CCToolKitToolComparisonPredicateComparisonTemplate *)self inTheLast];
  ...
  {
    isBetween = [(CCToolKitToolComparisonPredicateComparisonTemplate *)self isBetween];
