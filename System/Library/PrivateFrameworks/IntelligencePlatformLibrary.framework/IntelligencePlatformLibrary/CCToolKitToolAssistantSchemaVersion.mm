...
- (id)jsonDictionary
{
  ...
  if (self->_hasMajor)
  {
    v4 = [MEMORY[0x1E696AD98] numberWithUnsignedLongLong:{-[CCToolKitToolAssistantSchemaVersion major](self, "major")}];
    [v3 setObject:v4 forKeyedSubscript:@"major"];
  }

  if (self->_hasMinor)
  {
    v5 = [MEMORY[0x1E696AD98] numberWithUnsignedLongLong:{-[CCToolKitToolAssistantSchemaVersion minor](self, "minor")}];
    [v3 setObject:v5 forKeyedSubscript:@"minor"];
  }

  if (self->_hasPatch)
  {
    v6 = [MEMORY[0x1E696AD98] numberWithUnsignedLongLong:{-[CCToolKitToolAssistantSchemaVersion patch](self, "patch")}];
