...
- (CCToolKitToolAppDefinitionDevice)initWithJSONDictionary:(id)a3 error:(id *)a4;
- (CCToolKitToolAppDefinitionDevice)initWithKind:(id)a3 kindType:(unsigned int)a4 error:(id *)a5;
- (NSString)remote;
- (id)jsonDictionary;
...
- (CCToolKitToolAppDefinitionDevice)initWithJSONDictionary:(id)a3 error:(id *)a4
{
  ...
  if (IsInstanceOfExpectedClass)
  {
    ...
    v13 = [[CCToolKitToolAppDefinitionDevice alloc] initWithKind:v14 kindType:v12 error:a4];
  }
...
- (id)jsonDictionary
{
  ...
  {
    v6 = [(CCToolKitToolAppDefinitionDevice *)self remote];
