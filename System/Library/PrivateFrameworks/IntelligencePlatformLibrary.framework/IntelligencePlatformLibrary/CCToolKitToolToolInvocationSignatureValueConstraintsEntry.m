...
- (CCToolKitToolToolInvocationSignatureValueConstraintsEntry)initWithJSONDictionary:(id)a3 error:(id *)a4;
- (CCToolKitToolToolInvocationSignatureValueConstraintsEntry)initWithKey:(id)a3 value:(id)a4 error:(id *)a5;
- (NSString)key;
- (id)jsonDictionary;
...
- (CCToolKitToolToolInvocationSignatureValueConstraintsEntry)initWithJSONDictionary:(id)a3 error:(id *)a4
{
  ...
  if (IsInstanceOfExpectedClass)
  {
    ...
    v15 = [[CCToolKitToolToolInvocationSignatureValueConstraintsEntry alloc] initWithKey:v9 value:v12 error:a4];
    v11 = v12;
LABEL_10:
...
- (id)jsonDictionary
{
  ...
  if (self->_value)
  {
    v5 = [(CCToolKitToolToolInvocationSignatureValueConstraintsEntry *)self value];
