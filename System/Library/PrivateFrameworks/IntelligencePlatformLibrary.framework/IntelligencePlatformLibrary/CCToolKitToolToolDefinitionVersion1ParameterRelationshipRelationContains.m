...
- (CCToolKitToolToolDefinitionVersion1ParameterRelationshipRelationContains)initWithJSONDictionary:(id)a3 error:(id *)a4;
- (CCToolKitToolToolDefinitionVersion1ParameterRelationshipRelationContains)initWithValues:(id)a3 error:(id *)a4;
- (NSArray)values;
- (id)jsonDictionary;
...
- (CCToolKitToolToolDefinitionVersion1ParameterRelationshipRelationContains)initWithJSONDictionary:(id)a3 error:(id *)a4
{
  ...
  if (IsInstanceOfExpectedClass)
  {
    ...
    v24 = [[CCToolKitToolToolDefinitionVersion1ParameterRelationshipRelationContains alloc] initWithValues:v13 error:a4];
    v10 = v13;
LABEL_21:
...
- (id)jsonDictionary
{
  ...
  if (self->_values)
  {
    ...
    v16 = 0u;
    v17 = 0u;
    v5 = [(CCToolKitToolToolDefinitionVersion1ParameterRelationshipRelationContains *)self values];
