...
- (CCToolKitToolTypeInstanceRestricted)initWithIdentifier:(id)a3 context:(id)a4 error:(id *)a5;
- (CCToolKitToolTypeInstanceRestricted)initWithJSONDictionary:(id)a3 error:(id *)a4;
- (NSArray)context;
- (id)jsonDictionary;
...
- (CCToolKitToolTypeInstanceRestricted)initWithJSONDictionary:(id)a3 error:(id *)a4
{
  ...
  if (IsInstanceOfExpectedClass)
  {
    ...
    v27 = [[CCToolKitToolTypeInstanceRestricted alloc] initWithIdentifier:v9 context:v16 error:a4];
    v12 = v16;
LABEL_26:
...
- (id)jsonDictionary
{
  ...
  if (self->_identifier)
  {
    v4 = [(CCToolKitToolTypeInstanceRestricted *)self identifier];
  ...
  if (self->_context)
  {
    ...
    v18 = 0u;
    v19 = 0u;
    v7 = [(CCToolKitToolTypeInstanceRestricted *)self context];
