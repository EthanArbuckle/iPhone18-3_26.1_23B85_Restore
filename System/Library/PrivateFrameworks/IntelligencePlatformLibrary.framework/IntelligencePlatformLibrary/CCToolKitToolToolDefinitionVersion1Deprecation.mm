...
- (CCToolKitToolToolDefinitionVersion1Deprecation)initWithDeprecationMessage:(id)a3 replacedByToolId:(id)a4 error:(id *)a5;
- (CCToolKitToolToolDefinitionVersion1Deprecation)initWithJSONDictionary:(id)a3 error:(id *)a4;
...
- (CCToolKitToolToolDefinitionVersion1Deprecation)initWithJSONDictionary:(id)a3 error:(id *)a4
{
  ...
  {
    v9 = [v6 objectForKeyedSubscript:@"deprecationMessage"];
    v10 = [v6 objectForKeyedSubscript:@"replacedByToolId"];
    v11 = [[CCToolKitToolToolDefinitionVersion1Deprecation alloc] initWithDeprecationMessage:v9 replacedByToolId:v10 error:a4];
  }
...
- (id)jsonDictionary
{
  ...
  {
    v4 = [(CCToolKitToolToolDefinitionVersion1Deprecation *)self deprecationMessage];
    [v3 setObject:v4 forKeyedSubscript:@"deprecationMessage"];
  }

  if (self->_replacedByToolId)
  {
    v5 = [(CCToolKitToolToolDefinitionVersion1Deprecation *)self replacedByToolId];
    [v3 setObject:v5 forKeyedSubscript:@"replacedByToolId"];
  }
