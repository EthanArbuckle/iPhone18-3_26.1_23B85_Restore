...
- (CCToolKitToolDisplayRepresentationDisplayValueStatic)initWithJSONDictionary:(id)a3 error:(id *)a4;
- (CCToolKitToolDisplayRepresentationDisplayValueStatic)initWithValue:(id)a3 error:(id *)a4;
- (id)jsonDictionary;
...
- (CCToolKitToolDisplayRepresentationDisplayValueStatic)initWithJSONDictionary:(id)a3 error:(id *)a4
{
  ...
  if (IsInstanceOfExpectedClass)
  {
    ...
    v14 = [[CCToolKitToolDisplayRepresentationDisplayValueStatic alloc] initWithValue:v11 error:a4];
    v10 = v11;
LABEL_10:
...
- (id)jsonDictionary
{
  ...
  if (self->_value)
  {
    v4 = [(CCToolKitToolDisplayRepresentationDisplayValueStatic *)self value];
