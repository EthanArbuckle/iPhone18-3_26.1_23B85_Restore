...
- (CCToolKitToolToolSummaryString)initWithComponents:(id)a3 error:(id *)a4;
- (CCToolKitToolToolSummaryString)initWithJSONDictionary:(id)a3 error:(id *)a4;
- (NSArray)components;
- (id)jsonDictionary;
...
- (CCToolKitToolToolSummaryString)initWithJSONDictionary:(id)a3 error:(id *)a4
{
  ...
  if (IsInstanceOfExpectedClass)
  {
      ...
      if (v14)
      {
        ...
        do
        {
          for (i = 0; i != v15; ++i)
          {
            ...
            v28 = 0;
            v20 = [(CCToolKitToolToolSummaryStringComponent *)v19 initWithJSONDictionary:v18 error:&v28];
            v21 = v28;
            if (v20)
            {
              v22 = v21 == 0;
    ...
    v24 = [[CCToolKitToolToolSummaryString alloc] initWithComponents:v13 error:a4];
    v10 = v13;
LABEL_21:
...
- (id)jsonDictionary
{
  ...
  if (self->_components)
  {
    ...
    v16 = 0u;
    v17 = 0u;
    v5 = [(CCToolKitToolToolSummaryString *)self components];
