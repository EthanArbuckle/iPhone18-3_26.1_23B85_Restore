...
- (CCToolKitToolTypeDefinitionVersion1Query)initWithIdentifier:(id)a3 templates:(id)a4 error:(id *)a5;
- (CCToolKitToolTypeDefinitionVersion1Query)initWithJSONDictionary:(id)a3 error:(id *)a4;
...
- (CCToolKitToolTypeDefinitionVersion1Query)initWithJSONDictionary:(id)a3 error:(id *)a4
{
  ...
  if (IsInstanceOfExpectedClass)
  {
    ...
    v13 = [v6 objectForKeyedSubscript:@"templates"];
    if (!v13)
    {
      v14 = 0;
      goto LABEL_13;
...
LABEL_13:
      v17 = [[CCToolKitToolTypeDefinitionVersion1Query alloc] initWithIdentifier:v9 templates:v14 error:a4];
      v12 = v14;
LABEL_16:
...
- (id)jsonDictionary
{
  ...
  if (self->_identifier)
  {
    v4 = [(CCToolKitToolTypeDefinitionVersion1Query *)self identifier];
  ...
  if (self->_templates)
  {
    v6 = [(CCToolKitToolTypeDefinitionVersion1Query *)self templates];
    v7 = [v6 jsonDictionary];
    [v3 setObject:v7 forKeyedSubscript:@"templates"];
  }
