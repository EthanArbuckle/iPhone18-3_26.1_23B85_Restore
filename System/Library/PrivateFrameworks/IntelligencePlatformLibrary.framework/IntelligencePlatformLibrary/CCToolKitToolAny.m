...
- (CCToolKitToolAny)initWithJSONDictionary:(id)a3 error:(id *)a4;
- (CCToolKitToolAny)initWithTypeUrl:(id)a3 value:(id)a4 error:(id *)a5;
- (NSData)value;
- (NSString)typeUrl;
- (id)jsonDictionary;
...
- (CCToolKitToolAny)initWithJSONDictionary:(id)a3 error:(id *)a4
{
  ...
  {
    v9 = [v6 objectForKeyedSubscript:@"typeUrl"];
    ...
    v14 = [[CCToolKitToolAny alloc] initWithTypeUrl:v9 value:v10 error:a4];
LABEL_9:
...
- (id)jsonDictionary
{
  ...
  if (self->_typeUrl)
  {
    v4 = [(CCToolKitToolAny *)self typeUrl];
    [v3 setObject:v4 forKeyedSubscript:@"typeUrl"];
  }

  if (self->_value)
  {
    v5 = [(CCToolKitToolAny *)self value];
