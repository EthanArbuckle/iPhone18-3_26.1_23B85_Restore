...
- (CCHome)initWithJSONDictionary:(id)dictionary error:(id *)error;
- (CCHome)initWithName:(id)name error:(id *)error;
- (NSString)name;
- (id)jsonDictionary;
...
- (CCHome)initWithJSONDictionary:(id)dictionary error:(id *)error
{
  ...
  if (IsInstanceOfExpectedClass)
  {
    ...
    v10 = [[CCHome alloc] initWithName:v9 error:error];
  }
...
- (void)enumerateFieldsUsingBlock:(id)block parentFieldType:(unsigned __int16)type
{
  if (self->_name)
  {
    ...
    blockCopy = block;
    v8 = [[v6 alloc] initWithFieldType:7701 stringValue:self->_name];
