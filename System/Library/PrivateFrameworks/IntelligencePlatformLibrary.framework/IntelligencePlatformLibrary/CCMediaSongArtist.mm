...
- (CCMediaSongArtist)initWithJSONDictionary:(id)dictionary error:(id *)error;
- (CCMediaSongArtist)initWithName:(id)name error:(id *)error;
- (NSString)name;
- (id)jsonDictionary;
...
- (CCMediaSongArtist)initWithJSONDictionary:(id)dictionary error:(id *)error
{
  ...
  if (IsInstanceOfExpectedClass)
  {
    ...
    v10 = [[CCMediaSongArtist alloc] initWithName:v9 error:error];
  }
...
- (id)jsonDictionary
{
  ...
  if (self->_name)
  {
    name = [(CCMediaSongArtist *)self name];
