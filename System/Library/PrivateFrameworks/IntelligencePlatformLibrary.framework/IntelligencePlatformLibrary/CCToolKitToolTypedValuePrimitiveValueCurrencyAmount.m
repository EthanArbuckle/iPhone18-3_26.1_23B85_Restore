...
- (CCToolKitToolTypedValuePrimitiveValueCurrencyAmount)initWithAmount:(id)a3 currencyIdentifier:(id)a4 displayRepresentation:(id)a5 error:(id *)a6;
- (CCToolKitToolTypedValuePrimitiveValueCurrencyAmount)initWithJSONDictionary:(id)a3 error:(id *)a4;
...
- (CCToolKitToolTypedValuePrimitiveValueCurrencyAmount)initWithJSONDictionary:(id)a3 error:(id *)a4
{
  ...
  if (IsInstanceOfExpectedClass)
  {
    ...
    v12 = [v6 objectForKeyedSubscript:@"currencyIdentifier"];
...
LABEL_13:
      v17 = [[CCToolKitToolTypedValuePrimitiveValueCurrencyAmount alloc] initWithAmount:v9 currencyIdentifier:v12 displayRepresentation:v14 error:a4];
      v10 = v14;
LABEL_16:
...
- (id)jsonDictionary
{
  ...
  if (self->_amount)
  {
    v4 = [(CCToolKitToolTypedValuePrimitiveValueCurrencyAmount *)self amount];
  ...
  {
    v6 = [(CCToolKitToolTypedValuePrimitiveValueCurrencyAmount *)self currencyIdentifier];
    [v3 setObject:v6 forKeyedSubscript:@"currencyIdentifier"];
  }

  if (self->_displayRepresentation)
  {
    v7 = [(CCToolKitToolTypedValuePrimitiveValueCurrencyAmount *)self displayRepresentation];
