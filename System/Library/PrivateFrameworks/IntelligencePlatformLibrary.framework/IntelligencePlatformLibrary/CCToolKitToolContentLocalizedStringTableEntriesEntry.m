...
- (CCToolKitToolContentLocalizedStringTableEntriesEntry)initWithJSONDictionary:(id)a3 error:(id *)a4;
- (CCToolKitToolContentLocalizedStringTableEntriesEntry)initWithKey:(id)a3 value:(id)a4 error:(id *)a5;
- (NSString)key;
- (NSString)value;
- (id)jsonDictionary;
...
- (CCToolKitToolContentLocalizedStringTableEntriesEntry)initWithJSONDictionary:(id)a3 error:(id *)a4
{
  ...
  if (IsInstanceOfExpectedClass)
  {
    ...
    v11 = [[CCToolKitToolContentLocalizedStringTableEntriesEntry alloc] initWithKey:v9 value:v10 error:a4];
  }
...
- (id)jsonDictionary
{
  ...
  if (self->_value)
  {
    v5 = [(CCToolKitToolContentLocalizedStringTableEntriesEntry *)self value];
