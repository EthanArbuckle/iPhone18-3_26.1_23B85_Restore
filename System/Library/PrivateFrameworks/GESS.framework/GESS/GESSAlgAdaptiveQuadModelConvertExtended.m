...
- (BOOL)run:(id)a3 output:(id)a4
{
  ...
  if (objc_msgSend_valid(v6, v10, v11, v12) && objc_msgSend_meshType(v6, v13, v14, v15) == 1 && objc_msgSend_meshType(v7, v13, v16, v15) == 11)
  {
    ...
    v25 = objc_msgSend_meshImpl(v7, v22, v23, v24);
    if (!v75->_options)
    {
    ...
    sub_24BD29B54(v90);
    LODWORD(v90[0]) = objc_msgSend_outputFaceNumber(v75->_options, v28, v29, v30);
    BYTE4(v90[0]) = objc_msgSend_enableSimplify(v75->_options, v31, v32, v33);
    v93[0] = objc_msgSend_textureResolution(v75->_options, v34, v35, v36);
    v40 = objc_msgSend_textureTransferOptions(v75->_options, v37, v38, v39);
    v44 = objc_msgSend_inputTangentialSpaceType(v40, v41, v42, v43);
    v91 = sub_24BE74A64(v44);

    v48 = objc_msgSend_textureTransferOptions(v75->_options, v45, v46, v47);
    v52 = objc_msgSend_outputTangentialSpaceType(v48, v49, v50, v51);
    v92 = sub_24BE74A64(v52);

    if (objc_msgSend_materialImpl(v6, v53, v54, v55))
    {
      v78 = 0;
      v80 = 0;
      v82 = 0;
      ...
      sub_24BD2A57C(&v100);
      v64 = objc_msgSend_materialImpl(v6, v61, v62, v63);
      if (!objc_msgSend_materialImpl(v7, v65, v66, v67))
      {
        operator new();
      }

      v71 = objc_msgSend_materialImpl(v7, v68, v69, v70);
    ...
    if (v72)
    {
      objc_msgSend_setAlgStatus_(v75, v73, 3, v74);
      v57 = 1;
    }

    else
    {
      objc_msgSend_setAlgStatus_(v75, v73, 2, v74);
      v57 = 0;
    }
  ...
  {
    objc_msgSend_setAlgStatus_(v75, v13, 2, v15);
    v57 = 0;
  }
