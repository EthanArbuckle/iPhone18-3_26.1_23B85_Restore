...
- (HKHRCardioFitnessOnboardingStatus)initWithCoder:(id)coder;
- (HKHRCardioFitnessOnboardingStatus)initWithState:(int64_t)state unavailableReasons:(int64_t)reasons dateOnboarded:(id)onboarded shouldOnboardingTileBeAdvertised:(BOOL)advertised isLocaleValidOnLocalDevice:(BOOL)device isClassificationAvailable:(BOOL)available;
- (unint64_t)hash;
