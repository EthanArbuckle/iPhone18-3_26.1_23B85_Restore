...
+ (id)standardFooter;
- (HKHRIrregularRhythmNotificationsBridgeFooter)initWithText:(id)text linkText:(id)linkText linkURL:(id)l;
@end
...
+ (id)footerWhenSeedHasExpired
{
  ...
  v7 = [[self alloc] initWithText:v5 linkText:v4 linkURL:v6];
...
+ (id)standardFooter
{
  ...
  v6 = [[self alloc] initWithText:v3 linkText:v4 linkURL:v5];
