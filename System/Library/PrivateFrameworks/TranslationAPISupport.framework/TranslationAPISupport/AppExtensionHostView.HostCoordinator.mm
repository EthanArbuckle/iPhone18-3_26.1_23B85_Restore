...
- (void)hostViewControllerWillDeactivate:(id)a3 error:(id)a4
{
  ...
  v8 = a4;
  [v6 invalidate];
  v9 = *(&v7->super.isa + OBJC_IVAR____TtCV21TranslationAPISupport20AppExtensionHostView15HostCoordinator_remoteConnectionDidChange);
  if (v9)
  {
    v10 = *&v7->_anon_0[OBJC_IVAR____TtCV21TranslationAPISupport20AppExtensionHostView15HostCoordinator_remoteConnectionDidChange];
