...
+ (id)constraintsByCenteringView:()MPUAutolayout withView:alongAxes:offset:
{
  ...
  if (a7)
  {
    v14 = [MEMORY[0x277CCAAD0] constraintWithItem:v11 attribute:9 relatedBy:0 toItem:v12 attribute:9 multiplier:1.0 constant:a1];
    [v13 addObject:v14];
  }
...
+ (id)constraintsByAttachingView:()MPUAutolayout toView:alongEdges:insets:
{
  ...
  if (a9)
  {
    v20 = [MEMORY[0x277CCAAD0] constraintWithItem:v15 attribute:3 relatedBy:0 toItem:v16 attribute:3 multiplier:1.0 constant:a1];
    [v17 addObject:v20];
...
+ (id)constraintsByCenteringAndContainingView:()MPUAutolayout inView:insets:
{
  ...
  [v16 addObject:v17];
  v18 = [MEMORY[0x277CCAAD0] constraintWithItem:v15 attribute:10 relatedBy:0 toItem:v14 attribute:10 multiplier:1.0 constant:(a1 - a3) * 0.5];
  [v16 addObject:v18];
  v19 = -(a2 + a4);
...
LABEL_13:
  ...
  v13 = a6;
  v14 = a5;
  v15 = [v12 constraintWithItem:v14 attribute:9 relatedBy:0 toItem:v13 attribute:v10 multiplier:1.0 constant:v8];
...
+ (id)constraintsBySizingView:()MPUAutolayout toSize:
{
  ...
  if (a1 != -1.0)
  {
    v9 = [MEMORY[0x277CCAAD0] constraintWithItem:v7 attribute:7 relatedBy:0 toItem:0 attribute:0 multiplier:1.0 constant:a1];
    [v8 addObject:v9];
  }
