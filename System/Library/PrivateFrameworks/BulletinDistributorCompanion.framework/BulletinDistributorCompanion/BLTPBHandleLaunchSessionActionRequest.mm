...
- (id)description
{
  ...
  v8.receiver = self;
  v8.super_class = BLTPBHandleLaunchSessionActionRequest;
  v4 = [(BLTPBHandleLaunchSessionActionRequest *)&v8 description];
  dictionaryRepresentation = [(BLTPBHandleLaunchSessionActionRequest *)self dictionaryRepresentation];
...
- (void)mergeFrom:(id)from
{
  ...
  if (fromCopy[2])
  {
    [(BLTPBHandleLaunchSessionActionRequest *)self setPublisherBulletinID:?];
  }

  if (fromCopy[3])
  {
    [(BLTPBHandleLaunchSessionActionRequest *)self setRecordID:?];
  }

  if (fromCopy[4])
  {
    [(BLTPBHandleLaunchSessionActionRequest *)self setSectionID:?];
  }
  ...
  {
    [(BLTPBHandleLaunchSessionActionRequest *)self setActionInfo:?];
  }
}
