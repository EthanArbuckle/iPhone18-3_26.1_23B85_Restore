...
{
  v4 = a3;
  if ([v4 isMemberOfClass:objc_opt_class()] && ((publisherBulletinID = self->_publisherBulletinID, !(publisherBulletinID | v4[1])) || -[NSString isEqual:](publisherBulletinID, "isEqual:")))
  {
    recordID = self->_recordID;
    if (recordID | v4[2])
    {
