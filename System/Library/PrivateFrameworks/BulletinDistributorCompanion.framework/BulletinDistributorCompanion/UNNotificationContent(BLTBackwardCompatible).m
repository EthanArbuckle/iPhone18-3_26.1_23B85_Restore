...
- (void)blt_encodeWithCoder:()BLTBackwardCompatible
{
  ...
  v5 = [a1 _blt_encodedShouldAddToNotificationsList];
  if (v5)
  {
    v6 = blt_ids_log();
    ...
    [v4 encodeBool:objc_msgSend(v5 forKey:{"BOOLValue"), @"shouldAddToNotificationsList"}];
  }
...
- (void)blt_preEncodeShouldAddToNotificationsList:()BLTBackwardCompatible
{
  ...
  [a1 _blt_setEncodedShouldAddToNotificationsList:v5];
}
