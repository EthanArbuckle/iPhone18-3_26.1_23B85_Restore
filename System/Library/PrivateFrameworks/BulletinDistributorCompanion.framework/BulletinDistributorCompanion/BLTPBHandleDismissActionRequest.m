...
- (id)description
{
  ...
  v8.receiver = self;
  v8.super_class = BLTPBHandleDismissActionRequest;
...
- (void)mergeFrom:(id)a3
{
  ...
  if (v6[2])
  {
    [(BLTPBHandleDismissActionRequest *)self setPublisherBulletinID:?];
  }

  if (v6[3])
  {
    [(BLTPBHandleDismissActionRequest *)self setRecordID:?];
  }

  if (v6[4])
  {
    [(BLTPBHandleDismissActionRequest *)self setSectionID:?];
  }
  ...
  {
    [(BLTPBHandleDismissActionRequest *)self setActionInfo:?];
  }
}
