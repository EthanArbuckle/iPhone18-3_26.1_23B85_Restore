...
- (id)_arrayByFilteringEmojiCandidates:()UIKBCandidateExtras
{
  ...
  v7[4] = v8;
  v7[5] = a3;
  v4 = [self indexesOfObjectsPassingTest:v7];
  v5 = [self objectsAtIndexes:v4];
...
{
  selfCopy = self;
  v2 = [self indexesOfObjectsPassingTest:&__block_literal_global_4099];
  v3 = [selfCopy objectsAtIndexes:v2];
