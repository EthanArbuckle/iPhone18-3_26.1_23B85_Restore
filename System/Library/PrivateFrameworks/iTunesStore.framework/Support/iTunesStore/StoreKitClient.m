...
- (StoreKitClient)initWithMicroPaymentClientID:(id)a3
{
  v4 = [(StoreKitClient *)self _initStoreKitClient];
  if (v4)
  {
    v4->_databaseClientObjectID = a3;
  }
...
- (void)sendPurchaseIntents:(id)a3 forApp:(id)a4
{
  ...
  v14 = [LSApplicationProxy applicationProxyForIdentifier:a4];
  if (([objc_msgSend(v14 "appState")] & 1) != 0 || (v14 = +[LSPlugInKitProxy pluginKitProxyForIdentifier:](LSPlugInKitProxy, "pluginKitProxyForIdentifier:", a4), v15 = objc_msgSend(objc_msgSend(v14, "containingBundle"), "bundleType"), objc_msgSend(v15, "isEqualToString:", LSUserApplicationType)))
  {
    v16 = [v14 profileValidated];
  }
...
- (void)_networkTypeChangedNotification:(id)a3
{
  if ([+[ISNetworkObserver networkType:a3]]&& [(StoreKitClient *)self clientState]== 3)
  {
...
- (id)_clientIdentifier
{
  v2 = [(StoreKitClient *)self _clientIdentity];
...
LABEL_19:
    ...
    else
    {
      ...
      {
        v13 = [objc_msgSend(+[SSAccountStore defaultStore](SSAccountStore "defaultStore")];
LABEL_21:
        if (v13)
        {
          [v4 addObject:v13];
...
- (id)_copyDownloadsForDownloadIDs:(id)a3 properties:(id)a4 context:(id)a5
{
  ...
  v9 = [a5 objectWithID:self->_databaseClientObjectID];
  v10 = [MicroPaymentDownload downloadEntityFromContext:a5];
  v21 = 0u;
  v22 = 0u;
  v23 = 0u;
  v24 = 0u;
  ...
  if (v11)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        v17 = [a5 executeFetchRequest:v16 error:0];
        if ([v17 count] == 1)
        {
...
- (void)_mergeBatchResponse:(id)a3 forRestoreOperation:(id)a4
{
  ...
  v4[4] = self;
  v4[5] = a3;
  [(StoreKitClient *)self _dispatchAsync:v4, a4];
}
...
- (void)_refreshFromServerWithReason:(int64_t)a3 accountIdentifier:(id)a4
{
  ...
  if (self->_state == 1)
  {
    if (!a3)
    {
      ...
      if (v9)
      {
        ...
        v36 = objc_opt_class();
        v37 = 2112;
        v38 = [(StoreKitClient *)self _clientIdentifier];
        LODWORD(v32) = 22;
        v31 = &v35;
  ...
  {
    v13 = [(StoreKitClient *)self _copyAccountIDsForRefreshReason:a3];
    v14 = v13;
    if (a4)
    {
      [v13 addObject:a4];
    ...
    if ([v14 count])
    {
      ...
      if (v17)
      {
        ...
        v38 = a3;
        v39 = 2112;
        v40 = [(StoreKitClient *)self _clientIdentifier];
        v41 = 2112;
...
- (void)_sendBuyRequestForPayment:(id)a3 withCompletionBlock:(id)a4
{
  ...
  -[BuyMicroPaymentOperation setSimulatesAskToBuyInSandbox:](v7, "setSimulatesAskToBuyInSandbox:", [objc_msgSend(a3 "simulatesAskToBuyInSandbox")]);
  v10 = [a3 objectID];
  ...
  if (v8)
  {
    ...
    do
    {
      for (i = 0; i != v9; i = i + 1)
      {
        ...
        {
          v13 = [v12 copyPaymentTransaction];
          if (v13)
          {
            v14 = v13;
