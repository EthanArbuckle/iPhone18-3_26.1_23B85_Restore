...
- (id)dictionaryRepresentation
{
  ...
  if (self->_contextId)
  {
    v4 = [(CNVSchemaCNVFlowPluginInputContext *)self contextId];
  ...
  if (self->_ended)
  {
    v7 = [(CNVSchemaCNVFlowPluginInputContext *)self ended];
...
- (BOOL)isEqual:(id)a3
{
  ...
  v8 = [(CNVSchemaCNVFlowPluginInputContext *)self contextId];
  if (v8)
  {
    v9 = v8;
  ...
  v18 = [(CNVSchemaCNVFlowPluginInputContext *)self ended];
  if (v18)
  {
    v19 = v18;
  ...
  if ((v6 != 0) != (v7 == 0))
  {
    v23 = [(CNVSchemaCNVFlowPluginInputContext *)self hypothesisId];
    if (!v23)
    {
...
- (void)writeTo:(id)a3
{
  ...
  if (v4)
  {
    v5 = [(CNVSchemaCNVFlowPluginInputContext *)self contextId];
  ...
  if (v6)
  {
    v7 = [(CNVSchemaCNVFlowPluginInputContext *)self startedOrChanged];
    PBDataWriterWriteSubmessage();
  }

  v8 = [(CNVSchemaCNVFlowPluginInputContext *)self ended];
  ...
  if (v10)
  {
    v12 = [(CNVSchemaCNVFlowPluginInputContext *)self hypothesisId];
    PBDataWriterWriteSubmessage();
