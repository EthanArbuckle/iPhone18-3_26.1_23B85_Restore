...
- (id)dictionaryRepresentation
{
  ...
  if (self->_contextId)
  {
    v4 = [(NLXSchemaMILAssetAcquisitionContext *)self contextId];
  ...
  if (self->_ended)
  {
    v7 = [(NLXSchemaMILAssetAcquisitionContext *)self ended];
...
- (BOOL)isEqual:(id)a3
{
  ...
  v8 = [(NLXSchemaMILAssetAcquisitionContext *)self contextId];
  if (v8)
  {
    v9 = v8;
  ...
  v18 = [(NLXSchemaMILAssetAcquisitionContext *)self ended];
  if (v18)
  {
    v19 = v18;
  ...
  if ((v6 != 0) != (v7 == 0))
  {
    v23 = [(NLXSchemaMILAssetAcquisitionContext *)self failed];
    if (!v23)
    {
...
- (void)writeTo:(id)a3
{
  ...
  if (v4)
  {
    v5 = [(NLXSchemaMILAssetAcquisitionContext *)self contextId];
  ...
  if (v6)
  {
    v7 = [(NLXSchemaMILAssetAcquisitionContext *)self startedOrChanged];
    PBDataWriterWriteSubmessage();
  }

  v8 = [(NLXSchemaMILAssetAcquisitionContext *)self ended];
  ...
  if (v10)
  {
    v12 = [(NLXSchemaMILAssetAcquisitionContext *)self failed];
    PBDataWriterWriteSubmessage();
