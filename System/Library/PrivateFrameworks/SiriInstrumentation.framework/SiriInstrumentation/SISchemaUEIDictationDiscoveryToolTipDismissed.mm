...
- (id)dictionaryRepresentation
{
  ...
  if (*&self->_has)
  {
    v4 = [(SISchemaUEIDictationDiscoveryToolTipDismissed *)self dismissalReason];
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ([v4 isMemberOfClass:objc_opt_class()])
  {
    ...
    {
      if ((*&self->_has & 1) == 0 || (dismissalReason = self->_dismissalReason, dismissalReason == [v4 dismissalReason]))
      {
        v6 = 1;
      }
    }
