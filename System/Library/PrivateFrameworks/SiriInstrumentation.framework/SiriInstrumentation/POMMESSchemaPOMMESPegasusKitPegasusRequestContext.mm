...
- (id)dictionaryRepresentation
{
  ...
  if (self->_ended)
  {
    v4 = [(POMMESSchemaPOMMESPegasusKitPegasusRequestContext *)self ended];
  ...
  {
    v7 = [(POMMESSchemaPOMMESPegasusKitPegasusRequestContext *)self startedOrChanged];
...
- (BOOL)isEqual:(id)a3
{
  ...
  v8 = [(POMMESSchemaPOMMESPegasusKitPegasusRequestContext *)self startedOrChanged];
  if (v8)
  {
    v9 = v8;
  ...
  if ((v6 != 0) != (v7 == 0))
  {
    v13 = [(POMMESSchemaPOMMESPegasusKitPegasusRequestContext *)self ended];
    if (!v13)
    {
...
{
  v8 = a3;
  v4 = [(POMMESSchemaPOMMESPegasusKitPegasusRequestContext *)self startedOrChanged];
  ...
  if (v6)
  {
    v7 = [(POMMESSchemaPOMMESPegasusKitPegasusRequestContext *)self ended];
    PBDataWriterWriteSubmessage();
  }
}
