...
- (NSData)jsonData;
- (ODMSiriSchemaODMSiriTaskCounts)initWithDictionary:(id)dictionary;
- (ODMSiriSchemaODMSiriTaskCounts)initWithJSON:(id)n;
...
- (ODMSiriSchemaODMSiriTaskCounts)initWithDictionary:(id)dictionary
{
  ...
  if (v5)
  {
    v6 = [dictionaryCopy objectForKeyedSubscript:@"completedSiriTaskCount"];
    objc_opt_class();
    ...
    v7 = [dictionaryCopy objectForKeyedSubscript:@"failedSiriTaskCount"];
    objc_opt_class();
    if (objc_opt_isKindOfClass())
    {
    ...
    v8 = [dictionaryCopy objectForKeyedSubscript:@"cancelledSiriTaskCount"];
    objc_opt_class();
    if (objc_opt_isKindOfClass())
    {
    ...
    v9 = [dictionaryCopy objectForKeyedSubscript:@"completedUITaskCount"];
    objc_opt_class();
    if (objc_opt_isKindOfClass())
    {
...
- (NSData)jsonData
{
  dictionaryRepresentation = [(ODMSiriSchemaODMSiriTaskCounts *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  if ((has & 4) != 0)
  {
    ...
    [dictionary setObject:v7 forKeyedSubscript:@"cancelledSiriTaskCount"];
...
LABEL_3:
  ...
  [dictionary setObject:v8 forKeyedSubscript:@"completedSiriTaskCount"];
...
LABEL_11:
  ...
  [dictionary setObject:v9 forKeyedSubscript:@"completedUITaskCount"];

  if ((*&self->_has & 2) != 0)
  {
LABEL_5:
    v5 = [MEMORY[0x1E696AD98] numberWithUnsignedInt:{-[ODMSiriSchemaODMSiriTaskCounts failedSiriTaskCount](self, "failedSiriTaskCount")}];
    [dictionary setObject:v5 forKeyedSubscript:@"failedSiriTaskCount"];
  }
