...
- (id)dictionaryRepresentation
{
  ...
  {
    v4 = [(FLOWLINKSchemaFLOWLinkActionStarted *)self currentAction];
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ([v4 isMemberOfClass:objc_opt_class()])
  {
    ...
    if ((v5 != 0) != (v6 == 0))
    {
      v8 = [(FLOWLINKSchemaFLOWLinkActionStarted *)self currentAction];
      if (!v8)
      {
...
LABEL_10:
      ...
      v9 = v8;
      v10 = [(FLOWLINKSchemaFLOWLinkActionStarted *)self currentAction];
