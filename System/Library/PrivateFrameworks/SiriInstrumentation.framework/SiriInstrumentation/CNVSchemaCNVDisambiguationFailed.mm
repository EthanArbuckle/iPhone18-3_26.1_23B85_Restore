...
- (CNVSchemaCNVDisambiguationFailed)initWithDictionary:(id)dictionary;
- (CNVSchemaCNVDisambiguationFailed)initWithJSON:(id)n;
- (NSData)jsonData;
...
- (CNVSchemaCNVDisambiguationFailed)initWithDictionary:(id)dictionary
{
  ...
  v9.receiver = self;
  v9.super_class = CNVSchemaCNVDisambiguationFailed;
...
- (NSData)jsonData
{
  dictionaryRepresentation = [(CNVSchemaCNVDisambiguationFailed *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  if (*&self->_has)
  {
    v4 = [MEMORY[0x1E696AD98] numberWithUnsignedInt:{-[CNVSchemaCNVDisambiguationFailed errorCode](self, "errorCode")}];
