...
- (ExecutorSiriSchemaExecutorAppIntentCallContext)initWithDictionary:(id)dictionary;
- (ExecutorSiriSchemaExecutorAppIntentCallContext)initWithJSON:(id)n;
...
- (NSData)jsonData
{
  dictionaryRepresentation = [(ExecutorSiriSchemaExecutorAppIntentCallContext *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  if (self->_ended)
  {
    ended = [(ExecutorSiriSchemaExecutorAppIntentCallContext *)self ended];
  ...
  if (self->_failed)
  {
    failed = [(ExecutorSiriSchemaExecutorAppIntentCallContext *)self failed];
  ...
  {
    startedOrChanged = [(ExecutorSiriSchemaExecutorAppIntentCallContext *)self startedOrChanged];
  ...
  if (self->_traceId)
  {
    traceId = [(ExecutorSiriSchemaExecutorAppIntentCallContext *)self traceId];
...
- (BOOL)isEqual:(id)equal
{
  ...
  startedOrChanged3 = [(ExecutorSiriSchemaExecutorAppIntentCallContext *)self startedOrChanged];
  if (startedOrChanged3)
  {
    v9 = startedOrChanged3;
    startedOrChanged4 = [(ExecutorSiriSchemaExecutorAppIntentCallContext *)self startedOrChanged];
  ...
  startedOrChanged = [(ExecutorSiriSchemaExecutorAppIntentCallContext *)self ended];
  ...
  {
    v14 = ended;
    ended2 = [(ExecutorSiriSchemaExecutorAppIntentCallContext *)self ended];
  ...
  startedOrChanged = [(ExecutorSiriSchemaExecutorAppIntentCallContext *)self failed];
  ...
  {
    v19 = failed;
    failed2 = [(ExecutorSiriSchemaExecutorAppIntentCallContext *)self failed];
  ...
  startedOrChanged = [(ExecutorSiriSchemaExecutorAppIntentCallContext *)self traceId];
...
LABEL_26:
    ...
    v24 = traceId;
    traceId2 = [(ExecutorSiriSchemaExecutorAppIntentCallContext *)self traceId];
...
- (void)writeTo:(id)to
{
  ...
  if (startedOrChanged)
  {
    startedOrChanged2 = [(ExecutorSiriSchemaExecutorAppIntentCallContext *)self startedOrChanged];
