...
- (NSData)jsonData;
- (PEGASUSSchemaPEGASUSMapsExecution)initWithDictionary:(id)dictionary;
- (PEGASUSSchemaPEGASUSMapsExecution)initWithJSON:(id)n;
...
- (NSData)jsonData
{
  dictionaryRepresentation = [(PEGASUSSchemaPEGASUSMapsExecution *)self dictionaryRepresentation];
