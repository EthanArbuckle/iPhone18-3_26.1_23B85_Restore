...
- (IFTSchemaIFTApp)initWithDictionary:(id)dictionary;
- (IFTSchemaIFTApp)initWithJSON:(id)n;
- (NSData)jsonData;
...
- (IFTSchemaIFTApp)initWithDictionary:(id)dictionary
{
  ...
  v10.receiver = self;
  v10.super_class = IFTSchemaIFTApp;
...
- (NSData)jsonData
{
  dictionaryRepresentation = [(IFTSchemaIFTApp *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  if (self->_bundleId)
  {
    bundleId = [(IFTSchemaIFTApp *)self bundleId];
    v5 = [bundleId copy];
...
- (BOOL)isEqual:(id)equal
{
  ...
  if ([equalCopy isMemberOfClass:objc_opt_class()])
  {
    ...
    {
      bundleId3 = [(IFTSchemaIFTApp *)self bundleId];
      if (!bundleId3)
      {
...
LABEL_10:
      ...
      v9 = bundleId3;
      bundleId4 = [(IFTSchemaIFTApp *)self bundleId];
...
{
  v8.receiver = self;
  v8.super_class = IFTSchemaIFTApp;
  policyCopy = policy;
