...
- (NSData)jsonData;
- (ORCHSchemaORCHNLRouterDecisionGenAIMetadata)initWithDictionary:(id)dictionary;
- (ORCHSchemaORCHNLRouterDecisionGenAIMetadata)initWithJSON:(id)n;
...
- (NSData)jsonData
{
  dictionaryRepresentation = [(ORCHSchemaORCHNLRouterDecisionGenAIMetadata *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  if ((has & 2) != 0)
  {
    ...
    [dictionary setObject:v6 forKeyedSubscript:@"genAIAppIntent"];
    has = self->_has;
  }
