...
- (id)dictionaryRepresentation
{
  ...
  if (self->_contextId)
  {
    v4 = [(SISchemaUEIDictationDiscoveryToolTipDisplayContext *)self contextId];
  ...
  if (self->_ended)
  {
    v7 = [(SISchemaUEIDictationDiscoveryToolTipDisplayContext *)self ended];
...
- (BOOL)isEqual:(id)a3
{
  ...
  v8 = [(SISchemaUEIDictationDiscoveryToolTipDisplayContext *)self contextId];
  if (v8)
  {
    v9 = v8;
  ...
  v13 = [(SISchemaUEIDictationDiscoveryToolTipDisplayContext *)self startedOrChanged];
  if (v13)
  {
    v14 = v13;
  ...
  if ((v6 != 0) != (v7 == 0))
  {
    v18 = [(SISchemaUEIDictationDiscoveryToolTipDisplayContext *)self ended];
    if (!v18)
    {
...
- (void)writeTo:(id)a3
{
  ...
  if (v6)
  {
    v7 = [(SISchemaUEIDictationDiscoveryToolTipDisplayContext *)self startedOrChanged];
    PBDataWriterWriteSubmessage();
  }

  v8 = [(SISchemaUEIDictationDiscoveryToolTipDisplayContext *)self ended];

  v9 = v11;
  if (v8)
  {
    v10 = [(SISchemaUEIDictationDiscoveryToolTipDisplayContext *)self ended];
    PBDataWriterWriteSubmessage();
