...
- (NSData)jsonData;
- (SISchemaUEIUIRenderingStarted)initWithDictionary:(id)dictionary;
- (SISchemaUEIUIRenderingStarted)initWithJSON:(id)n;
...
- (SISchemaUEIUIRenderingStarted)initWithDictionary:(id)dictionary
{
  ...
  v9.receiver = self;
  v9.super_class = SISchemaUEIUIRenderingStarted;
...
- (NSData)jsonData
{
  dictionaryRepresentation = [(SISchemaUEIUIRenderingStarted *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  if (*(&self->_exists + 1))
  {
    v4 = [MEMORY[0x1E696AD98] numberWithBool:{-[SISchemaUEIUIRenderingStarted exists](self, "exists")}];
