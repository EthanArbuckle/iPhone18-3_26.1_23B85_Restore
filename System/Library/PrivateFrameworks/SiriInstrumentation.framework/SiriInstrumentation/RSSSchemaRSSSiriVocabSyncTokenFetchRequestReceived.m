...
- (BOOL)isEqual:(id)a3
{
  ...
  if ([v4 isMemberOfClass:objc_opt_class()])
  {
    ...
    {
      if ((*&self->_has & 1) == 0 || (syncTokenFetchRequestTransferLatencyInMs = self->_syncTokenFetchRequestTransferLatencyInMs, syncTokenFetchRequestTransferLatencyInMs == [v4 syncTokenFetchRequestTransferLatencyInMs]))
      {
        v6 = 1;
      }
    }
