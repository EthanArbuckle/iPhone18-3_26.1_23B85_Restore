  ...
  if ([v4 isMemberOfClass:objc_opt_class()])
  {
    if ((*&self->_has & 1) == (v4[24] & 1))
    {
      if ((*&self->_has & 1) == 0 || (exists = self->_exists, exists == [v4 exists]))
      {
        ...
        v7 = [v4 validationsMobileAssetVersion];
        v8 = v7;
        if ((v6 != 0) != (v7 == 0))
        {
          v9 = [(RGSiriSchemaRGValidationStarted *)self validationsMobileAssetVersion];
          if (!v9)
          {
...
LABEL_13:
          ...
          v10 = v9;
          v11 = [(RGSiriSchemaRGValidationStarted *)self validationsMobileAssetVersion];
...
- (void)writeTo:(id)a3
{
  ...
  v4 = [(RGSiriSchemaRGValidationStarted *)self validationsMobileAssetVersion];
