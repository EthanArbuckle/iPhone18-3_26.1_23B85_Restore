...
- (BOOL)isEqual:(id)a3;
- (MHSchemaMHAdaptiveSiriVolumeUserIntentDetected)initWithDictionary:(id)a3;
- (MHSchemaMHAdaptiveSiriVolumeUserIntentDetected)initWithJSON:(id)a3;
- (NSData)jsonData;
...
- (NSData)jsonData
{
  v2 = [(MHSchemaMHAdaptiveSiriVolumeUserIntentDetected *)self dictionaryRepresentation];
