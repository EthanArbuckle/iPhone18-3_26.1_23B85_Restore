...
- (TTMSchemaTTMOverrideTCUFailure)initWithDictionary:(id)a3
{
  ...
  if (v5)
  {
    ...
    v8 = [v4 objectForKeyedSubscript:@"failures"];
    objc_opt_class();
    if (objc_opt_isKindOfClass())
    {
      v18 = v6;
...
- (id)dictionaryRepresentation
{
  ...
  if (self->_tcuId)
  {
    v12 = [(TTMSchemaTTMOverrideTCUFailure *)self tcuId];
...
- (BOOL)isEqual:(id)a3
{
  ...
  v7 = [(TTMSchemaTTMOverrideTCUFailure *)self tcuId];
  if (v7)
  {
    v8 = v7;
    v9 = [(TTMSchemaTTMOverrideTCUFailure *)self tcuId];
    v10 = [v4 tcuId];
    v11 = [v9 isEqual:v10];
  ...
  if ((v5 != 0) != (v6 == 0))
  {
    v12 = [(TTMSchemaTTMOverrideTCUFailure *)self failures];
    if (!v12)
    {
...
LABEL_15:
    ...
    v13 = v12;
    v14 = [(TTMSchemaTTMOverrideTCUFailure *)self failures];
    v15 = [v4 failures];
    v16 = [v14 isEqual:v15];
