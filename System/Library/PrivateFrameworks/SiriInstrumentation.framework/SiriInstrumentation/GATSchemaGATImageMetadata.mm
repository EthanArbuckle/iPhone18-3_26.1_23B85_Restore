...
- (GATSchemaGATImageMetadata)initWithDictionary:(id)dictionary;
- (GATSchemaGATImageMetadata)initWithJSON:(id)n;
- (NSData)jsonData;
...
- (NSData)jsonData
{
  dictionaryRepresentation = [(GATSchemaGATImageMetadata *)self dictionaryRepresentation];
