...
- (id)dictionaryRepresentation
{
  ...
  {
    v4 = [(IFPlatformRequestSchemaIFPlatformRequestEnded *)self handledError];
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ([v4 isMemberOfClass:objc_opt_class()])
  {
    ...
    if ((v5 != 0) != (v6 == 0))
    {
      v8 = [(IFPlatformRequestSchemaIFPlatformRequestEnded *)self handledError];
      if (!v8)
      {
...
LABEL_10:
      ...
      v9 = v8;
      v10 = [(IFPlatformRequestSchemaIFPlatformRequestEnded *)self handledError];
      v11 = [v4 handledError];
      v12 = [v10 isEqual:v11];
