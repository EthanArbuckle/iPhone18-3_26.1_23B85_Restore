...
- (id)dictionaryRepresentation
{
  ...
  if (*&self->_has)
  {
    v4 = [(SISchemaPNRSpeechRecognitionSourceContext *)self speechRecognitionSource];
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ([v4 isMemberOfClass:objc_opt_class()])
  {
    ...
    {
      if ((*&self->_has & 1) == 0 || (speechRecognitionSource = self->_speechRecognitionSource, speechRecognitionSource == [v4 speechRecognitionSource]))
      {
        v6 = 1;
      }
    }
