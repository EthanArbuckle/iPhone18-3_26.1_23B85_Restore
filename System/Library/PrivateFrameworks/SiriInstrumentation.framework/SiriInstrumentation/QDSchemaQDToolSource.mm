...
- (BOOL)isEqual:(id)a3
{
  ...
  v7 = [(QDSchemaQDToolSource *)self spanMatches];
  if (v7)
  {
    v8 = v7;
    v9 = [(QDSchemaQDToolSource *)self spanMatches];
    v10 = [v4 spanMatches];
    v11 = [v9 isEqual:v10];
  ...
  v6 = [v4 contexualMatches];
  if ((v5 != 0) != (v6 == 0))
  {
    v12 = [(QDSchemaQDToolSource *)self contexualMatches];
    if (!v12)
    {
...
LABEL_15:
    ...
    v13 = v12;
    v14 = [(QDSchemaQDToolSource *)self contexualMatches];
    v15 = [v4 contexualMatches];
    v16 = [v14 isEqual:v15];
