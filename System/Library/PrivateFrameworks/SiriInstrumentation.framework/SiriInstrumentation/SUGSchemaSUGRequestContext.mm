...
- (SUGSchemaSUGRequestContext)initWithDictionary:(id)a3
{
  ...
  if (v5)
  {
    ...
    if (objc_opt_isKindOfClass())
    {
      v11 = [[SUGSchemaSUGRequestFailed alloc] initWithDictionary:v10];
...
- (unint64_t)hash
{
  v3 = [(SUGSchemaSUGRequestStarted *)self->_startedOrChanged hash];
  v4 = [(SUGSchemaSUGRequestEnded *)self->_ended hash]^ v3;
