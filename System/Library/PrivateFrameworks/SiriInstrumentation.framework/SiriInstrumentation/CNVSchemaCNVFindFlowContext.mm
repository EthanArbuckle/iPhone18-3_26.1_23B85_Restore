...
- (id)dictionaryRepresentation
{
  ...
  if (self->_contextId)
  {
    v4 = [(CNVSchemaCNVFindFlowContext *)self contextId];
  ...
  if (self->_ended)
  {
    v7 = [(CNVSchemaCNVFindFlowContext *)self ended];
...
- (BOOL)isEqual:(id)a3
{
  ...
  v8 = [(CNVSchemaCNVFindFlowContext *)self contextId];
  if (v8)
  {
    v9 = v8;
  ...
  v18 = [(CNVSchemaCNVFindFlowContext *)self ended];
  if (v18)
  {
    v19 = v18;
  ...
  if ((v6 != 0) != (v7 == 0))
  {
    v23 = [(CNVSchemaCNVFindFlowContext *)self hypothesisId];
    if (!v23)
    {
...
- (void)writeTo:(id)a3
{
  ...
  if (v4)
  {
    v5 = [(CNVSchemaCNVFindFlowContext *)self contextId];
  ...
  if (v6)
  {
    v7 = [(CNVSchemaCNVFindFlowContext *)self startedOrChanged];
    PBDataWriterWriteSubmessage();
  }

  v8 = [(CNVSchemaCNVFindFlowContext *)self ended];
  ...
  if (v10)
  {
    v12 = [(CNVSchemaCNVFindFlowContext *)self hypothesisId];
    PBDataWriterWriteSubmessage();
