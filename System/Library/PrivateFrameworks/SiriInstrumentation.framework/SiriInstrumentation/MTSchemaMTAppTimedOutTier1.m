...
- (id)dictionaryRepresentation
{
  ...
  if (self->_localePair)
  {
    v4 = [(MTSchemaMTAppTimedOutTier1 *)self localePair];
  ...
  {
    v7 = [(MTSchemaMTAppTimedOutTier1 *)self translationPayload];
    v8 = [v7 copy];
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ((v5 != 0) != (v6 == 0))
  {
    v12 = [(MTSchemaMTAppTimedOutTier1 *)self localePair];
    if (!v12)
    {
...
{
  v7 = a3;
  v4 = [(MTSchemaMTAppTimedOutTier1 *)self translationPayload];
