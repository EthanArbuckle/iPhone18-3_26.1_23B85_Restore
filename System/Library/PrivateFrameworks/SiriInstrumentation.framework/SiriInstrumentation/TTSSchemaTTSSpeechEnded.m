...
- (id)dictionaryRepresentation
{
  ...
  {
    v4 = [(TTSSchemaTTSSpeechEnded *)self errorCodes];
    v5 = [v4 copy];
  ...
  if (v9 == ((v6 >> 1) & 1))
  {
    ...
    if (v12 == ((v6 >> 2) & 1))
    {
      ...
      if (v15 == ((v6 >> 3) & 1))
      {
        ...
        {
          v17 = [(TTSSchemaTTSSpeechEnded *)self errorCodes];
          v18 = [v4 errorCodes];
          v19 = v18;
          if ((v17 != 0) != (v18 == 0))
          {
            v20 = [(TTSSchemaTTSSpeechEnded *)self errorCodes];
            if (!v20)
            {
...
LABEL_25:
            ...
            v21 = v20;
            v22 = [(TTSSchemaTTSSpeechEnded *)self errorCodes];
            v23 = [v4 errorCodes];
            v24 = [v22 isEqual:v23];
