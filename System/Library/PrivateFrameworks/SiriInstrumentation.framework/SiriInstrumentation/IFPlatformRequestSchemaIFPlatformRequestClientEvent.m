...
- (IFPlatformRequestSchemaIFPlatformRequestClientEvent)initWithDictionary:(id)a3
{
  ...
  if (v5)
  {
    ...
    v8 = [v4 objectForKeyedSubscript:@"ifPlatformRequestContext"];
    objc_opt_class();
    if (objc_opt_isKindOfClass())
    {
...
- (id)dictionaryRepresentation
{
  ...
  {
    v4 = [(IFPlatformRequestSchemaIFPlatformRequestClientEvent *)self eventMetadata];
  ...
  {
    v7 = [(IFPlatformRequestSchemaIFPlatformRequestClientEvent *)self ifPlanCycleGenerated];
...
- (BOOL)isEqual:(id)a3
{
  ...
  v6 = [(IFPlatformRequestSchemaIFPlatformRequestClientEvent *)self eventMetadata];
  v7 = [v4 eventMetadata];
  if ((v6 != 0) == (v7 == 0))
  {
    goto LABEL_22;
  ...
  v8 = [(IFPlatformRequestSchemaIFPlatformRequestClientEvent *)self eventMetadata];
  if (v8)
  {
    v9 = v8;
  ...
  v6 = [(IFPlatformRequestSchemaIFPlatformRequestClientEvent *)self ifPlatformRequestContext];
  v7 = [v4 ifPlatformRequestContext];
  if ((v6 != 0) == (v7 == 0))
  {
    goto LABEL_22;
  }

  v13 = [(IFPlatformRequestSchemaIFPlatformRequestClientEvent *)self ifPlatformRequestContext];
  if (v13)
  {
    v14 = v13;
    v15 = [(IFPlatformRequestSchemaIFPlatformRequestClientEvent *)self ifPlatformRequestContext];
    v16 = [v4 ifPlatformRequestContext];
    v17 = [v15 isEqual:v16];
  ...
  v6 = [(IFPlatformRequestSchemaIFPlatformRequestClientEvent *)self ifPlatformRequestInvoked];
  v7 = [v4 ifPlatformRequestInvoked];
  if ((v6 != 0) == (v7 == 0))
  {
    goto LABEL_22;
  }

  v18 = [(IFPlatformRequestSchemaIFPlatformRequestClientEvent *)self ifPlatformRequestInvoked];
  if (v18)
  {
    v19 = v18;
  ...
  v6 = [(IFPlatformRequestSchemaIFPlatformRequestClientEvent *)self ifPlanCycleGenerated];
  v7 = [v4 ifPlanCycleGenerated];
  if ((v6 != 0) != (v7 == 0))
  {
    v23 = [(IFPlatformRequestSchemaIFPlatformRequestClientEvent *)self ifPlanCycleGenerated];
    if (!v23)
    {
...
- (void)writeTo:(id)a3
{
  ...
  if (v4)
  {
    v5 = [(IFPlatformRequestSchemaIFPlatformRequestClientEvent *)self eventMetadata];
  ...
  if (v6)
  {
    v7 = [(IFPlatformRequestSchemaIFPlatformRequestClientEvent *)self ifPlatformRequestContext];
    PBDataWriterWriteSubmessage();
  }

  v8 = [(IFPlatformRequestSchemaIFPlatformRequestClientEvent *)self ifPlatformRequestInvoked];
  ...
  if (v10)
  {
    v12 = [(IFPlatformRequestSchemaIFPlatformRequestClientEvent *)self ifPlanCycleGenerated];
    PBDataWriterWriteSubmessage();
...
- (id)qualifiedMessageName
{
  v2 = [(IFPlatformRequestSchemaIFPlatformRequestClientEvent *)self whichEvent_Type];
  if (v2 - 101 > 2)
  {
...
- (SISchemaInstrumentationMessage)innerEvent
{
  v3 = [(IFPlatformRequestSchemaIFPlatformRequestClientEvent *)self whichEvent_Type];
  if (v3 - 101 > 2)
  {
    v4 = 0;
  }
  ...
  {
    v4 = *(&self->super.super.super.super.isa + *off_1E78E9A08[v3 - 101]);
  }
