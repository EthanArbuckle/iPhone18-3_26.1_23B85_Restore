...
- (BOOL)isEqual:(id)a3;
- (IFTSchemaIFTStructuredSearchProperty)initWithDictionary:(id)a3;
- (IFTSchemaIFTStructuredSearchProperty)initWithJSON:(id)a3;
- (NSData)jsonData;
...
- (IFTSchemaIFTStructuredSearchProperty)initWithDictionary:(id)a3
{
  ...
  if (v5)
  {
    ...
    v7 = [v4 objectForKeyedSubscript:@"previousAnswerReferenceStatementId"];
    objc_opt_class();
    if (objc_opt_isKindOfClass())
    {
...
- (NSData)jsonData
{
  v2 = [(IFTSchemaIFTStructuredSearchProperty *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  {
    v5 = [(IFTSchemaIFTStructuredSearchProperty *)self previousAnswerReferenceStatementId];
    v6 = [v5 dictionaryRepresentation];
    if (v6)
    {
      [v3 setObject:v6 forKeyedSubscript:@"previousAnswerReferenceStatementId"];
    }

    else
    {
      v7 = [MEMORY[0x1E695DFB0] null];
      [v3 setObject:v7 forKeyedSubscript:@"previousAnswerReferenceStatementId"];
    }
  }
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ([v4 isMemberOfClass:objc_opt_class()])
  {
    if ((*&self->_has & 1) == (v4[24] & 1))
    {
      ...
      {
        v6 = [(IFTSchemaIFTStructuredSearchProperty *)self previousAnswerReferenceStatementId];
        v7 = [v4 previousAnswerReferenceStatementId];
        v8 = v7;
        if ((v6 != 0) != (v7 == 0))
        {
          v9 = [(IFTSchemaIFTStructuredSearchProperty *)self previousAnswerReferenceStatementId];
          if (!v9)
          {
...
LABEL_13:
          ...
          v10 = v9;
          v11 = [(IFTSchemaIFTStructuredSearchProperty *)self previousAnswerReferenceStatementId];
          v12 = [v4 previousAnswerReferenceStatementId];
          v13 = [v11 isEqual:v12];
...
- (void)writeTo:(id)a3
{
  ...
  v4 = [(IFTSchemaIFTStructuredSearchProperty *)self previousAnswerReferenceStatementId];
