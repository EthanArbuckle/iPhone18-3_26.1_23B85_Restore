...
- (BOOL)isEqual:(id)a3;
- (NSData)jsonData;
- (PEGASUSSchemaPEGASUSAlternateQuerySuggestionTier1)initWithDictionary:(id)a3;
- (PEGASUSSchemaPEGASUSAlternateQuerySuggestionTier1)initWithJSON:(id)a3;
- (id)applySensitiveConditionsPolicy:(id)a3;
- (id)dictionaryRepresentation;
- (id)suppressMessageUnderConditions;
- (void)addAlternateQuerySuggestionCandidateTier1:(id)a3;
- (void)writeTo:(id)a3;
@end
...
- (PEGASUSSchemaPEGASUSAlternateQuerySuggestionTier1)initWithDictionary:(id)a3
{
  ...
  if (v5)
  {
    v6 = [v4 objectForKeyedSubscript:@"alternateQuerySuggestionCandidateTier1"];
    objc_opt_class();
...
- (NSData)jsonData
{
  v2 = [(PEGASUSSchemaPEGASUSAlternateQuerySuggestionTier1 *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  if ([(NSArray *)self->_alternateQuerySuggestionCandidateTier1s count])
  {
    ...
    [v3 setObject:v4 forKeyedSubscript:@"alternateQuerySuggestionCandidateTier1"];
  }
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    v5 = [(PEGASUSSchemaPEGASUSAlternateQuerySuggestionTier1 *)self alternateQuerySuggestionCandidateTier1s];
    v6 = [v4 alternateQuerySuggestionCandidateTier1s];
    v7 = v6;
    if ((v5 != 0) != (v6 == 0))
    {
      v8 = [(PEGASUSSchemaPEGASUSAlternateQuerySuggestionTier1 *)self alternateQuerySuggestionCandidateTier1s];
      if (!v8)
      {
...
LABEL_10:
      ...
      v9 = v8;
      v10 = [(PEGASUSSchemaPEGASUSAlternateQuerySuggestionTier1 *)self alternateQuerySuggestionCandidateTier1s];
      v11 = [v4 alternateQuerySuggestionCandidateTier1s];
      v12 = [v10 isEqual:v11];
...
- (void)addAlternateQuerySuggestionCandidateTier1:(id)a3
{
  ...
  if (!alternateQuerySuggestionCandidateTier1s)
  {
    ...
    self->_alternateQuerySuggestionCandidateTier1s = v6;

    v4 = v8;
    alternateQuerySuggestionCandidateTier1s = self->_alternateQuerySuggestionCandidateTier1s;
  }

  [(NSArray *)alternateQuerySuggestionCandidateTier1s addObject:v4];
}
...
- (id)applySensitiveConditionsPolicy:(id)a3
{
  ...
  v6 = [(PEGASUSSchemaPEGASUSAlternateQuerySuggestionTier1 *)self alternateQuerySuggestionCandidateTier1s];
