...
- (GATSchemaGATRequestFailed)initWithDictionary:(id)dictionary;
- (GATSchemaGATRequestFailed)initWithJSON:(id)n;
- (NSData)jsonData;
...
- (NSData)jsonData
{
  dictionaryRepresentation = [(GATSchemaGATRequestFailed *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  if (self->_error)
  {
    error = [(GATSchemaGATRequestFailed *)self error];
  ...
  {
    underlyingError = [(GATSchemaGATRequestFailed *)self underlyingError];
...
- (BOOL)isEqual:(id)equal
{
  ...
  error3 = [(GATSchemaGATRequestFailed *)self error];
  if (error3)
  {
    v13 = error3;
    error4 = [(GATSchemaGATRequestFailed *)self error];
  ...
  error = [(GATSchemaGATRequestFailed *)self underlyingError];
...
LABEL_22:
    ...
    v18 = underlyingError;
    underlyingError2 = [(GATSchemaGATRequestFailed *)self underlyingError];
...
- (void)writeTo:(id)to
{
  ...
  if (error)
  {
    error2 = [(GATSchemaGATRequestFailed *)self error];
