...
- (NLXSchemaCDMClientWarmupStarted)initWithDictionary:(id)dictionary;
- (NLXSchemaCDMClientWarmupStarted)initWithJSON:(id)n;
- (NSData)jsonData;
...
- (NLXSchemaCDMClientWarmupStarted)initWithDictionary:(id)dictionary
{
  ...
  if (v5)
  {
    v6 = [dictionaryCopy objectForKeyedSubscript:@"serviceGraphName"];
    objc_opt_class();
...
- (NSData)jsonData
{
  dictionaryRepresentation = [(NLXSchemaCDMClientWarmupStarted *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  if (*&self->_has)
  {
    ...
    [dictionary setObject:v5 forKeyedSubscript:@"serviceGraphName"];
  }
...
- (BOOL)isEqual:(id)equal
{
  ...
  if ([equalCopy isMemberOfClass:objc_opt_class()])
  {
    ...
    {
      if ((*&self->_has & 1) == 0 || (serviceGraphName = self->_serviceGraphName, serviceGraphName == [equalCopy serviceGraphName]))
      {
        v6 = 1;
      }
    }
