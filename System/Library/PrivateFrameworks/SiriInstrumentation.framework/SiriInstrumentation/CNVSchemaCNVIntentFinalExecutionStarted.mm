...
- (CNVSchemaCNVIntentFinalExecutionStarted)initWithDictionary:(id)dictionary;
- (CNVSchemaCNVIntentFinalExecutionStarted)initWithJSON:(id)n;
- (NSData)jsonData;
- (id)dictionaryRepresentation;
- (id)suppressMessageUnderConditions;
- (unint64_t)hash;
- (void)setHasStackDepth:(BOOL)depth;
- (void)writeTo:(id)to;
@end
...
- (CNVSchemaCNVIntentFinalExecutionStarted)initWithDictionary:(id)dictionary
{
  ...
  if (v5)
  {
    ...
    v7 = [dictionaryCopy objectForKeyedSubscript:@"stackDepth"];
    objc_opt_class();
    if (objc_opt_isKindOfClass())
    {
...
- (NSData)jsonData
{
  dictionaryRepresentation = [(CNVSchemaCNVIntentFinalExecutionStarted *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  if (has)
  {
    ...
    [dictionary setObject:v6 forKeyedSubscript:@"plugin"];
    has = self->_has;
  }
  ...
  if ((has & 2) != 0)
  {
    ...
    [dictionary setObject:v7 forKeyedSubscript:@"stackDepth"];
  }
...
LABEL_10:
  ...
  if (v8)
  {
    ...
    if (stackDepth != [equalCopy stackDepth])
    {
      goto LABEL_10;
    }
  }
