...
- (NSData)jsonData;
- (ORCHSchemaORCHExecuteOnRemoteRequestEnded)initWithDictionary:(id)dictionary;
- (ORCHSchemaORCHExecuteOnRemoteRequestEnded)initWithJSON:(id)n;
...
- (ORCHSchemaORCHExecuteOnRemoteRequestEnded)initWithDictionary:(id)dictionary
{
  ...
  v9.receiver = self;
  v9.super_class = ORCHSchemaORCHExecuteOnRemoteRequestEnded;
...
- (NSData)jsonData
{
  dictionaryRepresentation = [(ORCHSchemaORCHExecuteOnRemoteRequestEnded *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  if (*&self->_has)
  {
    v4 = [(ORCHSchemaORCHExecuteOnRemoteRequestEnded *)self aceCommandType]- 1;
    if (v4 > 4)
    {
