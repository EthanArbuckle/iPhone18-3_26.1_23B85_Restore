...
- (PLUSSchemaPLUSSuggestion)initWithDictionary:(id)a3
{
  ...
  if (v5)
  {
    ...
    v8 = [v4 objectForKeyedSubscript:@"suggestionValue"];
    objc_opt_class();
    if (objc_opt_isKindOfClass())
    {
...
- (id)dictionaryRepresentation
{
  ...
  {
    v4 = [(PLUSSchemaPLUSSuggestion *)self suggestionMetadata];
  ...
  {
    v7 = [(PLUSSchemaPLUSSuggestion *)self suggestionValue];
...
- (BOOL)isEqual:(id)a3
{
  ...
  v7 = [(PLUSSchemaPLUSSuggestion *)self suggestionMetadata];
  if (v7)
  {
    v8 = v7;
  ...
  if ((v5 != 0) != (v6 == 0))
  {
    v12 = [(PLUSSchemaPLUSSuggestion *)self suggestionValue];
    if (!v12)
    {
