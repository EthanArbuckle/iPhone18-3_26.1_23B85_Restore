...
- (BOOL)isEqual:(id)a3;
- (ExecutorSiriSchemaExecutorStringQueryEntityCallContext)initWithDictionary:(id)a3;
- (ExecutorSiriSchemaExecutorStringQueryEntityCallContext)initWithJSON:(id)a3;
...
- (NSData)jsonData
{
  v2 = [(ExecutorSiriSchemaExecutorStringQueryEntityCallContext *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  if (self->_ended)
  {
    v4 = [(ExecutorSiriSchemaExecutorStringQueryEntityCallContext *)self ended];
  ...
  if (self->_failed)
  {
    v7 = [(ExecutorSiriSchemaExecutorStringQueryEntityCallContext *)self failed];
  ...
  {
    v10 = [(ExecutorSiriSchemaExecutorStringQueryEntityCallContext *)self startedOrChanged];
...
- (BOOL)isEqual:(id)a3
{
  ...
  v6 = [(ExecutorSiriSchemaExecutorStringQueryEntityCallContext *)self startedOrChanged];
  ...
  v8 = [(ExecutorSiriSchemaExecutorStringQueryEntityCallContext *)self startedOrChanged];
  if (v8)
  {
    v9 = v8;
    v10 = [(ExecutorSiriSchemaExecutorStringQueryEntityCallContext *)self startedOrChanged];
  ...
  v6 = [(ExecutorSiriSchemaExecutorStringQueryEntityCallContext *)self ended];
  v7 = [v4 ended];
  if ((v6 != 0) == (v7 == 0))
  {
    goto LABEL_17;
  ...
  v13 = [(ExecutorSiriSchemaExecutorStringQueryEntityCallContext *)self ended];
  if (v13)
  {
    v14 = v13;
    v15 = [(ExecutorSiriSchemaExecutorStringQueryEntityCallContext *)self ended];
    v16 = [v4 ended];
    v17 = [v15 isEqual:v16];
  ...
  v6 = [(ExecutorSiriSchemaExecutorStringQueryEntityCallContext *)self failed];
  v7 = [v4 failed];
  if ((v6 != 0) != (v7 == 0))
  {
    v18 = [(ExecutorSiriSchemaExecutorStringQueryEntityCallContext *)self failed];
    if (!v18)
    {
...
LABEL_21:
    ...
    v19 = v18;
    v20 = [(ExecutorSiriSchemaExecutorStringQueryEntityCallContext *)self failed];
    v21 = [v4 failed];
    v22 = [v20 isEqual:v21];
...
{
  v11 = a3;
  v4 = [(ExecutorSiriSchemaExecutorStringQueryEntityCallContext *)self startedOrChanged];

  if (v4)
  {
    v5 = [(ExecutorSiriSchemaExecutorStringQueryEntityCallContext *)self startedOrChanged];
  ...
  if (v6)
  {
    v7 = [(ExecutorSiriSchemaExecutorStringQueryEntityCallContext *)self ended];
    PBDataWriterWriteSubmessage();
  }

  v8 = [(ExecutorSiriSchemaExecutorStringQueryEntityCallContext *)self failed];

  v9 = v11;
  if (v8)
  {
    v10 = [(ExecutorSiriSchemaExecutorStringQueryEntityCallContext *)self failed];
    PBDataWriterWriteSubmessage();
...
- (id)applySensitiveConditionsPolicy:(id)a3
{
  ...
  v9 = [(ExecutorSiriSchemaExecutorStringQueryEntityCallContext *)self ended];
  ...
  v12 = [(ExecutorSiriSchemaExecutorStringQueryEntityCallContext *)self failed];
