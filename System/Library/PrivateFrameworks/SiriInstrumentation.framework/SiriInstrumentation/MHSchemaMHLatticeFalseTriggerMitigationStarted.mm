...
- (MHSchemaMHLatticeFalseTriggerMitigationStarted)initWithDictionary:(id)dictionary;
- (MHSchemaMHLatticeFalseTriggerMitigationStarted)initWithJSON:(id)n;
- (NSData)jsonData;
...
- (NSData)jsonData
{
  dictionaryRepresentation = [(MHSchemaMHLatticeFalseTriggerMitigationStarted *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  {
    modelVersion = [(MHSchemaMHLatticeFalseTriggerMitigationStarted *)self modelVersion];
...
- (BOOL)isEqual:(id)equal
{
  ...
  if ([equalCopy isMemberOfClass:objc_opt_class()])
  {
    ...
    {
      modelVersion3 = [(MHSchemaMHLatticeFalseTriggerMitigationStarted *)self modelVersion];
      if (!modelVersion3)
      {
...
LABEL_10:
      ...
      v9 = modelVersion3;
      modelVersion4 = [(MHSchemaMHLatticeFalseTriggerMitigationStarted *)self modelVersion];
