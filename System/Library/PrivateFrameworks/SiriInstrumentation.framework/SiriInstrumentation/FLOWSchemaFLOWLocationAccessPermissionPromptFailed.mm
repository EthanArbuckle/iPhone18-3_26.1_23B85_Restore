...
- (FLOWSchemaFLOWLocationAccessPermissionPromptFailed)initWithDictionary:(id)dictionary;
- (FLOWSchemaFLOWLocationAccessPermissionPromptFailed)initWithJSON:(id)n;
- (NSData)jsonData;
...
- (NSData)jsonData
{
  dictionaryRepresentation = [(FLOWSchemaFLOWLocationAccessPermissionPromptFailed *)self dictionaryRepresentation];
