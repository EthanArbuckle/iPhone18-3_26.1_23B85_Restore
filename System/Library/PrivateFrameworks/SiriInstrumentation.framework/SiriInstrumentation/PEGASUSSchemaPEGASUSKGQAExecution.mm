...
- (id)dictionaryRepresentation
{
  ...
  if (self->_attributes)
  {
    v4 = [(PEGASUSSchemaPEGASUSKGQAExecution *)self attributes];
    v5 = [v4 copy];
...
LABEL_13:
  if (self->_nlgKey)
  {
    v11 = [(PEGASUSSchemaPEGASUSKGQAExecution *)self nlgKey];
    v12 = [v11 copy];
...
- (BOOL)isEqual:(id)a3
{
  ...
  v6 = [(PEGASUSSchemaPEGASUSKGQAExecution *)self attributes];
  v7 = [v4 attributes];
  if ((v6 != 0) == (v7 == 0))
  {
    goto LABEL_17;
  ...
  v8 = [(PEGASUSSchemaPEGASUSKGQAExecution *)self attributes];
  if (v8)
  {
    v9 = v8;
    v10 = [(PEGASUSSchemaPEGASUSKGQAExecution *)self attributes];
    v11 = [v4 attributes];
    v12 = [v10 isEqual:v11];
  ...
  v6 = [(PEGASUSSchemaPEGASUSKGQAExecution *)self nlgKey];
  v7 = [v4 nlgKey];
  if ((v6 != 0) == (v7 == 0))
  {
LABEL_17:
  ...
  v15 = [(PEGASUSSchemaPEGASUSKGQAExecution *)self nlgKey];
  if (v15)
  {
    v16 = v15;
...
- (void)writeTo:(id)a3
{
  ...
  v10 = [(PEGASUSSchemaPEGASUSKGQAExecution *)self nlgKey];
