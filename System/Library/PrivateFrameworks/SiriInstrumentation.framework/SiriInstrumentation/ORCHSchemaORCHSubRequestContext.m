...
- (id)dictionaryRepresentation
{
  ...
  if (self->_ended)
  {
    v4 = [(ORCHSchemaORCHSubRequestContext *)self ended];
  ...
  if (self->_failed)
  {
    v7 = [(ORCHSchemaORCHSubRequestContext *)self failed];
...
- (BOOL)isEqual:(id)a3
{
  ...
  v8 = [(ORCHSchemaORCHSubRequestContext *)self subRequestId];
  if (v8)
  {
    v9 = v8;
  ...
  v13 = [(ORCHSchemaORCHSubRequestContext *)self startedOrChanged];
  if (v13)
  {
    v14 = v13;
  ...
  v18 = [(ORCHSchemaORCHSubRequestContext *)self failed];
  if (v18)
  {
    v19 = v18;
  ...
  if ((v6 != 0) != (v7 == 0))
  {
    v23 = [(ORCHSchemaORCHSubRequestContext *)self ended];
    if (!v23)
    {
...
{
  v13 = a3;
  v4 = [(ORCHSchemaORCHSubRequestContext *)self subRequestId];

  if (v4)
  {
    v5 = [(ORCHSchemaORCHSubRequestContext *)self subRequestId];
  ...
  if (v6)
  {
    v7 = [(ORCHSchemaORCHSubRequestContext *)self startedOrChanged];
    PBDataWriterWriteSubmessage();
  }

  v8 = [(ORCHSchemaORCHSubRequestContext *)self failed];
  ...
  if (v10)
  {
    v12 = [(ORCHSchemaORCHSubRequestContext *)self ended];
    PBDataWriterWriteSubmessage();
