...
- (NSData)jsonData;
- (STSchemaSTLLMQURequestStarted)initWithDictionary:(id)dictionary;
- (STSchemaSTLLMQURequestStarted)initWithJSON:(id)n;
...
- (STSchemaSTLLMQURequestStarted)initWithDictionary:(id)dictionary
{
  ...
  v9.receiver = self;
  v9.super_class = STSchemaSTLLMQURequestStarted;
...
- (NSData)jsonData
{
  dictionaryRepresentation = [(STSchemaSTLLMQURequestStarted *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  if (*(&self->_exists + 1))
  {
    v4 = [MEMORY[0x1E696AD98] numberWithBool:{-[STSchemaSTLLMQURequestStarted exists](self, "exists")}];
