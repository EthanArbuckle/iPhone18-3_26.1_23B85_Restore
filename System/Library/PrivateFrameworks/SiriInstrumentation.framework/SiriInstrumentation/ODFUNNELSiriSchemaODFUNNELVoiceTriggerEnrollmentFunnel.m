...
- (id)dictionaryRepresentation
{
  ...
  {
    v12 = [(ODFUNNELSiriSchemaODFUNNELVoiceTriggerEnrollmentFunnel *)self fixedDimensions];
...
- (BOOL)isEqual:(id)a3
{
  ...
  v7 = [(ODFUNNELSiriSchemaODFUNNELVoiceTriggerEnrollmentFunnel *)self fixedDimensions];
  if (v7)
  {
    v8 = v7;
    v9 = [(ODFUNNELSiriSchemaODFUNNELVoiceTriggerEnrollmentFunnel *)self fixedDimensions];
  ...
  if ((v5 != 0) != (v6 == 0))
  {
    v12 = [(ODFUNNELSiriSchemaODFUNNELVoiceTriggerEnrollmentFunnel *)self digests];
    if (!v12)
    {
...
LABEL_15:
    ...
    v13 = v12;
    v14 = [(ODFUNNELSiriSchemaODFUNNELVoiceTriggerEnrollmentFunnel *)self digests];
    v15 = [v4 digests];
    v16 = [v14 isEqual:v15];
