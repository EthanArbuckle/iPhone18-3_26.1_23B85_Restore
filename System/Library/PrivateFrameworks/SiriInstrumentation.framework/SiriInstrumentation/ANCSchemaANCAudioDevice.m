...
- (id)dictionaryRepresentation
{
  ...
  {
    v4 = [(ANCSchemaANCAudioDevice *)self productIdentifier];
    v5 = [v4 copy];
...
- (BOOL)isEqual:(id)a3
{
  ...
  v7 = [(ANCSchemaANCAudioDevice *)self vendorIdentifier];
  if (v7)
  {
    v8 = v7;
  ...
  if ((v5 != 0) != (v6 == 0))
  {
    v12 = [(ANCSchemaANCAudioDevice *)self productIdentifier];
    if (!v12)
    {
...
{
  v6 = a3;
  v4 = [(ANCSchemaANCAudioDevice *)self vendorIdentifier];
