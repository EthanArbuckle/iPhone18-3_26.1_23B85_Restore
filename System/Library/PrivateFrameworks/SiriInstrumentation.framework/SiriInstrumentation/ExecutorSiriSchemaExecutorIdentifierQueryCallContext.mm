...
- (ExecutorSiriSchemaExecutorIdentifierQueryCallContext)initWithDictionary:(id)dictionary;
- (ExecutorSiriSchemaExecutorIdentifierQueryCallContext)initWithJSON:(id)n;
...
- (NSData)jsonData
{
  dictionaryRepresentation = [(ExecutorSiriSchemaExecutorIdentifierQueryCallContext *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  if (self->_ended)
  {
    ended = [(ExecutorSiriSchemaExecutorIdentifierQueryCallContext *)self ended];
  ...
  if (self->_failed)
  {
    failed = [(ExecutorSiriSchemaExecutorIdentifierQueryCallContext *)self failed];
  ...
  {
    startedOrChanged = [(ExecutorSiriSchemaExecutorIdentifierQueryCallContext *)self startedOrChanged];
...
- (BOOL)isEqual:(id)equal
{
  ...
  startedOrChanged3 = [(ExecutorSiriSchemaExecutorIdentifierQueryCallContext *)self startedOrChanged];
  if (startedOrChanged3)
  {
    v9 = startedOrChanged3;
    startedOrChanged4 = [(ExecutorSiriSchemaExecutorIdentifierQueryCallContext *)self startedOrChanged];
  ...
  startedOrChanged = [(ExecutorSiriSchemaExecutorIdentifierQueryCallContext *)self ended];
  ...
  {
    v14 = ended;
    ended2 = [(ExecutorSiriSchemaExecutorIdentifierQueryCallContext *)self ended];
  ...
  startedOrChanged = [(ExecutorSiriSchemaExecutorIdentifierQueryCallContext *)self failed];
...
LABEL_21:
    ...
    v19 = failed;
    failed2 = [(ExecutorSiriSchemaExecutorIdentifierQueryCallContext *)self failed];
...
- (void)writeTo:(id)to
{
  ...
  if (startedOrChanged)
  {
    startedOrChanged2 = [(ExecutorSiriSchemaExecutorIdentifierQueryCallContext *)self startedOrChanged];
