...
- (id)dictionaryRepresentation
{
  ...
  if (self->_counts)
  {
    v4 = [(ODDSiriSchemaODDAssistantCarPlayDigest *)self counts];
  ...
  if (self->_dimensions)
  {
    v7 = [(ODDSiriSchemaODDAssistantCarPlayDigest *)self dimensions];
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ((v5 != 0) != (v6 == 0))
  {
    v12 = [(ODDSiriSchemaODDAssistantCarPlayDigest *)self counts];
    if (!v12)
    {
...
{
  v8 = a3;
  v4 = [(ODDSiriSchemaODDAssistantCarPlayDigest *)self dimensions];
  ...
  if (v6)
  {
    v7 = [(ODDSiriSchemaODDAssistantCarPlayDigest *)self counts];
    PBDataWriterWriteSubmessage();
  }
}
