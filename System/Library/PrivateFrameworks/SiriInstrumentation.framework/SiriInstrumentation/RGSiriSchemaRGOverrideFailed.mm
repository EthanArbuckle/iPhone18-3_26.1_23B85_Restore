...
- (id)dictionaryRepresentation
{
  ...
  if (self->_error)
  {
    v4 = [(RGSiriSchemaRGOverrideFailed *)self error];
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ([v4 isMemberOfClass:objc_opt_class()])
  {
    if ((*&self->_has & 1) == (v4[24] & 1))
    {
      ...
      {
        v6 = [(RGSiriSchemaRGOverrideFailed *)self error];
        v7 = [v4 error];
        v8 = v7;
        if ((v6 != 0) != (v7 == 0))
        {
          v9 = [(RGSiriSchemaRGOverrideFailed *)self error];
          if (!v9)
          {
...
LABEL_13:
          ...
          v10 = v9;
          v11 = [(RGSiriSchemaRGOverrideFailed *)self error];
          v12 = [v4 error];
          v13 = [v11 isEqual:v12];
