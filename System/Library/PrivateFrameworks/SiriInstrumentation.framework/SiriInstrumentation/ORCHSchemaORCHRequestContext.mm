...
- (ORCHSchemaORCHRequestContext)initWithDictionary:(id)dictionary;
- (ORCHSchemaORCHRequestContext)initWithJSON:(id)n;
...
- (ORCHSchemaORCHRequestContext)initWithDictionary:(id)dictionary
{
  ...
  v16.receiver = self;
  v16.super_class = ORCHSchemaORCHRequestContext;
  ...
  if (v5)
  {
    ...
    if (objc_opt_isKindOfClass())
    {
      v11 = [[ORCHSchemaORCHRequestFailed alloc] initWithDictionary:v10];
...
- (NSData)jsonData
{
  dictionaryRepresentation = [(ORCHSchemaORCHRequestContext *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  if (self->_cancelled)
  {
    cancelled = [(ORCHSchemaORCHRequestContext *)self cancelled];
  ...
  if (self->_ended)
  {
    ended = [(ORCHSchemaORCHRequestContext *)self ended];
  ...
  if (self->_failed)
  {
    failed = [(ORCHSchemaORCHRequestContext *)self failed];
  ...
  {
    startedOrChanged = [(ORCHSchemaORCHRequestContext *)self startedOrChanged];
...
- (unint64_t)hash
{
  v3 = [(ORCHSchemaORCHRequestStarted *)self->_startedOrChanged hash];
  v4 = [(ORCHSchemaORCHRequestEnded *)self->_ended hash]^ v3;
  v5 = [(ORCHSchemaORCHRequestFailed *)self->_failed hash];
...
- (BOOL)isEqual:(id)equal
{
  ...
  startedOrChanged3 = [(ORCHSchemaORCHRequestContext *)self startedOrChanged];
  if (startedOrChanged3)
  {
    v9 = startedOrChanged3;
    startedOrChanged4 = [(ORCHSchemaORCHRequestContext *)self startedOrChanged];
  ...
  startedOrChanged = [(ORCHSchemaORCHRequestContext *)self ended];
  ...
  {
    v14 = ended;
    ended2 = [(ORCHSchemaORCHRequestContext *)self ended];
  ...
  startedOrChanged = [(ORCHSchemaORCHRequestContext *)self failed];
  ...
  {
    v19 = failed;
    failed2 = [(ORCHSchemaORCHRequestContext *)self failed];
  ...
  startedOrChanged = [(ORCHSchemaORCHRequestContext *)self cancelled];
...
LABEL_26:
    ...
    v24 = cancelled;
    cancelled2 = [(ORCHSchemaORCHRequestContext *)self cancelled];
...
- (void)writeTo:(id)to
{
  ...
  if (startedOrChanged)
  {
    startedOrChanged2 = [(ORCHSchemaORCHRequestContext *)self startedOrChanged];
...
- (id)applySensitiveConditionsPolicy:(id)policy
{
  policyCopy = policy;
  v19.receiver = self;
  v19.super_class = ORCHSchemaORCHRequestContext;
