...
- (MHSchemaMHAssistantDaemonAudioRecordingLastBufferContext)initWithDictionary:(id)dictionary;
- (MHSchemaMHAssistantDaemonAudioRecordingLastBufferContext)initWithJSON:(id)n;
...
- (NSData)jsonData
{
  dictionaryRepresentation = [(MHSchemaMHAssistantDaemonAudioRecordingLastBufferContext *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  if (self->_ended)
  {
    ended = [(MHSchemaMHAssistantDaemonAudioRecordingLastBufferContext *)self ended];
  ...
  {
    startedOrChanged = [(MHSchemaMHAssistantDaemonAudioRecordingLastBufferContext *)self startedOrChanged];
...
- (BOOL)isEqual:(id)equal
{
  ...
  startedOrChanged3 = [(MHSchemaMHAssistantDaemonAudioRecordingLastBufferContext *)self startedOrChanged];
  if (startedOrChanged3)
  {
    v9 = startedOrChanged3;
    startedOrChanged4 = [(MHSchemaMHAssistantDaemonAudioRecordingLastBufferContext *)self startedOrChanged];
  ...
  startedOrChanged = [(MHSchemaMHAssistantDaemonAudioRecordingLastBufferContext *)self ended];
...
LABEL_16:
    ...
    v14 = ended;
    ended2 = [(MHSchemaMHAssistantDaemonAudioRecordingLastBufferContext *)self ended];
...
- (void)writeTo:(id)to
{
  ...
  if (startedOrChanged)
  {
    startedOrChanged2 = [(MHSchemaMHAssistantDaemonAudioRecordingLastBufferContext *)self startedOrChanged];
