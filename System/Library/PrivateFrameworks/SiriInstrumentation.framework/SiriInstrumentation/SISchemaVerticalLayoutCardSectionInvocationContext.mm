...
- (id)dictionaryRepresentation
{
  ...
  {
    v4 = [(SISchemaVerticalLayoutCardSectionInvocationContext *)self resultIdentifier];
    v5 = [v4 copy];
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ([v4 isMemberOfClass:objc_opt_class()])
  {
    ...
    if ((v5 != 0) != (v6 == 0))
    {
      v8 = [(SISchemaVerticalLayoutCardSectionInvocationContext *)self resultIdentifier];
      if (!v8)
      {
...
LABEL_10:
      ...
      v9 = v8;
      v10 = [(SISchemaVerticalLayoutCardSectionInvocationContext *)self resultIdentifier];
