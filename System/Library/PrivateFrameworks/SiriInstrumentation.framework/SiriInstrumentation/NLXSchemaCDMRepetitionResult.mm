...
- (NLXSchemaCDMRepetitionResult)initWithDictionary:(id)dictionary;
- (NLXSchemaCDMRepetitionResult)initWithJSON:(id)n;
- (NSData)jsonData;
...
- (NLXSchemaCDMRepetitionResult)initWithDictionary:(id)dictionary
{
  ...
  if (v5)
  {
    ...
    v7 = [dictionaryCopy objectForKeyedSubscript:@"repetitionType"];
    objc_opt_class();
    if (objc_opt_isKindOfClass())
    {
...
- (NSData)jsonData
{
  dictionaryRepresentation = [(NLXSchemaCDMRepetitionResult *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  if ((has & 2) != 0)
  {
    ...
    [dictionary setObject:v7 forKeyedSubscript:@"repetitionType"];
  }
