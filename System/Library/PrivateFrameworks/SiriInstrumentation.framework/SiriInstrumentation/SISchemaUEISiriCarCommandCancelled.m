...
- (BOOL)isEqual:(id)a3
{
  ...
  if ([v4 isMemberOfClass:objc_opt_class()])
  {
    ...
    {
      if (!*(&self->_isSiriDigitalCarKeyRequest + 1) || (isSiriDigitalCarKeyRequest = self->_isSiriDigitalCarKeyRequest, isSiriDigitalCarKeyRequest == [v4 isSiriDigitalCarKeyRequest]))
      {
        v6 = 1;
      }
    }
