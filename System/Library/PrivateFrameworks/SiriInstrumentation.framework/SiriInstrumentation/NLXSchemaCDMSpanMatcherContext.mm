...
- (id)dictionaryRepresentation
{
  ...
  if (self->_contextId)
  {
    v4 = [(NLXSchemaCDMSpanMatcherContext *)self contextId];
  ...
  if (self->_ended)
  {
    v7 = [(NLXSchemaCDMSpanMatcherContext *)self ended];
...
- (BOOL)isEqual:(id)a3
{
  ...
  v8 = [(NLXSchemaCDMSpanMatcherContext *)self contextId];
  if (v8)
  {
    v9 = v8;
  ...
  v13 = [(NLXSchemaCDMSpanMatcherContext *)self startedOrChanged];
  if (v13)
  {
    v14 = v13;
  ...
  if ((v6 != 0) != (v7 == 0))
  {
    v18 = [(NLXSchemaCDMSpanMatcherContext *)self ended];
    if (!v18)
    {
...
- (void)writeTo:(id)a3
{
  ...
  if (v6)
  {
    v7 = [(NLXSchemaCDMSpanMatcherContext *)self startedOrChanged];
    PBDataWriterWriteSubmessage();
  }

  v8 = [(NLXSchemaCDMSpanMatcherContext *)self ended];

  v9 = v11;
  if (v8)
  {
    v10 = [(NLXSchemaCDMSpanMatcherContext *)self ended];
    PBDataWriterWriteSubmessage();
