...
- (CNVSchemaCNVIntentEagerExecutionCancelled)initWithDictionary:(id)dictionary;
- (CNVSchemaCNVIntentEagerExecutionCancelled)initWithJSON:(id)n;
- (NSData)jsonData;
...
- (CNVSchemaCNVIntentEagerExecutionCancelled)initWithDictionary:(id)dictionary
{
  ...
  if (v5)
  {
    v6 = [dictionaryCopy objectForKeyedSubscript:@"cancellationReason"];
    objc_opt_class();
...
- (NSData)jsonData
{
  dictionaryRepresentation = [(CNVSchemaCNVIntentEagerExecutionCancelled *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  if (*&self->_has)
  {
    ...
    [dictionary setObject:v5 forKeyedSubscript:@"cancellationReason"];
  }
...
- (BOOL)isEqual:(id)equal
{
  ...
  if ([equalCopy isMemberOfClass:objc_opt_class()])
  {
    ...
    {
      if ((*&self->_has & 1) == 0 || (cancellationReason = self->_cancellationReason, cancellationReason == [equalCopy cancellationReason]))
      {
        v6 = 1;
      }
    }
