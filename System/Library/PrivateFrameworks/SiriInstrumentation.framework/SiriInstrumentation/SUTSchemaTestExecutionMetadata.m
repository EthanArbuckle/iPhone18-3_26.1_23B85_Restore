...
- (id)dictionaryRepresentation
{
  ...
  {
    v4 = [(SUTSchemaTestExecutionMetadata *)self fingerprint];
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ([v4 isMemberOfClass:objc_opt_class()])
  {
    ...
    if ((v5 != 0) != (v6 == 0))
    {
      v8 = [(SUTSchemaTestExecutionMetadata *)self fingerprint];
      if (!v8)
      {
...
LABEL_10:
      ...
      v9 = v8;
      v10 = [(SUTSchemaTestExecutionMetadata *)self fingerprint];
      v11 = [v4 fingerprint];
      v12 = [v10 isEqual:v11];
