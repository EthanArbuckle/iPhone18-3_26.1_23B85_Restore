...
- (NSData)jsonData;
- (POMMESSchemaPOMMESProfileSliceResolutionRequestStarted)initWithDictionary:(id)dictionary;
- (POMMESSchemaPOMMESProfileSliceResolutionRequestStarted)initWithJSON:(id)n;
...
- (POMMESSchemaPOMMESProfileSliceResolutionRequestStarted)initWithDictionary:(id)dictionary
{
  ...
  if (v5)
  {
    v6 = [dictionaryCopy objectForKeyedSubscript:@"sliceLabel"];
    objc_opt_class();
...
- (NSData)jsonData
{
  dictionaryRepresentation = [(POMMESSchemaPOMMESProfileSliceResolutionRequestStarted *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  if (*&self->_has)
  {
    ...
    [dictionary setObject:v4 forKeyedSubscript:@"sliceLabel"];
  }
...
- (BOOL)isEqual:(id)equal
{
  ...
  if ([equalCopy isMemberOfClass:objc_opt_class()])
  {
    ...
    {
      if ((*&self->_has & 1) == 0 || (sliceLabel = self->_sliceLabel, sliceLabel == [equalCopy sliceLabel]))
      {
        v6 = 1;
      }
    }
