...
- (BOOL)isEqual:(id)a3;
- (NSData)jsonData;
- (STSchemaSTFailureError)initWithDictionary:(id)a3;
- (STSchemaSTFailureError)initWithJSON:(id)a3;
...
- (NSData)jsonData
{
  v2 = [(STSchemaSTFailureError *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  if (self->_domain)
  {
    v5 = [(STSchemaSTFailureError *)self domain];
    v6 = [v5 copy];
...
LABEL_12:
  ...
  v8 = [(STSchemaSTFailureError *)self domain];
  if (v8)
  {
    v9 = v8;
    v10 = [(STSchemaSTFailureError *)self domain];
    v11 = [v4 domain];
    v12 = [v10 isEqual:v11];
...
{
  v5 = a3;
  v4 = [(STSchemaSTFailureError *)self domain];
