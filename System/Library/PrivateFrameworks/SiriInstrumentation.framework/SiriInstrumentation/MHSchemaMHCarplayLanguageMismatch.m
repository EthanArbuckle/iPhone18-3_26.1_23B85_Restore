...
- (id)dictionaryRepresentation
{
  ...
  {
    v4 = [(MHSchemaMHCarplayLanguageMismatch *)self carHeadUnitSelectedLocale];
    v5 = [v4 copy];
...
- (BOOL)isEqual:(id)a3
{
  ...
  v6 = [v4 carHeadUnitSelectedLocale];
  v7 = v6;
  if ((v5 != 0) == (v6 == 0))
  {
...
LABEL_12:
  ...
  v8 = [(MHSchemaMHCarplayLanguageMismatch *)self carHeadUnitSelectedLocale];
  if (v8)
  {
    v9 = v8;
    v10 = [(MHSchemaMHCarplayLanguageMismatch *)self carHeadUnitSelectedLocale];
    v11 = [v4 carHeadUnitSelectedLocale];
    v12 = [v10 isEqual:v11];
