...
- (id)dictionaryRepresentation
{
  ...
  {
    v4 = [(STSchemaSTClientEventMetadata *)self searchToolId];
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ([v4 isMemberOfClass:objc_opt_class()])
  {
    ...
    if ((v5 != 0) != (v6 == 0))
    {
      v8 = [(STSchemaSTClientEventMetadata *)self searchToolId];
      if (!v8)
      {
...
LABEL_10:
      ...
      v9 = v8;
      v10 = [(STSchemaSTClientEventMetadata *)self searchToolId];
      v11 = [v4 searchToolId];
      v12 = [v10 isEqual:v11];
