...
- (BOOL)isEqual:(id)a3
{
  ...
  if ([v4 isMemberOfClass:objc_opt_class()])
  {
    ...
    v6 = [v4 metadataTier1s];
    v7 = v6;
    if ((v5 != 0) != (v6 == 0))
    {
      v8 = [(CNVSchemaCNVActionCandidatesGeneratedTier1 *)self metadataTier1s];
      if (!v8)
      {
...
LABEL_10:
      ...
      v9 = v8;
      v10 = [(CNVSchemaCNVActionCandidatesGeneratedTier1 *)self metadataTier1s];
      v11 = [v4 metadataTier1s];
      v12 = [v10 isEqual:v11];
