...
- (ASRSchemaASRManualEditClassificationFailed)initWithDictionary:(id)dictionary;
- (ASRSchemaASRManualEditClassificationFailed)initWithJSON:(id)n;
...
- (NSData)jsonData
{
  dictionaryRepresentation = [(ASRSchemaASRManualEditClassificationFailed *)self dictionaryRepresentation];
