...
- (GATSchemaGATRegisterMediaEventEnded)initWithDictionary:(id)dictionary;
- (GATSchemaGATRegisterMediaEventEnded)initWithJSON:(id)n;
- (NSData)jsonData;
...
- (GATSchemaGATRegisterMediaEventEnded)initWithDictionary:(id)dictionary
{
  ...
  v9.receiver = self;
  v9.super_class = GATSchemaGATRegisterMediaEventEnded;
...
- (NSData)jsonData
{
  dictionaryRepresentation = [(GATSchemaGATRegisterMediaEventEnded *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  if (*(&self->_exist + 1))
  {
    v4 = [MEMORY[0x1E696AD98] numberWithBool:{-[GATSchemaGATRegisterMediaEventEnded exist](self, "exist")}];
