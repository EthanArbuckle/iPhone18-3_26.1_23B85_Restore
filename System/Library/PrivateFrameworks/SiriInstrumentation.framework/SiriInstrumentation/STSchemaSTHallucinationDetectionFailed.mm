...
- (NSData)jsonData;
- (STSchemaSTHallucinationDetectionFailed)initWithDictionary:(id)dictionary;
- (STSchemaSTHallucinationDetectionFailed)initWithJSON:(id)n;
...
- (NSData)jsonData
{
  dictionaryRepresentation = [(STSchemaSTHallucinationDetectionFailed *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  if (*&self->_has)
  {
    ...
    [dictionary setObject:@"STHALLUCINATIONDETECTIONFAILUREREASON_UNKNOWN" forKeyedSubscript:@"reason"];
  }

  if (self->_stError)
  {
    stError = [(STSchemaSTHallucinationDetectionFailed *)self stError];
  ...
  if ([equalCopy isMemberOfClass:objc_opt_class()])
  {
    if ((*&self->_has & 1) == (equalCopy[24] & 1))
    {
      if ((*&self->_has & 1) == 0 || (reason = self->_reason, reason == [equalCopy reason]))
      {
        ...
        {
          stError3 = [(STSchemaSTHallucinationDetectionFailed *)self stError];
          if (!stError3)
          {
...
LABEL_13:
          ...
          v10 = stError3;
          stError4 = [(STSchemaSTHallucinationDetectionFailed *)self stError];
...
- (void)writeTo:(id)to
{
  ...
  if (stError)
  {
    stError2 = [(STSchemaSTHallucinationDetectionFailed *)self stError];
