...
- (BOOL)isEqual:(id)a3
{
  ...
  if ([v4 isMemberOfClass:objc_opt_class()])
  {
    ...
    v6 = [v4 actionCandidates];
    v7 = v6;
    if ((v5 != 0) != (v6 == 0))
    {
      v8 = [(CNVSchemaCNVActionCandidatesGenerated *)self actionCandidates];
      if (!v8)
      {
...
LABEL_10:
      ...
      v9 = v8;
      v10 = [(CNVSchemaCNVActionCandidatesGenerated *)self actionCandidates];
      v11 = [v4 actionCandidates];
      v12 = [v10 isEqual:v11];
