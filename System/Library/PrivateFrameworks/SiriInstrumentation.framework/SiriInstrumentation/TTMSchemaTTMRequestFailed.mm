...
- (NSData)jsonData;
- (TTMSchemaTTMRequestFailed)initWithDictionary:(id)dictionary;
- (TTMSchemaTTMRequestFailed)initWithJSON:(id)n;
...
- (TTMSchemaTTMRequestFailed)initWithDictionary:(id)dictionary
{
  ...
  v9.receiver = self;
  v9.super_class = TTMSchemaTTMRequestFailed;
...
- (NSData)jsonData
{
  dictionaryRepresentation = [(TTMSchemaTTMRequestFailed *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  if (*&self->_has)
  {
    v4 = [(TTMSchemaTTMRequestFailed *)self reason]- 1;
    if (v4 > 3)
    {
