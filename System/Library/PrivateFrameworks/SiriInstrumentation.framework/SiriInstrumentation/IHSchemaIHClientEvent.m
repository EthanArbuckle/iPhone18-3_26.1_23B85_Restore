...
- (IHSchemaIHClientEvent)initWithDictionary:(id)a3
{
  ...
  if (v5)
  {
    ...
    v8 = [v4 objectForKeyedSubscript:@"modelEvaluationContext"];
    objc_opt_class();
    if (objc_opt_isKindOfClass())
    {
...
- (id)dictionaryRepresentation
{
  ...
  {
    v4 = [(IHSchemaIHClientEvent *)self eventMetadata];
  ...
  {
    v7 = [(IHSchemaIHClientEvent *)self modelEvaluationContext];
...
- (BOOL)isEqual:(id)a3
{
  ...
  v6 = [(IHSchemaIHClientEvent *)self eventMetadata];
  v7 = [v4 eventMetadata];
  if ((v6 != 0) == (v7 == 0))
  {
    goto LABEL_12;
  ...
  v8 = [(IHSchemaIHClientEvent *)self eventMetadata];
  if (v8)
  {
    v9 = v8;
  ...
  v6 = [(IHSchemaIHClientEvent *)self modelEvaluationContext];
  v7 = [v4 modelEvaluationContext];
  if ((v6 != 0) != (v7 == 0))
  {
    v13 = [(IHSchemaIHClientEvent *)self modelEvaluationContext];
    if (!v13)
    {
