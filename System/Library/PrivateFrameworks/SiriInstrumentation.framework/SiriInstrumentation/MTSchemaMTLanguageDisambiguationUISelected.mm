...
- (MTSchemaMTLanguageDisambiguationUISelected)initWithDictionary:(id)dictionary;
- (MTSchemaMTLanguageDisambiguationUISelected)initWithJSON:(id)n;
- (NSData)jsonData;
...
- (MTSchemaMTLanguageDisambiguationUISelected)initWithDictionary:(id)dictionary
{
  ...
  v9.receiver = self;
  v9.super_class = MTSchemaMTLanguageDisambiguationUISelected;
...
- (NSData)jsonData
{
  dictionaryRepresentation = [(MTSchemaMTLanguageDisambiguationUISelected *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  if (*&self->_has)
  {
    v4 = [(MTSchemaMTLanguageDisambiguationUISelected *)self locale]- 1;
    if (v4 > 0x3D)
    {
...
- (BOOL)isEqual:(id)equal
{
  ...
  if ([equalCopy isMemberOfClass:objc_opt_class()])
  {
    ...
    {
      if ((*&self->_has & 1) == 0 || (locale = self->_locale, locale == [equalCopy locale]))
      {
        v6 = 1;
      }
    }
