...
- (ODDSiriSchemaODDGmsAssetAvailabilityStatus)initWithDictionary:(id)dictionary
{
  ...
  if (v5)
  {
    ...
    if (objc_opt_isKindOfClass())
    {
      -[ODDSiriSchemaODDGmsAssetAvailabilityStatus setStatusMessage:](v5, "setStatusMessage:", [v7 unsignedLongLongValue]);
    }
...
- (unint64_t)hash
{
  if (*&self->_has)
  {
    v2 = 2654435761u * self->_timestampInSecondsSince1970;
    if ((*&self->_has & 2) != 0)
    {
      goto LABEL_3;
    }
...
LABEL_3:
  v3 = 2654435761u * self->_statusMessage;
  return v3 ^ v2;
}
