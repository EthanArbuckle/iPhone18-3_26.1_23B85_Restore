...
- (ASRSpeechProfileSchemaASRSpeechProfileClientEvent)initWithDictionary:(id)a3;
- (ASRSpeechProfileSchemaASRSpeechProfileClientEvent)initWithJSON:(id)a3;
...
- (void)setSpeechProfileUpdateContext:(id)a3;
- (void)writeTo:(id)a3;
@end
...
- (ASRSpeechProfileSchemaASRSpeechProfileClientEvent)initWithDictionary:(id)a3
{
  ...
  if (v5)
  {
    ...
    v8 = [v4 objectForKeyedSubscript:@"speechProfileUpdateContext"];
    objc_opt_class();
    if (objc_opt_isKindOfClass())
    {
...
- (NSData)jsonData
{
  v2 = [(ASRSpeechProfileSchemaASRSpeechProfileClientEvent *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  {
    v4 = [(ASRSpeechProfileSchemaASRSpeechProfileClientEvent *)self eventMetadata];
  ...
  {
    v7 = [(ASRSpeechProfileSchemaASRSpeechProfileClientEvent *)self speechProfileUpdateContext];
    v8 = [v7 dictionaryRepresentation];
    if (v8)
    {
      [v3 setObject:v8 forKeyedSubscript:@"speechProfileUpdateContext"];
    }

    else
    {
      v9 = [MEMORY[0x1E695DFB0] null];
      [v3 setObject:v9 forKeyedSubscript:@"speechProfileUpdateContext"];
    }
  }
...
- (BOOL)isEqual:(id)a3
{
  ...
  v6 = [(ASRSpeechProfileSchemaASRSpeechProfileClientEvent *)self eventMetadata];
  v7 = [v4 eventMetadata];
  if ((v6 != 0) == (v7 == 0))
  {
    goto LABEL_12;
  ...
  v8 = [(ASRSpeechProfileSchemaASRSpeechProfileClientEvent *)self eventMetadata];
  if (v8)
  {
    v9 = v8;
    v10 = [(ASRSpeechProfileSchemaASRSpeechProfileClientEvent *)self eventMetadata];
  ...
  v6 = [(ASRSpeechProfileSchemaASRSpeechProfileClientEvent *)self speechProfileUpdateContext];
  v7 = [v4 speechProfileUpdateContext];
  if ((v6 != 0) != (v7 == 0))
  {
    v13 = [(ASRSpeechProfileSchemaASRSpeechProfileClientEvent *)self speechProfileUpdateContext];
    if (!v13)
    {
...
LABEL_16:
    ...
    v14 = v13;
    v15 = [(ASRSpeechProfileSchemaASRSpeechProfileClientEvent *)self speechProfileUpdateContext];
    v16 = [v4 speechProfileUpdateContext];
    v17 = [v15 isEqual:v16];
...
- (void)writeTo:(id)a3
{
  ...
  if (v4)
  {
    v5 = [(ASRSpeechProfileSchemaASRSpeechProfileClientEvent *)self eventMetadata];
...
- (void)setSpeechProfileUpdateContext:(id)a3
{
  ...
  objc_storeStrong(&self->_speechProfileUpdateContext, a3);
}
...
- (id)applySensitiveConditionsPolicy:(id)a3
{
  ...
  v9 = [(ASRSpeechProfileSchemaASRSpeechProfileClientEvent *)self speechProfileUpdateContext];
