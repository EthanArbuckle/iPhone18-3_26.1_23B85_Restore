...
- (CNVSchemaCNVFlowPluginLoadContextEnded)initWithDictionary:(id)dictionary;
- (CNVSchemaCNVFlowPluginLoadContextEnded)initWithJSON:(id)n;
- (NSData)jsonData;
...
- (NSData)jsonData
{
  dictionaryRepresentation = [(CNVSchemaCNVFlowPluginLoadContextEnded *)self dictionaryRepresentation];
