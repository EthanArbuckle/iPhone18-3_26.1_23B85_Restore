...
- (id)dictionaryRepresentation
{
  ...
  if (self->_identityId)
  {
    v4 = [(IDENTITYSchemaIDENTITYClientEventMetadata *)self identityId];
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ([v4 isMemberOfClass:objc_opt_class()])
  {
    ...
    if ((v5 != 0) != (v6 == 0))
    {
      v8 = [(IDENTITYSchemaIDENTITYClientEventMetadata *)self identityId];
      if (!v8)
      {
...
LABEL_10:
      ...
      v9 = v8;
      v10 = [(IDENTITYSchemaIDENTITYClientEventMetadata *)self identityId];
      v11 = [v4 identityId];
      v12 = [v10 isEqual:v11];
