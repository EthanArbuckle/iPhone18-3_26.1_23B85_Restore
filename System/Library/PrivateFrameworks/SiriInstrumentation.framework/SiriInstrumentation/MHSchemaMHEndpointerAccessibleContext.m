...
- (id)dictionaryRepresentation
{
  ...
  if (*&self->_has)
  {
    v4 = [(MHSchemaMHEndpointerAccessibleContext *)self accessibleEndpointerLevel];
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ([v4 isMemberOfClass:objc_opt_class()])
  {
    ...
    {
      if ((*&self->_has & 1) == 0 || (accessibleEndpointerLevel = self->_accessibleEndpointerLevel, accessibleEndpointerLevel == [v4 accessibleEndpointerLevel]))
      {
        v6 = 1;
      }
    }
