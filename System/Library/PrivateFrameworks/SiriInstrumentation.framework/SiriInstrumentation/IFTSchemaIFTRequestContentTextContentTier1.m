...
- (IFTSchemaIFTRequestContentTextContentTier1)initWithDictionary:(id)a3
{
  ...
  if (v5)
  {
    ...
    v8 = [v4 objectForKeyedSubscript:@"textQuery"];
    objc_opt_class();
    if (objc_opt_isKindOfClass())
    {
      v9 = [v8 copy];
...
- (id)dictionaryRepresentation
{
  ...
  if (self->_linkId)
  {
    v4 = [(IFTSchemaIFTRequestContentTextContentTier1 *)self linkId];
  ...
  if (self->_textQuery)
  {
    v7 = [(IFTSchemaIFTRequestContentTextContentTier1 *)self textQuery];
    v8 = [v7 copy];
...
- (BOOL)isEqual:(id)a3
{
  ...
  v7 = [(IFTSchemaIFTRequestContentTextContentTier1 *)self linkId];
  if (v7)
  {
    v8 = v7;
  ...
  if ((v5 != 0) != (v6 == 0))
  {
    v12 = [(IFTSchemaIFTRequestContentTextContentTier1 *)self textQuery];
    if (!v12)
    {
