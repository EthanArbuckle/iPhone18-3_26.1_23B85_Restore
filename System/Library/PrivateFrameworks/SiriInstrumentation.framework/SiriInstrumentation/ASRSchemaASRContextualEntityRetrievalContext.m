...
- (ASRSchemaASRContextualEntityRetrievalContext)initWithDictionary:(id)a3;
- (ASRSchemaASRContextualEntityRetrievalContext)initWithJSON:(id)a3;
...
- (NSData)jsonData
{
  v2 = [(ASRSchemaASRContextualEntityRetrievalContext *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  if (self->_ended)
  {
    v4 = [(ASRSchemaASRContextualEntityRetrievalContext *)self ended];
  ...
  {
    v7 = [(ASRSchemaASRContextualEntityRetrievalContext *)self startedOrChanged];
...
- (BOOL)isEqual:(id)a3
{
  ...
  v6 = [(ASRSchemaASRContextualEntityRetrievalContext *)self startedOrChanged];
  ...
  v8 = [(ASRSchemaASRContextualEntityRetrievalContext *)self startedOrChanged];
  if (v8)
  {
    v9 = v8;
    v10 = [(ASRSchemaASRContextualEntityRetrievalContext *)self startedOrChanged];
  ...
  v6 = [(ASRSchemaASRContextualEntityRetrievalContext *)self ended];
  v7 = [v4 ended];
  if ((v6 != 0) != (v7 == 0))
  {
    v13 = [(ASRSchemaASRContextualEntityRetrievalContext *)self ended];
    if (!v13)
    {
...
LABEL_16:
    ...
    v14 = v13;
    v15 = [(ASRSchemaASRContextualEntityRetrievalContext *)self ended];
    v16 = [v4 ended];
    v17 = [v15 isEqual:v16];
...
{
  v8 = a3;
  v4 = [(ASRSchemaASRContextualEntityRetrievalContext *)self startedOrChanged];

  if (v4)
  {
    v5 = [(ASRSchemaASRContextualEntityRetrievalContext *)self startedOrChanged];
  ...
  if (v6)
  {
    v7 = [(ASRSchemaASRContextualEntityRetrievalContext *)self ended];
    PBDataWriterWriteSubmessage();
  }
}
...
- (id)applySensitiveConditionsPolicy:(id)a3
{
  ...
  v9 = [(ASRSchemaASRContextualEntityRetrievalContext *)self ended];
