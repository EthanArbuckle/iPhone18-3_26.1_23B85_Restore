...
- (NSData)jsonData;
- (TTSSchemaTTSSpeechEnded)initWithDictionary:(id)dictionary;
- (TTSSchemaTTSSpeechEnded)initWithJSON:(id)n;
...
- (TTSSchemaTTSSpeechEnded)initWithDictionary:(id)dictionary
{
  ...
  v26.receiver = self;
  v26.super_class = TTSSchemaTTSSpeechEnded;
  ...
  if (v5)
  {
    ...
    {
      [v6 floatValue];
      [(TTSSchemaTTSSpeechEnded *)v5 setSynthesizedAudioDurationInSecond:?];
    }
    ...
    {
      [v7 floatValue];
      [(TTSSchemaTTSSpeechEnded *)v5 setSynthesisLatencyInSecond:?];
    }
    ...
    {
      [v8 floatValue];
      [(TTSSchemaTTSSpeechEnded *)v5 setSynthesisRealTimeFactor:?];
    }
...
- (NSData)jsonData
{
  dictionaryRepresentation = [(TTSSchemaTTSSpeechEnded *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  {
    errorCodes = [(TTSSchemaTTSSpeechEnded *)self errorCodes];
    v5 = [errorCodes copy];
  ...
  if ((has & 8) != 0)
  {
    v10 = [MEMORY[0x1E696AD98] numberWithUnsignedInt:{-[TTSSchemaTTSSpeechEnded promptCount](self, "promptCount")}];
    ...
    if (v12 == ((v6 >> 2) & 1))
    {
      ...
      if (v15 == ((v6 >> 3) & 1))
      {
        if (!v15 || (promptCount = self->_promptCount, promptCount == [equalCopy promptCount]))
        {
          ...
          {
            errorCodes3 = [(TTSSchemaTTSSpeechEnded *)self errorCodes];
            if (!errorCodes3)
            {
...
LABEL_25:
            ...
            v21 = errorCodes3;
            errorCodes4 = [(TTSSchemaTTSSpeechEnded *)self errorCodes];
