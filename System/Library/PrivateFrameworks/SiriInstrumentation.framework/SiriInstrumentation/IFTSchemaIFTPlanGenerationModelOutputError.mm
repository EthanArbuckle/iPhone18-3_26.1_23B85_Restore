...
- (id)dictionaryRepresentation
{
  ...
  if (self->_error)
  {
    v4 = [(IFTSchemaIFTPlanGenerationModelOutputError *)self error];
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ([v4 isMemberOfClass:objc_opt_class()])
  {
    ...
    if ((v5 != 0) != (v6 == 0))
    {
      v8 = [(IFTSchemaIFTPlanGenerationModelOutputError *)self error];
      if (!v8)
      {
...
LABEL_10:
      ...
      v9 = v8;
      v10 = [(IFTSchemaIFTPlanGenerationModelOutputError *)self error];
      v11 = [v4 error];
      v12 = [v10 isEqual:v11];
