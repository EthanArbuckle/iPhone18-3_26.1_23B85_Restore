...
- (id)dictionaryRepresentation
{
  ...
  {
    v4 = [(SISchemaLinkedAccessoryState *)self accessoryId];
...
- (BOOL)isEqual:(id)a3
{
  ...
  v7 = [(SISchemaLinkedAccessoryState *)self accessoryId];
  if (v7)
  {
    v8 = v7;
    v9 = [(SISchemaLinkedAccessoryState *)self accessoryId];
    v10 = [v4 accessoryId];
    v11 = [v9 isEqual:v10];
  ...
  if ((v5 != 0) != (v6 == 0))
  {
    v12 = [(SISchemaLinkedAccessoryState *)self gradingOptInStateChanges];
    if (!v12)
    {
...
LABEL_15:
    ...
    v13 = v12;
    v14 = [(SISchemaLinkedAccessoryState *)self gradingOptInStateChanges];
