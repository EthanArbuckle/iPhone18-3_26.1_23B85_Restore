...
- (NLXSchemaCDMAllServicesSetupContext)initWithDictionary:(id)dictionary;
- (NLXSchemaCDMAllServicesSetupContext)initWithJSON:(id)n;
...
- (NSData)jsonData
{
  dictionaryRepresentation = [(NLXSchemaCDMAllServicesSetupContext *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  if (self->_ended)
  {
    ended = [(NLXSchemaCDMAllServicesSetupContext *)self ended];
  ...
  if (self->_failed)
  {
    failed = [(NLXSchemaCDMAllServicesSetupContext *)self failed];
  ...
  {
    startedOrChanged = [(NLXSchemaCDMAllServicesSetupContext *)self startedOrChanged];
...
- (BOOL)isEqual:(id)equal
{
  ...
  startedOrChanged3 = [(NLXSchemaCDMAllServicesSetupContext *)self startedOrChanged];
  if (startedOrChanged3)
  {
    v9 = startedOrChanged3;
    startedOrChanged4 = [(NLXSchemaCDMAllServicesSetupContext *)self startedOrChanged];
  ...
  startedOrChanged = [(NLXSchemaCDMAllServicesSetupContext *)self ended];
  ...
  {
    v14 = ended;
    ended2 = [(NLXSchemaCDMAllServicesSetupContext *)self ended];
  ...
  startedOrChanged = [(NLXSchemaCDMAllServicesSetupContext *)self failed];
...
LABEL_21:
    ...
    v19 = failed;
    failed2 = [(NLXSchemaCDMAllServicesSetupContext *)self failed];
...
- (void)writeTo:(id)to
{
  ...
  if (startedOrChanged)
  {
    startedOrChanged2 = [(NLXSchemaCDMAllServicesSetupContext *)self startedOrChanged];
