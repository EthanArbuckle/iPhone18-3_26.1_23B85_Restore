...
- (unint64_t)hash;
- (void)setHasPrimitiveType:(BOOL)a3;
- (void)writeTo:(id)a3;
@end
...
- (IFTSchemaIFTPrimitive)initWithDictionary:(id)a3
{
  ...
  if (v5)
  {
    ...
    v7 = [v4 objectForKeyedSubscript:@"primitiveType"];
    objc_opt_class();
    if (objc_opt_isKindOfClass())
    {
...
- (id)dictionaryRepresentation
{
  ...
  if ((has & 2) != 0)
  {
    ...
    [v3 setObject:v7 forKeyedSubscript:@"primitiveType"];
  }
...
LABEL_10:
  ...
  if (v8)
  {
    ...
    if (primitiveType != [v4 primitiveType])
    {
      goto LABEL_10;
    }
  }
