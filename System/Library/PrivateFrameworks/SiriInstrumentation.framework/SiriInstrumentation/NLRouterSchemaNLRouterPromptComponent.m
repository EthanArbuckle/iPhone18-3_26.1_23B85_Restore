...
- (BOOL)isEqual:(id)a3;
- (NLRouterSchemaNLRouterPromptComponent)initWithDictionary:(id)a3;
- (NLRouterSchemaNLRouterPromptComponent)initWithJSON:(id)a3;
- (NSData)jsonData;
- (id)dictionaryRepresentation;
- (id)suppressMessageUnderConditions;
- (unint64_t)hash;
- (void)setHasSizeInTokens:(BOOL)a3;
- (void)writeTo:(id)a3;
@end
...
- (NLRouterSchemaNLRouterPromptComponent)initWithDictionary:(id)a3
{
  ...
  if (v5)
  {
    v6 = [v4 objectForKeyedSubscript:@"componentType"];
    objc_opt_class();
    ...
    v7 = [v4 objectForKeyedSubscript:@"sizeInTokens"];
    objc_opt_class();
    if (objc_opt_isKindOfClass())
    {
...
- (NSData)jsonData
{
  v2 = [(NLRouterSchemaNLRouterPromptComponent *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  if (has)
  {
    ...
    [v3 setObject:v6 forKeyedSubscript:@"componentType"];
    has = self->_has;
  }
  ...
  if ((has & 2) != 0)
  {
    ...
    [v3 setObject:v7 forKeyedSubscript:@"sizeInTokens"];
  }
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (*&has)
  {
    ...
    if (componentType != [v4 componentType])
    {
LABEL_10:
      v10 = 0;
      goto LABEL_11;
  ...
  if (v8)
  {
    ...
    if (sizeInTokens != [v4 sizeInTokens])
    {
      goto LABEL_10;
    }
  }
