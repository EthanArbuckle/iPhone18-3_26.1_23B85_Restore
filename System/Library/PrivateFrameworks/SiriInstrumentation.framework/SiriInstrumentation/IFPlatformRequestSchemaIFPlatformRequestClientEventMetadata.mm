...
- (id)dictionaryRepresentation
{
  ...
  {
    v4 = [(IFPlatformRequestSchemaIFPlatformRequestClientEventMetadata *)self ifRequestId];
...
LABEL_12:
  ...
  v8 = [(IFPlatformRequestSchemaIFPlatformRequestClientEventMetadata *)self ifRequestId];
  if (v8)
  {
    v9 = v8;
