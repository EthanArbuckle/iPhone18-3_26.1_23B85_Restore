...
- (id)dictionaryRepresentation
{
  ...
  {
    v4 = [(PGSchemaPGPrescribedPlanFailed *)self criticalError];
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ([v4 isMemberOfClass:objc_opt_class()])
  {
    ...
    if ((v5 != 0) != (v6 == 0))
    {
      v8 = [(PGSchemaPGPrescribedPlanFailed *)self criticalError];
      if (!v8)
      {
...
LABEL_10:
      ...
      v9 = v8;
      v10 = [(PGSchemaPGPrescribedPlanFailed *)self criticalError];
