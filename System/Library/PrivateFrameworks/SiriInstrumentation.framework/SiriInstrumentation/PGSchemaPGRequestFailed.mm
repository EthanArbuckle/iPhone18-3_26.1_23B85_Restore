...
- (NSData)jsonData;
- (PGSchemaPGRequestFailed)initWithDictionary:(id)dictionary;
- (PGSchemaPGRequestFailed)initWithJSON:(id)n;
...
- (NSData)jsonData
{
  dictionaryRepresentation = [(PGSchemaPGRequestFailed *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  {
    criticalError = [(PGSchemaPGRequestFailed *)self criticalError];
...
- (BOOL)isEqual:(id)equal
{
  ...
  if ([equalCopy isMemberOfClass:objc_opt_class()])
  {
    ...
    {
      criticalError3 = [(PGSchemaPGRequestFailed *)self criticalError];
      if (!criticalError3)
      {
...
LABEL_10:
      ...
      v9 = criticalError3;
      criticalError4 = [(PGSchemaPGRequestFailed *)self criticalError];
...
- (void)writeTo:(id)to
{
  ...
  if (criticalError)
  {
    criticalError2 = [(PGSchemaPGRequestFailed *)self criticalError];
