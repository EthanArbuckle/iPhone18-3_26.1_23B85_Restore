...
- (BOOL)isEqual:(id)a3;
- (DODMLASRSchemaDODMLASRFullPayloadCorrectionExperimentInfoTier1)initWithDictionary:(id)a3;
- (DODMLASRSchemaDODMLASRFullPayloadCorrectionExperimentInfoTier1)initWithJSON:(id)a3;
- (NSData)jsonData;
...
- (DODMLASRSchemaDODMLASRFullPayloadCorrectionExperimentInfoTier1)initWithDictionary:(id)a3
{
  ...
  if (v5)
  {
    v6 = [v4 objectForKeyedSubscript:@"infoTier1"];
    objc_opt_class();
...
- (NSData)jsonData
{
  v2 = [(DODMLASRSchemaDODMLASRFullPayloadCorrectionExperimentInfoTier1 *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  if (self->_infoTier1)
  {
    v4 = [(DODMLASRSchemaDODMLASRFullPayloadCorrectionExperimentInfoTier1 *)self infoTier1];
    v5 = [v4 dictionaryRepresentation];
    if (v5)
    {
      [v3 setObject:v5 forKeyedSubscript:@"infoTier1"];
    }

    else
    {
      v6 = [MEMORY[0x1E695DFB0] null];
      [v3 setObject:v6 forKeyedSubscript:@"infoTier1"];
    }
  }
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    v5 = [(DODMLASRSchemaDODMLASRFullPayloadCorrectionExperimentInfoTier1 *)self infoTier1];
    v6 = [v4 infoTier1];
    v7 = v6;
    if ((v5 != 0) != (v6 == 0))
    {
      v8 = [(DODMLASRSchemaDODMLASRFullPayloadCorrectionExperimentInfoTier1 *)self infoTier1];
      if (!v8)
      {
...
LABEL_10:
      ...
      v9 = v8;
      v10 = [(DODMLASRSchemaDODMLASRFullPayloadCorrectionExperimentInfoTier1 *)self infoTier1];
      v11 = [v4 infoTier1];
      v12 = [v10 isEqual:v11];
