...
- (NLXSchemaMILAssetAcquisitionContext)initWithDictionary:(id)dictionary;
- (NLXSchemaMILAssetAcquisitionContext)initWithJSON:(id)n;
...
- (NLXSchemaMILAssetAcquisitionContext)initWithDictionary:(id)dictionary
{
  ...
  v16.receiver = self;
  v16.super_class = NLXSchemaMILAssetAcquisitionContext;
  ...
  if (v5)
  {
    ...
    if (objc_opt_isKindOfClass())
    {
      v11 = [[NLXSchemaMILAssetAcquisitionEnded alloc] initWithDictionary:v10];
...
- (NSData)jsonData
{
  dictionaryRepresentation = [(NLXSchemaMILAssetAcquisitionContext *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  if (self->_contextId)
  {
    contextId = [(NLXSchemaMILAssetAcquisitionContext *)self contextId];
  ...
  if (self->_ended)
  {
    ended = [(NLXSchemaMILAssetAcquisitionContext *)self ended];
  ...
  if (self->_failed)
  {
    failed = [(NLXSchemaMILAssetAcquisitionContext *)self failed];
  ...
  {
    startedOrChanged = [(NLXSchemaMILAssetAcquisitionContext *)self startedOrChanged];
...
- (unint64_t)hash
{
  ...
  v4 = [(NLXSchemaMILAssetAcquisitionStarted *)self->_startedOrChanged hash]^ v3;
  v5 = [(NLXSchemaMILAssetAcquisitionEnded *)self->_ended hash];
...
- (BOOL)isEqual:(id)equal
{
  ...
  contextId3 = [(NLXSchemaMILAssetAcquisitionContext *)self contextId];
  if (contextId3)
  {
    v9 = contextId3;
    contextId4 = [(NLXSchemaMILAssetAcquisitionContext *)self contextId];
  ...
  contextId = [(NLXSchemaMILAssetAcquisitionContext *)self startedOrChanged];
  ...
  if (startedOrChanged)
  {
    ...
    startedOrChanged2 = [(NLXSchemaMILAssetAcquisitionContext *)self startedOrChanged];
  ...
  contextId = [(NLXSchemaMILAssetAcquisitionContext *)self ended];
  ...
  {
    v19 = ended;
    ended2 = [(NLXSchemaMILAssetAcquisitionContext *)self ended];
  ...
  contextId = [(NLXSchemaMILAssetAcquisitionContext *)self failed];
...
LABEL_26:
    ...
    v24 = failed;
    failed2 = [(NLXSchemaMILAssetAcquisitionContext *)self failed];
...
- (void)writeTo:(id)to
{
  ...
  if (contextId)
  {
    contextId2 = [(NLXSchemaMILAssetAcquisitionContext *)self contextId];
...
- (id)applySensitiveConditionsPolicy:(id)policy
{
  policyCopy = policy;
  v19.receiver = self;
  v19.super_class = NLXSchemaMILAssetAcquisitionContext;
