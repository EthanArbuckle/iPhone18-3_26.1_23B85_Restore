...
- (NSData)jsonData;
- (SIRISETUPSchemaSIRISETUPPHSEnrollmentUIUtteranceTrainingAttempted)initWithDictionary:(id)dictionary;
- (SIRISETUPSchemaSIRISETUPPHSEnrollmentUIUtteranceTrainingAttempted)initWithJSON:(id)n;
- (id)applySensitiveConditionsPolicy:(id)policy;
- (id)dictionaryRepresentation;
- (id)suppressMessageUnderConditions;
- (unint64_t)hash;
- (void)setHasEnrollmentMode:(BOOL)mode;
- (void)setHasIsRetry:(BOOL)retry;
- (void)setHasTrainingOutcome:(BOOL)outcome;
- (void)setHasWasAudioHintNeeded:(BOOL)needed;
- (void)setHasWasAudioHintSpokenSuccessfully:(BOOL)successfully;
- (void)writeTo:(id)to;
@end
...
- (SIRISETUPSchemaSIRISETUPPHSEnrollmentUIUtteranceTrainingAttempted)initWithDictionary:(id)dictionary
{
  ...
  if (v5)
  {
    ...
    v7 = [dictionaryCopy objectForKeyedSubscript:@"enrollmentMode"];
    objc_opt_class();
    if (objc_opt_isKindOfClass())
    {
    ...
    v10 = [dictionaryCopy objectForKeyedSubscript:@"isRetry"];
    objc_opt_class();
    if (objc_opt_isKindOfClass())
    {
    ...
    v11 = [dictionaryCopy objectForKeyedSubscript:@"trainingOutcome"];
    objc_opt_class();
    if (objc_opt_isKindOfClass())
    {
    ...
    v12 = [dictionaryCopy objectForKeyedSubscript:@"wasAudioHintNeeded"];
    objc_opt_class();
    if (objc_opt_isKindOfClass())
    {
    ...
    v13 = [dictionaryCopy objectForKeyedSubscript:@"wasAudioHintSpokenSuccessfully"];
    objc_opt_class();
    if (objc_opt_isKindOfClass())
    {
...
- (NSData)jsonData
{
  dictionaryRepresentation = [(SIRISETUPSchemaSIRISETUPPHSEnrollmentUIUtteranceTrainingAttempted *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  if ((v4 & 4) != 0)
  {
    ...
    [dictionary setObject:v7 forKeyedSubscript:@"isRetry"];
  }

  if (self->_locale)
  {
    locale = [(SIRISETUPSchemaSIRISETUPPHSEnrollmentUIUtteranceTrainingAttempted *)self locale];
  ...
  if (v11)
  {
    ...
    [dictionary setObject:v14 forKeyedSubscript:@"pageNumber"];
...
LABEL_15:
  ...
  [dictionary setObject:v16 forKeyedSubscript:@"trainingOutcome"];
  v11 = *(&self->_wasAudioHintSpokenSuccessfully + 1);
  if ((v11 & 0x10) == 0)
  {
LABEL_16:
...
LABEL_26:
  ...
  [dictionary setObject:v17 forKeyedSubscript:@"wasAudioHintNeeded"];
...
LABEL_17:
    ...
    [dictionary setObject:v12 forKeyedSubscript:@"wasAudioHintSpokenSuccessfully"];
  }
...
- (BOOL)isEqual:(id)equal
{
  ...
  locale3 = [(SIRISETUPSchemaSIRISETUPPHSEnrollmentUIUtteranceTrainingAttempted *)self locale];
  if (locale3)
  {
    v14 = locale3;
    locale4 = [(SIRISETUPSchemaSIRISETUPPHSEnrollmentUIUtteranceTrainingAttempted *)self locale];
...
LABEL_31:
  ...
  if (v24)
  {
    ...
    if (wasAudioHintNeeded == [equalCopy wasAudioHintNeeded])
    {
      v18 = *(&self->_wasAudioHintSpokenSuccessfully + 1);
      v20 = equalCopy[34];
      goto LABEL_27;
...
LABEL_27:
  ...
  if (v26)
  {
    ...
    if (wasAudioHintSpokenSuccessfully != [equalCopy wasAudioHintSpokenSuccessfully])
    {
      goto LABEL_31;
    }
  }
...
- (void)writeTo:(id)to
{
  ...
  if (locale)
  {
    locale2 = [(SIRISETUPSchemaSIRISETUPPHSEnrollmentUIUtteranceTrainingAttempted *)self locale];
