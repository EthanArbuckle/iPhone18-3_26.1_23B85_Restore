...
- (NSData)jsonData;
- (PEGASUSSchemaPEGASUSSportsExecution)initWithDictionary:(id)dictionary;
- (PEGASUSSchemaPEGASUSSportsExecution)initWithJSON:(id)n;
...
- (PEGASUSSchemaPEGASUSSportsExecution)initWithDictionary:(id)dictionary
{
  ...
  v14.receiver = self;
  v14.super_class = PEGASUSSchemaPEGASUSSportsExecution;
...
- (NSData)jsonData
{
  dictionaryRepresentation = [(PEGASUSSchemaPEGASUSSportsExecution *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  if ((v4 & 0x10) != 0)
  {
    v5 = [MEMORY[0x1E696AD98] numberWithBool:{-[PEGASUSSchemaPEGASUSSportsExecution isDisambiguation](self, "isDisambiguation")}];
...
LABEL_3:
  ...
  v6 = [MEMORY[0x1E696AD98] numberWithBool:{-[PEGASUSSchemaPEGASUSSportsExecution isLiveScoreRequest](self, "isLiveScoreRequest")}];
...
LABEL_10:
  v7 = [MEMORY[0x1E696AD98] numberWithBool:{-[PEGASUSSchemaPEGASUSSportsExecution isMachineUtterance](self, "isMachineUtterance")}];
...
LABEL_12:
    v9 = [MEMORY[0x1E696AD98] numberWithBool:{-[PEGASUSSchemaPEGASUSSportsExecution isSportsWatchFaceRequest](self, "isSportsWatchFaceRequest")}];
...
LABEL_13:
    v10 = [(PEGASUSSchemaPEGASUSSportsExecution *)self sportsUsecase]- 1;
    if (v10 > 0x1E)
    {
...
LABEL_11:
  v8 = [MEMORY[0x1E696AD98] numberWithBool:{-[PEGASUSSchemaPEGASUSSportsExecution isSnippetNextCardRequest](self, "isSnippetNextCardRequest")}];
