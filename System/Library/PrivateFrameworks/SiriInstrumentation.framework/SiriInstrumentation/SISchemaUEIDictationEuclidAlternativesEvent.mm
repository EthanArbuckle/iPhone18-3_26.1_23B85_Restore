...
- (NSData)jsonData;
- (SISchemaUEIDictationEuclidAlternativesEvent)initWithDictionary:(id)dictionary;
- (SISchemaUEIDictationEuclidAlternativesEvent)initWithJSON:(id)n;
...
- (NSData)jsonData
{
  dictionaryRepresentation = [(SISchemaUEIDictationEuclidAlternativesEvent *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  if (has)
  {
    eventType = [(SISchemaUEIDictationEuclidAlternativesEvent *)self eventType];
