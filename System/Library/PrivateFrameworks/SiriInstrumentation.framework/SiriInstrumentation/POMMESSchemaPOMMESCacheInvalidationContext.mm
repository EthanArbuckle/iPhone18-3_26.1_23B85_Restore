...
- (id)dictionaryRepresentation
{
  ...
  if (self->_ended)
  {
    v4 = [(POMMESSchemaPOMMESCacheInvalidationContext *)self ended];
  ...
  if (self->_failed)
  {
    v7 = [(POMMESSchemaPOMMESCacheInvalidationContext *)self failed];
...
- (BOOL)isEqual:(id)a3
{
  ...
  v8 = [(POMMESSchemaPOMMESCacheInvalidationContext *)self startedOrChanged];
  if (v8)
  {
    v9 = v8;
    v10 = [(POMMESSchemaPOMMESCacheInvalidationContext *)self startedOrChanged];
  ...
  v13 = [(POMMESSchemaPOMMESCacheInvalidationContext *)self ended];
  if (v13)
  {
    v14 = v13;
  ...
  if ((v6 != 0) != (v7 == 0))
  {
    v18 = [(POMMESSchemaPOMMESCacheInvalidationContext *)self failed];
    if (!v18)
    {
...
{
  v11 = a3;
  v4 = [(POMMESSchemaPOMMESCacheInvalidationContext *)self startedOrChanged];
  ...
  if (v6)
  {
    v7 = [(POMMESSchemaPOMMESCacheInvalidationContext *)self ended];
    PBDataWriterWriteSubmessage();
  }

  v8 = [(POMMESSchemaPOMMESCacheInvalidationContext *)self failed];

  v9 = v11;
  if (v8)
  {
    v10 = [(POMMESSchemaPOMMESCacheInvalidationContext *)self failed];
    PBDataWriterWriteSubmessage();
