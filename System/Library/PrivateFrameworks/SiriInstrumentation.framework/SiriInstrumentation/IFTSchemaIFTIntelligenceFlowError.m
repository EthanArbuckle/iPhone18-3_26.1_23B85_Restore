...
- (IFTSchemaIFTIntelligenceFlowError)initWithDictionary:(id)a3
{
  v4 = a3;
  v11.receiver = self;
  v11.super_class = IFTSchemaIFTIntelligenceFlowError;
...
- (id)dictionaryRepresentation
{
  ...
  if (*&self->_has)
  {
    v4 = [MEMORY[0x1E696AD98] numberWithLongLong:{-[IFTSchemaIFTIntelligenceFlowError code](self, "code")}];
...
LABEL_12:
  ...
  v8 = [(IFTSchemaIFTIntelligenceFlowError *)self domain];
  if (v8)
  {
    v9 = v8;
...
{
  v5 = a3;
  v4 = [(IFTSchemaIFTIntelligenceFlowError *)self domain];
