...
- (NSData)jsonData;
- (SISchemaSendWithoutConfirmation)initWithDictionary:(id)dictionary;
- (SISchemaSendWithoutConfirmation)initWithJSON:(id)n;
- (id)dictionaryRepresentation;
- (id)suppressMessageUnderConditions;
- (unint64_t)hash;
- (void)setHasIsEnabledForCarPlay:(BOOL)play;
...
- (SISchemaSendWithoutConfirmation)initWithDictionary:(id)dictionary
{
  ...
  if (v5)
  {
    v6 = [dictionaryCopy objectForKeyedSubscript:@"isEnabled"];
    objc_opt_class();
    ...
    v7 = [dictionaryCopy objectForKeyedSubscript:@"isEnabledForHeadphones"];
    objc_opt_class();
    if (objc_opt_isKindOfClass())
    {
    ...
    v8 = [dictionaryCopy objectForKeyedSubscript:@"isEnabledForCarPlay"];
    objc_opt_class();
    if (objc_opt_isKindOfClass())
    {
...
- (NSData)jsonData
{
  dictionaryRepresentation = [(SISchemaSendWithoutConfirmation *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  if (v4)
  {
    ...
    [dictionary setObject:v7 forKeyedSubscript:@"isEnabled"];
...
LABEL_3:
  ...
  [dictionary setObject:v8 forKeyedSubscript:@"isEnabledForCarPlay"];
...
LABEL_4:
    ...
    [dictionary setObject:v5 forKeyedSubscript:@"isEnabledForHeadphones"];
  }
...
LABEL_10:
  ...
  if (v10)
  {
    ...
    if (isEnabledForCarPlay != [equalCopy isEnabledForCarPlay])
    {
      goto LABEL_14;
    }
  }
