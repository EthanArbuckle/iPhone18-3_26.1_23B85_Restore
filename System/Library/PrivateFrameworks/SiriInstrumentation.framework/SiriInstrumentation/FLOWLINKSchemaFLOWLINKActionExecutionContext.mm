...
- (FLOWLINKSchemaFLOWLINKActionExecutionContext)initWithDictionary:(id)dictionary;
- (FLOWLINKSchemaFLOWLINKActionExecutionContext)initWithJSON:(id)n;
...
- (NSData)jsonData
{
  dictionaryRepresentation = [(FLOWLINKSchemaFLOWLINKActionExecutionContext *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  if (self->_ended)
  {
    ended = [(FLOWLINKSchemaFLOWLINKActionExecutionContext *)self ended];
  ...
  {
    startedOrChanged = [(FLOWLINKSchemaFLOWLINKActionExecutionContext *)self startedOrChanged];
...
- (BOOL)isEqual:(id)equal
{
  ...
  startedOrChanged3 = [(FLOWLINKSchemaFLOWLINKActionExecutionContext *)self startedOrChanged];
  if (startedOrChanged3)
  {
    v9 = startedOrChanged3;
    startedOrChanged4 = [(FLOWLINKSchemaFLOWLINKActionExecutionContext *)self startedOrChanged];
  ...
  startedOrChanged = [(FLOWLINKSchemaFLOWLINKActionExecutionContext *)self ended];
...
LABEL_16:
    ...
    v14 = ended;
    ended2 = [(FLOWLINKSchemaFLOWLINKActionExecutionContext *)self ended];
...
- (void)writeTo:(id)to
{
  ...
  if (startedOrChanged)
  {
    startedOrChanged2 = [(FLOWLINKSchemaFLOWLINKActionExecutionContext *)self startedOrChanged];
