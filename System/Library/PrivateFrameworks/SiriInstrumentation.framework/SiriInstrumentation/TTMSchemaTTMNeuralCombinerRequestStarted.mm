...
- (NSData)jsonData;
- (TTMSchemaTTMNeuralCombinerRequestStarted)initWithDictionary:(id)dictionary;
- (TTMSchemaTTMNeuralCombinerRequestStarted)initWithJSON:(id)n;
...
- (TTMSchemaTTMNeuralCombinerRequestStarted)initWithDictionary:(id)dictionary
{
  ...
  v10.receiver = self;
  v10.super_class = TTMSchemaTTMNeuralCombinerRequestStarted;
...
- (NSData)jsonData
{
  dictionaryRepresentation = [(TTMSchemaTTMNeuralCombinerRequestStarted *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  if (has)
  {
    v5 = [MEMORY[0x1E696AD98] numberWithBool:{-[TTMSchemaTTMNeuralCombinerRequestStarted exists](self, "exists")}];
  ...
  if ((has & 2) != 0)
  {
    mode = [(TTMSchemaTTMNeuralCombinerRequestStarted *)self mode];
    v7 = @"TTMNEURALCOMBINERMODE_UNKNOWN";
    if (mode == 1)
    {
      v7 = @"TTMNEURALCOMBINERMODE_SIRI_X";
    }
    ...
    [dictionary setObject:v8 forKeyedSubscript:@"mode"];
  }
