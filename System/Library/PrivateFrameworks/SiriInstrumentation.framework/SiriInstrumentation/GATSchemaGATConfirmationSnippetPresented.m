...
- (BOOL)isEqual:(id)a3;
- (GATSchemaGATConfirmationSnippetPresented)initWithDictionary:(id)a3;
- (GATSchemaGATConfirmationSnippetPresented)initWithJSON:(id)a3;
- (NSData)jsonData;
- (id)dictionaryRepresentation;
- (id)suppressMessageUnderConditions;
- (unint64_t)hash;
- (void)setHasRequestedAgent:(BOOL)a3;
- (void)writeTo:(id)a3;
@end
...
- (GATSchemaGATConfirmationSnippetPresented)initWithDictionary:(id)a3
{
  ...
  if (v5)
  {
    v6 = [v4 objectForKeyedSubscript:@"confirmationDialogName"];
    objc_opt_class();
    ...
    v7 = [v4 objectForKeyedSubscript:@"requestedAgent"];
    objc_opt_class();
    if (objc_opt_isKindOfClass())
    {
...
- (NSData)jsonData
{
  v2 = [(GATSchemaGATConfirmationSnippetPresented *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  if (has)
  {
    ...
    [v3 setObject:v6 forKeyedSubscript:@"confirmationDialogName"];
    has = self->_has;
  }
  ...
  if ((has & 2) != 0)
  {
    ...
    [v3 setObject:v8 forKeyedSubscript:@"requestedAgent"];
  }
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (*&has)
  {
    ...
    if (confirmationDialogName != [v4 confirmationDialogName])
    {
LABEL_10:
      v10 = 0;
      goto LABEL_11;
