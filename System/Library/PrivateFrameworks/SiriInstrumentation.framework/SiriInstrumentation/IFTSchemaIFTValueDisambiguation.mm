...
- (IFTSchemaIFTValueDisambiguation)initWithDictionary:(id)dictionary;
- (IFTSchemaIFTValueDisambiguation)initWithJSON:(id)n;
- (NSData)jsonData;
...
- (IFTSchemaIFTValueDisambiguation)initWithDictionary:(id)dictionary
{
  ...
  if (v5)
  {
    ...
    v7 = [dictionaryCopy objectForKeyedSubscript:@"items"];
    objc_opt_class();
    if (objc_opt_isKindOfClass())
    {
      v17 = v6;
...
- (NSData)jsonData
{
  dictionaryRepresentation = [(IFTSchemaIFTValueDisambiguation *)self dictionaryRepresentation];
...
- (BOOL)isEqual:(id)equal
{
  ...
  if ([equalCopy isMemberOfClass:objc_opt_class()])
  {
    if ((*&self->_has & 1) == (equalCopy[24] & 1))
    {
      ...
      {
        items = [(IFTSchemaIFTValueDisambiguation *)self items];
        items2 = [equalCopy items];
        v8 = items2;
        if ((items != 0) != (items2 == 0))
        {
          items3 = [(IFTSchemaIFTValueDisambiguation *)self items];
          if (!items3)
          {
...
LABEL_13:
          ...
          v10 = items3;
          items4 = [(IFTSchemaIFTValueDisambiguation *)self items];
          items5 = [equalCopy items];
          v13 = [items4 isEqual:items5];
