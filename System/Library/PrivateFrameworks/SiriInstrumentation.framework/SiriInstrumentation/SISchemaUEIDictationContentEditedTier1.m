...
- (BOOL)isEqual:(id)a3
{
  ...
  if ([v4 isMemberOfClass:objc_opt_class()])
  {
    ...
    v6 = [v4 autoPunctuationEdits];
    v7 = v6;
    if ((v5 != 0) != (v6 == 0))
    {
      v8 = [(SISchemaUEIDictationContentEditedTier1 *)self autoPunctuationEdits];
      if (!v8)
      {
...
LABEL_10:
      ...
      v9 = v8;
      v10 = [(SISchemaUEIDictationContentEditedTier1 *)self autoPunctuationEdits];
      v11 = [v4 autoPunctuationEdits];
      v12 = [v10 isEqual:v11];
