...
- (id)dictionaryRepresentation
{
  ...
  if (self->_ended)
  {
    v4 = [(RGSiriSchemaRGCacheManagerCallContext *)self ended];
  ...
  if (self->_failed)
  {
    v7 = [(RGSiriSchemaRGCacheManagerCallContext *)self failed];
...
- (BOOL)isEqual:(id)a3
{
  ...
  v8 = [(RGSiriSchemaRGCacheManagerCallContext *)self startedOrChanged];
  if (v8)
  {
    v9 = v8;
    v10 = [(RGSiriSchemaRGCacheManagerCallContext *)self startedOrChanged];
  ...
  v13 = [(RGSiriSchemaRGCacheManagerCallContext *)self ended];
  if (v13)
  {
    v14 = v13;
  ...
  v18 = [(RGSiriSchemaRGCacheManagerCallContext *)self failed];
  if (v18)
  {
    v19 = v18;
  ...
  if ((v6 != 0) != (v7 == 0))
  {
    v23 = [(RGSiriSchemaRGCacheManagerCallContext *)self traceId];
    if (!v23)
    {
...
{
  v13 = a3;
  v4 = [(RGSiriSchemaRGCacheManagerCallContext *)self startedOrChanged];

  if (v4)
  {
    v5 = [(RGSiriSchemaRGCacheManagerCallContext *)self startedOrChanged];
  ...
  if (v6)
  {
    v7 = [(RGSiriSchemaRGCacheManagerCallContext *)self ended];
    PBDataWriterWriteSubmessage();
  }

  v8 = [(RGSiriSchemaRGCacheManagerCallContext *)self failed];
  ...
  if (v10)
  {
    v12 = [(RGSiriSchemaRGCacheManagerCallContext *)self traceId];
    PBDataWriterWriteSubmessage();
