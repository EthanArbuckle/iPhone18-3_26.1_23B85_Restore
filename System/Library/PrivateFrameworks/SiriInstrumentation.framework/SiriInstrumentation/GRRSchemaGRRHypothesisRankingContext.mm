...
- (GRRSchemaGRRHypothesisRankingContext)initWithDictionary:(id)dictionary;
- (GRRSchemaGRRHypothesisRankingContext)initWithJSON:(id)n;
...
- (NSData)jsonData
{
  dictionaryRepresentation = [(GRRSchemaGRRHypothesisRankingContext *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  if (self->_contextId)
  {
    contextId = [(GRRSchemaGRRHypothesisRankingContext *)self contextId];
  ...
  if (self->_ended)
  {
    ended = [(GRRSchemaGRRHypothesisRankingContext *)self ended];
  ...
  {
    startedOrChanged = [(GRRSchemaGRRHypothesisRankingContext *)self startedOrChanged];
...
- (BOOL)isEqual:(id)equal
{
  ...
  contextId3 = [(GRRSchemaGRRHypothesisRankingContext *)self contextId];
  if (contextId3)
  {
    v9 = contextId3;
    contextId4 = [(GRRSchemaGRRHypothesisRankingContext *)self contextId];
  ...
  contextId = [(GRRSchemaGRRHypothesisRankingContext *)self startedOrChanged];
  ...
  if (startedOrChanged)
  {
    ...
    startedOrChanged2 = [(GRRSchemaGRRHypothesisRankingContext *)self startedOrChanged];
  ...
  contextId = [(GRRSchemaGRRHypothesisRankingContext *)self ended];
...
LABEL_21:
    ...
    v19 = ended;
    ended2 = [(GRRSchemaGRRHypothesisRankingContext *)self ended];
...
- (void)writeTo:(id)to
{
  ...
  if (contextId)
  {
    contextId2 = [(GRRSchemaGRRHypothesisRankingContext *)self contextId];
