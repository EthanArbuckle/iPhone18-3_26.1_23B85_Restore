...
- (IFTSchemaIFTIntelligenceFlowError)initWithDictionary:(id)dictionary;
- (IFTSchemaIFTIntelligenceFlowError)initWithJSON:(id)n;
- (NSData)jsonData;
...
- (NSData)jsonData
{
  dictionaryRepresentation = [(IFTSchemaIFTIntelligenceFlowError *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  if (self->_domain)
  {
    domain = [(IFTSchemaIFTIntelligenceFlowError *)self domain];
    v6 = [domain copy];
...
LABEL_12:
  ...
  domain3 = [(IFTSchemaIFTIntelligenceFlowError *)self domain];
  if (domain3)
  {
    v9 = domain3;
    domain4 = [(IFTSchemaIFTIntelligenceFlowError *)self domain];
