...
- (CNVSchemaCNVFlowPluginExecutionContext)initWithDictionary:(id)dictionary;
- (CNVSchemaCNVFlowPluginExecutionContext)initWithJSON:(id)n;
...
- (NSData)jsonData
{
  dictionaryRepresentation = [(CNVSchemaCNVFlowPluginExecutionContext *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  if (self->_contextId)
  {
    contextId = [(CNVSchemaCNVFlowPluginExecutionContext *)self contextId];
  ...
  if (self->_ended)
  {
    ended = [(CNVSchemaCNVFlowPluginExecutionContext *)self ended];
  ...
  {
    startedOrChanged = [(CNVSchemaCNVFlowPluginExecutionContext *)self startedOrChanged];
...
- (BOOL)isEqual:(id)equal
{
  ...
  contextId3 = [(CNVSchemaCNVFlowPluginExecutionContext *)self contextId];
  if (contextId3)
  {
    v9 = contextId3;
    contextId4 = [(CNVSchemaCNVFlowPluginExecutionContext *)self contextId];
  ...
  contextId = [(CNVSchemaCNVFlowPluginExecutionContext *)self startedOrChanged];
  ...
  if (startedOrChanged)
  {
    ...
    startedOrChanged2 = [(CNVSchemaCNVFlowPluginExecutionContext *)self startedOrChanged];
  ...
  contextId = [(CNVSchemaCNVFlowPluginExecutionContext *)self ended];
...
LABEL_21:
    ...
    v19 = ended;
    ended2 = [(CNVSchemaCNVFlowPluginExecutionContext *)self ended];
...
- (void)writeTo:(id)to
{
  ...
  if (contextId)
  {
    contextId2 = [(CNVSchemaCNVFlowPluginExecutionContext *)self contextId];
