...
- (SISchemaUEIDictationDiscoveryToolTipDisplayContext)initWithDictionary:(id)dictionary;
- (SISchemaUEIDictationDiscoveryToolTipDisplayContext)initWithJSON:(id)n;
...
- (SISchemaUEIDictationDiscoveryToolTipDisplayContext)initWithDictionary:(id)dictionary
{
  ...
  v14.receiver = self;
  v14.super_class = SISchemaUEIDictationDiscoveryToolTipDisplayContext;
  ...
  if (v5)
  {
    ...
    if (objc_opt_isKindOfClass())
    {
      v11 = [[SISchemaUEIDictationDiscoveryToolTipDismissed alloc] initWithDictionary:v10];
...
- (NSData)jsonData
{
  dictionaryRepresentation = [(SISchemaUEIDictationDiscoveryToolTipDisplayContext *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  if (self->_contextId)
  {
    contextId = [(SISchemaUEIDictationDiscoveryToolTipDisplayContext *)self contextId];
  ...
  if (self->_ended)
  {
    ended = [(SISchemaUEIDictationDiscoveryToolTipDisplayContext *)self ended];
  ...
  {
    startedOrChanged = [(SISchemaUEIDictationDiscoveryToolTipDisplayContext *)self startedOrChanged];
...
- (unint64_t)hash
{
  ...
  v4 = [(SISchemaUEIDictationDiscoveryToolTipShown *)self->_startedOrChanged hash]^ v3;
...
- (BOOL)isEqual:(id)equal
{
  ...
  contextId3 = [(SISchemaUEIDictationDiscoveryToolTipDisplayContext *)self contextId];
  if (contextId3)
  {
    v9 = contextId3;
    contextId4 = [(SISchemaUEIDictationDiscoveryToolTipDisplayContext *)self contextId];
  ...
  contextId = [(SISchemaUEIDictationDiscoveryToolTipDisplayContext *)self startedOrChanged];
  ...
  if (startedOrChanged)
  {
    ...
    startedOrChanged2 = [(SISchemaUEIDictationDiscoveryToolTipDisplayContext *)self startedOrChanged];
  ...
  contextId = [(SISchemaUEIDictationDiscoveryToolTipDisplayContext *)self ended];
...
LABEL_21:
    ...
    v19 = ended;
    ended2 = [(SISchemaUEIDictationDiscoveryToolTipDisplayContext *)self ended];
...
- (void)writeTo:(id)to
{
  ...
  if (contextId)
  {
    contextId2 = [(SISchemaUEIDictationDiscoveryToolTipDisplayContext *)self contextId];
...
- (id)applySensitiveConditionsPolicy:(id)policy
{
  policyCopy = policy;
  v16.receiver = self;
  v16.super_class = SISchemaUEIDictationDiscoveryToolTipDisplayContext;
