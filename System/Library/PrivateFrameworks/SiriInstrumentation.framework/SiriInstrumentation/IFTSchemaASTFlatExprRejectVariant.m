  ...
  if ([v4 isMemberOfClass:objc_opt_class()])
  {
    if ((*&self->_has & 1) == (v4[24] & 1))
    {
      if ((*&self->_has & 1) == 0 || (exists = self->_exists, exists == [v4 exists]))
      {
        ...
        if ((v6 != 0) != (v7 == 0))
        {
          v9 = [(IFTSchemaASTFlatExprRejectVariant *)self rawEventId];
          if (!v9)
          {
...
LABEL_13:
          ...
          v10 = v9;
          v11 = [(IFTSchemaASTFlatExprRejectVariant *)self rawEventId];
          v12 = [v4 rawEventId];
          v13 = [v11 isEqual:v12];
...
- (void)writeTo:(id)a3
{
  ...
  v4 = [(IFTSchemaASTFlatExprRejectVariant *)self rawEventId];
