...
- (id)dictionaryRepresentation
{
  ...
  {
    v4 = [(MHSchemaMHVoiceTriggerSecondPassCancelled *)self voiceTriggerEventInfo];
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ([v4 isMemberOfClass:objc_opt_class()])
  {
    ...
    if ((v5 != 0) != (v6 == 0))
    {
      v8 = [(MHSchemaMHVoiceTriggerSecondPassCancelled *)self voiceTriggerEventInfo];
      if (!v8)
      {
...
LABEL_10:
      ...
      v9 = v8;
      v10 = [(MHSchemaMHVoiceTriggerSecondPassCancelled *)self voiceTriggerEventInfo];
