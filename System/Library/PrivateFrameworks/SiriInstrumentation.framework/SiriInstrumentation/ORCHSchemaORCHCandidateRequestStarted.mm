...
- (NSData)jsonData;
- (ORCHSchemaORCHCandidateRequestStarted)initWithDictionary:(id)dictionary;
- (ORCHSchemaORCHCandidateRequestStarted)initWithJSON:(id)n;
...
- (NSData)jsonData
{
  dictionaryRepresentation = [(ORCHSchemaORCHCandidateRequestStarted *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  if (*&self->_has)
  {
    ...
    [dictionary setObject:v5 forKeyedSubscript:@"requestType"];
  }
...
- (BOOL)isEqual:(id)equal
{
  ...
  if ([equalCopy isMemberOfClass:objc_opt_class()])
  {
    ...
    {
      if ((*&self->_has & 1) == 0 || (requestType = self->_requestType, requestType == [equalCopy requestType]))
      {
        v6 = 1;
      }
    }
