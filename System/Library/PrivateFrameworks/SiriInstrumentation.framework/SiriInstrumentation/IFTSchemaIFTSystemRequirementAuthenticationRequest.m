...
- (id)dictionaryRepresentation
{
  ...
  if (*&self->_has)
  {
    v4 = [(IFTSchemaIFTSystemRequirementAuthenticationRequest *)self authenticationLevel];
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ([v4 isMemberOfClass:objc_opt_class()])
  {
    ...
    {
      if ((*&self->_has & 1) == 0 || (authenticationLevel = self->_authenticationLevel, authenticationLevel == [v4 authenticationLevel]))
      {
        v6 = 1;
      }
    }
