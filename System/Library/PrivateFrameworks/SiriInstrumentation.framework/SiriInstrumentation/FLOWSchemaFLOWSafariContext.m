...
- (BOOL)isEqual:(id)a3;
- (FLOWSchemaFLOWSafariContext)initWithDictionary:(id)a3;
- (FLOWSchemaFLOWSafariContext)initWithJSON:(id)a3;
- (NSData)jsonData;
...
- (NSData)jsonData
{
  v2 = [(FLOWSchemaFLOWSafariContext *)self dictionaryRepresentation];
