...
- (id)dictionaryRepresentation
{
  ...
  {
    v4 = [(PLUSSchemaPLUSMediaGroundTruthGenerated *)self groundTruth];
  ...
  {
    v7 = [(PLUSSchemaPLUSMediaGroundTruthGenerated *)self originalRequestId];
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ((v5 != 0) != (v6 == 0))
  {
    v12 = [(PLUSSchemaPLUSMediaGroundTruthGenerated *)self groundTruth];
    if (!v12)
    {
...
{
  v8 = a3;
  v4 = [(PLUSSchemaPLUSMediaGroundTruthGenerated *)self originalRequestId];
  ...
  if (v6)
  {
    v7 = [(PLUSSchemaPLUSMediaGroundTruthGenerated *)self groundTruth];
    PBDataWriterWriteSubmessage();
  }
}
