...
- (id)dictionaryRepresentation
{
  ...
  if (self->_ended)
  {
    v4 = [(CLPInstSchemaCLPCDMReplayTaskContext *)self ended];
  ...
  {
    v7 = [(CLPInstSchemaCLPCDMReplayTaskContext *)self startedOrChanged];
...
- (BOOL)isEqual:(id)a3
{
  ...
  v8 = [(CLPInstSchemaCLPCDMReplayTaskContext *)self startedOrChanged];
  if (v8)
  {
    v9 = v8;
  ...
  if ((v6 != 0) != (v7 == 0))
  {
    v13 = [(CLPInstSchemaCLPCDMReplayTaskContext *)self ended];
    if (!v13)
    {
...
{
  v8 = a3;
  v4 = [(CLPInstSchemaCLPCDMReplayTaskContext *)self startedOrChanged];
  ...
  if (v6)
  {
    v7 = [(CLPInstSchemaCLPCDMReplayTaskContext *)self ended];
    PBDataWriterWriteSubmessage();
  }
}
