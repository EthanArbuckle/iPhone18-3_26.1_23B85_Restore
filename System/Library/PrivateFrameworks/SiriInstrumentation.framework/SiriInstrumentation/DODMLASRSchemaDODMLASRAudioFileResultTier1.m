...
- (unint64_t)hash;
- (void)addOneBestTranscripts:(id)a3;
- (void)writeTo:(id)a3;
@end
...
- (DODMLASRSchemaDODMLASRAudioFileResultTier1)initWithDictionary:(id)a3
{
  ...
  if (v5)
  {
    ...
    v8 = [v4 objectForKeyedSubscript:@"oneBestTranscripts"];
    objc_opt_class();
    if (objc_opt_isKindOfClass())
    {
      v20 = v6;
...
- (id)dictionaryRepresentation
{
  ...
  if (self->_linkId)
  {
    v4 = [(DODMLASRSchemaDODMLASRAudioFileResultTier1 *)self linkId];
  ...
  if ([(NSArray *)self->_oneBestTranscripts count])
  {
    ...
    [v3 setObject:v7 forKeyedSubscript:@"oneBestTranscripts"];
  }

  if (self->_recognitionResult)
  {
    v15 = [(DODMLASRSchemaDODMLASRAudioFileResultTier1 *)self recognitionResult];
    v16 = [v15 dictionaryRepresentation];
    if (v16)
    {
      [v3 setObject:v16 forKeyedSubscript:@"recognitionResult"];
    }

    else
    {
      v17 = [MEMORY[0x1E695DFB0] null];
      [v3 setObject:v17 forKeyedSubscript:@"recognitionResult"];
    }
  }
...
- (BOOL)isEqual:(id)a3
{
  ...
  v7 = [(DODMLASRSchemaDODMLASRAudioFileResultTier1 *)self recognitionResult];
  if (v7)
  {
    v8 = v7;
    v9 = [(DODMLASRSchemaDODMLASRAudioFileResultTier1 *)self recognitionResult];
    v10 = [v4 recognitionResult];
    v11 = [v9 isEqual:v10];
  ...
  v5 = [(DODMLASRSchemaDODMLASRAudioFileResultTier1 *)self oneBestTranscripts];
  v6 = [v4 oneBestTranscripts];
  if ((v5 != 0) == (v6 == 0))
  {
    goto LABEL_16;
  }

  v12 = [(DODMLASRSchemaDODMLASRAudioFileResultTier1 *)self oneBestTranscripts];
  if (v12)
  {
    v13 = v12;
    v14 = [(DODMLASRSchemaDODMLASRAudioFileResultTier1 *)self oneBestTranscripts];
    v15 = [v4 oneBestTranscripts];
    v16 = [v14 isEqual:v15];
  ...
  v5 = [(DODMLASRSchemaDODMLASRAudioFileResultTier1 *)self linkId];
  v6 = [v4 linkId];
  if ((v5 != 0) != (v6 == 0))
  {
    v17 = [(DODMLASRSchemaDODMLASRAudioFileResultTier1 *)self linkId];
    if (!v17)
    {
...
LABEL_20:
    ...
    v18 = v17;
    v19 = [(DODMLASRSchemaDODMLASRAudioFileResultTier1 *)self linkId];
    v20 = [v4 linkId];
    v21 = [v19 isEqual:v20];
...
- (void)writeTo:(id)a3
{
  ...
  v12 = [(DODMLASRSchemaDODMLASRAudioFileResultTier1 *)self linkId];

  if (v12)
  {
    v13 = [(DODMLASRSchemaDODMLASRAudioFileResultTier1 *)self linkId];
    PBDataWriterWriteSubmessage();
  }
}
...
- (void)addOneBestTranscripts:(id)a3
{
  ...
  if (!oneBestTranscripts)
  {
    ...
    v7 = self->_oneBestTranscripts;
    self->_oneBestTranscripts = v6;

    v4 = v8;
    oneBestTranscripts = self->_oneBestTranscripts;
  }

  [(NSArray *)oneBestTranscripts addObject:v4];
}
...
- (id)applySensitiveConditionsPolicy:(id)a3
{
  ...
  v9 = [(DODMLASRSchemaDODMLASRAudioFileResultTier1 *)self oneBestTranscripts];
  v10 = [(SISchemaInstrumentationMessage *)self _pruneSuppressedMessagesFromArray:v9 underConditions:v4];
  [(DODMLASRSchemaDODMLASRAudioFileResultTier1 *)self setOneBestTranscripts:v10];

  v11 = [(DODMLASRSchemaDODMLASRAudioFileResultTier1 *)self linkId];
