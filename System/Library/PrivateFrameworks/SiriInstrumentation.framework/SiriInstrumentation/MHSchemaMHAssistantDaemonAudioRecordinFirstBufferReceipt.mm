...
- (BOOL)isEqual:(id)a3
{
  ...
  if ([v4 isMemberOfClass:objc_opt_class()])
  {
    ...
    {
      if ((*&self->_has & 1) == 0 || (firstBufferReceiptTimeOffsetInNs = self->_firstBufferReceiptTimeOffsetInNs, firstBufferReceiptTimeOffsetInNs == [v4 firstBufferReceiptTimeOffsetInNs]))
      {
        v6 = 1;
      }
    }
