...
- (id)dictionaryRepresentation
{
  ...
  if (self->_ended)
  {
    v4 = [(MHSchemaMHAssistantDaemonAudioConfigureContext *)self ended];
  ...
  {
    v7 = [(MHSchemaMHAssistantDaemonAudioConfigureContext *)self startedOrChanged];
...
- (BOOL)isEqual:(id)a3
{
  ...
  v8 = [(MHSchemaMHAssistantDaemonAudioConfigureContext *)self startedOrChanged];
  if (v8)
  {
    v9 = v8;
  ...
  if ((v6 != 0) != (v7 == 0))
  {
    v13 = [(MHSchemaMHAssistantDaemonAudioConfigureContext *)self ended];
    if (!v13)
    {
...
{
  v8 = a3;
  v4 = [(MHSchemaMHAssistantDaemonAudioConfigureContext *)self startedOrChanged];
  ...
  if (v6)
  {
    v7 = [(MHSchemaMHAssistantDaemonAudioConfigureContext *)self ended];
    PBDataWriterWriteSubmessage();
  }
}
