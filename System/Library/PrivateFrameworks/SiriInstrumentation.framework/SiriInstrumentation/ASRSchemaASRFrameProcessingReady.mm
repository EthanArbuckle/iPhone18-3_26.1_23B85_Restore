...
- (ASRSchemaASRFrameProcessingReady)initWithDictionary:(id)dictionary;
- (ASRSchemaASRFrameProcessingReady)initWithJSON:(id)n;
...
- (NSData)jsonData
{
  dictionaryRepresentation = [(ASRSchemaASRFrameProcessingReady *)self dictionaryRepresentation];
