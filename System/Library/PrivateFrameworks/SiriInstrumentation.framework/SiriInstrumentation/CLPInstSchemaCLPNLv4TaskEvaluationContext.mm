...
- (id)dictionaryRepresentation
{
  ...
  if (self->_ended)
  {
    v4 = [(CLPInstSchemaCLPNLv4TaskEvaluationContext *)self ended];
  ...
  {
    v7 = [(CLPInstSchemaCLPNLv4TaskEvaluationContext *)self startedOrChanged];
...
- (BOOL)isEqual:(id)a3
{
  ...
  v8 = [(CLPInstSchemaCLPNLv4TaskEvaluationContext *)self startedOrChanged];
  if (v8)
  {
    v9 = v8;
  ...
  if ((v6 != 0) != (v7 == 0))
  {
    v13 = [(CLPInstSchemaCLPNLv4TaskEvaluationContext *)self ended];
    if (!v13)
    {
...
{
  v8 = a3;
  v4 = [(CLPInstSchemaCLPNLv4TaskEvaluationContext *)self startedOrChanged];
  ...
  if (v6)
  {
    v7 = [(CLPInstSchemaCLPNLv4TaskEvaluationContext *)self ended];
    PBDataWriterWriteSubmessage();
  }
}
