...
- (BOOL)isEqual:(id)a3;
- (NSData)jsonData;
- (ODDSiriSchemaODDAttentionInvocationDigest)initWithDictionary:(id)a3;
- (ODDSiriSchemaODDAttentionInvocationDigest)initWithJSON:(id)a3;
...
- (NSData)jsonData
{
  v2 = [(ODDSiriSchemaODDAttentionInvocationDigest *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  if (self->_counts)
  {
    v4 = [(ODDSiriSchemaODDAttentionInvocationDigest *)self counts];
  ...
  if (self->_dimensions)
  {
    v7 = [(ODDSiriSchemaODDAttentionInvocationDigest *)self dimensions];
...
- (BOOL)isEqual:(id)a3
{
  ...
  v5 = [(ODDSiriSchemaODDAttentionInvocationDigest *)self dimensions];
  v6 = [v4 dimensions];
  if ((v5 != 0) == (v6 == 0))
  {
    goto LABEL_11;
  ...
  {
    v8 = v7;
    v9 = [(ODDSiriSchemaODDAttentionInvocationDigest *)self dimensions];
    v10 = [v4 dimensions];
    v11 = [v9 isEqual:v10];
  ...
  v5 = [(ODDSiriSchemaODDAttentionInvocationDigest *)self counts];
  v6 = [v4 counts];
  if ((v5 != 0) != (v6 == 0))
  {
    v12 = [(ODDSiriSchemaODDAttentionInvocationDigest *)self counts];
    if (!v12)
    {
...
LABEL_15:
    ...
    v13 = v12;
    v14 = [(ODDSiriSchemaODDAttentionInvocationDigest *)self counts];
    v15 = [v4 counts];
    v16 = [v14 isEqual:v15];
...
{
  v8 = a3;
  v4 = [(ODDSiriSchemaODDAttentionInvocationDigest *)self dimensions];
  ...
  v6 = [(ODDSiriSchemaODDAttentionInvocationDigest *)self counts];

  if (v6)
  {
    v7 = [(ODDSiriSchemaODDAttentionInvocationDigest *)self counts];
    PBDataWriterWriteSubmessage();
  }
}
...
- (id)applySensitiveConditionsPolicy:(id)a3
{
  ...
  v6 = [(ODDSiriSchemaODDAttentionInvocationDigest *)self dimensions];
  ...
  v9 = [(ODDSiriSchemaODDAttentionInvocationDigest *)self counts];
