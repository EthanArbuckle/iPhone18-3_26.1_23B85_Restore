...
- (id)dictionaryRepresentation
{
  ...
  if (self->_ended)
  {
    v4 = [(GATSchemaGATRegisterMediaContext *)self ended];
  ...
  if (self->_failed)
  {
    v7 = [(GATSchemaGATRegisterMediaContext *)self failed];
...
- (BOOL)isEqual:(id)a3
{
  ...
  v8 = [(GATSchemaGATRegisterMediaContext *)self startedOrChanged];
  if (v8)
  {
    v9 = v8;
    v10 = [(GATSchemaGATRegisterMediaContext *)self startedOrChanged];
  ...
  v13 = [(GATSchemaGATRegisterMediaContext *)self ended];
  if (v13)
  {
    v14 = v13;
  ...
  if ((v6 != 0) != (v7 == 0))
  {
    v18 = [(GATSchemaGATRegisterMediaContext *)self failed];
    if (!v18)
    {
...
{
  v11 = a3;
  v4 = [(GATSchemaGATRegisterMediaContext *)self startedOrChanged];
  ...
  if (v6)
  {
    v7 = [(GATSchemaGATRegisterMediaContext *)self ended];
    PBDataWriterWriteSubmessage();
  }

  v8 = [(GATSchemaGATRegisterMediaContext *)self failed];

  v9 = v11;
  if (v8)
  {
    v10 = [(GATSchemaGATRegisterMediaContext *)self failed];
    PBDataWriterWriteSubmessage();
