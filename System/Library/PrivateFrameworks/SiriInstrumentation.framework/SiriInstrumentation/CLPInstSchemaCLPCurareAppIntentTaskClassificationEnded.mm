...
- (CLPInstSchemaCLPCurareAppIntentTaskClassificationEnded)initWithDictionary:(id)dictionary;
- (CLPInstSchemaCLPCurareAppIntentTaskClassificationEnded)initWithJSON:(id)n;
- (NSData)jsonData;
- (id)dictionaryRepresentation;
- (id)suppressMessageUnderConditions;
- (unint64_t)hash;
- (void)setHasClassifiedSampleCount:(BOOL)count;
- (void)setHasPositiveCount:(BOOL)count;
- (void)writeTo:(id)to;
@end
...
- (CLPInstSchemaCLPCurareAppIntentTaskClassificationEnded)initWithDictionary:(id)dictionary
{
  ...
  if (v5)
  {
    v6 = [dictionaryCopy objectForKeyedSubscript:@"sampleCount"];
    objc_opt_class();
    ...
    v7 = [dictionaryCopy objectForKeyedSubscript:@"classifiedSampleCount"];
    objc_opt_class();
    if (objc_opt_isKindOfClass())
    {
    ...
    v8 = [dictionaryCopy objectForKeyedSubscript:@"positiveCount"];
    objc_opt_class();
    if (objc_opt_isKindOfClass())
    {
...
- (NSData)jsonData
{
  dictionaryRepresentation = [(CLPInstSchemaCLPCurareAppIntentTaskClassificationEnded *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  if ((has & 2) != 0)
  {
    ...
    [dictionary setObject:v7 forKeyedSubscript:@"classifiedSampleCount"];
...
LABEL_3:
  ...
  [dictionary setObject:v8 forKeyedSubscript:@"positiveCount"];
...
LABEL_4:
    ...
    [dictionary setObject:v5 forKeyedSubscript:@"sampleCount"];
  }
...
- (BOOL)isEqual:(id)equal
{
  ...
  if (v8)
  {
    ...
    if (classifiedSampleCount == [equalCopy classifiedSampleCount])
    {
      has = self->_has;
      v6 = equalCopy[20];
      goto LABEL_10;
...
LABEL_10:
  ...
  if (v10)
  {
    ...
    if (positiveCount != [equalCopy positiveCount])
    {
      goto LABEL_14;
    }
  }
