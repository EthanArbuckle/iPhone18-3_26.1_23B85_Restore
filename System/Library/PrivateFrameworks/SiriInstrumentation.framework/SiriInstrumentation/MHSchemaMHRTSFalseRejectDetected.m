...
- (id)dictionaryRepresentation
{
  ...
  {
    v7 = [(MHSchemaMHRTSFalseRejectDetected *)self gestureModelVersion];
    v8 = [v7 copy];
...
- (BOOL)isEqual:(id)a3
{
  ...
  v8 = [(MHSchemaMHRTSFalseRejectDetected *)self gestureModelVersion];
  if (v8)
  {
    v9 = v8;
  ...
  v13 = [(MHSchemaMHRTSFalseRejectDetected *)self audioModelVersion];
  if (v13)
  {
    v14 = v13;
    v15 = [(MHSchemaMHRTSFalseRejectDetected *)self audioModelVersion];
  ...
  if ((v6 != 0) != (v7 == 0))
  {
    v18 = [(MHSchemaMHRTSFalseRejectDetected *)self policyModelVersion];
    if (!v18)
    {
...
- (void)writeTo:(id)a3
{
  ...
  v4 = [(MHSchemaMHRTSFalseRejectDetected *)self gestureModelVersion];
