...
- (HALSchemaHALLocalFetchContext)initWithDictionary:(id)dictionary;
- (HALSchemaHALLocalFetchContext)initWithJSON:(id)n;
...
- (HALSchemaHALLocalFetchContext)initWithDictionary:(id)dictionary
{
  ...
  v14.receiver = self;
  v14.super_class = HALSchemaHALLocalFetchContext;
  ...
  if (v5)
  {
    ...
    if (objc_opt_isKindOfClass())
    {
      v11 = [[HALSchemaHALLocalFetchFailed alloc] initWithDictionary:v10];
...
- (NSData)jsonData
{
  dictionaryRepresentation = [(HALSchemaHALLocalFetchContext *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  if (self->_ended)
  {
    ended = [(HALSchemaHALLocalFetchContext *)self ended];
  ...
  if (self->_failed)
  {
    failed = [(HALSchemaHALLocalFetchContext *)self failed];
  ...
  {
    startedOrChanged = [(HALSchemaHALLocalFetchContext *)self startedOrChanged];
...
- (unint64_t)hash
{
  v3 = [(HALSchemaHALLocalFetchStarted *)self->_startedOrChanged hash];
  v4 = [(HALSchemaHALLocalFetchEnded *)self->_ended hash]^ v3;
...
- (BOOL)isEqual:(id)equal
{
  ...
  startedOrChanged3 = [(HALSchemaHALLocalFetchContext *)self startedOrChanged];
  if (startedOrChanged3)
  {
    v9 = startedOrChanged3;
    startedOrChanged4 = [(HALSchemaHALLocalFetchContext *)self startedOrChanged];
  ...
  startedOrChanged = [(HALSchemaHALLocalFetchContext *)self ended];
  ...
  {
    v14 = ended;
    ended2 = [(HALSchemaHALLocalFetchContext *)self ended];
  ...
  startedOrChanged = [(HALSchemaHALLocalFetchContext *)self failed];
...
LABEL_21:
    ...
    v19 = failed;
    failed2 = [(HALSchemaHALLocalFetchContext *)self failed];
...
- (void)writeTo:(id)to
{
  ...
  if (startedOrChanged)
  {
    startedOrChanged2 = [(HALSchemaHALLocalFetchContext *)self startedOrChanged];
...
- (id)applySensitiveConditionsPolicy:(id)policy
{
  policyCopy = policy;
  v16.receiver = self;
  v16.super_class = HALSchemaHALLocalFetchContext;
