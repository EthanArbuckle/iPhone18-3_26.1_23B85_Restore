...
- (id)dictionaryRepresentation
{
  ...
  if (self->_ended)
  {
    v4 = [(HALSchemaHALLocalFetchContext *)self ended];
  ...
  if (self->_failed)
  {
    v7 = [(HALSchemaHALLocalFetchContext *)self failed];
...
- (BOOL)isEqual:(id)a3
{
  ...
  v8 = [(HALSchemaHALLocalFetchContext *)self startedOrChanged];
  if (v8)
  {
    v9 = v8;
    v10 = [(HALSchemaHALLocalFetchContext *)self startedOrChanged];
  ...
  v13 = [(HALSchemaHALLocalFetchContext *)self ended];
  if (v13)
  {
    v14 = v13;
  ...
  if ((v6 != 0) != (v7 == 0))
  {
    v18 = [(HALSchemaHALLocalFetchContext *)self failed];
    if (!v18)
    {
...
{
  v11 = a3;
  v4 = [(HALSchemaHALLocalFetchContext *)self startedOrChanged];
  ...
  if (v6)
  {
    v7 = [(HALSchemaHALLocalFetchContext *)self ended];
    PBDataWriterWriteSubmessage();
  }

  v8 = [(HALSchemaHALLocalFetchContext *)self failed];

  v9 = v11;
  if (v8)
  {
    v10 = [(HALSchemaHALLocalFetchContext *)self failed];
    PBDataWriterWriteSubmessage();
