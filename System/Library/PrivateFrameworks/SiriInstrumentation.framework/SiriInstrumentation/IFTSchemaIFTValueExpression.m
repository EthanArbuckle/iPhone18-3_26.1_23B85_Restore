...
- (IFTSchemaIFTValueExpression)initWithDictionary:(id)a3
{
  ...
  if (v5)
  {
    ...
    v7 = [v4 objectForKeyedSubscript:@"array"];
    objc_opt_class();
    if (objc_opt_isKindOfClass())
    {
...
- (id)dictionaryRepresentation
{
  ...
  if (self->_array)
  {
    v4 = [(IFTSchemaIFTValueExpression *)self array];
    v5 = [v4 dictionaryRepresentation];
    if (v5)
    {
      [v3 setObject:v5 forKeyedSubscript:@"array"];
    }

    else
    {
      v6 = [MEMORY[0x1E695DFB0] null];
      [v3 setObject:v6 forKeyedSubscript:@"array"];
    }
  }
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ([v4 isMemberOfClass:objc_opt_class()])
  {
    if ((*&self->_has & 1) == (v4[24] & 1))
    {
      ...
      {
        v6 = [(IFTSchemaIFTValueExpression *)self array];
        v7 = [v4 array];
        v8 = v7;
        if ((v6 != 0) != (v7 == 0))
        {
          v9 = [(IFTSchemaIFTValueExpression *)self array];
          if (!v9)
          {
...
LABEL_13:
          ...
          v10 = v9;
          v11 = [(IFTSchemaIFTValueExpression *)self array];
          v12 = [v4 array];
          v13 = [v11 isEqual:v12];
