...
- (NSData)jsonData;
- (SISchemaUIStatePresenting)initWithDictionary:(id)dictionary;
- (SISchemaUIStatePresenting)initWithJSON:(id)n;
...
- (id)dictionaryRepresentation
{
  ...
  if (*&self->_has)
  {
    ...
    [dictionary setObject:v5 forKeyedSubscript:@"presentationType"];
  }
...
- (SISchemaUIStatePresenting)initWithDictionary:(id)dictionary
{
  ...
  if (v5)
  {
    v6 = [dictionaryCopy objectForKeyedSubscript:@"presentationType"];
    objc_opt_class();
...
- (NSData)jsonData
{
  dictionaryRepresentation = [(SISchemaUIStatePresenting *)self dictionaryRepresentation];
...
- (BOOL)isEqual:(id)equal
{
  ...
  if ([equalCopy isMemberOfClass:objc_opt_class()])
  {
    ...
    {
      if ((*&self->_has & 1) == 0 || (presentationType = self->_presentationType, presentationType == [equalCopy presentationType]))
      {
        v6 = 1;
      }
    }
