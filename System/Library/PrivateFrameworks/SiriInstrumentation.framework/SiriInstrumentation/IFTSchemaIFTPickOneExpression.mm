...
- (IFTSchemaIFTPickOneExpression)initWithDictionary:(id)dictionary;
- (IFTSchemaIFTPickOneExpression)initWithJSON:(id)n;
- (NSData)jsonData;
...
- (NSData)jsonData
{
  dictionaryRepresentation = [(IFTSchemaIFTPickOneExpression *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  {
    statementId = [(IFTSchemaIFTPickOneExpression *)self statementId];
...
- (BOOL)isEqual:(id)equal
{
  ...
  if ([equalCopy isMemberOfClass:objc_opt_class()])
  {
    ...
    {
      statementId3 = [(IFTSchemaIFTPickOneExpression *)self statementId];
      if (!statementId3)
      {
...
LABEL_10:
      ...
      v9 = statementId3;
      statementId4 = [(IFTSchemaIFTPickOneExpression *)self statementId];
...
- (void)writeTo:(id)to
{
  ...
  if (statementId)
  {
    statementId2 = [(IFTSchemaIFTPickOneExpression *)self statementId];
