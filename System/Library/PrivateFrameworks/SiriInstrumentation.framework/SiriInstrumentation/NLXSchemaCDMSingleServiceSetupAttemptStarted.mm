...
- (NLXSchemaCDMSingleServiceSetupAttemptStarted)initWithDictionary:(id)dictionary;
- (NLXSchemaCDMSingleServiceSetupAttemptStarted)initWithJSON:(id)n;
- (NSData)jsonData;
...
- (NLXSchemaCDMSingleServiceSetupAttemptStarted)initWithDictionary:(id)dictionary
{
  ...
  v10.receiver = self;
  v10.super_class = NLXSchemaCDMSingleServiceSetupAttemptStarted;
...
- (NSData)jsonData
{
  dictionaryRepresentation = [(NLXSchemaCDMSingleServiceSetupAttemptStarted *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  if ((has & 2) != 0)
  {
    v5 = [MEMORY[0x1E696AD98] numberWithUnsignedInt:{-[NLXSchemaCDMSingleServiceSetupAttemptStarted retryNumber](self, "retryNumber")}];
  ...
  if (has)
  {
    v6 = [(NLXSchemaCDMSingleServiceSetupAttemptStarted *)self serviceType]- 1;
    if (v6 > 0x24)
    {
