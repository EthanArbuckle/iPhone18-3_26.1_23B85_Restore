...
- (id)dictionaryRepresentation
{
  ...
  {
    v4 = [(DialogEngineSchemaDLGENGClientEventMetadata *)self dialogEngineId];
  ...
  if (self->_requestId)
  {
    v7 = [(DialogEngineSchemaDLGENGClientEventMetadata *)self requestId];
...
- (BOOL)isEqual:(id)a3
{
  ...
  v7 = [(DialogEngineSchemaDLGENGClientEventMetadata *)self dialogEngineId];
  if (v7)
  {
    v8 = v7;
  ...
  v12 = [(DialogEngineSchemaDLGENGClientEventMetadata *)self requestId];
  if (v12)
  {
    v13 = v12;
    v14 = [(DialogEngineSchemaDLGENGClientEventMetadata *)self requestId];
    v15 = [v4 requestId];
    v16 = [v14 isEqual:v15];
  ...
  if ((v5 != 0) != (v6 == 0))
  {
    v17 = [(DialogEngineSchemaDLGENGClientEventMetadata *)self subRequestId];
    if (!v17)
    {
...
- (void)writeTo:(id)a3
{
  ...
  v8 = [(DialogEngineSchemaDLGENGClientEventMetadata *)self subRequestId];
