...
- (NSData)jsonData;
- (TTMSchemaTTMOverrideFailure)initWithDictionary:(id)dictionary;
- (TTMSchemaTTMOverrideFailure)initWithJSON:(id)n;
...
- (TTMSchemaTTMOverrideFailure)initWithDictionary:(id)dictionary
{
  ...
  v10.receiver = self;
  v10.super_class = TTMSchemaTTMOverrideFailure;
...
- (NSData)jsonData
{
  dictionaryRepresentation = [(TTMSchemaTTMOverrideFailure *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  if (has)
  {
    v5 = [(TTMSchemaTTMOverrideFailure *)self overrideType]- 1;
    if (v5 > 8)
    {
  ...
  if ((has & 2) != 0)
  {
    v7 = [(TTMSchemaTTMOverrideFailure *)self reason]- 1;
    if (v7 > 2)
    {
