...
- (id)dictionaryRepresentation
{
  ...
  if (self->_cancelled)
  {
    v4 = [(SISchemaUEISiriCarCommandContext *)self cancelled];
  ...
  if (self->_ended)
  {
    v7 = [(SISchemaUEISiriCarCommandContext *)self ended];
...
- (BOOL)isEqual:(id)a3
{
  ...
  v8 = [(SISchemaUEISiriCarCommandContext *)self startedOrChanged];
  if (v8)
  {
    v9 = v8;
  ...
  v13 = [(SISchemaUEISiriCarCommandContext *)self ended];
  if (v13)
  {
    v14 = v13;
  ...
  v18 = [(SISchemaUEISiriCarCommandContext *)self failed];
  if (v18)
  {
    v19 = v18;
  ...
  if ((v6 != 0) != (v7 == 0))
  {
    v23 = [(SISchemaUEISiriCarCommandContext *)self cancelled];
    if (!v23)
    {
...
{
  v13 = a3;
  v4 = [(SISchemaUEISiriCarCommandContext *)self startedOrChanged];

  if (v4)
  {
    v5 = [(SISchemaUEISiriCarCommandContext *)self startedOrChanged];
  ...
  v8 = [(SISchemaUEISiriCarCommandContext *)self failed];
  ...
  if (v10)
  {
    v12 = [(SISchemaUEISiriCarCommandContext *)self cancelled];
    PBDataWriterWriteSubmessage();
