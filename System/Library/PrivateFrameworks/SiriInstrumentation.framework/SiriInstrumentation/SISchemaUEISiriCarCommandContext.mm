...
- (SISchemaUEISiriCarCommandContext)initWithDictionary:(id)dictionary;
- (SISchemaUEISiriCarCommandContext)initWithJSON:(id)n;
...
- (SISchemaUEISiriCarCommandContext)initWithDictionary:(id)dictionary
{
  ...
  v16.receiver = self;
  v16.super_class = SISchemaUEISiriCarCommandContext;
  ...
  if (v5)
  {
    ...
    if (objc_opt_isKindOfClass())
    {
      v11 = [[SISchemaUEISiriCarCommandFailed alloc] initWithDictionary:v10];
...
- (NSData)jsonData
{
  dictionaryRepresentation = [(SISchemaUEISiriCarCommandContext *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  if (self->_cancelled)
  {
    cancelled = [(SISchemaUEISiriCarCommandContext *)self cancelled];
  ...
  if (self->_ended)
  {
    ended = [(SISchemaUEISiriCarCommandContext *)self ended];
  ...
  if (self->_failed)
  {
    failed = [(SISchemaUEISiriCarCommandContext *)self failed];
  ...
  {
    startedOrChanged = [(SISchemaUEISiriCarCommandContext *)self startedOrChanged];
...
- (unint64_t)hash
{
  v3 = [(SISchemaUEISiriCarCommandStarted *)self->_startedOrChanged hash];
  v4 = [(SISchemaUEISiriCarCommandEnded *)self->_ended hash]^ v3;
  v5 = [(SISchemaUEISiriCarCommandFailed *)self->_failed hash];
...
- (BOOL)isEqual:(id)equal
{
  ...
  startedOrChanged3 = [(SISchemaUEISiriCarCommandContext *)self startedOrChanged];
  if (startedOrChanged3)
  {
    v9 = startedOrChanged3;
    startedOrChanged4 = [(SISchemaUEISiriCarCommandContext *)self startedOrChanged];
  ...
  startedOrChanged = [(SISchemaUEISiriCarCommandContext *)self ended];
  ...
  {
    v14 = ended;
    ended2 = [(SISchemaUEISiriCarCommandContext *)self ended];
  ...
  startedOrChanged = [(SISchemaUEISiriCarCommandContext *)self failed];
  ...
  {
    v19 = failed;
    failed2 = [(SISchemaUEISiriCarCommandContext *)self failed];
  ...
  startedOrChanged = [(SISchemaUEISiriCarCommandContext *)self cancelled];
...
LABEL_26:
    ...
    v24 = cancelled;
    cancelled2 = [(SISchemaUEISiriCarCommandContext *)self cancelled];
...
- (void)writeTo:(id)to
{
  ...
  if (startedOrChanged)
  {
    startedOrChanged2 = [(SISchemaUEISiriCarCommandContext *)self startedOrChanged];
...
- (id)applySensitiveConditionsPolicy:(id)policy
{
  policyCopy = policy;
  v19.receiver = self;
  v19.super_class = SISchemaUEISiriCarCommandContext;
