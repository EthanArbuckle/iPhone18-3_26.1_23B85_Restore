...
- (NSData)jsonData;
- (SUGSchemaSUGAggregateCounts)initWithDictionary:(id)dictionary;
- (SUGSchemaSUGAggregateCounts)initWithJSON:(id)n;
- (id)dictionaryRepresentation;
- (id)suppressMessageUnderConditions;
- (unint64_t)hash;
- (void)setHasLast28DaysBucket:(BOOL)bucket;
- (void)setHasLastWeekBucket:(BOOL)bucket;
- (void)writeTo:(id)to;
@end
...
- (SUGSchemaSUGAggregateCounts)initWithDictionary:(id)dictionary
{
  ...
  if (v5)
  {
    v6 = [dictionaryCopy objectForKeyedSubscript:@"lastDayCount"];
    objc_opt_class();
    ...
    v7 = [dictionaryCopy objectForKeyedSubscript:@"lastWeekBucket"];
    objc_opt_class();
    if (objc_opt_isKindOfClass())
    {
    ...
    v8 = [dictionaryCopy objectForKeyedSubscript:@"last28DaysBucket"];
    objc_opt_class();
    if (objc_opt_isKindOfClass())
    {
...
- (NSData)jsonData
{
  dictionaryRepresentation = [(SUGSchemaSUGAggregateCounts *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  if ((has & 4) != 0)
  {
    ...
    [dictionary setObject:v7 forKeyedSubscript:@"last28DaysBucket"];
...
LABEL_3:
  ...
  [dictionary setObject:v8 forKeyedSubscript:@"lastDayCount"];

  if ((*&self->_has & 2) != 0)
  {
LABEL_4:
    v5 = [MEMORY[0x1E696AD98] numberWithUnsignedInt:{-[SUGSchemaSUGAggregateCounts lastWeekBucket](self, "lastWeekBucket")}];
    [dictionary setObject:v5 forKeyedSubscript:@"lastWeekBucket"];
  }
...
- (BOOL)isEqual:(id)equal
{
  ...
  if (*&has)
  {
    ...
    if (lastDayCount != [equalCopy lastDayCount])
    {
      goto LABEL_14;
    }
  ...
  if (v8)
  {
    ...
    if (lastWeekBucket == [equalCopy lastWeekBucket])
    {
      has = self->_has;
      v6 = equalCopy[20];
      goto LABEL_10;
...
LABEL_10:
  ...
  if (v10)
  {
    ...
    if (last28DaysBucket != [equalCopy last28DaysBucket])
    {
      goto LABEL_14;
    }
  }
