...
- (id)dictionaryRepresentation
{
  ...
  if (*&self->_has)
  {
    v4 = [(STSchemaSTDisambiguationFailed *)self reason];
  ...
  if (self->_stError)
  {
    v7 = [(STSchemaSTDisambiguationFailed *)self stError];
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ([v4 isMemberOfClass:objc_opt_class()])
  {
    if ((*&self->_has & 1) == (v4[24] & 1))
    {
      ...
      {
        v6 = [(STSchemaSTDisambiguationFailed *)self stError];
        v7 = [v4 stError];
        v8 = v7;
        if ((v6 != 0) != (v7 == 0))
        {
          v9 = [(STSchemaSTDisambiguationFailed *)self stError];
          if (!v9)
          {
...
LABEL_13:
          ...
          v10 = v9;
          v11 = [(STSchemaSTDisambiguationFailed *)self stError];
          v12 = [v4 stError];
          v13 = [v11 isEqual:v12];
...
- (void)writeTo:(id)a3
{
  ...
  v4 = [(STSchemaSTDisambiguationFailed *)self stError];
