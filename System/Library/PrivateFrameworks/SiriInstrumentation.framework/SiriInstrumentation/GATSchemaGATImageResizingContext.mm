...
- (GATSchemaGATImageResizingContext)initWithDictionary:(id)dictionary;
- (GATSchemaGATImageResizingContext)initWithJSON:(id)n;
...
- (GATSchemaGATImageResizingContext)initWithDictionary:(id)dictionary
{
  ...
  v14.receiver = self;
  v14.super_class = GATSchemaGATImageResizingContext;
  ...
  if (v5)
  {
    ...
    if (objc_opt_isKindOfClass())
    {
      v11 = [[GATSchemaGATImageResizingEventFailed alloc] initWithDictionary:v10];
...
- (NSData)jsonData
{
  dictionaryRepresentation = [(GATSchemaGATImageResizingContext *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  if (self->_ended)
  {
    ended = [(GATSchemaGATImageResizingContext *)self ended];
  ...
  if (self->_failed)
  {
    failed = [(GATSchemaGATImageResizingContext *)self failed];
  ...
  {
    startedOrChanged = [(GATSchemaGATImageResizingContext *)self startedOrChanged];
...
- (unint64_t)hash
{
  v3 = [(GATSchemaGATImageResizingEventStarted *)self->_startedOrChanged hash];
  v4 = [(GATSchemaGATImageResizingEventEnded *)self->_ended hash]^ v3;
...
- (BOOL)isEqual:(id)equal
{
  ...
  startedOrChanged3 = [(GATSchemaGATImageResizingContext *)self startedOrChanged];
  if (startedOrChanged3)
  {
    v9 = startedOrChanged3;
    startedOrChanged4 = [(GATSchemaGATImageResizingContext *)self startedOrChanged];
  ...
  startedOrChanged = [(GATSchemaGATImageResizingContext *)self ended];
  ...
  {
    v14 = ended;
    ended2 = [(GATSchemaGATImageResizingContext *)self ended];
  ...
  startedOrChanged = [(GATSchemaGATImageResizingContext *)self failed];
...
LABEL_21:
    ...
    v19 = failed;
    failed2 = [(GATSchemaGATImageResizingContext *)self failed];
...
- (void)writeTo:(id)to
{
  ...
  if (startedOrChanged)
  {
    startedOrChanged2 = [(GATSchemaGATImageResizingContext *)self startedOrChanged];
...
- (id)applySensitiveConditionsPolicy:(id)policy
{
  policyCopy = policy;
  v16.receiver = self;
  v16.super_class = GATSchemaGATImageResizingContext;
