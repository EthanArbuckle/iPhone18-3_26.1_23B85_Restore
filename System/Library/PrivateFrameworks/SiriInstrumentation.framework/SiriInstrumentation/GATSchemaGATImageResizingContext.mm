...
- (id)dictionaryRepresentation
{
  ...
  if (self->_ended)
  {
    v4 = [(GATSchemaGATImageResizingContext *)self ended];
  ...
  if (self->_failed)
  {
    v7 = [(GATSchemaGATImageResizingContext *)self failed];
...
- (BOOL)isEqual:(id)a3
{
  ...
  v8 = [(GATSchemaGATImageResizingContext *)self startedOrChanged];
  if (v8)
  {
    v9 = v8;
    v10 = [(GATSchemaGATImageResizingContext *)self startedOrChanged];
  ...
  v13 = [(GATSchemaGATImageResizingContext *)self ended];
  if (v13)
  {
    v14 = v13;
  ...
  if ((v6 != 0) != (v7 == 0))
  {
    v18 = [(GATSchemaGATImageResizingContext *)self failed];
    if (!v18)
    {
...
{
  v11 = a3;
  v4 = [(GATSchemaGATImageResizingContext *)self startedOrChanged];
  ...
  if (v6)
  {
    v7 = [(GATSchemaGATImageResizingContext *)self ended];
    PBDataWriterWriteSubmessage();
  }

  v8 = [(GATSchemaGATImageResizingContext *)self failed];

  v9 = v11;
  if (v8)
  {
    v10 = [(GATSchemaGATImageResizingContext *)self failed];
    PBDataWriterWriteSubmessage();
