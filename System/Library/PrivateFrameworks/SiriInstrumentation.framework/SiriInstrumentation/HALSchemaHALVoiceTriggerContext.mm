...
- (BOOL)isEqual:(id)a3
{
  ...
  if ([v4 isMemberOfClass:objc_opt_class()])
  {
    ...
    {
      if ((*&self->_has & 1) == 0 || (timeSinceVoiceTriggerHeardInSeconds = self->_timeSinceVoiceTriggerHeardInSeconds, timeSinceVoiceTriggerHeardInSeconds == [v4 timeSinceVoiceTriggerHeardInSeconds]))
      {
        v6 = 1;
      }
    }
