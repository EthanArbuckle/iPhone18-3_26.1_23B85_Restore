...
- (BOOL)isEqual:(id)a3;
- (GATSchemaGATConfirmationSnippetUserActioned)initWithDictionary:(id)a3;
- (GATSchemaGATConfirmationSnippetUserActioned)initWithJSON:(id)a3;
- (NSData)jsonData;
...
- (NSData)jsonData
{
  v2 = [(GATSchemaGATConfirmationSnippetUserActioned *)self dictionaryRepresentation];
