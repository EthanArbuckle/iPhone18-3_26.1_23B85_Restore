...
- (id)dictionaryRepresentation
{
  ...
  if (self->_trpId)
  {
    v4 = [(TTMSchemaTTMClientEventMetadata *)self trpId];
  ...
  if (self->_ttmId)
  {
    v7 = [(TTMSchemaTTMClientEventMetadata *)self ttmId];
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ((v5 != 0) != (v6 == 0))
  {
    v12 = [(TTMSchemaTTMClientEventMetadata *)self trpId];
    if (!v12)
    {
...
{
  v8 = a3;
  v4 = [(TTMSchemaTTMClientEventMetadata *)self ttmId];
  ...
  if (v6)
  {
    v7 = [(TTMSchemaTTMClientEventMetadata *)self trpId];
    PBDataWriterWriteSubmessage();
  }
}
