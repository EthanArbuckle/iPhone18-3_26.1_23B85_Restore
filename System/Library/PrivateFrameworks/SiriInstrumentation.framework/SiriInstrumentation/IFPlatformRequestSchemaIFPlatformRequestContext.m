...
- (id)dictionaryRepresentation
{
  ...
  if (self->_ended)
  {
    v4 = [(IFPlatformRequestSchemaIFPlatformRequestContext *)self ended];
  ...
  if (self->_failed)
  {
    v7 = [(IFPlatformRequestSchemaIFPlatformRequestContext *)self failed];
...
- (BOOL)isEqual:(id)a3
{
  ...
  v8 = [(IFPlatformRequestSchemaIFPlatformRequestContext *)self startedOrChanged];
  if (v8)
  {
    v9 = v8;
    v10 = [(IFPlatformRequestSchemaIFPlatformRequestContext *)self startedOrChanged];
  ...
  v13 = [(IFPlatformRequestSchemaIFPlatformRequestContext *)self ended];
  if (v13)
  {
    v14 = v13;
  ...
  v18 = [(IFPlatformRequestSchemaIFPlatformRequestContext *)self failed];
  if (v18)
  {
    v19 = v18;
  ...
  if ((v6 != 0) != (v7 == 0))
  {
    v23 = [(IFPlatformRequestSchemaIFPlatformRequestContext *)self traceId];
    if (!v23)
    {
...
{
  v13 = a3;
  v4 = [(IFPlatformRequestSchemaIFPlatformRequestContext *)self startedOrChanged];

  if (v4)
  {
    v5 = [(IFPlatformRequestSchemaIFPlatformRequestContext *)self startedOrChanged];
  ...
  if (v6)
  {
    v7 = [(IFPlatformRequestSchemaIFPlatformRequestContext *)self ended];
    PBDataWriterWriteSubmessage();
  }

  v8 = [(IFPlatformRequestSchemaIFPlatformRequestContext *)self failed];
  ...
  if (v10)
  {
    v12 = [(IFPlatformRequestSchemaIFPlatformRequestContext *)self traceId];
    PBDataWriterWriteSubmessage();
