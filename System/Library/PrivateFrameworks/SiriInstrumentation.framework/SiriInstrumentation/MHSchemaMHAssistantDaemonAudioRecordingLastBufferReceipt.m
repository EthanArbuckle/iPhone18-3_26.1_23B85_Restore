...
- (BOOL)isEqual:(id)a3
{
  ...
  if ([v4 isMemberOfClass:objc_opt_class()])
  {
    ...
    {
      if ((*&self->_has & 1) == 0 || (lastAudioRecordBufferReceiptTimeOffsetInNs = self->_lastAudioRecordBufferReceiptTimeOffsetInNs, lastAudioRecordBufferReceiptTimeOffsetInNs == [v4 lastAudioRecordBufferReceiptTimeOffsetInNs]))
      {
        v6 = 1;
      }
    }
