...
- (id)dictionaryRepresentation
{
  ...
  if (self->_ended)
  {
    v4 = [(PGSchemaPGModelInferenceContext *)self ended];
  ...
  if (self->_failed)
  {
    v7 = [(PGSchemaPGModelInferenceContext *)self failed];
  ...
  if (self->_traceId)
  {
    v13 = [(PGSchemaPGModelInferenceContext *)self traceId];
...
- (BOOL)isEqual:(id)a3
{
  ...
  v8 = [(PGSchemaPGModelInferenceContext *)self startedOrChanged];
  if (v8)
  {
    v9 = v8;
    v10 = [(PGSchemaPGModelInferenceContext *)self startedOrChanged];
  ...
  v13 = [(PGSchemaPGModelInferenceContext *)self ended];
  if (v13)
  {
    v14 = v13;
  ...
  v18 = [(PGSchemaPGModelInferenceContext *)self failed];
  if (v18)
  {
    v19 = v18;
  ...
  v6 = [(PGSchemaPGModelInferenceContext *)self traceId];
  v7 = [v4 traceId];
  if ((v6 != 0) != (v7 == 0))
  {
    v23 = [(PGSchemaPGModelInferenceContext *)self traceId];
    if (!v23)
    {
...
LABEL_26:
    ...
    v24 = v23;
    v25 = [(PGSchemaPGModelInferenceContext *)self traceId];
    v26 = [v4 traceId];
    v27 = [v25 isEqual:v26];
...
{
  v13 = a3;
  v4 = [(PGSchemaPGModelInferenceContext *)self startedOrChanged];
  ...
  if (v6)
  {
    v7 = [(PGSchemaPGModelInferenceContext *)self ended];
    PBDataWriterWriteSubmessage();
  }

  v8 = [(PGSchemaPGModelInferenceContext *)self failed];
  ...
  v10 = [(PGSchemaPGModelInferenceContext *)self traceId];

  v11 = v13;
  if (v10)
  {
    v12 = [(PGSchemaPGModelInferenceContext *)self traceId];
    PBDataWriterWriteSubmessage();
...
- (id)applySensitiveConditionsPolicy:(id)a3
{
  ...
  v15 = [(PGSchemaPGModelInferenceContext *)self traceId];
