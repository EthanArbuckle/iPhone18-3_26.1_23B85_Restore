...
- (PLUSSchemaPLUSMediaSuggestionSource)initWithDictionary:(id)a3
{
  v4 = a3;
  v9.receiver = self;
  v9.super_class = PLUSSchemaPLUSMediaSuggestionSource;
...
- (id)dictionaryRepresentation
{
  ...
  if (*&self->_has)
  {
    ...
    {
      v4 = @"PLUSMEDIASUGGESTIONSOURCE_PLUS_INFERRED_MEDIA_SUGGESTER";
    }

    else
    {
      v4 = @"PLUSMEDIASUGGESTIONSOURCE_UNKNOWN";
    }
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ([v4 isMemberOfClass:objc_opt_class()])
  {
    ...
    {
      if ((*&self->_has & 1) == 0 || (sourceType = self->_sourceType, sourceType == [v4 sourceType]))
      {
        v6 = 1;
      }
    }
