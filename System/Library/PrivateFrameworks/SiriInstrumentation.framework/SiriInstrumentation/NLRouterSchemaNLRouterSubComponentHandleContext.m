...
- (id)dictionaryRepresentation
{
  ...
  if (self->_contextId)
  {
    v4 = [(NLRouterSchemaNLRouterSubComponentHandleContext *)self contextId];
  ...
  if (self->_ended)
  {
    v7 = [(NLRouterSchemaNLRouterSubComponentHandleContext *)self ended];
...
- (BOOL)isEqual:(id)a3
{
  ...
  v8 = [(NLRouterSchemaNLRouterSubComponentHandleContext *)self contextId];
  if (v8)
  {
    v9 = v8;
  ...
  v6 = [(NLRouterSchemaNLRouterSubComponentHandleContext *)self startedOrChanged];
  ...
  v6 = [(NLRouterSchemaNLRouterSubComponentHandleContext *)self ended];
  v7 = [v4 ended];
  if ((v6 != 0) == (v7 == 0))
  {
    goto LABEL_27;
  ...
  v18 = [(NLRouterSchemaNLRouterSubComponentHandleContext *)self ended];
  if (v18)
  {
    v19 = v18;
    v20 = [(NLRouterSchemaNLRouterSubComponentHandleContext *)self ended];
    v21 = [v4 ended];
    v22 = [v20 isEqual:v21];
  ...
  v6 = [(NLRouterSchemaNLRouterSubComponentHandleContext *)self failed];
  v7 = [v4 failed];
  if ((v6 != 0) == (v7 == 0))
  {
    goto LABEL_27;
  ...
  v23 = [(NLRouterSchemaNLRouterSubComponentHandleContext *)self failed];
  if (v23)
  {
    v24 = v23;
  ...
  v6 = [(NLRouterSchemaNLRouterSubComponentHandleContext *)self traceId];
  v7 = [v4 traceId];
  if ((v6 != 0) != (v7 == 0))
  {
    v28 = [(NLRouterSchemaNLRouterSubComponentHandleContext *)self traceId];
    if (!v28)
    {
...
- (void)writeTo:(id)a3
{
  ...
  if (v4)
  {
    v5 = [(NLRouterSchemaNLRouterSubComponentHandleContext *)self contextId];
  ...
  if (v6)
  {
    v7 = [(NLRouterSchemaNLRouterSubComponentHandleContext *)self startedOrChanged];
    PBDataWriterWriteSubmessage();
  }

  v8 = [(NLRouterSchemaNLRouterSubComponentHandleContext *)self ended];
  ...
  if (v10)
  {
    v11 = [(NLRouterSchemaNLRouterSubComponentHandleContext *)self failed];
    PBDataWriterWriteSubmessage();
  }

  v12 = [(NLRouterSchemaNLRouterSubComponentHandleContext *)self traceId];

  v13 = v15;
  if (v12)
  {
    v14 = [(NLRouterSchemaNLRouterSubComponentHandleContext *)self traceId];
    PBDataWriterWriteSubmessage();
