...
- (id)dictionaryRepresentation
{
  ...
  if (*&self->_has)
  {
    v4 = [(STSchemaSTHallucinationDetectionStarted *)self hallucinationDetectionSource];
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ([v4 isMemberOfClass:objc_opt_class()])
  {
    ...
    {
      if ((*&self->_has & 1) == 0 || (hallucinationDetectionSource = self->_hallucinationDetectionSource, hallucinationDetectionSource == [v4 hallucinationDetectionSource]))
      {
        v6 = 1;
      }
    }
