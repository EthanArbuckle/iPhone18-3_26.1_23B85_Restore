...
- (id)dictionaryRepresentation
{
  ...
  if (self->_ended)
  {
    v4 = [(SMTSchemaSMTAppLanguageModelBuildContext *)self ended];
  ...
  if (self->_failed)
  {
    v7 = [(SMTSchemaSMTAppLanguageModelBuildContext *)self failed];
...
- (BOOL)isEqual:(id)a3
{
  ...
  v8 = [(SMTSchemaSMTAppLanguageModelBuildContext *)self startedOrChanged];
  if (v8)
  {
    v9 = v8;
    v10 = [(SMTSchemaSMTAppLanguageModelBuildContext *)self startedOrChanged];
  ...
  v13 = [(SMTSchemaSMTAppLanguageModelBuildContext *)self ended];
  if (v13)
  {
    v14 = v13;
  ...
  if ((v6 != 0) != (v7 == 0))
  {
    v18 = [(SMTSchemaSMTAppLanguageModelBuildContext *)self failed];
    if (!v18)
    {
...
{
  v11 = a3;
  v4 = [(SMTSchemaSMTAppLanguageModelBuildContext *)self startedOrChanged];
  ...
  if (v6)
  {
    v7 = [(SMTSchemaSMTAppLanguageModelBuildContext *)self ended];
    PBDataWriterWriteSubmessage();
  }

  v8 = [(SMTSchemaSMTAppLanguageModelBuildContext *)self failed];

  v9 = v11;
  if (v8)
  {
    v10 = [(SMTSchemaSMTAppLanguageModelBuildContext *)self failed];
    PBDataWriterWriteSubmessage();
