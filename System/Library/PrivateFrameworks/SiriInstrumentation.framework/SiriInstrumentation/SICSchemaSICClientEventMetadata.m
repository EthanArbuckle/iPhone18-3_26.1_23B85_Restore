...
- (id)dictionaryRepresentation
{
  ...
  if (self->_requestId)
  {
    v4 = [(SICSchemaSICClientEventMetadata *)self requestId];
  ...
  if (self->_sicId)
  {
    v7 = [(SICSchemaSICClientEventMetadata *)self sicId];
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ((v5 != 0) != (v6 == 0))
  {
    v12 = [(SICSchemaSICClientEventMetadata *)self requestId];
    if (!v12)
    {
...
{
  v8 = a3;
  v4 = [(SICSchemaSICClientEventMetadata *)self sicId];
  ...
  if (v6)
  {
    v7 = [(SICSchemaSICClientEventMetadata *)self requestId];
    PBDataWriterWriteSubmessage();
  }
}
