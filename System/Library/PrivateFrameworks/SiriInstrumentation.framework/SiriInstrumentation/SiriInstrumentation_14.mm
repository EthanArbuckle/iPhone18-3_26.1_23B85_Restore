...
uint64_t FLOWSchemaFLOWSPORTSExecutionReadFrom(void *a1, void *a2)
{
  for (i = a2; ; i = a2)
  {
    v5 = [i position];
...
LABEL_92:
          [a1 setIsSportsWatchFaceRequest:v50];
          continue;
        case 3:
          v15 = 0;
          v16 = 0;
          ...
          v21 = (v17 != 0) & ~[a2 hasError];
LABEL_88:
          [a1 setIsSnippetNextCardRequest:v21];
          continue;
      }
    }
...
uint64_t FLOWSchemaFLOWSportsExecutionTier1ReadFrom(void *a1, void *a2)
{
  for (i = a2; ; i = a2)
  {
    v5 = [i position];
...
uint64_t FLOWSchemaFLOWTextMessageLengthReadFrom(void *a1, void *a2)
{
  for (i = a2; ; i = a2)
  {
    v5 = [i position];
