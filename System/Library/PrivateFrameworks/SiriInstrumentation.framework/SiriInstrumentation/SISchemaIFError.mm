...
- (NSData)jsonData;
- (SISchemaIFError)initWithDictionary:(id)dictionary;
- (SISchemaIFError)initWithJSON:(id)n;
...
- (NSData)jsonData
{
  dictionaryRepresentation = [(SISchemaIFError *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  if (self->_domain)
  {
    domain = [(SISchemaIFError *)self domain];
    v6 = [domain copy];
...
LABEL_12:
  ...
  domain3 = [(SISchemaIFError *)self domain];
  if (domain3)
  {
    v9 = domain3;
    domain4 = [(SISchemaIFError *)self domain];
