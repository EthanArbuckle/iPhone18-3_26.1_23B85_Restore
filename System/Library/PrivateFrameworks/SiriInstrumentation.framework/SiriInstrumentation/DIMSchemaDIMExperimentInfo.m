...
- (id)dictionaryRepresentation
{
  ...
  {
    v7 = [(DIMSchemaDIMExperimentInfo *)self treatmentId];
...
- (BOOL)isEqual:(id)a3
{
  ...
  v7 = [(DIMSchemaDIMExperimentInfo *)self experimentId];
  if (v7)
  {
    v8 = v7;
    v9 = [(DIMSchemaDIMExperimentInfo *)self experimentId];
    v10 = [v4 experimentId];
    v11 = [v9 isEqual:v10];
  ...
  v5 = [(DIMSchemaDIMExperimentInfo *)self treatmentId];
  v6 = [v4 treatmentId];
  if ((v5 != 0) == (v6 == 0))
  {
LABEL_11:
  ...
  v12 = [(DIMSchemaDIMExperimentInfo *)self treatmentId];
  if (v12)
  {
    v13 = v12;
...
{
  v7 = a3;
  v4 = [(DIMSchemaDIMExperimentInfo *)self experimentId];
