...
- (FLOWLINKSchemaFLOWLINKActionExecutionContext)initWithDictionary:(id)a3
{
  v4 = a3;
  v12.receiver = self;
  v12.super_class = FLOWLINKSchemaFLOWLINKActionExecutionContext;
...
- (id)dictionaryRepresentation
{
  ...
  if (self->_ended)
  {
    v4 = [(FLOWLINKSchemaFLOWLINKActionExecutionContext *)self ended];
  ...
  {
    v7 = [(FLOWLINKSchemaFLOWLINKActionExecutionContext *)self startedOrChanged];
...
- (BOOL)isEqual:(id)a3
{
  ...
  v8 = [(FLOWLINKSchemaFLOWLINKActionExecutionContext *)self startedOrChanged];
  if (v8)
  {
    v9 = v8;
  ...
  if ((v6 != 0) != (v7 == 0))
  {
    v13 = [(FLOWLINKSchemaFLOWLINKActionExecutionContext *)self ended];
    if (!v13)
    {
...
{
  v8 = a3;
  v4 = [(FLOWLINKSchemaFLOWLINKActionExecutionContext *)self startedOrChanged];
  ...
  if (v6)
  {
    v7 = [(FLOWLINKSchemaFLOWLINKActionExecutionContext *)self ended];
    PBDataWriterWriteSubmessage();
  }
}
...
- (id)applySensitiveConditionsPolicy:(id)a3
{
  v4 = a3;
  v13.receiver = self;
  v13.super_class = FLOWLINKSchemaFLOWLINKActionExecutionContext;
