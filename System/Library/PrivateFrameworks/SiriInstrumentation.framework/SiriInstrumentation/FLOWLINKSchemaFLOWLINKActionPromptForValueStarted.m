...
- (id)dictionaryRepresentation
{
  ...
  if (self->_parameter)
  {
    v4 = [(FLOWLINKSchemaFLOWLINKActionPromptForValueStarted *)self parameter];
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ([v4 isMemberOfClass:objc_opt_class()])
  {
    ...
    if ((v5 != 0) != (v6 == 0))
    {
      v8 = [(FLOWLINKSchemaFLOWLINKActionPromptForValueStarted *)self parameter];
      if (!v8)
      {
...
LABEL_10:
      ...
      v9 = v8;
      v10 = [(FLOWLINKSchemaFLOWLINKActionPromptForValueStarted *)self parameter];
      v11 = [v4 parameter];
      v12 = [v10 isEqual:v11];
