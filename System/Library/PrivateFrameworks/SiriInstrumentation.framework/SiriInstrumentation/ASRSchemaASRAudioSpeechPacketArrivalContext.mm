...
- (ASRSchemaASRAudioSpeechPacketArrivalContext)initWithDictionary:(id)dictionary;
- (ASRSchemaASRAudioSpeechPacketArrivalContext)initWithJSON:(id)n;
...
- (NSData)jsonData
{
  dictionaryRepresentation = [(ASRSchemaASRAudioSpeechPacketArrivalContext *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  if (self->_ended)
  {
    ended = [(ASRSchemaASRAudioSpeechPacketArrivalContext *)self ended];
  ...
  {
    startedOrChanged = [(ASRSchemaASRAudioSpeechPacketArrivalContext *)self startedOrChanged];
...
- (BOOL)isEqual:(id)equal
{
  ...
  startedOrChanged3 = [(ASRSchemaASRAudioSpeechPacketArrivalContext *)self startedOrChanged];
  if (startedOrChanged3)
  {
    v9 = startedOrChanged3;
    startedOrChanged4 = [(ASRSchemaASRAudioSpeechPacketArrivalContext *)self startedOrChanged];
  ...
  startedOrChanged = [(ASRSchemaASRAudioSpeechPacketArrivalContext *)self ended];
...
LABEL_16:
    ...
    v14 = ended;
    ended2 = [(ASRSchemaASRAudioSpeechPacketArrivalContext *)self ended];
...
- (void)writeTo:(id)to
{
  ...
  if (startedOrChanged)
  {
    startedOrChanged2 = [(ASRSchemaASRAudioSpeechPacketArrivalContext *)self startedOrChanged];
