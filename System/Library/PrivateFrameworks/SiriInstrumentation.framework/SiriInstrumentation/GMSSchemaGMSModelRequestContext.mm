...
- (id)dictionaryRepresentation
{
  ...
  if (self->_ended)
  {
    v4 = [(GMSSchemaGMSModelRequestContext *)self ended];
  ...
  if (self->_failed)
  {
    v7 = [(GMSSchemaGMSModelRequestContext *)self failed];
...
- (BOOL)isEqual:(id)a3
{
  ...
  v8 = [(GMSSchemaGMSModelRequestContext *)self started];
  if (v8)
  {
    v9 = v8;
    v10 = [(GMSSchemaGMSModelRequestContext *)self started];
  ...
  v13 = [(GMSSchemaGMSModelRequestContext *)self ended];
  if (v13)
  {
    v14 = v13;
  ...
  if ((v6 != 0) != (v7 == 0))
  {
    v18 = [(GMSSchemaGMSModelRequestContext *)self failed];
    if (!v18)
    {
...
{
  v11 = a3;
  v4 = [(GMSSchemaGMSModelRequestContext *)self started];
  ...
  if (v6)
  {
    v7 = [(GMSSchemaGMSModelRequestContext *)self ended];
    PBDataWriterWriteSubmessage();
  }

  v8 = [(GMSSchemaGMSModelRequestContext *)self failed];

  v9 = v11;
  if (v8)
  {
    v10 = [(GMSSchemaGMSModelRequestContext *)self failed];
    PBDataWriterWriteSubmessage();
