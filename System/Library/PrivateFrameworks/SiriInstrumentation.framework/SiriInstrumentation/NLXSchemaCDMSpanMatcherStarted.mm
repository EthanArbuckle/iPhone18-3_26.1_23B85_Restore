...
- (NLXSchemaCDMSpanMatcherStarted)initWithDictionary:(id)dictionary;
- (NLXSchemaCDMSpanMatcherStarted)initWithJSON:(id)n;
- (NSData)jsonData;
...
- (NLXSchemaCDMSpanMatcherStarted)initWithDictionary:(id)dictionary
{
  ...
  v9.receiver = self;
  v9.super_class = NLXSchemaCDMSpanMatcherStarted;
...
- (NSData)jsonData
{
  dictionaryRepresentation = [(NLXSchemaCDMSpanMatcherStarted *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  if (*&self->_has)
  {
    v4 = [(NLXSchemaCDMSpanMatcherStarted *)self name]- 1;
    if (v4 > 8)
    {
