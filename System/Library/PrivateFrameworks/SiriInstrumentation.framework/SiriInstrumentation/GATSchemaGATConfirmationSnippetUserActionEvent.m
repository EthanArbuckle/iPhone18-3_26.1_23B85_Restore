...
- (BOOL)isEqual:(id)a3;
- (GATSchemaGATConfirmationSnippetUserActionEvent)initWithDictionary:(id)a3;
- (GATSchemaGATConfirmationSnippetUserActionEvent)initWithJSON:(id)a3;
- (NSData)jsonData;
...
- (NSData)jsonData
{
  v2 = [(GATSchemaGATConfirmationSnippetUserActionEvent *)self dictionaryRepresentation];
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ([v4 isMemberOfClass:objc_opt_class()])
  {
    ...
    {
      if ((*&self->_has & 1) == 0 || (outcome = self->_outcome, outcome == [v4 outcome]))
      {
        v6 = 1;
      }
    }
