...
- (id)dictionaryRepresentation
{
  ...
  if (self->_ended)
  {
    v4 = [(RGSiriSchemaRGGMSCallContext *)self ended];
  ...
  if (self->_failed)
  {
    v7 = [(RGSiriSchemaRGGMSCallContext *)self failed];
...
- (BOOL)isEqual:(id)a3
{
  ...
  v8 = [(RGSiriSchemaRGGMSCallContext *)self startedOrChanged];
  if (v8)
  {
    v9 = v8;
    v10 = [(RGSiriSchemaRGGMSCallContext *)self startedOrChanged];
  ...
  v13 = [(RGSiriSchemaRGGMSCallContext *)self ended];
  if (v13)
  {
    v14 = v13;
  ...
  v18 = [(RGSiriSchemaRGGMSCallContext *)self failed];
  if (v18)
  {
    v19 = v18;
  ...
  if ((v6 != 0) != (v7 == 0))
  {
    v23 = [(RGSiriSchemaRGGMSCallContext *)self traceId];
    if (!v23)
    {
...
{
  v13 = a3;
  v4 = [(RGSiriSchemaRGGMSCallContext *)self startedOrChanged];

  if (v4)
  {
    v5 = [(RGSiriSchemaRGGMSCallContext *)self startedOrChanged];
  ...
  if (v6)
  {
    v7 = [(RGSiriSchemaRGGMSCallContext *)self ended];
    PBDataWriterWriteSubmessage();
  }

  v8 = [(RGSiriSchemaRGGMSCallContext *)self failed];
  ...
  if (v10)
  {
    v12 = [(RGSiriSchemaRGGMSCallContext *)self traceId];
    PBDataWriterWriteSubmessage();
