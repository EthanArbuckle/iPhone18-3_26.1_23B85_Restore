...
- (ASRSpeechProfileSchemaASRSpeechProfileUpdateFailed)initWithDictionary:(id)a3;
- (ASRSpeechProfileSchemaASRSpeechProfileUpdateFailed)initWithJSON:(id)a3;
- (BOOL)isEqual:(id)a3;
- (NSData)jsonData;
...
- (ASRSpeechProfileSchemaASRSpeechProfileUpdateFailed)initWithDictionary:(id)a3
{
  ...
  if (v5)
  {
    v6 = [v4 objectForKeyedSubscript:@"speechProfileUpdateFailureReason"];
    objc_opt_class();
...
- (NSData)jsonData
{
  v2 = [(ASRSpeechProfileSchemaASRSpeechProfileUpdateFailed *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  if (*&self->_has)
  {
    ...
    [v3 setObject:v5 forKeyedSubscript:@"speechProfileUpdateFailureReason"];
  }
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ([v4 isMemberOfClass:objc_opt_class()])
  {
    ...
    {
      if ((*&self->_has & 1) == 0 || (speechProfileUpdateFailureReason = self->_speechProfileUpdateFailureReason, speechProfileUpdateFailureReason == [v4 speechProfileUpdateFailureReason]))
      {
        v6 = 1;
      }
    }
