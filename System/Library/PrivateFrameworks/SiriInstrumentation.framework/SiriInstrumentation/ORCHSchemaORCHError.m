...
- (BOOL)isEqual:(id)a3;
- (NSData)jsonData;
- (ORCHSchemaORCHError)initWithDictionary:(id)a3;
- (ORCHSchemaORCHError)initWithJSON:(id)a3;
...
- (NSData)jsonData
{
  v2 = [(ORCHSchemaORCHError *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  {
    v5 = [(ORCHSchemaORCHError *)self errorDomain];
    v6 = [v5 copy];
...
LABEL_12:
  ...
  v8 = [(ORCHSchemaORCHError *)self errorDomain];
  if (v8)
  {
    v9 = v8;
    v10 = [(ORCHSchemaORCHError *)self errorDomain];
    v11 = [v4 errorDomain];
    v12 = [v10 isEqual:v11];
...
{
  v5 = a3;
  v4 = [(ORCHSchemaORCHError *)self errorDomain];
