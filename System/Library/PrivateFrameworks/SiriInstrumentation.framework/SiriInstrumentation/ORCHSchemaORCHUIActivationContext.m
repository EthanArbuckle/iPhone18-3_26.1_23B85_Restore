...
- (id)dictionaryRepresentation
{
  ...
  if (self->_ended)
  {
    v4 = [(ORCHSchemaORCHUIActivationContext *)self ended];
  ...
  {
    v7 = [(ORCHSchemaORCHUIActivationContext *)self startedOrChanged];
...
- (BOOL)isEqual:(id)a3
{
  ...
  v8 = [(ORCHSchemaORCHUIActivationContext *)self startedOrChanged];
  if (v8)
  {
    v9 = v8;
  ...
  v13 = [(ORCHSchemaORCHUIActivationContext *)self ended];
  if (v13)
  {
    v14 = v13;
  ...
  if ((v6 != 0) != (v7 == 0))
  {
    v18 = [(ORCHSchemaORCHUIActivationContext *)self trpId];
    if (!v18)
    {
...
{
  v11 = a3;
  v4 = [(ORCHSchemaORCHUIActivationContext *)self startedOrChanged];
  ...
  if (v6)
  {
    v7 = [(ORCHSchemaORCHUIActivationContext *)self ended];
    PBDataWriterWriteSubmessage();
  }

  v8 = [(ORCHSchemaORCHUIActivationContext *)self trpId];
