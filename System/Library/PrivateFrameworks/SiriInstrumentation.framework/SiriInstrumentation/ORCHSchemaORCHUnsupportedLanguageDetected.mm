...
- (NSData)jsonData;
- (ORCHSchemaORCHUnsupportedLanguageDetected)initWithDictionary:(id)dictionary;
- (ORCHSchemaORCHUnsupportedLanguageDetected)initWithJSON:(id)n;
...
- (ORCHSchemaORCHUnsupportedLanguageDetected)initWithDictionary:(id)dictionary
{
  ...
  if (v5)
  {
    v6 = [dictionaryCopy objectForKeyedSubscript:@"languageDetected"];
    objc_opt_class();
...
- (NSData)jsonData
{
  dictionaryRepresentation = [(ORCHSchemaORCHUnsupportedLanguageDetected *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  if (*&self->_has)
  {
    ...
    [dictionary setObject:v5 forKeyedSubscript:@"languageDetected"];
  }
...
- (BOOL)isEqual:(id)equal
{
  ...
  if ([equalCopy isMemberOfClass:objc_opt_class()])
  {
    ...
    {
      if ((*&self->_has & 1) == 0 || (languageDetected = self->_languageDetected, languageDetected == [equalCopy languageDetected]))
      {
        v6 = 1;
      }
    }
