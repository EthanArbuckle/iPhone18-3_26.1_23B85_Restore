...
- (NSData)jsonData;
- (RTSSchemaRTSSecondPassPolicyDecisionMade)initWithDictionary:(id)dictionary;
- (RTSSchemaRTSSecondPassPolicyDecisionMade)initWithJSON:(id)n;
...
- (NSData)jsonData
{
  dictionaryRepresentation = [(RTSSchemaRTSSecondPassPolicyDecisionMade *)self dictionaryRepresentation];
