...
- (JRSchemaJRExperimentTriggered)initWithDictionary:(id)dictionary;
- (JRSchemaJRExperimentTriggered)initWithJSON:(id)n;
- (NSData)jsonData;
...
- (NSData)jsonData
{
  dictionaryRepresentation = [(JRSchemaJRExperimentTriggered *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  if (self->_codepathId)
  {
    codepathId = [(JRSchemaJRExperimentTriggered *)self codepathId];
...
- (BOOL)isEqual:(id)equal
{
  ...
  allocations = [(JRSchemaJRExperimentTriggered *)self allocations];
  ...
  allocations3 = [(JRSchemaJRExperimentTriggered *)self allocations];
  if (allocations3)
  {
    v8 = allocations3;
    allocations4 = [(JRSchemaJRExperimentTriggered *)self allocations];
  ...
  allocations = [(JRSchemaJRExperimentTriggered *)self codepathId];
...
LABEL_15:
    ...
    v13 = codepathId;
    codepathId2 = [(JRSchemaJRExperimentTriggered *)self codepathId];
