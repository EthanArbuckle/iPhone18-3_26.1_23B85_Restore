...
- (id)dictionaryRepresentation
{
  ...
  if (self->_ended)
  {
    v4 = [(RGSiriSchemaRGHallucinationDetectionContext *)self ended];
  ...
  if (self->_failed)
  {
    v7 = [(RGSiriSchemaRGHallucinationDetectionContext *)self failed];
...
- (BOOL)isEqual:(id)a3
{
  ...
  v8 = [(RGSiriSchemaRGHallucinationDetectionContext *)self startedOrChanged];
  if (v8)
  {
    v9 = v8;
    v10 = [(RGSiriSchemaRGHallucinationDetectionContext *)self startedOrChanged];
  ...
  v13 = [(RGSiriSchemaRGHallucinationDetectionContext *)self ended];
  if (v13)
  {
    v14 = v13;
  ...
  if ((v6 != 0) != (v7 == 0))
  {
    v18 = [(RGSiriSchemaRGHallucinationDetectionContext *)self failed];
    if (!v18)
    {
...
{
  v11 = a3;
  v4 = [(RGSiriSchemaRGHallucinationDetectionContext *)self startedOrChanged];
  ...
  if (v6)
  {
    v7 = [(RGSiriSchemaRGHallucinationDetectionContext *)self ended];
    PBDataWriterWriteSubmessage();
  }

  v8 = [(RGSiriSchemaRGHallucinationDetectionContext *)self failed];

  v9 = v11;
  if (v8)
  {
    v10 = [(RGSiriSchemaRGHallucinationDetectionContext *)self failed];
    PBDataWriterWriteSubmessage();
