...
- (BOOL)isEqual:(id)a3;
- (NSData)jsonData;
- (PGSchemaPGGeneratePlanFailed)initWithDictionary:(id)a3;
- (PGSchemaPGGeneratePlanFailed)initWithJSON:(id)a3;
...
- (NSData)jsonData
{
  v2 = [(PGSchemaPGGeneratePlanFailed *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  {
    v4 = [(PGSchemaPGGeneratePlanFailed *)self criticalError];
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    v5 = [(PGSchemaPGGeneratePlanFailed *)self criticalError];
    v6 = [v4 criticalError];
    v7 = v6;
    if ((v5 != 0) != (v6 == 0))
    {
      v8 = [(PGSchemaPGGeneratePlanFailed *)self criticalError];
      if (!v8)
      {
...
LABEL_10:
      ...
      v9 = v8;
      v10 = [(PGSchemaPGGeneratePlanFailed *)self criticalError];
