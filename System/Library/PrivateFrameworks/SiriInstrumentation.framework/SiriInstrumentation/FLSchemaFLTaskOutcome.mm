...
- (FLSchemaFLTaskOutcome)initWithDictionary:(id)dictionary;
- (FLSchemaFLTaskOutcome)initWithJSON:(id)n;
- (NSData)jsonData;
- (id)dictionaryRepresentation;
- (id)suppressMessageUnderConditions;
- (unint64_t)hash;
- (void)setHasPromptStatus:(BOOL)status;
- (void)writeTo:(id)to;
@end
...
- (FLSchemaFLTaskOutcome)initWithDictionary:(id)dictionary
{
  ...
  if (v5)
  {
    v6 = [dictionaryCopy objectForKeyedSubscript:@"taskStatus"];
    objc_opt_class();
    ...
    v7 = [dictionaryCopy objectForKeyedSubscript:@"promptStatus"];
    objc_opt_class();
    if (objc_opt_isKindOfClass())
    {
...
- (NSData)jsonData
{
  dictionaryRepresentation = [(FLSchemaFLTaskOutcome *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  if ((has & 2) != 0)
  {
    ...
    [dictionary setObject:v6 forKeyedSubscript:@"promptStatus"];
    has = self->_has;
  }
  ...
  if (has)
  {
    ...
    [dictionary setObject:v8 forKeyedSubscript:@"taskStatus"];
  }
...
- (BOOL)isEqual:(id)equal
{
  ...
  if (*&has)
  {
    ...
    if (taskStatus != [equalCopy taskStatus])
    {
LABEL_10:
      v10 = 0;
      goto LABEL_11;
  ...
  if (v8)
  {
    ...
    if (promptStatus != [equalCopy promptStatus])
    {
      goto LABEL_10;
    }
  }
