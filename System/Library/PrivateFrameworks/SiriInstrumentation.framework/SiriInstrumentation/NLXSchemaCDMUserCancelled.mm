...
- (NLXSchemaCDMUserCancelled)initWithDictionary:(id)dictionary;
- (NLXSchemaCDMUserCancelled)initWithJSON:(id)n;
- (NSData)jsonData;
...
- (NLXSchemaCDMUserCancelled)initWithDictionary:(id)dictionary
{
  ...
  v10.receiver = self;
  v10.super_class = NLXSchemaCDMUserCancelled;
...
- (NSData)jsonData
{
  dictionaryRepresentation = [(NLXSchemaCDMUserCancelled *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  if (self->_taskId)
  {
    taskId = [(NLXSchemaCDMUserCancelled *)self taskId];
...
- (BOOL)isEqual:(id)equal
{
  ...
  if ([equalCopy isMemberOfClass:objc_opt_class()])
  {
    ...
    {
      taskId3 = [(NLXSchemaCDMUserCancelled *)self taskId];
      if (!taskId3)
      {
...
LABEL_10:
      ...
      v9 = taskId3;
      taskId4 = [(NLXSchemaCDMUserCancelled *)self taskId];
...
- (void)writeTo:(id)to
{
  ...
  if (taskId)
  {
    taskId2 = [(NLXSchemaCDMUserCancelled *)self taskId];
...
{
  v9.receiver = self;
  v9.super_class = NLXSchemaCDMUserCancelled;
  policyCopy = policy;
  v5 = [(SISchemaInstrumentationMessage *)&v9 applySensitiveConditionsPolicy:policyCopy];
  v6 = [(NLXSchemaCDMUserCancelled *)self taskId:v9.receiver];
