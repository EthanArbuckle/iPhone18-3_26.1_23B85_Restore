...
- (INFERENCESchemaINFERENCEABModelResultTriggered)initWithDictionary:(id)dictionary;
- (INFERENCESchemaINFERENCEABModelResultTriggered)initWithJSON:(id)n;
- (NSData)jsonData;
...
- (INFERENCESchemaINFERENCEABModelResultTriggered)initWithDictionary:(id)dictionary
{
  ...
  v10.receiver = self;
  v10.super_class = INFERENCESchemaINFERENCEABModelResultTriggered;
...
- (NSData)jsonData
{
  dictionaryRepresentation = [(INFERENCESchemaINFERENCEABModelResultTriggered *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  if ((has & 2) != 0)
  {
    v5 = [(INFERENCESchemaINFERENCEABModelResultTriggered *)self projectIntent]- 1;
    if (v5 > 0xB)
    {
    ...
    [dictionary setObject:v6 forKeyedSubscript:@"projectIntent"];
    has = self->_has;
  }

  if (has)
  {
    v7 = [(INFERENCESchemaINFERENCEABModelResultTriggered *)self triggerReason]- 1;
    if (v7 > 9)
    {
    ...
    [dictionary setObject:v8 forKeyedSubscript:@"triggerReason"];
  }
