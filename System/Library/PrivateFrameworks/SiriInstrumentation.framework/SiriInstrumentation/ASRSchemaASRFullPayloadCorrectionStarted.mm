...
- (ASRSchemaASRFullPayloadCorrectionStarted)initWithDictionary:(id)a3;
- (ASRSchemaASRFullPayloadCorrectionStarted)initWithJSON:(id)a3;
- (BOOL)isEqual:(id)a3;
- (NSData)jsonData;
...
- (ASRSchemaASRFullPayloadCorrectionStarted)initWithDictionary:(id)a3
{
  ...
  if (v5)
  {
    v6 = [v4 objectForKeyedSubscript:@"utteranceStartTimeInNs"];
    objc_opt_class();
    ...
    v7 = [v4 objectForKeyedSubscript:@"utteranceEndTimeInNs"];
    objc_opt_class();
    if (objc_opt_isKindOfClass())
    {
...
- (NSData)jsonData
{
  v2 = [(ASRSchemaASRFullPayloadCorrectionStarted *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  if ((has & 2) != 0)
  {
    ...
    [v3 setObject:v5 forKeyedSubscript:@"utteranceEndTimeInNs"];
  ...
  if (has)
  {
    ...
    [v3 setObject:v6 forKeyedSubscript:@"utteranceStartTimeInNs"];
  }
