...
- (id)dictionaryRepresentation
{
  ...
  if (self->_cancelled)
  {
    v4 = [(FLOWLINKSchemaFLOWLINKActionContext *)self cancelled];
  ...
  if (self->_ended)
  {
    v7 = [(FLOWLINKSchemaFLOWLINKActionContext *)self ended];
...
- (BOOL)isEqual:(id)a3
{
  ...
  v8 = [(FLOWLINKSchemaFLOWLINKActionContext *)self startedOrChanged];
  if (v8)
  {
    v9 = v8;
  ...
  v13 = [(FLOWLINKSchemaFLOWLINKActionContext *)self ended];
  if (v13)
  {
    v14 = v13;
  ...
  v18 = [(FLOWLINKSchemaFLOWLINKActionContext *)self failed];
  if (v18)
  {
    v19 = v18;
  ...
  if ((v6 != 0) != (v7 == 0))
  {
    v23 = [(FLOWLINKSchemaFLOWLINKActionContext *)self cancelled];
    if (!v23)
    {
...
{
  v13 = a3;
  v4 = [(FLOWLINKSchemaFLOWLINKActionContext *)self startedOrChanged];

  if (v4)
  {
    v5 = [(FLOWLINKSchemaFLOWLINKActionContext *)self startedOrChanged];
  ...
  v8 = [(FLOWLINKSchemaFLOWLINKActionContext *)self failed];
  ...
  if (v10)
  {
    v12 = [(FLOWLINKSchemaFLOWLINKActionContext *)self cancelled];
    PBDataWriterWriteSubmessage();
