...
- (id)dictionaryRepresentation
{
  ...
  if (self->_ended)
  {
    v4 = [(GATSchemaGATCreateSessionContext *)self ended];
  ...
  if (self->_failed)
  {
    v7 = [(GATSchemaGATCreateSessionContext *)self failed];
...
- (BOOL)isEqual:(id)a3
{
  ...
  v8 = [(GATSchemaGATCreateSessionContext *)self startedOrChanged];
  if (v8)
  {
    v9 = v8;
    v10 = [(GATSchemaGATCreateSessionContext *)self startedOrChanged];
  ...
  v13 = [(GATSchemaGATCreateSessionContext *)self ended];
  if (v13)
  {
    v14 = v13;
  ...
  if ((v6 != 0) != (v7 == 0))
  {
    v18 = [(GATSchemaGATCreateSessionContext *)self failed];
    if (!v18)
    {
...
{
  v11 = a3;
  v4 = [(GATSchemaGATCreateSessionContext *)self startedOrChanged];
  ...
  if (v6)
  {
    v7 = [(GATSchemaGATCreateSessionContext *)self ended];
    PBDataWriterWriteSubmessage();
  }

  v8 = [(GATSchemaGATCreateSessionContext *)self failed];

  v9 = v11;
  if (v8)
  {
    v10 = [(GATSchemaGATCreateSessionContext *)self failed];
    PBDataWriterWriteSubmessage();
