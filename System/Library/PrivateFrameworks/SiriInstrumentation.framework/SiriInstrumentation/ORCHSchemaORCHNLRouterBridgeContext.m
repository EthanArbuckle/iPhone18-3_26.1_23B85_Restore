...
- (id)dictionaryRepresentation
{
  ...
  if (self->_ended)
  {
    v4 = [(ORCHSchemaORCHNLRouterBridgeContext *)self ended];
  ...
  if (self->_failed)
  {
    v7 = [(ORCHSchemaORCHNLRouterBridgeContext *)self failed];
...
- (BOOL)isEqual:(id)a3
{
  ...
  v8 = [(ORCHSchemaORCHNLRouterBridgeContext *)self startedOrChanged];
  if (v8)
  {
    v9 = v8;
    v10 = [(ORCHSchemaORCHNLRouterBridgeContext *)self startedOrChanged];
  ...
  v13 = [(ORCHSchemaORCHNLRouterBridgeContext *)self ended];
  if (v13)
  {
    v14 = v13;
  ...
  v18 = [(ORCHSchemaORCHNLRouterBridgeContext *)self failed];
  if (v18)
  {
    v19 = v18;
  ...
  if ((v6 != 0) != (v7 == 0))
  {
    v23 = [(ORCHSchemaORCHNLRouterBridgeContext *)self trpId];
    if (!v23)
    {
...
{
  v13 = a3;
  v4 = [(ORCHSchemaORCHNLRouterBridgeContext *)self startedOrChanged];

  if (v4)
  {
    v5 = [(ORCHSchemaORCHNLRouterBridgeContext *)self startedOrChanged];
  ...
  if (v6)
  {
    v7 = [(ORCHSchemaORCHNLRouterBridgeContext *)self ended];
    PBDataWriterWriteSubmessage();
  }

  v8 = [(ORCHSchemaORCHNLRouterBridgeContext *)self failed];
  ...
  if (v10)
  {
    v12 = [(ORCHSchemaORCHNLRouterBridgeContext *)self trpId];
    PBDataWriterWriteSubmessage();
