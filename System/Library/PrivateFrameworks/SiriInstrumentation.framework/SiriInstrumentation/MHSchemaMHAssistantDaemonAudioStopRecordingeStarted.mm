...
- (MHSchemaMHAssistantDaemonAudioStopRecordingeStarted)initWithDictionary:(id)dictionary;
- (MHSchemaMHAssistantDaemonAudioStopRecordingeStarted)initWithJSON:(id)n;
- (NSData)jsonData;
...
- (MHSchemaMHAssistantDaemonAudioStopRecordingeStarted)initWithDictionary:(id)dictionary
{
  ...
  if (v5)
  {
    v6 = [dictionaryCopy objectForKeyedSubscript:@"stopReason"];
    objc_opt_class();
...
- (NSData)jsonData
{
  dictionaryRepresentation = [(MHSchemaMHAssistantDaemonAudioStopRecordingeStarted *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  if (*&self->_has)
  {
    ...
    [dictionary setObject:v5 forKeyedSubscript:@"stopReason"];
  }
...
- (BOOL)isEqual:(id)equal
{
  ...
  if ([equalCopy isMemberOfClass:objc_opt_class()])
  {
    ...
    {
      if ((*&self->_has & 1) == 0 || (stopReason = self->_stopReason, stopReason == [equalCopy stopReason]))
      {
        v6 = 1;
      }
    }
