...
- (CLPInstSchemaCLPCDMReplaySampleFailed)initWithDictionary:(id)dictionary;
- (CLPInstSchemaCLPCDMReplaySampleFailed)initWithJSON:(id)n;
- (NSData)jsonData;
...
- (NSData)jsonData
{
  dictionaryRepresentation = [(CLPInstSchemaCLPCDMReplaySampleFailed *)self dictionaryRepresentation];
