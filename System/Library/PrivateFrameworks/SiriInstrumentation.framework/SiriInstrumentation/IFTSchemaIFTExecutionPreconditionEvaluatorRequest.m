...
- (BOOL)isEqual:(id)a3;
- (IFTSchemaIFTExecutionPreconditionEvaluatorRequest)initWithDictionary:(id)a3;
- (IFTSchemaIFTExecutionPreconditionEvaluatorRequest)initWithJSON:(id)a3;
- (NSData)jsonData;
...
- (NSData)jsonData
{
  v2 = [(IFTSchemaIFTExecutionPreconditionEvaluatorRequest *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  if (self->_request)
  {
    v4 = [(IFTSchemaIFTExecutionPreconditionEvaluatorRequest *)self request];
    v5 = [v4 dictionaryRepresentation];
    if (v5)
    {
      [v3 setObject:v5 forKeyedSubscript:@"request"];
    }

    else
    {
      v6 = [MEMORY[0x1E695DFB0] null];
      [v3 setObject:v6 forKeyedSubscript:@"request"];
    }
  }
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    v5 = [(IFTSchemaIFTExecutionPreconditionEvaluatorRequest *)self request];
    v6 = [v4 request];
    v7 = v6;
    if ((v5 != 0) != (v6 == 0))
    {
      v8 = [(IFTSchemaIFTExecutionPreconditionEvaluatorRequest *)self request];
      if (!v8)
      {
...
LABEL_10:
      ...
      v9 = v8;
      v10 = [(IFTSchemaIFTExecutionPreconditionEvaluatorRequest *)self request];
      v11 = [v4 request];
      v12 = [v10 isEqual:v11];
