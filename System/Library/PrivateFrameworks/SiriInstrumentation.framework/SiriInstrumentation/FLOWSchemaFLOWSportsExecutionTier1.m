...
- (id)dictionaryRepresentation
{
  ...
  {
    v4 = [(FLOWSchemaFLOWSportsExecutionTier1 *)self athleteEntities];
    v5 = [v4 copy];
  ...
  if (self->_leagues)
  {
    v8 = [(FLOWSchemaFLOWSportsExecutionTier1 *)self leagues];
    v9 = [v8 copy];
  ...
  {
    v10 = [(FLOWSchemaFLOWSportsExecutionTier1 *)self sportNames];
    v11 = [v10 copy];
...
- (BOOL)isEqual:(id)a3
{
  ...
  v5 = [(FLOWSchemaFLOWSportsExecutionTier1 *)self sportNames];
  v6 = [v4 sportNames];
  if ((v5 != 0) == (v6 == 0))
  {
    goto LABEL_26;
  ...
  v7 = [(FLOWSchemaFLOWSportsExecutionTier1 *)self sportNames];
  if (v7)
  {
    v8 = v7;
    v9 = [(FLOWSchemaFLOWSportsExecutionTier1 *)self sportNames];
    v10 = [v4 sportNames];
    v11 = [v9 isEqual:v10];
  ...
  v5 = [(FLOWSchemaFLOWSportsExecutionTier1 *)self leagues];
  v6 = [v4 leagues];
  if ((v5 != 0) == (v6 == 0))
  {
    goto LABEL_26;
  ...
  v12 = [(FLOWSchemaFLOWSportsExecutionTier1 *)self leagues];
  if (v12)
  {
    v13 = v12;
    v14 = [(FLOWSchemaFLOWSportsExecutionTier1 *)self leagues];
    v15 = [v4 leagues];
    v16 = [v14 isEqual:v15];
  ...
  v5 = [(FLOWSchemaFLOWSportsExecutionTier1 *)self athleteEntities];
  ...
  v17 = [(FLOWSchemaFLOWSportsExecutionTier1 *)self athleteEntities];
  if (v17)
  {
    v18 = v17;
  ...
  v5 = [(FLOWSchemaFLOWSportsExecutionTier1 *)self teamEntities];
  v6 = [v4 teamEntities];
  if ((v5 != 0) == (v6 == 0))
  {
    goto LABEL_26;
  ...
  v22 = [(FLOWSchemaFLOWSportsExecutionTier1 *)self teamEntities];
  if (v22)
  {
    v23 = v22;
    v24 = [(FLOWSchemaFLOWSportsExecutionTier1 *)self teamEntities];
    v25 = [v4 teamEntities];
    v26 = [v24 isEqual:v25];
  ...
  v5 = [(FLOWSchemaFLOWSportsExecutionTier1 *)self eventEntities];
  v6 = [v4 eventEntities];
  if ((v5 != 0) != (v6 == 0))
  {
    v27 = [(FLOWSchemaFLOWSportsExecutionTier1 *)self eventEntities];
    if (!v27)
    {
