...
- (id)dictionaryRepresentation
{
  ...
  if (self->_linkId)
  {
    v4 = [(SUGSchemaSUGSuggestionTier1 *)self linkId];
  ...
  {
    v7 = [(SUGSchemaSUGSuggestionTier1 *)self suggestionId];
    v8 = [v7 copy];
...
- (BOOL)isEqual:(id)a3
{
  ...
  v7 = [(SUGSchemaSUGSuggestionTier1 *)self linkId];
  if (v7)
  {
    v8 = v7;
  ...
  if ((v5 != 0) != (v6 == 0))
  {
    v12 = [(SUGSchemaSUGSuggestionTier1 *)self suggestionId];
    if (!v12)
    {
