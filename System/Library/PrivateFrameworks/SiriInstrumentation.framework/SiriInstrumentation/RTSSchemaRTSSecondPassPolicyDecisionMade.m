...
- (RTSSchemaRTSSecondPassPolicyDecisionMade)initWithDictionary:(id)a3
{
  v4 = a3;
  v12.receiver = self;
  v12.super_class = RTSSchemaRTSSecondPassPolicyDecisionMade;
  ...
  if (v5)
  {
    ...
    {
      [v7 doubleValue];
      [(RTSSchemaRTSSecondPassPolicyDecisionMade *)v5 setSpeakingProbability:?];
    }
    ...
    {
      [v8 doubleValue];
      [(RTSSchemaRTSSecondPassPolicyDecisionMade *)v5 setProcessedAudioDurationInMs:?];
    }
...
- (id)dictionaryRepresentation
{
  ...
  if ((v4 & 8) != 0)
  {
    v8 = [MEMORY[0x1E696AD98] numberWithBool:{-[RTSSchemaRTSSecondPassPolicyDecisionMade isReplayModeEnabled](self, "isReplayModeEnabled")}];
...
LABEL_3:
  ...
  v9 = [MEMORY[0x1E696AD98] numberWithBool:{-[RTSSchemaRTSSecondPassPolicyDecisionMade isSecondPassTriggered](self, "isSecondPassTriggered")}];
