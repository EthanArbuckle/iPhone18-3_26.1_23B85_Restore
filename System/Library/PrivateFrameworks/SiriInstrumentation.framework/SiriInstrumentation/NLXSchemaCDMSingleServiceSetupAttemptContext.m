...
- (id)dictionaryRepresentation
{
  ...
  if (self->_contextId)
  {
    v4 = [(NLXSchemaCDMSingleServiceSetupAttemptContext *)self contextId];
  ...
  if (self->_ended)
  {
    v7 = [(NLXSchemaCDMSingleServiceSetupAttemptContext *)self ended];
...
- (BOOL)isEqual:(id)a3
{
  ...
  v8 = [(NLXSchemaCDMSingleServiceSetupAttemptContext *)self contextId];
  if (v8)
  {
    v9 = v8;
  ...
  v13 = [(NLXSchemaCDMSingleServiceSetupAttemptContext *)self startedOrChanged];
  if (v13)
  {
    v14 = v13;
  ...
  if ((v6 != 0) != (v7 == 0))
  {
    v18 = [(NLXSchemaCDMSingleServiceSetupAttemptContext *)self ended];
    if (!v18)
    {
...
- (void)writeTo:(id)a3
{
  ...
  if (v6)
  {
    v7 = [(NLXSchemaCDMSingleServiceSetupAttemptContext *)self startedOrChanged];
    PBDataWriterWriteSubmessage();
  }

  v8 = [(NLXSchemaCDMSingleServiceSetupAttemptContext *)self ended];

  v9 = v11;
  if (v8)
  {
    v10 = [(NLXSchemaCDMSingleServiceSetupAttemptContext *)self ended];
    PBDataWriterWriteSubmessage();
