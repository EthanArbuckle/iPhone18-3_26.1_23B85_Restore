...
- (id)dictionaryRepresentation
{
  ...
  if (self->_error)
  {
    v4 = [(GATSchemaGATGenerativeRequestEventFailed *)self error];
  ...
  {
    v11 = [(GATSchemaGATGenerativeRequestEventFailed *)self underlyingError];
...
- (BOOL)isEqual:(id)a3
{
  ...
  v10 = [(GATSchemaGATGenerativeRequestEventFailed *)self error];
  v11 = [v4 error];
  if ((v10 != 0) == (v11 == 0))
  {
    goto LABEL_18;
  ...
  v12 = [(GATSchemaGATGenerativeRequestEventFailed *)self error];
  if (v12)
  {
    v13 = v12;
    v14 = [(GATSchemaGATGenerativeRequestEventFailed *)self error];
    v15 = [v4 error];
    v16 = [v14 isEqual:v15];
  ...
  v10 = [(GATSchemaGATGenerativeRequestEventFailed *)self underlyingError];
  v11 = [v4 underlyingError];
  if ((v10 != 0) != (v11 == 0))
  {
    v17 = [(GATSchemaGATGenerativeRequestEventFailed *)self underlyingError];
    if (!v17)
    {
...
LABEL_22:
    ...
    v18 = v17;
    v19 = [(GATSchemaGATGenerativeRequestEventFailed *)self underlyingError];
...
- (void)writeTo:(id)a3
{
  ...
  v5 = [(GATSchemaGATGenerativeRequestEventFailed *)self error];

  if (v5)
  {
    v6 = [(GATSchemaGATGenerativeRequestEventFailed *)self error];
    PBDataWriterWriteSubmessage();
  }

  v7 = [(GATSchemaGATGenerativeRequestEventFailed *)self underlyingError];

  v8 = v10;
  if (v7)
  {
    v9 = [(GATSchemaGATGenerativeRequestEventFailed *)self underlyingError];
    PBDataWriterWriteSubmessage();
