...
- (NSData)jsonData;
- (STSchemaSTAnswerSynthesisRequestFailed)initWithDictionary:(id)dictionary;
- (STSchemaSTAnswerSynthesisRequestFailed)initWithJSON:(id)n;
...
- (STSchemaSTAnswerSynthesisRequestFailed)initWithDictionary:(id)dictionary
{
  ...
  v11.receiver = self;
  v11.super_class = STSchemaSTAnswerSynthesisRequestFailed;
  v5 = [(STSchemaSTAnswerSynthesisRequestFailed *)&v11 init];
  if (v5)
  {
    ...
    if (objc_opt_isKindOfClass())
    {
      ...
      [(STSchemaSTAnswerSynthesisRequestFailed *)v5 setStError:v8];
    }
...
- (NSData)jsonData
{
  dictionaryRepresentation = [(STSchemaSTAnswerSynthesisRequestFailed *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  if (*&self->_has)
  {
    reason = [(STSchemaSTAnswerSynthesisRequestFailed *)self reason];
  ...
  if (self->_stError)
  {
    stError = [(STSchemaSTAnswerSynthesisRequestFailed *)self stError];
  ...
  if ([equalCopy isMemberOfClass:objc_opt_class()])
  {
    if ((*&self->_has & 1) == (equalCopy[24] & 1))
    {
      if ((*&self->_has & 1) == 0 || (reason = self->_reason, reason == [equalCopy reason]))
      {
        ...
        {
          stError3 = [(STSchemaSTAnswerSynthesisRequestFailed *)self stError];
          if (!stError3)
          {
...
LABEL_13:
          ...
          v10 = stError3;
          stError4 = [(STSchemaSTAnswerSynthesisRequestFailed *)self stError];
...
- (void)writeTo:(id)to
{
  ...
  if (stError)
  {
    stError2 = [(STSchemaSTAnswerSynthesisRequestFailed *)self stError];
...
{
  v9.receiver = self;
  v9.super_class = STSchemaSTAnswerSynthesisRequestFailed;
  policyCopy = policy;
  v5 = [(SISchemaInstrumentationMessage *)&v9 applySensitiveConditionsPolicy:policyCopy];
  v6 = [(STSchemaSTAnswerSynthesisRequestFailed *)self stError:v9.receiver];
  v7 = [v6 applySensitiveConditionsPolicy:policyCopy];

  LODWORD(policyCopy) = [v7 suppressMessage];
  if (policyCopy)
  {
    [(STSchemaSTAnswerSynthesisRequestFailed *)self deleteStError];
  }
