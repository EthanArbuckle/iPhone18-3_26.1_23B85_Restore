...
- (BOOL)isEqual:(id)a3;
- (GATSchemaGATError)initWithDictionary:(id)a3;
- (GATSchemaGATError)initWithJSON:(id)a3;
- (NSData)jsonData;
...
- (NSData)jsonData
{
  v2 = [(GATSchemaGATError *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  if (self->_domain)
  {
    v5 = [(GATSchemaGATError *)self domain];
    v6 = [v5 copy];
...
LABEL_12:
  ...
  v8 = [(GATSchemaGATError *)self domain];
  if (v8)
  {
    v9 = v8;
    v10 = [(GATSchemaGATError *)self domain];
    v11 = [v4 domain];
    v12 = [v10 isEqual:v11];
...
{
  v5 = a3;
  v4 = [(GATSchemaGATError *)self domain];
