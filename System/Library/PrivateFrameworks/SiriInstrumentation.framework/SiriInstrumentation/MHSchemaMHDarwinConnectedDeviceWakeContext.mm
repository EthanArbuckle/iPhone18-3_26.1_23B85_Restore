...
- (MHSchemaMHDarwinConnectedDeviceWakeContext)initWithDictionary:(id)dictionary;
- (MHSchemaMHDarwinConnectedDeviceWakeContext)initWithJSON:(id)n;
...
- (NSData)jsonData
{
  dictionaryRepresentation = [(MHSchemaMHDarwinConnectedDeviceWakeContext *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  if (self->_ended)
  {
    ended = [(MHSchemaMHDarwinConnectedDeviceWakeContext *)self ended];
  ...
  if (self->_failed)
  {
    failed = [(MHSchemaMHDarwinConnectedDeviceWakeContext *)self failed];
  ...
  {
    startedOrChanged = [(MHSchemaMHDarwinConnectedDeviceWakeContext *)self startedOrChanged];
...
- (BOOL)isEqual:(id)equal
{
  ...
  startedOrChanged3 = [(MHSchemaMHDarwinConnectedDeviceWakeContext *)self startedOrChanged];
  if (startedOrChanged3)
  {
    v9 = startedOrChanged3;
    startedOrChanged4 = [(MHSchemaMHDarwinConnectedDeviceWakeContext *)self startedOrChanged];
  ...
  startedOrChanged = [(MHSchemaMHDarwinConnectedDeviceWakeContext *)self ended];
  ...
  {
    v14 = ended;
    ended2 = [(MHSchemaMHDarwinConnectedDeviceWakeContext *)self ended];
  ...
  startedOrChanged = [(MHSchemaMHDarwinConnectedDeviceWakeContext *)self failed];
...
LABEL_21:
    ...
    v19 = failed;
    failed2 = [(MHSchemaMHDarwinConnectedDeviceWakeContext *)self failed];
...
- (void)writeTo:(id)to
{
  ...
  if (startedOrChanged)
  {
    startedOrChanged2 = [(MHSchemaMHDarwinConnectedDeviceWakeContext *)self startedOrChanged];
