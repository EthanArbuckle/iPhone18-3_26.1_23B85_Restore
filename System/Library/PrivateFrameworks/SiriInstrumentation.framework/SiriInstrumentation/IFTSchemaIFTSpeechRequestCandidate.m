...
- (id)dictionaryRepresentation
{
  ...
  {
    v4 = [(IFTSchemaIFTSpeechRequestCandidate *)self statementId];
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ([v4 isMemberOfClass:objc_opt_class()])
  {
    ...
    if ((v5 != 0) != (v6 == 0))
    {
      v8 = [(IFTSchemaIFTSpeechRequestCandidate *)self statementId];
      if (!v8)
      {
...
LABEL_10:
      ...
      v9 = v8;
      v10 = [(IFTSchemaIFTSpeechRequestCandidate *)self statementId];
      v11 = [v4 statementId];
      v12 = [v10 isEqual:v11];
