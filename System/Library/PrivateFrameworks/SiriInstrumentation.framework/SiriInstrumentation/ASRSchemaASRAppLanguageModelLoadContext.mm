...
- (ASRSchemaASRAppLanguageModelLoadContext)initWithDictionary:(id)dictionary;
- (ASRSchemaASRAppLanguageModelLoadContext)initWithJSON:(id)n;
...
- (NSData)jsonData
{
  dictionaryRepresentation = [(ASRSchemaASRAppLanguageModelLoadContext *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  if (self->_ended)
  {
    ended = [(ASRSchemaASRAppLanguageModelLoadContext *)self ended];
  ...
  if (self->_failed)
  {
    failed = [(ASRSchemaASRAppLanguageModelLoadContext *)self failed];
  ...
  {
    startedOrChanged = [(ASRSchemaASRAppLanguageModelLoadContext *)self startedOrChanged];
...
- (BOOL)isEqual:(id)equal
{
  ...
  startedOrChanged3 = [(ASRSchemaASRAppLanguageModelLoadContext *)self startedOrChanged];
  if (startedOrChanged3)
  {
    v9 = startedOrChanged3;
    startedOrChanged4 = [(ASRSchemaASRAppLanguageModelLoadContext *)self startedOrChanged];
  ...
  startedOrChanged = [(ASRSchemaASRAppLanguageModelLoadContext *)self ended];
  ...
  {
    v14 = ended;
    ended2 = [(ASRSchemaASRAppLanguageModelLoadContext *)self ended];
  ...
  startedOrChanged = [(ASRSchemaASRAppLanguageModelLoadContext *)self failed];
...
LABEL_21:
    ...
    v19 = failed;
    failed2 = [(ASRSchemaASRAppLanguageModelLoadContext *)self failed];
...
- (void)writeTo:(id)to
{
  ...
  if (startedOrChanged)
  {
    startedOrChanged2 = [(ASRSchemaASRAppLanguageModelLoadContext *)self startedOrChanged];
