...
- (id)dictionaryRepresentation
{
  ...
  {
    v4 = [(IFTSchemaIFTCollectionValue *)self typeIdentifier];
...
- (BOOL)isEqual:(id)a3
{
  ...
  v7 = [(IFTSchemaIFTCollectionValue *)self typeIdentifier];
  if (v7)
  {
    v8 = v7;
    v9 = [(IFTSchemaIFTCollectionValue *)self typeIdentifier];
  ...
  if ((v5 != 0) != (v6 == 0))
  {
    v12 = [(IFTSchemaIFTCollectionValue *)self values];
    if (!v12)
    {
...
LABEL_15:
    ...
    v13 = v12;
    v14 = [(IFTSchemaIFTCollectionValue *)self values];
    v15 = [v4 values];
    v16 = [v14 isEqual:v15];
