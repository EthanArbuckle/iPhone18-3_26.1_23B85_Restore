...
- (NLXSchemaCDMRepetitionResult)initWithDictionary:(id)a3
{
  v4 = a3;
  v10.receiver = self;
  v10.super_class = NLXSchemaCDMRepetitionResult;
...
- (id)dictionaryRepresentation
{
  ...
  if (has)
  {
    v5 = [MEMORY[0x1E696AD98] numberWithUnsignedInt:{-[NLXSchemaCDMRepetitionResult asrHypothesisIndex](self, "asrHypothesisIndex")}];
  ...
  if ((has & 2) != 0)
  {
    v6 = [(NLXSchemaCDMRepetitionResult *)self repetitionType]- 1;
    if (v6 > 3)
    {
      v7 = @"CDMREPETITIONTYPE_UNKNOWN";
    }
