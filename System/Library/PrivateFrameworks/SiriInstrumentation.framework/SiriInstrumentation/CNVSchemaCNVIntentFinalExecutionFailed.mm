...
- (CNVSchemaCNVIntentFinalExecutionFailed)initWithDictionary:(id)dictionary;
- (CNVSchemaCNVIntentFinalExecutionFailed)initWithJSON:(id)n;
- (NSData)jsonData;
...
- (CNVSchemaCNVIntentFinalExecutionFailed)initWithDictionary:(id)dictionary
{
  ...
  v9.receiver = self;
  v9.super_class = CNVSchemaCNVIntentFinalExecutionFailed;
...
- (NSData)jsonData
{
  dictionaryRepresentation = [(CNVSchemaCNVIntentFinalExecutionFailed *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  if (*&self->_has)
  {
    reason = [(CNVSchemaCNVIntentFinalExecutionFailed *)self reason];
