...
- (NSData)jsonData;
- (PEGASUSSchemaPEGASUSAlignmentOffset)initWithDictionary:(id)dictionary;
- (PEGASUSSchemaPEGASUSAlignmentOffset)initWithJSON:(id)n;
- (id)dictionaryRepresentation;
- (id)suppressMessageUnderConditions;
- (unint64_t)hash;
- (void)setHasEndCharacterIdx:(BOOL)idx;
- (void)writeTo:(id)to;
@end
...
- (PEGASUSSchemaPEGASUSAlignmentOffset)initWithDictionary:(id)dictionary
{
  ...
  if (v5)
  {
    v6 = [dictionaryCopy objectForKeyedSubscript:@"startCharacterIdx"];
    objc_opt_class();
    ...
    v7 = [dictionaryCopy objectForKeyedSubscript:@"endCharacterIdx"];
    objc_opt_class();
    if (objc_opt_isKindOfClass())
    {
...
- (NSData)jsonData
{
  dictionaryRepresentation = [(PEGASUSSchemaPEGASUSAlignmentOffset *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  if ((has & 2) != 0)
  {
    ...
    [dictionary setObject:v5 forKeyedSubscript:@"endCharacterIdx"];
  ...
  if (has)
  {
    ...
    [dictionary setObject:v6 forKeyedSubscript:@"startCharacterIdx"];
  }
...
- (BOOL)isEqual:(id)equal
{
  ...
  if (*&has)
  {
    ...
    if (startCharacterIdx != [equalCopy startCharacterIdx])
    {
LABEL_10:
      v10 = 0;
      goto LABEL_11;
  ...
  if (v8)
  {
    ...
    if (endCharacterIdx != [equalCopy endCharacterIdx])
    {
      goto LABEL_10;
    }
  }
