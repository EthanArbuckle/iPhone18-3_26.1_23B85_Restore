...
- (id)dictionaryRepresentation
{
  ...
  if (self->_followup)
  {
    v4 = [(PSESchemaPSEMaps *)self followup];
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ([v4 isMemberOfClass:objc_opt_class()])
  {
    ...
    {
      if ((*&self->_has & 1) == 0 || (isSiriResultUseful = self->_isSiriResultUseful, isSiriResultUseful == [v4 isSiriResultUseful]))
      {
        ...
        if ((v6 != 0) != (v7 == 0))
        {
          v9 = [(PSESchemaPSEMaps *)self followup];
          if (!v9)
          {
...
LABEL_13:
          ...
          v10 = v9;
          v11 = [(PSESchemaPSEMaps *)self followup];
          v12 = [v4 followup];
          v13 = [v11 isEqual:v12];
