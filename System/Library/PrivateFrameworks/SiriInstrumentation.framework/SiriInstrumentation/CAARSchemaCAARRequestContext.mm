...
- (id)dictionaryRepresentation
{
  ...
  if (self->_ended)
  {
    v4 = [(CAARSchemaCAARRequestContext *)self ended];
  ...
  if (self->_failed)
  {
    v7 = [(CAARSchemaCAARRequestContext *)self failed];
...
- (BOOL)isEqual:(id)a3
{
  ...
  v8 = [(CAARSchemaCAARRequestContext *)self startedOrChanged];
  if (v8)
  {
    v9 = v8;
    v10 = [(CAARSchemaCAARRequestContext *)self startedOrChanged];
  ...
  v13 = [(CAARSchemaCAARRequestContext *)self ended];
  if (v13)
  {
    v14 = v13;
  ...
  if ((v6 != 0) != (v7 == 0))
  {
    v18 = [(CAARSchemaCAARRequestContext *)self failed];
    if (!v18)
    {
...
{
  v11 = a3;
  v4 = [(CAARSchemaCAARRequestContext *)self startedOrChanged];
  ...
  if (v6)
  {
    v7 = [(CAARSchemaCAARRequestContext *)self ended];
    PBDataWriterWriteSubmessage();
  }

  v8 = [(CAARSchemaCAARRequestContext *)self failed];

  v9 = v11;
  if (v8)
  {
    v10 = [(CAARSchemaCAARRequestContext *)self failed];
    PBDataWriterWriteSubmessage();
