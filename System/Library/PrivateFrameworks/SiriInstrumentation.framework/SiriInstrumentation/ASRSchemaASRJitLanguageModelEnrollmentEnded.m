...
- (id)dictionaryRepresentation
{
  ...
  if (self->_linkId)
  {
    v4 = [(ASRSchemaASRJitLanguageModelEnrollmentEnded *)self linkId];
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ([v4 isMemberOfClass:objc_opt_class()])
  {
    ...
    if ((v5 != 0) != (v6 == 0))
    {
      v8 = [(ASRSchemaASRJitLanguageModelEnrollmentEnded *)self linkId];
      if (!v8)
      {
...
LABEL_10:
      ...
      v9 = v8;
      v10 = [(ASRSchemaASRJitLanguageModelEnrollmentEnded *)self linkId];
      v11 = [v4 linkId];
      v12 = [v10 isEqual:v11];
