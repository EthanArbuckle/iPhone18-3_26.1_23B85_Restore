...
- (NLXSchemaCDMSingleServiceWarmupAttemptContext)initWithDictionary:(id)dictionary;
- (NLXSchemaCDMSingleServiceWarmupAttemptContext)initWithJSON:(id)n;
...
- (NLXSchemaCDMSingleServiceWarmupAttemptContext)initWithDictionary:(id)dictionary
{
  ...
  v14.receiver = self;
  v14.super_class = NLXSchemaCDMSingleServiceWarmupAttemptContext;
  ...
  if (v5)
  {
    ...
    if (objc_opt_isKindOfClass())
    {
      v11 = [[NLXSchemaCDMSingleServiceWarmupAttemptEnded alloc] initWithDictionary:v10];
...
- (NSData)jsonData
{
  dictionaryRepresentation = [(NLXSchemaCDMSingleServiceWarmupAttemptContext *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  if (self->_contextId)
  {
    contextId = [(NLXSchemaCDMSingleServiceWarmupAttemptContext *)self contextId];
  ...
  if (self->_ended)
  {
    ended = [(NLXSchemaCDMSingleServiceWarmupAttemptContext *)self ended];
  ...
  {
    startedOrChanged = [(NLXSchemaCDMSingleServiceWarmupAttemptContext *)self startedOrChanged];
...
- (unint64_t)hash
{
  ...
  v4 = [(NLXSchemaCDMSingleServiceWarmupAttemptStarted *)self->_startedOrChanged hash]^ v3;
...
- (BOOL)isEqual:(id)equal
{
  ...
  contextId3 = [(NLXSchemaCDMSingleServiceWarmupAttemptContext *)self contextId];
  if (contextId3)
  {
    v9 = contextId3;
    contextId4 = [(NLXSchemaCDMSingleServiceWarmupAttemptContext *)self contextId];
  ...
  contextId = [(NLXSchemaCDMSingleServiceWarmupAttemptContext *)self startedOrChanged];
  ...
  if (startedOrChanged)
  {
    ...
    startedOrChanged2 = [(NLXSchemaCDMSingleServiceWarmupAttemptContext *)self startedOrChanged];
  ...
  contextId = [(NLXSchemaCDMSingleServiceWarmupAttemptContext *)self ended];
...
LABEL_21:
    ...
    v19 = ended;
    ended2 = [(NLXSchemaCDMSingleServiceWarmupAttemptContext *)self ended];
...
- (void)writeTo:(id)to
{
  ...
  if (contextId)
  {
    contextId2 = [(NLXSchemaCDMSingleServiceWarmupAttemptContext *)self contextId];
...
- (id)applySensitiveConditionsPolicy:(id)policy
{
  policyCopy = policy;
  v16.receiver = self;
  v16.super_class = NLXSchemaCDMSingleServiceWarmupAttemptContext;
