...
- (id)dictionaryRepresentation
{
  ...
  if (self->_contextId)
  {
    v4 = [(NLXSchemaCDMSingleServiceWarmupAttemptContext *)self contextId];
  ...
  if (self->_ended)
  {
    v7 = [(NLXSchemaCDMSingleServiceWarmupAttemptContext *)self ended];
...
- (BOOL)isEqual:(id)a3
{
  ...
  v8 = [(NLXSchemaCDMSingleServiceWarmupAttemptContext *)self contextId];
  if (v8)
  {
    v9 = v8;
  ...
  v13 = [(NLXSchemaCDMSingleServiceWarmupAttemptContext *)self startedOrChanged];
  if (v13)
  {
    v14 = v13;
  ...
  if ((v6 != 0) != (v7 == 0))
  {
    v18 = [(NLXSchemaCDMSingleServiceWarmupAttemptContext *)self ended];
    if (!v18)
    {
...
- (void)writeTo:(id)a3
{
  ...
  if (v6)
  {
    v7 = [(NLXSchemaCDMSingleServiceWarmupAttemptContext *)self startedOrChanged];
    PBDataWriterWriteSubmessage();
  }

  v8 = [(NLXSchemaCDMSingleServiceWarmupAttemptContext *)self ended];

  v9 = v11;
  if (v8)
  {
    v10 = [(NLXSchemaCDMSingleServiceWarmupAttemptContext *)self ended];
    PBDataWriterWriteSubmessage();
