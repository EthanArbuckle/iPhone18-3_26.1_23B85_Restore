...
- (NLXSchemaMARRSMentionResolverEnded)initWithDictionary:(id)a3
{
  ...
  v4 = a3;
  v23.receiver = self;
  v23.super_class = NLXSchemaMARRSMentionResolverEnded;
...
- (id)dictionaryRepresentation
{
  ...
  if (self->_linkId)
  {
    v4 = [(NLXSchemaMARRSMentionResolverEnded *)self linkId];
...
- (BOOL)isEqual:(id)a3
{
  ...
  v7 = [(NLXSchemaMARRSMentionResolverEnded *)self mentionResolverSpans];
  if (v7)
  {
    v8 = v7;
    v9 = [(NLXSchemaMARRSMentionResolverEnded *)self mentionResolverSpans];
    v10 = [v4 mentionResolverSpans];
    v11 = [v9 isEqual:v10];
  ...
  if ((v5 != 0) != (v6 == 0))
  {
    v12 = [(NLXSchemaMARRSMentionResolverEnded *)self linkId];
    if (!v12)
    {
...
- (void)writeTo:(id)a3
{
  ...
  v10 = [(NLXSchemaMARRSMentionResolverEnded *)self linkId];

  if (v10)
  {
    v11 = [(NLXSchemaMARRSMentionResolverEnded *)self linkId];
    PBDataWriterWriteSubmessage();
  }
}
...
{
  v11.receiver = self;
  v11.super_class = NLXSchemaMARRSMentionResolverEnded;
  v4 = a3;
  v5 = [(SISchemaInstrumentationMessage *)&v11 applySensitiveConditionsPolicy:v4];
  v6 = [(NLXSchemaMARRSMentionResolverEnded *)self mentionResolverSpans:v11.receiver];
