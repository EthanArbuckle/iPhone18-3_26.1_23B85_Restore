...
- (BOOL)isEqual:(id)a3;
- (GATSchemaGATNotForMeResponseReturned)initWithDictionary:(id)a3;
- (GATSchemaGATNotForMeResponseReturned)initWithJSON:(id)a3;
- (NSData)jsonData;
...
- (GATSchemaGATNotForMeResponseReturned)initWithDictionary:(id)a3
{
  ...
  if (v5)
  {
    v6 = [v4 objectForKeyedSubscript:@"isUtteranceRewritten"];
    objc_opt_class();
...
- (NSData)jsonData
{
  v2 = [(GATSchemaGATNotForMeResponseReturned *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  if (*(&self->_isUtteranceRewritten + 1))
  {
    ...
    [v3 setObject:v4 forKeyedSubscript:@"isUtteranceRewritten"];
  }
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    if (*(&self->_isUtteranceRewritten + 1) == (v4[9] & 1))
    {
      if (!*(&self->_isUtteranceRewritten + 1) || (isUtteranceRewritten = self->_isUtteranceRewritten, isUtteranceRewritten == [v4 isUtteranceRewritten]))
      {
        v6 = 1;
      }
    }
