...
- (NSData)jsonData;
- (SISchemaUEIDictationTranscriptionTokenized)initWithDictionary:(id)dictionary;
- (SISchemaUEIDictationTranscriptionTokenized)initWithJSON:(id)n;
...
- (SISchemaUEIDictationTranscriptionTokenized)initWithDictionary:(id)dictionary
{
  ...
  if (v5)
  {
    v6 = [dictionaryCopy objectForKeyedSubscript:@"numTokens"];
    objc_opt_class();
...
- (NSData)jsonData
{
  dictionaryRepresentation = [(SISchemaUEIDictationTranscriptionTokenized *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  if (*&self->_has)
  {
    ...
    [dictionary setObject:v4 forKeyedSubscript:@"numTokens"];
  }
...
- (BOOL)isEqual:(id)equal
{
  ...
  if ([equalCopy isMemberOfClass:objc_opt_class()])
  {
    ...
    {
      if ((*&self->_has & 1) == 0 || (numTokens = self->_numTokens, numTokens == [equalCopy numTokens]))
      {
        v6 = 1;
      }
    }
