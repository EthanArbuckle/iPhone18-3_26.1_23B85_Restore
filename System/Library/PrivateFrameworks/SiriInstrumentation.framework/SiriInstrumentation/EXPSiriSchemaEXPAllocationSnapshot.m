...
- (EXPSiriSchemaEXPAllocationSnapshot)initWithDictionary:(id)a3
{
  ...
  v4 = a3;
  v21.receiver = self;
  v21.super_class = EXPSiriSchemaEXPAllocationSnapshot;
        ...
        do
        {
          ...
          do
          {
            ...
            if (objc_opt_isKindOfClass())
            {
              ...
              v14 = [(EXPSchemaEXPTrialExperiment *)v13 initWithDictionary:v12, v17];
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ([v4 isMemberOfClass:objc_opt_class()])
  {
    ...
    if ((v5 != 0) != (v6 == 0))
    {
      v8 = [(EXPSiriSchemaEXPAllocationSnapshot *)self allocations];
      if (!v8)
      {
...
LABEL_10:
      ...
      v9 = v8;
      v10 = [(EXPSiriSchemaEXPAllocationSnapshot *)self allocations];
      v11 = [v4 allocations];
      v12 = [v10 isEqual:v11];
...
{
  v9.receiver = self;
  v9.super_class = EXPSiriSchemaEXPAllocationSnapshot;
  v4 = a3;
  v5 = [(SISchemaInstrumentationMessage *)&v9 applySensitiveConditionsPolicy:v4];
  v6 = [(EXPSiriSchemaEXPAllocationSnapshot *)self allocations:v9.receiver];
