...
- (HALSchemaHALNearbyPersonalDevicesReported)initWithDictionary:(id)dictionary;
- (HALSchemaHALNearbyPersonalDevicesReported)initWithJSON:(id)n;
- (NSData)jsonData;
- (id)dictionaryRepresentation;
- (id)suppressMessageUnderConditions;
- (unint64_t)hash;
- (void)setHasIMacCount:(BOOL)count;
- (void)setHasIPadCount:(BOOL)count;
- (void)setHasMacBookCount:(BOOL)count;
- (void)setHasMacStudioCount:(BOOL)count;
- (void)setHasWatchCount:(BOOL)count;
- (void)writeTo:(id)to;
@end
...
- (HALSchemaHALNearbyPersonalDevicesReported)initWithDictionary:(id)dictionary
{
  ...
  if (v5)
  {
    v6 = [dictionaryCopy objectForKeyedSubscript:@"iPhoneCount"];
    objc_opt_class();
    ...
    v7 = [dictionaryCopy objectForKeyedSubscript:@"iPadCount"];
    objc_opt_class();
    if (objc_opt_isKindOfClass())
    {
    ...
    v8 = [dictionaryCopy objectForKeyedSubscript:@"watchCount"];
    objc_opt_class();
    if (objc_opt_isKindOfClass())
    {
    ...
    v9 = [dictionaryCopy objectForKeyedSubscript:@"macBookCount"];
    objc_opt_class();
    if (objc_opt_isKindOfClass())
    {
    ...
    v10 = [dictionaryCopy objectForKeyedSubscript:@"macStudioCount"];
    objc_opt_class();
    if (objc_opt_isKindOfClass())
    {
    ...
    v11 = [dictionaryCopy objectForKeyedSubscript:@"iMacCount"];
    objc_opt_class();
    if (objc_opt_isKindOfClass())
    {
...
- (NSData)jsonData
{
  dictionaryRepresentation = [(HALSchemaHALNearbyPersonalDevicesReported *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  if ((has & 0x20) != 0)
  {
    ...
    [dictionary setObject:v7 forKeyedSubscript:@"iMacCount"];
...
LABEL_3:
  ...
  [dictionary setObject:v8 forKeyedSubscript:@"iPadCount"];
...
LABEL_13:
  ...
  [dictionary setObject:v9 forKeyedSubscript:@"iPhoneCount"];
...
LABEL_14:
  ...
  [dictionary setObject:v10 forKeyedSubscript:@"macBookCount"];
...
- (BOOL)isEqual:(id)equal
{
  ...
  if (*&has)
  {
    ...
    if (iPhoneCount != [equalCopy iPhoneCount])
    {
      goto LABEL_26;
    }
  ...
  if (v8)
  {
    ...
    if (iPadCount != [equalCopy iPadCount])
    {
      goto LABEL_26;
    }
  ...
  if (v10)
  {
    ...
    if (watchCount != [equalCopy watchCount])
    {
      goto LABEL_26;
    }
  ...
  if (v12)
  {
    ...
    if (macBookCount != [equalCopy macBookCount])
    {
      goto LABEL_26;
    }
  ...
  if (v14)
  {
    ...
    if (macStudioCount == [equalCopy macStudioCount])
    {
      has = self->_has;
      v6 = equalCopy[32];
      goto LABEL_22;
...
LABEL_22:
  ...
  if (v16)
  {
    ...
    if (iMacCount != [equalCopy iMacCount])
    {
      goto LABEL_26;
    }
  }
