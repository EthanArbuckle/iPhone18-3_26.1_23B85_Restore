...
- (id)dictionaryRepresentation
{
  ...
  if (self->_ended)
  {
    v4 = [(MHSchemaMHLatticeFalseTriggerMitigationEvaluationContext *)self ended];
  ...
  if (self->_failed)
  {
    v7 = [(MHSchemaMHLatticeFalseTriggerMitigationEvaluationContext *)self failed];
...
- (BOOL)isEqual:(id)a3
{
  ...
  v8 = [(MHSchemaMHLatticeFalseTriggerMitigationEvaluationContext *)self startedOrChanged];
  if (v8)
  {
    v9 = v8;
    v10 = [(MHSchemaMHLatticeFalseTriggerMitigationEvaluationContext *)self startedOrChanged];
  ...
  v13 = [(MHSchemaMHLatticeFalseTriggerMitigationEvaluationContext *)self ended];
  if (v13)
  {
    v14 = v13;
  ...
  if ((v6 != 0) != (v7 == 0))
  {
    v18 = [(MHSchemaMHLatticeFalseTriggerMitigationEvaluationContext *)self failed];
    if (!v18)
    {
...
{
  v11 = a3;
  v4 = [(MHSchemaMHLatticeFalseTriggerMitigationEvaluationContext *)self startedOrChanged];
  ...
  if (v6)
  {
    v7 = [(MHSchemaMHLatticeFalseTriggerMitigationEvaluationContext *)self ended];
    PBDataWriterWriteSubmessage();
  }

  v8 = [(MHSchemaMHLatticeFalseTriggerMitigationEvaluationContext *)self failed];

  v9 = v11;
  if (v8)
  {
    v10 = [(MHSchemaMHLatticeFalseTriggerMitigationEvaluationContext *)self failed];
    PBDataWriterWriteSubmessage();
