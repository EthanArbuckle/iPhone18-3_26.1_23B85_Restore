...
- (id)dictionaryRepresentation
{
  ...
  {
    v4 = [(ODDSiriSchemaODDAssistantExperimentTuples *)self endpointDelayInMs];
    v5 = [v4 copy];
  ...
  {
    v8 = [(ODDSiriSchemaODDAssistantExperimentTuples *)self siriResponseTimeInMs];
    v9 = [v8 copy];
  ...
  {
    v10 = [(ODDSiriSchemaODDAssistantExperimentTuples *)self timeToFirstWordInMs];
    v11 = [v10 copy];
...
- (BOOL)isEqual:(id)a3
{
  ...
  v5 = [(ODDSiriSchemaODDAssistantExperimentTuples *)self launchTimeInMs];
  ...
  v7 = [(ODDSiriSchemaODDAssistantExperimentTuples *)self launchTimeInMs];
  if (v7)
  {
    v8 = v7;
    v9 = [(ODDSiriSchemaODDAssistantExperimentTuples *)self launchTimeInMs];
  ...
  v5 = [(ODDSiriSchemaODDAssistantExperimentTuples *)self endpointDelayInMs];
  ...
  v12 = [(ODDSiriSchemaODDAssistantExperimentTuples *)self endpointDelayInMs];
  if (v12)
  {
    v13 = v12;
    v14 = [(ODDSiriSchemaODDAssistantExperimentTuples *)self endpointDelayInMs];
  ...
  v5 = [(ODDSiriSchemaODDAssistantExperimentTuples *)self siriResponseTimeInMs];
  ...
  v17 = [(ODDSiriSchemaODDAssistantExperimentTuples *)self siriResponseTimeInMs];
  if (v17)
  {
    v18 = v17;
  ...
  v5 = [(ODDSiriSchemaODDAssistantExperimentTuples *)self timeToUufrInMs];
  ...
  v22 = [(ODDSiriSchemaODDAssistantExperimentTuples *)self timeToUufrInMs];
  if (v22)
  {
    v23 = v22;
    v24 = [(ODDSiriSchemaODDAssistantExperimentTuples *)self timeToUufrInMs];
  ...
  v5 = [(ODDSiriSchemaODDAssistantExperimentTuples *)self timeToFirstWordInMs];
  v6 = [v4 timeToFirstWordInMs];
  if ((v5 != 0) != (v6 == 0))
  {
    v27 = [(ODDSiriSchemaODDAssistantExperimentTuples *)self timeToFirstWordInMs];
    if (!v27)
    {
...
LABEL_30:
    ...
    v28 = v27;
    v29 = [(ODDSiriSchemaODDAssistantExperimentTuples *)self timeToFirstWordInMs];
