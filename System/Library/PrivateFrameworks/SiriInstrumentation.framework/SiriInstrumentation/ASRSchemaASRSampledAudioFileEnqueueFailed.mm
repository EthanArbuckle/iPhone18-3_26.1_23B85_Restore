...
- (id)dictionaryRepresentation
{
  ...
  {
    v7 = [(ASRSchemaASRSampledAudioFileEnqueueFailed *)self originalAsrId];
...
- (BOOL)isEqual:(id)a3
{
  ...
  v5 = [(ASRSchemaASRSampledAudioFileEnqueueFailed *)self originalAsrId];
  v6 = [v4 originalAsrId];
  if ((v5 != 0) == (v6 == 0))
  {
    goto LABEL_22;
  ...
  {
    v8 = v7;
    v9 = [(ASRSchemaASRSampledAudioFileEnqueueFailed *)self originalAsrId];
  ...
  v13 = [(ASRSchemaASRSampledAudioFileEnqueueFailed *)self errorDomain];
  if (v13)
  {
    v14 = v13;
  ...
  v5 = [(ASRSchemaASRSampledAudioFileEnqueueFailed *)self underlyingErrorDomain];
  v6 = [v4 underlyingErrorDomain];
  if ((v5 != 0) != (v6 == 0))
  {
    v20 = [(ASRSchemaASRSampledAudioFileEnqueueFailed *)self underlyingErrorDomain];
    if (!v20)
    {
...
{
  v9 = a3;
  v4 = [(ASRSchemaASRSampledAudioFileEnqueueFailed *)self originalAsrId];
  ...
  v6 = [(ASRSchemaASRSampledAudioFileEnqueueFailed *)self errorDomain];
  ...
  v7 = [(ASRSchemaASRSampledAudioFileEnqueueFailed *)self underlyingErrorDomain];
