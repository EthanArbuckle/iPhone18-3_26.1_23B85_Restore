...
- (id)dictionaryRepresentation
{
  ...
  {
    v4 = [(MTSchemaMTLanguageDisambiguationUIShown *)self locales];
    v5 = [v4 copy];
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ([v4 isMemberOfClass:objc_opt_class()])
  {
    ...
    if ((v5 != 0) != (v6 == 0))
    {
      v8 = [(MTSchemaMTLanguageDisambiguationUIShown *)self locales];
      if (!v8)
      {
...
LABEL_10:
      ...
      v9 = v8;
      v10 = [(MTSchemaMTLanguageDisambiguationUIShown *)self locales];
      v11 = [v4 locales];
      v12 = [v10 isEqual:v11];
