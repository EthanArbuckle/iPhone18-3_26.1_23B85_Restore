...
- (NSData)jsonData;
- (RRSchemaRRUsoGraphTier1)initWithDictionary:(id)dictionary;
- (RRSchemaRRUsoGraphTier1)initWithJSON:(id)n;
...
- (NSData)jsonData
{
  dictionaryRepresentation = [(RRSchemaRRUsoGraphTier1 *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  {
    usoGraphTier1 = [(RRSchemaRRUsoGraphTier1 *)self usoGraphTier1];
...
- (BOOL)isEqual:(id)equal
{
  ...
  if ([equalCopy isMemberOfClass:objc_opt_class()])
  {
    ...
    {
      usoGraphTier13 = [(RRSchemaRRUsoGraphTier1 *)self usoGraphTier1];
      if (!usoGraphTier13)
      {
...
LABEL_10:
      ...
      v9 = usoGraphTier13;
      usoGraphTier14 = [(RRSchemaRRUsoGraphTier1 *)self usoGraphTier1];
...
- (void)writeTo:(id)to
{
  ...
  if (usoGraphTier1)
  {
    usoGraphTier12 = [(RRSchemaRRUsoGraphTier1 *)self usoGraphTier1];
