...
- (BOOL)isEqual:(id)a3;
- (NSData)jsonData;
- (POMMESSchemaPOMMESKnowledgeFallbackTurnOffAlwaysPromptConfirmationShown)initWithDictionary:(id)a3;
- (POMMESSchemaPOMMESKnowledgeFallbackTurnOffAlwaysPromptConfirmationShown)initWithJSON:(id)a3;
...
- (NSData)jsonData
{
  v2 = [(POMMESSchemaPOMMESKnowledgeFallbackTurnOffAlwaysPromptConfirmationShown *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  {
    v4 = [(POMMESSchemaPOMMESKnowledgeFallbackTurnOffAlwaysPromptConfirmationShown *)self pommesSessionId];
    v5 = [v4 dictionaryRepresentation];
    if (v5)
    {
      [v3 setObject:v5 forKeyedSubscript:@"pommesSessionId"];
    }

    else
    {
      v6 = [MEMORY[0x1E695DFB0] null];
      [v3 setObject:v6 forKeyedSubscript:@"pommesSessionId"];
    }
  }
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    v5 = [(POMMESSchemaPOMMESKnowledgeFallbackTurnOffAlwaysPromptConfirmationShown *)self pommesSessionId];
    v6 = [v4 pommesSessionId];
    v7 = v6;
    if ((v5 != 0) != (v6 == 0))
    {
      v8 = [(POMMESSchemaPOMMESKnowledgeFallbackTurnOffAlwaysPromptConfirmationShown *)self pommesSessionId];
      if (!v8)
      {
...
LABEL_10:
      ...
      v9 = v8;
      v10 = [(POMMESSchemaPOMMESKnowledgeFallbackTurnOffAlwaysPromptConfirmationShown *)self pommesSessionId];
