...
- (void)copyTo:(id)a3
{
  ...
  if ([(PBBProtoTinkerWirelessCredentials *)self serializedNetworkRecordsCount])
  {
    ...
    v4 = [(PBBProtoTinkerWirelessCredentials *)self serializedNetworkRecordsCount];
    if (v4)
    {
      v5 = v4;
      for (i = 0; i != v5; ++i)
  ...
  if (v5)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        [(PBBProtoTinkerWirelessCredentials *)self addSerializedNetworkRecord:*(*(&v10 + 1) + 8 * v8++), v10];
      }
