...
- (id)description
{
  ...
  v8.receiver = self;
  v8.super_class = PBBProtoTinkerFitnessRouteTrackingEnabled;
  v4 = [(PBBProtoTinkerFitnessRouteTrackingEnabled *)&v8 description];
  dictionaryRepresentation = [(PBBProtoTinkerFitnessRouteTrackingEnabled *)self dictionaryRepresentation];
