...
- (_CDVisionSignalGradingDataCollectionTask)initWithFile:(id)a3 activity:(id)a4
{
  ...
  if (v9)
  {
    ...
    v11 = [(_CDVisionSignalGradingDataCollectionTask *)v10 eventFromFile:v7];
    event = v10->_event;
    v10->_event = v11;
...
- (id)eventFromFile:(id)a3
{
  ...
  if (v6)
  {
    ...
    {
      [(_CDVisionSignalGradingDataCollectionTask *)v4 eventFromFile:v6, v7];
    }
...
- (id)eventFromDict:(id)a3
{
  ...
  v57 = 0u;
  v44 = v3;
  obj = [v3 objectForKeyedSubscript:@"visionGrades"];
