...
+ (id)generateNewSession
{
  ...
  v7 = [v2 initWithIdentifier:v5 salt:v6 latestStartDate:0 lastCollectionDate:0 batchNumber:1];
...
- (id)subsequentSessionWithlatestStartDate:(id)a3 lastCollectionDate:(id)a4
{
  ...
  if (!v6)
  {
    v8 = [(_CDFTCPInteractionDataCollectionSession *)self latestStartDate];
    v9 = v8;
    if (v8)
    {
      v10 = v8;
  ...
  v12 = [(_CDFTCPInteractionDataCollectionSession *)self identifier];
  v13 = [(_CDFTCPInteractionDataCollectionSession *)self salt];
  v14 = [v11 initWithIdentifier:v12 salt:v13 latestStartDate:v6 lastCollectionDate:v7 batchNumber:{-[_CDFTCPInteractionDataCollectionSession batchNumber](self, "batchNumber") + 1}];
...
{
  v4 = a3;
  v5 = [(_CDFTCPInteractionDataCollectionSession *)self latestStartDate];
  if (v5)
  {
    v6 = v5;
    v7 = [(_CDFTCPInteractionDataCollectionSession *)self latestStartDate];
    v8 = [v4 compare:v7] != -1;
  }
  ...
  v9 = [(_CDFTCPInteractionDataCollectionSession *)self lastCollectionDate];
  if (v9)
  {
    v10 = v9;
    v11 = [(_CDFTCPInteractionDataCollectionSession *)self lastCollectionDate];
    v12 = [v4 compare:v11];
  ...
  v13 = [(_CDFTCPInteractionDataCollectionSession *)self identifier];
  if (v13)
  {
    v14 = [(_CDFTCPInteractionDataCollectionSession *)self salt];
    if (v14)
    {
...
- (id)copyWithZone:(_NSZone *)a3
{
  v4 = [_CDFTCPInteractionDataCollectionSession allocWithZone:a3];
  v5 = [(_CDFTCPInteractionDataCollectionSession *)self identifier];
  v6 = [(_CDFTCPInteractionDataCollectionSession *)self salt];
  v7 = [(_CDFTCPInteractionDataCollectionSession *)self latestStartDate];
  v8 = [(_CDFTCPInteractionDataCollectionSession *)self lastCollectionDate];
...
- (void)encodeWithCoder:(id)a3
{
  ...
  v13 = [(_CDFTCPInteractionDataCollectionSession *)self batchNumber];
