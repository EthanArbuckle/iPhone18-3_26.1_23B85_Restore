...
- (id)description
{
  ...
  v8.receiver = self;
  v8.super_class = VisionSignalGradingEntry;
  v4 = [(VisionSignalGradingEntry *)&v8 description];
  dictionaryRepresentation = [(VisionSignalGradingEntry *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  if (*&self->_has)
  {
    v6 = [MEMORY[0x1E696AD98] numberWithInt:self->_count];
...
- (void)mergeFrom:(id)from
{
  ...
  {
    v5 = fromCopy;
    [(VisionSignalGradingEntry *)self setIdentifier:?];
    fromCopy = v5;
  }
