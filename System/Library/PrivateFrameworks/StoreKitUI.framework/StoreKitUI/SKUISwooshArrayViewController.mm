...
- (SKUISwooshArrayViewController)initWithSwooshComponents:(id)components;
- (id)_artworkLoader;
...
- (SKUISwooshArrayViewController)initWithSwooshComponents:(id)components
{
  ...
  v9.receiver = self;
  v9.super_class = SKUISwooshArrayViewController;
...
- (void)dealloc
{
  ...
  v8.receiver = self;
  v8.super_class = SKUISwooshArrayViewController;
...
- (void)setClientContext:(id)context
{
  ...
  if (self->_clientContext != contextCopy)
  {
    ...
    if (clientContext)
    {
      [(SKUIClientContext *)clientContext localizedStringForKey:@"PRODUCT_PAGE_RELATED_TAB" inTable:@"ProductPage"];
    }
...
- (void)setColorScheme:(id)scheme
{
  ...
  if (self->_colorScheme != schemeCopy)
  {
    ...
    view = [(SKUISwooshArrayViewController *)self view];
...
- (void)setSwooshComponents:(id)components
{
  ...
  if (self->_swooshComponents != componentsCopy)
  {
    ...
    componentsCopy = [(SKUISwooshArrayViewController *)self isViewLoaded];
    v5 = v8;
    if (componentsCopy)
    {
      componentsCopy = [(SKUISwooshArrayViewController *)self _reloadChildViewControllers];
      v5 = v8;
    }
  }
...
- (void)setHeaderViewController:(id)controller
{
  ...
  if (headerViewController != controllerCopy)
  {
    ...
    {
      [(SKUISwooshArrayViewController *)self addChildViewController:?];
...
- (void)loadView
{
  _scrollView = [(SKUISwooshArrayViewController *)self _scrollView];
  [(SKUISwooshArrayViewController *)self setView:_scrollView];
...
- (void)viewWillAppear:(BOOL)appear
{
  ...
  v5.receiver = self;
  v5.super_class = SKUISwooshArrayViewController;
  [(SKUISwooshArrayViewController *)&v5 viewWillAppear:appearCopy];
}
...
- (void)swoosh:(id)swoosh didSelectCellAtIndex:(int64_t)index
{
  ...
  if (item)
  {
    v8 = [(SKUISwooshArrayViewController *)self _clickEventWithItem:item];
    if (v8)
    {
...
{
  allCopy = all;
  v5 = [(SKUISwooshArrayViewController *)self _clickEventForSeeAllForViewController:allCopy];
  if (v5)
  {
...
- (id)_clickEventForSeeAllForViewController:(id)controller
{
  ...
  controllerCopy = controller;
  if ([(SKUIMetricsController *)self->_metricsController canRecordEventWithType:*MEMORY[0x277D6A478]])
  {
    v5 = objc_alloc_init(MEMORY[0x277D69B68]);
    v6 = *MEMORY[0x277D6A4D0];
    [v5 setTargetType:*MEMORY[0x277D6A4D0]];
    v7 = [(SKUIMetricsController *)self->_metricsController locationWithPosition:[(NSMutableArray *)self->_viewControllers indexOfObjectIdenticalTo:controllerCopy] type:@"swoosh" fieldData:0];
    v8 = [(SKUIMetricsController *)self->_metricsController locationWithPosition:0 type:v6 fieldData:0];
    v9 = v8;
    if (v7)
    {
      v10 = v8 == 0;
...
- (id)_clickEventWithItem:(id)item
{
  ...
  if ([(SKUIMetricsController *)self->_metricsController canRecordEventWithType:*MEMORY[0x277D6A478]])
  {
    ...
    v8 = [(SKUIMetricsController *)self->_metricsController locationWithPosition:v35[3] type:@"swoosh" fieldData:0];
    v9 = *MEMORY[0x277D6A4E0];
    v10 = [(SKUIMetricsController *)self->_metricsController locationWithPosition:v39[3] type:*MEMORY[0x277D6A4E0] fieldData:v7];
    v11 = v10;
    if (v8 && v10)
    {
      v42[0] = v10;
...
LABEL_9:
    ...
    if ([v3 count])
    {
      ...
      operationQueue = [(SKUISwooshArrayViewController *)self operationQueue];
...
- (void)_reloadChildViewControllers
{
  ...
  {
    _artworkLoader = [(SKUISwooshArrayViewController *)self _artworkLoader];
    v34 = 0u;
    v35 = 0u;
    v36 = 0u;
    v37 = 0u;
      ...
      do
      {
        for (j = 0; j != v33; ++j)
        {
          ...
          if (!v22)
          {
            ...
            if (backgroundColor)
            {
              [(SKUIColorScheme *)v22 setBackgroundColor:backgroundColor];
            }
          ...
          v29 = [[SKUILockupSwooshViewController alloc] initWithSwoosh:v21];
          ...
          lockups = [v21 lockups];
          -[SKUILockupSwooshViewController setSeeAllHidden:](v29, "setSeeAllHidden:", [lockups count] < 4);

          [*(&self->super.super.super.isa + v6) addObject:v29];
          [(SKUISwooshArrayViewController *)self addChildViewController:v29];
          v31 = [[SKUILockupSwooshArtworkLoader alloc] initWithArtworkLoader:_artworkLoader swoosh:v29];
