...
- (void)setColorScheme:(id)a3
{
  ...
  if (self->_colorScheme != v5)
  {
    ...
    v6 = [(SKUISwooshArrayViewController *)self view];
...
- (void)setSwooshComponents:(id)a3
{
  ...
  if (self->_swooshComponents != v4)
  {
    ...
    v4 = [(SKUISwooshArrayViewController *)self isViewLoaded];
    v5 = v8;
    if (v4)
    {
      v4 = [(SKUISwooshArrayViewController *)self _reloadChildViewControllers];
      v5 = v8;
    }
  }
...
- (void)setHeaderViewController:(id)a3
{
  ...
  if (headerViewController != v5)
  {
    ...
    {
      v7 = [(SKUIProductPageHeaderViewController *)self->_headerViewController view];
...
- (void)loadView
{
  v3 = [(SKUISwooshArrayViewController *)self _scrollView];
...
- (void)swoosh:(id)a3 didSelectCellAtIndex:(int64_t)a4
{
  ...
  if (v7)
  {
    v8 = [(SKUISwooshArrayViewController *)self _clickEventWithItem:v7];
    if (v8)
    {
...
{
  v4 = a3;
  v5 = [(SKUISwooshArrayViewController *)self _clickEventForSeeAllForViewController:v4];
  if (v5)
  {
...
- (id)_clickEventForSeeAllForViewController:(id)a3
{
  ...
  if ([(SKUIMetricsController *)self->_metricsController canRecordEventWithType:*MEMORY[0x277D6A478]])
  {
    ...
    v7 = [(SKUIMetricsController *)self->_metricsController locationWithPosition:[(NSMutableArray *)self->_viewControllers indexOfObjectIdenticalTo:v4] type:@"swoosh" fieldData:0];
...
- (void)_layoutSwooshViews
{
  v3 = [(SKUISwooshArrayViewController *)self view];
  [v3 frame];
  v5 = v4;
  v18 = 0;
  v19 = &v18;
...
LABEL_9:
    ...
    if ([v3 count])
    {
      ...
      v18 = [(SKUIClientContext *)self->_clientContext platformContext];
      ...
      v24 = [(SKUISwooshArrayViewController *)self operationQueue];
...
- (void)_reloadChildViewControllers
{
  ...
  {
    v17 = [(SKUISwooshArrayViewController *)self _artworkLoader];
    v34 = 0u;
    v35 = 0u;
    v36 = 0u;
    v37 = 0u;
      ...
      do
      {
        for (j = 0; j != v33; ++j)
        {
          ...
          if (!v22)
          {
            ...
            v23 = [(SKUIColorScheme *)self->_colorScheme backgroundColor];
            if (v23)
            {
          ...
          v30 = [v21 lockups];
          -[SKUILockupSwooshViewController setSeeAllHidden:](v29, "setSeeAllHidden:", [v30 count] < 4);

          [*(&self->super.super.super.isa + v6) addObject:v29];
          [(SKUISwooshArrayViewController *)self addChildViewController:v29];
          v31 = [[SKUILockupSwooshArtworkLoader alloc] initWithArtworkLoader:v17 swoosh:v29];
