...
- (void)setValue:(id)value forSettingDescription:(id)description
{
  ...
  v16 = [(SKUISignInSettingsGroupController *)self _keyForSettingDescription:descriptionCopy];
  if (v16)
  {
    [(SKUISignInSettingsGroupController *)self setValue:valueCopy forKey:v16];
  }
...
- (void)_attemptSignInWithAccountName:(id)name password:(id)password
{
  ...
  delegate = [(SKUISettingsGroupController *)self delegate];
...
- (void)_updateFieldsAuthenticating:(BOOL)authenticating
{
  ...
  if (self->_authenticating != authenticating)
  {
    ...
    v13 = 0u;
    v14 = 0u;
    settingDescriptions = [(SKUISettingsGroupController *)self settingDescriptions];
...
- (void)_becomeFirstResponderWithKey:(id)key
{
  v5 = [(SKUISignInSettingsGroupController *)self _settingDescriptionForKey:key];
...
- (void)_signInFailed:(id)failed error:(id)error
{
  ...
  settingsGroupDescription = [(SKUISettingsGroupController *)self settingsGroupDescription];
