        ...
        if (v14)
        {
          ...
          do
          {
            for (i = 0; i != v15; ++i)
            {
              ...
              v20 = [v18 item];
              v21 = SKUILockupImageSizeForLockupSize(v19, [v20 itemKind]);
              v27 = v22;
              v28 = v21;
...
- (id)cellForIndexPath:(id)a3
{
  ...
  if (v6 > 2)
  {
    if (v6 != 5)
    {
      ...
      {
        v8 = [v5 children];
        v9 = [(SKUIGridPageSection *)self _mediaCellWithMedia:v8 indexPath:v4];
      }
      ...
      else
      {
        ...
        v8 = [v5 children];
        v9 = [(SKUIGridPageSection *)self _editorialCellWithEditorials:v8 indexPath:v4];
      }
...
LABEL_9:
    v8 = [v5 children];
    v9 = [(SKUIGridPageSection *)self _itemCellWithLockups:v8 indexPath:v4];
    goto LABEL_11;
  }
  ...
  v8 = [v5 children];
  v9 = [(SKUIGridPageSection *)self _editorialLockupCellWithLockups:v8 indexPath:v4];
LABEL_11:
  v7 = v9;
...
- (void)collectionViewDidConfirmItemOfferAtIndexPath:(id)a3
{
  v13 = a3;
  v4 = [v13 item];
  v5 = [(SKUIGridPageSection *)self _itemForIndex:v4];
  if (v5)
  {
    v6 = [(SKUIStorePageSection *)self context];
    v7 = [(SKUIGridPageSection *)self itemOfferClickEventWithItem:v5 elementName:*MEMORY[0x277D6A4E0] index:v4];
    if (v7)
    {
...
- (void)collectionViewDidEndDisplayingCellForItemAtIndexPath:(id)a3
{
  v4 = -[SKUIGridPageSection _itemForIndex:](self, "_itemForIndex:", [a3 item]);
  v5 = v4;
  if (v4)
  {
    v10 = v4;
...
- (void)collectionViewDidSelectItemAtIndexPath:(id)a3
{
  ...
  v5 = [v15 item];
  v6 = [(SKUIGridPageSection *)self _itemForIndex:v5];
  if (v6)
  {
  ...
  else if ([v4 gridType] == 4)
  {
    ...
    if (v5 < [v7 count])
    {
      ...
      v10 = [(SKUIStorePageSection *)self clickEventWithMedia:v9 elementName:*MEMORY[0x277D6A4E0] index:v5];
      if (v10)
      {
...
{
  v4 = a3;
  v5 = -[SKUIGridPageSection _itemForIndex:](self, "_itemForIndex:", [v4 item]);
  v6 = [v5 videos];
  v7 = [v6 firstObject];
...
- (void)prefetchResourcesWithReason:(int64_t)a3
{
  ...
  if (self->_containsLockups)
  {
    ...
    v17 = [(SKUIStorePageSection *)self pageComponent];
    v18 = [v17 gridType];

    v19 = [(SKUIStorePageSection *)self pageComponent];
    v20 = v19;
    if (v19)
    {
      [v19 lockupStyle];
...
LABEL_14:
  ...
  if (self->_isPad)
  {
    ...
    {
      self->_isLandscape = 0;
      v20 = [(SKUIGridPageSection *)self _numberOfPortraitColumnsWithGridType:v8];
    }

    else
    {
      self->_isLandscape = 1;
      v20 = [(SKUIGridPageSection *)self _numberOfLandscapeColumnsWithGridType:v8];
    }
...
- (void)willTransitionToSize:(CGSize)a3 withTransitionCoordinator:(id)a4
{
  ...
  if (self->_isPad || ([MEMORY[0x277D759A0] mainScreen], v8 = objc_claimAutoreleasedReturnValue(), objc_msgSend(v8, "bounds"), v10 = v9, v8, v10 > 375.0))
  {
    ...
    if (self->_isPad)
    {
      ...
      {
        v13 = [(SKUIGridPageSection *)self _numberOfLandscapeColumnsWithGridType:v12];
      }

      else
      {
        v13 = [(SKUIGridPageSection *)self _numberOfPortraitColumnsWithGridType:v12];
      }
    }
  ...
  [(SKUIStorePageSection *)&v17 willTransitionToSize:v7 withTransitionCoordinator:width, height];
}
  ...
  if (v22)
  {
    ...
    if (v24 == [(SKUIStorePageSection *)self sectionIndex])
    {
      ...
      if ([v26 canRecordEventWithType:*MEMORY[0x277D6A488]])
      {
        ...
        v28 = SKUIMetricsMediaEventTypeForPlaybackState(a4);
        [v27 setMediaEventType:v28];

        v29 = [(SKUIStorePageSection *)self pageComponent];
        v30 = [v29 children];
...
- (id)_artworkContextForLockupSize:(int64_t)a3
{
  ...
  if (!v8)
  {
    ...
    v11 = [SKUIProductImageDataConsumer lockupConsumerWithSize:a3 itemKind:7];
    [(SKUIItemArtworkContext *)v8 setGeneralConsumer:v11];

    v12 = [SKUIStyledImageDataConsumer lockupIconConsumerWithSize:a3];
    [(SKUIItemArtworkContext *)v8 setIconConsumer:v12];

    v13 = [SKUIProductImageDataConsumer lockupConsumerWithSize:a3 itemKind:8];
    [(SKUIItemArtworkContext *)v8 setLetterboxConsumer:v13];

    v14 = [SKUIStyledImageDataConsumer lockupProductImageConsumerWithSize:a3];
    [(SKUIItemArtworkContext *)v8 setNewsstandConsumer:v14];

    v15 = [SKUIProductImageDataConsumer lockupConsumerWithSize:a3 itemKind:6];
...
LABEL_4:
  ...
  v12 = [(SKUIGridPageSection *)self _artworkContextForLockupSize:a4];
...
- (id)_editorialCellWithEditorials:(id)a3 indexPath:(id)a4
{
  ...
  v8 = [(SKUIStorePageSection *)self context];
  v9 = [v8 collectionView];
  v10 = [v9 dequeueReusableCellWithReuseIdentifier:0x282808E48 forIndexPath:v7];
  v11 = [v10 layout];
...
- (id)_editorialLayoutForEditorial:(id)a3
{
  ...
  if (!v5)
  {
    ...
    v5 = [(SKUIEditorialLayout *)v6 initWithEditorial:v4 layoutCache:v8];
...
- (id)_editorialLockupCellWithLockups:(id)a3 indexPath:(id)a4
{
  ...
  v8 = [(SKUIStorePageSection *)self context];
  v9 = [v8 collectionView];
  v10 = [v9 dequeueReusableCellWithReuseIdentifier:0x2828123C8 forIndexPath:v7];
  v11 = [v10 layout];
...
- (double)_heightForEditorialLockup:(id)a3
{
  ...
  v6 = v5;
  v7 = [(SKUIGridPageSection *)self _editorialLayoutForLockup:v4];
...
- (id)_itemCellWithLockups:(id)a3 indexPath:(id)a4
{
  ...
  v8 = [(SKUIStorePageSection *)self context];
  v9 = [v8 collectionView];
  v10 = [v9 dequeueReusableCellWithReuseIdentifier:0x2828083E8 forIndexPath:v7];
...
- (void)_loadImageForItem:(id)a3 lockupSize:(int64_t)a4 loader:(id)a5 reason:(int64_t)a6
{
  v18 = a3;
  v10 = a5;
  v11 = [(SKUIGridPageSection *)self _artworkContextForLockupSize:a4];
  ...
  if (v12)
  {
    ...
    v14 = [(SKUIGridPageSection *)self _artworkContextForLockupSize:a4];
...
- (void)_loadMissingItemsFromIndex:(int64_t)a3 withReason:(int64_t)a4
{
  ...
  {
    v7 = [(SKUIGridPageSection *)self _missingItemLoader];
...
- (id)_mediaCellWithMedia:(id)a3 indexPath:(id)a4
{
  ...
  v10 = [v9 dequeueReusableCellWithReuseIdentifier:0x282811FA8 forIndexPath:v7];
  v11 = [v7 item];
...
LABEL_6:
        ...
        if (v18)
        {
          v19 = [(SKUIGridPageSection *)self _newSizeToFitArtworkRequestWithArtwork:v18 mediaIndex:v11];
          artworkRequests = self->_artworkRequests;
...
- (id)_newSizeToFitArtworkRequestWithArtwork:(id)a3 mediaIndex:(int64_t)a4
{
  ...
  [(SKUIGridPageSection *)self _mediaWidthForMediaIndex:a4 gridWidth:?];
  v12 = v11;
...
- (void)_reloadEditorialLockupCell:(id)a3 withLockup:(id)a4 index:(int64_t)a5
{
  v8 = a3;
  v9 = a4;
  v33 = [(SKUIStorePageSection *)self context];
  ...
  v32 = [(SKUIGridPageSection *)self _cellImageForItem:v12 lockupSize:0];
  [v13 setIconImage:?];
  ...
  v31 = [(SKUIGridPageSection *)self _editorialLayoutForLockup:v9];
...
- (void)_reloadItemCell:(id)a3 withLockup:(id)a4 index:(int64_t)a5
{
  ...
  if (v10)
  {
    v12 = [(SKUIGridPageSection *)self _cellImageForItem:v10 lockupSize:0];
...
- (void)_selectItem:(id)a3 withIndex:(int64_t)a4
{
  v6 = a3;
  v7 = [(SKUIStorePageSection *)self context];
  v8 = [(SKUIGridPageSection *)self clickEventWithItem:v6 elementName:*MEMORY[0x277D6A4E0] index:a4];
  if (v8)
  {
  ...
  if ((objc_opt_respondsToSelector() & 1) == 0 || ([v11 sectionsViewController:v10 showProductPageForItem:v6] & 1) == 0)
  {
    ...
    {
      v25 = a4;
      v26 = [[SKUIPlayableAsset alloc] initWithVideo:v15];
      v18 = [(SKUIStorePageSection *)self context];
      v19 = [v18 clientContext];
      SKUIVideoPreviewPlayPlayableAsset(v26, v19);
      v21 = v20 = v7;

      v22 = [(SKUIStorePageSection *)self context];
        ...
        if ([v16 section] == v7)
        {
          ...
          if (v17 < v10)
          {
            ...
            if (v9 == 1)
            {
              ...
              v21 = [(SKUIGridPageSection *)v25 _editorialLayoutForLockup:v23];
            ...
            else
            {
              ...
              v21 = [(SKUIGridPageSection *)v25 _editorialLayoutForEditorial:v20];
...
- (id)_videoThumbnailImageForVideo:(id)a3 thumbnailSize:(CGSize)a4
{
  ...
  {
LABEL_4:
    [(SKUIGridPageSection *)self _loadImageForVideo:v7 thumbnailSize:v9 loader:1 reason:width, height];
  }

  v13 = [[SKUISizeValue alloc] initWithSize:width, height];
