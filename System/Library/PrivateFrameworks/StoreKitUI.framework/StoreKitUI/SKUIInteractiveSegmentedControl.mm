...
- (SKUIInteractiveSegmentedControl)initWithFrame:(CGRect)a3
{
  ...
  v9.receiver = self;
  v9.super_class = SKUIInteractiveSegmentedControl;
  result = [(SKUIInteractiveSegmentedControl *)&v9 initWithFrame:x, y, width, height];
  if (result)
  {
...
- (void)dealloc
{
  ...
  if (v4)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        [(SKUIInteractiveSegmentedControl *)self _unregisterForObservationOfSegment:*(*(&v9 + 1) + 8 * v7++)];
      }
  ...
  v8.receiver = self;
  v8.super_class = SKUIInteractiveSegmentedControl;
...
- (void)layoutSubviews
{
  ...
  v59.receiver = self;
  v59.super_class = SKUIInteractiveSegmentedControl;
...
void __49__SKUIInteractiveSegmentedControl_layoutSubviews__block_invoke_2(uint64_t a1, void *a2)
{
  ...
  SKUIRectByApplyingUserInterfaceLayoutDirectionInRect(v6, 0.0, v8, Height, *(a1 + 88), *(a1 + 96), *(a1 + 104), *(a1 + 112));
  [v27 setFrame:?];
  v31.origin.y = 0.0;
  v31.origin.x = v6;
  v31.size.width = v8;
  ...
  *(*(*(a1 + 48) + 8) + 24) = CGRectGetWidth(v31) + *(*(*(a1 + 48) + 8) + 24);
  if ((v3 - 1) <= 1)
  {
    ...
    if (v21)
    {
      ...
      SKUIRectByApplyingUserInterfaceLayoutDirectionInRect(v18, 0.0, v19, v20, *(a1 + 88), *(a1 + 96), *(a1 + 104), *(a1 + 112));
      [v22 setFrame:?];
    }
...
- (void)setSegments:(id)a3
{
  ...
  if (segments != v4 && ![(NSArray *)segments isEqualToArray:v4])
  {
    ...
    if (v21)
    {
      ...
      do
      {
        for (j = 0; j != v22; ++j)
        {
          ...
          v25 = *(*(&v36 + 1) + 8 * j);
          [(SKUIInteractiveSegmentedControl *)self _unregisterForObservationOfSegment:v25, v34];
    ...
    if (v34)
    {
      ...
      v33 = [(SKUIInteractiveSegmentedControl *)self _setSelectionProgress:v30, v34];
