    ...
    if (v12)
    {
      ...
      do
      {
        ...
        do
        {
          ...
          [(SKUIImageGridView *)self addSubview:*(*(&v16 + 1) + 8 * v15++), v16];
        }
...
+ (CGSize)preferredSizeForViewElement:(id)element context:(id)context
{
  [SKUIImageGridViewReuseView preferredSizeForViewElement:element context:context];
  result.height = v5;
  result.width = v4;
  return result;
}
...
+ (CGSize)sizeThatFitsWidth:(double)width viewElement:(id)element context:(id)context
{
  [SKUIImageGridViewReuseView sizeThatFitsWidth:element viewElement:context context:width];
  result.height = v6;
  result.width = v5;
  return result;
}
...
- (void)reloadWithViewElement:(id)element width:(double)width context:(id)context
{
  ...
  [(SKUIImageGridViewReuseView *)reuseView reloadWithViewElement:elementCopy width:contextCopy context:width];
  -[SKUIImageGridView setColumnCount:](self, "setColumnCount:", [elementCopy columnCount]);
  [elementCopy contentInset];
  [(SKUIImageGridView *)self setContentInset:?];
  imageViews = [(SKUIImageGridViewReuseView *)self->_reuseView imageViews];
  [(SKUIImageGridView *)self setImageViews:imageViews];

  [elementCopy size];
  [(SKUIImageGridView *)self setSize:?];
}

- (CGSize)sizeThatFits:(CGSize)fits
{
  v36 = *MEMORY[0x277D85DE8];
  v4 = [(SKUIImageGridView *)self columnCount:fits.width];
  if (v4 <= 1)
  {
    v5 = 1;
  }
  ...
  imageViews = [(SKUIImageGridView *)self imageViews];
  v7 = [imageViews count] / v5;

  imageViews2 = [(SKUIImageGridView *)self imageViews];
  ...
  v32 = 0u;
  selfCopy = self;
  imageViews3 = [(SKUIImageGridView *)self imageViews];
...
- (void)layoutSubviews
{
  ...
  v69.receiver = self;
  v69.super_class = SKUIImageGridView;
  [(SKUIImageGridView *)&v69 layoutSubviews];
  columnCount = [(SKUIImageGridView *)self columnCount];
  if (columnCount <= 1)
  {
    v4 = 1;
  }
  ...
  v65 = 0u;
  v66 = 0u;
  imageViews3 = [(SKUIImageGridView *)selfCopy imageViews];
  ...
  [(SKUIImageGridView *)selfCopy bounds];
  v24 = v23;
  [(SKUIImageGridView *)selfCopy bounds];
  v26 = v25;
  for (j = 0; j != v4; ++j)
  ...
  [(SKUIImageGridView *)selfCopy contentInset];
  v32 = v26 - v31;
  [(SKUIImageGridView *)selfCopy contentInset];
  v34 = v32 - v33;
  [(SKUIImageGridView *)selfCopy contentInset];
  ...
  v63 = 0u;
  v64 = 0u;
  imageViews4 = [(SKUIImageGridView *)selfCopy imageViews];
