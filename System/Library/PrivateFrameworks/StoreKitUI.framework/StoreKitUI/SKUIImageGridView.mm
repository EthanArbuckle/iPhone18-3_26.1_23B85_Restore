...
- (void)reloadWithViewElement:(id)a3 width:(double)a4 context:(id)a5
{
  ...
  v12 = [(SKUIImageGridViewReuseView *)self->_reuseView imageViews];
...
- (CGSize)sizeThatFits:(CGSize)a3
{
  ...
  v4 = [(SKUIImageGridView *)self columnCount:a3.width];
  if (v4 <= 1)
  {
    v5 = 1;
  }
  ...
  v6 = [(SKUIImageGridView *)self imageViews];
  v7 = [v6 count] / v5;

  v8 = [(SKUIImageGridView *)self imageViews];
  v9 = [v8 count] % v5;
  ...
  v32 = 0u;
  v30 = self;
  v13 = [(SKUIImageGridView *)self imageViews];
...
- (void)layoutSubviews
{
  ...
  v3 = [(SKUIImageGridView *)self columnCount];
  if (v3 <= 1)
  {
    v4 = 1;
  }
  ...
  v5 = [(SKUIImageGridView *)self imageViews];
  v6 = [v5 count] / v4;

  v60 = self;
  v7 = [(SKUIImageGridView *)self imageViews];
  v8 = [v7 count] % v4;
  ...
  v65 = 0u;
  v66 = 0u;
  v12 = [(SKUIImageGridView *)v60 imageViews];
