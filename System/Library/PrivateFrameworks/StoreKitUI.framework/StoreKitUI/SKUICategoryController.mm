...
- (SKUICategoryController)initWithContentsController:(id)controller
{
  ...
  v8.receiver = self;
  v8.super_class = SKUICategoryController;
...
- (void)dealloc
{
  ...
  v3.receiver = self;
  v3.super_class = SKUICategoryController;
...
- (UIBarButtonItem)categoryButton
{
  ...
  if (!button)
  {
    ...
    {
      [SKUIClientContext localizedStringForKey:@"CATEGORIES_BUTTON" inBundles:0];
    }
    v5 = ;
...
- (void)loadFromURL:(id)l withCompletionBlock:(id)block
{
  ...
  v11 = +[(SSVURLDataConsumer *)SKUIJSONDataConsumer];
...
- (UISegmentedControl)segmentedControl
{
  ...
  if (!segmentedControl)
  {
    ...
    v5 = [(SKUISegmentedControl *)v4 initWithItems:MEMORY[0x277CBEBF8]];
...
- (void)buttonAction:(id)action
{
  ...
  else
  {
    ...
    v14 = [(SKUICategory *)v13 subcategoryContainingURL:self->_selectedURL];
    if (v14)
    {
      v15 = v14;
      ...
      while (1)
      {
        ...
        v15 = [(SKUICategory *)v23 subcategoryContainingURL:self->_selectedURL];
...
- (void)segmentedControlAction:(id)action
{
  ...
  if (isKindOfClass)
  {
    v7 = [(SKUICategoryController *)self _tableViewControllerWithCategory:rootCategory];
    tableViewController = self->_tableViewController;
...
LABEL_7:
  ...
  else
  {
    ...
    if (v12)
    {
      v13 = [(SKUICategoryController *)self _tableViewControllerWithCategory:v28];
...
- (id)metricsPageContextForCategoryTableView:(id)view
{
  ...
  if (WeakRetained)
  {
    v5 = [(SKUIClientContext *)self->_clientContext metricsPageContextForViewController:WeakRetained];
  }
...
- (id)_artworkLoader
{
  ...
  if (!artworkLoader)
  {
    ...
    v5 = [[SKUICategoryArtworkLoader alloc] initWithArtworkLoader:v4];
    v6 = self->_artworkLoader;
    self->_artworkLoader = v5;

    v7 = self->_artworkLoader;
    v8 = +[SKUIStyledImageDataConsumer categoryIconConsumer];
...
void __49__SKUICategoryController__reloadSegmentedControl__block_invoke(uint64_t a1, void *a2, uint64_t a3)
{
  ...
  else
  {
    ...
    else
    {
      ...
      {
        [SKUIClientContext localizedStringForKey:@"CATEGORIES_MORE_SEGMENT" inBundles:0];
      }
      v6 = ;
    }
  }
...
- (void)_recordClickEventWithCategory:(id)category index:(int64_t)index
{
  ...
  if (WeakRetained)
  {
    v8 = [(SKUIClientContext *)self->_clientContext metricsPageContextForViewController:WeakRetained];
  }
...
- (void)_reloadSelectedSegment
{
  ...
  selectedURL = self->_selectedURL;
  v4 = [(SKUICategory *)self->_rootCategory URL];
