...
- (BOOL)isEqual:(id)a3
{
  ...
  objc_opt_class();
  if ((objc_opt_isKindOfClass() & 1) == 0 || (v8.receiver = self, v8.super_class = SKUIImageIndexBarEntry, ![(SKUIIndexBarEntry *)&v8 isEqual:v4]))
  {
    v6 = 0;
    goto LABEL_8;
  }
...
- (void)_drawContentInRect:(CGRect)a3
{
  ...
  else
  {
    ...
    CGContextSetFillColorWithColor(CurrentContext, 0);
    [(UIImage *)self->_image drawInRect:x, y, width, height];
    v9 = [(SKUIIndexBarEntry *)self tintColor];
    [v9 setFill];
    v11.origin.x = x;
    v11.origin.y = y;
