...
- (SKUIMediaSocialSaveProfilePhotoOperation)initWithClientContext:(id)context;
...
- (SKUIMediaSocialSaveProfilePhotoOperation)initWithClientContext:(id)context
{
  ...
  v11.receiver = self;
  v11.super_class = SKUIMediaSocialSaveProfilePhotoOperation;
...
- (void)main
{
  ...
  v25 = __Block_byref_object_dispose__105;
  v26 = 0;
  obj = 0;
  ...
  if (v3)
  {
    ...
    v15 = &v14;
    v16 = 0x3032000000;
    v17 = __Block_byref_object_copy__105;
    v18 = __Block_byref_object_dispose__105;
    v19 = 0;
    v13[0] = MEMORY[0x277D85DD0];
    v13[1] = 3221225472;
    v13[2] = __48__SKUIMediaSocialSaveProfilePhotoOperation_main__block_invoke;
    v13[3] = &unk_2781FBAC8;
    v13[4] = &v14;
    v13[5] = &v21;
    ...
    else
    {
      ...
      if ([uRLResponse statusCode] < 200 || objc_msgSend(uRLResponse, "statusCode") > 299)
      {
        ...
        v9 = [MEMORY[0x277CCA9B8] errorWithDomain:@"SKUIErrorDomain" code:v8 userInfo:0];
        v10 = v22[5];
        v22[5] = v9;
      ...
      {
        v6 = [(SKUIMediaSocialSaveProfilePhotoOperation *)self _photoUploadWithResponseDictionary:v15[5]];
      }
    }
  ...
  outputBlock = [(SKUIMediaSocialSaveProfilePhotoOperation *)self outputBlock];
  v12 = outputBlock;
  if (outputBlock)
  {
...
- (id)_photoUploadWithResponseDictionary:(id)dictionary
{
  ...
  if (objc_opt_isKindOfClass())
  {
    v4 = [[SKUIMediaSocialPhotoUpload alloc] initWithUploadDictionary:dictionaryCopy];
  }
...
- (id)_requestWithError:(id *)error
{
  ...
  if (objc_opt_isKindOfClass())
  {
    ...
    if (error)
    {
      v13 = [objc_alloc(MEMORY[0x277CCA9B8]) initWithDomain:@"SKUIErrorDomain" code:4 userInfo:0];
      goto LABEL_8;
    }
  }
