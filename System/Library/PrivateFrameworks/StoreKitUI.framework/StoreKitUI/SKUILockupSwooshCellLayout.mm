...
- (CGSize)maxImageSize;
- (CGSize)videoSize;
- (SKUILockupSwooshCellLayout)initWithCollectionViewCell:(id)cell;
- (id)_newDefaultLabel;
...
- (SKUILockupSwooshCellLayout)initWithCollectionViewCell:(id)cell
{
  ...
  v5 = [(SKUICellLayout *)&v9 initWithCollectionViewCell:cellCopy];
  if (v5)
  {
...
- (void)setArtistName:(id)name
{
  ...
  if (text != nameCopy && ([text isEqualToString:nameCopy] & 1) == 0)
  {
    ...
    if (nameCopy)
    {
      if (!artistNameLabel)
      {
        _newDefaultLabel = [(SKUILockupSwooshCellLayout *)self _newDefaultLabel];
...
{
  imageCopy = image;
  videoThumbnailImage = [(SKUILockupSwooshCellLayout *)self videoThumbnailImage];
...
- (void)layoutSubviews
{
  ...
  if ((self->_visibleFields & 2) != 0)
  {
    ...
    isIconImageHidden = [(SKUIItemCellLayout *)self isIconImageHidden];
    iconImageView = v18;
  }
...
- (void)setItemOffer:(id)offer
{
  ...
  [(SKUIItemCellLayout *)&v4 setItemOffer:offer];
...
- (void)setItemState:(id)state animated:(BOOL)animated
{
  ...
  [(SKUIItemCellLayout *)&v5 setItemState:state animated:animated];
  [(SKUILockupSwooshCellLayout *)self _reloadPriceLabel];
}
...
- (void)setHighlighted:(BOOL)highlighted
{
  v4.receiver = self;
  v4.super_class = SKUILockupSwooshCellLayout;
  [(SKUIItemCellLayout *)&v4 setHighlighted:highlighted];
...
- (void)setSelected:(BOOL)selected
{
  v4.receiver = self;
  v4.super_class = SKUILockupSwooshCellLayout;
  [(SKUIItemCellLayout *)&v4 setSelected:selected];
  [(SKUILockupSwooshCellLayout *)self _reloadHighlight];
}
...
LABEL_19:
  ...
  if (itemOffer)
  {
    [(SKUILockupSwooshCellLayout *)self setPrice:itemOffer];
    goto LABEL_22;
  }
...
LABEL_21:
  ...
  [(SKUILockupSwooshCellLayout *)self setPrice:buttonText];
...
- (void)_reloadHighlight
{
  if ([(SKUIItemCellLayout *)self isHighlighted]|| [(SKUIItemCellLayout *)self isSelected])
  {
    ...
    iconImage = [(SKUIItemCellLayout *)self iconImage];
    blackColor = [MEMORY[0x277D75348] blackColor];
    ...
    if (videoImageView && ([(UIImageView *)videoImageView isHidden]& 1) == 0)
    {
      ...
      if (!videoHighlightImageView)
      {
        ...
        parentCellView2 = [(SKUICellLayout *)self parentCellView];
        ...
        contentView2 = [(SKUICellLayout *)self contentView];
