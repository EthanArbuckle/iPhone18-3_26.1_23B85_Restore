...
- (void)dealloc
{
  ...
  v5.receiver = self;
  v5.super_class = SKUIBannerViewController;
...
- (void)loadWithProductParameters:(id)a3 mainDocumentURL:(id)a4
{
  ...
  v18 = [(SKUIBannerViewController *)self resourceOperationQueue:v19];
...
- (id)_itemState
{
  ...
  {
    [(SKUIBannerViewController *)self _warmItemStateCenter];
    v3 = [(SKUIItemStateCenter *)self->_itemStateCenter stateForItemWithIdentifier:self->_itemIdentifier];
  }
...
- (void)_launchURL:(id)a3 withBundleIdentifier:(id)a4
{
  ...
  if (v5)
  {
    ...
    {
      SKUIMetricsLaunchApplicationWithIdentifierAndURLAndLaunchOptions(v7, 0, 0, 0, 0);
    }
...
LABEL_16:
    ...
    v20 = [(SKUIClientContext *)self->_clientContext valueForConfigurationKey:@"sfsuffix"];
...
- (id)_itemArtworkContext
{
  ...
  if (!itemArtworkContext)
  {
    ...
    v7 = +[SKUIStyledImageDataConsumer safariBannerIconConsumer];
    [(SKUIItemArtworkContext *)v6 setIconConsumer:v7];

    v8 = self->_itemArtworkContext;
    v9 = +[SKUIProductImageDataConsumer smartBannerConsumer];
    [(SKUIItemArtworkContext *)v8 setGeneralConsumer:v9];

    v10 = self->_itemArtworkContext;
    v11 = +[SKUIStyledImageDataConsumer safariBannerProductImageConsumer];
