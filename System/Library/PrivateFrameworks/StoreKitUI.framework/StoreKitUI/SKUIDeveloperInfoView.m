...
- (SKUIDeveloperInfoView)initWithDeveloperInfo:(id)a3 clientContext:(id)a4
{
  ...
  v48.receiver = self;
  v48.super_class = SKUIDeveloperInfoView;
  ...
  if (v9)
  {
    ...
    if (v14)
    {
      ...
      {
        [SKUIClientContext localizedStringForKey:@"DEVELOPER_INFO_LABEL_TRADE_NAME" inBundles:0 inTable:@"ProductPage"];
      }
      v15 = ;
      v53[0] = v15;
      v53[1] = v14;
    ...
    if (v17)
    {
      ...
      {
        [SKUIClientContext localizedStringForKey:@"DEVELOPER_INFO_LABEL_TRADE_REP" inBundles:0 inTable:@"ProductPage"];
      }
      v18 = ;
      v52[0] = v18;
      v52[1] = v17;
    ...
    if (v20)
    {
      ...
      {
        [SKUIClientContext localizedStringForKey:@"DEVELOPER_INFO_LABEL_ADDRESS" inBundles:0 inTable:@"ProductPage"];
      }
      v21 = ;
      v51[0] = v21;
      v51[1] = v20;
    ...
    if (v23)
    {
      ...
      {
        [SKUIClientContext localizedStringForKey:@"DEVELOPER_INFO_LABEL_PHONE" inBundles:0 inTable:@"ProductPage"];
      }
      v24 = ;
      v50[0] = v24;
      v50[1] = v23;
    ...
    if (v26)
    {
      ...
      {
        [SKUIClientContext localizedStringForKey:@"DEVELOPER_INFO_LABEL_EMAIL" inBundles:0 inTable:@"ProductPage"];
      }
      v27 = ;
      v49[0] = v27;
      v49[1] = v26;
    ...
    if ([v13 count])
    {
      ...
      [(SKUIProductInformationView *)v10->_infoView setContentInset:v31, v31, 17.0, 15.0];
...
- (void)layoutSubviews
{
  ...
  v8 = v7;
  [(SKUIProductInformationView *)self->_infoView sizeThatFits:v4, v6];
  v10 = v9;
  v12 = v11;
  *&v9 = (v4 - v9) * 0.5;
  v13 = floorf(*&v9);
  [(SKUIProductInformationView *)self->_infoView setFrame:v13, v8, v10, v11];
  v35.origin.x = v13;
  v35.origin.y = v8;
  v35.size.width = v10;
  v35.size.height = v12;
