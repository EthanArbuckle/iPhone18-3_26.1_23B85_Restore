...
- (id)_initSKProductPageViewController
{
  ...
  if (v3)
  {
    ...
    {
      v7 = [objc_opt_class() _defaultClientInterface];
      ...
      v11 = [(SUStorePageViewController *)v4->_storePageViewController copyScriptProperties];
      if (v4->_style == 1)
      {
      ...
      [v13 addObserver:v4 selector:sel__purchaseFailedNotification_ name:*MEMORY[0x277D7FF30] object:0];
      [v13 addObserver:v4 selector:sel__purchaseFinishedNotification_ name:*MEMORY[0x277D7FF38] object:0];
...
{
  v4 = a4;
  v6 = [(SKProductPageViewController *)self _previewOverlay];
...
- (void)_reloadViews
{
  ...
  if (!bannerViewController)
  {
    ...
    {
      v4 = [(SKUIITunesStoreUIPageViewController *)self->_storePageViewController view];
      [v4 removeFromSuperview];

      v5 = [(SKUIIPhoneProductPageViewController *)self->_iphoneProductPageViewController view];
    ...
    else
    {
      ...
      {
        v10 = [(SKUIITunesStoreUIPageViewController *)storePageViewController view];
        [v10 removeFromSuperview];

        v11 = [(SKUIIPadProductPageViewController *)self->_ipadProductPageViewController view];
        [v11 removeFromSuperview];

        v15 = [(SKUIIPhoneProductPageViewController *)self->_iphoneProductPageViewController view];
      ...
      v13 = [(SKUIIPadProductPageViewController *)self->_ipadProductPageViewController view];
...
LABEL_6:
  ...
  v7 = [(SKProductPageViewController *)self view];
  [v7 bounds];
  [v14 setFrame:?];

  v8 = [(SKProductPageViewController *)self view];
  [v8 addSubview:v14];
}
...
- (void)_setResponse:(id)a3 forProperties:(id)a4 error:(id)a5
{
  ...
  if (v13)
  {
    ...
    {
      v21 = [(SKProductPageViewController *)self view];
      v22 = [v8 MIMEType];
...
{
  v3 = a3;
  v5 = [(SKProductPageViewController *)self _previewOverlay];
  v6 = [(SUViewController *)self navigationController];
...
- (void)_showProductPage:(id)a3 pageEvent:(id)a4
{
  ...
  if (style == 3 || !style && ([MEMORY[0x277D75418] currentDevice], v14 = objc_claimAutoreleasedReturnValue(), v15 = objc_msgSend(v14, "userInterfaceIdiom"), v14, v15 == 1))
  {
    ...
    v17 = [[SKUIIPadProductPageViewController alloc] initWithProductPage:v6];
    ...
    [(SKUIIPadProductPageViewController *)v19 _setExistingNavigationItem:v20];
    ...
    [(SKUIIPadProductPageViewController *)self->_ipadProductPageViewController configureMetricsWithPageEvent:v7];
    [(SKUIIPadProductPageViewController *)self->_ipadProductPageViewController setAskPermission:self->_askToBuy];
  ...
  else
  {
    ...
    v23 = [[SKUIIPhoneProductPageViewController alloc] initWithProductPage:v6];
    ...
    v26 = [(SUViewController *)self navigationItem];
    [(SKUIIPhoneProductPageViewController *)v25 _setExistingNavigationItem:v26];
    ...
    [(SKUIIPhoneProductPageViewController *)self->_iphoneProductPageViewController configureMetricsWithPageEvent:v7];
