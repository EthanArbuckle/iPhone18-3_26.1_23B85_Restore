...
- (void)main
{
  ...
  if ([(SKUIRedeemPreflightOperation *)self forcesAuthentication])
  {
    ...
    v5 = [(SKUIRedeemPreflightOperation *)self _authenticationContext];
    ...
    if (([v4 canPerformExtendedBiometricActionsForAccountIdentifier:v6] & 1) == 0)
    {
      ...
      v9 = [(SKUIRedeemPreflightOperation *)self _authenticationContext];
      v10 = [v8 initWithAuthenticationContext:v9];

      v11 = [(SKUIRedeemPreflightOperation *)self redeemViewController];
