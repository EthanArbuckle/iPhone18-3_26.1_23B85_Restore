...
- (SKUICountdownView)initWithCountdown:(id)a3 clientContext:(id)a4
{
  ...
  if (v9)
  {
    ...
    v14 = [(SKUICountdown *)v10->_countdown numberFormat];
    if (v14)
    {
  ...
  if (v4 != v12)
  {
    ...
    if (v12)
    {
      if (!imageView)
      {
        ...
        v9 = self->_imageView;
        v10 = [(SKUICountdownView *)self backgroundColor];
    ...
    v5 = [(SKUICountdownView *)self setNeedsLayout];
  }
...
- (void)start
{
  if ([(SKUICountdown *)self->_countdown isLoaded])
  {
    ...
    {
      v4 = [(SKUICountdown *)self->_countdown rate];
...
- (void)setFrame:(CGRect)a3
{
  ...
  [(SKUICountdownView *)&v5 setFrame:a3.origin.x, a3.origin.y, a3.size.width, a3.size.height];
...
- (void)layoutSubviews
{
  ...
  if ([(SKUICountdown *)self->_countdown isLoaded])
  {
    v11 = [(SKUICountdown *)self->_countdown artworkProvider];

    if (v11)
    {
      v12 = [(SKUICountdown *)self->_countdown artworkProvider];
    ...
    v18 = [(SKUICountdown *)self->_countdown type];
    ...
    if (v18)
    {
      ...
      v20 = [(SKUICountdown *)self->_countdown isFlapped];
...
- (id)_newDateLabel
{
  ...
  v4 = [(SKUICountdown *)self->_countdown fontColor];
  [v3 setTextColor:v4];
...
- (id)_newFlapLabelWithPosition:(int64_t)a3
{
  v5 = [(SKUICountdown *)self->_countdown flapTopColor];
  v6 = [(SKUICountdown *)self->_countdown flapBottomColor];
  v7 = [[SKUICountdownFlapView alloc] initWithPosition:a3 flapTopColor:v5 flapBottomColor:v6];
  v8 = [MEMORY[0x277D75348] clearColor];
  [(SKUICountdownFlapView *)v7 setBackgroundColor:v8];

  v9 = [(SKUICountdown *)self->_countdown fontColor];
...
{
  v3 = objc_alloc_init(MEMORY[0x277D756B8]);
  v4 = [(SKUICountdown *)self->_countdown flapTopColor];
  if (v4)
  {
    [v3 setTextColor:v4];
  }
...
- (void)_reload
{
  if ([(SKUICountdown *)self->_countdown isLoaded])
  {
    v3 = [(SKUICountdown *)self->_countdown type];
    countdown = self->_countdown;
    if (v3)
    {
      if ([(SKUICountdown *)countdown type]== 1)
...
- (void)_reloadNumber
{
  if (!self->_numberLabel)
  {
    ...
    v6 = [(SKUICountdown *)self->_countdown fontColor];
    if (v6)
    {
    ...
    if (v10)
    {
      ...
      do
      {
        for (i = 0; i != v11; ++i)
        {
          ...
          v14 = *(*(&v51 + 1) + 8 * i);
          v15 = [(SKUICountdownView *)self _newNumberSeparatorLabel];
          [v15 setText:v14];
          [v15 sizeToFit];
...
- (void)_reloadDateDescriptions:(BOOL)a3
{
  ...
  if (v6)
  {
    if (!dateDescriptionLabelDay)
    {
      v7 = [(SKUICountdownView *)self _newDateDescriptionLabel];
...
LABEL_13:
  ...
  if (v37 || v36 || !v3)
  {
    ...
    {
      v15 = [(SKUICountdownView *)self _newDateDescriptionLabel];
...
LABEL_24:
  ...
  if (v37 || v36 || v35 || !v3)
  {
    if (!dateDescriptionLabelMinute)
    {
      v22 = [(SKUICountdownView *)self _newDateDescriptionLabel];
...
LABEL_36:
  ...
  if (v37 || v36 || v35 || v34 || !v3)
  {
    ...
    v29 = [(SKUICountdownView *)self _newDateDescriptionLabel];
...
- (void)_reloadTime
{
  ...
  if (*(&v29 + 1))
  {
    if (!dateLabelDay)
    {
      v5 = [(SKUICountdownView *)self _newDateLabel];
  ...
  else
  {
    if (!dateLabelHour)
    {
      v11 = [(SKUICountdownView *)self _newDateLabel];
  ...
  if (v29 != 0 || v28)
  {
    if (!dateLabelMinute)
    {
      v18 = [(SKUICountdownView *)self _newDateLabel];
  ...
  if (v29 != 0 || v28 || v27)
  {
    if (!dateLabelSecond)
    {
      v24 = [(SKUICountdownView *)self _newDateLabel];
...
- (int64_t)_currentValue
{
  v3 = [(SKUICountdown *)self->_countdown initialValue];
  v4 = [(SKUICountdown *)self->_countdown startDate];
  [v4 timeIntervalSinceNow];
  v6 = v5;
  v7 = [(SKUICountdown *)self->_countdown rate];
  v8 = [(SKUICountdown *)self->_countdown initialValue];
  v9 = [(SKUICountdown *)self->_countdown finalValue];
  v10 = -1.0;
  if (v8 < v9)
  {
    v10 = 1.0;
...
- (void)_currentRemainingDays:(int64_t *)a3 hours:(int64_t *)a4 minutes:(int64_t *)a5 seconds:(int64_t *)a6
{
  v10 = [(SKUICountdown *)self->_countdown endDate];
