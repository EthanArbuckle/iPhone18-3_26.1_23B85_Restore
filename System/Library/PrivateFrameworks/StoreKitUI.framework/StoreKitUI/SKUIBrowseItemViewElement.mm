...
- (NSArray)metadata;
- (SKUIBrowseItemViewElement)initWithDOMElement:(id)element parent:(id)parent elementFactory:(id)factory;
...
- (SKUIBrowseItemViewElement)initWithDOMElement:(id)element parent:(id)parent elementFactory:(id)factory
{
  ...
  v11 = [(SKUIItemViewElement *)&v14 initWithDOMElement:elementCopy parent:parentCopy elementFactory:factoryCopy];
  if (v11)
  {
    v12 = [elementCopy getAttribute:@"expands"];
...
- (id)applyUpdatesWithElement:(id)element
{
  ...
  v5 = [(SKUIItemViewElement *)&v8 applyUpdatesWithElement:elementCopy];
  v6 = v5;
  if (elementCopy != self || [v5 updateType])
  {
    *(&self->super._selected + 1) = [(SKUIBrowseItemViewElement *)elementCopy expands];
  }
