...
- (SKUIRedeemITunesPassLockup)initWithITunesPassConfiguration:(id)configuration clientContext:(id)context;
...
- (SKUIRedeemITunesPassLockup)initWithITunesPassConfiguration:(id)configuration clientContext:(id)context
{
  ...
  if (v9)
  {
    ...
    _attributedDescriptionString = [(SKUIRedeemITunesPassLockup *)v10 _attributedDescriptionString];
...
- (void)setHighlighted:(BOOL)highlighted
{
  ...
  [(SKUIRedeemITunesPassLockup *)&v6 setHighlighted:highlighted];
  descriptionLabel = self->_descriptionLabel;
  _attributedDescriptionString = [(SKUIRedeemITunesPassLockup *)self _attributedDescriptionString];
...
- (id)_attributedDescriptionString
{
  lockupDescription = [(SKUIITunesPassConfiguration *)self->_configuration lockupDescription];
  lockupLearnMoreLinkTitle = [(SKUIITunesPassConfiguration *)self->_configuration lockupLearnMoreLinkTitle];
  ...
  tintColor = [(SKUIRedeemITunesPassLockup *)self tintColor];
