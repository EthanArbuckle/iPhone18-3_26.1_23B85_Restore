...
- (SKUIStarRatingQueue)initWithReviewConfiguration:(id)configuration
{
  ...
  v9.receiver = self;
  v9.super_class = SKUIStarRatingQueue;
  v6 = [(SKUIStarRatingQueue *)&v9 init];
  v7 = v6;
  if (v6)
  {
...
- (void)initWithReviewConfiguration:.cold.1()
{
  v2 = *MEMORY[0x277D85DE8];
  v0 = 136446210;
  v1 = "[SKUIStarRatingQueue initWithReviewConfiguration:]";
}
