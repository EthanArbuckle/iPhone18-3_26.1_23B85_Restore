...
- (void)setPlaceholderView:(id)view
{
  ...
  if (placeholderView != viewCopy)
  {
    ...
    {
      [(SKUIProductPagePlaceholderScrollView *)self addSubview:?];
    }

    placeholderView = [(SKUIProductPagePlaceholderScrollView *)self setNeedsLayout];
    viewCopy = v7;
  }
...
- (void)layoutSubviews
{
  ...
  v16.receiver = self;
  v16.super_class = SKUIProductPagePlaceholderScrollView;
