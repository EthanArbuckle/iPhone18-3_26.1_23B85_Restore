...
- (void)dealloc
{
  ...
  [v3 removeObserver:self name:0x2828123E8 object:0];
...
- (void)loadView
{
  ...
  v4 = [(SKUIRedeemInputViewController *)self view];
  ...
  if (!imageView)
  {
    ...
    [v101 addObserver:self selector:sel__redeemConfigurationImagesDidLoad_ name:0x2828123E8 object:v21];
  ...
  v24 = dbl_215F3F1A0[(v23 & 0xFFFFFFFFFFFFFFFBLL) == 1];
  v25 = dbl_215F3F1B0[(v23 & 0xFFFFFFFFFFFFFFFBLL) == 1];
  [v4 frame];
  v27 = (v26 - v24) * 0.5;
  v28 = floorf(v27);
...
{
  redeemButton = self->_redeemButton;
  v4 = [(SKUIRedeemTextField *)self->_field text];
  -[UIBarButtonItem setEnabled:](redeemButton, "setEnabled:", [v4 length] != 0);
}

- (void)_cancelAction:(id)a3
{
  v4 = [(SKUIRedeemInputViewController *)self parentViewController];
  v5 = v4;
  if (!v4)
  {
    v4 = self;
...
- (void)_redeemAction:(id)a3
{
  ...
  v5 = [(SKUIRedeemTextField *)self->_field text];
...
- (id)_newTextFieldWithClientContext:(id)a3
{
  ...
  v9 = [(SKUIRedeemInputViewController *)self view];
  v10 = [v9 tintColor];
  v11 = v10;
  if (v10)
  {
...
- (void)_toggleActivityIndicatorBarButtonItem:(BOOL)a3
{
  ...
  if (a3)
  {
    ...
    v6 = [(SKUIRedeemInputViewController *)self navigationItem];
  ...
  {
    v4 = [(SKUIRedeemInputViewController *)self navigationItem];
    redeemButton = self->_redeemButton;
