...
- (SKUIArtworkList)initWithArtworkListArray:(id)a3
{
  ...
  v23.receiver = self;
  v23.super_class = SKUIArtworkList;
      ...
      do
      {
        ...
        do
        {
          ...
          if (objc_opt_isKindOfClass())
          {
            ...
            v17 = [(SKUIArtwork *)v16 initWithArtworkDictionary:v15, v19];
            if (v17)
            {
...
- (SKUIArtworkList)initWithLookupArray:(id)a3
{
  ...
  v21.receiver = self;
  v21.super_class = SKUIArtworkList;
  v5 = [(SKUIArtworkList *)&v21 init];
  if (v5)
  {
    v6 = objc_alloc_init(MEMORY[0x277CBEB18]);
    artworks = v5->_artworks;
      ...
      do
      {
        ...
        do
        {
          ...
          if (objc_opt_isKindOfClass())
          {
            ...
            v15 = [(SKUIArtwork *)v14 initWithArtworkDictionary:v13, v17];
            if (v15)
            {
...
- (NSString)description
{
  ...
  v7.receiver = self;
  v7.super_class = SKUIArtworkList;
  v4 = [(SKUIArtworkList *)&v7 description];
...
- (SKUIArtworkList)initWithCacheRepresentation:(id)a3
{
  ...
  {
    v11.receiver = self;
    v11.super_class = SKUIArtworkList;
    ...
    if (v5)
    {
      ...
      {
        v7 = objc_opt_class();
        v8 = SKUICacheCodingDecodeArray(v6, v7);
        artworks = v5->_artworks;
        v5->_artworks = v8;
      }
    }
...
- (NSMutableDictionary)cacheRepresentation
{
  ...
  v4 = SKUICacheCodingEncodeArray(self->_artworks);
