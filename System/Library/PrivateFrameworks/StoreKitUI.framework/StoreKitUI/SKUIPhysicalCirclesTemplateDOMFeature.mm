...
- (SKUIPhysicalCirclesTemplateDOMFeature)initWithDOMNode:(id)node featureName:(id)name;
...
+ (id)makeFeatureJSObjectForFeature:(id)feature
{
  ...
  v6 = [(SKUIJSPhysicalCirclesTemplate *)v4 initWithAppContext:appContext DOMFeature:featureCopy];
...
- (void)_requestAnimation:(id)animation
{
  ...
  delegate = [(SKUIPhysicalCirclesTemplateDOMFeature *)self delegate];
