...
- (SKUIGiftConfirmView)initWithGift:(id)gift configuration:(id)configuration;
...
- (SKUIGiftConfirmView)initWithGift:(id)gift configuration:(id)configuration
{
  ...
  v136.receiver = self;
  v136.super_class = SKUIGiftConfirmView;
  v8 = [(SKUIGiftConfirmView *)&v136 init];
  if (v8)
  {
    ...
    v12 = [(SKUIGiftConfirmView *)v8 _newLightLabelWithSize:23.0 alpha:1.0];
    ...
    {
      [SKUIClientContext localizedStringForKey:@"GIFTING_CONFIRM_CONFIRM_YOUR_ORDER" inBundles:0 inTable:@"Gifting"];
    }
    v15 = ;
    ...
    v16 = [(SKUIGiftConfirmView *)v8 _newLightLabelWithSize:11.0 alpha:0.5];
    ...
    {
      [SKUIClientContext localizedStringForKey:@"GIFTING_CONFIRM_CHARGE_WARNING" inBundles:0 inTable:@"Gifting"];
    }
    v19 = ;
    ...
    [(UIView *)v22 setBackgroundColor:_tertiaryLabelColor];

    [(SKUIGiftConfirmView *)v8 addSubview:v8->_rule1];
    v24 = [[SKUIGiftConfirmLabeledValue alloc] initWithGiftConfirmLabelStyle:0];
    ...
    {
      [SKUIClientContext localizedStringForKey:@"GIFTING_CONFIRM_RECIPIENTS_LABEL" inBundles:0 inTable:@"Gifting"];
    }
    v27 = ;
    [(SKUIGiftConfirmLabeledValue *)v26 setLabel:v27];

    v28 = v8->_recipientsView;
    recipientAddresses = [giftCopy recipientAddresses];
    v30 = [recipientAddresses componentsJoinedByString:{@", "}];
    [(SKUIGiftConfirmLabeledValue *)v28 setValue:v30];

    [(SKUIGiftConfirmView *)v8 addSubview:v8->_recipientsView];
    v31 = [[SKUIGiftConfirmLabeledValue alloc] initWithGiftConfirmLabelStyle:0];
    ...
    {
      [SKUIClientContext localizedStringForKey:@"GIFTING_CONFIRM_SENDER_LABEL" inBundles:0 inTable:@"Gifting"];
    }
    v34 = ;
    [(SKUIGiftConfirmLabeledValue *)v33 setLabel:v34];

    v35 = v8->_senderView;
    senderName = [giftCopy senderName];
    [(SKUIGiftConfirmLabeledValue *)v35 setValue:senderName];

    [(SKUIGiftConfirmView *)v8 addSubview:v8->_senderView];
    v37 = [[SKUIGiftConfirmLabeledValue alloc] initWithGiftConfirmLabelStyle:0];
    ...
    {
      [SKUIClientContext localizedStringForKey:@"GIFTING_CONFIRM_FROM_LABEL" inBundles:0 inTable:@"Gifting"];
    }
    v40 = ;
    [(SKUIGiftConfirmLabeledValue *)v39 setLabel:v40];

    v41 = v8->_fromView;
    senderEmailAddress = [giftCopy senderEmailAddress];
    [(SKUIGiftConfirmLabeledValue *)v41 setValue:senderEmailAddress];
    ...
    v45 = v8->_rule2;
    _tertiaryLabelColor2 = [MEMORY[0x277D75348] _tertiaryLabelColor];
    [(UIView *)v45 setBackgroundColor:_tertiaryLabelColor2];
    ...
    if (v47)
    {
      v49 = [(SKUIGiftConfirmLabeledValue *)v48 initWithGiftConfirmLabelStyle:1];
    ...
    {
      v53 = [(SKUIGiftConfirmLabeledValue *)v48 initWithGiftConfirmLabelStyle:0];
      v54 = v8->_messageView;
      v8->_messageView = v53;
      ...
      {
        [SKUIClientContext localizedStringForKey:@"GIFTING_NO_MESSAGE_PLACEHOLDER" inBundles:0 inTable:@"Gifting"];
      }
      message2 = ;
    }

    v55 = message2;
    [(SKUIGiftConfirmLabeledValue *)v51 setValue:message2];
    ...
    v60 = v8->_rule3;
    _tertiaryLabelColor3 = [MEMORY[0x277D75348] _tertiaryLabelColor];
    [(UIView *)v60 setBackgroundColor:_tertiaryLabelColor3];
    ...
    if (item)
    {
      ...
      {
        [SKUIClientContext localizedStringForKey:@"GIFTING_CONFIRM_ITEM_LABEL" inBundles:0 inTable:@"Gifting"];
      }
      v68 = ;
      ...
      v69 = v8->_itemView;
      title = [item title];
      [(SKUIGiftConfirmLabeledValue *)v69 setValue:title];
      ...
      {
        [SKUIClientContext localizedStringForKey:@"GIFTING_CONFIRM_PRICE_LABEL" inBundles:0 inTable:@"Gifting"];
      }
      v74 = ;
      ...
      {
        [SKUIClientContext localizedStringForKey:@"GIFTING_MULTIPLE_RECPIENT_PRICE_FORMAT" inBundles:0 inTable:@"Gifting"];
      }
      v78 = ;
      ...
      [(SKUIGiftConfirmLabeledValue *)v85 setValue:buttonText2];
    ...
    else
    {
      ...
      {
        [SKUIClientContext localizedStringForKey:@"GIFTING_CONFIRM_AMOUNT_LABEL" inBundles:0 inTable:@"Gifting"];
      }
      v88 = ;
      ...
      [(SKUIGiftConfirmLabeledValue *)v89 setValue:giftAmountString];

      [(SKUIGiftConfirmView *)v8 addSubview:v8->_amountView];
    }

    deliveryDate = [giftCopy deliveryDate];
    v92 = [[SKUIGiftConfirmLabeledValue alloc] initWithGiftConfirmLabelStyle:2];
    ...
    {
      [SKUIClientContext localizedStringForKey:@"GIFTING_CONFIRM_SEND_DATE_LABEL" inBundles:0 inTable:@"Gifting"];
    }
    v95 = ;
    [(SKUIGiftConfirmLabeledValue *)v94 setLabel:v95];
    ...
    if (deliveryDate)
    {
      ...
      [(SKUIGiftConfirmLabeledValue *)v97 setValue:v98];
    }
    ...
    else
    {
      ...
      {
        [SKUIClientContext localizedStringForKey:@"GIFTING_DATE_TODAY" inBundles:0 inTable:@"Gifting"];
      }
      v96 = ;
      [(SKUIGiftConfirmLabeledValue *)v99 setValue:v96];
    }
    ...
    v102 = v8->_rule4;
    _tertiaryLabelColor4 = [MEMORY[0x277D75348] _tertiaryLabelColor];
    [(UIView *)v102 setBackgroundColor:_tertiaryLabelColor4];

    [(SKUIGiftConfirmView *)v8 addSubview:v8->_rule4];
    v104 = [[SKUIGiftConfirmLabeledValue alloc] initWithGiftConfirmLabelStyle:2];
    ...
    {
      [SKUIClientContext localizedStringForKey:@"GIFTING_CONFIRM_THEME_LABEL" inBundles:0 inTable:@"Gifting"];
    }
    v107 = ;
    v108 = v11;
    [(SKUIGiftConfirmLabeledValue *)v106 setLabel:v107];

    v109 = v8->_themeNameView;
    giftCopy = v134;
    theme = [v134 theme];
    themeName = [theme themeName];
    [(SKUIGiftConfirmLabeledValue *)v109 setValue:themeName];
    ...
    v114 = v8->_rule5;
    _tertiaryLabelColor5 = [MEMORY[0x277D75348] _tertiaryLabelColor];
    [(UIView *)v114 setBackgroundColor:_tertiaryLabelColor5];

    [(SKUIGiftConfirmView *)v8 addSubview:v8->_rule5];
    v116 = [(SKUIGiftConfirmView *)v8 _newLightLabelWithSize:20.0 alpha:1.0];
    ...
    {
      [SKUIClientContext localizedStringForKey:@"GIFTING_CONFIRM_TOTAL_LABEL" inBundles:0 inTable:@"Gifting"];
    }
    ...
    v126 = v8->_rule6;
    _tertiaryLabelColor6 = [MEMORY[0x277D75348] _tertiaryLabelColor];
    [(UIView *)v126 setBackgroundColor:_tertiaryLabelColor6];

    [(SKUIGiftConfirmView *)v8 addSubview:v8->_rule6];
    _termsButton = [(SKUIGiftConfirmView *)v8 _termsButton];
    [(SKUIGiftConfirmView *)v8 addSubview:_termsButton];
...
- (void)layoutSubviews
{
  ...
  if (userInterfaceLayoutDirection)
  {
    v25 = v14 - v22;
    v26 = v200;
    [SKUICGRectHelpers rect:v22 withFlippedOriginXRelativeTo:v17, v25, v19, v201, v6, v8, v200];
  }
  ...
  if (userInterfaceLayoutDirection)
  {
    [SKUICGRectHelpers rect:v35 withFlippedOriginXRelativeTo:v32, v36, v37, v201, v199, v31, v26];
  }
  ...
  [(SKUIGiftConfirmLabeledValue *)self->_recipientsView sizeThatFits:v203 - v64, 1.79769313e308];
  v66 = v65;
  v68 = v67;
  [(SKUIGiftConfirmLabeledValue *)self->_recipientsView setFrame:v64, v61, v65, v67];
  v209.origin.x = v64;
  v209.origin.y = v61;
  v209.size.width = v66;
  ...
  [(SKUIGiftConfirmLabeledValue *)self->_senderView sizeThatFits:v203 - v72, 1.79769313e308];
  v74 = v73;
  v76 = v75;
  [(SKUIGiftConfirmLabeledValue *)self->_senderView setFrame:v72, v69, v73, v75];
  v210.origin.x = v72;
  v210.origin.y = v69;
  v210.size.width = v74;
  ...
  [(SKUIGiftConfirmLabeledValue *)self->_fromView sizeThatFits:v203 - v80, 1.79769313e308];
  v82 = v81;
  v84 = v83;
  [(SKUIGiftConfirmLabeledValue *)self->_fromView setFrame:v80, v77, v81, v83];
  v211.origin.x = v80;
  v211.origin.y = v77;
  v211.size.width = v82;
  ...
  [(SKUIGiftConfirmLabeledValue *)self->_messageView sizeThatFits:v203 - v97, 1.79769313e308];
  v99 = v98;
  v101 = v100;
  [(SKUIGiftConfirmLabeledValue *)self->_messageView setFrame:v97, v94, v98, v100];
  v213.origin.x = v97;
  v213.origin.y = v94;
  v213.size.width = v99;
  ...
  if (itemView)
  {
    ...
    [(SKUIGiftConfirmLabeledValue *)self->_itemView sizeThatFits:v203 - v115, 1.79769313e308];
    v117 = v116;
    v119 = v118;
    [(SKUIGiftConfirmLabeledValue *)self->_itemView setFrame:v115, v111, v116, v118];
    v215.origin.x = v115;
    v215.origin.y = v111;
  ...
  [(SKUIGiftConfirmLabeledValue *)self->_amountView sizeThatFits:v203 - v122, 1.79769313e308];
  v124 = v123;
  v126 = v125;
  [(SKUIGiftConfirmLabeledValue *)self->_amountView setFrame:v122, v111, v123, v125];
  v216.origin.x = v122;
  v216.origin.y = v111;
  ...
  [(SKUIGiftConfirmLabeledValue *)self->_sendOnView sizeThatFits:v203 - v130, 1.79769313e308];
  v132 = v131;
  v134 = v133;
  [(SKUIGiftConfirmLabeledValue *)self->_sendOnView setFrame:v130, v127, v131, v133];
  v217.origin.x = v130;
  v217.origin.y = v127;
  ...
  [(SKUIGiftConfirmLabeledValue *)self->_themeNameView sizeThatFits:v203 - v147, 1.79769313e308];
  v149 = v148;
  v151 = v150;
  [(SKUIGiftConfirmLabeledValue *)self->_themeNameView setFrame:v147, v144, v148, v150];
  v219.origin.x = v147;
  v219.origin.y = v144;
  ...
  if (userInterfaceLayoutDirection)
  {
    [SKUICGRectHelpers rect:v170 withFlippedOriginXRelativeTo:v165, v167, v169, v201, v199, v198, v200];
  }
  ...
  v189 = ceilf(v188);
  _termsButton = [(SKUIGiftConfirmView *)self _termsButton];
  [_termsButton frame];
  v191 = v190;
...
- (id)_newLightLabelWithSize:(double)size alpha:(double)alpha
{
  ...
  _labelColor = [MEMORY[0x277D75348] _labelColor];
  v10 = [_labelColor colorWithAlphaComponent:alpha];
  [v6 setTextColor:v10];
...
LABEL_11:
        ...
        [(UIButton *)v13 setTitleColor:_secondaryLabelColor forState:0];

        v15 = self->_termsButton;
        _labelColor = [MEMORY[0x277D75348] _labelColor];
        [(UIButton *)v15 setTitleColor:_labelColor forState:1];
    ...
    v8 = [SKUIClientContext localizedStringForKey:v9 inBundles:0 inTable:@"Gifting"];
    goto LABEL_11;
  }
