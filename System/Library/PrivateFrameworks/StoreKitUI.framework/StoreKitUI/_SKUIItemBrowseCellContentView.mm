...
- (_SKUIItemBrowseCellContentView)initWithFrame:(CGRect)frame;
...
- (_SKUIItemBrowseCellContentView)initWithFrame:(CGRect)frame
{
  ...
  v3 = [(_SKUIItemBrowseCellContentView *)&v6 initWithFrame:frame.origin.x, frame.origin.y, frame.size.width, frame.size.height];
  if (v3)
  {
    clearColor = [MEMORY[0x277D75348] clearColor];
    [(_SKUIItemBrowseCellContentView *)v3 setBackgroundColor:clearColor];
...
- (void)drawRect:(CGRect)rect
{
  ...
  {
    image = [(SKUICellImageView *)self->_userRatingImageView image];
...
- (void)setBackgroundColor:(id)color
{
  ...
  [(SKUICellImageView *)self->_userRatingImageView setBackgroundColor:colorCopy];
  [(UILabel *)self->_userRatingLabel setBackgroundColor:colorCopy];
  v6.receiver = self;
  v6.super_class = _SKUIItemBrowseCellContentView;
  [(_SKUIItemBrowseCellContentView *)&v6 setBackgroundColor:colorCopy];
}
