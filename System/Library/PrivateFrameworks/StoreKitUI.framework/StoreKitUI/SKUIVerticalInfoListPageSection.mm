...
- (SKUIVerticalInfoListPageSection)initWithPageComponent:(id)component;
...
{
  pathCopy = path;
  style = [(SKUIInfoListViewElement *)self->_infoList style];
  ...
  else
  {
    v11.receiver = self;
    v11.super_class = SKUIVerticalInfoListPageSection;
    v8 = [(SKUIStorePageSection *)&v11 backgroundColorForIndexPath:pathCopy];
  }
...
- (id)cellForIndexPath:(id)path
{
  ...
  v7 = [collectionView dequeueReusableCellWithReuseIdentifier:0x282814AA8 forIndexPath:pathCopy];
  [(SKUIVerticalInfoListPageSection *)self _contentInsetForIndexPath:pathCopy];
  [v7 setContentInset:?];
  _reloadColumnDataIfNecessary = [(SKUIVerticalInfoListPageSection *)self _reloadColumnDataIfNecessary];
  item = [pathCopy item];
...
- (void)willAppearInContext:(id)context
{
  ...
  [collectionView registerClass:objc_opt_class() forCellWithReuseIdentifier:0x282814AA8];
