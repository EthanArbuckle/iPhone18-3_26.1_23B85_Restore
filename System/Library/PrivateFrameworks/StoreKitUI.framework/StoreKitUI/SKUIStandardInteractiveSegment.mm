...
- (SKUIStandardInteractiveSegment)initWithFrame:(CGRect)a3
{
  ...
  if (v8)
  {
    ...
    *&v8->_contentEdgeInsets.bottom = xmmword_215F3F6E0;
    ...
    v9->_borderAndBackgroundContainerView = v15;
    ...
    v17 = [objc_alloc(MEMORY[0x277D755E8]) initWithFrame:{v11, v12, v13, v14}];
    borderImageView = v9->_borderImageView;
    v9->_borderImageView = v17;
...
- (void)layoutSubviews
{
  ...
  if (v5 > 0.00000011920929)
  {
    ...
    v22 = [(SKUIStandardInteractiveSegment *)self _cornersForSegmentPosition:self->_segmentPosition];
    v48.origin.x = v15;
    v48.origin.y = v17;
    v48.size.width = v19;
    v48.size.height = v21;
...
- (CGSize)sizeThatFits:(CGSize)a3
{
  ...
  v12 = ~[(SKUIStandardInteractiveSegment *)self _cornersForSegmentPosition:self->_segmentPosition];
  v13 = v11 + 1.0;
  if ((v12 & 5) != 0)
  {
    v13 = v11;
...
{
  v3.receiver = self;
  v3.super_class = SKUIStandardInteractiveSegment;
...
- (id)_backgroundImage
{
  if (!self->_backgroundImage)
  {
    ...
    if (v5 > 0.00000011920929)
    {
      v6 = [(SKUIStandardInteractiveSegment *)self _createCorneredImageWithScale:0 forBorder:v5];
...
- (id)_borderImage
{
  if (!self->_borderImage)
  {
    ...
    if (v5 > 0.00000011920929)
    {
      v6 = [(SKUIStandardInteractiveSegment *)self _createCorneredImageWithScale:1 forBorder:v5];
