...
- (double)heightForCellInTableView:(id)a3 indexPath:(id)a4
{
  v4 = [(SKUIProductPageTableSection *)self clientContext:a3];
...
- (id)tableViewCellForTableView:(id)a3 indexPath:(id)a4
{
  ...
  v8 = [(SKUIProductPageTableSection *)self clientContext];
  if (!v7)
  {
    v7 = [[SKUILockupItemTableViewCell alloc] initWithStyle:0 reuseIdentifier:@"LOCKUP"];
    v9 = [(SKUILockupItemTableViewCell *)v7 layout];
...
- (void)artworkRequest:(id)a3 didLoadImage:(id)a4
{
  ...
  v6 = a3;
  v7 = a4;
  v8 = [(SKUITableViewSection *)self delegate];
  if (objc_opt_respondsToSelector())
  {
    v24 = v7;
    v22 = v6;
    v25 = [v6 requestIdentifier];
    v9 = [(SKUITableViewSection *)self sectionIndex];
    v21 = v8;
...
- (void)missingItemLoader:(id)a3 didLoadItems:(id)a4 invalidItemIdentifiers:(id)a5
{
  ...
  if ([v6 count])
  {
    ...
    v8 = [(SKUITableViewSection *)self sectionIndex];
    lockups = self->_lockups;
    ...
    if ([v10 count])
    {
      v11 = [(SKUITableViewSection *)self delegate];
      if (objc_opt_respondsToSelector())
      {
...
- (id)_missingItemLoader
{
  ...
  if (!missingItemLoader)
  {
    ...
    v5 = [(SKUIProductPageTableLockupsSection *)self resourceLoader];
...
- (id)_productImageForItem:(id)a3
{
  ...
  v7 = [(SKUIProductPageTableLockupsSection *)self resourceLoader];
