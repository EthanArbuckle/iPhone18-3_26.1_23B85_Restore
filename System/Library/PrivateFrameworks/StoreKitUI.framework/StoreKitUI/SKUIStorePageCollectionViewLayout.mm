...
- (id)initialLayoutAttributesForAppearingItemAtIndexPath:(id)a3
{
  ...
  v5 = [(SKUIStorePageCollectionViewLayout *)&v29 initialLayoutAttributesForAppearingItemAtIndexPath:v4];
  expandChildPageSectionsIndexSet = self->_expandChildPageSectionsIndexSet;
...
- (id)finalLayoutAttributesForDisappearingItemAtIndexPath:(id)a3
{
  ...
  v5 = [(SKUIStorePageCollectionViewLayout *)&v28 finalLayoutAttributesForDisappearingItemAtIndexPath:v4];
  expandChildPageSectionsIndexSet = self->_expandChildPageSectionsIndexSet;
  if (expandChildPageSectionsIndexSet && -[NSIndexSet containsIndex:](expandChildPageSectionsIndexSet, "containsIndex:", [v4 section]) && self->_updateItems)
  {
...
- (id)invalidationContextForBoundsChange:(CGRect)a3
{
  ...
  {
    v25 = [(SKUIStorePageCollectionViewLayout *)self _indexPathsForPinningItems];
    if ([v25 count])
    {
      [v8 invalidateItemsAtIndexPaths:v25];
      [v8 invalidateDecorationElementsOfKind:0x28280D8E8 atIndexPaths:v25];
    }
  }
...
- (id)layoutAttributesForDecorationViewOfKind:(id)a3 atIndexPath:(id)a4
{
  v6 = a3;
  v7 = a4;
  if ([v6 isEqualToString:0x28280D8E8])
  {
    v8 = [(SKUIStorePageCollectionViewLayout *)self _itemPinningConfigurationForItemAtIndexPath:v7];
    v9 = [(SKUIStorePageCollectionViewLayout *)self _itemPinningLayoutInformationForItemAtIndexPath:v7];
    v10 = [(SKUIStorePageCollectionViewLayout *)self _layoutAttributesForPinnedBackdropDecorationViewAtIndexPath:v7 pinningConfiguration:v8 layoutInformation:v9];
  ...
  if (![v6 isEqualToString:0x282808328] || (+[UICollectionViewLayoutAttributes layoutAttributesForDecorationViewOfKind:withIndexPath:](SKUIGridViewGradientLayoutAttributes, "layoutAttributesForDecorationViewOfKind:withIndexPath:", 0x282808328, v7), (v10 = objc_claimAutoreleasedReturnValue()) == 0))
  {
LABEL_6:
    v12.receiver = self;
    v12.super_class = SKUIStorePageCollectionViewLayout;
    v10 = [(SKUIStorePageCollectionViewLayout *)&v12 layoutAttributesForDecorationViewOfKind:v6 atIndexPath:v7];
  }
  ...
  if (v11)
  {
    ...
    do
    {
      for (i = 0; i != v12; ++i)
      {
        ...
        {
          v17 = [(SKUIStorePageCollectionViewLayout *)self _indexPathsForPinningItems];
          v18 = [v17 containsObject:v16];

          if (v18)
          {
            v19 = [(SKUIStorePageCollectionViewLayout *)self _itemPinningLayoutInformationForItemAtIndexPath:v16];
            v20 = [(SKUIStorePageCollectionViewLayout *)self _itemPinningConfigurationForItemAtIndexPath:v16];
          }
          ...
          if (v30 == 1 && [(SKUIStorePageCollectionViewLayout *)self _allowsBackdropDecorationForItemPinningConfiguration:v20 atIndexPath:v16])
          {
            v21 = [(SKUIStorePageCollectionViewLayout *)self _layoutAttributesForPinnedBackdropDecorationViewAtIndexPath:v16 pinningConfiguration:v20 layoutInformation:v19];
            if (v21)
            {
              v22 = v29;
              if (!v29)
        ...
        v23 = [(SKUIStorePageCollectionViewLayout *)self _indexPathsForBackgroundGradients];
        v24 = [v23 containsObject:v16];

        if (v24)
        {
          v25 = [(SKUIStorePageCollectionViewLayout *)self _layoutAttributesForGradientDecorationViewAtIndexPath:v16 currentAttributes:v15];
          if (v25)
          {
            v26 = v29;
            if (!v29)
...
- (void)_alginCellsToTop:(id)a3
{
  ...
  v7 = [(SKUIStorePageCollectionViewLayout *)self _indexPathsForPinningItems];
  v53 = 0u;
  v54 = 0u;
  v55 = 0u;
  v56 = 0u;
...
- (id)layoutAttributesForItemAtIndexPath:(id)a3
{
  ...
  if (!self->_inLayoutAttributesForElementsCount && ![v5 representedElementCategory])
  {
    ...
    if (v8)
    {
      v9 = [(SKUIStorePageCollectionViewLayout *)self _itemPinningLayoutInformationForItemAtIndexPath:v4];
      v10 = [(SKUIStorePageCollectionViewLayout *)self _itemPinningConfigurationForItemAtIndexPath:v4];
    }
...
- (void)prepareLayout
{
  ...
  *&self->_collectionViewDelegateFlags = *&self->_collectionViewDelegateFlags & 0xDF | v9;
  ...
  v12 = [(SKUIStorePageCollectionViewLayout *)self _indexPathsForPinningItems];
  v13 = [(SKUIStorePageCollectionViewLayout *)self _indexPathsForBackgroundGradients];
}
...
- (BOOL)shouldInvalidateLayoutForBoundsChange:(CGRect)a3
{
  ...
  v6 = [(SKUIStorePageCollectionViewLayout *)self _indexPathsForPinningItems];
  if ([v6 count])
  {
    v7 = [(SKUIStorePageCollectionViewLayout *)self collectionView];
    [v7 bounds];
    v5 = y != v8;
  }
...
- (void)_updateItemsLayoutForRect:(CGRect)a3
{
  ...
  if (self->_overrideContentWidth >= 0.00000011920929)
  {
    v8 = [(SKUIStorePageCollectionViewLayout *)self collectionView];
  ...
  else
  {
    v10.receiver = self;
    v10.super_class = SKUIStorePageCollectionViewLayout;
    [(SKUIStorePageCollectionViewLayout *)&v10 _updateItemsLayoutForRect:a3.origin.x, a3.origin.y, a3.size.width, a3.size.height];
  }
}
    ...
    do
    {
      for (i = 0; i != v12; ++i)
      {
        ...
        if (![v15 representedElementCategory])
        {
          ...
          v24 = 0;
          [(SKUIStorePageCollectionViewLayout *)self _configureCellLayoutAttributes:v15 forItemWithPinningConfiguration:v20 layoutInformation:v19 atIndexPath:v16 allowPinning:v18 returningIsPinning:&v24];
          if (v24 == 1)
          {
            [v15 frame];
            [(SKUIStorePageCollectionViewLayout *)self _pinningFrameForStartingFrame:v20 itemPinningConfiguration:v16 atIndexPath:?];
            [v15 setFrame:?];
            v21 = v23;
            if (!v23)
            {
...
- (void)setBackdropGroupName:(id)a3
{
  ...
  if (backdropGroupName != v4)
  {
    ...
    if ((backdropGroupName & 1) == 0)
    {
      ...
      v8 = [(SKUIStorePageCollectionViewLayout *)self _indexPathsForPinningItems];
      if ([v8 count])
      {
        ...
        [v9 invalidateDecorationElementsOfKind:0x28280D8E8 atIndexPaths:v8];
...
- (BOOL)_allowsBackdropDecorationForItemPinningConfiguration:(id)a3 atIndexPath:(id)a4
{
  v4 = [(SKUIStorePageCollectionViewLayout *)self _pinningStyleForItemPinningConfiguration:a3 atIndexPath:a4];
  if (v4)
  {
    v5 = v4 == 3;
  }
...
- (void)_configureCellLayoutAttributes:(id)a3 forItemWithPinningConfiguration:(id)a4 layoutInformation:(id)a5 atIndexPath:(id)a6 allowPinning:(BOOL)a7 returningIsPinning:(BOOL *)a8
{
  ...
  v16 = a5;
  v17 = a6;
  v18 = [(SKUIStorePageCollectionViewLayout *)self collectionView];
  v19 = v18;
  ...
  if (v9)
  {
    [(SKUIStorePageCollectionViewLayout *)self _targetFrameForStartingFrame:v15 itemPinningConfiguration:v16 layoutInformation:v17 atIndexPath:&v39 returningIsPinning:v26, v27, v28, v29];
    v30 = v34;
    v31 = v35;
    v32 = v36;
    v33 = v37;
...
- (id)_layoutAttributesForPinnedBackdropDecorationViewAtIndexPath:(id)a3 pinningConfiguration:(id)a4 layoutInformation:(id)a5
{
  ...
  v9 = a4;
  v10 = a5;
  v11 = [(SKUIStorePageCollectionViewLayout *)self collectionView];
  v12 = [(UICollectionViewLayoutAttributes *)SKUIStorePagePinnedBackdropLayoutAttributes layoutAttributesForDecorationViewOfKind:0x28280D8E8 withIndexPath:v8];
  ...
  [(SKUIStorePageCollectionViewLayout *)self _targetFrameForStartingFrame:v9 itemPinningConfiguration:v10 layoutInformation:v8 atIndexPath:&v41 returningIsPinning:?];
  v13 = v41;
  v14 = 0.0;
  if (v41 == 1)
  {
    [(SKUIStorePageCollectionViewLayout *)self _pinningFrameForStartingFrame:v9 itemPinningConfiguration:v8 atIndexPath:?];
    [v12 setFrame:?];
    [v12 setZIndex:150];
    v15 = [(SKUIStorePageCollectionViewLayout *)self _pinningTransitionStyleForItemPinningConfiguration:v9 atIndexPath:v8];
    if (v15)
    {
      v16 = v15;
      v17 = [(SKUIStorePageCollectionViewLayout *)self _pinnedBackdropViewStyle];
      v18 = v17;
      if (v17)
      {
        if (v17 == 2)
...
- (id)_layoutAttributesForGradientDecorationViewAtIndexPath:(id)a3 currentAttributes:(id)a4
{
  ...
  v10 = [(SKUIStorePageCollectionViewLayout *)self layoutAttributesForDecorationViewOfKind:0x282808328 atIndexPath:v6];
  [v8 bounds];
  [v7 size];
  v12 = v11;
  [v7 frame];
...
- (UIEdgeInsets)_pinningContentInsetForItemPinningConfiguration:(id)a3 atIndexPath:(id)a4
{
  ...
  if (([v6 hasValidPinningContentInset] & 1) == 0)
  {
    ...
    {
      v12 = [(SKUIStorePageCollectionViewLayout *)self collectionView];
      v13 = [v12 delegate];
...
- (int64_t)_pinningTransitionStyleForItemPinningConfiguration:(id)a3 atIndexPath:(id)a4
{
  ...
  if (self->_allowsPinningTransitions)
  {
    if (([v6 hasValidPinningTransitionStyle] & 1) == 0)
    {
      ...
      {
        v10 = [(SKUIStorePageCollectionViewLayout *)self collectionView];
        v11 = [v10 delegate];
...
- (CGRect)_targetFrameForStartingFrame:(CGRect)a3 itemPinningConfiguration:(id)a4 layoutInformation:(id)a5 atIndexPath:(id)a6 returningIsPinning:(BOOL *)a7
{
  ...
  v16 = a5;
  v17 = a6;
  [(SKUIStorePageCollectionViewLayout *)self _pinningContentInsetForItemPinningConfiguration:v15 atIndexPath:v17];
  v90 = x;
  v91 = width;
  v21 = x - v20;
  v23 = y - v22;
  ...
  v25 = height;
  v26 = height - (-v18 - v22);
  v27 = [(SKUIStorePageCollectionViewLayout *)self collectionView];
  [v27 contentOffset];
  v29 = v28;
  [v27 _effectiveContentInset];
  v31 = v29 + v30;
  v32 = [(SKUIStorePageCollectionViewLayout *)self _pinningStyleForItemPinningConfiguration:v15 atIndexPath:v17];
  v33 = 0;
  if (v32 <= 2)
  {
    if (v32 == 1)
    {
      ...
      {
        v76 = [(SKUIStorePageCollectionViewLayout *)self _indexPathsForPinningItems];
        v77 = v76;
        v35 = v90;
        v34 = v91;
    ...
    v35 = v90;
    v34 = v91;
    [(SKUIStorePageCollectionViewLayout *)self _pinningFrameForStartingFrame:v15 itemPinningConfiguration:v17 atIndexPath:v90, v41, v91, v25];
