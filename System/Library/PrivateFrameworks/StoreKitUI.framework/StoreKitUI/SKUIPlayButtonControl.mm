...
{
  v13.receiver = self;
  v13.super_class = SKUIPlayButtonControl;
...
{
  v3.receiver = self;
  v3.super_class = SKUIPlayButtonControl;
...
LABEL_12:
  ...
  if (v17)
  {
    [(SKUIPlayButtonGradientView *)v17 removeFromSuperview];
...
LABEL_20:
  [(SKUIPlayButtonControl *)self setShowBorder:1, v26, v27, v28, v29];
...
- (id)_borderLayer
{
  ...
  if (!borderLayer)
  {
    ...
    {
      [(SKUIPlayButtonControl *)self insertSubview:v28 belowSubview:?];
    }
...
- (id)_gradientBackgroundView
{
  ...
  if (!gradientBackgroundView)
  {
    ...
    v5 = [(SKUIPlayButtonGradientView *)v4 initWithFrame:*MEMORY[0x277CBF3A0], *(MEMORY[0x277CBF3A0] + 8), *(MEMORY[0x277CBF3A0] + 16), *(MEMORY[0x277CBF3A0] + 24)];
...
- (id)_innerProgressLayer
{
  ...
  {
    [(SKUIPlayButtonControl *)self buttonSize];
    v6 = [(SKUIPlayButtonControl *)self _newShapeViewWithBounds:0.0 lineWidth:0.0, v4, v5, 2.0];
...
- (id)_outerProgressLayer
{
  ...
  {
    [(SKUIPlayButtonControl *)self buttonSize];
    v6 = [(SKUIPlayButtonControl *)self _newShapeViewWithBounds:0.0 lineWidth:0.0, v4, v5, 1.5];
    ...
    if (self->_innerProgressLayer)
    {
      [(SKUIPlayButtonControl *)self insertSubview:v12 belowSubview:?];
    }
...
- (id)_selectedLayer
{
  ...
  {
    [(SKUIPlayButtonControl *)self buttonSize];
    v6 = [[SKUIPlayButtonShapeView alloc] initWithFrame:0.0, 0.0, v4, v5];
...
- (void)_showPlayIndicator:(BOOL)indicator
{
  ...
  {
    [(SKUIPlayButtonControl *)self _cancelImage];
  }
  v6 = ;
...
void __80__SKUIPlayButtonControl__updateBackgroundBlur_withOffsetRight_withOffsetBottom___block_invoke_2(uint64_t a1)
{
  ...
  if (WeakRetained)
  {
    ...
    v5 = [SKUIPlayButtonControl blurColorForImage:"blurColorForImage:forButtonSize:withOffsetRight:withOffsetBottom:" forButtonSize:v4 withOffsetRight:? withOffsetBottom:?];
    block[0] = MEMORY[0x277D85DD0];
    block[1] = 3221225472;
    block[2] = __80__SKUIPlayButtonControl__updateBackgroundBlur_withOffsetRight_withOffsetBottom___block_invoke_3;
    block[3] = &unk_2781FD1C0;
    v12 = *(a1 + 56);
    v8 = *(a1 + 32);
    v9 = v5;
    v10 = *(a1 + 40);
...
{
  v2 = objc_getAssociatedObject(*(a1 + 32), _SKUIPlayButtonControlBackgroundImageAssociatedObjectKeyColorCache);
  v3 = *(*(a1 + 64) + 8);
  v4 = *(v3 + 40);
  *(v3 + 40) = v2;
  ...
  if (!v5)
  {
    ...
    *(v7 + 40) = v6;
    ...
    objc_setAssociatedObject(*(a1 + 32), _SKUIPlayButtonControlBackgroundImageAssociatedObjectKeyColorCache, *(*(*(a1 + 64) + 8) + 40), 1);
    v5 = *(*(*(a1 + 64) + 8) + 40);
  }
...
+ ($8452678F12DBC466148836A9D382CAFC)_calculateStatistics:(SEL)statistics withSize:(CGImage *)size
{
  ...
  *&retstr->var0 = 0u;
  *&retstr->var2 = 0u;
  v12 = malloc_type_malloc(v11 * a5.height, 0x7D1414DDuLL);
