...
- (SKUIReviewMetadata)editedReviewMetadata
{
  v3 = [(SKUIComposeReviewFormViewController *)self->_formViewController editedReviewMetadata];
  v4 = v3;
  if (self->_nickname)
  {
    [v3 setNickname:?];
...
- (void)composeReviewFormDidSubmit:(id)a3
{
  v8 = [(SKUIComposeReviewViewController *)self editedReviewMetadata];
  v4 = [v8 nickname];
...
- (void)_attemptReviewSubmission
{
  v4 = [(SKUIComposeReviewViewController *)self editedReviewMetadata];
  v3 = [(SKUIComposeReviewViewController *)self delegate];
...
- (void)_finishLoadWithOutput:(id)a3 error:(id)a4
{
  ...
  if (v5)
  {
    ...
    v9 = [(SKUIComposeReviewViewController *)self delegate];
...
LABEL_21:
    ...
    else if (!v8)
    {
      ...
      if (v11)
      {
        v14 = [(SKUIReviewMetadata *)v11 title];
        if ([v14 length])
        {
      ...
      v17 = [(SKUIComposeReviewViewController *)self isEdit];
...
- (void)_loadReviewWithURL:(id)a3 completionBlock:(id)a4
{
  ...
  v12 = [MEMORY[0x277D7FD30] provider];
  [v12 setShouldProcessDialogs:0];
  [v8 setDataProvider:v12];
  v13 = [objc_alloc(MEMORY[0x277D69CA0]) initWithURL:v6];
  ...
  v17 = [MEMORY[0x277D7FD20] mainQueue];
...
- (void)_sendDidSubmit
{
  ...
  if (objc_opt_respondsToSelector())
  {
    [v3 composeReviewViewController:self didSubmitWithEdit:{-[SKUIComposeReviewViewController isEdit](self, "isEdit")}];
  }
}
