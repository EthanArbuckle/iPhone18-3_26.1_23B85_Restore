...
- (SKUIGiftTextTableViewCell)initWithStyle:(int64_t)a3 reuseIdentifier:(id)a4
{
  ...
  if (v7)
  {
    ...
    v13 = [MEMORY[0x277D75348] tableSeparatorColor];
...
{
  v15 = a3;
  v4 = [(SKUIGiftTextTableViewCell *)self label];
...
{
  v15 = a3;
  v4 = [(SKUIGiftTextTableViewCell *)self placeholder];
  if (v4 != v15 && ([v15 isEqualToString:v4] & 1) == 0)
  {
...
- (void)setTextView:(id)a3
{
  ...
  if (textView)
  {
    ...
    v8 = [(SKUIGiftTextTableViewCell *)self contentView];
...
- (void)layoutSubviews
{
  ...
  v3 = [(SKUIGiftTextTableViewCell *)self contentView];
  [v3 bounds];
  v5 = v4;
  v7 = v6;
  v9 = v8;
  ...
  v13 = v12;
  v15 = v14;
  v16 = [(SKUIGiftTextTableViewCell *)self leftToRight];
  label = self->_label;
  v55 = v11;
  v52 = v7;
  if (v16)
  ...
  v54 = v9 + -15.0;
  v28 = v9 + -15.0 - v26;
  v29 = [(SKUIGiftTextTableViewCell *)self leftToRight];
  placeholderLabel = self->_placeholderLabel;
  v31 = 12.0;
  if (!v29)
  {
