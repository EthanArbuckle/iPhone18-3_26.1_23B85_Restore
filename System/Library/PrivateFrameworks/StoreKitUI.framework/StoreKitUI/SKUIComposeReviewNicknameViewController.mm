...
- (void)viewDidAppear:(BOOL)a3
{
  v4 = [(SKUIComposeReviewNicknameViewController *)self nicknameView];
...
{
  v4 = a3;
  v5 = [(SKUIComposeReviewNicknameViewController *)self submitButton];
...
- (void)_setupScrollView
{
  ...
  v4 = [(SKUIComposeReviewNicknameViewController *)self scrollView];
  [v4 setTranslatesAutoresizingMaskIntoConstraints:0];

  v5 = [(SKUIComposeReviewNicknameViewController *)self scrollView];
  ...
  v8 = [(SKUIComposeReviewNicknameViewController *)self scrollView];
  ...
  v36 = [(SKUIComposeReviewNicknameViewController *)self view];
...
- (void)_setupNicknameView
{
  ...
  v5 = [(SKUIComposeReviewNicknameViewController *)self nicknameView];
  ...
  v38 = [(SKUIComposeReviewNicknameViewController *)self scrollView];
...
- (void)_updateConfirmState
{
  v3 = [(SKUIComposeReviewNicknameViewController *)self nicknameView];
