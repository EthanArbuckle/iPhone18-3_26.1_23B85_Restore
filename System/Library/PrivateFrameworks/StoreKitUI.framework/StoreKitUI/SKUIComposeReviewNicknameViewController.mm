...
- (void)showSendAnimationInNavigationBarWithCompletion:(id)completion;
...
- (void)viewDidLoad
{
  view = [(SKUIComposeReviewNicknameViewController *)self view];
  ...
  nicknameView = [(SKUIComposeReviewNicknameViewController *)self nicknameView];
...
- (void)showSendAnimationInNavigationBarWithCompletion:(id)completion
{
  ...
  submitButton = [(SKUIComposeReviewNicknameViewController *)self submitButton];
  [submitButton animateWithCompletion:completionCopy];
}
...
- (void)_setupScrollView
{
  ...
  scrollView = [(SKUIComposeReviewNicknameViewController *)self scrollView];
  [scrollView setTranslatesAutoresizingMaskIntoConstraints:0];

  scrollView2 = [(SKUIComposeReviewNicknameViewController *)self scrollView];
  [scrollView2 setShowsVerticalScrollIndicator:0];

  view = [(SKUIComposeReviewNicknameViewController *)self view];
  scrollView3 = [(SKUIComposeReviewNicknameViewController *)self scrollView];
  [view addSubview:scrollView3];

  scrollView4 = [(SKUIComposeReviewNicknameViewController *)self scrollView];
  frameLayoutGuide = [scrollView4 frameLayoutGuide];
  topAnchor = [frameLayoutGuide topAnchor];
  view2 = [(SKUIComposeReviewNicknameViewController *)self view];
  safeAreaLayoutGuide = [view2 safeAreaLayoutGuide];
  topAnchor2 = [safeAreaLayoutGuide topAnchor];
  v14 = [topAnchor constraintEqualToAnchor:topAnchor2];
  [v14 setActive:1];

  scrollView5 = [(SKUIComposeReviewNicknameViewController *)self scrollView];
  frameLayoutGuide2 = [scrollView5 frameLayoutGuide];
  centerXAnchor = [frameLayoutGuide2 centerXAnchor];
  view3 = [(SKUIComposeReviewNicknameViewController *)self view];
  ...
  scrollView6 = [(SKUIComposeReviewNicknameViewController *)self scrollView];
  ...
  {
    view4 = [(SKUIComposeReviewNicknameViewController *)self view];
    widthAnchor2 = [view4 widthAnchor];
    v29 = [v26 constraintEqualToAnchor:widthAnchor2];
    [v29 setActive:1];
  }

  view5 = [(SKUIComposeReviewNicknameViewController *)self view];
  keyboardLayoutGuide = [view5 keyboardLayoutGuide];
  topAnchor3 = [keyboardLayoutGuide topAnchor];
  scrollView7 = [(SKUIComposeReviewNicknameViewController *)self scrollView];
...
- (void)_setupNicknameView
{
  ...
  v4 = [(SKUIComposeReviewNicknameView *)v3 initWithFrame:*MEMORY[0x277CBF3A0], *(MEMORY[0x277CBF3A0] + 8), *(MEMORY[0x277CBF3A0] + 16), *(MEMORY[0x277CBF3A0] + 24)];
  ...
  scrollView = [(SKUIComposeReviewNicknameViewController *)self scrollView];
  nicknameView2 = [(SKUIComposeReviewNicknameViewController *)self nicknameView];
  ...
  nicknameView3 = [(SKUIComposeReviewNicknameViewController *)self nicknameView];
  ...
  nicknameView4 = [(SKUIComposeReviewNicknameViewController *)self nicknameView];
  ...
  nicknameView5 = [(SKUIComposeReviewNicknameViewController *)self nicknameView];
  ...
  nicknameView6 = [(SKUIComposeReviewNicknameViewController *)self nicknameView];
...
- (void)_setupBarButtonItems
{
  ...
  v5 = [v4 localizedStringForKey:@"CONFIRM" value:&stru_2827FFAC8 table:0];
