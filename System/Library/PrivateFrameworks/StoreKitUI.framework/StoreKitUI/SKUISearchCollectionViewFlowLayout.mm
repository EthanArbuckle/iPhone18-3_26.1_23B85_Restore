...
- (SKUISearchCollectionViewFlowLayout)init
{
  ...
  v5.receiver = self;
  v5.super_class = SKUISearchCollectionViewFlowLayout;
...
- (id)layoutAttributesForElementsInRect:(CGRect)rect
{
  ...
  x = rect.origin.x;
  v30.receiver = self;
  v30.super_class = SKUISearchCollectionViewFlowLayout;
  v8 = [(SKUIItemGridCollectionViewLayout *)&v30 layoutAttributesForElementsInRect:?];
  v9 = [v8 mutableCopy];
...
{
  v13.receiver = self;
  v13.super_class = SKUISearchCollectionViewFlowLayout;
  [(UICollectionViewFlowLayout *)&v13 prepareLayout];
  collectionView = [(SKUISearchCollectionViewFlowLayout *)self collectionView];
