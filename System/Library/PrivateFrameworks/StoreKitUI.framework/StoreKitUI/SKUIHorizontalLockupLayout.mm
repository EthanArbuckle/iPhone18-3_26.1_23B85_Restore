...
- (SKUIHorizontalLockupLayout)initWithLockup:(id)lockup context:(id)context;
...
- (SKUIHorizontalLockupLayout)initWithLockup:(id)lockup context:(id)context
{
  ...
  v48.receiver = self;
  v48.super_class = SKUIHorizontalLockupLayout;
  v8 = [(SKUIHorizontalLockupLayout *)&v48 init];
  if (v8)
  {
    containsElementGroups = [lockupCopy containsElementGroups];
    v49[0] = xmmword_215F3FE60;
    v49[1] = xmmword_215F3FE70;
    v49[2] = xmmword_215F3FE80;
    v50 = 6;
    ...
    style = [v13 style];
    SKUIViewElementMarginForStyle(style, &v41);
    v16 = v15;
    ...
    *(v8 + 2) = v17;
    ...
    {
      *(v8 + 24) = xmmword_215F3FE90;
      *(v8 + 40) = xmmword_215F3FEA0;
...
LABEL_48:
  ...
  if (v8 <= 89)
  {
    if (v8 != 77)
    {
      ...
      v9 = [*(a1 + 40) aggregateValueForKey:0x28280A728];
      v10 = [v9 BOOLValue];
  ...
  if (v18 < *(a1 + 88) - 1)
  {
    v24[0] = xmmword_215F3FE60;
    v24[1] = xmmword_215F3FE70;
    v24[2] = xmmword_215F3FE80;
    v25 = 6;
    *(v17 + 24) = v18 + 1;
...
+ (id)fontForButtonViewElement:(id)element context:(id)context
{
  ...
  if (!v9)
  {
    ...
    v9 = SKUIFontLimitedPreferredFontForTextStyle(v11, 5);
  }
...
+ (id)fontForLabelViewElement:(id)element context:(id)context
{
  ...
  if (!v8)
  {
    ...
    else
    {
      ...
      v8 = SKUIFontLimitedPreferredFontForTextStyle(v10, 5);
    }
  }
    ...
    if (v14)
    {
      ...
      do
      {
        for (i = 0; i != v14; ++i)
        {
          ...
          {
            [(SKUIHorizontalLockupLayout *)self _sizeForViewElement:v17 width:width context:v12];
            v34[5] = v18 + v34[5];
          }
        }
