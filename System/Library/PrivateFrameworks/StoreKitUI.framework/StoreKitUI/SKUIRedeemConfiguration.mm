...
- (SKUIRedeemConfiguration)initWithOperationQueue:(id)queue category:(int64_t)category clientContext:(id)context;
...
- (void)_loadConfigurationWithURLBagDictionary:(id)dictionary completionBlock:(id)block
{
  ...
  if (v11)
  {
    ...
    _redeemPreflightRequestBodyData = [(SKUIRedeemConfiguration *)self _redeemPreflightRequestBodyData];
...
- (void)_setInputImage:(id)image
{
  ...
  if (self->_inputImage != imageCopy)
  {
    ...
    [defaultCenter postNotificationName:@"SKUIRedeemConfigurationImagesDidLoadNotification" object:self];
