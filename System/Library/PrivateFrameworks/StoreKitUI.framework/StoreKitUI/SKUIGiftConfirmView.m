...
- (SKUIGiftConfirmView)initWithGift:(id)a3 configuration:(id)a4
{
  ...
  if (v8)
  {
    ...
    v22 = v8->_rule1;
    v23 = [MEMORY[0x277D75348] _tertiaryLabelColor];
    ...
    v35 = v8->_senderView;
    v36 = [v6 senderName];
    [(SKUIGiftConfirmLabeledValue *)v35 setValue:v36];
    ...
    [(SKUIGiftConfirmLabeledValue *)v41 setValue:v42];
    ...
    v45 = v8->_rule2;
    v46 = [MEMORY[0x277D75348] _tertiaryLabelColor];
    ...
    v60 = v8->_rule3;
    v61 = [MEMORY[0x277D75348] _tertiaryLabelColor];
    ...
    v102 = v8->_rule4;
    v103 = [MEMORY[0x277D75348] _tertiaryLabelColor];
    ...
    v114 = v8->_rule5;
    v115 = [MEMORY[0x277D75348] _tertiaryLabelColor];
    ...
    v126 = v8->_rule6;
    v127 = [MEMORY[0x277D75348] _tertiaryLabelColor];
    [(UIView *)v126 setBackgroundColor:v127];

    [(SKUIGiftConfirmView *)v8 addSubview:v8->_rule6];
    v128 = [(SKUIGiftConfirmView *)v8 _termsButton];
    [(SKUIGiftConfirmView *)v8 addSubview:v128];
...
- (void)layoutSubviews
{
  ...
  v189 = ceilf(v188);
  v204 = [(SKUIGiftConfirmView *)self _termsButton];
  [v204 frame];
  v191 = v190;
...
- (id)_termsButton
{
  ...
  if (!termsButton)
  {
    v4 = [(SKUIGiftConfiguration *)self->_giftConfiguration clientContext];
