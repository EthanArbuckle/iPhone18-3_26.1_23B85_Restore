...
- (SKUIShakeAnimation)initWithOptions:(id)a3
{
  ...
  if (v5)
  {
    v6 = [v4 objectForKey:0x282809048];
    if (objc_opt_respondsToSelector())
    {
      v5->_shouldErase = [v6 BOOLValue];
    }

    v7 = [v4 objectForKey:0x282809068];
...
- (void)animateView:(id)a3
{
  ...
  *&v23 = v23;
  ...
  {
    v25 = SKUIAudioToolboxFramework();
    v26 = SKUIWeakLinkedSymbolForString("AudioServicesPlaySystemSound", v25);
    if (v26)
    {
      v26(4095);
    }
