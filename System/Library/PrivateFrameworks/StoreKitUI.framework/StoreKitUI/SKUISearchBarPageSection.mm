...
- (id)cellForIndexPath:(id)path
{
  ...
  v7 = [collectionView dequeueReusableCellWithReuseIdentifier:@"SKUISearchBarReuseIdentifier" forIndexPath:pathCopy];

  _searchBarController = [(SKUISearchBarPageSection *)self _searchBarController];
...
- (void)willAppearInContext:(id)context
{
  ...
  [collectionView registerClass:objc_opt_class() forCellWithReuseIdentifier:@"SKUISearchBarReuseIdentifier"];
  v6.receiver = self;
...
- (id)_searchBarController
{
  ...
  if (!searchBarController)
  {
    ...
    v6 = [[SKUISearchBarController alloc] initWithSearchBarViewElement:viewElement];
    ...
    [(SKUISearchBarController *)v10 setClientContext:clientContext];
