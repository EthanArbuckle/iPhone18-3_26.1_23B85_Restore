...
- (_SKUICounterTimeFieldView)initWithFrame:(CGRect)frame;
- (void)layoutSubviews;
...
- (_SKUICounterTimeFieldView)initWithFrame:(CGRect)frame
{
  ...
  v3 = [(_SKUICounterTimeFieldView *)&v13 initWithFrame:frame.origin.x, frame.origin.y, frame.size.width, frame.size.height];
  if (v3)
  {
...
- (void)setBackgroundColor:(id)color
{
  ...
  [(_SKUICounterTimeFieldView *)&v6 setBackgroundColor:colorCopy];
}
