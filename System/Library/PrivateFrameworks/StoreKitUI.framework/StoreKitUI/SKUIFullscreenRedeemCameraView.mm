...
- (SKUIFullscreenRedeemCameraView)initWithClientContext:(id)a3
{
  ...
  v19.receiver = self;
  v19.super_class = SKUIFullscreenRedeemCameraView;
...
- (void)dealloc
{
  ...
  v4.receiver = self;
  v4.super_class = SKUIFullscreenRedeemCameraView;
...
- (void)start
{
  ...
  {
    WeakRetained = objc_loadWeakRetained(&self->_delegate);
    v4 = [WeakRetained redeemerViewForSKUIRedeemCameraView:self];
...
- (void)layoutSubviews
{
  ...
  v12 = v11;
  if ([(SKUIRedeemTextField *)self->_textField isFirstResponder]&& (p_keyboardRect = &self->_keyboardRect, !CGRectEqualToRect(self->_keyboardRect, *MEMORY[0x277CBF3A0])))
  {
    ...
    [(SKUIRedeemTextField *)self->_textField setFrame:0.0, CGRectGetMinY(v21) + -44.0, v8, 44.0];
  ...
  {
    v14 = v10 + -44.0 - v12;
    [(SKUIRedeemTextField *)self->_textField setFrame:0.0, v14, v8, 44.0];
...
- (void)textFieldDidEndEditing:(id)a3
{
  ...
  if ([(SKUIFullscreenRedeemCameraView *)self enabled])
  {
    ...
    [(SKUIFullscreenRedeemCameraView *)self setText:&stru_2827FFAC8];
  }
}
