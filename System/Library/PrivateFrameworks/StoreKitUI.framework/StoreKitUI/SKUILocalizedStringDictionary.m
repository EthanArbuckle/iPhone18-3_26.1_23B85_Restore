...
LABEL_14:
      ...
      while (1)
      {
        ...
        v20 = [*(*(&v25 + 1) + 8 * v19) localizedStringForKey:v6 value:&stru_2827FFAC8 table:{v8, v25}];
        v15 = v20;
        if (v20 && v20 != v6)
        {
          break;
...
LABEL_13:
  v18 = [[SKUILocalizedStringTable alloc] initWithBundle:v6 localeName:v20->_localeName tableName:v7];
