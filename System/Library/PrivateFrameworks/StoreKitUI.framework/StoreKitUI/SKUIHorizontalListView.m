...
- (SKUIHorizontalListView)initWithFrame:(CGRect)a3
{
  ...
  v16 = [(SKUIViewReuseView *)&v18 initWithFrame:x, y, width, height];
  if (v16)
  {
...
+ (CGSize)sizeThatFitsWidth:(double)a3 viewElement:(id)a4 context:(id)a5
{
  ...
  v47 = 0x2020000000;
  v48 = 0;
  v18 = [a1 _linesWithViewElement:v8 width:v9 context:a3];
  v19 = [v18 count];
...
{
  v4 = a3;
  v5 = [(SKUIViewElement *)self->_listElement flattenedChildren];
...
- (void)layoutSubviews
{
  ...
  v4 = [(SKUIListViewElement *)self->_listElement style];
...
- (BOOL)pointInside:(CGPoint)a3 withEvent:(id)a4
{
  ...
  else
  {
    v13.receiver = self;
    v13.super_class = SKUIHorizontalListView;
    return [(SKUIHorizontalListView *)&v13 pointInside:a4 withEvent:a3.x, a3.y];
  }
}
...
- (CGSize)sizeThatFits:(CGSize)a3
{
  ...
  v33 = [(SKUIListViewElement *)v40->_listElement style];
  [v33 elementPadding];
  v35 = v34;
  v37 = v36;
...
- (void)_imageTapAction:(id)a3
{
  listElement = self->_listElement;
  v5 = a3;
  v10 = [(SKUIViewElement *)listElement flattenedChildren];
  v6 = [(SKUIViewReuseView *)self allExistingViews];
  v7 = [v5 view];
...
- (void)_menuButtonAction:(id)a3
{
  ...
  v8 = [(SKUIHorizontalListView *)self _viewElementForView:v23];
  if (v8)
  {
...
- (id)_viewElementForView:(id)a3
{
  listElement = self->_listElement;
  v5 = a3;
  v6 = [(SKUIViewElement *)listElement flattenedChildren];
