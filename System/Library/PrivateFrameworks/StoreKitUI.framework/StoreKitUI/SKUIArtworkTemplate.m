...
- (id)artworkForSize:(int64_t)a3
{
  v4 = [(SKUIArtworkTemplate *)self artworkWithWidth:a3];
...
- (id)artworkURLForSize:(int64_t)a3
{
  v4 = [(SKUIArtworkTemplate *)self artworkForSize:a3];
  v5 = [(SKUIArtworkTemplate *)self servedArtworks];
  [v5 addObject:v4];
...
- (id)artworkWithWidth:(int64_t)a3
{
  v4 = [(SKUIArtworkTemplate *)self _artworkWithWidth:a3];
  v5 = [(SKUIArtworkTemplate *)self servedArtworks];
  [v5 addObject:v4];
...
- (id)bestArtworkForSize:(CGSize)a3
{
  ...
  v9 = [(SKUIArtwork *)v7 initWithURL:v8 size:width, height];
...
- (id)preferredExactArtworkForSize:(CGSize)a3
{
  v4 = [(SKUIArtworkTemplate *)self bestArtworkForSize:a3.width, a3.height];
  v5 = [(SKUIArtworkTemplate *)self servedArtworks];
  [v5 addObject:v4];
...
- (SKUIArtwork)largestArtwork
{
  width = self->_width;
  height = self->_height;
  v5 = [(SKUIArtworkTemplate *)self _urlStringWithTargetSize:width, height];
  v6 = [SKUIArtwork alloc];
  v7 = [MEMORY[0x277CBEBC0] URLWithString:v5];
  v8 = [(SKUIArtwork *)v6 initWithURL:v7 size:width, height];
...
- (SKUIArtwork)smallestArtwork
{
  ...
  v7 = [(SKUIArtworkTemplate *)self servedArtworks];
  [v7 addObject:v6];
...
- (NSString)description
{
  ...
  v5 = [(SKUIArtworkTemplate *)self largestArtwork];
