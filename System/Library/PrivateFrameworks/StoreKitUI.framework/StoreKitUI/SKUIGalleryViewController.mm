...
- (SKUIGalleryViewController)initWithGalleryComponent:(id)component artworkLoader:(id)loader
{
  ...
  v14.receiver = self;
  v14.super_class = SKUIGalleryViewController;
...
- (void)dealloc
{
  ...
  v4.receiver = self;
  v4.super_class = SKUIGalleryViewController;
...
LABEL_6:
  ...
  if (!pageViewController)
  {
    ...
    if (v5 >= 1)
    {
      v12 = [(SKUIGalleryViewController *)self _newViewControllerWithIndex:0];
      v40[0] = v12;
...
- (id)_newViewControllerWithIndex:(int64_t)index
{
  ...
  if (v9)
  {
    v11 = -[SKUIResourceLoader cachedResourceForRequestIdentifier:](self->_artworkLoader, "cachedResourceForRequestIdentifier:", [v9 unsignedIntegerValue]);
  }
