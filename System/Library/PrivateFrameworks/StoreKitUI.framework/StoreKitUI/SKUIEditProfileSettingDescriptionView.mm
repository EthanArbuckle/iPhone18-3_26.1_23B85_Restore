...
+ (CGSize)sizeThatFitsWidth:(double)a3 settingDescription:(id)a4 context:(id)a5
{
  ...
  v15 = [a1 _baselineFontForTextStyle:*MEMORY[0x277D76918]];
...
- (void)reloadWithSettingDescription:(id)a3 width:(double)a4 context:(id)a5
{
  ...
  v14 = [(SKUIEditProfileSettingDescription *)self->_settingDescription photo];
  [(SKUIImageView *)imageView setImage:v14];
  ...
  v26 = [(SKUIEditProfileSettingDescription *)self->_settingDescription name];
  ...
  v32 = [(SKUIEditProfileSettingDescription *)self->_settingDescription handle];
  ...
  if (!self->_divider1)
  {
    ...
    v37 = [(SKUIEditProfileSettingDescriptionView *)self layer];
    [v37 addSublayer:self->_divider1];
  }

  v38 = [(SKUIEditProfileSettingDescription *)self->_settingDescription isEditing];
...
- (void)_updateHandleTextFieldValidity
{
  ...
  v5 = [(SKUIEditProfileSettingDescription *)self->_settingDescription isHandleValid];
  handleField = self->_handleField;
  if (v5)
  {
