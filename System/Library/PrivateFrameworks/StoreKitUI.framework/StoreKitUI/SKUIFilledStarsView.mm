...
- (SKUIFilledStarsView)initWithFrame:(CGRect)frame;
...
- (SKUIFilledStarsView)initWithFrame:(CGRect)frame
{
  ...
  v3 = [(SKUIFilledStarsView *)&v7 initWithFrame:frame.origin.x, frame.origin.y, frame.size.width, frame.size.height];
  if (v3)
  {
