...
- (void)getAdminStatusWithOptions:(id)options resultBlock:(id)block
{
  ...
  blockCopy = block;
  v6 = [options objectForKeyedSubscript:@"SKUIMediaSocialAdminPermissionsOptionIgnoreCache"];
  v7 = v6;
...
- (void)getAuthorsAndWaitWithOptions:(id)options authorsBlock:(id)block
{
  ...
  v9 = v8;
  v10 = blockCopy;
  [(SKUIMediaSocialAdminPermissionsCoordinator *)self getAuthorsWithOptions:optionsCopy authorsBlock:v11];
