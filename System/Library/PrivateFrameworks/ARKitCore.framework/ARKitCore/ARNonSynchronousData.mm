...
- (ARNonSynchronousData)initWithGatheredData:(id)data timestamp:(double)timestamp;
- (id)arMLDepthResult;
- (id)resultDataOfClass:(Class)class;
- (id)segmentationResultWithDataSource:(int64_t)source;
@end
...
- (ARNonSynchronousData)initWithGatheredData:(id)data timestamp:(double)timestamp
{
  ...
  if (v8)
  {
    objc_storeStrong(&v8->_gatheredData, data);
...
- (id)resultDataOfClass:(Class)class
{
  gatheredData = [(ARNonSynchronousData *)self gatheredData];
  ...
  v6 = [gatheredData filteredArrayUsingPredicate:v5];
