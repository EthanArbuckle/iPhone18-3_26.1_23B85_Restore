...
- (void)_processFaceDataInBackground:(id)a3 pixelBuffer:(__CVBuffer *)a4 lightIntensity:(float)a5 timestamp:(double)a6
{
  ...
  if (v27 > 0.0)
  {
    ...
    v21[1] = v24;
    v22 = v25;
    v19 = [(ARDirectionalLightEstimate *)v18 initWithSphericalHarmonics:v21 ambientIntensity:(a5 * 1000.0) temperature:self->_temperature];
    lastLightEstimate = self->_lastLightEstimate;
...
+ (shared_ptr<arkit::FaceTrackingData>)_transformFaceTrackingData:(id)a3
{
  ...
  v27 = 0;
  v28 = 0;
  std::vector<arkit::Landmark>::reserve(&__p, v4);
  if (v4)
  {
    v8 = 0;
  ...
  *v30.columns[0].i64 = ARMatrix3x3FromMatrix4x4([v3 transform]);
