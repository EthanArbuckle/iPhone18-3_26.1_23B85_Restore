...
- (void)getAuthorizationHintsWithURL:(id)a3 responseCode:(int64_t)a4 completion:(id)a5
{
  ...
  v15 = v9;
  v12 = v9;
  [(SOServiceConnection *)serviceConnection getAuthorizationHintsWithURL:v8 responseCode:a4 completion:v14];
...
- (void)performAuthorizationWithRequestParameters:(id)a3 completion:(id)a4
{
  ...
  v13 = v7;
  v10 = v7;
  [(SOServiceConnection *)serviceConnection performAuthorizationWithRequestParameters:v6 completion:v12];
...
- (void)beginAuthorizationWithRequestParameters:(id)a3 completion:(id)a4
{
  ...
  v13 = v7;
  v10 = v7;
  [(SOServiceConnection *)serviceConnection beginAuthorizationWithRequestParameters:v6 completion:v12];
...
- (void)cancelAuthorization:(id)a3 completion:(id)a4
{
  ...
  v13 = v6;
  v10 = v6;
  [(SOServiceConnection *)serviceConnection cancelAuthorization:v7 completion:v12];
...
- (void)finishAuthorization:(id)a3 completion:(id)a4
{
  ...
  v13 = v6;
  v10 = v6;
  [(SOServiceConnection *)serviceConnection finishAuthorization:v7 completion:v12];
