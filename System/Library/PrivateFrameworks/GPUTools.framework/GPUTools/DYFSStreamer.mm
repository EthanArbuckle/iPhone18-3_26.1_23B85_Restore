...
- (id)receiveTransfer:(id)transfer
{
  ...
  if (self->_owner)
  {
    *__error() = 0;
    ...
    if (!v6)
    {
      ...
      [future setError:{objc_msgSend(MEMORY[0x277D0AFC0], "errorWithDomain:code:userInfo:", *MEMORY[0x277CCA5B8], v21, 0)}];
  ...
  if (![(NSFileManager *)self->_fileManager createDirectoryAtPath:self->_path withIntermediateDirectories:0 attributes:v12 error:&v30])
  {
    ...
    if ((DYFSDirectoryExists() & 1) == 0)
    {
      ...
      v27 = v30;
      _DYOLog();
      [(DYFSStreamer *)self denyTransfer:transfer, v27];
      goto LABEL_12;
    }
  }
  ...
  v29[4] = self;
  v29[5] = future;
  v17 = [(DYTransport *)transport send:v14 inReplyTo:transfer error:&v30 replyQueue:queue timeout:10000000000 handler:v29];
  ++self->_messages;
...
LABEL_12:
    ...
    v24 = MEMORY[0x277CCABB0];
LABEL_15:
    [future setResult:{objc_msgSend(v24, "numberWithBool:", 0)}];
  }
