...
- (id)description
{
  ...
  v8.receiver = self;
  v8.super_class = FCCNotificationSuppressionRequestProtobuf;
  v4 = [(FCCNotificationSuppressionRequestProtobuf *)&v8 description];
  dictionaryRepresentation = [(FCCNotificationSuppressionRequestProtobuf *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  if (*&self->_has)
  {
    v6 = [MEMORY[0x277CCABB0] numberWithDouble:self->_expirationDate];
...
- (void)mergeFrom:(id)from
{
  ...
  {
    v5 = fromCopy;
    [(FCCNotificationSuppressionRequestProtobuf *)self setIdentifier:?];
    fromCopy = v5;
  }
