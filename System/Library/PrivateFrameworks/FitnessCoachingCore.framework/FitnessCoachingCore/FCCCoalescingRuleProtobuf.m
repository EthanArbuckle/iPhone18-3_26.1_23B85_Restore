...
- (id)description
{
  ...
  v8.receiver = self;
  v8.super_class = FCCCoalescingRuleProtobuf;
...
- (id)dictionaryRepresentation
{
  ...
  if (*&self->_has)
  {
    v6 = [MEMORY[0x277CCABB0] numberWithDouble:self->_interval];
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (*&self->_has)
  {
    if ((*(v4 + 24) & 1) != 0 && self->_interval == *(v4 + 1))
    {
      v6 = 1;
      goto LABEL_9;
    }
...
- (unint64_t)hash
{
  ...
  if (*&self->_has)
  {
    ...
    *v4.i64 = floor(interval + 0.5);
    v8 = (interval - *v4.i64) * 1.84467441e19;
...
- (void)mergeFrom:(id)a3
{
  ...
  {
    v5 = v4;
    [(FCCCoalescingRuleProtobuf *)self setEventIdentifier:?];
    v4 = v5;
  }
