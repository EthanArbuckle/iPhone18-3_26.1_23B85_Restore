...
LABEL_6:
  ...
  {
    if (![(RMModelPayloadBase *)self loadStringFromDictionary:v7 usingKey:@"Version" forKeyPath:@"responseVersion" isRequired:1 defaultValue:0 error:a5])
    {
      goto LABEL_6;
    }
...
{
  v4 = objc_opt_new();
  v5 = [(RMProtocolWellKnownResponse_WellKnownResponseServer *)self responseVersion];
  [(RMModelPayloadBase *)self serializeStringIntoDictionary:v4 usingKey:@"Version" value:v5 isRequired:1 defaultValue:0];

  v6 = [(RMProtocolWellKnownResponse_WellKnownResponseServer *)self responseBaseURL];
