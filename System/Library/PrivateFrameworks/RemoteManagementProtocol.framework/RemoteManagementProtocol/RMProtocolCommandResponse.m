...
- (BOOL)loadFromDictionary:(id)a3 serializationType:(signed __int16)a4 error:(id *)a5
{
  ...
  {
    LOWORD(v11) = a4;
    v9 = [(RMModelPayloadBase *)self loadDictionaryFromDictionary:v8 usingKey:@"Command" forKeyPath:@"responseCommand" classType:objc_opt_class() isRequired:0 defaultValue:0 serializationType:v11 error:a5];
  }
...
{
  v5 = objc_opt_new();
  v6 = [(RMProtocolCommandResponse *)self responseCommandToken];
