...
- (BWInferenceCompressibleLazyVideoRequirement)initWithLazyVideoRequirement:(id)requirement;
...
- (BWInferenceCompressibleLazyVideoRequirement)initWithLazyVideoRequirement:(id)requirement
{
  ...
  if (v4)
  {
    v4->_underlyingLazyVideoRequirement = requirement;
  }
...
- (int)prepareForInputInferenceVideoFormat:(id)format
{
  ...
  pixelFormat = [(BWInferenceVideoFormat *)[(BWInferenceVideoRequirement *)self->_underlyingLazyVideoRequirement videoFormat] pixelFormat];
  if (pixelFormat == [format uncompressedEquivalent])
  {
