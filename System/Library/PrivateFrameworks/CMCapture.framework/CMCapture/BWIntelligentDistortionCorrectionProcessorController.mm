...
- (uint64_t)_updateStateIfNeeded
{
  if (result)
  {
    v1 = result;
    v2 = *(result + 112);
    currentState = [*(result + 96) currentState];
    if (v2)
    {
      if (currentState == 2)
      {
...
- (void)_getAndAttachGDCInformationToDemosaicedRawSampleBuffer:(id *)buffer inputDimensions:(const void *)dimensions finalImageDimensions:(unint64_t)imageDimensions settingsID:(uint64_t)d
{
  if (buffer)
  {
    ...
    if (AttachedMedia)
    {
      ...
      if (!v11 || (v12 = v11, v66 = 0.0, v64 = 0u, v65 = 0u, v62 = 0u, v63 = 0u, [buffer[9] getAdjustedGDCInformation:&v62]) || (LODWORD(v13) = v64, v58 = objc_msgSend(MEMORY[0x1E696AD98], "numberWithFloat:", v13), LODWORD(v14) = DWORD1(v64), v59 = objc_msgSend(MEMORY[0x1E696AD98], "numberWithFloat:", v14), LODWORD(v15) = DWORD2(v64), v60 = objc_msgSend(MEMORY[0x1E696AD98], "numberWithFloat:", v15), LODWORD(v16) = HIDWORD(v64), v61 = objc_msgSend(MEMORY[0x1E696AD98], "numberWithFloat:", v16), v17 = objc_msgSend(MEMORY[0x1E695DEC8], "arrayWithObjects:count:", &v58, 4), v18 = BWPixelBufferDimensionsFromSampleBuffer(v10), (v19 = BWCreateDNGDictionaryWithZoomedGDCParameters(v12, v17, v18, *&v62, *(&v62 + 1), *&v63, *(&v63 + 1), *(&v65 + 1), v66)) == 0))
      {
      ...
      {
        v21 = llround(vabdd_f64(d, *&v63));
        v22 = llround(vabdd_f64(SHIDWORD(d), *(&v63 + 1)));
        if (v21 <= 4 && v22 <= 4)
        {
          ...
          v72.origin.x = 0.0;
          v72.origin.y = 0.0;
          v72.size.width = imageDimensions;
          v72.size.height = SHIDWORD(imageDimensions);
          v71.size.width = d;
          v71.size.height = SHIDWORD(d);
        ...
        v29 = [objc_msgSend(configuration "providedInferenceAttachedMediaByMode")];
        v30 = [v29 count];
        if (v30)
        {
        ...
        if (v38)
        {
          ...
          do
          {
            for (i = 0; i != v39; ++i)
            {
              ...
              v43 = *(*(&v67 + 1) + 8 * i);
              v44 = BWSampleBufferGetAttachedMedia(dimensions, v43);
              if (v44)
              {
                v52 = v44;
                ...
                if (v44)
                {
                  BWSampleBufferRemoveAttachedMedia(dimensions, v43);
                }
              }
            }
...
- (uint64_t)_applyExistingCorrectionToDepthPixelBuffer:(uint64_t)buffer primaryImageDimensions:
{
  ...
  if (!v6)
  {
    ...
    if (!v12)
    {
      ...
      if (CVPixelBufferCreate(*MEMORY[0x1E695E480], Width, Height, PixelFormatType, v17, (self + 128)))
      {
        goto LABEL_18;
      }
    ...
    v18 = [*(self + 72) applyExistingCorrectionToSecondaryAsset:a2 outputPixelBuffer:v12 primaryImageDimensions:buffer];
    if (v18)
    {
      v11 = v18;
...
LABEL_18:
  ...
  v9 = FigDepthRotateBuffer(a2, *(self + 120), v8);
  if (v9 || (v9 = [*(self + 72) applyExistingCorrectionToSecondaryAsset:*(self + 120) outputPixelBuffer:*(self + 128) primaryImageDimensions:buffer], v9))
  {
    v11 = v9;
    OUTLINED_FUNCTION_0_26();
LABEL_17:
  ...
  v11 = FigDepthRotateBuffer(*(self + 128), a2, v10);
  if (v11)
  {
    goto LABEL_17;
  }
...
- (uint64_t)_prepareProcessor:(void *)processor
{
  ...
  v12 = 0;
  v4 = [objc_msgSend(processor "configuration")];
  v6 = [(BWIntelligentDistortionCorrectionProcessorController *)processor _determineWorkingBufferRequirementsWithProcessorConfig:v4 processor:v5 metalBufferSizeOut:a2, &v12];
  if (v6)
  {
    goto LABEL_10;
  }
  ...
  v8 = [metalDevice newBufferWithLength:v12 options:0];
  if (!v8)
  {
    FigDebugAssert3();
