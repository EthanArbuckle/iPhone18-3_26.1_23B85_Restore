  ...
  if (a3)
  {
    ...
    if (v8)
    {
      ...
      do
      {
          ...
          if (([v12 isEqualToString:0x1F21836D0] & 1) != 0 || objc_msgSend(v12, "isEqualToString:", 0x1F2183E10))
          {
            ...
            if (v13)
            {
              ...
              *&v26 = v20;
              ...
              [(BWSphereInteractionCalibrationAnalyticsPayload *)v27 setMagneticFieldMagnitude:a5];
        ...
        v9 = [a3 countByEnumeratingWithState:&v37 objects:v36 count:16];
      }
...
+ (id)calibrationDataStringForInternalLogging:(id)a3
{
  if (a3)
  {
    ...
    v22 = 0u;
    v23 = 0u;
    v5 = [a3 countByEnumeratingWithState:&v20 objects:v19 count:16];
    if (v5)
    {
      v6 = v5;
      v7 = *v21;
        ...
        for (i = 0; i != v6; ++i)
        {
          ...
          if (([v9 isEqualToString:0x1F21836D0] & 1) != 0 || objc_msgSend(v9, "isEqualToString:", 0x1F2183E10))
          {
            ...
            if (v10)
            {
              ...
              v12 = *(v17 + 12);
              v13 = WORD6(v17[1]);
              [v4 appendFormat:@"%@, %d, %f, %f, %f, %f, %f, %f, %f, %f, %f, %f, %f, %f, %f, %f, %s, %d, ", v9, v14, *(&v14 + 1), *(&v14 + 2), *(&v14 + 3), *&v15, *(&v15 + 1), *(&v15 + 2), *(&v15 + 3), *&v16, *(&v16 + 1), *(&v16 + 2), *(&v16 + 3), *v17, *(v17 + 1), *(v17 + 2), &v12, v18];
            }
          }
        }

        v6 = [a3 countByEnumeratingWithState:&v20 objects:v19 count:16];
      }
