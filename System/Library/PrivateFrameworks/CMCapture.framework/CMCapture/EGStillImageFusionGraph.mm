...
- (uint64_t)_build
{
  ...
  LODWORD(v262) = v5;
  LODWORD(v250) = deferredPhotoProcessorEnabled;
  ...
  HIDWORD(v244) = v17;
  HIDWORD(v257) = (v16 & HIDWORD(v261) & 1) != 0 && (captureFlags & 0x4200000000) == 0x200000000;
  v18 = (v262 & ((captureFlags & 0x800) != 0)) == 1 && [OUTLINED_FUNCTION_5_68() depthDataType] == 8 && (captureFlags & 0x200) == 0;
  v265 = v2;
  LODWORD(v258) = captureType;
  if (v262)
  {
  ...
  HIDWORD(v253) = v9 | downgradedDeepFusionEnhancedResolutionCapture;
...
LABEL_64:
  if ((HIDWORD(v258) & v22 & v37) == 1)
  {
    ...
    v152 = inferencesDeliveredOutput;
    v153 = v22;
    ...
    v156 = v154;
    v22 = v153;
    inferencesDeliveredOutput = v152;
    encodingCompleteOutput = [v156 encodingCompleteOutput];
    [OUTLINED_FUNCTION_18_24(encodingCompleteOutput v158];
  }
...
LABEL_66:
  ...
  if (v258 == 12)
  {
    ...
    v230 = v265;
    v232 = *(v1 + 128);
    BYTE1(name2) = BYTE4(v253) & 1;
    LOBYTE(name2) = BYTE4(v244);
    ...
    if (v248 >= 1)
    {
      ...
      do
      {
        v165 = [array4 objectAtIndexedSubscript:v122];
    ...
    if ([v121 sbufForEarlyEmissionOutput])
    {
      ...
      [OUTLINED_FUNCTION_18_24(captureCompleteOutput2 v169];
    }
  ...
  else
  {
    ...
    HIDWORD(v240) = v22;
    v252 = inferencesDeliveredOutput;
    if (v262)
    {
      v149 = v248;
      LODWORD(v238) = (v248 > 3) & (captureFlags >> 20);
    }
    ...
    if (v149 >= 1)
    {
      ...
      do
      {
        v182 = [(NSArray *)sbufOutputs objectAtIndexedSubscript:v181];
    ...
    v192 = OUTLINED_FUNCTION_21_24(array6, v185, v186, v187, v188, v189, v190, v191, name2, v230, v232, v234, v236, v238, v240, referenceFrameOutput, v244, v245, array, v180, v252, v253, array3, v257, v258, captureFlags, v261, v262, array2, v265, v266, v268, v270, v272, v274, v276, v278, v280, v282, v284, v286, v288, v290, v292, v294, v296, v298, v301, v303, v305, v307, v309, v311, v313, v315, v317, v319, v321, v323, v325, v327, v329, v331);
    if (v192)
    {
      v193 = v192;
      v194 = MEMORY[0];
      do
      {
        for (j = 0; j != v193; ++j)
        {
          ...
          [v200 sbufOutput];
          [OUTLINED_FUNCTION_28() addObject:?];
          v201 = [array2 addObject:{objc_msgSend(v200, "processingCompleteOutput")}];
        }

        v193 = OUTLINED_FUNCTION_21_24(v201, v202, v203, v204, v205, v206, v207, v208, name, v230, v232, v234, v236, v238, v240, v242, v244, v245, array, v248, v250, v253, array3, v257, v258, captureFlags, v261, v262, array2, v265, v266, v268, v270, v272, v274, v276, v278, v280, v282, v284, v286, v288, v290, v292, v294, v296, v300, v302, v304, v306, v308, v310, v312, v314, v316, v318, v320, v322, v324, v326, v328, v330, v332);
      }
    ...
    if ([array6 count])
    {
      ...
      do
      {
        v214 = [array6 objectAtIndexedSubscript:v213];
      ...
      while ([array6 count] > v213);
    }

    if (v238)
    {
      secondEvZeroOutput = [v248 secondEvZeroOutput];
      v220 = [EGStillImageSoftISPNode alloc];
      v221 = MEMORY[0x1E696AEC0];
      name2 = [secondEvZeroOutput name];
      ...
      attemptErrorRecoveryOutput = [v211 attemptErrorRecoveryOutput];
      [v223 gatingInput];
      [OUTLINED_FUNCTION_1_15() connectOutput:attemptErrorRecoveryOutput toInput:?];
      [array2 addObject:{objc_msgSend(v223, "processingCompleteOutput")}];
      sbufOutput3 = [v223 sbufOutput];
      [v211 hdrErrorRecoveryEVZeroInput];
      [OUTLINED_FUNCTION_1_15() connectOutput:sbufOutput3 toInput:?];
    }

    inferenceInputImageOutput = [v211 inferenceInputImageOutput];
    fusionModeOutput = [v211 fusionModeOutput];
    sbufOutput2 = [v211 sbufOutput];
    inferencesDeliveredInput = 0;
    v23 = &OBJC_IVAR___BWVISNode__frameMotionTensorsRingBuffer;
  }
  ...
  v59 = v245;
  v22 = HIDWORD(v240);
  inferencesDeliveredOutput = v250;
  v58 = &OBJC_METACLASS___EGStillImageDeepFusionNode;
LABEL_69:
  v8 = v59 == 13;
  v64 = 52;
  ...
  if ((v245 & 0x100000000) != 0)
  {
    ...
    v132 = v66;
    v133 = inferencesDeliveredOutput;
    v134 = v131;
    OUTLINED_FUNCTION_10_41([*(v1 + 120) workerQueue]);
    [OUTLINED_FUNCTION_27_1() installNode:?];
    [(EGStillImageFusionGraph *)v1 _processorControllerOutputForType:?];
    ...
    [OUTLINED_FUNCTION_1_15() connectOutput:sbufOutput2 toInput:?];
    v135 = v134;
    inferencesDeliveredOutput = v133;
    v66 = v132;
    sbufOutput5 = [(EGStillImageScalerNode *)v135 sbufOutput];
    v58 = &OBJC_METACLASS___EGStillImageDeepFusionNode;
  ...
  if (v71)
  {
    if (fusionModeOutput)
    {
      v79 = OUTLINED_FUNCTION_20_19(v71, v72, v73, v74, v75, v76, v77, v78, name2, v230, v232, v234, v236, v238, v240, v242, v244, v245, array, v248, v250, v253, array3, v257, v258, captureFlags, v261, v262, array2, v265, v266, v268, v270, v272, v274, v276, v278, v280, v282, v284, v286, v288, v290, v292, v294, v296, 0);
      if (v79)
      {
        v22 = v79;
        ...
        do
        {
          ...
          v22 = OUTLINED_FUNCTION_20_19(v81, v82, v83, v84, v85, v86, v87, v88, name2, v231, v233, v235, v237, v239, v241, v243, v244, v246, array, v249, v251, v254, v256, v257, v258, v260, v261, v263, array2, v265, v267, v269, v271, v273, v275, v277, v279, v281, v283, v285, v287, v289, v291, v293, v295, v297, v299);
        }
...
LABEL_93:
  ...
  if (HIDWORD(v257))
  {
    ...
    OUTLINED_FUNCTION_11_40();
    LOBYTE(name2) = BYTE4(v261);
    v142 = [v141 initWithName:@"DistortionCorrection" stillImageSettings:name2 nodeConfiguration:1 addConfigurationInput:v265 processIDC:*(v1 + v140) processGDC:? deepZoomEnabled:? inputImageBufferType:? portType:? delegate:?];
  ...
  if (HIDWORD(v258))
  {
    ...
    [OUTLINED_FUNCTION_1_15() connectOutput:sbufOutput2 toInput:?];
    sbufOutput2 = [(EGStillImageSmartStyleRenderingNode *)v144 sbufOutput];
