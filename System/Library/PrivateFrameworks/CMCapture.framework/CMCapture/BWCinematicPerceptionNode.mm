...
- (BWCinematicPerceptionNode)initWithConvEngineSupportWithCaptureDevice:(id)a3 scheduler:(id)a4 priority:(unsigned int)a5 depthInferenceEnabled:(BOOL)a6 aspectRatio:(int)a7;
...
LABEL_7:
    ...
    v13 = BWSampleBufferGetAttachedMedia(a3, @"depthFeaturesOut");
    ...
    v14 = BWSampleBufferGetAttachedMedia(a3, @"colorFeaturesOut");
...
LABEL_14:
  v15 = CMGetAttachment(a3, @"FusionTrackerInput", 0);
  if (([objc_msgSend(v15 "highPriorityTrackerState")] & 1) == 0)
  {
    [objc_msgSend(v15 "highPriorityTrackerState")];
  }

  CMSetAttachment(a3, @"FTCinematicTrackingResult", [v15 commit], 1u);
}
...
- (id)inputVideoFormatForAttachedMediaKey:(id)a3
{
  if (([a3 isEqualToString:@"colorFeaturesIn"] & 1) != 0 || objc_msgSend(a3, "isEqualToString:", @"colorFeaturesOut"))
  {
    v5 = 312;
    return *(&self->super.super.super.isa + v5);
  }

  if (([a3 isEqualToString:@"depthFeaturesIn"] & 1) != 0 || objc_msgSend(a3, "isEqualToString:", @"depthFeaturesOut"))
  {
    v5 = 304;
    return *(&self->super.super.super.isa + v5);
  }
  ...
  {
    v7 = [(BWVideoDepthInferenceConfiguration *)self->_videoDepthConfiguration stereoV2inferenceDescriptor];
    [objc_msgSend(-[ADEspressoStereoV2InferenceDescriptor temporalSmoothingCurrentFeaturesRatioMinInput](v7 "temporalSmoothingCurrentFeaturesRatioMinInput")];
    v9 = v8;
    v11 = v10;
    ...
    v25 = [MEMORY[0x1E696AD98] numberWithUnsignedInt:{objc_msgSend(objc_msgSend(-[ADEspressoStereoV2InferenceDescriptor temporalSmoothingCurrentFeaturesRatioMinInput](v7, "temporalSmoothingCurrentFeaturesRatioMinInput"), "imageDescriptor"), "pixelFormat")}];
  ...
  {
    v15 = [(BWVideoDepthInferenceConfiguration *)self->_videoDepthConfiguration stereoV2inferenceDescriptor];
    [objc_msgSend(-[ADEspressoStereoV2InferenceDescriptor temporalSmoothingPreviousFeaturesRatioMinInput](v15 "temporalSmoothingPreviousFeaturesRatioMinInput")];
    v17 = v16;
    v19 = v18;
    ...
    v23 = [MEMORY[0x1E696AD98] numberWithUnsignedInt:{objc_msgSend(objc_msgSend(-[ADEspressoStereoV2InferenceDescriptor temporalSmoothingPreviousFeaturesRatioMinInput](v15, "temporalSmoothingPreviousFeaturesRatioMinInput"), "imageDescriptor"), "pixelFormat")}];
...
- (id)preparedOutputPixelBufferPoolForAttachedMediaKey:(id)a3 format:(id)a4
{
  ...
  v7 = @"Depth";
LABEL_3:
  v8 = [(BWNodeOutput *)output mediaPropertiesForAttachedMediaKey:v7];
...
- (BWCinematicPerceptionNode)initWithConvEngineSupportWithCaptureDevice:(id)a3 scheduler:(id)a4 priority:(unsigned int)a5 depthInferenceEnabled:(BOOL)a6 aspectRatio:(int)a7
{
  ...
  v15 = [(BWInferenceNode *)&v40 initWithConvEngineSupportWithCaptureDevice:a3 scheduler:a4 priority:v9 processingConfiguration:v13];
  v16 = v15;
  if (v15)
  {
    ...
    if (![OUTLINED_FUNCTION_38() addInferenceOfType:150 version:? configuration:?])
    {
      ...
      if (![OUTLINED_FUNCTION_38() addInferenceOfType:151 version:? configuration:?])
      {
        ...
        v16->_videoDepthConfiguration = [[BWVideoDepthInferenceConfiguration alloc] initWithConcurrencyWidth:2 videoDepthLayout:2 * (v7 != 3) captureDevice:a3 backpressureEvent:v16->_backpressureEvent];
        v16->_depthInferenceEnabled = v8;
        if (v8)
        {
          ...
          v22 = [(BWVideoDepthInferenceConfiguration *)v16->_videoDepthConfiguration featuresDimensions];
          ...
          [OUTLINED_FUNCTION_8() setSupportedPixelFormats:?];
          [(BWVideoFormatRequirements *)v23 setWidth:v22];
          [(BWVideoFormatRequirements *)v23 setHeight:v22 >> 32];
          v37 = v23;
          ...
          v25 = [(BWVideoDepthInferenceConfiguration *)v16->_videoDepthConfiguration stereoV2inferenceDescriptor];
          [objc_msgSend(-[ADEspressoStereoV2InferenceDescriptor colorFeaturesOutput](v25 "colorFeaturesOutput")];
          v27 = v26;
          v29 = v28;
          v30 = [objc_msgSend(-[ADEspressoStereoV2InferenceDescriptor colorFeaturesOutput](v25 "colorFeaturesOutput")];
          ...
          [objc_msgSend(-[ADEspressoStereoV2InferenceDescriptor temporalSmoothingCurrentFeaturesRatioMinInput](v25 "temporalSmoothingCurrentFeaturesRatioMinInput")];
          [objc_msgSend(-[ADEspressoStereoV2InferenceDescriptor temporalSmoothingCurrentFeaturesRatioMinInput](v25 "temporalSmoothingCurrentFeaturesRatioMinInput")];
          [objc_msgSend(-[ADEspressoStereoV2InferenceDescriptor temporalSmoothingPreviousFeaturesRatioMinInput](v25 "temporalSmoothingPreviousFeaturesRatioMinInput")];
          [objc_msgSend(-[ADEspressoStereoV2InferenceDescriptor temporalSmoothingPreviousFeaturesRatioMinInput](v25 "temporalSmoothingPreviousFeaturesRatioMinInput")];
...
- (BOOL)_attachISPDetectionsFromSampleBuffer:(void *)a3 toTrackingInput:(uint64_t)a4 withFrameTimestamp:
{
  ...
  do
  {
    ...
    do
    {
      ...
      v94 = 0u;
      v95 = 0u;
      v25 = OUTLINED_FUNCTION_3_106(v16, v17, v18, v19, v20, v21, v22, v23, v52, v53, v54, v55, v56, v57, v58, v59, v60, v61, v62, v63, v64, v65, obj, v13, v68, v69, v70, v71, v24, v73, v74, *(&v74 + 1), v75, v76, *&rect.origin.x, *&rect.origin.y, *&rect.size.width, *&rect.size.height, v78, v79, v80, v81, v82, v83, v84, v85, v86, v87, v88, v89, v90, v91, v92, v93, 0);
      if (v25)
      {
        v26 = v25;
        v27 = *v95;
        do
        {
          ...
          do
          {
            ...
            if (v30)
            {
              ...
              {
                v41 = v40 / 1000.0;
                v42 = [(__CFDictionary *)v30 unsignedIntegerValue];
                ...
                v74 = *v70;
                v75 = *(v70 + 16);
                v46 = [(BWFusionTrackerObservable *)v45 initWithKind:v72 box:&v74 confidence:v42 timestamp:v29 identifier:rect.origin.x metadata:rect.origin.y, rect.size.width, rect.size.height, v41];
                [v71 addObject:v46];
          ...
          while (v26 != v28);
          v47 = OUTLINED_FUNCTION_3_106(v30, v31, v32, v33, v34, v35, v36, v37, v52, v53, v54, v55, v56, v57, v58, v59, v60, v61, v62, v63, v64, v65, obj, v67, v68, v69, v70, v71, v72, v73, v74, *(&v74 + 1), v75, v76, *&rect.origin.x, *&rect.origin.y, *&rect.size.width, *&rect.size.height, v78, v79, v80, v81, v82, v83, v84, v85, v86, v87, v88, v89, v90, v91, v92, v93, v94);
          v26 = v47;
        }
...
- (void)renderSampleBuffer:(opaqueCMSampleBuffer *)a3 forInput:(id)a4
{
  ...
  v9 = CMGetAttachment(a3, @"CinematicVideoFocusRequest", 0);
  if (v9)
  {
    v10 = v9;
  ...
  v12 = [(BWCinematicPerceptionNode *)self _attachISPDetectionsFromSampleBuffer:a3 toTrackingInput:v7 withFrameTimestamp:v29];
  CMSetAttachment(a3, @"FusionTrackerInput", [(FTCinematicTracker *)self->_cinematicTracker computeTrackingStateForInput:v7], 1u);
  ...
  v17 = [(BWInferenceEngine *)[(BWInferenceNode *)self inferenceEngine] metalCommandBuffer];
  v18 = v17;
  if (self->_depthInferenceEnabled)
  {
    ...
    BWSampleBufferSetAttachedMedia(a3, @"depthFeaturesIn", previousDisparityFeaturesSampleBuffer);
    BWSampleBufferSetAttachedMedia(a3, @"colorFeaturesIn", self->_previousColorFeaturesSampleBuffer);
    BWSampleBufferSetAttachedMedia(a3, @"currentFeaturesMin", self->_currentFeaturesMinSampleBuffer);
    BWSampleBufferSetAttachedMedia(a3, @"previousFeaturesMin", self->_previousFeaturesMinSampleBuffer);
    previousColorFeaturesSampleBuffer = self->_previousColorFeaturesSampleBuffer;
    if (previousColorFeaturesSampleBuffer)
    {
      CFRelease(previousColorFeaturesSampleBuffer);
  ...
  {
    [v17 encodeWaitForEvent:self->_backpressureEvent value:self->_backpressureEventNumber];
  ...
  [(BWInferenceNode *)&v25 renderSampleBuffer:a3 forInput:a4];
  if (self->_depthInferenceEnabled)
  {
