...
- (uint64_t)_updateQuadraSubPixelSwitchingParametersWithVideoStabilizationStrength:(int)strength imageControlMode:(int)mode stillImageDigitalFlashMode:(int)flashMode isStationary:(char *)stationary quadraSubPixelSwitchingParametersChangedOut:;
- (void)dealloc;
@end
...
- (BWNondisruptiveSwitchingFormatSelector)initWithPortType:(id)type quadraSubPixelSwitchingParameters:(id)parameters baseZoomFactor:(float)factor zoomFactorToNondisruptiveSwitchingFormatIndexSIFRBinned:(id)binned zoomFactorToNondisruptiveSwitchingFormatIndexSIFRNonBinned:(id)nonBinned ultraHighResolutionNondisruptiveStreamingFormatIndex:(int)index mainFormatSIFRBinningFactor:(int)binningFactor
{
  ...
  if (v16)
  {
    ...
    {
      v16->_portType = type;
      v16->_baseZoomFactor = factor;
      v16->_zoomFactorToNondisruptiveSwitchingFormatIndexSIFRBinned = binned;
      v17->_zoomFactorToNondisruptiveSwitchingFormatIndexSIFRNonBinned = nonBinned;
      v17->_ultraHighResolutionNondisruptiveStreamingFormatIndex = index;
      v17->_mainFormatSIFRBinningFactor = binningFactor;
      v17->_lastNondisruptiveSwitchingFormatIndex = -1;
      parametersCopy = parameters;
      v17->_quadraSubPixelSwitchingParameters = parametersCopy;
      if (parametersCopy)
      {
        ...
        allKeys2 = [(NSDictionary *)v17->_quadraSubPixelSwitchingParameters allKeys];
    ...
    else if (mode != 1 || flashMode)
    {
      if (mode != 2 || flashMode)
      {
        if (mode != 1 || flashMode != 1)
        {
          ...
          v8 = (flashModeCopy & 1) != 0 ? @"DigitalFlashMaxTripod" : v10;
        }
...
- (int)formatIndexForZoomFactor:(float)lastZoomFactor frameStatistics:(id)statistics imageControlMode:(int)mode stillImageDigitalFlashMode:(int)flashMode isStationary:(BOOL)stationary isSecondaryStream:(BOOL)stream binnedSIFROnSecondaryStreamAllowed:(BOOL)allowed ignoreZoomFactorAndQuadraSubPixelSceneMonitoring:(BOOL)self0 ultraHighResolutionZeroShutterLagEnabled:(BOOL)self1
{
  ...
  v17 = v16 || !allowed;
  v58 = __PAIR64__(stationary, flashMode);
  HIDWORD(v56) = mode;
  if (!v17)
  {
  ...
  v81 = 0u;
  v82 = 0u;
  v20 = OUTLINED_FUNCTION_5_4(self, a2, statistics, *&mode, *&flashMode, stationary, stream, allowed, v56, v58, statisticsCopy, v62, v63, v64, v65, v66, v67, v68, v69, v70, v71, v72, v73, v74, v75, v76, v77, v78, 0);
  if (v20)
  {
    v21 = v20;
    v22 = *v80;
    ...
    do
    {
      ...
      v21 = OUTLINED_FUNCTION_5_4(floatValue, v28, v29, v30, v31, v32, v33, v34, v57, v59, v61, v62, v63, v64, v65, v66, v67, v68, v69, v70, v71, v72, v73, v74, v75, v76, v77, v78, v79);
    }
