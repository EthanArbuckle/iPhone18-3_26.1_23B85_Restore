...
- (EGStillImageSmartStyleRenderingNode)initWithName:(id)a3 stillImageSettings:(id)a4 portType:(id)a5 delegate:(id)a6;
- (void)dealloc;
...
- (void)queueManagedReceiveData:(id)a3 fromInputGroup:(id)a4
{
  ...
  {
    v7 = v6;
    v8 = [objc_msgSend(a3 objectForKeyedSubscript:{-[EGInput name](-[EGStillImageSmartStyleRenderingNode processorInput](self, "processorInput"), "name")), "processorController"}];
...
- (void)processorController:(id)a3 didFinishProcessingSampleBuffer:(opaqueCMSampleBuffer *)a4 type:(unint64_t)a5 processorInput:(id)a6 err:(int)a7
{
  ...
  if (!a4)
  {
    *&a7 = 4294954516;
LABEL_7:
    [EGStillImageSmartStyleRenderingNode processorController:*&a7 didFinishProcessingSampleBuffer:? type:? processorInput:? err:?];
    return;
  }
