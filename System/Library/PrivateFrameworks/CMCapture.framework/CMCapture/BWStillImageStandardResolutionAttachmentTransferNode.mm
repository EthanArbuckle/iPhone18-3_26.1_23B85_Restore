...
- (void)_transferAttachmentsToEnhancedResolutionBufferWithDimensions:(uint64_t)a1;
- (void)dealloc;
...
- (void)renderSampleBuffer:(opaqueCMSampleBuffer *)a3 forInput:(id)a4
{
  ...
  {
    v7 = v6;
    if (([objc_msgSend(v6 "captureSettings")] & 0x800) != 0 && (BWStillImageProcessingFlagsForSampleBuffer(a3) & 0x200000) == 0)
    {
      ...
      v9 = [CMGetAttachment(a3 @"StillImageBufferFrameType"];
      ...
      if (v10 && v9 == 13)
      {
        ...
        v12 = CMGetAttachment(a3, @"AttachedMedia", 0);
        ...
        {
          v13 = *off_1E798D2B8;
          v14 = CMGetAttachment(a3, *off_1E798D2B8, 0);
          if (v14)
          {
        ...
        self->_standardResBufferDimensions = BWPixelBufferDimensionsFromSampleBuffer(a3);
...
- (void)_transferAttachmentsToEnhancedResolutionBufferWithDimensions:(uint64_t)a1
{
  ...
  {
    v2 = HIDWORD(a2);
    v4 = [CMGetAttachment(*(a1 + 168) @"Inferences"];
    if (!v4)
    {
      v4 = objc_alloc_init(MEMORY[0x1E695DF90]);
    }

    [v4 addEntriesFromDictionary:*(a1 + 136)];
      ...
      if (v17)
      {
        ...
        do
        {
          for (i = 0; i != v18; ++i)
          {
            ...
            if ((v24 & 1) == 0)
            {
              v32 = BWCMSampleBufferCopyReattachAndReturnMutableMetadata([*(a1 + 144) objectForKeyedSubscript:v23]);
    ...
    [v36 addEntriesFromDictionary:*(a1 + 144)];
    ...
    if (v47)
    {
      ...
      do
      {
        for (j = 0; j != v48; ++j)
        {
          ...
          CMSetAttachment(*(a1 + 168), *(8 * j), [*(a1 + 152) objectForKeyedSubscript:*(8 * j)], 1u);
        }
