...
- (BWNoiseReductionAndSharpeningParameters)initWithPortType:(id)a3 sensorIDDictionary:(id)a4
{
  if (a3 && a4 && (v6 = [objc_msgSend(a4 objectForKeyedSubscript:{@"NoiseReductionAndSharpeningParameters", "objectForKeyedSubscript:", @"StillImage"}]) != 0)
  {
    v7 = v6;
    v10.receiver = self;
...
- (id)noiseReductionAndSharpeningConfigurationForType:(int)a3 gain:(float)a4 qSub:(BOOL)a5
{
  v6 = [(BWNoiseReductionAndSharpeningParameters *)self _noiseReductionAndSharpeningParametersForType:a3 qSub:a5];
  if (!v6)
  {
  ...
  if (v9)
  {
    ...
    v31[3] = *off_1E798B7F0;
    v32[3] = nrasp_interpolateArrayOfValuesForGain([v8 objectForKeyedSubscript:@"LumaProcessingStrength"], a4);
    v31[4] = *off_1E798B7E0;
    v32[4] = nrasp_interpolateArrayOfValuesForGain([v8 objectForKeyedSubscript:@"ChromaProcessingStrength"], a4);
  ...
  else
  {
    ...
    v29[2] = *off_1E798B7F0;
    v30[2] = nrasp_interpolateArrayOfValuesForGain([v8 objectForKeyedSubscript:@"LumaProcessingStrength"], a4);
    v12 = MEMORY[0x1E695DF20];
    v13 = v30;
    v14 = v29;
    v15 = 3;
  ...
  {
    v27[0] = *off_1E798B810;
    v28[0] = nrasp_interpolateValueForGain([v7 objectForKeyedSubscript:@"RawNoiseFilterStrength"], a4);
    v27[1] = *off_1E798B818;
    v28[1] = nrasp_interpolateValueForGain([v7 objectForKeyedSubscript:@"SharpeningControl"], a4);
    v27[2] = *off_1E798B800;
    v18 = nrasp_interpolateValueForGain([v7 objectForKeyedSubscript:@"LocalContrastEnhancementStrength"], a4);
    v27[3] = *off_1E798B808;
    v28[2] = v18;
    v28[3] = v17;
  ...
  {
    v26[0] = nrasp_interpolateValueForGain([v7 objectForKeyedSubscript:{@"RawNoiseFilterStrength", *off_1E798B810}], a4);
    v25[1] = *off_1E798B818;
    v23 = nrasp_interpolateValueForGain([v7 objectForKeyedSubscript:@"SharpeningControl"], a4);
    v25[2] = *off_1E798B808;
    v26[1] = v23;
    v26[2] = v17;
    v19 = MEMORY[0x1E695DF20];
