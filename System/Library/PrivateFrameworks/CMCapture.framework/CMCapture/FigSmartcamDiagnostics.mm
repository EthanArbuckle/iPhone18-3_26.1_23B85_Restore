...
- (BOOL)addClassifierVersionMajor:(unsigned __int16)a3 minor:(unsigned __int16)a4 patch:(unsigned __int16)a5
{
  v6 = [MEMORY[0x1E696AEC0] stringWithFormat:@"%d.%d.%d", a3, a4, a5];
...
- (BOOL)addMotionStats:(id *)a3
{
  ...
  *&v5 = a3->var0[1];
  ...
  v20 = [MEMORY[0x1E696AD98] numberWithInt:a3->var1[0]];
  v25[0] = v20;
  v19 = [MEMORY[0x1E696AD98] numberWithInt:a3->var1[1]];
  v25[1] = v19;
  v18 = [MEMORY[0x1E695DEC8] arrayWithObjects:v25 count:2];
  v28[1] = v18;
  v27[2] = @"frameRingBufferCount";
  v6 = [MEMORY[0x1E696AD98] numberWithInt:a3->var2];
  v28[2] = v6;
  v27[3] = @"frameRingBufferDistance";
  v7 = [MEMORY[0x1E696AD98] numberWithInt:a3->var3];
  v28[3] = v7;
  v27[4] = @"isMotionDetected";
  v8 = [MEMORY[0x1E696AD98] numberWithBool:a3->var5];
  v28[4] = v8;
  v27[5] = @"normalizedROI";
  v9 = [MEMORY[0x1E696AD98] numberWithDouble:a3->var4.origin.x];
  v24[0] = v9;
  v10 = [MEMORY[0x1E696AD98] numberWithDouble:a3->var4.origin.y];
  v24[1] = v10;
  v11 = [MEMORY[0x1E696AD98] numberWithDouble:a3->var4.size.width];
  v24[2] = v11;
  v12 = [MEMORY[0x1E696AD98] numberWithDouble:a3->var4.size.height];
  v24[3] = v12;
  v13 = [MEMORY[0x1E695DEC8] arrayWithObjects:v24 count:4];
  v28[5] = v13;
  v27[6] = @"valid";
  v14 = [MEMORY[0x1E696AD98] numberWithBool:a3->var6];
  v28[6] = v14;
