...
- (id)description;
- (void)_setAEStatistics:(id)statistics;
- (void)_setColorCorrectionMatrix:(id)matrix;
- (void)_setDisplayStrobeRGBEstimate:(id)estimate;
- (void)dealloc;
- (void)initWthPortType:(uint64_t)type storage:;
- (void)reset;
@end
...
- (void)_setAEStatistics:(id)statistics
{
  ...
  if (aeStatistics != statistics)
  {

    self->_aeStatistics = statistics;
  }
}
...
- (void)_setDisplayStrobeRGBEstimate:(id)estimate
{
  ...
  if (displayStrobeRGBEstimate != estimate)
  {

    self->_displayStrobeRGBEstimate = estimate;
  }
}
...
- (void)_setColorCorrectionMatrix:(id)matrix
{
  ...
  if (colorCorrectionMatrix != matrix)
  {

    self->_colorCorrectionMatrix = matrix;
  }
}
