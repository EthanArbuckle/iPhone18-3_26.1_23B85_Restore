...
- (id)publisherFromStartTime:(double)time
{
  ...
  v10 = [computedMode publisherWithOptions:v6];
...
- (id)filterHandler
{
  _filteringPredicate = [(TPSContextualBiomeUserFocusComputedModeEvent *)self _filteringPredicate];
...
- (id)_filteringPredicate
{
  ...
  if (filterInfo)
  {
    ...
    filterInfo2 = [(TPSContextualBiomeEvent *)self filterInfo];
    v6 = [filterInfo2 TPSSafeStringForKey:@"modeIdentifier"];
    ...
    filterInfo3 = [(TPSContextualBiomeEvent *)self filterInfo];
    v10 = [filterInfo3 TPSSafeObjectForKey:@"type"];

    if (v10)
    {
      filterInfo4 = [(TPSContextualBiomeEvent *)self filterInfo];
      v12 = [filterInfo4 TPSSafeIntegerForKey:@"type"];
    ...
    filterInfo5 = [(TPSContextualBiomeEvent *)self filterInfo];
    v15 = [filterInfo5 TPSSafeObjectForKey:@"updateReason"];

    if (v15)
    {
      filterInfo6 = [(TPSContextualBiomeEvent *)self filterInfo];
      v17 = [filterInfo6 TPSSafeUIntegerForKey:@"updateReason"];
    ...
    filterInfo7 = [(TPSContextualBiomeEvent *)self filterInfo];
    v20 = [filterInfo7 TPSSafeObjectForKey:@"updateSource"];

    if (v20)
    {
      filterInfo8 = [(TPSContextualBiomeEvent *)self filterInfo];
      v22 = [filterInfo8 TPSSafeIntegerForKey:@"updateSource"];
    ...
    filterInfo9 = [(TPSContextualBiomeEvent *)self filterInfo];
    v25 = [filterInfo9 TPSSafeObjectForKey:@"isStarting"];

    if (v25)
    {
      filterInfo10 = [(TPSContextualBiomeEvent *)self filterInfo];
      v27 = [filterInfo10 TPSSafeBoolForKey:@"isStarting"];
