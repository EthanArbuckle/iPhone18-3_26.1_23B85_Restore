...
- (AVMetadataDogHeadObject)initWithFigEmbeddedCaptureDeviceObjectDictionary:(id)a3 input:(id)a4 timeStamp:(id)a5 type:(id)a6
{
  ...
  *&v26.value = *MEMORY[0x1E6960C70];
  ...
  v24.receiver = self;
  v24.super_class = AVMetadataDogHeadObject;
...
- (id)description
{
  ...
  v12 = objc_opt_class();
  v13 = [v11 stringWithFormat:@"<%@: %p, objectID=%ld, bounds={%.1f, %.1f %.1fx%.1f}", NSStringFromClass(v12), self, -[AVMetadataDogHeadObject objectID](self, "objectID"), v4, v6, v8, v10];
