...
- (AVMetadataCatHeadObject)initWithObjectID:(int64_t)a3 time:(id *)a4 duration:(id *)a5 bounds:(CGRect)a6;
- (AVMetadataCatHeadObject)initWithObjectID:(int64_t)a3 time:(id *)a4 duration:(id *)a5 bounds:(CGRect)a6 optionalInfoDict:(id)a7 originalMetadataObject:(id)a8 sourceCaptureInput:(id)a9;
- (id)description;
...
+ (id)catHeadObjectWithFigEmbeddedCaptureDeviceObjectDictionary:(id)a3 input:(id)a4 timeStamp:(id)a5
{
  v5 = [objc_alloc(objc_opt_class()) initWithFigEmbeddedCaptureDeviceObjectDictionary:a3 input:a4 timeStamp:a5 type:@"catHead"];
...
- (AVMetadataCatHeadObject)initWithObjectID:(int64_t)a3 time:(id *)a4 duration:(id *)a5 bounds:(CGRect)a6
{
  v8 = *a4;
  v7 = *a5;
  return [(AVMetadataCatHeadObject *)self initWithObjectID:a3 time:&v8 duration:&v7 bounds:0 optionalInfoDict:0 originalMetadataObject:0 sourceCaptureInput:a6.origin.x, a6.origin.y, a6.size.width, a6.size.height];
}
...
- (AVMetadataCatHeadObject)initWithObjectID:(int64_t)a3 time:(id *)a4 duration:(id *)a5 bounds:(CGRect)a6 optionalInfoDict:(id)a7 originalMetadataObject:(id)a8 sourceCaptureInput:(id)a9
{
  ...
  v12 = *a4;
  v11 = *a5;
  result = [(AVMetadataObject *)&v13 initWithType:@"catHead" time:&v12 duration:&v11 bounds:a7 optionalInfoDict:a8 originalMetadataObject:a9 sourceCaptureInput:a6.origin.x, a6.origin.y, a6.size.width, a6.size.height];
  if (result)
  {
    result->_objectID = a3;
  }
...
- (id)initDerivedMetadataObjectFromMetadataObject:(id)a3 withTransform:(CGAffineTransform *)a4 isVideoMirrored:(BOOL)a5 rollAdjustment:(double)a6
{
  ...
  if (AVMetadataObjectAdjustBaseClassProperties(&v19, &v22, v11, v12, v13, v14))
  {
    ...
    return [(AVMetadataObject *)&v17 initWithType:@"catHead" time:&v19 duration:v18 bounds:0 optionalInfoDict:a3 originalMetadataObject:v16 sourceCaptureInput:*&v22.origin, *&v22.size];
  }
