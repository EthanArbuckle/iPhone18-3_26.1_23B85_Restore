...
- (BOOL)listener:(id)a3 shouldAcceptNewConnection:(id)a4
{
  ...
  {
    v14 = sub_264505F28([STSXPCHelperClientEntitlementChecker alloc], v7);
    v17 = v14;
    if (!v14 || (v14[8] & 1) == 0)
    {
  ...
  objc_msgSend_setExportedInterface_(v7, v19, v18);

  if (self)
  {
    objc_msgSend_addObject_(self->_xpcConnections, v20, v7);
  }

  else
  {
    objc_msgSend_addObject_(0, v20, v7);
  }

  objc_msgSend_setExportedObject_(v7, v21, self);
  ...
  objc_msgSend_setInvalidationHandler_(v7, v22, v35);
  ...
  objc_msgSend_setInterruptionHandler_(v7, v23, v32);
  if (self)
  {
  ...
  v25 = workQueue;
  objc_msgSend__setQueue_(v7, v26, v25);
...
- (void)transceive:(id)a3 completion:(id)a4
{
  ...
  if (self && (WeakRetained = objc_loadWeakRetained(&self->_delegate)) != 0)
  {
    v12 = WeakRetained;
    v20 = 0;
    v13 = objc_msgSend_transceiveWithData_outError_(WeakRetained, v11, v6, &v20);
    v14 = v20;
    v9[2](v9, v13, v14);
  }
