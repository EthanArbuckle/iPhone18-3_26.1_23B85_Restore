...
- (void)queue_populateConfiguration:(id)a3
{
  ...
  [v4 setSelection:{self->_selection, v5.receiver, v5.super_class}];
}
...
+ (void)configureClientInterface:(id)a3
{
  ...
  v5 = [v4 hk_setArrayOfClass:objc_opt_class() forSelector:sel_client_deliverConcepts_queryUUID_ argumentIndex:0 ofReply:0];
}
