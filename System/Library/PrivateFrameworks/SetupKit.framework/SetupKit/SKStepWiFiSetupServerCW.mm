    ...
    while (1)
    {
      ...
      switch(runState)
      {
        ...
        case 4:
          ...
          stepError = 0;
LABEL_22:
          [(SKStepWiFiSetupServerCW *)v10 _completeWithError:stepError, v27, v28];
          goto LABEL_46;
        case 11:
          self->_runState = 12;
...
LABEL_42:
        ...
        case 15:
          ...
          wifiChannel = 0;
LABEL_27:
          [(SKStepWiFiSetupServerCW *)v9 _runScanStart:wifiChannel, v27];
          goto LABEL_46;
        case 16:
          if (self->_scanResult)
          {
        ...
        case 17:
          ...
          v6 = 0;
LABEL_29:
          [(SKStepWiFiSetupServerCW *)v7 _runJoinStart:v6, v27];
          goto LABEL_46;
        case 18:
          if (self->_stepDone)
          {
...
- (void)_handleRequestWiFiSetup:(id)a3 responseHandler:(id)a4
{
  ...
  v37 = &v36;
  v38 = 0x3032000000;
  v39 = __Block_byref_object_copy__430;
  v40 = __Block_byref_object_dispose__431;
  v41 = 0;
  v33[0] = MEMORY[0x277D85DD0];
  v33[1] = 3221225472;
  v33[2] = __67__SKStepWiFiSetupServerCW__handleRequestWiFiSetup_responseHandler___block_invoke;
  v33[3] = &unk_279BB8500;
  v35 = &v36;
  v33[4] = self;
  v8 = v7;
  ...
  v10 = [v6 objectForKeyedSubscript:@"_wiEC"];
  wifiEAPConfig = self->_wifiEAPConfig;
  self->_wifiEAPConfig = v10;

  v12 = [v6 objectForKeyedSubscript:@"_wiET"];
...
LABEL_5:
  ...
  (*(v6 + 2))(v6, MEMORY[0x277CBEC10], 0, 0, &__block_literal_global_50);
}
...
LABEL_13:
    (*(v7 + 2))(v7, 0, 0, v11, &__block_literal_global_34);
    goto LABEL_14;
  }
  ...
  (*(v7 + 2))(v7, MEMORY[0x277CBEC10], 0, 0, &__block_literal_global_47);
...
LABEL_11:
  ...
  if (v12)
  {
    ...
    v18[1] = 3221225472;
    v18[2] = __46__SKStepWiFiSetupServerCW__completeWithError___block_invoke;
    v18[3] = &unk_279BB8838;
    v18[4] = self;
    v19 = v4;
...
LABEL_6:
  ...
  *(v7 + 64) = 0;
  ...
  if (v23)
  {
    ...
    v10 = NSErrorF_safe();
    (*(v23 + 2))(v23, 0, 0, v10, &__block_literal_global_496);
  }
...
- (void)_activate
{
  ...
  else
  {
    ...
    v6 = NSErrorF_safe();
    [(SKStepWiFiSetupServerCW *)self _completeWithError:v6];
  }
}
