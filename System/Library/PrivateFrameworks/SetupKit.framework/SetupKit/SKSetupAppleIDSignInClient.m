...
LABEL_19:
    ...
    if (runState)
    {
      ...
      [(SKSetupBase *)self _connectionStartWithSKConnection:0 clientMode:1 completeOnFailure:1 completion:&__block_literal_global_978];
...
- (void)_activate
{
  ...
  v3.receiver = self;
  v3.super_class = SKSetupAppleIDSignInClient;
...
{
  v6.receiver = self;
  v6.super_class = SKSetupAppleIDSignInClient;
