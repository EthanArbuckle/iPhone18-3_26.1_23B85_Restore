...
- (vector<ULMigrationDO,)fetchMigrationEntriesWithStates:(ULMigrationStore *)self limit:(SEL)a3;
@end
...
+ (unsigned)maxEntriesInTable
{
  ...
  {
    v6 = [&unk_286A71A60 unsignedIntValue];
  }
...
- (BOOL)insertDataObjects:(const void *)a3
{
  ...
  v7[1] = &v6;
  v7[3] = v7;
  inserted = ULDBUtils::insertDataObjects<ULMigrationDO,ULMigrationMO>(self, a3, v7);
...
- (vector<ULMigrationDO,)fetchMigrationEntriesWithStates:(ULMigrationStore *)self limit:(SEL)a3
{
  ...
  v15 = [MEMORY[0x277CCAC30] predicateWithFormat:@"%K IN %@", @"state", v11];
  [v10 addObject:v15];

  v16 = [MEMORY[0x277CCAC98] sortDescriptorWithKey:@"timestamp" ascending:0];
  v22[0] = v16;
  v17 = [MEMORY[0x277CBEA60] arrayWithObjects:v22 count:1];
  [(ULMigrationStore *)self _fetchMigrationsByAndPredicates:v10 sortDescriptors:v17 andLimit:a5];
  *&retstr->var0 = v20;
  retstr->var2 = v21;
...
- (id)insertDataObjects:
{
  ...
  v4 = [ULMigrationMO createFromDO:a2 inManagedObjectContext:v3];
