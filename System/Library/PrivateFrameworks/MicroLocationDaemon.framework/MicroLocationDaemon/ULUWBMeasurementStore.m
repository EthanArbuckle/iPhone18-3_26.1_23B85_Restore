@interface ULUWBMeasurementStore
+ (unsigned)maxEntriesInTable;
- (BOOL)deleteOrphanRecords;
@end

@implementation ULUWBMeasurementStore
...
+ (unsigned)maxEntriesInTable
{
  ...
  v4 = [MEMORY[0x277CCACA8] stringWithUTF8String:"ULUWBMeasurementTableMaxRows"];
  ...
  {
    v6 = [&unk_286A71BF8 unsignedIntValue];
  }
