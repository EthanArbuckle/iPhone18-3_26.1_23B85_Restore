...
- (void)addUnlockHandlerWithIdentifier:(id)a3 block:(id)a4
{
  ...
  {
    v8 = [(CNDeviceFirstUnlock *)self workQueue];
...
- (void)withHandlersLock_addHandlerWithIdentifier:(id)a3 block:(id)a4
{
  ...
  else
  {
    ...
    v13 = [(CNDeviceFirstUnlock *)self workQueue];
...
- (void)withHandlersLock_registerForDeviceFirstUnlock
{
  v3 = [(CNDeviceFirstUnlock *)self firstUnlockFuture];
  ...
  if (!v3)
  {
    ...
    v6 = [(CNDeviceFirstUnlock *)self firstUnlockFuture];
...
{
  v7 = a3;
  if (off_1EF440728(&__block_literal_global_122, v7))
  {
...
- (void)waitForAllOperationsToFinish
{
  v2 = [(CNDeviceFirstUnlock *)self workQueue];
...
- (int64_t)countOfUnlockHandlers
{
  ...
  v9 = 0x2020000000;
  v10 = 0;
  v3 = [(CNDeviceFirstUnlock *)self handlersLock];
