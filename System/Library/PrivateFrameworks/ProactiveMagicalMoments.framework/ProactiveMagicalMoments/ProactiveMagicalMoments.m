...
void sub_2263A058C(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, ...)
{
  va_start(va, a7);
...
void sub_2263A0DB4(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, ...)
{
  va_start(va, a13);
  _Block_object_dispose(va, 8);
  _Unwind_Resume(a1);
...
void serverConnectionCallback()
{
  ...
  {
    *v1 = 0;
    _os_log_impl(&dword_22639A000, v0, OS_LOG_TYPE_DEFAULT, "CTService: received notification \n", v1, 2u);
  }
}