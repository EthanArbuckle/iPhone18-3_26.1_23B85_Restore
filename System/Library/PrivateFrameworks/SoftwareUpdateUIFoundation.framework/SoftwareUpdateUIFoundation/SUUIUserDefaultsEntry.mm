...
- (SUUIUserDefaultsEntry)initWithType:(int64_t)type key:(id)key description:(id)description;
...
- (id)initBoolEntryWithKey:(id)key description:(id)description
{
  ...
  v4 = selfCopy;
  selfCopy = 0;
  selfCopy = [(SUUIUserDefaultsEntry *)v4 initWithType:0 key:location[0] description:v8];
  v7 = MEMORY[0x277D82BE0](selfCopy);
...
- (id)initNumberEntryWithKey:(id)key description:(id)description
{
  ...
  v4 = selfCopy;
  selfCopy = 0;
  selfCopy = [(SUUIUserDefaultsEntry *)v4 initWithType:1 key:location[0] description:v8];
  v7 = MEMORY[0x277D82BE0](selfCopy);
  objc_storeStrong(&v8, 0);
  objc_storeStrong(location, 0);
  objc_storeStrong(&selfCopy, 0);
...
- (id)initStringEntryWithKey:(id)key description:(id)description
{
  ...
  v4 = selfCopy;
  selfCopy = 0;
  selfCopy = [(SUUIUserDefaultsEntry *)v4 initWithType:2 key:location[0] description:v8];
  v7 = MEMORY[0x277D82BE0](selfCopy);
  objc_storeStrong(&v8, 0);
  objc_storeStrong(location, 0);
  objc_storeStrong(&selfCopy, 0);
