...
- (_EARExtractedEntity)initWithEntityContent:(id)a3 tagName:(id)a4;
- (int64_t)hash;
@end
...
- (int64_t)hash
{
  ...
  v6 = MEMORY[0x1B8C83C80](*(v4 + OBJC_IVAR____EARExtractedEntity_tagName), *(v4 + OBJC_IVAR____EARExtractedEntity_tagName + 8));
