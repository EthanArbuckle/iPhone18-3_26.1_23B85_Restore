...
- (CDPNavigationTitleLabel)initWithTitle:(id)title;
@end
...
- (CDPNavigationTitleLabel)initWithTitle:(id)title
{
  ...
  if (v5)
  {
    [(CDPNavigationTitleLabel *)v5 setText:titleCopy];
    ...
    v11 = [v7 preferredFontForTextStyle:v8 compatibleWithTraitCollection:traitCollection];
