...
+ (_LXLexicon)_createLexiconForLocale:(id)a3
{
  ...
  v3 = a3;
  v7 = objc_msgSend_localeIdentifier(v3, v4, v5, v6, 0, *MEMORY[0x1E69ABFE8]);
  v14[0] = v7;
...
+ (id)decodingLexiconForLocale:(id)a3
{
  v3 = a3;
  v4 = objc_opt_class();
  LexiconForLocale = objc_msgSend__createLexiconForLocale_(v4, v5, v3, v6);
  if (LexiconForLocale)
  {
...
+ (id)decodingLexiconForLocale:(id)a3 priority:(unint64_t)a4
{
  v5 = a3;
  v6 = objc_opt_class();
  LexiconForLocale = objc_msgSend__createLexiconForLocale_(v6, v7, v5, v8);
  if (LexiconForLocale)
  {
    v10 = [CVNLPDecodingLexicon alloc];
    v12 = objc_msgSend_initWithLexicon_priority_(v10, v11, LexiconForLocale, a4);
    CFRelease(LexiconForLocale);
  }
