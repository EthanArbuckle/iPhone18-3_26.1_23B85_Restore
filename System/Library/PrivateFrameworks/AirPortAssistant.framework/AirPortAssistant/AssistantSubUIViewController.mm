...
- (AssistantSubUIViewController)initWithNibName:(id)name bundle:(id)bundle
{
  ...
  v8 = [(AUUITableViewController *)&v10 initWithNibName:name bundle:bundle];
  if (v8)
  {
...
- (void)setLeftNavigationButton:(id)button enable:(BOOL)enable hide:(BOOL)hide
{
  ...
  else if (objc_msgSend_isEqualToString_(button, v7, @"kCancel"))
  {
...
{
  enableCopy = enable;
  if (objc_msgSend_isEqualToString_(button, a2, @"kNext"))
  {
    if (hide)
    {
      v10 = 0;
    ...
    else
    {
      ...
      objc_msgSend_setEnabled_(v10, v17, enableCopy);
    }
...
- (id)getProductLocalizedStringWithFormat:(id)format
{
  v5 = objc_msgSend_inParamDict(self, a2, format);

  return objc_msgSend_getProductLocalizedStringWithFormat_fromParamDict_(StepByStepUtilities, v4, format, v5);
}
...
+ (id)labelViewInContainer:(id *)container width:(double)width constrain:(BOOL)constrain
{
  ...
  v11 = objc_msgSend_initWithFrame_(v8, v9, v10, 0.0, 0.0, width, 50.0);
  v12 = v11;
  if (container)
  {
    *container = v11;
  ...
  v16 = objc_msgSend_initWithFrame_(v13, v14, v15, 0.0, 0.0, width, 50.0);
...
+ (id)labelViewInContainer:(id *)container width:(double)width withSpinner:(id *)spinner above:(BOOL)above
{
  aboveCopy = above;
  v48 = 0;
  v9 = objc_msgSend_labelViewInContainer_width_constrain_(AssistantSubUIViewController, a2, &v48, 0, width);
...
{
  v4 = [UITopoView alloc];
  v7 = objc_msgSend_initWithFrame_(v4, v5, v6, 0.0, 0.0, width, 140.0);
...
+ (id)containerViewWithWidth:(double)width
{
  ...
  v7 = objc_msgSend_initWithFrame_(v4, v5, v6, 0.0, 0.0, width, 20.0);
...
+ (id)tableViewWithWidth:(double)width height:(double)height
{
  ...
  v8 = objc_msgSend_initWithFrame_style_(v6, v7, 1, 0.0, 0.0, width, height);
