  ...
  if (v5 > 4002)
  {
    switch(v5)
    {
      ...
      case 4004:
        ...
        v41 = objc_msgSend_textField(a3, v39, v40);
  ...
  else
  {
    switch(v5)
    {
      ...
      case 4001:
        ...
        v30 = objc_msgSend_textField(a3, v28, v29);
...
- (int)callbackAskUserForUncertifiedForController:(id)a3
{
  if (objc_msgSend_uiAlert(self, a2, a3))
  {
    return -6721;
  }
  ...
  objc_msgSend_setContext_(self->uiAlert, v19, a3);
...
LABEL_9:
    ...
    valid = objc_msgSend_stringWithValidatedFormat_validFormatSpecifiers_error_(v11, v13, v12, @"%@", 0, a4);
    ...
    objc_msgSend_setContext_(self->uiAlert, v26, a5);
...
- (int)callbackAskUserForSetupCode:(int)a3 isRetry:(BOOL)a4 forController:(id)a5
{
  ...
  objc_msgSend_setContext_(self->uiAlert, v22, a5);
...
- (int)callbackAskUserAQuestion:(int)a3 paramDict:(id)a4 forController:(id)a5
{
  ...
  if (a3 == 5)
  {
    if (a4)
    {
      v47 = objc_msgSend_objectForKey_(a4, a2, @"kAssistantCallbackAskUserParamKey_MessageKey");
      v48 = sub_23EB6CD3C(v47, qword_27E383800);
      v50 = objc_msgSend_objectForKey_(a4, v49, @"kAssistantCallbackAskUserParamKey_OKKey");
      v51 = sub_23EB6CD3C(v50, qword_27E383800);
      v53 = objc_msgSend_objectForKey_(a4, v52, @"kAssistantCallbackAskUserParamKey_CancelKey");
      ...
      objc_msgSend_setContext_(self->uiAlert, v64, a5);
  ...
  else
  {
    if (a3 != 4)
    {
      if (a3 == 3)
      {
        objc_msgSend_callbackAskUserAQuestionResult_result_(a5, a2, *&a3, 0);
      }
    ...
    if (a4)
    {
      v9 = objc_msgSend_objectForKey_(a4, a2, @"kAssistantCallbackAskUserParamKey_Warning_MessageKey");
      v11 = objc_msgSend_objectForKey_(a4, v10, @"kAssistantCallbackAskUserParamKey_Warning_MessageParam1");
      v13 = objc_msgSend_objectForKey_(a4, v12, @"kAssistantCallbackAskUserParamKey_Warning_MessageParam2");
      ...
      v19 = objc_msgSend_objectForKey_(a4, v18, @"kAssistantCallbackAskUserParamKey_Warning_PromptKey");
      v21 = objc_msgSend_objectForKey_(a4, v20, @"kAssistantCallbackAskUserParamKey_Warning_PromptParam1");
      v23 = objc_msgSend_objectForKey_(a4, v22, @"kAssistantCallbackAskUserParamKey_Warning_PromptParam2");
      ...
      v29 = objc_msgSend_objectForKey_(a4, v28, @"kAssistantCallbackAskUserParamKey_OKKey");
      if (!v29)
      {
        v29 = @"kOK";
      }
      ...
      v32 = objc_msgSend_objectForKey_(a4, v31, @"kAssistantCallbackAskUserParamKey_CancelKey");
      if (v32)
      {
      ...
      objc_msgSend_setContext_(self->uiAlert, v43, a5);
...
- (void)showUIConfigPromptForGuestNetConfigWithParamDict:(id)a3
{
  ...
  if (v5)
  {
    ...
    v9 = objc_msgSend_objectForKey_(a3, v6, @"kBSConfigurationUIConfig_TargetBaseKey");
    v11 = objc_msgSend_objectForKey_(a3, v10, @"kBSConfigurationUIConfig_BaseNameKey");
    v13 = objc_msgSend_objectForKey_(a3, v12, @"kBSConfigurationUIConfig_NetworkameKey");
...
- (void)showAskUserSwapCablingForStatus:(int)a3 paramDict:(id)a4
{
  if (a3 == -6771)
  {
    v5 = objc_msgSend_currentSubController(self, a2, *&a3, a4);
  ...
  else
  {
    ...
    v12 = objc_msgSend_objectForKey_(a4, v11, @"kBSConfigurationSwapCabling_TargetBase");
    if (v12)
    {
      v14 = v12;
      v15 = objc_msgSend_objectForKey_(a4, v13, @"kBSConfigurationSwapCabling_SourceBase");
      if (v15)
      {
        v17 = v15;
...
- (void)handleNextButton:(id)a3
{
  v4 = objc_msgSend_state(self->_assistantUIController, a2, a3);
  if (v4 > 5)
  {
    if (v4 == 7)
    {
...
{
  self->_goingBack = 0;
  if (objc_msgSend_currentSubController(self, a2, a3, a4, a5) && objc_msgSend_currentSubController(self, v8, v9) != a4)
  {
    v14 = objc_msgSend_viewControllers(a3, v8, v9);
    v17 = objc_msgSend_currentSubController(self, v15, v16);
...
- (void)touchInCellAtIndexPath:(id)a3
{
  v4 = objc_msgSend_section(a3, a2, a3);
...
- (void)assistantUpdateProgress:(id)a3 forState:(int)a4
{
  if (a4 > 4)
  {
    if (a4 != 5)
    {
      ...
      if (objc_msgSend_settingUpStatusText(self, a2, a3))
      {
        justTextLabel = self->justTextLabel;
        justTextContainerView = self->justTextContainerView;
        v13 = objc_msgSend_settingUpStatusText(self, a2, a3);
  ...
  if ((a4 - 3) < 2)
  {
    if (objc_msgSend_length(a3, a2, a3))
    {
      ...
      if (objc_opt_respondsToSelector())
      {
        ...
        MEMORY[0x2821F9670](v10, sel_stepByStepUpdateProgress_forState_, a3);
      }
    }
...
LABEL_14:
  sub_23EB5E054(self->spinnerWithStatusBelowLabel, self->spinnerWithStatusBelowView, a3);
...
- (void)presentUIForRecommmendationTargetInfo:(id)a3
{
  ...
  v9 = objc_msgSend_objectForKey_(a3, a2, @"kRecommendationTargetInfoKey_ProductID");
  v11 = objc_msgSend_objectForKey_(a3, v10, @"kRecommendationTargetInfoKey_DeviceKind");
  ...
  {
    v17 = objc_msgSend_objectForKey_(a3, v14, @"kRecommendationTargetInfoKey_BaseName");
  }
...
- (void)presentUIForRecommendationResult:(int)a3 paramDict:(id)a4
{
  ...
  {
    self->_goingBack = 0;
    v7 = objc_msgSend_navigationController(self, a2, *&a3);
    ...
    if (a4)
    {
      if (v20 == self)
      {
        objc_msgSend_setRecommendationParamDict_(self, v21, a4);
        v23 = objc_msgSend_objectForKey_(a4, v22, @"promptString");
        if (v23)
        {
          v26 = v23;
...
- (void)presentUIForStepByStepNextStep:(int)a3 paramDict:(id)a4
{
  ...
  if (self->_goingBack)
  {
    v11 = objc_msgSend_navigationController(self, a2, *&a3);
...
LABEL_24:
  ...
  else
  {
    ...
    objc_msgSend_setInParamDict_(v19, v21, a4);
...
- (id)modifyTopoUIInLayer:(id)a3 withLayout:(id)a4 newLayout:(id)a5
{
  v6 = objc_msgSend_topoDevicesDescriptor(a5, a2, a3);
  ...
  return objc_msgSend_modifyTopoUIInLayer_withLayout_andOwningView_targetProductID_targetDeviceKind_targetName_targetWiFiName_sourceProductID_sourceDeviceKind_sourceName_sourceWiFiName_connectionType_(assistantUIController, v41, a3, a4, v40, v14, v16, v20, v18, v23, v25, v29, v27, v37);
}

- (void)connectionVerificationSucceededForSelector:(int)a3
{
  v4 = objc_msgSend_uiAlert(self, a2, *&a3);
...
- (void)presentUIForSetupStatusWithRecommendationDict:(id)a3
{
  v5 = objc_msgSend_objectForKey_(a3, a2, @"BSAutoGuess_Recommendation");
  if (!v5)
  {
    return;
  }
  ...
  v7 = v5;
  v8 = objc_msgSend_objectForKey_(a3, v6, @"BSAutoGuess_UnconfiguredBase");
  v10 = objc_msgSend_objectForKey_(a3, v9, @"BSAutoGuess_UnconfiguredNetwork");
  if (v8)
  {
  ...
  if ((objc_msgSend_isEqualToString_(v7, v42, @"BSSetupRecommend_OfferExtendWirelessly") & 1) == 0 && !objc_msgSend_isEqualToString_(v7, v43, @"BSSetupRecommend_AskUserChooseBaseWireless"))
  {
    ...
    {
      v60 = objc_msgSend_objectForKey_(a3, v59, @"BSAutoGuess_SourceBase");
      if (v60)
      {
LABEL_18:
    ...
    else
    {
      ...
      if ((objc_msgSend_isEqualToString_(v7, v108, @"BSSetupRecommend_OfferJoinNetwork") & 1) != 0 || objc_msgSend_isEqualToString_(v7, v112, @"BSSetupRecommend_AskUserChooseNetworkToJoin"))
      {
        ...
        if (!v116)
        {
          v116 = objc_msgSend_objectForKey_(a3, v117, @"BSAutoGuess_SourceNetwork");
          if (!v116)
          {
            return;
          }
      ...
      v60 = objc_msgSend_objectForKey_(a3, v118, @"BSAutoGuess_SourceBase");
    }
  ...
  v44 = objc_msgSend_objectForKey_(a3, v43, @"BSAutoGuess_SourceBase");
  if (!v44)
  {
...
LABEL_11:
  ...
  if (a3)
  {
    ...
    {
      sub_23EB5E054(self->justTextLabel, self->justTextContainerView, a5);
  ...
  v12 = objc_msgSend_objectForKey_(a4, v10, @"kSetupBaseStationInfoKey_RecommendationInfo");
  ...
  if (objc_msgSend_isEqualToString_(v14, v15, @"BSSetupRecommend_OfferReplaceSourceIsUnconfigurable"))
  {
    ...
    a5 = objc_msgSend_stringWithValidatedFormat_validFormatSpecifiers_error_(MEMORY[0x277CCACA8], v39, v164, @"%@%@", 0, a5, valid);
    a4 = v165;
  }
  ...
  v56 = objc_msgSend_objectForKey_(a4, v55, @"kSetupBaseStationInfoKey_BrowseRecord");
  ...
  if (((v59 | v60) & 1) == 0)
  {
    v68 = objc_msgSend_objectForKey_(a4, v61, @"kSetupBaseStationInfoKey_MFiAccessoryResponse");
  ...
  v122 = objc_msgSend_objectForKey_(a4, v121, @"kSetupBaseStationInfoKey_GeneralInfo");
  ...
  v130 = objc_msgSend_objectForKey_(a4, v125, @"kSetupBaseStationInfoKey_RadioInfo");
  ...
  if (objc_msgSend_objectForKey_(v130, v132, v131))
  {
    ...
    v137 = objc_msgSend_objectForKey_(a4, v136, @"kSetupBaseStationInfoKey_RadioInfo");
...
LABEL_11:
  v7 = objc_msgSend_setupOptions(self->_assistantUIController, a2, a3, a4);
...
- (void)replaceSubviewsInView:(id)a3 newSubviews:(id)a4 withAnimation:(BOOL)a5
{
  ...
  v7 = objc_msgSend_count(a4, a2, a3);
  v75 = 0u;
  v76 = 0u;
  v77 = 0u;
  v78 = 0u;
  v10 = objc_msgSend_subviews(a3, v8, v9);
  ...
  if (v7)
  {
    ...
    objc_msgSend_addSubview_(a3, v21, Object);
    ...
    if ((v7 - 1) >= 2)
    {
      ...
      do
      {
        Object = objc_msgSend_objectAtIndex_(v5, v13, v39);
        objc_msgSend_addSubview_(a3, v41, Object);
        v42 = v5;
        ...
        objc_msgSend_addConstraints_(a3, v47, v46);
        ...
        objc_msgSend_addConstraints_(a3, v53, v52);
    ...
    {
LABEL_15:
      v57 = objc_msgSend_lastObject(v5, v13, v14);
      objc_msgSend_addSubview_(a3, v58, v57);
      ...
      objc_msgSend_addConstraints_(a3, v63, v62);
      ...
      objc_msgSend_addConstraints_(a3, v68, v67);
      objc_msgSend_systemLayoutSizeFittingSize_(v57, v69, v70, v32, v33);
    }
  }

  objc_msgSend_frame(a3, v13, v14);
  objc_msgSend_setFrame_(a3, v71, v72);
  objc_msgSend_setNeedsLayout(a3, v73, v74);
}
...
{
  v3 = a3;
  v5 = objc_msgSend_navigationController(self, a2, a3);
  v8 = v5;
  if (v3)
  {
...
{
  v4 = a4;
  v6 = objc_msgSend_navigationController(self, a2, a3);

  objc_msgSend_pushViewController_animated_(v6, v7, a3, v4);
}
...
- (void)setupCompleteShowPasswords:(BOOL)a3
{
  ...
  {
LABEL_13:
    v49 = objc_msgSend_tableManager(self, a2, a3);
...
- (id)radioNameFromBaseStation:(id)a3
{
  if (a3)
  {
    return objc_msgSend_objectForKey_(a3, a2, @"raNm");
  }
