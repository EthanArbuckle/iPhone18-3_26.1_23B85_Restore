...
- (AXPhoenixAnalyticsEvent)initWithEventType:(int64_t)a3 eventInfo:(id)a4
{
  ...
  {
    v11->_eventType = v9;
    objc_storeStrong(&v11->_eventInfo, location);
  }
...
- (id)description
{
  ...
  v4 = [(AXPhoenixAnalyticsEvent *)self _jsonData];
...
- (id)_jsonData
{
  ...
  if ([MEMORY[0x277CCAAA0] isValidJSONObject:self->_eventInfo])
  {
    ...
    if (v10)
    {
      ...
      {
        __os_log_helper_16_2_3_8_32_8_64_8_64(v15, "[AXPhoenixAnalyticsEvent _jsonData]", v13->_eventInfo, v10);
  ...
  else
  {
    ...
    {
      __os_log_helper_16_2_2_8_32_8_64(v16, "[AXPhoenixAnalyticsEvent _jsonData]", v13->_eventInfo);
