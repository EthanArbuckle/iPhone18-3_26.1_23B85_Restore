    ...
    *(&v183 + 1) = v57;
    ...
    if (v200 == v73)
    {
      if (v73)
      {
        ...
        do
        {
          v182[0] = sub_100140050(*v75);
          v182[1] = v77;
          v78 = sub_100140050(*v72);
          v181[0] = v78;
          v181[1] = v79;
          if (v182[0])
          {
...
uint64_t mlir::ODIE::Compiler::CoreML::GraphOp::readProperties(uint64_t a1, uint64_t **a2)
{
  ...
  if (!sub_1001E1040(a1, a2[32]) || !sub_1001E14EC(a1, v4 + 1) || (sub_1001E1998(a1, v4 + 2) & 1) == 0 || !sub_1001E14EC(a1, v4 + 3))
  {
    return 0;
  }
  ...
  {
    return sub_10010FB18(a1, v4 + 7) & 1;
  }
...
uint64_t sub_1001E1998(uint64_t a1, uint64_t *a2)
{
  v31 = 0;
  if (((*(*a1 + 48))(a1, &v31) & 1) == 0)
  {
...
BOOL mlir::ODIE::Compiler::CoreML::IsolatedGroupOp::verify(mlir::Operation **this)
{
  ...
  if ((*(Terminator + 46) & 0x80) != 0)
  {
    ...
    if (sub_1001E0940(Context, v132, v128, v129))
    {
      goto LABEL_14;
    }
  }
...
BOOL mlir::ODIE::Compiler::CoreML::DelegateOp::readProperties(uint64_t a1, uint64_t a2)
{
  ...
  result = 0;
  if ((sub_10010FB18(a1, v3 + 1) & 1) != 0 && sub_1001E4948(a1, v3 + 3))
  {
    mlir::ODIE::Compiler::CoreML::CoreMLDialectVersion::get(a1, v5);
    if (v5[1] < 4uLL || sub_1001E1040(a1, v3) && sub_1001E1040(a1, v3 + 2))
    {
...
BOOL sub_1001E4948(uint64_t a1, void *a2)
{
  v31 = 0;
  if (((*(*a1 + 48))(a1, &v31) & 1) == 0)
  {
...
void sub_1001E602C(uint64_t a1, const void *a2, uint64_t a3)
{
  *(a1 + 192) = 0;
  v5 = *(a1 + 120);
  v6 = a3 + v5;
