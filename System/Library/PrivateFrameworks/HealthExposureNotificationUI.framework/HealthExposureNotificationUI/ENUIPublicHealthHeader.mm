...
- (_TtC28HealthExposureNotificationUI22ENUIPublicHealthHeader)initWithTitle:(id)a3 subtitle:(id)a4 backgroundColor:(id)a5 textColor:(id)a6 logoURL:(id)a7 style:(int64_t)a8
{
  ...
  *v26 = v20;
  v26[1] = v22;
  *(self + OBJC_IVAR____TtC28HealthExposureNotificationUI22ENUIPublicHealthHeader_backgroundColor) = a5;
  *(self + OBJC_IVAR____TtC28HealthExposureNotificationUI22ENUIPublicHealthHeader_textColor) = a6;
  sub_25169479C(v16, self + OBJC_IVAR____TtC28HealthExposureNotificationUI22ENUIPublicHealthHeader_logoURL);
  *(self + OBJC_IVAR____TtC28HealthExposureNotificationUI22ENUIPublicHealthHeader_style) = a8;
