@interface AVAudioPCMBuffer(NameRecognition)
- (id)recordingMagnitudesWithLevelMultiplier:()NameRecognition count:;
@end

@implementation AVAudioPCMBuffer(NameRecognition)
...
- (id)recordingMagnitudesWithLevelMultiplier:()NameRecognition count:
{
  ...
  MEMORY[0x25F85AD00](*[self floatChannelData], 1, v11, 1, v10, 1, v9);
  ...
  MEMORY[0x25F85AD10](v12, 1, &kAdjust0DB, v12, 1, v7 >> 1);
  __B = 1.0;
