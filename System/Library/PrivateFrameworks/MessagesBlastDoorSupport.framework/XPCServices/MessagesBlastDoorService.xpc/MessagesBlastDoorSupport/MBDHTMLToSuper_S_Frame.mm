...
{
  v14.receiver = self;
  v14.super_class = MBDHTMLToSuper_S_Frame;
  contextCopy = context;
  ...
  [contextCopy pushTextStrikethroughAttribute];
}

- (void)parser:(id)parser context:(id)context didEndElement:(id)element namespaceURI:(id)i qualifiedName:(id)name
{
  v12.receiver = self;
  v12.super_class = MBDHTMLToSuper_S_Frame;
  contextCopy = context;
  [(MBDToSuperParserFrame *)&v12 parser:parser context:contextCopy didEndElement:element namespaceURI:i qualifiedName:name];
  [contextCopy popTextStrikethroughAttribute];
}
