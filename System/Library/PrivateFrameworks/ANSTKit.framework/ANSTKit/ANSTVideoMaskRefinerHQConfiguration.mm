...
@implementation ANSTVideoMaskRefinerHQConfiguration
...
- (id)description
{
  ...
  v9 = objc_msgSend_version(self, v7, v8);
  v11 = ANSTVideoMaskRefinerHQVersionToNSString(v9, v10);
  objc_msgSend_appendFormat_(v3, v12, @"  version %@\n", v11);

  v15 = objc_msgSend_networkResolution(self, v13, v14);
  v16 = ANSTVideoMaskRefinerHQResolutionToNSString(v15);
