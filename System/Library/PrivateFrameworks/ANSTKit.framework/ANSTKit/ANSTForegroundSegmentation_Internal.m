...
- (ANSTForegroundSegmentation_Internal)initWithConfiguration:(id)a3
{
  ...
  v6 = [(ANSTForegroundSegmentation *)&v14 initWithConfiguration:v5];
  v7 = v6;
  if (v6)
  {
...
- (BOOL)prepareWithError:(id *)a3
{
  ...
  if (a3)
  {
    ...
    *a3 = objc_msgSend_errorWithDomain_code_userInfo_(v6, v8, @"ANSTErrorDomain", 1, v7);
  }
...
- (id)resultForPixelBuffer:(__CVBuffer *)resizedInputBuffer error:(id *)a4
{
  ...
  if (!self->_readyForInference)
  {
    ...
    if (a4)
    {
      ...
      *a4 = objc_msgSend_errorWithDomain_code_userInfo_(v25, v27, @"ANSTErrorDomain", 4, v26);
    }
  ...
  if (!resizedInputBuffer)
  {
    ...
    if (a4)
    {
      ...
      *a4 = objc_msgSend_errorWithDomain_code_userInfo_(v29, v31, @"ANSTErrorDomain", 2, v30);
    }
  ...
  if (Width != objc_msgSend_networkInputBufferWidth(self, v10, v11) || (Height = CVPixelBufferGetHeight(resizedInputBuffer), Height != objc_msgSend_networkInputBufferHeight(self, v13, v14)) || (PixelFormatType = CVPixelBufferGetPixelFormatType(resizedInputBuffer), PixelFormatType != objc_msgSend_networkInputBufferPixelFormat(self, v16, v17)))
  {
    if (VTPixelTransferSessionTransferImage(self->_pixelTransferSession, resizedInputBuffer, self->_resizedInputBuffer))
    {
      ...
      if (a4)
      {
        ...
        *a4 = objc_msgSend_errorWithDomain_code_userInfo_(v20, v22, @"ANSTErrorDomain", 4, v21);
      }
  ...
  if (!frameCount)
  {
    if ((objc_msgSend_runInitializerModel_(self->_vmtrackerNetworkEspresso, v18, resizedInputBuffer) & 1) == 0)
    {
      ...
      if (a4)
      {
        ...
        *a4 = objc_msgSend_errorWithDomain_code_userInfo_(v47, v49, @"ANSTErrorDomain", 4, v48);
      }
...
LABEL_35:
    ...
    if (a4)
    {
      ...
      *a4 = objc_msgSend_errorWithDomain_code_userInfo_(v36, v38, @"ANSTErrorDomain", 4, v37);
    }
