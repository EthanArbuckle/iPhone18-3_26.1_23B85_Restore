...
- (ANSTPersonInstanceSegmentationConfiguration)initWithVersion:(unint64_t)version;
- (ANSTPersonInstanceSegmentationConfiguration)initWithVersion:(unint64_t)version networkResolution:(int64_t)resolution;
