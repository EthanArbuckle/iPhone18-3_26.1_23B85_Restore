...
- (id)description
{
  ...
  v8.receiver = self;
  v8.super_class = BCSChatSuggestShardItem;
  v4 = [(BCSChatSuggestShardItem *)&v8 description];
  dictionaryRepresentation = [(BCSChatSuggestShardItem *)self dictionaryRepresentation];
...
LABEL_5:
  ...
  {
    v6 = fromCopy;
    [(BCSChatSuggestShardItem *)self setFilter:?];
    fromCopy = v6;
  }
}
