...
LABEL_38:
      ...
      else if (v14 == 2)
      {
        ...
        v27[0] = 0;
        v27[1] = 0;
        if (!PBReaderPlaceMark() || !BCSBusinessLinkMessageReadFrom(v17, a3))
        {
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v6 = [(NSString *)self->_orgId copyWithZone:a3];
  v7 = *(v5 + 24);
  *(v5 + 24) = v6;

  v8 = [(BCSBusinessLinkMessage *)self->_message copyWithZone:a3];
  v9 = *(v5 + 16);
  *(v5 + 16) = v8;
