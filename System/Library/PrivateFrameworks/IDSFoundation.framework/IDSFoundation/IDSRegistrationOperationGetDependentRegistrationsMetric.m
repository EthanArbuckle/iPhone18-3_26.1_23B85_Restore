...
- (NSDictionary)dictionaryRepresentation
{
  ...
  v4 = [(IDSRegistrationOperationGetDependentRegistrationsMetric *)self guid];
  if (v4)
  {
  ...
  v9 = [(IDSRegistrationOperationGetDependentRegistrationsMetric *)self genericError];
  if (v9)
  {
    CFDictionarySetValue(v3, @"genericError", v9);
  }

  v10 = [(IDSRegistrationOperationGetDependentRegistrationsMetric *)self URLError];
  if (v10)
  {
    CFDictionarySetValue(v3, @"URLError", v10);
  }

  v11 = [(IDSRegistrationOperationGetDependentRegistrationsMetric *)self POSIXError];
  if (v11)
  {
