...
- (NSDictionary)dictionaryRepresentation
{
  ...
  v4 = [(IDSRegistrationProfileHandleOperationLinkHandlesMetric *)self guid];
  if (v4)
  {
  ...
  v10 = [(IDSRegistrationProfileHandleOperationLinkHandlesMetric *)self genericError];
  if (v10)
  {
    CFDictionarySetValue(v3, @"genericError", v10);
  }

  v11 = [(IDSRegistrationProfileHandleOperationLinkHandlesMetric *)self URLError];
  if (v11)
  {
    CFDictionarySetValue(v3, @"URLError", v11);
  }

  v12 = [(IDSRegistrationProfileHandleOperationLinkHandlesMetric *)self POSIXError];
  if (v12)
  {
