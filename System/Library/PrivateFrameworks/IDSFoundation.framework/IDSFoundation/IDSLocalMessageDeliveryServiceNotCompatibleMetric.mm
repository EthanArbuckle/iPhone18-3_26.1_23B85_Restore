...
- (IDSLocalMessageDeliveryServiceNotCompatibleMetric)initWithService:(id)service isToDefaultPairedDevice:(BOOL)device messageSize:(unint64_t)size linkType:(unint64_t)type deliveryError:(unint64_t)error RTT:(unint64_t)t priority:(unint64_t)priority;
...
- (NSDictionary)dictionaryRepresentation
{
  ...
  service = [(IDSLocalMessageDeliveryServiceNotCompatibleMetric *)self service];
  if (service)
  {
