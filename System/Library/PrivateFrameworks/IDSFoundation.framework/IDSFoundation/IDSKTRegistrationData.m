...
- (IDSKTRegistrationData)initWithDataRepresentation:(id)a3 error:(id *)a4
{
  ...
  v6 = a3;
  v32 = 0;
  v7 = [MEMORY[0x1E696AE40] propertyListWithData:v6 options:0 format:0 error:&v32];
  v8 = v32;
...
- (id)dataRepresentationWithError:(id *)a3
{
  ...
  v17 = [MEMORY[0x1E696AE40] dataWithPropertyList:v6 format:200 options:0 error:a3];
  v18 = v17;
  if (v17)
  {
    v19 = v17;
...
- (void)encodeWithCoder:(id)a3
{
  ktDataForRegistration = self->_ktDataForRegistration;
  v5 = a3;
  [v5 encodeObject:ktDataForRegistration forKey:@"kKTDataForReg"];
  [v5 encodeObject:self->_ktPublicAccountKey forKey:@"kKTDataPubKeyForReg"];
  [v5 encodeObject:self->_ktDataSignature forKey:@"kKTDataSigForReg"];
  [v5 encodeBool:self->_uploadedToKVS forKey:@"kKTDataKVSUploaded"];
  [v5 encodeObject:self->_registeredTime forKey:@"kKTDataRegTime"];
  [v5 encodeObject:self->_ktAccountKeyTimestamp forKey:@"kKTDataAccountKeyTimestamp"];
  [v5 encodeObject:self->_ktOptInTimestamp forKey:@"kKTDataOptInTimestamp"];
  [v5 encodeInteger:self->_ktOptInStatus forKey:@"kKTDataOptInStatus"];
  [v5 encodeObject:self->_ktOptInErrorCode forKey:@"kKTDataOptInErrorCode"];
  [v5 encodeObject:self->_ktAccountKeyErrorCode forKey:@"kKTDataAccountKeyErrorCode"];
}
...
- (IDSKTRegistrationData)initWithCoder:(id)a3
{
  ...
  if (v5)
  {
    v6 = [v4 decodeObjectOfClass:objc_opt_class() forKey:@"kKTDataForReg"];
    ktDataForRegistration = v5->_ktDataForRegistration;
    v5->_ktDataForRegistration = v6;

    v8 = [v4 decodeObjectOfClass:objc_opt_class() forKey:@"kKTDataPubKeyForReg"];
    ktPublicAccountKey = v5->_ktPublicAccountKey;
    v5->_ktPublicAccountKey = v8;

    v10 = [v4 decodeObjectOfClass:objc_opt_class() forKey:@"kKTDataSigForReg"];
    ktDataSignature = v5->_ktDataSignature;
    v5->_ktDataSignature = v10;

    v5->_uploadedToKVS = [v4 decodeBoolForKey:@"kKTDataKVSUploaded"];
    v12 = [v4 decodeObjectOfClass:objc_opt_class() forKey:@"kKTDataRegTime"];
    registeredTime = v5->_registeredTime;
    v5->_registeredTime = v12;

    v14 = [v4 decodeObjectOfClass:objc_opt_class() forKey:@"kKTDataAccountKeyTimestamp"];
    ktAccountKeyTimestamp = v5->_ktAccountKeyTimestamp;
    v5->_ktAccountKeyTimestamp = v14;

    v16 = [v4 decodeObjectOfClass:objc_opt_class() forKey:@"kKTDataOptInTimestamp"];
    ktOptInTimestamp = v5->_ktOptInTimestamp;
    v5->_ktOptInTimestamp = v16;

    v5->_ktOptInStatus = [v4 decodeIntegerForKey:@"kKTDataOptInStatus"];
    v18 = [v4 decodeObjectOfClass:objc_opt_class() forKey:@"kKTDataOptInErrorCode"];
    ktOptInErrorCode = v5->_ktOptInErrorCode;
    v5->_ktOptInErrorCode = v18;

    v20 = [v4 decodeObjectOfClass:objc_opt_class() forKey:@"kKTDataAccountKeyErrorCode"];
