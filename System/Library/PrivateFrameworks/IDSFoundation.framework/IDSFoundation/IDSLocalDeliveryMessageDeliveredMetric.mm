...
- (NSDictionary)dictionaryRepresentation
{
  ...
  v6 = [MEMORY[0x1E696AD98] numberWithUnsignedLongLong:{-[IDSLocalDeliveryMessageDeliveredMetric messageSize](self, "messageSize")}];
  if (v6)
  {
    CFDictionarySetValue(v3, @"messageSize", v6);
  }

  v7 = [MEMORY[0x1E696AD98] numberWithUnsignedLongLong:{-[IDSLocalDeliveryMessageDeliveredMetric linkType](self, "linkType")}];
  if (v7)
  {
    CFDictionarySetValue(v3, @"linkType", v7);
  }

  v8 = [MEMORY[0x1E696AD98] numberWithUnsignedLongLong:{-[IDSLocalDeliveryMessageDeliveredMetric deliveryError](self, "deliveryError")}];
  if (v8)
  {
    CFDictionarySetValue(v3, @"deliveryError", v8);
  }

  v9 = [MEMORY[0x1E696AD98] numberWithUnsignedLongLong:{-[IDSLocalDeliveryMessageDeliveredMetric RTT](self, "RTT")}];
  if (v9)
  {
    CFDictionarySetValue(v3, @"RTT", v9);
  }

  v10 = [MEMORY[0x1E696AD98] numberWithUnsignedLongLong:{-[IDSLocalDeliveryMessageDeliveredMetric priority](self, "priority")}];
  if (v10)
  {
