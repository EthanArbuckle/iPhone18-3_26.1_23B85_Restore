...
- (NSDictionary)dictionaryRepresentation
{
  ...
  v4 = [(IDSRegistrationOperationGetHandlesMetric *)self guid];
  if (v4)
  {
  ...
  v9 = [(IDSRegistrationOperationGetHandlesMetric *)self genericError];
  if (v9)
  {
    CFDictionarySetValue(v3, @"genericError", v9);
  }

  v10 = [(IDSRegistrationOperationGetHandlesMetric *)self URLError];
  if (v10)
  {
    CFDictionarySetValue(v3, @"URLError", v10);
  }

  v11 = [(IDSRegistrationOperationGetHandlesMetric *)self POSIXError];
  if (v11)
  {
