...
- (NSDictionary)dictionaryRepresentation
{
  ...
  v4 = [(IDSRegistrationProfileOperationAuthenticateMetric *)self guid];
  if (v4)
  {
  ...
  v9 = [(IDSRegistrationProfileOperationAuthenticateMetric *)self genericError];
  if (v9)
  {
    CFDictionarySetValue(v3, @"genericError", v9);
  }

  v10 = [(IDSRegistrationProfileOperationAuthenticateMetric *)self URLError];
  if (v10)
  {
    CFDictionarySetValue(v3, @"URLError", v10);
  }

  v11 = [(IDSRegistrationProfileOperationAuthenticateMetric *)self POSIXError];
  if (v11)
  {
