...
- (void)rem_setFontHint:()REMCRMergeableStringDocument_Styling isOn:inRange:
{
  ...
  if (a3)
  {
    ...
    if (v11.length && v11.location != 0x7FFFFFFFFFFFFFFFLL)
    {
      ...
      v16[4] = a1;
      v16[5] = a3;
      [a1 enumerateAttributesInRange:v11.location options:v11.length usingBlock:{0x100000, v16}];
      [a1 endEditing];
      v12 = +[REMLog crdt];
  ...
  else
  {
    ...
    if (os_log_type_enabled(v14, OS_LOG_TYPE_ERROR))
    {
      v26.location = a5;
      v26.length = a6;
      [NSMutableAttributedString(REMCRMergeableStringDocument_Styling) rem_setFontHint:a1 isOn:v26 inRange:v14];
    }
  }
...
- (void)rem_setUnderline:()REMCRMergeableStringDocument_Styling inRange:
{
  ...
  if (v9.length && v9.location != 0x7FFFFFFFFFFFFFFFLL)
  {
    ...
    v14 = a3;
    v13[4] = a1;
    [a1 enumerateAttributesInRange:v9.location options:v9.length usingBlock:{0x100000, v13}];
    [a1 endEditing];
    v10 = +[REMLog crdt];
