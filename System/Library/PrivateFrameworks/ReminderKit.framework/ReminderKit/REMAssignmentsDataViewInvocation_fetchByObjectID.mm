...
- (REMAssignmentsDataViewInvocation_fetchByObjectID)initWithCoder:(id)coder;
- (REMAssignmentsDataViewInvocation_fetchByObjectID)initWithObjectIDs:(id)ds;
- (unint64_t)hash;
...
{
  coderCopy = coder;
  objectIDs = [(REMAssignmentsDataViewInvocation_fetchByObjectID *)self objectIDs];
  [coderCopy encodeObject:objectIDs forKey:@"objectIDs"];

  [coderCopy encodeBool:-[REMAssignmentsDataViewInvocation_fetchByObjectID allowConcealedObjects](self forKey:{"allowConcealedObjects"), @"allowConcealedObjects"}];
}
...
- (BOOL)isEqual:(id)equal
{
  ...
  objectIDs3 = [(REMAssignmentsDataViewInvocation_fetchByObjectID *)self objectIDs];
  ...
  {
LABEL_6:
    allowConcealedObjects = [(REMAssignmentsDataViewInvocation_fetchByObjectID *)self allowConcealedObjects];
