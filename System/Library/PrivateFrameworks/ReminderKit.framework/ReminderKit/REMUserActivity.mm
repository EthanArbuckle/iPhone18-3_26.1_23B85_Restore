...
{
  v4 = a3;
  v5 = [REMUserActivity dataFromUserActivity:v4];
  if (v5)
  {
...
- (REMUserActivity)userActivityWithFlags:(int64_t)a3
{
  ...
  v6 = [(REMUserActivity *)self type];
  v7 = [(REMUserActivity *)self storage];
  v8 = [(REMUserActivity *)v5 initWithType:v6 storage:v7 flags:a3];
...
- (unint64_t)hash
{
  v3 = [(REMUserActivity *)self type];
  v4 = [(REMUserActivity *)self storage];
  v5 = [v4 hash];
  v6 = v3 ^ [(REMUserActivity *)self flags];
...
- (BOOL)isEqual:(id)a3
{
  ...
  v7 = [(REMUserActivity *)self type];
  if (v7 != [(REMUserActivity *)v6 type])
  {
    goto LABEL_6;
  }

  v8 = [(REMUserActivity *)self storage];
  v9 = [(REMUserActivity *)v6 storage];
  v10 = v9;
  if (v8 == v9)
  {
  ...
  v11 = [(REMUserActivity *)self storage];
  v12 = [(REMUserActivity *)v6 storage];
  v13 = [v11 isEqual:v12];

  if (v13)
  {
LABEL_11:
    v16 = [(REMUserActivity *)self flags];
    v14 = v16 == [(REMUserActivity *)v6 flags];
    goto LABEL_7;
  }
...
{
  v5 = a3;
  [v5 encodeInteger:-[REMUserActivity type](self forKey:{"type"), @"type"}];
  v4 = [(REMUserActivity *)self storage];
  [v5 encodeObject:v4 forKey:@"storage"];

  [v5 encodeInteger:-[REMUserActivity flags](self forKey:{"flags"), @"flags"}];
}
...
- (REMUserActivity)initWithCoder:(id)a3
{
  ...
  v7 = [v4 decodeObjectOfClass:objc_opt_class() forKey:@"storage"];
...
- (id)userActivityData
{
  if ([(REMUserActivity *)self type]== 2)
  {
    v3 = [(REMUserActivity *)self storage];
  }
...
- (id)debugDescription
{
  ...
  v10 = [(REMUserActivity *)self debugDescriptionDetails];
  v11 = [v4 stringWithFormat:@"%@ (type=%@, bytes=%@, flags=%@, details=%@)", v3, v5, v8, v9, v10];
...
- (id)debugDescriptionDetails
{
  ...
  {
    case 3:
      v4 = [(REMUserActivity *)self siriIntent];
      v5 = [v4 debugDescription];
      goto LABEL_7;
    case 2:
      v4 = [(REMUserActivity *)self userActivity];
      v6 = MEMORY[0x1E696AEC0];
      v7 = [v4 activityType];
      v8 = [v4 title];
      v9 = [v4 webpageURL];
      v10 = [v4 userInfo];
      v11 = [v6 stringWithFormat:@"{type: %@, title: %@, URL: %@, userInfo: %@}", v7, v8, v9, v10];

      goto LABEL_9;
    case 1:
      v4 = [(REMUserActivity *)self universalLink];
...
+ (id)stringForActivityType:(int64_t)a3
{
  if ((a3 - 1) >= 3)
  {
    v4 = [MEMORY[0x1E696AEC0] stringWithFormat:@"Unknown REMUserActivityType %ld", a3];
  }

  else
  {
    v4 = off_1E7509958[a3 - 1];
  }
...
+ (id)stringForFlags:(int64_t)a3
{
  ...
  if (a3)
  {
    [v4 addObject:@"prefersHiddenInRemindersList"];
    a3 &= ~1uLL;
  }

  if (a3)
  {
    v6 = [MEMORY[0x1E696AEC0] stringWithFormat:@"unknownFlag(0x%lx)", a3];
    [v5 addObject:v6];
  }
