...
- (REMListSectionsDataViewInvocation_fetchListSectionsInList)initWithCoder:(id)coder;
- (REMListSectionsDataViewInvocation_fetchListSectionsInList)initWithParentListObjectID:(id)d;
- (unint64_t)hash;
...
{
  coderCopy = coder;
  listObjectID = [(REMListSectionsDataViewInvocation_fetchListSectionsInList *)self listObjectID];
...
- (BOOL)isEqual:(id)equal
{
  ...
  if (objc_opt_isKindOfClass())
  {
    ...
    {
      listObjectID3 = [(REMListSectionsDataViewInvocation_fetchListSectionsInList *)self listObjectID];
