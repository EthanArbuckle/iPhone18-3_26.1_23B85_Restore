...
uint64_t SCPError.description.getter(uint64_t a1)
{
  if (a1 <= 4)
  {
    if (a1 > 1)
...
unint64_t sub_26607EC88()
{
  result = qword_280059EB0;
  if (!qword_280059EB0)
  {
    result = swift_getWitnessTable();
    atomic_store(result, &qword_280059EB0);
  }
...
char *sub_26607ECFC(char *result, int64_t a2, char a3, char *a4)
{
  v5 = result;
  if (a3)
  {
  ...
  if (v9)
  {
    __swift_instantiateConcreteTypeFromMangledNameV2(&unk_280059EF0, &unk_266082018);
...
unint64_t sub_26607EEC4()
{
  result = qword_280059EB8;
  if (!qword_280059EB8)
  {
    result = swift_getWitnessTable();
    atomic_store(result, &qword_280059EB8);
  }

  return result;
}

unint64_t sub_26607EFB8()
{
  result = qword_280059ED8;
  if (!qword_280059ED8)
  {
    result = swift_getWitnessTable();
    atomic_store(result, &qword_280059ED8);
  }
...
uint64_t getEnumTagSinglePayload for SignalEncoder.FormatDescriptor.Semantic(unsigned __int8 *a1, unsigned int a2)
{
  if (!a2)
  {
    return 0;
...
uint64_t storeEnumTagSinglePayload for SignalEncoder.FormatDescriptor.Semantic(uint64_t result, unsigned int a2, unsigned int a3)
{
  if (a3 + 1 >= 0xFFFF00)
  {
    v3 = 4;
...
uint64_t _s17SignalCompression13SignalEncoderC7OptionsVwet_0(uint64_t a1, int a2)
{
  if (a2 && *(a1 + 8))
  {
    return (*a1 + 1);
...
uint64_t _s17SignalCompression13SignalEncoderC7OptionsVwst_0(uint64_t result, int a2, int a3)
{
  if (a2)
  {
    *result = (a2 - 1);
...
uint64_t sub_26607F4A0(uint64_t a1, unsigned int a2)
{
  if (!a2)
  {
    return 0;
...
uint64_t sub_26607F4F4(uint64_t result, unsigned int a2, unsigned int a3)
{
  if (a2 > 0xC)
  {
    *(result + 8) = 0;
