...
- (STUIStatusBarBadgeView)initWithFrame:(CGRect)frame;
...
- (STUIStatusBarBadgeView)initWithFrame:(CGRect)frame
{
  ...
  v3 = [(STUIStatusBarBadgeView *)&v29 initWithFrame:frame.origin.x, frame.origin.y, frame.size.width, frame.size.height];
  v4 = v3;
  if (v3)
  {
    layer = [(STUIStatusBarBadgeView *)v3 layer];
    ...
    leadingAnchor2 = [(STUIStatusBarBadgeView *)v4 leadingAnchor];
    v9 = [leadingAnchor constraintEqualToAnchor:leadingAnchor2];
    v31[0] = v9;
    bottomAnchor = [(STUIStatusBarBadgeView *)v4 bottomAnchor];
    ...
    centerXAnchor2 = [(STUIStatusBarBadgeView *)v4 centerXAnchor];
    v16 = [centerXAnchor constraintEqualToAnchor:centerXAnchor2];
    v30[0] = v16;
    widthAnchor = [(STUIStatusBarBadgeView *)v4 widthAnchor];
    heightAnchor = [(STUIStatusBarBadgeView *)v4 heightAnchor];
    v19 = [widthAnchor constraintGreaterThanOrEqualToAnchor:heightAnchor];
    v30[1] = v19;
    centerYAnchor = [(UILabel *)v4->_label centerYAnchor];
    centerYAnchor2 = [(STUIStatusBarBadgeView *)v4 centerYAnchor];
...
- (void)applyStyleAttributes:(id)attributes
{
  ...
  layer = [(STUIStatusBarBadgeView *)self layer];
  v16 = layer;
  v17 = 2.5;
  if (isRounded)
  {
  ...
  layer2 = [(STUIStatusBarBadgeView *)self layer];
