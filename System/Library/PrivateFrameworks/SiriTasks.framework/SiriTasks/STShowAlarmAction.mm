...
- (STShowAlarmAction)initWithCoder:(id)coder;
...
- (id)_initWithAlarmIds:(id)ids
{
  ...
  if (!idsCopy)
  {
    ...
    [currentHandler handleFailureInMethod:a2 object:self file:@"STShowAlarmAction.m" lineNumber:19 description:{@"Invalid parameter not satisfying: %@", @"alarmIds"}];
  }
