...
uint64_t sub_245DE3A04(uint64_t a1, PB::TextFormatter *this, char *a3)
{
  v5 = (a1 + 372);
...
uint64_t sub_245DE4668(uint64_t a1, PB::Reader *this)
{
  v3 = this + 24;
  v2 = *(this + 24);
  v4 = *(this + 1);
...
uint64_t sub_245DE6344(uint64_t result, PB::Writer *this)
{
  v3 = result;
  v4 = (result + 372);
  if (*(result + 372))
...
void *sub_245DE6D80(void *result)
{
  *result = &unk_2858CE1B0;
  result[45] = 0;
  result[46] = 0;
  return result;
}

void sub_245DE6DA8(PB::Base *a1)
{
  PB::Base::~Base(a1);
...
float sub_245DE6DE0(uint64_t a1, uint64_t a2)
{
  *a1 = &unk_2858CE1B0;
  *(a1 + 360) = 0;
  *(a1 + 368) = 0;
...
LABEL_154:
  ...
  *(a1 + 360) = v3;
  *(a1 + 244) = result;
  if ((*(a2 + 360) & 0x2000000000000000) != 0)
  {
LABEL_30:
    v11 = *(a2 + 284);
...
LABEL_197:
      ...
      *(a1 + 360) = v3;
      *(a1 + 188) = v85;
      if ((*(a2 + 360) & 0x8000000000000000) == 0)
      {
        goto LABEL_89;
      }
...
LABEL_93:
  ...
  *(a1 + 360) = v3;
  *(a1 + 280) = v86;
  if ((*(a2 + 360) & 0x4000000000000000) != 0)
  {
LABEL_94:
    v30 = *(a2 + 288);
...
LABEL_223:
  ...
  *(a1 + 360) = v3;
  *(a1 + 172) = v100;
  if ((*(a2 + 360) & 0x800000000) != 0)
  {
LABEL_131:
    v41 = *(a2 + 180);
    *(a1 + 360) = v3 | 0x800000000;
    *(a1 + 180) = v41;
  }
...
uint64_t sub_245DE79DC(uint64_t a1, PB::TextFormatter *this, char *a3)
{
  PB::TextFormatter::beginObject(this, a3);
  if ((*(a1 + 368) & 0x40) != 0)
  {
...
uint64_t sub_245DE879C(uint64_t a1, PB::Reader *this)
{
  v3 = (this + 8);
  v2 = *(this + 1);
  v5 = this + 24;
