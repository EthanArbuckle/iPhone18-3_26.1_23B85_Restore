...
uint64_t sub_245E5AE08(uint64_t a1, uint64_t a2)
{
  *a1 = &unk_2858D2050;
  v4 = (a1 + 704);
  bzero((a1 + 8), 0x2B0uLL);
...
uint64_t sub_245E65E50(uint64_t a1, PB::TextFormatter *this, char *a3)
{
...
uint64_t sub_245E6C9A8(uint64_t a1, PB::Reader *this)
{
  v2 = *(this + 1);
  v3 = *(this + 2);
  v4 = *(this + 24);
...
uint64_t sub_245E77DD0(uint64_t result, PB::Writer *this)
{
  v3 = result;
  if (*(result + 3928))
  {
...
uint64_t sub_245E7ABA8(uint64_t result)
{
  *result = &unk_2858D20A0;
  *(result + 188) = 0;
  return result;
}

void sub_245E7ABD0(PB::Base *a1)
{
  PB::Base::~Base(a1);
...
uint64_t sub_245E7AC08(uint64_t result, uint64_t a2)
{
  *result = &unk_2858D20A0;
  *(result + 188) = 0;
  v2 = *(a2 + 188);
