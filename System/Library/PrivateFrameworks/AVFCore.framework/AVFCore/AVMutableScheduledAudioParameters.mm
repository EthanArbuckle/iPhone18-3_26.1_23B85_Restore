...
- (void)_setVolumeRampFromStartVolume:(float)a3 toEndVolume:(float)a4 timeRange:(id *)a5 rampMode:(int64_t)a6
{
  ...
  v7[1] = v6;
  v7[2] = *&a5->var1.var1;
  [(AVScheduledAudioParameters *)self _setRamp:[AVScheduledVolumeRamp volumeRampWithStartVolume:"volumeRampWithStartVolume:endVolume:timeRange:rampMode:" endVolume:v7 timeRange:a6 rampMode:?]];
}
...
- (void)setVolumeRampFromStartVolume:(float)a3 toEndVolume:(float)a4 timeRange:(id *)a5 rampMode:(int64_t)a6
{
  ...
  v12[1] = v10;
  v12[2] = *&a5->var1.var1;
  [AVMutableScheduledAudioParameters _setVolumeRampFromStartVolume:"_setVolumeRampFromStartVolume:toEndVolume:timeRange:rampMode:" toEndVolume:v12 timeRange:a6 rampMode:?];
}
