...
- (id)copyWithZone:(_NSZone *)zone
{
  v4 = [[AVScheduledAudioParameters allocWithZone:?]];
  if (v4)
  {
...
- (void)_setVolumeRampFromStartVolume:(float)volume toEndVolume:(float)endVolume timeRange:(id *)range rampMode:(int64_t)mode
{
  ...
  [(AVScheduledAudioParameters *)self _setRamp:[AVScheduledVolumeRamp volumeRampWithStartVolume:"volumeRampWithStartVolume:endVolume:timeRange:rampMode:" endVolume:v7 timeRange:mode rampMode:?]];
}
...
- (void)setVolumeRampFromStartVolume:(float)volume toEndVolume:(float)endVolume timeRange:(id *)range
{
  ...
  [AVMutableScheduledAudioParameters _setVolumeRampFromStartVolume:"_setVolumeRampFromStartVolume:toEndVolume:timeRange:rampMode:" toEndVolume:v12 timeRange:0 rampMode:?];
}
...
- (void)setVolumeRampFromStartVolume:(float)volume toEndVolume:(float)endVolume timeRange:(id *)range rampMode:(int64_t)mode
{
  ...
  v12[1] = v10;
  v12[2] = *&range->var1.var1;
  [AVMutableScheduledAudioParameters _setVolumeRampFromStartVolume:"_setVolumeRampFromStartVolume:toEndVolume:timeRange:rampMode:" toEndVolume:v12 timeRange:mode rampMode:?];
}
