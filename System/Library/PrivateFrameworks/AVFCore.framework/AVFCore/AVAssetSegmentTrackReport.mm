...
- (AVAssetSegmentTrackReport)initWithFigSegmentTrackReportDictionary:(id)dictionary;
- (void)dealloc;
@end
...
- (AVAssetSegmentTrackReport)initWithFigSegmentTrackReportDictionary:(id)dictionary
{
  ...
  if (v5)
  {
    v5->_trackID = [objc_msgSend(dictionary objectForKey:{*MEMORY[0x1E6971468]), "longValue"}];
    v5->_mediaType = [AVMediaTypeFromCMMediaType(objc_msgSend(objc_msgSend(dictionary objectForKey:{*MEMORY[0x1E6971460]), "longValue")), "copy"}];
    CMTimeMakeFromDictionary(&v16, [dictionary objectForKey:*MEMORY[0x1E6971450]]);
    v5->_earliestPresentationTimeStamp = v16;
    CMTimeMakeFromDictionary(&v16, [dictionary objectForKey:*MEMORY[0x1E6971448]]);
    v5->_duration = v16;
    v6 = [dictionary objectForKey:*MEMORY[0x1E6971458]];
    if (v6)
    {
