...
- (AVCMNotificationDispatcherListenerKey)initWithWeakReferenceToListener:(id)a3 callback:(void *)a4 name:(id)a5 object:(void *)a6
{
  ...
  if (v10)
  {
    ...
    v10->_callback = a4;
    v10->_name = [a5 copyWithZone:{-[AVCMNotificationDispatcherListenerKey zone](v10, "zone")}];
    v10->_object = a6;
  }
...
- (BOOL)isEqual:(id)a3
{
  ...
  else
  {
    ...
    weakReferenceToListener = self->_weakReferenceToListener;
    if (weakReferenceToListener == *(a3 + 1) || (v7 = [(AVWeakReference *)weakReferenceToListener isEqual:?]) != 0)
    {
