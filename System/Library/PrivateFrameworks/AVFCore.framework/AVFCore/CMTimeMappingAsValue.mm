...
- ($D5AB1F6BCC7169BA692F6D1C6C8B6B88)CMTimeMappingValue;
- (BOOL)isEqualToValue:(id)value;
- (CMTimeMappingAsValue)initWithCoder:(id)coder;
...
- (CMTimeMappingAsValue)initWithCoder:(id)coder
{
  ...
  v23.receiver = self;
  v23.super_class = CMTimeMappingAsValue;
  v6 = [(CMTimeMappingAsValue *)&v23 init];
  v7 = v6;
  if (v6)
  {
