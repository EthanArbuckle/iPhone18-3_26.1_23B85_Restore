...
- (AVAssetVariantQualifierForMinimumInKeyPath)initWithCoder:(id)coder;
- (AVAssetVariantQualifierForMinimumInKeyPath)initWithFigAssetVariantQualifierForMinimumInKeyPath:(id)path;
...
- (AVAssetVariantQualifierForMinimumInKeyPath)initWithFigAssetVariantQualifierForMinimumInKeyPath:(id)path
{
  ...
  if (v5)
  {
    if (!-[AVAssetVariantQualifierForMinimumInKeyPath _validateKeyPath:](v5, "_validateKeyPath:", [path _keyPath]))
    {
      v7 = v5;
