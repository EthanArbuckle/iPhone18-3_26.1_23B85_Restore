...
- (unint64_t)hash
{
  v3 = [(AVFormatReaderInspector *)self _copyFormatReader];
  if (v3)
  {
    v4 = v3;
    v5 = CFHash(v3);
...
- (void)_valueAsCFTypeForProperty:(__CFString *)a3
{
  ...
  if (result)
  {
    ...
    if (v7)
    {
      v7(FigBaseObject, a3, *MEMORY[0x1E695E480], &v8);
    }
...
- (id)commonMetadata
{
  ...
  cf = 0;
  v4 = [(AVFormatReaderInspector *)self _copyFormatReader];
  if (v4)
  {
    v5 = v4;
