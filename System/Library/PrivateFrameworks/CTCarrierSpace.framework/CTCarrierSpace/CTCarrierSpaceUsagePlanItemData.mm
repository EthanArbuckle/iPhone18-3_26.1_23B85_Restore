...
- (BOOL)isEqual:(id)a3
{
  ...
  else
  {
    ...
    {
      v7 = [(CTCarrierSpaceUsagePlanItemData *)self units];
      if (v7 == [(CTCarrierSpaceUsagePlanItemData *)v6 units])
      {
        v8 = [(CTCarrierSpaceUsagePlanItemData *)self capacity];
        v9 = [(CTCarrierSpaceUsagePlanItemData *)v6 capacity];
        if (v8 != v9)
        {
          v10 = [(CTCarrierSpaceUsagePlanItemData *)self capacity];
          v42 = [(CTCarrierSpaceUsagePlanItemData *)v6 capacity];
          v43 = v10;
        ...
        v12 = [(CTCarrierSpaceUsagePlanItemData *)self maxDataBeforeThrottling];
        v13 = [(CTCarrierSpaceUsagePlanItemData *)v6 maxDataBeforeThrottling];
        if (v12 != v13)
        {
          v3 = [(CTCarrierSpaceUsagePlanItemData *)self maxDataBeforeThrottling];
          v4 = [(CTCarrierSpaceUsagePlanItemData *)v6 maxDataBeforeThrottling];
...
LABEL_30:
        ...
        v14 = [(CTCarrierSpaceUsagePlanItemData *)self thisDeviceDataUsed];
        v15 = [(CTCarrierSpaceUsagePlanItemData *)v6 thisDeviceDataUsed];
        v41 = v14;
        v16 = v14 == v15;
        v17 = v15;
        if (!v16)
        {
          v18 = [(CTCarrierSpaceUsagePlanItemData *)self thisDeviceDataUsed];
          v36 = [(CTCarrierSpaceUsagePlanItemData *)v6 thisDeviceDataUsed];
          v37 = v18;
...
LABEL_27:
        ...
        v20 = [(CTCarrierSpaceUsagePlanItemData *)self sharedDataUsed];
        v38 = [(CTCarrierSpaceUsagePlanItemData *)v6 sharedDataUsed];
        v39 = v17;
        v40 = v4;
        if (v20 == v38)
        {
        ...
        {
          v21 = v3;
          v22 = [(CTCarrierSpaceUsagePlanItemData *)self sharedDataUsed];
          v33 = [(CTCarrierSpaceUsagePlanItemData *)v6 sharedDataUsed];
          v34 = v22;
        ...
        v23 = [(CTCarrierSpaceUsagePlanItemData *)self sharedPlanIdentifier];
        v24 = [(CTCarrierSpaceUsagePlanItemData *)v6 sharedPlanIdentifier];
        v25 = v24;
        if (v23 == v24)
        {
        ...
        {
          v26 = [(CTCarrierSpaceUsagePlanItemData *)self sharedPlanIdentifier];
          [(CTCarrierSpaceUsagePlanItemData *)v6 sharedPlanIdentifier];
          v32 = v13;
          v27 = v12;
          v29 = v28 = v20;
