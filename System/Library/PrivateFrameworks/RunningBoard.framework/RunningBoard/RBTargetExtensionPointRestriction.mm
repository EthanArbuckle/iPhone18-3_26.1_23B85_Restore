...
+ (id)domainRestrictionForDictionary:(id)a3 withError:(id *)a4
{
  ...
  else if (a4)
  {
    ...
    v8 = [MEMORY[0x277CCACA8] stringWithFormat:@"RBTargetExtensionPointRestriction doesn't specify extensionPoint or doesn't have right class for extensionPoint: %@", v5, *MEMORY[0x277CCA470]];
    v15[0] = v8;
