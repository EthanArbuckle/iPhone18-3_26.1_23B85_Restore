...
- (id)_initWithEntitlement:(id)entitlement
{
  ...
  v10.receiver = self;
  v10.super_class = RBTargetEntitlementDomainRestriction;
...
+ (id)domainRestrictionForDictionary:(id)dictionary withError:(id *)error
{
  ...
  {
    error = [[RBTargetEntitlementDomainRestriction alloc] _initWithEntitlement:v6];
  }

  else if (error)
  {
    v7 = MEMORY[0x277CCA9B8];
    v8 = [MEMORY[0x277CCACA8] stringWithFormat:@"RBTargetEntitlementDomainRestriction doesn't specify entitlement: %@", dictionaryCopy, *MEMORY[0x277CCA470]];
    v15[0] = v8;
...
- (BOOL)allowsContext:(id)context withError:(id *)error
{
  ...
  targetEntitlements = [context targetEntitlements];
  v7 = [targetEntitlements rb_hasEntitlement:self->_entitlement];
  ...
  if (error && (v7 & 1) == 0)
  {
    ...
    entitlement = self->_entitlement;
    v11 = [MEMORY[0x277CCACA8] stringWithFormat:@"target is not running or doesn't have entitlement %@", entitlement, *MEMORY[0x277CCA470]];
    v16[0] = v11;
