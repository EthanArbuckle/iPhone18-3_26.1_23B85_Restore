...
- (NSArray)items;
- (SSVPlaybackResponse)initWithDictionary:(id)dictionary URLResponse:(id)response;
...
- (SSVPlaybackResponse)initWithDictionary:(id)dictionary URLResponse:(id)response
{
  ...
  if (v8)
  {
    ...
    objc_storeStrong(&v8->_urlResponse, response);
  }
...
- (id)copyWithZone:(_NSZone *)zone
{
  ...
  v6 = [(NSDictionary *)self->_responseDictionary copyWithZone:zone];
  v7 = v5[1];
  v5[1] = v6;

  v8 = [(NSHTTPURLResponse *)self->_urlResponse copyWithZone:zone];
  v9 = v5[2];
  v5[2] = v8;
