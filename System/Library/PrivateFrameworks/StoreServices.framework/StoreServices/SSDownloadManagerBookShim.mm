...
LABEL_12:
  v18 = [(SSDownloadManagerBookShim *)self __book_downloadsForStati:v5 overrideFinished:0 overrideFailed:0];
...
LABEL_12:
  v20 = [(SSDownloadManagerBookShim *)self __book_downloadsForStati:v7 overrideFinished:a5 == 0 overrideFailed:a5 != 0, v35];
...
- (id)_copyDownloadsForMessage:(int64_t)a3 downloadIDs:(id)a4
{
  v8.receiver = self;
  v8.super_class = SSDownloadManagerBookShim;
  v5 = [(SSDownloadManagerAppShim *)&v8 _copyDownloadsForMessage:a3 downloadIDs:a4];
  v6 = [(SSDownloadManagerBookShim *)self __book_getAllDownloads];
  if ([v6 count])
  {
...
- (id)__book_getAllDownloads
{
  ...
  v4 = [(SSDownloadManagerBookShim *)self __book_downloadsForStati:v3 overrideFinished:0 overrideFailed:0];
