...
- (void)addRolledLoiAnalyticsDictionary:(id)a3;
- (void)copyTo:(id)a3;
...
- (void)addRolledLoiAnalyticsDictionary:(id)a3
{
  ...
  [(NSMutableArray *)rolledLoiAnalyticsDictionarys addObject:v4];
}
...
- (id)description
{
  ...
  v5 = [(PCPPredictedContextAnalytics *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  if ([(NSMutableArray *)self->_rolledLoiAnalyticsDictionarys count])
  {
    ...
    [v3 setObject:v4 forKey:@"rolledLoiAnalyticsDictionary"];
  }
...
- (void)copyTo:(id)a3
{
  ...
  {
    [v8 clearRolledLoiAnalyticsDictionarys];
    v4 = [(PCPPredictedContextAnalytics *)self rolledLoiAnalyticsDictionarysCount];
    if (v4)
    {
      v5 = v4;
      for (i = 0; i != v5; ++i)
      {
        ...
        [v8 addRolledLoiAnalyticsDictionary:v7];
      }
    }
  }
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    rolledLoiAnalyticsDictionarys = self->_rolledLoiAnalyticsDictionarys;
    if (rolledLoiAnalyticsDictionarys | v4[1])
    {
