...
- (id)styleSettingsForPipelineState:(id)a3 size:(id)a4;
...
LABEL_46:
  ...
  if ([v10 evaluationMode])
  {
    ...
    {
      v16 = [(PISemanticStyleRenderNode *)self input];
      v17 = [v16 imageProperties:a5];
      ...
      if (v17)
      {
        ...
        v23 = [(NURenderNode *)self settings];
        v24 = [v23 mutableCopy];
        ...
        else if ([v10 evaluationMode] == 1)
        {
          ...
          v31 = [(PISemanticStyleRenderNode *)self input];
          v32 = [v30 styleTransferThumbnailNodeWithInput:v31 settings:v29];
          ...
          v15 = [v34 nodeByReplayingAgainstCache:v8 pipelineState:v10 error:a5];
        }
        ...
        else
        {
          ...
          v15 = [(PISemanticStyleRenderNode *)&v66 nodeByReplayingAgainstCache:v8 pipelineState:v10 error:a5];
        }
      }
  ...
  else
  {
    ...
    v15 = [(PISemanticStyleRenderNode *)&v70 nodeByReplayingAgainstCache:v8 pipelineState:v10 error:a5];
  }
...
- (id)styleSettingsForPipelineState:(id)a3 size:(id)a4
{
  ...
  v9 = [v8 objectForKeyedSubscript:@"cast"];

  v10 = [v7 evaluationMode];
  v11 = MEMORY[0x1E69B3940];
  if (v10 == 3 || v7 && ([v7 time], (v68 & 1) != 0))
  {
    v12 = MEMORY[0x1E69B3CD8];
    v13 = [v7 scale];
    v15 = [v12 semanticStyleVideoSettingsForScale:v13 aspectRatio:{v14, var0, var1}];
    v16 = [v15 mutableCopy];
  ...
  if ([v7 evaluationMode] == 1)
  {
    v20 = MEMORY[0x1E69B3CD8];
    v21 = [v7 scale];
    v16 = [v20 semanticStyleImageSettingsForScale:v21 aspectRatio:{v22, var0, var1}];
LABEL_9:
    ...
    v28 = [v27 objectForKeyedSubscript:@"tone"];
    [v28 floatValue];
    v30 = v29;

    v31 = [(NURenderNode *)self settings];
    v32 = [v31 objectForKeyedSubscript:@"color"];
    [v32 floatValue];
    v34 = v33;

    v35 = [(NURenderNode *)self settings];
    v36 = [v35 objectForKeyedSubscript:@"intensity"];
    [v36 floatValue];
    v38 = v37;
