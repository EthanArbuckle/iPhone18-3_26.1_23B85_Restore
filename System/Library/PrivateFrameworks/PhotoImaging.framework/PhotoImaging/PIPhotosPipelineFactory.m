...
+ (id)buildPhotosPipelineWithDescriptor:(id)a3 error:(id *)a4;
...
LABEL_24:
  ...
  v6 = v5;
  v7 = [PIPhotosPipelineBuilder pipelineBuilderWithDescriptor:v5 error:a4];
  if (v7)
  {
    v8 = [MEMORY[0x1E69B3BD0] buildPipelineWithBuilder:v7 error:a4];
  }
