...
- (void)populateUnderlyingErrorsStartingWithRootError:(id)a3 maxDepth:(unsigned int)a4 topLevelErrorCodeKey:(id)a5 topLevelErrorDomainKey:(id)a6 errorCodePrefix:(id)a7 errorDomainPrefix:(id)a8 domainAllowlist:(id)a9
{
  ...
  v38 = a8;
  v17 = a9;
  v18 = [MEMORY[0x277CCABB0] numberWithInteger:{objc_msgSend(v37, "code")}];
  v36 = v15;
  ...
  v22 = [v20 objectForKeyedSubscript:*MEMORY[0x277CCA7E8]];
  ...
  if (!v23)
  {
    ...
    while (1)
    {
      v26 = [MEMORY[0x277CCACA8] stringWithFormat:@"%@%u", v39, v25 - 1];
      v27 = [MEMORY[0x277CCACA8] stringWithFormat:@"%@%u", v38, v25 - 1];
      v28 = [MEMORY[0x277CCABB0] numberWithInteger:{objc_msgSend(v22, "code")}];
