...
- (AKAuthorizationDaemonConnection)initWithListenerEndpoint:(id)a3 exportedInterface:(id)a4
{
  ...
  v11 = [(AKAuthorizationDaemonConnection *)&v8 init];
  objc_storeStrong(&v11, v11);
  if (v11)
  {
    objc_storeStrong(&v11->_listenerEndpoint, location[0]);
    objc_storeStrong(&v11->_contextManager, v9);
    v11->_unfairLock._os_unfair_lock_opaque = 0;
  }
...
- (id)remoteObjectProxyWithErrorHandler:(id)a3
{
  ...
  location[0] = 0;
  objc_storeStrong(location, a3);
  v4 = [(AKAuthorizationDaemonConnection *)v7 _connection];
