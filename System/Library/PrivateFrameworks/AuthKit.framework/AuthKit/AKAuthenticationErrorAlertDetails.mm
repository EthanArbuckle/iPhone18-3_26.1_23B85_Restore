...
- (AKAuthenticationErrorAlertDetails)initWithError:(id)error title:(id)title message:(id)message;
@end
...
- (AKAuthenticationErrorAlertDetails)initWithError:(id)error title:(id)title message:(id)message
{
  ...
  *(self + OBJC_IVAR___AKAuthenticationErrorAlertDetails_error) = error;
