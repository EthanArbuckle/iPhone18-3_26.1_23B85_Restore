...
- (void)_setU13AgeLimit:(int64_t)limit;
- (void)_setU18AgeLimit:(int64_t)limit;
...
- (AKAgeRangeSettingsCache)init
{
  ...
  if (v23)
  {
    ...
    if ([(AKAgeRangeSettingsCache *)v23 _u13AgeLimit]> 0 && [(AKAgeRangeSettingsCache *)v23 _u18AgeLimit]> 0)
    {
      ...
      _u13AgeLimit = [(AKAgeRangeSettingsCache *)v23 _u13AgeLimit];
      v4 = [(AKAgeRangeSettings *)v12 initWithU13Limit:_u13AgeLimit u18Limit:[(AKAgeRangeSettingsCache *)v23 _u18AgeLimit]];
...
- (void)updateAgeRangeCacheWithGlobalConfig:(id)config
{
  ...
  if (location[0])
  {
    ...
    if (v34)
    {
      v33 = [v34 objectForKeyedSubscript:uppercaseString];
      v32 = 1;
      v22 = v33 == 0;
    }
    ...
    v15 = objc_opt_class();
    v16 = [v34 objectForKeyedSubscript:uppercaseString];
    ...
    [(AKAgeRangeSettingsCache *)selfCopy _setU13AgeLimit:intValue];
    [(AKAgeRangeSettingsCache *)selfCopy _setU18AgeLimit:intValue2];
...
- (void)clearAgeRangeCache
{
  ...
  v8[1] = a2;
  [AKAgeRangeSettingsCache _setConfigurationValue:"_setConfigurationValue:forKey:" forKey:?];
  [(AKAgeRangeSettingsCache *)selfCopy _setConfigurationValue:0 forKey:@"U18Limit"];
  v2 = selfCopy;
...
- (void)_updateAgeRangeSettings
{
  ...
  objc_storeStrong(location, 0);
  _u13AgeLimit = [(AKAgeRangeSettingsCache *)selfCopy _u13AgeLimit];
  _u18AgeLimit = [(AKAgeRangeSettingsCache *)selfCopy _u18AgeLimit];
  [(AKAgeRangeSettingsCache *)selfCopy willChangeValueForKey:?];
  ...
  [(AKAgeRangeSettingsCache *)selfCopy didChangeValueForKey:@"ageRangeSettings"];
  objc_storeStrong(&v10, 0);
}
