...
- (id)titleString
{
  ...
  v3 = [v2 localizedStringForKey:@"OD_UPDATE_SUCCESS_TITLE" value:&stru_1F42FFBE0 table:@"HealthUI-Localizable"];
...
{
  v2 = [MEMORY[0x1E696AAE8] bundleWithIdentifier:@"com.apple.HealthUI"];
  v3 = [v2 localizedStringForKey:@"OD_UPDATE_SUCCESS_BODY" value:&stru_1F42FFBE0 table:@"HealthUI-Localizable"];
