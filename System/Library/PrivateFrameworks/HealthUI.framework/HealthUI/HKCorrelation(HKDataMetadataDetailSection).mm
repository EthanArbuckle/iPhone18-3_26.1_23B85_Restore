...
- (void)addDetailValuesToSection:()HKDataMetadataDetailSection
{
  ...
  if (code == 80)
  {
    [self _hk_bloodPressureDetailRowsWithSection:v4];
  }
...
- (void)_hk_bloodPressureDetailRowsWithSection:()HKDataMetadataDetailSection
{
  ...
  [self _hk_bloodPressureDetailRowForSampleType:v7 title:v9 section:v6];
  ...
  [self _hk_bloodPressureDetailRowForSampleType:v12 title:v11 section:v6];
}
...
- (void)_hk_bloodPressureDetailRowForSampleType:()HKDataMetadataDetailSection title:section:
{
  ...
  v9 = a4;
  v10 = a5;
  v11 = [self objectsForType:v8];
  anyObject = [v11 anyObject];

  if (anyObject)
  {
    displayTypeController = [v10 displayTypeController];
    v14 = [displayTypeController displayTypeWithIdentifier:&unk_1F4384768];

    unitController = [v10 unitController];
    v33 = [unitController unitForDisplayType:v14];

    quantity = [anyObject quantity];
    [quantity doubleValueForUnit:v33];
    v18 = v17;

    presentation = [v14 presentation];
    v20 = [MEMORY[0x1E696AD98] numberWithDouble:v18];
    v32 = [presentation adjustedValueForDaemonValue:v20];

    unitController2 = [v10 unitController];
    v31 = HKFormattedStringFromValueForContext(v32, v14, unitController2, 0, 0, 1);

    unitController3 = [v10 unitController];
    v23 = [unitController3 localizedDisplayNameForDisplayType:v14 value:0 nameContext:3];
