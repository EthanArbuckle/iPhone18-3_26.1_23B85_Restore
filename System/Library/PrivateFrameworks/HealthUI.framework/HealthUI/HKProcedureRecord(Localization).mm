...
- (id)sortDateTitle
{
  ...
  if (v4)
  {
    v5 = @"PROCEDURE_RECORD_SORT_DATE_TITLE_MODIFIED_DATE";
LABEL_7:
  ...
  v8 = [keyPath2 isEqualToString:*MEMORY[0x1E696BBF8]];

  if (v8)
  {
    v5 = @"PROCEDURE_RECORD_SORT_DATE_TITLE_EXECUTION_END_DATE";
    goto LABEL_7;
  }

  sortDate3 = [self sortDate];
  keyPath3 = [sortDate3 keyPath];
  v11 = [keyPath3 isEqualToString:*MEMORY[0x1E696BC00]];

  if (v11)
  {
    v5 = @"PROCEDURE_RECORD_SORT_DATE_TITLE_EXECUTION_START_DATE";
    goto LABEL_7;
  }
