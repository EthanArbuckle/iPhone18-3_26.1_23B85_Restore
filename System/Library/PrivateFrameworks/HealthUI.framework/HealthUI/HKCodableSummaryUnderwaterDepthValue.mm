...
- (void)setHasValueClamped:(BOOL)clamped;
- (void)writeTo:(id)to;
@end
...
- (id)description
{
  ...
  dictionaryRepresentation = [(HKCodableSummaryUnderwaterDepthValue *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  if ((has & 2) != 0)
  {
    ...
    [dictionary setObject:v7 forKey:@"valueClamped"];
...
- (BOOL)isEqual:(id)equal
{
  ...
  if (*&self->_has)
  {
    if ((*(equalCopy + 28) & 1) != 0 && self->_dateData == *(equalCopy + 1))
    {
      v6 = 1;
      goto LABEL_12;
    }
