...
- (id)dictionaryRepresentation
{
  ...
  {
    v6 = [objc_alloc(MEMORY[0x1E695DF70]) initWithCapacity:{-[NSMutableArray count](self->_trends, "count")}];
    v14 = 0u;
    v15 = 0u;
    v16 = 0u;
    v17 = 0u;
...
- (void)mergeFrom:(id)from
{
  ...
  if (chartModel)
  {
    if (v6)
    {
      [(HKCodableChartSharableModel *)chartModel mergeFrom:?];
    }
  }

  else if (v6)
  {
    [(HKCodableChartFeedItemData *)self setChartModel:?];
  }
  ...
  if (v8)
  {
    ...
    do
    {
      for (i = 0; i != v9; ++i)
      {
        ...
        [(HKCodableChartFeedItemData *)self addTrends:*(*(&v12 + 1) + 8 * i), v12];
      }
