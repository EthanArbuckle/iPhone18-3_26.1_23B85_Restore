...
- (void)addDateIntervalsByValue:(id)value;
- (void)copyTo:(id)to;
...
- (void)addDateIntervalsByValue:(id)value
{
  ...
  [(NSMutableArray *)dateIntervalsByValues addObject:valueCopy];
}
...
- (id)description
{
  ...
  dictionaryRepresentation = [(HKCodableChartHorizontalTimePeriodDataSourceData *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  if ([(NSMutableArray *)self->_dateIntervalsByValues count])
  {
    ...
    [dictionary setObject:v4 forKey:@"dateIntervalsByValue"];
  }
...
- (void)copyTo:(id)to
{
  ...
  {
    [toCopy clearDateIntervalsByValues];
    dateIntervalsByValuesCount = [(HKCodableChartHorizontalTimePeriodDataSourceData *)self dateIntervalsByValuesCount];
    if (dateIntervalsByValuesCount)
    {
      v5 = dateIntervalsByValuesCount;
      for (i = 0; i != v5; ++i)
      {
        v7 = [(HKCodableChartHorizontalTimePeriodDataSourceData *)self dateIntervalsByValueAtIndex:i];
        [toCopy addDateIntervalsByValue:v7];
      }
    }
  }
}
...
- (BOOL)isEqual:(id)equal
{
  ...
  {
    dateIntervalsByValues = self->_dateIntervalsByValues;
    if (dateIntervalsByValues | equalCopy[1])
    {
