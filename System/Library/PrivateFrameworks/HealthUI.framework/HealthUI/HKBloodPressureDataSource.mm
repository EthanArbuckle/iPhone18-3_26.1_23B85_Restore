...
- (id)_chartPointsWithSystolicResults:(id)results diastolicResults:(id)diastolicResults blockStart:(id)start blockEnd:(id)end sourceTimeZone:(id)zone;
- (id)_earliestDateForSystolicResults:(id)results diastolicResults:(id)diastolicResults;
- (id)_latestDateForSystolicResults:(id)results diastolicResults:(id)diastolicResults;
...
- (id)queriesForRequest:(id)request completionHandler:(id)handler
{
  ...
  requestCopy = request;
  handlerCopy = handler;
  predicateForSamplesWithCorrelationedSample = [MEMORY[0x1E696C378] predicateForSamplesWithCorrelationedSample];
  v7 = MEMORY[0x1E696C378];
  startDate = [requestCopy startDate];
  endDate = [requestCopy endDate];
  v36 = [v7 predicateForSamplesWithStartDate:startDate endDate:endDate options:0];

  v10 = MEMORY[0x1E696AB28];
  v60[0] = v36;
  v60[1] = predicateForSamplesWithCorrelationedSample;
  ...
  queryStatisticsOption = [(HKBloodPressureDataSource *)self queryStatisticsOption];
  startDate2 = [requestCopy startDate];
  statisticsInterval = [requestCopy statisticsInterval];
  v18 = [v13 initWithQuantityType:v14 quantitySamplePredicate:v12 options:queryStatisticsOption anchorDate:startDate2 intervalComponents:statisticsInterval];

  v19 = objc_alloc(MEMORY[0x1E696C4D8]);
  v20 = [MEMORY[0x1E696C370] quantityTypeForIdentifier:*MEMORY[0x1E696BC88]];
  queryStatisticsOption2 = [(HKBloodPressureDataSource *)self queryStatisticsOption];
  startDate3 = [requestCopy startDate];
  statisticsInterval2 = [requestCopy statisticsInterval];
  v24 = [v19 initWithQuantityType:v20 quantitySamplePredicate:v12 options:queryStatisticsOption2 anchorDate:startDate3 intervalComponents:statisticsInterval2];
...
- (id)_chartPointsWithSystolicResults:(id)results diastolicResults:(id)diastolicResults blockStart:(id)start blockEnd:(id)end sourceTimeZone:(id)zone
{
  ...
  resultsCopy = results;
  diastolicResultsCopy = diastolicResults;
  startCopy = start;
  endCopy = end;
  zoneCopy = zone;
  ...
  if (v18 && v19)
  {
    ...
    v22 = v51[2](v51, v21, resultsCopy);
    [resultsCopy enumerateStatisticsFromDate:v18 toDate:v19 withBlock:v22];

    v23 = [MEMORY[0x1E696C370] quantityTypeForIdentifier:*MEMORY[0x1E696BC88]];
    v24 = v51[2](v51, v23, diastolicResultsCopy);
    [diastolicResultsCopy enumerateStatisticsFromDate:v18 toDate:v19 withBlock:v24];

    v20 = v52;
  }

  v48 = v18;
  v49 = diastolicResultsCopy;
  v50 = resultsCopy;
  ...
  if (v26)
  {
    ...
    do
    {
      for (i = 0; i != v27; ++i)
      {
        ...
        systolic = [v29 systolic];

        if (systolic)
        {
          v32 = [HKHealthChartPoint alloc];
          systolic2 = [v29 systolic];
          v34 = [(HKHealthChartPoint *)v32 initWithStatistics:systolic2 options:[(HKBloodPressureDataSource *)self queryStatisticsOption] unit:v25 displayType:displayType sourceTimeZone:zoneCopy];

          xValueAsGenericType = [(HKHealthChartPoint *)v34 xValueAsGenericType];
          [(HKBloodPressureChartPoint *)v30 setSystolicChartPoint:v34];
        }

        else
        {
          xValueAsGenericType = 0;
        }

        diastolic = [v29 diastolic];

        if (diastolic)
        {
          v37 = [HKHealthChartPoint alloc];
          diastolic2 = [v29 diastolic];
          v39 = [(HKHealthChartPoint *)v37 initWithStatistics:diastolic2 options:[(HKBloodPressureDataSource *)self queryStatisticsOption] unit:v25 displayType:displayType sourceTimeZone:zoneCopy];

          if (!xValueAsGenericType)
          {
            xValueAsGenericType = [(HKHealthChartPoint *)v39 xValueAsGenericType];
          }

          [(HKBloodPressureChartPoint *)v30 setDiastolicChartPoint:v39];
        }

        v40 = [xValueAsGenericType hk_dateFromSourceTimeZone:zoneCopy];
        [(HKBloodPressureChartPoint *)v30 setDate:v40];

        userInfoCreationBlock = self->_userInfoCreationBlock;
        if (userInfoCreationBlock)
        {
          systolic3 = [v29 systolic];
          diastolic3 = [v29 diastolic];
          v44 = userInfoCreationBlock[2](userInfoCreationBlock, systolic3, diastolic3);
...
- (id)chartPointsFromQueryData:(id)data dataIsFromRemoteSource:(BOOL)source
{
  ...
  v11 = [(HKCodableChartBloodPressureDataSourceQueryData *)v9 initWithData:queryDataObject];

  v12 = MEMORY[0x1E696C4C8];
  systolicStatisticsCollection = [(HKCodableChartBloodPressureDataSourceQueryData *)v11 systolicStatisticsCollection];
  v14 = [v12 statisticsCollectionWithCodableCollection:systolicStatisticsCollection];

  v15 = MEMORY[0x1E696C4C8];
  diastolicStatisticsCollection = [(HKCodableChartBloodPressureDataSourceQueryData *)v11 diastolicStatisticsCollection];
  v17 = [v15 statisticsCollectionWithCodableCollection:diastolicStatisticsCollection];
...
- (id)_earliestDateForSystolicResults:(id)results diastolicResults:(id)diastolicResults
{
  ...
  statistics2 = [diastolicResultsCopy statistics];

  firstObject2 = [statistics2 firstObject];
...
- (id)_latestDateForSystolicResults:(id)results diastolicResults:(id)diastolicResults
{
  diastolicResultsCopy = diastolicResults;
  statistics = [results statistics];
  lastObject = [statistics lastObject];
  endDate = [lastObject endDate];

  statistics2 = [diastolicResultsCopy statistics];

  lastObject2 = [statistics2 lastObject];
  ...
  if (endDate)
  {
    ...
    if (endDate2)
    {
      if ([endDate hk_isBeforeDate:endDate2])
      {
        v12 = endDate2;
      }
