...
- (id)title
{
  ...
  v3 = [v2 localizedStringForKey:@"medical_conditions" value:&stru_1F42FFBE0 table:@"HealthUI-Localizable"];
...
{
  v2 = [MEMORY[0x1E696AAE8] bundleWithIdentifier:@"com.apple.HealthUI"];
  v3 = [v2 localizedStringForKey:@"medical_conditions_none_listed" value:&stru_1F42FFBE0 table:@"HealthUI-Localizable"];
