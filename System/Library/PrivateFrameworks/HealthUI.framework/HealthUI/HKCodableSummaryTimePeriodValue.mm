...
- (void)setHasTimeInterval:(BOOL)interval;
- (void)writeTo:(id)to;
@end
...
- (id)description
{
  ...
  dictionaryRepresentation = [(HKCodableSummaryTimePeriodValue *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  if ((has & 2) != 0)
  {
    ...
    [dictionary setObject:v5 forKey:@"timeInterval"];
...
- (BOOL)isEqual:(id)equal
{
  ...
  if ((*&self->_has & 2) != 0)
  {
    if ((*(equalCopy + 24) & 2) == 0 || self->_timeInterval != *(equalCopy + 2))
    {
      goto LABEL_11;
    }
  }
