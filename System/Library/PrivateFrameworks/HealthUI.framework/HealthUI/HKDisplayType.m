...
- (void)_assignBloodPressureAxisForSeries:(id)a3 standardAxisConfiguration:(id)a4 externalAxisConfigurationOverrides:(id)a5;
...
- (unint64_t)roundingMode
{
  v2 = [(HKDisplayType *)self displayTypeIdentifier];
  result = 1;
  if (v2 > 178)
  {
    if (((v2 - 280) > 0x18 || ((1 << (v2 - 24)) & 0x107C04F) == 0) && v2 != 179 && v2 != 186)
    {
      return 0;
    }
  }

  else if ((v2 - 75) > 0x3F || ((1 << (v2 - 75)) & 0x8000005806000111) == 0)
  {
    v4 = v2 - 7;
...
{
  v6 = a3;
  v7 = [(HKDisplayType *)self chartingRules];
  v8 = [v7 allowedDecimalPrecisionRuleForUnit:v6];

  v9 = [(HKDisplayType *)self objectType];
  v10 = [v9 hk_numberFormatterForUnit:v6 decimalPrecisionRule:v8 formattingContext:a4];
...
- (id)hk_customSeriesPointIntervalComponentsForTimeScope:(int64_t)a3 resolution:(int64_t)a4
{
  v5 = [(HKDisplayType *)self chartableDisplayType:a3];
  v6 = [v5 hk_customSeriesPointIntervalComponentsForTimeScope:a3 resolution:0];
...
- (unint64_t)hk_chartCalendarUnitForTimeScope:(int64_t)a3
{
  v4 = [(HKDisplayType *)self chartableDisplayType];
  v5 = [v4 hk_chartCalendarUnitForTimeScope:a3];
...
{
  v8 = a5;
  v9 = [(HKDisplayType *)self hk_defaultChartAxisBoundStringFromValue:a3 defaultNumberFormatter:a4 unitController:v8];
  v10 = [(HKDisplayType *)self presentation];
  v11 = [v10 shouldDisplayUnitStringOnYAxis];
...
- (id)hk_defaultChartAxisBoundStringFromValue:(id)a3 defaultNumberFormatter:(id)a4 unitController:(id)a5
{
  ...
  v9 = a4;
  v10 = a3;
  v11 = [v8 unitForDisplayType:self];
  ...
  v16 = HKFormattedStringFromValue(v10, self, v8, 1, v15);
...
- (id)_dataSourceForTimeScope:(int64_t)a3 dataCacheController:(id)a4
{
  v4 = [a4 interactiveChartsCacheForDisplayType:self timeScope:a3];
...
- (id)_generateMinMaxSeriesWithColor:(id)a3 opacity:(double)a4 unselectedPointStyle:(int64_t)a5 selectedPointStyle:(int64_t)a6
{
  ...
  v11 = [HKChartSeriesPointMarker chartPointWithColor:v9 radius:a5 style:4.0];
  [(HKMinMaxSeries *)v10 setUnselectedPointMarkerImage:v11];

  v12 = [v9 colorWithAlphaComponent:a4];
  ...
  v15 = [v9 colorWithAlphaComponent:a4];
...
- (id)_generateBarSeriesWithFillStyle:(id)a3
{
  ...
  v7 = [HKStrokeStyle strokeStyleWithColor:v6 lineWidth:3.0];
  ...
  v11 = [MEMORY[0x1E69DC888] hk_chartInactiveSeriesColor];
...
- (id)_generateInsulinBarSeriesWithDisplayCategory
{
  ...
  v7 = [MEMORY[0x1E69DC888] hk_insulinBasalKeyColor];
  ...
  v11 = [MEMORY[0x1E69DC888] hk_chartBackgroundColor];
  v12 = [HKStrokeStyle strokeStyleWithColor:v11 lineWidth:3.0];
  ...
  v15 = [MEMORY[0x1E69DC888] hk_chartGrayGraphColor];
  [(HKSolidFillStyle *)v14 setColor:v15];

  v16 = objc_alloc_init(HKSolidFillStyle);
  v17 = [MEMORY[0x1E69DC888] hk_chartInactiveSeriesColor];
...
- (id)_generateHandwashingBarSeriesWithDisplayCategory:(id)a3
{
  ...
  v12 = [MEMORY[0x1E69DC888] hk_otherSecondaryColor];
...
- (id)_generateStackedSeriesWithColor:(id)a3 numericAxisConfigurationOverrides:(id)a4
{
  ...
  v9 = [(HKDisplayType *)self hk_enumeratedValueLabels];
  [(HKHorizontalTimePeriodSeries *)v8 setValueLabels:v9];

  v10 = [(HKDisplayType *)self hk_valueOrderForStackedCharts];
...
- (id)_generateSingleLineSeriesWithColor:(id)a3 timeScope:(int64_t)a4 numericAxisConfigurationOverrides:(id)a5
{
  ...
  if (a4 != 6)
  {
    v11 = [(HKDisplayType *)self chartingRules];
    v12 = [v11 shouldConnectSamplesWithLines];
...
- (id)_generateLevelCategorySeriesWithColor:(id)a3 numericAxisConfigurationOverrides:(id)a4
{
  ...
  v10 = [MEMORY[0x1E69DC888] hk_chartLightGrayTextColor];
  [(HKLevelCategoryTimePeriodSeries *)v8 setCategoryLevelColor:v10];

  [(HKHorizontalTimePeriodSeries *)v8 setFillColor:v7];
  v11 = [(HKDisplayType *)self hk_enumeratedValueLabels];
  [(HKHorizontalTimePeriodSeries *)v8 setValueLabels:v11];

  v12 = [(HKDisplayType *)self hk_valueOrderForStackedCharts];
  ...
  v15 = [(HKDisplayType *)self chartingRules];

  if (v15)
  {
    v16 = [(HKDisplayType *)self chartingRules];
...
{
  v3 = a3;
  v4 = [[HKJulianIndexedSevenDayQuantitySeries alloc] initWithColor:v3 lineWidth:6.0];
...
- (id)_generateAFibBurdenLineSeriesWithColor:(id)a3
{
  v3 = [(HKDisplayType *)self generateLineSeriesWithColor:a3 timeScope:3];
...
- (void)_assignBloodPressureAxisForSeries:(id)a3 standardAxisConfiguration:(id)a4 externalAxisConfigurationOverrides:(id)a5
{
  if (!a5)
  {
    ...
    [(HKNumericAxisConfiguration *)v11 applyOverridesFromNumericAxisConfiguration:v7];
...
{
  v10 = a3;
  v11 = [(HKDisplayType *)self generateLineSeriesWithColor:v10 timeScope:a4 valueAxisAnnotationFormatter:a5];
  v12 = [HKRelativeLineSeries alloc];
  v13 = [MEMORY[0x1E69DC888] systemGray3Color];
  v14 = [(HKRelativeLineSeries *)v12 initFromLineSeries:v11 color:v10 unavailableColor:v13 indeterminateLozengeLineWidth:a6 chartSizeClass:6.0];
...
{
  v6 = [a3 color];
  v7 = [(HKDisplayType *)self generateLineSeriesWithColor:v6 timeScope:a4];
...
- (id)_generateGraphSeriesForTimeScope:(int64_t)a3 displayCategory:(id)a4 unitController:(id)a5 standardAxisConfiguration:(id)a6 externalAxisConfigurationOverrides:(id)a7 chartSizeClass:(int64_t)a8
{
  ...
  {
LABEL_5:
    v18 = [v15 unitForDisplayType:self];
    v19 = [(HKDisplayType *)self hk_numberFormatterForUnit:v18];
    v25 = [v14 color];
  ...
  {
    v29 = [v14 color];
    v24 = [(HKDisplayType *)self _generateBloodPressureSeriesWithColor:v29];

    [(HKDisplayType *)self _assignBloodPressureAxisForSeries:v24 standardAxisConfiguration:v16 externalAxisConfigurationOverrides:v17];
    goto LABEL_8;
  }

  if ([(HKDisplayType *)self displayTypeIdentifier]== 125)
  {
    v30 = [(HKDisplayType *)self _generateInsulinBarSeriesWithDisplayCategory];
LABEL_15:
    v24 = v30;
    goto LABEL_8;
  }
  ...
  {
    v18 = [v14 color];
    v19 = [MEMORY[0x1E696ADA0] hk_wholeNumberFormatter];
    v20 = [(HKDisplayType *)self hk_supportsMinMaxOverlayForChartSizeClass:a8];
    v21 = self;
    v22 = v18;
    v23 = v19;
    goto LABEL_3;
  ...
  {
    v30 = [(HKDisplayType *)self _generateHandwashingBarSeriesWithDisplayCategory:v14];
    goto LABEL_15;
  }

  if ([(HKDisplayType *)self displayTypeIdentifier]== 14)
  {
    v18 = [[HKDisplayTypeNumberFormatter alloc] initWithDisplayType:self unitController:v15];
    v31 = [v14 color];
  ...
  if ([(HKDisplayType *)self displayTypeIdentifier]== 248)
  {
    ...
    {
      [(HKDisplayType *)self _generateJulianIndexedSevenDayQuantitySeriesWithColor:v32];
    }
    v24 = ;
  ...
  {
    v33 = [(HKDisplayType *)self chartingRules];
...
LABEL_7:
  ...
  {
    v18 = [v14 color];
    v24 = [(HKDisplayType *)self _generateMinMaxSeriesWithColor:v18 opacity:0 unselectedPointStyle:0 selectedPointStyle:1.0];
    goto LABEL_7;
  }
  ...
  if ([(HKDisplayType *)self displayTypeIdentifier]== 187 || [(HKDisplayType *)self displayTypeIdentifier]== 188 || [(HKDisplayType *)self displayTypeIdentifier]== 195 || [(HKDisplayType *)self displayTypeIdentifier]== 196)
  {
    ...
    v35 = [(HKTieredDecimalPrecisionRule *)v34 numberFormatter];
...
LABEL_42:
  ...
  {
    v35 = [v14 color];
    v37 = [HKMobilityUtilities generateAppleWalkingSteadinessSeriesForTimeScope:a3 displayType:self color:v35];
LABEL_45:
    v24 = v37;
    goto LABEL_42;
  }
  ...
  {
    v30 = [HKStateOfMindSeries standardStateOfMindSeriesWithStateOfMindDisplayType:self unitController:v15];
    goto LABEL_15;
  }

  if ([(HKDisplayType *)self displayTypeIdentifier]== 275)
  {
    v30 = [(HKDisplayType *)self _generateAbnormalBreathingSeriesWithDisplayCategory:v14 timeScope:a3];
    goto LABEL_15;
  }
  ...
  {
    v35 = [(HKDisplayType *)self chartingRules];
    v37 = -[HKDisplayType _generateStandardSeriesForChartStyle:timeScope:chartSizeClass:axisConfiguration:displayCategory:unitController:](self, "_generateStandardSeriesForChartStyle:timeScope:chartSizeClass:axisConfiguration:displayCategory:unitController:", [v35 chartStyleForTimeScope:a3], a3, a8, v16, v14, v15);
    goto LABEL_45;
  }

  v40 = [MEMORY[0x1E69DC888] hk_pregnancyKeyColor];
  v24 = [(HKDisplayType *)self _generateLevelCategorySeriesWithColor:v40 numericAxisConfigurationOverrides:v16];

  [v16 setBottomLegendViewPadding:4.0];
LABEL_8:
  v26 = [v14 color];
  [v24 setOffScreenIndicatorColor:v26];

  v27 = [(HKDisplayType *)self chartingRules];
  [v24 setWantsRoundingDuringYRangeExpansion:{objc_msgSend(v27, "shouldRoundYAxisDuringExpansion")}];
...
- (id)_generateStandardSeriesForChartStyle:(int64_t)a3 timeScope:(int64_t)a4 chartSizeClass:(int64_t)a5 axisConfiguration:(id)a6 displayCategory:(id)a7 unitController:(id)a8
{
  ...
  if (a3 <= 4)
  {
    if (a3 > 2)
    {
      ...
      {
        v18 = [v15 color];
        [(HKDisplayType *)self _generateMinMaxSeriesWithColor:v18 opacity:1 unselectedPointStyle:0 selectedPointStyle:0.3];
      }

      else
      {
        v18 = [v15 fillStyle];
        [(HKDisplayType *)self _generateBarSeriesWithFillStyle:v18];
      }
      v19 = ;
    }
    ...
    {
      v18 = [v15 color];
      v19 = [(HKDisplayType *)self generateLineSeriesWithColor:v18 timeScope:a4];
    }
    ...
    else
    {
      ...
      v18 = [v15 color];
      v19 = [(HKDisplayType *)self generateScatterPlotSeriesWithColor:v18];
    }
  }
  ...
  else if (a3 > 7)
  {
    if (a3 != 8)
    {
      ...
      v18 = [v15 color];
      v20 = [[HKDisplayTypeNumberFormatter alloc] initWithDisplayType:self unitController:v16];
      v17 = [(HKDisplayType *)self generateDistributionSeriesWithColor:v18 numberFormatter:v20 hasMinMaxOverlay:[(HKDisplayType *)self hk_supportsMinMaxOverlayForChartSizeClass:a5]];

      goto LABEL_21;
    }

    v18 = [v15 color];
    v19 = [(HKDisplayType *)self _generateLevelCategorySeriesWithColor:v18 numericAxisConfigurationOverrides:v14];
  }
  ...
  else if ((a3 - 5) >= 2)
  {
    ...
    v18 = [v15 color];
    v19 = [(HKDisplayType *)self _generateSingleLineSeriesWithColor:v18 timeScope:a4 numericAxisConfigurationOverrides:v14];
  }

  else
  {
    v18 = [v15 color];
    v19 = [(HKDisplayType *)self _generateStackedSeriesWithColor:v18 numericAxisConfigurationOverrides:v14];
  }
...
- (id)hk_standardSeriesForTimeScope:(int64_t)a3 displayCategory:(id)a4 unitController:(id)a5 dataCacheController:(id)a6 numericAxisConfigurationOverrides:(id)a7
{
  ...
  v14 = a5;
  v15 = a4;
  v16 = [(HKDisplayType *)self _dataSourceForTimeScope:a3 dataCacheController:v13];
  v17 = [(HKDisplayType *)self hk_standardSeriesForTimeScope:a3 graphSeriesDataSource:v16 displayCategory:v15 unitController:v14 dataCacheController:v13 numericAxisConfigurationOverrides:v12];
...
- (id)hk_standardSeriesForTimeScope:(int64_t)a3 displayCategory:(id)a4 unitController:(id)a5 dataCacheController:(id)a6 numericAxisConfigurationOverrides:(id)a7 chartSizeClass:(int64_t)a8
{
  ...
  v16 = a5;
  v17 = a4;
  v18 = [(HKDisplayType *)self _dataSourceForTimeScope:a3 dataCacheController:v15];
  v19 = [(HKDisplayType *)self hk_standardSeriesForTimeScope:a3 graphSeriesDataSource:v18 displayCategory:v17 unitController:v16 dataCacheController:v15 numericAxisConfigurationOverrides:v14 chartSizeClass:a8];
...
- (id)hk_standardSeriesForTimeScope:(int64_t)a3 graphSeriesDataSource:(id)a4 displayCategory:(id)a5 unitController:(id)a6 dataCacheController:(id)a7 numericAxisConfigurationOverrides:(id)a8 chartSizeClass:(int64_t)a9
{
  ...
  v16 = a6;
  v17 = a8;
  v18 = [(HKDisplayType *)self chartingRules];
  v19 = [v18 chartStyleForTimeScope:a3];

  v20 = objc_alloc_init(HKNumericAxisConfiguration);
  v21 = [(HKDisplayType *)self hk_dimensionForChartAxisWithUnitController:v16];
  ...
  if (v14)
  {
    v30 = [(HKDisplayType *)self _generateGraphSeriesForTimeScope:a3 displayCategory:v15 unitController:v16 standardAxisConfiguration:v20 externalAxisConfigurationOverrides:v17 chartSizeClass:a9];
    ...
    v33 = [(HKDisplayType *)self hk_axisScalingRuleForChartSizeClass:a9 unitController:v16];
    [v30 setAxisScalingRule:v33];
    v34 = [(HKDisplayType *)self presentation];
    [v30 setIsCriticalForAutoscale:{objc_msgSend(v34, "isCriticalForAutoscale")}];

    v35 = [(HKDisplayType *)self chartingRules];
    [v30 setInvertYAxis:{objc_msgSend(v35, "shouldInvertYAxis")}];
  }
...
{
  v6 = a3;
  v7 = [(HKDisplayType *)self objectType];
  v8 = [v7 hk_valueFormatterClassForUnit:v6];
...
{
  v6 = a4;
  if (a3 == 1 && (-[HKDisplayType chartingRules](self, "chartingRules"), v7 = objc_claimAutoreleasedReturnValue(), [v7 compactChartAxisScalingRule], v8 = objc_claimAutoreleasedReturnValue(), v8, v7, v8))
  {
    v9 = [(HKDisplayType *)self chartingRules];
    v10 = [v9 compactChartAxisScalingRule];
  }

  else
  {
    v9 = [(HKDisplayType *)self chartingRules];
    v10 = [v9 axisScalingRule];
  }

  v11 = v10;

  v12 = [v6 unitForChartingDisplayType:self];
...
- (int64_t)hk_stackedChartSectionsCountForTimeScope:(int64_t)a3
{
  v5 = [(HKDisplayType *)self chartingRules];
  ...
  {
    v7 = [(HKDisplayType *)self hk_enumeratedValueLabels];
    v8 = [v7 count];
    if (v8 <= 1)
    {
      v6 = 1;
...
- (BOOL)contextItemShouldUseTightSpacingBetweenValueAndUnit
{
  v3 = [(HKDisplayType *)self objectType];
  v4 = [v3 hk_valueFormatterClass];

  result = 1;
  if (v4 != objc_opt_class())
  {
    v5 = [(HKDisplayType *)self objectType];
    objc_opt_class();
    ...
    v7 = [(HKDisplayType *)self objectType];
    v8 = [v7 canonicalUnit];
    v9 = [MEMORY[0x1E696C510] degreeCelsiusUnit];
...
- (HKDisplayType)initWithDisplayTypeIdentifier:(int64_t)a3 categoryIdentifier:(int64_t)a4 secondaryCategoryIdentifiers:(id)a5 objectType:(id)a6 behavior:(id)a7 presentation:(id)a8 localization:(id)a9 chartingRules:(id)a10 defaultChartingPredicate:(id)a11 chartingPredicatesByTimeScope:(id)a12
{
  ...
  if (v22)
  {
    v22->_displayTypeIdentifier = a3;
    v22->_categoryIdentifier = a4;
    v24 = [v16 copy];
    ...
    objc_storeStrong(&v23->_chartingRules, a10);
    objc_storeStrong(&v23->_defaultChartingPredicate, a11);
    v34 = [v21 copy];
...
- (id)copyWithIsWheelchairUser:(BOOL)a3
{
  ...
  *(v5 + 48) = v3;
  ...
  v7 = [(HKDisplayType *)self localizedStringSuffixForWheelchairUser:v3];
...
- (id)chartingPredicateForTimeScope:(int64_t)a3
{
  ...
  else
  {
    ...
    {
      v10 = [(HKDisplayType *)self defaultValuePredicate];
    }
...
- (id)unitNameForValue:(id)a3 unitPreferenceController:(id)a4
{
  v6 = a4;
  v7 = a3;
  v8 = [v6 unitForDisplayType:self];
  v9 = [v6 localizedDisplayNameForUnit:v8 value:v7];
...
- (UIImage)dataTypeIconImage
{
  ...
  if (!dataTypeIconImage)
  {
    ...
    v5 = [(HKDisplayType *)self presentation];
    v6 = [v5 dataTypeIconImageName];
    v7 = [v4 _systemImageNamed:v6];

    if (v7)
    {
      v8 = v7;
      v9 = self->_dataTypeIconImage;
      self->_dataTypeIconImage = v8;
    }

    else
    {
      v9 = [(HKDisplayType *)self displayCategory];
      v10 = [v9 listIcon];
      v11 = self->_dataTypeIconImage;
      self->_dataTypeIconImage = v10;
    }
...
- (UIImage)detailImage
{
  ...
  if (!detailImage)
  {
    v4 = [(HKDisplayType *)self presentation];
    v5 = [v4 detailImageName];
    if (v5)
    {
      v6 = MEMORY[0x1E69DCAB8];
      v7 = [(HKDisplayType *)self presentation];
      v8 = [v7 detailImageName];
...
- (UIImage)listIcon
{
  if (!self->_listIcon)
  {
    v3 = [(HKDisplayType *)self presentation];
    v4 = [v3 listIconImageNameOverride];

    if (v4)
    {
      v5 = MEMORY[0x1E69DCAB8];
      v6 = [(HKDisplayType *)self presentation];
      v7 = [v6 listIconImageNameOverride];
    ...
    {
      v6 = [(HKDisplayType *)self displayCategory];
      v11 = [v6 listIcon];
      v7 = self->_listIcon;
      self->_listIcon = v11;
    }
...
- (NSString)listIconImageName
{
  ...
  {
    v7 = [(HKDisplayType *)self displayCategory];
    v6 = [v7 listIconName];
  }
...
- (NSArray)secondaryDisplayCategories
{
  ...
  v4 = [(HKDisplayType *)self secondaryCategoryIdentifiers];
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (objc_opt_isKindOfClass())
  {
    ...
    v6 = displayTypeIdentifier == [v4 displayTypeIdentifier];
  }
...
- (id)generateLineSeriesWithColor:(id)a3 timeScope:(int64_t)a4
{
  ...
  v8 = [(HKDisplayType *)self generateLineSeriesWithColor:v6 timeScope:a4 valueAxisAnnotationFormatter:v7];
...
- (id)generateLineSeriesWithColor:(id)a3 timeScope:(int64_t)a4 valueAxisAnnotationFormatter:(id)a5
{
  ...
  v15 = [HKStrokeStyle strokeStyleWithColor:v7 lineWidth:2.0];
  ...
  v47 = v7;
  v17 = [HKStrokeStyle strokeStyleWithColor:v7 lineWidth:2.0];
  ...
  v45 = [MEMORY[0x1E69DC888] hk_chartInactiveSeriesColor];
  ...
  if ([v26 lineChartUsesPointMarkerImageForTimeScope:v28])
  {
    ...
    v31 = [[HKLineSeriesPointMarkerStyle alloc] initWithColor:v45 radius:1 style:4.0];
...
- (id)generateScatterPlotSeriesWithColor:(id)a3
{
  ...
  v5 = [[HKLineSeriesPointMarkerStyle alloc] initWithColor:v3 radius:1 style:4.0];
  ...
  v16 = [MEMORY[0x1E69DC888] hk_chartInactiveSeriesColor];
  v17 = objc_alloc_init(HKLineSeriesPresentationStyle);
  v18 = [[HKLineSeriesPointMarkerStyle alloc] initWithColor:v16 radius:1 style:4.0];
...
- (id)generateDistributionSeriesWithColor:(id)a3 numberFormatter:(id)a4 lineWidth:(double)a5 hasMinMaxOverlay:(BOOL)a6
{
  ...
  v12 = [MEMORY[0x1E69DC888] hk_chartInactiveSeriesColor];
  v13 = [HKStrokeStyle strokeStyleWithColor:v12 lineWidth:a5];
  [v13 setLineCap:1];
  [(HKQuantityDistributionSeries *)v11 setInactiveStrokeStyle:v13];
  v14 = v9;
  v15 = [HKStrokeStyle strokeStyleWithColor:v14 lineWidth:a5];
  [v15 setLineCap:1];
  [(HKQuantityDistributionSeries *)v11 setUnselectedStrokeStyle:v15];
  v16 = [HKStrokeStyle strokeStyleWithColor:v14 lineWidth:a5];
  [v16 setLineCap:1];
...
- (id)cardioFitnessDataSourceWithUnitController:(id)a3 healthStore:(id)a4
{
  v6 = a4;
  v7 = a3;
  v8 = [[HKQuantityTypeDataSource alloc] initWithUnitController:v7 options:2 displayType:self healthStore:v6];
  v9 = [v7 unitForDisplayType:self];

  v25 = 0;
  v10 = [v6 biologicalSexWithError:&v25];
  v11 = v25;
  if (!v10)
  {
  ...
  v24 = v11;
  v13 = [v6 dateOfBirthComponentsWithError:&v24];
  v14 = v24;
...
- (id)_audioLevelDataSourceForTypeIdentifier:(id)a3 withHealthStore:(id)a4 attenuatesExposureData:(BOOL)a5 unitController:(id)a6
{
  ...
  v19 = [MEMORY[0x1E696C370] quantityTypeForIdentifier:v11];
  ...
  v23[3] = &unk_1E81B95E0;
  v23[4] = self;
  v21 = [(HKQuantityDistributionDataSource *)v20 initWithQuantityType:v19 unitController:v15 healthStore:v16 contextStyle:0 predicate:0 options:v18 baseDisplayType:self specificStartDate:0 specificEndDate:0 userInfoCreationBlock:v23];
...
- (BOOL)allowsManualEntry
{
  ...
  if (v2 > 235)
  {
    if ((v2 - 236) > 0x34 || ((1 << (v2 + 20)) & 0x1A01903C147001) == 0)
    {
      v4 = v2 - 305;
  ...
  else if (((v2 - 137) > 0x3E || ((1 << (v2 + 119)) & 0x41C2061800080489) == 0) && ((v2 - 70) > 0x25 || ((1 << (v2 - 70)) & 0x2040000021) == 0) && v2 != 13)
  {
    return 1;
  }
...
{
  v3 = a3;
  v4 = [(HKDisplayType *)self displayTypeIdentifier];
  v5 = (v4 - 70) > 0x1E || ((1 << (v4 - 70)) & 0x40000021) == 0;
  if (v5 && v4 != 186)
  {
    v6 = 0;
  }
  ...
  {
    v6 = [MEMORY[0x1E696C1C0] localizationStringSuffixForWheelchairUser:v3];
  }
...
- (UIImage)shareIcon
{
  v3 = [(HKDisplayType *)self displayTypeIdentifier];
  if (v3 == 13)
  {
    v4 = MEMORY[0x1E69DCAB8];
...
LABEL_5:
  ...
  v5 = [(HKDisplayType *)self displayCategory];
  v7 = [v5 shareIcon];
LABEL_7:
  v8 = v7;
    ...
    if (a3 <= 286)
    {
      switch(a3)
      {
        ...
        case 169:
          ...
          v15 = [v16 localizedStringForKey:@"PRESENCE_PRESENT" value:&stru_1F42FFBE0 table:@"HealthCharts-Localizable"];
          v78[1] = &unk_1F4384270;
          v79[0] = v15;
        ...
        case 170:
          ...
          v16 = [MEMORY[0x1E696AAE8] bundleWithIdentifier:@"com.apple.HealthCharts"];
          v15 = [v16 localizedStringForKey:@"APPETITE_CHANGES_UNSPECIFIED" value:&stru_1F42FFBE0 table:@"HealthCharts-Localizable"];
          v101[0] = v15;
        ...
        case 178:
          ...
          v15 = [v16 localizedStringForKey:@"NOISE_NOTIFICATION_LOUD_ENVIRONMENT" value:&stru_1F42FFBE0 table:@"HealthUI-Localizable"];
          v89 = v15;
        ...
        case 199:
          v84 = &unk_1F4384270;
          v16 = [MEMORY[0x1E696AAE8] bundleWithIdentifier:@"com.apple.HealthUI"];
          v15 = [v16 localizedStringForKey:@"HEADPHONE_NOTIFICATION_LOUD_ENVIRONMENT" value:&stru_1F42FFBE0 table:@"HealthUI-Localizable"];
          v85 = v15;
          v32 = MEMORY[0x1E695DF20];
          v33 = &v85;
          v34 = &v84;
        ...
        case 236:
          ...
          v15 = [v16 localizedStringForKey:@"CARDIO_FITNESS_EVENT_LOW_THRESHOLD" value:&stru_1F42FFBE0 table:@"Localizable-CardioFitness"];
          v83 = v15;
          v32 = MEMORY[0x1E695DF20];
          v33 = &v83;
          v34 = &v82;
LABEL_32:
        ...
        case 243:
          v72[0] = &unk_1F4384270;
          v16 = [MEMORY[0x1E696AAE8] bundleWithIdentifier:@"com.apple.HealthCharts"];
          v15 = [v16 localizedStringForKey:@"PREGNANCY_TEST_RESULT_NEGATIVE" value:&stru_1F42FFBE0 table:@"HealthCharts-Localizable"];
          v73[0] = v15;
          v72[1] = &unk_1F4384288;
          v18 = [MEMORY[0x1E696AAE8] bundleWithIdentifier:@"com.apple.HealthCharts"];
        ...
        case 244:
          v70[0] = &unk_1F4384270;
          v16 = [MEMORY[0x1E696AAE8] bundleWithIdentifier:@"com.apple.HealthCharts"];
          v15 = [v16 localizedStringForKey:@"PROGESTERONE_TEST_RESULT_NEGATIVE" value:&stru_1F42FFBE0 table:@"HealthCharts-Localizable"];
          v71[0] = v15;
          v70[1] = &unk_1F4384288;
          v18 = [MEMORY[0x1E696AAE8] bundleWithIdentifier:@"com.apple.HealthCharts"];
...
LABEL_28:
        ...
        case 250:
          ...
          v97[0] = v16;
          v96[1] = &unk_1F4384288;
          v15 = [HKMobilityUtilities localizedTitleForWalkingSteadinessEventCategoryValue:2];
          v97[1] = v15;
          v96[2] = &unk_1F43842A0;
...
LABEL_34:
    ...
    v86[0] = &unk_1F4384270;
    v16 = [MEMORY[0x1E696AAE8] bundleWithIdentifier:@"com.apple.HealthUI"];
    v15 = [v16 localizedStringForKey:@"GAD7_RISK_NONE_TO_MINIMAL" value:&stru_1F42FFBE0 table:@"HealthUI-Localizable-Chamomile"];
    v87[0] = v15;
    v86[1] = &unk_1F4384288;
  ...
  if (a3 <= 90)
  {
    if (a3 == 63)
    {
      ...
      v15 = [v67 localizedStringForKey:@"IN_BED" value:&stru_1F42FFBE0 table:@"HealthUI-Localizable"];
      v69[0] = v15;
      v68[1] = &unk_1F4384270;
      v64 = [MEMORY[0x1E696AAE8] bundleWithIdentifier:@"com.apple.HealthUI"];
...
LABEL_39:
    ...
    v98[0] = &unk_1F4384258;
    v16 = [MEMORY[0x1E696AAE8] bundleWithIdentifier:@"com.apple.HealthUI"];
    v15 = [MEMORY[0x1E696C1C0] localizationStringAdditionForWheelchairUser];
    v18 = [@"STOOD" stringByAppendingString:v15];
...
LABEL_43:
  ...
  switch(a3)
  {
    ...
    case '\\':
      v76[0] = &unk_1F4384270;
      v16 = [MEMORY[0x1E696AAE8] bundleWithIdentifier:@"com.apple.HealthCharts"];
      v15 = [v16 localizedStringForKey:@"OVULATION_TEST_RESULT_NEGATIVE_LOW" value:&stru_1F42FFBE0 table:@"HealthCharts-Localizable"];
      v77[0] = v15;
      v76[1] = &unk_1F4384288;
      v18 = [MEMORY[0x1E696AAE8] bundleWithIdentifier:@"com.apple.HealthCharts"];
...
- (id)hk_healthQueryChartCacheDataSourceForTimeScope:(int64_t)a3 healthStore:(id)a4 unitController:(id)a5
{
  ...
  switch([(HKDisplayType *)self displayTypeIdentifier])
  {
    ...
    case 303:
    case 304:
      v11 = [(HKDisplayType *)self objectType];
      v10 = HKInteractiveChartDataSourceQuantityType(self, v11, a3, v8, v9, 0);
      goto LABEL_3;
    case 5:
    case 15:
    case 61:
    ...
    case 196:
    case 286:
      v12 = [(HKDisplayType *)self objectType];
      v13 = [[HKQuantityDistributionDataSource alloc] initWithQuantityType:v12 unitController:v9 healthStore:v8 contextStyle:0 predicate:0 options:0 baseDisplayType:self specificStartDate:0 specificEndDate:0 userInfoCreationBlock:&__block_literal_global_70];
      goto LABEL_5;
    case 14:
      v12 = [(HKDisplayType *)self objectType];
      v13 = [[HKQuantityDistributionDataSource alloc] initWithQuantityType:v12 unitController:v9 healthStore:v8 contextStyle:0 predicate:0 options:1 baseDisplayType:self specificStartDate:0 specificEndDate:0 userInfoCreationBlock:&__block_literal_global_584];
LABEL_5:
      v10 = v13;
    ...
    case 79:
      if (a3 == 6)
      {
        v14 = HKInteractiveChartDataSourceForWorkouts(self, v8);
      }

      else
      {
LABEL_23:
        v14 = HKInteractiveChartDataSourceChartStyle(self, a3, v8, v9);
      }

      goto LABEL_24;
    case 80:
      v14 = HKInteractiveChartDataSourceForBloodPressure(self, v8);
      goto LABEL_24;
    case 95:
      v14 = HKInteractiveChartDataSourceForMenstruation(self, a3, v8);
      goto LABEL_24;
    case 97:
      v14 = HKInteractiveChartDataSourceCount(self, v8);
      goto LABEL_24;
    case 125:
      v14 = HKInteractiveChartDataSourceForInsulinDelivery(self, v8);
      goto LABEL_24;
    case 172:
    case 173:
    case 272:
      v14 = HKInteractiveChartDataSourceForAudioLevel(self, v8, v9);
      goto LABEL_24;
    case 237:
      v14 = HKInteractiveChartDataSourceForHandwashingEvent(self, v8);
      goto LABEL_24;
    case 248:
      v14 = HKInteractiveChartDataSourceForAfibBurden(self, a3, v8, v9);
      goto LABEL_24;
    case 249:
      v14 = HKInteractiveChartDataSourceForAppleWalkingSteadiness(self, a3, v8, v9);
      goto LABEL_24;
    case 256:
      v14 = HKInteractiveChartDataSourceForSleepingWristTemperature(self, a3, v8, v9);
      goto LABEL_24;
    case 269:
      v11 = [(HKDisplayType *)self objectType];
      v15 = [(HKDisplayType *)self objectType];
      v16 = HKPreprocessingHandlerForUnderwaterDepth(v15, v8);
      v10 = HKInteractiveChartDataSourceQuantityType(self, v11, a3, v8, v9, v16);

LABEL_3:
      break;
    case 284:
      v14 = HKInteractiveChartDataSourceForStateOfMind(self, v8);
      goto LABEL_24;
    case 287:
    case 288:
      v14 = HKInteractiveChartDataSourceForScoredAssessment(self, v8);
      goto LABEL_24;
    case 305:
      v14 = HKInteractiveChartDataSourceForBalance(self, v8);
      goto LABEL_24;
    case 341:
      v14 = HKInteractiveChartDataSourceForSleepScore(self, v8);
LABEL_24:
      v10 = v14;
      break;
    default:
...
- (id)hk_standardInteractiveChartsFormatterForTimeScope:(int64_t)a3
{
  ...
  {
    v8 = [(HKDisplayType *)self chartingRules];
    v9 = [v8 chartStyleForTimeScope:a3];
    ...
    if ((v9 - 4) >= 3)
    {
      if ((v9 - 7) < 2)
      {
        ...
        v11 = [(HKDisplayType *)self localization];
        v12 = [v11 displayName];
        v13 = [(HKInteractiveChartCategoryValueFormatter *)v10 initWithLocalizedCategoryName:v12];
...
- (id)hk_interactiveChartsFormatterForTimeScope:(int64_t)a3
{
  v5 = [(HKDisplayType *)self displayTypeIdentifier];
  if (v5 <= 247)
  {
    if (v5 <= 124)
    {
      if (v5 > 79)
      {
        if (v5 != 80)
        {
          if (v5 == 95)
          {
            ...
            v12 = [(HKDisplayType *)self localization];
            v13 = [v12 displayName];
            v6 = [(HKInteractiveChartCategoryValueFormatter *)v11 initWithLocalizedCategoryName:v13];
...
LABEL_44:
    ...
    v8 = [[HKInteractiveChartAudioLevelStatFormatter alloc] initForDisplayType:self timeScope:a3];
    v6 = v8;
    v9 = 1;
LABEL_42:
...
LABEL_33:
  v10 = [(HKDisplayType *)self hk_standardInteractiveChartsFormatterForTimeScope:a3];
LABEL_45:
  v6 = v10;
LABEL_46:
...
LABEL_17:
            v8 = [[v7 alloc] initWithDisplayType:self unitPreferencesController:v4];
            goto LABEL_18;
          }
...
LABEL_13:
      v9 = 0;
LABEL_14:
      v8 = [HKChartAxisDimensionFactory dimensionWithPurpose:v9 displayType:self unitController:v4];
      goto LABEL_18;
    }
...
LABEL_18:
  ...
  if (v5 <= 0x3F)
  {
    ...
    if (v5 == 2)
    {
      v14 = [v4 unitForDisplayType:self];
      v15 = [MEMORY[0x1E696C510] footUnit];
...
LABEL_15:
  v10 = [(HKDisplayType *)self chartingRules];
  v11 = [v10 shouldDisplayUnitForAxisLabels];
...
- (BOOL)hk_healthQueryChartDataSourceDependsOnTimeScope
{
  ...
  switch(v2)
  {
    ...
    case 275:
      goto LABEL_6;
    default:
      if (((v2 - 63) > 0x24 || ((1 << (v2 - 63)) & 0x1330010081) == 0) && (v2 - 313) >= 2)
      {
LABEL_6:
        result = 0;
      }
...
- (id)hk_chartFactorDescriptionDisplayTypes
{
  ...
  if (v2 <= 247)
  {
    if (((v2 - 118) > 0x13 || ((1 << (v2 - 118)) & 0x80041) == 0) && v2 != 3)
    {
      goto LABEL_9;
    }
