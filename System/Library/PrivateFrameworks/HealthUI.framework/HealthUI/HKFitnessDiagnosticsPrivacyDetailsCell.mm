...
- (void)_setUpSubviews
{
  v8 = [(HKFitnessDiagnosticsPrivacyDetailsCell *)self contentView];
...
- (void)_setUpConstraints
{
  v20 = [(HKFitnessDiagnosticsPrivacyDetailsCell *)self contentView];
...
- (id)_attributedContentsTextViewStringForCurrentContentSizeCategory
{
  ...
  v4 = [(HKFitnessDiagnosticsPrivacyDetailsCell *)self _attributedTitleString];
  v5 = [v3 initWithAttributedString:v4];

  v6 = [(HKFitnessDiagnosticsPrivacyDetailsCell *)self _newLineAttributedString];
  ...
  for (i = 0; i != 7; ++i)
  {
    ...
    v9 = [(HKFitnessDiagnosticsPrivacyDetailsCell *)self _newLineAttributedString];
...
- (id)_attributedTitleString
{
  ...
  v3 = [(HKFitnessDiagnosticsPrivacyDetailsCell *)self _bodyEmph];
  v11[0] = v3;
  v10[1] = *MEMORY[0x1E69DB688];
  v4 = [(HKFitnessDiagnosticsPrivacyDetailsCell *)self _titleParagraphStyle];
  v11[1] = v4;
  ...
  v7 = [(HKFitnessDiagnosticsPrivacyDetailsCell *)self _localizedTitleString];
  v8 = [objc_alloc(MEMORY[0x1E696AAB0]) initWithString:v7 attributes:v6];
...
- (id)_titleParagraphStyle
{
  v2 = [(HKFitnessDiagnosticsPrivacyDetailsCell *)self _bulletContentFont];
...
- (id)_localizedBulletContentStringForBulletAtIndex:(int64_t)a3
{
  ...
  v4 = [objc_alloc(MEMORY[0x1E696AEC0]) initWithFormat:@"DATA_COLLECTION_BODY_BULLET_%ld", a3 + 1];
...
- (id)_attributedStringForBulletAtIndex:(int64_t)a3
{
  ...
  v13[1] = v5;
  v6 = [(HKFitnessDiagnosticsPrivacyDetailsCell *)self _bulletContentFont];
  v14[1] = v6;
  v13[2] = *MEMORY[0x1E69DB688];
  v7 = [(HKFitnessDiagnosticsPrivacyDetailsCell *)self _bulletContentParagraphStyle];
  v14[2] = v7;
...
- (id)_bulletContentParagraphStyle
{
  v3 = [(HKFitnessDiagnosticsPrivacyDetailsCell *)self _bulletContentFont];
  v4 = [(HKFitnessDiagnosticsPrivacyDetailsCell *)self _attributedStringForBullet];
  [v4 size];
  v6 = v5 + 14.0;
...
- (id)_attributedStringForBullet
{
  ...
  v2 = [(HKFitnessDiagnosticsPrivacyDetailsCell *)self _bulletFont];
  v8[0] = v2;
...
- (void)_updateForCurrentContentSizeCategory
{
  ...
  v5 = v4;
  v6 = [(HKFitnessDiagnosticsPrivacyDetailsCell *)self superviewTopToContentsTextViewFirstBaselineConstraint];
  [v6 setConstant:v5];

  v7 = [(HKFitnessDiagnosticsPrivacyDetailsCell *)self _bulletContentFont];
  [v7 _scaledValueForValue:32.0];
  v9 = v8;
  v10 = [(HKFitnessDiagnosticsPrivacyDetailsCell *)self contentsTextViewLastBaselineToSuperviewBottomConstraint];
  [v10 setConstant:v9];
  ...
  v14 = [(HKFitnessDiagnosticsPrivacyDetailsCell *)self _attributedContentsTextViewStringForCurrentContentSizeCategory];
...
- (void)traitCollectionDidChange:(id)a3
{
  ...
  if (v4)
  {
    v5 = [(HKFitnessDiagnosticsPrivacyDetailsCell *)self traitCollection];
