...
- (id)dictionaryRepresentation
{
  ...
  {
    v5 = [objc_alloc(MEMORY[0x1E695DF70]) initWithCapacity:{-[NSMutableArray count](self->_dateIntervals, "count")}];
    v13 = 0u;
    v14 = 0u;
    v15 = 0u;
    v16 = 0u;
  ...
  if (v7)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        [(HKCodableHorizontalTimePeriodData *)self addDateIntervals:*(*(&v11 + 1) + 8 * v10++), v11];
      }
