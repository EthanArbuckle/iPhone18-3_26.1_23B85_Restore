...
LABEL_7:
  ...
  v22 = v15;
  if (![(CUIPlaceholderCUICommonAssetStorage *)v14 _commonInitWithStorage:v15 forWritting:v4])
  {
    BOMStorageFree(v22);
    goto LABEL_7;
  }
...
- (id)path
{
  ...
  return [v4 stringWithFileSystemRepresentation:v3 length:v5];
}
...
- (unsigned)thinnedWithCoreUIVersion
{
  ...
  if (result == -1)
  {
    v4 = [(CUIPlaceholderCUICommonAssetStorage *)self thinningArguments];
    result = 0x7FFFFFFF;
...
- (int64_t)deploymentPlatform
{
  v2 = [(CUIPlaceholderCUICommonAssetStorage *)self deploymentPlatformString];
...
- (void)_swapRenditionKeyArray:(unsigned __int16 *)a3
{
  v4 = [(CUIPlaceholderCUICommonAssetStorage *)self maximumRenditionKeyTokenCount];
  if (v4 >= 1)
  {
    do
    {
...
- (void)enumerateRenditionInfosUsingBlock:(id)a3
{
  ...
  if (!BOMTreeIteratorIsAtEnd(v6, v7, v8, v9, v10, v11, v12, v13))
  {
    do
    {
      ...
      if (v29 && v37)
      {
        ...
        v46 = [[CUIPlaceholderCUINamedRenditionInfo alloc] initWithData:v45 keyFormat:v5 andPlatform:[(CUIPlaceholderCUICommonAssetStorage *)self deploymentPlatform]];
        if (v46)
        {
          (*(a3 + 2))(a3, v21, v46);
        }
  ...
  [v55 drain];
  v54 = [(CUIPlaceholderCUICommonAssetStorage *)self lock];
...
{
  os_unfair_lock_lock([(CUIPlaceholderCUICommonAssetStorage *)self lock]);
  v7 = [(CUIPlaceholderCUICommonAssetStorage *)self _renditionKeyForName:a3 hotSpot:a4];
  os_unfair_lock_unlock([(CUIPlaceholderCUICommonAssetStorage *)self lock]);
  return v7;
}
...
LABEL_7:
  ...
  v9 = [(CUIPlaceholderCUICommonAssetStorage *)self swapped];
  v10 = strlen(a3);
...
LABEL_5:
  v18 = Value;
  if (a3 && !BOMTreeGetValueSize(self->_colordb, v22, 0x84uLL, &v21, v14, v15, v16, v17) && v21 == 12)
  {
    v19 = *v18;
    a3->var2 = *(v18 + 8);
    *&a3->var0 = v19;
...
- (const)_fontValueForFontType:(id)a3
{
  ...
  if (![a3 getBytes:v16 maxLength:128 usedLength:0 encoding:1 options:0 range:0 remainingRange:{objc_msgSend(a3, "length"), 0}])
  {
    return 0;
  }
...
{
  os_unfair_lock_lock([(CUIPlaceholderCUICommonAssetStorage *)self lock]);
  v9 = [(CUIPlaceholderCUICommonAssetStorage *)self _fontValueForFontType:a5];
  if (v9)
  {
    if (a3)
    {
      *a3 = [objc_alloc(MEMORY[0x1E696AEC0]) initWithBytes:v9 length:strlen(v9->var0) encoding:1];
    }
...
{
  os_unfair_lock_lock([(CUIPlaceholderCUICommonAssetStorage *)self lock]);
  v7 = [(CUIPlaceholderCUICommonAssetStorage *)self _fontValueForFontType:a4];
  if (a3 && v7)
  {
    *a3 = v7->var1;
  }
...
- (void)enumerateBitmapIndexUsingBlock:(id)a3
{
  os_unfair_lock_lock([(CUIPlaceholderCUICommonAssetStorage *)self lock]);
  v5 = [(CUIPlaceholderCUICommonAssetStorage *)self keyFormat];
  v6 = [(CUIPlaceholderCUICommonAssetStorage *)self deploymentPlatform];
  bitmapKeydb = self->_bitmapKeydb;
  if (bitmapKeydb)
  {
    ...
    if (!BOMTreeIteratorIsAtEnd(v8, v9, v10, v11, v12, v13, v14, v15))
    {
      do
      {
        ...
        v40 = [[CUIPlaceholderCUINamedRenditionInfo alloc] initWithData:v39 keyFormat:v5 andPlatform:v6];
        os_unfair_lock_unlock([(CUIPlaceholderCUICommonAssetStorage *)self lock]);
        (*(a3 + 2))(a3, v23, v40);
        os_unfair_lock_lock([(CUIPlaceholderCUICommonAssetStorage *)self lock]);
  ...
  v55 = [(CUIPlaceholderCUICommonAssetStorage *)self lock];
...
- (void)_addBitmapIndexForNameIdentifier:(unsigned __int16)a3 attribute:(int)a4 withValue:(unsigned __int16)a5 toDictionary:(id)a6
{
  v7 = a5;
  v8 = *&a4;
  v11 = [objc_alloc(MEMORY[0x1E696AD98]) initWithInt:a3];
  v10 = [a6 objectForKey:?];
  if (!v10)
  {
    ...
    do
    {
      ...
      if (var2)
      {
        ...
        if (*v33)
        {
          ...
          do
          {
            [(CUIPlaceholderCUICommonAssetStorage *)self _addBitmapIndexForNameIdentifier:v35 attribute:v5->var3[v36] withValue:*(v30 + 2 * v36) toDictionary:a3];
            ++v36;
          }
...
{
  os_unfair_lock_lock([(CUIPlaceholderCUICommonAssetStorage *)self lock]);
  v3 = [(CUIPlaceholderCUICommonAssetStorage *)self deploymentPlatform];
  if (self->_bitmapKeydb)
  {
    v4 = v3;
...
- (int)validatekeyformat
{
  ...
  v4 = NamedBlock;
  v5 = [(CUIPlaceholderCUICommonAssetStorage *)self _bomStorage];
  v12 = BOMStorageSizeOfBlock(v5, v4, v6, v7, v8, v9, v10, v11);
  v13 = malloc_type_malloc(v12, 0x8106E4EAuLL);
  v14 = [(CUIPlaceholderCUICommonAssetStorage *)self _bomStorage];
...
- (unsigned)appearanceIdentifierForName:(id)a3
{
  if ((*(self + 108) & 4) != 0)
  {
    v3 = [(NSDictionary *)[(CUIPlaceholderCUICommonAssetStorage *)self appearances] objectForKey:a3];
    if (v3)
    {
...
- (unsigned)localizationIdentifierForName:(id)a3
{
  ...
  {
    os_unfair_lock_lock([(CUIPlaceholderCUICommonAssetStorage *)self lock]);
    v8 = [(CUIPlaceholderCUICommonAssetStorage *)self localizationdb];
    v9 = strlen(v7);
