...
{
  v10.receiver = self;
  v10.super_class = CUIPlaceholderCUIRenditionKey;
  v4 = [(CUIPlaceholderCUIRenditionKey *)&v10 init];
  v5 = v4;
  if (v4)
  {
...
- (void)encodeWithCoder:(id)a3
{
  ...
  if ([a3 allowsKeyedCoding])
  {
    [a3 encodeInteger:+[CUIPlaceholderCUIRenditionKey version](CUIPlaceholderCUIRenditionKey forKey:{"version"), @"CUIRenditionKeyVersion"}];
...
- (void)dealloc
{
  ...
  v4.receiver = self;
  v4.super_class = CUIPlaceholderCUIRenditionKey;
...
- (void)setValuesFromKeyList:(const _renditionkeytoken *)a3
{
  ...
  [(CUIPlaceholderCUIRenditionKey *)self _expandKeyIfNecessaryForCount:v11];
  if (v11 <= self->_highwaterKeyCount)
  {
    key = self->_key;
LABEL_11:
...
LABEL_5:
  ...
  [(CUIPlaceholderCUIRenditionKey *)self _expandKeyIfNecessaryForCount:v6];
...
{
  v3.receiver = self;
  v3.super_class = CUIPlaceholderCUIRenditionKey;
  return [-[CUIPlaceholderCUIRenditionKey description](&v3 description)];
}
...
- (id)descriptionBasedOnKeyFormat:(const _renditionkeyfmt *)a3
{
  ...
  do
  {
    v9 = *var3++;
    v8 = v9;
    v10 = [(CUIPlaceholderCUIRenditionKey *)self nameOfAttributeName:v9];
    if ([v10 length])
    {
      v7 = -[__CFString stringByAppendingString:](v7, "stringByAppendingString:", [MEMORY[0x1E696AEC0] stringWithFormat:@"%@: %lu ", v10, CUIRenditionKeyValueForAttribute(&key->identifier, v8)]);
    }
