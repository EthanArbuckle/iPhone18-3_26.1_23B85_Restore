...
- (id)filterWithBackgroundImage:(id)image inputImage:(id)inputImage
{
  ...
  v59 = imageCopy;
  [v9 setValue:imageCopy forKey:*MEMORY[0x1E695FAB0]];
  ...
  isSolariumEnabled = [v15 isSolariumEnabled];
  ...
  outputImage3 = [v34 outputImage];
  [v38 setValue:outputImage3 forKey:v10];

  outputImage4 = [v29 outputImage];
  [v38 setValue:outputImage4 forKey:v33];

  v41 = [MEMORY[0x1E695F648] filterWithName:@"CISourceInCompositing"];
  outputImage5 = [v38 outputImage];
  [v41 setValue:outputImage5 forKey:v10];

  [v41 setValue:v32 forKey:v33];
  v43 = [MEMORY[0x1E695F648] filterWithName:@"CISourceOverCompositing"];
  outputImage6 = [v41 outputImage];
  [v43 setValue:outputImage6 forKey:v10];
  ...
  outputImage7 = [v47 outputImage];
  [v51 setValue:outputImage7 forKey:v10];

  [v51 setValue:v32 forKey:v33];
  v53 = [MEMORY[0x1E695F648] filterWithName:@"CILinearDodgeBlendMode"];
  outputImage8 = [v51 outputImage];
  [v53 setValue:outputImage8 forKey:v10];

  outputImage9 = [v45 outputImage];

  [v53 setValue:outputImage9 forKey:v33];
