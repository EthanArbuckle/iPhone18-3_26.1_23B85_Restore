...
{
  v4 = a3;
  co_companionLinkClientForDiscovery = [self co_companionLinkClientForDiscovery];
  [co_companionLinkClientForDiscovery setDispatchQueue:v4];

  return co_companionLinkClientForDiscovery;
}
...
{
  v6 = a4;
  v7 = [self co_companionLinkClientToDevice:a3];
