...
- (COAlarmDeleteEvent)initWithCoder:(id)coder;
- (COAlarmDeleteEvent)initWithIdentifier:(id)identifier date:(id)date;
...
- (COAlarmDeleteEvent)initWithIdentifier:(id)identifier date:(id)date
{
  ...
  dateCopy = date;
  v12.receiver = self;
  v12.super_class = COAlarmDeleteEvent;
...
- (COAlarmDeleteEvent)initWithCoder:(id)coder
{
  coderCopy = coder;
  v11.receiver = self;
  v11.super_class = COAlarmDeleteEvent;
...
{
  coderCopy = coder;
  identifier = [(COAlarmDeleteEvent *)self identifier];
  [coderCopy encodeObject:identifier forKey:@"identifier"];

  date = [(COAlarmDeleteEvent *)self date];
