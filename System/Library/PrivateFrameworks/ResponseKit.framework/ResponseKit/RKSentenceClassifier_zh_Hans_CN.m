...
{
  v6.receiver = self;
  v6.super_class = RKSentenceClassifier_zh_Hans_CN;
...
{
  v2.receiver = self;
  v2.super_class = RKSentenceClassifier_zh_Hans_CN;
...
{
  v8.receiver = self;
  v8.super_class = RKSentenceClassifier_zh_Hans_CN;
  ...
  if ([v3 sentenceType] == 31 && -[RKSentenceClassifier sentenceIsTerminated](self, "sentenceIsTerminated") && !-[RKSentenceClassifier sentenceHasQuestionTerminator](self, "sentenceHasQuestionTerminator"))
  {
