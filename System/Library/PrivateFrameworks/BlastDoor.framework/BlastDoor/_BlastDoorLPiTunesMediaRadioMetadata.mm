...
- (id)copyWithZone:(_NSZone *)a3
{
  v4 = [_BlastDoorLPiTunesMediaRadioMetadata allocWithZone:a3];
  if (v4)
  {
    v5 = [(_BlastDoorLPiTunesMediaRadioMetadata *)self storeFrontIdentifier];
    [(_BlastDoorLPiTunesMediaRadioMetadata *)v4 setStoreFrontIdentifier:v5];

    v6 = [(_BlastDoorLPiTunesMediaRadioMetadata *)self storeIdentifier];
    ...
    v8 = [(_BlastDoorLPiTunesMediaRadioMetadata *)self curator];
    ...
    v10 = [(_BlastDoorLPiTunesMediaRadioMetadata *)self artworkMetadata];
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ([(_BlastDoorLPiTunesMediaRadioMetadata *)&v15 isEqual:v4])
  {
    v5 = 1;
  }
