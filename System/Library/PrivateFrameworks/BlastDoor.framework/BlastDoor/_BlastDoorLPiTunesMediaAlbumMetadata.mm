...
- (id)copyWithZone:(_NSZone *)a3
{
  v4 = [_BlastDoorLPiTunesMediaAlbumMetadata allocWithZone:a3];
  if (v4)
  {
    v5 = [(_BlastDoorLPiTunesMediaAlbumMetadata *)self storeFrontIdentifier];
    [(_BlastDoorLPiTunesMediaAlbumMetadata *)v4 setStoreFrontIdentifier:v5];

    v6 = [(_BlastDoorLPiTunesMediaAlbumMetadata *)self storeIdentifier];
    ...
    v8 = [(_BlastDoorLPiTunesMediaAlbumMetadata *)self artist];
    ...
    v10 = [(_BlastDoorLPiTunesMediaAlbumMetadata *)self artworkMetadata];
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ([(_BlastDoorLPiTunesMediaAlbumMetadata *)&v16 isEqual:v4])
  {
    v5 = 1;
  }
