...
- (BlastDoorPriorityMessageCommand)init;
@end

@implementation BlastDoorPriorityMessageCommand
...
- (BlastDoorMetadata)metadata
{
  ...
  sub_213FB568C(self + OBJC_IVAR___BlastDoorPriorityMessageCommand_priorityMessageCommand, v6, type metadata accessor for Metadata);
  ...
  v11.receiver = v8;
  v11.super_class = v7;
  v9 = [(BlastDoorPriorityMessageCommand *)&v11 init];
