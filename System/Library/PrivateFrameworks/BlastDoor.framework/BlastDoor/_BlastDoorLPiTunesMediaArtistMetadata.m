...
- (id)copyWithZone:(_NSZone *)a3
{
  v4 = [_BlastDoorLPiTunesMediaArtistMetadata allocWithZone:a3];
  if (v4)
  {
    v5 = [(_BlastDoorLPiTunesMediaArtistMetadata *)self storeFrontIdentifier];
    [(_BlastDoorLPiTunesMediaArtistMetadata *)v4 setStoreFrontIdentifier:v5];

    v6 = [(_BlastDoorLPiTunesMediaArtistMetadata *)self storeIdentifier];
    ...
    v8 = [(_BlastDoorLPiTunesMediaArtistMetadata *)self genre];
    ...
    v10 = [(_BlastDoorLPiTunesMediaArtistMetadata *)self artworkMetadata];
...
- (BOOL)isEqual:(id)a3
{
  ...
  if ([(_BlastDoorLPiTunesMediaArtistMetadata *)&v15 isEqual:v4])
  {
    v5 = 1;
  }
