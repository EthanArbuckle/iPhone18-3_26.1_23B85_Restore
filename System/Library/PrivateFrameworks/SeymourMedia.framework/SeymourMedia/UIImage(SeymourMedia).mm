...
+ (id)imageWithSize:()SeymourMedia format:actions:
{
  ...
  v11 = a5;
  v12 = [[v10 alloc] initWithSize:v11 format:{self, a2}];
...
+ (id)compositedImageWithSize:()SeymourMedia images:cornerRadius:blendMode:legacyMode:
{
  ...
  v17 = [v14 count];
  if (a4 <= 0.0 && v17 == 1 && cGImage && ((Width = CGImageGetWidth(cGImage), Height = CGImageGetHeight(cGImage), v20 = round(a2), round(a3) == Height) ? (v21 = v20 == Width) : (v21 = 0), !v21 ? (v22 = a8 == 0) : (v22 = 0), !v22))
  {
    v23 = firstObject;
  }
  ...
  else if ([v14 count])
  {
    ...
    {
      [MEMORY[0x277D75568] smu_formatForImage:firstObject];
    }
    v24 = ;
    [v24 setOpaque:1];
    v25 = objc_opt_class();
