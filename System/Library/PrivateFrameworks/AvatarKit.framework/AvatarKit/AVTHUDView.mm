...
- (AVTHUDView)initWithFrame:(CGRect)a3
{
  ...
  v3 = [(AVTHUDView *)&v6 initWithFrame:a3.origin.x, a3.origin.y, a3.size.width, a3.size.height];
  if (v3)
  {
...
- (void)updateWithData:(id *)a3
{
  v5 = [MEMORY[0x1E696AEC0] stringWithFormat:@"Total latency: %.2f ms", a3->var0 * 1000.0];
  [(UILabel *)self->_totalLatencyLabel setText:v5];

  v6 = [MEMORY[0x1E696AEC0] stringWithFormat:@"ARKit latency: %.2f ms", a3->var1 * 1000.0];
  [(UILabel *)self->_arKitLatencyLabel setText:v6];

  v7 = [MEMORY[0x1E696AEC0] stringWithFormat:@"Sync latency: %.2f ms", a3->var2 * 1000.0];
  [(UILabel *)self->_updateSyncLatencyLabel setText:v7];

  v8 = [MEMORY[0x1E696AEC0] stringWithFormat:@"MTL latency: %.2f ms", a3->var3 * 1000.0];
  [(UILabel *)self->_metalLatencyLabel setText:v8];

  var6 = a3->var6;
  v10 = [MEMORY[0x1E696AEC0] stringWithFormat:@"Audio time: %f ms", var6];
  ...
  v12 = [MEMORY[0x1E696AEC0] stringWithFormat:@"FPS: %d | %@", a3->var5, v11];
  [(UILabel *)self->_fpsLabel setText:v12];

  v13 = [MEMORY[0x1E696AEC0] stringWithFormat:@"Time between ARFrame: %.2f ms", a3->var4 * 1000.0];
  [(UILabel *)self->_timeBetweenARFrameLabel setText:v13];

  v14 = [MEMORY[0x1E696AEC0] stringWithFormat:@"Frame dropped/s: %d", a3->var7];
  [(UILabel *)self->_droppedFrameLabel setText:v14];

  v15 = [MEMORY[0x1E696AEC0] stringWithFormat:@"Shader compilation: %d", a3->var9];
  ...
  *&self->_lastFrameData.totalLatency = *&a3->var0;
  v18 = *&a3->var4;
  v17 = *&a3->var6;
  v19 = *&a3->var2;
  *&self->_lastFrameData.onlineShaderCompilationCount = *&a3->var9;
...
- (void)_updateLatencyGraph:(id *)a3
{
  ...
  {
    v13 = [(NSMutableArray *)self->_totalLatencyGraphLayers objectAtIndexedSubscript:0];
...
LABEL_29:
  v24 = v23;
  [v13 setBackgroundColor:{objc_msgSend(v23, "CGColor")}];

  [v13 setFrame:{0.0, 0.0, 3.0, v20}];
  [(AVTHUDView *)self bounds];
  v26 = v25;
