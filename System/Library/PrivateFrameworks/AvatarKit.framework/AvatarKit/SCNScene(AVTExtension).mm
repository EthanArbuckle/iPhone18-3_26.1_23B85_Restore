...
LABEL_22:
      ...
      if (v26)
      {
        ...
        if ((vminvq_u32(vandq_s8(vandq_s8(vceqq_f32(v27, v42), vceqq_f32(v28, v41)), vandq_s8(vceqq_f32(v29, v40), vceqq_f32(v30, v39)))) & 0x80000000) == 0)
        {
          ...
          {
            [(SCNScene(AVTExtension) *)v56 avt_removeDuplicateSkeletonRootWithHandler:v31];
          }
        }
        ...
        v46[1] = 3221225472;
        v46[2] = __69__SCNScene_AVTExtension__avt_removeDuplicateSkeletonRootWithHandler___block_invoke;
        v46[3] = &unk_1E7F499C8;
        v46[4] = v17;
        v47 = firstObject;
...
- (void)avt_removeFaceSetsExportedAsDummyNodesWithHandler:()AVTExtension
{
  ...
  v24[1] = 3221225472;
  v24[2] = __76__SCNScene_AVTExtension__avt_removeFaceSetsExportedAsDummyNodesWithHandler___block_invoke;
  v24[3] = &unk_1E7F499F0;
  v7 = v5;
  v25 = v7;
