...
- (MusicKit_SoftLinking_MPModelLibraryRemoveFromPlaylistChangeRequest)initWithPlaylist:(id)playlist entriesToRemove:(id)remove;
...
- (MusicKit_SoftLinking_MPModelLibraryRemoveFromPlaylistChangeRequest)initWithPlaylist:(id)playlist entriesToRemove:(id)remove
{
  ...
  if (v8)
  {
    ...
    v8->_underlyingPlaylist = _underlyingModelObject;
    ...
    deviceMediaLibrary = [v11 deviceMediaLibrary];
    v14 = [removeCopy msv_compactMap:&__block_literal_global_3];
    v26 = 0;
    v27 = &v26;
    v28 = 0x2050000000;
    ...
    v16 = v15;
    _Block_object_dispose(&v26, 8);
    v17 = [[v15 alloc] initWithPlaylist:v8->_underlyingPlaylist inMediaLibrary:deviceMediaLibrary andEntriesToRemove:v14];
