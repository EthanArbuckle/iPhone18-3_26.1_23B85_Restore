...
- (FaceAestheticQualityFilterSVMDataScaler)init
{
  ...
  v4 = [(FaceAestheticQualityFilterSVMDataScaler *)self initWithContentsOfURL:uRLOfModelInThisBundle error:0];
...
- (FaceAestheticQualityFilterSVMDataScaler)initWithConfiguration:(id)configuration error:(id *)error
{
  ...
  uRLOfModelInThisBundle = [objc_opt_class() URLOfModelInThisBundle];
  v8 = [(FaceAestheticQualityFilterSVMDataScaler *)self initWithContentsOfURL:uRLOfModelInThisBundle configuration:configurationCopy error:error];
...
- (id)predictionFromFeatures:(id)features error:(id *)error
{
  ...
  v9 = [(FaceAestheticQualityFilterSVMDataScaler *)self predictionFromFeatures:featuresCopy options:v8 error:error];
...
- (id)predictionFromFeatures:(id)features options:(id)options error:(id *)error
{
  ...
  if (v11)
  {
    ...
    v15 = [(FaceAestheticQualityFilterSVMDataScalerOutput *)v12 initWithTransformed_features:multiArrayValue];
  }
...
{
  inputCopy = input;
  v7 = [[FaceAestheticQualityFilterSVMDataScalerInput alloc] initWithInput:inputCopy];

  v8 = [(FaceAestheticQualityFilterSVMDataScaler *)self predictionFromFeatures:v7 error:error];
  ...
  if (v12)
  {
    ...
    if ([v12 count] >= 1)
    {
      ...
      do
      {
        ...
        v19 = [(FaceAestheticQualityFilterSVMDataScalerOutput *)v16 initWithTransformed_features:multiArrayValue];
