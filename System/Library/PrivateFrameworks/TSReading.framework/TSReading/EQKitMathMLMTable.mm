...
{
  {
    std::set<EQKitTypes::Attributes::Enum>::set[abi:nn200100]<EQKitTypes::Attributes::Enum const*>(-[EQKitMathMLMTable mathMLAttributes]::sAttributesSet, -[EQKitMathMLMTable mathMLAttributes]::sAttributesData, &-[EQKitMathMLMTr mathMLAttributes]::sAttributesData);
  }
