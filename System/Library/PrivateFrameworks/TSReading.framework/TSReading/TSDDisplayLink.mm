...
- (void)start
{
  if (self->_displayLink)
  {
    ...
    [currentHandler handleFailureInFunction:v4 file:objc_msgSend(MEMORY[0x277CCACA8] lineNumber:"stringWithUTF8String:" description:{"/Library/Caches/com.apple.xbs/Sources/AlderShared/drawables/TSDDisplayLink.m"), 43, @"expected nil value for '%s'", "_displayLink"}];
  }
