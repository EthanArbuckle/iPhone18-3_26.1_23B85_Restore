  ...
  if (!sharedLowPriorityDispatcher_sSingletonInstance)
  {
    ...
    if (!sharedLowPriorityDispatcher_sSingletonInstance)
    {
      ...
      if (!v4)
      {
        ...
        [v5 handleFailureInFunction:v6 file:objc_msgSend(MEMORY[0x277CCACA8] lineNumber:"stringWithUTF8String:" description:{"/Library/Caches/com.apple.xbs/Sources/AlderShared/kit/TSKThreadDispatcher.m"), 62, @"Couldn't create singleton instance of %@", a1}];
      }
    }
...
+ (id)allocWithZone:(_NSZone *)a3
{
  ...
  [v3 handleFailureInFunction:v4 file:objc_msgSend(MEMORY[0x277CCACA8] lineNumber:"stringWithUTF8String:" description:{"/Library/Caches/com.apple.xbs/Sources/AlderShared/kit/TSKThreadDispatcher.m"), 62, @"Don't alloc a singleton"}];
  return 0;
}
...
- (void)resume
{
  ...
  if (add <= 0)
  {
    ...
    [v5 handleFailureInFunction:v6 file:v7 lineNumber:93 description:@"Suspend count underflow"];
  }
