...
- (uint64_t)p_getValue:()TSDCAAnimationAdditions animationPercent:atTime:initialValue:
{
  ...
  return [currentHandler handleFailureInFunction:v1 file:v2 lineNumber:169 description:@"Implement me in subclass!"];
}
...
- (uint64_t)TSD_valueForKeyPath:()TSDCAAnimationAdditions atTime:animationCache:
{
  if (([objc_msgSend(self "keyPath")] & 1) == 0)
  {
    ...
    [currentHandler handleFailureInFunction:v10 file:objc_msgSend(MEMORY[0x277CCACA8] lineNumber:"stringWithUTF8String:" description:{"/Library/Caches/com.apple.xbs/Sources/AlderShared/drawables/CAAnimationAdditions.m"), 174, @"Wrong keyPath for animation!"}];
  }

  v11 = [objc_msgSend(a5 "initialValues")];

  return [self TSD_valueAtTime:v11 initialValue:a2];
}
...
- (uint64_t)TSD_valueAtTime:()TSDCAAnimationAdditions initialValue:
{
  ...
  [currentHandler handleFailureInFunction:v1 file:objc_msgSend(MEMORY[0x277CCACA8] lineNumber:"stringWithUTF8String:" description:{"/Library/Caches/com.apple.xbs/Sources/AlderShared/drawables/CAAnimationAdditions.m"), 188, @"Implement me in subclass!"}];
  return 0;
}
...
- (double)TSD_animationPercentByApplyingTimingFunctionForKeyPath:()TSDCAAnimationAdditions atTime:
{
  ...
  [currentHandler handleFailureInFunction:v1 file:objc_msgSend(MEMORY[0x277CCACA8] lineNumber:"stringWithUTF8String:" description:{"/Library/Caches/com.apple.xbs/Sources/AlderShared/drawables/CAAnimationAdditions.m"), 194, @"Implement me in subclass!"}];
  return 0.0;
}
...
- (uint64_t)TSD_containsAnimationForKeyPath:()TSDCAAnimationAdditions
{
  ...
  [currentHandler handleFailureInFunction:v1 file:objc_msgSend(MEMORY[0x277CCACA8] lineNumber:"stringWithUTF8String:" description:{"/Library/Caches/com.apple.xbs/Sources/AlderShared/drawables/CAAnimationAdditions.m"), 200, @"Implement me in subclass!"}];
  return 0;
}
...
- (uint64_t)TSD_animationForKeyPath:()TSDCAAnimationAdditions atTime:
{
  ...
  [currentHandler handleFailureInFunction:v1 file:objc_msgSend(MEMORY[0x277CCACA8] lineNumber:"stringWithUTF8String:" description:{"/Library/Caches/com.apple.xbs/Sources/AlderShared/drawables/CAAnimationAdditions.m"), 206, @"Implement me in subclass!"}];
  return 0;
}
