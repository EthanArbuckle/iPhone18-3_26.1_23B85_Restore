...
{
  {
    std::set<EQKitTypes::Attributes::Enum>::set[abi:nn200100]<EQKitTypes::Attributes::Enum const*>(-[EQKitMathMLMStackGroup mathMLAttributes]::sAttributesSet, &-[EQKitMathMLMStackGroup mathMLAttributes]::sAttributesData, &-[EQKitMathMLMStackLine mathMLAttributes]::sAttributesData);
  }
