...
{
  {
    std::set<EQKitTypes::Attributes::Enum>::set[abi:nn200100]<EQKitTypes::Attributes::Enum const*>(-[EQKitMathMLMStackCarries mathMLAttributes]::sAttributesSet, &-[EQKitMathMLMStackCarries mathMLAttributes]::sAttributesData, &-[EQKitMathMLMStackCarry mathMLAttributes]::sAttributesData);
  }
