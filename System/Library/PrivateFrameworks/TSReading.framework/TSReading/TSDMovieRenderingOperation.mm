...
- (TSDMovieRenderingOperation)initWithPreset:(id)preset imageSize:(CGSize)size imageScale:(double)scale swatchFrame:(CGRect)frame movieInfo:(id)info documentRoot:(id)root shouldClipVertically:(BOOL)vertically;
- (void)dealloc;
