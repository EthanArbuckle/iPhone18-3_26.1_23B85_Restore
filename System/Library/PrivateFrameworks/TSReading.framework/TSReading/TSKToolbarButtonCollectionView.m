...
- (TSKToolbarButtonCollectionView)initWithHeight:(double)a3 items:(id)a4 maximumWidth:(double)a5
{
  ...
  v8 = 0.0;
  v9 = [(TSKToolbarButtonCollectionView *)&v68 initWithFrame:0.0, 0.0, 0.0, a3];
  if (v9)
  {
    ...
    v66 = 0u;
    v67 = 0u;
    v11 = [a4 countByEnumeratingWithState:&v64 objects:v70 count:16];
    if (v11)
    {
      v12 = v11;
      v59 = 0;
      ...
      do
      {
        ...
        v12 = [a4 countByEnumeratingWithState:&v64 objects:v70 count:16];
      }
          ...
          do
          {
            ...
            do
            {
              ...
              if (v47 >= 1.0)
              {
                ...
                [v43 setFrame:?];
                v39 = v39 - v49;
                for (j = [a4 indexOfObject:v43] + 1; j < objc_msgSend(a4, "count"); ++j)
                {
                  v51 = [a4 objectAtIndex:j];
                  if ([-[TSKToolbarButtonCollectionView subviews](v9 "subviews")])
                  {
                    [v51 frame];
...
LABEL_43:
      if (v39 > a5)
      {
        ...
        [v55 handleFailureInFunction:v56 file:objc_msgSend(MEMORY[0x277CCACA8] lineNumber:"stringWithUTF8String:" description:{"/Library/Caches/com.apple.xbs/Sources/AlderShared/kit/TSKToolbar.m"), 397, @"Unable to reduce width to %g; going with %g", *&a5, *&v39}];
      }
    }

    [(TSKToolbarButtonCollectionView *)v9 setFrame:0.0, 0.0, v39, a3];
  }
