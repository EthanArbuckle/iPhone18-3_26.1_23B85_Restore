...
- (void)setColor:(CGColor *)a3
{
  if (!a3)
  {
    ...
    [v5 handleFailureInFunction:v6 file:objc_msgSend(MEMORY[0x277CCACA8] lineNumber:"stringWithUTF8String:" description:{"/Library/Caches/com.apple.xbs/Sources/AlderShared/drawables/TSDCurvedShadow.m"), 376, @"invalid nil value for '%s'", "color"}];
  }
