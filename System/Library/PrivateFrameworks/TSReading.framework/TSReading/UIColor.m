...
{
  result = [objc_alloc(*(a1 + 32)) initWithWhite:0.23137255 alpha:1.0];
...
{
  result = [objc_alloc(*(a1 + 32)) initWithRed:0.905882359 green:0.913725495 blue:0.933333337 alpha:1.0];
