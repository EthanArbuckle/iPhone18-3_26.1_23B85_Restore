...
- (TSWPRangeMap)initWithSubRange:(_NSRange)range unmappedPairIndexes:(const void *)indexes
{
  ...
  v7 = [(TSWPRangeMap *)self initWithSubRange:range.location unmappedIndexes:range.length affinity:indexes, 0];
  v8 = v7;
  if (v7)
  {
    ...
    if ((v9 & 8) != 0)
    {
      ...
      [currentHandler handleFailureInFunction:v12 file:objc_msgSend(MEMORY[0x277CCACA8] lineNumber:"stringWithUTF8String:" description:{"/Library/Caches/com.apple.xbs/Sources/AlderShared/text/TSWPRangeMap.mm"), 43, @"expected an even number of indexes"}];
    }
    ...
    if (v10 != (end - begin) >> 4 || v10 != (v8->_mappedIndexes.__end_ - v8->_mappedIndexes.__begin_) >> 4)
    {
      ...
      [currentHandler2 handleFailureInFunction:v16 file:objc_msgSend(MEMORY[0x277CCACA8] lineNumber:"stringWithUTF8String:" description:{"/Library/Caches/com.apple.xbs/Sources/AlderShared/text/TSWPRangeMap.mm"), 45, @"index vector size is wrong"}];
      begin = v8->_unmappedIndexes.__begin_;
      end = v8->_unmappedIndexes.__end_;
    }
    ...
    if (end != begin)
    {
      ...
      do
      {
        ...
        if (!v22 && v19 != v23)
        {
          ...
          [currentHandler3 handleFailureInFunction:v26 file:objc_msgSend(MEMORY[0x277CCACA8] lineNumber:"stringWithUTF8String:" description:{"/Library/Caches/com.apple.xbs/Sources/AlderShared/text/TSWPRangeMap.mm"), 50, @"index is out of bounds"}];
          begin = v8->_unmappedIndexes.__begin_;
          end = v8->_unmappedIndexes.__end_;
        }
    ...
    if (v11 != v12)
    {
      ...
      do
      {
        ...
        if (!v19 && v16 != v20)
        {
          ...
          [currentHandler handleFailureInFunction:v23 file:objc_msgSend(MEMORY[0x277CCACA8] lineNumber:"stringWithUTF8String:" description:{"/Library/Caches/com.apple.xbs/Sources/AlderShared/text/TSWPRangeMap.mm"), 81, @"index is out of bounds"}];
        }
...
- (unint64_t)mappedCharIndex:(unint64_t)index
{
  if (index == 0x7FFFFFFFFFFFFFFFLL)
  {
    ...
    [currentHandler handleFailureInFunction:v6 file:objc_msgSend(MEMORY[0x277CCACA8] lineNumber:"stringWithUTF8String:" description:{"/Library/Caches/com.apple.xbs/Sources/AlderShared/text/TSWPRangeMap.mm"), 102, @"shouldn't be trying to map NSNotFound"}];
  }

  v7 = index - self->_subRange.location;
...
- (unint64_t)unmappedCharIndex:(unint64_t)index
{
  ...
  if (index == 0x7FFFFFFFFFFFFFFFLL)
  {
    ...
    [currentHandler handleFailureInFunction:v6 file:objc_msgSend(MEMORY[0x277CCACA8] lineNumber:"stringWithUTF8String:" description:{"/Library/Caches/com.apple.xbs/Sources/AlderShared/text/TSWPRangeMap.mm"), 121, @"shouldn't be trying to map NSNotFound"}];
  }
  ...
  if (end == v10 || *v10 != indexCopy)
  {
    return indexCopy - ((v10 - begin) >> 4) + self->_subRange.location;
  }
  ...
  else
  {
    ...
    [currentHandler2 handleFailureInFunction:v18 file:objc_msgSend(MEMORY[0x277CCACA8] lineNumber:"stringWithUTF8String:" description:{"/Library/Caches/com.apple.xbs/Sources/AlderShared/text/TSWPRangeMap.mm"), 140, @"bad affinity"}];
  }

  return [(TSWPRangeMap *)self unmappedCharIndex:indexCopy];
}
