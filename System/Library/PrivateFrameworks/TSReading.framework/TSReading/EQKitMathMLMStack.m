...
{
  {
    std::set<EQKitTypes::Attributes::Enum>::set[abi:nn200100]<EQKitTypes::Attributes::Enum const*>(-[EQKitMathMLMStack mathMLAttributes]::sAttributesSet, &-[EQKitMathMLMStack mathMLAttributes]::sAttributesData, &-[EQKitMathMLMStackGroup mathMLAttributes]::sAttributesData);
  }
