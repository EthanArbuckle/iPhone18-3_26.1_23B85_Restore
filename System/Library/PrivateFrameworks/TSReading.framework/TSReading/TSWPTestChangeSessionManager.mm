...
- (TSWPTestChangeSessionManager)initWithContext:(id)a3
{
  ...
  if (v4)
  {
    ...
    v6 = -[TSKAnnotationAuthor initWithContext:name:color:](v5, "initWithContext:name:color:", a3, @"Testing Author", [MEMORY[0x277D6C2A8] greenColor]);
...
- (id)changeSessionAuthorCreatedWithCommand:(id *)a3
{
  ...
  if (!result)
  {
    ...
    [v5 handleFailureInFunction:v6 file:objc_msgSend(MEMORY[0x277CCACA8] lineNumber:"stringWithUTF8String:" description:{"/Library/Caches/com.apple.xbs/Sources/AlderShared/text/TSWPTestChangeSessionManager.mm"), 48, @"invalid nil value for '%s'", "_currentSession"}];
...
- (void)startNewChangeSessionIfNecessaryGettingInsertAuthorCommand:(id *)a3
{
  ...
  if (!currentSession)
  {
    ...
    [v5 handleFailureInFunction:v6 file:objc_msgSend(MEMORY[0x277CCACA8] lineNumber:"stringWithUTF8String:" description:{"/Library/Caches/com.apple.xbs/Sources/AlderShared/text/TSWPTestChangeSessionManager.mm"), 55, @"invalid nil value for '%s'", "_currentSession"}];
    currentSession = self->_currentSession;
  }
