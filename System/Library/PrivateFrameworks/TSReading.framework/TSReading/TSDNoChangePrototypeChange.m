...
- (TSSPropertySource)propertiesBeforeChange
{
  ...
  if (!v3)
  {
    ...
    [v4 handleFailureInFunction:v5 file:objc_msgSend(MEMORY[0x277CCACA8] lineNumber:"stringWithUTF8String:" description:{"/Library/Caches/com.apple.xbs/Sources/AlderShared/drawables/TSDPrototypeChange.m"), 293, @"Tried to treat %@ as a property source when it's not", self->mPrototype}];
  }
