...
- (void)i_upgradeWithDataStore:(id)a3
{
  ...
  if (!v5)
  {
    ...
    [v6 handleFailureInFunction:v7 file:objc_msgSend(MEMORY[0x277CCACA8] lineNumber:"stringWithUTF8String:" description:{"/Library/Caches/com.apple.xbs/Sources/AlderShared/tables/TSTTableTileRowInfo.mm"), 669, @"failed to allocate memory in tile upgrade, the world will end now"}];
  }
  ...
  do
  {
    ...
    v13 = v12->mStorageOffsets[0];
    if (v13 != 0xFFFF)
    {
      TSTCellInflateFromStorageRef(v8, &MutableBytePtr[v13], a3);
  ...
  if (v11)
  {
    ...
    if (!mStorageBuffer)
    {
      ...
      [v15 handleFailureInFunction:v16 file:objc_msgSend(MEMORY[0x277CCACA8] lineNumber:"stringWithUTF8String:" description:{"/Library/Caches/com.apple.xbs/Sources/AlderShared/tables/TSTTableTileRowInfo.mm"), 719, @"NULL storage buffer"}];
      mStorageBuffer = v5->mStorageBuffer;
    }
