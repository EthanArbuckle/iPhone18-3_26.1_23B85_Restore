...
- (uint64_t)setDefaultFileProtectionForDirectoryPath:()TSPersistence error:
{
  ...
  v9 = [defaultManager setAttributes:v8 ofItemAtPath:v6 error:a4];
...
{
  v7 = a3;
  if (([self hasAtLeastFileProtection:*MEMORY[0x277CCA1A0] atURL:? recursively:?] & 1) == 0)
  {
    ...
    [currentHandler handleFailureInFunction:v5 file:v6 lineNumber:30 description:{@"Document does not have default file protection set: %@", v7}];
  }
}
