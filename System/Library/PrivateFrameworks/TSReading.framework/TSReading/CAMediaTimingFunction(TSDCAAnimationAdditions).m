...
- (void)TSD_valueAtPercent:()TSDCAAnimationAdditions
{
  ...
  if (a2 < 0.0 || a2 > 1.0)
  {
    ...
    [v5 handleFailureInFunction:v6 file:objc_msgSend(MEMORY[0x277CCACA8] lineNumber:"stringWithUTF8String:" description:{"/Library/Caches/com.apple.xbs/Sources/AlderShared/drawables/CAAnimationAdditions.m"), 56, @"percent(%0.3f) is outside [0, 1]!", *&a2}];
  }
