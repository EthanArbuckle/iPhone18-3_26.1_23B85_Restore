...
- (BOOL)_useVehicleDataProtocolAppearance:(id)a3;
...
- (void)handleChangeAppearance:(int64_t)a3 screenID:(id)a4;
...
- (BOOL)effectiveGlobalNightMode
{
  ...
  v4 = [v3 identifier];
  v5 = [(CARAppearanceManager *)self _useVehicleDataProtocolAppearance:v4];

  if (v5)
  {
    targetAppearanceModes = self->_targetAppearanceModes;
    v7 = [v3 identifier];
    v8 = [(NSMutableDictionary *)targetAppearanceModes objectForKeyedSubscript:v7];
    v9 = [v8 integerValue] == 2;
  }

  else
  {
    v10 = [(CARAppearanceManager *)self nightModeDictionary];
    v11 = [v3 identifier];
    v12 = [v10 objectForKey:v11];
    v13 = [v12 BOOLValue];

    v9 = [(CARAppearanceManager *)self locationBasedNightMode]| v13;
  }
...
- (CARAppearanceManager)initWithScreens:(id)a3 initialSystemNightMode:(BOOL)a4 initialLocationBasedNightMode:(BOOL)a5 delegate:(id)a6
{
  ...
  if (v12)
  {
    ...
    v12->_targetAppearanceModes = v29;
...
{
  v4 = a3;
  if ([(CARAppearanceManager *)self _useVehicleDataProtocolAppearance:v4])
  {
    v5 = [(NSMutableDictionary *)self->_targetAppearanceModes objectForKeyedSubscript:v4];
    v6 = [v5 integerValue];
  }

  else
  {
    v5 = [(CARAppearanceManager *)self _screenInfoForScreenUUID:v4];
    v7 = [v5 physicalDisplay];
    if ([v5 screenType] && (objc_msgSend(v7, "supportsDDPContent") & 1) != 0)
    {
      v6 = 2;
    }
    ...
    {
      v8 = [(CARAppearanceManager *)self currentEffectiveUIStyle];
...
- (void)handleNightModeUpdateWithParameters:(id)a3
{
  ...
  {
    v6 = [v4 objectForKey:@"IsNightMode"];
    v7 = [(CARAppearanceManager *)self screens];
...
- (void)handleUIAppearanceUpdateWithParameters:(id)a3
{
  ...
  if (![(CARAppearanceManager *)self _useVehicleDataProtocolAppearance:v5])
  {
    if ([v6 supportsAppearanceMode])
    {
      v7 = [v4 objectForKey:@"appearanceMode"];

      if (v7)
      {
        v8 = [v4 objectForKey:@"appearanceMode"];
        v9 = [v8 unsignedIntegerValue];

        v10 = [objc_opt_class() _carUserInterfaceStyleForAppearanceMode:v9];
      ...
      v14 = [v4 objectForKey:@"appearanceSetting"];

      if (v14)
      {
        v15 = [v4 objectForKey:@"appearanceSetting"];
        v16 = [v15 integerValue];

        v17 = CarAppearanceLogging();
        if (os_log_type_enabled(v17, OS_LOG_TYPE_DEFAULT))
        {
          v18 = [objc_opt_class() _descriptionForAppearanceSetting:v16];
          v23 = 138543618;
          v24 = v6;
          v25 = 2114;
          v26 = v18;
...
- (void)handleLocationBasedNightModeUpdate:(BOOL)a3
{
  ...
  v5 = [(CARAppearanceManager *)self _mainScreenInfo];
  v6 = [v5 identifier];
  v7 = [(CARAppearanceManager *)self _useVehicleDataProtocolAppearance:v6];
...
- (void)handleChangeAppearance:(int64_t)a3 screenID:(id)a4
{
  ...
  [(NSMutableDictionary *)self->_targetAppearanceModes setObject:v9 forKeyedSubscript:v6];

  v10 = [(CARAppearanceManager *)self delegate];
  v15 = v6;
  v11 = [MEMORY[0x1E695DEC8] arrayWithObjects:&v15 count:1];
  [v10 appearanceManager:self didUpdateMapAppearanceStyle:a3 forScreenUUIDs:v11];

  v12 = [(CARAppearanceManager *)self delegate];
  v14 = v6;
  v13 = [MEMORY[0x1E695DEC8] arrayWithObjects:&v14 count:1];
  [v12 appearanceManager:self didUpdateUIAppearanceStyle:a3 forScreenUUIDs:v13];
}
...
- (id)_screenInfoForScreenUUID:(id)a3
{
  ...
  v17 = 0;
  v5 = [(CARAppearanceManager *)self screens];
  v9[0] = MEMORY[0x1E69E9820];
  v9[1] = 3221225472;
...
- (void)_setInitialDisplayNightModeForScreen:(id)a3
{
  ...
  v4 = a3;
  v5 = [v4 screenInfoResponse];
  v6 = [v5 objectForKey:@"nightMode"];

  if (v6)
  {
    v7 = [v5 objectForKey:@"nightMode"];
    v8 = [v7 BOOLValue];
    ...
    v11 = [(CARAppearanceManager *)self nightModeDictionary];
...
- (void)_setInitialUIAppearanceNumberForScreen:(id)a3
{
  ...
  v4 = a3;
  v5 = [v4 screenInfoResponse];
  v6 = [v5 objectForKey:@"uiAppearanceMode"];
  if (v6 && (v7 = v6, [v5 objectForKey:@"uiAppearanceSetting"], v8 = objc_claimAutoreleasedReturnValue(), v8, v7, v8))
  {
    v9 = CarAppearanceLogging();
    if (os_log_type_enabled(v9, OS_LOG_TYPE_DEFAULT))
    {
    ...
    if ((v12 - 1) > 1 || v14 > 2)
    {
      if (os_log_type_enabled(v15, OS_LOG_TYPE_FAULT))
      {
        ...
        v30 = 2112;
        v31 = v4;
        _os_log_fault_impl(&dword_1C81FC000, v16, OS_LOG_TYPE_FAULT, "Invalid initial style (%{public}lu), setting (%{public}lu) for screenInfo: %@", &v26, 0x20u);
      }
    }
    ...
    else
    {
      if (os_log_type_enabled(v15, OS_LOG_TYPE_DEFAULT))
      {
        ...
        v20 = [objc_opt_class() _descriptionForAppearanceSetting:v14];
        v26 = 138543874;
        v27 = v19;
        v28 = 2114;
        v29 = v20;
        v30 = 2114;
        v31 = v4;
        _os_log_impl(&dword_1C81FC000, v16, OS_LOG_TYPE_DEFAULT, "Initial ui appearance style is: %{public}@, setting: %{public}@, for screenInfo: %{public}@", &v26, 0x20u);
      }
      ...
      v16 = [(CARAppearanceManager *)self appearanceModeSettingDictionary];
  ...
  {
    v16 = CarAppearanceLogging();
    if (os_log_type_enabled(v16, OS_LOG_TYPE_DEFAULT))
    {
      v26 = 138543362;
      v27 = v4;
      _os_log_impl(&dword_1C81FC000, v16, OS_LOG_TYPE_DEFAULT, "No initial appearance mode for screenInfo: %{public}@", &v26, 0xCu);
    }
  }
}
...
- (void)_setInitialMapAppearanceNumberForScreen:(id)a3
{
  ...
  v4 = a3;
  v5 = [v4 screenInfoResponse];
  v6 = [v5 objectForKey:@"mapAppearanceMode"];
  if (v6 && (v7 = v6, [v5 objectForKey:@"mapAppearanceSetting"], v8 = objc_claimAutoreleasedReturnValue(), v8, v7, v8))
  {
    v9 = CarAppearanceLogging();
    if (os_log_type_enabled(v9, OS_LOG_TYPE_DEFAULT))
    {
    ...
    v10 = objc_opt_class();
    v11 = [v5 objectForKey:@"mapAppearanceMode"];
    v12 = [v10 _carUserInterfaceStyleForAppearanceMode:{objc_msgSend(v11, "unsignedIntegerValue")}];

    v13 = [v5 objectForKey:@"mapAppearanceSetting"];
    v14 = [v13 integerValue];
    ...
    if ((v12 - 1) > 1 || v14 > 2)
    {
      if (os_log_type_enabled(v15, OS_LOG_TYPE_FAULT))
      {
        ...
        v30 = 2114;
        v31 = v4;
        _os_log_fault_impl(&dword_1C81FC000, v16, OS_LOG_TYPE_FAULT, "Invalid initial map appearance style (%{public}lu), setting (%{public}lu) for screenInfo: %{public}@", &v26, 0x20u);
      }
    }
    ...
    else
    {
      if (os_log_type_enabled(v15, OS_LOG_TYPE_DEFAULT))
      {
        ...
        v30 = 2114;
        v31 = v4;
        _os_log_impl(&dword_1C81FC000, v16, OS_LOG_TYPE_DEFAULT, "Initial map appearance style is: %{public}@, setting: %{public}@, for screenInfo: %{public}@", &v26, 0x20u);
      }
      ...
      v16 = [(CARAppearanceManager *)self mapAppearanceModeSettingDictionary];
      v24 = [MEMORY[0x1E696AD98] numberWithInteger:v14];
      v25 = [v4 identifier];
      [v16 setObject:v24 forKey:v25];
    }
  ...
  else
  {
    ...
    if (os_log_type_enabled(v16, OS_LOG_TYPE_DEFAULT))
    {
      v26 = 138543362;
      v27 = v4;
      _os_log_impl(&dword_1C81FC000, v16, OS_LOG_TYPE_DEFAULT, "No initial map appearance mode for screenInfo: %{public}@", &v26, 0xCu);
    }
  }
}
...
+ (id)_descriptionForAppearanceSetting:(int64_t)a3
{
  ...
  {
    return off_1E82FD6E0[a3];
  }
}

- (BOOL)_useVehicleDataProtocolAppearance:(id)a3
{
  v3 = [(NSMutableDictionary *)self->_targetAppearanceModes objectForKeyedSubscript:a3];
  v4 = v3 != 0;
