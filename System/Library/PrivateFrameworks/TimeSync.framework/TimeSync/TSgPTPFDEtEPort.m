...
- (TSgPTPFDEtEPort)initWithImplDC:(id)a3
{
  ...
  if (v6)
  {
    ...
    v9 = [(_TSF_TSDgPTPFDEtEPort *)v7->_impl statistics];
    v10 = [(TSgPTPPortStatistics *)v8 initWithDC:v9];
...
- (void)observeValueForKeyPath:(id)a3 ofObject:(id)a4 change:(id)a5 context:(void *)a6
{
  ...
  v11 = a4;
  v12 = a5;
  if (a6 == self && self->_impl == v11 && [v10 isEqualToString:@"statistics"])
  {
    v13 = [TSgPTPPortStatistics alloc];
    v14 = [(_TSF_TSDgPTPFDEtEPort *)self->_impl statistics];
