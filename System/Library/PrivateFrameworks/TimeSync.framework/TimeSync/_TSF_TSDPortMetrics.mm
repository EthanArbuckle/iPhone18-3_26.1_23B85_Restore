...
- (id)getDelta:(id)delta
{
  ...
  -[_TSF_TSDPortMetrics setSyncTimeouts:](v5, "setSyncTimeouts:", self->_syncTimeouts - [deltaCopy syncTimeouts]);
  port = self->_port;
  objc_opt_class();
  if (objc_opt_isKindOfClass())
  {
    -[_TSF_TSDPortMetrics setFilterResetsDroppedLimit:](v5, "setFilterResetsDroppedLimit:", self->_filterResetsDroppedLimit - [deltaCopy filterResetsDroppedLimit]);
    -[_TSF_TSDPortMetrics setFilterResetsOutOfBounds:](v5, "setFilterResetsOutOfBounds:", self->_filterResetsOutOfBounds - [deltaCopy filterResetsOutOfBounds]);
    -[_TSF_TSDPortMetrics setDroppedMeasurements:](v5, "setDroppedMeasurements:", self->_droppedMeasurements - [deltaCopy droppedMeasurements]);
    -[_TSF_TSDPortMetrics setDiscardedPpmLimitMeasurements:](v5, "setDiscardedPpmLimitMeasurements:", self->_discardedPpmLimitMeasurements - [deltaCopy discardedPpmLimitMeasurements]);
    -[_TSF_TSDPortMetrics setDiscardedDelayLimitExceededMeasurements:](v5, "setDiscardedDelayLimitExceededMeasurements:", self->_discardedDelayLimitExceededMeasurements - [deltaCopy discardedDelayLimitExceededMeasurements]);
    -[_TSF_TSDPortMetrics setDiscardedOutOfBoundsMeasurements:](v5, "setDiscardedOutOfBoundsMeasurements:", self->_discardedOutOfBoundsMeasurements - [deltaCopy discardedOutOfBoundsMeasurements]);
    -[_TSF_TSDPortMetrics setDiscardedTimestampsOutOfOrderMeasurements:](v5, "setDiscardedTimestampsOutOfOrderMeasurements:", self->_discardedTimestampsOutOfOrderMeasurements - [deltaCopy discardedTimestampsOutOfOrderMeasurements]);
    -[_TSF_TSDPortMetrics setSuccessfulMeasurements:](v5, "setSuccessfulMeasurements:", self->_successfulMeasurements - [deltaCopy successfulMeasurements]);
    -[_TSF_TSDPortMetrics setTotalMeasurements:](v5, "setTotalMeasurements:", self->_totalMeasurements - [deltaCopy totalMeasurements]);
