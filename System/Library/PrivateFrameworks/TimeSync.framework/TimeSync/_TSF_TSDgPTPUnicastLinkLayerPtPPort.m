...
{
  v9.receiver = self;
  v9.super_class = _TSF_TSDgPTPUnicastLinkLayerPtPPort;
...
+ (id)diagnosticInfoForService:(id)a3
{
  v4 = a3;
  v15.receiver = a1;
  v15.super_class = &OBJC_METACLASS____TSF_TSDgPTPUnicastLinkLayerPtPPort;
  ...
  {
    v9 = [v7 bytes];
    v10 = [MEMORY[0x277CCACA8] stringWithFormat:@"%02hhx:%02hhx:%02hhx:%02hhx:%02hhx:%02hhx", *v9, v9[1], v9[2], v9[3], v9[4], v9[5]];
  ...
  {
    v12 = [v11 bytes];
    v13 = [MEMORY[0x277CCACA8] stringWithFormat:@"%02hhx:%02hhx:%02hhx:%02hhx:%02hhx:%02hhx", *v12, v12[1], v12[2], v12[3], v12[4], v12[5]];
