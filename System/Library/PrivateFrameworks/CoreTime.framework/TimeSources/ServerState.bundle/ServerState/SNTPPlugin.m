...
- (SNTPPlugin)initWithClock:(id)a3 daemonCore:(id)a4;
- (void)dealloc;
...
- (void)didSetTime:(double)a3 withUncertainty:(double)a4 fromSource:(id)a5 lastInput:(id)a6
{
  ...
  v14 = [&off_4108 objectForKeyedSubscript:a5];
  if (self->header)
  {
    v15 = v14;
    if (v14)
    {
      sntp_datestamp_from_double(kCFAbsoluteTimeIntervalSince1970 + a3 + 2208988800.0);
      v16 = self->header;
      ...
      *self->header &= 0x3Fu;
      ...
      if (os_log_type_enabled(v20, OS_LOG_TYPE_INFO))
      {
        ...
        v24 = *v21 >> 6;
        var3 = v21->var3;
        v26 = [objc_msgSend(&off_4108 objectForKeyedSubscript:{a5), "UTF8String"}];
        *v27 = 67110146;
        *&v27[4] = var0;
        *&v27[8] = 1024;
        *&v27[10] = var1;
