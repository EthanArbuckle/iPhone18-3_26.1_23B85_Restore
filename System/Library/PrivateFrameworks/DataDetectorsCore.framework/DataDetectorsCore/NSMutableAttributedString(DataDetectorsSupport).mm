...
- (void)dd_appendAttributedString:()DataDetectorsSupport
{
  if ([a3 length])
  {
    ...
    if (v5)
    {
      ...
      [self appendAttributedString:v7];
    }

    else
    {

      [self appendAttributedString:a3];
    }
  }
}
...
- (void)dd_chopResults
{
  ...
  v4[3] = &unk_1E8002790;
  v4[4] = self;
  [self enumerateAttribute:@"DDResultAttributeName" inRange:0 options:v3 usingBlock:{0, v4}];
}
...
- (void)dd_offsetResultsBy:()DataDetectorsSupport
{
  ...
  v6[5] = &v7;
  v6[6] = a3;
  [self enumerateAttribute:@"DDResultAttributeName" inRange:0 options:v5 usingBlock:{0, v6}];
