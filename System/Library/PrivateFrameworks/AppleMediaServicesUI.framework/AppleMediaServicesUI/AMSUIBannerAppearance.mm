...
- (AMSUIBannerAppearance)initWithDictionary:(id)a3
{
  ...
  v5 = [(AMSUIAppearance *)&v43 initWithDictionary:v4];
  if (v5)
  {
    ...
    v12 = [AMSUIAppearance _accessorySecondaryButtonBackgroundColorWithDictionary:v4];
    ...
    v28 = [AMSUIAppearance _imageSymbolConfigurationWithDictionary:v4];
    imageSymbolConfiguration = v5->_imageSymbolConfiguration;
    v5->_imageSymbolConfiguration = v28;

    v30 = [AMSUIAppearance _imageTintColorWithDictionary:v4];
    ...
    v36 = [AMSUIAppearance _separatorColorWithDictionary:v4];
    separatorColor = v5->_separatorColor;
    v5->_separatorColor = v36;

    v38 = [AMSUIAppearance _titleFontWithDictionary:v4];
    titleFont = v5->_titleFont;
    v5->_titleFont = v38;

    v40 = [AMSUIAppearance _titleTextColorWithDictionary:v4];
