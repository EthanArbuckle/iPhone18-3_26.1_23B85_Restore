...
+ (id)fontWithDictionary:(id)a3 compatibleWith:(id)a4
{
  ...
  if (v6)
  {
    v8 = [v6 objectForKeyedSubscript:*MEMORY[0x1E698C4D8]];
    objc_opt_class();
    ...
    v11 = [v6 objectForKeyedSubscript:*MEMORY[0x1E698C4E8]];
    objc_opt_class();
    if (objc_opt_isKindOfClass())
    {
      v12 = v11;
    ...
    v13 = [v6 objectForKeyedSubscript:*MEMORY[0x1E698C4E0]];
    objc_opt_class();
    if (objc_opt_isKindOfClass())
    {
      v14 = v13;
    ...
    v15 = [v6 objectForKeyedSubscript:*MEMORY[0x1E698C4F0]];
    objc_opt_class();
    if (objc_opt_isKindOfClass())
    {
      v16 = v15;
    ...
    {
      v39 = v14;
      v21 = [MEMORY[0x1E69DB880] preferredFontDescriptorWithTextStyle:v19 compatibleWithTraitCollection:v7];
      v22 = v21;
      if (v20)
      {
