...
- (ICTTTextEdit)editAtIndex:()UI
{
  v7 = 0;
  v8 = 0;
  v3 = [self attributesAtIndex:a3 effectiveRange:&v7];
...
- (void)enumerateEditsInRange:()UI usingBlock:
{
  ...
  v13 = v8;
  v11 = v8;
  [self enumerateAttributesInRange:v10.location options:v10.length usingBlock:{0, v12}];
}
...
- (id)editsInRange:()UI
{
  ...
  v12 = array;
  v8 = array;
  [self enumerateEditsInRange:a3 usingBlock:{a4, v11}];
  v9 = [v8 copy];
...
- (uint64_t)edits
{
  ...
  return [self editsInRange:{ic_range, v2}];
}
