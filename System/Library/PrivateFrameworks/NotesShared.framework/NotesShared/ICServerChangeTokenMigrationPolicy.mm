...
- (BOOL)createDestinationInstancesForSourceInstance:(id)instance entityMapping:(id)mapping manager:(id)manager error:(id *)error
{
  ...
  managerCopy = manager;
  v22.receiver = self;
  v22.super_class = ICServerChangeTokenMigrationPolicy;
  ...
  if (v13)
  {
    ...
    v18 = [instanceCopy valueForKey:@"ckServerChangeToken"];
    v19 = v18;
    if (v18)
    {
      data = [v18 data];
      [firstObject setValue:data forKey:@"ckServerChangeTokenData"];
    }
  }
