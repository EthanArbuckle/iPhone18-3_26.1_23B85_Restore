...
- (id)description
{
  ...
  v5 = [(WiFiAnalyticsAWDWiFiNWActivityStateBin *)self dictionaryRepresentation];
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v6 = [(NSString *)self->_state copyWithZone:a3];
  v7 = *(v5 + 16);
  *(v5 + 16) = v6;
...
- (BOOL)isEqual:(id)a3
{
  ...
  if (*&self->_has)
  {
    if ((*(v4 + 24) & 1) != 0 && self->_residentTime == *(v4 + 1))
    {
      v6 = 1;
      goto LABEL_9;
    }
