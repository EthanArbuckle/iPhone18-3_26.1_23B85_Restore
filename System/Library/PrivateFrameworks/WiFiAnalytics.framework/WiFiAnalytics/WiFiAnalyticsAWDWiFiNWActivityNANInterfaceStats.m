...
- (void)copyTo:(id)a3
{
  ...
  {
    [v37 clearPackets];
    v4 = [(WiFiAnalyticsAWDWiFiNWActivityNANInterfaceStats *)self packetsCount];
    if (v4)
    {
      v5 = v4;
      for (i = 0; i != v5; ++i)
  ...
  {
    [v37 clearBytes];
    v8 = [(WiFiAnalyticsAWDWiFiNWActivityNANInterfaceStats *)self bytesCount];
    if (v8)
    {
      v9 = v8;
      for (j = 0; j != v9; ++j)
  ...
  {
    [v37 clearNpeers];
    v12 = [(WiFiAnalyticsAWDWiFiNWActivityNANInterfaceStats *)self npeersCount];
    if (v12)
    {
      v13 = v12;
      for (k = 0; k != v13; ++k)
...
LABEL_20:
  if ([(WiFiAnalyticsAWDWiFiNWActivityNANInterfaceStats *)self enableStatesCount])
  {
    ...
    v17 = [(WiFiAnalyticsAWDWiFiNWActivityNANInterfaceStats *)self enableStatesCount];
    if (v17)
    {
      v18 = v17;
      for (m = 0; m != v18; ++m)
  ...
  if ([(WiFiAnalyticsAWDWiFiNWActivityNANInterfaceStats *)self txLatencyBKsCount])
  {
    ...
    v21 = [(WiFiAnalyticsAWDWiFiNWActivityNANInterfaceStats *)self txLatencyBKsCount];
    if (v21)
    {
      v22 = v21;
      for (n = 0; n != v22; ++n)
  ...
  if ([(WiFiAnalyticsAWDWiFiNWActivityNANInterfaceStats *)self txLatencyBEsCount])
  {
    ...
    v25 = [(WiFiAnalyticsAWDWiFiNWActivityNANInterfaceStats *)self txLatencyBEsCount];
    if (v25)
    {
      v26 = v25;
      for (ii = 0; ii != v26; ++ii)
  ...
  if ([(WiFiAnalyticsAWDWiFiNWActivityNANInterfaceStats *)self txLatencyVOsCount])
  {
    ...
    v29 = [(WiFiAnalyticsAWDWiFiNWActivityNANInterfaceStats *)self txLatencyVOsCount];
    if (v29)
    {
      v30 = v29;
      for (jj = 0; jj != v30; ++jj)
  ...
  if ([(WiFiAnalyticsAWDWiFiNWActivityNANInterfaceStats *)self txLatencyVIsCount])
  {
    ...
    v33 = [(WiFiAnalyticsAWDWiFiNWActivityNANInterfaceStats *)self txLatencyVIsCount];
    if (v33)
    {
      v34 = v33;
      for (kk = 0; kk != v34; ++kk)
