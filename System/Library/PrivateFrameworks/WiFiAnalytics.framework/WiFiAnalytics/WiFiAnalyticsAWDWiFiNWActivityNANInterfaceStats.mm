...
- (id)description
{
  ...
  v8.receiver = self;
  v8.super_class = WiFiAnalyticsAWDWiFiNWActivityNANInterfaceStats;
  v4 = [(WiFiAnalyticsAWDWiFiNWActivityNANInterfaceStats *)&v8 description];
  dictionaryRepresentation = [(WiFiAnalyticsAWDWiFiNWActivityNANInterfaceStats *)self dictionaryRepresentation];
...
- (void)copyTo:(id)to
{
  ...
  {
    [toCopy clearPackets];
    packetsCount = [(WiFiAnalyticsAWDWiFiNWActivityNANInterfaceStats *)self packetsCount];
    if (packetsCount)
    {
      v5 = packetsCount;
      for (i = 0; i != v5; ++i)
      {
        v7 = [(WiFiAnalyticsAWDWiFiNWActivityNANInterfaceStats *)self packetsAtIndex:i];
  ...
  {
    [toCopy clearBytes];
    bytesCount = [(WiFiAnalyticsAWDWiFiNWActivityNANInterfaceStats *)self bytesCount];
    if (bytesCount)
    {
      v9 = bytesCount;
      for (j = 0; j != v9; ++j)
      {
        v11 = [(WiFiAnalyticsAWDWiFiNWActivityNANInterfaceStats *)self bytesAtIndex:j];
        [toCopy addBytes:v11];
      }
    }
  }
  ...
  {
    [toCopy clearNpeers];
    npeersCount = [(WiFiAnalyticsAWDWiFiNWActivityNANInterfaceStats *)self npeersCount];
    if (npeersCount)
    {
      v13 = npeersCount;
      for (k = 0; k != v13; ++k)
      {
        v15 = [(WiFiAnalyticsAWDWiFiNWActivityNANInterfaceStats *)self npeersAtIndex:k];
...
LABEL_20:
  if ([(WiFiAnalyticsAWDWiFiNWActivityNANInterfaceStats *)self enableStatesCount])
  {
    ...
    enableStatesCount = [(WiFiAnalyticsAWDWiFiNWActivityNANInterfaceStats *)self enableStatesCount];
  ...
  if ([(WiFiAnalyticsAWDWiFiNWActivityNANInterfaceStats *)self txLatencyBKsCount])
  {
    ...
    txLatencyBKsCount = [(WiFiAnalyticsAWDWiFiNWActivityNANInterfaceStats *)self txLatencyBKsCount];
    if (txLatencyBKsCount)
    {
      v22 = txLatencyBKsCount;
      for (n = 0; n != v22; ++n)
      {
        v24 = [(WiFiAnalyticsAWDWiFiNWActivityNANInterfaceStats *)self txLatencyBKAtIndex:n];
  ...
  if ([(WiFiAnalyticsAWDWiFiNWActivityNANInterfaceStats *)self txLatencyBEsCount])
  {
    ...
    txLatencyBEsCount = [(WiFiAnalyticsAWDWiFiNWActivityNANInterfaceStats *)self txLatencyBEsCount];
    if (txLatencyBEsCount)
    {
      v26 = txLatencyBEsCount;
      for (ii = 0; ii != v26; ++ii)
      {
        v28 = [(WiFiAnalyticsAWDWiFiNWActivityNANInterfaceStats *)self txLatencyBEAtIndex:ii];
  ...
  if ([(WiFiAnalyticsAWDWiFiNWActivityNANInterfaceStats *)self txLatencyVOsCount])
  {
    ...
    txLatencyVOsCount = [(WiFiAnalyticsAWDWiFiNWActivityNANInterfaceStats *)self txLatencyVOsCount];
    if (txLatencyVOsCount)
    {
      v30 = txLatencyVOsCount;
      for (jj = 0; jj != v30; ++jj)
      {
        v32 = [(WiFiAnalyticsAWDWiFiNWActivityNANInterfaceStats *)self txLatencyVOAtIndex:jj];
  ...
  if ([(WiFiAnalyticsAWDWiFiNWActivityNANInterfaceStats *)self txLatencyVIsCount])
  {
    ...
    txLatencyVIsCount = [(WiFiAnalyticsAWDWiFiNWActivityNANInterfaceStats *)self txLatencyVIsCount];
...
- (void)mergeFrom:(id)from
{
  ...
  if (*(fromCopy + 8))
  {
    [(WiFiAnalyticsAWDWiFiNWActivityNANInterfaceStats *)self setRole:?];
  }
  ...
  if (v6)
  {
    ...
    do
    {
      for (i = 0; i != v7; ++i)
      {
        ...
        [(WiFiAnalyticsAWDWiFiNWActivityNANInterfaceStats *)self addPackets:*(*(&v75 + 1) + 8 * i)];
      }
  ...
  if (v11)
  {
    ...
    do
    {
      for (j = 0; j != v12; ++j)
      {
        ...
        [(WiFiAnalyticsAWDWiFiNWActivityNANInterfaceStats *)self addBytes:*(*(&v71 + 1) + 8 * j)];
      }
  ...
  if (v16)
  {
    ...
    do
    {
      for (k = 0; k != v17; ++k)
      {
        ...
        [(WiFiAnalyticsAWDWiFiNWActivityNANInterfaceStats *)self addNpeers:*(*(&v67 + 1) + 8 * k)];
      }
  ...
  if (v22)
  {
    ...
    do
    {
      for (m = 0; m != v23; ++m)
      {
        ...
        [(WiFiAnalyticsAWDWiFiNWActivityNANInterfaceStats *)self addEnableState:*(*(&v63 + 1) + 8 * m)];
      }
  ...
  if (v27)
  {
    ...
    do
    {
      for (n = 0; n != v28; ++n)
      {
        ...
        [(WiFiAnalyticsAWDWiFiNWActivityNANInterfaceStats *)self addTxLatencyBK:*(*(&v59 + 1) + 8 * n)];
      }
  ...
  if (v32)
  {
    ...
    do
    {
      for (ii = 0; ii != v33; ++ii)
      {
        ...
        [(WiFiAnalyticsAWDWiFiNWActivityNANInterfaceStats *)self addTxLatencyBE:*(*(&v55 + 1) + 8 * ii)];
      }
  ...
  if (v37)
  {
    ...
    do
    {
      for (jj = 0; jj != v38; ++jj)
      {
        ...
        [(WiFiAnalyticsAWDWiFiNWActivityNANInterfaceStats *)self addTxLatencyVO:*(*(&v51 + 1) + 8 * jj)];
      }
  ...
  if (v42)
  {
    ...
    do
    {
      for (kk = 0; kk != v43; ++kk)
      {
        ...
        [(WiFiAnalyticsAWDWiFiNWActivityNANInterfaceStats *)self addTxLatencyVI:*(*(&v47 + 1) + 8 * kk), v47];
      }
