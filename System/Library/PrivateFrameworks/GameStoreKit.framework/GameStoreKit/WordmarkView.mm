...
- (_TtC12GameStoreKit12WordmarkView)initWithCoder:(id)coder;
- (_TtC12GameStoreKit12WordmarkView)initWithFrame:(CGRect)frame;
- (void)layoutSubviews;
@end
...
- (_TtC12GameStoreKit12WordmarkView)initWithFrame:(CGRect)frame
{
  v3 = sub_24F00BF0C(1, 0, frame.origin.x, frame.origin.y, frame.size.width, frame.size.height, 0.0);
  swift_getObjectType();
...
- (BOOL)hasContent
{
  image = [*(&self->super.super.super.isa + OBJC_IVAR____TtC12GameStoreKit12WordmarkView_imageView) image];
  v3 = image;
  if (image)
  {
  }
