...
- (ASKProfilePictureStore)init
{
  ...
  if (v2)
  {
    ...
    [defaultCenter addObserver:v2 selector:sel_appleAccountsDidChange_ name:*MEMORY[0x277CB8B78] object:v2->_accountStore];
    ...
    [defaultCenter3 addObserver:v2 selector:sel_profilePictureStoreDidChange_ name:*MEMORY[0x277CEC9C0] object:0];
