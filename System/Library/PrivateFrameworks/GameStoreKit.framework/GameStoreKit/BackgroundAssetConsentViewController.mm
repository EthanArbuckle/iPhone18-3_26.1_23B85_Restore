...
- (_TtC12GameStoreKit36BackgroundAssetConsentViewController)init;
- (_TtC12GameStoreKit36BackgroundAssetConsentViewController)initWithTitle:(id)title detailText:(id)text icon:(id)icon contentLayout:(int64_t)layout;
- (_TtC12GameStoreKit36BackgroundAssetConsentViewController)initWithTitle:(id)title detailText:(id)text symbolName:(id)name contentLayout:(int64_t)layout;
@end
...
LABEL_5:
    v14 = 0;
    v16 = 0;
    return sub_24EF16A70(v9, v11, text, v13, v14, v16, layout);
  }
