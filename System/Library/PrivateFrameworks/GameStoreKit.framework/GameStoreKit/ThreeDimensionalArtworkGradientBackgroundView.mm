...
- (_TtC12GameStoreKit45ThreeDimensionalArtworkGradientBackgroundView)initWithCoder:(id)coder;
- (_TtC12GameStoreKit45ThreeDimensionalArtworkGradientBackgroundView)initWithFrame:(CGRect)frame;
- (void)layoutSubviews;
@end
