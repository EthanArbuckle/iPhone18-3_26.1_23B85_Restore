...
- (_TtC12GameStoreKit14JSUserDefaults)init;
- (id)double:(id)double;
...
- (id)string:(id)string
{
  v4 = *(&self->super.isa + OBJC_IVAR____TtC12GameStoreKit14JSUserDefaults_userDefaults);
  selfCopy = self;
...
- (void)setString:(id)string :(id)a4
{
  ...
  {
    sub_24F92B0D8();
    v6 = *(&self->super.isa + OBJC_IVAR____TtC12GameStoreKit14JSUserDefaults_userDefaults);
    v7 = a4;
    selfCopy = self;
    v9 = sub_24F92B098();
  }
