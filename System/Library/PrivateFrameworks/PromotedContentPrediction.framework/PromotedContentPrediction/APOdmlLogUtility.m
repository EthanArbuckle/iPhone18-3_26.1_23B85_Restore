...
+ (void)logModelInputWithAdamID:(id)a3 adamID:(id)a4
{
  ...
  v5 = a4;
  v8 = objc_msgSend_mlDictionaryForJSON(a3, v6, v7);
  v11 = objc_msgSend_mutableCopy(v8, v9, v10);

  if (v11)
  {
    objc_msgSend_setObject_forKeyedSubscript_(v11, v12, v5, @"adamID");
    v29[0] = @"adFeatures";
    v28[0] = @"loggerKey";
...
+ (void)logTrainingRowFeatures:(id)a3
{
  ...
  v30 = 0u;
  v31 = 0u;
  obj = objc_msgSend_features(v3, v4, v5);
  ...
  if (v7)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        v17 = objc_msgSend_rowID(v3, v15, v16);
...
+ (void)printDESRecordRowOrder:(id)a3 iterationNumber:(id)a4
{
  ...
  objc_msgSend_setValue_forKey_(v8, v11, v5, @"IterationNumber");
...
+ (void)printDESRecordInSegments:(id)a3 isPlugin:(BOOL)a4 rowID:(id)a5
{
  ...
  if (!v33)
  {
    ...
    v33 = objc_msgSend_UUIDString(v13, v14, v15);
  }

  v32 = v7;
  v34 = objc_msgSend_mlJSONStringWithPrettyPrint_(v7, v8, 0);
  ...
  if (v25)
  {
    ...
    do
    {
      ...
      if (os_log_type_enabled(v37, OS_LOG_TYPE_DEFAULT))
      {
        ...
        ++v33;
        v39 = v38;
        v41 = objc_msgSend_substringWithRange_(v7, v40, v35, v36);
        *buf = 138479107;
        v48 = v38;
        v49 = 2112;
        v50 = v46;
