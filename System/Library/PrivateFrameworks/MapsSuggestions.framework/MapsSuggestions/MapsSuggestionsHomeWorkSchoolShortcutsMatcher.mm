@interface MapsSuggestionsHomeWorkSchoolShortcutsMatcher
- (id)_getShortcuts;
@end

@implementation MapsSuggestionsHomeWorkSchoolShortcutsMatcher
...
- (id)_getShortcuts
{
  ...
  else
  {
    ...
    v7 = v4;
    v12 = v7;
    if (([(MapsSuggestionsMapsSync *)mapsSync homeWorkSchoolShortcutsFromFavoritesWithHandler:v11]& 1) == 0)
    {
...
void __62__MapsSuggestionsHomeWorkSchoolShortcutsMatcher__getShortcuts__block_invoke(uint64_t a1, void *a2, void *a3)
{
  v17 = *MEMORY[0x1E69E9840];
  v6 = a2;
  v7 = a3;
  ...
  else
  {
    ...
    if (os_log_type_enabled(v10, OS_LOG_TYPE_ERROR))
    {
      ...
      v14 = 159;
      v15 = 2082;
      v16 = "[MapsSuggestionsHomeWorkSchoolShortcutsMatcher _getShortcuts]_block_invoke";
