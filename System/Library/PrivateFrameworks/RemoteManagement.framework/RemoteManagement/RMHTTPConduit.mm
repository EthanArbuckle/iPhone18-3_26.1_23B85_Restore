...
- (RMHTTPConduit)initWithManagementSourceObjectID:(id)a3 inContext:(id)a4 session:(id)a5
{
  ...
  if (v12)
  {
    objc_storeStrong(&v12->_managementSourceObjectID, a3);
...
- (void)enrollWithStatusItems:(id)a3 completionHandler:(id)a4
{
  ...
  {
    v11 = v25[5];
    v12 = [RMModelAnyPayload buildFromDictionary:v6];
...
- (void)_didReceiveEnrollReferralWithOriginalRequest:(id)a3 responsePayload:(id)a4 response:(id)a5 error:(id)a6 completionHandler:(id)a7
{
  ...
  else
  {
    ...
    v32 = [v12 responseReferralBaseURL];
    if (v32)
    {
      ...
      if (v33)
      {
        ...
        else
        {
          ...
          if (v21 >= 2)
          {
            v22 = [v20 subarrayWithRange:{v21 - 2, 2}];
...
- (void)_processDeclarationItemsWithContext:(id)a3 infos:(id)a4 declarationItemClass:(Class)a5 declarationItemKeyPath:(id)a6
{
  ...
  v39 = self;
  v11 = [(RMHTTPConduit *)self managementSourceObjectID];
  v38 = v9;
...
- (void)_fetchNextObjectOfClass:(Class)a3 endpoint:(id)a4 completionHandler:(id)a5
{
  ...
  if (!v36[5])
  {
    ...
    if (os_log_type_enabled(v18, OS_LOG_TYPE_DEBUG))
    {
      ...
      v21 = [(RMHTTPConduit *)self managementSourceObjectID];
      sub_10003C624(v20, v21, v56, v18);
    }
  ...
  if (v21 == 200 || !v19 || v21 == 404)
  {
    ...
    *&v37[16] = 0x3032000000;
    ...
    else
    {
      ...
      [(RMHTTPConduit *)self _fetchNextObjectOfClass:v26 endpoint:v23 completionHandler:v20];
    }
...
- (void)sendStatusData:(id)a3 completionHandler:(id)a4
{
  ...
  if (v28[5])
  {
    [(RMHTTPConduit *)self _setBody:v6 onURLRequest:?];
    v11 = v28[5];
    v12 = v22[5];
    v14[0] = _NSConcreteStackBlock;
    v14[1] = 3221225472;
...
- (id)_processResponse:(id)a3 data:(id)a4 payloadClassByStatusCode:(id)a5 shouldRetry:(BOOL *)a6 error:(id *)a7
{
  ...
  if ([v12 statusCode] == 401 && !-[RMHTTPConduit _processUnauthorizedResponse:shouldRetry:error:](self, "_processUnauthorizedResponse:shouldRetry:error:", v12, a6, a7))
  {
    goto LABEL_35;
  }
  ...
  {
    v49 = 0;
    v19 = [(RMHTTPConduit *)self _processErrorResponse:v12 data:v13 error:&v49];
    v20 = v49;
    v21 = v20;
    if ((v19 & 1) == 0)
    {
    ...
    if (v13)
    {
      v22 = [v13 base64EncodedStringWithOptions:0];
      if (!a7)
      {
        goto LABEL_33;
      }
...
LABEL_35:
    ...
    v38 = [RMErrorUtilities createHTTPErrorWithStatusCode:v15 reason:v22];
    if (v38)
    {
      v38 = v38;
      *a7 = v38;
...
LABEL_20:
  ...
  if (v18)
  {
    v48 = [v12 allHeaderFields];
    v23 = [v48 objectForKeyedSubscript:@"Content-Type"];
    v24 = @"text/html";
    v47 = v23;
    if (v23)
    {
    ...
    if (v13 && ([(__CFString *)v41 isEqualToString:@"application/json"]& 1) == 0)
    {
      v44 = [(RMHTTPConduit *)self _incrementConduitStateError:2 serverRetryAfter:0 error:a7];
      v34 = 0;
      if (a7 && v44)
      {
    ...
    else
    {
      ...
      if (v13)
      {
        v34 = [v18 loadData:v13 serializationType:1 error:a7];
      }

      else
      {
        v46 = objc_opt_new();
        v34 = [v18 loadData:v46 serializationType:1 error:a7];
      }
    }
...
LABEL_21:
  v35 = [(RMHTTPConduit *)self _incrementConduitStateError:2 serverRetryAfter:0 error:a7];
  v34 = 0;
  if (a7 && v35)
  {
    v36 = +[RMErrorUtilities createHTTPErrorWithStatusCode:reason:](RMErrorUtilities, "createHTTPErrorWithStatusCode:reason:", [v12 statusCode], @"Unexpected status code");
    if (v36)
    {
      v36 = v36;
      *a7 = v36;
...
- (BOOL)_processUnauthorizedResponse:(id)a3 shouldRetry:(BOOL *)a4 error:(id *)a5
{
  ...
  v10 = [v9 objectForKeyedSubscript:@"WWW-Authenticate"];
...
- (BOOL)_processErrorResponse:(id)a3 data:(id)a4 error:(id *)a5
{
  ...
  v11 = [v10 objectForKeyedSubscript:@"Content-Type"];
  v12 = v11;
  v13 = @"text/html";
  if (v11)
  {
  ...
  if (v9 && ![v24 isEqualToString:@"application/json"])
  {
    v28 = 0;
    goto LABEL_23;
  }
...
LABEL_23:
  ...
  if (v32 > 409)
  {
    ...
    {
      v33 = 0;
      v35 = [v31 isEqualToString:RMProtocolErrorResponse_Code_enrollmentNotAllowed] == 0;
      v36 = 4;
LABEL_38:
      if (v35)
      {
    ...
    if (v32 == 503)
    {
      ...
      if (v38)
      {
        ...
        if (!v33)
        {
          ...
          {
            v33 = [NSDate dateWithTimeIntervalSinceNow:v41];
          }
        }
      }
  ...
  else
  {
    if (v32 != 403)
    {
      ...
      v33 = 0;
      v35 = [v31 isEqualToString:RMProtocolErrorResponse_Code_enrollmentTokenInvalid] == 0;
      v36 = 5;
      goto LABEL_38;
    }

    if (([v31 isEqualToString:RMProtocolErrorResponse_Code_clientVersionInvalid] & 1) != 0 || (objc_msgSend(v31, "isEqualToString:", RMProtocolErrorResponse_Code_deviceAuthInvalid) & 1) != 0 || objc_msgSend(v31, "isEqualToString:", RMProtocolErrorResponse_Code_deviceAuthMissing))
    {
      v33 = 0;
      v34 = 1;
    }
...
LABEL_46:
  v42 = [(RMHTTPConduit *)self _incrementConduitStateError:v34 serverRetryAfter:v33 error:a5];
...
- (id)_makeURLRequestWithManagementSource:(id)a3 method:(id)a4 endpoint:(id)a5
{
  ...
  v8 = a4;
  v9 = a3;
  v10 = [v9 conduitConfig];
  v11 = [v10 state];
  v12 = [v11 enrollmentToken];
  v13 = [v9 enrollmentType];
  ...
  v20 = [v7 stringByReplacingOccurrencesOfString:@"{channel}" withString:v15];

  if (v12)
  {
    v21 = [v20 stringByReplacingOccurrencesOfString:@"{enrollmenttoken}" withString:v12];
...
- (id)_authenticationCredential
{
  ...
  {
    v5 = [v24[5] authenticationScheme];
    v6 = v18[5];
    if (v6 != v5 && (!v5 || ![v6 isEqualToString:v5]))
    {
      v7 = 0;
      goto LABEL_8;
    }
...
- (BOOL)_prepareURLRequest:(id)a3 withAuthenticationCredential:(id)a4 error:(id *)a5
{
  ...
  v20 = 0;
  v12 = [v8 prepareURLRequest:v7 error:&v20];
  v13 = v20;
  v14 = v13;
  if (v12)
  {
...
LABEL_6:
    ...
    if ([v14 length])
    {
      v15 = [v7 valueForHTTPHeaderField:@"Authorization"];
      if ([v15 length])
      {
...
- (BOOL)_prepareTask:(id)a3 withAuthenticationCredential:(id)a4 error:(id *)a5
{
  ...
  {
    v14 = 0;
    v11 = [v8 prepareTask:v7 error:&v14];
    v12 = v14;
    if ((v11 & 1) == 0 && a5 && v12)
    {
      v12 = v12;
...
- (BOOL)_setRequestPayload:(id)a3 onURLRequest:(id)a4 error:(id *)a5
{
  ...
  v10 = [v8 serializeAsDataWithType:1 error:a5];
  if (v10)
  {
LABEL_5:
...
- (void)_resumeTaskForRequest:(id)a3 enrollmentToken:(id)a4 expectedResponseClassByStatusCode:(id)a5 completionHandler:(id)a6
{
  ...
  v12 = a5;
  v13 = a6;
  v14 = [(RMHTTPConduit *)self _authenticationCredential];
  v32 = 0;
  ...
  if (a6)
  {
    ...
    v18 = [(RMHTTPConduit *)self session];
    ...
    v29 = self;
    v30 = v12;
    v21 = [v18 dataTaskWithRequest:v27 completionHandler:v25];
...
- (void)URLSession:(id)a3 task:(id)a4 didReceiveChallenge:(id)a5 completionHandler:(id)a6
{
  ...
  v11 = [v9 isEqualToString:NSURLAuthenticationMethodServerTrust];
  v12 = +[RMLog httpConduit];
  v13 = v12;
  if (v11)
  {
...
- (BOOL)persistentHistoryNotifier:(id)a3 isChangeInteresting:(id)a4 stop:(BOOL *)a5
{
  ...
  else
  {
    ...
    if (v10)
    {
      ...
      v24 = 0x2020000000;
      v25 = 0;
      v14 = [(RMHTTPConduit *)self context];
      v16[0] = _NSConcreteStackBlock;
      v16[1] = 3221225472;
      v16[2] = sub_10003B764;
      v16[3] = &unk_1000D20B0;
...
LABEL_7:
  v10 = [(RMHTTPConduit *)self delegate];
  if (objc_opt_respondsToSelector())
  {
