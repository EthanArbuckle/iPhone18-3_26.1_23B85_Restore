...
- (void)accountPropertiesFromConfiguration:(id)a3 account:(id)a4 accountStore:(id)a5 completionHandler:(id)a6
{
  ...
  v20 = v11;
  v16.receiver = self;
  v16.super_class = AccountTransformerCalDAV;
  v12 = v21;
  v13 = v11;
  v14 = v22;
  v15 = v10;
...
LABEL_14:
        ...
        v19 = +[RMLog accountTransformerCalDAV];
...
LABEL_13:
      ...
      v13 = +[RMLog accountTransformerCalDAV];
...
- (void)configurationUIForConfiguration:(id)a3 completionHandler:(id)a4
{
  ...
  v14 = [RMStoreLocalizable string:@"UI.Description.CalDAV"];
