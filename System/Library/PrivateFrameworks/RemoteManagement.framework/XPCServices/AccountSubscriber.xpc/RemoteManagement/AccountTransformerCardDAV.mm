...
- (void)accountPropertiesFromConfiguration:(id)configuration account:(id)account accountStore:(id)store completionHandler:(id)handler
{
  ...
  v20 = accountCopy;
  v16.receiver = self;
  v16.super_class = AccountTransformerCardDAV;
  v12 = storeCopy;
  v13 = accountCopy;
  v14 = handlerCopy;
...
LABEL_14:
        ...
        v19 = +[RMLog accountTransformerCardDAV];
...
LABEL_13:
      ...
      v13 = +[RMLog accountTransformerCardDAV];
...
- (void)configurationUIForConfiguration:(id)configuration completionHandler:(id)handler
{
  ...
  v14 = [RMStoreLocalizable string:@"UI.Description.CardDAV"];
