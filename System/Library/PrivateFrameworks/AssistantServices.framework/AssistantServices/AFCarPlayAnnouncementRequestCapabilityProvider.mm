  ...
  if (v7)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        [*(*(&v11 + 1) + 8 * v10) provider:self availableAnnouncementRequestTypesChanged:{a3, v11}];
        v10 = v10 + 1;
      }
...
- (void)_availableAnnouncementRequestTypesForCarPlayConnectionWithCompletion:(id)a3
{
  ...
  v6 = a3;
  v3 = v6;
  [(AFCarPlayAnnouncementRequestCapabilityProvider *)v5 isCarPlayConnectedWithCompletion:v4];
}
...
- (AFCarPlayAnnouncementRequestCapabilityProvider)initWithQueue:(id)a3
{
  ...
  if (v6)
  {
    objc_storeStrong(&v6->_providerQueue, a3);
    v17 = 0;
    v18 = &v17;
    v19 = 0x2050000000;
    v8 = qword_1005903C8;
