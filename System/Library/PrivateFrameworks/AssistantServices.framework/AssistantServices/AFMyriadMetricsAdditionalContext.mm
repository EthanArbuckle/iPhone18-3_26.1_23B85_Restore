...
- (AFMyriadMetricsAdditionalContext)initWithRawGoodnessScore:(unsigned __int8)score goodnessScore:(unsigned __int8)goodnessScore deviceClass:(unsigned __int8)class deviceProductType:(unsigned __int8)type;
@end
...
{
  v11.receiver = self;
  v11.super_class = AFMyriadMetricsAdditionalContext;
