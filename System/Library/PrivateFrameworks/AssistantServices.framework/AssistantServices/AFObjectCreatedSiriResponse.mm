...
- (AFObjectCreatedSiriResponse)initWithCoder:(id)coder;
...
- (AFObjectCreatedSiriResponse)initWithCoder:(id)coder
{
  ...
  if (v5)
  {
    v6 = [coderCopy decodeObjectOfClass:objc_opt_class() forKey:@"ObjectCreatedResponseObjectIdentifier"];
    v7 = [v6 copy];
...
- (void)encodeWithCoder:(id)coder
{
  ...
  [coderCopy encodeObject:self->_objectIdentifier forKey:{@"ObjectCreatedResponseObjectIdentifier", v5.receiver, v5.super_class}];
}
