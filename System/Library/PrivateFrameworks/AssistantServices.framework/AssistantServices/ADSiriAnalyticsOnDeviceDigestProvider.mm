...
+ (unsigned)_fetchLatestDaysWithTwoAssistantTurnsPerWeek
{
  ...
  onDeviceDigestSegmentsCohorts = [metrics OnDeviceDigestSegmentsCohorts];

  v6 = [[BMPublisherOptions alloc] initWithStartDate:0 endDate:0 maxEvents:1 lastN:0 reversed:1];
  v7 = [onDeviceDigestSegmentsCohorts publisherWithOptions:v6];
...
+ (id)createOnDeviceDigestEvent
{
  ...
  [v3 setDaysWithTwoAssistantSpeechRequestsPerWeek:{objc_msgSend(self, "_fetchLatestDaysWithTwoAssistantSpeechRequestsPerWeek")}];
  [v3 setDaysWithTwoValidAssistantTurnsPerWeek:{objc_msgSend(self, "_fetchLatestDaysWithTwoAssistantTurnsPerWeek")}];
