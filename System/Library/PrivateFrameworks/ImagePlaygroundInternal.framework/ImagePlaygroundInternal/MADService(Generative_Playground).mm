...
+ (uint64_t)getEmbeddingVectorDimension:()Generative_Playground
{
  getUnifiedEmbeddingVersion = [MEMORY[0x1E69AE238] getUnifiedEmbeddingVersion];
  v5 = MEMORY[0x1E69AE238];

  return [v5 getEmbeddingFormatForVersion:getUnifiedEmbeddingVersion dimension:a3 type:0 error:0];
}
