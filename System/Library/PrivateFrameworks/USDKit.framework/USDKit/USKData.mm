...
- (uint64_t)initWithDouble4x4:(__int128 *)double4x4;
- (uint64_t)initWithQuatf:(void *)quatf;
...
- (USKData)initWithString:(id)string
{
  ...
  {
    v5 = stringCopy;
    v11 = objc_msgSend_UTF8String(stringCopy, v6, v7, v8);
    v14 = 0;
