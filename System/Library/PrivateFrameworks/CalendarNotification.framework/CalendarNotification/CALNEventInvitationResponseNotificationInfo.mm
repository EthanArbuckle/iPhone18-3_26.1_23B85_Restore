...
- (CALNEventInvitationResponseNotificationInfo)initWithSourceClientIdentifier:(id)identifier launchURL:(id)l expirationDate:(id)date eventInvitationNotification:(id)notification eventRepresentationDictionary:(id)dictionary isDelegate:(BOOL)delegate sourceTitle:(id)title sourceIdentifier:(id)self0;
- (id)description;
@end
...
- (id)description
{
  ...
  v3 = objc_opt_class();
  sourceClientIdentifier = [(CALNEventInvitationResponseNotificationInfo *)self sourceClientIdentifier];
  launchURL = [(CALNEventInvitationResponseNotificationInfo *)self launchURL];
  expirationDate = [(CALNEventInvitationResponseNotificationInfo *)self expirationDate];
  eventInvitationNotification = [(CALNEventInvitationResponseNotificationInfo *)self eventInvitationNotification];
  eventRepresentationDictionary = [(CALNEventInvitationResponseNotificationInfo *)self eventRepresentationDictionary];
  v9 = [MEMORY[0x277CCABB0] numberWithBool:{-[CALNEventInvitationResponseNotificationInfo isDelegate](self, "isDelegate")}];
  sourceTitle = [(CALNEventInvitationResponseNotificationInfo *)self sourceTitle];
  sourceIdentifier = [(CALNEventInvitationResponseNotificationInfo *)self sourceIdentifier];
