...
- (ASKNetworkQualityInquiry)init
{
  ...
  if (v2)
  {
    v3 = objc_alloc_init(MEMORY[0x1E69D53E8]);
    manager = v2->_manager;
    v2->_manager = v3;
...
void __67__ASKNetworkQualityInquiry_investigateNetworksWithCompletionBlock___block_invoke_2(uint64_t a1, void *a2, void *a3)
{
  ...
  if (v6)
  {
    v14 = [MEMORY[0x1E698C968] ask_generalLogConfig];
    if (!v14)
    {
    ...
    if (os_log_type_enabled(v15, OS_LOG_TYPE_ERROR))
    {
      ...
      *&buf[12] = 2112;
      *&buf[14] = v6;
      _os_log_impl(&dword_1E12FC000, v15, OS_LOG_TYPE_ERROR, "Could not determine link quality for %@, reason: %@", buf, 0x16u);
    }
  }
