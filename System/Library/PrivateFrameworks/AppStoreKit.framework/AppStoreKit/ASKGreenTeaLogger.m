...
- (void)willAccessLocationForSearch
{
  ...
  {
    *v4 = 0;
    _os_log_impl(&dword_1E12FC000, v3, OS_LOG_TYPE_INFO, "Accessing location for search ad targeting", v4, 2u);
  }
}
...
- (void)willTransmitLocationForSearch
{
  ...
  {
    *v4 = 0;
    _os_log_impl(&dword_1E12FC000, v3, OS_LOG_TYPE_INFO, "Transmitting location to store platform for search ad targeting", v4, 2u);
  }
}
...
- (void)willRequestAppList
{
  ...
  {
    *v4 = 0;
    _os_log_impl(&dword_1E12FC000, v3, OS_LOG_TYPE_INFO, "Accessing application list to update installed status", v4, 2u);
  }
}
