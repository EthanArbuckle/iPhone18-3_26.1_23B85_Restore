...
+ (id)threeCharacterLanguageCodeFromTwoCharacterCode:()AMPICUExtensions
{
  ...
  {
    v5 = [MEMORY[0x1E696AEC0] stringWithUTF8String:ISO3Language];
  }
...
+ (id)threeCharacterRegionCodeFromTwoCharacterCode:()AMPICUExtensions
{
  ...
  {
    v6 = [MEMORY[0x1E696AEC0] stringWithUTF8String:ISO3Country];
  }
...
{
  v1 = [a1 languageCode];
  v2 = [MEMORY[0x1E695DF58] threeCharacterLanguageCodeFromTwoCharacterCode:v1];
  if (!v2)
  {
    v2 = v1;
  }
...
{
  v1 = [a1 countryCode];
  v2 = [MEMORY[0x1E695DF58] threeCharacterRegionCodeFromTwoCharacterCode:v1];
  if (!v2)
  {
    v2 = v1;
  }
...
LABEL_45:
        ...
        *v40 = v29;
        v41 = [MEMORY[0x1E695DF20] dictionaryWithObjects:? forKeys:? count:?];
              ...
              if (*Key)
              {
                ...
                *__dst = 0;
                ...
                if (String)
                {
                  if (*__dst)
                  {
                    v38 = [MEMORY[0x1E696AEC0] stringWithUTF8String:v36];
                    v39 = [MEMORY[0x1E696AEC0] stringWithCharacters:String length:*__dst];
...
- (id)localizedStringForLanguageCode:()AMPICUExtensions length:
{
  v6 = a3;
  v7 = a4;
  v8 = [MEMORY[0x1E695DF58] canonicalLocaleIdentifierFromString:v6];
