...
- (void)messageViewController:(id)a3 didSelectActionWithDialogResult:(id)a4
{
  ...
  v7 = a4;
  v8 = self;
  InlineUnifiedMessagePresenter.messageViewController(_:didSelectActionWith:)(v6, v7);
}
...
- (void)messageViewController:(id)a3 didFailWithError:(id)a4
{
  ...
  v7 = self;
  v8 = a4;
  _s11AppStoreKit29InlineUnifiedMessagePresenterC21messageViewController_16didFailWithErrorySo012AMSUIMessageiJ0_So06UIViewJ0CXc_s0N0_pSgtF_0(v6, a4);
}
...
- (void)messageViewController:(id)a3 enqueueEventWithFields:(id)a4 inTopic:(id)a5
{
  ...
  v9 = a3;
  v10 = self;
  _s11AppStoreKit29InlineUnifiedMessagePresenterC21messageViewController_22enqueueEventWithFields7inTopicySo012AMSUIMessageiJ0_So06UIViewJ0CXc_SDys11AnyHashableVypGSSSgtF_0(v9, v8);
}
...
- (void)engagement:(id)a3 didUpdateEngagementRequest:(id)a4 placement:(id)a5 serviceType:(id)a6 completion:(id)a7
{
  ...
  v18 = a4;
  v19 = self;
  _s11AppStoreKit29InlineUnifiedMessagePresenterC10engagement_9didUpdate9placement11serviceType10completionySo13AMSEngagementC_So0O7RequestCSgS2SySo0O6ResultCSg_s5Error_pSgtctF_0(v17, a4, v11, v13, v14, v16);
  _Block_release(v10);
}
