...
- (NSString)text;
- (_TtC11AppStoreKit19DynamicTypeTextView)initWithFrame:(CGRect)frame textContainer:(id)container;
...
- (void)setTextColor:(id)color
{
  ...
  *&v5[OBJC_IVAR____TtC11AppStoreKit19DynamicTypeTextView__cachedTextColor] = textColor;
