...
- (void)resolveDomainToBundleIds
{
  ...
  if (os_log_type_enabled(v10, OS_LOG_TYPE_INFO))
  {
    v12 = 134217984;
    v13 = v9;
    _os_log_impl(&dword_24AB24000, v10, OS_LOG_TYPE_INFO, "FedStatsCohortQueryInstalledApps#resolveDomainToBundleIds complete in %fms", &v12, 0xCu);
  }
    ...
    if (v7)
    {
      ...
      if ([*(a1 + 40) _isSupportedIntentMediaApp:v7 :v10 :v11])
      {
        ...
        if (os_log_type_enabled(v16, OS_LOG_TYPE_DEBUG))
        {
          ...
          v23 = 2112;
          v24 = v10;
          _os_log_debug_impl(&dword_24AB24000, v16, OS_LOG_TYPE_DEBUG, "pluginkit record: %@ has supported intent %@ and supported media categories: %@", &v19, 0x20u);
        }
      }
    }
...
void __57__FedStatsCohortQueryInstalledApps_lsPluginKitExtensions__block_invoke_cold_1(uint64_t a1, void *a2, NSObject *a3)
{
  ...
  v9 = 2112;
  v10 = v5;
  _os_log_error_impl(&dword_24AB24000, a3, OS_LOG_TYPE_ERROR, "Error enumerating plugins; matching query: %@, error: %@", &v7, 0x16u);
...
void __57__FedStatsCohortQueryInstalledApps_lsPluginKitExtensions__block_invoke_cold_2(uint64_t a1, NSObject *a2)
{
  ...
  v3 = 138412290;
  v4 = a1;
  _os_log_error_impl(&dword_24AB24000, a2, OS_LOG_TYPE_ERROR, "Error enumerating plugins; missing containing bundle of plugin: %@", &v3, 0xCu);
