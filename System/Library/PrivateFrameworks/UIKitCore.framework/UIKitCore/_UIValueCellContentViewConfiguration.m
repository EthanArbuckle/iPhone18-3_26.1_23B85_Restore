...
+ (_UIValueCellContentViewConfiguration)defaultListCellConfigurationForState:(void *)a3 traitCollection:
{
  ...
  {
    v34.receiver = v28;
    v34.super_class = _UIValueCellContentViewConfiguration;
    ...
    if (v32)
    {
      ...
      objc_storeStrong(&v28->_valueLabel, v14);
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  if (v4)
  {
    ...
    *(v4 + 48) = v7;
    ...
    v9 = [(_UIContentViewLabelConfiguration *)self->_valueLabel copy];
    v10 = *(v4 + 56);
    *(v4 + 56) = v9;
    ...
    *(v4 + 64) = self->_textToValuePadding;
    *(v4 + 32) = self->_defaultStyle;
...
- (BOOL)isEqual:(id)a3
{
  ...
  else if (v4 && (objc_opt_class(), (objc_opt_isKindOfClass() & 1) != 0))
  {
    ...
    if (self)
    {
      LOBYTE(self) = self->_defaultStyle == v6->_defaultStyle && [(_UIContentViewImageViewConfiguration *)self->_imageView _isEqualToConfiguration:?]&& [(_UIContentViewLabelConfiguration *)self->_textLabel _isEqualToConfiguration:?]&& [(_UIContentViewLabelConfiguration *)self->_valueLabel _isEqualToConfiguration:?]&& self->_axesPreservingSuperviewLayoutMargins == v7->_axesPreservingSuperviewLayoutMargins && (vminv_u16(vmovn_s32(vuzp1q_s32(vceqq_f64(*&self->_directionalLayoutMargins.top, *&v7->_directionalLayoutMargins.top), vceqq_f64(*&self->_directionalLayoutMargins.bottom, *&v7->_directionalLayoutMargins.bottom)))) & 1) != 0 && self->_imageToTextPadding == v7->_imageToTextPadding && self->_textToValuePadding.vertical == v7->_textToValuePadding.vertical && self->_textToValuePadding.horizontal == v7->_textToValuePadding.horizontal;
    }
  }
...
- (NSString)description
{
  ...
  v32 = [MEMORY[0x1E696AEC0] stringWithFormat:@"textToValuePadding = {horizontal = %g, vertical = %g}", *&self->_textToValuePadding.horizontal, *&self->_textToValuePadding.vertical];
  [v3 addObject:v32];
