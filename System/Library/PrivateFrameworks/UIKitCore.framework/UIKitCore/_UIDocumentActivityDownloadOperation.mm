...
- (_UIDocumentActivityDownloadOperation)initWithURL:(id)l scene:(id)scene;
- (void)main;
@end
...
- (void)main
{
  ...
  [v4 coordinateReadingItemAtURL:self->_url options:0 error:0 byAccessor:{&__block_literal_global_178, v5, v6, v7, v8, selfCopy}];
}
