...
- (void)animateTransition:(id)transition
{
  ...
  v9 = v8;
  _searchPresentationController = [v9 _searchPresentationController];
  ...
  if (isKindOfClass)
  {
    ...
    _includedInPresentationByOffscreenAnimator = [v13 _includedInPresentationByOffscreenAnimator];
    v15 = MEMORY[0x1E695EFF8];
    if (_includedInPresentationByOffscreenAnimator)
    {
      ...
      [searchBarContainerView addSubview:v13];
    }

    v18 = [transitionCopy viewForKey:@"UITransitionContextToView"];
    v19 = v18;
    v68 = v9;
    if (v18)
    {
    ...
    v40 = [searchResultsController _contentOrObservableScrollViewForEdge:1];
    v41 = v40;
    ...
    v67 = _searchPresentationController;
    if ([v13 barPosition] == 3)
    {
      [_searchPresentationController statusBarAdjustment];
      v52 = v52 + v53;
    }
    ...
    if (isAnimated)
    {
      ...
      [(_UISearchControllerAnimator *)selfCopy transitionDuration:v59];
      v63 = v62;
      if (!v61)
      {
        v30 = transitionCoordinator;
        +[UIView animateWithDuration:delay:options:animations:completion:](UIView, "animateWithDuration:delay:options:animations:completion:", [transitionCoordinator completionCurve], v58, v60, v62, 0.0);
        v5 = v70;
        goto LABEL_35;
      }
...
LABEL_35:
    ...
    _searchPresentationController = v67;
    v9 = v68;
    v32 = v66;
    goto LABEL_36;
  }
  ...
  if (isAnimated)
  {
    ...
    v30 = transitionCoordinator;
    +[UIView animateWithDuration:delay:options:animations:completion:](UIView, "animateWithDuration:delay:options:animations:completion:", [transitionCoordinator completionCurve], v27, v29, v31, 0.0);
  }
