...
- (void)ui_appendOrientationDebugDescription:()UIKitOrientationDebugging withName:skipIfNil:
{
  ...
  if (v8)
  {
    ...
    v13 = v8;
    selfCopy = self;
    [self appendCustomFormatWithName:v11 block:v12];
  }

  else if ((a5 & 1) == 0)
  {
    [self appendString:@"<nil>" withName:v9];
  }
}
...
- (void)ui_appendOrientationDebuggingArraySection:()UIKitOrientationDebugging withName:skipIfEmpty:
{
  v8 = a4;
  v9 = a3;
  activeMultilinePrefix = [self activeMultilinePrefix];
  ...
  v11[3] = &unk_1E7120228;
  v11[4] = self;
  [self appendArraySection:v9 withName:v8 multilinePrefix:activeMultilinePrefix skipIfEmpty:a5 objectTransformer:v11];
}
