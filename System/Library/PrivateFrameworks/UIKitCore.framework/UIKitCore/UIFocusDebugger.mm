...
+ (id)_statusForFocusSystem:(id)a3 includeDeferralTarget:(BOOL)a4
{
  ...
  if (v4)
  {
    ...
    v27 = [off_1E70ECC50 messageWithFormat:@"deferral target: %@", v26];
    [v12 addMessage:v27];
  }
...
uint64_t __45__UIFocusDebugger_focusGroupsForEnvironment___block_invoke(uint64_t a1, void *a2, uint64_t a3)
{
  v5 = a2;
  v6 = v5;
  if (a3 || ([v5 parentGroup], v10 = objc_claimAutoreleasedReturnValue(), v10, !v10))
  {
    v7 = [v6 description];
    v8 = [off_1E70ECC58 messageWithString:v7];
...
void __60__UIFocusDebugger_preferredFocusEnvironmentsForEnvironment___block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  else
  {
    ...
    {
      v11 = [off_1E70ECC50 messageWithPrefix:v10 string:v9];
      v12 = [v13 debugStack];
      [v12 addMessage:v11];
    }
