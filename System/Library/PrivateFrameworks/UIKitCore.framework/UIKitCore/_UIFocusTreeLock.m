...
- (BOOL)unlockEnvironmentTree:(id)a3
{
  ...
  if (!v5)
  {
    ...
    [v10 handleFailureInMethod:a2 object:self file:@"_UIFocusTreeLock.m" lineNumber:160 description:{@"Invalid parameter not satisfying: %@", @"environment"}];
  }
...
- (BOOL)isEnvironmentLocked:(id)a3
{
  ...
  if (v6)
  {
    ...
    do
    {
      ...
      while (v7 != v9);
      v13 = [v5 countByEnumeratingWithState:&v18 objects:v24 count:16];
      v7 = v13;
    }
