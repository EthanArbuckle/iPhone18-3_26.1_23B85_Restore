...
- (_UITabElementGroup)initWithIdentifier:(id)a3 title:(id)a4 image:(id)a5 children:(id)a6
{
  ...
  v11 = [(_UITabElement *)&v15 initWithIdentifier:a3 title:a4 image:a5];
  v12 = v11;
  if (v11)
  {
...
- (void)_setChildren:(id)a3
{
  ...
  if (!v5)
  {
    ...
    [v39 handleFailureInMethod:a2 object:self file:@"UITabGroup.m" lineNumber:808 description:{@"Invalid parameter not satisfying: %@", @"children"}];
  }

  v6 = [v5 differenceFromArray:self->_children withOptions:0 usingEquivalenceTest:&__block_literal_global_217];
  if ([v6 hasChanges])
  {
    v40 = a2;
    ...
    if (v9)
    {
      ...
      do
      {
        for (i = 0; i != v10; ++i)
        {
          ...
          v13 = [*(*(&v56 + 1) + 8 * i) object];
          [v7 addObject:v13];
        }

        v10 = [v8 countByEnumeratingWithState:&v56 objects:v63 count:16];
      }
      ...
      do
      {
        for (m = 0; m != v29; ++m)
        {
          ...
          if (([v32 _isUniquelySPI] & 1) == 0)
          {
            ...
            [v33 handleFailureInMethod:v40 object:self file:@"UITabGroup.m" lineNumber:829 description:@"Cannot add UITab objects to a UITabElementGroup. Please use UITab + UITabGroup directly."];
          }
...
LABEL_11:
  ...
  objc_storeStrong(&self->__displayOrder, a3);
  [(_UITabElementGroup *)self _notifyObserversElementsChanged];
  v12 = [(UITab *)self _tabModel];
  [v12 displayOrderIdentifiersDidChangeForGroup:self];

  if (v4 && (*&self->_delegateImplements & 2) != 0)
  {
...
- (id)_orderedChildrenForDisplayOrder:(id)a3
{
  ...
  if (!v4)
  {
    v4 = [(_UITabElementGroup *)self _displayOrder];
  }

  v5 = [(_UITabElementGroup *)self _children];
  if ([v4 count])
  {
    v6 = [v5 mutableCopy];
...
- (id)_defaultChildElement
{
  v3 = [(_UITabElementGroup *)self _defaultChildIdentifier];
  v26[0] = 0;
  v26[1] = v26;
  v26[2] = 0x2020000000;
  v27 = 0;
  ...
  v19 = 0;
  v4 = [(_UITabElementGroup *)self _children];
...
- (void)_selectElement:(id)a3 notifyingDelegate:(BOOL)a4 notifyOnReselection:(BOOL)a5 performBeforeNotifyingDelegate:(id)a6
{
  ...
  if (v12 && ([v12 _isElement] & 1) == 0)
  {
    ...
    [v18 handleFailureInMethod:a2 object:self file:@"UITabGroup.m" lineNumber:957 description:{@"Cannot select a tab (%@) that is not selectable in %@.", v12, self}];
  }

  v19 = v12;
  selectedElement = self->_selectedElement;
  objc_storeStrong(&self->_selectedElement, a3);
  if (v13)
  {
    v13[2](v13);
  }
  ...
  {
    if (v8 && (*&self->_delegateImplements & 1) != 0)
    {
      WeakRetained = objc_loadWeakRetained(&self->_delegate);
      [WeakRetained _tabElementGroup:self didSelectElement:v19];
    }

    v17 = [(UITab *)self _tabModel];
...
- (BOOL)_isCustomizable
{
  ...
  {
    v5 = [(_UITabElementGroup *)self children];
  ...
  if (v9)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        [*(*(&v13 + 1) + 8 * v12++) _didChangeTabModel:{v4, v13}];
      }
...
- (id)_filteredDisplayOrderIdentifiers
{
  ...
  v3 = [(_UITabElementGroup *)self _children];
  v4 = [v3 mutableCopy];

  v5 = objc_alloc_init(MEMORY[0x1E695DF70]);
  v6 = [(_UITabElementGroup *)self _displayOrder];
  v7 = [v6 count];
