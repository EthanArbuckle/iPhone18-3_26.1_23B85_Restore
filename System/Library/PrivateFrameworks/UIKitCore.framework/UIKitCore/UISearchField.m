...
- (UISearchField)initWithFrame:(CGRect)a3
{
  ...
  v3 = [(UITextField *)&v18 initWithFrame:a3.origin.x, a3.origin.y, a3.size.width, a3.size.height];
  if (v3)
  {
    ...
    else
    {
      ...
      v11 = [(UIColor *)1.0 _composedColorFromSourceColor:v12 destinationColor:0 tintColor:0 alpha:?];
    }
...
- (CGRect)rightViewRectForBounds:(CGRect)a3
{
  ...
  [(UITextField *)&v8 rightViewRectForBounds:a3.origin.x, a3.origin.y, a3.size.width, a3.size.height];
  v7 = v6 + 6.0;
