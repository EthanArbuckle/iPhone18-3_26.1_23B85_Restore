...
- (void)_interactionBegan
{
  ...
  {
    v4 = [(_UIHyperOutOfProcessViewAnimator *)self _interactor];
    v5 = [v4 _delegate];
    ...
    v27 = 0u;
    v26 = 0u;
    v7 = [(_UIHyperOutOfProcessViewAnimator *)self _propertyAnimators];
    v8 = [v7 copy];
    ...
    vDSP_vsubD([v24 _unconstrainedPoint], 1, v22, 1, v22, 1, self->__dimensions);
...
- (void)_interactionChanged
{
  ...
  v6 = [v5 _lastConstrainedPoint];
  v7 = [(_UIHyperOutOfProcessViewAnimator *)self _interactor];
  LOBYTE(v6) = _UIHyperregionIsBoundaryCrossedFromPointToPoint(v4, v6, [v7 _constrainedPoint]);

  v9 = MEMORY[0x1EEE9AC00](v8);
  v11 = v25 - ((v10 + 15) & 0xFFFFFFFFFFFFFFF0);
  v12 = [(_UIHyperOutOfProcessViewAnimator *)self _interactor];
  [v12 _closestPoint];
  cblas_dcopy_NEWLAPACK();

  v13 = [(_UIHyperOutOfProcessViewAnimator *)self _interactor];
  v14 = [(_UIHyperOutOfProcessViewAnimator *)self _interactor];
  [v13 _copyOverridePresentationPoint:{objc_msgSend(v14, "_lastConstrainedPoint")}];

  v15 = [(_UIHyperOutOfProcessViewAnimator *)self _interactor];
  [v15 _setOverridingPresentationPoint:1];

  v16 = [(_UIHyperOutOfProcessViewAnimator *)self _interactor];
  v17 = [v16 _delegate];
  v18 = [(_UIHyperOutOfProcessViewAnimator *)self _interactor];
  [v17 _hyperInteractorApplyPresentationPoint:v18];

  v19 = [(_UIHyperOutOfProcessViewAnimator *)self _interactor];
  [v19 _setOverridingPresentationPoint:0];

  v20 = [(_UIHyperOutOfProcessViewAnimator *)self _interactor];
  v21 = memcmp(v11, [v20 _closestPoint], 8 * self->__dimensions);
...
- (void)_interactionEndedMutatingState:(id)a3
{
  ...
  v8 = [(_UIHyperOutOfProcessViewAnimator *)self _interactor];
  [v8 _constrainedVelocity];
  cblas_dcopy_NEWLAPACK();

  v9 = [(_UIHyperOutOfProcessViewAnimator *)self _interactor];
  v10 = [(_UIHyperOutOfProcessViewAnimator *)self _interactor];
  [v9 _copyOverridePresentationPoint:{objc_msgSend(v10, "_constrainedPoint")}];

  v11 = [(_UIHyperOutOfProcessViewAnimator *)self _interactor];
  ...
  if (self->__dimensions)
  {
    ...
    while (1)
    {
      ...
      v18 = *([v17 _constrainedPoint] + 8 * v16);
      v19 = [(_UIHyperOutOfProcessViewAnimator *)self _interactor];
      v20 = v18 - *([v19 _presentationPoint] + 8 * v16);
...
LABEL_6:
    v26 = [(_UIHyperOutOfProcessViewAnimator *)self _interactor];
    ...
    v27 = *&v7[8 * v16] / v20;
    v28 = [(_UIHyperOutOfProcessViewAnimator *)self _interactionEndedSpringParameters];
...
LABEL_8:
  v29 = [(_UIHyperOutOfProcessViewAnimator *)self _interactor];
...
- (void)_animateWithParameters:(id)a3 velocity:(double)a4 animations:(id)a5
{
  v8 = a3;
  v9 = a5;
  v10 = [[UISpringTimingParameters alloc] initWithParameters:v8 initialVelocity:a4, a4];
  v11 = [[UIViewPropertyAnimator alloc] initWithDuration:v10 timingParameters:0.0];
...
{
  v4 = a3;
  v5 = -[_UIHyperOutOfProcessViewAnimator initWithDimensions:](self, "initWithDimensions:", [v4 decodeIntegerForKey:@"_dimensions"]);
  v6 = [v4 decodeObjectOfClass:objc_opt_class() forKey:@"_boundaryCrossedSpringParameters"];
  [(_UIHyperOutOfProcessViewAnimator *)v5 _setBoundaryCrossedSpringParameters:v6];

  v7 = [v4 decodeObjectOfClass:objc_opt_class() forKey:@"_interactionEndedSpringParameters"];
...
{
  v4 = a3;
  [v4 encodeInteger:-[_UIHyperOutOfProcessViewAnimator _dimensions](self forKey:{"_dimensions"), @"_dimensions"}];
  v5 = [(_UIHyperOutOfProcessViewAnimator *)self _boundaryCrossedSpringParameters];
  [v4 encodeObject:v5 forKey:@"_boundaryCrossedSpringParameters"];

  v6 = [(_UIHyperOutOfProcessViewAnimator *)self _interactionEndedSpringParameters];
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    v5 = v4;
    v6 = [(_UIHyperOutOfProcessViewAnimator *)self _dimensions];
...
LABEL_19:
    ...
    v7 = [(_UIHyperOutOfProcessViewAnimator *)self _boundaryCrossedSpringParameters];
    v8 = [v5 _boundaryCrossedSpringParameters];
    v9 = v7;
    v10 = v8;
    v11 = v10;
    if (v9 == v10)
...
LABEL_18:
    ...
    v15 = [(_UIHyperOutOfProcessViewAnimator *)self _interactionEndedSpringParameters];
    v16 = [v5 _interactionEndedSpringParameters];
    v14 = v15;
    v17 = v16;
    v13 = v17;
    if (v14 == v17)
