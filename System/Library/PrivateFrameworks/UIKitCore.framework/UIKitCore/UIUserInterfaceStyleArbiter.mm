...
- (void)toggleCurrentStyleWithOverrideTiming:(int64_t)a3
{
  ...
  if (currentModeValue > 99)
  {
    if (currentModeValue == 100 || currentModeValue == 102)
    {
      ...
      [(UISUserInterfaceStyleMode *)styleMode setOverride:v10, v12];
    }
  }
...
- (id)succinctDescription
{
  v2 = [(UIUserInterfaceStyleArbiter *)self succinctDescriptionBuilder];
  v3 = [v2 build];
...
- (id)descriptionWithMultilinePrefix:(id)a3
{
  v3 = [(UIUserInterfaceStyleArbiter *)self descriptionBuilderWithMultilinePrefix:a3];
  v4 = [v3 build];
...
- (void)_updateCurrentStyleAndNotify:(BOOL)a3 forReason:(int64_t)a4
{
  ...
  v8 = [(UISUserInterfaceStyleMode *)self->_styleMode modeValue];
  currentModeValue = self->_currentModeValue;
  v10 = [(UIUserInterfaceStyleArbiter *)self _updateControllersWithOldModeValue:currentModeValue newModeValue:v8];
...
LABEL_9:
  v12 = [(UIUserInterfaceStyleArbiter *)self _proposedStyleForCurrentMode];
  ...
  v16 = [(UISUserInterfaceStyleMode *)self->_styleMode override];
  v18 = v17;
  ...
  if (v16)
  {
    ...
    v23 = v12 != v16 && v12 != lastProposedAutomaticStyle && lastProposedAutomaticStyle != 0;
...
LABEL_35:
  ...
  if (a4 == 6 || v10 || self->_isDim || !UISUserInterfaceStyleModeOverridesEqual())
  {
LABEL_48:
...
LABEL_52:
  ...
  else
  {
    ...
    [(UIUserInterfaceStyleArbiter *)self _logArbiterDecisionToBiomeWithNewStyle:v12 reason:a4, v38];
  }

  [(UIUserInterfaceStyleArbiter *)self _logChangeEventWithNewMode:v8 oldMode:currentModeValue newStyle:v12 oldStyle:v34 reason:a4, v38];
  if (!v25)
  {
    return;
  }
...
- (void)_setWatchesScreenDim:(BOOL)a3
{
  ...
  if (v3)
  {
    ...
    {
      v6 = [MEMORY[0x1E698E520] sharedBacklight];
  ...
  else
  {
    ...
    {
      v7 = [MEMORY[0x1E698E520] sharedBacklight];
