...
- (_UIMainMenuBaseMenuRequestAction)initWithBaseMenuRequest:(id)request handler:(id)handler;
- (id)baseMenuRequest;
...
- (id)baseMenuRequest
{
  info = [(_UIMainMenuBaseMenuRequestAction *)self info];
...
- (void)handleMainMenuAction
{
  ...
  baseMenuRequest = [(_UIMainMenuBaseMenuRequestAction *)self baseMenuRequest];
  v6 = [v3 performBaseMenuRequest:baseMenuRequest];
