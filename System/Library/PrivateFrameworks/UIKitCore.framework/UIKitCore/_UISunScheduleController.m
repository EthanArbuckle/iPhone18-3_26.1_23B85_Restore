...
- (_UISunScheduleController)init
{
  ...
  if (v2)
  {
    ...
    [v8 addObserver:v3 selector:sel__significantTimeChange name:0x1EFB8EE90 object:0];

    v9 = [MEMORY[0x1E696AD88] defaultCenter];
    [v9 addObserver:v3 selector:sel__timeZoneChange name:*MEMORY[0x1E695DA68] object:0];
...
- (void)_setNextEventTimerToAbsoluteTime:(double)a3
{
  ...
  [v11 addTimer:self->_nextEventTimer forMode:*MEMORY[0x1E695DA28]];
...
- (void)_updateGeoCity
{
  ...
  if (!v5)
  {
    ...
    v17 = [v3 name];
    v6 = [v16 _ui_canonicalTimeZoneNameForTimeZoneName:v17];

    if (v6 && ([v3 name], v18 = objc_claimAutoreleasedReturnValue(), v19 = -[NSObject isEqual:](v6, "isEqual:", v18), v18, (v19 & 1) == 0))
    {
      v8 = [MEMORY[0x1E695DFE8] timeZoneWithName:v6];
      if (v8)
      {
        v21 = [MEMORY[0x1E698B670] sharedManager];
        v5 = [v21 defaultCityForTimeZone:v8];
        ...
        if (v5)
        {
          if (v22)
          {
            ...
            v28 = 2114;
            v29 = v24;
            _os_log_impl(&dword_188A29000, v9, OS_LOG_TYPE_DEFAULT, "SunScheduleController: Canonicalized time zone %{public}@ has a default city %{public}@", &v26, 0x16u);
          }
        ...
        if (v22)
        {
          ...
          v26 = 138543362;
          v27 = v25;
          _os_log_impl(&dword_188A29000, v9, OS_LOG_TYPE_DEFAULT, "SunScheduleController: Canonicalized time zone %{public}@ has no default city", &v26, 0xCu);
        }
      }
      ...
      else
      {
        ...
        if (os_log_type_enabled(v9, OS_LOG_TYPE_DEFAULT))
        {
          v26 = 138543362;
          v27 = v6;
          _os_log_impl(&dword_188A29000, v9, OS_LOG_TYPE_DEFAULT, "SunScheduleController: Canonicalized time zone has name %{public}@ but no NSTimeZone", &v26, 0xCu);
        }
      }
    }
    ...
    else
    {
      ...
      if (os_log_type_enabled(v8, OS_LOG_TYPE_DEFAULT))
      {
        ...
        v26 = 138543362;
        v27 = v20;
        _os_log_impl(&dword_188A29000, v8, OS_LOG_TYPE_DEFAULT, "SunScheduleController: No distinct canonicalized time zone name for %{public}@", &v26, 0xCu);
      }
    }
...
- (void)_updateSunriseSunsetTimesRelativeTo:(double)a3
{
  ...
  if (almanac && self->_hasTimeZoneLocation)
  {
    ...
    v6 = [(GEOAlmanac *)self->_almanac sunrise];
    [v6 timeIntervalSinceReferenceDate];
    v8 = v7;

    if (v8 < a3)
    {
      v9 = [(GEOAlmanac *)self->_almanac nextSunrise];
      [v9 timeIntervalSinceReferenceDate];
      v8 = v10;
    }

    v11 = [(GEOAlmanac *)self->_almanac sunset];
    [v11 timeIntervalSinceReferenceDate];
    v13 = v12;

    if (v13 < a3)
    {
      v14 = [(GEOAlmanac *)self->_almanac nextSunset];
  ...
  else
  {
    ...
    if (v17)
    {
      ...
      *buf = 0;
      v23 = 0;
      v24 = 0;
      if (CFCalendarDecomposeAbsoluteTime(v18, a3, "yMdHm", buf, &v24 + 4, &v24, &v23 + 4, &v23))
      {
        v23 = 0x1300000000;
        if (CFCalendarComposeAbsoluteTime(v18, &self->_sunsetAbsolute, "yMdHm", *buf, HIDWORD(v24), v24, 19, 0))
        {
          if (self->_sunsetAbsolute < a3)
          {
...
- (id)descriptionWithMultilinePrefix:(id)a3
{
  v3 = [(_UISunScheduleController *)self descriptionBuilderWithMultilinePrefix:a3];
  v4 = [v3 build];
