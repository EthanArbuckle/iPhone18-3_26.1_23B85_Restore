...
uint64_t __64___UINavigationBarTransitionContextPush__animateScaleTransition__block_invoke_5(uint64_t a1)
{
  ...
  [v2 setTransform:v5];
  return [*(a1 + 32) setFrame:{*(*(a1 + 40) + 264), *(*(a1 + 40) + 272), *(*(a1 + 40) + 280), *(*(a1 + 40) + 288)}];
}
...
void *__60___UINavigationBarTransitionContextPush__animateContentView__block_invoke(uint64_t a1, double a2)
{
  ...
  *&v5 = a2;
  ...
  [*(v8 + 88) setBackButtonAlpha:v7 titleLabelAlpha:v9 titleViewAlpha:v7 barsAlpha:v7];
  result = *(a1 + 32);
  if (result[12])
  {
    ...
    v11[3] = &unk_1E70F7030;
    v11[4] = result;
    return [result _animateInProcessAsTwoPartsWithOverlapIfNecessaryWithKeyframeID:@"contentViewAlpha" fractionComplete:0 partOne:v11 partTwo:a2];
  }
...
uint64_t __60___UINavigationBarTransitionContextPush__animateContentView__block_invoke_3(uint64_t a1, double a2)
{
  ...
  return [v6 setFrame:{v3 - v8 * a2, v2, v4, v5}];
}
...
{
  v3 = +[_UINavigationBarTransitionContext fadeOutFunction];
  HIDWORD(v4) = HIDWORD(a2);
  *&v4 = a2;
  [v3 _solveForInput:v4];
  v6 = 1.0 - v5;
  ...
  if (v8 != 1)
  {
    ...
    if ((*(v7 + 160) & 0x20) != 0)
    {
      [v9 layoutViewsWithOffset:1 useRestingTitleHeight:{(1.0 - a2) * 0.0 + *(a1 + 40) * a2, 0.0}];
      v10 = [*(*(a1 + 32) + 104) accessoryView];
      [v10 setAlpha:v6];
  ...
  {
LABEL_6:
    [v9 setContentAlpha:0.0];
    goto LABEL_10;
  }

  if ((_textDiffersBetweenLargeTitleAndBackButtonLayouts(v9, *(v7 + 96)) & 1) == 0)
  {
    [*(*(a1 + 32) + 104) setContentAlpha:v6];
  }

  v11 = *(a1 + 32);
  v12 = vmulq_n_f64(vnegq_f64(*(v11 + 296)), a2);
  _updateLargeTitleSpacingForLayout(*(v11 + 104), *(a1 + 48), *(a1 + 56), v12.f64[0], v12.f64[1]);
LABEL_10:
  v13 = *(a1 + 32);
  v14 = *(v13 + 112);
  if ((*(v13 + 160) & 0x40) != 0)
  {
    [v14 layoutViewsWithOffset:1 useRestingTitleHeight:{a2 * 0.0 + (1.0 - a2) * *(a1 + 40), 0.0}];
    v16 = [*(a1 + 32) _animationOptions];
    v18[0] = MEMORY[0x1E69E9820];
    v18[1] = 3221225472;
    v18[2] = __63___UINavigationBarTransitionContextPush__animateLargeTitleView__block_invoke_2;
    v18[3] = &unk_1E70F3590;
    v18[4] = *(a1 + 32);
    return [UIView _animateInProcessKeyframesAlongsideTransitionWithOptions:v16 animations:v18];
  }

  else
  {

    return [v14 setContentAlpha:0.0];
  }
}
