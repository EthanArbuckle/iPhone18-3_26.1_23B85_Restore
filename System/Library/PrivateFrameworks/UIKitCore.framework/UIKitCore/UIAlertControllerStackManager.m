  ...
  if (v4)
  {
    ...
    do
    {
      for (i = 0; i != v5; ++i)
      {
        ...
        {
          [(UIAlertControllerStackManager *)v2 _willHideAlertController:v8];
          ...
          [v8 _setHidden:1];
          [(UIAlertControllerStackManager *)v2 _didHideAlertController:v8];
          [(NSMutableArray *)v2->_hiddenAlertControllers addObject:v8];
        }
      }
...
- (void)_showHiddenStackedAlertControllers
{
  ...
  if ([(NSMutableArray *)self->_hiddenAlertControllers count])
  {
    ...
    v29 = 0u;
    v30 = 0u;
    obj = v2->_hiddenAlertControllers;
    ...
    if (v3)
    {
      ...
      do
      {
        ...
        do
        {
          ...
          v9 = *(*(&v29 + 1) + 8 * v8);
          [(UIAlertControllerStackManager *)v2 _willShowAlertController:v9];
    ...
    [(NSMutableArray *)v2->_hiddenAlertControllers removeAllObjects];
  }

  else
  {
    v20 = [(UIAlertControllerStackManager *)v2 _topAlertControllerInStack];
    ...
    [(UIAlertControllerStackManager *)v2 _willShowAlertController:v20];
  }
}
...
- (BOOL)_alertControllerShouldBeTrackedInStack:(id)a3
{
  ...
  if ([v3 _resolvedStyle] == 1)
  {
    ...
    {
      v7 = [v3 _window];
      v6 = [v7 _isHostedInAnotherProcess] ^ 1;
    }
  }
