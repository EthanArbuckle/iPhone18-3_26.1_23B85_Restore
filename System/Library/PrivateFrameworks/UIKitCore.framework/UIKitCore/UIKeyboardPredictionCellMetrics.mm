...
+ (id)secureCandidateEstimatedMetricsDictionaryForWidth:(double)width;
@end
...
+ (id)secureCandidateEstimatedMetricsDictionary
{
  ...
  scene = [v3 scene];
  _interfaceOrientation = [scene _interfaceOrientation];

  v6 = v3;
  v7 = +[UIKeyboardImpl keyboardScreen];
  v8 = [UIKBScreenTraits traitsWithScreen:v7 orientation:_interfaceOrientation];
  ...
  if (_usesiPadStyle())
  {
    ...
    {
      v10 = dbl_18A679D70[(_interfaceOrientation - 3) < 2];
    }
    ...
    else
    {
      ...
      [systemInputAssistantViewController _buttonBarWidthForTraitCollection:traitCollection interfaceOrientation:_interfaceOrientation];
      v17 = v16;
  ...
  v18 = [self secureCandidateEstimatedMetricsDictionaryForWidth:v10];
...
+ (id)secureCandidateEstimatedMetricsDictionaryForWidth:(double)width
{
  ...
  if (_usesiPadStyle())
  {
    ...
    *&v11 = v5;
    ...
    v13 = [MEMORY[0x1E696AD98] numberWithDouble:floor(width)];
    v41[4] = v13;
