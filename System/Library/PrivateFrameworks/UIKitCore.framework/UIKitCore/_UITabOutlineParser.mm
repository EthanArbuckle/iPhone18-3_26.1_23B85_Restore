...
- (_UITabOutlineParser)initWithTabs:(id)a3 includeAllowsHidingItems:(BOOL)a4 transaction:(id)a5
{
  ...
  if (v10)
  {
    ...
    objc_storeWeak(&v11->_transaction, v9);
...
- (void)_parseTabs:(id)a3
{
  ...
  if (v5)
  {
    ...
    v7 = [v6 indexesOfObjectsPassingTest:&__block_literal_global_483];

    v8 = [(_UITabOutlineNode *)v12 children];
    v9 = [(NSArray *)v8 objectsAtIndexes:v7];
    ...
    do
    {
      ...
      do
      {
        ...
        if (v15)
        {
          ...
          v21 = [v16 identifier];
          [(NSMutableSet *)allGroupIdentifiers addObject:v21];
          ...
          if ([v16 isCollapsedByDefault])
          {
            ...
            v25 = [v16 identifier];
            [(NSMutableSet *)collapsedByDefaultGroupIdentifiers addObject:v25];
          }
        }
        ...
        v28 = [v16 identifier];
        [(NSMutableDictionary *)contentByIdentifier setObject:v26 forKeyedSubscript:v28];
        ...
        if (![v16 isHidden] || objc_msgSend(v16, "allowsHiding") && -[_UITabOutlineParser includeAllowsHidingItems](self, "includeAllowsHidingItems"))
        {
          if (v15)
          {
            ...
            v72 = 0u;
            v73 = 0u;
            v29 = [v16 sidebarActions];
            v30 = [v29 countByEnumeratingWithState:&v72 objects:v82 count:16];
            if (v30)
            {
              v31 = v30;
              v32 = *v73;
              do
              {
                for (i = 0; i != v31; ++i)
                {
                  ...
                  v38 = [v34 identifier];
                  [v19 addActionIdentifier:v38];
                }

                v31 = [v29 countByEnumeratingWithState:&v72 objects:v82 count:16];
              }

              while (v31);
            }

            v39 = [v16 sidebarAppearance];
            v7 = v57;
            v40 = v58;
            if (v39 == 2 || (v41 = [v16 sidebarAppearance], v40 = v57, !v41))
            {
              [v40 addChild:v19];
            }
            ...
            v43 = [v16 identifier];
            v44 = [WeakRetained currentDisplayOrderForGroupWithIdentifier:v43];

            v45 = [v16 _orderedChildrenForDisplayOrder:v44];
            [(_UITabOutlineParser *)self _parseNode:v19 tabs:v45 rootNode:v58];
            if ([v16 sidebarAppearance] == 1)
            {
              ...
              v69 = 0u;
              v46 = [v19 children];
              v47 = [v46 countByEnumeratingWithState:&v68 objects:v81 count:16];
              if (v47)
              {
                v48 = v47;
                v49 = *v69;
                do
                {
                  ...
                  v48 = [v46 countByEnumeratingWithState:&v68 objects:v81 count:16];
                }
              ...
              v65 = 0u;
              v51 = [v19 actions];
              v52 = [v51 countByEnumeratingWithState:&v64 objects:v80 count:16];
              if (v52)
              {
                v53 = v52;
                v54 = *v65;
                do
                {
                  ...
                  v53 = [v51 countByEnumeratingWithState:&v64 objects:v80 count:16];
                }
