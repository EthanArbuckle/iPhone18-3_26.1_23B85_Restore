...
- (BOOL)performFocusMovement:(id)a3
{
  ...
  if (os_signpost_id_make_with_pointer(*(CategoryCachedImpl + 8), v5) - 1 <= 0xFFFFFFFFFFFFFFFDLL && os_signpost_enabled(v7))
  {
  ...
  if (!v5)
  {
    ...
    [v26 handleFailureInMethod:a2 object:self file:@"_UIFocusMovementPerformer.m" lineNumber:36 description:{@"Invalid parameter not satisfying: %@", @"request"}];
  ...
  {
    v12 = [v11 focusSystem];
    if ([v8 overridesDeferredFocusUpdate] & 1) == 0 && (-[NSObject _performDeferredFocusUpdateIfAvailable](v12, "_performDeferredFocusUpdateIfAvailable"))
    {
      LOBYTE(self) = 1;
      goto LABEL_34;
    }
    ...
    if (v13)
    {
      ...
      {
        v15 = [v12 _updateFocusImmediatelyWithContext:v14];
        if (!v10)
        {
          goto LABEL_13;
        }
...
LABEL_13:
  ...
  if (v17)
  {
    v19 = [v17 _handleFailedFocusMovementRequest:v8 withPerformer:self];
...
LABEL_31:
  ...
  v12 = *(v24 + 8);
  if (os_signpost_id_make_with_pointer(*(v24 + 8), v5) - 1 <= 0xFFFFFFFFFFFFFFFDLL && os_signpost_enabled(v12))
  {
    _os_signpost_emit_unreliably_with_name_impl();
  }
  ...
  if (v8)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        v13 = *(*(&v35 + 1) + 8 * v12);
        v14 = [v13 owningEnvironment];
        v15 = [v13 itemContainer];
        if ([v13 isScrollableContainer] && (objc_msgSend(v4, "movementInfo"), v16 = objc_claimAutoreleasedReturnValue(), v17 = objc_msgSend(v16, "_shouldLoadScrollableContainer"), v16, v17))
        {
          v18 = [(_UIFocusMovementPerformer *)self _findFocusCandidateByExhaustivelySearchingEnvironment:v14 scrollableContainer:v15 forRequest:v4];
          ...
          if (v18)
          {
            ...
            v19 = [v18 _focusMapSearchInfo];
            v20 = [v19 didFindFocusBlockingBoundary];
        ...
        {
          [(_UIFocusMovementPerformer *)self _minimumSearchAreaForContainer:v15 inCoordinateSpace:v32];
          v18 = [(_UIFocusMovementPerformer *)self _findFocusCandidateWithoutLoadingScrollableContentInEnvironment:v14 container:v15 forRequest:v4 minimumSearchArea:?];
...
LABEL_21:
  ...
  v24 = [v10 _destinationItemInfo];
  v25 = _UIFocusEngineCommonEnvironmentScrollableContainerForItems(v6, v24);
  v26 = v25;
  if (v24 && !v25)
  {
    v26 = _UIFocusEngineFirstScrollableContainerTupleThatScrollsForItem(v24);
  }
...
- (id)_bestCandidateForLinearFocusMovement:(id)a3
{
  ...
  v5 = [v4 focusSystem];
  v6 = [v4 focusedItemInfo];
  v7 = [(_UIFocusMovementPerformer *)self _findFocusCandidateBySearchingLinearFocusMovementSequencesForRequest:v4];
  if (!v7)
  {
    v7 = [(_UIFocusMovementPerformer *)self _nextLinearCandidateLoadingScrollableContentForRequest:v4];
  }

  v8 = [v7 _destinationItemInfo];
  v9 = _UIFocusEngineCommonEnvironmentScrollableContainerForItems(v6, v8);
  v10 = v9;
  if (v8 && !v9)
  {
    v10 = _UIFocusEngineFirstScrollableContainerTupleThatScrollsForItem(v8);
  }
...
- (id)_dummyFocusItemForFocusMovement:(id)a3 searchArea:(CGRect)a4 parent:(id)a5
{
  ...
  {
    v26 = [MEMORY[0x1E696AAA8] currentHandler];
    [v26 handleFailureInMethod:a2 object:self file:@"_UIFocusMovementPerformer.m" lineNumber:443 description:{@"Invalid parameter not satisfying: %@", @"parent != nil"}];
  }
