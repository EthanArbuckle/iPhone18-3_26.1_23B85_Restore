...
- (_UIFocusSoundPool)initWithSoundFileURL:(id)l;
- (_UIFocusSoundPool)initWithSystemSoundID:(unsigned int)d;
...
- (_UIFocusSoundPool)initWithSystemSoundID:(unsigned int)d
{
  ...
  if (result)
  {
    result->_originalSystemSoundID = d;
...
- (_UIFocusSoundPool)initWithSoundFileURL:(id)l
{
  ...
  if (v6)
  {
    objc_storeStrong(&v6->_soundFileURL, l);
    v7->_queueIndex = 0;
  }
    ...
    if (soundFileURL)
    {
      ...
      do
      {
        ...
        if (!v9)
        {
          ...
          [currentHandler handleFailureInFunction:v22 file:@"_UIFocusSoundGenerator.m" lineNumber:30 description:{@"%s", dlerror()}];
          while (1)
          {
...
LABEL_17:
            ...
            [currentHandler handleFailureInFunction:v22 file:@"_UIFocusSoundGenerator.m" lineNumber:31 description:{@"%s", dlerror()}];
          }
        }
