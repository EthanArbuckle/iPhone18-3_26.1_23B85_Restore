...
- (_UIFocusMovementInfo)init
{
  ...
  if (result)
  {
    ...
    *&result->_looping = 16777472;
    v3 = *(MEMORY[0x1E695F050] + 16);
    result->_fallbackMovementOriginatingFrame.origin = *MEMORY[0x1E695F050];
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  *&v4[2].height = self->_inputType;
  BYTE2(v4->height) = self->_isVelocityBased;
  BYTE3(v4->height) = self->_isInitialMovement;
