...
- (void)layoutManagedSubviews
{
  ...
  if (self->_highlightedTextRange)
  {
    ...
    objc_storeStrong(&v2->_visuallyHighlightedTextRange, v2->_highlightedTextRange);
    WeakRetained = objc_loadWeakRetained(&v2->_textView);
    v4 = [WeakRetained _textLineRectsForRange:v2->_highlightedTextRange];
  ...
  if ([(NSMutableSet *)v2->_decoratedTextRanges count]&& ![(_UITextViewSearchableObject *)v2 _usesTransientHighlightBehavior])
  {
    [(_UITextViewSearchableObject *)v2 _setDimmingViewVisible:1];
    v36 = objc_loadWeakRetained(&v2->_textView);
    ...
    if (!v38)
    {
      v39 = objc_loadWeakRetained(&v2->_textView);
      [v39 visibleRect];
      v41 = v40;
      v43 = v42;
      v45 = v44;
      ...
      v52 = objc_loadWeakRetained(&v2->_textView);
      v53 = [v52 closestPositionToPoint:{MinX, MinY}];

      v54 = objc_loadWeakRetained(&v2->_textView);
      v55 = [v54 closestPositionToPoint:{MaxX, MaxY}];

      v56 = objc_loadWeakRetained(&v2->_textView);
      v57 = [v56 textRangeFromPosition:v53 toPosition:v55];

      v58 = [(_UITextViewSearchableObject *)v2 _rangeProvider];
      v59 = [v58 _nsrangeForTextRange:v57];
      v97 = v60;
      v98 = v59;
    }
    ...
    if (v62)
    {
      ...
      do
      {
        for (j = 0; j != v63; ++j)
        {
          ...
          v66 = *(*(&v110 + 1) + 8 * j);
          v67 = [(_UITextViewSearchableObject *)v2 _rangeProvider];
          v68 = [v67 _nsrangeForTextRange:v66];
          v70 = v69;
          ...
          {
            v71 = objc_loadWeakRetained(&v2->_textView);
    ...
    v80 = objc_loadWeakRetained(&v2->_textView);
    [v80 contentSize];
    v82 = v81;

    v83 = objc_loadWeakRetained(&v2->_textView);
    [v83 bounds];
    v85 = v84;
    ...
    v87 = objc_loadWeakRetained(&v2->_textView);
    [v87 contentSize];
    v89 = v88;

    v90 = objc_loadWeakRetained(&v2->_textView);
    [v90 bounds];
    v92 = v91;
...
- (int64_t)compareFoundRange:(id)a3 toRange:(id)a4 inDocument:(id)a5
{
  ...
  WeakRetained = objc_loadWeakRetained(&self->_textView);
  v11 = [WeakRetained comparePosition:v8 toPosition:v9];
...
- ($96EE1C12479E9B303E9C2794B92A11A2)_wordTerminationCharacteristicsForRange:(_NSRange)a3
{
  ...
  if (location && (WeakRetained = objc_loadWeakRetained(&self->_textView), [WeakRetained textStorage], v9 = objc_claimAutoreleasedReturnValue(), objc_msgSend(v9, "string"), v10 = objc_claimAutoreleasedReturnValue(), v11 = objc_msgSend(v10, "characterAtIndex:", location - 1), v10, v9, WeakRetained, (objc_msgSend(v6, "characterIsMember:", v11) & 1) == 0))
  {
...
LABEL_11:
  ...
  v20 = [v18 string];
  v21 = [v20 characterAtIndex:v13];

  if (![v6 characterIsMember:v21])
  {
...
- (void)_performTextSearchWithQueryString:(id)a3 usingOptions:(id)a4 resultHandler:(id)a5
{
  ...
  v9 = a5;
  WeakRetained = objc_loadWeakRetained(&self->_textView);
  v11 = [WeakRetained textStorage];
  v12 = [v11 string];

  v13 = [v12 length];
  for (i = 0; i != 0x7FFFFFFFFFFFFFFFLL; v13 = [v12 length] - i)
  {
    v15 = [v12 rangeOfString:v22 options:objc_msgSend(v8 range:{"stringCompareOptions"), i, v13}];
    ...
    {
LABEL_10:
      v20 = [(_UITextViewSearchableObject *)self _rangeProvider];
      v21 = [v20 _textRangeFromNSRange:{v17, v18}];
...
- (void)replaceAllOccurrencesOfQueryString:(id)a3 usingOptions:(id)a4 withText:(id)a5
{
  ...
  v30 = v12;
  v24 = v8;
  [(_UITextViewSearchableObject *)self _performTextSearchWithQueryString:v8 usingOptions:v9 resultHandler:v29];
  WeakRetained = objc_loadWeakRetained(&self->_textView);
  v14 = [WeakRetained undoManager];
  [v14 beginUndoGrouping];

  v27 = 0u;
  v28 = 0u;
  v25 = 0u;
  v26 = 0u;
  v15 = [v12 reverseObjectEnumerator];
  ...
  if (v16)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        [v21 replaceRange:v20 withText:v10];
...
- (void)clearAllDecoratedFoundText
{
  ...
  v4 = [(_UITextViewSearchableObject *)self _activeFindSession];
  v5 = [v4 isSearching];
...
{
  v5 = a3;
  v6 = [(_UITextViewSearchableObject *)self _rangeProvider];
  v7 = [v6 _nsrangeForTextRange:v5];
  v9 = v8;
...
- (void)_updateHighlightLabelForMatchedRange:(id)a3
{
  ...
  {
    WeakRetained = objc_loadWeakRetained(&self->_textView);
    v6 = [WeakRetained _range:v5 isEqualToRange:self->_visuallyHighlightedTextRange] ^ 1;
  }
  ...
  v11 = [v10 assistantDelegate];

  if ([(_UITextViewSearchableObject *)self _usesTransientHighlightBehavior])
  {
    v12 = [v11 grabberSuppressionAssertion];

    if (!v12)
    {
      v13 = [v11 obtainSelectionGrabberSuppressionAssertion];
...
- (id)targetedPreviewForHighlightRange:(id)a3
{
  ...
  WeakRetained = objc_loadWeakRetained(&self->_textView);
  v9 = [WeakRetained _targetedPreviewForRange:v4 withRenderingAttributes:v7];
