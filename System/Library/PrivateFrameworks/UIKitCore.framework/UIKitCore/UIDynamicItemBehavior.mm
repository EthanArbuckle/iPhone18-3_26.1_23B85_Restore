...
- (CGPoint)_positionForItem:(id)item;
...
LABEL_18:
  [bodyCopy setAllowsRotation:{-[UIDynamicItemBehavior allowsRotation](self, "allowsRotation")}];
  stateFlags = self->_stateFlags;
  if ((stateFlags & 0x100) == 0)
  {
LABEL_8:
...
LABEL_19:
  [bodyCopy setDynamic:{-[UIDynamicItemBehavior isAnchored](self, "isAnchored") ^ 1}];
...
- (void)removeItem:(id)item
{
  ...
  if (v5)
  {
    ...
    {
      _context2 = [(UIDynamicBehavior *)self _context];
      [_context2 _unregisterBodyForItem:v9 action:0];
...
- (void)setElasticity:(CGFloat)elasticity
{
  if (self->_elasticity != elasticity)
  {
    ...
    *&self->_stateFlags |= 1u;
    _context = [(UIDynamicBehavior *)self _context];
    [_context _shouldReevaluateLocalBehaviors];
  }
}
...
- (void)addLinearVelocity:(CGPoint)velocity forItem:(id)item
{
  ...
  if (x != *MEMORY[0x1E695EFF8] || y != *(MEMORY[0x1E695EFF8] + 8))
  {
    ...
    if (v10)
    {
      ...
      {
        _context2 = [(UIDynamicBehavior *)self _context];
        v13 = [_context2 _bodyForItem:v28];
...
- (void)_setPosition:(CGPoint)position forItem:(id)item
{
  ...
  itemCopy = item;
  _context = [(UIDynamicBehavior *)self _context];
  v9 = [_context _bodyForItem:itemCopy];
...
- (CGPoint)_positionForItem:(id)item
{
  itemCopy = item;
  _context = [(UIDynamicBehavior *)self _context];
  v6 = [_context _bodyForItem:itemCopy];
...
- (void)_setAngle:(double)angle forItem:(id)item
{
  itemCopy = item;
  _context = [(UIDynamicBehavior *)self _context];
  v8 = [_context _bodyForItem:itemCopy];

  [v8 setRotation:angle];
...
- (void)addAngularVelocity:(CGFloat)velocity forItem:(id)item
{
  ...
  if (velocity != 0.0)
  {
    ...
    if (v8)
    {
      ...
      {
        _context2 = [(UIDynamicBehavior *)self _context];
        v11 = [_context2 _bodyForItem:v21];
...
- (BOOL)_rotationEnabledForItem:(id)item
{
  ...
  LOBYTE(_context) = [v6 allowsRotation];
  return _context;
}
...
- (void)_reevaluate:(unint64_t)_reevaluate
{
  ...
  if ((_reevaluate & 0xFFFFFFFFFFFFFFFDLL) == 0)
  {
    v16 = 0u;
    v17 = 0u;
    v14 = 0u;
    ...
    if (v6)
    {
      ...
      do
      {
        for (i = 0; i != v7; ++i)
        {
          ...
          if (_reevaluate == 2)
          {
            [_context _registerBodyForItem:v10];
          }

          else
          {
            [_context _bodyForItem:v10];
          }
          v13 = ;
        ...
        v7 = [_items countByEnumeratingWithState:&v14 objects:v18 count:16];
      }
  ...
  if (v21)
  {
    ...
    do
    {
      for (j = 0; j != v22; ++j)
      {
        ...
        v28 = v27;
        _context2 = [(UIDynamicBehavior *)self _context];
        v30 = [_context2 _bodyForItem:v25];
  ...
  if (v4)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        v8 = *(*(&v10 + 1) + 8 * v7);
        _context = [(UIDynamicBehavior *)self _context];
        [_context _unregisterBodyForItem:v8 action:&__block_literal_global_196];
...
- (void)setUseDefaultViewPropertiesApplier:(BOOL)applier
{
  if (self->_useDefaultViewPropertiesApplier != applier)
  {
    self->_useDefaultViewPropertiesApplier = applier;
