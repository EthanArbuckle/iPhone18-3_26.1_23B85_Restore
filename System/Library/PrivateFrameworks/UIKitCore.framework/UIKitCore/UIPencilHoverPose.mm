...
- (UIPencilHoverPose)init
{
  ...
  [v4 handleFailureInMethod:a2 object:self file:@"UIPencilInteraction.m" lineNumber:237 description:{@"%s: init is not allowed on %@", "-[UIPencilHoverPose init]", objc_opt_class()}];
