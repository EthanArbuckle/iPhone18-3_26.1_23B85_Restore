...
- (_UIMainMenuDeferredElementRequestAction)initWithDeferredElementRequest:(id)a3 handler:(id)a4;
...
- (id)deferredElementRequest
{
  v2 = [(_UIMainMenuDeferredElementRequestAction *)self info];
...
- (void)handleMainMenuAction
{
  ...
  v5 = [(_UIMainMenuDeferredElementRequestAction *)self deferredElementRequest];
  [v4 performDeferredElementRequest:v5 responseHandler:v3];
}
