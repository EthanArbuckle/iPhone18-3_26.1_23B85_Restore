...
- (void)addRectPath:(CGPath *)a3 toView:(id)a4 layer:(id)a5 rectangle:(id *)a6 upright:(BOOL)a7
{
  ...
  v15 = a6->var3.x;
  v16 = a6->var3.y;
  [a4 convertPointFromPDFPageSpace:{a6->var0.x, a6->var0.y}];
  v18 = v17;
  v20 = v19;
  [a4 convertPointFromPDFPageSpace:{v11, v12}];
  v22 = v21;
  v24 = v23;
  [a4 convertPointFromPDFPageSpace:{v13, v14}];
  v26 = v25;
  v28 = v27;
  [a4 convertPointFromPDFPageSpace:{v15, v16}];
  v30 = v29;
  ya = v31;
  [a5 convertPoint:objc_msgSend(a4 fromLayer:{"layer"), v18, v20}];
  v33 = v32;
  v35 = v34;
  [a5 convertPoint:objc_msgSend(a4 fromLayer:{"layer"), v22, v24}];
  v37 = v36;
  v39 = v38;
  [a5 convertPoint:objc_msgSend(a4 fromLayer:{"layer"), v26, v28}];
  x = v40;
  v42 = v41;
  [a5 convertPoint:objc_msgSend(a4 fromLayer:{"layer"), v30, ya}];
  v44 = v43;
  v52 = v45;
  y = v35;
  if (v7)
  ...
  v48 = v33;
  v49 = v47;
  CGPathMoveToPoint(a3, 0, v48, v47);
  v50 = v39 - v46;
  CGPathAddLineToPoint(a3, 0, v37, v50);
  if (v7)
  {
    CGPathAddArc(a3, 0, v37 + 2.0, v50, 2.0, -3.14159265, 1.57079633, 1);
    CGPathAddLineToPoint(a3, 0, x + -2.0, v42);
    CGPathAddArc(a3, 0, x + -2.0, v42 + -2.0, 2.0, 1.57079633, 0.0, 1);
    CGPathAddLineToPoint(a3, 0, v44, v52 + 2.0);
    CGPathAddArc(a3, 0, v44 + -2.0, v52 + 2.0, 2.0, 0.0, -1.14159265, 1);
    CGPathAddLineToPoint(a3, 0, v48 + 2.0, y);

    CGPathAddArc(a3, 0, v48 + 2.0, v49, 2.0, -1.57079633, -3.14159265, 1);
  }

  else
  {
    CGPathAddLineToPoint(a3, 0, x, v42);
    CGPathAddLineToPoint(a3, 0, v44, v52 + 0.0);

    CGPathAddLineToPoint(a3, 0, v48 + 0.0, y);
  }
}
...
- (void)addHighlightLayerFor:(id)a3 atIndex:(unint64_t)a4 to:(id)a5 animated:(BOOL)a6
{
  ...
  *&v34.tx = *&v40.m21;
  ...
  [a3 getBounds:&v33 transform:&v32 index:a4];
  v34 = v32;
  ...
  [a5 convertRectFromPDFPageSpace:?];
  v17 = v46.origin.x;
  v18 = v46.origin.y;
  v19 = v46.size.width;
  v20 = v46.size.height;
  ...
  [a5 convertRectFromPDFPageSpace:{v49.origin.x, v49.origin.y, v49.size.width, v49.size.height}];
  ...
  [objc_msgSend(a5 "layer")];
  [(UIPDFHighlightLayer *)v13 setNeedsDisplay];
  v34 = v32;
  IsIdentity = CGAffineTransformIsIdentity(&v34);
  v34 = v43;
  v35 = v44;
  [(UIPDFHighlighter *)self makeTheClipPath:a5 layer:v13 rectangle:&v34 upright:IsIdentity];
  v34 = v32;
  v28 = CGAffineTransformIsIdentity(&v34);
  v34 = v41;
  v35 = v42;
  [(UIPDFHighlighter *)self makeTheBorderPath:a5 layer:v13 rectangle:&v34 upright:v28];
...
{
  v5 = a5;
  v9 = [a3 numberOfRectangles];
  if (v9)
  {
    v10 = v9;
    v11 = [objc_msgSend(a4 "page")];
    self->_page = v11;
    CGPDFPageRetain(v11);
    [a4 convertRectFromPDFPageSpace:{0.0, 0.0, 1.0, 1.0}];
    v12 = 0;
...
- (void)drawLayer:(id)a3 inContext:(CGContext *)a4
{
  ...
  CGContextAddPath(a4, [a3 clipPath]);
  CGContextClip(a4);
  ...
  CGContextAddPath(a4, [a3 borderPath]);
