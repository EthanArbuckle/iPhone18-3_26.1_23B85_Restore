...
void ___UIViewLocalizeOverrideLayoutEngine_block_invoke()
{
  if (dyld_program_sdk_at_least())
  {
    ...
    if (v1 || (_UIKitPreferencesOnce(), v2 = objc_claimAutoreleasedReturnValue(), [v2 objectForKey:@"UIViewLocalizeOverrideLayoutEngine"], v1 = objc_claimAutoreleasedReturnValue(), v2, v1))
    {
      v3 = [v1 BOOLValue];
    }
