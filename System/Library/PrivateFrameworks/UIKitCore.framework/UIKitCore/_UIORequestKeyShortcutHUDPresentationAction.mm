...
- (_UIORequestKeyShortcutHUDPresentationAction)initWithConfiguration:(id)configuration responseHandler:(id)handler;
...
- (_UIKeyShortcutHUDConfiguration)configuration
{
  ...
  v4 = objc_opt_self();
  info = [(_UIORequestKeyShortcutHUDPresentationAction *)self info];
