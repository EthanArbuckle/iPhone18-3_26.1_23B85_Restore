...
+ (id)colorEffectLightMatrix:(id *)a3 darkMatrix:(id *)a4;
...
- (UIColorEffect)initWithCoder:(id)a3
{
  ...
  v5 = [(UIVisualEffect *)&v18 initWithCoder:v4];
  if (v5)
  {
    if ([v4 containsValueForKey:@"UIColorEffectBackgroundColor"])
    {
      v6 = objc_opt_self();
      v7 = [v4 decodeObjectOfClass:v6 forKey:@"UIColorEffectBackgroundColor"];
      backgroundColor = v5->_backgroundColor;
      v5->_backgroundColor = v7;
    }

    v9 = [v4 decodeObjectForKey:@"UIColorEffectType"];
    filterType = v5->_filterType;
    v5->_filterType = v9;

    v11 = _UIColorEffectDecodeDictionary(v4, @"UIColorEffectConfigurationValues");
    configurationValues = v5->_configurationValues;
    v5->_configurationValues = v11;

    v13 = _UIColorEffectDecodeDictionary(v4, @"UIColorEffectIdentityValues");
    identityValues = v5->_identityValues;
    v5->_identityValues = v13;

    v15 = _UIColorEffectDecodeDictionary(v4, @"UIColorEffectRequestedValues");
...
- (void)encodeWithCoder:(id)a3
{
  ...
  [(UIVisualEffect *)&v6 encodeWithCoder:v4];
  backgroundColor = self->_backgroundColor;
  if (backgroundColor)
  {
    [v4 encodeObject:backgroundColor forKey:@"UIColorEffectBackgroundColor"];
  }

  [v4 encodeObject:self->_filterType forKey:@"UIColorEffectType"];
...
+ (id)colorEffectMatrix:(id *)a3
{
  ...
  v18 = vcvt_hight_f32_f64(vcvt_f32_f64(v16), *&a3->var1.var1);
  v23 = vcvt_hight_f32_f64(vcvt_f32_f64(*&a3->var0.var0), *&a3->var0.var2);
  v24 = v18;
...
+ (id)colorEffectColor:(id)a3
{
  ...
  else
  {
    ...
    v25 = 0u;
    v26 = 0u;
    [v4 getRed:&v31 green:&v31 + 8 blue:&v32 alpha:&v32 + 8];
    v35 = v6;
    v16.f64[0] = *(&v27[1] + 1);
...
+ (id)colorEffectBlendColor:(id)a3
{
  ...
  if ((v5 & 1) != 0 || ([v4 alphaComponent], v7 != 0.0))
  {
    ...
    else
    {
      ...
      v24 = 0u;
      v25 = 0u;
      [v4 getRed:&v32 green:&v32 + 8 blue:&v33 alpha:&v33 + 8];
      v36 = v8;
      v18 = MEMORY[0x1E696B098];
      _UIColorEffectSourceOverCAMatrix(v23, v4);
...
+ (id)colorEffectMonochromeTint:(id)a3 blendingAmount:(double)a4 brightnessAdjustment:(double)a5
{
  ...
  else
  {
    ...
    v30[1] = v14;
    v29[2] = v18;
    v21 = [MEMORY[0x1E696AD98] numberWithDouble:a4];
    v30[2] = v21;
...
+ (id)colorEffectLuminanceMap:(id)a3 blendingAmount:(double)a4
{
  ...
  if (![v7 CGImage])
  {
    ...
    [v35 handleFailureInMethod:a2 object:a1 file:@"UIColorEffect.m" lineNumber:473 description:@"Luminance Map Image must be a CGImage based image"];
  }
  ...
  if (v9 <= 0.0 || v8 <= 0.0)
  {
    ...
    [v36 handleFailureInMethod:a2 object:a1 file:@"UIColorEffect.m" lineNumber:475 description:@"Luminance Map Image must be non-zero size"];
  }

  v10 = objc_alloc_init(a1);
  objc_storeStrong(v10 + 1, *MEMORY[0x1E6979C70]);
  v11 = v7;
  v12 = [v11 imageOrientation];
  v13 = [v11 CGImage];
  if (v12)
  {
    [v11 size];
    ...
    v19 = [v11 imageRendererFormat];
    v20 = [(UIGraphicsImageRenderer *)v18 initWithSize:v19 format:v15, v17];
  ...
  v39 = v28;
  v31 = [MEMORY[0x1E696AD98] numberWithDouble:a4];
  v40 = v31;
...
{
  v24[1] = *MEMORY[0x1E69E9840];
  v7 = _UIColorEffectUpgradeCurve(a3);
...
+ (id)colorEffectCurvesRed:(id)a3 green:(id)a4 blue:(id)a5 alpha:(id)a6
{
  ...
  v11 = a5;
  v12 = a4;
  v26 = _UIColorEffectUpgradeCurve(a3);
  v13 = _UIColorEffectUpgradeCurve(v12);

  v14 = _UIColorEffectUpgradeCurve(v11);

  v15 = _UIColorEffectUpgradeCurve(v10);
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    if (v4 && [(UIColorEffect *)v4 isMemberOfClass:objc_opt_class()])
    {
      v6 = v5;
...
- (id)_filterEntryForTraitCollection:(id)a3
{
  ...
  if (a3)
  {
    ...
    if (sourceColorUpdater)
    {
      ...
      v9 = a3;
      v10 = v8(sourceColorUpdater, v5, v9, 1);
...
- (BOOL)_needsUpdateForTransitionFromEnvironment:(id)a3 toEnvironment:(id)a4 changedTraits:(id)a5 usage:(int64_t)a6
{
  ...
  if (self->_sourceColorUpdater)
  {
    ...
    if ([v8 count])
    {
      ...
      do
      {
        v10 = [v7 containsObject:{objc_msgSend(v8, "objectAtIndexedSubscript:", v9)}];
        if (v10)
        {
          break;
        }
...
- (void)_updateEffectDescriptor:(id)a3 forEnvironment:(id)a4 usage:(int64_t)a5
{
  ...
  if (self->_backgroundColor)
  {
    ...
    [v11 addViewEffect:v8];
  }

  if (self->_filterType)
  {
    v9 = [v7 traitCollection];
    v10 = [(UIColorEffect *)self _filterEntryForTraitCollection:v9];
