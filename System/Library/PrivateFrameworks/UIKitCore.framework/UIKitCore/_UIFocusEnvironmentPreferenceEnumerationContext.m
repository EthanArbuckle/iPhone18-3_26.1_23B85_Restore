...
- (_UIFocusEnvironmentPreferenceEnumerationContext)initWithFocusEnvironment:(id)a3 enumerationMode:(int64_t)a4
{
  ...
  if (v8)
  {
    ...
    v18 = [MEMORY[0x1E696AC70] hashTableWithOptions:517];
  ...
  else if ([(NSMutableArray *)self->_visitedEnvironmentStack containsObject:v4])
  {
    ...
    if (os_log_type_enabled(v5, OS_LOG_TYPE_ERROR))
    {
      ...
      *buf = 138412802;
      ...
      _os_log_impl(&dword_188A29000, v5, OS_LOG_TYPE_ERROR, "Loop in preferred focus environment chain. %@ prefers %@, which is already on the stack: %@", buf, 0x20u);
    }
    ...
    do
    {
      for (i = 0; i != v7; ++i)
      {
        ...
        if (v10)
        {
          ...
          v13 = objc_opt_class();
          v14 = NSStringFromClass(v13);
          v15 = [v11 stringWithFormat:@"<%@: %p>", v14, v12, v21];
        }
...
- (void)_reportInferredPreferredFocusEnvironment:(id)a3
{
  ...
  if (debugStack)
  {
    ...
    if (v14)
    {
      ...
      v13 = [off_1E70ECC50 messageWithFormat:@"Found environment: %@", v12];
      [(_UIDebugLogStack *)v7 addMessage:v13];
    }

    else
    {
      v12 = [off_1E70ECC50 messageWithStyle:3 string:@"No focusable items found."];
