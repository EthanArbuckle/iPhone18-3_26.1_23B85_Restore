...
- (_UIMainMenuCommandInvocationRequestAction)initWithInvocationRequest:(id)request responseHandler:(id)handler;
...
- (id)invocationRequest
{
  info = [(_UIMainMenuCommandInvocationRequestAction *)self info];
  v3 = [info objectForSetting:11];
  v4 = objc_opt_self();
...
- (void)handleMainMenuAction
{
  ...
  invocationRequest = [(_UIMainMenuCommandInvocationRequestAction *)self invocationRequest];
  [v4 performMainMenuCommandInvocationRequest:invocationRequest responseHandler:v3];
}
