...
- (void)sl_mapAsynchronouslyOnQueue:()TransformUtilities transform:completionHandler:
{
  ...
  v12 = [v10 arrayWithObject:null repeated:v9];
  ...
  if (v9)
  {
    for (i = 0; i != v9; ++i)
    {
      ...
      v15 = [self objectAtIndexedSubscript:i];
...
- (void)sl_mapAsynchronously:()TransformUtilities completionHandler:
{
  ...
  [self sl_mapAsynchronouslyOnQueue:v7 transform:a3 completionHandler:a4];
}
