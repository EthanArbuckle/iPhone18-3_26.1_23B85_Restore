...
uint64_t std::vector<std::sub_match<std::__wrap_iter<char const*>>>::__init_with_size[abi:ne200100]<std::sub_match<std::__wrap_iter<char const*>>*,std::sub_match<std::__wrap_iter<char const*>>*>(uint64_t result, uint64_t a2, uint64_t a3, unint64_t a4)
{
  if (a4)
  {
    std::vector<std::sub_match<std::__wrap_iter<char const*>>>::__vallocate[abi:ne200100](result, a4);
  }

  return result;
}

void sub_22CD76630(_Unwind_Exception *exception_object)
{
  v3 = *v1;
  if (*v1)
  {
...
void std::vector<std::sub_match<std::__wrap_iter<char const*>>>::__vallocate[abi:ne200100](uint64_t a1, unint64_t a2)
{
  if (a2 < 0xAAAAAAAAAAAAAABLL)
  {
    std::__allocate_at_least[abi:ne200100]<std::allocator<std::sub_match<std::__wrap_iter<char const*>>>>(a1, a2);
  }

  std::vector<NLExtendedString>::__throw_length_error[abi:ne200100]();
}

void std::__allocate_at_least[abi:ne200100]<std::allocator<std::sub_match<std::__wrap_iter<char const*>>>>(uint64_t a1, unint64_t a2)
{
  if (a2 < 0xAAAAAAAAAAAAAABLL)
  {
    operator new();
...
const void **std::__hash_table<std::__hash_value_type<std::string,std::unordered_map<std::string,std::vector<std::string>>>,std::__unordered_map_hasher<std::string,std::__hash_value_type<std::string,std::unordered_map<std::string,std::vector<std::string>>>,std::hash<std::string>,std::equal_to<std::string>,true>,std::__unordered_map_equal<std::string,std::__hash_value_type<std::string,std::unordered_map<std::string,std::vector<std::string>>>,std::equal_to<std::string>,std::hash<std::string>,true>,std::allocator<std::__hash_value_type<std::string,std::unordered_map<std::string,std::vector<std::string>>>>>::__emplace_unique_key_args<std::string,std::piecewise_construct_t const&,std::tuple<std::string const&>,std::tuple<>>(void *a1, const void **a2)
{
  ...
  {
LABEL_18:
    std::__hash_table<std::__hash_value_type<std::string,std::unordered_map<std::string,std::vector<std::string>>>,std::__unordered_map_hasher<std::string,std::__hash_value_type<std::string,std::unordered_map<std::string,std::vector<std::string>>>,std::hash<std::string>,std::equal_to<std::string>,true>,std::__unordered_map_equal<std::string,std::__hash_value_type<std::string,std::unordered_map<std::string,std::vector<std::string>>>,std::equal_to<std::string>,std::hash<std::string>,true>,std::allocator<std::__hash_value_type<std::string,std::unordered_map<std::string,std::vector<std::string>>>>>::__construct_node_hash<std::piecewise_construct_t const&,std::tuple<std::string const&>,std::tuple<>>();
  }
...
void sub_22CD76950(_Unwind_Exception *a1, uint64_t a2, ...)
{
  va_start(va, a2);
  std::unique_ptr<std::__hash_node<std::__hash_value_type<std::string,std::unordered_map<std::string,std::vector<std::string>>>,void *>,std::__hash_node_destructor<std::allocator<std::__hash_node<std::__hash_value_type<std::string,std::unordered_map<std::string,std::vector<std::string>>>,void *>>>>::~unique_ptr[abi:ne200100](va);
  _Unwind_Resume(a1);
}

uint64_t std::unique_ptr<std::__hash_node<std::__hash_value_type<std::string,std::unordered_map<std::string,std::vector<std::string>>>,void *>,std::__hash_node_destructor<std::allocator<std::__hash_node<std::__hash_value_type<std::string,std::unordered_map<std::string,std::vector<std::string>>>,void *>>>>::~unique_ptr[abi:ne200100](uint64_t a1)
{
  v2 = *a1;
  *a1 = 0;
  if (v2)
  {
    if (*(a1 + 16) == 1)
    {
      std::__destroy_at[abi:ne200100]<std::pair<std::string const,std::unordered_map<std::string,std::vector<std::string>>>,0>(v2 + 16);
    }
...
void sub_22CD76CD0(_Unwind_Exception *a1, uint64_t a2, ...)
{
  va_start(va, a2);
...
{
  v2 = MEMORY[0x2318C0500]();
  this->__ct_ = std::locale::use_facet(v2, MEMORY[0x277D82680]);
  this->__col_ = std::locale::use_facet(&this->__loc_, MEMORY[0x277D826A0]);
  return this;
}

const void **std::__hash_table<std::__hash_value_type<std::string,std::vector<std::string>>,std::__unordered_map_hasher<std::string,std::__hash_value_type<std::string,std::vector<std::string>>,std::hash<std::string>,std::equal_to<std::string>,true>,std::__unordered_map_equal<std::string,std::__hash_value_type<std::string,std::vector<std::string>>,std::equal_to<std::string>,std::hash<std::string>,true>,std::allocator<std::__hash_value_type<std::string,std::vector<std::string>>>>::__emplace_unique_key_args<std::string,std::piecewise_construct_t const&,std::tuple<std::string&&>,std::tuple<>>(void *a1, const void **a2)
{
  v4 = std::__string_hash<char>::operator()[abi:ne200100](a1, a2);
  v5 = v4;
  v6 = a1[1];
...
void sub_22CD773A4(_Unwind_Exception *a1, uint64_t a2, ...)
{
  va_start(va, a2);
  std::unique_ptr<std::__hash_node<std::__hash_value_type<std::string,std::vector<std::string>>,void *>,std::__hash_node_destructor<std::allocator<std::__hash_node<std::__hash_value_type<std::string,std::vector<std::string>>,void *>>>>::~unique_ptr[abi:ne200100](va);
  _Unwind_Resume(a1);
...
void sub_22CD7744C(_Unwind_Exception *a1)
{
  if (*(v1 + 87) < 0)
  {
    operator delete(*v3);
...
void *std::__put_character_sequence[abi:ne200100]<char,std::char_traits<char>>(void *a1, uint64_t a2, uint64_t a3)
{
  ...
  MEMORY[0x2318C0440](v13);
  return a1;
}

void sub_22CD7772C(void *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, char a10, uint64_t a11, std::locale a12)
{
  MEMORY[0x2318C0440](&a10);
  __cxa_begin_catch(a1);
  std::ios_base::__set_badbit_and_consider_rethrow((v12 + *(*v12 - 24)));
  __cxa_end_catch();
  JUMPOUT(0x22CD7770CLL);
}
...
void sub_22CD77900(_Unwind_Exception *exception_object, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, void *__p, uint64_t a11, int a12, __int16 a13, char a14, char a15)
{
  if (a15 < 0)
  {
    operator delete(__p);
...
void std::basic_regex<char,std::regex_traits<char>>::basic_regex[abi:ne200100]<std::__wrap_iter<char const*>>(std::regex_traits<char> *a1, uint64_t a2, uint64_t a3, int a4)
{
...
void sub_22CD77AC4(_Unwind_Exception *a1)
{
...
void std::__throw_regex_error[abi:ne200100]<(std::regex_constants::error_type)17>()
{
  ...
  MEMORY[0x2318C02A0](exception, 17);
...
{
  exception = __cxa_allocate_exception(0x18uLL);
  MEMORY[0x2318C02A0](exception, 14);
  __cxa_throw(exception, MEMORY[0x277D82700], MEMORY[0x277D82628]);
}

void sub_22CD783C4(_Unwind_Exception *exception_object)
{
  if (v1)
  {
...
{
  exception = __cxa_allocate_exception(0x18uLL);
  MEMORY[0x2318C02A0](exception, 6);
  __cxa_throw(exception, MEMORY[0x277D82700], MEMORY[0x277D82628]);
}
...
void sub_22CD79A70(_Unwind_Exception *exception_object, int a2, int a3, int a4, int a5, int a6, int a7, int a8, void *__p, uint64_t a10)
{
  if (__p)
  {
    operator delete(__p);
...
void sub_22CD79E5C(_Unwind_Exception *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, void *__p, uint64_t a16)
{
...
void std::vector<std::sub_match<char const*>>::assign(std::vector<std::csub_match> *this, std::vector<std::csub_match>::size_type __n, std::vector<std::csub_match>::const_reference __u)
{
  ...
  if (0xAAAAAAAAAAAAAAABLL * ((value - begin) >> 3) < __n)
  {
    ...
    if (__n <= 0xAAAAAAAAAAAAAAALL)
    {
      ...
      std::vector<std::sub_match<std::__wrap_iter<char const*>>>::__vallocate[abi:ne200100](this, v9);
    }
...
{
  exception = __cxa_allocate_exception(0x18uLL);
  MEMORY[0x2318C02A0](exception, 12);
  __cxa_throw(exception, MEMORY[0x277D82700], MEMORY[0x277D82628]);
}
...
{
  exception = __cxa_allocate_exception(0x18uLL);
  MEMORY[0x2318C02A0](exception, 16);
  __cxa_throw(exception, MEMORY[0x277D82700], MEMORY[0x277D82628]);
}
...
void sub_22CD7A374(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, ...)
{
  va_start(va, a4);
...
void std::vector<std::sub_match<char const*>>::__append(std::vector<std::csub_match> *this, std::vector<std::csub_match>::size_type __n, std::vector<std::csub_match>::const_reference __x)
{
  ...
  else
  {
    ...
    if (v10)
    {
      std::__allocate_at_least[abi:ne200100]<std::allocator<std::sub_match<std::__wrap_iter<char const*>>>>(this, v10);
    }
...
void sub_22CD7A980(_Unwind_Exception *exception_object)
{
  v3 = *v1;
  if (*v1)
  {
...
void sub_22CD7A9F4(_Unwind_Exception *exception_object)
{
  v3 = *v1;
  if (*v1)
  {
...
{
  exception = __cxa_allocate_exception(0x18uLL);
  MEMORY[0x2318C02A0](exception, 11);
  __cxa_throw(exception, MEMORY[0x277D82700], MEMORY[0x277D82628]);
}
...
{
  exception = __cxa_allocate_exception(0x18uLL);
  MEMORY[0x2318C02A0](exception, 3);
  __cxa_throw(exception, MEMORY[0x277D82700], MEMORY[0x277D82628]);
}
...
{
  exception = __cxa_allocate_exception(0x18uLL);
  MEMORY[0x2318C02A0](exception, 4);
  __cxa_throw(exception, MEMORY[0x277D82700], MEMORY[0x277D82628]);
}
...
void sub_22CD7B780(_Unwind_Exception *a1)
{
...
void sub_22CD7C488(_Unwind_Exception *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, std::locale *a10)
{
...
void sub_22CD7CF10(_Unwind_Exception *exception_object, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, void *__p, uint64_t a11, int a12, __int16 a13, char a14, char a15)
{
  if (a15 < 0)
  {
    operator delete(__p);
...
void sub_22CD7D0A4(_Unwind_Exception *exception_object, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, uint64_t a10, uint64_t a11, void *__p, uint64_t a13, int a14, __int16 a15, char a16, char a17)
{
  if (*(v17 + 23) < 0)
  {
    operator delete(*v17);
...
void sub_22CD7D1CC(_Unwind_Exception *exception_object, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, void *__p, uint64_t a11, int a12, __int16 a13, char a14, char a15)
{
  if (a15 < 0)
  {
    operator delete(__p);
...
{
  exception = __cxa_allocate_exception(0x18uLL);
  MEMORY[0x2318C02A0](exception, 5);
  __cxa_throw(exception, MEMORY[0x277D82700], MEMORY[0x277D82628]);
}
...
void sub_22CD7D880(_Unwind_Exception *exception_object, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, void *a10, uint64_t a11, int a12, __int16 a13, char a14, char a15, void *__p, uint64_t a17, int a18, __int16 a19, char a20, char a21)
{
  if (a21 < 0)
  {
    operator delete(__p);
...
{
  exception = __cxa_allocate_exception(0x18uLL);
  MEMORY[0x2318C02A0](exception, 1);
  __cxa_throw(exception, MEMORY[0x277D82700], MEMORY[0x277D82628]);
}
...
{
  exception = __cxa_allocate_exception(0x18uLL);
  MEMORY[0x2318C02A0](exception, 2);
  __cxa_throw(exception, MEMORY[0x277D82700], MEMORY[0x277D82628]);
}
...
void sub_22CD7E418(_Unwind_Exception *exception_object, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, void *__p, uint64_t a11, int a12, __int16 a13, char a14, char a15)
{
  if (a15 < 0)
  {
    operator delete(__p);
...
{
  exception = __cxa_allocate_exception(0x18uLL);
  MEMORY[0x2318C02A0](exception, 9);
  __cxa_throw(exception, MEMORY[0x277D82700], MEMORY[0x277D82628]);
}
...
{
  exception = __cxa_allocate_exception(0x18uLL);
  MEMORY[0x2318C02A0](exception, 8);
  __cxa_throw(exception, MEMORY[0x277D82700], MEMORY[0x277D82628]);
}
...
{
  exception = __cxa_allocate_exception(0x18uLL);
  MEMORY[0x2318C02A0](exception, 7);
  __cxa_throw(exception, MEMORY[0x277D82700], MEMORY[0x277D82628]);
}
...
{
  exception = __cxa_allocate_exception(0x18uLL);
  MEMORY[0x2318C02A0](exception, 15);
  __cxa_throw(exception, MEMORY[0x277D82700], MEMORY[0x277D82628]);
}
...
void sub_22CD7FC04(_Unwind_Exception *exception_object, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, uint64_t a10, uint64_t a11)
{
  if (a10)
  {
    std::__hash_node_destructor<std::allocator<std::__hash_node<std::__hash_value_type<std::string,std::basic_regex<char,std::regex_traits<char>>>,void *>>>::operator()[abi:ne200100](&a11, a10);
  }

  _Unwind_Resume(exception_object);
}

void sub_22CD7FCB8(_Unwind_Exception *a1)
{
  *v1 = 0;
  std::__hash_node_destructor<std::allocator<std::__hash_node<std::__hash_value_type<std::string,std::basic_regex<char,std::regex_traits<char>>>,void *>>>::operator()[abi:ne200100](v3, v2);
  _Unwind_Resume(a1);
}

std::string *_ZNSt3__14pairIKNS_12basic_stringIcNS_11char_traitsIcEENS_9allocatorIcEEEENS_11basic_regexIcNS_12regex_traitsIcEEEEEC2B8ne200100IJRS7_EJEJLm0EEJEEENS_21piecewise_construct_tERNS_5tupleIJDpT_EEERNSG_IJDpT0_EEENS_15__tuple_indicesIJXspT1_EEEENSP_IJXspT2_EEEE(std::string *this, __int128 **a2)
{
  v3 = *a2;
  if (*(*a2 + 23) < 0)
  {
  ...
  std::regex_traits<char>::regex_traits(&this[1]);
...
void sub_22CD7FD38(_Unwind_Exception *exception_object)
{
  if (*(v1 + 23) < 0)
  {
    operator delete(*v1);
...
void std::__hash_node_destructor<std::allocator<std::__hash_node<std::__hash_value_type<std::string,std::basic_regex<char,std::regex_traits<char>>>,void *>>>::operator()[abi:ne200100](uint64_t a1, uint64_t a2)
{
  if (*(a1 + 8) == 1)
  {
    v3 = *(a2 + 88);
...
void sub_22CD7FEA4(_Unwind_Exception *exception_object, int a2, int a3, int a4, int a5, int a6, int a7, int a8, void *__p, uint64_t a10)
{
  if (__p)
  {
    operator delete(__p);
...
void sub_22CD80C1C(_Unwind_Exception *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, void *__p, uint64_t a16, uint64_t a17, uint64_t a18, uint64_t a19, uint64_t a20, uint64_t a21, uint64_t a22, uint64_t a23, uint64_t a24, uint64_t a25, uint64_t a26, uint64_t a27)
{
  std::__state<char>::~__state(&a11);
...
int64x2_t std::deque<std::__state<char>>::push_front(int64x2_t *a1, uint64_t a2)
{
  ...
  *(v7 - 11) = *(a2 + 85);
  *(v7 - 16) = v9;
  result = vaddq_s64(a1[2], xmmword_22CDDEB30);
  a1[2] = result;
  return result;
}
...
void sub_22CD81084(_Unwind_Exception *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, uint64_t a10, void *__p, uint64_t a12, uint64_t a13)
{
  operator delete(v13);
  if (__p)
  {
...
void *std::__split_buffer<std::__state<char> *,std::allocator<std::__state<char> *>>::emplace_back<std::__state<char> *&>(void *result, void *a2)
{
  ...
  if (v4 == result[3])
  {
    ...
    if (v5 <= *result)
    {
      ...
      std::__allocate_at_least[abi:ne200100]<std::allocator<NLTransliterationCandidate *>>(result, v11);
    }
...
const void **std::__split_buffer<std::__state<char> *,std::allocator<std::__state<char> *>>::emplace_front<std::__state<char> *>(const void **result, void *a2)
{
  ...
  if (v4 == *result)
  {
    ...
    if (v6 >= v7)
    {
      ...
      std::__allocate_at_least[abi:ne200100]<std::allocator<NLTransliterationCandidate *>>(result, v9);
    }
...
void *std::__split_buffer<std::__state<char> *,std::allocator<std::__state<char> *> &>::emplace_back<std::__state<char> *>(void *result, void *a2)
{
  ...
  if (v4 == result[3])
  {
    ...
    if (v5 <= *result)
    {
      ...
      std::__allocate_at_least[abi:ne200100]<std::allocator<NLTransliterationCandidate *>>(result[4], v11);
    }
...
const void **std::__split_buffer<std::__state<char> *,std::allocator<std::__state<char> *> &>::emplace_front<std::__state<char> *&>(const void **result, void *a2)
{
  ...
  if (v4 == *result)
  {
    ...
    if (v6 >= v7)
    {
      ...
      std::__allocate_at_least[abi:ne200100]<std::allocator<NLTransliterationCandidate *>>(result[4], v9);
    }
...
void sub_22CD81774(_Unwind_Exception *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, void *__p, uint64_t a11, uint64_t a12)
{
  operator delete(v12);
  if (__p)
  {
...
_BYTE *std::vector<std::sub_match<char const*>>::__assign_with_size[abi:ne200100]<std::sub_match<char const*>*,std::sub_match<char const*>*>(void *a1, uint64_t a2, __int128 *a3, unint64_t a4)
{
  ...
  if (0xAAAAAAAAAAAAAAABLL * ((v7 - result) >> 3) < a4)
  {
    ...
    if (a4 <= 0xAAAAAAAAAAAAAAALL)
    {
      ...
      std::vector<std::sub_match<std::__wrap_iter<char const*>>>::__vallocate[abi:ne200100](a1, v11);
    }
...
void std::vector<std::sub_match<std::__wrap_iter<char const*>>>::__append(std::vector<std::ssub_match> *this, std::vector<std::ssub_match>::size_type __n)
{
  ...
  else
  {
    ...
    if (v9)
    {
      std::__allocate_at_least[abi:ne200100]<std::allocator<std::sub_match<std::__wrap_iter<char const*>>>>(this, v9);
    }
...
void sub_22CD81F94(_Unwind_Exception *exception_object, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, uint64_t a10, uint64_t a11, void *__p, uint64_t a13, int a14, __int16 a15, char a16, char a17)
{
  if (a17 < 0)
  {
    operator delete(__p);
...
void sub_22CD82174(_Unwind_Exception *exception_object, int a2, int a3, int a4, int a5, int a6, int a7, int a8, void *__p, uint64_t a10)
{
  if (__p)
  {
    operator delete(__p);
...
void std::vector<NLMessageIntentTypeWithMetadata>::__destroy_vector::operator()[abi:ne200100](void ***a1)
{
  v1 = *a1;
  v2 = **a1;
  if (v2)
...
void sub_22CD8249C(_Unwind_Exception *a1, uint64_t a2, ...)
{
  va_start(va, a2);
...
uint64_t std::vector<NLMessageIntentTypeWithMetadata>::__emplace_back_slow_path<NLMessageIntentTypeWithMetadata const&>(uint64_t a1, _DWORD *a2)
{
  ...
  if (v6)
  {
    std::__allocate_at_least[abi:ne200100]<std::allocator<NLMessageIntentTypeWithMetadata>>(a1, v6);
  }
  ...
  v15 = 48 * v2;
  *v14 = *a2;
  std::unordered_map<std::string,std::string>::unordered_map(48 * v2 + 8, (a2 + 2));
  *&v15 = v15 + 48;
  v7 = *(a1 + 8);
  v8 = v14 + *a1 - v7;
  std::__uninitialized_allocator_relocate[abi:ne200100]<std::allocator<NLMessageIntentTypeWithMetadata>,NLMessageIntentTypeWithMetadata*>(a1, *a1, v7, v8);
  v9 = *a1;
  *a1 = v8;
  v10 = *(a1 + 16);
  v12 = v15;
  ...
  *(&v15 + 1) = v10;
  v13 = v9;
  v14 = v9;
  std::__split_buffer<NLMessageIntentTypeWithMetadata>::~__split_buffer(&v13);
  return v12;
}

void sub_22CD825D4(_Unwind_Exception *a1, uint64_t a2, uint64_t a3, uint64_t a4, ...)
{
  va_start(va, a4);
  std::__split_buffer<NLMessageIntentTypeWithMetadata>::~__split_buffer(va);
  _Unwind_Resume(a1);
}

void std::__allocate_at_least[abi:ne200100]<std::allocator<NLMessageIntentTypeWithMetadata>>(uint64_t a1, unint64_t a2)
{
...
void std::__uninitialized_allocator_relocate[abi:ne200100]<std::allocator<NLMessageIntentTypeWithMetadata>,NLMessageIntentTypeWithMetadata*>(uint64_t a1, uint64_t *a2, uint64_t *a3, uint64_t a4)
{
  if (a2 != a3)
  {
    v5 = a2;
    ...
    do
    {
      ...
      v8 += 6;
      *(v6 - 8) = v9;
      v6 = std::__hash_table<std::__hash_value_type<std::string,std::string>,std::__unordered_map_hasher<std::string,std::__hash_value_type<std::string,std::string>,std::hash<std::string>,std::equal_to<std::string>,true>,std::__unordered_map_equal<std::string,std::__hash_value_type<std::string,std::string>,std::equal_to<std::string>,std::hash<std::string>,true>,std::allocator<std::__hash_value_type<std::string,std::string>>>::__hash_table(v6, v7 + 1) + 48;
      v7 = v8;
    }
    ...
    while (v5 != a3)
    {
      std::__hash_table<std::__hash_value_type<std::string,std::string>,std::__unordered_map_hasher<std::string,std::__hash_value_type<std::string,std::string>,std::hash<std::string>,std::equal_to<std::string>,true>,std::__unordered_map_equal<std::string,std::__hash_value_type<std::string,std::string>,std::equal_to<std::string>,std::hash<std::string>,true>,std::allocator<std::__hash_value_type<std::string,std::string>>>::~__hash_table((v5 + 1));
      v5 += 6;
    }
  }
}
...
void NLGujaratiWordLanguageModeler::NLGujaratiWordLanguageModeler(NLGujaratiWordLanguageModeler *this, CFDictionaryRef theDict)
{
  ...
  *(this + 2) = 0;
  *this = &unk_28400E448;
  if (CFDictionaryGetValue(theDict, @"useLanguageModel") == *MEMORY[0x277CBED28])
  {
...
void NLGujaratiWordLanguageModeler::loadLanguageModel(NLGujaratiWordLanguageModeler *this, CFDictionaryRef theDict)
{
  ...
  CFRelease(v6);
  CFDictionarySetValue(v4, *MEMORY[0x277D230E0], @"gu");
  *(this + 1) = LMLanguageModelCreate();
  CFRelease(v4);
  if (!*(this + 1))
  {
    v8 = NL::CFLogger::sharedInstance(v7);
    (*(*v8 + 16))(v8, 3, "Could not locate Gujarati language model");
  }
}
...
void NLGujaratiWordLanguageModeler::removeDiacritics(uint64_t a1@<X1>, char a2@<W2>, std::string *a3@<X8>)
{
  ...
  std::string::basic_string[abi:ne200100]<0>(v7, "ઁ");
  ...
  std::string::basic_string[abi:ne200100]<0>(v7, "ં");
  std::string::basic_string[abi:ne200100]<0>(__p, "");
  replaceAll(a3, v7, __p);
  if (v6 < 0)
  {
  ...
  std::string::basic_string[abi:ne200100]<0>(v7, "઼");
  std::string::basic_string[abi:ne200100]<0>(__p, "");
  replaceAll(a3, v7, __p);
  if (v6 < 0)
  {
  ...
  std::string::basic_string[abi:ne200100]<0>(v7, "્");
  std::string::basic_string[abi:ne200100]<0>(__p, "");
  replaceAll(a3, v7, __p);
  if (v6 < 0)
  {
...
LABEL_22:
  std::string::basic_string[abi:ne200100]<0>(v7, "ઃ");
  std::string::basic_string[abi:ne200100]<0>(__p, "");
  replaceAll(a3, v7, __p);
  if (v6 < 0)
  {
...
void sub_22CD82BB0(_Unwind_Exception *exception_object, int a2, int a3, int a4, int a5, int a6, int a7, int a8, void *__p, uint64_t a10, int a11, __int16 a12, char a13, char a14, void *a15, uint64_t a16, int a17, __int16 a18, char a19, char a20)
{
  if (a14 < 0)
  {
    operator delete(__p);
...
uint64_t NLCommons::isVowel(NLCommons *this, int8x16_t a2)
{
  ...
  a2.i8[8] = this;
  a2.i8[9] = this & 0xFB;
  return vmaxv_u8(vceq_s8(vqtbl1_s8(a2, 0x100000100), 0x554F4941756F6169)) & 1;
}

uint64_t NLCommons::isPunct(NLCommons *this, double a2, int8x16_t a3)
{
  a3.i32[0] = this;
  a3.i8[1] = this & 0xFE;
  a3.i8[6] = this & 0xFD;
  v3 = vceqq_s8(vqtbl1q_s8(a3, xmmword_22CDDF000), xmmword_22CDDF010);
  v3.i8[0] = vmaxvq_u8(v3);
  v4 = vceq_s8(vdup_n_s8(this), 0x3F2E7C3D2B5F2D26);
  v4.i8[0] = vmaxv_u8(v4);
  return (v3.i32[0] | v4.i32[0]) & 1 | ((this - 35) < 3) | ((this - 40) < 3);
}

uint64_t NLCommons::isNumeric(char *a1)
{
  v1 = a1[23];
  if ((v1 & 0x80u) == 0)
  {
  ...
  {
    v3 = *v2;
    if (v3 < 0 || (*(MEMORY[0x277D85DE0] + 4 * v3 + 60) & 0x400) == 0)
    {
      break;
    }
...
uint64_t NLCommons::isNonAlphaNumericStr(char *a1, double a2, int8x16_t a3)
{
  v3 = a1[23];
  if (v3 >= 0)
  {
...
void sub_22CD83390(_Unwind_Exception *a1)
{
...
uint64_t std::basic_stringstream<char,std::char_traits<char>,std::allocator<char>>::~basic_stringstream(uint64_t a1)
{
  ...
  *(a1 + 24) = MEMORY[0x277D82868] + 16;
  ...
  std::iostream::~basic_iostream();
  MEMORY[0x2318C0570](a1 + 128);
  return a1;
}

uint64_t NLCommons::split@<X0>(const std::string *a1@<X0>, unsigned __int8 a2@<W1>, void *a3@<X8>)
{
  *a3 = 0;
  a3[1] = 0;
  a3[2] = 0;
  std::basic_stringstream<char,std::char_traits<char>,std::allocator<char>>::basic_stringstream[abi:ne200100](v10, a1, 24);
  __p = 0uLL;
  v9 = 0;
  while (1)
  {
    v5 = std::getline[abi:ne200100]<char,std::char_traits<char>,std::allocator<char>>(v10, &__p, a2);
    if ((*(v5 + *(*v5 - 24) + 32) & 5) != 0)
    {
      break;
    }
...
void NLCommons::normalize(uint64_t a1@<X0>, _BYTE *a2@<X8>)
{
  ...
  v5 = CFStringCreateWithCString(*MEMORY[0x277CBECE8], v4, 0x8000100u);
  if (v5)
  {
    v6 = v5;
...
void sub_22CD83A34(_Unwind_Exception *exception_object)
{
  if (*(v1 + 23) < 0)
  {
    operator delete(*v1);
...
void sub_22CD83C98(_Unwind_Exception *a1)
{
  if (*(v1 + 87) < 0)
  {
    operator delete(*v3);
