...
+ (void)didVisit
{
  v2 = +[ASFAssistantMetrics sharedMetrics];
  [v2 logVisit];
}
...
{
  v3 = a3;
  v4 = +[ASFAssistantMetrics sharedMetrics];
...
- (id)__enableSiriTracker
{
  ...
  if (!enableSiriTracker)
  {
    ...
    v5 = [(ASFAssistantMetrics *)self __siriSourceProperty];
    v12[0] = v5;
    v6 = [(ASFAssistantMetrics *)self __confirmedTrueFalseProperty];
    v12[1] = v6;
...
- (id)__toggleTracker
{
  ...
  {
    v4 = objc_alloc(getPETScalarEventTrackerClass());
    v5 = [(ASFAssistantMetrics *)self __toggleTrackerNameProperty];
    v12[0] = v5;
    v6 = [(ASFAssistantMetrics *)self __onOffProperty];
    v12[1] = v6;
    v7 = [MEMORY[0x277CBEA60] arrayWithObjects:v12 count:2];
...
- (id)__startEnrollmentTracker
{
  ...
  {
    v4 = objc_alloc(getPETScalarEventTrackerClass());
    v5 = [(ASFAssistantMetrics *)self __confirmedTrueFalseProperty];
    v11[0] = v5;
...
- (id)__detailVisitFoundInAppsTracker
{
  ...
  {
    v4 = objc_alloc(getPETScalarEventTrackerClass());
    v5 = [(ASFAssistantMetrics *)self __foundInAppsProperty];
    v11[0] = v5;
    v6 = [MEMORY[0x277CBEA60] arrayWithObjects:v11 count:1];
...
- (id)__detailToggleFoundInAppsTracker
{
  ...
  {
    v4 = objc_alloc(getPETScalarEventTrackerClass());
    v5 = [(ASFAssistantMetrics *)self __detailToggleTrackerNameProperty];
    v6 = [(ASFAssistantMetrics *)self __foundInAppsProperty];
    v13[1] = v6;
    v7 = [(ASFAssistantMetrics *)self __onOffProperty];
    v13[2] = v7;
...
- (id)__detailToggleSearchTracker
{
  ...
  {
    v4 = objc_alloc(getPETScalarEventTrackerClass());
    v5 = [(ASFAssistantMetrics *)self __onOffProperty];
    v11[0] = v5;
    v6 = [MEMORY[0x277CBEA60] arrayWithObjects:v11 count:1];
