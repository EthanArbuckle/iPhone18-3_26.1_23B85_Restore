...
- (id)__enableSiriTracker
{
  ...
  if (!enableSiriTracker)
  {
    ...
    __siriSourceProperty = [(ASFAssistantMetrics *)self __siriSourceProperty];
    v12[0] = __siriSourceProperty;
    __confirmedTrueFalseProperty = [(ASFAssistantMetrics *)self __confirmedTrueFalseProperty];
...
- (id)__toggleTracker
{
  ...
  {
    v4 = objc_alloc(getPETScalarEventTrackerClass());
    __toggleTrackerNameProperty = [(ASFAssistantMetrics *)self __toggleTrackerNameProperty];
    v12[0] = __toggleTrackerNameProperty;
    __onOffProperty = [(ASFAssistantMetrics *)self __onOffProperty];
...
- (id)__detailVisitFoundInAppsTracker
{
  ...
  {
    v4 = objc_alloc(getPETScalarEventTrackerClass());
    __foundInAppsProperty = [(ASFAssistantMetrics *)self __foundInAppsProperty];
...
- (id)__detailToggleFoundInAppsTracker
{
  ...
  {
    v4 = objc_alloc(getPETScalarEventTrackerClass());
    __detailToggleTrackerNameProperty = [(ASFAssistantMetrics *)self __detailToggleTrackerNameProperty];
    __foundInAppsProperty = [(ASFAssistantMetrics *)self __foundInAppsProperty];
