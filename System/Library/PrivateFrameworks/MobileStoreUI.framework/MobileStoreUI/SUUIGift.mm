...
- (id)HTTPBodyDictionary
{
  ...
  {
    v11 = [MEMORY[0x277CCACA8] stringWithFormat:@"%ld", -[SUUIGift giftAmount](self, "giftAmount")];
  ...
  if (theme)
  {
    v18 = [MEMORY[0x277CCABB0] numberWithLongLong:{-[SUUIGiftTheme themeIdentifier](theme, "themeIdentifier")}];
