...
- (id)backgroundColorForIndexPath:(id)a3
{
  ...
  else
  {
    ...
    v7 = [(SUUIStorePageSection *)&v10 backgroundColorForIndexPath:v4];
  }
...
- (id)cellForIndexPath:(id)a3
{
  ...
  if (v11 == 5)
  {
    v13 = [v6 dequeueReusableCellWithReuseIdentifier:0x286AFFD40 forIndexPath:v4];
  ...
  else if (v11 == 9)
  {
    ...
    if (v12)
    {
      v13 = [v6 dequeueReusableCellWithReuseIdentifier:0x286AEE560 forIndexPath:v4];
      [(SUUIRowSection *)self _reloadEditorialLockupCell:v13 forComponent:v10 columnIndex:v7];
    }

    else
    {
      v13 = [v6 dequeueReusableCellWithReuseIdentifier:0x286AFB0C0 forIndexPath:v4];
  ...
  {
    v13 = [v6 dequeueReusableCellWithReuseIdentifier:@"SUUIRowSectionMiscReuseIdentifer" forIndexPath:v4];
    if (v10)
    {
...
- (CGSize)cellSizeForIndexPath:(id)a3
{
  ...
  else
  {
    ...
    [(SUUIRowSection *)self _heightForComponent:v15 columnIndex:v13 rowWidth:v8];
    v17 = v16;
  }
...
- (void)collectionViewDidConfirmItemOfferAtIndexPath:(id)a3
{
  ...
  if ([v7 componentType] == 9)
  {
    ...
    v9 = [v7 item];
    v10 = [(SUUIRowSection *)self itemOfferClickEventWithItem:v9 elementName:@"Column" index:v4];
    if (v10)
    {
...
- (void)collectionViewDidSelectItemAtIndexPath:(id)a3
{
  ...
  v10.receiver = self;
  v10.super_class = SUUIRowSection;
  [(SUUIStorePageSection *)&v10 collectionViewDidSelectItemAtIndexPath:v4];
}
...
- (void)collectionViewWillApplyLayoutAttributes:(id)a3
{
  v4 = a3;
  v5 = [v4 indexPath];
  v6 = [(SUUIRowSection *)self backgroundColorForIndexPath:v5];
...
- (void)prefetchResourcesWithReason:(int64_t)a3
{
  ...
  {
    v5 = [(SUUIRowSection *)self _missingItemLoader];
...
- (void)willAppearInContext:(id)a3
{
  ...
  [v5 registerClass:objc_opt_class() forCellWithReuseIdentifier:0x286AFFD40];
  [v5 registerClass:objc_opt_class() forCellWithReuseIdentifier:0x286AFB0C0];
  [v5 registerClass:objc_opt_class() forCellWithReuseIdentifier:0x286AEE560];
  v6 = [(SUUIStorePageSection *)self pageComponent];
  v7 = [v6 childComponents];
...
- (void)willTransitionToSize:(CGSize)a3 withTransitionCoordinator:(id)a4
{
  ...
  [(SUUIStorePageSection *)&v14 willTransitionToSize:v7 withTransitionCoordinator:width, height];
}
...
- (void)artworkRequest:(id)a3 didLoadImage:(id)a4
{
  v6 = a4;
  v7 = a3;
  v8 = [(SUUIRowSection *)self _columnViews];
...
LABEL_23:
    ...
    if ([v13 canRecordEventWithType:*MEMORY[0x277D6A488]])
    {
      ...
      v22 = SUUIMetricsMediaEventTypeForPlaybackState(a4);
...
- (void)missingItemLoader:(id)a3 didLoadItems:(id)a4 invalidItemIdentifiers:(id)a5
{
  ...
  if ([v6 count])
  {
    ...
    if ([v8 count])
    {
      ...
      v12 = [(SUUIStorePageSection *)self sectionIndex];
      v15[0] = MEMORY[0x277D85DD0];
      v15[1] = 3221225472;
...
- (void)productPageOverlayDidDismiss:(id)a3
{
  v9 = [(SUUIRowSection *)self _overlaySourceCell];
  v4 = [v9 layout];
...
- (id)_editorialLayoutForEditorial:(id)a3 columnIndex:(int64_t)a4
{
  ...
  if (!v10)
  {
    ...
    v10 = [(SUUIEditorialLayout *)v12 initWithEditorial:v6 layoutCache:v14];

    [v11 portraitPageWidth];
    [(SUUIRowSection *)self _columnWidthForColumnIndex:a4 rowWidth:?];
...
- (id)_editorialLayoutForLockup:(id)a3 columnIndex:(int64_t)a4
{
  ...
  if (v7)
  {
    ...
    if (!v11)
    {
      ...
      v11 = [(SUUIEditorialLayout *)v13 initWithEditorial:v7 layoutCache:v15];
...
- (void)_expandEditorialComponent:(id)a3 columnIndex:(int64_t)a4
{
  ...
  v10 = [(SUUIRowSection *)self _editorialLayoutForEditorial:v6 columnIndex:a4];
  ...
  if ([v11 requiresTruncation] && (-[NSMutableIndexSet containsIndex:](self->_expandedEditorialIndexes, "containsIndex:", a4) & 1) == 0)
  {
    ...
    self->_landscapeCellContentHeight = 0.0;
    self->_portraitCellContentHeight = 0.0;
    v15 = [MEMORY[0x277CCAA70] indexPathForItem:a4 inSection:{-[SUUIStorePageSection sectionIndex](self, "sectionIndex")}];
    v17[0] = v15;
...
- (double)_heightForComponent:(id)a3 columnIndex:(double)a4 rowWidth:(double)a5
{
  ...
  if (v9 > 8)
  {
    ...
    {
      case 9:
        [(SUUIRowSection *)self _heightForLockupComponent:v8 columnIndex:a4 rowWidth:a5];
        goto LABEL_14;
      case 10:
        [(SUUIRowSection *)self _heightForMediaComponent:v8 columnIndex:a4 rowWidth:a5];
        goto LABEL_14;
      case 14:
        [v8 height];
        goto LABEL_14;
  ...
  else
  {
    ...
    {
      case 2:
        [(SUUIRowSection *)self _heightForCountdownComponent:v8 columnIndex:a4 rowWidth:a5];
        goto LABEL_14;
      case 5:
        [(SUUIRowSection *)self _heightForEditorialComponent:v8 columnIndex:a4 rowWidth:a5];
        goto LABEL_14;
      case 7:
        [(SUUIRowSection *)self _heightForGalleryComponent:v8 columnIndex:a4 rowWidth:a5];
LABEL_14:
        v10 = v11;
        break;
    }
...
- (double)_heightForEditorialComponent:(id)a3 columnIndex:(int64_t)a4 rowWidth:(double)a5
{
  v7 = [(SUUIRowSection *)self _editorialLayoutForEditorial:a3 columnIndex:a5];
  v8 = [(SUUIStorePageSection *)self context];
  v9 = [v8 collectionView];
  ...
  if (v9)
  {
    ...
    do
    {
      for (i = 0; i != v10; ++i)
      {
        ...
        [(SUUIRowSection *)self _heightForMediaComponent:*(*(&v16 + 1) + 8 * i) columnIndex:a4 rowWidth:a5];
        if (v12 < v14)
        {
          v12 = v14;
        }
...
- (double)_heightForLockupComponent:(id)a3 columnIndex:(int64_t)a4 rowWidth:(double)a5
{
  ...
  if (v9)
  {
    v15 = [(SUUIRowSection *)self _editorialLayoutForLockup:v7 columnIndex:a4];
...
- (id)_imageConsumerWithItem:(id)a3 lockupSize:(int64_t)a4
{
  ...
  {
    v6 = [SUUIStyledImageDataConsumer lockupIconConsumerWithSize:a4, v5];
  }

  else
  {
    v6 = [SUUIProductImageDataConsumer lockupConsumerWithSize:a4 itemKind:v5];
  }
...
{
  v6 = a3;
  v7 = [(SUUIRowSection *)self _viewControllerForGalleryComponent:v6];
  if (v7)
  {
    v8 = [(SUUIStorePageSection *)self context];
...
LABEL_6:
    ...
    {
      v11 = [(SUUIRowSection *)self _lockupPlaceholderForComponent:v4];
      goto LABEL_6;
    }
  }
  ...
  v13 = SUUILockupImageSizeForLockupSize(0, [v10 itemKind]);
  ...
  if (v17)
  {
    ...
    v19 = [(SUUIRowSection *)self _imageConsumerWithItem:v10 lockupSize:0];
  ...
  v12 = [(SUUIRowSection *)self _lockupPlaceholderForComponent:v4];
...
- (id)_lockupPlaceholderForComponent:(id)a3
{
  ...
  v7 = [(SUUIRowSection *)self _imageConsumerWithItem:v5 lockupSize:v6];
...
- (id)_popSourceViewForOverlayController:(id)a3
{
  ...
  {
    v6 = [(SUUIRowSection *)self _overlaySourceCell];
    v7 = [v6 layout];
    v8 = [v7 iconImageView];
    [v8 frame];
    v10 = v9;
...
- (void)_reloadEditorialCell:(id)a3 forComponent:(id)a4 columnIndex:(int64_t)a5
{
  v20 = a3;
  v8 = a4;
  v9 = [(SUUIRowSection *)self _editorialLayoutForEditorial:v8 columnIndex:a5];
  v10 = [(SUUIStorePageSection *)self context];
  v11 = [v10 collectionView];
...
- (void)_reloadEditorialLockupCell:(id)a3 forComponent:(id)a4 columnIndex:(int64_t)a5
{
  ...
  v12 = [(SUUILockupComponent *)v8 item];
  [v9 configureForItem:v12 clientContext:self->_clientContext];
  [v9 setSeparatorStyle:0];

  v13 = [(SUUIRowSection *)self _lockupImageForComponent:v8];
  ...
  [v14 setImageBoundingSize:{SUUILockupImageSizeForLockupSize(v23, objc_msgSend(v12, "itemKind"))}];
  [v14 setLockupSize:v23];
  v15 = [(SUUIRowSection *)self _editorialLayoutForLockup:v8 columnIndex:a5];
...
- (void)_reloadLockupCell:(id)a3 forComponent:(id)a4 columnIndex:(int64_t)a5
{
  ...
  v13 = [(SUUILockupComponent *)v8 item];
  [v9 configureForItem:v13 clientContext:self->_clientContext];
  [v9 setSeparatorStyle:0];

  [v11 setImageBoundingSize:{SUUILockupImageSizeForLockupSize(v19, objc_msgSend(v13, "itemKind"))}];
  v14 = [(SUUIRowSection *)self _lockupImageForComponent:v8];
...
- (void)_reloadView:(id)a3 forMediaComponent:(id)a4 columnIndex:(int64_t)a5
{
  ...
  if (!v11)
  {
    ...
    v14 = [(SUUIRowSection *)self _newSizeToFitArtworkRequestWithArtwork:v13 columnIndex:a5];
    componentArtworkRequestIDs = self->_componentArtworkRequestIDs;
  ...
  if (!v13 && ([v10 trySetReason:1 forRequestWithIdentifier:{objc_msgSend(v12, "unsignedIntegerValue")}] & 1) == 0)
  {
    ...
    if (v14)
    {
      v15 = [(SUUIRowSection *)self _newSizeToFitArtworkRequestWithArtwork:v14 columnIndex:a5];
...
- (void)_selectGalleryComponent:(id)a3 columnIndex:(int64_t)a4
{
  ...
  v7 = [(SUUIStorePageSection *)self clickEventWithMedia:v6 elementName:@"Column" index:a4];
  if (v7)
  {
    v8 = [(SUUIStorePageSection *)self context];
...
- (void)_selectLockupComponent:(id)a3 columnIndex:(int64_t)a4
{
  v6 = a3;
  v7 = [v6 item];
  v8 = [(SUUIRowSection *)self clickEventWithItem:v7 elementName:@"Column" index:a4];
  if (v8)
  {
    v9 = [(SUUIStorePageSection *)self context];
  ...
  {
    if (SUUIItemKindIsSoftwareKind([v7 itemKind]) && (objc_msgSend(MEMORY[0x277D75418], "currentDevice"), v14 = objc_claimAutoreleasedReturnValue(), v15 = objc_msgSend(v14, "userInterfaceIdiom"), v14, v15))
    {
...
- (id)_viewControllerForCountdownComponent:(id)a3
{
  ...
  if (!v5)
  {
    ...
    v5 = [(SUUICountdownViewController *)v7 initWithCountdownComponent:v4 artworkLoader:v8];
    ...
    v13 = [(SUUICountdownViewController *)v5 view];
...
- (id)_viewControllerForGalleryComponent:(id)a3
{
  ...
  if (!v5)
  {
    ...
    v8 = [v6 resourceLoader];
    v5 = [(SUUIGalleryViewController *)v7 initWithGalleryComponent:v4 artworkLoader:v8];
