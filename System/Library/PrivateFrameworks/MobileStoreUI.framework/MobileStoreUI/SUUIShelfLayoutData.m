...
- (void)dealloc
{
  ...
  v4.receiver = self;
  v4.super_class = SUUIShelfLayoutData;
...
- (void)rowHeightForIndex:(uint64_t)a3 .cold.1(uint64_t a1, uint64_t a2, uint64_t a3)
{
  v6 = [MEMORY[0x277CCA890] currentHandler];
  [v6 handleFailureInMethod:a1 object:a2 file:@"SUUIShelfLayoutData.m" lineNumber:85 description:{@"Invalid row index: %ld", a3}];
}
