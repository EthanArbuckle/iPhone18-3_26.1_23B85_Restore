...
uint64_t __24__SUUIWishlist_addItem___block_invoke(uint64_t a1, void *a2)
{
  v3 = a2;
  ...
  {
    v6 = v5;
    [v5 setValue:&unk_286BBE550 forProperty:*MEMORY[0x277D6A6A0]];
    *(*(*(a1 + 48) + 8) + 24) = 1;
  }

  else
  {
    v7 = SUUIWishlistItemPropertiesWithItem(*(a1 + 32));
    if (v7)
    {
      ...
      [v7 setObject:&unk_286BBE550 forKey:*MEMORY[0x277D6A6A0]];
...
uint64_t __21__SUUIWishlist_items__block_invoke(uint64_t a1, void *a2)
{
  ...
  v8 = [MEMORY[0x277D69C40] predicateWithProperty:*MEMORY[0x277D6A6A0] value:&unk_286BBE568 comparisonType:2];
  [v5 setPredicate:v8];
...
void __47__SUUIWishlist_removeItemsWithItemIdentifiers___block_invoke_2(uint64_t a1, uint64_t a2, id *a3)
{
  ...
  [v7 setValue:&unk_286BBE568 forProperty:*MEMORY[0x277D6A6A0]];
  v8 = -[SUUIRemoveFromWishlistOperation initWithItemIdentifier:entityIdentifier:reason:]([SUUIRemoveFromWishlistOperation alloc], "initWithItemIdentifier:entityIdentifier:reason:", [*a3 longLongValue], a2, 0);
