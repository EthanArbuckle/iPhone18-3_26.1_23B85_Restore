...
- (SUUIAttributedStringView)initWithFrame:(CGRect)a3
{
  ...
  v3 = [(SUUIAttributedStringView *)&v6 initWithFrame:a3.origin.x, a3.origin.y, a3.size.width, a3.size.height];
  v4 = v3;
  if (v3)
  {
...
- (void)setLayout:(id)a3
{
  ...
  if (self->_layout != v5)
  {
    ...
    if (textStorage)
    {
      if (v8)
      {
        v7 = [(SUUIAttributedStringLayout *)v8 attributedString];
...
- (void)touchesCancelled:(id)a3 withEvent:(id)a4
{
  if (self->_trackingTouch)
  {
    [(SUUIAttributedStringView *)self _setTrackingTouch:0, a4];
...
- (void)drawRect:(CGRect)a3
{
  ...
  [(SUUIAttributedStringView *)self bounds:a3.origin.x];
  v5 = v4;
  v7 = v6;
  v9 = v8;
  v11 = v10;
  ...
  if (self->_stringTreatment == 1)
  {
    ...
    if (treatmentColor)
    {
      ...
      v29 = self->_layout;
      v30 = [(SUUIAttributedStringLayout *)v29 attributedString];
  ...
  v43 = [(SUUIAttributedStringLayout *)self->_layout attributedString];
  if (v43)
  {
    v44 = v43;
...
LABEL_40:
    ...
    {
      v66 = [(SUUIAttributedStringView *)self tintColor];
    }
    ...
    v74 = [(SUUIAttributedStringLayout *)self->_layout shadow];
    v168 = v15;
    if (v74)
    {
      v75 = [v72 mutableCopy];
    ...
    else
    {
      ...
      v87 = [(SUUIAttributedStringLayout *)self->_layout stringDrawingContext];
      v93 = v170;
...
- (void)_setupTapLocatorContainer
{
  if (!self->_textContainer)
  {
    ...
    v10 = [(SUUIAttributedStringLayout *)self->_layout attributedString];
...
- (BOOL)_touchInsideLinkText:(CGPoint)a3 linkTextRange:(_NSRange *)a4
{
  ...
  v8 = [(SUUIAttributedStringLayout *)self->_layout attributedString];
  v9 = [v8 length];
  if (v9 < 1)
  {
    v14 = 0;
...
- (CGSize)sizeThatFits:(CGSize)a3
{
  ...
  if (layout)
  {
    [(SUUIAttributedStringLayout *)layout boundingSize:a3.width];
    v7 = v6;
  }
  ...
  if (self->_stringTreatment == 1)
  {
    ...
    v9 = v8 + 6.0;
    v10 = self->_layout;
    v11 = [(SUUIAttributedStringLayout *)v10 attributedString];
...
- (void)_reloadTopInset
{
  ...
  if (layout)
  {
    ...
    {
      v4 = layout;
      v5 = [(SUUIAttributedStringLayout *)v4 attributedString];
