...
- (SUUIFilterBarView)initWithFrame:(CGRect)frame;
...
{
  v13.receiver = self;
  v13.super_class = SUUIFilterBarView;
...
- (void)dealloc
{
  ...
  v3.receiver = self;
  v3.super_class = SUUIFilterBarView;
...
void __57__SUUIFilterBarView_reloadWithViewElement_width_context___block_invoke(uint64_t a1, void *a2)
{
  ...
  do
  {
    v5 = [*(a1 + 40) childViewElementsForAlignment:qword_259FCC200[v4]];
    v36 = 0u;
    v37 = 0u;
    v38 = 0u;
    v39 = 0u;
      ...
      for (i = 0; i != v7; ++i)
      {
        ...
        if (v11 <= 68)
        {
          if (v11 > 12)
          {
            ...
            [(SUUISearchBarController *)v23 addTarget:*(a1 + 32) action:sel__imageTapAction_];
            goto LABEL_37;
          }
...
LABEL_29:
        ...
        switch(v11)
        {
          case 'E':
            ...
            goto LABEL_37;
          case 'j':
            v23 = [[SUUISearchBarController alloc] initWithSearchBarViewElement:v10];
            ...
            [v26 addObject:v23];
            v13 = [(SUUISearchBarController *)v23 searchBar];
            [v3 addView:v13];
LABEL_37:
          ...
          case 'm':
            v12 = v4;
            v13 = [v3 addReusableViewWithReuseIdentifier:0x286AF9A00];
            v14 = [[SUUISegmentedControlViewElementController alloc] initWithViewElement:v10 segmentedControl:v13];
...
- (void)layoutSubviews
{
  ...
  if (selfCopy->_bottomDividerView)
  {
    ...
    [(SUUIDividerView *)selfCopy->_bottomDividerView setFrame:0.0, v6 - v51, v53, v51];
  }
...
- (void)_buttonAction:(id)action
{
  ...
  actionCopy = action;
  v5 = SUUICollectionViewCellForView(self);
...
{
  actionCopy = action;
  [(SUUIFilterBarView *)self bringSubviewToFront:actionCopy];
...
+ (id)_attributedStringForButtonText:(id)text style:(id)style context:(id)context
{
  ...
  labelColor = SUUIViewElementPlainColorWithStyle(styleCopy, tintColor);
...
+ (id)_attributedStringForLabel:(id)label context:(id)context
{
  ...
  tintColor = [contextCopy tintColor];
  labelColor = SUUIViewElementPlainColorWithStyle(style, tintColor);
