...
- (SUUIBadgeTextAttachmentLoader)initWithResourceLoader:(id)loader;
...
- (SUUIBadgeTextAttachmentLoader)initWithResourceLoader:(id)loader
{
  loaderCopy = loader;
  v13.receiver = self;
  v13.super_class = SUUIBadgeTextAttachmentLoader;
...
- (BOOL)loadImageForBadge:(id)badge layout:(id)layout reason:(int64_t)reason
{
  ...
  if (imageURL && ([badgeCopy image], v11 = objc_claimAutoreleasedReturnValue(), v11, !v11))
  {
    ...
    if (p_isa && [(SUUIResourceLoader *)self->_resourceLoader trySetReason:reason forRequestWithIdentifier:p_isa[1]])
    {
      v12 = 0;
    }
    ...
    else
    {
      ...
      v15 = +[(SSVURLDataConsumer *)SUUIImageDataConsumer];
      [(SUUIArtworkRequest *)v14 setDataConsumer:v15];

      [(SUUIArtworkRequest *)v14 setDelegate:self];
      [(SUUIArtworkRequest *)v14 setURL:imageURL];
      ...
      v12 = [(SUUIResourceLoader *)self->_resourceLoader loadResourceWithRequest:v14 reason:reason];
