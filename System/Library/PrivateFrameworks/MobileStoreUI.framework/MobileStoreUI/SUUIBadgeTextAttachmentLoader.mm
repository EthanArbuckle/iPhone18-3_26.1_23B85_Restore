...
- (BOOL)loadImageForBadge:(id)a3 layout:(id)a4 reason:(int64_t)a5
{
  ...
  if (v10 && ([v8 image], v11 = objc_claimAutoreleasedReturnValue(), v11, !v11))
  {
    ...
    if (p_isa && [(SUUIResourceLoader *)self->_resourceLoader trySetReason:a5 forRequestWithIdentifier:p_isa[1]])
    {
      v12 = 0;
    }
    ...
    else
    {
      ...
      v12 = [(SUUIResourceLoader *)self->_resourceLoader loadResourceWithRequest:v14 reason:a5];
