...
- (id)collectionView:(id)a3 cellForItemAtIndexPath:(id)a4
{
  collectionView = self->_collectionView;
  v6 = a4;
  v7 = [(SUUIGiftThemeCollectionView *)collectionView dequeueReusableCellWithReuseIdentifier:@"a" forIndexPath:v6];
...
- (void)_doneAction:(id)a3
{
  v4 = [(SUUIIPhoneSlideshowViewController *)self delegate];
...
- (id)_imageAtIndex:(int64_t)a3
{
  ...
  if (v5 == v6)
  {
    v7 = [(SUUIIPhoneSlideshowViewController *)self _placeholderImageAtIndex:a3];
...
- (void)_reloadSize
{
  v3 = [(SUUIIPhoneSlideshowViewController *)self view];
  [v3 frame];
  v5 = v4 + -54.0;

  v6 = [(SUUIIPhoneSlideshowViewController *)self view];
  [v6 frame];
  v8 = v7 + -64.0;

  v9 = [(SUUIGiftThemeCollectionView *)self->_collectionView collectionViewLayout];
