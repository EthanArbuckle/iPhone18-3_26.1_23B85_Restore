...
- (SUUIBrickSwooshViewController)initWithSwoosh:(id)swoosh;
...
- (id)popImageViewForItemAtIndex:(int64_t)index
{
  ...
  if (v7)
  {
    ...
    view = [(SUUIBrickSwooshViewController *)self view];
...
- (void)setClientContext:(id)context
{
  ...
  [(SUUISwooshViewController *)&v7 setClientContext:context];
