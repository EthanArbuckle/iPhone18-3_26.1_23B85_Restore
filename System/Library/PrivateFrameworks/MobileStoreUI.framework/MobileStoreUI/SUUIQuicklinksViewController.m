...
{
  width = a3.width;
  v6 = [(SUUIQuicklinksViewController *)self view:a4];
  if (width <= 682.0)
  {
    v7 = 1;
  }
...
- (void)loadView
{
  ...
  v6 = [(SUUIQuicklinksViewController *)self title];
  ...
  v12 = [(SUUIQuicklinksViewController *)self _numberOfRows];
  v13 = [objc_alloc(MEMORY[0x277D752A0]) initWithFrame:v16 collectionViewLayout:{0.0, 0.0, 0.0, ceilf(v12 * 44.0)}];
  collectionView = self->_collectionView;
  self->_collectionView = v13;

  [(UICollectionView *)self->_collectionView registerClass:objc_opt_class() forCellWithReuseIdentifier:@"a"];
  v15 = [(SUUIColorScheme *)self->_colorScheme backgroundColor];
  if (!v15)
  {
