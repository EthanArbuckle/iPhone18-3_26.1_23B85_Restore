...
- (void)main
{
  ...
  if (objc_opt_isKindOfClass())
  {
    ...
    v18[1] = 3221225472;
    v18[2] = __48__SUUIMediaSocialAdminPermissionsOperation_main__block_invoke;
    v18[3] = &unk_2798F8158;
    v18[4] = &v19;
    v18[5] = &v25;
    ...
    if (v20[5])
    {
      v10 = [(SUUIMediaSocialAdminPermissionsOperation *)self _authorsWithResponseDictionary:?];
    }
...
- (id)_lookupResponseForMissingAuthors:(id)authors error:(id *)error
{
  ...
  v12 = [(SUUIClientContext *)self->_clientContext valueForConfigurationKey:@"sfsuffix"];
