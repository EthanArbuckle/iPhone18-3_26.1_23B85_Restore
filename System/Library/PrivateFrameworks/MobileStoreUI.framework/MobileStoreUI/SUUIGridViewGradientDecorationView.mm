...
- (SUUIGridViewGradientDecorationView)initWithFrame:(CGRect)frame;
...
- (SUUIGridViewGradientDecorationView)initWithFrame:(CGRect)frame
{
  ...
  return [(SUUIGridViewGradientDecorationView *)&v4 initWithFrame:frame.origin.x, frame.origin.y, frame.size.width, frame.size.height];
}
...
- (void)layoutSubviews
{
  ...
  if ([(IKColor *)self->_kolor colorType]== 3)
  {
    ...
    if ([v6 count])
    {
      ...
      [(SUUIGridViewGradientDecorationBackgroundView *)self->_backgroundView setBackgroundColor:firstObject];
...
- (void)_createGradient:(id)gradient withGradientType:(int64_t)type
{
  ...
  layer = [(SUUIGridViewGradientDecorationBackgroundView *)self->_backgroundView layer];
...
- (void)applyLayoutAttributes:(id)attributes
{
  ...
  [(SUUIGridViewGradientDecorationView *)&v15 applyLayoutAttributes:attributesCopy];
  backgroundView = self->_backgroundView;
  if (backgroundView)
  {
  ...
  if ([(IKColor *)self->_kolor colorType]!= 3)
  {
    ...
    [(SUUIGridViewGradientDecorationBackgroundView *)v12 setBackgroundColor:color];
  }
}
