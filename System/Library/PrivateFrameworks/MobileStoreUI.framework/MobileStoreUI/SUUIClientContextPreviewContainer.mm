...
- (SUUIClientContextPreviewContainer)initWithAppContext:(id)context clientContext:(id)clientContext previewContainerViewController:(id)controller;
...
- (SUUIClientContextPreviewContainer)initWithAppContext:(id)context clientContext:(id)clientContext previewContainerViewController:(id)controller
{
  ...
  v13.receiver = self;
  v13.super_class = SUUIClientContextPreviewContainer;
...
void __54__SUUIClientContextPreviewContainer_previewDocument::__block_invoke(void *a1)
{
  if (*(a1[4] + 32))
  {
    ...
    v6 = [(SUUIDocumentContainerViewController *)v2 initWithDocument:v4 options:v3 clientContext:WeakRetained];
