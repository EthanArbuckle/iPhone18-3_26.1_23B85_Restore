...
- (_SUUIItemBrowseCellContentView)initWithFrame:(CGRect)a3
{
  ...
  v3 = [(_SUUIItemBrowseCellContentView *)&v6 initWithFrame:a3.origin.x, a3.origin.y, a3.size.width, a3.size.height];
  if (v3)
  {
...
- (void)drawRect:(CGRect)a3
{
  ...
  {
    v8 = [(SUUICellImageView *)self->_userRatingImageView image];
