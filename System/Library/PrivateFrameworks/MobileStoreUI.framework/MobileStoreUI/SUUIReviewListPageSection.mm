...
- (SUUIReviewListPageSection)initWithPageComponent:(id)component;
...
- (SUUIReviewListPageSection)initWithPageComponent:(id)component
{
  ...
  if (v3)
  {
    ...
    v3->_contextActionsRegistration = dictionary;
  }
...
- (id)cellForIndexPath:(id)path
{
  ...
  v12 = [collectionView dequeueReusableCellWithReuseIdentifier:0x286AF6160 forIndexPath:pathCopy];
  ...
  v15 = v14 + -30.0;
  [(SUUIReviewListPageSection *)self _contentInsetForReviewIndex:item];
  [v12 setContentInset:?];
...
- (void)collectionViewWillApplyLayoutAttributes:(id)attributes
{
  ...
  [(SUUIStorePageSection *)&v14 collectionViewWillApplyLayoutAttributes:attributesCopy];
}
...
- (void)registerContextActionsForCell:(id)cell indexPath:(id)path viewController:(id)controller
{
  ...
  if (objc_opt_isKindOfClass())
  {
    ...
    if (dialogTemplate)
    {
      v16 = [(SUUIReviewListPageSection *)self _contextActionRegistrationKeyWithCell:cellCopy indexPath:pathCopy];
      ...
      contextActionsRegistration = [(SUUIReviewListPageSection *)self contextActionsRegistration];
...
{
  controllerCopy = controller;
  v8 = [(SUUIReviewListPageSection *)self _contextActionRegistrationKeyWithCell:cell indexPath:path];
  contextActionsRegistration = [(SUUIReviewListPageSection *)self contextActionsRegistration];
  ...
  if (v10)
  {
    ...
    contextActionsRegistration2 = [(SUUIReviewListPageSection *)self contextActionsRegistration];
...
- (void)willAppearInContext:(id)context
{
  ...
  [collectionView registerClass:objc_opt_class() forCellWithReuseIdentifier:0x286AF6160];
