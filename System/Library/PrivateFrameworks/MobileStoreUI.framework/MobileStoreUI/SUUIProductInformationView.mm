...
- (SUUIProductInformationView)initWithFrame:(CGRect)a3
{
  ...
  v3 = [(SUUIProductInformationView *)&v16 initWithFrame:a3.origin.x, a3.origin.y, a3.size.width, a3.size.height];
  v4 = v3;
  if (v3)
  {
...
- (void)setColorScheme:(id)a3
{
  ...
  if (self->_colorScheme != v5)
  {
    ...
    v26 = [(SUUIColorScheme *)self->_colorScheme secondaryTextColor];
    if (v26)
    {
  ...
  if (v4 != v16 && ([v4 isEqualToString:v16] & 1) == 0)
  {
    ...
    if (v16)
    {
      if (!titleLabel)
      {
        ...
        v8 = self->_titleLabel;
        v9 = [(SUUIProductInformationView *)self backgroundColor];
