  ...
  if (v11)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        -[SUUIBrickSwooshPageSection _addImpressionForIndex:toSession:](self, "_addImpressionForIndex:toSession:", [v15 item], v7);
...
- (id)cellForIndexPath:(id)a3
{
  ...
  v7 = [v6 dequeueReusableCellWithReuseIdentifier:@"SUUIBrickSwooshPageSectionReuseIdentifier" forIndexPath:v4];
  ...
  if (v9 != v10)
  {
    v11 = [(SUUIStorePageSection *)self backgroundColorForIndexPath:v4];
...
- (CGSize)cellSizeForIndexPath:(id)a3
{
  ...
  v6 = [(SUUIBrickSwooshPageSection *)self _swooshViewController];
  v7 = [v6 view];
...
- (void)missingItemLoader:(id)a3 didLoadItems:(id)a4 invalidItemIdentifiers:(id)a5
{
  ...
  if ([v10 count])
  {
    ...
    v7 = [(SUUIBrickSwooshPageSection *)self _swooshViewController];
    v8 = [v6 bricks];
    [v7 setBricks:v8];

    v9 = [(SUUIBrickSwooshPageSection *)self _artworkLoader];
...
- (void)swoosh:(id)a3 didSelectCellAtIndex:(int64_t)a4
{
  ...
  v8 = [v7 link];
  v9 = [(SUUIStorePageSection *)self clickEventWithLink:v8 elementName:*MEMORY[0x277D6A4C8] index:a4];
  if (v9)
  {
...
- (id)swoosh:(id)a3 imageForCellAtIndex:(int64_t)a4
{
  ...
  v8 = [(SUUIBrickSwooshArtworkLoader *)self->_artworkLoader cachedImageForBrick:v7];
  if (!v8)
  {
    v9 = [(SUUIBrickSwooshPageSection *)self _artworkLoader];
...
- (void)_addImpressionForIndex:(int64_t)a3 toSession:(id)a4
{
  ...
  v6 = a4;
  v7 = [(SUUIBrickSwooshViewController *)swooshViewController bricks];
...
- (id)_artworkLoader
{
  ...
  if (!artworkLoader)
  {
    ...
    v7 = [(SUUIBrickSwooshPageSection *)self _swooshViewController];
    v8 = [(SUUIBrickSwooshArtworkLoader *)v5 initWithArtworkLoader:v6 swoosh:v7];
...
- (void)_loadMissingItemsFromIndex:(int64_t)a3 withReason:(int64_t)a4
{
  ...
  {
    v7 = [(SUUIBrickSwooshPageSection *)self _missingItemLoader];
...
- (id)_swooshViewController
{
  ...
  if (!swooshViewController)
  {
    ...
    v8 = [(SUUIBrickSwooshViewController *)v6 initWithSwoosh:v7];
