...
- (SUUIRedeemCameraView)initWithClientContext:(id)a3
{
  ...
  if (v6)
  {
    ...
    v12 = [(SUUIRedeemCameraView *)v7 _newTextFieldWithClientContext:v5 placeholderColor:v11];
    ...
    v15 = [(SUUIRedeemCameraView *)v7 _newTextFieldWithClientContext:v5 placeholderColor:v14];
...
- (void)keyboardWillShow:(id)a3
{
  if (self->_displayRedeem)
  {
    v9[9] = v3;
    v9[10] = v4;
    v6 = [(SUUIRedeemTextField *)self->_textField text];
    [(SUUIRedeemCameraView *)self setText:v6];
...
- (void)keyboardWillHide:(id)a3
{
  if (!self->_displayRedeem)
  {
    v4 = [(SUUIRedeemTextField *)self->_inputAccessoryTextField text];
...
- (void)_iTunesPassLearnMoreAction:(id)a3
{
  v4 = [(SUUIRedeemCameraView *)self delegate];
