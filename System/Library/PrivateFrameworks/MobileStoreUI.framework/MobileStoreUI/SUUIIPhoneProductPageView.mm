...
- (SUUIIPhoneProductPageView)initWithFrame:(CGRect)frame;
...
- (SUUIIPhoneProductPageView)initWithFrame:(CGRect)frame
{
  ...
  v3 = [(SUUIIPhoneProductPageView *)&v7 initWithFrame:frame.origin.x, frame.origin.y, frame.size.width, frame.size.height];
  if (v3)
  {
