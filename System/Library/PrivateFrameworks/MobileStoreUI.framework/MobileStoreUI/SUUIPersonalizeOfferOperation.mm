...
- (SUUIPersonalizeOfferOperation)initWithItemIdentifier:(int64_t)identifier clientContext:(id)context;
- (id)outputBlock;
- (void)main;
...
- (void)main
{
  ...
  [v6 main];
  outputBlock = [(SUUIPersonalizeOfferOperation *)self outputBlock];
  v11 = outputBlock;
  if (outputBlock)
  {
