...
- (SUUIGallerySwooshPageSection)initWithPageComponent:(id)component;
...
- (void)addImpressionsForIndexPath:(id)path toSession:(id)session
{
  ...
  indexPathsForVisibleItems = [(SUUIGallerySwooshViewController *)self->_swooshViewController indexPathsForVisibleItems];
  v13 = 0u;
  v14 = 0u;
  v15 = 0u;
  v16 = 0u;
  ...
  if (v9)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        -[SUUIGallerySwooshPageSection _addImpressionForIndex:toSession:](self, "_addImpressionForIndex:toSession:", [*(*(&v13 + 1) + 8 * v12++) item], sessionCopy);
      }
...
- (void)willAppearInContext:(id)context
{
  ...
  [collectionView registerClass:objc_opt_class() forCellWithReuseIdentifier:@"SUUIGallerySwooshPageSectionReuseIdentifier"];
}
...
- (id)cellForIndexPath:(id)path
{
  ...
  v7 = [collectionView dequeueReusableCellWithReuseIdentifier:@"SUUIGallerySwooshPageSectionReuseIdentifier" forIndexPath:pathCopy];

  _swooshViewController = [(SUUIGallerySwooshPageSection *)self _swooshViewController];
...
- (void)prefetchResourcesWithReason:(int64_t)reason
{
  ...
  context = [(SUUIStorePageSection *)selfCopy context];
  resourceLoader = [context resourceLoader];

  _swooshViewController = [(SUUIGallerySwooshPageSection *)selfCopy _swooshViewController];
  ...
  if (v7 >= 1)
  {
    ...
    do
    {
      ...
      if (!v14)
      {
        ...
        v16 = [(SUUIGallerySwooshPageSection *)selfCopy _newArtworkRequestWithArtwork:v15];
        v17 = v16;
        if (v16)
        {
  ...
  if (v13)
  {
    ...
    while (2)
    {
      for (i = 0; i != v14; ++i)
      {
        ...
        {
          _swooshViewController2 = [(SUUIGallerySwooshPageSection *)self _swooshViewController];
          item = [v17 item];
          imageCopy = v22;
...
- (void)swoosh:(id)swoosh didChangePlaybackState:(int64_t)state forItemAtIndex:(int64_t)index
{
  ...
  if ([metricsController canRecordEventWithType:*MEMORY[0x277D6A488]])
  {
    ...
    v11 = SUUIMetricsMediaEventTypeForPlaybackState(state);
...
- (void)swoosh:(id)swoosh didSelectCellAtIndex:(int64_t)index
{
  ...
  v9 = [(SUUIStorePageSection *)self clickEventWithMedia:v8 elementName:*MEMORY[0x277D6A4E0] index:index];
  if (v9)
  {
    context = [(SUUIStorePageSection *)self context];
    metricsController = [context metricsController];
...
- (void)swoosh:(id)swoosh willDisplayCellAtIndex:(int64_t)index
{
  ...
  {
    [(SUUIGallerySwooshPageSection *)self _addImpressionForIndex:index toSession:activeImpressionsSession];
    v8 = activeImpressionsSession;
  }
}
...
- (id)_newArtworkRequestWithArtwork:(id)artwork
{
  ...
  if (v5)
  {
    ...
    v7 = +[SUUISizeToFitImageDataConsumer consumerWithConstraintSize:](SUUISizeToFitImageDataConsumer, "consumerWithConstraintSize:", [artworkCopy width], objc_msgSend(artworkCopy, "height"));
...
- (id)_swooshViewController
{
  ...
  if (!swooshViewController)
  {
    ...
    pageComponent = [(SUUIStorePageSection *)self pageComponent];
    v8 = [(SUUIGallerySwooshViewController *)v6 initWithGallerySwoosh:pageComponent];
    ...
    [(SUUISwooshViewController *)v10 setClientContext:clientContext];

    v12 = self->_swooshViewController;
    colorScheme = [context colorScheme];
    [(SUUIGallerySwooshViewController *)v12 setColorScheme:colorScheme];
