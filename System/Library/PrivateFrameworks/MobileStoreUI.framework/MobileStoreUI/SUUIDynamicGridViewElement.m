  ...
  if (v6)
  {
    ...
    while (2)
    {
      for (i = 0; i != v7; ++i)
      {
        ...
        v11 = [(SUUIGridViewElement *)self _countOfInputCheckboxesWithBaseElement:v10 limit:1];
...
- (id)templateDefinitionViewElementsForType:(id)a3 mode:(id)a4
{
  v6 = [(SUUIDynamicGridViewElement *)self _templateDefinitionTypeToModeValueMap];
  if ([a3 length])
  {
