...
- (SUUICountdownFlapView)initWithPosition:(int64_t)a3 flapTopColor:(id)a4 flapBottomColor:(id)a5
{
  ...
  if (v11)
  {
    ...
    v13 = [(SUUICountdownFlapView *)v12 _newLabel];
    ...
    v17 = [(SUUICountdownFlapView *)v12 _newLabel];
    ...
    v21 = [(SUUICountdownFlapView *)v12 _newLabel];
    ...
    v26 = [(SUUICountdownFlapView *)v12 _newLabel];
...
- (void)setFrame:(CGRect)a3
{
  ...
  [(SUUICountdownFlapView *)&v25 setFrame:a3.origin.x, a3.origin.y, a3.size.width, a3.size.height];
  factor = self->_factor;
  position = self->_position;
  switch(position)
  {
