...
- (SUUIFlexibleSegmentedControl)initWithFrame:(CGRect)a3
{
  ...
  v3 = [(SUUIFlexibleSegmentedControl *)&v8 initWithFrame:a3.origin.x, a3.origin.y, a3.size.width, a3.size.height];
  v4 = v3;
  if (v3)
  {
...
- (void)layoutSubviews
{
  ...
  *&v18[8] = v5;
  ...
  v13 = [(SUUIFlexibleSegmentedControl *)self moreListIndex];
...
- (void)_valueChangeAction:(id)a3
{
  ...
  v4 = [(SUUIFlexibleSegmentedControl *)self moreListIndex];
  selectedSegmentIndex = self->_selectedSegmentIndex;
...
- (void)_configureSegmentedControl:(id)a3 withTitles:(id)a4 boundingSize:(CGSize)a5
{
  ...
  while (1)
  {
    [(SUUIFlexibleSegmentedControl *)self _setTitles:v9 forSegmentedControl:v34];
