...
- (SUUIAttributedStringView)initWithFrame:(CGRect)frame;
...
{
  v6.receiver = self;
  v6.super_class = SUUIAttributedStringView;
  v3 = [(SUUIAttributedStringView *)&v6 initWithFrame:frame.origin.x, frame.origin.y, frame.size.width, frame.size.height];
  v4 = v3;
  if (v3)
  {
...
- (void)setLayout:(id)layout
{
  ...
  if (self->_layout != layoutCopy)
  {
    ...
    if (textStorage)
    {
      if (v8)
      {
        attributedString = [(SUUIAttributedStringLayout *)v8 attributedString];
...
- (NSString)description
{
  attributedString = [(SUUIAttributedStringLayout *)self->_layout attributedString];
  ...
  {
    v11.receiver = self;
    v11.super_class = SUUIAttributedStringView;
    v7 = [(SUUIAttributedStringView *)&v11 description];
  ...
  {
    v12.receiver = self;
    v12.super_class = SUUIAttributedStringView;
    v7 = [(SUUIAttributedStringView *)&v12 description];
...
- (void)touchesBegan:(id)began withEvent:(id)event
{
  ...
  if ([(SUUIAttributedStringView *)self _touchInsideLinkText:&self->_trackingRange linkTextRange:?])
  {
  ...
  {
    v9.receiver = self;
    v9.super_class = SUUIAttributedStringView;
    [(SUUIAttributedStringView *)&v9 touchesBegan:beganCopy withEvent:eventCopy];
  }
}
...
- (void)touchesMoved:(id)moved withEvent:(id)event
{
  if (self->_trackingTouch)
  {
    ...
    [anyObject locationInView:self];
    [(SUUIAttributedStringView *)self _setTouchInside:[(SUUIAttributedStringView *)self _touchInsideLinkText:&self->_trackingRange linkTextRange:?]];
  }
  ...
  else
  {
    v6.receiver = self;
    v6.super_class = SUUIAttributedStringView;
    [(SUUIAttributedStringView *)&v6 touchesMoved:moved withEvent:event];
  }
}
...
- (void)touchesEnded:(id)ended withEvent:(id)event
{
  if (self->_trackingTouch)
  {
    ...
    if ([(SUUIAttributedStringView *)self _touchInsideLinkText:&self->_trackingRange linkTextRange:?])
    {
      ...
      v6 = [WeakRetained conformsToProtocol:&unk_286C57A40];
  ...
  else
  {
    v9.receiver = self;
    v9.super_class = SUUIAttributedStringView;
    [(SUUIAttributedStringView *)&v9 touchesEnded:ended withEvent:event];
  }
}
...
- (void)touchesCancelled:(id)cancelled withEvent:(id)event
{
  if (self->_trackingTouch)
  {
    [(SUUIAttributedStringView *)self _setTrackingTouch:0, event];
  ...
  {
    v5.receiver = self;
    v5.super_class = SUUIAttributedStringView;
    [(SUUIAttributedStringView *)&v5 touchesCancelled:cancelled withEvent:event];
  }
}
...
- (void)drawRect:(CGRect)rect
{
  ...
  [(SUUIAttributedStringView *)self bounds:rect.origin.x];
  v5 = v4;
  v7 = v6;
  v9 = v8;
  v11 = v10;
  ...
  if (self->_stringTreatment == 1)
  {
    ...
    if (treatmentColor)
    {
      ...
      v29 = self->_layout;
      attributedString = [(SUUIAttributedStringLayout *)v29 attributedString];
      v31 = [attributedString attribute:*MEMORY[0x277D740A8] atIndex:0 effectiveRange:0];

      [(SUUIAttributedStringLayout *)v29 baselineOffset];
      v33 = v32;
      [v31 capHeight];
      v35 = v33 - v34;
      [v31 _bodyLeading];
      v37 = v35 - v36 * ([(SUUIAttributedStringLayout *)v29 numberOfLines]- 1);
      [(SUUIAttributedStringLayout *)v29 topInset];
      v39 = v38;
  ...
  attributedString2 = [(SUUIAttributedStringLayout *)self->_layout attributedString];
...
LABEL_40:
    ...
    {
      tintColor = [(SUUIAttributedStringView *)self tintColor];
    }
    ...
    if (self->_containsLinks)
    {
      ...
      v182[1] = 3221225472;
      v182[2] = __37__SUUIAttributedStringView_drawRect___block_invoke;
      v182[3] = &unk_2798F6850;
      v182[4] = self;
      v71 = v69;
      v183 = v71;
    ...
    shadow = [(SUUIAttributedStringLayout *)self->_layout shadow];
    v168 = v15;
    if (shadow)
    {
      v75 = [v72 mutableCopy];
    ...
    else
    {
      ...
      stringDrawingContext = [(SUUIAttributedStringLayout *)self->_layout stringDrawingContext];
      v93 = v170;
...
{
  v14 = a2;
  v7 = [v14 objectForKey:@"SUUILinkAttributeName"];

  if (v7)
  {
    if ((v8 = *(a1 + 32), *(v8 + 456) != 1) || *(v8 + 480) != 1 || ((v9 = (v8 + 464), v11 = *v9, v10 = v9[1], a3 == v11) ? (v12 = a4 == v10) : (v12 = 0), !v12))
    {
      v13 = [v14 objectForKey:@"SUUILinkColorAttributeName"];
      if (!v13)
      {
        v13 = [*(a1 + 32) tintColor];
      }
...
- (BOOL)_touchInsideLinkText:(CGPoint)text linkTextRange:(_NSRange *)range
{
  ...
  else
  {
    ...
    [(NSLayoutManager *)self->_layoutManager enumerateLineFragmentsForGlyphRange:0 usingBlock:v10, &__block_literal_global_3];
...
- (CGSize)sizeThatFits:(CGSize)fits
{
  ...
  if (layout)
  {
    [(SUUIAttributedStringLayout *)layout boundingSize:fits.width];
    v7 = v6;
  }
  ...
  if (self->_stringTreatment == 1)
  {
    ...
    v9 = v8 + 6.0;
    v10 = self->_layout;
    attributedString = [(SUUIAttributedStringLayout *)v10 attributedString];
    ...
    v16 = v14 - v15;
    [v12 _bodyLeading];
    v18 = v16 - v17 * ([(SUUIAttributedStringLayout *)v10 numberOfLines]- 1);
...
{
  v3.receiver = self;
  v3.super_class = SUUIAttributedStringView;
...
- (void)_reloadTopInset
{
  ...
  if (layout)
  {
    ...
    {
      v4 = layout;
      attributedString = [(SUUIAttributedStringLayout *)v4 attributedString];
      ...
      v10 = v8 - v9;
      [v6 _bodyLeading];
      v12 = v10 - v11 * ([(SUUIAttributedStringLayout *)v4 numberOfLines]- 1);
