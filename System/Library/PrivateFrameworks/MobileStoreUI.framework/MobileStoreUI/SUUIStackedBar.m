...
- (SUUIStackedBar)initWithFrame:(CGRect)a3
{
  ...
  v3 = [(SUUIStackedBar *)&v15 initWithFrame:a3.origin.x, a3.origin.y, a3.size.width, a3.size.height];
  if (v3)
  {
...
- (void)_reload
{
  ...
  if ([(NSArray *)self->_items count])
  {
    ...
    do
    {
      ...
      v9 = [(SUUIStackedBarCell *)v6 backButton];
      [v9 setHidden:v8];

      v10 = [(SUUIStackedBarCell *)v6 backButton];
...
- (void)_selectItemAtIndex:(int64_t)a3
{
  v5 = [(SUUIStackedBar *)self delegate];
