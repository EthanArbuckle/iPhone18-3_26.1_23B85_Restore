...
LABEL_12:
  v18[0] = MEMORY[0x277D85DD0];
  v18[1] = 3221225472;
  v18[2] = __41__SUUIJSITunesStore_isRemovedSystemApp::__block_invoke_211;
  v18[3] = &unk_2798F8678;
  v14 = *(a1 + 48);
  v19 = *(a1 + 56);
  v22 = a2;
...
void __47__SUUIJSITunesStore_launchICloudFamilySettings__block_invoke(uint64_t a1, void *a2)
{
  ...
  if (objc_opt_respondsToSelector())
  {
    ...
    if (v3)
    {
      ...
      v6 = objc_alloc_init(SUUIWeakLinkedClassForString(&cfstr_Fafamilysettin.isa, v5));
      if (objc_opt_respondsToSelector())
      {
...
LABEL_12:
  v18[0] = MEMORY[0x277D85DD0];
  v18[1] = 3221225472;
  v18[2] = __46__SUUIJSITunesStore_restoreRemovedSystemApp::__block_invoke_232;
  v18[3] = &unk_2798F8678;
  v14 = *(a1 + 48);
  v19 = *(a1 + 56);
  v22 = a2;
...
void __33__SUUIJSITunesStore_loadRentals___block_invoke(id *a1)
{
  ...
  v3 = [SUUIWeakLinkedClassForString(&cfstr_Mpmediaquery.isa v2)];
  v4 = SUUIMediaPlayerFramework();
  v5 = *SUUIWeakLinkedSymbolForString("MPMediaItemPropertyRentalExpirationDate", v4);
...
void __33__SUUIJSITunesStore_loadRental::__block_invoke(uint64_t a1)
{
  ...
  v3 = [SUUIWeakLinkedClassForString(&cfstr_Mpmediaquery.isa v2)];
  v4 = SUUIMediaPlayerFramework();
  v5 = SUUIWeakLinkedClassForString(&cfstr_Mpmediapropert.isa, v4);
  v6 = SUUIMediaPlayerFramework();
  v7 = *SUUIWeakLinkedSymbolForString("MPMediaItemPropertyStoreID", v6);
    ...
    do
    {
      ...
      do
      {
        ...
        if ([v8 isRental])
        {
          ...
          v11 = *SUUIWeakLinkedSymbolForString("AVFileProcessorAttribute_RentalStartDate", v10);
          v12 = SUUIMediaPlayerFramework();
          v13 = *SUUIWeakLinkedSymbolForString("AVFileProcessorAttribute_RentalPeriod", v12);
          v14 = SUUIMediaPlayerFramework();
          v15 = *SUUIWeakLinkedSymbolForString("AVFileProcessorAttribute_RentalPlaybackStartDate", v14);
          v16 = SUUIMediaPlayerFramework();
          v83 = *SUUIWeakLinkedSymbolForString("AVFileProcessorAttribute_RentalPlaybackPeriod", v16);
          ...
          v76 = *SUUIWeakLinkedSymbolForString("MPMediaItemPropertyFilePath", v20);
          ...
          else
          {
            ...
            v32 = *SUUIWeakLinkedSymbolForString("MPMediaItemPropertyRentalPlaybackDuration", v31);
            v33 = SUUIMediaPlayerFramework();
            v34 = *SUUIWeakLinkedSymbolForString("MPMediaItemPropertyRentalStartTime", v33);
            v35 = SUUIMediaPlayerFramework();
            v36 = *SUUIWeakLinkedSymbolForString("MPMediaItemPropertyRentalDuration", v35);
            v72 = v30;
            v37 = [v8 valueForProperty:v30];
            if (([v37 isEqualToNumber:&unk_286BBE2F8] & 1) == 0)
            {
            ...
            if (([v42 isEqualToNumber:&unk_286BBE2F8] & 1) == 0)
            {
