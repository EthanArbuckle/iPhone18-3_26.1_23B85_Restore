...
- (SUUIAccountButtonsSection)initWithPageComponent:(id)component;
...
- (id)cellForIndexPath:(id)path
{
  ...
  v7 = [collectionView dequeueReusableCellWithReuseIdentifier:@"SUUIAccountButtonsSectionReuseIdentifier" forIndexPath:pathCopy];

  _accountButtonsViewController = [(SUUIAccountButtonsSection *)self _accountButtonsViewController];
  ...
  {
    v11 = [(SUUIAccountButtonsSection *)self backgroundColorForIndexPath:pathCopy];
...
- (void)willAppearInContext:(id)context
{
  ...
  [collectionView registerClass:objc_opt_class() forCellWithReuseIdentifier:@"SUUIAccountButtonsSectionReuseIdentifier"];
  v6.receiver = self;
...
- (id)_accountButtonsViewController
{
  ...
  if (!accountButtonsViewController)
  {
    ...
    [(SUUIAccountButtonsViewController *)self->_accountButtonsViewController setClientContext:clientContext];
    ...
    -[SUUIAccountButtonsViewController setTermsAndConditionsHidden:](self->_accountButtonsViewController, "setTermsAndConditionsHidden:", [pageComponent2 hidesTermsAndConditions]);
    ...
    if (!eCommerceLink && v12)
    {
      ...
      if ([string length])
      {
        eCommerceLink = [[SUUILink alloc] initWithURL:0 title:string targetString:0];
      }
    ...
    [(SUUIAccountButtonsViewController *)self->_accountButtonsViewController setECommerceLink:eCommerceLink];
    ...
    view = [(SUUIAccountButtonsViewController *)self->_accountButtonsViewController view];
