...
- (SUUIContextActionsConfiguration)initWithDialogTemplate:(id)template;
...
- (id)contextActions
{
  ...
  v22 = 0u;
  v23 = 0u;
  dialogTemplate = [(SUUIContextActionsConfiguration *)self dialogTemplate];
  ...
  if (v6)
  {
    ...
    do
    {
      for (i = 0; i != v7; ++i)
      {
        ...
        v15 = [(SUUIContextActionsConfiguration *)self _resourceImageForImageElement:buttonImage];
