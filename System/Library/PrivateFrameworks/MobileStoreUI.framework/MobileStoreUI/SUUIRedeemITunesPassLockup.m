...
- (void)setHighlighted:(BOOL)a3
{
  ...
  descriptionLabel = self->_descriptionLabel;
  v5 = [(SUUIRedeemITunesPassLockup *)self _attributedDescriptionString];
...
- (id)_attributedDescriptionString
{
  v3 = [(SUUIITunesPassConfiguration *)self->_configuration lockupDescription];
  v24 = [(SUUIITunesPassConfiguration *)self->_configuration lockupLearnMoreLinkTitle];
  ...
  v19 = [(SUUIRedeemITunesPassLockup *)self tintColor];
