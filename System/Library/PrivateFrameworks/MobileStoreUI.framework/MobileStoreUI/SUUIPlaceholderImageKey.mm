...
- (SUUIPlaceholderImageKey)initWithSize:(CGSize)size imageTreatment:(int64_t)treatment placeholderBackgroundColor:(id)color;
- (id)description;
@end
...
- (SUUIPlaceholderImageKey)initWithSize:(CGSize)size imageTreatment:(int64_t)treatment placeholderBackgroundColor:(id)color
{
  ...
  colorCopy = color;
  v14.receiver = self;
  v14.super_class = SUUIPlaceholderImageKey;
...
- (id)description
{
  ...
  v7.receiver = self;
  v7.super_class = SUUIPlaceholderImageKey;
