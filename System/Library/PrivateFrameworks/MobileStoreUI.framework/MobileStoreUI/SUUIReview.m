...
- (id)formattedBylineWithClientContext:(id)a3
{
  ...
  if (v13)
  {
    if (self->_reviewer)
    {
      ...
      {
        [SUUIClientContext localizedStringForKey:@"REVIEW_BYLINE_WITH_DATE" inBundles:0 inTable:@"ProductPage"];
      }
      v17 = ;
...
LABEL_28:
    if (self->_reviewer)
    {
      ...
      {
        [SUUIClientContext localizedStringForKey:@"REVIEW_BYLINE_NO_DATE" inBundles:0 inTable:@"ProductPage"];
      }
      v16 = ;
