...
- (void)setPersonalStarRating:(int64_t)a3
{
  v4 = [(SUUIReviewsHistogramViewController *)self _histogramView];
...
{
  v4 = a3;
  v5 = [(SUUIReviewsHistogramViewController *)self _histogramView];
...
- (void)loadView
{
  v3 = [(SUUIReviewsHistogramViewController *)self _histogramView];
...
- (void)_reloadHistogram
{
  ...
  v7 = [(SUUIReviewList *)self->_reviewList ratingCount];
  v8 = v7;
  [(SUUIReviewsHistogramView *)self->_histogramView setNumberOfUserRatings:v7];
  histogramView = self->_histogramView;
  if (v7)
  {
