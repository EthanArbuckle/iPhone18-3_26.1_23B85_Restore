...
{
  v8.receiver = self;
  v8.super_class = SUUIStoreDialogController;
...
void __65__SUUIStoreDialogController__performActionForDialog_buttonIndex___block_invoke(uint64_t a1, void *a2)
{
  ...
  v9 = [objc_alloc(MEMORY[0x277CBEAC0]) initWithObjectsAndKeys:{v3, @"SUUIStoreDialogControllerPurchaseNotificationKeyPurchaseResponse", 0}];
  v5 = [MEMORY[0x277CCAB98] defaultCenter];
  [v5 postNotificationName:@"SUUIStoreDialogControllerPurchaseRequestDidSucceedNotification" object:*(a1 + 32) userInfo:v9];
