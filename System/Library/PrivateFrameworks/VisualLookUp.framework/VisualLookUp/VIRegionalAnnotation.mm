...
- (VIRegionalAnnotation)initWithLabel:(id)label normalizedBoundingBox:(CGRect)box confidence:(float)confidence;
- (unint64_t)hash;
@end
...
- (BOOL)isEqual:(id)equal
{
  ...
  else
  {
    ...
    {
      label = self->_label;
      label = [(VIRegionalAnnotation *)v6 label];
      IsEqual = VIObjectIsEqual(label, label);
    }
