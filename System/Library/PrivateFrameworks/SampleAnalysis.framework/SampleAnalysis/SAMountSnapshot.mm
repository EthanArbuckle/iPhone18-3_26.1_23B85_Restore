  ...
  if ([(SAMountSnapshot *)self sizeInBytesForSerializedVersion]!= a4)
  {
    ...
    if (os_log_type_enabled(v18, OS_LOG_TYPE_ERROR))
    {
      ...
      *buf = 136315650;
      v47 = [v19 UTF8String];
      v48 = 2048;
      v49 = [(SAMountSnapshot *)self sizeInBytesForSerializedVersion];
      v50 = 2048;
      v51 = a4;
    ...
    *__error() = v17;
    ...
    _SASetCrashLogMessage(683, "%s: size %lu != buffer length %lu", v22, v23, v24, v25, v26, v27, v21);
...
LABEL_14:
    ...
    *__error() = v28;
    ...
    _SASetCrashLogMessage(692, "%s: %lu blockedThreadIDs", v35, v36, v37, v38, v39, v40, v34);
  ...
  *&a3->var0 = 257;
  *(&a3->var3 + 6) = *&self->_timestampOfLastResponse;
  *(&a3->var2 + 2) = SASerializableIndexForPointerFromSerializationDictionary(self->_timeWhenMeasured, a5);
  if ([(NSArray *)self->_blockedThreadIDs count]>= 0xFFFFFFFF)
  {
    goto LABEL_14;
  }

  *(&a3->var1 + 1) = [(NSArray *)self->_blockedThreadIDs count];
  v41 = 0u;
  v42 = 0u;
  v43 = 0u;
  v44 = 0u;
...
- (void)addSelfToSerializationDictionary:(id)a3
{
  ...
  if (v6)
  {
    ...
    [(SATimestamp *)timeWhenMeasured addSelfToSerializationDictionary:a3];
  }
}
  ...
  if (a4 <= 0x15)
  {
    ...
    if (os_log_type_enabled(v5, OS_LOG_TYPE_ERROR))
    {
      *buf = 134218240;
      ...
      v34 = 2048;
      v35 = 22;
      _os_log_error_impl(&dword_1E0E2F000, v5, OS_LOG_TYPE_ERROR, "bufferLength %lu < serialized SAMountSnapshot struct %lu", buf, 0x16u);
    }

    *__error() = v14;
    _SASetCrashLogMessage(718, "bufferLength %lu < serialized SAMountSnapshot struct %lu", v15, v16, v17, v18, v19, v20, a4);
    _os_crash();
    __break(1u);
    goto LABEL_11;
  }
...
LABEL_11:
    ...
    *__error() = v21;
    v31 = *(v5 + 2);
    _SASetCrashLogMessage(719, "bufferLength %lu < serialized SAMountStatusTracker struct with %lu blockedThreads", v24, v25, v26, v27, v28, v29, a4);
    _os_crash();
    __break(1u);
LABEL_14:
  ...
  v6->_timestampOfLastResponse = *(v5 + 14);
  v7 = [objc_alloc(MEMORY[0x1E695DF70]) initWithCapacity:*(v5 + 2)];
  if (*(v5 + 2))
  {
    v8 = 0;
    do
    {
      v9 = [MEMORY[0x1E696AD98] numberWithUnsignedLongLong:*(v5 + 22 + 8 * v8)];
      [v7 addObject:v9];
  ...
  if (a4 <= 0x15)
  {
    ...
    if (os_log_type_enabled(v7, OS_LOG_TYPE_ERROR))
    {
      *buf = 134218240;
      ...
      v36 = 2048;
      v37 = 22;
      _os_log_error_impl(&dword_1E0E2F000, v7, OS_LOG_TYPE_ERROR, "bufferLength %lu < serialized SAMountSnapshot struct %lu", buf, 0x16u);
    }

    *__error() = v16;
    _SASetCrashLogMessage(739, "bufferLength %lu < serialized SAMountSnapshot struct %lu", v17, v18, v19, v20, v21, v22, a4);
    _os_crash();
    __break(1u);
    goto LABEL_10;
  }
...
LABEL_10:
    ...
    *__error() = v23;
    v33 = *(v7 + 2);
    _SASetCrashLogMessage(740, "bufferLength %lu < serialized SAMountStatusTracker struct with %lu blockedThreads", v26, v27, v28, v29, v30, v31, a4);
    _os_crash();
    __break(1u);
LABEL_13:
