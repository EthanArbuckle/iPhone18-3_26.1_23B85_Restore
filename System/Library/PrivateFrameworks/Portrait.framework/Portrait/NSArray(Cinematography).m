...
{
  v16 = *a3;
  v7 = [a1 _firstIndexAtOrAfterTime:&v16 startIndex:0 lastIfEqual:1 timeSelector:a4];
  if (v7 >= 1)
  {
    if (v7 >= [a1 count])
    {
...
{
  time2 = *a3;
  v7 = [a1 _firstIndexAtOrAfterTime:&time2 timeSelector:?];
  if (v7 == [a1 count])
  {
    if (v7)
    {
...
- (uint64_t)_indexRangeOfTimeRange:()Cinematography timeSelector:
{
  ...
  lhs = *a3;
  v7 = [a1 _firstIndexAtOrAfterTime:&lhs timeSelector:a4];
  lhs = v11;
...
- (uint64_t)_firstIndexAtOrAfterTime:()Cinematography startIndex:lastIfEqual:timeSelector:
{
  ...
  v15[4] = a1;
  v15[5] = a6;
  v13 = [a1 indexOfObject:v10 inSortedRange:a4 options:v11 usingComparator:{v12, v15}];
...
{
  v13 = *a3;
  v8 = [a1 _firstIndexAtOrAfterTime:&v13 startIndex:a4 lastIfEqual:1 timeSelector:a5];
  if (v8 < [a1 count])
  {
