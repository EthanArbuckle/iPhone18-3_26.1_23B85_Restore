@interface PTRandom
+ (double)nextUshort2:(int)ushort2 seed:(std:()32 :()624 mersenne_twister_engine<unsigned)int;
- (PTRandom)initWithSeed:(unsigned int)seed;
- (double)nextGauss;
- (double)nextUshort2:(int)ushort2;
- (id).cxx_construct;
- (unsigned)nextUint:(unsigned int)uint;
@end
...
- (double)nextUshort2:(int)ushort2
{
  v6[0] = 0;
  v6[1] = ushort2;
  v4 = std::uniform_int_distribution<unsigned int>::operator()<std::mersenne_twister_engine<unsigned int,32ul,624ul,397ul,31ul,2567483615u,11ul,4294967295u,7ul,2636928640u,15ul,4022730752u,18ul,1812433253u>>(v6, (self + 8), v6);
  return COERCE_DOUBLE(__PAIR64__(std::uniform_int_distribution<unsigned int>::operator()<std::mersenne_twister_engine<unsigned int,32ul,624ul,397ul,31ul,2567483615u,11ul,4294967295u,7ul,2636928640u,15ul,4022730752u,18ul,1812433253u>>(v6, (self + 8), v6), v4));
}
