...
{
  v4 = a3;
  [v4 encodeBool:-[SUCorePolicyPreflightPersonalize performPhase](self forKey:{"performPhase"), @"PerformPhase"}];
}
...
- (BOOL)isEqual:(id)a3
{
  ...
  else
  {
    ...
    {
      v5 = [(SUCorePolicyPreflightPersonalize *)v4 performPhase];
      v6 = v5 ^ [(SUCorePolicyPreflightPersonalize *)self performPhase]^ 1;
    }
...
- (id)description
{
  ...
  v5 = [(SUCorePolicyPreflightPersonalize *)self basePreflightOptions];
  if (v5)
  {
    v6 = [(SUCorePolicyPreflightPersonalize *)self basePreflightOptions];
  }
  ...
  v7 = [(SUCorePolicyPreflightPersonalize *)self additionalOptions];
  if (v7)
  {
    v8 = [(SUCorePolicyPreflightPersonalize *)self additionalOptions];
    v9 = [v3 stringWithFormat:@"SUCorePolicyPreflightPersonalize(performPhase:%@|basePreflightOptions:%@|additionalOptions:%@)", v4, v6, v8];
  }

  else
  {
    v9 = [v3 stringWithFormat:@"SUCorePolicyPreflightPersonalize(performPhase:%@|basePreflightOptions:%@|additionalOptions:%@)", v4, v6, @"none"];
  }
...
- (id)summary
{
  ...
  v4 = [(SUCorePolicyPreflightPersonalize *)self basePreflightOptions];
  if (v4)
  {
