    ...
    if (v9)
    {
      ...
      do
      {
        ...
        do
        {
          ...
          if (v13)
          {
            v14 = [*(*(&v37 + 1) + 8 * v12) address];
            v15 = [v7 isKnownDevice:v14];

            v16 = [v13 address];
            v17 = [v7 getDeviceNotificationState:v16];

            if ([v13 immediacyType] == 2)
            {
              v18 = [v13 address];
              v36 = [v7 hasStagedImmediateDetections:v18] ^ 1;
            }
    ...
    if (v10)
    {
      ...
      do
      {
        for (i = 0; i != v11; ++i)
        {
          ...
          v14 = *(*(&v21 + 1) + 8 * i);
          v15 = [v14 address];
          v16 = [v7 getDeviceNotificationState:v15];
      ...
      do
      {
        for (i = 0; i != v45; ++i)
        {
          ...
          if (v12)
          {
            ...
            v53 = 0u;
            v15 = [v14 allKeys];
            v16 = [v15 countByEnumeratingWithState:&v52 objects:v65 count:16];
            if (v16)
            {
              v17 = v16;
              v18 = *v53;
              do
              {
                ...
                v17 = [v15 countByEnumeratingWithState:&v52 objects:v65 count:16];
              }
