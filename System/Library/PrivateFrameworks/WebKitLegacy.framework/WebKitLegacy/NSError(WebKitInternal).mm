...
- (uint64_t)_webkit_initWithDomain:()WebKitInternal code:URL:
{
  ...
  v13 = [a5 absoluteString];
  v14 = [v11 dictionaryWithObjectsAndKeys:{a5, v12, v13, @"NSErrorFailingURLStringKey", v10, *MEMORY[0x1E696A578], 0}];

  return [a1 initWithDomain:a3 code:a4 userInfo:v14];
}
