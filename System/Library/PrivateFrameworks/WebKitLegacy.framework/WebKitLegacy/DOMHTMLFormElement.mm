...
- (void)setAcceptCharset:(NSString *)acceptCharset
{
  ...
  WTF::AtomStringImpl::add(&v8, acceptCharset, v4);
  v6 = v8;
...
- (id)autocomplete
{
  ...
  v3 = *WebCore::HTMLFormElement::autocomplete(self->super.super.super.super._internal);
  if (v3)
  {
...
{
  WebCore::JSMainThreadNullState::JSMainThreadNullState(v11);
  v3 = *(self->super.super.super.super._internal + 18);
  if (v3)
  {
    atomic_fetch_add_explicit(v3, 2u, memory_order_relaxed);
    atomic_fetch_add_explicit(v3, 2u, memory_order_relaxed);
...
{
  WebCore::JSMainThreadNullState::JSMainThreadNullState(v7);
  WTF::AtomStringImpl::add(&v8, encoding, v4);
  v6 = v8;
  WebCore::Element::setAttributeWithoutSynchronization();
  if (v6 && atomic_fetch_add_explicit(v6, 0xFFFFFFFE, memory_order_relaxed) == 2)
  {
...
- (NSString)method
{
  ...
  WebCore::HTMLFormElement::method(&v11, self->super.super.super.super._internal);
  v3 = v11;
  if (v11)
  {
...
- (DOMHTMLCollection)elements
{
  ...
  MEMORY[0x1CCA652D0](&v7, self->super.super.super.super._internal);
  v4 = kit(v7);
  v5 = v7;
  v7 = 0;
  if (v5)
