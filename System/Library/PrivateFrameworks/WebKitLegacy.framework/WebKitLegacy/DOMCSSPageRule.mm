...
- (NSString)selectorText
{
  ...
  WebCore::CSSPageRule::selectorText(&v11, self->super.super._internal);
  v3 = v11;
  if (v11)
  {
...
- (void)setSelectorText:(NSString *)selectorText
{
  ...
  WebCore::CSSPageRule::setSelectorText(internal, &v8);
  v7 = v8;
  v8 = 0;
...
- (DOMCSSStyleDeclaration)style
{
  ...
  v3 = WebCore::CSSPageRule::style(self->super.super._internal);
  v4 = kit(v3);
