...
- (TUIMismatchedAppleIDModel)initWithFlow:(unint64_t)a3
{
  ...
  if (v4)
  {
    ...
    v4->_symbolName = @"person.icloud";

    v7 = [MEMORY[0x277CCA8D8] bundleForClass:objc_opt_class()];
    v8 = [v7 localizedStringForKey:@"MISMATCHED_APPLEID_ERROR_TITLE" value:&stru_287F92480 table:@"Localizable"];
    title = v5->_title;
    v5->_title = v8;
    ...
    v16 = [v15 localizedStringForKey:@"MISMATCHED_APPLEID_ERROR_PRIMARY_BUTTON" value:&stru_287F92480 table:@"Localizable"];
