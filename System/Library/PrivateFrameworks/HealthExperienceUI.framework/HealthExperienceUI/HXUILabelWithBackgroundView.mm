...
- (HXUILabelWithBackgroundView)initWithFrame:(CGRect)frame;
- (void)layoutSubviews;
...
- (HXUILabelWithBackgroundView)initWithFrame:(CGRect)frame
{
  ...
  v3 = [(HXUILabelWithBackgroundView *)&v11 initWithFrame:frame.origin.x, frame.origin.y, frame.size.width, frame.size.height];
  if (v3)
  {
    ...
    layer = [(HXUILabelWithBackgroundView *)v3 layer];
    [layer setCornerRadius:8.0];

    tertiarySystemFillColor = [MEMORY[0x1E69DC888] tertiarySystemFillColor];
    [(HXUILabelWithBackgroundView *)v3 setBackgroundColor:tertiarySystemFillColor];
  }
...
- (CGSize)sizeThatFits:(CGSize)fits
{
  ...
  [(UILabel *)self->_label sizeThatFits:v3, fits.height];
  v5 = v4 + 24.0;
  v7 = v6 + 14.0;
  result.height = v7;
  result.width = v5;
