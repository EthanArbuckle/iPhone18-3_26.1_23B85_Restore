...
- (void)addValue:(double)a3 forReferenceMetric:(double)a4 secondaryReferenceMetric:(double)a5
{
  MTMPU::LayoutInterpolator::EntriesContainer::EntriesContainer(v28, a4);
  begin = self->_entriesContainers.__begin_;
  end = self->_entriesContainers.__end_;
  if (end == begin)
  {
  ...
  else
  {
    ...
    if (v16)
    {
      MTMPU::LayoutInterpolator::EntriesContainer::insertEntry(begin, *&v17, &v22);
      v19 = v22;
      v25 = v22;
      __p = v23;
      v27 = v24;
    ...
    {
      MTMPU::LayoutInterpolator::EntriesContainer::insertEntry(v28, *&v17, &v22);
      v19 = v22;
      v25 = v22;
      __p = v23;
      v27 = v24;
  ...
  if ((v19 - 2) >= 3)
  {
    ...
    else if (!v19 && !self->_hasEntryWithSpecificSecondaryReferenceMetric && !MTMPUFloatEqualToFloat(a5, -1.13427449e38))
    {
...
LABEL_10:
  ...
  if (v8 != 32)
  {
    MTMPU::LayoutInterpolator::EntriesContainer::EntriesContainer(__p, a3);
    ...
    if (v26 == v27)
    {
      [(MTMPULayoutInterpolator *)self _interpolatedValueForPrimaryReferenceMetric:v27 - 64 secondaryReferenceMetric:v27 - 32 betweenFirstEntriesContainer:a3 andSecondEntriesContainer:a4];
    }
    ...
    else
    {
      ...
      {
        v34 = MTMPU::LayoutInterpolator::EntriesContainer::valueForSecondaryReferenceMetric(v27, a4);
      }

      else if (self->_entriesContainers.__begin_ == v27)
      {
        [(MTMPULayoutInterpolator *)self _interpolatedValueForPrimaryReferenceMetric:v27 secondaryReferenceMetric:v27 + 32 betweenFirstEntriesContainer:a3 andSecondEntriesContainer:a4];
      }

      else
      {
        [(MTMPULayoutInterpolator *)self _interpolatedValueForPrimaryReferenceMetric:v27 - 32 secondaryReferenceMetric:v27 betweenFirstEntriesContainer:a3 andSecondEntriesContainer:a4];
      }
    }
...
- (double)_interpolatedValueForPrimaryReferenceMetric:(double)a3 secondaryReferenceMetric:(double)a4 betweenFirstEntriesContainer:(void *)a5 andSecondEntriesContainer:(void *)a6
{
  v11 = MTMPU::LayoutInterpolator::EntriesContainer::entriesCount(a5);
  v12 = MTMPU::LayoutInterpolator::EntriesContainer::entriesCount(a6);
  if (v11 == 1 && v12 == 1)
  {
    MTMPU::LayoutInterpolator::EntriesContainer::copyEntriesVector(a5, &v62);
    v13 = *(v62.n128_u64[0] + 8);
    v14 = MTMPU::LayoutInterpolator::EntriesContainer::primaryReferenceMetric(a5);
    MTMPU::LayoutInterpolator::EntriesContainer::copyEntriesVector(a6, &__p);
    v15 = *(__p + 1);
    v16 = MTMPU::LayoutInterpolator::EntriesContainer::primaryReferenceMetric(a6);
...
LABEL_46:
  ...
  {
    v19 = 0.0;
    MTMPU::Point3D::Point3D(&__p, a3, a4, 0.0);
    [(MTMPULayoutInterpolator *)self _sortedPointsFor3DInterpolationFromEntriesContainer:a5 usingQueriedPoint:*&__p fallbackSecondaryReferenceMetric:*&v60, v61, a4];
    [(MTMPULayoutInterpolator *)self _sortedPointsFor3DInterpolationFromEntriesContainer:a6 usingQueriedPoint:*&__p fallbackSecondaryReferenceMetric:*&v60, v61, a4];
    __src = 0;
    v53 = 0;
    v54 = 0;
    v29 = v57;
...
- (vector<MTMPU::Point3D,)_sortedPointsFor3DInterpolationFromEntriesContainer:(MTMPULayoutInterpolator *)self usingQueriedPoint:(SEL)a3 fallbackSecondaryReferenceMetric:(void *)a4
{
  ...
  retstr->var1 = 0;
  retstr->var2 = 0;
  MTMPU::LayoutInterpolator::EntriesContainer::copyEntriesVector(a4, &__p);
  v13 = __p;
  v14 = v22;
  while (v13 != v14)
  {
    [(MTMPULayoutInterpolator *)self _pointForEntry:*v13 andPrimaryReferenceMetric:v13[1] usingFallbackSecondaryReferenceMetric:MTMPU::LayoutInterpolator::EntriesContainer::primaryReferenceMetric(a4), a6];
    v19.n128_u64[0] = v15;
    v19.n128_u64[1] = v16;
    v20 = v17;
...
- (void)_sortPointsFor3DInterpolation:(void *)a3 usingQueriedPoint:(Point3D)a4
{
  ...
  if (v8 >= 2)
  {
    ...
    std::__introsort<std::_ClassicAlgPolicy,[MTMPULayoutInterpolator _sortPointsFor3DInterpolation:usingQueriedPoint:]::$_2 &,MTMPU::Point3D *,false>(v6, v7, &v11.var0, v10, 1);
  }
}
          ...
          if (v12 > 2)
          {
            switch(v12)
            {
              case 3:
                ...
                std::__sort3[abi:ne200100]<std::_ClassicAlgPolicy,-[MTMPULayoutInterpolator _sortPointsFor3DInterpolation:usingQueriedPoint:]::$_2 &,MTMPU::Point3D *,0>(v10, (v10 + 24), (a2 - 24), a3);
                return;
              case 4:
                std::__sort3[abi:ne200100]<std::_ClassicAlgPolicy,-[MTMPULayoutInterpolator _sortPointsFor3DInterpolation:usingQueriedPoint:]::$_2 &,MTMPU::Point3D *,0>(v10, (v10 + 24), (v10 + 48), a3);
                v65 = *(a2 - 24);
                v66 = *(a2 - 16);
                v64 = a2 - 24;
                v67 = a3[1];
              ...
              case 5:
                ...
                std::__sort5[abi:ne200100]<std::_ClassicAlgPolicy,-[MTMPULayoutInterpolator _sortPointsFor3DInterpolation:usingQueriedPoint:]::$_2 &,MTMPU::Point3D *,0>(v10, v10 + 24, v10 + 48, v10 + 72, a2 - 24, a3);
                return;
            }
          }
...
LABEL_79:
          ...
          if (v11 < 0xC01)
          {
            std::__sort3[abi:ne200100]<std::_ClassicAlgPolicy,-[MTMPULayoutInterpolator _sortPointsFor3DInterpolation:usingQueriedPoint:]::$_2 &,MTMPU::Point3D *,0>((a1 + 24 * v13), a1, (a2 - 24), a3);
          }

          else
          {
            std::__sort3[abi:ne200100]<std::_ClassicAlgPolicy,-[MTMPULayoutInterpolator _sortPointsFor3DInterpolation:usingQueriedPoint:]::$_2 &,MTMPU::Point3D *,0>(a1, (a1 + 24 * v13), (a2 - 24), a3);
            v15 = 3 * v13;
            v16 = (a1 + 24 * v13 - 24);
            std::__sort3[abi:ne200100]<std::_ClassicAlgPolicy,-[MTMPULayoutInterpolator _sortPointsFor3DInterpolation:usingQueriedPoint:]::$_2 &,MTMPU::Point3D *,0>((a1 + 24), v16, (a2 - 48), a3);
            v17 = (a1 + 24 + 8 * v15);
            std::__sort3[abi:ne200100]<std::_ClassicAlgPolicy,-[MTMPULayoutInterpolator _sortPointsFor3DInterpolation:usingQueriedPoint:]::$_2 &,MTMPU::Point3D *,0>((a1 + 48), v17, (a2 - 72), a3);
            std::__sort3[abi:ne200100]<std::_ClassicAlgPolicy,-[MTMPULayoutInterpolator _sortPointsFor3DInterpolation:usingQueriedPoint:]::$_2 &,MTMPU::Point3D *,0>(v16, v14, v17, a3);
            v140 = *(a1 + 16);
            v134 = *a1;
            v18 = *(v14 + 16);
            *a1 = *v14;
...
LABEL_36:
        std::__introsort<std::_ClassicAlgPolicy,[MTMPULayoutInterpolator _sortPointsFor3DInterpolation:usingQueriedPoint:]::$_2 &,MTMPU::Point3D *,false>(a1, v10 - 24, a3, a4, a5 & 1);
        a5 = 0;
      }

      v42 = std::__insertion_sort_incomplete[abi:ne200100]<std::_ClassicAlgPolicy,-[MTMPULayoutInterpolator _sortPointsFor3DInterpolation:usingQueriedPoint:]::$_2 &,MTMPU::Point3D *>(a1, v10 - 24, a3);
      if (std::__insertion_sort_incomplete[abi:ne200100]<std::_ClassicAlgPolicy,-[MTMPULayoutInterpolator _sortPointsFor3DInterpolation:usingQueriedPoint:]::$_2 &,MTMPU::Point3D *>(v10, a2, a3))
      {
        break;
      }
