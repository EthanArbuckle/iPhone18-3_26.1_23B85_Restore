...
- (double)preferredFontAscender
{
  ...
  {
    v3 = [(MTMPUFontDescriptor *)self preferredFont];
    [v3 ascender];
...
- (double)defaultFontAscender
{
  ...
  {
    v3 = [(MTMPUFontDescriptor *)self defaultFont];
    [v3 ascender];
...
- (id)_preferredFontDescriptorForTextStyle:(int64_t)a3
{
  ...
  if ((a3 - 19) >= 2)
  {
    ...
    {
LABEL_2:
      v3 = [(MTMPUFontDescriptor *)self _defaultFontDescriptorForTextStyle:a3];
      goto LABEL_11;
    }
  ...
  {
    v4 = [(MTMPUFontDescriptor *)self _fontPointSizeLayoutInterpolator];
