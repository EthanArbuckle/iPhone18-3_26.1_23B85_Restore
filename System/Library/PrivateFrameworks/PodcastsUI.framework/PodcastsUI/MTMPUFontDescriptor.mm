...
{
  v7.receiver = self;
  v7.super_class = MTMPUFontDescriptor;
...
- (void)dealloc
{
  ...
  v5.receiver = self;
  v5.super_class = MTMPUFontDescriptor;
...
- (id)description
{
  ...
  v14 = 0;
  v7 = _MTMPUFontTextStyleGetDescriptionAndCustomStyleStatus(self->_textStyle, &v14);
  ...
  if (weight)
  {
    v9 = MTMPUFontWeightGetDescription(weight);
    v10 = v9;
    if (v9)
    {
...
- (BOOL)isEqual:(id)equal
{
  ...
  else
  {
    ...
    if (objc_opt_isKindOfClass())
    {
      v5 = equalCopy;
      v6 = v5;
      v7 = self->_textStyle == v5->_textStyle && self->_weight == v5->_weight && self->_leadingAdjustment == v5->_leadingAdjustment && self->_usesItalic == v5->_usesItalic && self->_usesCondensedMetrics == v5->_usesCondensedMetrics && self->_wantsMonospaceNumbers == v5->_wantsMonospaceNumbers && MTMPUFloatEqualToFloat(self->_systemFontSize, v5->_systemFontSize) && MTMPUFloatEqualToFloat(self->_defaultPointSizeAdjustment, v6[1]);
    }
...
- (id)typeSafeCopy
{
  v2 = [(MTMPUFontDescriptor *)self copy];
...
- (UIFont)preferredFont
{
  ...
  if (!preferredFont)
  {
    ...
    v7[3] = &unk_2782BEA30;
    v7[4] = self;
    v4 = [(MTMPUFontDescriptor *)self _fontWithBaseNativeFontDescriptorProvider:v7];
...
- (double)preferredFontAscender
{
  ...
  {
    preferredFont = [(MTMPUFontDescriptor *)self preferredFont];
...
- (double)defaultFontAscender
{
  ...
  {
    defaultFont = [(MTMPUFontDescriptor *)self defaultFont];
...
- (id)_fontWithBaseNativeFontDescriptorProvider:(id)provider
{
  ...
  if (!MTMPUFloatEqualToFloat(self->_defaultPointSizeAdjustment, 0.0))
  {
    v15 = [(MTMPUFontDescriptor *)self _defaultFontDescriptorForTextStyle:self->_textStyle];
...
- (id)_preferredFontDescriptorForTextStyle:(int64_t)style
{
  ...
  if ((style - 19) >= 2)
  {
    ...
    {
LABEL_2:
      fontDescriptor = [(MTMPUFontDescriptor *)self _defaultFontDescriptorForTextStyle:style];
      goto LABEL_11;
    }
  ...
  {
    _fontPointSizeLayoutInterpolator = [(MTMPUFontDescriptor *)self _fontPointSizeLayoutInterpolator];
    nSClassFromString(&cfstr_Uiapplication.isa) = [NSClassFromString(&cfstr_Uiapplication.isa) sharedApplication];
    v6 = nSClassFromString(&cfstr_Uiapplication.isa);
    if (nSClassFromString(&cfstr_Uiapplication.isa))
    {
      preferredContentSizeCategory = [nSClassFromString(&cfstr_Uiapplication.isa) preferredContentSizeCategory];
    }

    else
    {
      preferredContentSizeCategory = *MEMORY[0x277D76838];
    }

    v8 = preferredContentSizeCategory;

    [objc_opt_class() _layoutInterpolatorReferenceMetricForContentSizeCategory:v8];
    [_fontPointSizeLayoutInterpolator valueForReferenceMetric:?];
    v9 = [MEMORY[0x277D74300] systemFontOfSize:?];
