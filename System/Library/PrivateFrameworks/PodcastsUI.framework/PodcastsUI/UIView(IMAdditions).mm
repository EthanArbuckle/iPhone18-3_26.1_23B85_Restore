...
- (void)debugHighlightViewBlue
{
  v2 = [MEMORY[0x277D75348] blueColor];
  [a1 debugHighlightViewWithColor:v2 width:2.0];
}
...
- (id)imageSnapshot
{
  ...
  if (v2 <= 0.0 || ([a1 bounds], v3 <= 0.0))
  {
    ...
    [v12 logFile:"/Library/Caches/com.apple.xbs/Sources/PodcastsUI/PodcastsUI/PodcastsUI/Extensions/UIKit/UIView+IMAdditions.m" lineNumber:66 format:{@"Snapshotting a CGSizeZero view: %@", a1}];
...
- (id)debugingBorderColor
{
  ...
  v2 = [a1 layer];
  v3 = [v1 colorWithCGColor:{objc_msgSend(v2, "borderColor")}];
...
- (BOOL)isViewSizeFullScreenInWindow:()IMAdditions ignoreInWindowCheck:
{
  ...
  if (v6)
  {
    ...
    if (v15)
    {
      [a1 convertRect:v6 toView:{v13, v14, v10, v12}];
...
- (double)adjustRectCenter:()IMAdditions fromView:
{
  ...
  [a1 convertPoint:v12 fromView:{MidX, MidY}];
  v16 = v15;
  v18 = v17;
