...
- (_TtC10PodcastsUI17ModalSheetWrapper)initWithCoder:(id)coder;
- (void)loadView;
- (void)viewDidLoad;
...
- (void)loadView
{
  ...
  *(v6 + 3) = v3;
  ...
  [(ModalSheetWrapper *)selfCopy setView:v8, v9.receiver, v9.super_class];
}
...
- (void)viewWillAppear:(BOOL)appear
{
  ...
  v4 = v7.receiver;
  [(ModalSheetWrapper *)&v7 viewWillAppear:appearCopy];
