...
- (id)description
{
  ...
  v8.receiver = self;
  v8.super_class = _MRVolumeMutedDidChangeMessageProtobuf;
  v4 = [(_MRVolumeMutedDidChangeMessageProtobuf *)&v8 description];
  dictionaryRepresentation = [(_MRVolumeMutedDidChangeMessageProtobuf *)self dictionaryRepresentation];
...
- (void)mergeFrom:(id)from
{
  ...
  {
    v5 = fromCopy;
    [(_MRVolumeMutedDidChangeMessageProtobuf *)self setOutputDeviceUID:?];
    fromCopy = v5;
  }
}
