...
- (id)description
{
  ...
  v8.receiver = self;
  v8.super_class = _MRUpdateClientMessageProtobuf;
  v4 = [(_MRUpdateClientMessageProtobuf *)&v8 description];
  dictionaryRepresentation = [(_MRUpdateClientMessageProtobuf *)self dictionaryRepresentation];
...
- (void)mergeFrom:(id)from
{
  ...
  else
  {
    ...
    v7 = fromCopy;
    [(_MRUpdateClientMessageProtobuf *)self setClient:?];
  }
