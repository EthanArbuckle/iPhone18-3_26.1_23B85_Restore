...
- (void)copyTo:(id)a3
{
  ...
  {
    [v8 clearEndpoints];
    v4 = [(_MRDiscoveryUpdateEndpointsProtobufMessage *)self endpointsCount];
    if (v4)
    {
      v5 = v4;
      for (i = 0; i != v5; ++i)
...
{
  v4 = a3;
  if ([v4 isMemberOfClass:objc_opt_class()] && ((endpoints = self->_endpoints, !(endpoints | v4[2])) || -[NSMutableArray isEqual:](endpoints, "isEqual:")))
  {
    configuration = self->_configuration;
