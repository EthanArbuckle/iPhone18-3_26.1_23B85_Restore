...
- (id)description
{
  ...
  v8.receiver = self;
  v8.super_class = _MRRemoveClientMessageProtobuf;
  v4 = [(_MRRemoveClientMessageProtobuf *)&v8 description];
  dictionaryRepresentation = [(_MRRemoveClientMessageProtobuf *)self dictionaryRepresentation];
...
- (void)mergeFrom:(id)from
{
  ...
  else
  {
    ...
    v7 = fromCopy;
    [(_MRRemoveClientMessageProtobuf *)self setClient:?];
  }
