...
- (id)description
{
  ...
  dictionaryRepresentation = [(_MRAudioTimeProtobuf *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  if (has)
  {
    ...
    [dictionary setObject:v6 forKey:@"sampleRate"];
  }
...
LABEL_11:
  ...
  if (*&self->_has)
  {
    if ((*(equalCopy + 24) & 1) == 0 || self->_sampleRate != *(equalCopy + 1))
    {
      goto LABEL_11;
    }
