...
- (id)description
{
  ...
  v8.receiver = self;
  v8.super_class = _MRSetNowPlayingPlayerMessageProtobuf;
  v4 = [(_MRSetNowPlayingPlayerMessageProtobuf *)&v8 description];
  dictionaryRepresentation = [(_MRSetNowPlayingPlayerMessageProtobuf *)self dictionaryRepresentation];
...
- (void)mergeFrom:(id)from
{
  ...
  else
  {
    ...
    v7 = fromCopy;
    [(_MRSetNowPlayingPlayerMessageProtobuf *)self setPlayerPath:?];
  }
