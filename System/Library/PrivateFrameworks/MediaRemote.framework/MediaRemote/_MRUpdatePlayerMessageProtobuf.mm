...
- (id)description
{
  ...
  v8.receiver = self;
  v8.super_class = _MRUpdatePlayerMessageProtobuf;
  v4 = [(_MRUpdatePlayerMessageProtobuf *)&v8 description];
  dictionaryRepresentation = [(_MRUpdatePlayerMessageProtobuf *)self dictionaryRepresentation];
...
- (void)mergeFrom:(id)from
{
  ...
  else
  {
    ...
    v7 = fromCopy;
    [(_MRUpdatePlayerMessageProtobuf *)self setPlayerPath:?];
  }
