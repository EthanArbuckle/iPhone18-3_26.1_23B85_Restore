uint64_t SiriCoreMetricsPlugin.perform(_:)(void *a1)
{
  ...
  v10 = type metadata accessor for SiriCoreMetrics();
  v11 = *(v10 + 48);
  v12 = *(v10 + 52);
  v13 = swift_allocObject();
  v14 = SiriCoreMetrics.init(bookmarkLocation:conversationType:)();
  if (!v2)
  {
    v22[1] = v14;
    v15 = __swift_instantiateConcreteTypeFromMangledNameV2(&_s18lighthouse_runtime26LighthouseRuntimeProcessorCy15SiriCoreMetricsADCGMd, &_s18lighthouse_runtime26LighthouseRuntimeProcessorCy15SiriCoreMetricsADCGMR);
    v16 = *(v15 + 48);
    v17 = *(v15 + 52);
    swift_allocObject();
    v18 = a1;
    ...
    if (v19)
    {
      v20 = *(v3 + OBJC_IVAR___SiriCoreMetricsPlugin_processor);
      *(v3 + OBJC_IVAR___SiriCoreMetricsPlugin_processor) = v19;
...
Swift::Void __swiftcall SiriCoreMetricsPlugin.stop()()
{
  ...
  {
    v5 = *(v1 + OBJC_IVAR___SiriCoreMetricsPlugin_processor);
...
id SiriCoreMetricsPlugin.init()()
{
  ...
  *&v0[OBJC_IVAR___SiriCoreMetricsPlugin_processor] = 0;
  v2.receiver = v0;
  v2.super_class = type metadata accessor for SiriCoreMetricsPlugin();
