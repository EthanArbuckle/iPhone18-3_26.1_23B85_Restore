  ...
  if (v5)
  {
    ...
    do
    {
      for (i = 0; i != v6; ++i)
      {
        ...
        deviceInfoDict = [*(*(&v12 + 1) + 8 * i) deviceInfoDict];
...
- (void)startCollectingCounters
{
  ...
  if (collectingDataSources && [(NSMutableDictionary *)collectingDataSources count])
  {
    ...
    v5 = [allValues countByEnumeratingWithState:&v62 objects:v70 count:16];
    if (v5)
    {
      v6 = v5;
      LOBYTE(v7) = 0;
      ...
      do
      {
        ...
        v6 = [allValues countByEnumeratingWithState:&v62 objects:v70 count:16];
      }
    ...
    if (v57)
    {
      ...
      do
      {
        for (j = 0; j != v57; ++j)
        {
          ...
          v14 = *(*(&v58 + 1) + 8 * j);
          collectingProfile = [v14 collectingProfile];
          ...
          if (isAPS)
          {
            ...
            device = [v14 device];
            v20 = [v18 numberWithUnsignedLongLong:{objc_msgSend(device, "registryID")}];
            v68[2] = v20;
            v21 = MEMORY[0x277CCABB0];
            collectingProfile2 = [v14 collectingProfile];
            v23 = [v21 numberWithUnsignedInteger:{objc_msgSend(collectingProfile2, "profile")}];
            v68[3] = v23;
            collectingProfile3 = [v14 collectingProfile];
            counterProfileForHost = [collectingProfile3 counterProfileForHost];
            v68[4] = counterProfileForHost;
            counterProfileForHost3 = [MEMORY[0x277CBEA60] arrayWithObjects:v68 count:5];

            selfCopy = v56;
            [(DTGPUService *)v56 _sendMessage:counterProfileForHost3];
          }
          ...
          else
          {
            if (selfCopy->_enableMultiSourceCounters)
            {
              ...
              device2 = [v14 device];
              v50 = [v27 numberWithUnsignedLongLong:{objc_msgSend(device2, "registryID")}];
              v67[2] = v50;
              v28 = MEMORY[0x277CCABB0];
              collectingProfile4 = [v14 collectingProfile];
              v30 = [v28 numberWithUnsignedInteger:{objc_msgSend(collectingProfile4, "profile")}];
              v67[3] = v30;
              collectingProfile5 = [v14 collectingProfile];
              counterProfileForHost2 = [collectingProfile5 counterProfileForHost];
              v67[4] = counterProfileForHost2;
              collectingProfile6 = [v14 collectingProfile];
              sampleSizes = [collectingProfile6 sampleSizes];
              v67[5] = sampleSizes;
              collectingProfile7 = [v14 collectingProfile];
              ringBufferCounts = [collectingProfile7 ringBufferCounts];
              v67[6] = ringBufferCounts;
              counterProfileForHost3 = [MEMORY[0x277CBEA60] arrayWithObjects:v67 count:7];
            ...
            {
              collectingProfile8 = [v14 collectingProfile];
              counterProfileForHost3 = [collectingProfile8 counterProfileForHost];

              collectingProfile9 = [v14 collectingProfile];
              ...
              if ([counterProfileForHost3 count])
              {
                if ([ringBufferCounts2 count])
                {
                  ...
                  device3 = [v14 device];
                  v42 = [v40 numberWithUnsignedLongLong:{objc_msgSend(device3, "registryID")}];
                  v66[2] = v42;
                  v43 = MEMORY[0x277CCABB0];
                  collectingProfile10 = [v14 collectingProfile];
                  v45 = [v43 numberWithUnsignedInteger:{objc_msgSend(collectingProfile10, "profile")}];
                  v66[3] = v45;
                  v46 = [counterProfileForHost3 objectAtIndexedSubscript:0];
                  v66[4] = v46;
                  v47 = [ringBufferCounts2 objectAtIndexedSubscript:0];
                  v66[5] = v47;
...
- (id)stopCollectingCounters
{
  ...
  v26 = 0u;
  allValues = [(NSMutableDictionary *)self->_collectingDataSources allValues];
  v4 = [allValues countByEnumeratingWithState:&v23 objects:v28 count:16];
  if (v4)
  {
    v5 = v4;
    v6 = *v24;
  ...
  v9 = [allValues2 countByEnumeratingWithState:&v19 objects:v27 count:16];
  if (v9)
  {
    v10 = v9;
    v11 = *v20;
    ...
    do
    {
      for (j = 0; j != v10; ++j)
      {
        ...
        timestampOfFirstSample = [*(*(&v19 + 1) + 8 * j) timestampOfFirstSample];
      ...
      v10 = [allValues2 countByEnumeratingWithState:&v19 objects:v27 count:16];
    }
  ...
  if (v5)
  {
    ...
    do
    {
      for (i = 0; i != v6; ++i)
      {
        ...
        currentConsistentGPUPerformanceState = [*(*(&v12 + 1) + 8 * i) currentConsistentGPUPerformanceState];
