        ...
        if (der_utils_encode_fv_data(&v66))
        {
          if (der_utils_encode_fv_params(&v66))
          {
            ...
            if (ccder_blob_encode_tl())
            {
              ...
              v69[1] = v67;
              v69[2] = &v71 - v67;
              if (!OUTLINED_FUNCTION_1_11(v17, 0x4Cu, v69, 3u, v18, v19, v20, v21, v70, &v68))
              {
                OUTLINED_FUNCTION_2_4();
        ...
        if (der_utils_encode_fv_data(&v28))
        {
          if (der_utils_encode_fv_params(&v28))
          {
            ...
            if (ccder_blob_encode_tl())
            {
              v31[0] = v29;
              v31[1] = &v33 - v29;
              if (!OUTLINED_FUNCTION_1_11(v9, 0x63u, v31, 2u, v10, v11, v12, v13, v32, &v30))
              {
                *&v27 = v32;
                *(&v27 + 1) = &v32[v30];
                OUTLINED_FUNCTION_2_4();
            ...
            if (der_utils_encode_fv_data(v69))
            {
              if (der_utils_encode_fv_params(v69))
              {
                ...
                if (ccder_blob_encode_tl())
                {
                  ...
                  if (!OUTLINED_FUNCTION_1_11(v11, 0x4Du, v70, 2u, v20, v21, v22, v23, v71, v24))
                  {
                    OUTLINED_FUNCTION_2_4();
...
void aks_fv_set_protection()
{
  ...
  if (aks_client_connection)
  {
    ...
    if (!der_utils_encode_fv_data(&v25) || !der_utils_encode_fv_data(&v25) || !der_utils_encode_fv_data(&v25) || !der_utils_encode_fv_params(&v25) || (OUTLINED_FUNCTION_2_4(), !ccder_blob_encode_tl()) || (v28[0] = v5, v28[1] = v3, v28[2] = v26, v28[3] = v30 - v26, !OUTLINED_FUNCTION_1_11(v7, 0x54u, v28, 4u, v8, v9, v10, v11, v29, &v27)) && v27 && ((OUTLINED_FUNCTION_2_4(), !ccder_blob_decode_range()) || v0 && (OUTLINED_FUNCTION_15_3(), (der_utils_decode_fv_data(v12, v13, v14) & 1) == 0)))
    {
...
void aks_fv_unwrap_vek_with_acm()
{
  ...
  *(v2 - 96) = *MEMORY[0x1E69E9840];
  ...
  if (v1)
  {
    ...
    {
      v7 = aks_client_connection;
      if (!der_utils_encode_fv_data(&v26) || !der_utils_encode_fv_data(&v26) || !der_utils_encode_fv_data(&v26) || !der_utils_encode_fv_data(&v26) || !der_utils_encode_fv_params(&v26) || (OUTLINED_FUNCTION_2_4(), !ccder_blob_encode_tl()) || (v29[0] = v27, v29[1] = &v31[-v27], v29[2] = v5, !OUTLINED_FUNCTION_1_11(v7, 0x4Bu, v29, 3u, v8, v9, v10, v11, v30, &v28)) && ((OUTLINED_FUNCTION_2_4(), !ccder_blob_decode_range()) || v0 && (OUTLINED_FUNCTION_15_3(), (der_utils_decode_fv_key(v12, v13, v14) & 1) == 0)))
      {
        OUTLINED_FUNCTION_10_3();
      }
    }
...
uint64_t wrap_backup_bag(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4)
{
  ...
  *(a4 + 80) = 1;
  ...
  OUTLINED_FUNCTION_0_17(v9, v10, v11, v12, v13, v14, v15, v16, v20, v21, __s[0]);
  v18 = *MEMORY[0x1E69E9840];
  return v17;
}
...
LABEL_8:
  OUTLINED_FUNCTION_0_17(a1, a2, a3, a4, a5, a6, a7, a8, v17, v18, __s[0]);
  v15 = *MEMORY[0x1E69E9840];
  return v14;
}
  ...
  if (aks_client_connection)
  {
    ...
    if (der_utils_encode_fv_data(&v27))
    {
      ...
      if (ccder_blob_encode_tl())
      {
        ...
        v29[5] = v28;
        v29[6] = &v31 - v28;
        OUTLINED_FUNCTION_1_11(v12, 0x21u, v29, 7u, v13, v14, v15, v16, 0, 0);
      }
    }
  }
  ...
  if ((v10 || !a3) && a4 && a5)
  {
    ...
    if (aks_client_connection)
    {
      ...
      if (!encode_list_add_data() && !encode_list_add_data() && !encode_list_add_number(&v40, der_key_config_prederived_iterations, *(a5 + 4)) && !encode_list_add_number(&v40, der_key_config_prederived_type, *(a5 + 24)) && (a3 < 1 || !encode_list_add_data()) && !encode_list_is_empty(&v40) && !encode_list_dict(&v40, v42, &__n))
      {
        ...
        v5 = OUTLINED_FUNCTION_1_11(v12, 0x1Eu, v15, 3u, v16, v17, v18, v19, v26, v28);
      }
    }
...
LABEL_24:
                        if (!encode_list_dict(&v62, v64, &__n))
                        {
                          ...
                          v4 = OUTLINED_FUNCTION_1_11(v9, 0x1Eu, v37, 3u, v38, v39, v40, v41, v48, v50);
                        }
                      }
                    }
                  }
  ...
  if (v1)
  {
    ...
    if (v2)
    {
      ...
      if (aks_client_connection)
      {
        v7 = aks_client_connection;
        bzero(v39, 0x100uLL);
        result = OUTLINED_FUNCTION_1_11(v7, 0x31u, v38, 2u, v8, v9, v10, v11, v39, &__count);
        if (!result)
        {
          if (__count > 0x100)
          {
...
uint64_t remote_session_operate(uint64_t a1)
{
  ...
  if (aks_client_connection)
  {
    ...
    v16 = OUTLINED_FUNCTION_1_11(v11, v7, v32, 3u, v12, v13, v14, v15, __src, &__count);
    if (v16)
    {
      v7 = v16;
    }
  ...
  if (aks_client_connection)
  {
    ...
    if (v1)
    {
      if (v0)
      {
        ...
        OUTLINED_FUNCTION_45();
        if (!OUTLINED_FUNCTION_1_11(v16, 0x14u, v17, 2u, v18, v19, v20, v21, v37, v40))
        {
          if (v3)
          {
            v22 = calloc(v3, 1uLL);
...
void aks_set_backup_bag()
{
  ...
  if (aks_client_connection)
  {
    ...
    v35[3] = v9;
    v35[4] = v7;
    v22 = OUTLINED_FUNCTION_1_11(v14, 0x15u, v35, 5u, v18, v19, v20, v21, v15, p_count);
    if (v5 && !v22)
    {
      v23 = calloc(__count, 1uLL);
      *v5 = v23;
...
void _aks_se_get_reset_token_for_memento_secret()
{
  ...
  if (aks_client_connection)
  {
    if (!OUTLINED_FUNCTION_1_11(aks_client_connection, 0x48u, v30, 4u, v8, v9, v10, v11, v29, __n))
    {
  ...
  if (!se_derivation_request_serialize(v12, v10, v8, v6, v4, v17, v15))
  {
    ...
    if (v2)
    {
      ...
      if (v41)
      {
        ...
        if (aks_client_connection)
        {
          if (!OUTLINED_FUNCTION_1_11(aks_client_connection, 0x9Bu, v43, 3u, v22, v23, v24, v25, v44, &v42))
          {
            v26 = calloc(v42, 1uLL);
            *v2 = v26;
            if (v26)
...
void aks_get_icsc_srp(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, uint64_t a7, uint64_t a8, uint64_t a9, uint64_t a10, uint64_t a11, uint64_t a12, uint64_t a13, uint64_t a14, uint64_t a15, uint64_t a16, uint64_t a17, uint64_t a18, uint64_t a19, uint64_t a20, __int128 a21, __int128 a22, uint64_t a23, void *a24, size_t *a25)
{
  ...
  else
  {
    ...
    if (a25)
    {
      ...
      if (aks_client_connection)
      {
        if (!OUTLINED_FUNCTION_1_11(aks_client_connection, 0x9Fu, &v65, 3u, v42, v43, v44, v45, __src, &__count))
        {
...
void aks_bak_get_swizzler_internal()
{
  ...
  if (aks_client_connection)
  {
    if (!OUTLINED_FUNCTION_1_11(aks_client_connection, 0x87u, v35, 2u, v11, v12, v13, v14, v30, &v29))
    {
      __memcpy_chk();
...
uint64_t aks_get_cx_window(uint64_t a1)
{
  ...
  if (v1)
  {
    ...
    if (aks_client_connection)
    {
      v4 = aks_client_connection;
      bzero(v21, 0x1000uLL);
      result = OUTLINED_FUNCTION_1_11(v4, 0x98u, 0, 0, v5, v6, v7, v8, v21, &v20);
      if (!result)
      {
        if (v20 == 8)
        {
...
void AKSGetStashStats()
{
  ...
  if (aks_client_connection)
  {
    v10 = aks_client_connection;
    bzero(v29, 0x1000uLL);
    if (!OUTLINED_FUNCTION_1_11(v10, 0x9Eu, 0, 0, v11, v12, v13, v14, v29, &v28) && !stash_stats_deserialize(v29, v28, &v25))
    {
      if (v8)
      {
        *v8 = *(&v27 + 1);
...
LABEL_45:
  if ((a3 & 8) != 0)
  {
    OUTLINED_FUNCTION_0_17(a1, a2, a3, a4, a5, a6, a7, a8, v48, v49, v50[0]);
  }
    ...
    if (*a7 >= 0x20)
    {
      *v49 = 0uLL;
      ...
      else if (a5 == 72)
      {
        ...
        if (v31)
        {
          OUTLINED_FUNCTION_0_17(v31, v32, v33, v34, v35, v36, v37, v38, v47, v48, v49[0]);
LABEL_42:
          v8 = 4294967277;
          goto LABEL_37;
        }
...
{
  if (MEMORY[0x1B27239C0](a1, a3, a4, a2))
  {
    return 0;
  }
...
uint64_t encode_list_add_BOOL()
{
  ...
  if (v0)
  {
    ...
    if (v2)
    {
      ...
      {
        v8 = v7;
        if (ccder_blob_encode_body() && ccder_blob_encode_tl() && (v9 = v4 + *(v3 + 1), ccder_blob_encode_body(), OUTLINED_FUNCTION_8_5(), OUTLINED_FUNCTION_2_4(), ccder_blob_encode_tl(), OUTLINED_FUNCTION_8_5(), v10 == v8) && (v11 = OUTLINED_FUNCTION_26_1()) != 0)
        {
...
LABEL_8:
  ...
  if (a1 && a2)
  {
    ...
    if (v16)
    {
      ...
      while (v18);
      if ((ccder_blob_encode_body() & 1) != 0 && ccder_blob_encode_tl() && (v19 = v13 + *(a2 + 1), ccder_blob_encode_body(), OUTLINED_FUNCTION_5_5(), OUTLINED_FUNCTION_2_4(), ccder_blob_encode_tl(), OUTLINED_FUNCTION_5_5(), v20 == v17) && OUTLINED_FUNCTION_26_1())
      {
...
uint64_t decode_icsc_params_internal(int a1, int a2, void *__s)
{
  ...
  if (__s)
  {
    ...
    if (v4)
    {
      v12 = OUTLINED_FUNCTION_2_6(v4, v5, v6, v7, v8, v9, v10, v11, 6, 0, 0, &v72, v69, v70, v71);
      *(v13 + 24) = v12;
      *__s = v14;
      __s[1] = v15;
    }
    ...
    if (v16)
    {
      v24 = OUTLINED_FUNCTION_2_6(v16, v17, v18, v19, v20, v21, v22, v23, v66, *(&v66 + 1), v67, v68, v69, v70, v71);
      v25[4] = v24;
      __s[2] = v26;
      __s[3] = v27;
    }
    ...
    if (v28)
    {
      v36 = OUTLINED_FUNCTION_2_6(v28, v29, v30, v31, v32, v33, v34, v35, v66, *(&v66 + 1), v67, v68, v69, v70, v71);
      *(v37 + 104) = v36;
      __s[4] = v38;
      __s[5] = v39;
    }
    ...
    if (v40)
    {
      v48 = OUTLINED_FUNCTION_2_6(v40, v41, v42, v43, v44, v45, v46, v47, v66, *(&v66 + 1), v67, v68, v69, v70, v71);
      v49[9] = v48;
      __s[6] = v50;
      __s[7] = v51;
    }
    ...
    if (v52)
    {
      v60 = OUTLINED_FUNCTION_2_6(v52, v53, v54, v55, v56, v57, v58, v59, v66, *(&v66 + 1), v67, v68, v69, v70, v71);
      *(v61 + 184) = v60;
      __s[8] = v62;
      __s[9] = v63;
    }
