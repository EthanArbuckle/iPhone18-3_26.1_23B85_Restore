      ...
      if (v10)
      {
        ...
        while (2)
        {
          ...
          do
          {
            ...
            v15 = [a1 unc_isVibrationEnabledForAlertType:v7 topic:v14];
...
LABEL_14:
    ...
    {
      v16 = [a1 unc_isVibrationEnabledForAlertType:v7 topic:0];
    }
  }
...
- (uint64_t)unc_isVibrationEnabledForAlertConfiguration:()BulletinBoard
{
  v1 = [a1 unc_vibrationIdentifierForAlertConfiguration:?];
  v2 = [v1 isEqualToString:*MEMORY[0x1E69DA930]];
