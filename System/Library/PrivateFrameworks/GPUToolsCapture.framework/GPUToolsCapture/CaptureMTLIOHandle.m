...
- (void)dealloc
{
  ...
  *(v4 + 13) = v5;
  v9 = [(CaptureMTLIOHandle *)self traceStream];
  if (v9)
  {
    var0 = v9->var0;
  }
  ...
  *(v15 + 15) |= 8u;
  ...
  v13.receiver = self;
  v13.super_class = CaptureMTLIOHandle;
  [(CaptureMTLIOHandle *)&v13 dealloc];
}
...
- (BOOL)conformsToProtocol:(id)a3
{
  ...
  v4 = a3;
  v5 = [(MTLIOHandleSPI *)baseObject conformsToProtocol:v4];
...
- (void)setLabel:(id)a3
{
  ...
  *(v6 + 13) = v7;
  v11 = [(CaptureMTLIOHandle *)self traceStream];
  if (v11)
  {
    var0 = v11->var0;
  }
