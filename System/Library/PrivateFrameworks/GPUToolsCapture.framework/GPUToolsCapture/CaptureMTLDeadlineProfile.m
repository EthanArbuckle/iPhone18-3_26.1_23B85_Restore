...
- (void)dealloc
{
  ...
  *(v4 + 13) = v5;
  v9 = [(CaptureMTLDeadlineProfile *)self traceStream];
  if (v9)
  {
    var0 = v9->var0;
  }
  ...
  *(v15 + 15) |= 8u;
  ...
  v13.receiver = self;
  v13.super_class = CaptureMTLDeadlineProfile;
  [(CaptureMTLDeadlineProfile *)&v13 dealloc];
}
...
- (BOOL)conformsToProtocol:(id)a3
{
  ...
  v4 = a3;
  v5 = [(MTLDeadlineProfile *)baseObject conformsToProtocol:v4];
