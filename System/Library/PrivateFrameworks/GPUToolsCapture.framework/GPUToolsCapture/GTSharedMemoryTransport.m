...
LABEL_16:
    ...
    else if (([v8 _clientConnect:&v13] & 1) == 0)
    {
      v9 = *(a1 + 32);
      if (v9[304] != 1)
      {
...
LABEL_17:
    [*(a1 + 40) setError:v13];
    return [*(a1 + 40) setResult:{+[NSNumber numberWithBool:](NSNumber, "numberWithBool:", v10)}];
  }

  [*(a1 + 40) setError:{+[GTError_capture errorWithDomain:code:userInfo:](GTError_capture, "errorWithDomain:code:userInfo:", @"DYErrorDomain", 32, 0)}];
  v3 = 0;
LABEL_3:
  ...
  *(*(a1 + 32) + 304) = 0;
  ...
  if (result)
  {
    ...
    do
    {
      ...
      v11 = [v5 replyBlock];
      v13.receiver = v6;
      v13.super_class = GTSharedMemoryTransport_capture;
