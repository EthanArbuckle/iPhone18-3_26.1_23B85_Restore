...
- (void)dealloc
{
  ...
  *(v15 + 15) |= 8u;
  ...
  v13.receiver = self;
  v13.super_class = CaptureMTLFunctionPointerHandle;
...
{
  v7.receiver = self;
  v7.super_class = CaptureMTLFunctionPointerHandle;
  v3 = [(CaptureMTLFunctionPointerHandle *)&v7 description];
  v4 = [(MTLFunctionPointerHandleSPI *)self->_baseObject description];
