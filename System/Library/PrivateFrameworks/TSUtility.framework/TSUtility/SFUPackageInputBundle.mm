...
{
  v13 = 0;
  v5 = [(SFUPackageInputBundle *)self _existingPathForEntryName:a3 isGz:&v13];
  if (!v5)
  {
    return 0;
  }
  ...
  [v6 handleFailureInFunction:v7 file:objc_msgSend(MEMORY[0x277CCACA8] lineNumber:"stringWithUTF8String:" description:{"/Library/Caches/com.apple.xbs/Sources/AlderShared/utility/sf/SFUInputBundle.m"), 180, @"Asked for the length of gzipped entry %@. This is slow.", a3}];
  v8 = [(SFUPackageInputBundle *)self bufferedInputStreamForEntry:a3];
  if (v8)
  {
    v9 = 0;
    do
...
{
  v15 = 0;
  v7 = [(SFUPackageInputBundle *)self _existingPathForEntryName:a3 isGz:&v15];
  if (v7)
  {
    v8 = v7;
    ...
    else
    {
      v13 = v9;
      v14 = 0;
      if (([v9 linkItemAtPath:v8 toPath:a4 error:&v14] & 1) == 0 && (objc_msgSend(v13, "copyItemAtPath:toPath:error:", v8, a4, &v14) & 1) == 0)
      {
