...
- (TSUPointerSet)initWithCFSet:(__CFSet *)set;
- (TSUPointerSet)initWithObjects:(const void *)objects count:(unint64_t)count;
- (id)allObjects;
- (id)member:(id)member;
...
{
  v7.receiver = self;
  v7.super_class = TSUPointerSet;
  v4 = [(TSUPointerSet *)&v7 init];
  v5 = v4;
  if (set && v4)
  {
