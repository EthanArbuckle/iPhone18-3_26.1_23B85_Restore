...
- (id)copyWithZone:(_NSZone *)a3
{
  if ([(SFURegularExpression *)self zone]== a3)
  {
...
- (_NSRange)matchedRangeForCString:(const char *)a3 range:(_NSRange)a4 subexpressionRanges:(_NSRange *)a5 count:(unsigned int)a6
{
  ...
  {
    v12 = [(SFURegularExpression *)self numberOfSubexpressions];
  }
...
- (_NSRange)matchedRangeForString:(id)a3 range:(_NSRange)a4 subexpressionRanges:(_NSRange *)a5 count:(unsigned int)a6
{
  ...
  v12 = [(SFURegularExpression *)self matchedRangeForCString:[(__CFData *)ASCIIData bytes] range:location subexpressionRanges:length count:a5, v6];
  v14 = v13;
...
- (SFURegularExpression)initWithCoder:(id)a3
{
  v6 = [a3 versionForClassName:@"SFURegularExpression"];
  v7 = v6;
  if (v6 >= 2)
  {
