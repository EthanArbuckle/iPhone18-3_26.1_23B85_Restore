...
- (id)description
{
  ...
  v8.receiver = self;
  v8.super_class = NSSUpdateBetaEnrollmentStatusRespMsg;
  v4 = [(NSSUpdateBetaEnrollmentStatusRespMsg *)&v8 description];
  dictionaryRepresentation = [(NSSUpdateBetaEnrollmentStatusRespMsg *)self dictionaryRepresentation];
...
- (id)copyWithZone:(_NSZone *)zone
{
  ...
  v7 = [(NSData *)self->_error copyWithZone:zone];
  v8 = v6[1];
  v6[1] = v7;
...
- (void)mergeFrom:(id)from
{
  ...
  {
    v5 = fromCopy;
    [(NSSUpdateBetaEnrollmentStatusRespMsg *)self setError:?];
    fromCopy = v5;
  }
}
