...
- (id)description
{
  ...
  dictionaryRepresentation = [(NSSUpdatePowerStatusMsgType *)self dictionaryRepresentation];
...
- (id)dictionaryRepresentation
{
  ...
  [dictionary setObject:v4 forKey:@"notificationType"];
...
- (BOOL)isEqual:(id)equal
{
  ...
  {
    v5 = self->_notificationType == equalCopy[1];
  }
