...
- (SRSensorsCache)init
{
  ...
  {
    defaultManager = [objc_msgSend(MEMORY[0x277CCAA00] defaultManager];
    if (!defaultManager)
    {
      ...
      defaultManager = [MEMORY[0x277CBEBC0] fileURLWithPath:@"/System/Library"];
    }

    v5 = [MEMORY[0x277CBEBC0] fileURLWithPath:objc_msgSend(MEMORY[0x277CCACA8] isDirectory:"pathWithComponents:" relativeToURL:{&unk_287702FD8), 1, defaultManager}];
  }
