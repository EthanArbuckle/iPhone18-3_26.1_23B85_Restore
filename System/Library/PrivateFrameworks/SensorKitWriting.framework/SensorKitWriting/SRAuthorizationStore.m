...
- (void)updateAuthorizations
{
  ...
  v101 = [MEMORY[0x277CBEAC0] dictionaryWithDictionary:{objc_msgSend(a1, "readerAuthorizationValues")}];
...
LABEL_113:
  ...
  *&v166 = v71;
  ...
  v90 = [MEMORY[0x277CBEAC0] dictionaryWithDictionary:{objc_msgSend(a1, "writerAuthorizationValues")}];
...
- (uint64_t)updateToNewAuthorizations:(void *)a3 fromOldAuthorizations:(void *)a4 delegates:
{
  ...
  {
    v6 = a3;
    v7 = [MEMORY[0x277CBEB58] setWithArray:{objc_msgSend(a3, "allKeys")}];
...
- (id)readerAuthorizationBundleIdValues
{
  ...
  v3 = [MEMORY[0x277CBEB38] dictionaryWithCapacity:{-[NSDictionary count](v2, "count")}];
  v11 = 0u;
  v12 = 0u;
  v13 = 0u;
  v14 = 0u;
