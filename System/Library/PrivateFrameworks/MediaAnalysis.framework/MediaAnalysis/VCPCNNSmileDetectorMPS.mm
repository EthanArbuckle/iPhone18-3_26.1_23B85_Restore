...
- (VCPCNNSmileDetectorMPS)init
{
  ...
  v35.receiver = self;
  v35.super_class = VCPCNNSmileDetectorMPS;
  v6 = [(VCPCNNSmileDetectorMPS *)&v35 init];
  if (!v6)
  {
    goto LABEL_35;
  }
...
LABEL_19:
  ...
  v34 = [VCPCNNConvBlock convBlockWithFilterSize:3 filterNum:32 chunk:v5 reLU:1 padding:0];
...
LABEL_16:
  ...
  else
  {
    ...
    {
      v31 = [VCPCNNFullConnectionBlock fcBlockWithNumNeurons:2 NeuronType:0];
