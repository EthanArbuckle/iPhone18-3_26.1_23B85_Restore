...
- (void)executeWith:(id)with completionHandler:(id)handler
{
  ...
  v32[3] = sub_10014B3C4;
  v32[4] = sub_10014B3D4;
  v33 = VCPTransactionWithName(identifier);
  ...
  if ([objc_opt_class() taskID])
  {
    ...
    if (+[MADManagedBackgroundActivitySchedule isMACDPersistEnabled])
    {
      ...
      [MADManagedBackgroundActivitySchedule updateSessionLogWithTaskID:taskID startTime:v41[5] duration:0 exitStatus:-1.0];
    }
    ...
    else
    {
      ...
      if (v19)
      {
        ...
        [v19 storeSchedulingHistoryForActivityID:taskID2 andStartTime:v41[5]];
...
{
  identifier = [objc_opt_class() identifier];
  [NSString stringWithFormat:@"[%@][%@][Deferred]", objc_opt_class(), identifier];
  ...
  if (identifier)
  {
    ...
    v7 = [v6 registerForTaskWithIdentifier:identifier usingQueue:0 launchHandler:v5];
