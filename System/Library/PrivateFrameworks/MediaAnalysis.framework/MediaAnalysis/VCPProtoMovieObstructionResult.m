...
{
  v4 = a3;
  v6 = [v4 isMemberOfClass:objc_opt_class()] && ((timeRange = self->_timeRange, !(timeRange | *(v4 + 2))) || -[VCPProtoTimeRange isEqual:](timeRange, "isEqual:")) && self->_obstructionScore == *(v4 + 2);
...
- (id)exportToLegacyDictionary
{
  v3 = [(VCPProtoMovieObstructionResult *)self timeRange];
  v4 = v3;
  if (v3)
  {
    [v3 timeRangeValue];
