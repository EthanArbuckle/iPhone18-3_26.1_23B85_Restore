...
- (int)_processAssets
{
  v3 = [(MADSpotlightImageProcessingTask *)self isCanceled];
  ...
  else
  {
    ...
    *&v5 = 67109120;
    ...
    while (1)
    {
      ...
      v13 = [(MADSpotlightImageProcessingTask *)self cancelBlock];
      v14 = [MADSpotlightImageAssetBatch batchWithCancelBlock:v13];
...
- (BOOL)run:(id *)a3
{
  ...
  if (!publishError)
  {
    v15 = [(MADSpotlightImageProcessingTask *)self completionHandler];
    v15[2](v15, 0, 0);
LABEL_21:
  ...
  if (a3)
  {
    ...
    v15 = [NSString stringWithFormat:@"[Spotlight|Image] Processing %s", v14];
    v21 = v15;
