...
- (BOOL)run:(id *)run;
- (MADServiceTextProcessingTask)initWithRequests:(id)requests asset:(id)asset cancelBlock:(id)block completionHandler:(id)handler;
- (void)cancel;
@end
...
- (MADServiceTextProcessingTask)initWithRequests:(id)requests asset:(id)asset cancelBlock:(id)block completionHandler:(id)handler
{
  ...
  v26 = v15;
  v24.receiver = self;
  v24.super_class = MADServiceTextProcessingTask;
...
void __85__MADServiceTextProcessingTask_initWithRequests_asset_cancelBlock_completionHandler___block_invoke(uint64_t a1, void *a2, void *a3)
{
  v4 = *(a1 + 32);
  v5 = a3;
  v6 = [a2 objectForKeyedSubscript:@"Payloads"];
  (*(v4 + 16))(v4, v6, v5);
}
...
void __36__MADServiceTextProcessingTask_run___block_invoke(uint64_t a1)
{
  ...
  if (v2)
  {
    ...
    p_superclass = VCPMADVIFaceTask.superclass;
    ...
    do
    {
      for (i = 0; i != v3; ++i)
      {
        ...
        v8 = *(*(&v23 + 1) + 8 * i);
        v9 = [p_superclass + 64 subtaskForRequest:v8 asset:*(*(a1 + 32) + v6[999])];
        if (v9)
        {
...
void __38__MADServiceTextProcessingTask_cancel__block_invoke(uint64_t a1)
{
  ...
  v11.receiver = *(a1 + 32);
  v11.super_class = MADServiceTextProcessingTask;
