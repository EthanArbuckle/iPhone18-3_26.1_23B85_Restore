...
+ (id)vcp_instanceWithExtendedSceneIdentifier:()MediaAnalysis confidence:
{
  ...
  v7 = [v6 initWithExtendedSceneIdentifier:a4 confidence:0 boundingBox:self startTime:*MEMORY[0x1E695F050] duration:*(MEMORY[0x1E695F050] + 8) classificationType:{*(MEMORY[0x1E695F050] + 16), *(MEMORY[0x1E695F050] + 24), 0.0, 0.0}];
