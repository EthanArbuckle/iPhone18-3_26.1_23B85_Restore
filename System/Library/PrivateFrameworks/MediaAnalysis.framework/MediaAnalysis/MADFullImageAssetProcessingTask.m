@interface MADFullImageAssetProcessingTask
- (MADFullImageAssetProcessingTask)initWithLocalIdentifiers:(id)a3 fromPhotoLibraryWithURL:(id)a4 cancelBlock:(id)a5 progressHandler:(id)a6 completionHandler:(id)a7;
- (id)batchWithAnalysisDatabase:(id)a3 allowDownload:(BOOL)a4 cancelBlock:(id)a5;
- (void)dealloc;
@end

@implementation MADFullImageAssetProcessingTask

- (MADFullImageAssetProcessingTask)initWithLocalIdentifiers:(id)a3 fromPhotoLibraryWithURL:(id)a4 cancelBlock:(id)a5 progressHandler:(id)a6 completionHandler:(id)a7
{
  v12 = a4;
  v18.receiver = self;
  v18.super_class = MADFullImageAssetProcessingTask;
...
- (void)dealloc
{
  ...
  v4.receiver = self;
  v4.super_class = MADFullImageAssetProcessingTask;
  [(MADFullImageAssetProcessingTask *)&v4 dealloc];
}
