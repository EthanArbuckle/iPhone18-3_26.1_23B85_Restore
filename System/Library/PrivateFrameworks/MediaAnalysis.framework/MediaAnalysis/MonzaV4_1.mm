...
- (MonzaV4_1)init;
- (MonzaV4_1)initWithConfiguration:(id)configuration error:(id *)error;
- (MonzaV4_1)initWithContentsOfURL:(id)l configuration:(id)configuration error:(id *)error;
- (MonzaV4_1)initWithContentsOfURL:(id)l error:(id *)error;
- (MonzaV4_1)initWithMLModel:(id)model;
- (id)predictionFromFeatures:(id)features error:(id *)error;
- (id)predictionFromFeatures:(id)features options:(id)options error:(id *)error;
- (id)predictionFromInputImage:(__CVBuffer *)image error:(id *)error;
...
- (MonzaV4_1)init
{
  ...
  v4 = [(MonzaV4_1 *)self initWithContentsOfURL:uRLOfModelInThisBundle error:0];
...
- (MonzaV4_1)initWithConfiguration:(id)configuration error:(id *)error
{
  ...
  uRLOfModelInThisBundle = [objc_opt_class() URLOfModelInThisBundle];
  v8 = [(MonzaV4_1 *)self initWithContentsOfURL:uRLOfModelInThisBundle configuration:configurationCopy error:error];
...
- (id)predictionFromFeatures:(id)features error:(id *)error
{
  ...
  v9 = [(MonzaV4_1 *)self predictionFromFeatures:featuresCopy options:v8 error:error];
...
- (id)predictionFromFeatures:(id)features options:(id)options error:(id *)error
{
  ...
  if (v11)
  {
    ...
    v15 = [(MonzaV4_1Output *)v12 initWithAngle:multiArrayValue];
  }
...
- (id)predictionFromInputImage:(__CVBuffer *)image error:(id *)error
{
  v6 = [[MonzaV4_1Input alloc] initWithInputImage:image];
  v7 = [(MonzaV4_1 *)self predictionFromFeatures:v6 error:error];
  ...
  if (v12)
  {
    ...
    if ([v12 count] >= 1)
    {
      ...
      do
      {
        ...
        v19 = [(MonzaV4_1Output *)v16 initWithAngle:multiArrayValue];
