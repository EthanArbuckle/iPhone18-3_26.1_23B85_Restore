...
- (id)description
{
  ...
  v8.receiver = self;
  v8.super_class = VCPProtoMovieLaughterResult;
  v4 = [(VCPProtoMovieLaughterResult *)&v8 description];
  dictionaryRepresentation = [(VCPProtoMovieLaughterResult *)self dictionaryRepresentation];
...
- (void)mergeFrom:(id)from
{
  ...
  else
  {
    ...
    v7 = fromCopy;
    [(VCPProtoMovieLaughterResult *)self setTimeRange:?];
  }
    ...
    if ((v10.duration.flags & 1) != 0 && !v10.duration.epoch)
    {
      ...
      if ((v10.duration.value & 0x8000000000000000) == 0)
      {
        if (v4)
        {
          ...
          [(VCPProtoMovieLaughterResult *)v6 setTimeRange:v8];

          [v5 floatValue];
          [(VCPProtoMovieLaughterResult *)v6 setConfidence:?];
        }
      }
    }
  }
...
- (id)exportToLegacyDictionary
{
  timeRange = [(VCPProtoMovieLaughterResult *)self timeRange];
  v4 = timeRange;
  if (timeRange)
  {
