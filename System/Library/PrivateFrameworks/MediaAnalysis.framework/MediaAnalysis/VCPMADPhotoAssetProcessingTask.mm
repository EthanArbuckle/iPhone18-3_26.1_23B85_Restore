...
- (BOOL)run:(id *)run;
- (VCPMADPhotoAssetProcessingTask)initWithLocalIdentifiers:(id)identifiers fromPhotoLibraryWithURL:(id)l cancelBlock:(id)block progressHandler:(id)handler completionHandler:(id)completionHandler;
@end
...
- (VCPMADPhotoAssetProcessingTask)initWithLocalIdentifiers:(id)identifiers fromPhotoLibraryWithURL:(id)l cancelBlock:(id)block progressHandler:(id)handler completionHandler:(id)completionHandler
{
  ...
  if (v18)
  {
    objc_storeStrong((v18 + 28), identifiers);
    objc_storeStrong((v19 + 36), l);
    v20 = objc_retainBlock(handlerCopy);
    v21 = *(v19 + 44);
    *(v19 + 44) = v20;

    [v19 setCancelBlock:blockCopy];
  }
  ...
  if (v12)
  {
    if (+[MADPhotosDataStoreClient needsDataStoreMigrationForPhotoLibrary:](MADPhotosDataStoreClient, "needsDataStoreMigrationForPhotoLibrary:", v12) && ([objc_opt_class() allowBeforeMigration] & 1) == 0)
    {
      if (run)
      {
        ...
        path = [*(&self->_localIdentifiers + 4) path];
        v15 = [NSString stringWithFormat:@"[%@] Failed to process assets due to database migration incomplete for library %@", name, path];
        v68 = v15;
        name3 = [NSDictionary dictionaryWithObjects:&v68 forKeys:&v67 count:1];
    ...
    else
    {
      ...
      name = [VCPDatabaseManager sharedDatabaseForPhotoLibrary:v12];
      if (name)
      {
LABEL_12:
        runCopy2 = run;
        path = +[PHAsset vcp_fetchOptionsForLibrary:forTaskID:](PHAsset, "vcp_fetchOptionsForLibrary:forTaskID:", v12, [objc_opt_class() taskID]);
        if ([objc_opt_class() taskID] == 2)
        {
          [path setIncludeAssetSourceTypes:{objc_msgSend(path, "includeAssetSourceTypes") | 0x102}];
        }

        v15 = [PHAsset fetchAssetsWithLocalIdentifiers:*(&self->super._publishError + 1) options:path];
        if ([v15 count])
        {
          v50 = v5;
          v16 = [v15 count];
          ...
          v5 = v50;
          v19 = [(VCPMADPhotosProcessingTask *)self processAssetsInFetchResult:v15 initialScan:0 analysisDatabase:name allowDownload:0 progress:v50];
          if (v19 || (v19 = [(VCPMADPhotosProcessingTask *)self waitForPublishing]) != 0)
          {
            if (v19 == -128)
            {
              ...
              if (runCopy2)
              {
                ...
                v34 = [NSString stringWithFormat:@"[%@] Asset processing cancelled", name3];
                v58 = v34;
...
LABEL_46:
            ...
            else
            {
              ...
              if (runCopy2)
              {
                ...
                name3 = [objc_opt_class() name];
                v41 = [NSString stringWithFormat:@"[%@] Asset processing failed", name3];
                v56 = v41;
        ...
        [v52 destroy];
        name3 = [(VCPMADPhotoAssetProcessingTask *)self completionHandler];
        name3[2](name3, 0, 0);
        v32 = 1;
        goto LABEL_47;
      }
      ...
      if (run)
      {
        ...
        name = [objc_opt_class() name];
        path = [*(&self->_localIdentifiers + 4) path];
        v15 = [NSString stringWithFormat:@"[%@] Failed to open Media Analysis for Photo Library (%@)", name, path];
        v66 = v15;
        v23 = &v66;
        v24 = &v65;
        goto LABEL_23;
  ...
  else if (run)
  {
    ...
    name = [objc_opt_class() name];
    path = [*(&self->_localIdentifiers + 4) path];
    v15 = [NSString stringWithFormat:@"[%@] Failed to open Photo Library (%@)", name, path];
    v70 = v15;
    v23 = &v70;
    v24 = &v69;
LABEL_23:
    name3 = [NSDictionary dictionaryWithObjects:v23 forKeys:v24 count:1];
    v26 = v21;
    v5 = v20;
    v27 = -23;
LABEL_29:
    v30 = [NSError errorWithDomain:v26 code:v27 userInfo:name3];
    v31 = *runCopy4;
    *runCopy4 = v30;
