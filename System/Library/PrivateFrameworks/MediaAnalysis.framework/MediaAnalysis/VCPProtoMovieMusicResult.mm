...
- (id)description
{
  ...
  v8.receiver = self;
  v8.super_class = VCPProtoMovieMusicResult;
  v4 = [(VCPProtoMovieMusicResult *)&v8 description];
  dictionaryRepresentation = [(VCPProtoMovieMusicResult *)self dictionaryRepresentation];
...
- (void)mergeFrom:(id)from
{
  ...
  else
  {
    ...
    v7 = fromCopy;
    [(VCPProtoMovieMusicResult *)self setTimeRange:?];
  }
    ...
    if ((v10.duration.flags & 1) != 0 && !v10.duration.epoch)
    {
      ...
      if ((v10.duration.value & 0x8000000000000000) == 0)
      {
        if (v4)
        {
          ...
          [(VCPProtoMovieMusicResult *)v6 setTimeRange:v8];

          [v5 floatValue];
          [(VCPProtoMovieMusicResult *)v6 setConfidence:?];
        }
      }
    }
  }
...
- (id)exportToLegacyDictionary
{
  timeRange = [(VCPProtoMovieMusicResult *)self timeRange];
  v4 = timeRange;
  if (timeRange)
  {
