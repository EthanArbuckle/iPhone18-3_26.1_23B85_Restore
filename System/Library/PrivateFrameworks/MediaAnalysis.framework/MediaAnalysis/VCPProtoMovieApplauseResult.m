    ...
    if ((v10.duration.flags & 1) != 0 && !v10.duration.epoch)
    {
      ...
      if ((v10.duration.value & 0x8000000000000000) == 0)
      {
        if (v4)
        {
          ...
          [(VCPProtoMovieApplauseResult *)v6 setTimeRange:v8];

          [v5 floatValue];
          [(VCPProtoMovieApplauseResult *)v6 setConfidence:?];
        }
      }
    }
  }
...
- (id)exportToLegacyDictionary
{
  v3 = [(VCPProtoMovieApplauseResult *)self timeRange];
  v4 = v3;
  if (v3)
  {
    [v3 timeRangeValue];
...
- (id)description
{
  ...
  v8.receiver = self;
  v8.super_class = VCPProtoMovieApplauseResult;
  v4 = [(VCPProtoMovieApplauseResult *)&v8 description];
  v5 = [(VCPProtoMovieApplauseResult *)self dictionaryRepresentation];
...
- (void)mergeFrom:(id)a3
{
  ...
  else
  {
    ...
    v7 = v4;
    [(VCPProtoMovieApplauseResult *)self setTimeRange:?];
  }
