...
void __31__VCPMADVisionResource_session__block_invoke(uint64_t a1)
{
  ...
  if (!v2)
  {
    ...
    {
      *buf = 0;
      _os_signpost_emit_with_name_impl(&dword_1C9B70000, v6, OS_SIGNPOST_INTERVAL_BEGIN, v4, "VNSession_init", "", buf, 2u);
    }

    v7 = objc_alloc_init(MEMORY[0x1E6984688]);
    v8 = *(a1 + 32);
    v9 = *(v8 + 16);
    *(v8 + 16) = v7;
    ...
    {
      *v12 = 0;
      _os_signpost_emit_with_name_impl(&dword_1C9B70000, v11, OS_SIGNPOST_INTERVAL_END, v4, "VNSession_init", "", v12, 2u);
    }
