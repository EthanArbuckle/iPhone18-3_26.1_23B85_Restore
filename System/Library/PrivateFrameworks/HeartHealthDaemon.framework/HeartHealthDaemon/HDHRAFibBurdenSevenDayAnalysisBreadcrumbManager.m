...
- (HDHRAFibBurdenSevenDayAnalysisBreadcrumbManager)initWithProfile:(id)a3
{
  v4 = [MEMORY[0x277D10718] hdhr_aFibBurdenProtectedSyncedDomainForProfile:a3];
...
- (HDHRAFibBurdenSevenDayAnalysisBreadcrumbManager)initWithKeyValueDomain:(id)a3 dateGenerator:(id)a4 queue:(id)a5
{
  ...
  if (v12)
  {
    objc_storeStrong(&v12->_keyValueDomain, a3);
    v14 = MEMORY[0x22AACDB50](v10);
...
- (id)fetchBreadcrumbsWithError:(id *)a3
{
  ...
  v7 = [(HDKeyValueDomain *)keyValueDomain dateForKey:v6 error:a3];
  ...
  if (!*a3)
  {
    ...
    v11 = [(HDKeyValueDomain *)v9 dateForKey:v10 error:a3];
    ...
    else
    {
      ...
      v14 = [(HDKeyValueDomain *)v12 dateForKey:v13 error:a3];
      ...
      else
      {
        ...
        v17 = [(HDKeyValueDomain *)v15 dateForKey:v16 error:a3];
...
- (void)_queue_dropBreadcrumb:(int64_t)a3 date:(id)a4
{
  ...
  v8 = [(HDHRAFibBurdenSevenDayAnalysisBreadcrumbManager *)self _dateKeyForBreadcrumb:a3];
  keyValueDomain = self->_keyValueDomain;
  v12 = 0;
