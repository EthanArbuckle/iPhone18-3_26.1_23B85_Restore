...
+ (void)localAvailabilityForElectrocardiogramV2Recording
{
  ...
  [currentHandler handleFailureInMethod:self object:a2 file:@"HKCountrySet+ElectrocardiogramV2Recording.m" lineNumber:40 description:@"Local generated country set should never be nil"];
}
