...
- (id)valueForKey:(id)a3 error:(id *)a4
{
  ...
  if (objc_msgSend_isAppleInternalInstall(APSystemInternal, v6, v7, v8))
  {
    v9 = objc_alloc(MEMORY[0x1E695E000]);
    v12 = objc_msgSend_initWithSuiteName_(v9, v10, @"com.apple.AdPlatforms", v11);
    v15 = objc_msgSend_objectForKey_(v12, v13, v5, v14);
    v19 = v15;
    if (v15)
    {
      v20 = v15;
    ...
    else
    {
      ...
      v25 = objc_msgSend_lastNamespacedComponent(v5, v22, v23, v24);
...
- (void)setValue:(id)a3 forKey:(id)a4 error:(id *)a5
{
  ...
  if (objc_msgSend_isAppleInternalInstall(APSystemInternal, v9, v10, v11))
  {
    ...
    v23 = objc_msgSend_lastNamespacedComponent(v8, v20, v21, v22);
    v26 = objc_msgSend_objectForKey_(v19, v24, v23, v25);

    if (objc_msgSend_isEqual_(v26, v27, v7, v28))
    {
      objc_msgSend_setObject_forKey_(v15, v29, 0, v8);
    }

    else
    {
      objc_msgSend_setObject_forKey_(v15, v29, v7, v8);
      v38 = @"Key";
      v39[0] = v8;
