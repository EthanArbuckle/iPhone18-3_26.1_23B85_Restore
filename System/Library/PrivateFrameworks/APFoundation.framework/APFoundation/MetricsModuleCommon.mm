...
+ (void)setMetricClass:(Class)a3
{
  v5 = objc_msgSend_processInfo(MEMORY[0x1E696AE30], a2, a3, v3);
  isRunningTests = objc_msgSend_isRunningTests(v5, v6, v7, v8);

  if (isRunningTests)
  {
    proto = &unk_1F3911DB0;
    if (objc_msgSend_conformsToProtocol_(a3, v10, proto, v11))
    {
      qword_1EDBA4C08 = a3;
    }
...
+ (void)setDaemonDeliveryClass:(Class)a3
{
  ...
  if (isRunningTests)
  {
    ...
    v10 = &unk_1F390EA30;
    v11 = &unk_1F390EAA8;
    if (objc_msgSend_conformsToProtocol_(a3, v12, proto, v13) && objc_msgSend_conformsToProtocol_(a3, v14, v10, v15) && objc_msgSend_conformsToProtocol_(a3, v16, v11, v17))
    {
      qword_1EDBA4C10 = a3;
    }
...
+ (void)setNotificationRegistrarClass:(Class)a3
{
  ...
  if (isRunningTests)
  {
    proto = &unk_1F390F390;
    v10 = &unk_1F390EAA8;
    if (objc_msgSend_conformsToProtocol_(a3, v11, proto, v12) && objc_msgSend_conformsToProtocol_(a3, v13, v10, v14))
    {
      qword_1EDBA4C00 = a3;
    }
