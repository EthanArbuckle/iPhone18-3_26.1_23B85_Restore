...
- (id)_filePathWithName:(id)a3
{
  v4 = objc_msgSend_sha256hash(a3, a2, a3, v3);
...
- (void)_readFileIfNecessaryUsingKey:(id)a3
{
  ...
  if (!v10)
  {
    v11 = objc_msgSend_componentsSeparatedByString_(v4, v8, @".", v9);
    if (objc_msgSend_count(v11, v12, v13, v14) != 2)
    {
      v18 = objc_msgSend_stringWithFormat_(MEMORY[0x1E696AEC0], v15, @"The key (%@) must have two parts separated by the separator character '%@'", v17, v4, @".");
...
- (void)_writeFileUsingKey:(id)a3
{
  ...
  v4 = a3;
  v7 = objc_msgSend_componentsSeparatedByString_(v4, v5, @".", v6);
  ...
  if (v14)
  {
    v15 = objc_msgSend_stringWithFormat_(MEMORY[0x1E696AEC0], v12, @"We didn't get something useable as a filename from the key: '%@'", v13, v4);
  ...
  else
  {
    if (v11 != 2)
    {
      v17 = objc_msgSend_stringWithFormat_(MEMORY[0x1E696AEC0], v12, @"The key (%@) must have two parts separated by the separator character '%@'", v13, v4, @".");
...
- (id)valueForKey:(id)a3 error:(id *)a4
{
  ...
  objc_msgSend__readFileIfNecessaryUsingKey_(self, v13, v5, v14);
  v18 = objc_msgSend_storage(self, v15, v16, v17);
  v22 = v18;
  if (!v18 || (objc_msgSend_objectForKey_(v18, v19, v5, v21), (v23 = objc_claimAutoreleasedReturnValue()) == 0))
  {
    v24 = objc_msgSend_defaults(self, v19, v20, v21);
    v28 = objc_msgSend_lastNamespacedComponent(v5, v25, v26, v27);
...
- (void)setValue:(id)a3 forKey:(id)a4 error:(id *)a5
{
  ...
  if (v8 && (objc_opt_class(), (objc_opt_respondsToSelector() & 1) == 0))
  {
    ...
    v55 = objc_msgSend_stringWithFormat_(v47, v53, @"%@ %@ Non storable value type (%@) for property %@", v54, v49, v50, v52, v12);
  ...
  else
  {
    ...
    objc_msgSend__readFileIfNecessaryUsingKey_(self, v17, v12, v18);
    ...
    v33 = objc_msgSend_lastNamespacedComponent(v12, v30, v31, v32);
    v36 = objc_msgSend_objectForKey_(v29, v34, v33, v35);

    isEqual = objc_msgSend_isEqual_(v36, v37, v8, v38);
    if (!v8 || isEqual)
    {
      objc_msgSend_removeObjectForKey_(v25, v40, v12, v41);
    }

    else
    {
      objc_msgSend_setObject_forKey_(v25, v40, v8, v12);
    }

    objc_msgSend__writeFileUsingKey_(self, v42, v12, v43);
