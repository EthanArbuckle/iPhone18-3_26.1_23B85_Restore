@interface String:
- (uint64_t)String;
- (unint64_t)AppAssetGarbageCollector.Manifest.Entry;
- (unint64_t)E5Function;
- (unint64_t)MetadataSpecialToken;
- (unint64_t)OnDeviceInferenceAssetObject;
- (void)String;
@end
...
- (unint64_t)OnDeviceInferenceAssetObject
{
  result = lazy protocol witness table cache variable for type [String : OnDeviceInferenceAssetObject].Keys and conformance [A : B].Keys;
  if (!lazy protocol witness table cache variable for type [String : OnDeviceInferenceAssetObject].Keys and conformance [A : B].Keys)
  {
    __swift_instantiateConcreteTypeFromMangledNameAbstractV2(&_sSD4KeysVySS24TokenGenerationInference08OnDeviceD11AssetObject_p_GMd);
    result = swift_getWitnessTable();
    atomic_store(result, &lazy protocol witness table cache variable for type [String : OnDeviceInferenceAssetObject].Keys and conformance [A : B].Keys);
  }
