...
- (id)description
{
  ...
  v8.receiver = self;
  v8.super_class = PDSProtoMapEntry;
  v4 = [(PDSProtoMapEntry *)&v8 description];
  dictionaryRepresentation = [(PDSProtoMapEntry *)self dictionaryRepresentation];
...
- (void)mergeFrom:(id)from
{
  ...
  if (fromCopy[1])
  {
    [(PDSProtoMapEntry *)self setKey:?];
    fromCopy = v5;
  }

  if (fromCopy[2])
  {
    [(PDSProtoMapEntry *)self setValue:?];
    fromCopy = v5;
  }
}
