...
- (SiriRemoteTimerTarget)initWithCoder:(id)coder;
- (SiriRemoteTimerTarget)initWithIdentifier:(id)identifier displayString:(id)string pronunciationHint:(id)hint;
@end
...
- (SiriRemoteTimerTarget)initWithCoder:(id)coder
{
  ...
  coderCopy = coder;
  v5 = [(SiriRemoteTimerTarget *)&v7 initWithCoder:coderCopy];
