...
- (BOOL)fmipEnabled
{
  fmipState = [(FMDUIFMIPSettingsCache *)self fmipState];
  if (fmipState != 1)
  {
    LOBYTE(fmipState) = [(FMDUIFMIPSettingsCache *)self fmipState]== 0;
  }
...
- (void)_loadLowBatteryState
{
  ...
  [mEMORY[0x277D08F78] lowBatteryLocateEnabledWithCompletion:v3];
