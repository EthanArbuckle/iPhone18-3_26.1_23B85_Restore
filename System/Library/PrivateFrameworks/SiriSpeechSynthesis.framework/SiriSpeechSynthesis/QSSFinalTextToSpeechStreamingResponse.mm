...
- (Offset<siri::speech::schema_fb::FinalTextToSpeechStreamingResponse>)addObjectToBuffer:(void *)a3
{
  v5 = [(QSSFinalTextToSpeechStreamingResponse *)self speech_id];
  v6 = v5;
  if (!v5)
  {
    v5 = &stru_2879AE8E0;
  ...
  v10 = [(QSSFinalTextToSpeechStreamingResponse *)self session_id];
  v11 = v10;
  if (!v10)
  {
    v10 = &stru_2879AE8E0;
  ...
  v15 = [(QSSFinalTextToSpeechStreamingResponse *)self error_code];
  ...
  v25 = [(QSSFinalTextToSpeechStreamingResponse *)self total_pkt_number];
  ...
  *(a3 + 70) = 1;
  ...
  flatbuffers::FlatBufferBuilder::AddOffset<flatbuffers::Vector<unsigned char>>(a3, 16, v27);

  return flatbuffers::FlatBufferBuilder::EndTable(a3, v29 + v28);
}
