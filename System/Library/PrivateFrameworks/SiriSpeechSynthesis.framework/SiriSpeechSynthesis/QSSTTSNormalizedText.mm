...
- (QSSTTSNormalizedText)initWithFlatbuffData:(id)data root:(const TTSNormalizedText *)root verify:(BOOL)verify;
- (id)flatbuffData;
@end
...
- (Offset<siri::speech::schema_fb::TTSNormalizedText>)addObjectToBuffer:(void *)buffer
{
  text = [(QSSTTSNormalizedText *)self text];
  v5 = text;
  if (!text)
  {
    text = &stru_2879AE8E0;
...
- (QSSTTSNormalizedText)initWithFlatbuffData:(id)data root:(const TTSNormalizedText *)root verify:(BOOL)verify
{
  ...
  dataCopy = data;
  v29.receiver = self;
  v29.super_class = QSSTTSNormalizedText;
  v10 = [(QSSTTSNormalizedText *)&v29 init];
  v11 = v10;
  if (v10)
  {
