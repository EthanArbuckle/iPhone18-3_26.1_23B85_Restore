...
- (QSSTextToSpeechRequestExperiment)initWithFlatbuffData:(id)data root:(const TextToSpeechRequestExperiment *)root verify:(BOOL)verify;
- (id)flatbuffData;
@end
...
- (Offset<siri::speech::schema_fb::TextToSpeechRequestExperiment>)addObjectToBuffer:(void *)buffer
{
  experiment_identifier = [(QSSTextToSpeechRequestExperiment *)self experiment_identifier];
  v5 = experiment_identifier;
  if (!experiment_identifier)
  {
    experiment_identifier = &stru_2879AE8E0;
  }
