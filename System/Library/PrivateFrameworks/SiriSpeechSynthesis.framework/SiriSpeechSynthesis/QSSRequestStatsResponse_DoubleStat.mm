...
- (QSSRequestStatsResponse_DoubleStat)initWithFlatbuffData:(id)data root:(const DoubleStat *)root verify:(BOOL)verify;
- (double)value;
- (id)flatbuffData;
@end
...
- (Offset<siri::speech::schema_fb::RequestStatsResponse_::DoubleStat>)addObjectToBuffer:(void *)buffer
{
  name = [(QSSRequestStatsResponse_DoubleStat *)self name];
  v6 = name;
  if (!name)
  {
    name = &stru_2879AE8E0;
...
- (QSSRequestStatsResponse_DoubleStat)initWithFlatbuffData:(id)data root:(const DoubleStat *)root verify:(BOOL)verify
{
  ...
  dataCopy = data;
  v29.receiver = self;
  v29.super_class = QSSRequestStatsResponse_DoubleStat;
  v10 = [(QSSRequestStatsResponse_DoubleStat *)&v29 init];
  v11 = v10;
  if (v10)
  {
