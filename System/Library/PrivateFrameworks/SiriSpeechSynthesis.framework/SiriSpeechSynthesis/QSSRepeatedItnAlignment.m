...
- (Offset<siri::speech::schema_fb::RepeatedItnAlignment>)addObjectToBuffer:(void *)a3
{
  ...
  v5 = [(QSSRepeatedItnAlignment *)self itn_alignment];
  ...
  v20 = 0u;
  v21 = 0u;
  v6 = [(QSSRepeatedItnAlignment *)self itn_alignment];
...
- (QSSRepeatedItnAlignment)initWithFlatbuffData:(id)a3 root:(const RepeatedItnAlignment *)a4 verify:(BOOL)a5
{
  ...
  v9 = a3;
  v29.receiver = self;
  v29.super_class = QSSRepeatedItnAlignment;
  v10 = [(QSSRepeatedItnAlignment *)&v29 init];
  v11 = v10;
  if (v10)
  {
    if (!v9 || ![v9 length])
    ...
    if (v5)
    {
      ...
      if (v19)
      {
        if (!siri::speech::schema_fb::RepeatedItnAlignment::Verify(v19, &v24))
        {
LABEL_16:
          v22 = 0;
          goto LABEL_17;
