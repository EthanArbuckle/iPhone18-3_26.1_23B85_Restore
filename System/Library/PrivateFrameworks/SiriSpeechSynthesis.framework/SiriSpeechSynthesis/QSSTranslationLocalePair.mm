...
- (QSSTranslationLocalePair)initWithFlatbuffData:(id)data root:(const TranslationLocalePair *)root verify:(BOOL)verify;
- (id)flatbuffData;
@end
...
- (Offset<siri::speech::schema_fb::TranslationLocalePair>)addObjectToBuffer:(void *)buffer
{
  source_locale = [(QSSTranslationLocalePair *)self source_locale];
  v6 = source_locale;
  if (!source_locale)
  {
  ...
  target_locale = [(QSSTranslationLocalePair *)self target_locale];
  v11 = target_locale;
  if (!target_locale)
  {
...
- (QSSTranslationLocalePair)initWithFlatbuffData:(id)data root:(const TranslationLocalePair *)root verify:(BOOL)verify
{
  ...
  dataCopy = data;
  v29.receiver = self;
  v29.super_class = QSSTranslationLocalePair;
  v10 = [(QSSTranslationLocalePair *)&v29 init];
  v11 = v10;
  if (v10)
  {
