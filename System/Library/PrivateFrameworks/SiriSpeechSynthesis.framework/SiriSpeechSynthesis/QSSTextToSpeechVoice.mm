...
- (QSSTextToSpeechVoice)initWithFlatbuffData:(id)data root:(const TextToSpeechVoice *)root verify:(BOOL)verify;
- (id)flatbuffData;
@end
...
- (Offset<siri::speech::schema_fb::TextToSpeechVoice>)addObjectToBuffer:(void *)buffer
{
  language = [(QSSTextToSpeechVoice *)self language];
  v6 = language;
  if (!language)
  {
  ...
  gender = [(QSSTextToSpeechVoice *)self gender];
  v11 = gender;
  if (!gender)
  {
  ...
  name = [(QSSTextToSpeechVoice *)self name];
  v16 = name;
  if (!name)
  {
    name = &stru_2879AE8E0;
  ...
  version = [(QSSTextToSpeechVoice *)self version];
  v21 = version;
  if (!version)
  {
  ...
  quality = [(QSSTextToSpeechVoice *)self quality];
  v26 = quality;
  if (!quality)
  {
    quality = &stru_2879AE8E0;
  }
  ...
  type = [(QSSTextToSpeechVoice *)self type];
  v31 = type;
  if (!type)
  {
    type = &stru_2879AE8E0;
  ...
  *(buffer + 70) = 1;
  ...
  flatbuffers::FlatBufferBuilder::AddOffset<flatbuffers::Vector<unsigned char>>(buffer, 14, uTF8String6);
