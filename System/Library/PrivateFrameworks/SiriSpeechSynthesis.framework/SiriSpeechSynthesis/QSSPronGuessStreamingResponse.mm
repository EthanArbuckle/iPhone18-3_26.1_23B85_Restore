...
- (Offset<siri::speech::qss_fb::PronGuessStreamingResponse>)addObjectToBuffer:(void *)buffer;
- (QSSPronGuessResponse)contentAsQSSPronGuessResponse;
- (QSSPronGuessStreamingResponse)initWithFlatbuffData:(id)data root:(const PronGuessStreamingResponse *)root verify:(BOOL)verify;
- (id)flatbuffData;
...
- (Offset<siri::speech::qss_fb::PronGuessStreamingResponse>)addObjectToBuffer:(void *)buffer
{
  content_type = [(QSSPronGuessStreamingResponse *)self content_type];
  if ([(QSSPronGuessStreamingResponse *)self content_type]== 1)
  {
    contentAsQSSPronGuessResponse = [(QSSPronGuessStreamingResponse *)self contentAsQSSPronGuessResponse];
    v7 = [contentAsQSSPronGuessResponse addObjectToBuffer:buffer];
