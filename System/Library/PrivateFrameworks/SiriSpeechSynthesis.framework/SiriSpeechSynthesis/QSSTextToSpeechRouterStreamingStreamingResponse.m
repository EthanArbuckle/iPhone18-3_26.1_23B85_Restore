...
- (Offset<siri::speech::qss_fb::TextToSpeechRouterStreamingStreamingResponse>)addObjectToBuffer:(void *)a3
{
  v5 = [(QSSTextToSpeechRouterStreamingStreamingResponse *)self content_type];
  if ([(QSSTextToSpeechRouterStreamingStreamingResponse *)self content_type]== 1)
  {
    v6 = [(QSSTextToSpeechRouterStreamingStreamingResponse *)self contentAsQSSBeginTextToSpeechStreamingResponse];
  ...
  {
    v8 = [(QSSTextToSpeechRouterStreamingStreamingResponse *)self contentAsQSSPartialTextToSpeechStreamingResponse];
  ...
  {
    v10 = [(QSSTextToSpeechRouterStreamingStreamingResponse *)self contentAsQSSFinalTextToSpeechStreamingResponse];
...
- (QSSTextToSpeechRouterStreamingStreamingResponse)initWithFlatbuffData:(id)a3 root:(const TextToSpeechRouterStreamingStreamingResponse *)a4 verify:(BOOL)a5
{
  ...
  v9 = a3;
  v33.receiver = self;
  v33.super_class = QSSTextToSpeechRouterStreamingStreamingResponse;
  v10 = [(QSSTextToSpeechRouterStreamingStreamingResponse *)&v33 init];
  v11 = v10;
  if (!v10)
  {
    goto LABEL_39;
