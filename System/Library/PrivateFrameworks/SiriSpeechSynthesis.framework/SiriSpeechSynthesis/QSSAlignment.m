...
- (Offset<siri::speech::schema_fb::Alignment>)addObjectToBuffer:(void *)a3
{
  ...
  v12 = flatbuffers::FlatBufferBuilder::CreateVector<int>(a3, v11, v24.__end_ - v24.__begin_);
...
- (QSSAlignment)initWithFlatbuffData:(id)a3 root:(const Alignment *)a4 verify:(BOOL)a5
{
  ...
  v9 = a3;
  v29.receiver = self;
  v29.super_class = QSSAlignment;
  v10 = [(QSSAlignment *)&v29 init];
  v11 = v10;
  if (v10)
  {
    if (!v9 || ![v9 length])
    ...
    if (v5)
    {
      ...
      if (v19)
      {
        if (!siri::speech::schema_fb::Alignment::Verify(v19, &v24))
        {
LABEL_16:
          v22 = 0;
          goto LABEL_17;
