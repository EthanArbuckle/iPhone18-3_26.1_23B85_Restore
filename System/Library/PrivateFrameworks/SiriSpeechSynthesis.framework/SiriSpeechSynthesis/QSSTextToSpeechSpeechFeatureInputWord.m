...
- (Offset<siri::speech::schema_fb::TextToSpeechSpeechFeatureInputWord>)addObjectToBuffer:(void *)a3
{
  ...
  v5 = [(QSSTextToSpeechSpeechFeatureInputWord *)self word];
  v6 = v5;
  if (!v5)
  {
    v5 = &stru_2879AE8E0;
  ...
  v10 = [(QSSTextToSpeechSpeechFeatureInputWord *)self phonemes];
  ...
  v27 = 0u;
  v28 = 0u;
  v11 = [(QSSTextToSpeechSpeechFeatureInputWord *)self phonemes];
