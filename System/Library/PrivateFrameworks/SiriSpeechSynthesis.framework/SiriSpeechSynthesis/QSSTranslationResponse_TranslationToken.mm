...
- (QSSTranslationResponse_TranslationToken)initWithFlatbuffData:(id)data root:(const TranslationToken *)root verify:(BOOL)verify;
- (float)confidence;
- (id)flatbuffData;
@end
...
- (Offset<siri::speech::schema_fb::TranslationResponse_::TranslationToken>)addObjectToBuffer:(void *)buffer
{
  token = [(QSSTranslationResponse_TranslationToken *)self token];
  v6 = token;
  if (!token)
  {
    token = &stru_2879AE8E0;
  }
  ...
  v10 = v9;
  mt_alignment = [(QSSTranslationResponse_TranslationToken *)self mt_alignment];
  v12 = [mt_alignment addObjectToBuffer:buffer];

  add_space_after = [(QSSTranslationResponse_TranslationToken *)self add_space_after];
  ...
  *(buffer + 70) = 1;
  ...
  if (v12)
  {
    v17 = flatbuffers::FlatBufferBuilder::ReferTo(buffer, v12);
    flatbuffers::FlatBufferBuilder::AddElement<unsigned int>(buffer, 8, v17);
  }

  flatbuffers::FlatBufferBuilder::AddElement<unsigned char>(buffer, 10, add_space_after);
...
- (QSSTranslationResponse_TranslationToken)initWithFlatbuffData:(id)data root:(const TranslationToken *)root verify:(BOOL)verify
{
  ...
  dataCopy = data;
  v29.receiver = self;
  v29.super_class = QSSTranslationResponse_TranslationToken;
  v10 = [(QSSTranslationResponse_TranslationToken *)&v29 init];
  v11 = v10;
  if (v10)
  {
    ...
    if (verifyCopy)
    {
      ...
      if (v19)
      {
        if (!siri::speech::schema_fb::TranslationResponse_::TranslationToken::Verify(v19, &v24))
        {
LABEL_16:
          v22 = 0;
          goto LABEL_17;
