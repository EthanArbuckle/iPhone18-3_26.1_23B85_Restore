...
- (Offset<siri::speech::schema_fb::TranslationResponse_::TranslationToken>)addObjectToBuffer:(void *)a3
{
  v5 = [(QSSTranslationResponse_TranslationToken *)self token];
  v6 = v5;
  if (!v5)
  {
    v5 = &stru_2879AE8E0;
  ...
  v10 = v9;
  v11 = [(QSSTranslationResponse_TranslationToken *)self mt_alignment];
  v12 = [v11 addObjectToBuffer:a3];

  v13 = [(QSSTranslationResponse_TranslationToken *)self add_space_after];
  ...
  *(a3 + 70) = 1;
  ...
  if (v12)
  {
    v17 = flatbuffers::FlatBufferBuilder::ReferTo(a3, v12);
