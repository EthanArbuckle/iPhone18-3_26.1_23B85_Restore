...
- (Offset<siri::speech::qss_fb::TextToSpeechRouterStreamingStreamingRequest>)addObjectToBuffer:(void *)a3
{
  v5 = [(QSSTextToSpeechRouterStreamingStreamingRequest *)self content_type];
  if ([(QSSTextToSpeechRouterStreamingStreamingRequest *)self content_type]== 1)
  {
    v6 = [(QSSTextToSpeechRouterStreamingStreamingRequest *)self contentAsQSSStartTextToSpeechStreamingRequest];
