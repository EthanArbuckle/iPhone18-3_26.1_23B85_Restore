...
- (QSSAudioAnalytics_AcousticFeaturesEntry)initWithFlatbuffData:(id)data root:(const AcousticFeaturesEntry *)root verify:(BOOL)verify;
- (id)flatbuffData;
@end
...
- (Offset<siri::speech::schema_fb::AudioAnalytics_::AcousticFeaturesEntry>)addObjectToBuffer:(void *)buffer
{
  ...
  value = [(QSSAudioAnalytics_AcousticFeaturesEntry *)self value];
  ...
  *(buffer + 70) = 1;
  ...
  if (v10)
  {
    v14 = flatbuffers::FlatBufferBuilder::ReferTo(buffer, v10);
    flatbuffers::FlatBufferBuilder::AddElement<unsigned int>(buffer, 6, v14);
  }

  return flatbuffers::FlatBufferBuilder::EndTable(buffer, v13 - v11 + v12);
}
