...
- (Offset<siri::speech::schema_fb::AudioLimitExceeded>)addObjectToBuffer:(void *)buffer;
- (QSSAudioLimitExceeded)initWithFlatbuffData:(id)data root:(const AudioLimitExceeded *)root verify:(BOOL)verify;
- (id)flatbuffData;
@end
