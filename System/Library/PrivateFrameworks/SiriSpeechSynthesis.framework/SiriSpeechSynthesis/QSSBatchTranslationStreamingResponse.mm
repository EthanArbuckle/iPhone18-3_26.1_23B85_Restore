...
- (QSSBatchTranslationStreamingResponse)initWithFlatbuffData:(id)data root:(const BatchTranslationStreamingResponse *)root verify:(BOOL)verify;
...
- (Offset<siri::speech::qss_fb::BatchTranslationStreamingResponse>)addObjectToBuffer:(void *)buffer
{
  content_type = [(QSSBatchTranslationStreamingResponse *)self content_type];
  if ([(QSSBatchTranslationStreamingResponse *)self content_type]== 1)
  {
    contentAsQSSBatchTranslationResponse = [(QSSBatchTranslationStreamingResponse *)self contentAsQSSBatchTranslationResponse];
    LODWORD(v7) = [contentAsQSSBatchTranslationResponse addObjectToBuffer:buffer];
  ...
  {
    contentAsQSSFinalBlazarResponse = [(QSSBatchTranslationStreamingResponse *)self contentAsQSSFinalBlazarResponse];
    LODWORD(v9) = [contentAsQSSFinalBlazarResponse addObjectToBuffer:buffer];
  ...
  {
    contentAsQSSTranslationSupportedLanguagesResponse = [(QSSBatchTranslationStreamingResponse *)self contentAsQSSTranslationSupportedLanguagesResponse];
    v11 = [contentAsQSSTranslationSupportedLanguagesResponse addObjectToBuffer:buffer];
