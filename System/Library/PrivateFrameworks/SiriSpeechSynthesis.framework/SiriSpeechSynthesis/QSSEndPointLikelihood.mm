...
- (Offset<siri::speech::schema_fb::EndPointLikelihood>)addObjectToBuffer:(void *)a3
{
  v5 = [(QSSEndPointLikelihood *)self speech_id];
  v6 = v5;
  if (!v5)
  {
    v5 = &stru_2879AE8E0;
  ...
  v10 = [(QSSEndPointLikelihood *)self session_id];
  v11 = v10;
  if (!v10)
  {
    v10 = &stru_2879AE8E0;
  ...
  v15 = [(QSSEndPointLikelihood *)self return_code];
  ...
  v20 = [(QSSEndPointLikelihood *)self end_point_likelihood];
