...
- (QSSTextToSpeechStreamingStreamingRequest)initWithFlatbuffData:(id)data root:(const TextToSpeechStreamingStreamingRequest *)root verify:(BOOL)verify;
- (id)flatbuffData;
...
- (Offset<siri::speech::qss_fb::TextToSpeechStreamingStreamingRequest>)addObjectToBuffer:(void *)buffer
{
  content_type = [(QSSTextToSpeechStreamingStreamingRequest *)self content_type];
  if ([(QSSTextToSpeechStreamingStreamingRequest *)self content_type]== 1)
  {
    contentAsQSSStartTextToSpeechStreamingRequest = [(QSSTextToSpeechStreamingStreamingRequest *)self contentAsQSSStartTextToSpeechStreamingRequest];
...
- (QSSTextToSpeechStreamingStreamingRequest)initWithFlatbuffData:(id)data root:(const TextToSpeechStreamingStreamingRequest *)root verify:(BOOL)verify
{
  ...
  dataCopy = data;
  v32.receiver = self;
  v32.super_class = QSSTextToSpeechStreamingStreamingRequest;
  v10 = [(QSSTextToSpeechStreamingStreamingRequest *)&v32 init];
  v11 = v10;
  if (!v10)
  {
    goto LABEL_30;
