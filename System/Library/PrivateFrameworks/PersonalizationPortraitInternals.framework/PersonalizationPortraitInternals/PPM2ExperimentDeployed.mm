...
LABEL_11:
  ...
  if (namespaceName | *(v4 + 3) && ![(NSString *)namespaceName isEqual:?])
  {
    goto LABEL_11;
  }
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v7 = [(NSString *)self->_namespaceName copyWithZone:a3];
  v8 = v6[3];
  v6[3] = v7;
...
- (id)description
{
  ...
  v5 = [(PPM2ExperimentDeployed *)self dictionaryRepresentation];
