...
- (PPAugmentedGazetteerMetadata)initWithStatement:(id)a3
{
  ...
  v7 = [v4 getInt64ForColumnName:"qid" table:"metadata"];
  if (HIDWORD(v7))
  {
...
LABEL_12:
  ...
  v5->_threshold = vcvtd_n_f64_s64([v4 getInt64ForColumnName:"threshold" table:"metadata"], 3uLL);
  v10 = [v4 getNSStringForColumnName:"category" table:"metadata"];
  category = v5->_category;
  v5->_category = v10;

  v5->_gazetteerDomain = [v4 getInt64ForColumnName:"gazetteerDomain" table:"metadata"];
  v12 = [v4 getNSStringForColumnName:"alias" table:"metadata"];
  alias = v5->_alias;
  v5->_alias = v12;
