...
- (BOOL)listener:(id)listener shouldAcceptNewConnection:(id)connection
{
  ...
  v6 = [v4 interfaceWithProtocol:&unk_2847A04B0];
  v7 = [MEMORY[0x277CCAE90] interfaceWithProtocol:&unk_2847B9A88];
  v8 = objc_opt_new();
  ...
  v15 = v17;
  v11 = v17;
  v12 = [PPXPCServerHelper shouldAcceptConnection:connectionCopy serviceName:@"com.apple.proactive.PersonalizationPortrait.Topic.readOnly" allowedServerInterface:v6 allowedClientInterface:v7 requestHandler:v11 validateConnection:v10 setupClientProxy:v18 interruptionHandler:v16 invalidationHandler:v14];
...
BOOL __68__PPTopicReadOnlyServerDelegate_listener_shouldAcceptNewConnection___block_invoke(uint64_t a1, void *a2, uint64_t a3)
{
  ...
  v8 = [PPXPCServerHelper checkForAndLogTrueBooleanEntitlement:@"com.apple.proactive.PersonalizationPortrait.Topic.readOnly" connection:v6 serviceName:@"com.apple.proactive.PersonalizationPortrait.Topic.readOnly"];
  return v8;
}
...
{
  v3.receiver = self;
  v3.super_class = PPTopicReadOnlyServerDelegate;
