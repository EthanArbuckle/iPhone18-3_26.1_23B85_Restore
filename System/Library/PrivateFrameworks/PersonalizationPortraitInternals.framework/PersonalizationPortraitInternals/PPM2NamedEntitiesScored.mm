...
- (void)mergeFrom:(id)from
{
  ...
  if (*(fromCopy + 2))
  {
    [(PPM2NamedEntitiesScored *)self setBundleId:?];
    fromCopy = v6;
  }
...
LABEL_10:
  if (*(fromCopy + 1))
  {
    [(PPM2NamedEntitiesScored *)self setActiveTreatments:?];
    fromCopy = v6;
  }
}
...
- (id)description
{
  ...
  v8.receiver = self;
  v8.super_class = PPM2NamedEntitiesScored;
  v4 = [(PPM2NamedEntitiesScored *)&v8 description];
  dictionaryRepresentation = [(PPM2NamedEntitiesScored *)self dictionaryRepresentation];
