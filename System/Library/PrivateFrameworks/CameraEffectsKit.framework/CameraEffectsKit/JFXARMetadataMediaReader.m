...
- (id)arMetadataItemForTime:(id *)a3
{
  ...
  v6 = [(JFXARMetadataMediaReader *)self signPostID];
  ...
  *&time.timescale = &time;
  ...
  v11 = [(JFXARMetadataMediaReader *)self signPostID];
  if (v11 - 1 <= 0xFFFFFFFFFFFFFFFDLL && os_signpost_enabled(v10))
  {
    *v14 = 0;
    _os_signpost_emit_with_name_impl(&dword_242A3B000, v10, OS_SIGNPOST_INTERVAL_END, v11, "arMetadataItemForTime", &unk_242B66C87, v14, 2u);
  }
...
- (id)JFX_ARMetadataFromMetadataReaderItem:(id)a3
{
  v4 = a3;
  v5 = [v4 identifier];
  v6 = [v5 hasSuffix:s_JFXARMetadataClassName];
  ...
  if (v6)
  {
    ...
    v9 = [v4 data];
    v13 = 0;
    v10 = [v7 unarchivedObjectOfClass:v8 fromData:v9 error:&v13];
    v11 = v13;
...
- ($AC64C642040120CEEAD84DEEACA9A5CE)readableTimeRange
{
  ...
  v15 = 0u;
  v16 = 0u;
  v5 = [(JFXARMetadataMediaReader *)self synchronizationQueue];
...
- (NSString)name
{
  v2 = [(JFXARMetadataMediaReader *)self reader];
  v3 = [v2 name];
