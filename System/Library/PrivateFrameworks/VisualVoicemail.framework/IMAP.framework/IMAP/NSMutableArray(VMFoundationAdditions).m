...
- (uint64_t)vf_insertObject:()VMFoundationAdditions usingComparator:allowDuplicates:
{
  v8 = a3;
  v9 = a4;
  v10 = [a1 vf_indexWhereObjectWouldBeInserted:v8 usingComparator:v9];
  v11 = v10;
...
- (uint64_t)vf_insertObject:()VMFoundationAdditions usingSortFunction:context:allowDuplicates:
{
  ...
  v10 = [a1 vf_insertObject:v8 usingComparator:v9 allowDuplicates:{a6, v12, v13, v14, v15, v16, v17}];
