...
LABEL_5:
  ...
  else
  {
    ...
    v24 = [v8 customConsumer];

    if (v24)
    {
      v25 = [v8 customConsumer];
      [v23 addDataConsumer:v25];
    }

    v26 = [MEMORY[0x277CBEB38] dictionary];
    v27 = [MEMORY[0x277CBEB18] arrayWithObject:v8];
    [v26 setObject:v27 forKeyedSubscript:@"MFAttachmentAttachmentKey"];

    [v26 setObject:v40 forKeyedSubscript:@"MFAttachmentPrimaryConsumerKey"];
    [v26 setObject:v23 forKeyedSubscript:@"MFAttachmentCollectionFilterKey"];
    [v26 setObject:v22 forKeyedSubscript:@"MFAttachmentSyncLockKey"];
    v28 = vm_imap_log();
    ...
    [v33 retainArguments];
    v34 = [v33 monitor];
    [v26 setObject:v34 forKeyedSubscript:@"MFAttachmentMonitorKey"];

    [(NSMutableDictionary *)self->super._attachments setObject:v26 forKeyedSubscript:v29];
  ...
  if (v6)
  {
    ...
    do
    {
      for (i = 0; i != v7; ++i)
      {
        ...
        v10 = *(*(&v16 + 1) + 8 * i);
        if ([v10 rangeOfString:v4] != 0x7FFFFFFFFFFFFFFFLL)
        {
...
- (id)_composeAttachmentDataProviderForContext:(id)a3
{
  ...
  v5 = [MEMORY[0x277CCACA8] stringWithFormat:@"x-attach-compose://%@", a3];
  v6 = [v4 URLWithString:v5];

  providers = self->super._providers;
  v8 = [v6 absoluteString];
  v9 = [(NSMutableDictionary *)providers valueForKey:v8];
...
- (void)removeAttachmentForURL:(id)a3
{
  ...
  v7 = [(NSMutableArray *)composeAttachmentURLs indexOfObject:v6];
...
{
  v7 = a3;
  v6 = [(MFAttachmentComposeManager *)self _composeAttachmentDataProviderForContext:a4];
  objc_opt_class();
  if (objc_opt_isKindOfClass())
  {
    [v6 recordPasteboardDataForAttachments:v7];
  }
}
...
- (void)recordUndoAttachmentsForURLs:(id)a3 forContextID:(id)a4
{
  ...
  if (objc_opt_isKindOfClass())
  {
    [v6 recordUndoDataForAttachments:v7];
  }
}
