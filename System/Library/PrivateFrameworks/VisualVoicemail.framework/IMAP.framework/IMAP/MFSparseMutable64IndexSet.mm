...
- (void)addIndexes:(id)indexes
{
  ...
  {
    -[MFSparseMutable64IndexSet _incrementStorageIfNecessaryForCount:](self, "_incrementStorageIfNecessaryForCount:", [indexesCopy count]);
    firstIndex = [indexesCopy firstIndex];
    if (firstIndex != 0x7FFFFFFFFFFFFFFFLL)
    {
      for (i = firstIndex; i != 0x7FFFFFFFFFFFFFFFLL; i = [indexesCopy indexGreaterThanIndex:i])
      {
