...
- (id)authenticatorForAccount:(id)a3 connection:(id)a4
{
  ...
  if ([v8 containsObject:@"XOAUTH2"])
  {
    ...
    if (v10)
    {
      ...
      v11 = [(MFAuthScheme *)&v14 authenticatorForAccount:v6 connection:v7];
      goto LABEL_6;
    }
  }
...
{
  v6 = a4;
  v7 = [(objc_class *)a3 conformsToProtocol:&unk_288196A08];
  v9.receiver = self;
  v9.super_class = MFOAuth2TokenAuthScheme;
  LOBYTE(a3) = [(MFAuthScheme *)&v9 canAuthenticateAccountClass:a3 connection:v6];
