...
- (id)authenticatorForAccount:(id)account connection:(id)connection
{
  ...
  if ([authenticationMechanisms containsObject:@"XOAUTH2"])
  {
    ...
    if (v10)
    {
      ...
      v11 = [(MFAuthScheme *)&v14 authenticatorForAccount:accountCopy connection:connectionCopy];
      goto LABEL_6;
    }
  }
  ...
  v12 = [MFAuthScheme schemeWithName:@"PLAIN-CLIENTTOKEN"];
...
{
  connectionCopy = connection;
  v7 = [(objc_class *)class conformsToProtocol:&unk_288196A08];
  v9.receiver = self;
  v9.super_class = MFOAuth2TokenAuthScheme;
  LOBYTE(class) = [(MFAuthScheme *)&v9 canAuthenticateAccountClass:class connection:connectionCopy];
