...
{
  v2.receiver = self;
  v2.super_class = MFIMAPConnectionFlagSearchResults;
  [(MFIMAPConnectionFlagSearchResults *)&v2 dealloc];
}
  ...
  if (v5)
  {
    ...
    do
    {
      for (i = 0; i != v5; ++i)
      {
        ...
        v10 = IMAP_DescriptionForMessageFlags([v8 unsignedLongLongValue]);
        [v3 appendFormat:@"\n\t%@ set %@", v10, v9];
      }
  ...
  if (v12)
  {
    ...
    do
    {
      for (j = 0; j != v12; ++j)
      {
        ...
        v17 = IMAP_DescriptionForMessageFlags([v15 unsignedLongLongValue]);
        [v3 appendFormat:@"\n\t%@ unset %@", v17, v16, v20];
      }
