...
LABEL_10:
      if (v7 && v5 + v6 > v8)
      {
        ...
        v35.location = v8;
        v35.length = v5 + v6 - v8;
        CFStringGetCharacters(v1, v35, (v17 + v16));
      }
    ...
    else
    {
      ...
      v39.location = v11 + 1;
      v39.length = v12;
      if (CFStringFindCharacterFromSet(v1, MutableCopy, v39, 0, 0))
      {
        goto LABEL_10;
      }
    ...
    if (!v7)
    {
      ...
      if (v8)
      {
        ...
        v36.location = 0;
        v36.length = v8;
        CFStringGetCharacters(v1, v36, v24);
      }
    }
    ...
    if (v11 > v8)
    {
      ...
      v37.location = v8;
      v37.length = v11 - v8;
      CFStringGetCharacters(v1, v37, (v26 + v25));
    }
...
LABEL_23:
  ...
  if (v7)
  {
    if (v2)
    {
      ...
      v38.location = v8;
      v38.length = v2;
      CFStringGetCharacters(v1, v38, (v30 + v29));
    }
