...
- (_VFCombineLatestObservable)initWithObservables:(id)a3;
- (id)subscribe:(id)a3;
@end
...
- (id)subscribe:(id)a3
{
  ...
  v6 = [(_VFCombineLatestObservable *)self observables];
  v7 = [(_VFCombineLatestObservableSubscription *)v5 initWithObservables:v6];
  v8 = [(_VFCombineLatestObservableSubscription *)v7 subscribe:v4];
