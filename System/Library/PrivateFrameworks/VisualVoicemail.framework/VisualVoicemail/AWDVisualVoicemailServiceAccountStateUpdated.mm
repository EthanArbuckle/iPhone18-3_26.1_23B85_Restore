...
- (id)description
{
  ...
  dictionaryRepresentation = [(AWDVisualVoicemailServiceAccountStateUpdated *)self dictionaryRepresentation];
...
LABEL_11:
  ...
  if (*&self->_has)
  {
    if ((*(equalCopy + 24) & 1) == 0 || self->_serviceState != *(equalCopy + 1))
    {
      goto LABEL_11;
    }
