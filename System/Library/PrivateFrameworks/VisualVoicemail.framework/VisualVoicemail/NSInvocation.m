...
- (id)argumentDescriptionForIndex:(int64_t)a3
{
  ...
  v6 = [v5 getArgumentTypeAtIndex:a3];
  ...
  if (v7 > 0x5D)
  {
    if (v7 > 104)
    {
      if (v7 > 113)
      {
        if (v7 == 114)
        {
          v8 = [(NSInvocation *)self cStringDescriptionAtIndex:a3];
          goto LABEL_41;
        }

        if (v7 == 115)
        {
          v8 = [(NSInvocation *)self shortDescriptionAtIndex:a3];
          goto LABEL_41;
        }
      }
      ...
      else
      {
        if (v7 == 105)
        {
          v8 = [(NSInvocation *)self intDescriptionAtIndex:a3];
          goto LABEL_41;
        }

        if (v7 == 113)
        {
          v8 = [(NSInvocation *)self longDescriptionAtIndex:a3];
          goto LABEL_41;
        }
      }
    }
    ...
    else if (v7 > 99)
    {
      if (v7 == 100)
      {
        v8 = [(NSInvocation *)self doubleDescriptionAtIndex:a3];
        goto LABEL_41;
      }

      if (v7 == 102)
      {
        v8 = [(NSInvocation *)self floatDescriptionAtIndex:a3];
        goto LABEL_41;
      }
    }
    ...
    else
    {
      if (v7 == 94)
      {
        v8 = [(NSInvocation *)self pointerDescriptionAtIndex:a3];
        goto LABEL_41;
      }

      if (v7 == 99)
      {
        v8 = [(NSInvocation *)self charDescriptionAtIndex:a3];
        goto LABEL_41;
      }
    }
  }
  ...
  else if (v7 > 67)
  {
    if (v7 > 80)
    {
      if (v7 == 81)
      {
        v8 = [(NSInvocation *)self unsignedLongDescriptionAtIndex:a3];
        goto LABEL_41;
      }

      if (v7 == 83)
      {
        v8 = [(NSInvocation *)self unsignedShortDescriptionAtIndex:a3];
        goto LABEL_41;
      }
    }
    ...
    else
    {
      if (v7 == 68)
      {
        v8 = [(NSInvocation *)self longDoubleDescriptionAtIndex:a3];
        goto LABEL_41;
      }

      if (v7 == 73)
      {
        v8 = [(NSInvocation *)self unsignedIntDescriptionAtIndex:a3];
        goto LABEL_41;
      }
    }
  }
  ...
  else
  {
    ...
    if (v7 == 58)
    {
      v8 = [(NSInvocation *)self selectorDescriptionAtIndex:a3];
      goto LABEL_41;
    }

    if (v7 == 64)
    {
      v8 = [(NSInvocation *)self objectDescriptionAtIndex:a3];
      goto LABEL_41;
    }
  }
