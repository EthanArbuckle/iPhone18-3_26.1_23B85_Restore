...
- (id)description
{
  ...
  dictionaryRepresentation = [(AWDVisualVoicemailTranscriptionStatusChanged *)self dictionaryRepresentation];
...
LABEL_16:
  ...
  if ((*&self->_has & 2) != 0)
  {
    if ((*(equalCopy + 32) & 2) == 0 || self->_status != *(equalCopy + 2))
    {
      goto LABEL_16;
    }
  }
