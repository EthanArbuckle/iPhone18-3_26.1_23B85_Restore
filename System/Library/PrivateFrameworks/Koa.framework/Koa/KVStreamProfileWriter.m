...
- (BOOL)addItem:(id)a3 error:(id *)a4
{
  ...
  if (!objc_msgSend_length(v13, v14, v15, v16, v17, v18))
  {
    ...
    v48 = objc_msgSend_stringWithFormat_(MEMORY[0x277CCACA8], v19, @"Invalid item %@", v21, v22, v23, v6);
    v59[0] = v48;
  ...
  {
    v55 = objc_msgSend_stringWithFormat_(MEMORY[0x277CCACA8], v42, @"profile item: %@ buffer: %@", v43, v44, v45, v6, v13);
    sub_2559C6434(a4, v55, self->_stream, 2);
...
- (BOOL)startDataset:(id)a3 error:(id *)a4
{
  ...
  if (v19 != v41)
  {
    v42 = objc_msgSend_stringWithFormat_(MEMORY[0x277CCACA8], v37, @"profile datasetInfo: %@ buffer: %@", v38, v39, v40, v6, v13);
    sub_2559C6434(a4, v42, self->_stream, 2);
  }
...
- (BOOL)startProfile:(id)a3 error:(id *)a4
{
  ...
  if (v13 != v35)
  {
    v36 = objc_msgSend_stringWithFormat_(MEMORY[0x277CCACA8], v31, @"profile header: %@ with info: %@", v32, v33, v34, v7, v6);
    sub_2559C6434(a4, v36, self->_stream, 2);
  }
