...
- (BOOL)removeItemWithItemId:(id)a3 error:(id *)a4
{
  ...
  v20 = 0;
  v16 = objc_msgSend_removeItemWithSourceItemIdentifier_error_(v12, v13, v6, &v20, v14, v15);
...
- (BOOL)addOrUpdateItem:(id)a3 error:(id *)a4
{
  ...
  if (v11)
  {
    updated = objc_msgSend_addOrUpdateCascadeItem_error_(self, v8, v11, a4, v9, v10);
  }
...
- (BOOL)addOrUpdateCascadeItem:(id)a3 error:(id *)a4
{
  ...
  v12 = objc_msgSend_donation(self, v7, v8, v9, v10, v11);
  v20 = 0;
  updated = objc_msgSend_addOrUpdateItem_error_(v12, v13, v6, &v20, v14, v15);
