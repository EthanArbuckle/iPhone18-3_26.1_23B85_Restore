...
- (BOOL)finishProfile:(id *)a3
{
  ...
  if (v19 != v41)
  {
    ...
    sub_2559C6434(a3, v42, self->_stream, 3);
  }
...
LABEL_14:
      ...
      v106 = objc_msgSend_stringWithFormat_(MEMORY[0x277CCACA8], v92, @"item: %@ data: %@", v93, v94, v95, v10, v63);
      sub_2559C6434(a4, v106, self->_stream, 3);
    }
    ...
    else
    {
      ...
      v98 = objc_msgSend_stringWithFormat_(MEMORY[0x277CCACA8], v69, @"Invalid item %@", v71, v72, v73, v10);
      v110[0] = v98;
  ...
  sub_2559C6434(a4, v105, self->_stream, 3);
...
- (BOOL)startDataset:(id)a3 error:(id *)a4
{
  ...
  if (v11 >= 2)
  {
    ...
    if (v18 != objc_msgSend_write_maxLength_(stream, v33, v26, v32, v34, v35))
    {
      ...
      sub_2559C6434(a4, v92, self->_stream, 3);
      v90 = 0;
      goto LABEL_8;
    }
  }
  ...
  v49 = objc_msgSend_JSONWithIndent_(v10, v45, 4, v46, v47, v48);
  ...
  if (!v90)
  {
    ...
    sub_2559C6434(a4, v91, self->_stream, 3);
  }
...
- (BOOL)startProfile:(id)a3 error:(id *)a4
{
  ...
  v17 = objc_msgSend_JSONWithIndent_(v6, v13, 1, v14, v15, v16);
  ...
  if (v36 != v58)
  {
    ...
    sub_2559C6434(a4, v59, self->_stream, 3);
  }
