...
- (BOOL)enumerateItemsWithError:(id *)a3 usingBlock:(id)a4
{
  ...
  if (*v10->var0 >= 7u && (v11 = *v10[6].var0) != 0 && (v12 = *dataset[v11].var0, v13 = &dataset[v11 + v12], v14 = *v13->var0, v14))
  {
    ...
    while (1)
    {
      ...
      v21 = [KVItem alloc];
      v23 = objc_msgSend_initWithBuffer_verify_copy_error_(v21, v22, v20, 1, 0, a3);
      if (!v23 || (v8[2](v8, v23) & 1) == 0)
      {
        break;
      }
...
- (KVEmbeddedDatasetReader)initWithData:(id)a3 dataset:(const Dataset *)a4 error:(id *)a5
{
  ...
  v20 = objc_msgSend_initWithBuffer_error_(v16, v17, v15, a5, v18, v19);
