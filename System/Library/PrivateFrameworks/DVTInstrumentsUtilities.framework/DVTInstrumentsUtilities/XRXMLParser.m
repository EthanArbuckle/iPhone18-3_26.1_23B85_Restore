...
+ (BOOL)parseStream:(id)a3 topLevelParser:(id)a4 delegate:(id)a5
{
  ...
  v14 = objc_msgSend_initWithTopLevelParser_(v10, v11, v8, v12, v13);
  objc_msgSend_setDelegate_(v14, v15, v9, v16, v17);
...
- (XRXMLParser)initWithTopLevelParser:(id)a3
{
  ...
  if (v6)
  {
    if (v5)
    {
      objc_storeStrong(&v6->_topLevelElementParser, a3);
    }
...
- (BOOL)parseData:(id)a3
{
  ...
  v19 = objc_msgSend_parseData_(parser, v4, v7, v5, v6);
...
- (void)parser:(id)a3 didStartElement:(id)a4 namespaceURI:(id)a5 qualifiedName:(id)a6 attributes:(id)a7
{
  ...
  if (workingElement)
  {
    ...
    v28 = objc_msgSend_startElementWithName_attributes_line_col_(workingElement, v23, v10, v15, v17, v22);
    if (v28)
    {
