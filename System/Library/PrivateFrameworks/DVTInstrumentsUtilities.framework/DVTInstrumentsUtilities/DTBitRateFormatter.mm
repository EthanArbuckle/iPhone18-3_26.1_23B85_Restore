...
+ (id)stringForLongLong:(int64_t)long
{
  v10 = objc_msgSend_magnitudeFormatter(DTBytesFormatter, a2, long, v3, v4);
  if (long >= 0)
  {
    longCopy = long;
  }
  ...
  if (longCopy < 0xE8D4A51000)
  {
    if (longCopy < 0x3B9ACA00)
    {
      if (longCopy < 0xF4240)
      {
        ...
        if (longCopy < 0x3E8)
        {
          v13 = objc_msgSend_numberWithLongLong_(MEMORY[0x277CCABB0], v6, long, v8, v9);
        ...
        {
          v13 = objc_msgSend_numberWithDouble_(MEMORY[0x277CCABB0], v6, v7, v8, v9, long / 1000.0);
      ...
      else
      {
        ...
        v13 = objc_msgSend_numberWithDouble_(MEMORY[0x277CCABB0], v6, v7, v8, v9, long / 1000000.0);
    ...
    else
    {
      ...
      v13 = objc_msgSend_numberWithDouble_(MEMORY[0x277CCABB0], v6, v7, v8, v9, long / 1000000000.0);
  ...
  else
  {
    ...
    v13 = objc_msgSend_numberWithDouble_(MEMORY[0x277CCABB0], v6, v7, v8, v9, long / 1.0e12);
...
- (id)stringForObjectValue:(id)value
{
  ...
  {
    v8 = objc_msgSend_longLongValue(valueCopy, v4, v5, v6, v7);
