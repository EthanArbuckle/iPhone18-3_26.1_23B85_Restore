...
{
  v4 = a3;
  v11 = objc_msgSend_ticket(v4, v5, v6, v7, v8);
  objc_msgSend__prepareAgentToExecute_withTicket_(self, v9, v4, v11, v10);
}

- (void)_runAgentEpilogue:(id)a3
{
  v15 = a3;
  v8 = objc_msgSend_ticket(v15, v4, v5, v6, v7);
  objc_msgSend__escortAgentToExit_withTicket_(self, v9, v15, v8, v10);
...
{
  v13 = a3;
  objc_msgSend__runAgentPrologue_(self, v4, v13, v5, v6);
  objc_msgSend__executeAgent_(self, v7, v13, v8, v9);
  objc_msgSend__runAgentEpilogue_(self, v10, v13, v11, v12);
}
...
- (void)receiveMobileAgent:(id)a3
{
  ...
  {
    objc_msgSend__welcomeAgent_(self, v9, v4, v10, v11);
  }
}
...
- (void)_welcomeAgents:(id)a3
{
  ...
  if (!v8)
  {
    objc_msgSend__welcomeAgent_(self, v5, v4, v6, v7);
LABEL_10:
    executionQueue = self->_executionQueue;
