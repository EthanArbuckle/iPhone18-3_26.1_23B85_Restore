...
- (id)requestByEncodingRequest:(id)request parameters:(id)parameters
{
  ...
  if (objc_opt_isKindOfClass())
  {
    ...
    if (self)
    {
      if (sub_10033D488(self->_requestProperties))
      {
        ...
        [parametersCopy setObject:v10 forKeyedSubscript:@"guid"];
      }
      ...
      if ((sub_10033CD18(self->_requestProperties) - 3) >= 0xFFFFFFFFFFFFFFFELL)
      {
        ...
        v32 = 0;
        v15 = [v12 keybagSyncDataWithAccountID:ams_DSID transactionType:1 error:&v32];
        v16 = v32;
  ...
  v24 = [(URLRequestEncoder *)&v29 requestByEncodingRequest:v23 parameters:parametersCopy];
