...
+ (id)allocWithZone:(_NSZone *)zone
{
  ...
  v7.receiver = self;
  v7.super_class = &OBJC_METACLASS___ECGSSAPIAuthScheme;
...
+ (ECGSSAPIAuthScheme)gssapiAuthScheme
{
  ...
  v2 = gssapiAuthScheme_sharedInstance;
...
{
  v3.receiver = *(a1 + 32);
  v3.super_class = &OBJC_METACLASS___ECGSSAPIAuthScheme;
...
- (void)dealloc
{
  ...
  v5.receiver = self;
  v5.super_class = ECGSSAPIAuthScheme;
