...
+ (id)allocWithZone:(_NSZone *)a3
{
  ...
  v7.receiver = a1;
  v7.super_class = &OBJC_METACLASS___ECOAuth2AuthScheme;
...
+ (ECOAuth2AuthScheme)oauth2AuthScheme
{
  ...
  v2 = oauth2AuthScheme_sharedInstance;
...
{
  v3.receiver = *(a1 + 32);
  v3.super_class = &OBJC_METACLASS___ECOAuth2AuthScheme;
...
- (void)dealloc
{
  ...
  v5.receiver = self;
  v5.super_class = ECOAuth2AuthScheme;
