...
- (void)prepareForReuse
{
  ...
  v5 = &v10 - v4;
  v6 = type metadata accessor for ContentUnavailableFixedHeightCell();
  v11.receiver = self;
  v11.super_class = v6;
  v7 = self;
  ...
  swift_endAccess();
  [*(&v7->super.super.super.super.super.isa + OBJC_IVAR____TtC9SeymourUI33ContentUnavailableFixedHeightCell_contentUnavailableView) smu:0 updateWithType:0 text:0 secondaryText:0 image:0 buttonTitle:0 buttonPrimaryAction:?];
}
...
- (CGSize)systemLayoutSizeFittingSize:(CGSize)a3 withHorizontalFittingPriority:(float)a4 verticalFittingPriority:(float)a5
{
  ...
  width = a3.width;
  v9 = self;
  v10 = [(ContentUnavailableFixedHeightCell *)v9 contentView];
  *&v11 = a4;
  *&v12 = a5;
