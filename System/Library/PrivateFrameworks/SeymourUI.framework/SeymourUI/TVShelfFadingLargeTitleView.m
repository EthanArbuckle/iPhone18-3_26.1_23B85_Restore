...
- (void)applyLayoutAttributes:(id)a3
{
  ...
  v7 = &v14 - v6;
  v8 = type metadata accessor for TVShelfFadingLargeTitleView();
  v15.receiver = self;
  v15.super_class = v8;
  v9 = a3;
  v10 = self;
  ...
  v12 = sub_20C133244();
  (*(*(v12 - 8) + 56))(v7, 0, 1, v12);
  v13 = OBJC_IVAR____TtC9SeymourUI27TVShelfFadingLargeTitleView_indexPath;
  swift_beginAccess();
...
{
  v4.receiver = self;
  v4.super_class = type metadata accessor for TVShelfFadingLargeTitleView();
  v2 = v4.receiver;
