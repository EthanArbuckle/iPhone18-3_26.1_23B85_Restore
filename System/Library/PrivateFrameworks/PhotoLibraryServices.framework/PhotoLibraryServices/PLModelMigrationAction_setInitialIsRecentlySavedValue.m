...
- (int64_t)performActionWithManagedObjectContext:(id)a3 error:(id *)a4
{
  ...
  v56[1] = 3221225472;
  v56[2] = __101__PLModelMigrationAction_setInitialIsRecentlySavedValue_performActionWithManagedObjectContext_error___block_invoke;
  v56[3] = &unk_1E7575B30;
  v20 = v8;
  v57 = v20;
  v55[0] = MEMORY[0x1E69E9820];
  v55[1] = 3221225472;
  v55[2] = __101__PLModelMigrationAction_setInitialIsRecentlySavedValue_performActionWithManagedObjectContext_error___block_invoke_2;
  v55[3] = &unk_1E7572E50;
  v55[4] = self;
  v55[5] = v62;
  v54[0] = MEMORY[0x1E69E9820];
  v54[1] = 3221225472;
  v54[2] = __101__PLModelMigrationAction_setInitialIsRecentlySavedValue_performActionWithManagedObjectContext_error___block_invoke_3;
  v54[3] = &unk_1E756DD18;
  v54[4] = self;
  v54[5] = &v64;
  v54[6] = &v70;
  ...
  if (v23)
  {
    ...
    if (!v27)
    {
      ...
      [v31 logWithMessage:v30 fromCodeLocation:"PLModelMigrationActionBackground.m" type:{1162, 0}];
...
LABEL_15:
    ...
    if (os_log_type_enabled(v43, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *buf = 134217984;
      *&buf[4] = v44;
      _os_log_impl(&dword_19BF1F000, v43, OS_LOG_TYPE_DEFAULT, "Set initial isRecentlySaved for %tu assets.", buf, 0xCu);
    }
  }
  ...
  else
  {
    ...
    if (!v36)
    {
      ...
      [v42 logWithMessage:v41 fromCodeLocation:"PLModelMigrationActionBackground.m" type:{1165, 16}];
