...
- (BOOL)appendSnapshotWithJournal:(id)journal usingManagedObjectContext:(id)context changedKeys:(id)keys entryLimit:(unint64_t)limit error:(id *)error;
- (BOOL)createSnapshotWithJournal:(id)journal createOnlyIfNecessary:(BOOL)necessary usingManagedObjectContext:(id)context entryLimit:(unint64_t)limit error:(id *)error;
- (BOOL)saveHistoryToken:(id)token error:(id *)error;
- (PLJournalManagerCore)init;
- (PLJournalManagerCore)initWithName:(id)name baseURL:(id)l payloadClasses:(id)classes;
...
- (id)_objectEnumeratorForJournal:(id)journal usingManagedObjectContext:(id)context error:(id *)error
{
  journalCopy = journal;
  contextCopy = context;
  payloadClass = [journalCopy payloadClass];
  relationshipKeyPathsForPrefetching = [payloadClass relationshipKeyPathsForPrefetching];
  v13 = [objc_msgSend(journalCopy "payloadClass")];
  if (!v13)
  {
    currentHandler = [MEMORY[0x1E696AAA8] currentHandler];
    v21 = [objc_msgSend(journalCopy "payloadClass")];
    [currentHandler handleFailureInMethod:a2 object:self file:@"PLJournalManagerCore.m" lineNumber:218 description:{@"nil entityName for payloadClassID: %@", v21}];
  }

  v14 = [MEMORY[0x1E695D5E0] fetchRequestWithEntityName:v13];
  [v14 setFetchBatchSize:100];
  [v14 setReturnsObjectsAsFaults:0];
  [v14 setRelationshipKeyPathsForPrefetching:relationshipKeyPathsForPrefetching];
  v15 = [objc_msgSend(journalCopy "payloadClass")];
  [v14 setSortDescriptors:v15];

  [v14 setShouldRefreshRefetchedObjects:1];
  [v14 setIncludesSubentities:0];
  v16 = [payloadClass fetchPredicateInContext:contextCopy];
...
- (BOOL)appendSnapshotWithJournal:(id)journal usingManagedObjectContext:(id)context changedKeys:(id)keys entryLimit:(unint64_t)limit error:(id *)error
{
  ...
  keysCopy = keys;
  v32 = 0;
  v15 = [(PLJournalManagerCore *)self _objectEnumeratorForJournal:journalCopy usingManagedObjectContext:contextCopy error:&v32];
  v16 = v32;
  v17 = v16;
  if (v15)
  {
...
- (BOOL)createSnapshotWithJournal:(id)journal createOnlyIfNecessary:(BOOL)necessary usingManagedObjectContext:(id)context entryLimit:(unint64_t)limit error:(id *)error
{
  ...
  contextCopy = context;
  v30 = 0;
  v14 = [(PLJournalManagerCore *)self _objectEnumeratorForJournal:journalCopy usingManagedObjectContext:contextCopy error:&v30];
  v15 = v30;
  v16 = v15;
  if (v14)
  {
    ...
    v26 = journalCopy;
    v23 = v16;
    v17 = [v26 createSnapshotUsingNextPayloadBlock:v24 createOnlyIfNecessary:necessaryCopy error:&v23];
    v18 = v23;
...
- (id)_nextValidPayloadWithObjectEnumerator:(id)enumerator changedKeys:(id)keys payloadClass:(Class)class
{
  ...
  if (nextObject)
  {
    *&v11 = 138543618;
    ...
    do
    {
      v12 = [(objc_class *)class payloadAdapterForManagedObject:nextObject, v21];
      payloadID = [v12 payloadID];
      if (payloadID)
      {
        v14 = [v12 payloadForChangedKeys:keysCopy];
        if (v14)
        {
          v19 = v14;
...
- (BOOL)saveHistoryToken:(id)token error:(id *)error
{
  ...
  {
    currentHandler = [MEMORY[0x1E696AAA8] currentHandler];
    [currentHandler handleFailureInMethod:a2 object:self file:@"PLJournalManagerCore.m" lineNumber:128 description:{@"Invalid parameter not satisfying: %@", @"token"}];
  }
  ...
  v10 = [MEMORY[0x1E696ACC8] archivedDataWithRootObject:tokenCopy requiringSecureCoding:1 error:0];
  v16 = @"currentHistoryToken";
  v17[0] = v10;
  v11 = [MEMORY[0x1E695DF20] dictionaryWithObjects:v17 forKeys:&v16 count:1];
  v12 = [MEMORY[0x1E696AE40] dataWithPropertyList:v11 format:200 options:0 error:0];
  v13 = [PLJournalFile writeData:v12 toURL:self->_historyTokenURL atomically:1 error:error];
...
- (id)readHistoryTokenWithError:(id *)error
{
  ...
  historyTokenURL = [(PLJournalManagerCore *)self historyTokenURL];
  v6 = [v4 dataWithContentsOfURL:historyTokenURL options:1 error:error];

  if (v6)
  {
    v13 = 0;
    v7 = [MEMORY[0x1E696AE40] propertyListWithData:v6 options:0 format:&v13 error:error];
    v8 = [v7 objectForKeyedSubscript:@"currentHistoryToken"];
    if (v8)
    {
      v9 = [MEMORY[0x1E696ACD0] unarchivedObjectOfClass:objc_opt_class() fromData:v8 error:error];
      v10 = v9;
      if (v9)
      {
        v11 = [v9 copy];
...
- (PLJournalManagerCore)initWithName:(id)name baseURL:(id)l payloadClasses:(id)classes
{
  ...
  if (v12)
  {
    ...
    objc_storeStrong(&v13->_payloadClasses, classes);
    ...
    v26[3] = &unk_1E756A0C0;
    v27 = v13;
    [classesCopy enumerateObjectsUsingBlock:v26];
  }
