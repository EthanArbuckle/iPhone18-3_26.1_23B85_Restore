      ...
      if (!v55[5])
      {
        ...
        if (v17)
        {
          ...
          else
          {
            ...
            [v23 logWithMessage:v22 fromCodeLocation:"PLModelMigrationActionStaged.m" type:{93, 16}];
  ...
  else
  {
    ...
    if (v25)
    {
      ...
      else
      {
        ...
        [v33 logWithMessage:v32 fromCodeLocation:"PLModelMigrationActionStaged.m" type:{97, 16}];
