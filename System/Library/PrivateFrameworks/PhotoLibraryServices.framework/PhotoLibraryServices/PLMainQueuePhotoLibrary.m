...
+ (id)systemMainQueuePhotoLibrary
{
  ...
  if (!sharedInstance)
  {
    ...
    v15 = 0;
    v5 = +[PLPhotoLibrary newPhotoLibraryWithName:loadedFromURL:options:error:](PLMainQueuePhotoLibrary, "newPhotoLibraryWithName:loadedFromURL:options:error:", "+[PLMainQueuePhotoLibrary systemMainQueuePhotoLibrary]", v3, v4, &v15);
    v6 = v15;
    v7 = sharedInstance;
    sharedInstance = v5;
