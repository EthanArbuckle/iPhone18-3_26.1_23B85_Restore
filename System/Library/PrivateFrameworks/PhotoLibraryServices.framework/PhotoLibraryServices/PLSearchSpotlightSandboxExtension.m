...
- (BOOL)_acquireSpotlightSandboxExtensionWithPathManager:(id)a3;
- (PLSearchSpotlightSandboxExtension)initWithPathManager:(id)a3;
...
LABEL_19:
    ...
    v5 = [v4 spotlightSearchIndexPath];
...
- (PLSearchSpotlightSandboxExtension)initWithPathManager:(id)a3
{
  ...
  if (v5)
  {
    ...
    if (![(PLSearchSpotlightSandboxExtension *)v5 _acquireSpotlightSandboxExtensionWithPathManager:v4])
    {
