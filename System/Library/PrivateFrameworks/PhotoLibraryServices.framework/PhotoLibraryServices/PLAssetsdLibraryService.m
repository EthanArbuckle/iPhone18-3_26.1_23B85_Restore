...
- (id)_postRunningProgress
{
  v3 = [(PLAbstractLibraryServicesManagerService *)self libraryServicesManager];
  v4 = [v3 postRunningProgress];
  v5 = [(PLAssetsdLibraryService *)self _returnValueForProgress:v4 addTo:self->_postRunningProgressFollowers];
  ...
  *(&buf + 1) = &buf;
  ...
  if (v12)
  {
    if (v12 == 1)
    {
      ...
      p_buf = &buf;
      v41 = v11;
      v17 = [v14 donationProgressForMediaProcessingTaskID:v16 completionHandler:v40];
      v18 = v44[5];
      v44[5] = v17;
    ...
    else
    {
      ...
      v39 = &v43;
      v37 = v11;
      v25 = [v24 donationProgressForMediaProcessingTaskIDs:v6 completionHandler:v36];
...
- (void)proxyLockFileWithDatabasePath:(id)a3 reply:(id)a4
{
  ...
  v6 = a4;
  v7 = [v5 proxyLockFilePathForDatabasePath:a3];
  v6[2](v6, v7);
}
...
- (id)resetSocialGroupsWithReply:(id)a3
{
  ...
  *sel = 0u;
  ...
  v8 = [v7 newShortLivedLibraryWithName:"-[PLAssetsdLibraryService resetSocialGroupsWithReply:]"];

  v9 = [PLSocialGroup resetAllInLibrary:v8 completion:v4];
...
- (id)resetPersonsWithReply:(id)a3
{
  ...
  *sel = 0u;
  ...
  v6 = [(PLAbstractLibraryServicesManagerService *)self libraryServicesManager];
  v7 = [v6 databaseContext];
  v8 = [v7 newShortLivedLibraryWithName:"-[PLAssetsdLibraryService resetPersonsWithReply:]"];

  v9 = [PLPerson resetAllInLibrary:v8 completion:v4];
...
- (id)transferPersonsWithUuids:(id)a3 fromLibraryURL:(id)a4 transferOptions:(id)a5 reply:(id)a6
{
  ...
  *sel = 0u;
  ...
  if (v19)
  {
    ...
    v23 = [(PLAssetsdLibraryService *)self libraryBundle];
    v24 = [v22 transferPersons:v10 toBundle:v23 options:v12 completion:v13];
  }
...
- (id)transferAssetsWithUuids:(id)a3 fromLibraryURL:(id)a4 transferOptions:(id)a5 reply:(id)a6
{
  ...
  *sel = 0u;
  ...
  if (v19)
  {
    ...
    v23 = [(PLAssetsdLibraryService *)self libraryBundle];
    v24 = [v22 transferAssets:v10 toBundle:v23 options:v12 completion:v13];
  }
...
- (void)publishRemoteChangeEvent:(id)a3 delayedSaveActionsDetail:(id)a4 reply:(id)a5
{
  ...
  v9 = a4;
  v10 = a3;
  v11 = [(PLAssetsdLibraryService *)self libraryBundle];
  v13 = [v11 changeHandlingContainer];
...
- (void)automaticallyDeleteEmptyAlbumWithObjectURI:(id)a3 reply:(id)a4
{
  ...
  *sel = 0u;
  ...
  v27 = 0;
  v12 = [v11 awaitLibraryState:7 error:&v27];
  v13 = v27;
...
- (void)updateThumbnailsForPhotos:(id)a3 assignNewIndex:(BOOL)a4 forceRefresh:(BOOL)a5 reply:(id)a6
{
  ...
  *sel = 0u;
  ...
  v36 = 0;
  v16 = [v15 awaitLibraryState:6 error:&v36];
  v17 = v36;
  ...
  if (v16)
  {
    ...
    v20 = [v19 newShortLivedLibraryWithName:"-[PLAssetsdLibraryService updateThumbnailsForPhotos:assignNewIndex:forceRefresh:reply:]"];

    v21 = [v20 managedObjectContext];
    v22 = [v21 persistentStoreCoordinator];
...
- (void)repairSingletonObjectsWithReply:(id)a3
{
  ...
  *sel = 0u;
  ...
  v19 = 0;
  v9 = [v8 awaitLibraryState:6 error:&v19];
  v10 = v19;

  if (v9)
  {
    v11 = [(PLAbstractLibraryServicesManagerService *)self libraryServicesManager];
    v12 = [v11 modelMigrator];
...
- (void)recoverFromCrashIfNeeded
{
  ...
  *sel = 0u;
  ...
  v6 = [(PLAbstractLibraryServicesManagerService *)self libraryServicesManager];
  v17 = 0;
  v7 = [v6 awaitLibraryState:6 error:&v17];
  v8 = v17;
  ...
  else
  {
    ...
    {
      *buf = 0;
      _os_log_impl(&dword_19BF1F000, v10, OS_LOG_TYPE_ERROR, "LibraryServicesManager cannot get to the PreparingAccessible state", buf, 2u);
    }
  }
...
- (id)importFileSystemAssetsWithReason:(id)a3 force:(BOOL)a4 reply:(id)a5
{
  ...
  *sel = 0u;
  ...
  v14 = [(PLAbstractLibraryServicesManagerService *)self libraryServicesManager];
  v31 = 0;
  v15 = [v14 awaitLibraryState:6 error:&v31];
  v16 = v31;
...
- (void)getPhotoLibraryStoreXPCListenerEndpointWithReply:(id)a3
{
  ...
  v29 = 0;
  v6 = [v5 awaitLibraryState:7 error:&v29];
  v7 = v29;
  ...
  if (v6)
  {
    ...
    *sel = 0u;
    ...
    if (!xpcPhotoLibraryStoreContainer)
    {
      ...
      v13 = [v12 pathManager];
      v14 = [PLXPCPhotoLibraryStoreContainer newContainerWithPathManager:v13 connectionAuthorization:self->_connectionAuthorization];
    ...
    v16 = [(PLXPCPhotoLibraryStoreContainer *)xpcPhotoLibraryStoreContainer listenerEndpoint];
    v17 = PLGatekeeperXPCGetLog();
    if (os_log_type_enabled(v17, OS_LOG_TYPE_DEFAULT))
    {
      v18 = [(PLAbstractLibraryServicesManagerService *)self libraryServicesManager];
      v19 = [v18 pathManager];
      v20 = [(PLAssetsdConnectionAuthorization *)self->_connectionAuthorization trustedCallerBundleID];
      v21 = [(PLAssetsdConnectionAuthorization *)self->_connectionAuthorization clientProcessIdentifier];
      *buf = 134218754;
      v31 = v16;
      v32 = 2112;
      v33 = v19;
...
- (id)_returnValueForProgress:(id)a3 addTo:(id)a4
{
  v5 = a4;
  v6 = a3;
  v7 = [[PLProgressFollower alloc] initWithSourceProgress:v6 progressHandler:0];

  [v5 addObject:v7];
  v8 = [(PLProgressFollower *)v7 outputProgress];
...
{
  v3 = [(PLAbstractLibraryServicesManagerService *)self libraryServicesManager];
  v4 = [v3 preRunningProgress];
  v5 = [(PLAssetsdLibraryService *)self _returnValueForProgress:v4 addTo:self->_preRunningProgressFollowers];
...
- (id)upgradePhotoLibraryDatabaseWithOptions:(id)a3 reply:(id)a4
{
  ...
  *sel = 0u;
  ...
  v15 = [v14 path];
  LODWORD(v13) = [v11 fileExistsAtPath:v15 isDirectory:&v56];
  v16 = v56;
...
LABEL_13:
  ...
  v18 = [(PLAbstractLibraryServicesManagerService *)self libraryServicesManager];
  LOBYTE(v17) = [v17 shouldAutoUpgradeWellKnownPhotoLibraryIdentifier:{objc_msgSend(v18, "wellKnownPhotoLibraryIdentifier")}];
  ...
  if ((v17 & 1) == 0 && ![(PLAssetsdConnectionAuthorization *)self->_connectionAuthorization isClientAuthorizedForLibraryUpgrade])
  {
    ...
    v20 = [v19 isEqualToString:@"com.apple.migrationpluginwrapper"];
    ...
    if ((v20 & 1) == 0)
    {
      ...
      v25 = [v23 errorWithDomain:*MEMORY[0x1E69BFF48] code:41005 userInfo:v24];
      goto LABEL_13;
    }
  }

LABEL_14:
  v30 = [(PLAssetsdConnectionAuthorization *)self->_connectionAuthorization trustedCallerBundleID];
  v31 = [(PLAbstractLibraryServicesManagerService *)self libraryServicesManager];
  [v31 setUpgradeClient:v30];

  v32 = [v6 objectForKeyedSubscript:@"PLPhotoLibraryCreateOptions"];
  LOBYTE(v31) = [v32 unsignedIntegerValue];

  if ((v31 & 4) != 0)
  {
    v39 = [(PLAbstractLibraryServicesManagerService *)self libraryServicesManager];
    v40 = [v39 pathManager];

    [v40 setSqliteErrorForRebuildReason:10 allowsExit:0];
    v41 = [(PLAbstractLibraryServicesManagerService *)self libraryServicesManager];
    v42 = [v41 libraryBundle];
    ...
    [v42 unbindAssetsdService:WeakRetained];
    [(PLPhotoLibraryBundleController *)self->_libraryBundleController shutdownBundle:v42 reason:v45];
    v7[2](v7, 0, v45);
  ...
  v33 = [[PLLibraryOpenerCreationOptions alloc] initWithOptionsDictionary:v6 connectionAuthorization:self->_connectionAuthorization];
  v34 = [(PLAbstractLibraryServicesManagerService *)self libraryServicesManager];
  [v34 setCreateMode:0 options:v33];

  v35 = [(PLAbstractLibraryServicesManagerService *)self libraryServicesManager];
  v55 = 0;
  v36 = [v35 activate:&v55];
  v25 = v55;

  if (v36)
  {
    objc_initWeak(buf, self);
    v37 = [(PLAbstractLibraryServicesManagerService *)self libraryServicesManager];
    ...
    v52[4] = self;
    v53 = v7;
    [v37 awaitLibraryState:7 completionHandler:v52];

    objc_destroyWeak(&v54);
    objc_destroyWeak(buf);

    v38 = [(PLAssetsdLibraryService *)self _preRunningProgress];
    goto LABEL_20;
  }

LABEL_19:
  [(PLAssetsdLibraryService *)self _sendClientReply:v7 sandboxExtensionsByPath:0 error:v25];
  v38 = 0;
LABEL_20:
...
- (void)openPhotoLibraryDatabaseWithOptions:(id)a3 reply:(id)a4
{
  ...
  *sel = 0u;
  ...
  v11 = [(PLAssetsdLibraryService *)self newLibraryOpener];
  v31 = 0;
  v12 = [v11 openPhotoLibraryDatabaseWithAutoUpgrade:0 autoCreate:0 error:&v31];
  v13 = v31;
  if (v13)
  {
    v14 = 0;
  ...
  if (v14 == 1)
  {
    ...
    v18 = [v17 isEqualToString:@"com.apple.mediaanalysisd"];
...
LABEL_15:
  ...
  {
    v25 = [(PLAssetsdConnectionAuthorization *)self->_connectionAuthorization trustedCallerBundleID];
    v26 = [v25 length] == 0;
...
LABEL_20:
  [(PLAssetsdLibraryService *)self _sendClientReply:v7 sandboxExtensionsByPath:v24 error:v13];
...
- (void)validateOrRebuildPhotoLibraryDatabaseWithReply:(id)a3
{
  ...
  *sel = 0u;
  ...
  v8 = [(PLAssetsdLibraryService *)self newLibraryOpener];
  v9 = [(PLAbstractLibraryServicesManagerService *)self libraryServicesManager];
  v10 = [v9 openerCreationOptions];

  if (!v10)
  {
    v11 = [PLLibraryOpenerCreationOptions alloc];
    v12 = [(PLAbstractLibraryServicesManagerService *)self libraryServicesManager];
    v10 = -[PLLibraryOpenerCreationOptions initWithWellKnownLibraryIdentifier:](v11, "initWithWellKnownLibraryIdentifier:", [v12 wellKnownPhotoLibraryIdentifier]);
  }

  v19 = 0;
  v13 = [v8 createPhotoLibraryDatabaseWithOptions:v10 error:&v19];
  v14 = v19;
  v4[2](v4, v13, v14);
...
- (id)sandboxExtensionsByPathForLibraryAccessRole:(int64_t)a3
{
  ...
  v7 = [MEMORY[0x1E69BF278] sharedBookmarkManager];
  v8 = [v7 sandboxExtensionsByPathForClient:self->_connectionAuthorization pathManager:v6 libraryAccessRole:a3];
...
- (id)newLibraryOpener
{
  ...
  v5 = [(PLPhotoLibraryOpener *)v3 initWithLibraryServicesManager:v4 reportInProgressUpgrades:[(PLAssetsdConnectionAuthorization *)self->_connectionAuthorization isClientAuthorizedForLibraryUpgrade]];
...
- (void)isLibraryReadyForImportWithReply:(id)a3
{
  ...
  *sel = 0u;
  ...
  v9 = [(PLAbstractLibraryServicesManagerService *)self libraryServicesManager];
  v10 = [(PLPhotoLibraryImportValidation *)v8 initWithLibraryManager:v9];
...
- (PLAssetsdLibraryService)initWithLibraryServicesManager:(id)a3 bundleController:(id)a4 connectionAuthorization:(id)a5 assetsdService:(id)a6
{
  ...
  v14 = [(PLAbstractLibraryServicesManagerService *)&v21 initWithLibraryServicesManager:a3];
  v15 = v14;
  if (v14)
  {
    objc_storeStrong(&v14->_connectionAuthorization, a5);
    objc_storeStrong(&v15->_libraryBundleController, a4);
    objc_storeWeak(&v15->_assetsdService, v13);
...
+ (int64_t)requiredLibraryServicesStateForURL:(id)a3
{
  ...
  if ([MEMORY[0x1E69BF2A0] isSystemPhotoLibraryURL:v3])
  {
LABEL_7:
    v4 = 6;
    goto LABEL_8;
