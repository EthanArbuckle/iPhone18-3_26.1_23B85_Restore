...
- (int64_t)performActionWithManagedObjectContext:(id)context error:(id *)error
{
  ...
  v57[1] = 3221225472;
  v57[2] = __122__PLModelMigrationAction_setInitialhasPeopleSceneMidOrGreaterConfidenceValue_performActionWithManagedObjectContext_error___block_invoke;
  v57[3] = &unk_1E7575B30;
  v21 = v8;
  v58 = v21;
  v56[0] = MEMORY[0x1E69E9820];
  v56[1] = 3221225472;
  v56[2] = __122__PLModelMigrationAction_setInitialhasPeopleSceneMidOrGreaterConfidenceValue_performActionWithManagedObjectContext_error___block_invoke_2;
  v56[3] = &unk_1E7572E50;
  v56[4] = self;
  v56[5] = v63;
  v55[0] = MEMORY[0x1E69E9820];
  v55[1] = 3221225472;
  v55[2] = __122__PLModelMigrationAction_setInitialhasPeopleSceneMidOrGreaterConfidenceValue_performActionWithManagedObjectContext_error___block_invoke_3;
  v55[3] = &unk_1E7564AC0;
  v55[4] = self;
  v55[5] = &v65;
  v55[6] = &v71;
  ...
  if (v24)
  {
    ...
    if (!v28)
    {
      ...
      [v32 logWithMessage:v31 fromCodeLocation:"PLModelMigrationActionBackground.m" type:{1216, 0}];
...
LABEL_15:
    ...
    if (os_log_type_enabled(v44, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *buf = 134217984;
      *&buf[4] = v45;
      _os_log_impl(&dword_19BF1F000, v44, OS_LOG_TYPE_DEFAULT, "Set initial hasPeopleSceneMidOrGreaterConfidence for %tu assets.", buf, 0xCu);
    }
  }
  ...
  else
  {
    ...
    if (!v37)
    {
      ...
      [v43 logWithMessage:v42 fromCodeLocation:"PLModelMigrationActionBackground.m" type:{1219, 16}];
