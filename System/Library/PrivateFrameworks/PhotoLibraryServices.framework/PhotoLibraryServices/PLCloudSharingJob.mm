...
- (void)runDaemonSide
{
  ...
  if (self->_archiveFilename)
  {
    ...
    v7 = [v6 stringByAppendingPathComponent:self->_archiveFilename];
    v8 = objc_opt_new();
...
- (id)initFromXPCObject:(id)a3 libraryServicesManager:(id)a4
{
  ...
  v7 = [(PLDaemonJob *)&v11 initFromXPCObject:v6 libraryServicesManager:a4];
  if (v7)
  {
    ...
    *(v7 + 72) = xpc_dictionary_get_BOOL(v6, "PLCloudSharingJob_shouldPrioritize");
  }
...
- (void)archiveXPCToDisk:(id)a3
{
  ...
  xpc_dictionary_set_string(v4, "PLCloudSharingJob_archiveFilename", [v8 UTF8String]);
  ...
  v13 = [v12 cloudSharingArchiveDirectory];

  v14 = [v13 stringByAppendingPathComponent:v8];
  if (v10 && (([v10 writeToFile:v14 options:1073741825 error:0] & 1) != 0 || (v15 = objc_opt_new(), v40 = v11, objc_msgSend(v15, "createDirectoryAtPath:withIntermediateDirectories:attributes:error:", v13, 1, 0, &v40), v16 = v40, v17 = v11, v18 = self, v19 = v9, v20 = v5, v21 = v16, v17, v15, v22 = objc_msgSend(v10, "writeToFile:options:error:", v14, 1073741825, 0), v23 = v21, v5 = v20, v9 = v19, self = v18, v11 = v23, (v22 & 1) != 0)))
  {
...
- (PLPhotoLibrary)transientPhotoLibrary
{
  ...
  if (!v4)
  {
    ...
    [v10 handleFailureInMethod:a2 object:self file:@"PLCloudSharingJob.m" lineNumber:72 description:{@"Invalid parameter not satisfying: %@", @"self.libraryServicesManager"}];
  }

  v5 = PFFullMethodName();
  v6 = [(PLDaemonJob *)self libraryServicesManager];
  v7 = [v6 databaseContext];
  v8 = [v7 newShortLivedLibraryWithName:{objc_msgSend(v5, "UTF8String")}];
...
+ (void)deleteAllRecoveryEventsWithPathManager:(id)a3
{
  ...
  v6 = objc_opt_new();
  v27 = 0;
  v7 = [v6 contentsOfDirectoryAtPath:v5 error:&v27];
  v8 = v27;
  if (v7)
  {
    v25 = 0u;
...
+ (id)recoveredEventsWithPathManager:(id)a3
{
  ...
  v26 = v25 = v3;
  v4 = [v3 cloudSharingArchiveDirectory];
  v28 = objc_opt_new();
  v5 = [v28 contentsOfDirectoryAtPath:v4 error:0];
