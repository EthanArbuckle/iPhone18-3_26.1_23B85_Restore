...
- (id)fetchResultsSincePersistentHistoryToken:(id)a3
{
  ...
  v6 = [(PLLibraryScopeChangeTracker *)self _transactionIteratorSinceToken:v4];
...
- (id)lastKnownTokenFromDisk
{
  v8 = *MEMORY[0x1E69E9840];
  WeakRetained = objc_loadWeakRetained(&self->_delegate);
  v3 = [WeakRetained readRulesTrackerToken];
...
- (id)currentToken
{
  v2 = [(NSManagedObjectContext *)self->_context persistentStoreCoordinator];
  v3 = [v2 currentPersistentHistoryTokenFromStores:0];
...
- (BOOL)start
{
  ...
  v3 = [(PLLibraryScopeChangeTracker *)self lastKnownTokenFromDisk];
  if (!v3)
  {
    v3 = [(PLLibraryScopeChangeTracker *)self currentToken];
  }
