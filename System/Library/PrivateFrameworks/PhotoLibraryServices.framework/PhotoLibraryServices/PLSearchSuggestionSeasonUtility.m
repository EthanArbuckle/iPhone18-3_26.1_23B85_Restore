...
+ (id)generateSeasonBasedTemplateWithSeasonTemplateType:(unint64_t)a3 seasonTemplateSubType:(unint64_t)a4;
...
+ (id)generateSeasonBasedTemplateWithSeasonTemplateType:(unint64_t)a3 seasonTemplateSubType:(unint64_t)a4
{
  ...
  if (a4 == 2)
  {
    v9 = [a1 _templateKeySubstringForSeasonTemplateType:a3];
    v7 = 1104;
    v8 = 1101;
    v6 = @"_YEAR";
  }
  ...
  {
    v6 = [a1 _templateKeySubstringForSeasonTemplateType:a3];
    v7 = 5;
    v8 = 1104;
    v9 = @"CITY_IN_THE_";
  }
  ...
  v11 = [a1 seasonIdentifierForSeasonTemplateType:a3];
...
+ (id)seasonIdentifierForSeasonTemplateType:(unint64_t)a3
{
  ...
  {
    v5 = [MEMORY[0x1E696AEC0] stringWithFormat:@"%@/%lu", @"season", qword_19C60BE48[a3 - 1], v3];
  }
