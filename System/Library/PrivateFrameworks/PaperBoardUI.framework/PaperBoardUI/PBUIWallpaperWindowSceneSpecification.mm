...
- (id)initialSettingsDiffActions
{
  ...
  initialSettingsDiffActions = [(UIApplicationSceneSpecification *)&v8 initialSettingsDiffActions];
  v3 = objc_opt_new();
  v9[0] = v3;
  v4 = objc_opt_new();
  v9[1] = v4;
  v5 = [MEMORY[0x277CBEA60] arrayWithObjects:v9 count:2];
  v6 = [initialSettingsDiffActions arrayByAddingObjectsFromArray:v5];
