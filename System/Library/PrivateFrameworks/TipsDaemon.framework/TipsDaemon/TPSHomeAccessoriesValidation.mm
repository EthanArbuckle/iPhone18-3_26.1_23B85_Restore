...
- (void)validateWithCompletion:(id)completion
{
  ...
  getCurrentState = [(TPSHomeAccessoriesValidation *)self getCurrentState];
...
- (void)getCurrentStateWithCompletion:(id)completion
{
  ...
  completionCopy = completion;
  v7 = [v5 numberWithBool:{-[TPSHomeAccessoriesValidation getCurrentState](self, "getCurrentState")}];
