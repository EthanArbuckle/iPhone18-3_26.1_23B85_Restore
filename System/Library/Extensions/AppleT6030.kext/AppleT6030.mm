...
uint64_t AppleH15PlatformErrorHandler::_afxNsDecodeInterrupts(AppleH15PlatformErrorHandler *this, int a2, _DWORD *a3)
{
  ...
  if (8 * v3 != 8 * v3)
  {
    v5 = ((&unk_65F0 + 8 * v3) & 0xFFFFFFFFFFFFLL | 0x2BAD000000000000);
  }
  ...
  if (v4 != v4)
  {
    v15 = ((&off_6608 + v4) & 0xFFFFFFFFFFFFLL | 0x2BAD000000000000);
  }
  ...
  if (v17 != v17)
  {
    v18 = ((&unk_6620 + v17) & 0xFFFFFFFFFFFFLL | 0x2BAD000000000000);
  }
...
void AppleH15PlatformErrorHandler::_amccDecodeInterrupts(uint64_t this, int a2, void *a3)
{
  ...
  Register32 = AppleH15PlatformErrorHandler::_amccDecodeInterruptsForInputTable(this, dword_181C0, v3, &v28);
  v8 = 0;
  v9 = this + 8232;
  if (((this ^ (this + 8232)) & 0xFFC0000000000000) != 0)
  {
...
void AppleH15PlatformErrorHandler::_sepDecodeMonInterrupts(uint64_t this, int a2, void *a3)
{
  ...
  v13 = AppleH15PlatformErrorHandler::_readRegister32(v10, v12, 0, 0x5C000u);
  v14 = AppleH15PlatformErrorHandler::_readRegister32(v13, v12, 1u, 0x38u);
  if (!Register32)
  {
    v15 = &unk_404D;
    if (!v6)
