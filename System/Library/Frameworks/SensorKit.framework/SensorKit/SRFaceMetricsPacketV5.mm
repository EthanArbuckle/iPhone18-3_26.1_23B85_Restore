...
LABEL_26:
  ...
  v4 = [objc_alloc(MEMORY[0x1E696AFB0]) initWithUUIDBytes:a3->var1];
  if (!v4)
  {
    v12 = _MergedGlobals_4;
    if (!os_log_type_enabled(_MergedGlobals_4, OS_LOG_TYPE_FAULT))
  ...
  v6 = [MEMORY[0x1E696AEC0] stringWithFormat:@"%llu", a3->var3];
  if (!v6)
  {
    v12 = _MergedGlobals_4;
    if (!os_log_type_enabled(_MergedGlobals_4, OS_LOG_TYPE_FAULT))
...
- (NSArray)wholeFaceExpressions
{
  ...
  v5[1] = [SRFaceMetricsExpression wholeFaceMetricsExpressionWithIdentifier:@"1F26EABE-8350-48C5-97F0-06EFD6FEC6C4" value:self->_packet->var18.var0.var1, [SRFaceMetricsExpression wholeFaceMetricsExpressionWithIdentifier:@"E24480FE-8ECF-412C-8A02-3E924971A840" value:self->_packet->var18.var0.var0]];
  v5[2] = [SRFaceMetricsExpression wholeFaceMetricsExpressionWithIdentifier:@"726DA5E5-E63A-43CC-B7F3-FDD42A5583FA" value:self->_packet->var18.var0.var2];
  v5[3] = [SRFaceMetricsExpression wholeFaceMetricsExpressionWithIdentifier:@"6AEC22CC-2311-45F1-AF8E-F372A3C979B2" value:self->_packet->var18.var0.var3];
  v5[4] = [SRFaceMetricsExpression wholeFaceMetricsExpressionWithIdentifier:@"FECC0DAC-9B31-4504-896E-6C2898F16B69" value:self->_packet->var18.var0.var4];
  v5[5] = [SRFaceMetricsExpression wholeFaceMetricsExpressionWithIdentifier:@"A1E9B99B-C90B-4DB4-8ED3-4E0382ABC8B5" value:self->_packet->var18.var0.var5];
  v5[6] = [SRFaceMetricsExpression wholeFaceMetricsExpressionWithIdentifier:@"C57C8CCA-0194-4327-8CBA-987FAF744096" value:self->_packet->var18.var0.var6];
...
- (NSArray)partialFaceExpressions
{
  ...
  v5[0] = [SRFaceMetricsExpression partialFaceMetricsExpressionWithIdentifier:@"85E97F41-0CF7-481E-B9ED-8E5A90B4A547" value:self->_packet->var18.var1.var0];
  v5[1] = [SRFaceMetricsExpression partialFaceMetricsExpressionWithIdentifier:@"5A3CBD39-B24F-463A-990C-18C5372D6F1B" value:self->_packet->var18.var1.var1];
  v5[2] = [SRFaceMetricsExpression partialFaceMetricsExpressionWithIdentifier:@"D0859030-4703-45F6-A902-7634984A2074" value:self->_packet->var18.var1.var2];
  v5[3] = [SRFaceMetricsExpression partialFaceMetricsExpressionWithIdentifier:@"A29952D5-F6EA-4562-9A12-43284B1DB634" value:self->_packet->var18.var1.var3];
  v5[4] = [SRFaceMetricsExpression partialFaceMetricsExpressionWithIdentifier:@"A8B47A8D-A86F-4159-8472-33C67D6250B5" value:self->_packet->var18.var1.var4];
  v5[5] = [SRFaceMetricsExpression partialFaceMetricsExpressionWithIdentifier:@"60A8B7A9-8C8F-401A-A8C4-C996B1397CC9" value:self->_packet->var18.var1.var5];
  v5[6] = [SRFaceMetricsExpression partialFaceMetricsExpressionWithIdentifier:@"E5A9652C-9CF9-4F38-BC7A-1D622DC69B41" value:self->_packet->var18.var1.var6];
  v5[7] = [SRFaceMetricsExpression partialFaceMetricsExpressionWithIdentifier:@"A1D4672B-2E01-435A-BD0D-ABAEB1F4CB6E" value:self->_packet->var18.var1.var7];
...
- (NSDictionary)trackingData
{
  ...
  v29[0] = @"rotation";
  v29[1] = @"translation";
  v30[0] = [(SRFaceMetricsPacketV5 *)self rotation];
  v30[1] = [(SRFaceMetricsPacketV5 *)self translation];
  v3 = [MEMORY[0x1E695DF20] dictionaryWithObjects:v30 forKeys:v29 count:2];
  v27[0] = @"blendshapes";
  v28[0] = [(SRFaceMetricsPacketV5 *)self blendshapes];
  v27[1] = @"gaze";
  v28[1] = [(SRFaceMetricsPacketV5 *)self gaze];
  ...
  v25[0] = @"left_eye";
  v26[0] = [(SRFaceMetricsPacketV5 *)self geometryLeftEye];
  v25[1] = @"right_eye";
  v26[1] = [(SRFaceMetricsPacketV5 *)self geometryRightEye];
  v25[2] = @"vertices";
  if (qword_1EE02AB10 != -1)
  {
    dispatch_once(&qword_1EE02AB10, &__block_literal_global_4);
  ...
  v15[0] = @"face_id";
  v16[0] = [(NSUUID *)[(SRFaceMetricsPacketV5 *)self faceIdentifier] UUIDString];
  v16[1] = &unk_1F48CA9C8;
  v15[1] = @"confidence";
  v15[2] = @"rgb_camera";
  v16[2] = v10;
