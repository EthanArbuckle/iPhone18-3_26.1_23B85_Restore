...
+ (void)setAuthClient:(id)a3
{
  if (_MergedGlobals_10 != a3)
  {

    _MergedGlobals_10 = a3;
  }
}
...
- (SRAuthorizationClient)initWithConnection:(id)a3
{
  ...
  if (v4)
  {
    ...
    v18 = notify_register_dispatch(v17, &v5->_registrationToken, MEMORY[0x1E69E96A0], handler);
...
- (uint64_t)syncProxy
{
  ...
  {
    v4 = [v10[5] domain];
    if ([v4 isEqualToString:*MEMORY[0x1E696A250]] && objc_msgSend(v10[5], "code") == 4097)
    {
