...
- (id)dictionaryRepresentation
{
  ...
  v5 = [(NSArray *)deleteToDeletes countByEnumeratingWithState:&v156 objects:v167 count:16];
  if (v5)
  {
    v6 = v5;
    v7 = *v157;
    do
    {
      ...
      v6 = [(NSArray *)deleteToDeletes countByEnumeratingWithState:&v156 objects:v167 count:16];
    }
  ...
  v11 = [(NSArray *)longWordDownErrorDistance countByEnumeratingWithState:&v152 objects:v166 count:16];
  if (v11)
  {
    v12 = v11;
    v13 = *v153;
    do
    {
      ...
      v12 = [(NSArray *)longWordDownErrorDistance countByEnumeratingWithState:&v152 objects:v166 count:16];
    }
  ...
  v17 = [(NSArray *)longWordTouchDownDown countByEnumeratingWithState:&v148 objects:v165 count:16];
  if (v17)
  {
    v18 = v17;
    v19 = *v149;
    do
    {
      ...
      v18 = [(NSArray *)longWordTouchDownDown countByEnumeratingWithState:&v148 objects:v165 count:16];
    }
  ...
  v23 = [(NSArray *)longWordTouchDownUp countByEnumeratingWithState:&v144 objects:v164 count:16];
  if (v23)
  {
    v24 = v23;
    v25 = *v145;
    do
    {
      ...
      v24 = [(NSArray *)longWordTouchDownUp countByEnumeratingWithState:&v144 objects:v164 count:16];
    }
  ...
  v29 = [(NSArray *)longWordUpErrorDistance countByEnumeratingWithState:&v140 objects:v163 count:16];
  if (v29)
  {
    v30 = v29;
    v31 = *v141;
    do
    {
      ...
      v30 = [(NSArray *)longWordUpErrorDistance countByEnumeratingWithState:&v140 objects:v163 count:16];
    }
  ...
  v35 = [(NSArray *)longWordTouchUpDown countByEnumeratingWithState:&v136 objects:v162 count:16];
  if (v35)
  {
    v36 = v35;
    v37 = *v137;
    do
    {
      ...
      v36 = [(NSArray *)longWordTouchUpDown countByEnumeratingWithState:&v136 objects:v162 count:16];
    }
  ...
  v161[1] = [(SRKeyboardMetrics *)selfCopy keyboardIdentifier];
  v160[2] = @"version";
  v161[2] = [(SRKeyboardMetrics *)selfCopy version];
  v160[3] = @"width";
  v161[3] = [v134 stringFromMeasurement:{-[SRKeyboardMetrics width](selfCopy, "width")}];
  v160[4] = @"height";
  v161[4] = [v134 stringFromMeasurement:{-[SRKeyboardMetrics height](selfCopy, "height")}];
  v160[5] = @"inputModes";
  v161[5] = [(SRKeyboardMetrics *)selfCopy inputModes];
  v160[6] = @"sessionIdentifiers";
  v161[6] = [(SRKeyboardMetrics *)selfCopy sessionIdentifiers];
  ...
  v161[54] = [MEMORY[0x1E696AD98] numberWithInteger:{-[SRKeyboardMetrics totalAlteredWords](selfCopy, "totalAlteredWords")}];
  v160[55] = @"totalAutoCorrections";
  v161[55] = [MEMORY[0x1E696AD98] numberWithInteger:{-[SRKeyboardMetrics totalAutoCorrections](selfCopy, "totalAutoCorrections")}];
  v160[56] = @"totalDeletes";
  v161[56] = [MEMORY[0x1E696AD98] numberWithInteger:{-[SRKeyboardMetrics totalDeletes](selfCopy, "totalDeletes")}];
  v160[57] = @"totalDrags";
  v161[57] = [MEMORY[0x1E696AD98] numberWithInteger:{-[SRKeyboardMetrics totalDrags](selfCopy, "totalDrags")}];
  v160[58] = @"totalEmojis";
  v161[58] = [MEMORY[0x1E696AD98] numberWithInteger:{-[SRKeyboardMetrics totalEmojis](selfCopy, "totalEmojis")}];
  v160[59] = @"totalHitTestCorrections";
  v161[59] = [MEMORY[0x1E696AD98] numberWithInteger:{-[SRKeyboardMetrics totalHitTestCorrections](selfCopy, "totalHitTestCorrections")}];
  v160[60] = @"totalInsertKeyCorrections";
  v161[60] = [MEMORY[0x1E696AD98] numberWithInteger:{-[SRKeyboardMetrics totalInsertKeyCorrections](selfCopy, "totalInsertKeyCorrections")}];
  v160[61] = @"totalNearKeyCorrections";
  v161[61] = [MEMORY[0x1E696AD98] numberWithInteger:{-[SRKeyboardMetrics totalNearKeyCorrections](selfCopy, "totalNearKeyCorrections")}];
  v160[62] = @"totalPathLength";
  v161[62] = [v134 stringFromMeasurement:{-[SRKeyboardMetrics totalPathLength](selfCopy, "totalPathLength")}];
  ...
  v161[63] = v125;
  v160[64] = @"totalPaths";
  v161[64] = [MEMORY[0x1E696AD98] numberWithInteger:{-[SRKeyboardMetrics totalPaths](selfCopy, "totalPaths")}];
  v160[65] = @"totalRetroCorrections";
  v161[65] = [MEMORY[0x1E696AD98] numberWithInteger:{-[SRKeyboardMetrics totalRetroCorrections](selfCopy, "totalRetroCorrections")}];
  v160[66] = @"totalSkipTouchCorrections";
  v161[66] = [MEMORY[0x1E696AD98] numberWithInteger:{-[SRKeyboardMetrics totalSkipTouchCorrections](selfCopy, "totalSkipTouchCorrections")}];
  v160[67] = @"totalSpaceCorrections";
  v161[67] = [MEMORY[0x1E696AD98] numberWithInteger:{-[SRKeyboardMetrics totalSpaceCorrections](selfCopy, "totalSpaceCorrections")}];
  v160[68] = @"totalSubstitutionCorrections";
  v161[68] = [MEMORY[0x1E696AD98] numberWithInteger:{-[SRKeyboardMetrics totalSubstitutionCorrections](selfCopy, "totalSubstitutionCorrections")}];
  v160[69] = @"totalTaps";
  v161[69] = [MEMORY[0x1E696AD98] numberWithInteger:{-[SRKeyboardMetrics totalTaps](selfCopy, "totalTaps")}];
  v160[70] = @"totalTranspositionCorrections";
  v161[70] = [MEMORY[0x1E696AD98] numberWithInteger:{-[SRKeyboardMetrics totalTranspositionCorrections](selfCopy, "totalTranspositionCorrections")}];
  v160[71] = @"totalWords";
  v161[71] = [MEMORY[0x1E696AD98] numberWithInteger:{-[SRKeyboardMetrics totalWords](selfCopy, "totalWords")}];
  ...
  v161[73] = [MEMORY[0x1E696AD98] numberWithInteger:{-[SRKeyboardMetrics totalAbsolutistWords](selfCopy, "totalAbsolutistWords")}];
  v160[74] = @"wordCountAnger";
  v161[74] = [MEMORY[0x1E696AD98] numberWithInteger:{-[SRKeyboardMetrics totalAngerWords](selfCopy, "totalAngerWords")}];
  v160[75] = @"wordCountAnxiety";
  v161[75] = [MEMORY[0x1E696AD98] numberWithInteger:{-[SRKeyboardMetrics totalAnxietyWords](selfCopy, "totalAnxietyWords")}];
  v160[76] = @"wordCountConfused";
  v161[76] = [MEMORY[0x1E696AD98] numberWithInteger:{-[SRKeyboardMetrics wordCountForSentimentCategory:](selfCopy, "wordCountForSentimentCategory:", 9)}];
  v160[77] = @"wordCountDeath";
  v161[77] = [MEMORY[0x1E696AD98] numberWithInteger:{-[SRKeyboardMetrics totalDeathWords](selfCopy, "totalDeathWords")}];
  v160[78] = @"wordCountDown";
  v161[78] = [MEMORY[0x1E696AD98] numberWithInteger:{-[SRKeyboardMetrics totalDownWords](selfCopy, "totalDownWords")}];
  v160[79] = @"wordCountHealth";
  v161[79] = [MEMORY[0x1E696AD98] numberWithInteger:{-[SRKeyboardMetrics totalHealthFeelingWords](selfCopy, "totalHealthFeelingWords")}];
  v160[80] = @"wordCountLowEnergy";
  v161[80] = [MEMORY[0x1E696AD98] numberWithInteger:{-[SRKeyboardMetrics wordCountForSentimentCategory:](selfCopy, "wordCountForSentimentCategory:", 8)}];
  v160[81] = @"wordCountPositive";
  v161[81] = [MEMORY[0x1E696AD98] numberWithInteger:{-[SRKeyboardMetrics wordCountForSentimentCategory:](selfCopy, "wordCountForSentimentCategory:", 6)}];
  v160[82] = @"wordCountSad";
  v161[82] = [MEMORY[0x1E696AD98] numberWithInteger:{-[SRKeyboardMetrics wordCountForSentimentCategory:](selfCopy, "wordCountForSentimentCategory:", 7)}];
  v160[83] = @"emojiCountAbsolutist";
  v161[83] = [MEMORY[0x1E696AD98] numberWithInteger:{-[SRKeyboardMetrics emojiCountForSentimentCategory:](selfCopy, "emojiCountForSentimentCategory:", 0)}];
  v160[84] = @"emojiCountAnger";
  v161[84] = [MEMORY[0x1E696AD98] numberWithInteger:{-[SRKeyboardMetrics totalAngerEmojis](selfCopy, "totalAngerEmojis")}];
  v160[85] = @"emojiCountAnxiety";
  v161[85] = [MEMORY[0x1E696AD98] numberWithInteger:{-[SRKeyboardMetrics totalAnxietyEmojis](selfCopy, "totalAnxietyEmojis")}];
  v160[86] = @"emojiCountConfused";
  v161[86] = [MEMORY[0x1E696AD98] numberWithInteger:{-[SRKeyboardMetrics totalConfusedEmojis](selfCopy, "totalConfusedEmojis")}];
  v160[87] = @"emojiCountDeath";
  v161[87] = [MEMORY[0x1E696AD98] numberWithInteger:{-[SRKeyboardMetrics emojiCountForSentimentCategory:](selfCopy, "emojiCountForSentimentCategory:", 2)}];
  v160[88] = @"emojiCountDown";
  v161[88] = [MEMORY[0x1E696AD98] numberWithInteger:{-[SRKeyboardMetrics emojiCountForSentimentCategory:](selfCopy, "emojiCountForSentimentCategory:", 1)}];
  v160[89] = @"emojiCountHealth";
  v161[89] = [MEMORY[0x1E696AD98] numberWithInteger:{-[SRKeyboardMetrics totalHealthFeelingEmojis](selfCopy, "totalHealthFeelingEmojis")}];
  v160[90] = @"emojiCountLowEnergy";
  v161[90] = [MEMORY[0x1E696AD98] numberWithInteger:{-[SRKeyboardMetrics totalLowEnergyEmojis](selfCopy, "totalLowEnergyEmojis")}];
  v160[91] = @"emojiCountPositive";
  v161[91] = [MEMORY[0x1E696AD98] numberWithInteger:{-[SRKeyboardMetrics totalPositiveEmojis](selfCopy, "totalPositiveEmojis")}];
  v160[92] = @"emojiCountSad";
  v161[92] = [MEMORY[0x1E696AD98] numberWithInteger:{-[SRKeyboardMetrics totalSadEmojis](selfCopy, "totalSadEmojis")}];
  v160[93] = @"totalPathPauses";
  v161[93] = [MEMORY[0x1E696AD98] numberWithInteger:{-[SRKeyboardMetrics totalPathPauses](selfCopy, "totalPathPauses")}];
  v160[94] = @"totalPauses";
  v161[94] = [MEMORY[0x1E696AD98] numberWithInteger:{-[SRKeyboardMetrics totalPauses](selfCopy, "totalPauses")}];
  v160[95] = @"totalTypingEpisodes";
  v161[95] = [MEMORY[0x1E696AD98] numberWithInteger:{-[SRKeyboardMetrics totalTypingEpisodes](selfCopy, "totalTypingEpisodes")}];
  v160[96] = @"typingSpeed";
