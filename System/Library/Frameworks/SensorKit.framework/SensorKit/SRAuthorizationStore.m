      ...
      do
      {
        ...
        if (v12)
        {
          ...
          if (os_log_type_enabled(v13, OS_LOG_TYPE_INFO))
          {
            *v159 = 138543362;
            v160 = v10;
            _os_log_impl(&dword_1C914D000, v13, OS_LOG_TYPE_INFO, "Could not retrieve authorization information for TCC service %{public}@", v159, 0xCu);
          }
        }
        ...
        if (os_log_type_enabled(v15, OS_LOG_TYPE_DEFAULT))
        {
          *v159 = 138543874;
          ...
          v163 = 2114;
          v164 = v110;
          _os_log_impl(&dword_1C914D000, v15, OS_LOG_TYPE_DEFAULT, "Authorized Bundle Ids for %{public}@, overridden %{public, BOOL}d, %{public}@", v159, 0x1Cu);
          v15 = *(v6 + 3040);
        }
        ...
        if (os_log_type_enabled(v15, OS_LOG_TYPE_DEFAULT))
        {
          *v159 = 138543874;
          ...
          v163 = 2114;
          v164 = v107;
          _os_log_impl(&dword_1C914D000, v15, OS_LOG_TYPE_DEFAULT, "Deauthorized Bundle Ids for %{public}@, overridden %{public, BOOL}d, %{public}@", v159, 0x1Cu);
        }
          ...
          for (ii = 0; ii != v115; ii = ii + 1)
          {
            ...
            if (!v53)
            {
              ...
              *&v165[4] = v52;
              ...
              v65 = 12;
LABEL_108:
              _os_log_error_impl(&dword_1C914D000, v63, OS_LOG_TYPE_ERROR, v64, v165, v65);
              goto LABEL_105;
            }
    ...
    do
    {
      ...
      do
      {
        ...
        if (v82 && os_log_type_enabled(*(v70 + 3040), OS_LOG_TYPE_INFO))
        {
          *v156 = 138543362;
          *&v156[4] = v77;
          _os_log_impl(&dword_1C914D000, v81, OS_LOG_TYPE_INFO, "Could not retrieve authorization information for TCC service %{public}@", v156, 0xCu);
          v81 = *(v70 + 3040);
        }
        ...
        if (os_log_type_enabled(v81, OS_LOG_TYPE_DEFAULT))
        {
          ...
          *&v156[12] = 2114;
          *&v156[14] = v78;
          _os_log_impl(&dword_1C914D000, v81, OS_LOG_TYPE_DEFAULT, "Authorized Bundle Ids for %{public}@, %{public}@", v156, 0x16u);
          v81 = *(v70 + 3040);
        }
        ...
        if (os_log_type_enabled(v81, OS_LOG_TYPE_DEFAULT))
        {
          ...
          *&v156[12] = 2114;
          *&v156[14] = v80;
          _os_log_impl(&dword_1C914D000, v81, OS_LOG_TYPE_DEFAULT, "Deauthorized Bundle Ids for %{public}@, %{public}@", v156, 0x16u);
        }
...
- (SRAuthorizationStore)initWithSensors:(id)a3 withAuthorizationTimes:(BOOL)a4
{
  ...
  if (self)
  {
    ...
    if (v8)
    {
      ...
      v34 = [objc_alloc(MEMORY[0x1E695DF90]) initWithCapacity:{-[NSSet count](v9->_sensors, "count")}];
      v36 = 0u;
      v37 = 0u;
      v38 = 0u;
      v39 = 0u;
    ...
    else
    {
      ...
      if (v11)
      {
        ...
        if (os_log_type_enabled(SRLogAuthorizationStore, OS_LOG_TYPE_FAULT))
        {
          *v39 = 67240192;
          v40 = v11;
          _os_log_fault_impl(&dword_1C914D000, v12, OS_LOG_TYPE_FAULT, "Failed to register for TCC notifications.  Got status %{public}d", v39, 8u);
        }
...
- (id)readerAuthorizationBundleIdValues
{
  ...
  result = [MEMORY[0x1E695DF20] dictionaryWithDictionary:v3];
  v10 = *MEMORY[0x1E69E9840];
  return result;
}
