...
- (HMEraseAnisetteDataResponse)initWithCoder:(id)coder;
...
- (void)encodeWithCoder:(id)coder
{
  ...
  [coderCopy encodeBool:-[HMEraseAnisetteDataResponse didSucceed](self forKey:{"didSucceed", v5.receiver, v5.super_class), @"TRAnisetteDataMessages_dS"}];
}
...
- (NSDictionary)messagePayload
{
  ...
  messageName = [(HMEraseAnisetteDataResponse *)self messageName];
  v8 = messageName;
  v9[0] = v3;
...
+ (id)objWithMessage:(id)message
{
  ...
  v6 = [messagePayload hmf_dataForKey:@"kHMEraseAnisetteDataResponse"];
...
+ (id)objWithDict:(id)dict
{
  ...
  dictCopy = dict;
  v5 = [dictCopy hmf_dataForKey:@"kHMEraseAnisetteDataResponse"];
  v14 = 0;
