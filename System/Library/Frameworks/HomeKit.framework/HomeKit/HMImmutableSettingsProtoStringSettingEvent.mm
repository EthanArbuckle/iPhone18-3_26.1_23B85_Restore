...
- (id)copyWithZone:(_NSZone *)zone
{
  ...
  v6 = [(HMImmutableSettingsProtoStringValueEvent *)self->_value copyWithZone:zone];
  v7 = v5[1];
  v5[1] = v6;
...
- (id)dictionaryRepresentation
{
  ...
  if (value)
  {
    dictionaryRepresentation = [(HMImmutableSettingsProtoStringValueEvent *)value dictionaryRepresentation];
...
- (id)description
{
  ...
  dictionaryRepresentation = [(HMImmutableSettingsProtoStringSettingEvent *)self dictionaryRepresentation];
