...
- (HMSyncAnisetteDataResponse)initWithCoder:(id)coder;
...
- (HMSyncAnisetteDataResponse)initWithCoder:(id)coder
{
  coderCopy = coder;
  v7.receiver = self;
  v7.super_class = HMSyncAnisetteDataResponse;
...
{
  v5.receiver = self;
  v5.super_class = HMSyncAnisetteDataResponse;
  coderCopy = coder;
  [(HMRemoteLoginMessage *)&v5 encodeWithCoder:coderCopy];
  [coderCopy encodeBool:-[HMSyncAnisetteDataResponse didSucceed](self forKey:{"didSucceed", v5.receiver, v5.super_class), @"TRAnisetteDataMessages_dS"}];
}
...
- (NSString)description
{
  ...
  v8.receiver = self;
  v8.super_class = HMSyncAnisetteDataResponse;
...
- (NSDictionary)messagePayload
{
  ...
  messageName = [(HMSyncAnisetteDataResponse *)self messageName];
  v8 = messageName;
  v9[0] = v3;
...
+ (id)objWithMessage:(id)message
{
  ...
  v6 = [messagePayload hmf_dataForKey:@"kHMSyncAnisetteDataResponse"];
...
+ (id)objWithDict:(id)dict
{
  ...
  dictCopy = dict;
  v5 = [dictCopy hmf_dataForKey:@"kHMSyncAnisetteDataResponse"];
  v14 = 0;
