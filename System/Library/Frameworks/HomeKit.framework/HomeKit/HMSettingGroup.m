...
- (id)longDescription
{
  ...
  v4 = [MEMORY[0x1E696AEC0] stringWithFormat:@"[%@ settings: %@]", objc_opt_class(), v3];
...
- (id)description
{
  ...
  v6 = [v3 stringWithFormat:@"[%@ keyPath: %@]", v4, v5];
...
- (void)fixNestedKeyPaths
{
  ...
  v4 = [(HMSettingGroup *)self settings];
...
- (void)addSetting:(id)a3
{
  ...
  v9 = [v10 name];
  [(NSMutableDictionary *)settings setObject:v10 forKey:v9];
...
- (void)addGroup:(id)a3
{
  ...
  groups = self->_groups;
  v9 = [v10 name];
  [(NSMutableDictionary *)groups setObject:v10 forKey:v9];
...
{
  os_unfair_lock_lock_with_options();
  v3 = [(NSMutableDictionary *)self->_settings allValues];
  os_unfair_lock_unlock(&self->_lock);
