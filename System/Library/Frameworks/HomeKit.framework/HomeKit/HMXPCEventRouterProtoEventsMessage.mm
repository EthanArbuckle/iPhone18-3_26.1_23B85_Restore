  ...
  if (v6)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        [(HMXPCEventRouterProtoEventsMessage *)self addEvents:*(*(&v20 + 1) + 8 * v9++)];
      }
  ...
  if (v11)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        [(HMXPCEventRouterProtoEventsMessage *)self addCachedEvents:*(*(&v16 + 1) + 8 * v14++), v16];
      }
...
- (void)copyTo:(id)a3
{
  ...
  {
    [v12 clearEvents];
    v4 = [(HMXPCEventRouterProtoEventsMessage *)self eventsCount];
    if (v4)
    {
      v5 = v4;
      for (i = 0; i != v5; ++i)
  ...
  if ([(HMXPCEventRouterProtoEventsMessage *)self cachedEventsCount])
  {
    ...
    v8 = [(HMXPCEventRouterProtoEventsMessage *)self cachedEventsCount];
    if (v8)
    {
      v9 = v8;
      for (j = 0; j != v9; ++j)
...
- (id)description
{
  ...
  v5 = [(HMXPCEventRouterProtoEventsMessage *)self dictionaryRepresentation];
