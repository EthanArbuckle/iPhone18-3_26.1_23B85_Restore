...
- (BOOL)isEqual:(id)a3
{
  ...
  else
  {
    ...
    if (v6)
    {
      v7 = [(HMSettingBooleanValue *)self BOOLValue];
      v8 = v7 ^ [(HMSettingBooleanValue *)v6 BOOLValue]^ 1;
    }
...
- (HMSettingBooleanValue)initWithPayload:(id)a3
{
  ...
  v4 = a3;
  v14 = 0;
  v5 = [v4 hmf_BOOLForKey:@"HMImmutableSettingValuePayloadKey" error:&v14];
  v6 = v14;
  if (v6)
  {
  ...
  {
    v8 = [(HMSettingBooleanValue *)self initWithBoolValue:v5];
    v11 = v8;
  }
