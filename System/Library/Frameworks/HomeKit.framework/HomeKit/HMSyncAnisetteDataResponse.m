...
- (void)encodeWithCoder:(id)a3
{
  ...
  [v4 encodeBool:-[HMSyncAnisetteDataResponse didSucceed](self forKey:{"didSucceed", v5.receiver, v5.super_class), @"TRAnisetteDataMessages_dS"}];
}
...
- (NSDictionary)messagePayload
{
  ...
  v4 = [(HMSyncAnisetteDataResponse *)self messageName];
  v8 = v4;
  v9[0] = v3;
...
+ (id)objWithMessage:(id)a3
{
  ...
  v6 = [v5 hmf_dataForKey:@"kHMSyncAnisetteDataResponse"];
...
+ (id)objWithDict:(id)a3
{
  ...
  v4 = a3;
  v5 = [v4 hmf_dataForKey:@"kHMSyncAnisetteDataResponse"];
  v14 = 0;
