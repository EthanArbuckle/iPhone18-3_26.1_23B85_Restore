...
- (void)homeManagerDidUpdateHomes:(id)homes
{
  ...
  if (selfCopy)
  {
    homeSyncGroup = selfCopy->_homeSyncGroup;
  }
...
- (id)attachmentsForParameters:(id)parameters
{
  ...
  v8 = [parametersCopy hmf_BOOLForKey:@"DEExtensionAttachmentsParamConsentProvidedKey"];
  ...
  if (selfCopy)
  {
    dispatch_group_enter(selfCopy->_homeSyncGroup);
    v14 = [[HMHomeManager alloc] initWithOptions:64];
    objc_storeStrong(&selfCopy->_homeManager, v14);
  ...
  v20 = homeManager;
  currentAccessory = [(HMHomeManager *)v20 currentAccessory];
  if (selfCopy)
  {
    objc_storeStrong(&selfCopy->_currentAccessory, currentAccessory);
  }
  ...
  v63[3] = &unk_100030F08;
  v63[4] = selfCopy;
  sub_100018D60(selfCopy, @"Prepare", v63);
  ...
  v61 = v26;
  v62 = selfCopy;
  sub_100018D60(selfCopy, @"HomeKit Logs", v60);
  ...
  v58 = v27;
  v59 = selfCopy;
  sub_100018D60(selfCopy, @"Memgraphs", v57);
  ...
  v28 = v27;
  v56 = v28;
  sub_100018D60(selfCopy, @"Endpoint Assignments", v55);
  ...
  v29 = v28;
  v54 = v29;
  sub_100018D60(selfCopy, @"Dispatch Queue Information (ddt)", v53);
  if (v8)
  {
    ...
    v31 = v29;
    v52 = v31;
    sub_100018D60(selfCopy, @"HomeUtil dump all", v51);
    ...
    v49 = v32;
    v50 = selfCopy;
    sub_100018D60(selfCopy, @"Database Files", v48);
    ...
    v46 = v33;
    v47 = selfCopy;
    sub_100018D60(selfCopy, @"Network Diagnostics", v45);
    ...
    v43[4] = selfCopy;
    v44 = v33;
    sub_100018D60(selfCopy, @"Video Analysis Session Logs", v43);
  }
  ...
  else
  {
    ...
    v30 = &v42;
    v42 = v29;
    sub_100018D60(selfCopy, @"HomeUtil dump all", v41);
  }
