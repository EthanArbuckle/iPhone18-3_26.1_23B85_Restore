...
- (_TtC22ScreenTimeWebExtension19STURLRequestLimiter)initWithRate:(int64_t)a3 rateInterval:(double)a4;
- (void)incrementRequestCountForBundleIdentifier:(id)a3 completionHandler:(id)a4;
@end
