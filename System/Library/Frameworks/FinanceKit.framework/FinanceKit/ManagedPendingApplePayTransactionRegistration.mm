...
- (_TtC10FinanceKit45ManagedPendingApplePayTransactionRegistration)initWithEntity:(id)entity insertIntoManagedObjectContext:(id)context;
- (void).cxx_construct;
...
- (void)awakeFromInsert
{
  ...
  v9 = sub_1B77FF8B8();
  (*(v5 + 8))(v7, v4);
  [(ManagedPendingApplePayTransactionRegistration *)selfCopy setCreationDate:v9];
}
...
- (_TtC10FinanceKit45ManagedPendingApplePayTransactionRegistration)initWithEntity:(id)entity insertIntoManagedObjectContext:(id)context
{
  ...
  return [(ManagedPendingApplePayTransactionRegistration *)&v7 initWithEntity:entity insertIntoManagedObjectContext:context];
}
