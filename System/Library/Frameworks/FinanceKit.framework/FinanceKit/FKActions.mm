...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v6 = [(NSURL *)self->_digitalServicingURL copyWithZone:a3];
  digitalServicingURL = v5->_digitalServicingURL;
  v5->_digitalServicingURL = v6;

  v8 = [(NSURL *)self->_payNowURL copyWithZone:a3];
  payNowURL = v5->_payNowURL;
  v5->_payNowURL = v8;

  v10 = [(NSURL *)self->_transferFundsURL copyWithZone:a3];
  transferFundsURL = v5->_transferFundsURL;
  v5->_transferFundsURL = v10;

  v12 = [(NSURL *)self->_postInstallmentURL copyWithZone:a3];
  postInstallmentURL = v5->_postInstallmentURL;
  v5->_postInstallmentURL = v12;

  v14 = [(NSURL *)self->_redeemRewardsURL copyWithZone:a3];
