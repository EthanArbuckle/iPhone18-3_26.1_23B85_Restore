...
- (PKProofreadingQuery)initWithRecognitionSessionManager:(id)manager;
...
- (PKProofreadingQuery)initWithRecognitionSessionManager:(id)manager
{
  managerCopy = manager;
  v11.receiver = self;
  v11.super_class = PKProofreadingQuery;
  v5 = [(PKQuery *)&v11 initWithRecognitionSessionManager:managerCopy];
  if (v5)
  {
    v6 = objc_alloc(MEMORY[0x1E6997BC0]);
...
- (void)queryDidUpdateResult:(id)result
{
  ...
  if (objc_opt_isKindOfClass())
  {
    ...
    if (v10)
    {
      ...
      do
      {
        ...
        do
        {
          ...
          v14 = [[PKProofreadingQueryItem alloc] initWithCoreHandwritingTextCheckingQueryItem:*(*(&v19 + 1) + 8 * v13)];
          [v8 addObject:v14];
    ...
    if (v16)
    {
      ...
      v18 = [v8 copy];
      [delegate2 proofreadingQuery:self foundItems:v18];
    }
  }
}
