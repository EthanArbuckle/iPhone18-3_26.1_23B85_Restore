...
- (uint64_t)isInvalidatedGivenDrawing:(void *)a3 autoRefineController:(void *)a4 currentStrokes:(void *)a5 inStrokesToReplace:(void *)a6 lineDrawing:(void *)a7 strokeGroups:(void *)a8 outStrokeGroupsToReplace:(void *)a9 outStrokesToPreserve:;
...
- (void)trimTaskForNewStroke:(char *)a3 shouldCancel:;
...
- (void)updateCommittableRange
{
  if (a1)
  {
    ...
    v33 = &v39;
    v34 = &v35;
    [v6 enumerateTokensInTranscriptionPath:v10 columnRange:v2 tokenProcessingBlock:{v11 + 1, &v27}];
    ...
    *(a1 + 80) = v17;
    ...
    v24 = [v23 firstObject];
    v25 = [v20 transcriptionWithPath:v24 columnRange:v2 filterLowConfidence:{v11 + 1, 0}];
    v26 = *(a1 + 72);
    *(a1 + 72) = v25;
...
- (id)debugInfo
{
  ...
  if (a1)
  {
    ...
    if (!v2)
    {
      [v40 setObject:v1 forKeyedSubscript:@"modelVersionForUserLocale"];
      [v40 setObject:v39 forKeyedSubscript:@"userLocale"];
    }
    ...
    if (v5)
    {
      ...
      v7 = [v5 transcriptionPaths];
      v42 = [v7 firstObject];

      v43 = [v5 refinableTranscriptionPath];
      for (i = 0; i < [v5 tokenColumnCount]; ++i)
      {
        v9 = [v5 tokenRowsAtColumnIndex:i];
        v10 = [v5 transcriptionWithPath:v42 columnRange:i filterLowConfidence:1 allowPrecedingSeparator:{0, 1}];
        v11 = [v5 transcriptionWithPath:v43 columnRange:i filterLowConfidence:1 allowPrecedingSeparator:{0, 1}];
    ...
    [v40 setObject:v38 forKeyedSubscript:@"textResult"];
    v18 = *(a1 + 8);
    if (v18)
    {
      v18 = v18[10];
    ...
    v19 = v18;
    v20 = [v19 refinableTranscription];
    [v40 setObject:v20 forKeyedSubscript:@"refinableTranscription"];

    v50[0] = @"lastColumnToCommit";
    v21 = [MEMORY[0x1E696AD98] numberWithInteger:*(a1 + 40)];
    v51[0] = v21;
    v50[1] = @"firstColumnToCommit";
    v22 = [MEMORY[0x1E696AD98] numberWithInteger:*(a1 + 32)];
    v51[1] = v22;
    v50[2] = @"startTime";
    v23 = [MEMORY[0x1E696AD98] numberWithDouble:*(a1 + 56)];
    v51[2] = v23;
    v50[3] = @"completionTime";
    v24 = [MEMORY[0x1E696AD98] numberWithDouble:*(a1 + 64)];
    v51[3] = v24;
    v50[4] = @"duration";
    v25 = [MEMORY[0x1E696AD98] numberWithDouble:*(a1 + 64) - *(a1 + 56)];
    v51[4] = v25;
    v50[5] = @"initialFirstColumnToCommit";
    v26 = [MEMORY[0x1E696AD98] numberWithInteger:*(a1 + 16)];
    v51[5] = v26;
    v50[6] = @"initialLastColumnToCommit";
    v27 = [MEMORY[0x1E696AD98] numberWithInteger:*(a1 + 24)];
    v51[6] = v27;
    v50[7] = @"strokesToReplace";
    v28 = [MEMORY[0x1E696AD98] numberWithUnsignedInteger:{objc_msgSend(*(a1 + 80), "count")}];
    v51[7] = v28;
    v29 = [MEMORY[0x1E695DF20] dictionaryWithObjects:v51 forKeys:v50 count:8];
    [v40 setObject:v29 forKeyedSubscript:@"commit"];

    v48[0] = @"isCanceled";
    v30 = [MEMORY[0x1E696AD98] numberWithBool:*(a1 + 104)];
    v49[0] = v30;
    v48[1] = @"isComplete";
    v31 = [MEMORY[0x1E696AD98] numberWithBool:*(a1 + 105)];
    v49[1] = v31;
    v48[2] = @"hasStrokeAnimationStarted";
    v32 = [MEMORY[0x1E696AD98] numberWithBool:*(a1 + 106)];
    v49[2] = v32;
    v48[3] = @"strokesRefinementSuccessful";
    v33 = [MEMORY[0x1E696AD98] numberWithBool:*(a1 + 107)];
    v49[3] = v33;
    v34 = [MEMORY[0x1E695DF20] dictionaryWithObjects:v49 forKeys:v48 count:4];
    [v40 setObject:v34 forKeyedSubscript:@"status"];
  }
...
- (void)trimTaskForNewStroke:(char *)a3 shouldCancel:
{
  ...
  v8 = [v5 path];
  v9 = -[PKFloatRange initWithLowerBound:upperBound:](v7, "initWithLowerBound:upperBound:", 0.0, [v8 count]);
  v133 = a1;
  ...
  v147 = v150;
  v148 = v151;
  [v6 enumerateInterpolatedPointsInRange:v9 strideByDistance:v145 usingBlock:3.0];
  ...
  while (2)
  {
    ...
    v30 = v29;
    v31 = [v30 transcriptionPaths];
    v32 = [v31 firstObject];
    v33 = [v28 transcriptionWithPath:v32 columnRange:v11 filterLowConfidence:{1, 0}];
    ...
    while (1)
    {
      ...
      v59 = [MEMORY[0x1E696AB08] punctuationCharacterSet];
      v60 = [v33 stringByTrimmingCharactersInSet:v59];
      if (![v60 length])
      {
...
LABEL_30:
      ...
      v70 = v69;
      v71 = [v70 transcriptionPaths];
      v72 = [v71 firstObject];
      v73 = [v68 transcriptionWithPath:v72 columnRange:v36 filterLowConfidence:{1, 0}];
...
- (void)trimTaskForNewItem:(_BYTE *)a3 shouldCancel:
{
  ...
  if (a1)
  {
    ...
    if (os_log_type_enabled(v11, OS_LOG_TYPE_DEFAULT))
    {
      ...
      v13 = v12;
      v14 = [v13 topTranscription];
      v15 = [v6 topTranscription];
      v16 = [v110 insertions];
      v17 = [v16 count];
      v18 = [v110 removals];
      *buf = 134219011;
    ...
    if ([v19 count])
    {
        ...
        if ([v21 count])
        {
          ...
          if (v26)
          {
            ...
            if (os_log_type_enabled(v27, OS_LOG_TYPE_DEBUG))
            {
              ...
              v85 = v84;
              v86 = [v85 tokenColumnCount];
              v87 = [v111 topTranscription];
              v88 = [v111 tokenColumnCount];
              *buf = 134219011;
              v113 = a1;
              v114 = 2117;
              v115 = v83;
      ...
      else
      {
        ...
        while (v32 < [v111 tokenColumnCount])
        {
          ...
          v41 = v40;
          v42 = [v41 refinableTranscriptionPath];
          v43 = [v39 transcriptionWithPath:v42 columnRange:v32 filterLowConfidence:{1, 0}];

          v44 = [v111 refinableTranscriptionPath];
          v45 = [v111 transcriptionWithPath:v44 columnRange:v32 filterLowConfidence:{1, 0}];

          LODWORD(v44) = [v43 isEqualToString:v45];
          v46 = [v34 isEqualToIndexSet:v37] & v44;
          v47 = v32;
          if ((v46 & 1) == 0)
          {
            ...
            if (os_log_type_enabled(v48, OS_LOG_TYPE_DEBUG))
            {
              ...
              v101 = v52;
              v99 = [v101 tokenColumnCount];
              v97 = a1[4];
              v98 = a1[5];
              v100 = [v111 topTranscription];
              v53 = [v111 tokenColumnCount];
              *buf = 134220803;
              v113 = a1;
              v114 = 2117;
              v115 = v103;
...
LABEL_46:
          ...
          v57 = v56;
          v58 = [v57 transcriptionPaths];
          v59 = [v58 firstObject];
          v60 = [v55 transcriptionWithPath:v59 columnRange:v31 filterLowConfidence:{v105, 0}];
          ...
          if (os_log_type_enabled(v61, OS_LOG_TYPE_DEBUG))
          {
            ...
            v75 = v74;
            v76 = [v75 tokenColumnCount];
            v78 = a1[4];
            v77 = a1[5];
            v79 = [v111 topTranscription];
            v80 = [v111 tokenColumnCount];
            *buf = 134219779;
            v113 = a1;
            v114 = 2117;
            v115 = v73;
        ...
        else
        {
          if (v47 < a1[5])
          {
            ...
            v67 = [v66 firstObject];
            v68 = [v63 transcriptionWithPath:v67 columnRange:? filterLowConfidence:?];
            ...
            a1[5] = v47;
            [(PKAutoRefineTask *)a1 updateCommittableRange];
        ...
        if (v30)
        {
          ...
          while (2)
          {
            for (j = 0; j != v30; ++j)
            {
              ...
              v33 = [*(*(&v100 + 1) + 8 * j) strokeUUID];
              v34 = [v16 _visibleStrokeForIdentifier:v33];
              ...
              {
                v25 = [(PKAutoRefineController *)v90 isRefinableStroke:v34];
                if (!v34)
                {
LABEL_64:
    ...
    if ((v26 & 1) == 0)
    {
      if (v25)
      {
          ...
          if (v40)
          {
            ...
            while (2)
            {
              for (k = 0; k != v40; ++k)
              {
                ...
                [(PKAutoRefineTask *)a1 trimTaskForNewStroke:&v99 shouldCancel:?];
                if (v99 == 1)
                {
        ...
        v47 = [MEMORY[0x1E695DFD8] setWithArray:v86];
            ...
            if (v56)
            {
              ...
              do
              {
                for (m = 0; m != v56; ++m)
                {
                  ...
                  v59 = [*(*(&v91 + 1) + 8 * m) strokeUUID];
                  v60 = [v16 _visibleStrokeForIdentifier:v59];
