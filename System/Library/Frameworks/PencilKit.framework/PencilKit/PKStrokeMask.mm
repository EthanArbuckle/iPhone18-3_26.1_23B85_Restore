...
- (__n128)calculateCenterlineSlices:(uint64_t)a3;
- (id).cxx_construct;
- (id)bezierPath;
...
- (PKStrokeMask)initWithMaskPaths:(const void *)a3 centerlineSlices:(const void *)a4
{
  ...
  if (v6 + 8 != a3)
  {
    std::vector<std::vector<ClipperLib::IntPoint>>::__assign_with_size[abi:ne200100]<std::vector<ClipperLib::IntPoint>*,std::vector<ClipperLib::IntPoint>*>(v6 + 1, *a3, *(a3 + 1), 0xAAAAAAAAAAAAAAABLL * ((*(a3 + 1) - *a3) >> 3));
  }
...
- (PKStrokeMask)initWithBezierPath:(id)a3 stroke:(id)a4
{
  ...
  PKClipperPathsFromCGPath([v6 PK_CGPath], 100.0);
}
...
- (PKStrokeMask)initWithArchive:(const void *)a3
{
  ...
  std::vector<std::vector<ClipperLib::IntPoint>>::reserve([(PKStrokeMask *)v3 maskPaths], (*(a3 + 9) - *(a3 + 8)) >> 4);
  v4 = *(a3 + 9) - *(a3 + 8);
  if (v4)
  {
    v60 = 0;
    ...
    do
    {
      ...
      if (v10 >= v9)
      {
        ...
        v14 = 0xAAAAAAAAAAAAAAABLL * ((v9 - *v7) >> 3);
        if (2 * v14 > v13)
        {
          v13 = 2 * v14;
        }
        ...
        if (v15)
        {
          std::__allocate_at_least[abi:ne200100]<std::allocator<std::vector<ClipperLib::IntPoint>>>(v7, v15);
        }
  ...
  v38 = [(PKStrokeMask *)v3 centerlineSlices];
  v39 = (*(a3 + 2) - *(a3 + 1)) >> 2;
  if (v39 >> 1 > (v38[2] - *v38) >> 4)
  {
    if (!(v39 >> 61))
    {
  ...
  if (v40)
  {
    ...
    do
    {
      v44 = [(PKStrokeMask *)v3 centerlineSlices];
      v45 = v44;
      v46 = vcvtq_f64_f32(*(*(a3 + 1) + v41));
      v48 = *(v44 + 8);
      v47 = *(v44 + 16);
      if (v48 >= v47)
      {
...
- (void)saveToArchive:(void *)a3
{
  v4 = [(PKStrokeMask *)self maskPaths];
  v5 = *v4;
  v51 = v4[1];
  if (*v4 != v51)
  {
  ...
  v23 = [(PKStrokeMask *)self centerlineSlices];
  v24 = (a3 + 8);
  v25 = (v23[1] - *v23) >> 3;
  if (v25 > (*(a3 + 3) - *(a3 + 1)) >> 2)
  {
    if (!(v25 >> 62))
    {
      std::__allocate_at_least[abi:ne200100]<std::allocator<float>>(a3 + 8, v25);
    }
...
LABEL_46:
  ...
  v26 = [(PKStrokeMask *)self centerlineSlices];
  v27 = *v26;
  v28 = v26[1];
  if (*v26 != v28)
  {
    ...
    do
    {
      ...
      if (v29 >= v32)
      {
        ...
        if (v38)
        {
          std::__allocate_at_least[abi:ne200100]<std::allocator<float>>(a3 + 8, v38);
        }
      ...
      *(a3 + 2) = v34;
      if (v34 >= v32)
      {
        ...
        if (v45)
        {
          std::__allocate_at_least[abi:ne200100]<std::allocator<float>>(a3 + 8, v45);
        }
...
- (CGRect)_boundsWithTransform:(CGAffineTransform *)a3
{
  ...
  v17 = *&a3->tx;
  v18 = *&a3->c;
  v3 = [(PKStrokeMask *)self maskPaths];
  v4 = *v3;
  v5 = v3[1];
  if (*v3 == v5)
  {
...
- (void)_transformBy:(id)a3
{
  ...
  if (begin != end)
  {
    ...
    do
    {
      ...
      while (v6 != v7)
      {
        v8.f64[0] = v11[2](*v6 / 100.0, v6[1] / 100.0);
        v8.f64[1] = v9;
...
LABEL_180:
    ...
    if (v13 == 5)
    {
      ...
      result.n128_u64[0] = std::__sort5[abi:ne200100]<std::_ClassicAlgPolicy,-[PKStrokeMask calculateCenterlineSlices:]::$_0 &,_PKFloatRange *,0>(v12, (v12 + 16), (v12 + 32), (v12 + 48), a2 - 2, result).n128_u64[0];
      return result;
    }
...
LABEL_61:
      ...
      *(v12 - 8) = v36;
      ...
      v46 = std::__insertion_sort_incomplete[abi:ne200100]<std::_ClassicAlgPolicy,-[PKStrokeMask calculateCenterlineSlices:]::$_0 &,_PKFloatRange *>(a1, (v12 - 16), result);
      if (std::__insertion_sort_incomplete[abi:ne200100]<std::_ClassicAlgPolicy,-[PKStrokeMask calculateCenterlineSlices:]::$_0 &,_PKFloatRange *>(v12, a2, v47))
      {
        a2 = (v12 - 16);
        if (!v46)
        {
      ...
      {
LABEL_80:
        std::__introsort<std::_ClassicAlgPolicy,[PKStrokeMask calculateCenterlineSlices:]::$_0 &,_PKFloatRange *,false>(a1, v12 - 16, a3, a4 & 1);
        a4 = 0;
      }
    }
