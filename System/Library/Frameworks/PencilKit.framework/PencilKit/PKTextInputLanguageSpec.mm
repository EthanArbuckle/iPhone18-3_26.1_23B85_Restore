...
- (void)initWithLocales:(void *)locales;
@end
...
- (void)initWithLocales:(void *)locales
{
  ...
  if (locales)
  {
    v11.receiver = locales;
    v11.super_class = PKTextInputLanguageSpec;
    locales = objc_msgSendSuper2(&v11, sel_init);
    if (locales)
    {
      v4 = [v3 copy];
      v5 = locales[3];
      ...
      if ([qword_1ED6A4F78 containsObject:lowercaseString])
      {
        v9 = 2;
      }

      else if ([_MergedGlobals_120 containsObject:lowercaseString])
      {
        v9 = 1;
      }
      ...
      {
        if (![qword_1ED6A4F80 containsObject:lowercaseString])
        {
          locales[1] = 0;
          goto LABEL_12;
        }
      ...
      locales[1] = v9;
LABEL_12:
      locales[2] = [qword_1ED6A4F88 containsObject:lowercaseString];
    }
  }
...
LABEL_7:
        if (v2)
        {
          incrementalCommitWordsBack = v3;
        }

        else
        {
          incrementalCommitWordsBack = 0;
        }
    ...
    incrementalCommitWordsBack = [v5 incrementalCommitWordsBack];

LABEL_11:
    if (incrementalCommitWordsBack <= 1)
    {
      return 1;
    }
    ...
    {
      return incrementalCommitWordsBack;
    }
  }
...
- (id)debugLocaleDescriptions
{
  ...
  if (self)
  {
    v2 = [MEMORY[0x1E695DF70] arrayWithCapacity:{objc_msgSend(self[3], "count")}];
    v10 = 0u;
    v11 = 0u;
    v12 = 0u;
    v13 = 0u;
    ...
    if (v4)
    {
      ...
      do
      {
        for (i = 0; i != v5; ++i)
        {
          ...
          localeIdentifier = [*(*(&v10 + 1) + 8 * i) localeIdentifier];
          if (localeIdentifier)
          {
            [v2 addObject:localeIdentifier];
          }
        }
