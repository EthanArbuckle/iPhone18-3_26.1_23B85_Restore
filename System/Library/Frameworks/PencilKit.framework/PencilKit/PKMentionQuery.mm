...
- (NSSet)validSuffixes;
- (PKMentionQuery)initWithRecognitionSessionManager:(id)manager;
...
- (PKMentionQuery)initWithRecognitionSessionManager:(id)manager
{
  ...
  if (v5)
  {
    ...
    v8 = [v6 mentionQueryForRecognitionSession:session];
...
- (void)setValidSuffixes:(id)suffixes
{
  ...
  [query setValidSuffixes:suffixesCopy];
}

- (NSSet)validSuffixes
{
  query = [(PKDetectionQuery *)self query];
  validSuffixes = [query validSuffixes];
...
- (void)queryDidUpdateResult:(id)result
{
  ...
  if (objc_opt_isKindOfClass())
  {
    ...
    if (v16)
    {
      ...
      v18 = [v8 copy];
      [delegate2 mentionQuery:self foundItems:v18];
    }
  }
}
