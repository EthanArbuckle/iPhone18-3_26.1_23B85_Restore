...
{
  v4 = [a3 copy];
  v5 = [(_GCGamepadEventGamepadHIDAdapter *)self observers];
  v6 = _Block_copy(v4);
  ...
  if ((v7 & 1) == 0)
  {
    do
    {
      v8 = [(_GCGamepadEventGamepadHIDAdapter *)self observers];
      v9 = [v8 mutableCopy];
      ...
      v11 = [(_GCGamepadEventGamepadHIDAdapter *)self observers];
      v12 = _Block_copy(v4);
