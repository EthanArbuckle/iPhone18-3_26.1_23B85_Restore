...
- (void)setGravity:(GCAcceleration)gravity
{
  ...
  y = gravity.y;
  x = gravity.x;
  v7 = [(GCMotion *)self controller];
  if (!v7 || (v8 = v7, -[GCMotion controller](self, "controller"), v9 = objc_claimAutoreleasedReturnValue(), v10 = [v9 isSnapshot], v9, v8, v10))
  {
    self->_gravity.x = x;
    self->_gravity.y = y;
    self->_gravity.z = z;
...
- (void)setAttitude:(GCQuaternion)attitude
{
  ...
  y = attitude.y;
  x = attitude.x;
  v8 = [(GCMotion *)self controller];
  if (!v8 || (v9 = v8, -[GCMotion controller](self, "controller"), v10 = objc_claimAutoreleasedReturnValue(), v11 = [v10 isSnapshot], v10, v9, v11))
  {
    self->_attitude.x = x;
    self->_attitude.y = y;
    self->_attitude.z = z;
...
- (void)setStateFromMotion:(GCMotion *)motion
{
  v4 = motion;
  v5 = [(GCMotion *)self controller];
  if (!v5 || (v6 = v5, -[GCMotion controller](self, "controller"), v7 = objc_claimAutoreleasedReturnValue(), v8 = [v7 isSnapshot], v7, v6, v8))
  {
...
{
  v5 = a3;
  v4 = [(GCMotion *)self identifier];
  [v5 encodeObject:v4 forKey:@"identifier"];

  [v5 encodeBool:-[GCMotion hasAttitude](self forKey:{"hasAttitude"), @"hasAttitude"}];
  [v5 encodeBool:-[GCMotion hasRotationRate](self forKey:{"hasRotationRate"), @"hasRotationRate"}];
}
