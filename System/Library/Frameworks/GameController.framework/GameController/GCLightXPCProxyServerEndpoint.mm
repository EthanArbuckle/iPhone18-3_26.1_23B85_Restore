...
- (GCLightXPCProxyServerEndpoint)initWithInitialValue:(id)a3
{
  ...
  v5 = a3;
  v6 = [v4 UUID];
  v7 = [(GCLightXPCProxyServerEndpoint *)self initWithIdentifier:v6 initialValue:v5];
...
- (void)setLight:(id)a3
{
  ...
  if (self->_light != v5)
  {
    objc_storeStrong(&self->_light, a3);
...
{
  v5 = a3;
  v6 = [(GCLightXPCProxyServerEndpoint *)self identifier];
  (*(a3 + 2))(v5, v6);
}
