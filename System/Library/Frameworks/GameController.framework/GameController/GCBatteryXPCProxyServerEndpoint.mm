...
- (GCBatteryXPCProxyServerEndpoint)initWithIdentifier:(id)identifier initialValue:(id)value;
- (GCBatteryXPCProxyServerEndpoint)initWithInitialValue:(id)value;
- (GCBatteryXPCProxyServerEndpointDelegate)delegate;
- (_GCControllerComponentDescription)receiverDescription;
- (void)fetchBatteryWithReply:(id)reply;
...
- (GCBatteryXPCProxyServerEndpoint)initWithIdentifier:(id)identifier initialValue:(id)value
{
  ...
  valueCopy = value;
  v12.receiver = self;
  v12.super_class = GCBatteryXPCProxyServerEndpoint;
  ...
  if (v8)
  {
    ...
    objc_storeStrong(&v8->_battery, value);
  }
...
- (GCBatteryXPCProxyServerEndpoint)initWithInitialValue:(id)value
{
  ...
  valueCopy = value;
  uUID = [v4 UUID];
  v7 = [(GCBatteryXPCProxyServerEndpoint *)self initWithIdentifier:uUID initialValue:valueCopy];
...
- (void)invalidateClient
{
  ...
  {
    OUTLINED_FUNCTION_8();
    OUTLINED_FUNCTION_0_0(&dword_1D2CD5000, v3, v4, "Dropping remote endpoint for %@", v5, v6, v7, v8, v9);
  }
...
- (BOOL)acceptClient:(id)client onConnection:(id)connection error:(id *)error
{
  ...
  {
    v20 = getGCLogger();
    [GCBatteryXPCProxyServerEndpoint acceptClient:v20 onConnection:? error:?];
  }
      ...
      if (v7 <= 6)
      {
        ...
        else
        {
          ...
          if (self->_pendingUpdates == 3)
          {
            ...
            v10[1] = 3221225472;
            v10[2] = __46__GCBatteryXPCProxyServerEndpoint_setBattery___block_invoke;
            v10[3] = &unk_1E8418C28;
            v10[4] = self;
...
- (void)fetchBatteryWithReply:(id)reply
{
  ...
  v6[1] = 3221225472;
  v6[2] = __57__GCBatteryXPCProxyServerEndpoint_fetchBatteryWithReply___block_invoke;
  v6[3] = &unk_1E8418D68;
  v6[4] = self;
  v7 = replyCopy;
  v5 = replyCopy;
  _os_activity_initiate(&dword_1D2CD5000, "(Battery XPC Proxy Server Endpoint) Fetch Battery", OS_ACTIVITY_FLAG_DEFAULT, v6);
}
...
- (void)invalidateConnection
{
  ...
  _os_activity_initiate(&dword_1D2CD5000, "(Battery XPC Proxy Server Endpoint) Invalidate Connection", OS_ACTIVITY_FLAG_DEFAULT, activity_block);
}
...
{
  replyCopy = reply;
  identifier = [(GCBatteryXPCProxyServerEndpoint *)self identifier];
...
- (void)setBattery:.cold.1()
{
  ...
  {
    OUTLINED_FUNCTION_8();
    OUTLINED_FUNCTION_0_0(&dword_1D2CD5000, v3, v4, "Sending new battery to remote endpoint: %@", v5, v6, v7, v8, v9);
  }
...
- (void)setBattery:.cold.2()
{
  ...
  {
    OUTLINED_FUNCTION_8();
    OUTLINED_FUNCTION_0_0(&dword_1D2CD5000, v3, v4, "Sending battery refresh request to remote endpoint: %@", v5, v6, v7, v8, v9);
  }
