...
- (void)makeMLIROpWithBuilder:(void *)builder symbolTable:(void *)table inputValues:(void *)values opInitialization:(BOOL)initialization name:(id)name
{
  ...
  v15 = mlir::FileLineColLoc::get(StringAttr, 0x4Du, 0);
  if (v12)
  {
    v16 = v12;
  ...
  {
    HIBYTE(v46) = 22;
    qmemcpy(__dst, "mps.cumulative_product", sizeof(__dst));
    v20 = &v46;
  }
...
LABEL_16:
  ...
  v29 = mlir::RegisteredOperationName::lookup(&mlir::detail::TypeIDResolver<mlir::mps::CumulativeProductOp,void>::id, Context);
  if ((v30 & 1) == 0)
  {
    v44 = 1283;
    v42.__r_.__value_.__r.__words[2] = "mps.cumulative_product";
    v43 = 22;
    v41 = 259;
  ...
  mlir::mps::CumulativeProductOp::build(builder, v47, *v25, v25[1], exclusive, reverse);
  v31 = mlir::OpBuilder::create(builder, v47);
  v32 = *(*(v31 + 48) + 16);
  mlir::OperationState::~OperationState(v47);
  if (v32 == &mlir::detail::TypeIDResolver<mlir::mps::CumulativeProductOp,void>::id)
  {
    v33 = v31;
  }
