...
- (void)makeMLIROpWithBuilder:(void *)a3 symbolTable:(void *)a4 inputValues:(void *)a5 opInitialization:(BOOL)a6 name:(id)a7
{
  ...
  v11 = MPSSymbolTable::getLocationByInsertingOp<mlir::mps::ReductionMinOp>(a4, a3, __p, 0x61u, v10);
  if (v22 < 0)
  {
...
LABEL_6:
  ...
  v18 = 1;
  v17 = 0;
  v19 = mlir::OpBuilder::create<mlir::mps::ReductionMinOp,mlir::Value &,mlir::Value &,BOOL,BOOL>(a3, v11, v12, &v20, &v18, &v17) - 16;
