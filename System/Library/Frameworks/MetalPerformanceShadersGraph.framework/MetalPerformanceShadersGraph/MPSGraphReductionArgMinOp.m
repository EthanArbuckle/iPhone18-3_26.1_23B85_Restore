...
- (void)makeMLIROpWithBuilder:(void *)a3 symbolTable:(void *)a4 inputValues:(void *)a5 opInitialization:(BOOL)a6 name:(id)a7
{
  ...
  v11 = MPSSymbolTable::getLocationByInsertingOp<mlir::mps::ReductionProdOp>(a4, a3, __p, 0x174u, v10);
  if (v21 < 0)
  {
...
LABEL_6:
  ...
  v17 = 1;
  v18 = mlir::OpBuilder::create<mlir::mps::ReductionArgMinOp,mlir::Value &,mlir::Value &,BOOL>(a3, v11, v12, &v19, &v17) - 16;
