...
- (void)makeMLIROpWithBuilder:(void *)a3 symbolTable:(void *)a4 inputValues:(void *)a5 opInitialization:(BOOL)a6 name:(id)a7
{
  ...
  *v19 = 0;
  ...
  LOBYTE(v55) = v21;
  v22 = mlir::Builder::getStringAttr(a3, v54);
...
LABEL_25:
  ...
  mlir::mps::ResizeOp::build(a3, v54, *v25, v25[1], v28, v27, mode, self->super._centerResult, self->super._alignCorners, v30);
  v34 = mlir::OpBuilder::create(a3, v54);
  v35 = *(*(v34 + 48) + 16);
...
- (id)partialDerivativeForInputTensor:(id)a3 incomingGradient:(id)a4 inputIndex:(unint64_t)a5 name:(id)a6
{
  ...
  if (!self->super._mode)
  {
    ...
    if (v20 == 2)
    {
      v18 = [WeakRetained resizeNearestWithGradientTensor:v11 input:v10 nearestRoundingMode:self->super._nearestRoundingMode centerResult:self->super._centerResult alignCorners:self->super._alignCorners layout:self->super._layout name:v12];
      goto LABEL_8;
    }

    v22 = [(MPSGraphOperation *)self inputTensors];
    v23 = [v22 objectAtIndexedSubscript:2];
    v24 = [v17 resizeNearestWithGradientTensor:v11 input:v10 scaleOffsetTensor:v23 nearestRoundingMode:self->super._nearestRoundingMode layout:self->super._layout name:v12];
LABEL_11:
    v13 = v24;
  ...
  if (v15 != 2)
  {
    v22 = [(MPSGraphOperation *)self inputTensors];
    v23 = [v22 objectAtIndexedSubscript:2];
    v24 = [v17 resizeWithGradientTensor:v11 input:v10 scaleOffsetTensor:v23 mode:self->super._mode layout:self->super._layout name:v12];
    goto LABEL_11;
  }

  v18 = [v16 resizeWithGradientTensor:v11 input:v10 mode:self->super._mode centerResult:self->super._centerResult alignCorners:self->super._alignCorners layout:self->super._layout name:v12];
LABEL_8:
  v13 = v18;
LABEL_12:
