...
- (void)makeMLIROpWithBuilder:(void *)builder symbolTable:(void *)table inputValues:(void *)values opInitialization:(BOOL)initialization name:(id)name
{
  ...
  v15 = mlir::FileLineColLoc::get(StringAttr, 0x627u, 0);
  if (v12)
  {
    v16 = v12;
  ...
  {
    v42 = 15;
    qmemcpy(__dst, "mpsx.interleave", sizeof(__dst));
    v20 = &v41;
  }
...
LABEL_16:
  ...
  v27 = mlir::RegisteredOperationName::lookup(&mlir::detail::TypeIDResolver<mlir::mpsx::InterleaveOp,void>::id, Context);
  if ((v28 & 1) == 0)
  {
    v39 = 1283;
    v37.__r_.__value_.__r.__words[2] = "mpsx.interleave";
    v38 = 15;
    v36 = 259;
  ...
  mlir::mpsx::InterleaveOp::build(builder, v43, *v25, self->_interleaveFactor);
  v29 = mlir::OpBuilder::create(builder, v43);
  v30 = *(v29[6] + 16);
  mlir::OperationState::~OperationState(v43);
  if (v30 != &mlir::detail::TypeIDResolver<mlir::mpsx::InterleaveOp,void>::id)
  {
    v29 = 0;
  }
