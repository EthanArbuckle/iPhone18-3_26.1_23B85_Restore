...
LABEL_16:
  ...
  mlir::mps::ATan2Op::build(a3, v44, *v24, v24[1]);
  v28 = mlir::OpBuilder::create(a3, v44);
  v29 = *(*(v28 + 48) + 16);
...
- (id)partialDerivativeForInputTensor:(id)a3 incomingGradient:(id)a4 inputIndex:(unint64_t)a5 name:(id)a6
{
  ...
  if (v14 != v9 && MTLReportFailureTypeEnabled())
  {
    MTLReportFailure();
  }

  WeakRetained = objc_loadWeakRetained(&self->super._graph);
  v16 = [WeakRetained constantWithScalar:&unk_1F5B77978 shape:objc_msgSend(v9 dataType:{"dataType"), 0.0}];

  v17 = objc_loadWeakRetained(&self->super._graph);
  v38 = v16;
  v18 = [v17 constantWithScalar:&unk_1F5B77990 shape:objc_msgSend(v9 dataType:{"dataType"), 1.0}];

  v19 = objc_loadWeakRetained(&self->super._graph);
  v39 = v18;
  if (v11)
  {
    v20 = [v11 stringByAppendingString:@"/lessThanOrEqualTo"];
  }
  ...
  v37 = [v19 greaterThanWithPrimaryTensor:v9 secondaryTensor:v16 name:v20];
  if (v11)
  {
  }

  v21 = objc_loadWeakRetained(&self->super._graph);
  v22 = [(MPSGraphOperation *)self outputTensors];
  v23 = [v22 objectAtIndexedSubscript:0];
  v24 = [(MPSGraphOperation *)self inputTensors];
  v25 = [v24 objectAtIndexedSubscript:1];
  if (v11)
  {
    v26 = [v11 stringByAppendingString:@"/negativeRegionGradient"];
  }
  ...
  if (v11)
  {
    v29 = v39;
    v30 = v37;
    v31 = [v11 stringByAppendingString:@"/localGradient"];
  }
  ...
  if (v11)
  {
    ...
    v34 = [v11 stringByAppendingString:@"/select"];
  }
  ...
  v35 = [v33 multiplicationWithPrimaryTensor:v10 secondaryTensor:v32 name:v34];
  if (v11)
  {
  }
