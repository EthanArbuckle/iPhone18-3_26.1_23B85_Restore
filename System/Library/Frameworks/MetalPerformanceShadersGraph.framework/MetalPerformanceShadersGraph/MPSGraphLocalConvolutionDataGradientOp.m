...
- (void)makeMLIROpWithBuilder:(void *)a3 symbolTable:(void *)a4 inputValues:(void *)a5 opInitialization:(BOOL)a6 name:(id)a7
{
  ...
  v25 = mlir::RegisteredOperationName::lookup(&mlir::detail::TypeIDResolver<mlir::mps::LocalConvolutionDataGradientOp,void>::id, Context);
  if ((v26 & 1) == 0)
  {
    v39 = 1283;
    v38[2] = "mps.local_convolution_data_gradient";
    v38[3] = 35;
    v37 = 259;
