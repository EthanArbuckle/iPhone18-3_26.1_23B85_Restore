...
void *mlir::RegisteredOperationName::Model<mlir::anec::L2NormPool>::Model(void *a1, uint64_t a2)
{
  ...
  mlir::OperationName::Impl::Impl(a1, "anec.l2norm_pool", 16, a2, &mlir::detail::TypeIDResolver<mlir::anec::L2NormPool,void>::id, &v9);
  v4 = v9;
  if (v10)
  {
    v5 = 16 * v10;
...
uint64_t mlir::RegisteredOperationName::Model<mlir::anec::LayerNorm>::printAssembly(uint64_t a1, uint64_t a2, uint64_t a3, uint64_t a4, uint64_t a5)
{
  v11 = *MEMORY[0x1E69E9840];
