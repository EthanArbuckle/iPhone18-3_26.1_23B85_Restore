...
LABEL_15:
  ...
  v29 = mlir::RegisteredOperationName::lookup(&mlir::detail::TypeIDResolver<mlir::mps::FastFourierTransformOp,void>::id, Context);
  if ((v30 & 1) == 0)
  {
    v41 = 1283;
    v39.__r_.__value_.__r.__words[2] = "mps.fast_fourier_transform";
    v40 = 26;
    v38 = 259;
  ...
  mlir::mps::FastFourierTransformOp::build(builder, v44, *v27, v27[1], v26, inverse);
  v31 = mlir::OpBuilder::create(builder, v44);
  v32 = *(v31[6] + 16);
  mlir::OperationState::~OperationState(v44);
  if (v32 != &mlir::detail::TypeIDResolver<mlir::mps::FastFourierTransformOp,void>::id)
  {
    v31 = 0;
  }
