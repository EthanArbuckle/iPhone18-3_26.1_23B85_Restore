...
LABEL_16:
  ...
  v26 = mlir::RegisteredOperationName::lookup(&mlir::detail::TypeIDResolver<mlir::mpsx::ListPopBackOp,void>::id, Context);
  if ((v27 & 1) == 0)
  {
    v39 = 1283;
    v37.__r_.__value_.__r.__words[2] = "mpsx.list_pop_back";
    v38 = 18;
    v36 = 259;
  ...
  mlir::mpsx::ListPopBackOp::build(a3, v43, *v24);
  v28 = mlir::OpBuilder::create(a3, v43);
  v29 = *(*(v28 + 48) + 16);
  mlir::OperationState::~OperationState(v43);
  if (v29 == &mlir::detail::TypeIDResolver<mlir::mpsx::ListPopBackOp,void>::id)
  {
    v30 = v28;
  }
