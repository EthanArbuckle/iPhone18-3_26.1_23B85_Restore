...
- (void)makeMLIROpWithBuilder:(void *)builder symbolTable:(void *)table inputValues:(void *)values opInitialization:(BOOL)initialization name:(id)name
{
  ...
  {
    v44[2] = 21;
    qmemcpy(__dst, "mps.space_to_depth_2d", sizeof(__dst));
    v20 = v44;
  }
...
LABEL_16:
  ...
  v27 = mlir::RegisteredOperationName::lookup(&mlir::detail::TypeIDResolver<mlir::mps::SpaceToDepth2DOp,void>::id, Context);
  if ((v28 & 1) == 0)
  {
    v42 = 1283;
    v40.__r_.__value_.__r.__words[2] = "mps.space_to_depth_2d";
    v41 = 21;
    v39 = 259;
