...
- (id)objectAtIndex:(unint64_t)a3
{
  ...
  if ((a3 & 0x8000000000000000) != 0 || cnt <= a3)
  {
    ...
    {
      v12 = cnt - 1;
      v13 = __os_log_helper_1_2_3_8_32_8_0_8_0(v10, "[__NSOrderedSetReversed objectAtIndex:]", a3, v12);
      v11 = CFStringCreateWithFormat(&__kCFAllocatorSystemDefault, 0, @"*** %s: index %lu beyond bounds [0 .. %lu]", v13, "[__NSOrderedSetReversed objectAtIndex:]", a3, v12);
    }
    ...
    else
    {
      ...
      *(v10 + 12) = 2048;
      *(v10 + 14) = a3;
      v11 = CFStringCreateWithFormat(&__kCFAllocatorSystemDefault, 0, @"*** %s: index %lu beyond bounds for empty ordered set", "[__NSOrderedSetReversed objectAtIndex:]", a3);
    }
