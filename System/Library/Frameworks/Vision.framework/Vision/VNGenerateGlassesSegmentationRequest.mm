...
- (BOOL)internalPerformRevision:(unint64_t)revision inContext:(id)context error:(id *)error
{
  ...
  if (v9)
  {
    ...
    v11 = [(VNGenerateGlassesSegmentationRequest *)self newDefaultDetectorOptionsForRequestRevision:revision session:session];
    v21[0] = v9;
    v12 = [MEMORY[0x1E695DEC8] arrayWithObjects:v21 count:1];
    [v11 setObject:v12 forKeyedSubscript:@"VNDetectorProcessOption_InputImageBuffers"];

    qualityLevel = [(VNGenerateGlassesSegmentationRequest *)self qualityLevel];
    if (qualityLevel)
    {
      if (qualityLevel == 1)
      {
...
- (id)applicableDetectorTypeForRevision:(unint64_t)revision error:(id *)error
{
  ...
  qualityLevel2 = [(VNGenerateGlassesSegmentationRequest *)self qualityLevel];
  if (qualityLevel2 == 1)
  {
