...
+ (id)createNSExceptionWithStatus:(int64_t)status andMessage:(id)message
{
  ...
  else
  {
    ...
    v11 = [mainBundle localizedStringForKey:v9 value:&stru_1F1976900 table:0];
    v19[0] = v11;
    ...
    v16 = [mainBundle2 localizedStringForKey:v15 value:&stru_1F1976900 table:0];
...
+ (id)createNSErrorWithStatus:(int64_t)status andMessage:(id)message
{
  ...
  else
  {
    ...
    mainBundle = [MEMORY[0x1E696AAE8] mainBundle];
    v11 = [mainBundle localizedStringForKey:messageCopy value:&stru_1F1976900 table:0];

    v18[0] = v11;
    v17[1] = *MEMORY[0x1E696A588];
    mainBundle2 = [MEMORY[0x1E696AAE8] mainBundle];
    v13 = [MEMORY[0x1E696AEC0] stringWithUTF8String:CVML_getStatusDescription(status)];
    v14 = [mainBundle2 localizedStringForKey:v13 value:&stru_1F1976900 table:0];
    v18[1] = v14;
