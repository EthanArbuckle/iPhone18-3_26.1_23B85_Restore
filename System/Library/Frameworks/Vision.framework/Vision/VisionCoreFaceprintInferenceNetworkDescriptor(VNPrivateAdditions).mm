...
- (VNFaceprint)VNFaceprintFromData:()VNPrivateAdditions confidence:originatingRequestSpecifier:error:
{
  ...
  *&v12 = a2;
  ...
  {
    faceprintOutput = [self faceprintOutput];
    if (faceprintOutput)
    {
      v29 = 0;
      v30 = 0;
      v28 = 0;
      v14 = [self getVNEspressoModelImageprintData:&v28 elementType:&v30 elementCount:&v29 fromTensorData:v10 descriptor:faceprintOutput error:a6];
      v15 = v28;
      v16 = v15;
      if (v14)
      {
        ...
        bytes = [v16 bytes];
        v20 = vision::mod::FaceprintAndAttributes::normalizeFacePrintData(bytes, v29, 1, __p[0], v19);
        if (v20 == 128)
        {
...
- (id)VNFaceprintFromOutputObjects:()VNPrivateAdditions originatingRequestSpecifier:error:
{
  ...
  if (faceprintOutput)
  {
    confidencesOutput = [self confidencesOutput];
    if (confidencesOutput)
    {
      v27 = 0;
      if ([v8 VNGetConfidenceValue:&v27 asTensor:confidencesOutput error:a5])
      {
        v21 = 0;
        v22 = &v21;
        v23 = 0x3032000000;
        ...
        name = [faceprintOutput name];
        v14 = [v8 accessReadOnlyDataForName:name usingBlock:v12 error:a5];
