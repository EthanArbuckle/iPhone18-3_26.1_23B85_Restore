...
- (BOOL)internalPerformRevision:(unint64_t)a3 inContext:(id)a4 error:(id *)a5
{
  ...
  {
    v10 = [v8 session];
    v11 = [(VNGenerateHumanAttributesSegmentationRequest *)self newDefaultDetectorOptionsForRequestRevision:a3 session:v10];
    v21[0] = v9;
    v12 = [MEMORY[0x1E695DEC8] arrayWithObjects:v21 count:1];
    [v11 setObject:v12 forKeyedSubscript:@"VNDetectorProcessOption_InputImageBuffers"];

    v13 = [(VNGenerateHumanAttributesSegmentationRequest *)self qualityLevel];
    if (v13)
    {
      if (v13 == 1)
      {
...
{
  v4 = a3;
  v5 = [(VNGenerateHumanAttributesSegmentationRequest *)self qualityLevel];
...
- (id)applicableDetectorTypeForRevision:(unint64_t)a3 error:(id *)a4
{
  if (a3 != 3737841664)
  {
    ...
    v6 = [(VNGenerateHumanAttributesSegmentationRequest *)self qualityLevel];
    if (v6 == 1)
    {
  ...
  v7 = [(VNGenerateHumanAttributesSegmentationRequest *)self qualityLevel];
  if (v7 == 1)
  {
...
- (id)supportedHumanAttributesNamesAndReturnError:(id *)a3
{
  ...
  {
    v6 = [objc_opt_class() _supportedHumanAttributesNamesRevision1];
  }
