...
- (VNCoreSceneUnderstandingDetectorRecognizeObjectsConfiguration)initWithObservationsRecipient:(id)recipient;
...
- (BOOL)isEqual:(id)equal
{
  ...
  else
  {
    ...
    if (objc_opt_isKindOfClass())
    {
      ...
      {
        targetedIdentifiers = [(VNCoreSceneUnderstandingDetectorRecognizeObjectsConfiguration *)self targetedIdentifiers];
        targetedIdentifiers2 = [(VNCoreSceneUnderstandingDetectorRecognizeObjectsConfiguration *)v5 targetedIdentifiers];
