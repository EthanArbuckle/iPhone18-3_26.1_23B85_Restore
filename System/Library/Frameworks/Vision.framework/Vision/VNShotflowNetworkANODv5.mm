...
- (id)processVImage:(vImage_Buffer *)a3 inputIsBGR:(BOOL)a4
{
  ...
  v66[0] = *&a3->data;
  v66[1] = v9;
  [(VNShotflowNetwork *)self runNetwork:v66 inputIsBGR:v4];
  ...
  if (v16 >= 1)
  {
    ...
    do
    {
      ...
      if (v23 >= 0.3)
      {
        ...
        LODWORD(v56) = v37;
        v52 = [(VNShotflowDetection *)v45 initWithBox:0 defaultBox:v46[1] - *v46 > 8uLL confidence:v26 scale:v49 * 0.5 + v47 - v49 * 0.5 rotationAngle:v51 yawAngle:v49 pitchAngle:v50 hasLabel:v49 * 0.5 + v47 - v49 * 0.5 label:v51 petFaceScore:v49 associatedX:v50 associatedY:__PAIR64__(LODWORD(v65), LODWORD(v23)), v62, __PAIR64__(v39, v36), v56];
        [v10 addObject:v52];
      }
