...
- (NSString)description
{
  v2 = CFStringCreateWithFormat(*MEMORY[0x1E695E480], 0, @"<nw_connection_group_send_request>");
...
{
  v2.receiver = self;
  v2.super_class = NWConcrete_nw_connection_group_send_request;
...
- (NWConcrete_nw_connection_group_send_request)init
{
  ...
  v16.receiver = self;
  v16.super_class = NWConcrete_nw_connection_group_send_request;
  v2 = [(NWConcrete_nw_connection_group_send_request *)&v16 init];
  v3 = v2;
  if (v2)
  {
    v4 = v2;
