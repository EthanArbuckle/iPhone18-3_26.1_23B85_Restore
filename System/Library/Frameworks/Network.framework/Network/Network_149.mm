void nw_parameters_set_required_address_family(uint64_t a1, int a2)
{
  ...
  if (a1)
  {
    v13 = _nw_parameters_copy_default_protocol_stack(a1);
    v3 = nw_protocol_stack_copy_internet_protocol_as_ip_options(v13, 1);
    v4 = v3;
    if (v3)
    {
      if (a2 == 2)
      ...
      if (a2 == 30)
      {
        v5 = 6;
LABEL_7:
        _nw_ip_options_set_version(v3, v5);
      }
    }
  ...
  v6 = __nwlog_obj();
  *buf = 136446210;
  v17 = "nw_parameters_set_required_address_family";
...
void nw_parameters_set_local_address_preference(uint64_t a1, uint64_t a2)
{
  ...
  if (a1)
  {
    v12 = _nw_parameters_copy_default_protocol_stack(a1);
...
void *nw_parameters_get_upper_transport_protocol_identifier(uint64_t a1)
{
  ...
  if (a1)
  {
    ...
    if (v2)
    {
      ...
      {
        v5 = _nw_protocol_options_copy_definition(v3);
...
void nw_parameters_set_parent_id(void *a1, uint64_t a2)
{
  ...
  if (!v3)
  {
    v5 = __nwlog_obj();
    *buf = 136446210;
    v18 = "nw_parameters_set_parent_id";
    v6 = _os_log_send_and_compose_impl();
...
LABEL_33:
  ...
  if (a2)
  {
    _nw_parameters_set_parent_id_inner(v3, a2, 1);
    goto LABEL_4;
  }
...
void nw_parameters_set_prohibit_roaming(char *a1, char a2)
{
  v15 = *MEMORY[0x1E69E9840];
  if (a1)
  {

    _nw_parameters_set_prohibit_roaming(a1, a2);
    return;
  }

  v2 = __nwlog_obj();
  *buf = 136446210;
  v12 = "nw_parameters_set_prohibit_roaming";
  v3 = _os_log_send_and_compose_impl();
...
void nw_parameters_set_use_long_outstanding_queries(char *a1, char a2)
{
  v15 = *MEMORY[0x1E69E9840];
  if (a1)
  {

    _nw_parameters_set_use_long_outstanding_queries(a1, a2);
    return;
  }

  v2 = __nwlog_obj();
  *buf = 136446210;
  v12 = "nw_parameters_set_use_long_outstanding_queries";
  v3 = _os_log_send_and_compose_impl();
...
void nw_parameters_set_ignore_resolver_stats(char *a1, char a2)
{
  v15 = *MEMORY[0x1E69E9840];
  if (a1)
  {

    _nw_parameters_set_ignore_resolver_stats(a1, a2);
    return;
  }

  v2 = __nwlog_obj();
  *buf = 136446210;
  v12 = "nw_parameters_set_ignore_resolver_stats";
  v3 = _os_log_send_and_compose_impl();
...
void nw_parameters_set_use_awdl(uint64_t a1, uint64_t a2)
{
  v15 = *MEMORY[0x1E69E9840];
  if (a1)
  {

    _nw_parameters_set_use_awdl(a1, a2);
    return;
  }

  v2 = __nwlog_obj();
  *buf = 136446210;
  v12 = "nw_parameters_set_use_awdl";
  v3 = _os_log_send_and_compose_impl();
...
void nw_parameters_set_resolve_ptr(char *a1, char a2)
{
  v15 = *MEMORY[0x1E69E9840];
  if (a1)
  {

    _nw_parameters_set_resolve_ptr(a1, a2);
    return;
  }

  v2 = __nwlog_obj();
  *buf = 136446210;
  v12 = "nw_parameters_set_resolve_ptr";
  v3 = _os_log_send_and_compose_impl();
...
void nw_parameters_set_no_proxy(char *a1, char a2)
{
  v15 = *MEMORY[0x1E69E9840];
  if (a1)
  {
...
void nw_parameters_set_no_opaque_proxy(char *a1, char a2)
{
  v15 = *MEMORY[0x1E69E9840];
  if (a1)
  {

    _nw_parameters_set_no_opaque_proxy(a1, a2);
    return;
  }

  v2 = __nwlog_obj();
  *buf = 136446210;
  v12 = "nw_parameters_set_no_opaque_proxy";
  v3 = _os_log_send_and_compose_impl();
...
void nw_parameters_set_no_fallback(char *a1, char a2)
{
  v15 = *MEMORY[0x1E69E9840];
  if (a1)
  {

    _nw_parameters_set_no_fallback(a1, a2);
    return;
  }

  v2 = __nwlog_obj();
  *buf = 136446210;
  v12 = "nw_parameters_set_no_fallback";
  v3 = _os_log_send_and_compose_impl();
...
void nw_parameters_set_sleep_keepalive_interval(char *a1, unsigned int a2)
{
  v15 = *MEMORY[0x1E69E9840];
  if (a1)
  {

    _nw_parameters_set_sleep_keepalive_interval(a1, a2);
    return;
  }

  v2 = __nwlog_obj();
  *buf = 136446210;
  v12 = "nw_parameters_set_sleep_keepalive_interval";
  v3 = _os_log_send_and_compose_impl();
...
void nw_parameters_set_is_encrypted_dns_resolver_connection(char *a1, char a2)
{
  v15 = *MEMORY[0x1E69E9840];
  if (a1)
  {

    _nw_parameters_set_is_encrypted_dns_resolver_connection(a1, a2);
    return;
  }

  v2 = __nwlog_obj();
  *buf = 136446210;
  v12 = "nw_parameters_set_is_encrypted_dns_resolver_connection";
  v3 = _os_log_send_and_compose_impl();
...
void nw_parameters_set_multipath_force_enable(char *a1, char a2)
{
  v15 = *MEMORY[0x1E69E9840];
  if (a1)
  {

    _nw_parameters_set_multipath_force_enable(a1, a2);
    return;
  }

  v2 = __nwlog_obj();
  *buf = 136446210;
  v12 = "nw_parameters_set_multipath_force_enable";
  v3 = _os_log_send_and_compose_impl();
...
void nw_parameters_set_no_fullstack_fallback(char *a1, char a2)
{
  v15 = *MEMORY[0x1E69E9840];
  if (a1)
  {

    _nw_parameters_set_no_fullstack_fallback(a1, a2);
    return;
  }

  v2 = __nwlog_obj();
  *buf = 136446210;
  v12 = "nw_parameters_set_no_fullstack_fallback";
  v3 = _os_log_send_and_compose_impl();
...
void nw_parameters_set_block_trackers(char *a1, char a2)
{
  v15 = *MEMORY[0x1E69E9840];
  if (a1)
  {

    _nw_parameters_set_block_trackers(a1, a2);
    return;
  }

  v2 = __nwlog_obj();
  *buf = 136446210;
  v12 = "nw_parameters_set_block_trackers";
  v3 = _os_log_send_and_compose_impl();
...
void nw_parameters_set_no_delay(char *a1, char a2)
{
  v15 = *MEMORY[0x1E69E9840];
  if (a1)
  {
...
void nw_parameters_set_reduce_buffering(char *a1, char a2)
{
  v15 = *MEMORY[0x1E69E9840];
  if (a1)
  {
...
void nw_parameters_set_tfo_no_cookie(char *a1, char a2)
{
  v15 = *MEMORY[0x1E69E9840];
  if (a1)
  {
...
void nw_parameters_set_fast_open_force_enable(char *a1, char a2)
{
  v15 = *MEMORY[0x1E69E9840];
  if (a1)
  {
...
void nw_parameters_set_keepalive_enabled(char *a1, char a2)
{
  v15 = *MEMORY[0x1E69E9840];
  if (a1)
  {
...
void nw_parameters_set_keepalive_offload(char *a1, char a2)
{
  v15 = *MEMORY[0x1E69E9840];
  if (a1)
  {
...
void nw_parameters_set_background_traffic_management(char *a1, char a2)
{
  v15 = *MEMORY[0x1E69E9840];
  if (a1)
  {
...
void nw_parameters_set_prohibit_encrypted_dns(char *a1, char a2)
{
  v15 = *MEMORY[0x1E69E9840];
  if (a1)
  {

    _nw_parameters_set_prohibit_encrypted_dns(a1, a2);
    return;
  }

  v2 = __nwlog_obj();
  *buf = 136446210;
  v12 = "nw_parameters_set_prohibit_encrypted_dns";
  v3 = _os_log_send_and_compose_impl();
...
void nw_parameters_set_fail_if_svcb_received(char *a1, char a2)
{
  v15 = *MEMORY[0x1E69E9840];
  if (a1)
  {

    _nw_parameters_set_fail_if_svcb_received(a1, a2);
    return;
  }

  v2 = __nwlog_obj();
  *buf = 136446210;
  v12 = "nw_parameters_set_fail_if_svcb_received";
  v3 = _os_log_send_and_compose_impl();
...
void nw_parameters_set_allow_internet_fallback(char *a1, char a2)
{
  v15 = *MEMORY[0x1E69E9840];
  if (a1)
  {

    _nw_parameters_set_allow_internet_fallback(a1, a2);
    return;
  }

  v2 = __nwlog_obj();
  *buf = 136446210;
  v12 = "nw_parameters_set_allow_internet_fallback";
  v3 = _os_log_send_and_compose_impl();
...
void nw_parameters_set_is_probe(uint64_t a1, uint64_t a2)
{
  v15 = *MEMORY[0x1E69E9840];
  if (a1)
  {

    _nw_parameters_set_is_probe(a1, a2);
    return;
  }

  v2 = __nwlog_obj();
  *buf = 136446210;
  v12 = "nw_parameters_set_is_probe";
  v3 = _os_log_send_and_compose_impl();
...
void nw_parameters_set_allow_unusable_addresses(char *a1, char a2)
{
  v15 = *MEMORY[0x1E69E9840];
  if (a1)
  {

    _nw_parameters_set_allow_unusable_addresses(a1, a2);
    return;
  }

  v2 = __nwlog_obj();
  *buf = 136446210;
  v12 = "nw_parameters_set_allow_unusable_addresses";
  v3 = _os_log_send_and_compose_impl();
...
void nw_parameters_set_no_proxy_path_selection(char *a1, char a2)
{
  v15 = *MEMORY[0x1E69E9840];
  if (a1)
  {

    _nw_parameters_set_no_proxy_path_selection(a1, a2);
    return;
  }

  v2 = __nwlog_obj();
  *buf = 136446210;
  v12 = "nw_parameters_set_no_proxy_path_selection";
  v3 = _os_log_send_and_compose_impl();
...
void nw_parameters_set_privacy_proxy_fail_closed(char *a1, char a2)
{
  v15 = *MEMORY[0x1E69E9840];
  if (a1)
  {

    _nw_parameters_set_privacy_proxy_fail_closed(a1, a2);
    return;
  }

  v2 = __nwlog_obj();
  *buf = 136446210;
  v12 = "nw_parameters_set_privacy_proxy_fail_closed";
  v3 = _os_log_send_and_compose_impl();
...
void nw_parameters_set_privacy_proxy_strict_fail_closed(char *a1, char a2)
{
  v15 = *MEMORY[0x1E69E9840];
  if (a1)
  {

    _nw_parameters_set_privacy_proxy_strict_fail_closed(a1, a2);
    return;
  }

  v2 = __nwlog_obj();
  *buf = 136446210;
  v12 = "nw_parameters_set_privacy_proxy_strict_fail_closed";
  v3 = _os_log_send_and_compose_impl();
...
void nw_parameters_set_privacy_proxy_fail_closed_for_unreachable_hosts(char *a1, char a2)
{
  v15 = *MEMORY[0x1E69E9840];
  if (a1)
  {

    _nw_parameters_set_privacy_proxy_fail_closed_for_unreachable_hosts(a1, a2);
    return;
  }

  v2 = __nwlog_obj();
  *buf = 136446210;
  v12 = "nw_parameters_set_privacy_proxy_fail_closed_for_unreachable_hosts";
  v3 = _os_log_send_and_compose_impl();
...
void nw_parameters_set_prohibit_privacy_proxy(char *a1, char a2)
{
  v15 = *MEMORY[0x1E69E9840];
  if (a1)
  {

    _nw_parameters_set_prohibit_privacy_proxy(a1, a2);
    return;
  }

  v2 = __nwlog_obj();
  *buf = 136446210;
  v12 = "nw_parameters_set_prohibit_privacy_proxy";
  v3 = _os_log_send_and_compose_impl();
...
void nw_parameters_set_channel_teardown_delay(char *a1, uint64_t a2)
{
  v15 = *MEMORY[0x1E69E9840];
  if (a1)
  {

    _nw_parameters_set_channel_teardown_delay(a1, a2);
    return;
  }

  v2 = __nwlog_obj();
  *buf = 136446210;
  v12 = "nw_parameters_set_channel_teardown_delay";
  v3 = _os_log_send_and_compose_impl();
...
void nw_parameters_set_use_persona(char *a1, char a2)
{
  v15 = *MEMORY[0x1E69E9840];
  if (a1)
  {

    _nw_parameters_set_use_persona(a1, a2);
    return;
  }

  v2 = __nwlog_obj();
  *buf = 136446210;
  v12 = "nw_parameters_set_use_persona";
  v3 = _os_log_send_and_compose_impl();
...
void nw_parameters_set_desperate_ivan(char *a1, char a2)
{
  v15 = *MEMORY[0x1E69E9840];
  if (a1)
  {

    _nw_parameters_set_desperate_ivan(a1, a2);
    return;
  }

  v2 = __nwlog_obj();
  *buf = 136446210;
  v12 = "nw_parameters_set_desperate_ivan";
  v3 = _os_log_send_and_compose_impl();
...
void nw_parameters_set_custom_protocols_only(char *a1, char a2)
{
  v15 = *MEMORY[0x1E69E9840];
  if (a1)
  {

    _nw_parameters_set_custom_protocols_only(a1, a2);
    return;
  }

  v2 = __nwlog_obj();
  *buf = 136446210;
  v12 = "nw_parameters_set_custom_protocols_only";
  v3 = _os_log_send_and_compose_impl();
...
void nw_parameters_set_companion_link_upgrade_preference(char *a1, int a2)
{
  v15 = *MEMORY[0x1E69E9840];
  if (a1)
  {

    _nw_parameters_set_companion_link_upgrade_preference(a1, a2);
    return;
  }

  v2 = __nwlog_obj();
  *buf = 136446210;
  v12 = "nw_parameters_set_companion_link_upgrade_preference";
  v3 = _os_log_send_and_compose_impl();
...
void nw_parameters_set_receive_any_interface(char *a1, char a2)
{
  v15 = *MEMORY[0x1E69E9840];
  if (a1)
  {

    _nw_parameters_set_receive_any_interface(a1, a2);
    return;
  }

  v2 = __nwlog_obj();
  *buf = 136446210;
  v12 = "nw_parameters_set_receive_any_interface";
  v3 = _os_log_send_and_compose_impl();
...
void nw_parameters_set_ecn_mode(char *a1, int a2)
{
  v15 = *MEMORY[0x1E69E9840];
  if (a1)
  {

    _nw_parameters_set_ecn_mode(a1, a2);
    return;
  }

  v2 = __nwlog_obj();
  *buf = 136446210;
  v12 = "nw_parameters_set_ecn_mode";
  v3 = _os_log_send_and_compose_impl();
...
void nw_parameters_set_https_proxy_is_opaque(char *a1, char a2)
{
  v15 = *MEMORY[0x1E69E9840];
  if (a1)
  {

    _nw_parameters_set_https_proxy_is_opaque(a1, a2);
    return;
  }

  v2 = __nwlog_obj();
  *buf = 136446210;
  v12 = "nw_parameters_set_https_proxy_is_opaque";
  v3 = _os_log_send_and_compose_impl();
...
void nw_parameters_set_https_proxy_over_tls(char *a1, char a2)
{
  v15 = *MEMORY[0x1E69E9840];
  if (a1)
  {

    _nw_parameters_set_https_proxy_over_tls(a1, a2);
    return;
  }

  v2 = __nwlog_obj();
  *buf = 136446210;
  v12 = "nw_parameters_set_https_proxy_over_tls";
  v3 = _os_log_send_and_compose_impl();
...
void nw_parameters_set_stricter_path_scoping(char *a1, char a2)
{
  v15 = *MEMORY[0x1E69E9840];
  if (a1)
  {

    _nw_parameters_set_stricter_path_scoping(a1, a2);
    return;
  }

  v2 = __nwlog_obj();
  *buf = 136446210;
  v12 = "nw_parameters_set_stricter_path_scoping";
  v3 = _os_log_send_and_compose_impl();
...
void nw_parameters_set_allow_joining_connected_fd(char *a1, char a2)
{
  v15 = *MEMORY[0x1E69E9840];
  if (a1)
  {

    _nw_parameters_set_allow_joining_connected_fd(a1, a2);
    return;
  }

  v2 = __nwlog_obj();
  *buf = 136446210;
  v12 = "nw_parameters_set_allow_joining_connected_fd";
  v3 = _os_log_send_and_compose_impl();
...
void nw_parameters_set_allow_duplicate_state_updates(char *a1, char a2)
{
  v15 = *MEMORY[0x1E69E9840];
  if (a1)
  {

    _nw_parameters_set_allow_duplicate_state_updates(a1, a2);
    return;
  }

  v2 = __nwlog_obj();
  *buf = 136446210;
  v12 = "nw_parameters_set_allow_duplicate_state_updates";
  v3 = _os_log_send_and_compose_impl();
...
void nw_parameters_set_always_open_listener_socket(char *a1, char a2)
{
  v15 = *MEMORY[0x1E69E9840];
  if (a1)
  {

    _nw_parameters_set_always_open_listener_socket(a1, a2);
    return;
  }

  v2 = __nwlog_obj();
  *buf = 136446210;
  v12 = "nw_parameters_set_always_open_listener_socket";
  v3 = _os_log_send_and_compose_impl();
