...
{
  equalCopy = equal;
  if ([equalCopy isMemberOfClass:objc_opt_class()] && ((descriptor = self->_descriptor, !(descriptor | equalCopy[2])) || -[NWPBBrowseDescriptor isEqual:](descriptor, "isEqual:")) && ((parameters = self->_parameters, !(parameters | equalCopy[3])) || -[NWPBParameters isEqual:](parameters, "isEqual:")))
  {
...
- (id)copyWithZone:(_NSZone *)zone
{
  ...
  v6 = [(NWPBBrowseDescriptor *)self->_descriptor copyWithZone:zone];
  v7 = v5[2];
  v5[2] = v6;
...
LABEL_4:
      ...
      if (v17 == 1)
      {
        ...
        v19 = 0;
        v20 = 0;
        if (!PBReaderPlaceMark() || !NWPBBrowseDescriptorReadFrom(clientUUID, from))
        {
          goto LABEL_33;
        }
...
- (id)dictionaryRepresentation
{
  ...
  if (descriptor)
  {
    dictionaryRepresentation = [(NWPBBrowseDescriptor *)descriptor dictionaryRepresentation];
...
- (id)description
{
  ...
  dictionaryRepresentation = [(NWPBStartBrowse *)self dictionaryRepresentation];
