...
+ (id)_rpUserErrorForCode:()ReplayKitErrors userInfo:
{
  ...
  v10 = [MEMORY[0x277CCA8D8] _rpLocalizedStringFromFrameworkBundleWithKey:v9];
  if (v10)
  {
    [v8 setValue:v10 forKey:*MEMORY[0x277CCA450]];
  }

  v11 = [MEMORY[0x277CCA9B8] errorWithDomain:@"com.apple.ReplayKit.RPRecordingErrorDomain" code:a3 userInfo:v8];
...
+ (id)_scUserErrorForCode:()ReplayKitErrors userInfo:
{
  ...
  v11 = [MEMORY[0x277CCA9B8] errorWithDomain:@"com.apple.ScreenCaptureKit.SCStreamErrorDomain" code:a3 userInfo:v8];
