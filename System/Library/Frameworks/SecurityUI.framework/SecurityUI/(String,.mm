...
- (unint64_t)String)
{
  result = lazy protocol witness table cache variable for type ForEach<[(String, String)], String, TupleView<(ModifiedContent<ModifiedContent<Text, _FlexFrameLayout>, _EnvironmentKeyWritingModifier<TextAlignment>>, <<opaque return type of View.hyphenationDisabled(_:)>>.0)>> and conformance <> ForEach<A, B, C>;
  if (!lazy protocol witness table cache variable for type ForEach<[(String, String)], String, TupleView<(ModifiedContent<ModifiedContent<Text, _FlexFrameLayout>, _EnvironmentKeyWritingModifier<TextAlignment>>, <<opaque return type of View.hyphenationDisabled(_:)>>.0)>> and conformance <> ForEach<A, B, C>)
  {
    __swift_instantiateConcreteTypeFromMangledNameAbstractV2(&_s7SwiftUI7ForEachVySaySS_SStGSSAA9TupleViewVyAA15ModifiedContentVyAHyAA4TextVAA16_FlexFrameLayoutVGAA30_EnvironmentKeyWritingModifierVyAA0I9AlignmentOGG_AA0F0PAAE19hyphenationDisabledyQrSbFQOyAM_Qo_tGGMd, &_s7SwiftUI7ForEachVySaySS_SStGSSAA9TupleViewVyAA15ModifiedContentVyAHyAA4TextVAA16_FlexFrameLayoutVGAA30_EnvironmentKeyWritingModifierVyAA0I9AlignmentOGG_AA0F0PAAE19hyphenationDisabledyQrSbFQOyAM_Qo_tGGMR);
    ...
    atomic_store(result, &lazy protocol witness table cache variable for type ForEach<[(String, String)], String, TupleView<(ModifiedContent<ModifiedContent<Text, _FlexFrameLayout>, _EnvironmentKeyWritingModifier<TextAlignment>>, <<opaque return type of View.hyphenationDisabled(_:)>>.0)>> and conformance <> ForEach<A, B, C>);
  }
