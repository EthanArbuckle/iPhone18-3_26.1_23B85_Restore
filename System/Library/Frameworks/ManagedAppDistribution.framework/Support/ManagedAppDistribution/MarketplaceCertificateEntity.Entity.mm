...
- (_TtCV28ManagedAppDistributionDaemon28MarketplaceCertificateEntity6Entity)initWithPersistentID:(int64_t)d onConnection:(id)connection;
- (_TtCV28ManagedAppDistributionDaemon28MarketplaceCertificateEntity6Entity)initWithPropertyValues:(id)values onConnection:(id)connection;
@end
...
{
  v7.receiver = self;
  v7.super_class = type metadata accessor for MarketplaceCertificateEntity.Entity();
...
- (_TtCV28ManagedAppDistributionDaemon28MarketplaceCertificateEntity6Entity)initWithPropertyValues:(id)values onConnection:(id)connection
{
  ...
  v10.receiver = self;
  v10.super_class = type metadata accessor for MarketplaceCertificateEntity.Entity();
