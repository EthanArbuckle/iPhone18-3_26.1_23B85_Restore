...
- (_TtCV28ManagedAppDistributionDaemon20LicenseStorageEntity6Entity)initWithPersistentID:(int64_t)d onConnection:(id)connection;
- (_TtCV28ManagedAppDistributionDaemon20LicenseStorageEntity6Entity)initWithPropertyValues:(id)values onConnection:(id)connection;
@end
...
{
  v7.receiver = self;
  v7.super_class = type metadata accessor for LicenseStorageEntity.Entity();
...
- (_TtCV28ManagedAppDistributionDaemon20LicenseStorageEntity6Entity)initWithPropertyValues:(id)values onConnection:(id)connection
{
  ...
  v10.receiver = self;
  v10.super_class = type metadata accessor for LicenseStorageEntity.Entity();
