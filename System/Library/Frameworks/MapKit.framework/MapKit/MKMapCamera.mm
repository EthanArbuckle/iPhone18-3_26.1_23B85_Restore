...
- ($9433BFB5400FDC760880D1BFD6845728)_enclosingGEOMapRectForAspectRatio:(float)a3;
- (BOOL)_validate;
- (BOOL)isEqual:(id)a3;
- (CGFloat)pitch;
...
+ (id)_cameraLookingAtScene:(id)a3
{
  ...
  v4 = [v3 _mapItem];
  v5 = [v4 _geoMapItem];
  v6 = [v5 _storefrontPresentationInfo];
  ...
  v11 = [objc_opt_class() camera];
  [v11 setCenterCoordinate:{0.0, 0.0}];
  [v11 setAltitude:0.0];
  [v11 setHeading:0.0];
  [v11 setPitch:0.0];
...
+ (id)_cameraLookingAtMapRect:(id)a3 forViewSize:(CGSize)a4
{
  ...
  *&v4 = a4.width / a4.height;
  v5 = [a1 _cameraLookingAtGEOMapRect:&v7 aspectRatio:v4];
...
+ (id)_cameraLookingAtGEOMapRect:(id *)a3 aspectRatio:(float)a4
{
  ...
  v5 = [a1 camera];
  [v5 setCenterCoordinate:{0.0, 0.0}];
  [v5 setAltitude:0.0];
...
+ (MKMapCamera)cameraLookingAtMapItem:(MKMapItem *)mapItem forViewSize:(CGSize)viewSize allowPitch:(BOOL)allowPitch
{
  ...
  v9 = mapItem;
  v10 = [(MKMapItem *)v9 _viewportFrame];

  if (v10)
  {
    v11 = [(MKMapItem *)v9 _viewportFrame];
    [v11 latitude];
    v13 = v12;
    [v11 longitude];
...
LABEL_100:
    ...
    *&v60 = width / height;
    ...
    v65 = v64;
    v67 = v66;
    v68 = [a1 _sizeCategoryForViewSize:{width, height}];
    switch(v68)
    {
      case 2:
        [v11 distance];
...
LABEL_30:
    ...
    if (v88 < v89 && v5)
    {
      ...
      v91 = v90;
      [v11 pitch];
      [a1 _adjustCoordinateForPitch:v65 heading:v67 pitch:v91 minimumPitchRequiredForAdjustment:v92 tolerance:{v88, 5000.0}];
      v65 = v93;
      v67 = v94;
    }
    ...
    v33 = [MKMapCamera _cameraLookingAtMapRect:v101 forViewSize:v102, v99, v100, v206, v212];
    [v11 heading];
    [v33 setHeading:v189];
    [v33 setCenterCoordinate:{v65, v67}];
    v190 = 0.0;
    if (v5)
    {
      [v11 pitch];
  ...
  {
    v33 = +[MKMapCamera camera];
    goto LABEL_101;
  }

  v38 = [a1 _sizeCategoryForViewSize:{width, height}];
  v39 = 0.0;
  v209 = 0.0;
  v40 = 0.0;
  if (v38 <= 2)
  ...
  v211 = height;
  v72 = height / v44;
  v73 = [(MKMapItem *)v9 _geoMapItem];
  v74 = [v73 displayMapRegionOrNil];
...
LABEL_72:
  ...
  if (v54 == INFINITY && v122 == INFINITY)
  {
    ...
    if (os_log_type_enabled(v153, OS_LOG_TYPE_INFO))
    {
      ...
      v157 = [v154 stringWithFormat:@"{%@, %@}", v155, v156];
  ...
  else
  {
    ...
    if (v165)
    {
      if (v167)
      {
        ...
        v171 = [v168 stringWithFormat:@"{%@, %@}", v169, v170];
    ...
    else
    {
      if (v167)
      {
        ...
        v175 = [v172 stringWithFormat:@"{%@, %@}", v173, v174];
  ...
  v33 = [a1 _cameraLookingAtMapRect:v151 forViewSize:{v152, v71, v158, width, v211}];
  if (v159 > 0.0 && v5)
  {
    v176 = [a1 _cameraLookingAtMapRect:v202 - width / 0.14358737 * 0.5 forViewSize:{v120 - v211 / 0.14358737 * 0.5, width / 0.14358737, v211 / 0.14358737, width, v211}];
    [v33 centerCoordinateDistance];
    v178 = v177;
...
+ (MKMapCamera)cameraLookingAtCenterCoordinate:(CLLocationCoordinate2D)centerCoordinate fromDistance:(CLLocationDistance)distance pitch:(CGFloat)pitch heading:(CLLocationDirection)heading
{
  ...
  latitude = centerCoordinate.latitude;
  v11 = [objc_opt_class() camera];
  [v11 setCenterCoordinate:{latitude, longitude}];
  [v11 setHeading:heading];
  [v11 _setPrecisePitch:pitch];
  [v11 setAltitude:(cos(pitch * 0.0174532925) * distance)];
...
+ (MKMapCamera)cameraLookingAtCenterCoordinate:(CLLocationCoordinate2D)centerCoordinate fromEyeCoordinate:(CLLocationCoordinate2D)eyeCoordinate eyeAltitude:(CLLocationDistance)eyeAltitude
{
  ...
  v10 = [objc_opt_class() camera];
  [v10 setCenterCoordinate:{v9, v8}];
