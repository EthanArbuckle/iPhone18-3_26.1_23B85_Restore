...
- (MKFullDeveloperPlaceCardLoadingView)init
{
  ...
  if (v2)
  {
    ...
    v17 = [(MKDeveloperPlaceCardLoadingActivityIndicatorView *)v2->_activityIndicatorView centerXAnchor];
    v16 = [(MKFullDeveloperPlaceCardLoadingView *)v2 centerXAnchor];
    v5 = [v17 constraintEqualToAnchor:v16];
    v19[0] = v5;
    v6 = [(MKDeveloperPlaceCardLoadingActivityIndicatorView *)v2->_activityIndicatorView centerYAnchor];
    v7 = [(MKFullDeveloperPlaceCardLoadingView *)v2 centerYAnchor];
    v8 = [v6 constraintEqualToAnchor:v7];
    v19[1] = v8;
    v9 = [(MKFullDeveloperPlaceCardLoadingView *)v2 widthAnchor];
    v10 = [v9 constraintGreaterThanOrEqualToConstant:320.0];
    v19[2] = v10;
    v11 = [(MKFullDeveloperPlaceCardLoadingView *)v2 heightAnchor];
    v12 = [v11 constraintGreaterThanOrEqualToConstant:442.0];
    v19[3] = v12;
