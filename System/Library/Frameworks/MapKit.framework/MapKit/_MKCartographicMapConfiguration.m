...
- (void)_removeObserver:(id)a3 context:(void *)a4
{
  ...
  [(_MKCartographicMapConfiguration *)self removeObserver:v6 forKeyPath:@"cartographicConfiguration" context:a4, v7.receiver, v7.super_class];
}
...
- (void)_addObserver:(id)a3 options:(unint64_t)a4 context:(void *)a5
{
  ...
  [(_MKCartographicMapConfiguration *)self addObserver:v8 forKeyPath:@"cartographicConfiguration" options:a4 context:a5, v9.receiver, v9.super_class];
}

- (BOOL)isEqualToCartographicMapConfiguration:(id)a3
{
  v4 = a3;
  v6 = v4 && (v8.receiver = self, v8.super_class = _MKCartographicMapConfiguration, -[MKMapConfiguration isEqual:](&v8, sel_isEqual_, v4)) && (v5 = -[_MKCartographicMapConfiguration showsTraffic](self, "showsTraffic"), v5 == [v4 showsTraffic]) && _MKCartographicConfigurationEquals(&self->_cartographicConfiguration, v4 + 32);
...
{
  v4 = a3;
  v5 = v4 && (objc_opt_class(), (objc_opt_isKindOfClass() & 1) != 0) && [(_MKCartographicMapConfiguration *)self isEqualToCartographicMapConfiguration:v4];
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  result = [(MKMapConfiguration *)&v8 copyWithZone:a3];
...
- (_MKCartographicMapConfiguration)initWithCoder:(id)a3
{
  ...
  v5 = [(MKMapConfiguration *)&v25 initWithCoder:v4];
  v6 = v5;
  if (v5)
  {
...
- (void)encodeWithCoder:(id)a3
{
  ...
  v4 = a3;
  [(MKMapConfiguration *)&v21 encodeWithCoder:v4];
...
- (_MKCartographicMapConfiguration)initWithCartographicConfiguration:(id *)a3
{
  ...
  if (result)
  {
    ...
    v6 = *&a3->var4;
    v8 = *&a3->var0;
    *&result->_cartographicConfiguration.gridOnly = *&a3->var6;
