...
+ (CMAVRoutingTimeAsValue)valueWithCMTime:()NSValueCMTimeExtensions;
+ (CMAVRoutingTimeMappingAsValue)valueWithCMTimeMapping:()NSValueCMTimeExtensions;
...
+ (CMAVRoutingTimeAsValue)valueWithCMTime:()NSValueCMTimeExtensions
{
  v4 = *a3;
  v5 = *(a3 + 2);
  return [CMAVRoutingTimeAsValue valueWithCMTime:&v4];
}
...
+ (CMAVRoutingTimeRangeAsValue)valueWithCMTimeRange:()NSValueCMTimeExtensions
{
  ...
  v5[1] = v3;
  v5[2] = a3[2];
  return [CMAVRoutingTimeRangeAsValue valueWithCMTimeRange:v5];
}
...
+ (CMAVRoutingTimeMappingAsValue)valueWithCMTimeMapping:()NSValueCMTimeExtensions
{
  ...
  v7[0] = *a3;
  v7[1] = v5;
  return [CMAVRoutingTimeMappingAsValue valueWithCMTimeMapping:v7];
}
