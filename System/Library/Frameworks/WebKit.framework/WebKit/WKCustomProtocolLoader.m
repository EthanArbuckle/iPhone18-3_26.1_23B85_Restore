...
- (WKCustomProtocolLoader)initWithLegacyCustomProtocolManagerProxy:(void *)a3 customProtocolID:()ObjectIdentifierGeneric<WebKit:()WTF:(unsigned long long>)a4 :(id)a5 ObjectIdentifierThreadSafeAccessTraits<uint64_t> :LegacyCustomProtocolIDType request:
{
  ...
  if (v8)
  {
    ...
    v8->_customProtocolID.m_value = a4;
    v8->_storagePolicy = 2;
    ...
    [v14 scheduleInRunLoop:v15 forMode:*MEMORY[0x1E695DA28]];
...
- (void)connection:(id)a3 didReceiveResponse:(id)a4
{
  ...
  atomic_fetch_add((v6 + 16), 1u);
  WebCore::ResourceResponse::ResourceResponse(v12, a4);
  m_identifier = self->_customProtocolID.m_value.m_identifier;
  if (!m_identifier)
  {
    __break(0xC471u);
...
- (void)connection:(id)a3 didReceiveData:(id)a4
{
  ...
  if (m_ptr)
  {
    ...
    if (v5)
    {
      ...
      WebKit::LegacyCustomProtocolManagerProxy::didLoadData(v5, m_identifier, v9, v10);
...
- (id)connection:(id)a3 willSendRequest:(id)a4 redirectResponse:(id)a5
{
  ...
  if (a5)
  {
    ...
    if (m_identifier)
    {
      MEMORY[0x19EB06210](v16, a4, a3);
      WebCore::ResourceResponse::ResourceResponse(v14, a5);
