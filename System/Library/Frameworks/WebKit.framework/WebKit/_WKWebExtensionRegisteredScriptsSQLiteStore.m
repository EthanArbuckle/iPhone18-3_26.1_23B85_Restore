...
- (void)updateScripts:(id)a3 completionHandler:(id)a4
{
  v6 = a3;
  v7 = a4;
  v8 = WebKit::mapObjects<NSArray>(v6, &__block_literal_global_0);
...
- (void)_insertScript:(id)a3 inDatabase:(id)a4 errorMessage:(id *)a5
{
  ...
  *buf = 0;
  ...
  if (v14)
  {
    ...
    v18 = [(_WKWebExtensionSQLiteStatement *)v17 execute];
    [(_WKWebExtensionSQLiteStatement *)v17 invalidate];
    if ((v18 - 100) >= 2 && v18)
    {
      [v12 reportErrorWithCode:v18 statement:-[_WKWebExtensionSQLiteStatement handle](v17 error:{"handle"), 0}];
    }
  }
  ...
  if (v18 != 101)
  {
    ...
    *v21 = @"Failed to add content script.";
  }
}
...
- (int)_createFreshDatabaseSchema
{
  ...
  if (v3 != 101)
  {
    ...
    {
      uniqueIdentifier = self->super._uniqueIdentifier;
      v7 = [(_WKWebExtensionSQLiteDatabase *)self->super._database lastErrorMessage];
      v8 = 138478339;
      v9 = uniqueIdentifier;
      v10 = 2114;
      v11 = v7;
