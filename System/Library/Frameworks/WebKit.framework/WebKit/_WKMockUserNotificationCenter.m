...
- (_WKMockUserNotificationCenter)initWithBundleIdentifier:(id)a3
{
  ...
  {
    v5 = [[_WKMockUserNotificationCenter alloc] _internalInitWithBundleIdentifier:a3];
    v6 = v5;
    if (v5)
    {
      v7 = v5;
    ...
    [qword_1ED641718 setObject:v6 forKeyedSubscript:a3];
  }

  v8 = [qword_1ED641718 objectForKeyedSubscript:a3];
...
- (void)addNotificationRequest:(id)a3 withCompletionHandler:(id)a4
{
  -[NSMutableArray addObject:](self->m_notifications.m_ptr, "addObject:", [MEMORY[0x1E6983240] notificationWithRequest:a3 date:{objc_msgSend(MEMORY[0x1E695DF00], "now")}]);
  if (![objc_msgSend(a3 "content")])
  {
    WTF::RetainPtr<NSNumber>::operator=(&self->m_appBadge.m_ptr, [objc_msgSend(a3 "content")]);
  }
  ...
  if (v7)
  {
    ...
    do
    {
      for (i = 0; i != v7; ++i)
      {
        ...
        v10 = *(*(&v11 + 1) + 8 * i);
        if ([a3 containsObject:{objc_msgSend(objc_msgSend(v10, "request"), "identifier")}])
        {
          [v5 addObject:v10];
        }
      }
...
- (id)notificationSettings
{
  v3 = [MEMORY[0x1E6983230] emptySettings];
  v4 = v3;
  if (v3)
  {
    v5 = v3;
