...
- (_WKWarningViewTextView)initWithAttributedString:(id)string forWarning:(id)warning;
@end
...
- (_WKWarningViewTextView)initWithAttributedString:(id)string forWarning:(id)warning
{
  ...
  if (v6)
  {
    objc_storeWeak(&v6->_warning.m_weakReference, warning);
    [(_WKWarningViewTextView *)v7 setDelegate:warning];
    v8 = colorForItem(4u, warning);
    v9 = v8;
    if (v8)
    {
      v10 = v8;
    ...
    [(_WKWarningViewTextView *)v7 setBackgroundColor:colorForItem(1u, warning)];
    v15 = v12;
    v16 = v9;
