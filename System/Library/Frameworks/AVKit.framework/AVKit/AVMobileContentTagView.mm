...
- (AVMobileContentTagView)initWithContentTag:(id)tag withStyleSheet:(id)sheet;
...
- (void)_updateContentTagLabelFont
{
  if (self)
  {
    placement = [*(self + 424) placement];
    if (placement == 1)
    {
      v3 = *(self + 416);
      prominentContentTagFont = [*(self + 432) prominentContentTagFont];
    }
    ...
    else
    {
      ...
      v3 = *(self + 416);
      prominentContentTagFont = [*(self + 432) contentTagFont];
    }
