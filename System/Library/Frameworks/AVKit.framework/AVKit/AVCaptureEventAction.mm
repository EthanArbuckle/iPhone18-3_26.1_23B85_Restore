...
- (void)sendPhaseUpdate:(unint64_t)a3 physicalButton:(unint64_t)a4 interaction:(id)a5;
@end
...
- (void)sendPhaseUpdate:(unint64_t)a3 physicalButton:(unint64_t)a4 interaction:(id)a5
{
  ...
  v6 = [AVCaptureEvent eventWithSource:self->_source physicalButton:a4 phase:a3 interaction:a5];
  v7 = _AVLog();
