...
- (AVMobileSliderMark)initWithStartValue:(float)value endValue:(float)endValue filledColor:(id)color unfilledColor:(id)unfilledColor markWithType:(unint64_t)type;
@end
...
- (AVMobileSliderMark)initWithStartValue:(float)value endValue:(float)endValue filledColor:(id)color unfilledColor:(id)unfilledColor markWithType:(unint64_t)type
{
  ...
  v18.receiver = self;
  v18.super_class = AVMobileSliderMark;
...
+ (id)liveEdgeMarkAtValue:(float)value
{
  ...
  *&v7 = value;
  *&v8 = value;
  v9 = [(AVMobileSliderMark *)v4 initWithStartValue:avkit_liveContentAccessoryViewColor endValue:avkit_liveContentAccessoryViewColor2 filledColor:1 unfilledColor:v7 markWithType:v8];
...
+ (id)interstitialMarkAtValue:(float)value
{
  ...
  *&v7 = value;
  *&v8 = value;
  v9 = [(AVMobileSliderMark *)v4 initWithStartValue:systemDarkGrayColor endValue:systemYellowColor filledColor:0 unfilledColor:v7 markWithType:v8];
