...
{
  v10.receiver = self;
  v10.super_class = AVMobileContentTagView;
...
- (void)setStyleSheet:(id)a3
{
  ...
  if (self->_styleSheet != v5)
  {
    ...
    [(AVMobileContentTagView *)self _updateContentTagLabelFont];
    v5 = v6;
  }
}
...
- (void)_updateContentTagLabelFont
{
  if (a1)
  {
    ...
    {
      v3 = *(a1 + 416);
      v4 = [*(a1 + 432) prominentContentTagFont];
    }
...
- (AVMobileContentTagView)initWithContentTag:(id)a3 withStyleSheet:(id)a4
{
  ...
  v8 = a4;
  v24.receiver = self;
  v24.super_class = AVMobileContentTagView;
  v9 = [(AVMobileContentTagView *)&v24 init];
  v10 = v9;
  if (v9)
  {
    ...
    [(AVMobileContentTagView *)v10 _updateContentTagLabelFont];
