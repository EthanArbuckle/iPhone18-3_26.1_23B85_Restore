...
- (void)triggerFetchWithReply:(id)a3;
...
- (void)updateConversionValue:(id)a3 reply:(id)a4
{
  ...
  *(v21 + 24) = v20;
  ...
  sub_1001702C4("Postback Update Testing", 23, 2, sub_10009DA9C, v17, v13 + v18, v10, &unk_1001BAB30, v21);
...
- (void)submitConversionEventWithEventData:(id)a3 reply:(id)a4
{
  ...
  *(v21 + 24) = v20;
  ...
  sub_1001702C4("Submit Conversion Event", 23, 2, sub_10009DA9C, v17, v13 + v18, v10, &unk_1001BAB08, v21);
...
- (void)submitPurchaseEventWithEventData:(id)a3 reply:(id)a4
{
  ...
  *(v21 + 24) = v20;
  ...
  sub_1001702C4("Submit Purchase Event", 21, 2, sub_10009DA9C, v17, v13 + v18, v10, &unk_1001BAAF0, v21);
