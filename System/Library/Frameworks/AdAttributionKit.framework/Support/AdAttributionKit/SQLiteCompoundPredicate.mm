...
- (unint64_t)hash
{
  ...
  predicates = [(SQLiteCompoundPredicate *)self predicates];
...
- (BOOL)isEqual:(id)equal
{
  ...
  if ([(SQLitePredicate *)&v12 isEqual:equalCopy]&& ((combinationOperation = self->_combinationOperation, combinationOperation == equalCopy[1]) || [(NSString *)combinationOperation isEqual:?]))
  {
