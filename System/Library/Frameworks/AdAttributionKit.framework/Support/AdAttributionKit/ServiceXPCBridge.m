...
- (void)reportDeveloperBillingEvent:(id)a3 reply:(id)a4;
...
- (void)updateConversionValue:(id)a3 reply:(id)a4
{
  ...
  *(v21 + 24) = v20;
  ...
  sub_1001717F8("Update Postback", 15, 2, sub_10009DA9C, v17, v13 + v18, v10, &unk_1001C33C8, v21);
...
- (void)reportDeveloperBillingEvent:(id)a3 reply:(id)a4
{
  ...
  *(v21 + 24) = v20;
  ...
  sub_1001717F8("Report Developer Billing Event", 30, 2, sub_1000849C4, v17, v13 + v18, v10, &unk_1001C3348, v21);
