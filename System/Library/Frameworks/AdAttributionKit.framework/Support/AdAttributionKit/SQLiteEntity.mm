...
- (SQLiteEntity)initWithPropertyValues:(id)values onConnection:(id)connection
{
  ...
  v18 = sub_1000021E8;
  v19 = &unk_100212A48;
  v12 = sub_1001AAD08(self, valuesCopy);
  v20 = v12;
  v23 = longLongValue;
  v13 = connectionCopy;
  v21 = v13;
  v22 = &v24;
  sub_1000064FC(v13, &v16);
  if ((v25[3] & 1) == 0)
  {
...
- (BOOL)deleteFromDatabase
{
  ...
  if (*(v11 + 24) == 1)
  {
    ...
    block[1] = 3221225472;
    block[2] = sub_100002A80;
    block[3] = &unk_100212A90;
...
- (BOOL)existsInDatabase
{
  ...
  v8[4] = self;
  v8[5] = &v9;
  sub_1000061F0(connection, v5, v8);
  LOBYTE(self) = *(v10 + 24);
...
- (id)getValuesForProperties:(id)properties
{
  ...
  else
  {
    ...
    v22 = v20;
    v27 = v22;
    sub_1000061F0(connection, v12, v25);
    v23 = v27;
    v8 = v22;
  }
