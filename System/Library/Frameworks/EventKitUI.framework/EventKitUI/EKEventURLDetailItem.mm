...
- (id)linkWithLaunchInfo
{
  ...
  if (self->_launchInfo)
  {
    ...
    v11 = [v5 initWithString:v6 attributes:v10];
  }
...
- (BOOL)configureWithEvent:(id)a3 calendar:(id)a4 preview:(BOOL)a5
{
  ...
  if (([(EKEvent *)self->super.super._event isBirthday:a3]& 1) != 0)
  {
    return 0;
  }
  ...
  v12 = [(EKEvent *)self->super.super._event suggestionInfo];
  ...
  v13 = [(EKEvent *)self->super.super._event suggestionInfo];
  v14 = [v13 uniqueKey];
  ...
  if (!v14)
  {
    ...
    if (os_log_type_enabled(kEKUILogHandle, OS_LOG_TYPE_ERROR))
    {
      ...
      v24 = v22;
      v25 = [(EKEvent *)event calendarItemExternalIdentifier];
      v26 = [(EKEvent *)self->super.super._event suggestionInfo];
      *buf = 138543618;
      v35 = v25;
      v36 = 2112;
      v37 = v26;
  ...
  v17 = [(EKEvent *)self->super.super._event suggestionInfo];
  v18 = [v17 uniqueKey];
  v19 = self->_url;
  ...
  if (v15)
  {
    ...
    v32[3] = &unk_1E843F600;
    v32[4] = self;
    [v16 launchInfoForSuggestedEventWithUniqueIdentifier:v18 sourceURL:v19 clientLocale:v20 withCompletion:v32];
  ...
  {
    v33 = 0;
    v27 = [v16 launchInfoForSuggestedEventWithUniqueIdentifier:v18 sourceURL:v19 clientLocale:v20 error:&v33];
    v28 = v33;
...
- (id)_createEventDetailCell
{
  ...
  v6 = [(EKEventURLDetailItem *)self attributedTextFromEventBlock];
  v7 = [(EKEventDetailTextCell *)v3 initWithEvent:event title:v5 attributedTextFromEventBlock:v6 textViewDelegate:self axTextView:@"event-details-url-link"];
...
- (id)textView:(id)a3 primaryActionForTextItem:(id)a4 defaultAction:(id)a5
{
  ...
  if (v8)
  {
    ...
    v12 = [v11 isEqualToString:@"calshow://launchSuggestedEvent"];
