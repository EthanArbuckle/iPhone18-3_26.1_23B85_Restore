...
+ (id)setRoleRowActionWithParticipant:(id)participant withSetRoleBlock:(id)block forSections:(id)sections;
@end
...
+ (id)deleteRowAction:(id)action forRow:(id)row
{
  ...
  v8 = [actionCopy titleForDeleteConfirmationButtonForRow:rowCopy];
