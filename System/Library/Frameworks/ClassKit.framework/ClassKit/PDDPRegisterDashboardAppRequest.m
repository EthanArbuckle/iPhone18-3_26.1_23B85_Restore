...
- (id)description
{
  ...
  v4 = [(PDDPRegisterDashboardAppRequest *)self dictionaryRepresentation];
...
LABEL_15:
      ...
      if ((v13 >> 3) == 1)
      {
        ...
        v17[0] = 0;
        v17[1] = 0;
        if (!PBReaderPlaceMark() || !sub_10016CC98(v14, a3))
        {
...
- (void)copyTo:(id)a3
{
  ...
  if ([(PDDPRegisterDashboardAppRequest *)self dashboardAppsCount])
  {
    ...
    v4 = [(PDDPRegisterDashboardAppRequest *)self dashboardAppsCount];
    if (v4)
    {
      v5 = v4;
      for (i = 0; i != v5; ++i)
