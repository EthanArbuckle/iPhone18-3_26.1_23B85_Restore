...
- (id)dictionaryRepresentation
{
  ...
  {
    v4 = [[NSMutableArray alloc] initWithCapacity:{-[NSMutableArray count](self->_queryPayloads, "count")}];
    v12 = 0u;
    v13 = 0u;
    v14 = 0u;
    v15 = 0u;
  ...
  if (v5)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        [(PDDPQueryResponse *)self addQueryPayload:*(*(&v9 + 1) + 8 * v8), v9];
        v8 = v8 + 1;
      }
