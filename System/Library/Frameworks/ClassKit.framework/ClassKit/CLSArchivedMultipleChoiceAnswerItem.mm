...
{
  rowCopy = row;
  _init = [(CLSArchivedMultipleChoiceAnswerItem *)self _init];
  v6 = _init;
  if (_init)
  {
...
- (void)bindTo:(id)to
{
  ...
  toCopy = to;
  [(CLSArchivedMultipleChoiceAnswerItem *)&v9 bindTo:toCopy];
  v10 = @"appIdentifier";
  v5 = [NSArray arrayWithObjects:&v10 count:1, v9.receiver, v9.super_class];
  sub_1000983A8(toCopy, v5);

  parentObjectID = [(CLSArchivedMultipleChoiceAnswerItem *)self parentObjectID];
  sub_1000982FC(toCopy, parentObjectID, @"parentObjectID");

  itemText = [(CLSArchivedMultipleChoiceAnswerItem *)self itemText];
...
{
  databaseCopy = database;
  objectID = [(CLSArchivedMultipleChoiceAnswerItem *)self objectID];
  v7 = objectID;
