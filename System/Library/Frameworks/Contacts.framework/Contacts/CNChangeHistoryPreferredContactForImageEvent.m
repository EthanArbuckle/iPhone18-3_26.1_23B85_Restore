...
- (id)description
{
  ...
  v4 = [(CNChangeHistoryPreferredContactForImageEvent *)self preferredContact];
  v5 = [v3 appendName:@"preferredContact" object:v4];

  v6 = [(CNChangeHistoryPreferredContactForImageEvent *)self unifiedContact];
...
{
  v4 = a3;
  v5 = [(CNChangeHistoryPreferredContactForImageEvent *)self unifiedContact];
  v6 = [v5 identifier];
  ...
  if (!v9)
  {
    v10 = [(CNChangeHistoryPreferredContactForImageEvent *)self preferredContact];
    v11 = [v10 identifier];
