...
- (CNChangeHistoryRemoveMemberFromGroupEvent)initWithCoder:(id)coder;
- (CNChangeHistoryRemoveMemberFromGroupEvent)initWithMember:(id)member group:(id)group;
- (id)description;
...
- (id)description
{
  ...
  member = [(CNChangeHistoryRemoveMemberFromGroupEvent *)self member];
  v5 = [v3 appendName:@"member" object:member];

  group = [(CNChangeHistoryRemoveMemberFromGroupEvent *)self group];
