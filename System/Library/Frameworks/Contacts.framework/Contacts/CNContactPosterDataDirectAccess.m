...
- (CNContactPosterDataDirectAccess)initWithStoreManager:(id)a3;
...
- (CNContactPosterDataDirectAccess)initWithStoreManager:(id)a3
{
  ...
  if (v6)
  {
    objc_storeStrong(&v6->_storeManager, a3);
    v8 = v7;
  }
...
{
  v6 = a3;
  v7 = [(CNContactPosterDataDirectAccess *)self storeManager];
  v8 = [CNContactPosterDataDirectFetchMethod execute:v6 storeManager:v7 error:a4];
...
- (BOOL)executeCreateRequest:(id)a3 error:(id *)a4
{
  v6 = a3;
  v7 = [(CNContactPosterDataDirectAccess *)self storeManager];
  LOBYTE(a4) = [CNContactPosterDataDirectCreateMethod execute:v6 storeManager:v7 error:a4];
