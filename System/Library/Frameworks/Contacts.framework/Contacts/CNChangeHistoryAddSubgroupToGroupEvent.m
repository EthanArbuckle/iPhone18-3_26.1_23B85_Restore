...
- (id)description
{
  ...
  v4 = [(CNChangeHistoryAddSubgroupToGroupEvent *)self subgroup];
  v5 = [v3 appendName:@"subgroup" object:v4];

  v6 = [(CNChangeHistoryAddSubgroupToGroupEvent *)self group];
...
{
  v4 = a3;
  v5 = [(CNChangeHistoryAddSubgroupToGroupEvent *)self group];
  v6 = [v5 identifier];
  v7 = [v4 group];
  v8 = [v7 identifier];
  v9 = [v6 compare:v8];
  ...
  if (!v9)
  {
    v10 = [(CNChangeHistoryAddSubgroupToGroupEvent *)self subgroup];
    v11 = [v10 identifier];
    v12 = [v4 subgroup];
    v13 = [v12 identifier];
    v9 = [v11 compare:v13];
