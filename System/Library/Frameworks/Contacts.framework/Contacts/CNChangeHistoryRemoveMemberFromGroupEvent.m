...
LABEL_12:
  v15.receiver = self;
  v15.super_class = CNChangeHistoryRemoveMemberFromGroupEvent;
  v11 = [(CNChangeHistoryRemoveMemberFromGroupEvent *)&v15 init];
  v12 = v11;
  if (v11)
  {
    objc_storeStrong(&v11->_member, a3);
...
- (CNChangeHistoryRemoveMemberFromGroupEvent)initWithCoder:(id)a3
{
  ...
  v7 = [(CNChangeHistoryRemoveMemberFromGroupEvent *)self initWithMember:v5 group:v6];
  return v7;
}
...
- (id)description
{
  ...
  v4 = [(CNChangeHistoryRemoveMemberFromGroupEvent *)self member];
  v5 = [v3 appendName:@"member" object:v4];

  v6 = [(CNChangeHistoryRemoveMemberFromGroupEvent *)self group];
...
{
  v4 = a3;
  v5 = [(CNChangeHistoryRemoveMemberFromGroupEvent *)self group];
  v6 = [v5 identifier];
  v7 = [v4 group];
  v8 = [v7 identifier];
  v9 = [v6 compare:v8];
  ...
  if (!v9)
  {
    v10 = [(CNChangeHistoryRemoveMemberFromGroupEvent *)self member];
    v11 = [v10 identifier];
    v12 = [v4 member];
    v13 = [v12 identifier];
    v9 = [v11 compare:v13];
