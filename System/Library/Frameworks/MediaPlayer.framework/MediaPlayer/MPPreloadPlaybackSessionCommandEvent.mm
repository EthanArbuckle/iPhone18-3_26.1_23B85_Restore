...
- (MPPreloadPlaybackSessionCommandEvent)initWithCommand:(id)command mediaRemoteType:(unsigned int)type options:(id)options;
@end
...
- (MPPreloadPlaybackSessionCommandEvent)initWithCommand:(id)command mediaRemoteType:(unsigned int)type options:(id)options
{
  ...
  v9 = [(MPRemoteCommandEvent *)&v27 initWithCommand:command mediaRemoteType:v5 options:optionsCopy];
  if (v9)
  {
    ...
    v12 = [optionsCopy objectForKeyedSubscript:*MEMORY[0x1E69B11C0]];
    type = v9->_type;
    v9->_type = v12;
    ...
    v17 = [optionsCopy objectForKeyedSubscript:*MEMORY[0x1E69B1198]];
    if (![v17 length])
    {
    ...
    v20 = [optionsCopy objectForKeyedSubscript:*MEMORY[0x1E69B11B8]];
    ...
    v23 = [optionsCopy objectForKeyedSubscript:*MEMORY[0x1E69B11A8]];
    if ([v23 length])
    {
