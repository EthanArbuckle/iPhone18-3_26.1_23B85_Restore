...
- (id)stringRepresentation
{
  imageArtworkIdentifier = [(_MPAbstractNetworkArtworkDataSourceVisualIdenticalityIdentifier *)self imageArtworkIdentifier];
  v4 = [imageArtworkIdentifier copy];

  videoArtworkIdentifier = [(_MPAbstractNetworkArtworkDataSourceVisualIdenticalityIdentifier *)self videoArtworkIdentifier];
