...
+ (id)propertyForMPMediaEntityProperty:()MPMediaAdditions
{
  ...
  {
    dispatch_once(&propertyForMPMediaEntityProperty__once_29, &__block_literal_global_31_9437);
  }

  v5 = [propertyForMPMediaEntityProperty__ML3ForMP_28 objectForKeyedSubscript:v4];
  v6 = v5;
  if (v5)
  {
    v7 = v5;
