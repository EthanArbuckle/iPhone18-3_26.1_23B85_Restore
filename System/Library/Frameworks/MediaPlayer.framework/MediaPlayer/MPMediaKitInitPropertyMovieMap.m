...
{
  v2 = a2;
  v3 = _MPKeyPathValueTransformHasNonnullValue(&unk_1F150A750, v2);
  v4 = [v3 BOOLValue];
...
id ___MPMediaKitInitPropertyMovieMap_block_invoke_4(uint64_t a1, void *a2, void *a3)
{
  ...
  v6 = [v5 firstObject];
  v7 = MPTranslatorUtilitiesTransformMillisecondsToSeconds(&unk_1F150A6D8, v6);
...
void ___MPMediaKitInitPropertyMovieMap_block_invoke(uint64_t a1, void *a2, void *a3, void *a4)
{
  ...
  v11 = [v8 personID];
  [v10 setPersonalStoreIdentifiersWithPersonID:v11 block:&__block_literal_global_747];
}
