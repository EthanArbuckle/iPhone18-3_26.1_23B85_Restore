...
- (id)modelObjectForRecommendationChildDictionary:(id)a3 parentGroup:(id)a4 subgroupsAccumulator:(id)a5 userIdentity:(id)a6
{
  ...
  {
    v13 = [(MPModelForYouRecommendationItemBuilder *)self requestedPropertySet];
    v14 = [v13 properties];
    if ([v14 containsObject:@"MPModelForYouRecommendationItemPropertyItemType"])
    {
      v15 = 2;
    }
    ...
    *&self->_requestedItemProperties = *&self->_requestedItemProperties & 0xFD | v15;
    if ([v14 containsObject:@"MPModelForYouRecommendationItemPropertyBackedByStoreItemMetadata"])
    {
      v16 = 4;
    }
    ...
    *&self->_requestedItemProperties = *&self->_requestedItemProperties & 0xFB | v16;
    v17 = [v13 relationships];
    v18 = objc_alloc_init(MEMORY[0x1E695DF90]);
    v19 = [v17 objectForKey:@"MPModelForYouRecommendationItemRelationshipAlbum"];
    if (v19)
    {
    ...
    v68 = v11;
    v20 = [v17 objectForKey:@"MPModelForYouRecommendationItemRelationshipPlaylist"];
    ...
    *&self->_requestedItemProperties = requestedItemProperties & 0xEF | (16 * (v20 != 0));
    ...
    v22 = [v17 objectForKey:@"MPModelForYouRecommendationItemRelationshipRadioStation"];
    ...
    *&self->_requestedItemProperties = v23 & 0xDF | (32 * (v22 != 0));
    ...
    v29 = [v17 objectForKey:@"MPModelForYouRecommendationItemRelationshipSubgroup"];
    *&self->_requestedItemProperties = *&self->_requestedItemProperties & 0xBF | ((v29 != 0) << 6);
    v30 = [[MPModelForYouRecommendationGroupBuilder alloc] initWithRequestedGroupPropertySet:v29 requestedItemPropertySet:v13 storeItemMetadataResults:v77 flatSectionedItems:self->_flatSectionedItems];
  ...
  v74 = [v10 objectForKey:@"contentId"];
  if (_NSIsNSString())
  {
    v32 = v74;
  }
  ...
  v33 = [v10 objectForKey:@"contentType"];
  if (_NSIsNSString())
  {
    v34 = v33;
  }
  ...
  if ([v32 length] && objc_msgSend(v34, "length"))
  {
    ...
    if (v36)
    {
      v37 = [(MPStoreModelObjectBuilder *)self->_contentItemBuilder modelObjectWithStoreItemMetadata:v36 userIdentity:v12];
      v38 = [v37 itemType];
      switch(v38)
      {
        case 5:
          v39 = [v37 radioStation];
          v62 = 0;
          v41 = 0;
          v67 = 3;
          v40 = v39;
        ...
        case 1:
          ...
          v41 = v39;
LABEL_39:
          v42 = [(MPModelObject *)v39 identifiers];
          v44 = 1;
          goto LABEL_53;
      }
    ...
    v37 = [v10 objectForKey:@"isUnavailableInAppleMusic"];
    if ((objc_opt_respondsToSelector() & 1) != 0 && [v37 BOOLValue])
    {
      ...
      {
        v66 = v34;
        v42 = strtoll([v32 UTF8String], 0, 0);
        if (!v42)
        {
          v40 = 0;
          v62 = 0;
...
LABEL_29:
          ...
          v33 = v63;
          v34 = v65;
          v70 = [(MPModelObject *)v50 initWithIdentifiers:v42 block:v78];
...
LABEL_35:
      ...
      {
        v54 = v34;
        v42 = strtoull([v32 UTF8String], 0, 0);
        if (v42)
        {
...
LABEL_52:
  ...
  v71 = [(MPModelForYouRecommendationGroupBuilder *)self->_subgroupBuilder modelObjectForRecommendationDictionary:v10 userIdentity:v12];
  v42 = [v71 identifiers];
  v40 = 0;
  v43 = 0;
  v41 = 0;
...
- (MPModelForYouRecommendationItemBuilder)initWithRequestedPropertySet:(id)a3 storeItemMetadataResults:(id)a4 flatSectionedItems:(id)a5
{
  ...
  if (v11)
  {
    ...
    objc_storeStrong(&v11->_flatSectionedItems, a5);
  }
