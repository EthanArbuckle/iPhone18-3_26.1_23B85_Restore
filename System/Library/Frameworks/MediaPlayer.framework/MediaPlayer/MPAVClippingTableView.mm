...
- (MPAVClippingTableView)initWithFrame:(CGRect)frame style:(int64_t)style;
- (id)_createBackgroundView;
- (id)backgroundViewForSection:(unint64_t)section;
- (void)layoutSubviews;
@end
...
- (id)backgroundViewForSection:(unint64_t)section
{
  ...
  _createBackgroundView = [(NSMutableDictionary *)sectionBackgroundViews objectForKeyedSubscript:v6];

  if (!_createBackgroundView)
  {
    _createBackgroundView = [(MPAVClippingTableView *)self _createBackgroundView];
    v8 = self->_sectionBackgroundViews;
    v9 = [MEMORY[0x1E696AD98] numberWithUnsignedInteger:section];
    [(NSMutableDictionary *)v8 setObject:_createBackgroundView forKeyedSubscript:v9];
  }
...
- (void)layoutSubviews
{
  ...
  indexPathsForVisibleRows = [(MPAVClippingTableView *)self indexPathsForVisibleRows];
  ...
  v21 = v14;
  selfCopy = self;
  [indexPathsForVisibleRows enumerateObjectsUsingBlock:v20];
...
- (MPAVClippingTableView)initWithFrame:(CGRect)frame style:(int64_t)style
{
  ...
  v4 = [(MPAVClippingTableView *)&v12 initWithFrame:style style:frame.origin.x, frame.origin.y, frame.size.width, frame.size.height];
  if (v4)
  {
    ...
    _createBackgroundView = [(MPAVClippingTableView *)v4 _createBackgroundView];
    headerBackgroundView = v4->_headerBackgroundView;
    v4->_headerBackgroundView = _createBackgroundView;

    _createBackgroundView2 = [(MPAVClippingTableView *)v4 _createBackgroundView];
    footerBackgroundView = v4->_footerBackgroundView;
    v4->_footerBackgroundView = _createBackgroundView2;
