...
- (id)humanDescription
{
  ...
  v4 = [v2 stringWithFormat:@"genres with %@", v3];
...
{
  v4 = a3;
  v5 = [MEMORY[0x1E696AEC0] stringWithFormat:@"Genre:a%p", v4];
  v6 = objc_opt_class();
...
{
  v3 = v2;
  v8 = [(MPModelGenreKind *)self albumKind];
  v4 = [v8 songKind];
  v5 = v4;
  if (v4)
  {
...
- (void)applyToView:(shared_ptr<mlcore:(id)a4 :LibraryView>)a3 withContext:
{
  var0 = a3.var0;
  v6 = a3.var1;
  v7 = [(MPModelGenreKind *)self albumKind];
  v8 = v7;
  v9 = *(var0 + 1);
  v10 = *var0;
  v11 = v9;
