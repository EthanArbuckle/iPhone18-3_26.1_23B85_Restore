...
void *___MPMediaKitInitPropertyArtistMap_block_invoke_4(uint64_t a1, void *a2)
{
...
void ___MPMediaKitInitPropertyArtistMap_block_invoke(uint64_t a1, void *a2, void *a3, void *a4)
{
  ...
  [v8 setPersonalStoreIdentifiersWithPersonID:v10 block:&__block_literal_global_361];
}
