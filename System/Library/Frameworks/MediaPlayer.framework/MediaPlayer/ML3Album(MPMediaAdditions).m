...
+ (id)propertyForMPMediaEntityProperty:()MPMediaAdditions
{
  ...
  {
    dispatch_once(&propertyForMPMediaEntityProperty__once_9, &__block_literal_global_11);
  }

  v5 = [propertyForMPMediaEntityProperty__ML3ForMP_8 objectForKeyedSubscript:v4];
  v6 = v5;
  if (v5)
  {
    v7 = v5;
