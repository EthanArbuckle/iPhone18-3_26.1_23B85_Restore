...
void ___MPMediaKitInitPropertySongMap_block_invoke_8_206(uint64_t a1, void *a2, uint64_t a3, void *a4)
{
  v5 = a4;
  v6 = [a2 objectForKeyedSubscript:@"previews"];
  [v5 setObject:v6 forKeyedSubscript:@"previews"];
}

void ___MPMediaKitInitPropertySongMap_block_invoke_7_196(uint64_t a1, void *a2, uint64_t a3, void *a4)
{
  v5 = a4;
  v6 = a2;
...
void ___MPMediaKitInitPropertySongMap_block_invoke_6_186(uint64_t a1, void *a2, uint64_t a3, void *a4)
{
  v5 = a4;
  v6 = a2;
...
void ___MPMediaKitInitPropertySongMap_block_invoke_5_179(uint64_t a1, void *a2, uint64_t a3, void *a4)
{
  v5 = a4;
...
void ___MPMediaKitInitPropertySongMap_block_invoke_4_175(uint64_t a1, void *a2, uint64_t a3, void *a4)
{
  v5 = a4;
  v6 = [a2 objectForKeyedSubscript:@"attribution"];
  [v5 setObject:v6 forKeyedSubscript:@"name"];
}

void ___MPMediaKitInitPropertySongMap_block_invoke_3_165(uint64_t a1, void *a2, uint64_t a3, void *a4)
{
  v5 = a4;
  v6 = a2;
...
void ___MPMediaKitInitPropertySongMap_block_invoke_2_152(uint64_t a1, void *a2, uint64_t a3, void *a4)
{
  v5 = a4;
  v6 = a2;
  v7 = [v6 valueForKeyPath:@"relationships.albums.data.id.@firstObject"];
  [v5 setIdentifier:v7];

  v9 = [v6 valueForKeyPath:@"attributes.albumName"];
...
id ___MPMediaKitInitPropertySongMap_block_invoke_130(uint64_t a1, void *a2)
{
  v2 = a2;
...
{
  v2 = [a2 valueForKeyPath:@"attributes.attribution"];
  v3 = [MEMORY[0x1E696AD98] numberWithInt:{objc_msgSend(v2, "length") != 0}];
...
id ___MPMediaKitInitPropertySongMap_block_invoke_6(uint64_t a1, void *a2, void *a3)
{
  ...
  v5 = a3;
  v6 = a2;
  v7 = [v4 arrayWithObjects:v13 count:2];
  ...
  {
    v10 = [v8 isEqual:@"uploaded-videos"];
  }
...
void ___MPMediaKitInitPropertySongMap_block_invoke(uint64_t a1, void *a2, void *a3, void *a4)
{
  ...
  v11 = [v8 personID];
  [v10 setPersonalStoreIdentifiersWithPersonID:v11 block:&__block_literal_global_40];
}
