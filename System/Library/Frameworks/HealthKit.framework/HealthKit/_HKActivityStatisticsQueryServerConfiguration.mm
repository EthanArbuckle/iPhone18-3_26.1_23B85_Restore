...
- (_HKActivityStatisticsQueryServerConfiguration)initWithCoder:(id)coder;
...
- (_HKActivityStatisticsQueryServerConfiguration)initWithCoder:(id)coder
{
  ...
  v5 = [(HKQueryServerConfiguration *)&v25 initWithCoder:coderCopy];
  if (v5)
  {
    v6 = objc_opt_class();
...
- (void)encodeWithCoder:(id)coder
{
  ...
  coderCopy = coder;
  [(HKQueryServerConfiguration *)&v15 encodeWithCoder:coderCopy];
  startDate = self->_startDate;
  v6 = NSStringFromSelector(sel_startDate);
  [coderCopy encodeObject:startDate forKey:{v6, v15.receiver, v15.super_class}];
