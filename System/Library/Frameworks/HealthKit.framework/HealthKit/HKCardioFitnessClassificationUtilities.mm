        ...
        do
        {
          ...
          do
          {
            ...
            if (v20 != v9)
            {
              if (v20 <= v9)
              {
                [(HKCardioFitnessClassificationUtilities *)v48 _parseCoreMotionClassificationData:selfCopy];
              }
...
+ (id)_flattenedThresholdsForLevelData:(id)data
{
  ...
  v8 = [hk_sortedKeys countByEnumeratingWithState:&v19 objects:v23 count:16];
  if (v8)
  {
    v9 = v8;
    v10 = *v20;
    do
    {
      for (i = 0; i != v9; ++i)
      {
        ...
        v12 = [dataCopy objectForKeyedSubscript:*(*(&v19 + 1) + 8 * i)];
      ...
      v9 = [hk_sortedKeys countByEnumeratingWithState:&v19 objects:v23 count:16];
    }
...
+ (id)_cardioFitnessLevelTransitionDatesForDateInterval:(id)interval biologicalSex:(int64_t)sex dateOfBirth:(id)birth
{
  ...
  else
  {
    ...
    for (i = 0; i != 40; i += 8)
    {
      [v11 setYear:{*(&v18 + i) + year, v18, v19, v20, v21}];
...
+ (id)cardioFitnessPropertiesForDate:(id)date healthStore:(id)store
{
  ...
  storeCopy = store;
  v16 = 0;
  v7 = [storeCopy biologicalSexWithError:&v16];
  v8 = v16;
  if (!v7)
  {
    _HKInitializeLogging();
  ...
  v15 = v8;
  v9 = [storeCopy dateOfBirthComponentsWithError:&v15];
  v10 = v15;
  ...
  if (v9)
  {
    if (v7)
    {
      ...
      v12 = [v9 hk_ageWithCurrentDate:dateCopy];
      v13 = objc_alloc_init(HKCardioFitnessLookupProperties);
      [(HKCardioFitnessLookupProperties *)v13 setAge:v12];
      [(HKCardioFitnessLookupProperties *)v13 setBiologicalSex:biologicalSex];
      goto LABEL_10;
    }
  }
...
+ (id)cardioFitnessLevelDateIntervalsWithDateInterval:(id)interval healthStore:(id)store
{
  ...
  storeCopy = store;
  v36 = 0;
  v8 = [storeCopy biologicalSexWithError:&v36];
  v9 = v36;
  if (!v8)
  {
    _HKInitializeLogging();
  ...
  v35 = v9;
  v10 = [storeCopy dateOfBirthComponentsWithError:&v35];
  v11 = v35;
...
LABEL_16:
  ...
  v30 = storeCopy;
  v28 = v10;
  v12 = [self _cardioFitnessLevelTransitionDatesForDateInterval:intervalCopy biologicalSex:objc_msgSend(v8 dateOfBirth:{"biologicalSex"), v10}];
  v13 = objc_alloc_init(MEMORY[0x1E695DF70]);
  ...
  v25 = [v23 initWithStartDate:startDate endDate:endDate];
