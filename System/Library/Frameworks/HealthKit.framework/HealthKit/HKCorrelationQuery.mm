...
- (void)client_deliverCorrelations:(id)correlations clearPendingSamples:(BOOL)samples isFinalBatch:(BOOL)batch queryUUID:(id)d;
...
- (void)client_deliverCorrelations:(id)correlations clearPendingSamples:(BOOL)samples isFinalBatch:(BOOL)batch queryUUID:(id)d
{
  ...
  v16 = dCopy;
  samplesCopy = samples;
  v17 = correlationsCopy;
  batchCopy = batch;
  v13 = correlationsCopy;
  v14 = dCopy;
...
+ (void)configureClientInterface:(id)interface
{
  ...
  v5 = [interfaceCopy hk_setArrayOfClass:objc_opt_class() forSelector:sel_client_deliverCorrelations_clearPendingSamples_isFinalBatch_queryUUID_ argumentIndex:0 ofReply:0];
}
...
- (void)queue_populateConfiguration:(id)configuration
{
  ...
  [configurationCopy setFilterDictionary:{self->_filterDictionary, v5.receiver, v5.super_class}];
}
