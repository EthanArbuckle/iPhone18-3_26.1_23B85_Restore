...
- (id)_dictionaryRepresentation
{
  ...
  v9 = @"code";
  v2 = [(INStartAudioCallIntentResponse *)self code];
  v3 = v2;
  if (v2 < (INStartAudioCallIntentResponseCodeFailureNoValidNumber|INStartAudioCallIntentResponseCodeReady))
  {
    v4 = off_1E7280508[v2];
    v5 = v4;
  }
...
- (int64_t)_codeWithName:(id)a3
{
  ...
  v4 = [v3 isEqualToString:@"INStartAudioCallIntentResponseCodeReady"];
  ...
  if ([v3 isEqualToString:@"INStartAudioCallIntentResponseCodeFailureRequiringAppLaunch"])
  {
    v4 = 4;
  }

  if ([v3 isEqualToString:@"INStartAudioCallIntentResponseCodeFailureAppConfigurationRequired"])
  {
    v4 = 5;
  }

  if ([v3 isEqualToString:@"INStartAudioCallIntentResponseCodeFailureCallingServiceNotAvailable"])
  {
    v4 = 6;
  }

  if ([v3 isEqualToString:@"INStartAudioCallIntentResponseCodeFailureContactNotSupportedByApp"])
  {
    v5 = 7;
  }
  ...
  v6 = [v3 isEqualToString:@"INStartAudioCallIntentResponseCodeFailureNoValidNumber"];
