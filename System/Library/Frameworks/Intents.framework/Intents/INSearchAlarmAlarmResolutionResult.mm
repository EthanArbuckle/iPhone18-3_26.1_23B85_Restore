...
- (id)_buildIntentSlotResolutionResultWithIntentSlotDescription:(id)description
{
  ...
  if ([(INIntentResolutionResult *)self resolutionResultCode]== 1 && [(INIntentResolutionResult *)self unsupportedReason])
  {
    ...
    [payloadUnsupported2 setSearchAlarmIntentAlarmsUnsupportedReason:v9];
  }
...
- (id)_initWithIntentSlotResolutionResult:(id)result slotDescription:(id)description
{
  ...
  if (v7)
  {
    ...
    hasSearchAlarmIntentAlarmsUnsupportedReason = [payloadUnsupported hasSearchAlarmIntentAlarmsUnsupportedReason];

    if (hasSearchAlarmIntentAlarmsUnsupportedReason)
    {
      payloadUnsupported2 = [resultCopy payloadUnsupported];
      searchAlarmIntentAlarmsUnsupportedReason = [payloadUnsupported2 searchAlarmIntentAlarmsUnsupportedReason];
      if (searchAlarmIntentAlarmsUnsupportedReason)
      {
        v12 = 2 * (searchAlarmIntentAlarmsUnsupportedReason == 1);
      }
