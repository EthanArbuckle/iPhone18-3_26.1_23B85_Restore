...
+ (id)confirmationRequiredWithEventAttributeToConfirm:(int64_t)confirm;
+ (id)successWithResolvedEventAttribute:(int64_t)attribute;
...
+ (id)confirmationRequiredWithEventAttributeToConfirm:(int64_t)confirm
{
  if (!confirm)
  {
    v7 = [MEMORY[0x1E695DF30] exceptionWithName:*MEMORY[0x1E695D940] reason:@"Confirmation of INEventAttributeUnknown is not supported." userInfo:0];
...
+ (id)successWithResolvedEventAttribute:(int64_t)attribute
{
  ...
  {
    NSLog(@"Success resolution with INEventAttributeUnknown will be reformed to notRequired.", a2);
...
- (id)_vocabularyValueForObject:(id)object slotDescription:(id)description
{
  ...
  if (valueType == 241)
  {
    ...
    if (objc_opt_isKindOfClass())
    {
      ...
      {
        v10 = *(&off_1E7286080 + integerValue - 1);
      }
...
- (id)_intentSlotValueForObject:(id)object slotDescription:(id)description
{
  ...
  if ([descriptionCopy valueType] == 241)
  {
