...
+ (INTemporalEventTriggerTypeOptionsResolutionResult)confirmationRequiredWithTemporalEventTriggerTypeOptionsToConfirm:(INTemporalEventTriggerTypeOptions)temporalEventTriggerTypeOptionsToConfirm
{
  v4 = [MEMORY[0x1E696AD98] numberWithUnsignedInteger:temporalEventTriggerTypeOptionsToConfirm];
...
+ (INTemporalEventTriggerTypeOptionsResolutionResult)successWithResolvedTemporalEventTriggerTypeOptions:(INTemporalEventTriggerTypeOptions)resolvedTemporalEventTriggerTypeOptions
{
  v4 = [MEMORY[0x1E696AD98] numberWithUnsignedInteger:resolvedTemporalEventTriggerTypeOptions];
...
- (id)_vocabularyValueForObject:(id)object slotDescription:(id)description
{
  ...
  if (valueType == 140)
  {
    ...
    {
      v11 = INTemporalEventTriggerTypeOptionsGetNames([objectCopy unsignedIntegerValue]);
...
- (id)_intentSlotValueForObject:(id)object slotDescription:(id)description
{
  ...
  if (valueType == 140)
  {
    ...
    if (objc_opt_isKindOfClass())
    {
      ...
      v11[3] = &unk_1E7288628;
      v12 = v7;
      INTemporalEventTriggerTypeOptionsEnumerateBackingTypes(unsignedIntegerValue, v11);
    }
  }
