...
- (INBusReservation)initWithCoder:(id)a3
{
  ...
  if (v5)
  {
    ...
    v8 = [v4 decodeObjectOfClass:objc_opt_class() forKey:@"busTrip"];
    busTrip = v5->_busTrip;
    v5->_busTrip = v8;
  }
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    objc_opt_class();
    if ((objc_opt_isKindOfClass() & 1) != 0 && (v10.receiver = self, v10.super_class = INBusReservation, [(INReservation *)&v10 isEqual:v4]))
    {
      v5 = v4;
      reservedSeat = self->_reservedSeat;
      v8 = 0;
