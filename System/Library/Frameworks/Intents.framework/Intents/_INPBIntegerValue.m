...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    v5 = [(_INPBIntegerValue *)self hasValue];
    if (v5 == [v4 hasValue])
    {
      if (!-[_INPBIntegerValue hasValue](self, "hasValue") || ![v4 hasValue] || (value = self->_value, value == objc_msgSend(v4, "value")))
      {
        ...
        if ((v7 != 0) != (v8 == 0))
        {
          v10 = [(_INPBIntegerValue *)self valueMetadata];
          if (!v10)
          {
...
{
  v4 = a3;
  v6 = [(_INPBIntegerValue *)self data];
