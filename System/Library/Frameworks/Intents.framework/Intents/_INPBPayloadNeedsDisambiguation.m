...
- (BOOL)isEqual:(id)a3
{
  ...
  if ([v4 isMemberOfClass:objc_opt_class()])
  {
    ...
    if ((v5 != 0) != (v6 == 0))
    {
      v8 = [(_INPBPayloadNeedsDisambiguation *)self disambiguationItems];
      if (!v8)
      {
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v6 = [(NSArray *)self->_disambiguationItems copyWithZone:a3];
...
{
  v4 = a3;
  v6 = [(_INPBPayloadNeedsDisambiguation *)self data];
