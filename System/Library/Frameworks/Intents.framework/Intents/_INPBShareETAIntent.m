...
- (BOOL)isEqual:(id)a3
{
  ...
  v7 = [(_INPBShareETAIntent *)self intentMetadata];
  if (v7)
  {
    v8 = v7;
    v9 = [(_INPBShareETAIntent *)self intentMetadata];
  ...
  if ((v5 != 0) != (v6 == 0))
  {
    v12 = [(_INPBShareETAIntent *)self recipients];
    if (!v12)
    {
...
LABEL_15:
    ...
    v13 = v12;
    v14 = [(_INPBShareETAIntent *)self recipients];
    v15 = [v4 recipients];
    v16 = [v14 isEqual:v15];
...
- (id)copyWithZone:(_NSZone *)a3
{
  v5 = [+[_INPBShareETAIntent allocWithZone:](_INPBShareETAIntent init];
...
{
  v4 = a3;
  v6 = [(_INPBShareETAIntent *)self data];
...
- (void)writeTo:(id)a3
{
  ...
  if (v5)
  {
    v6 = [(_INPBShareETAIntent *)self intentMetadata];
