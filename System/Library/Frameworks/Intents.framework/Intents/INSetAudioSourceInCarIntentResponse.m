...
- (id)_dictionaryRepresentation
{
  ...
  v9 = @"code";
  v2 = [(INSetAudioSourceInCarIntentResponse *)self code];
  v3 = v2;
  if (v2 < (INSetAudioSourceInCarIntentResponseCodeFailure|INSetAudioSourceInCarIntentResponseCodeInProgress))
  {
    v4 = off_1E727F750[v2];
    v5 = v4;
  }
...
- (int64_t)_codeWithName:(id)a3
{
  ...
  v4 = [v3 isEqualToString:@"INSetAudioSourceInCarIntentResponseCodeReady"];
  ...
  v6 = [v3 isEqualToString:@"INSetAudioSourceInCarIntentResponseCodeFailureRequiringAppLaunch"];
