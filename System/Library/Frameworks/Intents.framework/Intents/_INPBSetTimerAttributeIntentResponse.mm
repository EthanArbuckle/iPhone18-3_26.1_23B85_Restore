...
- (BOOL)isEqual:(id)a3
{
  ...
  if ([v4 isMemberOfClass:objc_opt_class()])
  {
    ...
    if ((v5 != 0) != (v6 == 0))
    {
      v8 = [(_INPBSetTimerAttributeIntentResponse *)self updatedTimer];
      if (!v8)
      {
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v6 = [(_INPBTimer *)self->_updatedTimer copyWithZone:a3];
...
{
  v4 = a3;
  v6 = [(_INPBSetTimerAttributeIntentResponse *)self data];
