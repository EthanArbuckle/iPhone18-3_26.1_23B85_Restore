...
+ (INDateSearchTypeResolutionResult)confirmationRequiredWithDateSearchTypeToConfirm:(INDateSearchType)dateSearchTypeToConfirm
{
  ...
  {
    v7 = [MEMORY[0x1E695DF30] exceptionWithName:*MEMORY[0x1E695D940] reason:@"Confirmation of INDateSearchTypeUnknown is not supported." userInfo:0];
...
+ (INDateSearchTypeResolutionResult)successWithResolvedDateSearchType:(INDateSearchType)resolvedDateSearchType
{
  ...
  {
    NSLog(@"Success resolution with INDateSearchTypeUnknown will be reformed to notRequired.", a2);
...
- (id)_vocabularyValueForObject:(id)object slotDescription:(id)description
{
  ...
  if (valueType == 126)
  {
    ...
    if (objc_opt_isKindOfClass())
    {
      ...
      {
        v10 = off_1E7280730[integerValue - 1];
      }
...
- (id)_intentSlotValueForObject:(id)object slotDescription:(id)description
{
  ...
  if ([descriptionCopy valueType] == 126)
  {
