...
{
  v11.receiver = self;
  v11.super_class = INSetTaskAttributeContactEventTriggerResolutionResult;
  ...
  if ([(INIntentResolutionResult *)self resolutionResultCode]== 1 && [(INIntentResolutionResult *)self unsupportedReason])
  {
    ...
    [payloadUnsupported2 setSetTaskAttributeIntentContactEventTriggerUnsupportedReason:v9];
  }
...
- (id)_initWithIntentSlotResolutionResult:(id)result slotDescription:(id)description
{
  resultCopy = result;
  v14.receiver = self;
  v14.super_class = INSetTaskAttributeContactEventTriggerResolutionResult;
  ...
  if (v7)
  {
    ...
    hasSetTaskAttributeIntentContactEventTriggerUnsupportedReason = [payloadUnsupported hasSetTaskAttributeIntentContactEventTriggerUnsupportedReason];

    if (hasSetTaskAttributeIntentContactEventTriggerUnsupportedReason)
    {
      payloadUnsupported2 = [resultCopy payloadUnsupported];
      setTaskAttributeIntentContactEventTriggerUnsupportedReason = [payloadUnsupported2 setTaskAttributeIntentContactEventTriggerUnsupportedReason];
      ...
      {
        v12 = 2 * (setTaskAttributeIntentContactEventTriggerUnsupportedReason == 2);
      }
