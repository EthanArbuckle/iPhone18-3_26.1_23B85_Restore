...
{
  v10.receiver = self;
  v10.super_class = INRequestPaymentCurrencyAmountResolutionResult;
  ...
  if ([(INIntentResolutionResult *)self resolutionResultCode]== 1 && [(INIntentResolutionResult *)self unsupportedReason])
  {
    ...
    [payloadUnsupported2 setRequestPaymentIntentCurrencyAmountUnsupportedReason:v8];
  }
...
- (id)_initWithIntentSlotResolutionResult:(id)result slotDescription:(id)description
{
  resultCopy = result;
  v14.receiver = self;
  v14.super_class = INRequestPaymentCurrencyAmountResolutionResult;
  ...
  if (v7)
  {
    ...
    hasRequestPaymentIntentCurrencyAmountUnsupportedReason = [payloadUnsupported hasRequestPaymentIntentCurrencyAmountUnsupportedReason];

    if (hasRequestPaymentIntentCurrencyAmountUnsupportedReason)
    {
      payloadUnsupported2 = [resultCopy payloadUnsupported];
      v11 = [payloadUnsupported2 requestPaymentIntentCurrencyAmountUnsupportedReason] - 1;
      if (v11 < 3)
      {
        v12 = v11 + 1;
      }
