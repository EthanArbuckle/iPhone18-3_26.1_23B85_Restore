        ...
        if (v9)
        {
          ...
          do
          {
            for (i = 0; i != v10; ++i)
            {
              ...
              v13 = INIntentSlotValueTransformToTemperatureValue(*(*(&v32 + 1) + 8 * i));
        ...
        if (v17)
        {
          ...
          do
          {
            for (j = 0; j != v18; ++j)
            {
              ...
              v21 = INIntentSlotValueTransformToTemperature(*(*(&v28 + 1) + 8 * j));
              [(_INPBTemperatureList *)v15 addTemperature:v21, v28];
            }
