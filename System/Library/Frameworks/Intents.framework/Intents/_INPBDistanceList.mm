...
- (BOOL)isEqual:(id)a3
{
  ...
  v7 = [(_INPBDistanceList *)self condition];
  if (v7)
  {
    v8 = v7;
    v9 = [(_INPBDistanceList *)self condition];
    v10 = [v4 condition];
    v11 = [v9 isEqual:v10];
  ...
  if ((v5 != 0) != (v6 == 0))
  {
    v12 = [(_INPBDistanceList *)self distances];
    if (!v12)
    {
...
LABEL_15:
    ...
    v13 = v12;
    v14 = [(_INPBDistanceList *)self distances];
    v15 = [v4 distances];
    v16 = [v14 isEqual:v15];
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v7 = [(NSArray *)self->_distances copyWithZone:a3];
...
{
  v4 = a3;
  v6 = [(_INPBDistanceList *)self data];
...
- (void)writeTo:(id)a3
{
  ...
  if (v5)
  {
    v6 = [(_INPBDistanceList *)self condition];
