...
- (void)_redactForMissingPrivacyEntitlementOptions:(unint64_t)a3 containingAppBundleId:(id)a4
{
  v6 = [(INGetCarPowerLevelStatusIntent *)self _typedBackingStore:a3];
  v5 = [v6 copy];
...
{
  v4 = a3;
  v6 = [(INGetCarPowerLevelStatusIntent *)self _typedBackingStore];
...
{
  v4 = a3;
  v5 = [(INGetCarPowerLevelStatusIntent *)self _typedBackingStore];
