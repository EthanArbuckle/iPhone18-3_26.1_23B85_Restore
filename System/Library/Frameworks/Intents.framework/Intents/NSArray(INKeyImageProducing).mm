...
- (uint64_t)_compareSubProducerOne:()INKeyImageProducing subProducerTwo:
{
  ...
  v7 = a4;
  v8 = [v6 numberWithUnsignedInteger:{objc_msgSend(self, "indexOfObject:", a3)}];
  v9 = MEMORY[0x1E696AD98];
  v10 = [self indexOfObject:v7];
...
- (id)_keyImage
{
  ...
  v4 = INKeyImageUtilitiesKeyImageBySubProducerComparison(self, v3);
