...
- (_INVocabulary)init;
- (id)_validator;
- (void)_THROW_EXCEPTION_FOR_ATTEMPT_TO_PROVIDE_VOCABULARY_OF_TYPE_THAT_APP_DOES_NOT_HANDLE_:(id)e_;
- (void)_THROW_EXCEPTION_FOR_INVALID_VOCABULARY_TYPE_;
- (void)_setVocabulary:(id)vocabulary ofType:(int64_t)type onBehalfOf:(id)of;
- (void)removeAllVocabularyStrings;
- (void)removeAllVocabularyStringsOnBehalfOf:(id)of;
- (void)setValidatedVocabulary:(id)vocabulary ofType:(int64_t)type onBehalfOf:(id)of;
- (void)setVocabularyStrings:(id)strings ofType:(int64_t)type;
- (void)validateVocabularyType:(int64_t)type;
@end
...
{
  e_Copy = e_;
  e_Copy = [MEMORY[0x1E696AEC0] stringWithFormat:@"Illegal attempt to provide vocabulary of type %@ by an app that does not handle any intents that could use that type of vocabulary", e_Copy];
  ...
  {
    v4 = [MEMORY[0x1E695DF30] exceptionWithName:*MEMORY[0x1E695D930] reason:e_Copy userInfo:0];
...
- (void)validateVocabularyType:(int64_t)type
{
  v4 = _INSyncSlotFromVocabularyStringType(type);
...
- (void)setValidatedVocabulary:(id)vocabulary ofType:(int64_t)type onBehalfOf:(id)of
{
  vocabularyCopy = vocabulary;
  ofCopy = of;
  v10 = _INSyncSlotFromVocabularyStringType(type);
  ...
  v13[1] = type;
  [(INVocabularyUpdater *)vocabularyUpdater setValidatedVocabulary:vocabularyCopy forIntentSlot:v10 onBehalfOf:ofCopy validationCompletion:v12];
