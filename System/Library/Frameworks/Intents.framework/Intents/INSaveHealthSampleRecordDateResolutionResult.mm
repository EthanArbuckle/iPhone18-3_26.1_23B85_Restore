...
{
  v10.receiver = self;
  v10.super_class = INSaveHealthSampleRecordDateResolutionResult;
  ...
  if ([(INIntentResolutionResult *)self resolutionResultCode]== 1 && [(INIntentResolutionResult *)self unsupportedReason])
  {
    ...
    [payloadUnsupported2 setSaveHealthSampleIntentRecordDateUnsupportedReason:v8];
  }
...
- (id)_initWithIntentSlotResolutionResult:(id)result slotDescription:(id)description
{
  resultCopy = result;
  v14.receiver = self;
  v14.super_class = INSaveHealthSampleRecordDateResolutionResult;
  ...
  if (v7)
  {
    ...
    hasSaveHealthSampleIntentRecordDateUnsupportedReason = [payloadUnsupported hasSaveHealthSampleIntentRecordDateUnsupportedReason];

    if (hasSaveHealthSampleIntentRecordDateUnsupportedReason)
    {
      payloadUnsupported2 = [resultCopy payloadUnsupported];
      v11 = [payloadUnsupported2 saveHealthSampleIntentRecordDateUnsupportedReason] - 1;
      if (v11 < 3)
      {
        v12 = v11 + 1;
      }
