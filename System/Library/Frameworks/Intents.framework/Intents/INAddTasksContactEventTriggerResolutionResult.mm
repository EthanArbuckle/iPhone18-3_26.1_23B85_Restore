...
{
  v11.receiver = self;
  v11.super_class = INAddTasksContactEventTriggerResolutionResult;
  ...
  if ([(INIntentResolutionResult *)self resolutionResultCode]== 1 && [(INIntentResolutionResult *)self unsupportedReason])
  {
    ...
    [payloadUnsupported2 setAddTasksIntentContactEventTriggerUnsupportedReason:v9];
  }
...
- (id)_initWithIntentSlotResolutionResult:(id)result slotDescription:(id)description
{
  resultCopy = result;
  v14.receiver = self;
  v14.super_class = INAddTasksContactEventTriggerResolutionResult;
  ...
  if (v7)
  {
    ...
    hasAddTasksIntentContactEventTriggerUnsupportedReason = [payloadUnsupported hasAddTasksIntentContactEventTriggerUnsupportedReason];

    if (hasAddTasksIntentContactEventTriggerUnsupportedReason)
    {
      payloadUnsupported2 = [resultCopy payloadUnsupported];
      addTasksIntentContactEventTriggerUnsupportedReason = [payloadUnsupported2 addTasksIntentContactEventTriggerUnsupportedReason];
      ...
      {
        v12 = 2 * (addTasksIntentContactEventTriggerUnsupportedReason == 2);
      }
