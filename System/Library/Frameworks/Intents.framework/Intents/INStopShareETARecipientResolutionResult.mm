...
{
  v10.receiver = self;
  v10.super_class = INStopShareETARecipientResolutionResult;
  ...
  if ([(INIntentResolutionResult *)self resolutionResultCode]== 1 && [(INIntentResolutionResult *)self unsupportedReason])
  {
    ...
    [payloadUnsupported2 setStopShareETAIntentRecipientUnsupportedReason:v8];
  }
...
- (id)_initWithIntentSlotResolutionResult:(id)result slotDescription:(id)description
{
  resultCopy = result;
  v14.receiver = self;
  v14.super_class = INStopShareETARecipientResolutionResult;
  ...
  if (v7)
  {
    ...
    hasStopShareETAIntentRecipientUnsupportedReason = [payloadUnsupported hasStopShareETAIntentRecipientUnsupportedReason];

    if (hasStopShareETAIntentRecipientUnsupportedReason)
    {
      payloadUnsupported2 = [resultCopy payloadUnsupported];
      stopShareETAIntentRecipientUnsupportedReason = [payloadUnsupported2 stopShareETAIntentRecipientUnsupportedReason];
      if (stopShareETAIntentRecipientUnsupportedReason < 5)
      {
        v12 = stopShareETAIntentRecipientUnsupportedReason + 1;
      }
