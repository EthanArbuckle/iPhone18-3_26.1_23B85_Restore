...
- (id)_dictionaryRepresentation
{
  ...
  v12[0] = @"code";
  v3 = [(INChangeAlarmStatusIntentResponse *)self code];
  v4 = v3;
  if (v3 < 6)
  {
    v5 = off_1E7288238[v3];
  ...
  v12[1] = @"modifiedAlarms";
  v13[0] = v5;
  v7 = [(INChangeAlarmStatusIntentResponse *)self modifiedAlarms];
  v8 = v7;
  if (!v7)
  {
...
- (int64_t)_codeWithName:(id)a3
{
  ...
  v4 = [v3 isEqualToString:@"INChangeAlarmStatusIntentResponseCodeReady"];
  ...
  v6 = [v3 isEqualToString:@"INChangeAlarmStatusIntentResponseCodeFailureRequiringAppLaunch"];
...
- (int64_t)_intentResponseCode
{
  v2 = [(INChangeAlarmStatusIntentResponse *)self code];
  if ((v2 - 1) > 4)
  {
    return 0;
  }
...
{
  v4.receiver = self;
  v4.super_class = INChangeAlarmStatusIntentResponse;
...
{
  v3.receiver = self;
  v3.super_class = INChangeAlarmStatusIntentResponse;
...
{
  v5.receiver = self;
  v5.super_class = INChangeAlarmStatusIntentResponse;
...
- (INChangeAlarmStatusIntentResponse)initWithCode:(int64_t)a3 userActivity:(id)a4
{
  ...
  if (os_log_type_enabled(INSiriLogContextIntents, OS_LOG_TYPE_INFO))
  {
    ...
    v10 = v9;
    *buf = 136315906;
    v16 = "[INChangeAlarmStatusIntentResponse initWithCode:userActivity:]";
    v17 = 2048;
    v18 = a3;
    v19 = 2112;
    v20 = v10;
  ...
  v14.receiver = self;
  v14.super_class = INChangeAlarmStatusIntentResponse;
