...
+ (id)confirmationRequiredWithUpdateAlarmOperationToConfirm:(int64_t)a3
{
  if (!a3)
  {
    v7 = [MEMORY[0x1E695DF30] exceptionWithName:*MEMORY[0x1E695D940] reason:@"Confirmation of INUpdateAlarmOperationUnknown is not supported." userInfo:0];
...
+ (id)successWithResolvedUpdateAlarmOperation:(int64_t)a3
{
  ...
  {
    NSLog(@"Success resolution with INUpdateAlarmOperationUnknown will be reformed to notRequired.", a2);
    v5 = [a1 notRequired];
  }
