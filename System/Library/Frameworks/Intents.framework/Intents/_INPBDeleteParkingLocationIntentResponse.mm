...
- (_INPBDeleteParkingLocationIntentResponse)initWithCoder:(id)coder;
...
- (id)dictionaryRepresentation
{
  ...
  parkingLocation = [(_INPBDeleteParkingLocationIntentResponse *)self parkingLocation];
  ...
  parkingNote = [(_INPBDeleteParkingLocationIntentResponse *)self parkingNote];
...
- (BOOL)isEqual:(id)equal
{
  ...
  parkingLocation3 = [(_INPBDeleteParkingLocationIntentResponse *)self parkingLocation];
  if (parkingLocation3)
  {
    v8 = parkingLocation3;
    parkingLocation4 = [(_INPBDeleteParkingLocationIntentResponse *)self parkingLocation];
  ...
  parkingLocation = [(_INPBDeleteParkingLocationIntentResponse *)self parkingNote];
...
LABEL_15:
    ...
    v13 = parkingNote;
    parkingNote2 = [(_INPBDeleteParkingLocationIntentResponse *)self parkingNote];
...
{
  coderCopy = coder;
  data = [(_INPBDeleteParkingLocationIntentResponse *)self data];
...
- (_INPBDeleteParkingLocationIntentResponse)initWithCoder:(id)coder
{
  ...
  {
    self = [(_INPBDeleteParkingLocationIntentResponse *)self initWithData:selfCopy];
...
- (void)writeTo:(id)to
{
  ...
  if (parkingLocation)
  {
    parkingLocation2 = [(_INPBDeleteParkingLocationIntentResponse *)self parkingLocation];
