...
- (id)_dictionaryRepresentation
{
  ...
  v12[0] = @"code";
  v3 = [(INAddCallParticipantIntentResponse *)self code];
  v4 = v3;
  if (v3 < 0xE)
  {
    v5 = off_1E7288940[v3];
...
- (NSArray)invites
{
  ...
  v3 = [v2 invites];
  v4 = INIntentSlotValueTransformFromCallInvites(v3);
...
- (int64_t)_codeWithName:(id)a3
{
  ...
  v4 = [v3 isEqualToString:@"INAddCallParticipantIntentResponseCodeReady"];
  ...
  if ([v3 isEqualToString:@"INAddCallParticipantIntentResponseCodeFailureRequiringAppLaunch"])
  {
    v4 = 5;
  }

  if ([v3 isEqualToString:@"INAddCallParticipantIntentResponseCodeFailureRestrictedForParticipantInDowntime"])
  {
    v4 = 6;
  }

  if ([v3 isEqualToString:@"INAddCallParticipantIntentResponseCodeFailureUnsupportedActiveCall"])
  {
    v4 = 7;
  }
  ...
  if ([v3 isEqualToString:@"INAddCallParticipantIntentResponseCodeFailureParticipantAlreadyActive"])
  {
    v4 = 9;
  }

  if ([v3 isEqualToString:@"INAddCallParticipantIntentResponseCodeFailureMaxParticipantsReached"])
  {
    v4 = 10;
  }

  if ([v3 isEqualToString:@"INAddCallParticipantIntentResponseCodeFailureRestrictedDevice"])
  {
    v4 = 11;
  }

  if ([v3 isEqualToString:@"INAddCallParticipantIntentResponseCodeFailureRestrictedDeviceByRegion"])
  {
    v5 = 12;
  }
  ...
  v6 = [v3 isEqualToString:@"INAddCallParticipantIntentResponseCodeFailureRestrictedForParticipant"];
...
- (int64_t)_intentResponseCode
{
  v2 = [(INAddCallParticipantIntentResponse *)self code];
  if ((v2 - 1) > 0xC)
  {
    return 0;
  }
