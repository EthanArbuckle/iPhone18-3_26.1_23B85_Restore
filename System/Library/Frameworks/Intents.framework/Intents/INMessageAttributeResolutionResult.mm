...
+ (INMessageAttributeResolutionResult)confirmationRequiredWithMessageAttributeToConfirm:(INMessageAttribute)messageAttributeToConfirm
{
  ...
  {
    v7 = [MEMORY[0x1E695DF30] exceptionWithName:*MEMORY[0x1E695D940] reason:@"Confirmation of INMessageAttributeUnknown is not supported." userInfo:0];
...
+ (INMessageAttributeResolutionResult)successWithResolvedMessageAttribute:(INMessageAttribute)resolvedMessageAttribute
{
  ...
  {
    NSLog(@"Success resolution with INMessageAttributeUnknown will be reformed to notRequired.", a2);
...
- (id)_vocabularyValueForObject:(id)object slotDescription:(id)description
{
  ...
  if (valueType == 84)
  {
    ...
    if (objc_opt_isKindOfClass())
    {
      ...
      {
        v10 = off_1E72806E0[integerValue - 1];
      }
...
- (id)_intentSlotValueForObject:(id)object slotDescription:(id)description
{
  ...
  if ([descriptionCopy valueType] == 84)
  {
