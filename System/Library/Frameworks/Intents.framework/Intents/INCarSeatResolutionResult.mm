...
+ (INCarSeatResolutionResult)confirmationRequiredWithCarSeatToConfirm:(INCarSeat)carSeatToConfirm
{
  ...
  {
    v7 = [MEMORY[0x1E695DF30] exceptionWithName:*MEMORY[0x1E695D940] reason:@"Confirmation of INCarSeatUnknown is not supported." userInfo:0];
...
+ (INCarSeatResolutionResult)successWithResolvedCarSeat:(INCarSeat)resolvedCarSeat
{
  ...
  {
    NSLog(@"Success resolution with INCarSeatUnknown will be reformed to notRequired.", a2);
...
- (id)_vocabularyValueForObject:(id)object slotDescription:(id)description
{
  ...
  if (valueType == 123)
  {
    ...
    if (objc_opt_isKindOfClass())
    {
      ...
      {
        v10 = off_1E727EFE0[integerValue - 1];
      }
...
- (id)_intentSlotValueForObject:(id)object slotDescription:(id)description
{
  ...
  if ([descriptionCopy valueType] == 123)
  {
