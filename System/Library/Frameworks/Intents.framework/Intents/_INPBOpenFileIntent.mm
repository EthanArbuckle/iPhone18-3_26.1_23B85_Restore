...
- (id)dictionaryRepresentation
{
  ...
  {
    v8 = [(_INPBOpenFileIntent *)self entityType];
    if (v8 >= 4)
    {
  ...
  {
    v19 = [(_INPBOpenFileIntent *)self scope];
    if (v19 >= 3)
    {
...
- (BOOL)isEqual:(id)a3
{
  ...
  v5 = [(_INPBOpenFileIntent *)self appId];
  v6 = [v4 appId];
  if ((v5 != 0) == (v6 == 0))
  {
    goto LABEL_34;
  ...
  v7 = [(_INPBOpenFileIntent *)self appId];
  if (v7)
  {
    v8 = v7;
  ...
  v5 = [(_INPBOpenFileIntent *)self entityName];
  v6 = [v4 entityName];
  if ((v5 != 0) == (v6 == 0))
  {
    goto LABEL_34;
  ...
  v12 = [(_INPBOpenFileIntent *)self entityName];
  if (v12)
  {
    v13 = v12;
    v14 = [(_INPBOpenFileIntent *)self entityName];
    v15 = [v4 entityName];
    v16 = [v14 isEqual:v15];
  ...
  v17 = [(_INPBOpenFileIntent *)self hasEntityType];
  ...
  v5 = [(_INPBOpenFileIntent *)self intentMetadata];
  ...
  v19 = [(_INPBOpenFileIntent *)self intentMetadata];
  if (v19)
  {
    v20 = v19;
  ...
  v5 = [(_INPBOpenFileIntent *)self properties];
  v6 = [v4 properties];
  if ((v5 != 0) == (v6 == 0))
  {
    goto LABEL_34;
  ...
  v24 = [(_INPBOpenFileIntent *)self properties];
  if (v24)
  {
    v25 = v24;
    v26 = [(_INPBOpenFileIntent *)self properties];
    v27 = [v4 properties];
    v28 = [v26 isEqual:v27];
  ...
  v29 = [(_INPBOpenFileIntent *)self hasScope];
  if (v29 != [v4 hasScope])
  {
    goto LABEL_35;
  }
  ...
  v5 = [(_INPBOpenFileIntent *)self scopeEntityName];
  v6 = [v4 scopeEntityName];
  if ((v5 != 0) != (v6 == 0))
  {
    v31 = [(_INPBOpenFileIntent *)self scopeEntityName];
    if (!v31)
    {
...
{
  v4 = a3;
  v6 = [(_INPBOpenFileIntent *)self data];
...
- (void)writeTo:(id)a3
{
  ...
  if (v5)
  {
    v6 = [(_INPBOpenFileIntent *)self appId];
    PBDataWriterWriteSubmessage();
  }

  v7 = [(_INPBOpenFileIntent *)self entityName];

  if (v7)
  {
    v8 = [(_INPBOpenFileIntent *)self entityName];
    PBDataWriterWriteSubmessage();
  }
  ...
  if (v10)
  {
    v11 = [(_INPBOpenFileIntent *)self intentMetadata];
    PBDataWriterWriteSubmessage();
  }
  ...
  v19 = [(_INPBOpenFileIntent *)self scopeEntityName];

  if (v19)
  {
    v20 = [(_INPBOpenFileIntent *)self scopeEntityName];
    PBDataWriterWriteSubmessage();
  }
