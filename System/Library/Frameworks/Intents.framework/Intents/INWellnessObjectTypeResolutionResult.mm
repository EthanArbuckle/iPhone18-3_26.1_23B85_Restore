...
+ (id)confirmationRequiredWithWellnessObjectTypeToConfirm:(int64_t)confirm;
+ (id)successWithResolvedWellnessObjectType:(int64_t)type;
...
+ (id)confirmationRequiredWithWellnessObjectTypeToConfirm:(int64_t)confirm
{
  if (!confirm)
  {
    v7 = [MEMORY[0x1E695DF30] exceptionWithName:*MEMORY[0x1E695D940] reason:@"Confirmation of INWellnessObjectTypeUnknown is not supported." userInfo:0];
...
+ (id)successWithResolvedWellnessObjectType:(int64_t)type
{
  ...
  {
    NSLog(@"Success resolution with INWellnessObjectTypeUnknown will be reformed to notRequired.", a2);
...
- (id)_vocabularyValueForObject:(id)object slotDescription:(id)description
{
  ...
  if (valueType == 172)
  {
    ...
    if (objc_opt_isKindOfClass())
    {
      ...
      {
        v10 = off_1E727FAC8[integerValue - 1];
      }
...
- (id)_intentSlotValueForObject:(id)object slotDescription:(id)description
{
  ...
  if ([descriptionCopy valueType] == 172)
  {
