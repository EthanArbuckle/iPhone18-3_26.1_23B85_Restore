...
- (_INPBAirline)initWithCoder:(id)coder;
...
- (id)dictionaryRepresentation
{
  ...
  if (self->_iataCode)
  {
    iataCode = [(_INPBAirline *)self iataCode];
    v5 = [iataCode copy];
  ...
  if (self->_icaoCode)
  {
    icaoCode = [(_INPBAirline *)self icaoCode];
    v7 = [icaoCode copy];
...
- (BOOL)isEqual:(id)equal
{
  ...
  iataCode3 = [(_INPBAirline *)self iataCode];
  if (iataCode3)
  {
    v8 = iataCode3;
    iataCode4 = [(_INPBAirline *)self iataCode];
  ...
  iataCode = [(_INPBAirline *)self icaoCode];
  ...
  {
    v13 = icaoCode;
    icaoCode2 = [(_INPBAirline *)self icaoCode];
  ...
  iataCode = [(_INPBAirline *)self name];
...
- (_INPBAirline)initWithCoder:(id)coder
{
  ...
  {
    self = [(_INPBAirline *)self initWithData:selfCopy];
