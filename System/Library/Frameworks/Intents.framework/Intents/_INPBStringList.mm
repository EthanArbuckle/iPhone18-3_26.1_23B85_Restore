...
- (_INPBStringList)initWithCoder:(id)coder;
...
- (id)dictionaryRepresentation
{
  ...
  conditionType = [(_INPBStringList *)self conditionType];
...
- (BOOL)isEqual:(id)equal
{
  ...
  conditionType3 = [(_INPBStringList *)self conditionType];
  if (conditionType3)
  {
    v8 = conditionType3;
    conditionType4 = [(_INPBStringList *)self conditionType];
  ...
  conditionType = [(_INPBStringList *)self dataStrings];
  conditionType2 = [equalCopy dataStrings];
  if ((conditionType != 0) != (conditionType2 == 0))
  {
    dataStrings = [(_INPBStringList *)self dataStrings];
    if (!dataStrings)
    {
...
LABEL_15:
    ...
    v13 = dataStrings;
    dataStrings2 = [(_INPBStringList *)self dataStrings];
...
- (id)copyWithZone:(_NSZone *)zone
{
  v5 = [+[_INPBStringList allocWithZone:](_INPBStringList init];
...
{
  coderCopy = coder;
  data = [(_INPBStringList *)self data];
...
- (_INPBStringList)initWithCoder:(id)coder
{
  ...
  {
    self = [(_INPBStringList *)self initWithData:selfCopy];
...
- (void)writeTo:(id)to
{
  ...
  if (conditionType)
  {
    conditionType2 = [(_INPBStringList *)self conditionType];
