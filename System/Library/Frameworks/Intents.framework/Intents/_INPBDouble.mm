...
- (_INPBDouble)initWithCoder:(id)coder;
...
- (BOOL)isEqual:(id)equal
{
  ...
  {
    values = [(_INPBDouble *)self values];
    values2 = [equalCopy values];
    v7 = values2;
    if ((values != 0) != (values2 == 0))
    {
      values3 = [(_INPBDouble *)self values];
      if (!values3)
      {
...
LABEL_10:
      ...
      v9 = values3;
      values4 = [(_INPBDouble *)self values];
...
- (id)copyWithZone:(_NSZone *)zone
{
  v5 = [+[_INPBDouble allocWithZone:](_INPBDouble init];
...
- (_INPBDouble)initWithCoder:(id)coder
{
  ...
  {
    self = [(_INPBDouble *)self initWithData:selfCopy];
