...
{
  v11.receiver = self;
  v11.super_class = INDeleteTasksTaskResolutionResult;
  ...
  if ([(INIntentResolutionResult *)self resolutionResultCode]== 1 && [(INIntentResolutionResult *)self unsupportedReason])
  {
    ...
    [payloadUnsupported2 setDeleteTasksIntentTaskUnsupportedReason:v9];
  }
...
- (id)_initWithIntentSlotResolutionResult:(id)result slotDescription:(id)description
{
  resultCopy = result;
  v14.receiver = self;
  v14.super_class = INDeleteTasksTaskResolutionResult;
  ...
  if (v7)
  {
    ...
    hasDeleteTasksIntentTaskUnsupportedReason = [payloadUnsupported hasDeleteTasksIntentTaskUnsupportedReason];

    if (hasDeleteTasksIntentTaskUnsupportedReason)
    {
      payloadUnsupported2 = [resultCopy payloadUnsupported];
      deleteTasksIntentTaskUnsupportedReason = [payloadUnsupported2 deleteTasksIntentTaskUnsupportedReason];
      ...
      {
        v12 = 2 * (deleteTasksIntentTaskUnsupportedReason == 2);
      }
