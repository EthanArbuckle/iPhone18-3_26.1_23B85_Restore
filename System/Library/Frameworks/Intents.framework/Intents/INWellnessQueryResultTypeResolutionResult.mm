...
+ (id)confirmationRequiredWithWellnessQueryResultTypeToConfirm:(int64_t)confirm;
+ (id)successWithResolvedWellnessQueryResultType:(int64_t)type;
...
+ (id)confirmationRequiredWithWellnessQueryResultTypeToConfirm:(int64_t)confirm
{
  if (!confirm)
  {
    v7 = [MEMORY[0x1E695DF30] exceptionWithName:*MEMORY[0x1E695D940] reason:@"Confirmation of INWellnessQueryResultTypeUnknown is not supported." userInfo:0];
...
+ (id)successWithResolvedWellnessQueryResultType:(int64_t)type
{
  ...
  {
    NSLog(@"Success resolution with INWellnessQueryResultTypeUnknown will be reformed to notRequired.", a2);
...
- (id)_vocabularyValueForObject:(id)object slotDescription:(id)description
{
  ...
  if (valueType == 178)
  {
    ...
    if (objc_opt_isKindOfClass())
    {
      ...
      {
        v10 = off_1E7285448[integerValue - 1];
      }
...
- (id)_intentSlotValueForObject:(id)object slotDescription:(id)description
{
  ...
  if ([descriptionCopy valueType] == 178)
  {
