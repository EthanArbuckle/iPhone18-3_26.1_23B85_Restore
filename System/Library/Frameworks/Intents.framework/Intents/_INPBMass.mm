...
- (_INPBMass)initWithCoder:(id)coder;
...
- (BOOL)isEqual:(id)equal
{
  ...
  {
    values = [(_INPBMass *)self values];
    values2 = [equalCopy values];
    v7 = values2;
    if ((values != 0) != (values2 == 0))
    {
      values3 = [(_INPBMass *)self values];
      if (!values3)
      {
...
- (id)copyWithZone:(_NSZone *)zone
{
  v5 = [+[_INPBMass allocWithZone:](_INPBMass init];
...
- (_INPBMass)initWithCoder:(id)coder
{
  ...
  {
    self = [(_INPBMass *)self initWithData:selfCopy];
