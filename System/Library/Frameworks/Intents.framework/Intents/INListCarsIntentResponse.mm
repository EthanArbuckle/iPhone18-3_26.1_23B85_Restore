...
- (id)_dictionaryRepresentation
{
  ...
  v12[0] = @"code";
  v3 = [(INListCarsIntentResponse *)self code];
  v4 = v3;
  if (v3 < (INListCarsIntentResponseCodeFailure|INListCarsIntentResponseCodeInProgress))
  {
    v5 = *(&off_1E7287710 + v3);
    v6 = v5;
  }
  ...
  v12[1] = @"cars";
  v13[0] = v5;
  v7 = [(INListCarsIntentResponse *)self cars];
  v8 = v7;
  if (!v7)
  {
...
- (NSArray)cars
{
  ...
  v3 = [v2 cars];
  v4 = INIntentSlotValueTransformFromCars(v3);
...
- (int64_t)_codeWithName:(id)a3
{
  ...
  v4 = [v3 isEqualToString:@"INListCarsIntentResponseCodeReady"];
  ...
  v6 = [v3 isEqualToString:@"INListCarsIntentResponseCodeFailureRequiringAppLaunch"];
...
- (int64_t)_intentResponseCode
{
  v2 = [(INListCarsIntentResponse *)self code];
  if ((v2 - 1) > 4)
  {
    return 0;
  }
...
- (INListCarsIntentResponse)initWithCode:(INListCarsIntentResponseCode)code userActivity:(NSUserActivity *)userActivity
{
  ...
  if (os_log_type_enabled(INSiriLogContextIntents, OS_LOG_TYPE_INFO))
  {
    ...
    v10 = v9;
    *buf = 136315906;
    v16 = "[INListCarsIntentResponse initWithCode:userActivity:]";
    v17 = 2048;
    v18 = code;
    v19 = 2112;
    v20 = v10;
  ...
  v14.receiver = self;
  v14.super_class = INListCarsIntentResponse;
