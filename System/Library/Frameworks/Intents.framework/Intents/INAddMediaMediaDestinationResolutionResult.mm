...
{
  v11.receiver = self;
  v11.super_class = INAddMediaMediaDestinationResolutionResult;
  ...
  if ([(INIntentResolutionResult *)self resolutionResultCode]== 1 && [(INIntentResolutionResult *)self unsupportedReason])
  {
    ...
    [payloadUnsupported2 setAddMediaIntentMediaDestinationUnsupportedReason:v9];
  }
...
- (id)_initWithIntentSlotResolutionResult:(id)result slotDescription:(id)description
{
  resultCopy = result;
  v14.receiver = self;
  v14.super_class = INAddMediaMediaDestinationResolutionResult;
  ...
  if (v7)
  {
    ...
    hasAddMediaIntentMediaDestinationUnsupportedReason = [payloadUnsupported hasAddMediaIntentMediaDestinationUnsupportedReason];

    if (hasAddMediaIntentMediaDestinationUnsupportedReason)
    {
      payloadUnsupported2 = [resultCopy payloadUnsupported];
      addMediaIntentMediaDestinationUnsupportedReason = [payloadUnsupported2 addMediaIntentMediaDestinationUnsupportedReason];
      ...
      {
        v12 = 2 * (addMediaIntentMediaDestinationUnsupportedReason == 2);
      }
