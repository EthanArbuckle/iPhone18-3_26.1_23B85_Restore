...
- (id)_buildIntentSlotResolutionResultWithIntentSlotDescription:(id)description
{
  ...
  if ([(INIntentResolutionResult *)self resolutionResultCode]== 1 && [(INIntentResolutionResult *)self unsupportedReason])
  {
    ...
    [payloadUnsupported2 setUpdateMediaAffinityIntentMediaItemsUnsupportedReason:v18];
  }
...
- (id)_initWithIntentSlotResolutionResult:(id)result slotDescription:(id)description
{
  ...
  if (v7)
  {
    ...
    hasUpdateMediaAffinityIntentMediaItemsUnsupportedReason = [payloadUnsupported hasUpdateMediaAffinityIntentMediaItemsUnsupportedReason];

    if (hasUpdateMediaAffinityIntentMediaItemsUnsupportedReason)
    {
      payloadUnsupported2 = [resultCopy payloadUnsupported];
      updateMediaAffinityIntentMediaItemsUnsupportedReason = [payloadUnsupported2 updateMediaAffinityIntentMediaItemsUnsupportedReason];
      v12 = 1001;
      v13 = 1002;
      v14 = 1003;
      if (updateMediaAffinityIntentMediaItemsUnsupportedReason != 103)
      {
        v14 = 0;
      }

      if (updateMediaAffinityIntentMediaItemsUnsupportedReason != 102)
      {
        v13 = v14;
      }

      if (updateMediaAffinityIntentMediaItemsUnsupportedReason != 101)
      {
        v12 = v13;
      }
      ...
      if (updateMediaAffinityIntentMediaItemsUnsupportedReason != 8)
      {
        v16 = v17;
      }

      if (updateMediaAffinityIntentMediaItemsUnsupportedReason != 7)
      {
        v15 = v16;
      }
      ...
      if (updateMediaAffinityIntentMediaItemsUnsupportedReason != 5)
      {
        v19 = v20;
      }
