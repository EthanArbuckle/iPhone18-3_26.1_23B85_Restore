...
- (BOOL)isEqual:(id)a3
{
  ...
  v7 = [(_INPBSaveProfileInCarIntent *)self intentMetadata];
  if (v7)
  {
    v8 = v7;
  ...
  v12 = [(_INPBSaveProfileInCarIntent *)self profileName];
  if (v12)
  {
    v13 = v12;
  ...
  if ((v5 != 0) != (v6 == 0))
  {
    v17 = [(_INPBSaveProfileInCarIntent *)self profileNumber];
    if (!v17)
    {
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v7 = [(_INPBString *)self->_profileName copyWithZone:a3];
  [(_INPBSaveProfileInCarIntent *)v5 setProfileName:v7];

  v8 = [(_INPBInteger *)self->_profileNumber copyWithZone:a3];
...
{
  v4 = a3;
  v6 = [(_INPBSaveProfileInCarIntent *)self data];
...
- (void)writeTo:(id)a3
{
  ...
  if (v6)
  {
    v7 = [(_INPBSaveProfileInCarIntent *)self profileName];
    PBDataWriterWriteSubmessage();
  }
  ...
  if (v8)
  {
    v10 = [(_INPBSaveProfileInCarIntent *)self profileNumber];
    PBDataWriterWriteSubmessage();
