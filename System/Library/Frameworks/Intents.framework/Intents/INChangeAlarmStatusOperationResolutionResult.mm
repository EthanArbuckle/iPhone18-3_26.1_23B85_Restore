...
+ (id)confirmationRequiredWithChangeAlarmStatusOperationToConfirm:(int64_t)confirm
{
  if (!confirm)
  {
    v7 = [MEMORY[0x1E695DF30] exceptionWithName:*MEMORY[0x1E695D940] reason:@"Confirmation of INChangeAlarmStatusOperationUnknown is not supported." userInfo:0];
...
+ (id)successWithResolvedChangeAlarmStatusOperation:(int64_t)operation
{
  ...
  {
    NSLog(@"Success resolution with INChangeAlarmStatusOperationUnknown will be reformed to notRequired.", a2);
...
- (id)_vocabularyValueForObject:(id)object slotDescription:(id)description
{
  ...
  if (valueType == 184)
  {
    ...
    if (objc_opt_isKindOfClass())
    {
      ...
      {
        v10 = off_1E7288130[integerValue - 1];
      }
...
- (id)_intentSlotValueForObject:(id)object slotDescription:(id)description
{
  ...
  if ([descriptionCopy valueType] == 184)
  {
