...
- (id)_dictionaryRepresentation
{
  ...
  v9 = @"code";
  v2 = [(INPlayAudioMessageIntentResponse *)self code];
  v3 = v2;
  if (v2 < 8)
  {
    v4 = *(&off_1E727E950 + v2);
...
- (int64_t)_codeWithName:(id)a3
{
  ...
  v4 = [v3 isEqualToString:@"INPlayAudioMessageIntentResponseCodeReady"];
  ...
  if ([v3 isEqualToString:@"INPlayAudioMessageIntentResponseCodeFailureRequiringAppLaunch"])
  {
    v4 = 5;
  }

  if ([v3 isEqualToString:@"INPlayAudioMessageIntentResponseCodeFailureMessageNotFound"])
  {
    v5 = 6;
  }
  ...
  v6 = [v3 isEqualToString:@"INPlayAudioMessageIntentResponseCodeFailureMessageNotPlayed"];
