...
+ (INTaskPriorityResolutionResult)confirmationRequiredWithTaskPriorityToConfirm:(INTaskPriority)taskPriorityToConfirm
{
  ...
  {
    v7 = [MEMORY[0x1E695DF30] exceptionWithName:*MEMORY[0x1E695D940] reason:@"Confirmation of INTaskPriorityUnknown is not supported." userInfo:0];
...
+ (INTaskPriorityResolutionResult)successWithResolvedTaskPriority:(INTaskPriority)resolvedTaskPriority
{
  ...
  {
    NSLog(@"Success resolution with INTaskPriorityUnknown will be reformed to notRequired.", a2);
...
- (id)_intentSlotValueForObject:(id)object slotDescription:(id)description
{
  ...
  if ([descriptionCopy valueType] == 141)
  {
