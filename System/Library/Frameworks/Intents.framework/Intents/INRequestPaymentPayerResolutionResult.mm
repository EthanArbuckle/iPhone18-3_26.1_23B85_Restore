...
- (id)_buildIntentSlotResolutionResultWithIntentSlotDescription:(id)description
{
  ...
  if ([(INIntentResolutionResult *)self resolutionResultCode]== 1 && [(INIntentResolutionResult *)self unsupportedReason])
  {
    ...
    [payloadUnsupported2 setRequestPaymentIntentPayerUnsupportedReason:v8];
  }
...
- (id)_initWithIntentSlotResolutionResult:(id)result slotDescription:(id)description
{
  ...
  if (v7)
  {
    ...
    hasRequestPaymentIntentPayerUnsupportedReason = [payloadUnsupported hasRequestPaymentIntentPayerUnsupportedReason];

    if (hasRequestPaymentIntentPayerUnsupportedReason)
    {
      payloadUnsupported2 = [resultCopy payloadUnsupported];
      v11 = [payloadUnsupported2 requestPaymentIntentPayerUnsupportedReason] - 1;
      if (v11 < 3)
      {
        v12 = v11 + 1;
      }
