...
- (_INPBSaveParkingLocationIntentResponse)initWithCoder:(id)coder;
...
- (id)dictionaryRepresentation
{
  ...
  parkingLocation = [(_INPBSaveParkingLocationIntentResponse *)self parkingLocation];
  ...
  parkingNote = [(_INPBSaveParkingLocationIntentResponse *)self parkingNote];
...
- (BOOL)isEqual:(id)equal
{
  ...
  parkingLocation3 = [(_INPBSaveParkingLocationIntentResponse *)self parkingLocation];
  if (parkingLocation3)
  {
    v8 = parkingLocation3;
    parkingLocation4 = [(_INPBSaveParkingLocationIntentResponse *)self parkingLocation];
  ...
  parkingLocation = [(_INPBSaveParkingLocationIntentResponse *)self parkingNote];
...
LABEL_15:
    ...
    v13 = parkingNote;
    parkingNote2 = [(_INPBSaveParkingLocationIntentResponse *)self parkingNote];
...
{
  coderCopy = coder;
  data = [(_INPBSaveParkingLocationIntentResponse *)self data];
...
- (_INPBSaveParkingLocationIntentResponse)initWithCoder:(id)coder
{
  ...
  {
    self = [(_INPBSaveParkingLocationIntentResponse *)self initWithData:selfCopy];
...
- (void)writeTo:(id)to
{
  ...
  if (parkingLocation)
  {
    parkingLocation2 = [(_INPBSaveParkingLocationIntentResponse *)self parkingLocation];
