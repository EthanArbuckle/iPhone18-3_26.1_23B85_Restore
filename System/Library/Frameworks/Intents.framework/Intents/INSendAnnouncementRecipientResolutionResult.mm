...
{
  v10.receiver = self;
  v10.super_class = INSendAnnouncementRecipientResolutionResult;
  ...
  if ([(INIntentResolutionResult *)self resolutionResultCode]== 1 && [(INIntentResolutionResult *)self unsupportedReason])
  {
    ...
    [payloadUnsupported2 setSendAnnouncementIntentRecipientsUnsupportedReason:v8];
  }
...
- (id)_initWithIntentSlotResolutionResult:(id)result slotDescription:(id)description
{
  resultCopy = result;
  v14.receiver = self;
  v14.super_class = INSendAnnouncementRecipientResolutionResult;
  ...
  if (v7)
  {
    ...
    hasSendAnnouncementIntentRecipientsUnsupportedReason = [payloadUnsupported hasSendAnnouncementIntentRecipientsUnsupportedReason];

    if (hasSendAnnouncementIntentRecipientsUnsupportedReason)
    {
      payloadUnsupported2 = [resultCopy payloadUnsupported];
      v11 = [payloadUnsupported2 sendAnnouncementIntentRecipientsUnsupportedReason] - 1;
      if (v11 < 4)
      {
        v12 = v11 + 1;
      }
