...
- (id)_initWithIntentSlotResolutionResult:(id)a3 slotDescription:(id)a4
{
  ...
  if (v7)
  {
    ...
    v9 = [v8 hasAddTasksIntentTargetTaskListMembersUnsupportedReason];

    if (v9)
    {
      v10 = [v6 payloadUnsupported];
      [v7 setUnsupportedReason:{objc_msgSend(v10, "addTasksIntentTargetTaskListMembersUnsupportedReason") == 1}];
    }
  }
