...
- (void)_redactForMissingPrivacyEntitlementOptions:(unint64_t)a3 containingAppBundleId:(id)a4
{
  v6 = [(INResumeTimerIntent *)self _typedBackingStore:a3];
  v5 = [v6 copy];
...
- (void)setResumeMultiple:(id)a3
{
  ...
  if (v5)
  {
    [v4 setResumeMultiple:{objc_msgSend(v5, "BOOLValue")}];
  }
...
- (NSNumber)resumeMultiple
{
  ...
  if ([v3 hasResumeMultiple])
  {
    ...
    v5 = [(INResumeTimerIntent *)self _typedBackingStore];
    v6 = [v4 numberWithBool:{objc_msgSend(v5, "resumeMultiple")}];
  }
...
{
  v4 = a3;
  v6 = [(INResumeTimerIntent *)self _typedBackingStore];
