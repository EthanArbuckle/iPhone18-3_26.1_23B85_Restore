...
- (id)dictionaryRepresentation
{
  ...
  v4 = [(_INPBDoubleList *)self conditionType];
...
- (BOOL)isEqual:(id)a3
{
  ...
  v7 = [(_INPBDoubleList *)self conditionType];
  if (v7)
  {
    v8 = v7;
    v9 = [(_INPBDoubleList *)self conditionType];
  ...
  if ((v5 != 0) != (v6 == 0))
  {
    v12 = [(_INPBDoubleList *)self dataStrings];
    if (!v12)
    {
...
LABEL_15:
    ...
    v13 = v12;
    v14 = [(_INPBDoubleList *)self dataStrings];
    v15 = [v4 dataStrings];
    v16 = [v14 isEqual:v15];
...
- (void)writeTo:(id)a3
{
  ...
  if (v5)
  {
    v6 = [(_INPBDoubleList *)self conditionType];
