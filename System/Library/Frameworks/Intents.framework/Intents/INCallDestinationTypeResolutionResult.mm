...
+ (INCallDestinationTypeResolutionResult)confirmationRequiredWithCallDestinationTypeToConfirm:(INCallDestinationType)callDestinationTypeToConfirm
{
  ...
  {
    v7 = [MEMORY[0x1E695DF30] exceptionWithName:*MEMORY[0x1E695D940] reason:@"Confirmation of INCallDestinationTypeUnknown is not supported." userInfo:0];
...
+ (INCallDestinationTypeResolutionResult)successWithResolvedCallDestinationType:(INCallDestinationType)resolvedCallDestinationType
{
  ...
  {
    NSLog(@"Success resolution with INCallDestinationTypeUnknown will be reformed to notRequired.", a2);
...
- (id)_vocabularyValueForObject:(id)object slotDescription:(id)description
{
  ...
  if (valueType == 70)
  {
    ...
    if (objc_opt_isKindOfClass())
    {
      ...
      {
        v10 = off_1E727FF40[integerValue - 1];
      }
...
- (id)_intentSlotValueForObject:(id)object slotDescription:(id)description
{
  ...
  if ([descriptionCopy valueType] == 70)
  {
