...
- (BOOL)isEqual:(id)a3
{
  ...
  v7 = [(_INPBConfigureHomeIntent *)self entities];
  if (v7)
  {
    v8 = v7;
  ...
  if ((v5 != 0) != (v6 == 0))
  {
    v12 = [(_INPBConfigureHomeIntent *)self intentMetadata];
    if (!v12)
    {
...
LABEL_15:
    ...
    v13 = v12;
    v14 = [(_INPBConfigureHomeIntent *)self intentMetadata];
...
{
  v4 = a3;
  v6 = [(_INPBConfigureHomeIntent *)self data];
