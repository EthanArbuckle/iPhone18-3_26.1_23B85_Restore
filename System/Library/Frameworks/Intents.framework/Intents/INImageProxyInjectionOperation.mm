...
{
  self->_isExecuting = 1;
  injector = [(INImageProxyInjectionOperation *)self injector];
  imageProxyRequestBlock = [(INImageProxyInjectionOperation *)self imageProxyRequestBlock];
  v5[0] = MEMORY[0x1E69E9820];
  v5[1] = 3221225472;
  v5[2] = __39__INImageProxyInjectionOperation_start__block_invoke;
  v5[3] = &unk_1E7285B78;
  v5[4] = self;
  [injector _injectProxiesForImages:imageProxyRequestBlock completion:v5];
}
