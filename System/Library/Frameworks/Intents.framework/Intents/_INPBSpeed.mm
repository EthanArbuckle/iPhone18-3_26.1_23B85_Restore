...
- (_INPBSpeed)initWithCoder:(id)coder;
...
- (BOOL)isEqual:(id)equal
{
  ...
  {
    values = [(_INPBSpeed *)self values];
    values2 = [equalCopy values];
    v7 = values2;
    if ((values != 0) != (values2 == 0))
    {
      values3 = [(_INPBSpeed *)self values];
      if (!values3)
      {
...
LABEL_10:
      ...
      v9 = values3;
      values4 = [(_INPBSpeed *)self values];
...
- (id)copyWithZone:(_NSZone *)zone
{
  v5 = [+[_INPBSpeed allocWithZone:](_INPBSpeed init];
...
- (_INPBSpeed)initWithCoder:(id)coder
{
  ...
  {
    self = [(_INPBSpeed *)self initWithData:selfCopy];
