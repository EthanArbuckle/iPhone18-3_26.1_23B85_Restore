...
- (BOOL)isEqual:(id)a3
{
  ...
  v7 = [(_INPBPaymentMethodList *)self condition];
  if (v7)
  {
    v8 = v7;
    v9 = [(_INPBPaymentMethodList *)self condition];
    v10 = [v4 condition];
    v11 = [v9 isEqual:v10];
  ...
  if ((v5 != 0) != (v6 == 0))
  {
    v12 = [(_INPBPaymentMethodList *)self paymentMethods];
    if (!v12)
    {
...
LABEL_15:
    ...
    v13 = v12;
    v14 = [(_INPBPaymentMethodList *)self paymentMethods];
...
{
  v4 = a3;
  v6 = [(_INPBPaymentMethodList *)self data];
...
- (void)writeTo:(id)a3
{
  ...
  if (v5)
  {
    v6 = [(_INPBPaymentMethodList *)self condition];
