...
- (id)_dictionaryRepresentation
{
  ...
  v12[0] = @"code";
  v3 = [(INFindDeviceAndPlaySoundIntentResponse *)self code];
  v4 = v3;
  if (v3 < 6)
  {
    v5 = *(&off_1E7287648 + v3);
  ...
  v12[1] = @"devicesFounds";
  v13[0] = v5;
  v7 = [(INFindDeviceAndPlaySoundIntentResponse *)self devicesFounds];
  v8 = v7;
  if (!v7)
  {
...
- (int64_t)_codeWithName:(id)a3
{
  ...
  v4 = [v3 isEqualToString:@"INFindDeviceAndPlaySoundIntentResponseCodeReady"];
  ...
  v6 = [v3 isEqualToString:@"INFindDeviceAndPlaySoundIntentResponseCodeFailureRequiringAppLaunch"];
...
- (int64_t)_intentResponseCode
{
  v2 = [(INFindDeviceAndPlaySoundIntentResponse *)self code];
  if ((v2 - 1) > 4)
  {
    return 0;
  }
