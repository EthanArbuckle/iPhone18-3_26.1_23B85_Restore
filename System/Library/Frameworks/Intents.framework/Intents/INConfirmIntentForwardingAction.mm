...
- (void)executeLocallyWithIntentDeliverer:(id)deliverer completionHandler:(id)handler
{
  ...
  v8 = [(INConfirmIntentForwardingAction *)self _completionHandlerWithActionCompletionHandler:handlerCopy];

  [delivererCopy confirmIntent:intent withCompletion:v8];
}
...
- (BOOL)executeRemotelyWithVendorRemote:(id)remote completionHandler:(id)handler
{
  ...
  handlerCopy = handler;
  v12.receiver = self;
  v12.super_class = INConfirmIntentForwardingAction;
  if (![(INIntentForwardingAction *)&v12 executeRemotelyWithVendorRemote:remoteCopy completionHandler:handlerCopy])
  {
    ...
    v10 = [(INConfirmIntentForwardingAction *)self _completionHandlerWithActionCompletionHandler:handlerCopy];
    [remoteCopy confirmIntent:v9 withCompletion:v10];
  }
