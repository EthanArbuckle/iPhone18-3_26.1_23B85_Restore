...
- (INAirline)initWithCoder:(id)coder;
...
- (id)descriptionAtIndent:(unint64_t)indent
{
  ...
  v11.receiver = self;
  v11.super_class = INAirline;
  v6 = [(INAirline *)&v11 description];
  _dictionaryRepresentation = [(INAirline *)self _dictionaryRepresentation];
...
- (INAirline)initWithName:(NSString *)name iataCode:(NSString *)iataCode icaoCode:(NSString *)icaoCode
{
  ...
  v10 = icaoCode;
  v19.receiver = self;
  v19.super_class = INAirline;
  v11 = [(INAirline *)&v19 init];
  if (v11)
  {
