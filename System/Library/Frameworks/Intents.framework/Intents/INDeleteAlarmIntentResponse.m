...
- (id)_dictionaryRepresentation
{
  ...
  v9 = @"code";
  v2 = [(INDeleteAlarmIntentResponse *)self code];
  v3 = v2;
  if (v2 < 6)
  {
    v4 = off_1E7288080[v2];
...
- (int64_t)_codeWithName:(id)a3
{
  ...
  v4 = [v3 isEqualToString:@"INDeleteAlarmIntentResponseCodeReady"];
  ...
  v6 = [v3 isEqualToString:@"INDeleteAlarmIntentResponseCodeFailureRequiringAppLaunch"];
