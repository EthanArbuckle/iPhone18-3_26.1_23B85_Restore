...
+ (INTaskStatusResolutionResult)confirmationRequiredWithTaskStatusToConfirm:(INTaskStatus)taskStatusToConfirm
{
  ...
  {
    v7 = [MEMORY[0x1E695DF30] exceptionWithName:*MEMORY[0x1E695D940] reason:@"Confirmation of INTaskStatusUnknown is not supported." userInfo:0];
...
+ (INTaskStatusResolutionResult)successWithResolvedTaskStatus:(INTaskStatus)resolvedTaskStatus
{
  ...
  {
    NSLog(@"Success resolution with INTaskStatusUnknown will be reformed to notRequired.", a2);
...
- (id)_intentSlotValueForObject:(id)object slotDescription:(id)description
{
  ...
  if ([descriptionCopy valueType] == 128)
  {
