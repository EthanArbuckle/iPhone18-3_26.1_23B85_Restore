...
{
  v11.receiver = self;
  v11.super_class = INSnoozeAlarmAlarmResolutionResult;
  ...
  if ([(INIntentResolutionResult *)self resolutionResultCode]== 1 && [(INIntentResolutionResult *)self unsupportedReason])
  {
    ...
    [payloadUnsupported2 setSnoozeAlarmIntentAlarmsUnsupportedReason:v9];
  }
...
- (id)_initWithIntentSlotResolutionResult:(id)result slotDescription:(id)description
{
  resultCopy = result;
  v14.receiver = self;
  v14.super_class = INSnoozeAlarmAlarmResolutionResult;
  ...
  if (v7)
  {
    ...
    hasSnoozeAlarmIntentAlarmsUnsupportedReason = [payloadUnsupported hasSnoozeAlarmIntentAlarmsUnsupportedReason];

    if (hasSnoozeAlarmIntentAlarmsUnsupportedReason)
    {
      payloadUnsupported2 = [resultCopy payloadUnsupported];
      snoozeAlarmIntentAlarmsUnsupportedReason = [payloadUnsupported2 snoozeAlarmIntentAlarmsUnsupportedReason];
      if (snoozeAlarmIntentAlarmsUnsupportedReason)
      {
        v12 = 2 * (snoozeAlarmIntentAlarmsUnsupportedReason == 1);
      }
