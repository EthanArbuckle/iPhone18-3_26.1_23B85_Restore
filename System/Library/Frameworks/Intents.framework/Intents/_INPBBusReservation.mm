...
- (BOOL)isEqual:(id)a3
{
  ...
  v7 = [(_INPBBusReservation *)self busTrip];
  if (v7)
  {
    v8 = v7;
  ...
  v12 = [(_INPBBusReservation *)self reservation];
  if (v12)
  {
    v13 = v12;
  ...
  if ((v5 != 0) != (v6 == 0))
  {
    v17 = [(_INPBBusReservation *)self reservedSeat];
    if (!v17)
    {
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v6 = [(_INPBBusTrip *)self->_busTrip copyWithZone:a3];
...
{
  v4 = a3;
  v6 = [(_INPBBusReservation *)self data];
...
- (void)writeTo:(id)a3
{
  ...
  if (v6)
  {
    v7 = [(_INPBBusReservation *)self reservation];
    PBDataWriterWriteSubmessage();
  }
  ...
  if (v8)
  {
    v10 = [(_INPBBusReservation *)self reservedSeat];
    PBDataWriterWriteSubmessage();
