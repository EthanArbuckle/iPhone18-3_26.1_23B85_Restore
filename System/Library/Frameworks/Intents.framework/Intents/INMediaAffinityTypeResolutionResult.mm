...
+ (INMediaAffinityTypeResolutionResult)confirmationRequiredWithMediaAffinityTypeToConfirm:(INMediaAffinityType)mediaAffinityTypeToConfirm
{
  ...
  {
    v7 = [MEMORY[0x1E695DF30] exceptionWithName:*MEMORY[0x1E695D940] reason:@"Confirmation of INMediaAffinityTypeUnknown is not supported." userInfo:0];
...
+ (INMediaAffinityTypeResolutionResult)successWithResolvedMediaAffinityType:(INMediaAffinityType)resolvedMediaAffinityType
{
  ...
  {
    NSLog(@"Success resolution with INMediaAffinityTypeUnknown will be reformed to notRequired.", a2);
...
- (id)_intentSlotValueForObject:(id)object slotDescription:(id)description
{
  ...
  if ([descriptionCopy valueType] == 158)
  {
