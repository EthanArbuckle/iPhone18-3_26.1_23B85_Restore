...
- (id)_dictionaryRepresentation
{
  ...
  v9 = @"code";
  v2 = [(INPauseWorkoutIntentResponse *)self code];
  v3 = v2;
  if (v2 < 8)
  {
    v4 = off_1E7283680[v2];
...
- (int64_t)_codeWithName:(id)a3
{
  ...
  v4 = [v3 isEqualToString:@"INPauseWorkoutIntentResponseCodeReady"];
  ...
  if ([v3 isEqualToString:@"INPauseWorkoutIntentResponseCodeFailureRequiringAppLaunch"])
  {
    v5 = 4;
  }
  ...
  v6 = [v3 isEqualToString:@"INPauseWorkoutIntentResponseCodeFailureNoMatchingWorkout"];
