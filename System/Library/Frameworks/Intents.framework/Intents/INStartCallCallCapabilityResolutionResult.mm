...
{
  v10.receiver = self;
  v10.super_class = INStartCallCallCapabilityResolutionResult;
  ...
  if ([(INIntentResolutionResult *)self resolutionResultCode]== 1 && [(INIntentResolutionResult *)self unsupportedReason])
  {
    ...
    [payloadUnsupported2 setStartCallIntentCallCapabilityUnsupportedReason:v8];
  }
...
- (id)_initWithIntentSlotResolutionResult:(id)result slotDescription:(id)description
{
  resultCopy = result;
  v14.receiver = self;
  v14.super_class = INStartCallCallCapabilityResolutionResult;
  ...
  if (v7)
  {
    ...
    hasStartCallIntentCallCapabilityUnsupportedReason = [payloadUnsupported hasStartCallIntentCallCapabilityUnsupportedReason];

    if (hasStartCallIntentCallCapabilityUnsupportedReason)
    {
      payloadUnsupported2 = [resultCopy payloadUnsupported];
      v11 = [payloadUnsupported2 startCallIntentCallCapabilityUnsupportedReason] - 1;
      if (v11 < 3)
      {
        v12 = v11 + 1;
      }
