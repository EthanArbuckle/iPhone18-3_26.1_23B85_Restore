...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v5 = [(MTRUnitTestingClusterTestListInt8UReverseRequestParams *)self arg1];
  [(MTRUnitTestingClusterTestListInt8UReverseRequestParams *)v4 setArg1:v5];

  v6 = [(MTRUnitTestingClusterTestListInt8UReverseRequestParams *)self timedInvokeTimeoutMs];
  [(MTRUnitTestingClusterTestListInt8UReverseRequestParams *)v4 setTimedInvokeTimeoutMs:v6];

  v7 = [(MTRUnitTestingClusterTestListInt8UReverseRequestParams *)self serverSideProcessingTimeout];
  [(MTRUnitTestingClusterTestListInt8UReverseRequestParams *)v4 setServerSideProcessingTimeout:v7];
...
- (ChipError)_encodeToTLVReader:(PacketBufferTLVReader *)a3
{
  ...
  v17[1] = 0;
  v16 = v17;
  v4 = [(MTRUnitTestingClusterTestListInt8UReverseRequestParams *)self arg1];
  v5 = [v4 count] == 0;
