...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v5 = [(MTRTimeSynchronizationClusterSetTimeZoneParams *)self timeZone];
  [(MTRTimeSynchronizationClusterSetTimeZoneParams *)v4 setTimeZone:v5];

  v6 = [(MTRTimeSynchronizationClusterSetTimeZoneParams *)self timedInvokeTimeoutMs];
  [(MTRTimeSynchronizationClusterSetTimeZoneParams *)v4 setTimedInvokeTimeoutMs:v6];

  v7 = [(MTRTimeSynchronizationClusterSetTimeZoneParams *)self serverSideProcessingTimeout];
  [(MTRTimeSynchronizationClusterSetTimeZoneParams *)v4 setServerSideProcessingTimeout:v7];
...
- (ChipError)_encodeToTLVReader:(PacketBufferTLVReader *)a3
{
  ...
  v17[1] = 0;
  v16 = v17;
  v3 = [(MTRTimeSynchronizationClusterSetTimeZoneParams *)self timeZone];
  v4 = [v3 count] == 0;
