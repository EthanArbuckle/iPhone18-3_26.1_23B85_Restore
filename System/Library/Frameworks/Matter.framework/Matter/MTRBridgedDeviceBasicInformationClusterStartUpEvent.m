...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v5 = [(MTRBridgedDeviceBasicInformationClusterStartUpEvent *)self softwareVersion];
  [(MTRBridgedDeviceBasicInformationClusterStartUpEvent *)v4 setSoftwareVersion:v5];
