...
{
  v9.receiver = self;
  v9.super_class = MTRMediaPlaybackClusterActivateAudioTrackParams;
  ...
  if (v2)
  {
    ...
    v3->_audioOutputIndex = &unk_284C3E4C8;
...
- (id)description
{
  ...
  v6 = [v3 stringWithFormat:@"<%@: trackID:%@ audioOutputIndex:%@; >", v5, self->_trackID, self->_audioOutputIndex];;
...
- (ChipError)_encodeToTLVReader:(PacketBufferTLVReader *)reader
{
  ...
  if (v20)
  {
    ...
    v7 = sub_238F1E2A4(&v23, v15, 0x100uLL);
    v9 = v7;
