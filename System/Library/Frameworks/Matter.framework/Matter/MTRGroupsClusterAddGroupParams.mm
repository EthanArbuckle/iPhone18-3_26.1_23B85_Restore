...
- (id)copyWithZone:(_NSZone *)zone
{
  ...
  groupID = [(MTRGroupsClusterAddGroupParams *)self groupID];
  [(MTRGroupsClusterAddGroupParams *)v4 setGroupID:groupID];

  groupName = [(MTRGroupsClusterAddGroupParams *)self groupName];
  [(MTRGroupsClusterAddGroupParams *)v4 setGroupName:groupName];

  timedInvokeTimeoutMs = [(MTRGroupsClusterAddGroupParams *)self timedInvokeTimeoutMs];
  [(MTRGroupsClusterAddGroupParams *)v4 setTimedInvokeTimeoutMs:timedInvokeTimeoutMs];

  serverSideProcessingTimeout = [(MTRGroupsClusterAddGroupParams *)self serverSideProcessingTimeout];
  [(MTRGroupsClusterAddGroupParams *)v4 setServerSideProcessingTimeout:serverSideProcessingTimeout];
