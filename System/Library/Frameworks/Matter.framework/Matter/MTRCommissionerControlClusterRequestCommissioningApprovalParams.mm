...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v5 = [(MTRCommissionerControlClusterRequestCommissioningApprovalParams *)self requestID];
  [(MTRCommissionerControlClusterRequestCommissioningApprovalParams *)v4 setRequestID:v5];

  v6 = [(MTRCommissionerControlClusterRequestCommissioningApprovalParams *)self vendorID];
  [(MTRCommissionerControlClusterRequestCommissioningApprovalParams *)v4 setVendorID:v6];

  v7 = [(MTRCommissionerControlClusterRequestCommissioningApprovalParams *)self productID];
  [(MTRCommissionerControlClusterRequestCommissioningApprovalParams *)v4 setProductID:v7];

  v8 = [(MTRCommissionerControlClusterRequestCommissioningApprovalParams *)self label];
  [(MTRCommissionerControlClusterRequestCommissioningApprovalParams *)v4 setLabel:v8];

  v9 = [(MTRCommissionerControlClusterRequestCommissioningApprovalParams *)self timedInvokeTimeoutMs];
  [(MTRCommissionerControlClusterRequestCommissioningApprovalParams *)v4 setTimedInvokeTimeoutMs:v9];

  v10 = [(MTRCommissionerControlClusterRequestCommissioningApprovalParams *)self serverSideProcessingTimeout];
  [(MTRCommissionerControlClusterRequestCommissioningApprovalParams *)v4 setServerSideProcessingTimeout:v10];
...
- (ChipError)_encodeToTLVReader:(PacketBufferTLVReader *)a3
{
  ...
  v24 = v25;
  v5 = [(MTRCommissionerControlClusterRequestCommissioningApprovalParams *)self requestID];
  v26 = [v5 unsignedLongLongValue];

  v6 = [(MTRCommissionerControlClusterRequestCommissioningApprovalParams *)self vendorID];
  LOWORD(v27) = [v6 unsignedShortValue];

  v7 = [(MTRCommissionerControlClusterRequestCommissioningApprovalParams *)self productID];
  HIWORD(v27) = [v7 unsignedShortValue];
  ...
  if (v8)
  {
    v28 = 1;
    v29 = 0uLL;
    v9 = [(MTRCommissionerControlClusterRequestCommissioningApprovalParams *)self label];
  ...
  if (v23)
  {
    ...
    v10 = sub_238F0A2EC(&v26, v18, 0x100uLL);
    v12 = v10;
