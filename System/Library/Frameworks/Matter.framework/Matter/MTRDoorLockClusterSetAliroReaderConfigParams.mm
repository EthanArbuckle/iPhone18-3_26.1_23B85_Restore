...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v5 = [(MTRDoorLockClusterSetAliroReaderConfigParams *)self signingKey];
  [(MTRDoorLockClusterSetAliroReaderConfigParams *)v4 setSigningKey:v5];

  v6 = [(MTRDoorLockClusterSetAliroReaderConfigParams *)self verificationKey];
  [(MTRDoorLockClusterSetAliroReaderConfigParams *)v4 setVerificationKey:v6];

  v7 = [(MTRDoorLockClusterSetAliroReaderConfigParams *)self groupIdentifier];
  [(MTRDoorLockClusterSetAliroReaderConfigParams *)v4 setGroupIdentifier:v7];

  v8 = [(MTRDoorLockClusterSetAliroReaderConfigParams *)self groupResolvingKey];
  [(MTRDoorLockClusterSetAliroReaderConfigParams *)v4 setGroupResolvingKey:v8];

  v9 = [(MTRDoorLockClusterSetAliroReaderConfigParams *)self timedInvokeTimeoutMs];
  [(MTRDoorLockClusterSetAliroReaderConfigParams *)v4 setTimedInvokeTimeoutMs:v9];

  v10 = [(MTRDoorLockClusterSetAliroReaderConfigParams *)self serverSideProcessingTimeout];
  [(MTRDoorLockClusterSetAliroReaderConfigParams *)v4 setServerSideProcessingTimeout:v10];
...
- (ChipError)_encodeToTLVReader:(PacketBufferTLVReader *)a3
{
  ...
  if (v8)
  {
    v29 = 1;
    v30 = 0uLL;
    v9 = [(MTRDoorLockClusterSetAliroReaderConfigParams *)self groupResolvingKey];
