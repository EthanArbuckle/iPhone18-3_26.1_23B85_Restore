...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v5 = [(MTRAccountLoginClusterLogoutParams *)self node];
  [(MTRAccountLoginClusterLogoutParams *)v4 setNode:v5];

  v6 = [(MTRAccountLoginClusterLogoutParams *)self timedInvokeTimeoutMs];
  [(MTRAccountLoginClusterLogoutParams *)v4 setTimedInvokeTimeoutMs:v6];

  v7 = [(MTRAccountLoginClusterLogoutParams *)self serverSideProcessingTimeout];
  [(MTRAccountLoginClusterLogoutParams *)v4 setServerSideProcessingTimeout:v7];
...
- (ChipError)_encodeToTLVReader:(PacketBufferTLVReader *)a3
{
  ...
  if (v5)
  {
    v23[0] = 1;
    v24 = 0;
    v6 = [(MTRAccountLoginClusterLogoutParams *)self node];
