...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v5 = [(MTRLevelControlClusterMoveWithOnOffParams *)self moveMode];
  [(MTRLevelControlClusterMoveWithOnOffParams *)v4 setMoveMode:v5];

  v6 = [(MTRLevelControlClusterMoveWithOnOffParams *)self rate];
  [(MTRLevelControlClusterMoveWithOnOffParams *)v4 setRate:v6];

  v7 = [(MTRLevelControlClusterMoveWithOnOffParams *)self optionsMask];
  [(MTRLevelControlClusterMoveWithOnOffParams *)v4 setOptionsMask:v7];

  v8 = [(MTRLevelControlClusterMoveWithOnOffParams *)self optionsOverride];
  [(MTRLevelControlClusterMoveWithOnOffParams *)v4 setOptionsOverride:v8];

  v9 = [(MTRLevelControlClusterMoveWithOnOffParams *)self timedInvokeTimeoutMs];
  [(MTRLevelControlClusterMoveWithOnOffParams *)v4 setTimedInvokeTimeoutMs:v9];

  v10 = [(MTRLevelControlClusterMoveWithOnOffParams *)self serverSideProcessingTimeout];
  [(MTRLevelControlClusterMoveWithOnOffParams *)v4 setServerSideProcessingTimeout:v10];
...
- (ChipError)_encodeToTLVReader:(PacketBufferTLVReader *)a3
{
  ...
  {
    *(&v26 + 1) = 256;
    v7 = [(MTRLevelControlClusterMoveWithOnOffParams *)self rate];
    BYTE1(v26) = [v7 unsignedCharValue];
  }

  v8 = [(MTRLevelControlClusterMoveWithOnOffParams *)self optionsMask];
  HIBYTE(v26) = [v8 unsignedCharValue];

  v9 = [(MTRLevelControlClusterMoveWithOnOffParams *)self optionsOverride];
