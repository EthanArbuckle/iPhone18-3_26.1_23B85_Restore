...
- (id)copyWithZone:(_NSZone *)zone
{
  ...
  mfgCode = [(MTRLaundryWasherModeClusterModeTagStruct *)self mfgCode];
  [(MTRLaundryWasherModeClusterModeTagStruct *)v4 setMfgCode:mfgCode];

  value = [(MTRLaundryWasherModeClusterModeTagStruct *)self value];
  [(MTRLaundryWasherModeClusterModeTagStruct *)v4 setValue:value];
