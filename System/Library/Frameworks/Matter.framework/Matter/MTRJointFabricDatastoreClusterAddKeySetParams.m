...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v5 = [(MTRJointFabricDatastoreClusterAddKeySetParams *)self groupKeySet];
  [(MTRJointFabricDatastoreClusterAddKeySetParams *)v4 setGroupKeySet:v5];

  v6 = [(MTRJointFabricDatastoreClusterAddKeySetParams *)self timedInvokeTimeoutMs];
  [(MTRJointFabricDatastoreClusterAddKeySetParams *)v4 setTimedInvokeTimeoutMs:v6];

  v7 = [(MTRJointFabricDatastoreClusterAddKeySetParams *)self serverSideProcessingTimeout];
  [(MTRJointFabricDatastoreClusterAddKeySetParams *)v4 setServerSideProcessingTimeout:v7];
...
- (ChipError)_encodeToTLVReader:(PacketBufferTLVReader *)a3
{
  ...
  v7 = [(MTRJointFabricDatastoreClusterAddKeySetParams *)self groupKeySet];
  v8 = [v7 groupKeySecurityPolicy];
  v52 = [v8 unsignedCharValue];

  v9 = [(MTRJointFabricDatastoreClusterAddKeySetParams *)self groupKeySet];
  v10 = [v9 epochKey0];
  ...
  if (v10)
  {
    v53 = 0uLL;
    v54 = 1;
    v11 = [(MTRJointFabricDatastoreClusterAddKeySetParams *)self groupKeySet];
    v12 = [v11 epochKey0];
  ...
  v13 = [(MTRJointFabricDatastoreClusterAddKeySetParams *)self groupKeySet];
  ...
  if (v14)
  {
    v55 = 0;
    v56 = 1;
    v15 = [(MTRJointFabricDatastoreClusterAddKeySetParams *)self groupKeySet];
    v16 = [v15 epochStartTime0];
    v55 = [v16 unsignedLongLongValue];
  }

  v17 = [(MTRJointFabricDatastoreClusterAddKeySetParams *)self groupKeySet];
  v18 = [v17 epochKey1];
  ...
  if (v18)
  {
    v57 = 0uLL;
    v58 = 1;
    v19 = [(MTRJointFabricDatastoreClusterAddKeySetParams *)self groupKeySet];
    v20 = [v19 epochKey1];
  ...
  v21 = [(MTRJointFabricDatastoreClusterAddKeySetParams *)self groupKeySet];
  ...
  if (v22)
  {
    v59 = 0;
    v60 = 1;
    v23 = [(MTRJointFabricDatastoreClusterAddKeySetParams *)self groupKeySet];
    v24 = [v23 epochStartTime1];
    v59 = [v24 unsignedLongLongValue];
  }

  v25 = [(MTRJointFabricDatastoreClusterAddKeySetParams *)self groupKeySet];
  v26 = [v25 epochKey2];
  ...
  if (v26)
  {
    v61 = 0uLL;
    v62 = 1;
    v27 = [(MTRJointFabricDatastoreClusterAddKeySetParams *)self groupKeySet];
    v28 = [v27 epochKey2];
  ...
  v29 = [(MTRJointFabricDatastoreClusterAddKeySetParams *)self groupKeySet];
  ...
  if (v30)
  {
    v63 = 0;
    v64 = 1;
    v31 = [(MTRJointFabricDatastoreClusterAddKeySetParams *)self groupKeySet];
    v32 = [v31 epochStartTime2];
    v63 = [v32 unsignedLongLongValue];
  }

  v33 = [(MTRJointFabricDatastoreClusterAddKeySetParams *)self groupKeySet];
