...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v5 = [(MTROperationalCredentialsClusterAttestationRequestParams *)self attestationNonce];
  [(MTROperationalCredentialsClusterAttestationRequestParams *)v4 setAttestationNonce:v5];

  v6 = [(MTROperationalCredentialsClusterAttestationRequestParams *)self timedInvokeTimeoutMs];
  [(MTROperationalCredentialsClusterAttestationRequestParams *)v4 setTimedInvokeTimeoutMs:v6];

  v7 = [(MTROperationalCredentialsClusterAttestationRequestParams *)self serverSideProcessingTimeout];
  [(MTROperationalCredentialsClusterAttestationRequestParams *)v4 setServerSideProcessingTimeout:v7];
...
- (ChipError)_encodeToTLVReader:(PacketBufferTLVReader *)a3
{
  ...
  v20[1] = 0;
  v19 = v20;
  v4 = [(MTROperationalCredentialsClusterAttestationRequestParams *)self attestationNonce];
