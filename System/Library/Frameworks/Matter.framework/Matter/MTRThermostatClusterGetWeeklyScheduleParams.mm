...
{
  v9.receiver = self;
  v9.super_class = MTRThermostatClusterGetWeeklyScheduleParams;
  v2 = [(MTRThermostatClusterGetWeeklyScheduleParams *)&v9 init];
  v3 = v2;
  if (v2)
  {
    daysToReturn = v2->_daysToReturn;
    v2->_daysToReturn = &unk_284C3E4C8;

    modeToReturn = v3->_modeToReturn;
    v3->_modeToReturn = &unk_284C3E4C8;
...
- (id)description
{
  ...
  v6 = [v3 stringWithFormat:@"<%@: daysToReturn:%@ modeToReturn:%@; >", v5, self->_daysToReturn, self->_modeToReturn];;
