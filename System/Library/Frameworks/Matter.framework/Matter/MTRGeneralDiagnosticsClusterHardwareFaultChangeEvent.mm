...
- (id)copyWithZone:(_NSZone *)zone
{
  ...
  current = [(MTRGeneralDiagnosticsClusterHardwareFaultChangeEvent *)self current];
  [(MTRGeneralDiagnosticsClusterHardwareFaultChangeEvent *)v4 setCurrent:current];

  previous = [(MTRGeneralDiagnosticsClusterHardwareFaultChangeEvent *)self previous];
  [(MTRGeneralDiagnosticsClusterHardwareFaultChangeEvent *)v4 setPrevious:previous];
