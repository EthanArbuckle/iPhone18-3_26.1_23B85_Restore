...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v6 = [(MTRColorControlClusterMoveToHueAndSaturationParams *)self saturation];
  [(MTRColorControlClusterMoveToHueAndSaturationParams *)v4 setSaturation:v6];

  v7 = [(MTRColorControlClusterMoveToHueAndSaturationParams *)self transitionTime];
  [(MTRColorControlClusterMoveToHueAndSaturationParams *)v4 setTransitionTime:v7];

  v8 = [(MTRColorControlClusterMoveToHueAndSaturationParams *)self optionsMask];
  [(MTRColorControlClusterMoveToHueAndSaturationParams *)v4 setOptionsMask:v8];

  v9 = [(MTRColorControlClusterMoveToHueAndSaturationParams *)self optionsOverride];
  [(MTRColorControlClusterMoveToHueAndSaturationParams *)v4 setOptionsOverride:v9];

  v10 = [(MTRColorControlClusterMoveToHueAndSaturationParams *)self timedInvokeTimeoutMs];
  [(MTRColorControlClusterMoveToHueAndSaturationParams *)v4 setTimedInvokeTimeoutMs:v10];

  v11 = [(MTRColorControlClusterMoveToHueAndSaturationParams *)self serverSideProcessingTimeout];
  [(MTRColorControlClusterMoveToHueAndSaturationParams *)v4 setServerSideProcessingTimeout:v11];
...
- (ChipError)_encodeToTLVReader:(PacketBufferTLVReader *)a3
{
  ...
  v7 = [(MTRColorControlClusterMoveToHueAndSaturationParams *)self transitionTime];
  HIWORD(v26) = [v7 unsignedShortValue];

  v8 = [(MTRColorControlClusterMoveToHueAndSaturationParams *)self optionsMask];
  LOBYTE(v27) = [v8 unsignedCharValue];

  v9 = [(MTRColorControlClusterMoveToHueAndSaturationParams *)self optionsOverride];
  HIBYTE(v27) = [v9 unsignedCharValue];
