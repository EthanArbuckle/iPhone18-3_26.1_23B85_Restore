...
{
  v9.receiver = self;
  v9.super_class = MTRTemperatureControlClusterSetTemperatureParams;
...
- (id)description
{
  ...
  v6 = [v3 stringWithFormat:@"<%@: targetTemperature:%@ targetTemperatureLevel:%@; >", v5, self->_targetTemperature, self->_targetTemperatureLevel];;
...
- (ChipError)_encodeToTLVReader:(PacketBufferTLVReader *)a3
{
  ...
  if (v22)
  {
    ...
    v9 = sub_238F29104(v25, v17, 0x100uLL);
    v11 = v9;
