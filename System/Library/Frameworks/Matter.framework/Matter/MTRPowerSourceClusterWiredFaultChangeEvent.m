...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v5 = [(MTRPowerSourceClusterWiredFaultChangeEvent *)self current];
  [(MTRPowerSourceClusterWiredFaultChangeEvent *)v4 setCurrent:v5];

  v6 = [(MTRPowerSourceClusterWiredFaultChangeEvent *)self previous];
  [(MTRPowerSourceClusterWiredFaultChangeEvent *)v4 setPrevious:v6];
