...
- (id)copyWithZone:(_NSZone *)zone
{
  ...
  current = [(MTRPowerSourceClusterWiredFaultChangeType *)self current];
  [(MTRPowerSourceClusterWiredFaultChangeType *)v4 setCurrent:current];

  previous = [(MTRPowerSourceClusterWiredFaultChangeType *)self previous];
  [(MTRPowerSourceClusterWiredFaultChangeType *)v4 setPrevious:previous];
