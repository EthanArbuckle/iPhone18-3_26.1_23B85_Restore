...
- (id)copyWithZone:(_NSZone *)zone
{
  ...
  alarmSeverityLevel = [(MTRSmokeCOAlarmClusterLowBatteryEvent *)self alarmSeverityLevel];
  [(MTRSmokeCOAlarmClusterLowBatteryEvent *)v4 setAlarmSeverityLevel:alarmSeverityLevel];
