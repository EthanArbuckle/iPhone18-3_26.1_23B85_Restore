...
{
  v6.receiver = self;
  v6.super_class = MTRTLSClientManagementClusterProvisionEndpointResponseParams;
  v2 = [(MTRTLSClientManagementClusterProvisionEndpointResponseParams *)&v6 init];
  v3 = v2;
  if (v2)
  {
...
- (id)description
{
  ...
  v6 = [v3 stringWithFormat:@"<%@: endpointID:%@ >", v5, self->_endpointID];;
...
- (MTRTLSClientManagementClusterProvisionEndpointResponseParams)initWithResponseValue:(id)a3 error:(id *)a4
{
  ...
  if (v14)
  {
    ...
    if (!v8)
    {
      ...
      if (!v8)
      {
        v8 = [(MTRTLSClientManagementClusterProvisionEndpointResponseParams *)v7 _setFieldsFromDecodableStruct:&v12];
        if (!v8)
        {
          v10 = v7;
          goto LABEL_8;
...
- (MTRTLSClientManagementClusterProvisionEndpointResponseParams)initWithDecodableStruct:(const DecodableType *)a3
{
  ...
  v4 = [(MTRTLSClientManagementClusterProvisionEndpointResponseParams *)&v10 init];
  v5 = v4;
  if (v4)
  {
