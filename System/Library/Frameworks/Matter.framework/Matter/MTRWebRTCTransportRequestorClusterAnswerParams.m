...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v5 = [(MTRWebRTCTransportRequestorClusterAnswerParams *)self webRTCSessionID];
  [(MTRWebRTCTransportRequestorClusterAnswerParams *)v4 setWebRTCSessionID:v5];

  v6 = [(MTRWebRTCTransportRequestorClusterAnswerParams *)self sdp];
  [(MTRWebRTCTransportRequestorClusterAnswerParams *)v4 setSdp:v6];

  v7 = [(MTRWebRTCTransportRequestorClusterAnswerParams *)self timedInvokeTimeoutMs];
  [(MTRWebRTCTransportRequestorClusterAnswerParams *)v4 setTimedInvokeTimeoutMs:v7];

  v8 = [(MTRWebRTCTransportRequestorClusterAnswerParams *)self serverSideProcessingTimeout];
  [(MTRWebRTCTransportRequestorClusterAnswerParams *)v4 setServerSideProcessingTimeout:v8];
