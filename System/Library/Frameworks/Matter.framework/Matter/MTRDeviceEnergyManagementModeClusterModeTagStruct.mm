...
- (id)copyWithZone:(_NSZone *)zone
{
  ...
  mfgCode = [(MTRDeviceEnergyManagementModeClusterModeTagStruct *)self mfgCode];
  [(MTRDeviceEnergyManagementModeClusterModeTagStruct *)v4 setMfgCode:mfgCode];

  value = [(MTRDeviceEnergyManagementModeClusterModeTagStruct *)self value];
  [(MTRDeviceEnergyManagementModeClusterModeTagStruct *)v4 setValue:value];
