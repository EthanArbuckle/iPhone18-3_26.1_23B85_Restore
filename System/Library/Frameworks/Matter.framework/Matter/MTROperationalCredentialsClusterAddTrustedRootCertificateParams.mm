...
- (id)copyWithZone:(_NSZone *)zone
{
  ...
  rootCACertificate = [(MTROperationalCredentialsClusterAddTrustedRootCertificateParams *)self rootCACertificate];
  [(MTROperationalCredentialsClusterAddTrustedRootCertificateParams *)v4 setRootCACertificate:rootCACertificate];

  timedInvokeTimeoutMs = [(MTROperationalCredentialsClusterAddTrustedRootCertificateParams *)self timedInvokeTimeoutMs];
  [(MTROperationalCredentialsClusterAddTrustedRootCertificateParams *)v4 setTimedInvokeTimeoutMs:timedInvokeTimeoutMs];

  serverSideProcessingTimeout = [(MTROperationalCredentialsClusterAddTrustedRootCertificateParams *)self serverSideProcessingTimeout];
  [(MTROperationalCredentialsClusterAddTrustedRootCertificateParams *)v4 setServerSideProcessingTimeout:serverSideProcessingTimeout];
...
- (ChipError)_encodeToTLVReader:(PacketBufferTLVReader *)reader
{
  ...
  v19 = v20;
  rootCACertificate = [(MTROperationalCredentialsClusterAddTrustedRootCertificateParams *)self rootCACertificate];
  sub_238DB6950(v13, [rootCACertificate bytes], objc_msgSend(rootCACertificate, "length"));
