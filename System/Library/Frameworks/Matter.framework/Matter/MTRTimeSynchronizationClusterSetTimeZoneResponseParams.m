...
- (MTRTimeSynchronizationClusterSetTimeZoneResponseParams)initWithDecodableStruct:(const DecodableType *)a3;
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v5 = [(MTRTimeSynchronizationClusterSetTimeZoneResponseParams *)self dstOffsetRequired];
  [(MTRTimeSynchronizationClusterSetTimeZoneResponseParams *)v4 setDstOffsetRequired:v5];
...
- (MTRTimeSynchronizationClusterSetTimeZoneResponseParams)initWithResponseValue:(id)a3 error:(id *)a4
{
  ...
  [MTRBaseDevice _responseDataForCommand:v6 clusterID:56 commandID:3 error:a4];
  if (v14)
  {
    sub_2393C5AAC(v13);
...
- (MTRTimeSynchronizationClusterSetTimeZoneResponseParams)initWithDecodableStruct:(const DecodableType *)a3
{
  ...
  if (v4)
  {
    v6 = [(MTRTimeSynchronizationClusterSetTimeZoneResponseParams *)v4 _setFieldsFromDecodableStruct:a3];
    if (!v6)
    {
      v8 = v5;
      goto LABEL_6;
