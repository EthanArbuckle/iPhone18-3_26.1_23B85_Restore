...
- (MTROptionalQRCodeInfo)initWithTag:(id)a3 stringValue:(id)a4
{
  ...
  v8->_info.type = 1;
  v8->_info.tag = sub_2392DFAF8(v6);
  if (!v7)
  {
    sub_23921D8FC(@"value");
  }

  MEMORY[0x23EE77A00](&v8->_info.data, [v7 UTF8String]);
...
- (id)description
{
  ...
  v6 = [(MTROptionalQRCodeInfo *)self integerValue];
  v7 = v6;
  if (!v6)
  {
    v7 = [(MTROptionalQRCodeInfo *)self stringValue];
  }

  v8 = [v3 stringWithFormat:@"0x%02x=%@", v5, v7];
  if (!v6)
  {
  }
...
- (NSNumber)infoType
{
  ...
  v3 = [(MTROptionalQRCodeInfo *)self type];
