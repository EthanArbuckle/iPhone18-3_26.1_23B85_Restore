...
{
  v7.receiver = self;
  v7.super_class = MTRUnitTestingClusterTestEmitTestEventResponseParams;
...
- (id)description
{
  ...
  v6 = [v3 stringWithFormat:@"<%@: value:%@ >", v5, self->_value];;
...
- (MTRUnitTestingClusterTestEmitTestEventResponseParams)initWithResponseValue:(NSDictionary *)responseValue error:(NSError *)error
{
  v6 = responseValue;
  v15.receiver = self;
  v15.super_class = MTRUnitTestingClusterTestEmitTestEventResponseParams;
  v7 = [(MTRUnitTestingClusterTestEmitTestEventResponseParams *)&v15 init];
  if (!v7)
  {
    v10 = 0;
    goto LABEL_10;
  ...
  [MTRBaseDevice _responseDataForCommand:v6 clusterID:4294048773 commandID:10 error:error];
  if (v14)
  {
    sub_2393C5AAC(v13);
    ...
    if (!v8)
    {
      ...
      if (!v8)
      {
        v8 = [(MTRUnitTestingClusterTestEmitTestEventResponseParams *)v7 _setFieldsFromDecodableStruct:&v12];
        if (!v8)
        {
          v10 = v7;
          goto LABEL_8;
...
- (MTRUnitTestingClusterTestEmitTestEventResponseParams)initWithDecodableStruct:(const DecodableType *)struct
{
  ...
  v4 = [(MTRUnitTestingClusterTestEmitTestEventResponseParams *)&v10 init];
  v5 = v4;
  if (v4)
  {
