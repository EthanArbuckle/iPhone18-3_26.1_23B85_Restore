...
- (id)copyWithZone:(_NSZone *)zone
{
  ...
  errorState = [(MTROvenCavityOperationalStateClusterOperationalErrorEvent *)self errorState];
  [(MTROvenCavityOperationalStateClusterOperationalErrorEvent *)v4 setErrorState:errorState];
