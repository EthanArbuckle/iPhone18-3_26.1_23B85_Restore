...
- (id)copyWithZone:(_NSZone *)zone
{
  ...
  current = [(MTRGeneralDiagnosticsClusterNetworkFaultChangeEvent *)self current];
  [(MTRGeneralDiagnosticsClusterNetworkFaultChangeEvent *)v4 setCurrent:current];

  previous = [(MTRGeneralDiagnosticsClusterNetworkFaultChangeEvent *)self previous];
  [(MTRGeneralDiagnosticsClusterNetworkFaultChangeEvent *)v4 setPrevious:previous];
