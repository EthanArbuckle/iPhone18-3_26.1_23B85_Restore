...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v5 = [(MTRMediaPlaybackClusterStopParams *)self timedInvokeTimeoutMs];
  [(MTRMediaPlaybackClusterStopParams *)v4 setTimedInvokeTimeoutMs:v5];

  v6 = [(MTRMediaPlaybackClusterStopParams *)self serverSideProcessingTimeout];
  [(MTRMediaPlaybackClusterStopParams *)v4 setServerSideProcessingTimeout:v6];
