...
- (MTRGroupsClusterRemoveGroupResponseParams)initWithDecodableStruct:(const DecodableType *)a3;
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v5 = [(MTRGroupsClusterRemoveGroupResponseParams *)self status];
  [(MTRGroupsClusterRemoveGroupResponseParams *)v4 setStatus:v5];

  v6 = [(MTRGroupsClusterRemoveGroupResponseParams *)self groupID];
  [(MTRGroupsClusterRemoveGroupResponseParams *)v4 setGroupID:v6];

  v7 = [(MTRGroupsClusterRemoveGroupResponseParams *)self timedInvokeTimeoutMs];
  [(MTRGroupsClusterRemoveGroupResponseParams *)v4 setTimedInvokeTimeoutMs:v7];
...
- (MTRGroupsClusterRemoveGroupResponseParams)initWithDecodableStruct:(const DecodableType *)a3
{
  ...
  if (v4)
  {
    v6 = [(MTRGroupsClusterRemoveGroupResponseParams *)v4 _setFieldsFromDecodableStruct:a3];
    if (!v6)
    {
      v8 = v5;
      goto LABEL_6;
