...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v5 = [(MTRAdministratorCommissioningClusterOpenCommissioningWindowParams *)self commissioningTimeout];
  [(MTRAdministratorCommissioningClusterOpenCommissioningWindowParams *)v4 setCommissioningTimeout:v5];

  v6 = [(MTRAdministratorCommissioningClusterOpenCommissioningWindowParams *)self pakePasscodeVerifier];
  [(MTRAdministratorCommissioningClusterOpenCommissioningWindowParams *)v4 setPakePasscodeVerifier:v6];

  v7 = [(MTRAdministratorCommissioningClusterOpenCommissioningWindowParams *)self discriminator];
  [(MTRAdministratorCommissioningClusterOpenCommissioningWindowParams *)v4 setDiscriminator:v7];

  v8 = [(MTRAdministratorCommissioningClusterOpenCommissioningWindowParams *)self iterations];
  [(MTRAdministratorCommissioningClusterOpenCommissioningWindowParams *)v4 setIterations:v8];

  v9 = [(MTRAdministratorCommissioningClusterOpenCommissioningWindowParams *)self salt];
  [(MTRAdministratorCommissioningClusterOpenCommissioningWindowParams *)v4 setSalt:v9];

  v10 = [(MTRAdministratorCommissioningClusterOpenCommissioningWindowParams *)self timedInvokeTimeoutMs];
  [(MTRAdministratorCommissioningClusterOpenCommissioningWindowParams *)v4 setTimedInvokeTimeoutMs:v10];

  v11 = [(MTRAdministratorCommissioningClusterOpenCommissioningWindowParams *)self serverSideProcessingTimeout];
  [(MTRAdministratorCommissioningClusterOpenCommissioningWindowParams *)v4 setServerSideProcessingTimeout:v11];
