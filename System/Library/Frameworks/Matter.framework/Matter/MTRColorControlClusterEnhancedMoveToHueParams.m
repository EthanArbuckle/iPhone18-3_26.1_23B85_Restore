...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v5 = [(MTRColorControlClusterEnhancedMoveToHueParams *)self enhancedHue];
  [(MTRColorControlClusterEnhancedMoveToHueParams *)v4 setEnhancedHue:v5];

  v6 = [(MTRColorControlClusterEnhancedMoveToHueParams *)self direction];
  [(MTRColorControlClusterEnhancedMoveToHueParams *)v4 setDirection:v6];

  v7 = [(MTRColorControlClusterEnhancedMoveToHueParams *)self transitionTime];
  [(MTRColorControlClusterEnhancedMoveToHueParams *)v4 setTransitionTime:v7];

  v8 = [(MTRColorControlClusterEnhancedMoveToHueParams *)self optionsMask];
  [(MTRColorControlClusterEnhancedMoveToHueParams *)v4 setOptionsMask:v8];

  v9 = [(MTRColorControlClusterEnhancedMoveToHueParams *)self optionsOverride];
  [(MTRColorControlClusterEnhancedMoveToHueParams *)v4 setOptionsOverride:v9];

  v10 = [(MTRColorControlClusterEnhancedMoveToHueParams *)self timedInvokeTimeoutMs];
  [(MTRColorControlClusterEnhancedMoveToHueParams *)v4 setTimedInvokeTimeoutMs:v10];

  v11 = [(MTRColorControlClusterEnhancedMoveToHueParams *)self serverSideProcessingTimeout];
  [(MTRColorControlClusterEnhancedMoveToHueParams *)v4 setServerSideProcessingTimeout:v11];
...
- (ChipError)_encodeToTLVReader:(PacketBufferTLVReader *)a3
{
  ...
  if (v23)
  {
    ...
    v10 = sub_238F09464(&v26, v18, 0x100uLL);
    v12 = v10;
