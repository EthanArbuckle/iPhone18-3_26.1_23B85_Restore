...
- (id)copyWithZone:(_NSZone *)zone
{
  ...
  connectionStatus = [(MTRThreadNetworkDiagnosticsClusterConnectionStatusEvent *)self connectionStatus];
  [(MTRThreadNetworkDiagnosticsClusterConnectionStatusEvent *)v4 setConnectionStatus:connectionStatus];
