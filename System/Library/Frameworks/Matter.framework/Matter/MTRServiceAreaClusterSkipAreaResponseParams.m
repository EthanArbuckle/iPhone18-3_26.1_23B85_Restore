...
- (MTRServiceAreaClusterSkipAreaResponseParams)initWithDecodableStruct:(const void *)a3;
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v5 = [(MTRServiceAreaClusterSkipAreaResponseParams *)self status];
  [(MTRServiceAreaClusterSkipAreaResponseParams *)v4 setStatus:v5];

  v6 = [(MTRServiceAreaClusterSkipAreaResponseParams *)self statusText];
  [(MTRServiceAreaClusterSkipAreaResponseParams *)v4 setStatusText:v6];
...
- (MTRServiceAreaClusterSkipAreaResponseParams)initWithResponseValue:(id)a3 error:(id *)a4
{
  ...
  [MTRBaseDevice _responseDataForCommand:v6 clusterID:336 commandID:3 error:a4];
  if (v16)
  {
    sub_2393C5AAC(v15);
...
- (MTRServiceAreaClusterSkipAreaResponseParams)initWithDecodableStruct:(const void *)a3
{
  ...
  if (v4)
  {
    v6 = [(MTRServiceAreaClusterSkipAreaResponseParams *)v4 _setFieldsFromDecodableStruct:a3];
    if (!v6)
    {
      v8 = v5;
      goto LABEL_6;
...
- (ChipError)_setFieldsFromDecodableStruct:(const void *)a3
{
  ...
  v7 = [(MTRServiceAreaClusterSkipAreaResponseParams *)self statusText];
