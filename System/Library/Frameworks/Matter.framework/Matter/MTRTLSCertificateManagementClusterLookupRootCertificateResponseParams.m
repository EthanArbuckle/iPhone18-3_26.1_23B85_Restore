...
- (MTRTLSCertificateManagementClusterLookupRootCertificateResponseParams)initWithDecodableStruct:(const DecodableType *)a3;
- (MTRTLSCertificateManagementClusterLookupRootCertificateResponseParams)initWithResponseValue:(id)a3 error:(id *)a4;
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v5 = [(MTRTLSCertificateManagementClusterLookupRootCertificateResponseParams *)self caid];
  [(MTRTLSCertificateManagementClusterLookupRootCertificateResponseParams *)v4 setCaid:v5];
...
- (MTRTLSCertificateManagementClusterLookupRootCertificateResponseParams)initWithResponseValue:(id)a3 error:(id *)a4
{
  ...
  [MTRBaseDevice _responseDataForCommand:v6 clusterID:2049 commandID:5 error:a4];
  if (v14)
  {
    sub_2393C5AAC(v13);
...
- (MTRTLSCertificateManagementClusterLookupRootCertificateResponseParams)initWithDecodableStruct:(const DecodableType *)a3
{
  ...
  if (v4)
  {
    v6 = [(MTRTLSCertificateManagementClusterLookupRootCertificateResponseParams *)v4 _setFieldsFromDecodableStruct:a3];
    if (!v6)
    {
      v8 = v5;
      goto LABEL_6;
