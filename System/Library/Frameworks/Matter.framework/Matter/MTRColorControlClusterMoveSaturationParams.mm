...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v5 = [(MTRColorControlClusterMoveSaturationParams *)self moveMode];
  [(MTRColorControlClusterMoveSaturationParams *)v4 setMoveMode:v5];

  v6 = [(MTRColorControlClusterMoveSaturationParams *)self rate];
  [(MTRColorControlClusterMoveSaturationParams *)v4 setRate:v6];

  v7 = [(MTRColorControlClusterMoveSaturationParams *)self optionsMask];
  [(MTRColorControlClusterMoveSaturationParams *)v4 setOptionsMask:v7];

  v8 = [(MTRColorControlClusterMoveSaturationParams *)self optionsOverride];
  [(MTRColorControlClusterMoveSaturationParams *)v4 setOptionsOverride:v8];

  v9 = [(MTRColorControlClusterMoveSaturationParams *)self timedInvokeTimeoutMs];
  [(MTRColorControlClusterMoveSaturationParams *)v4 setTimedInvokeTimeoutMs:v9];

  v10 = [(MTRColorControlClusterMoveSaturationParams *)self serverSideProcessingTimeout];
  [(MTRColorControlClusterMoveSaturationParams *)v4 setServerSideProcessingTimeout:v10];
...
- (ChipError)_encodeToTLVReader:(PacketBufferTLVReader *)a3
{
  ...
  v23 = v24;
  v5 = [(MTRColorControlClusterMoveSaturationParams *)self moveMode];
  LOBYTE(v25) = [v5 unsignedCharValue];

  v6 = [(MTRColorControlClusterMoveSaturationParams *)self rate];
  BYTE1(v25) = [v6 unsignedCharValue];

  v7 = [(MTRColorControlClusterMoveSaturationParams *)self optionsMask];
  BYTE2(v25) = [v7 unsignedCharValue];

  v8 = [(MTRColorControlClusterMoveSaturationParams *)self optionsOverride];
  HIBYTE(v25) = [v8 unsignedCharValue];
