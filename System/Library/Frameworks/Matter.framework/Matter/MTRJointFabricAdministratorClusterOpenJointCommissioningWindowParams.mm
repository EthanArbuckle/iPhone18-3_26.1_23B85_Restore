...
- (id)copyWithZone:(_NSZone *)zone
{
  ...
  commissioningTimeout = [(MTRJointFabricAdministratorClusterOpenJointCommissioningWindowParams *)self commissioningTimeout];
  [(MTRJointFabricAdministratorClusterOpenJointCommissioningWindowParams *)v4 setCommissioningTimeout:commissioningTimeout];

  pakePasscodeVerifier = [(MTRJointFabricAdministratorClusterOpenJointCommissioningWindowParams *)self pakePasscodeVerifier];
  [(MTRJointFabricAdministratorClusterOpenJointCommissioningWindowParams *)v4 setPakePasscodeVerifier:pakePasscodeVerifier];

  discriminator = [(MTRJointFabricAdministratorClusterOpenJointCommissioningWindowParams *)self discriminator];
  [(MTRJointFabricAdministratorClusterOpenJointCommissioningWindowParams *)v4 setDiscriminator:discriminator];

  iterations = [(MTRJointFabricAdministratorClusterOpenJointCommissioningWindowParams *)self iterations];
  [(MTRJointFabricAdministratorClusterOpenJointCommissioningWindowParams *)v4 setIterations:iterations];

  salt = [(MTRJointFabricAdministratorClusterOpenJointCommissioningWindowParams *)self salt];
  [(MTRJointFabricAdministratorClusterOpenJointCommissioningWindowParams *)v4 setSalt:salt];

  timedInvokeTimeoutMs = [(MTRJointFabricAdministratorClusterOpenJointCommissioningWindowParams *)self timedInvokeTimeoutMs];
  [(MTRJointFabricAdministratorClusterOpenJointCommissioningWindowParams *)v4 setTimedInvokeTimeoutMs:timedInvokeTimeoutMs];

  serverSideProcessingTimeout = [(MTRJointFabricAdministratorClusterOpenJointCommissioningWindowParams *)self serverSideProcessingTimeout];
  [(MTRJointFabricAdministratorClusterOpenJointCommissioningWindowParams *)v4 setServerSideProcessingTimeout:serverSideProcessingTimeout];
