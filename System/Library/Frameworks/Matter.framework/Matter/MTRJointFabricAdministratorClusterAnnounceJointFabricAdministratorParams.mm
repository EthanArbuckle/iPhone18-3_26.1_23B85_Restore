...
{
  v8.receiver = self;
  v8.super_class = MTRJointFabricAdministratorClusterAnnounceJointFabricAdministratorParams;
  v2 = [(MTRJointFabricAdministratorClusterAnnounceJointFabricAdministratorParams *)&v8 init];
  v3 = v2;
  if (v2)
  {
