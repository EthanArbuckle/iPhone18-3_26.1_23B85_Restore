...
{
  v9.receiver = self;
  v9.super_class = MTROperationalCredentialsClusterCSRRequestParams;
...
- (id)description
{
  ...
  v6 = [(NSData *)self->_csrNonce base64EncodedStringWithOptions:0];
  v7 = [v3 stringWithFormat:@"<%@: csrNonce:%@ isForUpdateNOC:%@; >", v5, v6, self->_isForUpdateNOC];;
...
- (ChipError)_encodeToTLVReader:(PacketBufferTLVReader *)reader
{
  ...
  if (v21)
  {
    ...
    v8 = sub_238F21C68(&v24, v16, 0x100uLL);
    v10 = v8;
