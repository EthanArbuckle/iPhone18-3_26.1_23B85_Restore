...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v5 = [(MTRMediaPlaybackClusterFastForwardParams *)self audioAdvanceUnmuted];
  [(MTRMediaPlaybackClusterFastForwardParams *)v4 setAudioAdvanceUnmuted:v5];

  v6 = [(MTRMediaPlaybackClusterFastForwardParams *)self timedInvokeTimeoutMs];
  [(MTRMediaPlaybackClusterFastForwardParams *)v4 setTimedInvokeTimeoutMs:v6];

  v7 = [(MTRMediaPlaybackClusterFastForwardParams *)self serverSideProcessingTimeout];
  [(MTRMediaPlaybackClusterFastForwardParams *)v4 setServerSideProcessingTimeout:v7];
...
- (ChipError)_encodeToTLVReader:(PacketBufferTLVReader *)a3
{
  ...
  {
    v23 = 1;
    v6 = [(MTRMediaPlaybackClusterFastForwardParams *)self audioAdvanceUnmuted];
