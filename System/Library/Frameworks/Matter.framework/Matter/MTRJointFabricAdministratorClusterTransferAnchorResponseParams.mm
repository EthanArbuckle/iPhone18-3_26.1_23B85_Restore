...
- (MTRJointFabricAdministratorClusterTransferAnchorResponseParams)initWithDecodableStruct:(const DecodableType *)a3;
- (MTRJointFabricAdministratorClusterTransferAnchorResponseParams)initWithResponseValue:(id)a3 error:(id *)a4;
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v5 = [(MTRJointFabricAdministratorClusterTransferAnchorResponseParams *)self statusCode];
  [(MTRJointFabricAdministratorClusterTransferAnchorResponseParams *)v4 setStatusCode:v5];
...
- (MTRJointFabricAdministratorClusterTransferAnchorResponseParams)initWithResponseValue:(id)a3 error:(id *)a4
{
  ...
  [MTRBaseDevice _responseDataForCommand:v6 clusterID:1875 commandID:6 error:a4];
  if (v14)
  {
    sub_2393C5AAC(v13);
...
- (MTRJointFabricAdministratorClusterTransferAnchorResponseParams)initWithDecodableStruct:(const DecodableType *)a3
{
  ...
  if (v4)
  {
    v6 = [(MTRJointFabricAdministratorClusterTransferAnchorResponseParams *)v4 _setFieldsFromDecodableStruct:a3];
    if (!v6)
    {
      v8 = v5;
      goto LABEL_6;
