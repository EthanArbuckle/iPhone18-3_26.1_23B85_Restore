...
- (id)copyWithZone:(_NSZone *)zone
{
  ...
  credential = [(MTRDoorLockClusterGetCredentialStatusParams *)self credential];
  [(MTRDoorLockClusterGetCredentialStatusParams *)v4 setCredential:credential];

  timedInvokeTimeoutMs = [(MTRDoorLockClusterGetCredentialStatusParams *)self timedInvokeTimeoutMs];
  [(MTRDoorLockClusterGetCredentialStatusParams *)v4 setTimedInvokeTimeoutMs:timedInvokeTimeoutMs];

  serverSideProcessingTimeout = [(MTRDoorLockClusterGetCredentialStatusParams *)self serverSideProcessingTimeout];
  [(MTRDoorLockClusterGetCredentialStatusParams *)v4 setServerSideProcessingTimeout:serverSideProcessingTimeout];
...
- (ChipError)_encodeToTLVReader:(PacketBufferTLVReader *)reader
{
  ...
  credential2 = [(MTRDoorLockClusterGetCredentialStatusParams *)self credential];
