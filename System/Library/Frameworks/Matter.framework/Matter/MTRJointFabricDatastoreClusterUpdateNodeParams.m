...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v5 = [(MTRJointFabricDatastoreClusterUpdateNodeParams *)self nodeID];
  [(MTRJointFabricDatastoreClusterUpdateNodeParams *)v4 setNodeID:v5];

  v6 = [(MTRJointFabricDatastoreClusterUpdateNodeParams *)self friendlyName];
  [(MTRJointFabricDatastoreClusterUpdateNodeParams *)v4 setFriendlyName:v6];

  v7 = [(MTRJointFabricDatastoreClusterUpdateNodeParams *)self timedInvokeTimeoutMs];
  [(MTRJointFabricDatastoreClusterUpdateNodeParams *)v4 setTimedInvokeTimeoutMs:v7];

  v8 = [(MTRJointFabricDatastoreClusterUpdateNodeParams *)self serverSideProcessingTimeout];
  [(MTRJointFabricDatastoreClusterUpdateNodeParams *)v4 setServerSideProcessingTimeout:v8];
