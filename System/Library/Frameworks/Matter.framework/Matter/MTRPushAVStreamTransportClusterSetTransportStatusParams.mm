...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v5 = [(MTRPushAVStreamTransportClusterSetTransportStatusParams *)self connectionID];
  [(MTRPushAVStreamTransportClusterSetTransportStatusParams *)v4 setConnectionID:v5];

  v6 = [(MTRPushAVStreamTransportClusterSetTransportStatusParams *)self transportStatus];
  [(MTRPushAVStreamTransportClusterSetTransportStatusParams *)v4 setTransportStatus:v6];

  v7 = [(MTRPushAVStreamTransportClusterSetTransportStatusParams *)self timedInvokeTimeoutMs];
  [(MTRPushAVStreamTransportClusterSetTransportStatusParams *)v4 setTimedInvokeTimeoutMs:v7];

  v8 = [(MTRPushAVStreamTransportClusterSetTransportStatusParams *)self serverSideProcessingTimeout];
  [(MTRPushAVStreamTransportClusterSetTransportStatusParams *)v4 setServerSideProcessingTimeout:v8];
...
- (ChipError)_encodeToTLVReader:(PacketBufferTLVReader *)a3
{
  ...
  if (v5)
  {
    v24 = 0;
    v25 = 1;
    v6 = [(MTRPushAVStreamTransportClusterSetTransportStatusParams *)self connectionID];
    v24 = [v6 unsignedShortValue];
  }

  v7 = [(MTRPushAVStreamTransportClusterSetTransportStatusParams *)self transportStatus];
  ...
  if (v21)
  {
    ...
    v8 = sub_238F24D38(&v24, v16, 0x100uLL);
    v10 = v8;
