...
- (MTRRVCOperationalStateClusterOperationalCommandResponseParams)initWithDecodableStruct:(const void *)a3;
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v5 = [(MTRRVCOperationalStateClusterOperationalCommandResponseParams *)self commandResponseState];
  [(MTRRVCOperationalStateClusterOperationalCommandResponseParams *)v4 setCommandResponseState:v5];
...
- (MTRRVCOperationalStateClusterOperationalCommandResponseParams)initWithResponseValue:(id)a3 error:(id *)a4
{
  ...
  [MTRBaseDevice _responseDataForCommand:v6 clusterID:97 commandID:4 error:a4];
  if (v14)
  {
    sub_2393C5AAC(v13);
...
- (MTRRVCOperationalStateClusterOperationalCommandResponseParams)initWithDecodableStruct:(const void *)a3
{
  ...
  if (v4)
  {
    v6 = [(MTRRVCOperationalStateClusterOperationalCommandResponseParams *)v4 _setFieldsFromDecodableStruct:a3];
    if (!v6)
    {
      v8 = v5;
      goto LABEL_6;
...
- (ChipError)_setFieldsFromDecodableStruct:(const void *)a3
{
  ...
  v7 = [(MTRRVCOperationalStateClusterOperationalCommandResponseParams *)self commandResponseState];
  [v7 setErrorStateID:v6];

  if (*(a3 + 8) != 1)
  {
    v15 = [(MTRRVCOperationalStateClusterOperationalCommandResponseParams *)self commandResponseState];
...
LABEL_5:
    ...
    if (v17 == 1)
    {
      ...
      v20 = [(MTRRVCOperationalStateClusterOperationalCommandResponseParams *)self commandResponseState];
      [v20 setErrorStateDetails:v19];

      v21 = [(MTRRVCOperationalStateClusterOperationalCommandResponseParams *)self commandResponseState];
    ...
    {
      v24 = [(MTRRVCOperationalStateClusterOperationalCommandResponseParams *)self commandResponseState];
  ...
  v10 = [(MTRRVCOperationalStateClusterOperationalCommandResponseParams *)self commandResponseState];
  [v10 setErrorStateLabel:v9];

  v11 = [(MTRRVCOperationalStateClusterOperationalCommandResponseParams *)self commandResponseState];
