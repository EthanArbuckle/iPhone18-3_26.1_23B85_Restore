...
- (id)copyWithZone:(_NSZone *)zone
{
  ...
  application = [(MTRApplicationLauncherClusterStopAppParams *)self application];
  [(MTRApplicationLauncherClusterStopAppParams *)v4 setApplication:application];

  timedInvokeTimeoutMs = [(MTRApplicationLauncherClusterStopAppParams *)self timedInvokeTimeoutMs];
  [(MTRApplicationLauncherClusterStopAppParams *)v4 setTimedInvokeTimeoutMs:timedInvokeTimeoutMs];

  serverSideProcessingTimeout = [(MTRApplicationLauncherClusterStopAppParams *)self serverSideProcessingTimeout];
  [(MTRApplicationLauncherClusterStopAppParams *)v4 setServerSideProcessingTimeout:serverSideProcessingTimeout];
...
- (ChipError)_encodeToTLVReader:(PacketBufferTLVReader *)reader
{
  ...
  if (application)
  {
    ...
    v28 = 0uLL;
    v27 = 0;
    application2 = [(MTRApplicationLauncherClusterStopAppParams *)self application];
    catalogVendorID = [application2 catalogVendorID];
    LOWORD(v27) = [catalogVendorID unsignedShortValue];

    application3 = [(MTRApplicationLauncherClusterStopAppParams *)self application];
