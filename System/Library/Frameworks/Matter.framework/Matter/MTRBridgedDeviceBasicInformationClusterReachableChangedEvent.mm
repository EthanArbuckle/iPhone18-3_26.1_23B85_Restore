...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v5 = [(MTRBridgedDeviceBasicInformationClusterReachableChangedEvent *)self reachableNewValue];
  [(MTRBridgedDeviceBasicInformationClusterReachableChangedEvent *)v4 setReachableNewValue:v5];
