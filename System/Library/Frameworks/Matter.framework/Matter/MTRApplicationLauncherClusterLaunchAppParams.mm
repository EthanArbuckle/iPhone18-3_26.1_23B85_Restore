...
{
  v9.receiver = self;
  v9.super_class = MTRApplicationLauncherClusterLaunchAppParams;
...
- (id)description
{
  ...
  v8 = [v3 stringWithFormat:@"<%@: application:%@ data:%@; >", v5, application, v7];;
...
- (ChipError)_encodeToTLVReader:(PacketBufferTLVReader *)reader
{
  ...
  if (v25)
  {
    ...
    v12 = sub_238F00C60(v28, v20, 0x100uLL);
    v14 = v12;
