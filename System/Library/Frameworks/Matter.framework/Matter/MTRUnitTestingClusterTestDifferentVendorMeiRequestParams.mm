...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v5 = [(MTRUnitTestingClusterTestDifferentVendorMeiRequestParams *)self arg1];
  [(MTRUnitTestingClusterTestDifferentVendorMeiRequestParams *)v4 setArg1:v5];

  v6 = [(MTRUnitTestingClusterTestDifferentVendorMeiRequestParams *)self timedInvokeTimeoutMs];
  [(MTRUnitTestingClusterTestDifferentVendorMeiRequestParams *)v4 setTimedInvokeTimeoutMs:v6];

  v7 = [(MTRUnitTestingClusterTestDifferentVendorMeiRequestParams *)self serverSideProcessingTimeout];
  [(MTRUnitTestingClusterTestDifferentVendorMeiRequestParams *)v4 setServerSideProcessingTimeout:v7];
...
- (ChipError)_encodeToTLVReader:(PacketBufferTLVReader *)a3
{
  ...
  v20[1] = 0;
  v19 = v20;
  v4 = [(MTRUnitTestingClusterTestDifferentVendorMeiRequestParams *)self arg1];
