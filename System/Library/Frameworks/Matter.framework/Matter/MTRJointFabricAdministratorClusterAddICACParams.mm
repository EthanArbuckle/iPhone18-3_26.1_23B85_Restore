...
{
  v8.receiver = self;
  v8.super_class = MTRJointFabricAdministratorClusterAddICACParams;
...
- (id)description
{
  ...
  v6 = [(NSData *)self->_icacValue base64EncodedStringWithOptions:0];
  v7 = [v3 stringWithFormat:@"<%@: icacValue:%@ >", v5, v6];;
