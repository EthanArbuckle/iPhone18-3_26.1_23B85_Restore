...
{
  v7.receiver = self;
  v7.super_class = MTRServiceAreaClusterSelectAreasResponseParams;
...
- (MTRServiceAreaClusterSelectAreasResponseParams)initWithResponseValue:(id)a3 error:(id *)a4
{
  ...
  if (v16)
  {
    ...
    if (!v8)
    {
      ...
      if (!v8)
      {
        v8 = [(MTRServiceAreaClusterSelectAreasResponseParams *)v7 _setFieldsFromDecodableStruct:v12];
        if (!v8)
        {
          v10 = v7;
          goto LABEL_8;
...
- (MTRServiceAreaClusterSelectAreasResponseParams)initWithDecodableStruct:(const void *)a3
{
  ...
  v4 = [(MTRServiceAreaClusterSelectAreasResponseParams *)&v10 init];
  v5 = v4;
  if (v4)
  {
