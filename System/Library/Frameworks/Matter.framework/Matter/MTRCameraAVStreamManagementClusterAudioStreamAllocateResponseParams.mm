...
- (MTRCameraAVStreamManagementClusterAudioStreamAllocateResponseParams)initWithDecodableStruct:(const DecodableType *)struct;
- (MTRCameraAVStreamManagementClusterAudioStreamAllocateResponseParams)initWithResponseValue:(id)value error:(id *)error;
...
- (id)copyWithZone:(_NSZone *)zone
{
  ...
  audioStreamID = [(MTRCameraAVStreamManagementClusterAudioStreamAllocateResponseParams *)self audioStreamID];
  [(MTRCameraAVStreamManagementClusterAudioStreamAllocateResponseParams *)v4 setAudioStreamID:audioStreamID];
...
- (MTRCameraAVStreamManagementClusterAudioStreamAllocateResponseParams)initWithResponseValue:(id)value error:(id *)error
{
  ...
  [MTRBaseDevice _responseDataForCommand:valueCopy clusterID:1361 commandID:1 error:error];
  if (v14)
  {
    sub_2393C5AAC(v13);
...
- (MTRCameraAVStreamManagementClusterAudioStreamAllocateResponseParams)initWithDecodableStruct:(const DecodableType *)struct
{
  ...
  if (v4)
  {
    v6 = [(MTRCameraAVStreamManagementClusterAudioStreamAllocateResponseParams *)v4 _setFieldsFromDecodableStruct:struct];
    if (!v6)
    {
      v8 = v5;
      goto LABEL_6;
