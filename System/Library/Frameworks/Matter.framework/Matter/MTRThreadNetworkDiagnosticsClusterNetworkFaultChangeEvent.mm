...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v5 = [(MTRThreadNetworkDiagnosticsClusterNetworkFaultChangeEvent *)self current];
  [(MTRThreadNetworkDiagnosticsClusterNetworkFaultChangeEvent *)v4 setCurrent:v5];

  v6 = [(MTRThreadNetworkDiagnosticsClusterNetworkFaultChangeEvent *)self previous];
  [(MTRThreadNetworkDiagnosticsClusterNetworkFaultChangeEvent *)v4 setPrevious:v6];
