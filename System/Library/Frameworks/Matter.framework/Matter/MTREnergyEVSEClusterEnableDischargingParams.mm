...
{
  v9.receiver = self;
  v9.super_class = MTREnergyEVSEClusterEnableDischargingParams;
  ...
  if (v2)
  {
    ...
    v3->_maximumDischargeCurrent = &unk_284C3E4C8;
...
- (id)description
{
  ...
  v6 = [v3 stringWithFormat:@"<%@: dischargingEnabledUntil:%@ maximumDischargeCurrent:%@; >", v5, self->_dischargingEnabledUntil, self->_maximumDischargeCurrent];;
