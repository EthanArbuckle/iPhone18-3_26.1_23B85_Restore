...
- (id)copyWithZone:(_NSZone *)zone
{
  ...
  credential = [(MTRDoorLockClusterClearCredentialParams *)self credential];
  [(MTRDoorLockClusterClearCredentialParams *)v4 setCredential:credential];

  timedInvokeTimeoutMs = [(MTRDoorLockClusterClearCredentialParams *)self timedInvokeTimeoutMs];
  [(MTRDoorLockClusterClearCredentialParams *)v4 setTimedInvokeTimeoutMs:timedInvokeTimeoutMs];

  serverSideProcessingTimeout = [(MTRDoorLockClusterClearCredentialParams *)self serverSideProcessingTimeout];
  [(MTRDoorLockClusterClearCredentialParams *)v4 setServerSideProcessingTimeout:serverSideProcessingTimeout];
...
- (ChipError)_encodeToTLVReader:(PacketBufferTLVReader *)reader
{
  ...
  if (credential)
  {
    v26 = 0;
    v27 = 1;
    credential2 = [(MTRDoorLockClusterClearCredentialParams *)self credential];
    credentialType = [credential2 credentialType];
    LOBYTE(v26) = [credentialType unsignedCharValue];

    credential3 = [(MTRDoorLockClusterClearCredentialParams *)self credential];
