...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v5 = [(MTROperationalCredentialsClusterRemoveFabricParams *)self fabricIndex];
  [(MTROperationalCredentialsClusterRemoveFabricParams *)v4 setFabricIndex:v5];

  v6 = [(MTROperationalCredentialsClusterRemoveFabricParams *)self timedInvokeTimeoutMs];
  [(MTROperationalCredentialsClusterRemoveFabricParams *)v4 setTimedInvokeTimeoutMs:v6];

  v7 = [(MTROperationalCredentialsClusterRemoveFabricParams *)self serverSideProcessingTimeout];
  [(MTROperationalCredentialsClusterRemoveFabricParams *)v4 setServerSideProcessingTimeout:v7];
...
- (ChipError)_encodeToTLVReader:(PacketBufferTLVReader *)a3
{
  ...
  v20[1] = 0;
  v19 = v20;
  v4 = [(MTROperationalCredentialsClusterRemoveFabricParams *)self fabricIndex];
