...
- (MTRZoneManagementClusterCreateTwoDCartesianZoneResponseParams)initWithDecodableStruct:(const DecodableType *)a3;
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v5 = [(MTRZoneManagementClusterCreateTwoDCartesianZoneResponseParams *)self zoneID];
  [(MTRZoneManagementClusterCreateTwoDCartesianZoneResponseParams *)v4 setZoneID:v5];
...
- (MTRZoneManagementClusterCreateTwoDCartesianZoneResponseParams)initWithResponseValue:(id)a3 error:(id *)a4
{
  ...
  [MTRBaseDevice _responseDataForCommand:v6 clusterID:1360 commandID:1 error:a4];
  if (v14)
  {
    sub_2393C5AAC(v13);
...
- (MTRZoneManagementClusterCreateTwoDCartesianZoneResponseParams)initWithDecodableStruct:(const DecodableType *)a3
{
  ...
  if (v4)
  {
    v6 = [(MTRZoneManagementClusterCreateTwoDCartesianZoneResponseParams *)v4 _setFieldsFromDecodableStruct:a3];
    if (!v6)
    {
      v8 = v5;
      goto LABEL_6;
