...
- (id)copyWithZone:(_NSZone *)zone
{
  ...
  getNewMode = [(MTRRVCCleanModeClusterChangeToModeParams *)self getNewMode];
  [(MTRRVCCleanModeClusterChangeToModeParams *)v4 setNewMode:getNewMode];

  timedInvokeTimeoutMs = [(MTRRVCCleanModeClusterChangeToModeParams *)self timedInvokeTimeoutMs];
  [(MTRRVCCleanModeClusterChangeToModeParams *)v4 setTimedInvokeTimeoutMs:timedInvokeTimeoutMs];

  serverSideProcessingTimeout = [(MTRRVCCleanModeClusterChangeToModeParams *)self serverSideProcessingTimeout];
  [(MTRRVCCleanModeClusterChangeToModeParams *)v4 setServerSideProcessingTimeout:serverSideProcessingTimeout];
