...
- (void)launchAppWithParams:(MTRApplicationLauncherClusterLaunchAppParams *)params expectedValues:(NSArray *)expectedDataValueDictionaries expectedValueInterval:(NSNumber *)expectedValueIntervalMs completion:(void *)completion
{
  ...
  v15 = [(MTRApplicationLauncherClusterLaunchAppParams *)v10 timedInvokeTimeoutMs];
  v16 = [(MTRGenericCluster *)self device];
  v17 = [(MTRCluster *)self endpointID];
  v18 = [(MTRApplicationLauncherClusterLaunchAppParams *)v10 serverSideProcessingTimeout];
  v19 = objc_opt_class();
  v20 = [(MTRCluster *)self callbackQueue];
  [v16 _invokeKnownCommandWithEndpointID:v17 clusterID:&unk_284C43298 commandID:&unk_284C41660 commandPayload:v10 expectedValues:v22 expectedValueInterval:v11 timedInvokeTimeout:v15 serverSideProcessingTimeout:v18 responseClass:v19 queue:v20 completion:{v14, v21}];
}
...
- (void)stopAppWithParams:(MTRApplicationLauncherClusterStopAppParams *)params expectedValues:(NSArray *)expectedDataValueDictionaries expectedValueInterval:(NSNumber *)expectedValueIntervalMs completion:(void *)completion
{
  ...
  v24 = v13;
  v14 = MEMORY[0x23EE78590](v23);
  v15 = [(MTRApplicationLauncherClusterStopAppParams *)v10 timedInvokeTimeoutMs];
  v16 = [(MTRGenericCluster *)self device];
  v17 = [(MTRCluster *)self endpointID];
  v18 = [(MTRApplicationLauncherClusterStopAppParams *)v10 serverSideProcessingTimeout];
  v19 = objc_opt_class();
  v20 = [(MTRCluster *)self callbackQueue];
  [v16 _invokeKnownCommandWithEndpointID:v17 clusterID:&unk_284C43298 commandID:&unk_284C41768 commandPayload:v10 expectedValues:v22 expectedValueInterval:v11 timedInvokeTimeout:v15 serverSideProcessingTimeout:v18 responseClass:v19 queue:v20 completion:{v14, v21}];
}
...
- (void)hideAppWithParams:(MTRApplicationLauncherClusterHideAppParams *)params expectedValues:(NSArray *)expectedDataValueDictionaries expectedValueInterval:(NSNumber *)expectedValueIntervalMs completion:(void *)completion
{
  ...
  v24 = v13;
  v14 = MEMORY[0x23EE78590](v23);
  v15 = [(MTRApplicationLauncherClusterHideAppParams *)v10 timedInvokeTimeoutMs];
  v16 = [(MTRGenericCluster *)self device];
  v17 = [(MTRCluster *)self endpointID];
  v18 = [(MTRApplicationLauncherClusterHideAppParams *)v10 serverSideProcessingTimeout];
  v19 = objc_opt_class();
  v20 = [(MTRCluster *)self callbackQueue];
  [v16 _invokeKnownCommandWithEndpointID:v17 clusterID:&unk_284C43298 commandID:&unk_284C41780 commandPayload:v10 expectedValues:v22 expectedValueInterval:v11 timedInvokeTimeout:v15 serverSideProcessingTimeout:v18 responseClass:v19 queue:v20 completion:{v14, v21}];
}
...
- (NSDictionary)readAttributeCatalogListWithParams:(MTRReadParams *)params
{
  ...
  v7 = [v5 readAttributeWithEndpointID:v6 clusterID:&unk_284C432B0 attributeID:&unk_284C416A8 params:v4];
...
- (NSDictionary)readAttributeCurrentAppWithParams:(MTRReadParams *)params
{
  ...
  v5 = [(MTRGenericCluster *)self device];
  v6 = [(MTRCluster *)self endpointID];
  v7 = [v5 readAttributeWithEndpointID:v6 clusterID:&unk_284C432B0 attributeID:&unk_284C416C0 params:v4];
...
- (void)writeAttributeCurrentAppWithValue:(NSDictionary *)dataValueDictionary expectedValueInterval:(NSNumber *)expectedValueIntervalMs params:(MTRWriteParams *)params
{
  ...
  [v10 writeAttributeWithEndpointID:v11 clusterID:&unk_284C432B0 attributeID:&unk_284C416C0 value:v12 expectedValueInterval:v8 timedWriteTimeout:v9];
}
...
- (NSDictionary)readAttributeGeneratedCommandListWithParams:(MTRReadParams *)params
{
  ...
  v5 = [(MTRGenericCluster *)self device];
  v6 = [(MTRCluster *)self endpointID];
  v7 = [v5 readAttributeWithEndpointID:v6 clusterID:&unk_284C432B0 attributeID:&unk_284C416D8 params:v4];
...
- (NSDictionary)readAttributeAcceptedCommandListWithParams:(MTRReadParams *)params
{
  ...
  v5 = [(MTRGenericCluster *)self device];
  v6 = [(MTRCluster *)self endpointID];
  v7 = [v5 readAttributeWithEndpointID:v6 clusterID:&unk_284C432B0 attributeID:&unk_284C416F0 params:v4];
...
- (NSDictionary)readAttributeAttributeListWithParams:(MTRReadParams *)params
{
  ...
  v5 = [(MTRGenericCluster *)self device];
  v6 = [(MTRCluster *)self endpointID];
  v7 = [v5 readAttributeWithEndpointID:v6 clusterID:&unk_284C432B0 attributeID:&unk_284C41708 params:v4];
...
- (NSDictionary)readAttributeFeatureMapWithParams:(MTRReadParams *)params
{
  ...
  v5 = [(MTRGenericCluster *)self device];
  v6 = [(MTRCluster *)self endpointID];
  v7 = [v5 readAttributeWithEndpointID:v6 clusterID:&unk_284C432B0 attributeID:&unk_284C41720 params:v4];
...
- (NSDictionary)readAttributeClusterRevisionWithParams:(MTRReadParams *)params
{
  ...
  v5 = [(MTRGenericCluster *)self device];
  v6 = [(MTRCluster *)self endpointID];
  v7 = [v5 readAttributeWithEndpointID:v6 clusterID:&unk_284C432B0 attributeID:&unk_284C41738 params:v4];
