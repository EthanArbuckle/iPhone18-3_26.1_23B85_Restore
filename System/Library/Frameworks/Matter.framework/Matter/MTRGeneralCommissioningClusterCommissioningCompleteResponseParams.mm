...
{
  v8.receiver = self;
  v8.super_class = MTRGeneralCommissioningClusterCommissioningCompleteResponseParams;
...
- (MTRGeneralCommissioningClusterCommissioningCompleteResponseParams)initWithResponseValue:(NSDictionary *)responseValue error:(NSError *)error
{
  v6 = responseValue;
  v17.receiver = self;
  v17.super_class = MTRGeneralCommissioningClusterCommissioningCompleteResponseParams;
  v7 = [(MTRGeneralCommissioningClusterCommissioningCompleteResponseParams *)&v17 init];
  if (!v7)
  {
    v10 = 0;
    goto LABEL_10;
  ...
  [MTRBaseDevice _responseDataForCommand:v6 clusterID:48 commandID:5 error:error];
  if (v16)
  {
    sub_2393C5AAC(v15);
    ...
    if (!v8)
    {
      ...
      if (!v8)
      {
        v8 = [(MTRGeneralCommissioningClusterCommissioningCompleteResponseParams *)v7 _setFieldsFromDecodableStruct:v12];
        if (!v8)
        {
          v10 = v7;
          goto LABEL_8;
...
- (MTRGeneralCommissioningClusterCommissioningCompleteResponseParams)initWithDecodableStruct:(const void *)a3
{
  ...
  v4 = [(MTRGeneralCommissioningClusterCommissioningCompleteResponseParams *)&v10 init];
  v5 = v4;
  if (v4)
  {
