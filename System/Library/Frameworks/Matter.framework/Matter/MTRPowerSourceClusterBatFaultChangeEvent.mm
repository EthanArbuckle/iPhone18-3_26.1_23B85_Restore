...
- (id)copyWithZone:(_NSZone *)zone
{
  ...
  current = [(MTRPowerSourceClusterBatFaultChangeEvent *)self current];
  [(MTRPowerSourceClusterBatFaultChangeEvent *)v4 setCurrent:current];

  previous = [(MTRPowerSourceClusterBatFaultChangeEvent *)self previous];
  [(MTRPowerSourceClusterBatFaultChangeEvent *)v4 setPrevious:previous];
