...
- (void)cx_setAllowedClassesForProviderHostProtocol
{
  ...
  [self setClasses:_cx_providerAllowedClasses forSelector:sel_reportNewIncomingCallWithUUID_update_reply_ argumentIndex:1 ofReply:0];

  _cx_providerAllowedClasses2 = [self _cx_providerAllowedClasses];
  [self setClasses:_cx_providerAllowedClasses2 forSelector:sel_reportCallWithUUID_updated_ argumentIndex:1 ofReply:0];

  _cx_providerAllowedClasses3 = [self _cx_providerAllowedClasses];
  [self setClasses:_cx_providerAllowedClasses3 forSelector:sel_actionCompleted_completionHandler_ argumentIndex:0 ofReply:0];
}
