...
void sub_100022264()
{
  ...
  strerror(*v1);
  sub_10000EC04();
  sub_10000EC1C(&_mh_execute_header, v2, v3, "failed to resolve temporary directory (%d): %s", v4, v5, v6, v7, v8);
}
...
void sub_1000222EC()
{
  ...
  strerror(*v1);
  sub_10000EC04();
  sub_10000EC1C(&_mh_execute_header, v2, v3, "failed to initialize temporary directory (%d): %s", v4, v5, v6, v7, v8);
}
