...
- (void)encodeWithCoder:(id)a3
{
  ...
  v14 = a3;
  [v14 encodeInteger:preferredAssetRepresentationMode forKey:@"PHPickerConfigurationCoderAssetRepresentationModeKey"];
  [v14 encodeInteger:self->_selection forKey:@"PHPickerConfigurationCoderSelectionKey"];
  [v14 encodeInteger:self->_selectionLimit forKey:@"PHPickerConfigurationCoderSelectionLimitKey"];
  [v14 encodeInteger:self->_minimumSelectionLimit forKey:@"PHPickerConfigurationCoderMinimumSelectionLimitKey"];
  v5 = [(PHPickerFilter *)self->_filter _puPickerFilter];
  [v14 encodeObject:v5 forKey:@"PHPickerConfigurationCoderFilterKey"];

  [v14 encodeObject:self->__aspectRatio forKey:@"PHPickerConfigurationCoderAspectRatioKey"];
  [v14 encodeObject:self->_preselectedItemIdentifiers forKey:@"PHPickerConfigurationCoderPreselectedItemIdentifiersKey"];
  [v14 encodeInteger:self->_mode forKey:@"PHPickerConfigurationCoderModeKey"];
  v6 = [MEMORY[0x1E696AD98] numberWithUnsignedInteger:self->_edgesWithoutContentMargins];
  [v14 encodeObject:v6 forKey:@"PHPickerConfigurationCoderEdgesWithoutContentMarginsKey"];

  v7 = [MEMORY[0x1E696AD98] numberWithUnsignedInteger:self->_disabledCapabilities];
  [v14 encodeObject:v7 forKey:@"PHPickerConfigurationCoderDisabledCapabilitiesKey"];

  [v14 encodeObject:self->_prompt forKey:@"PHPickerConfigurationCoderPromptKey"];
  [v14 encodeObject:self->_title forKey:@"PHPickerConfigurationCoderTitleKey"];
  v8 = [(PHPhotoLibrary *)self->_photoLibrary photoLibraryURL];
  [v14 encodeObject:v8 forKey:@"PHPickerConfigurationCoderPhotoLibraryURLKey"];

  [v14 encodeBool:self->__onlyReturnsIdentifiers forKey:@"PHPickerConfigurationCoderOnlyReturnsIdentifiersKey"];
  [v14 encodeBool:self->__allowsDownscaling forKey:@"PHPickerConfigurationCoderAllowsDownscalingKey"];
  [v14 encodeBool:self->__allowsEncodingPolicyModification forKey:@"PHPickerConfigurationAllowsEncodingPolicyModificationKey"];
  [v14 encodeBool:self->__usesOpenPanelLayout forKey:@"PHPickerConfigurationCoderUsesOpenPanelLayoutKey"];
  [v14 encodeBool:self->__usesMemoriesLayout forKey:@"PHPickerConfigurationCoderUsesMemoriesLayoutKey"];
  [v14 encodeObject:self->__suggestionGroup forKey:@"PHPickerConfigurationCoderSuggestionGroupKey"];
  [v14 encodeObject:self->__searchText forKey:@"PHPickerConfigurationCoderSearchTextKey"];
  [v14 encodeObject:self->__albumsConfiguration forKey:@"PHPickerConfigurationCoderAlbumsConfigurationKey"];
  [v14 encodeObject:self->__peopleConfiguration forKey:@"PHPickerConfigurationCoderPeopleConfigurationKey"];
  [v14 encodeBool:self->__alwaysShowLoadingPlaceholder forKey:@"PHPickerConfigurationCoderAlwaysShowLoadingPlaceholderKey"];
  v9 = [MEMORY[0x1E696AD98] numberWithUnsignedInteger:self->__disabledPrivateCapabilities];
  [v14 encodeObject:v9 forKey:@"PHPickerConfigurationCoderDisabledPrivateCapabilitiesKey"];

  v10 = [MEMORY[0x1E696AD98] numberWithInteger:self->__primaryButtonType];
  [v14 encodeObject:v10 forKey:@"PHPickerConfigurationCoderPrimaryButtonTypeKey"];

  v11 = [MEMORY[0x1E696AD98] numberWithInteger:self->__secondaryButtonType];
  [v14 encodeObject:v11 forKey:@"PHPickerConfigurationCoderSecondaryButtonTypeKey"];

  [v14 encodeInteger:self->__sourceType forKey:@"PHPickerConfigurationCoderSourceTypeKey"];
  [v14 encodeObject:self->__containerIdentifier forKey:@"PHPickerConfigurationCoderContainerIdentifierKey"];
  [v14 encodeObject:self->__purposedLimitedLibraryApplicationIdentifier forKey:@"PHPickerConfigurationCoderPurposedLimitedLibraryApplicationIdentifierKey"];
  [v14 encodeBool:self->__onboardingOverlayDismissedBefore forKey:@"PHPickerConfigurationCoderOnboardingOverlayDismissedBeforeKey"];
  [v14 encodeBool:self->__onboardingHeaderDismissedBefore forKey:@"PHPickerConfigurationCoderOnboardingHeaderDismissedBeforeKey"];
  [v14 encodeBool:self->__limitedLibraryHeaderDismissedBefore forKey:@"PHPickerConfigurationCoderLimitedLibraryHeaderDismissedBeforeKey"];
  v12 = [MEMORY[0x1E696AD98] numberWithUnsignedInteger:self->__excludedCollections];
  [v14 encodeObject:v12 forKey:@"PHPickerConfigurationCoderExcludedCollectionsKey"];

  v13 = [MEMORY[0x1E696AD98] numberWithUnsignedInteger:self->__desiredCollectionSuggestions];
  [v14 encodeObject:v13 forKey:@"PHPickerConfigurationCoderDesiredCollectionSuggestionsKey"];

  [v14 encodeObject:self->__sharedAlbumSheetConfiguration forKey:@"PHPickerConfigurationCoderSharedAlbumSheetConfigKey"];
}
...
- (PHPickerConfiguration)initWithCoder:(id)a3
{
  ...
  if (v5)
  {
    v5->_preferredAssetRepresentationMode = [v4 decodeIntegerForKey:@"PHPickerConfigurationCoderAssetRepresentationModeKey"];
    ...
    v7 = [v4 decodeObjectOfClasses:v6 forKey:@"PHPickerConfigurationCoderFilterKey"];
    ...
    v10 = [v4 decodeArrayOfObjectsOfClass:objc_opt_class() forKey:@"PHPickerConfigurationCoderPreselectedItemIdentifiersKey"];
    v11 = v10;
    if (v10)
    {
      v12 = v10;
    ...
    v15 = [v4 decodeObjectOfClass:objc_opt_class() forKey:@"PHPickerConfigurationCoderPromptKey"];
    prompt = v5->_prompt;
    v5->_prompt = v15;

    v17 = [v4 decodeObjectOfClass:objc_opt_class() forKey:@"PHPickerConfigurationCoderTitleKey"];
    title = v5->_title;
    v5->_title = v17;

    v19 = [v4 decodeObjectOfClass:objc_opt_class() forKey:@"PHPickerConfigurationCoderPhotoLibraryURLKey"];
    if (v19)
    {
    ...
    v22 = [v4 decodeObjectOfClass:objc_opt_class() forKey:@"PHPickerConfigurationCoderAspectRatioKey"];
    aspectRatio = v5->__aspectRatio;
    v5->__aspectRatio = v22;

    v24 = [v4 decodeObjectOfClass:objc_opt_class() forKey:@"PHPickerConfigurationCoderSuggestionGroupKey"];
    suggestionGroup = v5->__suggestionGroup;
    v5->__suggestionGroup = v24;

    v26 = [v4 decodeObjectOfClass:objc_opt_class() forKey:@"PHPickerConfigurationCoderSearchTextKey"];
    searchText = v5->__searchText;
    v5->__searchText = v26;

    v28 = [v4 decodeObjectOfClass:objc_opt_class() forKey:@"PHPickerConfigurationCoderAlbumsConfigurationKey"];
    albumsConfiguration = v5->__albumsConfiguration;
    v5->__albumsConfiguration = v28;

    v30 = [v4 decodeObjectOfClass:objc_opt_class() forKey:@"PHPickerConfigurationCoderPeopleConfigurationKey"];
    ...
    v32 = [v4 decodeObjectOfClass:objc_opt_class() forKey:@"PHPickerConfigurationCoderDisabledPrivateCapabilitiesKey"];
    v5->__disabledPrivateCapabilities = [v32 unsignedIntegerValue];

    v33 = [v4 decodeObjectOfClass:objc_opt_class() forKey:@"PHPickerConfigurationCoderPrimaryButtonTypeKey"];
    v5->__primaryButtonType = [v33 unsignedIntegerValue];

    v34 = [v4 decodeObjectOfClass:objc_opt_class() forKey:@"PHPickerConfigurationCoderSecondaryButtonTypeKey"];
    ...
    v35 = [v4 decodeObjectOfClass:objc_opt_class() forKey:@"PHPickerConfigurationCoderContainerIdentifierKey"];
    containerIdentifier = v5->__containerIdentifier;
    v5->__containerIdentifier = v35;

    v37 = [v4 decodeObjectOfClass:objc_opt_class() forKey:@"PHPickerConfigurationCoderPurposedLimitedLibraryApplicationIdentifierKey"];
    ...
    v39 = [v4 decodeObjectOfClass:objc_opt_class() forKey:@"PHPickerConfigurationCoderExcludedCollectionsKey"];
    v5->__excludedCollections = [v39 unsignedIntegerValue];

    v40 = [v4 decodeObjectOfClass:objc_opt_class() forKey:@"PHPickerConfigurationCoderDesiredCollectionSuggestionsKey"];
    v5->__desiredCollectionSuggestions = [v40 unsignedIntegerValue];

    v41 = [v4 decodeObjectOfClass:objc_opt_class() forKey:@"PHPickerConfigurationCoderSharedAlbumSheetConfigKey"];
...
{
  v4 = a3;
  if (v4 || ([MEMORY[0x1E69789A8] imagePickerPhotoLibrary], (v4 = objc_claimAutoreleasedReturnValue()) != 0))
  {
    v5 = v4;
...
- (PHPickerConfiguration)initWithPhotoLibraryAndOnlyReturnsIdentifiers:(id)a3
{
  ...
  {
    v5 = v4;
    v6 = [(PHPickerConfiguration *)self _initWithPhotoLibrary:v4 onlyReturnsIdentifiers:1];
