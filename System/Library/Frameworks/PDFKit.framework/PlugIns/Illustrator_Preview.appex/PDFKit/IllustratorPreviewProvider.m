...
- (void)providePreviewForFileRequest:(id)a3 completionHandler:(id)a4
{
  ...
  v19 = 0;
  v18 = 0;
  v8 = [v7 getResourceValue:&v19 forKey:NSURLContentTypeKey error:&v18];
  v9 = v19;
  v10 = v18;
  v11 = v9;
  if (v8)
...
- (BOOL)_illustratorFileContainsPDFAtURL:(id)a3 type:(id)a4
{
  ...
  if (v6 && v7)
  {
    if ([v6 conformsToType:v7] && CFURLGetFileSystemRepresentation(v5, 1u, buffer, 1024) && (v10 = open(buffer, 0, 0), v10 != -1))
    {
      v11 = v10;
