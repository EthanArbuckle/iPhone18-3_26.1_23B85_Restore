...
- (void)touchesBegan:(id)began withEvent:(id)event
{
  ...
  view = [(PDFPanGestureRecognizer *)self view];
  ...
  [(PDFPanGestureRecognizer *)&v28 touchesBegan:beganCopy withEvent:eventCopy];
...
- (void)touchesMoved:(id)moved withEvent:(id)event
{
  ...
  [(PDFPanGestureRecognizer *)&v17 touchesMoved:movedCopy withEvent:event];
  v15 = 0u;
  v16 = 0u;
  v13 = 0u;
  v14 = 0u;
