...
- (void)encodeWithCoder:(id)a3
{
  ...
  v29 = a3;
  objc_msgSend_encodeInt_forKey_(v29, v5, v6, v7, label_low, @"kCLLocationButtonLabel");
  objc_msgSend_encodeInt_forKey_(v29, v8, v9, v10, LODWORD(self->_icon), @"kCLLocationButtonIcon");
  objc_msgSend_encodeObject_forKey_(v29, v11, v12, v13, self->_backgroundColor, @"kCLLocationButtonBackgroundColor");
  objc_msgSend_encodeObject_forKey_(v29, v14, v15, v16, self->_tintColor, @"kCLLocationButtonTintColor");
  v17.n128_u64[0] = *&self->_cornerRadius;
  v17.n128_f32[0] = v17.n128_f64[0];
  objc_msgSend_encodeFloat_forKey_(v29, v18, v17, v19, @"kCLLocationButtonCornerRadius");
  v20.n128_u64[0] = *&self->_frame.origin.x;
  v21.n128_u64[0] = *&self->_frame.origin.y;
  objc_msgSend_encodeCGRect_forKey_(v29, v22, v20, v21, @"kCLLocationButtonFrame", self->_frame.size.width, self->_frame.size.height);
  v23.n128_u64[0] = *&self->_fontSize;
  v23.n128_f32[0] = v23.n128_f64[0];
  objc_msgSend_encodeFloat_forKey_(v29, v24, v23, v25, @"kCLLocationButtonFontSize");
  objc_msgSend_encodeInt_forKey_(v29, v26, v27, v28, self->_controlSize, @"kCLLocationButtonControlSize");
}

- (CLLocationButtonTag)initWithCoder:(id)a3
{
  v4 = a3;
  v8 = objc_msgSend_decodeIntForKey_(v4, v5, v6, v7, @"kCLLocationButtonLabel");
  v12 = objc_msgSend_decodeIntForKey_(v4, v9, v10, v11, @"kCLLocationButtonIcon");
  v13 = objc_opt_class();
  v17 = objc_msgSend_decodeObjectOfClass_forKey_(v4, v14, v15, v16, v13, @"kCLLocationButtonBackgroundColor");
  v18 = objc_opt_class();
  ...
  v41 = v40.n128_f32[0];
  v44 = objc_msgSend_decodeIntForKey_(v4, v42, v40, v43, @"kCLLocationButtonControlSize");
...
- (id)resolvedStyleForStyle:(id)a3
{
  v5 = objc_msgSend_copyWithChangeBlock_(a3, a2, v3, v4, &unk_284A43A48);
...
- (unsigned)secureNameForStyle:(id)a3
{
  v6 = objc_msgSend_label(self, a2, v3, v4, a3);
