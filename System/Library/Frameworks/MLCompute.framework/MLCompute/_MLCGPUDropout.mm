...
- (_MLCGPUDropout)initWithDevice:(id)device rate:(float)rate seed:(unint64_t)seed;
@end
  ...
  if (v9)
  {
    ...
    if (v12)
    {
      ...
      do
      {
        ...
        v18 = [deviceList2 objectAtIndexedSubscript:v13];

        v19 = objc_alloc(*(v15 + 1632));
        v37 = v35;
        v38 = 1;
        v20 = [v19 initWithDevice:v18 keepProbability:seed seed:&v37 maskStrideInPixels:{COERCE_DOUBLE(__PAIR64__(v35.u32[1], LODWORD(v14)))}];
        v21 = objc_alloc(*(v16 + 1640));
        v37 = v35;
        v38 = 1;
        v22 = [v21 initWithDevice:v18 keepProbability:seed seed:&v37 maskStrideInPixels:{COERCE_DOUBLE(__PAIR64__(v35.u32[1], LODWORD(v14)))}];
        v23 = v22;
        if (v20)
        {
          v24 = v22 == 0;
