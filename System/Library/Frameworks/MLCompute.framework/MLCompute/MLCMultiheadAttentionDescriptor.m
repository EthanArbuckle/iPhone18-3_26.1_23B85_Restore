...
{
  LOBYTE(v6) = 0;
  v4 = [[a1 alloc] initWithModelDimension:modelDimension keyDimension:modelDimension valueDimension:modelDimension headCount:headCount dropout:1 hasBias:0 hasAttentionBias:0.0 addsZeroAttention:v6];
...
- (id)description
{
  ...
  v6 = [(MLCMultiheadAttentionDescriptor *)self modelDimension];
  v7 = [(MLCMultiheadAttentionDescriptor *)self keyDimension];
  v8 = [(MLCMultiheadAttentionDescriptor *)self valueDimension];
  v9 = [(MLCMultiheadAttentionDescriptor *)self headCount];
  [(MLCMultiheadAttentionDescriptor *)self dropout];
  v11 = [v3 stringWithFormat:@"%@: { modelDimension=%lu : keyDimension=%lu : valueDimension=%lu : headCount=%lu : dropout=%f : hasBias=%d : hasAttentionBias=%d : addsZeroAttention=%d }", v5, v6, v7, v8, v9, v10, -[MLCMultiheadAttentionDescriptor hasBiases](self, "hasBiases"), -[MLCMultiheadAttentionDescriptor hasAttentionBiases](self, "hasAttentionBiases"), -[MLCMultiheadAttentionDescriptor addsZeroAttention](self, "addsZeroAttention")];
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    v5 = v4;
    v6 = [v5 modelDimension];
    if (v6 == -[MLCMultiheadAttentionDescriptor modelDimension](self, "modelDimension") && (v7 = [v5 keyDimension], v7 == -[MLCMultiheadAttentionDescriptor keyDimension](self, "keyDimension")) && (v8 = objc_msgSend(v5, "headCount"), v8 == -[MLCMultiheadAttentionDescriptor headCount](self, "headCount")) && (objc_msgSend(v5, "dropout"), v10 = v9, -[MLCMultiheadAttentionDescriptor dropout](self, "dropout"), v10 == v11) && (v12 = objc_msgSend(v5, "hasBiases"), v12 == -[MLCMultiheadAttentionDescriptor hasBiases](self, "hasBiases")) && (v13 = objc_msgSend(v5, "hasAttentionBiases"), v13 == -[MLCMultiheadAttentionDescriptor hasAttentionBiases](self, "hasAttentionBiases")))
    {
      v16 = [v5 addsZeroAttention];
      v14 = v16 ^ [(MLCMultiheadAttentionDescriptor *)self addsZeroAttention]^ 1;
    }
...
{
  v14 = 0;
  v3 = [(MLCMultiheadAttentionDescriptor *)self modelDimension];
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v5 = [(MLCMultiheadAttentionDescriptor *)self modelDimension];
  v6 = [(MLCMultiheadAttentionDescriptor *)self keyDimension];
  v7 = [(MLCMultiheadAttentionDescriptor *)self valueDimension];
  v8 = [(MLCMultiheadAttentionDescriptor *)self headCount];
  [(MLCMultiheadAttentionDescriptor *)self dropout];
  v10 = v9;
  v11 = [(MLCMultiheadAttentionDescriptor *)self hasBiases];
  v12 = [(MLCMultiheadAttentionDescriptor *)self hasAttentionBiases];
  LOBYTE(v15) = [(MLCMultiheadAttentionDescriptor *)self addsZeroAttention];
  LODWORD(v13) = v10;
  return [v4 initWithModelDimension:v5 keyDimension:v6 valueDimension:v7 headCount:v8 dropout:v11 hasBias:v12 hasAttentionBias:v13 addsZeroAttention:v15];
}
