...
- (CGRect)getSuggestedBounds:(unsigned __int8)bounds;
...
- (void)setContent:(__CFAttributedString *)content;
- (void)setCuePosition:(CGPoint)position;
...
- (void)layoutSublayersOfLayer:(id)layer
{
  ...
  if (CGRectEqualToRect(v32, *MEMORY[0x1E695F058]))
  {
    ...
    [layer setPosition:{v7 + v11 * 0.5, v9 + v13 * 0.5}];
  }
  ...
  else
  {
    ...
    [layer setPosition:{v7 + v11 * 0.5, v9 + v13 * 0.5}];
    [layer addAnimation:v28 forKey:@"animatePosition"];
  }

  [layer setBounds:{v7, v9, v11, v13}];
...
- (void)drawLayer:(id)layer inContext:(CGContext *)context
{
  ...
  if (var1)
  {
    ...
    if (*(v25 + 24))
    {
      ...
      {
        [layer bounds];
        CGContextClearRect(context, v32);
      }
