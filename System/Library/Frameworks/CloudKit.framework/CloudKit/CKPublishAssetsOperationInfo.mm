...
- (void)encodeWithCoder:(id)a3
{
  ...
  [(CKDatabaseOperationInfo *)&v22 encodeWithCoder:v4];
  ...
  objc_msgSend_encodeObject_forKey_(v4, v13, v12, @"fileNamesByAssetFieldNames");

  v16 = objc_msgSend_requestedTTL(self, v14, v15);
  objc_msgSend_encodeInt64_forKey_(v4, v17, v16, @"requestedTTL");
  v20 = objc_msgSend_URLOptions(self, v18, v19);
  objc_msgSend_encodeInt64_forKey_(v4, v21, v20, @"URLOptions");
...
- (CKPublishAssetsOperationInfo)initWithCoder:(id)a3
{
  ...
  if (v5)
  {
    ...
    v21 = objc_msgSend_decodeObjectOfClasses_forKey_(v4, v20, v19, @"fileNamesByAssetFieldNames");
    fileNamesByAssetFieldNames = v5->_fileNamesByAssetFieldNames;
    v5->_fileNamesByAssetFieldNames = v21;

    v5->_requestedTTL = objc_msgSend_decodeInt64ForKey_(v4, v23, @"requestedTTL");
    v5->_URLOptions = objc_msgSend_decodeInt64ForKey_(v4, v24, @"URLOptions");
