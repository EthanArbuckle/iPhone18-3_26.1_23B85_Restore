...
{
  v4.receiver = self;
  v4.super_class = CKFetchNotificationChangesOperation;
...
{
  v4 = a3;
  v7 = objc_msgSend_fetchNotificationChangesCompletionBlock(self, v5, v6);

  if (v7)
  {
    v10 = objc_msgSend_fetchNotificationChangesCompletionBlock(self, v8, v9);
    v13 = objc_msgSend_CKClientSuitableError(v4, v11, v12);
    (v10)[2](v10, 0, v13);

    objc_msgSend_setFetchNotificationChangesCompletionBlock_(self, v14, 0);
  }

  v15.receiver = self;
  v15.super_class = CKFetchNotificationChangesOperation;
