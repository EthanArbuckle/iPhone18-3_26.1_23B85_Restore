...
- (void)setSystemImposedInfo:(id)a3
{
  ...
  v4->_systemImposedInfo_locked = v7;
...
- (void)encodeWithCoder:(id)a3
{
  ...
  objc_msgSend_encodeObject_forKey_(v37, v8, v7, @"OperationGroupID");

  v11 = objc_msgSend_defaultConfiguration(self, v9, v10);
  objc_msgSend_encodeObject_forKey_(v37, v12, v11, @"DefaultConfiguration");

  v15 = objc_msgSend_authPromptReason(self, v13, v14);
  objc_msgSend_encodeObject_forKey_(v37, v16, v15, @"AuthPromptReason");

  v19 = objc_msgSend_name(self, v17, v18);
  objc_msgSend_encodeObject_forKey_(v37, v20, v19, @"Name");

  v23 = objc_msgSend_quantityNumber(self, v21, v22);
  objc_msgSend_encodeObject_forKey_(v37, v24, v23, @"Quantity");

  v27 = objc_msgSend_expectedSendSize(self, v25, v26);
  objc_msgSend_encodeInt64_forKey_(v37, v28, v27, @"ExpectedSendSize");
  v31 = objc_msgSend_expectedReceiveSize(self, v29, v30);
  objc_msgSend_encodeInt64_forKey_(v37, v32, v31, @"ExpectedReceiveSize");
  v35 = objc_msgSend_systemImposedInfo(self, v33, v34);
  objc_msgSend_encodeObject_forKey_(v37, v36, v35, @"SystemImposedInfo");
...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  if (v12)
  {
    ...
    v15 = objc_msgSend_copyWithZone_(v13, v14, a3);
    v16 = v12[5];
    v12[5] = v15;
    ...
    v27 = objc_msgSend_copyWithZone_(v25, v26, a3);
    v28 = v12[8];
    v12[8] = v27;

    v31 = objc_msgSend_name(self, v29, v30);
    v33 = objc_msgSend_copyWithZone_(v31, v32, a3);
    v34 = v12[6];
    v12[6] = v33;

    v37 = objc_msgSend_quantityNumber(self, v35, v36);
    v39 = objc_msgSend_copyWithZone_(v37, v38, a3);
    v40 = v12[7];
    v12[7] = v39;
    ...
    v49 = objc_msgSend_copyWithZone_(v47, v48, a3);
    v50 = v12[1];
    v12[1] = v49;
  }
