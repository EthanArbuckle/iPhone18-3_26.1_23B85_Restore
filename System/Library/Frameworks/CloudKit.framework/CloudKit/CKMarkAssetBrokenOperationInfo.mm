...
- (CKMarkAssetBrokenOperationInfo)initWithCoder:(id)coder;
...
- (void)encodeWithCoder:(id)coder
{
  ...
  [(CKDatabaseOperationInfo *)&v46 encodeWithCoder:coderCopy];
...
- (CKMarkAssetBrokenOperationInfo)initWithCoder:(id)coder
{
  ...
  if (v5)
  {
    ...
    v5->_listIndex = objc_msgSend_decodeIntegerForKey_(coderCopy, v18, v17);

    v19 = NSStringFromSelector(sel_touchRepairZone);
    v5->_touchRepairZone = objc_msgSend_decodeBoolForKey_(coderCopy, v20, v19);

    v21 = NSStringFromSelector(sel_simulateCorruptAsset);
    v5->_simulateCorruptAsset = objc_msgSend_decodeBoolForKey_(coderCopy, v22, v21);

    v23 = NSStringFromSelector(sel_bypassPCSEncryptionForTouchRepairZone);
    v5->_bypassPCSEncryptionForTouchRepairZone = objc_msgSend_decodeBoolForKey_(coderCopy, v24, v23);

    v25 = NSStringFromSelector(sel_writeRepairRecord);
    v5->_writeRepairRecord = objc_msgSend_decodeBoolForKey_(coderCopy, v26, v25);
