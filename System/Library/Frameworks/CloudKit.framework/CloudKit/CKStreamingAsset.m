...
{
  v41 = a3;
  v40 = objc_msgSend_fileSignature(v41, v4, v5);
  v8 = objc_msgSend_referenceSignature(v41, v6, v7);
  v11 = objc_msgSend_downloadURL(v41, v9, v10);
  v14 = objc_msgSend_uploadURL(v41, v12, v13);
  v17 = objc_msgSend_uploadURLExpirationDate(v41, v15, v16);
  v20 = objc_msgSend_downloadURLExpirationDate(v41, v18, v19);
  v23 = objc_msgSend_expectedSizeBytes(v41, v21, v22);
  v26 = objc_msgSend_reservedSize(v41, v24, v25);
  v29 = objc_msgSend_uploadReceipt(v41, v27, v28);
  v34 = objc_msgSend_immutableRequestOptions(v41, v30, v31);
  if (v14)
  {
  ...
  if (objc_msgSend_hasSize(v41, v32, v33))
  {
    objc_msgSend_setHasSize_(self, v35, 1);
    v38 = objc_msgSend_size(v41, v36, v37);
...
- (void)CKDescribePropertiesUsing:(id)a3
{
  ...
  objc_msgSend_addPropertyIfExists_value_shouldRedact_(v81, v7, @"owner", v6, 0);

  v10 = objc_msgSend_fileSignature(self, v8, v9);
  v13 = objc_msgSend_CKHexString(v10, v11, v12);
  objc_msgSend_addPropertyIfExists_value_shouldRedact_(v81, v14, @"fileSignature", v13, 0);

  v17 = objc_msgSend_referenceSignature(self, v15, v16);
  v20 = objc_msgSend_CKHexString(v17, v18, v19);
  objc_msgSend_addPropertyIfExists_value_shouldRedact_(v81, v21, @"referenceSignature", v20, 0);

  v24 = objc_msgSend_downloadURL(self, v22, v23);
  v27 = objc_msgSend_absoluteString(v24, v25, v26);
  objc_msgSend_addPropertyIfExists_value_shouldRedact_(v81, v28, @"downloadURL", v27, 0);

  v31 = objc_msgSend_uploadURL(self, v29, v30);
  v34 = objc_msgSend_absoluteString(v31, v32, v33);
  objc_msgSend_addPropertyIfExists_value_shouldRedact_(v81, v35, @"uploadURL", v34, 0);

  v38 = objc_msgSend_uploadURLExpirationDate(self, v36, v37);
  v41 = objc_msgSend_description(v38, v39, v40);
  objc_msgSend_addPropertyIfExists_value_shouldRedact_(v81, v42, @"uploadURLExpirationDate", v41, 0);

  v45 = objc_msgSend_downloadURLExpirationDate(self, v43, v44);
  v48 = objc_msgSend_description(v45, v46, v47);
  objc_msgSend_addPropertyIfExists_value_shouldRedact_(v81, v49, @"downloadURLExpirationDate", v48, 0);
  ...
  if (objc_msgSend_hasSize(self, v50, v51))
  {
    ...
    objc_msgSend_addProperty_value_shouldRedact_(v81, v58, @"size", v57, 0);
  }

  v59 = objc_msgSend_uploadReceipt(self, v52, v53);
  objc_msgSend_addPropertyIfExists_value_shouldRedact_(v81, v60, @"uploadReceipt", v59, 0);

  v63 = objc_msgSend_immutableRequestOptions(self, v61, v62);
  objc_msgSend_addPropertyIfExists_value_shouldRedact_(v81, v64, @"requestOptions", v63, 0);
  ...
  if (objc_msgSend_expectedSizeBytes(self, v65, v66))
  {
    ...
    objc_msgSend_addProperty_value_shouldRedact_(v81, v73, @"expectedSizeBytes", v72, 0);
  }
  ...
  if (objc_msgSend_reservedSize(self, v67, v68))
  {
    ...
    objc_msgSend_addProperty_value_shouldRedact_(v81, v80, @"reservedSize", v79, 0);
  }
}
...
- (void)encodeWithCoder:(id)a3
{
  ...
  objc_msgSend_encodeInt64_forKey_(v52, v7, v6, @"ExpectedSizeBytes");
  if (objc_msgSend_hasSize(self, v8, v9))
  {
    v12 = objc_msgSend_size(self, v10, v11);
    objc_msgSend_encodeInt64_forKey_(v52, v13, v12, @"Size");
  }

  v14 = objc_msgSend_downloadURL(self, v10, v11);
  objc_msgSend_encodeObject_forKey_(v52, v15, v14, @"DownloadURL");

  v18 = objc_msgSend_downloadURLExpirationDate(self, v16, v17);
  objc_msgSend_encodeObject_forKey_(v52, v19, v18, @"DownloadURLExpirationDate");

  v22 = objc_msgSend_fileSignature(self, v20, v21);
  objc_msgSend_encodeObject_forKey_(v52, v23, v22, @"FileSignature");

  v26 = objc_msgSend_referenceSignature(self, v24, v25);
  objc_msgSend_encodeObject_forKey_(v52, v27, v26, @"ReferenceSignature");

  v30 = objc_msgSend_owner(self, v28, v29);
  objc_msgSend_encodeObject_forKey_(v52, v31, v30, @"Owner");

  v34 = objc_msgSend_uploadURL(self, v32, v33);
  objc_msgSend_encodeObject_forKey_(v52, v35, v34, @"UploadURL");

  v38 = objc_msgSend_uploadURLExpirationDate(self, v36, v37);
  objc_msgSend_encodeObject_forKey_(v52, v39, v38, @"UploadURLExpirationDate");

  v42 = objc_msgSend_reservedSize(self, v40, v41);
  objc_msgSend_encodeInt64_forKey_(v52, v43, v42, @"ReservedSize");
  v46 = objc_msgSend_uploadReceipt(self, v44, v45);
  objc_msgSend_encodeObject_forKey_(v52, v47, v46, @"UploadReceipt");

  v50 = objc_msgSend_immutableRequestOptions(self, v48, v49);
  objc_msgSend_encodeObject_forKey_(v52, v51, v50, @"RequestOptions");
}
...
- (CKStreamingAsset)initWithCoder:(id)a3
{
  ...
  if (v6)
  {
    v6->_expectedSizeBytes = objc_msgSend_decodeInt64ForKey_(v4, v5, @"ExpectedSizeBytes");
    v7 = objc_opt_class();
    v9 = objc_msgSend_decodeObjectOfClass_forKey_(v4, v8, v7, @"DownloadURL");
    downloadURL = v6->_downloadURL;
    v6->_downloadURL = v9;

    v11 = objc_opt_class();
    v13 = objc_msgSend_decodeObjectOfClass_forKey_(v4, v12, v11, @"DownloadURLExpirationDate");
    downloadURLExpirationDate = v6->_downloadURLExpirationDate;
    v6->_downloadURLExpirationDate = v13;

    v15 = objc_opt_class();
    v17 = objc_msgSend_decodeObjectOfClass_forKey_(v4, v16, v15, @"FileSignature");
    fileSignature = v6->_fileSignature;
    v6->_fileSignature = v17;

    v19 = objc_opt_class();
    v21 = objc_msgSend_decodeObjectOfClass_forKey_(v4, v20, v19, @"ReferenceSignature");
    referenceSignature = v6->_referenceSignature;
    v6->_referenceSignature = v21;

    v23 = objc_opt_class();
    v25 = objc_msgSend_decodeObjectOfClass_forKey_(v4, v24, v23, @"Owner");
    owner = v6->_owner;
    v6->_owner = v25;

    v27 = objc_opt_class();
    v29 = objc_msgSend_decodeObjectOfClass_forKey_(v4, v28, v27, @"UploadURL");
    uploadURL = v6->_uploadURL;
    v6->_uploadURL = v29;

    v31 = objc_opt_class();
    v33 = objc_msgSend_decodeObjectOfClass_forKey_(v4, v32, v31, @"UploadURLExpirationDate");
    uploadURLExpirationDate = v6->_uploadURLExpirationDate;
    v6->_uploadURLExpirationDate = v33;

    v6->_reservedSize = objc_msgSend_decodeInt64ForKey_(v4, v35, @"ReservedSize");
    v36 = objc_opt_class();
    v38 = objc_msgSend_decodeObjectOfClass_forKey_(v4, v37, v36, @"UploadReceipt");
    uploadReceipt = v6->_uploadReceipt;
    v6->_uploadReceipt = v38;

    v40 = objc_opt_class();
    v42 = objc_msgSend_decodeObjectOfClass_forKey_(v4, v41, v40, @"RequestOptions");
    immutableRequestOptions = v6->_immutableRequestOptions;
    v6->_immutableRequestOptions = v42;

    if (objc_msgSend_containsValueForKey_(v4, v44, @"Size"))
    {
      v6->_hasSize = 1;
      v6->_size = objc_msgSend_decodeInt64ForKey_(v4, v45, @"Size");
    }
  }
