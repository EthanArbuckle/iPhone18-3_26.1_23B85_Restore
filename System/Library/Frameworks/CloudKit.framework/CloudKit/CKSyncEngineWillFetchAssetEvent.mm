@interface CKSyncEngineWillFetchAssetEvent
- (CKSyncEngineWillFetchAssetEvent)initWithAsset:(id)asset;
- (void)CKDescribePropertiesUsing:(id)using;
@end

@implementation CKSyncEngineWillFetchAssetEvent
...
- (CKSyncEngineWillFetchAssetEvent)initWithAsset:(id)asset
{
  ...
  v22.receiver = self;
  v22.super_class = CKSyncEngineWillFetchAssetEvent;
...
{
  v9.receiver = self;
  v9.super_class = CKSyncEngineWillFetchAssetEvent;
  usingCopy = using;
