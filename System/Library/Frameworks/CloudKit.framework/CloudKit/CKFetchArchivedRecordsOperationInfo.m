...
- (void)encodeWithCoder:(id)a3
{
  ...
  objc_msgSend_encodeObject_forKey_(v4, v25, v24, @"assetTransferOptionsByRecordTypeAndKey");
...
- (CKFetchArchivedRecordsOperationInfo)initWithCoder:(id)a3
{
  ...
  if (v5)
  {
    ...
    v33 = objc_msgSend_decodeObjectOfClasses_forKey_(v4, v32, v31, @"assetTransferOptionsByRecordTypeAndKey");
