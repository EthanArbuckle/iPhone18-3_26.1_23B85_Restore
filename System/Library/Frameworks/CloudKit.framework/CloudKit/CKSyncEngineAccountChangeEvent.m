...
- (CKSyncEngineAccountChangeEvent)initWithPreviousUser:(id)a3 currentUser:(id)a4
{
  ...
  v9 = [(CKSyncEngineEvent *)&v27 initInternal];
  v10 = v9;
  if (!v9)
  {
    goto LABEL_9;
  ...
  objc_storeStrong(&v10->_currentUser, a4);
  if (v8)
  {
    if (!v7)
    {
...
- (void)CKDescribePropertiesUsing:(id)a3
{
  ...
  v4 = a3;
  [(CKSyncEngineEvent *)&v17 CKDescribePropertiesUsing:v4];
  ...
  {
    objc_msgSend_addProperty_value_shouldRedact_(v4, v8, @"changeType", off_1E70C0308[v7], 0);
  }

  v11 = objc_msgSend_previousUser(self, v9, v10);
  objc_msgSend_addPropertyIfExists_value_shouldRedact_(v4, v12, @"previousUser", v11, 0);

  v15 = objc_msgSend_currentUser(self, v13, v14);
  objc_msgSend_addPropertyIfExists_value_shouldRedact_(v4, v16, @"currentUser", v15, 0);
}
