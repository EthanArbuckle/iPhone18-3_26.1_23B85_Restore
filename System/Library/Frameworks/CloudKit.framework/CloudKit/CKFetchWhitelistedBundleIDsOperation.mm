...
- (id)fetchWhitelistedBundleIDsCompletionBlock
{
  ...
  {
    v6 = _Block_copy(self->_fetchWhitelistedBundleIDsCompletionBlock);
  }
...
{
  v8.receiver = self;
  v8.super_class = CKFetchWhitelistedBundleIDsOperation;
  if ([(CKOperation *)&v8 hasCKOperationCallbacksSet])
  {
    return 1;
  }

  v6 = objc_msgSend_fetchWhitelistedBundleIDsCompletionBlock(self, v3, v4);
  v5 = v6 != 0;
...
- (void)_finishOnCallbackQueueWithError:(id)error
{
  ...
  if (v6)
  {
    ...
    {
      *buf = 0;
      _os_signpost_emit_with_name_impl(&dword_1883EA000, v13, OS_SIGNPOST_EVENT, v18, "CKFetchWhitelistedBundleIDsOperation", "Finishing", buf, 2u);
    }
  }

  v19 = objc_msgSend_fetchWhitelistedBundleIDsCompletionBlock(self, v7, v8);
...
- (void)ckSignpostBegin
{
  ...
  if (v4)
  {
    ...
    if (v14 - 1 <= 0xFFFFFFFFFFFFFFFDLL && os_signpost_enabled(v9))
    {
      ...
      v53 = 2114;
      v54 = v41;
      _os_signpost_emit_with_name_impl(&dword_1883EA000, v9, OS_SIGNPOST_INTERVAL_BEGIN, v14, "CKFetchWhitelistedBundleIDsOperation", "ID=%{signpost.description:attribute}@ Container=%{signpost.description:attribute}@ GroupID=%{signpost.description:attribute}@ GroupName=%{signpost.description:attribute,public}@ Behavior=%{signpost.description:attribute,public}@ QoS=%{signpost.description:attribute,public}@ ", &v43, 0x3Eu);
    }
  }
