...
- (void)syncEngine:(id)a3 handleEvent:(id)a4
{
  ...
  v14 = objc_msgSend_type(v7, v12, v13);
  if (v14 > 5)
  {
    if (v14 > 8)
    {
      if (v14 == 9)
      {
        ...
        {
          objc_msgSend_syncEngineDidEndFetchingChanges_(v11, v131, v6);
        }
      }
      ...
      else if (v14 == 10)
      {
        if (objc_opt_respondsToSelector())
        {
          objc_msgSend_syncEngineWillBeginModifyingPendingChanges_(v11, v198, v6);
        }
      }

      else if (v14 == 11 && (objc_opt_respondsToSelector() & 1) != 0)
      {
        objc_msgSend_syncEngineDidEndModifyingPendingChanges_(v11, v96, v6);
      }
    ...
    if (v14 == 6)
    {
      if (objc_opt_respondsToSelector())
      {
        objc_msgSend_syncEngineWillBeginFetchingChanges_(v11, v105, v6);
      }
    ...
    if (v14 == 7)
    {
      ...
      v97 = objc_msgSend_willFetchRecordZoneChangesEvent(v7, v139, v140);
      v100 = objc_msgSend_zoneID(v97, v141, v142);
      v348 = v100;
      v103 = objc_msgSend_arrayWithObjects_count_(MEMORY[0x1E695DEC8], v143, &v348, 1);
      objc_msgSend_syncEngine_willBeginFetchingChangesForZoneIDs_(v11, v144, v6, v103);
      goto LABEL_86;
    }

    v50 = objc_msgSend_didFetchRecordZoneChangesEvent(v7, v15, v16);
...
LABEL_156:
        ...
        if (v89)
        {
          ...
          objc_msgSend_syncEngine_failedToFetchChangesForRecordZoneID_error_(v11, v279, v6, v278, v89);
        }
      }
    }
    ...
    if (objc_opt_respondsToSelector())
    {
      ...
      objc_msgSend_syncEngine_didEndFetchingChangesForZoneID_(v11, v282, v6, v190);
      goto LABEL_163;
    }
  ...
  if (v14 > 2)
  {
    if (v14 == 3)
    {
      v50 = objc_msgSend_fetchedRecordZoneChangesEvent(v7, v15, v16);
      v332 = 0u;
      v333 = 0u;
      v334 = 0u;
      v335 = 0u;
      ...
      if (v110)
      {
        ...
        do
        {
          for (j = 0; j != v112; ++j)
          {
            ...
            objc_msgSend_syncEngine_didFetchRecord_(v11, v111, v6, *(*(&v332 + 1) + 8 * j));
          }
      ...
      if (v119)
      {
        ...
        do
        {
          for (k = 0; k != v122; ++k)
          {
            ...
            objc_msgSend_syncEngine_recordWithIDWasDeleted_recordType_(v11, v130, v6, v126, v129);
          }
    ...
    if (v14 != 4)
    {
      ...
      objc_msgSend_sentRecordZoneChangesEvent(v7, v92, v93);
      v309 = 0u;
      v310 = 0u;
      v311 = 0u;
      v293 = v312 = 0u;
      ...
      if (v203)
      {
        ...
        do
        {
          for (m = 0; m != v205; ++m)
          {
            ...
            v208 = *(*(&v309 + 1) + 8 * m);
            objc_msgSend_syncEngine_didSaveRecord_(v11, v204, v6, v208);
        ...
        do
        {
          for (n = 0; n != v218; ++n)
          {
            ...
            if ((v224 & 1) == 0)
            {
              ...
              objc_msgSend_syncEngine_failedToSaveRecord_error_(v11, v231, v6, v227, v230);
            }
      ...
      if (v248)
      {
        ...
        do
        {
          for (ii = 0; ii != v251; ++ii)
          {
            ...
            v254 = *(*(&v301 + 1) + 8 * ii);
            objc_msgSend_syncEngine_didDeleteRecordWithID_(v11, v249, v6, v254);
...
LABEL_152:
    ...
    v50 = objc_msgSend_sentDatabaseChangesEvent(v7, v15, v16);
      ...
      if (v154)
      {
        ...
        do
        {
          for (jj = 0; jj != v156; ++jj)
          {
            ...
            objc_msgSend_syncEngine_didSaveRecordZone_(v11, v155, v6, *(*(&v324 + 1) + 8 * jj));
          }
      ...
      if (v166)
      {
        ...
        do
        {
          for (kk = 0; kk != v169; ++kk)
          {
            ...
            objc_msgSend_syncEngine_failedToSaveRecordZone_error_(v11, v177, v6, v173, v176);
          }
...
LABEL_164:
      ...
      if (v185)
      {
        ...
        do
        {
          for (mm = 0; mm != v187; ++mm)
          {
            ...
            objc_msgSend_syncEngine_didDeleteRecordZoneWithID_(v11, v186, v6, *(*(&v316 + 1) + 8 * mm));
          }
  ...
  {
    case 0:
      v97 = objc_msgSend_stateUpdateEvent(v7, v15, v16);
      v100 = objc_msgSend_stateSerialization(v97, v98, v99);
      v103 = objc_msgSend_data(v100, v101, v102);
      objc_msgSend_syncEngine_didUpdateMetadata_(v11, v104, v6, v103);
      goto LABEL_86;
    case 1:
      if ((objc_opt_respondsToSelector() & 1) == 0)
      {
      ...
      v97 = objc_msgSend_accountChangeEvent(v7, v132, v133);
      v100 = objc_msgSend_previousUser(v97, v134, v135);
      v103 = objc_msgSend_currentUser(v97, v136, v137);
      objc_msgSend_syncEngine_accountChangedFromUserRecordID_toUserRecordID_(v11, v138, v6, v100, v103);
LABEL_86:

      break;
    case 2:
      objc_msgSend_fetchedDatabaseChangesEvent(v7, v15, v16);
      v340 = 0u;
      v341 = 0u;
      v342 = 0u;
      v291 = v343 = 0u;
        ...
        do
        {
          for (nn = 0; nn != v22; ++nn)
          {
            ...
            if (objc_opt_respondsToSelector())
            {
              ...
              objc_msgSend_syncEngine_zoneWithIDChanged_(v11, v29, v6, v28);
            }
          }
          ...
          for (i1 = 0; i1 != v37; ++i1)
          {
            ...
            if (v41 == 2)
            {
              if (objc_opt_respondsToSelector())
              {
                ...
                objc_msgSend_syncEngine_zoneWithIDWasDeletedDueToUserEncryptedDataReset_(v11, v48, v6, v44);
                goto LABEL_34;
              }
            }
            ...
            else if (v41 == 1)
            {
              if (objc_opt_respondsToSelector())
              {
                ...
                objc_msgSend_syncEngine_zoneWithIDWasPurged_(v11, v45, v6, v44);
                goto LABEL_34;
              }
            }
            ...
            objc_msgSend_syncEngine_zoneWithIDWasDeleted_(v11, v49, v6, v44);
LABEL_34:
          }
...
- (id)syncEngine:(id)a3 nextRecordZoneChangeBatchForContext:(id)a4
{
  ...
  v11 = objc_msgSend_options(v7, v9, v10);
  ...
  if (v17)
  {
    if (objc_opt_respondsToSelector())
    {
      ...
      v22 = objc_msgSend_syncEngine_nextBatchOfRecordsToModifyForZoneIDs_(v17, v21, v6, v20);
    ...
    {
      v36 = objc_opt_new();
      v39 = objc_msgSend_state(v6, v37, v38);
...
- (BOOL)syncEngine:(id)a3 shouldFetchChangesForZoneID:(id)a4
{
  ...
  if (v10)
  {
    if (objc_opt_respondsToSelector())
    {
      ChangesForZoneID = objc_msgSend_syncEngine_shouldFetchChangesForZoneID_(v10, v11, v6, v7);
    }
...
- (BOOL)syncEngine:(id)a3 shouldFetchAssetContentsForZoneID:(id)a4
{
  ...
  if (objc_opt_respondsToSelector())
  {
    AssetContentsForZoneID = objc_msgSend_syncEngine_shouldFetchAssetContentsForZoneID_(v10, v11, v6, v7);
  }
...
- (id)syncEngine:(id)a3 relatedApplicationBundleIdentifiersForZoneIDs:(id)a4 recordIDs:(id)a5
{
  ...
  if (objc_opt_respondsToSelector())
  {
    v15 = objc_msgSend_syncEngine_relatedApplicationBundleIdentifiersForZoneIDs_recordIDs_(v13, v14, v8, v9, v10);
  }
