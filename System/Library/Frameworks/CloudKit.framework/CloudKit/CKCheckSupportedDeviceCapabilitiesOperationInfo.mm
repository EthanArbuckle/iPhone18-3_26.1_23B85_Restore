...
- (CKCheckSupportedDeviceCapabilitiesOperationInfo)initWithCoder:(id)coder;
...
- (void)encodeWithCoder:(id)coder
{
  ...
  objc_msgSend_encodeObject_forKey_(coderCopy, v13, v12, @"desiredCapabilitySets");

  v16 = objc_msgSend_options(self, v14, v15);
  objc_msgSend_encodeObject_forKey_(coderCopy, v17, v16, @"options");
...
- (CKCheckSupportedDeviceCapabilitiesOperationInfo)initWithCoder:(id)coder
{
  ...
  v5 = [(CKDatabaseOperationInfo *)&v30 initWithCoder:coderCopy];
  if (v5)
  {
    ...
    v23 = objc_msgSend_decodeObjectOfClasses_forKey_(coderCopy, v22, v21, @"desiredCapabilitySets");
    desiredCapabilitySets = v5->_desiredCapabilitySets;
    v5->_desiredCapabilitySets = v23;

    v25 = objc_opt_class();
    v27 = objc_msgSend_decodeObjectOfClass_forKey_(coderCopy, v26, v25, @"options");
    options = v5->_options;
    v5->_options = v27;
