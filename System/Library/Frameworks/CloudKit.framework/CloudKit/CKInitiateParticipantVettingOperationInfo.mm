...
- (CKInitiateParticipantVettingOperationInfo)initWithCoder:(id)coder;
...
- (void)encodeWithCoder:(id)coder
{
  ...
  objc_msgSend_encodeObject_forKey_(coderCopy, v8, v7, @"ShareMetadata");
  ...
  objc_msgSend_encodeObject_forKey_(coderCopy, v16, v15, @"Address");

  v17.receiver = self;
  v17.super_class = CKInitiateParticipantVettingOperationInfo;
  [(CKOperationInfo *)&v17 encodeWithCoder:coderCopy];
}
...
- (CKInitiateParticipantVettingOperationInfo)initWithCoder:(id)coder
{
  ...
  v5 = [(CKOperationInfo *)&v19 initWithCoder:coderCopy];
  if (v5)
  {
    v6 = objc_opt_class();
    v8 = objc_msgSend_decodeObjectOfClass_forKey_(coderCopy, v7, v6, @"ShareMetadata");
    shareMetadata = v5->_shareMetadata;
    v5->_shareMetadata = v8;

    v10 = objc_opt_class();
    v12 = objc_msgSend_decodeObjectOfClass_forKey_(coderCopy, v11, v10, @"ParticipantID");
    participantID = v5->_participantID;
    v5->_participantID = v12;

    v14 = objc_opt_class();
    v16 = objc_msgSend_decodeObjectOfClass_forKey_(coderCopy, v15, v14, @"Address");
    address = v5->_address;
    v5->_address = v16;
  }
