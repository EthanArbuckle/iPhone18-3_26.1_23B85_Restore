...
- (void)encodeWithCoder:(id)a3
{
  ...
  [(CKDatabaseOperationInfo *)&v41 encodeWithCoder:v4];
  ...
  objc_msgSend_encodeObject_forKey_(v4, v40, v38, v39);
...
- (CKRepairAssetsOperationInfo)initWithCoder:(id)a3
{
  ...
  v5 = [(CKDatabaseOperationInfo *)&v67 initWithCoder:v4];
  if (v5)
  {
    ...
    v41 = objc_msgSend_decodeObjectOfClasses_forKey_(v4, v40, v38, v39);
    ...
    v50 = objc_msgSend_decodeObjectOfClasses_forKey_(v4, v49, v47, v48);
    ...
    v59 = objc_msgSend_decodeObjectOfClasses_forKey_(v4, v58, v56, v57);
