...
- (CKDistributedTimestampImmutableStateVector)initWithCoder:(id)coder;
...
- (unsigned)atomStateForTimestamp:(id)timestamp;
...
- (BOOL)hasAtomStateNotInStateVector:(id)vector
{
  ...
  objc_msgSend_minusStateVector_(v7, v8, vectorCopy);
