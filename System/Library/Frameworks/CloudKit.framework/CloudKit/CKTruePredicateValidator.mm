...
- (BOOL)validate:(id)a3 error:(id *)a4
{
  ...
  if ((objc_opt_isKindOfClass() & 1) == 0)
  {
    if (a4)
    {
      ...
      v13 = objc_msgSend_stringWithFormat_(MEMORY[0x1E696AEC0], v6, @"<%@> is not a predicate", v5);
...
LABEL_8:
  ...
  if ((isEqual & 1) == 0)
  {
    ...
    {
      v12 = MEMORY[0x1E696ABC0];
      v13 = objc_msgSend_stringWithFormat_(MEMORY[0x1E696AEC0], v11, @"Invalid predicate %@", v5, *MEMORY[0x1E696A578]);
