...
- (CKSyncEngineDidFetchChangesEvent)initWithContext:(id)context;
...
- (CKSyncEngineDidFetchChangesEvent)initWithContext:(id)context
{
  ...
  v22.receiver = self;
  v22.super_class = CKSyncEngineDidFetchChangesEvent;
...
{
  v9.receiver = self;
  v9.super_class = CKSyncEngineDidFetchChangesEvent;
  usingCopy = using;
