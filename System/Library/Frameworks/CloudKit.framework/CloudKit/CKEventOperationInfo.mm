...
- (CKEventOperationInfo)initWithOperation:(id)a3
{
  ...
  if (v7)
  {
    ...
    v21 = objc_msgSend_group(v4, v19, v20);
...
- (void)encodeWithCoder:(id)a3
{
  ...
  objc_msgSend_encodeObject_forKey_(v17, v8, v7, @"operationID");

  v11 = objc_msgSend_operationType(self, v9, v10);
  objc_msgSend_encodeObject_forKey_(v17, v12, v11, @"operationType");

  v15 = objc_msgSend_operationGroupID(self, v13, v14);
  objc_msgSend_encodeObject_forKey_(v17, v16, v15, @"groupID");
...
- (CKEventOperationInfo)initWithCoder:(id)a3
{
  ...
  if (v5)
  {
    ...
    v11 = objc_opt_class();
    v13 = objc_msgSend_decodeObjectOfClass_forKey_(v4, v12, v11, @"operationType");
    operationType = v5->_operationType;
    v5->_operationType = v13;

    v15 = objc_opt_class();
    v17 = objc_msgSend_decodeObjectOfClass_forKey_(v4, v16, v15, @"groupID");
