...
- (CKShareRequestAccessOperationInfo)initWithCoder:(id)a3;
...
- (void)encodeWithCoder:(id)a3
{
  ...
  objc_msgSend_encodeObject_forKey_(v4, v9, v8, @"ShareURLsToRequestAccessFor");
...
- (CKShareRequestAccessOperationInfo)initWithCoder:(id)a3
{
  ...
  v4 = a3;
  v17.receiver = self;
  v17.super_class = CKShareRequestAccessOperationInfo;
  ...
  if (v5)
  {
    ...
    v13 = objc_msgSend_decodeObjectOfClasses_forKey_(v4, v12, v11, @"ShareURLsToRequestAccessFor");
