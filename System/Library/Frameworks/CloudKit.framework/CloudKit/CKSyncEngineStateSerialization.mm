...
- (CKSyncEngineStateSerialization)initWithCoder:(id)coder;
- (CKSyncEngineStateSerialization)initWithData:(id)data;
...
- (void)encodeWithCoder:(id)coder
{
  ...
  objc_msgSend_encodeObject_forKey_(coderCopy, v5, data, v6);
}
...
- (void)CKDescribePropertiesUsing:(id)using
{
  ...
  objc_msgSend_addProperty_value_shouldRedact_(usingCopy, v7, @"data", v8, 0);
}
