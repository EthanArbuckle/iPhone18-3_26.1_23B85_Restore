...
- (void)encodeWithCoder:(id)a3
{
  ...
  [(CKModifyRecordsOperationInfo *)&v16 encodeWithCoder:v4];
  ...
  objc_msgSend_encodeInteger_forKey_(v4, v15, v13, v14);
...
- (CKMovePhotosOperationInfo)initWithCoder:(id)a3
{
  ...
  v5 = [(CKModifyRecordsOperationInfo *)&v20 initWithCoder:v4];
  if (v5)
  {
    ...
    v5->_sourceDatabaseScope = objc_msgSend_decodeIntegerForKey_(v4, v17, v16);
