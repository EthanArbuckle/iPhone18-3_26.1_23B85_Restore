...
- (CKSyncEngineWillFetchChangesEvent)initWithContext:(id)a3
{
  v5 = a3;
  v23 = 0;
  v6 = _CKCheckArgument("context", v5, 0, 0, 0, &v23);
  v7 = v23;
  if ((v6 & 1) == 0)
  {
    v11 = v7;
  ...
  v22.receiver = self;
  v22.super_class = CKSyncEngineWillFetchChangesEvent;
...
{
  v9.receiver = self;
  v9.super_class = CKSyncEngineWillFetchChangesEvent;
  v4 = a3;
  [(CKSyncEngineEvent *)&v9 CKDescribePropertiesUsing:v4];
  v7 = objc_msgSend_context(self, v5, v6, v9.receiver, v9.super_class);
  objc_msgSend_addProperty_value_shouldRedact_(v4, v8, @"context", v7, 0);
}
