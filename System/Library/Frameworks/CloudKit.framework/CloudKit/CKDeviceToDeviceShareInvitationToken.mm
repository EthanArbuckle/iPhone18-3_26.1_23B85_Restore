...
- (CKDeviceToDeviceShareInvitationToken)initWithCoder:(id)coder;
- (CKDeviceToDeviceShareInvitationToken)initWithSharingInvitationData:(id)data shareURL:(id)l participantID:(id)d;
...
- (void)encodeWithCoder:(id)coder
{
  ...
  objc_msgSend_encodeObject_forKey_(coderCopy, v8, v7, @"ShareInvitationData");

  v11 = objc_msgSend_shareURL(self, v9, v10);
  objc_msgSend_encodeObject_forKey_(coderCopy, v12, v11, @"ShareURL");

  v15 = objc_msgSend_participantID(self, v13, v14);
  objc_msgSend_encodeObject_forKey_(coderCopy, v16, v15, @"ParticipantID");
...
- (CKDeviceToDeviceShareInvitationToken)initWithCoder:(id)coder
{
  coderCopy = coder;
  objc_opt_class();
  if ((objc_opt_isKindOfClass() & 1) != 0 && (objc_opt_respondsToSelector() & 1) != 0 && (objc_msgSend__strictSecureDecodingEnabled(coderCopy, v5, v6) & 1) == 0)
  {
  ...
  else
  {
    ...
    v8 = objc_opt_class();
    v10 = objc_msgSend_decodeObjectOfClass_forKey_(coderCopy, v9, v8, @"ShareInvitationData");
    v11 = objc_opt_class();
    v13 = objc_msgSend_decodeObjectOfClass_forKey_(coderCopy, v12, v11, @"ShareURL");
    v14 = objc_opt_class();
    v16 = objc_msgSend_decodeObjectOfClass_forKey_(coderCopy, v15, v14, @"ParticipantID");
