...
- (BOOL)validate:(id)a3 error:(id *)a4
{
  ...
  if ((objc_opt_isKindOfClass() & 1) == 0)
  {
    ...
    v23 = objc_msgSend_stringWithFormat_(MEMORY[0x1E696AEC0], v7, @"<%@> is not an expression", v6);
  ...
  if (objc_msgSend_expressionType(v6, v7, v8) != 3)
  {
    if (!a4)
    {
      goto LABEL_15;
    ...
    v23 = objc_msgSend_stringWithFormat_(MEMORY[0x1E696AEC0], v9, @"<%@> is not a keyPath expression", v6);
  ...
  v11 = objc_msgSend_keyPath(v6, v9, v10);
  ...
  if (!v11)
  {
    if (a4)
    {
      ...
      v23 = objc_msgSend_stringWithFormat_(MEMORY[0x1E696AEC0], v12, @"'%@' is not a valid keyPath", v6);
...
LABEL_16:
  ...
  v18 = objc_msgSend_keyPath(v6, v15, v16);
  if (!a4)
  {
