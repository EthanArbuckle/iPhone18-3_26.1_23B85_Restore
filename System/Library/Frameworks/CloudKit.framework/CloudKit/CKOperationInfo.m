...
- (void)encodeWithCoder:(id)a3
{
  ...
  v7 = objc_msgSend_operationID(self, v5, v6);
  objc_msgSend_encodeObject_forKey_(v82, v8, v7, @"OperationID");

  v11 = objc_msgSend_clientQueuePriority(self, v9, v10);
  objc_msgSend_encodeInt64_forKey_(v82, v12, v11, @"QueuePriority");
  v15 = objc_msgSend_duetPreClearedMode(self, v13, v14);
  objc_msgSend_encodeInt64_forKey_(v82, v16, v15, @"DuetPreClearedMode");
  v19 = objc_msgSend_discretionaryWhenBackgroundedState(self, v17, v18);
  objc_msgSend_encodeInt64_forKey_(v82, v20, v19, @"DiscretionaryWhenBackgroundedState");
  v23 = objc_msgSend_systemScheduler(self, v21, v22);
  objc_msgSend_encodeInt64_forKey_(v82, v24, v23, @"SystemScheduler");
  v27 = objc_msgSend_backgroundTaskIdentifier(self, v25, v26);
  objc_msgSend_encodeObject_forKey_(v82, v28, v27, @"XPCActivityIdentifier");

  v31 = objc_msgSend_ckOperationClassName(self, v29, v30);
  v32 = NSStringFromSelector(sel_ckOperationClassName);
  objc_msgSend_encodeObject_forKey_(v82, v33, v31, v32);
  ...
  if (objc_opt_isKindOfClass())
  {
    ...
    objc_msgSend_encodeObject_forKey_(v82, v38, v36, v37);
  }

  isOutstandingOperation = objc_msgSend_isOutstandingOperation(self, v34, v35);
  objc_msgSend_encodeBool_forKey_(v82, v40, isOutstandingOperation, @"IsOutstanding");
  if (self)
  {
    objc_msgSend_encodeObject_forKey_(v82, v41, self->_name, @"OperationName");
  }

  else
  {
    objc_msgSend_encodeObject_forKey_(v82, v41, 0, @"OperationName");
  }

  v44 = objc_msgSend_MMCSRequestOptions(self, v42, v43);
  objc_msgSend_encodeObject_forKey_(v82, v45, v44, @"MMCSRequestOptions");

  v48 = objc_msgSend_resolvedConfiguration(self, v46, v47);
  objc_msgSend_encodeObject_forKey_(v82, v49, v48, @"ResolvedConfiguration");

  v52 = objc_msgSend_group(self, v50, v51);
  objc_msgSend_encodeObject_forKey_(v82, v53, v52, @"Group");
...
- (CKOperationInfo)initWithCoder:(id)a3
{
  ...
  if (v5)
  {
    ...
    v7 = objc_opt_class();
    v9 = objc_msgSend_decodeObjectOfClass_forKey_(v4, v8, v7, @"OperationID");
    operationID = v5->_operationID;
    v5->_operationID = v9;

    v5->_clientQueuePriority = objc_msgSend_decodeInt64ForKey_(v4, v11, @"QueuePriority");
    v5->_duetPreClearedMode = objc_msgSend_decodeInt64ForKey_(v4, v12, @"DuetPreClearedMode");
    v5->_discretionaryWhenBackgroundedState = objc_msgSend_decodeInt64ForKey_(v4, v13, @"DiscretionaryWhenBackgroundedState");
    v5->_systemScheduler = objc_msgSend_decodeInt64ForKey_(v4, v14, @"SystemScheduler");
    v15 = objc_opt_class();
    v17 = objc_msgSend_decodeObjectOfClass_forKey_(v4, v16, v15, @"XPCActivityIdentifier");
    ...
    v5->_isOutstandingOperation = objc_msgSend_decodeBoolForKey_(v4, v29, @"IsOutstanding");
    v30 = objc_opt_class();
    v32 = objc_msgSend_decodeObjectOfClass_forKey_(v4, v31, v30, @"OperationName");
    name = v5->_name;
    v5->_name = v32;

    v34 = objc_opt_class();
    v36 = objc_msgSend_decodeObjectOfClass_forKey_(v4, v35, v34, @"MMCSRequestOptions");
    MMCSRequestOptions = v5->_MMCSRequestOptions;
    v5->_MMCSRequestOptions = v36;

    v38 = objc_opt_class();
    v40 = objc_msgSend_decodeObjectOfClass_forKey_(v4, v39, v38, @"ResolvedConfiguration");
    resolvedConfiguration = v5->_resolvedConfiguration;
    v5->_resolvedConfiguration = v40;

    v42 = objc_opt_class();
    v44 = objc_msgSend_decodeObjectOfClass_forKey_(v4, v43, v42, @"Group");
    group = v5->_group;
    v5->_group = v44;

    v46 = NSStringFromSelector(sel_clientHasValidatedEntitlements);
    v5->_clientHasValidatedEntitlements = objc_msgSend_decodeBoolForKey_(v4, v47, v46);

    v48 = NSStringFromSelector(sel_requestOriginator);
    v5->_requestOriginator = objc_msgSend_decodeIntegerForKey_(v4, v49, v48);

    v5->_wantsRequestStatistics = objc_msgSend_decodeBoolForKey_(v4, v50, @"WantsRequestStatistics");
    v5->_usesAssetDownloadStagingManager = objc_msgSend_decodeBoolForKey_(v4, v51, @"UsesAssetDownloadStagingManager");
    v52 = NSStringFromSelector(sel_wantsDaemonOperationCallbacks);
    v5->_wantsDaemonOperationCallbacks = objc_msgSend_decodeBoolForKey_(v4, v53, v52);

    v54 = NSStringFromSelector(sel_wantsDaemonRequestCallbacks);
    v5->_wantsDaemonRequestCallbacks = objc_msgSend_decodeBoolForKey_(v4, v55, v54);
...
{
  v28 = a3;
  v6 = objc_msgSend_operationID(v28, v4, v5);
  objc_msgSend_setOperationID_(self, v7, v6);

  v10 = objc_msgSend_ckOperationClassName(v28, v8, v9);
  objc_msgSend_setCkOperationClassName_(self, v11, v10);

  v14 = objc_msgSend_callbackProxyEndpoint(v28, v12, v13);
  objc_msgSend_setCallbackProxyEndpoint_(self, v15, v14);

  isOutstandingOperation = objc_msgSend_isOutstandingOperation(v28, v16, v17);
  if (self)
  {
...
LABEL_5:
      ...
      self->_wantsRequestStatistics = objc_msgSend_wantsRequestStatistics(v28, v21, v22);
      goto LABEL_6;
    }
  }
  ...
  objc_msgSend_wantsRequestStatistics(v28, v19, v20);
LABEL_6:
  v25 = objc_msgSend_requestOriginator(v28, v23, v24);
  objc_msgSend_setRequestOriginator_(self, v26, v25);
  objc_msgSend_takeValuesFromParentOperationInfo_(self, v27, v28);
}

- (void)takeValuesFromParentOperationInfo:(id)a3
{
  v4 = a3;
  v7 = objc_msgSend_clientQueuePriority(v4, v5, v6);
  objc_msgSend_setClientQueuePriority_(self, v8, v7);
  v11 = objc_msgSend_duetPreClearedMode(v4, v9, v10);
  objc_msgSend_setDuetPreClearedMode_(self, v12, v11);
  v15 = objc_msgSend_discretionaryWhenBackgroundedState(v4, v13, v14);
  objc_msgSend_setDiscretionaryWhenBackgroundedState_(self, v16, v15);
  v19 = objc_msgSend_systemScheduler(v4, v17, v18);
  objc_msgSend_setSystemScheduler_(self, v20, v19);
  v23 = objc_msgSend_backgroundTaskIdentifier(v4, v21, v22);
  objc_msgSend_setBackgroundTaskIdentifier_(self, v24, v23);

  v27 = objc_msgSend_MMCSRequestOptions(v4, v25, v26);
  objc_msgSend_setMMCSRequestOptions_(self, v28, v27);

  v31 = objc_msgSend_resolvedConfiguration(v4, v29, v30);
  objc_msgSend_setResolvedConfiguration_(self, v32, v31);

  v35 = objc_msgSend_group(v4, v33, v34);
  objc_msgSend_setGroup_(self, v36, v35);

  HasValidatedEntitlements = objc_msgSend_clientHasValidatedEntitlements(v4, v37, v38);
  objc_msgSend_setClientHasValidatedEntitlements_(self, v40, HasValidatedEntitlements);
  v43 = objc_msgSend_usesAssetDownloadStagingManager(v4, v41, v42);
  objc_msgSend_setUsesAssetDownloadStagingManager_(self, v44, v43);
  v47 = objc_msgSend_wantsDaemonOperationCallbacks(v4, v45, v46);
  objc_msgSend_setWantsDaemonOperationCallbacks_(self, v48, v47);
  v51 = objc_msgSend_wantsDaemonRequestCallbacks(v4, v49, v50);
