...
+ (void)initialize;
- (CKRecordZoneNotification)initWithCoder:(id)coder;
- (CKRecordZoneNotification)initWithRemoteNotificationDictionary:(id)dictionary;
...
- (id)CKPropertiesDescription
{
  ...
  v16 = objc_msgSend_stringWithFormat_(v3, v15, @"%@, recordZoneID=%@, database=%@", cKPropertiesDescription, v10, v14);
...
- (void)encodeWithCoder:(id)coder
{
  ...
  [(CKNotification *)&v14 encodeWithCoder:coderCopy];
  v8 = objc_msgSend_recordZoneID(self, v6, v7);
  objc_msgSend_encodeObject_forKey_(coderCopy, v9, v8, @"RecordZoneID");

  v12 = objc_msgSend_databaseScope(self, v10, v11);
  objc_msgSend_encodeInt64_forKey_(coderCopy, v13, v12, @"DatabaseScope");
...
- (CKRecordZoneNotification)initWithCoder:(id)coder
{
  ...
  v5 = [(CKNotification *)&v13 initWithCoder:coderCopy];
  if (v5)
  {
    v6 = objc_autoreleasePoolPush();
    v7 = objc_opt_class();
    v9 = objc_msgSend_decodeObjectOfClass_forKey_(coderCopy, v8, v7, @"RecordZoneID");
    recordZoneID = v5->_recordZoneID;
    v5->_recordZoneID = v9;

    v5->_databaseScope = objc_msgSend_decodeInt64ForKey_(coderCopy, v11, @"DatabaseScope");
...
- (CKRecordZoneNotification)initWithRemoteNotificationDictionary:(id)dictionary
{
  ...
  v5 = [(CKNotification *)&v32 initWithRemoteNotificationDictionary:dictionaryCopy];
  v7 = v5;
  if (v5)
  {
