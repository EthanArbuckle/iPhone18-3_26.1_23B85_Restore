...
- (id)outputImage
{
  ...
  *&v11 = -1.0 / ((v25 * v25) + (v25 * v25));
  ...
  v31 = [(CIDisparityRefinementAntialiasV3 *)self antialiasKernel];
  v32 = *MEMORY[0x1E695F040];
  v33 = *(MEMORY[0x1E695F040] + 8);
  v34 = *(MEMORY[0x1E695F040] + 16);
  v35 = *(MEMORY[0x1E695F040] + 24);
  v43[0] = [(CIImage *)v28 imageByClampingToExtent];
  v43[1] = [(CIImage *)v27 imageByClampingToExtent];
  v43[2] = [(CIImage *)v26 imageByClampingToExtent];
  v43[3] = v24;
  v43[4] = v30;
  v36 = [MEMORY[0x1E695DEC8] arrayWithObjects:v43 count:5];
  v41 = @"kCIKernelOutputFormat";
  v42 = [MEMORY[0x1E696AD98] numberWithInt:2053];
  v37 = [v31 applyWithExtent:&__block_literal_global_289 roiCallback:v36 arguments:objc_msgSend(MEMORY[0x1E695DF20] options:{"dictionaryWithObjects:forKeys:count:", &v42, &v41, 1), v32, v33, v34, v35}];
  [(CIImage *)inputPreprocImage extent];
