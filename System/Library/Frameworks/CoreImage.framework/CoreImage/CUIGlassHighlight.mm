@interface CUIGlassHighlight
- (id)outputImage;
@end

@implementation CUIGlassHighlight
...
- (id)outputImage
{
  ...
  if (inputImage)
  {
    ...
    _kernel = [(CUIGlassHighlight *)self _kernel];
    if (_kernel)
    {
      v22 = _kernel;
      [(CIImage *)v4 extent];
      ...
      v37[3] = [(CUIGlassHighlightInternal *)self inputSDFZeroValue:imageByClampingToExtent];
      v37[4] = [(CUIGlassHighlightInternal *)self inputColor];
      return [objc_msgSend(v22 applyWithExtent:&__block_literal_global_121 roiCallback:objc_msgSend(MEMORY[0x1E695DEC8] arguments:{"arrayWithObjects:count:", v37, 5), x, y, width, height), "imageByCroppingToRect:", v24, v26, v28, v30}];
    }
