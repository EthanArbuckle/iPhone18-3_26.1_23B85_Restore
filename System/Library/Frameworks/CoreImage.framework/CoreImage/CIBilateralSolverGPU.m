...
- (void)_setupPipelineCache
{
  ...
  {
    if (_setupPipelineCache_onceToken != -1)
    {
      [CIBilateralSolverGPU _setupPipelineCache];
    }

    v3 = [MEMORY[0x1E696AD98] numberWithUnsignedLongLong:{-[MTLDevice registryID](self->_metalDevice, "registryID")}];
    v4 = _setupPipelineCache__pipelineDict;
    objc_sync_enter(v4);
    v5 = [_setupPipelineCache__pipelineDict objectForKeyedSubscript:v3];
    objc_sync_exit(v4);
    ...
    else
    {
      ...
      v10[1] = 3221225472;
      v10[2] = __43__CIBilateralSolverGPU__setupPipelineCache__block_invoke_2;
      v10[3] = &unk_1E75C1BA8;
      v10[4] = self;
      v11 = v3;
      [(CIBilateralSolverGPU *)self _setupPipelinesAsync:v10];
    }
  }
}
...
{
  _setupPipelineCache__pipelineDict = [MEMORY[0x1E695DF90] dictionary];
...
{
  v5 = [MEMORY[0x1E695DF70] arrayWithCapacity:9];
  for (i = 24; i != 96; i += 8)
  {
    [v5 addObject:*(*(a1 + 32) + i)];
  }

  v3 = _setupPipelineCache__pipelineDict;
  objc_sync_enter(v3);
  v4 = [MEMORY[0x1E695DEC8] arrayWithArray:v5];
  [_setupPipelineCache__pipelineDict setObject:v4 forKeyedSubscript:*(a1 + 40)];
...
- (void)_setupPipelinesAsync:(id)a3
{
  ...
  do
  {
    v10 = [objc_alloc(MEMORY[0x1E696AEC0]) initWithUTF8String:kKernelNames[v8]];
...
- (void)_setupBuffer
{
  v28 = [MEMORY[0x1E69741C0] texture2DDescriptorWithPixelFormat:53 width:self->_width height:self->_height mipmapped:0];
  v3 = 1;
  [v28 setUsage:1];
