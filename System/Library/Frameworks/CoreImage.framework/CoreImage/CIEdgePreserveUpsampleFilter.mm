...
- (id)outputImage
{
  ...
  if (result)
  {
    ...
    else
    {
      ...
      *&v12 = v9 / v5;
      *&v13 = v11 / v7;
      imageByClampingToExtent = [(CIImage *)self->inputSmallImage imageByClampingToExtent];
      ...
      imageByClampingToExtent2 = [[(CIImage *)self->inputImage imageByApplyingFilter:@"CILinearToSRGBToneCurve" withInputParameters:0] imageByClampingToExtent];
      ...
      *&v31 = *&v13 * 0.4;
      ...
      _kernelGuideCombine = [(CIEdgePreserveUpsampleFilter *)self _kernelGuideCombine];
      v34 = *v23;
      v35 = v23[1];
      v36 = v23[2];
      v37 = v23[3];
      v48[0] = v28;
      v48[1] = v32;
      v38 = [_kernelGuideCombine applyWithExtent:objc_msgSend(MEMORY[0x1E695DEC8] arguments:{"arrayWithObjects:count:", v48, 2), v34, v35, v36, v37}];
      _kernelJointUpsamp = [(CIEdgePreserveUpsampleFilter *)self _kernelJointUpsamp];
      [(CIImage *)self->inputImage extent];
      v47[0] = v15;
      v47[1] = v38;
      v47[2] = v20;
      v44 = [_kernelJointUpsamp applyWithExtent:&v45 roiCallback:objc_msgSend(MEMORY[0x1E695DEC8] arguments:{"arrayWithObjects:count:", v47, 3, MEMORY[0x1E69E9820], 3221225472, __43__CIEdgePreserveUpsampleFilter_outputImage__block_invoke, &__block_descriptor_40_e73__CGRect__CGPoint_dd__CGSize_dd__44__0i8_CGRect__CGPoint_dd__CGSize_dd__12l, __PAIR64__(v13, v12)), v40, v41, v42, v43}];
      [(CIImage *)self->inputImage extent];
