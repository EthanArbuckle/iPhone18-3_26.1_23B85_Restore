...
- (id)outputImage
{
  ...
  weightsXKernel = [(CIDisparityWeightsV3 *)self weightsXKernel];
  ...
  v21 = [objc_msgSend(objc_msgSend(weightsXKernel applyWithExtent:v38 roiCallback:v20 arguments:objc_msgSend(MEMORY[0x1E695DF20] options:{"dictionaryWithObjects:forKeys:count:", &v44, &v43, 1), v15, v16, v18, v17), "imageByCroppingToRect:", v4, v6, v34, v33), "imageByClampingToExtent"}];
  weightsYKernel = [(CIDisparityWeightsV3 *)self weightsYKernel];
  ...
  *&v28 = v35;
  ...
  return [objc_msgSend(weightsYKernel applyWithExtent:v36 roiCallback:v29 arguments:objc_msgSend(MEMORY[0x1E695DF20] options:{"dictionaryWithObjects:forKeys:count:", &v41, &v40, 1), v24, v23, v25, v26), "imageByCroppingToRect:", v32, v31, v34, v33}];
}
