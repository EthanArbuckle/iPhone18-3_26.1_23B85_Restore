...
- (id)outputImage
{
  ...
  *(v12.f64 + 1) = v22;
  ...
  v33 = [(CIGlideReflectedTile *)self _kernel];
  ...
  v47[1] = v31;
  v47[2] = v32;
  return [v33 applyWithExtent:v42 roiCallback:inputImage inputImage:objc_msgSend(MEMORY[0x1E695DEC8] arguments:{"arrayWithObjects:count:", v47, 3), v34, v35, v37, v36}];
}
