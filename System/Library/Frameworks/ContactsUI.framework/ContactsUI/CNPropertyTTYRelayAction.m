...
LABEL_9:
    ...
    if (v14)
    {
      ...
      {
        v18 = [MEMORY[0x1E695DFF8] _cnui_ttyRelayURLWithHandle:v12 contact:v11 channelIdentifier:v17];
...
LABEL_8:
    ...
    v18 = [MEMORY[0x1E695DFF8] _cnui_ttyRelayURLWithHandle:v12 contact:v11];
    goto LABEL_8;
  }
