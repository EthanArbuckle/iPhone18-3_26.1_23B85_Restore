...
- (uint64_t)updateGroupInStore:()UIAdditions saveRequest:
{
  ...
  if (!v7)
  {
    ...
    [currentHandler handleFailureInMethod:a2 object:self file:@"CNGroup+UIAdditions.m" lineNumber:55 description:@"A store is needed here"];
  }
...
- (uint64_t)deleteGroupInStore:()UIAdditions saveRequest:
{
  ...
  {
    currentHandler = [MEMORY[0x1E696AAA8] currentHandler];
    [currentHandler handleFailureInMethod:a2 object:self file:@"CNGroup+UIAdditions.m" lineNumber:35 description:@"A store is needed here"];
  }
...
- (uint64_t)addGroupInStore:()UIAdditions toContainerWithIdentifier:saveRequest:
{
  ...
  {
    currentHandler = [MEMORY[0x1E696AAA8] currentHandler];
    [currentHandler handleFailureInMethod:a2 object:self file:@"CNGroup+UIAdditions.m" lineNumber:15 description:@"A store is needed here"];
  }
  ...
  [v11 addGroup:self toContainerWithIdentifier:v10];
  v19 = 0;
