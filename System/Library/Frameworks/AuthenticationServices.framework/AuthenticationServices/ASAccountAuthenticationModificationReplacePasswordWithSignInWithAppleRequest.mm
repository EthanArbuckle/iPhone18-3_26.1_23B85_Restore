...
- (ASAccountAuthenticationModificationReplacePasswordWithSignInWithAppleRequest)initWithUser:(id)user password:(id)password extension:(id)extension serviceIdentifier:(id)identifier userInfo:(id)info;
@end
