...
- (id)description
{
  ...
  v8.receiver = self;
  v8.super_class = SPProtoCacheAssets;
  v4 = [(SPProtoCacheAssets *)&v8 description];
...
- (id)dictionaryRepresentation
{
  ...
  {
    v4 = [objc_alloc(MEMORY[0x277CBEB18]) initWithCapacity:{-[NSMutableArray count](self->_assets, "count")}];
    v13 = 0u;
    v14 = 0u;
    v15 = 0u;
    v16 = 0u;
...
- (void)copyTo:(id)a3
{
  ...
  {
    [v8 clearAssets];
    v4 = [(SPProtoCacheAssets *)self assetsCount];
    if (v4)
    {
      v5 = v4;
      for (i = 0; i != v5; ++i)
  ...
  if (v5)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        [(SPProtoCacheAssets *)self addAssets:*(*(&v10 + 1) + 8 * v8++), v10];
      }
