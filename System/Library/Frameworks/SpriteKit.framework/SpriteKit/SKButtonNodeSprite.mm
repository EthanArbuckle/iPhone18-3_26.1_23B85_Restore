...
- (SKButtonNodeSprite)initWithCoder:(id)coder;
...
- (SKButtonNodeSprite)initWithCoder:(id)coder
{
  ...
  v5 = [(SKSpriteNode *)&v10 initWithCoder:coderCopy];
  v6 = v5;
  if (v5)
  {
...
- (void)encodeWithCoder:(id)coder
{
  ...
  coderCopy = coder;
  [(SKSpriteNode *)&v5 encodeWithCoder:coderCopy];
...
- (id)copyWithZone:(_NSZone *)zone
{
  ...
  v4 = [(SKSpriteNode *)&v7 copyWithZone:zone];
