...
- (SKThreadSafeMutableDictionary)initWithNSMutableDictionary:(id)dictionary;
...
- (id)copyWithZone:(_NSZone *)zone
{
  ...
  v6 = [(NSMutableDictionary *)self->_storage copyWithZone:zone];
  v7 = *(v5 + 72);
  *(v5 + 72) = v6;
...
- (void)forwardInvocation:(id)invocation
{
  ...
  else
  {
    ...
    [(SKThreadSafeMutableDictionary *)&v5 forwardInvocation:invocationCopy];
  }
}
...
- (id)methodSignatureForSelector:(SEL)selector
{
  ...
  if (!v5)
  {
    v5 = [(NSMutableDictionary *)self->_storage methodSignatureForSelector:selector];
  }
