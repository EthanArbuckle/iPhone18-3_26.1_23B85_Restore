...
- (BOOL)parsePayloadData:(id)data
{
  ...
  else
  {
    ...
    {
      v11 = 136315138;
      v12 = "[NEIKEv2CertificatePayload parsePayloadData:]";
...
LABEL_6:
  ...
  {
    *v13 = 0;
    _os_log_error_impl(&dword_1BA83C000, v10, OS_LOG_TYPE_ERROR, "Certificate payload missing required fields", v13, 2u);
  }
