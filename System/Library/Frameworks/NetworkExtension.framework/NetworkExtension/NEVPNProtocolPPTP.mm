...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v4 = [(NEVPNProtocolPPP *)&v6 copyWithZone:a3];
...
- (void)encodeWithCoder:(id)a3
{
  ...
  [v4 encodeInt32:-[NEVPNProtocolPPTP encryptionLevel](self forKey:{"encryptionLevel", v5.receiver, v5.super_class), @"EncryptionLevel"}];
}
...
- (NEVPNProtocolPPTP)initWithCoder:(id)a3
{
  ...
  v5 = [(NEVPNProtocolPPP *)&v7 initWithCoder:v4];
  if (v5)
  {
    v5->_encryptionLevel = [v4 decodeInt32ForKey:@"EncryptionLevel"];
  }
