...
- (CTXPCAddPlanWithProvisioningRequest)initWithRequest:(id)request appName:(id)name appType:(unint64_t)type;
- (id)appName;
- (id)request;
- (unint64_t)appType;
...
- (CTXPCAddPlanWithProvisioningRequest)initWithRequest:(id)request appName:(id)name appType:(unint64_t)type
{
  ...
  v15.receiver = self;
  v15.super_class = CTXPCAddPlanWithProvisioningRequest;
...
- (void)performRequestWithHandler:(id)handler completionHandler:(id)completionHandler
{
  ...
  request = [(CTXPCAddPlanWithProvisioningRequest *)self request];
  appName = [(CTXPCAddPlanWithProvisioningRequest *)self appName];
  appType = [(CTXPCAddPlanWithProvisioningRequest *)self appType];
  ...
  v13 = v11;
  [handlerCopy addPlanWith:request appName:appName appType:appType completionHandler:v12];
}
...
+ (id)allowedClassesForArguments
{
  ...
  v7.receiver = self;
  v7.super_class = &OBJC_METACLASS___CTXPCAddPlanWithProvisioningRequest;
