...
- (void)performRequestWithHandler:(id)a3 completionHandler:(id)a4
{
  v6 = a3;
  v7 = a4;
  v8 = [(CTXPCAddPlanWithProvisioningRequest *)self request];
  v9 = [(CTXPCAddPlanWithProvisioningRequest *)self appName];
  v10 = [(CTXPCAddPlanWithProvisioningRequest *)self appType];
