...
- (CTXPCUpdateCellularPlanPropertiesRequest)initWithProperties:(id)a3 appName:(id)a4 appType:(unint64_t)a5;
- (id)appName;
- (id)properties;
- (unint64_t)appType;
...
- (void)performRequestWithHandler:(id)a3 completionHandler:(id)a4
{
  v6 = a3;
  v7 = a4;
  v8 = [(CTXPCUpdateCellularPlanPropertiesRequest *)self properties];
  v9 = [(CTXPCUpdateCellularPlanPropertiesRequest *)self appName];
  v10 = [(CTXPCUpdateCellularPlanPropertiesRequest *)self appType];
  ...
  v11 = v7;
  v13 = v11;
  [v6 updateCellularPlanProperties:v8 appName:v9 appType:v10 completionHandler:v12];
}
