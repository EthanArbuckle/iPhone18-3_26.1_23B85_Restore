...
- (CTXPCDiscoverRemoteCapabilitiesRequest)initWithContext:(id)a3 destination:(id)a4 operationID:(id)a5
{
  ...
  v15.receiver = self;
  v15.super_class = CTXPCDiscoverRemoteCapabilitiesRequest;
...
- (void)performRequestWithHandler:(id)a3 completionHandler:(id)a4
{
  ...
  v9 = [(CTXPCDiscoverRemoteCapabilitiesRequest *)self destination];
  v10 = [(CTXPCDiscoverRemoteCapabilitiesRequest *)self operationID];
...
+ (id)allowedClassesForArguments
{
  ...
  v7.receiver = a1;
  v7.super_class = &OBJC_METACLASS___CTXPCDiscoverRemoteCapabilitiesRequest;
