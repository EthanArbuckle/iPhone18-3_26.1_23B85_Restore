...
- (CTXPCAddQRCodePlanResponse)initWithResult:(unint64_t)result;
- (unint64_t)result;
@end
...
- (CTXPCAddQRCodePlanResponse)initWithResult:(unint64_t)result
{
  ...
  v9.receiver = self;
  v9.super_class = CTXPCAddQRCodePlanResponse;
...
{
  v5.receiver = self;
  v5.super_class = &OBJC_METACLASS___CTXPCAddQRCodePlanResponse;
