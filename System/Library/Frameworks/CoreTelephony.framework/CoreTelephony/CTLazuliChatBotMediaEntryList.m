...
- (BOOL)isEqualToCTLazuliChatBotMediaEntryList:(id)a3
{
  ...
  {
    v7 = [(CTLazuliChatBotMediaEntryList *)self list];
    v8 = [v4 list];
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    v6 = v4 && (objc_opt_class(), (objc_opt_isKindOfClass() & 1) != 0) && [(CTLazuliChatBotMediaEntryList *)self isEqualToCTLazuliChatBotMediaEntryList:v5];
  }
