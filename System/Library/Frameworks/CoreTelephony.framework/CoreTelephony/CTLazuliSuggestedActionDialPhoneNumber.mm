...
- (BOOL)isEqualToCTLazuliSuggestedActionDialPhoneNumber:(id)number;
- (CTLazuliSuggestedActionDialPhoneNumber)initWithCoder:(id)coder;
- (CTLazuliSuggestedActionDialPhoneNumber)initWithReflection:(const void *)reflection;
...
- (id)description
{
  ...
  phoneNumber = [(CTLazuliSuggestedActionDialPhoneNumber *)self phoneNumber];
  [v3 appendFormat:@", phoneNumber = %@", phoneNumber];

  fallbackUrl = [(CTLazuliSuggestedActionDialPhoneNumber *)self fallbackUrl];
...
- (BOOL)isEqualToCTLazuliSuggestedActionDialPhoneNumber:(id)number
{
  numberCopy = number;
  phoneNumber = [(CTLazuliSuggestedActionDialPhoneNumber *)self phoneNumber];
  phoneNumber2 = [numberCopy phoneNumber];
  if (phoneNumber != phoneNumber2)
  {
    phoneNumber3 = [(CTLazuliSuggestedActionDialPhoneNumber *)self phoneNumber];
    phoneNumber4 = [numberCopy phoneNumber];
...
LABEL_8:
  ...
  fallbackUrl = [(CTLazuliSuggestedActionDialPhoneNumber *)self fallbackUrl];
  fallbackUrl2 = [numberCopy fallbackUrl];
  v12 = fallbackUrl2;
  ...
  {
    fallbackUrl3 = [(CTLazuliSuggestedActionDialPhoneNumber *)self fallbackUrl];
    fallbackUrl4 = [numberCopy fallbackUrl];
...
- (BOOL)isEqual:(id)equal
{
  ...
  {
    v6 = equalCopy && (objc_opt_class(), (objc_opt_isKindOfClass() & 1) != 0) && [(CTLazuliSuggestedActionDialPhoneNumber *)self isEqualToCTLazuliSuggestedActionDialPhoneNumber:v5];
  }
