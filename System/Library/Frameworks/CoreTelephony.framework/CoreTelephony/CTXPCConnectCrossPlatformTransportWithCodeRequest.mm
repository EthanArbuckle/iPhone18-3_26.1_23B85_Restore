...
- (CTXPCConnectCrossPlatformTransportWithCodeRequest)initWithCode:(id)a3;
- (id)code;
...
- (void)performRequestWithHandler:(id)a3 completionHandler:(id)a4
{
  v6 = a3;
  v7 = a4;
  v8 = [(CTXPCConnectCrossPlatformTransportWithCodeRequest *)self code];
  ...
  v9 = v7;
  v11 = v9;
  [v6 connectCrossPlatformTransportWithCode:v8 completion:v10];
}
