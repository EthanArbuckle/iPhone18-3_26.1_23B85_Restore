...
- (CTXPCSendFileTransferMessageRequest)initWithContext:(id)a3 destination:(id)a4 messageID:(id)a5 descriptor:(id)a6 security:(id)a7;
- (CTXPCSendFileTransferMessageRequest)initWithContext:(id)a3 groupChatURI:(id)a4 messageID:(id)a5 descriptor:(id)a6 security:(id)a7;
- (id)security;
...
- (void)performRequestWithHandler:(id)a3 completionHandler:(id)a4
{
  ...
  v10 = [(CTXPCSendFileTransferMessageRequest *)self lazuliDescriptor];
  v11 = [(CTXPCSendFileTransferMessageRequest *)self security];
  v12 = [(CTXPCSendFileTransferMessageRequest *)self destination];
  if (v12)
  {
    ...
    v17[3] = &unk_1E6A43CC8;
    v18 = v7;
    [v6 sendFileTransferMessage:v8 to:v12 withMessageID:v9 withFileInformation:v10 withSecurity:v11 completion:v17];
    v13 = v18;
  }

  else
  {
    v13 = [(CTXPCSendFileTransferMessageRequest *)self groupChatURI];
    if (v13)
    {
      ...
      v15[3] = &unk_1E6A43CC8;
      v16 = v7;
      [v6 sendFileTransferMessage:v8 toGroupDestination:v13 withMessageID:v9 withFileInformation:v10 withSecurity:v11 completion:v15];
    }
