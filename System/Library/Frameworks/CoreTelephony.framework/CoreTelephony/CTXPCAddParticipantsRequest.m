...
- (CTXPCAddParticipantsRequest)initWithContext:(id)a3 groupChatURI:(id)a4 participants:(id)a5 operationID:(id)a6 security:(id)a7;
- (id)security;
...
- (CTXPCAddParticipantsRequest)initWithContext:(id)a3 groupChatURI:(id)a4 participants:(id)a5 operationID:(id)a6 security:(id)a7
{
  ...
  v23.receiver = self;
  v23.super_class = CTXPCAddParticipantsRequest;
...
- (void)performRequestWithHandler:(id)a3 completionHandler:(id)a4
{
  ...
  v10 = [(CTXPCAddParticipantsRequest *)self participants];
  v11 = [(CTXPCAddParticipantsRequest *)self operationID];
  v12 = [(CTXPCAddParticipantsRequest *)self security];
  ...
  v13 = v7;
  v15 = v13;
  [v6 addParticipants:v8 toGroupChat:v9 withParticipantsToAdd:v10 withOperationID:v11 withSecurity:v12 completion:v14];
}
...
+ (id)allowedClassesForArguments
{
  ...
  v7.receiver = a1;
  v7.super_class = &OBJC_METACLASS___CTXPCAddParticipantsRequest;
