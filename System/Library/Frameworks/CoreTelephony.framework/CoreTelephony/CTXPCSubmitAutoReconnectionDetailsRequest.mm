...
- (CTXPCSubmitAutoReconnectionDetailsRequest)initWithDetails:(id)a3;
- (id)details;
...
- (void)performRequestWithHandler:(id)a3 completionHandler:(id)a4
{
  v6 = a3;
  v7 = a4;
  v8 = [(CTXPCSubmitAutoReconnectionDetailsRequest *)self details];
  ...
  v9 = v7;
  v11 = v9;
  [v6 submitAutoReconnectionDetails:v8 completion:v10];
}
