...
- (CTXPCExitGroupChatRequest)initWithContext:(id)a3 groupChatURI:(id)a4 operationID:(id)a5
{
  ...
  v15.receiver = self;
  v15.super_class = CTXPCExitGroupChatRequest;
...
- (void)performRequestWithHandler:(id)a3 completionHandler:(id)a4
{
  ...
  v9 = [(CTXPCExitGroupChatRequest *)self groupChatURI];
  v10 = [(CTXPCExitGroupChatRequest *)self operationID];
...
+ (id)allowedClassesForArguments
{
  ...
  v7.receiver = a1;
  v7.super_class = &OBJC_METACLASS___CTXPCExitGroupChatRequest;
