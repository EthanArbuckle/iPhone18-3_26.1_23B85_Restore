...
- (CTXPCReportSpamRequest)initWithContext:(id)a3 destination:(id)a4 spamReportInfo:(id)a5 operationID:(id)a6
{
  ...
  v18.receiver = self;
  v18.super_class = CTXPCReportSpamRequest;
...
- (void)performRequestWithHandler:(id)a3 completionHandler:(id)a4
{
  ...
  v10 = [(CTXPCReportSpamRequest *)self spamReportInfo];
  v11 = [(CTXPCReportSpamRequest *)self operationID];
...
+ (id)allowedClassesForArguments
{
  ...
  v7.receiver = a1;
  v7.super_class = &OBJC_METACLASS___CTXPCReportSpamRequest;
