...
- (void)performRequestWithHandler:(id)handler completionHandler:(id)completionHandler
{
  ...
  v11 = v9;
  [handlerCopy getEnhancedVoiceLinkQualityMetric:context completion:v10];
}
...
void __93__CTXPCGetEnhancedVoiceLinkQualityMetricRequest_performRequestWithHandler_completionHandler___block_invoke(uint64_t a1, void *a2, void *a3)
{
  ...
  if (v7 && !v5)
  {
    v6 = [[CTXPCGetEnhancedVoiceLinkQualityMetricResponse alloc] initWithEnhancedLinkQualityMetric:v7];
  }
