...
{
  v6 = a3;
  v7 = [(CTLazuliChatBotMenuL2 *)self displayText];
  v8 = [v6 displayText];
  if (v7 != v8)
  {
    v3 = [(CTLazuliChatBotMenuL2 *)self displayText];
    v4 = [v6 displayText];
...
LABEL_8:
  ...
  v10 = [(CTLazuliChatBotMenuL2 *)self list];
  v11 = [v6 list];
  v12 = v11;
  if (v10 == v11)
  {
  ...
  {
    v13 = [(CTLazuliChatBotMenuL2 *)self list];
    v14 = [v6 list];
...
- (BOOL)isEqual:(id)a3
{
  ...
  {
    v6 = v4 && (objc_opt_class(), (objc_opt_isKindOfClass() & 1) != 0) && [(CTLazuliChatBotMenuL2 *)self isEqualToCTLazuliChatBotMenuL2:v5];
  }
