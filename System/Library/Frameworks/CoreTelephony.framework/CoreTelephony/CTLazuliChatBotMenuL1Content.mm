...
- (CTLazuliChatBotMenuL1Content)initWithReflection:(const void *)reflection
{
  ...
  if (v4)
  {
    ...
    if (v5 == 1)
    {
      ...
      *&v15[24] = 0;
      v16 = 0uLL;
      std::vector<Lazuli::ChatBotMenuL2Content>::__init_with_size[abi:nn200100]<Lazuli::ChatBotMenuL2Content*,Lazuli::ChatBotMenuL2Content*>(&v15[24], *(reflection + 4), *(reflection + 5), 0x34F72C234F72C235 * ((*(reflection + 5) - *(reflection + 4)) >> 3));
