...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  v9 = [(CTSatelliteMessagingProvisioningReceipt *)self sps_environment];
  v10 = [v9 copy];
...
- (void)encodeWithCoder:(id)a3
{
  ...
  v7 = [(CTSatelliteMessagingProvisioningReceipt *)self sps_environment];
...
- (CTSatelliteMessagingProvisioningReceipt)initWithCoder:(id)a3
{
  ...
  if (v5)
  {
    ...
    v8 = [v4 decodeObjectOfClass:objc_opt_class() forKey:@"result"];
    v9 = v5->_result;
    v5->_result = v8;
