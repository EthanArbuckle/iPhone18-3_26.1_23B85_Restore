...
- (CTXPCRevokeTokenForBundleIDRequest)initWithBundleID:(id)a3;
- (id)bundleID;
...
- (CTXPCRevokeTokenForBundleIDRequest)initWithBundleID:(id)a3
{
  ...
  v9.receiver = self;
  v9.super_class = CTXPCRevokeTokenForBundleIDRequest;
...
- (void)performRequestWithHandler:(id)a3 completionHandler:(id)a4
{
  v6 = a3;
  v7 = a4;
  v8 = [(CTXPCRevokeTokenForBundleIDRequest *)self bundleID];
  ...
  v9 = v7;
  v11 = v9;
  [v6 revokeTokenForBundleID:v8 completion:v10];
}
