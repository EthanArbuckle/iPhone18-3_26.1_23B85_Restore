...
- (NSConcreteArrayChange)initWithType:(unint64_t)type sourceIndex:(unint64_t)index destinationIndex:(unint64_t)destinationIndex value:(id)value;
- (void)dealloc;
@end
...
- (NSConcreteArrayChange)initWithType:(unint64_t)type sourceIndex:(unint64_t)index destinationIndex:(unint64_t)destinationIndex value:(id)value
{
  ...
  v13.receiver = self;
  v13.super_class = NSConcreteArrayChange;
...
- (void)dealloc
{
  ...
  v3.receiver = self;
  v3.super_class = NSConcreteArrayChange;
