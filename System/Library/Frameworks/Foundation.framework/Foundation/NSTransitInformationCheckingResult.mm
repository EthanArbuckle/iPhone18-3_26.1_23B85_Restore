...
- (void)encodeWithCoder:(id)a3
{
  v5 = [(NSTransitInformationCheckingResult *)self components];
...
- (NSTransitInformationCheckingResult)initWithCoder:(id)a3
{
  if ([a3 allowsKeyedCoding])
  {
    ...
    v10 = objc_opt_class();
    v11 = [a3 decodeObjectOfClasses:objc_msgSend(v9 forKey:{"setWithObjects:", v10, objc_opt_class(), 0), @"NSTransitInformationComponents"}];
  }
  ...
  return [(NSTransitInformationCheckingResult *)self initWithRange:v6 components:v8, v11];
}
...
- (id)resultByAdjustingRangesWithOffset:(int64_t)a3
{
  v6 = [(NSTransitInformationCheckingResult *)self range];
  v8 = v7;
