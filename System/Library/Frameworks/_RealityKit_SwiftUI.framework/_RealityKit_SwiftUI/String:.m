@interface String:
- (uint64_t)Entity.ConfigurationCatalog.ConfigurationSet;
- (void)String;
@end
...
- (void)String
{
  if (!lazy cache variable for type metadata for (Entity.ConfigurationCatalog, configurations: [String : String]?))
  {
