...
- (CLKComplicationTemplateGraphicExtraLargeCircularStackText)initWithLine1TextProvider:(CLKTextProvider *)line1TextProvider line2TextProvider:(CLKTextProvider *)line2TextProvider
{
  ...
  v11.receiver = self;
  v11.super_class = CLKComplicationTemplateGraphicExtraLargeCircularStackText;
  initPrivate = [(CLKComplicationTemplate *)&v11 initPrivate];
  v9 = initPrivate;
  if (initPrivate)
  {
    [(CLKComplicationTemplateGraphicExtraLargeCircularStackText *)initPrivate setLine1TextProvider:v6];
...
- (id)initPrivateWithJSONObjectRepresentation:(id)representation bundle:(id)bundle
{
  ...
  v10.receiver = self;
  v10.super_class = CLKComplicationTemplateGraphicExtraLargeCircularStackText;
...
{
  v7.receiver = self;
  v7.super_class = CLKComplicationTemplateGraphicExtraLargeCircularStackText;
  v4 = [(CLKComplicationTemplate *)&v7 JSONObjectRepresentationWritingResourcesToBundlePath:path purpose:0];
  v5 = [MEMORY[0x277CCABB0] numberWithBool:{-[CLKComplicationTemplateGraphicExtraLargeCircularStackText highlightLine2](self, "highlightLine2")}];
