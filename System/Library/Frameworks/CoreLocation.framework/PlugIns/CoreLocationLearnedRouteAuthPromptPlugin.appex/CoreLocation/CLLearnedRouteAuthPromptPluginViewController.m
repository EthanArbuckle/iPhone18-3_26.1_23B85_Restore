...
- (BOOL)parseUserInfo:(id)a3 error:(id *)a4;
- (BOOL)validateCoordinateDictionary:(id)a3;
- (BOOL)validateRoute:(id)a3;
- (CLLocationCoordinate2D)coordinateFromDictionary:(id)a3;
...
- (void)configureProperties
{
  ...
  {
    v25 = 0;
    v7 = [(CLLearnedRouteAuthPromptPluginViewController *)self parseUserInfo:v6 error:&v25];
    v8 = v25;
    if (v7)
    {
      ...
      {
        v19 = [(CLLearnedRouteAuthPromptPluginViewController *)self route];
        v20 = [v19 count];
        *buf = 134545665;
        *v27 = v20;
...
- (BOOL)parseUserInfo:(id)a3 error:(id *)a4
{
  ...
  v9 = [v6 objectForKeyedSubscript:@"originCoordinate"];
  objc_opt_class();
  if (objc_opt_isKindOfClass())
  {
    v10 = [v6 objectForKeyedSubscript:@"originCoordinate"];

    if (v10)
    {
      v11 = [v6 objectForKeyedSubscript:@"destinationCoordinate"];
      objc_opt_class();
      if (objc_opt_isKindOfClass())
      {
        v12 = [v6 objectForKeyedSubscript:@"destinationCoordinate"];
        ...
        if (v12)
        {
          if ([(CLLearnedRouteAuthPromptPluginViewController *)self validateCoordinateDictionary:v10])
          {
            if ([(CLLearnedRouteAuthPromptPluginViewController *)self validateCoordinateDictionary:v12])
            {
              ...
              v13 = [v6 objectForKeyedSubscript:@"route"];
              objc_opt_class();
              isKindOfClass = objc_opt_isKindOfClass();
              if (isKindOfClass)
              {
                v15 = [v6 objectForKeyedSubscript:@"route"];
              }
              ...
              v19 = [v6 objectForKeyedSubscript:@"isMockRoute"];
              -[CLLearnedRouteAuthPromptPluginViewController setIsMockRoute:](self, "setIsMockRoute:", [v19 BOOLValue]);

              v20 = [(CLLearnedRouteAuthPromptPluginViewController *)self route];
              v21 = [(CLLearnedRouteAuthPromptPluginViewController *)self validateRoute:v20];
...
- (BOOL)validateCoordinateDictionary:(id)a3
{
  ...
  v6 = [v3 objectForKeyedSubscript:@"longitude"];
  objc_opt_class();
...
- (void)configureMapView
{
  ...
  if ((+[CLLocationManager authorizationPromptMapDisplayEnabled]& 1) == 0)
  {
    ...
    v62 = [(CLAuthWithFootnoteViewController *)v63 footnoteLabelContainer];
    [v62 setHidden:1];
    goto LABEL_40;
  }
  ...
  v3 = [(CLLearnedRouteAuthPromptPluginViewController *)self originAnnotation];
  if (!v3 || ([(CLLearnedRouteAuthPromptPluginViewController *)self destinationAnnotation], v4 = objc_claimAutoreleasedReturnValue(), v5 = v4 == 0, v4, v3, v5))
  {
    if ([(CLLearnedRouteAuthPromptPluginViewController *)self didInitializationSucceed])
    {
      ...
      [v9 registerClass:objc_opt_class() forAnnotationViewWithReuseIdentifier:@"Start"];

      v10 = [(CLAuthBaseViewController *)self mapView];
      [v10 registerClass:objc_opt_class() forAnnotationViewWithReuseIdentifier:@"End"];

      v11 = [(CLAuthBaseViewController *)self mapView];
      [v11 registerClass:objc_opt_class() forAnnotationViewWithReuseIdentifier:@"Other"];
      ...
      v18 = [(CLLearnedRouteAuthPromptPluginViewController *)self originAnnotation];
      v78[0] = v18;
      v19 = [(CLLearnedRouteAuthPromptPluginViewController *)self destinationAnnotation];
      v78[1] = v19;
      v67 = [NSArray arrayWithObjects:v78 count:2];

      v20 = [(CLAuthBaseViewController *)self mapView];
      [v20 addAnnotations:v67];
      ...
      v72 = 0u;
      v73 = 0u;
      v21 = [(CLLearnedRouteAuthPromptPluginViewController *)self route];
      v22 = [v21 countByEnumeratingWithState:&v70 objects:v75 count:16];
      if (v22)
      {
        v23 = *v71;
        v69 = v21;
      ...
      v45 = [(CLAuthBaseViewController *)self mapView];
      [v45 addOverlay:v43];

      v46 = [(CLAuthBaseViewController *)self mapView];
      [v46 showAnnotations:v67 animated:0];

      v47 = [(CLAuthBaseViewController *)self mapView];
      [v47 visibleMapRect];
      v49 = v48;
      v51 = v50;
      v53 = v52;
      ...
      [v56 setVisibleMapRect:0 edgePadding:v49 animated:{v51, v53, v55, -38.0, 0.0, 38.0, 0.0}];

      v57 = [(CLLearnedRouteAuthPromptPluginViewController *)self isMockRoute];
      v58 = @"Your Route";
      if (v57)
      {
        v58 = @"Sample Route";
...
- (id)mapView:(id)a3 viewForAnnotation:(id)a4
{
  ...
  v9 = [(CLLearnedRouteAuthPromptPluginViewController *)self originAnnotation];
  v10 = v9 == v7;
  ...
  {
    v11 = [(CLLearnedRouteAuthPromptPluginViewController *)self destinationAnnotation];
    v12 = v11 == v7;
  ...
  v17 = [v16 dequeueReusableAnnotationViewWithIdentifier:v15 forAnnotation:v7];
...
- (id)mapView:(id)a3 rendererForOverlay:(id)a4
{
  ...
  if (objc_opt_isKindOfClass())
  {
    ...
    v12 = [v8 title];
    v13 = [v12 isEqualToString:@"border"];
...
LABEL_26:
    ...
    v16 = [v8 title];
    v17 = [v16 isEqualToString:@"stroke"];
