void sub_100002D0C(_Unwind_Exception *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, id a10)
{
  v13 = v12;
...
void sub_1000050E4(_Unwind_Exception *a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, void *a9, uint64_t a10, uint64_t a11, void *__p, uint64_t a13)
{
  if (__p)
  {
    operator delete(__p);
...
double sub_100006178(double **a1)
{
  __src = 0;
  v32 = 0;
  v33 = 0;
...
void sub_100006428(_Unwind_Exception *exception_object, int a2, int a3, int a4, int a5, int a6, int a7, int a8, uint64_t a9, void *__p, uint64_t a11)
{
  if (__p)
  {
    operator delete(__p);
...
uint64_t sub_100007EE8(uint64_t result, uint64_t a2, uint64_t a3, unint64_t a4)
{
  if (a4)
  {
    sub_100007F64(result, a4);
  }

  return result;
}

void sub_100007F48(_Unwind_Exception *exception_object)
{
  v3 = *v1;
  if (*v1)
  {
...
void sub_100007F64(uint64_t a1, unint64_t a2)
{
  if (!(a2 >> 59))
  {
    sub_100008048(a1, a2);
...
void sub_100007FB8(const char *a1)
{
  exception = __cxa_allocate_exception(0x10uLL);
  sub_100008014(exception, a1);
}

std::logic_error *sub_100008014(std::logic_error *a1, const char *a2)
{
  result = std::logic_error::logic_error(a1, a2);
  return result;
}

void sub_100008048(uint64_t a1, unint64_t a2)
{
  if (!(a2 >> 59))
  {
    operator new();
...
__n128 sub_1000080C4(uint64_t a1, __n128 *a2, uint64_t a3, char a4, __n128 result)
{
LABEL_1:
...
LABEL_179:
    ...
    if (v13 == 5)
    {
      ...
      result.n128_u64[0] = sub_100008CD4(v12, (v12 + 32), (v12 + 64), (v12 + 96), a2 - 2, result).n128_u64[0];
      return result;
    }
...
LABEL_58:
    ...
    if ((a4 & 1) != 0 || *(v12 - 32) < v64)
    {
      ...
      *(v12 - 24) = v152;
      ...
      v76 = sub_100008E60(a1, v12 - 32, v152);
      if (sub_100008E60(v12, a2, v77))
      {
        a2 = (v12 - 32);
        if (!v76)
        {
      ...
      {
LABEL_79:
        sub_1000080C4(a1, v12 - 32, a3, a4 & 1);
        a4 = 0;
      }
    }
...
__n128 sub_100008CD4(__n128 *a1, __n128 *a2, __n128 *a3, __n128 *a4, __n128 *a5, __n128 result)
{
  v6 = a2->n128_f64[0];
  v7 = a3->n128_f64[0];
...
BOOL sub_100008E60(uint64_t a1, uint64_t a2, __n128 a3)
{
  v3 = (a2 - a1) >> 5;
  if (v3 > 2)
  {
...
LABEL_50:
    ...
    if (v3 != 4)
    {
      ...
      sub_100008CD4(a1, (a1 + 32), (a1 + 64), (a1 + 96), (a2 - 32), a3);
      return 1;
    }
...
void sub_1000091E0(id a1)
{
  qword_100015B18 = os_log_create("com.apple.corelocation.CoreLocationMapLNPromptPlugin", "Prompt");

  _objc_release_x1();
}

void sub_100009224(uint64_t a1, unint64_t a2)
{
  if (!(a2 >> 60))
  {
    operator new();
...
void sub_10000926C(uint64_t a1, unint64_t a2)
{
...
uint64_t sub_1000092C4(uint64_t result, uint64_t a2, uint64_t a3, unint64_t a4)
{
  if (a4)
  {
    sub_100009340(result, a4);
  }

  return result;
}

void sub_100009324(_Unwind_Exception *exception_object)
{
  v3 = *v1;
  if (*v1)
  {
...
void sub_100009340(uint64_t a1, unint64_t a2)
{
  if (!(a2 >> 60))
  {
    sub_100009224(a1, a2);
