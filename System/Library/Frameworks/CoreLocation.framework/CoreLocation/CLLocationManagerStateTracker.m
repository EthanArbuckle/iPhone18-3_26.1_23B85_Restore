...
- (void)dealloc
{
  ...
  if (os_log_type_enabled(qword_1ED519080, OS_LOG_TYPE_DEBUG))
  {
    *buf = 68290562;
    ...
    v13 = "LocationManager";
    v14 = 2050;
    v15 = [(CLLocationManagerStateTracker *)self identifier];
    v16 = 2082;
    v17 = "lifecycle";
    v18 = 2050;
    v19 = self;
...
- (CLLocationManagerStateTracker)initWithQueue:(id)a3 identifier:(void *)a4 state:(id)a5
{
  ...
  v7 = [(CLStateTracker *)&v17 initWithQueue:a3];
  v8 = v7;
  if (!v7)
  {
    goto LABEL_11;
...
LABEL_5:
  ...
  if (os_log_type_enabled(qword_1ED519080, OS_LOG_TYPE_DEBUG))
  {
    v10 = [(CLLocationManagerStateTracker *)v8 identifier];
    *buf = 68290562;
    v19 = 0;
    v20 = 2082;
    v21 = "";
...
LABEL_7:
  ...
  if (os_log_type_enabled(qword_1ED519080, OS_LOG_TYPE_DEBUG))
  {
    v12 = [(CLLocationManagerStateTracker *)v8 identifier];
    *buf = 68290562;
    v19 = 0;
    v20 = 2082;
    v21 = "";
  ...
  if (self->_inTransaction)
  {
    ...
    if (os_log_type_enabled(qword_1ED519080, OS_LOG_TYPE_INFO))
    {
      *buf = 68289539;
      ...
      v19 = 2081;
      v20 = "!_inTransaction";
      _os_log_impl(&dword_19B873000, &v6->super.super, OS_LOG_TYPE_INFO, "{msg%{public}.0s:Already in a transaction. LocationManager threading bug?, event:%{public, location:escape_only}s, condition:%{private, location:escape_only}s}", buf, 0x26u);
    }
...
LABEL_3:
  ...
  if (os_log_type_enabled(qword_1ED519080, OS_LOG_TYPE_DEBUG))
  {
    v8 = [(CLLocationManagerStateTracker *)v6 identifier];
    *buf = 68291074;
    v14 = 0;
    v15 = 2082;
    v16 = "";
