@interface MTL4FXTemporalDenoisedScaler
@end

@implementation MTL4FXTemporalDenoisedScaler

id __58___MTL4FXTemporalDenoisedScaler__emitTelemetry_forDevice___block_invoke(void *a1)
{
