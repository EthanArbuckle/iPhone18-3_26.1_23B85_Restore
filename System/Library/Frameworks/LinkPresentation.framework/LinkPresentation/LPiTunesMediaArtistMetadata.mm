...
- (id)copyWithZone:(_NSZone *)a3
{
  ...
  if (v4)
  {
    ...
    v8 = [(LPiTunesMediaArtistMetadata *)self genre];
    ...
    v10 = [(LPiTunesMediaArtistMetadata *)self artworkMetadata];
...
{
  v4 = a3;
  v5 = [v4 commonPresentationPropertiesForStyle:7];
  ...
  v10 = [(LPiTunesMediaArtistMetadata *)self artwork];
...
- (id)previewSummaryForTransformer:(id)a3
{
  ...
  v6 = [(LPiTunesMediaArtistMetadata *)self name];
...
{
  v6 = a3;
  v4 = [(LPiTunesMediaArtistMetadata *)self name];
  [v6 setTitle:v4];

  v5 = [(LPiTunesMediaArtistMetadata *)self artwork];
  [v6 setImage:v5];
}
