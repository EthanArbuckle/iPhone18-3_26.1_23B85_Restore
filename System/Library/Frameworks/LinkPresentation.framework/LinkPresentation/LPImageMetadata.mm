...
- (LPImageMetadata)initWithCoder:(id)coder;
...
{
  v6.receiver = self;
  v6.super_class = LPImageMetadata;
...
- (LPImageMetadata)initWithCoder:(id)coder
{
  coderCopy = coder;
  v16.receiver = self;
  v16.super_class = LPImageMetadata;
...
- (BOOL)isEqual:(id)equal
{
  equalCopy = equal;
  v9.receiver = self;
  v9.super_class = LPImageMetadata;
  if ([(LPImageMetadata *)&v9 isEqual:equalCopy])
  {
    v5 = 1;
  }
