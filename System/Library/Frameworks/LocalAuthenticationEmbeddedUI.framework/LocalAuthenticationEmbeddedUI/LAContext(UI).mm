...
- (void)evaluateAccessControl:()UI operation:options:presentationContext:reply:
{
  ...
  v21 = v17;
  v25 = v21;
  [self evaluateAccessControl:a3 operation:a4 options:v21 reply:v22];
...
- (void)_authenticateWithOptions:()UI acl:availableMechanisms:hostVC:context:operation:updatedOptions:reply:
{
  ...
  v24 = v20;
  v26 = v24;
  [uiHelper authenticateWithOptions:v16 availableMechanisms:v17 hostVC:v18 context:v19 reply:v25];
...
- (void)_validateAvailableMechanims:()UI completion:
{
  ...
  {
    mEMORY[0x277D240F8] = [MEMORY[0x277D240F8] sharedInstance];
    faceIDServiceName = [MEMORY[0x277D240F8] faceIDServiceName];
    ...
    v10 = v5;
    v11 = v6;
    [mEMORY[0x277D240F8] requestAuthorizationForService:faceIDServiceName completion:v9];
  }
