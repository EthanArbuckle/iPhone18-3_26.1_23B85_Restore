...
{
  v4.receiver = self;
  v4.super_class = CMFitnessMachineInternal;
  v2 = [(CMFitnessMachineInternal *)&v4 init];
  if (v2)
  {
    v2->fInternalQueue = dispatch_queue_create("com.apple.CoreMotion.CMFitnessMachine", 0);
    operator new();
  }
...
- (void)dealloc
{
  ...
  v3.receiver = self;
  v3.super_class = CMFitnessMachineInternal;
