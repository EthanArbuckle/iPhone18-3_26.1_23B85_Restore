...
LABEL_18:
    v25 = objc_msgSend_currentHandler(MEMORY[0x1E696AAA8], a2, id);
...
LABEL_3:
  if (objc_msgSend_count(workouts, a2, id) >= 2)
  {
    ...
    v28 = 0u;
    v29 = 0u;
    v9 = objc_msgSend_countByEnumeratingWithState_objects_count_(workouts, v8, &v28, v32, 16);
    if (v9)
    {
      v12 = v9;
      v13 = *v29;
      do
      {
        ...
        v12 = objc_msgSend_countByEnumeratingWithState_objects_count_(workouts, v10, &v28, v32, 16);
      }
