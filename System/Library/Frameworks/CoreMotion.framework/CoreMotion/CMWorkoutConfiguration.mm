...
- (CMWorkoutConfiguration)initWithCoder:(id)coder;
...
- (BOOL)isEqual:(id)equal
{
  ...
  objc_opt_class();
  return (objc_opt_isKindOfClass() & 1) != 0 && self->_workoutType == *(equal + 1) && self->_locationType == *(equal + 2);
}
...
- (void)encodeWithCoder:(id)coder
{
  objc_msgSend_encodeInteger_forKey_(coder, a2, self->_workoutType, @"kCMWorkoutConfigurationDataCodingKeyWorkoutType");
  locationType = self->_locationType;

  objc_msgSend_encodeInteger_forKey_(coder, v5, locationType, @"kCMWorkoutConfigurationDataCodingKeyLocationType");
}
...
- (CMWorkoutConfiguration)initWithCoder:(id)coder
{
  ...
  if (v5)
  {
    v5->_workoutType = objc_msgSend_decodeIntegerForKey_(coder, v4, @"kCMWorkoutConfigurationDataCodingKeyWorkoutType");
    v5->_locationType = objc_msgSend_decodeIntegerForKey_(coder, v6, @"kCMWorkoutConfigurationDataCodingKeyLocationType");
  }
...
- (id)copyWithZone:(_NSZone *)zone
{
  v4 = objc_msgSend_allocWithZone_(CMWorkoutConfiguration, a2, zone);
