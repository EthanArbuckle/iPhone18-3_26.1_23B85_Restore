...
- (id)featureValueForName:(id)a3
{
  ...
  if ([v4 isEqualToString:@"input_1"])
  {
    ...
    v6 = [(SNSoundPrintAShoutingModelOutput *)self input];
LABEL_9:
    v7 = v6;
  ...
  {
    v5 = MEMORY[0x1E695FE60];
    v6 = [(SNSoundPrintAShoutingModelOutput *)self Confidence];
    goto LABEL_9;
  }
  ...
  {
    v5 = MEMORY[0x1E695FE60];
    v6 = [(SNSoundPrintAShoutingModelOutput *)self Detected];
    goto LABEL_9;
  }
  ...
  {
    v5 = MEMORY[0x1E695FE60];
    v6 = [(SNSoundPrintAShoutingModelOutput *)self detectedHistoryOut];
    goto LABEL_9;
  }
