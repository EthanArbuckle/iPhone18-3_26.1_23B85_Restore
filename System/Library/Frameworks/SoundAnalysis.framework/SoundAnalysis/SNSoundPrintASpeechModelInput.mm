...
- (SNSoundPrintASpeechModelInput)initWithInput1:(id)input1 stateIn:(id)in detectedHistoryIn:(id)historyIn;
...
- (id)featureValueForName:(id)name
{
  ...
  if ([nameCopy isEqualToString:@"input1"])
  {
    ...
    input1 = [(SNSoundPrintASpeechModelInput *)self input1];
...
LABEL_11:
  ...
  {
    input1 = [(SNSoundPrintASpeechModelInput *)self stateIn];
    if (input1)
    {
      v8 = MEMORY[0x1E695FE60];
      stateIn = [(SNSoundPrintASpeechModelInput *)self stateIn];
LABEL_9:
      v10 = stateIn;
  ...
  {
    input1 = [(SNSoundPrintASpeechModelInput *)self detectedHistoryIn];
    if (input1)
    {
      v8 = MEMORY[0x1E695FE60];
      stateIn = [(SNSoundPrintASpeechModelInput *)self detectedHistoryIn];
      goto LABEL_9;
    }
