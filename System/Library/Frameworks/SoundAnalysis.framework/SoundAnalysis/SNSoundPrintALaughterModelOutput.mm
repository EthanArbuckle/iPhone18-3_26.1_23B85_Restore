...
- (SNSoundPrintALaughterModelOutput)initWithInput_1:(id)input_1 Confidence:(id)confidence Detected:(id)detected detectedHistoryOut:(id)out;
...
- (id)featureValueForName:(id)name
{
  ...
  if ([nameCopy isEqualToString:@"input_1"])
  {
    ...
    input = [(SNSoundPrintALaughterModelOutput *)self input];
LABEL_9:
    v7 = input;
  ...
  {
    v5 = MEMORY[0x1E695FE60];
    input = [(SNSoundPrintALaughterModelOutput *)self Confidence];
    goto LABEL_9;
  }
  ...
  {
    v5 = MEMORY[0x1E695FE60];
    input = [(SNSoundPrintALaughterModelOutput *)self Detected];
    goto LABEL_9;
  }
  ...
  {
    v5 = MEMORY[0x1E695FE60];
    input = [(SNSoundPrintALaughterModelOutput *)self detectedHistoryOut];
    goto LABEL_9;
  }
