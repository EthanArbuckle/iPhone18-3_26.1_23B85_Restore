...
- (id)predictionFromFeatures:(id)a3 error:(id *)a4
{
  ...
  v9 = [(SNSoundPrintAEmbeddingModel *)self predictionFromFeatures:v7 options:v8 error:a4];
...
- (id)predictionFromFeatures:(id)a3 options:(id)a4 error:(id *)a5
{
  v8 = a4;
  v9 = a3;
  v10 = [(SNSoundPrintAEmbeddingModel *)self model];
...
- (void)predictionFromFeatures:(id)a3 completionHandler:(id)a4
{
  v6 = a4;
  v7 = a3;
  v8 = [(SNSoundPrintAEmbeddingModel *)self model];
  v10[0] = MEMORY[0x1E69E9820];
  v10[1] = 3221225472;
  v10[2] = sub_1C9A84174;
  v10[3] = &unk_1E8347738;
...
- (void)predictionFromFeatures:(id)a3 options:(id)a4 completionHandler:(id)a5
{
  ...
  v9 = a4;
  v10 = a3;
  v11 = [(SNSoundPrintAEmbeddingModel *)self model];
...
{
  v6 = a3;
  v7 = [[SNSoundPrintAEmbeddingModelInput alloc] initWithAudioSamples:v6];

  v8 = [(SNSoundPrintAEmbeddingModel *)self predictionFromFeatures:v7 error:a4];
