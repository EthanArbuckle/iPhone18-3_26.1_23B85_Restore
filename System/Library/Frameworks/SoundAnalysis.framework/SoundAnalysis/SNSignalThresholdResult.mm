...
- ($E36B78CDAC119E0352F6B513F3BB0FF8)timeRange
{
  SNSignalThresholdResult.timeRange.getter(v9);
  v5 = v12;
  v6 = v11;
  v7 = v10;
  v8 = v9[1];
...
- (void)setTimeRange:(id *)range
{
  ...
  v6 = *&range->var1.var1;
  v7 = var3;
  SNSignalThresholdResult.timeRange.setter(v4);
}
...
- (BOOL)isEqual:(id)equal
{
  ...
  v6 = SNSignalThresholdResult.isEqual(_:)(v8);
...
- (void)encodeWithCoder:(id)coder
{
  coderCopy = coder;
  selfCopy = self;
  SNSignalThresholdResult.encode(with:)(coderCopy);
}
