...
- (NIRegionPredicate)initWithName:(id)name radius:(float)radius preferredUpdateRate:(int64_t)rate
{
  ...
  if (!nameCopy)
  {
    ...
    [currentHandler handleFailureInMethod:a2 object:self file:@"NIRegionPredicate.mm" lineNumber:22 description:{@"Invalid parameter not satisfying: %@", @"name"}];
  }

  if (radius <= 0.0)
  {
    currentHandler2 = [MEMORY[0x1E696AAA8] currentHandler];
    [currentHandler2 handleFailureInMethod:a2 object:self file:@"NIRegionPredicate.mm" lineNumber:23 description:@"radius must be larger than 0"];
  }
...
- (NIRegionPredicate)initWithName:(id)name devicePresencePreset:(int64_t)preset
{
  ...
  {
    currentHandler = [MEMORY[0x1E696AAA8] currentHandler];
    [currentHandler handleFailureInMethod:a2 object:self file:@"NIRegionPredicate.mm" lineNumber:42 description:{@"Invalid parameter not satisfying: %@", @"name"}];
  ...
  currentHandler2 = [MEMORY[0x1E696AAA8] currentHandler];
  [currentHandler2 handleFailureInMethod:a2 object:self file:@"NIRegionPredicate.mm" lineNumber:43 description:@"device presence preset cannot be unspecified"];
