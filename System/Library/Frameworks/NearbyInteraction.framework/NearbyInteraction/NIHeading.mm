...
- (unint64_t)hash
{
  ...
  v5 = [MEMORY[0x1E696AD98] numberWithDouble:self->_trueHeading];
  v6 = [v5 hash];
  v7 = [MEMORY[0x1E696AD98] numberWithDouble:self->_magneticHeading];
  v8 = [v7 hash];
  v9 = [MEMORY[0x1E696AD98] numberWithDouble:self->_headingAccuracy];
  v10 = v6 ^ v4;
  v11 = v8 ^ [v9 hash];
...
- (id)descriptionInternal
{
  ...
  {
    v3 = [MEMORY[0x1E696AEC0] stringWithFormat:@"%.1fdeg", *&self->_trueHeading];
    v4 = [MEMORY[0x1E696AEC0] stringWithFormat:@"%.1fdeg", *&self->_magneticHeading];
    v5 = [MEMORY[0x1E696AEC0] stringWithFormat:@"%.1fdeg", *&self->_headingAccuracy];
    v6 = [MEMORY[0x1E696AEC0] stringWithFormat:@"Time: %@. TrueHeading: %@. MagHeading: %@. HeadingAcc: %@", self->_timestamp, v3, v4, v5];
  }
