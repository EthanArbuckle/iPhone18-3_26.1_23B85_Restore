...
- (BOOL)isEqualToExtension:(id)a3
{
  ...
  if (objc_opt_isKindOfClass())
  {
    if (a3)
    {
      if ([(NSString *)self->_predicateString isEqualToString:objc_getProperty(a3, v6, 16, 1)]&& [(NSSQLProperty *)self->_attribute isEqual:objc_getProperty(a3, v7, 32, 1)])
      {
        entity = self->_entity;
...
- (BOOL)validate:(id *)a3
{
  ...
  if (self)
  {
    ...
    {
      v6 = [(NSSQLColumn *)self->_attribute columnName];
      v7 = [(NSSQLEntity *)self->_entity tableName];
      v104 = [(NSSQLEntity *)self->_destinationEntity tableName];
      v102 = [MEMORY[0x1E696AEC0] stringWithFormat:@"ZT_%@_%@_%@", v7, v6, v104];
      entity = self->_entity;
      if (entity)
      {
      ...
      v10 = [(NSSQLColumn *)primaryKey columnName];
      v11 = self->_entity;
      if (v11)
      {
      ...
      v101 = [(NSSQLColumn *)entityKey columnName];
      v103 = objc_opt_new();
      relationship = self->_relationship;
      if (relationship && LOBYTE(relationship->length) == 9)
      {
        v14 = [(NSSQLRelationship *)self->_relationship correlationTableName];
        v15 = [(__CFString *)relationship columnName];
        v100 = [(NSSQLManyToMany *)relationship inverseColumnName];
        v16 = objc_alloc_init(MEMORY[0x1E696AD60]);
        v17 = [objc_alloc(MEMORY[0x1E696AEC0]) initWithFormat:@"%@_%@_INSERT_INCREMENT", v102, v14];
        ...
        [v16 appendFormat:@" WHERE NEW.%@ IN (SELECT %@ FROM %@ WHERE %@)", v100, v10, v104, self->_mToManyInnerFetchWhereClause];
        [v16 appendFormat:@" AND NEW.%@ = %@;", v15, v10];
        [v16 appendFormat:@" SELECT NSCoreDataTriggerUpdateAffectedObjectValue('%@', %@, %@, '%@', %@) FROM %@ WHERE %@ = NEW.%@;", v7, v101, v10, v6, v6, v7, v10, v15];
        [v16 appendFormat:@" END"];
        [(NSMutableArray *)self->_mSqlDropStrings addObject:v18];

        [v103 addObject:v16];
        v19 = objc_alloc_init(MEMORY[0x1E696AD60]);
        v20 = [objc_alloc(MEMORY[0x1E696AEC0]) initWithFormat:@"%@_UPDATE_INCREMENT", v102];
        ...
        [v19 appendFormat:@" AFTER UPDATE OF %@ ON %@ FOR EACH ROW", self->_mOfClause, v104];
        ...
        [v19 appendFormat:@" WHERE %@ IN (SELECT %@ FROM %@ WHERE %@ = NEW.%@ AND (%@));", v10, v15, v14, v100, v10, self->_mNewMatchingClause];
        [v19 appendFormat:@" SELECT NSCoreDataTriggerUpdateAffectedObjectValue('%@', %@, %@, '%@', %@) FROM %@ WHERE %@ = NEW.%@;", v7, v101, v10, v6, v6, v7, v10, v10];
        [v19 appendString:@" END"];
        [v103 addObject:v19];
        [(NSMutableArray *)self->_mSqlDropStrings addObject:v21];

        v22 = objc_alloc_init(MEMORY[0x1E696AD60]);
        v23 = [objc_alloc(MEMORY[0x1E696AEC0]) initWithFormat:@"%@_UPDATE_DECREMENT", v102];
        ...
        [v22 appendFormat:@" AFTER UPDATE OF %@ ON %@ FOR EACH ROW", self->_mOfClause, v104];
        ...
        [v22 appendFormat:@" WHERE %@ IN (SELECT %@ FROM %@ WHERE %@ = NEW.%@ AND (%@));", v10, v15, v14, v100, v10, self->_mOldMatchingClause];
        [v22 appendFormat:@" SELECT NSCoreDataTriggerUpdateAffectedObjectValue('%@', %@, %@, '%@', %@) FROM %@ WHERE %@ = NEW.%@;", v7, v101, v10, v6, v6, v7, v10, v10];
        [v22 appendString:@" END"];
        [v103 addObject:v22];
        [(NSMutableArray *)self->_mSqlDropStrings addObject:v24];

        v25 = objc_alloc_init(MEMORY[0x1E696AD60]);
        v26 = [objc_alloc(MEMORY[0x1E696AEC0]) initWithFormat:@"%@_%@_DELETE_DECREMENT", v102, v14];
        ...
        [v25 appendFormat:@" WHERE OLD.%@ IN (SELECT %@ FROM %@ WHERE %@)", v100, v10, v104, self->_mToManyInnerFetchWhereClause];
        [v25 appendFormat:@" AND OLD.%@ = %@;", v15, v10];
        [v25 appendFormat:@" SELECT NSCoreDataTriggerUpdateAffectedObjectValue('%@', %@, %@, '%@', %@) FROM %@ WHERE %@ = OLD.%@;", v7, v101, v10, v6, v6, v7, v10, v15];
        [v25 appendFormat:@" END"];
        [v103 addObject:v25];
        [(NSMutableArray *)self->_mSqlDropStrings addObject:v27];

        v28 = objc_alloc_init(MEMORY[0x1E696AD60]);
        v29 = [objc_alloc(MEMORY[0x1E696AEC0]) initWithFormat:@"%@_DELETE_DECREMENT", v102];
        v30 = [objc_alloc(MEMORY[0x1E696AEC0]) initWithFormat:@"DROP TRIGGER IF EXISTS %@", v29];
        [v28 appendFormat:@"CREATE TRIGGER IF NOT EXISTS %@ AFTER DELETE ON %@ FOR EACH ROW WHEN %@", v29, v104, self->_mOldMatchingClause];
        [v28 appendFormat:@" BEGIN"];
        [v28 appendFormat:@" UPDATE %@ SET %@ = MAX(0, IFNULL(%@, 0) - 1)", v7, v6, v6];
        [v28 appendFormat:@" WHERE %@ IN (SELECT %@ FROM %@ WHERE %@ = OLD.%@ AND (%@));", v10, v15, v14, v100, v10, self->_mOldMatchingClause];
        [v28 appendFormat:@" SELECT NSCoreDataTriggerUpdateAffectedObjectValue('%@', %@, %@, '%@', %@) FROM %@ WHERE %@ = OLD.%@;", v7, v101, v10, v6, v6, v7, v10, v10];
        [v28 appendFormat:@" END"];
        [v103 addObject:v28];
        [(NSMutableArray *)self->_mSqlDropStrings addObject:v30];

        v31 = [objc_alloc(MEMORY[0x1E696AEC0]) initWithFormat:@"COUNT_%@", v102];
        v32 = [objc_alloc(MEMORY[0x1E696AD60]) initWithFormat:@"CREATE TEMP TABLE %@ AS", v31];
        [v32 appendFormat:@" SELECT %@, COUNT(DISTINCT(%@.%@)) AS COUNT", v15, v104, v10];
        [v32 appendFormat:@" FROM %@, %@", v104, v14];
        [v32 appendFormat:@" WHERE %@ AND %@.%@ == %@.%@", self->_mToManyInnerFetchWhereClause, v14, v100, v104, v10];
        ...
        v34 = [objc_alloc(MEMORY[0x1E696AD60]) initWithFormat:@" CREATE INDEX %@_INDEX ON %@(%@, COUNT);", v31, v31, v15];
        [(NSMutableArray *)self->_mBulkChangeStrings addObject:v34];

        v35 = [objc_alloc(MEMORY[0x1E696AD60]) initWithFormat:@" UPDATE %@ SET %@ = IFNULL((SELECT COUNT FROM %@ WHERE %@ = %@), 0);", v7, v6, v31, v10, v15];
      }

      else
      {
        v36 = [(NSSQLProperty *)self->_relationship isToMany];
        ...
        if (v36)
        {
          ...
          v38 = [(NSSQLProperty *)v37 columnName];
          v39 = objc_alloc_init(MEMORY[0x1E696AD60]);
          v40 = [objc_alloc(MEMORY[0x1E696AEC0]) initWithFormat:@"%@_INSERT_INCREMENT", v102];
          ...
          [v39 appendFormat:@" AFTER INSERT ON %@ FOR EACH ROW WHEN %@", v104, self->_mNewMatchingClause];
          [v39 appendFormat:@" BEGIN"];
          [v39 appendFormat:@" UPDATE %@ SET %@ = IFNULL(%@, 0) + 1", v7, v6, v6];
          [v39 appendFormat:@" WHERE NEW.%@ = %@;", v38, v10];
          [v39 appendFormat:@" SELECT NSCoreDataTriggerUpdateAffectedObjectValue('%@', %@, %@, '%@', %@) FROM %@ WHERE %@ = NEW.%@;", v7, v101, v10, v6, v6, v7, v10, v38];
          [v39 appendFormat:@" END"];
          [v103 addObject:v39];
          [(NSMutableArray *)self->_mSqlDropStrings addObject:v41];

          v42 = objc_alloc_init(MEMORY[0x1E696AD60]);
          v43 = [objc_alloc(MEMORY[0x1E696AEC0]) initWithFormat:@"%@_UPDATE_INCREMENT", v102];
          ...
          [v42 appendFormat:@" AFTER UPDATE OF %@ ON %@", self->_mOfClause, v104];
          mNewMatchingClause = self->_mNewMatchingClause;
          [v42 appendFormat:@" FOR EACH ROW WHEN (%@) AND (%@) AND (NEW.%@ == OLD.%@)", mNewMatchingClause, self->_mColumnChangedClause, v38, v38];
          [v42 appendFormat:@" BEGIN"];
          [v42 appendFormat:@" UPDATE %@ SET %@ = IFNULL(%@, 0) + 1", v7, v6, v6];
          [v42 appendFormat:@" WHERE NEW.%@ = %@;", v38, v10];
          [v42 appendFormat:@" SELECT NSCoreDataTriggerUpdateAffectedObjectValue('%@', %@, %@, '%@', %@) FROM %@ WHERE %@ = NEW.%@;", v7, v101, v10, v6, v6, v7, v10, v38];
          [v42 appendFormat:@" END"];
          [v103 addObject:v42];
          [(NSMutableArray *)self->_mSqlDropStrings addObject:v44];

          v46 = objc_alloc_init(MEMORY[0x1E696AD60]);
          v47 = [objc_alloc(MEMORY[0x1E696AEC0]) initWithFormat:@"%@_UPDATE_DECREMENT", v102];
          v48 = [objc_alloc(MEMORY[0x1E696AEC0]) initWithFormat:@"DROP TRIGGER IF EXISTS %@", v47];
          [v46 appendFormat:@"CREATE TRIGGER IF NOT EXISTS %@", v47];
          [v46 appendFormat:@" AFTER UPDATE OF %@ ON %@", self->_mOfClause, v104];
          mOldMatchingClause = self->_mOldMatchingClause;
          [v46 appendFormat:@" FOR EACH ROW WHEN (%@) AND (%@) AND (OLD.%@ == NEW.%@)", mOldMatchingClause, self->_mColumnChangedClause, v38, v38];
          [v46 appendFormat:@" BEGIN"];
          [v46 appendFormat:@" UPDATE %@ SET %@ = MAX(0, IFNULL(%@, 0) - 1)", v7, v6, v6];
          [v46 appendFormat:@" WHERE OLD.%@ = %@;", v38, v10];
          [v46 appendFormat:@" SELECT NSCoreDataTriggerUpdateAffectedObjectValue('%@', %@, %@, '%@', %@) FROM %@ WHERE %@ = NEW.%@;", v7, v101, v10, v6, v6, v7, v10, v38];
          [v46 appendFormat:@" END"];
          [v103 addObject:v46];
          [(NSMutableArray *)self->_mSqlDropStrings addObject:v48];

          v50 = objc_alloc_init(MEMORY[0x1E696AD60]);
          v51 = [objc_alloc(MEMORY[0x1E696AEC0]) initWithFormat:@"%@_DELETE_DECREMENT", v102];
          v52 = [objc_alloc(MEMORY[0x1E696AEC0]) initWithFormat:@"DROP TRIGGER IF EXISTS %@", v51];
          [v50 appendFormat:@"CREATE TRIGGER IF NOT EXISTS %@", v51];
          [v50 appendFormat:@" AFTER DELETE ON %@ FOR EACH ROW WHEN %@", v104, self->_mOldMatchingClause];
          [v50 appendFormat:@" BEGIN"];
          [v50 appendFormat:@" UPDATE %@ SET %@ = MAX(0, IFNULL(%@, 0) - 1) WHERE OLD.%@ = %@;", v7, v6, v6, v38, v10];
          [v50 appendFormat:@" SELECT NSCoreDataTriggerUpdateAffectedObjectValue('%@', %@, %@, '%@', %@) FROM %@ WHERE %@ = OLD.%@;", v7, v101, v10, v6, v6, v7, v10, v38];
          [v50 appendFormat:@" END"];
          [v103 addObject:v50];
          [(NSMutableArray *)self->_mSqlDropStrings addObject:v52];

          v53 = objc_alloc_init(MEMORY[0x1E696AD60]);
          v54 = [objc_alloc(MEMORY[0x1E696AEC0]) initWithFormat:@"%@_%@_INSERT_INCREMENT", v102, v7];
          ...
          [v53 appendFormat:@" AFTER INSERT ON %@ FOR EACH ROW", v7];
          [v53 appendFormat:@" BEGIN"];
          [v53 appendFormat:@" UPDATE %@ SET %@ = (SELECT COUNT(%@) FROM %@ WHERE (%@ = NEW.%@) AND (%@)) WHERE %@ = NEW.%@;", v7, v6, v10, v104, v38, v10, self->_mToManyInnerFetchWhereClause, v10, v10];
          [v53 appendFormat:@" SELECT NSCoreDataTriggerUpdateAffectedObjectValue('%@', %@, %@, '%@', %@) FROM %@ WHERE %@ = NEW.%@;", v7, v101, v10, v6, v6, v7, v10, v10];
          [v53 appendFormat:@" END"];
          [v103 addObject:v53];
          [(NSMutableArray *)self->_mSqlDropStrings addObject:v55];

          v56 = objc_alloc_init(MEMORY[0x1E696AD60]);
          v57 = [objc_alloc(MEMORY[0x1E696AEC0]) initWithFormat:@"%@_%@_UPDATE_INCREMENT", v102, v38];
          ...
          [v56 appendFormat:@" AFTER UPDATE OF %@ ON %@ WHEN (%@) AND", v38, v104, self->_mNewMatchingClause];
          [v56 appendFormat:@" ((NEW.%@ IS NOT NULL AND OLD.%@ IS NULL) OR (NEW.%@ != OLD.%@))", v38, v38, v38, v38];
          [v56 appendFormat:@" BEGIN"];
          [v56 appendFormat:@" UPDATE %@ SET %@ = IFNULL(%@, 0) + 1 WHERE %@ = NEW.%@;", v7, v6, v6, v10, v38];
          [v56 appendFormat:@" SELECT NSCoreDataTriggerUpdateAffectedObjectValue('%@', %@, %@, '%@', %@) FROM %@ WHERE %@ = NEW.%@;", v7, v101, v10, v6, v6, v7, v10, v38];
          [v56 appendFormat:@" END"];
          [v103 addObject:v56];
          [(NSMutableArray *)self->_mSqlDropStrings addObject:v58];

          v59 = objc_alloc_init(MEMORY[0x1E696AD60]);
          v60 = [objc_alloc(MEMORY[0x1E696AEC0]) initWithFormat:@"%@_%@_UPDATE_DECREMENT", v102, v38];
          ...
          [v59 appendFormat:@" AFTER UPDATE OF %@ ON %@ WHEN (%@) AND", v38, v104, self->_mOldMatchingClause];
          [v59 appendFormat:@" ((OLD.%@ IS NOT NULL AND NEW.%@ IS NULL) OR (NEW.%@ != OLD.%@))", v38, v38, v38, v38];
          [v59 appendFormat:@" BEGIN"];
          [v59 appendFormat:@" UPDATE %@ SET %@ = MAX(0, IFNULL(%@, 0) - 1) WHERE %@ = OLD.%@;", v7, v6, v6, v10, v38];
          [v59 appendFormat:@" SELECT NSCoreDataTriggerUpdateAffectedObjectValue('%@', %@, %@, '%@', %@) FROM %@ WHERE %@ = OLD.%@;", v7, v101, v10, v6, v6, v7, v10, v38];
          [v59 appendFormat:@" END"];
          [v103 addObject:v59];
          [(NSMutableArray *)self->_mSqlDropStrings addObject:v61];

          v31 = [objc_alloc(MEMORY[0x1E696AEC0]) initWithFormat:@"COUNT_%@", v102];
          v62 = [objc_alloc(MEMORY[0x1E696AD60]) initWithFormat:@"CREATE TEMP TABLE %@ AS", v31];
          [v62 appendFormat:@" SELECT %@, COUNT(DISTINCT(%@.%@)) AS COUNT", v38, v104, v10];
          [v62 appendFormat:@" FROM %@", v104];
          [v62 appendFormat:@" WHERE %@", self->_mToManyInnerFetchWhereClause];
          [v62 appendFormat:@" GROUP BY %@;", v38];
          p_mBulkChangeStrings = &self->_mBulkChangeStrings;
          [(NSMutableArray *)self->_mBulkChangeStrings addObject:v62];

          v63 = [objc_alloc(MEMORY[0x1E696AD60]) initWithFormat:@" CREATE INDEX %@_INDEX ON %@(%@, COUNT);", v31, v31, v38];
          [(NSMutableArray *)self->_mBulkChangeStrings addObject:v63];

          v35 = [objc_alloc(MEMORY[0x1E696AD60]) initWithFormat:@" UPDATE %@ SET %@ = IFNULL((SELECT COUNT FROM %@ WHERE %@ = %@), 0);", v7, v6, v31, v10, v38];
        }
...
LABEL_27:
          ...
          v64 = [(NSSQLProperty *)v37 columnName];
          v65 = objc_alloc_init(MEMORY[0x1E696AD60]);
          v66 = [objc_alloc(MEMORY[0x1E696AEC0]) initWithFormat:@"%@_INSERT_INCREMENT", v102];
          v67 = [objc_alloc(MEMORY[0x1E696AEC0]) initWithFormat:@"DROP TRIGGER IF EXISTS %@", v66];
          [v65 appendFormat:@"CREATE TRIGGER IF NOT EXISTS %@", v66];
          [v65 appendFormat:@" AFTER INSERT ON %@ FOR EACH ROW WHEN %@", v104, self->_mNewMatchingClause];
          [v65 appendFormat:@" BEGIN"];
          [v65 appendFormat:@" UPDATE %@ SET %@ = IFNULL(%@, 0) + 1", v7, v6, v6];
          [v65 appendFormat:@" WHERE NEW.%@ = %@;", v10, v64];
          [v65 appendFormat:@" SELECT NSCoreDataTriggerUpdateAffectedObjectValue('%@', %@, %@, '%@', %@) FROM %@ WHERE %@ = NEW.%@;", v7, v101, v10, v6, v6, v7, v64, v10];
          [v65 appendFormat:@" END"];
          [v103 addObject:v65];
          [(NSMutableArray *)self->_mSqlDropStrings addObject:v67];

          v68 = objc_alloc_init(MEMORY[0x1E696AD60]);
          v69 = [objc_alloc(MEMORY[0x1E696AEC0]) initWithFormat:@"%@_UPDATE_INCREMENT", v102];
          v70 = [objc_alloc(MEMORY[0x1E696AEC0]) initWithFormat:@"DROP TRIGGER IF EXISTS %@", v69];
          [v68 appendFormat:@"CREATE TRIGGER IF NOT EXISTS %@", v69];
          [v68 appendFormat:@" AFTER UPDATE OF %@ ON %@", self->_mOfClause, v104];
          v71 = self->_mNewMatchingClause;
          [v68 appendFormat:@" FOR EACH ROW WHEN (%@) AND (%@)", v71, self->_mColumnChangedClause];
          [v68 appendFormat:@" BEGIN"];
          [v68 appendFormat:@" UPDATE %@ SET %@ = IFNULL(%@, 0) + 1", v7, v6, v6];
          [v68 appendFormat:@" WHERE NEW.%@ = %@;", v10, v64];
          [v68 appendFormat:@" SELECT NSCoreDataTriggerUpdateAffectedObjectValue('%@', %@, %@, '%@', %@) FROM %@ WHERE %@ = NEW.%@;", v7, v101, v10, v6, v6, v7, v64, v10];
          [v68 appendFormat:@" END"];
          [v103 addObject:v68];
          [(NSMutableArray *)self->_mSqlDropStrings addObject:v70];

          v72 = objc_alloc_init(MEMORY[0x1E696AD60]);
          v73 = [objc_alloc(MEMORY[0x1E696AEC0]) initWithFormat:@"%@_UPDATE_DECREMENT", v102];
          ...
          [v72 appendFormat:@" AFTER UPDATE OF %@ ON %@", self->_mOfClause, v104];
          v75 = self->_mOldMatchingClause;
          [v72 appendFormat:@" FOR EACH ROW WHEN (%@) AND (%@)", v75, self->_mColumnChangedClause];
          [v72 appendFormat:@" BEGIN"];
          [v72 appendFormat:@" UPDATE %@ SET %@ = MAX(0, IFNULL(%@, 0) - 1)", v7, v6, v6];
          [v72 appendFormat:@" WHERE OLD.%@ = %@;", v10, v64];
          [v72 appendFormat:@" SELECT NSCoreDataTriggerUpdateAffectedObjectValue('%@', %@, %@, '%@', %@) FROM %@ WHERE %@ = NEW.%@;", v7, v101, v10, v6, v6, v7, v64, v10];
          [v72 appendFormat:@" END"];
          [v103 addObject:v72];
          [(NSMutableArray *)self->_mSqlDropStrings addObject:v74];

          v76 = objc_alloc_init(MEMORY[0x1E696AD60]);
          v77 = [objc_alloc(MEMORY[0x1E696AEC0]) initWithFormat:@"%@_DELETE_DECREMENT", v102];
          v78 = [objc_alloc(MEMORY[0x1E696AEC0]) initWithFormat:@"DROP TRIGGER IF EXISTS %@", v77];
          [v76 appendFormat:@"CREATE TRIGGER IF NOT EXISTS %@", v77];
          [v76 appendFormat:@" AFTER DELETE ON %@ FOR EACH ROW WHEN %@", v104, self->_mOldMatchingClause];
          [v76 appendFormat:@" BEGIN"];
          [v76 appendFormat:@" UPDATE %@ SET %@ = MAX(0, IFNULL(%@, 0) - 1) WHERE OLD.%@ = %@;", v7, v6, v6, v10, v64];
          [v76 appendFormat:@" SELECT NSCoreDataTriggerUpdateAffectedObjectValue('%@', %@, %@, '%@', %@) FROM %@ WHERE %@ = OLD.%@;", v7, v101, v10, v6, v6, v7, v64, v10];
          [v76 appendFormat:@" END"];
          [v103 addObject:v76];
          [(NSMutableArray *)self->_mSqlDropStrings addObject:v78];

          v79 = objc_alloc_init(MEMORY[0x1E696AD60]);
          v80 = [objc_alloc(MEMORY[0x1E696AEC0]) initWithFormat:@"%@_%@_INSERT_INCREMENT", v102, v7];
          ...
          [v79 appendFormat:@" AFTER INSERT ON %@ FOR EACH ROW", v7];
          [v79 appendFormat:@" BEGIN"];
          [v79 appendFormat:@" UPDATE %@ SET %@ = (SELECT COUNT(%@) FROM %@ WHERE (%@ = NEW.%@) AND (%@)) WHERE %@ = NEW.%@;", v7, v6, v10, v104, v10, v64, self->_mToManyInnerFetchWhereClause, v10, v10];
          [v79 appendFormat:@" SELECT NSCoreDataTriggerUpdateAffectedObjectValue('%@', %@, %@, '%@', %@) FROM %@ WHERE %@ = NEW.%@;", v7, v101, v10, v6, v6, v7, v10, v10];
          [v79 appendFormat:@" END"];
          [v103 addObject:v79];
          [(NSMutableArray *)self->_mSqlDropStrings addObject:v81];

          v82 = objc_alloc_init(MEMORY[0x1E696AD60]);
          v83 = [objc_alloc(MEMORY[0x1E696AEC0]) initWithFormat:@"%@_%@_UPDATE_TO_NULL", v102, v64];
          ...
          [v82 appendFormat:@" AFTER UPDATE OF %@ ON %@ WHEN", v64, v7];
          [v82 appendFormat:@" (NEW.%@ IS NULL AND OLD.%@ IS NOT NULL)", v64, v64];
          [v82 appendFormat:@" BEGIN"];
          [v82 appendFormat:@" UPDATE %@ SET %@ = 0 WHERE %@ = NEW.%@;", v7, v6, v10, v10];
          [v82 appendFormat:@" SELECT NSCoreDataTriggerUpdateAffectedObjectValue('%@', %@, %@, '%@', %@) FROM %@ WHERE %@ = NEW.%@;", v7, v101, v10, v6, v6, v7, v10, v10];
          [v82 appendFormat:@" END"];
          [v103 addObject:v82];
          [(NSMutableArray *)self->_mSqlDropStrings addObject:v84];

          v85 = objc_alloc_init(MEMORY[0x1E696AD60]);
          v86 = [objc_alloc(MEMORY[0x1E696AEC0]) initWithFormat:@"%@_%@_UPDATE_INCREMENT", v102, v64];
          ...
          [v85 appendFormat:@" AFTER UPDATE OF %@ ON %@ WHEN", v64, v7];
          [v85 appendFormat:@" ((NEW.%@ IS NOT NULL AND OLD.%@ IS NULL) OR (NEW.%@ != OLD.%@))", v64, v64, v64, v64];
          [v85 appendFormat:@" BEGIN"];
          [v85 appendFormat:@" UPDATE %@ SET %@ = (SELECT COUNT(%@) FROM %@ WHERE %@ = NEW.%@ AND (%@)) WHERE %@ = NEW.%@;", v7, v6, v10, v104, v10, v64, self->_mToManyInnerFetchWhereClause, v10, v10];
          [v85 appendFormat:@" SELECT NSCoreDataTriggerUpdateAffectedObjectValue('%@', %@, %@, '%@', %@) FROM %@ WHERE %@ = NEW.%@;", v7, v101, v10, v6, v6, v7, v10, v10];
          [v85 appendFormat:@" END"];
          [v103 addObject:v85];
          [(NSMutableArray *)self->_mSqlDropStrings addObject:v87];

          v31 = [objc_alloc(MEMORY[0x1E696AEC0]) initWithFormat:@"COUNT_%@", v102];
          v88 = [objc_alloc(MEMORY[0x1E696AD60]) initWithFormat:@"CREATE TEMP TABLE %@ AS", v31];
          [v88 appendFormat:@" SELECT %@, COUNT(DISTINCT(%@)) AS COUNT", v10, v10];
          [v88 appendFormat:@" FROM %@", v104];
          [v88 appendFormat:@" WHERE %@", self->_mToManyInnerFetchWhereClause];
          [v88 appendFormat:@" GROUP BY %@;", v10];
          p_mBulkChangeStrings = &self->_mBulkChangeStrings;
          [(NSMutableArray *)self->_mBulkChangeStrings addObject:v88];

          v89 = [objc_alloc(MEMORY[0x1E696AD60]) initWithFormat:@" CREATE INDEX %@_INDEX ON %@(%@, COUNT);", v31, v31, v10];
          [(NSMutableArray *)self->_mBulkChangeStrings addObject:v89];

          v35 = [objc_alloc(MEMORY[0x1E696AD60]) initWithFormat:@" UPDATE %@ SET %@ = IFNULL((SELECT COUNT FROM %@ WHERE %@ = %@), 0);", v7, v6, v31, v10, v64];
        }
      }
      ...
      v91 = [objc_alloc(MEMORY[0x1E696AD60]) initWithFormat:@" DROP TABLE %@;", v31];
      ...
      if ([a2 compoundPredicateType] == 1 || objc_msgSend(a2, "compoundPredicateType") == 2)
      {
        ...
        if (v14)
        {
          ...
          while (2)
          {
            ...
            v15 = [v13 countByEnumeratingWithState:&v68 objects:v77 count:16];
            if (v15)
            {
              continue;
            }
...
LABEL_40:
  ...
  v41 = [v40 destinationEntity];
  v42 = [v6 objectAtIndexedSubscript:1];
  if (v41)
  {
    v43 = [*(v41 + 40) objectForKey:v42];
  }
  ...
  if (v43)
  {
    ...
    if (([*(v5 + 56) containsObject:v43] & 1) == 0)
    {
      ...
      *(v5 + 56) = [v53 copy];
      ...
      [v56 appendFormat:v59, v57, v44, v37, v58, v49, v37];
      if (![*(v5 + 72) length])
      {
        v60 = @"(NEW.%@ %@ %ld AND OLD.%@ %@ %ld)";
      }

      [*(v5 + 72) appendFormat:v60, objc_msgSend(v43, "columnName"), v49, v37, objc_msgSend(v43, "columnName"), v44, v37];
      if ([*(v5 + 88) length])
      {
        [*(v5 + 88) appendString:{@", "}];
      }
