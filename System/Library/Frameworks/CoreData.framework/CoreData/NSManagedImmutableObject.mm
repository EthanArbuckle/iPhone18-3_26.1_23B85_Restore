...
+ (id)allocWithEntity:(id)a3
{
  ...
  if (v5)
  {
    ...
    {
      v12 = [a3 managedObjectModel];
      v13 = a3;
      if (v12)
      {
        v13 = [a3 managedObjectModel];
      }

      [v13 _setIsEditable:0];
    }
    ...
    if (v8)
    {
      ...
      if (!*(v8 + 24))
      {
        ...
        {
          v15 = [objc_msgSend(a3 "propertiesByName")];
        }
  ...
  return _PFAllocateObject(v10, 0);
}
...
+ (Class)classForEntity:(id)a3
{
  ...
  if (!atomic_load(v3 + 124))
  {
    v87 = [v3 managedObjectModel];
    v88 = v3;
    if (v87)
    {
      v88 = [v3 managedObjectModel];
    }

    [v88 _setIsEditable:0];
  }
  ...
  while (1)
  {
    ...
    while (1)
    {
      ClassPair = objc_allocateClassPair(a1, __str, 0);
      if (ClassPair)
      {
        break;
      }

      v14 = class_getName(a1);
      v15 = v10 + 1;
    ...
    if (objc_opt_class() != a1)
    {
      ...
      v42 = class_getMethodImplementation(a1, sel_willAccessValueForKey_);
      v43 = objc_opt_class();
      v44 = class_getMethodImplementation(v43, sel_didAccessValueForKey_);
      v45 = class_getMethodImplementation(a1, sel_didAccessValueForKey_);
      ...
      *(v36 + 18) = v47;
      ...
      if (v49 != class_getMethodImplementation(a1, sel_validateValue_forKey_error_))
      {
        *(v36 + 18) |= 0x10u;
        v50 = objc_opt_class();
      ...
      if (v55 != class_getMethodImplementation(a1, sel_awakeFromFetch))
      {
        *(v36 + 18) |= 0x20u;
      }
      ...
      v58 = class_getMethodImplementation(a1, sel_willChangeValueForKey_);
      v59 = objc_opt_class();
      v60 = class_getMethodImplementation(v59, sel_didChangeValueForKey_);
      if (v60 == class_getMethodImplementation(a1, sel_didChangeValueForKey_) && v57 == v58)
      {
        v62 = 0;
      }
      ...
      *(v36 + 18) = v62 | v36[9] & 0xFFFFFFFD;
      ...
      v65 = class_getMethodImplementation(a1, sel_willChangeValueForKey_withSetMutation_usingObjects_);
      v66 = objc_opt_class();
      v67 = class_getMethodImplementation(v66, sel_didChangeValueForKey_withSetMutation_usingObjects_);
      if (v67 == class_getMethodImplementation(a1, sel_didChangeValueForKey_withSetMutation_usingObjects_) && v64 == v65)
      {
        v69 = 0;
      }
    ...
    v70 = [objc_msgSend(v3 "properties")];
    if ((v70 & 0xFFFFFFF8) != 0)
    {
      v71 = v70;
...
LABEL_48:
    *(v36 + 32) = v76;
    v36[5] = 0;
LABEL_49:
    v78 = [(objc_class *)v12 _PFMOClassFactoryData];
    v79 = *(v78 + 8);
    if (!v79 || v79 == v3)
    {
      v81 = v78;
      ...
      if ([objc_msgSend(v3 "versionHash")])
      {
        break;
      }
    }

    v82 = class_getName(a1);
...
LABEL_58:
  if (!v79)
  {
    *v81 = 0;
    *(v81 + 8) = v3;
    *(v81 + 16) = [objc_msgSend(v3 "name")];
    *(v81 + 24) = 0;
    v83 = [(objc_class *)v12 _PFPlaceHolderSingleton];
    object_setClass(v83, v12);
    *(v81 + 48) = v83;
  }
