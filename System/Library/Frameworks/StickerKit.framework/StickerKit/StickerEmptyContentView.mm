...
- (_TtC10StickerKit23StickerEmptyContentView)initWithCoder:(id)a3;
- (_TtC10StickerKit23StickerEmptyContentView)initWithFrame:(CGRect)a3;
@end
...
- (_TtC10StickerKit23StickerEmptyContentView)initWithFrame:(CGRect)a3
{
  ...
  *(&self->super.super.super.super._responderFlags + OBJC_IVAR____TtC10StickerKit23StickerEmptyContentView_delegate) = 0;
  ...
  v11 = [(StickerEmptyContentView *)&v13 initWithFrame:x, y, width, height];
