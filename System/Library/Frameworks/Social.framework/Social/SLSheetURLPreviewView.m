...
- (SLSheetURLPreviewView)initWithFrame:(CGRect)a3
{
  ...
  v5 = [(SLSheetImagePreviewView *)&v20 initWithFrame:v3, v4, a3.size.width, a3.size.height];
  v6 = v5;
  if (v5)
  {
...
- (void)layoutSubviews
{
  ...
  v14 = [(SLSheetImagePreviewView *)self imageView];
  [v14 frame];
...
- (BOOL)generatePreviewImageFromAttachments
{
  v3 = [(SLSheetImagePreviewView *)self principalAttachments];
  v4 = [v3 count];

  if (v4)
  {
    v4 = [(SLSheetImagePreviewView *)self principalAttachments];
...
- (void)_generateAutomaticPreviewForURL:(id)a3
{
  ...
  v6 = [[SLURLPreviewGenerator alloc] initWithFrame:0.0, 0.0, 420.0, 420.0, v5];
