...
- (CLLocation)location;
- (PHAssetPTPProperties)initWithFetchDictionary:(id)dictionary asset:(id)asset prefetched:(BOOL)prefetched;
@end
...
- (PHAssetPTPProperties)initWithFetchDictionary:(id)dictionary asset:(id)asset prefetched:(BOOL)prefetched
{
  ...
  if (v9)
  {
    ...
    v11 = [dictionaryCopy objectForKeyedSubscript:@"kindSubtype"];
    v10->_kindSubType = [v11 integerValue];

    v12 = [dictionaryCopy objectForKeyedSubscript:@"kind"];
    v10->_kind = [v12 integerValue];

    v13 = [dictionaryCopy objectForKeyedSubscript:@"avalanchePickType"];
    v10->_burstPickType = [v13 integerValue];

    v14 = [dictionaryCopy objectForKeyedSubscript:@"mediaGroupUUID"];
    livePhotoPairingIdentifier = v10->_livePhotoPairingIdentifier;
    v10->_livePhotoPairingIdentifier = v14;

    v16 = [dictionaryCopy objectForKeyedSubscript:@"filename"];
    filename = v10->_filename;
    v10->_filename = v16;

    v18 = [dictionaryCopy objectForKeyedSubscript:@"avalancheUUID"];
    burstIdentifier = v10->_burstIdentifier;
    v10->_burstIdentifier = v18;

    v20 = [dictionaryCopy objectForKeyedSubscript:@"locationData"];
    locationData = v10->_locationData;
    v10->_locationData = v20;

    v22 = [dictionaryCopy objectForKeyedSubscript:@"hdrType"];
    v10->_hdrType = [v22 integerValue];

    v23 = [dictionaryCopy objectForKeyedSubscript:@"hidden"];
    v10->_hidden = [v23 BOOLValue];

    v24 = [dictionaryCopy objectForKeyedSubscript:@"deferredProcessingNeeded"];
    v10->_deferredProcessingNeeded = [v24 BOOLValue];

    v25 = [dictionaryCopy objectForKeyedSubscript:@"additionalAttributes.originalFilename"];
    originalFilename = v10->_originalFilename;
    v10->_originalFilename = v25;

    v27 = [dictionaryCopy objectForKeyedSubscript:@"additionalAttributes.originalFilesize"];
    v10->_originalFilesize = [v27 integerValue];

    v28 = [dictionaryCopy objectForKeyedSubscript:@"additionalAttributes.originalWidth"];
    v10->_originalWidth = [v28 integerValue];

    v29 = [dictionaryCopy objectForKeyedSubscript:@"additionalAttributes.originalHeight"];
    v10->_originalHeight = [v29 integerValue];

    v30 = [dictionaryCopy objectForKeyedSubscript:@"additionalAttributes.exifTimestampString"];
    exifTimestampString = v10->_exifTimestampString;
    v10->_exifTimestampString = v30;

    v32 = [dictionaryCopy objectForKeyedSubscript:@"additionalAttributes.ptpTrashedState"];
    v10->_ptpTrashedState = [v32 integerValue];

    v33 = [dictionaryCopy objectForKeyedSubscript:@"additionalAttributes.originatingAssetIdentifier"];
    originatingAssetIdentifier = v10->_originatingAssetIdentifier;
    v10->_originatingAssetIdentifier = v33;

    v35 = [dictionaryCopy objectForKeyedSubscript:@"additionalAttributes.embeddedThumbnailOffset"];
    embeddedThumbnailOffset = v10->_embeddedThumbnailOffset;
    v10->_embeddedThumbnailOffset = v35;

    v37 = [dictionaryCopy objectForKeyedSubscript:@"additionalAttributes.embeddedThumbnailLength"];
    embeddedThumbnailLength = v10->_embeddedThumbnailLength;
    v10->_embeddedThumbnailLength = v37;

    v39 = [dictionaryCopy objectForKeyedSubscript:@"additionalAttributes.embeddedThumbnailWidth"];
    embeddedThumbnailWidth = v10->_embeddedThumbnailWidth;
    v10->_embeddedThumbnailWidth = v39;

    v41 = [dictionaryCopy objectForKeyedSubscript:@"additionalAttributes.embeddedThumbnailHeight"];
    embeddedThumbnailHeight = v10->_embeddedThumbnailHeight;
    v10->_embeddedThumbnailHeight = v41;

    v43 = [dictionaryCopy objectForKeyedSubscript:@"additionalAttributes.originalStableHash"];
    fingerprint = v10->_fingerprint;
    v10->_fingerprint = v43;

    v45 = [dictionaryCopy objectForKeyedSubscript:@"additionalAttributes.timeZoneOffset"];
    v10->_timeZoneOffset = [v45 integerValue];

    v46 = [dictionaryCopy objectForKeyedSubscript:@"extendedAttributes.dateCreated"];
    dateCreated = v10->_dateCreated;
    v10->_dateCreated = v46;

    v48 = [dictionaryCopy objectForKeyedSubscript:@"extendedAttributes.duration"];
    originalDuration = v10->_originalDuration;
    v10->_originalDuration = v48;

    v50 = [dictionaryCopy objectForKeyedSubscript:@"extendedAttributes.codec"];
    codec = v10->_codec;
    v10->_codec = v50;
  }
