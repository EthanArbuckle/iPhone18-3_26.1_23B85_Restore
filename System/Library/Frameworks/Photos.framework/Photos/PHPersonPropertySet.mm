...
- (PHPerson)person;
- (PHPersonPropertySet)initWithFetchDictionary:(id)dictionary person:(id)person prefetched:(BOOL)prefetched;
@end
...
- (PHPerson)person
{
  WeakRetained = objc_loadWeakRetained(&self->_person);
...
{
  pl_dispatch_once();
  v2 = propertiesToPrefetch_propertiesToPrefetch_28413;
...
void __43__PHPersonPropertySet_propertiesToPrefetch__block_invoke(uint64_t a1)
{
  ...
  if (v4)
  {
    ...
    v15 = propertiesToPrefetch_propertiesToPrefetch_28413;
    propertiesToPrefetch_propertiesToPrefetch_28413 = v14;
  ...
  {
    objc_storeStrong(&propertiesToPrefetch_propertiesToPrefetch_28413, v3);
  }
}
