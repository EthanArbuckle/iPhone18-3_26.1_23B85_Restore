...
void __87___PHPhotoLibraryFeatureAvailabilityTaskGlobalProcessing_executeWithCompletionHandler___block_invoke(uint64_t a1)
{
  ...
  [WeakRetained _addHighlightProcessingToAvailabilityStatus:*(a1 + 32)];

  v3 = objc_loadWeakRetained((a1 + 64));
  v4 = *(a1 + 32);
  v12 = 0;
  v5 = [v3 addGraphAvailabilityToAvailabilityStatus:v4 error:&v12];
  v6 = v12;
...
void __87___PHPhotoLibraryFeatureAvailabilityTaskGlobalProcessing_executeWithCompletionHandler___block_invoke_3(uint64_t a1)
{
  ...
  {
    *v13 = 0;
    _os_signpost_emit_with_name_impl(&dword_19C86F000, v11, OS_SIGNPOST_INTERVAL_END, v12, "GlobalProcessingFeatureAvailability", byte_19CB567AE, v13, 2u);
  }
}
