...
{
  v3 = [*(a1 + 32) placeValuesFromBases:&unk_1F102E3A8];
  v1 = [v3 copy];
  v2 = dcfCompliantFileNameFromFileNameHash__pl_once_object_17;
...
uint64_t __26__PHDCFUtilities_dcfRegex__block_invoke()
{
