@interface SortKeyPublishDate
@end

@implementation SortKeyPublishDate

id PHQueryForAssetsInAlbum_SortKeyPublishDate_block_invoke_103(uint64_t a1, void *a2)
{
  ...
  {
    v11 = 136315138;
    v12 = "PHQueryForAssetsInAlbum_SortKeyPublishDate_block_invoke_103";
