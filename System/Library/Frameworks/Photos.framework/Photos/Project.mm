...
id PHQueryForAssetCollectionType_Project_block_invoke_115(uint64_t a1, void *a2)
{
  ...
  {
    v11 = 136315138;
    v12 = "PHQueryForAssetCollectionType_Project_block_invoke_115";
...
id PHQueryForAssetInAlbumKind_Project_block_invoke_36(uint64_t a1, void *a2)
{
  v13 = *MEMORY[0x1E69E9840];
  v2 = a2;
  v3 = PLPhotoKitGetLog();
  ...
  {
    v11 = 136315138;
    v12 = "PHQueryForAssetInAlbumKind_Project_block_invoke_36";
    _os_signpost_emit_with_name_impl(&dword_19C86F000, v6, OS_SIGNPOST_INTERVAL_BEGIN, v4, "QueryIdentificationBlock", "%s", &v11, 0xCu);
  }
