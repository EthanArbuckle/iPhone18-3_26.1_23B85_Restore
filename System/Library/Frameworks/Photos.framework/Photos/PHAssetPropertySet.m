...
{
  pl_dispatch_once();
  v2 = propertiesToPrefetch_propertiesToPrefetch_22504;
...
void __42__PHAssetPropertySet_propertiesToPrefetch__block_invoke(uint64_t a1)
{
  ...
  if (v4)
  {
    ...
    v15 = propertiesToPrefetch_propertiesToPrefetch_22504;
    propertiesToPrefetch_propertiesToPrefetch_22504 = v14;
  ...
  {
    objc_storeStrong(&propertiesToPrefetch_propertiesToPrefetch_22504, v3);
  }
}

+ (NSString)propertySetName
{
  v2 = [MEMORY[0x1E695DF30] exceptionWithName:*MEMORY[0x1E695D930] reason:@"Abstract base class method called" userInfo:0];
