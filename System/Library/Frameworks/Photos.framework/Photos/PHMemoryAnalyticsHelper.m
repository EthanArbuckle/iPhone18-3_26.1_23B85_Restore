...
+ (id)analyticsPayloadForMemory:(id)a3
{
  ...
  v8 = [MEMORY[0x1E696AD98] numberWithLongLong:{objc_msgSend(v4, "playCount")}];
  v23[2] = v8;
  v22[3] = @"cpa_memory_shareCount";
  v9 = [MEMORY[0x1E696AD98] numberWithLongLong:{objc_msgSend(v4, "shareCount")}];
  v23[3] = v9;
  v22[4] = @"cpa_memory_viewCount";
  v10 = [MEMORY[0x1E696AD98] numberWithLongLong:{objc_msgSend(v4, "viewCount")}];
  v23[4] = v10;
  ...
  if ([v4 isGenerative])
  {
    v19 = [PHMemoryAnalyticsHelper isPromptSuggestedForGenerativeMemory:v4];
    if (v19)
    {
