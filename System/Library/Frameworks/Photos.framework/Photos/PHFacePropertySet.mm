...
{
  pl_dispatch_once();
  v2 = propertiesToPrefetch_propertiesToPrefetch_33899;
...
void __41__PHFacePropertySet_propertiesToPrefetch__block_invoke(uint64_t a1)
{
  ...
  if (v4)
  {
    ...
    v15 = propertiesToPrefetch_propertiesToPrefetch_33899;
    propertiesToPrefetch_propertiesToPrefetch_33899 = v14;
  ...
  {
    objc_storeStrong(&propertiesToPrefetch_propertiesToPrefetch_33899, v3);
  }
}

+ (NSString)propertySetName
{
  v2 = [MEMORY[0x1E695DF30] exceptionWithName:*MEMORY[0x1E695D930] reason:@"Abstract base class method" userInfo:0];
