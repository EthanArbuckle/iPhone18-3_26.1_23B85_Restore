...
- (void)_updateFeatureAvailabilityForAvailabilityStatus:(id)a3
{
  ...
  v5 = [v17 photosKnowledgeGraphIsReady];
  [v17 fractionOfStillAssetsWithEmbeddingsInIndex];
  v7 = v6;
  ...
  [v17 fractionOfHighlightsEnriched];
  v12 = v11;
  ...
  [v17 setFeatureAvailability:v16];
}
...
- (void)_addHighlightProcessingToAvailabilityStatus:(id)a3
{
  ...
  v10 = [(PHPhotoLibraryFeatureAvailabilityTask *)self photoLibrary];
  v11 = [v10 librarySpecificFetchOptions];

  [v11 setShouldPrefetchCount:1];
  v12 = [PHAssetCollection fetchAssetCollectionsWithType:6 subtype:0x7FFFFFFFFFFFFFFFLL options:v11];
  v13 = [v12 count];
  if (v13)
  {
    v14 = [(PHPhotoLibraryFeatureAvailabilityTask *)self photoLibrary];
    ...
    [v25 setFractionOfHighlightsEnriched:{objc_msgSend(v21, "count") / v13}];
  }
...
- (BOOL)addAnalysisStateToAvailabilityStatus:(id)a3 error:(id *)a4
{
  ...
  v13 = [(PHPhotoLibraryFeatureAvailabilityTask *)&v18 addAnalysisStateToAvailabilityStatus:v6 error:a4];
  if (v13)
  {
