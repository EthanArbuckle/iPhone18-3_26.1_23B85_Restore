...
- (void)dealloc
{
  ...
  while (v3 != 31);
  v5.receiver = self;
  v5.super_class = MTLBufferLayoutDescriptorArrayInternal;
...
- (void)setObject:(id)a3 atIndexedSubscript:(unint64_t)a4
{
  if (a3)
  {
    ...
    {
      [(MTLBufferLayoutDescriptorArrayInternal *)isKindOfClass setObject:v8 atIndexedSubscript:v9, v10, v11, v12, v13, v14, v16];
    }
  }
