...
- (MTLFunctionStitchingInputThreadgroup)initWithBindIndex:(unint64_t)index;
...
{
  v5.receiver = self;
  v5.super_class = MTLFunctionStitchingInputThreadgroup;
...
- (BOOL)isEqual:(id)equal
{
  ...
  bindIndex = [(MTLFunctionStitchingInputThreadgroup *)self bindIndex];
...
- (id)formattedDescription:(unint64_t)description
{
  ...
  v9.receiver = self;
  v9.super_class = MTLFunctionStitchingInputThreadgroup;
  v6 = [(MTLFunctionStitchingInputThreadgroup *)&v9 description];
  v10[0] = v4;
  v10[1] = @"bind index = ";
