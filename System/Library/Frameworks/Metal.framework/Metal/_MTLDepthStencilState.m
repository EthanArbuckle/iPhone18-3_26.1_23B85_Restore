...
- (_MTLDepthStencilState)initWithDevice:(id)a3 depthStencilDescriptor:(id)a4
{
  ...
  _MTLMessageContextBegin_(v64, "[_MTLDepthStencilState initWithDevice:depthStencilDescriptor:]", 479, a3, 10, "Creation Depth Stencil State");
  if (!a3)
  {
...
LABEL_5:
  ...
  if ([objc_msgSend(a4 "frontFaceStencil")] >= 8)
  {
  ...
  {
    v57->_device = a3;
    v57->_label = [objc_msgSend(a4 "label")];
  }
