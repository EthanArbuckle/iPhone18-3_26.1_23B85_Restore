...
- (id)objectAtIndexedSubscript:(unint64_t)a3
{
  if (a3 >= 4)
  {
    [(MTLRenderPassSampleBufferAttachmentDescriptorArrayInternal *)a3 objectAtIndexedSubscript:a2, a3, v3, v4, v5, v6, v7];
  }
...
- (void)setObject:(id)a3 atIndexedSubscript:(unint64_t)a4
{
  if (a4 >= 4)
  {
    [(MTLRenderPassSampleBufferAttachmentDescriptorArrayInternal *)a4 setObject:a2 atIndexedSubscript:a3, a4, v4, v5, v6, v7];
  }
