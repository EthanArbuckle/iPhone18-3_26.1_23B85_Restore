...
- (id)formattedDescription:(unint64_t)a3
{
  ...
  return [v5 stringWithFormat:@"%@%@", v6, depthAttachmentFormattedDescription(a3, &self->_private)];
}
...
- (void)setTexture:(id)a3
{
  ...
  {
    [(MTLRenderPassDepthAttachmentDescriptorInternal *)a3 setTexture:v6, v7, v8, v9, v10, v11, v12, v13];
  }
...
- (void)setResolveTexture:(id)a3
{
  ...
  if (a3 && MTLFailureTypeGetEnabled(1uLL))
  {
    [(MTLRenderPassDepthAttachmentDescriptorInternal *)a3 setResolveTexture:v7, v8, v9, v10, v11, v12, v13, v14];
  }
