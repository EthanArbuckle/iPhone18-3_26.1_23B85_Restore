...
{
  v4.receiver = self;
  v4.super_class = MTLResourceStatePassDescriptorInternal;
  v2 = [(MTLResourceStatePassDescriptorInternal *)&v4 init];
  if (v2)
  {
...
{
  v3.receiver = self;
  v3.super_class = MTLResourceStatePassDescriptorInternal;
...
- (id)copyWithZone:(_NSZone *)zone
{
  ...
  for (i = 0; i != 4; ++i)
  {
    ...
    if (v7)
    {
      *(v5[1] + 8 + i * 8) = [(MTLResourceStatePassSampleBufferAttachmentDescriptorInternal *)v7 copyWithZone:zone];
    }
  }
