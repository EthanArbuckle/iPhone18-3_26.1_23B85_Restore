...
- (_MTL4CompilerTask)initWithCompiler:(id)a3;
- (id).cxx_construct;
- (int64_t)status;
- (void)clearInternalCompileTokenIfMatches:(void *)a3;
- (void)dealloc;
- (void)setInternalCompileToken:(void *)a3;
...
- (void)clearInternalCompileTokenIfMatches:(void *)a3
{
  if (a3)
  {
    ...
    if (cntrl)
    {
      ...
      {
        v8 = v7;
        if (p_internalCompileTokenWeak->__ptr_ == a3)
        {
