...
+ (MTLComputePassSampleBufferAttachmentDescriptor)allocWithZone:(_NSZone *)zone;
@end
...
+ (MTLComputePassSampleBufferAttachmentDescriptor)allocWithZone:(_NSZone *)zone
{
  if (objc_opt_class() == self)
  {
    ...
    return [MTLComputePassSampleBufferAttachmentDescriptorInternal allocWithZone:zone];
  }
