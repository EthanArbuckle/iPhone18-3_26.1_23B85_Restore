...
+ (MTLBlitPassSampleBufferAttachmentDescriptorArray)allocWithZone:(_NSZone *)zone;
@end
...
+ (MTLBlitPassSampleBufferAttachmentDescriptorArray)allocWithZone:(_NSZone *)zone
{
  if (objc_opt_class() == self)
  {
    ...
    return [MTLBlitPassSampleBufferAttachmentDescriptorArrayInternal allocWithZone:zone];
  }
