...
- (_SFImageActivityItemProvider)initWithWebView:(id)view;
- (id)_imageData;
- (id)item;
@end
...
- (_SFImageActivityItemProvider)initWithWebView:(id)view
{
  ...
  v6 = [(_SFActivityItemProvider *)&v14 initWithPlaceholderItem:data URL:0 pageTitle:0 webView:viewCopy];
  ...
  if (v6)
  {
    ...
    PreferredIdentifierForTag = UTTypeCreatePreferredIdentifierForTag(v8, _MIMEType, 0);
...
- (id)item
{
  ...
  {
    _imageData = [(_SFImageActivityItemProvider *)self _imageData];
    v5 = self->_imageOnlyDocumentData;
    self->_imageOnlyDocumentData = _imageData;
...
- (id)_imageData
{
  ...
  if (documentUTI && UTTypeConformsTo(documentUTI, *MEMORY[0x1E69637F8]))
  {
    ...
    v16 = 0;
    webView = [(_SFActivityItemProvider *)self webView];
    ...
    v10[4] = &v17;
    v10[5] = &v11;
    [webView _getMainResourceDataWithCompletionHandler:v10];
    ...
    if ((v18[3] & 1) == 0)
    {
      ...
      do
      {
        ...
        [currentRunLoop runMode:v5 beforeDate:distantFuture];
      }
