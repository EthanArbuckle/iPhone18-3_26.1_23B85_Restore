...
- (uint64_t)_sf_scrollIndicatorInsets
{
  ...
  v9 = v8;
  v11 = v10;
  result = [a1 verticalScrollIndicatorInsets];
  *a2 = v5;
  a2[1] = v7;
  a2[2] = v9;
  a2[3] = v11;
...
- (uint64_t)_sf_setScrollIndicatorInsets:()SafariServicesExtras
{
  [a1 setHorizontalScrollIndicatorInsets:{*a3, a3[1], a3[2], a3[3]}];
  v5 = a3[4];
  v6 = a3[5];
  v7 = a3[6];
  v8 = a3[7];

  return [a1 setVerticalScrollIndicatorInsets:{v5, v6, v7, v8}];
}

- (void)_sf_setContentInsetAdjustments:()SafariServicesExtras
{
  v29 = objc_getAssociatedObject(a1, _sf_setContentInsetAdjustments__lastContentInsetAdjustmentsKey);
