...
- (MFRecentComposeRecipientGroup)initWithChildren:(id)children displayString:(id)string recentContact:(id)contact;
- (id)label;
- (id)placeholderName;
@end
...
- (MFRecentComposeRecipientGroup)initWithChildren:(id)children displayString:(id)string recentContact:(id)contact
{
  ...
  v10 = [(MFComposeRecipientGroup *)&v14 initWithChildren:children displayString:string];
  v11 = v10;
  if (v10)
  {
