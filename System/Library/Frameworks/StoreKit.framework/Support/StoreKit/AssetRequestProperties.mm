...
- (id)mutableCopyWithZone:(_NSZone *)a3
{
  ...
  v6 = [(NSNumber *)self->_bytesPerSecondLimit copyWithZone:a3];
  ...
  v8 = [(NSString *)self->_duetBudgetingIdentifier copyWithZone:a3];
  ...
  v21 = [(NSNumber *)self->_taskPriority copyWithZone:a3];
