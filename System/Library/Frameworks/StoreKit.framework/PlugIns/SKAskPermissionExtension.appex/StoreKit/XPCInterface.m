...
+ (NSXPCInterface)service
{
  ...
  v17 = [NSXPCInterface interfaceWithProtocol:&OBJC_PROTOCOL___ProductResponseReceiver];
  [v2 setInterface:v17 forSelector:"productsWithRequest:responseReceiver:reply:" argumentIndex:1 ofReply:0];
