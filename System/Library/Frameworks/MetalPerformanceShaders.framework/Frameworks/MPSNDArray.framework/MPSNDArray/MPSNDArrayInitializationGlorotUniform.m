...
- (MPSNDArrayInitializationGlorotUniform)initWithCoder:(id)a3 device:(id)a4;
- (MPSNDArrayInitializationGlorotUniform)initWithDevice:(id)a3 seed:(unint64_t)a4;
...
- (void)encodeToCommandBuffer:(id)a3 destinationArray:(id)a4
{
  ...
  *&v8 = -sqrtf(6.0 / (self->_FanIn + self->_FanOut));
  ...
  [(MPSNDArrayInitialization *)&v11 encodeToCommandBuffer:a3 destinationArray:a4];
}
