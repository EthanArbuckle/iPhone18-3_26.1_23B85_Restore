@interface MPSNDArrayConvolution3DGradientWithWeights
- (MPSNDArrayConvolution3DGradientWithWeights)initWithDevice:(id)device;
...
@implementation MPSNDArrayConvolution3DGradientWithWeights

- (MPSNDArrayConvolution3DGradientWithWeights)initWithDevice:(id)device
{
  v4.receiver = self;
  v4.super_class = MPSNDArrayConvolution3DGradientWithWeights;
  result = [(MPSNDArrayBinarySecondaryGradientKernel *)&v4 initWithDevice:device];
  if (result)
  {
    ...
    result->super.super.super._encodeGradient = EncodeNDArrayConvolution3DGradientWithWeights;
...
{
  v242.receiver = self;
  v242.super_class = MPSNDArrayConvolution3DGradientWithWeights;
  object = [(MPSNDArrayMultiaryBase *)&v242 workloadStatisticsForSourceArrays:arrays destArrays:destArrays sourceState:state, object];
  v10 = *(kernel + 60);
  v184 = object;
  if (v10)
  {
...
LABEL_9:
  ...
  v102 = v98 / (v100 + v101);
  v103 = *([arrays objectAtIndexedSubscript:0] + *v93);
  v104 = MPSGetDataTypeName();
  v105 = *([arrays objectAtIndexedSubscript:1] + *v93);
  v106 = MPSGetDataTypeName();
  v107 = *(destArrays + *v93);
  v108 = MPSGetDataTypeName();
  MPSKernel_LogInfo(kernelCopy, v109, "Convolution3D: N=%lu, C=%lu, D=%lu, H=%lu, W=%lu, kD=%lu, kH=%lu, kW=%lu, O=%lu, matrixM=%lu, matrixN=%lu, matrixK=%lu, A Datatype: %s, B Datatype: %s C Datatype: %s\t", v159, v183, v201, v90, v217, v135, v70, v73, v76, v76, v91, v92, v104, v106, v108);
  [v184 float16Ops];
  v111 = v110;
  [v184 float32Ops];
  v113 = v112;
  ...
  v115 = v114;
  [v184 deviceMemoryBytesWrite];
  MPSKernel_LogInfo(kernelCopy, v116, "Convolution3D: f16Ops=%f, f32Ops=%f, BytesRead=%f, BytesWritten=%f, OpsPerByte=%f\n", v111, v113, v115, v117, v102);
  return v184;
}
...
{
  v2.receiver = self;
  v2.super_class = MPSNDArrayConvolution3DGradientWithWeights;
