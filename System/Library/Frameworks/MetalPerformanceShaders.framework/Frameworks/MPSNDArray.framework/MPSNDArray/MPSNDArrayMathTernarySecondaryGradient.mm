...
- (MPSNDArrayMathTernarySecondaryGradient)initWithCoder:(id)coder device:(id)device;
- (MPSNDArrayMathTernarySecondaryGradient)initWithDevice:(id)device;
...
- (MPSNDArrayMathTernarySecondaryGradient)initWithDevice:(id)device
{
  ...
  result = [(MPSNDArrayMultiaryGradientKernel *)&v4 initWithDevice:device sourceCount:3 sourceGradientIndex:1];
