...
- (MPSNDArrayMathBinarySecondaryGradient)initWithCoder:(id)coder device:(id)device;
- (MPSNDArrayMathBinarySecondaryGradient)initWithDevice:(id)device;
...
- (MPSNDArrayMathBinarySecondaryGradient)initWithCoder:(id)coder device:(id)device
{
  ...
  result = [(MPSNDArrayBinarySecondaryGradientKernel *)&v8 initWithCoder:coder device:device];
  if (result)
  {
    result->super.super.super._encodeGradient = EncodeArrayMathBinaryGradient;
    result->super.super.super._encodeData = result;
