@interface MPSNDArrayIm2colKernel
- (MPSNDArrayIm2colKernel)initWithCoder:(id)coder device:(id)device;
- (MPSNDArrayIm2colKernel)initWithDevice:(id)device ndArrayIm2colDescriptor:(id)descriptor;
- (id)copyWithZone:(_NSZone *)zone device:(id)device;
- (void)encodeWithCoder:(id)coder;
@end

@implementation MPSNDArrayIm2colKernel

- (MPSNDArrayIm2colKernel)initWithDevice:(id)device ndArrayIm2colDescriptor:(id)descriptor
{
  v7.receiver = self;
  v7.super_class = MPSNDArrayIm2colKernel;
  v5 = [(MPSNDArrayUnaryKernel *)&v7 initWithDevice:device];
  v5->super.super._encode = EncodeArrayIm2col;
...
{
  v5.receiver = self;
  v5.super_class = MPSNDArrayIm2colKernel;
  result = [(MPSNDArrayUnaryKernel *)&v5 initWithCoder:coder device:device];
  if (result)
  {
    result->super.super._encode = EncodeArrayIm2col;
...
{
  v3.receiver = self;
  v3.super_class = MPSNDArrayIm2colKernel;
...
{
  v6.receiver = self;
  v6.super_class = MPSNDArrayIm2colKernel;
  result = [(MPSNDArrayMultiaryKernel *)&v6 copyWithZone:zone device:device];
  if (result)
  {
    self->super.super._encode = EncodeArrayIm2col;
