...
- (MPSNDArrayMathBinaryKernel)initWithCoder:(id)a3 device:(id)a4;
- (MPSNDArrayMathBinaryKernel)initWithDevice:(id)a3;
...
- (MPSNDArrayMathBinaryKernel)initWithCoder:(id)a3 device:(id)a4
{
  ...
  result = [(MPSNDArrayBinaryKernel *)&v8 initWithCoder:a3 device:a4];
  if (result)
  {
    result->super.super._encode = EncodeArrayMathBinary;
    result->super.super.super._encodeData = result;
