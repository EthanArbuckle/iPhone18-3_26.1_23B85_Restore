...
- (MPSNDArrayInitializationGlorotUniform)initWithCoder:(id)coder device:(id)device;
- (MPSNDArrayInitializationGlorotUniform)initWithDevice:(id)device seed:(unint64_t)seed;
...
@implementation MPSNDArrayInitializationGlorotUniform
...
{
  v6.receiver = self;
  v6.super_class = MPSNDArrayInitializationGlorotUniform;
...
{
  v5.receiver = self;
  v5.super_class = MPSNDArrayInitializationGlorotUniform;
...
- (void)encodeToCommandBuffer:(id)buffer destinationArray:(id)array
{
  ...
  *&v8 = -sqrtf(6.0 / (self->_FanIn + self->_FanOut));
  v9 = [MEMORY[0x277CD7280] uniformDistributionDescriptorWithMinimum:v8 maximum:?];
  self->super._distribution = v9;
  v10 = v9;
  objc_autoreleasePoolPop(v7);
  v11.receiver = self;
  v11.super_class = MPSNDArrayInitializationGlorotUniform;
  [(MPSNDArrayInitialization *)&v11 encodeToCommandBuffer:buffer destinationArray:array];
}
