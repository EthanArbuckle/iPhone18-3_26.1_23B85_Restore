...
- (MPSNDArrayInitializationRandomNormal)initWithCoder:(id)a3 device:(id)a4;
- (MPSNDArrayInitializationRandomNormal)initWithDevice:(id)a3 mean:(float)a4 standardDeviation:(float)a5 seed:(unint64_t)a6;
- (MPSNDArrayInitializationRandomNormal)initWithDevice:(id)a3 sourceCount:(unint64_t)a4;
...
- (MPSNDArrayInitializationRandomNormal)initWithDevice:(id)a3 sourceCount:(unint64_t)a4
{
  ...
  [(MPSNDArrayInitializationRandomNormal *)self initWithDevice:a3 mean:0 standardDeviation:0.0 seed:v4];
  return self;
}
