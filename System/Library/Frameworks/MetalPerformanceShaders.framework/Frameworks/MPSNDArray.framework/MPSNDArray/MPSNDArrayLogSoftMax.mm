...
- (MPSNDArrayLogSoftMax)initWithCoder:(id)a3 device:(id)a4;
- (MPSNDArrayLogSoftMax)initWithDevice:(id)a3;
- (MPSNDArrayLogSoftMax)initWithDevice:(id)a3 axis:(unint64_t)a4;
...
- (MPSNDArrayLogSoftMax)initWithDevice:(id)a3 axis:(unint64_t)a4
{
  result = [(MPSNDArrayLogSoftMax *)self initWithDevice:a3];
  result->_axis = a4;
  return result;
}
