...
- (MPSNNReduceFeatureChannelsMin)initWithCoder:(NSCoder *)aDecoder device:(id)device;
- (MPSNNReduceFeatureChannelsMin)initWithDevice:(id)device;
- (id)destinationImageDescriptorForSourceImages:(id)a3 sourceStates:(id)a4 paddingMethod:(unint64_t)a5 sourceOffset:(id *)a6;
@end

@implementation MPSNNReduceFeatureChannelsMin

- (MPSNNReduceFeatureChannelsMin)initWithDevice:(id)device
{
  v4.receiver = self;
  v4.super_class = MPSNNReduceFeatureChannelsMin;
  result = [(MPSNNReduceUnary *)&v4 initWithDevice:device reduceOperation:2];
  if (result)
  {
...
{
  v14.receiver = self;
  v14.super_class = MPSNNReduceFeatureChannelsMin;
...
{
  v5.receiver = self;
  v5.super_class = MPSNNReduceFeatureChannelsMin;
