...
- (MPSNNReduceRowMean)initWithCoder:(NSCoder *)aDecoder device:(id)device;
- (MPSNNReduceRowMean)initWithDevice:(id)device;
- (id)destinationImageDescriptorForSourceImages:(id)a3 sourceStates:(id)a4 paddingMethod:(unint64_t)a5 sourceOffset:(id *)a6;
@end

@implementation MPSNNReduceRowMean

- (MPSNNReduceRowMean)initWithDevice:(id)device
{
  v4.receiver = self;
  v4.super_class = MPSNNReduceRowMean;
  return [(MPSNNReduceUnary *)&v4 initWithDevice:device reduceOperation:8];
}

- (id)destinationImageDescriptorForSourceImages:(id)a3 sourceStates:(id)a4 paddingMethod:(unint64_t)a5 sourceOffset:(id *)a6
{
  v14.receiver = self;
  v14.super_class = MPSNNReduceRowMean;
...
{
  v5.receiver = self;
  v5.super_class = MPSNNReduceRowMean;
