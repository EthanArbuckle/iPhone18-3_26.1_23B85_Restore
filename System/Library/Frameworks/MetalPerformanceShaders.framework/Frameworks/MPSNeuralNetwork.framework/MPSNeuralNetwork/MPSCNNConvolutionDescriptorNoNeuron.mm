...
- (MPSCNNConvolutionDescriptorNoNeuron)initWithCoder:(id)a3;
- (MPSCNNConvolutionDescriptorNoNeuron)initWithConvDescriptor:(id)a3;
- (void)dealloc;
...
- (MPSCNNConvolutionDescriptorNoNeuron)initWithConvDescriptor:(id)a3
{
  ...
  if (v4)
  {
    v4->super._kernelWidth = *(a3 + 1);
    v4->super._kernelHeight = *(a3 + 2);
    v4->super._inputFeatureChannels = *(a3 + 3);
    *&v4->super._outputFeatureChannels = *(a3 + 2);
    v4->super._subPixelScaleFactor = *(a3 + 11);
    v4->super._dilationRateX = *(a3 + 12);
    v4->super._dilationRateY = *(a3 + 13);
    v4->super._strideInPixelsX = *(a3 + 6);
    v4->super._strideInPixelsY = *(a3 + 7);
    v4->super._groups = *(a3 + 8);
    v4->super._batchNormalizationData = *(a3 + 9);
...
- (MPSCNNConvolutionDescriptorNoNeuron)initWithCoder:(id)a3
{
  ...
  result = [(MPSCNNConvolutionDescriptor *)&v4 initWithCoder:a3];
  if (result)
  {
...
- (void)encodeWithCoder:(id)a3
{
  v3.receiver = self;
  v3.super_class = MPSCNNConvolutionDescriptorNoNeuron;
  [(MPSCNNConvolutionDescriptor *)&v3 encodeWithCoder:a3];
}
