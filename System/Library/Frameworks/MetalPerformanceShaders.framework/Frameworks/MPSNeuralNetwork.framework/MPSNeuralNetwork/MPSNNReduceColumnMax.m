...
- (MPSNNReduceColumnMax)initWithCoder:(NSCoder *)aDecoder device:(id)device;
- (MPSNNReduceColumnMax)initWithDevice:(id)device;
- (id)destinationImageDescriptorForSourceImages:(id)a3 sourceStates:(id)a4 paddingMethod:(unint64_t)a5 sourceOffset:(id *)a6;
@end

@implementation MPSNNReduceColumnMax

- (MPSNNReduceColumnMax)initWithDevice:(id)device
{
  v4.receiver = self;
  v4.super_class = MPSNNReduceColumnMax;
  return [(MPSNNReduceUnary *)&v4 initWithDevice:device reduceOperation:5];
}

- (id)destinationImageDescriptorForSourceImages:(id)a3 sourceStates:(id)a4 paddingMethod:(unint64_t)a5 sourceOffset:(id *)a6
{
  v14.receiver = self;
  v14.super_class = MPSNNReduceColumnMax;
...
{
  v5.receiver = self;
  v5.super_class = MPSNNReduceColumnMax;
