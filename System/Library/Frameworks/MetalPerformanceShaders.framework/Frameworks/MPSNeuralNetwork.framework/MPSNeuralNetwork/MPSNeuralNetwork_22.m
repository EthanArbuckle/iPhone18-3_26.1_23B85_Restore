_DWORD *sub_239CCBC78(_DWORD *result, int32x4_t *a2, uint64_t a3)
{
  v3 = *(a3 + 8);
  v4 = *(a3 + 32);
  v699 = *(a3 + 48);
...
unint64_t sub_239CD05EC(unint64_t result, int32x4_t *a2, uint64_t a3, double a4, int32x4_t a5)
{
  v5 = result;
  v6 = *(a3 + 8);
  v397 = *(a3 + 32);
...
_DWORD *sub_239CD298C(_DWORD *result, unsigned __int32 *a2, uint64_t a3, double a4, int32x4_t a5)
{
  v544 = a2;
  v5 = *(a3 + 8);
  v560 = *(a3 + 32);
