...
- (id)recurrentStateForBatchSize:(unint64_t)a3 forGradientPass:(BOOL)a4;
- (id)temporaryRecurrentStateForCommandBuffer:(id)a3 batchSize:(unint64_t)a4 forGradientPass:(BOOL)a5;
...
- (void)encodeWithCoder:(id)a3
{
  *(&self->super.super.isa + *MEMORY[0x277CD7358] + 2) = 1;
  ...
  objc_msgSend_encodeInt64_forKey_(a3, v15, 1, @"kMPSRNNLayer._numberOfLayers", v16, v17, v18, v19);
  ...
  *v25 = self->layerType;
  v30 = v25;
  sub_239BCD9D8(a3, v25, @"kMPSRNNLayer.layerTypes", 1, v26, v27, v28, v29);
  free(v30);
  layerType = self->layerType;
  switch(layerType)
  {
    case 2:
      sub_239BC6D40(a3, self->layer, 0);
      break;
    case 1:
      sub_239BC6FA4(a3, self->layer, 0);
      break;
    case 0:
      sub_239BC6BE0(a3, self->layer, 0);
      break;
  }
}
      ...
      if (v275 == *v276)
      {
        ...
        if (v277 < objc_msgSend_count(weights, v285, v286, v287, v288, v289, v290, v291, v568))
        {
          ...
          if (v371 == v379)
          {
            ...
            sub_239BCA7FC(v380, v388, v371 * v353, v588, *(&v587->super.super.isa + *MEMORY[0x277CD7370]), v335, v334);
          }
          ...
          else if (v353)
          {
            ...
            do
            {
              ...
              sub_239BCA7FC(v390, v398, v370 * (v406 >> 3), v588, *(&v587->super.super.isa + *v389), v335, v334);
              v334 += v371;
              v335 += v379;
              --v353;
            }
...
LABEL_34:
  ...
  v580 = v171;
  if (!v133 && (*(&v587->super.super.isa + v582) & 1) == 0)
  {
  ...
  if (v217 == v225)
  {
    ...
    sub_239BCA7FC(v226, v234, v217 * v577, v588, *(&v587->super.super.isa + *MEMORY[0x277CD7370]), v136, v135);
  }
  ...
  else if (v577)
  {
    ...
    do
    {
      ...
      sub_239BCA7FC(v237, v245, v580 * (v253 >> 3), v588, *(&v587->super.super.isa + *v235), v136, v135);
      v135 += v217;
      v136 += v225;
      --v236;
    }
...
LABEL_10:
  ...
  {
    v40 = v587->layer;
    if ((*(&v587->super.super.isa + v582) & 1) == 0)
    {
...
LABEL_125:
          ...
          if (((v489 == v497) & ~v408) != 0)
          {
            ...
            sub_239BCA7FC(v515, v523, v489 * v471, v588, *(&v587->super.super.isa + *MEMORY[0x277CD7370]), v452, v451);
          }
          ...
          else
          {
            for (; v471; --v471)
            {
              ...
              sub_239BCA7FC(v498, v506, v488 * (v514 >> 3), v588, *(&v587->super.super.isa + *MEMORY[0x277CD7370]), v452, v451);
              v451 += v489;
              v452 += v497;
            }
          }
...
- (void)encodeForwardSequenceToCommandBuffer:(id)commandBuffer sourceMatrices:(NSArray *)sourceMatrices sourceOffsets:(NSUInteger *)sourceOffsets destinationMatrices:(NSArray *)destinationMatrices destinationOffsets:(NSUInteger *)destinationOffsets trainingStates:(NSMutableArray *)trainingStates recurrentInputState:(MPSRNNRecurrentMatrixState *)recurrentInputState recurrentOutputStates:(NSMutableArray *)recurrentOutputStates weights:(NSArray *)weights
{
  ...
  {
    v50 = 0;
    for (i = objc_msgSend_objectAtIndexedSubscript_(sourceMatrices, v42, 0, v43, v44, v45, v46, v47); ; i = objc_msgSend_objectAtIndexedSubscript_(sourceMatrices, v58, v50, v60, v61, v62, v63, v64, v142, v144, v146, inputFeatureChannels))
    {
      v48[v50] = i;
      *(v49 + 8 * v50) = objc_msgSend_objectAtIndexedSubscript_(destinationMatrices, v52, v50, v53, v54, v55, v56, v57);
      if ((*(&self->super.super.isa + v32) & 1) == 0)
      {
        ...
        objc_msgSend_columns(v48[v50], v87, v88, v89, v90, v91, v92, v93, v142, v144, v146);
        ...
        objc_msgSend_columns(*(v49 + 8 * v50), v101, v102, v103, v104, v105, v106, v107, v143, v145, v147);
...
- (void)encodeGradientSequenceToCommandBuffer:(id)commandBuffer forwardSources:(NSArray *)forwardSources forwardSourceOffsets:(NSUInteger *)forwardSourceOffsets sourceGradients:(NSArray *)sourceGradients sourceGradientOffsets:(NSUInteger *)sourceGradientOffsets destinationGradients:(NSArray *)destinationGradients destinationOffsets:(NSUInteger *)destinationOffsets weightGradients:(NSArray *)weightGradients trainingStates:(NSArray *)trainingStates recurrentInputState:(MPSRNNRecurrentMatrixState *)recurrentInputState recurrentOutputStates:(NSMutableArray *)recurrentOutputStates weights:(NSArray *)weights
{
  ...
  if ((*(&self->super.super.isa + v551) & 1) == 0)
  {
    ...
    objc_msgSend_count(weights, a2, commandBuffer, forwardSources, forwardSourceOffsets, sourceGradients, sourceGradientOffsets, destinationGradients, v521, v525, v529);
    ...
    if (objc_msgSend_count(weights, v61, v62, v63, v64, v65, v66, v67, v522, v526, v530))
    {
      ...
      do
      {
        ...
        v142 = objc_msgSend_rows(v81, v89, v90, v91, v92, v93, v94, v95, v521, v525, v529);
  ...
  if (v276)
  {
    ...
    v559 = 0;
    v562 = 0;
    for (i = objc_msgSend_objectAtIndexedSubscript_(forwardSources, v285, 0, v286, v287, v288, v289, v290, v521, v525, v529); ; i = objc_msgSend_objectAtIndexedSubscript_(forwardSources, v285, v294, v286, v287, v288, v289, v290, v521, v525, v529))
    {
      *&v291[8 * v294] = i;
      ...
      *(v293 + 8 * v294) = v304;
      ...
      if ((*(&self->super.super.isa + v551) & 1) == 0)
      {
        ...
        objc_msgSend_columns(*&v291[8 * v294], v332, v333, v334, v335, v336, v337, v338, v521, v525, v529, inputFeatureChannels, v534);
        ...
        objc_msgSend_columns(*(v292 + 8 * v294), v346, v347, v348, v349, v350, v351, v352, v524, v528, v532);
        ...
        if (destinationGradients)
        {
          ...
          objc_msgSend_columns(*(v293 + 8 * v294), v383, v384, v385, v386, v387, v388, v389, v521, v525, v529);
  ...
  if (v284)
  {
    if (weightGradients)
    {
      for (k = 0; k != v284; ++k)
      {
        v557[k] = objc_msgSend_objectAtIndexedSubscript_(weightGradients, v285, k, v286, v287, v288, v289, v290, v521, v525, v529);
      }
    }
  ...
  for (m = 0; m != v276; ++m)
  {
    v446 = objc_msgSend_rows(*&v291[8 * m], v436, v437, v438, v439, v440, v441, v442, v521, v525, v529);
    if (v446 > v444)
    {
      v444 = v446;
    }
...
- (id)recurrentStateForBatchSize:(unint64_t)a3 forGradientPass:(BOOL)a4
{
  v4 = sub_239BC82A0(1, a3, &self->layer, &self->layerType, 0, (*(&self->super.super.isa + *MEMORY[0x277CD7350]))[2], 0, a4);
...
- (id)temporaryRecurrentStateForCommandBuffer:(id)a3 batchSize:(unint64_t)a4 forGradientPass:(BOOL)a5
{
  v5 = sub_239BC82A0(1, a4, &self->layer, &self->layerType, 1u, (*(&self->super.super.isa + *MEMORY[0x277CD7350]))[2], a3, a5);
