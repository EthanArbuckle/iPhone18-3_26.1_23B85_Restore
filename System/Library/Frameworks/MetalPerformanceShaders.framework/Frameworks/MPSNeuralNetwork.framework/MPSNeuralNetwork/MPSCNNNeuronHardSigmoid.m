...
- (MPSCNNNeuronHardSigmoid)initWithDevice:(id)a3 neuronDescriptor:(id)a4;
- (MPSCNNNeuronHardSigmoid)initWithDevice:(id)a3 neuronDescriptor:(id)a4 aArray:(const float *)a5;
