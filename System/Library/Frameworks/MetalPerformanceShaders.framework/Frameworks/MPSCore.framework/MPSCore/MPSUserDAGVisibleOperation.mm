...
- (MPSUserDAGVisibleOperation)initWithVisibleName:(id)a3 specializedName:(id)a4 functionConstants:(id)a5;
- (id)getVisibleFunction:(id)a3;
- (void)dealloc;
@end
...
- (MPSUserDAGVisibleOperation)initWithVisibleName:(id)a3 specializedName:(id)a4 functionConstants:(id)a5
{
  ...
  v8->_visibleName = objc_msgSend_copy(a3, v9, v10, v11, v12);
  v8->_specializedName = objc_msgSend_copy(a4, v13, v14, v15, v16);
  v8->_functionConstants = objc_msgSend_copy(a5, v17, v18, v19, v20);
  return v8;
}
...
- (id)getVisibleFunction:(id)a3
{
  ...
  v9 = objc_msgSend_functionDescriptor(MEMORY[0x277CD6D78], a2, a3, v3, v4);
  ...
  {
    v39 = objc_msgSend_device(a3, v20, v21, v22, v23);
    MPSDevice = MPSDevice::GetMPSDevice(v39);
    MPSDevice::AddBinaryArchives(MPSDevice, v9, a3);
    result = objc_msgSend_newFunctionWithDescriptor_error_(a3, v41, v9, &v79, v42);
    if (v79)
    {
      v47 = result;
  ...
  else
  {
    ...
    v37 = objc_msgSend_newFunctionWithName_(a3, v34, v33, v35, v36);
