...
- (void)encodeToCommandBuffer:(id)buffer gradientMatrix:(id)matrix forwardOutputMatrix:(id)outputMatrix resultMatrix:(id)resultMatrix
{
  ...
  if ((*(&self->super.super.super.super.isa + v13) & 1) == 0)
  {
    ...
    objc_msgSend_primarySourceMatrixOrigin(self, a2, buffer, matrix, outputMatrix, resultMatrix, v6, v7, v157);
    ...
    if (objc_msgSend_matrices(matrix, v49, v50, v51, v52, v53, v54, v55, v160) == 1 && objc_msgSend_matrices(outputMatrix, v56, v57, v58, v59, v60, v61, v62) == 1)
    {
      objc_msgSend_matrices(resultMatrix, v56, v57, v58, v59, v60, v61, v62);
    }

    if ((objc_msgSend_matrices(matrix, v56, v57, v58, v59, v60, v61, v62) != 1 || objc_msgSend_matrices(outputMatrix, v63, v64, v65, v66, v67, v68, v69) != 1 || objc_msgSend_matrices(resultMatrix, v70, v71, v72, v73, v74, v75, v76) != 1) && MTLReportFailureTypeEnabled())
    {
      MTLReportFailure();
    }
    ...
    objc_msgSend_dataType(matrix, v91, v92, v93, v94, v95, v96, v97);
    if (objc_msgSend_dataType(matrix, v98, v99, v100, v101, v102, v103, v104) != 268435488 && MTLReportFailureTypeEnabled())
    {
      MTLReportFailure();
    }

    objc_msgSend_dataType(outputMatrix, v105, v106, v107, v108, v109, v110, v111);
    if (objc_msgSend_dataType(outputMatrix, v112, v113, v114, v115, v116, v117, v118) != 268435488 && MTLReportFailureTypeEnabled())
    {
      MTLReportFailure();
    }
  }
  ...
  v131 = objc_msgSend_initWithCommandBuffer_withDispatchType_(v119, v120, buffer, 0, v121, v122, v123, v124);
  ...
  sub_2399D7A0C(self, v131, buffer, matrix, outputMatrix, resultMatrix, 1, v130);
