...
- (void)encodeToCommandBuffer:(id)a3 destinationVector:(id)a4
{
  ...
  v25 = *(a4 + *MEMORY[0x277CD74A8]);
  v26 = objc_msgSend_batchStart(self, v18, v19, v20, v21, v22, v23, v24, v66, v67);
  v34 = v25 + objc_msgSend_vectorBytes(a4, v27, v28, v29, v30, v31, v32, v33) * v26;
  v42 = objc_msgSend_dataType(a4, v35, v36, v37, v38, v39, v40, v41);
  parallelFilter = self->_parallelFilter;
  v44 = v34 / (v42 >> 3);
  v52 = objc_msgSend_data(a4, v45, v46, v47, v48, v49, v50, v51);
  v60 = objc_msgSend_length(a4, v53, v54, v55, v56, v57, v58, v59);

  MEMORY[0x2821F9670](parallelFilter, sel_encodeToCommandBuffer_destinationBuffer_destinationOffset_numEntries_, a3, v52, v44, v60, v61, v62);
}
...
- (void)encodeToCommandBuffer:(id)a3 destinationMatrix:(id)a4
{
  ...
  v25 = objc_msgSend_rowBytes(a4, v18, v19, v20, v21, v22, v23, v24, v83, v84);
  v33 = objc_msgSend_dataType(a4, v26, v27, v28, v29, v30, v31, v32);
  v34 = *(a4 + *MEMORY[0x277CD73A8]);
  v35 = v25 / (v33 >> 3);
  v43 = objc_msgSend_batchStart(self, v36, v37, v38, v39, v40, v41, v42);
  v51 = v34 + objc_msgSend_matrixBytes(a4, v44, v45, v46, v47, v48, v49, v50) * v43;
  v59 = objc_msgSend_dataType(a4, v52, v53, v54, v55, v56, v57, v58);
  parallelFilter = self->_parallelFilter;
  v61 = v51 / (v59 >> 3);
  v69 = objc_msgSend_data(a4, v62, v63, v64, v65, v66, v67, v68);
  v77 = objc_msgSend_rows(a4, v70, v71, v72, v73, v74, v75, v76) * v35;

  MEMORY[0x2821F9670](parallelFilter, sel_encodeToCommandBuffer_destinationBuffer_destinationOffset_numEntries_, a3, v69, v61, v77, v78, v79);
}
