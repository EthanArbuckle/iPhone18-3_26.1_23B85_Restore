...
- (MPSImageThresholdBinary)initWithCoder:(NSCoder *)aDecoder device:(id)device;
- (MPSImageThresholdBinary)initWithDevice:(id)device;
- (MPSImageThresholdBinary)initWithDevice:(id)device thresholdValue:(float)thresholdValue maximumValue:(float)maximumValue linearGrayColorTransform:(const float *)transform;
...
{
  v11.receiver = self;
  v11.super_class = MPSImageThresholdBinary;
  ...
  if (result)
  {
    ...
    result->super._encode = sub_239976714;
...
{
  v34.receiver = self;
  v34.super_class = MPSImageThresholdBinary;
  ...
  if (*(&v5->super.super.super.isa + *MEMORY[0x277CD7358] + 2) << 16 == 0x10000)
  {
    ...
    v5->super._encode = sub_239976714;
...
- (void)encodeWithCoder:(id)a3
{
  ...
  *(&self->super.super.super.isa + *MEMORY[0x277CD7358] + 2) = 1;
  v30.receiver = self;
  v30.super_class = MPSImageThresholdBinary;
...
{
  v7.receiver = self;
  v7.super_class = MPSImageThresholdBinary;
...
- (id)debugDescription
{
  ...
  v10.receiver = self;
  v10.super_class = MPSImageThresholdBinary;
