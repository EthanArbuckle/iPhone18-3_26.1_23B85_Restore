...
{
  v12.receiver = self;
  v12.super_class = MPSImageStatisticsMinAndMax;
...
{
  v38.receiver = self;
  v38.super_class = MPSImageStatisticsMinAndMax;
...
- (void)encodeWithCoder:(id)coder
{
  ...
  *(&self->super.super.super.isa + *MEMORY[0x277CD7358] + 2) = 1;
  v23.receiver = self;
  v23.super_class = MPSImageStatisticsMinAndMax;
...
{
  v14.receiver = self;
  v14.super_class = MPSImageStatisticsMinAndMax;
