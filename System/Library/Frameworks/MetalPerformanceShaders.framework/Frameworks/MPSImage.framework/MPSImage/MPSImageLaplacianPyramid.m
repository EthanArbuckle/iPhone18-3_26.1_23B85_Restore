...
- (BOOL)isValidDstPixelFormat:(unint64_t)a3 srcPixelFormat:(unint64_t)a4;
- (MPSImageLaplacianPyramid)initWithCoder:(id)a3 device:(id)a4;
- (MPSImageLaplacianPyramid)initWithDevice:(id)a3 kernelWidth:(unint64_t)a4 kernelHeight:(unint64_t)a5 weights:(const float *)a6;
...
- (void)cleanUpAll
{
  ...
  v2 = (v2 + 264);
  verbosityLevel = v2->super.super.super._verbosityLevel;
}

- (BOOL)isValidDstPixelFormat:(unint64_t)a3 srcPixelFormat:(unint64_t)a4
{
  v6 = *MEMORY[0x277CD7350];
  PixelInfo = MPSDevice::GetPixelInfo(*(&self->super.super.super.super.isa + v6), a3, MPSImageFeatureChannelFormatNone);
  v8 = MPSDevice::GetPixelInfo(*(&self->super.super.super.super.isa + v6), a4, MPSImageFeatureChannelFormatNone);
...
- (MPSImageLaplacianPyramid)initWithDevice:(id)a3 kernelWidth:(unint64_t)a4 kernelHeight:(unint64_t)a5 weights:(const float *)a6
{
  ...
  if (v10)
  {
    v47 = 0;
    v48 = 0;
    if (!sub_2399425CC(&v48, &v47, v10 + 264, a5, a4))
    {
      goto LABEL_15;
    }
    ...
    *(v10 + 332) = 0x3F80000000000000;
    ...
    v15 = objc_msgSend_initWithBytes_length_(v11, v12, a6, 4 * a4 * a5, v13, v14);
    *(v10 + 40) = v15;
    if (!v15)
    {
      goto LABEL_15;
    ...
    *(v10 + 46) = v32;
    ...
    v36 = objc_msgSend_newBufferWithLength_options_(a3, v33, v19, 0, v34, v35);
    *(v10 + 47) = v36;
    if (v36 && (v40 = objc_msgSend_newBufferWithLength_options_(a3, v37, v26, 0, v38, v39), (*(v10 + 48) = v40) != 0))
    {
      *(v10 + 43) = v16;
      *(v10 + 44) = v17;
      ...
      if (v38)
      {
        if (v33)
        {
          ...
          while (1)
          {
            ...
            objc_msgSend_decodeFloatForKey_(a3, v46, v45, v47, v48, v49);
            *(objc_msgSend_mutableBytes(v43, v50, v51, v52, v53, v54) + 4 * v44) = v55;
            if (objc_msgSend_error(a3, v56, v57, v58, v59, v60))
            {
              break;
            }
...
LABEL_8:
          *p_state = v25;
          ...
          v12->_state.isPyramidAdd = objc_msgSend_decodeBoolForKey_(a3, v39, @"MPSImageLaplacianPyramid.isPyramidAdd", v40, v41, v42);
          if (!objc_msgSend_error(a3, v61, v62, v63, v64, v65))
          {
            objc_msgSend_decodeFloatForKey_(a3, v66, @"MPSImageLaplacianPyramid.laplacianBias", v67, v68, v69);
            v12->_state.laplacianBias = v70;
            if (!objc_msgSend_error(a3, v71, v72, v73, v74, v75))
            {
              objc_msgSend_decodeFloatForKey_(a3, v76, @"MPSImageLaplacianPyramid.laplacianScale", v77, v78, v79);
              v12->_state.laplacianScale = v80;
              if (!objc_msgSend_error(a3, v81, v82, v83, v84, v85))
              {
                v89 = v117;
                v88 = v118;
                v90 = v117 * v118;
                ...
                if (v97)
                {
                  ...
                  if (v103)
                  {
                    v107 = objc_msgSend_newBufferWithLength_options_(a4, v104, v91, 0, v105, v106);
                    v12->_derivedState.d_WeightsRawFull = v107;
                    if (v107)
                    {
                      v111 = objc_msgSend_newBufferWithLength_options_(a4, v108, 2 * v90, 0, v109, v110);
...
- (id)copyWithZone:(_NSZone *)a3 device:(id)a4
{
  ...
  v11 = [(MPSImagePyramid *)&v56 copyWithZone:a3 device:?];
  if (v11)
  {
    v54 = 0;
    v55 = 0;
    ...
    *(v11 + 46) = v39;
    ...
    v43 = objc_msgSend_newBufferWithLength_options_(a4, v40, v26, 0, v41, v42);
    *(v11 + 47) = v43;
    if (v43 && (v47 = objc_msgSend_newBufferWithLength_options_(a4, v44, v33, 0, v45, v46), (*(v11 + 48) = v47) != 0))
    {
      *v22 = v23;
      *(v11 + 44) = v24;
...
- (void)encodeWithCoder:(id)a3
{
  ...
  if (self->_state.filterWidth * self->_state.filterHeight)
  {
    ...
    do
    {
      ...
      objc_msgSend_encodeFloat_forKey_(a3, v17, v10, v18, v19, v20, v16);
      ++v9;
    }
  ...
  objc_msgSend_encodeBool_forKey_(a3, v5, self->_state.isPyramidAdd, @"MPSImageLaplacianPyramid.isPyramidAdd", v7, v8);
  *&v21 = self->_state.laplacianBias;
  objc_msgSend_encodeFloat_forKey_(a3, v22, @"MPSImageLaplacianPyramid.laplacianBias", v23, v24, v25, v21);
  *&v26 = self->_state.laplacianScale;
  objc_msgSend_encodeFloat_forKey_(a3, v27, @"MPSImageLaplacianPyramid.laplacianScale", v28, v29, v30, v26);
}
