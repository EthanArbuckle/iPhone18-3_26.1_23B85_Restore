  ...
  if (v10)
  {
    ...
    if (width & height & depth)
    {
      if (width == height)
      {
        ...
        v16 = objc_msgSend_initWithDevice_kernelWidth_kernelHeight_(v13, v14, device, width, width, v15);
        v10->_boxFilter = v16;
...
- (void)encodeToCommandBuffer:(id)buffer sourceTexture:(id)texture destinationTexture:(id)destinationTexture
{
  v8 = objc_msgSend_supportedPixelFormats(MPSImageBox3D, a2, buffer, texture, destinationTexture, v5);
  v9 = MEMORY[0x277CCABB0];
  v15 = objc_msgSend_pixelFormat(texture, v10, v11, v12, v13, v14);
  ...
  textureCopy = texture;
  v37 = objc_msgSend_pixelFormat(texture, v32, v33, v34, v35, v36);
  ...
  if ((objc_msgSend_containsObject_(v30, v43, v42, v44, v45, v46) & 1) == 0 && MTLReportFailureTypeEnabled())
  {
    ...
    v490 = objc_msgSend_pixelFormat(texture, v47, v48, v49, v50, v51);
    MTLReportFailure();
  }

  v52 = objc_msgSend_supportedPixelFormats(MPSImageBox3D, v47, v48, v49, v50, v51, textureCopy2, v490);
  v53 = MEMORY[0x277CCABB0];
  v59 = objc_msgSend_pixelFormat(destinationTexture, v54, v55, v56, v57, v58);
  ...
  v81 = objc_msgSend_pixelFormat(destinationTexture, v76, v77, v78, v79, v80);
  ...
  if ((objc_msgSend_containsObject_(v74, v87, v86, v88, v89, v90) & 1) == 0 && MTLReportFailureTypeEnabled())
  {
    ...
    v491 = objc_msgSend_pixelFormat(destinationTexture, v91, v92, v93, v94, v95);
    MTLReportFailure();
  }

  if (objc_msgSend_textureType(texture, v91, v92, v93, v94, v95, destinationTextureCopy, v491) != 2)
  {
    objc_msgSend_textureType(texture, v96, v97, v98, v99, v100);
  }

  if (objc_msgSend_textureType(texture, v96, v97, v98, v99, v100) != 2 && objc_msgSend_textureType(texture, v101, v102, v103, v104, v105) != 3 && MTLReportFailureTypeEnabled())
  {
    textureCopy3 = texture;
    MTLReportFailure();
  }

  objc_msgSend_textureType(destinationTexture, v101, v102, v103, v104, v105, textureCopy3);
  objc_msgSend_textureType(texture, v106, v107, v108, v109, v110);
  v116 = objc_msgSend_textureType(destinationTexture, v111, v112, v113, v114, v115);
  if (v116 != objc_msgSend_textureType(texture, v117, v118, v119, v120, v121) && MTLReportFailureTypeEnabled())
  {
    destinationTextureCopy2 = destinationTexture;
    MTLReportFailure();
  }

  v127 = objc_msgSend_width(texture, v122, v123, v124, v125, v126, destinationTextureCopy2);
  if (v127 != objc_msgSend_width(destinationTexture, v128, v129, v130, v131, v132) || (v138 = objc_msgSend_height(texture, v133, v134, v135, v136, v137), v138 != objc_msgSend_height(destinationTexture, v139, v140, v141, v142, v143)) || (v149 = objc_msgSend_arrayLength(texture, v144, v145, v146, v147, v148), v149 != objc_msgSend_arrayLength(destinationTexture, v150, v151, v152, v153, v154)))
  {
    if (MTLReportFailureTypeEnabled())
    {
...
LABEL_26:
    ...
    if (!objc_msgSend_arrayLength(texture, v155, v156, v157, v158, v159, destinationTextureCopy3, textureCopy4))
    {
      goto LABEL_33;
    }
  ...
  v161 = objc_msgSend_pixelFormat(texture, v155, v156, v157, v158, v159);
  v167 = objc_msgSend_width(texture, v162, v163, v164, v165, v166);
  v173 = objc_msgSend_height(texture, v168, v169, v170, v171, v172);
  v175 = objc_msgSend_texture2DDescriptorWithPixelFormat_width_height_mipmapped_(v160, v174, v161, v167, v173, 0);
  v181 = objc_msgSend_textureType(texture, v176, v177, v178, v179, v180);
  objc_msgSend_setTextureType_(v175, v182, v181, v183, v184, v185);
  v191 = objc_msgSend_arrayLength(texture, v186, v187, v188, v189, v190);
  ...
  v493 = objc_msgSend_temporaryImageWithCommandBuffer_textureDescriptor_(MEMORY[0x277CD72A8], v204, buffer, v175, v205, v206);
  destinationTextureCopy5 = objc_msgSend_texture(v493, v207, v208, v209, v210, v211);
  if (self->_supportsReadWriteTextures)
  {
    goto LABEL_26;
  }
...
LABEL_15:
  ...
  v213 = objc_msgSend_pixelFormat(texture, v155, v156, v157, v158, v159, destinationTextureCopy3, textureCopy4);
  v219 = objc_msgSend_width(texture, v214, v215, v216, v217, v218);
  v225 = objc_msgSend_height(texture, v220, v221, v222, v223, v224);
  ...
  textureCopy6 = texture;
  v240 = objc_msgSend_temporaryImageWithCommandBuffer_textureDescriptor_(MEMORY[0x277CD72A8], v237, buffer, v227, v238, v239);
  v246 = objc_msgSend_arrayLength(textureCopy, v241, v242, v243, v244, v245);
  objc_msgSend_setReadCount_(v240, v247, v246, v248, v249, v250);
  v496 = objc_msgSend_texture(v240, v251, v252, v253, v254, v255);
  if (!objc_msgSend_arrayLength(textureCopy, v256, v257, v258, v259, v260))
  {
LABEL_23:
    if (v240)
    {
  ...
  if (v240)
  {
    ...
    do
    {
      v267 = objc_msgSend_pixelFormat(textureCopy, v261, v262, v263, v264, v265);
      v269 = objc_msgSend_newTextureViewWithPixelFormat_textureType_levels_slices_(textureCopy, v268, v267, 2, 0, 1, v266, 1);
      v275 = objc_msgSend_pixelFormat(destinationTextureCopy5, v270, v271, v272, v273, v274);
      v277 = objc_msgSend_newTextureViewWithPixelFormat_textureType_levels_slices_(destinationTextureCopy5, v276, v275, 2, 0, 1, v266, 1);
      v495 = v269;
      objc_msgSend_encodeToCommandBuffer_sourceTexture_destinationTexture_(self->_boxFilter, v278, buffer, v269, v496, v279);
      v280 = *MEMORY[0x277CD7370];
      v281 = *(&self->super.super.super.isa + v280);
      ComputeState = MPSLibrary::GetComputeState();
      v283 = objc_alloc(MEMORY[0x277CD7210]);
      v291 = objc_msgSend_initWithCommandBuffer_withDispatchType_(v283, v284, buffer, 0, v285, v286);
      v508 = v291;
      selfCopy3 = self;
      ...
      v324 = objc_msgSend_width(textureCopy, v319, v320, v321, v322, v323);
      v330 = objc_msgSend_height(textureCopy, v325, v326, v327, v328, v329);
    ...
    while (v266 < objc_msgSend_arrayLength(textureCopy, v340, v341, v342, v343, v344));
    goto LABEL_23;
  }
...
LABEL_27:
  ...
  do
  {
    v346 = objc_msgSend_pixelFormat(textureCopy6, v261, v262, v263, v264, v265);
    v348 = objc_msgSend_newTextureViewWithPixelFormat_textureType_levels_slices_(textureCopy6, v347, v346, 2, 0, 1, v345, 1);
    v354 = objc_msgSend_pixelFormat(destinationTextureCopy5, v349, v350, v351, v352, v353);
    v356 = objc_msgSend_newTextureViewWithPixelFormat_textureType_levels_slices_(destinationTextureCopy5, v355, v354, 2, 0, 1, v345, 1);
    objc_msgSend_encodeToCommandBuffer_sourceTexture_destinationTexture_(self->_boxFilter, v357, buffer, v348, v356, v358);
    ...
    v370 = objc_msgSend_initWithCommandBuffer_withDispatchType_(v362, v363, buffer, 0, v364, v365);
    v508 = v370;
    selfCopy3 = self;
    if ((*(&self->super.super.super.isa + *MEMORY[0x277CD7378]) & 0x18) != 0)
    {
    ...
    v400 = objc_msgSend_width(textureCopy, v395, v396, v397, v398, v399);
    v406 = objc_msgSend_height(textureCopy, v401, v402, v403, v404, v405);
  ...
  while (v345 < objc_msgSend_arrayLength(textureCopy, v416, v417, v418, v419, v420));
LABEL_33:
  if (self->_kernelDepth >= 2)
  {
    ...
    v432 = objc_msgSend_initWithCommandBuffer_withDispatchType_(v424, v425, buffer, 0, v426, v427);
    v508 = v432;
    selfCopy3 = self;
    if ((*(&self->super.super.super.isa + *MEMORY[0x277CD7378]) & 0x18) != 0)
    {
    ...
    objc_msgSend_setTexture_atIndex_(v432, v440, destinationTextureCopy5, 0, v441, v442);
    objc_msgSend_setTexture_atIndex_(v432, v443, destinationTextureCopy4, 1, v444, v445);
    ...
    v465 = objc_msgSend_width(textureCopy6, v460, v461, v462, v463, v464);
    v471 = objc_msgSend_height(textureCopy6, v466, v467, v468, v469, v470);
