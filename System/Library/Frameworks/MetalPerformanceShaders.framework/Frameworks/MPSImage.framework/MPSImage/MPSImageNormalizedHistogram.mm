...
- (MPSImageNormalizedHistogram)initWithDevice:(id)a3;
...
- (void)dealloc;
- (void)encodeInternalToCommandEncoder:(id)a3 commandBuffer:(id)a4 sourceTexture:(id)a5 minmaxTexture:(id)a6 histogram:(id)a7 histogramOffset:(unint64_t)a8 inputExtent:(id *)a9 srcStyle:(int)a10;
- (void)encodeToCommandEncoder:(id)a3 commandBuffer:(id)a4 sourceTexture:(id)a5 minmaxTexture:(id)a6 histogram:(id)a7 histogramOffset:(unint64_t)a8;
...
- (void)encodeWithCoder:(id)a3
{
  *(&self->super.super.isa + *MEMORY[0x277CD7358] + 2) = 1;
  ...
  objc_msgSend_encodeInt64_forKey_(a3, v5, self->histogramEntries, @"MPSImageNormalizedHistogram.histogramEntries", v6, v7);
  objc_msgSend_encodeBool_forKey_(a3, v8, self->histogramAlpha, @"MPSImageNormalizedHistogram.histogramAlpha", v9, v10);
  LODWORD(v11) = *self->minPixelValue;
  objc_msgSend_encodeFloat_forKey_(a3, v12, @"MPSImageNormalizedHistogram.minPixelValueX", v13, v14, v15, v11);
  LODWORD(v16) = *&self->minPixelValue[4];
  objc_msgSend_encodeFloat_forKey_(a3, v17, @"MPSImageNormalizedHistogram.minPixelValueY", v18, v19, v20, v16);
  LODWORD(v21) = *&self->minPixelValue[8];
  objc_msgSend_encodeFloat_forKey_(a3, v22, @"MPSImageNormalizedHistogram.minPixelValueZ", v23, v24, v25, v21);
  LODWORD(v26) = *&self->minPixelValue[12];
  objc_msgSend_encodeFloat_forKey_(a3, v27, @"MPSImageNormalizedHistogram.minPixelValueW", v28, v29, v30, v26);
  LODWORD(v31) = *self->maxPixelValue;
  objc_msgSend_encodeFloat_forKey_(a3, v32, @"MPSImageNormalizedHistogram.maxPixelValueX", v33, v34, v35, v31);
  LODWORD(v36) = *&self->maxPixelValue[4];
  objc_msgSend_encodeFloat_forKey_(a3, v37, @"MPSImageNormalizedHistogram.maxPixelValueY", v38, v39, v40, v36);
  LODWORD(v41) = *&self->maxPixelValue[8];
  objc_msgSend_encodeFloat_forKey_(a3, v42, @"MPSImageNormalizedHistogram.maxPixelValueZ", v43, v44, v45, v41);
  LODWORD(v46) = *&self->maxPixelValue[12];
  objc_msgSend_encodeFloat_forKey_(a3, v47, @"MPSImageNormalizedHistogram.maxPixelValueW", v48, v49, v50, v46);
  objc_msgSend_encodeInt64_forKey_(a3, v51, self->_clipRectSource.origin.x, @"MPSImageNormalizedHistogram.clipRectSource.origin.x", v52, v53);
  objc_msgSend_encodeInt64_forKey_(a3, v54, self->_clipRectSource.origin.y, @"MPSImageNormalizedHistogram.clipRectSource.origin.y", v55, v56);
  objc_msgSend_encodeInt64_forKey_(a3, v57, self->_clipRectSource.origin.z, @"MPSImageNormalizedHistogram.clipRectSource.origin.z", v58, v59);
  objc_msgSend_encodeInt64_forKey_(a3, v60, self->_clipRectSource.size.width, @"MPSImageNormalizedHistogram.clipRectSource.size.width", v61, v62);
  objc_msgSend_encodeInt64_forKey_(a3, v63, self->_clipRectSource.size.height, @"MPSImageNormalizedHistogram.clipRectSource.size.height", v64, v65);
  objc_msgSend_encodeInt64_forKey_(a3, v66, self->_clipRectSource.size.depth, @"MPSImageNormalizedHistogram.clipRectSource.size.depth", v67, v68);
  objc_msgSend_encodeBool_forKey_(a3, v69, self->_zeroHistogram, @"MPSImageNormalizedHistogram.zeroHistogram", v70, v71);
}
...
- (void)encodeInternalToCommandEncoder:(id)a3 commandBuffer:(id)a4 sourceTexture:(id)a5 minmaxTexture:(id)a6 histogram:(id)a7 histogramOffset:(unint64_t)a8 inputExtent:(id *)a9 srcStyle:(int)a10
{
  ...
  {
    v14 = self->histogramEntries * dword_239989980[a10];
    ...
    else
    {
      ...
      *v76 = v14;
      objc_msgSend_setBytes_length_atIndex_(a3, v30, v76, 4, 1, v31, v72);
    }

    objc_msgSend_setBuffer_offset_atIndex_(a3, v30, a7, a8, 0, v31, v72);
    *v76 = v33;
    *&v76[8] = vdupq_n_s64(1uLL);
    v81 = v24;
    v82 = *&v76[8];
    objc_msgSend_dispatchThreadgroups_threadsPerThreadgroup_(a3, v35, v76, &v81, v36, v37);
  }
  ...
  if (v41)
  {
    objc_msgSend_setComputePipelineState_(a3, v42, v41, v43, v44, v45);
    ...
    *&v76[16] = v54;
    v55 = vmovn_s64(*&a9->var0.var0);
    var1 = a9->var1.var1;
    *&v54 = vmovn_s64(*&a9->var1.var0);
    var0 = a9->var1.var0;
    v80 = 0;
    v78 = v55.u16[2];
    v77 = v55.i16[0];
    ...
    *&v80 = (histogramEntries - 1);
    ...
    objc_msgSend_setTexture_atIndex_(a3, v47, v72, 0, v48, v49, v72);
    objc_msgSend_setTexture_atIndex_(a3, v61, a6, 1, v62, v63);
    if ((v50 - 3) <= 1)
    {
      if ((a10 - 1) >= 4)
      {
        objc_msgSend_setThreadgroupMemoryLength_atIndex_(a3, v64, 0, 0, v65, v66);
      }

      else
      {
        objc_msgSend_setThreadgroupMemoryLength_atIndex_(a3, v64, ((a10 - 1) << 10) + 1024, 0, v65, v66);
      }
    }

    objc_msgSend_setBuffer_offset_atIndex_(a3, v64, a7, a8, 0, v66);
    objc_msgSend_setBytes_length_atIndex_(a3, v67, v76, 48, 1, v68);
    v81 = v58;
    *&v82 = v59;
    *(&v82 + 1) = 1;
    v74 = vdupq_n_s64(0x10uLL);
    v75 = 1;
    objc_msgSend_dispatchThreadgroups_threadsPerThreadgroup_(a3, v69, &v81, &v74, v70, v71);
  }
}
...
- (void)encodeToCommandEncoder:(id)a3 commandBuffer:(id)a4 sourceTexture:(id)a5 minmaxTexture:(id)a6 histogram:(id)a7 histogramOffset:(unint64_t)a8
{
  ...
  if ((v16 & 1) == 0)
  {
    ...
    v20 = objc_msgSend_pixelFormat(0, a2, a3, a4, a5, a6);
    ...
    objc_msgSend_textureType(a5, v27, v28, v29, v30, v31, v111, v114);
    v10 = a6;
  ...
  if (a5 && (objc_msgSend_isEqual_(a5, a2, 0, a4, a5, a6) & 1) == 0)
  {
    if (!v9 && (*(&self->super.super.isa + v15) & 1) == 0 && MTLReportFailureTypeEnabled())
    {
      v107 = objc_opt_class();
    ...
    v121.width = objc_msgSend_width(a5, v40, v41, v42, v43, v44, v111, v114);
    v121.height = objc_msgSend_height(a5, v45, v46, v47, v48, v49);
    v121.depth = 1;
    ...
    *&v120.size.height = *&self->_clipRectSource.size.height;
    ...
    v57 = objc_msgSend_pixelFormat(a5, v52, v53, v54, v55, v56);
    ...
    if ((*(&self->super.super.isa + v15) & 1) == 0)
    {
      ...
      objc_msgSend_width(a5, v58, v59, v60, v61, v62, v112);
      v65 = v122.size.width + v122.origin.x;
      if (v65 > objc_msgSend_width(a5, v66, v67, v68, v69, v70) && MTLReportFailureTypeEnabled())
      {
        v113 = v122.size.width + v122.origin.x;
        v115 = objc_msgSend_width(a5, v71, v72, v73, v74, v75);
        MTLReportFailure();
      }

      objc_msgSend_height(a5, v71, v72, v73, v74, v75, v113, v115);
      v76 = v122.size.height + v122.origin.y;
      if (v76 > objc_msgSend_height(a5, v77, v78, v79, v80, v81) && MTLReportFailureTypeEnabled())
      {
        v112 = (v122.size.height + v122.origin.y);
        v115 = objc_msgSend_height(a5, v58, v108, v109, v110, v62);
        MTLReportFailure();
      }
    }
    ...
    if (v122.size.height && v122.size.width)
    {
      ...
      objc_msgSend_encodeToCommandBuffer_sourceTexture_destinationTexture_(self->_minmaxFilter, v58, v12, a5, v10, v62, v112, v115);
      if (a3)
      {
        v120 = v122;
        LODWORD(v116) = v63;
        objc_msgSend_encodeInternalToCommandEncoder_commandBuffer_sourceTexture_minmaxTexture_histogram_histogramOffset_inputExtent_srcStyle_(self, v82, a3, v12, a5, v10, v9, v8, &v120, v116);
      }
      ...
      else
      {
        ...
        v84 = v12;
        v92 = objc_msgSend_initWithCommandBuffer_withDispatchType_(v83, v85, v12, 0, v86, v87);
        v121.width = v92;
        v121.height = self;
        ...
        v120 = v122;
        LODWORD(v116) = v63;
        objc_msgSend_encodeInternalToCommandEncoder_commandBuffer_sourceTexture_minmaxTexture_histogram_histogramOffset_inputExtent_srcStyle_(self, v88, v92, v84, a5, v10, v9, v8, &v120, v116);
