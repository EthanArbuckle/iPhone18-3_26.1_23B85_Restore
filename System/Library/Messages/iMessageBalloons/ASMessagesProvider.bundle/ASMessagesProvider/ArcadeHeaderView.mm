...
- (void)preferredContentSizeCategoryDidChange
{
  v3 = OBJC_IVAR____TtC18ASMessagesProvider15TitleHeaderView_titleLabel;
  v4 = *(&self->super.super.super.super.super.isa + OBJC_IVAR____TtC18ASMessagesProvider15TitleHeaderView_titleLabel);
  selfCopy = self;
