...
- (_TtC18ASMessagesProvider23CollectionTableViewCell)initWithStyle:(int64_t)style reuseIdentifier:(id)identifier;
- (void)layoutSubviews;
...
- (_TtC18ASMessagesProvider23CollectionTableViewCell)initWithStyle:(int64_t)style reuseIdentifier:(id)identifier
{
  ...
  return sub_2564DC(style, identifier, v6);
}
