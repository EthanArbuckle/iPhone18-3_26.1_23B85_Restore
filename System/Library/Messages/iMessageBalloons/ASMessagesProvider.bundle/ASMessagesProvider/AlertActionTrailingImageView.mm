...
- (_TtC18ASMessagesProvider28AlertActionTrailingImageView)initWithFrame:(CGRect)frame;
- (void)layoutSubviews;
...
- (void)tintColorDidChange
{
  ...
  v3 = *&v2[OBJC_IVAR____TtC18ASMessagesProvider28AlertActionTrailingImageView_label];
