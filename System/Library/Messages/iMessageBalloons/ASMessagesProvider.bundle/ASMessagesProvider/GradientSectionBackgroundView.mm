...
- (_TtC18ASMessagesProvider29GradientSectionBackgroundView)initWithCoder:(id)coder;
- (_TtC18ASMessagesProvider29GradientSectionBackgroundView)initWithFrame:(CGRect)frame;
- (void)layoutSubviews;
...
- (_TtC18ASMessagesProvider29GradientSectionBackgroundView)initWithFrame:(CGRect)frame
{
  ...
  *(&self->super.super.super.super.isa + v8) = [objc_allocWithZone(type metadata accessor for GradientView()) init];
  ...
  [(GradientSectionBackgroundView *)height addSubview:*(&height->super.super.super.super.isa + OBJC_IVAR____TtC18ASMessagesProvider29GradientSectionBackgroundView_gradientView)];
  return height;
}
