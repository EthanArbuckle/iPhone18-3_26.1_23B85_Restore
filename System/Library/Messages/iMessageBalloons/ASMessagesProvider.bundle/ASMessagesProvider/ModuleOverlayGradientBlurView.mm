...
- (_TtC18ASMessagesProvider29ModuleOverlayGradientBlurView)initWithCoder:(id)coder;
- (_TtC18ASMessagesProvider29ModuleOverlayGradientBlurView)initWithEffect:(id)effect;
- (void)layoutSubviews;
@end
