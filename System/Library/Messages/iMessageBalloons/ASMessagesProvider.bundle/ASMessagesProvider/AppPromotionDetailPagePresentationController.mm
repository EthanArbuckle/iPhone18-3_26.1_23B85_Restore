...
- (_TtC18ASMessagesProvider44AppPromotionDetailPagePresentationController)initWithPresentedViewController:(id)controller presentingViewController:(id)viewController;
...
- (_TtC18ASMessagesProvider44AppPromotionDetailPagePresentationController)initWithPresentedViewController:(id)controller presentingViewController:(id)viewController
{
  ...
  sub_44F38C(controllerCopy, viewController);
  return result;
}
...
- (void)willTransitionToTraitCollection:(id)collection withTransitionCoordinator:(id)coordinator
{
  ...
  selfCopy = self;
  sub_44FF94(collectionCopy, coordinator);
...
- (void)viewWillTransitionToSize:(CGSize)size withTransitionCoordinator:(id)coordinator
{
  ...
  swift_unknownObjectRetain();
  selfCopy = self;
  sub_450154(coordinator, width, height);
  swift_unknownObjectRelease();
}
