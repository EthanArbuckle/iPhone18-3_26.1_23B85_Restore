...
- (BYODMemberLeaveRequest)initWithAccount:(id)account accountStore:(id)store domain:(id)domain;
- (id)bodyDictionary;
- (id)urlString;
...
- (BYODMemberLeaveRequest)initWithAccount:(id)account accountStore:(id)store domain:(id)domain
{
  ...
  storeCopy = store;
  domainCopy = domain;
  urlString = [(BYODMemberLeaveRequest *)self urlString];
  v14.receiver = self;
  v14.super_class = BYODMemberLeaveRequest;
