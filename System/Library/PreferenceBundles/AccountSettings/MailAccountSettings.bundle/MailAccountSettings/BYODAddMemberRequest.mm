...
- (BYODAddMemberRequest)initWithAccount:(id)account accountStore:(id)store domain:(id)domain email:(id)email phone:(id)phone;
- (id)bodyDictionary;
- (id)urlString;
...
- (BYODAddMemberRequest)initWithAccount:(id)account accountStore:(id)store domain:(id)domain email:(id)email phone:(id)phone
{
  ...
  emailCopy = email;
  phoneCopy = phone;
  urlString = [(BYODAddMemberRequest *)self urlString];
  v20.receiver = self;
  v20.super_class = BYODAddMemberRequest;
