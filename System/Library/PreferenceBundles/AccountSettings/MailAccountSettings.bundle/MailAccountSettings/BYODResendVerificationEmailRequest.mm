...
- (BYODResendVerificationEmailRequest)initWithAccount:(id)account accountStore:(id)store domain:(id)domain;
- (id)bodyDictionary;
- (id)urlString;
...
- (BYODResendVerificationEmailRequest)initWithAccount:(id)account accountStore:(id)store domain:(id)domain
{
  ...
  storeCopy = store;
  domainCopy = domain;
  urlString = [(BYODResendVerificationEmailRequest *)self urlString];
  v14.receiver = self;
