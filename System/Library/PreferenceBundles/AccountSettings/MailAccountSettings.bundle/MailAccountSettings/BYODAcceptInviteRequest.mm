...
- (BYODAcceptInviteRequest)initWithAccount:(id)account accountStore:(id)store domain:(id)domain;
- (id)bodyDictionary;
- (id)urlString;
...
- (BYODAcceptInviteRequest)initWithAccount:(id)account accountStore:(id)store domain:(id)domain
{
  ...
  storeCopy = store;
  domainCopy = domain;
  urlString = [(BYODAcceptInviteRequest *)self urlString];
  v14.receiver = self;
  v14.super_class = BYODAcceptInviteRequest;
