...
- (BYODListEmailRequest)initWithAccount:(id)account accountStore:(id)store;
- (id)urlString;
...
- (BYODListEmailRequest)initWithAccount:(id)account accountStore:(id)store
{
  accountCopy = account;
  storeCopy = store;
  urlString = [(BYODListEmailRequest *)self urlString];
  v11.receiver = self;
  v11.super_class = BYODListEmailRequest;
