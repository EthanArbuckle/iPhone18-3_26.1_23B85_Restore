...
- (BYODListDomainRequest)initWithAccount:(id)account accountStore:(id)store;
- (id)urlString;
...
- (BYODListDomainRequest)initWithAccount:(id)account accountStore:(id)store
{
  accountCopy = account;
  storeCopy = store;
  urlString = [(BYODListDomainRequest *)self urlString];
  v11.receiver = self;
  v11.super_class = BYODListDomainRequest;
