...
+ (id)alertContentForGenericInitiateVettingError
{
  ...
  v3 = sub_16B8(v2, &stru_14980);
  v7[1] = @"ckVettingAlertBody";
  v8[0] = v3;
  v4 = sub_16B8(@"VETTING_FAILURE_ALERT_BODY_INITIATE_GENERIC_ERROR", &stru_14980);
  v8[1] = v4;
...
+ (id)alertContentForRequestAccessWithHandle:(id)handle
{
  ...
  v12[0] = @"ckVettingAlertTitle";
  v9 = sub_16B8(@"ASK_FOR_ACCESS", &stru_14980);
  v12[1] = @"ckVettingAlertBody";
  v13[0] = v9;
  v13[1] = v8;
...
+ (id)alertContentForRequestAccessConfirmation
{
  ...
  v2 = sub_16B8(@"CLOUDKIT_VETTING_ACCESS_REQUEST_SENT_TITLE", &stru_14980);
  v6[1] = @"ckVettingAlertBody";
  v7[0] = v2;
  v3 = sub_16B8(@"CLOUDKIT_VETTING_ACCESS_REQUEST_SENT_MESSAGE", &stru_14980);
  v7[1] = v3;
...
{
  v6[0] = @"ckVettingAlertTitle";
  v2 = sub_16B8(@"CLOUDKIT_VETTING_ACCESS_CANT_SEND_REQUEST_TITLE", &stru_14980);
  v6[1] = @"ckVettingAlertBody";
  v7[0] = v2;
  v3 = sub_16B8(@"CLOUDKIT_VETTING_ACCESS_TRY_AGAIN_LATER", &stru_14980);
  v7[1] = v3;
  v4 = [NSDictionary dictionaryWithObjects:v7 forKeys:v6 count:2];
