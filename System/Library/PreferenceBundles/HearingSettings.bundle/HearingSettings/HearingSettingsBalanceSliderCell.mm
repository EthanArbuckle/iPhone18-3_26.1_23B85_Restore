...
+ (id)valueLabels;
- (HearingSettingsBalanceSliderCell)initWithStyle:(int64_t)style reuseIdentifier:(id)identifier;
- (HearingSettingsBalanceSliderCellDelegate)delegate;
- (id)_labelForSliderValue:(float)value;
- (id)accessibilityValue;
- (void)refreshCellContentsWithSpecifier:(id)specifier;
- (void)sliderDidEndEditing:(id)editing;
...
- (HearingSettingsBalanceSliderCell)initWithStyle:(int64_t)style reuseIdentifier:(id)identifier
{
  ...
  v4 = [(HearingSettingsValueSliderCell *)&v15 initWithStyle:1 reuseIdentifier:identifier];
  v5 = v4;
  if (v4)
  {
    v14.receiver = v4;
    v14.super_class = HearingSettingsBalanceSliderCell;
    slider = [(HearingSettingsValueSliderCell *)&v14 slider];
    [(HearingSettingsBalanceSliderCell *)v5 minValue];
    *&v7 = v7;
    [slider setMinimumValue:v7];
    [(HearingSettingsBalanceSliderCell *)v5 maxValue];
    *&v8 = v8;
    [slider setMaximumValue:v8];
    [slider addTarget:v5 action:"sliderValueDidChange:" forControlEvents:4096];
    [slider addTarget:v5 action:"sliderDidEndEditing:" forControlEvents:192];
    if ([slider isSegmented])
    {
      v9 = [slider segmentCount] + 1;
    }
    ...
    [slider _setSliderConfiguration:v11];
  }
...
- (void)refreshCellContentsWithSpecifier:(id)specifier
{
  ...
  [(HearingSettingsValueSliderCell *)&v6 refreshCellContentsWithSpecifier:specifier];
...
{
  editingCopy = editing;
  delegate = [(HearingSettingsBalanceSliderCell *)self delegate];
  v5 = objc_opt_respondsToSelector();

  if (v5)
  {
    delegate2 = [(HearingSettingsBalanceSliderCell *)self delegate];
    [editingCopy value];
    [delegate2 balanceSliderDidChangeToValue:v7];
  }
}
