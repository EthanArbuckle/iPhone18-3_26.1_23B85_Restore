...
- (void)setStateForServiceID:(id)a3
{
  ...
  v15 = [v9 optionsForServiceID:v4 withGrade:{-[ContentFilterSetupListController vpnGrade](self, "vpnGrade")}];
...
- (id)connection
{
  ...
  v4 = [(ContentFilterSetupListController *)self serviceID];
  v5 = [v3 connectionWithServiceID:v4 withGrade:{-[ContentFilterSetupListController vpnGrade](self, "vpnGrade")}];
...
- (id)statusForConnection:(id)a3
{
  v3 = [(ContentFilterSetupListController *)self connection];
  v4 = v3;
  if (v3)
  {
    v5 = [v3 statusText];
...
- (id)specifiers
{
  ...
  {
    v3 = [(ContentFilterSetupListController *)self displayName];
    ...
    v54 = v4;
    [v4 addObject:v11];
    v13 = [(ContentFilterSetupListController *)v2 includedBundleIDs];
    if (v13)
    {
      v14 = v13;
      v15 = [(ContentFilterSetupListController *)v2 includedBundleIDs];
      v16 = [v15 count];
      ...
      if (v16)
      {
        ...
        v57 = 0u;
        v58 = 0u;
        obj = [(ContentFilterSetupListController *)v2 includedBundleIDs];
          ...
          do
          {
            for (i = 0; i != v22; i = i + 1)
            {
              ...
              if (v31)
              {
                ...
                v34 = [(ContentFilterSetupListController *)v21 includedBundleIDs];
