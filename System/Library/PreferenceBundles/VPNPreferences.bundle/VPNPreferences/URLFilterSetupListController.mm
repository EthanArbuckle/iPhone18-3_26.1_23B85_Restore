...
- (void)setStateForServiceID:(id)a3
{
  ...
  v15 = [v9 optionsForServiceID:v4 withGrade:{-[URLFilterSetupListController vpnGrade](self, "vpnGrade")}];
...
- (id)connection
{
  ...
  v4 = [(URLFilterSetupListController *)self serviceID];
  v5 = [v3 connectionWithServiceID:v4 withGrade:{-[URLFilterSetupListController vpnGrade](self, "vpnGrade")}];
...
- (id)statusForConnection:(id)a3
{
  v3 = [(URLFilterSetupListController *)self connection];
  v4 = v3;
  if (v3)
  {
    v5 = [v3 statusText];
...
- (id)specifiers
{
  ...
  {
    v3 = [(URLFilterSetupListController *)self displayName];
    [(URLFilterSetupListController *)v2 setTitle:v3];
    ...
    v54 = v4;
    [v4 addObject:v11];
    v13 = [(URLFilterSetupListController *)v2 includedBundleIDs];
    if (v13)
    {
      v14 = v13;
      v15 = [(URLFilterSetupListController *)v2 includedBundleIDs];
      v16 = [v15 count];
      ...
      if (v16)
      {
        ...
        v57 = 0u;
        v58 = 0u;
        obj = [(URLFilterSetupListController *)v2 includedBundleIDs];
          ...
          do
          {
            for (i = 0; i != v22; i = i + 1)
            {
              ...
              if (v31)
              {
                ...
                v34 = [(URLFilterSetupListController *)v21 includedBundleIDs];
