...
+ (id)appIconImageForBundleIdentifier:(id)a3
{
  ...
  {
    v8 = [[ISIcon alloc] initWithBundleIdentifier:v3];
...
{
  v3 = a3;
  v4 = [[ISIcon alloc] initWithType:v3];
...
- (GCSettingsAppIcon)initWithISImage:(id)a3
{
  ...
  if (v6)
  {
    objc_storeStrong(&v6->_isImage, a3);
  }
...
- (id)UIImage
{
  ...
  {
    v4 = [UIImage alloc];
    v5 = [(IFImage *)self->_isImage CGImage];
    [(IFImage *)self->_isImage scale];
    v6 = [v4 initWithCGImage:v5 scale:0 orientation:?];
    v7 = self->_uiImage;
    self->_uiImage = v6;
