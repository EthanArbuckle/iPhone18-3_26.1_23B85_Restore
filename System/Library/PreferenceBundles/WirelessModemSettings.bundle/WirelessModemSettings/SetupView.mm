...
- (SetupView)initWithFrame:(CGRect)frame;
...
- (SetupView)initWithFrame:(CGRect)frame
{
  ...
  v3 = [(SetupView *)&v9 initWithFrame:frame.origin.x, frame.origin.y, frame.size.width, frame.size.height];
  if (v3)
  {
    clearColor = [MEMORY[0x277D75348] clearColor];
    [(SetupView *)v3 setBackgroundColor:clearColor];
    ...
    v3->_layoutDirection = [mEMORY[0x277D75128] userInterfaceLayoutDirection];
  }
...
- (void)setIcon:(id)icon
{
  ...
  if (iconCopy)
  {
    ...
    [(UIImageView *)v9 setTintColor:labelColor];
...
- (void)addStep:(id)step
{
  ...
  v10 = [(SetupView *)self _preferenceLabelWithText:stepCopy];
...
- (CGSize)sizeThatFits:(CGSize)fits shouldSetSize:(BOOL)size
{
  ...
  [(UIImageView *)self->_icon frame:fits.width];
  if (width >= v6 + 20.0 + 15.0)
  {
    ...
    if (icon)
    {
      ...
      {
        [(UIImageView *)selfCopy->_icon frame];
        v17 = v12 - v18;
      }
      ...
      if (sizeCopy)
      {
        ...
        [(UIImageView *)selfCopy->_icon setFrame:v86.origin.x, v86.origin.y, v86.size.width, v86.size.height];
      }
    ...
    if (title)
    {
      ...
      v80 = *v20;
      font = [(UILabel *)selfCopy->_title font];
      v81[0] = font;
      v24 = [MEMORY[0x277CBEAC0] dictionaryWithObjects:v81 forKeys:&v80 count:1];
      [text boundingRectWithSize:1 options:v24 attributes:0 context:{v12, height}];
      v26 = v25;
      v28 = v27;
      ...
      if (sizeCopy)
      {
        ...
        [(UILabel *)selfCopy->_title setFrame:v87.origin.x, v87.origin.y, v87.size.width, v87.size.height];
      }
    ...
    if ([(NSMutableArray *)selfCopy->_setupSteps count])
    {
      v69 = x;
      v33 = 0;
      v34 = *v20;
      ...
      {
        v36 = selfCopy;
        v37 = [(NSMutableArray *)selfCopy->_setupSteps objectAtIndex:v33];
        ...
        v43 = v42 = v21;
        [text2 boundingRectWithSize:0 options:v43 attributes:0 context:{v12, height}];
        v45 = v44;
        rect = v46;
        ...
        if (v71 == 1)
        {
          ...
          [text3 boundingRectWithSize:1 options:v50 attributes:0 context:{v47 + -10.0, height}];
          v52 = v51;
          v54 = v53;
        ...
        else
        {
          ...
          [text4 boundingRectWithSize:1 options:v58 attributes:0 context:{v47 + -5.0, height}];
          v52 = v59;
          v54 = v60;
...
- (CGSize)sizeThatFits:(CGSize)fits
{
  [(SetupView *)self sizeThatFits:0 shouldSetSize:fits.width, fits.height];
  result.height = v4;
  result.width = v3;
  return result;
}
