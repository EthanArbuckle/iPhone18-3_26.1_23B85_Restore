...
+ (id)mediaTypesForIdentifier:(id)identifier
{
  ...
  v5 = [qword_BA560 objectForKey:identifierCopy];
...
- (NSMutableDictionary)mediaCache
{
  ...
  if (!mediaCache)
  {
    ...
    v17 = [(STMediaCache *)self cacheItemForQuery:v16 withGroupingType:10 splitByPropertyName:MPMediaItemPropertyStorePlaylistID defaultPropertyValue:&off_AEFB8];
