...
- (void)viewDidAppear:(BOOL)appear
{
  ...
  [(CSAlternateCalendarsController *)&v17 viewDidAppear:appear];
  ...
  v9 = [v5 initWithKey:@"Alternate Calendars" table:@"MobileCalSettings" locale:v6 bundleURL:bundleURL];
...
- (void)viewDidDisappear:(BOOL)disappear
{
  ...
  [(CSAlternateCalendarsController *)&v5 viewDidDisappear:disappear];
