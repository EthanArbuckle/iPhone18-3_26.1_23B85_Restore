...
- (void)viewDidAppear:(BOOL)appear
{
  ...
  [(CSDefaultAllDayEventAlarmsController *)&v21 viewDidAppear:appear];
  ...
  v8 = [v4 initWithKey:@"All-Day Events" table:@"MobileCalSettings" locale:v5 bundleURL:bundleURL];
...
- (void)viewDidDisappear:(BOOL)disappear
{
  ...
  [(CSDefaultAllDayEventAlarmsController *)&v4 viewDidDisappear:disappear];
