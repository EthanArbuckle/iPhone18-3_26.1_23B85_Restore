...
- (void)viewDidAppear:(BOOL)appear
{
  ...
  [(CSDefaultEventAlarmsController *)&v21 viewDidAppear:appear];
  ...
  v8 = [v4 initWithKey:@"Events" table:@"MobileCalSettings" locale:v5 bundleURL:bundleURL];
...
- (void)viewDidDisappear:(BOOL)disappear
{
  ...
  [(CSDefaultEventAlarmsController *)&v4 viewDidDisappear:disappear];
