...
- (void)tableView:(id)view willDisplayCell:(id)cell forRowAtIndexPath:(id)path
{
  ...
  v9 = [specifier propertyForKey:@"HTContentType"];
  v10 = [v9 isEqual:v7];
...
- (void)tableView:(id)view didSelectRowAtIndexPath:(id)path
{
  ...
  pathCopy = path;
  [(HoverTextContentTypeViewController *)&v11 tableView:view didSelectRowAtIndexPath:pathCopy];
  v7 = [(HoverTextContentTypeViewController *)self specifierAtIndex:[(HoverTextContentTypeViewController *)self indexForIndexPath:pathCopy, v11.receiver, v11.super_class]];
  v8 = [v7 propertyForKey:@"HTContentType"];
  integerValue = [v8 integerValue];
  v10 = +[AXSettings sharedInstance];
  [v10 setHoverTextContentType:integerValue];

  [(HoverTextContentTypeViewController *)self updateTableCheckedSelection:pathCopy];
}
