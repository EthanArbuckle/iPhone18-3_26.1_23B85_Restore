...
- (BOOL)_shouldEnableHeadSwitch:(int64_t)switch;
- (id)specifiers;
...
- (void)tableView:(id)view didSelectRowAtIndexPath:(id)path
{
  ...
  v5 = [(SCATCameraHeadGesturesSwitchSourceController *)&v17 tableView:view cellForRowAtIndexPath:path];
  ...
  if ([identifier isEqualToString:@"LeftHeadMovementSwitchIdentifier"])
  {
    v9 = 1;
  }
  ...
  {
    if (![identifier isEqualToString:@"RightHeadMovementSwitchIdentifier"])
    {
      goto LABEL_6;
    }
...
LABEL_6:
  ...
  {
    navigationController = [(SCATCameraHeadGesturesSwitchSourceController *)self navigationController];
  ...
  else
  {
    ...
    rootController = [(SCATCameraHeadGesturesSwitchSourceController *)self rootController];
    ...
    [(SCATCameraHeadGesturesSwitchSourceController *)self showController:navigationController animate:1];
  }
}
