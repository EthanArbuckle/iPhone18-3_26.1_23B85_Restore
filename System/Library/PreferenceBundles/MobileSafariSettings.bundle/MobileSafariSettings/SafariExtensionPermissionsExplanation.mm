...
- (NSArray)specifiers;
- (SafariExtensionPermissionsExplanation)initWithContentBlocker:(id)a3 withDisplayName:(id)a4;
- (SafariExtensionPermissionsExplanation)initWithExtension:(id)a3;
- (id)title;
@end
...
{
  v4 = a3;
  v5 = [v4 userVisiblePermissions];
  if (v5 && (v26.receiver = self, v26.super_class = SafariExtensionPermissionsExplanation, (self = [(SafariExtensionPermissionsExplanation *)&v26 init]) != 0))
  {
    v6 = objc_alloc_init(NSMutableArray);
    v7 = [v4 displayName];
    objc_storeStrong(&self->_extensionName, v7);
    v8 = [v4 composedIdentifier];
    composedIdentifier = self->_composedIdentifier;
    self->_composedIdentifier = v8;

    v10 = [v5 safari_stringForKey:@"Level"];
    if ([v10 isEqualToString:WBSExtensionPermissionDiscreteAccessLevelKey])
    {
      self->_titleType = 2;
      v11 = [v5 objectForKeyedSubscript:@"Configured Sites"];
      objc_opt_class();
      ...
      v14 = v13;
      v15 = [v11 isEqual:@"All"];
      v16 = [v5 safari_BOOLForKey:@"Requested Current Site"];
      if ([v5 safari_BOOLForKey:@"Has Injected Content"])
      {
      ...
      {
        v25 = v14;
        v20 = [v5 safari_BOOLForKey:@"Requests Tracking"];
        v17 = [SafariWebExtensionPermissionsExplanationSection alloc];
        if (v20)
        {
          v18 = 1;
      ...
      v21 = [(SafariWebExtensionPermissionsExplanationSection *)v17 initWithType:v18 sites:v14 allowedOnAllSites:v15 includesCurrentTab:v16 extensionName:v7];
      [v6 addObject:v21];
    }
...
- (SafariExtensionPermissionsExplanation)initWithContentBlocker:(id)a3 withDisplayName:(id)a4
{
  ...
  {
    v7->_titleType = 1;
    objc_storeStrong(&v7->_extensionName, a4);
    v9 = v8;
  }
...
- (NSArray)specifiers
{
  ...
  if (self->_titleType <= 1uLL)
  {
    ...
    v50 = @"subtitle";
    v11 = [(SafariExtensionPermissionsExplanation *)self title];
    v51 = v11;
    ...
    do
    {
      for (i = 0; i != v14; i = i + 1)
      {
        ...
        if (v23 >= v24)
        {
          ...
          v39 = 0u;
          v26 = [v17 sites];
          v27 = [v26 countByEnumeratingWithState:&v38 objects:v48 count:16];
          if (v27)
          {
            v28 = v27;
            v29 = *v39;
            do
            {
              ...
              v28 = [v26 countByEnumeratingWithState:&v38 objects:v48 count:16];
            }
