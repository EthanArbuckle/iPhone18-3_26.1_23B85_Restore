...
- (void)commit
{
  if (self->_languageToSet)
  {
    if ([(ISLanguageSetupController *)self isSettingDifferentLanguage])
    {
      ...
      v4 = [v3 localizedStringForKey:@"CHANGE_TO_%@_FOR_NEW_DEVICE_LANGUAGE" value:&stru_35798 table:@"InternationalSettings"];
      ...
      v14 = [v13 localizedStringForKey:@"WOULD_YOU_LIKE_TO_USE_%@_AS_PRIMARY_LANGUAGE" value:&stru_35798 table:@"InternationalSettings"];
      ...
      else
      {
        ...
        v22 = [v20 localizedStringForKey:v21 value:&stru_35798 table:@"InternationalSettings"];
        ...
        v24 = [v23 localizedStringForKey:@"PREFER_%@" value:&stru_35798 table:@"InternationalSettings"];
        ...
        v26 = [v25 localizedStringForKey:@"PREFER_%@" value:&stru_35798 table:@"InternationalSettings"];
        ...
        v18 = [v28 localizedStringForKey:@"ADD_PREFERRED_LANGUAGE_TITLE" value:&stru_35798 table:@"InternationalSettings"];
...
- (void)saveLanguage:(BOOL)a3
{
  ...
  if ([v14 count])
  {
    ...
    v13 = CFPreferencesCopyValue(@"AppleKeyboards", kCFPreferencesAnyApplication, kCFPreferencesCurrentUser, kCFPreferencesAnyHost);
    if (v13)
    {
...
- (void)setupController
{
  ...
  v3 = [NSBundle bundleForClass:objc_opt_class()];
  v4 = [v3 localizedStringForKey:@"Language" value:&stru_35798 table:@"InternationalSettings"];
  [v6 setName:v4];
