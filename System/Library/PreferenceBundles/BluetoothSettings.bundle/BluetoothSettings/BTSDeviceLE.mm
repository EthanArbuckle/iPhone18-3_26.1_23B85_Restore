  ...
  else
  {
    ...
    else
    {
      ...
      else
      {
        ...
        v4 = [v10 localizedStringForKey:@"ACCESSORY" value:&stru_284EE3458 table:@"Devices"];
      }
    }
  }
...
- (void)sendNextChannelSoundingMessage
{
  ...
  v8 = 138412290;
  v9 = v6;
  _os_log_error_impl(&dword_23C0F7000, a2, OS_LOG_TYPE_ERROR, "Error sending channel sounding data: %@", &v8, 0xCu);
    ...
    if (a4 != 4)
    {
      ...
      if (a4 == 16)
      {
        ...
        if (os_log_type_enabled(v9, OS_LOG_TYPE_DEFAULT))
        {
          v15 = 67109120;
          v16 = 128;
          _os_log_impl(&dword_23C0F7000, v9, OS_LOG_TYPE_DEFAULT, "NSStreamEventEndEncountered for %d", &v15, 8u);
        }
...
LABEL_20:
    _os_log_impl(&dword_23C0F7000, v10, OS_LOG_TYPE_DEFAULT, v11, &v15, 8u);
    goto LABEL_21;
  }
...
LABEL_15:
        _os_log_impl(&dword_23C0F7000, v7, OS_LOG_TYPE_DEFAULT, v8, &v15, 8u);
        goto LABEL_25;
      }
...
- (void)stream:(void *)a1 handleEvent:(NSObject *)a2 .cold.1(void *a1, NSObject *a2)
{
  ...
  v7 = 2112;
  v8 = v4;
  _os_log_error_impl(&dword_23C0F7000, a2, OS_LOG_TYPE_ERROR, "NSStreamEventErrorOccurred for %d. Error: %@", v6, 0x12u);
