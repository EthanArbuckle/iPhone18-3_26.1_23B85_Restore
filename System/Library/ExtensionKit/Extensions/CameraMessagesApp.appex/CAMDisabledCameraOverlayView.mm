...
- (CAMDisabledCameraOverlayView)initWithFrame:(CGRect)frame;
...
- (CAMDisabledCameraOverlayView)initWithFrame:(CGRect)frame
{
  ...
  v3 = [(CAMDisabledCameraOverlayView *)&v20 initWithFrame:frame.origin.x, frame.origin.y, frame.size.width, frame.size.height];
  if (v3)
  {
...
- (void)_updateFonts
{
  ...
  _messageLabel = [(CAMDisabledCameraOverlayView *)self _messageLabel];
  [_messageLabel setFont:v3];
}
...
- (void)layoutSubviews
{
  ...
  v8 = v7;
  v10 = v9;
  doneButton = [(CAMDisabledCameraOverlayView *)self doneButton];
  _messageLabel = [(CAMDisabledCameraOverlayView *)self _messageLabel];
  [doneButton intrinsicContentSize];
  [doneButton setFrame:{v8 - v13 + -16.0 + -10.0, 21.0, v13 + 20.0, v14 + 20.0}];
  [_messageLabel setFrame:{v4 + 15.0, v6 + 0.0, v8 + -30.0, v10}];
}
