...
- (_TtC22SubscribePageExtension25ArtworkCollectionViewCell)initWithCoder:(id)coder;
- (_TtC22SubscribePageExtension25ArtworkCollectionViewCell)initWithFrame:(CGRect)frame;
- (void)layoutSubviews;
...
- (_TtC22SubscribePageExtension25ArtworkCollectionViewCell)initWithFrame:(CGRect)frame
{
  ...
  *(&self->super.super.super.super.super.isa + OBJC_IVAR____TtC22SubscribePageExtension25ArtworkCollectionViewCell_artworkView) = [objc_allocWithZone(sub_1007433C4()) initWithFrame:{0.0, 0.0, 0.0, 0.0}];
  ...
  [contentView addSubview:*(&height->super.super.super.super.super.isa + OBJC_IVAR____TtC22SubscribePageExtension25ArtworkCollectionViewCell_artworkView)];
