...
+ (void)as_activatePresentationHack
{
  ...
  block[3] = &unk_100861128;
  block[4] = self;
  if (qword_100948990 != -1)
  {
    dispatch_once(&qword_100948990, block);
  }
}
...
- (_TtP22SubscribePageExtension20PageTraitEnvironment_)snapshotPageTraitEnvironment
{
  ...
  *v10 = v4;
  *(v10 + 1) = v6;
  *&v9[OBJC_IVAR____TtC22SubscribePageExtension28SnapshotPageTraitEnvironment_traitCollection] = traitCollection;
  v14.receiver = v9;
  v14.super_class = v8;
  v11 = traitCollection;
