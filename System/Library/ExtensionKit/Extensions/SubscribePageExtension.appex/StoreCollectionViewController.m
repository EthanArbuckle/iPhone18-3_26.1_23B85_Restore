...
{
  v4 = self;
  sub_10062D5C0(a3, &selRef_viewWillAppear_, &enum case for StoreViewControllerLifecycleEvent.willAppear(_:));
}
...
{
  v2 = self;
  sub_10062D32C(&selRef_as_viewDidBecomeFullyVisible, &enum case for StoreViewControllerLifecycleEvent.didBecomeFullyVisible(_:));
}

- (void)as_viewWillBecomePartiallyVisible
{
  v2 = self;
  sub_10062D32C(&selRef_as_viewWillBecomePartiallyVisible, &enum case for StoreViewControllerLifecycleEvent.willBecomePartiallyVisible(_:));
}

- (void)as_viewDidBecomePartiallyVisible
{
  v2 = self;
  sub_10062D32C(&selRef_as_viewDidBecomePartiallyVisible, &enum case for StoreViewControllerLifecycleEvent.didBecomePartiallyVisible(_:));
}

- (void)viewDidDisappear:(BOOL)a3
{
  v4 = self;
  sub_10062D5C0(a3, &selRef_viewDidDisappear_, &enum case for StoreViewControllerLifecycleEvent.didDisappear(_:));
}
