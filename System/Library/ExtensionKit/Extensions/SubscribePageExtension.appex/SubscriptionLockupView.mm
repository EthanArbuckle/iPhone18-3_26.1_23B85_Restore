...
- (void)setLayoutMargins:(UIEdgeInsets)a3
{
  ...
  v10 = *(&v9->super.super.super.isa + OBJC_IVAR____TtC22SubscribePageExtension22SubscriptionLockupView_iapLockupView);
  v13.receiver = v9;
  v13.super_class = ObjectType;
  [(SubscriptionLockupView *)&v13 layoutMargins];
  [v10 setLayoutMargins:?];
  v11 = *(&v9->super.super.super.isa + OBJC_IVAR____TtC22SubscribePageExtension22SubscriptionLockupView_appLockupView);
  v12.receiver = v9;
...
- (CGSize)sizeThatFits:(CGSize)a3
{
  ...
  v13 = sub_1001CF768(v10, v8, width, height, v11, v12);
  v15 = v14;
