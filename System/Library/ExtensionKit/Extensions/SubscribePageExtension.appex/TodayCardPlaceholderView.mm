...
- (void)layoutSubviews
{
  ...
  v3 = *&v2[OBJC_IVAR____TtC22SubscribePageExtension24TodayCardPlaceholderView_shadowView];
  [v2 bounds];
  [v3 setFrame:?];
  v4 = *&v2[OBJC_IVAR____TtC22SubscribePageExtension24TodayCardPlaceholderView_cardPlaceholder];
  [v2 bounds];
  [v4 setFrame:?];
}
