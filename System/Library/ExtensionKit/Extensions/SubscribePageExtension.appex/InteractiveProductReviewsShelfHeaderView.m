...
- (_TtC22SubscribePageExtension40InteractiveProductReviewsShelfHeaderView)initWithCoder:(id)a3
{
  v3 = self + OBJC_IVAR____TtC22SubscribePageExtension40InteractiveProductReviewsShelfHeaderView_currentState;
  *v3 = 0u;
  *(v3 + 1) = 0u;
  *(v3 + 4) = 0;
  v3[40] = 1;
...
- (void)prepareForReuse
{
  ...
  [*&v2[OBJC_IVAR____TtC22SubscribePageExtension40InteractiveProductReviewsShelfHeaderView_firstColumnLabel] setText:{0, v4.receiver, v4.super_class}];
  [*&v2[OBJC_IVAR____TtC22SubscribePageExtension40InteractiveProductReviewsShelfHeaderView_pinnedLabel] setText:0];
