...
- (CGRect)frame;
- (_TtCC22SubscribePageExtension30ArticleContainerViewControllerP33_BACDBA853B9C19619833ED681F77E93313ContainerView)initWithCoder:(id)coder;
- (_TtCC22SubscribePageExtension30ArticleContainerViewControllerP33_BACDBA853B9C19619833ED681F77E93313ContainerView)initWithFrame:(CGRect)frame;
...
- (void)setFrame:(CGRect)frame
{
  ...
  {
    v22 = *(&selfCopy->super.super.super.isa + OBJC_IVAR____TtCC22SubscribePageExtension30ArticleContainerViewControllerP33_BACDBA853B9C19619833ED681F77E93313ContainerView_frameUpdatedCallback);
    if (v22)
    {
