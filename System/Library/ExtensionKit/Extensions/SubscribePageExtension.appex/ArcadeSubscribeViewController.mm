...
- (_TtC22SubscribePageExtension29ArcadeSubscribeViewController)initWithCoder:(id)coder;
...
- (_TtC22SubscribePageExtension29ArcadeSubscribeViewController)initWithCoder:(id)coder
{
  *(&self->super.super.super.isa + OBJC_IVAR____TtC22SubscribePageExtension29ArcadeSubscribeViewController_overlayViewController) = 0;
  *(&self->super.super.super.isa + OBJC_IVAR____TtC22SubscribePageExtension29ArcadeSubscribeViewController_fallbackDismissButton) = 0;
  *&self->lifecycleObserver[OBJC_IVAR____TtC22SubscribePageExtension29ArcadeSubscribeViewController_delegate] = 0;
  swift_unknownObjectWeakInit();
  *(&self->super.super.super.isa + OBJC_IVAR____TtC22SubscribePageExtension29ArcadeSubscribeViewController_delayedDismissalReappearanceItem) = 0;
...
- (void)viewDidDisappear:(BOOL)disappear
{
  ...
  sub_10000C888((&selfCopy->super.super.super.isa + OBJC_IVAR____TtC22SubscribePageExtension29ArcadeSubscribeViewController_lifecycleObserver), *&selfCopy->lifecycleObserver[OBJC_IVAR____TtC22SubscribePageExtension29ArcadeSubscribeViewController_lifecycleObserver + 16]);
