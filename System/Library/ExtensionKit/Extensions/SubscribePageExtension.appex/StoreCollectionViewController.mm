...
- (_TtC22SubscribePageExtension29StoreCollectionViewController)initWithCollectionViewLayout:(id)layout;
- (_TtC22SubscribePageExtension29StoreCollectionViewController)initWithNibName:(id)name bundle:(id)bundle;
...
{
  selfCopy = self;
  sub_10062D5C0(appear, &selRef_viewWillAppear_, &enum case for StoreViewControllerLifecycleEvent.willAppear(_:));
}

- (void)viewDidAppear:(BOOL)appear
{
  selfCopy = self;
  sub_10062C80C(appear);
}

- (void)viewWillDisappear:(BOOL)disappear
{
  selfCopy = self;
  sub_10062CAC0(disappear);
}
...
{
  selfCopy = self;
  sub_10062D5C0(disappear, &selRef_viewDidDisappear_, &enum case for StoreViewControllerLifecycleEvent.didDisappear(_:));
}
