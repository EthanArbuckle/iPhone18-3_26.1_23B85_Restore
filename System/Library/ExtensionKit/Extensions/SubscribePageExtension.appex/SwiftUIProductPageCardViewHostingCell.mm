...
- (_TtC22SubscribePageExtension37SwiftUIProductPageCardViewHostingCell)initWithCoder:(id)coder;
- (_TtC22SubscribePageExtension37SwiftUIProductPageCardViewHostingCell)initWithFrame:(CGRect)frame;
@end
