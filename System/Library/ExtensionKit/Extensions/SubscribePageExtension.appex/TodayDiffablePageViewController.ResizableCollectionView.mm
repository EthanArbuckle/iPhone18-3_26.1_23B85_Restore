...
- (CGRect)frame;
- (_TtCC22SubscribePageExtension31TodayDiffablePageViewControllerP33_B12EF26EAF02F70AE4817770683129CD23ResizableCollectionView)initWithCoder:(id)coder;
- (_TtCC22SubscribePageExtension31TodayDiffablePageViewControllerP33_B12EF26EAF02F70AE4817770683129CD23ResizableCollectionView)initWithFrame:(CGRect)frame collectionViewLayout:(id)layout;
- (void)reloadData;
