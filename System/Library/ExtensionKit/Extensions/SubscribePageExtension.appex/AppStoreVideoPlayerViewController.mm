...
- (_TtC22SubscribePageExtension33AppStoreVideoPlayerViewController)initWithCoder:(id)coder;
- (_TtC22SubscribePageExtension33AppStoreVideoPlayerViewController)initWithNibName:(id)name bundle:(id)bundle;
- (_TtC22SubscribePageExtension33AppStoreVideoPlayerViewController)initWithPlayerLayerView:(id)view;
@end
