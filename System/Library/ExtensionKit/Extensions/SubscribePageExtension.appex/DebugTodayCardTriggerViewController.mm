...
- (id)tableView:(id)a3 titleForHeaderInSection:(int64_t)a4
{
  ...
  if (*(*(self + OBJC_IVAR____TtC22SubscribePageExtension35DebugTodayCardTriggerViewController_sections) + 16) <= a4)
  {
LABEL_7:
    __break(1u);
    return self;
...
- (id)tableView:(id)a3 willSelectRowAtIndexPath:(id)a4
{
  ...
  v9 = sub_10000C518(&unk_100923C00);
  ...
  v14 = *(&v12->super.super.super.super.isa + OBJC_IVAR____TtC22SubscribePageExtension35DebugTodayCardTriggerViewController_sections);
  if (result >= *(v14 + 16))
  {
LABEL_13:
    __break(1u);
