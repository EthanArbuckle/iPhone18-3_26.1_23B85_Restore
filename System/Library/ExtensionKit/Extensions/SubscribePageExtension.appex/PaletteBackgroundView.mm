...
- (_TtC22SubscribePageExtension21PaletteBackgroundView)initWithCoder:(id)coder;
- (_TtC22SubscribePageExtension21PaletteBackgroundView)initWithEffect:(id)effect;
@end
...
- (_TtC22SubscribePageExtension21PaletteBackgroundView)initWithEffect:(id)effect
{
  *(&self->super.super.super.super.isa + OBJC_IVAR____TtC22SubscribePageExtension21PaletteBackgroundView_blurEffectOverride) = 0;
  v5.receiver = self;
