...
- (_TtC22SubscribePageExtension32GridTodayBrickCollectionViewCell)initWithFrame:(CGRect)frame;
- (void)layoutSubviews;
@end
...
- (_TtC22SubscribePageExtension32GridTodayBrickCollectionViewCell)initWithFrame:(CGRect)frame
{
  ...
  v9 = OBJC_IVAR____TtC22SubscribePageExtension32GridTodayBrickCollectionViewCell_grid;
  *(&self->super.super.super.super.super.super.isa + v9) = [objc_allocWithZone(type metadata accessor for ArtworkGrid()) initWithFrame:{0.0, 0.0, 0.0, 0.0}];
  ...
  [*(&height->super.super.super.super.super.super.isa + OBJC_IVAR____TtC22SubscribePageExtension32BaseTodayBrickCollectionViewCell_mainContentView) addSubview:*(&height->super.super.super.super.super.super.isa + OBJC_IVAR____TtC22SubscribePageExtension32GridTodayBrickCollectionViewCell_grid)];
  return height;
}
...
- (void)layoutSubviews
{
  ...
  v3 = *&v2[OBJC_IVAR____TtC22SubscribePageExtension32GridTodayBrickCollectionViewCell_grid];
