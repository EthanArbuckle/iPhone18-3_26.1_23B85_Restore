...
- (_TtC22SubscribePageExtension32GridTodayBrickCollectionViewCell)initWithFrame:(CGRect)a3;
- (void)layoutSubviews;
@end
...
- (_TtC22SubscribePageExtension32GridTodayBrickCollectionViewCell)initWithFrame:(CGRect)a3
{
  ...
  *(&self->super.super.super.super.super.super.isa + v9) = [objc_allocWithZone(type metadata accessor for ArtworkGrid()) initWithFrame:{0.0, 0.0, 0.0, 0.0}];
  ...
  [*(&v10->super.super.super.super.super.super.isa + OBJC_IVAR____TtC22SubscribePageExtension32BaseTodayBrickCollectionViewCell_mainContentView) addSubview:*(&v10->super.super.super.super.super.super.isa + OBJC_IVAR____TtC22SubscribePageExtension32GridTodayBrickCollectionViewCell_grid)];
  return v10;
}
