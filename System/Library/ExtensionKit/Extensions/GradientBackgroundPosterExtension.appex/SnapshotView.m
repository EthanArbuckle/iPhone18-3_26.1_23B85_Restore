...
- (_TtC33GradientBackgroundPosterExtension12SnapshotView)initWithCoder:(id)a3;
- (_TtC33GradientBackgroundPosterExtension12SnapshotView)initWithFrame:(CGRect)a3;
- (void)layoutSubviews;
@end
