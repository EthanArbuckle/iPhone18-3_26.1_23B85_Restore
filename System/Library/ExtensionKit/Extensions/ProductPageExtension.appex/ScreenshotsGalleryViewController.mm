...
- (void)collectionView:(id)a3 didSelectItemAtIndexPath:(id)a4
{
  ...
  if (v12 == *(&v11->super.super.super.super.super.isa + OBJC_IVAR____TtC20ProductPageExtension32ScreenshotsGalleryViewController_selectedIndex))
  {
