...
{
  v4 = self;
  sub_100075EA0(a3, &selRef_viewWillAppear_, &enum case for StoreViewControllerLifecycleEvent.willAppear(_:));
}
...
{
  v4 = self;
  sub_100075EA0(a3, &selRef_viewDidDisappear_, &enum case for StoreViewControllerLifecycleEvent.didDisappear(_:));
}
