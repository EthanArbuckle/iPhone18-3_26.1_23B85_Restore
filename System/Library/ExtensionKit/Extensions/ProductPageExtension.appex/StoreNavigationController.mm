...
- (_TtC20ProductPageExtension25StoreNavigationController)initWithCoder:(id)coder;
- (_TtC20ProductPageExtension25StoreNavigationController)initWithNavigationBarClass:(Class)class toolbarClass:(Class)toolbarClass;
- (_TtC20ProductPageExtension25StoreNavigationController)initWithNibName:(id)name bundle:(id)bundle;
- (_TtC20ProductPageExtension25StoreNavigationController)initWithRootViewController:(id)controller;
