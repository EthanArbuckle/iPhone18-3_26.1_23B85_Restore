...
- (_TtC20ProductPageExtension32GridTodayBrickCollectionViewCell)initWithFrame:(CGRect)a3;
- (void)layoutSubviews;
@end
...
- (_TtC20ProductPageExtension32GridTodayBrickCollectionViewCell)initWithFrame:(CGRect)a3
{
  ...
  v9 = OBJC_IVAR____TtC20ProductPageExtension32GridTodayBrickCollectionViewCell_grid;
  *(&self->super.super.super.super.super.super.isa + v9) = [objc_allocWithZone(type metadata accessor for ArtworkGrid()) initWithFrame:{0.0, 0.0, 0.0, 0.0}];
  ...
  [*(&v10->super.super.super.super.super.super.isa + OBJC_IVAR____TtC20ProductPageExtension32BaseTodayBrickCollectionViewCell_mainContentView) addSubview:*(&v10->super.super.super.super.super.super.isa + OBJC_IVAR____TtC20ProductPageExtension32GridTodayBrickCollectionViewCell_grid)];
  return v10;
}
...
- (void)layoutSubviews
{
  ...
  v3 = *&v2[OBJC_IVAR____TtC20ProductPageExtension32GridTodayBrickCollectionViewCell_grid];
