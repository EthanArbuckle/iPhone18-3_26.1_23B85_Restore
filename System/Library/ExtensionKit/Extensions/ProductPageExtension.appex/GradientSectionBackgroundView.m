...
- (_TtC20ProductPageExtension29GradientSectionBackgroundView)initWithFrame:(CGRect)a3
{
  ...
  *(&self->super.super.super.super.isa + v8) = [objc_allocWithZone(type metadata accessor for GradientView()) init];
  ...
  [(GradientSectionBackgroundView *)v9 addSubview:*(&v9->super.super.super.super.isa + OBJC_IVAR____TtC20ProductPageExtension29GradientSectionBackgroundView_gradientView)];
  return v9;
}
