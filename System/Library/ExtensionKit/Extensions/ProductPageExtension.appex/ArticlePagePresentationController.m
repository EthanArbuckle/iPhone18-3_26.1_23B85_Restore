...
- (void)dismissalTransitionDidEnd:(BOOL)a3
{
  if (a3)
  {
    ...
    [*(&v4->super.super.isa + OBJC_IVAR____TtC20ProductPageExtension33ArticlePagePresentationController_overlayBlurView) removeFromSuperview];
  }
}
