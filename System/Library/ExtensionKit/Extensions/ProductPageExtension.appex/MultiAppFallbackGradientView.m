...
- (_TtC20ProductPageExtension28MultiAppFallbackGradientView)initWithFrame:(CGRect)a3
{
  ...
  *(&self->super.super.super.super.isa + v9) = [objc_allocWithZone(type metadata accessor for GradientView()) init];
  ...
  v11 = sub_1000871F4();
  v12 = *(&v10->super.super.super.super.isa + OBJC_IVAR____TtC20ProductPageExtension28MultiAppFallbackGradientView_overlayGradientView);
  *(&v10->super.super.super.super.isa + OBJC_IVAR____TtC20ProductPageExtension28MultiAppFallbackGradientView_overlayGradientView) = v11;
