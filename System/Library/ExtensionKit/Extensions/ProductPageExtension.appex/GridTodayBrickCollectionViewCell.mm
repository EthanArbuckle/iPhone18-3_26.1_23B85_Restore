...
- (_TtC20ProductPageExtension32GridTodayBrickCollectionViewCell)initWithFrame:(CGRect)frame;
- (void)layoutSubviews;
@end
...
- (_TtC20ProductPageExtension32GridTodayBrickCollectionViewCell)initWithFrame:(CGRect)frame
{
  ...
  *(&self->super.super.super.super.super.super.isa + v9) = [objc_allocWithZone(type metadata accessor for ArtworkGrid()) initWithFrame:{0.0, 0.0, 0.0, 0.0}];
  ...
  [*(&height->super.super.super.super.super.super.isa + OBJC_IVAR____TtC20ProductPageExtension32BaseTodayBrickCollectionViewCell_mainContentView) addSubview:*(&height->super.super.super.super.super.super.isa + OBJC_IVAR____TtC20ProductPageExtension32GridTodayBrickCollectionViewCell_grid)];
  return height;
}
