...
- (_TtC20ProductPageExtension19IconArtworkGridView)initWithFrame:(CGRect)frame;
- (void)layoutSubviews;
...
- (JUMeasurements)measurementsWithFitting:(CGSize)fitting in:(id)in
{
  ...
  width = fitting.width;
  v7 = OBJC_IVAR____TtC20ProductPageExtension19IconArtworkGridView_layoutMetrics;
  swift_beginAccess();
  sub_10015E8A4(self + v7, v18);
  selfCopy = self;

  v10 = sub_10016E274(v9);
