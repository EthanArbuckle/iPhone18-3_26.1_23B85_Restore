...
- (_TtC20ProductPageExtension21PaletteBackgroundView)initWithCoder:(id)coder;
- (_TtC20ProductPageExtension21PaletteBackgroundView)initWithEffect:(id)effect;
@end
...
- (_TtC20ProductPageExtension21PaletteBackgroundView)initWithEffect:(id)effect
{
  *(&self->super.super.super.super.isa + OBJC_IVAR____TtC20ProductPageExtension21PaletteBackgroundView_blurEffectOverride) = 0;
  v5.receiver = self;
