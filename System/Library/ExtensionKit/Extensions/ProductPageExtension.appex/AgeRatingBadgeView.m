...
- (void)tintColorDidChange
{
  v2 = *(&self->super.super.super.isa + OBJC_IVAR____TtC20ProductPageExtension18AgeRatingBadgeView_ageLabel);
  v4 = self;
...
- (void)drawRect:(CGRect)a3
{
  ...
  x = a3.origin.x;
  v7 = self;
  sub_100340904(x, y, width, height);
}
...
- (void)layoutSubviews
{
  ...
  v3 = OBJC_IVAR____TtC20ProductPageExtension18AgeRatingBadgeView_ageLabel;
  v4 = *&v2[OBJC_IVAR____TtC20ProductPageExtension18AgeRatingBadgeView_ageLabel];
  sub_10076422C();
