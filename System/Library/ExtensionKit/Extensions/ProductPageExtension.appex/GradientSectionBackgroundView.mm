...
- (_TtC20ProductPageExtension29GradientSectionBackgroundView)initWithCoder:(id)coder;
- (_TtC20ProductPageExtension29GradientSectionBackgroundView)initWithFrame:(CGRect)frame;
- (void)layoutSubviews;
...
- (_TtC20ProductPageExtension29GradientSectionBackgroundView)initWithFrame:(CGRect)frame
{
  ...
  *(&self->super.super.super.super.isa + v8) = [objc_allocWithZone(type metadata accessor for GradientView()) init];
  ...
  [(GradientSectionBackgroundView *)height addSubview:*(&height->super.super.super.super.isa + OBJC_IVAR____TtC20ProductPageExtension29GradientSectionBackgroundView_gradientView)];
  return height;
}

- (_TtC20ProductPageExtension29GradientSectionBackgroundView)initWithCoder:(id)coder
{
  v3 = OBJC_IVAR____TtC20ProductPageExtension29GradientSectionBackgroundView_gradientView;
...
- (void)layoutSubviews
{
  ...
  v3 = *&v2[OBJC_IVAR____TtC20ProductPageExtension29GradientSectionBackgroundView_gradientView];
  [v2 bounds];
  [v3 setFrame:?];
}
