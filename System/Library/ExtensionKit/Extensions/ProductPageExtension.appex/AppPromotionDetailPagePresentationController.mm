...
- (_TtC20ProductPageExtension44AppPromotionDetailPagePresentationController)initWithPresentedViewController:(id)controller presentingViewController:(id)viewController;
...
- (_TtC20ProductPageExtension44AppPromotionDetailPagePresentationController)initWithPresentedViewController:(id)controller presentingViewController:(id)viewController
{
  ...
  sub_10002E698(controllerCopy, viewController);
  return result;
}
...
- (void)willTransitionToTraitCollection:(id)collection withTransitionCoordinator:(id)coordinator
{
  ...
  selfCopy = self;
  sub_10002F2A0(collectionCopy, coordinator);
...
- (void)viewWillTransitionToSize:(CGSize)size withTransitionCoordinator:(id)coordinator
{
  ...
  swift_unknownObjectRetain();
  selfCopy = self;
  sub_10002F460(coordinator, width, height);
  swift_unknownObjectRelease();
}
