...
- (_TtC20ProductPageExtension35SmallSearchLockupCollectionViewCell)initWithCoder:(id)coder;
- (void)layoutSubviews;
@end
...
- (_TtC20ProductPageExtension35SmallSearchLockupCollectionViewCell)initWithCoder:(id)coder
{
  v3 = OBJC_IVAR____TtC20ProductPageExtension35SmallSearchLockupCollectionViewCell_lockupView;
...
- (void)layoutSubviews
{
  ...
  v3 = *&v2[OBJC_IVAR____TtC20ProductPageExtension35SmallSearchLockupCollectionViewCell_lockupView];
