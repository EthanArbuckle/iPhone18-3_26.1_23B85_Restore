...
- (_TtC20ProductPageExtension37MaterialGradientSectionBackgroundView)initWithCoder:(id)a3
{
  v4 = OBJC_IVAR____TtC20ProductPageExtension37MaterialGradientSectionBackgroundView_gradientView;
  *(&self->super.super.super.super.isa + v4) = [objc_allocWithZone(type metadata accessor for GradientView()) init];
  v5 = OBJC_IVAR____TtC20ProductPageExtension37MaterialGradientSectionBackgroundView_materialView;
...
- (void)layoutSubviews
{
  ...
  v3 = *&v2[OBJC_IVAR____TtC20ProductPageExtension37MaterialGradientSectionBackgroundView_gradientView];
  [v2 bounds];
  [v3 setFrame:?];
  v4 = *&v2[OBJC_IVAR____TtC20ProductPageExtension37MaterialGradientSectionBackgroundView_materialView];
  [v2 bounds];
  [v4 setFrame:?];
}
