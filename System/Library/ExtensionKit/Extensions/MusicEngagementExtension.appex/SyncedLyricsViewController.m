...
- (void)tapHandler:(id)a3
{
  v4 = a3;
  v5 = self;
  SyncedLyricsViewController.tapHandler(_:)(v4);
}
...
- (BOOL)gestureRecognizer:(id)a3 shouldReceiveTouch:(id)a4
{
  ...
  v7 = a4;
  v8 = self;
  v9 = specialized SyncedLyricsViewController.gestureRecognizer(_:shouldReceive:)(v7);
...
- (void)scrollViewWillEndDragging:(id)a3 withVelocity:(CGPoint)a4 targetContentOffset:(CGPoint *)a5
{
  ...
  v9 = a3;
  v10 = self;
  specialized SyncedLyricsViewController.scrollViewWillEndDragging(_:withVelocity:targetContentOffset:)(a5, x, y);
}
