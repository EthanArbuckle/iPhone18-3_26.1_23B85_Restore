...
- (void)tintColorDidChange
{
  ...
  swift_beginAccess();
  outlined init with copy of SymbolButton.Configuration(v7 + v8, v5, type metadata accessor for SymbolButton.Configuration);
...
- (id)pointerInteraction:(id)a3 styleForRegion:(id)a4
{
  ...
  v7 = a4;
  v8 = self;
  v9 = specialized SymbolButton.pointerInteraction(_:styleFor:)(v6);
