...
- (BOOL)synchronizeFollowUpsForAccount:(id)a3 error:(id *)a4
{
  ...
  v10 = [MEMORY[0x29EDBFB38] sharedInstance];
  v9 = [v10 store];
...
- (BOOL)synchronizeFollowUpsForAccount:(id)a3 inStore:(id)a4 error:(id *)a5
{
  ...
  if ([(AKFollowUpSynchronizer *)v30 shouldSynchronizeForAccount:location[0]])
  {
    ...
    if (os_log_type_enabled(v26, OS_LOG_TYPE_ERROR))
    {
      ...
      v17 = [MEMORY[0x29EDBFB38] sharedInstance];
      v16 = [v17 altDSIDForAccount:location[0]];
      v24 = MEMORY[0x29EDC9748](v16);
      sub_29C876360(v32, v18, v24);
    ...
    v23 = objc_opt_new();
    v11 = [MEMORY[0x29EDBFB38] sharedInstance];
    v10 = [v11 altDSIDForAccount:location[0]];
    [v23 setAltDSID:?];
    MEMORY[0x29EDC9740](v10);
