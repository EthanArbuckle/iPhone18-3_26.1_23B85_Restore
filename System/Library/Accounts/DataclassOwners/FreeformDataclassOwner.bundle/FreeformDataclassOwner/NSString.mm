...
void __76__NSString_CRLApplicationAdditions__crl_nameByConvertingFirstNameToInitials__block_invoke(uint64_t a1, void *a2, uint64_t a3, uint64_t a4, uint64_t a5, uint64_t a6, _BYTE *a7)
{
  v14 = a2;
  if ([v14 length] >= 2)
  {
...
- (id)crl_stringByUniquingPathInsideDirectory:(id)directory withFormat:(id)format
{
  ...
  if (!directoryCopy)
  {
    ...
    if (os_log_type_enabled(CRLAssertCat_log_t, OS_LOG_TYPE_ERROR))
    {
      [NSString(CRLAdditions) crl_stringByUniquingPathInsideDirectory:v8 withFormat:?];
    }
...
void __77__NSString_CRLAdditions__crl_stringByUniquingPathInsideDirectory_withFormat___block_invoke_99(id a1)
{
  CRLAssertCat_log_t = CRLLogCreateCategory("CRLAssertCat");
...
- (id)crl_stringByRemovingCharactersInSet:(id)set options:(unsigned int)options
{
  ...
  else
  {
    ...
    if (os_log_type_enabled(CRLAssertCat_log_t, OS_LOG_TYPE_ERROR))
    {
      [NSString(CRLAdditions) crl_stringByUniquingPathInsideDirectory:v9 withFormat:?];
    }
...
void __70__NSString_CRLAdditions__crl_stringByRemovingCharactersInSet_options___block_invoke_107(id a1)
{
  CRLAssertCat_log_t = CRLLogCreateCategory("CRLAssertCat");
...
- (id)crl_escapeForIcuRegex
{
  ...
  {
    [NSString(CRLAdditions) crl_escapeForIcuRegex];
  }

  selfCopy = self;
  v4 = [(NSString *)selfCopy length];
  *&v13 = [(NSString *)selfCopy rangeOfCharacterFromSet:crl_escapeForIcuRegex_icuRegexCharSet];
    ...
    if (v4 != v13)
    {
      do
      {
        ...
        *(&v13 + 1) = &v4[-v13];
        ...
        if (v4 != v13)
        {
          *&v12 = [(NSString *)selfCopy rangeOfCharacterFromSet:crl_escapeForIcuRegex_icuRegexCharSet options:0 range:v13];
          *(&v12 + 1) = v9;
          v13 = v12;
...
void __47__NSString_CRLAdditions__crl_escapeForIcuRegex__block_invoke(id a1)
{
  ...
  objc_storeStrong(&crl_escapeForIcuRegex_icuRegexCharSet, v1);
  if (!crl_escapeForIcuRegex_icuRegexCharSet)
  {
    +[CRLAssertionHandler _atomicIncrementAssertCount];
    if (CRLAssertCat_init_token != -1)
    {
      __47__NSString_CRLAdditions__crl_escapeForIcuRegex__block_invoke_cold_1();
    }
    ...
    if (CRLAssertCat_init_token != -1)
    {
      __47__NSString_CRLAdditions__crl_escapeForIcuRegex__block_invoke_cold_3();
    }

    v2 = CRLAssertCat_log_t;
    if (os_log_type_enabled(CRLAssertCat_log_t, OS_LOG_TYPE_ERROR))
    {
      [NSString(CRLAdditions) crl_stringByUniquingPathInsideDirectory:v2 withFormat:?];
    }
...
void __47__NSString_CRLAdditions__crl_escapeForIcuRegex__block_invoke_119(id a1)
{
  CRLAssertCat_log_t = CRLLogCreateCategory("CRLAssertCat");
...
+ (id)crl_stringByBase64EncodingBytes:(const char *)bytes length:(unint64_t)length breakLines:(BOOL)lines
{
  ...
  if (lengthCopy == 1)
  {
    [v8 appendFormat:@"%c%c==", Base64Alphabet[bytes[v12] >> 2], Base64Alphabet[16 * (bytes[v12] & 3)], v15];
  }
...
{
  extensionCopy = extension;
  if (-[NSString isEqualToString:](self, "isEqualToString:", &stru_4EB10) || [extensionCopy isEqualToString:&stru_4EB10])
  {
    selfCopy = self;
LABEL_4:
    v6 = selfCopy;
...
- (id)crl_stringWithoutAttachmentCharacters
{
  ...
  {
    [NSString(CRLAdditions) crl_stringWithoutAttachmentCharacters];
  }

  v3 = crl_stringWithoutAttachmentCharacters_sAttachmentCharacter;

  return [(NSString *)self stringByReplacingOccurrencesOfString:v3 withString:&stru_4EB10];
}
...
void __63__NSString_CRLAdditions__crl_stringWithoutAttachmentCharacters__block_invoke(id a1)
{
  ...
  v2 = crl_stringWithoutAttachmentCharacters_sAttachmentCharacter;
  crl_stringWithoutAttachmentCharacters_sAttachmentCharacter = v1;
}
...
- (id)crl_stringWithNormalizedHyphens
{
  ...
  {
    [NSString(CRLAdditions) crl_stringWithNormalizedHyphens];
  }

  v3 = crl_stringWithNormalizedHyphens_hyphenSet;
...
- (id)crl_stringWithNormalizedQuotationMarks
{
  ...
  {
    [NSString(CRLAdditions) crl_stringWithNormalizedQuotationMarks];
  }

  v3 = crl_stringWithNormalizedQuotationMarks_quotationSet;
...
- (id)crl_stringWithoutBidiControls
{
  ...
  v4 = [(NSString *)self crl_stringByReplacingInstancesOfCharactersInSet:v3 withString:&stru_4EB10];
...
void __98__NSString_CRLAdditions__crl_regexForTitleParsingWithLocalizedCopyString_isFirstCopyFormatString___block_invoke_200(id a1)
{
  CRLAssertCat_log_t = CRLLogCreateCategory("CRLAssertCat");
...
- (id)crl_stringByApplyingSubstitutions:(id)substitutions
{
  ...
  allKeys = [v6 allKeys];
  v8 = [allKeys sortedArrayUsingComparator:&__block_literal_global_216];
...
- (void)crl_appendJSONStringToString:(id)string
{
  ...
  {
    [NSString(CRLAdditions) crl_appendJSONStringToString:];
  }

  [stringCopy appendString:@""];
  if ([(NSString *)self rangeOfCharacterFromSet:crl_appendJSONStringToString__escapeCharacters]!= 0x7FFFFFFFFFFFFFFFLL)
  {
    v5 = [(NSString *)self length];
...
+ (id)crl_stringWithItemProviderData:(id)data typeIdentifier:(id)identifier error:(id *)error
{
  ...
  if (!v8)
  {
    ...
    if (os_log_type_enabled(CRLAssertCat_log_t, OS_LOG_TYPE_ERROR))
    {
      [NSString(CRLAdditions) crl_stringWithItemProviderData:identifierCopy typeIdentifier:v9 error:?];
    }
...
void __78__NSString_CRLAdditions__crl_stringWithItemProviderData_typeIdentifier_error___block_invoke_252(id a1)
{
  CRLAssertCat_log_t = CRLLogCreateCategory("CRLAssertCat");
...
+ (id)crl_localizedDisplayNameWithPersonNameComponents:(id)components
{
  ...
  {
    +[NSString(CRLPersonNameComponents) crl_localizedDisplayNameWithPersonNameComponents:];
  }
...
- (id)crl_initRedactedWithFormat:(id)format arguments:(char *)arguments
{
  ...
  {
    [NSString(CRLLogAdditions) crl_initRedactedWithFormat:arguments:];
  }

  v7 = [crl_initRedactedWithFormat_arguments__redactRegex stringByReplacingMatchesInString:v6 options:0 range:0 withTemplate:{objc_msgSend(v6, "length"), @"<redacted>"}];
...
void __66__NSString_CRLLogAdditions__crl_initRedactedWithFormat_arguments___block_invoke(id a1)
{
  ...
  v2 = v4;
  v3 = crl_initRedactedWithFormat_arguments__redactRegex;
  crl_initRedactedWithFormat_arguments__redactRegex = v1;
}
