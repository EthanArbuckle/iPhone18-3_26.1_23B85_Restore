  ...
  if (v7)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        unsignedIntValue = [*(*(&v15 + 1) + 8 * v10) unsignedIntValue];
        v12 = [NSString stringWithCharacters:&unsignedIntValue length:1];
        stringCopy = [v11 stringByReplacingOccurrencesOfString:v12 withString:@" "];
