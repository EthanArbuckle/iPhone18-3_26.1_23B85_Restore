  ...
  if (a4)
  {
    ...
    if (objc_opt_isKindOfClass())
    {
      ...
      if (a2)
      {
        ...
        *buf = 67109120;
        *&buf[4] = a2;
        v23 = "Unhandled BTSessionEvent: %d";
        v24 = buf;
        v25 = v16;
      ...
      {
        *buf = 0;
        _os_log_impl(&dword_23361B000, v15, OS_LOG_TYPE_INFO, "BTSession attached", buf, 2u);
      }
      ...
      if (a1)
      {
        ...
        *buf = 0;
        ...
        if (v20 && !Default)
        {
          ...
          {
            *v28 = 0;
            _os_log_impl(&dword_23361B000, v16, OS_LOG_TYPE_INFO, "Successfully established BT session", v28, 2u);
          }

          [v13 setBTAccessoryManager:*buf];
          [v13 setIsBTReady:1];
          v16 = [v13 setup_complete_semaphore];
        ...
        {
          *v28 = 0;
          v23 = "Unabled to establish BT session";
          v24 = v28;
          goto LABEL_56;
        }
      }
      ...
      else
      {
        ...
        {
          *buf = 0;
          v23 = "ERROR - OOBBTPairing __callbackSessionEvent called with a NULL BTSession";
          v24 = buf;
LABEL_56:
          v25 = v16;
          ...
          v27 = 2;
LABEL_57:
          _os_log_impl(&dword_23361B000, v25, v26, v23, v24, v27);
        }
      }
