...
+ (void)_accessibilityPerformValidations:(id)validations
{
  ...
  [validationsCopy validateClass:@"_CSDoubleBatteryChargingView" hasInstanceVariable:@"_internalChargingNameLabel" withType:"SBUILegibilityLabel"];
  [validationsCopy validateClass:@"_CSDoubleBatteryChargingView" hasInstanceVariable:@"_internalChargePercentLabel" withType:"SBUILegibilityLabel"];
  [validationsCopy validateClass:@"_CSDoubleBatteryChargingView" hasInstanceVariable:@"_externalChargingNameLabel" withType:"SBUILegibilityLabel"];
  [validationsCopy validateClass:@"_CSDoubleBatteryChargingView" hasInstanceVariable:@"_externalChargePercentLabel" withType:"SBUILegibilityLabel"];
  [validationsCopy validateClass:@"_CSDoubleBatteryChargingView" hasInstanceVariable:@"_internalChargingIndicator" withType:"UIImageView"];
  [validationsCopy validateClass:@"_CSDoubleBatteryChargingView" hasInstanceVariable:@"_externalChargingIndicator" withType:"UIImageView"];
}
