...
{
  v3 = a3;
  [v3 validateClass:@"CSActivityPickerViewController" hasInstanceMethod:@"viewDidLoad" withFullSignature:{"v", 0}];
  [v3 validateClass:@"CSActivityPickerViewController" hasInstanceMethod:@"dismiss" withFullSignature:{"v", 0}];
}
