...
+ (void)_accessibilityPerformValidations:(id)validations
{
  ...
  [validationsCopy validateClass:@"PSPasscodeField" hasInstanceMethod:@"numberOfEntryFields" withFullSignature:{"Q", 0}];
  [validationsCopy validateClass:@"PSPasscodeField" hasInstanceMethod:@"stringValue" withFullSignature:{"@", 0}];
}
...
- (id)accessibilityValue
{
  ...
  v9 = [v7 localizedStringWithFormat:v8, v6, integerValue];
