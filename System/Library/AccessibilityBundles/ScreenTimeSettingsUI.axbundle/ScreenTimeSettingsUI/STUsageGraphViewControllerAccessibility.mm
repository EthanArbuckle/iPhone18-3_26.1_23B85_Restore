...
{
  v3 = a3;
  [v3 validateClass:@"STUsageGraphViewController" hasInstanceMethod:@"weeklyAverageLine" withFullSignature:{"@", 0}];
  [v3 validateClass:@"STUsageGraphViewController" hasInstanceVariable:@"_titleView" withType:"UIView"];
  [v3 validateClass:@"STUsageGraphViewController" hasInstanceMethod:@"barViews" withFullSignature:{"@", 0}];
  [v3 validateClass:@"STUsageGraphViewController" hasInstanceMethod:@"dataSet" withFullSignature:{"@", 0}];
  [v3 validateClass:@"STBarView" hasInstanceMethod:@"dataPoint" withFullSignature:{"@", 0}];
  [v3 validateClass:@"STUsageItem" hasInstanceMethod:@"totalUsage" withFullSignature:{"@", 0}];
  [v3 validateClass:@"STUsageItem" hasInstanceMethod:@"itemType" withFullSignature:{"Q", 0}];
  [v3 validateClass:@"STUsageReportGraphDataPoint" hasInstanceMethod:@"total" withFullSignature:{"@", 0}];
  [v3 validateClass:@"STUsageReportGraphDataSet" hasInstanceMethod:@"itemType" withFullSignature:{"Q", 0}];
  [v3 validateClass:@"STUsageReportGraphDataSet" hasInstanceMethod:@"total" withFullSignature:{"@", 0}];
