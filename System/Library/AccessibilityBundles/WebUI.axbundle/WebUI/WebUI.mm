id accessibilityMobileSafariLocalizedString(void *a1)
{
  ...
  v8 = [v2 localizedStringForKey:v1 value:&stru_2A23BACA0 table:@"Accessibility"];
...
id accessibilitySafariServicesLocalizedString(void *a1)
{
  ...
  v8 = [v2 localizedStringForKey:v1 value:&stru_2A23BACA0 table:@"SafariServicesAccessibility"];
...
id accessibilitySafariScribbleLocalizedString(void *a1)
{
  ...
  v8 = [v2 localizedStringForKey:v1 value:&stru_2A23BACA0 table:@"SafariScribbleAccessibility"];
