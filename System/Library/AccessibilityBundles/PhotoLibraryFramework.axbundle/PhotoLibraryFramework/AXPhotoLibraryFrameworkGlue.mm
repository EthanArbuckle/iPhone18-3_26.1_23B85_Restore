...
+ (void)accessibilityInitializeBundle
{
  if (!_Failover)
  {
    ...
    [mEMORY[0x29EDBD6E8] performValidations:&__block_literal_global withPreValidationHandler:&__block_literal_global_611 postValidationHandler:0 safeCategoryInstallationHandler:&__block_literal_global_620];
    ...
    [mEMORY[0x29EDBD690] addHandler:&__block_literal_global_682 forFramework:@"MessageUI"];
  }
}
