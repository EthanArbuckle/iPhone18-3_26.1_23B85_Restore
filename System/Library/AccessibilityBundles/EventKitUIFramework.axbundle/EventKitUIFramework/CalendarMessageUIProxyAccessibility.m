...
{
  v3 = a3;
  [v3 validateClass:@"CalendarMessageUIProxy" hasClassMethod:@"CalendarComposeRecipientClass" withFullSignature:{"#", 0}];
  [v3 validateClass:@"CalendarMessageUIProxy" hasClassMethod:@"MailComposeRecipientClass" withFullSignature:{"#", 0}];
  [v3 validateClass:@"CalendarMessageUIProxy" hasClassMethod:@"ComposeRecipientViewClass" withFullSignature:{"#", 0}];
  [v3 validateClass:@"CalendarMessageUIProxy" hasClassMethod:@"RecipientTableViewCellClass" withFullSignature:{"#", 0}];
  [v3 validateClass:@"CalendarMessageUIProxy" hasClassMethod:@"SearchShadowViewClass" withFullSignature:{"#", 0}];
  [v3 validateClass:@"CalendarMessageUIProxy" hasClassMethod:@"MFContactsSearchManagerClass" withFullSignature:{"#", 0}];
  [v3 validateClass:@"CalendarMessageUIProxy" hasClassMethod:@"MFContactsSearchResultsModelClass" withFullSignature:{"#", 0}];
}
