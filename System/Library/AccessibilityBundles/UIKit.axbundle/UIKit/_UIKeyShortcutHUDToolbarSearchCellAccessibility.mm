...
- (void)_accessibilityLoadAccessibilityInformation
{
  ...
  v2 = [(_UIKeyShortcutHUDToolbarSearchCellAccessibility *)v5 _accessibilityDescendantOfType:objc_opt_class()];
...
- (BOOL)isAccessibilityElement
{
  ...
  v3 = [v5[0] _accessibilityViewController];
  v4 = [v3 safeBoolForKey:@"isSearching"] ^ 1;
