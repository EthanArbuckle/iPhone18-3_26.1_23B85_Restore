...
- (id)accessibilityLabel
{
  ...
  *&v2 = MEMORY[0x29EDC9740](v16).n128_u64[0];
  if (!v16 || ((location[0] = [(_UIStatusBarCellularSignalViewAcessibility *)selfCopy _accessibilityValueForKey:@"AXStatusBarSignalViewServiceKey", v2]) == 0 ? (v18 = 0) : (v21 = MEMORY[0x29EDC9748](location[0]), v18 = 1), objc_storeStrong(location, 0), !v18))
  {
    ...
    *&v3 = MEMORY[0x29EDC9740](v15).n128_u64[0];
    if (([(_UIStatusBarCellularSignalViewAcessibility *)selfCopy _accessibilityBoolValueForKey:@"PrimaryCellular", v3]& 1) != 0)
    {
    ...
    else if (([(_UIStatusBarCellularSignalViewAcessibility *)selfCopy _accessibilityBoolValueForKey:@"SecondaryCellular"]& 1) != 0)
    {
