...
- (id)accessibilityLabel
{
  ...
  v7 = [(_UIInterfaceActionSystemRepresentationViewAccessibility *)v10 safeValueForKey:@"_labelsView", MEMORY[0x29EDC9740](v6).n128_f64[0]];
  ...
  v4 = [v9[0] accessibilityLabel];
  v3 = [location accessibilityLabel];
