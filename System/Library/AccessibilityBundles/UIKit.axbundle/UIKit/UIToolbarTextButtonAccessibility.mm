...
- (id)accessibilityLabel
{
  ...
  selfCopy = self;
  v20[1] = a2;
  accessibilityUserDefinedLabel = [(UIToolbarTextButtonAccessibility *)self accessibilityUserDefinedLabel];
  *&v2 = MEMORY[0x29EDC9740](accessibilityUserDefinedLabel).n128_u64[0];
  if (accessibilityUserDefinedLabel)
  {
    accessibilityUserDefinedLabel2 = [(UIToolbarTextButtonAccessibility *)selfCopy accessibilityUserDefinedLabel];
  }

  else
  {
    v20[0] = [(UIToolbarTextButtonAccessibility *)selfCopy safeValueForKey:@"_title", v2];
    if (!v20[0])
    {
      v19.receiver = selfCopy;
      v19.super_class = UIToolbarTextButtonAccessibility;
      accessibilityLabel = [(UIToolbarTextButtonAccessibility *)&v19 accessibilityLabel];
      v4 = v20[0];
    ...
    if (!v20[0])
    {
      location = [(UIToolbarTextButtonAccessibility *)selfCopy safeValueForKey:@"subviews"];
  ...
  if (v12)
  {
    ...
    while (1)
    {
      ...
      if ([v25 isAccessibilityElement])
      {
        ...
        v22 = 0;
        objc_opt_class();
        v6 = [(UIToolbarTextButtonAccessibility *)selfCopy safeValueForKey:@"title"];
...
LABEL_23:
  ...
  if (!v17)
  {
    v15 = 0;
    objc_opt_class();
    v4 = [(UIToolbarTextButtonAccessibility *)selfCopy safeValueForKey:@"_title"];
