...
BOOL __75__CALayerAccessibility__UIKit__QuartzCore__accessibilityHitTest_withEvent___block_invoke(uint64_t a1)
{
  ...
  v16 = a1;
  v15 = a1;
  v18 = &MACancelDownloadErrorDomain_block_invoke_onceToken;
  location = 0;
  objc_storeStrong(&location, &__block_literal_global_462);
  if (*v18 != -1)
  {
  ...
  return Implementation != MACancelDownloadErrorDomain_block_invoke_BaseImplementation;
}
...
void __75__CALayerAccessibility__UIKit__QuartzCore__accessibilityHitTest_withEvent___block_invoke_2(uint64_t a1)
{
  ...
  if (InstanceMethod)
  {
    MACancelDownloadErrorDomain_block_invoke_BaseImplementation = method_getImplementation(InstanceMethod);
  }
