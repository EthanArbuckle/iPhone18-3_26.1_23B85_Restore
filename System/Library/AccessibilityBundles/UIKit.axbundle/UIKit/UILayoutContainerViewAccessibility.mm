...
- (void)_accessibilityLoadAccessibilityInformation
{
  ...
  v8 = [(UILayoutContainerViewAccessibility *)selfCopy safeValueForKey:@"delegate"];
  objc_opt_class();
  if (objc_opt_isKindOfClass())
  {
    view = [v8 view];
    [view _accessibilitySetIsSortPriorityContainer:1];
    v7 = 0;
    if (([v8 safeBoolForKey:{@"isNavigationBarHidden", MEMORY[0x29EDC9740](view).n128_f64[0]}] & 1) == 0)
    {
...
- (int64_t)_accessibilityCompareElement:(id)element toElement:(id)toElement
{
  ...
  v18 = 0;
  objc_storeStrong(&v18, toElement);
  v17 = [MEMORY[0x29EDC7DA8] viewControllerForView:selfCopy];
  objc_opt_class();
...
- (void)layoutSubviews
{
  ...
  [(UILayoutContainerViewAccessibility *)selfCopy _accessibilityLoadAccessibilityInformation];
}
