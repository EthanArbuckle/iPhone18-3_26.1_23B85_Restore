...
{
  v3 = a3;
  [v3 validateClass:@"Arcade.PosterLockupCollectionViewCell" hasInstanceMethod:@"accessibilityFallbackTitle" withFullSignature:{"@", 0}];
  [v3 validateClass:@"Arcade.PosterLockupCollectionViewCell" hasInstanceMethod:@"accessibilityFooterView" withFullSignature:{"@", 0}];
  [v3 validateClass:@"Arcade.PosterLockupCollectionViewCell" hasInstanceMethod:@"accessibilityOfferButton" withFullSignature:{"@", 0}];
}
