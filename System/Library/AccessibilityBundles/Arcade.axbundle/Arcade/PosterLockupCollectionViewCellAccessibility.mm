...
+ (void)_accessibilityPerformValidations:(id)validations
{
  ...
  [validationsCopy validateClass:@"Arcade.PosterLockupCollectionViewCell" hasInstanceMethod:@"accessibilityFallbackTitle" withFullSignature:{"@", 0}];
  [validationsCopy validateClass:@"Arcade.PosterLockupCollectionViewCell" hasInstanceMethod:@"accessibilityFooterView" withFullSignature:{"@", 0}];
  [validationsCopy validateClass:@"Arcade.PosterLockupCollectionViewCell" hasInstanceMethod:@"accessibilityOfferButton" withFullSignature:{"@", 0}];
}
