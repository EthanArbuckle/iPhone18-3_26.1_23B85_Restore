...
+ (void)_accessibilityPerformValidations:(id)validations
{
  ...
  [validationsCopy validateClass:@"Arcade.CondensedEditorialSearchResultContentView" hasInstanceMethod:@"accessibilityHeaderLabel" withFullSignature:{"@", 0}];
  [validationsCopy validateClass:@"Arcade.CondensedEditorialSearchResultContentView" hasInstanceMethod:@"accessibilityTitleLabel" withFullSignature:{"@", 0}];
  [validationsCopy validateClass:@"Arcade.CondensedEditorialSearchResultContentView" hasSwiftField:@"viewButton" withSwiftType:"UIButton"];
}
