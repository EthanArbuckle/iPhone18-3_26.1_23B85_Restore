...
+ (void)_accessibilityPerformValidations:(id)validations
{
  ...
  [validationsCopy validateClass:@"Arcade.AnnotationCollectionViewCell" hasInstanceMethod:@"accessibilityTitleLabel" withFullSignature:{"@", 0}];
  [validationsCopy validateClass:@"Arcade.AnnotationCollectionViewCell" hasInstanceMethod:@"accessibilitySummaryLabel" withFullSignature:{"@", 0}];
  [validationsCopy validateClass:@"Arcade.AnnotationCollectionViewCell" hasInstanceMethod:@"accessibilityDetailItems" withFullSignature:{"@", 0}];
}
