...
+ (void)_accessibilityPerformValidations:(id)validations
{
  ...
  [validationsCopy validateClass:@"Arcade.ActivityViewController"];
  [validationsCopy validateClass:@"Arcade.ActivityViewController" isKindOfClass:@"UIViewController"];
  [validationsCopy validateClass:@"Arcade.AppDelegate" hasSwiftField:@"tabBarController" withSwiftType:"Optional<StoreTabBarController>"];
  [validationsCopy validateClass:@"Arcade.StoreTabBarController" isKindOfClass:@"UITabBarController"];
}
