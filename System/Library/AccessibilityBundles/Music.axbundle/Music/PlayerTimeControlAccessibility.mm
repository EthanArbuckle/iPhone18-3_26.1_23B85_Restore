...
{
  v3 = a3;
  [v3 validateClass:@"Music.PlayerTimeControl" hasInstanceMethod:@"accessibilityTotalDuration" withFullSignature:{"d", 0}];
  [v3 validateClass:@"Music.PlayerTimeControl" hasInstanceMethod:@"accessibilityElapsedDuration" withFullSignature:{"d", 0}];
  [v3 validateClass:@"Music.PlayerTimeControl" hasInstanceMethod:@"accessibilityUpdateWithElapsedDuration:" withFullSignature:{"v", "d", 0}];
  [v3 validateClass:@"Music.PlayerTimeControl" hasInstanceMethod:@"accessibilityIsLiveContent" withFullSignature:{"B", 0}];
  [v3 validateClass:@"Music.PlayerTimeControl" hasInstanceMethod:@"liveLabel" withFullSignature:{"@", 0}];
}
