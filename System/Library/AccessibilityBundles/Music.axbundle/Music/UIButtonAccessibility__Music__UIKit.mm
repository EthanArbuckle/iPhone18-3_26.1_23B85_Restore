...
- (BOOL)isAccessibilityElement
{
  accessibilityIdentifier = [(UIButtonAccessibility__Music__UIKit *)self accessibilityIdentifier];
  ...
  {
    v12.receiver = self;
    v12.super_class = UIButtonAccessibility__Music__UIKit;
...
- (id)accessibilityLabel
{
  v3 = [(UIButtonAccessibility__Music__UIKit *)self safeValueForKey:@"currentImage"];
...
LABEL_5:
  ...
  v9.receiver = self;
  v9.super_class = UIButtonAccessibility__Music__UIKit;
  accessibilityLabel = [(UIButtonAccessibility__Music__UIKit *)&v9 accessibilityLabel];
LABEL_7:
