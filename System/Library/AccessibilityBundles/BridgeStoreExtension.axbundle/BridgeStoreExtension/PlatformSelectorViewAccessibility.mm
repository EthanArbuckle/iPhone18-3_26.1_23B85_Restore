...
+ (void)_accessibilityPerformValidations:(id)validations
{
  ...
  [validationsCopy validateClass:@"BridgeStoreExtension.PlatformSelectorView" hasSwiftField:@"text" withSwiftType:"Optional<String>"];
  [validationsCopy validateClass:@"BridgeStoreExtension.PlatformSelectorView" hasInstanceMethod:@"accessibilityDescriptionLabel" withFullSignature:{"@", 0}];
  [validationsCopy validateClass:@"BridgeStoreExtension.PlatformSelectorView" hasSwiftField:@"accessoryImageView" withSwiftType:"UIImageView"];
