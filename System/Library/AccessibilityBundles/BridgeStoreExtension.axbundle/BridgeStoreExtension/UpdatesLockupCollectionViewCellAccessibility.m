...
{
  v3 = a3;
  [v3 validateClass:@"BridgeStoreExtension.UpdatesLockupCollectionViewCell" hasInstanceMethod:@"accessibilitytLockupView" withFullSignature:{"@", 0}];
  [v3 validateClass:@"BridgeStoreExtension.UpdatesLockupCollectionViewCell" hasInstanceMethod:@"accessibilityExpandableTextView" withFullSignature:{"@", 0}];
  [v3 validateClass:@"BridgeStoreExtension.UpdatesLockupCollectionViewCell" hasInstanceMethod:@"accessibilityVersionMetadata" withFullSignature:{"@", 0}];
}
