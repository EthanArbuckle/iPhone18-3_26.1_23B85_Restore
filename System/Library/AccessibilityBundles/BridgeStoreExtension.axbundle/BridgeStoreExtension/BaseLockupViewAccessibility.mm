...
+ (void)_accessibilityPerformValidations:(id)a3
{
  ...
  [v3 validateClass:@"BridgeStoreExtension.BaseLockupView" hasInstanceMethod:@"accessibilityHeadingLabel" withFullSignature:{"@", 0}];
  [v3 validateClass:@"BridgeStoreExtension.BaseLockupView" hasInstanceMethod:@"accessibilityTertiaryTitleLabel" withFullSignature:{"@", 0}];
  [v3 validateClass:@"BridgeStoreExtension.BaseLockupView" hasInstanceMethod:@"accessibilityOfferLabel" withFullSignature:{"@", 0}];
  [v3 validateClass:@"BridgeStoreExtension.BaseLockupView" hasInstanceMethod:@"accessibilityOrdinalLabel" withFullSignature:{"@", 0}];
  [v3 validateClass:@"BridgeStoreExtension.BaseLockupView" hasInstanceMethod:@"accessibilityTitleLabel" withFullSignature:{"@", 0}];
  [v3 validateClass:@"BridgeStoreExtension.BaseLockupView" hasInstanceMethod:@"accessibilitySubtitleLabel" withFullSignature:{"@", 0}];
  [v3 validateClass:@"BridgeStoreExtension.BaseLockupView" hasInstanceMethod:@"accessibilityOfferButton" withFullSignature:{"@", 0}];
}
