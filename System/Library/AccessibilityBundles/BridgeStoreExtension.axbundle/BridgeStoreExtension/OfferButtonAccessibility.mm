...
+ (void)_accessibilityPerformValidations:(id)validations
{
  ...
  [validationsCopy validateClass:@"BridgeStoreExtension.OfferButton" hasInstanceMethod:@"accessibilityShowRedownload" withFullSignature:{"v", 0}];
  [validationsCopy validateClass:@"BridgeStoreExtension.OfferButton" hasInstanceMethod:@"accessibilityShowLoading" withFullSignature:{"v", 0}];
  [validationsCopy validateClass:@"BridgeStoreExtension.OfferButton" hasInstanceMethod:@"accessibilityShowProgress:" withFullSignature:{"v", "d", 0}];
  [validationsCopy validateClass:@"BridgeStoreExtension.OfferButton" hasInstanceMethod:@"accessibilityShowText:" withFullSignature:{"v", "@", 0}];
  [validationsCopy validateClass:@"BridgeStoreExtension.OfferButton" hasInstanceMethod:@"layoutSubviews" withFullSignature:{"v", 0}];
  [validationsCopy validateClass:@"BridgeStoreExtension.OfferButton" hasInstanceMethod:@"initWithFrame:" withFullSignature:{"@", "{CGRect={CGPoint=dd}{CGSize=dd}}", 0}];
  [validationsCopy validateClass:@"BridgeStoreExtension.OfferButton" isKindOfClass:@"UIControl"];
  [validationsCopy validateClass:@"BridgeStoreExtension.OfferButton" hasInstanceMethod:@"accessibilityShowPaused" withFullSignature:{"v", 0}];
  [validationsCopy validateClass:@"BridgeStoreExtension.OfferButton" hasInstanceMethod:@"accessibilityOfferLabel" withFullSignature:{"@", 0}];
  [validationsCopy validateClass:@"BridgeStoreExtension.OfferButton" hasSwiftField:@"label" withSwiftType:"DynamicTypeLabel"];
  [validationsCopy validateClass:@"BridgeStoreExtension.OfferButton" hasSwiftField:@"subtitleLabel" withSwiftType:"DynamicTypeLabel"];
}
