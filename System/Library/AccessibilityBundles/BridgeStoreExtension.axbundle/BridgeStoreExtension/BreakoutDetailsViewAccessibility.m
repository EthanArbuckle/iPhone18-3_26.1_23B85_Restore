...
{
  v3 = a3;
  [v3 validateClass:@"BridgeStoreExtension.BreakoutDetailsView" hasInstanceMethod:@"accessibilityBadgeLabel" withFullSignature:{"@", 0}];
  [v3 validateClass:@"BridgeStoreExtension.BreakoutDetailsView" hasInstanceMethod:@"accessibilityTitleLabel" withFullSignature:{"@", 0}];
  [v3 validateClass:@"BridgeStoreExtension.BreakoutDetailsView" hasInstanceMethod:@"accessibilityDescriptionLabel" withFullSignature:{"@", 0}];
  [v3 validateClass:@"BridgeStoreExtension.BreakoutDetailsView" hasInstanceMethod:@"accessibilityCallToActionButton" withFullSignature:{"@", 0}];
}
