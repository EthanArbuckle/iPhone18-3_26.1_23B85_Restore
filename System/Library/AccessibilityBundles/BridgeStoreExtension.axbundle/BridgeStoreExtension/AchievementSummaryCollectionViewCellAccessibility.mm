...
+ (void)_accessibilityPerformValidations:(id)validations
{
  ...
  [validationsCopy validateClass:@"BridgeStoreExtension.AchievementSummaryCollectionViewCell" hasSwiftField:@"achievementGroupView" withSwiftType:"Optional<AchievementGroupView>"];
  [validationsCopy validateClass:@"BridgeStoreExtension.AchievementSummaryCollectionViewCell" hasSwiftField:@"numberCompletedLabel" withSwiftType:"DynamicTypeLabel"];
  [validationsCopy validateClass:@"BridgeStoreExtension.AchievementSummaryCollectionViewCell" hasSwiftField:@"outOfTotalLabel" withSwiftType:"DynamicTypeLabel"];
...
- (id)accessibilityLabel
{
  ...
  v10 = [accessibilityLabel2 stringByReplacingOccurrencesOfString:@"\u202A/ " withString:&stru_2A212BD08];
