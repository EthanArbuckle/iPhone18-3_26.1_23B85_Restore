...
+ (void)_accessibilityPerformValidations:(id)validations
{
  ...
  [validationsCopy validateClass:@"BridgeStoreExtension.SmallSearchLockupView" hasInstanceMethod:@"accessibilitytUserRatingView" withFullSignature:{"@", 0}];
  [validationsCopy validateClass:@"BridgeStoreExtension.SmallSearchLockupView" hasInstanceMethod:@"accessibilityRatingCountLabel" withFullSignature:{"@", 0}];
  [validationsCopy validateClass:@"BridgeStoreExtension.SmallSearchLockupView" hasInstanceMethod:@"accessibilityIsAd" withFullSignature:{"B", 0}];
  [validationsCopy validateClass:@"BridgeStoreExtension.SmallSearchLockupView" hasInstanceMethod:@"accessibilityAdButton" withFullSignature:{"@", 0}];
  [validationsCopy validateClass:@"BridgeStoreExtension.SmallSearchLockupView" hasInstanceMethod:@"accessibilityDescriptionLabel" withFullSignature:{"@", 0}];
  [validationsCopy validateClass:@"BridgeStoreExtension.SmallSearchLockupView" hasInstanceMethod:@"accessibilitySearchTagsRibbonView" withFullSignature:{"@", 0}];
  [validationsCopy validateClass:@"BridgeStoreExtension.SmallSearchLockupView" isKindOfClass:@"BridgeStoreExtension.BaseLockupView"];
  ...
  [validationsCopy validateClass:@"BridgeStoreExtension.SmallSearchLockupView" hasSwiftField:@"editorsChoiceView" withSwiftType:"Optional<EditorsChoiceView>"];
}
