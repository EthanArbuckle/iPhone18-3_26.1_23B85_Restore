...
{
  v3 = a3;
  [v3 validateClass:@"BridgeStoreExtension.BadgeView" hasInstanceMethod:@"accessibilityValueLabel" withFullSignature:{"@", 0}];
  [v3 validateClass:@"BridgeStoreExtension.BadgeView" hasInstanceMethod:@"accessibilityCaptionLabel" withFullSignature:{"@", 0}];
  [v3 validateClass:@"BridgeStoreExtension.BadgeView" hasInstanceMethod:@"accessibilityHeadingLabel" withFullSignature:{"@", 0}];
  [v3 validateClass:@"BridgeStoreExtension.BadgeView" hasInstanceMethod:@"accessibilityValueView" withFullSignature:{"@", 0}];
