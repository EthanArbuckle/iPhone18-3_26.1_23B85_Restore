...
+ (void)_accessibilityPerformValidations:(id)a3
{
  ...
  [v3 validateClass:@"BridgeStoreExtension.AppDelegate" hasSwiftField:@"tabBarController" withSwiftType:"Optional<StoreTabBarController>"];
  [v3 validateClass:@"BridgeStoreExtension.StoreTabBarController" isKindOfClass:@"UITabBarController"];
}
