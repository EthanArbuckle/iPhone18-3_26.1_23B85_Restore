id AXGameCenterLocString(void *a1)
{
  ...
  {
    v2 = [AXGameCenterLocString_bundle localizedStringForKey:v1 value:&stru_2A21AA0A8 table:@"GameCenter"];
  }
...
id AXGameCenterUIFrameworkLocString(void *a1)
{
  ...
  {
    v2 = [AXGameCenterUIFrameworkLocString_bundle localizedStringForKey:v1 value:&stru_2A21AA0A8 table:@"GameCenterUIFrameworkAccessibility"];
  }
