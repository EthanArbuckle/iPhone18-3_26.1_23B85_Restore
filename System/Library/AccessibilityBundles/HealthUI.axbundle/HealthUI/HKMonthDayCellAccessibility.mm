...
+ (void)_accessibilityPerformValidations:(id)validations
{
  ...
  [validationsCopy validateClass:@"HKMonthDayCell" isKindOfClass:@"HKCalendarDayCell"];
  ...
  [validationsCopy validateClass:@"HKCalendarDayCell" hasInstanceMethod:@"circle" withFullSignature:{"@", 0}];
}
...
- (unint64_t)accessibilityTraits
{
  ...
  accessibilityTraits = [(HKMonthDayCellAccessibility *)&v7 accessibilityTraits];
  objc_opt_class();
