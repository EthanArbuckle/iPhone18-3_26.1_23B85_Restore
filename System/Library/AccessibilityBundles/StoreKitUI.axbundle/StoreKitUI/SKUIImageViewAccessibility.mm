...
- (id)accessibilityLabel
{
  accessibilityIdentifier = [(SKUIImageViewAccessibility *)self accessibilityIdentifier];
  if ([accessibilityIdentifier isEqualToString:@"Badge_CC"])
  {
    v4 = @"video.cc";
LABEL_11:
    accessibilityLabel = accessibilitySKUILocalizedString(v4);
    goto LABEL_12;
  }
  ...
  accessibilityLabel = [(SKUIImageViewAccessibility *)&v8 accessibilityLabel];
LABEL_12:
...
- (id)accessibilityValue
{
  ...
  if ([accessibilityIdentifier isEqualToString:@"Badge_MPAA_G"])
  {
    v4 = @"movie.rating.g";
LABEL_25:
    accessibilityValue = accessibilitySKUILocalizedString(v4);
    goto LABEL_26;
  }
  ...
  v8.receiver = self;
  v8.super_class = SKUIImageViewAccessibility;
  accessibilityValue = [(SKUIImageViewAccessibility *)&v8 accessibilityValue];
LABEL_26:
...
- (BOOL)isAccessibilityElement
{
  ...
  isAccessibilityUserDefinedElement = [(SKUIImageViewAccessibility *)self isAccessibilityUserDefinedElement];
