...
- (id)accessibilityCustomActions
{
  ...
  v3 = [(SKUIVerticalLockupCollectionViewCellAccessibility *)self _accessibilityFindPlayButton];
  v4 = v3;
...
- (id)accessibilityValue
{
  v2 = [(SKUIVerticalLockupCollectionViewCellAccessibility *)self _accessibilityFindPlayButton];
...
- (id)_accessibilityHitTest:(CGPoint)a3 withEvent:(id)a4
{
  ...
  v14 = [(SKUIVerticalLockupCollectionViewCellAccessibility *)&v20 _accessibilityHitTest:v7 withEvent:x, y];
LABEL_14:
