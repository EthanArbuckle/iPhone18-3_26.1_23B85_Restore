...
{
  v3 = a3;
  [v3 validateClass:@"SKUIProductPageHeaderView" hasInstanceMethod:@"title" withFullSignature:{"@", 0}];
  [v3 validateClass:@"SKUIProductPageHeaderView" hasInstanceMethod:@"initWithClientContext:" withFullSignature:{"@", "@", 0}];
  [v3 validateClass:@"SKUIProductPageHeaderView" hasInstanceMethod:@"setUserRating:" withFullSignature:{"v", "d", 0}];
  [v3 validateClass:@"SKUIProductPageHeaderView" hasInstanceMethod:@"setIconImage:" withFullSignature:{"v", "@", 0}];
  [v3 validateClass:@"SKUIProductPageHeaderView" hasInstanceMethod:@"setNumberOfUserRatings:" withFullSignature:{"v", "q", 0}];
  ...
  [v3 validateClass:@"SKUIProductPageHeaderView" hasInstanceMethod:@"inAppPurchasesString" withFullSignature:{"@", 0}];
}
...
- (SKUIProductPageHeaderViewAccessibility)initWithClientContext:(id)a3
{
  ...
  v3 = [(SKUIProductPageHeaderViewAccessibility *)&v7 initWithClientContext:a3];
...
- (id)accessibilityElements
{
  ...
  v4 = [(SKUIProductPageHeaderViewAccessibility *)self _accessibilityValueForKey:*MEMORY[0x29EDC7620]];
  if (!v4)
  {
