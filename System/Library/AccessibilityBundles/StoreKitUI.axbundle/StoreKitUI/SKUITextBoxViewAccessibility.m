...
- (id)accessibilityElements
{
  ...
  v4 = [(SKUITextBoxViewAccessibility *)self _accessibilityValueForKey:*MEMORY[0x29EDC7620]];
  if (!v4)
  {
...
- (id)accessibilityLabel:(id)a3
{
  ...
  else
  {
    ...
    if (!v10)
    {
      ...
      v8 = [(SKUITextBoxViewAccessibility *)&v21 accessibilityLabel];
      goto LABEL_12;
    }
