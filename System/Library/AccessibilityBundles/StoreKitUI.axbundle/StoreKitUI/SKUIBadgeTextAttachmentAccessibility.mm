...
+ (void)_accessibilityPerformValidations:(id)validations
{
  ...
  [validationsCopy validateClass:@"SKUIBadgeTextAttachment" isKindOfClass:@"NSTextAttachment"];
}
...
- (id)accessibilityLabel
{
  v11 = 0;
  objc_opt_class();
  v3 = [(SKUIBadgeTextAttachmentAccessibility *)self safeValueForKey:@"image"];
  ...
  if ([accessibilityIdentifier isEqualToString:@"Badge_CC"])
  {
    v6 = @"video.cc";
LABEL_11:
    accessibilityLabel = accessibilitySKUILocalizedString(v6);
    goto LABEL_12;
  }
  ...
  v10.receiver = self;
  v10.super_class = SKUIBadgeTextAttachmentAccessibility;
  accessibilityLabel = [(SKUIBadgeTextAttachmentAccessibility *)&v10 accessibilityLabel];
LABEL_12:
