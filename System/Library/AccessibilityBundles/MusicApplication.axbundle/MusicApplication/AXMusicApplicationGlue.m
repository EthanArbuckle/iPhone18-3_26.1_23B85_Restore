...
+ (void)accessibilityInitializeBundle
{
  if (!_Failover)
  {
    ...
    [v4 performValidations:&__block_literal_global_13 withPreValidationHandler:&__block_literal_global_360 postValidationHandler:0 safeCategoryInstallationHandler:&__block_literal_global_369];
  }
}
