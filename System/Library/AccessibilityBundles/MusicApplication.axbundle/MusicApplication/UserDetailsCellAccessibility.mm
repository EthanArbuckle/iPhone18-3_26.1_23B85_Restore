...
+ (void)_accessibilityPerformValidations:(id)validations
{
  ...
  [validationsCopy validateClass:@"MusicApplication.UserDetailsCell" hasInstanceMethod:@"title" withFullSignature:{"@", 0}];
  [validationsCopy validateClass:@"MusicApplication.UserDetailsCell" hasInstanceMethod:@"subtitle" withFullSignature:{"@", 0}];
}
