...
+ (void)_accessibilityPerformValidations:(id)validations
{
  ...
  [validationsCopy validateClass:@"MusicApplication.LyricsSelectionViewController" hasInstanceMethod:@"accessibilityCharacterCount" withFullSignature:{"q", 0}];
  [validationsCopy validateClass:@"MusicApplication.LyricsSelectionViewController" hasInstanceMethod:@"accessibilityDidSelectItem" withFullSignature:{"v", 0}];
}
