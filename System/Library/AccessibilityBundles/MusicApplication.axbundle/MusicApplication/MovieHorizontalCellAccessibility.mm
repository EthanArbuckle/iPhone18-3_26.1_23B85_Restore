...
+ (void)_accessibilityPerformValidations:(id)validations
{
  ...
  [validationsCopy validateClass:@"MusicApplication.MovieHorizontalCell" hasInstanceMethod:@"title" withFullSignature:{"@", 0}];
  [validationsCopy validateClass:@"MusicApplication.MovieHorizontalCell" hasInstanceMethod:@"releaseDate" withFullSignature:{"@", 0}];
}
