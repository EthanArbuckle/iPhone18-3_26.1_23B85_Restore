...
- (id)accessibilityLabel
{
  ...
  if (accessibilityLabel)
  {
    ...
    v31 = [v6 stringWithFormat:v7, accessibilityLabel];
  }
  ...
  v14 = [accessibilityLabel3 componentsSeparatedByString:@"-"];
  ...
  accessibilityLabel4 = [v22 accessibilityLabel];
  v24 = [v20 stringWithFormat:v21, accessibilityLabel4];

  if (bOOLValue)
  {
    v29 = accessibilityLocalizedString(@"athlete.injured");
    v26 = accessibilityLabel2;
    v25 = v31;
