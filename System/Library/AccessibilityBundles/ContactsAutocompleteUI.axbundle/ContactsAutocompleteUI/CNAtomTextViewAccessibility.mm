...
- (CNAtomTextViewAccessibility)initWithFrame:(CGRect)frame;
...
+ (void)_accessibilityPerformValidations:(id)validations
{
  ...
  [validationsCopy validateClass:@"CNAtomTextView" hasInstanceMethod:@"clearButton" withFullSignature:{"@", 0}];
  [validationsCopy validateClass:@"CNAtomTextView" isKindOfClass:@"UIView"];
  [validationsCopy validateClass:@"CNAtomTextView" hasInstanceMethod:@"placeholder" withFullSignature:{"@", 0}];
...
- (CNAtomTextViewAccessibility)initWithFrame:(CGRect)frame
{
  ...
  v3 = [(CNAtomTextViewAccessibility *)&v5 initWithFrame:frame.origin.x, frame.origin.y, frame.size.width, frame.size.height];
