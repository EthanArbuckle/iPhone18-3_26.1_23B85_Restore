...
- (void)didStopRecordingOrBroadcast
{
  ...
  {
    *v3 = 0;
    _os_log_impl(&dword_29BB9F000, v2, OS_LOG_TYPE_DEFAULT, "Notifying VO that recording is stopping", v3, 2u);
  }
...
- (void)didStartRecordingOrBroadcast
{
  ...
  {
    *v3 = 0;
    _os_log_impl(&dword_29BB9F000, v2, OS_LOG_TYPE_DEFAULT, "Notifying VO that recording is starting", v3, 2u);
  }
