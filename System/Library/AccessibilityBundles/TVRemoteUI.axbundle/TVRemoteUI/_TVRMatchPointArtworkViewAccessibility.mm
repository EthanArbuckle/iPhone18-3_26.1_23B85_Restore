...
{
  v35.receiver = self;
  v35.super_class = _TVRMatchPointArtworkViewAccessibility;
  [(_TVRMatchPointArtworkViewAccessibility *)&v35 _accessibilityLoadAccessibilityInformation];
  v3 = [(_TVRMatchPointArtworkViewAccessibility *)self safeUIViewForKey:@"_selectIndicator"];
...
{
  v3.receiver = self;
  v3.super_class = _TVRMatchPointArtworkViewAccessibility;
