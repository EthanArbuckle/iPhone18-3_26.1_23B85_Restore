...
- (id)accessibilityLabel
{
  ...
  allTargets = [v3 allTargets];
  anyObject = [allTargets anyObject];
  v6 = [anyObject safeIntegerForKey:@"tag"];

  v11.receiver = self;
  v11.super_class = UIToolbarButtonAccessibility__AnnotationKit__UIKit;
  accessibilityLabel = [(UIToolbarButtonAccessibility__AnnotationKit__UIKit *)&v11 accessibilityLabel];
  v8 = v6 - 764014;
