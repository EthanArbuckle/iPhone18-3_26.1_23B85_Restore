...
+ (void)_accessibilityPerformValidations:(id)validations
{
  ...
  [validationsCopy validateClass:@"CHWorkoutFormattingManager" hasInstanceMethod:@"formattedDurationForWorkout:workoutActivity:context:" withFullSignature:{"@", "@", "@", "@", 0}];
  [validationsCopy validateClass:@"CHWorkoutFormattingManager" hasInstanceMethod:@"_fetchIconForConnectedGymWorkout:context:completion:" withFullSignature:{"v", "@", "@", "@?", 0}];
  [validationsCopy validateClass:@"CHWorkoutFormattingManager" hasInstanceMethod:@"_fetchIconForHiddenAppWorkout:context:completion:" withFullSignature:{"v", "@", "@", "@?", 0}];
  [validationsCopy validateClass:@"CHWorkoutFormattingManager" hasInstanceMethod:@"_fetchIconForFirstPartyWorkout:context:completion:" withFullSignature:{"v", "@", "@", "@?", 0}];
  [validationsCopy validateClass:@"CHWorkoutFormattingManager" hasInstanceMethod:@"_fetchIconForThirdPartyWorkout:context:completion:" withFullSignature:{"v", "@", "@", "@?", 0}];
  [validationsCopy validateClass:@"HKWorkout" hasInstanceMethod:@"shouldUseCircularGradientImage" withFullSignature:{"B", 0}];
  [validationsCopy validateClass:@"HKWorkout" hasInstanceMethod:@"fiui_completionFactor" withFullSignature:{"d", 0}];
}
...
- (id)formattedDurationForWorkout:(id)workout workoutActivity:(id)activity context:(id)context
{
  ...
  v11 = [(CHWorkoutFormattingManagerAccessibility *)&v22 formattedDurationForWorkout:workoutCopy workoutActivity:activityCopy context:contextCopy];
  v21 = 0;
  objc_opt_class();
  v20.receiver = self;
  v20.super_class = CHWorkoutFormattingManagerAccessibility;
  v12 = [(CHWorkoutFormattingManagerAccessibility *)&v20 formattedDurationForWorkout:workoutCopy workoutActivity:activityCopy context:contextCopy];
  ...
  if (v15)
  {
    ...
    string2 = [v13 string];
    v18 = [v16 initWithString:string2];
...
- (void)_fetchIconForConnectedGymWorkout:(id)workout context:(id)context completion:(id)completion
{
  ...
  v8 = completionCopy;
  v9 = workoutCopy;
  [(CHWorkoutFormattingManagerAccessibility *)&v10 _fetchIconForConnectedGymWorkout:v9 context:context completion:v11];
}
...
- (void)_fetchIconForHiddenAppWorkout:(id)workout context:(id)context completion:(id)completion
{
  ...
  v8 = completionCopy;
  [(CHWorkoutFormattingManagerAccessibility *)&v9 _fetchIconForHiddenAppWorkout:workout context:context completion:v10];
}
...
- (void)_fetchIconForFirstPartyWorkout:(id)workout context:(id)context completion:(id)completion
{
  ...
  v8 = completionCopy;
  v9 = workoutCopy;
  [(CHWorkoutFormattingManagerAccessibility *)&v10 _fetchIconForFirstPartyWorkout:v9 context:context completion:v11];
}
...
- (void)_fetchIconForThirdPartyWorkout:(id)workout context:(id)context completion:(id)completion
{
  ...
  v8 = completionCopy;
  v9 = workoutCopy;
  [(CHWorkoutFormattingManagerAccessibility *)&v10 _fetchIconForThirdPartyWorkout:v9 context:context completion:v11];
}
