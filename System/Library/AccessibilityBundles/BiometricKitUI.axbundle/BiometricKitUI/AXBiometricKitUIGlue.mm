...
+ (void)accessibilityInitializeBundle
{
  if (!_Failover)
  {
    ...
    [v4 performValidations:&__block_literal_global withPreValidationHandler:&__block_literal_global_290 postValidationHandler:&__block_literal_global_299 safeCategoryInstallationHandler:&__block_literal_global_302];
  }
}
