...
{
  v3 = a3;
  [v3 validateClass:@"ASMessagesProvider.BadgeView" hasInstanceMethod:@"accessibilityValueLabel" withFullSignature:{"@", 0}];
  [v3 validateClass:@"ASMessagesProvider.BadgeView" hasInstanceMethod:@"accessibilityCaptionLabel" withFullSignature:{"@", 0}];
  [v3 validateClass:@"ASMessagesProvider.BadgeView" hasInstanceMethod:@"accessibilityHeadingLabel" withFullSignature:{"@", 0}];
  [v3 validateClass:@"ASMessagesProvider.BadgeView" hasInstanceMethod:@"accessibilityValueView" withFullSignature:{"@", 0}];
