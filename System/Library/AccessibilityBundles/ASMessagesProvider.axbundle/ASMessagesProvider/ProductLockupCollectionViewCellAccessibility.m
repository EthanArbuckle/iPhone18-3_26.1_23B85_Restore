...
{
  v3 = a3;
  [v3 validateClass:@"ASMessagesProvider.ProductLockupCollectionViewCell" hasInstanceMethod:@"initWithFrame:" withFullSignature:{"@", "{CGRect={CGPoint=dd}{CGSize=dd}}", 0}];
  [v3 validateClass:@"ASMessagesProvider.ProductLockupCollectionViewCell" hasInstanceMethod:@"layoutSubviews" withFullSignature:{"v", 0}];
  [v3 validateClass:@"ASMessagesProvider.ProductLockupCollectionViewCell" hasInstanceMethod:@"accessibilityTitleLabel" withFullSignature:{"@", 0}];
  [v3 validateClass:@"ASMessagesProvider.ProductLockupCollectionViewCell" hasInstanceMethod:@"accessibilityArtworkView" withFullSignature:{"@", 0}];
  [v3 validateClass:@"ASMessagesProvider.ProductLockupCollectionViewCell" hasInstanceMethod:@"accessibilityDeveloperLabel" withFullSignature:{"@", 0}];
  [v3 validateClass:@"ASMessagesProvider.ProductLockupCollectionViewCell" hasInstanceMethod:@"accessibilityTaglineLabel" withFullSignature:{"@", 0}];
  [v3 validateClass:@"ASMessagesProvider.ProductLockupCollectionViewCell" hasInstanceMethod:@"accessibilityOfferButton" withFullSignature:{"@", 0}];
  [v3 validateClass:@"ASMessagesProvider.ProductLockupCollectionViewCell" hasInstanceMethod:@"accessibilityOfferSubtitleLabel" withFullSignature:{"@", 0}];
  [v3 validateClass:@"ASMessagesProvider.ProductLockupCollectionViewCell" hasInstanceMethod:@"accessibilityDownloadProgressLabel" withFullSignature:{"@", 0}];
  ...
  [v3 validateClass:@"ASMessagesProvider.ProductLockupCollectionViewCell" hasInstanceMethod:@"accessibilityVideoView" withFullSignature:{"@", 0}];
  [v3 validateClass:@"ASMessagesProvider.VideoView" hasInstanceMethod:@"accessibilityPlayButton" withFullSignature:{"@", 0}];
  [v3 validateClass:@"ASMessagesProvider.VideoView" hasInstanceMethod:@"accessibilityPlayerViewController" withFullSignature:{"@", 0}];
  [v3 validateClass:@"ASMessagesProvider.VideoView" hasInstanceMethod:@"accessibilityIsPlaying" withFullSignature:{"B", 0}];
  [v3 validateClass:@"ASMessagesProvider.VideoView" hasInstanceMethod:@"accessibilityShouldBePlaying" withFullSignature:{"B", 0}];
}
