...
{
  v3 = a3;
  [v3 validateClass:@"ASMessagesProvider.PlatformSelectorView" hasSwiftField:@"text" withSwiftType:"Optional<String>"];
  [v3 validateClass:@"ASMessagesProvider.PlatformSelectorView" hasInstanceMethod:@"accessibilityDescriptionLabel" withFullSignature:{"@", 0}];
  [v3 validateClass:@"ASMessagesProvider.PlatformSelectorView" hasSwiftField:@"accessoryImageView" withSwiftType:"UIImageView"];
