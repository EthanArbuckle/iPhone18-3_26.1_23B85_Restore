...
{
  v3 = a3;
  [v3 validateClass:@"ASMessagesProvider.PosterLockupCollectionViewCell" hasInstanceMethod:@"accessibilityFallbackTitle" withFullSignature:{"@", 0}];
  [v3 validateClass:@"ASMessagesProvider.PosterLockupCollectionViewCell" hasInstanceMethod:@"accessibilityFooterView" withFullSignature:{"@", 0}];
  [v3 validateClass:@"ASMessagesProvider.PosterLockupCollectionViewCell" hasInstanceMethod:@"accessibilityOfferButton" withFullSignature:{"@", 0}];
}
