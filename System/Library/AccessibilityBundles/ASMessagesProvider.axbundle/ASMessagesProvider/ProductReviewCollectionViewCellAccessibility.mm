...
+ (void)_accessibilityPerformValidations:(id)validations
{
  ...
  [validationsCopy validateClass:@"ASMessagesProvider.ProductReviewCollectionViewCell" hasInstanceMethod:@"accessibilityTitleLabel" withFullSignature:{"@", 0}];
  [validationsCopy validateClass:@"ASMessagesProvider.ProductReviewCollectionViewCell" hasInstanceMethod:@"accessibilityDateLabel" withFullSignature:{"@", 0}];
  [validationsCopy validateClass:@"ASMessagesProvider.ProductReviewCollectionViewCell" hasInstanceMethod:@"accessibilityRatingView" withFullSignature:{"@", 0}];
  [validationsCopy validateClass:@"ASMessagesProvider.ProductReviewCollectionViewCell" hasInstanceMethod:@"accessibilityAuthorLabel" withFullSignature:{"@", 0}];
  [validationsCopy validateClass:@"ASMessagesProvider.ProductReviewCollectionViewCell" hasInstanceMethod:@"accessibilityBodyLabel" withFullSignature:{"@", 0}];
  [validationsCopy validateClass:@"ASMessagesProvider.ProductReviewCollectionViewCell" hasInstanceMethod:@"accessibilityResponseTitleLabel" withFullSignature:{"@", 0}];
  [validationsCopy validateClass:@"ASMessagesProvider.ProductReviewCollectionViewCell" hasInstanceMethod:@"accessibilityResponseDateLabel" withFullSignature:{"@", 0}];
  [validationsCopy validateClass:@"ASMessagesProvider.ProductReviewCollectionViewCell" hasInstanceMethod:@"accessibilityResponseBodyLabel" withFullSignature:{"@", 0}];
}
