...
{
  v3 = a3;
  [v3 validateClass:@"ASMessagesProvider.OfferButton" hasInstanceMethod:@"accessibilityShowRedownload" withFullSignature:{"v", 0}];
  [v3 validateClass:@"ASMessagesProvider.OfferButton" hasInstanceMethod:@"accessibilityShowLoading" withFullSignature:{"v", 0}];
  [v3 validateClass:@"ASMessagesProvider.OfferButton" hasInstanceMethod:@"accessibilityShowProgress:" withFullSignature:{"v", "d", 0}];
  [v3 validateClass:@"ASMessagesProvider.OfferButton" hasInstanceMethod:@"accessibilityShowText:" withFullSignature:{"v", "@", 0}];
  [v3 validateClass:@"ASMessagesProvider.OfferButton" hasInstanceMethod:@"layoutSubviews" withFullSignature:{"v", 0}];
  [v3 validateClass:@"ASMessagesProvider.OfferButton" hasInstanceMethod:@"initWithFrame:" withFullSignature:{"@", "{CGRect={CGPoint=dd}{CGSize=dd}}", 0}];
  [v3 validateClass:@"ASMessagesProvider.OfferButton" isKindOfClass:@"UIControl"];
  [v3 validateClass:@"ASMessagesProvider.OfferButton" hasInstanceMethod:@"accessibilityShowPaused" withFullSignature:{"v", 0}];
  [v3 validateClass:@"ASMessagesProvider.OfferButton" hasInstanceMethod:@"accessibilityOfferLabel" withFullSignature:{"@", 0}];
