...
+ (void)_accessibilityPerformValidations:(id)validations
{
  ...
  [validationsCopy validateClass:@"ASMessagesProvider.OfferButton" hasInstanceMethod:@"accessibilityShowRedownload" withFullSignature:{"v", 0}];
  [validationsCopy validateClass:@"ASMessagesProvider.OfferButton" hasInstanceMethod:@"accessibilityShowLoading" withFullSignature:{"v", 0}];
  [validationsCopy validateClass:@"ASMessagesProvider.OfferButton" hasInstanceMethod:@"accessibilityShowProgress:" withFullSignature:{"v", "d", 0}];
  [validationsCopy validateClass:@"ASMessagesProvider.OfferButton" hasInstanceMethod:@"accessibilityShowText:" withFullSignature:{"v", "@", 0}];
  [validationsCopy validateClass:@"ASMessagesProvider.OfferButton" hasInstanceMethod:@"layoutSubviews" withFullSignature:{"v", 0}];
  [validationsCopy validateClass:@"ASMessagesProvider.OfferButton" hasInstanceMethod:@"initWithFrame:" withFullSignature:{"@", "{CGRect={CGPoint=dd}{CGSize=dd}}", 0}];
  [validationsCopy validateClass:@"ASMessagesProvider.OfferButton" isKindOfClass:@"UIControl"];
  [validationsCopy validateClass:@"ASMessagesProvider.OfferButton" hasInstanceMethod:@"accessibilityShowPaused" withFullSignature:{"v", 0}];
  [validationsCopy validateClass:@"ASMessagesProvider.OfferButton" hasInstanceMethod:@"accessibilityOfferLabel" withFullSignature:{"@", 0}];
  [validationsCopy validateClass:@"ASMessagesProvider.OfferButton" hasSwiftField:@"label" withSwiftType:"DynamicTypeLabel"];
  [validationsCopy validateClass:@"ASMessagesProvider.OfferButton" hasSwiftField:@"subtitleLabel" withSwiftType:"DynamicTypeLabel"];
}
