...
{
  v3 = a3;
  [v3 validateClass:@"ASMessagesProvider.UpdatesLockupCollectionViewCell" hasInstanceMethod:@"accessibilitytLockupView" withFullSignature:{"@", 0}];
  [v3 validateClass:@"ASMessagesProvider.UpdatesLockupCollectionViewCell" hasInstanceMethod:@"accessibilityExpandableTextView" withFullSignature:{"@", 0}];
  [v3 validateClass:@"ASMessagesProvider.UpdatesLockupCollectionViewCell" hasInstanceMethod:@"accessibilityVersionMetadata" withFullSignature:{"@", 0}];
}
