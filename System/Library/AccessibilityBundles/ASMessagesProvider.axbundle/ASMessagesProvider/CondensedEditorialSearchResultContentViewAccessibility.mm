...
{
  v3 = a3;
  [v3 validateClass:@"ASMessagesProvider.CondensedEditorialSearchResultContentView" hasInstanceMethod:@"accessibilityHeaderLabel" withFullSignature:{"@", 0}];
  [v3 validateClass:@"ASMessagesProvider.CondensedEditorialSearchResultContentView" hasInstanceMethod:@"accessibilityTitleLabel" withFullSignature:{"@", 0}];
  [v3 validateClass:@"ASMessagesProvider.CondensedEditorialSearchResultContentView" hasSwiftField:@"viewButton" withSwiftType:"UIButton"];
}
