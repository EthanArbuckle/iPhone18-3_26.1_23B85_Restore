...
+ (void)_accessibilityPerformValidations:(id)validations
{
  ...
  [validationsCopy validateClass:@"ASMessagesProvider.AnnotationCollectionViewCell" hasInstanceMethod:@"accessibilityTitleLabel" withFullSignature:{"@", 0}];
  [validationsCopy validateClass:@"ASMessagesProvider.AnnotationCollectionViewCell" hasInstanceMethod:@"accessibilitySummaryLabel" withFullSignature:{"@", 0}];
  [validationsCopy validateClass:@"ASMessagesProvider.AnnotationCollectionViewCell" hasInstanceMethod:@"accessibilityDetailItems" withFullSignature:{"@", 0}];
  [validationsCopy validateClass:@"ASMessagesProvider.AnnotationCollectionViewCell" hasInstanceMethod:@"accessibilityCellIsExpanded" withFullSignature:{"B", 0}];
  [validationsCopy validateClass:@"ASMessagesProvider.AnnotationCollectionViewCell" hasInstanceMethod:@"accessibilityLinkLabel" withFullSignature:{"@", 0}];
  [validationsCopy validateClass:@"ASMessagesProvider.AnnotationCollectionViewCell" hasInstanceMethod:@"accessibilityLinkLabelTapped" withFullSignature:{"v", 0}];
  [validationsCopy validateClass:@"ASMessagesProvider.AnnotationCollectionViewCell" hasInstanceMethod:@"accessibilityIsSummaryExpandable" withFullSignature:{"B", 0}];
}
