...
+ (void)_accessibilityPerformValidations:(id)a3
{
  ...
  [v3 validateClass:@"ASMessagesProvider.AppDelegate" hasSwiftField:@"tabBarController" withSwiftType:"Optional<StoreTabBarController>"];
  [v3 validateClass:@"ASMessagesProvider.StoreTabBarController" isKindOfClass:@"UITabBarController"];
}
