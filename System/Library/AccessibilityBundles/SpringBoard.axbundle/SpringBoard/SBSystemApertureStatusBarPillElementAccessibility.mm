...
- (SBSystemApertureStatusBarPillElementAccessibility)initWithStatusBarStyleOverrides:(unint64_t)overrides;
@end
...
+ (void)_accessibilityPerformValidations:(id)validations
{
  ...
  [validationsCopy validateClass:@"SBSystemApertureStatusBarPillElement" hasInstanceMethod:@"leadingView" withFullSignature:{"@", 0}];
  [validationsCopy validateClass:@"SBSystemApertureStatusBarPillElement" hasInstanceMethod:@"minimalView" withFullSignature:{"@", 0}];
}
