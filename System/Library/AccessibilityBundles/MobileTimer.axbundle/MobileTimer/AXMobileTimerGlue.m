...
+ (void)accessibilityInitializeBundle
{
  if (!_Failover)
  {
    ...
    [v2 performValidations:&__block_literal_global withPreValidationHandler:&__block_literal_global_453 postValidationHandler:0 safeCategoryInstallationHandler:&__block_literal_global_462];
    ...
    [v5 addHandler:&__block_literal_global_572 forFramework:@"Weather"];
  }
}
