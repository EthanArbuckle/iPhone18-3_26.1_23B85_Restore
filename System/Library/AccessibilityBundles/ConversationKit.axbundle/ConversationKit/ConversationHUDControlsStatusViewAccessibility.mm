...
{
  v3 = a3;
  [v3 validateClass:@"ConversationKit.ConversationHUDControlsStatusView" hasInstanceMethod:@"conversationDetailsView" withFullSignature:{"@", 0}];
  [v3 validateClass:@"ConversationKit.ConversationDetailsView" hasInstanceMethod:@"conversationTitleLabel" withFullSignature:{"@", 0}];
  [v3 validateClass:@"ConversationKit.ConversationDetailsView" hasInstanceMethod:@"conversationSubtitleLabel" withFullSignature:{"@", 0}];
  [v3 validateClass:@"ConversationKit.ConversationHUDControlsStatusView" hasInstanceMethod:@"setupRootView" withFullSignature:{"v", 0}];
}
...
- (void)_accessibilitySetupVStack
{
  v3 = [(ConversationHUDControlsStatusViewAccessibility *)self _accessibilityConversationDetailsView];
  v4 = [v3 accessibilityTraits];
  v5 = *MEMORY[0x29EDC7F70];
  v6 = accessibilityLocalizedString(@"show.call.details.hint");
  [v3 setAccessibilityHint:v6];

  [v3 setAccessibilityTraits:v5 | v4];
  ...
  [v3 setIsAccessibilityElement:{1, v7, v8, v9, v10}];
