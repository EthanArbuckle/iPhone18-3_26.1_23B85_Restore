...
+ (void)_accessibilityPerformValidations:(id)a3
{
  ...
  [v3 validateClass:@"SFCapsuleCollectionView" hasInstanceMethod:@"delegate" withFullSignature:{"@", 0}];
  if (AXProcessIsSafari())
  {
    [v3 validateClass:@"CapsuleNavigationBarViewController"];
    [v3 validateClass:@"CapsuleNavigationBarViewController" hasInstanceMethod:@"delegate" withFullSignature:{"@", 0}];
    ...
    [v3 validateClass:@"BrowserController" hasInstanceMethod:@"showTabView" withFullSignature:{"v", 0}];
    [v3 validateClass:@"BrowserController" hasInstanceMethod:@"nextTabKeyPressed:" withFullSignature:{"v", "@", 0}];
    [v3 validateClass:@"BrowserController" hasInstanceMethod:@"previousTabKeyPressed:" withFullSignature:{"v", "@", 0}];
    [v3 validateClass:@"BrowserController" hasInstanceMethod:@"navigationBarReaderButtonWasTapped:" withFullSignature:{"v", "@", 0}];
    [v3 validateClass:@"SFCapsuleNavigationBar" hasInstanceMethod:@"setTrailingButtons:" withFullSignature:{"v", "@", 0}];
    [v3 validateClass:@"BrowserController" hasInstanceVariable:@"_tabController" withType:"TabController"];
    [v3 validateClass:@"BrowserController" hasInstanceMethod:@"canReadThis" withFullSignature:{"B", 0}];
    [v3 validateClass:@"BrowserController" hasInstanceMethod:@"isReaderAvailable" withFullSignature:{"B", 0}];
    [v3 validateClass:@"TabController" hasInstanceMethod:@"currentTabs" withFullSignature:{"@", 0}];
    [v3 validateClass:@"TabController" hasInstanceMethod:@"indexOfSelectedTab" withFullSignature:{"Q", 0}];
    [v3 validateClass:@"TabController" hasInstanceMethod:@"tabDocumentBeingActivated" withFullSignature:{"@", 0}];
    [v3 validateClass:@"TabDocument" hasInstanceMethod:@"suggestedTitleForCurrentURL" withFullSignature:{"@", 0}];
...
- (id)accessibilityElements
{
  ...
  {
    v4 = [(SFCapsuleNavigationBarAccessibility *)self _accessibilitySortedElementsWithin];
  }
