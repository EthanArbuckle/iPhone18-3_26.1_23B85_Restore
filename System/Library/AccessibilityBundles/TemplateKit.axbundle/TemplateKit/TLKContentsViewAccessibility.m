...
{
  v3 = a3;
  [v3 validateClass:@"TLKContentsView" hasInstanceMethod:@"titleLabel" withFullSignature:{"@", 0}];
  [v3 validateClass:@"TLKContentsView" hasInstanceMethod:@"detailsLabels" withFullSignature:{"@", 0}];
}
