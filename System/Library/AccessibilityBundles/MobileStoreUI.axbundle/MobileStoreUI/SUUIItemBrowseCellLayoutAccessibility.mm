...
+ (void)_accessibilityPerformValidations:(id)validations
{
  ...
  [validationsCopy validateClass:@"SUUIItemBrowseCellLayout" hasInstanceVariable:@"_cellContentView" withType:"_SUUIItemBrowseCellContentView"];
  [validationsCopy validateClass:@"_SUUIItemBrowseCellContentView" hasInstanceMethod:@"userRatingImageView" withFullSignature:{"@", 0}];
  [validationsCopy validateClass:@"_SUUIItemBrowseCellContentView" hasInstanceMethod:@"userRatingLabel" withFullSignature:{"@", 0}];
  [validationsCopy validateClass:@"_SUUIItemBrowseCellContentView" hasInstanceMethod:@"titleLabel" withFullSignature:{"@", 0}];
  [validationsCopy validateClass:@"_SUUIItemBrowseCellContentView" hasInstanceMethod:@"subtitleLabel" withFullSignature:{"@", 0}];
}
