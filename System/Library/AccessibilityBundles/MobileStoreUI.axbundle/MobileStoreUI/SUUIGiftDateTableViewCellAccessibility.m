...
{
  v3 = a3;
  [v3 validateClass:@"SUUIGiftDateTableViewCell" hasInstanceMethod:@"label" withFullSignature:{"@", 0}];
  [v3 validateClass:@"SUUIGiftDateTableViewCell" hasInstanceMethod:@"date" withFullSignature:{"@", 0}];
...
- (id)_accessibilitySupplementaryFooterViews
{
  ...
  else
  {
    ...
    v4 = [(SUUIGiftDateTableViewCellAccessibility *)&v8 _accessibilitySupplementaryFooterViews];
  }
