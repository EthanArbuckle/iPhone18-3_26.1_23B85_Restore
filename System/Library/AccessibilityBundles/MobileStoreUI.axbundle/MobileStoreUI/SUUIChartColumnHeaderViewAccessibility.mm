...
- (void)_accessibilityLoadAccessibilityInformation
{
  ...
  v15.receiver = self;
  v15.super_class = SUUIChartColumnHeaderViewAccessibility;
  [(SUUIChartColumnHeaderViewAccessibility *)&v15 _accessibilityLoadAccessibilityInformation];
  v13 = 0u;
  v14 = 0u;
  v11 = 0u;
  v12 = 0u;
  v3 = [(SUUIChartColumnHeaderViewAccessibility *)self safeValueForKey:@"_buttons", 0];
...
{
  v3.receiver = self;
  v3.super_class = SUUIChartColumnHeaderViewAccessibility;
