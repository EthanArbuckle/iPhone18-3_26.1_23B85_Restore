...
{
  v3 = a3;
  [v3 validateClass:@"SUUIIndexBarControl" hasInstanceMethod:@"_visibleBounds" withFullSignature:{"{CGRect={CGPoint=dd}{CGSize=dd}}", 0}];
  ...
  [v3 validateClass:@"SUUIIndexBarControl" hasInstanceMethod:@"_entryAtIndexPath:" withFullSignature:{"@", 0}];
...
- (BOOL)_accessibilityMoveToIndexPath:(id)a3
{
  ...
  if (objc_opt_isKindOfClass())
  {
    v16 = @"recently.added";
LABEL_13:
    v15 = accessibilityLocalizedString(v16);
LABEL_14:
