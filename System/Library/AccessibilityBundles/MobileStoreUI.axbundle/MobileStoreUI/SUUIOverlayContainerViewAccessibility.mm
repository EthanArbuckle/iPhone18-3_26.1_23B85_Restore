...
- (id)accessibilityElements
{
  ...
  subviews = [(SUUIOverlayContainerViewAccessibility *)self subviews];
...
- (id)_accessibilityObscuredScreenAllowedViews
{
  ...
  accessibilityIdentifier = [(SUUIOverlayContainerViewAccessibility *)self accessibilityIdentifier];
  ...
  array = [(SUUIOverlayContainerViewAccessibility *)&v19 _accessibilityObscuredScreenAllowedViews];
LABEL_15:
