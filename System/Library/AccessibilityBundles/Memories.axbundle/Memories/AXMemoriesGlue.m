...
+ (void)accessibilityInitializeBundle
{
  ...
  [v2 performValidations:&__block_literal_global withPreValidationHandler:&__block_literal_global_471 postValidationHandler:0 safeCategoryInstallationHandler:&__block_literal_global_480];
}
