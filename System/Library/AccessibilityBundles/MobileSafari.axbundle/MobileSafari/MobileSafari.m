id accessibilityLocalizedString(void *a1)
{
  ...
  if (accessibilityLocalizedString_axBundle || ([MEMORY[0x29EDB9F48] bundleWithIdentifier:@"com.apple.MobileSafari.axbundle"], v3 = objc_claimAutoreleasedReturnValue(), v4 = accessibilityLocalizedString_axBundle, accessibilityLocalizedString_axBundle = v3, v4, (v2 = accessibilityLocalizedString_axBundle) != 0))
  {
    v5 = [v2 localizedStringForKey:v1 value:&stru_2A2220208 table:@"Accessibility"];
  }
...
id accessibilityMobileSafariLocalizedString(void *a1)
{
  ...
  v8 = [v2 localizedStringForKey:v1 value:&stru_2A2220208 table:@"Accessibility"];
...
id accessibilitySafariServicesLocalizedString(void *a1)
{
  ...
  v8 = [v2 localizedStringForKey:v1 value:&stru_2A2220208 table:@"SafariServicesAccessibility"];
...
id accessibilitySafariScribbleLocalizedString(void *a1)
{
  ...
  v8 = [v2 localizedStringForKey:v1 value:&stru_2A2220208 table:@"SafariScribbleAccessibility"];
