...
+ (void)_accessibilityPerformValidations:(id)validations
{
  ...
  [validationsCopy validateClass:@"AppInstallExtension.SmallSearchLockupView" hasInstanceMethod:@"accessibilitytUserRatingView" withFullSignature:{"@", 0}];
  [validationsCopy validateClass:@"AppInstallExtension.SmallSearchLockupView" hasInstanceMethod:@"accessibilityRatingCountLabel" withFullSignature:{"@", 0}];
  [validationsCopy validateClass:@"AppInstallExtension.SmallSearchLockupView" hasInstanceMethod:@"accessibilityIsAd" withFullSignature:{"B", 0}];
  [validationsCopy validateClass:@"AppInstallExtension.SmallSearchLockupView" hasInstanceMethod:@"accessibilityAdButton" withFullSignature:{"@", 0}];
  [validationsCopy validateClass:@"AppInstallExtension.SmallSearchLockupView" hasInstanceMethod:@"accessibilityDescriptionLabel" withFullSignature:{"@", 0}];
  [validationsCopy validateClass:@"AppInstallExtension.SmallSearchLockupView" hasInstanceMethod:@"accessibilitySearchTagsRibbonView" withFullSignature:{"@", 0}];
  [validationsCopy validateClass:@"AppInstallExtension.SmallSearchLockupView" isKindOfClass:@"AppInstallExtension.BaseLockupView"];
  [validationsCopy validateClass:@"AppInstallExtension.BaseLockupView" hasInstanceMethod:@"accessibilityTitleLabel" withFullSignature:{"@", 0}];
  [validationsCopy validateClass:@"AppInstallExtension.SmallSearchLockupView" hasSwiftField:@"editorsChoiceView" withSwiftType:"Optional<EditorsChoiceView>"];
}
