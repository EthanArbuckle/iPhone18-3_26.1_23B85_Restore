...
{
  v3 = a3;
  [v3 validateClass:@"AppInstallExtension.ProductReviewCollectionViewCell" hasInstanceMethod:@"accessibilityTitleLabel" withFullSignature:{"@", 0}];
  [v3 validateClass:@"AppInstallExtension.ProductReviewCollectionViewCell" hasInstanceMethod:@"accessibilityDateLabel" withFullSignature:{"@", 0}];
  [v3 validateClass:@"AppInstallExtension.ProductReviewCollectionViewCell" hasInstanceMethod:@"accessibilityRatingView" withFullSignature:{"@", 0}];
  [v3 validateClass:@"AppInstallExtension.ProductReviewCollectionViewCell" hasInstanceMethod:@"accessibilityAuthorLabel" withFullSignature:{"@", 0}];
  [v3 validateClass:@"AppInstallExtension.ProductReviewCollectionViewCell" hasInstanceMethod:@"accessibilityBodyLabel" withFullSignature:{"@", 0}];
  [v3 validateClass:@"AppInstallExtension.ProductReviewCollectionViewCell" hasInstanceMethod:@"accessibilityResponseTitleLabel" withFullSignature:{"@", 0}];
  [v3 validateClass:@"AppInstallExtension.ProductReviewCollectionViewCell" hasInstanceMethod:@"accessibilityResponseDateLabel" withFullSignature:{"@", 0}];
  [v3 validateClass:@"AppInstallExtension.ProductReviewCollectionViewCell" hasInstanceMethod:@"accessibilityResponseBodyLabel" withFullSignature:{"@", 0}];
}
