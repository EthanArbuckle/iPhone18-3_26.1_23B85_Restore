...
- (unint64_t)accessibilityTraits
{
  v2 = [(ArtworkViewAccessibility *)self _accessibilityAncestorIsKindOf:MEMORY[0x29C2C8630](@"AppInstallExtension.CarouselItemLockupCollectionView", a2)];
...
- (id)accessibilityLabel
{
  ...
  {
    v4 = [(ArtworkViewAccessibility *)self _accessibilityAncestorIsKindOf:MEMORY[0x29C2C8630](@"AppInstallExtension.CarouselItemLockupCollectionView")];
