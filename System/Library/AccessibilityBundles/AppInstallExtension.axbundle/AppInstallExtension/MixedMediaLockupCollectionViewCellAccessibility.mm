...
+ (void)_accessibilityPerformValidations:(id)validations
{
  ...
  [validationsCopy validateClass:@"AppInstallExtension.MixedMediaLockupCollectionViewCell" hasInstanceMethod:@"accessibilityLockupView" withFullSignature:{"@", 0}];
  [validationsCopy validateClass:@"AppInstallExtension.MixedMediaLockupCollectionViewCell" hasInstanceMethod:@"accessibilityTaglineLabel" withFullSignature:{"@", 0}];
  [validationsCopy validateClass:@"AppInstallExtension.MixedMediaLockupCollectionViewCell" hasInstanceMethod:@"accessibilityVideoView" withFullSignature:{"@", 0}];
  [validationsCopy validateClass:@"AppInstallExtension.MixedMediaLockupCollectionViewCell" hasInstanceMethod:@"accessibilityMediaView" withFullSignature:{"@", 0}];
}
