...
+ (void)_accessibilityPerformValidations:(id)validations
{
  ...
  [validationsCopy validateClass:@"AppInstallExtension.ShelfHeaderView" hasSwiftField:@"eyebrowButton" withSwiftType:"DynamicTypeButton"];
  [validationsCopy validateClass:@"AppInstallExtension.ShelfHeaderView" hasSwiftField:@"titleButton" withSwiftType:"DynamicTypeButton"];
  [validationsCopy validateClass:@"AppInstallExtension.ShelfHeaderView" hasSwiftField:@"subtitleLabel" withSwiftType:"DynamicTypeLabel"];
  [validationsCopy validateClass:@"AppInstallExtension.ShelfHeaderView" hasSwiftField:@"accessoryButton" withSwiftType:"DynamicTypeButton"];
}
...
- (id)accessibilityLabel
{
  ...
  v9 = [string stringByReplacingOccurrencesOfString:@"\uFFFC" withString:&stru_2A20EDBF0];
