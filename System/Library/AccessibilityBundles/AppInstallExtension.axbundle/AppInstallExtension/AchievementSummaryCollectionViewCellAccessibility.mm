...
+ (void)_accessibilityPerformValidations:(id)validations
{
  ...
  [validationsCopy validateClass:@"AppInstallExtension.AchievementSummaryCollectionViewCell" hasSwiftField:@"achievementGroupView" withSwiftType:"Optional<AchievementGroupView>"];
  [validationsCopy validateClass:@"AppInstallExtension.AchievementSummaryCollectionViewCell" hasSwiftField:@"numberCompletedLabel" withSwiftType:"DynamicTypeLabel"];
  [validationsCopy validateClass:@"AppInstallExtension.AchievementSummaryCollectionViewCell" hasSwiftField:@"outOfTotalLabel" withSwiftType:"DynamicTypeLabel"];
...
- (id)accessibilityLabel
{
  ...
  v10 = [accessibilityLabel2 stringByReplacingOccurrencesOfString:@"\u202A/ " withString:&stru_2A20EDBF0];
