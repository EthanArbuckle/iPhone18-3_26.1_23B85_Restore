...
+ (void)_accessibilityPerformValidations:(id)validations
{
  ...
  [validationsCopy validateClass:@"CKLocationSearchController" isKindOfClass:@"CKSearchController"];
...
- (id)cellForItemInCollectionView:(id)view atIndexPath:(id)path withIdentifier:(id)identifier
{
  ...
  v11 = [(CKLocationSearchControllerAccessibility *)&v26 cellForItemInCollectionView:viewCopy atIndexPath:pathCopy withIdentifier:identifierCopy];
  LOBYTE(v20) = 0;
  objc_opt_class();
