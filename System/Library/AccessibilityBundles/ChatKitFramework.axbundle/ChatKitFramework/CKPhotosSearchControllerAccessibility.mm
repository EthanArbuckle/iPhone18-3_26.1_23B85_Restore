...
- (id)cellForItemInCollectionView:(id)view atIndexPath:(id)path withIdentifier:(id)identifier
{
  ...
  v26.receiver = self;
  v26.super_class = CKPhotosSearchControllerAccessibility;
  v11 = [(CKPhotosSearchControllerAccessibility *)&v26 cellForItemInCollectionView:viewCopy atIndexPath:pathCopy withIdentifier:identifierCopy];
  LOBYTE(v20) = 0;
  objc_opt_class();
  ...
  if (v12)
  {
    ...
    if (v14 < [v13 count])
    {
      ...
      [v12 _axSetContact:{v16, v18, 3221225472, __96__CKPhotosSearchControllerAccessibility_cellForItemInCollectionView_atIndexPath_withIdentifier___block_invoke, &unk_29F2B06F8}];
    }
  }
