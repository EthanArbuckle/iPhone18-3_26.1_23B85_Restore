...
+ (void)_accessibilityPerformValidations:(id)validations
{
  ...
  [validationsCopy validateClass:@"ProductPageExtension.SmallSearchLockupView" hasInstanceMethod:@"accessibilitytUserRatingView" withFullSignature:{"@", 0}];
  [validationsCopy validateClass:@"ProductPageExtension.SmallSearchLockupView" hasInstanceMethod:@"accessibilityRatingCountLabel" withFullSignature:{"@", 0}];
  [validationsCopy validateClass:@"ProductPageExtension.SmallSearchLockupView" hasInstanceMethod:@"accessibilityIsAd" withFullSignature:{"B", 0}];
  [validationsCopy validateClass:@"ProductPageExtension.SmallSearchLockupView" hasInstanceMethod:@"accessibilityAdButton" withFullSignature:{"@", 0}];
  [validationsCopy validateClass:@"ProductPageExtension.SmallSearchLockupView" hasInstanceMethod:@"accessibilityDescriptionLabel" withFullSignature:{"@", 0}];
  [validationsCopy validateClass:@"ProductPageExtension.SmallSearchLockupView" hasInstanceMethod:@"accessibilitySearchTagsRibbonView" withFullSignature:{"@", 0}];
  [validationsCopy validateClass:@"ProductPageExtension.SmallSearchLockupView" isKindOfClass:@"ProductPageExtension.BaseLockupView"];
  [validationsCopy validateClass:@"ProductPageExtension.BaseLockupView" hasInstanceMethod:@"accessibilityTitleLabel" withFullSignature:{"@", 0}];
  [validationsCopy validateClass:@"ProductPageExtension.SmallSearchLockupView" hasSwiftField:@"editorsChoiceView" withSwiftType:"Optional<EditorsChoiceView>"];
}
