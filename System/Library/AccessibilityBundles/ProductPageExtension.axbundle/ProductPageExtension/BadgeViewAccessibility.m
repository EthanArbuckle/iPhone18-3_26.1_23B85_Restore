...
{
  v3 = a3;
  [v3 validateClass:@"ProductPageExtension.BadgeView" hasInstanceMethod:@"accessibilityValueLabel" withFullSignature:{"@", 0}];
  [v3 validateClass:@"ProductPageExtension.BadgeView" hasInstanceMethod:@"accessibilityCaptionLabel" withFullSignature:{"@", 0}];
  [v3 validateClass:@"ProductPageExtension.BadgeView" hasInstanceMethod:@"accessibilityHeadingLabel" withFullSignature:{"@", 0}];
  [v3 validateClass:@"ProductPageExtension.BadgeView" hasInstanceMethod:@"accessibilityValueView" withFullSignature:{"@", 0}];
