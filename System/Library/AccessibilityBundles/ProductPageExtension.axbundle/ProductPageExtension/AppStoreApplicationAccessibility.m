...
+ (void)_accessibilityPerformValidations:(id)a3
{
  ...
  [v3 validateClass:@"ProductPageExtension.AppDelegate" hasSwiftField:@"tabBarController" withSwiftType:"Optional<StoreTabBarController>"];
  [v3 validateClass:@"ProductPageExtension.StoreTabBarController" isKindOfClass:@"UITabBarController"];
}
