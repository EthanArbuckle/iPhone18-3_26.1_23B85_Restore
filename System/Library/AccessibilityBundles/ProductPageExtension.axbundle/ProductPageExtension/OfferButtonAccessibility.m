...
{
  v3 = a3;
  [v3 validateClass:@"ProductPageExtension.OfferButton" hasInstanceMethod:@"accessibilityShowRedownload" withFullSignature:{"v", 0}];
  [v3 validateClass:@"ProductPageExtension.OfferButton" hasInstanceMethod:@"accessibilityShowLoading" withFullSignature:{"v", 0}];
  [v3 validateClass:@"ProductPageExtension.OfferButton" hasInstanceMethod:@"accessibilityShowProgress:" withFullSignature:{"v", "d", 0}];
  [v3 validateClass:@"ProductPageExtension.OfferButton" hasInstanceMethod:@"accessibilityShowText:" withFullSignature:{"v", "@", 0}];
  [v3 validateClass:@"ProductPageExtension.OfferButton" hasInstanceMethod:@"layoutSubviews" withFullSignature:{"v", 0}];
  [v3 validateClass:@"ProductPageExtension.OfferButton" hasInstanceMethod:@"initWithFrame:" withFullSignature:{"@", "{CGRect={CGPoint=dd}{CGSize=dd}}", 0}];
  [v3 validateClass:@"ProductPageExtension.OfferButton" isKindOfClass:@"UIControl"];
  [v3 validateClass:@"ProductPageExtension.OfferButton" hasInstanceMethod:@"accessibilityShowPaused" withFullSignature:{"v", 0}];
  [v3 validateClass:@"ProductPageExtension.OfferButton" hasInstanceMethod:@"accessibilityOfferLabel" withFullSignature:{"@", 0}];
