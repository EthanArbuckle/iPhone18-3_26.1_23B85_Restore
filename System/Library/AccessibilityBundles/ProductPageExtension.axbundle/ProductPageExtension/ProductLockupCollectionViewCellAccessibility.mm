...
{
  v3 = a3;
  [v3 validateClass:@"ProductPageExtension.ProductLockupCollectionViewCell" hasInstanceMethod:@"initWithFrame:" withFullSignature:{"@", "{CGRect={CGPoint=dd}{CGSize=dd}}", 0}];
  [v3 validateClass:@"ProductPageExtension.ProductLockupCollectionViewCell" hasInstanceMethod:@"layoutSubviews" withFullSignature:{"v", 0}];
  [v3 validateClass:@"ProductPageExtension.ProductLockupCollectionViewCell" hasInstanceMethod:@"accessibilityTitleLabel" withFullSignature:{"@", 0}];
  [v3 validateClass:@"ProductPageExtension.ProductLockupCollectionViewCell" hasInstanceMethod:@"accessibilityArtworkView" withFullSignature:{"@", 0}];
  [v3 validateClass:@"ProductPageExtension.ProductLockupCollectionViewCell" hasInstanceMethod:@"accessibilityDeveloperLabel" withFullSignature:{"@", 0}];
  [v3 validateClass:@"ProductPageExtension.ProductLockupCollectionViewCell" hasInstanceMethod:@"accessibilityTaglineLabel" withFullSignature:{"@", 0}];
  [v3 validateClass:@"ProductPageExtension.ProductLockupCollectionViewCell" hasInstanceMethod:@"accessibilityOfferButton" withFullSignature:{"@", 0}];
  [v3 validateClass:@"ProductPageExtension.ProductLockupCollectionViewCell" hasInstanceMethod:@"accessibilityOfferSubtitleLabel" withFullSignature:{"@", 0}];
  [v3 validateClass:@"ProductPageExtension.ProductLockupCollectionViewCell" hasInstanceMethod:@"accessibilityDownloadProgressLabel" withFullSignature:{"@", 0}];
  ...
  [v3 validateClass:@"ProductPageExtension.ProductLockupCollectionViewCell" hasInstanceMethod:@"accessibilityVideoView" withFullSignature:{"@", 0}];
  [v3 validateClass:@"ProductPageExtension.VideoView" hasInstanceMethod:@"accessibilityPlayButton" withFullSignature:{"@", 0}];
  [v3 validateClass:@"ProductPageExtension.VideoView" hasInstanceMethod:@"accessibilityPlayerViewController" withFullSignature:{"@", 0}];
  [v3 validateClass:@"ProductPageExtension.VideoView" hasInstanceMethod:@"accessibilityIsPlaying" withFullSignature:{"B", 0}];
  [v3 validateClass:@"ProductPageExtension.VideoView" hasInstanceMethod:@"accessibilityShouldBePlaying" withFullSignature:{"B", 0}];
}
