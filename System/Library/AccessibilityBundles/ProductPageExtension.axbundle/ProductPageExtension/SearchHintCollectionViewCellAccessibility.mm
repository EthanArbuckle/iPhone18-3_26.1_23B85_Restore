...
+ (void)_accessibilityPerformValidations:(id)validations
{
  ...
  [validationsCopy validateClass:@"ProductPageExtension.SearchHintCollectionViewCell" hasInstanceMethod:@"accessibilityHintView" withFullSignature:{"@", 0}];
...
- (id)accessibilityLabel
{
  ...
  v3 = [v2 _accessibilityDescendantOfType:MEMORY[0x29C2E9430](@"AppStoreKit.DynamicTypeLabel")];
