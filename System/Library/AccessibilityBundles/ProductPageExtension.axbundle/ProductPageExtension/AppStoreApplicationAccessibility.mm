...
+ (void)_accessibilityPerformValidations:(id)validations
{
  ...
  [validationsCopy validateClass:@"ProductPageExtension.ActivityViewController"];
  [validationsCopy validateClass:@"ProductPageExtension.ActivityViewController" isKindOfClass:@"UIViewController"];
  [validationsCopy validateClass:@"ProductPageExtension.AppDelegate" hasSwiftField:@"tabBarController" withSwiftType:"Optional<StoreTabBarController>"];
  [validationsCopy validateClass:@"ProductPageExtension.StoreTabBarController" isKindOfClass:@"UITabBarController"];
}
