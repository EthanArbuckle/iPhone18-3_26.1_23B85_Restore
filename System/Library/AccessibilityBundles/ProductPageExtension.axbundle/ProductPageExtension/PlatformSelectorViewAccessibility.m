...
{
  v3 = a3;
  [v3 validateClass:@"ProductPageExtension.PlatformSelectorView" hasSwiftField:@"text" withSwiftType:"Optional<String>"];
  [v3 validateClass:@"ProductPageExtension.PlatformSelectorView" hasInstanceMethod:@"accessibilityDescriptionLabel" withFullSignature:{"@", 0}];
  [v3 validateClass:@"ProductPageExtension.PlatformSelectorView" hasSwiftField:@"accessoryImageView" withSwiftType:"UIImageView"];
