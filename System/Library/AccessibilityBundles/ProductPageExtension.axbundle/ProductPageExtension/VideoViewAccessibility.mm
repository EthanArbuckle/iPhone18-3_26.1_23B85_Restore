...
+ (void)_accessibilityPerformValidations:(id)validations
{
  ...
  [validationsCopy validateClass:@"ProductPageExtension.ProductLockupCollectionViewCell"];
  [validationsCopy validateClass:@"ProductPageExtension.VideoView" hasInstanceMethod:@"accessibilityUpdatePlayerControllerControls" withFullSignature:{"v", 0}];
}
