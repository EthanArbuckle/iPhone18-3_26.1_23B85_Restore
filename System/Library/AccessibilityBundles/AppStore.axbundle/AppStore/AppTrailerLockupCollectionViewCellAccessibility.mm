...
+ (void)_accessibilityPerformValidations:(id)validations
{
  ...
  [validationsCopy validateClass:@"AppStore.SmallLockupView" hasInstanceMethod:@"accessibilityAdLabel" withFullSignature:{"@", 0}];
  [validationsCopy validateClass:@"AppStore.MixedMediaLockupCollectionViewCell" hasInstanceMethod:@"accessibilityTaglineLabel" withFullSignature:{"@", 0}];
}
