...
+ (void)_accessibilityPerformValidations:(id)validations
{
  ...
  [validationsCopy validateClass:@"AppStore.ProductLockupCollectionViewCell" hasInstanceMethod:@"initWithFrame:" withFullSignature:{"@", "{CGRect={CGPoint=dd}{CGSize=dd}}", 0}];
  [validationsCopy validateClass:@"AppStore.ProductLockupCollectionViewCell" hasInstanceMethod:@"layoutSubviews" withFullSignature:{"v", 0}];
  [validationsCopy validateClass:@"AppStore.ProductLockupCollectionViewCell" hasInstanceMethod:@"accessibilityTitleLabel" withFullSignature:{"@", 0}];
  [validationsCopy validateClass:@"AppStore.ProductLockupCollectionViewCell" hasInstanceMethod:@"accessibilityArtworkView" withFullSignature:{"@", 0}];
  [validationsCopy validateClass:@"AppStore.ProductLockupCollectionViewCell" hasInstanceMethod:@"accessibilityOfferButton" withFullSignature:{"@", 0}];
  [validationsCopy validateClass:@"AppStore.ProductLockupCollectionViewCell" hasInstanceMethod:@"accessibilityOfferSubtitleLabel" withFullSignature:{"@", 0}];
  [validationsCopy validateClass:@"AppStore.ProductLockupCollectionViewCell" hasInstanceMethod:@"accessibilityDeveloperLabel" withFullSignature:{"@", 0}];
  [validationsCopy validateClass:@"AppStore.ProductLockupCollectionViewCell" hasInstanceMethod:@"accessibilityTaglineLabel" withFullSignature:{"@", 0}];
  [validationsCopy validateClass:@"AppStore.ProductLockupCollectionViewCell" hasInstanceMethod:@"accessibilityOfferSubtitleLabel" withFullSignature:{"@", 0}];
  [validationsCopy validateClass:@"AppStore.ProductLockupCollectionViewCell" hasInstanceMethod:@"accessibilityDownloadProgressLabel" withFullSignature:{"@", 0}];
  [validationsCopy validateClass:@"AppStore.ProductLockupCollectionViewCell" hasSwiftField:@"expandedOfferTitleLabel" withSwiftType:"Optional<DynamicTypeLabel>"];
  [validationsCopy validateClass:@"AppStore.ProductLockupCollectionViewCell" hasSwiftField:@"expandedOfferSubtitleLabel" withSwiftType:"Optional<DynamicTypeLabel>"];
  [validationsCopy validateClass:@"AppStore.ProductLockupCollectionViewCell" hasInstanceMethod:@"accessibilityVideoView" withFullSignature:{"@", 0}];
  [validationsCopy validateClass:@"AppStore.ProductLockupCollectionViewCell" hasInstanceMethod:@"accessibilityBannerView" withFullSignature:{"@", 0}];
  [validationsCopy validateClass:@"AppStore.ProductLockupCollectionViewCell" hasInstanceMethod:@"accessibilitySecondaryBannerView" withFullSignature:{"@", 0}];
  [validationsCopy validateClass:@"AppStore.VideoView" hasInstanceMethod:@"accessibilityPlayButton" withFullSignature:{"@", 0}];
  [validationsCopy validateClass:@"AppStore.VideoView" hasInstanceMethod:@"accessibilityPlayerViewController" withFullSignature:{"@", 0}];
  [validationsCopy validateClass:@"AppStore.VideoView" hasInstanceMethod:@"accessibilityIsPlaying" withFullSignature:{"B", 0}];
  [validationsCopy validateClass:@"AppStore.VideoView" hasInstanceMethod:@"accessibilityShouldBePlaying" withFullSignature:{"B", 0}];
}
