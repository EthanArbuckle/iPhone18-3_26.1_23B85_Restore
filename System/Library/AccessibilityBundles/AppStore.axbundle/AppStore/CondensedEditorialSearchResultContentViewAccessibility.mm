...
+ (void)_accessibilityPerformValidations:(id)validations
{
  ...
  [validationsCopy validateClass:@"AppStore.CondensedEditorialSearchResultContentView" hasInstanceMethod:@"accessibilityHeaderLabel" withFullSignature:{"@", 0}];
  [validationsCopy validateClass:@"AppStore.CondensedEditorialSearchResultContentView" hasInstanceMethod:@"accessibilityTitleLabel" withFullSignature:{"@", 0}];
  [validationsCopy validateClass:@"AppStore.CondensedEditorialSearchResultContentView" hasSwiftField:@"viewButton" withSwiftType:"UIButton"];
}
