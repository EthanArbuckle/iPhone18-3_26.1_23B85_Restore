...
{
  v3 = a3;
  [v3 validateClass:@"AppStore.BreakoutDetailsView" hasInstanceMethod:@"accessibilityBadgeLabel" withFullSignature:{"@", 0}];
  [v3 validateClass:@"AppStore.BreakoutDetailsView" hasInstanceMethod:@"accessibilityTitleLabel" withFullSignature:{"@", 0}];
  [v3 validateClass:@"AppStore.BreakoutDetailsView" hasInstanceMethod:@"accessibilityDescriptionLabel" withFullSignature:{"@", 0}];
  [v3 validateClass:@"AppStore.BreakoutDetailsView" hasInstanceMethod:@"accessibilityCallToActionButton" withFullSignature:{"@", 0}];
}
