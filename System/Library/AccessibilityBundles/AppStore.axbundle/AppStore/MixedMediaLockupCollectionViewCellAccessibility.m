...
{
  v3 = a3;
  [v3 validateClass:@"AppStore.MixedMediaLockupCollectionViewCell" hasInstanceMethod:@"accessibilityLockupView" withFullSignature:{"@", 0}];
  [v3 validateClass:@"AppStore.MixedMediaLockupCollectionViewCell" hasInstanceMethod:@"accessibilityTaglineLabel" withFullSignature:{"@", 0}];
  [v3 validateClass:@"AppStore.MixedMediaLockupCollectionViewCell" hasInstanceMethod:@"accessibilityVideoView" withFullSignature:{"@", 0}];
  [v3 validateClass:@"AppStore.MixedMediaLockupCollectionViewCell" hasInstanceMethod:@"accessibilityMediaView" withFullSignature:{"@", 0}];
}
