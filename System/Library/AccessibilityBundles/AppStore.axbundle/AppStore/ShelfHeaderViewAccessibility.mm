...
+ (void)_accessibilityPerformValidations:(id)validations
{
  ...
  [validationsCopy validateClass:@"AppStore.ShelfHeaderView" hasSwiftField:@"eyebrowButton" withSwiftType:"DynamicTypeButton"];
  [validationsCopy validateClass:@"AppStore.ShelfHeaderView" hasSwiftField:@"titleButton" withSwiftType:"DynamicTypeButton"];
  [validationsCopy validateClass:@"AppStore.ShelfHeaderView" hasSwiftField:@"subtitleLabel" withSwiftType:"DynamicTypeLabel"];
  [validationsCopy validateClass:@"AppStore.ShelfHeaderView" hasSwiftField:@"accessoryButton" withSwiftType:"DynamicTypeButton"];
}
...
- (id)accessibilityLabel
{
  ...
  v9 = [string stringByReplacingOccurrencesOfString:@"\uFFFC" withString:&stru_2A20F95B0];
