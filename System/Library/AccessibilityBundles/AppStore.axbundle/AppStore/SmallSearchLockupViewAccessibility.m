...
{
  v3 = a3;
  [v3 validateClass:@"AppStore.SmallSearchLockupView" hasInstanceMethod:@"accessibilitytUserRatingView" withFullSignature:{"@", 0}];
  [v3 validateClass:@"AppStore.SmallSearchLockupView" hasInstanceMethod:@"accessibilityRatingCountLabel" withFullSignature:{"@", 0}];
  [v3 validateClass:@"AppStore.SmallSearchLockupView" hasInstanceMethod:@"accessibilityIsAd" withFullSignature:{"B", 0}];
  [v3 validateClass:@"AppStore.SmallSearchLockupView" hasInstanceMethod:@"accessibilityAdButton" withFullSignature:{"@", 0}];
  [v3 validateClass:@"AppStore.SmallSearchLockupView" hasInstanceMethod:@"accessibilityDescriptionLabel" withFullSignature:{"@", 0}];
  [v3 validateClass:@"AppStore.SmallSearchLockupView" hasInstanceMethod:@"accessibilityMetadataRibbonView" withFullSignature:{"@", 0}];
  [v3 validateClass:@"AppStore.SmallSearchLockupView" hasInstanceMethod:@"accessibilitySearchTagsRibbonView" withFullSignature:{"@", 0}];
  ...
  [v3 validateClass:@"AppStore.SmallSearchLockupView" hasSwiftField:@"editorsChoiceView" withSwiftType:"Optional<EditorsChoiceView>"];
}
