...
+ (void)_accessibilityPerformValidations:(id)a3
{
  ...
  [v3 validateClass:@"AppStore.AppDelegate" hasSwiftField:@"tabBarController" withSwiftType:"Optional<StoreTabBarController>"];
  [v3 validateClass:@"AppStore.StoreTabBarController" isKindOfClass:@"UITabBarController"];
}
