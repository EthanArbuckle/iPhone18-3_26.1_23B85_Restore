...
{
  v3 = a3;
  [v3 validateClass:@"AppStore.CrossLinkLockupView" hasInstanceMethod:@"accessibilityTitleLabel" withFullSignature:{"@", 0}];
  [v3 validateClass:@"AppStore.CrossLinkLockupView" hasInstanceMethod:@"accessibilitySubtitleLabel" withFullSignature:{"@", 0}];
  [v3 validateClass:@"AppStore.CrossLinkLockupView" hasInstanceMethod:@"accessibilityLockupView" withFullSignature:{"@", 0}];
}
