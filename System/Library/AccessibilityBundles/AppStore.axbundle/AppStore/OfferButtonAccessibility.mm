...
+ (void)_accessibilityPerformValidations:(id)validations
{
  ...
  [validationsCopy validateClass:@"AppStore.OfferButton" hasInstanceMethod:@"accessibilityShowRedownload" withFullSignature:{"v", 0}];
  [validationsCopy validateClass:@"AppStore.OfferButton" hasInstanceMethod:@"accessibilityShowLoading" withFullSignature:{"v", 0}];
  [validationsCopy validateClass:@"AppStore.OfferButton" hasInstanceMethod:@"accessibilityShowProgress:" withFullSignature:{"v", "d", 0}];
  [validationsCopy validateClass:@"AppStore.OfferButton" hasInstanceMethod:@"accessibilityShowText:" withFullSignature:{"v", "@", 0}];
  [validationsCopy validateClass:@"AppStore.OfferButton" hasInstanceMethod:@"layoutSubviews" withFullSignature:{"v", 0}];
  [validationsCopy validateClass:@"AppStore.OfferButton" hasInstanceMethod:@"initWithFrame:" withFullSignature:{"@", "{CGRect={CGPoint=dd}{CGSize=dd}}", 0}];
  [validationsCopy validateClass:@"AppStore.OfferButton" hasSwiftField:@"label" withSwiftType:"DynamicTypeLabel"];
  [validationsCopy validateClass:@"AppStore.OfferButton" hasSwiftField:@"subtitleLabel" withSwiftType:"DynamicTypeLabel"];
  [validationsCopy validateClass:@"AppStore.OfferButton" hasInstanceMethod:@"accessibilityShowPaused" withFullSignature:{"v", 0}];
  [validationsCopy validateClass:@"AppStore.OfferButton" hasInstanceMethod:@"accessibilityOfferLabel" withFullSignature:{"@", 0}];
  [validationsCopy validateClass:@"AppStore.OfferButton" isKindOfClass:@"UIControl"];
}
