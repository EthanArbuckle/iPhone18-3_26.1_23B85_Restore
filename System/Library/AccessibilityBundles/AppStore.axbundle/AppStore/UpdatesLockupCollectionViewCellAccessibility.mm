...
+ (void)_accessibilityPerformValidations:(id)validations
{
  ...
  [validationsCopy validateClass:@"AppStore.UpdatesLockupCollectionViewCell" hasInstanceMethod:@"accessibilitytLockupView" withFullSignature:{"@", 0}];
  [validationsCopy validateClass:@"AppStore.UpdatesLockupCollectionViewCell" hasInstanceMethod:@"accessibilityExpandableTextView" withFullSignature:{"@", 0}];
  [validationsCopy validateClass:@"AppStore.UpdatesLockupCollectionViewCell" hasInstanceMethod:@"accessibilityVersionMetadata" withFullSignature:{"@", 0}];
}
...
- (id)accessibilityCustomContent
{
  ...
  if ([v4 length])
  {
    v5 = [MEMORY[0x29EDB8058] customContentWithLabel:&stru_2A20F95B0 value:v4];
