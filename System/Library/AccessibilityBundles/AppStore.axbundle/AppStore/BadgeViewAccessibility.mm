...
+ (void)_accessibilityPerformValidations:(id)validations
{
  ...
  [validationsCopy validateClass:@"AppStore.BadgeView" hasInstanceMethod:@"accessibilityValueLabel" withFullSignature:{"@", 0}];
  [validationsCopy validateClass:@"AppStore.BadgeView" hasInstanceMethod:@"accessibilityCaptionLabel" withFullSignature:{"@", 0}];
  [validationsCopy validateClass:@"AppStore.BadgeView" hasInstanceMethod:@"accessibilityHeadingLabel" withFullSignature:{"@", 0}];
  [validationsCopy validateClass:@"AppStore.BadgeView" hasInstanceMethod:@"accessibilityValueView" withFullSignature:{"@", 0}];
  [validationsCopy validateClass:@"AppStore.BadgeView" hasSwiftField:@"valueView" withSwiftType:"Optional<UIView>"];
