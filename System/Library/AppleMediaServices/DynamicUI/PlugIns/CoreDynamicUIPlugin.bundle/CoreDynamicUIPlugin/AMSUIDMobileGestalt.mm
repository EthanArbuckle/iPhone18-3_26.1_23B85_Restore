    ...
    *&v5 = 138544130;
    ...
    while (2)
    {
      for (i = 0; i != v6; i = i + 1)
      {
        ...
        v10 = *(*(&v23 + 1) + 8 * i);
        if (([v10 isEqualToString:{&stru_BBC78, v21}] & 1) == 0)
        {
          ...
          else
          {
            ...
            if (os_log_type_enabled(oSLogObject, OS_LOG_TYPE_ERROR))
            {
              ...
              *buf = v21;
              ...
              v33 = 1026;
              v34 = 0;
              _os_log_impl(&def_4BB18, oSLogObject, OS_LOG_TYPE_ERROR, "%{public}@: [%{public}@] Failed to obtain capability: %{public}@, %{public}d", buf, 0x26u);
            }
          }
