...
uint64_t sub_10008CAD8(const char *a1)
{
  if (!a1)
  {
    return 0xFFFFFFFFLL;
...
char *parse_nx_mount_options(char *a1, int *a2)
{
  ...
  *(a2 + 4) = a2[2] & 0xCDFA | v11 & 1 | v11 & 4 | (((v11 & 0x30) != 0) << 12) | (((v11 & 0x60) != 0) << 13) | (((v11 >> 3) & 1) << 9);
  ...
  freemntopts();
  result = sub_10008CDAC(&off_1000C1898, a1, v8);
  if (!result)
  {
    return 0;
  }
...
char *sub_10008CDAC(const char **a1, char *__s1, const char *a3)
{
  v4 = __s1;
  v6 = strdup(__s1);
  if (v6)
...
char *parse_apfs_mount_options(char *a1, void *a2)
{
  getmnt_silent = 1;
  if (!a1)
  {
  ...
  if (getmntopts())
  {
    *a2 = v5;
    freemntopts();
    result = sub_10008CDAC(&apfs_mopts, a1, 0);
    if (result)
    {
      return result;
    }
...
const char *parse_multiple_nx_or_apfs_options(const char *a1, uint64_t (*a2)(const char *, uint64_t), uint64_t a3, uint64_t (*a4)(const char *, uint64_t), uint64_t a5)
{
  v10 = strlen(a1);
  v11 = 0;
  v12 = 0;
...
uint64_t apfs_increment_num_objects(uint64_t result, uint64_t a2, unint64_t a3)
{
  if ((*(a2 + 64) & 1) == 0)
  {
    v3 = *(a2 + 96) & 0xF000;
    ...
    atomic_fetch_add_explicit((*(result + 376) + v6), a3, memory_order_relaxed);
  }
...
uint64_t rolling_stats_roll_window(uint64_t a1)
{
    ...
    if ((*(v8 + 144) & 1) != 0 && *(v8 + 336))
    {
      ...
      do
      {
        ...
        if (v16 == v10)
        {
          ...
          *(v7 + 16) = v19;
          v20 = sub_10008DF10(a1, a2, v6, *v19 / *(v8 + 36));
          v3 = v20;
          if (v20)
          {
            v21 = a1[1];
...
uint64_t sub_10008DF10(uint64_t a1, unsigned int a2, uint64_t a3, unint64_t a4)
{
  if (!a1)
  {
    return 22;
    ...
    if (a2)
    {
      ...
      if (a3 <= 1 && a4 <= 3)
      {
        ...
        if (v21 < v15)
        {
          v32 = 0;
LABEL_55:
          v57 = sub_10008DF10(v5, v6, a4, v21);
          if (v57)
          {
            v4 = v57;
            v63 = *(a1 + 384) + 212;
            ...
            do
            {
              ...
              if (v31[5])
              {
                ...
                if (v34 / v35 != v71 || v72 == 0)
                {
                  ...
                  v41 = sub_10003BEB0(*(a1 + 392), 0x40000000, v40, &xmmword_100096000, &v76[2], 0, 0, 0, &v75);
                  if (v41)
                  {
                    v4 = v41;
              ...
              v44 = sub_10003BEB0(*(a1 + 392), 0x40000000, v43, &xmmword_100096010, v76, 0, 0, 0, &v74);
              if (v44)
              {
                v4 = v44;
                v64 = *(a1 + 384) + 212;
...
_DWORD *tx_checkpoint_get_available(_DWORD *result, _DWORD *a2, _DWORD *a3)
{
  v3 = result[24];
  v4 = result[26];
  if (v3 > v4)
...
uint64_t sub_10008F330(uint64_t a1, char a2, int a3)
{
  v5 = *(a1 + 400);
  if ((a2 & 0x40) != 0)
  {
...
uint64_t tx_checkpoint_write(void *a1, uint64_t a2, uint64_t a3, int8x16_t a4, int8x16_t a5)
{
  ...
  if (*(v11 + 36) == v8[21])
  {
    sub_10003F19C(a1, v11, *(a1[47] + 36), a4, a5);
    v12 = *(*(a2 + 64) + 8);
    v13 = sub_1000069D8(a1[48]);
    if (v13)
    {
      v14 = v13;
      if (!v8[19])
...
LABEL_27:
      ...
      *(a2 + 48) += v43;
      if (v27)
      {
        sub_100036CD4(v27, *(a3 + 48), *(a3 + 16), a1[49]);
      }
...
uint64_t sub_10008FFE4(uint64_t a1, uint64_t *a2, char a3)
{
  if (*(a1 + 627))
  {
    return 30;
...
LABEL_42:
          ...
          if (*(a1 + 626) == 1)
          {
            sub_10003F168(a1, v13, v14);
            v25 = *(a1 + 376);
            v26 = sub_1000069D8(*(a1 + 384));
            if (v26)
            {
              v3 = v26;
...
__darwin_time_t sub_100090594(uint64_t a1, int a2, int a3)
{
  if (a2)
  {
    v4 = *(a1 + 24);
...
uint64_t sub_100090680(uint64_t a1)
{
  v2 = *(a1 + 400);
  ...
  *(v2 + 72) = i | 0x10;
  ...
  if ((v5 & 0x14) == 0 || (v6 = sub_100090AB0(a1, v4), !v6))
  {
LABEL_9:
    v7 = *(v2 + 144);
    if (v7 && (*(v7 + 24) & 4) != 0)
    {
      v6 = sub_100090AB0(a1, v7);
    }
...
uint64_t tx_leave(uint64_t a1, uint64_t a2, int a3)
{
  if ((*(a1 + 627) & 1) == 0)
  {
    ...
    {
      v9 = *(v8 + 32) <= 0x186A0u && !sub_100039430(*(a1 + 392)) && sub_100012180(a1) == 0;
    }
...
uint64_t sub_100090AB0(uint64_t a1, uint64_t a2)
{
  v5 = *(a1 + 392);
  v4 = *(a1 + 400);
  ...
  *(a1 + 660) = -1;
  ...
  if ((v7 & 0x10) == 0)
  {
    ...
    *(a2 + 72) = v8;
    ...
    v11 = sub_10003771C(v5, 0, v10, *(a2 + 16));
    if (v11)
    {
      v12 = v11;
      if (!*(v4 + 76))
...
LABEL_24:
      ...
      *(v85 + 128) = v82;
      *(v85 + 132) = v83;
      sub_10003F19C(a1, v85, *(*(a1 + 376) + 36), v71, v72);
      *(a2 + 48) = 0;
      *(a2 + 40) = 1;
      *(*(a2 + 64) + 36) = 0;
      v86 = *(a2 + 24);
  ...
  v26 = sub_100039008(v5, v25);
  if (*(a1 + 629) == 1)
  {
    pthread_mutex_lock(v4);
    sub_100038998(v5);
    sub_10008F330(a1, 0, 0);
    cv_wakeup((v4 + 256));
    v12 = 0;
    *(a2 + 52) = 0;
    return v12;
  ...
  while (1)
  {
    ...
    if (!v32)
    {
      ...
      {
        *(v33 + 32) |= 1u;
        sub_10003F19C(a1, v33, *(*(a1 + 376) + 36), v27, v28);
        v34 = *(*(a2 + 64) + 8);
        v35 = sub_1000069D8(*(a1 + 384));
        if (v35)
        {
          v12 = v35;
          pthread_mutex_lock(v4);
      ...
      *(a2 + 104) = v45;
      ...
      {
        if ((*(a2 + 26) & 8) == 0 || (v63 = *(a2 + 56), v64 = sub_1000069D8(*(a1 + 384)), !v64))
        {
          ...
          *(a2 + 104) += v66;
          ...
          v68 = sub_10008F330(a1, (v67 >> 14) & 0x10, 0);
          if (!v68)
          {
LABEL_160:
            *(a2 + 52) = 0;
      ...
      *(v4 + 76) = v60;
      ...
      v62 = 32;
LABEL_123:
      v50 = *(a2 + 104) + sub_100090594(v61, v62, 16);
LABEL_124:
      *(a2 + 104) = v50;
      goto LABEL_66;
    }
...
uint64_t sub_1000928B4(uint64_t a1, uint64_t a2)
{
  v3 = *(a1 + 6);
