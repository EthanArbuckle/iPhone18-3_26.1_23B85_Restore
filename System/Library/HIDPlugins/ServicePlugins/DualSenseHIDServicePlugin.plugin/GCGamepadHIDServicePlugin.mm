...
LABEL_5:
  ...
  if (v19)
  {
    ...
    {
      v20 = [NSPredicate predicateWithBlock:&stru_18588];
...
- (BOOL)setProperty:(id)property forKey:(id)key client:(id)client
{
  ...
  if (sub_DE8())
  {
    sub_B464(self, propertyCopy, keyCopy);
  }
...
- (void)createVirtualHIDDeviceForBattery
{
  if ([(GCGamepadHIDServicePlugin *)self shouldCreateBatteryDevice])
  {
    ...
    [v5 setObject:&off_19698 forKeyedSubscript:@"GameControllerType"];
...
- (BOOL)isIdle
{
  ...
  v5 = (v4 * dword_1F208 / *algn_1F20C) / 1000000000.0;
