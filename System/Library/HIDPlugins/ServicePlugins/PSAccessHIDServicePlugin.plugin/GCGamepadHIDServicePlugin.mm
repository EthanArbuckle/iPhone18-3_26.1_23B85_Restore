...
LABEL_5:
  ...
  if (v19)
  {
    ...
    {
      v20 = [NSPredicate predicateWithBlock:&stru_10578];
...
- (BOOL)setProperty:(id)property forKey:(id)key client:(id)client
{
  ...
  if (sub_DC0())
  {
    sub_7BC0(self, propertyCopy, keyCopy);
  }
...
- (void)createVirtualHIDDeviceForBattery
{
  if ([(GCGamepadHIDServicePlugin *)self shouldCreateBatteryDevice])
  {
    ...
    [v5 setObject:&off_11010 forKeyedSubscript:@"GameControllerType"];
...
- (BOOL)isIdle
{
  ...
  v5 = (v4 * dword_16B00 / *algn_16B04) / 1000000000.0;
