...
{
  v21.receiver = self;
  v21.super_class = HeadphoneAccommodationsCCModuleViewController;
  v2 = [(HeadphoneAccommodationsCCModuleViewController *)&v21 init];
  if (v2)
  {
    v3 = objc_alloc(MEMORY[0x29EDC50A8]);
    v5 = objc_msgSend_initWithDelegate_andAvailableModules_(v3, v4, v2, &unk_2A23E80C8);
    ...
    v17 = objc_msgSend__systemImageNamed_withConfiguration_(MEMORY[0x29EDC7AC8], v16, @"headphones", v15);
...
{
  v40.receiver = self;
  v40.super_class = HeadphoneAccommodationsCCModuleViewController;
...
{
  v6.receiver = self;
  v6.super_class = HeadphoneAccommodationsCCModuleViewController;
