...
- (RPBackgroundActivity)initWithBackgroundActivityIdentifier:(id)a3
{
  ...
  if (__RPLogLevel <= 1u && os_log_type_enabled(&_os_log_default, OS_LOG_TYPE_DEFAULT))
  {
    *buf = 136446722;
    ...
    v18 = 2112;
    v19 = v4;
    _os_log_impl(&dword_0, &_os_log_default, OS_LOG_TYPE_DEFAULT, " [INFO] %{public}s:%d Initializing with identifier: %@", buf, 0x1Cu);
  }
...
- (void)dealloc
{
  if (__RPLogLevel <= 1u && os_log_type_enabled(&_os_log_default, OS_LOG_TYPE_DEFAULT))
  {
    *buf = 136446466;
    ...
    v8 = 1024;
    v9 = 50;
    _os_log_impl(&dword_0, &_os_log_default, OS_LOG_TYPE_DEFAULT, " [INFO] %{public}s:%d Deallocating RPBackgroundActivity", buf, 0x12u);
  }
...
- (void)activateWithUserInteractionHandler:(id)a3
{
  ...
  if (__RPLogLevel <= 1u && os_log_type_enabled(&_os_log_default, OS_LOG_TYPE_DEFAULT))
  {
    *buf = 136446466;
    ...
    v9 = 1024;
    v10 = 63;
    _os_log_impl(&dword_0, &_os_log_default, OS_LOG_TYPE_DEFAULT, " [INFO] %{public}s:%d Activating background activity", buf, 0x12u);
  }
...
- (void)deactivate
{
  if (__RPLogLevel <= 1u && os_log_type_enabled(&_os_log_default, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *&buf[12] = 1024;
    *&buf[14] = 77;
    _os_log_impl(&dword_0, &_os_log_default, OS_LOG_TYPE_DEFAULT, " [INFO] %{public}s:%d Deactivating background activity", buf, 0x12u);
  }
...
- (void)updateTimerString:(id)a3
{
  ...
  if (__RPLogLevel <= 1u && os_log_type_enabled(&_os_log_default, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *&buf[18] = 2112;
    *&buf[20] = v4;
    _os_log_impl(&dword_0, &_os_log_default, OS_LOG_TYPE_DEFAULT, " [INFO] %{public}s:%d timer=%@", buf, 0x1Cu);
  }
    ...
    *&buf[16] = 0x2020000000;
    ...
    else if (__RPLogLevel <= 1u && os_log_type_enabled(&_os_log_default, OS_LOG_TYPE_DEFAULT))
    {
      ...
      *&location[4] = "[RPBackgroundActivity updateTimerString:]";
      v13 = 1024;
      v14 = 109;
      _os_log_impl(&dword_0, &_os_log_default, OS_LOG_TYPE_DEFAULT, " [INFO] %{public}s:%d Background activity not active, storing timer string for later use", location, 0x12u);
    }
...
- (void)publishNewDataWithUserInteractionHandler:(id)a3
{
  ...
  if (__RPLogLevel <= 1u && os_log_type_enabled(&_os_log_default, OS_LOG_TYPE_DEFAULT))
  {
    ...
    *buf = 136446722;
    ...
    v31 = 1024;
    LODWORD(v32) = v6;
    _os_log_impl(&dword_0, &_os_log_default, OS_LOG_TYPE_DEFAULT, " [INFO] %{public}s:%d Publishing new data with active state: %d", buf, 0x18u);
  }
        ...
        if (v11)
        {
          if (__RPLogLevel <= 1u && os_log_type_enabled(&_os_log_default, OS_LOG_TYPE_DEFAULT))
          {
            *buf = 136446722;
            ...
            v31 = 2112;
            v32 = v11;
            _os_log_impl(&dword_0, &_os_log_default, OS_LOG_TYPE_DEFAULT, " [INFO] %{public}s:%d Created new background activity attribution=%@", buf, 0x1Cu);
          }
