...
void __31__ACCObjCType_typeForEncoding___block_invoke(id a1)
{
  ...
  v20[10] = v4;
  v5 = [[ACCObjCType alloc] initWithCode:11 encoding:@"d" name:@"double" className:0 size:8 flags:2];
  v20[11] = v5;
  ...
  v20[13] = v7;
  v8 = [[ACCObjCType alloc] initWithCode:14 encoding:@"*" name:@"char*" className:0 size:8 flags:0];
  v20[14] = v8;
  v9 = [[ACCObjCType alloc] initWithCode:15 encoding:@"@" name:@"id" className:0 size:8 flags:0];
  v20[15] = v9;
  v10 = [[ACCObjCType alloc] initWithCode:16 encoding:@"#" name:@"Class" className:0 size:8 flags:0];
  v20[16] = v10;
  v11 = [NSArray arrayWithObjects:v20 count:17];
  v12 = _ACCObjCTypesByCode;
...
- (void)getBytes:(void *)a3 forObject:(id)a4
{
  ...
  {
    [NSException raise:NSInternalInconsistencyException format:@"Unsupported unboxing type: %@", self->_name];
  }
}
