...
void ggctl_reset(mach_port_t a1, unsigned int a2)
{
  ...
  else
  {
    ...
    {
      *buf = 0;
      _os_log_impl(&dword_277275000, v3, OS_LOG_TYPE_DEFAULT, "gas gauge: reset", buf, 2u);
    }
...
uint64_t ggctl_map_currentlog(uint64_t a1, void *a2)
{
  v5 = 0;
  v6 = 0;
  result = MEMORY[0x277CABEA0](a1, 0, *MEMORY[0x277D85F48], &v6, &v5, 1);
  v4 = v6;
  if (result)
  {
    v4 = 0;
...
{
  keys = @"built-in";
  result = CFDictionaryCreate(*MEMORY[0x277CBECE8], &keys, MEMORY[0x277CBED28], 1, MEMORY[0x277CBF138], MEMORY[0x277CBF150]);
  if (result)
  {
    v1 = result;
    ...
    CFRelease(v1);
    return IOServiceGetMatchingService(*MEMORY[0x277CD2898], v2);
  }
...
uint64_t updateThread(uint64_t a1)
{
  ...
  *notification = 0;
  ...
  {
    *buf = 0;
    _os_log_impl(&dword_277275000, v3, OS_LOG_TYPE_DEFAULT, "gasgauge: updateThread start", buf, 2u);
  }
  ...
  if (v4)
  {
    ...
    if (kernelPort && thePortRef)
    {
      ...
      *buf = 0;
      v348[0] = 0;
      v16 = MEMORY[0x277CABEA0](v13, 0, *MEMORY[0x277D85F48], buf, v348, 1);
      if (v16)
      {
        v17 = 0;
      }
      ...
      *buf = 352;
      v291 = v15;
      IOConnectCallStructMethod(v15, 2u, 0, 0, &dword_2815AEE88, buf);
      byte_2815AEDD4 = dword_2815AEF2C != 0;
      v333 = word_2815AEF16;
      v278 = dword_2815AEFE0;
      ...
      if (v25)
      {
        ...
        else
        {
          ...
          if (!Value)
          {
            ...
            {
              *buf = 0;
              _os_log_impl(&dword_277275000, v263, OS_LOG_TYPE_DEFAULT, "Critical battery shutdown disabled", buf, 2u);
              v283 = 0;
            }
...
LABEL_30:
            ...
            v292 = v334 != 0;
            getUPOData(@"IOPMUBootBatteryHealthMetric", &dword_2815AEE80);
            v327 = 64;
            ...
            if (os_log_type_enabled(logger, OS_LOG_TYPE_DEFAULT))
            {
              ...
              *&buf[14] = v283;
              *&buf[18] = 1024;
              *&buf[20] = word_2815AEF14;
              *&buf[24] = 1024;
              *&buf[26] = valuePtr;
              *&buf[30] = 1024;
              LODWORD(v371) = byte_2815AEDD4;
              WORD2(v371) = 1024;
              *(&v371 + 6) = v333;
              WORD5(v371) = 1024;
...
LABEL_507:
                IOObjectRelease(v5);
                MEMORY[0x277CABEB0](v291, 0, *MEMORY[0x277D85F48], v285);
                IOServiceClose(v291);
                *(v14 + 2448) = 0;
                v262 = *(v2 + 3456);
...
LABEL_152:
                  ...
                  else
                  {
                    ...
                    else if (hdq_state)
                    {
                      if (hdq_state < 0)
                      {
                        if (os_log_type_enabled(*(v2 + 3456), OS_LOG_TYPE_ERROR))
                        {
                          ...
                          else
                          {
                            ...
                            *v285 = word_2815AEDB6 > 0x131u;
                            ...
                            else
                            {
                              ...
                              if (v276)
                              {
                                byte_2815AEDB8 = dword_2815AEF28;
                                if (dword_2815AEF28)
                                {
                                  LOBYTE(v276) = 1;
                                  goto LABEL_431;
                                ...
                                if (os_log_type_enabled(logger, OS_LOG_TYPE_ERROR))
                                {
                                  ...
                                  *&input[8] = 1024;
                                  *&input[10] = Block;
                                  _os_log_error_impl(&dword_277275000, v228, OS_LOG_TYPE_ERROR, "disabled passedCharge PCFF=%d err=%d", input, 0xEu);
                                }
                              }
...
LABEL_431:
                              ...
                              if (hdqReadS16(v291, 60, &word_2815AEDB2))
                              {
                                word_2815AEDB2 = 0;
                              }

                              if (!controlReadU16(v291, 8, &word_2815AEDB0))
                              {
                                v2 = 0x2815AE000;
                                goto LABEL_202;
                              }
                                ...
                                if (ggctl_logShutdownReason(v291, input, 1u) || !*&input[40])
                                {
                                  ...
                                  if (os_log_type_enabled(v210, OS_LOG_TYPE_DEFAULT))
                                  {
                                    *v338 = 136315394;
                                    ...
                                    v340 = 1024;
                                    v341 = 3577;
                                    _os_log_impl(&dword_277275000, v210, OS_LOG_TYPE_DEFAULT, "%s:%d  Error Reading Shutdown reason", v338, 0x12u);
                                  }
                                }
                                ...
                                if (v211)
                                {
                                  ...
                                  if (v214)
                                  {
                                    ...
                                    if (os_log_type_enabled(logger, OS_LOG_TYPE_ERROR))
                                    {
                                      *input = 67109120;
                                      *&input[4] = v215;
                                      _os_log_error_impl(&dword_277275000, v216, OS_LOG_TYPE_ERROR, "IORegistryEntrySetCFProperties(0x%x)", input, 8u);
                                    }
                                  }
...
LABEL_426:
                                    _os_log_impl(&dword_277275000, v226, OS_LOG_TYPE_DEFAULT, v227, input, 0xCu);
LABEL_457:
                                    v240 = 1;
LABEL_458:
                                    if (v274)
                                    {
                                      ...
                                      if (os_log_type_enabled(logger, OS_LOG_TYPE_DEFAULT))
                                      {
                                        ...
                                        *input = 67109120;
                                        *&input[4] = v242;
                                        _os_log_impl(&dword_277275000, v241, OS_LOG_TYPE_DEFAULT, "disabling DLOG (num_clients=%i)", input, 8u);
                                      }
                                      ...
                                      if (v243)
                                      {
                                        ...
                                        if (os_log_type_enabled(logger, OS_LOG_TYPE_ERROR))
                                        {
                                          *input = 67109120;
                                          *&input[4] = v244;
                                          _os_log_error_impl(&dword_277275000, v245, OS_LOG_TYPE_ERROR, "cannot disable DLOG (%#x)", input, 8u);
                                        }
...
LABEL_465:
                                    ...
                                    else if (word_2815AEDB6 < 0x600u)
                                    {
                                      v251 = word_2815AEDB6 > 0x501u && v264;
                                    }

                                    else
                                    {
                                      v251 = (word_2815AEDEA >> 5) & 1;
                                    }
                                    ...
                                    if (os_log_type_enabled(logger, OS_LOG_TYPE_ERROR))
                                    {
                                      *input = 67109120;
                                      *&input[4] = v253;
                                      _os_log_error_impl(&dword_277275000, v254, OS_LOG_TYPE_ERROR, "CCA: cannot disable DLOG (%#x)", input, 8u);
                                    }
                                  ...
                                  if (U16)
                                  {
                                    ...
                                    if (os_log_type_enabled(logger, OS_LOG_TYPE_ERROR))
                                    {
                                      *input = 67109120;
                                      *&input[4] = v236;
                                      _os_log_error_impl(&dword_277275000, v237, OS_LOG_TYPE_ERROR, "CCA: cannot read DLOG status (%#x)", input, 8u);
                                    }
...
LABEL_453:
                                    _os_log_impl(&dword_277275000, v233, OS_LOG_TYPE_DEFAULT, v234, input, 0x12u);
                                  }
...
LABEL_454:
                              ...
                              if (v221)
                              {
                                ...
                                if (os_log_type_enabled(logger, OS_LOG_TYPE_ERROR))
                                {
                                  *input = 67109120;
                                  *&input[4] = v222;
                                  _os_log_error_impl(&dword_277275000, v223, OS_LOG_TYPE_ERROR, "CCA: usermode cannot disable DLOG (%#x)", input, 8u);
                                }
...
uint64_t GGEventInstall()
{
  ...
  if (!result)
  {
    ...
    if (result)
    {
      ...
      v3 = dispatch_source_create(MEMORY[0x277D85D30], 0xFuLL, 0, global_queue);
...
uint64_t EnableFullSleepForRevCOrLater(int a1)
{
  ...
  if (result)
  {
    ...
    if (v3 != -1)
    {
      ...
      {
        v5 = -1;
        if ((getFWVersion(v3, &v5) & 0x80000000) != 0 && os_log_type_enabled(logger, OS_LOG_TYPE_ERROR))
        {
...
{
  CFProperty = IORegistryEntryCreateCFProperty(service, key, *MEMORY[0x277CBECE8], 0);
  if (CFProperty)
  {
    v4 = CFProperty;
...
void setUPOData(const __CFString *a1, int a2)
{
  ...
  if (v3)
  {
    ...
    v6 = CFDictionaryCreate(v5, &setUPOData_tmp, &v12, 1, MEMORY[0x277CBF138], MEMORY[0x277CBF150]);
    if (v6)
    {
      v7 = v6;
...
void getUPOData(CFStringRef key, void *a2)
{
  ...
  if (v6)
  {
    ...
    if (v9)
    {
      ...
      CFRelease(v10);
      find_pmu_pmu_service = IOServiceGetMatchingService(*MEMORY[0x277CD2898], v7);
    }
...
void updateThermalCoolDownState(io_registry_entry_t a1, int a2)
{
  ...
  keys[0] = CFStringCreateWithCString(*MEMORY[0x277CBECE8], "ThermalCoolDown", 0x8000100u);
  ...
  values = *v5;
  v6 = CFDictionaryCreate(v4, keys, &values, 1, MEMORY[0x277CBF138], MEMORY[0x277CBF150]);
  if (v6)
  {
    v7 = v6;
...
void statsAndLogs(io_registry_entry_t a1, int a2)
{
  ...
  v7 = CFDictionaryCreate(v4, &keys, &values, v6, MEMORY[0x277CBF138], MEMORY[0x277CBF150]);
  if (v7)
  {
    v8 = v7;
...
void debugLog(io_registry_entry_t a1, int a2)
{
  ...
  keys[0] = CFStringCreateWithCString(*MEMORY[0x277CBECE8], "debug", 0x8000100u);
  values = CFNumberCreate(v3, kCFNumberSInt32Type, &valuePtr);
  v4 = CFDictionaryCreate(v3, keys, &values, 1, MEMORY[0x277CBF138], MEMORY[0x277CBF150]);
  if (v4)
  {
    v5 = v4;
...
void calculateBatteryHealthMetric()
{
  if (word_2815AEDB6 >= 0x600u)
  {
    v0 = (bswap32(word_2815AEE30) >> 16) * 0.137995 + (bswap32(word_2815AEE2E) >> 16) * 0.0693069 + (bswap32(word_2815AEE32) >> 16) * 0.137376 + (bswap32(word_2815AEE34) >> 16) * 0.137376 + (bswap32(word_2815AEE36) >> 16) * 0.137376 + (bswap32(word_2815AEE38) >> 16) * 0.137376 + (bswap32(word_2815AEE3A) >> 16) * 0.137376 + (bswap32(word_2815AEE3C) >> 16) * 0.0872525 + (bswap32(word_2815AEE3E) >> 16) * 0.0185644;
    word_2815AEE84 = v0;
    v1 = &dword_280A6A75C;
    v2 = 17;
    while (*(v1 - 2) != word_2815AEDB0)
    {
      v1 += 2;
      if (!--v2)
      {
...
LABEL_11:
  ...
  *(values + v19) = v18;
  *(keys + v19) = @"UpdateTime";
  v11 = CFDictionaryCreate(v8, keys, values, v10 + 4, MEMORY[0x277CBF138], MEMORY[0x277CBF150]);
  v20 = v10 + 5;
  do
  {
    v21 = *v13--;
...
CFDictionaryRef dynamicATV(mach_port_t a1)
{
  ...
  *input = xmmword_27727F750;
  ...
  v1 = word_2815AEDB4 + word_2815AEDBE;
  v2 = word_2815AEDB2;
  if (v1 <= (v2 + ((v2 & 0x8000) >> 15)) >> 1)
  {
    v3 = (word_2815AEDB2 + ((word_2815AEDB2 & 0x8000u) >> 15)) >> 1;
  }

  else
  {
    v3 = word_2815AEDB4 + word_2815AEDBE;
  }

  if (v1 <= word_2815AEDB2)
  {
    v2 = v3;
  }
...
uint64_t determineVACVoltage()
{
  ...
  if (dword_2815AEF30)
  {
    if (determineVACVoltage_lastBatteryCycleCount != word_2815AEDE4 || dword_2815AEDD8 == 0)
    {
      determineVACVoltage_lastBatteryCycleCount = word_2815AEDE4;
      v3 = &dword_2815AEF34;
      while (1)
      {
        v5 = *v3++;
        v4 = v5;
        v6 = HIWORD(v5);
        if (v5 < 0x10000 || v6 > word_2815AEDE4)
        {
          break;
        }
...
LABEL_16:
      v8 = LOWORD(updateThread_batteryInfo[dword_2815AEF30 + 104]);
LABEL_17:
  ...
  v11 = dword_2815AEF74;
  if (dword_2815AEF74 && word_2815AEDB6 >= 0x313u)
  {
    v12 = word_2815AEE1E;
    ...
    v14 = &word_2815AEE1E + 1;
    if (word_2815AEDB6 > 0x500u)
    {
      v14 = &word_2815AEE1C + 1;
    }
...
LABEL_53:
        v24 = LOWORD(updateThread_batteryInfo[dword_2815AEF74 + 121]);
LABEL_54:
...
uint64_t determinePoSMThreshold()
{
  ...
  v4 = *v0;
  v5 = dword_2815AEFBC;
  v6 = dword_2815AEFBC != 0;
  v7 = word_2815AEFC0;
  v8 = word_2815AEFC0 != 0;
  v9 = dword_2815AEFC4;
  v10 = dword_2815AEFC4 != 0;
  v11 = word_2815AEFC8;
  v12 = word_2815AEFC8 != 0;
  ...
  if (v13)
  {
    ...
    if (word_2815AEDE4 <= HIWORD(dword_2815AEFBC))
    {
      v16 = -1;
    }
  ...
  if (v17)
  {
    ...
    if ((42949673 * (v4 * v3)) >> 32 <= HIWORD(dword_2815AEFC4))
    {
      v19 = -1;
    }
  ...
  {
    determinePoSMThreshold_lastAbove95 = v4;
    if (v4 <= HIWORD(*&word_2815AEFC8))
    {
      v21 = &getFWVersion_gFWVersion;
      v20 = -1;
    }
...
CFStringRef createStringWithBytes(UInt8 *bytes, unint64_t a2)
{
  ...
  return CFStringCreateWithBytesNoCopy(*MEMORY[0x277CBECE8], bytes, v2, 0x8000100u, 0, *MEMORY[0x277CBED00]);
}
...
void updateThread_cold_8(uint8_t *buf, _DWORD *a2, os_log_t log)
{
  *buf = 67109120;
  *a2 = -1;
  _os_log_error_impl(&dword_277275000, log, OS_LOG_TYPE_ERROR, "cannot drain the data log (%d)", buf, 8u);
}
