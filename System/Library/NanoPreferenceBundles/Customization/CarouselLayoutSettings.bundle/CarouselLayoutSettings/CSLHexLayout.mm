...
- (CSLHexLayout)initWithConfiguration:(HexLayoutConfiguration *)a3
{
  ...
  if (result)
  {
    *&result->_configuration.var0 = *&a3->var0;
    v5 = *&a3->var4;
    v6 = *&a3[1].var3;
    v7 = *&a3[2].var2;
    result[1]._contentOffset.x = *&a3[3].var1;
    ...
    *result->_boundsRadius = vmul_f32(vsub_f32(*&a3[2].var0, *&v6), 0x3F0000003F000000);
  }
...
- (void)applyRubberbandVectorToCenter:(float32x2_t *)a1 forHex:(float32x2_t)a2
{
  ...
  if (fmaxf(v4.f32[0], v4.f32[1]) > 0.0)
  {
    ...
    *v11.f32 = vmul_f32(vminnm_f32(vmaxnm_f32(vdiv_f32(a2, a1[1]), _D10), _D11), vdup_n_s32(0x40490FDBu));
...
- (CGPoint)scrolledPointFromContentPoint:(CGPoint)a3
{
  v3 = a3.x - self->_contentOffset.x;
  v4 = a3.y - self->_contentOffset.y;
  result.y = v4;
  result.x = v3;
  return result;
}
