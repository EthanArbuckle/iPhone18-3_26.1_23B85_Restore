...
- (CSLIconPositionsStore)init
{
  ...
  if (v2)
  {
    ...
    CFNotificationCenterAddObserver(DarwinNotifyCenter, v2, sub_16210, @"CSLIconPositionsChangedNotification", 0, 0);
    v2->_initialSyncComplete = 0;
    v6 = CFNotificationCenterGetDarwinNotifyCenter();
    CFNotificationCenterAddObserver(v6, v2, sub_16218, kNPSInitialSyncCompletionDarwinNotification, 0, 0);
