...
{
  v6 = a3;
  v4 = sub_14288(&self->_nodes.__table_.__bucket_list_.__ptr_, &v6);
  if (v4)
  {
...
{
  v5 = a3;
  v3 = sub_14288(&self->_nodes.__table_.__bucket_list_.__ptr_, &v5);
  if (v3)
  {
    v3 = v3[3];
  }
...
- (int64_t)neighborCountOfHex:(Hex)a3 upToMinimumNeighbors:(int64_t)a4 withinRange:(unint64_t)a5
{
  ...
  {
    v7 = sub_14288(&self->_neighborCounts.__table_.__bucket_list_.__ptr_, &v20);
    if (v7)
    {
      return *(v7 + 6);
    }
...
- (void)setNodeObject:(id)a3 forKey:(Hex)a4
{
  ...
  v5 = a3;
  v6[2] = v6;
  sub_14B68(&self->_nodes.__table_.__bucket_list_.__ptr_, v6)[3] = v5;
  *&self->_neighborCountValid = 256;
}
...
{
  v4 = a3;
  sub_14DA4(&self->_nodes.__table_.__bucket_list_.__ptr_, &v4);
  *&self->_neighborCountValid = 256;
}
...
{
  v7 = a3;
  [v7 encodeObject:&off_39DE0 forKey:@"Version"];
  if (self->_isVerticalOnly)
  {
...
- (id)description
{
  ...
  v4 = [v3 sortedArrayUsingComparator:&stru_38C90];
...
- (id)_emplaceNodeAtHex:(Hex)a3 withBundleIdentifier:(id)a4
{
  ...
  sub_14DDC(&self->_nodes.__table_.__bucket_list_.__ptr_, &v10);
  v7 = v9;
