...
- (id)displayName
{
  ...
  if (type > 3)
  {
    switch(type)
    {
      case 4:
        ...
        v5 = [v4 localizedStringForKey:@"TO_OR_CC" value:&stru_34FF0 table:@"Main"];
        break;
      case 6:
        v4 = [NSBundle bundleForClass:objc_opt_class()];
        v5 = [v4 localizedStringForKey:@"IMPORTANT_THREADS" value:&stru_34FF0 table:@"Main"];
        break;
      case 7:
        v4 = [NSBundle bundleForClass:objc_opt_class()];
        v5 = [v4 localizedStringForKey:@"TODAY" value:&stru_34FF0 table:@"Main"];
        break;
      default:
        goto LABEL_15;
    }
  ...
  else
  {
    switch(type)
    {
      case 1:
        v4 = [NSBundle bundleForClass:objc_opt_class()];
        v5 = [v4 localizedStringForKey:@"VIP" value:&stru_34FF0 table:@"Main"];
        break;
      case 2:
        v4 = [NSBundle bundleForClass:objc_opt_class()];
        v5 = [v4 localizedStringForKey:@"FLAGGED" value:&stru_34FF0 table:@"Main"];
        break;
      case 3:
        v4 = [NSBundle bundleForClass:objc_opt_class()];
        v5 = [v4 localizedStringForKey:@"UNREAD" value:&stru_34FF0 table:@"Main"];
        break;
      default:
        goto LABEL_15;
    }
