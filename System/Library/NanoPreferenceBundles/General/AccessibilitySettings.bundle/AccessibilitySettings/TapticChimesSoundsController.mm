...
- (void)tableView:(id)a3 didSelectRowAtIndexPath:(id)a4
{
  ...
  v7 = [(TapticChimesSoundsController *)self indexForIndexPath:v6, v18.receiver, v18.super_class];
  v8 = [(TapticChimesSoundsController *)self specifiers];
  v9 = [v8 objectAtIndex:v7];

  v10 = [v6 section];
  v11 = [(TapticChimesSoundsController *)self specifierAtIndex:[(TapticChimesSoundsController *)self indexOfGroup:v10]];
