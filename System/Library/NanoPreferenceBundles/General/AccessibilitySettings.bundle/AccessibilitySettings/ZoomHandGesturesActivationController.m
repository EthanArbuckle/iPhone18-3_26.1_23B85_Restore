...
- (id)specifiers
{
  ...
  if (!v3)
  {
    ...
    v30 = v5;
    [v4 addObject:v5];
    v34 = [(ZoomHandGesturesActivationController *)self greyActivationGesture];
    v35 = 0u;
    v36 = 0u;
    v37 = 0u;
    v38 = 0u;
...
- (void)tableView:(id)a3 didSelectRowAtIndexPath:(id)a4
{
  ...
  v7 = [(ZoomHandGesturesActivationController *)self indexForIndexPath:v6, v16.receiver, v16.super_class];
