...
- (void)ax_addArcWithFirstPoint:(CGPoint)a3 secondPoint:(CGPoint)a4 cornerRadius:(double)a5
{
  ...
  {
    v27 = v35.f64[0] - v18 * fabs(cos(v15 * 0.5) / v22);
  ...
  v25.f64[0] = v31;
  v25.f64[1] = v30;
  [(UIBezierPath *)self addArcWithCenter:vmovn_s64(vcgtq_f64(v33 radius:v35)).i8[4] & 1 startAngle:vaddq_f64(v25 endAngle:vaddq_f64(*&v36.tx clockwise:vmlaq_n_f64(vmulq_n_f64(*&v36.c, v29), *&v36.a, v27))), v18, v17 + v23, v17 + v24];
}
