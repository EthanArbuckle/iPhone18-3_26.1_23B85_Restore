...
- (RAWOpcodeScalePerRow)initWithArguments:(id)arguments;
- (id)outputImage;
@end
...
- (RAWOpcodeScalePerRow)initWithArguments:(id)arguments
{
  ...
  v11.receiver = self;
  v11.super_class = RAWOpcodeScalePerRow;
...
- (id)outputImage
{
  ...
  v5 = objc_msgSend_kernelWithString_(MEMORY[0x277CBF738], a2, @"kernel vec4 rc_scale_per_row (__sample c) { return c }", v2, v3);;
