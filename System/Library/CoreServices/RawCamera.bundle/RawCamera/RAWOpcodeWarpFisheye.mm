...
- (RAWOpcodeWarpFisheye)initWithArguments:(id)arguments;
- (id)outputImage;
@end
...
- (RAWOpcodeWarpFisheye)initWithArguments:(id)arguments
{
  ...
  v11.receiver = self;
  v11.super_class = RAWOpcodeWarpFisheye;
...
- (id)outputImage
{
  ...
  v5 = objc_msgSend_kernelWithString_(MEMORY[0x277CBF738], a2, @"kernel vec4 rc_warp_fisheye (__sample c) { return c }", v2, v3);;
