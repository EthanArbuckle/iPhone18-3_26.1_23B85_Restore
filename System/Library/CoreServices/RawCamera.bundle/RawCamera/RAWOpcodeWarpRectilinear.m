...
- (RAWOpcodeWarpRectilinear)initWithArguments:(id)a3
{
  v4 = a3;
  v11.receiver = self;
  v11.super_class = RAWOpcodeWarpRectilinear;
...
- (id)outputImage
{
  ...
  v5 = objc_msgSend_kernelWithString_(MEMORY[0x277CBF738], a2, @"kernel vec4 rc_warp_rectilinear (__sample c) { return c }", v2, v3);;
