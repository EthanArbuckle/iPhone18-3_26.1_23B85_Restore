...
- (BOOL)isCurrent:(unint64_t)a3 withHUDUpdateInterval:(double)a4
{
  v7 = sub_100017A6C(a3 - [(HTHangHUDInfo *)self receivedTimestamp]);
  v8 = [(HTHangHUDInfo *)self getHangHUDInfoKey];
  v9 = sub_100002F0C();
  if (os_log_type_enabled(v9, OS_LOG_TYPE_DEBUG))
  {
    sub_100019D94(v8, v9, v7);
  }

  if ([(HTHangHUDInfo *)self hangEndTime]== 0x7FFFFFFFFFFFFFFFLL || sub_100017A6C(a3 - [(HTHangHUDInfo *)self hangEndTime]) >= 200.0)
  {
