...
- (ProcExitHUDLine)initWithProcExitRecord:(id)record theme:(id)theme lineDelegate:(id)delegate
{
  ...
  if (v11)
  {
    [(HUDLine *)v11 setSpacing:sub_1000172DC()];
    ...
    [(CATextLayer *)v11->_exitedProcNameLayer setFont:qword_10003E768];
    sub_100016E74();
    ...
    v18 = [NSSet setWithObject:&off_100035CF0];
    ...
    if ((v20 & 1) == 0)
    {
      v21 = sub_10000D8F0([recordCopy exitReasonNamespace]);
    ...
    [v22 setFont:qword_10003E778];
    sub_100016E74();
    [v22 setFontSize:?];
    [(HUDLine *)v11 contentScaleForTexts];
    [v22 setContentsScale:?];
    [v22 setAlignmentMode:kCAAlignmentRight];
    v23 = sub_10000F008([recordCopy exitReasonNamespace], objc_msgSend(recordCopy, "exitReasonCode"));
    [v22 setString:v23];
