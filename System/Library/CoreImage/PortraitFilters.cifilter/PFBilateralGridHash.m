...
- (int)_createWithSurface:(__IOSurface *)a3 region:(CGRect)a4 cropRect:(CGRect)a5 sigma_s:(int)a6 sigma_r_luma:(int)a7 sigma_r_chroma:(int)a8
{
  ...
  if ([(PFBilateralGridHash *)self _computeBilateralSpaceYCC444:a3 region:v10 cropRect:v9 sigma_s:v8 sigma_r_luma:v18 sigma_r_chroma:v17, v16, v15, x, y, width, height])
  {
...
- (int)createWithSurface:(__IOSurface *)a3 region:(CGRect)a4 cropRect:(CGRect)a5 sigma_s:(int)a6 sigma_r_luma:(int)a7 sigma_r_chroma:(int)a8
{
  ...
  v16 = a4.origin.y;
  v17 = a4.origin.x;
  result = [PFBilateralGridHash _createWithSurface:"_createWithSurface:region:cropRect:sigma_s:sigma_r_luma:sigma_r_chroma:" region:a3 cropRect:*&a6 sigma_s:*&a7 sigma_r_luma:*&a8 sigma_r_chroma:?];
  if (result)
  {

    return [(PFBilateralGridHash *)self _createWithSurface:a3 region:v9 cropRect:v8 sigma_s:255 sigma_r_luma:v17 sigma_r_chroma:v16, v15, v14, x, y, width, height];
  }
...
- (void)splat:(__CVBuffer *)a3 pout:(float *)a4
{
  v7 = [(PFBilateralGridHash *)self countVertices];
  v8 = [(PFBilateralGridHash *)self width];
  v9 = [(PFBilateralGridHash *)self height];
...
- (void)splat_w_mul_x:(__CVBuffer *)a3 inPixelBuffer:(__CVBuffer *)a4 pout:(float *)a5
{
  v20 = [(PFBilateralGridHash *)self countVertices];
  v9 = [(PFBilateralGridHash *)self width];
  v10 = [(PFBilateralGridHash *)self height];
  CVPixelBufferLockBaseAddress(a3, 0);
...
- (void)slice:(const float *)a3 outPixelBuffer:(__CVBuffer *)a4
{
  v7 = [(PFBilateralGridHash *)self width];
  v8 = [(PFBilateralGridHash *)self height];
  CVPixelBufferLockBaseAddress(a4, 0);
...
- (void)blur:(const float *)a3 pout:(float *)a4
{
  v7 = [(PFBilateralGridHash *)self countDims];
  v8 = [(PFBilateralGridHash *)self countVertices];
  if (v8 >= 1)
  {
    v9 = v8;
    v10 = a3;
...
- (void)splat_ones:(float *)a3
{
  v5 = [(PFBilateralGridHash *)self countVertices];
  if (v5 >= 1)
  {
    v6 = v5;
    p_var1 = &self->_hash_table->var1;
...
- (void)_computeBlurIndices
{
  v3 = [(PFBilateralGridHash *)self countDims];
  v4 = [(PFBilateralGridHash *)self countVertices];
  if (v4 >= 1)
  {
    v5 = 0;
    v6 = 0;
...
- (void)_computeCoordIndices
{
  v3 = [(PFBilateralGridHash *)self width];
  v4 = [(PFBilateralGridHash *)self height];
  v5 = [(PFBilateralGridHash *)self countVertices];
...
- (void)_computeInterpIndices
{
  v3 = [(PFBilateralGridHash *)self countVertices];
  if (v3 < 1)
  {
    v5 = 0;
  }
...
{
  v18 = 0;
  if ([(PFBilateralGridHash *)self _hashMapFindKey:a5 to:&v18])
  {
    v11 = v18;
    hash_table = self->_hash_table;
...
LABEL_6:
  ...
  if (self->_max_hash_table_size > hash_table_size)
  {
    ...
    *&v16->var1 = xmmword_54AB0;
    ...
    [(PFBilateralGridHash *)self _hashMapAddKey:a5 andValue:?];
    v13 = 0;
    if (a6)
    {
      goto LABEL_6;
