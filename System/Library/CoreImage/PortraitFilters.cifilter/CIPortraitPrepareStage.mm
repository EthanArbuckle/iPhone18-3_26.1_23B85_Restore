  ...
  if (result)
  {
    if (self->inputImage && self->inputThresholdImage)
    {
      ...
      else
      {
        ...
        v15 = v14;
        v17 = v16;
        convertToHalfFloat = [(CIPortraitPrepareStage *)self convertToHalfFloat];
        [(CIImage *)self->inputImage extent];
        inputImage = self->inputImage;
        v23 = [convertToHalfFloat applyWithExtent:+[NSArray arrayWithObjects:count:](NSArray arguments:{"arrayWithObjects:count:", &inputImage, 1), v19, v20, v21, v22}];
        ...
        renormalize01 = [(CIPortraitPrepareStage *)self renormalize01];
        [(CIImage *)inputDisparityImage extent];
        v87[0] = inputDisparityImage;
        v87[1] = v25;
        v32 = [renormalize01 applyWithExtent:+[NSArray arrayWithObjects:count:](NSArray arguments:"arrayWithObjects:count:" options:{v87, 2), v26, v28, v29, v30, v31}];
        ...
        renormalizeThreshold = [(CIPortraitPrepareStage *)self renormalizeThreshold];
        [(CIImage *)self->inputThresholdImage extent];
        v84[0] = self->inputThresholdImage;
        v84[1] = v25;
        v35 = v25;
        v40 = [renormalizeThreshold applyWithExtent:+[NSArray arrayWithObjects:count:](NSArray arguments:"arrayWithObjects:count:" options:{v84, 2), v26, v36, v37, v38, v39}];
        ...
        computeBand = [(CIPortraitPrepareStage *)self computeBand];
        [v32 extent];
        v83[0] = v32;
        v83[1] = v40;
        v83[2] = v35;
        v83[3] = v46;
        v52 = [computeBand applyWithExtent:+[NSArray arrayWithObjects:count:](NSArray arguments:"arrayWithObjects:count:" options:{v83, 4), v26, v48, v49, v50, v51}];
        protectInterior = [(CIPortraitPrepareStage *)self protectInterior];
        [v52 extent];
        v82[0] = v33;
        v82[1] = v52;
        v58 = [protectInterior applyWithExtent:+[NSArray arrayWithObjects:count:](NSArray arguments:"arrayWithObjects:count:" options:{v82, 2), v26, v54, v55, v56, v57}];
        ...
        denormalize = [(CIPortraitPrepareStage *)self denormalize];
        [(CIImage *)v65 extent];
        v79[0] = v65;
        v79[1] = v35;
        v71 = [denormalize applyWithExtent:+[NSArray arrayWithObjects:count:](NSArray arguments:"arrayWithObjects:count:" options:{v79, 2), v26, v67, v68, v69, v70}];
