    ...
    do
    {
      ...
      do
      {
        ...
        if ((objc_opt_isKindOfClass() & 1) == 0)
        {
          ...
          *buf = 138412290;
          v62 = v30;
          _os_log_impl(&dword_0, v26, OS_LOG_TYPE_DEFAULT, "Skipping isKindOfClass for %@", buf, 0xCu);
              ...
              if ((v35 & 1) == 0 && ([v29 containsObject:v49]& 1) == 0)
              {
                ...
                if (os_log_type_enabled(v36, OS_LOG_TYPE_DEFAULT))
                {
                  *buf = 138543874;
                  ...
                  v65 = 2112;
                  v66 = *&v49;
                  _os_log_impl(&dword_0, v36, OS_LOG_TYPE_DEFAULT, "Skipping %{public}@ since it's not managed by the personal:%@ persona nor system:%@ persona", buf, 0x20u);
                  v46 = v55;
                  v47 = v49;
                  v19 = v56;
                  v45 = v26;
...
LABEL_50:
              ...
              if (v37 == 2)
              {
                ...
                *buf = 138412290;
                v62 = v26;
                _os_log_impl(&dword_0, v36, OS_LOG_TYPE_DEFAULT, "Skipping %@ (Swift Playgrounds app)", buf, 0xCu);
                v45 = v26;
              }
...
LABEL_63:
                ...
                *buf = 138412290;
                v62 = v26;
                _os_log_impl(&dword_0, v36, OS_LOG_TYPE_DEFAULT, "Skipping %@ (app clip)", buf, 0xCu);
                v45 = v26;
              }
            }
            ...
            else if (v52)
            {
              ...
              *buf = 138543618;
              ...
              v63 = 2114;
              v64 = v55;
              _os_log_impl(&dword_0, v36, OS_LOG_TYPE_DEFAULT, "Skipping %{public}@ for data-separated persona %{public}@ since it's not in the list of managed personae", buf, 0x16u);
              v45 = v26;
              v46 = v55;
              v19 = v56;
            }
            ...
            else
            {
              ...
              *buf = 138543618;
              ...
              v63 = 2114;
              v64 = v55;
              _os_log_impl(&dword_0, v36, OS_LOG_TYPE_DEFAULT, "Skipping %{public}@ for persona %{public}@ since it's not in the list of managed personae", buf, 0x16u);
              v45 = v26;
              v46 = v55;
              v19 = v56;
            }
...
LABEL_62:
          ...
          if (os_log_type_enabled(v29, OS_LOG_TYPE_INFO))
          {
            *buf = 138412290;
            v62 = v26;
            _os_log_impl(&dword_0, v29, OS_LOG_TYPE_INFO, "Skipping %@ as of Hidden type", buf, 0xCu);
            v45 = v26;
LABEL_27:
            _MBLog();
          }
        ...
        else
        {
          ...
          if (os_log_type_enabled(v29, OS_LOG_TYPE_DEBUG))
          {
            *buf = 138412290;
            v62 = v26;
            _os_log_impl(&dword_0, v29, OS_LOG_TYPE_DEBUG, "Skipping isContainerized for %@", buf, 0xCu);
            v45 = v26;
            goto LABEL_27;
          }
        }
...
- (BOOL)registerSafeHarborWithIdentifier:(id)a3 path:(id)a4 type:(int)a5 error:(id *)a6
{
  v9 = a3;
  v10 = a4;
  v11 = MCMContainerContentClassForMBContainerType(a5);
...
- (BOOL)removeSafeHarborWithIdentifier:(id)a3 type:(int)a4 error:(id *)a5
{
  ...
  if (a4)
  {
    v8 = MCMContainerContentClassForMBContainerType(a4);
  }
