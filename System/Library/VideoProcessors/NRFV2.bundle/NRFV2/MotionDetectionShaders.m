...
- (MotionDetectionShaders)initWithMetal:(id)a3
{
  ...
  v7 = objc_msgSend_computePipelineStateFor_constants_(v4, v5, @"kernelMotionDetectGenClippingMapAndDownscale", 0);
...
LABEL_24:
  ...
  v10 = objc_msgSend_computePipelineStateFor_constants_(v4, v9, @"kernelMotionDetectGenClippingMapAndDownscaleLinear", 0);
  ...
  v13 = objc_msgSend_computePipelineStateFor_constants_(v4, v12, @"motionDetectGradient", 0);
  ...
  v16 = objc_msgSend_computePipelineStateFor_constants_(v4, v15, @"motionDetectWarp", 0);
  ...
  v19 = objc_msgSend_computePipelineStateFor_constants_(v4, v18, @"motionDetectDilate", 0);
  ...
  v22 = objc_msgSend_computePipelineStateFor_constants_(v4, v21, @"motionDetectDiffGradient", 0);
  ...
  v25 = objc_msgSend_computePipelineStateFor_constants_(v4, v24, @"motionDetectMaxTileAvg", 0);
  ...
  v28 = objc_msgSend_computePipelineStateFor_constants_(v4, v27, @"motionDetectLLDownscale", 0);
  ...
  v31 = objc_msgSend_computePipelineStateFor_constants_(v4, v30, @"motionDetectLL", 0);
  ...
  v34 = objc_msgSend_computePipelineStateFor_constants_(v4, v33, @"motionDetectLLSumReduce", 0);
