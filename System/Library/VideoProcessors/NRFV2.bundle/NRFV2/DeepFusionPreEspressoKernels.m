...
- (DeepFusionPreEspressoKernels)initWithMetal:(id)a3 networkVersion:(int)a4
{
  ...
  v9 = objc_msgSend_computePipelineStateFor_constants_(v6, v7, @"yuvCopyAndBias", 0);
...
LABEL_13:
  ...
  v12 = objc_msgSend_computePipelineStateFor_constants_(v6, v11, @"yuvPlanarRGBToRGBA", 0);
  ...
  v15 = objc_msgSend_computePipelineStateFor_constants_(v6, v14, @"filterChroma", 0);
  ...
  do
  {
    ...
    v22 = objc_msgSend_computePipelineStateFor_constants_(v6, v21, @"estimateAndTuneNoise", v17);
