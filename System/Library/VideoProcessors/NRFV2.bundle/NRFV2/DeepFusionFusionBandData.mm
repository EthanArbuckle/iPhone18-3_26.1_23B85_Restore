...
- (int)readPlist:(id)plist
{
  ...
  v8 = objc_msgSend_objectForKeyedSubscript_(plistCopy, v6, @"ChromaGlobal", v7);
...
LABEL_15:
  ...
  v19 = objc_msgSend_objectForKeyedSubscript_(plistCopy, v17, @"LSCAmp", v18);
  ...
  v30 = objc_msgSend_objectForKeyedSubscript_(plistCopy, v28, @"LSCOffset", v29);
  ...
  v41 = objc_msgSend_objectForKeyedSubscript_(plistCopy, v39, @"LumaMid", v40);
  ...
  v52 = objc_msgSend_objectForKeyedSubscript_(plistCopy, v50, @"LumaSlope", v51);
  ...
  v63 = objc_msgSend_objectForKeyedSubscript_(plistCopy, v61, @"HighlightFusionAlpha", v62);
