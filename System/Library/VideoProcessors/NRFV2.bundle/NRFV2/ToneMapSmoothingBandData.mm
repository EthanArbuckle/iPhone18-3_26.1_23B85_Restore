...
- (int)readPlist:(id)plist
{
  ...
  v8 = objc_msgSend_objectForKeyedSubscript_(plistCopy, v6, @"MaskedDetailMix", v7);
  ...
  if (self->maskedDetailMix)
  {
    ...
    v16 = objc_msgSend_objectForKeyedSubscript_(plistCopy, v14, @"UnmaskedDetailMix", v15);
    ...
    {
      v23 = objc_msgSend_objectForKeyedSubscript_(plistCopy, v21, @"SkyMaskedDetailMix", v22);

      if (v23)
      {
        v26 = [GainValueArray alloc];
        v29 = objc_msgSend_objectForKeyedSubscript_(plistCopy, v27, @"SkyMaskedDetailMix", v28);
        v32 = objc_msgSend_initWithArray_(v26, v30, v29, v31);
        skyMaskedDetailMix = self->skyMaskedDetailMix;
        self->skyMaskedDetailMix = v32;
      }

      v34 = objc_msgSend_objectForKeyedSubscript_(plistCopy, v24, @"Feature1MaskedDetailMix", v25);

      if (v34)
      {
        v35 = [GainValueArray alloc];
        v38 = objc_msgSend_objectForKeyedSubscript_(plistCopy, v36, @"Feature1MaskedDetailMix", v37);
