...
- (int)readPlist:(id)plist
{
  ...
  v8 = objc_msgSend_valueForKey_(plistCopy, v6, @"BoundsMapLimit", v7);
...
LABEL_19:
  ...
  v16 = objc_msgSend_valueForKey_(plistCopy, v14, @"ShadowLimit", v15);
  ...
  v24 = objc_msgSend_valueForKey_(plistCopy, v22, @"LowResMotionThreshold", v23);
  ...
  v32 = objc_msgSend_valueForKey_(plistCopy, v30, @"BoostedLumaMotionThreshold", v31);
  ...
  v40 = objc_msgSend_valueForKey_(plistCopy, v38, @"SADThreshold", v39);
  ...
  v48 = objc_msgSend_valueForKey_(plistCopy, v46, @"NCCLowLimitMatchedTexture", v47);
  ...
  v56 = objc_msgSend_valueForKey_(plistCopy, v54, @"NCCHighLimitMatchedTexture", v55);
  ...
  v64 = objc_msgSend_valueForKey_(plistCopy, v62, @"FusionBoostMatchedTexture", v63);
