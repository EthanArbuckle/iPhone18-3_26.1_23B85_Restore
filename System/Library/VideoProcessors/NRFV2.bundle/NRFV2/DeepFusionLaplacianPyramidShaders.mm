...
- (DeepFusionLaplacianPyramidShaders)initWithMetal:(id)metal;
@end
...
- (DeepFusionLaplacianPyramidShaders)initWithMetal:(id)metal
{
  ...
  v7 = objc_msgSend_computePipelineStateFor_constants_(metalCopy, v5, @"boxPyramid5x5", 0);
...
LABEL_20:
  ...
  v10 = objc_msgSend_computePipelineStateFor_constants_(metalCopy, v9, @"bilinearPyramid", 0);
  ...
  v13 = objc_msgSend_computePipelineStateFor_constants_(metalCopy, v12, @"gaussianPyramid5SeparableH", 0);
  ...
  v16 = objc_msgSend_computePipelineStateFor_constants_(metalCopy, v15, @"gaussianPyramid5SeparableV", 0);
  ...
  v19 = objc_msgSend_computePipelineStateFor_constants_(metalCopy, v18, @"laplacianPyramidSubtractionPass", 0);
  ...
  v22 = objc_msgSend_computePipelineStateFor_constants_(metalCopy, v21, @"laplacianPyramidGaussianH", 0);
  ...
  v25 = objc_msgSend_computePipelineStateFor_constants_(metalCopy, v24, @"laplacianPyramidGaussianV", 0);
  ...
  v28 = objc_msgSend_computePipelineStateFor_constants_(metalCopy, v27, @"laplacianPyramidGaussianVLap", 0);
