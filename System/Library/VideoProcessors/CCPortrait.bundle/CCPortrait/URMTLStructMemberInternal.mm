...
- (URMTLStructMemberInternal)initWithCoder:(id)coder;
...
- (URMTLStructMemberInternal)initWithCoder:(id)coder
{
  ...
  v6 = objc_opt_class();
  v7 = objc_opt_class();
  v9 = objc_msgSend_decodeObjectOfClass_forKey_(coderCopy, v8, v7, @"name");
  objc_msgSend_setName_(v5, v10, v9);

  v12 = objc_msgSend_decodeObjectOfClass_forKey_(coderCopy, v11, v6, @"offset");
  v15 = objc_msgSend_unsignedIntegerValue(v12, v13, v14);
  objc_msgSend_setOffset_(v5, v16, v15);

  v18 = objc_msgSend_decodeObjectOfClass_forKey_(coderCopy, v17, v6, @"dataType");
  v21 = objc_msgSend_unsignedIntegerValue(v18, v19, v20);
  objc_msgSend_setDataType_(v5, v22, v21);

  v24 = objc_msgSend_decodeObjectOfClass_forKey_(coderCopy, v23, v6, @"argumentIndex");
