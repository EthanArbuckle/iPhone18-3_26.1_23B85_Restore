...
+ (BOOL)runHighlightRecoveryWithInputTexture:(id)texture outputTexture:(id)outputTexture temporaryTexture:(id)temporaryTexture dynamicParams:(id)params iterations:(int)iterations tileSize:(int)size scanKernel:(id)kernel diffuseKernel:(id)self0 copyBackKernel:(id)self1 copyKernel:(id)self2 commandBuffer:(id)self3 constants:(id)self4 forCoreImage:(BOOL)self5;
+ (id)generateCIImage:(id)image;
+ (id)processList:(id)list tileSize:(int)size;
- (UniHighlightRecovery)init;
- (UniHighlightRecovery)initWithDevice:(id)device;
- (UniHighlightRecovery)initWithDevice:(id)device library:(id)library constants:(id)constants;
...
- (UniHighlightRecovery)initWithDevice:(id)device library:(id)library constants:(id)constants
{
  ...
  v12 = objc_msgSend_initWithDevice_(self, v10, device);
  if (v12)
  {
    v13 = objc_msgSend_objectForKeyedSubscript_(constantsCopy, v11, @"SparseRenderer::kXhlrbTileSize");
    v16 = objc_msgSend_intValue(v13, v14, v15);
    objc_msgSend_setHlrTileSize_(v12, v17, v16);

    v19 = objc_msgSend_objectForKeyedSubscript_(constantsCopy, v18, @"SparseRenderer::kXhlrbTileSize", @"SparseRenderer::kXhlrbTileSize");
    v49 = v19;
    v21 = objc_msgSend_dictionaryWithObjects_forKeys_count_(MEMORY[0x29EDB8DC0], v20, &v49, &v48, 1);

    v23 = objc_msgSend_findComputeKernel_library_constants_(UniDeviceCache, v22, @"sparserendering_xhlrb_scan", libraryCopy, constantsCopy);
    v26 = objc_msgSend_mk(v23, v24, v25);
    objc_msgSend_setHlrScanKernel_(v12, v27, v26);

    v29 = objc_msgSend_findComputeKernel_library_constants_(UniDeviceCache, v28, @"sparserendering_xhlrb_diffuse", libraryCopy, constantsCopy);
    v32 = objc_msgSend_mk(v29, v30, v31);
    objc_msgSend_setHlrDiffuseKernel_(v12, v33, v32);

    v35 = objc_msgSend_findComputeKernel_library_constants_(UniDeviceCache, v34, @"sparserendering_xhlrb_copy_back", libraryCopy, v21);
    v38 = objc_msgSend_mk(v35, v36, v37);
    objc_msgSend_setHlrCopyBackKernel_(v12, v39, v38);

    v41 = objc_msgSend_findComputeKernel_library_constants_(UniDeviceCache, v40, @"plain_or_sRGB_copy", libraryCopy, 0);
    v44 = objc_msgSend_mk(v41, v42, v43);
    objc_msgSend_setHlrCopyKernel_(v12, v45, v44);

    objc_msgSend_setHlrConstants_(v12, v46, constantsCopy);
  }
...
- (id)copyWithZone:(_NSZone *)zone
{
  ...
  v6 = [(UniKernel *)&v30 copyWithZone:zone];
  if (v6)
  {
...
{
  listCopy = list;
  v8 = objc_msgSend_width(listCopy, v6, v7);
  v11 = 2 * (v8 + size - 1) / size * ((objc_msgSend_height(listCopy, v9, v10) + size - 1) / size) + 4;
  v12 = 4 * v11;
  ...
  free(v13);
  v18 = objc_msgSend_device(listCopy, v16, v17);
...
+ (BOOL)runHighlightRecoveryWithInputTexture:(id)texture outputTexture:(id)outputTexture temporaryTexture:(id)temporaryTexture dynamicParams:(id)params iterations:(int)iterations tileSize:(int)size scanKernel:(id)kernel diffuseKernel:(id)self0 copyBackKernel:(id)self1 copyKernel:(id)self2 commandBuffer:(id)self3 constants:(id)self4 forCoreImage:(BOOL)self5
{
  ...
  temporaryTextureCopy = temporaryTexture;
  paramsCopy = params;
  kernelCopy = kernel;
  diffuseKernelCopy = diffuseKernel;
  backKernelCopy = backKernel;
  copyKernelCopy = copyKernel;
  bufferCopy = buffer;
  constantsCopy = constants;
  v23 = textureCopy;
  v24 = outputTextureCopy;
  v25 = v23;
  v26 = v24;
  ...
  if (image)
  {
    v35 = objc_msgSend_blitCommandEncoder(bufferCopy, v32, v33);
    objc_msgSend_setLabel_(bufferCopy, v36, @"XHLRBComputeBlit");
    if (!temporaryTextureCopy)
    {
      sub_2956CE03C();
    }

    v39 = objc_msgSend_width(v25, v37, v38);
    if (v39 > objc_msgSend_width(temporaryTextureCopy, v40, v41))
    {
      sub_2956CE010();
    }

    v44 = objc_msgSend_height(v25, v42, v43);
    if (v44 > objc_msgSend_height(temporaryTextureCopy, v45, v46))
    {
      sub_2956CDFE4();
    }

    v49 = objc_msgSend_pixelFormat(v25, v47, v48);
    if (v49 != objc_msgSend_pixelFormat(temporaryTextureCopy, v50, v51))
    {
      sub_2956CDF34();
    }
    ...
    *&v210 = 1;
    ...
    v219 = 0;
    v220 = 0;
    objc_msgSend_copyFromTexture_sourceSlice_sourceLevel_sourceOrigin_sourceSize_toTexture_destinationSlice_destinationLevel_destinationOrigin_(v35, v56, v25, 0, 0, &v214, &v209, temporaryTextureCopy, 0, 0, &v218);
    objc_msgSend_endEncoding(v35, v57, v58);
    v59 = temporaryTextureCopy;
  ...
  v194 = temporaryTextureCopy;
  v189 = constantsCopy;
  v72 = (WORD4(v209) & 0x800) == 0 && *(&v215 + 1) == 32;
  v188 = v72;
  v208 = v72;
  sizeCopy = size;
  v74 = objc_msgSend_processList_tileSize_(UniHighlightRecovery, v70, v25, size);
  v77 = objc_msgSend_maxTotalThreadsPerThreadgroup(kernelCopy, v75, v76);
  v80 = objc_msgSend_maxTotalThreadsPerThreadgroup(diffuseKernelCopy, v78, v79);
  v83 = objc_msgSend_maxTotalThreadsPerThreadgroup(backKernelCopy, v81, v82);
  v84 = log2f(fminf(v77, fminf(v80, v83)));
  v87 = exp2f(floorf(v84)) / size;
  if (v87 >= size >> 1)
  {
    v88 = size >> 1;
  }
  ...
  if (objc_msgSend_length(paramsCopy, v93, v94) != 22)
  {
    sub_2956CDFB8();
  }
  ...
  v187 = (v96 + v92) / size;
  v97 = (v96 + v89) / size;
  objc_msgSend_getBytes_length_(paramsCopy, v95, v207, 22);
  v100 = objc_msgSend_blitCommandEncoder(bufferCopy, v98, v99);
  ...
  v110 = objc_msgSend_computeCommandEncoder(bufferCopy, v108, v109);
  ...
  if (iterations >= 1)
  {
    do
    {
      objc_msgSend_setComputePipelineState_(v110, v118, diffuseKernelCopy);
      ...
      if (v191 != v188)
      {
        ...
        objc_msgSend_setComputePipelineState_(v110, v126, backKernelCopy);
      ...
      else
      {
        ...
        objc_msgSend_setComputePipelineState_(v110, v132, backKernelCopy);
  ...
  v136 = objc_msgSend_threadExecutionWidth(copyKernelCopy, v118, v119);
  v139 = objc_msgSend_maxTotalThreadsPerThreadgroup(copyKernelCopy, v137, v138) / v136;
  objc_msgSend_setComputePipelineState_(v110, v140, copyKernelCopy);
  ...
  {
    v153 = objc_msgSend_threadExecutionWidth(copyKernelCopy, v144, v145);
    v156 = objc_msgSend_maxTotalThreadsPerThreadgroup(copyKernelCopy, v154, v155) / v153;
  ...
  if (!image)
  {
    ...
    {
      v175 = objc_msgSend_threadExecutionWidth(copyKernelCopy, v168, v169);
      v178 = objc_msgSend_maxTotalThreadsPerThreadgroup(copyKernelCopy, v176, v177) / v175;
...
{
  imageCopy = image;
  v6 = objc_msgSend_inputs(imageCopy, v4, v5);
  v8 = objc_msgSend_objectForKeyedSubscript_(v6, v7, *MEMORY[0x29EDB9238]);
  v10 = objc_msgSend__ciImageForInput_(imageCopy, v9, v8);
