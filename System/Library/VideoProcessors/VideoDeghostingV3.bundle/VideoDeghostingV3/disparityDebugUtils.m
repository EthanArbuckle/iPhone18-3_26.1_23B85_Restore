...
- (void)saveF32FPBuffer:(__CVBuffer *)a3 AsPPMFile:(const char *)a4 scale:(float)a5
{
  PathIfNeededAndOpenFile = createPathIfNeededAndOpenFile(a4);
...
- (void)saveF32Buffer:(__CVBuffer *)a3 AsPPMFile:(const char *)a4
{
  ...
  v16 = v17;
  writePPMFromRGBA(Width, Height, 4 * Width, v10, [v17 UTF8String]);
  free(v10);
}
...
- (void)saveU8Buffer:(__CVBuffer *)a3 AsPPMFile:(const char *)a4
{
  ...
  v19 = v20;
  writePPMFromRGBA(Width, Height, 4 * Width, v11, [v20 UTF8String]);
  free(v11);
}
...
- (void)saveVUYA4444Texture:(id)a3 AsPPMFile:(const char *)a4
{
  ...
  writePPMFromRGBA(v7, v8, 4 * v7, v9, a4);
  free(v9);
}
...
- (void)saveVUYA4444PixelBuffer:(__CVBuffer *)a3 out_width:(unsigned int)Width out_height:(unsigned int)Height AsBinaryFile:(const char *)a6
{
  PathIfNeededAndOpenFile = createPathIfNeededAndOpenFile(a6);
  if (!PathIfNeededAndOpenFile)
  {
    return;
  }
...
- (void)saveVUYA4444PixelBuffer:(__CVBuffer *)a3 out_width:(unsigned int)a4 out_height:(unsigned int)a5 AsPPMFile:(const char *)a6
{
  ...
  writePPMFromRGBA(v15, v16, 4 * Width, v14, a6);
...
- (void)saveRGB10A2PixelBuffer:(__CVBuffer *)a3 out_width:(unsigned int)a4 out_height:(unsigned int)a5 AsPPMFile:(const char *)a6
{
  ...
  CVPixelBufferUnlockBaseAddress(a3, 1uLL);
  writePPMFromRGBA(v8, v7, 4 * v8, v14, a6);
...
- (void)saveRGBATexture:(id)a3 AsPPMFile:(const char *)a4
{
  ...
  writePPMFromRGBA(v7, v8, 4 * v7, v9, [v10 UTF8String]);
  free(v9);
}
...
- (void)saveF16DisparityBufferAsTurbo:(__CVBuffer *)a3 AsPPMFile:(const char *)a4 WithMin:(float)a5 WithMax:(float)a6
{
  ...
  if (v14)
  {
      ...
      for (i = 0; i != Height; ++i)
      {
        if (Width)
        {
          ...
          do
          {
            ...
            v25 = &turbo_srgb_bytes_1024 + 3 * ((((fmaxf(a5, fminf(a6, _S3)) - a5) / (a6 - a5)) * 1024.0) + -0.49);
            *v18 = *v25;
            v18[2] = v25[2];
            v18[3] = -1;
            v18 += 4;
    ...
    CVPixelBufferUnlockBaseAddress(a3, 1uLL);
    writePPMFromRGBA(Width, Height, 4 * Width, v15, a4);
...
- (void)saveF16DisparityBuffer:(__CVBuffer *)a3 AsGrayScalePPMFile:(const char *)a4 range:
{
  ...
  writePPMFromRGBA(Width, Height, v30, v28, a4);
  free(v29);
...
- (void)saveF16Texture:(id)a3 AsGrayScalePPMFile:(const char *)a4 range:
{
  ...
  writePPMFromRGBA(v8, v9, v32, v30, a4);
  free(v31);
  free(v10);
  free(v12);
}
...
- (void)ApplyColorWheelAndWrite:(unsigned int)a3 height:(unsigned int)a4 data:(float *)a5 fileFullPath:(const char *)a6
{
  ...
  ColorsWheelContext_drawMatrix_f32(v15, a3, a4, a5, 4 * a3, 4, v10, 4 * a3, v11, v12, v13, v14, 4);
  writePPMFromRGBA(a3, a4, 4 * a3, v10, a6);
  free(v10);
...
- (void)saveRGF16Texture:(id)a3 AsF32BinaryFile0:(id)a4 AsF32BinaryFile1:(id)a5
{
  ...
  v9 = a4;
  v10 = a5;
  PathIfNeededAndOpenFile = createPathIfNeededAndOpenFile([v9 UTF8String]);
  if (PathIfNeededAndOpenFile)
  {
    v12 = PathIfNeededAndOpenFile;
    __stream = createPathIfNeededAndOpenFile([v10 UTF8String]);
    if (!__stream)
    {
      v36 = v12;
LABEL_17:
...
- (void)saveRGBA8Texture:(id)a3 AsPPMFile:(const char *)a4
{
  ...
  if (v9)
  {
    ...
    writePPMFromRGBA(v7, v8, 4 * v7, v10, a4);
    free(v10);
  }
...
- (void)WriteBinDataToFile:(void *)a3 length:(unsigned int)a4 fileFullPath:(const char *)a5
{
  PathIfNeededAndOpenFile = createPathIfNeededAndOpenFile(a5);
  if (PathIfNeededAndOpenFile)
  {
    v8 = PathIfNeededAndOpenFile;
    fwrite(a3, 1uLL, a4, PathIfNeededAndOpenFile);
...
- (void)saveAccumulationFrom:(id)a3 asBinaryFiles:(const char *)a4 forSize:(CGSize)a5 costLineSize:(unsigned __int16)a6
{
  ...
  v34 = v16;
  PathIfNeededAndOpenFile = createPathIfNeededAndOpenFile([v16 UTF8String]);
  v21 = createPathIfNeededAndOpenFile([v17 UTF8String]);
  v42 = createPathIfNeededAndOpenFile([v18 UTF8String]);
  v22 = createPathIfNeededAndOpenFile([v19 UTF8String]);
...
LABEL_12:
  ...
  if (v42 && v22)
  {
    ...
    writePPMFromRGBA(v27, v38, 4 * v27, v24, [v35 UTF8String]);
    v17 = v33;
    v23 = __stream;
    goto LABEL_12;
  }
