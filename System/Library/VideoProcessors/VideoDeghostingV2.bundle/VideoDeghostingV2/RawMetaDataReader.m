...
+ (id)readMetaDataFromDictionary:(id)a3 andValidWidth:(unint64_t)a4 andValidHeight:(unint64_t)a5 andLightSource:(opaqueCMSampleBuffer *)a6 andKeyPoints:(opaqueCMSampleBuffer *)a7
{
  ...
  if (v10)
  {
    ...
    v13 = [v10 objectForKeyedSubscript:kFigCaptureStreamMetadata_DistortionOpticalCenterV2];
    if (v13)
    {
    ...
    v15 = [v10 objectForKeyedSubscript:kFigCaptureStreamMetadata_LuxLevel];
    if (v15)
    {
    ...
    if (a7)
    {
      v17 = CMGetAttachment(a7, kFigCaptureSampleBufferAttachmentKey_MetadataDictionary, 0);
      if (v17)
      {
        Value = CFDictionaryGetValue(v17, kFigCaptureStreamMetadata_ImageRegistrationInfo);
        if (Value)
        {
          v19 = [RawMetaDataReader _getRegistrationInfo:v10 validWidth:a4 validHeight:a5 keypointDictionary:Value ispInfo:v30];
          if ((v19 & [RawMetaDataReader _getKeypointsMappingInfoFrom:v10 validWidth:a4 validHeight:a5 KeyPointDictionary:Value IspInfo:v30]) == 1)
          {
            LODWORD(v32) = 1;
          }
        }
    ...
    v24 = CMGetAttachment(a6, kFigCaptureSampleBufferAttachmentKey_MetadataDictionary, 0);
    if (v24 && [RawMetaDataReader _getLightSourceMappingInfoFrom:v10 imageValidWidth:a4 imageValidHeight:a5 lightSourceDictionary:v24 lightSourceValidWidth:Width lightSourceValidHeight:Height ispInfo:v30])
    {
      HIDWORD(v32) = 1;
    }
