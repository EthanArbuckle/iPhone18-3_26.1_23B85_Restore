...
- (id)_normalizeHomography:(double)a3 width:(double)a4 height:(double)a5
{
  *&a5 = a8;
  *&a6 = a9;
  return [a1 _scaleHomography:a2 scaleX:a3 scaleY:{a4, a5, a6}];
}
...
- (double)_scaleHomography:(simd_float3x3)a1 scaleX:(float)a2 scaleY:(float)a3
{
  ...
  do
  {
    *(&v12 + v5 * 16) = vmlaq_laneq_f32(vmlaq_lane_f32(vmulq_n_f32(a1.columns[0], COERCE_FLOAT(*&v11.columns[v5])), a1.columns[1], *v11.columns[v5].f32, 1), xmmword_2EB00, v11.columns[v5], 2);
    ++v5;
  }

  while (v5 != 3);
  a1.columns[2] = xmmword_2EB00;
  v9 = v13;
  v10 = v12;
  v8 = v14;
  v15 = __invert_f3(a1);
