...
void start(int a1, uint64_t a2)
{
  if (a1 <= 3)
  {
    fwrite("Usage: newfs_fskit [--progress] [-t fstype] <options> device\n", 0x3DuLL, 1uLL, __stderrp);
    fwrite("\t--progress if passed it will display the progress of newfs (optional)\n", 0x47uLL, 1uLL, __stderrp);
...
LABEL_12:
      ...
      if (**v11 != 45)
      {
        ...
        v13 = sub_100000958(2, v12, a1 - v9, v11);
        exit(v13);
      }
